...
vlogan +v2k \
      ...
      ../../example_design/v6_emac_v1_3.v \
      ../../example_design/v6_emac_v1_3_block.v \
      ../../example_design/v6_emac_v1_3_locallink.v \
      ../../example_design/v6_emac_v1_3_example_design.v \
      ../configuration_tb.v \
      ../phy_tb.v \
      ../demo_tb.v \
...
./simv -ucli -s -i ucli_commands.key
