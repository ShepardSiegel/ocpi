# -------------------------------------------------------------------------
#
# ALTMEMPHY v11.0 DDR3 SDRAM pin constraints script for ddr3_s4_amphy
#
...
set mem_reset_n_pin_name ${pin_prefix}reset_n
set mem_reset_n_CURRENT_STRENGTH_NEW "MAXIMUM CURRENT"
set mem_reset_n_IO_STANDARD "SSTL-15 CLASS I"
...
set mem_reset_n_pin_name ${::ppl_instance_name}${mem_reset_n_pin_name}${output_suffix}
...
set_instance_assignment -name OUTPUT_TERMINATION "${mem_dqs_OUTPUT_TERMINATION}" -to ${mem_dqs_pin_name}${single_bit}
set_instance_assignment -name IO_STANDARD "${mem_dqs_IO_STANDARD}" -to ${mem_dqs_pin_name}${single_bit}
set_instance_assignment -name IO_STANDARD "${mem_dqsn_IO_STANDARD}" -to ${mem_dqsn_pin_name}${single_bit}
set_instance_assignment -name OUTPUT_TERMINATION "${mem_dqsn_OUTPUT_TERMINATION}" -to ${mem_dqsn_pin_name}${single_bit}
set_instance_assignment -name IO_STANDARD "${mem_dqsn_IO_STANDARD}" -to ${mem_dqsn_pin_name}${single_bit}
set_instance_assignment -name IO_STANDARD "${mem_dm_IO_STANDARD}" -to ${mem_dm_pin_name}${single_bit}
set_instance_assignment -name OUTPUT_TERMINATION "${mem_dm_OUTPUT_TERMINATION}" -to ${mem_dm_pin_name}${single_bit}
set_instance_assignment -name IO_STANDARD "${mem_reset_n_IO_STANDARD}" -to ${mem_reset_n_pin_name}
set_instance_assignment -name CURRENT_STRENGTH_NEW "${mem_reset_n_CURRENT_STRENGTH_NEW}" -to ${mem_reset_n_pin_name}
...
set_instance_assignment -name OUTPUT_ENABLE_GROUP "990065205" -to ${mem_dq_pin_name}[0]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "990065205" -to ${mem_dq_pin_name}[1]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "990065205" -to ${mem_dq_pin_name}[2]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "990065205" -to ${mem_dq_pin_name}[3]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "990065205" -to ${mem_dq_pin_name}[4]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "990065205" -to ${mem_dq_pin_name}[5]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "990065205" -to ${mem_dq_pin_name}[6]
set_instance_assignment -name OUTPUT_ENABLE_GROUP "990065205" -to ${mem_dq_pin_name}[7]
set_instance_assignment -name MEM_INTERFACE_DELAY_CHAIN_CONFIG "${delay_chain_config}" -to ${mem_dqs_pin_name}${single_bit}
set_instance_assignment -name OUTPUT_ENABLE_GROUP "990065205" -to ${mem_dqs_pin_name}${single_bit}
set_instance_assignment -name MEM_INTERFACE_DELAY_CHAIN_CONFIG "${delay_chain_config}" -to ${mem_dqsn_pin_name}${single_bit}
set_instance_assignment -name OUTPUT_ENABLE_GROUP "990065205" -to ${mem_dqsn_pin_name}${single_bit}
set_instance_assignment -name MEM_INTERFACE_DELAY_CHAIN_CONFIG "${delay_chain_config}" -to ${mem_dm_pin_name}${single_bit}
set_instance_assignment -name OUTPUT_ENABLE_GROUP "990065205" -to ${mem_dm_pin_name}${single_bit}
set_instance_assignment -name DQ_GROUP 9 -to ${mem_dq_pin_name}\[0\] -from ${mem_dqs_pin_name}${single_bit}
set_instance_assignment -name DQ_GROUP 9 -to ${mem_dq_pin_name}\[1\] -from ${mem_dqs_pin_name}${single_bit}
set_instance_assignment -name DQ_GROUP 9 -to ${mem_dq_pin_name}\[2\] -from ${mem_dqs_pin_name}${single_bit}
set_instance_assignment -name DQ_GROUP 9 -to ${mem_dq_pin_name}\[3\] -from ${mem_dqs_pin_name}${single_bit}
set_instance_assignment -name DQ_GROUP 9 -to ${mem_dq_pin_name}\[4\] -from ${mem_dqs_pin_name}${single_bit}
set_instance_assignment -name DQ_GROUP 9 -to ${mem_dq_pin_name}\[5\] -from ${mem_dqs_pin_name}${single_bit}
set_instance_assignment -name DQ_GROUP 9 -to ${mem_dq_pin_name}\[6\] -from ${mem_dqs_pin_name}${single_bit}
set_instance_assignment -name DQ_GROUP 9 -to ${mem_dq_pin_name}\[7\] -from ${mem_dqs_pin_name}${single_bit}
set_instance_assignment -name DQ_GROUP 9 -to ${mem_dm_pin_name}${single_bit} -from ${mem_dqs_pin_name}${single_bit}
set_instance_assignment -name DQSB_DQS_PAIR ON -from ${mem_dqsn_pin_name}${single_bit} -to ${mem_dqs_pin_name}${single_bit}
