...
module altera_mem_if_ddr3_phy_0001_read_datapath(
	reset_n_afi_clk,
	seq_read_fifo_reset,
	reset_n_resync_clk,
	pll_dqs_ena_clk,
...
`endif
	...
	`endif
		...
		altera_mem_if_ddr3_phy_0001_fr_cycle_shifter uread_fr_cycle_shifter(
			.clk (pll_afi_clk),
...
genvar dqs_count, subgroup, dq_count, timeslot;
	...
	begin: read_buffering
		...
		altera_mem_if_ddr3_phy_0001_read_valid_selector uread_valid_selector(
			.reset_n		(reset_n_afi_clk),
		...
		altera_mem_if_ddr3_phy_0001_read_valid_selector uread_valid_full_selector(
			.reset_n		(reset_n_afi_clk),
			.pll_afi_clk		(pll_afi_clk),
		...
		`else
		altera_mem_if_ddr3_phy_0001_sim_delay #(
				.delay(10)
			)
			sim_delay_inst(
		...
		begin: read_subgroup
			...
			altera_mem_if_ddr3_phy_0001_flop_mem	uread_fifo(
			...
			altera_mem_if_ddr3_phy_0001_flop_mem	uread_fifo_neg(
