...
module altera_mem_if_ddr3_phy_0001_memphy_top(
	global_reset_n,
	soft_reset_n,
	reset_request_n,
	ctl_reset_n,
...
assign afi_rlat = 0;
	...
	altera_mem_if_ddr3_phy_0001_memphy	umemphy(
...
`else
	altera_mem_if_ddr3_phy_0001_sim_delay #(.delay(1)) sim_delay_inst(.o(delayed_pll_locked_pre), .i(pll_locked));
`endif
...
begin
	altera_mem_if_ddr3_phy_0001_pll_memphy	upll_memphy(
...
begin
	altera_mem_if_ddr3_phy_0001_dll_memphy  udll_memphy(
...
endgenerate
	...
	altera_mem_if_ddr3_phy_0001_oct_control	uoct_control(
