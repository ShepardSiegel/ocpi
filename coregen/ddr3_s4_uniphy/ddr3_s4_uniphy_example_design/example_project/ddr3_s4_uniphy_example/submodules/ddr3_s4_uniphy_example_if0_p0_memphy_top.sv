...
module ddr3_s4_uniphy_example_if0_p0_memphy_top(
	global_reset_n,
	soft_reset_n,
	reset_request_n,
	ctl_reset_n,
...
assign afi_rlat = 0;
	...
	ddr3_s4_uniphy_example_if0_p0_memphy	umemphy(
...
`else
	ddr3_s4_uniphy_example_if0_p0_sim_delay #(.delay(1)) sim_delay_inst(.o(delayed_pll_locked_pre), .i(pll_locked));
`endif
...
begin
	ddr3_s4_uniphy_example_if0_p0_pll_memphy	upll_memphy(
...
begin
	ddr3_s4_uniphy_example_if0_p0_dll_memphy  udll_memphy(
...
endgenerate
	...
	ddr3_s4_uniphy_example_if0_p0_oct_control	uoct_control(
