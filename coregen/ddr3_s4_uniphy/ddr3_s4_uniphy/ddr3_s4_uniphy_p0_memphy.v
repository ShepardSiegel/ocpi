...
module ddr3_s4_uniphy_p0_memphy(
	global_reset_n,
	soft_reset_n,
	reset_request_n,
	ctl_reset_n,
...
// ******************************************************************************************************************************** 
	...
	ddr3_s4_uniphy_p0_reset	ureset(
...
// ******************************************************************************************************************************** 
    ...
    ddr3_s4_uniphy_p0_nios_sequencer  usequencer(
...
// ******************************************************************************************************************************** 
	...
	ddr3_s4_uniphy_p0_afi_mux		uafi_mux(
		.mux_sel						(mux_sel),
...
// ******************************************************************************************************************************** 
    ...
    ddr3_s4_uniphy_p0_addr_cmd_datapath	uaddr_cmd_datapath(
...
// ******************************************************************************************************************************** 
    ...
    ddr3_s4_uniphy_p0_write_datapath	uwrite_datapath(
		.pll_afi_clk			(pll_afi_clk),
...
// ******************************************************************************************************************************** 
	...
	ddr3_s4_uniphy_p0_read_datapath	uread_datapath(
...
// ******************************************************************************************************************************** 
	ddr3_s4_uniphy_p0_new_io_pads uio_pads (
		.reset_n_addr_cmd_clk	(reset_n_addr_cmd_clk),
