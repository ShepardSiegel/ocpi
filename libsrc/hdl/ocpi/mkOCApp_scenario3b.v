...
//
// On Fri Jun 25 12:09:34 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkOCApp(RST_N_rst_0,
  ...
  // inlined wires
  wire [31 : 0] tieOff0_wci_Es_mData_w$wget, tieOff1_wci_Es_mData_w$wget;
  wire [19 : 0] tieOff0_wci_Es_mAddr_w$wget, tieOff1_wci_Es_mAddr_w$wget;
  wire [3 : 0] tieOff0_wci_Es_mByteEn_w$wget, tieOff1_wci_Es_mByteEn_w$wget;
  wire [2 : 0] tieOff0_wci_Es_mCmd_w$wget, tieOff1_wci_Es_mCmd_w$wget;
  ...
  // ports of submodule appW5
  wire [31 : 0] appW5$wciS0_MData,
		appW5$wciS0_SData,
		appW5$wsiM0_MData,
		appW5$wsiM1_MData,
		appW5$wsiS0_MData,
		appW5$wsiS1_MData;
  wire [19 : 0] appW5$wciS0_MAddr;
  wire [11 : 0] appW5$wsiM0_MBurstLength,
		appW5$wsiM1_MBurstLength,
		appW5$wsiS0_MBurstLength,
		appW5$wsiS1_MBurstLength;
  wire [7 : 0] appW5$wsiM0_MReqInfo,
	       appW5$wsiM1_MReqInfo,
	       appW5$wsiS0_MReqInfo,
	       appW5$wsiS1_MReqInfo;
  wire [3 : 0] appW5$wciS0_MByteEn,
	       appW5$wsiM0_MByteEn,
	       appW5$wsiM1_MByteEn,
	       appW5$wsiS0_MByteEn,
	       appW5$wsiS1_MByteEn;
  wire [2 : 0] appW5$wciS0_MCmd,
	       appW5$wsiM0_MCmd,
	       appW5$wsiM1_MCmd,
	       appW5$wsiS0_MCmd,
	       appW5$wsiS1_MCmd;
  wire [1 : 0] appW5$wciS0_MFlag, appW5$wciS0_SFlag, appW5$wciS0_SResp;
  wire appW5$wciS0_MAddrSpace,
       appW5$wciS0_SThreadBusy,
       appW5$wsiM0_MBurstPrecise,
       appW5$wsiM0_MReqLast,
       appW5$wsiM0_MReset_n,
       appW5$wsiM0_SReset_n,
       appW5$wsiM0_SThreadBusy,
       appW5$wsiM1_MBurstPrecise,
       appW5$wsiM1_MReqLast,
       appW5$wsiM1_MReset_n,
       appW5$wsiM1_SReset_n,
       appW5$wsiM1_SThreadBusy,
       appW5$wsiS0_MBurstPrecise,
       appW5$wsiS0_MReqLast,
       appW5$wsiS0_MReset_n,
       appW5$wsiS0_SReset_n,
       appW5$wsiS0_SThreadBusy,
       appW5$wsiS1_MBurstPrecise,
       appW5$wsiS1_MReqLast,
       appW5$wsiS1_MReset_n,
       appW5$wsiS1_SReset_n,
       appW5$wsiS1_SThreadBusy;

  // ports of submodule appW6
  wire [31 : 0] appW6$wciS0_MData,
		appW6$wciS0_SData,
		appW6$wsiM0_MData,
		appW6$wsiS0_MData;
  wire [19 : 0] appW6$wciS0_MAddr;
  wire [11 : 0] appW6$wsiM0_MBurstLength, appW6$wsiS0_MBurstLength;
  wire [7 : 0] appW6$wsiM0_MReqInfo, appW6$wsiS0_MReqInfo;
  wire [3 : 0] appW6$wciS0_MByteEn, appW6$wsiM0_MByteEn, appW6$wsiS0_MByteEn;
  wire [2 : 0] appW6$wciS0_MCmd, appW6$wsiM0_MCmd, appW6$wsiS0_MCmd;
  wire [1 : 0] appW6$wciS0_MFlag, appW6$wciS0_SFlag, appW6$wciS0_SResp;
  wire appW6$wciS0_MAddrSpace,
       appW6$wciS0_SThreadBusy,
       appW6$wsiM0_MBurstPrecise,
       appW6$wsiM0_MReqLast,
       appW6$wsiM0_MReset_n,
       appW6$wsiM0_SReset_n,
       appW6$wsiM0_SThreadBusy,
       appW6$wsiS0_MBurstPrecise,
       appW6$wsiS0_MReqLast,
       appW6$wsiS0_MReset_n,
       appW6$wsiS0_SReset_n,
       appW6$wsiS0_SThreadBusy;

  // ports of submodule appW7
  wire [31 : 0] appW7$wciS0_MData,
		appW7$wciS0_SData,
		appW7$wsiM0_MData,
		appW7$wsiS0_MData;
  wire [19 : 0] appW7$wciS0_MAddr;
  wire [11 : 0] appW7$wsiM0_MBurstLength, appW7$wsiS0_MBurstLength;
  wire [7 : 0] appW7$wsiM0_MReqInfo, appW7$wsiS0_MReqInfo;
  wire [3 : 0] appW7$wciS0_MByteEn, appW7$wsiM0_MByteEn, appW7$wsiS0_MByteEn;
  wire [2 : 0] appW7$wciS0_MCmd, appW7$wsiM0_MCmd, appW7$wsiS0_MCmd;
  wire [1 : 0] appW7$wciS0_MFlag, appW7$wciS0_SFlag, appW7$wciS0_SResp;
  wire appW7$wciS0_MAddrSpace,
       appW7$wciS0_SThreadBusy,
       appW7$wsiM0_MBurstPrecise,
       appW7$wsiM0_MReqLast,
       appW7$wsiM0_MReset_n,
       appW7$wsiM0_SReset_n,
       appW7$wsiM0_SThreadBusy,
       appW7$wsiS0_MBurstPrecise,
       appW7$wsiS0_MReqLast,
       appW7$wsiS0_MReset_n,
       appW7$wsiS0_SReset_n,
       appW7$wsiS0_SThreadBusy;
  ...
  wire CAN_FIRE_RL_mBurstLConnect,
       ...
       CAN_FIRE_RL_mBurstLConnect_5,
       CAN_FIRE_RL_mBurstPConnect,
       CAN_FIRE_RL_mBurstPConnect_1,
       CAN_FIRE_RL_mBurstPConnect_2,
       CAN_FIRE_RL_mBurstPConnect_3,
       CAN_FIRE_RL_mBurstPConnect_4,
       CAN_FIRE_RL_mBurstPConnect_5,
       CAN_FIRE_RL_mByteEnConnect,
       CAN_FIRE_RL_mByteEnConnect_1,
       CAN_FIRE_RL_mByteEnConnect_2,
       CAN_FIRE_RL_mByteEnConnect_3,
       CAN_FIRE_RL_mByteEnConnect_4,
       CAN_FIRE_RL_mByteEnConnect_5,
       ...
       WILL_FIRE_RL_mBurstLConnect_5,
       WILL_FIRE_RL_mBurstPConnect,
       WILL_FIRE_RL_mBurstPConnect_1,
       WILL_FIRE_RL_mBurstPConnect_2,
       WILL_FIRE_RL_mBurstPConnect_3,
       WILL_FIRE_RL_mBurstPConnect_4,
       WILL_FIRE_RL_mBurstPConnect_5,
       WILL_FIRE_RL_mByteEnConnect,
       WILL_FIRE_RL_mByteEnConnect_1,
       WILL_FIRE_RL_mByteEnConnect_2,
       WILL_FIRE_RL_mByteEnConnect_3,
       WILL_FIRE_RL_mByteEnConnect_4,
       WILL_FIRE_RL_mByteEnConnect_5,
  ...
  // value method wci_s_5_sResp
  assign wci_s_5_SResp = appW5$wciS0_SResp ;

  // value method wci_s_5_sData
  assign wci_s_5_SData = appW5$wciS0_SData ;

  // value method wci_s_5_sThreadBusy
  assign wci_s_5_SThreadBusy = appW5$wciS0_SThreadBusy ;

  // value method wci_s_5_sFlag
  assign wci_s_5_SFlag = appW5$wciS0_SFlag ;
  ...
  // value method wci_s_6_sResp
  assign wci_s_6_SResp = appW6$wciS0_SResp ;

  // value method wci_s_6_sData
  assign wci_s_6_SData = appW6$wciS0_SData ;

  // value method wci_s_6_sThreadBusy
  assign wci_s_6_SThreadBusy = appW6$wciS0_SThreadBusy ;

  // value method wci_s_6_sFlag
  assign wci_s_6_SFlag = appW6$wciS0_SFlag ;
  ...
  // value method wci_s_7_sResp
  assign wci_s_7_SResp = appW7$wciS0_SResp ;

  // value method wci_s_7_sData
  assign wci_s_7_SData = appW7$wciS0_SData ;

  // value method wci_s_7_sThreadBusy
  assign wci_s_7_SThreadBusy = appW7$wciS0_SThreadBusy ;

  // value method wci_s_7_sFlag
  assign wci_s_7_SFlag = appW7$wciS0_SFlag ;
  ...
  // value method wsi_s_adc_sThreadBusy
  assign wsi_s_adc_SThreadBusy = appW5$wsiS1_SThreadBusy ;

  // value method wsi_s_adc_sReset_n
  assign wsi_s_adc_SReset_n = appW5$wsiS1_SReset_n ;
  ...
  // submodule appW5
  mkWsiSplitter2x24B #(.ctrlInit(32'h0),
		       .hasDebugLogic(hasDebugLogic)) appW5(.wciS0_Clk(CLK),
							    .wciS0_MReset_n(RST_N_rst_5),
							    .wciS0_MAddr(appW5$wciS0_MAddr),
							    .wciS0_MAddrSpace(appW5$wciS0_MAddrSpace),
							    .wciS0_MByteEn(appW5$wciS0_MByteEn),
							    .wciS0_MCmd(appW5$wciS0_MCmd),
							    .wciS0_MData(appW5$wciS0_MData),
							    .wciS0_MFlag(appW5$wciS0_MFlag),
							    .wsiS0_MBurstLength(appW5$wsiS0_MBurstLength),
							    .wsiS0_MByteEn(appW5$wsiS0_MByteEn),
							    .wsiS0_MCmd(appW5$wsiS0_MCmd),
							    .wsiS0_MData(appW5$wsiS0_MData),
							    .wsiS0_MReqInfo(appW5$wsiS0_MReqInfo),
							    .wsiS1_MBurstLength(appW5$wsiS1_MBurstLength),
							    .wsiS1_MByteEn(appW5$wsiS1_MByteEn),
							    .wsiS1_MCmd(appW5$wsiS1_MCmd),
							    .wsiS1_MData(appW5$wsiS1_MData),
							    .wsiS1_MReqInfo(appW5$wsiS1_MReqInfo),
							    .wsiS0_MReqLast(appW5$wsiS0_MReqLast),
							    .wsiS0_MBurstPrecise(appW5$wsiS0_MBurstPrecise),
							    .wsiS0_MReset_n(appW5$wsiS0_MReset_n),
							    .wsiS1_MReqLast(appW5$wsiS1_MReqLast),
							    .wsiS1_MBurstPrecise(appW5$wsiS1_MBurstPrecise),
							    .wsiS1_MReset_n(appW5$wsiS1_MReset_n),
							    .wsiM0_SThreadBusy(appW5$wsiM0_SThreadBusy),
							    .wsiM0_SReset_n(appW5$wsiM0_SReset_n),
							    .wsiM1_SThreadBusy(appW5$wsiM1_SThreadBusy),
							    .wsiM1_SReset_n(appW5$wsiM1_SReset_n),
							    .wciS0_SResp(appW5$wciS0_SResp),
							    .wciS0_SData(appW5$wciS0_SData),
							    .wciS0_SThreadBusy(appW5$wciS0_SThreadBusy),
							    .wciS0_SFlag(appW5$wciS0_SFlag),
							    .wsiS0_SThreadBusy(appW5$wsiS0_SThreadBusy),
							    .wsiS0_SReset_n(appW5$wsiS0_SReset_n),
							    .wsiS1_SThreadBusy(appW5$wsiS1_SThreadBusy),
							    .wsiS1_SReset_n(appW5$wsiS1_SReset_n),
							    .wsiM0_MCmd(appW5$wsiM0_MCmd),
							    .wsiM0_MReqLast(appW5$wsiM0_MReqLast),
							    .wsiM0_MBurstPrecise(appW5$wsiM0_MBurstPrecise),
							    .wsiM0_MBurstLength(appW5$wsiM0_MBurstLength),
							    .wsiM0_MData(appW5$wsiM0_MData),
							    .wsiM0_MByteEn(appW5$wsiM0_MByteEn),
							    .wsiM0_MReqInfo(appW5$wsiM0_MReqInfo),
							    .wsiM0_MReset_n(appW5$wsiM0_MReset_n),
							    .wsiM1_MCmd(appW5$wsiM1_MCmd),
							    .wsiM1_MReqLast(appW5$wsiM1_MReqLast),
							    .wsiM1_MBurstPrecise(appW5$wsiM1_MBurstPrecise),
							    .wsiM1_MBurstLength(appW5$wsiM1_MBurstLength),
							    .wsiM1_MData(appW5$wsiM1_MData),
							    .wsiM1_MByteEn(appW5$wsiM1_MByteEn),
							    .wsiM1_MReqInfo(appW5$wsiM1_MReqInfo),
							    .wsiM1_MReset_n(appW5$wsiM1_MReset_n));

  // submodule appW6
  mkFrameGate4B #(.fgCtrlInit(32'h0),
		  .hasDebugLogic(hasDebugLogic)) appW6(.wciS0_Clk(CLK),
						       .wciS0_MReset_n(RST_N_rst_6),
						       .wciS0_MAddr(appW6$wciS0_MAddr),
						       .wciS0_MAddrSpace(appW6$wciS0_MAddrSpace),
						       .wciS0_MByteEn(appW6$wciS0_MByteEn),
						       .wciS0_MCmd(appW6$wciS0_MCmd),
						       .wciS0_MData(appW6$wciS0_MData),
						       .wciS0_MFlag(appW6$wciS0_MFlag),
						       .wsiS0_MBurstLength(appW6$wsiS0_MBurstLength),
						       .wsiS0_MByteEn(appW6$wsiS0_MByteEn),
						       .wsiS0_MCmd(appW6$wsiS0_MCmd),
						       .wsiS0_MData(appW6$wsiS0_MData),
						       .wsiS0_MReqInfo(appW6$wsiS0_MReqInfo),
						       .wsiS0_MReqLast(appW6$wsiS0_MReqLast),
						       .wsiS0_MBurstPrecise(appW6$wsiS0_MBurstPrecise),
						       .wsiS0_MReset_n(appW6$wsiS0_MReset_n),
						       .wsiM0_SThreadBusy(appW6$wsiM0_SThreadBusy),
						       .wsiM0_SReset_n(appW6$wsiM0_SReset_n),
						       .wciS0_SResp(appW6$wciS0_SResp),
						       .wciS0_SData(appW6$wciS0_SData),
						       .wciS0_SThreadBusy(appW6$wciS0_SThreadBusy),
						       .wciS0_SFlag(appW6$wciS0_SFlag),
						       .wsiS0_SThreadBusy(appW6$wsiS0_SThreadBusy),
						       .wsiS0_SReset_n(appW6$wsiS0_SReset_n),
						       .wsiM0_MCmd(appW6$wsiM0_MCmd),
						       .wsiM0_MReqLast(appW6$wsiM0_MReqLast),
						       .wsiM0_MBurstPrecise(appW6$wsiM0_MBurstPrecise),
						       .wsiM0_MBurstLength(appW6$wsiM0_MBurstLength),
						       .wsiM0_MData(appW6$wsiM0_MData),
						       .wsiM0_MByteEn(appW6$wsiM0_MByteEn),
						       .wsiM0_MReqInfo(appW6$wsiM0_MReqInfo),
						       .wsiM0_MReset_n(appW6$wsiM0_MReset_n));

  // submodule appW7
  mkPSD #(.psdCtrlInit(32'h0),
	  .hasDebugLogic(hasDebugLogic)) appW7(.wciS0_Clk(CLK),
					       .wciS0_MReset_n(RST_N_rst_7),
					       .wciS0_MAddr(appW7$wciS0_MAddr),
					       .wciS0_MAddrSpace(appW7$wciS0_MAddrSpace),
					       .wciS0_MByteEn(appW7$wciS0_MByteEn),
					       .wciS0_MCmd(appW7$wciS0_MCmd),
					       .wciS0_MData(appW7$wciS0_MData),
					       .wciS0_MFlag(appW7$wciS0_MFlag),
					       .wsiS0_MBurstLength(appW7$wsiS0_MBurstLength),
					       .wsiS0_MByteEn(appW7$wsiS0_MByteEn),
					       .wsiS0_MCmd(appW7$wsiS0_MCmd),
					       .wsiS0_MData(appW7$wsiS0_MData),
					       .wsiS0_MReqInfo(appW7$wsiS0_MReqInfo),
					       .wsiS0_MReqLast(appW7$wsiS0_MReqLast),
					       .wsiS0_MBurstPrecise(appW7$wsiS0_MBurstPrecise),
					       .wsiS0_MReset_n(appW7$wsiS0_MReset_n),
					       .wsiM0_SThreadBusy(appW7$wsiM0_SThreadBusy),
					       .wsiM0_SReset_n(appW7$wsiM0_SReset_n),
					       .wciS0_SResp(appW7$wciS0_SResp),
					       .wciS0_SData(appW7$wciS0_SData),
					       .wciS0_SThreadBusy(appW7$wciS0_SThreadBusy),
					       .wciS0_SFlag(appW7$wciS0_SFlag),
					       .wsiS0_SThreadBusy(appW7$wsiS0_SThreadBusy),
					       .wsiS0_SReset_n(appW7$wsiS0_SReset_n),
					       .wsiM0_MCmd(appW7$wsiM0_MCmd),
					       .wsiM0_MReqLast(appW7$wsiM0_MReqLast),
					       .wsiM0_MBurstPrecise(appW7$wsiM0_MBurstPrecise),
					       .wsiM0_MBurstLength(appW7$wsiM0_MBurstLength),
					       .wsiM0_MData(appW7$wsiM0_MData),
					       .wsiM0_MByteEn(appW7$wsiM0_MByteEn),
					       .wsiM0_MReqInfo(appW7$wsiM0_MReqInfo),
					       .wsiM0_MReset_n(appW7$wsiM0_MReset_n));

  // rule RL_sRstConnect_5
  assign CAN_FIRE_RL_sRstConnect_5 = appW4$wsiS1_SReset_n ;
  assign WILL_FIRE_RL_sRstConnect_5 = appW4$wsiS1_SReset_n ;

  // rule RL_mRstConnect_5
  assign CAN_FIRE_RL_mRstConnect_5 = appW3$wsiM1_MReset_n ;
  assign WILL_FIRE_RL_mRstConnect_5 = appW3$wsiM1_MReset_n ;

  // rule RL_stbConnect_5
  assign CAN_FIRE_RL_stbConnect_5 = appW4$wsiS1_SThreadBusy ;
  assign WILL_FIRE_RL_stbConnect_5 = appW4$wsiS1_SThreadBusy ;

  // rule RL_mDataIConnect_5
  assign CAN_FIRE_RL_mDataIConnect_5 = 1'd1 ;
  assign WILL_FIRE_RL_mDataIConnect_5 = 1'd1 ;

  // rule RL_mReqIConnect_5
  assign CAN_FIRE_RL_mReqIConnect_5 = 1'd1 ;
  assign WILL_FIRE_RL_mReqIConnect_5 = 1'd1 ;

  // rule RL_mByteEnConnect_5
  assign CAN_FIRE_RL_mByteEnConnect_5 = 1'd1 ;
  assign WILL_FIRE_RL_mByteEnConnect_5 = 1'd1 ;

  // rule RL_mDataConnect_5
  assign CAN_FIRE_RL_mDataConnect_5 = 1'd1 ;
  assign WILL_FIRE_RL_mDataConnect_5 = 1'd1 ;

  // rule RL_mBurstLConnect_5
  assign CAN_FIRE_RL_mBurstLConnect_5 = 1'd1 ;
  assign WILL_FIRE_RL_mBurstLConnect_5 = 1'd1 ;

  // rule RL_mBurstPConnect_5
  assign CAN_FIRE_RL_mBurstPConnect_5 = appW3$wsiM1_MBurstPrecise ;
  assign WILL_FIRE_RL_mBurstPConnect_5 = appW3$wsiM1_MBurstPrecise ;

  // rule RL_mCmdConnect_5
  assign CAN_FIRE_RL_mCmdConnect_5 = 1'd1 ;
  assign WILL_FIRE_RL_mCmdConnect_5 = 1'd1 ;

  // rule RL_mReqLConnect_5
  assign CAN_FIRE_RL_mReqLConnect_5 = appW3$wsiM1_MReqLast ;
  assign WILL_FIRE_RL_mReqLConnect_5 = appW3$wsiM1_MReqLast ;

  // rule RL_sRstConnect_4
  assign CAN_FIRE_RL_sRstConnect_4 = appW2$wsiS1_SReset_n ;
  assign WILL_FIRE_RL_sRstConnect_4 = appW2$wsiS1_SReset_n ;

  // rule RL_mRstConnect_4
  assign CAN_FIRE_RL_mRstConnect_4 = appW7$wsiM0_MReset_n ;
  assign WILL_FIRE_RL_mRstConnect_4 = appW7$wsiM0_MReset_n ;

  // rule RL_stbConnect_4
  assign CAN_FIRE_RL_stbConnect_4 = appW2$wsiS1_SThreadBusy ;
  assign WILL_FIRE_RL_stbConnect_4 = appW2$wsiS1_SThreadBusy ;
  ...
  // rule RL_mByteEnConnect_4
  assign CAN_FIRE_RL_mByteEnConnect_4 = 1'd1 ;
  assign WILL_FIRE_RL_mByteEnConnect_4 = 1'd1 ;

  // rule RL_mBurstLConnect_4
  assign CAN_FIRE_RL_mBurstLConnect_4 = 1'd1 ;
  assign WILL_FIRE_RL_mBurstLConnect_4 = 1'd1 ;

  // rule RL_mBurstPConnect_4
  assign CAN_FIRE_RL_mBurstPConnect_4 = appW7$wsiM0_MBurstPrecise ;
  assign WILL_FIRE_RL_mBurstPConnect_4 = appW7$wsiM0_MBurstPrecise ;

  // rule RL_mReqLConnect_4
  assign CAN_FIRE_RL_mReqLConnect_4 = appW7$wsiM0_MReqLast ;
  assign WILL_FIRE_RL_mReqLConnect_4 = appW7$wsiM0_MReqLast ;
  ...
  assign CAN_FIRE_RL_sRstConnect_3 = appW7$wsiS0_SReset_n ;
  assign WILL_FIRE_RL_sRstConnect_3 = appW7$wsiS0_SReset_n ;

  // rule RL_stbConnect_3
  assign CAN_FIRE_RL_stbConnect_3 = appW7$wsiS0_SThreadBusy ;
  assign WILL_FIRE_RL_stbConnect_3 = appW7$wsiS0_SThreadBusy ;

  // rule RL_mRstConnect_3
  assign CAN_FIRE_RL_mRstConnect_3 = appW6$wsiM0_MReset_n ;
  assign WILL_FIRE_RL_mRstConnect_3 = appW6$wsiM0_MReset_n ;
  ...
  // rule RL_mByteEnConnect_3
  assign CAN_FIRE_RL_mByteEnConnect_3 = 1'd1 ;
  assign WILL_FIRE_RL_mByteEnConnect_3 = 1'd1 ;
  ...
  assign CAN_FIRE_RL_mReqLConnect_3 = appW6$wsiM0_MReqLast ;
  assign WILL_FIRE_RL_mReqLConnect_3 = appW6$wsiM0_MReqLast ;

  // rule RL_mBurstPConnect_3
  assign CAN_FIRE_RL_mBurstPConnect_3 = appW6$wsiM0_MBurstPrecise ;
  assign WILL_FIRE_RL_mBurstPConnect_3 = appW6$wsiM0_MBurstPrecise ;
  ...
  assign CAN_FIRE_RL_sRstConnect_2 = appW6$wsiS0_SReset_n ;
  assign WILL_FIRE_RL_sRstConnect_2 = appW6$wsiS0_SReset_n ;

  // rule RL_mRstConnect_2
  assign CAN_FIRE_RL_mRstConnect_2 = appW5$wsiM1_MReset_n ;
  assign WILL_FIRE_RL_mRstConnect_2 = appW5$wsiM1_MReset_n ;

  // rule RL_stbConnect_2
  assign CAN_FIRE_RL_stbConnect_2 = appW6$wsiS0_SThreadBusy ;
  assign WILL_FIRE_RL_stbConnect_2 = appW6$wsiS0_SThreadBusy ;
  ...
  assign CAN_FIRE_RL_mBurstPConnect_2 = appW5$wsiM1_MBurstPrecise ;
  assign WILL_FIRE_RL_mBurstPConnect_2 = appW5$wsiM1_MBurstPrecise ;

  // rule RL_mReqLConnect_2
  assign CAN_FIRE_RL_mReqLConnect_2 = appW5$wsiM1_MReqLast ;
  assign WILL_FIRE_RL_mReqLConnect_2 = appW5$wsiM1_MReqLast ;
  ...
  assign CAN_FIRE_RL_mRstConnect_1 = appW5$wsiM0_MReset_n ;
  assign WILL_FIRE_RL_mRstConnect_1 = appW5$wsiM0_MReset_n ;

  // rule RL_sRstConnect_1
  assign CAN_FIRE_RL_sRstConnect_1 = appW3$wsiS1_SReset_n ;
  assign WILL_FIRE_RL_sRstConnect_1 = appW3$wsiS1_SReset_n ;

  // rule RL_stbConnect_1
  assign CAN_FIRE_RL_stbConnect_1 = appW3$wsiS1_SThreadBusy ;
  assign WILL_FIRE_RL_stbConnect_1 = appW3$wsiS1_SThreadBusy ;
  ...
  assign CAN_FIRE_RL_mBurstPConnect_1 = appW5$wsiM0_MBurstPrecise ;
  assign WILL_FIRE_RL_mBurstPConnect_1 = appW5$wsiM0_MBurstPrecise ;
  ...
  assign CAN_FIRE_RL_mReqLConnect_1 = appW5$wsiM0_MReqLast ;
  assign WILL_FIRE_RL_mReqLConnect_1 = appW5$wsiM0_MReqLast ;
  ...
  // rule RL_sRstConnect
  assign CAN_FIRE_RL_sRstConnect = appW5$wsiS0_SReset_n ;
  assign WILL_FIRE_RL_sRstConnect = appW5$wsiS0_SReset_n ;
  ...
  // rule RL_stbConnect
  assign CAN_FIRE_RL_stbConnect = appW5$wsiS0_SThreadBusy ;
  assign WILL_FIRE_RL_stbConnect = appW5$wsiS0_SThreadBusy ;
  ...
  assign appW2$wsiS1_MBurstLength = appW7$wsiM0_MBurstLength ;
  assign appW2$wsiS1_MByteEn = appW7$wsiM0_MByteEn ;
  assign appW2$wsiS1_MCmd = appW7$wsiM0_MCmd ;
  assign appW2$wsiS1_MData = appW7$wsiM0_MData ;
  assign appW2$wsiS1_MReqInfo = appW7$wsiM0_MReqInfo ;
  ...
  assign appW2$wsiM1_SReset_n = appW5$wsiS0_SReset_n ;
  assign appW2$wsiM1_SThreadBusy = appW5$wsiS0_SThreadBusy ;
  assign appW2$wsiS1_MBurstPrecise = appW7$wsiM0_MBurstPrecise ;
  assign appW2$wsiS1_MReqLast = appW7$wsiM0_MReqLast ;
  assign appW2$wsiS1_MReset_n = appW7$wsiM0_MReset_n ;
  ...
  assign appW3$wsiS1_MBurstLength = appW5$wsiM0_MBurstLength ;
  assign appW3$wmemiM_SResp = wmemiM_SResp ;
  assign appW3$wsiS1_MByteEn = appW5$wsiM0_MByteEn ;
  assign appW3$wsiS1_MCmd = appW5$wsiM0_MCmd ;
  assign appW3$wsiS1_MData = appW5$wsiM0_MData ;
  assign appW3$wsiS1_MReqInfo = appW5$wsiM0_MReqInfo ;
  ...
  assign appW3$wsiS1_MBurstPrecise = appW5$wsiM0_MBurstPrecise ;
  assign appW3$wsiS1_MReqLast = appW5$wsiM0_MReqLast ;
  assign appW3$wsiS1_MReset_n = appW5$wsiM0_MReset_n ;
  ...
  // submodule appW5
  assign appW5$wciS0_MAddr = wci_s_5_MAddr ;
  assign appW5$wciS0_MAddrSpace = wci_s_5_MAddrSpace ;
  assign appW5$wciS0_MByteEn = wci_s_5_MByteEn ;
  assign appW5$wciS0_MCmd = wci_s_5_MCmd ;
  assign appW5$wciS0_MData = wci_s_5_MData ;
  assign appW5$wciS0_MFlag = wci_s_5_MFlag ;
  assign appW5$wsiS0_MBurstLength = appW2$wsiM1_MBurstLength ;
  assign appW5$wsiS0_MByteEn = appW2$wsiM1_MByteEn ;
  assign appW5$wsiS0_MCmd = appW2$wsiM1_MCmd ;
  assign appW5$wsiS0_MData = appW2$wsiM1_MData ;
  assign appW5$wsiS0_MReqInfo = appW2$wsiM1_MReqInfo ;
  assign appW5$wsiS1_MBurstLength = wsi_s_adc_MBurstLength ;
  assign appW5$wsiS1_MByteEn = wsi_s_adc_MByteEn ;
  assign appW5$wsiS1_MCmd = wsi_s_adc_MCmd ;
  assign appW5$wsiS1_MData = wsi_s_adc_MData ;
  assign appW5$wsiS1_MReqInfo = wsi_s_adc_MReqInfo ;
  assign appW5$wsiM0_SReset_n = appW3$wsiS1_SReset_n ;
  assign appW5$wsiM0_SThreadBusy = appW3$wsiS1_SThreadBusy ;
  assign appW5$wsiM1_SReset_n = appW6$wsiS0_SReset_n ;
  assign appW5$wsiM1_SThreadBusy = appW6$wsiS0_SThreadBusy ;
  assign appW5$wsiS0_MBurstPrecise = appW2$wsiM1_MBurstPrecise ;
  assign appW5$wsiS0_MReset_n = appW2$wsiM1_MReset_n ;
  assign appW5$wsiS0_MReqLast = appW2$wsiM1_MReqLast ;
  assign appW5$wsiS1_MBurstPrecise = wsi_s_adc_MBurstPrecise ;
  assign appW5$wsiS1_MReset_n = wsi_s_adc_MReset_n ;
  assign appW5$wsiS1_MReqLast = wsi_s_adc_MReqLast ;

  // submodule appW6
  assign appW6$wciS0_MAddr = wci_s_6_MAddr ;
  assign appW6$wciS0_MAddrSpace = wci_s_6_MAddrSpace ;
  assign appW6$wciS0_MByteEn = wci_s_6_MByteEn ;
  assign appW6$wciS0_MCmd = wci_s_6_MCmd ;
  assign appW6$wciS0_MData = wci_s_6_MData ;
  assign appW6$wciS0_MFlag = wci_s_6_MFlag ;
  assign appW6$wsiS0_MByteEn = appW5$wsiM1_MByteEn ;
  assign appW6$wsiS0_MBurstLength = appW5$wsiM1_MBurstLength ;
  assign appW6$wsiS0_MCmd = appW5$wsiM1_MCmd ;
  assign appW6$wsiS0_MData = appW5$wsiM1_MData ;
  assign appW6$wsiS0_MReqInfo = appW5$wsiM1_MReqInfo ;
  assign appW6$wsiM0_SReset_n = appW7$wsiS0_SReset_n ;
  assign appW6$wsiM0_SThreadBusy = appW7$wsiS0_SThreadBusy ;
  assign appW6$wsiS0_MBurstPrecise = appW5$wsiM1_MBurstPrecise ;
  assign appW6$wsiS0_MReqLast = appW5$wsiM1_MReqLast ;
  assign appW6$wsiS0_MReset_n = appW5$wsiM1_MReset_n ;

  // submodule appW7
  assign appW7$wciS0_MAddr = wci_s_7_MAddr ;
  assign appW7$wciS0_MAddrSpace = wci_s_7_MAddrSpace ;
  assign appW7$wciS0_MByteEn = wci_s_7_MByteEn ;
  assign appW7$wciS0_MCmd = wci_s_7_MCmd ;
  assign appW7$wciS0_MFlag = wci_s_7_MFlag ;
  assign appW7$wciS0_MData = wci_s_7_MData ;
  assign appW7$wsiS0_MBurstLength = appW6$wsiM0_MBurstLength ;
  assign appW7$wsiS0_MByteEn = appW6$wsiM0_MByteEn ;
  assign appW7$wsiS0_MCmd = appW6$wsiM0_MCmd ;
  assign appW7$wsiS0_MData = appW6$wsiM0_MData ;
  assign appW7$wsiS0_MReqInfo = appW6$wsiM0_MReqInfo ;
  assign appW7$wsiM0_SReset_n = appW2$wsiS1_SReset_n ;
  assign appW7$wsiM0_SThreadBusy = appW2$wsiS1_SThreadBusy ;
  assign appW7$wsiS0_MBurstPrecise = appW6$wsiM0_MBurstPrecise ;
  assign appW7$wsiS0_MReqLast = appW6$wsiM0_MReqLast ;
  assign appW7$wsiS0_MReset_n = appW6$wsiM0_MReset_n ;
endmodule  // mkOCApp
