...
//
// On Fri Dec 17 10:00:35 EST 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkOCApp4B(RST_N_rst_0,
  ...
  assign CAN_FIRE_RL_stbConnect_1 = appW3$wsiS0_SThreadBusy ;
  assign WILL_FIRE_RL_stbConnect_1 = appW3$wsiS0_SThreadBusy ;
  ...
  assign CAN_FIRE_RL_stbConnect_4 = appW2$wsiS0_SThreadBusy ;
  assign WILL_FIRE_RL_stbConnect_4 = appW2$wsiS0_SThreadBusy ;
  ...
  assign CAN_FIRE_RL_sRstConnect_4 = appW2$wsiS0_SReset_n ;
  assign WILL_FIRE_RL_sRstConnect_4 = appW2$wsiS0_SReset_n ;
  ...
  assign CAN_FIRE_RL_mReqLConnect_5 = appW3$wsiM0_MReqLast ;
  assign WILL_FIRE_RL_mReqLConnect_5 = appW3$wsiM0_MReqLast ;

  // rule RL_mBurstPConnect_5
  assign CAN_FIRE_RL_mBurstPConnect_5 = appW3$wsiM0_MBurstPrecise ;
  assign WILL_FIRE_RL_mBurstPConnect_5 = appW3$wsiM0_MBurstPrecise ;
  ...
  assign CAN_FIRE_RL_stbConnect_5 = appW4$wsiS0_SThreadBusy ;
  assign WILL_FIRE_RL_stbConnect_5 = appW4$wsiS0_SThreadBusy ;

  // rule RL_mRstConnect_5
  assign CAN_FIRE_RL_mRstConnect_5 = appW3$wsiM0_MReset_n ;
  assign WILL_FIRE_RL_mRstConnect_5 = appW3$wsiM0_MReset_n ;

  // rule RL_sRstConnect_5
  assign CAN_FIRE_RL_sRstConnect_5 = appW4$wsiS0_SReset_n ;
  assign WILL_FIRE_RL_sRstConnect_5 = appW4$wsiS0_SReset_n ;
  ...
  assign appW2$wsiS0_MBurstLength = appW7$wsiM0_MBurstLength ;
  assign appW2$wsiS0_MByteEn = appW7$wsiM0_MByteEn ;
  assign appW2$wsiS0_MCmd = appW7$wsiM0_MCmd ;
  assign appW2$wsiS0_MData = appW7$wsiM0_MData ;
  assign appW2$wsiS0_MReqInfo = appW7$wsiM0_MReqInfo ;
  ...
  assign appW2$wsiM0_SThreadBusy = appW5$wsiS0_SThreadBusy ;
  assign appW2$wsiM0_SReset_n = appW5$wsiS0_SReset_n ;
  assign appW2$wsiS0_MReqLast = appW7$wsiM0_MReqLast ;
  assign appW2$wsiS0_MBurstPrecise = appW7$wsiM0_MBurstPrecise ;
  assign appW2$wsiS0_MReset_n = appW7$wsiM0_MReset_n ;
  ...
  assign appW3$wsiS0_MBurstLength = appW5$wsiM0_MBurstLength ;
  assign appW3$wsiS0_MByteEn = appW5$wsiM0_MByteEn ;
  assign appW3$wsiS0_MCmd = appW5$wsiM0_MCmd ;
  assign appW3$wsiS0_MData = appW5$wsiM0_MData ;
  assign appW3$wsiS0_MReqInfo = appW5$wsiM0_MReqInfo ;
  assign appW3$wsiS0_MReqLast = appW5$wsiM0_MReqLast ;
  assign appW3$wsiS0_MBurstPrecise = appW5$wsiM0_MBurstPrecise ;
  assign appW3$wsiS0_MReset_n = appW5$wsiM0_MReset_n ;
  ...
  assign appW5$wsiS0_MBurstLength = appW2$wsiM0_MBurstLength ;
  assign appW5$wsiS0_MByteEn = appW2$wsiM0_MByteEn ;
  assign appW5$wsiS0_MCmd = appW2$wsiM0_MCmd ;
  assign appW5$wsiS0_MData = appW2$wsiM0_MData ;
  assign appW5$wsiS0_MReqInfo = appW2$wsiM0_MReqInfo ;
  ...
  assign appW5$wsiS0_MReqLast = appW2$wsiM0_MReqLast ;
  assign appW5$wsiS0_MBurstPrecise = appW2$wsiM0_MBurstPrecise ;
  assign appW5$wsiS0_MReset_n = appW2$wsiM0_MReset_n ;
  ...
  assign appW5$wsiM0_SThreadBusy = appW3$wsiS0_SThreadBusy ;
  assign appW5$wsiM0_SReset_n = appW3$wsiS0_SReset_n ;
  ...
  assign appW7$wsiM0_SThreadBusy = appW2$wsiS0_SThreadBusy ;
  assign appW7$wsiM0_SReset_n = appW2$wsiS0_SReset_n ;
endmodule  // mkOCApp4B
