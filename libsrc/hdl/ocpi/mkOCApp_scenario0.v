...
//
// On Fri Oct 15 09:46:38 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkOCApp(RST_N_rst_0,
  ...
  wire [11 : 0] appW3$wsiM1_MBurstLength, appW3$wsiS1_MBurstLength;
  wire [7 : 0] appW3$wsiM1_MReqInfo, appW3$wsiS1_MReqInfo;
  wire [3 : 0] appW3$wciS0_MByteEn, appW3$wsiM1_MByteEn, appW3$wsiS1_MByteEn;
  wire [2 : 0] appW3$wciS0_MCmd, appW3$wsiM1_MCmd, appW3$wsiS1_MCmd;
  ...
  // submodule appW3
  mkBiasWorker #(.hasDebugLogic(hasDebugLogic)) appW3(.wciS0_Clk(CLK),
