...
//
// On Sat Oct 30 16:29:16 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkOCApp(RST_N_rst_0,
  ...
  reg [63 : 0] v__h10137, v__h10625, v__h3280, v__h3438, v__h4337;
  reg [31 : 0] _theResult____h10121;
  wire [31 : 0] rdat__h10206,
		rdat__h10306,
		rdat__h10320,
		rdat__h10328,
		rdat__h10334,
		...
		x_data__h10898;
  wire [15 : 0] x__h10210;
  wire appW3_wsiS_reqFifo_notFull__49_AND_appW3_wsiS__ETC___d269;
  ...
  assign appW3_wsiS_peerIsReady_1$whas = appW2$wsiM1_MReset_n ;
  ...
  assign appW3_wsiM_reqFifo_dequeueing$whas =
	     CAN_FIRE_RL_appW3_wsiM_reqFifo_deq ;
  assign appW3_wsiM_sThreadBusy_pw$whas = appW4$wsiS1_SThreadBusy ;
  assign appW3_wsiM_operateD_1$wget = 1'd1 ;
  assign appW3_wsiM_peerIsReady_1$wget = 1'd1 ;
  assign appW3_wsiM_peerIsReady_1$whas = appW4$wsiS1_SReset_n ;
  ...
  assign appW3_wsi_Es_mCmd_w$wget = appW2$wsiM1_MCmd ;
  assign appW3_wsi_Es_mReqLast_w$whas = appW2$wsiM1_MReqLast ;
  assign appW3_wsi_Es_mCmd_w$whas = 1'd1 ;
  assign appW3_wsi_Es_mBurstPrecise_w$whas = appW2$wsiM1_MBurstPrecise ;
  assign appW3_wsi_Es_mBurstLength_w$wget = appW2$wsiM1_MBurstLength ;
  assign appW3_wsi_Es_mBurstLength_w$whas = 1'd1 ;
  assign appW3_wsi_Es_mData_w$wget = appW2$wsiM1_MData ;
  assign appW3_wsi_Es_mByteEn_w$wget = appW2$wsiM1_MByteEn ;
  assign appW3_wsi_Es_mData_w$whas = 1'd1 ;
  assign appW3_wsi_Es_mByteEn_w$whas = 1'd1 ;
  assign appW3_wsi_Es_mReqInfo_w$whas = 1'd1 ;
  assign appW3_wsi_Es_mReqInfo_w$wget = appW2$wsiM1_MReqInfo ;
  ...
  // register appW3_wsiM_peerIsReady
  assign appW3_wsiM_peerIsReady$D_IN = appW4$wsiS1_SReset_n ;
  ...
  // register appW3_wsiM_sThreadBusy_d
  assign appW3_wsiM_sThreadBusy_d$D_IN = appW4$wsiS1_SThreadBusy ;
  ...
  assign appW3_wsiS_burstKind$EN =
	     WILL_FIRE_RL_appW3_wsiS_reqFifo_enq &&
	     appW3_wsiS_reqFifo_notFull__49_AND_appW3_wsiS__ETC___d269 ;
  ...
  // register appW3_wsiS_peerIsReady
  assign appW3_wsiS_peerIsReady$D_IN = appW2$wsiM1_MReset_n ;
  ...
  assign appW2$wsiM1_SReset_n = CAN_FIRE_RL_sRstConnect ;
  assign appW2$wmiM_SThreadBusy = wmiM0_SThreadBusy ;
  assign appW2$wsiM1_SThreadBusy = CAN_FIRE_RL_stbConnect ;
  ...
  assign appW4$wsiS1_MBurstLength =
	     appW3_wsiM_sThreadBusy_d ?
	       12'd0 :
	       appW3_wsiM_reqFifo_q_0[55:44] ;
  assign appW4$wsiS1_MCmd =
	     appW3_wsiM_sThreadBusy_d ? 3'd0 : appW3_wsiM_reqFifo_q_0[60:58] ;
  assign appW4$wsiS1_MByteEn = appW3_wsiM_reqFifo_q_0[11:8] ;
  assign appW4$wsiS1_MData = appW3_wsiM_reqFifo_q_0[43:12] ;
  assign appW4$wsiS1_MReqInfo =
  ...
  assign appW4$wsiS1_MBurstPrecise = CAN_FIRE_RL_mBurstPConnect_1 ;
  assign appW4$wsiS1_MReqLast = CAN_FIRE_RL_mReqLConnect_1 ;
  assign appW4$wsiS1_MReset_n = CAN_FIRE_RL_mRstConnect_1 ;

  // remaining internal signals
  assign appW3_wsiS_reqFifo_notFull__49_AND_appW3_wsiS__ETC___d269 =
	     appW3_wsiS_reqFifo$FULL_N &&
	     (appW3_wsiS_burstKind == 2'd0 ||
	      (appW3_wsiS_burstKind == 2'd1 ||
	       appW3_wsiS_burstKind == 2'd2) &&
	      appW3_wsiS_wsiReq$wget[57]) ;
  assign rdat__h10206 = hasDebugLogic ? { 16'd0, x__h10210 } : 32'd0 ;
  assign rdat__h10306 =
  ...
  assign x__h10210 = { appW3_wsiS_statusR, appW3_wsiM_statusR } ;
  assign x_data__h10898 = appW3_wsiS_reqFifo$D_OUT[43:12] + appW3_biasValue ;
  always@(appW3_wci_reqF$D_OUT or
	  ...
	  rdat__h10306 or
	  rdat__h10320 or
	  rdat__h10328 or rdat__h10334 or rdat__h10348 or rdat__h10356)
  begin
    case (appW3_wci_reqF$D_OUT[39:32])
      8'h0: _theResult____h10121 = appW3_biasValue;
      8'h04: _theResult____h10121 = appW3_controlReg;
      8'h20: _theResult____h10121 = rdat__h10206;
      8'h24: _theResult____h10121 = rdat__h10306;
      8'h28: _theResult____h10121 = rdat__h10320;
      8'h2C: _theResult____h10121 = rdat__h10328;
      8'h30: _theResult____h10121 = rdat__h10334;
      8'h34: _theResult____h10121 = rdat__h10348;
      8'h38: _theResult____h10121 = rdat__h10356;
      default: _theResult____h10121 = 32'd0;
    endcase
  end
