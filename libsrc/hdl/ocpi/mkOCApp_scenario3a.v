...
//
// On Mon Jun 21 17:18:47 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkOCApp_scenario3a(RST_N_rst_0,
			  RST_N_rst_1,
			  RST_N_rst_2,
			  RST_N_rst_3,
			  RST_N_rst_4,
  ...
  // submodule appW5
  mkWsiSplitter2x24B #(.ctrlInit(32'h0)) appW5(.wciS0_Clk(CLK),
  ...
  // submodule appW6
  mkFrameGate4B #(.fgCtrlInit(32'h0)) appW6(.wciS0_Clk(CLK),
  ...
  assign CAN_FIRE_RL_sRstConnect_4 = appW4$wsiS1_SReset_n ;
  assign WILL_FIRE_RL_sRstConnect_4 = appW4$wsiS1_SReset_n ;

  // rule RL_mRstConnect_4
  assign CAN_FIRE_RL_mRstConnect_4 = appW3$wsiM1_MReset_n ;
  assign WILL_FIRE_RL_mRstConnect_4 = appW3$wsiM1_MReset_n ;

  // rule RL_stbConnect_4
  assign CAN_FIRE_RL_stbConnect_4 = appW4$wsiS1_SThreadBusy ;
  assign WILL_FIRE_RL_stbConnect_4 = appW4$wsiS1_SThreadBusy ;
  ...
  assign CAN_FIRE_RL_mReqLConnect_4 = appW3$wsiM1_MReqLast ;
  assign WILL_FIRE_RL_mReqLConnect_4 = appW3$wsiM1_MReqLast ;

  // rule RL_mBurstPConnect_4
  assign CAN_FIRE_RL_mBurstPConnect_4 = appW3$wsiM1_MBurstPrecise ;
  assign WILL_FIRE_RL_mBurstPConnect_4 = appW3$wsiM1_MBurstPrecise ;
  ...
  assign CAN_FIRE_RL_sRstConnect_3 = appW2$wsiS1_SReset_n ;
  assign WILL_FIRE_RL_sRstConnect_3 = appW2$wsiS1_SReset_n ;
  ...
  assign CAN_FIRE_RL_stbConnect_3 = appW2$wsiS1_SThreadBusy ;
  assign WILL_FIRE_RL_stbConnect_3 = appW2$wsiS1_SThreadBusy ;
  ...
  assign appW2$wsiS1_MBurstLength = appW6$wsiM0_MBurstLength ;
  assign appW2$wsiS1_MByteEn = appW6$wsiM0_MByteEn ;
  assign appW2$wsiS1_MCmd = appW6$wsiM0_MCmd ;
  assign appW2$wsiS1_MData = appW6$wsiM0_MData ;
  assign appW2$wsiS1_MReqInfo = appW6$wsiM0_MReqInfo ;
  ...
  assign appW2$wsiS1_MBurstPrecise = appW6$wsiM0_MBurstPrecise ;
  assign appW2$wsiS1_MReqLast = appW6$wsiM0_MReqLast ;
  assign appW2$wsiS1_MReset_n = appW6$wsiM0_MReset_n ;
  ...
  assign appW6$wsiM0_SReset_n = appW2$wsiS1_SReset_n ;
  assign appW6$wsiM0_SThreadBusy = appW2$wsiS1_SThreadBusy ;
