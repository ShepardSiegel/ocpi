...
//
// On Fri Dec 17 09:51:22 EST 2010
//
//
// Ports:
// Name                         I/O  size props
...
// pci0_reset_n_adx_srst          O     1 reset
...
module mkFTop(sys0_clkp,
  ...
  wire [6 : 0] adcW10$adc0_ddn_arg,
	       ...
	       adcW10$adc1_ddn_arg,
	       adcW10$adc1_ddp_arg;
  wire [3 : 0] adcW10$wsiM0_MByteEn;
  wire [2 : 0] adcW10$wsiM0_MCmd;
  ...
  wire [3 : 0] dacW11$wsiS0_MByteEn;
  wire [2 : 0] dacW11$wsiS0_MCmd;
  ...
  wire [127 : 0] put_data__h4139, wOut_data__h4217;
  wire [15 : 0] pci0_pcie_ep_cfg_bus_number__32_CONCAT_pci0_pc_ETC___d245,
		put_be__h4138,
		wOut_be__h4216;
  ...
  assign pci0_reset_n_adx_srst = adcW10$RST_N_adx_srst ;
  ...
  // submodule ctop
  mkCTop4B ctop(.pciDevice(pci0_pcie_ep_cfg_bus_number__32_CONCAT_pci0_pc_ETC___d245),
  ...
  assign CAN_FIRE_RL_mReqLConnect = adcW10$wsiM0_MReqLast ;
  assign WILL_FIRE_RL_mReqLConnect = adcW10$wsiM0_MReqLast ;

  // rule RL_mBurstPConnect
  assign CAN_FIRE_RL_mBurstPConnect = adcW10$wsiM0_MBurstPrecise ;
  assign WILL_FIRE_RL_mBurstPConnect = adcW10$wsiM0_MBurstPrecise ;
  ...
  // rule RL_mRstConnect
  assign CAN_FIRE_RL_mRstConnect = adcW10$wsiM0_MReset_n ;
  assign WILL_FIRE_RL_mRstConnect = adcW10$wsiM0_MReset_n ;
  ...
  assign CAN_FIRE_RL_stbConnect_8 = dacW11$wsiS0_SThreadBusy ;
  assign WILL_FIRE_RL_stbConnect_8 = dacW11$wsiS0_SThreadBusy ;
  ...
  assign CAN_FIRE_RL_sRstConnect_1 = dacW11$wsiS0_SReset_n ;
  assign WILL_FIRE_RL_sRstConnect_1 = dacW11$wsiS0_SReset_n ;
  ...
  assign MUX_ctop$server_request_put_1__VAL_1 =
	     { fP2I$D_OUT[80:72], put_be__h4138, put_data__h4139 } ;
  ...
  // remaining internal signals
  assign pci0_pcie_ep_cfg_bus_number__32_CONCAT_pci0_pc_ETC___d245 =
	     { pci0_pcie_ep$cfg_bus_number,
	       pci0_pcie_ep$cfg_device_number,
	       pci0_pcie_ep$cfg_function_number } ;
  assign put_be__h4138 = { fP2I$D_OUT[71:64], 8'd0 } ;
  assign put_data__h4139 = { fP2I$D_OUT[63:0], 64'hAAAAAAAAAAAAAAAA } ;
  assign wOut_be__h4216 =
	     { Prelude_inst_changeSpecialWires_rg[71:64],
	       fP2I$D_OUT[71:64] } ;
  assign wOut_data__h4217 =
