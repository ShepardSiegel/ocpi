...
//
// On Tue Jan  4 18:39:08 EST 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkFTop(sys0_clkp,
  ...
  wire [59 : 0] MUX_icap$wci_s_putreq_1__VAL_2;
  ...
  // value method led
  assign led = { 10'b1010000000, infLed$WGET, pciw_pciLinkUp$dD_OUT } ;
  ...
  assign WILL_FIRE_RL_icapwci_Es_doAlways_Req = 1'b0 ;
  ...
  assign MUX_pciw_p2iS$write_1__SEL_1 =
	     WILL_FIRE_RL_pciw_Prelude_inst_changeSpecialWires_1_upconv_connect1 &&
	     pciw_fP2I$D_OUT[79] ;
  assign MUX_icap$wci_s_putreq_1__VAL_2 =
	     { ctop$wci_m_0_MCmd,
	       ctop$wci_m_0_MAddrSpace,
  ...
  assign icapwci_Es_mCmd_w$wget = 3'h0 ;
  assign icapwci_Es_mCmd_w$whas = 1'b0 ;
  assign icapwci_Es_mAddrSpace_w$wget = 1'b0 ;
  assign icapwci_Es_mAddrSpace_w$whas = 1'b0 ;
  assign icapwci_Es_mAddr_w$wget = 20'h0 ;
  assign icapwci_Es_mAddr_w$whas = 1'b0 ;
  assign icapwci_Es_mData_w$wget = 32'h0 ;
  assign icapwci_Es_mData_w$whas = 1'b0 ;
  assign icapwci_Es_mByteEn_w$wget = 4'h0 ;
  assign icapwci_Es_mByteEn_w$whas = 1'b0 ;
  ...
  assign icap$wci_s_req = MUX_icap$wci_s_putreq_1__VAL_2 ;
