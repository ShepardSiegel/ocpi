...
//
// On Sun Nov 14 13:44:21 EST 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkFTop(sys0_clkp,
  ...
  wire [127 : 0] val_data__h6289, wOut_data__h6395;
  wire [15 : 0] val_be__h6288, wOut_be__h6394;
  wire p2iAF_head_wrapped_crossed__8_EQ_p2iAF_tail_wr_ETC___d98;
  ...
  assign CAN_FIRE_RL_Prelude_inst_changeSpecialWires_1_upconv_connect1 =
	     fP2I$EMPTY_N &&
	     (!fP2I$D_OUT[79] ||
	      p2iAF_head_wrapped_crossed__8_EQ_p2iAF_tail_wr_ETC___d98) &&
  ...
  assign MUX_p2iS$write_1__VAL_1 =
	     { fP2I$D_OUT[80:72], val_be__h6288, val_data__h6289 } ;
  ...
  // remaining internal signals
  assign p2iAF_head_wrapped_crossed__8_EQ_p2iAF_tail_wr_ETC___d98 =
	     p2iAF_head_wrapped == p2iAF_tail_wrapped &&
	     !p2iAF_sInReset$VAL &&
	     preEdge$CLK_VAL ;
  assign val_be__h6288 = { fP2I$D_OUT[71:64], 8'd0 } ;
  assign val_data__h6289 = { fP2I$D_OUT[63:0], 64'hAAAAAAAAAAAAAAAA } ;
  assign wOut_be__h6394 =
	     { Prelude_inst_changeSpecialWires_1_rg[71:64],
	       fP2I$D_OUT[71:64] } ;
  assign wOut_data__h6395 =
