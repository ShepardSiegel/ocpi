...
//
// On Mon Nov 22 13:27:50 EST 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkFTop(sys0_clkp,
  ...
  wire [32 : 0] pmemMonW8_pmemF$D_IN, pmemMonW8_pmemF$D_OUT;
  ...
  wire [32 : 0] wciMonW8$pmem_get;
  wire [31 : 0] wciMonW8$wciO0_MData, wciMonW8$wciO0_SData;
  wire [19 : 0] wciMonW8$wciO0_MAddr;
  wire [3 : 0] wciMonW8$wciO0_MByteEn;
  wire [2 : 0] wciMonW8$wciO0_MCmd;
  wire [1 : 0] wciMonW8$wciO0_MFlag,
	       wciMonW8$wciO0_SFlag,
	       wciMonW8$wciO0_SResp;
  wire wciMonW8$EN_pmem_get,
       wciMonW8$RDY_pmem_get,
       wciMonW8$wciO0_MAddrSpace,
       wciMonW8$wciO0_SThreadBusy;
  ...
  FIFO2 #(.width(32'd33),
	  .guarded(32'd1)) pmemMonW8_pmemF(.RST_N(pci0_reset_n),
					   .CLK(pci0_pcie_ep$trn2_clk),
  ...
  // submodule wciMonW8
  mkWciOcpMonitor wciMonW8(.monId(8'h42),
			   .CLK(pci0_pcie_ep$trn2_clk),
			   .RST_N(pci0_reset_n),
			   .wciO0_MAddr(wciMonW8$wciO0_MAddr),
			   .wciO0_MAddrSpace(wciMonW8$wciO0_MAddrSpace),
			   .wciO0_MByteEn(wciMonW8$wciO0_MByteEn),
			   .wciO0_MCmd(wciMonW8$wciO0_MCmd),
			   .wciO0_MData(wciMonW8$wciO0_MData),
			   .wciO0_MFlag(wciMonW8$wciO0_MFlag),
			   .wciO0_SData(wciMonW8$wciO0_SData),
			   .wciO0_SFlag(wciMonW8$wciO0_SFlag),
			   .wciO0_SResp(wciMonW8$wciO0_SResp),
			   .wciO0_SThreadBusy(wciMonW8$wciO0_SThreadBusy),
  ...
  // register pmemMonW8_pmh
  assign pmemMonW8_pmh$D_IN = pmemMonW8_pmemF$D_OUT[31:0] ;
  ...
  // submodule pmemMonW8_pmemF
  assign pmemMonW8_pmemF$D_IN = wciMonW8$pmem_get ;
  ...
  // submodule wciMonW8
  assign wciMonW8$wciO0_MAddr = ctop$wci_m_0_MAddr ;
  assign wciMonW8$wciO0_MAddrSpace = ctop$wci_m_0_MAddrSpace ;
  assign wciMonW8$wciO0_MByteEn = ctop$wci_m_0_MByteEn ;
  assign wciMonW8$wciO0_MCmd = ctop$wci_m_0_MCmd ;
  assign wciMonW8$wciO0_MData = ctop$wci_m_0_MData ;
  assign wciMonW8$wciO0_MFlag = ctop$wci_m_0_MFlag ;
  assign wciMonW8$wciO0_SData = icap$wci_s_resp[31:0] ;
  assign wciMonW8$wciO0_SFlag = icap$wci_s_SFlag ;
  assign wciMonW8$wciO0_SResp = icap$wci_s_resp[33:32] ;
  assign wciMonW8$wciO0_SThreadBusy = icap$wci_s_SThreadBusy ;
  ...
  begin
	...
	$display("[%0d]: %m: PMEM MONITOR Event %0d Header srcId:%0x eType:%0x srcTag:%0x length:%0x",
		 ...
		 pmemMonW8_pmemF$D_OUT[15:8],
		 pmemMonW8_pmemF$D_OUT[7:0]);
    if (pci0_reset_n)
