...
//
// On Sun Dec 19 11:41:47 EST 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkFTop(sys0_clkp,
  ...
  wire [7 : 0] pci_pcie_irq_wInterruptDo$wget,
  ...
  wire icapwci_Es_mAddrSpace_w$wget,
       ...
       pci_i2pAF_dClear_pw$whas,
       pci_i2pAF_deq_happened$whas,
       pci_i2pAF_deq_pw$whas,
       pci_i2pAF_enq_pw$whas,
       pci_i2pAF_sClear_pw$whas,
       pci_p2iAF_dClear_pw$whas,
       pci_p2iAF_deq_happened$whas,
       pci_p2iAF_deq_pw$whas,
       pci_p2iAF_enq_pw$whas,
       pci_p2iAF_sClear_pw$whas,
       pci_pci0_pwTrnRx$whas,
       pci_pci0_pwTrnTx$whas,
       pci_pcie_irq_wInterruptDo$whas,
       pci_pcie_irq_wInterruptRdyN$wget,
       pci_pcie_irq_wInterruptRdyN$whas,
  ...
  // register pci_Prelude_inst_changeSpecialWires_1_rg
  reg [81 : 0] pci_Prelude_inst_changeSpecialWires_1_rg;
  wire [81 : 0] pci_Prelude_inst_changeSpecialWires_1_rg$D_IN;
  wire pci_Prelude_inst_changeSpecialWires_1_rg$EN;

  // register pci_Prelude_inst_changeSpecialWires_2_rg
  reg [81 : 0] pci_Prelude_inst_changeSpecialWires_2_rg;
  wire [81 : 0] pci_Prelude_inst_changeSpecialWires_2_rg$D_IN;
  wire pci_Prelude_inst_changeSpecialWires_2_rg$EN;

  // register pci_i2pAF_dInReset_isInReset
  reg pci_i2pAF_dInReset_isInReset;
  wire pci_i2pAF_dInReset_isInReset$D_IN, pci_i2pAF_dInReset_isInReset$EN;

  // register pci_i2pAF_head_wrapped
  reg pci_i2pAF_head_wrapped;
  wire pci_i2pAF_head_wrapped$D_IN, pci_i2pAF_head_wrapped$EN;

  // register pci_i2pAF_sInReset_isInReset
  reg pci_i2pAF_sInReset_isInReset;
  wire pci_i2pAF_sInReset_isInReset$D_IN, pci_i2pAF_sInReset_isInReset$EN;

  // register pci_i2pAF_tail_wrapped
  reg pci_i2pAF_tail_wrapped;
  wire pci_i2pAF_tail_wrapped$D_IN, pci_i2pAF_tail_wrapped$EN;

  // register pci_i2pS
  reg [152 : 0] pci_i2pS;
  wire [152 : 0] pci_i2pS$D_IN;
  wire pci_i2pS$EN;

  // register pci_p2iAF_dInReset_isInReset
  reg pci_p2iAF_dInReset_isInReset;
  wire pci_p2iAF_dInReset_isInReset$D_IN, pci_p2iAF_dInReset_isInReset$EN;

  // register pci_p2iAF_head_wrapped
  reg pci_p2iAF_head_wrapped;
  wire pci_p2iAF_head_wrapped$D_IN, pci_p2iAF_head_wrapped$EN;

  // register pci_p2iAF_sInReset_isInReset
  reg pci_p2iAF_sInReset_isInReset;
  wire pci_p2iAF_sInReset_isInReset$D_IN, pci_p2iAF_sInReset_isInReset$EN;

  // register pci_p2iAF_tail_wrapped
  reg pci_p2iAF_tail_wrapped;
  wire pci_p2iAF_tail_wrapped$D_IN, pci_p2iAF_tail_wrapped$EN;

  // register pci_p2iS
  reg [152 : 0] pci_p2iS;
  wire [152 : 0] pci_p2iS$D_IN;
  wire pci_p2iS$EN;

  // register pci_pcie_irq_rInterruptDi
  reg [7 : 0] pci_pcie_irq_rInterruptDi;
  wire [7 : 0] pci_pcie_irq_rInterruptDi$D_IN;
  wire pci_pcie_irq_rInterruptDi$EN;

  // register pci_pcie_irq_rInterruptN
  reg pci_pcie_irq_rInterruptN;
  wire pci_pcie_irq_rInterruptN$D_IN, pci_pcie_irq_rInterruptN$EN;

  // register pci_pcie_irq_rInterrupting
  reg pci_pcie_irq_rInterrupting;
  wire pci_pcie_irq_rInterrupting$D_IN, pci_pcie_irq_rInterrupting$EN;

  // register pci_pcie_irq_rMMEnabled
  reg [2 : 0] pci_pcie_irq_rMMEnabled;
  wire [2 : 0] pci_pcie_irq_rMMEnabled$D_IN;
  wire pci_pcie_irq_rMMEnabled$EN;

  // register pci_pcie_irq_rMSIEnabled
  reg pci_pcie_irq_rMSIEnabled;
  wire pci_pcie_irq_rMSIEnabled$D_IN, pci_pcie_irq_rMSIEnabled$EN;
  ...
  // ports of submodule pci_fI2P
  wire [80 : 0] pci_fI2P$D_IN, pci_fI2P$D_OUT;
  wire pci_fI2P$CLR,
       pci_fI2P$DEQ,
       pci_fI2P$EMPTY_N,
       pci_fI2P$ENQ,
  ...
  // ports of submodule pci_fP2I
  wire [80 : 0] pci_fP2I$D_IN, pci_fP2I$D_OUT;
  wire pci_fP2I$CLR,
       pci_fP2I$DEQ,
       pci_fP2I$EMPTY_N,
       pci_fP2I$ENQ,
  ...
  // ports of submodule pci_i2pAF_dCombinedReset
  wire pci_i2pAF_dCombinedReset$RST_OUT;

  // ports of submodule pci_i2pAF_dCrossedsReset
  wire pci_i2pAF_dCrossedsReset$OUT_RST_N;

  // ports of submodule pci_i2pAF_sCombinedReset
  wire pci_i2pAF_sCombinedReset$RST_OUT;

  // ports of submodule pci_i2pAF_sCrosseddReset
  wire pci_i2pAF_sCrosseddReset$OUT_RST_N;

  // ports of submodule pci_p2iAF_dCombinedReset
  wire pci_p2iAF_dCombinedReset$RST_OUT;

  // ports of submodule pci_p2iAF_dCrossedsReset
  wire pci_p2iAF_dCrossedsReset$OUT_RST_N;

  // ports of submodule pci_p2iAF_sCombinedReset
  wire pci_p2iAF_sCombinedReset$RST_OUT;

  // ports of submodule pci_p2iAF_sCrosseddReset
  wire pci_p2iAF_sCrosseddReset$OUT_RST_N;

  // ports of submodule pci_pci0_clk
  wire pci_pci0_clk$O;

  // ports of submodule pci_pci0_pcie_ep
  wire [63 : 0] pci_pci0_pcie_ep$cfg_dsn,
		pci_pci0_pcie_ep$trn_rd,
		pci_pci0_pcie_ep$trn_td;
  wire [47 : 0] pci_pci0_pcie_ep$cfg_err_tlp_cpl_header;
  wire [31 : 0] pci_pci0_pcie_ep$cfg_di;
  wire [9 : 0] pci_pci0_pcie_ep$cfg_dwaddr;
  wire [7 : 0] pci_pci0_pcie_ep$cfg_bus_number,
	       pci_pci0_pcie_ep$cfg_interrupt_di,
	       pci_pci0_pcie_ep$cfg_interrupt_do;
  wire [6 : 0] pci_pci0_pcie_ep$trn_rbar_hit_n;
  wire [4 : 0] pci_pci0_pcie_ep$cfg_device_number;
  wire [3 : 0] pci_pci0_pcie_ep$cfg_byte_en_n,
	       pci_pci0_pcie_ep$pci_exp_rxn,
	       pci_pci0_pcie_ep$pci_exp_rxp,
	       pci_pci0_pcie_ep$pci_exp_txn,
	       pci_pci0_pcie_ep$pci_exp_txp;
  wire [2 : 0] pci_pci0_pcie_ep$cfg_function_number,
	       pci_pci0_pcie_ep$cfg_interrupt_mmenable,
	       pci_pci0_pcie_ep$trn_fc_sel;
  wire [1 : 0] pci_pci0_pcie_ep$pl_directed_link_change,
	       pci_pci0_pcie_ep$pl_directed_link_width;
  wire pci_pci0_pcie_ep$cfg_err_cor_n,
       pci_pci0_pcie_ep$cfg_err_cpl_abort_n,
       pci_pci0_pcie_ep$cfg_err_cpl_timeout_n,
       pci_pci0_pcie_ep$cfg_err_cpl_unexpect_n,
       pci_pci0_pcie_ep$cfg_err_ecrc_n,
       pci_pci0_pcie_ep$cfg_err_locked_n,
       pci_pci0_pcie_ep$cfg_err_posted_n,
       pci_pci0_pcie_ep$cfg_err_ur_n,
       pci_pci0_pcie_ep$cfg_interrupt_assert_n,
       pci_pci0_pcie_ep$cfg_interrupt_msienable,
       pci_pci0_pcie_ep$cfg_interrupt_n,
       pci_pci0_pcie_ep$cfg_interrupt_rdy_n,
       pci_pci0_pcie_ep$cfg_pm_wake_n,
       pci_pci0_pcie_ep$cfg_rd_en_n,
       pci_pci0_pcie_ep$cfg_trn_pending_n,
       pci_pci0_pcie_ep$cfg_turnoff_ok_n,
       pci_pci0_pcie_ep$cfg_wr_en_n,
       pci_pci0_pcie_ep$pl_directed_link_auton,
       pci_pci0_pcie_ep$pl_directed_link_speed,
       pci_pci0_pcie_ep$pl_upstream_prefer_deemph,
       pci_pci0_pcie_ep$trn2_clk,
       pci_pci0_pcie_ep$trn_clk,
       pci_pci0_pcie_ep$trn_lnk_up_n,
       pci_pci0_pcie_ep$trn_rdst_rdy_n,
       pci_pci0_pcie_ep$trn_reof_n,
       pci_pci0_pcie_ep$trn_reset_n,
       pci_pci0_pcie_ep$trn_rnp_ok_n,
       pci_pci0_pcie_ep$trn_rrem_n,
       pci_pci0_pcie_ep$trn_rsof_n,
       pci_pci0_pcie_ep$trn_rsrc_rdy_n,
       pci_pci0_pcie_ep$trn_tcfg_gnt_n,
       pci_pci0_pcie_ep$trn_tdst_rdy_n,
       pci_pci0_pcie_ep$trn_teof_n,
       pci_pci0_pcie_ep$trn_terrfwd_n,
       pci_pci0_pcie_ep$trn_trem_n,
       pci_pci0_pcie_ep$trn_tsof_n,
       pci_pci0_pcie_ep$trn_tsrc_dsc_n,
       pci_pci0_pcie_ep$trn_tsrc_rdy_n,
       pci_pci0_pcie_ep$trn_tstr_n;

  // ports of submodule pci_pci0_rst
  wire pci_pci0_rst$O;

  // ports of submodule pci_pciDevice
  wire [15 : 0] pci_pciDevice$dD_OUT, pci_pciDevice$sD_IN;
  wire pci_pciDevice$sEN, pci_pciDevice$sRDY;

  // ports of submodule pci_pciLinkUp
  wire pci_pciLinkUp$dD_OUT,
       pci_pciLinkUp$sD_IN,
       pci_pciLinkUp$sEN,
       pci_pciLinkUp$sRDY;

  // ports of submodule pci_pcie_irq_fifoAssert
  wire [7 : 0] pci_pcie_irq_fifoAssert$dD_OUT, pci_pcie_irq_fifoAssert$sD_IN;
  wire pci_pcie_irq_fifoAssert$dDEQ,
       pci_pcie_irq_fifoAssert$dEMPTY_N,
       pci_pcie_irq_fifoAssert$sENQ;

  // ports of submodule pci_preEdge
  wire pci_preEdge$CLK_VAL;

  // ports of submodule pci_trn2_rst
  wire pci_trn2_rst$OUT_RST_N;

  // ports of submodule pci_trn_rst
  wire pci_trn_rst$OUT_RST_N;
  ...
  wire CAN_FIRE_RL_Prelude_inst_changeSpecialWires_1_mAddrConnect,
       ...
       CAN_FIRE_RL_pci_Prelude_inst_changeSpecialWires_1_upconv_connect1,
       CAN_FIRE_RL_pci_Prelude_inst_changeSpecialWires_1_upconv_connect2,
       CAN_FIRE_RL_pci_Prelude_inst_changeSpecialWires_2_downconv_connect1,
       CAN_FIRE_RL_pci_Prelude_inst_changeSpecialWires_2_downconv_connect2,
       CAN_FIRE_RL_pci_Prelude_inst_changeSpecialWires_3_connect,
       CAN_FIRE_RL_pci_Prelude_inst_changeSpecialWires_3_every,
       CAN_FIRE_RL_pci_Prelude_inst_changeSpecialWires_connect,
       CAN_FIRE_RL_pci_Prelude_inst_changeSpecialWires_every,
       CAN_FIRE_RL_pci_connect_interrupt_1,
       CAN_FIRE_RL_pci_connect_interrupt_do,
       CAN_FIRE_RL_pci_connect_interrupt_mmenable,
       CAN_FIRE_RL_pci_connect_interrupt_msienable,
       CAN_FIRE_RL_pci_connect_interrupt_rdy_n,
       CAN_FIRE_RL_pci_i2pAF_dClear_update_head,
       CAN_FIRE_RL_pci_i2pAF_dInReset_isResetAssertedUpdate,
       CAN_FIRE_RL_pci_i2pAF_deq_update_head,
       CAN_FIRE_RL_pci_i2pAF_enq_update_tail,
       CAN_FIRE_RL_pci_i2pAF_reset_head,
       CAN_FIRE_RL_pci_i2pAF_reset_tail,
       CAN_FIRE_RL_pci_i2pAF_sClear_update_tail,
       CAN_FIRE_RL_pci_i2pAF_sInReset_isResetAssertedUpdate,
       CAN_FIRE_RL_pci_p2iAF_dClear_update_head,
       CAN_FIRE_RL_pci_p2iAF_dInReset_isResetAssertedUpdate,
       CAN_FIRE_RL_pci_p2iAF_deq_update_head,
       CAN_FIRE_RL_pci_p2iAF_enq_update_tail,
       CAN_FIRE_RL_pci_p2iAF_reset_head,
       CAN_FIRE_RL_pci_p2iAF_reset_tail,
       CAN_FIRE_RL_pci_p2iAF_sClear_update_tail,
       CAN_FIRE_RL_pci_p2iAF_sInReset_isResetAssertedUpdate,
       CAN_FIRE_RL_pci_pci0_connect_trn_rx,
       CAN_FIRE_RL_pci_pci0_connect_trn_tx,
       CAN_FIRE_RL_pci_pcie_irq_msi_enabled_assert_interrupt,
       CAN_FIRE_RL_pci_pcie_irq_msi_enabled_assert_interrupt_done,
       CAN_FIRE_RL_pci_tie_off_inputs,
       CAN_FIRE_RL_pci_tie_off_inputs_1,
       CAN_FIRE_RL_pci_write_pciDevice,
       CAN_FIRE_RL_pci_write_pciLinkup,
       ...
       WILL_FIRE_RL_pci_Prelude_inst_changeSpecialWires_1_upconv_connect1,
       WILL_FIRE_RL_pci_Prelude_inst_changeSpecialWires_1_upconv_connect2,
       WILL_FIRE_RL_pci_Prelude_inst_changeSpecialWires_2_downconv_connect1,
       WILL_FIRE_RL_pci_Prelude_inst_changeSpecialWires_2_downconv_connect2,
       WILL_FIRE_RL_pci_Prelude_inst_changeSpecialWires_3_connect,
       WILL_FIRE_RL_pci_Prelude_inst_changeSpecialWires_3_every,
       WILL_FIRE_RL_pci_Prelude_inst_changeSpecialWires_connect,
       WILL_FIRE_RL_pci_Prelude_inst_changeSpecialWires_every,
       WILL_FIRE_RL_pci_connect_interrupt_1,
       WILL_FIRE_RL_pci_connect_interrupt_do,
       WILL_FIRE_RL_pci_connect_interrupt_mmenable,
       WILL_FIRE_RL_pci_connect_interrupt_msienable,
       WILL_FIRE_RL_pci_connect_interrupt_rdy_n,
       WILL_FIRE_RL_pci_i2pAF_dClear_update_head,
       WILL_FIRE_RL_pci_i2pAF_dInReset_isResetAssertedUpdate,
       WILL_FIRE_RL_pci_i2pAF_deq_update_head,
       WILL_FIRE_RL_pci_i2pAF_enq_update_tail,
       WILL_FIRE_RL_pci_i2pAF_reset_head,
       WILL_FIRE_RL_pci_i2pAF_reset_tail,
       WILL_FIRE_RL_pci_i2pAF_sClear_update_tail,
       WILL_FIRE_RL_pci_i2pAF_sInReset_isResetAssertedUpdate,
       WILL_FIRE_RL_pci_p2iAF_dClear_update_head,
       WILL_FIRE_RL_pci_p2iAF_dInReset_isResetAssertedUpdate,
       WILL_FIRE_RL_pci_p2iAF_deq_update_head,
       WILL_FIRE_RL_pci_p2iAF_enq_update_tail,
       WILL_FIRE_RL_pci_p2iAF_reset_head,
       WILL_FIRE_RL_pci_p2iAF_reset_tail,
       WILL_FIRE_RL_pci_p2iAF_sClear_update_tail,
       WILL_FIRE_RL_pci_p2iAF_sInReset_isResetAssertedUpdate,
       WILL_FIRE_RL_pci_pci0_connect_trn_rx,
       WILL_FIRE_RL_pci_pci0_connect_trn_tx,
       WILL_FIRE_RL_pci_pcie_irq_msi_enabled_assert_interrupt,
       WILL_FIRE_RL_pci_pcie_irq_msi_enabled_assert_interrupt_done,
       WILL_FIRE_RL_pci_tie_off_inputs,
       WILL_FIRE_RL_pci_tie_off_inputs_1,
       WILL_FIRE_RL_pci_write_pciDevice,
       WILL_FIRE_RL_pci_write_pciLinkup,
  ...
  wire [152 : 0] MUX_pci_p2iS$write_1__VAL_1, MUX_pci_p2iS$write_1__VAL_2;
  wire [81 : 0] MUX_pci_Prelude_inst_changeSpecialWires_1_rg$write_1__VAL_1,
		MUX_pci_Prelude_inst_changeSpecialWires_2_rg$write_1__VAL_1;
  wire [80 : 0] MUX_pci_fI2P$enq_1__VAL_1;
  ...
  wire MUX_pci_Prelude_inst_changeSpecialWires_1_rg$write_1__SEL_1,
       MUX_pci_Prelude_inst_changeSpecialWires_2_rg$write_1__SEL_1,
       MUX_pci_p2iS$write_1__SEL_1,
       MUX_pmemMonW8_eventCount$write_1__SEL_1,
       MUX_pmemMonW8_wsiS_reqFifo_levelsValid$write_1__SEL_3;

  // remaining internal signals
  reg [63 : 0] v__h15529, v__h15612, v__h16911, v__h16994;
  reg [7 : 0] CASE_pmemMonW8_pmemFD_OUT_BITS_23_TO_16_255_0_ETC__q1,
	      CASE_pmemMonW8_wsiS_reqFifoD_OUT_BITS_35_TO_2_ETC__q2,
	      IF_pmemMonW8_pmh_77_BITS_23_TO_16_09_EQ_0_10_O_ETC___d771;
  wire [127 : 0] val_data__h5589, wOut_data__h5695;
  wire [15 : 0] val_be__h5588, wOut_be__h5694;
  wire pci_p2iAF_head_wrapped_crossed__2_EQ_pci_p2iAF_ETC___d101,
       pmemMonW8_wsiS_reqFifo_notFull__14_AND_pmemMon_ETC___d236,
       z__h13966,
       z__h13973,
       z__h13980,
       z__h13987,
  ...
  // oscillator and gates for output clock trn2Clk
  assign trn2Clk = pci_pci0_pcie_ep$trn2_clk ;
  ...
  // value method pcie_txp
  assign pcie_txp = pci_pci0_pcie_ep$pci_exp_txp ;

  // value method pcie_txn
  assign pcie_txn = pci_pci0_pcie_ep$pci_exp_txn ;
  ...
  // submodule ctop
  mkCTop4B ctop(.pciDevice(pci_pciDevice$dD_OUT),
		.CLK_sys0_clk(sys0_clk$O),
		.RST_N_sys0_rst(sys0_rst$OUT_RST_N),
		.CLK(pci_pci0_pcie_ep$trn2_clk),
		.RST_N(pci_trn2_rst$OUT_RST_N),
  ...
  // submodule flash0
  mkFlashWorker flash0(.CLK(pci_pci0_pcie_ep$trn2_clk),
  ...
  mkICAPWorker #(.isV6ICAP(1'd1),
		 .hasDebugLogic(1'd1)) icap(.wciS0_Clk(pci_pci0_pcie_ep$trn2_clk),
  ...
  SizedFIFO #(.p1width(32'd81),
	      .p2depth(32'd4),
	      .p3cntr_width(32'd2),
	      .guarded(32'd1)) pci_fI2P(.RST_N(pci_trn_rst$OUT_RST_N),
					.CLK(pci_pci0_pcie_ep$trn_clk),
					.D_IN(pci_fI2P$D_IN),
					.ENQ(pci_fI2P$ENQ),
					.DEQ(pci_fI2P$DEQ),
					.CLR(pci_fI2P$CLR),
					.D_OUT(pci_fI2P$D_OUT),
					.FULL_N(pci_fI2P$FULL_N),
					.EMPTY_N(pci_fI2P$EMPTY_N));

  // submodule pci_fP2I
  SizedFIFO #(.p1width(32'd81),
	      .p2depth(32'd4),
	      .p3cntr_width(32'd2),
	      .guarded(32'd1)) pci_fP2I(.RST_N(pci_trn_rst$OUT_RST_N),
					.CLK(pci_pci0_pcie_ep$trn_clk),
					.D_IN(pci_fP2I$D_IN),
					.ENQ(pci_fP2I$ENQ),
					.DEQ(pci_fP2I$DEQ),
					.CLR(pci_fP2I$CLR),
					.D_OUT(pci_fP2I$D_OUT),
					.FULL_N(pci_fP2I$FULL_N),
					.EMPTY_N(pci_fP2I$EMPTY_N));

  // submodule pci_i2pAF_dCombinedReset
  ResetEither pci_i2pAF_dCombinedReset(.A_RST(pci_trn_rst$OUT_RST_N),
				       .B_RST(pci_i2pAF_dCrossedsReset$OUT_RST_N),
				       .RST_OUT(pci_i2pAF_dCombinedReset$RST_OUT));

  // submodule pci_i2pAF_dCrossedsReset
  SyncReset0 pci_i2pAF_dCrossedsReset(.IN_RST_N(pci_trn2_rst$OUT_RST_N),
				      .OUT_RST_N(pci_i2pAF_dCrossedsReset$OUT_RST_N));

  // submodule pci_i2pAF_sCombinedReset
  ResetEither pci_i2pAF_sCombinedReset(.A_RST(pci_trn2_rst$OUT_RST_N),
				       .B_RST(pci_i2pAF_sCrosseddReset$OUT_RST_N),
				       .RST_OUT(pci_i2pAF_sCombinedReset$RST_OUT));

  // submodule pci_i2pAF_sCrosseddReset
  SyncReset0 pci_i2pAF_sCrosseddReset(.IN_RST_N(pci_trn_rst$OUT_RST_N),
				      .OUT_RST_N(pci_i2pAF_sCrosseddReset$OUT_RST_N));

  // submodule pci_p2iAF_dCombinedReset
  ResetEither pci_p2iAF_dCombinedReset(.A_RST(pci_trn2_rst$OUT_RST_N),
				       .B_RST(pci_p2iAF_dCrossedsReset$OUT_RST_N),
				       .RST_OUT(pci_p2iAF_dCombinedReset$RST_OUT));

  // submodule pci_p2iAF_dCrossedsReset
  SyncReset0 pci_p2iAF_dCrossedsReset(.IN_RST_N(pci_trn_rst$OUT_RST_N),
				      .OUT_RST_N(pci_p2iAF_dCrossedsReset$OUT_RST_N));

  // submodule pci_p2iAF_sCombinedReset
  ResetEither pci_p2iAF_sCombinedReset(.A_RST(pci_trn_rst$OUT_RST_N),
				       .B_RST(pci_p2iAF_sCrosseddReset$OUT_RST_N),
				       .RST_OUT(pci_p2iAF_sCombinedReset$RST_OUT));

  // submodule pci_p2iAF_sCrosseddReset
  SyncReset0 pci_p2iAF_sCrosseddReset(.IN_RST_N(pci_trn2_rst$OUT_RST_N),
				      .OUT_RST_N(pci_p2iAF_sCrosseddReset$OUT_RST_N));

  // submodule pci_pci0_clk
  IBUFDS_GTXE1 pci_pci0_clk(.I(pci0_clkp),
			    .IB(pci0_clkn),
			    .CEB(1'd0),
			    .O(pci_pci0_clk$O),
			    .ODIV2());

  // submodule pci_pci0_pcie_ep
  xilinx_v6_pcie_wrapper #(.PL_FAST_TRAIN("FALSE")) pci_pci0_pcie_ep(.sys_clk(pci_pci0_clk$O),
								     .sys_reset_n(pci_pci0_rst$O),
								     .cfg_byte_en_n(pci_pci0_pcie_ep$cfg_byte_en_n),
								     .cfg_di(pci_pci0_pcie_ep$cfg_di),
								     .cfg_dsn(pci_pci0_pcie_ep$cfg_dsn),
								     .cfg_dwaddr(pci_pci0_pcie_ep$cfg_dwaddr),
								     .cfg_err_cor_n(pci_pci0_pcie_ep$cfg_err_cor_n),
								     .cfg_err_cpl_abort_n(pci_pci0_pcie_ep$cfg_err_cpl_abort_n),
								     .cfg_err_cpl_timeout_n(pci_pci0_pcie_ep$cfg_err_cpl_timeout_n),
								     .cfg_err_cpl_unexpect_n(pci_pci0_pcie_ep$cfg_err_cpl_unexpect_n),
								     .cfg_err_ecrc_n(pci_pci0_pcie_ep$cfg_err_ecrc_n),
								     .cfg_err_locked_n(pci_pci0_pcie_ep$cfg_err_locked_n),
								     .cfg_err_posted_n(pci_pci0_pcie_ep$cfg_err_posted_n),
								     .cfg_err_tlp_cpl_header(pci_pci0_pcie_ep$cfg_err_tlp_cpl_header),
								     .cfg_err_ur_n(pci_pci0_pcie_ep$cfg_err_ur_n),
								     .cfg_interrupt_assert_n(pci_pci0_pcie_ep$cfg_interrupt_assert_n),
								     .cfg_interrupt_di(pci_pci0_pcie_ep$cfg_interrupt_di),
								     .cfg_interrupt_n(pci_pci0_pcie_ep$cfg_interrupt_n),
								     .cfg_pm_wake_n(pci_pci0_pcie_ep$cfg_pm_wake_n),
								     .cfg_rd_en_n(pci_pci0_pcie_ep$cfg_rd_en_n),
								     .cfg_trn_pending_n(pci_pci0_pcie_ep$cfg_trn_pending_n),
								     .cfg_turnoff_ok_n(pci_pci0_pcie_ep$cfg_turnoff_ok_n),
								     .cfg_wr_en_n(pci_pci0_pcie_ep$cfg_wr_en_n),
								     .pci_exp_rxn(pci_pci0_pcie_ep$pci_exp_rxn),
								     .pci_exp_rxp(pci_pci0_pcie_ep$pci_exp_rxp),
								     .pl_directed_link_auton(pci_pci0_pcie_ep$pl_directed_link_auton),
								     .pl_directed_link_change(pci_pci0_pcie_ep$pl_directed_link_change),
								     .pl_directed_link_speed(pci_pci0_pcie_ep$pl_directed_link_speed),
								     .pl_directed_link_width(pci_pci0_pcie_ep$pl_directed_link_width),
								     .pl_upstream_prefer_deemph(pci_pci0_pcie_ep$pl_upstream_prefer_deemph),
								     .trn_fc_sel(pci_pci0_pcie_ep$trn_fc_sel),
								     .trn_rdst_rdy_n(pci_pci0_pcie_ep$trn_rdst_rdy_n),
								     .trn_rnp_ok_n(pci_pci0_pcie_ep$trn_rnp_ok_n),
								     .trn_tcfg_gnt_n(pci_pci0_pcie_ep$trn_tcfg_gnt_n),
								     .trn_td(pci_pci0_pcie_ep$trn_td),
								     .trn_teof_n(pci_pci0_pcie_ep$trn_teof_n),
								     .trn_terrfwd_n(pci_pci0_pcie_ep$trn_terrfwd_n),
								     .trn_trem_n(pci_pci0_pcie_ep$trn_trem_n),
								     .trn_tsof_n(pci_pci0_pcie_ep$trn_tsof_n),
								     .trn_tsrc_dsc_n(pci_pci0_pcie_ep$trn_tsrc_dsc_n),
								     .trn_tsrc_rdy_n(pci_pci0_pcie_ep$trn_tsrc_rdy_n),
								     .trn_tstr_n(pci_pci0_pcie_ep$trn_tstr_n),
								     .pci_exp_txp(pci_pci0_pcie_ep$pci_exp_txp),
								     .pci_exp_txn(pci_pci0_pcie_ep$pci_exp_txn),
								     .trn_lnk_up_n(pci_pci0_pcie_ep$trn_lnk_up_n),
								     .trn_fc_ph(),
								     .trn_fc_pd(),
								     .trn_fc_nph(),
								     .trn_fc_npd(),
								     ...
								     .cfg_do(),
								     .cfg_rd_wr_done_n(),
								     .cfg_bus_number(pci_pci0_pcie_ep$cfg_bus_number),
								     .cfg_device_number(pci_pci0_pcie_ep$cfg_device_number),
								     .cfg_function_number(pci_pci0_pcie_ep$cfg_function_number),
								     .cfg_status(),
								     .cfg_command(),
								     .cfg_dstatus(),
								     .cfg_dcommand(),
								     ...
								     .trn_tdst_rdy_n(pci_pci0_pcie_ep$trn_tdst_rdy_n),
								     .trn_tbuf_av(),
								     .trn_terr_drop_n(),
								     .trn_tcfg_req_n(),
								     .cfg_interrupt_rdy_n(pci_pci0_pcie_ep$cfg_interrupt_rdy_n),
								     .cfg_interrupt_do(pci_pci0_pcie_ep$cfg_interrupt_do),
								     .cfg_interrupt_mmenable(pci_pci0_pcie_ep$cfg_interrupt_mmenable),
								     .cfg_interrupt_msienable(pci_pci0_pcie_ep$cfg_interrupt_msienable),
								     .cfg_interrupt_msixenable(),
								     .cfg_interrupt_msixfm(),
								     .cfg_err_cpl_rdy_n(),
								     .trn_rsof_n(pci_pci0_pcie_ep$trn_rsof_n),
								     .trn_reof_n(pci_pci0_pcie_ep$trn_reof_n),
								     .trn_rd(pci_pci0_pcie_ep$trn_rd),
								     .trn_rrem_n(pci_pci0_pcie_ep$trn_rrem_n),
								     .trn_rerrfwd_n(),
								     .trn_rsrc_rdy_n(pci_pci0_pcie_ep$trn_rsrc_rdy_n),
								     .trn_rsrc_dsc_n(),
								     .trn_rbar_hit_n(pci_pci0_pcie_ep$trn_rbar_hit_n),
								     ...
								     .pl_ltssm_state(),
								     .pl_received_hot_rst(),
								     .trn_clk(pci_pci0_pcie_ep$trn_clk),
								     .trn2_clk(pci_pci0_pcie_ep$trn2_clk),
								     .trn_reset_n(pci_pci0_pcie_ep$trn_reset_n));

  // submodule pci_pci0_rst
  IBUF pci_pci0_rst(.I(pci0_reset_n), .O(pci_pci0_rst$O));

  // submodule pci_pciDevice
  SyncRegister #(.width(32'd16),
		 .init(16'd0)) pci_pciDevice(.sCLK(pci_pci0_pcie_ep$trn_clk),
					     .dCLK(pci_pci0_pcie_ep$trn2_clk),
					     .sRST_N(pci_trn_rst$OUT_RST_N),
					     .sD_IN(pci_pciDevice$sD_IN),
					     .sEN(pci_pciDevice$sEN),
					     .dD_OUT(pci_pciDevice$dD_OUT),
					     .sRDY(pci_pciDevice$sRDY));

  // submodule pci_pciLinkUp
  SyncRegister #(.width(32'd1),
		 .init(1'd0)) pci_pciLinkUp(.sCLK(pci_pci0_pcie_ep$trn_clk),
					    .dCLK(pci_pci0_pcie_ep$trn2_clk),
					    .sRST_N(pci_trn_rst$OUT_RST_N),
					    .sD_IN(pci_pciLinkUp$sD_IN),
					    .sEN(pci_pciLinkUp$sEN),
					    .dD_OUT(pci_pciLinkUp$dD_OUT),
					    .sRDY(pci_pciLinkUp$sRDY));

  // submodule pci_pcie_irq_fifoAssert
  SyncFIFO #(.dataWidth(32'd8),
	     .depth(32'd8),
	     .indxWidth(32'd3),
	     .regFull(1'd1),
	     .regEmpty(1'd1)) pci_pcie_irq_fifoAssert(.sCLK(pci_pci0_pcie_ep$trn_clk),
						      .dCLK(pci_pci0_pcie_ep$trn_clk),
						      .sRST_N(pci_trn_rst$OUT_RST_N),
						      .sD_IN(pci_pcie_irq_fifoAssert$sD_IN),
						      .sENQ(pci_pcie_irq_fifoAssert$sENQ),
						      .dDEQ(pci_pcie_irq_fifoAssert$dDEQ),
						      .dD_OUT(pci_pcie_irq_fifoAssert$dD_OUT),
						      .sFULL_N(),
						      .dEMPTY_N(pci_pcie_irq_fifoAssert$dEMPTY_N));

  // submodule pci_preEdge
  ClockInvToBool pci_preEdge(.CLK_FAST(pci_pci0_pcie_ep$trn_clk),
			     .CLK_SLOW(pci_pci0_pcie_ep$trn2_clk),
			     .CLK_VAL(pci_preEdge$CLK_VAL));

  // submodule pci_trn2_rst
  SyncResetA #(.RSTDELAY(32'd0)) pci_trn2_rst(.CLK(pci_pci0_pcie_ep$trn2_clk),
					      .IN_RST_N(pci_pci0_pcie_ep$trn_reset_n),
					      .OUT_RST_N(pci_trn2_rst$OUT_RST_N));

  // submodule pci_trn_rst
  SyncResetA #(.RSTDELAY(32'd0)) pci_trn_rst(.CLK(pci_pci0_pcie_ep$trn_clk),
					     .IN_RST_N(pci_pci0_pcie_ep$trn_reset_n),
					     .OUT_RST_N(pci_trn_rst$OUT_RST_N));

  // submodule pmemMonW8_pmemF
  FIFO2 #(.width(32'd34),
	  .guarded(32'd1)) pmemMonW8_pmemF(.RST_N(pci_trn2_rst$OUT_RST_N),
					   .CLK(pci_pci0_pcie_ep$trn2_clk),
  ...
  ResetToBool pmemMonW8_wsiS_isReset(.RST(pci_trn2_rst$OUT_RST_N),
  ...
  SizedFIFO #(.p1width(32'd61),
	      .p2depth(32'd3),
	      .p3cntr_width(32'd1),
	      .guarded(32'd1)) pmemMonW8_wsiS_reqFifo(.RST_N(pci_trn2_rst$OUT_RST_N),
						      .CLK(pci_pci0_pcie_ep$trn2_clk),
  ...
  SyncResetA #(.RSTDELAY(32'd0)) sys0_rst(.CLK(sys0_clk$O),
					  .IN_RST_N(pci_trn2_rst$OUT_RST_N),
  ...
  // submodule wciMonW8
  mkWciOcpMonitor #(.monId(8'h42)) wciMonW8(.CLK(pci_pci0_pcie_ep$trn2_clk),
					    .RST_N(pci_trn2_rst$OUT_RST_N),
  ...
  // rule RL_pci_write_pciLinkup
  assign CAN_FIRE_RL_pci_write_pciLinkup = pci_pciLinkUp$sRDY ;
  assign WILL_FIRE_RL_pci_write_pciLinkup = pci_pciLinkUp$sRDY ;

  // rule RL_pci_write_pciDevice
  assign CAN_FIRE_RL_pci_write_pciDevice = pci_pciDevice$sRDY ;
  assign WILL_FIRE_RL_pci_write_pciDevice = pci_pciDevice$sRDY ;

  // rule RL_pci_connect_interrupt_1
  assign CAN_FIRE_RL_pci_connect_interrupt_1 = 1'd1 ;
  assign WILL_FIRE_RL_pci_connect_interrupt_1 = 1'd1 ;

  // rule RL_pci_connect_interrupt_rdy_n
  assign CAN_FIRE_RL_pci_connect_interrupt_rdy_n = 1'd1 ;
  assign WILL_FIRE_RL_pci_connect_interrupt_rdy_n = 1'd1 ;

  // rule RL_pci_connect_interrupt_mmenable
  assign CAN_FIRE_RL_pci_connect_interrupt_mmenable = 1'd1 ;
  assign WILL_FIRE_RL_pci_connect_interrupt_mmenable = 1'd1 ;

  // rule RL_pci_connect_interrupt_do
  assign CAN_FIRE_RL_pci_connect_interrupt_do = 1'd1 ;
  assign WILL_FIRE_RL_pci_connect_interrupt_do = 1'd1 ;

  // rule RL_pci_tie_off_inputs
  assign CAN_FIRE_RL_pci_tie_off_inputs = 1'd1 ;
  assign WILL_FIRE_RL_pci_tie_off_inputs = 1'd1 ;

  // rule RL_pci_tie_off_inputs_1
  assign CAN_FIRE_RL_pci_tie_off_inputs_1 = 1'd1 ;
  assign WILL_FIRE_RL_pci_tie_off_inputs_1 = 1'd1 ;

  // rule RL_pci_pcie_irq_msi_enabled_assert_interrupt
  assign CAN_FIRE_RL_pci_pcie_irq_msi_enabled_assert_interrupt =
	     pci_pcie_irq_fifoAssert$dEMPTY_N && pci_pcie_irq_rMSIEnabled &&
	     !pci_pcie_irq_rInterrupting &&
	     pci_pci0_pcie_ep$cfg_interrupt_rdy_n ;
  assign WILL_FIRE_RL_pci_pcie_irq_msi_enabled_assert_interrupt =
	     CAN_FIRE_RL_pci_pcie_irq_msi_enabled_assert_interrupt ;

  // rule RL_pci_pcie_irq_msi_enabled_assert_interrupt_done
  assign CAN_FIRE_RL_pci_pcie_irq_msi_enabled_assert_interrupt_done =
	     pci_pcie_irq_rMSIEnabled && pci_pcie_irq_rInterrupting &&
	     !pci_pci0_pcie_ep$cfg_interrupt_rdy_n ;
  assign WILL_FIRE_RL_pci_pcie_irq_msi_enabled_assert_interrupt_done =
	     CAN_FIRE_RL_pci_pcie_irq_msi_enabled_assert_interrupt_done ;

  // rule RL_pci_connect_interrupt_msienable
  assign CAN_FIRE_RL_pci_connect_interrupt_msienable = 1'd1 ;
  assign WILL_FIRE_RL_pci_connect_interrupt_msienable = 1'd1 ;

  // rule RL_pci_p2iAF_deq_update_head
  assign CAN_FIRE_RL_pci_p2iAF_deq_update_head = 1'b0 ;
  assign WILL_FIRE_RL_pci_p2iAF_deq_update_head = 1'b0 ;

  // rule RL_pci_p2iAF_dClear_update_head
  assign CAN_FIRE_RL_pci_p2iAF_dClear_update_head = 1'b0 ;
  assign WILL_FIRE_RL_pci_p2iAF_dClear_update_head = 1'b0 ;

  // rule RL_pci_p2iAF_reset_head
  assign CAN_FIRE_RL_pci_p2iAF_reset_head = pci_p2iAF_dInReset_isInReset ;
  assign WILL_FIRE_RL_pci_p2iAF_reset_head = pci_p2iAF_dInReset_isInReset ;

  // rule RL_pci_p2iAF_dInReset_isResetAssertedUpdate
  assign CAN_FIRE_RL_pci_p2iAF_dInReset_isResetAssertedUpdate =
	     pci_p2iAF_dInReset_isInReset ;
  assign WILL_FIRE_RL_pci_p2iAF_dInReset_isResetAssertedUpdate =
	     pci_p2iAF_dInReset_isInReset ;

  // rule RL_pci_i2pAF_enq_update_tail
  assign CAN_FIRE_RL_pci_i2pAF_enq_update_tail = 1'b0 ;
  assign WILL_FIRE_RL_pci_i2pAF_enq_update_tail = 1'b0 ;

  // rule RL_pci_i2pAF_sClear_update_tail
  assign CAN_FIRE_RL_pci_i2pAF_sClear_update_tail = 1'b0 ;
  assign WILL_FIRE_RL_pci_i2pAF_sClear_update_tail = 1'b0 ;

  // rule RL_pci_i2pAF_reset_tail
  assign CAN_FIRE_RL_pci_i2pAF_reset_tail = pci_i2pAF_sInReset_isInReset ;
  assign WILL_FIRE_RL_pci_i2pAF_reset_tail = pci_i2pAF_sInReset_isInReset ;

  // rule RL_pci_i2pAF_reset_head
  assign CAN_FIRE_RL_pci_i2pAF_reset_head = pci_i2pAF_dInReset_isInReset ;
  assign WILL_FIRE_RL_pci_i2pAF_reset_head = pci_i2pAF_dInReset_isInReset ;

  // rule RL_pci_i2pAF_sInReset_isResetAssertedUpdate
  assign CAN_FIRE_RL_pci_i2pAF_sInReset_isResetAssertedUpdate =
	     pci_i2pAF_sInReset_isInReset ;
  assign WILL_FIRE_RL_pci_i2pAF_sInReset_isResetAssertedUpdate =
	     pci_i2pAF_sInReset_isInReset ;

  // rule RL_pci_i2pAF_dInReset_isResetAssertedUpdate
  assign CAN_FIRE_RL_pci_i2pAF_dInReset_isResetAssertedUpdate =
	     pci_i2pAF_dInReset_isInReset ;
  assign WILL_FIRE_RL_pci_i2pAF_dInReset_isResetAssertedUpdate =
	     pci_i2pAF_dInReset_isInReset ;

  // rule RL_pci_Prelude_inst_changeSpecialWires_every
  assign CAN_FIRE_RL_pci_Prelude_inst_changeSpecialWires_every = 1'd1 ;
  assign WILL_FIRE_RL_pci_Prelude_inst_changeSpecialWires_every = 1'd1 ;

  // rule RL_pci_Prelude_inst_changeSpecialWires_connect
  assign CAN_FIRE_RL_pci_Prelude_inst_changeSpecialWires_connect =
	     !pci_pci0_pcie_ep$trn_rsrc_rdy_n && pci_fP2I$FULL_N ;
  assign WILL_FIRE_RL_pci_Prelude_inst_changeSpecialWires_connect =
	     CAN_FIRE_RL_pci_Prelude_inst_changeSpecialWires_connect ;

  // rule RL_pci_pci0_connect_trn_rx
  assign CAN_FIRE_RL_pci_pci0_connect_trn_rx = 1'd1 ;
  assign WILL_FIRE_RL_pci_pci0_connect_trn_rx = 1'd1 ;

  // rule RL_pci_Prelude_inst_changeSpecialWires_1_upconv_connect1
  assign CAN_FIRE_RL_pci_Prelude_inst_changeSpecialWires_1_upconv_connect1 =
	     pci_fP2I$EMPTY_N &&
	     (!pci_fP2I$D_OUT[79] ||
	      pci_p2iAF_head_wrapped_crossed__2_EQ_pci_p2iAF_ETC___d101) &&
	     !pci_Prelude_inst_changeSpecialWires_1_rg[81] ;
  assign WILL_FIRE_RL_pci_Prelude_inst_changeSpecialWires_1_upconv_connect1 =
	     CAN_FIRE_RL_pci_Prelude_inst_changeSpecialWires_1_upconv_connect1 ;

  // rule RL_pci_p2iAF_reset_tail
  assign CAN_FIRE_RL_pci_p2iAF_reset_tail = pci_p2iAF_sInReset_isInReset ;
  assign WILL_FIRE_RL_pci_p2iAF_reset_tail = pci_p2iAF_sInReset_isInReset ;

  // rule RL_pci_p2iAF_sInReset_isResetAssertedUpdate
  assign CAN_FIRE_RL_pci_p2iAF_sInReset_isResetAssertedUpdate =
	     pci_p2iAF_sInReset_isInReset ;
  assign WILL_FIRE_RL_pci_p2iAF_sInReset_isResetAssertedUpdate =
	     pci_p2iAF_sInReset_isInReset ;

  // rule RL_pci_Prelude_inst_changeSpecialWires_1_upconv_connect2
  assign CAN_FIRE_RL_pci_Prelude_inst_changeSpecialWires_1_upconv_connect2 =
	     pci_p2iAF_head_wrapped_crossed__2_EQ_pci_p2iAF_ETC___d101 &&
	     pci_fP2I$EMPTY_N &&
	     pci_Prelude_inst_changeSpecialWires_1_rg[81] ;
  assign WILL_FIRE_RL_pci_Prelude_inst_changeSpecialWires_1_upconv_connect2 =
	     CAN_FIRE_RL_pci_Prelude_inst_changeSpecialWires_1_upconv_connect2 ;

  // rule RL_pci_p2iAF_enq_update_tail
  assign CAN_FIRE_RL_pci_p2iAF_enq_update_tail =
	     !pci_p2iAF_sInReset_isInReset && pci_p2iAF_enq_pw$whas ;
  assign WILL_FIRE_RL_pci_p2iAF_enq_update_tail =
	     CAN_FIRE_RL_pci_p2iAF_enq_update_tail ;

  // rule RL_pci_p2iAF_sClear_update_tail
  assign CAN_FIRE_RL_pci_p2iAF_sClear_update_tail = 1'b0 ;
  assign WILL_FIRE_RL_pci_p2iAF_sClear_update_tail = 1'b0 ;

  // rule RL_pci_Prelude_inst_changeSpecialWires_2_downconv_connect1
  assign CAN_FIRE_RL_pci_Prelude_inst_changeSpecialWires_2_downconv_connect1 =
	     pci_i2pAF_head_wrapped != pci_i2pAF_tail_wrapped &&
	     !pci_i2pAF_dInReset_isInReset &&
	     pci_preEdge$CLK_VAL &&
	     pci_fI2P$FULL_N &&
	     !pci_Prelude_inst_changeSpecialWires_2_rg[81] ;
  assign WILL_FIRE_RL_pci_Prelude_inst_changeSpecialWires_2_downconv_connect1 =
	     CAN_FIRE_RL_pci_Prelude_inst_changeSpecialWires_2_downconv_connect1 ;

  // rule RL_pci_i2pAF_deq_update_head
  assign CAN_FIRE_RL_pci_i2pAF_deq_update_head =
	     !pci_i2pAF_dInReset_isInReset &&
	     CAN_FIRE_RL_pci_Prelude_inst_changeSpecialWires_2_downconv_connect1 ;
  assign WILL_FIRE_RL_pci_i2pAF_deq_update_head =
	     CAN_FIRE_RL_pci_i2pAF_deq_update_head ;

  // rule RL_pci_i2pAF_dClear_update_head
  assign CAN_FIRE_RL_pci_i2pAF_dClear_update_head = 1'b0 ;
  assign WILL_FIRE_RL_pci_i2pAF_dClear_update_head = 1'b0 ;

  // rule RL_pci_Prelude_inst_changeSpecialWires_2_downconv_connect2
  assign CAN_FIRE_RL_pci_Prelude_inst_changeSpecialWires_2_downconv_connect2 =
	     pci_fI2P$FULL_N && pci_Prelude_inst_changeSpecialWires_2_rg[81] ;
  assign WILL_FIRE_RL_pci_Prelude_inst_changeSpecialWires_2_downconv_connect2 =
	     CAN_FIRE_RL_pci_Prelude_inst_changeSpecialWires_2_downconv_connect2 ;

  // rule RL_pci_Prelude_inst_changeSpecialWires_3_every
  assign CAN_FIRE_RL_pci_Prelude_inst_changeSpecialWires_3_every = 1'd1 ;
  assign WILL_FIRE_RL_pci_Prelude_inst_changeSpecialWires_3_every = 1'd1 ;

  // rule RL_pci_Prelude_inst_changeSpecialWires_3_connect
  assign CAN_FIRE_RL_pci_Prelude_inst_changeSpecialWires_3_connect =
	     !pci_pci0_pcie_ep$trn_tdst_rdy_n && pci_fI2P$EMPTY_N ;
  assign WILL_FIRE_RL_pci_Prelude_inst_changeSpecialWires_3_connect =
	     CAN_FIRE_RL_pci_Prelude_inst_changeSpecialWires_3_connect ;

  // rule RL_pci_pci0_connect_trn_tx
  assign CAN_FIRE_RL_pci_pci0_connect_trn_tx = 1'd1 ;
  assign WILL_FIRE_RL_pci_pci0_connect_trn_tx = 1'd1 ;
  ...
  // inputs to muxes for submodule ports
  assign MUX_pci_Prelude_inst_changeSpecialWires_1_rg$write_1__SEL_1 =
	     WILL_FIRE_RL_pci_Prelude_inst_changeSpecialWires_1_upconv_connect1 &&
	     !pci_fP2I$D_OUT[79] ;
  assign MUX_pci_Prelude_inst_changeSpecialWires_2_rg$write_1__SEL_1 =
	     WILL_FIRE_RL_pci_Prelude_inst_changeSpecialWires_2_downconv_connect1 &&
	     pci_i2pS[135:128] != 8'd0 ;
  assign MUX_pci_p2iS$write_1__SEL_1 =
	     WILL_FIRE_RL_pci_Prelude_inst_changeSpecialWires_1_upconv_connect1 &&
	     pci_fP2I$D_OUT[79] ;
  ...
  assign MUX_pmemMonW8_wsiS_reqFifo_levelsValid$write_1__SEL_3 =
	     WILL_FIRE_RL_pmemMonW8_wsiS_reqFifo_enq &&
	     pmemMonW8_wsiS_reqFifo$FULL_N ;
  assign MUX_pci_Prelude_inst_changeSpecialWires_1_rg$write_1__VAL_1 =
	     { 1'd1, pci_fP2I$D_OUT } ;
  assign MUX_pci_Prelude_inst_changeSpecialWires_2_rg$write_1__VAL_1 =
	     { 2'd2, pci_i2pS[151:144], pci_i2pS[135:128], pci_i2pS[63:0] } ;
  assign MUX_pci_fI2P$enq_1__VAL_1 =
	     (pci_i2pS[135:128] == 8'd0) ?
	       { pci_i2pS[152:136], pci_i2pS[127:64] } :
	       { pci_i2pS[152], 1'd0, pci_i2pS[150:136], pci_i2pS[127:64] } ;
  assign MUX_pci_p2iS$write_1__VAL_1 =
	     { pci_fP2I$D_OUT[80:72], val_be__h5588, val_data__h5589 } ;
  assign MUX_pci_p2iS$write_1__VAL_2 =
	     { pci_Prelude_inst_changeSpecialWires_1_rg[80],
	       pci_fP2I$D_OUT[79],
	       pci_Prelude_inst_changeSpecialWires_1_rg[78:72],
	       wOut_be__h5694,
	       wOut_data__h5695 } ;
  ...
  // inlined wires
  assign pci_pcie_irq_wInterruptRdyN$wget =
	     pci_pci0_pcie_ep$cfg_interrupt_rdy_n ;
  assign pci_pcie_irq_wInterruptRdyN$whas = 1'd1 ;
  assign pci_pcie_irq_wInterruptDo$wget = pci_pci0_pcie_ep$cfg_interrupt_do ;
  assign pci_pcie_irq_wInterruptDo$whas = 1'd1 ;
  ...
  assign pmemMonW8_pmGrab_1$wget = z__h14169 ^ pmemMonW8_pmh[31] ;
  ...
  assign pci_pci0_pwTrnTx$whas =
	     CAN_FIRE_RL_pci_Prelude_inst_changeSpecialWires_3_connect ;
  assign pci_pci0_pwTrnRx$whas =
	     CAN_FIRE_RL_pci_Prelude_inst_changeSpecialWires_connect ;
  assign pci_p2iAF_enq_pw$whas =
	     WILL_FIRE_RL_pci_Prelude_inst_changeSpecialWires_1_upconv_connect1 &&
	     pci_fP2I$D_OUT[79] ||
	     WILL_FIRE_RL_pci_Prelude_inst_changeSpecialWires_1_upconv_connect2 ;
  assign pci_p2iAF_deq_pw$whas = 1'b0 ;
  assign pci_p2iAF_sClear_pw$whas = 1'b0 ;
  assign pci_p2iAF_dClear_pw$whas = 1'b0 ;
  assign pci_p2iAF_deq_happened$whas = 1'b0 ;
  assign pci_i2pAF_enq_pw$whas = 1'b0 ;
  assign pci_i2pAF_deq_pw$whas =
	     CAN_FIRE_RL_pci_Prelude_inst_changeSpecialWires_2_downconv_connect1 ;
  assign pci_i2pAF_sClear_pw$whas = 1'b0 ;
  assign pci_i2pAF_dClear_pw$whas = 1'b0 ;
  assign pci_i2pAF_deq_happened$whas = 1'b0 ;
  ...
  // register pci_Prelude_inst_changeSpecialWires_1_rg
  assign pci_Prelude_inst_changeSpecialWires_1_rg$D_IN =
	     MUX_pci_Prelude_inst_changeSpecialWires_1_rg$write_1__SEL_1 ?
	       MUX_pci_Prelude_inst_changeSpecialWires_1_rg$write_1__VAL_1 :
	       82'h0AAAAAAAAAAAAAAAAAAAA ;
  assign pci_Prelude_inst_changeSpecialWires_1_rg$EN =
	     WILL_FIRE_RL_pci_Prelude_inst_changeSpecialWires_1_upconv_connect1 &&
	     !pci_fP2I$D_OUT[79] ||
	     WILL_FIRE_RL_pci_Prelude_inst_changeSpecialWires_1_upconv_connect2 ;

  // register pci_Prelude_inst_changeSpecialWires_2_rg
  assign pci_Prelude_inst_changeSpecialWires_2_rg$D_IN =
	     MUX_pci_Prelude_inst_changeSpecialWires_2_rg$write_1__SEL_1 ?
	       MUX_pci_Prelude_inst_changeSpecialWires_2_rg$write_1__VAL_1 :
	       82'h0AAAAAAAAAAAAAAAAAAAA ;
  assign pci_Prelude_inst_changeSpecialWires_2_rg$EN =
	     WILL_FIRE_RL_pci_Prelude_inst_changeSpecialWires_2_downconv_connect1 &&
	     pci_i2pS[135:128] != 8'd0 ||
	     WILL_FIRE_RL_pci_Prelude_inst_changeSpecialWires_2_downconv_connect2 ;

  // register pci_i2pAF_dInReset_isInReset
  assign pci_i2pAF_dInReset_isInReset$D_IN = 1'd0 ;
  assign pci_i2pAF_dInReset_isInReset$EN = pci_i2pAF_dInReset_isInReset ;

  // register pci_i2pAF_head_wrapped
  assign pci_i2pAF_head_wrapped$D_IN =
	     WILL_FIRE_RL_pci_i2pAF_deq_update_head &&
	     !pci_i2pAF_head_wrapped ;
  assign pci_i2pAF_head_wrapped$EN =
	     WILL_FIRE_RL_pci_i2pAF_deq_update_head ||
	     pci_i2pAF_dInReset_isInReset ;

  // register pci_i2pAF_sInReset_isInReset
  assign pci_i2pAF_sInReset_isInReset$D_IN = 1'd0 ;
  assign pci_i2pAF_sInReset_isInReset$EN = pci_i2pAF_sInReset_isInReset ;

  // register pci_i2pAF_tail_wrapped
  assign pci_i2pAF_tail_wrapped$D_IN = 1'd0 ;
  assign pci_i2pAF_tail_wrapped$EN = pci_i2pAF_sInReset_isInReset ;

  // register pci_i2pS
  assign pci_i2pS$D_IN = 153'h0 ;
  assign pci_i2pS$EN = 1'b0 ;

  // register pci_p2iAF_dInReset_isInReset
  assign pci_p2iAF_dInReset_isInReset$D_IN = 1'd0 ;
  assign pci_p2iAF_dInReset_isInReset$EN = pci_p2iAF_dInReset_isInReset ;

  // register pci_p2iAF_head_wrapped
  assign pci_p2iAF_head_wrapped$D_IN = 1'd0 ;
  assign pci_p2iAF_head_wrapped$EN = pci_p2iAF_dInReset_isInReset ;

  // register pci_p2iAF_sInReset_isInReset
  assign pci_p2iAF_sInReset_isInReset$D_IN = 1'd0 ;
  assign pci_p2iAF_sInReset_isInReset$EN = pci_p2iAF_sInReset_isInReset ;

  // register pci_p2iAF_tail_wrapped
  assign pci_p2iAF_tail_wrapped$D_IN =
	     WILL_FIRE_RL_pci_p2iAF_enq_update_tail &&
	     !pci_p2iAF_tail_wrapped ;
  assign pci_p2iAF_tail_wrapped$EN =
	     WILL_FIRE_RL_pci_p2iAF_enq_update_tail ||
	     pci_p2iAF_sInReset_isInReset ;

  // register pci_p2iS
  assign pci_p2iS$D_IN =
	     MUX_pci_p2iS$write_1__SEL_1 ?
	       MUX_pci_p2iS$write_1__VAL_1 :
	       MUX_pci_p2iS$write_1__VAL_2 ;
  assign pci_p2iS$EN = pci_p2iAF_enq_pw$whas ;

  // register pci_pcie_irq_rInterruptDi
  assign pci_pcie_irq_rInterruptDi$D_IN = pci_pcie_irq_fifoAssert$dD_OUT ;
  assign pci_pcie_irq_rInterruptDi$EN =
	     CAN_FIRE_RL_pci_pcie_irq_msi_enabled_assert_interrupt ;

  // register pci_pcie_irq_rInterruptN
  assign pci_pcie_irq_rInterruptN$D_IN =
	     !WILL_FIRE_RL_pci_pcie_irq_msi_enabled_assert_interrupt ;
  assign pci_pcie_irq_rInterruptN$EN =
	     WILL_FIRE_RL_pci_pcie_irq_msi_enabled_assert_interrupt ||
	     WILL_FIRE_RL_pci_pcie_irq_msi_enabled_assert_interrupt_done ;

  // register pci_pcie_irq_rInterrupting
  assign pci_pcie_irq_rInterrupting$D_IN =
	     !WILL_FIRE_RL_pci_pcie_irq_msi_enabled_assert_interrupt_done ;
  assign pci_pcie_irq_rInterrupting$EN =
	     WILL_FIRE_RL_pci_pcie_irq_msi_enabled_assert_interrupt_done ||
	     WILL_FIRE_RL_pci_pcie_irq_msi_enabled_assert_interrupt ;

  // register pci_pcie_irq_rMMEnabled
  assign pci_pcie_irq_rMMEnabled$D_IN =
	     pci_pci0_pcie_ep$cfg_interrupt_mmenable ;
  assign pci_pcie_irq_rMMEnabled$EN = 1'd1 ;

  // register pci_pcie_irq_rMSIEnabled
  assign pci_pcie_irq_rMSIEnabled$D_IN =
	     pci_pci0_pcie_ep$cfg_interrupt_msienable ;
  assign pci_pcie_irq_rMSIEnabled$EN = 1'd1 ;
  ...
  assign ctop$server_request_put = 153'h0 ;
  ...
  assign ctop$EN_server_request_put = 1'b0 ;
  assign ctop$EN_server_response_get = 1'b0 ;
  ...
  // submodule pci_fI2P
  assign pci_fI2P$D_IN =
	     WILL_FIRE_RL_pci_Prelude_inst_changeSpecialWires_2_downconv_connect1 ?
	       MUX_pci_fI2P$enq_1__VAL_1 :
	       pci_Prelude_inst_changeSpecialWires_2_rg[80:0] ;
  assign pci_fI2P$ENQ =
	     WILL_FIRE_RL_pci_Prelude_inst_changeSpecialWires_2_downconv_connect1 ||
	     WILL_FIRE_RL_pci_Prelude_inst_changeSpecialWires_2_downconv_connect2 ;
  assign pci_fI2P$DEQ =
	     CAN_FIRE_RL_pci_Prelude_inst_changeSpecialWires_3_connect ;
  assign pci_fI2P$CLR = 1'b0 ;

  // submodule pci_fP2I
  assign pci_fP2I$D_IN =
	     { !pci_pci0_pcie_ep$trn_rsof_n,
	       !pci_pci0_pcie_ep$trn_reof_n,
	       ~pci_pci0_pcie_ep$trn_rbar_hit_n,
	       ~pci_pci0_pcie_ep$trn_rrem_n,
	       ~pci_pci0_pcie_ep$trn_rrem_n,
	       ~pci_pci0_pcie_ep$trn_rrem_n,
	       ~pci_pci0_pcie_ep$trn_rrem_n,
  ...
  assign pci_fP2I$DEQ =
	     WILL_FIRE_RL_pci_Prelude_inst_changeSpecialWires_1_upconv_connect2 ||
	     WILL_FIRE_RL_pci_Prelude_inst_changeSpecialWires_1_upconv_connect1 ;
  assign pci_fP2I$CLR = 1'b0 ;

  // submodule pci_pci0_pcie_ep
  assign pci_pci0_pcie_ep$cfg_byte_en_n = 4'd15 ;
  assign pci_pci0_pcie_ep$cfg_di = 32'd0 ;
  assign pci_pci0_pcie_ep$cfg_dsn = 64'h0000000101000A35 ;
  assign pci_pci0_pcie_ep$cfg_dwaddr = 10'd0 ;
  assign pci_pci0_pcie_ep$cfg_err_cor_n = 1'd1 ;
  assign pci_pci0_pcie_ep$cfg_err_cpl_abort_n = 1'd1 ;
  assign pci_pci0_pcie_ep$cfg_err_cpl_timeout_n = 1'd1 ;
  assign pci_pci0_pcie_ep$cfg_err_cpl_unexpect_n = 1'd1 ;
  assign pci_pci0_pcie_ep$cfg_err_ecrc_n = 1'd1 ;
  assign pci_pci0_pcie_ep$cfg_err_locked_n = 1'd1 ;
  assign pci_pci0_pcie_ep$cfg_err_posted_n = 1'd1 ;
  assign pci_pci0_pcie_ep$cfg_err_tlp_cpl_header = 48'd0 ;
  assign pci_pci0_pcie_ep$cfg_err_ur_n = 1'd1 ;
  assign pci_pci0_pcie_ep$cfg_interrupt_assert_n = 1'd1 ;
  assign pci_pci0_pcie_ep$cfg_interrupt_di = pci_pcie_irq_rInterruptDi ;
  assign pci_pci0_pcie_ep$cfg_interrupt_n = pci_pcie_irq_rInterruptN ;
  assign pci_pci0_pcie_ep$cfg_pm_wake_n = 1'd1 ;
  assign pci_pci0_pcie_ep$cfg_rd_en_n = 1'd1 ;
  assign pci_pci0_pcie_ep$cfg_trn_pending_n = 1'd1 ;
  assign pci_pci0_pcie_ep$cfg_turnoff_ok_n = 1'd1 ;
  assign pci_pci0_pcie_ep$cfg_wr_en_n = 1'd1 ;
  assign pci_pci0_pcie_ep$pci_exp_rxn = pcie_rxn_i ;
  assign pci_pci0_pcie_ep$pci_exp_rxp = pcie_rxp_i ;
  assign pci_pci0_pcie_ep$pl_directed_link_auton = 1'b0 ;
  assign pci_pci0_pcie_ep$pl_directed_link_change = 2'h0 ;
  assign pci_pci0_pcie_ep$pl_directed_link_speed = 1'b0 ;
  assign pci_pci0_pcie_ep$pl_directed_link_width = 2'h0 ;
  assign pci_pci0_pcie_ep$pl_upstream_prefer_deemph = 1'b0 ;
  assign pci_pci0_pcie_ep$trn_fc_sel = 3'h0 ;
  assign pci_pci0_pcie_ep$trn_rdst_rdy_n =
	     !CAN_FIRE_RL_pci_Prelude_inst_changeSpecialWires_connect ;
  assign pci_pci0_pcie_ep$trn_rnp_ok_n = 1'd0 ;
  assign pci_pci0_pcie_ep$trn_tcfg_gnt_n = 1'd0 ;
  assign pci_pci0_pcie_ep$trn_td = pci_fI2P$D_OUT[63:0] ;
  assign pci_pci0_pcie_ep$trn_teof_n = !pci_fI2P$D_OUT[79] ;
  assign pci_pci0_pcie_ep$trn_terrfwd_n = 1'd1 ;
  assign pci_pci0_pcie_ep$trn_trem_n = pci_fI2P$D_OUT[71:64] != 8'd255 ;
  assign pci_pci0_pcie_ep$trn_tsof_n = !pci_fI2P$D_OUT[80] ;
  assign pci_pci0_pcie_ep$trn_tsrc_dsc_n = 1'd1 ;
  assign pci_pci0_pcie_ep$trn_tsrc_rdy_n =
	     !CAN_FIRE_RL_pci_Prelude_inst_changeSpecialWires_3_connect ;
  assign pci_pci0_pcie_ep$trn_tstr_n = 1'd1 ;

  // submodule pci_pciDevice
  assign pci_pciDevice$sD_IN =
	     { pci_pci0_pcie_ep$cfg_bus_number,
	       pci_pci0_pcie_ep$cfg_device_number,
	       pci_pci0_pcie_ep$cfg_function_number } ;
  assign pci_pciDevice$sEN = pci_pciDevice$sRDY ;

  // submodule pci_pciLinkUp
  assign pci_pciLinkUp$sD_IN = !pci_pci0_pcie_ep$trn_lnk_up_n ;
  assign pci_pciLinkUp$sEN = pci_pciLinkUp$sRDY ;

  // submodule pci_pcie_irq_fifoAssert
  assign pci_pcie_irq_fifoAssert$sD_IN = 8'h0 ;
  assign pci_pcie_irq_fifoAssert$sENQ = 1'b0 ;
  assign pci_pcie_irq_fifoAssert$dDEQ =
	     CAN_FIRE_RL_pci_pcie_irq_msi_enabled_assert_interrupt ;
  ...
  // remaining internal signals
  assign pci_p2iAF_head_wrapped_crossed__2_EQ_pci_p2iAF_ETC___d101 =
	     pci_p2iAF_head_wrapped == pci_p2iAF_tail_wrapped &&
	     !pci_p2iAF_sInReset_isInReset &&
	     pci_preEdge$CLK_VAL ;
  assign pmemMonW8_wsiS_reqFifo_notFull__14_AND_pmemMon_ETC___d236 =
	     pmemMonW8_wsiS_reqFifo$FULL_N &&
	     (pmemMonW8_wsiS_burstKind == 2'd0 ||
	      (pmemMonW8_wsiS_burstKind == 2'd1 ||
	       pmemMonW8_wsiS_burstKind == 2'd2) &&
	      pmemMonW8_wsiS_wsiReq$wget[57]) ;
  assign val_be__h5588 = { pci_fP2I$D_OUT[71:64], 8'd0 } ;
  assign val_data__h5589 = { pci_fP2I$D_OUT[63:0], 64'hAAAAAAAAAAAAAAAA } ;
  assign wOut_be__h5694 =
	     { pci_Prelude_inst_changeSpecialWires_1_rg[71:64],
	       pci_fP2I$D_OUT[71:64] } ;
  assign wOut_data__h5695 =
	     { pci_Prelude_inst_changeSpecialWires_1_rg[63:0],
	       pci_fP2I$D_OUT[63:0] } ;
  assign z__h13966 = pmemMonW8_pmh[0] ^ pmemMonW8_pmh[1] ;
  assign z__h13973 = z__h13966 ^ pmemMonW8_pmh[2] ;
  assign z__h13980 = z__h13973 ^ pmemMonW8_pmh[3] ;
  assign z__h13987 = z__h13980 ^ pmemMonW8_pmh[4] ;
  assign z__h13994 = z__h13987 ^ pmemMonW8_pmh[5] ;
  assign z__h14001 = z__h13994 ^ pmemMonW8_pmh[6] ;
  assign z__h14008 = z__h14001 ^ pmemMonW8_pmh[7] ;
  assign z__h14015 = z__h14008 ^ pmemMonW8_pmh[8] ;
  assign z__h14022 = z__h14015 ^ pmemMonW8_pmh[9] ;
  assign z__h14029 = z__h14022 ^ pmemMonW8_pmh[10] ;
  assign z__h14036 = z__h14029 ^ pmemMonW8_pmh[11] ;
  assign z__h14043 = z__h14036 ^ pmemMonW8_pmh[12] ;
  assign z__h14050 = z__h14043 ^ pmemMonW8_pmh[13] ;
  assign z__h14057 = z__h14050 ^ pmemMonW8_pmh[14] ;
  assign z__h14064 = z__h14057 ^ pmemMonW8_pmh[15] ;
  assign z__h14071 =
	     z__h14064 ^
	     IF_pmemMonW8_pmh_77_BITS_23_TO_16_09_EQ_0_10_O_ETC___d771[0] ;
  assign z__h14078 =
	     z__h14071 ^
	     IF_pmemMonW8_pmh_77_BITS_23_TO_16_09_EQ_0_10_O_ETC___d771[1] ;
  assign z__h14085 =
	     z__h14078 ^
	     IF_pmemMonW8_pmh_77_BITS_23_TO_16_09_EQ_0_10_O_ETC___d771[2] ;
  assign z__h14092 =
	     z__h14085 ^
	     IF_pmemMonW8_pmh_77_BITS_23_TO_16_09_EQ_0_10_O_ETC___d771[3] ;
  assign z__h14099 =
	     z__h14092 ^
	     IF_pmemMonW8_pmh_77_BITS_23_TO_16_09_EQ_0_10_O_ETC___d771[4] ;
  assign z__h14106 =
	     z__h14099 ^
	     IF_pmemMonW8_pmh_77_BITS_23_TO_16_09_EQ_0_10_O_ETC___d771[5] ;
  assign z__h14113 =
	     z__h14106 ^
	     IF_pmemMonW8_pmh_77_BITS_23_TO_16_09_EQ_0_10_O_ETC___d771[6] ;
  assign z__h14120 =
	     z__h14113 ^
	     IF_pmemMonW8_pmh_77_BITS_23_TO_16_09_EQ_0_10_O_ETC___d771[7] ;
  assign z__h14127 = z__h14120 ^ pmemMonW8_pmh[24] ;
  assign z__h14134 = z__h14127 ^ pmemMonW8_pmh[25] ;
  assign z__h14141 = z__h14134 ^ pmemMonW8_pmh[26] ;
  assign z__h14148 = z__h14141 ^ pmemMonW8_pmh[27] ;
  assign z__h14155 = z__h14148 ^ pmemMonW8_pmh[28] ;
  assign z__h14162 = z__h14155 ^ pmemMonW8_pmh[29] ;
  assign z__h14169 = z__h14162 ^ pmemMonW8_pmh[30] ;
  ...
  begin
    case (pmemMonW8_pmh[23:16])
	  ...
	  IF_pmemMonW8_pmh_77_BITS_23_TO_16_09_EQ_0_10_O_ETC___d771 =
	      pmemMonW8_pmh[23:16];
      default: IF_pmemMonW8_pmh_77_BITS_23_TO_16_09_EQ_0_10_O_ETC___d771 =
		   8'd255;
    endcase
  end
  ...
  always@(posedge pci_pci0_pcie_ep$trn_clk)
  begin
    if (!pci_trn_rst$OUT_RST_N)
      begin
        pci_Prelude_inst_changeSpecialWires_1_rg <= `BSV_ASSIGNMENT_DELAY
	    82'h0AAAAAAAAAAAAAAAAAAAA;
	pci_Prelude_inst_changeSpecialWires_2_rg <= `BSV_ASSIGNMENT_DELAY
	    82'h0AAAAAAAAAAAAAAAAAAAA;
	pci_i2pAF_head_wrapped <= `BSV_ASSIGNMENT_DELAY 1'd0;
	pci_p2iAF_tail_wrapped <= `BSV_ASSIGNMENT_DELAY 1'd0;
	pci_pcie_irq_rInterruptDi <= `BSV_ASSIGNMENT_DELAY 8'd0;
	pci_pcie_irq_rInterruptN <= `BSV_ASSIGNMENT_DELAY 1'd1;
	pci_pcie_irq_rInterrupting <= `BSV_ASSIGNMENT_DELAY 1'd0;
      end
    else
      begin
        if (pci_Prelude_inst_changeSpecialWires_1_rg$EN)
	  pci_Prelude_inst_changeSpecialWires_1_rg <= `BSV_ASSIGNMENT_DELAY
	      pci_Prelude_inst_changeSpecialWires_1_rg$D_IN;
	if (pci_Prelude_inst_changeSpecialWires_2_rg$EN)
	  pci_Prelude_inst_changeSpecialWires_2_rg <= `BSV_ASSIGNMENT_DELAY
	      pci_Prelude_inst_changeSpecialWires_2_rg$D_IN;
	if (pci_i2pAF_head_wrapped$EN)
	  pci_i2pAF_head_wrapped <= `BSV_ASSIGNMENT_DELAY
	      pci_i2pAF_head_wrapped$D_IN;
	if (pci_p2iAF_tail_wrapped$EN)
	  pci_p2iAF_tail_wrapped <= `BSV_ASSIGNMENT_DELAY
	      pci_p2iAF_tail_wrapped$D_IN;
	if (pci_pcie_irq_rInterruptDi$EN)
	  pci_pcie_irq_rInterruptDi <= `BSV_ASSIGNMENT_DELAY
	      pci_pcie_irq_rInterruptDi$D_IN;
	if (pci_pcie_irq_rInterruptN$EN)
	  pci_pcie_irq_rInterruptN <= `BSV_ASSIGNMENT_DELAY
	      pci_pcie_irq_rInterruptN$D_IN;
	if (pci_pcie_irq_rInterrupting$EN)
	  pci_pcie_irq_rInterrupting <= `BSV_ASSIGNMENT_DELAY
	      pci_pcie_irq_rInterrupting$D_IN;
      end
    if (pci_p2iS$EN) pci_p2iS <= `BSV_ASSIGNMENT_DELAY pci_p2iS$D_IN;
    if (pci_pcie_irq_rMMEnabled$EN)
      pci_pcie_irq_rMMEnabled <= `BSV_ASSIGNMENT_DELAY
	  pci_pcie_irq_rMMEnabled$D_IN;
    if (pci_pcie_irq_rMSIEnabled$EN)
      pci_pcie_irq_rMSIEnabled <= `BSV_ASSIGNMENT_DELAY
	  pci_pcie_irq_rMSIEnabled$D_IN;
  end

  always@(posedge pci_pci0_pcie_ep$trn2_clk)
  begin
    if (!pci_trn2_rst$OUT_RST_N)
      begin
        pci_i2pAF_tail_wrapped <= `BSV_ASSIGNMENT_DELAY 1'd0;
	pci_p2iAF_head_wrapped <= `BSV_ASSIGNMENT_DELAY 1'd0;
	...
	pmemMonW8_wsiS_wordCount <= `BSV_ASSIGNMENT_DELAY 12'd1;
      ...
      begin
        if (pci_i2pAF_tail_wrapped$EN)
	  pci_i2pAF_tail_wrapped <= `BSV_ASSIGNMENT_DELAY
	      pci_i2pAF_tail_wrapped$D_IN;
	if (pci_p2iAF_head_wrapped$EN)
	  pci_p2iAF_head_wrapped <= `BSV_ASSIGNMENT_DELAY
	      pci_p2iAF_head_wrapped$D_IN;
    ...
    if (pci_i2pS$EN) pci_i2pS <= `BSV_ASSIGNMENT_DELAY pci_i2pS$D_IN;
  ...
  always@(posedge pci_pci0_pcie_ep$trn_clk or
	  negedge pci_i2pAF_dCombinedReset$RST_OUT)
  if (!pci_i2pAF_dCombinedReset$RST_OUT)
    begin
      pci_i2pAF_dInReset_isInReset <= `BSV_ASSIGNMENT_DELAY 1'd1;
    end
  else
    begin
      if (pci_i2pAF_dInReset_isInReset$EN)
	pci_i2pAF_dInReset_isInReset <= `BSV_ASSIGNMENT_DELAY
	    pci_i2pAF_dInReset_isInReset$D_IN;
    end

  always@(posedge pci_pci0_pcie_ep$trn_clk or
	  negedge pci_p2iAF_sCombinedReset$RST_OUT)
  if (!pci_p2iAF_sCombinedReset$RST_OUT)
    begin
      pci_p2iAF_sInReset_isInReset <= `BSV_ASSIGNMENT_DELAY 1'd1;
    end
  else
    begin
      if (pci_p2iAF_sInReset_isInReset$EN)
	pci_p2iAF_sInReset_isInReset <= `BSV_ASSIGNMENT_DELAY
	    pci_p2iAF_sInReset_isInReset$D_IN;
    end

  always@(posedge pci_pci0_pcie_ep$trn2_clk or
	  negedge pci_i2pAF_sCombinedReset$RST_OUT)
  if (!pci_i2pAF_sCombinedReset$RST_OUT)
    begin
      pci_i2pAF_sInReset_isInReset <= `BSV_ASSIGNMENT_DELAY 1'd1;
    end
  else
    begin
      if (pci_i2pAF_sInReset_isInReset$EN)
	pci_i2pAF_sInReset_isInReset <= `BSV_ASSIGNMENT_DELAY
	    pci_i2pAF_sInReset_isInReset$D_IN;
    end

  always@(posedge pci_pci0_pcie_ep$trn2_clk or
	  negedge pci_p2iAF_dCombinedReset$RST_OUT)
  if (!pci_p2iAF_dCombinedReset$RST_OUT)
    begin
      pci_p2iAF_dInReset_isInReset <= `BSV_ASSIGNMENT_DELAY 1'd1;
    end
  else
    begin
      if (pci_p2iAF_dInReset_isInReset$EN)
	pci_p2iAF_dInReset_isInReset <= `BSV_ASSIGNMENT_DELAY
	    pci_p2iAF_dInReset_isInReset$D_IN;
    end
  ...
  initial
  begin
    pci_Prelude_inst_changeSpecialWires_1_rg = 82'h2AAAAAAAAAAAAAAAAAAAA;
    pci_Prelude_inst_changeSpecialWires_2_rg = 82'h2AAAAAAAAAAAAAAAAAAAA;
    pci_i2pAF_dInReset_isInReset = 1'h0;
    pci_i2pAF_head_wrapped = 1'h0;
    pci_i2pAF_sInReset_isInReset = 1'h0;
    pci_i2pAF_tail_wrapped = 1'h0;
    pci_i2pS = 153'h0AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA;
    pci_p2iAF_dInReset_isInReset = 1'h0;
    pci_p2iAF_head_wrapped = 1'h0;
    pci_p2iAF_sInReset_isInReset = 1'h0;
    pci_p2iAF_tail_wrapped = 1'h0;
    pci_p2iS = 153'h0AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA;
    pci_pcie_irq_rInterruptDi = 8'hAA;
    pci_pcie_irq_rInterruptN = 1'h0;
    pci_pcie_irq_rInterrupting = 1'h0;
    pci_pcie_irq_rMMEnabled = 3'h2;
    pci_pcie_irq_rMSIEnabled = 1'h0;
  ...
  // synopsys translate_off
  always@(negedge pci_pci0_pcie_ep$trn2_clk)
  begin
    #0;
    if (pci_trn2_rst$OUT_RST_N)
    ...
    if (pci_trn2_rst$OUT_RST_N)
	  ...
	  pmemMonW8_pmemF$D_OUT[7:0] == 8'd1 &&
	  !pmemMonW8_pmemF$D_OUT[33])
	$display("[%0d]: %m PMEM HEAD EOF ERROR", v__h15529);
    if (pci_trn2_rst$OUT_RST_N)
      if (WILL_FIRE_RL_pmemMonW8_get_message_head)
	begin
	  v__h15612 = $time;
    ...
    if (pci_trn2_rst$OUT_RST_N)
      if (WILL_FIRE_RL_pmemMonW8_get_message_head)
	$write("[%0d]: %m PMEM event: ", v__h15612);
    if (pci_trn2_rst$OUT_RST_N)
    ...
    if (pci_trn2_rst$OUT_RST_N)
	  ...
	  pmemMonW8_dwRemain == 8'd1 &&
	  !pmemMonW8_pmemF$D_OUT[33])
	$display("[%0d]: %m PMEM BODY EOF ERROR", v__h16911);
    if (pci_trn2_rst$OUT_RST_N)
      if (WILL_FIRE_RL_pmemMonW8_gen_message_body)
	begin
	  v__h16994 = $time;
