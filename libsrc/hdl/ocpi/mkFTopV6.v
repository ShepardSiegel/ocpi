...
//
// On Mon Jan 10 16:58:29 EST 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkFTop(sys0_clkp,
  ...
  wire [31 : 0] dram0$wci_s_MData, dram0$wci_s_SData;
  wire [19 : 0] dram0$wci_s_MAddr;
  ...
  wire [3 : 0] dram0$wci_s_MByteEn;
  wire [2 : 0] dram0$dram_ba, dram0$wci_s_MCmd, dram0$wmemiS_MCmd;
  wire [1 : 0] dram0$wci_s_MFlag,
	       dram0$wci_s_SFlag,
	       dram0$wci_s_SResp,
	       dram0$wmemiS_SResp;
  ...
  wire [31 : 0] flash0$wci_s_MData, flash0$wci_s_SData;
  wire [23 : 0] flash0$flash_addr;
  wire [19 : 0] flash0$wci_s_MAddr;
  wire [15 : 0] flash0$flash_io_dq;
  wire [3 : 0] flash0$wci_s_MByteEn;
  wire [2 : 0] flash0$wci_s_MCmd;
  wire [1 : 0] flash0$wci_s_MFlag, flash0$wci_s_SFlag, flash0$wci_s_SResp;
  wire flash0$flash_adv_n,
       ...
       flash0$flash_we_n,
       flash0$flash_wp_n,
       flash0$wci_s_MAddrSpace,
       flash0$wci_s_SThreadBusy;

  // ports of submodule gbe0
  wire [66 : 0] gbe0$wti_s_req;
  wire [31 : 0] gbe0$wci_rx_MData,
		gbe0$wci_rx_SData,
		gbe0$wci_tx_MData,
		gbe0$wci_tx_SData,
		gbe0$wsiS0_MData;
  wire [19 : 0] gbe0$wci_rx_MAddr, gbe0$wci_tx_MAddr;
  wire [11 : 0] gbe0$wsiS0_MBurstLength;
  wire [7 : 0] gbe0$gmii_rxd_i, gbe0$gmii_txd, gbe0$wsiS0_MReqInfo;
  wire [3 : 0] gbe0$wci_rx_MByteEn, gbe0$wci_tx_MByteEn, gbe0$wsiS0_MByteEn;
  wire [2 : 0] gbe0$wci_rx_MCmd, gbe0$wci_tx_MCmd, gbe0$wsiS0_MCmd;
  ...
  wire gbe0$CLK_gmii_tx_clk,
       ...
       gbe0$gmii_tx_en,
       gbe0$gmii_tx_er,
       gbe0$wci_rx_MAddrSpace,
       gbe0$wci_rx_SThreadBusy,
       gbe0$wci_tx_MAddrSpace,
  ...
  wire [31 : 0] icap$wci_s_MData, icap$wci_s_SData;
  wire [19 : 0] icap$wci_s_MAddr;
  wire [3 : 0] icap$wci_s_MByteEn;
  wire [2 : 0] icap$wci_s_MCmd;
  wire [1 : 0] icap$wci_s_MFlag, icap$wci_s_SFlag, icap$wci_s_SResp;
  wire icap$wci_s_MAddrSpace, icap$wci_s_SThreadBusy;
  ...
  mkDramServer dram0(.CLK_sys0_clk(sys0_clk$O),
		     ...
		     .wci_s_MAddr(dram0$wci_s_MAddr),
		     .wci_s_MAddrSpace(dram0$wci_s_MAddrSpace),
		     .wci_s_MByteEn(dram0$wci_s_MByteEn),
		     .wci_s_MCmd(dram0$wci_s_MCmd),
		     .wci_s_MData(dram0$wci_s_MData),
		     ...
		     .wci_s_SResp(dram0$wci_s_SResp),
		     .wci_s_SData(dram0$wci_s_SData),
  ...
  mkFlashWorker flash0(.wciS0_Clk(pciw_pci0_pcie_ep$trn2_clk),
		       ...
		       .wci_s_MAddr(flash0$wci_s_MAddr),
		       .wci_s_MAddrSpace(flash0$wci_s_MAddrSpace),
		       .wci_s_MByteEn(flash0$wci_s_MByteEn),
		       .wci_s_MCmd(flash0$wci_s_MCmd),
		       .wci_s_MData(flash0$wci_s_MData),
		       .wci_s_MFlag(flash0$wci_s_MFlag),
		       .wci_s_SResp(flash0$wci_s_SResp),
		       .wci_s_SData(flash0$wci_s_SData),
  ...
  mkGbeWorker gbe0(.CLK_gmii_rx_clk(gmii_rx_clk),
		   ...
		   .wci_rx_MAddr(gbe0$wci_rx_MAddr),
		   .wci_rx_MAddrSpace(gbe0$wci_rx_MAddrSpace),
		   .wci_rx_MByteEn(gbe0$wci_rx_MByteEn),
		   .wci_rx_MCmd(gbe0$wci_rx_MCmd),
		   .wci_rx_MData(gbe0$wci_rx_MData),
		   .wci_rx_MFlag(gbe0$wci_rx_MFlag),
		   .wci_tx_MAddr(gbe0$wci_tx_MAddr),
		   .wci_tx_MAddrSpace(gbe0$wci_tx_MAddrSpace),
		   .wci_tx_MByteEn(gbe0$wci_tx_MByteEn),
		   .wci_tx_MCmd(gbe0$wci_tx_MCmd),
		   .wci_tx_MData(gbe0$wci_tx_MData),
		   ...
		   .wci_rx_SResp(gbe0$wci_rx_SResp),
		   .wci_rx_SData(gbe0$wci_rx_SData),
		   .wci_rx_SThreadBusy(gbe0$wci_rx_SThreadBusy),
		   .wci_rx_SFlag(gbe0$wci_rx_SFlag),
		   .wci_tx_SResp(gbe0$wci_tx_SResp),
		   .wci_tx_SData(gbe0$wci_tx_SData),
  ...
  mkICAPWorker #(.isV6ICAP(1'd1),
		 .hasDebugLogic(1'd1)) icap(.wciS0_Clk(pciw_pci0_pcie_ep$trn2_clk),
					    ...
					    .wci_s_MAddr(icap$wci_s_MAddr),
					    .wci_s_MAddrSpace(icap$wci_s_MAddrSpace),
					    .wci_s_MByteEn(icap$wci_s_MByteEn),
					    .wci_s_MCmd(icap$wci_s_MCmd),
					    .wci_s_MData(icap$wci_s_MData),
					    .wci_s_MFlag(icap$wci_s_MFlag),
					    .wci_s_SResp(icap$wci_s_SResp),
					    .wci_s_SData(icap$wci_s_SData),
  ...
  assign ctop$wci_m_0_SData = icap$wci_s_SData ;
  assign ctop$wci_m_0_SFlag = icap$wci_s_SFlag ;
  assign ctop$wci_m_0_SResp = icap$wci_s_SResp ;
  assign ctop$wci_m_1_SData = flash0$wci_s_SData ;
  assign ctop$wci_m_1_SFlag = flash0$wci_s_SFlag ;
  assign ctop$wci_m_1_SResp = flash0$wci_s_SResp ;
  assign ctop$wci_m_2_SData = gbe0$wci_rx_SData ;
  assign ctop$wci_m_2_SFlag = gbe0$wci_rx_SFlag ;
  assign ctop$wci_m_2_SResp = gbe0$wci_rx_SResp ;
  assign ctop$wci_m_3_SData = gbe0$wci_tx_SData ;
  assign ctop$wci_m_3_SFlag = gbe0$wci_tx_SFlag ;
  assign ctop$wci_m_3_SResp = gbe0$wci_tx_SResp ;
  assign ctop$wci_m_4_SData = dram0$wci_s_SData ;
  assign ctop$wci_m_4_SFlag = dram0$wci_s_SFlag ;
  assign ctop$wci_m_4_SResp = dram0$wci_s_SResp ;
  ...
  // submodule dram0
  assign dram0$wci_s_MAddr = ctop$wci_m_4_MAddr ;
  assign dram0$wci_s_MAddrSpace = ctop$wci_m_4_MAddrSpace ;
  assign dram0$wci_s_MByteEn = ctop$wci_m_4_MByteEn ;
  assign dram0$wci_s_MCmd = ctop$wci_m_4_MCmd ;
  assign dram0$wci_s_MData = ctop$wci_m_4_MData ;
  ...
  assign flash0$wci_s_MAddr = ctop$wci_m_1_MAddr ;
  assign flash0$wci_s_MAddrSpace = ctop$wci_m_1_MAddrSpace ;
  assign flash0$wci_s_MByteEn = ctop$wci_m_1_MByteEn ;
  assign flash0$wci_s_MCmd = ctop$wci_m_1_MCmd ;
  assign flash0$wci_s_MData = ctop$wci_m_1_MData ;
  ...
  assign gbe0$wci_rx_MAddr = ctop$wci_m_2_MAddr ;
  assign gbe0$wci_rx_MAddrSpace = ctop$wci_m_2_MAddrSpace ;
  assign gbe0$wci_rx_MByteEn = ctop$wci_m_2_MByteEn ;
  assign gbe0$wci_rx_MCmd = ctop$wci_m_2_MCmd ;
  assign gbe0$wci_rx_MData = ctop$wci_m_2_MData ;
  assign gbe0$wci_rx_MFlag = ctop$wci_m_2_MFlag ;
  assign gbe0$wci_tx_MAddr = ctop$wci_m_3_MAddr ;
  assign gbe0$wci_tx_MAddrSpace = ctop$wci_m_3_MAddrSpace ;
  assign gbe0$wci_tx_MByteEn = ctop$wci_m_3_MByteEn ;
  assign gbe0$wci_tx_MCmd = ctop$wci_m_3_MCmd ;
  assign gbe0$wci_tx_MData = ctop$wci_m_3_MData ;
  ...
  // submodule icap
  assign icap$wci_s_MAddr = ctop$wci_m_0_MAddr ;
  assign icap$wci_s_MAddrSpace = ctop$wci_m_0_MAddrSpace ;
  assign icap$wci_s_MByteEn = ctop$wci_m_0_MByteEn ;
  assign icap$wci_s_MCmd = ctop$wci_m_0_MCmd ;
  assign icap$wci_s_MData = ctop$wci_m_0_MData ;
  ...
  assign wciMonW8$observe_SData = icap$wci_s_SData ;
  assign wciMonW8$observe_SFlag = icap$wci_s_SFlag ;
  assign wciMonW8$observe_SResp = icap$wci_s_SResp ;
