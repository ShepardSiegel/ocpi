...
//
// On Mon Apr 25 14:34:22 EDT 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkFTop_htgs4(sys0_clk,
  ...
  wire [3 : 0] pciw_pcie_ep$pcie_rx_in;
  ...
  wire swParity__h135, z__h569, z__h576, z__h583, z__h590, z__h597, z__h604;
  ...
  // submodule pciw_pcie_ep
  assign pciw_pcie_ep$pcie_rx_in = 4'h0 ;
  ...
  // remaining internal signals
  assign swParity__h135 = z__h604 ^ swReg[7] ;
  assign z__h569 = swReg[0] ^ swReg[1] ;
  assign z__h576 = z__h569 ^ swReg[2] ;
  assign z__h583 = z__h576 ^ swReg[3] ;
  assign z__h590 = z__h583 ^ swReg[4] ;
  assign z__h597 = z__h590 ^ swReg[5] ;
  assign z__h604 = z__h597 ^ swReg[6] ;
