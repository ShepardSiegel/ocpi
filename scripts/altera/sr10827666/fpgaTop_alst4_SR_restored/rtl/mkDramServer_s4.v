...
//
// On Wed Sep 14 15:45:15 EDT 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkDramServer_s4(CLK_sys0_clk,
  ...
  reg [63 : 0] v__h15945, v__h4795, v__h4969, v__h5113;
  reg [31 : 0] IF_wci_wslv_reqF_first__8_BITS_39_TO_32_23_EQ__ETC___d439,
	       g_data__h11856;
  wire [175 : 0] IF_wci_wslv_reqF_first__8_BIT_51_22_THEN_pReg__ETC___d373;
  wire [127 : 0] x1_data__h13097, x1_data__h14098;
  wire [31 : 0] dramStatus__h10498,
		g_data__h15614,
		rdat___1__h15704,
		rdat___1__h15717,
		rdat___1__h15725,
		x1_addr__h14096;
  wire [15 : 0] x1_be__h14097, x__h15654;
  wire [2 : 0] activeBits__h1133;
  wire IF_wci_wslv_reqF_first__8_BIT_51_22_THEN_lreqF_ETC___d398,
       NOT_wci_wslv_respF_c_r_5_EQ_2_4_5_AND_IF_wci_w_ETC___d334,
       lrespF_RDY_first__85_AND_NOT_splitReadInFlight_ETC___d301,
       lrespF_RDY_first__85_AND_NOT_wmemi_respF_c_r_7_ETC___d287,
       wmemi_operateD_05_AND_wmemi_peerIsReady_06_07__ETC___d263;
  ...
  assign WILL_FIRE_RL_wci_cfrd =
	     wci_wslv_reqF$EMPTY_N &&
	     IF_wci_wslv_reqF_first__8_BIT_51_22_THEN_lreqF_ETC___d398 &&
	     wci_wslv_wci_cfrd_pw$whas &&
	     !WILL_FIRE_RL_wci_wslv_ctl_op_start &&
	     !WILL_FIRE_RL_wci_wslv_ctl_op_complete ;
  ...
  assign MUX_lreqF$enq_1__VAL_1 =
	     { !wci_wslv_reqF$D_OUT[51] &&
	       wci_wslv_reqF$D_OUT[39:32] != 8'h54,
	       IF_wci_wslv_reqF_first__8_BIT_51_22_THEN_pReg__ETC___d373 } ;
  ...
  assign MUX_wci_wslv_respF_q_1$write_1__VAL_2 =
	     (wci_wslv_respF_c_r == 2'd2) ?
	       MUX_wci_wslv_respF_q_0$write_1__VAL_1 :
	       34'h0AAAAAAAA ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_1 = { 2'd1, g_data__h11856 } ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_2 = { 2'd1, g_data__h15614 } ;
  ...
  // remaining internal signals
  assign IF_wci_wslv_reqF_first__8_BIT_51_22_THEN_lreqF_ETC___d398 =
	     wci_wslv_reqF$D_OUT[51] ?
	       lreqF$sFULL_N && splaF$FULL_N :
	       wci_wslv_respF_c_r != 2'd2 ;
  assign IF_wci_wslv_reqF_first__8_BIT_51_22_THEN_pReg__ETC___d373 =
	     wci_wslv_reqF$D_OUT[51] ?
	       { x1_addr__h14096, x1_be__h14097, x1_data__h14098 } :
	       { wci_wslv_reqF$D_OUT[31:0], mReg, x1_data__h13097 } ;
  assign NOT_wci_wslv_respF_c_r_5_EQ_2_4_5_AND_IF_wci_w_ETC___d334 =
	     wci_wslv_respF_c_r != 2'd2 &&
	     (wci_wslv_reqF$D_OUT[51] ?
		lreqF$sFULL_N :
		((wci_wslv_reqF$D_OUT[39:32] == 8'h54) ?
  ...
  assign activeBits__h1133 =
	     { memc_curCount[3],
	       memc_sysActive$dD_OUT,
	       memc_afiActive$dD_OUT } ;
  assign dramStatus__h10498 = { 16'd0, x__h15654 } ;
  assign g_data__h15614 =
	     wci_wslv_reqF$D_OUT[51] ?
	       32'd0 :
	       IF_wci_wslv_reqF_first__8_BITS_39_TO_32_23_EQ__ETC___d439 ;
  assign lrespF_RDY_first__85_AND_NOT_splitReadInFlight_ETC___d301 =
	     lrespF$dEMPTY_N &&
	     (!splitReadInFlight ||
	      wci_wslv_respF_c_r != 2'd2 && splaF$EMPTY_N) ;
  assign lrespF_RDY_first__85_AND_NOT_wmemi_respF_c_r_7_ETC___d287 =
	     lrespF$dEMPTY_N && wmemi_respF_c_r != 2'd2 && wmemi_operateD &&
	     wmemi_peerIsReady ;
  assign rdat___1__h15704 = { 16'd0, requestCount$dD_OUT } ;
  assign rdat___1__h15717 = { 16'd0, pReg } ;
  assign rdat___1__h15725 = { 16'd0, mReg } ;
  assign wmemi_operateD_05_AND_wmemi_peerIsReady_06_07__ETC___d263 =
	     wmemi_operateD && wmemi_peerIsReady && wmemi_reqF$EMPTY_N &&
	     (wmemi_reqF$D_OUT[51:49] != 3'd1 || wmemi_dhF$EMPTY_N) ;
  assign x1_addr__h14096 = { pReg[12:0], wci_wslv_reqF$D_OUT[50:36], 4'd0 } ;
  assign x1_be__h14097 =
  ...
  assign x1_data__h13097 = { wdReg_3, wdReg_2, wdReg_1, wdReg } ;
  assign x1_data__h14098 = {4{wci_wslv_reqF$D_OUT[31:0]}} ;
  assign x__h15654 =
	     { respCount,
	       1'h0,
	       activeBits__h1133,
  ...
  begin
    case (splaF$D_OUT)
      2'd0: g_data__h11856 = lrespF$dD_OUT[31:0];
      2'd1: g_data__h11856 = lrespF$dD_OUT[63:32];
      2'd2: g_data__h11856 = lrespF$dD_OUT[95:64];
      2'd3: g_data__h11856 = lrespF$dD_OUT[127:96];
    endcase
  end
  always@(wci_wslv_reqF$D_OUT or
	  dramStatus__h10498 or
	  dramCtrl or
	  rdat___1__h15704 or
	  rdat___1__h15717 or
	  rdat___1__h15725 or
  ...
  begin
    case (wci_wslv_reqF$D_OUT[39:32])
	  ...
	  IF_wci_wslv_reqF_first__8_BITS_39_TO_32_23_EQ__ETC___d439 =
	      rdat___1__h15725;
      8'h60:
	  IF_wci_wslv_reqF_first__8_BITS_39_TO_32_23_EQ__ETC___d439 = wdReg;
      8'h64:
	  IF_wci_wslv_reqF_first__8_BITS_39_TO_32_23_EQ__ETC___d439 = wdReg_1;
      8'h68:
	  IF_wci_wslv_reqF_first__8_BITS_39_TO_32_23_EQ__ETC___d439 = wdReg_2;
      8'h6C:
	  IF_wci_wslv_reqF_first__8_BITS_39_TO_32_23_EQ__ETC___d439 = wdReg_3;
      8'h80:
	  IF_wci_wslv_reqF_first__8_BITS_39_TO_32_23_EQ__ETC___d439 = rdReg;
      8'h84:
	  IF_wci_wslv_reqF_first__8_BITS_39_TO_32_23_EQ__ETC___d439 = rdReg_1;
      8'h88:
	  IF_wci_wslv_reqF_first__8_BITS_39_TO_32_23_EQ__ETC___d439 = rdReg_2;
      8'h8C:
	  IF_wci_wslv_reqF_first__8_BITS_39_TO_32_23_EQ__ETC___d439 = rdReg_3;
      default: IF_wci_wslv_reqF_first__8_BITS_39_TO_32_23_EQ__ETC___d439 =
		   32'd0;
    endcase
  end
