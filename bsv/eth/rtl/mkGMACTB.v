...
//
// On Fri Feb 17 11:38:21 EST 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkGMACTB(CLK,
  ...
  reg [63 : 0] v__h13542,
	       ...
	       v__h65882,
	       v__h66080;
  reg [31 : 0] _theResult____h20727;
  wire [31 : 0] rdat__h20817,
		toCount__h2445,
		wciAddr__h60032,
		x__h2604,
		x_data__h20062;
  wire [26 : 0] IF_wci_lastControlOp_22_BIT_3_23_THEN_wci_last_ETC___d137;
  wire [15 : 0] wsiBurstLength__h65481, x__h20820, x__h65379, x__h65850;
  wire NOT_wci_busy_5_04_AND_IF_wci_wReset_n_5_THEN_N_ETC___d817,
       _dand1wci_busy$EN_write,
       _dand1wci_respF$EN_enq,
       _dor1wci_lastConfigAddr$EN_write,
       wciSeqFsm_abort_whas__63_AND_wciSeqFsm_abort_w_ETC___d875,
       wci_respTimr_7_ULT_1_SL_wci_wTimeout_8_9___d964,
       wsiS_reqFifo_first__99_BITS_43_TO_12_00_EQ_dst_ETC___d940;
  ...
  assign MUX_dstUnrollCnt$write_1__VAL_2 =
	     (dstUnrollCnt == 16'd1) ? wsiBurstLength__h65481 : x__h65850 ;
  assign MUX_srcUnrollCnt$write_1__VAL_2 =
	     (srcUnrollCnt == 16'd1) ? 16'd16 : x__h65379 ;
  ...
  assign MUX_wci_reqF_x_wire$wset_1__VAL_2 =
	     { 8'd63, wciAddr__h60032, 32'h00004242 } ;
  assign MUX_wci_reqF_x_wire$wset_1__VAL_3 =
	     { 8'd90, wciAddr__h60032, 32'hAAAAAAAA } ;
  ...
  assign IF_wci_lastControlOp_22_BIT_3_23_THEN_wci_last_ETC___d137 =
	     { wci_lastControlOp[3] ? wci_lastControlOp[2:0] : 3'b111,
	       ...
	       wci_reqFAIL,
	       wci_reqERR } ;
  assign NOT_wci_busy_5_04_AND_IF_wci_wReset_n_5_THEN_N_ETC___d817 =
  ...
  assign _dor1wci_lastConfigAddr$EN_write =
	     WILL_FIRE_RL_wciSeqFsm_action_l68c8 ||
	     WILL_FIRE_RL_wciSeqFsm_action_l64c8 ;
  assign rdat__h20817 = { 16'd0, x__h20820 } ;
  assign toCount__h2445 = 32'd1 << wci_wTimeout ;
  assign wciAddr__h60032 = { wci_pageWindow, 20'h00004 } ;
  assign wciSeqFsm_abort_whas__63_AND_wciSeqFsm_abort_w_ETC___d875 =
	     (wciSeqFsm_state_mkFSMstate == 5'd0 ||
	      wciSeqFsm_state_mkFSMstate == 5'd22) &&
	     (!wciSeqFsm_start_reg_1 || wciSeqFsm_state_fired) ;
  assign wci_respTimr_7_ULT_1_SL_wci_wTimeout_8_9___d964 =
	     wci_respTimr < toCount__h2445 ;
  assign wsiBurstLength__h65481 = { 4'd0, wsiS_reqFifo$D_OUT[55:44] } ;
  assign wsiS_reqFifo_first__99_BITS_43_TO_12_00_EQ_dst_ETC___d940 =
	     wsiS_reqFifo$D_OUT[43:12] == dstDataOut ;
  assign x__h20820 = { biasWorker_wsiS_statusR, biasWorker_wsiM_statusR } ;
  assign x__h2604 = wci_respTimr + 32'd1 ;
  assign x__h65379 = srcUnrollCnt - 16'd1 ;
  assign x__h65850 = dstUnrollCnt - 16'd1 ;
  assign x_data__h20062 =
  ...
  begin
    case (biasWorker_wci_wslv_reqF$D_OUT[39:32])
      8'h0: _theResult____h20727 = biasWorker_biasValue;
      8'h04: _theResult____h20727 = biasWorker_controlReg;
      8'h20: _theResult____h20727 = rdat__h20817;
      8'h24: _theResult____h20727 = biasWorker_wsiS_extStatusW$wget[95:64];
      8'h28: _theResult____h20727 = biasWorker_wsiS_extStatusW$wget[63:32];
      8'h2C: _theResult____h20727 = biasWorker_wsiS_extStatusW$wget[31:0];
      8'h30: _theResult____h20727 = biasWorker_wsiM_extStatusW$wget[95:64];
      8'h34: _theResult____h20727 = biasWorker_wsiM_extStatusW$wget[63:32];
      8'h38: _theResult____h20727 = biasWorker_wsiM_extStatusW$wget[31:0];
      default: _theResult____h20727 = 32'd0;
    endcase
  end
  ...
  begin
    ...
    if (RST_N)
      if (simCycle == 16'd1000)
	$display("[%0d]: %m: mkGMACTB termination", v__h66080);
    if (RST_N)
    ...
    if (RST_N)
      if (wciSeqFsm_state_mkFSMstate == 5'd2)
	$display("[%0d]: %m: Taking DUT out of Reset...", v__h57636);
    if (RST_N)
    ...
    if (RST_N)
      if (wciSeqFsm_state_mkFSMstate == 5'd5)
	$display("[%0d]: %m: CONTROL-OP: -INITIALIZE- DUT...", v__h58678);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_wciSeqFsm_action_l60c8)
	$display("[%0d]: %m: WORKER CONTROL ARM...", v__h58982);
    if (RST_N)
    ...
    if (RST_N)
      if (wciSeqFsm_state_mkFSMstate == 5'd11)
	$display("[%0d]: %m: Read Dataplane Config Properties...", v__h60823);
    if (RST_N)
    ...
    if (RST_N)
      if (wciSeqFsm_state_mkFSMstate == 5'd14)
	$display("[%0d]: %m: CONTROL-OP: -START- DUT...", v__h61977);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_wciSeqFsm_action_l72c8)
	$display("[%0d]: %m: WORKER CONTROL ARM...", v__h62353);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_wciSeqFsm_action_l52c5)
	$display("[%0d]: %m: Checking for DUT presence...", v__h57208);
    if (RST_N)
      if (WILL_FIRE_RL_wciSeqFsm_action_l52c5 &&
	  (WILL_FIRE_RL_wciSeqFsm_action_l53c10 ||
	   wciSeqFsm_state_mkFSMstate == 5'd2 ||
