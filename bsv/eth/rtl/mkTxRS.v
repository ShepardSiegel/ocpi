...
module mkTxRS(CLK,
  ...
  reg [63 : 0] v__h3237;
  wire lenCnt_value_1_ULT_60___d88, preambleCnt_value_5_ULT_7___d131;
  ...
  // submodule txF
  FIFO2 #(.width(32'd12), .guarded(32'd1)) txF(.RST_N(RST_N),
					       .CLK(CLK),
					       .D_IN(txF$D_IN),
					       .ENQ(txF$ENQ),
					       .DEQ(txF$DEQ),
  ...
  assign MUX_txData_1$wset_1__VAL_3 =
	     preambleCnt_value_5_ULT_7___d131 ?
	       8'd85 :
  ...
  assign lenCnt_incAction$whas =
	     WILL_FIRE_RL_egress_SOF && !preambleCnt_value_5_ULT_7___d131 &&
  ...
  assign doPad$EN =
	     WILL_FIRE_RL_egress_EOF && lenCnt_value_1_ULT_60___d88 ||
	     WILL_FIRE_RL_egress_PAD && !lenCnt_value_1_ULT_60___d88 ;
  ...
  // remaining internal signals
  assign lenCnt_value_1_ULT_60___d88 = lenCnt_value < 12'd60 ;
  assign preambleCnt_value_5_ULT_7___d131 = preambleCnt_value < 5'd7 ;
