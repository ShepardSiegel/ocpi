...
Core=onewire
SourceFiles+=$(OCPI_DIR)/lib/hdl/onewire.v
AuthoredSourceFiles=$(sort $(SourceFiles))
WorkLibrarySources+=$(OCPI_DIR)/lib/hdl/onewire.v
ifndef Targets
...
$(OutDir)$(1)/$(LibName)/$(call LibraryFileTarget,$(1)): $(SourceFiles) | $(OutDir)$(1)
...
#	      done;\
#	      echo verilog work $(call FindRelative,$(OutDir)$(Family),$(OCPI_DIR)/lib/hdl)/onewire.v)\
