...
//
// On Thu May 31 14:04:39 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkSPIFlashWorker(wciS0_Clk,
  ...
  wire flash_clk, flash_cs_n, flash_mosi, flash_wp_n, wciS0_SThreadBusy;
  ...
  // register flashC_wpReg
  reg flashC_wpReg;
  wire flashC_wpReg$D_IN, flashC_wpReg$EN;
  ...
  reg [63 : 0] v__h3618, v__h3792, v__h3936, v__h6865;
  reg [31 : 0] CASE_wci_wslv_reqFD_OUT_BITS_39_TO_32_0_0x0_f_ETC__q1;
  wire [31 : 0] flashStatus__h5849, g_data__h6728;
  wire wci_wslv_reqF_i_notEmpty__4_AND_IF_wci_wslv_re_ETC___d215,
       wci_wslv_reqF_i_notEmpty__4_AND_wci_wslv_reqF__ETC___d194;
  ...
  // value method flash_mosi
  assign flash_mosi = flashC_mosiReg ;

  // value method flash_clk
  assign flash_clk = flashC_clkReg ;

  // value method flash_cs_n
  assign flash_cs_n = !flashC_csReg ;

  // value method flash_wp_n
  assign flash_wp_n = !flashC_wpReg ;
  ...
  assign WILL_FIRE_RL_wci_cfrd =
	     wci_wslv_reqF_i_notEmpty__4_AND_IF_wci_wslv_re_ETC___d215 &&
	     wci_wslv_wci_cfrd_pw$whas &&
	     !WILL_FIRE_RL_wci_wslv_ctl_op_start &&
	     !WILL_FIRE_RL_wci_wslv_ctl_op_complete ;
  ...
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_2 = { 2'd1, g_data__h6728 } ;
  ...
  assign flashC_wpReg_1$wget = 1'b0 ;
  assign flashC_wpReg_1$whas = 1'b0 ;
  ...
  // register flashC_misoReg
  assign flashC_misoReg$D_IN = flash_miso_i ;
  ...
  // register flashC_wpReg
  assign flashC_wpReg$D_IN = 1'b0 ;
  assign flashC_wpReg$EN = 1'd1 ;
  ...
  // remaining internal signals
  assign flashStatus__h5849 = { 31'd1, flashC_waitReg } ;
  assign g_data__h6728 =
	     wci_wslv_reqF$D_OUT[51] ?
	       32'd0 :
	       CASE_wci_wslv_reqFD_OUT_BITS_39_TO_32_0_0x0_f_ETC__q1 ;
  assign wci_wslv_reqF_i_notEmpty__4_AND_IF_wci_wslv_re_ETC___d215 =
	     wci_wslv_reqF$EMPTY_N &&
	     (wci_wslv_reqF$D_OUT[51] ?
		flashC_reqF$FULL_N :
		wci_wslv_respF_c_r != 2'd2) ;
  assign wci_wslv_reqF_i_notEmpty__4_AND_wci_wslv_reqF__ETC___d194 =
	     wci_wslv_reqF$EMPTY_N &&
	     ((wci_wslv_reqF$D_OUT[39:32] == 8'h14) ?
		flashC_reqF$FULL_N :
		wci_wslv_reqF$D_OUT[39:32] != 8'h18 || flashC_reqF$FULL_N) ;
  always@(wci_wslv_reqF$D_OUT or
	  flashStatus__h5849 or flashCtrl or aReg or wdReg or rdReg)
  begin
  ...
  begin
	...
	flashC_wpReg <= `BSV_ASSIGNMENT_DELAY 1'd0;
	...
	if (flashC_wpReg$EN)
	  flashC_wpReg <= `BSV_ASSIGNMENT_DELAY flashC_wpReg$D_IN;
