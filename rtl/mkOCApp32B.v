...
//
// On Wed Nov  9 10:01:36 EST 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkOCApp32B(RST_N_rst_0,
  ...
  wire [255 : 0] appW3$wsiM0_MData, appW3$wsiS0_MData;
  ...
  // submodule appW2
  mkSMAdapter32B #(.smaCtrlInit(32'h00000001),
  ...
  // submodule appW3
  mkBiasWorker32B #(.hasDebugLogic(hasDebugLogic)) appW3(.wciS0_Clk(CLK),
  ...
  // submodule appW4
  mkSMAdapter32B #(.smaCtrlInit(32'h00000002),
