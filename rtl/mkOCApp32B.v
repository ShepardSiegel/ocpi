...
//
// On Wed Nov 10 07:49:33 EST 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkOCApp32B(RST_N_rst_0,
  ...
  wire [307 : 0] IF_appW2_respF_wDataIn_whas__26_THEN_appW2_res_ETC___d2556,
		 IF_appW4_respF_wDataIn_whas__092_THEN_appW4_re_ETC___d2549;
  wire [255 : 0] x__h38357, x__h42110;
  ...
  wire [2 : 0] IF_appW2_respF_wDataIn_whas__26_THEN_appW2_res_ETC___d2546,
  ...
  assign appW3_bytesThisMessage$D_IN =
		 ...
		 { 5'd0, appW3_mesgLengthSoFar_248_PLUS_1___d2803 },
	       5'd0 } ;
  ...
  // submodule appW3_mesgRF
  assign appW3_mesgRF$D_IN = { 224'd0, v__h43332 } ;
  ...
  assign IF_appW4_respF_wDataIn_whas__092_THEN_appW4_re_ETC___d2547 =
	     appW4_respF_pwEnqueue$whas ?
	       ...
	       3'd0 ;
  assign IF_appW4_respF_wDataIn_whas__092_THEN_appW4_re_ETC___d2549 =
	     appW4_respF_pwEnqueue$whas ?
  ...
  assign addr__h20308 = { appW2_mesgLengthSoFar[8:0], 5'd0 } ;
  assign addr__h42667 = { 9'd0, x__h42725 } ;
  assign addr__h43017 = { 9'd0, x__h43062 } ;
  assign addr__h67705 = { appW4_mesgLengthSoFar[8:0], 5'd0 } ;
  ...
  assign b__h65386 =
	     { {2{appW4_fabRespCredit_value[11]}},
	       appW4_fabRespCredit_value } ;
  assign bl__h19563 =
	     appW2_zeroLengthMesg ? 12'd1 : { 3'd0, x__h19474[13:5] } ;
  assign bl__h66960 =
	     appW4_zeroLengthMesg ? 12'd1 : { 3'd0, x__h66871[13:5] } ;
  assign btm__h40846 =
	     { appW3_wsiS_reqFifo$D_OUT[308] ?
		 { 7'd0, appW3_wsiS_reqFifo$D_OUT[307:296] } :
		 { 5'd0, appW3_mesgLengthSoFar_248_PLUS_1___d2803 },
  ...
  assign mlp1B__h20292 = { mlp1__h20291[8:0], 5'd0 } ;
  assign mlp1B__h67689 = { mlp1__h67688[8:0], 5'd0 } ;
