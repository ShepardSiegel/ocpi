...
//
// On Wed Oct 30 08:48:03 EDT 2013
//
//
// Ports:
// Name                         I/O  size props
...
module mkICAPWorker(wciS0_Clk,
  ...
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_2 = { 2'd1, v__h26380 } ;
  ...
  assign coutF_memory$ADDRB =
	     coutF_pwDequeue$whas ? x__h21947[9:0] : x2__h21916 ;
  assign coutF_memory$DIA = x3__h20684 ;
  ...
  assign rdat__h26416 = hasDebugLogic ? inCnt$dD_OUT : 32'd0 ;
  assign rdat__h26422 = hasDebugLogic ? outCnt$dD_OUT : 32'd0 ;
  ...
  assign x2__h21916 =
	     { coutF_rRdPtr_rsCounter_91_BIT_10_17_XOR_coutF__ETC___d481,
	       ...
	       coutF_rRdPtr_rsCounter_91_BIT_10_17_XOR_coutF__ETC___d493,
	       coutF_rRdPtr_rsCounter_91_BIT_10_17_XOR_coutF__ETC___d494 } ;
  assign x3__h20684 = coutF_pwEnqueue$whas ? icap_coutF$D_OUT : 32'd0 ;
  assign x__h16273 =
	     11'd1 <<
	     IF_coutF_rWrPtr_rsCounter_22_BIT_0_29_XOR_cout_ETC___d371 ;
  assign x__h18575 =
  ...
  begin
    case (wci_wslv_reqF$D_OUT[63:32])
      ...
      32'h0000000C: v__h26380 = coutF_memory$DOB;
