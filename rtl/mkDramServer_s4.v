...
//
// On Mon Jan 16 15:16:04 EST 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkDramServer_s4(CLK_sys0_clk,
  ...
  reg [63 : 0] v__h17566, v__h6405, v__h6579, v__h6723;
  reg [31 : 0] IF_wci_wslv_reqF_first__07_BITS_39_TO_32_73_EQ_ETC___d489,
	       g_data__h13477;
  wire [175 : 0] IF_wci_wslv_reqF_first__07_BIT_51_72_THEN_pReg_ETC___d423;
  wire [127 : 0] x1_data__h14718, x1_data__h15719;
  wire [31 : 0] dramStatus__h12119,
		g_data__h17235,
		rdat___1__h17325,
		rdat___1__h17338,
		rdat___1__h17346,
		x1_addr__h15717;
  wire [15 : 0] x1_be__h15718, x__h17275;
  wire [2 : 0] activeBits__h1948;
  wire IF_wci_wslv_reqF_first__07_BIT_51_72_THEN_lreq_ETC___d448,
       lrespF_RDY_first__35_AND_NOT_splitReadInFlight_ETC___d351,
       lrespF_RDY_first__35_AND_NOT_wmemi_respF_c_r_1_ETC___d337,
       wci_wslv_reqF_i_notEmpty__06_AND_IF_wci_wslv_r_ETC___d384,
       wmemi_operateD_54_AND_wmemi_peerIsReady_55_56__ETC___d313;
  ...
  assign WILL_FIRE_RL_wci_cfrd =
	     wci_wslv_reqF$EMPTY_N &&
	     IF_wci_wslv_reqF_first__07_BIT_51_72_THEN_lreq_ETC___d448 &&
	     wci_wslv_wci_cfrd_pw$whas &&
	     !WILL_FIRE_RL_wci_wslv_ctl_op_start &&
	     !WILL_FIRE_RL_wci_wslv_ctl_op_complete ;
  ...
  assign MUX_lreqF$enq_1__VAL_1 =
	     { !wci_wslv_reqF$D_OUT[51] &&
	       wci_wslv_reqF$D_OUT[39:32] != 8'h54,
	       IF_wci_wslv_reqF_first__07_BIT_51_72_THEN_pReg_ETC___d423 } ;
  ...
  assign MUX_wci_wslv_respF_q_1$write_1__VAL_1 =
	     (wci_wslv_respF_c_r == 2'd2) ?
	       MUX_wci_wslv_respF_q_0$write_1__VAL_2 :
	       34'h0AAAAAAAA ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_1 = { 2'd1, g_data__h13477 } ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_2 = { 2'd1, g_data__h17235 } ;
  ...
  assign requestCount$sEN = requestCount$sRDY ;
  ...
  // remaining internal signals
  assign IF_wci_wslv_reqF_first__07_BIT_51_72_THEN_lreq_ETC___d448 =
	     wci_wslv_reqF$D_OUT[51] ?
	       lreqF$sFULL_N && splaF$FULL_N :
	       wci_wslv_respF_c_r != 2'd2 ;
  assign IF_wci_wslv_reqF_first__07_BIT_51_72_THEN_pReg_ETC___d423 =
	     wci_wslv_reqF$D_OUT[51] ?
	       { x1_addr__h15717, x1_be__h15718, x1_data__h15719 } :
	       { wci_wslv_reqF$D_OUT[31:0], mReg, x1_data__h14718 } ;
  assign activeBits__h1948 =
	     { memc_curCount[3],
	       memc_sysActive$dD_OUT,
	       memc_afiActive$dD_OUT } ;
  assign dramStatus__h12119 = { 16'd0, x__h17275 } ;
  assign g_data__h17235 =
	     wci_wslv_reqF$D_OUT[51] ?
	       32'd0 :
	       IF_wci_wslv_reqF_first__07_BITS_39_TO_32_73_EQ_ETC___d489 ;
  assign lrespF_RDY_first__35_AND_NOT_splitReadInFlight_ETC___d351 =
	     lrespF$dEMPTY_N &&
	     (!splitReadInFlight ||
	      wci_wslv_respF_c_r != 2'd2 && splaF$EMPTY_N) ;
  assign lrespF_RDY_first__35_AND_NOT_wmemi_respF_c_r_1_ETC___d337 =
	     lrespF$dEMPTY_N && wmemi_respF_c_r != 2'd2 && wmemi_operateD &&
	     wmemi_peerIsReady ;
  assign rdat___1__h17325 = { 16'd0, requestCount$dD_OUT } ;
  assign rdat___1__h17338 = { 16'd0, pReg } ;
  assign rdat___1__h17346 = { 16'd0, mReg } ;
  assign wci_wslv_reqF_i_notEmpty__06_AND_IF_wci_wslv_r_ETC___d384 =
	     wci_wslv_reqF$EMPTY_N &&
	     (wci_wslv_reqF$D_OUT[51] ?
		lreqF$sFULL_N :
		((wci_wslv_reqF$D_OUT[39:32] == 8'h54) ?
  ...
  assign wmemi_operateD_54_AND_wmemi_peerIsReady_55_56__ETC___d313 =
	     wmemi_operateD && wmemi_peerIsReady && wmemi_reqF$EMPTY_N &&
	     (wmemi_reqF$D_OUT[51:49] != 3'd1 || wmemi_dhF$EMPTY_N) ;
  assign x1_addr__h15717 = { pReg[12:0], wci_wslv_reqF$D_OUT[50:36], 4'd0 } ;
  assign x1_be__h15718 =
  ...
  assign x1_data__h14718 = { wdReg_3, wdReg_2, wdReg_1, wdReg } ;
  assign x1_data__h15719 = {4{wci_wslv_reqF$D_OUT[31:0]}} ;
  assign x__h17275 =
	     { respCount,
	       1'h0,
	       activeBits__h1948,
  ...
  begin
    case (splaF$D_OUT)
      2'd0: g_data__h13477 = lrespF$dD_OUT[31:0];
      2'd1: g_data__h13477 = lrespF$dD_OUT[63:32];
      2'd2: g_data__h13477 = lrespF$dD_OUT[95:64];
      2'd3: g_data__h13477 = lrespF$dD_OUT[127:96];
    endcase
  end
  always@(wci_wslv_reqF$D_OUT or
	  dramStatus__h12119 or
	  dramCtrl or
	  rdat___1__h17325 or
	  rdat___1__h17338 or
	  rdat___1__h17346 or
  ...
  begin
    case (wci_wslv_reqF$D_OUT[39:32])
	  ...
	  IF_wci_wslv_reqF_first__07_BITS_39_TO_32_73_EQ_ETC___d489 =
	      rdat___1__h17346;
      8'h60:
	  IF_wci_wslv_reqF_first__07_BITS_39_TO_32_73_EQ_ETC___d489 = wdReg;
      8'h64:
	  IF_wci_wslv_reqF_first__07_BITS_39_TO_32_73_EQ_ETC___d489 = wdReg_1;
      8'h68:
	  IF_wci_wslv_reqF_first__07_BITS_39_TO_32_73_EQ_ETC___d489 = wdReg_2;
      8'h6C:
	  IF_wci_wslv_reqF_first__07_BITS_39_TO_32_73_EQ_ETC___d489 = wdReg_3;
      8'h80:
	  IF_wci_wslv_reqF_first__07_BITS_39_TO_32_73_EQ_ETC___d489 = rdReg;
      8'h84:
	  IF_wci_wslv_reqF_first__07_BITS_39_TO_32_73_EQ_ETC___d489 = rdReg_1;
      8'h88:
	  IF_wci_wslv_reqF_first__07_BITS_39_TO_32_73_EQ_ETC___d489 = rdReg_2;
      8'h8C:
	  IF_wci_wslv_reqF_first__07_BITS_39_TO_32_73_EQ_ETC___d489 = rdReg_3;
      default: IF_wci_wslv_reqF_first__07_BITS_39_TO_32_73_EQ_ETC___d489 =
		   32'd0;
    endcase
  end
  ...
  begin
	...
	$display("Error: \"bsv/wrk/DramServer_s4.bsv\", line 127, column 28: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_cfwr] and\n  [RL_advance_response] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n)
	...
	$display("Error: \"bsv/wrk/DramServer_s4.bsv\", line 127, column 38: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_cfrd] and\n  [RL_advance_response] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n)
	...
	$display("Error: \"bsv/wrk/DramServer_s4.bsv\", line 127, column 62: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_ctrl_IsO] and\n  [RL_wci_ctrl_OrE] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wci_ctrl_EiI && WILL_FIRE_RL_wci_ctrl_OrE)
	$display("Error: \"bsv/wrk/DramServer_s4.bsv\", line 127, column 48: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_ctrl_EiI] and\n  [RL_wci_ctrl_OrE] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n)
