...
//
// On Tue Jun  5 09:37:42 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkDramServer_s4(CLK_sys0_clk,
  ...
  reg [63 : 0] v__h17740, v__h6463, v__h6637, v__h6781;
  ...
  wire [127 : 0] x1_data__h14876, x1_data__h15877;
  wire [31 : 0] dramStatus__h12264,
		g_data__h17393,
		rdat___1__h17483,
		rdat___1__h17494,
		rdat___1__h17500,
		...
		rdat___1__h17621,
		x1_addr__h15875;
  wire [15 : 0] x1_be__h15876, x__h17433;
  wire [2 : 0] activeBits__h1959;
  wire IF_wci_wslv_reqF_first__09_BIT_51_83_THEN_lreq_ETC___d459,
       ...
       wmemiReadInFlight_value_85_SLT_16___d594;
  ...
  assign MUX_wci_wslv_respF_q_1$write_1__VAL_1 =
	     (wci_wslv_respF_c_r == 2'd2) ?
	       MUX_wci_wslv_respF_q_0$write_1__VAL_2 :
	       34'h0AAAAAAAA ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_1 = { 2'd1, g_data__h13635 } ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_2 = { 2'd1, g_data__h17393 } ;
  ...
  assign IF_wci_wslv_reqF_first__09_BIT_51_83_THEN_pReg_ETC___d434 =
	     wci_wslv_reqF$D_OUT[51] ?
	       { x1_addr__h15875, x1_be__h15876, x1_data__h15877 } :
	       { wci_wslv_reqF$D_OUT[31:0], mReg, x1_data__h14876 } ;
  assign IF_wmemi_reqF_first__11_BITS_51_TO_49_12_EQ_1__ETC___d320 =
	     (wmemi_reqF$D_OUT[51:49] == 3'd1) ?
	       lreqF$sFULL_N && wmemi_dhF$EMPTY_N :
	       !wmemiReadInFlight_value_85_SLT_16___d594 || lreqF$sFULL_N ;
  assign activeBits__h1959 =
	     { memc_curCount[3],
	       memc_sysActive$dD_OUT,
	       memc_afiActive$dD_OUT } ;
  assign dramStatus__h12264 = { 16'd0, x__h17433 } ;
  assign g_data__h17393 =
	     wci_wslv_reqF$D_OUT[51] ?
	       32'd0 :
  ...
  assign lrespF_RDY_first__46_AND_NOT_wmemi_respF_c_r_2_ETC___d348 =
	     ...
	     wmemi_peerIsReady ;
  assign rdat___1__h17483 =
	     hasDebugLogic ? { 16'd0, requestCount$dD_OUT } : 32'd0 ;
  assign rdat___1__h17494 = hasDebugLogic ? 32'hC0DE4002 : 32'd0 ;
  assign rdat___1__h17500 = hasDebugLogic ? { 16'd0, pReg } : 32'd0 ;
  assign rdat___1__h17510 = hasDebugLogic ? { 16'd0, mReg } : 32'd0 ;
  assign rdat___1__h17520 = hasDebugLogic ? wdReg : 32'd0 ;
  assign rdat___1__h17534 = hasDebugLogic ? wdReg_1 : 32'd0 ;
  assign rdat___1__h17548 = hasDebugLogic ? wdReg_2 : 32'd0 ;
  assign rdat___1__h17562 = hasDebugLogic ? wdReg_3 : 32'd0 ;
  assign rdat___1__h17576 = hasDebugLogic ? rdReg : 32'd0 ;
  assign rdat___1__h17591 = hasDebugLogic ? rdReg_1 : 32'd0 ;
  assign rdat___1__h17606 = hasDebugLogic ? rdReg_2 : 32'd0 ;
  assign rdat___1__h17621 = hasDebugLogic ? rdReg_3 : 32'd0 ;
  ...
  assign wmemiReadInFlight_value_85_SLT_16___d594 =
	     (wmemiReadInFlight_value ^ 8'h80) < 8'd144 ;
  assign x1_addr__h15875 = { pReg[12:0], wci_wslv_reqF$D_OUT[50:36], 4'd0 } ;
  assign x1_be__h15876 =
  ...
  assign x1_data__h14876 = { wdReg_3, wdReg_2, wdReg_1, wdReg } ;
  assign x1_data__h15877 = {4{wci_wslv_reqF$D_OUT[31:0]}} ;
  assign x__h17433 =
	     { respCount,
	       1'h0,
	       activeBits__h1959,
  ...
  begin
    case (splaF$D_OUT)
      2'd0: g_data__h13635 = lrespF$dD_OUT[31:0];
      2'd1: g_data__h13635 = lrespF$dD_OUT[63:32];
      2'd2: g_data__h13635 = lrespF$dD_OUT[95:64];
      2'd3: g_data__h13635 = lrespF$dD_OUT[127:96];
    endcase
  end
  always@(wci_wslv_reqF$D_OUT or
	  dramStatus__h12264 or
	  dramCtrl or
	  rdat___1__h17483 or
	  rdat___1__h17494 or
	  rdat___1__h17500 or
	  ...
	  rdat___1__h17562 or
	  rdat___1__h17576 or
	  rdat___1__h17591 or rdat___1__h17606 or rdat___1__h17621)
  begin
  ...
  always@(posedge memc_memc$afi_clk or negedge memc_memc$afi_reset_n)
  if (!memc_memc$afi_reset_n)
    begin
