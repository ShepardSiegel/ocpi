...
//
// On Wed Sep  7 10:30:53 EDT 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkDramServer_s4(CLK_sys0_clk,
  ...
  reg [63 : 0] v__h15595, v__h3631, v__h3805, v__h3949;
  reg [31 : 0] CASE_wci_wslv_reqFD_OUT_BITS_39_TO_32_0_0x0_d_ETC__q1,
	       g_data__h11538;
  wire [175 : 0] IF_wci_wslv_reqF_first__5_BIT_51_13_THEN_pReg__ETC___d364;
  wire [127 : 0] x1_data__h12779, x1_data__h13780;
  wire [31 : 0] dramStatus__h10180,
		g_data__h15296,
		rdat___1__h15359,
		rdat___1__h15368,
		rdat___1__h15376,
		x1_addr__h13778;
  wire [15 : 0] x1_be__h13779, x__h15336;
  wire IF_wci_wslv_reqF_first__5_BIT_51_13_THEN_lreqF_ETC___d389,
       NOT_wci_wslv_respF_c_r_2_EQ_2_1_2_AND_IF_wci_w_ETC___d325,
       lrespF_RDY_first__76_AND_NOT_splitReadInFlight_ETC___d292,
       lrespF_RDY_first__76_AND_NOT_wmemi_respF_c_r_6_ETC___d278,
       wmemi_operateD_97_AND_wmemi_peerIsReady_98_99__ETC___d254;
  ...
  // submodule appFull
  SyncBit #(.init(1'd0)) appFull(.sCLK(memc_memc$afi_half_clk),
				 .dCLK(wciS0_Clk),
  ...
  // submodule firBeat
  SyncBit #(.init(1'd0)) firBeat(.sCLK(memc_memc$afi_half_clk),
				 .dCLK(wciS0_Clk),
				 .sRST_N(memc_memc$afi_reset_n),
				 .sD_IN(firBeat$sD_IN),
				 .sEN(firBeat$sEN),
  ...
  SyncBit #(.init(1'd0)) initComplete(.sCLK(memc_memc$afi_half_clk),
				      .dCLK(wciS0_Clk),
				      .sRST_N(memc_memc$afi_reset_n),
  ...
  ddr3_s4_uniphy memc_memc(.pll_ref_clk(CLK_sys0_clk),
			   .global_reset_n(RST_N_sys0_rstn),
  ...
  // submodule secBeat
  SyncBit #(.init(1'd0)) secBeat(.sCLK(memc_memc$afi_half_clk),
				 .dCLK(wciS0_Clk),
				 .sRST_N(memc_memc$afi_reset_n),
				 .sD_IN(secBeat$sD_IN),
				 .sEN(secBeat$sEN),
  ...
  // submodule wdfFull
  SyncBit #(.init(1'd0)) wdfFull(.sCLK(memc_memc$afi_half_clk),
				 .dCLK(wciS0_Clk),
				 .sRST_N(memc_memc$afi_reset_n),
				 .sD_IN(wdfFull$sD_IN),
				 .sEN(wdfFull$sEN),
  ...
  assign WILL_FIRE_RL_wci_cfrd =
	     wci_wslv_reqF$EMPTY_N &&
	     IF_wci_wslv_reqF_first__5_BIT_51_13_THEN_lreqF_ETC___d389 &&
	     wci_wslv_wci_cfrd_pw$whas &&
	     !WILL_FIRE_RL_wci_wslv_ctl_op_start &&
	     !WILL_FIRE_RL_wci_wslv_ctl_op_complete ;
  ...
  assign MUX_lreqF$enq_1__VAL_1 =
	     { !wci_wslv_reqF$D_OUT[51] &&
	       wci_wslv_reqF$D_OUT[39:32] != 8'h54,
	       IF_wci_wslv_reqF_first__5_BIT_51_13_THEN_pReg__ETC___d364 } ;
  ...
  assign MUX_wci_wslv_respF_q_1$write_1__VAL_2 =
	     (wci_wslv_respF_c_r == 2'd2) ?
	       MUX_wci_wslv_respF_q_0$write_1__VAL_1 :
	       34'h0AAAAAAAA ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_1 = { 2'd1, g_data__h11538 } ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_2 = { 2'd1, g_data__h15296 } ;
  ...
  // submodule appFull
  assign appFull$sD_IN = 1'b0 ;
  assign appFull$sEN = 1'b0 ;

  // submodule firBeat
  assign firBeat$sD_IN = 1'b0 ;
  assign firBeat$sEN = 1'b0 ;

  // submodule initComplete
  assign initComplete$sD_IN =
	     memc_memc$local_init_done && memc_memc$local_cal_success ;
  ...
  // submodule memc_memc
  assign memc_memc$avl_addr = 24'h0 ;
  assign memc_memc$avl_be = 8'h0 ;
  assign memc_memc$avl_burstbegin = 1'b0 ;
  assign memc_memc$avl_size = 3'h0 ;
  assign memc_memc$avl_wdata = 64'h0 ;
  ...
  // submodule secBeat
  assign secBeat$sD_IN = 1'b0 ;
  assign secBeat$sEN = 1'b0 ;
  ...
  // submodule wdfFull
  assign wdfFull$sD_IN = 1'b0 ;
  assign wdfFull$sEN = 1'b0 ;
  ...
  // remaining internal signals
  assign IF_wci_wslv_reqF_first__5_BIT_51_13_THEN_lreqF_ETC___d389 =
	     wci_wslv_reqF$D_OUT[51] ?
	       lreqF$sFULL_N && splaF$FULL_N :
	       wci_wslv_respF_c_r != 2'd2 ;
  assign IF_wci_wslv_reqF_first__5_BIT_51_13_THEN_pReg__ETC___d364 =
	     wci_wslv_reqF$D_OUT[51] ?
	       { x1_addr__h13778, x1_be__h13779, x1_data__h13780 } :
	       { wci_wslv_reqF$D_OUT[31:0], mReg, x1_data__h12779 } ;
  assign NOT_wci_wslv_respF_c_r_2_EQ_2_1_2_AND_IF_wci_w_ETC___d325 =
	     wci_wslv_respF_c_r != 2'd2 &&
	     (wci_wslv_reqF$D_OUT[51] ?
		lreqF$sFULL_N :
		((wci_wslv_reqF$D_OUT[39:32] == 8'h54) ?
  ...
  assign dramStatus__h10180 = { 16'd0, x__h15336 } ;
  assign g_data__h15296 =
	     wci_wslv_reqF$D_OUT[51] ?
	       32'd0 :
	       CASE_wci_wslv_reqFD_OUT_BITS_39_TO_32_0_0x0_d_ETC__q1 ;
  assign lrespF_RDY_first__76_AND_NOT_splitReadInFlight_ETC___d292 =
	     lrespF$dEMPTY_N &&
	     (!splitReadInFlight ||
	      wci_wslv_respF_c_r != 2'd2 && splaF$EMPTY_N) ;
  assign lrespF_RDY_first__76_AND_NOT_wmemi_respF_c_r_6_ETC___d278 =
	     lrespF$dEMPTY_N && wmemi_respF_c_r != 2'd2 && wmemi_operateD &&
	     wmemi_peerIsReady ;
  assign rdat___1__h15359 = { 16'd0, requestCount$dD_OUT } ;
  assign rdat___1__h15368 = { 16'd0, pReg } ;
  assign rdat___1__h15376 = { 16'd0, mReg } ;
  assign wmemi_operateD_97_AND_wmemi_peerIsReady_98_99__ETC___d254 =
	     wmemi_operateD && wmemi_peerIsReady && wmemi_reqF$EMPTY_N &&
	     (wmemi_reqF$D_OUT[51:49] != 3'd1 || wmemi_dhF$EMPTY_N) ;
  assign x1_addr__h13778 = { pReg[12:0], wci_wslv_reqF$D_OUT[50:36], 4'd0 } ;
  assign x1_be__h13779 =
  ...
  assign x1_data__h12779 = { wdReg_3, wdReg_2, wdReg_1, wdReg } ;
  assign x1_data__h13780 = {4{wci_wslv_reqF$D_OUT[31:0]}} ;
  assign x__h15336 =
	     { respCount,
	       2'h0,
	       memIsResetCC$dD_OUT,
  ...
  begin
    case (splaF$D_OUT)
      2'd0: g_data__h11538 = lrespF$dD_OUT[31:0];
      2'd1: g_data__h11538 = lrespF$dD_OUT[63:32];
      2'd2: g_data__h11538 = lrespF$dD_OUT[95:64];
      2'd3: g_data__h11538 = lrespF$dD_OUT[127:96];
    endcase
  end
  always@(wci_wslv_reqF$D_OUT or
	  dramStatus__h10180 or
	  dramCtrl or
	  rdat___1__h15359 or
	  rdat___1__h15368 or
	  rdat___1__h15376 or
  ...
  begin
	...
	$display("Error: \"bsv/wrk/DramServer_s4.bsv\", line 125, column 28: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_cfwr] and\n  [RL_advance_response] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n)
	...
	$display("Error: \"bsv/wrk/DramServer_s4.bsv\", line 125, column 38: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_cfrd] and\n  [RL_advance_response] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n)
	...
	$display("Error: \"bsv/wrk/DramServer_s4.bsv\", line 125, column 62: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_ctrl_IsO] and\n  [RL_wci_ctrl_OrE] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wci_ctrl_EiI && WILL_FIRE_RL_wci_ctrl_OrE)
	$display("Error: \"bsv/wrk/DramServer_s4.bsv\", line 125, column 48: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_ctrl_EiI] and\n  [RL_wci_ctrl_OrE] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n)
