...
//
// On Thu Oct  6 15:45:00 EDT 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkDramServer_s4(CLK_sys0_clk,
  ...
  reg [63 : 0] v__h17565, v__h6404, v__h6578, v__h6722;
  ...
  wire [127 : 0] x1_data__h14717, x1_data__h15718;
  wire [31 : 0] dramStatus__h12118,
		g_data__h17234,
		rdat___1__h17324,
		rdat___1__h17337,
		rdat___1__h17345,
		x1_addr__h15716;
  wire [15 : 0] x1_be__h15717, x__h17274;
  wire [2 : 0] activeBits__h1947;
  wire IF_wci_wslv_reqF_first__07_BIT_51_72_THEN_lreq_ETC___d448,
       NOT_wci_wslv_respF_c_r_4_EQ_2_3_4_AND_IF_wci_w_ETC___d384,
  ...
  assign MUX_wci_wslv_respF_q_1$write_1__VAL_2 =
	     (wci_wslv_respF_c_r == 2'd2) ?
	       MUX_wci_wslv_respF_q_0$write_1__VAL_1 :
	       34'h0AAAAAAAA ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_1 = { 2'd1, g_data__h13476 } ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_2 = { 2'd1, g_data__h17234 } ;
  ...
  assign IF_wci_wslv_reqF_first__07_BIT_51_72_THEN_pReg_ETC___d423 =
	     wci_wslv_reqF$D_OUT[51] ?
	       { x1_addr__h15716, x1_be__h15717, x1_data__h15718 } :
	       { wci_wslv_reqF$D_OUT[31:0], mReg, x1_data__h14717 } ;
  assign NOT_wci_wslv_respF_c_r_4_EQ_2_3_4_AND_IF_wci_w_ETC___d384 =
	     wci_wslv_respF_c_r != 2'd2 &&
	     (wci_wslv_reqF$D_OUT[51] ?
		lreqF$sFULL_N :
		((wci_wslv_reqF$D_OUT[39:32] == 8'h54) ?
  ...
  assign activeBits__h1947 =
	     { memc_curCount[3],
	       memc_sysActive$dD_OUT,
	       memc_afiActive$dD_OUT } ;
  assign dramStatus__h12118 = { 16'd0, x__h17274 } ;
  assign g_data__h17234 =
	     wci_wslv_reqF$D_OUT[51] ?
	       32'd0 :
  ...
  assign lrespF_RDY_first__35_AND_NOT_wmemi_respF_c_r_1_ETC___d337 =
	     ...
	     wmemi_peerIsReady ;
  assign rdat___1__h17324 = { 16'd0, requestCount$dD_OUT } ;
  assign rdat___1__h17337 = { 16'd0, pReg } ;
  assign rdat___1__h17345 = { 16'd0, mReg } ;
  ...
  assign x1_addr__h15716 = { pReg[12:0], wci_wslv_reqF$D_OUT[50:36], 4'd0 } ;
  assign x1_be__h15717 =
  ...
  assign x1_data__h14717 = { wdReg_3, wdReg_2, wdReg_1, wdReg } ;
  assign x1_data__h15718 = {4{wci_wslv_reqF$D_OUT[31:0]}} ;
  assign x__h17274 =
	     { respCount,
	       1'h0,
	       activeBits__h1947,
  ...
  begin
    case (splaF$D_OUT)
      2'd0: g_data__h13476 = lrespF$dD_OUT[31:0];
      2'd1: g_data__h13476 = lrespF$dD_OUT[63:32];
      2'd2: g_data__h13476 = lrespF$dD_OUT[95:64];
      2'd3: g_data__h13476 = lrespF$dD_OUT[127:96];
    endcase
  end
  always@(wci_wslv_reqF$D_OUT or
	  dramStatus__h12118 or
	  dramCtrl or
	  rdat___1__h17324 or
	  rdat___1__h17337 or
	  rdat___1__h17345 or
