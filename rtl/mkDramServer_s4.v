...
//
// On Mon Sep 19 09:12:15 EDT 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkDramServer_s4(CLK_sys0_clk,
  ...
  reg [63 : 0] v__h15994, v__h4844, v__h5018, v__h5162;
  ...
  wire [127 : 0] x1_data__h13146, x1_data__h14147;
  wire [31 : 0] dramStatus__h10547,
		g_data__h15663,
		rdat___1__h15753,
		rdat___1__h15766,
		rdat___1__h15774,
		x1_addr__h14145;
  wire [15 : 0] x1_be__h14146, x__h15703;
  wire [2 : 0] activeBits__h1182;
  wire IF_wci_wslv_reqF_first__8_BIT_51_22_THEN_lreqF_ETC___d398,
       ...
       wci_wslv_reqF_i_notEmpty__7_AND_IF_wci_wslv_re_ETC___d334,
  ...
  assign MUX_wci_wslv_respF_q_1$write_1__VAL_1 =
	     (wci_wslv_respF_c_r == 2'd2) ?
	       MUX_wci_wslv_respF_q_0$write_1__VAL_2 :
	       34'h0AAAAAAAA ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_1 = { 2'd1, g_data__h11905 } ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_2 = { 2'd1, g_data__h15663 } ;
  ...
  assign IF_wci_wslv_reqF_first__8_BIT_51_22_THEN_pReg__ETC___d373 =
	     wci_wslv_reqF$D_OUT[51] ?
	       { x1_addr__h14145, x1_be__h14146, x1_data__h14147 } :
	       { wci_wslv_reqF$D_OUT[31:0], mReg, x1_data__h13146 } ;
  assign activeBits__h1182 =
	     { memc_curCount[3],
	       memc_sysActive$dD_OUT,
	       memc_afiActive$dD_OUT } ;
  assign dramStatus__h10547 = { 16'd0, x__h15703 } ;
  assign g_data__h15663 =
	     wci_wslv_reqF$D_OUT[51] ?
	       32'd0 :
  ...
  assign lrespF_RDY_first__85_AND_NOT_wmemi_respF_c_r_7_ETC___d287 =
	     ...
	     wmemi_peerIsReady ;
  assign rdat___1__h15753 = { 16'd0, requestCount$dD_OUT } ;
  assign rdat___1__h15766 = { 16'd0, pReg } ;
  assign rdat___1__h15774 = { 16'd0, mReg } ;
  assign wci_wslv_reqF_i_notEmpty__7_AND_IF_wci_wslv_re_ETC___d334 =
	     wci_wslv_reqF$EMPTY_N &&
	     (wci_wslv_reqF$D_OUT[51] ?
		lreqF$sFULL_N :
		((wci_wslv_reqF$D_OUT[39:32] == 8'h54) ?
  ...
  assign x1_addr__h14145 = { pReg[12:0], wci_wslv_reqF$D_OUT[50:36], 4'd0 } ;
  assign x1_be__h14146 =
  ...
  assign x1_data__h13146 = { wdReg_3, wdReg_2, wdReg_1, wdReg } ;
  assign x1_data__h14147 = {4{wci_wslv_reqF$D_OUT[31:0]}} ;
  assign x__h15703 =
	     { respCount,
	       1'h0,
	       activeBits__h1182,
  ...
  begin
    case (splaF$D_OUT)
      2'd0: g_data__h11905 = lrespF$dD_OUT[31:0];
      2'd1: g_data__h11905 = lrespF$dD_OUT[63:32];
      2'd2: g_data__h11905 = lrespF$dD_OUT[95:64];
      2'd3: g_data__h11905 = lrespF$dD_OUT[127:96];
    endcase
  end
  always@(wci_wslv_reqF$D_OUT or
	  dramStatus__h10547 or
	  dramCtrl or
	  rdat___1__h15753 or
	  rdat___1__h15766 or
	  rdat___1__h15774 or
