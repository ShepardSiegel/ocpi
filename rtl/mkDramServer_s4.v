...
//
// On Tue Jan  1 09:12:28 EST 2013
//
//
// Ports:
// Name                         I/O  size props
...
module mkDramServer_s4(CLK_sys0_clk,
  ...
  reg [15 : 0] memc_dbg_reqCount;
  wire [15 : 0] memc_dbg_reqCount$D_IN;
  wire memc_dbg_reqCount$EN;

  // register memc_dbg_respCount
  reg [15 : 0] memc_dbg_respCount;
  wire [15 : 0] memc_dbg_respCount$D_IN;
  wire memc_dbg_respCount$EN;

  // register memc_rdStageLS
  reg [63 : 0] memc_rdStageLS;
  wire [63 : 0] memc_rdStageLS$D_IN;
  wire memc_rdStageLS$EN;

  // register memc_secondRdBeat
  reg memc_secondRdBeat;
  wire memc_secondRdBeat$D_IN, memc_secondRdBeat$EN;

  // register memc_secondWrBeat
  reg memc_secondWrBeat;
  wire memc_secondWrBeat$D_IN, memc_secondWrBeat$EN;
  ...
  wire memc_memc$afi_clk,
       memc_memc$afi_reset_n,
       memc_memc$avl_burstbegin,
       memc_memc$avl_rdata_valid,
  ...
  wire WILL_FIRE_RL_advance_response,
       ...
       WILL_FIRE_RL_memc_advance_readResponse,
  ...
  reg [63 : 0] v__h18076, v__h6589, v__h6764, v__h6908;
  reg [31 : 0] IF_wci_wslv_reqF_first__09_BITS_39_TO_32_84_EQ_ETC___d512,
	       g_data__h13952;
  wire [175 : 0] IF_wci_wslv_reqF_first__09_BIT_51_83_THEN_pReg_ETC___d434;
  wire [127 : 0] x1_data__h15200, x1_data__h16201;
  wire [31 : 0] dramStatus__h12575,
		g_data__h17725,
		rdat___1__h17815,
		rdat___1__h17826,
		rdat___1__h17832,
		...
		rdat___1__h17953,
		x1_addr__h16199;
  wire [15 : 0] x1_be__h16200, x__h17765;
  wire [2 : 0] activeBits__h2005;
  wire IF_wci_wslv_reqF_first__09_BIT_51_83_THEN_lreq_ETC___d459,
       IF_wmemi_reqF_first__11_BITS_51_TO_49_12_EQ_1__ETC___d320,
       lrespF_RDY_first__46_AND_NOT_splitReadInFlight_ETC___d362,
       lrespF_RDY_first__46_AND_NOT_wmemi_respF_c_r_2_ETC___d348,
       wci_wslv_reqF_i_notEmpty__08_AND_IF_wci_wslv_r_ETC___d395,
       wmemiReadInFlight_value_85_SLT_16___d591;
  ...
  // submodule calFail
  SyncBit #(.init(1'd0)) calFail(.sCLK(memc_memc$afi_clk),
				 .dCLK(wciS0_Clk),
				 .sRST(memc_memc$afi_reset_n),
				 .sD_IN(calFail$sD_IN),
				 .sEN(calFail$sEN),
				 .dD_OUT(calFail$dD_OUT));

  // submodule calSuccess
  SyncBit #(.init(1'd0)) calSuccess(.sCLK(memc_memc$afi_clk),
				    .dCLK(wciS0_Clk),
				    .sRST(memc_memc$afi_reset_n),
  ...
  // submodule initDone
  SyncBit #(.init(1'd0)) initDone(.sCLK(memc_memc$afi_clk),
				  .dCLK(wciS0_Clk),
				  .sRST(memc_memc$afi_reset_n),
  ...
  SyncFIFO #(.dataWidth(32'd128),
	     .depth(32'd2),
	     .indxWidth(32'd1)) lrespF(.sCLK(memc_memc$afi_clk),
				       .dCLK(wciS0_Clk),
				       .sRST(memc_memc$afi_reset_n),
				       .sD_IN(lrespF$sD_IN),
				       .sENQ(lrespF$sENQ),
  ...
  SyncBit #(.init(1'd0)) memIsResetCC(.sCLK(memc_memc$afi_clk),
				      .dCLK(wciS0_Clk),
				      .sRST(memc_memc$afi_reset_n),
  ...
  SyncBit #(.init(1'd0)) memc_afiActive(.sCLK(memc_memc$afi_clk),
					.dCLK(wciS0_Clk),
					.sRST(memc_memc$afi_reset_n),
  ...
  SyncResetA #(.RSTDELAY(32'd3)) memc_drstn(.CLK(CLK_sys0_clk),
					    ...
					    .OUT_RST(memc_drstn$OUT_RST));

  // submodule memc_memc
  ddr3_s4_uniphy memc_memc(.pll_ref_clk(CLK_sys0_clk),
			   .global_reset_n(memc_drstn$OUT_RST),
			   ...
			   .avl_ready(memc_memc$avl_ready),
			   .avl_rdata_valid(memc_memc$avl_rdata_valid),
			   .avl_rdata(memc_memc$avl_rdata),
			   .afi_clk(memc_memc$afi_clk),
  ...
  // submodule memc_reqF
  FIFO2 #(.width(32'd177),
	  .guarded(32'd1)) memc_reqF(.RST(memc_memc$afi_reset_n),
				     .CLK(memc_memc$afi_clk),
				     .D_IN(memc_reqF$D_IN),
				     .ENQ(memc_reqF$ENQ),
				     .DEQ(memc_reqF$DEQ),
				     .CLR(memc_reqF$CLR),
  ...
  arSRLFIFOD #(.width(32'd128),
	       .l2depth(32'd4)) memc_respF(.CLK(memc_memc$afi_clk),
					   .RST_N(memc_memc$afi_reset_n),
  ...
  SyncRegister #(.width(32'd16),
		 .init(16'd0)) requestCount(.sCLK(memc_memc$afi_clk),
					    .dCLK(wciS0_Clk),
					    .sRST(memc_memc$afi_reset_n),
  ...
  SyncRegister #(.width(32'd16),
		 .init(16'd0)) responseCount(.sCLK(memc_memc$afi_clk),
					     .dCLK(wciS0_Clk),
					     .sRST(memc_memc$afi_reset_n),
  ...
  // submodule splaF
  FIFO2 #(.width(32'd2), .guarded(32'd1)) splaF(.RST(wciS0_MReset_n),
						.CLK(wciS0_Clk),
						.D_IN(splaF$D_IN),
						.ENQ(splaF$ENQ),
						.DEQ(splaF$DEQ),
  ...
  assign WILL_FIRE_RL_memc_advance_request =
	     memc_reqF$EMPTY_N && memc_memc$local_init_done &&
	     memc_memc$local_cal_success &&
	     !memc_secondWrBeat &&
	     !memc_secondRdBeat &&
	     memc_memc$avl_ready ;
  ...
  // rule RL_memc_advance_readResponse
  assign WILL_FIRE_RL_memc_advance_readResponse =
	     (!memc_secondRdBeat || memc_respF$FULL_N) &&
	     memc_memc$local_init_done &&
	     memc_memc$local_cal_success &&
	     memc_memc$avl_rdata_valid ;
  ...
  assign WILL_FIRE_RL_wci_cfrd =
	     wci_wslv_reqF$EMPTY_N &&
	     IF_wci_wslv_reqF_first__09_BIT_51_83_THEN_lreq_ETC___d459 &&
	     wci_wslv_wci_cfrd_pw$whas &&
	     !WILL_FIRE_RL_wci_wslv_ctl_op_start &&
	     !WILL_FIRE_RL_wci_wslv_ctl_op_complete ;
  ...
  assign MUX_memc_avlBE$wset_1__SEL_1 =
  ...
  assign MUX_lreqF$enq_1__VAL_2 =
	     { !wci_wslv_reqF$D_OUT[51] &&
	       wci_wslv_reqF$D_OUT[39:32] != 8'h54,
	       IF_wci_wslv_reqF_first__09_BIT_51_83_THEN_pReg_ETC___d434 } ;
  ...
  assign MUX_wci_wslv_respF_q_1$write_1__VAL_1 =
	     (wci_wslv_respF_c_r == 2'd2) ?
	       MUX_wci_wslv_respF_q_0$write_1__VAL_2 :
	       34'h0AAAAAAAA ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_1 = { 2'd1, g_data__h13952 } ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_2 = { 2'd1, g_data__h17725 } ;
  ...
  // inlined wires
  assign memc_avlBurstBegin$wget = 1'd1 ;
  assign memc_avlBurstBegin$whas = WILL_FIRE_RL_memc_advance_request ;
  assign memc_avlAddr$wget = memc_reqF$D_OUT[170:147] ;
  assign memc_avlAddr$whas =
	     WILL_FIRE_RL_memc_advance_write1 ||
	     WILL_FIRE_RL_memc_advance_request ;
  assign memc_avlWData$wget =
	     MUX_memc_avlBE$wset_1__SEL_1 ?
	       memc_reqF$D_OUT[63:0] :
	       memc_reqF$D_OUT[127:64] ;
  assign memc_avlWData$whas =
	     WILL_FIRE_RL_memc_advance_request && !memc_reqF$D_OUT[176] ||
	     WILL_FIRE_RL_memc_advance_write1 ;
  assign memc_avlBE$wget =
	     MUX_memc_avlBE$wset_1__SEL_1 ?
	       memc_reqF$D_OUT[135:128] :
	       memc_reqF$D_OUT[143:136] ;
  assign memc_avlBE$whas = memc_avlWData$whas ;
  assign memc_avlReadReq$wget = 1'd1 ;
  assign memc_avlReadReq$whas =
	     WILL_FIRE_RL_memc_advance_request && memc_reqF$D_OUT[176] ;
  assign memc_avlWriteReq$wget = 1'd1 ;
  assign memc_avlWriteReq$whas = memc_avlWData$whas ;
  assign memc_avlSize$wget = 3'd2 ;
  assign memc_avlSize$whas = memc_avlAddr$whas ;
  ...
  // register memc_dbg_reqCount
  assign memc_dbg_reqCount$D_IN = memc_dbg_reqCount + 16'd1 ;
  assign memc_dbg_reqCount$EN = WILL_FIRE_RL_memc_advance_request ;

  // register memc_dbg_respCount
  assign memc_dbg_respCount$D_IN = memc_dbg_respCount + 16'd1 ;
  assign memc_dbg_respCount$EN =
	     WILL_FIRE_RL_memc_advance_readResponse && memc_secondRdBeat ;

  // register memc_rdStageLS
  assign memc_rdStageLS$D_IN = memc_memc$avl_rdata ;
  assign memc_rdStageLS$EN =
	     WILL_FIRE_RL_memc_advance_readResponse && !memc_secondRdBeat ;

  // register memc_secondRdBeat
  assign memc_secondRdBeat$D_IN = !memc_secondRdBeat ;
  assign memc_secondRdBeat$EN = WILL_FIRE_RL_memc_advance_readResponse ;

  // register memc_secondWrBeat
  assign memc_secondWrBeat$D_IN = MUX_memc_avlBE$wset_1__SEL_1 ;
  assign memc_secondWrBeat$EN = memc_avlWData$whas ;
  ...
  // submodule memc_memc
  assign memc_memc$avl_addr =
	     memc_avlAddr$whas ? memc_reqF$D_OUT[170:147] : 24'd0 ;
  assign memc_memc$avl_be = memc_avlWData$whas ? memc_avlBE$wget : 8'd0 ;
  assign memc_memc$avl_burstbegin = WILL_FIRE_RL_memc_advance_request ;
  assign memc_memc$avl_read_req = memc_avlReadReq$whas ;
  assign memc_memc$avl_size = memc_avlAddr$whas ? 3'd2 : 3'd0 ;
  assign memc_memc$avl_wdata =
	     memc_avlWData$whas ? memc_avlWData$wget : 64'd0 ;
  assign memc_memc$avl_write_req = memc_avlWData$whas ;
  ...
  // submodule memc_respF
  assign memc_respF$D_IN = { memc_memc$avl_rdata, memc_rdStageLS } ;
  ...
  // submodule requestCount
  assign requestCount$sD_IN = memc_dbg_reqCount ;
  assign requestCount$sEN = requestCount$sRDY && responseCount$sRDY ;

  // submodule responseCount
  assign responseCount$sD_IN = memc_dbg_respCount ;
  assign responseCount$sEN = requestCount$sRDY && responseCount$sRDY ;
  ...
  // remaining internal signals
  assign IF_wci_wslv_reqF_first__09_BIT_51_83_THEN_lreq_ETC___d459 =
	     wci_wslv_reqF$D_OUT[51] ?
	       lreqF$sFULL_N && splaF$FULL_N :
	       wci_wslv_respF_c_r != 2'd2 ;
  assign IF_wci_wslv_reqF_first__09_BIT_51_83_THEN_pReg_ETC___d434 =
	     wci_wslv_reqF$D_OUT[51] ?
	       { x1_addr__h16199, x1_be__h16200, x1_data__h16201 } :
	       { wci_wslv_reqF$D_OUT[31:0], mReg, x1_data__h15200 } ;
  assign IF_wmemi_reqF_first__11_BITS_51_TO_49_12_EQ_1__ETC___d320 =
	     (wmemi_reqF$D_OUT[51:49] == 3'd1) ?
	       lreqF$sFULL_N && wmemi_dhF$EMPTY_N :
	       !wmemiReadInFlight_value_85_SLT_16___d591 || lreqF$sFULL_N ;
  assign activeBits__h2005 =
	     { memc_curCount[3],
	       memc_sysActive$dD_OUT,
	       memc_afiActive$dD_OUT } ;
  assign dramStatus__h12575 = { 16'd0, x__h17765 } ;
  assign g_data__h17725 =
	     wci_wslv_reqF$D_OUT[51] ?
	       32'd0 :
	       IF_wci_wslv_reqF_first__09_BITS_39_TO_32_84_EQ_ETC___d512 ;
  assign lrespF_RDY_first__46_AND_NOT_splitReadInFlight_ETC___d362 =
	     lrespF$dEMPTY_N &&
	     (!splitReadInFlight ||
	      wci_wslv_respF_c_r != 2'd2 && splaF$EMPTY_N) ;
  assign lrespF_RDY_first__46_AND_NOT_wmemi_respF_c_r_2_ETC___d348 =
	     lrespF$dEMPTY_N && wmemi_respF_c_r != 2'd2 && wmemi_operateD &&
	     wmemi_peerIsReady ;
  assign rdat___1__h17815 =
	     hasDebugLogic ? { 16'd0, requestCount$dD_OUT } : 32'd0 ;
  assign rdat___1__h17826 = hasDebugLogic ? 32'hC0DE4002 : 32'd0 ;
  assign rdat___1__h17832 = hasDebugLogic ? { 16'd0, pReg } : 32'd0 ;
  assign rdat___1__h17842 = hasDebugLogic ? { 16'd0, mReg } : 32'd0 ;
  assign rdat___1__h17852 = hasDebugLogic ? wdReg : 32'd0 ;
  assign rdat___1__h17866 = hasDebugLogic ? wdReg_1 : 32'd0 ;
  assign rdat___1__h17880 = hasDebugLogic ? wdReg_2 : 32'd0 ;
  assign rdat___1__h17894 = hasDebugLogic ? wdReg_3 : 32'd0 ;
  assign rdat___1__h17908 = hasDebugLogic ? rdReg : 32'd0 ;
  assign rdat___1__h17923 = hasDebugLogic ? rdReg_1 : 32'd0 ;
  assign rdat___1__h17938 = hasDebugLogic ? rdReg_2 : 32'd0 ;
  assign rdat___1__h17953 = hasDebugLogic ? rdReg_3 : 32'd0 ;
  assign wci_wslv_reqF_i_notEmpty__08_AND_IF_wci_wslv_r_ETC___d395 =
	     wci_wslv_reqF$EMPTY_N &&
	     (wci_wslv_reqF$D_OUT[51] ?
		lreqF$sFULL_N :
		((wci_wslv_reqF$D_OUT[39:32] == 8'h54) ?
  ...
  assign wmemiReadInFlight_value_85_SLT_16___d591 =
	     (wmemiReadInFlight_value ^ 8'h80) < 8'd144 ;
  assign x1_addr__h16199 = { pReg[12:0], wci_wslv_reqF$D_OUT[50:36], 4'd0 } ;
  assign x1_be__h16200 =
  ...
  assign x1_data__h15200 = { wdReg_3, wdReg_2, wdReg_1, wdReg } ;
  assign x1_data__h16201 = {4{wci_wslv_reqF$D_OUT[31:0]}} ;
  assign x__h17765 =
	     { respCount,
	       1'h0,
	       activeBits__h2005,
  ...
  begin
    case (splaF$D_OUT)
      2'd0: g_data__h13952 = lrespF$dD_OUT[31:0];
      2'd1: g_data__h13952 = lrespF$dD_OUT[63:32];
      2'd2: g_data__h13952 = lrespF$dD_OUT[95:64];
      2'd3: g_data__h13952 = lrespF$dD_OUT[127:96];
    endcase
  end
  always@(wci_wslv_reqF$D_OUT or
	  dramStatus__h12575 or
	  dramCtrl or
	  rdat___1__h17815 or
	  rdat___1__h17826 or
	  rdat___1__h17832 or
	  ...
	  rdat___1__h17894 or
	  rdat___1__h17908 or
	  rdat___1__h17923 or rdat___1__h17938 or rdat___1__h17953)
  begin
    case (wci_wslv_reqF$D_OUT[39:32])
	  ...
	  IF_wci_wslv_reqF_first__09_BITS_39_TO_32_84_EQ_ETC___d512 =
	      rdat___1__h17953;
      default: IF_wci_wslv_reqF_first__09_BITS_39_TO_32_84_EQ_ETC___d512 =
		   32'd0;
    endcase
  end
  ...
  begin
    if (RST_N_sys0_rstn == `BSV_RESET_VALUE)
      begin
  ...
  always@(posedge memc_memc$afi_clk)
  begin
    if (memc_memc$afi_reset_n == `BSV_RESET_VALUE)
      begin
        dbgCtrl <= `BSV_ASSIGNMENT_DELAY 32'd0;
	memc_afiCount <= `BSV_ASSIGNMENT_DELAY 4'd0;
	memc_dbg_reqCount <= `BSV_ASSIGNMENT_DELAY 16'd0;
	memc_dbg_respCount <= `BSV_ASSIGNMENT_DELAY 16'd0;
	memc_secondRdBeat <= `BSV_ASSIGNMENT_DELAY 1'd0;
	memc_secondWrBeat <= `BSV_ASSIGNMENT_DELAY 1'd0;
      end
    else
      begin
	...
	if (memc_dbg_respCount$EN)
	  memc_dbg_respCount <= `BSV_ASSIGNMENT_DELAY memc_dbg_respCount$D_IN;
	if (memc_secondRdBeat$EN)
	  memc_secondRdBeat <= `BSV_ASSIGNMENT_DELAY memc_secondRdBeat$D_IN;
	if (memc_secondWrBeat$EN)
	  memc_secondWrBeat <= `BSV_ASSIGNMENT_DELAY memc_secondWrBeat$D_IN;
      end
    if (memc_rdStageLS$EN)
      memc_rdStageLS <= `BSV_ASSIGNMENT_DELAY memc_rdStageLS$D_IN;
  end
  ...
  always@(posedge memc_memc$afi_clk or `BSV_RESET_EDGE memc_memc$afi_reset_n)
  if (memc_memc$afi_reset_n == `BSV_RESET_VALUE)
    begin
  ...
  begin
    ...
    memc_afiCount = 4'hA;
    memc_curCount = 4'hA;
    memc_dbg_reqCount = 16'hAAAA;
    memc_dbg_respCount = 16'hAAAA;
    memc_rdStageLS = 64'hAAAAAAAAAAAAAAAA;
    memc_secondRdBeat = 1'h0;
    memc_secondWrBeat = 1'h0;
    memc_sysCount = 4'hA;
    pReg = 16'hAAAA;
    rdReg = 32'hAAAAAAAA;
  ...
  begin
	...
	$display("Error: \"bsv/wrk/DramServer_s4.bsv\", line 129, column 28: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_cfwr] and\n  [RL_advance_response] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n != `BSV_RESET_VALUE)
	...
	$display("Error: \"bsv/wrk/DramServer_s4.bsv\", line 129, column 38: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_cfrd] and\n  [RL_advance_response] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n != `BSV_RESET_VALUE)
	...
	$display("Error: \"bsv/wrk/DramServer_s4.bsv\", line 129, column 62: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_ctrl_IsO] and\n  [RL_wci_ctrl_OrE] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_wci_ctrl_EiI && WILL_FIRE_RL_wci_ctrl_OrE)
	$display("Error: \"bsv/wrk/DramServer_s4.bsv\", line 129, column 48: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_ctrl_EiI] and\n  [RL_wci_ctrl_OrE] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n != `BSV_RESET_VALUE)
