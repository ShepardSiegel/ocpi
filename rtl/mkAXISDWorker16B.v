...
//
// On Thu Feb 10 09:44:40 EST 2011
//
//
// Ports:
// Name                         I/O  size props
...
// wsiM0_MReqInfo                 O     8
// wsiM0_MReset_n                 O     1
// axiM0_TVALID                   O     1 const
// axiM0_TDATA                    O   128 const
// axiM0_TSTRB                    O    16 const
// axiM0_TUSER                    O    32 const
// axiM0_TLAST                    O     1 const
// axiS0_TREADY                   O     1 const
// wciS0_Clk                      I     1 clock
...
// wsiS0_MByteEn                  I    16
// wsiS0_MReqInfo                 I     8
// axiS0_TDATA                    I   128 unused
// axiS0_TSTRB                    I    16 unused
// axiS0_TUSER                    I    32 unused
// wsiS0_MReqLast                 I     1
// wsiS0_MBurstPrecise            I     1
// wsiS0_MReset_n                 I     1 reg
// wsiM0_SThreadBusy              I     1 reg
// wsiM0_SReset_n                 I     1 reg
// axiM0_TREADY                   I     1 unused
// axiS0_TVALID                   I     1 unused
// axiS0_TLAST                    I     1 unused
//
...
module mkAXISDWorker16B(wciS0_Clk,
			wciS0_MReset_n,
  ...
  output [127 : 0] axiM0_TDATA;

  // value method axiM0_mTSTRB
  output [15 : 0] axiM0_TSTRB;
  ...
  input  [127 : 0] axiS0_TDATA;

  // action method axiS0_mTSTRB
  input  [15 : 0] axiS0_TSTRB;
  ...
  wire [127 : 0] axiM0_TDATA, wsiM0_MData;
  wire [31 : 0] axiM0_TUSER, wciS0_SData;
  wire [15 : 0] axiM0_TSTRB, wsiM0_MByteEn;
  ...
  // register mesgPushCount
  reg [31 : 0] mesgPushCount;
  wire [31 : 0] mesgPushCount$D_IN;
  wire mesgPushCount$EN;
  ...
  // ports of submodule axiM
  wire [31 : 0] axiM$wsi_MData;
  wire [11 : 0] axiM$wsi_MBurstLength;
  wire [7 : 0] axiM$wsi_MReqInfo;
  wire [3 : 0] axiM$wsi_MByteEn;
  wire [2 : 0] axiM$wsi_MCmd;
  wire axiM$EN_operate,
       axiM$axi_TREADY,
       axiM$wsi_MBurstPrecise,
       axiM$wsi_MReqLast,
       axiM$wsi_MReset_n;

  // ports of submodule axiS
  wire [31 : 0] axiS$axi_TDATA, axiS$axi_TUSER;
  wire [3 : 0] axiS$axi_TSTRB;
  wire axiS$EN_operate,
       axiS$axi_TLAST,
       axiS$axi_TVALID,
       axiS$wsi_SReset_n,
       axiS$wsi_SThreadBusy;
  ...
  wire [168 : 0] MUX_wsiM_reqFifo_q_0$write_1__VAL_2,
  ...
  reg [63 : 0] v__h10574, v__h10727, v__h3565, v__h3739, v__h3883;
  reg [31 : 0] _theResult____h10711;
  wire [31 : 0] rdat__h10802,
		rdat__h10902,
		rdat__h10916,
		rdat__h10924,
		rdat__h10930,
  ...
  // value method axiM0_mTDATA
  assign axiM0_TDATA = 128'hAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA ;

  // value method axiM0_mTSTRB
  assign axiM0_TSTRB = 16'hAAAA ;

  // value method axiM0_mTUSER
  assign axiM0_TUSER = 32'hAAAAAAAA ;

  // value method axiM0_mTLAST
  assign axiM0_TLAST = 1'h0 ;
  ...
  // submodule axiM
  mkWSItoAXIS4B axiM(.CLK(wciS0_Clk),
		     .RST_N(wciS0_MReset_n),
		     .wsi_MBurstLength(axiM$wsi_MBurstLength),
		     .wsi_MByteEn(axiM$wsi_MByteEn),
		     .wsi_MCmd(axiM$wsi_MCmd),
		     .wsi_MData(axiM$wsi_MData),
		     .wsi_MReqInfo(axiM$wsi_MReqInfo),
		     .wsi_MReqLast(axiM$wsi_MReqLast),
		     .wsi_MBurstPrecise(axiM$wsi_MBurstPrecise),
		     .wsi_MReset_n(axiM$wsi_MReset_n),
		     .axi_TREADY(axiM$axi_TREADY),
		     .EN_operate(axiM$EN_operate),
		     .wsi_SThreadBusy(),
		     .wsi_SReset_n(),
		     .axi_TVALID(),
		     .axi_TDATA(),
  ...
  // submodule axiS
  mkAXIStoWSI4B axiS(.CLK(wciS0_Clk),
		     .RST_N(wciS0_MReset_n),
		     .axi_TDATA(axiS$axi_TDATA),
		     .axi_TSTRB(axiS$axi_TSTRB),
		     .axi_TUSER(axiS$axi_TUSER),
		     .axi_TVALID(axiS$axi_TVALID),
		     .axi_TLAST(axiS$axi_TLAST),
		     .wsi_SThreadBusy(axiS$wsi_SThreadBusy),
		     .wsi_SReset_n(axiS$wsi_SReset_n),
		     .EN_operate(axiS$EN_operate),
		     .axi_TREADY(),
		     .wsi_MCmd(),
		     .wsi_MReqLast(),
		     .wsi_MBurstPrecise(),
  ...
  assign wsiS_reqFifo_doResetEnq$whas =
	     MUX_wsiS_reqFifo_levelsValid$write_1__SEL_3 ;
  assign wsiS_reqFifo_doResetDeq$whas = CAN_FIRE_RL_doMessagePush ;
  ...
  // register mesgPushCount
  assign mesgPushCount$D_IN = mesgPushCount + 32'd1 ;
  assign mesgPushCount$EN = CAN_FIRE_RL_doMessagePush ;
  ...
  // submodule axiM
  assign axiM$wsi_MBurstLength = 12'h0 ;
  assign axiM$wsi_MByteEn = 4'h0 ;
  assign axiM$wsi_MCmd = 3'h0 ;
  assign axiM$wsi_MData = 32'h0 ;
  assign axiM$wsi_MReqInfo = 8'h0 ;
  assign axiM$wsi_MReqLast = 1'b0 ;
  assign axiM$wsi_MBurstPrecise = 1'b0 ;
  assign axiM$wsi_MReset_n = 1'b0 ;
  assign axiM$axi_TREADY = 1'b0 ;
  assign axiM$EN_operate = CAN_FIRE_RL_operating_actions ;

  // submodule axiS
  assign axiS$axi_TDATA = 32'h0 ;
  assign axiS$axi_TSTRB = 4'h0 ;
  assign axiS$axi_TUSER = 32'h0 ;
  assign axiS$axi_TVALID = 1'b0 ;
  assign axiS$axi_TLAST = 1'b0 ;
  assign axiS$wsi_SThreadBusy = 1'b0 ;
  assign axiS$wsi_SReset_n = 1'b0 ;
  assign axiS$EN_operate = CAN_FIRE_RL_operating_actions ;
  ...
  // remaining internal signals
  assign rdat__h10802 = hasDebugLogic ? { 16'd0, x__h10806 } : 32'd0 ;
  assign rdat__h10902 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h10916 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h10924 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h10930 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h10944 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h10952 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h10958 = hasDebugLogic ? mesgPushCount : 32'd0 ;
  assign wsiS_reqFifo_notFull__86_AND_wsiS_burstKind_01_ETC___d208 =
	     wsiS_reqFifo$FULL_N &&
	     (wsiS_burstKind == 2'd0 ||
	      (wsiS_burstKind == 2'd1 || wsiS_burstKind == 2'd2) &&
	      wsiS_wsiReq$wget[165]) ;
  assign x__h10806 = { wsiS_statusR, wsiM_statusR } ;
  always@(wci_wslv_reqF$D_OUT or
	  ...
	  rdat__h10916 or
	  rdat__h10924 or
	  rdat__h10930 or rdat__h10944 or rdat__h10952 or rdat__h10958)
  begin
    case (wci_wslv_reqF$D_OUT[39:32])
      8'h0: _theResult____h10711 = spareValue;
      8'h04: _theResult____h10711 = controlReg;
      8'h20: _theResult____h10711 = rdat__h10802;
      8'h24: _theResult____h10711 = rdat__h10902;
      8'h28: _theResult____h10711 = rdat__h10916;
      8'h2C: _theResult____h10711 = rdat__h10924;
      8'h30: _theResult____h10711 = rdat__h10930;
      8'h34: _theResult____h10711 = rdat__h10944;
      8'h38: _theResult____h10711 = rdat__h10952;
      8'h3C: _theResult____h10711 = rdat__h10958;
      default: _theResult____h10711 = 32'd0;
    endcase
  end
  ...
  begin
    ...
    if (mesgPushCount$EN)
      mesgPushCount <= `BSV_ASSIGNMENT_DELAY mesgPushCount$D_IN;
