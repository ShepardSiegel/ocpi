...
//
// On Wed Feb  9 10:50:54 EST 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkOCTG_dmaFP(CLK,
  ...
  assign reqFsm_pw_list_35$whas =
	     MUX_reqFsm_state_mkFSMstate$write_1__SEL_35 ;
  assign reqFsm_pw_list_36$whas = WILL_FIRE_RL_reqFsm_actionof_l178c15 ;
  ...
  begin
    ...
    if (RST_N)
      if (MUX_reqFsm_state_mkFSMstate$write_1__SEL_35)
	begin
	  v__h218532 = $time;
	  #0;
	end
	...
	$display("[%0d]: %m: 1DW WRITE-INITIATED  Addr:%0x Data:%0x",
		 ...
		 32'h00F0005C,
		 32'h00000010);
    if (RST_N) if (MUX_reqFsm_state_mkFSMstate$write_1__SEL_35) $write("");
    if (RST_N)
	...
	$display("[%0d]: %m: 1DW WRITE-INITIATED  Addr:%0x Data:%0x",
		 ...
		 32'h00F00060,
		 32'h00E00018);
    if (RST_N) if (WILL_FIRE_RL_reqFsm_actionof_l178c15) $write("");
    if (RST_N)
