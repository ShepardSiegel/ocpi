...
//
// On Tue Nov 23 21:28:16 EST 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkTB11(CLK,
  ...
  wire [32 : 0] pmemMon_pmemF$D_IN, pmemMon_pmemF$D_OUT;
  ...
  wire [15 : 0] wsiBurstLength__h63498, x__h19544;
  wire NOT_wci_busy_5_026_AND_IF_wci_wReset_n_5_THEN__ETC___d1039,
       ...
       wci_respTimr_7_ULT_1_SL_wci_wTimeout_8_9___d1259,
  ...
  FIFO2 #(.width(32'd33), .guarded(32'd1)) pmemMon_pmemF(.RST_N(RST_N),
							 .CLK(CLK),
  ...
  assign CAN_FIRE_RL_wciSeqFsm_action_l61c8 =
	     NOT_wci_busy_5_026_AND_IF_wci_wReset_n_5_THEN__ETC___d1039 &&
  ...
  assign wciSeqFsm_pw_list_11$whas = CAN_FIRE_RL_wciSeqFsm_actionof_l65c8 ;
  ...
  assign IF_wci_lastControlOp_22_BIT_3_23_THEN_wci_last_ETC___d137 =
	     { wci_lastControlOp[3] ? wci_lastControlOp[2:0] : 3'b111,
	       ...
	       wci_reqFAIL,
	       wci_reqERR } ;
  assign NOT_wci_busy_5_026_AND_IF_wci_wReset_n_5_THEN__ETC___d1039 =
  ...
  assign wci_respTimr_7_ULT_1_SL_wci_wTimeout_8_9___d1259 =
	     wci_respTimr < toCount__h2393 ;
  assign wsiBurstLength__h63498 = { 4'd0, wsiS_reqFifo$D_OUT[55:44] } ;
  ...
  assign x_data__h63179 = {2{srcDataOut[15:0]}} ;
  ...
  begin
    ...
    if (RST_N)
      if (WILL_FIRE_RL_terminate)
	$display("[%0d]: %m: mkTB11 termination", v__h63970);
    ...
    if (RST_N)
      if (WILL_FIRE_RL_pmemMon_get_message_head)
	$write("[%0d]: %m PMEM event: ", v__h22254);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_wciSeqFsm_actionof_l56c5)
	$display("[%0d]: %m: Taking DUT out of Reset...", v__h57808);
    ...
    if (RST_N)
      if (WILL_FIRE_RL_wciSeqFsm_actionof_l60c5)
	$display("[%0d]: %m: CONTROL-OP: -INITIALIZE- DUT...", v__h58654);
    ...
    if (RST_N)
      if (WILL_FIRE_RL_wciSeqFsm_actionof_l61c8)
	$display("[%0d]: %m: WORKER CONTROL ARM...", v__h58882);
    ...
    if (RST_N)
      if (WILL_FIRE_RL_wciSeqFsm_actionof_l68c5)
	$display("[%0d]: %m: Read Dataplane Config Properties...", v__h60267);
    ...
    if (RST_N)
      if (WILL_FIRE_RL_wciSeqFsm_actionof_l72c5)
	$display("[%0d]: %m: CONTROL-OP: -START- DUT...", v__h61090);
    ...
    if (RST_N)
      if (WILL_FIRE_RL_wciSeqFsm_actionof_l73c8)
	$display("[%0d]: %m: WORKER CONTROL ARM...", v__h61345);
    ...
    if (RST_N)
      if (WILL_FIRE_RL_wciSeqFsm_actionof_l53c5)
	$display("[%0d]: %m: Checking for DUT presence...", v__h57485);
