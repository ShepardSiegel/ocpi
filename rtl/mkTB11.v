...
//
// On Mon Nov 29 19:53:01 EST 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkTB11(CLK,
  ...
  wire [15 : 0] wsiBurstLength__h64231, x__h19544;
  wire NOT_wci_busy_5_039_AND_IF_wci_wReset_n_5_THEN__ETC___d1052,
       ...
       wci_respTimr_7_ULT_1_SL_wci_wTimeout_8_9___d1268,
  ...
  assign CAN_FIRE_RL_wciSeqFsm_action_l61c8 =
	     NOT_wci_busy_5_039_AND_IF_wci_wReset_n_5_THEN__ETC___d1052 &&
  ...
  assign IF_wci_lastControlOp_22_BIT_3_23_THEN_wci_last_ETC___d137 =
	     { wci_lastControlOp[3] ? wci_lastControlOp[2:0] : 3'b111,
	       ...
	       wci_reqFAIL,
	       wci_reqERR } ;
  assign NOT_wci_busy_5_039_AND_IF_wci_wReset_n_5_THEN__ETC___d1052 =
  ...
  assign wci_respTimr_7_ULT_1_SL_wci_wTimeout_8_9___d1268 =
	     wci_respTimr < toCount__h2393 ;
  assign wsiBurstLength__h64231 = { 4'd0, wsiS_reqFifo$D_OUT[55:44] } ;
  ...
  assign x_data__h63912 = {2{srcDataOut[15:0]}} ;
  ...
  begin
    ...
    if (RST_N)
      if (WILL_FIRE_RL_terminate)
	$display("[%0d]: %m: mkTB11 termination", v__h64703);
    ...
    if (RST_N)
	  ...
	  pmemMon_pmemF$D_OUT[7:0] == 8'd1 &&
	  !pmemMon_pmemF$D_OUT[33])
	$display("[%0d]: %m PMEM HEAD EOF ERROR", v__h22738);
    if (RST_N)
      if (WILL_FIRE_RL_pmemMon_get_message_head)
	begin
	  v__h22821 = $time;
    ...
    if (RST_N)
      if (WILL_FIRE_RL_pmemMon_get_message_head)
	$write("[%0d]: %m PMEM event: ", v__h22821);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_pmemMon_gen_message_body && pmemMon_dwRemain == 8'd1 &&
	  !pmemMon_pmemF$D_OUT[33])
	$display("[%0d]: %m PMEM BODY EOF ERROR", v__h24120);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_wciSeqFsm_actionof_l56c5)
	$display("[%0d]: %m: Taking DUT out of Reset...", v__h58541);
    ...
    if (RST_N)
      if (WILL_FIRE_RL_wciSeqFsm_actionof_l60c5)
	$display("[%0d]: %m: CONTROL-OP: -INITIALIZE- DUT...", v__h59387);
    ...
    if (RST_N)
      if (WILL_FIRE_RL_wciSeqFsm_actionof_l61c8)
	$display("[%0d]: %m: WORKER CONTROL ARM...", v__h59615);
    ...
    if (RST_N)
      if (WILL_FIRE_RL_wciSeqFsm_actionof_l68c5)
	$display("[%0d]: %m: Read Dataplane Config Properties...", v__h61000);
    ...
    if (RST_N)
      if (WILL_FIRE_RL_wciSeqFsm_actionof_l72c5)
	$display("[%0d]: %m: CONTROL-OP: -START- DUT...", v__h61823);
    ...
    if (RST_N)
      if (WILL_FIRE_RL_wciSeqFsm_actionof_l73c8)
	$display("[%0d]: %m: WORKER CONTROL ARM...", v__h62078);
    ...
    if (RST_N)
      if (WILL_FIRE_RL_wciSeqFsm_actionof_l53c5)
	$display("[%0d]: %m: Checking for DUT presence...", v__h58218);
