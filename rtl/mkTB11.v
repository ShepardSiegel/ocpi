...
//
// On Tue Nov 23 17:14:47 EST 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkTB11(CLK,
  ...
  wire [15 : 0] wsiBurstLength__h62444, x__h19544;
  wire NOT_wci_busy_5_83_AND_IF_wci_wReset_n_5_THEN_N_ETC___d996,
       ...
       wci_respTimr_7_ULT_1_SL_wci_wTimeout_8_9___d1215,
  ...
  assign CAN_FIRE_RL_wciSeqFsm_action_l61c8 =
	     NOT_wci_busy_5_83_AND_IF_wci_wReset_n_5_THEN_N_ETC___d996 &&
  ...
  assign IF_wci_lastControlOp_22_BIT_3_23_THEN_wci_last_ETC___d137 =
	     { wci_lastControlOp[3] ? wci_lastControlOp[2:0] : 3'b111,
	       ...
	       wci_reqFAIL,
	       wci_reqERR } ;
  assign NOT_wci_busy_5_83_AND_IF_wci_wReset_n_5_THEN_N_ETC___d996 =
  ...
  assign wci_respTimr_7_ULT_1_SL_wci_wTimeout_8_9___d1215 =
	     wci_respTimr < toCount__h2393 ;
  assign wsiBurstLength__h62444 = { 4'd0, wsiS_reqFifo$D_OUT[55:44] } ;
  ...
  assign x_data__h62125 = {2{srcDataOut[15:0]}} ;
  ...
  begin
    ...
    if (RST_N)
      if (WILL_FIRE_RL_terminate)
	$display("[%0d]: %m: mkTB11 termination", v__h62916);
    ...
    if (RST_N)
      if (WILL_FIRE_RL_pmemMon_get_message_head)
	$display("[%0d]: %m: PMEM MONITOR Event %0d srcId:%0x srcTag:%0x length:%0x",
		 v__h22254,
		 pmemMon_eventCount,
		 pmemMon_pmemF$D_OUT[31:24],
    ...
    if (RST_N)
      if (WILL_FIRE_RL_wciSeqFsm_actionof_l56c5)
	$display("[%0d]: %m: Taking DUT out of Reset...", v__h56754);
    ...
    if (RST_N)
      if (WILL_FIRE_RL_wciSeqFsm_actionof_l60c5)
	$display("[%0d]: %m: CONTROL-OP: -INITIALIZE- DUT...", v__h57600);
    ...
    if (RST_N)
      if (WILL_FIRE_RL_wciSeqFsm_actionof_l61c8)
	$display("[%0d]: %m: WORKER CONTROL ARM...", v__h57828);
    ...
    if (RST_N)
      if (WILL_FIRE_RL_wciSeqFsm_actionof_l68c5)
	$display("[%0d]: %m: Read Dataplane Config Properties...", v__h59213);
    ...
    if (RST_N)
      if (WILL_FIRE_RL_wciSeqFsm_actionof_l72c5)
	$display("[%0d]: %m: CONTROL-OP: -START- DUT...", v__h60036);
    ...
    if (RST_N)
      if (WILL_FIRE_RL_wciSeqFsm_actionof_l73c8)
	$display("[%0d]: %m: WORKER CONTROL ARM...", v__h60291);
    ...
    if (RST_N)
      if (WILL_FIRE_RL_wciSeqFsm_actionof_l53c5)
	$display("[%0d]: %m: Checking for DUT presence...", v__h56431);
