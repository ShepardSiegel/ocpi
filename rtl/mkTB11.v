...
//
// On Wed Jan  5 15:07:59 EST 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkTB11(CLK,
  ...
  // register wsiMon_observer_e_sThreadBusy_srcD
  reg wsiMon_observer_e_sThreadBusy_srcD;
  wire wsiMon_observer_e_sThreadBusy_srcD$D_IN,
       wsiMon_observer_e_sThreadBusy_srcD$EN;
  ...
  reg [98 : 0] wsiMon_observer_evF$D_IN;
  wire [98 : 0] wsiMon_observer_evF$D_OUT;
  ...
  wire CAN_FIRE_RL_biasWorker_doMessagePush,
       ...
       CAN_FIRE_RL_wsiMon_observer_backpressure_leading_detected,
       CAN_FIRE_RL_wsiMon_observer_backpressure_trailing_detected,
       CAN_FIRE_RL_wsiMon_observer_doAlways,
       CAN_FIRE_RL_wsiMon_observer_e_sThreadBusy_doAlways,
       ...
       CAN_FIRE_RL_wsiMon_observer_reqlast_detected,
       ...
       WILL_FIRE_RL_wsiMon_observer_backpressure_leading_detected,
       WILL_FIRE_RL_wsiMon_observer_backpressure_trailing_detected,
       WILL_FIRE_RL_wsiMon_observer_doAlways,
       WILL_FIRE_RL_wsiMon_observer_e_sThreadBusy_doAlways,
       ...
       WILL_FIRE_RL_wsiMon_observer_reqlast_detected,
  ...
  wire [98 : 0] MUX_wsiMon_observer_evF$enq_1__VAL_1,
		MUX_wsiMon_observer_evF$enq_1__VAL_2;
  ...
  wire MUX_biasWorker_biasValue$write_1__SEL_1,
       ...
       MUX_wsiMon_observer_evF$enq_1__SEL_1,
  ...
  reg [63 : 0] v__h13098,
	       ...
	       v__h84960,
	       v__h85067;
  reg [31 : 0] _theResult____h19422, x_data__h34349;
  reg [7 : 0] CASE_CASE_wsiMon_pmsender_evFD_OUT_BITS_98_TO__ETC__q5,
	      CASE_pmemMon0_pmemFD_OUT_BITS_23_TO_16_255_0__ETC__q7,
	      CASE_pmemMon0_wsiS_reqFifoD_OUT_BITS_35_TO_28_ETC__q6,
	      ...
	      IF_pmemMon0_pmh_09_BITS_23_TO_16_41_EQ_0_42_OR_ETC___d2646,
	      IF_pmemMon1_pmh_877_BITS_23_TO_16_909_EQ_0_910_ETC___d2647,
	      x__h35283;
  reg [4 : 0] CASE_wsiMon_pmsender_evFD_OUT_BITS_39_TO_32_2_ETC__q3,
	      CASE_wsiMon_pmsender_evFD_OUT_BITS_71_TO_64_2_ETC__q1,
	      CASE_wsiMon_pmsender_evFD_OUT_BITS_7_TO_0_25__ETC__q2,
	      CASE_wsiMon_pmsender_evFD_OUT_BITS_98_TO_96_C_ETC__q4;
  reg [2 : 0] CASE_wsiMon_observer_evFD_OUT_BITS_98_TO_96_5_ETC__q10,
	      len__h34277;
  wire [31 : 0] _0x52_CONCAT_IF_IF_wsiMon_pmsender_evF_first__2_ETC___d1469,
		rdat__h19512,
		toCount__h2394,
		x__h2553,
		x_data__h19019,
  ...
  wire [15 : 0] wsiBurstLength__h84595, x__h19515;
  wire [11 : 0] x_burstLength__h34348;
  wire NOT_wci_busy_5_250_AND_IF_wci_wReset_n_5_THEN__ETC___d2263,
       ...
       srcMesgCount_347_ULT_2___d2348,
       wci_respTimr_7_ULT_1_SL_wci_wTimeout_8_9___d2523,
       wsiMon_pmsender_idx_241_EQ_IF_wsiMon_pmsender__ETC___d2428,
  ...
  assign CAN_FIRE_RL_wsi_source =
	     (!srcMesgCount_347_ULT_2___d2348 || wsiM_reqFifo_c_r != 2'd2) &&
	     enWsiSource ;
  ...
  // rule RL_wsiMon_observer_reqlast_detected
  assign CAN_FIRE_RL_wsiMon_observer_reqlast_detected =
	     wsiMon_observer_evF$FULL_N && wsiMon_observer_r_mReqLast ;
  assign WILL_FIRE_RL_wsiMon_observer_reqlast_detected =
	     CAN_FIRE_RL_wsiMon_observer_reqlast_detected &&
	     !WILL_FIRE_RL_wsiMon_observer_request_detected ;
  ...
  // rule RL_wsiMon_observer_backpressure_leading_detected
  assign CAN_FIRE_RL_wsiMon_observer_backpressure_leading_detected =
	     wsiMon_observer_evF$FULL_N && wsiMon_observer_r_sThreadBusy &&
	     !wsiMon_observer_e_sThreadBusy_srcD ;
  assign WILL_FIRE_RL_wsiMon_observer_backpressure_leading_detected =
	     CAN_FIRE_RL_wsiMon_observer_backpressure_leading_detected &&
	     !WILL_FIRE_RL_wsiMon_observer_reqlast_detected &&
	     !WILL_FIRE_RL_wsiMon_observer_request_detected ;

  // rule RL_wsiMon_observer_backpressure_trailing_detected
  assign CAN_FIRE_RL_wsiMon_observer_backpressure_trailing_detected =
	     wsiMon_observer_evF$FULL_N && !wsiMon_observer_r_sThreadBusy &&
	     wsiMon_observer_e_sThreadBusy_srcD ;
  assign WILL_FIRE_RL_wsiMon_observer_backpressure_trailing_detected =
	     CAN_FIRE_RL_wsiMon_observer_backpressure_trailing_detected &&
	     !WILL_FIRE_RL_wsiMon_observer_reqlast_detected &&
	     !WILL_FIRE_RL_wsiMon_observer_request_detected ;
  ...
  // rule RL_wsiMon_observer_e_sThreadBusy_doAlways
  assign CAN_FIRE_RL_wsiMon_observer_e_sThreadBusy_doAlways = 1'd1 ;
  assign WILL_FIRE_RL_wsiMon_observer_e_sThreadBusy_doAlways = 1'd1 ;
  ...
  assign CAN_FIRE_RL_wciSeqFsm_action_l64c8 =
	     NOT_wci_busy_5_250_AND_IF_wci_wReset_n_5_THEN__ETC___d2263 &&
  ...
  assign MUX_wsiMon_observer_evF$enq_1__SEL_1 =
	     WILL_FIRE_RL_wsiMon_observer_request_detected &&
  ...
  assign MUX_wsiM_reqFifo_q_1$write_1__VAL_1 =
	     (wsiM_reqFifo_c_r == 2'd2) ?
	       MUX_wsiM_reqFifo_q_0$write_1__VAL_2 :
	       61'h00000AAAAAAAAA00 ;
  assign MUX_wsiMon_observer_evF$enq_1__VAL_1 =
	     { 67'h1AAAAAAAAAAAAAA10, wsiMon_observer_r_mData } ;
  assign MUX_wsiMon_observer_evF$enq_1__VAL_2 =
	     { 67'h1AAAAAAAAAAAAAA50, wsiMon_observer_r_mData } ;
  ...
  assign wsiM_reqFifo_enqueueing$whas =
	     WILL_FIRE_RL_wsi_source && srcMesgCount_347_ULT_2___d2348 ;
  ...
  assign wciSeqFsm_pw_list_6$whas = CAN_FIRE_RL_wciSeqFsm_actionof_l61c5 ;
  ...
  assign wciSeqFsm_pw_list_10$whas = CAN_FIRE_RL_wciSeqFsm_action_l67c5 ;
  ...
  assign wciSeqFsm_pw_list_13$whas = CAN_FIRE_RL_wciSeqFsm_action_l71c5 ;
  ...
  assign wciSeqFsm_pw_list_17$whas = CAN_FIRE_RL_wciSeqFsm_actionof_l76c8 ;
  ...
  assign wciSeqFsm_pw_list_20$whas = CAN_FIRE_RL_wciSeqFsm_actionof_l80c19 ;
  ...
  assign wciSeqFsm_pw_list_23$whas = CAN_FIRE_RL_wciSeqFsm_action_l84c19 ;
  ...
  assign enWsiSource$EN = CAN_FIRE_RL_wciSeqFsm_action_l84c19 ;
  ...
  // register pmemMon0_pmGrab
  assign pmemMon0_pmGrab$D_IN = z__h25804 ^ pmemMon0_pmh[31] ;
  ...
  // register pmemMon1_pmGrab
  assign pmemMon1_pmGrab$D_IN = z__h40992 ^ pmemMon1_pmh[31] ;
  ...
  // register wsiMon_observer_e_sThreadBusy_srcD
  assign wsiMon_observer_e_sThreadBusy_srcD$D_IN =
	     wsiMon_observer_r_sThreadBusy ;
  assign wsiMon_observer_e_sThreadBusy_srcD$EN = 1'd1 ;
  ...
  // submodule wsiMon_observer_evF
  always@(MUX_wsiMon_observer_evF$enq_1__SEL_1 or
	  MUX_wsiMon_observer_evF$enq_1__VAL_1 or
	  WILL_FIRE_RL_wsiMon_observer_reqlast_detected or
	  MUX_wsiMon_observer_evF$enq_1__VAL_2 or
	  WILL_FIRE_RL_wsiMon_observer_backpressure_leading_detected or
	  WILL_FIRE_RL_wsiMon_observer_backpressure_trailing_detected)
  begin
    case (1'b1) // synopsys parallel_case
      MUX_wsiMon_observer_evF$enq_1__SEL_1:
	  wsiMon_observer_evF$D_IN = MUX_wsiMon_observer_evF$enq_1__VAL_1;
      WILL_FIRE_RL_wsiMon_observer_reqlast_detected:
	  wsiMon_observer_evF$D_IN = MUX_wsiMon_observer_evF$enq_1__VAL_2;
      WILL_FIRE_RL_wsiMon_observer_backpressure_leading_detected:
	  wsiMon_observer_evF$D_IN = 99'h0AAAAAAAAAAAAAAAAAAAAAA60;
      WILL_FIRE_RL_wsiMon_observer_backpressure_trailing_detected:
	  wsiMon_observer_evF$D_IN = 99'h0AAAAAAAAAAAAAAAAAAAAAA61;
      default: wsiMon_observer_evF$D_IN =
  ...
  assign IF_wci_lastControlOp_22_BIT_3_23_THEN_wci_last_ETC___d137 =
	     { wci_lastControlOp[3] ? wci_lastControlOp[2:0] : 3'b111,
	       ...
	       wci_reqFAIL,
	       wci_reqERR } ;
  assign NOT_wci_busy_5_250_AND_IF_wci_wReset_n_5_THEN__ETC___d2263 =
	     !wci_busy && (wci_wReset_n ? !wci_reqF_c_r : wci_respF$FULL_N) ;
  assign _0x52_CONCAT_IF_IF_wsiMon_pmsender_evF_first__2_ETC___d1469 =
	     { 8'h52,
  ...
  assign srcMesgCount_347_ULT_2___d2348 = srcMesgCount < 16'd2 ;
  assign toCount__h2394 = 32'd1 << wci_wTimeout ;
  assign wci_respTimr_7_ULT_1_SL_wci_wTimeout_8_9___d2523 =
	     wci_respTimr < toCount__h2394 ;
  assign wsiBurstLength__h84595 = { 4'd0, wsiS_reqFifo$D_OUT[55:44] } ;
  assign wsiMon_pmsender_idx_241_EQ_IF_wsiMon_pmsender__ETC___d2428 =
	     wsiMon_pmsender_idx == len__h34277 ;
  ...
  assign x_burstLength__h34348 = { 9'd0, len__h34277 } ;
  assign x_data__h19019 =
	     biasWorker_wsiS_reqFifo$D_OUT[43:12] + biasWorker_biasValue ;
  assign x_data__h84276 = {2{srcDataOut[15:0]}} ;
  assign z__h25601 = pmemMon0_pmh[0] ^ pmemMon0_pmh[1] ;
  assign z__h25608 = z__h25601 ^ pmemMon0_pmh[2] ;
  assign z__h25615 = z__h25608 ^ pmemMon0_pmh[3] ;
  assign z__h25622 = z__h25615 ^ pmemMon0_pmh[4] ;
  assign z__h25629 = z__h25622 ^ pmemMon0_pmh[5] ;
  assign z__h25636 = z__h25629 ^ pmemMon0_pmh[6] ;
  assign z__h25643 = z__h25636 ^ pmemMon0_pmh[7] ;
  assign z__h25650 = z__h25643 ^ pmemMon0_pmh[8] ;
  assign z__h25657 = z__h25650 ^ pmemMon0_pmh[9] ;
  assign z__h25664 = z__h25657 ^ pmemMon0_pmh[10] ;
  assign z__h25671 = z__h25664 ^ pmemMon0_pmh[11] ;
  assign z__h25678 = z__h25671 ^ pmemMon0_pmh[12] ;
  assign z__h25685 = z__h25678 ^ pmemMon0_pmh[13] ;
  assign z__h25692 = z__h25685 ^ pmemMon0_pmh[14] ;
  assign z__h25699 = z__h25692 ^ pmemMon0_pmh[15] ;
  assign z__h25706 =
	     z__h25699 ^
	     IF_pmemMon0_pmh_09_BITS_23_TO_16_41_EQ_0_42_OR_ETC___d2646[0] ;
  assign z__h25713 =
	     z__h25706 ^
	     IF_pmemMon0_pmh_09_BITS_23_TO_16_41_EQ_0_42_OR_ETC___d2646[1] ;
  assign z__h25720 =
	     z__h25713 ^
	     IF_pmemMon0_pmh_09_BITS_23_TO_16_41_EQ_0_42_OR_ETC___d2646[2] ;
  assign z__h25727 =
	     z__h25720 ^
	     IF_pmemMon0_pmh_09_BITS_23_TO_16_41_EQ_0_42_OR_ETC___d2646[3] ;
  assign z__h25734 =
	     z__h25727 ^
	     IF_pmemMon0_pmh_09_BITS_23_TO_16_41_EQ_0_42_OR_ETC___d2646[4] ;
  assign z__h25741 =
	     z__h25734 ^
	     IF_pmemMon0_pmh_09_BITS_23_TO_16_41_EQ_0_42_OR_ETC___d2646[5] ;
  assign z__h25748 =
	     z__h25741 ^
	     IF_pmemMon0_pmh_09_BITS_23_TO_16_41_EQ_0_42_OR_ETC___d2646[6] ;
  assign z__h25755 =
	     z__h25748 ^
	     IF_pmemMon0_pmh_09_BITS_23_TO_16_41_EQ_0_42_OR_ETC___d2646[7] ;
  assign z__h25762 = z__h25755 ^ pmemMon0_pmh[24] ;
  assign z__h25769 = z__h25762 ^ pmemMon0_pmh[25] ;
  assign z__h25776 = z__h25769 ^ pmemMon0_pmh[26] ;
  assign z__h25783 = z__h25776 ^ pmemMon0_pmh[27] ;
  assign z__h25790 = z__h25783 ^ pmemMon0_pmh[28] ;
  assign z__h25797 = z__h25790 ^ pmemMon0_pmh[29] ;
  assign z__h25804 = z__h25797 ^ pmemMon0_pmh[30] ;
  assign z__h40789 = pmemMon1_pmh[0] ^ pmemMon1_pmh[1] ;
  assign z__h40796 = z__h40789 ^ pmemMon1_pmh[2] ;
  assign z__h40803 = z__h40796 ^ pmemMon1_pmh[3] ;
  assign z__h40810 = z__h40803 ^ pmemMon1_pmh[4] ;
  assign z__h40817 = z__h40810 ^ pmemMon1_pmh[5] ;
  assign z__h40824 = z__h40817 ^ pmemMon1_pmh[6] ;
  assign z__h40831 = z__h40824 ^ pmemMon1_pmh[7] ;
  assign z__h40838 = z__h40831 ^ pmemMon1_pmh[8] ;
  assign z__h40845 = z__h40838 ^ pmemMon1_pmh[9] ;
  assign z__h40852 = z__h40845 ^ pmemMon1_pmh[10] ;
  assign z__h40859 = z__h40852 ^ pmemMon1_pmh[11] ;
  assign z__h40866 = z__h40859 ^ pmemMon1_pmh[12] ;
  assign z__h40873 = z__h40866 ^ pmemMon1_pmh[13] ;
  assign z__h40880 = z__h40873 ^ pmemMon1_pmh[14] ;
  assign z__h40887 = z__h40880 ^ pmemMon1_pmh[15] ;
  assign z__h40894 =
	     z__h40887 ^
	     IF_pmemMon1_pmh_877_BITS_23_TO_16_909_EQ_0_910_ETC___d2647[0] ;
  assign z__h40901 =
	     z__h40894 ^
	     IF_pmemMon1_pmh_877_BITS_23_TO_16_909_EQ_0_910_ETC___d2647[1] ;
  assign z__h40908 =
	     z__h40901 ^
	     IF_pmemMon1_pmh_877_BITS_23_TO_16_909_EQ_0_910_ETC___d2647[2] ;
  assign z__h40915 =
	     z__h40908 ^
	     IF_pmemMon1_pmh_877_BITS_23_TO_16_909_EQ_0_910_ETC___d2647[3] ;
  assign z__h40922 =
	     z__h40915 ^
	     IF_pmemMon1_pmh_877_BITS_23_TO_16_909_EQ_0_910_ETC___d2647[4] ;
  assign z__h40929 =
	     z__h40922 ^
	     IF_pmemMon1_pmh_877_BITS_23_TO_16_909_EQ_0_910_ETC___d2647[5] ;
  assign z__h40936 =
	     z__h40929 ^
	     IF_pmemMon1_pmh_877_BITS_23_TO_16_909_EQ_0_910_ETC___d2647[6] ;
  assign z__h40943 =
	     z__h40936 ^
	     IF_pmemMon1_pmh_877_BITS_23_TO_16_909_EQ_0_910_ETC___d2647[7] ;
  assign z__h40950 = z__h40943 ^ pmemMon1_pmh[24] ;
  assign z__h40957 = z__h40950 ^ pmemMon1_pmh[25] ;
  assign z__h40964 = z__h40957 ^ pmemMon1_pmh[26] ;
  assign z__h40971 = z__h40964 ^ pmemMon1_pmh[27] ;
  assign z__h40978 = z__h40971 ^ pmemMon1_pmh[28] ;
  assign z__h40985 = z__h40978 ^ pmemMon1_pmh[29] ;
  assign z__h40992 = z__h40985 ^ pmemMon1_pmh[30] ;
  always@(wsiMon_pmsender_evF$D_OUT)
  begin
    case (wsiMon_pmsender_evF$D_OUT[98:96])
      3'd0: len__h34277 = 3'd1;
      3'd1: len__h34277 = 3'd2;
      3'd2: len__h34277 = 3'd3;
      default: len__h34277 = 3'd7;
    endcase
  end
  always@(wsiMon_pmsender_evF$D_OUT)
  begin
  ...
  begin
    case (wsiMon_pmsender_evF$D_OUT[71:64])
      ...
      8'd80: CASE_wsiMon_pmsender_evFD_OUT_BITS_71_TO_64_2_ETC__q1 = 5'd19;
      8'd96: CASE_wsiMon_pmsender_evFD_OUT_BITS_71_TO_64_2_ETC__q1 = 5'd20;
      8'd97: CASE_wsiMon_pmsender_evFD_OUT_BITS_71_TO_64_2_ETC__q1 = 5'd21;
      8'd128: CASE_wsiMon_pmsender_evFD_OUT_BITS_71_TO_64_2_ETC__q1 = 5'd22;
      8'd144: CASE_wsiMon_pmsender_evFD_OUT_BITS_71_TO_64_2_ETC__q1 = 5'd23;
      8'd160: CASE_wsiMon_pmsender_evFD_OUT_BITS_71_TO_64_2_ETC__q1 = 5'd24;
      default: CASE_wsiMon_pmsender_evFD_OUT_BITS_71_TO_64_2_ETC__q1 = 5'd25;
    endcase
  end
  always@(wsiMon_pmsender_evF$D_OUT)
  begin
    case (wsiMon_pmsender_evF$D_OUT[7:0])
      8'd0: CASE_wsiMon_pmsender_evFD_OUT_BITS_7_TO_0_25__ETC__q2 = 5'd0;
      8'd1: CASE_wsiMon_pmsender_evFD_OUT_BITS_7_TO_0_25__ETC__q2 = 5'd1;
      8'd2: CASE_wsiMon_pmsender_evFD_OUT_BITS_7_TO_0_25__ETC__q2 = 5'd2;
      8'd3: CASE_wsiMon_pmsender_evFD_OUT_BITS_7_TO_0_25__ETC__q2 = 5'd3;
      8'd4: CASE_wsiMon_pmsender_evFD_OUT_BITS_7_TO_0_25__ETC__q2 = 5'd4;
      8'd5: CASE_wsiMon_pmsender_evFD_OUT_BITS_7_TO_0_25__ETC__q2 = 5'd5;
      8'd6: CASE_wsiMon_pmsender_evFD_OUT_BITS_7_TO_0_25__ETC__q2 = 5'd6;
      8'd7: CASE_wsiMon_pmsender_evFD_OUT_BITS_7_TO_0_25__ETC__q2 = 5'd7;
      8'd8: CASE_wsiMon_pmsender_evFD_OUT_BITS_7_TO_0_25__ETC__q2 = 5'd8;
      8'd9: CASE_wsiMon_pmsender_evFD_OUT_BITS_7_TO_0_25__ETC__q2 = 5'd9;
      8'd10: CASE_wsiMon_pmsender_evFD_OUT_BITS_7_TO_0_25__ETC__q2 = 5'd10;
      8'd11: CASE_wsiMon_pmsender_evFD_OUT_BITS_7_TO_0_25__ETC__q2 = 5'd11;
      8'd12: CASE_wsiMon_pmsender_evFD_OUT_BITS_7_TO_0_25__ETC__q2 = 5'd12;
      8'd13: CASE_wsiMon_pmsender_evFD_OUT_BITS_7_TO_0_25__ETC__q2 = 5'd13;
      8'd14: CASE_wsiMon_pmsender_evFD_OUT_BITS_7_TO_0_25__ETC__q2 = 5'd14;
      8'd16: CASE_wsiMon_pmsender_evFD_OUT_BITS_7_TO_0_25__ETC__q2 = 5'd15;
      8'd32: CASE_wsiMon_pmsender_evFD_OUT_BITS_7_TO_0_25__ETC__q2 = 5'd16;
      8'd48: CASE_wsiMon_pmsender_evFD_OUT_BITS_7_TO_0_25__ETC__q2 = 5'd17;
      8'd64: CASE_wsiMon_pmsender_evFD_OUT_BITS_7_TO_0_25__ETC__q2 = 5'd18;
      8'd80: CASE_wsiMon_pmsender_evFD_OUT_BITS_7_TO_0_25__ETC__q2 = 5'd19;
      8'd96: CASE_wsiMon_pmsender_evFD_OUT_BITS_7_TO_0_25__ETC__q2 = 5'd20;
      8'd97: CASE_wsiMon_pmsender_evFD_OUT_BITS_7_TO_0_25__ETC__q2 = 5'd21;
      8'd128: CASE_wsiMon_pmsender_evFD_OUT_BITS_7_TO_0_25__ETC__q2 = 5'd22;
      8'd144: CASE_wsiMon_pmsender_evFD_OUT_BITS_7_TO_0_25__ETC__q2 = 5'd23;
      8'd160: CASE_wsiMon_pmsender_evFD_OUT_BITS_7_TO_0_25__ETC__q2 = 5'd24;
      default: CASE_wsiMon_pmsender_evFD_OUT_BITS_7_TO_0_25__ETC__q2 = 5'd25;
    endcase
  end
  always@(wsiMon_pmsender_evF$D_OUT)
  begin
    case (wsiMon_pmsender_evF$D_OUT[39:32])
      ...
      8'd80: CASE_wsiMon_pmsender_evFD_OUT_BITS_39_TO_32_2_ETC__q3 = 5'd19;
      8'd96: CASE_wsiMon_pmsender_evFD_OUT_BITS_39_TO_32_2_ETC__q3 = 5'd20;
      8'd97: CASE_wsiMon_pmsender_evFD_OUT_BITS_39_TO_32_2_ETC__q3 = 5'd21;
      8'd128: CASE_wsiMon_pmsender_evFD_OUT_BITS_39_TO_32_2_ETC__q3 = 5'd22;
      8'd144: CASE_wsiMon_pmsender_evFD_OUT_BITS_39_TO_32_2_ETC__q3 = 5'd23;
      8'd160: CASE_wsiMon_pmsender_evFD_OUT_BITS_39_TO_32_2_ETC__q3 = 5'd24;
      default: CASE_wsiMon_pmsender_evFD_OUT_BITS_39_TO_32_2_ETC__q3 = 5'd25;
    endcase
  end
  always@(wsiMon_pmsender_evF$D_OUT or
	  CASE_wsiMon_pmsender_evFD_OUT_BITS_71_TO_64_2_ETC__q1 or
	  CASE_wsiMon_pmsender_evFD_OUT_BITS_7_TO_0_25__ETC__q2 or
  ...
  begin
    case (CASE_wsiMon_pmsender_evFD_OUT_BITS_98_TO_96_C_ETC__q4)
      ...
      5'd19: CASE_CASE_wsiMon_pmsender_evFD_OUT_BITS_98_TO__ETC__q5 = 8'd80;
      5'd20: CASE_CASE_wsiMon_pmsender_evFD_OUT_BITS_98_TO__ETC__q5 = 8'd96;
      5'd21: CASE_CASE_wsiMon_pmsender_evFD_OUT_BITS_98_TO__ETC__q5 = 8'd97;
      5'd22: CASE_CASE_wsiMon_pmsender_evFD_OUT_BITS_98_TO__ETC__q5 = 8'd128;
      5'd23: CASE_CASE_wsiMon_pmsender_evFD_OUT_BITS_98_TO__ETC__q5 = 8'd144;
      5'd24: CASE_CASE_wsiMon_pmsender_evFD_OUT_BITS_98_TO__ETC__q5 = 8'd160;
  ...
  always@(wsiMon_pmsender_idx or
	  ...
	  _0x52_CONCAT_IF_IF_wsiMon_pmsender_evF_first__2_ETC___d1469)
  begin
    case (wsiMon_pmsender_idx)
      ...
      default: x_data__h34349 = wsiMon_pmsender_evF$D_OUT[31:0];
    endcase
  end
  always@(pmemMon0_pmh)
  begin
    case (pmemMon0_pmh[23:16])
	  ...
	  IF_pmemMon0_pmh_09_BITS_23_TO_16_41_EQ_0_42_OR_ETC___d2646 =
	      pmemMon0_pmh[23:16];
      default: IF_pmemMon0_pmh_09_BITS_23_TO_16_41_EQ_0_42_OR_ETC___d2646 =
		   8'd255;
    endcase
  end
  always@(pmemMon1_pmh)
  begin
    case (pmemMon1_pmh[23:16])
	  ...
	  IF_pmemMon1_pmh_877_BITS_23_TO_16_909_EQ_0_910_ETC___d2647 =
	      pmemMon1_pmh[23:16];
      default: IF_pmemMon1_pmh_877_BITS_23_TO_16_909_EQ_0_910_ETC___d2647 =
		   8'd255;
    endcase
  end
  ...
  begin
    case (pmemMon0_wsiS_reqFifo$D_OUT[35:28])
      ...
      default: CASE_pmemMon0_wsiS_reqFifoD_OUT_BITS_35_TO_28_ETC__q6 = 8'd255;
    endcase
  end
  ...
  begin
    case (pmemMon0_pmemF$D_OUT[23:16])
      ...
      default: CASE_pmemMon0_pmemFD_OUT_BITS_23_TO_16_255_0__ETC__q7 = 8'd255;
    endcase
  end
  ...
  begin
    ...
    if (wsiMon_observer_e_sThreadBusy_srcD$EN)
      wsiMon_observer_e_sThreadBusy_srcD <= `BSV_ASSIGNMENT_DELAY
	  wsiMon_observer_e_sThreadBusy_srcD$D_IN;
  ...
  begin
    ...
    wsiMon_observer_e_sThreadBusy_srcD = 1'h0;
  ...
  begin
    ...
    if (RST_N)
      if (WILL_FIRE_RL_terminate)
	$display("[%0d]: %m: mkTB11 termination", v__h85067);
    ...
    if (RST_N)
      if (WILL_FIRE_RL_pmemMon0_get_message_head_dw)
	$write("[%0d]: %m: PMEM HEAD: ", v__h27086);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_pmemMon1_get_message_head_dw)
	$write("[%0d]: %m: PMEM HEAD: ", v__h42274);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_wciSeqFsm_actionof_l59c5)
	$display("[%0d]: %m: Taking DUT out of Reset...", v__h78905);
    ...
    if (RST_N)
      if (WILL_FIRE_RL_wciSeqFsm_actionof_l63c5)
	$display("[%0d]: %m: CONTROL-OP: -INITIALIZE- DUT...", v__h79751);
    ...
    if (RST_N)
      if (WILL_FIRE_RL_wciSeqFsm_actionof_l64c8)
	$display("[%0d]: %m: WORKER CONTROL ARM...", v__h79979);
    ...
    if (RST_N)
      if (WILL_FIRE_RL_wciSeqFsm_actionof_l71c5)
	$display("[%0d]: %m: Read Dataplane Config Properties...", v__h81364);
    ...
    if (RST_N)
      if (WILL_FIRE_RL_wciSeqFsm_actionof_l75c5)
	$display("[%0d]: %m: CONTROL-OP: -START- DUT...", v__h82187);
    ...
    if (RST_N)
      if (WILL_FIRE_RL_wciSeqFsm_actionof_l76c8)
	$display("[%0d]: %m: WORKER CONTROL ARM...", v__h82442);
    ...
    if (RST_N)
      if (WILL_FIRE_RL_wciSeqFsm_actionof_l56c5)
	$display("[%0d]: %m: Checking for DUT presence...", v__h78582);
