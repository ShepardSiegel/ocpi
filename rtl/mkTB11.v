...
//
// On Mon Nov 15 14:14:48 EST 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkTB11(CLK,
  ...
  wire [31 : 0] wciMon$wciO0_MData, wciMon$wciO0_SData;
  wire [19 : 0] wciMon$wciO0_MAddr;
  wire [3 : 0] wciMon$wciO0_MByteEn;
  wire [2 : 0] wciMon$wciO0_MCmd;
  wire [1 : 0] wciMon$wciO0_MFlag, wciMon$wciO0_SFlag, wciMon$wciO0_SResp;
  wire wciMon$EN_pmem_get,
       wciMon$RDY_pmem_get,
       wciMon$wciO0_MAddrSpace,
       wciMon$wciO0_SThreadBusy;
  ...
  wire [15 : 0] wsiBurstLength__h61950, x__h19544;
  wire NOT_wci_busy_5_83_AND_IF_wci_wReset_n_5_THEN_N_ETC___d896,
       ...
       wci_respTimr_7_ULT_1_SL_wci_wTimeout_8_9___d1114,
  ...
  // submodule wciMon
  mkWciOcpMonitor wciMon(.monId(8'h42),
			 .CLK(CLK),
			 .RST_N(RST_N),
			 .wciO0_MAddr(wciMon$wciO0_MAddr),
			 .wciO0_MAddrSpace(wciMon$wciO0_MAddrSpace),
			 .wciO0_MByteEn(wciMon$wciO0_MByteEn),
			 .wciO0_MCmd(wciMon$wciO0_MCmd),
			 .wciO0_MData(wciMon$wciO0_MData),
			 .wciO0_MFlag(wciMon$wciO0_MFlag),
			 .wciO0_SData(wciMon$wciO0_SData),
			 .wciO0_SFlag(wciMon$wciO0_SFlag),
			 .wciO0_SResp(wciMon$wciO0_SResp),
			 .wciO0_SThreadBusy(wciMon$wciO0_SThreadBusy),
  ...
  assign CAN_FIRE_RL_wciSeqFsm_action_l61c8 =
	     NOT_wci_busy_5_83_AND_IF_wci_wReset_n_5_THEN_N_ETC___d896 &&
  ...
  begin
    case (1'b1) // synopsys parallel_case
      ...
      MUX_wci_lastConfigBE$write_1__SEL_2:
	  MUX_wci_reqF_q_0$write_1__VAL_2 = 60'h3F0000400000002;
  ...
  // register pmemMon_pmh
  assign pmemMon_pmh$D_IN = pmemMon_pmemF$D_OUT[31:0] ;
  ...
  // submodule pmemMon_pmemF
  assign pmemMon_pmemF$D_IN = wciMon$pmem_get ;
  ...
  // submodule wciMon
  assign wciMon$wciO0_MAddr = biasWorker_wci_Es_mAddr_w$wget ;
  assign wciMon$wciO0_MAddrSpace = biasWorker_wci_Es_mAddrSpace_w$wget ;
  assign wciMon$wciO0_MByteEn = biasWorker_wci_Es_mByteEn_w$wget ;
  assign wciMon$wciO0_MCmd = biasWorker_wci_Es_mCmd_w$wget ;
  assign wciMon$wciO0_MData = wci_reqF_q_0[31:0] ;
  assign wciMon$wciO0_MFlag = wci_mFlagReg ;
  assign wciMon$wciO0_SData = biasWorker_wci_respF_q_0[31:0] ;
  assign wciMon$wciO0_SFlag = { 1'd1, biasWorker_wci_sFlagReg } ;
  assign wciMon$wciO0_SResp = biasWorker_wci_respF_q_0[33:32] ;
  assign wciMon$wciO0_SThreadBusy = wci_sThreadBusy_pw$whas ;
  ...
  assign IF_wci_lastControlOp_22_BIT_3_23_THEN_wci_last_ETC___d137 =
	     { wci_lastControlOp[3] ? wci_lastControlOp[2:0] : 3'b111,
	       ...
	       wci_reqFAIL,
	       wci_reqERR } ;
  assign NOT_wci_busy_5_83_AND_IF_wci_wReset_n_5_THEN_N_ETC___d896 =
  ...
  assign wci_respTimr_7_ULT_1_SL_wci_wTimeout_8_9___d1114 =
	     wci_respTimr < toCount__h2393 ;
  assign wsiBurstLength__h61950 = { 4'd0, wsiS_reqFifo$D_OUT[55:44] } ;
  ...
  assign x_data__h61631 = {2{srcDataOut[15:0]}} ;
  ...
  begin
    ...
    if (RST_N)
      if (WILL_FIRE_RL_terminate)
	$display("[%0d]: %m: mkTB11 termination", v__h62422);
    ...
    if (RST_N)
      if (WILL_FIRE_RL_pmemMon_get_message_head)
	$display("[%0d]: %m: Event Header srcId:%0x eType:%0x srcTag:%0x length:%0x",
		 v__h22046,
		 pmemMon_pmemF$D_OUT[31:24],
		 pmemMon_pmemF$D_OUT[23:16],
		 pmemMon_pmemF$D_OUT[15:8],
		 pmemMon_pmemF$D_OUT[7:0]);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_pmemMon_gen_message_body)
	$display("[%0d]: %m: Event Body dwRemain:%0x data:%0x ",
		 v__h22239,
		 pmemMon_dwRemain,
    ...
    if (RST_N)
      if (WILL_FIRE_RL_wciSeqFsm_actionof_l56c5)
	$display("[%0d]: %m: Taking DUT out of Reset...", v__h56260);
    ...
    if (RST_N)
      if (WILL_FIRE_RL_wciSeqFsm_actionof_l60c5)
	$display("[%0d]: %m: CONTROL-OP: -INITIALIZE- DUT...", v__h57106);
    ...
    if (RST_N)
      if (WILL_FIRE_RL_wciSeqFsm_actionof_l61c8)
	$display("[%0d]: %m: WORKER CONTROL ARM...", v__h57334);
    ...
    if (RST_N)
      if (WILL_FIRE_RL_wciSeqFsm_actionof_l68c5)
	$display("[%0d]: %m: Read Dataplane Config Properties...", v__h58719);
    ...
    if (RST_N)
      if (WILL_FIRE_RL_wciSeqFsm_actionof_l72c5)
	$display("[%0d]: %m: CONTROL-OP: -START- DUT...", v__h59542);
    ...
    if (RST_N)
      if (WILL_FIRE_RL_wciSeqFsm_actionof_l73c8)
	$display("[%0d]: %m: WORKER CONTROL ARM...", v__h59797);
    ...
    if (RST_N)
      if (WILL_FIRE_RL_wciSeqFsm_actionof_l53c5)
	$display("[%0d]: %m: Checking for DUT presence...", v__h55937);
