...
//
// On Wed Dec 29 17:42:47 EST 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkA4LS(ACLK,
  ...
  wire [34 : 0] a4rdAddr_data_wire$wget, a4wrAddr_data_wire$wget;
  ...
  wire [34 : 0] a4rdAddr_fifof$D_IN, a4rdAddr_fifof$D_OUT;
  ...
  wire [34 : 0] a4wrAddr_fifof$D_IN, a4wrAddr_fifof$D_OUT;
  ...
  reg [63 : 0] v__h4390, v__h4610, v__h4642;
  reg [31 : 0] _theResult____h4453;
  wire [31 : 0] rdat__h4579;
  ...
  // value method sAWREADY
  assign AWREADY = a4wrAddr_fifof$FULL_N ;
  ...
  // value method sWREADY
  assign WREADY = a4wrData_fifof$FULL_N ;
  ...
  // value method sBVALID
  assign BVALID = a4wrResp_fifof_c_r != 2'd0 ;
  ...
  // value method sBRESP
  assign BRESP = a4wrResp_fifof_q_0 ;
  ...
  // value method sARREADY
  assign ARREADY = a4rdAddr_fifof$FULL_N ;
  ...
  // value method sRVALID
  assign RVALID = a4rdResp_fifof_c_r != 2'd0 ;
  ...
  // value method sRDATA
  assign RDATA = a4rdResp_fifof_q_0[31:0] ;

  // value method sRRESP
  assign RRESP = a4rdResp_fifof_q_0[33:32] ;

  // submodule a4rdAddr_fifof
  FIFO2 #(.width(32'd35), .guarded(32'd1)) a4rdAddr_fifof(.RST_N(ARESETN),
							  .CLK(ACLK),
  ...
  FIFO2 #(.width(32'd35), .guarded(32'd1)) a4wrAddr_fifof(.RST_N(ARESETN),
							  .CLK(ACLK),
  ...
  FIFO2 #(.width(32'd36), .guarded(32'd1)) a4wrData_fifof(.RST_N(ARESETN),
							  .CLK(ACLK),
  ...
  assign CAN_FIRE_RL_a4wrAddr_do_enq = a4wrAddr_fifof$FULL_N && AWVALID ;
  assign WILL_FIRE_RL_a4wrAddr_do_enq = CAN_FIRE_RL_a4wrAddr_do_enq ;

  // rule RL_a4wrData_do_enq
  assign CAN_FIRE_RL_a4wrData_do_enq = a4wrData_fifof$FULL_N && WVALID ;
  assign WILL_FIRE_RL_a4wrData_do_enq = CAN_FIRE_RL_a4wrData_do_enq ;

  // rule RL_a4wrResp_do_deq
  assign CAN_FIRE_RL_a4wrResp_do_deq = a4wrResp_fifof_c_r != 2'd0 && BREADY ;
  ...
  assign CAN_FIRE_RL_a4rdAddr_do_enq = a4rdAddr_fifof$FULL_N && ARVALID ;
  assign WILL_FIRE_RL_a4rdAddr_do_enq = CAN_FIRE_RL_a4rdAddr_do_enq ;

  // rule RL_a4rdResp_do_deq
  assign CAN_FIRE_RL_a4rdResp_do_deq = a4rdResp_fifof_c_r != 2'd0 && RREADY ;
  ...
  assign a4wrAddr_enq_valid$whas = AWVALID ;
  assign a4wrAddr_enq_enq$whas = 1'b0 ;
  assign a4wrData_enq_valid$whas = WVALID ;
  ...
  assign a4wrResp_deq_ready$whas = BREADY ;
  assign a4wrResp_deq_deq$whas = 1'b0 ;
  assign a4rdAddr_enq_valid$whas = ARVALID ;
  ...
  assign a4rdResp_deq_ready$whas = RREADY ;
  assign a4rdResp_deq_deq$whas = 1'b0 ;
  assign a4wrAddr_data_wire$wget = { AWPROT, AWADDR } ;
  assign a4wrData_data_wire$wget = { WSTRB, WDATA } ;
  assign a4rdAddr_data_wire$wget = { ARPROT, ARADDR } ;
  ...
  // submodule a4rdAddr_fifof
  assign a4rdAddr_fifof$D_IN = a4rdAddr_data_wire$wget ;
  ...
  // submodule a4wrAddr_fifof
  assign a4wrAddr_fifof$D_IN = a4wrAddr_data_wire$wget ;
  ...
  // submodule a4wrData_fifof
  assign a4wrData_fifof$D_IN = a4wrData_data_wire$wget ;
  ...
  // remaining internal signals
  assign rdat__h4579 = { b1B, b1A, b19, b18 } ;
  always@(a4rdAddr_fifof$D_OUT or r0 or r4 or rdat__h4579)
  begin
    case (a4rdAddr_fifof$D_OUT[7:0])
      8'h0: _theResult____h4453 = r0;
      8'h04: _theResult____h4453 = r4;
      8'h10: _theResult____h4453 = 32'hF00DFACE;
      8'h18: _theResult____h4453 = rdat__h4579;
      default: _theResult____h4453 = 32'd0;
    endcase
  end
