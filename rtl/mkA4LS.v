...
//
// On Sat Jan 15 12:16:02 EST 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkA4LS(ACLK,
  ...
  wire [31 : 0] lastReadAddr$D_IN;
  wire lastReadAddr$EN;

  // register lastWriteAddr
  reg [31 : 0] lastWriteAddr;
  wire [31 : 0] lastWriteAddr$D_IN;
  wire lastWriteAddr$EN;
  ...
  reg [63 : 0] v__h4478, v__h4743, v__h4775;
  reg [31 : 0] _theResult____h4573;
  wire [31 : 0] rdat__h4693;
  ...
  // register lastReadAddr
  assign lastReadAddr$D_IN = a4l_a4rdAddr_fifof$D_OUT[31:0] ;
  assign lastReadAddr$EN = WILL_FIRE_RL_a4l_cfrd ;

  // register lastWriteAddr
  assign lastWriteAddr$D_IN = a4l_a4wrAddr_fifof$D_OUT[31:0] ;
  assign lastWriteAddr$EN = WILL_FIRE_RL_a4l_cfwr ;
  ...
  // remaining internal signals
  assign rdat__h4693 = { b1B, b1A, b19, b18 } ;
  always@(a4l_a4rdAddr_fifof$D_OUT or
	  lastReadAddr or r0 or r4 or rdat__h4693 or lastWriteAddr)
  begin
    case (a4l_a4rdAddr_fifof$D_OUT[7:0])
      8'h0: _theResult____h4573 = r0;
      8'h04: _theResult____h4573 = r4;
      8'h10: _theResult____h4573 = 32'hF00DFACE;
      8'h18: _theResult____h4573 = rdat__h4693;
      8'h20: _theResult____h4573 = lastWriteAddr;
      default: _theResult____h4573 = lastReadAddr;
    endcase
  end
  ...
  begin
	...
	if (lastReadAddr$EN)
	  lastReadAddr <= `BSV_ASSIGNMENT_DELAY lastReadAddr$D_IN;
	if (lastWriteAddr$EN)
	  lastWriteAddr <= `BSV_ASSIGNMENT_DELAY lastWriteAddr$D_IN;
