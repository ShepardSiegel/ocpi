...
//
// On Fri Jun 25 12:01:12 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker16B(wciS0_Clk,
  ...
  reg [63 : 0] v__h17446,
	       ...
	       v__h2816,
	       v__h3715;
  reg [31 : 0] x_data__h21534;
  reg CASE_wrtSerPos_0b1_0_1_1_1_2_1_3_0b1__q1,
      IF_wrtSerPos_28_EQ_0_29_OR_wrtSerPos_28_EQ_1_3_ETC___d914;
  wire [127 : 0] IF_wrtSerPos_28_EQ_2_31_THEN_0x0_ELSE_mesgWF_w_ETC___d371,
		 IF_wrtSerPos_28_EQ_2_31_THEN_0x0_ELSE_metaWF_f_ETC___d394,
		 mesg__h22102,
		 x1__h19699,
		 x1__h19708,
		 x1__h20222,
		 ...
		 x__h16045,
		 x__h19635;
  wire [35 : 0] addr__h20724, addr__h20896;
  wire [31 : 0] rdat__h21561,
		rdat__h21567,
		rdat__h21574,
		rdat__h21580,
		rdat__h21704,
		...
		rdat__h21808,
		v__h22476;
  wire [26 : 0] x__h20782, x__h20941;
  wire [23 : 0] x1_length__h17139, x__h21584;
  wire [15 : 0] x_byteEn__h22194;
  wire [13 : 0] mlp1__h17809, x__h17183;
  wire [12 : 0] x__h15009;
  wire [11 : 0] x_burstLength__h22193;
  wire [10 : 0] x__h15937;
  wire [7 : 0] x1_opcode__h17138;
  wire [1 : 0] wrtSerPos_28_PLUS_1___d1019;
  wire NOT_dlyWordsStored_value_26_SLE_0_81_82_AND_NO_ETC___d289,
       NOT_mesgRF_rRdPtr_69_PLUS_512_10_EQ_mesgRF_rWr_ETC___d225,
       NOT_wmemi_reqF_c_r_74_EQ_2_75_76_AND_NOT_wmemi_ETC___d308,
       NOT_wsiS_reqFifo_countReg_01_ULE_1_02___d703,
       _dor1bytesWritten$EN_write,
       metaRF_RDY_enq__58_AND_NOT_rdSerEmpty_13_14_AN_ETC___d259,
       metaWF_RDY_deq__75_AND_NOT_wrtSerPos_28_EQ_3_3_ETC___d382,
       wci_cState_9_EQ_2_0_AND_dlyCtrl_4_BITS_3_TO_0__ETC___d414;
  ...
  assign CAN_FIRE_RL_delay_read_req =
	     ...
	     wci_cState == 3'd2 &&
	     dlyCtrl[3:0] == 4'h7 &&
	     NOT_dlyWordsStored_value_26_SLE_0_81_82_AND_NO_ETC___d289 &&
  ...
  assign MUX_mesgLength$write_1__VAL_3 = { 1'd1, mlp1__h17809[9:0], 4'd0 } ;
  ...
  assign MUX_metaWF$enq_1__VAL_1 = { x1_opcode__h17138, x1_length__h17139 } ;
  ...
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_1 = { 4'd5, addr__h20724, 12'd1 } ;
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_2 = { 4'd3, addr__h20896, 12'd1 } ;
  assign MUX_rdSyncWord$write_1__VAL_2 =
	     rdSerPos != 2'd3 && v__h22476[23:0] == 24'd0 ;
  assign MUX_wsiM_reqFifo_x_wire$wset_1__VAL_1 =
	     { 3'd1,
	       unrollCnt == 16'd1,
	       1'd1,
	       x_burstLength__h22193,
	       mesg__h22102,
	       x_byteEn__h22194,
	       readMeta[31:24] } ;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_1 = { 2'd1, x_data__h21534 } ;
  ...
  always@(wrtSerPos or
	  IF_wrtSerPos_28_EQ_2_31_THEN_0x0_ELSE_mesgWF_w_ETC___d371 or
	  x1__h19699 or x1__h19708)
  begin
    case (wrtSerPos)
      2'd0: MUX_wide16Fa$enq_1__VAL_2 = x1__h19699;
      2'd1: MUX_wide16Fa$enq_1__VAL_2 = x1__h19708;
      default: MUX_wide16Fa$enq_1__VAL_2 =
		   IF_wrtSerPos_28_EQ_2_31_THEN_0x0_ELSE_mesgWF_w_ETC___d371;
    endcase
  end
  always@(wrtSerPos or
	  IF_wrtSerPos_28_EQ_2_31_THEN_0x0_ELSE_metaWF_f_ETC___d394 or
	  x1__h20222 or x1__h20231)
  begin
    case (wrtSerPos)
      2'd0: MUX_wide16Fa$enq_1__VAL_1 = x1__h20222;
      2'd1: MUX_wide16Fa$enq_1__VAL_1 = x1__h20231;
      default: MUX_wide16Fa$enq_1__VAL_1 =
		   IF_wrtSerPos_28_EQ_2_31_THEN_0x0_ELSE_metaWF_f_ETC___d394;
    endcase
  end
  assign MUX_wrtSerPos$write_1__VAL_1 =
	     (wrtSerUnroll == 16'd1) ? 2'd0 : wrtSerPos_28_PLUS_1___d1019 ;
  assign MUX_wrtSerPos$write_1__VAL_2 =
	     (metaWF$D_OUT[23:0] == 24'd0) ?
	       2'd0 :
	       wrtSerPos_28_PLUS_1___d1019 ;
  ...
  assign mesgRF_wDataIn$wget = { 96'd0, v__h22476 } ;
  ...
  assign mesgRF_rCache$D_IN = { 1'd1, mesgRF_rWrPtr, x__h16045 } ;

  // register mesgRF_rRdPtr
  assign mesgRF_rRdPtr$D_IN = x__h15937 ;
  ...
  // register mesgWF_rCache
  assign mesgWF_rCache$D_IN = { 1'd1, mesgWF_rWrPtr, x__h15117 } ;
  assign mesgWF_rCache$EN = mesgWF_pwEnqueue$whas ;

  // register mesgWF_rRdPtr
  assign mesgWF_rRdPtr$D_IN = x__h15009 ;
  ...
  assign wrtSerStage$D_IN =
	     MUX_wrtSerStage$write_1__SEL_1 ? x__h19635[31:0] : metaWF$D_OUT ;
  ...
  assign mesgRF_memory$DIA = x__h16045 ;
  ...
  assign mesgWF_memory$DIA = x__h15117 ;
  assign mesgWF_memory$ADDRB =
	     CAN_FIRE_RL_wrtSer_body ? x__h15009[11:0] : mesgWF_rRdPtr[11:0] ;
  ...
  // remaining internal signals
  assign IF_wrtSerPos_28_EQ_2_31_THEN_0x0_ELSE_mesgWF_w_ETC___d371 =
	     { (wrtSerPos == 2'd2) ? 32'h0 : x__h19635[31:0],
	       (wrtSerPos == 2'd2) ? x__h19635[31:0] : wrtSerStage_2,
	       wrtSerStage_1,
	       wrtSerStage } ;
  assign IF_wrtSerPos_28_EQ_2_31_THEN_0x0_ELSE_metaWF_f_ETC___d394 =
	     { (wrtSerPos == 2'd2) ? 32'h0 : metaWF$D_OUT,
	       (wrtSerPos == 2'd2) ? metaWF$D_OUT : wrtSerStage_2,
	       wrtSerStage_1,
	       wrtSerStage } ;
  assign NOT_dlyWordsStored_value_26_SLE_0_81_82_AND_NO_ETC___d289 =
	     (dlyWordsStored_value ^ 23'h400000) > 23'd4194304 &&
	     bytesWritten >= dlyHoldoffBytes &&
	     cyclesPassed >= dlyHoldoffCycles ;
  assign NOT_mesgRF_rRdPtr_69_PLUS_512_10_EQ_mesgRF_rWr_ETC___d225 =
	     mesgRF_rRdPtr + 11'd512 != mesgRF_rWrPtr &&
	     (!rdSerEmpty && rdSerPos != 2'd0 || wide16Fb$EMPTY_N) ;
  assign NOT_wmemi_reqF_c_r_74_EQ_2_75_76_AND_NOT_wmemi_ETC___d308 =
	     wmemi_reqF_c_r != 2'd2 && wmemi_dhF_c_r != 2'd2 &&
	     wmemi_operateD &&
	     wmemi_peerIsReady ;
  assign NOT_wsiS_reqFifo_countReg_01_ULE_1_02___d703 =
	     wsiS_reqFifo_countReg > 2'd1 ;
  assign _dor1bytesWritten$EN_write =
	     WILL_FIRE_RL_wmwt_messagePushPrecise ||
	     WILL_FIRE_RL_wmwt_messagePushImprecise ;
  assign addr__h20724 = { 9'd0, x__h20782 } ;
  assign addr__h20896 = { 9'd0, x__h20941 } ;
  assign mesg__h22102 = mesgRF_wDataOut$wget ;
  assign metaRF_RDY_enq__58_AND_NOT_rdSerEmpty_13_14_AN_ETC___d259 =
	     metaRF$FULL_N &&
	     (!rdSerEmpty && rdSerPos != 2'd0 || wide16Fb$EMPTY_N) ;
  assign metaWF_RDY_deq__75_AND_NOT_wrtSerPos_28_EQ_3_3_ETC___d382 =
	     metaWF$EMPTY_N &&
	     (wrtSerPos != 2'd3 && metaWF$D_OUT[23:0] != 24'd0 ||
	      IF_wrtSerPos_28_EQ_0_29_OR_wrtSerPos_28_EQ_1_3_ETC___d914) ;
  assign mlp1__h17809 = MUX_mesgLengthSoFar$write_1__VAL_2 ;
  assign rdat__h21561 = hasDebugLogic ? mesgWtCount : 32'd0 ;
  assign rdat__h21567 = hasDebugLogic ? mesgRdCount : 32'd0 ;
  assign rdat__h21574 = hasDebugLogic ? bytesWritten : 32'd0 ;
  assign rdat__h21580 = hasDebugLogic ? { 8'd0, x__h21584 } : 32'd0 ;
  assign rdat__h21704 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h21718 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h21726 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h21732 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h21746 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h21754 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h21760 = hasDebugLogic ? wmemiWrReq : 32'd0 ;
  assign rdat__h21766 = hasDebugLogic ? wmemiRdReq : 32'd0 ;
  assign rdat__h21772 = hasDebugLogic ? wmemiRdResp : 32'd0 ;
  assign rdat__h21778 =
	     hasDebugLogic ? { 9'd0, dlyWordsStored_value } : 32'd0 ;
  assign rdat__h21788 =
	     hasDebugLogic ? { 24'd0, dlyReadCredit_value } : 32'd0 ;
  assign rdat__h21798 = hasDebugLogic ? { 9'd0, dlyWAG } : 32'd0 ;
  assign rdat__h21808 = hasDebugLogic ? { 9'd0, dlyRAG } : 32'd0 ;
  assign v__h22476 = metaRF$D_IN ;
  assign wci_cState_9_EQ_2_0_AND_dlyCtrl_4_BITS_3_TO_0__ETC___d414 =
	     wci_cState == 3'd2 && dlyCtrl[3:0] == 4'h7 && mesgLength[14] &&
	     !doAbort &&
	     (preciseBurst && wsiWordsRemain == 12'd0 ||
	      impreciseBurst && endOfMessage) ;
  assign wrtSerPos_28_PLUS_1___d1019 = wrtSerPos + 2'd1 ;
  assign x1__h19699 = { 96'd0, x__h19635[31:0] } ;
  assign x1__h19708 = { 64'd0, x__h19635[31:0], wrtSerStage } ;
  assign x1__h20222 = { 96'd0, metaWF$D_OUT } ;
  assign x1__h20231 = { 64'd0, metaWF$D_OUT, wrtSerStage } ;
  assign x1_length__h17139 = { 10'd0, x__h17183 } ;
  assign x1_opcode__h17138 = opcode[8] ? opcode[7:0] : 8'd0 ;
  assign x__h15009 = mesgWF_rRdPtr + 13'd1 ;
  assign x__h15117 =
	     mesgWF_pwEnqueue$whas ? wsiS_reqFifo$D_OUT[151:24] : 128'd0 ;
  assign x__h15937 = mesgRF_rRdPtr + 11'd1 ;
  assign x__h16045 = CAN_FIRE_RL_rdSer_body ? mesgRF_wDataIn$wget : 128'd0 ;
  assign x__h17183 = mesgLength[14] ? mesgLength[13:0] : 14'd0 ;
  assign x__h19635 = mesgWF_wDataOut$wget ;
  assign x__h20782 = { dlyRAG, 4'h0 } ;
  assign x__h20941 = { dlyWAG, 4'h0 } ;
  assign x__h21584 = { wmemi_statusR, wsiS_statusR, wsiM_statusR } ;
  assign x_burstLength__h22193 =
	     (readMeta[23:0] == 24'd0) ? 12'd1 : readMeta[15:4] ;
  assign x_byteEn__h22194 = (readMeta[23:0] == 24'd0) ? 16'd0 : 16'd65535 ;
  always@(wci_reqF$D_OUT or
	  ...
	  rdat__h21766 or
	  rdat__h21772 or
	  rdat__h21778 or rdat__h21788 or rdat__h21798 or rdat__h21808)
  begin
    case (wci_reqF$D_OUT[51:32])
      20'h0: x_data__h21534 = dlyCtrl;
      20'h00004: x_data__h21534 = dlyHoldoffBytes;
      20'h00008: x_data__h21534 = dlyHoldoffCycles;
      20'h0000C: x_data__h21534 = rdat__h21561;
      20'h00010: x_data__h21534 = rdat__h21567;
      20'h00014: x_data__h21534 = rdat__h21574;
      20'h00018: x_data__h21534 = rdat__h21580;
      20'h0001C: x_data__h21534 = 32'd0;
      20'h00020: x_data__h21534 = rdat__h21704;
      20'h00024: x_data__h21534 = rdat__h21718;
      20'h00028: x_data__h21534 = rdat__h21726;
      20'h0002C: x_data__h21534 = rdat__h21732;
      20'h00030: x_data__h21534 = rdat__h21746;
      20'h00034: x_data__h21534 = rdat__h21754;
      20'h00038: x_data__h21534 = rdat__h21760;
      20'h0003C: x_data__h21534 = rdat__h21766;
      20'h00040: x_data__h21534 = rdat__h21772;
      20'h00044: x_data__h21534 = rdat__h21778;
      20'h00048: x_data__h21534 = rdat__h21788;
      20'h0004C: x_data__h21534 = rdat__h21798;
      20'h00050: x_data__h21534 = rdat__h21808;
      default: x_data__h21534 = 32'd0;
    endcase
  end
  ...
  begin
    ...
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wmwt_doAbort)
	$display("[%0d]: %m: wmwt_doAbort", v__h17662);
    if (wciS0_MReset_n)
