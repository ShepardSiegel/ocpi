...
//
// On Fri Oct 22 08:41:27 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker16B(wciS0_Clk,
  ...
  assign mesgRF$D_IN = { 96'd0, v__h20256 } ;
  ...
  assign x_byteEn__h19979 = (readMeta[23:0] == 24'd0) ? 16'd0 : 16'd65535 ;
  always@(wrtSerPos)
  begin
    case (wrtSerPos)
