...
//
// On Fri Jul 23 11:09:35 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker16B(wciS0_Clk,
  ...
  assign wsiS_wordCount$D_IN =
	     wsiS_wsiReq$wget[165] ? 12'd0 : wsiS_wordCount + 12'd1 ;
  ...
  assign mesgRF$D_IN = { 96'd0, v__h19693 } ;
  ...
  assign x__h14794 =
	     MUX_wsiS_reqFifo_levelsValid$write_1__SEL_3 ?
	       ...
	       128'd0 ;
  assign x__h16572 = { wsiS_wordCount[7:0], 4'd0 } ;
  ...
  assign x_byteEn__h19412 = (readMeta[23:0] == 24'd0) ? 16'd0 : 16'd65535 ;
