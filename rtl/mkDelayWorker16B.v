...
//
// On Sun Jun  6 11:14:42 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker16B(wciS0_Clk,
  ...
  reg [63 : 0] v__h17437,
	       ...
	       v__h2816,
	       v__h3715;
  reg [31 : 0] x_data__h21570;
  reg CASE_wrtSerPos_0b1_0_1_1_1_2_1_3_0b1__q1,
      IF_wrtSerPos_01_EQ_0_02_OR_wrtSerPos_01_EQ_1_0_ETC___d887;
  wire [127 : 0] IF_wrtSerPos_01_EQ_2_04_THEN_0x0_ELSE_mesgWF_w_ETC___d344,
		 IF_wrtSerPos_01_EQ_2_04_THEN_0x0_ELSE_metaWF_f_ETC___d367,
		 mesg__h22097,
		 x1__h19788,
		 x1__h19797,
		 x1__h20311,
		 ...
		 x__h16034,
		 x__h19724;
  wire [35 : 0] addr__h20789, addr__h20961;
  wire [31 : 0] rdat__h21614,
		rdat__h21823,
		rdat__h21831,
		rdat__h21839,
		rdat__h21847,
		v__h22478;
  wire [23 : 0] x1_length__h17130, x__h20847, x__h21006, x__h21617;
  wire [15 : 0] x_byteEn__h22189;
  wire [13 : 0] mlp1__h17829, x__h17174;
  wire [11 : 0] x_burstLength__h22188;
  wire [10 : 0] x__h15000, x__h15926;
  wire [7 : 0] x1_opcode__h17129;
  wire [1 : 0] wrtSerPos_01_PLUS_1___d998;
  wire NOT_mesgRF_rRdPtr_49_PLUS_512_93_EQ_mesgRF_rWr_ETC___d208,
       NOT_wmemi_reqF_c_r_57_EQ_2_58_59_AND_NOT_wmemi_ETC___d284,
       NOT_wsiS_reqFifo_countReg_82_ULE_1_83___d684,
       _dor1bytesWritten$EN_write,
       metaRF_RDY_enq__41_AND_NOT_rdSerEmpty_96_97_AN_ETC___d242,
       metaWF_RDY_deq__48_AND_NOT_wrtSerPos_01_EQ_3_0_ETC___d355,
       wci_cState_9_EQ_2_0_AND_dlyCtrl_4_BITS_3_TO_0__ETC___d184,
       wci_cState_9_EQ_2_0_AND_dlyCtrl_4_BITS_3_TO_0__ETC___d387;
  ...
  assign MUX_mesgLength$write_1__VAL_3 = { 1'd1, mlp1__h17829[9:0], 4'd0 } ;
  ...
  assign MUX_metaWF$enq_1__VAL_2 = { x1_opcode__h17129, x1_length__h17130 } ;
  ...
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_1 = { 4'd5, addr__h20789, 12'd1 } ;
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_2 = { 4'd3, addr__h20961, 12'd1 } ;
  assign MUX_wci_respF_x_wire$wset_1__VAL_1 = { 2'd1, x_data__h21570 } ;
  ...
  assign MUX_rdSyncWord$write_1__VAL_2 =
	     rdSerPos != 2'd3 && v__h22478[23:0] == 24'd0 ;
  assign MUX_wsiM_reqFifo_x_wire$wset_1__VAL_1 =
	     { 3'd1,
	       unrollCnt == 16'd1,
	       1'd1,
	       x_burstLength__h22188,
	       mesg__h22097,
	       x_byteEn__h22189,
	       readMeta[31:24] } ;
  ...
  always@(wrtSerPos or
	  IF_wrtSerPos_01_EQ_2_04_THEN_0x0_ELSE_mesgWF_w_ETC___d344 or
	  x1__h19788 or x1__h19797)
  begin
    case (wrtSerPos)
      2'd0: MUX_wide16Fa$enq_1__VAL_2 = x1__h19788;
      2'd1: MUX_wide16Fa$enq_1__VAL_2 = x1__h19797;
      default: MUX_wide16Fa$enq_1__VAL_2 =
		   IF_wrtSerPos_01_EQ_2_04_THEN_0x0_ELSE_mesgWF_w_ETC___d344;
    endcase
  end
  always@(wrtSerPos or
	  IF_wrtSerPos_01_EQ_2_04_THEN_0x0_ELSE_metaWF_f_ETC___d367 or
	  x1__h20311 or x1__h20320)
  begin
    case (wrtSerPos)
      2'd0: MUX_wide16Fa$enq_1__VAL_1 = x1__h20311;
      2'd1: MUX_wide16Fa$enq_1__VAL_1 = x1__h20320;
      default: MUX_wide16Fa$enq_1__VAL_1 =
		   IF_wrtSerPos_01_EQ_2_04_THEN_0x0_ELSE_metaWF_f_ETC___d367;
    endcase
  end
  assign MUX_wrtSerPos$write_1__VAL_1 =
	     (wrtSerUnroll == 16'd1) ? 2'd0 : wrtSerPos_01_PLUS_1___d998 ;
  assign MUX_wrtSerPos$write_1__VAL_2 =
	     (metaWF$D_OUT[23:0] == 24'd0) ?
	       2'd0 :
	       wrtSerPos_01_PLUS_1___d998 ;
  ...
  assign mesgRF_wDataIn$wget = { 96'd0, v__h22478 } ;
  ...
  assign wrtSerStage$D_IN =
	     MUX_wrtSerStage$write_1__SEL_1 ? x__h19724[31:0] : metaWF$D_OUT ;
  ...
  // remaining internal signals
  assign IF_wrtSerPos_01_EQ_2_04_THEN_0x0_ELSE_mesgWF_w_ETC___d344 =
	     { (wrtSerPos == 2'd2) ? 32'h0 : x__h19724[31:0],
	       (wrtSerPos == 2'd2) ? x__h19724[31:0] : wrtSerStage_2,
	       wrtSerStage_1,
	       wrtSerStage } ;
  assign IF_wrtSerPos_01_EQ_2_04_THEN_0x0_ELSE_metaWF_f_ETC___d367 =
  ...
  assign NOT_wmemi_reqF_c_r_57_EQ_2_58_59_AND_NOT_wmemi_ETC___d284 =
	     wmemi_reqF_c_r != 2'd2 && wmemi_dhF_c_r != 2'd2 &&
	     wmemi_operateD &&
	     wmemi_peerIsReady ;
  assign NOT_wsiS_reqFifo_countReg_82_ULE_1_83___d684 =
	     wsiS_reqFifo_countReg > 2'd1 ;
  assign _dor1bytesWritten$EN_write =
	     WILL_FIRE_RL_wmwt_messagePushPrecise ||
	     WILL_FIRE_RL_wmwt_messagePushImprecise ;
  assign addr__h20789 = { 12'd0, x__h20847 } ;
  assign addr__h20961 = { 12'd0, x__h21006 } ;
  assign mesg__h22097 = mesgRF_wDataOut$wget ;
  assign metaRF_RDY_enq__41_AND_NOT_rdSerEmpty_96_97_AN_ETC___d242 =
	     metaRF$FULL_N &&
	     (!rdSerEmpty && rdSerPos != 2'd0 || wide16Fb$EMPTY_N) ;
  assign metaWF_RDY_deq__48_AND_NOT_wrtSerPos_01_EQ_3_0_ETC___d355 =
	     metaWF$EMPTY_N &&
	     (wrtSerPos != 2'd3 && metaWF$D_OUT[23:0] != 24'd0 ||
	      IF_wrtSerPos_01_EQ_0_02_OR_wrtSerPos_01_EQ_1_0_ETC___d887) ;
  assign mlp1__h17829 = MUX_mesgLengthSoFar$write_1__VAL_2 ;
  assign rdat__h21614 = { 8'd0, x__h21617 } ;
  assign rdat__h21823 = { 12'd0, dlyWordsStored_value } ;
  assign rdat__h21831 = { 24'd0, dlyReadCredit_value } ;
  assign rdat__h21839 = { 12'd0, dlyWAG } ;
  assign rdat__h21847 = { 12'd0, dlyRAG } ;
  assign v__h22478 = metaRF$D_IN ;
  assign wci_cState_9_EQ_2_0_AND_dlyCtrl_4_BITS_3_TO_0__ETC___d184 =
	     wci_cState == 3'd2 && dlyCtrl[3:0] == 4'h7 &&
	     unrollCnt == 16'd0 &&
	     bytesWritten > dlyHoldoff ;
  assign wci_cState_9_EQ_2_0_AND_dlyCtrl_4_BITS_3_TO_0__ETC___d387 =
	     wci_cState == 3'd2 && dlyCtrl[3:0] == 4'h7 && mesgLength[14] &&
	     !doAbort &&
	     (preciseBurst && wsiWordsRemain == 12'd0 ||
	      impreciseBurst && endOfMessage) ;
  assign wrtSerPos_01_PLUS_1___d998 = wrtSerPos + 2'd1 ;
  assign x1__h19788 = { 96'd0, x__h19724[31:0] } ;
  assign x1__h19797 = { 64'd0, x__h19724[31:0], wrtSerStage } ;
  assign x1__h20311 = { 96'd0, metaWF$D_OUT } ;
  assign x1__h20320 = { 64'd0, metaWF$D_OUT, wrtSerStage } ;
  ...
  assign x__h16034 = CAN_FIRE_RL_rdSer_body ? mesgRF_wDataIn$wget : 128'd0 ;
  assign x__h17174 = mesgLength[14] ? mesgLength[13:0] : 14'd0 ;
  assign x__h19724 = mesgWF_wDataOut$wget ;
  assign x__h20847 = { dlyRAG, 4'h0 } ;
  assign x__h21006 = { dlyWAG, 4'h0 } ;
  assign x__h21617 = { wmemi_statusR, wsiS_statusR, wsiM_statusR } ;
  assign x_burstLength__h22188 =
	     (readMeta[23:0] == 24'd0) ? 12'd1 : readMeta[15:4] ;
  assign x_byteEn__h22189 = (readMeta[23:0] == 24'd0) ? 16'd0 : 16'd65535 ;
  always@(wci_reqF$D_OUT or
	  ...
	  wmemiRdReq or
	  wmemiRdResp or
	  rdat__h21823 or rdat__h21831 or rdat__h21839 or rdat__h21847)
  begin
    case (wci_reqF$D_OUT[51:32])
      20'h0: x_data__h21570 = dlyCtrl;
      20'h00004: x_data__h21570 = dlyHoldoff;
      20'h00008: x_data__h21570 = mesgWtCount;
      20'h0000C: x_data__h21570 = mesgRdCount;
      20'h00010: x_data__h21570 = bytesWritten;
      20'h00014: x_data__h21570 = 32'd0;
      20'h00018: x_data__h21570 = rdat__h21614;
      20'h00020: x_data__h21570 = wsiS_extStatusW$wget[95:64];
      20'h00024: x_data__h21570 = wsiS_extStatusW$wget[63:32];
      20'h00028: x_data__h21570 = wsiS_extStatusW$wget[31:0];
      20'h0002C: x_data__h21570 = wsiM_extStatusW$wget[95:64];
      20'h00030: x_data__h21570 = wsiM_extStatusW$wget[63:32];
      20'h00034: x_data__h21570 = wsiM_extStatusW$wget[31:0];
      20'h00038: x_data__h21570 = wmemiWrReq;
      20'h0003C: x_data__h21570 = wmemiRdReq;
      20'h00040: x_data__h21570 = wmemiRdResp;
      20'h00044: x_data__h21570 = rdat__h21823;
      20'h00048: x_data__h21570 = rdat__h21831;
      20'h0004C: x_data__h21570 = rdat__h21839;
      20'h00050: x_data__h21570 = rdat__h21847;
      default: x_data__h21570 = 32'd0;
    endcase
  end
