...
//
// On Thu Jun 17 09:01:15 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker16B(wciS0_Clk,
  ...
  reg CASE_wrtSerPos_0b1_0_1_1_1_2_1_3_0b1__q1,
      IF_wrtSerPos_11_EQ_0_12_OR_wrtSerPos_11_EQ_1_1_ETC___d898;
  ...
  wire [31 : 0] rdat__h21847,
		...
		rdat__h22054,
		v__h22720;
  wire [26 : 0] x__h21052, x__h21211;
  wire [23 : 0] x1_length__h17254, x__h21850;
  wire [15 : 0] x_byteEn__h22438;
  wire [13 : 0] mlp1__h17953, x__h17298;
  wire [11 : 0] x_burstLength__h22437;
  wire [10 : 0] x__h15126, x__h16052;
  wire [7 : 0] x1_opcode__h17253;
  wire [1 : 0] wrtSerPos_11_PLUS_1___d1015;
  ...
  assign MUX_mesgLength$write_1__VAL_3 = { 1'd1, mlp1__h17953[9:0], 4'd0 } ;
  ...
  assign MUX_metaWF$enq_1__VAL_2 = { x1_opcode__h17253, x1_length__h17254 } ;
  ...
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_1 = { 4'd5, addr__h20994, 12'd1 } ;
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_2 = { 4'd3, addr__h21166, 12'd1 } ;
  assign MUX_wci_respF_x_wire$wset_1__VAL_1 = { 2'd1, x_data__h21804 } ;
  ...
  assign MUX_rdSyncWord$write_1__VAL_2 =
	     rdSerPos != 2'd3 && v__h22720[23:0] == 24'd0 ;
  ...
  begin
    case (wrtSerPos)
      2'd0: MUX_wide16Fa$enq_1__VAL_2 = x1__h19969;
      2'd1: MUX_wide16Fa$enq_1__VAL_2 = x1__h19978;
  ...
  begin
    case (wrtSerPos)
      2'd0: MUX_wide16Fa$enq_1__VAL_1 = x1__h20492;
      2'd1: MUX_wide16Fa$enq_1__VAL_1 = x1__h20501;
      default: MUX_wide16Fa$enq_1__VAL_1 =
		   IF_wrtSerPos_11_EQ_2_14_THEN_0x0_ELSE_metaWF_f_ETC___d377;
    endcase
  end
  assign MUX_wrtSerPos$write_1__VAL_1 =
	     (wrtSerUnroll == 16'd1) ? 2'd0 : wrtSerPos_11_PLUS_1___d1015 ;
  assign MUX_wrtSerPos$write_1__VAL_2 =
	     (metaWF$D_OUT[23:0] == 24'd0) ?
	       2'd0 :
	       wrtSerPos_11_PLUS_1___d1015 ;
  ...
  assign mesgRF_wDataIn$wget = { 96'd0, v__h22720 } ;
  ...
  assign wrtSerStage$D_IN =
	     MUX_wrtSerStage$write_1__SEL_1 ? x__h19905[31:0] : metaWF$D_OUT ;
  ...
  assign IF_wrtSerPos_11_EQ_2_14_THEN_0x0_ELSE_mesgWF_w_ETC___d354 =
	     { (wrtSerPos == 2'd2) ? 32'h0 : x__h19905[31:0],
	       (wrtSerPos == 2'd2) ? x__h19905[31:0] : wrtSerStage_2,
	       wrtSerStage_1,
	       wrtSerStage } ;
  ...
  assign _dor1bytesWritten$EN_write =
	     WILL_FIRE_RL_wmwt_messagePushPrecise ||
	     WILL_FIRE_RL_wmwt_messagePushImprecise ;
  assign addr__h20994 = { 9'd0, x__h21052 } ;
  assign addr__h21166 = { 9'd0, x__h21211 } ;
  assign mesg__h22346 = mesgRF_wDataOut$wget ;
  ...
  assign rdat__h21847 = { 8'd0, x__h21850 } ;
  assign rdat__h22030 = { 9'd0, dlyWordsStored_value } ;
  assign rdat__h22038 = { 24'd0, dlyReadCredit_value } ;
  assign rdat__h22046 = { 9'd0, dlyWAG } ;
  assign rdat__h22054 = { 9'd0, dlyRAG } ;
  assign v__h22720 = rdSerMeta$D_IN ;
  ...
  assign wrtSerPos_11_PLUS_1___d1015 = wrtSerPos + 2'd1 ;
  assign x1__h19969 = { 96'd0, x__h19905[31:0] } ;
  assign x1__h19978 = { 64'd0, x__h19905[31:0], wrtSerStage } ;
  assign x1__h20492 = { 96'd0, metaWF$D_OUT } ;
  assign x1__h20501 = { 64'd0, metaWF$D_OUT, wrtSerStage } ;
  ...
  assign x__h19905 = mesgWF_wDataOut$wget ;
  ...
  assign x_byteEn__h22438 = (readMeta[23:0] == 24'd0) ? 16'd0 : 16'd65535 ;
  ...
  begin
    case (wci_reqF$D_OUT[51:32])
      ...
      20'h0001C: x_data__h21804 = 32'd0;
      20'h00020: x_data__h21804 = wsiS_extStatusW$wget[95:64];
      20'h00024: x_data__h21804 = wsiS_extStatusW$wget[63:32];
      20'h00028: x_data__h21804 = wsiS_extStatusW$wget[31:0];
      20'h0002C: x_data__h21804 = wsiM_extStatusW$wget[95:64];
      20'h00030: x_data__h21804 = wsiM_extStatusW$wget[63:32];
      20'h00034: x_data__h21804 = wsiM_extStatusW$wget[31:0];
