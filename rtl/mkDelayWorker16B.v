...
//
// On Tue Jul  6 08:21:08 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker16B(wciS0_Clk,
  ...
  assign MUX_mesgLength$write_1__VAL_3 = { 1'd1, mlp1__h17012[9:0], 4'd0 } ;
  ...
  assign mesgRF$D_IN = { 96'd0, v__h21675 } ;
  ...
  assign x_byteEn__h21395 = (readMeta[23:0] == 24'd0) ? 16'd0 : 16'd65535 ;
