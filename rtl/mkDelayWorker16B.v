...
//
// On Tue Dec 28 16:50:31 EST 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker16B(wciS0_Clk,
  ...
  assign wrtSerStage$D_IN =
	     MUX_wrtSerStage$write_1__SEL_1 ? x__h18599[31:0] : metaWF$D_OUT ;
  ...
  // submodule mesgRF
  assign mesgRF$D_IN = { 96'd0, v__h19821 } ;
  ...
  assign IF_wrtSerPos_82_EQ_2_92_THEN_0x0_ELSE_mesgWF_w_ETC___d550 =
	     { (wrtSerPos == 2'd2) ? 32'h0 : x__h18599[31:0],
	       (wrtSerPos == 2'd2) ? x__h18599[31:0] : wrtSerStage_2,
	       wrtSerStage_1,
	       wrtSerStage } ;
  ...
  assign x__h18599 = mesgWF_wDataOut$wget ;
  assign x__h18732 = { 96'd0, x__h18599[31:0] } ;
  assign x__h18756 = { 64'd0, x__h18599[31:0], wrtSerStage } ;
  ...
  assign x_byteEn__h21694 = (readMeta[23:0] == 24'd0) ? 16'd0 : 16'd65535 ;
  always@(rdSerPos or
