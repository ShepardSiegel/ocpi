...
//
// On Mon Jun  7 12:26:38 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker16B(wciS0_Clk,
  ...
  reg [63 : 0] v__h17563,
	       ...
	       v__h2817,
	       v__h3716;
  reg [31 : 0] x_data__h21806;
  reg CASE_wrtSerPos_0b1_0_1_1_1_2_1_3_0b1__q1,
      IF_wrtSerPos_09_EQ_0_10_OR_wrtSerPos_09_EQ_1_1_ETC___d978;
  wire [127 : 0] IF_wrtSerPos_09_EQ_2_12_THEN_0x0_ELSE_mesgWF_w_ETC___d352,
		 IF_wrtSerPos_09_EQ_2_12_THEN_0x0_ELSE_metaWF_f_ETC___d375,
		 mesg__h22342,
		 x1__h19971,
		 x1__h19980,
		 x1__h20494,
		 ...
		 x__h16160,
		 x__h19907;
  wire [35 : 0] addr__h20996, addr__h21168;
  wire [31 : 0] rdat__h21849,
		rdat__h22027,
		rdat__h22035,
		rdat__h22043,
		rdat__h22051,
		v__h22716;
  wire [23 : 0] x1_length__h17256, x__h21054, x__h21213, x__h21852;
  wire [15 : 0] x_byteEn__h22434;
  wire [13 : 0] mlp1__h17955, x__h17300;
  wire [11 : 0] x_burstLength__h22433;
  wire [10 : 0] x__h15126, x__h16052;
  wire [7 : 0] x1_opcode__h17255;
  wire [1 : 0] wrtSerPos_09_PLUS_1___d1012;
  wire NOT_dlyWordsStored_value_12_SLE_0_62_63_AND_NO_ETC___d270,
       NOT_mesgRF_rRdPtr_50_PLUS_512_91_EQ_mesgRF_rWr_ETC___d206,
       NOT_wsiS_reqFifo_countReg_94_ULE_1_95___d696,
       _dor1bytesWritten$EN_write,
       metaRF_RDY_enq__39_AND_NOT_rdSerEmpty_94_95_AN_ETC___d240,
       metaWF_RDY_deq__56_AND_NOT_wrtSerPos_09_EQ_3_1_ETC___d363,
  ...
  assign CAN_FIRE_RL_delay_read_req =
	     ...
	     wci_cState == 3'd2 &&
	     dlyCtrl[3:0] == 4'h7 &&
	     NOT_dlyWordsStored_value_12_SLE_0_62_63_AND_NO_ETC___d270 &&
  ...
  assign MUX_mesgLength$write_1__VAL_3 = { 1'd1, mlp1__h17955[9:0], 4'd0 } ;
  ...
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_1 = { 4'd5, addr__h20996, 12'd1 } ;
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_2 = { 4'd3, addr__h21168, 12'd1 } ;
  assign MUX_wci_respF_x_wire$wset_1__VAL_1 = { 2'd1, x_data__h21806 } ;
  ...
  assign MUX_rdSyncWord$write_1__VAL_2 =
	     rdSerPos != 2'd3 && v__h22716[23:0] == 24'd0 ;
  assign MUX_wsiM_reqFifo_x_wire$wset_1__VAL_1 =
	     { 3'd1,
	       unrollCnt == 16'd1,
	       1'd1,
	       x_burstLength__h22433,
	       mesg__h22342,
	       x_byteEn__h22434,
	       readMeta[31:24] } ;
  ...
  always@(wrtSerPos or
	  IF_wrtSerPos_09_EQ_2_12_THEN_0x0_ELSE_mesgWF_w_ETC___d352 or
	  x1__h19971 or x1__h19980)
  begin
    case (wrtSerPos)
      2'd0: MUX_wide16Fa$enq_1__VAL_2 = x1__h19971;
      2'd1: MUX_wide16Fa$enq_1__VAL_2 = x1__h19980;
      default: MUX_wide16Fa$enq_1__VAL_2 =
		   IF_wrtSerPos_09_EQ_2_12_THEN_0x0_ELSE_mesgWF_w_ETC___d352;
    endcase
  end
  always@(wrtSerPos or
	  IF_wrtSerPos_09_EQ_2_12_THEN_0x0_ELSE_metaWF_f_ETC___d375 or
	  x1__h20494 or x1__h20503)
  begin
    case (wrtSerPos)
      2'd0: MUX_wide16Fa$enq_1__VAL_1 = x1__h20494;
      2'd1: MUX_wide16Fa$enq_1__VAL_1 = x1__h20503;
      default: MUX_wide16Fa$enq_1__VAL_1 =
		   IF_wrtSerPos_09_EQ_2_12_THEN_0x0_ELSE_metaWF_f_ETC___d375;
    endcase
  end
  assign MUX_wrtSerPos$write_1__VAL_1 =
	     (wrtSerUnroll == 16'd1) ? 2'd0 : wrtSerPos_09_PLUS_1___d1012 ;
  assign MUX_wrtSerPos$write_1__VAL_2 =
	     (metaWF$D_OUT[23:0] == 24'd0) ?
	       2'd0 :
	       wrtSerPos_09_PLUS_1___d1012 ;
  ...
  assign mesgRF_wDataIn$wget = { 96'd0, v__h22716 } ;
  ...
  assign wrtSerStage$D_IN =
	     MUX_wrtSerStage$write_1__SEL_1 ? x__h19907[31:0] : metaWF$D_OUT ;
  ...
  // remaining internal signals
  assign IF_wrtSerPos_09_EQ_2_12_THEN_0x0_ELSE_mesgWF_w_ETC___d352 =
	     { (wrtSerPos == 2'd2) ? 32'h0 : x__h19907[31:0],
	       (wrtSerPos == 2'd2) ? x__h19907[31:0] : wrtSerStage_2,
	       wrtSerStage_1,
	       wrtSerStage } ;
  assign IF_wrtSerPos_09_EQ_2_12_THEN_0x0_ELSE_metaWF_f_ETC___d375 =
	     { (wrtSerPos == 2'd2) ? 32'h0 : metaWF$D_OUT,
	       (wrtSerPos == 2'd2) ? metaWF$D_OUT : wrtSerStage_2,
	       wrtSerStage_1,
	       wrtSerStage } ;
  assign NOT_dlyWordsStored_value_12_SLE_0_62_63_AND_NO_ETC___d270 =
  ...
  assign NOT_wsiS_reqFifo_countReg_94_ULE_1_95___d696 =
	     wsiS_reqFifo_countReg > 2'd1 ;
  assign _dor1bytesWritten$EN_write =
	     WILL_FIRE_RL_wmwt_messagePushPrecise ||
	     WILL_FIRE_RL_wmwt_messagePushImprecise ;
  assign addr__h20996 = { 12'd0, x__h21054 } ;
  assign addr__h21168 = { 12'd0, x__h21213 } ;
  assign mesg__h22342 = mesgRF_wDataOut$wget ;
  assign metaRF_RDY_enq__39_AND_NOT_rdSerEmpty_94_95_AN_ETC___d240 =
	     metaRF$FULL_N &&
	     (!rdSerEmpty && rdSerPos != 2'd0 || wide16Fb$EMPTY_N) ;
  assign metaWF_RDY_deq__56_AND_NOT_wrtSerPos_09_EQ_3_1_ETC___d363 =
	     metaWF$EMPTY_N &&
	     (wrtSerPos != 2'd3 && metaWF$D_OUT[23:0] != 24'd0 ||
	      IF_wrtSerPos_09_EQ_0_10_OR_wrtSerPos_09_EQ_1_1_ETC___d978) ;
  assign mlp1__h17955 = mesgLengthSoFar + 14'd1 ;
  assign rdat__h21849 = { 8'd0, x__h21852 } ;
  assign rdat__h22027 = { 12'd0, dlyWordsStored_value } ;
  assign rdat__h22035 = { 24'd0, dlyReadCredit_value } ;
  assign rdat__h22043 = { 12'd0, dlyWAG } ;
  assign rdat__h22051 = { 12'd0, dlyRAG } ;
  assign v__h22716 = metaRF$D_IN ;
  ...
  assign wrtSerPos_09_PLUS_1___d1012 = wrtSerPos + 2'd1 ;
  assign x1__h19971 = { 96'd0, x__h19907[31:0] } ;
  assign x1__h19980 = { 64'd0, x__h19907[31:0], wrtSerStage } ;
  assign x1__h20494 = { 96'd0, metaWF$D_OUT } ;
  assign x1__h20503 = { 64'd0, metaWF$D_OUT, wrtSerStage } ;
  ...
  assign x__h16160 = CAN_FIRE_RL_rdSer_body ? mesgRF_wDataIn$wget : 128'd0 ;
  assign x__h17300 = mesgLength[14] ? mesgLength[13:0] : 14'd0 ;
  assign x__h19907 = mesgWF_wDataOut$wget ;
  assign x__h21054 = { dlyRAG, 4'h0 } ;
  assign x__h21213 = { dlyWAG, 4'h0 } ;
  assign x__h21852 = { wmemi_statusR, wsiS_statusR, wsiM_statusR } ;
  assign x_burstLength__h22433 =
	     (readMeta[23:0] == 24'd0) ? 12'd1 : readMeta[15:4] ;
  assign x_byteEn__h22434 = (readMeta[23:0] == 24'd0) ? 16'd0 : 16'd65535 ;
  always@(wci_reqF$D_OUT or
	  ...
	  wmemiRdReq or
	  wmemiRdResp or
	  rdat__h22027 or rdat__h22035 or rdat__h22043 or rdat__h22051)
  begin
    case (wci_reqF$D_OUT[51:32])
      20'h0: x_data__h21806 = dlyCtrl;
      20'h00004: x_data__h21806 = dlyHoldoffBytes;
      20'h00008: x_data__h21806 = dlyHoldoffCycles;
      20'h0000C: x_data__h21806 = mesgWtCount;
      20'h00010: x_data__h21806 = mesgRdCount;
      20'h00014: x_data__h21806 = bytesWritten;
      20'h00018: x_data__h21806 = rdat__h21849;
      20'h00020: x_data__h21806 = wsiS_extStatusW$wget[95:64];
      20'h00024: x_data__h21806 = wsiS_extStatusW$wget[63:32];
      20'h00028: x_data__h21806 = wsiS_extStatusW$wget[31:0];
      20'h0002C: x_data__h21806 = wsiM_extStatusW$wget[95:64];
      20'h00030: x_data__h21806 = wsiM_extStatusW$wget[63:32];
      20'h00034: x_data__h21806 = wsiM_extStatusW$wget[31:0];
      20'h00038: x_data__h21806 = wmemiWrReq;
      20'h0003C: x_data__h21806 = wmemiRdReq;
      20'h00040: x_data__h21806 = wmemiRdResp;
      20'h00044: x_data__h21806 = rdat__h22027;
      20'h00048: x_data__h21806 = rdat__h22035;
      20'h0004C: x_data__h21806 = rdat__h22043;
      20'h00050: x_data__h21806 = rdat__h22051;
      default: x_data__h21806 = 32'd0;
    endcase
  end
