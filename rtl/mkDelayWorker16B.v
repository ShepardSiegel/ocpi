...
//
// On Thu Jun 17 14:44:34 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker16B(wciS0_Clk,
  ...
  reg [140 : 0] mesgWF_rCache;
  wire [140 : 0] mesgWF_rCache$D_IN;
  ...
  reg [63 : 0] v__h17565,
	       ...
	       v__h2817,
	       v__h3716;
  reg [31 : 0] x_data__h21808;
  reg CASE_wrtSerPos_0b1_0_1_1_1_2_1_3_0b1__q1,
      IF_wrtSerPos_11_EQ_0_12_OR_wrtSerPos_11_EQ_1_1_ETC___d897;
  wire [127 : 0] IF_wrtSerPos_11_EQ_2_14_THEN_0x0_ELSE_mesgWF_w_ETC___d354,
		 ...
		 x__h16164,
		 x__h19909;
  wire [35 : 0] addr__h20998, addr__h21170;
  wire [31 : 0] rdat__h21851,
		rdat__h22034,
		rdat__h22042,
		rdat__h22050,
		rdat__h22058,
		v__h22724;
  wire [26 : 0] x__h21056, x__h21215;
  wire [23 : 0] x1_length__h17258, x__h21854;
  wire [15 : 0] x_byteEn__h22442;
  wire [13 : 0] mlp1__h17957, x__h17302;
  wire [11 : 0] x__h15129, x_burstLength__h22441;
  wire [10 : 0] x__h16056;
  ...
  assign MUX_mesgLength$write_1__VAL_3 = { 1'd1, mlp1__h17957[9:0], 4'd0 } ;
  ...
  assign MUX_metaWF$enq_1__VAL_2 = { x1_opcode__h17257, x1_length__h17258 } ;
  ...
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_1 = { 4'd5, addr__h20998, 12'd1 } ;
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_2 = { 4'd3, addr__h21170, 12'd1 } ;
  assign MUX_wci_respF_x_wire$wset_1__VAL_1 = { 2'd1, x_data__h21808 } ;
  ...
  assign MUX_rdSyncWord$write_1__VAL_2 =
	     rdSerPos != 2'd3 && v__h22724[23:0] == 24'd0 ;
  assign MUX_wsiM_reqFifo_x_wire$wset_1__VAL_1 =
	     { 3'd1,
	       unrollCnt == 16'd1,
	       1'd1,
	       x_burstLength__h22441,
	       mesg__h22350,
	       x_byteEn__h22442,
	       readMeta[31:24] } ;
  ...
  always@(wrtSerPos or
	  ...
	  x1__h19973 or x1__h19982)
  begin
    case (wrtSerPos)
      2'd0: MUX_wide16Fa$enq_1__VAL_2 = x1__h19973;
      2'd1: MUX_wide16Fa$enq_1__VAL_2 = x1__h19982;
  ...
  always@(wrtSerPos or
	  ...
	  x1__h20496 or x1__h20505)
  begin
    case (wrtSerPos)
      2'd0: MUX_wide16Fa$enq_1__VAL_1 = x1__h20496;
      2'd1: MUX_wide16Fa$enq_1__VAL_1 = x1__h20505;
      default: MUX_wide16Fa$enq_1__VAL_1 =
		   IF_wrtSerPos_11_EQ_2_14_THEN_0x0_ELSE_metaWF_f_ETC___d377;
    endcase
  end
  assign MUX_wrtSerPos$write_1__VAL_1 =
	     (wrtSerUnroll == 16'd1) ? 2'd0 : wrtSerPos_11_PLUS_1___d1014 ;
  ...
  assign mesgWF_wDataOut$wget =
	     (mesgWF_rCache[140] && mesgWF_rCache[139:128] == mesgWF_rRdPtr) ?
	       mesgWF_rCache[127:0] :
	       mesgWF_memory$DOB ;
  ...
  assign mesgRF_wDataIn$wget = { 96'd0, v__h22724 } ;
  ...
  begin
    case (rdSerPos)
      2'd0: rdSerMeta$D_IN = wide16Fb$D_OUT[31:0];
  ...
  assign wrtSerStage$D_IN =
	     MUX_wrtSerStage$write_1__SEL_1 ? x__h19909[31:0] : metaWF$D_OUT ;
  ...
  assign IF_wrtSerPos_11_EQ_2_14_THEN_0x0_ELSE_mesgWF_w_ETC___d354 =
	     { (wrtSerPos == 2'd2) ? 32'h0 : x__h19909[31:0],
	       (wrtSerPos == 2'd2) ? x__h19909[31:0] : wrtSerStage_2,
	       wrtSerStage_1,
	       wrtSerStage } ;
  ...
  assign _dor1bytesWritten$EN_write =
	     WILL_FIRE_RL_wmwt_messagePushPrecise ||
	     WILL_FIRE_RL_wmwt_messagePushImprecise ;
  assign addr__h20998 = { 9'd0, x__h21056 } ;
  assign addr__h21170 = { 9'd0, x__h21215 } ;
  assign mesg__h22350 = mesgRF_wDataOut$wget ;
  ...
  assign rdat__h21851 = { 8'd0, x__h21854 } ;
  assign rdat__h22034 = { 9'd0, dlyWordsStored_value } ;
  assign rdat__h22042 = { 24'd0, dlyReadCredit_value } ;
  assign rdat__h22050 = { 9'd0, dlyWAG } ;
  assign rdat__h22058 = { 9'd0, dlyRAG } ;
  assign v__h22724 = rdSerMeta$D_IN ;
  ...
  assign wrtSerPos_11_PLUS_1___d1014 = wrtSerPos + 2'd1 ;
  assign x1__h19973 = { 96'd0, x__h19909[31:0] } ;
  assign x1__h19982 = { 64'd0, x__h19909[31:0], wrtSerStage } ;
  assign x1__h20496 = { 96'd0, metaWF$D_OUT } ;
  assign x1__h20505 = { 64'd0, metaWF$D_OUT, wrtSerStage } ;
  ...
  assign x__h16164 = CAN_FIRE_RL_rdSer_body ? mesgRF_wDataIn$wget : 128'd0 ;
  assign x__h17302 = mesgLength[14] ? mesgLength[13:0] : 14'd0 ;
  assign x__h19909 = mesgWF_wDataOut$wget ;
  assign x__h21056 = { dlyRAG, 4'h0 } ;
  assign x__h21215 = { dlyWAG, 4'h0 } ;
  assign x__h21854 = { wmemi_statusR, wsiS_statusR, wsiM_statusR } ;
  assign x_burstLength__h22441 =
	     (readMeta[23:0] == 24'd0) ? 12'd1 : readMeta[15:4] ;
  assign x_byteEn__h22442 = (readMeta[23:0] == 24'd0) ? 16'd0 : 16'd65535 ;
  always@(wci_reqF$D_OUT or
	  ...
	  wmemiRdReq or
	  wmemiRdResp or
	  rdat__h22034 or rdat__h22042 or rdat__h22050 or rdat__h22058)
  begin
    case (wci_reqF$D_OUT[51:32])
      20'h0: x_data__h21808 = dlyCtrl;
      20'h00004: x_data__h21808 = dlyHoldoffBytes;
      20'h00008: x_data__h21808 = dlyHoldoffCycles;
      20'h0000C: x_data__h21808 = mesgWtCount;
      20'h00010: x_data__h21808 = mesgRdCount;
      20'h00014: x_data__h21808 = bytesWritten;
      20'h00018: x_data__h21808 = rdat__h21851;
      20'h0001C: x_data__h21808 = 32'd0;
      20'h00020: x_data__h21808 = wsiS_extStatusW$wget[95:64];
      20'h00024: x_data__h21808 = wsiS_extStatusW$wget[63:32];
      20'h00028: x_data__h21808 = wsiS_extStatusW$wget[31:0];
      20'h0002C: x_data__h21808 = wsiM_extStatusW$wget[95:64];
      20'h00030: x_data__h21808 = wsiM_extStatusW$wget[63:32];
      20'h00034: x_data__h21808 = wsiM_extStatusW$wget[31:0];
      20'h00038: x_data__h21808 = wmemiWrReq;
      20'h0003C: x_data__h21808 = wmemiRdReq;
      20'h00040: x_data__h21808 = wmemiRdResp;
      20'h00044: x_data__h21808 = rdat__h22034;
      20'h00048: x_data__h21808 = rdat__h22042;
      20'h0004C: x_data__h21808 = rdat__h22050;
      20'h00050: x_data__h21808 = rdat__h22058;
      default: x_data__h21808 = 32'd0;
    endcase
  end
  ...
  begin
    ...
    mesgReqValid = 1'h0;
    mesgWF_rCache = 141'h0AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA;
