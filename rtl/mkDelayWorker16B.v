...
//
// On Tue Jun  1 17:10:20 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker16B(wciS0_Clk,
  ...
  wire [15 : 0] MUX_rdSerUnroll$write_1__VAL_1,
  ...
  reg [63 : 0] v__h17183,
	       ...
	       v__h2806,
	       v__h3705;
  reg [31 : 0] x_data__h20374;
  reg CASE_wrtSerPos_0b1_0_1_1_1_2_1_3_0b1__q1;
  wire [127 : 0] mesg__h20847, x__h15015, x__h15941, x__h19468;
  wire [31 : 0] rdat__h20418, v__h21160;
  wire [23 : 0] x1_length__h16876, x__h20421;
  wire [15 : 0] x_byteEn__h20939;
  wire [13 : 0] mlp1__h17575, x__h16920;
  wire [11 : 0] x_burstLength__h20938;
  wire [10 : 0] x__h14907, x__h15833;
  wire [7 : 0] x1_opcode__h16875;
  wire NOT_mesgRF_rRdPtr_23_PLUS_512_66_EQ_mesgRF_rWr_ETC___d181,
       NOT_wsiS_reqFifo_countReg_75_ULE_1_76___d577,
       ...
       _dor1wide16F$EN_deq,
       metaRF_RDY_enq__04_AND_NOT_rdSerEmpty_69_70_AN_ETC___d205,
       wci_cState_9_EQ_2_0_AND_dlyCtrl_4_BITS_3_TO_0__ETC___d159,
       wci_cState_9_EQ_2_0_AND_dlyCtrl_4_BITS_3_TO_0__ETC___d270;
  ...
  assign MUX_mesgLength$write_1__VAL_3 = { 1'd1, mlp1__h17575[9:0], 4'd0 } ;
  ...
  assign MUX_rdSerUnroll$write_1__VAL_1 = rdSerUnroll - 16'd1 ;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_1 = { 2'd1, x_data__h20374 } ;
  ...
  assign MUX_wide16F$enq_1__VAL_1 =
	     { x__h19468[31:0], wrtSerStage_2, wrtSerStage_1, wrtSerStage } ;
  ...
  assign mesgRF_wDataIn$wget = { 96'd0, v__h21160 } ;
  ...
  assign rdSerUnroll$D_IN =
	     WILL_FIRE_RL_rdSer_body ?
	       MUX_rdSerUnroll$write_1__VAL_1 :
	       v__h21160[19:4] ;
  ...
  assign wrtSerStage$D_IN =
	     MUX_wrtSerStage$write_1__SEL_1 ? x__h19468[31:0] : metaWF$D_OUT ;
  ...
  assign wrtSerStage_3$D_IN =
	     MUX_wide16F$enq_1__SEL_1 ? x__h19468[31:0] : metaWF$D_OUT ;
  ...
  begin
    case (rdSerPos)
      2'd0: metaRF$D_IN = wide16F$D_OUT[31:0];
  ...
  assign NOT_wsiS_reqFifo_countReg_75_ULE_1_76___d577 =
	     wsiS_reqFifo_countReg > 2'd1 ;
  ...
  assign _dor1wide16F$EN_deq =
	     WILL_FIRE_RL_rdSer_begin || WILL_FIRE_RL_rdSer_body ;
  assign mesg__h20847 = mesgRF_wDataOut$wget ;
  assign metaRF_RDY_enq__04_AND_NOT_rdSerEmpty_69_70_AN_ETC___d205 =
	     metaRF$FULL_N &&
	     (!rdSerEmpty && rdSerPos != 2'd0 || wide16F$EMPTY_N) ;
  assign mlp1__h17575 = mesgLengthSoFar + 14'd1 ;
  assign rdat__h20418 = { 8'd0, x__h20421 } ;
  assign v__h21160 = metaRF$D_IN ;
  assign wci_cState_9_EQ_2_0_AND_dlyCtrl_4_BITS_3_TO_0__ETC___d159 =
	     wci_cState == 3'd2 && dlyCtrl[3:0] == 4'h7 &&
	     unrollCnt == 16'd0 &&
	     bytesWritten > dlyHoldoff ;
  assign wci_cState_9_EQ_2_0_AND_dlyCtrl_4_BITS_3_TO_0__ETC___d270 =
  ...
  assign x__h15941 = CAN_FIRE_RL_rdSer_body ? mesgRF_wDataIn$wget : 128'd0 ;
  assign x__h16920 = mesgLength[14] ? mesgLength[13:0] : 14'd0 ;
  assign x__h19468 = mesgWF_wDataOut$wget ;
  assign x__h20421 = { wmemi_statusR, wsiS_statusR, wsiM_statusR } ;
  assign x_burstLength__h20938 =
	     (readMeta[23:0] == 24'd0) ? 12'd1 : readMeta[15:4] ;
  assign x_byteEn__h20939 = (readMeta[23:0] == 24'd0) ? 16'd0 : 16'd65535 ;
  always@(wrtSerPos)
  begin
    case (wrtSerPos)
  ...
  always@(wci_reqF$D_OUT or
	  ...
	  mesgWtCount or
	  mesgRdCount or
	  rdat__h20418 or wsiS_extStatusW$wget or wsiM_extStatusW$wget)
  begin
    case (wci_reqF$D_OUT[51:32])
      20'h0: x_data__h20374 = dlyCtrl;
      20'h00004: x_data__h20374 = dlyHoldoff;
      20'h00008: x_data__h20374 = mesgWtCount;
      20'h0000C: x_data__h20374 = mesgRdCount;
      20'h00010, 20'h00014: x_data__h20374 = 32'd0;
      20'h00018: x_data__h20374 = rdat__h20418;
      20'h00020: x_data__h20374 = wsiS_extStatusW$wget[95:64];
      20'h00024: x_data__h20374 = wsiS_extStatusW$wget[63:32];
      20'h00028: x_data__h20374 = wsiS_extStatusW$wget[31:0];
      20'h0002C: x_data__h20374 = wsiM_extStatusW$wget[95:64];
      20'h00030: x_data__h20374 = wsiM_extStatusW$wget[63:32];
      20'h00034: x_data__h20374 = wsiM_extStatusW$wget[31:0];
      default: x_data__h20374 = 32'd0;
    endcase
  end
