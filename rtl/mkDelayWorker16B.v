...
//
// On Mon Oct 25 17:57:35 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker16B(wciS0_Clk,
  ...
  assign mesgRF$D_IN = { 96'd0, v__h20288 } ;
  ...
  assign btm__h17061 =
		 ...
		 { 6'd0, mesgLengthSoFar_05_PLUS_1___d970 },
	       4'd0 } ;
  ...
  assign x_byteEn__h20011 = (readMeta[23:0] == 24'd0) ? 16'd0 : 16'd65535 ;
  always@(wrtSerPos)
  begin
    case (wrtSerPos)
