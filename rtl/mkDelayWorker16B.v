...
//
// On Fri Nov 19 14:56:17 EST 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker16B(wciS0_Clk,
  ...
  wire [127 : 0] wmemiM_MData, wsiM0_MData;
  wire [35 : 0] wmemiM_MAddr;
  wire [31 : 0] wciS0_SData;
  wire [15 : 0] wmemiM_MDataByteEn, wsiM0_MByteEn;
  ...
  wire [127 : 0] IF_wrtSerPos_82_EQ_2_92_THEN_0x0_ELSE_mesgWF_w_ETC___d550,
  ...
  wire IF_wrtSerPos_82_EQ_0_90_OR_wrtSerPos_82_EQ_1_9_ETC___d535,
       ...
       bytesWritten_78_ULT_dlyHoldoffBytes_58___d1004,
       cyclesPassed_48_ULT_dlyHoldoffCycles_61___d1006,
       dlyWordsStored_value_09_SLE_0_57_OR_bytesWritt_ETC___d565,
       dlyWordsStored_value_09_SLE_0___d1007,
       dlyWordsStored_value_09_SLT_8388608___d567,
       mesgRF_i_notFull__64_AND_NOT_rdSerEmpty_14_15__ETC___d665,
       metaRF_i_notFull__13_AND_NOT_rdSerEmpty_14_15__ETC___d624,
       wci_cState_5_EQ_2_6_AND_dlyCtrl_40_BITS_3_TO_0_ETC___d585,
  ...
  always@(wrtSerPos or
	  IF_wrtSerPos_82_EQ_2_92_THEN_0x0_ELSE_mesgWF_w_ETC___d550 or
  ...
  begin
    case (wrtSerPos)
      ...
      default: MUX_wide16Fa$enq_1__VAL_2 =
		   IF_wrtSerPos_82_EQ_2_92_THEN_0x0_ELSE_mesgWF_w_ETC___d550;
    endcase
  end
  ...
  assign wrtSerStage$D_IN =
	     MUX_wrtSerStage$write_1__SEL_1 ? x__h18621[31:0] : metaWF$D_OUT ;
  ...
  // submodule mesgRF
  assign mesgRF$D_IN = { 96'd0, v__h19843 } ;
  ...
  assign IF_wrtSerPos_82_EQ_0_90_OR_wrtSerPos_82_EQ_1_9_ETC___d535 =
	     ...
	     (wrtSerPos != 2'd3 && wrtSerUnroll != 16'd1 ||
	      CASE_wrtSerPos_NOT_wrtSerPos_EQ_3_OR_wide16Fa_ETC__q1) ;
  assign IF_wrtSerPos_82_EQ_2_92_THEN_0x0_ELSE_mesgWF_w_ETC___d550 =
	     { (wrtSerPos == 2'd2) ? 32'h0 : x__h18621[31:0],
	       (wrtSerPos == 2'd2) ? x__h18621[31:0] : wrtSerStage_2,
	       wrtSerStage_1,
	       wrtSerStage } ;
  ...
  assign btm__h17357 =
		 ...
		 { 6'd0, mesgLengthSoFar_65_PLUS_1___d970 },
	       4'd0 } ;
  assign bytesWritten_78_ULT_dlyHoldoffBytes_58___d1004 =
	     bytesWritten < dlyHoldoffBytes ;
  assign cyclesPassed_48_ULT_dlyHoldoffCycles_61___d1006 =
  ...
  assign delayStatus__h21808 =
	     { 14'h0,
	       ...
	       wide16Fc$FULL_N,
	       wide16Fc$EMPTY_N } ;
  assign dlyWordsStored_value_09_SLE_0_57_OR_bytesWritt_ETC___d565 =
	     dlyWordsStored_value_09_SLE_0___d1007 ||
	     bytesWritten_78_ULT_dlyHoldoffBytes_58___d1004 ||
	     cyclesPassed_48_ULT_dlyHoldoffCycles_61___d1006 ||
	     wsiM_reqFifo_c_r == 2'd2 ||
	     tog50 ;
  assign dlyWordsStored_value_09_SLE_0___d1007 =
	     (dlyWordsStored_value ^ 25'h1000000) <= 25'd16777216 ;
  assign dlyWordsStored_value_09_SLT_8388608___d567 =
	     (dlyWordsStored_value ^ 25'h1000000) < 25'd25165824 ;
  assign mesgLengthSoFar_65_PLUS_1___d970 = mesgLengthSoFar + 14'd1 ;
  assign mesgRF_i_notFull__64_AND_NOT_rdSerEmpty_14_15__ETC___d665 =
	     mesgRF$FULL_N &&
	     (!rdSerEmpty && rdSerPos != 2'd0 || wide16Fc$EMPTY_N) ;
  assign metaRF_i_notFull__13_AND_NOT_rdSerEmpty_14_15__ETC___d624 =
	     metaRF$FULL_N &&
	     (!rdSerEmpty && rdSerPos != 2'd0 || wide16Fc$EMPTY_N) ;
  ...
  assign wci_cState_5_EQ_2_6_AND_dlyCtrl_40_BITS_3_TO_0_ETC___d585 =
  ...
  assign x__h18621 = mesgWF_wDataOut$wget ;
  assign x__h18754 = { 96'd0, x__h18621[31:0] } ;
  assign x__h18778 = { 64'd0, x__h18621[31:0], wrtSerStage } ;
  ...
  assign x_byteEn__h21716 = (readMeta[23:0] == 24'd0) ? 16'd0 : 16'd65535 ;
  always@(rdSerPos or
