...
//
// On Wed Jun 23 09:36:19 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker16B(wciS0_Clk,
  ...
  reg CASE_wrtSerPos_0b1_0_1_1_1_2_1_3_0b1__q1,
      IF_wrtSerPos_11_EQ_0_12_OR_wrtSerPos_11_EQ_1_1_ETC___d967;
  ...
  assign MUX_mesgLength$write_1__VAL_3 = { 1'd1, mlp1__h17808[9:0], 4'd0 } ;
  ...
  assign mesgRF_wDataIn$wget = { 96'd0, v__h22449 } ;
  ...
  assign x__h16044 = CAN_FIRE_RL_rdSer_body ? mesgRF_wDataIn$wget : 128'd0 ;
  ...
  assign x_byteEn__h22167 = (readMeta[23:0] == 24'd0) ? 16'd0 : 16'd65535 ;
