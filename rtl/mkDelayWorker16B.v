...
//
// On Sat Jun  5 13:28:10 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker16B(wciS0_Clk,
  ...
  reg [63 : 0] v__h17393,
	       ...
	       v__h2815,
	       v__h3714;
  reg [31 : 0] x_data__h21485;
  reg CASE_wrtSerPos_0b1_0_1_1_1_2_1_3_0b1__q1,
      IF_wrtSerPos_94_EQ_0_95_OR_wrtSerPos_94_EQ_1_9_ETC___d954;
  wire [127 : 0] IF_wrtSerPos_94_EQ_2_97_THEN_0x0_ELSE_mesgWF_w_ETC___d337,
		 IF_wrtSerPos_94_EQ_2_97_THEN_0x0_ELSE_metaWF_f_ETC___d360,
		 mesg__h22012,
		 x1__h19744,
		 x1__h19753,
		 x1__h20267,
		 ...
		 x__h16033,
		 x__h19680;
  wire [35 : 0] addr__h20745, addr__h20902;
  wire [31 : 0] rdat__h21529,
		rdat__h21738,
		rdat__h21746,
		rdat__h21754,
		rdat__h21762,
		v__h22950;
  wire [23 : 0] x1_length__h17086, x__h20803, x__h20947, x__h21532;
  wire [15 : 0] x_byteEn__h22104;
  wire [13 : 0] mlp1__h17785, x__h17130;
  wire [11 : 0] x_burstLength__h22103;
  wire [10 : 0] x__h14999, x__h15925;
  wire [7 : 0] x1_opcode__h17085;
  wire [1 : 0] wrtSerPos_94_PLUS_1___d990;
  wire NOT_mesgRF_rRdPtr_49_PLUS_512_02_EQ_mesgRF_rWr_ETC___d214,
       NOT_wsiS_reqFifo_countReg_75_ULE_1_76___d677,
       _dor1bytesWritten$EN_write,
       metaRF_RDY_enq__39_AND_NOT_rdSerEmpty_05_06_AN_ETC___d240,
       metaWF_RDY_deq__41_AND_NOT_wrtSerPos_94_EQ_3_0_ETC___d348,
       wci_cState_9_EQ_2_0_AND_dlyCtrl_4_BITS_3_TO_0__ETC___d184,
       wci_cState_9_EQ_2_0_AND_dlyCtrl_4_BITS_3_TO_0__ETC___d380;
  ...
  assign MUX_mesgLength$write_1__VAL_3 = { 1'd1, mlp1__h17785[9:0], 4'd0 } ;
  ...
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_1 = { 4'd5, addr__h20745, 12'd1 } ;
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_2 = { 4'd3, addr__h20902, 12'd1 } ;
  ...
  assign MUX_wmemi_reqF_q_1$write_1__VAL_1 =
	     (wmemi_reqF_c_r == 2'd2) ?
	       MUX_wmemi_reqF_q_0$write_1__VAL_2 :
	       52'h0AAAAAAAAAAAA ;
  assign MUX_wci_respF_x_wire$wset_1__VAL_1 = { 2'd1, x_data__h21485 } ;
  ...
  always@(wrtSerPos or
	  IF_wrtSerPos_94_EQ_2_97_THEN_0x0_ELSE_mesgWF_w_ETC___d337 or
	  x1__h19744 or x1__h19753)
  begin
    case (wrtSerPos)
      2'd0: MUX_wide16Fa$enq_1__VAL_2 = x1__h19744;
      2'd1: MUX_wide16Fa$enq_1__VAL_2 = x1__h19753;
      default: MUX_wide16Fa$enq_1__VAL_2 =
		   IF_wrtSerPos_94_EQ_2_97_THEN_0x0_ELSE_mesgWF_w_ETC___d337;
    endcase
  end
  always@(wrtSerPos or
	  IF_wrtSerPos_94_EQ_2_97_THEN_0x0_ELSE_metaWF_f_ETC___d360 or
	  x1__h20267 or x1__h20276)
  begin
    case (wrtSerPos)
      2'd0: MUX_wide16Fa$enq_1__VAL_1 = x1__h20267;
      2'd1: MUX_wide16Fa$enq_1__VAL_1 = x1__h20276;
  ...
  assign MUX_wrtSerPos$write_1__VAL_1 =
	     (wrtSerUnroll == 16'd1) ? 2'd0 : wrtSerPos_94_PLUS_1___d990 ;
  assign MUX_wrtSerPos$write_1__VAL_2 =
	     (metaWF$D_OUT[23:0] == 24'd0) ?
	       2'd0 :
	       wrtSerPos_94_PLUS_1___d990 ;
  ...
  assign mesgRF_wDataIn$wget = { 96'd0, v__h22950 } ;
  ...
  always@(WILL_FIRE_RL_rdSer_body or
	  rdSerUnroll or
	  WILL_FIRE_RL_rdSer_begin or v__h22950 or WILL_FIRE_RL_rdSer_sync)
  begin
    case (1'b1) // synopsys parallel_case
      WILL_FIRE_RL_rdSer_body: rdSyncWord$D_IN = rdSerUnroll == 16'd1;
      WILL_FIRE_RL_rdSer_begin: rdSyncWord$D_IN = v__h22950[23:0] == 24'd0;
  ...
  assign wrtSerStage$D_IN =
	     MUX_wrtSerStage$write_1__SEL_1 ? x__h19680[31:0] : metaWF$D_OUT ;
  ...
  // remaining internal signals
  assign IF_wrtSerPos_94_EQ_2_97_THEN_0x0_ELSE_mesgWF_w_ETC___d337 =
	     { (wrtSerPos == 2'd2) ? 32'h0 : x__h19680[31:0],
	       (wrtSerPos == 2'd2) ? x__h19680[31:0] : wrtSerStage_2,
	       wrtSerStage_1,
	       wrtSerStage } ;
  assign IF_wrtSerPos_94_EQ_2_97_THEN_0x0_ELSE_metaWF_f_ETC___d360 =
  ...
  assign NOT_wsiS_reqFifo_countReg_75_ULE_1_76___d677 =
	     wsiS_reqFifo_countReg > 2'd1 ;
  assign _dor1bytesWritten$EN_write =
	     WILL_FIRE_RL_wmwt_messagePushPrecise ||
	     WILL_FIRE_RL_wmwt_messagePushImprecise ;
  assign addr__h20745 = { 12'd0, x__h20803 } ;
  assign addr__h20902 = { 12'd0, x__h20947 } ;
  assign mesg__h22012 = mesgRF_wDataOut$wget ;
  assign metaRF_RDY_enq__39_AND_NOT_rdSerEmpty_05_06_AN_ETC___d240 =
	     metaRF$FULL_N &&
	     (!rdSerEmpty && rdSerPos != 2'd0 || wide16Fb$EMPTY_N) ;
  assign metaWF_RDY_deq__41_AND_NOT_wrtSerPos_94_EQ_3_0_ETC___d348 =
	     metaWF$EMPTY_N &&
	     (wrtSerPos != 2'd3 && metaWF$D_OUT[23:0] != 24'd0 ||
	      IF_wrtSerPos_94_EQ_0_95_OR_wrtSerPos_94_EQ_1_9_ETC___d954) ;
  assign mlp1__h17785 = mesgLengthSoFar + 14'd1 ;
  assign rdat__h21529 = { 8'd0, x__h21532 } ;
  assign rdat__h21738 = { 12'd0, dlyWordsStored_value } ;
  assign rdat__h21746 = { 24'd0, dlyReadCredit_value } ;
  assign rdat__h21754 = { 12'd0, dlyWAG } ;
  assign rdat__h21762 = { 12'd0, dlyRAG } ;
  assign v__h22950 = metaRF$D_IN ;
  assign wci_cState_9_EQ_2_0_AND_dlyCtrl_4_BITS_3_TO_0__ETC___d184 =
	     wci_cState == 3'd2 && dlyCtrl[3:0] == 4'h7 &&
	     unrollCnt == 16'd0 &&
	     bytesWritten > dlyHoldoff ;
  assign wci_cState_9_EQ_2_0_AND_dlyCtrl_4_BITS_3_TO_0__ETC___d380 =
	     wci_cState == 3'd2 && dlyCtrl[3:0] == 4'h7 && mesgLength[14] &&
	     !doAbort &&
	     (preciseBurst && wsiWordsRemain == 12'd0 ||
	      impreciseBurst && endOfMessage) ;
  assign wrtSerPos_94_PLUS_1___d990 = wrtSerPos + 2'd1 ;
  assign x1__h19744 = { 96'd0, x__h19680[31:0] } ;
  assign x1__h19753 = { 64'd0, x__h19680[31:0], wrtSerStage } ;
  assign x1__h20267 = { 96'd0, metaWF$D_OUT } ;
  assign x1__h20276 = { 64'd0, metaWF$D_OUT, wrtSerStage } ;
  ...
  assign x__h16033 = CAN_FIRE_RL_rdSer_body ? mesgRF_wDataIn$wget : 128'd0 ;
  assign x__h17130 = mesgLength[14] ? mesgLength[13:0] : 14'd0 ;
  assign x__h19680 = mesgWF_wDataOut$wget ;
  assign x__h20803 = { dlyRAG, 4'h0 } ;
  assign x__h20947 = { dlyWAG, 4'h0 } ;
  assign x__h21532 = { wmemi_statusR, wsiS_statusR, wsiM_statusR } ;
  assign x_burstLength__h22103 =
	     (readMeta[23:0] == 24'd0) ? 12'd1 : readMeta[15:4] ;
  assign x_byteEn__h22104 = (readMeta[23:0] == 24'd0) ? 16'd0 : 16'd65535 ;
  always@(wci_reqF$D_OUT or
	  ...
	  wmemiRdReq or
	  wmemiRdResp or
	  rdat__h21738 or rdat__h21746 or rdat__h21754 or rdat__h21762)
  begin
    case (wci_reqF$D_OUT[51:32])
      20'h0: x_data__h21485 = dlyCtrl;
      20'h00004: x_data__h21485 = dlyHoldoff;
      20'h00008: x_data__h21485 = mesgWtCount;
      20'h0000C: x_data__h21485 = mesgRdCount;
      20'h00010: x_data__h21485 = bytesWritten;
      20'h00014: x_data__h21485 = 32'd0;
      20'h00018: x_data__h21485 = rdat__h21529;
      20'h00020: x_data__h21485 = wsiS_extStatusW$wget[95:64];
      20'h00024: x_data__h21485 = wsiS_extStatusW$wget[63:32];
      20'h00028: x_data__h21485 = wsiS_extStatusW$wget[31:0];
      20'h0002C: x_data__h21485 = wsiM_extStatusW$wget[95:64];
      20'h00030: x_data__h21485 = wsiM_extStatusW$wget[63:32];
      20'h00034: x_data__h21485 = wsiM_extStatusW$wget[31:0];
      20'h00038: x_data__h21485 = wmemiWrReq;
      20'h0003C: x_data__h21485 = wmemiRdReq;
      20'h00040: x_data__h21485 = wmemiRdResp;
      20'h00044: x_data__h21485 = rdat__h21738;
      20'h00048: x_data__h21485 = rdat__h21746;
      20'h0004C: x_data__h21485 = rdat__h21754;
      20'h00050: x_data__h21485 = rdat__h21762;
      default: x_data__h21485 = 32'd0;
    endcase
  end
