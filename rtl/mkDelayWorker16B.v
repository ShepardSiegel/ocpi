...
//
// On Tue Jul 27 12:20:35 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker16B(wciS0_Clk,
  ...
  assign mesgRF$D_IN = { 96'd0, v__h20254 } ;
  ...
  assign btm__h17027 =
		 ...
		 { 6'd0, mesgLengthSoFar_05_PLUS_1___d960 },
	       4'd0 } ;
  ...
  assign x_byteEn__h19977 = (readMeta[23:0] == 24'd0) ? 16'd0 : 16'd65535 ;
  always@(wrtSerPos)
  begin
    case (wrtSerPos)
