...
//
// On Fri Jun 18 15:20:11 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker16B(wciS0_Clk,
  ...
  reg [63 : 0] v__h17441,
	       ...
	       v__h2815,
	       v__h3714;
  reg [31 : 0] x_data__h21529;
  reg CASE_wrtSerPos_0b1_0_1_1_1_2_1_3_0b1__q1,
      IF_wrtSerPos_11_EQ_0_12_OR_wrtSerPos_11_EQ_1_1_ETC___d888;
  wire [127 : 0] IF_wrtSerPos_11_EQ_2_14_THEN_0x0_ELSE_mesgWF_w_ETC___d354,
		 ...
		 x__h16040,
		 x__h19630;
  wire [35 : 0] addr__h20719, addr__h20891;
  wire [31 : 0] rdat__h21572,
		rdat__h21755,
		rdat__h21763,
		rdat__h21771,
		rdat__h21779,
		v__h22445;
  wire [26 : 0] x__h20777, x__h20936;
  wire [23 : 0] x1_length__h17134, x__h21575;
  wire [15 : 0] x_byteEn__h22163;
  wire [13 : 0] mlp1__h17804, x__h17178;
  wire [11 : 0] x__h15005, x_burstLength__h22162;
  wire [10 : 0] x__h15932;
  wire [7 : 0] x1_opcode__h17133;
  wire [1 : 0] wrtSerPos_11_PLUS_1___d1002;
  ...
  assign MUX_mesgLength$write_1__VAL_3 = { 1'd1, mlp1__h17804[9:0], 4'd0 } ;
  ...
  assign MUX_metaWF$enq_1__VAL_2 = { x1_opcode__h17133, x1_length__h17134 } ;
  ...
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_1 = { 4'd5, addr__h20719, 12'd1 } ;
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_2 = { 4'd3, addr__h20891, 12'd1 } ;
  assign MUX_wci_respF_x_wire$wset_1__VAL_1 = { 2'd1, x_data__h21529 } ;
  ...
  assign MUX_rdSyncWord$write_1__VAL_2 =
	     rdSerPos != 2'd3 && v__h22445[23:0] == 24'd0 ;
  assign MUX_wsiM_reqFifo_x_wire$wset_1__VAL_1 =
	     { 3'd1,
	       unrollCnt == 16'd1,
	       1'd1,
	       x_burstLength__h22162,
	       mesg__h22071,
	       x_byteEn__h22163,
	       readMeta[31:24] } ;
  ...
  always@(wrtSerPos or
	  ...
	  x1__h19694 or x1__h19703)
  begin
    case (wrtSerPos)
      2'd0: MUX_wide16Fa$enq_1__VAL_2 = x1__h19694;
      2'd1: MUX_wide16Fa$enq_1__VAL_2 = x1__h19703;
  ...
  always@(wrtSerPos or
	  ...
	  x1__h20217 or x1__h20226)
  begin
    case (wrtSerPos)
      2'd0: MUX_wide16Fa$enq_1__VAL_1 = x1__h20217;
      2'd1: MUX_wide16Fa$enq_1__VAL_1 = x1__h20226;
      default: MUX_wide16Fa$enq_1__VAL_1 =
		   IF_wrtSerPos_11_EQ_2_14_THEN_0x0_ELSE_metaWF_f_ETC___d377;
    endcase
  end
  assign MUX_wrtSerPos$write_1__VAL_1 =
	     (wrtSerUnroll == 16'd1) ? 2'd0 : wrtSerPos_11_PLUS_1___d1002 ;
  assign MUX_wrtSerPos$write_1__VAL_2 =
	     (metaWF$D_OUT[23:0] == 24'd0) ?
	       2'd0 :
	       wrtSerPos_11_PLUS_1___d1002 ;
  ...
  assign mesgRF_wDataIn$wget = { 96'd0, v__h22445 } ;
  ...
  assign wrtSerStage$D_IN =
	     MUX_wrtSerStage$write_1__SEL_1 ? x__h19630[31:0] : metaWF$D_OUT ;
  ...
  assign IF_wrtSerPos_11_EQ_2_14_THEN_0x0_ELSE_mesgWF_w_ETC___d354 =
	     { (wrtSerPos == 2'd2) ? 32'h0 : x__h19630[31:0],
	       (wrtSerPos == 2'd2) ? x__h19630[31:0] : wrtSerStage_2,
	       wrtSerStage_1,
	       wrtSerStage } ;
  ...
  assign _dor1bytesWritten$EN_write =
	     WILL_FIRE_RL_wmwt_messagePushPrecise ||
	     WILL_FIRE_RL_wmwt_messagePushImprecise ;
  assign addr__h20719 = { 9'd0, x__h20777 } ;
  assign addr__h20891 = { 9'd0, x__h20936 } ;
  assign mesg__h22071 = mesgRF_wDataOut$wget ;
  ...
  assign rdat__h21572 = { 8'd0, x__h21575 } ;
  assign rdat__h21755 = { 9'd0, dlyWordsStored_value } ;
  assign rdat__h21763 = { 24'd0, dlyReadCredit_value } ;
  assign rdat__h21771 = { 9'd0, dlyWAG } ;
  assign rdat__h21779 = { 9'd0, dlyRAG } ;
  assign v__h22445 = metaRF$D_IN ;
  ...
  assign wrtSerPos_11_PLUS_1___d1002 = wrtSerPos + 2'd1 ;
  assign x1__h19694 = { 96'd0, x__h19630[31:0] } ;
  assign x1__h19703 = { 64'd0, x__h19630[31:0], wrtSerStage } ;
  assign x1__h20217 = { 96'd0, metaWF$D_OUT } ;
  assign x1__h20226 = { 64'd0, metaWF$D_OUT, wrtSerStage } ;
  ...
  assign x__h16040 = CAN_FIRE_RL_rdSer_body ? mesgRF_wDataIn$wget : 128'd0 ;
  assign x__h17178 = mesgLength[14] ? mesgLength[13:0] : 14'd0 ;
  assign x__h19630 = mesgWF_wDataOut$wget ;
  assign x__h20777 = { dlyRAG, 4'h0 } ;
  assign x__h20936 = { dlyWAG, 4'h0 } ;
  assign x__h21575 = { wmemi_statusR, wsiS_statusR, wsiM_statusR } ;
  assign x_burstLength__h22162 =
	     (readMeta[23:0] == 24'd0) ? 12'd1 : readMeta[15:4] ;
  assign x_byteEn__h22163 = (readMeta[23:0] == 24'd0) ? 16'd0 : 16'd65535 ;
  always@(wci_reqF$D_OUT or
	  ...
	  wmemiRdReq or
	  wmemiRdResp or
	  rdat__h21755 or rdat__h21763 or rdat__h21771 or rdat__h21779)
  begin
    case (wci_reqF$D_OUT[51:32])
      20'h0: x_data__h21529 = dlyCtrl;
      20'h00004: x_data__h21529 = dlyHoldoffBytes;
      20'h00008: x_data__h21529 = dlyHoldoffCycles;
      20'h0000C: x_data__h21529 = mesgWtCount;
      20'h00010: x_data__h21529 = mesgRdCount;
      20'h00014: x_data__h21529 = bytesWritten;
      20'h00018: x_data__h21529 = rdat__h21572;
      20'h0001C: x_data__h21529 = 32'd0;
      20'h00020: x_data__h21529 = wsiS_extStatusW$wget[95:64];
      20'h00024: x_data__h21529 = wsiS_extStatusW$wget[63:32];
      20'h00028: x_data__h21529 = wsiS_extStatusW$wget[31:0];
      20'h0002C: x_data__h21529 = wsiM_extStatusW$wget[95:64];
      20'h00030: x_data__h21529 = wsiM_extStatusW$wget[63:32];
      20'h00034: x_data__h21529 = wsiM_extStatusW$wget[31:0];
      20'h00038: x_data__h21529 = wmemiWrReq;
      20'h0003C: x_data__h21529 = wmemiRdReq;
      20'h00040: x_data__h21529 = wmemiRdResp;
      20'h00044: x_data__h21529 = rdat__h21755;
      20'h00048: x_data__h21529 = rdat__h21763;
      20'h0004C: x_data__h21529 = rdat__h21771;
      20'h00050: x_data__h21529 = rdat__h21779;
      default: x_data__h21529 = 32'd0;
    endcase
  end
