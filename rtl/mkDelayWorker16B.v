...
//
// On Tue Jul 13 07:46:20 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker16B(wciS0_Clk,
  ...
  assign MUX_mesgLength$write_1__VAL_3 = { 1'd1, mlp1__h17940[9:0], 4'd0 } ;
  ...
  assign mesgRF$D_IN = { 96'd0, v__h23184 } ;
  ...
  assign x_byteEn__h22904 = (readMeta[23:0] == 24'd0) ? 16'd0 : 16'd65535 ;
