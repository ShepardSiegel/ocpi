...
//
// On Sun Jan  9 10:36:59 EST 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker16B(wciS0_Clk,
  ...
  wire [127 : 0] IF_wrtSerPos_99_EQ_2_09_THEN_0x0_ELSE_mesgWF_w_ETC___d567,
  ...
  wire [15 : 0] x_byteEn__h22166;
  wire [13 : 0] mesgLengthSoFar_82_PLUS_1___d967;
  wire [12 : 0] x__h15419;
  wire [11 : 0] x_burstLength__h22165;
  wire [1 : 0] wrtSerPos_99_PLUS_1___d966;
  wire IF_wrtSerPos_99_EQ_0_07_OR_wrtSerPos_99_EQ_1_0_ETC___d552,
       ...
       bytesWritten_95_ULT_dlyHoldoffBytes_75___d1007,
       cyclesPassed_65_ULT_dlyHoldoffCycles_78___d1005,
       dlyWordsStored_value_26_SLE_0_74_OR_bytesWritt_ETC___d582,
       dlyWordsStored_value_26_SLE_0___d1006,
       dlyWordsStored_value_26_SLT_8388608___d584,
       mesgRF_i_notFull__81_AND_NOT_rdSerEmpty_31_32__ETC___d682,
       metaRF_i_notFull__30_AND_NOT_rdSerEmpty_31_32__ETC___d641,
       wci_wslv_cState_5_EQ_2_6_AND_dlyCtrl_57_BITS_3_ETC___d602,
  ...
  always@(wrtSerPos or
	  IF_wrtSerPos_99_EQ_2_09_THEN_0x0_ELSE_mesgWF_w_ETC___d567 or
  ...
  begin
    case (wrtSerPos)
      ...
      default: MUX_wide16Fa$enq_1__VAL_2 =
		   IF_wrtSerPos_99_EQ_2_09_THEN_0x0_ELSE_mesgWF_w_ETC___d567;
    endcase
  end
  ...
  assign MUX_wrtSerPos$write_1__VAL_1 =
	     (metaWF$D_OUT[23:0] == 24'd0) ?
	       2'd0 :
	       wrtSerPos_99_PLUS_1___d966 ;
  assign MUX_wrtSerPos$write_1__VAL_2 =
	     (wrtSerUnroll == 16'd1) ? 2'd0 : wrtSerPos_99_PLUS_1___d966 ;
  ...
  assign mesgLengthSoFar$D_IN =
	     wsiS_reqFifo$D_OUT[165] ?
	       14'd0 :
	       mesgLengthSoFar_82_PLUS_1___d967 ;
  ...
  assign wrtSerStage$D_IN =
	     MUX_wrtSerStage$write_1__SEL_1 ? x__h19071[31:0] : metaWF$D_OUT ;
  ...
  // submodule mesgRF
  assign mesgRF$D_IN = { 96'd0, v__h20293 } ;
  ...
  assign mesgWF_memory$ADDRB =
	     CAN_FIRE_RL_wrtSer_body ? x__h15419[11:0] : mesgWF_rRdPtr[11:0] ;
  ...
  assign IF_wrtSerPos_99_EQ_0_07_OR_wrtSerPos_99_EQ_1_0_ETC___d552 =
	     ...
	     (wrtSerPos != 2'd3 && wrtSerUnroll != 16'd1 ||
	      CASE_wrtSerPos_NOT_wrtSerPos_EQ_3_OR_wide16Fa_ETC__q1) ;
  assign IF_wrtSerPos_99_EQ_2_09_THEN_0x0_ELSE_mesgWF_w_ETC___d567 =
	     { (wrtSerPos == 2'd2) ? 32'h0 : x__h19071[31:0],
	       (wrtSerPos == 2'd2) ? x__h19071[31:0] : wrtSerStage_2,
	       wrtSerStage_1,
	       wrtSerStage } ;
  ...
  assign btm__h17807 =
		 ...
		 { 6'd0, mesgLengthSoFar_82_PLUS_1___d967 },
	       4'd0 } ;
  assign bytesWritten_95_ULT_dlyHoldoffBytes_75___d1007 =
	     bytesWritten < dlyHoldoffBytes ;
  assign cyclesPassed_65_ULT_dlyHoldoffCycles_78___d1005 =
  ...
  assign delayStatus__h22258 =
	     { 14'h0,
	       ...
	       wide16Fc$FULL_N,
	       wide16Fc$EMPTY_N } ;
  assign dlyWordsStored_value_26_SLE_0_74_OR_bytesWritt_ETC___d582 =
	     dlyWordsStored_value_26_SLE_0___d1006 ||
	     bytesWritten_95_ULT_dlyHoldoffBytes_75___d1007 ||
	     cyclesPassed_65_ULT_dlyHoldoffCycles_78___d1005 ||
	     wsiM_reqFifo_c_r == 2'd2 ||
	     tog50 ;
  assign dlyWordsStored_value_26_SLE_0___d1006 =
	     (dlyWordsStored_value ^ 25'h1000000) <= 25'd16777216 ;
  assign dlyWordsStored_value_26_SLT_8388608___d584 =
	     (dlyWordsStored_value ^ 25'h1000000) < 25'd25165824 ;
  assign mesgLengthSoFar_82_PLUS_1___d967 = mesgLengthSoFar + 14'd1 ;
  ...
  assign wci_wslv_cState_5_EQ_2_6_AND_dlyCtrl_57_BITS_3_ETC___d602 =
	     wci_wslv_cState == 3'd2 && dlyCtrl[3:0] == 4'h7 &&
	     !dlyWordsStored_value_26_SLE_0___d1006 &&
	     !bytesWritten_95_ULT_dlyHoldoffBytes_75___d1007 &&
	     !cyclesPassed_65_ULT_dlyHoldoffCycles_78___d1005 ;
  assign wrtSerPos_99_PLUS_1___d966 = wrtSerPos + 2'd1 ;
  ...
  assign x__h19071 = mesgWF_wDataOut$wget ;
  assign x__h19204 = { 96'd0, x__h19071[31:0] } ;
  assign x__h19228 = { 64'd0, x__h19071[31:0], wrtSerStage } ;
  ...
  assign x_byteEn__h22166 = (readMeta[23:0] == 24'd0) ? 16'd0 : 16'd65535 ;
  always@(rdSerPos or
