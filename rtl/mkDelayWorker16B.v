...
//
// On Tue Jun  1 12:37:42 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker16B(wciS0_Clk,
  ...
  reg [63 : 0] v__h16563,
	       ...
	       v__h2804,
	       v__h3703;
  reg [31 : 0] x_data__h19646;
  reg CASE_wrtSerPos_0b1_0_1_1_1_2_1_3_0b1__q1;
  wire [127 : 0] mesg__h20119, x__h15013, x__h15939, x__h18848;
  wire [31 : 0] rdat__h19690, v__h20432;
  wire [23 : 0] x1_length__h16256, x__h19693;
  wire [15 : 0] x_byteEn__h20211;
  wire [13 : 0] mlp1__h16955, x__h16300;
  wire [11 : 0] x_burstLength__h20210;
  wire [10 : 0] x__h14905, x__h15831;
  wire [7 : 0] x1_opcode__h16255;
  wire NOT_mesgRF_rRdPtr_23_PLUS_512_66_EQ_mesgRF_rWr_ETC___d181,
       NOT_wsiS_reqFifo_countReg_57_ULE_1_58___d559,
  ...
  assign MUX_mesgLength$write_1__VAL_3 = { 1'd1, mlp1__h16955[9:0], 4'd0 } ;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_1 = { 2'd1, x_data__h19646 } ;
  ...
  assign MUX_wide16F$enq_1__VAL_1 =
	     { x__h18848[31:0], wrtSerStage_2, wrtSerStage_1, wrtSerStage } ;
  ...
  assign mesgRF_wDataIn$wget = { 96'd0, v__h20432 } ;
  ...
  assign wrtSerStage$D_IN =
	     MUX_wrtSerStage$write_1__SEL_1 ? x__h18848[31:0] : metaWF$D_OUT ;
  ...
  assign wrtSerStage_3$D_IN =
	     MUX_wide16F$enq_1__SEL_1 ? x__h18848[31:0] : metaWF$D_OUT ;
  ...
  assign NOT_wsiS_reqFifo_countReg_57_ULE_1_58___d559 =
	     wsiS_reqFifo_countReg > 2'd1 ;
  ...
  assign x__h15939 = CAN_FIRE_RL_rdSer_body ? mesgRF_wDataIn$wget : 128'd0 ;
  assign x__h16300 = mesgLength[14] ? mesgLength[13:0] : 14'd0 ;
  assign x__h18848 = mesgWF_wDataOut$wget ;
  assign x__h19693 = { wmemi_statusR, wsiS_statusR, wsiM_statusR } ;
  assign x_burstLength__h20210 =
	     (readMeta[23:0] == 24'd0) ? 12'd1 : readMeta[15:4] ;
  assign x_byteEn__h20211 = (readMeta[23:0] == 24'd0) ? 16'd0 : 16'd65535 ;
  always@(wrtSerPos)
  begin
    case (wrtSerPos)
  ...
  always@(wci_reqF$D_OUT or
	  ...
	  mesgWtCount or
	  mesgRdCount or
	  rdat__h19690 or wsiS_extStatusW$wget or wsiM_extStatusW$wget)
  begin
    case (wci_reqF$D_OUT[51:32])
      20'h0: x_data__h19646 = dlyCtrl;
      20'h00004: x_data__h19646 = dlyHoldoff;
      20'h00008: x_data__h19646 = mesgWtCount;
      20'h0000C: x_data__h19646 = mesgRdCount;
      20'h00010, 20'h00014: x_data__h19646 = 32'd0;
      20'h00018: x_data__h19646 = rdat__h19690;
      20'h00020: x_data__h19646 = wsiS_extStatusW$wget[95:64];
      20'h00024: x_data__h19646 = wsiS_extStatusW$wget[63:32];
      20'h00028: x_data__h19646 = wsiS_extStatusW$wget[31:0];
      20'h0002C: x_data__h19646 = wsiM_extStatusW$wget[95:64];
      20'h00030: x_data__h19646 = wsiM_extStatusW$wget[63:32];
      20'h00034: x_data__h19646 = wsiM_extStatusW$wget[31:0];
      default: x_data__h19646 = 32'd0;
    endcase
  end
