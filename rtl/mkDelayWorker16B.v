...
//
// On Fri Jun  4 10:55:35 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker16B(wciS0_Clk,
  ...
  reg [63 : 0] v__h17359,
	       ...
	       v__h2812,
	       v__h3711;
  reg [31 : 0] x_data__h21172;
  reg CASE_wrtSerPos_0b1_0_1_1_1_2_1_3_0b1__q1;
  wire [127 : 0] mesg__h21699, x__h15021, x__h15947, x__h19644;
  wire [35 : 0] addr__h20432, addr__h20589;
  wire [31 : 0] rdat__h21216,
		rdat__h21425,
		rdat__h21433,
		rdat__h21441,
		rdat__h21449,
		v__h22012;
  wire [23 : 0] x1_length__h17052, x__h20490, x__h20634, x__h21219;
  wire [15 : 0] x_byteEn__h21791;
  wire [13 : 0] mlp1__h17751, x__h17096;
  wire [11 : 0] x_burstLength__h21790;
  wire [10 : 0] x__h14913, x__h15839;
  wire [7 : 0] x1_opcode__h17051;
  wire NOT_mesgRF_rRdPtr_48_PLUS_512_91_EQ_mesgRF_rWr_ETC___d206,
       NOT_wmemi_reqF_c_r_41_EQ_2_42_43_AND_NOT_wmemi_ETC___d263,
       NOT_wsiS_reqFifo_countReg_30_ULE_1_31___d632,
       ...
       metaRF_RDY_enq__29_AND_NOT_rdSerEmpty_94_95_AN_ETC___d230,
       wci_cState_9_EQ_2_0_AND_dlyCtrl_4_BITS_3_TO_0__ETC___d184,
       wci_cState_9_EQ_2_0_AND_dlyCtrl_4_BITS_3_TO_0__ETC___d335;
  ...
  assign MUX_mesgLength$write_1__VAL_3 = { 1'd1, mlp1__h17751[9:0], 4'd0 } ;
  ...
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_1 = { 4'd5, addr__h20432, 12'd1 } ;
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_2 = { 4'd3, addr__h20589, 12'd1 } ;
  assign MUX_wci_respF_x_wire$wset_1__VAL_1 = { 2'd1, x_data__h21172 } ;
  ...
  assign MUX_wide16Fa$enq_1__VAL_1 =
	     { x__h19644[31:0], wrtSerStage_2, wrtSerStage_1, wrtSerStage } ;
  ...
  assign mesgRF_wDataIn$wget = { 96'd0, v__h22012 } ;
  ...
  assign wrtSerStage$D_IN =
	     MUX_wrtSerStage$write_1__SEL_1 ? x__h19644[31:0] : metaWF$D_OUT ;
  ...
  assign wrtSerStage_3$D_IN =
	     MUX_wide16Fa$enq_1__SEL_1 ? x__h19644[31:0] : metaWF$D_OUT ;
  ...
  assign NOT_wmemi_reqF_c_r_41_EQ_2_42_43_AND_NOT_wmemi_ETC___d263 =
	     wmemi_reqF_c_r != 2'd2 && wmemi_dhF_c_r != 2'd2 &&
	     wmemi_operateD &&
	     wmemi_peerIsReady ;
  assign NOT_wsiS_reqFifo_countReg_30_ULE_1_31___d632 =
	     wsiS_reqFifo_countReg > 2'd1 ;
  ...
  assign _dor1wide16Fb$EN_deq =
	     WILL_FIRE_RL_rdSer_begin || WILL_FIRE_RL_rdSer_body ;
  assign addr__h20432 = { 12'd0, x__h20490 } ;
  assign addr__h20589 = { 12'd0, x__h20634 } ;
  assign mesg__h21699 = mesgRF_wDataOut$wget ;
  assign metaRF_RDY_enq__29_AND_NOT_rdSerEmpty_94_95_AN_ETC___d230 =
	     metaRF$FULL_N &&
	     (!rdSerEmpty && rdSerPos != 2'd0 || wide16Fb$EMPTY_N) ;
  assign mlp1__h17751 = MUX_mesgLengthSoFar$write_1__VAL_2 ;
  assign rdat__h21216 = { 8'd0, x__h21219 } ;
  assign rdat__h21425 = { 12'd0, dlyWordsStored_value } ;
  assign rdat__h21433 = { 24'd0, dlyReadCredit_value } ;
  assign rdat__h21441 = { 12'd0, dlyWAG } ;
  assign rdat__h21449 = { 12'd0, dlyRAG } ;
  assign v__h22012 = metaRF$D_IN ;
  assign wci_cState_9_EQ_2_0_AND_dlyCtrl_4_BITS_3_TO_0__ETC___d184 =
	     wci_cState == 3'd2 && dlyCtrl[3:0] == 4'h7 &&
	     unrollCnt == 16'd0 &&
	     bytesWritten > dlyHoldoff ;
  assign wci_cState_9_EQ_2_0_AND_dlyCtrl_4_BITS_3_TO_0__ETC___d335 =
  ...
  assign x__h15947 = CAN_FIRE_RL_rdSer_body ? mesgRF_wDataIn$wget : 128'd0 ;
  assign x__h17096 = mesgLength[14] ? mesgLength[13:0] : 14'd0 ;
  assign x__h19644 = mesgWF_wDataOut$wget ;
  assign x__h20490 = { dlyRAG, 4'h0 } ;
  assign x__h20634 = { dlyWAG, 4'h0 } ;
  assign x__h21219 = { wmemi_statusR, wsiS_statusR, wsiM_statusR } ;
  assign x_burstLength__h21790 =
	     (readMeta[23:0] == 24'd0) ? 12'd1 : readMeta[15:4] ;
  assign x_byteEn__h21791 = (readMeta[23:0] == 24'd0) ? 16'd0 : 16'd65535 ;
  always@(wrtSerPos)
  begin
    case (wrtSerPos)
  ...
  always@(wci_reqF$D_OUT or
	  ...
	  wmemiRdReq or
	  wmemiRdResp or
	  rdat__h21425 or rdat__h21433 or rdat__h21441 or rdat__h21449)
  begin
    case (wci_reqF$D_OUT[51:32])
      20'h0: x_data__h21172 = dlyCtrl;
      20'h00004: x_data__h21172 = dlyHoldoff;
      20'h00008: x_data__h21172 = mesgWtCount;
      20'h0000C: x_data__h21172 = mesgRdCount;
      20'h00010, 20'h00014: x_data__h21172 = 32'd0;
      20'h00018: x_data__h21172 = rdat__h21216;
      20'h00020: x_data__h21172 = wsiS_extStatusW$wget[95:64];
      20'h00024: x_data__h21172 = wsiS_extStatusW$wget[63:32];
      20'h00028: x_data__h21172 = wsiS_extStatusW$wget[31:0];
      20'h0002C: x_data__h21172 = wsiM_extStatusW$wget[95:64];
      20'h00030: x_data__h21172 = wsiM_extStatusW$wget[63:32];
      20'h00034: x_data__h21172 = wsiM_extStatusW$wget[31:0];
      20'h00038: x_data__h21172 = wmemiWrReq;
      20'h0003C: x_data__h21172 = wmemiRdReq;
      20'h00040: x_data__h21172 = wmemiRdResp;
      20'h00044: x_data__h21172 = rdat__h21425;
      20'h00048: x_data__h21172 = rdat__h21433;
      20'h0004C: x_data__h21172 = rdat__h21441;
      20'h00050: x_data__h21172 = rdat__h21449;
      default: x_data__h21172 = 32'd0;
    endcase
  end
