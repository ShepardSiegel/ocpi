...
//
// On Thu Jun  3 15:11:59 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker16B(wciS0_Clk,
  ...
  reg [63 : 0] v__h17359,
	       ...
	       v__h2812,
	       v__h3711;
  reg [31 : 0] x_data__h21174;
  reg CASE_wrtSerPos_0b1_0_1_1_1_2_1_3_0b1__q1;
  wire [127 : 0] mesg__h21701, x__h15021, x__h15947, x__h19644;
  wire [35 : 0] addr__h20432, addr__h20589;
  wire [31 : 0] rdat__h21218,
		rdat__h21427,
		rdat__h21435,
		rdat__h21443,
		rdat__h21451,
		v__h22014;
  wire [23 : 0] x1_length__h17052, x__h20490, x__h20634, x__h21221;
  wire [15 : 0] x_byteEn__h21793;
  wire [13 : 0] mlp1__h17751, x__h17096;
  wire [11 : 0] x_burstLength__h21792;
  ...
  assign MUX_metaWF$enq_1__VAL_2 = { x1_opcode__h17051, x1_length__h17052 } ;
  ...
  assign MUX_wmemi_dhF_q_0$write_1__VAL_2 = { 2'd3, wide16Fa$D_OUT, 16'd0 } ;
  ...
  assign MUX_wmemi_reqF_q_1$write_1__VAL_1 =
	     (wmemi_reqF_c_r == 2'd2) ?
	       MUX_wmemi_reqF_q_0$write_1__VAL_2 :
	       52'h0AAAAAAAAAAAA ;
  assign MUX_wci_respF_x_wire$wset_1__VAL_1 = { 2'd1, x_data__h21174 } ;
  ...
  assign mesgRF_wDataIn$wget = { 96'd0, v__h22014 } ;
  ...
  assign mesg__h21701 = mesgRF_wDataOut$wget ;
  assign metaRF_RDY_enq__29_AND_NOT_rdSerEmpty_94_95_AN_ETC___d230 =
	     metaRF$FULL_N &&
	     (!rdSerEmpty && rdSerPos != 2'd0 || wide16Fb$EMPTY_N) ;
  assign mlp1__h17751 = mesgLengthSoFar + 14'd1 ;
  assign rdat__h21218 = { 8'd0, x__h21221 } ;
  assign rdat__h21427 = { 12'd0, dlyWordsStored_value } ;
  assign rdat__h21435 = { 24'd0, dlyReadCredit_value } ;
  assign rdat__h21443 = { 12'd0, dlyWAG } ;
  assign rdat__h21451 = { 12'd0, dlyRAG } ;
  assign v__h22014 = metaRF$D_IN ;
  ...
  assign x__h21221 = { wmemi_statusR, wsiS_statusR, wsiM_statusR } ;
  assign x_burstLength__h21792 =
	     (readMeta[23:0] == 24'd0) ? 12'd1 : readMeta[15:4] ;
  assign x_byteEn__h21793 = (readMeta[23:0] == 24'd0) ? 16'd0 : 16'd65535 ;
  always@(wrtSerPos)
  begin
    case (wrtSerPos)
  ...
  always@(wci_reqF$D_OUT or
	  ...
	  wmemiRdReq or
	  wmemiRdResp or
	  rdat__h21427 or rdat__h21435 or rdat__h21443 or rdat__h21451)
  begin
    case (wci_reqF$D_OUT[51:32])
      20'h0: x_data__h21174 = dlyCtrl;
      20'h00004: x_data__h21174 = dlyHoldoff;
      20'h00008: x_data__h21174 = mesgWtCount;
      20'h0000C: x_data__h21174 = mesgRdCount;
      20'h00010, 20'h00014: x_data__h21174 = 32'd0;
      20'h00018: x_data__h21174 = rdat__h21218;
      20'h00020: x_data__h21174 = wsiS_extStatusW$wget[95:64];
      20'h00024: x_data__h21174 = wsiS_extStatusW$wget[63:32];
      20'h00028: x_data__h21174 = wsiS_extStatusW$wget[31:0];
      20'h0002C: x_data__h21174 = wsiM_extStatusW$wget[95:64];
      20'h00030: x_data__h21174 = wsiM_extStatusW$wget[63:32];
      20'h00034: x_data__h21174 = wsiM_extStatusW$wget[31:0];
      20'h00038: x_data__h21174 = wmemiWrReq;
      20'h0003C: x_data__h21174 = wmemiRdReq;
      20'h00040: x_data__h21174 = wmemiRdResp;
      20'h00044: x_data__h21174 = rdat__h21427;
      20'h00048: x_data__h21174 = rdat__h21435;
      20'h0004C: x_data__h21174 = rdat__h21443;
      20'h00050: x_data__h21174 = rdat__h21451;
      default: x_data__h21174 = 32'd0;
    endcase
  end
