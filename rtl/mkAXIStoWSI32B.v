...
//
// On Sun Feb  6 11:13:59 EST 2011
//
//
// Ports:
// Name                         I/O  size props
// axi_dat_TREADY                 O     1
// axi_len_TREADY                 O     1 const
// axi_spt_TREADY                 O     1 const
// axi_dpt_TREADY                 O     1 const
// axi_err_TREADY                 O     1 const
// wsi_MCmd                       O     3
// wsi_MReqLast                   O     1
...
// axi_len_TDATA                  I    16 unused
// axi_len_TSTRB                  I     2 unused
// axi_spt_TDATA                  I     8 unused
// axi_spt_TSTRB                  I     1 unused
// axi_dpt_TDATA                  I     8 unused
// axi_dpt_TSTRB                  I     1 unused
// axi_dat_TVALID                 I     1
// axi_dat_TLAST                  I     1 reg
// axi_len_TVALID                 I     1 unused
// axi_len_TLAST                  I     1 unused
// axi_spt_TVALID                 I     1 unused
// axi_spt_TLAST                  I     1 unused
// axi_dpt_TVALID                 I     1 unused
// axi_dpt_TLAST                  I     1 unused
// axi_err_TVALID                 I     1 unused
// axi_err_TLAST                  I     1 unused
...
module mkAXIStoWSI32B(CLK,
  ...
  // value method axi_dat_sTREADY
  assign axi_dat_TREADY = a4ss_fifof$FULL_N ;

  // value method axi_len_sTREADY
  assign axi_len_TREADY = 1'h0 ;

  // value method axi_spt_sTREADY
  assign axi_spt_TREADY = 1'h0 ;

  // value method axi_dpt_sTREADY
  assign axi_dpt_TREADY = 1'h0 ;

  // value method axi_err_sTREADY
  assign axi_err_TREADY = 1'h0 ;
  ...
  assign axi_Es_mTVal_w$whas = axi_dat_TVALID ;
  assign axi_Es_mTLast_w$wget = 1'd1 ;
  assign axi_Es_mTLast_w$whas = axi_dat_TLAST ;
  assign axi_Es_mTData_w$wget = axi_dat_TDATA ;
  assign axi_Es_mTData_w$whas = 1'd1 ;
  assign axi_Es_mTStrb_w$wget = axi_dat_TSTRB ;
  assign axi_Es_mTStrb_w$whas = 1'd1 ;
  assign a4ss_enq_valid$whas = axi_dat_TVALID ;
  ...
  assign a4ss_fifof$ENQ = a4ss_fifof$FULL_N && axi_dat_TVALID ;
