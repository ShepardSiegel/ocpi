...
//
// On Mon Feb  7 09:35:39 EST 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkAXIStoWSI32B(CLK,
  ...
  wire [11 : 0] x_burstLength__h4624;
  ...
  // submodule err_fifof
  FIFO2 #(.width(32'd1), .guarded(32'd1)) err_fifof(.RST_N(RST_N),
						    .CLK(CLK),
						    .D_IN(err_fifof$D_IN),
						    .ENQ(err_fifof$ENQ),
						    .DEQ(err_fifof$DEQ),
  ...
  assign err_data_wire$wget = axi_err_TLAST ;
  ...
  // submodule err_fifof
  assign err_fifof$D_IN = axi_err_TLAST ;
  ...
  assign _0_CONCAT_IF_dat_fifof_first__19_BIT_0_20_THEN__ETC___d127 =
	     { 1'd0,
	       x_burstLength__h4624,
	       dat_fifof$D_OUT[288:1],
	       firstWord ? spt_fifof$D_OUT[9:2] : 8'd0 } ;
  assign x_burstLength__h4624 = dat_fifof$D_OUT[0] ? 12'd1 : 12'd4095 ;
