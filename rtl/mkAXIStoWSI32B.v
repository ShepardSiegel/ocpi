...
//
// On Sun Jan  9 09:48:53 EST 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkAXIStoWSI32B(CLK,
  ...
  assign CAN_FIRE_RL_wsiM_reqFifo_incCtr =
		...
		CAN_FIRE_RL_advance_data :
		wsiM_reqFifo_c_r != 2'd1 || CAN_FIRE_RL_advance_data) &&
	     CAN_FIRE_RL_advance_data &&
	     !CAN_FIRE_RL_wsiM_reqFifo_deq ;
  ...
  assign CAN_FIRE_RL_wsiM_reqFifo_decCtr =
	     CAN_FIRE_RL_wsiM_reqFifo_deq && !CAN_FIRE_RL_advance_data ;
  ...
  assign CAN_FIRE_RL_wsiM_reqFifo_both =
		...
		CAN_FIRE_RL_advance_data :
		wsiM_reqFifo_c_r != 2'd2 || CAN_FIRE_RL_advance_data) &&
	     CAN_FIRE_RL_wsiM_reqFifo_deq &&
	     CAN_FIRE_RL_advance_data ;
  ...
  assign a4ss_fifof$DEQ = CAN_FIRE_RL_advance_data ;
