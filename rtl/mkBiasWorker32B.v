...
//
// On Sun Sep 15 08:30:37 EDT 2013
//
//
// Ports:
// Name                         I/O  size props
...
module mkBiasWorker32B(wciS0_Clk,
  ...
  assign MUX_wsiS_reqFifo_levelsValid$write_1__SEL_3 =
	     wsiM_reqFifo_cntr_r != 2'd2 && wsiS_reqFifo$EMPTY_N &&
	     wci_wslv_cState == 3'd2 ;
  ...
  assign rdat__h12355 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h12369 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h12377 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h12383 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h12397 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h12405 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign wci_wslv_respF_cntr_r_8_MINUS_1___d27 =
	     wci_wslv_respF_cntr_r - 2'd1 ;
  assign x__h12259 = { wsiS_statusR, wsiM_statusR } ;
  assign x_data__h10099 =
	     { wsiS_reqFifo$D_OUT[295:264] + biasValue,
	       wsiS_reqFifo$D_OUT[263:232] + biasValue,
	       wsiS_reqFifo$D_OUT[231:200] + biasValue,
	       wsiS_reqFifo$D_OUT[199:168] + biasValue,
	       wsiS_reqFifo$D_OUT[167:136] + biasValue,
	       wsiS_reqFifo$D_OUT[135:104] + biasValue,
	       wsiS_reqFifo$D_OUT[103:72] + biasValue,
	       wsiS_reqFifo$D_OUT[71:40] + biasValue } ;
