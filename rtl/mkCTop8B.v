...
//
// On Wed Nov  9 10:00:29 EST 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkCTop8B(pciDevice,
  ...
  wire [7 : 0] app$wmiM0_MDataByteEn,
	       app$wmiM1_MDataByteEn,
	       app$wsi_s_adc_MByteEn,
	       app$wsi_s_adc_MReqInfo;
  ...
  wire [7 : 0] inf$wmiDP0_MDataByteEn, inf$wmiDP1_MDataByteEn;
  ...
  // submodule app
  mkOCApp8B #(.hasDebugLogic(1'd1)) app(.RST_N_rst_0(inf$RST_N_wci_m_0),
  ...
  // submodule inf
  mkOCInf8B inf(.pciDevice(pciDevice),
  ...
  assign app$wsi_s_adc_MByteEn = 8'h0 ;
  assign app$wsi_s_adc_MCmd = 3'h0 ;
  assign app$wsi_s_adc_MData = 64'h0 ;
