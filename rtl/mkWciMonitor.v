...
//
// On Tue Apr 26 09:22:07 EDT 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkWciMonitor(CLK,
  ...
  wire pmsender_idx_29_EQ_IF_pmsender_evF_first__30_B_ETC___d563;
  ...
  assign MUX_pmsender_wsiM_reqFifo_q_0$write_1__VAL_2 =
	     { 3'd1,
	       pmsender_idx_29_EQ_IF_pmsender_evF_first__30_B_ETC___d563,
	       1'd0,
  ...
  assign monId_CONCAT_IF_IF_pmsender_evF_first__30_BITS_ETC___d357 =
	     { monId,
	       ...
	       pmsender_srcTag,
	       x__h5656 } ;
  assign pmsender_idx_29_EQ_IF_pmsender_evF_first__30_B_ETC___d563 =
	     pmsender_idx == len__h4651 ;
  assign x_burstLength__h4721 = { 9'd0, len__h4651 } ;
  always@(pmsender_evF$D_OUT)
  begin
    case (pmsender_evF$D_OUT[98:96])
      3'd0: len__h4651 = 3'd1;
      3'd1: len__h4651 = 3'd2;
      3'd2: len__h4651 = 3'd3;
      default: len__h4651 = 3'd7;
    endcase
  end
  always@(pmsender_evF$D_OUT)
  begin
