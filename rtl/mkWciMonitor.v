...
//
// On Wed Jan  5 15:07:37 EST 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkWciMonitor(CLK,
  ...
  wire pmsender_idx_30_EQ_IF_pmsender_evF_first__31_B_ETC___d564;
  ...
  assign MUX_pmsender_wsiM_reqFifo_q_0$write_1__VAL_2 =
	     { 3'd1,
	       pmsender_idx_30_EQ_IF_pmsender_evF_first__31_B_ETC___d564,
	       1'd0,
  ...
  assign monId_CONCAT_IF_IF_pmsender_evF_first__31_BITS_ETC___d358 =
	     { monId,
	       ...
	       pmsender_srcTag,
	       x__h5595 } ;
  assign pmsender_idx_30_EQ_IF_pmsender_evF_first__31_B_ETC___d564 =
	     pmsender_idx == len__h4589 ;
  assign x__h1131 = { 12'd0, observer_r_mAddr } ;
  assign x_burstLength__h4660 = { 9'd0, len__h4589 } ;
  always@(pmsender_evF$D_OUT)
  begin
    case (pmsender_evF$D_OUT[98:96])
      3'd0: len__h4589 = 3'd1;
      3'd1: len__h4589 = 3'd2;
      3'd2: len__h4589 = 3'd3;
      default: len__h4589 = 3'd7;
    endcase
  end
  always@(pmsender_evF$D_OUT)
  begin
