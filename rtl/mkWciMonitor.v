...
//
// On Wed Jan 25 12:40:23 EST 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkWciMonitor(CLK,
  ...
  reg [63 : 0] v__h1502, v__h1525;
  reg [31 : 0] x_data__h4734;
  ...
  wire [11 : 0] x_burstLength__h4733;
  wire pmsender_idx_29_EQ_IF_pmsender_evF_first__30_B_ETC___d604;
  ...
  assign MUX_pmsender_wsiM_reqFifo_q_0$write_1__VAL_2 =
	     { 3'd1,
	       pmsender_idx_29_EQ_IF_pmsender_evF_first__30_B_ETC___d604,
	       1'd0,
	       x_burstLength__h4733,
	       x_data__h4734,
	       12'd3840 } ;
  ...
  assign monId_CONCAT_IF_IF_pmsender_evF_first__30_BITS_ETC___d381 =
	     { monId,
	       ...
	       pmsender_srcTag,
	       x__h5748 } ;
  assign pmsender_idx_29_EQ_IF_pmsender_evF_first__30_B_ETC___d604 =
	     pmsender_idx == len__h4664 ;
  assign x_burstLength__h4733 = { 9'd0, len__h4664 } ;
  always@(pmsender_evF$D_OUT)
  begin
    case (pmsender_evF$D_OUT[98:96])
      3'd0: len__h4664 = 3'd1;
      3'd1: len__h4664 = 3'd2;
      3'd2: len__h4664 = 3'd3;
      default: len__h4664 = 3'd7;
    endcase
  end
  always@(pmsender_evF$D_OUT)
  begin
  ...
  begin
    case (pmsender_idx)
      ...
      default: x_data__h4734 = pmsender_evF$D_OUT[31:0];
    endcase
  end
  ...
  begin
    ...
    if (RST_N)
      if (WILL_FIRE_RL_observer_reset_changed && observer_r_mResetn)
	$display("[%0d]: %m: WCI reset DE-ASSERTED", v__h1502);
    if (RST_N)
      if (WILL_FIRE_RL_observer_reset_changed && !observer_r_mResetn)
	begin
	  v__h1525 = $time;
    ...
    if (RST_N)
      if (WILL_FIRE_RL_observer_reset_changed && !observer_r_mResetn)
	$display("[%0d]: %m: WCI reset IS-ASSERTED", v__h1525);
  end
  // synopsys translate_on
