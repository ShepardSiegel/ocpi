...
//
// On Sun Jan 27 10:32:46 EST 2013
//
//
// Ports:
// Name                         I/O  size props
...
module mkWciMonitor(CLK,
  ...
  wire [1 : 0] pmsender_wsiM_reqFifo_cntr_r$D_IN;
  wire pmsender_wsiM_reqFifo_cntr_r$EN;
  ...
  wire [1 : 0] MUX_pmsender_wsiM_reqFifo_cntr_r$write_1__VAL_2;
  ...
  assign WILL_FIRE_RL_pmsender_serialize_message =
	     pmsender_wsiM_reqFifo_cntr_r != 2'd2 && pmsender_evF$EMPTY_N ;
  ...
  assign MUX_pmsender_wsiM_reqFifo_cntr_r$write_1__VAL_2 =
	     pmsender_wsiM_reqFifo_cntr_r + 2'd1 ;
  ...
  begin
    case (pmsender_idx)
      ...
      default: x_data__h4786 = pmsender_evF$D_OUT[31:0];
    endcase
  end
  ...
  begin
	...
	if (pmsender_wsiM_reqFifo_cntr_r$EN)
	  pmsender_wsiM_reqFifo_cntr_r <= `BSV_ASSIGNMENT_DELAY
	      pmsender_wsiM_reqFifo_cntr_r$D_IN;
