...
//
// On Sat Sep 29 14:28:39 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkWciMonitor(CLK,
  ...
  assign pmsender_idx_29_EQ_IF_pmsender_evF_first__30_B_ETC___d606 =
	     pmsender_idx == len__h4848 ;
  assign x_burstLength__h4918 = { 9'd0, len__h4848 } ;
  always@(pmsender_evF$D_OUT)
  begin
    case (pmsender_evF$D_OUT[98:96])
      3'd0: len__h4848 = 3'd1;
      3'd1: len__h4848 = 3'd2;
      3'd2: len__h4848 = 3'd3;
      default: len__h4848 = 3'd7;
    endcase
  end
  always@(pmsender_evF$D_OUT)
  begin
