...
//
// On Tue Jan  4 17:07:20 EST 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkWciMonitor(CLK,
  ...
  wire CAN_FIRE_RL_mkConnectionAVtoAf,
       ...
       CAN_FIRE_RL_pmsender_operate,
       CAN_FIRE_RL_pmsender_serialize_message,
       CAN_FIRE_RL_pmsender_wsiM_ext_status_assign,
       CAN_FIRE_RL_pmsender_wsiM_inc_tBusyCount,
       CAN_FIRE_RL_pmsender_wsiM_operateD__dreg_update,
       CAN_FIRE_RL_pmsender_wsiM_peerIsReady__dreg_update,
       CAN_FIRE_RL_pmsender_wsiM_reqFifo_both,
       CAN_FIRE_RL_pmsender_wsiM_reqFifo_decCtr,
       CAN_FIRE_RL_pmsender_wsiM_reqFifo_deq,
       CAN_FIRE_RL_pmsender_wsiM_reqFifo_incCtr,
       CAN_FIRE_RL_pmsender_wsiM_sThreadBusy_reg,
       CAN_FIRE_RL_pmsender_wsiM_update_statusR,
       ...
       WILL_FIRE_RL_pmsender_operate,
       WILL_FIRE_RL_pmsender_serialize_message,
       WILL_FIRE_RL_pmsender_wsiM_ext_status_assign,
       WILL_FIRE_RL_pmsender_wsiM_inc_tBusyCount,
       WILL_FIRE_RL_pmsender_wsiM_operateD__dreg_update,
       WILL_FIRE_RL_pmsender_wsiM_peerIsReady__dreg_update,
       ...
       WILL_FIRE_RL_pmsender_wsiM_sThreadBusy_reg,
       WILL_FIRE_RL_pmsender_wsiM_update_statusR,
  ...
  reg [4 : 0] CASE_pmsender_evFD_OUT_BITS_39_TO_32_22_0_0_1_ETC__q3,
	      CASE_pmsender_evFD_OUT_BITS_71_TO_64_22_0_0_1_ETC__q1,
	      CASE_pmsender_evFD_OUT_BITS_7_TO_0_22_0_0_1_1_ETC__q2,
	      CASE_pmsender_evFD_OUT_BITS_98_TO_96_CASE_pms_ETC__q4;
  reg [2 : 0] CASE_observer_evFD_OUT_BITS_98_TO_96_5_0_obse_ETC__q6,
	      len__h4577;
  wire [31 : 0] monId_CONCAT_IF_IF_pmsender_evF_first__33_BITS_ETC___d329,
		x__h1125;
  wire [11 : 0] x_burstLength__h4671;
  wire pmsender_idx_32_EQ_IF_pmsender_evF_first__33_B_ETC___d514;
  ...
  assign CAN_FIRE_RL_mkConnectionAVtoAf =
	     observer_evF$EMPTY_N && pmsender_evF$FULL_N ;
  ...
  // rule RL_pmsender_operate
  assign CAN_FIRE_RL_pmsender_operate = 1'd1 ;
  assign WILL_FIRE_RL_pmsender_operate = 1'd1 ;

  // rule RL_pmsender_serialize_message
  assign CAN_FIRE_RL_pmsender_serialize_message =
	     pmsender_wsiM_reqFifo_c_r != 2'd2 && pmsender_evF$EMPTY_N ;
  assign WILL_FIRE_RL_pmsender_serialize_message =
	     CAN_FIRE_RL_pmsender_serialize_message ;

  // rule RL_pmsender_wsiM_ext_status_assign
  assign CAN_FIRE_RL_pmsender_wsiM_ext_status_assign = 1'd1 ;
  assign WILL_FIRE_RL_pmsender_wsiM_ext_status_assign = 1'd1 ;

  // rule RL_pmsender_wsiM_inc_tBusyCount
  assign CAN_FIRE_RL_pmsender_wsiM_inc_tBusyCount =
	     pmsender_wsiM_operateD && pmsender_wsiM_peerIsReady &&
	     pmsender_wsiM_sThreadBusy_d ;
  assign WILL_FIRE_RL_pmsender_wsiM_inc_tBusyCount =
	     CAN_FIRE_RL_pmsender_wsiM_inc_tBusyCount ;

  // rule RL_pmsender_wsiM_update_statusR
  assign CAN_FIRE_RL_pmsender_wsiM_update_statusR = 1'd1 ;
  assign WILL_FIRE_RL_pmsender_wsiM_update_statusR = 1'd1 ;

  // rule RL_pmsender_wsiM_reqFifo_deq
  assign CAN_FIRE_RL_pmsender_wsiM_reqFifo_deq =
	     pmsender_wsiM_reqFifo_c_r != 2'd0 &&
	     !pmsender_wsiM_sThreadBusy_d ;
  assign WILL_FIRE_RL_pmsender_wsiM_reqFifo_deq =
	     CAN_FIRE_RL_pmsender_wsiM_reqFifo_deq ;

  // rule RL_pmsender_wsiM_sThreadBusy_reg
  assign CAN_FIRE_RL_pmsender_wsiM_sThreadBusy_reg = 1'd1 ;
  assign WILL_FIRE_RL_pmsender_wsiM_sThreadBusy_reg = 1'd1 ;

  // rule RL_pmsender_wsiM_reqFifo_incCtr
  assign CAN_FIRE_RL_pmsender_wsiM_reqFifo_incCtr =
	     ((pmsender_wsiM_reqFifo_c_r == 2'd0) ?
		CAN_FIRE_RL_pmsender_serialize_message :
  ...
  assign CAN_FIRE_RL_pmsender_wsiM_reqFifo_decCtr =
	     CAN_FIRE_RL_pmsender_wsiM_reqFifo_deq &&
	     !CAN_FIRE_RL_pmsender_serialize_message ;
  ...
  assign CAN_FIRE_RL_pmsender_wsiM_reqFifo_both =
	     ((pmsender_wsiM_reqFifo_c_r == 2'd1) ?
		CAN_FIRE_RL_pmsender_serialize_message :
  ...
  // rule RL_pmsender_wsiM_operateD__dreg_update
  assign CAN_FIRE_RL_pmsender_wsiM_operateD__dreg_update = 1'd1 ;
  assign WILL_FIRE_RL_pmsender_wsiM_operateD__dreg_update = 1'd1 ;

  // rule RL_pmsender_wsiM_peerIsReady__dreg_update
  assign CAN_FIRE_RL_pmsender_wsiM_peerIsReady__dreg_update = 1'd1 ;
  assign WILL_FIRE_RL_pmsender_wsiM_peerIsReady__dreg_update = 1'd1 ;
  ...
  assign MUX_observer_evF$enq_1__VAL_2 =
	     (observer_r_mCmd == 3'd1) ?
	       { 35'h2AAAAAA10, x__h1125, observer_r_mData } :
  ...
  assign MUX_pmsender_wsiM_reqFifo_q_0$write_1__VAL_1 =
	     { 3'd1,
	       pmsender_idx_32_EQ_IF_pmsender_evF_first__33_B_ETC___d514,
	       1'd0,
	       x_burstLength__h4671,
	       x_data__h4672,
	       12'd3840 } ;
  ...
  assign pmsender_idx$D_IN =
	     pmsender_idx_32_EQ_IF_pmsender_evF_first__33_B_ETC___d514 ?
	       3'd1 :
	       pmsender_idx + 3'd1 ;
  assign pmsender_idx$EN = CAN_FIRE_RL_pmsender_serialize_message ;
  ...
  assign pmsender_srcTag$EN = CAN_FIRE_RL_pmsender_serialize_message ;
  ...
  assign observer_evF$ENQ =
	     ...
	     (observer_r_mCmd == 3'd1 || observer_r_mCmd == 3'd2) ||
	     WILL_FIRE_RL_observer_reset_changed ;
  assign observer_evF$DEQ = CAN_FIRE_RL_mkConnectionAVtoAf ;
  ...
  assign pmsender_evF$ENQ = CAN_FIRE_RL_mkConnectionAVtoAf ;
  ...
  // remaining internal signals
  assign monId_CONCAT_IF_IF_pmsender_evF_first__33_BITS_ETC___d329 =
	     { monId,
	       CASE_CASE_pmsender_evFD_OUT_BITS_98_TO_96_CASE_ETC__q5,
	       pmsender_srcTag,
	       8'd0 } ;
  assign pmsender_idx_32_EQ_IF_pmsender_evF_first__33_B_ETC___d514 =
	     pmsender_idx == len__h4577 ;
  assign x__h1125 = { 12'd0, observer_r_mAddr } ;
  assign x_burstLength__h4671 = { 9'd0, len__h4577 } ;
  always@(pmsender_evF$D_OUT)
  begin
    case (pmsender_evF$D_OUT[98:96])
      3'd0: len__h4577 = 3'd1;
      3'd1: len__h4577 = 3'd2;
      3'd2: len__h4577 = 3'd3;
      default: len__h4577 = 3'd7;
    endcase
  end
  always@(pmsender_evF$D_OUT)
  begin
    case (pmsender_evF$D_OUT[71:64])
      8'd0: CASE_pmsender_evFD_OUT_BITS_71_TO_64_22_0_0_1_ETC__q1 = 5'd0;
      8'd1: CASE_pmsender_evFD_OUT_BITS_71_TO_64_22_0_0_1_ETC__q1 = 5'd1;
      8'd2: CASE_pmsender_evFD_OUT_BITS_71_TO_64_22_0_0_1_ETC__q1 = 5'd2;
      8'd3: CASE_pmsender_evFD_OUT_BITS_71_TO_64_22_0_0_1_ETC__q1 = 5'd3;
      8'd4: CASE_pmsender_evFD_OUT_BITS_71_TO_64_22_0_0_1_ETC__q1 = 5'd4;
      8'd5: CASE_pmsender_evFD_OUT_BITS_71_TO_64_22_0_0_1_ETC__q1 = 5'd5;
      8'd6: CASE_pmsender_evFD_OUT_BITS_71_TO_64_22_0_0_1_ETC__q1 = 5'd6;
      8'd7: CASE_pmsender_evFD_OUT_BITS_71_TO_64_22_0_0_1_ETC__q1 = 5'd7;
      8'd8: CASE_pmsender_evFD_OUT_BITS_71_TO_64_22_0_0_1_ETC__q1 = 5'd8;
      8'd9: CASE_pmsender_evFD_OUT_BITS_71_TO_64_22_0_0_1_ETC__q1 = 5'd9;
      8'd10: CASE_pmsender_evFD_OUT_BITS_71_TO_64_22_0_0_1_ETC__q1 = 5'd10;
      8'd11: CASE_pmsender_evFD_OUT_BITS_71_TO_64_22_0_0_1_ETC__q1 = 5'd11;
      8'd12: CASE_pmsender_evFD_OUT_BITS_71_TO_64_22_0_0_1_ETC__q1 = 5'd12;
      8'd13: CASE_pmsender_evFD_OUT_BITS_71_TO_64_22_0_0_1_ETC__q1 = 5'd13;
      8'd14: CASE_pmsender_evFD_OUT_BITS_71_TO_64_22_0_0_1_ETC__q1 = 5'd14;
      8'd16: CASE_pmsender_evFD_OUT_BITS_71_TO_64_22_0_0_1_ETC__q1 = 5'd15;
      8'd32: CASE_pmsender_evFD_OUT_BITS_71_TO_64_22_0_0_1_ETC__q1 = 5'd16;
      8'd48: CASE_pmsender_evFD_OUT_BITS_71_TO_64_22_0_0_1_ETC__q1 = 5'd17;
      8'd64: CASE_pmsender_evFD_OUT_BITS_71_TO_64_22_0_0_1_ETC__q1 = 5'd18;
      8'd128: CASE_pmsender_evFD_OUT_BITS_71_TO_64_22_0_0_1_ETC__q1 = 5'd19;
      8'd144: CASE_pmsender_evFD_OUT_BITS_71_TO_64_22_0_0_1_ETC__q1 = 5'd20;
      8'd160: CASE_pmsender_evFD_OUT_BITS_71_TO_64_22_0_0_1_ETC__q1 = 5'd21;
      default: CASE_pmsender_evFD_OUT_BITS_71_TO_64_22_0_0_1_ETC__q1 = 5'd22;
    endcase
  end
  always@(pmsender_evF$D_OUT)
  begin
    case (pmsender_evF$D_OUT[7:0])
      8'd0: CASE_pmsender_evFD_OUT_BITS_7_TO_0_22_0_0_1_1_ETC__q2 = 5'd0;
      8'd1: CASE_pmsender_evFD_OUT_BITS_7_TO_0_22_0_0_1_1_ETC__q2 = 5'd1;
      8'd2: CASE_pmsender_evFD_OUT_BITS_7_TO_0_22_0_0_1_1_ETC__q2 = 5'd2;
      8'd3: CASE_pmsender_evFD_OUT_BITS_7_TO_0_22_0_0_1_1_ETC__q2 = 5'd3;
      8'd4: CASE_pmsender_evFD_OUT_BITS_7_TO_0_22_0_0_1_1_ETC__q2 = 5'd4;
      8'd5: CASE_pmsender_evFD_OUT_BITS_7_TO_0_22_0_0_1_1_ETC__q2 = 5'd5;
      8'd6: CASE_pmsender_evFD_OUT_BITS_7_TO_0_22_0_0_1_1_ETC__q2 = 5'd6;
      8'd7: CASE_pmsender_evFD_OUT_BITS_7_TO_0_22_0_0_1_1_ETC__q2 = 5'd7;
      8'd8: CASE_pmsender_evFD_OUT_BITS_7_TO_0_22_0_0_1_1_ETC__q2 = 5'd8;
      8'd9: CASE_pmsender_evFD_OUT_BITS_7_TO_0_22_0_0_1_1_ETC__q2 = 5'd9;
      8'd10: CASE_pmsender_evFD_OUT_BITS_7_TO_0_22_0_0_1_1_ETC__q2 = 5'd10;
      8'd11: CASE_pmsender_evFD_OUT_BITS_7_TO_0_22_0_0_1_1_ETC__q2 = 5'd11;
      8'd12: CASE_pmsender_evFD_OUT_BITS_7_TO_0_22_0_0_1_1_ETC__q2 = 5'd12;
      8'd13: CASE_pmsender_evFD_OUT_BITS_7_TO_0_22_0_0_1_1_ETC__q2 = 5'd13;
      8'd14: CASE_pmsender_evFD_OUT_BITS_7_TO_0_22_0_0_1_1_ETC__q2 = 5'd14;
      8'd16: CASE_pmsender_evFD_OUT_BITS_7_TO_0_22_0_0_1_1_ETC__q2 = 5'd15;
      8'd32: CASE_pmsender_evFD_OUT_BITS_7_TO_0_22_0_0_1_1_ETC__q2 = 5'd16;
      8'd48: CASE_pmsender_evFD_OUT_BITS_7_TO_0_22_0_0_1_1_ETC__q2 = 5'd17;
      8'd64: CASE_pmsender_evFD_OUT_BITS_7_TO_0_22_0_0_1_1_ETC__q2 = 5'd18;
      8'd128: CASE_pmsender_evFD_OUT_BITS_7_TO_0_22_0_0_1_1_ETC__q2 = 5'd19;
      8'd144: CASE_pmsender_evFD_OUT_BITS_7_TO_0_22_0_0_1_1_ETC__q2 = 5'd20;
      8'd160: CASE_pmsender_evFD_OUT_BITS_7_TO_0_22_0_0_1_1_ETC__q2 = 5'd21;
      default: CASE_pmsender_evFD_OUT_BITS_7_TO_0_22_0_0_1_1_ETC__q2 = 5'd22;
    endcase
  end
  always@(pmsender_evF$D_OUT)
  begin
    case (pmsender_evF$D_OUT[39:32])
      8'd0: CASE_pmsender_evFD_OUT_BITS_39_TO_32_22_0_0_1_ETC__q3 = 5'd0;
      8'd1: CASE_pmsender_evFD_OUT_BITS_39_TO_32_22_0_0_1_ETC__q3 = 5'd1;
      8'd2: CASE_pmsender_evFD_OUT_BITS_39_TO_32_22_0_0_1_ETC__q3 = 5'd2;
      8'd3: CASE_pmsender_evFD_OUT_BITS_39_TO_32_22_0_0_1_ETC__q3 = 5'd3;
      8'd4: CASE_pmsender_evFD_OUT_BITS_39_TO_32_22_0_0_1_ETC__q3 = 5'd4;
      8'd5: CASE_pmsender_evFD_OUT_BITS_39_TO_32_22_0_0_1_ETC__q3 = 5'd5;
      8'd6: CASE_pmsender_evFD_OUT_BITS_39_TO_32_22_0_0_1_ETC__q3 = 5'd6;
      8'd7: CASE_pmsender_evFD_OUT_BITS_39_TO_32_22_0_0_1_ETC__q3 = 5'd7;
      8'd8: CASE_pmsender_evFD_OUT_BITS_39_TO_32_22_0_0_1_ETC__q3 = 5'd8;
      8'd9: CASE_pmsender_evFD_OUT_BITS_39_TO_32_22_0_0_1_ETC__q3 = 5'd9;
      8'd10: CASE_pmsender_evFD_OUT_BITS_39_TO_32_22_0_0_1_ETC__q3 = 5'd10;
      8'd11: CASE_pmsender_evFD_OUT_BITS_39_TO_32_22_0_0_1_ETC__q3 = 5'd11;
      8'd12: CASE_pmsender_evFD_OUT_BITS_39_TO_32_22_0_0_1_ETC__q3 = 5'd12;
      8'd13: CASE_pmsender_evFD_OUT_BITS_39_TO_32_22_0_0_1_ETC__q3 = 5'd13;
      8'd14: CASE_pmsender_evFD_OUT_BITS_39_TO_32_22_0_0_1_ETC__q3 = 5'd14;
      8'd16: CASE_pmsender_evFD_OUT_BITS_39_TO_32_22_0_0_1_ETC__q3 = 5'd15;
      8'd32: CASE_pmsender_evFD_OUT_BITS_39_TO_32_22_0_0_1_ETC__q3 = 5'd16;
      8'd48: CASE_pmsender_evFD_OUT_BITS_39_TO_32_22_0_0_1_ETC__q3 = 5'd17;
      8'd64: CASE_pmsender_evFD_OUT_BITS_39_TO_32_22_0_0_1_ETC__q3 = 5'd18;
      8'd128: CASE_pmsender_evFD_OUT_BITS_39_TO_32_22_0_0_1_ETC__q3 = 5'd19;
      8'd144: CASE_pmsender_evFD_OUT_BITS_39_TO_32_22_0_0_1_ETC__q3 = 5'd20;
      8'd160: CASE_pmsender_evFD_OUT_BITS_39_TO_32_22_0_0_1_ETC__q3 = 5'd21;
      default: CASE_pmsender_evFD_OUT_BITS_39_TO_32_22_0_0_1_ETC__q3 = 5'd22;
    endcase
  end
  always@(pmsender_evF$D_OUT or
	  CASE_pmsender_evFD_OUT_BITS_71_TO_64_22_0_0_1_ETC__q1 or
	  CASE_pmsender_evFD_OUT_BITS_7_TO_0_22_0_0_1_1_ETC__q2 or
	  CASE_pmsender_evFD_OUT_BITS_39_TO_32_22_0_0_1_ETC__q3)
  begin
    case (pmsender_evF$D_OUT[98:96])
      3'd0:
	  CASE_pmsender_evFD_OUT_BITS_98_TO_96_CASE_pms_ETC__q4 =
  ...
  begin
    case (CASE_pmsender_evFD_OUT_BITS_98_TO_96_CASE_pms_ETC__q4)
      ...
      5'd19: CASE_CASE_pmsender_evFD_OUT_BITS_98_TO_96_CASE_ETC__q5 = 8'd128;
      5'd20: CASE_CASE_pmsender_evFD_OUT_BITS_98_TO_96_CASE_ETC__q5 = 8'd144;
      5'd21: CASE_CASE_pmsender_evFD_OUT_BITS_98_TO_96_CASE_ETC__q5 = 8'd160;
  ...
  always@(pmsender_idx or
	  ...
	  monId_CONCAT_IF_IF_pmsender_evF_first__33_BITS_ETC___d329)
  begin
    case (pmsender_idx)
      3'd1:
	  x_data__h4672 =
      ...
      default: x_data__h4672 = pmsender_evF$D_OUT[31:0];
    endcase
  end
