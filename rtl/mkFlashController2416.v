...
//
// On Thu Jan 24 17:39:27 EST 2013
//
//
// Ports:
// Name                         I/O  size props
...
module mkFlashController2416(CLK,
  ...
  wire rseqFsm_abort$wget,
       rseqFsm_abort$whas,
       rseqFsm_start_reg_2$wget,
       rseqFsm_start_reg_2$whas,
       ...
       wseqFsm_abort$wget,
       wseqFsm_abort$whas,
       wseqFsm_start_reg_2$wget,
       wseqFsm_start_reg_2$whas,
  ...
  wire [6 : 0] wseqFsm_jj_1_delay_count$D_IN;
  wire wseqFsm_jj_1_delay_count$EN;
  ...
  wire [6 : 0] MUX_wseqFsm_jj_1_delay_count$write_1__VAL_1,
  ...
  assign MUX_wseqFsm_jj_1_delay_count$write_1__VAL_1 =
  ...
  assign rseqFsm_start_reg_2$wget = 1'd1 ;
  assign rseqFsm_start_reg_2$whas = rseqFsm_start_wire$whas ;
  ...
  assign wseqFsm_start_reg_2$wget = 1'd1 ;
  assign wseqFsm_start_reg_2$whas = wseqFsm_start_wire$whas ;
  ...
  // register wseqFsm_jj_1_delay_count
  assign wseqFsm_jj_1_delay_count$D_IN =
	     WILL_FIRE_RL_wseqFsm_action_np_2 ?
	       MUX_wseqFsm_jj_1_delay_count$write_1__VAL_1 :
	       7'd1 ;
  assign wseqFsm_jj_1_delay_count$EN =
	     WILL_FIRE_RL_wseqFsm_action_np_2 ||
	     WILL_FIRE_RL_wseqFsm_action_d_init_np_1 ;
  ...
  begin
	...
	if (wseqFsm_jj_1_delay_count$EN)
	  wseqFsm_jj_1_delay_count <= `BSV_ASSIGNMENT_DELAY
	      wseqFsm_jj_1_delay_count$D_IN;
