...
//
// On Sat Feb 12 10:47:09 EST 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkFlashController2416(CLK,
  ...
  wire [3 : 0] x__h11725, x__h24863;
  wire reqF_i_notEmpty__73_AND_IF_reqF_first__74_BIT__ETC___d193,
       rseqFsm_state_mkFSMstate_EQ_4_7_AND_NOT_rseqFs_ETC___d63,
       wseqFsm_state_mkFSMstate_3_EQ_5_03_AND_NOT_wse_ETC___d151;
  ...
  assign WILL_FIRE_RL_nextRequest =
	     reqF_i_notEmpty__73_AND_IF_reqF_first__74_BIT__ETC___d193 &&
  ...
  assign WILL_FIRE_RL_rseqFsm_actionof_l56c15_6 =
	     rseqFsm_state_mkFSMstate == 4'd1 && !rseqFsm_start_wire$whas &&
  ...
  assign CAN_FIRE_RL_rseqFsm_actionof_l57c12 =
	     ...
	     (rseqFsm_start_wire$whas || rseqFsm_state_standby) &&
	     isRead ;
  ...
  assign WILL_FIRE_RL_wseqFsm_actionof_l66c15_7 =
	     wseqFsm_state_mkFSMstate == 4'd1 && !wseqFsm_start_wire$whas &&
  ...
  assign CAN_FIRE_RL_wseqFsm_actionof_l67c12 =
	     ...
	     (wseqFsm_start_wire$whas || wseqFsm_state_standby) &&
	     !isRead ;
  ...
  assign rseqFsm_state_run_pw$whas =
	     ...
	     WILL_FIRE_RL_rseqFsm_actionof_l58c12 ||
	     WILL_FIRE_RL_rseqFsm_actionof_l57c12 ;
  assign rseqFsm_state_start_pw$whas = rseqFsm_start_wire$whas ;
  ...
  assign wseqFsm_state_run_pw$whas =
	     ...
	     WILL_FIRE_RL_wseqFsm_actionof_l68c12 ||
	     WILL_FIRE_RL_wseqFsm_actionof_l67c12 ;
  assign wseqFsm_state_start_pw$whas = wseqFsm_start_wire$whas ;
  ...
  assign rseqFsm_repeat_count$D_IN =
	     (rseqFsm_repeat_count == 4'd14) ? 4'd0 : x__h11725 ;
  ...
  assign rseqFsm_state_standby$EN =
	     rseqFsm_state_run_pw$whas || rseqFsm_start_wire$whas ;
  ...
  assign wseqFsm_repeat_count$D_IN =
	     (wseqFsm_repeat_count == 4'd14) ? 4'd0 : x__h24863 ;
  ...
  assign wseqFsm_state_standby$EN =
	     wseqFsm_state_run_pw$whas || wseqFsm_start_wire$whas ;
  ...
  // remaining internal signals
  assign reqF_i_notEmpty__73_AND_IF_reqF_first__74_BIT__ETC___d193 =
	     reqF$EMPTY_N &&
	     (reqF$D_OUT[40] ?
		(rseqFsm_state_mkFSMstate == 4'd7 ||
		 rseqFsm_state_mkFSMstate == 4'd1 &&
		...
		(wseqFsm_state_mkFSMstate == 4'd8 ||
		 ...
		 !wseqFsm_state_standby) &&
		!wseqFsm_start_reg) ;
  assign rseqFsm_state_mkFSMstate_EQ_4_7_AND_NOT_rseqFs_ETC___d63 =
	     rseqFsm_state_mkFSMstate == 4'd4 &&
	     rseqFsm_repeat_count == 4'd0 ;
  assign wseqFsm_state_mkFSMstate_3_EQ_5_03_AND_NOT_wse_ETC___d151 =
	     wseqFsm_state_mkFSMstate == 4'd5 &&
	     wseqFsm_repeat_count == 4'd0 ;
  assign x__h11725 = rseqFsm_repeat_count + 4'd1 ;
  assign x__h24863 = wseqFsm_repeat_count + 4'd1 ;
  ...
  begin
	...
	$write("");
    if (RST_N)
      if (wseqFsm_state_mkFSMstate_3_EQ_5_03_AND_NOT_wse_ETC___d151 &&
	  !isRead)
	$write("");
