...
//
// On Mon Feb  3 15:04:27 EST 2014
//
//
// Ports:
// Name                         I/O  size props
...
module mkAXBLUART(s_axi_aclk,
  ...
  reg [63 : 0] v__h6161, v__h6550, v__h6582;
  reg [31 : 0] v__h6235;
  reg [7 : 0] put__h3589;
  wire [31 : 0] rdat__h6319, rdat__h6325, v__h6356;
  wire [5 : 0] x__h3633;
  ...
  assign MUX_a4l_a4rdResp_fifof_cntr_r_write_1__VAL_2 =
	     a4l_a4rdResp_fifof_cntr_r + 2'd1 ;
  assign MUX_a4l_a4rdResp_fifof_q_0_write_1__VAL_1 = { 2'd0, v__h6235 } ;
  ...
  assign bluart_EN_rxChar_get =
	     WILL_FIRE_RL_a4l_cfrd && a4l_a4rdAddr_fifof_D_OUT[7:0] == 8'h30 ;
  ...
  assign a4l_a4wrResp_fifof_cntr_r_9_MINUS_1___d27 =
	     a4l_a4wrResp_fifof_cntr_r - 2'd1 ;
  assign rdat__h6319 = { 24'd0, bluart_txLevel } ;
  assign rdat__h6325 = { 24'd0, bluart_rxLevel } ;
  assign v__h6356 = { 24'd0, bluart_rxChar_get } ;
  assign x__h3633 = uartTxtP - 6'd2 ;
  always@(a4l_a4rdAddr_fifof_D_OUT or
	  bluart_rxChar_get or
	  r0 or r4 or r8 or rC or rdat__h6319 or rdat__h6325 or v__h6356)
  begin
    case (a4l_a4rdAddr_fifof_D_OUT[7:0])
      ...
      8'h08: v__h6235 = r8;
      8'h0C: v__h6235 = rC;
      8'h10: v__h6235 = 32'hDEADBEEF;
      8'h14: v__h6235 = 32'hBABECAFE;
      8'h18: v__h6235 = 32'hF00DFACE;
      8'h1C: v__h6235 = 32'hFEEDC0DE;
      8'h24: v__h6235 = rdat__h6319;
      8'h28: v__h6235 = rdat__h6325;
      8'h30: v__h6235 = v__h6356;
      default: v__h6235 = { 24'd0, bluart_rxChar_get };
    endcase
  end
  always@(x__h3633)
  begin
    case (x__h3633)
      6'd0, 6'd5, 6'd15: put__h3589 = 8'd65;
      6'd1: put__h3589 = 8'd88;
      6'd2: put__h3589 = 8'd66;
      6'd3, 6'd28, 6'd29: put__h3589 = 8'd76;
      6'd4: put__h3589 = 8'd85;
      6'd6, 6'd22: put__h3589 = 8'd82;
      6'd7: put__h3589 = 8'd84;
      6'd8: put__h3589 = 8'd46;
      6'd9: put__h3589 = 8'd98;
      6'd10, 6'd26: put__h3589 = 8'd115;
      6'd11: put__h3589 = 8'd118;
      6'd12, 6'd14, 6'd21, 6'd27, 6'd31, 6'd35: put__h3589 = 8'd32;
      6'd13: put__h3589 = 8'd45;
      6'd16: put__h3589 = 8'd116;
      6'd17: put__h3589 = 8'd111;
      6'd18: put__h3589 = 8'd109;
      6'd19: put__h3589 = 8'd105;
      6'd20, 6'd33: put__h3589 = 8'd99;
      6'd23: put__h3589 = 8'd117;
      6'd24: put__h3589 = 8'd108;
      6'd25: put__h3589 = 8'd101;
      6'd30: put__h3589 = 8'd67;
      6'd32: put__h3589 = 8'd40;
      6'd34: put__h3589 = 8'd41;
      6'd36: put__h3589 = 8'd50;
      6'd37: put__h3589 = 8'd48;
      6'd38: put__h3589 = 8'd49;
      6'd39: put__h3589 = 8'd52;
      default: put__h3589 = 8'b10101010 /* unspecified value */ ;
    endcase
  end
