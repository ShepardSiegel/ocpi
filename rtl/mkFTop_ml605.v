...
module mkFTop_ml605(sys0_clkp,
  ...
  wire [31 : 0] a4lm_rdData_w_wget;
  wire [7 : 0] pciw_pcie_irq_wInterruptDo_wget;
  wire [1 : 0] a4lm_rdResp_w_wget, a4lm_wrResp_w_wget, infLed_wget;
  wire a4lm_rdAddrRdy_w_wget,
       a4lm_rdAddrRdy_w_whas,
       a4lm_rdData_w_whas,
       a4lm_rdRespVal_w_wget,
       a4lm_rdRespVal_w_whas,
       a4lm_rdResp_w_whas,
       a4lm_wrAddrRdy_w_wget,
       a4lm_wrAddrRdy_w_whas,
       a4lm_wrDataRdy_w_wget,
       a4lm_wrDataRdy_w_whas,
       a4lm_wrRespVal_w_wget,
       a4lm_wrRespVal_w_whas,
       a4lm_wrResp_w_whas,
       blinkLed_wget,
  ...
  // ports of submodule axbluart
  wire [31 : 0] axbluart_s_axi_ARADDR,
		axbluart_s_axi_AWADDR,
		axbluart_s_axi_RDATA,
		axbluart_s_axi_WDATA;
  wire [3 : 0] axbluart_s_axi_WSTRB;
  wire [2 : 0] axbluart_s_axi_ARPROT, axbluart_s_axi_AWPROT;
  wire [1 : 0] axbluart_s_axi_BRESP, axbluart_s_axi_RRESP;
  wire axbluart_s_axi_ARREADY,
       axbluart_s_axi_ARVALID,
       axbluart_s_axi_AWREADY,
       axbluart_s_axi_AWVALID,
       axbluart_s_axi_BREADY,
       axbluart_s_axi_BVALID,
       axbluart_s_axi_RREADY,
       axbluart_s_axi_RVALID,
       axbluart_s_axi_WREADY,
       axbluart_s_axi_WVALID,
       axbluart_upads_cts_arg,
       axbluart_upads_rts,
       axbluart_upads_rx_arg,
       axbluart_upads_tx;
  ...
  // ports of submodule wmemiTap
  wire [127 : 0] wmemiTap_wmemiM0_MData,
		 wmemiTap_wmemiM0_SData,
		 wmemiTap_wmemiS0_MData,
		 wmemiTap_wmemiS0_SData;
  wire [35 : 0] wmemiTap_axiM0_wrData_data,
		wmemiTap_wmemiM0_MAddr,
		wmemiTap_wmemiS0_MAddr;
  wire [34 : 0] wmemiTap_axiM0_rdAddr_data, wmemiTap_axiM0_wrAddr_data;
  wire [33 : 0] wmemiTap_axiM0_rdResp_data_value;
  wire [15 : 0] wmemiTap_wmemiM0_MDataByteEn, wmemiTap_wmemiS0_MDataByteEn;
  wire [11 : 0] wmemiTap_wmemiM0_MBurstLength, wmemiTap_wmemiS0_MBurstLength;
  wire [2 : 0] wmemiTap_wmemiM0_MCmd, wmemiTap_wmemiS0_MCmd;
  wire [1 : 0] wmemiTap_axiM0_wrResp_data_value,
	       wmemiTap_wmemiM0_SResp,
	       wmemiTap_wmemiS0_SResp;
  wire wmemiTap_axiM0_rdAddr_ready_value,
       wmemiTap_axiM0_rdAddr_valid,
       wmemiTap_axiM0_rdResp_ready,
       wmemiTap_axiM0_rdResp_valid_value,
       wmemiTap_axiM0_wrAddr_ready_value,
       wmemiTap_axiM0_wrAddr_valid,
       wmemiTap_axiM0_wrData_ready_value,
       wmemiTap_axiM0_wrData_valid,
       wmemiTap_axiM0_wrResp_ready,
       wmemiTap_axiM0_wrResp_valid_value,
       wmemiTap_wmemiM0_MDataLast,
       wmemiTap_wmemiM0_MDataValid,
       wmemiTap_wmemiM0_MReqLast,
       wmemiTap_wmemiM0_MReset_n,
       wmemiTap_wmemiM0_SCmdAccept,
       wmemiTap_wmemiM0_SDataAccept,
       wmemiTap_wmemiM0_SRespLast,
       wmemiTap_wmemiS0_MDataLast,
       wmemiTap_wmemiS0_MDataValid,
       wmemiTap_wmemiS0_MReqLast,
       wmemiTap_wmemiS0_MReset_n,
       wmemiTap_wmemiS0_SCmdAccept,
       wmemiTap_wmemiS0_SDataAccept,
  ...
  wire [127 : 0] val_data__h6497, wOut_data__h6606;
  ...
  // value method upads_rts
  assign upads_rts = axbluart_upads_rts ;

  // value method upads_tx
  assign upads_tx = axbluart_upads_tx ;

  // submodule axbluart
  mkAXBLUART axbluart(.s_axi_aclk(pciw_pci0_pcie_ep_trn2_clk),
		      .s_axi_aresetn(pciw_p125rst_OUT_RST),
		      .s_axi_ARADDR(axbluart_s_axi_ARADDR),
		      .s_axi_ARPROT(axbluart_s_axi_ARPROT),
		      .s_axi_AWADDR(axbluart_s_axi_AWADDR),
		      .s_axi_AWPROT(axbluart_s_axi_AWPROT),
		      .s_axi_WDATA(axbluart_s_axi_WDATA),
		      .s_axi_WSTRB(axbluart_s_axi_WSTRB),
		      .upads_cts_arg(axbluart_upads_cts_arg),
		      .upads_rx_arg(axbluart_upads_rx_arg),
		      .s_axi_AWVALID(axbluart_s_axi_AWVALID),
		      .s_axi_WVALID(axbluart_s_axi_WVALID),
		      .s_axi_BREADY(axbluart_s_axi_BREADY),
		      .s_axi_ARVALID(axbluart_s_axi_ARVALID),
		      .s_axi_RREADY(axbluart_s_axi_RREADY),
		      .s_axi_AWREADY(axbluart_s_axi_AWREADY),
		      .s_axi_WREADY(axbluart_s_axi_WREADY),
		      .s_axi_BVALID(axbluart_s_axi_BVALID),
		      .s_axi_BRESP(axbluart_s_axi_BRESP),
		      .s_axi_ARREADY(axbluart_s_axi_ARREADY),
		      .s_axi_RVALID(axbluart_s_axi_RVALID),
		      .s_axi_RDATA(axbluart_s_axi_RDATA),
		      .s_axi_RRESP(axbluart_s_axi_RRESP),
		      .upads_rts(axbluart_upads_rts),
		      .upads_tx(axbluart_upads_tx));
  ...
  // submodule wmemiTap
  mkWmemiTap wmemiTap(.CLK(pciw_pci0_pcie_ep_trn2_clk),
		      .RST_N(pciw_p125rst_OUT_RST),
		      .axiM0_rdAddr_ready_value(wmemiTap_axiM0_rdAddr_ready_value),
		      .axiM0_rdResp_data_value(wmemiTap_axiM0_rdResp_data_value),
		      .axiM0_rdResp_valid_value(wmemiTap_axiM0_rdResp_valid_value),
		      .axiM0_wrAddr_ready_value(wmemiTap_axiM0_wrAddr_ready_value),
		      .axiM0_wrData_ready_value(wmemiTap_axiM0_wrData_ready_value),
		      .axiM0_wrResp_data_value(wmemiTap_axiM0_wrResp_data_value),
		      .axiM0_wrResp_valid_value(wmemiTap_axiM0_wrResp_valid_value),
		      .wmemiM0_SData(wmemiTap_wmemiM0_SData),
		      .wmemiM0_SResp(wmemiTap_wmemiM0_SResp),
		      .wmemiS0_MAddr(wmemiTap_wmemiS0_MAddr),
		      .wmemiS0_MBurstLength(wmemiTap_wmemiS0_MBurstLength),
		      .wmemiS0_MCmd(wmemiTap_wmemiS0_MCmd),
		      .wmemiS0_MData(wmemiTap_wmemiS0_MData),
		      .wmemiS0_MDataByteEn(wmemiTap_wmemiS0_MDataByteEn),
		      .wmemiS0_MReqLast(wmemiTap_wmemiS0_MReqLast),
		      .wmemiS0_MDataValid(wmemiTap_wmemiS0_MDataValid),
		      .wmemiS0_MDataLast(wmemiTap_wmemiS0_MDataLast),
		      .wmemiS0_MReset_n(wmemiTap_wmemiS0_MReset_n),
		      .wmemiM0_SRespLast(wmemiTap_wmemiM0_SRespLast),
		      .wmemiM0_SCmdAccept(wmemiTap_wmemiM0_SCmdAccept),
		      .wmemiM0_SDataAccept(wmemiTap_wmemiM0_SDataAccept),
		      .wmemiS0_SResp(wmemiTap_wmemiS0_SResp),
		      .wmemiS0_SRespLast(wmemiTap_wmemiS0_SRespLast),
		      .wmemiS0_SData(wmemiTap_wmemiS0_SData),
		      .wmemiS0_SCmdAccept(wmemiTap_wmemiS0_SCmdAccept),
		      .wmemiS0_SDataAccept(wmemiTap_wmemiS0_SDataAccept),
		      .wmemiM0_MCmd(wmemiTap_wmemiM0_MCmd),
		      .wmemiM0_MReqLast(wmemiTap_wmemiM0_MReqLast),
		      .wmemiM0_MAddr(wmemiTap_wmemiM0_MAddr),
		      .wmemiM0_MBurstLength(wmemiTap_wmemiM0_MBurstLength),
		      .wmemiM0_MDataValid(wmemiTap_wmemiM0_MDataValid),
		      .wmemiM0_MDataLast(wmemiTap_wmemiM0_MDataLast),
		      .wmemiM0_MData(wmemiTap_wmemiM0_MData),
		      .wmemiM0_MDataByteEn(wmemiTap_wmemiM0_MDataByteEn),
		      .wmemiM0_MReset_n(wmemiTap_wmemiM0_MReset_n),
		      .axiM0_wrAddr_data(wmemiTap_axiM0_wrAddr_data),
		      .axiM0_wrAddr_valid(wmemiTap_axiM0_wrAddr_valid),
		      .axiM0_wrData_data(wmemiTap_axiM0_wrData_data),
		      .axiM0_wrData_valid(wmemiTap_axiM0_wrData_valid),
		      .axiM0_wrResp_ready(wmemiTap_axiM0_wrResp_ready),
		      .axiM0_rdAddr_data(wmemiTap_axiM0_rdAddr_data),
		      .axiM0_rdAddr_valid(wmemiTap_axiM0_rdAddr_valid),
		      .axiM0_rdResp_ready(wmemiTap_axiM0_rdResp_ready));
  ...
  assign MUX_pciw_p2iS_write_1__VAL_1 =
	     { pciw_fP2I_D_OUT[80:72], val_be__h6496, val_data__h6497 } ;
  ...
  assign a4lm_wrAddrRdy_w_wget = 1'd1 ;
  assign a4lm_wrAddrRdy_w_whas = axbluart_s_axi_AWREADY ;
  assign a4lm_wrDataRdy_w_wget = 1'd1 ;
  assign a4lm_wrDataRdy_w_whas = axbluart_s_axi_WREADY ;
  assign a4lm_wrRespVal_w_wget = 1'd1 ;
  assign a4lm_wrRespVal_w_whas = axbluart_s_axi_BVALID ;
  assign a4lm_rdAddrRdy_w_wget = 1'd1 ;
  assign a4lm_rdAddrRdy_w_whas = axbluart_s_axi_ARREADY ;
  assign a4lm_rdRespVal_w_wget = 1'd1 ;
  assign a4lm_rdRespVal_w_whas = axbluart_s_axi_RVALID ;
  assign a4lm_wrResp_w_wget = axbluart_s_axi_BRESP ;
  assign a4lm_wrResp_w_whas = 1'd1 ;
  assign a4lm_rdData_w_wget = axbluart_s_axi_RDATA ;
  assign a4lm_rdData_w_whas = 1'd1 ;
  assign a4lm_rdResp_w_wget = axbluart_s_axi_RRESP ;
  assign a4lm_rdResp_w_whas = 1'd1 ;
  ...
  // submodule axbluart
  assign axbluart_s_axi_ARADDR = wmemiTap_axiM0_rdAddr_data[31:0] ;
  assign axbluart_s_axi_ARPROT = wmemiTap_axiM0_rdAddr_data[34:32] ;
  assign axbluart_s_axi_AWADDR = wmemiTap_axiM0_wrAddr_data[31:0] ;
  assign axbluart_s_axi_AWPROT = wmemiTap_axiM0_wrAddr_data[34:32] ;
  assign axbluart_s_axi_WDATA = wmemiTap_axiM0_wrData_data[31:0] ;
  assign axbluart_s_axi_WSTRB = wmemiTap_axiM0_wrData_data[35:32] ;
  assign axbluart_upads_cts_arg = upads_cts_arg ;
  assign axbluart_upads_rx_arg = upads_rx_arg ;
  assign axbluart_s_axi_AWVALID = wmemiTap_axiM0_wrAddr_valid ;
  assign axbluart_s_axi_WVALID = wmemiTap_axiM0_wrData_valid ;
  assign axbluart_s_axi_BREADY = wmemiTap_axiM0_wrResp_ready ;
  assign axbluart_s_axi_ARVALID = wmemiTap_axiM0_rdAddr_valid ;
  assign axbluart_s_axi_RREADY = wmemiTap_axiM0_rdResp_ready ;
  ...
  assign ctop_wmemiM0_SData = wmemiTap_wmemiS0_SData ;
  assign ctop_wmemiM0_SResp = wmemiTap_wmemiS0_SResp ;
  ...
  assign ctop_wmemiM0_SRespLast = wmemiTap_wmemiS0_SRespLast ;
  assign ctop_wmemiM0_SCmdAccept = wmemiTap_wmemiS0_SCmdAccept ;
  assign ctop_wmemiM0_SDataAccept = wmemiTap_wmemiS0_SDataAccept ;
  ...
  assign dram0_wmemiS0_MAddr = wmemiTap_wmemiM0_MAddr ;
  assign dram0_wmemiS0_MBurstLength = wmemiTap_wmemiM0_MBurstLength ;
  assign dram0_wmemiS0_MCmd = wmemiTap_wmemiM0_MCmd ;
  assign dram0_wmemiS0_MData = wmemiTap_wmemiM0_MData ;
  assign dram0_wmemiS0_MDataByteEn = wmemiTap_wmemiM0_MDataByteEn ;
  assign dram0_wmemiS0_MReqLast = wmemiTap_wmemiM0_MReqLast ;
  assign dram0_wmemiS0_MDataValid = wmemiTap_wmemiM0_MDataValid ;
  assign dram0_wmemiS0_MDataLast = wmemiTap_wmemiM0_MDataLast ;
  assign dram0_wmemiS0_MReset_n = wmemiTap_wmemiM0_MReset_n ;
  ...
  // submodule wmemiTap
  assign wmemiTap_axiM0_rdAddr_ready_value = axbluart_s_axi_ARREADY ;
  assign wmemiTap_axiM0_rdResp_data_value =
	     { axbluart_s_axi_RRESP, axbluart_s_axi_RDATA } ;
  assign wmemiTap_axiM0_rdResp_valid_value = axbluart_s_axi_RVALID ;
  assign wmemiTap_axiM0_wrAddr_ready_value = axbluart_s_axi_AWREADY ;
  assign wmemiTap_axiM0_wrData_ready_value = axbluart_s_axi_WREADY ;
  assign wmemiTap_axiM0_wrResp_data_value = axbluart_s_axi_BRESP ;
  assign wmemiTap_axiM0_wrResp_valid_value = axbluart_s_axi_BVALID ;
  assign wmemiTap_wmemiM0_SData = dram0_wmemiS0_SData ;
  assign wmemiTap_wmemiM0_SResp = dram0_wmemiS0_SResp ;
  assign wmemiTap_wmemiS0_MAddr = ctop_wmemiM0_MAddr ;
  assign wmemiTap_wmemiS0_MBurstLength = ctop_wmemiM0_MBurstLength ;
  assign wmemiTap_wmemiS0_MCmd = ctop_wmemiM0_MCmd ;
  assign wmemiTap_wmemiS0_MData = ctop_wmemiM0_MData ;
  assign wmemiTap_wmemiS0_MDataByteEn = ctop_wmemiM0_MDataByteEn ;
  assign wmemiTap_wmemiS0_MReqLast = ctop_wmemiM0_MReqLast ;
  assign wmemiTap_wmemiS0_MDataValid = ctop_wmemiM0_MDataValid ;
  assign wmemiTap_wmemiS0_MDataLast = ctop_wmemiM0_MDataLast ;
  assign wmemiTap_wmemiS0_MReset_n = ctop_wmemiM0_MReset_n ;
  assign wmemiTap_wmemiM0_SRespLast = dram0_wmemiS0_SRespLast ;
  assign wmemiTap_wmemiM0_SCmdAccept = dram0_wmemiS0_SCmdAccept ;
  assign wmemiTap_wmemiM0_SDataAccept = dram0_wmemiS0_SDataAccept ;
  ...
  assign pciw_p2iAF_head_wrapped_crossed__4_EQ_pciw_p2i_ETC___d123 =
	     ...
	     !pciw_p2iAF_sInReset_isInReset &&
	     pciw_preEdge_CLK_VAL ;
  assign val_be__h6496 = { pciw_fP2I_D_OUT[71:64], 8'd0 } ;
  assign val_data__h6497 = { pciw_fP2I_D_OUT[63:0], 64'hAAAAAAAAAAAAAAAA } ;
  assign wOut_be__h6605 =
	     { pciw_Prelude_inst_changeSpecialWires_1_rg[71:64],
	       pciw_fP2I_D_OUT[71:64] } ;
  assign wOut_data__h6606 =
