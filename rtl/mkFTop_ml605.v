...
//
// On Sat Apr 14 13:11:48 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkFTop_ml605(sys0_clkp,
  ...
  wire [13 : 0] mlB__h34261, mlInc__h34260;
  ...
  assign MUX_cap0_wci_wslv_respF_x_wire$wset_1__VAL_3 = { 2'd1, v__h36489 } ;
  ...
  assign cap0_statusReg_w$wget = rdat___1__h37972 ;
  ...
  assign cap0_mesgLengthSoFar$D_IN =
	     cap0_wsiS_reqFifo$D_OUT[57] ? 14'd0 : mlB__h34261 ;
  ...
  assign cap0_metaBram_memory$DIA = { 18'd0, mlB__h34261 } ;
  ...
  assign g_data__h38950 =
	     (cap0_wci_wslv_reqF$D_OUT[63:52] == 12'h0) ? v__h37875 : 32'd0 ;
  assign mlB__h34261 = cap0_mesgLengthSoFar + mlInc__h34260 ;
  assign mlInc__h34260 =
	     cap0_wsiS_reqFifo$D_OUT[57] ?
	       { 11'd0, x__h34309 + y__h34310 } :
	       14'd4 ;
  assign pciw_p2iAF_head_wrapped_crossed__4_EQ_pciw_p2i_ETC___d123 =
	     pciw_p2iAF_head_wrapped == pciw_p2iAF_tail_wrapped &&
	     !pciw_p2iAF_sInReset_isInReset &&
	     pciw_preEdge$CLK_VAL ;
  assign rdat___1__h37972 =
	     { 6'd40,
	       !cap0_metaCount_045_ULT_1024___d1495,
	       !cap0_dataCount_048_ULT_1024___d1496,
	       24'd2361866 } ;
  assign rdat___1__h38046 = { 24'd0, cap0_wsiS_statusR } ;
  assign v__h36489 =
	     cap0_splaF$D_OUT[2] ?
	       y_avValue__h37116 :
  ...
  assign x__h34309 = x__h34321 + y__h34322 ;
  assign x__h34321 = x__h34333 + y__h34334 ;
  assign x__h34333 = { 2'd0, cap0_wsiS_reqFifo$D_OUT[11] } ;
  assign y__h34310 = { 2'd0, cap0_wsiS_reqFifo$D_OUT[8] } ;
  assign y__h34322 = { 2'd0, cap0_wsiS_reqFifo$D_OUT[9] } ;
  assign y__h34334 = { 2'd0, cap0_wsiS_reqFifo$D_OUT[10] } ;
  assign y_avValue__h37116 =
	     cap0_dataBram_serverAdapterB_outDataCore$EMPTY_N ?
	       cap0_dataBram_serverAdapterB_outDataCore$D_OUT :
	       cap0_dataBram_memory$DOB ;
  assign y_avValue__h37160 =
	     cap0_metaBram_serverAdapterB_outDataCore$EMPTY_N ?
	       cap0_metaBram_serverAdapterB_outDataCore$D_OUT :
	       cap0_metaBram_memory$DOB ;
  assign y_avValue__h37200 =
	     cap0_metaBram_serverAdapterB_1_outDataCore$EMPTY_N ?
	       cap0_metaBram_serverAdapterB_1_outDataCore$D_OUT :
	       cap0_metaBram_memory_1$DOB ;
  assign y_avValue__h37240 =
	     cap0_metaBram_serverAdapterB_2_outDataCore$EMPTY_N ?
	       cap0_metaBram_serverAdapterB_2_outDataCore$D_OUT :
	       cap0_metaBram_memory_2$DOB ;
  assign y_avValue__h37280 =
	     cap0_metaBram_serverAdapterB_3_outDataCore$EMPTY_N ?
	       cap0_metaBram_serverAdapterB_3_outDataCore$D_OUT :
	       cap0_metaBram_memory_3$DOB ;
  ...
  always@(cap0_splaF$D_OUT or
	  y_avValue__h37280 or
	  y_avValue__h37160 or y_avValue__h37200 or y_avValue__h37240)
  begin
  ...
  always@(cap0_wci_wslv_reqF$D_OUT or
	  ...
	  cap0_metaCount or
	  cap0_dataCount or
	  rdat___1__h37972 or rdat___1__h38046 or cap0_wsiS_extStatusW$wget)
  begin
    case (cap0_wci_wslv_reqF$D_OUT[39:32])
      8'h0: v__h37875 = cap0_controlReg;
      8'h04: v__h37875 = cap0_metaCount;
      8'h08: v__h37875 = cap0_dataCount;
      8'h0C: v__h37875 = rdat___1__h37972;
      8'h10: v__h37875 = rdat___1__h38046;
      8'h14: v__h37875 = cap0_wsiS_extStatusW$wget[95:64];
      8'h18: v__h37875 = cap0_wsiS_extStatusW$wget[63:32];
      8'h1C: v__h37875 = cap0_wsiS_extStatusW$wget[31:0];
      default: v__h37875 = 32'd0;
    endcase
  end
  always@(cap0_splaF$D_OUT or
  ...
  begin
    ...
    if (ctop$RST_N_wci_m_3)
      if (WILL_FIRE_RL_cap0_advance_split_response)
	$display("[%0d]: %m: WCI SPLIT READ Data:%0x", v__h37408, v__h36489);
    if (ctop$RST_N_wci_m_3)
      if (WILL_FIRE_RL_cap0_advance_split_response &&
	  WILL_FIRE_RL_cap0_wci_ctrl_OrE)
