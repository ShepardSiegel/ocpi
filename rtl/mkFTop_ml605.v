...
//
// On Tue Nov  5 11:24:33 EST 2013
//
//
// Ports:
// Name                         I/O  size props
...
module mkFTop_ml605(sys0_clkp,
  ...
  wire [80 : 0] MUX_pciw_fI2P$enq_1__VAL_2;
  ...
  mkDramServer_v6 #(.hasDebugLogic(1'd1)) dram0(.CLK_sys0_clk(sys0_clk$O),
						...
						.isInReset(dram0$isInReset),
						.isReset(dram0$isReset),
						.isTrained(dram0$isTrained),
  ...
  assign MUX_pciw_Prelude_inst_changeSpecialWires_2_rg$write_1__VAL_1 =
	     { 2'd2,
	       ...
	       pciw_i2pS[135:128],
	       pciw_i2pS[63:0] } ;
  assign MUX_pciw_fI2P$enq_1__VAL_2 =
	     (pciw_i2pS[135:128] == 8'd0) ?
  ...
  assign MUX_pciw_p2iS$write_1__VAL_1 =
	     { pciw_fP2I$D_OUT[80:72], val_be__h6495, val_data__h6496 } ;
  ...
  assign pciw_p2iAF_head_wrapped_crossed__4_EQ_pciw_p2i_ETC___d123 =
	     ...
	     !pciw_p2iAF_sInReset_isInReset &&
	     pciw_preEdge$CLK_VAL ;
  assign val_be__h6495 = { pciw_fP2I$D_OUT[71:64], 8'd0 } ;
  assign val_data__h6496 = { pciw_fP2I$D_OUT[63:0], 64'hAAAAAAAAAAAAAAAA } ;
