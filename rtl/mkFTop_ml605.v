...
//
// On Fri Aug 19 10:59:25 EDT 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkFTop_ml605(sys0_clkp,
  ...
  // register pmemMonW8_pmGrab
  assign pmemMonW8_pmGrab$D_IN = z__h14598 ^ pmemMonW8_pmh[31] ;
  ...
  assign z__h14395 = pmemMonW8_pmh[0] ^ pmemMonW8_pmh[1] ;
  assign z__h14402 = z__h14395 ^ pmemMonW8_pmh[2] ;
  assign z__h14409 = z__h14402 ^ pmemMonW8_pmh[3] ;
  assign z__h14416 = z__h14409 ^ pmemMonW8_pmh[4] ;
  assign z__h14423 = z__h14416 ^ pmemMonW8_pmh[5] ;
  assign z__h14430 = z__h14423 ^ pmemMonW8_pmh[6] ;
  assign z__h14437 = z__h14430 ^ pmemMonW8_pmh[7] ;
  assign z__h14444 = z__h14437 ^ pmemMonW8_pmh[8] ;
  assign z__h14451 = z__h14444 ^ pmemMonW8_pmh[9] ;
  assign z__h14458 = z__h14451 ^ pmemMonW8_pmh[10] ;
  assign z__h14465 = z__h14458 ^ pmemMonW8_pmh[11] ;
  assign z__h14472 = z__h14465 ^ pmemMonW8_pmh[12] ;
  assign z__h14479 = z__h14472 ^ pmemMonW8_pmh[13] ;
  assign z__h14486 = z__h14479 ^ pmemMonW8_pmh[14] ;
  assign z__h14493 = z__h14486 ^ pmemMonW8_pmh[15] ;
  assign z__h14500 =
	     z__h14493 ^
	     IF_pmemMonW8_pmh_90_BITS_23_TO_16_22_EQ_0_23_O_ETC___d760[0] ;
  assign z__h14507 =
	     z__h14500 ^
	     IF_pmemMonW8_pmh_90_BITS_23_TO_16_22_EQ_0_23_O_ETC___d760[1] ;
  assign z__h14514 =
	     z__h14507 ^
	     IF_pmemMonW8_pmh_90_BITS_23_TO_16_22_EQ_0_23_O_ETC___d760[2] ;
  assign z__h14521 =
	     z__h14514 ^
	     IF_pmemMonW8_pmh_90_BITS_23_TO_16_22_EQ_0_23_O_ETC___d760[3] ;
  assign z__h14528 =
	     z__h14521 ^
	     IF_pmemMonW8_pmh_90_BITS_23_TO_16_22_EQ_0_23_O_ETC___d760[4] ;
  assign z__h14535 =
	     z__h14528 ^
	     IF_pmemMonW8_pmh_90_BITS_23_TO_16_22_EQ_0_23_O_ETC___d760[5] ;
  assign z__h14542 =
	     z__h14535 ^
	     IF_pmemMonW8_pmh_90_BITS_23_TO_16_22_EQ_0_23_O_ETC___d760[6] ;
  assign z__h14549 =
	     z__h14542 ^
	     IF_pmemMonW8_pmh_90_BITS_23_TO_16_22_EQ_0_23_O_ETC___d760[7] ;
  assign z__h14556 = z__h14549 ^ pmemMonW8_pmh[24] ;
  assign z__h14563 = z__h14556 ^ pmemMonW8_pmh[25] ;
  assign z__h14570 = z__h14563 ^ pmemMonW8_pmh[26] ;
  assign z__h14577 = z__h14570 ^ pmemMonW8_pmh[27] ;
  assign z__h14584 = z__h14577 ^ pmemMonW8_pmh[28] ;
  assign z__h14591 = z__h14584 ^ pmemMonW8_pmh[29] ;
  assign z__h14598 = z__h14591 ^ pmemMonW8_pmh[30] ;
  ...
  begin
    case (pmemMonW8_pmh[23:16])
	  ...
	  IF_pmemMonW8_pmh_90_BITS_23_TO_16_22_EQ_0_23_O_ETC___d760 =
	      pmemMonW8_pmh[23:16];
      default: IF_pmemMonW8_pmh_90_BITS_23_TO_16_22_EQ_0_23_O_ETC___d760 =
		   8'd255;
    endcase
  end
  ...
  begin
    ...
    if (pciw_p125rst$OUT_RST_N)
      if (WILL_FIRE_RL_pmemMonW8_get_message_head_dw)
	$write("[%0d]: %m: PMEM HEAD: ", v__h15880);
    if (pciw_p125rst$OUT_RST_N)
