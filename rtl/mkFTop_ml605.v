...
//
// On Mon Mar 21 09:54:48 EDT 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkFTop_ml605(sys0_clkp,
  ...
  reg [63 : 0] v__h17291, v__h18785;
  reg [7 : 0] CASE_pmemMonW8_pmemFD_OUT_BITS_23_TO_16_255_0_ETC__q2,
	      CASE_pmemMonW8_wsiS_reqFifoD_OUT_BITS_35_TO_2_ETC__q1,
	      IF_pmemMonW8_pmh_97_BITS_23_TO_16_29_EQ_0_30_O_ETC___d780;
  wire [127 : 0] val_data__h5898, wOut_data__h6004;
  wire [15 : 0] val_be__h5897, wOut_be__h6003;
  wire _dor1pmemMonW8_eventCount$EN_write,
       pciw_p2iAF_head_wrapped_crossed__4_EQ_pciw_p2i_ETC___d99,
  ...
  assign MUX_pciw_p2iS$write_1__VAL_1 =
	     { pciw_fP2I$D_OUT[80:72], val_be__h5897, val_data__h5898 } ;
  ...
  // inlined wires
  assign pciw_pcie_irq_wInterruptRdyN$wget = 1'b0 /* unspecified value */  ;
  ...
  // register pciw_pcie_irq_rMMEnabled
  assign pciw_pcie_irq_rMMEnabled$D_IN = 3'b010 /* unspecified value */  ;
  assign pciw_pcie_irq_rMMEnabled$EN = 1'd1 ;

  // register pciw_pcie_irq_rMSIEnabled
  assign pciw_pcie_irq_rMSIEnabled$D_IN = 1'b0 /* unspecified value */  ;
  ...
  // register pmemMonW8_pmGrab
  assign pmemMonW8_pmGrab$D_IN = z__h16009 ^ pmemMonW8_pmh[31] ;
  ...
  // submodule pciw_pci0_pcie_ep
  assign pciw_pci0_pcie_ep$cfg_byte_en = 4'h0 ;
  assign pciw_pci0_pcie_ep$cfg_di = 32'h0 ;
  assign pciw_pci0_pcie_ep$cfg_dsn = 64'h0 ;
  assign pciw_pci0_pcie_ep$cfg_dwaddr = 10'h0 ;
  assign pciw_pci0_pcie_ep$cfg_err_cor = 1'b0 ;
  assign pciw_pci0_pcie_ep$cfg_err_cpl_abort = 1'b0 ;
  assign pciw_pci0_pcie_ep$cfg_err_cpl_timeout = 1'b0 ;
  assign pciw_pci0_pcie_ep$cfg_err_cpl_unexpect = 1'b0 ;
  assign pciw_pci0_pcie_ep$cfg_err_ecrc = 1'b0 ;
  assign pciw_pci0_pcie_ep$cfg_err_locked = 1'b0 ;
  assign pciw_pci0_pcie_ep$cfg_err_posted = 1'b0 ;
  assign pciw_pci0_pcie_ep$cfg_err_tlp_cpl_header = 48'h0 ;
  assign pciw_pci0_pcie_ep$cfg_err_ur = 1'b0 ;
  assign pciw_pci0_pcie_ep$cfg_interrupt = 1'b0 ;
  assign pciw_pci0_pcie_ep$cfg_interrupt_assert = 1'b0 ;
  assign pciw_pci0_pcie_ep$cfg_interrupt_di = 8'h0 ;
  assign pciw_pci0_pcie_ep$cfg_pm_wake = 1'b0 ;
  assign pciw_pci0_pcie_ep$cfg_rd_en = 1'b0 ;
  assign pciw_pci0_pcie_ep$cfg_trn_pending = 1'b0 ;
  assign pciw_pci0_pcie_ep$cfg_turnoff_ok = 1'b0 ;
  assign pciw_pci0_pcie_ep$cfg_wr_en = 1'b0 ;
  assign pciw_pci0_pcie_ep$fc_sel = 3'h0 ;
  ...
  assign pciw_pci0_pcie_ep$rx_np_ok = 1'b0 ;
  ...
  assign pciw_pci0_pcie_ep$tx_cfg_gnt = 1'b0 ;
  ...
  assign _dor1pmemMonW8_eventCount$EN_write =
	     WILL_FIRE_RL_pmemMonW8_gen_message_body_dw ||
	     WILL_FIRE_RL_pmemMonW8_get_message_head_dw ;
  assign pciw_p2iAF_head_wrapped_crossed__4_EQ_pciw_p2i_ETC___d99 =
	     pciw_p2iAF_head_wrapped == pciw_p2iAF_tail_wrapped &&
	     !pciw_p2iAF_sInReset_isInReset &&
	     pciw_preEdge$CLK_VAL ;
  assign pmemMonW8_wsiS_reqFifo_notFull__17_AND_pmemMon_ETC___d239 =
	     ...
	     (pmemMonW8_wsiS_burstKind == 2'd0 ||
	      (pmemMonW8_wsiS_burstKind == 2'd1 ||
	       pmemMonW8_wsiS_burstKind == 2'd2) &&
	      pmemMonW8_wsiS_wsiReq$wget[57]) ;
  assign val_be__h5897 = { pciw_fP2I$D_OUT[71:64], 8'd0 } ;
  assign val_data__h5898 = { pciw_fP2I$D_OUT[63:0], 64'hAAAAAAAAAAAAAAAA } ;
  assign wOut_be__h6003 =
	     { pciw_Prelude_inst_changeSpecialWires_1_rg[71:64],
	       pciw_fP2I$D_OUT[71:64] } ;
  assign wOut_data__h6004 =
	     { pciw_Prelude_inst_changeSpecialWires_1_rg[63:0],
	       pciw_fP2I$D_OUT[63:0] } ;
  assign z__h15806 = pmemMonW8_pmh[0] ^ pmemMonW8_pmh[1] ;
  assign z__h15813 = z__h15806 ^ pmemMonW8_pmh[2] ;
  assign z__h15820 = z__h15813 ^ pmemMonW8_pmh[3] ;
  assign z__h15827 = z__h15820 ^ pmemMonW8_pmh[4] ;
  assign z__h15834 = z__h15827 ^ pmemMonW8_pmh[5] ;
  assign z__h15841 = z__h15834 ^ pmemMonW8_pmh[6] ;
  assign z__h15848 = z__h15841 ^ pmemMonW8_pmh[7] ;
  assign z__h15855 = z__h15848 ^ pmemMonW8_pmh[8] ;
  assign z__h15862 = z__h15855 ^ pmemMonW8_pmh[9] ;
  assign z__h15869 = z__h15862 ^ pmemMonW8_pmh[10] ;
  assign z__h15876 = z__h15869 ^ pmemMonW8_pmh[11] ;
  assign z__h15883 = z__h15876 ^ pmemMonW8_pmh[12] ;
  assign z__h15890 = z__h15883 ^ pmemMonW8_pmh[13] ;
  assign z__h15897 = z__h15890 ^ pmemMonW8_pmh[14] ;
  assign z__h15904 = z__h15897 ^ pmemMonW8_pmh[15] ;
  assign z__h15911 =
	     z__h15904 ^
	     IF_pmemMonW8_pmh_97_BITS_23_TO_16_29_EQ_0_30_O_ETC___d780[0] ;
  assign z__h15918 =
	     z__h15911 ^
	     IF_pmemMonW8_pmh_97_BITS_23_TO_16_29_EQ_0_30_O_ETC___d780[1] ;
  assign z__h15925 =
	     z__h15918 ^
	     IF_pmemMonW8_pmh_97_BITS_23_TO_16_29_EQ_0_30_O_ETC___d780[2] ;
  assign z__h15932 =
	     z__h15925 ^
	     IF_pmemMonW8_pmh_97_BITS_23_TO_16_29_EQ_0_30_O_ETC___d780[3] ;
  assign z__h15939 =
	     z__h15932 ^
	     IF_pmemMonW8_pmh_97_BITS_23_TO_16_29_EQ_0_30_O_ETC___d780[4] ;
  assign z__h15946 =
	     z__h15939 ^
	     IF_pmemMonW8_pmh_97_BITS_23_TO_16_29_EQ_0_30_O_ETC___d780[5] ;
  assign z__h15953 =
	     z__h15946 ^
	     IF_pmemMonW8_pmh_97_BITS_23_TO_16_29_EQ_0_30_O_ETC___d780[6] ;
  assign z__h15960 =
	     z__h15953 ^
	     IF_pmemMonW8_pmh_97_BITS_23_TO_16_29_EQ_0_30_O_ETC___d780[7] ;
  assign z__h15967 = z__h15960 ^ pmemMonW8_pmh[24] ;
  assign z__h15974 = z__h15967 ^ pmemMonW8_pmh[25] ;
  assign z__h15981 = z__h15974 ^ pmemMonW8_pmh[26] ;
  assign z__h15988 = z__h15981 ^ pmemMonW8_pmh[27] ;
  assign z__h15995 = z__h15988 ^ pmemMonW8_pmh[28] ;
  assign z__h16002 = z__h15995 ^ pmemMonW8_pmh[29] ;
  assign z__h16009 = z__h16002 ^ pmemMonW8_pmh[30] ;
  ...
  begin
    case (pmemMonW8_pmh[23:16])
	  ...
	  IF_pmemMonW8_pmh_97_BITS_23_TO_16_29_EQ_0_30_O_ETC___d780 =
	      pmemMonW8_pmh[23:16];
      default: IF_pmemMonW8_pmh_97_BITS_23_TO_16_29_EQ_0_30_O_ETC___d780 =
		   8'd255;
    endcase
  end
  ...
  begin
    ...
    if (pciw_p125rst$OUT_RST_N)
      if (WILL_FIRE_RL_pmemMonW8_get_message_head_dw)
	$write("[%0d]: %m: PMEM HEAD: ", v__h17291);
    if (pciw_p125rst$OUT_RST_N)
