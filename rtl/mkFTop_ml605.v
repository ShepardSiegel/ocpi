...
//
// On Wed May 23 14:26:45 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkFTop_ml605(sys0_clkp,
  ...
  wire [13 : 0] mlB__h34298, mlInc__h34297;
  ...
  wire IF_cap0_splaF_first__108_BITS_1_TO_0_110_EQ_0__ETC___d1138,
       ...
       cap0_dataCount_048_ULT_1024___d1523,
       cap0_metaCount_045_ULT_1024___d1522,
  ...
  assign MUX_cap0_wci_wslv_respF_x_wire$wset_1__VAL_3 = { 2'd1, v__h36526 } ;
  ...
  assign cap0_statusReg_w$wget = rdat___1__h38009 ;
  ...
  assign cap0_mesgLengthSoFar$D_IN =
	     cap0_wsiS_reqFifo$D_OUT[57] ? 14'd0 : mlB__h34298 ;
  ...
  assign cap0_metaBram_memory$DIA = { 18'd0, mlB__h34298 } ;
  ...
  assign cap0_dataBram_serverAdapterB_cnt_32_PLUS_IF_ca_ETC___d538 =
		...
		3'd7 :
		3'd0) ;
  assign cap0_dataCount_048_ULT_1024___d1523 = cap0_dataCount < 32'd1024 ;
  ...
  assign cap0_metaBram_serverAdapterB_cnt_50_PLUS_IF_ca_ETC___d656 =
		...
		3'd7 :
		3'd0) ;
  assign cap0_metaCount_045_ULT_1024___d1522 = cap0_metaCount < 32'd1024 ;
  ...
  assign g_data__h38987 =
	     (cap0_wci_wslv_reqF$D_OUT[63:52] == 12'h0) ? v__h37912 : 32'd0 ;
  assign mlB__h34298 = cap0_mesgLengthSoFar + mlInc__h34297 ;
  assign mlInc__h34297 =
	     cap0_wsiS_reqFifo$D_OUT[57] ?
	       { 11'd0, x__h34346 + y__h34347 } :
	       14'd4 ;
  assign pciw_p2iAF_head_wrapped_crossed__4_EQ_pciw_p2i_ETC___d123 =
	     pciw_p2iAF_head_wrapped == pciw_p2iAF_tail_wrapped &&
	     !pciw_p2iAF_sInReset_isInReset &&
	     pciw_preEdge$CLK_VAL ;
  assign rdat___1__h38009 =
	     { 6'd40,
	       !cap0_metaCount_045_ULT_1024___d1522,
	       !cap0_dataCount_048_ULT_1024___d1523,
	       24'd2361866 } ;
  assign rdat___1__h38083 = { 24'd0, cap0_wsiS_statusR } ;
  assign v__h36526 =
	     cap0_splaF$D_OUT[2] ?
	       y_avValue__h37153 :
  ...
  assign x__h34346 = x__h34358 + y__h34359 ;
  assign x__h34358 = x__h34370 + y__h34371 ;
  assign x__h34370 = { 2'd0, cap0_wsiS_reqFifo$D_OUT[11] } ;
  assign y__h34347 = { 2'd0, cap0_wsiS_reqFifo$D_OUT[8] } ;
  assign y__h34359 = { 2'd0, cap0_wsiS_reqFifo$D_OUT[9] } ;
  assign y__h34371 = { 2'd0, cap0_wsiS_reqFifo$D_OUT[10] } ;
  assign y_avValue__h37153 =
	     cap0_dataBram_serverAdapterB_outDataCore$EMPTY_N ?
	       cap0_dataBram_serverAdapterB_outDataCore$D_OUT :
	       cap0_dataBram_memory$DOB ;
  assign y_avValue__h37197 =
	     cap0_metaBram_serverAdapterB_outDataCore$EMPTY_N ?
	       cap0_metaBram_serverAdapterB_outDataCore$D_OUT :
	       cap0_metaBram_memory$DOB ;
  assign y_avValue__h37237 =
	     cap0_metaBram_serverAdapterB_1_outDataCore$EMPTY_N ?
	       cap0_metaBram_serverAdapterB_1_outDataCore$D_OUT :
	       cap0_metaBram_memory_1$DOB ;
  assign y_avValue__h37277 =
	     cap0_metaBram_serverAdapterB_2_outDataCore$EMPTY_N ?
	       cap0_metaBram_serverAdapterB_2_outDataCore$D_OUT :
	       cap0_metaBram_memory_2$DOB ;
  assign y_avValue__h37317 =
	     cap0_metaBram_serverAdapterB_3_outDataCore$EMPTY_N ?
	       cap0_metaBram_serverAdapterB_3_outDataCore$D_OUT :
	       cap0_metaBram_memory_3$DOB ;
  ...
  always@(cap0_splaF$D_OUT or
	  y_avValue__h37317 or
	  y_avValue__h37197 or y_avValue__h37237 or y_avValue__h37277)
  begin
  ...
  always@(cap0_wci_wslv_reqF$D_OUT or
	  ...
	  cap0_metaCount or
	  cap0_dataCount or
	  rdat___1__h38009 or rdat___1__h38083 or cap0_wsiS_extStatusW$wget)
  begin
    case (cap0_wci_wslv_reqF$D_OUT[39:32])
      8'h0: v__h37912 = cap0_controlReg;
      8'h04: v__h37912 = cap0_metaCount;
      8'h08: v__h37912 = cap0_dataCount;
      8'h0C: v__h37912 = rdat___1__h38009;
      8'h10: v__h37912 = rdat___1__h38083;
      8'h14: v__h37912 = cap0_wsiS_extStatusW$wget[95:64];
      8'h18: v__h37912 = cap0_wsiS_extStatusW$wget[63:32];
      8'h1C: v__h37912 = cap0_wsiS_extStatusW$wget[31:0];
      default: v__h37912 = 32'd0;
    endcase
  end
  always@(cap0_splaF$D_OUT or
  ...
  begin
    ...
    if (ctop$RST_N_wci_m_3)
      if (WILL_FIRE_RL_cap0_advance_split_response)
	$display("[%0d]: %m: WCI SPLIT READ Data:%0x", v__h37445, v__h36526);
    if (ctop$RST_N_wci_m_3)
      if (WILL_FIRE_RL_cap0_advance_split_response &&
	  WILL_FIRE_RL_cap0_wci_ctrl_OrE)
