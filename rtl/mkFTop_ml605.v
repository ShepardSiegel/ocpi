...
//
// On Sun Mar 20 12:53:50 EDT 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkFTop_ml605(sys0_clkp,
  ...
  reg [63 : 0] v__h17268, v__h18762;
  reg [7 : 0] CASE_pmemMonW8_pmemFD_OUT_BITS_23_TO_16_255_0_ETC__q2,
	      CASE_pmemMonW8_wsiS_reqFifoD_OUT_BITS_35_TO_2_ETC__q1,
	      IF_pmemMonW8_pmh_97_BITS_23_TO_16_29_EQ_0_30_O_ETC___d687;
  wire [127 : 0] val_data__h5875, wOut_data__h5981;
  wire [15 : 0] val_be__h5874, wOut_be__h5980;
  ...
  // submodule flash0
  mkFlashWorker flash0(.wciS0_Clk(pciw_pci0_pcie_ep$user_clk_out),
  ...
  mkICAPWorker #(.isV6ICAP(1'd1),
		 .hasDebugLogic(1'd1)) icap(.wciS0_Clk(pciw_pci0_pcie_ep$user_clk_out),
  ...
  SyncResetA #(.RSTDELAY(32'd0)) pciw_p125rst(.CLK(pciw_pci0_pcie_ep$user_clk_out),
					      .IN_RST_N(pciw_pci0_pcie_ep$user_reset_out),
  ...
  ClockInvToBool pciw_preEdge(.CLK_FAST(pciw_pci0_pcie_ep$user_clk_out),
			      .CLK_SLOW(pciw_pci0_pcie_ep$user_clk_out),
  ...
  // submodule wciMonW8
  mkWciMonitor #(.monId(8'h42)) wciMonW8(.CLK(pciw_pci0_pcie_ep$user_clk_out),
					 .RST_N(pciw_p125rst$OUT_RST_N),
  ...
  assign MUX_pciw_p2iS$write_1__VAL_1 =
	     { pciw_fP2I$D_OUT[80:72], val_be__h5874, val_data__h5875 } ;
  ...
  // register pmemMonW8_pmGrab
  assign pmemMonW8_pmGrab$D_IN = z__h15986 ^ pmemMonW8_pmh[31] ;
  ...
  assign pmemMonW8_wsiS_reqFifo_notFull__17_AND_pmemMon_ETC___d239 =
	     ...
	     (pmemMonW8_wsiS_burstKind == 2'd0 ||
	      (pmemMonW8_wsiS_burstKind == 2'd1 ||
	       pmemMonW8_wsiS_burstKind == 2'd2) &&
	      pmemMonW8_wsiS_wsiReq$wget[57]) ;
  assign val_be__h5874 = { pciw_fP2I$D_OUT[71:64], 8'd0 } ;
  assign val_data__h5875 = { pciw_fP2I$D_OUT[63:0], 64'hAAAAAAAAAAAAAAAA } ;
  assign wOut_be__h5980 =
	     { pciw_Prelude_inst_changeSpecialWires_1_rg[71:64],
	       pciw_fP2I$D_OUT[71:64] } ;
  assign wOut_data__h5981 =
	     { pciw_Prelude_inst_changeSpecialWires_1_rg[63:0],
	       pciw_fP2I$D_OUT[63:0] } ;
  assign z__h15783 = pmemMonW8_pmh[0] ^ pmemMonW8_pmh[1] ;
  assign z__h15790 = z__h15783 ^ pmemMonW8_pmh[2] ;
  assign z__h15797 = z__h15790 ^ pmemMonW8_pmh[3] ;
  assign z__h15804 = z__h15797 ^ pmemMonW8_pmh[4] ;
  assign z__h15811 = z__h15804 ^ pmemMonW8_pmh[5] ;
  assign z__h15818 = z__h15811 ^ pmemMonW8_pmh[6] ;
  assign z__h15825 = z__h15818 ^ pmemMonW8_pmh[7] ;
  assign z__h15832 = z__h15825 ^ pmemMonW8_pmh[8] ;
  assign z__h15839 = z__h15832 ^ pmemMonW8_pmh[9] ;
  assign z__h15846 = z__h15839 ^ pmemMonW8_pmh[10] ;
  assign z__h15853 = z__h15846 ^ pmemMonW8_pmh[11] ;
  assign z__h15860 = z__h15853 ^ pmemMonW8_pmh[12] ;
  assign z__h15867 = z__h15860 ^ pmemMonW8_pmh[13] ;
  assign z__h15874 = z__h15867 ^ pmemMonW8_pmh[14] ;
  assign z__h15881 = z__h15874 ^ pmemMonW8_pmh[15] ;
  assign z__h15888 =
	     z__h15881 ^
	     IF_pmemMonW8_pmh_97_BITS_23_TO_16_29_EQ_0_30_O_ETC___d687[0] ;
  assign z__h15895 =
	     z__h15888 ^
	     IF_pmemMonW8_pmh_97_BITS_23_TO_16_29_EQ_0_30_O_ETC___d687[1] ;
  assign z__h15902 =
	     z__h15895 ^
	     IF_pmemMonW8_pmh_97_BITS_23_TO_16_29_EQ_0_30_O_ETC___d687[2] ;
  assign z__h15909 =
	     z__h15902 ^
	     IF_pmemMonW8_pmh_97_BITS_23_TO_16_29_EQ_0_30_O_ETC___d687[3] ;
  assign z__h15916 =
	     z__h15909 ^
	     IF_pmemMonW8_pmh_97_BITS_23_TO_16_29_EQ_0_30_O_ETC___d687[4] ;
  assign z__h15923 =
	     z__h15916 ^
	     IF_pmemMonW8_pmh_97_BITS_23_TO_16_29_EQ_0_30_O_ETC___d687[5] ;
  assign z__h15930 =
	     z__h15923 ^
	     IF_pmemMonW8_pmh_97_BITS_23_TO_16_29_EQ_0_30_O_ETC___d687[6] ;
  assign z__h15937 =
	     z__h15930 ^
	     IF_pmemMonW8_pmh_97_BITS_23_TO_16_29_EQ_0_30_O_ETC___d687[7] ;
  assign z__h15944 = z__h15937 ^ pmemMonW8_pmh[24] ;
  assign z__h15951 = z__h15944 ^ pmemMonW8_pmh[25] ;
  assign z__h15958 = z__h15951 ^ pmemMonW8_pmh[26] ;
  assign z__h15965 = z__h15958 ^ pmemMonW8_pmh[27] ;
  assign z__h15972 = z__h15965 ^ pmemMonW8_pmh[28] ;
  assign z__h15979 = z__h15972 ^ pmemMonW8_pmh[29] ;
  assign z__h15986 = z__h15979 ^ pmemMonW8_pmh[30] ;
  ...
  begin
    case (pmemMonW8_pmh[23:16])
	  ...
	  IF_pmemMonW8_pmh_97_BITS_23_TO_16_29_EQ_0_30_O_ETC___d687 =
	      pmemMonW8_pmh[23:16];
      default: IF_pmemMonW8_pmh_97_BITS_23_TO_16_29_EQ_0_30_O_ETC___d687 =
		   8'd255;
    endcase
  end
  ...
  begin
    ...
    if (pciw_p125rst$OUT_RST_N)
      if (WILL_FIRE_RL_pmemMonW8_get_message_head_dw)
	$write("[%0d]: %m: PMEM HEAD: ", v__h17268);
    if (pciw_p125rst$OUT_RST_N)
