...
//
// On Tue Jan 10 09:44:34 EST 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkFTop_ml605(sys0_clkp,
  ...
  // register pmemMonW8_pmGrab
  assign pmemMonW8_pmGrab$D_IN = z__h15603 ^ pmemMonW8_pmh[31] ;
  ...
  assign z__h15400 = pmemMonW8_pmh[0] ^ pmemMonW8_pmh[1] ;
  assign z__h15407 = z__h15400 ^ pmemMonW8_pmh[2] ;
  assign z__h15414 = z__h15407 ^ pmemMonW8_pmh[3] ;
  assign z__h15421 = z__h15414 ^ pmemMonW8_pmh[4] ;
  assign z__h15428 = z__h15421 ^ pmemMonW8_pmh[5] ;
  assign z__h15435 = z__h15428 ^ pmemMonW8_pmh[6] ;
  assign z__h15442 = z__h15435 ^ pmemMonW8_pmh[7] ;
  assign z__h15449 = z__h15442 ^ pmemMonW8_pmh[8] ;
  assign z__h15456 = z__h15449 ^ pmemMonW8_pmh[9] ;
  assign z__h15463 = z__h15456 ^ pmemMonW8_pmh[10] ;
  assign z__h15470 = z__h15463 ^ pmemMonW8_pmh[11] ;
  assign z__h15477 = z__h15470 ^ pmemMonW8_pmh[12] ;
  assign z__h15484 = z__h15477 ^ pmemMonW8_pmh[13] ;
  assign z__h15491 = z__h15484 ^ pmemMonW8_pmh[14] ;
  assign z__h15498 = z__h15491 ^ pmemMonW8_pmh[15] ;
  assign z__h15505 =
	     z__h15498 ^
	     IF_pmemMonW8_pmh_13_BITS_23_TO_16_45_EQ_0_46_O_ETC___d703[0] ;
  assign z__h15512 =
	     z__h15505 ^
	     IF_pmemMonW8_pmh_13_BITS_23_TO_16_45_EQ_0_46_O_ETC___d703[1] ;
  assign z__h15519 =
	     z__h15512 ^
	     IF_pmemMonW8_pmh_13_BITS_23_TO_16_45_EQ_0_46_O_ETC___d703[2] ;
  assign z__h15526 =
	     z__h15519 ^
	     IF_pmemMonW8_pmh_13_BITS_23_TO_16_45_EQ_0_46_O_ETC___d703[3] ;
  assign z__h15533 =
	     z__h15526 ^
	     IF_pmemMonW8_pmh_13_BITS_23_TO_16_45_EQ_0_46_O_ETC___d703[4] ;
  assign z__h15540 =
	     z__h15533 ^
	     IF_pmemMonW8_pmh_13_BITS_23_TO_16_45_EQ_0_46_O_ETC___d703[5] ;
  assign z__h15547 =
	     z__h15540 ^
	     IF_pmemMonW8_pmh_13_BITS_23_TO_16_45_EQ_0_46_O_ETC___d703[6] ;
  assign z__h15554 =
	     z__h15547 ^
	     IF_pmemMonW8_pmh_13_BITS_23_TO_16_45_EQ_0_46_O_ETC___d703[7] ;
  assign z__h15561 = z__h15554 ^ pmemMonW8_pmh[24] ;
  assign z__h15568 = z__h15561 ^ pmemMonW8_pmh[25] ;
  assign z__h15575 = z__h15568 ^ pmemMonW8_pmh[26] ;
  assign z__h15582 = z__h15575 ^ pmemMonW8_pmh[27] ;
  assign z__h15589 = z__h15582 ^ pmemMonW8_pmh[28] ;
  assign z__h15596 = z__h15589 ^ pmemMonW8_pmh[29] ;
  assign z__h15603 = z__h15596 ^ pmemMonW8_pmh[30] ;
  ...
  begin
    case (pmemMonW8_pmh[23:16])
	  ...
	  IF_pmemMonW8_pmh_13_BITS_23_TO_16_45_EQ_0_46_O_ETC___d703 =
	      pmemMonW8_pmh[23:16];
      default: IF_pmemMonW8_pmh_13_BITS_23_TO_16_45_EQ_0_46_O_ETC___d703 =
		   8'd255;
    endcase
  end
  ...
  begin
    ...
    if (pciw_p125rst$OUT_RST_N)
      if (WILL_FIRE_RL_pmemMonW8_get_message_head_dw)
	$write("[%0d]: %m: PMEM HEAD: ", v__h16885);
    if (pciw_p125rst$OUT_RST_N)
