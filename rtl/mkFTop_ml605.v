...
//
// On Fri Apr 27 14:54:05 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkFTop_ml605(sys0_clkp,
  ...
  wire CAN_FIRE_RL_cap0_wci_cfrd,
       ...
       WILL_FIRE_RL_cap0_metaBram_serverAdapterA_outData_setFirstEnq,
  ...
  wire [13 : 0] mlB__h34292, mlInc__h34291;
  ...
  wire IF_cap0_splaF_first__108_BITS_1_TO_0_110_EQ_0__ETC___d1138,
       ...
       cap0_dataCount_048_ULT_1024___d1548,
       cap0_metaCount_045_ULT_1024___d1547,
  ...
  // rule RL_cap0_metaBram_serverAdapterA_outData_setFirstEnq
  assign WILL_FIRE_RL_cap0_metaBram_serverAdapterA_outData_setFirstEnq =
	     !cap0_metaBram_serverAdapterA_outDataCore$EMPTY_N &&
	     cap0_metaBram_serverAdapterA_outData_enqData$whas ;
  ...
  assign MUX_cap0_wci_wslv_respF_x_wire$wset_1__VAL_3 = { 2'd1, v__h36520 } ;
  ...
  assign cap0_statusReg_w$wget = rdat___1__h38003 ;
  ...
  assign cap0_mesgLengthSoFar$D_IN =
	     cap0_wsiS_reqFifo$D_OUT[57] ? 14'd0 : mlB__h34292 ;
  ...
  assign cap0_metaBram_memory$DIA = { 18'd0, mlB__h34292 } ;
  ...
  assign cap0_dataBram_serverAdapterB_cnt_32_PLUS_IF_ca_ETC___d538 =
		...
		3'd7 :
		3'd0) ;
  assign cap0_dataCount_048_ULT_1024___d1548 = cap0_dataCount < 32'd1024 ;
  ...
  assign cap0_metaBram_serverAdapterB_cnt_50_PLUS_IF_ca_ETC___d656 =
		...
		3'd7 :
		3'd0) ;
  assign cap0_metaCount_045_ULT_1024___d1547 = cap0_metaCount < 32'd1024 ;
  ...
  assign g_data__h38981 =
	     (cap0_wci_wslv_reqF$D_OUT[63:52] == 12'h0) ? v__h37906 : 32'd0 ;
  assign mlB__h34292 = cap0_mesgLengthSoFar + mlInc__h34291 ;
  assign mlInc__h34291 =
	     cap0_wsiS_reqFifo$D_OUT[57] ?
	       { 11'd0, x__h34340 + y__h34341 } :
	       14'd4 ;
  assign pciw_p2iAF_head_wrapped_crossed__4_EQ_pciw_p2i_ETC___d123 =
	     pciw_p2iAF_head_wrapped == pciw_p2iAF_tail_wrapped &&
	     !pciw_p2iAF_sInReset_isInReset &&
	     pciw_preEdge$CLK_VAL ;
  assign rdat___1__h38003 =
	     { 6'd40,
	       !cap0_metaCount_045_ULT_1024___d1547,
	       !cap0_dataCount_048_ULT_1024___d1548,
	       24'd2361866 } ;
  assign rdat___1__h38077 = { 24'd0, cap0_wsiS_statusR } ;
  assign v__h36520 =
	     cap0_splaF$D_OUT[2] ?
	       y_avValue__h37147 :
  ...
  assign x__h34340 = x__h34352 + y__h34353 ;
  assign x__h34352 = x__h34364 + y__h34365 ;
  assign x__h34364 = { 2'd0, cap0_wsiS_reqFifo$D_OUT[11] } ;
  assign y__h34341 = { 2'd0, cap0_wsiS_reqFifo$D_OUT[8] } ;
  assign y__h34353 = { 2'd0, cap0_wsiS_reqFifo$D_OUT[9] } ;
  assign y__h34365 = { 2'd0, cap0_wsiS_reqFifo$D_OUT[10] } ;
  assign y_avValue__h37147 =
	     cap0_dataBram_serverAdapterB_outDataCore$EMPTY_N ?
	       cap0_dataBram_serverAdapterB_outDataCore$D_OUT :
	       cap0_dataBram_memory$DOB ;
  assign y_avValue__h37191 =
	     cap0_metaBram_serverAdapterB_outDataCore$EMPTY_N ?
	       cap0_metaBram_serverAdapterB_outDataCore$D_OUT :
	       cap0_metaBram_memory$DOB ;
  assign y_avValue__h37231 =
	     cap0_metaBram_serverAdapterB_1_outDataCore$EMPTY_N ?
	       cap0_metaBram_serverAdapterB_1_outDataCore$D_OUT :
	       cap0_metaBram_memory_1$DOB ;
  assign y_avValue__h37271 =
	     cap0_metaBram_serverAdapterB_2_outDataCore$EMPTY_N ?
	       cap0_metaBram_serverAdapterB_2_outDataCore$D_OUT :
	       cap0_metaBram_memory_2$DOB ;
  assign y_avValue__h37311 =
	     cap0_metaBram_serverAdapterB_3_outDataCore$EMPTY_N ?
	       cap0_metaBram_serverAdapterB_3_outDataCore$D_OUT :
	       cap0_metaBram_memory_3$DOB ;
  ...
  always@(cap0_splaF$D_OUT or
	  y_avValue__h37311 or
	  y_avValue__h37191 or y_avValue__h37231 or y_avValue__h37271)
  begin
  ...
  always@(cap0_wci_wslv_reqF$D_OUT or
	  ...
	  cap0_metaCount or
	  cap0_dataCount or
	  rdat___1__h38003 or rdat___1__h38077 or cap0_wsiS_extStatusW$wget)
  begin
    case (cap0_wci_wslv_reqF$D_OUT[39:32])
      8'h0: v__h37906 = cap0_controlReg;
      8'h04: v__h37906 = cap0_metaCount;
      8'h08: v__h37906 = cap0_dataCount;
      8'h0C: v__h37906 = rdat___1__h38003;
      8'h10: v__h37906 = rdat___1__h38077;
      8'h14: v__h37906 = cap0_wsiS_extStatusW$wget[95:64];
      8'h18: v__h37906 = cap0_wsiS_extStatusW$wget[63:32];
      8'h1C: v__h37906 = cap0_wsiS_extStatusW$wget[31:0];
      default: v__h37906 = 32'd0;
    endcase
  end
  always@(cap0_splaF$D_OUT or
  ...
  begin
    ...
    if (ctop$RST_N_wci_m_3)
      if (WILL_FIRE_RL_cap0_advance_split_response)
	$display("[%0d]: %m: WCI SPLIT READ Data:%0x", v__h37439, v__h36520);
    if (ctop$RST_N_wci_m_3)
      if (WILL_FIRE_RL_cap0_advance_split_response &&
	  WILL_FIRE_RL_cap0_wci_ctrl_OrE)
