...
//
// On Mon Sep 19 13:13:49 EDT 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkFTop_ml605(sys0_clkp,
  ...
  // register pmemMonW8_pmGrab
  assign pmemMonW8_pmGrab$D_IN = z__h14745 ^ pmemMonW8_pmh[31] ;
  ...
  assign z__h14542 = pmemMonW8_pmh[0] ^ pmemMonW8_pmh[1] ;
  assign z__h14549 = z__h14542 ^ pmemMonW8_pmh[2] ;
  assign z__h14556 = z__h14549 ^ pmemMonW8_pmh[3] ;
  assign z__h14563 = z__h14556 ^ pmemMonW8_pmh[4] ;
  assign z__h14570 = z__h14563 ^ pmemMonW8_pmh[5] ;
  assign z__h14577 = z__h14570 ^ pmemMonW8_pmh[6] ;
  assign z__h14584 = z__h14577 ^ pmemMonW8_pmh[7] ;
  assign z__h14591 = z__h14584 ^ pmemMonW8_pmh[8] ;
  assign z__h14598 = z__h14591 ^ pmemMonW8_pmh[9] ;
  assign z__h14605 = z__h14598 ^ pmemMonW8_pmh[10] ;
  assign z__h14612 = z__h14605 ^ pmemMonW8_pmh[11] ;
  assign z__h14619 = z__h14612 ^ pmemMonW8_pmh[12] ;
  assign z__h14626 = z__h14619 ^ pmemMonW8_pmh[13] ;
  assign z__h14633 = z__h14626 ^ pmemMonW8_pmh[14] ;
  assign z__h14640 = z__h14633 ^ pmemMonW8_pmh[15] ;
  assign z__h14647 =
	     z__h14640 ^
	     IF_pmemMonW8_pmh_90_BITS_23_TO_16_22_EQ_0_23_O_ETC___d681[0] ;
  assign z__h14654 =
	     z__h14647 ^
	     IF_pmemMonW8_pmh_90_BITS_23_TO_16_22_EQ_0_23_O_ETC___d681[1] ;
  assign z__h14661 =
	     z__h14654 ^
	     IF_pmemMonW8_pmh_90_BITS_23_TO_16_22_EQ_0_23_O_ETC___d681[2] ;
  assign z__h14668 =
	     z__h14661 ^
	     IF_pmemMonW8_pmh_90_BITS_23_TO_16_22_EQ_0_23_O_ETC___d681[3] ;
  assign z__h14675 =
	     z__h14668 ^
	     IF_pmemMonW8_pmh_90_BITS_23_TO_16_22_EQ_0_23_O_ETC___d681[4] ;
  assign z__h14682 =
	     z__h14675 ^
	     IF_pmemMonW8_pmh_90_BITS_23_TO_16_22_EQ_0_23_O_ETC___d681[5] ;
  assign z__h14689 =
	     z__h14682 ^
	     IF_pmemMonW8_pmh_90_BITS_23_TO_16_22_EQ_0_23_O_ETC___d681[6] ;
  assign z__h14696 =
	     z__h14689 ^
	     IF_pmemMonW8_pmh_90_BITS_23_TO_16_22_EQ_0_23_O_ETC___d681[7] ;
  assign z__h14703 = z__h14696 ^ pmemMonW8_pmh[24] ;
  assign z__h14710 = z__h14703 ^ pmemMonW8_pmh[25] ;
  assign z__h14717 = z__h14710 ^ pmemMonW8_pmh[26] ;
  assign z__h14724 = z__h14717 ^ pmemMonW8_pmh[27] ;
  assign z__h14731 = z__h14724 ^ pmemMonW8_pmh[28] ;
  assign z__h14738 = z__h14731 ^ pmemMonW8_pmh[29] ;
  assign z__h14745 = z__h14738 ^ pmemMonW8_pmh[30] ;
  ...
  begin
    case (pmemMonW8_pmh[23:16])
	  ...
	  IF_pmemMonW8_pmh_90_BITS_23_TO_16_22_EQ_0_23_O_ETC___d681 =
	      pmemMonW8_pmh[23:16];
      default: IF_pmemMonW8_pmh_90_BITS_23_TO_16_22_EQ_0_23_O_ETC___d681 =
		   8'd255;
    endcase
  end
  ...
  begin
    ...
    if (pciw_p125rst$OUT_RST_N)
      if (WILL_FIRE_RL_pmemMonW8_get_message_head_dw)
	$write("[%0d]: %m: PMEM HEAD: ", v__h16027);
    if (pciw_p125rst$OUT_RST_N)
