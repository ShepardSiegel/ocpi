...
//
// On Sun Mar 20 11:20:52 EDT 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkFTop_ml605(sys0_clkp,
  ...
  wire [2 : 0] pciw_pci0_pcie_ep$axi_fc_sel;
  ...
  wire [127 : 0] val_data__h5851, wOut_data__h5957;
  wire [15 : 0] val_be__h5850, wOut_be__h5956;
  ...
  v6_pcie_v2_3 #(.PL_FAST_TRAIN("FALSE")) pciw_pci0_pcie_ep(.sys_clk(pciw_pci0_clk$O),
							    ...
							    .axi_fc_sel(pciw_pci0_pcie_ep$axi_fc_sel),
  ...
  assign MUX_pciw_p2iS$write_1__VAL_1 =
	     { pciw_fP2I$D_OUT[80:72], val_be__h5850, val_data__h5851 } ;
  ...
  // register pmemMonW8_pmGrab
  assign pmemMonW8_pmGrab$D_IN = z__h15962 ^ pmemMonW8_pmh[31] ;
  ...
  // submodule pciw_pci0_pcie_ep
  assign pciw_pci0_pcie_ep$axi_fc_sel = 3'h0 ;
  ...
  assign pmemMonW8_wsiS_reqFifo_notFull__17_AND_pmemMon_ETC___d239 =
	     ...
	     (pmemMonW8_wsiS_burstKind == 2'd0 ||
	      (pmemMonW8_wsiS_burstKind == 2'd1 ||
	       pmemMonW8_wsiS_burstKind == 2'd2) &&
	      pmemMonW8_wsiS_wsiReq$wget[57]) ;
  assign val_be__h5850 = { pciw_fP2I$D_OUT[71:64], 8'd0 } ;
  assign val_data__h5851 = { pciw_fP2I$D_OUT[63:0], 64'hAAAAAAAAAAAAAAAA } ;
  assign wOut_be__h5956 =
	     { pciw_Prelude_inst_changeSpecialWires_1_rg[71:64],
	       pciw_fP2I$D_OUT[71:64] } ;
  assign wOut_data__h5957 =
	     { pciw_Prelude_inst_changeSpecialWires_1_rg[63:0],
	       pciw_fP2I$D_OUT[63:0] } ;
  assign z__h15759 = pmemMonW8_pmh[0] ^ pmemMonW8_pmh[1] ;
  assign z__h15766 = z__h15759 ^ pmemMonW8_pmh[2] ;
  assign z__h15773 = z__h15766 ^ pmemMonW8_pmh[3] ;
  assign z__h15780 = z__h15773 ^ pmemMonW8_pmh[4] ;
  assign z__h15787 = z__h15780 ^ pmemMonW8_pmh[5] ;
  assign z__h15794 = z__h15787 ^ pmemMonW8_pmh[6] ;
  assign z__h15801 = z__h15794 ^ pmemMonW8_pmh[7] ;
  assign z__h15808 = z__h15801 ^ pmemMonW8_pmh[8] ;
  assign z__h15815 = z__h15808 ^ pmemMonW8_pmh[9] ;
  assign z__h15822 = z__h15815 ^ pmemMonW8_pmh[10] ;
  assign z__h15829 = z__h15822 ^ pmemMonW8_pmh[11] ;
  assign z__h15836 = z__h15829 ^ pmemMonW8_pmh[12] ;
  assign z__h15843 = z__h15836 ^ pmemMonW8_pmh[13] ;
  assign z__h15850 = z__h15843 ^ pmemMonW8_pmh[14] ;
  assign z__h15857 = z__h15850 ^ pmemMonW8_pmh[15] ;
  assign z__h15864 =
	     z__h15857 ^
  ...
  assign z__h15920 = z__h15913 ^ pmemMonW8_pmh[24] ;
  assign z__h15927 = z__h15920 ^ pmemMonW8_pmh[25] ;
  assign z__h15934 = z__h15927 ^ pmemMonW8_pmh[26] ;
  assign z__h15941 = z__h15934 ^ pmemMonW8_pmh[27] ;
  assign z__h15948 = z__h15941 ^ pmemMonW8_pmh[28] ;
  assign z__h15955 = z__h15948 ^ pmemMonW8_pmh[29] ;
  assign z__h15962 = z__h15955 ^ pmemMonW8_pmh[30] ;
  ...
  begin
    ...
    if (pciw_p125rst$OUT_RST_N)
      if (WILL_FIRE_RL_pmemMonW8_get_message_head_dw)
	$write("[%0d]: %m: PMEM HEAD: ", v__h17244);
    if (pciw_p125rst$OUT_RST_N)
