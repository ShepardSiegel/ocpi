...
//
// On Mon Jan 27 11:02:54 EST 2014
//
//
// Ports:
// Name                         I/O  size props
...
module mkFTop_ml605(sys0_clkp,
  ...
  // value method upads_rts
  assign upads_rts = ctop_upads_rts ;

  // value method upads_tx
  assign upads_tx = ctop_upads_tx ;
  ...
  mkCTop16B ctop(.pciDevice(pciDevice),
		 ...
		 .upads_cts_arg(ctop_upads_cts_arg),
		 .upads_rx_arg(ctop_upads_rx_arg),
  ...
  assign ctop_upads_cts_arg = upads_cts_arg ;
  assign ctop_upads_rx_arg = upads_rx_arg ;
  ...
  assign ctop_EN_cpServer_request_put =
	     gbe0_RDY_cpClient_request_get && ctop_RDY_cpServer_request_put ;
