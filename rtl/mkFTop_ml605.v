...
//
// On Sun Apr 15 13:50:17 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
// flp_sclk                       O     1 clock
// CLK_GATE_flp_sclk              O     1 const
// flp_sclkn                      O     1 clock
// CLK_GATE_flp_sclkn             O     1 const
// p125rst                        O     1 reset
// gmii_rstn                      O     1 reset
// flp_srst                       O     1 reset
// sys0_clkp                      I     1 clock
...
module mkFTop_ml605(sys0_clkp,
  ...
  // value method flp_sdo
  output flp_sdo;

  // value method flp_csb
  output flp_csb;

  // value method flp_sclkgate
  output flp_sclkgate;

  // action method flp_sdi
  input  flp_sdi_arg;
  ...
  // oscillator and gates for output clock flp_sclk
  output flp_sclk;
  output CLK_GATE_flp_sclk;

  // oscillator and gates for output clock flp_sclkn
  output flp_sclkn;
  output CLK_GATE_flp_sclkn;
  ...
  wire [7 : 0] cap0_wsi_Es_mReqInfo_w$wget, pciw_pcie_irq_wInterruptDo$wget;
  wire [3 : 0] cap0_wci_wci_Es_mByteEn_w$wget, cap0_wsi_Es_mByteEn_w$wget;
  ...
  wire fmc150$CLK_pads_sclk,
       fmc150$CLK_pads_sclkn,
       fmc150$RST_N_pads_srst,
       fmc150$pads_csb,
       fmc150$pads_sclkgate,
       fmc150$pads_sdi_arg,
       fmc150$pads_sdo,
  ...
  wire [127 : 0] val_data__h6442, wOut_data__h6548;
  wire [31 : 0] g_data__h38956,
		rdat___1__h37978,
		rdat___1__h38052,
		v__h36495,
		y_avValue__h37122,
		...
		y_avValue__h37246,
		y_avValue__h37286;
  wire [15 : 0] val_be__h6441, wOut_be__h6547;
  wire [13 : 0] mlB__h34267, mlInc__h34266;
  ...
  wire IF_cap0_splaF_first__108_BITS_1_TO_0_110_EQ_0__ETC___d1138,
       ...
       cap0_dataCount_048_ULT_1024___d1496,
       cap0_metaCount_045_ULT_1024___d1495,
  ...
  // oscillator and gates for output clock flp_sclk
  assign flp_sclk = fmc150$CLK_pads_sclk ;
  assign CLK_GATE_flp_sclk = 1'b1 ;

  // oscillator and gates for output clock flp_sclkn
  assign flp_sclkn = fmc150$CLK_pads_sclkn ;
  assign CLK_GATE_flp_sclkn = 1'b1 ;

  // output resets
  assign p125rst = pciw_p125rst$OUT_RST_N ;
  assign gmii_rstn = gbe0$RST_N_gmii_rstn ;
  assign flp_srst = fmc150$RST_N_pads_srst ;
  ...
  // value method flp_sdo
  assign flp_sdo = fmc150$pads_sdo ;

  // value method flp_csb
  assign flp_csb = fmc150$pads_csb ;

  // value method flp_sclkgate
  assign flp_sclkgate = fmc150$pads_sclkgate ;
  ...
  SyncResetA #(.RSTDELAY(32'd0)) flp_rst(.CLK(flp_clk$O),
					 ...
					 .OUT_RST_N(flp_rst$OUT_RST_N));

  // submodule fmc150
  mkFMC150 #(.hasDebugLogic(1'd1)) fmc150(.CLK_flp_clk(flp_clk$O),
					  .RST_N_flp_rst(flp_rst$OUT_RST_N),
					  .wciS0_Clk(pciw_pci0_pcie_ep$trn2_clk),
					  .wciS0_MReset_n(ctop$RST_N_wci_m_0),
					  .pads_sdi_arg(fmc150$pads_sdi_arg),
					  ...
					  .pads_sdo(fmc150$pads_sdo),
					  .pads_csb(fmc150$pads_csb),
					  .pads_sclkgate(fmc150$pads_sclkgate),
					  .CLK_pads_sclk(fmc150$CLK_pads_sclk),
					  .CLK_GATE_pads_sclk(),
					  .CLK_pads_sclkn(fmc150$CLK_pads_sclkn),
					  .CLK_GATE_pads_sclkn(),
					  .RST_N_pads_srst(fmc150$RST_N_pads_srst));
  ...
  assign MUX_cap0_wci_wslv_respF_x_wire$wset_1__VAL_3 = { 2'd1, v__h36495 } ;
  ...
  assign MUX_pciw_p2iS$write_1__VAL_1 =
	     { pciw_fP2I$D_OUT[80:72], val_be__h6441, val_data__h6442 } ;
  ...
  assign cap0_statusReg_w$wget = rdat___1__h37978 ;
  ...
  assign cap0_mesgLengthSoFar$D_IN =
	     cap0_wsiS_reqFifo$D_OUT[57] ? 14'd0 : mlB__h34267 ;
  ...
  assign cap0_metaBram_memory$DIA = { 18'd0, mlB__h34267 } ;
  ...
  // submodule fmc150
  assign fmc150$pads_sdi_arg = flp_sdi_arg ;
  ...
  assign cap0_dataBram_serverAdapterB_cnt_32_PLUS_IF_ca_ETC___d538 =
		...
		3'd1 :
		3'd0) +
	     (cap0_dataBram_serverAdapterB_cnt_2$whas ? 3'd7 : 3'd0) ;
  assign cap0_dataCount_048_ULT_1024___d1496 = cap0_dataCount < 32'd1024 ;
  ...
  assign cap0_metaBram_serverAdapterB_cnt_50_PLUS_IF_ca_ETC___d656 =
		...
		3'd7 :
		3'd0) ;
  assign cap0_metaCount_045_ULT_1024___d1495 = cap0_metaCount < 32'd1024 ;
  ...
  assign g_data__h38956 =
	     (cap0_wci_wslv_reqF$D_OUT[63:52] == 12'h0) ? v__h37881 : 32'd0 ;
  assign mlB__h34267 = cap0_mesgLengthSoFar + mlInc__h34266 ;
  assign mlInc__h34266 =
	     cap0_wsiS_reqFifo$D_OUT[57] ?
	       { 11'd0, x__h34315 + y__h34316 } :
	       14'd4 ;
  assign pciw_p2iAF_head_wrapped_crossed__4_EQ_pciw_p2i_ETC___d123 =
	     pciw_p2iAF_head_wrapped == pciw_p2iAF_tail_wrapped &&
	     !pciw_p2iAF_sInReset_isInReset &&
	     pciw_preEdge$CLK_VAL ;
  assign rdat___1__h37978 =
	     { 6'd40,
	       !cap0_metaCount_045_ULT_1024___d1495,
	       !cap0_dataCount_048_ULT_1024___d1496,
	       24'd2361866 } ;
  assign rdat___1__h38052 = { 24'd0, cap0_wsiS_statusR } ;
  assign v__h36495 =
	     cap0_splaF$D_OUT[2] ?
	       y_avValue__h37122 :
	       IF_cap0_splaF_first__108_BITS_1_TO_0_110_EQ_0__ETC___d1162 ;
  assign val_be__h6441 = { pciw_fP2I$D_OUT[71:64], 8'd0 } ;
  assign val_data__h6442 = { pciw_fP2I$D_OUT[63:0], 64'hAAAAAAAAAAAAAAAA } ;
  assign wOut_be__h6547 =
	     { pciw_Prelude_inst_changeSpecialWires_1_rg[71:64],
	       pciw_fP2I$D_OUT[71:64] } ;
  assign wOut_data__h6548 =
	     { pciw_Prelude_inst_changeSpecialWires_1_rg[63:0],
	       pciw_fP2I$D_OUT[63:0] } ;
  assign x__h34315 = x__h34327 + y__h34328 ;
  assign x__h34327 = x__h34339 + y__h34340 ;
  assign x__h34339 = { 2'd0, cap0_wsiS_reqFifo$D_OUT[11] } ;
  assign y__h34316 = { 2'd0, cap0_wsiS_reqFifo$D_OUT[8] } ;
  assign y__h34328 = { 2'd0, cap0_wsiS_reqFifo$D_OUT[9] } ;
  assign y__h34340 = { 2'd0, cap0_wsiS_reqFifo$D_OUT[10] } ;
  assign y_avValue__h37122 =
	     cap0_dataBram_serverAdapterB_outDataCore$EMPTY_N ?
	       cap0_dataBram_serverAdapterB_outDataCore$D_OUT :
	       cap0_dataBram_memory$DOB ;
  assign y_avValue__h37166 =
	     cap0_metaBram_serverAdapterB_outDataCore$EMPTY_N ?
	       cap0_metaBram_serverAdapterB_outDataCore$D_OUT :
	       cap0_metaBram_memory$DOB ;
  assign y_avValue__h37206 =
	     cap0_metaBram_serverAdapterB_1_outDataCore$EMPTY_N ?
	       cap0_metaBram_serverAdapterB_1_outDataCore$D_OUT :
	       cap0_metaBram_memory_1$DOB ;
  assign y_avValue__h37246 =
	     cap0_metaBram_serverAdapterB_2_outDataCore$EMPTY_N ?
	       cap0_metaBram_serverAdapterB_2_outDataCore$D_OUT :
	       cap0_metaBram_memory_2$DOB ;
  assign y_avValue__h37286 =
	     cap0_metaBram_serverAdapterB_3_outDataCore$EMPTY_N ?
	       cap0_metaBram_serverAdapterB_3_outDataCore$D_OUT :
	       cap0_metaBram_memory_3$DOB ;
  ...
  always@(cap0_splaF$D_OUT or
	  y_avValue__h37286 or
	  y_avValue__h37166 or y_avValue__h37206 or y_avValue__h37246)
  begin
  ...
  always@(cap0_wci_wslv_reqF$D_OUT or
	  ...
	  cap0_metaCount or
	  cap0_dataCount or
	  rdat___1__h37978 or rdat___1__h38052 or cap0_wsiS_extStatusW$wget)
  begin
    case (cap0_wci_wslv_reqF$D_OUT[39:32])
      8'h0: v__h37881 = cap0_controlReg;
      8'h04: v__h37881 = cap0_metaCount;
      8'h08: v__h37881 = cap0_dataCount;
      8'h0C: v__h37881 = rdat___1__h37978;
      8'h10: v__h37881 = rdat___1__h38052;
      8'h14: v__h37881 = cap0_wsiS_extStatusW$wget[95:64];
      8'h18: v__h37881 = cap0_wsiS_extStatusW$wget[63:32];
      8'h1C: v__h37881 = cap0_wsiS_extStatusW$wget[31:0];
      default: v__h37881 = 32'd0;
    endcase
  end
  always@(cap0_splaF$D_OUT or
  ...
  begin
    ...
    if (ctop$RST_N_wci_m_3)
      if (WILL_FIRE_RL_cap0_advance_split_response)
	$display("[%0d]: %m: WCI SPLIT READ Data:%0x", v__h37414, v__h36495);
    if (ctop$RST_N_wci_m_3)
      if (WILL_FIRE_RL_cap0_advance_split_response &&
	  WILL_FIRE_RL_cap0_wci_ctrl_OrE)
