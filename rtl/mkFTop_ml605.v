...
//
// On Mon Mar 21 12:31:14 EDT 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkFTop_ml605(sys0_clkp,
  ...
  // ports of submodule pciw_pci0_axiReset
  wire pciw_pci0_axiReset$OUT_RST_N;
  ...
  reg [63 : 0] v__h17793, v__h19287;
  reg [7 : 0] CASE_pmemMonW8_pmemFD_OUT_BITS_23_TO_16_255_0_ETC__q2,
	      CASE_pmemMonW8_wsiS_reqFifoD_OUT_BITS_35_TO_2_ETC__q1,
	      IF_pmemMonW8_pmh_04_BITS_23_TO_16_36_EQ_0_37_O_ETC___d696;
  wire [127 : 0] val_data__h7161, wOut_data__h7267;
  wire [15 : 0] val_be__h7160, wOut_be__h7266;
  wire _dor1pmemMonW8_eventCount$EN_write,
       pciw_p2iAF_head_wrapped_crossed__1_EQ_pciw_p2i_ETC___d106,
       pmemMonW8_wsiS_reqFifo_notFull__24_AND_pmemMon_ETC___d246,
       z__h16308,
       z__h16315,
       z__h16322,
       z__h16329,
  ...
  // submodule pciw_pci0_axiReset
  SyncResetA #(.RSTDELAY(32'd0)) pciw_pci0_axiReset(.CLK(pciw_pci0_pcie_ep$user_clk_out),
						    .IN_RST_N(pciw_pci0_usr_rst_n$RESET_OUT),
						    .OUT_RST_N(pciw_pci0_axiReset$OUT_RST_N));
  ...
  SyncFIFO #(.dataWidth(32'd8),
	     .depth(32'd8),
	     .indxWidth(32'd3)) pciw_pcie_irq_fifoAssert(.sCLK(pciw_pci0_pcie_ep$user_clk_out),
							 .dCLK(pciw_pci0_pcie_ep$user_clk_out),
							 .sRST_N(pciw_p250rst$OUT_RST_N),
  ...
  assign MUX_pciw_p2iS$write_1__VAL_1 =
	     { pciw_fP2I$D_OUT[80:72], val_be__h7160, val_data__h7161 } ;
  ...
  assign pciw_pcie_irq_wInterruptRdyN$wget = 1'b0 ;
  assign pciw_pcie_irq_wInterruptRdyN$whas = 1'b0 ;
  assign pciw_pcie_irq_wInterruptDo$wget = 8'h0 ;
  assign pciw_pcie_irq_wInterruptDo$whas = 1'b0 ;
  ...
  // register pciw_pcie_irq_rInterruptN
  assign pciw_pcie_irq_rInterruptN$D_IN = 1'd0 ;
  assign pciw_pcie_irq_rInterruptN$EN =
	     WILL_FIRE_RL_pciw_pcie_irq_msi_enabled_assert_interrupt ;

  // register pciw_pcie_irq_rInterrupting
  assign pciw_pcie_irq_rInterrupting$D_IN = 1'd1 ;
  assign pciw_pcie_irq_rInterrupting$EN =
	     WILL_FIRE_RL_pciw_pcie_irq_msi_enabled_assert_interrupt ;

  // register pciw_pcie_irq_rMMEnabled
  assign pciw_pcie_irq_rMMEnabled$D_IN = 3'h0 ;
  assign pciw_pcie_irq_rMMEnabled$EN = 1'b0 ;

  // register pciw_pcie_irq_rMSIEnabled
  assign pciw_pcie_irq_rMSIEnabled$D_IN = 1'b0 ;
  assign pciw_pcie_irq_rMSIEnabled$EN = 1'b0 ;
  ...
  // register pmemMonW8_pmGrab
  assign pmemMonW8_pmGrab$D_IN = z__h16511 ^ pmemMonW8_pmh[31] ;
  ...
  assign _dor1pmemMonW8_eventCount$EN_write =
	     WILL_FIRE_RL_pmemMonW8_gen_message_body_dw ||
	     WILL_FIRE_RL_pmemMonW8_get_message_head_dw ;
  assign pciw_p2iAF_head_wrapped_crossed__1_EQ_pciw_p2i_ETC___d106 =
	     pciw_p2iAF_head_wrapped == pciw_p2iAF_tail_wrapped &&
	     !pciw_p2iAF_sInReset_isInReset &&
	     pciw_preEdge$CLK_VAL ;
  assign pmemMonW8_wsiS_reqFifo_notFull__24_AND_pmemMon_ETC___d246 =
	     pmemMonW8_wsiS_reqFifo$FULL_N &&
	     (pmemMonW8_wsiS_burstKind == 2'd0 ||
	      (pmemMonW8_wsiS_burstKind == 2'd1 ||
	       pmemMonW8_wsiS_burstKind == 2'd2) &&
	      pmemMonW8_wsiS_wsiReq$wget[57]) ;
  assign val_be__h7160 = { pciw_fP2I$D_OUT[71:64], 8'd0 } ;
  assign val_data__h7161 = { pciw_fP2I$D_OUT[63:0], 64'hAAAAAAAAAAAAAAAA } ;
  assign wOut_be__h7266 =
	     { pciw_Prelude_inst_changeSpecialWires_1_rg[71:64],
	       pciw_fP2I$D_OUT[71:64] } ;
  assign wOut_data__h7267 =
	     { pciw_Prelude_inst_changeSpecialWires_1_rg[63:0],
	       pciw_fP2I$D_OUT[63:0] } ;
  assign z__h16308 = pmemMonW8_pmh[0] ^ pmemMonW8_pmh[1] ;
  assign z__h16315 = z__h16308 ^ pmemMonW8_pmh[2] ;
  assign z__h16322 = z__h16315 ^ pmemMonW8_pmh[3] ;
  assign z__h16329 = z__h16322 ^ pmemMonW8_pmh[4] ;
  assign z__h16336 = z__h16329 ^ pmemMonW8_pmh[5] ;
  assign z__h16343 = z__h16336 ^ pmemMonW8_pmh[6] ;
  assign z__h16350 = z__h16343 ^ pmemMonW8_pmh[7] ;
  assign z__h16357 = z__h16350 ^ pmemMonW8_pmh[8] ;
  assign z__h16364 = z__h16357 ^ pmemMonW8_pmh[9] ;
  assign z__h16371 = z__h16364 ^ pmemMonW8_pmh[10] ;
  assign z__h16378 = z__h16371 ^ pmemMonW8_pmh[11] ;
  assign z__h16385 = z__h16378 ^ pmemMonW8_pmh[12] ;
  assign z__h16392 = z__h16385 ^ pmemMonW8_pmh[13] ;
  assign z__h16399 = z__h16392 ^ pmemMonW8_pmh[14] ;
  assign z__h16406 = z__h16399 ^ pmemMonW8_pmh[15] ;
  assign z__h16413 =
	     z__h16406 ^
	     IF_pmemMonW8_pmh_04_BITS_23_TO_16_36_EQ_0_37_O_ETC___d696[0] ;
  assign z__h16420 =
	     z__h16413 ^
	     IF_pmemMonW8_pmh_04_BITS_23_TO_16_36_EQ_0_37_O_ETC___d696[1] ;
  assign z__h16427 =
	     z__h16420 ^
	     IF_pmemMonW8_pmh_04_BITS_23_TO_16_36_EQ_0_37_O_ETC___d696[2] ;
  assign z__h16434 =
	     z__h16427 ^
	     IF_pmemMonW8_pmh_04_BITS_23_TO_16_36_EQ_0_37_O_ETC___d696[3] ;
  assign z__h16441 =
	     z__h16434 ^
	     IF_pmemMonW8_pmh_04_BITS_23_TO_16_36_EQ_0_37_O_ETC___d696[4] ;
  assign z__h16448 =
	     z__h16441 ^
	     IF_pmemMonW8_pmh_04_BITS_23_TO_16_36_EQ_0_37_O_ETC___d696[5] ;
  assign z__h16455 =
	     z__h16448 ^
	     IF_pmemMonW8_pmh_04_BITS_23_TO_16_36_EQ_0_37_O_ETC___d696[6] ;
  assign z__h16462 =
	     z__h16455 ^
	     IF_pmemMonW8_pmh_04_BITS_23_TO_16_36_EQ_0_37_O_ETC___d696[7] ;
  assign z__h16469 = z__h16462 ^ pmemMonW8_pmh[24] ;
  assign z__h16476 = z__h16469 ^ pmemMonW8_pmh[25] ;
  assign z__h16483 = z__h16476 ^ pmemMonW8_pmh[26] ;
  assign z__h16490 = z__h16483 ^ pmemMonW8_pmh[27] ;
  assign z__h16497 = z__h16490 ^ pmemMonW8_pmh[28] ;
  assign z__h16504 = z__h16497 ^ pmemMonW8_pmh[29] ;
  assign z__h16511 = z__h16504 ^ pmemMonW8_pmh[30] ;
  ...
  begin
    case (pmemMonW8_pmh[23:16])
	  ...
	  IF_pmemMonW8_pmh_04_BITS_23_TO_16_36_EQ_0_37_O_ETC___d696 =
	      pmemMonW8_pmh[23:16];
      default: IF_pmemMonW8_pmh_04_BITS_23_TO_16_36_EQ_0_37_O_ETC___d696 =
		   8'd255;
    endcase
  end
  ...
  begin
    ...
    if (!pciw_pci0_axiReset$OUT_RST_N)
      begin
  ...
  begin
    ...
    if (pciw_p125rst$OUT_RST_N)
      if (WILL_FIRE_RL_pmemMonW8_get_message_head_dw)
	$write("[%0d]: %m: PMEM HEAD: ", v__h17793);
    if (pciw_p125rst$OUT_RST_N)
