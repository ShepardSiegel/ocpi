...
//
// On Wed Apr  4 14:46:34 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkFTop_ml605(sys0_clkp,
  ...
  reg [7 : 0] CASE_pmemMonW8_pmemFD_OUT_BITS_23_TO_16_255_0_ETC__q3,
	      ...
	      IF_pmemMonW8_pmh_507_BITS_23_TO_16_539_EQ_0_54_ETC___d1842;
  ...
  wire [13 : 0] mlB__h34167, mlInc__h34166;
  ...
  wire IF_cap0_splaF_first__108_BITS_1_TO_0_110_EQ_0__ETC___d1138,
       ...
       cap0_dataCount_048_ULT_1024___d1880,
       cap0_metaCount_045_ULT_1024___d1990,
  ...
  assign MUX_cap0_wci_wslv_respF_x_wire$wset_1__VAL_3 = { 2'd1, v__h36395 } ;
  ...
  assign cap0_statusReg_w$wget = rdat___1__h37878 ;
  ...
  assign cap0_mesgLengthSoFar$D_IN =
	     cap0_wsiS_reqFifo$D_OUT[57] ? 14'd0 : mlB__h34167 ;
  ...
  // register pmemMonW8_pmGrab
  assign pmemMonW8_pmGrab$D_IN = z__h44669 ^ pmemMonW8_pmh[31] ;
  ...
  assign cap0_metaBram_memory$DIA = { 18'd0, mlB__h34167 } ;
  ...
  assign cap0_dataBram_serverAdapterB_cnt_32_PLUS_IF_ca_ETC___d538 =
		...
		3'd7 :
		3'd0) ;
  assign cap0_dataCount_048_ULT_1024___d1880 = cap0_dataCount < 32'd1024 ;
  ...
  assign cap0_metaBram_serverAdapterB_cnt_50_PLUS_IF_ca_ETC___d656 =
		...
		3'd7 :
		3'd0) ;
  assign cap0_metaCount_045_ULT_1024___d1990 = cap0_metaCount < 32'd1024 ;
  ...
  assign g_data__h38856 =
	     (cap0_wci_wslv_reqF$D_OUT[63:52] == 12'h0) ? v__h37781 : 32'd0 ;
  assign mlB__h34167 = cap0_mesgLengthSoFar + mlInc__h34166 ;
  assign mlInc__h34166 =
	     cap0_wsiS_reqFifo$D_OUT[57] ?
	       { 11'd0, x__h34215 + y__h34216 } :
	       14'd4 ;
  assign pciw_p2iAF_head_wrapped_crossed__4_EQ_pciw_p2i_ETC___d123 =
	     pciw_p2iAF_head_wrapped == pciw_p2iAF_tail_wrapped &&
	     !pciw_p2iAF_sInReset_isInReset &&
	     pciw_preEdge$CLK_VAL ;
  assign rdat___1__h37878 =
	     { 6'd40,
	       !cap0_metaCount_045_ULT_1024___d1990,
	       !cap0_dataCount_048_ULT_1024___d1880,
	       24'd2361866 } ;
  assign rdat___1__h37952 = { 24'd0, cap0_wsiS_statusR } ;
  assign v__h36395 =
	     cap0_splaF$D_OUT[2] ?
	       y_avValue__h37022 :
  ...
  assign x__h34215 = x__h34227 + y__h34228 ;
  assign x__h34227 = x__h34239 + y__h34240 ;
  assign x__h34239 = { 2'd0, cap0_wsiS_reqFifo$D_OUT[11] } ;
  assign y__h34216 = { 2'd0, cap0_wsiS_reqFifo$D_OUT[8] } ;
  assign y__h34228 = { 2'd0, cap0_wsiS_reqFifo$D_OUT[9] } ;
  assign y__h34240 = { 2'd0, cap0_wsiS_reqFifo$D_OUT[10] } ;
  assign y_avValue__h37022 =
	     cap0_dataBram_serverAdapterB_outDataCore$EMPTY_N ?
	       cap0_dataBram_serverAdapterB_outDataCore$D_OUT :
	       cap0_dataBram_memory$DOB ;
  assign y_avValue__h37066 =
	     cap0_metaBram_serverAdapterB_outDataCore$EMPTY_N ?
	       cap0_metaBram_serverAdapterB_outDataCore$D_OUT :
	       cap0_metaBram_memory$DOB ;
  assign y_avValue__h37106 =
	     cap0_metaBram_serverAdapterB_1_outDataCore$EMPTY_N ?
	       cap0_metaBram_serverAdapterB_1_outDataCore$D_OUT :
	       cap0_metaBram_memory_1$DOB ;
  assign y_avValue__h37146 =
	     cap0_metaBram_serverAdapterB_2_outDataCore$EMPTY_N ?
	       cap0_metaBram_serverAdapterB_2_outDataCore$D_OUT :
	       cap0_metaBram_memory_2$DOB ;
  assign y_avValue__h37186 =
	     cap0_metaBram_serverAdapterB_3_outDataCore$EMPTY_N ?
	       cap0_metaBram_serverAdapterB_3_outDataCore$D_OUT :
	       cap0_metaBram_memory_3$DOB ;
  assign z__h44466 = pmemMonW8_pmh[0] ^ pmemMonW8_pmh[1] ;
  assign z__h44473 = z__h44466 ^ pmemMonW8_pmh[2] ;
  assign z__h44480 = z__h44473 ^ pmemMonW8_pmh[3] ;
  assign z__h44487 = z__h44480 ^ pmemMonW8_pmh[4] ;
  assign z__h44494 = z__h44487 ^ pmemMonW8_pmh[5] ;
  assign z__h44501 = z__h44494 ^ pmemMonW8_pmh[6] ;
  assign z__h44508 = z__h44501 ^ pmemMonW8_pmh[7] ;
  assign z__h44515 = z__h44508 ^ pmemMonW8_pmh[8] ;
  assign z__h44522 = z__h44515 ^ pmemMonW8_pmh[9] ;
  assign z__h44529 = z__h44522 ^ pmemMonW8_pmh[10] ;
  assign z__h44536 = z__h44529 ^ pmemMonW8_pmh[11] ;
  assign z__h44543 = z__h44536 ^ pmemMonW8_pmh[12] ;
  assign z__h44550 = z__h44543 ^ pmemMonW8_pmh[13] ;
  assign z__h44557 = z__h44550 ^ pmemMonW8_pmh[14] ;
  assign z__h44564 = z__h44557 ^ pmemMonW8_pmh[15] ;
  assign z__h44571 =
	     z__h44564 ^
	     IF_pmemMonW8_pmh_507_BITS_23_TO_16_539_EQ_0_54_ETC___d1842[0] ;
  assign z__h44578 =
	     z__h44571 ^
	     IF_pmemMonW8_pmh_507_BITS_23_TO_16_539_EQ_0_54_ETC___d1842[1] ;
  assign z__h44585 =
	     z__h44578 ^
	     IF_pmemMonW8_pmh_507_BITS_23_TO_16_539_EQ_0_54_ETC___d1842[2] ;
  assign z__h44592 =
	     z__h44585 ^
	     IF_pmemMonW8_pmh_507_BITS_23_TO_16_539_EQ_0_54_ETC___d1842[3] ;
  assign z__h44599 =
	     z__h44592 ^
	     IF_pmemMonW8_pmh_507_BITS_23_TO_16_539_EQ_0_54_ETC___d1842[4] ;
  assign z__h44606 =
	     z__h44599 ^
	     IF_pmemMonW8_pmh_507_BITS_23_TO_16_539_EQ_0_54_ETC___d1842[5] ;
  assign z__h44613 =
	     z__h44606 ^
	     IF_pmemMonW8_pmh_507_BITS_23_TO_16_539_EQ_0_54_ETC___d1842[6] ;
  assign z__h44620 =
	     z__h44613 ^
	     IF_pmemMonW8_pmh_507_BITS_23_TO_16_539_EQ_0_54_ETC___d1842[7] ;
  assign z__h44627 = z__h44620 ^ pmemMonW8_pmh[24] ;
  assign z__h44634 = z__h44627 ^ pmemMonW8_pmh[25] ;
  assign z__h44641 = z__h44634 ^ pmemMonW8_pmh[26] ;
  assign z__h44648 = z__h44641 ^ pmemMonW8_pmh[27] ;
  assign z__h44655 = z__h44648 ^ pmemMonW8_pmh[28] ;
  assign z__h44662 = z__h44655 ^ pmemMonW8_pmh[29] ;
  assign z__h44669 = z__h44662 ^ pmemMonW8_pmh[30] ;
  ...
  always@(cap0_splaF$D_OUT or
	  y_avValue__h37186 or
	  y_avValue__h37066 or y_avValue__h37106 or y_avValue__h37146)
  begin
  ...
  begin
    case (pmemMonW8_pmh[23:16])
	  ...
	  IF_pmemMonW8_pmh_507_BITS_23_TO_16_539_EQ_0_54_ETC___d1842 =
	      pmemMonW8_pmh[23:16];
      default: IF_pmemMonW8_pmh_507_BITS_23_TO_16_539_EQ_0_54_ETC___d1842 =
		   8'd255;
    endcase
  end
  always@(cap0_wci_wslv_reqF$D_OUT or
	  ...
	  cap0_metaCount or
	  cap0_dataCount or
	  rdat___1__h37878 or rdat___1__h37952 or cap0_wsiS_extStatusW$wget)
  begin
    case (cap0_wci_wslv_reqF$D_OUT[39:32])
      8'h0: v__h37781 = cap0_controlReg;
      8'h04: v__h37781 = cap0_metaCount;
      8'h08: v__h37781 = cap0_dataCount;
      8'h0C: v__h37781 = rdat___1__h37878;
      8'h10: v__h37781 = rdat___1__h37952;
      8'h14: v__h37781 = cap0_wsiS_extStatusW$wget[95:64];
      8'h18: v__h37781 = cap0_wsiS_extStatusW$wget[63:32];
      8'h1C: v__h37781 = cap0_wsiS_extStatusW$wget[31:0];
      default: v__h37781 = 32'd0;
    endcase
  end
  always@(cap0_splaF$D_OUT or
  ...
  begin
    ...
    if (ctop$RST_N_wci_m_3)
      if (WILL_FIRE_RL_cap0_advance_split_response)
	$display("[%0d]: %m: WCI SPLIT READ Data:%0x", v__h37314, v__h36395);
    if (ctop$RST_N_wci_m_3)
      if (WILL_FIRE_RL_cap0_advance_split_response &&
	  WILL_FIRE_RL_cap0_wci_ctrl_OrE)
    ...
    if (pciw_p125rst$OUT_RST_N)
      if (WILL_FIRE_RL_pmemMonW8_get_message_head_dw)
	$write("[%0d]: %m: PMEM HEAD: ", v__h45975);
    if (pciw_p125rst$OUT_RST_N)
