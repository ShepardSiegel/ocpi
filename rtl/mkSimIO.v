...
//
// On Fri Sep 28 16:04:52 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkSimIO(CLK,
  ...
  reg [63 : 0] v__h1088, v__h1276, v__h1630;
  reg [31 : 0] TASK_fopen___d4, TASK_fopen___d9, b__h928;
  ...
  // rule RL_do_r_char
  assign WILL_FIRE_RL_do_r_char = reqF$FULL_N && r_hdl[32] && !inEOF ;
  ...
  assign h2cpByteCount$EN =
	     WILL_FIRE_RL_do_r_char && b__h928 != 32'hFFFFFFFF ;

  // register inEOF
  assign inEOF$D_IN = 1'd1 ;
  assign inEOF$EN = WILL_FIRE_RL_do_r_char && b__h928 == 32'hFFFFFFFF ;
  ...
  // submodule reqF
  assign reqF$D_IN = b__h928[7:0] ;
  assign reqF$ENQ = WILL_FIRE_RL_do_r_char && b__h928 != 32'hFFFFFFFF ;
  ...
  begin
	...
	begin
	  b__h928 = $fgetc(r_hdl[31:0]);
	  #0;
	end
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_do_r_char && b__h928 == 32'hFFFFFFFF)
	begin
	  v__h1088 = $time;
	  #0;
	end
