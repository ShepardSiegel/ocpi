...
//
// On Thu Jun  3 13:13:33 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
// wmemiS_SCmdAccept              O     1 const
// wmemiS_SDataAccept             O     1 const
...
module mkDramServerV5(CLK_sys0_clk,
  ...
  reg [63 : 0] v__h13045, v__h2646, v__h2793, v__h3692;
  reg [31 : 0] IF_wci_reqF_first__3_BITS_39_TO_32_2_EQ_0x0_3__ETC___d167,
	       x_data__h17700;
  wire [175 : 0] IF_wci_reqF_first__3_BIT_51_4_THEN_pReg_5_BITS_ETC___d207;
  wire [127 : 0] x1_data__h14922, x1_data__h15892;
  wire [31 : 0] dramStatus__h12895,
		rdat___1__h13439,
		rdat___1__h13448,
		rdat___1__h13457,
		rdat___1__h13466,
		...
		x1_addr__h13230,
		x_data__h13384;
  wire [15 : 0] x1_be__h15891;
  wire IF_wci_reqF_first__3_BIT_51_4_THEN_lreqF_RDY_e_ETC___d51,
       NOT_wci_respF_c_r_8_EQ_2_9_0_AND_IF_wci_reqF_f_ETC___d178,
       dbg_calib_dq_tap_cnt_RDY_write__99_AND_dbg_cal_ETC___d311,
       lrespF_RDY_deq__22_AND_NOT_splitReadInFlight_2_ETC___d230,
       wmemi_reqF_i_notEmpty__66_AND_wmemi_operateD_5_ETC___d274;
  ...
  // value method wmemiS_sCmdAccept
  assign wmemiS_SCmdAccept = 1'd0 ;

  // value method wmemiS_sDataAccept
  assign wmemiS_SDataAccept = 1'd0 ;
  ...
  assign MUX_lreqF$enq_1__VAL_1 =
	     { !wci_reqF$D_OUT[51] && wci_reqF$D_OUT[39:32] != 8'h54,
	       IF_wci_reqF_first__3_BIT_51_4_THEN_pReg_5_BITS_ETC___d207 } ;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_1 = { 2'd1, x_data__h17700 } ;
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, x_data__h13384 } ;
  ...
  assign IF_wci_reqF_first__3_BIT_51_4_THEN_lreqF_RDY_e_ETC___d51 =
	     wci_reqF$D_OUT[51] ?
	       ...
	       wci_respF_c_r != 2'd2 ;
  assign IF_wci_reqF_first__3_BIT_51_4_THEN_pReg_5_BITS_ETC___d207 =
	     wci_reqF$D_OUT[51] ?
	       { x1_addr__h13230, x1_be__h15891, x1_data__h15892 } :
	       { wci_reqF$D_OUT[31:0], mReg, x1_data__h14922 } ;
  assign NOT_wci_respF_c_r_8_EQ_2_9_0_AND_IF_wci_reqF_f_ETC___d178 =
	     wci_respF_c_r != 2'd2 &&
	     (wci_reqF$D_OUT[51] ?
		lreqF$sFULL_N :
  ...
  assign dbg_calib_dq_tap_cnt_RDY_write__99_AND_dbg_cal_ETC___d311 =
  ...
  assign dramStatus__h12895 =
	     { 16'hFEED,
	       ...
	       firBeat$dD_OUT,
	       initComplete$dD_OUT } ;
  assign lrespF_RDY_deq__22_AND_NOT_splitReadInFlight_2_ETC___d230 =
	     lrespF$dEMPTY_N &&
	     (!splitReadInFlight || splaF$EMPTY_N && wci_respF_c_r != 2'd2) ;
  assign rdat___1__h13439 = { 28'd0, dbg_calib_done$dD_OUT } ;
  assign rdat___1__h13448 = { 28'd0, dbg_calib_err$dD_OUT } ;
  assign rdat___1__h13457 = { 8'd0, dbg_calib_dq_tap_cnt$dD_OUT } ;
  assign rdat___1__h13466 = { 8'd0, dbg_calib_dqs_tap_cnt$dD_OUT } ;
  assign rdat___1__h13475 = { 8'd0, dbg_calib_gate_tap_cnt$dD_OUT } ;
  assign rdat___1__h13484 = { 28'd0, dbg_calib_rd_data_sel$dD_OUT } ;
  assign rdat___1__h13493 = { 12'd0, dbg_calib_rden_delay$dD_OUT } ;
  assign rdat___1__h13502 = { 12'd0, dbg_calib_gate_delay$dD_OUT } ;
  assign rdat___1__h13531 = { 24'd0, wmemi_statusR } ;
  assign rdat___1__h13584 = { 24'd0, wmemiReadInFlight_value } ;
  assign rdat___1__h13602 = { 16'd0, requestCount$dD_OUT } ;
  assign rdat___1__h13611 = { 16'd0, pReg } ;
  assign rdat___1__h13619 = { 16'd0, mReg } ;
  assign wmemi_reqF_i_notEmpty__66_AND_wmemi_operateD_5_ETC___d274 =
	     wmemi_reqF$EMPTY_N && wmemi_operateD && wmemi_peerIsReady &&
	     (wmemi_reqF$D_OUT[51:49] != 3'd1 || wmemi_dhF$EMPTY_N) ;
  assign x1_addr__h13230 = { pReg[12:0], wci_reqF$D_OUT[50:36], 4'd0 } ;
  assign x1_be__h15891 =
  ...
  assign x1_data__h14922 = { wdReg_3, wdReg_2, wdReg_1, wdReg } ;
  assign x1_data__h15892 = {4{wci_reqF$D_OUT[31:0]}} ;
  assign x_data__h13384 =
	     wci_reqF$D_OUT[51] ?
	       32'd0 :
	       IF_wci_reqF_first__3_BITS_39_TO_32_2_EQ_0x0_3__ETC___d167 ;
  always@(splaF$D_OUT or lrespF$dD_OUT)
  begin
    case (splaF$D_OUT)
      2'd0: x_data__h17700 = lrespF$dD_OUT[31:0];
      2'd1: x_data__h17700 = lrespF$dD_OUT[63:32];
      2'd2: x_data__h17700 = lrespF$dD_OUT[95:64];
      2'd3: x_data__h17700 = lrespF$dD_OUT[127:96];
    endcase
  end
  always@(wci_reqF$D_OUT or
	  dramStatus__h12895 or
	  dramCtrl or
	  rdat___1__h13439 or
	  rdat___1__h13448 or
	  rdat___1__h13457 or
  ...
  begin
    case (wci_reqF$D_OUT[39:32])
	  ...
	  IF_wci_reqF_first__3_BITS_39_TO_32_2_EQ_0x0_3__ETC___d167 =
	      rdat___1__h13584;
      8'h40, 8'h44:
	  IF_wci_reqF_first__3_BITS_39_TO_32_2_EQ_0x0_3__ETC___d167 = 32'd0;
      8'h48:
	  IF_wci_reqF_first__3_BITS_39_TO_32_2_EQ_0x0_3__ETC___d167 =
	      rdat___1__h13602;
      8'h50:
	  ...
	  IF_wci_reqF_first__3_BITS_39_TO_32_2_EQ_0x0_3__ETC___d167 =
	      rdat___1__h13619;
      8'h60:
	  IF_wci_reqF_first__3_BITS_39_TO_32_2_EQ_0x0_3__ETC___d167 = wdReg;
      8'h64:
	  IF_wci_reqF_first__3_BITS_39_TO_32_2_EQ_0x0_3__ETC___d167 = wdReg_1;
      8'h68:
	  IF_wci_reqF_first__3_BITS_39_TO_32_2_EQ_0x0_3__ETC___d167 = wdReg_2;
      8'h6C:
	  IF_wci_reqF_first__3_BITS_39_TO_32_2_EQ_0x0_3__ETC___d167 = wdReg_3;
      8'h80:
	  IF_wci_reqF_first__3_BITS_39_TO_32_2_EQ_0x0_3__ETC___d167 = rdReg;
      8'h84:
	  IF_wci_reqF_first__3_BITS_39_TO_32_2_EQ_0x0_3__ETC___d167 = rdReg_1;
      8'h88:
	  IF_wci_reqF_first__3_BITS_39_TO_32_2_EQ_0x0_3__ETC___d167 = rdReg_2;
      8'h8C:
	  IF_wci_reqF_first__3_BITS_39_TO_32_2_EQ_0x0_3__ETC___d167 = rdReg_3;
      default: IF_wci_reqF_first__3_BITS_39_TO_32_2_EQ_0x0_3__ETC___d167 =
		   32'd0;
    endcase
  end
