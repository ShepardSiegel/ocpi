...
//
// On Mon Jun  7 08:02:46 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDramServerV5(CLK_sys0_clk,
  ...
  wire [127 : 0] x1_data__h15122, x1_data__h16092;
  ...
  wire IF_wci_reqF_first__3_BIT_51_4_THEN_lreqF_RDY_e_ETC___d51,
       ...
       wci_reqF_i_notEmpty__2_AND_IF_wci_reqF_first___ETC___d178,
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_1 = { 2'd1, x_data__h17900 } ;
  ...
  assign IF_wci_reqF_first__3_BIT_51_4_THEN_pReg_5_BITS_ETC___d207 =
	     wci_reqF$D_OUT[51] ?
	       { x1_addr__h13430, x1_be__h16091, x1_data__h16092 } :
	       { wci_reqF$D_OUT[31:0], mReg, x1_data__h15122 } ;
  ...
  assign rdat___1__h13811 = { 16'd0, pReg } ;
  assign rdat___1__h13819 = { 16'd0, mReg } ;
  assign wci_reqF_i_notEmpty__2_AND_IF_wci_reqF_first___ETC___d178 =
	     wci_reqF$EMPTY_N &&
	     (wci_reqF$D_OUT[51] ?
		lreqF$sFULL_N :
  ...
  assign x1_data__h15122 = { wdReg_3, wdReg_2, wdReg_1, wdReg } ;
  assign x1_data__h16092 = {4{wci_reqF$D_OUT[31:0]}} ;
  ...
  begin
    case (splaF$D_OUT)
      2'd0: x_data__h17900 = lrespF$dD_OUT[31:0];
      2'd1: x_data__h17900 = lrespF$dD_OUT[63:32];
      2'd2: x_data__h17900 = lrespF$dD_OUT[95:64];
      2'd3: x_data__h17900 = lrespF$dD_OUT[127:96];
    endcase
  end
