...
//
// On Wed Jul  7 09:38:49 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDramServerV5(CLK_sys0_clk,
  ...
  reg [63 : 0] v__h13328, v__h2646, v__h2793, v__h3692;
  ...
  wire [127 : 0] x1_data__h15207, x1_data__h16177;
  wire [31 : 0] dramStatus__h13178,
		rdat___1__h13720,
		rdat___1__h13729,
		rdat___1__h13738,
		rdat___1__h13747,
  ...
  assign WILL_FIRE_RL_mkConnectionGetPut =
	     lreqF$dEMPTY_N && memc_reqF$FULL_N ;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_1 = { 2'd1, x_data__h17985 } ;
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, x_data__h13665 } ;
  ...
  assign wmemi_errorSticky$EN =
	     WILL_FIRE_RL_wmemi_reqF_enq && !wmemi_reqF$FULL_N ||
	     WILL_FIRE_RL_wmemi_dhF_enq && !wmemi_dhF$FULL_N ;
  ...
  assign lreqF$dDEQ = WILL_FIRE_RL_mkConnectionGetPut ;
  assign lreqF$sENQ =
	     WILL_FIRE_RL_wci_cfwr &&
	     (wci_reqF$D_OUT[51] || wci_reqF$D_OUT[39:32] == 8'h54 ||
	      wci_reqF$D_OUT[39:32] == 8'h58) ||
  ...
  assign memc_reqF$DEQ =
	     WILL_FIRE_RL_memc_advance_request && memc_reqF$D_OUT[176] ||
	     WILL_FIRE_RL_memc_advance_write1 ;
  assign memc_reqF$ENQ = WILL_FIRE_RL_mkConnectionGetPut ;
  ...
  assign IF_wci_reqF_first__3_BIT_51_4_THEN_pReg_5_BITS_ETC___d209 =
	     wci_reqF$D_OUT[51] ?
	       { x1_addr__h13511, x1_be__h16176, x1_data__h16177 } :
	       { wci_reqF$D_OUT[31:0], mReg, x1_data__h15207 } ;
  ...
  assign rdat___1__h13720 = { 28'd0, dbg_calib_done$dD_OUT } ;
  assign rdat___1__h13729 = { 28'd0, dbg_calib_err$dD_OUT } ;
  assign rdat___1__h13738 = { 8'd0, dbg_calib_dq_tap_cnt$dD_OUT } ;
  assign rdat___1__h13747 = { 8'd0, dbg_calib_dqs_tap_cnt$dD_OUT } ;
  assign rdat___1__h13756 = { 8'd0, dbg_calib_gate_tap_cnt$dD_OUT } ;
  assign rdat___1__h13765 = { 28'd0, dbg_calib_rd_data_sel$dD_OUT } ;
  assign rdat___1__h13774 = { 12'd0, dbg_calib_rden_delay$dD_OUT } ;
  assign rdat___1__h13783 = { 12'd0, dbg_calib_gate_delay$dD_OUT } ;
  assign rdat___1__h13812 = { 24'd0, wmemi_statusR } ;
  assign rdat___1__h13865 = { 24'd0, wmemiReadInFlight_value } ;
  assign rdat___1__h13883 = { 16'd0, requestCount$dD_OUT } ;
  assign rdat___1__h13897 = { 16'd0, pReg } ;
  assign rdat___1__h13905 = { 16'd0, mReg } ;
  ...
  assign x1_addr__h13511 = { pReg[12:0], wci_reqF$D_OUT[50:36], 4'd0 } ;
  assign x1_be__h16176 =
  ...
  assign x1_data__h15207 = { wdReg_3, wdReg_2, wdReg_1, wdReg } ;
  assign x1_data__h16177 = {4{wci_reqF$D_OUT[31:0]}} ;
  assign x_data__h13665 =
	     wci_reqF$D_OUT[51] ?
	       32'd0 :
  ...
  begin
    case (splaF$D_OUT)
      2'd0: x_data__h17985 = lrespF$dD_OUT[31:0];
      2'd1: x_data__h17985 = lrespF$dD_OUT[63:32];
      2'd2: x_data__h17985 = lrespF$dD_OUT[95:64];
      2'd3: x_data__h17985 = lrespF$dD_OUT[127:96];
    endcase
  end
  always@(wci_reqF$D_OUT or
	  dramStatus__h13178 or
	  dramCtrl or
	  rdat___1__h13720 or
	  rdat___1__h13729 or
	  rdat___1__h13738 or
