...
//
// On Fri Dec 17 09:47:35 EST 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDramServerV5(CLK_sys0_clk,
  ...
  reg [63 : 0] v__h17433, v__h3570, v__h3755, v__h3910;
  reg [31 : 0] CASE_wci_reqFD_OUT_BITS_39_TO_32_0_0x0_dramSt_ETC__q1,
	       x_data__h13204;
  wire [175 : 0] IF_wci_reqF_first__4_BIT_51_70_THEN_pReg_94_BI_ETC___d421;
  wire [127 : 0] x1_data__h14443, x1_data__h15436;
  wire [31 : 0] dramStatus__h12336,
		rdat___1__h17013,
		rdat___1__h17022,
		rdat___1__h17031,
		rdat___1__h17040,
		...
		x1_addr__h15434,
		x_data__h16946;
  wire [15 : 0] x1_be__h15435;
  wire IF_wci_reqF_first__4_BIT_51_70_THEN_lreqF_RDY__ETC___d446,
       NOT_wci_respF_c_r_2_EQ_2_1_2_AND_IF_wci_reqF_f_ETC___d382,
       dbg_calib_dq_tap_cnt_RDY_write__67_AND_dbg_cal_ETC___d279,
       lrespF_RDY_deq__31_AND_NOT_splitReadInFlight_4_ETC___d349,
       wmemi_operateD_26_AND_wmemi_peerIsReady_27_28__ETC___d309;
  ...
  assign CAN_FIRE_RL_wci_cfrd =
	     wci_reqF$EMPTY_N &&
	     IF_wci_reqF_first__4_BIT_51_70_THEN_lreqF_RDY__ETC___d446 &&
	     wci_wci_cfrd_pw$whas ;
  ...
  assign MUX_lreqF$enq_1__VAL_1 =
	     { !wci_reqF$D_OUT[51] && wci_reqF$D_OUT[39:32] != 8'h54,
	       IF_wci_reqF_first__4_BIT_51_70_THEN_pReg_94_BI_ETC___d421 } ;
  ...
  assign MUX_wci_respF_q_1$write_1__VAL_2 =
	     (wci_respF_c_r == 2'd2) ?
	       MUX_wci_respF_q_0$write_1__VAL_1 :
	       34'h0AAAAAAAA ;
  assign MUX_wci_respF_x_wire$wset_1__VAL_1 = { 2'd1, x_data__h13204 } ;
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, x_data__h16946 } ;
  ...
  // remaining internal signals
  assign IF_wci_reqF_first__4_BIT_51_70_THEN_lreqF_RDY__ETC___d446 =
	     wci_reqF$D_OUT[51] ?
	       lreqF$sFULL_N && splaF$FULL_N :
	       wci_respF_c_r != 2'd2 ;
  assign IF_wci_reqF_first__4_BIT_51_70_THEN_pReg_94_BI_ETC___d421 =
	     wci_reqF$D_OUT[51] ?
	       { x1_addr__h15434, x1_be__h15435, x1_data__h15436 } :
	       { wci_reqF$D_OUT[31:0], mReg, x1_data__h14443 } ;
  assign NOT_wci_respF_c_r_2_EQ_2_1_2_AND_IF_wci_reqF_f_ETC___d382 =
	     wci_respF_c_r != 2'd2 &&
	     (wci_reqF$D_OUT[51] ?
		lreqF$sFULL_N :
  ...
  assign dbg_calib_dq_tap_cnt_RDY_write__67_AND_dbg_cal_ETC___d279 =
  ...
  assign dramStatus__h12336 =
	     { 16'hFEED,
	       ...
	       firBeat$dD_OUT,
	       initComplete$dD_OUT } ;
  assign lrespF_RDY_deq__31_AND_NOT_splitReadInFlight_4_ETC___d349 =
	     lrespF$dEMPTY_N &&
	     (!splitReadInFlight || splaF$EMPTY_N && wci_respF_c_r != 2'd2) ;
  assign rdat___1__h17013 = { 28'd0, dbg_calib_done$dD_OUT } ;
  assign rdat___1__h17022 = { 28'd0, dbg_calib_err$dD_OUT } ;
  assign rdat___1__h17031 = { 8'd0, dbg_calib_dq_tap_cnt$dD_OUT } ;
  assign rdat___1__h17040 = { 8'd0, dbg_calib_dqs_tap_cnt$dD_OUT } ;
  assign rdat___1__h17049 = { 8'd0, dbg_calib_gate_tap_cnt$dD_OUT } ;
  assign rdat___1__h17058 = { 28'd0, dbg_calib_rd_data_sel$dD_OUT } ;
  assign rdat___1__h17067 = { 12'd0, dbg_calib_rden_delay$dD_OUT } ;
  assign rdat___1__h17076 = { 12'd0, dbg_calib_gate_delay$dD_OUT } ;
  assign rdat___1__h17104 = { 24'd0, wmemi_statusR } ;
  assign rdat___1__h17157 = { 24'd0, wmemiReadInFlight_value } ;
  assign rdat___1__h17175 = { 16'd0, requestCount$dD_OUT } ;
  assign rdat___1__h17189 = { 16'd0, pReg } ;
  assign rdat___1__h17197 = { 16'd0, mReg } ;
  assign wmemi_operateD_26_AND_wmemi_peerIsReady_27_28__ETC___d309 =
	     wmemi_operateD && wmemi_peerIsReady && wmemi_reqF$EMPTY_N &&
	     (wmemi_reqF$D_OUT[51:49] != 3'd1 || wmemi_dhF$EMPTY_N) ;
  assign x1_addr__h15434 = { pReg[12:0], wci_reqF$D_OUT[50:36], 4'd0 } ;
  assign x1_be__h15435 =
  ...
  assign x1_data__h14443 = { wdReg_3, wdReg_2, wdReg_1, wdReg } ;
  assign x1_data__h15436 = {4{wci_reqF$D_OUT[31:0]}} ;
  assign x_data__h16946 =
	     wci_reqF$D_OUT[51] ?
	       32'd0 :
  ...
  begin
    case (splaF$D_OUT)
      2'd0: x_data__h13204 = lrespF$dD_OUT[31:0];
      2'd1: x_data__h13204 = lrespF$dD_OUT[63:32];
      2'd2: x_data__h13204 = lrespF$dD_OUT[95:64];
      2'd3: x_data__h13204 = lrespF$dD_OUT[127:96];
    endcase
  end
  always@(wci_reqF$D_OUT or
	  dramStatus__h12336 or
	  dramCtrl or
	  rdat___1__h17013 or
	  rdat___1__h17022 or
	  rdat___1__h17031 or
