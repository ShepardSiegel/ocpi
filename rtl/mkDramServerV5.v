...
//
// On Mon Jul 12 14:01:27 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDramServerV5(CLK_sys0_clk,
  ...
  reg [63 : 0] v__h12436, v__h2646, v__h2793, v__h3692;
  ...
  wire [127 : 0] x1_data__h14315, x1_data__h15285;
  wire [31 : 0] dramStatus__h12286,
		rdat___1__h12828,
		rdat___1__h12837,
		rdat___1__h12846,
		rdat___1__h12855,
  ...
  wire IF_wci_reqF_first__3_BIT_51_4_THEN_lreqF_RDY_e_ETC___d51,
       ...
       wmemi_operateD_57_AND_wmemi_peerIsReady_58_59__ETC___d276;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_1 = { 2'd1, x_data__h17093 } ;
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, x_data__h12773 } ;
  ...
  assign IF_wci_reqF_first__3_BIT_51_4_THEN_pReg_5_BITS_ETC___d209 =
	     wci_reqF$D_OUT[51] ?
	       { x1_addr__h12619, x1_be__h15284, x1_data__h15285 } :
	       { wci_reqF$D_OUT[31:0], mReg, x1_data__h14315 } ;
  ...
  assign rdat___1__h12828 = { 28'd0, dbg_calib_done$dD_OUT } ;
  assign rdat___1__h12837 = { 28'd0, dbg_calib_err$dD_OUT } ;
  assign rdat___1__h12846 = { 8'd0, dbg_calib_dq_tap_cnt$dD_OUT } ;
  assign rdat___1__h12855 = { 8'd0, dbg_calib_dqs_tap_cnt$dD_OUT } ;
  assign rdat___1__h12864 = { 8'd0, dbg_calib_gate_tap_cnt$dD_OUT } ;
  assign rdat___1__h12873 = { 28'd0, dbg_calib_rd_data_sel$dD_OUT } ;
  assign rdat___1__h12882 = { 12'd0, dbg_calib_rden_delay$dD_OUT } ;
  assign rdat___1__h12891 = { 12'd0, dbg_calib_gate_delay$dD_OUT } ;
  assign rdat___1__h12920 = { 24'd0, wmemi_statusR } ;
  assign rdat___1__h12973 = { 24'd0, wmemiReadInFlight_value } ;
  assign rdat___1__h12991 = { 16'd0, requestCount$dD_OUT } ;
  assign rdat___1__h13005 = { 16'd0, pReg } ;
  assign rdat___1__h13013 = { 16'd0, mReg } ;
  ...
  assign wmemi_operateD_57_AND_wmemi_peerIsReady_58_59__ETC___d276 =
	     wmemi_operateD && wmemi_peerIsReady && wmemi_reqF$EMPTY_N &&
	     (wmemi_reqF$D_OUT[51:49] != 3'd1 || wmemi_dhF$EMPTY_N) ;
  assign x1_addr__h12619 = { pReg[12:0], wci_reqF$D_OUT[50:36], 4'd0 } ;
  assign x1_be__h15284 =
  ...
  assign x1_data__h14315 = { wdReg_3, wdReg_2, wdReg_1, wdReg } ;
  assign x1_data__h15285 = {4{wci_reqF$D_OUT[31:0]}} ;
  assign x_data__h12773 =
	     wci_reqF$D_OUT[51] ?
	       32'd0 :
  ...
  begin
    case (splaF$D_OUT)
      2'd0: x_data__h17093 = lrespF$dD_OUT[31:0];
      2'd1: x_data__h17093 = lrespF$dD_OUT[63:32];
      2'd2: x_data__h17093 = lrespF$dD_OUT[95:64];
      2'd3: x_data__h17093 = lrespF$dD_OUT[127:96];
    endcase
  end
  always@(wci_reqF$D_OUT or
	  dramStatus__h12286 or
	  dramCtrl or
	  rdat___1__h12828 or
	  rdat___1__h12837 or
	  rdat___1__h12846 or
