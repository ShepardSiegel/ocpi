...
//
// On Tue Jun  1 06:16:50 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDramServerV5(CLK_sys0_clk,
  ...
  // register wmemi_blockReq
  reg wmemi_blockReq;
  wire wmemi_blockReq$D_IN, wmemi_blockReq$EN;
  ...
  reg [63 : 0] v__h11568, v__h2642, v__h2789, v__h3688;
  reg [31 : 0] CASE_wci_reqFD_OUT_BITS_39_TO_32_0_0x0_dramSt_ETC__q1,
	       x_data__h16175;
  wire [175 : 0] IF_wci_reqF_first__3_BIT_51_4_THEN_pReg_5_BITS_ETC___d200;
  wire [127 : 0] x1_data__h13396, x1_data__h14366;
  wire [31 : 0] dramStatus__h11441,
		rdat___1__h11964,
		rdat___1__h11973,
		rdat___1__h11982,
		rdat___1__h11991,
		...
		x1_addr__h11755,
		x_data__h11909;
  wire [15 : 0] x1_be__h14365;
  wire IF_wci_reqF_first__3_BIT_51_4_THEN_lreqF_RDY_e_ETC___d51,
       dbg_calib_dq_tap_cnt_RDY_write__55_AND_dbg_cal_ETC___d267,
       lrespF_RDY_deq__15_AND_NOT_splitReadInFlight_1_ETC___d223,
       wci_reqF_i_notEmpty__2_AND_IF_wci_reqF_first___ETC___d171;
  ...
  assign MUX_lreqF$enq_1__VAL_1 =
	     { !wci_reqF$D_OUT[51] && wci_reqF$D_OUT[39:32] != 8'h54,
	       IF_wci_reqF_first__3_BIT_51_4_THEN_pReg_5_BITS_ETC___d200 } ;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_1 = { 2'd1, x_data__h16175 } ;
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, x_data__h11909 } ;
  ...
  // register wmemi_blockReq
  assign wmemi_blockReq$D_IN = 1'b0 ;
  assign wmemi_blockReq$EN = 1'b0 ;
  ...
  assign IF_wci_reqF_first__3_BIT_51_4_THEN_lreqF_RDY_e_ETC___d51 =
	     wci_reqF$D_OUT[51] ?
	       ...
	       wci_respF_c_r != 2'd2 ;
  assign IF_wci_reqF_first__3_BIT_51_4_THEN_pReg_5_BITS_ETC___d200 =
	     wci_reqF$D_OUT[51] ?
	       { x1_addr__h11755, x1_be__h14365, x1_data__h14366 } :
	       { wci_reqF$D_OUT[31:0], mReg, x1_data__h13396 } ;
  assign dbg_calib_dq_tap_cnt_RDY_write__55_AND_dbg_cal_ETC___d267 =
  ...
  assign dramStatus__h11441 =
	     { 16'hFEED,
	       ...
	       firBeat$dD_OUT,
	       initComplete$dD_OUT } ;
  assign lrespF_RDY_deq__15_AND_NOT_splitReadInFlight_1_ETC___d223 =
	     lrespF$dEMPTY_N &&
	     (!splitReadInFlight || splaF$EMPTY_N && wci_respF_c_r != 2'd2) ;
  assign rdat___1__h11964 = { 28'd0, dbg_calib_done$dD_OUT } ;
  assign rdat___1__h11973 = { 28'd0, dbg_calib_err$dD_OUT } ;
  assign rdat___1__h11982 = { 8'd0, dbg_calib_dq_tap_cnt$dD_OUT } ;
  assign rdat___1__h11991 = { 8'd0, dbg_calib_dqs_tap_cnt$dD_OUT } ;
  assign rdat___1__h12000 = { 8'd0, dbg_calib_gate_tap_cnt$dD_OUT } ;
  assign rdat___1__h12009 = { 28'd0, dbg_calib_rd_data_sel$dD_OUT } ;
  assign rdat___1__h12018 = { 12'd0, dbg_calib_rden_delay$dD_OUT } ;
  assign rdat___1__h12027 = { 12'd0, dbg_calib_gate_delay$dD_OUT } ;
  assign rdat___1__h12076 = { 16'd0, requestCount$dD_OUT } ;
  assign rdat___1__h12085 = { 16'd0, pReg } ;
  assign rdat___1__h12093 = { 16'd0, mReg } ;
  assign wci_reqF_i_notEmpty__2_AND_IF_wci_reqF_first___ETC___d171 =
	     wci_reqF$EMPTY_N &&
	     (wci_reqF$D_OUT[51] ?
		lreqF$sFULL_N :
  ...
  assign x1_addr__h11755 = { pReg[12:0], wci_reqF$D_OUT[50:36], 4'd0 } ;
  assign x1_be__h14365 =
  ...
  assign x1_data__h13396 = { wdReg_3, wdReg_2, wdReg_1, wdReg } ;
  assign x1_data__h14366 = {4{wci_reqF$D_OUT[31:0]}} ;
  assign x_data__h11909 =
	     wci_reqF$D_OUT[51] ?
	       32'd0 :
  ...
  begin
    case (splaF$D_OUT)
      2'd0: x_data__h16175 = lrespF$dD_OUT[31:0];
      2'd1: x_data__h16175 = lrespF$dD_OUT[63:32];
      2'd2: x_data__h16175 = lrespF$dD_OUT[95:64];
      2'd3: x_data__h16175 = lrespF$dD_OUT[127:96];
    endcase
  end
  always@(wci_reqF$D_OUT or
	  dramStatus__h11441 or
	  dramCtrl or
	  rdat___1__h11964 or
	  rdat___1__h11973 or
	  rdat___1__h11982 or
  ...
  begin
    case (wci_reqF$D_OUT[39:32])
	  ...
	  CASE_wci_reqFD_OUT_BITS_39_TO_32_0_0x0_dramSt_ETC__q1 =
	      32'hC0DEBABE;
      8'h2C, 8'h30, 8'h34, 8'h38, 8'h3C, 8'h40, 8'h44:
  ...
  begin
	...
	wmemi_blockReq <= `BSV_ASSIGNMENT_DELAY 1'd0;
	...
	if (wmemi_blockReq$EN)
	  wmemi_blockReq <= `BSV_ASSIGNMENT_DELAY wmemi_blockReq$D_IN;
