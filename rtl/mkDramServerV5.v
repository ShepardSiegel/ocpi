...
//
// On Fri Sep 10 16:38:01 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDramServerV5(CLK_sys0_clk,
  ...
  reg [63 : 0] v__h12434, v__h2646, v__h2793, v__h3692;
  ...
  wire [127 : 0] x1_data__h14313, x1_data__h15283;
  wire [31 : 0] dramStatus__h12284,
		rdat___1__h12826,
		rdat___1__h12835,
		rdat___1__h12844,
		rdat___1__h12853,
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_1 = { 2'd1, x_data__h17091 } ;
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, x_data__h12771 } ;
  ...
  assign IF_wci_reqF_first__3_BIT_51_4_THEN_pReg_5_BITS_ETC___d209 =
	     wci_reqF$D_OUT[51] ?
	       { x1_addr__h12617, x1_be__h15282, x1_data__h15283 } :
	       { wci_reqF$D_OUT[31:0], mReg, x1_data__h14313 } ;
  ...
  assign rdat___1__h12826 = { 28'd0, dbg_calib_done$dD_OUT } ;
  assign rdat___1__h12835 = { 28'd0, dbg_calib_err$dD_OUT } ;
  assign rdat___1__h12844 = { 8'd0, dbg_calib_dq_tap_cnt$dD_OUT } ;
  assign rdat___1__h12853 = { 8'd0, dbg_calib_dqs_tap_cnt$dD_OUT } ;
  assign rdat___1__h12862 = { 8'd0, dbg_calib_gate_tap_cnt$dD_OUT } ;
  assign rdat___1__h12871 = { 28'd0, dbg_calib_rd_data_sel$dD_OUT } ;
  assign rdat___1__h12880 = { 12'd0, dbg_calib_rden_delay$dD_OUT } ;
  assign rdat___1__h12889 = { 12'd0, dbg_calib_gate_delay$dD_OUT } ;
  assign rdat___1__h12918 = { 24'd0, wmemi_statusR } ;
  assign rdat___1__h12971 = { 24'd0, wmemiReadInFlight_value } ;
  assign rdat___1__h12989 = { 16'd0, requestCount$dD_OUT } ;
  assign rdat___1__h13003 = { 16'd0, pReg } ;
  assign rdat___1__h13011 = { 16'd0, mReg } ;
  ...
  assign x1_addr__h12617 = { pReg[12:0], wci_reqF$D_OUT[50:36], 4'd0 } ;
  assign x1_be__h15282 =
  ...
  assign x1_data__h14313 = { wdReg_3, wdReg_2, wdReg_1, wdReg } ;
  assign x1_data__h15283 = {4{wci_reqF$D_OUT[31:0]}} ;
  assign x_data__h12771 =
	     wci_reqF$D_OUT[51] ?
	       32'd0 :
  ...
  begin
    case (splaF$D_OUT)
      2'd0: x_data__h17091 = lrespF$dD_OUT[31:0];
      2'd1: x_data__h17091 = lrespF$dD_OUT[63:32];
      2'd2: x_data__h17091 = lrespF$dD_OUT[95:64];
      2'd3: x_data__h17091 = lrespF$dD_OUT[127:96];
    endcase
  end
  always@(wci_reqF$D_OUT or
	  dramStatus__h12284 or
	  dramCtrl or
	  rdat___1__h12826 or
	  rdat___1__h12835 or
	  rdat___1__h12844 or
