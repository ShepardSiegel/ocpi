...
//
// On Thu Jul  8 12:36:10 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDramServerV5(CLK_sys0_clk,
  ...
  reg [63 : 0] v__h13330, v__h2646, v__h2793, v__h3692;
  ...
  wire [127 : 0] x1_data__h15209, x1_data__h16179;
  wire [31 : 0] dramStatus__h13180,
		rdat___1__h13722,
		rdat___1__h13731,
		rdat___1__h13740,
		rdat___1__h13749,
		...
		x1_addr__h13513,
		x_data__h13667;
  wire [15 : 0] x1_be__h16178;
  wire IF_wci_reqF_first__3_BIT_51_4_THEN_lreqF_RDY_e_ETC___d51,
       dbg_calib_dq_tap_cnt_RDY_write__04_AND_dbg_cal_ETC___d316,
       lrespF_RDY_deq__24_AND_NOT_splitReadInFlight_2_ETC___d232,
       wci_reqF_i_notEmpty__2_AND_IF_wci_reqF_first___ETC___d180,
       wmemi_operateD_57_AND_wmemi_peerIsReady_58_59__ETC___d357,
       wmemi_operateD_57_AND_wmemi_peerIsReady_58_59__ETC___d366,
  ...
  // value method wmemiS_sCmdAccept
  assign wmemiS_SCmdAccept =
	     wmemi_operateD_57_AND_wmemi_peerIsReady_58_59__ETC___d366 ;

  // value method wmemiS_sDataAccept
  assign wmemiS_SDataAccept =
	     wmemi_operateD_57_AND_wmemi_peerIsReady_58_59__ETC___d357 ;
  ...
  assign CAN_FIRE_RL_wmemi_reqF_enq =
	     wmemi_operateD_57_AND_wmemi_peerIsReady_58_59__ETC___d366 ;
  assign WILL_FIRE_RL_wmemi_reqF_enq =
	     wmemi_operateD_57_AND_wmemi_peerIsReady_58_59__ETC___d366 ;
  ...
  assign CAN_FIRE_RL_wmemi_dhF_enq =
	     wmemi_operateD_57_AND_wmemi_peerIsReady_58_59__ETC___d357 ;
  assign WILL_FIRE_RL_wmemi_dhF_enq =
	     wmemi_operateD_57_AND_wmemi_peerIsReady_58_59__ETC___d357 ;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_1 = { 2'd1, x_data__h17987 } ;
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, x_data__h13667 } ;
  ...
  assign IF_wci_reqF_first__3_BIT_51_4_THEN_pReg_5_BITS_ETC___d209 =
	     wci_reqF$D_OUT[51] ?
	       { x1_addr__h13513, x1_be__h16178, x1_data__h16179 } :
	       { wci_reqF$D_OUT[31:0], mReg, x1_data__h15209 } ;
  assign dbg_calib_dq_tap_cnt_RDY_write__04_AND_dbg_cal_ETC___d316 =
  ...
  assign rdat___1__h13722 = { 28'd0, dbg_calib_done$dD_OUT } ;
  assign rdat___1__h13731 = { 28'd0, dbg_calib_err$dD_OUT } ;
  assign rdat___1__h13740 = { 8'd0, dbg_calib_dq_tap_cnt$dD_OUT } ;
  assign rdat___1__h13749 = { 8'd0, dbg_calib_dqs_tap_cnt$dD_OUT } ;
  assign rdat___1__h13758 = { 8'd0, dbg_calib_gate_tap_cnt$dD_OUT } ;
  assign rdat___1__h13767 = { 28'd0, dbg_calib_rd_data_sel$dD_OUT } ;
  assign rdat___1__h13776 = { 12'd0, dbg_calib_rden_delay$dD_OUT } ;
  assign rdat___1__h13785 = { 12'd0, dbg_calib_gate_delay$dD_OUT } ;
  assign rdat___1__h13814 = { 24'd0, wmemi_statusR } ;
  assign rdat___1__h13867 = { 24'd0, wmemiReadInFlight_value } ;
  assign rdat___1__h13885 = { 16'd0, requestCount$dD_OUT } ;
  assign rdat___1__h13899 = { 16'd0, pReg } ;
  assign rdat___1__h13907 = { 16'd0, mReg } ;
  assign wci_reqF_i_notEmpty__2_AND_IF_wci_reqF_first___ETC___d180 =
	     wci_reqF$EMPTY_N &&
	     (wci_reqF$D_OUT[51] ?
		lreqF$sFULL_N :
  ...
  assign wmemi_operateD_57_AND_wmemi_peerIsReady_58_59__ETC___d357 =
	     wmemi_operateD && wmemi_peerIsReady && wmemi_wmemiDh$wget[145] &&
	     wmemi_dhF$FULL_N ;
  assign wmemi_operateD_57_AND_wmemi_peerIsReady_58_59__ETC___d366 =
  ...
  assign x1_addr__h13513 = { pReg[12:0], wci_reqF$D_OUT[50:36], 4'd0 } ;
  assign x1_be__h16178 =
  ...
  assign x1_data__h15209 = { wdReg_3, wdReg_2, wdReg_1, wdReg } ;
  assign x1_data__h16179 = {4{wci_reqF$D_OUT[31:0]}} ;
  assign x_data__h13667 =
	     wci_reqF$D_OUT[51] ?
	       32'd0 :
  ...
  begin
    case (splaF$D_OUT)
      2'd0: x_data__h17987 = lrespF$dD_OUT[31:0];
      2'd1: x_data__h17987 = lrespF$dD_OUT[63:32];
      2'd2: x_data__h17987 = lrespF$dD_OUT[95:64];
      2'd3: x_data__h17987 = lrespF$dD_OUT[127:96];
    endcase
  end
  always@(wci_reqF$D_OUT or
	  dramStatus__h13180 or
	  dramCtrl or
	  rdat___1__h13722 or
	  rdat___1__h13731 or
	  rdat___1__h13740 or
