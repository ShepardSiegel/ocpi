...
//
// On Tue Jun  1 12:35:42 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDramServerV5(CLK_sys0_clk,
  ...
  reg [63 : 0] v__h12021, v__h2642, v__h2789, v__h3688;
  ...
  wire [127 : 0] x1_data__h13849, x1_data__h14819;
  wire [31 : 0] dramStatus__h11894,
		rdat___1__h12417,
		rdat___1__h12426,
		rdat___1__h12435,
		rdat___1__h12444,
		...
		x1_addr__h12208,
		x_data__h12362;
  wire [15 : 0] x1_be__h14818;
  wire IF_wci_reqF_first__3_BIT_51_4_THEN_lreqF_RDY_e_ETC___d51,
       NOT_wci_respF_c_r_8_EQ_2_9_0_AND_IF_wci_reqF_f_ETC___d171,
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_1 = { 2'd1, x_data__h16628 } ;
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, x_data__h12362 } ;
  ...
  assign IF_wci_reqF_first__3_BIT_51_4_THEN_pReg_5_BITS_ETC___d200 =
	     wci_reqF$D_OUT[51] ?
	       { x1_addr__h12208, x1_be__h14818, x1_data__h14819 } :
	       { wci_reqF$D_OUT[31:0], mReg, x1_data__h13849 } ;
  assign NOT_wci_respF_c_r_8_EQ_2_9_0_AND_IF_wci_reqF_f_ETC___d171 =
	     wci_respF_c_r != 2'd2 &&
	     (wci_reqF$D_OUT[51] ?
		lreqF$sFULL_N :
  ...
  assign rdat___1__h12417 = { 28'd0, dbg_calib_done$dD_OUT } ;
  assign rdat___1__h12426 = { 28'd0, dbg_calib_err$dD_OUT } ;
  assign rdat___1__h12435 = { 8'd0, dbg_calib_dq_tap_cnt$dD_OUT } ;
  assign rdat___1__h12444 = { 8'd0, dbg_calib_dqs_tap_cnt$dD_OUT } ;
  assign rdat___1__h12453 = { 8'd0, dbg_calib_gate_tap_cnt$dD_OUT } ;
  assign rdat___1__h12462 = { 28'd0, dbg_calib_rd_data_sel$dD_OUT } ;
  assign rdat___1__h12471 = { 12'd0, dbg_calib_rden_delay$dD_OUT } ;
  assign rdat___1__h12480 = { 12'd0, dbg_calib_gate_delay$dD_OUT } ;
  assign rdat___1__h12529 = { 16'd0, requestCount$dD_OUT } ;
  assign rdat___1__h12538 = { 16'd0, pReg } ;
  assign rdat___1__h12546 = { 16'd0, mReg } ;
  assign x1_addr__h12208 = { pReg[12:0], wci_reqF$D_OUT[50:36], 4'd0 } ;
  assign x1_be__h14818 =
  ...
  assign x1_data__h13849 = { wdReg_3, wdReg_2, wdReg_1, wdReg } ;
  assign x1_data__h14819 = {4{wci_reqF$D_OUT[31:0]}} ;
  assign x_data__h12362 =
	     wci_reqF$D_OUT[51] ?
	       32'd0 :
  ...
  begin
    case (splaF$D_OUT)
      2'd0: x_data__h16628 = lrespF$dD_OUT[31:0];
      2'd1: x_data__h16628 = lrespF$dD_OUT[63:32];
      2'd2: x_data__h16628 = lrespF$dD_OUT[95:64];
      2'd3: x_data__h16628 = lrespF$dD_OUT[127:96];
    endcase
  end
  always@(wci_reqF$D_OUT or
	  dramStatus__h11894 or
	  dramCtrl or
	  rdat___1__h12417 or
	  rdat___1__h12426 or
	  rdat___1__h12435 or
