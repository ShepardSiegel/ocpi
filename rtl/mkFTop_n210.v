...
//
// On Sun Sep  9 13:23:06 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkFTop_n210(sys0_clkp,
  ...
  reg [1 : 0] CASE_edcpserver_response_get_BITS_19_TO_18_3__ETC__q7,
	      ...
	      CASE_emuxserver_response_get_BITS_19_TO_18_3__ETC__q15,
	      CASE_emuxserver_response_get_BITS_29_TO_28_3__ETC__q14,
	      CASE_emuxserver_response_get_BITS_39_TO_38_3__ETC__q13,
	      CASE_emuxserver_response_get_BITS_9_TO_8_3_0__ETC__q16,
	      CASE_gbe0client_request_get_BITS_19_TO_18_3_0_ETC__q11,
	      CASE_gbe0client_request_get_BITS_29_TO_28_3_0_ETC__q10,
	      CASE_gbe0client_request_get_BITS_39_TO_38_3_0_ETC__q9,
	      CASE_gbe0client_request_get_BITS_9_TO_8_3_0_g_ETC__q12;
  ...
  assign emux$client1_response_put = 40'h0 ;
  ...
  assign emux$EN_client0_response_put =
	     edcp$RDY_server_response_get && emux$RDY_client0_response_put ;
  assign emux$EN_client1_request_get = 1'b0 ;
  assign emux$EN_client1_response_put = 1'b0 ;
  ...
  begin
    case (gbe0$client_request_get[39:38])
      ...
      2'd3: CASE_gbe0client_request_get_BITS_39_TO_38_3_0_ETC__q9 = 2'd3;
    endcase
  end
  always@(gbe0$client_request_get)
  begin
    case (gbe0$client_request_get[29:28])
      ...
      2'd3: CASE_gbe0client_request_get_BITS_29_TO_28_3_0_ETC__q10 = 2'd3;
    endcase
  end
  always@(gbe0$client_request_get)
  begin
    case (gbe0$client_request_get[19:18])
      ...
      2'd3: CASE_gbe0client_request_get_BITS_19_TO_18_3_0_ETC__q11 = 2'd3;
    endcase
  end
  always@(gbe0$client_request_get)
  begin
    case (gbe0$client_request_get[9:8])
      ...
      2'd3: CASE_gbe0client_request_get_BITS_9_TO_8_3_0_g_ETC__q12 = 2'd3;
    endcase
  end
  ...
  begin
    case (emux$server_response_get[39:38])
      ...
      2'd3: CASE_emuxserver_response_get_BITS_39_TO_38_3__ETC__q13 = 2'd3;
    endcase
  end
  always@(emux$server_response_get)
  begin
    case (emux$server_response_get[29:28])
      ...
      2'd3: CASE_emuxserver_response_get_BITS_29_TO_28_3__ETC__q14 = 2'd3;
    endcase
  end
  always@(emux$server_response_get)
  begin
    case (emux$server_response_get[19:18])
      ...
      2'd3: CASE_emuxserver_response_get_BITS_19_TO_18_3__ETC__q15 = 2'd3;
    endcase
  end
  always@(emux$server_response_get)
  begin
    case (emux$server_response_get[9:8])
      ...
      2'd3: CASE_emuxserver_response_get_BITS_9_TO_8_3_0__ETC__q16 = 2'd3;
    endcase
  end
