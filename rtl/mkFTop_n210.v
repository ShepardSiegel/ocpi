...
//
// On Tue Aug 14 16:47:40 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkFTop_n210(sys0_clkp,
  ...
  reg [33 : 0] MUX_pat0_wci_wslv_respF_q_0$write_1__VAL_2,
  ...
  wire [33 : 0] MUX_pat0_wci_wslv_respF_q_0$write_1__VAL_1,
  ...
  reg CASE_pat0_splaFD_OUT_BITS_1_TO_0_NOT_pat0_spl_ETC__q1,
      ...
      IF_pat0_wci_wslv_reqF_first__3_BITS_35_TO_34_0_ETC___d2520,
      IF_pat0_wci_wslv_reqF_first__3_BITS_63_TO_52_0_ETC___d1135;
  wire [55 : 0] IF_sma0_respF_wDataIn_whas__615_THEN_sma0_resp_ETC___d2184;
  wire [31 : 0] b__h26641,
		g_data__h33776,
		rdat___1__h32941,
		rdat__h57876,
		...
		y_avValue__h31179;
  wire [23 : 0] b__h51838,
		mesgMetaF_length__h56420,
		residue__h51701,
		x__h51958;
  wire [15 : 0] wsiBurstLength__h52586, x__h57879, x_length__h56820;
  wire [13 : 0] b__h52211, mlB__h56253, mlInc__h56252;
  wire [11 : 0] b__h49026,
		sendData_burstLength__h52668,
		x__h50380,
		x_burstLength__h27417;
  wire [7 : 0] mesgMetaF_opcode__h56419;
  wire [3 : 0] sendData_byteEn__h52670, x_byteEn__h27419;
  wire [2 : 0] IF_sma0_respF_wDataIn_whas__615_THEN_sma0_resp_ETC___d2175,
	       ...
	       y__h56472,
	       y__h56484;
  wire [1 : 0] ab__h13027, ab__h16126, ab__h19053, ab__h21980, ab__h24907;
  wire IF_pat0_splaF_first__015_BITS_1_TO_0_017_EQ_0__ETC___d1045,
       ...
       pat0_dataBram_serverAdapterB_cnt_41_SLT_3___d2287,
  ...
  SizedFIFO #(.p1width(32'd32),
	      .p2depth(32'd3),
	      .p3cntr_width(32'd1),
	      .guarded(32'd1)) pat0_dataBram_serverAdapterA_outDataCore(.RST_N(clkN210$clk0_rstn),
									.CLK(clkN210$clk0_buf),
  ...
  SizedFIFO #(.p1width(32'd32),
	      .p2depth(32'd3),
	      .p3cntr_width(32'd1),
	      .guarded(32'd1)) pat0_dataBram_serverAdapterB_outDataCore(.RST_N(clkN210$clk0_rstn),
									.CLK(clkN210$clk0_buf),
  ...
  FIFO10 #(.guarded(32'd1)) pat0_loopReqInFlightF(.RST_N(clkN210$clk0_rstn),
						  .CLK(clkN210$clk0_buf),
  ...
  SizedFIFO #(.p1width(32'd32),
	      .p2depth(32'd3),
	      .p3cntr_width(32'd1),
	      .guarded(32'd1)) pat0_metaBram_serverAdapterA_1_outDataCore(.RST_N(clkN210$clk0_rstn),
									  .CLK(clkN210$clk0_buf),
  ...
  SizedFIFO #(.p1width(32'd32),
	      .p2depth(32'd3),
	      .p3cntr_width(32'd1),
	      .guarded(32'd1)) pat0_metaBram_serverAdapterA_2_outDataCore(.RST_N(clkN210$clk0_rstn),
									  .CLK(clkN210$clk0_buf),
  ...
  SizedFIFO #(.p1width(32'd32),
	      .p2depth(32'd3),
	      .p3cntr_width(32'd1),
	      .guarded(32'd1)) pat0_metaBram_serverAdapterA_3_outDataCore(.RST_N(clkN210$clk0_rstn),
									  .CLK(clkN210$clk0_buf),
  ...
  SizedFIFO #(.p1width(32'd32),
	      .p2depth(32'd3),
	      .p3cntr_width(32'd1),
	      .guarded(32'd1)) pat0_metaBram_serverAdapterA_outDataCore(.RST_N(clkN210$clk0_rstn),
									.CLK(clkN210$clk0_buf),
  ...
  SizedFIFO #(.p1width(32'd32),
	      .p2depth(32'd3),
	      .p3cntr_width(32'd1),
	      .guarded(32'd1)) pat0_metaBram_serverAdapterB_1_outDataCore(.RST_N(clkN210$clk0_rstn),
									  .CLK(clkN210$clk0_buf),
  ...
  SizedFIFO #(.p1width(32'd32),
	      .p2depth(32'd3),
	      .p3cntr_width(32'd1),
	      .guarded(32'd1)) pat0_metaBram_serverAdapterB_2_outDataCore(.RST_N(clkN210$clk0_rstn),
									  .CLK(clkN210$clk0_buf),
  ...
  SizedFIFO #(.p1width(32'd32),
	      .p2depth(32'd3),
	      .p3cntr_width(32'd1),
	      .guarded(32'd1)) pat0_metaBram_serverAdapterB_3_outDataCore(.RST_N(clkN210$clk0_rstn),
									  .CLK(clkN210$clk0_buf),
  ...
  SizedFIFO #(.p1width(32'd32),
	      .p2depth(32'd3),
	      .p3cntr_width(32'd1),
	      .guarded(32'd1)) pat0_metaBram_serverAdapterB_outDataCore(.RST_N(clkN210$clk0_rstn),
									.CLK(clkN210$clk0_buf),
  ...
  FIFO10 #(.guarded(32'd1)) pat0_metaReqInFlightF(.RST_N(clkN210$clk0_rstn),
						  .CLK(clkN210$clk0_buf),
  ...
  FIFO2 #(.width(32'd3),
	  .guarded(32'd1)) pat0_splaF(.RST_N(clkN210$clk0_rstn),
				      .CLK(clkN210$clk0_buf),
  ...
  SizedFIFO #(.p1width(32'd72),
	      .p2depth(32'd3),
	      .p3cntr_width(32'd1),
	      .guarded(32'd1)) pat0_wci_wslv_reqF(.RST_N(clkN210$clk0_rstn),
						  .CLK(clkN210$clk0_buf),
  ...
  FIFO10 #(.guarded(32'd1)) sma0_mesgTokenF(.RST_N(clkN210$clk0_rstn),
					    .CLK(clkN210$clk0_buf),
  ...
  SizedFIFO #(.p1width(32'd72),
	      .p2depth(32'd3),
	      .p3cntr_width(32'd1),
	      .guarded(32'd1)) sma0_wci_wslv_reqF(.RST_N(clkN210$clk0_rstn),
						  .CLK(clkN210$clk0_buf),
  ...
  FIFO2 #(.width(32'd34),
	  .guarded(32'd1)) sma0_wmi_respF(.RST_N(clkN210$clk0_rstn),
					  .CLK(clkN210$clk0_buf),
  ...
  SizedFIFO #(.p1width(32'd61),
	      .p2depth(32'd3),
	      .p3cntr_width(32'd1),
	      .guarded(32'd1)) sma0_wsiS_reqFifo(.RST_N(clkN210$clk0_rstn),
						 .CLK(clkN210$clk0_buf),
  ...
  assign MUX_sma0_wmi_mFlagF_x_wire$wset_1__SEL_1 =
	     WILL_FIRE_RL_sma0_wmrd_mesgBodyRequest && x__h52382 ;
  ...
  assign MUX_pat0_unrollCnt$write_1__VAL_1 =
	     (v__h26024 == 32'd0) ? 16'd1 : b__h26641[15:0] ;
  ...
  assign MUX_pat0_wci_wslv_respF_x_wire$wset_1__VAL_3 = { 2'd1, v__h30389 } ;
  ...
  assign MUX_sma0_fabRespCredit_value$write_1__VAL_2 =
	     ...
	     (WILL_FIRE_RL_sma0_wmrd_mesgBodyRequest ? b__h49026 : 12'd0) +
	     (WILL_FIRE_RL_sma0_wmrd_mesgResptoWsi ? 12'd1 : 12'd0) ;
  assign MUX_sma0_fabWordsRemain$write_1__VAL_1 =
	     (sma0_wmi_sFlagReg[23:0] == 24'd0) ? 14'd1 : b__h51838[13:0] ;
  ...
  assign MUX_sma0_unrollCnt$write_1__VAL_1 =
	     (sma0_wmi_sFlagReg[23:0] == 24'd0) ? 16'd1 : b__h51838[15:0] ;
  ...
  assign MUX_sma0_wmi_mFlagF_q_1$write_1__VAL_2 =
	     (sma0_wmi_mFlagF_c_r == 2'd2) ? value__h40519 : 32'd0 ;
  assign MUX_sma0_wmi_mFlagF_x_wire$wset_1__VAL_2 =
	     { mesgMetaF_opcode__h56419, mesgMetaF_length__h56420 } ;
  ...
  assign pat0_metaBram_serverAdapterA_outData_enqData$whas =
	     ...
	     pat0_metaBram_serverAdapterA_s1[0] ;
  assign pat0_metaBram_serverAdapterA_outData_outData$wget = v__h26024 ;
  ...
  assign sma0_wmi_reqF_x_wire$whas =
	     WILL_FIRE_RL_sma0_wmrd_mesgBodyRequest ||
	     WILL_FIRE_RL_sma0_wmwt_messagePush ;
  assign sma0_wmi_mFlagF_x_wire$wget = value__h40519 ;
  ...
  assign sma0_wsiS_sThreadBusy_dw$whas =
	     ...
	     sma0_wsiS_peerIsReady ;
  assign sma0_fabRespCredit_acc_v1$wget = b__h49026 ;
  ...
  // register pat0_doZLM
  assign pat0_doZLM$D_IN = WILL_FIRE_RL_pat0_resp_meta && v__h26024 == 32'd0 ;
  ...
  // register pat0_thisLength
  assign pat0_thisLength$D_IN = v__h26024 ;
  ...
  assign sma0_mesgLengthSoFar$D_IN =
	     WILL_FIRE_RL_sma0_wmwt_messagePush ? mlB__h56253 : 14'd0 ;
  ...
  begin
    case (1'b1) // synopsys parallel_case
      MUX_sma0_wmi_mFlagF_q_0$write_1__SEL_1:
	  sma0_wmi_mFlagF_q_0$D_IN = value__h40519;
      WILL_FIRE_RL_sma0_wmi_mFlagF_both:
  ...
  begin
    case (1'b1) // synopsys parallel_case
      MUX_sma0_wmi_mFlagF_q_1$write_1__SEL_1:
	  sma0_wmi_mFlagF_q_1$D_IN = value__h40519;
      WILL_FIRE_RL_sma0_wmi_mFlagF_both:
  ...
  assign IF_sma0_respF_wDataIn_whas__615_THEN_sma0_resp_ETC___d2175 =
	     sma0_respF_pwEnqueue$whas ?
	       sma0_respF_wDataIn$wget[60:58] :
	       3'd0 ;
  assign IF_sma0_respF_wDataIn_whas__615_THEN_sma0_resp_ETC___d2184 =
	     sma0_respF_pwEnqueue$whas ?
  ...
  assign NOT_sma0_wmi_reqF_c_r_341_EQ_2_359_360_AND_sma_ETC___d1706 =
	     ...
	     sma0_wmi_peerIsReady &&
	     (!x__h52382 || sma0_wmi_mFlagF_c_r != 2'd2) ;
  assign ab__h13027 = MUX_pat0_dataBram_memory$b_put_1__SEL_1 ? 2'd0 : 2'd2 ;
  assign ab__h16126 = MUX_pat0_metaBram_memory$b_put_1__SEL_1 ? 2'd0 : 2'd2 ;
  assign ab__h19053 =
  ...
  assign b__h26641 = x__h26657 + residue__h26630 ;
  assign b__h49026 = -sma0_fabWordsCurReq[11:0] ;
  assign b__h51838 = x__h51958 + residue__h51701 ;
  assign b__h52211 =
	     { {2{sma0_fabRespCredit_value[11]}}, sma0_fabRespCredit_value } ;
  assign g_data__h33776 =
	     (pat0_wci_wslv_reqF$D_OUT[63:52] == 12'h0) ? v__h32765 : 32'd0 ;
  assign mesgMetaF_length__h56420 =
	     (sma0_wsiS_reqFifo$D_OUT[57] &&
	      sma0_wsiS_reqFifo$D_OUT[11:8] == 4'd0 &&
	      sma0_mesgLengthSoFar == 14'd0) ?
	       24'd0 :
	       { 10'd0, mlB__h56253 } ;
  assign mesgMetaF_opcode__h56419 = sma0_opcode[8] ? sma0_opcode[7:0] : 8'd0 ;
  assign mlB__h56253 = sma0_mesgLengthSoFar + mlInc__h56252 ;
  assign mlInc__h56252 =
	     sma0_wsiS_reqFifo$D_OUT[57] ?
	       { 11'd0, x__h56459 + y__h56460 } :
	       14'd4 ;
  ...
  assign pat0_dataBram_serverAdapterB_cnt_41_PLUS_IF_pa_ETC___d347 =
		...
		3'd7 :
		3'd0) ;
  assign pat0_dataBram_serverAdapterB_cnt_41_SLT_3___d2287 =
  ...
  assign rdat___1__h32941 = { 24'd0, pat0_wsiM_statusR } ;
  assign rdat__h57876 = { 16'd0, x__h57879 } ;
  assign residue__h26630 =
	     ({ 4'd0, v__h26024[1:0] } == 6'd0) ? 32'd0 : 32'd1 ;
  assign residue__h51701 =
	     ({ 4'd0, sma0_wmi_sFlagReg[1:0] } == 6'd0) ? 24'd0 : 24'd1 ;
  assign sendData_burstLength__h52668 =
	     (sma0_thisMesg[15:0] == 16'd0 ||
	      sma0_smaCtrl[5] && sma0_unrollCnt == 16'd1) ?
	       12'd1 :
	       (sma0_smaCtrl[5] ? 12'd4095 : wsiBurstLength__h52586[11:0]) ;
  assign sendData_byteEn__h52670 =
	     (sma0_thisMesg[15:0] == 16'd0) ?
	       4'd0 :
	       ((sma0_unrollCnt == 16'd1) ? x__h52727[3:0] : 4'd15) ;
  ...
  assign value__h40519 =
	     MUX_sma0_wmi_mFlagF_x_wire$wset_1__SEL_1 ?
	       32'hAAAAAAAA /* unspecified value */  :
	       MUX_sma0_wmi_mFlagF_x_wire$wset_1__VAL_2 ;
  assign wsiBurstLength__h52586 =
	     sma0_smaCtrl[5] ? 16'd2 : { 2'd0, sma0_thisMesg[15:2] } ;
  assign x__h26657 = { 2'd0, v__h26024[31:2] } ;
  assign x__h27583 =
													...
													6'd30) ?
													 ...
													 (({ 4'd0,
													   ...
													   6'd31) ?
													    32'h7FFFFFFF :
													    32'hFFFFFFFF))))))))))))))))))))))))))))))) ;
  assign x__h50380 = sma0_respF_rRdPtr + 12'd1 ;
  assign x__h51958 = { 2'd0, sma0_wmi_sFlagReg[23:2] } ;
  assign x__h52382 = sma0_fabWordsRemain == sma0_fabWordsCurReq ;
  assign x__h52727 =
													...
													6'd30) ?
													 ...
													 (({ 4'd0,
													   ...
													   6'd31) ?
													    32'h7FFFFFFF :
													    32'hFFFFFFFF))))))))))))))))))))))))))))))) ;
  assign x__h56459 = x__h56471 + y__h56472 ;
  assign x__h56471 = x__h56483 + y__h56484 ;
  assign x__h56483 = { 2'd0, sma0_wsiS_reqFifo$D_OUT[11] } ;
  assign x__h57879 = { sma0_wsiS_statusR, sma0_wsiM_statusR } ;
  assign x_burstLength__h27417 =
	     (pat0_thisLength == 32'd0 || pat0_unrollCnt == 16'd1) ?
	       12'd1 :
	       12'd4095 ;
  assign x_byteEn__h27419 =
	     (pat0_thisLength == 32'd0) ?
	       4'd0 :
	       ((pat0_unrollCnt == 16'd1) ? x__h27583[3:0] : 4'd15) ;
  assign x_length__h56820 = { 2'd0, mlB__h56253 } ;
  assign y__h56460 = { 2'd0, sma0_wsiS_reqFifo$D_OUT[8] } ;
  assign y__h56472 = { 2'd0, sma0_wsiS_reqFifo$D_OUT[9] } ;
  assign y__h56484 = { 2'd0, sma0_wsiS_reqFifo$D_OUT[10] } ;
  assign y_avValue__h31015 =
	     pat0_dataBram_serverAdapterB_outDataCore$EMPTY_N ?
	       pat0_dataBram_serverAdapterB_outDataCore$D_OUT :
	       pat0_dataBram_memory$DOB ;
  assign y_avValue__h31059 =
	     pat0_metaBram_serverAdapterB_outDataCore$EMPTY_N ?
	       pat0_metaBram_serverAdapterB_outDataCore$D_OUT :
	       pat0_metaBram_memory$DOB ;
  assign y_avValue__h31099 =
	     pat0_metaBram_serverAdapterB_1_outDataCore$EMPTY_N ?
	       pat0_metaBram_serverAdapterB_1_outDataCore$D_OUT :
	       pat0_metaBram_memory_1$DOB ;
  assign y_avValue__h31139 =
	     pat0_metaBram_serverAdapterB_2_outDataCore$EMPTY_N ?
	       pat0_metaBram_serverAdapterB_2_outDataCore$D_OUT :
	       pat0_metaBram_memory_2$DOB ;
  assign y_avValue__h31179 =
	     pat0_metaBram_serverAdapterB_3_outDataCore$EMPTY_N ?
	       pat0_metaBram_serverAdapterB_3_outDataCore$D_OUT :
	       pat0_metaBram_memory_3$DOB ;
  always@(pat0_splaF$D_OUT or
	  y_avValue__h31179 or
	  y_avValue__h31059 or y_avValue__h31099 or y_avValue__h31139)
  begin
  ...
  always@(pat0_wci_wslv_reqF$D_OUT or
	  ...
	  IF_pat0_wci_wslv_reqF_first__3_BITS_35_TO_34_0_ETC___d2520 or
	  pat0_dataBram_serverAdapterB_cnt_41_SLT_3___d2287)
  begin
  ...
  always@(pat0_wci_wslv_reqF$D_OUT or
	  ...
	  pat0_mesgCount or
	  pat0_dataCount or
	  pat0_mesgRemain or rdat___1__h32941 or pat0_wsiM_extStatusW$wget)
  begin
    case (pat0_wci_wslv_reqF$D_OUT[39:32])
      8'h0: v__h32765 = pat0_controlReg;
      8'h08: v__h32765 = pat0_mesgCount;
      8'h0C: v__h32765 = pat0_dataCount;
      8'h10: v__h32765 = pat0_mesgRemain;
      8'h1C: v__h32765 = 32'hA0240A0A;
      8'h20: v__h32765 = rdat___1__h32941;
      8'h24: v__h32765 = pat0_wsiM_extStatusW$wget[95:64];
      8'h28: v__h32765 = pat0_wsiM_extStatusW$wget[63:32];
      8'h2C: v__h32765 = pat0_wsiM_extStatusW$wget[31:0];
      default: v__h32765 = 32'd0;
    endcase
  end
  always@(pat0_splaF$D_OUT or
  ...
  begin
    case (sma0_wci_wslv_reqF$D_OUT[39:32])
      8'h0: g_data__h57789 = sma0_smaCtrl;
      8'h04: g_data__h57789 = sma0_mesgCount;
      8'h08: g_data__h57789 = sma0_abortCount;
      8'h10: g_data__h57789 = sma0_thisMesg;
      8'h14: g_data__h57789 = sma0_lastMesg;
      8'h18: g_data__h57789 = rdat__h57876;
      8'h20: g_data__h57789 = sma0_wsiS_extStatusW$wget[95:64];
      8'h24: g_data__h57789 = sma0_wsiS_extStatusW$wget[63:32];
      8'h28: g_data__h57789 = sma0_wsiS_extStatusW$wget[31:0];
      8'h2C: g_data__h57789 = sma0_wsiM_extStatusW$wget[95:64];
      8'h30: g_data__h57789 = sma0_wsiM_extStatusW$wget[63:32];
      8'h34: g_data__h57789 = sma0_wsiM_extStatusW$wget[31:0];
      8'h38: g_data__h57789 = sma0_wmwtBeginCount;
      8'h3C: g_data__h57789 = sma0_wmwtPushCount;
      8'h40: g_data__h57789 = sma0_wmwtFinalCount;
      8'h44: g_data__h57789 = 32'hFEEDC0DE;
      default: g_data__h57789 = 32'd0;
    endcase
  end
  ...
  always@(posedge clkN210$clk0_buf or negedge clkN210$clk0_rstn)
  if (!clkN210$clk0_rstn)
    begin
  ...
  begin
    ...
    if (clkN210$clk0_rstn)
      if (WILL_FIRE_RL_pat0_advance_split_response)
	$display("[%0d]: %m: WCI SPLIT READ Data:%0x", v__h31307, v__h30389);
    if (clkN210$clk0_rstn)
      if (WILL_FIRE_RL_pat0_advance_split_response &&
	  WILL_FIRE_RL_pat0_wci_ctrl_OrE)
    ...
    if (clkN210$clk0_rstn)
      if (WILL_FIRE_RL_sma0_wmwt_doAbort)
	$display("[%0d]: %m: wmwt_doAbort", v__h57240);
    if (clkN210$clk0_rstn)
