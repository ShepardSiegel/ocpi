...
//
// On Mon Aug  6 14:42:46 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkFTop_n210(sys0_clkp,
  ...
  wire [1 : 0] edp0$wciS0_MFlag, edp0$wciS0_SFlag, edp0$wciS0_SResp;
  ...
  assign edp0$wmiS0_MAddr = 14'h0 ;
  assign edp0$wmiS0_MAddrSpace = 1'b0 ;
  assign edp0$wmiS0_MBurstLength = 12'h0 ;
  assign edp0$wmiS0_MCmd = 3'h0 ;
  assign edp0$wmiS0_MData = 32'h0 ;
  assign edp0$wmiS0_MDataByteEn = 4'h0 ;
  assign edp0$wmiS0_MReqInfo = 1'b0 ;
  assign edp0$wmiS0_arg_mFlag = 32'h0 ;
  assign edp0$wtiS0_req = 67'h0 ;
  assign edp0$wmiS0_MReqLast = 1'b0 ;
  assign edp0$wmiS0_MDataValid = 1'b0 ;
  assign edp0$wmiS0_MDataLast = 1'b0 ;
  assign edp0$wmiS0_MReset_n = 1'b0 ;
