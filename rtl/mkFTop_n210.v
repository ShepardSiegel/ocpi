...
//
// On Fri Aug  3 15:54:46 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkFTop_n210(sys0_clkp,
  ...
  wire [9 : 0] edp0$server_request_put;
  ...
  wire [9 : 0] gbe0$dpClient_response_put;
  ...
  // submodule edp0
  assign edp0$server_request_put = 10'h0 ;
  ...
  assign edp0$EN_server_request_put = 1'b0 ;
  assign edp0$EN_server_response_get = 1'b0 ;

  // submodule gbe0
  assign gbe0$cpClient_response_put = cp$server_response_get ;
  assign gbe0$dpClient_response_put = 10'h0 ;
  ...
  assign gbe0$EN_cpClient_response_put =
	     gbe0$RDY_cpClient_response_put && cp$RDY_server_response_get ;
  assign gbe0$EN_dpClient_request_get = 1'b0 ;
  assign gbe0$EN_dpClient_response_put = 1'b0 ;
