...
//
// On Tue Jun  5 15:23:29 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkFTop_n210(sys0_clkp,
  ...
  // ports of submodule flashw
  wire [31 : 0] flashw$wciS0_MAddr, flashw$wciS0_MData, flashw$wciS0_SData;
  wire [3 : 0] flashw$wciS0_MByteEn;
  wire [2 : 0] flashw$wciS0_MCmd;
  wire [1 : 0] flashw$wciS0_MFlag, flashw$wciS0_SFlag, flashw$wciS0_SResp;
  wire flashw$pads_clk,
       flashw$pads_csn,
       flashw$pads_miso_i,
       flashw$pads_mosi,
       flashw$wciS0_MAddrSpace,
       flashw$wciS0_SThreadBusy;
  ...
  // value method flash_mosi
  assign flash_mosi = flashw$pads_mosi ;

  // value method flash_clk
  assign flash_clk = flashw$pads_clk ;

  // value method flash_csn
  assign flash_csn = flashw$pads_csn ;
  ...
  // submodule flashw
  mkSPIFlashWorker #(.hasDebugLogic(1'd1)) flashw(.wciS0_Clk(clkN210$clk0_buf),
						  .wciS0_MReset_n(cp$RST_N_wci_Vm_8),
						  .pads_miso_i(flashw$pads_miso_i),
						  .wciS0_MAddr(flashw$wciS0_MAddr),
						  .wciS0_MAddrSpace(flashw$wciS0_MAddrSpace),
						  .wciS0_MByteEn(flashw$wciS0_MByteEn),
						  .wciS0_MCmd(flashw$wciS0_MCmd),
						  .wciS0_MData(flashw$wciS0_MData),
						  .wciS0_MFlag(flashw$wciS0_MFlag),
						  .wciS0_SResp(flashw$wciS0_SResp),
						  .wciS0_SData(flashw$wciS0_SData),
						  .wciS0_SThreadBusy(flashw$wciS0_SThreadBusy),
						  .wciS0_SFlag(flashw$wciS0_SFlag),
						  .pads_mosi(flashw$pads_mosi),
						  .pads_clk(flashw$pads_clk),
						  .pads_csn(flashw$pads_csn));
  ...
  assign cp$wci_Vm_8_SData = flashw$wciS0_SData ;
  assign cp$wci_Vm_8_SFlag = flashw$wciS0_SFlag ;
  assign cp$wci_Vm_8_SResp = flashw$wciS0_SResp ;
  ...
  assign cp$wci_Vm_8_SThreadBusy = flashw$wciS0_SThreadBusy ;
  ...
  // submodule flashw
  assign flashw$pads_miso_i = flash_miso_i ;
  assign flashw$wciS0_MAddr = cp$wci_Vm_8_MAddr ;
  assign flashw$wciS0_MAddrSpace = cp$wci_Vm_8_MAddrSpace ;
  assign flashw$wciS0_MByteEn = cp$wci_Vm_8_MByteEn ;
  assign flashw$wciS0_MCmd = cp$wci_Vm_8_MCmd ;
  assign flashw$wciS0_MData = cp$wci_Vm_8_MData ;
  assign flashw$wciS0_MFlag = cp$wci_Vm_8_MFlag ;
