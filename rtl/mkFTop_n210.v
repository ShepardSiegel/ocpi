...
//
// On Wed May 16 15:47:20 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkFTop_n210(sys0_clkp,
  ...
  mkOCCP cp(.pciDevice(16'hAAAA),
	    ...
	    .CLK(clkN210$clk125_buf),
	    .RST_N(clkN210$clk125_rstn),
  ...
  mkGbeLite #(.hasDebugLogic(1'd0)) gbe0(.CLK_gmii_rx_clk(gmii_rx_clk),
					 ...
					 .CLK_cpClock(clkN210$clk125_buf),
					 .RST_N_cpReset(clkN210$clk125_rstn),
  ...
  // submodule sys1_clki
  IBUFG sys1_clki(.I(gmii_sysclk), .O(sys1_clki$O));
