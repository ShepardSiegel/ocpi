...
//
// On Sat Sep  1 10:54:51 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkFTop_n210(sys0_clkp,
  ...
  // submodule cap0
  mkWSICaptureWorker4B #(.hasDebugLogic(1'd1)) cap0(.wciS0_Clk(clkN210$clkdv_buf),
  ...
  mkOCCP cp(.pciDevice(16'hAAAA),
	    .CLK_sys0_clk(clkN210$clkdv_buf),
  ...
  mkGbeLite #(.hasDebugLogic(1'd0)) gbe0(.CLK_gmii_rx_clk(gmii_rx_clk),
					 ...
					 .CLK_cpClock(clkN210$clkdv_buf),
					 .RST_N_cpReset(clkN210$clkdv_rstn),
  ...
  assign edp0$EN_server_request_put =
	     edp0$RDY_server_request_put && gbe0$RDY_dpClient_request_get ;
  assign edp0$EN_server_response_get =
	     edp0$RDY_server_response_get && gbe0$RDY_dpClient_response_put ;
