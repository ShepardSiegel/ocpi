...
//
// On Thu May 31 11:56:52 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkFTop_n210(sys0_clkp,
  ...
  wire [31 : 0] cp$wci_Vm_0_SData,
		...
		cp$wci_Vm_8_SData,
		cp$wci_Vm_9_SData;
  wire [3 : 0] cp$wci_Vm_7_MByteEn, cp$wci_Vm_8_MByteEn;
  wire [2 : 0] cp$switch_x, cp$wci_Vm_7_MCmd, cp$wci_Vm_8_MCmd;
  ...
  assign cp$wci_Vm_10_SData = 32'hAAAAAAAA /* unspecified value */  ;
  assign cp$wci_Vm_10_SFlag = 2'b0 ;
  assign cp$wci_Vm_10_SResp = 2'd0 ;
  ...
  assign cp$wci_Vm_10_SThreadBusy = 1'd1 ;
