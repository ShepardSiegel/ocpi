...
//
// On Tue Dec 28 10:55:35 EST 2010
//
//
// Ports:
// Name                         I/O  size props
// pcie_txp                       O     4
// pcie_txn                       O     4
// axi4m_wrAddr_data              O    23 reg
// axi4m_wrAddr_valid             O     1
// axi4m_wrData_data              O    36 reg
// axi4m_wrData_valid             O     1
// axi4m_wrResp_ready             O     1
// axi4m_rdAddr_data              O    23 reg
// axi4m_rdAddr_valid             O     1
// axi4m_rdResp_ready             O     1
// debug                          O    32
// p125clk                        O     1 clock
...
// pcie_rxp_i                     I     4
// pcie_rxn_i                     I     4
// axi4m_wrAddr_ready_value       I     1
// axi4m_wrData_ready_value       I     1
// axi4m_wrResp_data_value        I     2 reg
// axi4m_wrResp_valid_value       I     1
// axi4m_rdAddr_ready_value       I     1
// axi4m_rdResp_data_value        I    34 reg
// axi4m_rdResp_valid_value       I     1
//
...
module mkOPEDv6(pci0_clkp,
		...
		axi4m_wrAddr_ready_value,

		axi4m_wrData_data,

		axi4m_wrData_valid,

		axi4m_wrData_ready_value,

		axi4m_wrResp_data_value,

		axi4m_wrResp_valid_value,
		...
		axi4m_rdAddr_ready_value,

		axi4m_rdResp_data_value,

		axi4m_rdResp_valid_value,
  ...
  // value method axi4m_wrAddr_data
  output [22 : 0] axi4m_wrAddr_data;

  // value method axi4m_wrAddr_valid
  output axi4m_wrAddr_valid;

  // action method axi4m_wrAddr_ready
  input  axi4m_wrAddr_ready_value;

  // value method axi4m_wrData_data
  output [35 : 0] axi4m_wrData_data;

  // value method axi4m_wrData_valid
  output axi4m_wrData_valid;

  // action method axi4m_wrData_ready
  input  axi4m_wrData_ready_value;

  // action method axi4m_wrResp_data
  input  [1 : 0] axi4m_wrResp_data_value;

  // action method axi4m_wrResp_valid
  input  axi4m_wrResp_valid_value;

  // value method axi4m_wrResp_ready
  output axi4m_wrResp_ready;

  // value method axi4m_rdAddr_data
  output [22 : 0] axi4m_rdAddr_data;

  // value method axi4m_rdAddr_valid
  output axi4m_rdAddr_valid;

  // action method axi4m_rdAddr_ready
  input  axi4m_rdAddr_ready_value;

  // action method axi4m_rdResp_data
  input  [33 : 0] axi4m_rdResp_data_value;

  // action method axi4m_rdResp_valid
  input  axi4m_rdResp_valid_value;

  // value method axi4m_rdResp_ready
  output axi4m_rdResp_ready;
  ...
  wire [35 : 0] axi4m_wrData_data;
  wire [31 : 0] debug;
  wire [22 : 0] axi4m_rdAddr_data, axi4m_wrAddr_data;
  ...
  wire [2 : 0] cp$switch_x, cp$wci_Vm_0_MCmd;
  ...
  wire [22 : 0] wci2axi$axiM0_rdAddr_data, wci2axi$axiM0_wrAddr_data;
  ...
  wire CAN_FIRE_RL_ClientServerRequest,
       ...
       CAN_FIRE_axi4m_rdAddr_ready,
       CAN_FIRE_axi4m_rdResp_data,
       CAN_FIRE_axi4m_rdResp_valid,
       CAN_FIRE_axi4m_wrAddr_ready,
       CAN_FIRE_axi4m_wrData_ready,
       CAN_FIRE_axi4m_wrResp_data,
       CAN_FIRE_axi4m_wrResp_valid,
       CAN_FIRE_pcie_rxn,
       CAN_FIRE_pcie_rxp,
       ...
       WILL_FIRE_axi4m_rdAddr_ready,
       WILL_FIRE_axi4m_rdResp_data,
       WILL_FIRE_axi4m_rdResp_valid,
       WILL_FIRE_axi4m_wrAddr_ready,
       WILL_FIRE_axi4m_wrData_ready,
       WILL_FIRE_axi4m_wrResp_data,
       WILL_FIRE_axi4m_wrResp_valid,
       WILL_FIRE_pcie_rxn,
       WILL_FIRE_pcie_rxp;
  ...
  reg [63 : 0] v__h103593,
	       ...
	       v__h86237,
	       v__h86399;
  reg [31 : 0] IF_0_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d4497,
	       IF_0_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d4502,
	       IF_1_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d4498,
	       IF_1_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d4503,
	       IF_2_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d4499,
	       IF_2_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d4504,
	       IF_3_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d4500,
	       IF_3_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d4505,
	       IF_dp0_tlp_readReq_first__424_BITS_30_TO_29_42_ETC___d4501,
	       IF_dp1_tlp_readReq_first__455_BITS_30_TO_29_45_ETC___d4506,
	       _theResult____h163650,
	       _theResult____h86383,
	       rdata__h156852,
	       rdata__h79582;
  reg [15 : 0] CASE_dp0_tlp_outDwRemain_BITS_1_TO_0_0xFFF0_0b_ETC__q23,
	       CASE_dp1_tlp_outDwRemain_BITS_1_TO_0_0xFFF0_0b_ETC__q24;
  reg [1 : 0] lowAddr10__h138929,
	      lowAddr10__h61659,
	      x__h139051,
	      x__h139074,
	      x__h61781,
  ...
  reg CASE_dp0_dpControl_BITS_1_TO_0_NOT_dp0_bml_fab_ETC__q17,
      ...
      IF_0_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d4403,
      IF_0_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d3238,
      IF_0_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d4423,
      IF_1_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d1217,
      IF_1_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d4404,
      IF_1_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d3248,
      IF_1_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d4424,
      IF_2_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d1227,
      IF_2_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d4432,
      IF_2_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d3258,
      IF_2_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d4433,
      IF_3_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d1237,
      IF_3_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d4405,
      IF_3_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d3268,
      IF_3_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d4425,
      IF_dp0_bml_dpControl_wget__970_BITS_1_TO_0_976_ETC___d2047,
      IF_dp0_tlp_readReq_first__424_BITS_30_TO_29_42_ETC___d1439,
      IF_dp0_wmi_addr_802_BITS_3_TO_2_803_EQ_0_804_T_ETC___d4387,
      ...
      IF_dp1_wmi_addr_833_BITS_3_TO_2_834_EQ_0_835_T_ETC___d4388,
  ...
  wire [127 : 0] IF_dp0_tlp_readNxtDWAddr_376_BIT_0_553_THEN_dp_ETC___d1558,
		 ...
		 w_data__h46974,
		 w_data__h48288;
  wire [31 : 0] dp0_bml_fabFlowAddr_009_PLUS_dp0_bml_fabFlowSi_ETC___d4939,
		dp1_bml_fabFlowAddr_040_PLUS_dp1_bml_fabFlowSi_ETC___d4940,
		mesgMeta_opcode__h155132,
		mesgMeta_opcode__h77862,
		nowLS__h109890,
		nowLS__h43481,
		nowMS__h109889,
		nowMS__h43480,
  ...
  wire [12 : 0] dp0_tlp_readNxtDWAddr_PLUS_1__q7,
		...
		spanToNextPage__h113103,
		spanToNextPage__h46692,
		thisRequestLength__h113104,
		thisRequestLength__h46693;
  wire [11 : 0] byteCount__h138931,
		byteCount__h61661,
		x__h139042,
		x__h139044,
		x__h61772,
		...
		y__h61773,
		y__h61775;
  wire [9 : 0] x__h113659, x__h47303, x__h47981;
  wire [7 : 0] rreq_tag__h113333, tag__h46968, tagm__h47094;
  wire [6 : 0] lowAddr__h138930, lowAddr__h61660;
  wire [3 : 0] lastBE__h113532, lastBE__h46995;
  ...
  wire IF_1_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d1240,
       ...
       _dfoo13,
       dp0_bml_crdBuf_value_952_EQ_dp0_bml_crdBuf_mod_ETC___d5074,
       dp0_bml_fabBuf_value_937_EQ_dp0_bml_fabBuf_mod_ETC___d5075,
       dp0_bml_lclBufDone_994_AND_IF_dp0_bml_dpContro_ETC___d4407,
       dp0_bml_lclBuf_value_907_EQ_dp0_bml_lclBuf_mod_ETC___d5090,
       dp0_bml_remBuf_value_922_EQ_dp0_bml_remBuf_mod_ETC___d5091,
       dp0_bram_serverAdapterA_1_cnt_50_SLT_3___d4944,
       dp0_bram_serverAdapterA_2_cnt_68_SLT_3___d4945,
       dp0_bram_serverAdapterA_2_outDataCore_notEmpty_ETC___d1518,
       dp0_bram_serverAdapterA_3_cnt_86_SLT_3___d4946,
       dp0_bram_serverAdapterA_cnt_32_SLT_3___d4943,
       ...
       dp0_tlp_dmaPullRemainDWLen_017_ULE_dp0_tlp_dma_ETC___d4941,
       dp0_tlp_dmaPullRemainDWSub_031_ULE_4___d4942,
       ...
       dp0_tlp_outDwRemain_142_ULE_4___d4603,
       dp0_tlp_rdRespDwRemain_508_ULE_4___d1509,
       dp0_tlp_readRemainDWLen_364_ULE_4___d1365,
       dp0_tlp_writeRemainDWLen_194_ULE_1___d4332,
       dp0_tlp_writeRemainDWLen_194_ULE_2___d4352,
       dp0_tlp_writeRemainDWLen_194_ULE_3___d4333,
       dp0_wmi_dpControl_whas__701_AND_dp0_bram_serve_ETC___d1747,
       dp1_bml_crdBuf_value_983_EQ_dp1_bml_crdBuf_mod_ETC___d5141,
       dp1_bml_fabBuf_value_968_EQ_dp1_bml_fabBuf_mod_ETC___d5142,
       dp1_bml_lclBufDone_025_AND_IF_dp1_bml_dpContro_ETC___d4427,
       dp1_bml_lclBuf_value_938_EQ_dp1_bml_lclBuf_mod_ETC___d5157,
       dp1_bml_remBuf_value_953_EQ_dp1_bml_remBuf_mod_ETC___d5158,
       dp1_bram_serverAdapterA_1_cnt_386_SLT_3___d4948,
       dp1_bram_serverAdapterA_2_cnt_504_SLT_3___d4949,
       dp1_bram_serverAdapterA_2_outDataCore_notEmpty_ETC___d3549,
       dp1_bram_serverAdapterA_3_cnt_622_SLT_3___d4950,
       dp1_bram_serverAdapterA_cnt_268_SLT_3___d4947,
       ...
       dp1_tlp_mRespF_first__905_BITS_71_TO_62_995_ULE_1___d4334,
       dp1_tlp_outDwRemain_021_ULE_4___d4608,
       dp1_tlp_rdRespDwRemain_539_ULE_4___d3540,
       dp1_tlp_readRemainDWLen_395_ULE_4___d3396,
       dp1_tlp_writeRemainDWLen_225_ULE_1___d4335,
       dp1_tlp_writeRemainDWLen_225_ULE_2___d4350,
       dp1_tlp_writeRemainDWLen_225_ULE_3___d4382,
  ...
  // value method axi4m_wrAddr_data
  assign axi4m_wrAddr_data = wci2axi$axiM0_wrAddr_data ;

  // value method axi4m_wrAddr_valid
  assign axi4m_wrAddr_valid = wci2axi$axiM0_wrAddr_valid ;

  // action method axi4m_wrAddr_ready
  assign CAN_FIRE_axi4m_wrAddr_ready = 1'd1 ;
  assign WILL_FIRE_axi4m_wrAddr_ready = 1'd1 ;

  // value method axi4m_wrData_data
  assign axi4m_wrData_data = wci2axi$axiM0_wrData_data ;

  // value method axi4m_wrData_valid
  assign axi4m_wrData_valid = wci2axi$axiM0_wrData_valid ;

  // action method axi4m_wrData_ready
  assign CAN_FIRE_axi4m_wrData_ready = 1'd1 ;
  assign WILL_FIRE_axi4m_wrData_ready = 1'd1 ;

  // action method axi4m_wrResp_data
  assign CAN_FIRE_axi4m_wrResp_data = 1'd1 ;
  assign WILL_FIRE_axi4m_wrResp_data = 1'd1 ;

  // action method axi4m_wrResp_valid
  assign CAN_FIRE_axi4m_wrResp_valid = 1'd1 ;
  assign WILL_FIRE_axi4m_wrResp_valid = 1'd1 ;

  // value method axi4m_wrResp_ready
  assign axi4m_wrResp_ready = wci2axi$axiM0_wrResp_ready ;

  // value method axi4m_rdAddr_data
  assign axi4m_rdAddr_data = wci2axi$axiM0_rdAddr_data ;

  // value method axi4m_rdAddr_valid
  assign axi4m_rdAddr_valid = wci2axi$axiM0_rdAddr_valid ;

  // action method axi4m_rdAddr_ready
  assign CAN_FIRE_axi4m_rdAddr_ready = 1'd1 ;
  assign WILL_FIRE_axi4m_rdAddr_ready = 1'd1 ;

  // action method axi4m_rdResp_data
  assign CAN_FIRE_axi4m_rdResp_data = 1'd1 ;
  assign WILL_FIRE_axi4m_rdResp_data = 1'd1 ;

  // action method axi4m_rdResp_valid
  assign CAN_FIRE_axi4m_rdResp_valid = 1'd1 ;
  assign WILL_FIRE_axi4m_rdResp_valid = 1'd1 ;

  // value method axi4m_rdResp_ready
  assign axi4m_rdResp_ready = wci2axi$axiM0_rdResp_ready ;
  ...
  assign MUX_dp0_bml_fabBufsAvail$write_1__VAL_1 =
	     (dp0_bml_fabAvail && !dp0_bml_remStart) ? x__h84849 : x__h84854 ;
  assign MUX_dp0_bml_fabBufsAvail$write_1__VAL_2 =
	     (dp0_dpControl[3:2] == 2'd1) ? x__h83606 : 16'd0 ;
  assign MUX_dp0_bml_fabFlowAddr$write_1__VAL_1 =
	     dp0_bml_fabBuf_value_937_EQ_dp0_bml_fabBuf_mod_ETC___d5075 ?
	       dp0_bml_fabFlowBase :
	       dp0_bml_fabFlowAddr_009_PLUS_dp0_bml_fabFlowSi_ETC___d4939 ;
  ...
  assign MUX_dp0_bram_memory$a_put_3__VAL_3 =
	     { IF_0_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d4497[7:0],
	       IF_0_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d4497[15:8],
	       IF_0_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d4497[23:16],
	       IF_0_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d4497[31:24] } ;
  ...
  assign MUX_dp0_bram_memory_1$a_put_3__VAL_3 =
	     { IF_1_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d4498[7:0],
	       IF_1_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d4498[15:8],
	       IF_1_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d4498[23:16],
	       IF_1_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d4498[31:24] } ;
  assign MUX_dp0_bram_memory_1$b_put_3__VAL_4 =
	     { 24'h800000, dp0_wmi_wmi_mFlagReg[31:24] } ;
  always@(idx__h56001 or
	  dp0_tlp_writeDWAddr_PLUS_3__q3 or
	  dp0_tlp_writeDWAddr or
	  dp0_tlp_writeDWAddr_PLUS_1__q4 or dp0_tlp_writeDWAddr_PLUS_2__q5)
  begin
  ...
  assign MUX_dp0_bram_memory_2$a_put_3__VAL_3 =
	     { IF_2_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d4499[7:0],
	       IF_2_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d4499[15:8],
	       IF_2_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d4499[23:16],
	       IF_2_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d4499[31:24] } ;
  always@(idx__h57297 or
	  dp0_tlp_writeDWAddr_PLUS_3__q3 or
	  dp0_tlp_writeDWAddr or
	  dp0_tlp_writeDWAddr_PLUS_1__q4 or dp0_tlp_writeDWAddr_PLUS_2__q5)
  begin
  ...
  assign MUX_dp0_bram_memory_3$a_put_3__VAL_3 =
	     { IF_3_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d4500[7:0],
	       IF_3_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d4500[15:8],
	       IF_3_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d4500[23:16],
	       IF_3_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d4500[31:24] } ;
  ...
  assign MUX_dp0_tlp_mesgComplReceived$write_1__VAL_2 =
	     dp0_tlp_mesgComplReceived + y__h47978 ;
  ...
  assign MUX_dp0_tlp_mesgLengthRemainPull$write_1__VAL_2 =
	     dp0_tlp_mesgLengthRemainPull - y__h46718 ;
  ...
  assign MUX_dp0_tlp_outF$enq_1__VAL_1 = { 25'd25362416, w_data__h41199 } ;
  assign MUX_dp0_tlp_outF$enq_1__VAL_2 = { 25'd25362416, w_data__h46974 } ;
  assign MUX_dp0_tlp_outF$enq_1__VAL_3 = { 25'd25296895, w_data__h48288 } ;
  ...
  assign MUX_dp0_wmi_wmi_respF_q_0$write_1__VAL_2 = { 2'd1, rdata__h79582 } ;
  ...
  assign MUX_dp1_bml_fabBufsAvail$write_1__VAL_2 =
	     (dp1_dpControl[3:2] == 2'd1) ? x__h160873 : 16'd0 ;
  ...
  assign MUX_dp1_bram_memory$a_put_3__VAL_3 =
	     { IF_0_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d4502[7:0],
	       IF_0_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d4502[15:8],
	       IF_0_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d4502[23:16],
	       IF_0_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d4502[31:24] } ;
  ...
  assign MUX_dp1_bram_memory_1$a_put_3__VAL_3 =
	     { IF_1_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d4503[7:0],
	       IF_1_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d4503[15:8],
	       IF_1_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d4503[23:16],
	       IF_1_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d4503[31:24] } ;
  assign MUX_dp1_bram_memory_1$b_put_3__VAL_4 =
	     { 24'h800000, dp1_wmi_wmi_mFlagReg[31:24] } ;
  always@(idx__h133271 or
	  dp1_tlp_writeDWAddr_PLUS_3__q9 or
	  dp1_tlp_writeDWAddr or
	  dp1_tlp_writeDWAddr_PLUS_1__q10 or dp1_tlp_writeDWAddr_PLUS_2__q11)
  begin
  ...
  assign MUX_dp1_bram_memory_2$a_put_3__VAL_3 =
	     { IF_2_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d4504[7:0],
	       IF_2_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d4504[15:8],
	       IF_2_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d4504[23:16],
	       IF_2_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d4504[31:24] } ;
  always@(idx__h134567 or
	  dp1_tlp_writeDWAddr_PLUS_3__q9 or
	  dp1_tlp_writeDWAddr or
	  dp1_tlp_writeDWAddr_PLUS_1__q10 or dp1_tlp_writeDWAddr_PLUS_2__q11)
  begin
  ...
  assign MUX_dp1_bram_memory_3$a_put_3__VAL_3 =
	     { IF_3_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d4505[7:0],
	       IF_3_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d4505[15:8],
	       IF_3_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d4505[23:16],
	       IF_3_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d4505[31:24] } ;
  assign MUX_dp1_tlp_fabMesgAccu$write_1__VAL_2 =
	     dp1_tlp_fabMesgAccu + y__h113656 ;
  ...
  assign MUX_dp1_tlp_mReqF$enq_1__VAL_3 =
	     { 88'hAAAAAAAAAAAAAAAAAAFFF8,
	       ...
	       thisRequestLength__h113104[11:2],
	       8'd255,
	       rreq_tag__h113333,
	       3'h2 } ;
  ...
  assign MUX_dp1_tlp_mesgLengthRemainPush$write_1__VAL_2 =
	     dp1_tlp_mesgLengthRemainPush - y__h113144 ;
  ...
  assign MUX_dp1_tlp_outF$enq_1__VAL_1 =
	     { 1'd1,
	       ...
	       23'd196607,
	       w_data__h113508 } ;
  assign MUX_dp1_tlp_outF$enq_1__VAL_2 = { 25'd16973823, w_data__h114487 } ;
  assign MUX_dp1_tlp_outF$enq_1__VAL_3 = { 25'd8585200, w_data__h115549 } ;
  assign MUX_dp1_tlp_outF$enq_1__VAL_4 = { 25'd25296895, w_data__h125557 } ;
  ...
  assign MUX_dp1_tlp_remMesgAccu$write_1__VAL_2 =
	     dp1_tlp_remMesgAccu + y__h113286 ;
  assign MUX_dp1_tlp_srcMesgAccu$write_1__VAL_2 =
	     dp1_tlp_srcMesgAccu + y__h113238 ;
  ...
  assign MUX_dp1_wmi_wmi_respF_q_0$write_1__VAL_2 = { 2'd1, rdata__h156852 } ;
  ...
  assign dp0_bram_serverAdapterA_s1_1$wget =
	     { 1'd1, !ab__h12351[1] || ab__h12351[0] } ;
  ...
  assign dp0_bram_serverAdapterB_s1_1$wget =
	     { 1'd1, !ab__h13750[1] || ab__h13750[0] } ;
  ...
  assign dp0_bram_serverAdapterA_1_s1_1$wget =
	     { 1'd1, !ab__h15280[1] || ab__h15280[0] } ;
  ...
  assign dp0_bram_serverAdapterB_1_s1_1$wget =
	     { 1'd1, !ab__h16677[1] || ab__h16677[0] } ;
  ...
  assign dp0_bram_serverAdapterA_2_s1_1$wget =
	     { 1'd1, !ab__h18207[1] || ab__h18207[0] } ;
  ...
  assign dp0_bram_serverAdapterB_2_s1_1$wget =
	     { 1'd1, !ab__h19604[1] || ab__h19604[0] } ;
  ...
  assign dp0_bram_serverAdapterA_3_s1_1$wget =
	     { 1'd1, !ab__h21134[1] || ab__h21134[0] } ;
  ...
  assign dp0_bram_serverAdapterB_3_s1_1$wget =
	     { 1'd1, !ab__h22531[1] || ab__h22531[0] } ;
  ...
  assign dp0_tlp_pullTagMatch_1$wget =
	     tagm__h47094 == dp0_tlp_inF$D_OUT[47:40] &&
	     dp0_tlp_inF_first__02_BITS_63_TO_56_05_EQ_pciD_ETC___d914 ;
  ...
  assign dp1_bram_serverAdapterA_s1_1$wget =
	     { 1'd1, !ab__h89722[1] || ab__h89722[0] } ;
  ...
  assign dp1_bram_serverAdapterB_s1_1$wget =
	     { 1'd1, !ab__h91121[1] || ab__h91121[0] } ;
  ...
  assign dp1_bram_serverAdapterA_1_s1_1$wget =
	     { 1'd1, !ab__h92651[1] || ab__h92651[0] } ;
  ...
  assign dp1_bram_serverAdapterB_1_s1_1$wget =
	     { 1'd1, !ab__h94048[1] || ab__h94048[0] } ;
  ...
  assign dp1_bram_serverAdapterA_2_s1_1$wget =
	     { 1'd1, !ab__h95578[1] || ab__h95578[0] } ;
  ...
  assign dp1_bram_serverAdapterB_2_s1_1$wget =
	     { 1'd1, !ab__h96975[1] || ab__h96975[0] } ;
  ...
  assign dp1_bram_serverAdapterA_3_s1_1$wget =
	     { 1'd1, !ab__h98505[1] || ab__h98505[0] } ;
  ...
  assign dp1_bram_serverAdapterB_3_s1_1$wget =
	     { 1'd1, !ab__h99902[1] || ab__h99902[0] } ;
  ...
  begin
    case (1'b1) // synopsys parallel_case
      WILL_FIRE_RL_dp0_tlp_dmaPullRequestFarMesg:
	  dp0_tlp_dmaPullRemainDWLen$D_IN = thisRequestLength__h46693[11:2];
      WILL_FIRE_RL_dp0_tlp_dmaPullResponseHeader:
  ...
  always@(WILL_FIRE_RL_dp0_tlp_dmaPullResponseHeader or
	  ...
	  WILL_FIRE_RL_dp0_tlp_dmaPullResponseBody or
	  dp0_tlp_dmaPullRemainDWSub_031_ULE_4___d4942 or
	  WILL_FIRE_RL_dp0_tlp_dmaPullRequestFarMesg)
  begin
    case (1'b1) // synopsys parallel_case
      WILL_FIRE_RL_dp0_tlp_dmaPullResponseHeader:
  ...
  assign dp0_wmi_wmi_sFlagReg$D_IN =
	     { y_avValue__h79438[7:0], y_avValue__h79418[23:0] } ;
  ...
  assign dp1_wmi_wmi_sFlagReg$D_IN =
	     { y_avValue__h156708[7:0], y_avValue__h156688[23:0] } ;
  ...
  // submodule wci2axi
  assign wci2axi$axiM0_rdAddr_ready_value = axi4m_rdAddr_ready_value ;
  assign wci2axi$axiM0_rdResp_data_value = axi4m_rdResp_data_value ;
  assign wci2axi$axiM0_rdResp_valid_value = axi4m_rdResp_valid_value ;
  assign wci2axi$axiM0_wrAddr_ready_value = axi4m_wrAddr_ready_value ;
  assign wci2axi$axiM0_wrData_ready_value = axi4m_wrData_ready_value ;
  assign wci2axi$axiM0_wrResp_data_value = axi4m_wrResp_data_value ;
  assign wci2axi$axiM0_wrResp_valid_value = axi4m_wrResp_valid_value ;
  ...
  assign _dfoo13 =
	     dp1_tlp_mRespF$D_OUT[71:62] != 10'd1 ||
	     dp1_tlp_mRespF$D_OUT[42:35] == 8'h01 ;
  assign ab__h12351 = dp0_bram_serverAdapterA_writeWithResp$wget ;
  assign ab__h13750 = dp0_bram_serverAdapterB_writeWithResp$wget ;
  assign ab__h15280 = dp0_bram_serverAdapterA_1_writeWithResp$wget ;
  assign ab__h16677 = dp0_bram_serverAdapterB_1_writeWithResp$wget ;
  assign ab__h18207 = dp0_bram_serverAdapterA_2_writeWithResp$wget ;
  assign ab__h19604 = dp0_bram_serverAdapterB_2_writeWithResp$wget ;
  assign ab__h21134 = dp0_bram_serverAdapterA_3_writeWithResp$wget ;
  assign ab__h22531 = dp0_bram_serverAdapterB_3_writeWithResp$wget ;
  assign ab__h89722 = dp1_bram_serverAdapterA_writeWithResp$wget ;
  assign ab__h91121 = dp1_bram_serverAdapterB_writeWithResp$wget ;
  assign ab__h92651 = dp1_bram_serverAdapterA_1_writeWithResp$wget ;
  assign ab__h94048 = dp1_bram_serverAdapterB_1_writeWithResp$wget ;
  assign ab__h95578 = dp1_bram_serverAdapterA_2_writeWithResp$wget ;
  assign ab__h96975 = dp1_bram_serverAdapterB_2_writeWithResp$wget ;
  assign ab__h98505 = dp1_bram_serverAdapterA_3_writeWithResp$wget ;
  assign ab__h99902 = dp1_bram_serverAdapterB_3_writeWithResp$wget ;
  assign byteCount__h138931 = x__h139042 - y__h139043 ;
  assign byteCount__h61661 = x__h61772 - y__h61773 ;
  assign dp0_bml_crdBuf_value_952_EQ_dp0_bml_crdBuf_mod_ETC___d5074 =
	     dp0_bml_crdBuf_value == dp0_bml_crdBuf_modulus ;
  assign dp0_bml_fabBuf_value_937_EQ_dp0_bml_fabBuf_mod_ETC___d5075 =
	     dp0_bml_fabBuf_value == dp0_bml_fabBuf_modulus ;
  assign dp0_bml_fabFlowAddr_009_PLUS_dp0_bml_fabFlowSi_ETC___d4939 =
	     dp0_bml_fabFlowAddr + dp0_bml_fabFlowSize ;
  assign dp0_bml_lclBufDone_994_AND_IF_dp0_bml_dpContro_ETC___d4407 =
	     dp0_bml_lclBufDone &&
	     CASE_dp0_dpControl_BITS_1_TO_0_NOT_dp0_bml_fab_ETC__q29 ;
  assign dp0_bml_lclBuf_value_907_EQ_dp0_bml_lclBuf_mod_ETC___d5090 =
	     dp0_bml_lclBuf_value == dp0_bml_lclBuf_modulus ;
  assign dp0_bml_remBuf_value_922_EQ_dp0_bml_remBuf_mod_ETC___d5091 =
  ...
  assign dp0_bram_serverAdapterA_1_cnt_50_PLUS_IF_dp0_b_ETC___d356 =
		...
		3'd7 :
		3'd0) ;
  assign dp0_bram_serverAdapterA_1_cnt_50_SLT_3___d4944 =
  ...
  assign dp0_bram_serverAdapterA_2_cnt_68_PLUS_IF_dp0_b_ETC___d474 =
		...
		3'd7 :
		3'd0) ;
  assign dp0_bram_serverAdapterA_2_cnt_68_SLT_3___d4945 =
  ...
  assign dp0_bram_serverAdapterA_3_cnt_86_PLUS_IF_dp0_b_ETC___d592 =
		...
		3'd7 :
		3'd0) ;
  assign dp0_bram_serverAdapterA_3_cnt_86_SLT_3___d4946 =
  ...
  assign dp0_bram_serverAdapterA_cnt_32_SLT_3___d4943 =
  ...
  assign dp0_tlp_dmaPullRemainDWLen_017_ULE_dp0_tlp_dma_ETC___d4941 =
	     dp0_tlp_dmaPullRemainDWLen <= dp0_tlp_dmaPullRemainDWSub ;
  assign dp0_tlp_dmaPullRemainDWSub_031_ULE_4___d4942 =
	     dp0_tlp_dmaPullRemainDWSub <= 10'd4 ;
  ...
  assign dp0_tlp_mReqF_RDY_deq__157_AND_IF_dp0_tlp_mReq_ETC___d1173 =
	     dp0_tlp_mReqF$EMPTY_N &&
	     CASE_dp0_tlp_mReqFD_OUT_BITS_51_TO_50_NOT_dp0_ETC__q25 ;
  assign dp0_tlp_outDwRemain_142_ULE_4___d4603 =
	     dp0_tlp_outDwRemain <= 10'd4 ;
  ...
  assign dp0_tlp_writeRemainDWLen_194_ULE_1___d4332 =
	     dp0_tlp_writeRemainDWLen <= 10'd1 ;
  assign dp0_tlp_writeRemainDWLen_194_ULE_2___d4352 =
	     dp0_tlp_writeRemainDWLen <= 10'd2 ;
  assign dp0_tlp_writeRemainDWLen_194_ULE_3___d4333 =
  ...
  assign dp0_wmi_dpControl_whas__701_AND_dp0_bram_serve_ETC___d1747 =
	     ...
	     (dp0_bram_serverAdapterB_1_outDataCore$EMPTY_N ||
	      dp0_bram_serverAdapterB_1_outData_enqData$whas) &&
	     dp0_bram_serverAdapterB_1_outData_outData_whas_ETC___d1743 ;
  assign dp1_bml_crdBuf_value_983_EQ_dp1_bml_crdBuf_mod_ETC___d5141 =
	     dp1_bml_crdBuf_value == dp1_bml_crdBuf_modulus ;
  assign dp1_bml_fabBuf_value_968_EQ_dp1_bml_fabBuf_mod_ETC___d5142 =
	     dp1_bml_fabBuf_value == dp1_bml_fabBuf_modulus ;
  assign dp1_bml_fabFlowAddr_040_PLUS_dp1_bml_fabFlowSi_ETC___d4940 =
	     dp1_bml_fabFlowAddr + dp1_bml_fabFlowSize ;
  assign dp1_bml_lclBufDone_025_AND_IF_dp1_bml_dpContro_ETC___d4427 =
	     dp1_bml_lclBufDone &&
	     CASE_dp1_dpControl_BITS_1_TO_0_NOT_dp1_bml_fab_ETC__q30 ;
  assign dp1_bml_lclBuf_value_938_EQ_dp1_bml_lclBuf_mod_ETC___d5157 =
	     dp1_bml_lclBuf_value == dp1_bml_lclBuf_modulus ;
  assign dp1_bml_remBuf_value_953_EQ_dp1_bml_remBuf_mod_ETC___d5158 =
  ...
  assign dp1_bram_serverAdapterA_1_cnt_386_PLUS_IF_dp1__ETC___d2392 =
		...
		3'd7 :
		3'd0) ;
  assign dp1_bram_serverAdapterA_1_cnt_386_SLT_3___d4948 =
  ...
  assign dp1_bram_serverAdapterA_2_cnt_504_PLUS_IF_dp1__ETC___d2510 =
		...
		3'd7 :
		3'd0) ;
  assign dp1_bram_serverAdapterA_2_cnt_504_SLT_3___d4949 =
  ...
  assign dp1_bram_serverAdapterA_3_cnt_622_PLUS_IF_dp1__ETC___d2628 =
		...
		3'd7 :
		3'd0) ;
  assign dp1_bram_serverAdapterA_3_cnt_622_SLT_3___d4950 =
  ...
  assign dp1_bram_serverAdapterA_cnt_268_SLT_3___d4947 =
  ...
  assign dp1_tlp_mReqF_RDY_deq__188_AND_IF_dp1_tlp_mReq_ETC___d3204 =
	     dp1_tlp_mReqF$EMPTY_N &&
	     CASE_dp1_tlp_mReqFD_OUT_BITS_51_TO_50_NOT_dp1_ETC__q27 ;
  assign dp1_tlp_mRespF_first__905_BITS_71_TO_62_995_ULE_1___d4334 =
	     dp1_tlp_mRespF$D_OUT[71:62] <= 10'd1 ;
  assign dp1_tlp_outDwRemain_021_ULE_4___d4608 =
	     dp1_tlp_outDwRemain <= 10'd4 ;
  ...
  assign dp1_tlp_writeRemainDWLen_225_ULE_1___d4335 =
	     dp1_tlp_writeRemainDWLen <= 10'd1 ;
  assign dp1_tlp_writeRemainDWLen_225_ULE_2___d4350 =
	     dp1_tlp_writeRemainDWLen <= 10'd2 ;
  assign dp1_tlp_writeRemainDWLen_225_ULE_3___d4382 =
  ...
  assign dp1_wmi_dpControl_whas__732_AND_dp1_bram_serve_ETC___d3778 =
	     ...
	     (dp1_bram_serverAdapterB_1_outDataCore$EMPTY_N ||
	      dp1_bram_serverAdapterB_1_outData_enqData$whas) &&
	     dp1_bram_serverAdapterB_1_outData_outData_whas_ETC___d3774 ;
  assign idx__h129752 = 2'd0 - dp1_tlp_writeDWAddr[1:0] ;
  assign idx__h131975 = 2'd1 - dp1_tlp_writeDWAddr[1:0] ;
  assign idx__h133271 = 2'd2 - dp1_tlp_writeDWAddr[1:0] ;
  assign idx__h134567 = 2'd3 - dp1_tlp_writeDWAddr[1:0] ;
  assign idx__h136815 = 2'd0 - dp1_tlp_readNxtDWAddr[1:0] ;
  assign idx__h137283 = 2'd1 - dp1_tlp_readNxtDWAddr[1:0] ;
  assign idx__h137656 = 2'd2 - dp1_tlp_readNxtDWAddr[1:0] ;
  assign idx__h138029 = 2'd3 - dp1_tlp_readNxtDWAddr[1:0] ;
  assign idx__h52482 = 2'd0 - dp0_tlp_writeDWAddr[1:0] ;
  assign idx__h54705 = 2'd1 - dp0_tlp_writeDWAddr[1:0] ;
  assign idx__h56001 = 2'd2 - dp0_tlp_writeDWAddr[1:0] ;
  assign idx__h57297 = 2'd3 - dp0_tlp_writeDWAddr[1:0] ;
  assign idx__h59545 = 2'd0 - dp0_tlp_readNxtDWAddr[1:0] ;
  assign idx__h60013 = 2'd1 - dp0_tlp_readNxtDWAddr[1:0] ;
  assign idx__h60386 = 2'd2 - dp0_tlp_readNxtDWAddr[1:0] ;
  assign idx__h60759 = 2'd3 - dp0_tlp_readNxtDWAddr[1:0] ;
  assign lastBE__h113532 =
	     dp1_tlp_mRespF_first__905_BITS_71_TO_62_995_ULE_1___d4334 ?
	       4'd0 :
	       4'd15 ;
  assign lastBE__h46995 =
	     (thisRequestLength__h46693[11:2] == 10'd1) ? 4'd0 : 4'd15 ;
  assign lowAddr__h138930 =
	     { dp1_tlp_readReq$D_OUT[33:29], lowAddr10__h138929 } ;
  assign lowAddr__h61660 =
	     { dp0_tlp_readReq$D_OUT[33:29], lowAddr10__h61659 } ;
  assign mesgMeta_opcode__h155132 = MUX_dp1_bram_memory_1$b_put_3__VAL_4 ;
  assign mesgMeta_opcode__h77862 = MUX_dp0_bram_memory_1$b_put_3__VAL_4 ;
  assign nowLS__h109890 =
	     { dp1_tlp_mRespF$D_OUT[39:32],
	       dp1_tlp_mRespF$D_OUT[47:40],
	       dp1_tlp_mRespF$D_OUT[55:48],
	       dp1_tlp_mRespF$D_OUT[63:56] } ;
  assign nowLS__h43481 =
	     { dp0_tlp_inF$D_OUT[39:32],
	       dp0_tlp_inF$D_OUT[47:40],
	       dp0_tlp_inF$D_OUT[55:48],
	       dp0_tlp_inF$D_OUT[63:56] } ;
  assign nowMS__h109889 =
	     { dp1_tlp_mRespF$D_OUT[71:64],
	       dp1_tlp_mRespF$D_OUT[79:72],
	       dp1_tlp_mRespF$D_OUT[87:80],
	       dp1_tlp_mRespF$D_OUT[95:88] } ;
  assign nowMS__h43480 =
	     { dp0_tlp_inF$D_OUT[71:64],
	       dp0_tlp_inF$D_OUT[79:72],
	       dp0_tlp_inF$D_OUT[87:80],
	       dp0_tlp_inF$D_OUT[95:88] } ;
  assign opcode__h109888 =
	     { dp1_tlp_mRespF$D_OUT[103:96],
	       dp1_tlp_mRespF$D_OUT[111:104],
	       dp1_tlp_mRespF$D_OUT[119:112],
	       dp1_tlp_mRespF$D_OUT[127:120] } ;
  assign opcode__h43479 =
  ...
  assign rdat__h163729 = { 16'd0, dp1_bml_lclNumBufs } ;
  assign rdat__h163737 = { 16'd0, dp1_bml_fabNumBufs } ;
  assign rdat__h163745 = { 16'd0, dp1_bml_mesgBase } ;
  assign rdat__h163753 = { 16'd0, dp1_bml_metaBase } ;
  assign rdat__h163761 = { 16'd0, dp1_bml_mesgSize } ;
  assign rdat__h163769 = { 16'd0, dp1_bml_metaSize } ;
  assign rdat__h163777 = { 16'd0, dp1_bml_lclBufsCF } ;
  assign rdat__h163798 = { dp1_bml_lclBufsAR, dp1_bml_fabBufsAvail } ;
  assign rdat__h163803 = { dp1_bml_remBuf_value, dp1_bml_lclBuf_value } ;
  assign rdat__h163814 = { dp1_bml_lclStarts, dp1_bml_lclDones } ;
  assign rdat__h163819 = { dp1_bml_remStarts, dp1_bml_remDones } ;
  assign rdat__h163880 = { 28'd0, dp1_dpControl } ;
  assign rdat__h86462 = { 16'd0, dp0_bml_lclNumBufs } ;
  assign rdat__h86470 = { 16'd0, dp0_bml_fabNumBufs } ;
  assign rdat__h86478 = { 16'd0, dp0_bml_mesgBase } ;
  assign rdat__h86486 = { 16'd0, dp0_bml_metaBase } ;
  assign rdat__h86494 = { 16'd0, dp0_bml_mesgSize } ;
  assign rdat__h86502 = { 16'd0, dp0_bml_metaSize } ;
  assign rdat__h86510 = { 16'd0, dp0_bml_lclBufsCF } ;
  assign rdat__h86531 = { dp0_bml_lclBufsAR, dp0_bml_fabBufsAvail } ;
  assign rdat__h86536 = { dp0_bml_remBuf_value, dp0_bml_lclBuf_value } ;
  assign rdat__h86547 = { dp0_bml_lclStarts, dp0_bml_lclDones } ;
  assign rdat__h86552 = { dp0_bml_remStarts, dp0_bml_remDones } ;
  assign rdat__h86613 = { 28'd0, dp0_dpControl } ;
  assign rdata__h144299 =
	     dp1_tlp_readNxtDWAddr[1] ?
	       IF_dp1_tlp_readNxtDWAddr_407_BIT_0_584_THEN_dp_ETC___d3589 :
	       IF_dp1_tlp_readNxtDWAddr_407_BIT_0_584_THEN_dp_ETC___d3594 ;
  assign rdata__h67029 =
	     dp0_tlp_readNxtDWAddr[1] ?
	       IF_dp0_tlp_readNxtDWAddr_376_BIT_0_553_THEN_dp_ETC___d1558 :
	       IF_dp0_tlp_readNxtDWAddr_376_BIT_0_553_THEN_dp_ETC___d1563 ;
  assign rreq_tag__h113333 =
	     (y__h113144 == dp1_tlp_mesgLengthRemainPush) ? 8'h01 : 8'h0 ;
  assign rresp_data__h138973 =
	     { IF_dp1_tlp_readReq_first__455_BITS_30_TO_29_45_ETC___d4506[7:0],
	       IF_dp1_tlp_readReq_first__455_BITS_30_TO_29_45_ETC___d4506[15:8],
	       IF_dp1_tlp_readReq_first__455_BITS_30_TO_29_45_ETC___d4506[23:16],
	       IF_dp1_tlp_readReq_first__455_BITS_30_TO_29_45_ETC___d4506[31:24] } ;
  assign rresp_data__h61703 =
	     { IF_dp0_tlp_readReq_first__424_BITS_30_TO_29_42_ETC___d4501[7:0],
	       IF_dp0_tlp_readReq_first__424_BITS_30_TO_29_42_ETC___d4501[15:8],
	       IF_dp0_tlp_readReq_first__424_BITS_30_TO_29_42_ETC___d4501[23:16],
	       IF_dp0_tlp_readReq_first__424_BITS_30_TO_29_42_ETC___d4501[31:24] } ;
  assign spanToNextPage__h113103 =
	     13'd4096 - { 1'd0, dp1_tlp_srcMesgAccu[11:0] } ;
  assign spanToNextPage__h46692 =
	     13'd4096 - { 1'd0, dp0_tlp_fabMesgAccu[11:0] } ;
  assign tag__h46968 = { 3'd0, dp0_tlp_dmaTag } ;
  assign tagm__h47094 = { 3'd0, dp0_tlp_dmaReqTag } ;
  assign thisRequestLength__h113104 =
	     (x__h113157[12:0] <= spanToNextPage__h113103) ?
	       x__h113157[12:0] :
	       spanToNextPage__h113103 ;
  assign thisRequestLength__h46693 =
	     (x__h46726[12:0] <= spanToNextPage__h46692) ?
	       x__h46726[12:0] :
	       spanToNextPage__h46692 ;
  ...
  assign w_data__h115549 =
	     { dp1_tlp_fabMeta[71:64],
	       ...
	       32'b0 } ;
  assign w_data__h125557 =
	     { 32'd1073745921,
	       pciDevice[15:3],
	       19'd65551,
	       dp1_tlp_fabFlowAddr,
	       32'd16777216 } ;
  assign w_data__h41199 =
	     { 32'd4100,
	       pciDevice[15:3],
	       3'd0,
	       tag__h46968,
	       ...
	       34'd0 } ;
  assign w_data__h46974 =
	     { 22'd4,
	       thisRequestLength__h46693[11:2],
	       pciDevice[15:3],
	       3'd0,
	       tag__h46968,
	       lastBE__h46995,
	       ...
	       34'd0 } ;
  assign w_data__h48288 =
	     { 32'd1073745921,
	       pciDevice[15:3],
	       19'd15,
	       dp0_tlp_fabFlowAddr,
	       32'd16777216 } ;
  assign x3__h155092 = MUX_dp1_bram_memory$b_put_3__VAL_4 ;
  assign x3__h77822 = MUX_dp0_bram_memory$b_put_3__VAL_4 ;
  assign x__h109951 = { 15'd0, dp1_tlp_mesgLengthRemainPush } ;
  assign x__h113157 =
	     (dp1_tlp_mesgLengthRemainPush <= y__h113159) ?
	       dp1_tlp_mesgLengthRemainPush :
	       y__h113159 ;
  assign x__h113659 = { dp1_tlp_mRespF$D_OUT[69:62], 2'd0 } ;
  assign x__h139042 = x__h139044 - y__h139045 ;
  assign x__h139044 = { dp1_tlp_readReq$D_OUT[28:19], 2'b0 } ;
  assign x__h160873 =
	     (dp1_dpControl[1:0] == 2'd1) ? dp1_bml_fabNumBufs : 16'd0 ;
  assign x__h161997 = dp1_bml_lclBufsAR + 16'd1 ;
  assign x__h162002 = dp1_bml_lclBufsAR - 16'd1 ;
  assign x__h162074 = dp1_bml_lclBufsCF + 16'd1 ;
  assign x__h162079 = dp1_bml_lclBufsCF - 16'd1 ;
  assign x__h162116 = dp1_bml_fabBufsAvail + 16'd1 ;
  assign x__h162121 = dp1_bml_fabBufsAvail - 16'd1 ;
  assign x__h162154 = dp1_bml_lclCredit + 16'd1 ;
  assign x__h162159 = dp1_bml_lclCredit - 16'd1 ;
  assign x__h43511 = { 15'd0, dp0_tlp_mesgLengthRemainPull } ;
  assign x__h46726 =
	     (dp0_tlp_mesgLengthRemainPull <= y__h46728) ?
	       dp0_tlp_mesgLengthRemainPull :
	       y__h46728 ;
  assign x__h47303 = { dp0_tlp_inF$D_OUT[103:96], 2'd0 } ;
  assign x__h47981 = { dp0_tlp_dmaPullRemainDWSub[7:0], 2'd0 } ;
  assign x__h61772 = x__h61774 - y__h61775 ;
  assign x__h61774 = { dp0_tlp_readReq$D_OUT[28:19], 2'b0 } ;
  assign x__h83606 =
	     (dp0_dpControl[1:0] == 2'd1) ? dp0_bml_fabNumBufs : 16'd0 ;
  assign x__h84730 = dp0_bml_lclBufsAR + 16'd1 ;
  assign x__h84735 = dp0_bml_lclBufsAR - 16'd1 ;
  assign x__h84807 = dp0_bml_lclBufsCF + 16'd1 ;
  assign x__h84812 = dp0_bml_lclBufsCF - 16'd1 ;
  assign x__h84849 = dp0_bml_fabBufsAvail + 16'd1 ;
  assign x__h84854 = dp0_bml_fabBufsAvail - 16'd1 ;
  assign x__h84887 = dp0_bml_lclCredit + 16'd1 ;
  assign x__h84892 = dp0_bml_lclCredit - 16'd1 ;
  assign y__h113144 = { 4'd0, thisRequestLength__h113104 } ;
  assign y__h113159 = { 4'd0, dp1_tlp_maxPayloadSize } ;
  assign y__h113238 = { 19'd0, thisRequestLength__h113104 } ;
  assign y__h113286 = { 3'd0, thisRequestLength__h113104 } ;
  assign y__h113656 = { 22'd0, x__h113659 } ;
  assign y__h139043 =
	     (dp1_tlp_readReq$D_OUT[28:19] == 10'd1) ?
	       12'd0 :
	       { 10'd0, x__h139074 } ;
  assign y__h139045 = { 10'd0, x__h139051 } ;
  assign y__h46718 = { 4'd0, thisRequestLength__h46693 } ;
  assign y__h46728 = { 4'd0, dp0_tlp_maxReadReqSize } ;
  assign y__h46789 = { 19'd0, thisRequestLength__h46693 } ;
  assign y__h47300 = { 6'd0, x__h47303 } ;
  assign y__h47978 =
	     dp0_tlp_dmaPullRemainDWSub_031_ULE_4___d4942 ?
	       { 7'd0, x__h47981 } :
	       17'd16 ;
  assign y__h61773 =
	     (dp0_tlp_readReq$D_OUT[28:19] == 10'd1) ?
	       12'd0 :
	       { 10'd0, x__h61804 } ;
  assign y__h61775 = { 10'd0, x__h61781 } ;
  assign y_avValue__h156688 = dp1_bram_serverAdapterB_outData_outData$wget ;
  assign y_avValue__h156708 = dp1_bram_serverAdapterB_1_outData_outData$wget ;
  assign y_avValue__h156728 = dp1_bram_serverAdapterB_2_outData_outData$wget ;
  assign y_avValue__h156748 = dp1_bram_serverAdapterB_3_outData_outData$wget ;
  assign y_avValue__h79418 = dp0_bram_serverAdapterB_outData_outData$wget ;
  assign y_avValue__h79438 = dp0_bram_serverAdapterB_1_outData_outData$wget ;
  assign y_avValue__h79458 = dp0_bram_serverAdapterB_2_outData_outData$wget ;
  assign y_avValue__h79478 = dp0_bram_serverAdapterB_3_outData_outData$wget ;
  always@(dp0_tlp_readReq$D_OUT)
  begin
    case (dp0_tlp_readReq$D_OUT[18:15])
      4'b1100: x__h61781 = 2'b10;
      4'b1110: x__h61781 = 2'b01;
      4'b1111: x__h61781 = 2'b0;
      default: x__h61781 = 2'b11;
    endcase
  end
  always@(dp0_tlp_readReq$D_OUT)
  begin
    case (dp0_tlp_readReq$D_OUT[14:11])
      4'b1100: x__h61804 = 2'b10;
      4'b1110: x__h61804 = 2'b01;
      4'b1111: x__h61804 = 2'b0;
      default: x__h61804 = 2'b11;
    endcase
  end
  always@(dp1_tlp_readReq$D_OUT)
  begin
    case (dp1_tlp_readReq$D_OUT[18:15])
      4'b1100: x__h139051 = 2'b10;
      4'b1110: x__h139051 = 2'b01;
      4'b1111: x__h139051 = 2'b0;
      default: x__h139051 = 2'b11;
    endcase
  end
  always@(dp1_tlp_readReq$D_OUT)
  begin
    case (dp1_tlp_readReq$D_OUT[14:11])
      4'b1100: x__h139074 = 2'b10;
      4'b1110: x__h139074 = 2'b01;
      4'b1111: x__h139074 = 2'b0;
      default: x__h139074 = 2'b11;
    endcase
  end
  always@(dp1_wmi_p4B or
	  y_avValue__h156748 or
	  y_avValue__h156688 or y_avValue__h156708 or y_avValue__h156728)
  begin
    case (dp1_wmi_p4B)
      2'd0: rdata__h156852 = y_avValue__h156688;
      2'd1: rdata__h156852 = y_avValue__h156708;
      2'd2: rdata__h156852 = y_avValue__h156728;
      2'd3: rdata__h156852 = y_avValue__h156748;
    endcase
  end
  always@(dp0_wmi_p4B or
	  y_avValue__h79478 or
	  y_avValue__h79418 or y_avValue__h79438 or y_avValue__h79458)
  begin
    case (dp0_wmi_p4B)
      2'd0: rdata__h79582 = y_avValue__h79418;
      2'd1: rdata__h79582 = y_avValue__h79438;
      2'd2: rdata__h79582 = y_avValue__h79458;
      2'd3: rdata__h79582 = y_avValue__h79478;
    endcase
  end
  always@(dp0_tlp_readReq$D_OUT)
  begin
    case (dp0_tlp_readReq$D_OUT[18:15])
      4'b1000: lowAddr10__h61659 = 2'b11;
      4'b1100: lowAddr10__h61659 = 2'b10;
      4'b1110: lowAddr10__h61659 = 2'b01;
      default: lowAddr10__h61659 = 2'b0;
    endcase
  end
  always@(dp0_wci_reqF$D_OUT or
	  ...
	  dp0_bml_fabFlowBase or dp0_bml_fabFlowSize or rdat__h86613)
  begin
    case (dp0_wci_reqF$D_OUT[39:32])
      8'h0: _theResult____h86383 = rdat__h86462;
      8'h04: _theResult____h86383 = rdat__h86470;
      8'h08: _theResult____h86383 = rdat__h86478;
      8'h0C: _theResult____h86383 = rdat__h86486;
      8'h10: _theResult____h86383 = rdat__h86494;
      8'h14: _theResult____h86383 = rdat__h86502;
      8'h20: _theResult____h86383 = rdat__h86510;
      8'h24: _theResult____h86383 = 32'hF00DFACE;
      8'h28: _theResult____h86383 = rdat__h86531;
      8'h2C: _theResult____h86383 = rdat__h86536;
      8'h30: _theResult____h86383 = rdat__h86547;
      8'h34: _theResult____h86383 = rdat__h86552;
      8'h48: _theResult____h86383 = 32'hDADEBABE;
      8'h4C: _theResult____h86383 = 32'h00008000;
      8'h50: _theResult____h86383 = dp0_bml_fabMesgBase;
      8'h54: _theResult____h86383 = dp0_bml_fabMetaBase;
      8'h58: _theResult____h86383 = dp0_bml_fabMesgSize;
      8'h5C: _theResult____h86383 = dp0_bml_fabMetaSize;
      8'h60: _theResult____h86383 = dp0_bml_fabFlowBase;
      8'h64: _theResult____h86383 = dp0_bml_fabFlowSize;
      8'h68: _theResult____h86383 = rdat__h86613;
      default: _theResult____h86383 = 32'd0;
    endcase
  end
  always@(dp1_tlp_readReq$D_OUT)
  begin
    case (dp1_tlp_readReq$D_OUT[18:15])
      4'b1000: lowAddr10__h138929 = 2'b11;
      4'b1100: lowAddr10__h138929 = 2'b10;
      4'b1110: lowAddr10__h138929 = 2'b01;
      default: lowAddr10__h138929 = 2'b0;
    endcase
  end
  always@(dp1_wci_reqF$D_OUT or
	  ...
	  dp1_bml_fabFlowBase or dp1_bml_fabFlowSize or rdat__h163880)
  begin
    case (dp1_wci_reqF$D_OUT[39:32])
      8'h0: _theResult____h163650 = rdat__h163729;
      8'h04: _theResult____h163650 = rdat__h163737;
      8'h08: _theResult____h163650 = rdat__h163745;
      8'h0C: _theResult____h163650 = rdat__h163753;
      8'h10: _theResult____h163650 = rdat__h163761;
      8'h14: _theResult____h163650 = rdat__h163769;
      8'h20: _theResult____h163650 = rdat__h163777;
      8'h24: _theResult____h163650 = 32'hF00DFACE;
      8'h28: _theResult____h163650 = rdat__h163798;
      8'h2C: _theResult____h163650 = rdat__h163803;
      8'h30: _theResult____h163650 = rdat__h163814;
      8'h34: _theResult____h163650 = rdat__h163819;
      8'h48: _theResult____h163650 = 32'hDADEBABE;
      8'h4C: _theResult____h163650 = 32'h00008000;
      8'h50: _theResult____h163650 = dp1_bml_fabMesgBase;
      8'h54: _theResult____h163650 = dp1_bml_fabMetaBase;
      8'h58: _theResult____h163650 = dp1_bml_fabMesgSize;
      8'h5C: _theResult____h163650 = dp1_bml_fabMetaSize;
      8'h60: _theResult____h163650 = dp1_bml_fabFlowBase;
      8'h64: _theResult____h163650 = dp1_bml_fabFlowSize;
      8'h68: _theResult____h163650 = rdat__h163880;
      default: _theResult____h163650 = 32'd0;
    endcase
  end
  ...
  always@(idx__h52482 or
	  dp0_tlp_writeRemainDWLen_194_ULE_3___d4333 or
	  dp0_tlp_writeRemainDWLen or
	  dp0_tlp_writeRemainDWLen_194_ULE_1___d4332 or
	  dp0_tlp_writeRemainDWLen_194_ULE_2___d4352)
  begin
    case (idx__h52482)
      2'd0:
  ...
  always@(idx__h129752 or
	  dp1_tlp_writeRemainDWLen_225_ULE_3___d4382 or
	  dp1_tlp_writeRemainDWLen or
	  dp1_tlp_writeRemainDWLen_225_ULE_1___d4335 or
	  dp1_tlp_writeRemainDWLen_225_ULE_2___d4350)
  begin
    case (idx__h129752)
      2'd0:
  ...
  always@(dp0_tlp_mReqF$D_OUT or
	  dp0_bram_serverAdapterA_3_cnt_86_SLT_3___d4946 or
	  dp0_bram_serverAdapterA_cnt_32_SLT_3___d4943 or
	  dp0_bram_serverAdapterA_1_cnt_50_SLT_3___d4944 or
	  dp0_bram_serverAdapterA_2_cnt_68_SLT_3___d4945)
  begin
  ...
  always@(dp1_tlp_mReqF$D_OUT or
	  dp1_bram_serverAdapterA_3_cnt_622_SLT_3___d4950 or
	  dp1_bram_serverAdapterA_cnt_268_SLT_3___d4947 or
	  dp1_bram_serverAdapterA_1_cnt_386_SLT_3___d4948 or
	  dp1_bram_serverAdapterA_2_cnt_504_SLT_3___d4949)
  begin
  ...
  always@(idx__h52482 or dp0_tlp_mReqF$D_OUT)
  begin
    case (idx__h52482)
      2'd0:
	  IF_0_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d4497 =
  ...
  always@(idx__h57297 or dp0_tlp_mReqF$D_OUT)
  begin
    case (idx__h57297)
      2'd0:
	  IF_3_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d4500 =
  ...
  always@(idx__h54705 or dp0_tlp_mReqF$D_OUT)
  begin
    case (idx__h54705)
      2'd0:
	  IF_1_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d4498 =
  ...
  always@(idx__h56001 or dp0_tlp_mReqF$D_OUT)
  begin
    case (idx__h56001)
      2'd0:
	  IF_2_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d4499 =
  ...
  always@(idx__h129752 or dp1_tlp_mReqF$D_OUT)
  begin
    case (idx__h129752)
      2'd0:
	  IF_0_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d4502 =
  ...
  always@(idx__h131975 or dp1_tlp_mReqF$D_OUT)
  begin
    case (idx__h131975)
      2'd0:
	  IF_1_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d4503 =
  ...
  always@(idx__h134567 or dp1_tlp_mReqF$D_OUT)
  begin
    case (idx__h134567)
      2'd0:
	  IF_3_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d4505 =
  ...
  always@(idx__h133271 or dp1_tlp_mReqF$D_OUT)
  begin
    case (idx__h133271)
      2'd0:
	  IF_2_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d4504 =
  ...
  begin
    ...
    if (cp$RST_N_wci_Vm_13)
      if (WILL_FIRE_RL_dp0_tlp_dmaXmtDoorbell)
	$display("[%0d]: %m: dmaXmtDoorbell FC/FPactFlow-Step1/1", v__h40929);
    if (cp$RST_N_wci_Vm_13)
      if (pciw_p125rst$OUT_RST_N)
    ...
    if (cp$RST_N_wci_Vm_13)
      if (pciw_p125rst$OUT_RST_N)
	if (WILL_FIRE_RL_dp0_tlp_dmaTailEventSender)
	  $display("[%0d]: %m: dmaTailEventSender - generic", v__h49156);
    if (cp$RST_N_wci_Vm_13)
      if (pciw_p125rst$OUT_RST_N)
    ...
    if (cp$RST_N_wci_Vm_13)
      if (WILL_FIRE_RL_dp0_tlp_dmaPullTailEvent)
	$display("[%0d]: %m: dmaPullTailEvent FPactMesg-Step5/5", v__h48201);
    if (cp$RST_N_wci_Vm_13)
    ...
    if (cp$RST_N_wci_Vm_13)
      if (WILL_FIRE_RL_dp0_wci_cfwr && dp0_wci_reqF$D_OUT[39:32] == 8'h18)
	$display("[%0d] %m: fabDoneAvail Event", v__h85863);
    if (cp$RST_N_wci_Vm_13)
    ...
    if (cp$RST_N_wci_Vm_14)
      if (pciw_p125rst$OUT_RST_N)
	if (WILL_FIRE_RL_dp1_tlp_dmaXmtMetaHead)
	  $display("[%0d]: %m: dmaXmtMetaHead FPactMesg-Step5/7", v__h115381);
    if (cp$RST_N_wci_Vm_14)
    ...
    if (cp$RST_N_wci_Vm_14)
      if (WILL_FIRE_RL_dp1_tlp_dmaXmtMetaBody)
	$display("[%0d]: %m: dmaXmtMetaBody FPactMesg-Step6/7", v__h118115);
    if (cp$RST_N_wci_Vm_14)
    ...
    if (cp$RST_N_wci_Vm_14)
      if (WILL_FIRE_RL_dp1_tlp_dmaXmtTailEvent)
	$display("[%0d]: %m: dmaXmtTailEvent FPactMesg-Step7/7", v__h118300);
    if (cp$RST_N_wci_Vm_14)
      if (pciw_p125rst$OUT_RST_N)
    ...
    if (cp$RST_N_wci_Vm_14)
      if (pciw_p125rst$OUT_RST_N)
	if (WILL_FIRE_RL_dp1_tlp_dmaTailEventSender)
	  $display("[%0d]: %m: dmaTailEventSender - generic", v__h126425);
    if (cp$RST_N_wci_Vm_14)
    ...
    if (cp$RST_N_wci_Vm_14)
      if (WILL_FIRE_RL_dp1_wci_cfwr && dp1_wci_reqF$D_OUT[39:32] == 8'h18)
	$display("[%0d] %m: fabDoneAvail Event", v__h163130);
    if (cp$RST_N_wci_Vm_14)
