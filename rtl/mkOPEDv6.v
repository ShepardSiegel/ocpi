...
//
// On Thu Dec 30 09:53:12 EST 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkOPEDv6(pci0_clkp,
  ...
  reg [63 : 0] v__h103555,
	       ...
	       v__h86215,
	       v__h86369;
  reg [31 : 0] IF_0_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d4528,
	       IF_0_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d4533,
	       IF_1_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d4529,
	       IF_1_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d4534,
	       IF_2_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d4530,
	       IF_2_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d4535,
	       IF_3_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d4531,
	       IF_3_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d4536,
	       IF_dp0_tlp_readReq_first__424_BITS_30_TO_29_42_ETC___d4532,
	       IF_dp1_tlp_readReq_first__455_BITS_30_TO_29_45_ETC___d4537,
	       _theResult____h163585,
	       _theResult____h86353,
	       rdata__h156795,
	       rdata__h79560;
  reg [15 : 0] CASE_dp0_tlp_outDwRemain_BITS_1_TO_0_0xFFF0_0b_ETC__q23,
	       CASE_dp1_tlp_outDwRemain_BITS_1_TO_0_0xFFF0_0b_ETC__q24;
  reg [1 : 0] lowAddr10__h138872,
	      lowAddr10__h61637,
	      x__h138994,
	      x__h139017,
	      x__h61759,
  ...
  reg CASE_dp0_dpControl_BITS_1_TO_0_NOT_dp0_bml_fab_ETC__q17,
      ...
      IF_0_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d4434,
      IF_0_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d3238,
      IF_0_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d4454,
      IF_1_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d1217,
      IF_1_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d4435,
      IF_1_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d3248,
      IF_1_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d4455,
      IF_2_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d1227,
      IF_2_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d4463,
      IF_2_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d3258,
      IF_2_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d4464,
      IF_3_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d1237,
      IF_3_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d4436,
      IF_3_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d3268,
      IF_3_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d4456,
      IF_dp0_bml_dpControl_wget__970_BITS_1_TO_0_976_ETC___d2047,
      IF_dp0_tlp_readReq_first__424_BITS_30_TO_29_42_ETC___d1439,
      IF_dp0_wmi_addr_802_BITS_3_TO_2_803_EQ_0_804_T_ETC___d4418,
      ...
      IF_dp1_wmi_addr_833_BITS_3_TO_2_834_EQ_0_835_T_ETC___d4419,
  ...
  wire [127 : 0] IF_dp0_tlp_readNxtDWAddr_376_BIT_0_553_THEN_dp_ETC___d1558,
		 ...
		 w_data__h46952,
		 w_data__h48266;
  wire [31 : 0] dp0_bml_fabFlowAddr_009_PLUS_dp0_bml_fabFlowSi_ETC___d4349,
		dp1_bml_fabFlowAddr_040_PLUS_dp1_bml_fabFlowSi_ETC___d4351,
		mesgMeta_opcode__h155075,
		mesgMeta_opcode__h77840,
		nowLS__h109833,
		nowLS__h43459,
		nowMS__h109832,
		nowMS__h43458,
  ...
  wire [12 : 0] dp0_tlp_readNxtDWAddr_PLUS_1__q7,
		...
		dp1_tlp_readNxtDWAddr_PLUS_1__q10,
		dp1_tlp_readNxtDWAddr_PLUS_2__q11,
		dp1_tlp_readNxtDWAddr_PLUS_3__q9,
		dp1_tlp_writeDWAddr_PLUS_1__q13,
		dp1_tlp_writeDWAddr_PLUS_2__q14,
		dp1_tlp_writeDWAddr_PLUS_3__q12,
		spanToNextPage__h113046,
		spanToNextPage__h46670,
		thisRequestLength__h113047,
		thisRequestLength__h46671;
  wire [11 : 0] byteCount__h138874,
		byteCount__h61639,
		x__h138985,
		x__h138987,
		x__h61750,
		...
		y__h61751,
		y__h61753;
  wire [9 : 0] x__h113602, x__h47281, x__h47959;
  wire [7 : 0] rreq_tag__h113276, tag__h46946, tagm__h47072;
  wire [6 : 0] lowAddr__h138873, lowAddr__h61638;
  wire [3 : 0] lastBE__h113475, lastBE__h46973;
  ...
  wire IF_1_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d1240,
       ...
       _dfoo13,
       dp0_bml_crdBuf_value_952_EQ_dp0_bml_crdBuf_mod_ETC___d5105,
       dp0_bml_fabBuf_value_937_EQ_dp0_bml_fabBuf_mod_ETC___d5106,
       dp0_bml_lclBufDone_994_AND_IF_dp0_bml_dpContro_ETC___d4438,
       dp0_bml_lclBuf_value_907_EQ_dp0_bml_lclBuf_mod_ETC___d5121,
       dp0_bml_remBuf_value_922_EQ_dp0_bml_remBuf_mod_ETC___d5122,
       dp0_bram_serverAdapterA_1_cnt_50_SLT_3___d4972,
       dp0_bram_serverAdapterA_2_cnt_68_SLT_3___d4973,
       dp0_bram_serverAdapterA_2_outDataCore_notEmpty_ETC___d1518,
       dp0_bram_serverAdapterA_3_cnt_86_SLT_3___d4974,
       dp0_bram_serverAdapterA_cnt_32_SLT_3___d4971,
       ...
       dp0_tlp_dmaPullRemainDWLen_017_ULE_dp0_tlp_dma_ETC___d4969,
       dp0_tlp_dmaPullRemainDWSub_031_ULE_4___d4970,
       ...
       dp0_tlp_outDwRemain_142_ULE_4___d4634,
       dp0_tlp_rdRespDwRemain_508_ULE_4___d1509,
       dp0_tlp_readRemainDWLen_364_ULE_4___d1365,
       dp0_tlp_writeRemainDWLen_194_ULE_1___d4365,
       dp0_tlp_writeRemainDWLen_194_ULE_2___d4384,
       dp0_tlp_writeRemainDWLen_194_ULE_3___d4366,
       dp0_wmi_dpControl_whas__701_AND_dp0_bram_serve_ETC___d1747,
       dp1_bml_crdBuf_value_983_EQ_dp1_bml_crdBuf_mod_ETC___d5172,
       dp1_bml_fabBuf_value_968_EQ_dp1_bml_fabBuf_mod_ETC___d5173,
       dp1_bml_lclBufDone_025_AND_IF_dp1_bml_dpContro_ETC___d4458,
       dp1_bml_lclBuf_value_938_EQ_dp1_bml_lclBuf_mod_ETC___d5188,
       dp1_bml_remBuf_value_953_EQ_dp1_bml_remBuf_mod_ETC___d5189,
       dp1_bram_serverAdapterA_1_cnt_386_SLT_3___d4976,
       dp1_bram_serverAdapterA_2_cnt_504_SLT_3___d4977,
       dp1_bram_serverAdapterA_2_outDataCore_notEmpty_ETC___d3549,
       dp1_bram_serverAdapterA_3_cnt_622_SLT_3___d4978,
       dp1_bram_serverAdapterA_cnt_268_SLT_3___d4975,
       ...
       dp1_tlp_mRespF_first__905_BITS_71_TO_62_995_ULE_1___d4367,
       dp1_tlp_outDwRemain_021_ULE_4___d4639,
       dp1_tlp_rdRespDwRemain_539_ULE_4___d3540,
       dp1_tlp_readRemainDWLen_395_ULE_4___d3396,
       dp1_tlp_writeRemainDWLen_225_ULE_1___d4368,
       dp1_tlp_writeRemainDWLen_225_ULE_2___d4383,
       dp1_tlp_writeRemainDWLen_225_ULE_3___d4413,
  ...
  assign MUX_dp0_bml_fabBufsAvail$write_1__VAL_1 =
	     (dp0_bml_fabAvail && !dp0_bml_remStart) ? x__h84827 : x__h84832 ;
  assign MUX_dp0_bml_fabBufsAvail$write_1__VAL_2 =
	     (dp0_dpControl[3:2] == 2'd1) ? x__h83584 : 16'd0 ;
  assign MUX_dp0_bml_fabFlowAddr$write_1__VAL_1 =
	     dp0_bml_fabBuf_value_937_EQ_dp0_bml_fabBuf_mod_ETC___d5106 ?
	       dp0_bml_fabFlowBase :
	       dp0_bml_fabFlowAddr_009_PLUS_dp0_bml_fabFlowSi_ETC___d4349 ;
  ...
  assign MUX_dp0_bram_memory$a_put_3__VAL_3 =
	     { IF_0_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d4528[7:0],
	       IF_0_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d4528[15:8],
	       IF_0_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d4528[23:16],
	       IF_0_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d4528[31:24] } ;
  ...
  assign MUX_dp0_bram_memory_1$a_put_3__VAL_3 =
	     { IF_1_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d4529[7:0],
	       IF_1_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d4529[15:8],
	       IF_1_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d4529[23:16],
	       IF_1_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d4529[31:24] } ;
  assign MUX_dp0_bram_memory_1$b_put_3__VAL_4 =
	     { 24'h800000, dp0_wmi_wmi_mFlagReg[31:24] } ;
  always@(idx__h55979 or
	  dp0_tlp_writeDWAddr_PLUS_3__q3 or
	  dp0_tlp_writeDWAddr or
	  dp0_tlp_writeDWAddr_PLUS_1__q4 or dp0_tlp_writeDWAddr_PLUS_2__q5)
  begin
  ...
  assign MUX_dp0_bram_memory_2$a_put_3__VAL_3 =
	     { IF_2_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d4530[7:0],
	       IF_2_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d4530[15:8],
	       IF_2_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d4530[23:16],
	       IF_2_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d4530[31:24] } ;
  always@(idx__h57275 or
	  dp0_tlp_writeDWAddr_PLUS_3__q3 or
	  dp0_tlp_writeDWAddr or
	  dp0_tlp_writeDWAddr_PLUS_1__q4 or dp0_tlp_writeDWAddr_PLUS_2__q5)
  begin
  ...
  assign MUX_dp0_bram_memory_3$a_put_3__VAL_3 =
	     { IF_3_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d4531[7:0],
	       IF_3_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d4531[15:8],
	       IF_3_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d4531[23:16],
	       IF_3_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d4531[31:24] } ;
  ...
  assign MUX_dp0_tlp_mesgComplReceived$write_1__VAL_2 =
	     dp0_tlp_mesgComplReceived + y__h47956 ;
  ...
  assign MUX_dp0_tlp_mesgLengthRemainPull$write_1__VAL_2 =
	     dp0_tlp_mesgLengthRemainPull - y__h46696 ;
  ...
  assign MUX_dp0_tlp_outF$enq_1__VAL_1 = { 25'd25362416, w_data__h41177 } ;
  assign MUX_dp0_tlp_outF$enq_1__VAL_2 = { 25'd25362416, w_data__h46952 } ;
  assign MUX_dp0_tlp_outF$enq_1__VAL_3 = { 25'd25296895, w_data__h48266 } ;
  ...
  assign MUX_dp0_wmi_wmi_respF_q_0$write_1__VAL_2 = { 2'd1, rdata__h79560 } ;
  ...
  assign MUX_dp1_bml_fabBufsAvail$write_1__VAL_2 =
	     (dp1_dpControl[3:2] == 2'd1) ? x__h160816 : 16'd0 ;
  ...
  always@(idx__h136758 or
	  dp1_tlp_readNxtDWAddr_PLUS_3__q9 or
	  dp1_tlp_readNxtDWAddr or
	  dp1_tlp_readNxtDWAddr_PLUS_1__q10 or
	  dp1_tlp_readNxtDWAddr_PLUS_2__q11)
  begin
    case (idx__h136758)
      ...
      2'd1:
	  MUX_dp1_bram_memory$a_put_2__VAL_4 =
	      dp1_tlp_readNxtDWAddr_PLUS_1__q10[12:2];
      2'd2:
	  MUX_dp1_bram_memory$a_put_2__VAL_4 =
	      dp1_tlp_readNxtDWAddr_PLUS_2__q11[12:2];
      2'd3:
	  MUX_dp1_bram_memory$a_put_2__VAL_4 =
	      dp1_tlp_readNxtDWAddr_PLUS_3__q9[12:2];
    endcase
  end
  ...
  assign MUX_dp1_bram_memory$a_put_3__VAL_3 =
	     { IF_0_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d4533[7:0],
	       IF_0_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d4533[15:8],
	       IF_0_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d4533[23:16],
	       IF_0_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d4533[31:24] } ;
  ...
  assign MUX_dp1_bram_memory_1$a_put_3__VAL_3 =
	     { IF_1_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d4534[7:0],
	       IF_1_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d4534[15:8],
	       IF_1_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d4534[23:16],
	       IF_1_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d4534[31:24] } ;
  assign MUX_dp1_bram_memory_1$b_put_3__VAL_4 =
	     { 24'h800000, dp1_wmi_wmi_mFlagReg[31:24] } ;
  always@(idx__h133214 or
	  dp1_tlp_writeDWAddr_PLUS_3__q12 or
	  dp1_tlp_writeDWAddr or
	  dp1_tlp_writeDWAddr_PLUS_1__q13 or dp1_tlp_writeDWAddr_PLUS_2__q14)
  begin
  ...
  assign MUX_dp1_bram_memory_2$a_put_3__VAL_3 =
	     { IF_2_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d4535[7:0],
	       IF_2_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d4535[15:8],
	       IF_2_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d4535[23:16],
	       IF_2_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d4535[31:24] } ;
  always@(idx__h134510 or
	  dp1_tlp_writeDWAddr_PLUS_3__q12 or
	  dp1_tlp_writeDWAddr or
	  dp1_tlp_writeDWAddr_PLUS_1__q13 or dp1_tlp_writeDWAddr_PLUS_2__q14)
  begin
  ...
  assign MUX_dp1_bram_memory_3$a_put_3__VAL_3 =
	     { IF_3_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d4536[7:0],
	       IF_3_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d4536[15:8],
	       IF_3_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d4536[23:16],
	       IF_3_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d4536[31:24] } ;
  assign MUX_dp1_tlp_fabMesgAccu$write_1__VAL_2 =
	     dp1_tlp_fabMesgAccu + y__h113599 ;
  ...
  assign MUX_dp1_tlp_mReqF$enq_1__VAL_3 =
	     { 88'hAAAAAAAAAAAAAAAAAAFFF8,
	       ...
	       thisRequestLength__h113047[11:2],
	       8'd255,
	       rreq_tag__h113276,
	       3'h2 } ;
  ...
  assign MUX_dp1_tlp_mesgLengthRemainPush$write_1__VAL_2 =
	     dp1_tlp_mesgLengthRemainPush - y__h113087 ;
  ...
  assign MUX_dp1_tlp_outF$enq_1__VAL_1 =
	     { 1'd1,
	       ...
	       23'd196607,
	       w_data__h113451 } ;
  assign MUX_dp1_tlp_outF$enq_1__VAL_2 = { 25'd16973823, w_data__h114430 } ;
  assign MUX_dp1_tlp_outF$enq_1__VAL_3 = { 25'd8585200, w_data__h115492 } ;
  assign MUX_dp1_tlp_outF$enq_1__VAL_4 = { 25'd25296895, w_data__h125500 } ;
  ...
  assign MUX_dp1_tlp_remMesgAccu$write_1__VAL_2 =
	     dp1_tlp_remMesgAccu + y__h113229 ;
  assign MUX_dp1_tlp_srcMesgAccu$write_1__VAL_2 =
	     dp1_tlp_srcMesgAccu + y__h113181 ;
  ...
  assign MUX_dp1_wmi_wmi_respF_q_0$write_1__VAL_2 = { 2'd1, rdata__h156795 } ;
  ...
  assign dp0_tlp_pullTagMatch_1$wget =
	     tagm__h47072 == dp0_tlp_inF$D_OUT[47:40] &&
	     dp0_tlp_inF_first__02_BITS_63_TO_56_05_EQ_pciD_ETC___d914 ;
  ...
  assign dp1_bram_serverAdapterA_s1_1$wget =
	     { 1'd1, !ab__h89684[1] || ab__h89684[0] } ;
  ...
  assign dp1_bram_serverAdapterB_s1_1$wget =
	     { 1'd1, !ab__h91083[1] || ab__h91083[0] } ;
  ...
  assign dp1_bram_serverAdapterA_1_s1_1$wget =
	     { 1'd1, !ab__h92613[1] || ab__h92613[0] } ;
  ...
  assign dp1_bram_serverAdapterB_1_s1_1$wget =
	     { 1'd1, !ab__h94010[1] || ab__h94010[0] } ;
  ...
  assign dp1_bram_serverAdapterA_2_s1_1$wget =
	     { 1'd1, !ab__h95540[1] || ab__h95540[0] } ;
  ...
  assign dp1_bram_serverAdapterB_2_s1_1$wget =
	     { 1'd1, !ab__h96937[1] || ab__h96937[0] } ;
  ...
  assign dp1_bram_serverAdapterA_3_s1_1$wget =
	     { 1'd1, !ab__h98467[1] || ab__h98467[0] } ;
  ...
  assign dp1_bram_serverAdapterB_3_s1_1$wget =
	     { 1'd1, !ab__h99864[1] || ab__h99864[0] } ;
  ...
  begin
    case (1'b1) // synopsys parallel_case
      WILL_FIRE_RL_dp0_tlp_dmaPullRequestFarMesg:
	  dp0_tlp_dmaPullRemainDWLen$D_IN = thisRequestLength__h46671[11:2];
      WILL_FIRE_RL_dp0_tlp_dmaPullResponseHeader:
  ...
  always@(WILL_FIRE_RL_dp0_tlp_dmaPullResponseHeader or
	  ...
	  WILL_FIRE_RL_dp0_tlp_dmaPullResponseBody or
	  dp0_tlp_dmaPullRemainDWSub_031_ULE_4___d4970 or
	  WILL_FIRE_RL_dp0_tlp_dmaPullRequestFarMesg)
  begin
    case (1'b1) // synopsys parallel_case
      WILL_FIRE_RL_dp0_tlp_dmaPullResponseHeader:
  ...
  assign dp0_wmi_wmi_sFlagReg$D_IN =
	     { y_avValue__h79416[7:0], y_avValue__h79396[23:0] } ;
  ...
  assign dp1_wmi_wmi_sFlagReg$D_IN =
	     { y_avValue__h156651[7:0], y_avValue__h156631[23:0] } ;
  ...
  assign ab__h89684 = dp1_bram_serverAdapterA_writeWithResp$wget ;
  assign ab__h91083 = dp1_bram_serverAdapterB_writeWithResp$wget ;
  assign ab__h92613 = dp1_bram_serverAdapterA_1_writeWithResp$wget ;
  assign ab__h94010 = dp1_bram_serverAdapterB_1_writeWithResp$wget ;
  assign ab__h95540 = dp1_bram_serverAdapterA_2_writeWithResp$wget ;
  assign ab__h96937 = dp1_bram_serverAdapterB_2_writeWithResp$wget ;
  assign ab__h98467 = dp1_bram_serverAdapterA_3_writeWithResp$wget ;
  assign ab__h99864 = dp1_bram_serverAdapterB_3_writeWithResp$wget ;
  assign byteCount__h138874 = x__h138985 - y__h138986 ;
  assign byteCount__h61639 = x__h61750 - y__h61751 ;
  assign dp0_bml_crdBuf_value_952_EQ_dp0_bml_crdBuf_mod_ETC___d5105 =
	     dp0_bml_crdBuf_value == dp0_bml_crdBuf_modulus ;
  assign dp0_bml_fabBuf_value_937_EQ_dp0_bml_fabBuf_mod_ETC___d5106 =
	     dp0_bml_fabBuf_value == dp0_bml_fabBuf_modulus ;
  assign dp0_bml_fabFlowAddr_009_PLUS_dp0_bml_fabFlowSi_ETC___d4349 =
	     dp0_bml_fabFlowAddr + dp0_bml_fabFlowSize ;
  assign dp0_bml_lclBufDone_994_AND_IF_dp0_bml_dpContro_ETC___d4438 =
	     dp0_bml_lclBufDone &&
	     CASE_dp0_dpControl_BITS_1_TO_0_NOT_dp0_bml_fab_ETC__q29 ;
  assign dp0_bml_lclBuf_value_907_EQ_dp0_bml_lclBuf_mod_ETC___d5121 =
	     dp0_bml_lclBuf_value == dp0_bml_lclBuf_modulus ;
  assign dp0_bml_remBuf_value_922_EQ_dp0_bml_remBuf_mod_ETC___d5122 =
  ...
  assign dp0_bram_serverAdapterA_1_cnt_50_PLUS_IF_dp0_b_ETC___d356 =
		...
		3'd7 :
		3'd0) ;
  assign dp0_bram_serverAdapterA_1_cnt_50_SLT_3___d4972 =
  ...
  assign dp0_bram_serverAdapterA_2_cnt_68_PLUS_IF_dp0_b_ETC___d474 =
		...
		3'd7 :
		3'd0) ;
  assign dp0_bram_serverAdapterA_2_cnt_68_SLT_3___d4973 =
  ...
  assign dp0_bram_serverAdapterA_3_cnt_86_PLUS_IF_dp0_b_ETC___d592 =
		...
		3'd7 :
		3'd0) ;
  assign dp0_bram_serverAdapterA_3_cnt_86_SLT_3___d4974 =
  ...
  assign dp0_bram_serverAdapterA_cnt_32_SLT_3___d4971 =
  ...
  assign dp0_tlp_dmaPullRemainDWLen_017_ULE_dp0_tlp_dma_ETC___d4969 =
	     dp0_tlp_dmaPullRemainDWLen <= dp0_tlp_dmaPullRemainDWSub ;
  assign dp0_tlp_dmaPullRemainDWSub_031_ULE_4___d4970 =
	     dp0_tlp_dmaPullRemainDWSub <= 10'd4 ;
  ...
  assign dp0_tlp_mReqF_RDY_deq__157_AND_IF_dp0_tlp_mReq_ETC___d1173 =
	     dp0_tlp_mReqF$EMPTY_N &&
	     CASE_dp0_tlp_mReqFD_OUT_BITS_51_TO_50_NOT_dp0_ETC__q25 ;
  assign dp0_tlp_outDwRemain_142_ULE_4___d4634 =
	     dp0_tlp_outDwRemain <= 10'd4 ;
  ...
  assign dp0_tlp_writeRemainDWLen_194_ULE_1___d4365 =
	     dp0_tlp_writeRemainDWLen <= 10'd1 ;
  assign dp0_tlp_writeRemainDWLen_194_ULE_2___d4384 =
	     dp0_tlp_writeRemainDWLen <= 10'd2 ;
  assign dp0_tlp_writeRemainDWLen_194_ULE_3___d4366 =
  ...
  assign dp0_wmi_dpControl_whas__701_AND_dp0_bram_serve_ETC___d1747 =
	     ...
	     (dp0_bram_serverAdapterB_1_outDataCore$EMPTY_N ||
	      dp0_bram_serverAdapterB_1_outData_enqData$whas) &&
	     dp0_bram_serverAdapterB_1_outData_outData_whas_ETC___d1743 ;
  assign dp1_bml_crdBuf_value_983_EQ_dp1_bml_crdBuf_mod_ETC___d5172 =
	     dp1_bml_crdBuf_value == dp1_bml_crdBuf_modulus ;
  assign dp1_bml_fabBuf_value_968_EQ_dp1_bml_fabBuf_mod_ETC___d5173 =
	     dp1_bml_fabBuf_value == dp1_bml_fabBuf_modulus ;
  assign dp1_bml_fabFlowAddr_040_PLUS_dp1_bml_fabFlowSi_ETC___d4351 =
	     dp1_bml_fabFlowAddr + dp1_bml_fabFlowSize ;
  assign dp1_bml_lclBufDone_025_AND_IF_dp1_bml_dpContro_ETC___d4458 =
	     dp1_bml_lclBufDone &&
	     CASE_dp1_dpControl_BITS_1_TO_0_NOT_dp1_bml_fab_ETC__q30 ;
  assign dp1_bml_lclBuf_value_938_EQ_dp1_bml_lclBuf_mod_ETC___d5188 =
	     dp1_bml_lclBuf_value == dp1_bml_lclBuf_modulus ;
  assign dp1_bml_remBuf_value_953_EQ_dp1_bml_remBuf_mod_ETC___d5189 =
  ...
  assign dp1_bram_serverAdapterA_1_cnt_386_PLUS_IF_dp1__ETC___d2392 =
		...
		3'd7 :
		3'd0) ;
  assign dp1_bram_serverAdapterA_1_cnt_386_SLT_3___d4976 =
  ...
  assign dp1_bram_serverAdapterA_2_cnt_504_PLUS_IF_dp1__ETC___d2510 =
		...
		3'd7 :
		3'd0) ;
  assign dp1_bram_serverAdapterA_2_cnt_504_SLT_3___d4977 =
  ...
  assign dp1_bram_serverAdapterA_3_cnt_622_PLUS_IF_dp1__ETC___d2628 =
		...
		3'd7 :
		3'd0) ;
  assign dp1_bram_serverAdapterA_3_cnt_622_SLT_3___d4978 =
  ...
  assign dp1_bram_serverAdapterA_cnt_268_SLT_3___d4975 =
  ...
  assign dp1_tlp_mReqF_RDY_deq__188_AND_IF_dp1_tlp_mReq_ETC___d3204 =
	     dp1_tlp_mReqF$EMPTY_N &&
	     CASE_dp1_tlp_mReqFD_OUT_BITS_51_TO_50_NOT_dp1_ETC__q27 ;
  assign dp1_tlp_mRespF_first__905_BITS_71_TO_62_995_ULE_1___d4367 =
	     dp1_tlp_mRespF$D_OUT[71:62] <= 10'd1 ;
  assign dp1_tlp_outDwRemain_021_ULE_4___d4639 =
	     dp1_tlp_outDwRemain <= 10'd4 ;
  assign dp1_tlp_rdRespDwRemain_539_ULE_4___d3540 =
	     dp1_tlp_rdRespDwRemain <= 10'd4 ;
  assign dp1_tlp_readNxtDWAddr_PLUS_1__q10 = dp1_tlp_readNxtDWAddr + 13'd1 ;
  assign dp1_tlp_readNxtDWAddr_PLUS_2__q11 = dp1_tlp_readNxtDWAddr + 13'd2 ;
  assign dp1_tlp_readNxtDWAddr_PLUS_3__q9 = dp1_tlp_readNxtDWAddr + 13'd3 ;
  ...
  assign dp1_tlp_writeRemainDWLen_225_ULE_1___d4368 =
	     dp1_tlp_writeRemainDWLen <= 10'd1 ;
  assign dp1_tlp_writeRemainDWLen_225_ULE_2___d4383 =
	     dp1_tlp_writeRemainDWLen <= 10'd2 ;
  assign dp1_tlp_writeRemainDWLen_225_ULE_3___d4413 =
  ...
  assign dp1_wmi_dpControl_whas__732_AND_dp1_bram_serve_ETC___d3778 =
	     ...
	     (dp1_bram_serverAdapterB_1_outDataCore$EMPTY_N ||
	      dp1_bram_serverAdapterB_1_outData_enqData$whas) &&
	     dp1_bram_serverAdapterB_1_outData_outData_whas_ETC___d3774 ;
  assign idx__h129695 = 2'd0 - dp1_tlp_writeDWAddr[1:0] ;
  assign idx__h131918 = 2'd1 - dp1_tlp_writeDWAddr[1:0] ;
  assign idx__h133214 = 2'd2 - dp1_tlp_writeDWAddr[1:0] ;
  assign idx__h134510 = 2'd3 - dp1_tlp_writeDWAddr[1:0] ;
  assign idx__h136758 = 2'd0 - dp1_tlp_readNxtDWAddr[1:0] ;
  assign idx__h137226 = 2'd1 - dp1_tlp_readNxtDWAddr[1:0] ;
  assign idx__h137599 = 2'd2 - dp1_tlp_readNxtDWAddr[1:0] ;
  assign idx__h137972 = 2'd3 - dp1_tlp_readNxtDWAddr[1:0] ;
  assign idx__h52460 = 2'd0 - dp0_tlp_writeDWAddr[1:0] ;
  assign idx__h54683 = 2'd1 - dp0_tlp_writeDWAddr[1:0] ;
  assign idx__h55979 = 2'd2 - dp0_tlp_writeDWAddr[1:0] ;
  assign idx__h57275 = 2'd3 - dp0_tlp_writeDWAddr[1:0] ;
  assign idx__h59523 = 2'd0 - dp0_tlp_readNxtDWAddr[1:0] ;
  assign idx__h59991 = 2'd1 - dp0_tlp_readNxtDWAddr[1:0] ;
  assign idx__h60364 = 2'd2 - dp0_tlp_readNxtDWAddr[1:0] ;
  assign idx__h60737 = 2'd3 - dp0_tlp_readNxtDWAddr[1:0] ;
  assign lastBE__h113475 =
	     dp1_tlp_mRespF_first__905_BITS_71_TO_62_995_ULE_1___d4367 ?
	       4'd0 :
	       4'd15 ;
  assign lastBE__h46973 =
	     (thisRequestLength__h46671[11:2] == 10'd1) ? 4'd0 : 4'd15 ;
  assign lowAddr__h138873 =
	     { dp1_tlp_readReq$D_OUT[33:29], lowAddr10__h138872 } ;
  assign lowAddr__h61638 =
	     { dp0_tlp_readReq$D_OUT[33:29], lowAddr10__h61637 } ;
  assign mesgMeta_opcode__h155075 = MUX_dp1_bram_memory_1$b_put_3__VAL_4 ;
  assign mesgMeta_opcode__h77840 = MUX_dp0_bram_memory_1$b_put_3__VAL_4 ;
  assign nowLS__h109833 =
	     { dp1_tlp_mRespF$D_OUT[39:32],
	       dp1_tlp_mRespF$D_OUT[47:40],
	       dp1_tlp_mRespF$D_OUT[55:48],
	       dp1_tlp_mRespF$D_OUT[63:56] } ;
  assign nowLS__h43459 =
	     { dp0_tlp_inF$D_OUT[39:32],
	       dp0_tlp_inF$D_OUT[47:40],
	       dp0_tlp_inF$D_OUT[55:48],
	       dp0_tlp_inF$D_OUT[63:56] } ;
  assign nowMS__h109832 =
	     { dp1_tlp_mRespF$D_OUT[71:64],
	       dp1_tlp_mRespF$D_OUT[79:72],
	       dp1_tlp_mRespF$D_OUT[87:80],
	       dp1_tlp_mRespF$D_OUT[95:88] } ;
  assign nowMS__h43458 =
	     { dp0_tlp_inF$D_OUT[71:64],
	       dp0_tlp_inF$D_OUT[79:72],
	       dp0_tlp_inF$D_OUT[87:80],
	       dp0_tlp_inF$D_OUT[95:88] } ;
  assign opcode__h109831 =
	     { dp1_tlp_mRespF$D_OUT[103:96],
	       dp1_tlp_mRespF$D_OUT[111:104],
	       dp1_tlp_mRespF$D_OUT[119:112],
	       dp1_tlp_mRespF$D_OUT[127:120] } ;
  assign opcode__h43457 =
  ...
  assign rdat__h163664 = { 16'd0, dp1_bml_lclNumBufs } ;
  assign rdat__h163672 = { 16'd0, dp1_bml_fabNumBufs } ;
  assign rdat__h163680 = { 16'd0, dp1_bml_mesgBase } ;
  assign rdat__h163688 = { 16'd0, dp1_bml_metaBase } ;
  assign rdat__h163696 = { 16'd0, dp1_bml_mesgSize } ;
  assign rdat__h163704 = { 16'd0, dp1_bml_metaSize } ;
  assign rdat__h163712 = { 16'd0, dp1_bml_lclBufsCF } ;
  assign rdat__h163733 = { dp1_bml_lclBufsAR, dp1_bml_fabBufsAvail } ;
  assign rdat__h163738 = { dp1_bml_remBuf_value, dp1_bml_lclBuf_value } ;
  assign rdat__h163749 = { dp1_bml_lclStarts, dp1_bml_lclDones } ;
  assign rdat__h163754 = { dp1_bml_remStarts, dp1_bml_remDones } ;
  assign rdat__h163815 = { 28'd0, dp1_dpControl } ;
  assign rdat__h86432 = { 16'd0, dp0_bml_lclNumBufs } ;
  assign rdat__h86440 = { 16'd0, dp0_bml_fabNumBufs } ;
  assign rdat__h86448 = { 16'd0, dp0_bml_mesgBase } ;
  assign rdat__h86456 = { 16'd0, dp0_bml_metaBase } ;
  assign rdat__h86464 = { 16'd0, dp0_bml_mesgSize } ;
  assign rdat__h86472 = { 16'd0, dp0_bml_metaSize } ;
  assign rdat__h86480 = { 16'd0, dp0_bml_lclBufsCF } ;
  assign rdat__h86501 = { dp0_bml_lclBufsAR, dp0_bml_fabBufsAvail } ;
  assign rdat__h86506 = { dp0_bml_remBuf_value, dp0_bml_lclBuf_value } ;
  assign rdat__h86517 = { dp0_bml_lclStarts, dp0_bml_lclDones } ;
  assign rdat__h86522 = { dp0_bml_remStarts, dp0_bml_remDones } ;
  assign rdat__h86583 = { 28'd0, dp0_dpControl } ;
  assign rdata__h144242 =
	     dp1_tlp_readNxtDWAddr[1] ?
	       IF_dp1_tlp_readNxtDWAddr_407_BIT_0_584_THEN_dp_ETC___d3589 :
	       IF_dp1_tlp_readNxtDWAddr_407_BIT_0_584_THEN_dp_ETC___d3594 ;
  assign rdata__h67007 =
	     dp0_tlp_readNxtDWAddr[1] ?
	       IF_dp0_tlp_readNxtDWAddr_376_BIT_0_553_THEN_dp_ETC___d1558 :
	       IF_dp0_tlp_readNxtDWAddr_376_BIT_0_553_THEN_dp_ETC___d1563 ;
  assign rreq_tag__h113276 =
	     (y__h113087 == dp1_tlp_mesgLengthRemainPush) ? 8'h01 : 8'h0 ;
  assign rresp_data__h138916 =
	     { IF_dp1_tlp_readReq_first__455_BITS_30_TO_29_45_ETC___d4537[7:0],
	       IF_dp1_tlp_readReq_first__455_BITS_30_TO_29_45_ETC___d4537[15:8],
	       IF_dp1_tlp_readReq_first__455_BITS_30_TO_29_45_ETC___d4537[23:16],
	       IF_dp1_tlp_readReq_first__455_BITS_30_TO_29_45_ETC___d4537[31:24] } ;
  assign rresp_data__h61681 =
	     { IF_dp0_tlp_readReq_first__424_BITS_30_TO_29_42_ETC___d4532[7:0],
	       IF_dp0_tlp_readReq_first__424_BITS_30_TO_29_42_ETC___d4532[15:8],
	       IF_dp0_tlp_readReq_first__424_BITS_30_TO_29_42_ETC___d4532[23:16],
	       IF_dp0_tlp_readReq_first__424_BITS_30_TO_29_42_ETC___d4532[31:24] } ;
  assign spanToNextPage__h113046 =
	     13'd4096 - { 1'd0, dp1_tlp_srcMesgAccu[11:0] } ;
  assign spanToNextPage__h46670 =
	     13'd4096 - { 1'd0, dp0_tlp_fabMesgAccu[11:0] } ;
  assign tag__h46946 = { 3'd0, dp0_tlp_dmaTag } ;
  assign tagm__h47072 = { 3'd0, dp0_tlp_dmaReqTag } ;
  assign thisRequestLength__h113047 =
	     (x__h113100[12:0] <= spanToNextPage__h113046) ?
	       x__h113100[12:0] :
	       spanToNextPage__h113046 ;
  assign thisRequestLength__h46671 =
	     (x__h46704[12:0] <= spanToNextPage__h46670) ?
	       x__h46704[12:0] :
	       spanToNextPage__h46670 ;
  ...
  assign w_data__h115492 =
	     { dp1_tlp_fabMeta[71:64],
	       ...
	       32'b0 } ;
  assign w_data__h125500 =
	     { 32'd1073745921,
	       pciDevice[15:3],
	       19'd65551,
	       dp1_tlp_fabFlowAddr,
	       32'd16777216 } ;
  assign w_data__h41177 =
	     { 32'd4100,
	       pciDevice[15:3],
	       3'd0,
	       tag__h46946,
	       ...
	       34'd0 } ;
  assign w_data__h46952 =
	     { 22'd4,
	       thisRequestLength__h46671[11:2],
	       pciDevice[15:3],
	       3'd0,
	       tag__h46946,
	       lastBE__h46973,
	       ...
	       34'd0 } ;
  assign w_data__h48266 =
	     { 32'd1073745921,
	       pciDevice[15:3],
	       19'd15,
	       dp0_tlp_fabFlowAddr,
	       32'd16777216 } ;
  assign x3__h155035 = MUX_dp1_bram_memory$b_put_3__VAL_4 ;
  assign x3__h77800 = MUX_dp0_bram_memory$b_put_3__VAL_4 ;
  assign x__h109894 = { 15'd0, dp1_tlp_mesgLengthRemainPush } ;
  assign x__h113100 =
	     (dp1_tlp_mesgLengthRemainPush <= y__h113102) ?
	       dp1_tlp_mesgLengthRemainPush :
	       y__h113102 ;
  assign x__h113602 = { dp1_tlp_mRespF$D_OUT[69:62], 2'd0 } ;
  assign x__h138985 = x__h138987 - y__h138988 ;
  assign x__h138987 = { dp1_tlp_readReq$D_OUT[28:19], 2'b0 } ;
  assign x__h160816 =
	     (dp1_dpControl[1:0] == 2'd1) ? dp1_bml_fabNumBufs : 16'd0 ;
  assign x__h161940 = dp1_bml_lclBufsAR + 16'd1 ;
  assign x__h161945 = dp1_bml_lclBufsAR - 16'd1 ;
  assign x__h162017 = dp1_bml_lclBufsCF + 16'd1 ;
  assign x__h162022 = dp1_bml_lclBufsCF - 16'd1 ;
  assign x__h162059 = dp1_bml_fabBufsAvail + 16'd1 ;
  assign x__h162064 = dp1_bml_fabBufsAvail - 16'd1 ;
  assign x__h162097 = dp1_bml_lclCredit + 16'd1 ;
  assign x__h162102 = dp1_bml_lclCredit - 16'd1 ;
  assign x__h43489 = { 15'd0, dp0_tlp_mesgLengthRemainPull } ;
  assign x__h46704 =
	     (dp0_tlp_mesgLengthRemainPull <= y__h46706) ?
	       dp0_tlp_mesgLengthRemainPull :
	       y__h46706 ;
  assign x__h47281 = { dp0_tlp_inF$D_OUT[103:96], 2'd0 } ;
  assign x__h47959 = { dp0_tlp_dmaPullRemainDWSub[7:0], 2'd0 } ;
  assign x__h61750 = x__h61752 - y__h61753 ;
  assign x__h61752 = { dp0_tlp_readReq$D_OUT[28:19], 2'b0 } ;
  assign x__h83584 =
	     (dp0_dpControl[1:0] == 2'd1) ? dp0_bml_fabNumBufs : 16'd0 ;
  assign x__h84708 = dp0_bml_lclBufsAR + 16'd1 ;
  assign x__h84713 = dp0_bml_lclBufsAR - 16'd1 ;
  assign x__h84785 = dp0_bml_lclBufsCF + 16'd1 ;
  assign x__h84790 = dp0_bml_lclBufsCF - 16'd1 ;
  assign x__h84827 = dp0_bml_fabBufsAvail + 16'd1 ;
  assign x__h84832 = dp0_bml_fabBufsAvail - 16'd1 ;
  assign x__h84865 = dp0_bml_lclCredit + 16'd1 ;
  assign x__h84870 = dp0_bml_lclCredit - 16'd1 ;
  assign y__h113087 = { 4'd0, thisRequestLength__h113047 } ;
  assign y__h113102 = { 4'd0, dp1_tlp_maxPayloadSize } ;
  assign y__h113181 = { 19'd0, thisRequestLength__h113047 } ;
  assign y__h113229 = { 3'd0, thisRequestLength__h113047 } ;
  assign y__h113599 = { 22'd0, x__h113602 } ;
  assign y__h138986 =
	     (dp1_tlp_readReq$D_OUT[28:19] == 10'd1) ?
	       12'd0 :
	       { 10'd0, x__h139017 } ;
  assign y__h138988 = { 10'd0, x__h138994 } ;
  assign y__h46696 = { 4'd0, thisRequestLength__h46671 } ;
  assign y__h46706 = { 4'd0, dp0_tlp_maxReadReqSize } ;
  assign y__h46767 = { 19'd0, thisRequestLength__h46671 } ;
  assign y__h47278 = { 6'd0, x__h47281 } ;
  assign y__h47956 =
	     dp0_tlp_dmaPullRemainDWSub_031_ULE_4___d4970 ?
	       { 7'd0, x__h47959 } :
	       17'd16 ;
  assign y__h61751 =
	     (dp0_tlp_readReq$D_OUT[28:19] == 10'd1) ?
	       12'd0 :
	       { 10'd0, x__h61782 } ;
  assign y__h61753 = { 10'd0, x__h61759 } ;
  assign y_avValue__h156631 = dp1_bram_serverAdapterB_outData_outData$wget ;
  assign y_avValue__h156651 = dp1_bram_serverAdapterB_1_outData_outData$wget ;
  assign y_avValue__h156671 = dp1_bram_serverAdapterB_2_outData_outData$wget ;
  assign y_avValue__h156691 = dp1_bram_serverAdapterB_3_outData_outData$wget ;
  assign y_avValue__h79396 = dp0_bram_serverAdapterB_outData_outData$wget ;
  assign y_avValue__h79416 = dp0_bram_serverAdapterB_1_outData_outData$wget ;
  assign y_avValue__h79436 = dp0_bram_serverAdapterB_2_outData_outData$wget ;
  assign y_avValue__h79456 = dp0_bram_serverAdapterB_3_outData_outData$wget ;
  always@(dp0_tlp_readReq$D_OUT)
  begin
    case (dp0_tlp_readReq$D_OUT[18:15])
      4'b1100: x__h61759 = 2'b10;
      4'b1110: x__h61759 = 2'b01;
      4'b1111: x__h61759 = 2'b0;
      default: x__h61759 = 2'b11;
    endcase
  end
  always@(dp0_tlp_readReq$D_OUT)
  begin
    case (dp0_tlp_readReq$D_OUT[14:11])
      4'b1100: x__h61782 = 2'b10;
      4'b1110: x__h61782 = 2'b01;
      4'b1111: x__h61782 = 2'b0;
      default: x__h61782 = 2'b11;
    endcase
  end
  always@(dp1_tlp_readReq$D_OUT)
  begin
    case (dp1_tlp_readReq$D_OUT[18:15])
      4'b1100: x__h138994 = 2'b10;
      4'b1110: x__h138994 = 2'b01;
      4'b1111: x__h138994 = 2'b0;
      default: x__h138994 = 2'b11;
    endcase
  end
  always@(dp1_tlp_readReq$D_OUT)
  begin
    case (dp1_tlp_readReq$D_OUT[14:11])
      4'b1100: x__h139017 = 2'b10;
      4'b1110: x__h139017 = 2'b01;
      4'b1111: x__h139017 = 2'b0;
      default: x__h139017 = 2'b11;
    endcase
  end
  always@(dp0_wmi_p4B or
	  y_avValue__h79456 or
	  y_avValue__h79396 or y_avValue__h79416 or y_avValue__h79436)
  begin
    case (dp0_wmi_p4B)
      2'd0: rdata__h79560 = y_avValue__h79396;
      2'd1: rdata__h79560 = y_avValue__h79416;
      2'd2: rdata__h79560 = y_avValue__h79436;
      2'd3: rdata__h79560 = y_avValue__h79456;
    endcase
  end
  always@(dp1_wmi_p4B or
	  y_avValue__h156691 or
	  y_avValue__h156631 or y_avValue__h156651 or y_avValue__h156671)
  begin
    case (dp1_wmi_p4B)
      2'd0: rdata__h156795 = y_avValue__h156631;
      2'd1: rdata__h156795 = y_avValue__h156651;
      2'd2: rdata__h156795 = y_avValue__h156671;
      2'd3: rdata__h156795 = y_avValue__h156691;
    endcase
  end
  always@(dp0_tlp_readReq$D_OUT)
  begin
    case (dp0_tlp_readReq$D_OUT[18:15])
      4'b1000: lowAddr10__h61637 = 2'b11;
      4'b1100: lowAddr10__h61637 = 2'b10;
      4'b1110: lowAddr10__h61637 = 2'b01;
      default: lowAddr10__h61637 = 2'b0;
    endcase
  end
  always@(dp0_wci_reqF$D_OUT or
	  ...
	  dp0_bml_fabFlowBase or dp0_bml_fabFlowSize or rdat__h86583)
  begin
    case (dp0_wci_reqF$D_OUT[39:32])
      8'h0: _theResult____h86353 = rdat__h86432;
      8'h04: _theResult____h86353 = rdat__h86440;
      8'h08: _theResult____h86353 = rdat__h86448;
      8'h0C: _theResult____h86353 = rdat__h86456;
      8'h10: _theResult____h86353 = rdat__h86464;
      8'h14: _theResult____h86353 = rdat__h86472;
      8'h20: _theResult____h86353 = rdat__h86480;
      8'h24: _theResult____h86353 = 32'hF00DFACE;
      8'h28: _theResult____h86353 = rdat__h86501;
      8'h2C: _theResult____h86353 = rdat__h86506;
      8'h30: _theResult____h86353 = rdat__h86517;
      8'h34: _theResult____h86353 = rdat__h86522;
      8'h48: _theResult____h86353 = 32'hDADEBABE;
      8'h4C: _theResult____h86353 = 32'h00008000;
      8'h50: _theResult____h86353 = dp0_bml_fabMesgBase;
      8'h54: _theResult____h86353 = dp0_bml_fabMetaBase;
      8'h58: _theResult____h86353 = dp0_bml_fabMesgSize;
      8'h5C: _theResult____h86353 = dp0_bml_fabMetaSize;
      8'h60: _theResult____h86353 = dp0_bml_fabFlowBase;
      8'h64: _theResult____h86353 = dp0_bml_fabFlowSize;
      8'h68: _theResult____h86353 = rdat__h86583;
      default: _theResult____h86353 = 32'd0;
    endcase
  end
  always@(dp1_tlp_readReq$D_OUT)
  begin
    case (dp1_tlp_readReq$D_OUT[18:15])
      4'b1000: lowAddr10__h138872 = 2'b11;
      4'b1100: lowAddr10__h138872 = 2'b10;
      4'b1110: lowAddr10__h138872 = 2'b01;
      default: lowAddr10__h138872 = 2'b0;
    endcase
  end
  always@(dp1_wci_reqF$D_OUT or
	  ...
	  dp1_bml_fabFlowBase or dp1_bml_fabFlowSize or rdat__h163815)
  begin
    case (dp1_wci_reqF$D_OUT[39:32])
      8'h0: _theResult____h163585 = rdat__h163664;
      8'h04: _theResult____h163585 = rdat__h163672;
      8'h08: _theResult____h163585 = rdat__h163680;
      8'h0C: _theResult____h163585 = rdat__h163688;
      8'h10: _theResult____h163585 = rdat__h163696;
      8'h14: _theResult____h163585 = rdat__h163704;
      8'h20: _theResult____h163585 = rdat__h163712;
      8'h24: _theResult____h163585 = 32'hF00DFACE;
      8'h28: _theResult____h163585 = rdat__h163733;
      8'h2C: _theResult____h163585 = rdat__h163738;
      8'h30: _theResult____h163585 = rdat__h163749;
      8'h34: _theResult____h163585 = rdat__h163754;
      8'h48: _theResult____h163585 = 32'hDADEBABE;
      8'h4C: _theResult____h163585 = 32'h00008000;
      8'h50: _theResult____h163585 = dp1_bml_fabMesgBase;
      8'h54: _theResult____h163585 = dp1_bml_fabMetaBase;
      8'h58: _theResult____h163585 = dp1_bml_fabMesgSize;
      8'h5C: _theResult____h163585 = dp1_bml_fabMetaSize;
      8'h60: _theResult____h163585 = dp1_bml_fabFlowBase;
      8'h64: _theResult____h163585 = dp1_bml_fabFlowSize;
      8'h68: _theResult____h163585 = rdat__h163815;
      default: _theResult____h163585 = 32'd0;
    endcase
  end
  ...
  always@(idx__h52460 or
	  dp0_tlp_writeRemainDWLen_194_ULE_3___d4366 or
	  dp0_tlp_writeRemainDWLen or
	  dp0_tlp_writeRemainDWLen_194_ULE_1___d4365 or
	  dp0_tlp_writeRemainDWLen_194_ULE_2___d4384)
  begin
    case (idx__h52460)
      2'd0:
  ...
  always@(idx__h129695 or
	  dp1_tlp_writeRemainDWLen_225_ULE_3___d4413 or
	  dp1_tlp_writeRemainDWLen or
	  dp1_tlp_writeRemainDWLen_225_ULE_1___d4368 or
	  dp1_tlp_writeRemainDWLen_225_ULE_2___d4383)
  begin
    case (idx__h129695)
      2'd0:
  ...
  always@(dp0_tlp_mReqF$D_OUT or
	  dp0_bram_serverAdapterA_3_cnt_86_SLT_3___d4974 or
	  dp0_bram_serverAdapterA_cnt_32_SLT_3___d4971 or
	  dp0_bram_serverAdapterA_1_cnt_50_SLT_3___d4972 or
	  dp0_bram_serverAdapterA_2_cnt_68_SLT_3___d4973)
  begin
  ...
  always@(dp1_tlp_mReqF$D_OUT or
	  dp1_bram_serverAdapterA_3_cnt_622_SLT_3___d4978 or
	  dp1_bram_serverAdapterA_cnt_268_SLT_3___d4975 or
	  dp1_bram_serverAdapterA_1_cnt_386_SLT_3___d4976 or
	  dp1_bram_serverAdapterA_2_cnt_504_SLT_3___d4977)
  begin
  ...
  always@(idx__h52460 or dp0_tlp_mReqF$D_OUT)
  begin
    case (idx__h52460)
      2'd0:
	  IF_0_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d4528 =
  ...
  always@(idx__h55979 or dp0_tlp_mReqF$D_OUT)
  begin
    case (idx__h55979)
      2'd0:
	  IF_2_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d4530 =
  ...
  always@(idx__h54683 or dp0_tlp_mReqF$D_OUT)
  begin
    case (idx__h54683)
      2'd0:
	  IF_1_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d4529 =
  ...
  always@(idx__h57275 or dp0_tlp_mReqF$D_OUT)
  begin
    case (idx__h57275)
      2'd0:
	  IF_3_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d4531 =
  ...
  always@(idx__h129695 or dp1_tlp_mReqF$D_OUT)
  begin
    case (idx__h129695)
      2'd0:
	  IF_0_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d4533 =
  ...
  always@(idx__h133214 or dp1_tlp_mReqF$D_OUT)
  begin
    case (idx__h133214)
      2'd0:
	  IF_2_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d4535 =
  ...
  always@(idx__h131918 or dp1_tlp_mReqF$D_OUT)
  begin
    case (idx__h131918)
      2'd0:
	  IF_1_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d4534 =
  ...
  always@(idx__h134510 or dp1_tlp_mReqF$D_OUT)
  begin
    case (idx__h134510)
      2'd0:
	  IF_3_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d4536 =
  ...
  begin
    ...
    if (cp$RST_N_wci_Vm_13)
      if (WILL_FIRE_RL_dp0_tlp_dmaXmtDoorbell)
	$display("[%0d]: %m: dmaXmtDoorbell FC/FPactFlow-Step1/1", v__h40907);
    if (cp$RST_N_wci_Vm_13)
      if (pciw_p125rst$OUT_RST_N)
    ...
    if (cp$RST_N_wci_Vm_13)
      if (pciw_p125rst$OUT_RST_N)
	if (WILL_FIRE_RL_dp0_tlp_dmaTailEventSender)
	  $display("[%0d]: %m: dmaTailEventSender - generic", v__h49134);
    if (cp$RST_N_wci_Vm_13)
      if (pciw_p125rst$OUT_RST_N)
    ...
    if (cp$RST_N_wci_Vm_13)
      if (WILL_FIRE_RL_dp0_tlp_dmaPullTailEvent)
	$display("[%0d]: %m: dmaPullTailEvent FPactMesg-Step5/5", v__h48179);
    if (cp$RST_N_wci_Vm_13)
    ...
    if (cp$RST_N_wci_Vm_13)
      if (WILL_FIRE_RL_dp0_wci_cfwr && dp0_wci_reqF$D_OUT[39:32] == 8'h18)
	$display("[%0d] %m: fabDoneAvail Event", v__h85841);
    if (cp$RST_N_wci_Vm_13)
    ...
    if (cp$RST_N_wci_Vm_14)
      if (pciw_p125rst$OUT_RST_N)
	if (WILL_FIRE_RL_dp1_tlp_dmaXmtMetaHead)
	  $display("[%0d]: %m: dmaXmtMetaHead FPactMesg-Step5/7", v__h115324);
    if (cp$RST_N_wci_Vm_14)
    ...
    if (cp$RST_N_wci_Vm_14)
      if (WILL_FIRE_RL_dp1_tlp_dmaXmtMetaBody)
	$display("[%0d]: %m: dmaXmtMetaBody FPactMesg-Step6/7", v__h118058);
    if (cp$RST_N_wci_Vm_14)
    ...
    if (cp$RST_N_wci_Vm_14)
      if (WILL_FIRE_RL_dp1_tlp_dmaXmtTailEvent)
	$display("[%0d]: %m: dmaXmtTailEvent FPactMesg-Step7/7", v__h118243);
    if (cp$RST_N_wci_Vm_14)
      if (pciw_p125rst$OUT_RST_N)
    ...
    if (cp$RST_N_wci_Vm_14)
      if (pciw_p125rst$OUT_RST_N)
	if (WILL_FIRE_RL_dp1_tlp_dmaTailEventSender)
	  $display("[%0d]: %m: dmaTailEventSender - generic", v__h126368);
    if (cp$RST_N_wci_Vm_14)
    ...
    if (cp$RST_N_wci_Vm_14)
      if (WILL_FIRE_RL_dp1_wci_cfwr && dp1_wci_reqF$D_OUT[39:32] == 8'h18)
	$display("[%0d] %m: fabDoneAvail Event", v__h163073);
    if (cp$RST_N_wci_Vm_14)
