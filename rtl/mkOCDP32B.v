...
//
// On Wed Nov  9 10:01:46 EST 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkOCDP32B(pciDevice,
  ...
  wire MUX_bml_fabBufsAvail$write_1__SEL_1,
       ...
       MUX_bram_memory_1$a_put_3__SEL_1,
  ...
  reg [63 : 0] v__h15540,
	       ...
	       v__h77374,
	       v__h77528;
  reg [31 : 0] IF_0_MINUS_tlp_writeDWAddr_160_BITS_1_TO_0_161_ETC___d2241,
	       IF_1_MINUS_tlp_writeDWAddr_160_BITS_1_TO_0_161_ETC___d2242,
	       IF_2_MINUS_tlp_writeDWAddr_160_BITS_1_TO_0_161_ETC___d2243,
	       IF_3_MINUS_tlp_writeDWAddr_160_BITS_1_TO_0_161_ETC___d2244,
	       IF_tlp_readReq_first__394_BITS_30_TO_29_395_EQ_ETC___d2245,
	       _theResult____h77512;
  ...
  reg [1 : 0] lowAddr10__h54335, x__h54457, x__h54480;
  reg CASE_dpControl_BITS_1_TO_0_NOT_bml_fabDone_0_N_ETC__q6,
      ...
      IF_0_MINUS_tlp_writeDWAddr_160_BITS_1_TO_0_161_ETC___d2646,
      IF_1_MINUS_tlp_writeDWAddr_160_BITS_1_TO_0_161_ETC___d1187,
      IF_1_MINUS_tlp_writeDWAddr_160_BITS_1_TO_0_161_ETC___d2647,
      IF_2_MINUS_tlp_writeDWAddr_160_BITS_1_TO_0_161_ETC___d1197,
      IF_2_MINUS_tlp_writeDWAddr_160_BITS_1_TO_0_161_ETC___d2648,
      IF_3_MINUS_tlp_writeDWAddr_160_BITS_1_TO_0_161_ETC___d1207,
      IF_3_MINUS_tlp_writeDWAddr_160_BITS_1_TO_0_161_ETC___d2649,
  ...
  wire [127 : 0] IF_tlp_readReq_first__394_BITS_30_TO_29_395_PL_ETC___d1529,
		 ...
		 w_data__h39361,
		 w_data__h40876;
  wire [31 : 0] bml_fabFlowAddr_924_PLUS_bml_fabFlowSize_925___d2465,
		mesgMeta_opcode__h69830,
		nowLS__h25519,
		nowLS__h37829,
		nowMS__h24576,
		nowMS__h36888,
  ...
  wire [15 : 0] w_be__h27716,
		...
		y__h26933,
		y__h39739;
  wire [12 : 0] spanToNextPage__h26765,
		spanToNextPage__h39079,
		thisRequestLength__h26766,
		thisRequestLength__h39080,
  ...
  wire [11 : 0] byteCount__h54337, x__h54448, x__h54450, y__h54449, y__h54451;
  wire [7 : 0] rreq_tag__h26980, tag__h39355, tagm__h39532;
  wire [6 : 0] lowAddr__h54336;
  wire [3 : 0] lastBE__h27190, lastBE__h39382;
  ...
  wire [1 : 0] ab__h10380,
	       ...
	       idx__h53062,
	       idx__h53435,
	       tlp_readReq_first__394_BITS_30_TO_29_395_PLUS_1___d2592;
  wire IF_1_MINUS_tlp_writeDWAddr_160_BITS_1_TO_0_161_ETC___d1210,
       ...
       _dfoo5,
       bml_crdBuf_value_867_EQ_bml_crdBuf_modulus_bw__ETC___d2555,
       bml_fabBuf_value_852_EQ_bml_fabBuf_modulus_bw__ETC___d2556,
       bml_lclBufDone_909_AND_IF_bml_dpControl_wget___ETC___d2651,
       bml_lclBuf_value_822_EQ_bml_lclBuf_modulus_bw__ETC___d2571,
       bml_remBuf_value_837_EQ_bml_remBuf_modulus_bw__ETC___d2572,
       bram_serverAdapterA_1_cnt_44_SLT_3___d2470,
       bram_serverAdapterA_1_outDataCore_notEmpty__20_ETC___d1488,
       bram_serverAdapterA_2_cnt_62_SLT_3___d2471,
       bram_serverAdapterA_3_cnt_80_SLT_3___d2472,
       bram_serverAdapterA_3_outDataCore_notEmpty__56_ETC___d1486,
       bram_serverAdapterA_cnt_6_SLT_3___d2469,
       ...
       tlp_dmaPullRemainDWLen_007_ULE_tlp_dmaPullRema_ETC___d2466,
       tlp_dmaPullRemainDWSub_021_ULE_4___d2467,
       ...
       tlp_mRespF_first__69_BITS_71_TO_62_66_ULE_1___d2594,
       tlp_outDwRemain_89_ULE_4___d2311,
       tlp_rdRespDwRemain_478_ULE_4___d1479,
       tlp_readRemainDWLen_334_ULE_4___d1335,
       tlp_writeRemainDWLen_164_ULE_1___d2596,
       tlp_writeRemainDWLen_164_ULE_2___d2597,
       tlp_writeRemainDWLen_164_ULE_3___d2598,
       wmi_dpControl_whas__664_AND_bram_serverAdapter_ETC___d1710,
       wmi_wmi_operateD_617_AND_wmi_wmi_peerIsReady_6_ETC___d1774;
  ...
  assign MUX_bram_memory_1$a_put_1__SEL_3 =
	     WILL_FIRE_RL_tlp_writeData &&
	     IF_1_MINUS_tlp_writeDWAddr_160_BITS_1_TO_0_161_ETC___d2647 ;
  assign MUX_bram_memory_1$a_put_3__SEL_1 =
  ...
  assign MUX_bml_fabBufsAvail$write_1__VAL_1 =
	     (bml_fabAvail && !bml_remStart) ? x__h75984 : x__h75989 ;
  assign MUX_bml_fabBufsAvail$write_1__VAL_2 =
	     (dpControl[3:2] == 2'd1) ? x__h74741 : 16'd0 ;
  assign MUX_bml_fabFlowAddr$write_1__VAL_1 =
	     bml_fabBuf_value_852_EQ_bml_fabBuf_modulus_bw__ETC___d2556 ?
	       bml_fabFlowBase :
	       bml_fabFlowAddr_924_PLUS_bml_fabFlowSize_925___d2465 ;
  ...
  assign MUX_bml_lclCredit$write_1__VAL_1 =
	     (bml_lclBufDone && !bml_remStart) ? x__h76022 : x__h76027 ;
  ...
  assign MUX_bram_memory$a_put_3__VAL_3 =
	     { IF_0_MINUS_tlp_writeDWAddr_160_BITS_1_TO_0_161_ETC___d2241[7:0],
	       IF_0_MINUS_tlp_writeDWAddr_160_BITS_1_TO_0_161_ETC___d2241[15:8],
	       IF_0_MINUS_tlp_writeDWAddr_160_BITS_1_TO_0_161_ETC___d2241[23:16],
	       IF_0_MINUS_tlp_writeDWAddr_160_BITS_1_TO_0_161_ETC___d2241[31:24] } ;
  always@(idx__h47357 or
	  tlp_writeDWAddr_PLUS_3__q8 or
	  tlp_writeDWAddr or
	  tlp_writeDWAddr_PLUS_1__q9 or tlp_writeDWAddr_PLUS_2__q10)
  begin
  ...
  assign MUX_bram_memory_1$a_put_3__VAL_3 =
	     { IF_1_MINUS_tlp_writeDWAddr_160_BITS_1_TO_0_161_ETC___d2242[7:0],
	       IF_1_MINUS_tlp_writeDWAddr_160_BITS_1_TO_0_161_ETC___d2242[15:8],
	       IF_1_MINUS_tlp_writeDWAddr_160_BITS_1_TO_0_161_ETC___d2242[23:16],
	       IF_1_MINUS_tlp_writeDWAddr_160_BITS_1_TO_0_161_ETC___d2242[31:24] } ;
  always@(idx__h48661 or
	  tlp_writeDWAddr_PLUS_3__q8 or
	  tlp_writeDWAddr or
	  tlp_writeDWAddr_PLUS_1__q9 or tlp_writeDWAddr_PLUS_2__q10)
  begin
  ...
  assign MUX_bram_memory_2$a_put_3__VAL_3 =
	     { IF_2_MINUS_tlp_writeDWAddr_160_BITS_1_TO_0_161_ETC___d2243[7:0],
	       IF_2_MINUS_tlp_writeDWAddr_160_BITS_1_TO_0_161_ETC___d2243[15:8],
	       IF_2_MINUS_tlp_writeDWAddr_160_BITS_1_TO_0_161_ETC___d2243[23:16],
	       IF_2_MINUS_tlp_writeDWAddr_160_BITS_1_TO_0_161_ETC___d2243[31:24] } ;
  always@(idx__h49965 or
	  tlp_writeDWAddr_PLUS_3__q8 or
	  tlp_writeDWAddr or
	  tlp_writeDWAddr_PLUS_1__q9 or tlp_writeDWAddr_PLUS_2__q10)
  begin
  ...
  assign MUX_bram_memory_3$a_put_3__VAL_3 =
	     { IF_3_MINUS_tlp_writeDWAddr_160_BITS_1_TO_0_161_ETC___d2244[7:0],
	       IF_3_MINUS_tlp_writeDWAddr_160_BITS_1_TO_0_161_ETC___d2244[15:8],
	       IF_3_MINUS_tlp_writeDWAddr_160_BITS_1_TO_0_161_ETC___d2244[23:16],
	       IF_3_MINUS_tlp_writeDWAddr_160_BITS_1_TO_0_161_ETC___d2244[31:24] } ;
  ...
  assign MUX_tlp_fabMesgAccu$write_1__VAL_2 = tlp_fabMesgAccu + y__h27318 ;
  assign MUX_tlp_fabMesgAccu$write_1__VAL_3 = tlp_fabMesgAccu + y__h39176 ;
  ...
  assign MUX_tlp_mReqF$enq_1__VAL_3 =
	     { 88'hAAAAAAAAAAAAAAAAAAFFF8,
	       ...
	       thisRequestLength__h26766[11:2],
	       8'd255,
	       rreq_tag__h26980,
	       3'h2 } ;
  ...
  assign MUX_tlp_mesgComplReceived$write_1__VAL_2 =
	     tlp_mesgComplReceived + y__h40444 ;
  ...
  assign MUX_tlp_mesgLengthRemainPull$write_1__VAL_3 =
	     tlp_mesgLengthRemainPull - y__h39105 ;
  ...
  assign MUX_tlp_mesgLengthRemainPush$write_1__VAL_3 =
	     tlp_mesgLengthRemainPush - y__h26791 ;
  ...
  assign MUX_tlp_outF$enq_1__VAL_1 =
	     { 1'd1,
	       ...
	       23'd196607,
	       w_data__h27166 } ;
  assign MUX_tlp_outF$enq_1__VAL_2 = { 25'd16973823, w_data__h28147 } ;
  assign MUX_tlp_outF$enq_1__VAL_3 = { 25'd8585200, w_data__h29217 } ;
  assign MUX_tlp_outF$enq_1__VAL_4 = { 25'd25362416, w_data__h32354 } ;
  assign MUX_tlp_outF$enq_1__VAL_5 = { 25'd25362416, w_data__h39361 } ;
  assign MUX_tlp_outF$enq_1__VAL_6 = { 25'd25296895, w_data__h40876 } ;
  ...
  assign MUX_tlp_remMesgAccu$write_1__VAL_2 = tlp_remMesgAccu + y__h26933 ;
  assign MUX_tlp_remMesgAccu$write_1__VAL_3 = tlp_remMesgAccu + y__h39739 ;
  assign MUX_tlp_reqMesgInFlight$write_1__VAL_2 =
	     !tlp_dmaPullRemainDWSub_021_ULE_4___d2467 ||
	     !tlp_dmaPullRemainDWLen_007_ULE_tlp_dmaPullRema_ETC___d2466 ;
  assign MUX_tlp_srcMesgAccu$write_1__VAL_2 = tlp_srcMesgAccu + y__h26885 ;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, _theResult____h77512 } ;
  assign MUX_wmi_addr$write_1__VAL_1 = wmi_addr + 14'd32 ;
  assign MUX_wmi_bufDwell$write_1__VAL_3 = wmi_bufDwell - 2'd1 ;
  assign MUX_wmi_bytesRemainReq$write_1__VAL_1 = wmi_bytesRemainReq - 14'd32 ;
  ...
  assign MUX_wmi_mesgMeta$write_1__VAL_2 =
	     { 1'd1, x__h68391, x__h68392, x__h68393, x__h68394 } ;
  ...
  assign bram_serverAdapterB_outData_enqData$whas =
	     ...
	     bram_serverAdapterB_s1[0] ;
  assign bram_serverAdapterB_outData_outData$wget = x__h68391 ;
  ...
  assign bram_serverAdapterB_cnt_2$whas = WILL_FIRE_RL_wmi_respMetadata ;
  ...
  assign bram_serverAdapterB_1_outData_enqData$whas =
	     ...
	     bram_serverAdapterB_1_s1[0] ;
  assign bram_serverAdapterB_1_outData_outData$wget = x__h68392 ;
  ...
  assign bram_serverAdapterB_1_cnt_2$whas = WILL_FIRE_RL_wmi_respMetadata ;
  ...
  assign bram_serverAdapterB_2_outData_enqData$whas =
	     ...
	     bram_serverAdapterB_2_s1[0] ;
  assign bram_serverAdapterB_2_outData_outData$wget = x__h68393 ;
  ...
  assign bram_serverAdapterB_2_cnt_2$whas = WILL_FIRE_RL_wmi_respMetadata ;
  ...
  assign bram_serverAdapterB_3_outData_enqData$whas =
	     ...
	     bram_serverAdapterB_3_s1[0] ;
  assign bram_serverAdapterB_3_outData_outData$wget = x__h68394 ;
  ...
  assign bram_serverAdapterB_3_cnt_2$whas = WILL_FIRE_RL_wmi_respMetadata ;
  ...
  assign tlp_pullTagMatch_1$wget =
	     tagm__h39532 == tlp_inF$D_OUT[47:40] &&
	     tlp_inF_first__00_BITS_63_TO_56_03_EQ_pciDevic_ETC___d913 ;
  ...
  assign bram_serverAdapterB_cnt$EN =
	     bram_serverAdapterB_cnt_1$whas || WILL_FIRE_RL_wmi_respMetadata ;
  ...
  begin
    case (1'b1) // synopsys parallel_case
      WILL_FIRE_RL_tlp_dmaPullRequestFarMesg:
	  tlp_dmaPullRemainDWLen$D_IN = thisRequestLength__h39080[11:2];
      WILL_FIRE_RL_tlp_dmaPullResponseHeader:
  ...
  always@(WILL_FIRE_RL_tlp_dmaPullResponseHeader or
	  tlp_inF$D_OUT or
	  WILL_FIRE_RL_tlp_dmaPullResponseBody or
	  tlp_dmaPullRemainDWSub_021_ULE_4___d2467 or
	  WILL_FIRE_RL_tlp_dmaPullRequestFarMesg)
  begin
    case (1'b1) // synopsys parallel_case
      WILL_FIRE_RL_tlp_dmaPullResponseHeader:
  ...
  begin
    case (1'b1) // synopsys parallel_case
      ...
      WILL_FIRE_RL_tlp_dmaPullResponseBody:
	  tlp_tlpRcvBusy$D_IN = !tlp_dmaPullRemainDWSub_021_ULE_4___d2467;
  ...
  assign wmi_wmi_respF_c_r$EN = wmi_wmi_respF_c_r != 2'd0 ;

  // register wmi_wmi_respF_q_0
  assign wmi_wmi_respF_q_0$D_IN = wmi_wmi_respF_q_1 ;
  assign wmi_wmi_respF_q_0$EN = wmi_wmi_respF_c_r != 2'd0 ;

  // register wmi_wmi_respF_q_1
  assign wmi_wmi_respF_q_1$D_IN = 258'd0 ;
  assign wmi_wmi_respF_q_1$EN = wmi_wmi_respF_c_r != 2'd0 ;

  // register wmi_wmi_sFlagReg
  assign wmi_wmi_sFlagReg$D_IN = { x__h68392[7:0], x__h68391[23:0] } ;
  ...
  assign bram_memory$DIB = WILL_FIRE_RL_wmi_reqMetadata ? 32'd0 : x3__h69790 ;
  ...
  // submodule bram_memory_1
  always@(MUX_bram_memory_1$a_put_3__SEL_1 or
	  tlp_mReqF$D_OUT or
  ...
  assign bram_memory_1$DIB =
	     WILL_FIRE_RL_wmi_reqMetadata ? 32'd0 : mesgMeta_opcode__h69830 ;
  ...
  assign bram_memory_1$ENA =
	     ...
	     IF_1_MINUS_tlp_writeDWAddr_160_BITS_1_TO_0_161_ETC___d2647 ||
	     WILL_FIRE_RL_tlp_read_NextReq ;
  assign bram_memory_1$ENB = bram_serverAdapterB_writeWithResp$whas ;
  ...
  assign bram_memory_2$ENA =
	     ...
	     IF_2_MINUS_tlp_writeDWAddr_160_BITS_1_TO_0_161_ETC___d2648 ||
	     WILL_FIRE_RL_tlp_read_NextReq ;
  assign bram_memory_2$ENB = bram_serverAdapterB_writeWithResp$whas ;
  ...
  assign bram_memory_3$ENA =
	     ...
	     IF_3_MINUS_tlp_writeDWAddr_160_BITS_1_TO_0_161_ETC___d2649 ||
	     WILL_FIRE_RL_tlp_read_NextReq ;
  assign bram_memory_3$ENB = bram_serverAdapterB_writeWithResp$whas ;
  ...
  assign IF_tlp_readReq_first__394_BITS_30_TO_29_395_PL_ETC___d1529 =
	     tlp_readReq_first__394_BITS_30_TO_29_395_PLUS_1___d2592[0] ?
	       { bram_serverAdapterA_3_outData_outData$wget[7:0],
		 bram_serverAdapterA_3_outData_outData$wget[15:8],
		 bram_serverAdapterA_3_outData_outData$wget[23:16],
		 bram_serverAdapterA_3_outData_outData$wget[31:24],
  ...
  assign ab__h10380 =
	     (MUX_bram_memory_3$a_put_1__SEL_2 ||
	      WILL_FIRE_RL_tlp_read_NextReq) ?
	       2'd0 :
	       2'd2 ;
  assign ab__h11777 = WILL_FIRE_RL_wmi_reqMetadata ? 2'd0 : 2'd2 ;
  assign ab__h1597 =
	     (MUX_bram_memory$a_put_1__SEL_2 ||
	      WILL_FIRE_RL_tlp_read_NextReq) ?
	       2'd0 :
	       2'd2 ;
  assign ab__h2996 = WILL_FIRE_RL_wmi_reqMetadata ? 2'd0 : 2'd2 ;
  assign ab__h4526 =
	     (MUX_bram_memory_1$a_put_1__SEL_2 ||
	      WILL_FIRE_RL_tlp_read_NextReq) ?
	       2'd0 :
	       2'd2 ;
  assign ab__h5923 = WILL_FIRE_RL_wmi_reqMetadata ? 2'd0 : 2'd2 ;
  assign ab__h7453 =
	     (MUX_bram_memory_2$a_put_1__SEL_2 ||
	      WILL_FIRE_RL_tlp_read_NextReq) ?
	       2'd0 :
	       2'd2 ;
  assign ab__h8850 = WILL_FIRE_RL_wmi_reqMetadata ? 2'd0 : 2'd2 ;
  assign bml_crdBuf_value_867_EQ_bml_crdBuf_modulus_bw__ETC___d2555 =
	     bml_crdBuf_value == bml_crdBuf_modulus ;
  assign bml_fabBuf_value_852_EQ_bml_fabBuf_modulus_bw__ETC___d2556 =
	     bml_fabBuf_value == bml_fabBuf_modulus ;
  assign bml_fabFlowAddr_924_PLUS_bml_fabFlowSize_925___d2465 =
	     bml_fabFlowAddr + bml_fabFlowSize ;
  assign bml_lclBufDone_909_AND_IF_bml_dpControl_wget___ETC___d2651 =
	     bml_lclBufDone &&
	     CASE_dpControl_BITS_1_TO_0_NOT_bml_fabDone_0_N_ETC__q6 ;
  assign bml_lclBuf_value_822_EQ_bml_lclBuf_modulus_bw__ETC___d2571 =
	     bml_lclBuf_value == bml_lclBuf_modulus ;
  assign bml_remBuf_value_837_EQ_bml_remBuf_modulus_bw__ETC___d2572 =
  ...
  assign bram_serverAdapterA_1_cnt_44_SLT_3___d2470 =
  ...
  assign bram_serverAdapterA_2_cnt_62_SLT_3___d2471 =
  ...
  assign bram_serverAdapterA_3_cnt_80_SLT_3___d2472 =
  ...
  assign bram_serverAdapterA_cnt_6_SLT_3___d2469 =
  ...
  assign bram_serverAdapterB_1_cnt_03_PLUS_IF_bram_serv_ETC___d209 =
	     ...
	     (WILL_FIRE_RL_wmi_respMetadata ? 3'd7 : 3'd0) ;
  ...
  assign byteCount__h54337 = x__h54448 - y__h54449 ;
  ...
  assign hasPush_AND_tlp_dpControl_wget__34_BITS_3_TO_2_ETC___d815 =
	     ...
	     tlp_xmtMetaOK &&
	     tlp_postSeqDwell == 4'd0 ;
  assign idx__h45126 = 2'd0 - tlp_writeDWAddr[1:0] ;
  assign idx__h47357 = 2'd1 - tlp_writeDWAddr[1:0] ;
  assign idx__h48661 = 2'd2 - tlp_writeDWAddr[1:0] ;
  assign idx__h49965 = 2'd3 - tlp_writeDWAddr[1:0] ;
  assign idx__h52221 = 2'd0 - tlp_readNxtDWAddr[1:0] ;
  assign idx__h52689 = 2'd1 - tlp_readNxtDWAddr[1:0] ;
  assign idx__h53062 = 2'd2 - tlp_readNxtDWAddr[1:0] ;
  assign idx__h53435 = 2'd3 - tlp_readNxtDWAddr[1:0] ;
  assign lastBE__h27190 =
	     tlp_mRespF_first__69_BITS_71_TO_62_66_ULE_1___d2594 ?
	       4'd0 :
	       4'd15 ;
  assign lastBE__h39382 =
	     (thisRequestLength__h39080[11:2] == 10'd1) ? 4'd0 : 4'd15 ;
  assign lowAddr__h54336 = { tlp_readReq$D_OUT[33:29], lowAddr10__h54335 } ;
  assign mesgMeta_opcode__h69830 =
	     { 24'h800000, wmi_wmi_mFlagF$D_OUT[31:24] } ;
  assign nowLS__h25519 =
	     { tlp_mRespF$D_OUT[39:32],
	       tlp_mRespF$D_OUT[47:40],
	       tlp_mRespF$D_OUT[55:48],
	       tlp_mRespF$D_OUT[63:56] } ;
  assign nowLS__h37829 =
	     { tlp_inF$D_OUT[39:32],
	       tlp_inF$D_OUT[47:40],
	       tlp_inF$D_OUT[55:48],
	       tlp_inF$D_OUT[63:56] } ;
  assign nowMS__h24576 =
	     { tlp_mRespF$D_OUT[71:64],
	       tlp_mRespF$D_OUT[79:72],
	       tlp_mRespF$D_OUT[87:80],
	       tlp_mRespF$D_OUT[95:88] } ;
  assign nowMS__h36888 =
	     { tlp_inF$D_OUT[71:64],
	       tlp_inF$D_OUT[79:72],
	       tlp_inF$D_OUT[87:80],
	       tlp_inF$D_OUT[95:88] } ;
  assign opcode__h23345 =
	     { tlp_mRespF$D_OUT[103:96],
	       tlp_mRespF$D_OUT[111:104],
	       tlp_mRespF$D_OUT[119:112],
	       tlp_mRespF$D_OUT[127:120] } ;
  assign opcode__h35668 =
  ...
  assign rdat__h77591 = { 16'd0, bml_lclNumBufs } ;
  assign rdat__h77599 = { 16'd0, bml_fabNumBufs } ;
  assign rdat__h77607 = { 16'd0, bml_mesgBase } ;
  assign rdat__h77615 = { 16'd0, bml_metaBase } ;
  assign rdat__h77623 = { 16'd0, bml_mesgSize } ;
  assign rdat__h77631 = { 16'd0, bml_metaSize } ;
  assign rdat__h77639 = { 16'd0, bml_lclBufsCF } ;
  assign rdat__h77660 = { bml_lclBufsAR, bml_fabBufsAvail } ;
  assign rdat__h77665 = { bml_remBuf_value, bml_lclBuf_value } ;
  assign rdat__h77676 = { bml_lclStarts, bml_lclDones } ;
  assign rdat__h77681 = { bml_remStarts, bml_remDones } ;
  assign rdat__h77998 = { wmi_reqCount, wmi_wrtCount } ;
  assign rdat__h78152 = { 28'd0, dpControl } ;
  assign rdat__h78177 =
	     { 4'h0,
	       tlp_complTimerCount,
	       12'h0,
	       CASE_tlp_lastRuleFired_8_1_tlp_lastRuleFired_2_ETC__q1 } ;
  assign rdata__h59754 =
	     tlp_readReq_first__394_BITS_30_TO_29_395_PLUS_1___d2592[1] ?
	       IF_tlp_readReq_first__394_BITS_30_TO_29_395_PL_ETC___d1529 :
	       IF_tlp_readReq_first__394_BITS_30_TO_29_395_PL_ETC___d1534 ;
  assign rreq_tag__h26980 =
	     (y__h26791 == tlp_mesgLengthRemainPush) ? 8'h01 : 8'h0 ;
  assign rresp_data__h54379 =
	     { IF_tlp_readReq_first__394_BITS_30_TO_29_395_EQ_ETC___d2245[7:0],
	       IF_tlp_readReq_first__394_BITS_30_TO_29_395_EQ_ETC___d2245[15:8],
	       IF_tlp_readReq_first__394_BITS_30_TO_29_395_EQ_ETC___d2245[23:16],
	       IF_tlp_readReq_first__394_BITS_30_TO_29_395_EQ_ETC___d2245[31:24] } ;
  assign spanToNextPage__h26765 = 13'd4096 - { 1'd0, tlp_srcMesgAccu[11:0] } ;
  assign spanToNextPage__h39079 = 13'd4096 - { 1'd0, tlp_fabMesgAccu[11:0] } ;
  assign tag__h39355 = { 3'd0, tlp_dmaTag } ;
  assign tagm__h39532 = { 3'd0, tlp_dmaReqTag } ;
  assign thisRequestLength__h26766 =
	     (x__h26804[12:0] <= spanToNextPage__h26765) ?
	       x__h26804[12:0] :
	       spanToNextPage__h26765 ;
  assign thisRequestLength__h39080 =
	     (x__h39113[12:0] <= spanToNextPage__h39079) ?
	       x__h39113[12:0] :
	       spanToNextPage__h39079 ;
  assign tlp_dmaPullRemainDWLen_007_ULE_tlp_dmaPullRema_ETC___d2466 =
	     tlp_dmaPullRemainDWLen <= tlp_dmaPullRemainDWSub ;
  assign tlp_dmaPullRemainDWSub_021_ULE_4___d2467 =
	     tlp_dmaPullRemainDWSub <= 10'd4 ;
  ...
  assign tlp_mReqF_RDY_first__127_AND_IF_tlp_mReqF_firs_ETC___d1143 =
	     tlp_mReqF$EMPTY_N &&
	     CASE_tlp_mReqFD_OUT_BITS_51_TO_50_NOT_tlp_mRe_ETC__q4 ;
  assign tlp_mRespF_first__69_BITS_71_TO_62_66_ULE_1___d2594 =
	     tlp_mRespF$D_OUT[71:62] <= 10'd1 ;
  ...
  assign tlp_outDwRemain_89_ULE_4___d2311 = tlp_outDwRemain <= 10'd4 ;
  ...
  assign tlp_readRemainDWLen_334_ULE_4___d1335 =
	     tlp_readRemainDWLen <= 10'd4 ;
  assign tlp_readReq_first__394_BITS_30_TO_29_395_PLUS_1___d2592 =
	     tlp_readReq$D_OUT[30:29] + 2'd1 ;
  ...
  assign tlp_writeRemainDWLen_164_ULE_1___d2596 =
	     tlp_writeRemainDWLen <= 10'd1 ;
  assign tlp_writeRemainDWLen_164_ULE_2___d2597 =
	     tlp_writeRemainDWLen <= 10'd2 ;
  assign tlp_writeRemainDWLen_164_ULE_3___d2598 =
	     tlp_writeRemainDWLen <= 10'd3 ;
  assign w_be__h27716 =
	     tlp_outDwRemain_89_ULE_4___d2311 ?
	       CASE_tlp_outDwRemain_BITS_1_TO_0_0xFFF0_0b0_0x_ETC__q3 :
	       16'd65535 ;
  assign w_data__h27166 =
	     { 22'd1048576,
	       tlp_mRespF$D_OUT[71:62],
	       pciDevice,
	       8'd0,
  ...
  assign w_data__h32354 =
	     { 32'd4,
	       ...
	       34'd0 } ;
  assign w_data__h39361 =
	     { 22'd0,
	       thisRequestLength__h39080[11:2],
	       pciDevice,
	       tag__h39355,
	       lastBE__h39382,
	       4'd15,
  ...
  assign wmi_dpControl_whas__664_AND_bram_serverAdapter_ETC___d1710 =
	     ...
	     (bram_serverAdapterB_1_outDataCore$EMPTY_N ||
	      bram_serverAdapterB_1_outData_enqData$whas) &&
	     bram_serverAdapterB_1_outData_outData_whas__69_ETC___d1706 ;
  assign wmi_wmi_operateD_617_AND_wmi_wmi_peerIsReady_6_ETC___d1774 =
	     wmi_wmi_operateD && wmi_wmi_peerIsReady &&
	     bram_serverAdapterB_cnt_5_SLT_3___d1677 &&
	     bram_serverAdapterB_1_cnt_03_SLT_3___d1678 &&
	     bram_serverAdapterB_2_cnt_21_SLT_3___d1679 &&
	     bram_serverAdapterB_3_cnt_39_SLT_3___d1680 &&
	     wmi_wmi_mFlagF$EMPTY_N ;
  assign x3__h69790 = { 8'd0, wmi_wmi_mFlagF$D_OUT[23:0] } ;
  assign x__h21517 =
	     { tlp_mRespF$D_OUT[7:0],
	       tlp_mRespF$D_OUT[15:8],
	       tlp_mRespF$D_OUT[23:16],
	       tlp_mRespF$D_OUT[31:24] } ;
  assign x__h26522 = { 15'd0, tlp_mesgLengthRemainPush } ;
  assign x__h26804 =
	     (tlp_mesgLengthRemainPush <= y__h26806) ?
  ...
  assign x__h33642 =
	     { tlp_inF$D_OUT[7:0],
	       ...
	       tlp_inF$D_OUT[23:16],
	       tlp_inF$D_OUT[31:24] } ;
  assign x__h38799 = { 15'd0, tlp_mesgLengthRemainPull } ;
  assign x__h39113 =
	     (tlp_mesgLengthRemainPull <= y__h39115) ?
	       tlp_mesgLengthRemainPull :
	       y__h39115 ;
  assign x__h54448 = x__h54450 - y__h54451 ;
  assign x__h54450 = { tlp_readReq$D_OUT[28:19], 2'b0 } ;
  assign x__h68391 =
	     bram_serverAdapterB_outDataCore$EMPTY_N ?
	       bram_serverAdapterB_outDataCore$D_OUT :
	       bram_memory$DOB ;
  ...
  assign x__h68394 =
	     bram_serverAdapterB_3_outDataCore$EMPTY_N ?
	       bram_serverAdapterB_3_outDataCore$D_OUT :
	       bram_memory_3$DOB ;
  assign x__h74741 = (dpControl[1:0] == 2'd1) ? bml_fabNumBufs : 16'd0 ;
  assign x__h75865 = bml_lclBufsAR + 16'd1 ;
  assign x__h75870 = bml_lclBufsAR - 16'd1 ;
  assign x__h75942 = bml_lclBufsCF + 16'd1 ;
  assign x__h75947 = bml_lclBufsCF - 16'd1 ;
  assign x__h75984 = bml_fabBufsAvail + 16'd1 ;
  assign x__h75989 = bml_fabBufsAvail - 16'd1 ;
  assign x__h76022 = bml_lclCredit + 16'd1 ;
  assign x__h76027 = bml_lclCredit - 16'd1 ;
  assign y__h26791 = { 4'd0, thisRequestLength__h26766 } ;
  assign y__h26806 = { 4'd0, tlp_maxPayloadSize } ;
  assign y__h26885 = { 19'd0, thisRequestLength__h26766 } ;
  assign y__h26933 = { 3'd0, thisRequestLength__h26766 } ;
  assign y__h27318 = { 20'd0, tlp_mRespF$D_OUT[71:62], 2'd0 } ;
  assign y__h39105 = { 4'd0, thisRequestLength__h39080 } ;
  assign y__h39115 = { 4'd0, tlp_maxReadReqSize } ;
  assign y__h39176 = { 19'd0, thisRequestLength__h39080 } ;
  assign y__h39739 = { 4'd0, tlp_inF$D_OUT[105:96], 2'd0 } ;
  assign y__h40444 =
	     tlp_dmaPullRemainDWSub_021_ULE_4___d2467 ?
  ...
  assign y__h54449 =
	     (tlp_readReq$D_OUT[28:19] == 10'd1) ?
	       12'd0 :
	       { 10'd0, x__h54480 } ;
  assign y__h54451 = { 10'd0, x__h54457 } ;
  always@(tlp_readReq$D_OUT)
  begin
    case (tlp_readReq$D_OUT[18:15])
      4'b1100: x__h54457 = 2'b10;
      4'b1110: x__h54457 = 2'b01;
      4'b1111: x__h54457 = 2'b0;
      default: x__h54457 = 2'b11;
    endcase
  end
  always@(tlp_readReq$D_OUT)
  begin
    case (tlp_readReq$D_OUT[14:11])
      4'b1100: x__h54480 = 2'b10;
      4'b1110: x__h54480 = 2'b01;
      4'b1111: x__h54480 = 2'b0;
      default: x__h54480 = 2'b11;
    endcase
  end
  ...
  begin
    case (tlp_readReq$D_OUT[18:15])
      4'b1000: lowAddr10__h54335 = 2'b11;
      4'b1100: lowAddr10__h54335 = 2'b10;
      4'b1110: lowAddr10__h54335 = 2'b01;
      default: lowAddr10__h54335 = 2'b0;
    endcase
  end
  ...
  begin
    case (wci_reqF$D_OUT[39:32])
      8'h0: _theResult____h77512 = rdat__h77591;
      8'h04: _theResult____h77512 = rdat__h77599;
      8'h08: _theResult____h77512 = rdat__h77607;
      8'h0C: _theResult____h77512 = rdat__h77615;
      8'h10: _theResult____h77512 = rdat__h77623;
      8'h14: _theResult____h77512 = rdat__h77631;
      8'h20: _theResult____h77512 = rdat__h77639;
      8'h24: _theResult____h77512 = 32'hF00DFACE;
      8'h28: _theResult____h77512 = rdat__h77660;
      8'h2C: _theResult____h77512 = rdat__h77665;
      8'h30: _theResult____h77512 = rdat__h77676;
      8'h34: _theResult____h77512 = rdat__h77681;
      8'h38: _theResult____h77512 = wmi_thisMesg;
      8'h3C: _theResult____h77512 = wmi_lastMesg;
      8'h40: _theResult____h77512 = rdat__h77998;
      8'h44: _theResult____h77512 = 32'h0;
      8'h48: _theResult____h77512 = 32'hDADEBABE;
      8'h4C: _theResult____h77512 = 32'h00008000;
      8'h50: _theResult____h77512 = bml_fabMesgBase;
      8'h54: _theResult____h77512 = bml_fabMetaBase;
      8'h58: _theResult____h77512 = bml_fabMesgSize;
      8'h5C: _theResult____h77512 = bml_fabMetaSize;
      8'h60: _theResult____h77512 = bml_fabFlowBase;
      8'h64: _theResult____h77512 = bml_fabFlowSize;
      8'h68: _theResult____h77512 = rdat__h78152;
      8'h6C: _theResult____h77512 = tlp_flowDiagCount;
      8'h70: _theResult____h77512 = rdat__h78177;
      8'h80: _theResult____h77512 = tlp_lastMetaV;
      8'h84: _theResult____h77512 = tlp_lastMetaV_1;
      8'h88: _theResult____h77512 = tlp_lastMetaV_2;
      8'h8C: _theResult____h77512 = tlp_lastMetaV_3;
      8'h90: _theResult____h77512 = 32'hC0DE0111;
      default: _theResult____h77512 = 32'd0;
    endcase
  end
  ...
  always@(idx__h45126 or
	  tlp_writeRemainDWLen_164_ULE_3___d2598 or
	  tlp_writeRemainDWLen or
	  tlp_writeRemainDWLen_164_ULE_1___d2596 or
	  tlp_writeRemainDWLen_164_ULE_2___d2597)
  begin
    case (idx__h45126)
      2'd0:
  ...
  always@(tlp_mReqF$D_OUT or
	  bram_serverAdapterA_3_cnt_80_SLT_3___d2472 or
	  bram_serverAdapterA_cnt_6_SLT_3___d2469 or
	  bram_serverAdapterA_1_cnt_44_SLT_3___d2470 or
	  bram_serverAdapterA_2_cnt_62_SLT_3___d2471)
  begin
  ...
  always@(idx__h45126 or tlp_mReqF$D_OUT)
  begin
    case (idx__h45126)
      2'd0:
	  IF_0_MINUS_tlp_writeDWAddr_160_BITS_1_TO_0_161_ETC___d2241 =
  ...
  always@(idx__h47357 or tlp_mReqF$D_OUT)
  begin
    case (idx__h47357)
      2'd0:
	  IF_1_MINUS_tlp_writeDWAddr_160_BITS_1_TO_0_161_ETC___d2242 =
  ...
  always@(idx__h48661 or tlp_mReqF$D_OUT)
  begin
    case (idx__h48661)
      2'd0:
	  IF_2_MINUS_tlp_writeDWAddr_160_BITS_1_TO_0_161_ETC___d2243 =
  ...
  always@(idx__h49965 or tlp_mReqF$D_OUT)
  begin
    case (idx__h49965)
      2'd0:
	  IF_3_MINUS_tlp_writeDWAddr_160_BITS_1_TO_0_161_ETC___d2244 =
  ...
  begin
	...
	wmi_wmi_respF_q_0 <= `BSV_ASSIGNMENT_DELAY 258'd0;
	wmi_wmi_respF_q_1 <= `BSV_ASSIGNMENT_DELAY 258'd0;
  ...
  begin
    ...
    if (RST_N)
      if (WILL_FIRE_RL_tlp_dmaXmtMetaHead)
	$display("[%0d]: %m: dmaXmtMetaHead FPactMesg-Step5/7", v__h29048);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_tlp_dmaXmtTailEvent)
	$display("[%0d]: %m: dmaXmtTailEvent FPactMesg-Step7/7", v__h31927);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_tlp_dmaXmtMetaBody)
	$display("[%0d]: %m: dmaXmtMetaBody FPactMesg-Step6/7", v__h31807);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_tlp_dmaXmtDoorbell)
	$display("[%0d]: %m: dmaXmtDoorbell FC/FPactFlow-Step1/1", v__h32096);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_tlp_dmaPullTailEvent)
	$display("[%0d]: %m: dmaPullTailEvent FPactMesg-Step5/5", v__h40652);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_tlp_dmaTailEventSender)
	$display("[%0d]: %m: dmaTailEventSender - generic", v__h41777);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_tlp_dmaRequestFarMeta)
	$display("[%0d]: %m: dmaRequestFarMeta FCactMesg-Step1/5", v__h32487);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_wci_cfwr && wci_reqF$D_OUT[39:32] == 8'h18)
	$display("[%0d] %m: fabDoneAvail Event", v__h77000);
    if (RST_N)
