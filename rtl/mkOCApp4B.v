...
//
// On Mon Jan 16 17:01:15 EST 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkOCApp4B(RST_N_rst_0,
  ...
  wire [31 : 0] _0x81_CONCAT_IF_IF_wsisMonW3_pmsender_evF_first_ETC___d1438,
		...
		y_avValue__h98590,
		y_avValue__h98630;
  wire [13 : 0] mlB__h23464,
		mlB__h59550,
		mlB__h95635,
		mlInc__h23463,
		mlInc__h59549,
		mlInc__h95634;
  wire [11 : 0] x_burstLength__h34212, x_burstLength__h70303;
  ...
  assign captWorker0_mesgLengthSoFar$D_IN =
	     captWorker0_wsiS_reqFifo$D_OUT[57] ? 14'd0 : mlB__h23464 ;
  ...
  assign captWorker1_mesgLengthSoFar$D_IN =
	     captWorker1_wsiS_reqFifo$D_OUT[57] ? 14'd0 : mlB__h59550 ;
  ...
  assign captWorker2_mesgLengthSoFar$D_IN =
	     captWorker2_wsiS_reqFifo$D_OUT[57] ? 14'd0 : mlB__h95635 ;
  ...
  assign captWorker0_metaBram_memory$DIA = { 18'd0, mlB__h23464 } ;
  ...
  assign captWorker1_metaBram_memory$DIA = { 18'd0, mlB__h59550 } ;
  ...
  assign captWorker2_metaBram_memory$DIA = { 18'd0, mlB__h95635 } ;
  ...
  assign captWorker2_metaBram_serverAdapterB_cnt_706_PL_ETC___d3712 =
		...
		3'd1 :
		3'd0) +
	     (captWorker2_metaBram_serverAdapterB_cnt_2$whas ? 3'd7 : 3'd0) ;
  assign captWorker2_splaF_i_notEmpty__161_AND_IF_captW_ETC___d4194 =
		...
		(captWorker2_splaF$D_OUT[1:0] != 2'd0 ||
		 captWorker2_dataBram_serverAdapterB_outData_outData$whas) :
		IF_captWorker2_splaF_first__162_BITS_1_TO_0_16_ETC___d4192) ;
  assign g_data__h100252 =
	     (captWorker2_wci_wslv_reqF$D_OUT[63:52] == 12'h0) ?
	       v__h99225 :
	       32'd0 ;
  assign g_data__h28081 =
	     (captWorker0_wci_wslv_reqF$D_OUT[63:52] == 12'h0) ?
	       v__h27054 :
	       32'd0 ;
  assign g_data__h64167 =
	     (captWorker1_wci_wslv_reqF$D_OUT[63:52] == 12'h0) ?
	       v__h63140 :
	       32'd0 ;
  assign mlB__h23464 = captWorker0_mesgLengthSoFar + mlInc__h23463 ;
  assign mlB__h59550 = captWorker1_mesgLengthSoFar + mlInc__h59549 ;
  assign mlB__h95635 = captWorker2_mesgLengthSoFar + mlInc__h95634 ;
  assign mlInc__h23463 =
	     captWorker0_wsiS_reqFifo$D_OUT[57] ?
	       { 11'd0, x__h23512 + y__h23513 } :
	       14'd4 ;
  assign mlInc__h59549 =
	     captWorker1_wsiS_reqFifo$D_OUT[57] ?
	       { 11'd0, x__h59598 + y__h59599 } :
	       14'd4 ;
  assign mlInc__h95634 =
	     captWorker2_wsiS_reqFifo$D_OUT[57] ?
	       { 11'd0, x__h95683 + y__h95684 } :
	       14'd4 ;
  assign rdat___1__h27176 = { 24'd0, captWorker0_wsiS_statusR } ;
  assign rdat___1__h63262 = { 24'd0, captWorker1_wsiS_statusR } ;
  assign rdat___1__h99347 = { 24'd0, captWorker2_wsiS_statusR } ;
  assign v__h25668 =
	     captWorker0_splaF$D_OUT[2] ?
	       y_avValue__h26295 :
  ...
  assign wsimMonW3_pmsender_idx_844_EQ_IF_wsimMonW3_pms_ETC___d4428 =
	     wsimMonW3_pmsender_idx == len__h70234 ;
  assign wsisMonW3_pmsender_idx_210_EQ_IF_wsisMonW3_pms_ETC___d4427 =
	     wsisMonW3_pmsender_idx == len__h34143 ;
  assign x__h23512 = x__h23524 + y__h23525 ;
  assign x__h23524 = x__h23536 + y__h23537 ;
  assign x__h23536 = { 2'd0, captWorker0_wsiS_reqFifo$D_OUT[11] } ;
  assign x__h59598 = x__h59610 + y__h59611 ;
  assign x__h59610 = x__h59622 + y__h59623 ;
  assign x__h59622 = { 2'd0, captWorker1_wsiS_reqFifo$D_OUT[11] } ;
  assign x__h95683 = x__h95695 + y__h95696 ;
  assign x__h95695 = x__h95707 + y__h95708 ;
  assign x__h95707 = { 2'd0, captWorker2_wsiS_reqFifo$D_OUT[11] } ;
  assign x_burstLength__h34212 = { 9'd0, len__h34143 } ;
  assign x_burstLength__h70303 = { 9'd0, len__h70234 } ;
  assign y__h23513 = { 2'd0, captWorker0_wsiS_reqFifo$D_OUT[8] } ;
  assign y__h23525 = { 2'd0, captWorker0_wsiS_reqFifo$D_OUT[9] } ;
  assign y__h23537 = { 2'd0, captWorker0_wsiS_reqFifo$D_OUT[10] } ;
  assign y__h59599 = { 2'd0, captWorker1_wsiS_reqFifo$D_OUT[8] } ;
  assign y__h59611 = { 2'd0, captWorker1_wsiS_reqFifo$D_OUT[9] } ;
  assign y__h59623 = { 2'd0, captWorker1_wsiS_reqFifo$D_OUT[10] } ;
  assign y__h95684 = { 2'd0, captWorker2_wsiS_reqFifo$D_OUT[8] } ;
  assign y__h95696 = { 2'd0, captWorker2_wsiS_reqFifo$D_OUT[9] } ;
  assign y__h95708 = { 2'd0, captWorker2_wsiS_reqFifo$D_OUT[10] } ;
  assign y_avValue__h26295 =
	     captWorker0_dataBram_serverAdapterB_outDataCore$EMPTY_N ?
	       captWorker0_dataBram_serverAdapterB_outDataCore$D_OUT :
	       captWorker0_dataBram_memory$DOB ;
  assign y_avValue__h26339 =
	     captWorker0_metaBram_serverAdapterB_outDataCore$EMPTY_N ?
	       captWorker0_metaBram_serverAdapterB_outDataCore$D_OUT :
	       captWorker0_metaBram_memory$DOB ;
  assign y_avValue__h26379 =
	     captWorker0_metaBram_serverAdapterB_1_outDataCore$EMPTY_N ?
	       captWorker0_metaBram_serverAdapterB_1_outDataCore$D_OUT :
	       captWorker0_metaBram_memory_1$DOB ;
  assign y_avValue__h26419 =
	     captWorker0_metaBram_serverAdapterB_2_outDataCore$EMPTY_N ?
	       captWorker0_metaBram_serverAdapterB_2_outDataCore$D_OUT :
	       captWorker0_metaBram_memory_2$DOB ;
  assign y_avValue__h26459 =
	     captWorker0_metaBram_serverAdapterB_3_outDataCore$EMPTY_N ?
	       captWorker0_metaBram_serverAdapterB_3_outDataCore$D_OUT :
	       captWorker0_metaBram_memory_3$DOB ;
  assign y_avValue__h62381 =
	     captWorker1_dataBram_serverAdapterB_outDataCore$EMPTY_N ?
	       captWorker1_dataBram_serverAdapterB_outDataCore$D_OUT :
	       captWorker1_dataBram_memory$DOB ;
  assign y_avValue__h62425 =
	     captWorker1_metaBram_serverAdapterB_outDataCore$EMPTY_N ?
	       captWorker1_metaBram_serverAdapterB_outDataCore$D_OUT :
	       captWorker1_metaBram_memory$DOB ;
  assign y_avValue__h62465 =
	     captWorker1_metaBram_serverAdapterB_1_outDataCore$EMPTY_N ?
	       captWorker1_metaBram_serverAdapterB_1_outDataCore$D_OUT :
	       captWorker1_metaBram_memory_1$DOB ;
  assign y_avValue__h62505 =
	     captWorker1_metaBram_serverAdapterB_2_outDataCore$EMPTY_N ?
	       captWorker1_metaBram_serverAdapterB_2_outDataCore$D_OUT :
	       captWorker1_metaBram_memory_2$DOB ;
  assign y_avValue__h62545 =
	     captWorker1_metaBram_serverAdapterB_3_outDataCore$EMPTY_N ?
	       captWorker1_metaBram_serverAdapterB_3_outDataCore$D_OUT :
	       captWorker1_metaBram_memory_3$DOB ;
  assign y_avValue__h98466 =
	     captWorker2_dataBram_serverAdapterB_outDataCore$EMPTY_N ?
	       captWorker2_dataBram_serverAdapterB_outDataCore$D_OUT :
	       captWorker2_dataBram_memory$DOB ;
  assign y_avValue__h98510 =
	     captWorker2_metaBram_serverAdapterB_outDataCore$EMPTY_N ?
	       captWorker2_metaBram_serverAdapterB_outDataCore$D_OUT :
	       captWorker2_metaBram_memory$DOB ;
  assign y_avValue__h98550 =
	     captWorker2_metaBram_serverAdapterB_1_outDataCore$EMPTY_N ?
	       captWorker2_metaBram_serverAdapterB_1_outDataCore$D_OUT :
	       captWorker2_metaBram_memory_1$DOB ;
  assign y_avValue__h98590 =
	     captWorker2_metaBram_serverAdapterB_2_outDataCore$EMPTY_N ?
	       captWorker2_metaBram_serverAdapterB_2_outDataCore$D_OUT :
	       captWorker2_metaBram_memory_2$DOB ;
  assign y_avValue__h98630 =
	     captWorker2_metaBram_serverAdapterB_3_outDataCore$EMPTY_N ?
	       captWorker2_metaBram_serverAdapterB_3_outDataCore$D_OUT :
	       captWorker2_metaBram_memory_3$DOB ;
  ...
  begin
    case (wsisMonW3_pmsender_evF$D_OUT[98:96])
      3'd0: len__h34143 = 3'd1;
      3'd1: len__h34143 = 3'd2;
      3'd2: len__h34143 = 3'd3;
      default: len__h34143 = 3'd7;
    endcase
  end
  always@(wsimMonW3_pmsender_evF$D_OUT)
  begin
    case (wsimMonW3_pmsender_evF$D_OUT[98:96])
      3'd0: len__h70234 = 3'd1;
      3'd1: len__h70234 = 3'd2;
      3'd2: len__h70234 = 3'd3;
      default: len__h70234 = 3'd7;
    endcase
  end
  always@(wsisMonW3_pmsender_evF$D_OUT)
  begin
  ...
  always@(captWorker0_splaF$D_OUT or
	  y_avValue__h26459 or
	  y_avValue__h26339 or y_avValue__h26379 or y_avValue__h26419)
  begin
  ...
  begin
    case (wsisMonW3_pmsender_idx)
      ...
      default: x_data__h34213 = wsisMonW3_pmsender_evF$D_OUT[31:0];
    endcase
  end
  always@(captWorker1_splaF$D_OUT or
	  y_avValue__h62545 or
	  y_avValue__h62425 or y_avValue__h62465 or y_avValue__h62505)
  begin
  ...
  begin
    case (wsimMonW3_pmsender_idx)
      ...
      default: x_data__h70304 = wsimMonW3_pmsender_evF$D_OUT[31:0];
    endcase
  end
  always@(captWorker2_splaF$D_OUT or
	  y_avValue__h98630 or
	  y_avValue__h98510 or y_avValue__h98550 or y_avValue__h98590)
  begin
  ...
  always@(captWorker0_wci_wslv_reqF$D_OUT or
	  ...
	  rdat___1__h27176 or captWorker0_wsiS_extStatusW$wget)
  begin
    case (captWorker0_wci_wslv_reqF$D_OUT[39:32])
      8'h0: v__h27054 = captWorker0_controlReg;
      8'h04: v__h27054 = captWorker0_mesgCount;
      8'h08: v__h27054 = captWorker0_dataCount;
      8'h10: v__h27054 = 32'd2361866;
      8'h1C: v__h27054 = 32'hFEEDC0DE;
      8'h20: v__h27054 = rdat___1__h27176;
      8'h24: v__h27054 = captWorker0_wsiS_extStatusW$wget[95:64];
      8'h28: v__h27054 = captWorker0_wsiS_extStatusW$wget[63:32];
      8'h2C: v__h27054 = captWorker0_wsiS_extStatusW$wget[31:0];
      default: v__h27054 = 32'd0;
    endcase
  end
  always@(captWorker0_splaF$D_OUT or
  ...
  always@(captWorker1_wci_wslv_reqF$D_OUT or
	  ...
	  rdat___1__h63262 or captWorker1_wsiS_extStatusW$wget)
  begin
    case (captWorker1_wci_wslv_reqF$D_OUT[39:32])
      8'h0: v__h63140 = captWorker1_controlReg;
      8'h04: v__h63140 = captWorker1_mesgCount;
      8'h08: v__h63140 = captWorker1_dataCount;
      8'h10: v__h63140 = 32'd2361866;
      8'h1C: v__h63140 = 32'hFEEDC0DE;
      8'h20: v__h63140 = rdat___1__h63262;
      8'h24: v__h63140 = captWorker1_wsiS_extStatusW$wget[95:64];
      8'h28: v__h63140 = captWorker1_wsiS_extStatusW$wget[63:32];
      8'h2C: v__h63140 = captWorker1_wsiS_extStatusW$wget[31:0];
      default: v__h63140 = 32'd0;
    endcase
  end
  always@(captWorker1_splaF$D_OUT or
  ...
  always@(captWorker2_wci_wslv_reqF$D_OUT or
	  ...
	  rdat___1__h99347 or captWorker2_wsiS_extStatusW$wget)
  begin
    case (captWorker2_wci_wslv_reqF$D_OUT[39:32])
      8'h0: v__h99225 = captWorker2_controlReg;
      8'h04: v__h99225 = captWorker2_mesgCount;
      8'h08: v__h99225 = captWorker2_dataCount;
      8'h10: v__h99225 = 32'd2361866;
      8'h1C: v__h99225 = 32'hFEEDC0DE;
      8'h20: v__h99225 = rdat___1__h99347;
      8'h24: v__h99225 = captWorker2_wsiS_extStatusW$wget[95:64];
      8'h28: v__h99225 = captWorker2_wsiS_extStatusW$wget[63:32];
      8'h2C: v__h99225 = captWorker2_wsiS_extStatusW$wget[31:0];
      default: v__h99225 = 32'd0;
    endcase
  end
  always@(captWorker2_splaF$D_OUT or
  ...
  begin
    ...
    if (RST_N_rst_5)
      if (WILL_FIRE_RL_captWorker0_advance_split_response)
	$display("[%0d]: %m: WCI SPLIT READ Data:%0x", v__h26587, v__h25668);
    if (RST_N_rst_5)
      if (WILL_FIRE_RL_captWorker0_advance_split_response &&
	  WILL_FIRE_RL_captWorker0_wci_ctrl_OrE)
    ...
    if (RST_N_rst_6)
      if (WILL_FIRE_RL_captWorker1_advance_split_response)
	$display("[%0d]: %m: WCI SPLIT READ Data:%0x", v__h62673, v__h61754);
    if (RST_N_rst_6)
      if (WILL_FIRE_RL_captWorker1_advance_split_response &&
	  WILL_FIRE_RL_captWorker1_wci_ctrl_OrE)
    ...
    if (RST_N_rst_7)
      if (WILL_FIRE_RL_captWorker2_advance_split_response)
	$display("[%0d]: %m: WCI SPLIT READ Data:%0x", v__h98758, v__h97839);
    if (RST_N_rst_7)
      if (WILL_FIRE_RL_captWorker2_advance_split_response &&
	  WILL_FIRE_RL_captWorker2_wci_ctrl_OrE)
