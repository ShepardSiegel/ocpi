...
//
// On Mon Sep 10 09:58:48 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkEDDPAdapter(CLK,
  ...
  wire [39 : 0] dpRespF$D_IN;
  wire dpRespF$CLR, dpRespF$DEQ, dpRespF$ENQ, dpRespF$FULL_N;
  ...
  wire edpReqF$CLR, edpReqF$DEQ, edpReqF$ENQ, edpReqF$FULL_N;

  // ports of submodule edpRespF
  wire [39 : 0] edpRespF$D_IN, edpRespF$D_OUT;
  wire edpRespF$CLR, edpRespF$DEQ, edpRespF$EMPTY_N, edpRespF$ENQ;
  ...
  reg [1 : 0] CASE_client_response_put_BITS_19_TO_18_3_0_cli_ETC__q11,
	      ...
	      CASE_server_request_put_BITS_19_TO_18_3_0_serv_ETC__q15,
	      CASE_server_request_put_BITS_29_TO_28_3_0_serv_ETC__q14,
	      CASE_server_request_put_BITS_39_TO_38_3_0_serv_ETC__q13,
	      CASE_server_request_put_BITS_9_TO_8_3_0_server_ETC__q16;
  ...
  assign edpReqF$DEQ = 1'b0 ;
  assign edpReqF$CLR = 1'b0 ;

  // submodule edpRespF
  assign edpRespF$D_IN = 40'h0 ;
  assign edpRespF$ENQ = 1'b0 ;
  ...
  begin
    case (server_request_put[39:38])
      ...
      2'd3: CASE_server_request_put_BITS_39_TO_38_3_0_serv_ETC__q13 = 2'd3;
    endcase
  end
  always@(server_request_put)
  begin
    case (server_request_put[29:28])
      ...
      2'd3: CASE_server_request_put_BITS_29_TO_28_3_0_serv_ETC__q14 = 2'd3;
    endcase
  end
  always@(server_request_put)
  begin
    case (server_request_put[19:18])
      ...
      2'd3: CASE_server_request_put_BITS_19_TO_18_3_0_serv_ETC__q15 = 2'd3;
    endcase
  end
  always@(server_request_put)
  begin
    case (server_request_put[9:8])
      ...
      2'd3: CASE_server_request_put_BITS_9_TO_8_3_0_server_ETC__q16 = 2'd3;
    endcase
  end
