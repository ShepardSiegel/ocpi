...
//
// On Tue Sep 11 04:34:02 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkEDDPAdapter(CLK,
  ...
  wire dpReqF$CLR, dpReqF$DEQ, dpReqF$EMPTY_N, dpReqF$ENQ;
  ...
  wire WILL_FIRE_RL_edpFsm_action_l78c14,
       WILL_FIRE_RL_edpFsm_action_l79c14,
       WILL_FIRE_RL_edpFsm_action_l80c14,
       WILL_FIRE_RL_edpFsm_action_l81c14,
       WILL_FIRE_RL_edpFsm_fsm_start,
       WILL_FIRE_RL_edpFsm_idle_l77c3,
       WILL_FIRE_RL_egress_body,
       WILL_FIRE_RL_egress_setup;
  ...
  wire MUX_txPayload$write_1__VAL_2;
  ...
  wire edpFsm_abort_whas__1_AND_edpFsm_abort_wget__2__ETC___d93;
  ...
  // rule RL_edpFsm_action_l79c14
  assign WILL_FIRE_RL_edpFsm_action_l79c14 =
	     edpRespF$FULL_N && edpFsm_state_mkFSMstate == 3'd1 &&
	     !WILL_FIRE_RL_egress_body ;

  // rule RL_edpFsm_action_l80c14
  assign WILL_FIRE_RL_edpFsm_action_l80c14 =
	     edpRespF$FULL_N && edpFsm_state_mkFSMstate == 3'd2 &&
	     !WILL_FIRE_RL_egress_body ;

  // rule RL_edpFsm_action_l81c14
  assign WILL_FIRE_RL_edpFsm_action_l81c14 =
	     edpRespF$FULL_N && edpFsm_state_mkFSMstate == 3'd3 &&
	     !WILL_FIRE_RL_egress_body ;

  // rule RL_edpFsm_fsm_start
  assign WILL_FIRE_RL_edpFsm_fsm_start =
	     edpFsm_abort_whas__1_AND_edpFsm_abort_wget__2__ETC___d93 &&
	     edpFsm_start_reg ;

  // rule RL_edpFsm_action_l78c14
  assign WILL_FIRE_RL_edpFsm_action_l78c14 =
	     edpRespF$FULL_N && edpFsm_start_wire$whas &&
	     (edpFsm_state_mkFSMstate == 3'd0 ||
	      edpFsm_state_mkFSMstate == 3'd5) &&
	     !WILL_FIRE_RL_egress_body ;

  // rule RL_egress_setup
  assign WILL_FIRE_RL_egress_setup =
	     edpFsm_abort_whas__1_AND_edpFsm_abort_wget__2__ETC___d93 &&
	     !edpFsm_start_reg &&
	     dpRespF$EMPTY_N &&
	     !txPayload ;
  ...
  // rule RL_edpFsm_idle_l77c3
  assign WILL_FIRE_RL_edpFsm_idle_l77c3 =
	     !edpFsm_start_wire$whas && edpFsm_state_mkFSMstate == 3'd5 ;
  ...
  assign edpIngress_1$whas = edpReqF$EMPTY_N ;
  assign edpEgress_1$wget = 1'b0 ;
  assign edpEgress_1$whas = 1'b0 ;
  ...
  assign edpFsm_state_set_pw$whas =
	     ...
	     WILL_FIRE_RL_edpFsm_action_l80c14 ||
	     WILL_FIRE_RL_edpFsm_action_l79c14 ||
	     WILL_FIRE_RL_edpFsm_action_l78c14 ;
  ...
  // register edpFsm_state_mkFSMstate
  always@(WILL_FIRE_RL_edpFsm_idle_l77c3 or
	  WILL_FIRE_RL_edpFsm_action_l78c14 or
	  WILL_FIRE_RL_edpFsm_action_l79c14 or
	  WILL_FIRE_RL_edpFsm_action_l80c14 or
	  WILL_FIRE_RL_edpFsm_action_l81c14 or edpFsm_state_mkFSMstate)
  begin
    case (1'b1) // synopsys parallel_case
      WILL_FIRE_RL_edpFsm_idle_l77c3: edpFsm_state_mkFSMstate$D_IN = 3'd0;
      WILL_FIRE_RL_edpFsm_action_l78c14: edpFsm_state_mkFSMstate$D_IN = 3'd1;
      WILL_FIRE_RL_edpFsm_action_l79c14: edpFsm_state_mkFSMstate$D_IN = 3'd2;
      WILL_FIRE_RL_edpFsm_action_l80c14: edpFsm_state_mkFSMstate$D_IN = 3'd3;
      WILL_FIRE_RL_edpFsm_action_l81c14: edpFsm_state_mkFSMstate$D_IN = 3'd4;
  ...
  // register edpIngress
  assign edpIngress$D_IN = edpReqF$EMPTY_N ;
  assign edpIngress$EN = 1'd1 ;

  // register eeDID
  assign eeDID$D_IN = { dpRespF$D_OUT[37:30], dpRespF$D_OUT[27:20] } ;
  assign eeDID$EN = WILL_FIRE_RL_egress_setup ;
  ...
  // submodule dpReqF
  assign dpReqF$D_IN = 40'h0 ;
  assign dpReqF$ENQ = 1'b0 ;
  ...
  assign dpRespF$DEQ = WILL_FIRE_RL_egress_body || WILL_FIRE_RL_egress_setup ;
  ...
  assign edpReqF$DEQ = edpReqF$EMPTY_N ;
  assign edpReqF$CLR = 1'b0 ;

  // submodule edpRespF
  always@(WILL_FIRE_RL_edpFsm_action_l78c14 or
	  MUX_edpRespF$enq_1__VAL_1 or
	  WILL_FIRE_RL_edpFsm_action_l79c14 or
	  MUX_edpRespF$enq_1__VAL_2 or
	  WILL_FIRE_RL_edpFsm_action_l80c14 or
	  MUX_edpRespF$enq_1__VAL_3 or
	  WILL_FIRE_RL_edpFsm_action_l81c14 or
  ...
  // remaining internal signals
  assign edpFsm_abort_whas__1_AND_edpFsm_abort_wget__2__ETC___d93 =
	     (edpFsm_state_mkFSMstate == 3'd0 ||
	      edpFsm_state_mkFSMstate == 3'd5) &&
	     (!edpFsm_start_reg_1 || edpFsm_state_fired) ;
  ...
  begin
    #0;
    if (RST_N)
      if (WILL_FIRE_RL_edpFsm_action_l78c14 &&
	  (WILL_FIRE_RL_edpFsm_action_l79c14 ||
	   WILL_FIRE_RL_edpFsm_action_l80c14 ||
	   WILL_FIRE_RL_edpFsm_action_l81c14 ||
	   edpFsm_state_mkFSMstate == 3'd4))
	$display("Error: \"bsv/eth/EDDP.bsv\", line 78, column 14: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_edpFsm_action_l78c14] and\n  [RL_edpFsm_action_l79c14, RL_edpFsm_action_l80c14, RL_edpFsm_action_l81c14,\n  RL_edpFsm_action_l82c16] ) fired in the same clock cycle.\n");
    if (RST_N)
      if (WILL_FIRE_RL_edpFsm_action_l79c14 &&
	  (WILL_FIRE_RL_edpFsm_action_l80c14 ||
	   WILL_FIRE_RL_edpFsm_action_l81c14 ||
	   edpFsm_state_mkFSMstate == 3'd4))
	$display("Error: \"bsv/eth/EDDP.bsv\", line 79, column 14: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_edpFsm_action_l79c14] and\n  [RL_edpFsm_action_l80c14, RL_edpFsm_action_l81c14, RL_edpFsm_action_l82c16]\n  ) fired in the same clock cycle.\n");
    if (RST_N)
      if (WILL_FIRE_RL_edpFsm_action_l80c14 &&
	  (WILL_FIRE_RL_edpFsm_action_l81c14 ||
	   edpFsm_state_mkFSMstate == 3'd4))
	$display("Error: \"bsv/eth/EDDP.bsv\", line 80, column 14: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_edpFsm_action_l80c14] and\n  [RL_edpFsm_action_l81c14, RL_edpFsm_action_l82c16] ) fired in the same clock\n  cycle.\n");
    if (RST_N)
      if (WILL_FIRE_RL_edpFsm_action_l81c14 &&
	  edpFsm_state_mkFSMstate == 3'd4)
	$display("Error: \"bsv/eth/EDDP.bsv\", line 81, column 14: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_edpFsm_action_l81c14] and\n  [RL_edpFsm_action_l82c16] ) fired in the same clock cycle.\n");
  end
  // synopsys translate_on
