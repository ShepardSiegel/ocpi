...
module mkWciAxiTarget(wciS0_Clk,
  ...
  // value method wciS0_mAWVALID
  output wciS0_mAWVALID;
  ...
  // value method wciS0_mWVALID
  output wciS0_mWVALID;
  ...
  // value method wciS0_mBREADY
  output wciS0_mBREADY;

  // value method wciS0_sBRESP
  output [1 : 0] wciS0_BRESP;

  // value method wciS0_mARVALID
  output wciS0_mARVALID;
  ...
  // value method wciS0_mRREADY
  output wciS0_mRREADY;
  ...
  // value method wciS0_mBREADY
  assign wciS0_mBREADY = 1'h0 ;

  // value method wciS0_sBRESP
  assign wciS0_BRESP = 2'h2 ;

  // value method wciS0_mARVALID
  assign wciS0_mARVALID = 1'h0 ;
  ...
  // inputs to muxes for submodule ports
  assign MUX_target_rBS_fifof_q_0$write_1__SEL_2 =
	     WILL_FIRE_RL_target_rBS_fifof_incCtr &&
	     target_rBS_fifof_c_r == 2'd0 ;
  assign MUX_target_rBS_fifof_q_1$write_1__SEL_2 =
	     WILL_FIRE_RL_target_rBS_fifof_incCtr &&
	     target_rBS_fifof_c_r == 2'd1 ;
  ...
  assign MUX_target_rBS_fifof_c_r$write_1__VAL_1 =
	     target_rBS_fifof_c_r + 2'd1 ;
  assign MUX_target_rBS_fifof_q_0$write_1__VAL_2 =
  ...
  assign target_rBS_fifof_x_wire$wget =
	     MUX_target_rBS_fifof_q_0$write_1__VAL_2 ;
  ...
  // register target_rBS_fifof_q_0
  assign target_rBS_fifof_q_0$D_IN = MUX_target_rBS_fifof_q_0$write_1__VAL_2 ;
  assign target_rBS_fifof_q_0$EN = MUX_target_rBS_fifof_q_0$write_1__SEL_2 ;

  // register target_rBS_fifof_q_1
  assign target_rBS_fifof_q_1$D_IN = MUX_target_rBS_fifof_q_0$write_1__VAL_2 ;
  assign target_rBS_fifof_q_1$EN = MUX_target_rBS_fifof_q_1$write_1__SEL_2 ;
  ...
  assign target_awBR_fifof$DEQ = WILL_FIRE_RL_target_wci_write_request ;
  assign target_awBR_fifof$ENQ = 1'b0 ;
  assign target_awBR_fifof$CLR = 1'b0 ;

  // submodule target_bBR_fifof
  assign target_bBR_fifof$D_IN = 35'h0 ;
  assign target_bBR_fifof$DEQ = CAN_FIRE_RL_target_wci_read_request ;
  ...
  assign target_wBR_fifof$DEQ = WILL_FIRE_RL_target_wci_write_request ;
