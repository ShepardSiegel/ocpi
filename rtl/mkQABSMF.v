...
//
// On Mon Sep 24 13:37:52 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkQABSMF(et0,
  ...
  reg [7 : 0] IF_frk_ptr_08_EQ_0_26_THEN_frk_sr_12_BITS_17_T_ETC___d727,
	      ...
	      IF_frk_ptr_08_EQ_0_26_THEN_frk_sr_12_BITS_37_T_ETC___d725,
	      IF_frk_ptr_08_EQ_0_26_THEN_frk_sr_12_BITS_7_TO_ETC___d728;
  ...
  wire IF_merge_fi0HasPrio_06_THEN_merge_fi0_first_BI_ETC___d689,
  ...
  // register frk_match0
  assign frk_match0$D_IN = et0 == seen__h10467 ;
  ...
  assign IF_IF_merge_fi0HasPrio_06_THEN_merge_fi0_first_ETC___d124 =
		...
		merge_fi1$D_OUT[39:38] == 2'd1) ?
	       { 2'd1,
		 IF_merge_fi0HasPrio_06_THEN_merge_fi0_first_BI_ETC___d721 } :
  ...
  assign IF_merge_fi0HasPrio_06_THEN_merge_fi0_first_BI_ETC___d689 =
	     merge_fi0HasPrio ?
	       merge_fi0$D_OUT[39:38] == 2'd0 :
	       merge_fi1$D_OUT[39:38] == 2'd0 ;
  assign IF_merge_fi0HasPrio_06_THEN_merge_fi0_first_BI_ETC___d721 =
	     merge_fi0HasPrio ?
	       merge_fi0$D_OUT[37:30] :
	       merge_fi1$D_OUT[37:30] ;
  ...
  assign seen__h10467 = { frk_srcF$D_OUT[7:0], frk_srcF$D_OUT[17:10] } ;
  ...
  begin
    case (frk_ptr)
	  ...
	  IF_frk_ptr_08_EQ_0_26_THEN_frk_sr_12_BITS_27_T_ETC___d726 =
	      frk_sr[67:60];
      default: IF_frk_ptr_08_EQ_0_26_THEN_frk_sr_12_BITS_27_T_ETC___d726 =
		   frk_sr[107:100];
    endcase
  end
  always@(frk_ptr or frk_sr)
  ...
  begin
    case (frk_ptr)
	  ...
	  IF_frk_ptr_08_EQ_0_26_THEN_frk_sr_12_BITS_37_T_ETC___d725 =
	      frk_sr[77:70];
      default: IF_frk_ptr_08_EQ_0_26_THEN_frk_sr_12_BITS_37_T_ETC___d725 =
		   frk_sr[117:110];
    endcase
  end
  always@(frk_ptr or frk_sr)
  ...
  begin
    case (frk_ptr)
	  ...
	  IF_frk_ptr_08_EQ_0_26_THEN_frk_sr_12_BITS_17_T_ETC___d727 =
	      frk_sr[57:50];
      default: IF_frk_ptr_08_EQ_0_26_THEN_frk_sr_12_BITS_17_T_ETC___d727 =
		   frk_sr[97:90];
    endcase
  end
  always@(frk_ptr or frk_sr)
  ...
  begin
    case (frk_ptr)
	  ...
	  IF_frk_ptr_08_EQ_0_26_THEN_frk_sr_12_BITS_7_TO_ETC___d728 =
	      frk_sr[47:40];
      default: IF_frk_ptr_08_EQ_0_26_THEN_frk_sr_12_BITS_7_TO_ETC___d728 =
		   frk_sr[87:80];
    endcase
  end
  always@(frk_ptr or frk_sr)
