...
//
// On Fri Oct 12 11:31:01 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkQABSMF(et0,
  ...
  reg [7 : 0] IF_frk_ptr_19_EQ_0_37_THEN_frk_sr_23_BITS_17_T_ETC___d738,
	      IF_frk_ptr_19_EQ_0_37_THEN_frk_sr_23_BITS_27_T_ETC___d737,
  ...
  wire [39 : 0] IF_frk_srcF_first__79_BITS_39_TO_38_80_EQ_0_81_ETC___d740;
  wire [19 : 0] IF_IF_merge_fi0HasPrio_06_THEN_merge_fi0_first_ETC___d147;
  wire [15 : 0] seen__h10505;
  ...
  wire [7 : 0] IF_merge_fi0HasPrio_06_THEN_merge_fi0_first_BI_ETC___d732,
	       IF_merge_fi0HasPrio_06_THEN_merge_fi0_first_BI_ETC___d733,
	       IF_merge_fi0HasPrio_06_THEN_merge_fi0_first_BI_ETC___d734,
	       IF_merge_fi0HasPrio_06_THEN_merge_fi0_first_BI_ETC___d735;
  wire [2 : 0] frk_ptr_19_PLUS_1___d795;
  ...
  wire IF_merge_fi0HasPrio_06_THEN_NOT_merge_fi0_i_no_ETC___d113,
       IF_merge_fi0HasPrio_06_THEN_NOT_merge_fi0_i_no_ETC___d911,
       IF_merge_fi0HasPrio_06_THEN_merge_fi0_first_BI_ETC___d704,
       IF_merge_fi0HasPrio_06_THEN_merge_fi0_first_BI_ETC___d909,
       IF_merge_fi0HasPrio_06_THEN_merge_fi0_first_BI_ETC___d910,
  ...
  assign MUX_frk_ptr$write_1__VAL_1 =
	     frk_stageSent ? 3'd0 : frk_ptr_19_PLUS_1___d795 ;
  assign MUX_frk_ptr$write_1__VAL_2 =
	     (frk_srcF$D_OUT[9:8] != 2'd0 || frk_srcF$D_OUT[19:18] != 2'd0 ||
	      frk_srcF$D_OUT[29:28] != 2'd0 ||
	      frk_srcF$D_OUT[39:38] != 2'd0) ?
	       3'd0 :
	       frk_ptr_19_PLUS_1___d795 ;
  ...
  // register frk_match0
  assign frk_match0$D_IN = et0 == seen__h10505 ;
  ...
  // register frk_sr
  assign frk_sr$D_IN =
	     { IF_frk_srcF_first__79_BITS_39_TO_38_80_EQ_0_81_ETC___d740,
	       CASE_frk_sr_BITS_119_TO_118_3_0_frk_sr_BITS_11_ETC__q37,
	       frk_sr[117:110],
	       CASE_frk_sr_BITS_109_TO_108_3_0_frk_sr_BITS_10_ETC__q38,
	       frk_sr[107:100],
  ...
  assign IF_IF_merge_fi0HasPrio_06_THEN_merge_fi0_first_ETC___d135 =
		...
		merge_fi1$D_OUT[39:38] == 2'd1) ?
	       { 2'd1,
		 IF_merge_fi0HasPrio_06_THEN_merge_fi0_first_BI_ETC___d732 } :
  ...
  assign IF_IF_merge_fi0HasPrio_06_THEN_merge_fi0_first_ETC___d166 =
		...
		merge_fi1$D_OUT[9:8] == 2'd1) ?
		 ...
		 IF_merge_fi0HasPrio_06_THEN_merge_fi0_first_BI_ETC___d735 } :
	       { IF_IF_merge_fi0HasPrio_06_THEN_merge_fi0_first_ETC___d164,
		 IF_merge_fi0HasPrio_06_THEN_merge_fi0_first_BI_ETC___d735 } ;
  assign IF_frk_srcF_first__79_BITS_39_TO_38_80_EQ_0_81_ETC___d740 =
	     { CASE_frk_srcFD_OUT_BITS_39_TO_38_3_0_frk_srcF_ETC__q25,
  ...
  assign IF_merge_fi0HasPrio_06_THEN_NOT_merge_fi0_i_no_ETC___d911 =
	     IF_merge_fi0HasPrio_06_THEN_NOT_merge_fi0_i_no_ETC___d113 ||
	     (merge_fi0HasPrio ? merge_fi0$EMPTY_N : merge_fi1$EMPTY_N) ;
  assign IF_merge_fi0HasPrio_06_THEN_merge_fi0_first_BI_ETC___d704 =
	     merge_fi0HasPrio ?
	       merge_fi0$D_OUT[39:38] == 2'd0 :
	       merge_fi1$D_OUT[39:38] == 2'd0 ;
  assign IF_merge_fi0HasPrio_06_THEN_merge_fi0_first_BI_ETC___d732 =
	     merge_fi0HasPrio ?
	       merge_fi0$D_OUT[37:30] :
	       merge_fi1$D_OUT[37:30] ;
  assign IF_merge_fi0HasPrio_06_THEN_merge_fi0_first_BI_ETC___d733 =
	     merge_fi0HasPrio ?
	       merge_fi0$D_OUT[27:20] :
	       merge_fi1$D_OUT[27:20] ;
  assign IF_merge_fi0HasPrio_06_THEN_merge_fi0_first_BI_ETC___d734 =
	     merge_fi0HasPrio ?
	       merge_fi0$D_OUT[17:10] :
	       merge_fi1$D_OUT[17:10] ;
  assign IF_merge_fi0HasPrio_06_THEN_merge_fi0_first_BI_ETC___d735 =
	     merge_fi0HasPrio ? merge_fi0$D_OUT[7:0] : merge_fi1$D_OUT[7:0] ;
  assign IF_merge_fi0HasPrio_06_THEN_merge_fi0_first_BI_ETC___d909 =
	     merge_fi0HasPrio ?
	       merge_fi0$D_OUT[29:28] == 2'd0 :
	       merge_fi1$D_OUT[29:28] == 2'd0 ;
  assign IF_merge_fi0HasPrio_06_THEN_merge_fi0_first_BI_ETC___d910 =
	     merge_fi0HasPrio ?
	       merge_fi0$D_OUT[19:18] == 2'd0 :
	       merge_fi1$D_OUT[19:18] == 2'd0 ;
  assign IF_merge_fi0HasPrio_06_THEN_merge_fi0_first_BI_ETC___d912 =
	     merge_fi0HasPrio ?
  ...
  assign frk_ptr_19_PLUS_1___d795 = frk_ptr + 3'd1 ;
  assign seen__h10505 = { frk_srcF$D_OUT[7:0], frk_srcF$D_OUT[17:10] } ;
  ...
  begin
    case (frk_ptr)
	  ...
	  IF_frk_ptr_19_EQ_0_37_THEN_frk_sr_23_BITS_37_T_ETC___d736 =
	      frk_sr[77:70];
      default: IF_frk_ptr_19_EQ_0_37_THEN_frk_sr_23_BITS_37_T_ETC___d736 =
		   frk_sr[117:110];
    endcase
  end
  always@(frk_ptr or frk_sr)
  ...
  begin
    case (frk_ptr)
	  ...
	  IF_frk_ptr_19_EQ_0_37_THEN_frk_sr_23_BITS_27_T_ETC___d737 =
	      frk_sr[67:60];
      default: IF_frk_ptr_19_EQ_0_37_THEN_frk_sr_23_BITS_27_T_ETC___d737 =
		   frk_sr[107:100];
    endcase
  end
  always@(frk_ptr or frk_sr)
  ...
  begin
    case (frk_ptr)
	  ...
	  IF_frk_ptr_19_EQ_0_37_THEN_frk_sr_23_BITS_17_T_ETC___d738 =
	      frk_sr[57:50];
      default: IF_frk_ptr_19_EQ_0_37_THEN_frk_sr_23_BITS_17_T_ETC___d738 =
		   frk_sr[97:90];
    endcase
  end
  always@(frk_ptr or frk_sr)
  ...
  begin
    case (frk_ptr)
	  ...
	  IF_frk_ptr_19_EQ_0_37_THEN_frk_sr_23_BITS_7_TO_ETC___d739 =
	      frk_sr[47:40];
      default: IF_frk_ptr_19_EQ_0_37_THEN_frk_sr_23_BITS_7_TO_ETC___d739 =
		   frk_sr[87:80];
    endcase
  end
  always@(frk_ptr or frk_sr)
