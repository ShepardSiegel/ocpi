...
//
// On Wed Sep 19 10:30:35 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkQABSMF(et0,
  ...
  reg [7 : 0] IF_frk_ptr_08_EQ_0_26_THEN_frk_sr_12_BITS_17_T_ETC___d728,
	      IF_frk_ptr_08_EQ_0_26_THEN_frk_sr_12_BITS_27_T_ETC___d727,
	      IF_frk_ptr_08_EQ_0_26_THEN_frk_sr_12_BITS_37_T_ETC___d726,
	      IF_frk_ptr_08_EQ_0_26_THEN_frk_sr_12_BITS_7_TO_ETC___d688;
  ...
  wire [39 : 0] IF_frk_srcF_first__68_BITS_39_TO_38_69_EQ_0_70_ETC___d729;
  wire [19 : 0] IF_IF_merge_fi0HasPrio_06_THEN_merge_fi0_first_ETC___d136;
  wire [15 : 0] seenEt__h10464;
  ...
  wire [7 : 0] IF_merge_fi0HasPrio_06_THEN_merge_fi0_first_BI_ETC___d722,
	       IF_merge_fi0HasPrio_06_THEN_merge_fi0_first_BI_ETC___d723,
	       IF_merge_fi0HasPrio_06_THEN_merge_fi0_first_BI_ETC___d724,
	       IF_merge_fi0HasPrio_06_THEN_merge_fi0_first_BI_ETC___d725;
  wire [2 : 0] frk_ptr_08_PLUS_1___d783;
  ...
  wire IF_merge_fi0HasPrio_06_THEN_merge_fi0_first_BI_ETC___d697,
  ...
  assign MUX_frk_ptr$write_1__VAL_1 =
	     frk_stageSent ? 3'd0 : frk_ptr_08_PLUS_1___d783 ;
  ...
  // register frk_match0
  assign frk_match0$D_IN = seenEt__h10464 == et0 ;
  ...
  assign IF_IF_frk_ptr_08_EQ_0_26_THEN_frk_sr_12_BITS_1_ETC___d395 =
		 ...
		 2'd2 :
		 2'd3,
	       IF_frk_ptr_08_EQ_0_26_THEN_frk_sr_12_BITS_17_T_ETC___d728 } ;
  ...
  assign IF_IF_merge_fi0HasPrio_06_THEN_merge_fi0_first_ETC___d155 =
		...
		merge_fi1$D_OUT[9:8] == 2'd1) ?
		 ...
		 IF_merge_fi0HasPrio_06_THEN_merge_fi0_first_BI_ETC___d725 } :
	       { IF_IF_merge_fi0HasPrio_06_THEN_merge_fi0_first_ETC___d153,
		 IF_merge_fi0HasPrio_06_THEN_merge_fi0_first_BI_ETC___d725 } ;
  assign IF_frk_srcF_first__68_BITS_39_TO_38_69_EQ_0_70_ETC___d729 =
	     { CASE_frk_srcFD_OUT_BITS_39_TO_38_3_0_frk_srcF_ETC__q25,
  ...
  assign IF_merge_fi0HasPrio_06_THEN_merge_fi0_first_BI_ETC___d697 =
	     merge_fi0HasPrio ?
	       merge_fi0$D_OUT[39:38] == 2'd0 :
	       merge_fi1$D_OUT[39:38] == 2'd0 ;
  assign IF_merge_fi0HasPrio_06_THEN_merge_fi0_first_BI_ETC___d722 =
	     merge_fi0HasPrio ?
	       merge_fi0$D_OUT[37:30] :
	       merge_fi1$D_OUT[37:30] ;
  assign IF_merge_fi0HasPrio_06_THEN_merge_fi0_first_BI_ETC___d723 =
	     merge_fi0HasPrio ?
	       merge_fi0$D_OUT[27:20] :
	       merge_fi1$D_OUT[27:20] ;
  assign IF_merge_fi0HasPrio_06_THEN_merge_fi0_first_BI_ETC___d724 =
	     merge_fi0HasPrio ?
	       merge_fi0$D_OUT[17:10] :
	       merge_fi1$D_OUT[17:10] ;
  assign IF_merge_fi0HasPrio_06_THEN_merge_fi0_first_BI_ETC___d725 =
	     merge_fi0HasPrio ? merge_fi0$D_OUT[7:0] : merge_fi1$D_OUT[7:0] ;
  assign IF_merge_fi0HasPrio_06_THEN_merge_fi0_first_BI_ETC___d898 =
	     merge_fi0HasPrio ?
	       merge_fi0$D_OUT[29:28] == 2'd0 :
	       merge_fi1$D_OUT[29:28] == 2'd0 ;
  assign IF_merge_fi0HasPrio_06_THEN_merge_fi0_first_BI_ETC___d899 =
	     merge_fi0HasPrio ?
  ...
  begin
    case (frk_ptr)
	  ...
	  IF_frk_ptr_08_EQ_0_26_THEN_frk_sr_12_BITS_27_T_ETC___d727 =
	      frk_sr[67:60];
      default: IF_frk_ptr_08_EQ_0_26_THEN_frk_sr_12_BITS_27_T_ETC___d727 =
		   frk_sr[107:100];
    endcase
  end
  always@(frk_ptr or frk_sr)
  ...
  begin
    case (frk_ptr)
	  ...
	  IF_frk_ptr_08_EQ_0_26_THEN_frk_sr_12_BITS_37_T_ETC___d726 =
	      frk_sr[77:70];
      default: IF_frk_ptr_08_EQ_0_26_THEN_frk_sr_12_BITS_37_T_ETC___d726 =
		   frk_sr[117:110];
    endcase
  end
  always@(frk_ptr or frk_sr)
  ...
  begin
    case (frk_ptr)
	  ...
	  IF_frk_ptr_08_EQ_0_26_THEN_frk_sr_12_BITS_17_T_ETC___d728 =
	      frk_sr[57:50];
      default: IF_frk_ptr_08_EQ_0_26_THEN_frk_sr_12_BITS_17_T_ETC___d728 =
		   frk_sr[97:90];
    endcase
  end
  always@(frk_ptr or frk_sr)
  ...
  begin
    case (frk_ptr)
	  ...
	  IF_frk_ptr_08_EQ_0_26_THEN_frk_sr_12_BITS_7_TO_ETC___d688 =
	      frk_sr[47:40];
      default: IF_frk_ptr_08_EQ_0_26_THEN_frk_sr_12_BITS_7_TO_ETC___d688 =
		   frk_sr[87:80];
    endcase
  end
  always@(frk_ptr or frk_sr)
