...
//
// On Sat Mar  3 14:59:38 EST 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkGMAC(CLK_rxClk,
  ...
  wire CAN_FIRE_RL_txRS_egress_SOF,
  ...
  wire [7 : 0] MUX_txRS_txData_1$wset_1__VAL_3;
  ...
  wire MUX_rxRS_rxF$enq_1__SEL_1,
       ...
       MUX_txRS_crc$add_1__SEL_2,
       MUX_txRS_doPad$write_1__SEL_1,
       MUX_txRS_emitFCS$write_1__PSEL_1,
       MUX_txRS_emitFCS$write_1__SEL_1,
       MUX_txRS_txActive$write_1__SEL_1;

  // remaining internal signals
  reg [63 : 0] v__h12040, v__h6453;
  reg [1 : 0] CASE_rxRS_rxFdD_OUT_BITS_9_TO_8_3_0_rxRS_rxF_ETC__q1,
	      CASE_tx_put_BITS_9_TO_8_3_0_tx_put_BITS_9_TO_8_ETC__q2;
  wire rxRS_crc_complete_0_EQ_rxRS_rxPipe_6_BITS_31_T_ETC___d260,
       txRS_lenCnt_value_25_ULT_60___d184,
       txRS_preambleCnt_value_9_ULT_7___d270;

  // oscillator and gates for output clock CLK_gmii_tx_tx_clk
  assign CLK_gmii_tx_tx_clk = CLK_txClk ;
  assign CLK_GATE_gmii_tx_tx_clk = 1'd1 ;

  // oscillator and gates for output clock CLK_rxclk
  assign CLK_rxclk = rxClk_BUFR$O ;
  assign CLK_GATE_rxclk = 1'b1 ;

  // output resets
  assign RST_N_gmii_rstn = phyReset$OUT_RST_N ;

  // value method gmii_tx_txd
  assign gmii_tx_txd = txRS_txData ;

  // value method gmii_tx_tx_en
  assign gmii_tx_tx_en = txRS_txDV ;

  // value method gmii_tx_tx_er
  assign gmii_tx_tx_er = txRS_txER ;
  ...
  assign WILL_FIRE_RL_rxRS_ingress_noadvance =
	     (!rxRS_rxActive || rxRS_rxF$sFULL_N) && !rxRS_rxDVD &&
	     rxRS_rxAPipe[0] &&
	     rxRS_rxAPipe[1] &&
	     rxRS_rxAPipe[2] &&
	     rxRS_rxAPipe[3] &&
  ...
  assign WILL_FIRE_RL_rxRS_egress_data =
	     rxRS_rxF$sFULL_N && rxRS_rxDVD && rxRS_rxAPipe[5] ;
  ...
  assign WILL_FIRE_RL_txRS_egress_SOF =
	     CAN_FIRE_RL_txRS_egress_SOF && !WILL_FIRE_RL_txRS_egress_PAD &&
	     !(txRS_emitFCS != 3'd0) ;

  // rule RL_txRS_egress_Body
  assign WILL_FIRE_RL_txRS_egress_Body =
	     txRS_txF$dEMPTY_N && txRS_txActive && !txRS_isSOF &&
	     txRS_txF$dD_OUT[9:8] == 2'd0 &&
	     !WILL_FIRE_RL_txRS_egress_PAD &&
	     !(txRS_emitFCS != 3'd0) ;
  ...
  assign WILL_FIRE_RL_txRS_egress_EOF =
	     txRS_txF$dEMPTY_N && txRS_txActive &&
	     txRS_txF$dD_OUT[9:8] == 2'd1 &&
	     !WILL_FIRE_RL_txRS_egress_PAD &&
	     !(txRS_emitFCS != 3'd0) ;

  // rule RL_txRS_egress_PAD
  assign WILL_FIRE_RL_txRS_egress_PAD =
	     txRS_txActive && txRS_doPad && !(txRS_emitFCS != 3'd0) ;
  ...
  assign MUX_txRS_crc$add_1__SEL_1 =
	     ...
	     !txRS_preambleCnt_value_9_ULT_7___d270 &&
	     txRS_preambleCnt_value != 5'd7 ;
  assign MUX_txRS_crc$add_1__SEL_2 =
	     WILL_FIRE_RL_txRS_egress_Body || WILL_FIRE_RL_txRS_egress_EOF ;
  assign MUX_txRS_doPad$write_1__SEL_1 =
	     WILL_FIRE_RL_txRS_egress_EOF &&
	     txRS_lenCnt_value_25_ULT_60___d184 ;
  assign MUX_txRS_emitFCS$write_1__PSEL_1 =
	     WILL_FIRE_RL_txRS_egress_EOF || WILL_FIRE_RL_txRS_egress_PAD ;
  assign MUX_txRS_emitFCS$write_1__SEL_1 =
	     MUX_txRS_emitFCS$write_1__PSEL_1 &&
	     !txRS_lenCnt_value_25_ULT_60___d184 ;
  assign MUX_txRS_txActive$write_1__SEL_1 =
	     MUX_txRS_emitFCS$write_1__PSEL_1 &&
	     !txRS_lenCnt_value_25_ULT_60___d184 ;
  ...
  assign MUX_rxRS_rxF$enq_1__VAL_1 =
	     rxRS_crc_complete_0_EQ_rxRS_rxPipe_6_BITS_31_T_ETC___d260 ?
  ...
  begin
    case (txRS_emitFCS)
      3'd1: MUX_txRS_txData_1$wset_1__VAL_2 = txRS_crc$result[7:0];
      3'd2: MUX_txRS_txData_1$wset_1__VAL_2 = txRS_crc$result[15:8];
      3'd3: MUX_txRS_txData_1$wset_1__VAL_2 = txRS_crc$result[23:16];
      default: MUX_txRS_txData_1$wset_1__VAL_2 = txRS_crc$result[31:24];
    endcase
  end
  assign MUX_txRS_txData_1$wset_1__VAL_3 =
	     txRS_preambleCnt_value_9_ULT_7___d270 ?
	       8'd85 :
	       ((txRS_preambleCnt_value == 5'd7) ?
		  8'd213 :
  ...
  // inlined wires
  assign rxRS_eof_1$wget =
	     rxRS_crc_complete_0_EQ_rxRS_rxPipe_6_BITS_31_T_ETC___d260 ?
	       2'd1 :
	       2'd2 ;
  assign rxRS_eof_1$whas = MUX_rxRS_rxF$enq_1__SEL_1 ;
  always@(MUX_txRS_crc$add_1__SEL_2 or
	  txRS_txF$dD_OUT or
	  txRS_emitFCS or
	  MUX_txRS_txData_1$wset_1__VAL_2 or
	  WILL_FIRE_RL_txRS_egress_SOF or
	  MUX_txRS_txData_1$wset_1__VAL_3 or WILL_FIRE_RL_txRS_egress_PAD)
  begin
    case (1'b1) // synopsys parallel_case
      MUX_txRS_crc$add_1__SEL_2: txRS_txData_1$wget = txRS_txF$dD_OUT[7:0];
      txRS_emitFCS != 3'd0:
	  txRS_txData_1$wget = MUX_txRS_txData_1$wset_1__VAL_2;
      WILL_FIRE_RL_txRS_egress_SOF:
	  txRS_txData_1$wget = MUX_txRS_txData_1$wset_1__VAL_3;
      WILL_FIRE_RL_txRS_egress_PAD: txRS_txData_1$wget = 8'd0;
  ...
  assign rxRS_preambleCnt_incAction$whas = rxRS_rxDV && rxRS_rxData == 8'd85 ;
  assign rxRS_preambleCnt_decAction$whas = 1'b0 ;
  assign rxRS_crcDbgCnt_incAction$whas = rxRS_rxDV && rxRS_rxAPipe[3] ;
  ...
  assign txRS_ifgCnt_decAction$whas = txRS_ifgCnt_value != 5'h0 ;
  ...
  // register rxRS_crcEnd
  assign rxRS_crcEnd$D_IN = !rxRS_crcEnd ;
  assign rxRS_crcEnd$EN = rxRS_crcEnd || WILL_FIRE_RL_rxRS_ingress_noadvance ;

  // register rxRS_eof
  assign rxRS_eof$D_IN = MUX_rxRS_rxF$enq_1__SEL_1 ? rxRS_eof_1$wget : 2'd0 ;
  assign rxRS_eof$EN = 1'd1 ;

  // register rxRS_fullD
  assign rxRS_fullD$D_IN = !rxRS_rxF$sFULL_N ;
  assign rxRS_fullD$EN = 1'd1 ;

  // register rxRS_isSOF
  assign rxRS_isSOF$D_IN = rxRS_crcEnd ;
  assign rxRS_isSOF$EN = WILL_FIRE_RL_rxRS_egress_data || rxRS_crcEnd ;

  // register rxRS_preambleCnt_value
  assign rxRS_preambleCnt_value$D_IN =
	     rxRS_crcEnd ? 4'd0 : MUX_rxRS_preambleCnt_value$write_1__VAL_3 ;
  assign rxRS_preambleCnt_value$EN =
	     rxRS_preambleCnt_incAction$whas || rxRS_crcEnd ;

  // register rxRS_rxAPipe
  assign rxRS_rxAPipe$D_IN =
	     rxRS_crcEnd ? 6'd0 : MUX_rxRS_rxAPipe$write_1__VAL_2 ;
  assign rxRS_rxAPipe$EN = rxRS_rxDV || rxRS_crcEnd ;

  // register rxRS_rxActive
  assign rxRS_rxActive$D_IN = !rxRS_crcEnd ;
  assign rxRS_rxActive$EN =
	     rxRS_rxDV && rxRS_preambleCnt_value > 4'd6 &&
	     rxRS_rxData == 8'd213 ||
	     rxRS_crcEnd ;
  ...
  assign rxRS_rxDVD$EN = 1'd1 ;

  // register rxRS_rxDVD2
  assign rxRS_rxDVD2$D_IN = rxRS_rxDVD ;
  assign rxRS_rxDVD2$EN = 1'd1 ;
  ...
  assign rxRS_rxPipe$EN = rxRS_rxDV ;
  ...
  assign txRS_crcDbgCnt_value$EN =
	     txRS_emitFCS == 3'd4 ||
	     txRS_crcDbgCnt_incAction$whas && !(txRS_emitFCS != 3'd0) ;

  // register txRS_doPad
  assign txRS_doPad$D_IN = MUX_txRS_doPad$write_1__SEL_1 ;
  assign txRS_doPad$EN =
	     WILL_FIRE_RL_txRS_egress_EOF &&
	     txRS_lenCnt_value_25_ULT_60___d184 ||
	     WILL_FIRE_RL_txRS_egress_PAD &&
	     !txRS_lenCnt_value_25_ULT_60___d184 ;
  ...
  assign txRS_ifgCnt_value$EN =
	     txRS_emitFCS == 3'd1 || txRS_ifgCnt_value != 5'h0 ;
  ...
  assign txRS_lenCnt_value$EN =
	     txRS_emitFCS == 3'd1 ||
	     txRS_lenCnt_incAction$whas && !(txRS_emitFCS != 3'd0) ;
  ...
  assign txRS_preambleCnt_value$EN =
	     txRS_emitFCS == 3'd1 || WILL_FIRE_RL_txRS_egress_SOF ;

  // register txRS_txActive
  assign txRS_txActive$D_IN = !MUX_txRS_txActive$write_1__SEL_1 ;
  ...
  // register txRS_unfD
  assign txRS_unfD$D_IN = !txRS_txF$dEMPTY_N && txRS_txActive ;
  assign txRS_unfD$EN = 1'd1 ;

  // submodule rxRS_crc
  assign rxRS_crc$add_data = rxRS_rxPipe[31:24] ;
  assign rxRS_crc$EN_add = rxRS_rxDV && rxRS_rxAPipe[3] ;
  assign rxRS_crc$EN_clear = 1'b0 ;
  assign rxRS_crc$EN_complete = WILL_FIRE_RL_rxRS_ingress_noadvance ;

  // submodule rxRS_ovfBit
  assign rxRS_ovfBit$sD_IN = !rxRS_rxF$sFULL_N || rxRS_fullD ;
  assign rxRS_ovfBit$sEN = 1'd1 ;
  ...
  // submodule txRS_crc
  assign txRS_crc$add_data = txRS_txF$dD_OUT[7:0] ;
  assign txRS_crc$EN_add =
	     ...
	     WILL_FIRE_RL_txRS_egress_Body ||
	     WILL_FIRE_RL_txRS_egress_EOF ;
  assign txRS_crc$EN_clear = txRS_emitFCS == 3'd1 ;
  ...
  assign txRS_txF$dDEQ = txRS_crcDbgCnt_incAction$whas ;

  // submodule txRS_unfBit
  assign txRS_unfBit$sD_IN =
	     !txRS_txF$dEMPTY_N && txRS_txActive || txRS_unfD ;
  assign txRS_unfBit$sEN = 1'd1 ;

  // remaining internal signals
  assign rxRS_crc_complete_0_EQ_rxRS_rxPipe_6_BITS_31_T_ETC___d260 =
	     rxRS_crc$complete == rxRS_rxPipe[31:0] ;
  assign txRS_lenCnt_value_25_ULT_60___d184 = txRS_lenCnt_value < 12'd60 ;
  assign txRS_preambleCnt_value_9_ULT_7___d270 =
	     txRS_preambleCnt_value < 5'd7 ;
  ...
  begin
	...
	rxRS_eof <= `BSV_ASSIGNMENT_DELAY 2'd0;
	...
	if (rxRS_eof$EN) rxRS_eof <= `BSV_ASSIGNMENT_DELAY rxRS_eof$D_IN;
	if (rxRS_fullD$EN)
  ...
  begin
    #0;
    if (txRS_txRst$OUT_RST_N)
      if (txRS_emitFCS != 3'd0 && txRS_emitFCS == 3'd4)
	begin
	  v__h12040 = $time;
	  #0;
	end
