...
//
// On Thu Mar 29 16:41:23 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkGMAC(CLK_rxClk,
  ...
  assign MUX_txRS_doPad$write_1__SEL_1 =
	     WILL_FIRE_RL_txRS_egress_EOF &&
	     txRS_lenCnt_value_36_ULT_60___d195 ;
  ...
  // remaining internal signals
  assign txRS_lenCnt_value_36_ULT_60___d195 = txRS_lenCnt_value < 12'd60 ;
  assign txRS_preambleCnt_value_10_ULT_7___d284 =
	     txRS_preambleCnt_value < 5'd7 ;
