...
//
// On Fri May  4 16:16:24 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkGMAC(CLK_rxClk,
  ...
  wire [7 : 0] txRS_iobTxData$D0, txRS_iobTxData$D1, txRS_iobTxData$Q;
  wire txRS_iobTxData$CE, txRS_iobTxData$R, txRS_iobTxData$S;
  ...
  wire txRS_lenCnt_value_39_ULT_59___d304,
       txRS_preambleCnt_value_13_ULT_7___d303;
  ...
  // value method gmii_tx_txd
  assign gmii_tx_txd = txRS_iobTxData$Q ;
  ...
  ODDR2 #(.DDR_ALIGNMENT("NONE"),
	  .INIT(1'd0),
	  .SRTYPE("SYNC")) txRS_iobTxData(.C0(CLK_txClk),
  ...
  ODDR2 #(.DDR_ALIGNMENT("NONE"),
	  .INIT(1'd0),
	  .SRTYPE("SYNC")) txRS_iobTxEna(.C0(CLK_txClk),
  ...
  ODDR2 #(.DDR_ALIGNMENT("NONE"),
	  .INIT(1'd0),
	  .SRTYPE("SYNC")) txRS_iobTxErr(.C0(CLK_txClk),
  ...
  assign CAN_FIRE_RL_txRS_egress_EOF =
	     txRS_txF$dEMPTY_N &&
	     (txRS_lenCnt_value_39_ULT_59___d304 || txRS_txF$dEMPTY_N) &&
	     txRS_txOperateS$dD_OUT &&
	     txRS_txActive &&
  ...
  assign MUX_txRS_emitFCS$write_1__SEL_1 =
	     WILL_FIRE_RL_txRS_egress_EOF &&
	     !txRS_lenCnt_value_39_ULT_59___d304 ;
  ...
  // register txRS_doPad
  assign txRS_doPad$D_IN = txRS_lenCnt_value_39_ULT_59___d304 ;
  ...
  assign txRS_iobTxData$D0 = txRS_txData ;
  assign txRS_iobTxData$D1 = txRS_txData ;
  assign txRS_iobTxData$R = 1'd0 ;
  ...
  // remaining internal signals
  assign txRS_lenCnt_value_39_ULT_59___d304 = txRS_lenCnt_value < 12'd59 ;
  assign txRS_preambleCnt_value_13_ULT_7___d303 =
	     txRS_preambleCnt_value < 5'd7 ;
