...
//
// On Fri May 25 10:27:32 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkGMAC(CLK_rxClk,
  ...
  wire txRS_lenCnt_value_39_ULT_59___d322,
       txRS_preambleCnt_value_13_ULT_7___d321;
  ...
  assign CAN_FIRE_RL_txRS_egress_EOF =
	     txRS_txF$dEMPTY_N &&
	     (txRS_lenCnt_value_39_ULT_59___d322 || txRS_txF$dEMPTY_N) &&
	     txRS_txOperateS$dD_OUT &&
	     txRS_txActive &&
  ...
  assign MUX_txRS_emitFCS$write_1__SEL_1 =
	     WILL_FIRE_RL_txRS_egress_EOF &&
	     !txRS_lenCnt_value_39_ULT_59___d322 ;
  ...
  // register txRS_doPad
  assign txRS_doPad$D_IN = txRS_lenCnt_value_39_ULT_59___d322 ;
  ...
  // remaining internal signals
  assign txRS_lenCnt_value_39_ULT_59___d322 = txRS_lenCnt_value < 12'd59 ;
  assign txRS_preambleCnt_value_13_ULT_7___d321 =
	     txRS_preambleCnt_value < 5'd7 ;
