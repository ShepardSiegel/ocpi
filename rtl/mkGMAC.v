...
//
// On Thu Mar 29 09:03:13 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkGMAC(CLK_rxClk,
  ...
  assign MUX_txRS_doPad$write_1__SEL_1 =
	     WILL_FIRE_RL_txRS_egress_EOF &&
	     txRS_lenCnt_value_30_ULT_60___d189 ;
  ...
  // submodule rxRS_rxOperateS
  assign rxRS_rxOperateS$sD_IN = 1'd1 ;
  assign rxRS_rxOperateS$sEN = EN_rxOperate ;
  ...
  // remaining internal signals
  assign txRS_lenCnt_value_30_ULT_60___d189 = txRS_lenCnt_value < 12'd60 ;
  assign txRS_preambleCnt_value_04_ULT_7___d278 =
	     txRS_preambleCnt_value < 5'd7 ;
