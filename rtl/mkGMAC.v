...
//
// On Sat Mar 31 15:12:22 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkGMAC(CLK_rxClk,
  ...
  wire txRS_lenCnt_value_24_ULT_60___d175,
       txRS_preambleCnt_value_8_ULT_7___d277;
  ...
  assign MUX_txRS_doPad$write_1__SEL_1 =
	     WILL_FIRE_RL_txRS_egress_EOF &&
	     txRS_lenCnt_value_24_ULT_60___d175 ;
  ...
  // remaining internal signals
  assign txRS_lenCnt_value_24_ULT_60___d175 = txRS_lenCnt_value < 12'd60 ;
  assign txRS_preambleCnt_value_8_ULT_7___d277 =
	     txRS_preambleCnt_value < 5'd7 ;
