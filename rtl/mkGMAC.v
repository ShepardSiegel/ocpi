...
//
// On Sun Apr  1 18:30:52 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkGMAC(CLK_rxClk,
  ...
  wire rxRS_preambleCnt_decAction$whas,
  ...
  wire [11 : 0] MUX_txRS_lenCnt_value$write_1__VAL_2;
  wire [9 : 0] MUX_rxRS_rxF$enq_1__VAL_1, MUX_rxRS_rxF$enq_1__VAL_2;
  wire [7 : 0] MUX_txRS_txData_1$wset_1__VAL_2,
	       MUX_txRS_txData_1$wset_1__VAL_3;
  ...
  reg [7 : 0] IF_txRS_emitFCS_81_EQ_1_85_THEN_txRS_crc_resul_ETC___d259;
  reg [1 : 0] CASE_rxRS_rxFdD_OUT_BITS_9_TO_8_3_0_rxRS_rxF_ETC__q1,
	      CASE_tx_put_BITS_9_TO_8_3_0_tx_put_BITS_9_TO_8_ETC__q2;
  wire txRS_lenCnt_value_24_ULT_60___d178,
       txRS_preambleCnt_value_8_ULT_7___d292;
  ...
  BUFIO gmii_rx_clk(.I(gmii_rxc_dly$DATAOUT), .O());
  ...
  assign WILL_FIRE_RL_txRS_egress_Body =
	     CAN_FIRE_RL_txRS_egress_Body && !WILL_FIRE_RL_txRS_egress_PAD &&
	     !WILL_FIRE_RL_txRS_egress_FCS ;
  ...
  assign WILL_FIRE_RL_txRS_egress_PAD =
	     txRS_txOperateS$dD_OUT && txRS_txActive && txRS_doPad &&
	     !WILL_FIRE_RL_txRS_egress_FCS ;
  ...
  assign MUX_txRS_doPad$write_1__SEL_1 =
	     WILL_FIRE_RL_txRS_egress_EOF &&
	     txRS_lenCnt_value_24_ULT_60___d178 ;
  ...
  assign MUX_txRS_txData_1$wset_1__VAL_2 =
	     { IF_txRS_emitFCS_81_EQ_1_85_THEN_txRS_crc_resul_ETC___d259[0],
	       IF_txRS_emitFCS_81_EQ_1_85_THEN_txRS_crc_resul_ETC___d259[1],
	       IF_txRS_emitFCS_81_EQ_1_85_THEN_txRS_crc_resul_ETC___d259[2],
	       IF_txRS_emitFCS_81_EQ_1_85_THEN_txRS_crc_resul_ETC___d259[3],
	       IF_txRS_emitFCS_81_EQ_1_85_THEN_txRS_crc_resul_ETC___d259[4],
	       IF_txRS_emitFCS_81_EQ_1_85_THEN_txRS_crc_resul_ETC___d259[5],
	       IF_txRS_emitFCS_81_EQ_1_85_THEN_txRS_crc_resul_ETC___d259[6],
	       IF_txRS_emitFCS_81_EQ_1_85_THEN_txRS_crc_resul_ETC___d259[7] } ;
  ...
  // remaining internal signals
  assign txRS_lenCnt_value_24_ULT_60___d178 = txRS_lenCnt_value < 12'd60 ;
  assign txRS_preambleCnt_value_8_ULT_7___d292 =
	     txRS_preambleCnt_value < 5'd7 ;
  ...
  begin
    case (txRS_emitFCS)
      3'd1:
	  IF_txRS_emitFCS_81_EQ_1_85_THEN_txRS_crc_resul_ETC___d259 =
      ...
      default: IF_txRS_emitFCS_81_EQ_1_85_THEN_txRS_crc_resul_ETC___d259 =
		   txRS_crc$result[7:0];
    endcase
  end
  always@(tx_put)
