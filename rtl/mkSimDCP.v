...
//
// On Sat Sep 29 15:57:11 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkSimDCP(CLK,
  ...
  wire WILL_FIRE_RL_cp_to_dcp_response,
       ...
       WILL_FIRE_RL_edpFsm_action_l225c16,
       WILL_FIRE_RL_edpFsm_action_l226c16,
       WILL_FIRE_RL_edpFsm_action_l227c16,
       WILL_FIRE_RL_edpFsm_action_l228c16,
       WILL_FIRE_RL_edpFsm_fsm_start,
       WILL_FIRE_RL_edpFsm_idle_l217c3,
       WILL_FIRE_RL_edpFsm_idle_l217c3_1,
  ...
  wire [7 : 0] IF_dcpRespF_first__33_BIT_42_40_THEN_0x70_ELSE_ETC___d355;
  wire IF_NOT_dcpReqF_first__33_BITS_39_TO_32_51_EQ_I_ETC___d158,
       NOT_dcpReqF_first__33_BITS_78_TO_77_34_EQ_0_35_ETC___d219,
       dcpReqF_first__33_BITS_39_TO_32_51_EQ_IF_lastT_ETC___d396,
       dcpReqF_first__33_BITS_71_TO_64_38_EQ_IF_lastT_ETC___d394,
       dcpReqF_first__33_BITS_78_TO_77_34_EQ_0_35_OR__ETC___d166,
       dcpReqF_first__33_BITS_78_TO_77_34_EQ_1_37_AND_ETC___d207,
       edpFsm_abort_whas__33_AND_edpFsm_abort_wget__3_ETC___d322,
       edpFsm_abort_whas__33_AND_edpFsm_abort_wget__3_ETC___d330;
  ...
  // rule RL_edpFsm_action_l225c16
  assign WILL_FIRE_RL_edpFsm_action_l225c16 =
	     simRespF$FULL_N && !isWrtResp &&
	     edpFsm_state_mkFSMstate == 4'd6 ;

  // rule RL_edpFsm_action_l226c16
  assign WILL_FIRE_RL_edpFsm_action_l226c16 =
  ...
  // rule RL_edpFsm_idle_l217c3
  assign WILL_FIRE_RL_edpFsm_idle_l217c3 =
	     isWrtResp && !edpFsm_start_wire$whas &&
	     edpFsm_state_mkFSMstate == 4'd6 ;
  ...
  // rule RL_edpFsm_idle_l217c3_1
  assign WILL_FIRE_RL_edpFsm_idle_l217c3_1 =
	     !edpFsm_start_wire$whas && edpFsm_state_mkFSMstate == 4'd10 ;
  ...
  always@(MUX_edpFsm_state_mkFSMstate$write_1__SEL_1 or
	  ...
	  WILL_FIRE_RL_edpFsm_action_l225c16 or
	  WILL_FIRE_RL_edpFsm_action_l226c16 or
  ...
  begin
    case (1'b1) // synopsys parallel_case
      ...
      WILL_FIRE_RL_edpFsm_action_l218c14: edpFsm_state_mkFSMstate$D_IN = 4'd1;
      WILL_FIRE_RL_edpFsm_action_l219c14: edpFsm_state_mkFSMstate$D_IN = 4'd2;
      WILL_FIRE_RL_edpFsm_action_l220c14: edpFsm_state_mkFSMstate$D_IN = 4'd3;
      WILL_FIRE_RL_edpFsm_action_l221c14: edpFsm_state_mkFSMstate$D_IN = 4'd4;
      WILL_FIRE_RL_edpFsm_action_l222c14: edpFsm_state_mkFSMstate$D_IN = 4'd5;
      WILL_FIRE_RL_edpFsm_action_l223c14: edpFsm_state_mkFSMstate$D_IN = 4'd6;
      WILL_FIRE_RL_edpFsm_action_l225c16: edpFsm_state_mkFSMstate$D_IN = 4'd7;
      WILL_FIRE_RL_edpFsm_action_l226c16: edpFsm_state_mkFSMstate$D_IN = 4'd8;
      WILL_FIRE_RL_edpFsm_action_l227c16: edpFsm_state_mkFSMstate$D_IN = 4'd9;
      WILL_FIRE_RL_edpFsm_action_l228c16:
  ...
  // submodule simRespF
  always@(WILL_FIRE_RL_edpFsm_action_l218c14 or
	  eePli or
	  WILL_FIRE_RL_edpFsm_action_l219c14 or
	  WILL_FIRE_RL_edpFsm_action_l220c14 or
	  eeDmh or
  ...
  begin
    case (1'b1) // synopsys parallel_case
      WILL_FIRE_RL_edpFsm_action_l218c14: simRespF$D_IN = eePli[15:8];
      WILL_FIRE_RL_edpFsm_action_l219c14: simRespF$D_IN = eePli[7:0];
      WILL_FIRE_RL_edpFsm_action_l220c14: simRespF$D_IN = eeDmh[31:24];
      WILL_FIRE_RL_edpFsm_action_l221c14: simRespF$D_IN = eeDmh[23:16];
      WILL_FIRE_RL_edpFsm_action_l222c14: simRespF$D_IN = eeDmh[15:8];
      WILL_FIRE_RL_edpFsm_action_l223c14: simRespF$D_IN = eeDmh[7:0];
      WILL_FIRE_RL_edpFsm_action_l225c16: simRespF$D_IN = eeDat[31:24];
      WILL_FIRE_RL_edpFsm_action_l226c16: simRespF$D_IN = eeDat[23:16];
      WILL_FIRE_RL_edpFsm_action_l227c16: simRespF$D_IN = eeDat[15:8];
      WILL_FIRE_RL_edpFsm_action_l228c16: simRespF$D_IN = eeDat[7:0];
  ...
  assign IF_NOT_dcpReqF_first__33_BITS_39_TO_32_51_EQ_I_ETC___d158 =
	     (!dcpReqF_first__33_BITS_39_TO_32_51_EQ_IF_lastT_ETC___d396 ||
	      ...
	      dcpReqF$D_OUT[44]) ?
	       cpReqF$FULL_N :
	       dcpRespF$FULL_N ;
  assign IF_dcpRespF_first__33_BIT_42_40_THEN_0x70_ELSE_ETC___d355 =
	     dcpRespF$D_OUT[42] ? 8'h70 : 8'h30 ;
  assign NOT_dcpReqF_first__33_BITS_78_TO_77_34_EQ_0_35_ETC___d219 =
	     dcpReqF$D_OUT[78:77] != 2'd0 && dcpReqF$D_OUT[78:77] != 2'd1 &&
	     dcpReqF_first__33_BITS_39_TO_32_51_EQ_IF_lastT_ETC___d396 &&
	     lastTag[8] &&
	     !dcpReqF$D_OUT[44] ;
  assign dcpReqF_first__33_BITS_39_TO_32_51_EQ_IF_lastT_ETC___d396 =
	     dcpReqF$D_OUT[39:32] == lastTag[7:0] ;
  assign dcpReqF_first__33_BITS_71_TO_64_38_EQ_IF_lastT_ETC___d394 =
  ...
  assign dcpReqF_first__33_BITS_78_TO_77_34_EQ_1_37_AND_ETC___d207 =
	     ...
	     (!dcpReqF_first__33_BITS_39_TO_32_51_EQ_IF_lastT_ETC___d396 ||
	      !lastTag[8] ||
	      dcpReqF$D_OUT[44]) ;
  assign edpFsm_abort_whas__33_AND_edpFsm_abort_wget__3_ETC___d322 =
	     edpFsm_state_mkFSMstate == 4'd0 ||
	     isWrtResp && edpFsm_state_mkFSMstate == 4'd6 ;
  assign edpFsm_abort_whas__33_AND_edpFsm_abort_wget__3_ETC___d330 =
	     (edpFsm_abort_whas__33_AND_edpFsm_abort_wget__3_ETC___d322 ||
	      edpFsm_state_mkFSMstate == 4'd10) &&
	     (!edpFsm_start_reg_1 || edpFsm_state_fired) &&
	     !edpFsm_start_reg ;
  ...
  always@(dcpReqF$D_OUT or
	  ...
	  dcpRespF$FULL_N or
	  dcpReqF_first__33_BITS_71_TO_64_38_EQ_IF_lastT_ETC___d394 or
  ...
  always@(dcpRespF$D_OUT or
	  IF_dcpRespF_first__33_BIT_42_40_THEN_0x70_ELSE_ETC___d355)
  begin
    case (dcpRespF$D_OUT[44:43])
      2'd0:
	  CASE_dcpRespFD_OUT_BITS_44_TO_43_IF_dcpRespF__ETC__q3 =
  ...
  begin
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rx_sim_dcp && eDMH[13:12] == 2'b01)
	$display("[%0d]: rx_sim_dcp REQUEST: WRITE Addr:%0x Data:%0x",
		 v__h3781,
		 eAddr,
		 eData);
    if (RST_N != `BSV_RESET_VALUE)
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rx_sim_dcp && eDMH[13:12] == 2'd2)
	$display("[%0d]: rx_sim_dcp REQUEST: READ Addr:%0x ",
		 v__h3795,
		 eAddr);
    if (RST_N != `BSV_RESET_VALUE)
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_dcp_to_cp_request &&
	  NOT_dcpReqF_first__33_BITS_78_TO_77_34_EQ_0_35_ETC___d219)
	$display("[%0d]: dcp_to_cp_request ***TAG MATCH*** (Returning Previous Response)",
		 v__h5063);
    if (RST_N != `BSV_RESET_VALUE)
	  ...
	  (WILL_FIRE_RL_edpFsm_action_l220c14 ||
	   ...
	   WILL_FIRE_RL_edpFsm_action_l227c16 ||
	   WILL_FIRE_RL_edpFsm_action_l228c16))
	$display("Error: \"bsv/eth/SimDCP.bsv\", line 219, column 14: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_edpFsm_action_l219c14] and\n  [RL_edpFsm_action_l220c14, RL_edpFsm_action_l221c14,\n  RL_edpFsm_action_l222c14, RL_edpFsm_action_l223c14,\n  RL_edpFsm_action_l225c16, RL_edpFsm_action_l226c16,\n  RL_edpFsm_action_l227c16, RL_edpFsm_action_l228c16] ) fired in the same\n  clock cycle.\n");
    if (RST_N != `BSV_RESET_VALUE)
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_edpFsm_action_l226c16 &&
	  (WILL_FIRE_RL_edpFsm_action_l227c16 ||
	   WILL_FIRE_RL_edpFsm_action_l228c16))
	$display("Error: \"bsv/eth/SimDCP.bsv\", line 226, column 16: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_edpFsm_action_l226c16] and\n  [RL_edpFsm_action_l227c16, RL_edpFsm_action_l228c16] ) fired in the same\n  clock cycle.\n");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_edpFsm_action_l225c16 &&
	  (WILL_FIRE_RL_edpFsm_action_l226c16 ||
	   WILL_FIRE_RL_edpFsm_action_l227c16 ||
	   WILL_FIRE_RL_edpFsm_action_l228c16))
	$display("Error: \"bsv/eth/SimDCP.bsv\", line 225, column 16: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_edpFsm_action_l225c16] and\n  [RL_edpFsm_action_l226c16, RL_edpFsm_action_l227c16,\n  RL_edpFsm_action_l228c16] ) fired in the same clock cycle.\n");
    if (RST_N != `BSV_RESET_VALUE)
    ...
    if (RST_N != `BSV_RESET_VALUE)
	  ...
	  (WILL_FIRE_RL_edpFsm_action_l219c14 ||
	   ...
	   WILL_FIRE_RL_edpFsm_action_l227c16 ||
	   WILL_FIRE_RL_edpFsm_action_l228c16))
	$display("Error: \"bsv/eth/SimDCP.bsv\", line 218, column 14: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_edpFsm_action_l218c14] and\n  [RL_edpFsm_action_l219c14, RL_edpFsm_action_l220c14,\n  RL_edpFsm_action_l221c14, RL_edpFsm_action_l222c14,\n  RL_edpFsm_action_l223c14, RL_edpFsm_action_l225c16,\n  RL_edpFsm_action_l226c16, RL_edpFsm_action_l227c16,\n  RL_edpFsm_action_l228c16] ) fired in the same clock cycle.\n");
    if (RST_N != `BSV_RESET_VALUE)
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_sim_egress && dcpRespF$D_OUT[44:43] == 2'd0)
	$display("[%0d]: sim_egress NOP RESPONSE", v__h26990);
    if (RST_N != `BSV_RESET_VALUE)
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_sim_egress && dcpRespF$D_OUT[44:43] == 2'd1)
	$display("[%0d]: sim_egress WRITE RESPONSE", v__h27148);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_sim_egress && dcpRespF$D_OUT[44:43] != 2'd0 &&
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_sim_egress && dcpRespF$D_OUT[44:43] != 2'd0 &&
	  dcpRespF$D_OUT[44:43] != 2'd1)
	$display("[%0d]: sim_egress READ RESPONSE Data:%0x ",
		 v__h27347,
