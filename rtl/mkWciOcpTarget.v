...
//
// On Sun Nov  7 11:39:21 EST 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkWciOcpTarget(wciS0_Clk,
  ...
  wire CAN_FIRE_RL_target_ctlAckReg__dreg_update,
  ...
  reg [63 : 0] v__h2642, v__h2800, v__h3699;
  ...
  assign CAN_FIRE_RL_target_reqF_enq = target_wciReq$wget[59:57] != 3'd0 ;
  ...
  assign CAN_FIRE_RL_target_respF_decCtr =
	     target_respF_c_r != 2'd0 && !CAN_FIRE_RL_target_ctl_op_complete ;
  ...
  assign target_respF_enqueueing$whas = CAN_FIRE_RL_target_ctl_op_complete ;
  assign target_respF_x_wire$wget = MUX_target_respF_q_0$write_1__VAL_1 ;
  assign target_respF_x_wire$whas = CAN_FIRE_RL_target_ctl_op_complete ;
  ...
  assign target_wci_ctrl_pw$whas =
	     target_reqF$EMPTY_N && !target_reqF$D_OUT[56] &&
	     target_reqF$D_OUT[59:57] == 3'd2 ;
  assign target_reqF_r_deq$whas = WILL_FIRE_RL_target_ctl_op_start ;
  assign target_wEdge$whas = WILL_FIRE_RL_target_ctl_op_start ;
  assign target_ctlAckReg_1$wget = 1'b0 ;
  assign target_ctlAckReg_1$whas = 1'b0 ;
  ...
  // register target_ctlAckReg
  assign target_ctlAckReg$D_IN = 1'b0 ;
  ...
  assign target_reqF$DEQ = WILL_FIRE_RL_target_ctl_op_start ;
