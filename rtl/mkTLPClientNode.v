...
//
// On Wed Oct 30 15:56:48 EDT 2013
//
//
// Ports:
// Name                         I/O  size props
...
module mkTLPClientNode(pfk,
  ...
  // action method s_request_put
  assign RDY_s_request_put = pktMerge_RDY_iport0_put ;

  // actionvalue method s_response_get
  assign s_response_get = pktFork_oport0_get ;
  assign RDY_s_response_get = pktFork_RDY_oport0_get ;
  ...
  assign pktFork_EN_oport0_get = EN_s_response_get ;
  assign pktFork_EN_oport1_get =
	     pktMerge_RDY_iport1_put && pktFork_RDY_oport1_get ;

  // submodule pktMerge
  assign pktMerge_iport0_put = s_request_put ;
  assign pktMerge_iport1_put = pktFork_oport1_get ;
  assign pktMerge_EN_iport0_put = EN_s_request_put ;
