...
//
// On Tue Feb  8 14:06:21 EST 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkTB13(CLK,
  ...
  wire WILL_FIRE_RL_wciSeqFsm_actionof_l41c3_5,
       WILL_FIRE_RL_wciSeqFsm_actionof_l66c19,
  ...
  wire [15 : 0] wsiBurstLength__h20352, x__h20250, x__h20720;
  wire NOT_wciSeqFsm_abort_whas__18_41_OR_NOT_wciSeqF_ETC___d346,
       wci_respTimr_7_ULT_1_SL_wci_wTimeout_8_9___d533,
       wsiS_reqFifo_first__42_BITS_43_TO_12_43_EQ_dst_ETC___d484,
  ...
  // rule RL_wciSeqFsm_actionof_l41c3_5
  assign WILL_FIRE_RL_wciSeqFsm_actionof_l41c3_5 =
	     wciSeqFsm_state_mkFSMstate == 4'd1 &&
	     !wciSeqFsm_start_wire$whas &&
	     !wciSeqFsm_state_standby ;

  // rule RL_wciSeqFsm_actionof_l66c19
  assign WILL_FIRE_RL_wciSeqFsm_actionof_l66c19 =
	     wciSeqFsm_state_mkFSMstate == 4'd1 &&
	     NOT_wciSeqFsm_abort_whas__18_41_OR_NOT_wciSeqF_ETC___d346 ;
  ...
  assign MUX_wciSeqFsm_state_mkFSMstate$write_1__SEL_1 =
	     WILL_FIRE_RL_wciSeqFsm_actionof_l41c3_5 ||
  ...
  assign MUX_dstUnrollCnt$write_1__VAL_2 =
	     wsiS_reqFifo$D_OUT[57] ? wsiBurstLength__h20352 : x__h20720 ;
  assign MUX_srcUnrollCnt$write_1__VAL_2 =
	     (srcUnrollCnt == 16'd1) ? 16'd16 : x__h20250 ;
  ...
  assign wciSeqFsm_pw_list_2$whas = WILL_FIRE_RL_wciSeqFsm_actionof_l66c19 ;
  ...
  assign wciSeqFsm_pw_list_7$whas = 1'b0 ;
  ...
  assign enWsiChecker$EN = wciSeqFsm_state_mkFSMstate == 4'd3 ;

  // register enWsiSource
  assign enWsiSource$D_IN = 1'd1 ;
  assign enWsiSource$EN = wciSeqFsm_state_mkFSMstate == 4'd5 ;
  ...
  assign testOperating$EN = WILL_FIRE_RL_wciSeqFsm_actionof_l66c19 ;
  ...
  always@(MUX_wciSeqFsm_state_mkFSMstate$write_1__SEL_1 or
	  WILL_FIRE_RL_wciSeqFsm_actionof_l66c19 or
  ...
  assign IF_wci_lastControlOp_22_BIT_3_23_THEN_wci_last_ETC___d137 =
	     { wci_lastControlOp[3] ? wci_lastControlOp[2:0] : 3'b111,
	       ...
	       wci_reqFAIL,
	       wci_reqERR } ;
  assign NOT_wciSeqFsm_abort_whas__18_41_OR_NOT_wciSeqF_ETC___d346 =
	     wciSeqFsm_start_wire$whas || wciSeqFsm_state_standby ;
  assign toCount__h2445 = 32'd1 << wci_wTimeout ;
  assign wci_respTimr_7_ULT_1_SL_wci_wTimeout_8_9___d533 =
	     wci_respTimr < toCount__h2445 ;
  assign wsiBurstLength__h20352 = { 4'd0, wsiS_reqFifo$D_OUT[55:44] } ;
  assign wsiS_reqFifo_first__42_BITS_43_TO_12_43_EQ_dst_ETC___d484 =
  ...
  assign wsiS_reqFifo_notFull__56_AND_wsiS_burstKind_71_ETC___d278 =
	     ...
	     (wsiS_burstKind == 2'd0 ||
	      ...
	      wsiS_wsiReq$wget[57]) ;
  assign x__h20250 = srcUnrollCnt - 16'd1 ;
  assign x__h20720 = dstUnrollCnt - 16'd1 ;
  ...
  begin
    ...
    if (RST_N)
      if (simCycle == 16'd1000)
	$display("[%0d]: %m: mkTB13 termination", v__h20951);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_wciSeqFsm_actionof_l41c3_5 ||
	  wciSeqFsm_state_mkFSMstate == 4'd6)
	$write("");
    if (RST_N)
