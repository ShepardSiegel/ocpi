...
//
// On Wed May 23 14:00:40 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkOCDP16B(pciDevice,
  ...
  reg [31 : 0] IF_0_MINUS_tlp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2505,
	       ...
	       IF_2_MINUS_tlp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2507,
	       IF_3_MINUS_tlp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2508,
	       IF_tlp_tlpBRAM_readReq_first__97_BITS_30_TO_29_ETC___d2409,
	       _theResult____h90074;
  ...
  reg [1 : 0] lowAddr10__h28461, x__h28590, x__h28613;
  reg CASE_dpControl_BITS_1_TO_0_NOT_bml_fabDone_0_N_ETC__q7,
      ...
      IF_2_MINUS_tlp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2465,
      IF_2_MINUS_tlp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d695,
      IF_3_MINUS_tlp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2466,
  ...
  wire [127 : 0] IF_tlp_fabMesgAddrMS_186_EQ_0_187_THEN_0_ELSE__ETC___d1461,
  ...
  wire [31 : 0] bml_fabFlowAddr_047_PLUS_bml_fabFlowSize_048___d2646,
		mesgMeta_opcode__h80205,
		nowLS__h44687,
		nowLS__h60988,
		nowMS__h43744,
		nowMS__h60047,
  ...
  wire [15 : 0] w_be__h47082,
		...
		y__h46101,
		y__h62936;
  wire [12 : 0] spanToNextPage__h45933,
		spanToNextPage__h62238,
		thisRequestLength__h45934,
		thisRequestLength__h62239,
		tlp_tlpBRAM_readNxtDWAddr_PLUS_1__q10,
		tlp_tlpBRAM_readNxtDWAddr_PLUS_2__q11,
		tlp_tlpBRAM_readNxtDWAddr_PLUS_3__q9,
		tlp_tlpBRAM_writeDWAddr_PLUS_1__q13,
		tlp_tlpBRAM_writeDWAddr_PLUS_2__q14,
		tlp_tlpBRAM_writeDWAddr_PLUS_3__q12,
		y__h17303,
		y__h26073;
  wire [11 : 0] byteCount__h28463, x__h28581, x__h28583, y__h28582, y__h28584;
  wire [9 : 0] y__h17374, y__h26025, y__h29523, y__h46662;
  wire [7 : 0] rreq_tag__h46149, tag__h62514, tagm__h62729;
  wire [6 : 0] lowAddr__h28462;
  wire [3 : 0] lastBE__h46370, lastBE__h62546;
  ...
  wire [1 : 0] ab__h10383,
	       ...
	       idx__h27161,
	       idx__h27534,
	       tlp_tlpBRAM_readReq_first__97_BITS_30_TO_29_99_ETC___d2406;
  wire IF_1_MINUS_tlp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d708,
       IF_tlp_tlpBRAM_readReq_first__97_BITS_30_TO_29_ETC___d921,
       NOT_bml_lclBufDone_032_099_AND_IF_bml_dpContro_ETC___d2112,
       NOT_wmi_wrActive_827_828_OR_NOT_wmi_rdActive_8_ETC___d1837,
       _dfoo5,
       bml_crdBuf_value_990_EQ_bml_crdBuf_modulus_bw__ETC___d2785,
       bml_fabBuf_value_975_EQ_bml_fabBuf_modulus_bw__ETC___d2786,
       bml_lclBufDone_032_AND_IF_bml_dpControl_wget___ETC___d2474,
       bml_lclBuf_value_945_EQ_bml_lclBuf_modulus_bw__ETC___d2804,
       bml_remBuf_value_960_EQ_bml_remBuf_modulus_bw__ETC___d2805,
       bram_serverAdapterA_1_cnt_44_SLT_3___d2651,
       bram_serverAdapterA_2_cnt_62_SLT_3___d2652,
       bram_serverAdapterA_2_outDataCore_notEmpty__38_ETC___d993,
       bram_serverAdapterA_3_cnt_80_SLT_3___d2653,
       bram_serverAdapterA_cnt_6_SLT_3___d2650,
       bram_serverAdapterA_outDataCore_notEmpty_OR_br_ETC___d995,
       bram_serverAdapterB_1_cnt_03_SLT_3___d1777,
       bram_serverAdapterB_1_outData_outData_whas__79_ETC___d1805,
       bram_serverAdapterB_2_cnt_21_SLT_3___d1778,
       bram_serverAdapterB_3_cnt_39_SLT_3___d1779,
       bram_serverAdapterB_cnt_5_SLT_3_776_AND_bram_s_ETC___d1782,
       bram_serverAdapterB_cnt_5_SLT_3___d1776,
       bram_serverAdapterB_outData_outData_whas__795__ETC___d1807,
       ...
       hasPull_AND_tlp_dpControl_wget__072_BITS_7_TO__ETC___d1518,
       hasPush_AND_tlp_dpControl_wget__072_BITS_7_TO__ETC___d1093,
       hasPush_AND_tlp_dpControl_wget__072_BITS_7_TO__ETC___d1166,
       hasPush_AND_tlp_dpControl_wget__072_BITS_7_TO__ETC___d1206,
       hasPush_AND_tlp_dpControl_wget__072_BITS_7_TO__ETC___d1263,
       tlp_dmaPullRemainDWLen_481_ULE_tlp_dmaPullRema_ETC___d2647,
       tlp_dmaPullRemainDWSub_495_ULE_4___d2648,
       tlp_inF_first__367_BITS_63_TO_56_370_EQ_pciDev_ETC___d1380,
       tlp_inF_first__367_BIT_152_570_AND_NOT_tlp_inF_ETC___d1595,
       tlp_outDwRemain_237_ULE_4___d2583,
       tlp_tlpBRAM_mReqF_first__18_BIT_60_02_OR_IF_tl_ETC___d813,
       tlp_tlpBRAM_mReqF_first__18_BIT_63_19_OR_IF_tl_ETC___d634,
       tlp_tlpBRAM_mRespF_first__108_BITS_71_TO_62_20_ETC___d2403,
       tlp_tlpBRAM_rdRespDwRemain_024_ULE_4___d1026,
       tlp_tlpBRAM_readRemainDWLen_46_ULE_4___d847,
       tlp_tlpBRAM_writeRemainDWLen_62_ULE_1___d2398,
       tlp_tlpBRAM_writeRemainDWLen_62_ULE_2___d2400,
  ...
  assign MUX_bml_fabBufsAvail$write_1__VAL_1 =
	     (bml_fabAvail && !bml_remStart) ? x__h88190 : x__h88195 ;
  assign MUX_bml_fabBufsAvail$write_1__VAL_2 =
	     (dpControl[3:2] == 2'd1) ? x__h86839 : 16'd0 ;
  assign MUX_bml_fabFlowAddr$write_1__VAL_1 =
	     bml_fabBuf_value_975_EQ_bml_fabBuf_modulus_bw__ETC___d2786 ?
	       bml_fabFlowBase :
	       bml_fabFlowAddr_047_PLUS_bml_fabFlowSize_048___d2646 ;
  ...
  assign MUX_bml_lclCredit$write_1__VAL_1 =
	     (bml_lclBufDone && !bml_remStart) ? x__h88228 : x__h88233 ;
  ...
  always@(idx__h19089 or
	  tlp_tlpBRAM_writeDWAddr_PLUS_3__q12 or
	  tlp_tlpBRAM_writeDWAddr or
	  tlp_tlpBRAM_writeDWAddr_PLUS_1__q13 or
	  tlp_tlpBRAM_writeDWAddr_PLUS_2__q14)
  begin
    case (idx__h19089)
	  ...
	  MUX_bram_memory$a_put_2__VAL_3 =
	      tlp_tlpBRAM_writeDWAddr_PLUS_1__q13[12:2];
      2'd2:
	  MUX_bram_memory$a_put_2__VAL_3 =
	      tlp_tlpBRAM_writeDWAddr_PLUS_2__q14[12:2];
      2'd3:
	  MUX_bram_memory$a_put_2__VAL_3 =
	      tlp_tlpBRAM_writeDWAddr_PLUS_3__q12[12:2];
    endcase
  end
  always@(idx__h26320 or
	  tlp_tlpBRAM_readNxtDWAddr_PLUS_3__q9 or
	  tlp_tlpBRAM_readNxtDWAddr or
	  tlp_tlpBRAM_readNxtDWAddr_PLUS_1__q10 or
	  tlp_tlpBRAM_readNxtDWAddr_PLUS_2__q11)
  begin
    case (idx__h26320)
      ...
      2'd1:
	  MUX_bram_memory$a_put_2__VAL_4 =
	      tlp_tlpBRAM_readNxtDWAddr_PLUS_1__q10[12:2];
      2'd2:
	  MUX_bram_memory$a_put_2__VAL_4 =
	      tlp_tlpBRAM_readNxtDWAddr_PLUS_2__q11[12:2];
      2'd3:
	  MUX_bram_memory$a_put_2__VAL_4 =
	      tlp_tlpBRAM_readNxtDWAddr_PLUS_3__q9[12:2];
    endcase
  end
  ...
  assign MUX_bram_memory_2$a_put_3__VAL_3 =
	     { IF_2_MINUS_tlp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2507[7:0],
	       IF_2_MINUS_tlp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2507[15:8],
	       IF_2_MINUS_tlp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2507[23:16],
	       IF_2_MINUS_tlp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2507[31:24] } ;
  always@(idx__h23928 or
	  tlp_tlpBRAM_writeDWAddr_PLUS_3__q12 or
	  tlp_tlpBRAM_writeDWAddr or
	  tlp_tlpBRAM_writeDWAddr_PLUS_1__q13 or
	  tlp_tlpBRAM_writeDWAddr_PLUS_2__q14)
  ...
  assign MUX_bram_memory_3$a_put_3__VAL_3 =
	     { IF_3_MINUS_tlp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2508[7:0],
	       IF_3_MINUS_tlp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2508[15:8],
	       IF_3_MINUS_tlp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2508[23:16],
	       IF_3_MINUS_tlp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2508[31:24] } ;
  ...
  assign MUX_tlp_fabMesgAccu$write_1__VAL_2 = tlp_fabMesgAccu + y__h46715 ;
  assign MUX_tlp_fabMesgAccu$write_1__VAL_3 = tlp_fabMesgAccu + y__h62335 ;
  ...
  assign MUX_tlp_mesgComplReceived$write_1__VAL_2 =
	     tlp_mesgComplReceived + y__h63643 ;
  ...
  assign MUX_tlp_mesgLengthRemainPull$write_1__VAL_3 =
	     tlp_mesgLengthRemainPull - y__h62264 ;
  ...
  assign MUX_tlp_mesgLengthRemainPush$write_1__VAL_3 =
	     tlp_mesgLengthRemainPush - y__h45959 ;
  assign MUX_tlp_outDwRemain$write_1__VAL_1 =
	     tlp_tlpBRAM_mRespF$D_OUT[71:62] - y__h46662 ;
  ...
  assign MUX_tlp_outF$enq_1__VAL_5 =
	     { 9'd386,
	       ...
	       IF_tlp_fabMesgAddrMS_186_EQ_0_187_THEN_0_ELSE__ETC___d1461 } ;
  assign MUX_tlp_outF$enq_1__VAL_6 =
	     (tlp_fabFlowAddrMS == 32'd0) ?
	       { 25'd25362431, w_data__h64162 } :
	       (tlp_sentTail4DWHeader ?
		  { 25'd8581120, w_data__h65496 } :
		  { 25'd16973823, w_data__h65250 }) ;
  ...
  assign MUX_tlp_remMesgAccu$write_1__VAL_2 = tlp_remMesgAccu + y__h46101 ;
  assign MUX_tlp_remMesgAccu$write_1__VAL_3 = tlp_remMesgAccu + y__h62936 ;
  assign MUX_tlp_reqMesgInFlight$write_1__VAL_2 =
	     !tlp_dmaPullRemainDWSub_495_ULE_4___d2648 ||
	     !tlp_dmaPullRemainDWLen_481_ULE_tlp_dmaPullRema_ETC___d2647 ;
  assign MUX_tlp_srcMesgAccu$write_1__VAL_2 = tlp_srcMesgAccu + y__h46053 ;
  ...
  assign MUX_tlp_tlpBRAM_mReqF$enq_1__VAL_3 =
	     { 69'h12AAAAAAAAAAAAAAAA,
	       ...
	       thisRequestLength__h45934[11:2],
	       8'd255,
	       rreq_tag__h46149,
	       3'h2 } ;
  ...
  assign MUX_tlp_tlpBRAM_rdRespDwRemain$write_1__VAL_1 =
	     tlp_tlpBRAM_readReq$D_OUT[28:19] - y__h29523 ;
  ...
  assign MUX_tlp_tlpBRAM_readNxtDWAddr$write_1__VAL_1 =
	     tlp_tlpBRAM_mReqF$D_OUT[41:29] + y__h26073 ;
  ...
  assign MUX_tlp_tlpBRAM_readRemainDWLen$write_1__VAL_1 =
	     tlp_tlpBRAM_mReqF$D_OUT[28:19] - y__h26025 ;
  ...
  assign MUX_tlp_tlpBRAM_writeDWAddr$write_1__VAL_1 =
	     tlp_tlpBRAM_mReqF$D_OUT[62:50] + y__h17303 ;
  ...
  assign MUX_tlp_tlpBRAM_writeRemainDWLen$write_1__VAL_1 =
	     tlp_tlpBRAM_mReqF$D_OUT[49:40] - y__h17374 ;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, _theResult____h90074 } ;
  ...
  assign MUX_wmi_wmi_respF_q_0$write_1__VAL_1 =
	     (wmi_wmi_respF_c_r == 2'd1) ?
	       MUX_wmi_wmi_respF_q_0$write_1__VAL_2 :
	       wmi_wmi_respF_q_1 ;
  assign MUX_wmi_wmi_respF_q_0$write_1__VAL_2 = { 2'd1, rdata__h82055 } ;
  ...
  assign tlp_pullTagMatch_1$wget =
	     tagm__h62729 == tlp_inF$D_OUT[47:40] &&
	     tlp_inF_first__367_BITS_63_TO_56_370_EQ_pciDev_ETC___d1380 ;
  ...
  begin
    case (1'b1) // synopsys parallel_case
      WILL_FIRE_RL_tlp_dmaPullRequestFarMesg:
	  tlp_dmaPullRemainDWLen$D_IN = thisRequestLength__h62239[11:2];
      WILL_FIRE_RL_tlp_dmaPullResponseHeader:
  ...
  always@(WILL_FIRE_RL_tlp_dmaPullResponseHeader or
	  tlp_inF$D_OUT or
	  WILL_FIRE_RL_tlp_dmaPullResponseBody or
	  tlp_dmaPullRemainDWSub_495_ULE_4___d2648 or
	  WILL_FIRE_RL_tlp_dmaPullRequestFarMesg)
  begin
    case (1'b1) // synopsys parallel_case
      WILL_FIRE_RL_tlp_dmaPullResponseHeader:
  ...
  begin
    case (1'b1) // synopsys parallel_case
      ...
      WILL_FIRE_RL_tlp_dmaPullResponseBody:
	  tlp_tlpRcvBusy$D_IN = !tlp_dmaPullRemainDWSub_495_ULE_4___d2648;
  ...
  begin
    case (1'b1) // synopsys parallel_case
      ...
      WILL_FIRE_RL_wmi_doWriteFinalize: bram_memory$DIB = x3__h80165;
      WILL_FIRE_RL_wmi_reqMetadata || WILL_FIRE_RL_wmi_doReadReq:
  ...
  begin
    case (1'b1) // synopsys parallel_case
      ...
      WILL_FIRE_RL_wmi_doWriteFinalize:
	  bram_memory_1$DIB = mesgMeta_opcode__h80205;
      WILL_FIRE_RL_wmi_reqMetadata || WILL_FIRE_RL_wmi_doReadReq:
  ...
  assign IF_1_MINUS_tlp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d708 =
	     ...
	     (IF_3_MINUS_tlp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d705 ||
	      bram_serverAdapterA_3_cnt_80_SLT_3___d2653) ;
  assign IF_tlp_fabMesgAddrMS_186_EQ_0_187_THEN_0_ELSE__ETC___d1461 =
	     { (tlp_fabMesgAddrMS == 32'd0) ? 22'd0 : 22'd524288,
	       thisRequestLength__h62239[11:2],
	       pciDevice,
	       tag__h62514,
	       lastBE__h62546,
	       4'd15,
  ...
  assign IF_tlp_tlpBRAM_readReq_first__97_BITS_30_TO_29_ETC___d1037 =
	     tlp_tlpBRAM_readReq_first__97_BITS_30_TO_29_99_ETC___d2406[0] ?
	       { bram_serverAdapterA_3_outData_outData$wget[7:0],
		 bram_serverAdapterA_3_outData_outData$wget[15:8],
		 bram_serverAdapterA_3_outData_outData$wget[23:16],
		 bram_serverAdapterA_3_outData_outData$wget[31:24],
  ...
  assign IF_tlp_tlpBRAM_readReq_first__97_BITS_30_TO_29_ETC___d921 =
	     IF_tlp_tlpBRAM_readReq_first__97_BITS_30_TO_29_ETC___d912 &&
	     CASE_tlp_tlpBRAM_readReqD_OUT_BITS_30_TO_29_N_ETC__q17 ;
  assign NOT_bml_lclBufDone_032_099_AND_IF_bml_dpContro_ETC___d2112 =
	     !bml_lclBufDone &&
	     CASE_dpControl_BITS_1_TO_0_bml_fabDone_0_bml_f_ETC__q3 ;
  assign NOT_wmi_wrActive_827_828_OR_NOT_wmi_rdActive_8_ETC___d1837 =
  ...
  assign ab__h8853 =
	     MUX_bram_serverAdapterB_1_writeWithResp$wset_1__SEL_1 ?
	       2'd0 :
	       2'd2 ;
  assign bml_crdBuf_value_990_EQ_bml_crdBuf_modulus_bw__ETC___d2785 =
	     bml_crdBuf_value == bml_crdBuf_modulus ;
  assign bml_fabBuf_value_975_EQ_bml_fabBuf_modulus_bw__ETC___d2786 =
	     bml_fabBuf_value == bml_fabBuf_modulus ;
  assign bml_fabFlowAddr_047_PLUS_bml_fabFlowSize_048___d2646 =
	     bml_fabFlowAddr + bml_fabFlowSize ;
  assign bml_lclBufDone_032_AND_IF_bml_dpControl_wget___ETC___d2474 =
	     bml_lclBufDone &&
	     CASE_dpControl_BITS_1_TO_0_NOT_bml_fabDone_0_N_ETC__q7 ;
  assign bml_lclBuf_value_945_EQ_bml_lclBuf_modulus_bw__ETC___d2804 =
	     bml_lclBuf_value == bml_lclBuf_modulus ;
  assign bml_remBuf_value_960_EQ_bml_remBuf_modulus_bw__ETC___d2805 =
  ...
  assign bram_serverAdapterA_1_cnt_44_SLT_3___d2651 =
  ...
  assign bram_serverAdapterA_2_cnt_62_SLT_3___d2652 =
  ...
  assign bram_serverAdapterA_3_cnt_80_SLT_3___d2653 =
  ...
  assign bram_serverAdapterA_cnt_6_SLT_3___d2650 =
  ...
  assign bram_serverAdapterB_1_cnt_03_SLT_3___d1777 =
	     (bram_serverAdapterB_1_cnt ^ 3'h4) < 3'd7 ;
  assign bram_serverAdapterB_1_outData_outData_whas__79_ETC___d1805 =
	     bram_serverAdapterB_1_outData_outData$whas &&
	     (bram_serverAdapterB_2_outDataCore$EMPTY_N ||
	      bram_serverAdapterB_2_outData_enqData$whas) &&
	     bram_serverAdapterB_2_outData_outData$whas &&
  ...
  assign bram_serverAdapterB_2_cnt_21_PLUS_IF_bram_serv_ETC___d327 =
	     ...
	     (bram_serverAdapterB_outData_deqCalled$whas ? 3'd7 : 3'd0) ;
  assign bram_serverAdapterB_2_cnt_21_SLT_3___d1778 =
  ...
  assign bram_serverAdapterB_3_cnt_39_PLUS_IF_bram_serv_ETC___d445 =
	     ...
	     (bram_serverAdapterB_outData_deqCalled$whas ? 3'd7 : 3'd0) ;
  assign bram_serverAdapterB_3_cnt_39_SLT_3___d1779 =
  ...
  assign bram_serverAdapterB_cnt_5_PLUS_IF_bram_serverA_ETC___d91 =
	     ...
	     (bram_serverAdapterB_outData_deqCalled$whas ? 3'd7 : 3'd0) ;
  assign bram_serverAdapterB_cnt_5_SLT_3_776_AND_bram_s_ETC___d1782 =
	     bram_serverAdapterB_cnt_5_SLT_3___d1776 &&
	     bram_serverAdapterB_1_cnt_03_SLT_3___d1777 &&
	     bram_serverAdapterB_2_cnt_21_SLT_3___d1778 &&
	     bram_serverAdapterB_3_cnt_39_SLT_3___d1779 ;
  assign bram_serverAdapterB_cnt_5_SLT_3___d1776 =
	     (bram_serverAdapterB_cnt ^ 3'h4) < 3'd7 ;
  assign bram_serverAdapterB_outData_outData_whas__795__ETC___d1807 =
	     bram_serverAdapterB_outData_outData$whas &&
	     (bram_serverAdapterB_1_outDataCore$EMPTY_N ||
	      bram_serverAdapterB_1_outData_enqData$whas) &&
	     bram_serverAdapterB_1_outData_outData_whas__79_ETC___d1805 ;
  assign byteCount__h28463 = x__h28581 - y__h28582 ;
  assign hasPull_AND_tlp_dpControl_wget__072_BITS_7_TO__ETC___d1341 =
	     ...
	     !tlp_reqMetaBodyInFlight &&
	     !tlp_fabMeta[128] ;
  assign hasPull_AND_tlp_dpControl_wget__072_BITS_7_TO__ETC___d1382 =
	     hasPull && dpControl[7:4] == 4'd0 && dpControl[3:2] == 2'd2 &&
	     dpControl[1:0] == 2'd1 &&
	     tlp_reqMetaInFlight &&
	     !tlp_tlpRcvBusy &&
	     tagm__h62729 == tlp_inF$D_OUT[47:40] &&
	     tlp_inF_first__367_BITS_63_TO_56_370_EQ_pciDev_ETC___d1380 ;
  assign hasPull_AND_tlp_dpControl_wget__072_BITS_7_TO__ETC___d1434 =
	     hasPull && dpControl[7:4] == 4'd0 && dpControl[3:2] == 2'd2 &&
	     dpControl[1:0] == 2'd1 &&
	     tlp_fabMeta[128] &&
  ...
  assign hasPull_AND_tlp_dpControl_wget__072_BITS_7_TO__ETC___d1473 =
	     hasPull && dpControl[7:4] == 4'd0 && dpControl[3:2] == 2'd2 &&
	     dpControl[1:0] == 2'd1 &&
	     tlp_fabMeta[128] &&
	     tlp_reqMesgInFlight &&
  ...
  assign hasPull_AND_tlp_dpControl_wget__072_BITS_7_TO__ETC___d1493 =
	     hasPull && dpControl[7:4] == 4'd0 && dpControl[3:2] == 2'd2 &&
	     dpControl[1:0] == 2'd1 &&
	     tlp_fabMeta[128] &&
	     tlp_reqMesgInFlight &&
	     tlp_gotResponseHeader ;
  assign hasPull_AND_tlp_dpControl_wget__072_BITS_7_TO__ETC___d1518 =
	     hasPull && dpControl[7:4] == 4'd0 && dpControl[3:2] == 2'd2 &&
	     dpControl[1:0] == 2'd1 &&
	     tlp_fabMeta[128] &&
	     tlp_dmaDoTailEvent &&
  ...
  assign hasPush_AND_tlp_dpControl_wget__072_BITS_7_TO__ETC___d1206 =
	     hasPush && dpControl[7:4] == 4'd0 && dpControl[3:2] == 2'd1 &&
	     dpControl[1:0] == 2'd1 &&
	     !tlp_tlpBRAM_mRespF$D_OUT[138] &&
  ...
  assign hasPush_AND_tlp_dpControl_wget__072_BITS_7_TO__ETC___d1263 =
	     ...
	     tlp_xmtMetaOK &&
	     tlp_postSeqDwell == 4'd0 ;
  assign idx__h19089 = 2'd0 - tlp_tlpBRAM_writeDWAddr[1:0] ;
  assign idx__h21320 = 2'd1 - tlp_tlpBRAM_writeDWAddr[1:0] ;
  assign idx__h22624 = 2'd2 - tlp_tlpBRAM_writeDWAddr[1:0] ;
  assign idx__h23928 = 2'd3 - tlp_tlpBRAM_writeDWAddr[1:0] ;
  assign idx__h26320 = 2'd0 - tlp_tlpBRAM_readNxtDWAddr[1:0] ;
  assign idx__h26788 = 2'd1 - tlp_tlpBRAM_readNxtDWAddr[1:0] ;
  assign idx__h27161 = 2'd2 - tlp_tlpBRAM_readNxtDWAddr[1:0] ;
  assign idx__h27534 = 2'd3 - tlp_tlpBRAM_readNxtDWAddr[1:0] ;
  assign lastBE__h46370 =
	     tlp_tlpBRAM_mRespF_first__108_BITS_71_TO_62_20_ETC___d2403 ?
	       4'd0 :
	       4'd15 ;
  assign lastBE__h62546 =
	     (thisRequestLength__h62239[11:2] == 10'd1) ? 4'd0 : 4'd15 ;
  assign lowAddr__h28462 =
	     { tlp_tlpBRAM_readReq$D_OUT[33:29], lowAddr10__h28461 } ;
  assign mesgMeta_opcode__h80205 =
	     { 24'h800000, wmi_wmi_mFlagF$D_OUT[31:24] } ;
  assign nowLS__h44687 =
	     { tlp_tlpBRAM_mRespF$D_OUT[39:32],
	       tlp_tlpBRAM_mRespF$D_OUT[47:40],
	       tlp_tlpBRAM_mRespF$D_OUT[55:48],
	       tlp_tlpBRAM_mRespF$D_OUT[63:56] } ;
  assign nowLS__h60988 =
	     { tlp_inF$D_OUT[39:32],
	       tlp_inF$D_OUT[47:40],
	       tlp_inF$D_OUT[55:48],
	       tlp_inF$D_OUT[63:56] } ;
  assign nowMS__h43744 =
	     { tlp_tlpBRAM_mRespF$D_OUT[71:64],
	       tlp_tlpBRAM_mRespF$D_OUT[79:72],
	       tlp_tlpBRAM_mRespF$D_OUT[87:80],
	       tlp_tlpBRAM_mRespF$D_OUT[95:88] } ;
  assign nowMS__h60047 =
	     { tlp_inF$D_OUT[71:64],
	       tlp_inF$D_OUT[79:72],
	       tlp_inF$D_OUT[87:80],
	       tlp_inF$D_OUT[95:88] } ;
  assign opcode__h42513 =
  ...
  assign rdat__h90153 = { 16'd0, bml_lclNumBufs } ;
  assign rdat__h90161 = { 16'd0, bml_fabNumBufs } ;
  assign rdat__h90169 = { 16'd0, bml_mesgBase } ;
  assign rdat__h90177 = { 16'd0, bml_metaBase } ;
  assign rdat__h90185 = { 16'd0, bml_mesgSize } ;
  assign rdat__h90193 = { 16'd0, bml_metaSize } ;
  assign rdat__h90201 = { 16'd0, bml_lclBufsCF } ;
  assign rdat__h90222 =
  ...
  assign rdat__h90256 = hasDebugLogic ? wmi_thisMesg : 32'd0 ;
  assign rdat__h90520 = hasDebugLogic ? wmi_lastMesg : 32'd0 ;
  assign rdat__h90570 =
	     hasDebugLogic ? { wmi_reqCount, wmi_wrtCount } : 32'd0 ;
  assign rdat__h90670 = hasDebugLogic ? 32'hDADEBABE : 32'd0 ;
  assign rdat__h90728 = { 24'd0, dpControl } ;
  assign rdat__h90750 = hasDebugLogic ? tlp_flowDiagCount : 32'd0 ;
  assign rdat__h90760 =
	     hasDebugLogic ?
	       { 4'h0,
		 tlp_complTimerCount,
		 ...
		 CASE_tlp_lastRuleFired_10_1_tlp_lastRuleFired__ETC__q1 } :
	       32'd0 ;
  assign rdat__h90882 = hasDebugLogic ? tlp_lastMetaV : 32'd0 ;
  assign rdat__h91003 = hasDebugLogic ? tlp_lastMetaV_1 : 32'd0 ;
  assign rdat__h91032 = hasDebugLogic ? tlp_lastMetaV_2 : 32'd0 ;
  assign rdat__h91061 = hasDebugLogic ? tlp_lastMetaV_3 : 32'd0 ;
  assign rdat__h91090 = hasDebugLogic ? 32'hC0DE0111 : 32'd0 ;
  assign rdat__h91120 = hasDebugLogic ? dmaStartTime[31:0] : 32'd0 ;
  assign rdat__h91154 = hasDebugLogic ? dmaStartTime[63:32] : 32'd0 ;
  assign rdat__h91187 = hasDebugLogic ? dmaDoneTime[31:0] : 32'd0 ;
  assign rdat__h91221 = hasDebugLogic ? dmaDoneTime[63:32] : 32'd0 ;
  assign rdata__h33892 =
	     tlp_tlpBRAM_readReq_first__97_BITS_30_TO_29_99_ETC___d2406[1] ?
	       IF_tlp_tlpBRAM_readReq_first__97_BITS_30_TO_29_ETC___d1037 :
	       IF_tlp_tlpBRAM_readReq_first__97_BITS_30_TO_29_ETC___d1042 ;
  assign rdata__h82055 =
	     { bram_serverAdapterB_3_outData_outData$wget,
	       bram_serverAdapterB_2_outData_outData$wget,
	       bram_serverAdapterB_1_outData_outData$wget,
	       bram_serverAdapterB_outData_outData$wget } ;
  assign rreq_tag__h46149 =
	     (y__h45959 == tlp_mesgLengthRemainPush) ? 8'h01 : 8'h0 ;
  assign rresp_data__h28508 =
	     { IF_tlp_tlpBRAM_readReq_first__97_BITS_30_TO_29_ETC___d2409[7:0],
	       IF_tlp_tlpBRAM_readReq_first__97_BITS_30_TO_29_ETC___d2409[15:8],
	       IF_tlp_tlpBRAM_readReq_first__97_BITS_30_TO_29_ETC___d2409[23:16],
	       IF_tlp_tlpBRAM_readReq_first__97_BITS_30_TO_29_ETC___d2409[31:24] } ;
  assign spanToNextPage__h45933 = 13'd4096 - { 1'd0, tlp_srcMesgAccu[11:0] } ;
  assign spanToNextPage__h62238 = 13'd4096 - { 1'd0, tlp_fabMesgAccu[11:0] } ;
  assign tag__h62514 = { 3'd0, tlp_dmaTag } ;
  assign tagm__h62729 = { 3'd0, tlp_dmaReqTag } ;
  assign thisRequestLength__h45934 =
	     (x__h45972[12:0] <= spanToNextPage__h45933) ?
	       x__h45972[12:0] :
	       spanToNextPage__h45933 ;
  assign thisRequestLength__h62239 =
	     (x__h62272[12:0] <= spanToNextPage__h62238) ?
	       x__h62272[12:0] :
	       spanToNextPage__h62238 ;
  assign tlp_dmaPullRemainDWLen_481_ULE_tlp_dmaPullRema_ETC___d2647 =
	     tlp_dmaPullRemainDWLen <= tlp_dmaPullRemainDWSub ;
  assign tlp_dmaPullRemainDWSub_495_ULE_4___d2648 =
	     tlp_dmaPullRemainDWSub <= 10'd4 ;
  assign tlp_inF_first__367_BITS_63_TO_56_370_EQ_pciDev_ETC___d1380 =
	     tlp_inF$D_OUT[63:56] == pciDevice[15:8] &&
	     tlp_inF$D_OUT[55:51] == pciDevice[7:3] &&
	     tlp_inF$D_OUT[50:48] == pciDevice[2:0] ;
  assign tlp_inF_first__367_BIT_152_570_AND_NOT_tlp_inF_ETC___d1595 =
  ...
  assign tlp_outDwRemain_237_ULE_4___d2583 = tlp_outDwRemain <= 10'd4 ;
  ...
  assign tlp_tlpBRAM_mReqF_first__18_BIT_63_19_OR_IF_tl_ETC___d634 =
	     tlp_tlpBRAM_mReqF$D_OUT[63] ||
	     CASE_tlp_tlpBRAM_mReqFD_OUT_BITS_51_TO_50_NOT_ETC__q5 ;
  assign tlp_tlpBRAM_mRespF_first__108_BITS_71_TO_62_20_ETC___d2403 =
	     tlp_tlpBRAM_mRespF$D_OUT[71:62] <= 10'd1 ;
  assign tlp_tlpBRAM_rdRespDwRemain_024_ULE_4___d1026 =
	     tlp_tlpBRAM_rdRespDwRemain <= 10'd4 ;
  assign tlp_tlpBRAM_readNxtDWAddr_PLUS_1__q10 =
	     tlp_tlpBRAM_readNxtDWAddr + 13'd1 ;
  assign tlp_tlpBRAM_readNxtDWAddr_PLUS_2__q11 =
	     tlp_tlpBRAM_readNxtDWAddr + 13'd2 ;
  assign tlp_tlpBRAM_readNxtDWAddr_PLUS_3__q9 =
	     tlp_tlpBRAM_readNxtDWAddr + 13'd3 ;
  assign tlp_tlpBRAM_readRemainDWLen_46_ULE_4___d847 =
	     tlp_tlpBRAM_readRemainDWLen <= 10'd4 ;
  assign tlp_tlpBRAM_readReq_first__97_BITS_30_TO_29_99_ETC___d2406 =
	     tlp_tlpBRAM_readReq$D_OUT[30:29] +
	     (tlp_tlpBRAM_readReq$D_OUT[60] ? 2'd0 : 2'd1) ;
  assign tlp_tlpBRAM_writeDWAddr_PLUS_1__q13 =
	     tlp_tlpBRAM_writeDWAddr + 13'd1 ;
  assign tlp_tlpBRAM_writeDWAddr_PLUS_2__q14 =
	     tlp_tlpBRAM_writeDWAddr + 13'd2 ;
  assign tlp_tlpBRAM_writeDWAddr_PLUS_3__q12 =
	     tlp_tlpBRAM_writeDWAddr + 13'd3 ;
  assign tlp_tlpBRAM_writeRemainDWLen_62_ULE_1___d2398 =
	     tlp_tlpBRAM_writeRemainDWLen <= 10'd1 ;
  assign tlp_tlpBRAM_writeRemainDWLen_62_ULE_2___d2400 =
	     tlp_tlpBRAM_writeRemainDWLen <= 10'd2 ;
  assign tlp_tlpBRAM_writeRemainDWLen_62_ULE_3___d2401 =
	     tlp_tlpBRAM_writeRemainDWLen <= 10'd3 ;
  assign w_be__h47082 =
	     tlp_outDwRemain_237_ULE_4___d2583 ?
	       CASE_tlp_outDwRemain_BITS_1_TO_0_0xFFF0_0b0_0x_ETC__q4 :
	       16'd65535 ;
  assign w_data__h46343 =
	     { 22'd1048576,
	       tlp_tlpBRAM_mRespF$D_OUT[71:62],
	       pciDevice,
	       8'd0,
  ...
  assign w_data__h65250 =
	     { 32'd1610612737,
	       pciDevice,
	       16'd15,
	       tlp_fabFlowAddrMS,
	       tlp_fabFlowAddr } ;
  assign w_data__h65496 =
	     { wti_nowReq_BITS_63_TO_0__q2[12:6],
	       1'd1,
	       wti_nowReq_BITS_63_TO_0__q2[20:13],
	       wti_nowReq_BITS_63_TO_0__q2[28:21],
	       wti_nowReq_BITS_63_TO_0__q2[36:29],
	       96'd0 } ;
  assign wmi_wmi_operateD_716_AND_wmi_wmi_peerIsReady_7_ETC___d1887 =
	     wmi_wmi_operateD && wmi_wmi_peerIsReady &&
	     bram_serverAdapterB_cnt_5_SLT_3___d1776 &&
	     bram_serverAdapterB_1_cnt_03_SLT_3___d1777 &&
	     bram_serverAdapterB_2_cnt_21_SLT_3___d1778 &&
	     bram_serverAdapterB_3_cnt_39_SLT_3___d1779 &&
	     wmi_wmi_mFlagF$EMPTY_N ;
  assign wmi_wmi_operateD_716_AND_wmi_wmi_peerIsReady_7_ETC___d1908 =
	     wmi_wmi_operateD && wmi_wmi_peerIsReady &&
	     (bram_serverAdapterB_outDataCore$EMPTY_N ||
	      bram_serverAdapterB_outData_enqData$whas) &&
	     bram_serverAdapterB_outData_outData_whas__795__ETC___d1807 ;
  assign wti_nowReq_BITS_63_TO_0__q2 = wti_nowReq[63:0] ;
  assign x3__h80165 = { 8'd0, wmi_wmi_mFlagF$D_OUT[23:0] } ;
  assign x__h28581 = x__h28583 - y__h28584 ;
  assign x__h28583 = { tlp_tlpBRAM_readReq$D_OUT[28:19], 2'b0 } ;
  assign x__h40679 =
	     { tlp_tlpBRAM_mRespF$D_OUT[7:0],
	       tlp_tlpBRAM_mRespF$D_OUT[15:8],
	       tlp_tlpBRAM_mRespF$D_OUT[23:16],
	       tlp_tlpBRAM_mRespF$D_OUT[31:24] } ;
  assign x__h45690 = { 15'd0, tlp_mesgLengthRemainPush } ;
  assign x__h45972 =
	     (tlp_mesgLengthRemainPush <= y__h45974) ?
  ...
  assign x__h56799 =
	     { tlp_inF$D_OUT[7:0],
	       ...
	       tlp_inF$D_OUT[23:16],
	       tlp_inF$D_OUT[31:24] } ;
  assign x__h61958 = { 15'd0, tlp_mesgLengthRemainPull } ;
  assign x__h62272 =
	     (tlp_mesgLengthRemainPull <= y__h62274) ?
	       tlp_mesgLengthRemainPull :
	       y__h62274 ;
  assign x__h86839 = (dpControl[1:0] == 2'd1) ? bml_fabNumBufs : 16'd0 ;
  assign x__h87963 = bml_lclBufsAR + 16'd1 ;
  assign x__h87968 = bml_lclBufsAR - 16'd1 ;
  assign x__h88075 = bml_lclBufsCF + 16'd1 ;
  assign x__h88112 = bml_lclBufsCF - 16'd1 ;
  assign x__h88190 = bml_fabBufsAvail + 16'd1 ;
  assign x__h88195 = bml_fabBufsAvail - 16'd1 ;
  assign x__h88228 = bml_lclCredit + 16'd1 ;
  assign x__h88233 = bml_lclCredit - 16'd1 ;
  assign y__h17303 = tlp_tlpBRAM_mReqF$D_OUT[63] ? 13'd0 : 13'd1 ;
  assign y__h17374 = tlp_tlpBRAM_mReqF$D_OUT[63] ? 10'd0 : 10'd1 ;
  assign y__h26025 = tlp_tlpBRAM_mReqF$D_OUT[60] ? 10'd0 : 10'd1 ;
  assign y__h26073 = tlp_tlpBRAM_mReqF$D_OUT[60] ? 13'd0 : 13'd1 ;
  assign y__h28582 =
	     (tlp_tlpBRAM_readReq$D_OUT[28:19] == 10'd1) ?
	       12'd0 :
	       { 10'd0, x__h28613 } ;
  assign y__h28584 = { 10'd0, x__h28590 } ;
  assign y__h29523 = tlp_tlpBRAM_readReq$D_OUT[60] ? 10'd0 : 10'd1 ;
  assign y__h45959 = { 4'd0, thisRequestLength__h45934 } ;
  assign y__h45974 = { 4'd0, tlp_maxPayloadSize } ;
  assign y__h46053 = { 19'd0, thisRequestLength__h45934 } ;
  assign y__h46101 = { 3'd0, thisRequestLength__h45934 } ;
  assign y__h46662 = (tlp_fabMesgAddrMS == 32'd0) ? 10'd1 : 10'd0 ;
  assign y__h46715 = { 20'd0, tlp_tlpBRAM_mRespF$D_OUT[71:62], 2'd0 } ;
  assign y__h62264 = { 4'd0, thisRequestLength__h62239 } ;
  assign y__h62274 = { 4'd0, tlp_maxReadReqSize } ;
  assign y__h62335 = { 19'd0, thisRequestLength__h62239 } ;
  assign y__h62936 = { 4'd0, tlp_inF$D_OUT[105:96], 2'd0 } ;
  assign y__h63643 =
	     tlp_dmaPullRemainDWSub_495_ULE_4___d2648 ?
  ...
  begin
    case (tlp_tlpBRAM_readReq$D_OUT[18:15])
      4'b1100: x__h28590 = 2'b10;
      4'b1110: x__h28590 = 2'b01;
      4'b1111: x__h28590 = 2'b0;
      default: x__h28590 = 2'b11;
    endcase
  end
  always@(tlp_tlpBRAM_readReq$D_OUT)
  begin
    case (tlp_tlpBRAM_readReq$D_OUT[14:11])
      4'b1100: x__h28613 = 2'b10;
      4'b1110: x__h28613 = 2'b01;
      4'b1111: x__h28613 = 2'b0;
      default: x__h28613 = 2'b11;
    endcase
  end
  ...
  always@(wci_reqF$D_OUT or
	  ...
	  rdat__h91120 or rdat__h91154 or rdat__h91187 or rdat__h91221)
  begin
    case (wci_reqF$D_OUT[39:32])
      8'h0: _theResult____h90074 = rdat__h90153;
      8'h04: _theResult____h90074 = rdat__h90161;
      8'h08: _theResult____h90074 = rdat__h90169;
      8'h0C: _theResult____h90074 = rdat__h90177;
      8'h10: _theResult____h90074 = rdat__h90185;
      8'h14: _theResult____h90074 = rdat__h90193;
      8'h20: _theResult____h90074 = rdat__h90201;
      8'h24: _theResult____h90074 = 32'hF00DFACE;
      8'h28: _theResult____h90074 = rdat__h90222;
      8'h2C: _theResult____h90074 = rdat__h90229;
      8'h30: _theResult____h90074 = rdat__h90242;
      8'h34: _theResult____h90074 = rdat__h90249;
      8'h38: _theResult____h90074 = rdat__h90256;
      8'h3C: _theResult____h90074 = rdat__h90520;
      8'h40: _theResult____h90074 = rdat__h90570;
      8'h44: _theResult____h90074 = 32'd0;
      8'h48: _theResult____h90074 = rdat__h90670;
      8'h4C: _theResult____h90074 = 32'h00008000;
      8'h50: _theResult____h90074 = bml_fabMesgBase;
      8'h54: _theResult____h90074 = bml_fabMetaBase;
      8'h58: _theResult____h90074 = bml_fabMesgSize;
      8'h5C: _theResult____h90074 = bml_fabMetaSize;
      8'h60: _theResult____h90074 = bml_fabFlowBase;
      8'h64: _theResult____h90074 = bml_fabFlowSize;
      8'h68: _theResult____h90074 = rdat__h90728;
      8'h6C: _theResult____h90074 = rdat__h90750;
      8'h70: _theResult____h90074 = rdat__h90760;
      8'h80: _theResult____h90074 = rdat__h90882;
      8'h84: _theResult____h90074 = rdat__h91003;
      8'h88: _theResult____h90074 = rdat__h91032;
      8'h8C: _theResult____h90074 = rdat__h91061;
      8'h90: _theResult____h90074 = rdat__h91090;
      8'h94: _theResult____h90074 = bml_fabMesgBaseMS;
      8'h98: _theResult____h90074 = bml_fabMetaBaseMS;
      8'h9C: _theResult____h90074 = bml_fabFlowBaseMS;
      8'hA0: _theResult____h90074 = rdat__h91120;
      8'hA4: _theResult____h90074 = rdat__h91154;
      8'hA8: _theResult____h90074 = rdat__h91187;
      8'hAC: _theResult____h90074 = rdat__h91221;
      default: _theResult____h90074 = 32'd0;
    endcase
  end
  always@(tlp_tlpBRAM_readReq$D_OUT)
  begin
    case (tlp_tlpBRAM_readReq$D_OUT[18:15])
      4'b1000: lowAddr10__h28461 = 2'b11;
      4'b1100: lowAddr10__h28461 = 2'b10;
      4'b1110: lowAddr10__h28461 = 2'b01;
      default: lowAddr10__h28461 = 2'b0;
    endcase
  end
  ...
  begin
    case (dpControl[1:0])
	  ...
	  IF_bml_dpControl_wget__008_BITS_1_TO_0_014_EQ__ETC___d2085 =
	      bml_remDone;
      default: IF_bml_dpControl_wget__008_BITS_1_TO_0_014_EQ__ETC___d2085 =
		   bml_fabDone;
    endcase
  end
  ...
  always@(idx__h19089 or
	  tlp_tlpBRAM_writeRemainDWLen_62_ULE_3___d2401 or
	  tlp_tlpBRAM_writeRemainDWLen or
	  tlp_tlpBRAM_writeRemainDWLen_62_ULE_1___d2398 or
	  tlp_tlpBRAM_writeRemainDWLen_62_ULE_2___d2400)
  begin
    case (idx__h19089)
      2'd0:
  ...
  always@(tlp_tlpBRAM_mReqF$D_OUT or
	  bram_serverAdapterA_3_cnt_80_SLT_3___d2653 or
	  bram_serverAdapterA_cnt_6_SLT_3___d2650 or
	  bram_serverAdapterA_1_cnt_44_SLT_3___d2651 or
	  bram_serverAdapterA_2_cnt_62_SLT_3___d2652)
  begin
  ...
  always@(idx__h19089 or tlp_tlpBRAM_mReqF$D_OUT)
  begin
    case (idx__h19089)
      2'd0:
  ...
  always@(idx__h21320 or tlp_tlpBRAM_mReqF$D_OUT)
  begin
    case (idx__h21320)
      2'd0:
	  IF_1_MINUS_tlp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2506 =
  ...
  always@(idx__h22624 or tlp_tlpBRAM_mReqF$D_OUT)
  begin
    case (idx__h22624)
      2'd0:
	  IF_2_MINUS_tlp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2507 =
  ...
  always@(idx__h23928 or tlp_tlpBRAM_mReqF$D_OUT)
  begin
    case (idx__h23928)
      2'd0:
	  IF_3_MINUS_tlp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2508 =
  ...
  begin
    ...
    if (RST_N)
      if (WILL_FIRE_RL_tlp_dmaXmtMetaHead)
	$display("[%0d]: %m: dmaXmtMetaHead FPactMesg-Step5/7", v__h48570);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_tlp_dmaXmtTailEvent)
	$display("[%0d]: %m: dmaXmtTailEvent FPactMesg-Step7/7", v__h54976);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_tlp_dmaXmtMetaBody)
	$display("[%0d]: %m: dmaXmtMetaBody FPactMesg-Step6/7", v__h54856);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_tlp_dmaXmtDoorbell)
	$display("[%0d]: %m: dmaXmtDoorbell FC/FPactFlow-Step1/1", v__h55181);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_tlp_dmaPullTailEvent)
	$display("[%0d]: %m: dmaPullTailEvent FPactMesg-Step5/5", v__h63851);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_tlp_dmaTailEventSender)
	$display("[%0d]: %m: dmaTailEventSender - generic", v__h69011);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_tlp_dmaRequestFarMeta)
	$display("[%0d]: %m: dmaRequestFarMeta FCactMesg-Step1/5", v__h55644);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_wci_cfwr && wci_reqF$D_OUT[39:32] == 8'h18)
	$display("[%0d] %m: fabDoneAvail Event", v__h89467);
    if (RST_N)
