...
//
// On Mon Feb  6 11:50:17 EST 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkOCDP16B(pciDevice,
  ...
  reg [63 : 0] v__h15540,
	       ...
	       v__h88863,
	       v__h89017;
  reg [31 : 0] IF_0_MINUS_tlp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2442,
	       IF_1_MINUS_tlp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2443,
	       IF_2_MINUS_tlp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2444,
	       IF_3_MINUS_tlp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2445,
	       IF_tlp_tlpBRAM_readReq_first__97_BITS_30_TO_29_ETC___d2364,
	       _theResult____h89001;
  ...
  reg [1 : 0] lowAddr10__h28540, x__h28669, x__h28692;
  reg CASE_dpControl_BITS_1_TO_0_NOT_bml_fabDone_0_N_ETC__q6,
      ...
      IF_0_MINUS_tlp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2407,
      IF_0_MINUS_tlp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d675,
      IF_1_MINUS_tlp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2412,
      IF_1_MINUS_tlp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d685,
      IF_2_MINUS_tlp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2413,
      IF_2_MINUS_tlp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d695,
      IF_3_MINUS_tlp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2414,
      IF_3_MINUS_tlp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d705,
      IF_bml_dpControl_wget__980_BITS_1_TO_0_986_EQ__ETC___d2057,
      IF_tlp_tlpBRAM_readReq_first__97_BITS_30_TO_29_ETC___d912;
  wire [127 : 0] IF_tlp_fabMesgAddrMS_180_EQ_0_181_THEN_0_ELSE__ETC___d1451,
		 ...
		 w_data__h63583,
		 w_data__h64634;
  wire [31 : 0] bml_fabFlowAddr_019_PLUS_bml_fabFlowSize_020___d2673,
		mesgMeta_opcode__h79564,
		nowLS__h44209,
		nowLS__h60443,
		nowMS__h43266,
		nowMS__h59502,
  ...
  wire [15 : 0] w_be__h46604,
		...
		y__h45623,
		y__h62391;
  wire [12 : 0] spanToNextPage__h45455,
		spanToNextPage__h61693,
		thisRequestLength__h45456,
		thisRequestLength__h61694,
		...
		y__h17382,
		y__h26152;
  wire [11 : 0] byteCount__h28542, x__h28660, x__h28662, y__h28661, y__h28663;
  wire [9 : 0] y__h17453, y__h26104, y__h29602, y__h46184;
  wire [7 : 0] rreq_tag__h45671, tag__h61969, tagm__h62184;
  wire [6 : 0] lowAddr__h28541;
  wire [3 : 0] lastBE__h45892, lastBE__h62001;
  ...
  wire [1 : 0] ab__h10380,
	       ...
	       idx__h27240,
	       idx__h27613,
	       tlp_tlpBRAM_readReq_first__97_BITS_30_TO_29_99_ETC___d2360;
  wire IF_1_MINUS_tlp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d708,
       IF_tlp_tlpBRAM_readReq_first__97_BITS_30_TO_29_ETC___d921,
       NOT_bml_lclBufDone_004_071_AND_IF_bml_dpContro_ETC___d2084,
       NOT_wmi_wrActive_802_803_OR_NOT_wmi_rdActive_8_ETC___d1812,
       _dfoo5,
       bml_crdBuf_value_962_EQ_bml_crdBuf_modulus_bw__ETC___d2753,
       bml_fabBuf_value_947_EQ_bml_fabBuf_modulus_bw__ETC___d2755,
       bml_lclBufDone_004_AND_IF_bml_dpControl_wget___ETC___d2416,
       bml_lclBuf_value_917_EQ_bml_lclBuf_modulus_bw__ETC___d2752,
       bml_remBuf_value_932_EQ_bml_remBuf_modulus_bw__ETC___d2754,
       bram_serverAdapterA_1_cnt_44_SLT_3___d2678,
       bram_serverAdapterA_2_cnt_62_SLT_3___d2679,
       bram_serverAdapterA_2_outDataCore_notEmpty__38_ETC___d993,
       bram_serverAdapterA_3_cnt_80_SLT_3___d2680,
       bram_serverAdapterA_cnt_6_SLT_3___d2677,
       bram_serverAdapterA_outDataCore_notEmpty_OR_br_ETC___d995,
       bram_serverAdapterB_1_cnt_03_SLT_3___d1752,
       bram_serverAdapterB_1_outData_outData_whas__77_ETC___d1780,
       bram_serverAdapterB_2_cnt_21_SLT_3___d1753,
       bram_serverAdapterB_3_cnt_39_SLT_3___d1754,
       bram_serverAdapterB_cnt_5_SLT_3_751_AND_bram_s_ETC___d1757,
       bram_serverAdapterB_cnt_5_SLT_3___d1751,
       bram_serverAdapterB_outData_outData_whas__770__ETC___d1782,
       hasPull_AND_tlp_dpControl_wget__066_BITS_7_TO__ETC___d1332,
       hasPull_AND_tlp_dpControl_wget__066_BITS_7_TO__ETC___d1372,
       hasPull_AND_tlp_dpControl_wget__066_BITS_7_TO__ETC___d1424,
       hasPull_AND_tlp_dpControl_wget__066_BITS_7_TO__ETC___d1462,
       hasPull_AND_tlp_dpControl_wget__066_BITS_7_TO__ETC___d1482,
       hasPull_AND_tlp_dpControl_wget__066_BITS_7_TO__ETC___d1507,
       hasPush_AND_tlp_dpControl_wget__066_BITS_7_TO__ETC___d1087,
       hasPush_AND_tlp_dpControl_wget__066_BITS_7_TO__ETC___d1160,
       hasPush_AND_tlp_dpControl_wget__066_BITS_7_TO__ETC___d1201,
       hasPush_AND_tlp_dpControl_wget__066_BITS_7_TO__ETC___d1257,
       tlp_dmaPullRemainDWLen_470_ULE_tlp_dmaPullRema_ETC___d2674,
       tlp_dmaPullRemainDWSub_484_ULE_4___d2675,
       tlp_inF_first__357_BITS_63_TO_56_360_EQ_pciDev_ETC___d1370,
       tlp_inF_first__357_BIT_152_547_AND_NOT_tlp_inF_ETC___d1571,
       tlp_outDwRemain_232_ULE_4___d2520,
       tlp_tlpBRAM_mReqF_first__18_BIT_60_02_OR_IF_tl_ETC___d813,
       tlp_tlpBRAM_mReqF_first__18_BIT_63_19_OR_IF_tl_ETC___d634,
       tlp_tlpBRAM_mRespF_first__102_BITS_71_TO_62_20_ETC___d2366,
       tlp_tlpBRAM_rdRespDwRemain_024_ULE_4___d1026,
       tlp_tlpBRAM_readRemainDWLen_46_ULE_4___d847,
       tlp_tlpBRAM_writeRemainDWLen_62_ULE_1___d2368,
       tlp_tlpBRAM_writeRemainDWLen_62_ULE_2___d2369,
       tlp_tlpBRAM_writeRemainDWLen_62_ULE_3___d2344,
       wmi_wmi_operateD_691_AND_wmi_wmi_peerIsReady_6_ETC___d1862,
       wmi_wmi_operateD_691_AND_wmi_wmi_peerIsReady_6_ETC___d1883;
  ...
  assign MUX_bml_fabBufsAvail$write_1__VAL_1 =
	     (bml_fabAvail && !bml_remStart) ? x__h87232 : x__h87237 ;
  assign MUX_bml_fabBufsAvail$write_1__VAL_2 =
	     (dpControl[3:2] == 2'd1) ? x__h85989 : 16'd0 ;
  assign MUX_bml_fabFlowAddr$write_1__VAL_1 =
	     bml_fabBuf_value_947_EQ_bml_fabBuf_modulus_bw__ETC___d2755 ?
	       bml_fabFlowBase :
	       bml_fabFlowAddr_019_PLUS_bml_fabFlowSize_020___d2673 ;
  ...
  assign MUX_bml_lclCredit$write_1__VAL_1 =
	     (bml_lclBufDone && !bml_remStart) ? x__h87270 : x__h87275 ;
  ...
  assign MUX_bram_memory$a_put_3__VAL_3 =
	     { IF_0_MINUS_tlp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2442[7:0],
	       IF_0_MINUS_tlp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2442[15:8],
	       IF_0_MINUS_tlp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2442[23:16],
	       IF_0_MINUS_tlp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2442[31:24] } ;
  assign MUX_bram_memory$b_put_2__VAL_2 =
	     wmi_lclMesgAddr[14:4] + { 1'd0, wmi_addr[13:4] } ;
  always@(idx__h21399 or
	  tlp_tlpBRAM_writeDWAddr_PLUS_3__q8 or
	  tlp_tlpBRAM_writeDWAddr or
	  tlp_tlpBRAM_writeDWAddr_PLUS_1__q9 or
	  tlp_tlpBRAM_writeDWAddr_PLUS_2__q10)
  ...
  assign MUX_bram_memory_1$a_put_3__VAL_3 =
	     { IF_1_MINUS_tlp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2443[7:0],
	       IF_1_MINUS_tlp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2443[15:8],
	       IF_1_MINUS_tlp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2443[23:16],
	       IF_1_MINUS_tlp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2443[31:24] } ;
  always@(idx__h22703 or
	  tlp_tlpBRAM_writeDWAddr_PLUS_3__q8 or
	  tlp_tlpBRAM_writeDWAddr or
	  tlp_tlpBRAM_writeDWAddr_PLUS_1__q9 or
	  tlp_tlpBRAM_writeDWAddr_PLUS_2__q10)
  ...
  assign MUX_bram_memory_2$a_put_3__VAL_3 =
	     { IF_2_MINUS_tlp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2444[7:0],
	       IF_2_MINUS_tlp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2444[15:8],
	       IF_2_MINUS_tlp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2444[23:16],
	       IF_2_MINUS_tlp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2444[31:24] } ;
  always@(idx__h24007 or
	  tlp_tlpBRAM_writeDWAddr_PLUS_3__q8 or
	  tlp_tlpBRAM_writeDWAddr or
	  tlp_tlpBRAM_writeDWAddr_PLUS_1__q9 or
	  tlp_tlpBRAM_writeDWAddr_PLUS_2__q10)
  ...
  assign MUX_bram_memory_3$a_put_3__VAL_3 =
	     { IF_3_MINUS_tlp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2445[7:0],
	       IF_3_MINUS_tlp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2445[15:8],
	       IF_3_MINUS_tlp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2445[23:16],
	       IF_3_MINUS_tlp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2445[31:24] } ;
  ...
  assign MUX_tlp_fabMesgAccu$write_1__VAL_2 = tlp_fabMesgAccu + y__h46237 ;
  assign MUX_tlp_fabMesgAccu$write_1__VAL_3 = tlp_fabMesgAccu + y__h61790 ;
  ...
  assign MUX_tlp_mesgComplReceived$write_1__VAL_2 =
	     tlp_mesgComplReceived + y__h63098 ;
  ...
  assign MUX_tlp_mesgLengthRemainPull$write_1__VAL_3 =
	     tlp_mesgLengthRemainPull - y__h61719 ;
  ...
  assign MUX_tlp_mesgLengthRemainPush$write_1__VAL_3 =
	     tlp_mesgLengthRemainPush - y__h45481 ;
  assign MUX_tlp_outDwRemain$write_1__VAL_1 =
	     tlp_tlpBRAM_mRespF$D_OUT[71:62] - y__h46184 ;
  ...
  assign MUX_tlp_outF$enq_1__VAL_5 =
	     { 9'd386,
	       ...
	       IF_tlp_fabMesgAddrMS_180_EQ_0_181_THEN_0_ELSE__ETC___d1451 } ;
  assign MUX_tlp_outF$enq_1__VAL_6 =
	     (tlp_fabFlowAddrMS == 32'd0) ?
	       { 25'd25362431, w_data__h63583 } :
	       (tlp_sentTail4DWHeader ?
		  153'h082F00001000000000000000000000000000000 :
		  { 25'd16973823, w_data__h64634 }) ;
  ...
  assign MUX_tlp_remMesgAccu$write_1__VAL_2 = tlp_remMesgAccu + y__h45623 ;
  assign MUX_tlp_remMesgAccu$write_1__VAL_3 = tlp_remMesgAccu + y__h62391 ;
  assign MUX_tlp_reqMesgInFlight$write_1__VAL_2 =
	     !tlp_dmaPullRemainDWSub_484_ULE_4___d2675 ||
	     !tlp_dmaPullRemainDWLen_470_ULE_tlp_dmaPullRema_ETC___d2674 ;
  assign MUX_tlp_srcMesgAccu$write_1__VAL_2 = tlp_srcMesgAccu + y__h45575 ;
  ...
  assign MUX_tlp_tlpBRAM_mReqF$enq_1__VAL_3 =
	     { 69'h12AAAAAAAAAAAAAAAA,
	       ...
	       thisRequestLength__h45456[11:2],
	       8'd255,
	       rreq_tag__h45671,
	       3'h2 } ;
  ...
  assign MUX_tlp_tlpBRAM_rdRespDwRemain$write_1__VAL_1 =
	     tlp_tlpBRAM_readReq$D_OUT[28:19] - y__h29602 ;
  ...
  assign MUX_tlp_tlpBRAM_readNxtDWAddr$write_1__VAL_1 =
	     tlp_tlpBRAM_mReqF$D_OUT[41:29] + y__h26152 ;
  ...
  assign MUX_tlp_tlpBRAM_readRemainDWLen$write_1__VAL_1 =
	     tlp_tlpBRAM_mReqF$D_OUT[28:19] - y__h26104 ;
  ...
  assign MUX_tlp_tlpBRAM_writeDWAddr$write_1__VAL_1 =
	     tlp_tlpBRAM_mReqF$D_OUT[62:50] + y__h17382 ;
  ...
  assign MUX_tlp_tlpBRAM_writeRemainDWLen$write_1__VAL_1 =
	     tlp_tlpBRAM_mReqF$D_OUT[49:40] - y__h17453 ;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, _theResult____h89001 } ;
  ...
  assign MUX_wmi_wmi_respF_q_0$write_1__VAL_1 =
	     (wmi_wmi_respF_c_r == 2'd1) ?
	       MUX_wmi_wmi_respF_q_0$write_1__VAL_2 :
	       wmi_wmi_respF_q_1 ;
  assign MUX_wmi_wmi_respF_q_0$write_1__VAL_2 = { 2'd1, rdata__h81414 } ;
  ...
  assign tlp_pullTagMatch_1$wget =
	     tagm__h62184 == tlp_inF$D_OUT[47:40] &&
	     tlp_inF_first__357_BITS_63_TO_56_360_EQ_pciDev_ETC___d1370 ;
  ...
  begin
    case (1'b1) // synopsys parallel_case
      WILL_FIRE_RL_tlp_dmaPullRequestFarMesg:
	  tlp_dmaPullRemainDWLen$D_IN = thisRequestLength__h61694[11:2];
      WILL_FIRE_RL_tlp_dmaPullResponseHeader:
  ...
  always@(WILL_FIRE_RL_tlp_dmaPullResponseHeader or
	  tlp_inF$D_OUT or
	  WILL_FIRE_RL_tlp_dmaPullResponseBody or
	  tlp_dmaPullRemainDWSub_484_ULE_4___d2675 or
	  WILL_FIRE_RL_tlp_dmaPullRequestFarMesg)
  begin
    case (1'b1) // synopsys parallel_case
      WILL_FIRE_RL_tlp_dmaPullResponseHeader:
  ...
  begin
    case (1'b1) // synopsys parallel_case
      ...
      WILL_FIRE_RL_tlp_dmaPullResponseBody:
	  tlp_tlpRcvBusy$D_IN = !tlp_dmaPullRemainDWSub_484_ULE_4___d2675;
  ...
  begin
    case (1'b1) // synopsys parallel_case
      ...
      WILL_FIRE_RL_wmi_doWriteFinalize: bram_memory$DIB = x3__h79524;
      WILL_FIRE_RL_wmi_reqMetadata || WILL_FIRE_RL_wmi_doReadReq:
  ...
  begin
    case (1'b1) // synopsys parallel_case
      ...
      WILL_FIRE_RL_wmi_doWriteFinalize:
	  bram_memory_1$DIB = mesgMeta_opcode__h79564;
      WILL_FIRE_RL_wmi_reqMetadata || WILL_FIRE_RL_wmi_doReadReq:
  ...
  assign IF_1_MINUS_tlp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d708 =
	     ...
	     (IF_3_MINUS_tlp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d705 ||
	      bram_serverAdapterA_3_cnt_80_SLT_3___d2680) ;
  assign IF_tlp_fabMesgAddrMS_180_EQ_0_181_THEN_0_ELSE__ETC___d1451 =
	     { (tlp_fabMesgAddrMS == 32'd0) ? 22'd0 : 22'd524288,
	       thisRequestLength__h61694[11:2],
	       pciDevice,
	       tag__h61969,
	       lastBE__h62001,
	       4'd15,
  ...
  assign IF_tlp_tlpBRAM_readReq_first__97_BITS_30_TO_29_ETC___d1037 =
	     tlp_tlpBRAM_readReq_first__97_BITS_30_TO_29_99_ETC___d2360[0] ?
	       { bram_serverAdapterA_3_outData_outData$wget[7:0],
		 bram_serverAdapterA_3_outData_outData$wget[15:8],
		 bram_serverAdapterA_3_outData_outData$wget[23:16],
		 bram_serverAdapterA_3_outData_outData$wget[31:24],
  ...
  assign IF_tlp_tlpBRAM_readReq_first__97_BITS_30_TO_29_ETC___d921 =
	     IF_tlp_tlpBRAM_readReq_first__97_BITS_30_TO_29_ETC___d912 &&
	     CASE_tlp_tlpBRAM_readReqD_OUT_BITS_30_TO_29_N_ETC__q17 ;
  assign NOT_bml_lclBufDone_004_071_AND_IF_bml_dpContro_ETC___d2084 =
	     !bml_lclBufDone &&
	     CASE_dpControl_BITS_1_TO_0_bml_fabDone_0_bml_f_ETC__q2 ;
  assign NOT_wmi_wrActive_802_803_OR_NOT_wmi_rdActive_8_ETC___d1812 =
  ...
  assign ab__h8850 =
	     MUX_bram_serverAdapterB_1_writeWithResp$wset_1__SEL_1 ?
	       2'd0 :
	       2'd2 ;
  assign bml_crdBuf_value_962_EQ_bml_crdBuf_modulus_bw__ETC___d2753 =
	     bml_crdBuf_value == bml_crdBuf_modulus ;
  assign bml_fabBuf_value_947_EQ_bml_fabBuf_modulus_bw__ETC___d2755 =
	     bml_fabBuf_value == bml_fabBuf_modulus ;
  assign bml_fabFlowAddr_019_PLUS_bml_fabFlowSize_020___d2673 =
	     bml_fabFlowAddr + bml_fabFlowSize ;
  assign bml_lclBufDone_004_AND_IF_bml_dpControl_wget___ETC___d2416 =
	     bml_lclBufDone &&
	     CASE_dpControl_BITS_1_TO_0_NOT_bml_fabDone_0_N_ETC__q6 ;
  assign bml_lclBuf_value_917_EQ_bml_lclBuf_modulus_bw__ETC___d2752 =
	     bml_lclBuf_value == bml_lclBuf_modulus ;
  assign bml_remBuf_value_932_EQ_bml_remBuf_modulus_bw__ETC___d2754 =
  ...
  assign bram_serverAdapterA_1_cnt_44_SLT_3___d2678 =
  ...
  assign bram_serverAdapterA_2_cnt_62_SLT_3___d2679 =
  ...
  assign bram_serverAdapterA_3_cnt_80_SLT_3___d2680 =
  ...
  assign bram_serverAdapterA_cnt_6_SLT_3___d2677 =
  ...
  assign bram_serverAdapterB_1_cnt_03_SLT_3___d1752 =
	     (bram_serverAdapterB_1_cnt ^ 3'h4) < 3'd7 ;
  assign bram_serverAdapterB_1_outData_outData_whas__77_ETC___d1780 =
	     bram_serverAdapterB_1_outData_outData$whas &&
	     (bram_serverAdapterB_2_outDataCore$EMPTY_N ||
	      bram_serverAdapterB_2_outData_enqData$whas) &&
	     bram_serverAdapterB_2_outData_outData$whas &&
  ...
  assign bram_serverAdapterB_2_cnt_21_PLUS_IF_bram_serv_ETC___d327 =
	     ...
	     (bram_serverAdapterB_outData_deqCalled$whas ? 3'd7 : 3'd0) ;
  assign bram_serverAdapterB_2_cnt_21_SLT_3___d1753 =
  ...
  assign bram_serverAdapterB_3_cnt_39_PLUS_IF_bram_serv_ETC___d445 =
	     ...
	     (bram_serverAdapterB_outData_deqCalled$whas ? 3'd7 : 3'd0) ;
  assign bram_serverAdapterB_3_cnt_39_SLT_3___d1754 =
  ...
  assign bram_serverAdapterB_cnt_5_PLUS_IF_bram_serverA_ETC___d91 =
	     ...
	     (bram_serverAdapterB_outData_deqCalled$whas ? 3'd7 : 3'd0) ;
  assign bram_serverAdapterB_cnt_5_SLT_3_751_AND_bram_s_ETC___d1757 =
	     bram_serverAdapterB_cnt_5_SLT_3___d1751 &&
	     bram_serverAdapterB_1_cnt_03_SLT_3___d1752 &&
	     bram_serverAdapterB_2_cnt_21_SLT_3___d1753 &&
	     bram_serverAdapterB_3_cnt_39_SLT_3___d1754 ;
  assign bram_serverAdapterB_cnt_5_SLT_3___d1751 =
	     (bram_serverAdapterB_cnt ^ 3'h4) < 3'd7 ;
  assign bram_serverAdapterB_outData_outData_whas__770__ETC___d1782 =
	     bram_serverAdapterB_outData_outData$whas &&
	     (bram_serverAdapterB_1_outDataCore$EMPTY_N ||
	      bram_serverAdapterB_1_outData_enqData$whas) &&
	     bram_serverAdapterB_1_outData_outData_whas__77_ETC___d1780 ;
  assign byteCount__h28542 = x__h28660 - y__h28661 ;
  assign hasPull_AND_tlp_dpControl_wget__066_BITS_7_TO__ETC___d1332 =
	     ...
	     !tlp_reqMetaBodyInFlight &&
	     !tlp_fabMeta[128] ;
  assign hasPull_AND_tlp_dpControl_wget__066_BITS_7_TO__ETC___d1372 =
	     hasPull && dpControl[7:4] == 4'd0 && dpControl[3:2] == 2'd2 &&
	     dpControl[1:0] == 2'd1 &&
	     tlp_reqMetaInFlight &&
	     !tlp_tlpRcvBusy &&
	     tagm__h62184 == tlp_inF$D_OUT[47:40] &&
	     tlp_inF_first__357_BITS_63_TO_56_360_EQ_pciDev_ETC___d1370 ;
  assign hasPull_AND_tlp_dpControl_wget__066_BITS_7_TO__ETC___d1424 =
	     hasPull && dpControl[7:4] == 4'd0 && dpControl[3:2] == 2'd2 &&
	     dpControl[1:0] == 2'd1 &&
	     tlp_fabMeta[128] &&
  ...
  assign hasPull_AND_tlp_dpControl_wget__066_BITS_7_TO__ETC___d1462 =
	     hasPull && dpControl[7:4] == 4'd0 && dpControl[3:2] == 2'd2 &&
	     dpControl[1:0] == 2'd1 &&
	     tlp_fabMeta[128] &&
	     tlp_reqMesgInFlight &&
  ...
  assign hasPull_AND_tlp_dpControl_wget__066_BITS_7_TO__ETC___d1482 =
	     hasPull && dpControl[7:4] == 4'd0 && dpControl[3:2] == 2'd2 &&
	     dpControl[1:0] == 2'd1 &&
	     tlp_fabMeta[128] &&
	     tlp_reqMesgInFlight &&
	     tlp_gotResponseHeader ;
  assign hasPull_AND_tlp_dpControl_wget__066_BITS_7_TO__ETC___d1507 =
	     hasPull && dpControl[7:4] == 4'd0 && dpControl[3:2] == 2'd2 &&
	     dpControl[1:0] == 2'd1 &&
	     tlp_fabMeta[128] &&
	     tlp_dmaDoTailEvent &&
  ...
  assign hasPush_AND_tlp_dpControl_wget__066_BITS_7_TO__ETC___d1201 =
	     hasPush && dpControl[7:4] == 4'd0 && dpControl[3:2] == 2'd1 &&
	     dpControl[1:0] == 2'd1 &&
	     !tlp_tlpBRAM_mRespF$D_OUT[138] &&
  ...
  assign hasPush_AND_tlp_dpControl_wget__066_BITS_7_TO__ETC___d1257 =
	     ...
	     tlp_xmtMetaOK &&
	     tlp_postSeqDwell == 4'd0 ;
  assign idx__h19168 = 2'd0 - tlp_tlpBRAM_writeDWAddr[1:0] ;
  assign idx__h21399 = 2'd1 - tlp_tlpBRAM_writeDWAddr[1:0] ;
  assign idx__h22703 = 2'd2 - tlp_tlpBRAM_writeDWAddr[1:0] ;
  assign idx__h24007 = 2'd3 - tlp_tlpBRAM_writeDWAddr[1:0] ;
  assign idx__h26399 = 2'd0 - tlp_tlpBRAM_readNxtDWAddr[1:0] ;
  assign idx__h26867 = 2'd1 - tlp_tlpBRAM_readNxtDWAddr[1:0] ;
  assign idx__h27240 = 2'd2 - tlp_tlpBRAM_readNxtDWAddr[1:0] ;
  assign idx__h27613 = 2'd3 - tlp_tlpBRAM_readNxtDWAddr[1:0] ;
  assign lastBE__h45892 =
	     tlp_tlpBRAM_mRespF_first__102_BITS_71_TO_62_20_ETC___d2366 ?
	       4'd0 :
	       4'd15 ;
  assign lastBE__h62001 =
	     (thisRequestLength__h61694[11:2] == 10'd1) ? 4'd0 : 4'd15 ;
  assign lowAddr__h28541 =
	     { tlp_tlpBRAM_readReq$D_OUT[33:29], lowAddr10__h28540 } ;
  assign mesgMeta_opcode__h79564 =
	     { 24'h800000, wmi_wmi_mFlagF$D_OUT[31:24] } ;
  assign nowLS__h44209 =
	     { tlp_tlpBRAM_mRespF$D_OUT[39:32],
	       tlp_tlpBRAM_mRespF$D_OUT[47:40],
	       tlp_tlpBRAM_mRespF$D_OUT[55:48],
	       tlp_tlpBRAM_mRespF$D_OUT[63:56] } ;
  assign nowLS__h60443 =
	     { tlp_inF$D_OUT[39:32],
	       tlp_inF$D_OUT[47:40],
	       tlp_inF$D_OUT[55:48],
	       tlp_inF$D_OUT[63:56] } ;
  assign nowMS__h43266 =
	     { tlp_tlpBRAM_mRespF$D_OUT[71:64],
	       tlp_tlpBRAM_mRespF$D_OUT[79:72],
	       tlp_tlpBRAM_mRespF$D_OUT[87:80],
	       tlp_tlpBRAM_mRespF$D_OUT[95:88] } ;
  assign nowMS__h59502 =
	     { tlp_inF$D_OUT[71:64],
	       tlp_inF$D_OUT[79:72],
	       tlp_inF$D_OUT[87:80],
	       tlp_inF$D_OUT[95:88] } ;
  assign opcode__h42035 =
  ...
  assign rdat__h89080 = { 16'd0, bml_lclNumBufs } ;
  assign rdat__h89088 = { 16'd0, bml_fabNumBufs } ;
  assign rdat__h89096 = { 16'd0, bml_mesgBase } ;
  assign rdat__h89104 = { 16'd0, bml_metaBase } ;
  assign rdat__h89112 = { 16'd0, bml_mesgSize } ;
  assign rdat__h89120 = { 16'd0, bml_metaSize } ;
  assign rdat__h89128 = { 16'd0, bml_lclBufsCF } ;
  assign rdat__h89149 =
  ...
  assign rdat__h89183 = hasDebugLogic ? wmi_thisMesg : 32'd0 ;
  assign rdat__h89447 = hasDebugLogic ? wmi_lastMesg : 32'd0 ;
  assign rdat__h89497 =
	     hasDebugLogic ? { wmi_reqCount, wmi_wrtCount } : 32'd0 ;
  assign rdat__h89597 = hasDebugLogic ? 32'hDADEBABE : 32'd0 ;
  assign rdat__h89655 = { 24'd0, dpControl } ;
  assign rdat__h89677 = hasDebugLogic ? tlp_flowDiagCount : 32'd0 ;
  assign rdat__h89687 =
	     hasDebugLogic ?
	       { 4'h0,
		 tlp_complTimerCount,
		 ...
		 CASE_tlp_lastRuleFired_10_1_tlp_lastRuleFired__ETC__q1 } :
	       32'd0 ;
  assign rdat__h89809 = hasDebugLogic ? tlp_lastMetaV : 32'd0 ;
  assign rdat__h89930 = hasDebugLogic ? tlp_lastMetaV_1 : 32'd0 ;
  assign rdat__h89959 = hasDebugLogic ? tlp_lastMetaV_2 : 32'd0 ;
  assign rdat__h89988 = hasDebugLogic ? tlp_lastMetaV_3 : 32'd0 ;
  assign rdat__h90017 = hasDebugLogic ? 32'hC0DE0111 : 32'd0 ;
  assign rdata__h33971 =
	     tlp_tlpBRAM_readReq_first__97_BITS_30_TO_29_99_ETC___d2360[1] ?
	       IF_tlp_tlpBRAM_readReq_first__97_BITS_30_TO_29_ETC___d1037 :
	       IF_tlp_tlpBRAM_readReq_first__97_BITS_30_TO_29_ETC___d1042 ;
  assign rdata__h81414 =
	     { bram_serverAdapterB_3_outData_outData$wget,
	       bram_serverAdapterB_2_outData_outData$wget,
	       bram_serverAdapterB_1_outData_outData$wget,
	       bram_serverAdapterB_outData_outData$wget } ;
  assign rreq_tag__h45671 =
	     (y__h45481 == tlp_mesgLengthRemainPush) ? 8'h01 : 8'h0 ;
  assign rresp_data__h28587 =
	     { IF_tlp_tlpBRAM_readReq_first__97_BITS_30_TO_29_ETC___d2364[7:0],
	       IF_tlp_tlpBRAM_readReq_first__97_BITS_30_TO_29_ETC___d2364[15:8],
	       IF_tlp_tlpBRAM_readReq_first__97_BITS_30_TO_29_ETC___d2364[23:16],
	       IF_tlp_tlpBRAM_readReq_first__97_BITS_30_TO_29_ETC___d2364[31:24] } ;
  assign spanToNextPage__h45455 = 13'd4096 - { 1'd0, tlp_srcMesgAccu[11:0] } ;
  assign spanToNextPage__h61693 = 13'd4096 - { 1'd0, tlp_fabMesgAccu[11:0] } ;
  assign tag__h61969 = { 3'd0, tlp_dmaTag } ;
  assign tagm__h62184 = { 3'd0, tlp_dmaReqTag } ;
  assign thisRequestLength__h45456 =
	     (x__h45494[12:0] <= spanToNextPage__h45455) ?
	       x__h45494[12:0] :
	       spanToNextPage__h45455 ;
  assign thisRequestLength__h61694 =
	     (x__h61727[12:0] <= spanToNextPage__h61693) ?
	       x__h61727[12:0] :
	       spanToNextPage__h61693 ;
  assign tlp_dmaPullRemainDWLen_470_ULE_tlp_dmaPullRema_ETC___d2674 =
	     tlp_dmaPullRemainDWLen <= tlp_dmaPullRemainDWSub ;
  assign tlp_dmaPullRemainDWSub_484_ULE_4___d2675 =
	     tlp_dmaPullRemainDWSub <= 10'd4 ;
  ...
  assign tlp_inF_first__357_BIT_152_547_AND_NOT_tlp_inF_ETC___d1571 =
  ...
  assign tlp_outDwRemain_232_ULE_4___d2520 = tlp_outDwRemain <= 10'd4 ;
  ...
  assign tlp_tlpBRAM_mReqF_first__18_BIT_63_19_OR_IF_tl_ETC___d634 =
	     tlp_tlpBRAM_mReqF$D_OUT[63] ||
	     CASE_tlp_tlpBRAM_mReqFD_OUT_BITS_51_TO_50_NOT_ETC__q4 ;
  assign tlp_tlpBRAM_mRespF_first__102_BITS_71_TO_62_20_ETC___d2366 =
	     tlp_tlpBRAM_mRespF$D_OUT[71:62] <= 10'd1 ;
  ...
  assign tlp_tlpBRAM_readRemainDWLen_46_ULE_4___d847 =
	     tlp_tlpBRAM_readRemainDWLen <= 10'd4 ;
  assign tlp_tlpBRAM_readReq_first__97_BITS_30_TO_29_99_ETC___d2360 =
  ...
  assign tlp_tlpBRAM_writeRemainDWLen_62_ULE_1___d2368 =
	     tlp_tlpBRAM_writeRemainDWLen <= 10'd1 ;
  assign tlp_tlpBRAM_writeRemainDWLen_62_ULE_2___d2369 =
	     tlp_tlpBRAM_writeRemainDWLen <= 10'd2 ;
  assign tlp_tlpBRAM_writeRemainDWLen_62_ULE_3___d2344 =
	     tlp_tlpBRAM_writeRemainDWLen <= 10'd3 ;
  assign w_be__h46604 =
	     tlp_outDwRemain_232_ULE_4___d2520 ?
	       CASE_tlp_outDwRemain_BITS_1_TO_0_0xFFF0_0b0_0x_ETC__q3 :
	       16'd65535 ;
  assign w_data__h45865 =
	     { 22'd1048576,
	       tlp_tlpBRAM_mRespF$D_OUT[71:62],
	       pciDevice,
	       8'd0,
  ...
  assign w_data__h50929 =
	     { tlp_fabMeta[103:96],
	       ...
	       tlp_fabMeta[23:16],
	       tlp_fabMeta[31:24] } ;
  assign w_data__h63583 =
	     { 32'd1073741825,
	       pciDevice,
	       16'd15,
	       tlp_fabFlowAddr,
	       32'd16777216 } ;
  assign w_data__h64634 =
	     { 32'd1610612737,
	       pciDevice,
	       16'd15,
	       tlp_fabFlowAddrMS,
	       tlp_fabFlowAddr } ;
  assign wmi_wmi_operateD_691_AND_wmi_wmi_peerIsReady_6_ETC___d1862 =
	     wmi_wmi_operateD && wmi_wmi_peerIsReady &&
	     bram_serverAdapterB_cnt_5_SLT_3___d1751 &&
	     bram_serverAdapterB_1_cnt_03_SLT_3___d1752 &&
	     bram_serverAdapterB_2_cnt_21_SLT_3___d1753 &&
	     bram_serverAdapterB_3_cnt_39_SLT_3___d1754 &&
	     wmi_wmi_mFlagF$EMPTY_N ;
  assign wmi_wmi_operateD_691_AND_wmi_wmi_peerIsReady_6_ETC___d1883 =
	     wmi_wmi_operateD && wmi_wmi_peerIsReady &&
	     (bram_serverAdapterB_outDataCore$EMPTY_N ||
	      bram_serverAdapterB_outData_enqData$whas) &&
	     bram_serverAdapterB_outData_outData_whas__770__ETC___d1782 ;
  assign x3__h79524 = { 8'd0, wmi_wmi_mFlagF$D_OUT[23:0] } ;
  assign x__h28660 = x__h28662 - y__h28663 ;
  assign x__h28662 = { tlp_tlpBRAM_readReq$D_OUT[28:19], 2'b0 } ;
  assign x__h40201 =
	     { tlp_tlpBRAM_mRespF$D_OUT[7:0],
	       tlp_tlpBRAM_mRespF$D_OUT[15:8],
	       tlp_tlpBRAM_mRespF$D_OUT[23:16],
	       tlp_tlpBRAM_mRespF$D_OUT[31:24] } ;
  assign x__h45212 = { 15'd0, tlp_mesgLengthRemainPush } ;
  assign x__h45494 =
	     (tlp_mesgLengthRemainPush <= y__h45496) ?
  ...
  assign x__h56256 =
	     { tlp_inF$D_OUT[7:0],
	       ...
	       tlp_inF$D_OUT[23:16],
	       tlp_inF$D_OUT[31:24] } ;
  assign x__h61413 = { 15'd0, tlp_mesgLengthRemainPull } ;
  assign x__h61727 =
	     (tlp_mesgLengthRemainPull <= y__h61729) ?
	       tlp_mesgLengthRemainPull :
	       y__h61729 ;
  assign x__h85989 = (dpControl[1:0] == 2'd1) ? bml_fabNumBufs : 16'd0 ;
  assign x__h87113 = bml_lclBufsAR + 16'd1 ;
  assign x__h87118 = bml_lclBufsAR - 16'd1 ;
  assign x__h87190 = bml_lclBufsCF + 16'd1 ;
  assign x__h87195 = bml_lclBufsCF - 16'd1 ;
  assign x__h87232 = bml_fabBufsAvail + 16'd1 ;
  assign x__h87237 = bml_fabBufsAvail - 16'd1 ;
  assign x__h87270 = bml_lclCredit + 16'd1 ;
  assign x__h87275 = bml_lclCredit - 16'd1 ;
  assign y__h17382 = tlp_tlpBRAM_mReqF$D_OUT[63] ? 13'd0 : 13'd1 ;
  assign y__h17453 = tlp_tlpBRAM_mReqF$D_OUT[63] ? 10'd0 : 10'd1 ;
  assign y__h26104 = tlp_tlpBRAM_mReqF$D_OUT[60] ? 10'd0 : 10'd1 ;
  assign y__h26152 = tlp_tlpBRAM_mReqF$D_OUT[60] ? 13'd0 : 13'd1 ;
  assign y__h28661 =
	     (tlp_tlpBRAM_readReq$D_OUT[28:19] == 10'd1) ?
	       12'd0 :
	       { 10'd0, x__h28692 } ;
  assign y__h28663 = { 10'd0, x__h28669 } ;
  assign y__h29602 = tlp_tlpBRAM_readReq$D_OUT[60] ? 10'd0 : 10'd1 ;
  assign y__h45481 = { 4'd0, thisRequestLength__h45456 } ;
  assign y__h45496 = { 4'd0, tlp_maxPayloadSize } ;
  assign y__h45575 = { 19'd0, thisRequestLength__h45456 } ;
  assign y__h45623 = { 3'd0, thisRequestLength__h45456 } ;
  assign y__h46184 = (tlp_fabMesgAddrMS == 32'd0) ? 10'd1 : 10'd0 ;
  assign y__h46237 = { 20'd0, tlp_tlpBRAM_mRespF$D_OUT[71:62], 2'd0 } ;
  assign y__h61719 = { 4'd0, thisRequestLength__h61694 } ;
  assign y__h61729 = { 4'd0, tlp_maxReadReqSize } ;
  assign y__h61790 = { 19'd0, thisRequestLength__h61694 } ;
  assign y__h62391 = { 4'd0, tlp_inF$D_OUT[105:96], 2'd0 } ;
  assign y__h63098 =
	     tlp_dmaPullRemainDWSub_484_ULE_4___d2675 ?
  ...
  begin
    case (tlp_tlpBRAM_readReq$D_OUT[18:15])
      4'b1100: x__h28669 = 2'b10;
      4'b1110: x__h28669 = 2'b01;
      4'b1111: x__h28669 = 2'b0;
      default: x__h28669 = 2'b11;
    endcase
  end
  always@(tlp_tlpBRAM_readReq$D_OUT)
  begin
    case (tlp_tlpBRAM_readReq$D_OUT[14:11])
      4'b1100: x__h28692 = 2'b10;
      4'b1110: x__h28692 = 2'b01;
      4'b1111: x__h28692 = 2'b0;
      default: x__h28692 = 2'b11;
    endcase
  end
  ...
  begin
    case (wci_reqF$D_OUT[39:32])
      8'h0: _theResult____h89001 = rdat__h89080;
      8'h04: _theResult____h89001 = rdat__h89088;
      8'h08: _theResult____h89001 = rdat__h89096;
      8'h0C: _theResult____h89001 = rdat__h89104;
      8'h10: _theResult____h89001 = rdat__h89112;
      8'h14: _theResult____h89001 = rdat__h89120;
      8'h20: _theResult____h89001 = rdat__h89128;
      8'h24: _theResult____h89001 = 32'hF00DFACE;
      8'h28: _theResult____h89001 = rdat__h89149;
      8'h2C: _theResult____h89001 = rdat__h89156;
      8'h30: _theResult____h89001 = rdat__h89169;
      8'h34: _theResult____h89001 = rdat__h89176;
      8'h38: _theResult____h89001 = rdat__h89183;
      8'h3C: _theResult____h89001 = rdat__h89447;
      8'h40: _theResult____h89001 = rdat__h89497;
      8'h44: _theResult____h89001 = 32'd0;
      8'h48: _theResult____h89001 = rdat__h89597;
      8'h4C: _theResult____h89001 = 32'h00008000;
      8'h50: _theResult____h89001 = bml_fabMesgBase;
      8'h54: _theResult____h89001 = bml_fabMetaBase;
      8'h58: _theResult____h89001 = bml_fabMesgSize;
      8'h5C: _theResult____h89001 = bml_fabMetaSize;
      8'h60: _theResult____h89001 = bml_fabFlowBase;
      8'h64: _theResult____h89001 = bml_fabFlowSize;
      8'h68: _theResult____h89001 = rdat__h89655;
      8'h6C: _theResult____h89001 = rdat__h89677;
      8'h70: _theResult____h89001 = rdat__h89687;
      8'h80: _theResult____h89001 = rdat__h89809;
      8'h84: _theResult____h89001 = rdat__h89930;
      8'h88: _theResult____h89001 = rdat__h89959;
      8'h8C: _theResult____h89001 = rdat__h89988;
      8'h90: _theResult____h89001 = rdat__h90017;
      8'h94: _theResult____h89001 = bml_fabMesgBaseMS;
      8'h98: _theResult____h89001 = bml_fabMetaBaseMS;
      8'h9C: _theResult____h89001 = bml_fabFlowBaseMS;
      default: _theResult____h89001 = 32'd0;
    endcase
  end
  always@(tlp_tlpBRAM_readReq$D_OUT)
  begin
    case (tlp_tlpBRAM_readReq$D_OUT[18:15])
      4'b1000: lowAddr10__h28540 = 2'b11;
      4'b1100: lowAddr10__h28540 = 2'b10;
      4'b1110: lowAddr10__h28540 = 2'b01;
      default: lowAddr10__h28540 = 2'b0;
    endcase
  end
  ...
  begin
    case (dpControl[1:0])
	  ...
	  IF_bml_dpControl_wget__980_BITS_1_TO_0_986_EQ__ETC___d2057 =
	      bml_remDone;
      default: IF_bml_dpControl_wget__980_BITS_1_TO_0_986_EQ__ETC___d2057 =
		   bml_fabDone;
    endcase
  end
  ...
  always@(idx__h19168 or
	  tlp_tlpBRAM_writeRemainDWLen_62_ULE_3___d2344 or
	  tlp_tlpBRAM_writeRemainDWLen or
	  tlp_tlpBRAM_writeRemainDWLen_62_ULE_1___d2368 or
	  tlp_tlpBRAM_writeRemainDWLen_62_ULE_2___d2369)
  begin
    case (idx__h19168)
      2'd0:
  ...
  always@(tlp_tlpBRAM_mReqF$D_OUT or
	  bram_serverAdapterA_3_cnt_80_SLT_3___d2680 or
	  bram_serverAdapterA_cnt_6_SLT_3___d2677 or
	  bram_serverAdapterA_1_cnt_44_SLT_3___d2678 or
	  bram_serverAdapterA_2_cnt_62_SLT_3___d2679)
  begin
  ...
  always@(idx__h19168 or tlp_tlpBRAM_mReqF$D_OUT)
  begin
    case (idx__h19168)
      2'd0:
	  IF_0_MINUS_tlp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2442 =
  ...
  always@(idx__h21399 or tlp_tlpBRAM_mReqF$D_OUT)
  begin
    case (idx__h21399)
      2'd0:
	  IF_1_MINUS_tlp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2443 =
  ...
  always@(idx__h22703 or tlp_tlpBRAM_mReqF$D_OUT)
  begin
    case (idx__h22703)
      2'd0:
	  IF_2_MINUS_tlp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2444 =
  ...
  always@(idx__h24007 or tlp_tlpBRAM_mReqF$D_OUT)
  begin
    case (idx__h24007)
      2'd0:
	  IF_3_MINUS_tlp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2445 =
  ...
  begin
    ...
    if (RST_N)
      if (MUX_tlp_outF$enq_1__SEL_2)
	$display("[%0d]: %m: dmaXmtMetaHead FPactMesg-Step5/7", v__h48092);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_tlp_dmaXmtTailEvent)
	$display("[%0d]: %m: dmaXmtTailEvent FPactMesg-Step7/7", v__h54498);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_tlp_dmaXmtMetaBody)
	$display("[%0d]: %m: dmaXmtMetaBody FPactMesg-Step6/7", v__h54378);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_tlp_dmaXmtDoorbell)
	$display("[%0d]: %m: dmaXmtDoorbell FC/FPactFlow-Step1/1", v__h54670);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_tlp_dmaPullTailEvent)
	$display("[%0d]: %m: dmaPullTailEvent FPactMesg-Step5/5", v__h63306);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_tlp_dmaTailEventSender)
	$display("[%0d]: %m: dmaTailEventSender - generic", v__h68375);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_tlp_dmaRequestFarMeta)
	$display("[%0d]: %m: dmaRequestFarMeta FCactMesg-Step1/5", v__h55101);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_wci_cfwr && wci_reqF$D_OUT[39:32] == 8'h18)
	$display("[%0d] %m: fabDoneAvail Event", v__h88394);
    if (RST_N)
