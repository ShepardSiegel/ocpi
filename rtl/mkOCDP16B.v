...
//
// On Mon Aug 15 14:46:01 EDT 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkOCDP16B(pciDevice,
  ...
  reg [63 : 0] v__h15553,
	       ...
	       v__h77381,
	       v__h77535;
  reg [31 : 0] IF_0_MINUS_tlp_writeDWAddr_152_BITS_1_TO_0_153_ETC___d2252,
	       IF_1_MINUS_tlp_writeDWAddr_152_BITS_1_TO_0_153_ETC___d2253,
	       IF_2_MINUS_tlp_writeDWAddr_152_BITS_1_TO_0_153_ETC___d2254,
	       IF_3_MINUS_tlp_writeDWAddr_152_BITS_1_TO_0_153_ETC___d2255,
	       IF_tlp_readReq_first__380_BITS_30_TO_29_381_EQ_ETC___d2256,
	       _theResult____h77519;
  ...
  reg [1 : 0] lowAddr10__h52061, x__h52183, x__h52206;
  reg CASE_dpControl_BITS_1_TO_0_NOT_bml_fabDone_0_N_ETC__q6,
      ...
      IF_0_MINUS_tlp_writeDWAddr_152_BITS_1_TO_0_153_ETC___d1169,
      IF_0_MINUS_tlp_writeDWAddr_152_BITS_1_TO_0_153_ETC___d2634,
      IF_1_MINUS_tlp_writeDWAddr_152_BITS_1_TO_0_153_ETC___d1179,
      IF_1_MINUS_tlp_writeDWAddr_152_BITS_1_TO_0_153_ETC___d2635,
      IF_2_MINUS_tlp_writeDWAddr_152_BITS_1_TO_0_153_ETC___d1189,
      IF_2_MINUS_tlp_writeDWAddr_152_BITS_1_TO_0_153_ETC___d2636,
      IF_3_MINUS_tlp_writeDWAddr_152_BITS_1_TO_0_153_ETC___d1199,
      IF_3_MINUS_tlp_writeDWAddr_152_BITS_1_TO_0_153_ETC___d2637,
      IF_bml_dpControl_wget__886_BITS_1_TO_0_892_EQ__ETC___d1963,
      IF_tlp_readReq_first__380_BITS_30_TO_29_381_EQ_ETC___d1395;
  wire [127 : 0] IF_tlp_readReq_first__380_BITS_30_TO_29_381_PL_ETC___d1509,
		 IF_tlp_readReq_first__380_BITS_30_TO_29_381_PL_ETC___d1514,
		 pkt__h40506,
		 rdata__h57478,
		 rdata__h70297,
		 w_data__h25928,
		 ...
		 w_data__h37089,
		 w_data__h38604;
  wire [31 : 0] bml_fabFlowAddr_925_PLUS_bml_fabFlowSize_926___d2484,
		mesgMeta_opcode__h68447,
		nowLS__h22232,
		nowLS__h33515,
		nowMS__h22231,
		nowMS__h33514,
  ...
  wire [15 : 0] w_be__h26478,
		...
		y__h25695,
		y__h37467;
  wire [12 : 0] spanToNextPage__h25527,
		spanToNextPage__h36807,
		thisRequestLength__h25528,
		thisRequestLength__h36808,
  ...
  wire [11 : 0] byteCount__h52063, x__h52174, x__h52176, y__h52175, y__h52177;
  wire [7 : 0] rreq_tag__h25742, tag__h37083, tagm__h37260;
  wire [6 : 0] lowAddr__h52062;
  wire [3 : 0] lastBE__h25952, lastBE__h37110;
  ...
  wire [1 : 0] ab__h10393,
	       ...
	       idx__h50788,
	       idx__h51161,
	       tlp_readReq_first__380_BITS_30_TO_29_381_PLUS_1___d2206;
  wire IF_1_MINUS_tlp_writeDWAddr_152_BITS_1_TO_0_153_ETC___d1202,
       IF_tlp_readReq_first__380_BITS_30_TO_29_381_EQ_ETC___d1403,
       NOT_bml_lclBufDone_910_977_AND_IF_bml_dpContro_ETC___d1990,
       NOT_wmi_wrActive_708_709_OR_NOT_wmi_rdActive_7_ETC___d1718,
       _dfoo5,
       bml_crdBuf_value_868_EQ_bml_crdBuf_modulus_bw__ETC___d2563,
       bml_fabBuf_value_853_EQ_bml_fabBuf_modulus_bw__ETC___d2565,
       bml_lclBufDone_910_AND_IF_bml_dpControl_wget___ETC___d2639,
       bml_lclBuf_value_823_EQ_bml_lclBuf_modulus_bw__ETC___d2562,
       bml_remBuf_value_838_EQ_bml_remBuf_modulus_bw__ETC___d2564,
       bram_serverAdapterA_1_cnt_44_SLT_3___d2489,
       bram_serverAdapterA_2_cnt_62_SLT_3___d2490,
       bram_serverAdapterA_2_outDataCore_notEmpty__38_ETC___d1466,
       bram_serverAdapterA_3_cnt_80_SLT_3___d2491,
       bram_serverAdapterA_cnt_6_SLT_3___d2488,
       bram_serverAdapterA_outDataCore_notEmpty_OR_br_ETC___d1468,
       bram_serverAdapterB_1_cnt_03_SLT_3___d1658,
       bram_serverAdapterB_1_outData_outData_whas__67_ETC___d1686,
       bram_serverAdapterB_2_cnt_21_SLT_3___d1659,
       bram_serverAdapterB_3_cnt_39_SLT_3___d1660,
       bram_serverAdapterB_cnt_5_SLT_3_657_AND_bram_s_ETC___d1663,
       bram_serverAdapterB_cnt_5_SLT_3___d1657,
       bram_serverAdapterB_outData_outData_whas__676__ETC___d1688,
       hasPull_AND_tlp_dpControl_wget__34_BITS_3_TO_2_ETC___d1015,
       hasPull_AND_tlp_dpControl_wget__34_BITS_3_TO_2_ETC___d1040,
       hasPull_AND_tlp_dpControl_wget__34_BITS_3_TO_2_ETC___d877,
       hasPull_AND_tlp_dpControl_wget__34_BITS_3_TO_2_ETC___d911,
       hasPull_AND_tlp_dpControl_wget__34_BITS_3_TO_2_ETC___d962,
       hasPull_AND_tlp_dpControl_wget__34_BITS_3_TO_2_ETC___d995,
       hasPush_AND_tlp_dpControl_wget__34_BITS_3_TO_2_ETC___d654,
       hasPush_AND_tlp_dpControl_wget__34_BITS_3_TO_2_ETC___d763,
       hasPush_AND_tlp_dpControl_wget__34_BITS_3_TO_2_ETC___d813,
       tlp_dmaPullRemainDWLen_003_ULE_tlp_dmaPullRema_ETC___d2485,
       tlp_dmaPullRemainDWSub_017_ULE_4___d2486,
       tlp_inF_first__96_BITS_63_TO_56_99_EQ_pciDevic_ETC___d909,
       tlp_inF_first__96_BIT_152_058_AND_NOT_tlp_inF__ETC___d1082,
       tlp_mReqF_i_notEmpty__120_AND_IF_tlp_mReqF_fir_ETC___d1136,
       tlp_mRespF_first__67_BITS_71_TO_62_65_ULE_1___d2215,
       tlp_outDwRemain_88_ULE_4___d2321,
       tlp_rdRespDwRemain_497_ULE_4___d1499,
       tlp_readRemainDWLen_329_ULE_4___d1330,
       tlp_readReq_i_notFull__295_AND_IF_tlp_mReqF_fi_ETC___d1306,
       tlp_writeRemainDWLen_156_ULE_1___d2209,
       tlp_writeRemainDWLen_156_ULE_2___d2210,
       tlp_writeRemainDWLen_156_ULE_3___d2211,
       wmi_wmi_operateD_597_AND_wmi_wmi_peerIsReady_5_ETC___d1768,
       wmi_wmi_operateD_597_AND_wmi_wmi_peerIsReady_5_ETC___d1789;
  ...
  assign WILL_FIRE_RL_tlp_writeData =
	     ...
	     (IF_0_MINUS_tlp_writeDWAddr_152_BITS_1_TO_0_153_ETC___d1169 ||
	      bram_serverAdapterA_cnt_6_SLT_3___d2488) &&
	     IF_1_MINUS_tlp_writeDWAddr_152_BITS_1_TO_0_153_ETC___d1202 &&
  ...
  assign MUX_bml_fabBufsAvail$write_1__VAL_1 =
	     (bml_fabAvail && !bml_remStart) ? x__h75991 : x__h75996 ;
  assign MUX_bml_fabBufsAvail$write_1__VAL_2 =
	     (dpControl[3:2] == 2'd1) ? x__h74748 : 16'd0 ;
  assign MUX_bml_fabFlowAddr$write_1__VAL_1 =
	     bml_fabBuf_value_853_EQ_bml_fabBuf_modulus_bw__ETC___d2565 ?
	       bml_fabFlowBase :
	       bml_fabFlowAddr_925_PLUS_bml_fabFlowSize_926___d2484 ;
  ...
  assign MUX_bml_lclCredit$write_1__VAL_1 =
	     (bml_lclBufDone && !bml_remStart) ? x__h76029 : x__h76034 ;
  ...
  assign MUX_bram_memory$a_put_3__VAL_2 =
	     { IF_0_MINUS_tlp_writeDWAddr_152_BITS_1_TO_0_153_ETC___d2252[7:0],
	       IF_0_MINUS_tlp_writeDWAddr_152_BITS_1_TO_0_153_ETC___d2252[15:8],
	       IF_0_MINUS_tlp_writeDWAddr_152_BITS_1_TO_0_153_ETC___d2252[23:16],
	       IF_0_MINUS_tlp_writeDWAddr_152_BITS_1_TO_0_153_ETC___d2252[31:24] } ;
  assign MUX_bram_memory$b_put_2__VAL_2 =
	     wmi_lclMesgAddr[14:4] + { 1'd0, wmi_addr[13:4] } ;
  always@(idx__h45083 or
	  tlp_writeDWAddr_PLUS_3__q8 or
	  tlp_writeDWAddr or
	  tlp_writeDWAddr_PLUS_1__q9 or tlp_writeDWAddr_PLUS_2__q10)
  begin
  ...
  assign MUX_bram_memory_1$a_put_3__VAL_2 =
	     { IF_1_MINUS_tlp_writeDWAddr_152_BITS_1_TO_0_153_ETC___d2253[7:0],
	       IF_1_MINUS_tlp_writeDWAddr_152_BITS_1_TO_0_153_ETC___d2253[15:8],
	       IF_1_MINUS_tlp_writeDWAddr_152_BITS_1_TO_0_153_ETC___d2253[23:16],
	       IF_1_MINUS_tlp_writeDWAddr_152_BITS_1_TO_0_153_ETC___d2253[31:24] } ;
  ...
  assign MUX_bram_memory_2$a_put_3__VAL_2 =
	     { IF_2_MINUS_tlp_writeDWAddr_152_BITS_1_TO_0_153_ETC___d2254[7:0],
	       IF_2_MINUS_tlp_writeDWAddr_152_BITS_1_TO_0_153_ETC___d2254[15:8],
	       IF_2_MINUS_tlp_writeDWAddr_152_BITS_1_TO_0_153_ETC___d2254[23:16],
	       IF_2_MINUS_tlp_writeDWAddr_152_BITS_1_TO_0_153_ETC___d2254[31:24] } ;
  always@(idx__h47691 or
	  tlp_writeDWAddr_PLUS_3__q8 or
	  tlp_writeDWAddr or
	  tlp_writeDWAddr_PLUS_1__q9 or tlp_writeDWAddr_PLUS_2__q10)
  begin
  ...
  assign MUX_bram_memory_3$a_put_3__VAL_3 =
	     { IF_3_MINUS_tlp_writeDWAddr_152_BITS_1_TO_0_153_ETC___d2255[7:0],
	       IF_3_MINUS_tlp_writeDWAddr_152_BITS_1_TO_0_153_ETC___d2255[15:8],
	       IF_3_MINUS_tlp_writeDWAddr_152_BITS_1_TO_0_153_ETC___d2255[23:16],
	       IF_3_MINUS_tlp_writeDWAddr_152_BITS_1_TO_0_153_ETC___d2255[31:24] } ;
  ...
  assign MUX_tlp_fabMesgAccu$write_1__VAL_2 = tlp_fabMesgAccu + y__h26080 ;
  assign MUX_tlp_fabMesgAccu$write_1__VAL_3 = tlp_fabMesgAccu + y__h36904 ;
  ...
  assign MUX_tlp_mReqF$enq_1__VAL_3 =
	     { 88'hAAAAAAAAAAAAAAAAAAFFF8,
	       ...
	       thisRequestLength__h25528[11:2],
	       8'd255,
	       rreq_tag__h25742,
	       3'h2 } ;
  ...
  assign MUX_tlp_mesgComplReceived$write_1__VAL_2 =
	     tlp_mesgComplReceived + y__h38198 ;
  ...
  assign MUX_tlp_mesgLengthRemainPull$write_1__VAL_3 =
	     tlp_mesgLengthRemainPull - y__h36833 ;
  ...
  assign MUX_tlp_mesgLengthRemainPush$write_1__VAL_3 =
	     tlp_mesgLengthRemainPush - y__h25553 ;
  ...
  assign MUX_tlp_outF$enq_1__VAL_1 =
	     { 1'd1,
	       ...
	       23'd196607,
	       w_data__h25928 } ;
  assign MUX_tlp_outF$enq_1__VAL_2 = { 25'd16973823, w_data__h26909 } ;
  assign MUX_tlp_outF$enq_1__VAL_3 = { 25'd8585200, w_data__h27979 } ;
  assign MUX_tlp_outF$enq_1__VAL_4 = { 25'd25362416, w_data__h31116 } ;
  assign MUX_tlp_outF$enq_1__VAL_5 = { 25'd25362416, w_data__h37089 } ;
  assign MUX_tlp_outF$enq_1__VAL_6 = { 25'd25296895, w_data__h38604 } ;
  ...
  assign MUX_tlp_remMesgAccu$write_1__VAL_2 = tlp_remMesgAccu + y__h25695 ;
  assign MUX_tlp_remMesgAccu$write_1__VAL_3 = tlp_remMesgAccu + y__h37467 ;
  assign MUX_tlp_reqMesgInFlight$write_1__VAL_2 =
	     !tlp_dmaPullRemainDWSub_017_ULE_4___d2486 ||
	     !tlp_dmaPullRemainDWLen_003_ULE_tlp_dmaPullRema_ETC___d2485 ;
  assign MUX_tlp_srcMesgAccu$write_1__VAL_2 = tlp_srcMesgAccu + y__h25647 ;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, _theResult____h77519 } ;
  ...
  assign MUX_wmi_wmi_respF_q_0$write_1__VAL_1 =
	     (wmi_wmi_respF_c_r == 2'd1) ?
	       MUX_wmi_wmi_respF_q_0$write_1__VAL_2 :
	       wmi_wmi_respF_q_1 ;
  assign MUX_wmi_wmi_respF_q_0$write_1__VAL_2 = { 2'd1, rdata__h70297 } ;
  ...
  assign tlp_pullTagMatch_1$wget =
	     tagm__h37260 == tlp_inF$D_OUT[47:40] &&
	     tlp_inF_first__96_BITS_63_TO_56_99_EQ_pciDevic_ETC___d909 ;
  ...
  begin
    case (1'b1) // synopsys parallel_case
      WILL_FIRE_RL_tlp_dmaPullRequestFarMesg:
	  tlp_dmaPullRemainDWLen$D_IN = thisRequestLength__h36808[11:2];
      WILL_FIRE_RL_tlp_dmaPullResponseHeader:
  ...
  always@(WILL_FIRE_RL_tlp_dmaPullResponseHeader or
	  tlp_inF$D_OUT or
	  WILL_FIRE_RL_tlp_dmaPullResponseBody or
	  tlp_dmaPullRemainDWSub_017_ULE_4___d2486 or
	  WILL_FIRE_RL_tlp_dmaPullRequestFarMesg)
  begin
    case (1'b1) // synopsys parallel_case
      WILL_FIRE_RL_tlp_dmaPullResponseHeader:
  ...
  begin
    case (1'b1) // synopsys parallel_case
      ...
      WILL_FIRE_RL_tlp_dmaPullResponseBody:
	  tlp_tlpRcvBusy$D_IN = !tlp_dmaPullRemainDWSub_017_ULE_4___d2486;
  ...
  begin
    case (1'b1) // synopsys parallel_case
      ...
      WILL_FIRE_RL_wmi_doWriteFinalize: bram_memory$DIB = x3__h68407;
      WILL_FIRE_RL_wmi_reqMetadata || WILL_FIRE_RL_wmi_doReadReq:
  ...
  begin
    case (1'b1) // synopsys parallel_case
      ...
      WILL_FIRE_RL_wmi_doWriteFinalize:
	  bram_memory_1$DIB = mesgMeta_opcode__h68447;
      WILL_FIRE_RL_wmi_reqMetadata || WILL_FIRE_RL_wmi_doReadReq:
  ...
  // remaining internal signals
  assign IF_1_MINUS_tlp_writeDWAddr_152_BITS_1_TO_0_153_ETC___d1202 =
	     (IF_1_MINUS_tlp_writeDWAddr_152_BITS_1_TO_0_153_ETC___d1179 ||
	      bram_serverAdapterA_1_cnt_44_SLT_3___d2489) &&
	     (IF_2_MINUS_tlp_writeDWAddr_152_BITS_1_TO_0_153_ETC___d1189 ||
	      bram_serverAdapterA_2_cnt_62_SLT_3___d2490) &&
	     (IF_3_MINUS_tlp_writeDWAddr_152_BITS_1_TO_0_153_ETC___d1199 ||
	      bram_serverAdapterA_3_cnt_80_SLT_3___d2491) ;
  assign IF_tlp_readReq_first__380_BITS_30_TO_29_381_EQ_ETC___d1403 =
	     (tlp_readReq$D_OUT[30:29] == 2'd0) ?
	       (bram_serverAdapterA_outDataCore$EMPTY_N ||
		bram_serverAdapterA_outData_enqData$whas) &&
	       bram_serverAdapterA_outData_outData$whas :
	       IF_tlp_readReq_first__380_BITS_30_TO_29_381_EQ_ETC___d1395 &&
	       CASE_tlp_readReqD_OUT_BITS_30_TO_29_NOT_tlp_r_ETC__q17 ;
  assign IF_tlp_readReq_first__380_BITS_30_TO_29_381_PL_ETC___d1509 =
	     tlp_readReq_first__380_BITS_30_TO_29_381_PLUS_1___d2206[0] ?
	       { bram_serverAdapterA_3_outData_outData$wget[7:0],
		 bram_serverAdapterA_3_outData_outData$wget[15:8],
		 bram_serverAdapterA_3_outData_outData$wget[23:16],
		 bram_serverAdapterA_3_outData_outData$wget[31:24],
		 ...
		 bram_serverAdapterA_1_outData_outData$wget[23:16],
		 bram_serverAdapterA_1_outData_outData$wget[31:24] } ;
  assign IF_tlp_readReq_first__380_BITS_30_TO_29_381_PL_ETC___d1514 =
	     tlp_readReq_first__380_BITS_30_TO_29_381_PLUS_1___d2206[0] ?
	       { bram_serverAdapterA_1_outData_outData$wget[7:0],
		 bram_serverAdapterA_1_outData_outData$wget[15:8],
		 bram_serverAdapterA_1_outData_outData$wget[23:16],
  ...
  assign NOT_bml_lclBufDone_910_977_AND_IF_bml_dpContro_ETC___d1990 =
	     !bml_lclBufDone &&
	     CASE_dpControl_BITS_1_TO_0_bml_fabDone_0_bml_f_ETC__q2 ;
  assign NOT_wmi_wrActive_708_709_OR_NOT_wmi_rdActive_7_ETC___d1718 =
  ...
  assign ab__h8863 =
	     MUX_bram_serverAdapterB_1_writeWithResp$wset_1__SEL_1 ?
	       2'd0 :
	       2'd2 ;
  assign bml_crdBuf_value_868_EQ_bml_crdBuf_modulus_bw__ETC___d2563 =
	     bml_crdBuf_value == bml_crdBuf_modulus ;
  assign bml_fabBuf_value_853_EQ_bml_fabBuf_modulus_bw__ETC___d2565 =
	     bml_fabBuf_value == bml_fabBuf_modulus ;
  assign bml_fabFlowAddr_925_PLUS_bml_fabFlowSize_926___d2484 =
	     bml_fabFlowAddr + bml_fabFlowSize ;
  assign bml_lclBufDone_910_AND_IF_bml_dpControl_wget___ETC___d2639 =
	     bml_lclBufDone &&
	     CASE_dpControl_BITS_1_TO_0_NOT_bml_fabDone_0_N_ETC__q6 ;
  assign bml_lclBuf_value_823_EQ_bml_lclBuf_modulus_bw__ETC___d2562 =
	     bml_lclBuf_value == bml_lclBuf_modulus ;
  assign bml_remBuf_value_838_EQ_bml_remBuf_modulus_bw__ETC___d2564 =
  ...
  assign bram_serverAdapterA_2_outDataCore_notEmpty__38_ETC___d1466 =
	     (bram_serverAdapterA_2_outDataCore$EMPTY_N ||
	      bram_serverAdapterA_2_outData_enqData$whas) &&
	     (bram_serverAdapterA_3_outDataCore$EMPTY_N ||
	      bram_serverAdapterA_3_outData_enqData$whas) &&
  ...
  assign bram_serverAdapterA_outDataCore_notEmpty_OR_br_ETC___d1468 =
	     (bram_serverAdapterA_outDataCore$EMPTY_N ||
	      bram_serverAdapterA_outData_enqData$whas) &&
	     (bram_serverAdapterA_1_outDataCore$EMPTY_N ||
	      bram_serverAdapterA_1_outData_enqData$whas) &&
  ...
  assign bram_serverAdapterB_1_cnt_03_SLT_3___d1658 =
	     (bram_serverAdapterB_1_cnt ^ 3'h4) < 3'd7 ;
  assign bram_serverAdapterB_1_outData_outData_whas__67_ETC___d1686 =
	     bram_serverAdapterB_1_outData_outData$whas &&
	     (bram_serverAdapterB_2_outDataCore$EMPTY_N ||
	      bram_serverAdapterB_2_outData_enqData$whas) &&
	     bram_serverAdapterB_2_outData_outData$whas &&
  ...
  assign bram_serverAdapterB_2_cnt_21_PLUS_IF_bram_serv_ETC___d327 =
	     ...
	     (bram_serverAdapterB_outData_deqCalled$whas ? 3'd7 : 3'd0) ;
  assign bram_serverAdapterB_2_cnt_21_SLT_3___d1659 =
  ...
  assign bram_serverAdapterB_3_cnt_39_PLUS_IF_bram_serv_ETC___d445 =
	     ...
	     (bram_serverAdapterB_outData_deqCalled$whas ? 3'd7 : 3'd0) ;
  assign bram_serverAdapterB_3_cnt_39_SLT_3___d1660 =
  ...
  assign bram_serverAdapterB_cnt_5_PLUS_IF_bram_serverA_ETC___d91 =
	     ...
	     (bram_serverAdapterB_outData_deqCalled$whas ? 3'd7 : 3'd0) ;
  assign bram_serverAdapterB_cnt_5_SLT_3_657_AND_bram_s_ETC___d1663 =
	     bram_serverAdapterB_cnt_5_SLT_3___d1657 &&
	     bram_serverAdapterB_1_cnt_03_SLT_3___d1658 &&
	     bram_serverAdapterB_2_cnt_21_SLT_3___d1659 &&
	     bram_serverAdapterB_3_cnt_39_SLT_3___d1660 ;
  assign bram_serverAdapterB_cnt_5_SLT_3___d1657 =
	     (bram_serverAdapterB_cnt ^ 3'h4) < 3'd7 ;
  assign bram_serverAdapterB_outData_outData_whas__676__ETC___d1688 =
	     bram_serverAdapterB_outData_outData$whas &&
	     (bram_serverAdapterB_1_outDataCore$EMPTY_N ||
	      bram_serverAdapterB_1_outData_enqData$whas) &&
	     bram_serverAdapterB_1_outData_outData_whas__67_ETC___d1686 ;
  assign byteCount__h52063 = x__h52174 - y__h52175 ;
  ...
  assign hasPull_AND_tlp_dpControl_wget__34_BITS_3_TO_2_ETC___d1040 =
	     hasPull && dpControl[3:2] == 2'd2 && dpControl[1:0] == 2'd1 &&
	     tlp_fabMeta[128] &&
	     tlp_dmaDoTailEvent &&
	     tlp_postSeqDwell == 4'd0 &&
  ...
  assign hasPull_AND_tlp_dpControl_wget__34_BITS_3_TO_2_ETC___d877 =
	     ...
	     !tlp_fabMeta[128] &&
	     tlp_nearBufReady ;
  assign hasPull_AND_tlp_dpControl_wget__34_BITS_3_TO_2_ETC___d911 =
	     hasPull && dpControl[3:2] == 2'd2 && dpControl[1:0] == 2'd1 &&
	     tlp_reqMetaInFlight &&
	     !tlp_tlpRcvBusy &&
	     tagm__h37260 == tlp_inF$D_OUT[47:40] &&
	     tlp_inF_first__96_BITS_63_TO_56_99_EQ_pciDevic_ETC___d909 ;
  assign hasPull_AND_tlp_dpControl_wget__34_BITS_3_TO_2_ETC___d962 =
	     hasPull && dpControl[3:2] == 2'd2 && dpControl[1:0] == 2'd1 &&
	     tlp_fabMeta[128] &&
	     tlp_fabMeta[127:96] != 32'd0 &&
	     !tlp_tlpXmtBusy &&
  ...
  assign hasPull_AND_tlp_dpControl_wget__34_BITS_3_TO_2_ETC___d995 =
	     hasPull && dpControl[3:2] == 2'd2 && dpControl[1:0] == 2'd1 &&
	     tlp_fabMeta[128] &&
	     tlp_reqMesgInFlight &&
	     !tlp_tlpRcvBusy &&
  ...
  assign hasPush_AND_tlp_dpControl_wget__34_BITS_3_TO_2_ETC___d654 =
	     ...
	     tlp_nearBufReady &&
	     tlp_farBufReady ;
  assign hasPush_AND_tlp_dpControl_wget__34_BITS_3_TO_2_ETC___d763 =
	     hasPush && dpControl[3:2] == 2'd1 && dpControl[1:0] == 2'd1 &&
	     !tlp_mRespF$D_OUT[138] &&
	     tlp_mRespF$D_OUT[89:88] == 2'd2 &&
	     !tlp_tlpXmtBusy &&
	     tlp_postSeqDwell == 4'd0 ;
  assign hasPush_AND_tlp_dpControl_wget__34_BITS_3_TO_2_ETC___d813 =
	     hasPush && dpControl[3:2] == 2'd1 && dpControl[1:0] == 2'd1 &&
	     tlp_fabMeta[128] &&
	     !tlp_tlpXmtBusy &&
	     !tlp_xmtMetaInFlight &&
	     tlp_xmtMetaOK &&
	     tlp_postSeqDwell == 4'd0 ;
  assign idx__h42852 = 2'd0 - tlp_writeDWAddr[1:0] ;
  assign idx__h45083 = 2'd1 - tlp_writeDWAddr[1:0] ;
  assign idx__h46387 = 2'd2 - tlp_writeDWAddr[1:0] ;
  assign idx__h47691 = 2'd3 - tlp_writeDWAddr[1:0] ;
  assign idx__h49947 = 2'd0 - tlp_readNxtDWAddr[1:0] ;
  assign idx__h50415 = 2'd1 - tlp_readNxtDWAddr[1:0] ;
  assign idx__h50788 = 2'd2 - tlp_readNxtDWAddr[1:0] ;
  assign idx__h51161 = 2'd3 - tlp_readNxtDWAddr[1:0] ;
  assign lastBE__h25952 =
	     tlp_mRespF_first__67_BITS_71_TO_62_65_ULE_1___d2215 ?
	       4'd0 :
	       4'd15 ;
  assign lastBE__h37110 =
	     (thisRequestLength__h36808[11:2] == 10'd1) ? 4'd0 : 4'd15 ;
  assign lowAddr__h52062 = { tlp_readReq$D_OUT[33:29], lowAddr10__h52061 } ;
  assign mesgMeta_opcode__h68447 =
	     { 24'h800000, wmi_wmi_mFlagF$D_OUT[31:24] } ;
  assign nowLS__h22232 =
	     { tlp_mRespF$D_OUT[39:32],
	       tlp_mRespF$D_OUT[47:40],
	       tlp_mRespF$D_OUT[55:48],
	       tlp_mRespF$D_OUT[63:56] } ;
  assign nowLS__h33515 =
	     { tlp_inF$D_OUT[39:32],
	       tlp_inF$D_OUT[47:40],
	       tlp_inF$D_OUT[55:48],
	       tlp_inF$D_OUT[63:56] } ;
  assign nowMS__h22231 =
	     { tlp_mRespF$D_OUT[71:64],
	       tlp_mRespF$D_OUT[79:72],
	       tlp_mRespF$D_OUT[87:80],
	       tlp_mRespF$D_OUT[95:88] } ;
  assign nowMS__h33514 =
	     { tlp_inF$D_OUT[71:64],
	       tlp_inF$D_OUT[79:72],
	       tlp_inF$D_OUT[87:80],
	       tlp_inF$D_OUT[95:88] } ;
  assign opcode__h22230 =
	     { tlp_mRespF$D_OUT[103:96],
	       tlp_mRespF$D_OUT[111:104],
	       tlp_mRespF$D_OUT[119:112],
	       tlp_mRespF$D_OUT[127:120] } ;
  assign opcode__h33513 =
  ...
  assign rdat__h77598 = { 16'd0, bml_lclNumBufs } ;
  assign rdat__h77606 = { 16'd0, bml_fabNumBufs } ;
  assign rdat__h77614 = { 16'd0, bml_mesgBase } ;
  assign rdat__h77622 = { 16'd0, bml_metaBase } ;
  assign rdat__h77630 = { 16'd0, bml_mesgSize } ;
  assign rdat__h77638 = { 16'd0, bml_metaSize } ;
  assign rdat__h77646 = { 16'd0, bml_lclBufsCF } ;
  assign rdat__h77667 = { bml_lclBufsAR, bml_fabBufsAvail } ;
  assign rdat__h77672 = { bml_remBuf_value, bml_lclBuf_value } ;
  assign rdat__h77683 = { bml_lclStarts, bml_lclDones } ;
  assign rdat__h77688 = { bml_remStarts, bml_remDones } ;
  assign rdat__h78005 = { wmi_reqCount, wmi_wrtCount } ;
  assign rdat__h78159 = { 28'd0, dpControl } ;
  assign rdat__h78176 =
	     { 4'h0,
	       tlp_complTimerCount,
	       12'h0,
	       CASE_tlp_lastRuleFired_8_1_tlp_lastRuleFired_2_ETC__q1 } ;
  assign rdata__h57478 =
	     tlp_readReq_first__380_BITS_30_TO_29_381_PLUS_1___d2206[1] ?
	       IF_tlp_readReq_first__380_BITS_30_TO_29_381_PL_ETC___d1509 :
	       IF_tlp_readReq_first__380_BITS_30_TO_29_381_PL_ETC___d1514 ;
  assign rdata__h70297 =
	     { bram_serverAdapterB_3_outData_outData$wget,
	       bram_serverAdapterB_2_outData_outData$wget,
	       bram_serverAdapterB_1_outData_outData$wget,
	       bram_serverAdapterB_outData_outData$wget } ;
  assign rreq_tag__h25742 =
	     (y__h25553 == tlp_mesgLengthRemainPush) ? 8'h01 : 8'h0 ;
  assign rresp_data__h52105 =
	     { IF_tlp_readReq_first__380_BITS_30_TO_29_381_EQ_ETC___d2256[7:0],
	       IF_tlp_readReq_first__380_BITS_30_TO_29_381_EQ_ETC___d2256[15:8],
	       IF_tlp_readReq_first__380_BITS_30_TO_29_381_EQ_ETC___d2256[23:16],
	       IF_tlp_readReq_first__380_BITS_30_TO_29_381_EQ_ETC___d2256[31:24] } ;
  assign spanToNextPage__h25527 = 13'd4096 - { 1'd0, tlp_srcMesgAccu[11:0] } ;
  assign spanToNextPage__h36807 = 13'd4096 - { 1'd0, tlp_fabMesgAccu[11:0] } ;
  assign tag__h37083 = { 3'd0, tlp_dmaTag } ;
  assign tagm__h37260 = { 3'd0, tlp_dmaReqTag } ;
  assign thisRequestLength__h25528 =
	     (x__h25566[12:0] <= spanToNextPage__h25527) ?
	       x__h25566[12:0] :
	       spanToNextPage__h25527 ;
  assign thisRequestLength__h36808 =
	     (x__h36841[12:0] <= spanToNextPage__h36807) ?
	       x__h36841[12:0] :
	       spanToNextPage__h36807 ;
  assign tlp_dmaPullRemainDWLen_003_ULE_tlp_dmaPullRema_ETC___d2485 =
	     tlp_dmaPullRemainDWLen <= tlp_dmaPullRemainDWSub ;
  assign tlp_dmaPullRemainDWSub_017_ULE_4___d2486 =
	     tlp_dmaPullRemainDWSub <= 10'd4 ;
  assign tlp_inF_first__96_BITS_63_TO_56_99_EQ_pciDevic_ETC___d909 =
	     tlp_inF$D_OUT[63:56] == pciDevice[15:8] &&
	     tlp_inF$D_OUT[55:51] == pciDevice[7:3] &&
	     tlp_inF$D_OUT[50:48] == pciDevice[2:0] ;
  assign tlp_inF_first__96_BIT_152_058_AND_NOT_tlp_inF__ETC___d1082 =
	     tlp_inF$D_OUT[152] && !tlp_inF$D_OUT[110] &&
	     !tlp_inF$D_OUT[125] &&
	     tlp_inF$D_OUT[124:120] == 5'b0 ||
	     !tlp_inF$D_OUT[152] && !tlp_inIgnorePkt ;
  assign tlp_mReqF_i_notEmpty__120_AND_IF_tlp_mReqF_fir_ETC___d1136 =
	     tlp_mReqF$EMPTY_N &&
	     CASE_tlp_mReqFD_OUT_BITS_51_TO_50_NOT_tlp_mRe_ETC__q4 ;
  assign tlp_mRespF_first__67_BITS_71_TO_62_65_ULE_1___d2215 =
	     tlp_mRespF$D_OUT[71:62] <= 10'd1 ;
  ...
  assign tlp_outDwRemain_88_ULE_4___d2321 = tlp_outDwRemain <= 10'd4 ;
  assign tlp_rdRespDwRemain_497_ULE_4___d1499 = tlp_rdRespDwRemain <= 10'd4 ;
  ...
  assign tlp_readRemainDWLen_329_ULE_4___d1330 =
	     tlp_readRemainDWLen <= 10'd4 ;
  assign tlp_readReq_first__380_BITS_30_TO_29_381_PLUS_1___d2206 =
	     tlp_readReq$D_OUT[30:29] + 2'd1 ;
  assign tlp_readReq_i_notFull__295_AND_IF_tlp_mReqF_fi_ETC___d1306 =
	     tlp_readReq$FULL_N &&
	     CASE_tlp_mReqFD_OUT_BITS_30_TO_29_NOT_tlp_mRe_ETC__q5 ;
  ...
  assign tlp_writeRemainDWLen_156_ULE_1___d2209 =
	     tlp_writeRemainDWLen <= 10'd1 ;
  assign tlp_writeRemainDWLen_156_ULE_2___d2210 =
	     tlp_writeRemainDWLen <= 10'd2 ;
  assign tlp_writeRemainDWLen_156_ULE_3___d2211 =
	     tlp_writeRemainDWLen <= 10'd3 ;
  assign w_be__h26478 =
	     tlp_outDwRemain_88_ULE_4___d2321 ?
	       CASE_tlp_outDwRemain_BITS_1_TO_0_0xFFF0_0b0_0x_ETC__q3 :
	       16'd65535 ;
  assign w_data__h25928 =
	     { 22'd1048580,
	       tlp_mRespF$D_OUT[71:62],
	       pciDevice,
	       8'd0,
  ...
  assign w_data__h31116 =
	     { 32'd4100,
	       ...
	       34'd0 } ;
  assign w_data__h37089 =
	     { 22'd4,
	       thisRequestLength__h36808[11:2],
	       pciDevice,
	       tag__h37083,
	       lastBE__h37110,
	       4'd15,
	       ...
	       34'd0 } ;
  assign w_data__h38604 =
	     { 32'd1073745921,
	       pciDevice,
	       16'd15,
	       tlp_fabFlowAddr,
	       32'd16777216 } ;
  assign wmi_wmi_operateD_597_AND_wmi_wmi_peerIsReady_5_ETC___d1768 =
	     wmi_wmi_operateD && wmi_wmi_peerIsReady &&
	     bram_serverAdapterB_cnt_5_SLT_3___d1657 &&
	     bram_serverAdapterB_1_cnt_03_SLT_3___d1658 &&
	     bram_serverAdapterB_2_cnt_21_SLT_3___d1659 &&
	     bram_serverAdapterB_3_cnt_39_SLT_3___d1660 &&
	     wmi_wmi_mFlagF$EMPTY_N ;
  assign wmi_wmi_operateD_597_AND_wmi_wmi_peerIsReady_5_ETC___d1789 =
	     wmi_wmi_operateD && wmi_wmi_peerIsReady &&
	     (bram_serverAdapterB_outDataCore$EMPTY_N ||
	      bram_serverAdapterB_outData_enqData$whas) &&
	     bram_serverAdapterB_outData_outData_whas__676__ETC___d1688 ;
  assign x3__h68407 = { 8'd0, wmi_wmi_mFlagF$D_OUT[23:0] } ;
  assign x__h22293 = { 15'd0, tlp_mesgLengthRemainPush } ;
  assign x__h25566 =
	     (tlp_mesgLengthRemainPush <= y__h25568) ?
	       tlp_mesgLengthRemainPush :
	       y__h25568 ;
  assign x__h33545 = { 15'd0, tlp_mesgLengthRemainPull } ;
  assign x__h36841 =
	     (tlp_mesgLengthRemainPull <= y__h36843) ?
	       tlp_mesgLengthRemainPull :
	       y__h36843 ;
  assign x__h52174 = x__h52176 - y__h52177 ;
  assign x__h52176 = { tlp_readReq$D_OUT[28:19], 2'b0 } ;
  assign x__h74748 = (dpControl[1:0] == 2'd1) ? bml_fabNumBufs : 16'd0 ;
  assign x__h75872 = bml_lclBufsAR + 16'd1 ;
  assign x__h75877 = bml_lclBufsAR - 16'd1 ;
  assign x__h75949 = bml_lclBufsCF + 16'd1 ;
  assign x__h75954 = bml_lclBufsCF - 16'd1 ;
  assign x__h75991 = bml_fabBufsAvail + 16'd1 ;
  assign x__h75996 = bml_fabBufsAvail - 16'd1 ;
  assign x__h76029 = bml_lclCredit + 16'd1 ;
  assign x__h76034 = bml_lclCredit - 16'd1 ;
  assign y__h25553 = { 4'd0, thisRequestLength__h25528 } ;
  assign y__h25568 = { 4'd0, tlp_maxPayloadSize } ;
  assign y__h25647 = { 19'd0, thisRequestLength__h25528 } ;
  assign y__h25695 = { 3'd0, thisRequestLength__h25528 } ;
  assign y__h26080 = { 20'd0, tlp_mRespF$D_OUT[71:62], 2'd0 } ;
  assign y__h36833 = { 4'd0, thisRequestLength__h36808 } ;
  assign y__h36843 = { 4'd0, tlp_maxReadReqSize } ;
  assign y__h36904 = { 19'd0, thisRequestLength__h36808 } ;
  assign y__h37467 = { 4'd0, tlp_inF$D_OUT[105:96], 2'd0 } ;
  assign y__h38198 =
	     tlp_dmaPullRemainDWSub_017_ULE_4___d2486 ?
  ...
  assign y__h52175 =
	     (tlp_readReq$D_OUT[28:19] == 10'd1) ?
	       12'd0 :
	       { 10'd0, x__h52206 } ;
  assign y__h52177 = { 10'd0, x__h52183 } ;
  always@(tlp_readReq$D_OUT)
  begin
    case (tlp_readReq$D_OUT[18:15])
      4'b1100: x__h52183 = 2'b10;
      4'b1110: x__h52183 = 2'b01;
      4'b1111: x__h52183 = 2'b0;
      default: x__h52183 = 2'b11;
    endcase
  end
  always@(tlp_readReq$D_OUT)
  begin
    case (tlp_readReq$D_OUT[14:11])
      4'b1100: x__h52206 = 2'b10;
      4'b1110: x__h52206 = 2'b01;
      4'b1111: x__h52206 = 2'b0;
      default: x__h52206 = 2'b11;
    endcase
  end
  ...
  begin
    case (tlp_readReq$D_OUT[18:15])
      4'b1000: lowAddr10__h52061 = 2'b11;
      4'b1100: lowAddr10__h52061 = 2'b10;
      4'b1110: lowAddr10__h52061 = 2'b01;
      default: lowAddr10__h52061 = 2'b0;
    endcase
  end
  always@(wci_reqF$D_OUT or
	  ...
	  bml_fabMesgSize or
	  bml_fabMetaSize or
	  bml_fabFlowBase or bml_fabFlowSize or rdat__h78159 or rdat__h78176)
  begin
    case (wci_reqF$D_OUT[39:32])
      8'h0: _theResult____h77519 = rdat__h77598;
      8'h04: _theResult____h77519 = rdat__h77606;
      8'h08: _theResult____h77519 = rdat__h77614;
      8'h0C: _theResult____h77519 = rdat__h77622;
      8'h10: _theResult____h77519 = rdat__h77630;
      8'h14: _theResult____h77519 = rdat__h77638;
      8'h20: _theResult____h77519 = rdat__h77646;
      8'h24: _theResult____h77519 = 32'hF00DFACE;
      8'h28: _theResult____h77519 = rdat__h77667;
      8'h2C: _theResult____h77519 = rdat__h77672;
      8'h30: _theResult____h77519 = rdat__h77683;
      8'h34: _theResult____h77519 = rdat__h77688;
      8'h38: _theResult____h77519 = wmi_thisMesg;
      8'h3C: _theResult____h77519 = wmi_lastMesg;
      8'h40: _theResult____h77519 = rdat__h78005;
      8'h44: _theResult____h77519 = 32'h0;
      8'h48: _theResult____h77519 = 32'hDADEBABE;
      8'h4C: _theResult____h77519 = 32'h00008000;
      8'h50: _theResult____h77519 = bml_fabMesgBase;
      8'h54: _theResult____h77519 = bml_fabMetaBase;
      8'h58: _theResult____h77519 = bml_fabMesgSize;
      8'h5C: _theResult____h77519 = bml_fabMetaSize;
      8'h60: _theResult____h77519 = bml_fabFlowBase;
      8'h64: _theResult____h77519 = bml_fabFlowSize;
      8'h68: _theResult____h77519 = rdat__h78159;
      8'h70: _theResult____h77519 = rdat__h78176;
      default: _theResult____h77519 = 32'd0;
    endcase
  end
  ...
  always@(idx__h42852 or
	  tlp_writeRemainDWLen_156_ULE_3___d2211 or
	  tlp_writeRemainDWLen or
	  tlp_writeRemainDWLen_156_ULE_1___d2209 or
	  tlp_writeRemainDWLen_156_ULE_2___d2210)
  begin
    case (idx__h42852)
      2'd0:
  ...
  always@(idx__h42852 or tlp_mReqF$D_OUT)
  begin
    case (idx__h42852)
      2'd0:
	  IF_0_MINUS_tlp_writeDWAddr_152_BITS_1_TO_0_153_ETC___d2252 =
  ...
  always@(idx__h45083 or tlp_mReqF$D_OUT)
  begin
    case (idx__h45083)
      2'd0:
	  IF_1_MINUS_tlp_writeDWAddr_152_BITS_1_TO_0_153_ETC___d2253 =
  ...
  always@(idx__h46387 or tlp_mReqF$D_OUT)
  begin
    case (idx__h46387)
      2'd0:
	  IF_2_MINUS_tlp_writeDWAddr_152_BITS_1_TO_0_153_ETC___d2254 =
  ...
  always@(idx__h47691 or tlp_mReqF$D_OUT)
  begin
    case (idx__h47691)
      2'd0:
	  IF_3_MINUS_tlp_writeDWAddr_152_BITS_1_TO_0_153_ETC___d2255 =
  ...
  begin
    case (tlp_readReq$D_OUT[30:29])
	  ...
	  IF_tlp_readReq_first__380_BITS_30_TO_29_381_EQ_ETC___d1395 =
	      bram_serverAdapterA_2_outDataCore$EMPTY_N ||
	      bram_serverAdapterA_2_outData_enqData$whas;
      default: IF_tlp_readReq_first__380_BITS_30_TO_29_381_EQ_ETC___d1395 =
		   tlp_readReq$D_OUT[30:29] != 2'd3 ||
		   bram_serverAdapterA_3_outDataCore$EMPTY_N ||
		   bram_serverAdapterA_3_outData_enqData$whas;
    endcase
  ...
  begin
    ...
    if (RST_N)
      if (WILL_FIRE_RL_tlp_dmaXmtMetaHead)
	$display("[%0d]: %m: dmaXmtMetaHead FPactMesg-Step5/7", v__h27810);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_tlp_dmaXmtTailEvent)
	$display("[%0d]: %m: dmaXmtTailEvent FPactMesg-Step7/7", v__h30689);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_tlp_dmaXmtMetaBody)
	$display("[%0d]: %m: dmaXmtMetaBody FPactMesg-Step6/7", v__h30569);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_tlp_dmaXmtDoorbell)
	$display("[%0d]: %m: dmaXmtDoorbell FC/FPactFlow-Step1/1", v__h30858);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_tlp_dmaPullTailEvent)
	$display("[%0d]: %m: dmaPullTailEvent FPactMesg-Step5/5", v__h38380);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_tlp_dmaTailEventSender)
	$display("[%0d]: %m: dmaTailEventSender - generic", v__h39505);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_tlp_dmaRequestFarMeta)
	$display("[%0d]: %m: dmaRequestFarMeta FCactMesg-Step1/5", v__h31249);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_wci_cfwr && wci_reqF$D_OUT[39:32] == 8'h18)
	$display("[%0d] %m: fabDoneAvail Event", v__h77007);
    if (RST_N)
