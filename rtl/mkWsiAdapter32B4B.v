...
//
// On Wed Oct 30 15:56:18 EDT 2013
//
//
// Ports:
// Name                         I/O  size props
...
module mkWsiAdapter32B4B(CLK,
  ...
  // register isEmpty
  assign isEmpty_D_IN = wsiM_reqFifo_enqueueing_whas && pos == 3'd7 ;
  assign isEmpty_EN =
	     wsiM_reqFifo_enqueueing_whas ||
	     MUX_wsiS_reqFifo_levelsValid_write_1__SEL_3 ;

  // register isLast
  assign isLast_D_IN = wsiS_reqFifo_D_OUT[309] ;
  assign isLast_EN = MUX_wsiS_reqFifo_levelsValid_write_1__SEL_3 ;

  // register pos
  assign pos_D_IN = pos + 3'd1 ;
  assign pos_EN = wsiM_reqFifo_enqueueing_whas ;

  // register req32
  assign req32_D_IN = wsiS_reqFifo_D_OUT ;
  assign req32_EN = MUX_wsiS_reqFifo_levelsValid_write_1__SEL_3 ;
  ...
  begin
    ...
    if (req32_EN) req32 <= `BSV_ASSIGNMENT_DELAY req32_D_IN;
    if (wsiM_statusR_EN)
