...
//
// On Sun Sep 15 08:30:34 EDT 2013
//
//
// Ports:
// Name                         I/O  size props
...
module mkWsiAdapter32B4B(CLK,
  ...
  wire MUX_wsiM_reqFifo_q_0$write_1__SEL_1,
  ...
  // register isEmpty
  assign isEmpty$D_IN = wsiM_reqFifo_enqueueing$whas && pos == 3'd7 ;
  assign isEmpty$EN =
	     wsiM_reqFifo_enqueueing$whas ||
	     MUX_wsiS_reqFifo_levelsValid$write_1__SEL_3 ;
  ...
  assign req32$EN = MUX_wsiS_reqFifo_levelsValid$write_1__SEL_3 ;
  ...
  assign x_burstLength__h5955 = { req32[304:296], 3'd0 } ;
  always@(pos or req32)
  begin
    case (pos)
      3'd0: x_data__h5956 = req32[71:40];
      3'd1: x_data__h5956 = req32[103:72];
      3'd2: x_data__h5956 = req32[135:104];
      3'd3: x_data__h5956 = req32[167:136];
      3'd4: x_data__h5956 = req32[199:168];
      3'd5: x_data__h5956 = req32[231:200];
      3'd6: x_data__h5956 = req32[263:232];
      3'd7: x_data__h5956 = req32[295:264];
    endcase
  end
  always@(pos or req32)
  begin
    case (pos)
      3'd0: x_byteEn__h5957 = req32[11:8];
      3'd1: x_byteEn__h5957 = req32[15:12];
      3'd2: x_byteEn__h5957 = req32[19:16];
      3'd3: x_byteEn__h5957 = req32[23:20];
      3'd4: x_byteEn__h5957 = req32[27:24];
      3'd5: x_byteEn__h5957 = req32[31:28];
      3'd6: x_byteEn__h5957 = req32[35:32];
      3'd7: x_byteEn__h5957 = req32[39:36];
    endcase
  end
