...
//
// On Fri Oct 22 08:41:46 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter16B(wciS0_Clk,
  ...
  wire [15 : 0] wsiBurstLength__h19518,
		x1_byteEn__h19592,
		x__h16159,
		x_length__h17891;
  ...
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_3 =
	     { 4'd3, wsiS_reqFifo$D_OUT[165], 1'b0, addr__h17461, 12'd1 } ;
  ...
  assign addr__h17461 = { mesgLengthSoFar[9:0], 4'd0 } ;
  ...
  assign bl__h18513 =
	     zeroLengthMesg ?
	       12'd1 :
	       { 2'd0,
		 IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d791[13:4] } ;
  ...
  assign mlp1B__h17445 = { mlp1__h17444[9:0], 4'd0 } ;
