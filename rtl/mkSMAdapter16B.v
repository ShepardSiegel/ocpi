...
//
// On Tue Nov  5 11:22:14 EST 2013
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter16B(wciS0_Clk,
  ...
  assign MUX_thisMesg$write_1__VAL_1 =
	     { mesgCount[7:0], mesgMetaF_opcode__h22372, x_length__h23264 } ;
  ...
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_2 = { 2'd1, g_data__h24240 } ;
  ...
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_2 =
	     { 4'd3, wsiS_reqFifo$D_OUT[165], 1'b0, mesgLengthSoFar, 12'd1 } ;
  ...
  assign mlInc__h22205 =
	     wsiS_reqFifo$D_OUT[165] ?
	       { 9'd0, x__h22411 + y__h22412 } :
	       14'd16 ;
  assign rdat__h24283 = hasDebugLogic ? mesgCount : 32'd0 ;
  assign rdat__h24289 = hasDebugLogic ? abortCount : 32'd0 ;
  assign rdat__h24295 = hasDebugLogic ? thisMesg : 32'd0 ;
  assign rdat__h24308 = hasDebugLogic ? lastMesg : 32'd0 ;
  assign rdat__h24331 = hasDebugLogic ? { 16'd0, x__h24335 } : 32'd0 ;
  assign rdat__h24431 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h24445 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h24453 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h24459 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h24473 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h24481 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h24487 = hasDebugLogic ? wmwtBeginCount : 32'd0 ;
  assign rdat__h24493 = hasDebugLogic ? wmwtPushCount : 32'd0 ;
  assign rdat__h24499 = hasDebugLogic ? wmwtFinalCount : 32'd0 ;
  assign rdat__h24505 = hasDebugLogic ? { 31'd0, x__h24509 } : 32'd0 ;
  assign rdat__h24515 = hasDebugLogic ? 32'hFEEDC0DE : 32'd0 ;
  ...
  assign wsiS_reqFifo_i_notEmpty__61_AND_NOT_smaCtrl_62_ETC___d667 =
	     ...
	     (!wsiS_reqFifo$D_OUT[165] || wmi_mFlagF_cntr_r != 2'd2) ;
  ...
  assign x__h22579 = { 4'd0, wsiS_reqFifo$D_OUT[23] } ;
  assign x__h24335 = { wsiS_statusR, wsiM_statusR } ;
  assign x__h24509 = wmi_sThreadBusy_d || wmi_sDataThreadBusy_d ;
  assign x_length__h23264 = { 2'd0, mlB__h22206 } ;
  assign y__h22412 = { 4'd0, wsiS_reqFifo$D_OUT[8] } ;
  assign y__h22424 = { 4'd0, wsiS_reqFifo$D_OUT[9] } ;
  assign y__h22436 = { 4'd0, wsiS_reqFifo$D_OUT[10] } ;
  assign y__h22448 = { 4'd0, wsiS_reqFifo$D_OUT[11] } ;
  assign y__h22460 = { 4'd0, wsiS_reqFifo$D_OUT[12] } ;
  assign y__h22472 = { 4'd0, wsiS_reqFifo$D_OUT[13] } ;
  assign y__h22484 = { 4'd0, wsiS_reqFifo$D_OUT[14] } ;
  assign y__h22496 = { 4'd0, wsiS_reqFifo$D_OUT[15] } ;
  assign y__h22508 = { 4'd0, wsiS_reqFifo$D_OUT[16] } ;
  assign y__h22520 = { 4'd0, wsiS_reqFifo$D_OUT[17] } ;
  assign y__h22532 = { 4'd0, wsiS_reqFifo$D_OUT[18] } ;
  assign y__h22544 = { 4'd0, wsiS_reqFifo$D_OUT[19] } ;
  assign y__h22556 = { 4'd0, wsiS_reqFifo$D_OUT[20] } ;
  assign y__h22568 = { 4'd0, wsiS_reqFifo$D_OUT[21] } ;
  assign y__h22580 = { 4'd0, wsiS_reqFifo$D_OUT[22] } ;
  always@(wci_wslv_reqF$D_OUT or
	  ...
	  rdat__h24481 or
	  rdat__h24487 or
	  rdat__h24493 or rdat__h24499 or rdat__h24505 or rdat__h24515)
  begin
    case (wci_wslv_reqF$D_OUT[39:32])
      8'h0: g_data__h24240 = smaCtrl;
      8'h04: g_data__h24240 = rdat__h24283;
      8'h08: g_data__h24240 = rdat__h24289;
      8'h10: g_data__h24240 = rdat__h24295;
      8'h14: g_data__h24240 = rdat__h24308;
      8'h18: g_data__h24240 = rdat__h24331;
      8'h20: g_data__h24240 = rdat__h24431;
      8'h24: g_data__h24240 = rdat__h24445;
      8'h28: g_data__h24240 = rdat__h24453;
      8'h2C: g_data__h24240 = rdat__h24459;
      8'h30: g_data__h24240 = rdat__h24473;
      8'h34: g_data__h24240 = rdat__h24481;
      8'h38: g_data__h24240 = rdat__h24487;
      8'h3C: g_data__h24240 = rdat__h24493;
      8'h40: g_data__h24240 = rdat__h24499;
      8'h44: g_data__h24240 = rdat__h24505;
      8'h48: g_data__h24240 = rdat__h24515;
      default: g_data__h24240 = 32'd0;
    endcase
  end
  ...
  begin
    ...
    if (wciS0_MReset_n != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_wmwt_doAbort)
	$display("[%0d]: %m: wmwt_doAbort", v__h23689);
    if (wciS0_MReset_n != `BSV_RESET_VALUE)
