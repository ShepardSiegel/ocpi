...
//
// On Sun Apr  3 10:10:44 EDT 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter16B(wciS0_Clk,
  ...
  wire [163 : 0] IF_respF_wDataIn_whas__45_THEN_respF_wDataIn_w_ETC___d848;
  ...
  wire [15 : 0] sendData_byteEn__h19051,
		wsiBurstLength__h18967,
		x__h22789,
		x_length__h20219;
  ...
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_3 =
	     { 4'd3, wsiS_reqFifo$D_OUT[165], 1'b0, addr__h21095, 12'd1 } ;
  ...
  assign addr__h21095 = { mesgLengthSoFar[9:0], 4'd0 } ;
  assign b__h15200 = -fabWordsCurReq[11:0] ;
  assign b__h18589 = { {2{fabRespCredit_value[11]}}, fabRespCredit_value } ;
  assign bl__h20326 = zeroLengthMesg ? 12'd1 : { 2'd0, x__h20237[13:4] } ;
  ...
  assign mesgMetaF_length__h21225 =
	     (wsiS_reqFifo$D_OUT[165] && wsiS_reqFifo$D_OUT[23:8] == 16'd0 &&
	      mesgLengthSoFar == 14'd0) ?
	       24'd0 :
	       { 10'd0, mlp1B__h21055 } ;
  assign mlp1B__h21055 = { mlp1__h21054[9:0], 4'd0 } ;
  ...
  assign sendData_byteEn__h19051 =
