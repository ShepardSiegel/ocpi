...
//
// On Tue Feb 28 06:54:13 EST 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter16B(wciS0_Clk,
  ...
  wire [145 : 0] MUX_wmi_dhF_q_0$write_1__VAL_2,
  ...
  reg [63 : 0] v__h18191,
	       ...
	       v__h3825,
	       v__h3969;
  reg [31 : 0] g_data__h25042;
  wire [163 : 0] IF_respF_wDataIn_whas__33_THEN_respF_wDataIn_w_ETC___d914;
  wire [31 : 0] rdat__h25085,
		rdat__h25091,
		rdat__h25097,
		rdat__h25110,
		rdat__h25133,
  ...
  wire [15 : 0] sendData_byteEn__h18734,
		...
		x__h25137,
		x_length__h24073;
  wire [13 : 0] b__h18275, mlB__h23014, mlInc__h23013;
  wire [11 : 0] b__h15090, sendData_burstLength__h18732, x__h16444;
  wire [7 : 0] mesgMetaF_opcode__h23180;
  wire [4 : 0] x__h23220,
	       x__h23232,
	       x__h23244,
	       x__h23256,
	       ...
	       y__h23377,
	       y__h23389;
  wire [2 : 0] IF_respF_wDataIn_whas__33_THEN_respF_wDataIn_w_ETC___d921;
  ...
  assign MUX_thisMesg$write_1__VAL_1 =
	     { mesgCount[7:0], mesgMetaF_opcode__h23180, x_length__h24073 } ;
  ...
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_2 = { 2'd1, g_data__h25042 } ;
  ...
  assign MUX_wmi_dhF_q_1$write_1__VAL_2 =
	     (wmi_dhF_c_r == 2'd2) ? MUX_wmi_dhF_q_1$write_1__VAL_1 : 146'd0 ;
  ...
  assign MUX_wmi_mFlagF_x_wire$wset_1__VAL_2 =
	     { mesgMetaF_opcode__h23180, mesgMetaF_length__h23181 } ;
  ...
  assign wmi_dhF_x_wire$wget = MUX_wmi_dhF_q_1$write_1__VAL_1 ;
  ...
  assign respF_rCache$D_IN =
	     { 1'd1,
	       ...
	       IF_respF_wDataIn_whas__33_THEN_respF_wDataIn_w_ETC___d914 } ;
  ...
  begin
    case (1'b1) // synopsys parallel_case
      MUX_wmi_dhF_q_0$write_1__SEL_1:
	  wmi_dhF_q_0$D_IN = MUX_wmi_dhF_q_1$write_1__VAL_1;
      WILL_FIRE_RL_wmi_dhF_both:
  ...
  // remaining internal signals
  assign IF_respF_wDataIn_whas__33_THEN_respF_wDataIn_w_ETC___d914 =
  ...
  assign mesgMetaF_length__h23181 =
	     (wsiS_reqFifo$D_OUT[165] && wsiS_reqFifo$D_OUT[23:8] == 16'd0 &&
	      mesgLengthSoFar == 14'd0) ?
	       24'd0 :
	       { 10'd0, mlB__h23014 } ;
  assign mesgMetaF_opcode__h23180 = opcode[8] ? opcode[7:0] : 8'd0 ;
  assign mlB__h23014 = mesgLengthSoFar + mlInc__h23013 ;
  assign mlInc__h23013 =
	     wsiS_reqFifo$D_OUT[165] ?
	       { 9'd0, x__h23220 + y__h23221 } :
	       14'd16 ;
  assign rdat__h25085 = hasDebugLogic ? mesgCount : 32'd0 ;
  assign rdat__h25091 = hasDebugLogic ? abortCount : 32'd0 ;
  assign rdat__h25097 = hasDebugLogic ? thisMesg : 32'd0 ;
  assign rdat__h25110 = hasDebugLogic ? lastMesg : 32'd0 ;
  assign rdat__h25133 = hasDebugLogic ? { 16'd0, x__h25137 } : 32'd0 ;
  assign rdat__h25233 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h25247 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h25255 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h25261 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h25275 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h25283 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h25289 = hasDebugLogic ? wmwtBeginCount : 32'd0 ;
  assign rdat__h25295 = hasDebugLogic ? wmwtPushCount : 32'd0 ;
  assign rdat__h25301 = hasDebugLogic ? wmwtFinalCount : 32'd0 ;
  assign rdat__h25307 = hasDebugLogic ? 32'hFEEDC0DE : 32'd0 ;
													...
													6'd30) ?
													 ...
													 (({ 2'd0,
													   ...
													   6'd31) ?
													    32'h7FFFFFFF :
													    32'hFFFFFFFF))))))))))))))))))))))))))))))) ;
  assign x__h23220 = x__h23232 + y__h23233 ;
  assign x__h23232 = x__h23244 + y__h23245 ;
  assign x__h23244 = x__h23256 + y__h23257 ;
  assign x__h23256 = x__h23268 + y__h23269 ;
  assign x__h23268 = x__h23280 + y__h23281 ;
  assign x__h23280 = x__h23292 + y__h23293 ;
  assign x__h23292 = x__h23304 + y__h23305 ;
  assign x__h23304 = x__h23316 + y__h23317 ;
  assign x__h23316 = x__h23328 + y__h23329 ;
  assign x__h23328 = x__h23340 + y__h23341 ;
  assign x__h23340 = x__h23352 + y__h23353 ;
  assign x__h23352 = x__h23364 + y__h23365 ;
  assign x__h23364 = x__h23376 + y__h23377 ;
  assign x__h23376 = x__h23388 + y__h23389 ;
  assign x__h23388 = { 4'd0, wsiS_reqFifo$D_OUT[23] } ;
  assign x__h25137 = { wsiS_statusR, wsiM_statusR } ;
  assign x_length__h24073 = { 2'd0, mlB__h23014 } ;
  assign y__h23221 = { 4'd0, wsiS_reqFifo$D_OUT[8] } ;
  assign y__h23233 = { 4'd0, wsiS_reqFifo$D_OUT[9] } ;
  assign y__h23245 = { 4'd0, wsiS_reqFifo$D_OUT[10] } ;
  assign y__h23257 = { 4'd0, wsiS_reqFifo$D_OUT[11] } ;
  assign y__h23269 = { 4'd0, wsiS_reqFifo$D_OUT[12] } ;
  assign y__h23281 = { 4'd0, wsiS_reqFifo$D_OUT[13] } ;
  assign y__h23293 = { 4'd0, wsiS_reqFifo$D_OUT[14] } ;
  assign y__h23305 = { 4'd0, wsiS_reqFifo$D_OUT[15] } ;
  assign y__h23317 = { 4'd0, wsiS_reqFifo$D_OUT[16] } ;
  assign y__h23329 = { 4'd0, wsiS_reqFifo$D_OUT[17] } ;
  assign y__h23341 = { 4'd0, wsiS_reqFifo$D_OUT[18] } ;
  assign y__h23353 = { 4'd0, wsiS_reqFifo$D_OUT[19] } ;
  assign y__h23365 = { 4'd0, wsiS_reqFifo$D_OUT[20] } ;
  assign y__h23377 = { 4'd0, wsiS_reqFifo$D_OUT[21] } ;
  assign y__h23389 = { 4'd0, wsiS_reqFifo$D_OUT[22] } ;
  always@(wci_wslv_reqF$D_OUT or
	  ...
	  rdat__h25275 or
	  rdat__h25283 or
	  rdat__h25289 or rdat__h25295 or rdat__h25301 or rdat__h25307)
  begin
    case (wci_wslv_reqF$D_OUT[39:32])
      8'h0: g_data__h25042 = smaCtrl;
      8'h04: g_data__h25042 = rdat__h25085;
      8'h08: g_data__h25042 = rdat__h25091;
      8'h10: g_data__h25042 = rdat__h25097;
      8'h14: g_data__h25042 = rdat__h25110;
      8'h18: g_data__h25042 = rdat__h25133;
      8'h20: g_data__h25042 = rdat__h25233;
      8'h24: g_data__h25042 = rdat__h25247;
      8'h28: g_data__h25042 = rdat__h25255;
      8'h2C: g_data__h25042 = rdat__h25261;
      8'h30: g_data__h25042 = rdat__h25275;
      8'h34: g_data__h25042 = rdat__h25283;
      8'h38: g_data__h25042 = rdat__h25289;
      8'h3C: g_data__h25042 = rdat__h25295;
      8'h40: g_data__h25042 = rdat__h25301;
      8'h44: g_data__h25042 = rdat__h25307;
      default: g_data__h25042 = 32'd0;
    endcase
  end
  ...
  begin
    ...
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wmwt_doAbort)
	$display("[%0d]: %m: wmwt_doAbort", v__h24493);
    if (wciS0_MReset_n)
