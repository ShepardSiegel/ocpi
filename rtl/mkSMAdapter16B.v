...
//
// On Sat Oct 30 09:41:31 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter16B(wciS0_Clk,
  ...
  wire [163 : 0] IF_respF_wDataIn_whas__78_THEN_respF_wDataIn_w_ETC___d908;
  ...
  wire [15 : 0] sendData_byteEn__h20738,
		wsiBurstLength__h20632,
		x__h17272,
		x_length__h19012;
  ...
  wire [11 : 0] b__h14530,
		...
		x__h15812;
  wire [7 : 0] mesgMetaF_opcode__h18734;
  wire [2 : 0] IF_respF_wDataIn_whas__78_THEN_respF_wDataIn_w_ETC___d911;
  ...
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_3 =
	     { 4'd3, wsiS_reqFifo$D_OUT[165], 1'b0, addr__h18582, 12'd1 } ;
  ...
  assign respF_rCache$D_IN =
	     { 1'd1,
	       respF_rWrPtr,
	       IF_respF_wDataIn_whas__78_THEN_respF_wDataIn_w_ETC___d911,
  ...
  assign IF_respF_wDataIn_whas__78_THEN_respF_wDataIn_w_ETC___d911 =
  ...
  assign addr__h18582 = { mesgLengthSoFar[9:0], 4'd0 } ;
  ...
  assign bl__h19634 =
	     zeroLengthMesg ?
	       12'd1 :
	       { 2'd0,
		 IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d817[13:4] } ;
  ...
  assign mlp1B__h18566 = { mlp1__h18565[9:0], 4'd0 } ;
  ...
  assign sendData_byteEn__h20738 =
