...
//
// On Thu Jun 23 18:09:26 EDT 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter16B(wciS0_Clk,
  ...
  reg [63 : 0] v__h18213,
	       ...
	       v__h3825,
	       v__h3969;
  reg [31 : 0] g_data__h25064;
  wire [163 : 0] IF_respF_wDataIn_whas__43_THEN_respF_wDataIn_w_ETC___d921;
  wire [31 : 0] rdat__h25107,
		rdat__h25113,
		rdat__h25119,
		rdat__h25132,
		rdat__h25155,
  ...
  wire [15 : 0] sendData_byteEn__h18756,
		...
		x__h25159,
		x_length__h24095;
  wire [13 : 0] b__h18297, mlB__h23036, mlInc__h23035;
  wire [11 : 0] b__h15112, sendData_burstLength__h18754, x__h16466;
  wire [7 : 0] mesgMetaF_opcode__h23202;
  wire [4 : 0] x__h23242,
	       x__h23254,
	       x__h23266,
	       x__h23278,
	       ...
	       y__h23399,
	       y__h23411;
  wire [2 : 0] IF_respF_wDataIn_whas__43_THEN_respF_wDataIn_w_ETC___d929;
  ...
  assign MUX_thisMesg$write_1__VAL_1 =
	     { mesgCount[7:0], mesgMetaF_opcode__h23202, x_length__h24095 } ;
  ...
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_2 = { 2'd1, g_data__h25064 } ;
  ...
  assign MUX_wmi_mFlagF_x_wire$wset_1__VAL_2 =
	     { mesgMetaF_opcode__h23202, mesgMetaF_length__h23203 } ;
  ...
  assign respF_rCache$D_IN =
	     { 1'd1,
	       respF_rWrPtr,
	       IF_respF_wDataIn_whas__43_THEN_respF_wDataIn_w_ETC___d929,
	       respF_pwEnqueue$whas && respF_wDataIn$wget[165],
	       respF_pwEnqueue$whas && respF_wDataIn$wget[164],
	       IF_respF_wDataIn_whas__43_THEN_respF_wDataIn_w_ETC___d921 } ;
  ...
  // remaining internal signals
  assign IF_respF_wDataIn_whas__43_THEN_respF_wDataIn_w_ETC___d921 =
	     respF_pwEnqueue$whas ? respF_wDataIn$wget[163:0] : 164'd0 ;
  assign IF_respF_wDataIn_whas__43_THEN_respF_wDataIn_w_ETC___d929 =
  ...
  assign mesgMetaF_length__h23203 =
	     (wsiS_reqFifo$D_OUT[165] && wsiS_reqFifo$D_OUT[23:8] == 16'd0 &&
	      mesgLengthSoFar == 14'd0) ?
	       24'd0 :
	       { 10'd0, mlB__h23036 } ;
  assign mesgMetaF_opcode__h23202 = opcode[8] ? opcode[7:0] : 8'd0 ;
  assign mlB__h23036 = mesgLengthSoFar + mlInc__h23035 ;
  assign mlInc__h23035 =
	     wsiS_reqFifo$D_OUT[165] ?
	       { 9'd0, x__h23242 + y__h23243 } :
	       14'd16 ;
  assign rdat__h25107 = hasDebugLogic ? mesgCount : 32'd0 ;
  assign rdat__h25113 = hasDebugLogic ? abortCount : 32'd0 ;
  assign rdat__h25119 = hasDebugLogic ? thisMesg : 32'd0 ;
  assign rdat__h25132 = hasDebugLogic ? lastMesg : 32'd0 ;
  assign rdat__h25155 = hasDebugLogic ? { 16'd0, x__h25159 } : 32'd0 ;
  assign rdat__h25255 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h25269 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h25277 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h25283 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h25297 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h25305 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h25311 = hasDebugLogic ? wmwtBeginCount : 32'd0 ;
  assign rdat__h25317 = hasDebugLogic ? wmwtPushCount : 32'd0 ;
  assign rdat__h25323 = hasDebugLogic ? wmwtFinalCount : 32'd0 ;
  assign rdat__h25329 = hasDebugLogic ? 32'hFEEDC0DE : 32'd0 ;
  ...
  assign x__h23398 = x__h23410 + y__h23411 ;
  assign x__h23410 = { 4'd0, wsiS_reqFifo$D_OUT[23] } ;
  assign x__h25159 = { wsiS_statusR, wsiM_statusR } ;
  assign x_length__h24095 = { 2'd0, mlB__h23036 } ;
  assign y__h23243 = { 4'd0, wsiS_reqFifo$D_OUT[8] } ;
  assign y__h23255 = { 4'd0, wsiS_reqFifo$D_OUT[9] } ;
  assign y__h23267 = { 4'd0, wsiS_reqFifo$D_OUT[10] } ;
  assign y__h23279 = { 4'd0, wsiS_reqFifo$D_OUT[11] } ;
  assign y__h23291 = { 4'd0, wsiS_reqFifo$D_OUT[12] } ;
  assign y__h23303 = { 4'd0, wsiS_reqFifo$D_OUT[13] } ;
  assign y__h23315 = { 4'd0, wsiS_reqFifo$D_OUT[14] } ;
  assign y__h23327 = { 4'd0, wsiS_reqFifo$D_OUT[15] } ;
  assign y__h23339 = { 4'd0, wsiS_reqFifo$D_OUT[16] } ;
  assign y__h23351 = { 4'd0, wsiS_reqFifo$D_OUT[17] } ;
  assign y__h23363 = { 4'd0, wsiS_reqFifo$D_OUT[18] } ;
  assign y__h23375 = { 4'd0, wsiS_reqFifo$D_OUT[19] } ;
  assign y__h23387 = { 4'd0, wsiS_reqFifo$D_OUT[20] } ;
  assign y__h23399 = { 4'd0, wsiS_reqFifo$D_OUT[21] } ;
  assign y__h23411 = { 4'd0, wsiS_reqFifo$D_OUT[22] } ;
  always@(wci_wslv_reqF$D_OUT or
	  ...
	  rdat__h25297 or
	  rdat__h25305 or
	  rdat__h25311 or rdat__h25317 or rdat__h25323 or rdat__h25329)
  begin
    case (wci_wslv_reqF$D_OUT[39:32])
      8'h0: g_data__h25064 = smaCtrl;
      8'h04: g_data__h25064 = rdat__h25107;
      8'h08: g_data__h25064 = rdat__h25113;
      8'h10: g_data__h25064 = rdat__h25119;
      8'h14: g_data__h25064 = rdat__h25132;
      8'h18: g_data__h25064 = rdat__h25155;
      8'h20: g_data__h25064 = rdat__h25255;
      8'h24: g_data__h25064 = rdat__h25269;
      8'h28: g_data__h25064 = rdat__h25277;
      8'h2C: g_data__h25064 = rdat__h25283;
      8'h30: g_data__h25064 = rdat__h25297;
      8'h34: g_data__h25064 = rdat__h25305;
      8'h38: g_data__h25064 = rdat__h25311;
      8'h3C: g_data__h25064 = rdat__h25317;
      8'h40: g_data__h25064 = rdat__h25323;
      8'h44: g_data__h25064 = rdat__h25329;
      default: g_data__h25064 = 32'd0;
    endcase
  end
  ...
  begin
    ...
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wmwt_doAbort)
	$display("[%0d]: %m: wmwt_doAbort", v__h24515);
    if (wciS0_MReset_n)
