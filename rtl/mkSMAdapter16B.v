...
//
// On Mon Aug 30 14:22:53 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter16B(wciS0_Clk,
  ...
  wire [15 : 0] wsiBurstLength__h19334,
		x__h16107,
		x_byteEn__h19432,
		x_length__h17839;
  ...
  wire [7 : 0] mesgMetaF_opcode__h17561;
  wire [3 : 0] b__h14495;
  ...
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_3 =
	     { 4'd3, wsiS_reqFifo$D_OUT[165], 1'b0, addr__h17409, 12'd1 } ;
  ...
  assign addr__h17409 = { mesgLengthSoFar[9:0], 4'd0 } ;
  ...
  assign bl__h18461 =
	     zeroLengthMesg ?
	       12'd1 :
	       { 2'd0,
		 IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d783[13:4] } ;
  ...
  assign mlp1B__h17393 = { mlp1__h17392[9:0], 4'd0 } ;
