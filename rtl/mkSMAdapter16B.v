...
//
// On Fri Jun 25 13:29:44 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter16B(wciS0_Clk,
  ...
  wire [15 : 0] wsiBurstLength__h18726,
		x__h15550,
		x_byteEn__h18824,
		x_length__h17251;
  wire [13 : 0] IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d753,
		addr__h16821,
		b__h19347,
		mlp1B__h16805,
		mlp1__h16804;
  ...
  wire NOT_wmi_dhF_c_r_61_EQ_2_62_63_AND_wmi_operateD_ETC___d222,
       NOT_wmi_reqF_c_r_58_EQ_2_59_60_AND_wmi_operate_ETC___d307,
  ...
  assign MUX_wmi_dhF_x_wire$wset_1__VAL_2 =
	     { 1'd1, x__h16889, wsiS_reqFifo$D_OUT[151:24], 16'd65535 } ;
  ...
  assign errCount$EN =
	     ...
	     (!x__h16889 || wsiS_reqFifo$D_OUT[23:8] != 16'd0) ;
  ...
  // remaining internal signals
  assign IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d753 =
  ...
  assign NOT_wmi_reqF_c_r_58_EQ_2_59_60_AND_wmi_operate_ETC___d307 =
  ...
  assign NOT_wsiS_reqFifo_countReg_70_ULE_1_71___d372 =
	     wsiS_reqFifo_countReg > 2'd1 ;
  assign addr__h16821 = { mesgLengthSoFar[9:0], 4'd0 } ;
  ...
  assign bl__h17853 =
	     zeroLengthMesg ?
	       12'd1 :
	       { 2'd0,
		 IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d753[13:4] } ;
  assign mesgMetaF_length__h16976 = { 10'd0, mlp1B__h16805 } ;
  assign mesgMetaF_length__h17997 =
	     { 10'd0,
	       IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d753 } ;
  assign mesgMetaF_opcode__h16975 = opcode[8] ? opcode[7:0] : 8'd0 ;
  assign mlp1B__h16805 = { mlp1__h16804[9:0], 4'd0 } ;
  ...
  assign x__h16889 = wsiS_reqFifo$D_OUT[163:152] == 12'd1 ;
