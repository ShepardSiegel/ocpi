...
//
// On Tue Jun 21 16:39:52 EDT 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter16B(wciS0_Clk,
  ...
  reg [63 : 0] v__h18508,
	       ...
	       v__h3827,
	       v__h3971;
  reg [31 : 0] g_data__h25937, value__h6629;
  wire [163 : 0] IF_respF_wDataIn_whas__45_THEN_respF_wDataIn_w_ETC___d927;
  wire [31 : 0] rdat__h25980,
		rdat__h25986,
		rdat__h25992,
		rdat__h26005,
		rdat__h26028,
		...
		rdat__h26202,
		x__h19111;
  wire [23 : 0] mesgMetaF_length__h23708, mesgMetaF_length__h24468;
  wire [15 : 0] sendData_byteEn__h19054,
		wsiBurstLength__h18970,
		x__h26032,
		x_length__h23462;
  wire [13 : 0] addr__h24338,
		b__h18592,
		mlp1B__h24298,
		mlp1__h24297,
		x__h23480;
  wire [11 : 0] b__h15203,
		...
		x__h16557;
  wire [7 : 0] x__h23466;
  wire [2 : 0] IF_respF_wDataIn_whas__45_THEN_respF_wDataIn_w_ETC___d919;
  ...
  assign MUX_mesgLength$write_1__VAL_3 = { 1'd1, mlp1B__h24298 } ;
  ...
  assign MUX_thisMesg$write_1__VAL_1 =
	     { mesgCount[7:0], x__h23466, x_length__h23462 } ;
  ...
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_2 = { 2'd1, g_data__h25937 } ;
  ...
  assign MUX_wmi_mFlagF_x_wire$wset_1__VAL_2 =
	     { x__h23466, mesgMetaF_length__h24468 } ;
  assign MUX_wmi_mFlagF_x_wire$wset_1__VAL_3 =
	     { x__h23466, mesgMetaF_length__h23708 } ;
  ...
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_2 = { 20'd229376, bl__h23569 } ;
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_3 =
	     { 4'd3, wsiS_reqFifo$D_OUT[165], 1'b0, addr__h24338, 12'd1 } ;
  ...
  assign mesgLengthSoFar$D_IN =
	     MUX_impreciseBurst$write_1__SEL_3 ? 14'd0 : mlp1__h24297 ;
  ...
  assign respF_rCache$D_IN =
	     { 1'd1,
	       respF_rWrPtr,
	       IF_respF_wDataIn_whas__45_THEN_respF_wDataIn_w_ETC___d919,
	       respF_pwEnqueue$whas && respF_wDataIn$wget[165],
	       respF_pwEnqueue$whas && respF_wDataIn$wget[164],
	       IF_respF_wDataIn_whas__45_THEN_respF_wDataIn_w_ETC___d927 } ;
  ...
  // remaining internal signals
  assign IF_respF_wDataIn_whas__45_THEN_respF_wDataIn_w_ETC___d919 =
	     respF_pwEnqueue$whas ? respF_wDataIn$wget[168:166] : 3'd0 ;
  assign IF_respF_wDataIn_whas__45_THEN_respF_wDataIn_w_ETC___d927 =
  ...
  assign addr__h24338 = { mesgLengthSoFar[9:0], 4'd0 } ;
  assign b__h15203 = -fabWordsCurReq[11:0] ;
  assign b__h18592 = { {2{fabRespCredit_value[11]}}, fabRespCredit_value } ;
  assign bl__h23569 = zeroLengthMesg ? 12'd1 : { 2'd0, x__h23480[13:4] } ;
  assign mesgMetaF_length__h23708 = { 10'd0, x__h23480 } ;
  assign mesgMetaF_length__h24468 =
	     (wsiS_reqFifo$D_OUT[165] && wsiS_reqFifo$D_OUT[23:8] == 16'd0 &&
	      mesgLengthSoFar == 14'd0) ?
	       24'd0 :
	       { 10'd0, mlp1B__h24298 } ;
  assign mlp1B__h24298 = { mlp1__h24297[9:0], 4'd0 } ;
  assign mlp1__h24297 = mesgLengthSoFar + 14'd1 ;
  assign rdat__h25980 = hasDebugLogic ? mesgCount : 32'd0 ;
  assign rdat__h25986 = hasDebugLogic ? abortCount : 32'd0 ;
  assign rdat__h25992 = hasDebugLogic ? thisMesg : 32'd0 ;
  assign rdat__h26005 = hasDebugLogic ? lastMesg : 32'd0 ;
  assign rdat__h26028 = hasDebugLogic ? { 16'd0, x__h26032 } : 32'd0 ;
  assign rdat__h26128 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h26142 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h26150 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h26156 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h26170 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h26178 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h26184 = hasDebugLogic ? wmwtBeginCount : 32'd0 ;
  assign rdat__h26190 = hasDebugLogic ? wmwtPImpCount : 32'd0 ;
  assign rdat__h26196 = hasDebugLogic ? wmwtFinalCount : 32'd0 ;
  assign rdat__h26202 = hasDebugLogic ? 32'hFEEDC0DE : 32'd0 ;
  ...
  assign sendData_byteEn__h19054 =
	     (thisMesg[15:0] == 16'd0) ?
	       thisMesg[15:0] :
	       ((unrollCnt == 16'd1) ? x__h19111[15:0] : 16'd65535) ;
													...
													6'd30) ?
													 ...
													 (({ 2'd0,
													   ...
													   6'd31) ?
													    32'h7FFFFFFF :
													    32'hFFFFFFFF))))))))))))))))))))))))))))))) ;
  assign x__h23466 = opcode[8] ? opcode[7:0] : 8'd0 ;
  assign x__h23480 = mesgLength[14] ? mesgLength[13:0] : 14'd0 ;
  assign x__h26032 = { wsiS_statusR, wsiM_statusR } ;
  assign x_length__h23462 = { 2'd0, x__h23480 } ;
  always@(wci_wslv_reqF$D_OUT or
	  ...
	  rdat__h26170 or
	  rdat__h26178 or
	  rdat__h26184 or rdat__h26190 or rdat__h26196 or rdat__h26202)
  begin
    case (wci_wslv_reqF$D_OUT[39:32])
      8'h0: g_data__h25937 = smaCtrl;
      8'h04: g_data__h25937 = rdat__h25980;
      8'h08: g_data__h25937 = rdat__h25986;
      8'h10: g_data__h25937 = rdat__h25992;
      8'h14: g_data__h25937 = rdat__h26005;
      8'h18: g_data__h25937 = rdat__h26028;
      8'h20: g_data__h25937 = rdat__h26128;
      8'h24: g_data__h25937 = rdat__h26142;
      8'h28: g_data__h25937 = rdat__h26150;
      8'h2C: g_data__h25937 = rdat__h26156;
      8'h30: g_data__h25937 = rdat__h26170;
      8'h34: g_data__h25937 = rdat__h26178;
      8'h38: g_data__h25937 = rdat__h26184;
      8'h3C: g_data__h25937 = rdat__h26190;
      8'h40: g_data__h25937 = rdat__h26196;
      8'h44: g_data__h25937 = rdat__h26202;
      default: g_data__h25937 = 32'd0;
    endcase
  end
  ...
  begin
    ...
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wmwt_doAbort)
	$display("[%0d]: %m: wmwt_doAbort", v__h25236);
    if (wciS0_MReset_n)
