...
//
// On Tue Jun  1 12:38:03 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter16B(wciS0_Clk,
  ...
  wire [23 : 0] mesgMetaF_length__h16810, mesgMetaF_length__h17726;
  wire [15 : 0] wsiBurstLength__h18458,
		x__h15543,
		x_byteEn__h18565,
		x_length__h17088;
  wire [13 : 0] IF_mesgLength_22_BIT_14_23_THEN_mesgLength_22__ETC___d754,
		...
		mlp1B__h16631,
		mlp1__h16630;
  wire [11 : 0] bl__h17582, x_burstLength__h18563;
  wire [7 : 0] mesgMetaF_opcode__h16809;
  wire [3 : 0] b__h13937;
  wire NOT_wmi_dhF_c_r_50_EQ_2_51_52_AND_wmi_operateD_ETC___d165,
       NOT_wmi_reqF_c_r_47_EQ_2_48_49_AND_wmi_operate_ETC___d292,
  ...
  assign CAN_FIRE_RL_wmwt_messagePushImprecise =
	     ...
	     NOT_wmi_dhF_c_r_50_EQ_2_51_52_AND_wmi_operateD_ETC___d165 &&
	     wci_cState == 3'd2 &&
  ...
  assign CAN_FIRE_RL_wmwt_messagePushPrecise =
	     wsiS_reqFifo$EMPTY_N && wmi_dhF_c_r != 2'd2 && wmi_operateD &&
	     wmi_peerIsReady &&
	     wci_cState == 3'd2 &&
	     (smaCtrl[3:0] == 4'h2 || smaCtrl[3:0] == 4'h3) &&
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_1 = { 2'd1, x_data__h15447 } ;
  ...
  assign MUX_wmi_dhF_x_wire$wset_1__VAL_2 =
	     { 1'd1, x__h16715, wsiS_reqFifo$D_OUT[151:24], 16'd0 } ;
  ...
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_2 =
	     { 4'd5, x__h18888, 1'b0, mesgReqAddr, fabWordsCurReq[11:0] } ;
  assign MUX_wsiM_reqFifo_x_wire$wset_1__VAL_1 =
	     { 3'd1,
	       unrollCnt == 16'd1,
	       !smaCtrl[5],
	       x_burstLength__h18563,
  ...
  assign MUX_wmi_mFlagF_x_wire$wset_1__SEL_2 =
	     WILL_FIRE_RL_wmrd_mesgBodyRequest && x__h18888 ;
  ...
  assign MUX_wmi_mFlagF_x_wire$wset_1__VAL_3 =
	     { mesgMetaF_opcode__h16809, mesgMetaF_length__h17726 } ;
  ...
  assign errCount$EN =
	     ...
	     (!x__h16715 || wsiS_reqFifo$D_OUT[23:8] != 16'd0) ;
  ...
  assign fabWordsCurReq$D_IN =
	     (fabWordsRemain <= b__h19088) ? fabWordsRemain : b__h19088 ;
  ...
  assign NOT_wmi_dhF_c_r_50_EQ_2_51_52_AND_wmi_operateD_ETC___d165 =
	     wmi_dhF_c_r != 2'd2 && wmi_operateD && wmi_peerIsReady &&
	     (!x__h16715 || wmi_mFlagF_c_r != 2'd2) ;
  assign NOT_wmi_reqF_c_r_47_EQ_2_48_49_AND_wmi_operate_ETC___d292 =
	     wmi_reqF_c_r != 2'd2 && wmi_operateD && wmi_peerIsReady &&
	     (!x__h18888 || wmi_mFlagF_c_r != 2'd2) ;
  assign NOT_wsiS_reqFifo_countReg_56_ULE_1_57___d358 =
	     wsiS_reqFifo_countReg > 2'd1 ;
  assign addr__h16647 = { mesgLengthSoFar[9:0], 4'd0 } ;
  assign b__h13937 = -fabWordsCurReq[3:0] ;
  assign b__h19088 = { {10{fabRespCredit_value[3]}}, fabRespCredit_value } ;
  assign bl__h17582 =
	     zeroLengthMesg ?
	       12'd1 :
	       { 2'd0,
