...
//
// On Fri Aug 13 08:38:15 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter16B(wciS0_Clk,
  ...
  wire [15 : 0] wsiBurstLength__h19332,
		x__h16105,
		x_byteEn__h19430,
		x_length__h17837;
  ...
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_3 =
	     { 4'd3, wsiS_reqFifo$D_OUT[165], 1'b0, addr__h17407, 12'd1 } ;
  ...
  assign addr__h17407 = { mesgLengthSoFar[9:0], 4'd0 } ;
  ...
  assign bl__h18459 =
	     zeroLengthMesg ?
	       12'd1 :
	       { 2'd0,
		 IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d774[13:4] } ;
  ...
  assign mlp1B__h17391 = { mlp1__h17390[9:0], 4'd0 } ;
