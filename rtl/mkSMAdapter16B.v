...
//
// On Wed Feb  9 09:56:58 EST 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter16B(wciS0_Clk,
  ...
  wire [163 : 0] IF_respF_wDataIn_whas__43_THEN_respF_wDataIn_w_ETC___d842;
  ...
  wire [15 : 0] sendData_byteEn__h18722,
		wsiBurstLength__h18638,
		x__h22393,
		x_length__h19856;
  ...
  wire [11 : 0] b__h14952,
		...
		x__h16306;
  wire [7 : 0] x__h19860;
  wire [2 : 0] IF_respF_wDataIn_whas__43_THEN_respF_wDataIn_w_ETC___d843;
  ...
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_3 =
	     { 4'd3, wsiS_reqFifo$D_OUT[165], 1'b0, addr__h20732, 12'd1 } ;
  ...
  assign addr__h20732 = { mesgLengthSoFar[9:0], 4'd0 } ;
  assign b__h14952 = -fabWordsCurReq[11:0] ;
  assign b__h18260 = { {2{fabRespCredit_value[11]}}, fabRespCredit_value } ;
  assign bl__h19963 = zeroLengthMesg ? 12'd1 : { 2'd0, x__h19874[13:4] } ;
  ...
  assign mesgMetaF_length__h20862 =
	     (wsiS_reqFifo$D_OUT[165] && wsiS_reqFifo$D_OUT[23:8] == 16'd0 &&
	      mesgLengthSoFar == 14'd0) ?
	       24'd0 :
	       { 10'd0, mlp1B__h20692 } ;
  assign mlp1B__h20692 = { mlp1__h20691[9:0], 4'd0 } ;
  ...
  assign sendData_byteEn__h18722 =
