...
//
// On Wed Feb  9 16:47:44 EST 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter16B(wciS0_Clk,
  ...
  wire [163 : 0] IF_respF_wDataIn_whas__43_THEN_respF_wDataIn_w_ETC___d847;
  ...
  wire [15 : 0] sendData_byteEn__h18801,
		wsiBurstLength__h18717,
		x__h22539,
		x_length__h19969;
  ...
  wire [11 : 0] b__h14952,
		...
		x__h16306;
  wire [7 : 0] x__h19973;
  wire [2 : 0] IF_respF_wDataIn_whas__43_THEN_respF_wDataIn_w_ETC___d857;
  ...
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_3 =
	     { 4'd3, wsiS_reqFifo$D_OUT[165], 1'b0, addr__h20845, 12'd1 } ;
  ...
  assign respF_rCache$D_IN =
	     { 1'd1,
	       ...
	       IF_respF_wDataIn_whas__43_THEN_respF_wDataIn_w_ETC___d847 } ;
  ...
  // remaining internal signals
  assign IF_respF_wDataIn_whas__43_THEN_respF_wDataIn_w_ETC___d847 =
  ...
  assign addr__h20845 = { mesgLengthSoFar[9:0], 4'd0 } ;
  assign b__h14952 = -fabWordsCurReq[11:0] ;
  assign b__h18339 = { {2{fabRespCredit_value[11]}}, fabRespCredit_value } ;
  assign bl__h20076 = zeroLengthMesg ? 12'd1 : { 2'd0, x__h19987[13:4] } ;
  ...
  assign mesgMetaF_length__h20975 =
	     (wsiS_reqFifo$D_OUT[165] && wsiS_reqFifo$D_OUT[23:8] == 16'd0 &&
	      mesgLengthSoFar == 14'd0) ?
	       24'd0 :
	       { 10'd0, mlp1B__h20805 } ;
  assign mlp1B__h20805 = { mlp1__h20804[9:0], 4'd0 } ;
  ...
  assign sendData_byteEn__h18801 =
