...
//
// On Mon Oct 25 17:56:53 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter16B(wciS0_Clk,
  ...
  wire [168 : 0] respF$D_IN, respF$D_OUT;
  ...
  wire [15 : 0] wsiBurstLength__h19566,
		x1_byteEn__h19640,
		x__h16199,
		x_length__h17939;
  ...
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_3 =
	     { 4'd3, wsiS_reqFifo$D_OUT[165], 1'b0, addr__h17509, 12'd1 } ;
  ...
  assign addr__h17509 = { mesgLengthSoFar[9:0], 4'd0 } ;
  ...
  assign bl__h18561 =
	     zeroLengthMesg ?
	       12'd1 :
	       { 2'd0,
		 IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d784[13:4] } ;
  ...
  assign mlp1B__h17493 = { mlp1__h17492[9:0], 4'd0 } ;
