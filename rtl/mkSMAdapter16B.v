...
//
// On Mon Jul 12 14:05:01 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter16B(wciS0_Clk,
  ...
  wire [15 : 0] wsiBurstLength__h19147,
		x__h15920,
		x_byteEn__h19245,
		x_length__h17652;
  ...
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_3 =
	     { 4'd3, wsiS_reqFifo$D_OUT[165], 1'b0, addr__h17222, 12'd1 } ;
  ...
  assign addr__h17222 = { mesgLengthSoFar[9:0], 4'd0 } ;
  ...
  assign mlp1B__h17206 = { mlp1__h17205[9:0], 4'd0 } ;
