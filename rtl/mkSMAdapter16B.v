...
//
// On Mon Jun 21 11:40:57 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter16B(wciS0_Clk,
  ...
  wire [23 : 0] mesgMetaF_length__h16963, mesgMetaF_length__h17984;
  wire [15 : 0] wsiBurstLength__h18713,
		x__h15544,
		x_byteEn__h18811,
		x_length__h17238;
  wire [13 : 0] IF_mesgLength_22_BIT_14_23_THEN_mesgLength_22__ETC___d759,
		addr__h16808,
		b__h19334,
		mlp1B__h16792,
		mlp1__h16791;
  wire [11 : 0] bl__h17840, x_burstLength__h18809;
  wire [7 : 0] mesgMetaF_opcode__h16962;
  wire [3 : 0] b__h13937;
  wire NOT_wmi_reqF_c_r_46_EQ_2_47_48_AND_wmi_operate_ETC___d296,
       NOT_wsiS_reqFifo_countReg_59_ULE_1_60___d361,
  ...
  assign CAN_FIRE_RL_wmrd_mesgBodyRequest =
	     NOT_wmi_reqF_c_r_46_EQ_2_47_48_AND_wmi_operate_ETC___d296 &&
	     wci_cState == 3'd2 &&
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_1 = { 2'd1, x_data__h15448 } ;
  ...
  assign MUX_wmi_dhF_x_wire$wset_1__VAL_2 =
	     { 1'd1, x__h16876, wsiS_reqFifo$D_OUT[151:24], 16'd65535 } ;
  ...
  assign MUX_wmi_mFlagF_x_wire$wset_1__VAL_3 =
	     { mesgMetaF_opcode__h16962, mesgMetaF_length__h17984 } ;
  ...
  assign errCount$EN =
	     ...
	     (!x__h16876 || wsiS_reqFifo$D_OUT[23:8] != 16'd0) ;
  ...
  // remaining internal signals
  assign IF_mesgLength_22_BIT_14_23_THEN_mesgLength_22__ETC___d759 =
	     mesgLength[14] ? mesgLength[13:0] : 14'd0 ;
  assign NOT_wmi_reqF_c_r_46_EQ_2_47_48_AND_wmi_operate_ETC___d296 =
	     wmi_reqF_c_r != 2'd2 && wmi_operateD && wmi_peerIsReady &&
	     (!x__h19134 || wmi_mFlagF_c_r != 2'd2) ;
  assign NOT_wsiS_reqFifo_countReg_59_ULE_1_60___d361 =
	     wsiS_reqFifo_countReg > 2'd1 ;
  assign addr__h16808 = { mesgLengthSoFar[9:0], 4'd0 } ;
  ...
  assign bl__h17840 =
	     zeroLengthMesg ?
	       12'd1 :
	       { 2'd0,
		 IF_mesgLength_22_BIT_14_23_THEN_mesgLength_22__ETC___d759[13:4] } ;
  assign mesgMetaF_length__h16963 = { 10'd0, mlp1B__h16792 } ;
  assign mesgMetaF_length__h17984 =
	     { 10'd0,
	       IF_mesgLength_22_BIT_14_23_THEN_mesgLength_22__ETC___d759 } ;
  assign mesgMetaF_opcode__h16962 = opcode[8] ? opcode[7:0] : 8'd0 ;
  assign mlp1B__h16792 = { mlp1__h16791[9:0], 4'd0 } ;
  ...
  assign x__h16876 = wsiS_reqFifo$D_OUT[163:152] == 12'd1 ;
