...
//
// On Sat Jun 25 08:29:25 EDT 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter16B(wciS0_Clk,
  ...
  reg [63 : 0] v__h18213,
	       ...
	       v__h3825,
	       v__h3969;
  reg [31 : 0] g_data__h24367;
  wire [163 : 0] IF_respF_wDataIn_whas__43_THEN_respF_wDataIn_w_ETC___d999;
  wire [31 : 0] rdat__h24410,
		rdat__h24416,
		rdat__h24422,
		rdat__h24435,
		rdat__h24458,
  ...
  wire [23 : 0] b__h17924,
		...
		residue__h17787,
		x__h18044;
  wire [15 : 0] sendData_byteEn__h18756,
		wsiBurstLength__h18672,
		x__h24462,
		x_length__h23398;
  ...
  wire [4 : 0] x__h22545,
	       ...
	       y__h22702,
	       y__h22714;
  wire [2 : 0] IF_respF_wDataIn_whas__43_THEN_respF_wDataIn_w_ETC___d996;
  ...
  assign MUX_thisMesg$write_1__VAL_1 =
	     { mesgCount[7:0], mesgMetaF_opcode__h22505, x_length__h23398 } ;
  ...
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_2 = { 2'd1, g_data__h24367 } ;
  ...
  assign respF_rCache$D_IN =
	     { 1'd1,
	       respF_rWrPtr,
	       IF_respF_wDataIn_whas__43_THEN_respF_wDataIn_w_ETC___d996,
	       respF_pwEnqueue$whas && respF_wDataIn$wget[165],
	       respF_pwEnqueue$whas && respF_wDataIn$wget[164],
	       IF_respF_wDataIn_whas__43_THEN_respF_wDataIn_w_ETC___d999 } ;
  ...
  // remaining internal signals
  assign IF_respF_wDataIn_whas__43_THEN_respF_wDataIn_w_ETC___d996 =
	     respF_pwEnqueue$whas ? respF_wDataIn$wget[168:166] : 3'd0 ;
  assign IF_respF_wDataIn_whas__43_THEN_respF_wDataIn_w_ETC___d999 =
  ...
  assign mlInc__h22338 =
	     wsiS_reqFifo$D_OUT[165] ?
	       { 9'd0, x__h22545 + y__h22546 } :
	       14'd16 ;
  assign rdat__h24410 = hasDebugLogic ? mesgCount : 32'd0 ;
  assign rdat__h24416 = hasDebugLogic ? abortCount : 32'd0 ;
  assign rdat__h24422 = hasDebugLogic ? thisMesg : 32'd0 ;
  assign rdat__h24435 = hasDebugLogic ? lastMesg : 32'd0 ;
  assign rdat__h24458 = hasDebugLogic ? { 16'd0, x__h24462 } : 32'd0 ;
  assign rdat__h24558 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h24572 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h24580 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h24586 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h24600 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h24608 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h24614 = hasDebugLogic ? wmwtBeginCount : 32'd0 ;
  assign rdat__h24620 = hasDebugLogic ? wmwtPushCount : 32'd0 ;
  assign rdat__h24626 = hasDebugLogic ? wmwtFinalCount : 32'd0 ;
  assign rdat__h24632 = hasDebugLogic ? 32'hFEEDC0DE : 32'd0 ;
  ...
  assign sendData_byteEn__h18756 =
	     (thisMesg[15:0] == 16'd0) ?
	       thisMesg[15:0] :
	       ((unrollCnt == 16'd1) ? x__h18813[15:0] : 16'd65535) ;
  assign value__h6580 =
	     MUX_wmi_mFlagF_x_wire$wset_1__SEL_1 ?
  ...
  assign x__h18044 = { 4'd0, wmi_sFlagReg[23:4] } ;
  ...
  assign x__h22713 = { 4'd0, wsiS_reqFifo$D_OUT[23] } ;
  assign x__h24462 = { wsiS_statusR, wsiM_statusR } ;
  assign x_length__h23398 = { 2'd0, mlB__h22339 } ;
  assign y__h22546 = { 4'd0, wsiS_reqFifo$D_OUT[8] } ;
  assign y__h22558 = { 4'd0, wsiS_reqFifo$D_OUT[9] } ;
  assign y__h22570 = { 4'd0, wsiS_reqFifo$D_OUT[10] } ;
  assign y__h22582 = { 4'd0, wsiS_reqFifo$D_OUT[11] } ;
  assign y__h22594 = { 4'd0, wsiS_reqFifo$D_OUT[12] } ;
  assign y__h22606 = { 4'd0, wsiS_reqFifo$D_OUT[13] } ;
  assign y__h22618 = { 4'd0, wsiS_reqFifo$D_OUT[14] } ;
  assign y__h22630 = { 4'd0, wsiS_reqFifo$D_OUT[15] } ;
  assign y__h22642 = { 4'd0, wsiS_reqFifo$D_OUT[16] } ;
  assign y__h22654 = { 4'd0, wsiS_reqFifo$D_OUT[17] } ;
  assign y__h22666 = { 4'd0, wsiS_reqFifo$D_OUT[18] } ;
  assign y__h22678 = { 4'd0, wsiS_reqFifo$D_OUT[19] } ;
  assign y__h22690 = { 4'd0, wsiS_reqFifo$D_OUT[20] } ;
  assign y__h22702 = { 4'd0, wsiS_reqFifo$D_OUT[21] } ;
  assign y__h22714 = { 4'd0, wsiS_reqFifo$D_OUT[22] } ;
  always@(wci_wslv_reqF$D_OUT or
	  ...
	  rdat__h24600 or
	  rdat__h24608 or
	  rdat__h24614 or rdat__h24620 or rdat__h24626 or rdat__h24632)
  begin
    case (wci_wslv_reqF$D_OUT[39:32])
      8'h0: g_data__h24367 = smaCtrl;
      8'h04: g_data__h24367 = rdat__h24410;
      8'h08: g_data__h24367 = rdat__h24416;
      8'h10: g_data__h24367 = rdat__h24422;
      8'h14: g_data__h24367 = rdat__h24435;
      8'h18: g_data__h24367 = rdat__h24458;
      8'h20: g_data__h24367 = rdat__h24558;
      8'h24: g_data__h24367 = rdat__h24572;
      8'h28: g_data__h24367 = rdat__h24580;
      8'h2C: g_data__h24367 = rdat__h24586;
      8'h30: g_data__h24367 = rdat__h24600;
      8'h34: g_data__h24367 = rdat__h24608;
      8'h38: g_data__h24367 = rdat__h24614;
      8'h3C: g_data__h24367 = rdat__h24620;
      8'h40: g_data__h24367 = rdat__h24626;
      8'h44: g_data__h24367 = rdat__h24632;
      default: g_data__h24367 = 32'd0;
    endcase
  end
  ...
  begin
    ...
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wmwt_doAbort)
	$display("[%0d]: %m: wmwt_doAbort", v__h23818);
    if (wciS0_MReset_n)
