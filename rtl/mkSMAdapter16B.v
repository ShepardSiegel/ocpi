...
//
// On Sun Oct 28 09:31:46 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter16B(wciS0_Clk,
  ...
  wire [23 : 0] b__h18410,
		...
		residue__h18273,
		x__h18530;
  wire [15 : 0] sendData_byteEn__h19245,
		wsiBurstLength__h19161,
		x__h25660,
		x_length__h24588;
  ...
  assign MUX_thisMesg$write_1__VAL_1 =
	     { mesgCount[7:0], mesgMetaF_opcode__h23695, x_length__h24588 } ;
  ...
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_2 = { 2'd1, g_data__h25565 } ;
  ...
  assign mlInc__h23528 =
	     wsiS_reqFifo$D_OUT[165] ?
	       { 9'd0, x__h23735 + y__h23736 } :
	       14'd16 ;
  assign rdat__h25608 = hasDebugLogic ? mesgCount : 32'd0 ;
  assign rdat__h25614 = hasDebugLogic ? abortCount : 32'd0 ;
  assign rdat__h25620 = hasDebugLogic ? thisMesg : 32'd0 ;
  assign rdat__h25633 = hasDebugLogic ? lastMesg : 32'd0 ;
  assign rdat__h25656 = hasDebugLogic ? { 16'd0, x__h25660 } : 32'd0 ;
  assign rdat__h25756 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h25770 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h25778 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h25784 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h25798 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h25806 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h25812 = hasDebugLogic ? wmwtBeginCount : 32'd0 ;
  assign rdat__h25818 = hasDebugLogic ? wmwtPushCount : 32'd0 ;
  assign rdat__h25824 = hasDebugLogic ? wmwtFinalCount : 32'd0 ;
  assign rdat__h25830 = hasDebugLogic ? { 31'd0, x__h25834 } : 32'd0 ;
  assign rdat__h25840 = hasDebugLogic ? 32'hFEEDC0DE : 32'd0 ;
  ...
  assign sendData_byteEn__h19245 =
	     (thisMesg[15:0] == 16'd0) ?
	       thisMesg[15:0] :
	       ((unrollCnt == 16'd1) ? x__h19302[15:0] : 16'd65535) ;
  assign value__h6702 =
	     MUX_wmi_mFlagF_x_wire$wset_1__SEL_1 ?
  ...
  assign x__h18530 = { 4'd0, wmi_sFlagReg[23:4] } ;
  ...
  assign x__h23759 = x__h23771 + y__h23772 ;
  assign x__h23771 = x__h23783 + y__h23784 ;
  assign x__h23783 = x__h23795 + y__h23796 ;
  assign x__h23795 = x__h23807 + y__h23808 ;
  assign x__h23807 = x__h23819 + y__h23820 ;
  assign x__h23819 = x__h23831 + y__h23832 ;
  assign x__h23831 = x__h23843 + y__h23844 ;
  assign x__h23843 = x__h23855 + y__h23856 ;
  assign x__h23855 = x__h23867 + y__h23868 ;
  assign x__h23867 = x__h23879 + y__h23880 ;
  assign x__h23879 = x__h23891 + y__h23892 ;
  assign x__h23891 = x__h23903 + y__h23904 ;
  assign x__h23903 = { 4'd0, wsiS_reqFifo$D_OUT[23] } ;
  assign x__h25660 = { wsiS_statusR, wsiM_statusR } ;
  assign x__h25834 = wmi_sThreadBusy_d || wmi_sDataThreadBusy_d ;
  assign x_length__h24588 = { 2'd0, mlB__h23529 } ;
  assign y__h23736 = { 4'd0, wsiS_reqFifo$D_OUT[8] } ;
  assign y__h23748 = { 4'd0, wsiS_reqFifo$D_OUT[9] } ;
  assign y__h23760 = { 4'd0, wsiS_reqFifo$D_OUT[10] } ;
  assign y__h23772 = { 4'd0, wsiS_reqFifo$D_OUT[11] } ;
  assign y__h23784 = { 4'd0, wsiS_reqFifo$D_OUT[12] } ;
  assign y__h23796 = { 4'd0, wsiS_reqFifo$D_OUT[13] } ;
  assign y__h23808 = { 4'd0, wsiS_reqFifo$D_OUT[14] } ;
  assign y__h23820 = { 4'd0, wsiS_reqFifo$D_OUT[15] } ;
  assign y__h23832 = { 4'd0, wsiS_reqFifo$D_OUT[16] } ;
  assign y__h23844 = { 4'd0, wsiS_reqFifo$D_OUT[17] } ;
  assign y__h23856 = { 4'd0, wsiS_reqFifo$D_OUT[18] } ;
  assign y__h23868 = { 4'd0, wsiS_reqFifo$D_OUT[19] } ;
  assign y__h23880 = { 4'd0, wsiS_reqFifo$D_OUT[20] } ;
  assign y__h23892 = { 4'd0, wsiS_reqFifo$D_OUT[21] } ;
  assign y__h23904 = { 4'd0, wsiS_reqFifo$D_OUT[22] } ;
  always@(wci_wslv_reqF$D_OUT or
	  ...
	  rdat__h25806 or
	  rdat__h25812 or
	  rdat__h25818 or rdat__h25824 or rdat__h25830 or rdat__h25840)
  begin
    case (wci_wslv_reqF$D_OUT[39:32])
      8'h0: g_data__h25565 = smaCtrl;
      8'h04: g_data__h25565 = rdat__h25608;
      8'h08: g_data__h25565 = rdat__h25614;
      8'h10: g_data__h25565 = rdat__h25620;
      8'h14: g_data__h25565 = rdat__h25633;
      8'h18: g_data__h25565 = rdat__h25656;
      8'h20: g_data__h25565 = rdat__h25756;
      8'h24: g_data__h25565 = rdat__h25770;
      8'h28: g_data__h25565 = rdat__h25778;
      8'h2C: g_data__h25565 = rdat__h25784;
      8'h30: g_data__h25565 = rdat__h25798;
      8'h34: g_data__h25565 = rdat__h25806;
      8'h38: g_data__h25565 = rdat__h25812;
      8'h3C: g_data__h25565 = rdat__h25818;
      8'h40: g_data__h25565 = rdat__h25824;
      8'h44: g_data__h25565 = rdat__h25830;
      8'h48: g_data__h25565 = rdat__h25840;
      default: g_data__h25565 = 32'd0;
    endcase
  end
  ...
  begin
    ...
    if (wciS0_MReset_n != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_wmwt_doAbort)
	$display("[%0d]: %m: wmwt_doAbort", v__h25014);
    if (wciS0_MReset_n != `BSV_RESET_VALUE)
