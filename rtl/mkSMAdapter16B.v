...
//
// On Mon Jul 12 09:46:25 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter16B(wciS0_Clk,
  ...
  wire [15 : 0] wsiBurstLength__h19146,
		x__h15919,
		x_byteEn__h19244,
		x_length__h17651;
  ...
  wire [7 : 0] mesgMetaF_opcode__h17373;
  wire [3 : 0] b__h14307;
  ...
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_3 =
	     { 4'd3, wsiS_reqFifo$D_OUT[165], 1'b0, addr__h17221, 12'd1 } ;
  ...
  assign addr__h17221 = { mesgLengthSoFar[9:0], 4'd0 } ;
  ...
  assign mlp1B__h17205 = { mlp1__h17204[9:0], 4'd0 } ;
