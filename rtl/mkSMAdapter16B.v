...
//
// On Tue Jun 29 13:17:33 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter16B(wciS0_Clk,
  ...
  wire [15 : 0] wsiBurstLength__h18715,
		x__h15538,
		x_byteEn__h18813,
		x_length__h17239;
  ...
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_3 =
	     { 4'd3, wsiS_reqFifo$D_OUT[165], 1'b0, addr__h16809, 12'd1 } ;
  ...
  assign NOT_wsiS_reqFifo_countReg_71_ULE_1_72___d373 =
	     wsiS_reqFifo_countReg > 2'd1 ;
  assign addr__h16809 = { mesgLengthSoFar[9:0], 4'd0 } ;
  ...
  assign bl__h17842 =
	     zeroLengthMesg ?
	       12'd1 :
	       { 2'd0,
		 IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d766[13:4] } ;
  ...
  assign mlp1B__h16793 = { mlp1__h16792[9:0], 4'd0 } ;
