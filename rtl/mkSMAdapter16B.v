...
//
// On Wed Aug 15 13:30:25 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter16B(wciS0_Clk,
  ...
  reg [63 : 0] v__h18191,
	       ...
	       v__h3825,
	       v__h3969;
  reg [31 : 0] g_data__h24345;
  wire [163 : 0] IF_respF_wDataIn_whas__33_THEN_respF_wDataIn_w_ETC___d912;
  wire [31 : 0] rdat__h24388,
		rdat__h24394,
		rdat__h24400,
		rdat__h24413,
		rdat__h24436,
  ...
  wire [23 : 0] b__h17902,
		...
		residue__h17765,
		x__h18022;
  wire [15 : 0] sendData_byteEn__h18734,
		wsiBurstLength__h18650,
		x__h24440,
		x_length__h23376;
  ...
  wire [4 : 0] x__h22523,
	       ...
	       y__h22680,
	       y__h22692;
  wire [2 : 0] IF_respF_wDataIn_whas__33_THEN_respF_wDataIn_w_ETC___d910;
  ...
  assign MUX_thisMesg$write_1__VAL_1 =
	     { mesgCount[7:0], mesgMetaF_opcode__h22483, x_length__h23376 } ;
  ...
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_2 = { 2'd1, g_data__h24345 } ;
  ...
  assign respF_rCache$D_IN =
	     { 1'd1,
	       respF_rWrPtr,
	       IF_respF_wDataIn_whas__33_THEN_respF_wDataIn_w_ETC___d910,
	       respF_pwEnqueue$whas && respF_wDataIn$wget[165],
	       respF_pwEnqueue$whas && respF_wDataIn$wget[164],
	       IF_respF_wDataIn_whas__33_THEN_respF_wDataIn_w_ETC___d912 } ;
  ...
  // remaining internal signals
  assign IF_respF_wDataIn_whas__33_THEN_respF_wDataIn_w_ETC___d910 =
	     respF_pwEnqueue$whas ? respF_wDataIn$wget[168:166] : 3'd0 ;
  assign IF_respF_wDataIn_whas__33_THEN_respF_wDataIn_w_ETC___d912 =
  ...
  assign mlInc__h22316 =
	     wsiS_reqFifo$D_OUT[165] ?
	       { 9'd0, x__h22523 + y__h22524 } :
	       14'd16 ;
  assign rdat__h24388 = hasDebugLogic ? mesgCount : 32'd0 ;
  assign rdat__h24394 = hasDebugLogic ? abortCount : 32'd0 ;
  assign rdat__h24400 = hasDebugLogic ? thisMesg : 32'd0 ;
  assign rdat__h24413 = hasDebugLogic ? lastMesg : 32'd0 ;
  assign rdat__h24436 = hasDebugLogic ? { 16'd0, x__h24440 } : 32'd0 ;
  assign rdat__h24536 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h24550 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h24558 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h24564 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h24578 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h24586 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h24592 = hasDebugLogic ? wmwtBeginCount : 32'd0 ;
  assign rdat__h24598 = hasDebugLogic ? wmwtPushCount : 32'd0 ;
  assign rdat__h24604 = hasDebugLogic ? wmwtFinalCount : 32'd0 ;
  assign rdat__h24610 = hasDebugLogic ? 32'hFEEDC0DE : 32'd0 ;
  ...
  assign sendData_byteEn__h18734 =
	     (thisMesg[15:0] == 16'd0) ?
	       thisMesg[15:0] :
	       ((unrollCnt == 16'd1) ? x__h18791[15:0] : 16'd65535) ;
  assign value__h6580 =
	     MUX_wmi_mFlagF_x_wire$wset_1__SEL_1 ?
  ...
  assign x__h18022 = { 4'd0, wmi_sFlagReg[23:4] } ;
  ...
  assign x__h22691 = { 4'd0, wsiS_reqFifo$D_OUT[23] } ;
  assign x__h24440 = { wsiS_statusR, wsiM_statusR } ;
  assign x_length__h23376 = { 2'd0, mlB__h22317 } ;
  assign y__h22524 = { 4'd0, wsiS_reqFifo$D_OUT[8] } ;
  assign y__h22536 = { 4'd0, wsiS_reqFifo$D_OUT[9] } ;
  assign y__h22548 = { 4'd0, wsiS_reqFifo$D_OUT[10] } ;
  assign y__h22560 = { 4'd0, wsiS_reqFifo$D_OUT[11] } ;
  assign y__h22572 = { 4'd0, wsiS_reqFifo$D_OUT[12] } ;
  assign y__h22584 = { 4'd0, wsiS_reqFifo$D_OUT[13] } ;
  assign y__h22596 = { 4'd0, wsiS_reqFifo$D_OUT[14] } ;
  assign y__h22608 = { 4'd0, wsiS_reqFifo$D_OUT[15] } ;
  assign y__h22620 = { 4'd0, wsiS_reqFifo$D_OUT[16] } ;
  assign y__h22632 = { 4'd0, wsiS_reqFifo$D_OUT[17] } ;
  assign y__h22644 = { 4'd0, wsiS_reqFifo$D_OUT[18] } ;
  assign y__h22656 = { 4'd0, wsiS_reqFifo$D_OUT[19] } ;
  assign y__h22668 = { 4'd0, wsiS_reqFifo$D_OUT[20] } ;
  assign y__h22680 = { 4'd0, wsiS_reqFifo$D_OUT[21] } ;
  assign y__h22692 = { 4'd0, wsiS_reqFifo$D_OUT[22] } ;
  always@(wci_wslv_reqF$D_OUT or
	  ...
	  rdat__h24578 or
	  rdat__h24586 or
	  rdat__h24592 or rdat__h24598 or rdat__h24604 or rdat__h24610)
  begin
    case (wci_wslv_reqF$D_OUT[39:32])
      8'h0: g_data__h24345 = smaCtrl;
      8'h04: g_data__h24345 = rdat__h24388;
      8'h08: g_data__h24345 = rdat__h24394;
      8'h10: g_data__h24345 = rdat__h24400;
      8'h14: g_data__h24345 = rdat__h24413;
      8'h18: g_data__h24345 = rdat__h24436;
      8'h20: g_data__h24345 = rdat__h24536;
      8'h24: g_data__h24345 = rdat__h24550;
      8'h28: g_data__h24345 = rdat__h24558;
      8'h2C: g_data__h24345 = rdat__h24564;
      8'h30: g_data__h24345 = rdat__h24578;
      8'h34: g_data__h24345 = rdat__h24586;
      8'h38: g_data__h24345 = rdat__h24592;
      8'h3C: g_data__h24345 = rdat__h24598;
      8'h40: g_data__h24345 = rdat__h24604;
      8'h44: g_data__h24345 = rdat__h24610;
      default: g_data__h24345 = 32'd0;
    endcase
  end
  ...
  begin
    ...
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wmwt_doAbort)
	$display("[%0d]: %m: wmwt_doAbort", v__h23796);
    if (wciS0_MReset_n)
