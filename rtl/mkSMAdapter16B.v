...
//
// On Wed Nov 28 10:32:37 EST 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter16B(wciS0_Clk,
  ...
  assign MUX_thisMesg$write_1__VAL_1 =
	     { mesgCount[7:0], mesgMetaF_opcode__h22998, x_length__h23891 } ;
  ...
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_2 = { 2'd1, g_data__h24868 } ;
  ...
  assign mlInc__h22831 =
	     wsiS_reqFifo$D_OUT[165] ?
	       { 9'd0, x__h23038 + y__h23039 } :
	       14'd16 ;
  assign rdat__h24911 = hasDebugLogic ? mesgCount : 32'd0 ;
  assign rdat__h24917 = hasDebugLogic ? abortCount : 32'd0 ;
  assign rdat__h24923 = hasDebugLogic ? thisMesg : 32'd0 ;
  assign rdat__h24936 = hasDebugLogic ? lastMesg : 32'd0 ;
  assign rdat__h24959 = hasDebugLogic ? { 16'd0, x__h24963 } : 32'd0 ;
  assign rdat__h25059 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h25073 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h25081 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h25087 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h25101 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h25109 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h25115 = hasDebugLogic ? wmwtBeginCount : 32'd0 ;
  assign rdat__h25121 = hasDebugLogic ? wmwtPushCount : 32'd0 ;
  assign rdat__h25127 = hasDebugLogic ? wmwtFinalCount : 32'd0 ;
  assign rdat__h25133 = hasDebugLogic ? { 31'd0, x__h25137 } : 32'd0 ;
  assign rdat__h25143 = hasDebugLogic ? 32'hFEEDC0DE : 32'd0 ;
  ...
  assign x__h23206 = { 4'd0, wsiS_reqFifo$D_OUT[23] } ;
  assign x__h24963 = { wsiS_statusR, wsiM_statusR } ;
  assign x__h25137 = wmi_sThreadBusy_d || wmi_sDataThreadBusy_d ;
  assign x_length__h23891 = { 2'd0, mlB__h22832 } ;
  assign y__h23039 = { 4'd0, wsiS_reqFifo$D_OUT[8] } ;
  assign y__h23051 = { 4'd0, wsiS_reqFifo$D_OUT[9] } ;
  assign y__h23063 = { 4'd0, wsiS_reqFifo$D_OUT[10] } ;
  assign y__h23075 = { 4'd0, wsiS_reqFifo$D_OUT[11] } ;
  assign y__h23087 = { 4'd0, wsiS_reqFifo$D_OUT[12] } ;
  assign y__h23099 = { 4'd0, wsiS_reqFifo$D_OUT[13] } ;
  assign y__h23111 = { 4'd0, wsiS_reqFifo$D_OUT[14] } ;
  assign y__h23123 = { 4'd0, wsiS_reqFifo$D_OUT[15] } ;
  assign y__h23135 = { 4'd0, wsiS_reqFifo$D_OUT[16] } ;
  assign y__h23147 = { 4'd0, wsiS_reqFifo$D_OUT[17] } ;
  assign y__h23159 = { 4'd0, wsiS_reqFifo$D_OUT[18] } ;
  assign y__h23171 = { 4'd0, wsiS_reqFifo$D_OUT[19] } ;
  assign y__h23183 = { 4'd0, wsiS_reqFifo$D_OUT[20] } ;
  assign y__h23195 = { 4'd0, wsiS_reqFifo$D_OUT[21] } ;
  assign y__h23207 = { 4'd0, wsiS_reqFifo$D_OUT[22] } ;
  always@(wci_wslv_reqF$D_OUT or
	  ...
	  rdat__h25109 or
	  rdat__h25115 or
	  rdat__h25121 or rdat__h25127 or rdat__h25133 or rdat__h25143)
  begin
    case (wci_wslv_reqF$D_OUT[39:32])
      8'h0: g_data__h24868 = smaCtrl;
      8'h04: g_data__h24868 = rdat__h24911;
      8'h08: g_data__h24868 = rdat__h24917;
      8'h10: g_data__h24868 = rdat__h24923;
      8'h14: g_data__h24868 = rdat__h24936;
      8'h18: g_data__h24868 = rdat__h24959;
      8'h20: g_data__h24868 = rdat__h25059;
      8'h24: g_data__h24868 = rdat__h25073;
      8'h28: g_data__h24868 = rdat__h25081;
      8'h2C: g_data__h24868 = rdat__h25087;
      8'h30: g_data__h24868 = rdat__h25101;
      8'h34: g_data__h24868 = rdat__h25109;
      8'h38: g_data__h24868 = rdat__h25115;
      8'h3C: g_data__h24868 = rdat__h25121;
      8'h40: g_data__h24868 = rdat__h25127;
      8'h44: g_data__h24868 = rdat__h25133;
      8'h48: g_data__h24868 = rdat__h25143;
      default: g_data__h24868 = 32'd0;
    endcase
  end
  ...
  begin
    ...
    if (wciS0_MReset_n != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_wmwt_doAbort)
	$display("[%0d]: %m: wmwt_doAbort", v__h24317);
    if (wciS0_MReset_n != `BSV_RESET_VALUE)
