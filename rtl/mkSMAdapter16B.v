...
//
// On Fri Jul 23 11:09:56 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter16B(wciS0_Clk,
  ...
  wire [15 : 0] wsiBurstLength__h19224,
		x__h15997,
		x_byteEn__h19322,
		x_length__h17729;
  ...
  wire [7 : 0] mesgMetaF_opcode__h17451;
  wire [3 : 0] b__h14385;
  ...
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_3 =
	     { 4'd3, wsiS_reqFifo$D_OUT[165], 1'b0, addr__h17299, 12'd1 } ;
  ...
  assign addr__h17299 = { mesgLengthSoFar[9:0], 4'd0 } ;
  ...
  assign bl__h18351 =
	     zeroLengthMesg ?
	       12'd1 :
	       { 2'd0,
		 IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d798[13:4] } ;
  ...
  assign mlp1B__h17283 = { mlp1__h17282[9:0], 4'd0 } ;
