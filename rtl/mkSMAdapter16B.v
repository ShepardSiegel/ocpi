...
//
// On Wed Jun 22 17:51:07 EDT 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter16B(wciS0_Clk,
  ...
  wire [168 : 0] respF_memory$DIA, respF_memory$DIB, respF_memory$DOB;
  ...
  reg [63 : 0] v__h18234,
	       ...
	       v__h3825,
	       v__h3969;
  reg [31 : 0] g_data__h24394;
  wire [163 : 0] IF_respF_wDataIn_whas__45_THEN_respF_wDataIn_w_ETC___d995;
  wire [31 : 0] rdat__h24437,
		rdat__h24443,
		rdat__h24449,
		rdat__h24462,
		rdat__h24485,
  ...
  wire [15 : 0] sendData_byteEn__h18777,
		wsiBurstLength__h18693,
		x__h24489,
		x_length__h23425;
  ...
  wire [4 : 0] x__h22573,
	       ...
	       y__h22730,
	       y__h22742;
  wire [2 : 0] IF_respF_wDataIn_whas__45_THEN_respF_wDataIn_w_ETC___d993;
  wire NOT_wmi_reqF_c_r_57_EQ_2_76_77_AND_wmi_operate_ETC___d529,
       wmi_respF_i_notEmpty__42_AND_smaCtrl_77_BIT_4__ETC___d547,
       wsiS_reqFifo_i_notEmpty__76_AND_NOT_smaCtrl_77_ETC___d675,
  ...
  // value method wmiM0_mDataLast
  assign wmiM0_MDataLast = wmi_dhF_q_0[144] ;

  // value method wmiM0_mData
  assign wmiM0_MData = wmi_dhF_q_0[143:16] ;

  // value method wmiM0_mDataByteEn
  assign wmiM0_MDataByteEn = wmi_dhF_q_0[15:0] ;
  ...
  assign MUX_endOfMessage$write_1__SEL_1 =
	     WILL_FIRE_RL_wmwt_messagePush && wsiS_reqFifo$D_OUT[165] ;
  ...
  assign MUX_thisMesg$write_1__VAL_1 =
	     { mesgCount[7:0], mesgMetaF_opcode__h22533, x_length__h23425 } ;
  ...
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_2 = { 2'd1, g_data__h24394 } ;
  ...
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_2 =
	     { 4'd3, wsiS_reqFifo$D_OUT[165], 1'b0, addr__h22400, 12'd1 } ;
  ...
  assign errCount$EN =
	     ...
	     (!wsiS_reqFifo$D_OUT[165] || wsiS_reqFifo$D_OUT[23:8] != 16'd0 ||
  ...
  assign respF_rCache$D_IN =
	     { 1'd1,
	       respF_rWrPtr,
	       IF_respF_wDataIn_whas__45_THEN_respF_wDataIn_w_ETC___d993,
	       respF_pwEnqueue$whas && respF_wDataIn$wget[165],
	       respF_pwEnqueue$whas && respF_wDataIn$wget[164],
	       IF_respF_wDataIn_whas__45_THEN_respF_wDataIn_w_ETC___d995 } ;
  ...
  // remaining internal signals
  assign IF_respF_wDataIn_whas__45_THEN_respF_wDataIn_w_ETC___d993 =
	     respF_pwEnqueue$whas ? respF_wDataIn$wget[168:166] : 3'd0 ;
  assign IF_respF_wDataIn_whas__45_THEN_respF_wDataIn_w_ETC___d995 =
  ...
  assign addr__h22400 = { mesgLengthSoFar[9:0], 4'd0 } ;
  ...
  assign mlInc__h22359 =
	     wsiS_reqFifo$D_OUT[165] ?
	       { 9'd0, x__h22573 + y__h22574 } :
	       14'd16 ;
  assign rdat__h24437 = hasDebugLogic ? mesgCount : 32'd0 ;
  assign rdat__h24443 = hasDebugLogic ? abortCount : 32'd0 ;
  assign rdat__h24449 = hasDebugLogic ? thisMesg : 32'd0 ;
  assign rdat__h24462 = hasDebugLogic ? lastMesg : 32'd0 ;
  assign rdat__h24485 = hasDebugLogic ? { 16'd0, x__h24489 } : 32'd0 ;
  assign rdat__h24585 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h24599 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h24607 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h24613 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h24627 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h24635 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h24641 = hasDebugLogic ? wmwtBeginCount : 32'd0 ;
  assign rdat__h24647 = hasDebugLogic ? wmwtPushCount : 32'd0 ;
  assign rdat__h24653 = hasDebugLogic ? wmwtFinalCount : 32'd0 ;
  assign rdat__h24659 = hasDebugLogic ? 32'hFEEDC0DE : 32'd0 ;
  ...
  assign sendData_byteEn__h18777 =
	     (thisMesg[15:0] == 16'd0) ?
	       thisMesg[15:0] :
	       ((unrollCnt == 16'd1) ? x__h18834[15:0] : 16'd65535) ;
  assign value__h6627 =
	     MUX_wmi_mFlagF_x_wire$wset_1__SEL_1 ?
  ...
  assign wsiS_reqFifo_i_notEmpty__76_AND_NOT_smaCtrl_77_ETC___d675 =
	     wsiS_reqFifo$EMPTY_N &&
	     (smaCtrl[3:0] != 4'h3 || wsiM_reqFifo_c_r != 2'd2) &&
	     (!wsiS_reqFifo$D_OUT[165] || wmi_mFlagF_c_r != 2'd2) ;
  ...
  assign x__h22741 = { 4'd0, wsiS_reqFifo$D_OUT[23] } ;
  assign x__h24489 = { wsiS_statusR, wsiM_statusR } ;
  assign x_length__h23425 = { 2'd0, mlB__h22360 } ;
  assign y__h22574 = { 4'd0, wsiS_reqFifo$D_OUT[8] } ;
  assign y__h22586 = { 4'd0, wsiS_reqFifo$D_OUT[9] } ;
  assign y__h22598 = { 4'd0, wsiS_reqFifo$D_OUT[10] } ;
  assign y__h22610 = { 4'd0, wsiS_reqFifo$D_OUT[11] } ;
  assign y__h22622 = { 4'd0, wsiS_reqFifo$D_OUT[12] } ;
  assign y__h22634 = { 4'd0, wsiS_reqFifo$D_OUT[13] } ;
  assign y__h22646 = { 4'd0, wsiS_reqFifo$D_OUT[14] } ;
  assign y__h22658 = { 4'd0, wsiS_reqFifo$D_OUT[15] } ;
  assign y__h22670 = { 4'd0, wsiS_reqFifo$D_OUT[16] } ;
  assign y__h22682 = { 4'd0, wsiS_reqFifo$D_OUT[17] } ;
  assign y__h22694 = { 4'd0, wsiS_reqFifo$D_OUT[18] } ;
  assign y__h22706 = { 4'd0, wsiS_reqFifo$D_OUT[19] } ;
  assign y__h22718 = { 4'd0, wsiS_reqFifo$D_OUT[20] } ;
  assign y__h22730 = { 4'd0, wsiS_reqFifo$D_OUT[21] } ;
  assign y__h22742 = { 4'd0, wsiS_reqFifo$D_OUT[22] } ;
  always@(wci_wslv_reqF$D_OUT or
	  ...
	  rdat__h24627 or
	  rdat__h24635 or
	  rdat__h24641 or rdat__h24647 or rdat__h24653 or rdat__h24659)
  begin
    case (wci_wslv_reqF$D_OUT[39:32])
      8'h0: g_data__h24394 = smaCtrl;
      8'h04: g_data__h24394 = rdat__h24437;
      8'h08: g_data__h24394 = rdat__h24443;
      8'h10: g_data__h24394 = rdat__h24449;
      8'h14: g_data__h24394 = rdat__h24462;
      8'h18: g_data__h24394 = rdat__h24485;
      8'h20: g_data__h24394 = rdat__h24585;
      8'h24: g_data__h24394 = rdat__h24599;
      8'h28: g_data__h24394 = rdat__h24607;
      8'h2C: g_data__h24394 = rdat__h24613;
      8'h30: g_data__h24394 = rdat__h24627;
      8'h34: g_data__h24394 = rdat__h24635;
      8'h38: g_data__h24394 = rdat__h24641;
      8'h3C: g_data__h24394 = rdat__h24647;
      8'h40: g_data__h24394 = rdat__h24653;
      8'h44: g_data__h24394 = rdat__h24659;
      default: g_data__h24394 = 32'd0;
    endcase
  end
  ...
  begin
    ...
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wmwt_doAbort)
	$display("[%0d]: %m: wmwt_doAbort", v__h23845);
    if (wciS0_MReset_n)
