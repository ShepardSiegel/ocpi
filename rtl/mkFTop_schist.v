...
//
// On Wed Feb 29 09:03:52 EST 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkFTop_schist(sys0_clkp,
  ...
  wire pciw_pci0_pwTrnRx$whas,
       ...
       tcW10_wti_peerIsReady_1$wget,
       tcW10_wti_peerIsReady_1$whas,
       tcW10_wti_sThreadBusy_pw$whas,
       tcW11_wti_peerIsReady_1$wget,
       tcW11_wti_peerIsReady_1$whas,
  ...
  // register tcW10_wti_peerIsReady
  reg tcW10_wti_peerIsReady;
  wire tcW10_wti_peerIsReady$D_IN, tcW10_wti_peerIsReady$EN;
  ...
  // register tcW11_wti_peerIsReady
  reg tcW11_wti_peerIsReady;
  wire tcW11_wti_peerIsReady$D_IN, tcW11_wti_peerIsReady$EN;
  ...
  // submodule adcW10
  mkADCWorker #(.hasDebugLogic(1'd1)) adcW10(.CLK_sys0_clk(sys0_clk$O),
					     ...
					     .wtiS0_SReset_n(adcW10$wtiS0_SReset_n),
  ...
  // submodule dacW11
  mkDACWorker #(.hasDebugLogic(1'd1)) dacW11(.CLK_dac_clk(dac_clk$O),
					     ...
					     .wtiS0_SReset_n(dacW11$wtiS0_SReset_n),
  ...
  // submodule dram0
  mkDramServer_v5 #(.hasDebugLogic(1'd0)) dram0(.CLK_sys0_clk(sys0_clk$O),
						.RST_N_sys0_rst(sys0_rst$OUT_RST_N),
  ...
  assign tcW10_wti_peerIsReady_1$wget = 1'd1 ;
  assign tcW10_wti_peerIsReady_1$whas = adcW10$wtiS0_SReset_n ;
  assign tcW11_wti_peerIsReady_1$wget = 1'd1 ;
  assign tcW11_wti_peerIsReady_1$whas = dacW11$wtiS0_SReset_n ;
  ...
  // register tcW10_wti_peerIsReady
  assign tcW10_wti_peerIsReady$D_IN = adcW10$wtiS0_SReset_n ;
  assign tcW10_wti_peerIsReady$EN = 1'd1 ;
  ...
  // register tcW11_wti_peerIsReady
  assign tcW11_wti_peerIsReady$D_IN = dacW11$wtiS0_SReset_n ;
  assign tcW11_wti_peerIsReady$EN = 1'd1 ;
  ...
  begin
	...
	tcW11_wti_peerIsReady <= `BSV_ASSIGNMENT_DELAY 1'd0;
	...
	if (tcW11_wti_peerIsReady$EN)
	  tcW11_wti_peerIsReady <= `BSV_ASSIGNMENT_DELAY
	      tcW11_wti_peerIsReady$D_IN;
  ...
  begin
	...
	tcW10_wti_peerIsReady <= `BSV_ASSIGNMENT_DELAY 1'd0;
	...
	if (tcW10_wti_peerIsReady$EN)
	  tcW10_wti_peerIsReady <= `BSV_ASSIGNMENT_DELAY
	      tcW10_wti_peerIsReady$D_IN;
