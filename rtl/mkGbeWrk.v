...
//
// On Wed Aug 22 12:03:17 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkGbeWrk(wciS0_Clk,
  ...
  wire RDY_dgdpEgressCnt, RDY_l2Dst, RDY_l2Typ, wciS0_SThreadBusy;
  ...
  // value method l2Dst
  assign l2Dst = edpDV[47:0] ;
  assign RDY_l2Dst = 1'd1 ;

  // value method l2Typ
  assign l2Typ = edpDV[63:48] ;
  ...
  assign CAN_FIRE_RL_wci_cfrd =
	     wci_wslv_respF_c_r != 2'd2 && wci_wslv_reqF$EMPTY_N &&
	     (wci_wslv_reqF$D_OUT[39:32] != 8'h0C || EN_dgdpEgressCnt) &&
	     wci_wslv_wci_cfrd_pw$whas ;
  assign WILL_FIRE_RL_wci_cfrd =
	     CAN_FIRE_RL_wci_cfrd && !WILL_FIRE_RL_wci_cfwr ;
  ...
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_2 = { 2'd1, g_data__h11499 } ;
  ...
  assign edpDV$D_IN =
	     (wci_wslv_reqF$D_OUT[39:32] == 8'h10) ?
	       { wci_wslv_reqF$D_OUT[31:0], edpDV[127:32] } :
	       { edpDV[95:0], wci_wslv_reqF$D_OUT[31:0] } ;
  assign edpDV$EN =
	     WILL_FIRE_RL_wci_cfwr &&
	     (wci_wslv_reqF$D_OUT[39:32] == 8'h10 ||
  ...
  // remaining internal signals
  always@(wci_wslv_reqF$D_OUT or dgdpEgressCnt_arg or edpDV)
  begin
    case (wci_wslv_reqF$D_OUT[39:32])
      8'h0C: g_data__h11499 = dgdpEgressCnt_arg;
      8'h10: g_data__h11499 = edpDV[31:0];
      8'h14: g_data__h11499 = edpDV[63:32];
      default: g_data__h11499 = 32'd0;
    endcase
  end
