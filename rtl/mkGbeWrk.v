...
//
// On Tue Aug 28 14:31:28 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkGbeWrk(wciS0_Clk,
  ...
  reg [63 : 0] v__h3619, v__h3793, v__h3937;
  reg [31 : 0] g_data__h11588;
  ...
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_2 = { 2'd1, g_data__h11588 } ;
  ...
  // remaining internal signals
  always@(wci_wslv_reqF$D_OUT or ctlReg or dgdpEgressCnt_arg or edpDV)
  begin
    case (wci_wslv_reqF$D_OUT[39:32])
      8'h0: g_data__h11588 = ctlReg;
      8'h0C: g_data__h11588 = dgdpEgressCnt_arg;
      8'h10: g_data__h11588 = edpDV[31:0];
      8'h14: g_data__h11588 = edpDV[63:32];
      default: g_data__h11588 = 32'd0;
    endcase
  end
