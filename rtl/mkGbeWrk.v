...
//
// On Tue Aug 21 18:36:17 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkGbeWrk(wciS0_Clk,
  ...
  wire RDY_l2Dst, RDY_l2Typ, wciS0_SThreadBusy;
  ...
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_2 = { 2'd1, g_data__h11420 } ;
  ...
  // remaining internal signals
  always@(wci_wslv_reqF$D_OUT or edpDV)
  begin
    case (wci_wslv_reqF$D_OUT[39:32])
      8'h10: g_data__h11420 = edpDV[31:0];
      8'h14: g_data__h11420 = edpDV[63:32];
      default: g_data__h11420 = 32'd0;
    endcase
  end
