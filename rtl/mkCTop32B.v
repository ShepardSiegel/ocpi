...
//
// On Wed Nov  9 10:02:03 EST 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkCTop32B(pciDevice,
  ...
  // submodule app
  mkOCApp32B #(.hasDebugLogic(1'd1)) app(.RST_N_rst_0(inf$RST_N_wci_m_0),
  ...
  // submodule inf
  mkOCInf32B inf(.pciDevice(pciDevice),
  ...
  assign app$wsi_s_adc_MByteEn = 32'h0 ;
  assign app$wsi_s_adc_MCmd = 3'h0 ;
  assign app$wsi_s_adc_MData = 256'h0 ;
