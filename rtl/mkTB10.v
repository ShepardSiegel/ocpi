...
//
// On Mon Jun 28 16:48:43 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkTB10(CLK,
  ...
  reg [63 : 0] v__h2950,
	       ...
	       v__h48916,
	       v__h49259;
  wire [31 : 0] toCount__h2410, x__h2829, x_data__h49084;
  wire [26 : 0] IF_wci_lastControlOp_51_BIT_3_52_THEN_wci_last_ETC___d469;
  wire [15 : 0] wsiBurstLength__h48579;
  wire [3 : 0] x__h2584;
  wire NOT_wci_busy_29_30_AND_IF_wci_wReset_n_43_THEN_ETC___d147,
       NOT_wsiS_reqFifo_countReg_37_ULE_1_38___d239,
       _dand1wci_busy$EN_write,
       _dand2wci_respF$EN_enq,
       _dor1wci_lastConfigAddr$EN_write,
       wci_respTimr_75_ULT_1_SL_wci_wTimeout_76_77___d624;
  ...
  assign CAN_FIRE_RL_wciSeqFsm_action_l52c8 =
	     NOT_wci_busy_29_30_AND_IF_wci_wReset_n_43_THEN_ETC___d147 &&
  ...
  assign wciSeqFsm_pw_list_6$whas = CAN_FIRE_RL_wciSeqFsm_actionof_l49c5 ;
  assign wciSeqFsm_pw_list_8$whas = CAN_FIRE_RL_wciSeqFsm_action_l52c8 ;
  assign wciSeqFsm_pw_list_7$whas = CAN_FIRE_RL_wciSeqFsm_action_l51c5 ;
  ...
  assign wciSeqFsm_pw_list_10$whas = CAN_FIRE_RL_wciSeqFsm_action_l55c5 ;
  ...
  assign wciSeqFsm_pw_list_13$whas = CAN_FIRE_RL_wciSeqFsm_action_l59c5 ;
  assign wciSeqFsm_pw_list_15$whas = CAN_FIRE_RL_wciSeqFsm_action_l61c5 ;
  assign wciSeqFsm_pw_list_16$whas = CAN_FIRE_RL_wciSeqFsm_action_l63c5 ;
  assign wciSeqFsm_pw_list_17$whas = CAN_FIRE_RL_wciSeqFsm_actionof_l64c8 ;
  ...
  assign wciSeqFsm_pw_list_20$whas = CAN_FIRE_RL_wciSeqFsm_actionof_l68c19 ;
  assign wciSeqFsm_pw_list_21$whas = CAN_FIRE_RL_wciSeqFsm_action_l69c19 ;
  assign wciSeqFsm_pw_list_22$whas = CAN_FIRE_RL_wciSeqFsm_action_l71c19 ;
  assign wciSeqFsm_pw_list_23$whas = CAN_FIRE_RL_wciSeqFsm_actionof_l72c19 ;
  ...
  assign enWsiSource$EN = CAN_FIRE_RL_wciSeqFsm_actionof_l72c19 ;
  ...
  always@(CAN_FIRE_RL_wciSeqFsm_action_l43c3 or
	  ...
	  WILL_FIRE_RL_wciSeqFsm_actionof_l71c19 or
	  WILL_FIRE_RL_wciSeqFsm_actionof_l72c19)
  begin
    case (1'b1) // synopsys parallel_case
      CAN_FIRE_RL_wciSeqFsm_action_l43c3:
  ...
  assign wci_wStatus$D_IN =
	     { 4'b0,
	       ...
	       IF_wci_lastControlOp_51_BIT_3_52_THEN_wci_last_ETC___d469 } ;
  ...
  // remaining internal signals
  assign IF_wci_lastControlOp_51_BIT_3_52_THEN_wci_last_ETC___d469 =
	     { wci_lastControlOp[3] ? wci_lastControlOp[2:0] : 3'b111,
	       ...
	       wci_reqFAIL,
	       wci_reqERR } ;
  assign NOT_wci_busy_29_30_AND_IF_wci_wReset_n_43_THEN_ETC___d147 =
	     !wci_busy && (wci_wReset_n ? !wci_reqF_c_r : wci_respF$FULL_N) ;
  assign NOT_wsiS_reqFifo_countReg_37_ULE_1_38___d239 =
	     wsiS_reqFifo_countReg > 2'd1 ;
  ...
  assign wci_respTimr_75_ULT_1_SL_wci_wTimeout_76_77___d624 =
	     wci_respTimr < toCount__h2410 ;
  assign wsiBurstLength__h48579 = { 4'd0, wsiS_reqFifo$D_OUT[55:44] } ;
  assign x__h2584 = wci_lastConfigBE[4] ? wci_lastConfigBE[3:0] : 4'hF ;
  assign x__h2829 = wci_respTimr + 32'd1 ;
  assign x_data__h49084 = {2{srcDataOut[15:0]}} ;
  ...
  begin
    ...
    if (RST_N)
      if (WILL_FIRE_RL_terminate)
	$display("[%0d]: %m: mkTB10 termination", v__h48511);
    ...
    if (RST_N)
      if (WILL_FIRE_RL_wciSeqFsm_actionof_l44c5)
	$display("[%0d]: %m: Checking for DUT presence...", v__h43030);
    ...
    if (RST_N)
      if (WILL_FIRE_RL_wciSeqFsm_actionof_l47c5)
	$display("[%0d]: %m: Taking DUT out of Reset...", v__h43353);
    ...
    if (RST_N)
      if (WILL_FIRE_RL_wciSeqFsm_actionof_l51c5)
	$display("[%0d]: %m: CONTROL-OP: -INITIALIZE- DUT...", v__h44172);
    ...
    if (RST_N)
      if (WILL_FIRE_RL_wciSeqFsm_actionof_l59c5)
	$display("[%0d]: %m: Read Dataplane Config Properties...", v__h45772);
    ...
    if (RST_N)
      if (WILL_FIRE_RL_wciSeqFsm_actionof_l63c5)
	$display("[%0d]: %m: CONTROL-OP: -START- DUT...", v__h46597);
    ...
    if (RST_N)
      if (WILL_FIRE_RL_wciSeqFsm_actionof_l52c8)
	$display("[%0d]: %m: WORKER CONTROL ARM...", v__h44395);
    ...
    if (RST_N)
      if (WILL_FIRE_RL_wciSeqFsm_actionof_l64c8)
	$display("[%0d]: %m: WORKER CONTROL ARM...", v__h46847);
