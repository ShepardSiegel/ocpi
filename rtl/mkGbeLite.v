...
//
// On Tue Jun 12 10:36:15 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkGbeLite(CLK_gmii_rx_clk,
  ...
  wire [58 : 0] dcp_cpReqF$dD_OUT, dcp_cpReqF$sD_IN;
  wire dcp_cpReqF$dDEQ,
       dcp_cpReqF$dEMPTY_N,
       dcp_cpReqF$sENQ,
       dcp_cpReqF$sFULL_N;

  // ports of submodule dcp_cpRespF
  wire [39 : 0] dcp_cpRespF$dD_OUT, dcp_cpRespF$sD_IN;
  wire dcp_cpRespF$dDEQ,
       dcp_cpRespF$dEMPTY_N,
       dcp_cpRespF$sENQ,
       dcp_cpRespF$sFULL_N;
  ...
  reg [9 : 0] CASE_dcpRespFD_OUT_BITS_43_TO_42_IF_txDCPPos__ETC__q7,
	      IF_txDCPPos_47_EQ_0_48_THEN_0_ELSE_IF_txDCPPos_ETC___d677;
  reg [7 : 0] CASE_13_MINUS_txDCPPos_rxHdr_sV_BITS_63_TO_56__ETC__q6,
	      ...
	      IF_rxDCPMesgPos_10_EQ_5_51_THEN_rxDCPMesg_17_B_ETC___d602,
	      tag__h62212;
  ...
  reg CASE_IF_rxDCPMesgPos_10_EQ_5_51_THEN_rxDCPMesg_ETC__q4,
      CASE_dcpRespFD_OUT_BITS_43_TO_42_IF_txDCPPos__ETC__q3,
      IF_txDCPPos_47_EQ_0_48_OR_txDCPPos_47_EQ_1_49__ETC___d673;
  ...
  wire [4 : 0] IF_txDCPPos_47_EQ_9_65_THEN_0_ELSE_txDCPPos_47_ETC___d665,
	       txDCPPos_47_PLUS_1___d623;
  wire [2 : 0] d0__h1997,
	       d10__h1987,
	       d11__h1986,
	       d12__h1985,
	       ...
	       ra3__h1977,
	       ra4__h1976;
  wire IF_dcp_dcpReqF_first__29_BITS_77_TO_76_30_EQ_0_ETC___d140,
       IF_rxHdr_pos_09_EQ_0_25_THEN_rxHdr_sV_92_BITS__ETC___d294,
       NOT_rxHdr_sV_92_BIT_112_93_09_AND_rxHdr_sV_92__ETC___d315,
       NOT_rxHdr_sV_92_BIT_112_93_09_AND_rxHdr_sV_92__ETC___d502,
       dcpRespF_i_notEmpty__43_AND_IF_dcpRespF_first__ETC___d479,
       gmac_rx_get_03_BITS_9_TO_8_04_EQ_0_05_OR_gmac__ETC___d297,
       rxHdr_sV_92_BIT_112_93_OR_NOT_rxHdr_sV_92_BITS_ETC___d581;
  ...
  // actionvalue method cpClient_request_get
  assign cpClient_request_get = dcp_cpReqF$dD_OUT ;
  assign RDY_cpClient_request_get = dcp_cpReqF$dEMPTY_N ;

  // action method cpClient_response_put
  assign RDY_cpClient_response_put = dcp_cpRespF$sFULL_N ;
  ...
  SyncFIFO #(.dataWidth(32'd59),
	     .depth(32'd4),
	     .indxWidth(32'd2)) dcp_cpReqF(.sCLK(wciS0_Clk),
					   .dCLK(CLK_cpClock),
					   .sRST_N(wciS0_MReset_n),
					   .sD_IN(dcp_cpReqF$sD_IN),
					   .sENQ(dcp_cpReqF$sENQ),
					   .dDEQ(dcp_cpReqF$dDEQ),
					   .dD_OUT(dcp_cpReqF$dD_OUT),
					   .sFULL_N(dcp_cpReqF$sFULL_N),
					   .dEMPTY_N(dcp_cpReqF$dEMPTY_N));

  // submodule dcp_cpRespF
  SyncFIFO #(.dataWidth(32'd40),
	     .depth(32'd4),
	     .indxWidth(32'd2)) dcp_cpRespF(.sCLK(CLK_cpClock),
					    .dCLK(wciS0_Clk),
					    .sRST_N(RST_N_cpReset),
					    .sD_IN(dcp_cpRespF$sD_IN),
					    .sENQ(dcp_cpRespF$sENQ),
					    .dDEQ(dcp_cpRespF$dDEQ),
					    .dD_OUT(dcp_cpRespF$dD_OUT),
					    .sFULL_N(dcp_cpRespF$sFULL_N),
					    .dEMPTY_N(dcp_cpRespF$dEMPTY_N));
  ...
  assign WILL_FIRE_RL_rx_dcp =
	     rxDCPHdrF$EMPTY_N &&
	     CASE_IF_rxDCPMesgPos_10_EQ_5_51_THEN_rxDCPMesg_ETC__q4 &&
	     !WILL_FIRE_RL_rx_data ;
  ...
  assign WILL_FIRE_RL_dcp_dcp_request =
	     dcp_dcpReqF$EMPTY_N &&
	     IF_dcp_dcpReqF_first__29_BITS_77_TO_76_30_EQ_0_ETC___d140 ;

  // rule RL_dcp_cp_response
  assign CAN_FIRE_RL_dcp_cp_response =
	     dcp_cpRespF$dEMPTY_N && dcp_dcpRespF$FULL_N ;
  ...
  assign MUX_dcp_dcpRespF$enq_1__VAL_2 =
	     { 2'd2,
	       dcp_cpRespF$dD_OUT[31:0],
	       dcp_cpRespF$dD_OUT[39:32],
	       2'd0 } ;
  ...
  // register rxLenCount
  assign rxLenCount$D_IN = (gmac$rx_get[9:8] == 2'd0) ? x__h62002 : 32'd0 ;
  assign rxLenCount$EN = WILL_FIRE_RL_rx_data ;

  // register rxLenLast
  assign rxLenLast$D_IN = x__h62002 ;
  ...
  assign txDCPPos$D_IN =
	     (!rxHdr_sV[112] && rxHdr_sV[15:0] == 16'hF040) ?
	       ((txDCPPos == 5'd13) ? 5'd0 : txDCPPos_47_PLUS_1___d623) :
  ...
  assign dcp_cpReqF$sENQ =
	     WILL_FIRE_RL_dcp_dcp_request &&
	     dcp_dcpReqF$D_OUT[77:76] != 2'd0 ;
  assign dcp_cpReqF$dDEQ = EN_cpClient_request_get ;

  // submodule dcp_cpRespF
  assign dcp_cpRespF$sD_IN = cpClient_response_put ;
  assign dcp_cpRespF$sENQ = EN_cpClient_response_put ;
  assign dcp_cpRespF$dDEQ = MUX_dcp_dcpRespF$enq_1__SEL_2 ;

  // submodule dcp_dcpReqF
  always@(IF_rxDCPMesgPos_10_EQ_5_51_THEN_rxDCPMesg_17_B_ETC___d602 or
	  tag__h62212 or rxDCPMesg)
  begin
    case (IF_rxDCPMesgPos_10_EQ_5_51_THEN_rxDCPMesg_17_B_ETC___d602[7:4])
      4'd0:
	  dcp_dcpReqF$D_IN = { 38'h0AAAAAAAAA, tag__h62212, rxDCPMesg[31:0] };
      4'd1:
	  dcp_dcpReqF$D_IN =
	      { 2'd1,
		IF_rxDCPMesgPos_10_EQ_5_51_THEN_rxDCPMesg_17_B_ETC___d602[3:0],
		tag__h62212,
		rxDCPMesg[31:0],
		rxDCPMesg[63:32] };
  ...
  assign dcp_dcpReqF$ENQ =
	     WILL_FIRE_RL_rx_dcp &&
	     (IF_rxDCPMesgPos_10_EQ_5_51_THEN_rxDCPMesg_17_B_ETC___d602[7:4] ==
	      4'd0 ||
	      IF_rxDCPMesgPos_10_EQ_5_51_THEN_rxDCPMesg_17_B_ETC___d602[7:4] ==
	      4'd1 ||
	      IF_rxDCPMesgPos_10_EQ_5_51_THEN_rxDCPMesg_17_B_ETC___d602[7:4] ==
  ...
  // remaining internal signals
  assign IF_dcp_dcpReqF_first__29_BITS_77_TO_76_30_EQ_0_ETC___d140 =
	     (dcp_dcpReqF$D_OUT[77:76] == 2'd0) ?
	       dcp_dcpRespF$FULL_N :
	       (dcp_dcpReqF$D_OUT[77:76] == 2'd1 || dcp_cpReqF$sFULL_N) &&
	       (dcp_dcpReqF$D_OUT[77:76] != 2'd1 ||
		dcp_cpReqF$sFULL_N && dcp_dcpRespF$FULL_N) ;
  assign IF_rxHdr_pos_09_EQ_0_25_THEN_rxHdr_sV_92_BITS__ETC___d294 =
	     CASE_rxHdr_pos_rxHdr_sV_BITS_111_TO_104_0_rxHd_ETC__q1 ==
	     CASE_rxHdr_pos_rxHdr_pV_BITS_111_TO_104_0_rxHd_ETC__q2 ;
  assign IF_txDCPPos_47_EQ_9_65_THEN_0_ELSE_txDCPPos_47_ETC___d665 =
	     (txDCPPos == 5'd9) ? 5'd0 : txDCPPos_47_PLUS_1___d623 ;
  assign NOT_rxHdr_sV_92_BIT_112_93_09_AND_rxHdr_sV_92__ETC___d315 =
	     !rxHdr_sV[112] && rxHdr_sV[15:0] == 16'hF040 &&
	     { 3'd0, rxDCPMesgPos } < rxDCPPLI ;
  assign NOT_rxHdr_sV_92_BIT_112_93_09_AND_rxHdr_sV_92__ETC___d502 =
	     !rxHdr_sV[112] && rxHdr_sV[15:0] == 16'hF040 ||
  ...
  assign dcpRespF_i_notEmpty__43_AND_IF_dcpRespF_first__ETC___d479 =
	     dcpRespF$EMPTY_N &&
	     CASE_dcpRespFD_OUT_BITS_43_TO_42_IF_txDCPPos__ETC__q3 ;
  assign gmac_rx_get_03_BITS_9_TO_8_04_EQ_0_05_OR_gmac__ETC___d297 =
	     (gmac$rx_get[9:8] == 2'd0 || gmac$rx_get[9:8] == 2'd1) &&
	     rxHdr_sV[112] &&
	     !rxHdr_pV[112] &&
	     IF_rxHdr_pos_09_EQ_0_25_THEN_rxHdr_sV_92_BITS__ETC___d294 ;
  ...
  assign rxHdr_sV_92_BIT_112_93_OR_NOT_rxHdr_sV_92_BITS_ETC___d581 =
	     (rxHdr_sV[112] || rxHdr_sV[15:0] != 16'hF040) &&
	     (dcpRespF$D_OUT[43:42] == 2'd0 && txDCPPos == 5'd9 ||
	      dcpRespF$D_OUT[43:42] != 2'd0 &&
	      (dcpRespF$D_OUT[43:42] == 2'd1 && txDCPPos == 5'd5 ||
	       dcpRespF$D_OUT[43:42] != 2'd1 && txDCPPos == 5'd9)) ;
  assign txDCPPos_47_PLUS_1___d623 = txDCPPos + 5'd1 ;
  assign x__h62002 = rxLenCount + 32'd1 ;
  ...
  begin
    case (rxDCPMesgPos)
      5'd6: tag__h62212 = rxDCPMesg[7:0];
      5'd7: tag__h62212 = rxDCPMesg[15:8];
      5'd8: tag__h62212 = rxDCPMesg[23:16];
      5'd9: tag__h62212 = rxDCPMesg[31:24];
      5'd10: tag__h62212 = rxDCPMesg[39:32];
      5'd11: tag__h62212 = rxDCPMesg[47:40];
      5'd12: tag__h62212 = rxDCPMesg[55:48];
      5'd13: tag__h62212 = rxDCPMesg[63:56];
      5'd14: tag__h62212 = rxDCPMesg[71:64];
      5'd15: tag__h62212 = rxDCPMesg[79:72];
      5'd16: tag__h62212 = rxDCPMesg[87:80];
      5'd17: tag__h62212 = rxDCPMesg[95:88];
      5'd18: tag__h62212 = rxDCPMesg[103:96];
      default: tag__h62212 = rxDCPMesg[111:104];
    endcase
  end
  ...
  begin
    case (txDCPPos)
	  ...
	  IF_txDCPPos_47_EQ_0_48_OR_txDCPPos_47_EQ_1_49__ETC___d673 =
	      gmac$RDY_tx_put;
      default: IF_txDCPPos_47_EQ_0_48_OR_txDCPPos_47_EQ_1_49__ETC___d673 =
		   txDCPPos != 5'd9 || gmac$RDY_tx_put;
    endcase
  end
  always@(dcpRespF$D_OUT or
	  IF_txDCPPos_47_EQ_0_48_OR_txDCPPos_47_EQ_1_49__ETC___d673 or
  ...
  begin
    case (rxDCPMesgPos)
	  ...
	  IF_rxDCPMesgPos_10_EQ_5_51_THEN_rxDCPMesg_17_B_ETC___d602 =
	      rxDCPMesg[103:96];
      default: IF_rxDCPMesgPos_10_EQ_5_51_THEN_rxDCPMesg_17_B_ETC___d602 =
		   rxDCPMesg[111:104];
    endcase
  end
  ...
  begin
    case (txDCPPos)
      5'd0, 5'd2, 5'd3:
	  IF_txDCPPos_47_EQ_0_48_THEN_0_ELSE_IF_txDCPPos_ETC___d677 = 10'd0;
      5'd1:
	  IF_txDCPPos_47_EQ_0_48_THEN_0_ELSE_IF_txDCPPos_ETC___d677 = 10'd10;
      5'd4:
	  IF_txDCPPos_47_EQ_0_48_THEN_0_ELSE_IF_txDCPPos_ETC___d677 = 10'd48;
      5'd5:
	  IF_txDCPPos_47_EQ_0_48_THEN_0_ELSE_IF_txDCPPos_ETC___d677 =
      ...
      default: IF_txDCPPos_47_EQ_0_48_THEN_0_ELSE_IF_txDCPPos_ETC___d677 =
  ...
  begin
    case (IF_rxDCPMesgPos_10_EQ_5_51_THEN_rxDCPMesg_17_B_ETC___d602[7:4])
	  ...
	  CASE_IF_rxDCPMesgPos_10_EQ_5_51_THEN_rxDCPMesg_ETC__q4 =
	      dcp_dcpReqF$FULL_N;
      default: CASE_IF_rxDCPMesgPos_10_EQ_5_51_THEN_rxDCPMesg_ETC__q4 =
		   IF_rxDCPMesgPos_10_EQ_5_51_THEN_rxDCPMesg_17_B_ETC___d602[7:4] !=
		   4'd2 ||
		   dcp_dcpReqF$FULL_N;
    endcase
  ...
  always@(dcpRespF$D_OUT or
	  IF_txDCPPos_47_EQ_0_48_THEN_0_ELSE_IF_txDCPPos_ETC___d677 or
	  txDCPPos)
  begin
    case (dcpRespF$D_OUT[43:42])
      2'd0:
  ...
  always@(dcpRespF$D_OUT or
	  IF_txDCPPos_47_EQ_9_65_THEN_0_ELSE_txDCPPos_47_ETC___d665 or
	  txDCPPos or txDCPPos_47_PLUS_1___d623)
  begin
    case (dcpRespF$D_OUT[43:42])
      2'd0:
	  CASE_dcpRespFD_OUT_BITS_43_TO_42_IF_txDCPPos__ETC__q9 =
	      IF_txDCPPos_47_EQ_9_65_THEN_0_ELSE_txDCPPos_47_ETC___d665;
      2'd1:
	  CASE_dcpRespFD_OUT_BITS_43_TO_42_IF_txDCPPos__ETC__q9 =
	      (txDCPPos == 5'd5) ? 5'd0 : txDCPPos_47_PLUS_1___d623;
