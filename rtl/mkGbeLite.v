...
//
// On Sun May  6 09:50:59 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkGbeLite(CLK_gmii_rx_clk,
  ...
  // register rxLenCount
  assign rxLenCount$D_IN = (gmac$rx_get[9:8] == 2'd0) ? x__h61799 : 32'd0 ;
  assign rxLenCount$EN = WILL_FIRE_RL_rx_data ;

  // register rxLenLast
  assign rxLenLast$D_IN = x__h61799 ;
  ...
  always@(IF_rxDCPMesgPos_01_EQ_5_42_THEN_rxDCPMesg_08_B_ETC___d595 or
	  tag__h62009 or rxDCPMesg)
  begin
    case (IF_rxDCPMesgPos_01_EQ_5_42_THEN_rxDCPMesg_08_B_ETC___d595[7:4])
      4'd0:
	  dcp_dcpReqF$D_IN = { 38'h0AAAAAAAAA, tag__h62009, rxDCPMesg[31:0] };
      4'd1:
	  dcp_dcpReqF$D_IN =
	      { 2'd1,
  ...
  assign x__h61799 = rxLenCount + 32'd1 ;
  ...
  begin
    case (rxDCPMesgPos)
      5'd6: tag__h62009 = rxDCPMesg[7:0];
      5'd7: tag__h62009 = rxDCPMesg[15:8];
      5'd8: tag__h62009 = rxDCPMesg[23:16];
      5'd9: tag__h62009 = rxDCPMesg[31:24];
      5'd10: tag__h62009 = rxDCPMesg[39:32];
      5'd11: tag__h62009 = rxDCPMesg[47:40];
      5'd12: tag__h62009 = rxDCPMesg[55:48];
      5'd13: tag__h62009 = rxDCPMesg[63:56];
      5'd14: tag__h62009 = rxDCPMesg[71:64];
      5'd15: tag__h62009 = rxDCPMesg[79:72];
      5'd16: tag__h62009 = rxDCPMesg[87:80];
      5'd17: tag__h62009 = rxDCPMesg[95:88];
      5'd18: tag__h62009 = rxDCPMesg[103:96];
      default: tag__h62009 = rxDCPMesg[111:104];
    endcase
  end
