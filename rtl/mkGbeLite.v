...
//
// On Tue Jun 19 09:58:46 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkGbeLite(CLK_gmii_rx_clk,
  ...
  reg [9 : 0] CASE_dcpRespFD_OUT_BITS_43_TO_42_IF_txDCPPos__ETC__q7,
	      IF_txDCPPos_02_EQ_0_03_THEN_0_ELSE_IF_txDCPPos_ETC___d746;
  reg [7 : 0] CASE_13_MINUS_txDCPPos_rxHdr_sV_BITS_63_TO_56__ETC__q6,
	      ...
	      IF_rxDCPMesgPos_62_EQ_5_05_THEN_rxDCPMesg_70_B_ETC___d657,
	      tag__h63526;
  reg [4 : 0] CASE_dcpRespFD_OUT_BITS_43_TO_42_IF_txDCPPos__ETC__q9;
  reg [1 : 0] CASE_dcp_dcp_dcpRespFD_OUT_BITS_43_TO_42_2_0__ETC__q5;
  reg CASE_IF_rxDCPMesgPos_62_EQ_5_05_THEN_rxDCPMesg_ETC__q4,
      CASE_dcpRespFD_OUT_BITS_43_TO_42_IF_txDCPPos__ETC__q3,
      IF_txDCPPos_02_EQ_0_03_OR_txDCPPos_02_EQ_1_04__ETC___d740;
  wire [194 : 0] _1434766110945527031733894725304609466537681244_ETC__q8,
		 _643371375338640__q10,
		 bs__h14908,
		 bs__h2383;
  wire [31 : 0] x__h63291;
  wire [15 : 0] x_data__h18106;
  wire [4 : 0] IF_txDCPPos_02_EQ_9_20_THEN_0_ELSE_txDCPPos_02_ETC___d730,
	       txDCPPos_02_PLUS_1___d683;
  wire [2 : 0] d0__h2009,
	       d10__h1999,
	       d11__h1998,
	       d12__h1997,
  ...
  wire IF_dcp_dcp_dcpReqF_first__29_BITS_77_TO_76_30__ETC___d153,
       ...
       IF_rxHdr_pos_60_EQ_0_76_THEN_rxHdr_sV_35_BITS__ETC___d345,
       NOT_rxHdr_sV_35_BIT_112_36_60_AND_rxHdr_sV_35__ETC___d375,
       NOT_rxHdr_sV_35_BIT_112_36_60_AND_rxHdr_sV_35__ETC___d557,
       dcpRespF_i_notEmpty__98_AND_IF_dcpRespF_first__ETC___d534,
       dcp_dcp_dcpReqF_first__29_BITS_39_TO_32_34_EQ__ETC___d737,
       dcp_dcp_dcpReqF_first__29_BITS_71_TO_64_45_EQ__ETC___d738,
       dcp_dcp_dcpReqF_first__29_BITS_77_TO_76_30_EQ__ETC___d177,
       dcp_dcp_dcpRespF_i_notFull__32_AND_dcp_dcp_dcp_ETC___d150,
       gmac_rx_get_54_BITS_9_TO_8_55_EQ_0_56_OR_gmac__ETC___d348,
       gmac_rx_get_54_BITS_9_TO_8_55_EQ_0_56_OR_gmac__ETC___d369,
       rxHdr_sV_35_BITS_111_TO_64_40_EQ_0xFFFFFFFFFFF_ETC___d366,
       rxHdr_sV_35_BITS_111_TO_64_40_EQ_macAddress_43___d244,
       rxHdr_sV_35_BIT_112_36_OR_NOT_rxHdr_sV_35_BITS_ETC___d636;
  ...
  assign WILL_FIRE_RL_rx_dcp =
	     rxDCPHdrF$EMPTY_N &&
	     CASE_IF_rxDCPMesgPos_62_EQ_5_05_THEN_rxDCPMesg_ETC__q4 &&
	     !WILL_FIRE_RL_rx_data ;
  ...
  assign mdi_rMDC$D_IN =
	     _1434766110945527031733894725304609466537681244_ETC__q8[mdi_rPlayIndex$Q_OUT] ;
  assign mdi_rMDC$EN = WILL_FIRE_RL_mdi_run_frame ;

  // register mdi_rMDD
  assign mdi_rMDD$D_IN = bs__h2383[mdi_rPlayIndex$Q_OUT] ;
  assign mdi_rMDD$EN = WILL_FIRE_RL_mdi_run_frame ;

  // register mdi_rOutEn
  assign mdi_rOutEn$D_IN = bs__h14908[mdi_rPlayIndex$Q_OUT] ;
  ...
  // register rxLenCount
  assign rxLenCount$D_IN = (gmac$rx_get[9:8] == 2'd0) ? x__h63291 : 32'd0 ;
  assign rxLenCount$EN = WILL_FIRE_RL_rx_data ;

  // register rxLenLast
  assign rxLenLast$D_IN = x__h63291 ;
  ...
  assign txDCPPos$D_IN =
	     (!rxHdr_sV[112] && rxHdr_sV[15:0] == 16'hF040) ?
	       ((txDCPPos == 5'd13) ? 5'd0 : txDCPPos_02_PLUS_1___d683) :
  ...
  assign dcpRespF$D_IN =
	     { CASE_dcp_dcp_dcpRespFD_OUT_BITS_43_TO_42_2_0__ETC__q5,
  ...
  // submodule dcp_dcp_dcpReqF
  always@(IF_rxDCPMesgPos_62_EQ_5_05_THEN_rxDCPMesg_70_B_ETC___d657 or
	  tag__h63526 or rxDCPMesg)
  begin
    case (IF_rxDCPMesgPos_62_EQ_5_05_THEN_rxDCPMesg_70_B_ETC___d657[7:4])
      4'd0:
	  dcp_dcp_dcpReqF$D_IN =
	      { 38'h0AAAAAAAAA, tag__h63526, rxDCPMesg[31:0] };
      4'd1:
	  dcp_dcp_dcpReqF$D_IN =
	      { 2'd1,
		IF_rxDCPMesgPos_62_EQ_5_05_THEN_rxDCPMesg_70_B_ETC___d657[3:0],
		tag__h63526,
		rxDCPMesg[31:0],
		rxDCPMesg[63:32] };
  ...
  assign dcp_dcp_dcpReqF$ENQ =
	     WILL_FIRE_RL_rx_dcp &&
	     (IF_rxDCPMesgPos_62_EQ_5_05_THEN_rxDCPMesg_70_B_ETC___d657[7:4] ==
	      4'd0 ||
	      IF_rxDCPMesgPos_62_EQ_5_05_THEN_rxDCPMesg_70_B_ETC___d657[7:4] ==
	      4'd1 ||
	      IF_rxDCPMesgPos_62_EQ_5_05_THEN_rxDCPMesg_70_B_ETC___d657[7:4] ==
  ...
  // submodule mdi_fResponse
  assign mdi_fResponse$D_IN = { 1'd1, x_data__h18106 } ;
  ...
  assign IF_rxHdr_pos_60_EQ_0_76_THEN_rxHdr_sV_35_BITS__ETC___d345 =
	     CASE_rxHdr_pos_rxHdr_sV_BITS_111_TO_104_0_rxHd_ETC__q1 ==
	     CASE_rxHdr_pos_rxHdr_pV_BITS_111_TO_104_0_rxHd_ETC__q2 ;
  assign IF_txDCPPos_02_EQ_9_20_THEN_0_ELSE_txDCPPos_02_ETC___d730 =
	     (txDCPPos == 5'd9) ? 5'd0 : txDCPPos_02_PLUS_1___d683 ;
  assign NOT_rxHdr_sV_35_BIT_112_36_60_AND_rxHdr_sV_35__ETC___d375 =
	     !rxHdr_sV[112] && rxHdr_sV[15:0] == 16'hF040 &&
	     rxHdr_sV_35_BITS_111_TO_64_40_EQ_0xFFFFFFFFFFF_ETC___d366 &&
	     rxDCPMesgPos == 5'd1 ;
  assign NOT_rxHdr_sV_35_BIT_112_36_60_AND_rxHdr_sV_35__ETC___d557 =
	     !rxHdr_sV[112] && rxHdr_sV[15:0] == 16'hF040 ||
	     ...
	     (dcpRespF$D_OUT[43:42] == 2'd1 &&
	      ...
	      (txDCPPos == 5'd0 || txDCPPos == 5'd1 || txDCPPos == 5'd2 ||
	       ...
	       txDCPPos == 5'd8 ||
	       txDCPPos == 5'd9)) ;
  assign _1434766110945527031733894725304609466537681244_ETC__q8 =
  ...
  assign bs__h2383 =
		 ...
		 108'hFFFFFFFFFFFFFFFFFFFFFFFF1F8,
	       ...
	       d0__h2009,
	       3'b111 } ;
  assign d0__h2009 = {3{mdi_rWriteData[0]}} ;
  assign d10__h1999 = {3{mdi_rWriteData[10]}} ;
  assign d11__h1998 = {3{mdi_rWriteData[11]}} ;
  assign d12__h1997 = {3{mdi_rWriteData[12]}} ;
  assign d13__h1996 = {3{mdi_rWriteData[13]}} ;
  assign d14__h1995 = {3{mdi_rWriteData[14]}} ;
  assign d15__h1994 = {3{mdi_rWriteData[15]}} ;
  assign d1__h2008 = {3{mdi_rWriteData[1]}} ;
  assign d2__h2007 = {3{mdi_rWriteData[2]}} ;
  assign d3__h2006 = {3{mdi_rWriteData[3]}} ;
  assign d4__h2005 = {3{mdi_rWriteData[4]}} ;
  assign d5__h2004 = {3{mdi_rWriteData[5]}} ;
  assign d6__h2003 = {3{mdi_rWriteData[6]}} ;
  assign d7__h2002 = {3{mdi_rWriteData[7]}} ;
  assign d8__h2001 = {3{mdi_rWriteData[8]}} ;
  assign d9__h2000 = {3{mdi_rWriteData[9]}} ;
  assign dcpRespF_i_notEmpty__98_AND_IF_dcpRespF_first__ETC___d534 =
	     dcpRespF$EMPTY_N &&
	     CASE_dcpRespFD_OUT_BITS_43_TO_42_IF_txDCPPos__ETC__q3 ;
  assign dcp_dcp_dcpReqF_first__29_BITS_39_TO_32_34_EQ__ETC___d737 =
	     dcp_dcp_dcpReqF$D_OUT[39:32] == dcp_dcp_lastTag[7:0] ;
  assign dcp_dcp_dcpReqF_first__29_BITS_71_TO_64_45_EQ__ETC___d738 =
  ...
  assign dcp_dcp_dcpRespF_i_notFull__32_AND_dcp_dcp_dcp_ETC___d150 =
	     ...
	     (dcp_dcp_dcpReqF_first__29_BITS_71_TO_64_45_EQ__ETC___d738 &&
	      dcp_dcp_lastTag[8] ||
	      dcp_dcp_cpReqF$FULL_N) ;
  assign gmac_rx_get_54_BITS_9_TO_8_55_EQ_0_56_OR_gmac__ETC___d348 =
	     (gmac$rx_get[9:8] == 2'd0 || gmac$rx_get[9:8] == 2'd1) &&
	     rxHdr_sV[112] &&
	     !rxHdr_pV[112] &&
	     IF_rxHdr_pos_60_EQ_0_76_THEN_rxHdr_sV_35_BITS__ETC___d345 ;
  assign gmac_rx_get_54_BITS_9_TO_8_55_EQ_0_56_OR_gmac__ETC___d369 =
	     (gmac$rx_get[9:8] == 2'd0 || gmac$rx_get[9:8] == 2'd1) &&
	     !rxHdr_sV[112] &&
	     rxHdr_sV[15:0] == 16'hF040 &&
	     rxHdr_sV_35_BITS_111_TO_64_40_EQ_0xFFFFFFFFFFF_ETC___d366 ;
  assign pa0__h1986 = {3{mdi_rPhyAddr[0]}} ;
  assign pa1__h1985 = {3{mdi_rPhyAddr[1]}} ;
  assign pa2__h1984 = {3{mdi_rPhyAddr[2]}} ;
  assign pa3__h1983 = {3{mdi_rPhyAddr[3]}} ;
  assign pa4__h1982 = {3{mdi_rPhyAddr[4]}} ;
  assign ra0__h1992 = {3{mdi_rRegAddr[0]}} ;
  assign ra1__h1991 = {3{mdi_rRegAddr[1]}} ;
  assign ra2__h1990 = {3{mdi_rRegAddr[2]}} ;
  assign ra3__h1989 = {3{mdi_rRegAddr[3]}} ;
  assign ra4__h1988 = {3{mdi_rRegAddr[4]}} ;
  assign rxHdr_sV_35_BITS_111_TO_64_40_EQ_0xFFFFFFFFFFF_ETC___d366 =
	     (rxHdr_sV[111:64] == 48'hFFFFFFFFFFFF ||
	      rxHdr_sV_35_BITS_111_TO_64_40_EQ_macAddress_43___d244) &&
	     { 3'd0, rxDCPMesgPos } < rxDCPPLI ;
  assign rxHdr_sV_35_BITS_111_TO_64_40_EQ_macAddress_43___d244 =
	     rxHdr_sV[111:64] == macAddress ;
  assign rxHdr_sV_35_BIT_112_36_OR_NOT_rxHdr_sV_35_BITS_ETC___d636 =
	     (rxHdr_sV[112] || rxHdr_sV[15:0] != 16'hF040) &&
	     (dcpRespF$D_OUT[43:42] == 2'd0 && txDCPPos == 5'd9 ||
	      dcpRespF$D_OUT[43:42] != 2'd0 &&
	      (dcpRespF$D_OUT[43:42] == 2'd1 && txDCPPos == 5'd5 ||
	       dcpRespF$D_OUT[43:42] != 2'd1 && txDCPPos == 5'd9)) ;
  assign txDCPPos_02_PLUS_1___d683 = txDCPPos + 5'd1 ;
  assign x__h63291 = rxLenCount + 32'd1 ;
  assign x_data__h18106 =
	     { mdi_vrReadData_15,
	       mdi_vrReadData_14,
	       mdi_vrReadData_13,
	       mdi_vrReadData_12,
  ...
  begin
    case (rxDCPMesgPos)
      5'd6: tag__h63526 = rxDCPMesg[7:0];
      5'd7: tag__h63526 = rxDCPMesg[15:8];
      5'd8: tag__h63526 = rxDCPMesg[23:16];
      5'd9: tag__h63526 = rxDCPMesg[31:24];
      5'd10: tag__h63526 = rxDCPMesg[39:32];
      5'd11: tag__h63526 = rxDCPMesg[47:40];
      5'd12: tag__h63526 = rxDCPMesg[55:48];
      5'd13: tag__h63526 = rxDCPMesg[63:56];
      5'd14: tag__h63526 = rxDCPMesg[71:64];
      5'd15: tag__h63526 = rxDCPMesg[79:72];
      5'd16: tag__h63526 = rxDCPMesg[87:80];
      5'd17: tag__h63526 = rxDCPMesg[95:88];
      5'd18: tag__h63526 = rxDCPMesg[103:96];
      default: tag__h63526 = rxDCPMesg[111:104];
    endcase
  end
  ...
  begin
    case (txDCPPos)
	  ...
	  IF_txDCPPos_02_EQ_0_03_OR_txDCPPos_02_EQ_1_04__ETC___d740 =
	      gmac$RDY_tx_put;
      default: IF_txDCPPos_02_EQ_0_03_OR_txDCPPos_02_EQ_1_04__ETC___d740 =
		   txDCPPos != 5'd9 || gmac$RDY_tx_put;
    endcase
  end
  always@(dcpRespF$D_OUT or
	  IF_txDCPPos_02_EQ_0_03_OR_txDCPPos_02_EQ_1_04__ETC___d740 or
  ...
  begin
    case (rxDCPMesgPos)
	  ...
	  IF_rxDCPMesgPos_62_EQ_5_05_THEN_rxDCPMesg_70_B_ETC___d657 =
	      rxDCPMesg[103:96];
      default: IF_rxDCPMesgPos_62_EQ_5_05_THEN_rxDCPMesg_70_B_ETC___d657 =
		   rxDCPMesg[111:104];
    endcase
  end
  ...
  begin
    case (txDCPPos)
      5'd0, 5'd2, 5'd3:
	  IF_txDCPPos_02_EQ_0_03_THEN_0_ELSE_IF_txDCPPos_ETC___d746 = 10'd0;
      5'd1:
	  IF_txDCPPos_02_EQ_0_03_THEN_0_ELSE_IF_txDCPPos_ETC___d746 = 10'd10;
      5'd4:
	  IF_txDCPPos_02_EQ_0_03_THEN_0_ELSE_IF_txDCPPos_ETC___d746 = 10'd48;
      5'd5:
	  IF_txDCPPos_02_EQ_0_03_THEN_0_ELSE_IF_txDCPPos_ETC___d746 =
      ...
      default: IF_txDCPPos_02_EQ_0_03_THEN_0_ELSE_IF_txDCPPos_ETC___d746 =
  ...
  begin
    case (IF_rxDCPMesgPos_62_EQ_5_05_THEN_rxDCPMesg_70_B_ETC___d657[7:4])
	  ...
	  CASE_IF_rxDCPMesgPos_62_EQ_5_05_THEN_rxDCPMesg_ETC__q4 =
	      dcp_dcp_dcpReqF$FULL_N;
      default: CASE_IF_rxDCPMesgPos_62_EQ_5_05_THEN_rxDCPMesg_ETC__q4 =
		   IF_rxDCPMesgPos_62_EQ_5_05_THEN_rxDCPMesg_70_B_ETC___d657[7:4] !=
		   4'd2 ||
		   dcp_dcp_dcpReqF$FULL_N;
    endcase
  ...
  begin
    case (dcp_dcp_dcpRespF$D_OUT[43:42])
      ...
      default: CASE_dcp_dcp_dcpRespFD_OUT_BITS_43_TO_42_2_0__ETC__q5 = 2'd2;
    endcase
  end
  ...
  always@(dcpRespF$D_OUT or
	  IF_txDCPPos_02_EQ_0_03_THEN_0_ELSE_IF_txDCPPos_ETC___d746 or
	  txDCPPos)
  begin
    case (dcpRespF$D_OUT[43:42])
      2'd0:
  ...
  always@(dcpRespF$D_OUT or
	  IF_txDCPPos_02_EQ_9_20_THEN_0_ELSE_txDCPPos_02_ETC___d730 or
	  txDCPPos or txDCPPos_02_PLUS_1___d683)
  begin
    case (dcpRespF$D_OUT[43:42])
      2'd0:
	  CASE_dcpRespFD_OUT_BITS_43_TO_42_IF_txDCPPos__ETC__q9 =
	      IF_txDCPPos_02_EQ_9_20_THEN_0_ELSE_txDCPPos_02_ETC___d730;
      2'd1:
	  CASE_dcpRespFD_OUT_BITS_43_TO_42_IF_txDCPPos__ETC__q9 =
	      (txDCPPos == 5'd5) ? 5'd0 : txDCPPos_02_PLUS_1___d683;
