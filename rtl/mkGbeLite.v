...
//
// On Fri Aug 24 09:03:03 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkGbeLite(CLK_gmii_rx_clk,
  ...
  reg [9 : 0] CASE_dcpRespFD_OUT_BITS_44_TO_43_IF_txDCPPos__ETC__q19,
	      IF_txDCPPos_19_EQ_0_20_THEN_0_ELSE_IF_txDCPPos_ETC___d911;
  ...
  reg CASE_dcpRespFD_OUT_BITS_44_TO_43_IF_txDCPPos__ETC__q4,
      ...
      IF_txDCPPos_19_EQ_0_20_OR_txDCPPos_19_EQ_1_21__ETC___d920;
  ...
  wire [7 : 0] IF_merge_fi0HasPrio_50_THEN_merge_fi0_first__2_ETC___d924;
  wire [4 : 0] IF_txDCPPos_19_EQ_9_37_THEN_0_ELSE_txDCPPos_19_ETC___d1046,
	       txDCPPos_19_PLUS_1___d982;
  wire [2 : 0] d0__h2011,
	       d10__h2001,
	       d11__h2000,
	       d12__h1999,
  ...
  wire IF_dcp_dcp_dcpReqF_first__29_BITS_78_TO_77_30__ETC___d160,
       ...
       dcp_dcp_dcpReqF_first__29_BITS_39_TO_32_34_EQ__ETC___d901,
       dcp_dcp_dcpReqF_first__29_BITS_71_TO_64_47_EQ__ETC___d902,
  ...
  assign MUX_merge_fo$enq_1__VAL_3 =
		...
		merge_fi1$D_OUT[9:8] == 2'd0) ?
	       { 2'd0,
		 IF_merge_fi0HasPrio_50_THEN_merge_fi0_first__2_ETC___d924 } :
  ...
  assign txDCPPos$D_IN =
	     (!rxHdr_sV[112] && rxHdr_sV[15:0] == 16'hF040) ?
	       ((txDCPPos == 5'd13) ? 5'd0 : txDCPPos_19_PLUS_1___d982) :
  ...
  assign IF_merge_fi0HasPrio_50_THEN_merge_fi0_first__2_ETC___d924 =
	     merge_fi0HasPrio ? merge_fi0$D_OUT[7:0] : merge_fi1$D_OUT[7:0] ;
  assign IF_rxHdr_pos_22_EQ_0_38_THEN_rxHdr_sV_98_BITS__ETC___d607 =
	     CASE_rxHdr_pos_rxHdr_sV_BITS_111_TO_104_0_rxHd_ETC__q2 ==
	     CASE_rxHdr_pos_rxHdr_pV_BITS_111_TO_104_0_rxHd_ETC__q3 ;
  assign IF_txDCPPos_19_EQ_9_37_THEN_0_ELSE_txDCPPos_19_ETC___d1046 =
	     (txDCPPos == 5'd9) ? 5'd0 : txDCPPos_19_PLUS_1___d982 ;
  ...
  assign dcp_dcp_dcpReqF_first__29_BITS_39_TO_32_34_EQ__ETC___d901 =
	     dcp_dcp_dcpReqF$D_OUT[39:32] == dcp_dcp_lastTag[7:0] ;
  assign dcp_dcp_dcpReqF_first__29_BITS_71_TO_64_47_EQ__ETC___d902 =
  ...
  assign txDCPPos_19_PLUS_1___d982 = txDCPPos + 5'd1 ;
  ...
  begin
    case (txDCPPos)
	  ...
	  IF_txDCPPos_19_EQ_0_20_OR_txDCPPos_19_EQ_1_21__ETC___d920 =
	      merge_fi0$FULL_N;
      default: IF_txDCPPos_19_EQ_0_20_OR_txDCPPos_19_EQ_1_21__ETC___d920 =
		   txDCPPos != 5'd9 || merge_fi0$FULL_N;
    endcase
  end
  always@(dcpRespF$D_OUT or
	  IF_txDCPPos_19_EQ_0_20_OR_txDCPPos_19_EQ_1_21__ETC___d920 or
  ...
  begin
    case (txDCPPos)
      5'd0, 5'd2, 5'd3:
	  IF_txDCPPos_19_EQ_0_20_THEN_0_ELSE_IF_txDCPPos_ETC___d911 = 10'd0;
      5'd1:
	  IF_txDCPPos_19_EQ_0_20_THEN_0_ELSE_IF_txDCPPos_ETC___d911 = 10'd10;
      5'd4:
	  IF_txDCPPos_19_EQ_0_20_THEN_0_ELSE_IF_txDCPPos_ETC___d911 =
      ...
      default: IF_txDCPPos_19_EQ_0_20_THEN_0_ELSE_IF_txDCPPos_ETC___d911 =
  ...
  always@(dcpRespF$D_OUT or
	  IF_txDCPPos_19_EQ_0_20_THEN_0_ELSE_IF_txDCPPos_ETC___d911 or
	  txDCPPos)
  begin
    case (dcpRespF$D_OUT[44:43])
      2'd0:
  ...
  always@(dcpRespF$D_OUT or
	  IF_txDCPPos_19_EQ_9_37_THEN_0_ELSE_txDCPPos_19_ETC___d1046 or
	  txDCPPos or txDCPPos_19_PLUS_1___d982)
  begin
    case (dcpRespF$D_OUT[44:43])
      2'd0:
	  CASE_dcpRespFD_OUT_BITS_44_TO_43_IF_txDCPPos__ETC__q20 =
	      IF_txDCPPos_19_EQ_9_37_THEN_0_ELSE_txDCPPos_19_ETC___d1046;
      2'd1:
	  CASE_dcpRespFD_OUT_BITS_44_TO_43_IF_txDCPPos__ETC__q20 =
	      (txDCPPos == 5'd5) ? 5'd0 : txDCPPos_19_PLUS_1___d982;
