...
//
// On Thu Aug 23 14:48:06 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkGbeLite(CLK_gmii_rx_clk,
  ...
  wire merge_fi1$CLR, merge_fi1$DEQ, merge_fi1$EMPTY_N, merge_fi1$ENQ;
  ...
  reg [9 : 0] CASE_dcpRespFD_OUT_BITS_44_TO_43_IF_txDCPPos__ETC__q19,
	      IF_txDCPPos_19_EQ_0_20_THEN_0_ELSE_IF_txDCPPos_ETC___d1063;
  ...
  reg [4 : 0] CASE_dcpRespFD_OUT_BITS_44_TO_43_IF_txDCPPos__ETC__q20;
  ...
  reg CASE_dcpRespFD_OUT_BITS_44_TO_43_IF_txDCPPos__ETC__q4,
      ...
      IF_txDCPPos_19_EQ_0_20_OR_txDCPPos_19_EQ_1_21__ETC___d1052;
  wire [194 : 0] _1434766110945527031733894725304609466537681244_ETC__q17,
		 _643371375338640__q21,
		 bs__h14910,
		 bs__h2385;
  wire [31 : 0] x__h103612;
  wire [15 : 0] x_data__h18108;
  wire [9 : 0] IF_IF_merge_fi0HasPrio_50_THEN_merge_fi0_first_ETC___d468;
  wire [7 : 0] IF_merge_fi0HasPrio_50_THEN_merge_fi0_first__2_ETC___d905;
  wire [4 : 0] IF_txDCPPos_19_EQ_9_37_THEN_0_ELSE_txDCPPos_19_ETC___d1027,
	       txDCPPos_19_PLUS_1___d963;
  wire [2 : 0] d0__h2011,
	       d10__h2001,
	       d11__h2000,
	       d12__h1999,
  ...
  wire IF_dcp_dcp_dcpReqF_first__29_BITS_78_TO_77_30__ETC___d160,
       ...
       dcp_dcp_dcpReqF_first__29_BITS_39_TO_32_34_EQ__ETC___d1039,
       dcp_dcp_dcpReqF_first__29_BITS_71_TO_64_47_EQ__ETC___d1040,
  ...
  assign MUX_merge_fo$enq_1__VAL_3 =
		...
		merge_fi1$D_OUT[9:8] == 2'd0) ?
	       { 2'd0,
		 IF_merge_fi0HasPrio_50_THEN_merge_fi0_first__2_ETC___d905 } :
  ...
  assign mdi_vrReadData$EN =
	     WILL_FIRE_RL_mdi_run_frame && mdi_rPlayIndex$Q_OUT != 8'd0 &&
	     !mdi_rWrite &&
	     _643371375338640__q21[mdi_rPlayIndex$Q_OUT] ;
  ...
  // register rxLenCount
  assign rxLenCount$D_IN = (gmac$rx_get[9:8] == 2'd0) ? x__h103612 : 32'd0 ;
  assign rxLenCount$EN = WILL_FIRE_RL_rx_data ;

  // register rxLenLast
  assign rxLenLast$D_IN = x__h103612 ;
  ...
  assign txDCPPos$D_IN =
	     (!rxHdr_sV[112] && rxHdr_sV[15:0] == 16'hF040) ?
	       ((txDCPPos == 5'd13) ? 5'd0 : txDCPPos_19_PLUS_1___d963) :
	       CASE_dcpRespFD_OUT_BITS_44_TO_43_IF_txDCPPos__ETC__q20 ;
  assign txDCPPos$EN = WILL_FIRE_RL_tx_dcp ;

  // register txEgressCnt
  assign txEgressCnt$D_IN = txEgressCnt + 32'd1 ;
  assign txEgressCnt$EN = edp_edp_edpRespF$EMPTY_N ;
  ...
  assign edp_edp_edpRespF$ENQ =
	     ...
	     WILL_FIRE_RL_edp_edp_egressIpHeadFsm_action_l52c41 ||
	     WILL_FIRE_RL_edp_edp_egressIpHeadFsm_action_l53c41 ;
  assign edp_edp_edpRespF$DEQ = edp_edp_edpRespF$EMPTY_N ;
  ...
  // submodule merge_fi1
  assign merge_fi1$D_IN = 10'h0 ;
  assign merge_fi1$ENQ = 1'b0 ;
  ...
  assign IF_merge_fi0HasPrio_50_THEN_merge_fi0_first__2_ETC___d905 =
	     merge_fi0HasPrio ? merge_fi0$D_OUT[7:0] : merge_fi1$D_OUT[7:0] ;
  assign IF_rxHdr_pos_22_EQ_0_38_THEN_rxHdr_sV_98_BITS__ETC___d607 =
	     CASE_rxHdr_pos_rxHdr_sV_BITS_111_TO_104_0_rxHd_ETC__q2 ==
	     CASE_rxHdr_pos_rxHdr_pV_BITS_111_TO_104_0_rxHd_ETC__q3 ;
  assign IF_txDCPPos_19_EQ_9_37_THEN_0_ELSE_txDCPPos_19_ETC___d1027 =
	     (txDCPPos == 5'd9) ? 5'd0 : txDCPPos_19_PLUS_1___d963 ;
  ...
  assign dcp_dcp_dcpReqF_first__29_BITS_39_TO_32_34_EQ__ETC___d1039 =
	     dcp_dcp_dcpReqF$D_OUT[39:32] == dcp_dcp_lastTag[7:0] ;
  assign dcp_dcp_dcpReqF_first__29_BITS_71_TO_64_47_EQ__ETC___d1040 =
  ...
  assign txDCPPos_19_PLUS_1___d963 = txDCPPos + 5'd1 ;
  assign x__h103612 = rxLenCount + 32'd1 ;
  ...
  begin
    case (txDCPPos)
	  ...
	  IF_txDCPPos_19_EQ_0_20_OR_txDCPPos_19_EQ_1_21__ETC___d1052 =
	      merge_fi0$FULL_N;
      default: IF_txDCPPos_19_EQ_0_20_OR_txDCPPos_19_EQ_1_21__ETC___d1052 =
		   txDCPPos != 5'd9 || merge_fi0$FULL_N;
    endcase
  end
  always@(dcpRespF$D_OUT or
	  IF_txDCPPos_19_EQ_0_20_OR_txDCPPos_19_EQ_1_21__ETC___d1052 or
  ...
  begin
    case (txDCPPos)
      5'd0, 5'd2, 5'd3:
	  IF_txDCPPos_19_EQ_0_20_THEN_0_ELSE_IF_txDCPPos_ETC___d1063 = 10'd0;
      5'd1:
	  IF_txDCPPos_19_EQ_0_20_THEN_0_ELSE_IF_txDCPPos_ETC___d1063 = 10'd10;
      5'd4:
	  IF_txDCPPos_19_EQ_0_20_THEN_0_ELSE_IF_txDCPPos_ETC___d1063 =
      ...
      default: IF_txDCPPos_19_EQ_0_20_THEN_0_ELSE_IF_txDCPPos_ETC___d1063 =
  ...
  always@(dcpRespF$D_OUT or
	  IF_txDCPPos_19_EQ_0_20_THEN_0_ELSE_IF_txDCPPos_ETC___d1063 or
	  txDCPPos)
  begin
    case (dcpRespF$D_OUT[44:43])
      2'd0:
  ...
  always@(dcpRespF$D_OUT or
	  IF_txDCPPos_19_EQ_9_37_THEN_0_ELSE_txDCPPos_19_ETC___d1027 or
	  txDCPPos or txDCPPos_19_PLUS_1___d963)
  begin
    case (dcpRespF$D_OUT[44:43])
      2'd0:
	  CASE_dcpRespFD_OUT_BITS_44_TO_43_IF_txDCPPos__ETC__q20 =
	      IF_txDCPPos_19_EQ_9_37_THEN_0_ELSE_txDCPPos_19_ETC___d1027;
      2'd1:
	  CASE_dcpRespFD_OUT_BITS_44_TO_43_IF_txDCPPos__ETC__q20 =
	      (txDCPPos == 5'd5) ? 5'd0 : txDCPPos_19_PLUS_1___d963;
      default: CASE_dcpRespFD_OUT_BITS_44_TO_43_IF_txDCPPos__ETC__q20 =
		   IF_txDCPPos_19_EQ_9_37_THEN_0_ELSE_txDCPPos_19_ETC___d1027;
    endcase
  end
