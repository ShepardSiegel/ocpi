...
//
// On Thu Aug 16 11:27:19 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkGbeLite(CLK_gmii_rx_clk,
  ...
  // register rxLenCount
  assign rxLenCount$D_IN = (gmac$rx_get[9:8] == 2'd0) ? x__h103660 : 32'd0 ;
  assign rxLenCount$EN = WILL_FIRE_RL_rx_data ;

  // register rxLenLast
  assign rxLenLast$D_IN = x__h103660 ;
  ...
  assign x__h103660 = rxLenCount + 32'd1 ;
