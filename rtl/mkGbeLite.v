...
//
// On Tue Aug 14 16:47:31 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkGbeLite(CLK_gmii_rx_clk,
  ...
  reg [63 : 0] v__h3654, v__h3828, v__h3972;
  reg [9 : 0] CASE_dcpRespFD_OUT_BITS_44_TO_43_IF_txDCPPos__ETC__q19,
	      IF_txDCPPos_75_EQ_0_76_THEN_0_ELSE_IF_txDCPPos_ETC___d1259;
  ...
  reg CASE_dcpRespFD_OUT_BITS_44_TO_43_IF_txDCPPos__ETC__q4,
      ...
      IF_txDCPPos_75_EQ_0_76_OR_txDCPPos_75_EQ_1_77__ETC___d1240;
  wire [194 : 0] _1434766110945527031733894725304609466537681244_ETC__q17,
		 _643371375338640__q22,
		 bs__h19385,
		 bs__h6860;
  wire [31 : 0] x__h108134;
  wire [15 : 0] x_data__h22583;
  wire [9 : 0] IF_IF_merge_fi0HasPrio_06_THEN_merge_fi0_first_ETC___d624;
  wire [7 : 0] IF_merge_fi0HasPrio_06_THEN_merge_fi0_first__7_ETC___d1072;
  wire [4 : 0] IF_txDCPPos_75_EQ_9_93_THEN_0_ELSE_txDCPPos_75_ETC___d1213,
	       txDCPPos_75_PLUS_1___d1137;
  wire [2 : 0] d0__h6486,
	       d10__h6476,
	       d11__h6475,
	       d12__h6474,
	       ...
	       ra3__h6466,
	       ra4__h6465;
  wire [1 : 0] IF_IF_merge_fi0HasPrio_06_THEN_merge_fi0_first_ETC___d622;
  wire IF_dcp_dcp_dcpReqF_first__85_BITS_78_TO_77_86__ETC___d316,
       IF_dcp_dcp_dcpReqF_first__85_BITS_78_TO_77_86__ETC___d318,
       IF_rxHdr_pos_78_EQ_0_94_THEN_rxHdr_sV_54_BITS__ETC___d763,
       NOT_rxHdr_sV_54_BIT_112_55_78_AND_rxHdr_sV_54__ETC___d793,
       NOT_rxHdr_sV_54_BIT_112_55_78_AND_rxHdr_sV_54__ETC___d932,
       dcpRespF_i_notEmpty__71_AND_IF_dcpRespF_first__ETC___d907,
       dcp_dcp_dcpReqF_first__85_BITS_39_TO_32_90_EQ__ETC___d1226,
       dcp_dcp_dcpReqF_first__85_BITS_71_TO_64_03_EQ__ETC___d1227,
       dcp_dcp_dcpReqF_first__85_BITS_78_TO_77_86_EQ__ETC___d321,
       dcp_dcp_dcpReqF_first__85_BITS_78_TO_77_86_EQ__ETC___d362,
       edp_edp_egressIpHeadFsm_abort_whas__25_AND_edp_ETC___d536,
       edp_edp_ix_57_ULT_2___d458,
       gmac_rx_get_72_BITS_9_TO_8_73_EQ_0_74_OR_gmac__ETC___d766,
       gmac_rx_get_72_BITS_9_TO_8_73_EQ_0_74_OR_gmac__ETC___d787,
       merge_fo_i_notFull__72_AND_IF_merge_fi0HasPrio_ETC___d608,
       rxHdr_sV_54_BITS_111_TO_64_59_EQ_0xFFFFFFFFFFF_ETC___d784,
       rxHdr_sV_54_BITS_111_TO_64_59_EQ_macAddress_01___d662,
       rxHdr_sV_54_BIT_112_55_OR_NOT_rxHdr_sV_54_BITS_ETC___d1011,
       rxHdr_sV_54_BIT_112_55_OR_NOT_rxHdr_sV_54_BITS_ETC___d666;
  ...
  SizedFIFO #(.p1width(32'd72),
	      .p2depth(32'd3),
	      .p3cntr_width(32'd1),
	      .guarded(32'd1)) wci_wslv_reqF(.RST_N(RST_N_cpReset),
					     .CLK(CLK_cpClock),
  ...
  assign WILL_FIRE_RL_edp_edp_egressIpHeadFsm_action_l53c41 =
	     edp_edp_edpRespF$FULL_N && edp_edp_ix_57_ULT_2___d458 &&
  ...
  assign MUX_merge_fo$enq_1__VAL_3 =
		...
		merge_fi1$D_OUT[9:8] == 2'd0) ?
	       { 2'd0,
		 IF_merge_fi0HasPrio_06_THEN_merge_fi0_first__7_ETC___d1072 } :
	       IF_IF_merge_fi0HasPrio_06_THEN_merge_fi0_first_ETC___d624 ;
  ...
  // inlined wires
  assign wci_wslv_wciReq$wget = 72'd0 ;
  assign wci_wslv_wciReq$whas = 1'd1 ;
  assign wci_wslv_respF_x_wire$wget = MUX_wci_wslv_respF_q_0$write_1__VAL_1 ;
  assign wci_wslv_respF_x_wire$whas = WILL_FIRE_RL_wci_wslv_ctl_op_complete ;
  ...
  assign wci_wslv_ctlAckReg_1$wget = 1'b0 ;
  assign wci_wslv_ctlAckReg_1$whas = 1'b0 ;
  assign wci_wci_Es_mCmd_w$wget = 3'h0 ;
  assign wci_wci_Es_mCmd_w$whas = 1'b0 ;
  assign wci_wci_Es_mAddrSpace_w$wget = 1'b0 ;
  assign wci_wci_Es_mAddrSpace_w$whas = 1'b0 ;
  assign wci_wci_Es_mAddr_w$wget = 32'h0 ;
  assign wci_wci_Es_mAddr_w$whas = 1'b0 ;
  assign wci_wci_Es_mData_w$wget = 32'h0 ;
  assign wci_wci_Es_mData_w$whas = 1'b0 ;
  assign wci_wci_Es_mByteEn_w$wget = 4'h0 ;
  assign wci_wci_Es_mByteEn_w$whas = 1'b0 ;
  ...
  assign edp_edp_egressIpHeadFsm_state_fired_1$whas =
	     edp_edp_egressIpHeadFsm_state_set_pw$whas ;
  assign wci_wslv_reqF_r_enq$whas = 1'b0 ;
  assign wci_wslv_reqF_r_deq$whas = WILL_FIRE_RL_wci_wslv_ctl_op_start ;
  ...
  // register mdi_rMDD
  assign mdi_rMDD$D_IN = bs__h6860[mdi_rPlayIndex$Q_OUT] ;
  assign mdi_rMDD$EN = WILL_FIRE_RL_mdi_run_frame ;

  // register mdi_rOutEn
  assign mdi_rOutEn$D_IN = bs__h19385[mdi_rPlayIndex$Q_OUT] ;
  ...
  // register rxLenCount
  assign rxLenCount$D_IN = (gmac$rx_get[9:8] == 2'd0) ? x__h108134 : 32'd0 ;
  assign rxLenCount$EN = WILL_FIRE_RL_rx_data ;

  // register rxLenLast
  assign rxLenLast$D_IN = x__h108134 ;
  ...
  assign txDCPPos$D_IN =
	     (!rxHdr_sV[112] && rxHdr_sV[15:0] == 16'hF040) ?
	       ((txDCPPos == 5'd13) ? 5'd0 : txDCPPos_75_PLUS_1___d1137) :
  ...
  // register wci_wslv_ctlAckReg
  assign wci_wslv_ctlAckReg$D_IN = 1'b0 ;
  ...
  // register wci_wslv_reqF_countReg
  assign wci_wslv_reqF_countReg$D_IN = wci_wslv_reqF_countReg - 2'd1 ;
  assign wci_wslv_reqF_countReg$EN =
	     1'b0 != WILL_FIRE_RL_wci_wslv_ctl_op_start ;
  ...
  // submodule mdi_fResponse
  assign mdi_fResponse$D_IN = { 1'd1, x_data__h22583 } ;
  ...
  // submodule wci_wslv_reqF
  assign wci_wslv_reqF$D_IN = 72'd0 ;
  assign wci_wslv_reqF$ENQ = 1'b0 ;
  assign wci_wslv_reqF$DEQ = WILL_FIRE_RL_wci_wslv_ctl_op_start ;
  assign wci_wslv_reqF$CLR = 1'b0 ;

  // remaining internal signals
  assign IF_IF_merge_fi0HasPrio_06_THEN_merge_fi0_first_ETC___d622 =
	     (merge_fi0HasPrio ?
		merge_fi0$D_OUT[9:8] == 2'd2 :
		merge_fi1$D_OUT[9:8] == 2'd2) ?
	       2'd2 :
	       2'd3 ;
  assign IF_IF_merge_fi0HasPrio_06_THEN_merge_fi0_first_ETC___d624 =
	     (merge_fi0HasPrio ?
		merge_fi0$D_OUT[9:8] == 2'd1 :
		merge_fi1$D_OUT[9:8] == 2'd1) ?
	       { 2'd1,
		 IF_merge_fi0HasPrio_06_THEN_merge_fi0_first__7_ETC___d1072 } :
	       { IF_IF_merge_fi0HasPrio_06_THEN_merge_fi0_first_ETC___d622,
		 IF_merge_fi0HasPrio_06_THEN_merge_fi0_first__7_ETC___d1072 } ;
  assign IF_dcp_dcp_dcpReqF_first__85_BITS_78_TO_77_86__ETC___d316 =
	     (dcp_dcp_dcpReqF$D_OUT[78:77] == 2'd1) ?
	       dcp_dcp_dcpRespF$FULL_N &&
	       (dcp_dcp_dcpReqF_first__85_BITS_71_TO_64_03_EQ__ETC___d1227 &&
		dcp_dcp_lastTag[8] &&
		...
		dcp_dcp_cpReqF$FULL_N) :
	       ...
	       !dcp_dcp_dcpReqF$D_OUT[44] ||
	       dcp_dcp_cpReqF$FULL_N ;
  assign IF_dcp_dcp_dcpReqF_first__85_BITS_78_TO_77_86__ETC___d318 =
	     (dcp_dcp_dcpReqF$D_OUT[78:77] == 2'd0) ?
	       dcp_dcp_dcpRespF$FULL_N :
	       (dcp_dcp_dcpReqF$D_OUT[78:77] == 2'd1 ||
		!dcp_dcp_dcpReqF_first__85_BITS_39_TO_32_90_EQ__ETC___d1226 ||
		...
		dcp_dcp_dcpReqF$D_OUT[44] ||
		dcp_dcp_dcpRespF$FULL_N) &&
	       IF_dcp_dcp_dcpReqF_first__85_BITS_78_TO_77_86__ETC___d316 ;
  assign IF_merge_fi0HasPrio_06_THEN_merge_fi0_first__7_ETC___d1072 =
	     merge_fi0HasPrio ? merge_fi0$D_OUT[7:0] : merge_fi1$D_OUT[7:0] ;
  assign IF_rxHdr_pos_78_EQ_0_94_THEN_rxHdr_sV_54_BITS__ETC___d763 =
	     CASE_rxHdr_pos_rxHdr_sV_BITS_111_TO_104_0_rxHd_ETC__q2 ==
	     CASE_rxHdr_pos_rxHdr_pV_BITS_111_TO_104_0_rxHd_ETC__q3 ;
  assign IF_txDCPPos_75_EQ_9_93_THEN_0_ELSE_txDCPPos_75_ETC___d1213 =
	     (txDCPPos == 5'd9) ? 5'd0 : txDCPPos_75_PLUS_1___d1137 ;
  assign NOT_rxHdr_sV_54_BIT_112_55_78_AND_rxHdr_sV_54__ETC___d793 =
	     !rxHdr_sV[112] && rxHdr_sV[15:0] == 16'hF040 &&
	     rxHdr_sV_54_BITS_111_TO_64_59_EQ_0xFFFFFFFFFFF_ETC___d784 &&
	     rxDCPMesgPos == 5'd1 ;
  assign NOT_rxHdr_sV_54_BIT_112_55_78_AND_rxHdr_sV_54__ETC___d932 =
	     !rxHdr_sV[112] && rxHdr_sV[15:0] == 16'hF040 ||
  ...
  assign bs__h6860 =
		 ...
		 108'hFFFFFFFFFFFFFFFFFFFFFFFF1F8,
	       ...
	       d0__h6486,
	       3'b111 } ;
  assign d0__h6486 = {3{mdi_rWriteData[0]}} ;
  assign d10__h6476 = {3{mdi_rWriteData[10]}} ;
  assign d11__h6475 = {3{mdi_rWriteData[11]}} ;
  assign d12__h6474 = {3{mdi_rWriteData[12]}} ;
  assign d13__h6473 = {3{mdi_rWriteData[13]}} ;
  assign d14__h6472 = {3{mdi_rWriteData[14]}} ;
  assign d15__h6471 = {3{mdi_rWriteData[15]}} ;
  assign d1__h6485 = {3{mdi_rWriteData[1]}} ;
  assign d2__h6484 = {3{mdi_rWriteData[2]}} ;
  assign d3__h6483 = {3{mdi_rWriteData[3]}} ;
  assign d4__h6482 = {3{mdi_rWriteData[4]}} ;
  assign d5__h6481 = {3{mdi_rWriteData[5]}} ;
  assign d6__h6480 = {3{mdi_rWriteData[6]}} ;
  assign d7__h6479 = {3{mdi_rWriteData[7]}} ;
  assign d8__h6478 = {3{mdi_rWriteData[8]}} ;
  assign d9__h6477 = {3{mdi_rWriteData[9]}} ;
  assign dcpRespF_i_notEmpty__71_AND_IF_dcpRespF_first__ETC___d907 =
	     dcpRespF$EMPTY_N &&
	     CASE_dcpRespFD_OUT_BITS_44_TO_43_IF_txDCPPos__ETC__q4 ;
  assign dcp_dcp_dcpReqF_first__85_BITS_39_TO_32_90_EQ__ETC___d1226 =
	     dcp_dcp_dcpReqF$D_OUT[39:32] == dcp_dcp_lastTag[7:0] ;
  assign dcp_dcp_dcpReqF_first__85_BITS_71_TO_64_03_EQ__ETC___d1227 =
	     dcp_dcp_dcpReqF$D_OUT[71:64] == dcp_dcp_lastTag[7:0] ;
  assign dcp_dcp_dcpReqF_first__85_BITS_78_TO_77_86_EQ__ETC___d321 =
	     dcp_dcp_dcpReqF$D_OUT[78:77] == 2'd0 ||
	     dcp_dcp_dcpReqF$D_OUT[78:77] == 2'd1 ||
	     dcp_dcp_dcpReqF_first__85_BITS_39_TO_32_90_EQ__ETC___d1226 &&
	     dcp_dcp_lastTag[8] &&
	     !dcp_dcp_dcpReqF$D_OUT[44] ;
  assign dcp_dcp_dcpReqF_first__85_BITS_78_TO_77_86_EQ__ETC___d362 =
	     dcp_dcp_dcpReqF$D_OUT[78:77] == 2'd1 &&
	     (!dcp_dcp_dcpReqF_first__85_BITS_71_TO_64_03_EQ__ETC___d1227 ||
	      !dcp_dcp_lastTag[8] ||
	      dcp_dcp_dcpReqF$D_OUT[76]) ||
	     ...
	     (!dcp_dcp_dcpReqF_first__85_BITS_39_TO_32_90_EQ__ETC___d1226 ||
	      !dcp_dcp_lastTag[8] ||
	      dcp_dcp_dcpReqF$D_OUT[44]) ;
  assign edp_edp_egressIpHeadFsm_abort_whas__25_AND_edp_ETC___d536 =
	     (edp_edp_egressIpHeadFsm_state_mkFSMstate == 4'd0 ||
	      !edp_edp_ix_57_ULT_2___d458 &&
	      edp_edp_egressIpHeadFsm_state_mkFSMstate == 4'd7 ||
	      !edp_edp_ix_57_ULT_2___d458 &&
	     ...
	     (!edp_edp_egressIpHeadFsm_start_reg_1 ||
	      edp_edp_egressIpHeadFsm_state_fired) ;
  assign edp_edp_ix_57_ULT_2___d458 = edp_edp_ix < 3'd2 ;
  assign gmac_rx_get_72_BITS_9_TO_8_73_EQ_0_74_OR_gmac__ETC___d766 =
	     (gmac$rx_get[9:8] == 2'd0 || gmac$rx_get[9:8] == 2'd1) &&
	     rxHdr_sV[112] &&
	     !rxHdr_pV[112] &&
	     IF_rxHdr_pos_78_EQ_0_94_THEN_rxHdr_sV_54_BITS__ETC___d763 ;
  assign gmac_rx_get_72_BITS_9_TO_8_73_EQ_0_74_OR_gmac__ETC___d787 =
	     (gmac$rx_get[9:8] == 2'd0 || gmac$rx_get[9:8] == 2'd1) &&
	     !rxHdr_sV[112] &&
	     rxHdr_sV[15:0] == 16'hF040 &&
	     rxHdr_sV_54_BITS_111_TO_64_59_EQ_0xFFFFFFFFFFF_ETC___d784 ;
  assign merge_fo_i_notFull__72_AND_IF_merge_fi0HasPrio_ETC___d608 =
	     merge_fo$FULL_N &&
	     (merge_fi0HasPrio ? merge_fi0$EMPTY_N : merge_fi1$EMPTY_N) ;
  assign pa0__h6463 = {3{mdi_rPhyAddr[0]}} ;
  assign pa1__h6462 = {3{mdi_rPhyAddr[1]}} ;
  assign pa2__h6461 = {3{mdi_rPhyAddr[2]}} ;
  assign pa3__h6460 = {3{mdi_rPhyAddr[3]}} ;
  assign pa4__h6459 = {3{mdi_rPhyAddr[4]}} ;
  assign ra0__h6469 = {3{mdi_rRegAddr[0]}} ;
  assign ra1__h6468 = {3{mdi_rRegAddr[1]}} ;
  assign ra2__h6467 = {3{mdi_rRegAddr[2]}} ;
  assign ra3__h6466 = {3{mdi_rRegAddr[3]}} ;
  assign ra4__h6465 = {3{mdi_rRegAddr[4]}} ;
  assign rxHdr_sV_54_BITS_111_TO_64_59_EQ_0xFFFFFFFFFFF_ETC___d784 =
	     (rxHdr_sV[111:64] == 48'hFFFFFFFFFFFF ||
	      rxHdr_sV_54_BITS_111_TO_64_59_EQ_macAddress_01___d662) &&
	     { 3'd0, rxDCPMesgPos } < rxDCPPLI ;
  assign rxHdr_sV_54_BITS_111_TO_64_59_EQ_macAddress_01___d662 =
	     rxHdr_sV[111:64] == macAddress ;
  assign rxHdr_sV_54_BIT_112_55_OR_NOT_rxHdr_sV_54_BITS_ETC___d1011 =
	     (rxHdr_sV[112] || rxHdr_sV[15:0] != 16'hF040) &&
	     (dcpRespF$D_OUT[44:43] == 2'd0 && txDCPPos == 5'd9 ||
	      dcpRespF$D_OUT[44:43] != 2'd0 &&
	      (dcpRespF$D_OUT[44:43] == 2'd1 && txDCPPos == 5'd5 ||
	       dcpRespF$D_OUT[44:43] != 2'd1 && txDCPPos == 5'd9)) ;
  assign rxHdr_sV_54_BIT_112_55_OR_NOT_rxHdr_sV_54_BITS_ETC___d666 =
	     rxHdr_sV[112] || rxHdr_sV[15:0] != 16'hF040 ||
	     rxHdr_sV[111:64] != 48'hFFFFFFFFFFFF &&
	     !rxHdr_sV_54_BITS_111_TO_64_59_EQ_macAddress_01___d662 ;
  assign txDCPPos_75_PLUS_1___d1137 = txDCPPos + 5'd1 ;
  assign x__h108134 = rxLenCount + 32'd1 ;
  assign x_data__h22583 =
	     { mdi_vrReadData_15,
	       mdi_vrReadData_14,
	       mdi_vrReadData_13,
	       mdi_vrReadData_12,
  ...
  begin
    case (txDCPPos)
	  ...
	  IF_txDCPPos_75_EQ_0_76_OR_txDCPPos_75_EQ_1_77__ETC___d1240 =
	      merge_fi0$FULL_N;
      default: IF_txDCPPos_75_EQ_0_76_OR_txDCPPos_75_EQ_1_77__ETC___d1240 =
		   txDCPPos != 5'd9 || merge_fi0$FULL_N;
    endcase
  end
  always@(dcpRespF$D_OUT or
	  IF_txDCPPos_75_EQ_0_76_OR_txDCPPos_75_EQ_1_77__ETC___d1240 or
  ...
  begin
    case (txDCPPos)
      5'd0, 5'd2, 5'd3:
	  IF_txDCPPos_75_EQ_0_76_THEN_0_ELSE_IF_txDCPPos_ETC___d1259 = 10'd0;
      5'd1:
	  IF_txDCPPos_75_EQ_0_76_THEN_0_ELSE_IF_txDCPPos_ETC___d1259 = 10'd10;
      5'd4:
	  IF_txDCPPos_75_EQ_0_76_THEN_0_ELSE_IF_txDCPPos_ETC___d1259 =
      ...
      default: IF_txDCPPos_75_EQ_0_76_THEN_0_ELSE_IF_txDCPPos_ETC___d1259 =
  ...
  always@(dcpRespF$D_OUT or
	  IF_txDCPPos_75_EQ_0_76_THEN_0_ELSE_IF_txDCPPos_ETC___d1259 or
	  txDCPPos)
  begin
    case (dcpRespF$D_OUT[44:43])
      2'd0:
  ...
  always@(dcpRespF$D_OUT or
	  IF_txDCPPos_75_EQ_9_93_THEN_0_ELSE_txDCPPos_75_ETC___d1213 or
	  txDCPPos or txDCPPos_75_PLUS_1___d1137)
  begin
    case (dcpRespF$D_OUT[44:43])
      2'd0:
	  CASE_dcpRespFD_OUT_BITS_44_TO_43_IF_txDCPPos__ETC__q21 =
	      IF_txDCPPos_75_EQ_9_93_THEN_0_ELSE_txDCPPos_75_ETC___d1213;
      2'd1:
	  CASE_dcpRespFD_OUT_BITS_44_TO_43_IF_txDCPPos__ETC__q21 =
	      (txDCPPos == 5'd5) ? 5'd0 : txDCPPos_75_PLUS_1___d1137;
  ...
  always@(posedge CLK_cpClock or negedge RST_N_cpReset)
  if (!RST_N_cpReset)
    begin
