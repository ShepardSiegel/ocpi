...
//
// On Wed Nov 10 08:58:16 EST 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkFlashWorker(CLK,
  ...
  reg [63 : 0] v__h31022, v__h3549, v__h3734, v__h3889;
  reg [31 : 0] CASE_wci_reqFD_OUT_BITS_39_TO_32_0_0x0_flashS_ETC__q1;
  wire [31 : 0] flashStatus__h29982, x_data__h30877;
  wire [23 : 0] x_addr__h30775;
  wire [3 : 0] x__h15685, x__h28823;
  wire NOT_wci_respF_c_r_2_EQ_2_1_2_AND_wci_reqF_firs_ETC___d365,
       flashC_reqF_i_notEmpty__11_AND_IF_flashC_reqF__ETC___d331,
       wci_reqF_i_notEmpty__3_AND_IF_wci_reqF_first___ETC___d387;
  ...
  assign CAN_FIRE_RL_wci_cfwr =
	     wci_reqF$EMPTY_N &&
	     NOT_wci_respF_c_r_2_EQ_2_1_2_AND_wci_reqF_firs_ETC___d365 &&
	     wci_wci_cfwr_pw$whas ;
  ...
  assign MUX_flashC_reqF$enq_1__VAL_2 = { 1'd1, x_addr__h30775, 16'hAAAA } ;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, x_data__h30877 } ;
  ...
  assign flashC_rseqFsm_repeat_count$D_IN =
	     (flashC_rseqFsm_repeat_count == 4'd14) ? 4'd0 : x__h15685 ;
  ...
  assign flashC_wseqFsm_repeat_count$D_IN =
	     (flashC_wseqFsm_repeat_count == 4'd14) ? 4'd0 : x__h28823 ;
  ...
  // remaining internal signals
  assign NOT_wci_respF_c_r_2_EQ_2_1_2_AND_wci_reqF_firs_ETC___d365 =
	     wci_respF_c_r != 2'd2 &&
	     ((wci_reqF$D_OUT[39:32] == 8'h14) ?
		flashC_reqF$FULL_N :
		wci_reqF$D_OUT[39:32] != 8'h18 || flashC_reqF$FULL_N) ;
  assign flashC_reqF_i_notEmpty__11_AND_IF_flashC_reqF__ETC___d331 =
	     flashC_reqF$EMPTY_N &&
		...
		(flashC_wseqFsm_state_mkFSMstate == 4'd8 ||
		 ...
		 !flashC_wseqFsm_state_standby) &&
		!flashC_wseqFsm_start_reg) ;
  assign flashStatus__h29982 = { 31'd1, flashC_waitReg } ;
  assign wci_reqF_i_notEmpty__3_AND_IF_wci_reqF_first___ETC___d387 =
	     wci_reqF$EMPTY_N &&
	     (wci_reqF$D_OUT[51] ?
		flashC_reqF$FULL_N :
		wci_respF_c_r != 2'd2) ;
  assign x__h15685 = flashC_rseqFsm_repeat_count + 4'd1 ;
  assign x__h28823 = flashC_wseqFsm_repeat_count + 4'd1 ;
  assign x_addr__h30775 = { 5'h0, wci_reqF$D_OUT[50:34], 2'b0 } ;
  assign x_data__h30877 =
	     wci_reqF$D_OUT[51] ?
	       32'd0 :
	       CASE_wci_reqFD_OUT_BITS_39_TO_32_0_0x0_flashS_ETC__q1 ;
  always@(wci_reqF$D_OUT or
	  flashStatus__h29982 or flashCtrl or aReg or wdReg or rdReg)
  begin
