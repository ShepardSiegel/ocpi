...
//
// On Fri Oct 15 14:26:51 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkFlashWorker(CLK,
  ...
  reg [63 : 0] v__h2625, v__h2772, v__h30045, v__h3671;
  reg [31 : 0] CASE_wci_reqFD_OUT_BITS_39_TO_32_0_0x0_flashS_ETC__q1;
  wire [31 : 0] flashStatus__h29917, x_data__h30311;
  wire [23 : 0] x_addr__h30216;
  wire [3 : 0] x__h15638, x__h28758;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, x_data__h30311 } ;
  ...
  assign MUX_flashC_reqF$enq_1__VAL_2 = { 1'd1, x_addr__h30216, 16'hAAAA } ;
  ...
  assign flashC_rseqFsm_repeat_count$D_IN =
	     (flashC_rseqFsm_repeat_count == 4'd14) ? 4'd0 : x__h15638 ;
  ...
  assign flashC_wseqFsm_repeat_count$D_IN =
	     (flashC_wseqFsm_repeat_count == 4'd14) ? 4'd0 : x__h28758 ;
  ...
  assign flashC_reqF_i_notEmpty__1_AND_IF_flashC_reqF_f_ETC___d158 =
		...
		(flashC_wseqFsm_state_mkFSMstate == 4'd8 ||
		 ...
		 !flashC_wseqFsm_state_standby) &&
		!flashC_wseqFsm_start_reg) ;
  assign flashStatus__h29917 = { 31'd1, flashC_waitReg } ;
  ...
  assign x__h15638 = flashC_rseqFsm_repeat_count + 4'd1 ;
  assign x__h28758 = flashC_wseqFsm_repeat_count + 4'd1 ;
  assign x_addr__h30216 = { 5'h0, wci_reqF$D_OUT[50:34], 2'b0 } ;
  assign x_data__h30311 =
	     wci_reqF$D_OUT[51] ?
	       32'd0 :
	       CASE_wci_reqFD_OUT_BITS_39_TO_32_0_0x0_flashS_ETC__q1 ;
  always@(wci_reqF$D_OUT or
	  flashStatus__h29917 or flashCtrl or aReg or wdReg or rdReg)
  begin
