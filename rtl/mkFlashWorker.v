...
//
// On Wed Aug 11 07:33:20 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkFlashWorker(CLK,
  ...
  reg [63 : 0] v__h2625, v__h2772, v__h30043, v__h3671;
  reg [31 : 0] CASE_wci_reqFD_OUT_BITS_39_TO_32_0_0x0_flashS_ETC__q1;
  wire [31 : 0] flashStatus__h29915, x_data__h30309;
  wire [23 : 0] x_addr__h30214;
  wire [3 : 0] x__h15636, x__h28756;
  wire flashC_reqF_i_notEmpty__1_AND_IF_flashC_reqF_f_ETC___d158,
       wci_reqF_i_notEmpty__0_AND_IF_wci_reqF_first___ETC___d28,
       wci_reqF_i_notEmpty__0_AND_wci_reqF_first__1_B_ETC___d62;
  ...
  assign CAN_FIRE_RL_flashC_nextRequest =
	     flashC_reqF_i_notEmpty__1_AND_IF_flashC_reqF_f_ETC___d158 &&
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, x_data__h30309 } ;
  ...
  assign MUX_flashC_reqF$enq_1__SEL_1 =
	     WILL_FIRE_RL_wci_cfwr &&
	     (wci_reqF$D_OUT[39:32] == 8'h14 ||
	      wci_reqF$D_OUT[39:32] == 8'h18) ;
  assign MUX_flashC_reqF$enq_1__VAL_1 =
	     { wci_reqF$D_OUT[39:32] != 8'h14, aReg[23:0], wdReg[15:0] } ;
  assign MUX_flashC_reqF$enq_1__VAL_2 = { 1'd1, x_addr__h30214, 16'hAAAA } ;
  ...
  // register aReg
  assign aReg$D_IN = wci_reqF$D_OUT[31:0] ;
  assign aReg$EN = WILL_FIRE_RL_wci_cfwr && wci_reqF$D_OUT[39:32] == 8'h08 ;
  ...
  assign flashC_rseqFsm_repeat_count$D_IN =
	     (flashC_rseqFsm_repeat_count == 4'd14) ? 4'd0 : x__h15636 ;
  ...
  assign flashC_wseqFsm_repeat_count$D_IN =
	     (flashC_wseqFsm_repeat_count == 4'd14) ? 4'd0 : x__h28756 ;
  ...
  // register flashCtrl
  assign flashCtrl$D_IN = wci_reqF$D_OUT[31:0] ;
  assign flashCtrl$EN =
  ...
  assign wdReg$EN = WILL_FIRE_RL_wci_cfwr && wci_reqF$D_OUT[39:32] == 8'h0C ;
  ...
  assign flashC_respF$ENQ = CAN_FIRE_RL_flashC_rseqFsm_actionof_l60c10 ;
  ...
  // remaining internal signals
  assign flashC_reqF_i_notEmpty__1_AND_IF_flashC_reqF_f_ETC___d158 =
	     flashC_reqF$EMPTY_N &&
		...
		(flashC_wseqFsm_state_mkFSMstate == 4'd8 ||
		 ...
		 !flashC_wseqFsm_state_standby) &&
		!flashC_wseqFsm_start_reg) ;
  assign flashStatus__h29915 = { 31'd1, flashC_waitReg } ;
  assign wci_reqF_i_notEmpty__0_AND_IF_wci_reqF_first___ETC___d28 =
	     wci_reqF$EMPTY_N &&
	     (wci_reqF$D_OUT[51] ?
		flashC_reqF$FULL_N :
		wci_respF_c_r != 2'd2) ;
  assign wci_reqF_i_notEmpty__0_AND_wci_reqF_first__1_B_ETC___d62 =
	     wci_reqF$EMPTY_N &&
	     ((wci_reqF$D_OUT[39:32] == 8'h14) ?
		flashC_reqF$FULL_N :
		wci_reqF$D_OUT[39:32] != 8'h18 || flashC_reqF$FULL_N) ;
  assign x__h15636 = flashC_rseqFsm_repeat_count + 4'd1 ;
  assign x__h28756 = flashC_wseqFsm_repeat_count + 4'd1 ;
  assign x_addr__h30214 = { 5'h0, wci_reqF$D_OUT[50:34], 2'b0 } ;
  assign x_data__h30309 =
	     wci_reqF$D_OUT[51] ?
	       32'd0 :
	       CASE_wci_reqFD_OUT_BITS_39_TO_32_0_0x0_flashS_ETC__q1 ;
  always@(wci_reqF$D_OUT or
	  flashStatus__h29915 or flashCtrl or aReg or wdReg or rdReg)
  begin
    case (wci_reqF$D_OUT[39:32])
	  ...
	  CASE_wci_reqFD_OUT_BITS_39_TO_32_0_0x0_flashS_ETC__q1 =
	      flashStatus__h29915;
      8'h04:
	  CASE_wci_reqFD_OUT_BITS_39_TO_32_0_0x0_flashS_ETC__q1 = flashCtrl;
      8'h08: CASE_wci_reqFD_OUT_BITS_39_TO_32_0_0x0_flashS_ETC__q1 = aReg;
      8'h0C: CASE_wci_reqFD_OUT_BITS_39_TO_32_0_0x0_flashS_ETC__q1 = wdReg;
      8'h10: CASE_wci_reqFD_OUT_BITS_39_TO_32_0_0x0_flashS_ETC__q1 = rdReg;
      default: CASE_wci_reqFD_OUT_BITS_39_TO_32_0_0x0_flashS_ETC__q1 = 32'd0;
    endcase
  end
