...
//
// On Wed Jan  5 11:18:52 EST 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkFlashWorker(CLK,
  ...
  reg [63 : 0] v__h30976, v__h3549, v__h3723, v__h3867;
  reg [31 : 0] CASE_wci_reqFD_OUT_BITS_39_TO_32_0_0x0_flashS_ETC__q1;
  wire [31 : 0] flashStatus__h29960, g_data__h30837;
  wire [23 : 0] x_addr__h30737;
  wire [3 : 0] x__h15663, x__h28801;
  ...
  assign MUX_flashC_reqF$enq_1__VAL_2 = { 1'd1, x_addr__h30737, 16'hAAAA } ;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, g_data__h30837 } ;
  ...
  assign flashC_rseqFsm_repeat_count$D_IN =
	     (flashC_rseqFsm_repeat_count == 4'd14) ? 4'd0 : x__h15663 ;
  ...
  assign flashC_wseqFsm_repeat_count$D_IN =
	     (flashC_wseqFsm_repeat_count == 4'd14) ? 4'd0 : x__h28801 ;
  ...
  assign flashC_reqF_i_notEmpty__11_AND_IF_flashC_reqF__ETC___d331 =
		...
		(flashC_wseqFsm_state_mkFSMstate == 4'd8 ||
		 ...
		 !flashC_wseqFsm_state_standby) &&
		!flashC_wseqFsm_start_reg) ;
  assign flashStatus__h29960 = { 31'd1, flashC_waitReg } ;
  assign g_data__h30837 =
	     wci_reqF$D_OUT[51] ?
	       32'd0 :
  ...
  assign x__h15663 = flashC_rseqFsm_repeat_count + 4'd1 ;
  assign x__h28801 = flashC_wseqFsm_repeat_count + 4'd1 ;
  assign x_addr__h30737 = { 5'h0, wci_reqF$D_OUT[50:34], 2'b0 } ;
  always@(wci_reqF$D_OUT or
	  flashStatus__h29960 or flashCtrl or aReg or wdReg or rdReg)
  begin
