...
//
// On Thu Oct 31 09:24:13 EDT 2013
//
//
// Ports:
// Name                         I/O  size props
...
module mkFlashWorker(wciS0_Clk,
  ...
  wire flashC_rseqFsm_abort_wget,
       flashC_rseqFsm_abort_whas,
       flashC_rseqFsm_start_reg_2_wget,
       flashC_rseqFsm_start_reg_2_whas,
       flashC_rseqFsm_start_wire_wget,
       flashC_rseqFsm_start_wire_whas,
       flashC_rseqFsm_state_fired_1_wget,
       flashC_rseqFsm_state_fired_1_whas,
       flashC_rseqFsm_state_overlap_pw_whas,
       flashC_rseqFsm_state_set_pw_whas,
       flashC_wseqFsm_abort_wget,
       flashC_wseqFsm_abort_whas,
       flashC_wseqFsm_start_reg_2_wget,
       flashC_wseqFsm_start_reg_2_whas,
       flashC_wseqFsm_start_wire_wget,
       flashC_wseqFsm_start_wire_whas,
       flashC_wseqFsm_state_fired_1_wget,
       flashC_wseqFsm_state_fired_1_whas,
       flashC_wseqFsm_state_overlap_pw_whas,
       flashC_wseqFsm_state_set_pw_whas,
  ...
  wire [23 : 0] flashC_aReg_D_IN;
  wire flashC_aReg_EN;

  // register flashC_ceReg
  reg flashC_ceReg;
  wire flashC_ceReg_D_IN, flashC_ceReg_EN;

  // register flashC_isRead
  reg flashC_isRead;
  wire flashC_isRead_D_IN, flashC_isRead_EN;

  // register flashC_oeReg
  reg flashC_oeReg;
  wire flashC_oeReg_D_IN, flashC_oeReg_EN;

  // register flashC_rseqFsm_jj_delay_count
  reg [14 : 0] flashC_rseqFsm_jj_delay_count;
  wire [14 : 0] flashC_rseqFsm_jj_delay_count_D_IN;
  wire flashC_rseqFsm_jj_delay_count_EN;

  // register flashC_rseqFsm_start_reg
  reg flashC_rseqFsm_start_reg;
  wire flashC_rseqFsm_start_reg_D_IN, flashC_rseqFsm_start_reg_EN;

  // register flashC_rseqFsm_start_reg_1
  reg flashC_rseqFsm_start_reg_1;
  wire flashC_rseqFsm_start_reg_1_D_IN, flashC_rseqFsm_start_reg_1_EN;

  // register flashC_rseqFsm_state_can_overlap
  reg flashC_rseqFsm_state_can_overlap;
  wire flashC_rseqFsm_state_can_overlap_D_IN,
       flashC_rseqFsm_state_can_overlap_EN;

  // register flashC_rseqFsm_state_fired
  reg flashC_rseqFsm_state_fired;
  wire flashC_rseqFsm_state_fired_D_IN, flashC_rseqFsm_state_fired_EN;

  // register flashC_rseqFsm_state_mkFSMstate
  reg [3 : 0] flashC_rseqFsm_state_mkFSMstate;
  reg [3 : 0] flashC_rseqFsm_state_mkFSMstate_D_IN;
  wire flashC_rseqFsm_state_mkFSMstate_EN;

  // register flashC_tmpWD
  reg [15 : 0] flashC_tmpWD;
  wire [15 : 0] flashC_tmpWD_D_IN;
  wire flashC_tmpWD_EN;

  // register flashC_tsOE
  reg flashC_tsOE;
  wire flashC_tsOE_D_IN, flashC_tsOE_EN;

  // register flashC_tsWD
  reg [15 : 0] flashC_tsWD;
  wire [15 : 0] flashC_tsWD_D_IN;
  wire flashC_tsWD_EN;

  // register flashC_waitReg
  reg flashC_waitReg;
  wire flashC_waitReg_D_IN, flashC_waitReg_EN;

  // register flashC_wdReg
  reg [15 : 0] flashC_wdReg;
  wire [15 : 0] flashC_wdReg_D_IN;
  wire flashC_wdReg_EN;

  // register flashC_weReg
  reg flashC_weReg;
  wire flashC_weReg_D_IN, flashC_weReg_EN;

  // register flashC_wseqFsm_jj_1_delay_count
  reg [6 : 0] flashC_wseqFsm_jj_1_delay_count;
  wire [6 : 0] flashC_wseqFsm_jj_1_delay_count_D_IN;
  wire flashC_wseqFsm_jj_1_delay_count_EN;

  // register flashC_wseqFsm_jj_2_delay_count
  reg [6 : 0] flashC_wseqFsm_jj_2_delay_count;
  wire [6 : 0] flashC_wseqFsm_jj_2_delay_count_D_IN;
  wire flashC_wseqFsm_jj_2_delay_count_EN;

  // register flashC_wseqFsm_jj_delay_count
  reg [6 : 0] flashC_wseqFsm_jj_delay_count;
  wire [6 : 0] flashC_wseqFsm_jj_delay_count_D_IN;
  wire flashC_wseqFsm_jj_delay_count_EN;

  // register flashC_wseqFsm_start_reg
  reg flashC_wseqFsm_start_reg;
  wire flashC_wseqFsm_start_reg_D_IN, flashC_wseqFsm_start_reg_EN;

  // register flashC_wseqFsm_start_reg_1
  reg flashC_wseqFsm_start_reg_1;
  wire flashC_wseqFsm_start_reg_1_D_IN, flashC_wseqFsm_start_reg_1_EN;

  // register flashC_wseqFsm_state_can_overlap
  reg flashC_wseqFsm_state_can_overlap;
  wire flashC_wseqFsm_state_can_overlap_D_IN,
       flashC_wseqFsm_state_can_overlap_EN;

  // register flashC_wseqFsm_state_fired
  reg flashC_wseqFsm_state_fired;
  wire flashC_wseqFsm_state_fired_D_IN, flashC_wseqFsm_state_fired_EN;

  // register flashC_wseqFsm_state_mkFSMstate
  reg [4 : 0] flashC_wseqFsm_state_mkFSMstate;
  reg [4 : 0] flashC_wseqFsm_state_mkFSMstate_D_IN;
  wire flashC_wseqFsm_state_mkFSMstate_EN;

  // register flashCtrl
  reg [31 : 0] flashCtrl;
  wire [31 : 0] flashCtrl_D_IN;
  wire flashCtrl_EN;

  // register rdReg
  reg [31 : 0] rdReg;
  wire [31 : 0] rdReg_D_IN;
  wire rdReg_EN;
  ...
  // register wdReg
  reg [31 : 0] wdReg;
  wire [31 : 0] wdReg_D_IN;
  wire wdReg_EN;

  // ports of submodule flashC_reqF
  wire [40 : 0] flashC_reqF_D_IN, flashC_reqF_D_OUT;
  wire flashC_reqF_CLR,
       flashC_reqF_DEQ,
       flashC_reqF_EMPTY_N,
       flashC_reqF_ENQ,
       flashC_reqF_FULL_N;
  ...
  wire [15 : 0] flashC_respF_D_IN, flashC_respF_D_OUT;
  wire flashC_respF_CLR,
       flashC_respF_DEQ,
       flashC_respF_EMPTY_N,
       flashC_respF_ENQ,
       flashC_respF_FULL_N;

  // ports of submodule flashC_tsd
  wire [15 : 0] flashC_tsd_IO, flashC_tsd_O;
  ...
  wire [40 : 0] MUX_flashC_reqF_enq_1__VAL_1, MUX_flashC_reqF_enq_1__VAL_2;
  ...
  wire [31 : 0] MUX_rdReg_write_1__VAL_2;
  wire [14 : 0] MUX_flashC_rseqFsm_jj_delay_count_write_1__VAL_1;
  wire [6 : 0] MUX_flashC_wseqFsm_jj_1_delay_count_write_1__VAL_1,
	       MUX_flashC_wseqFsm_jj_2_delay_count_write_1__VAL_1,
	       MUX_flashC_wseqFsm_jj_delay_count_write_1__VAL_1;
  wire [1 : 0] MUX_wci_wslv_respF_cntr_r_write_1__VAL_2;
  wire MUX_flashC_ceReg_write_1__SEL_1,
       MUX_flashC_oeReg_write_1__SEL_1,
       MUX_flashC_rseqFsm_start_reg_write_1__SEL_1,
       MUX_flashC_weReg_write_1__SEL_1,
       MUX_flashC_wseqFsm_start_reg_write_1__SEL_1,
       MUX_rdReg_write_1__SEL_1,
  ...
  reg [63 : 0] v__h3564, v__h3739, v__h3883, v__h87698;
  reg [31 : 0] IF_wci_wslv_reqF_first__3_BITS_39_TO_32_89_EQ__ETC___d442;
  wire [31 : 0] flashStatus__h86674, g_data__h87561;
  wire [23 : 0] x_addr__h87461;
  wire [1 : 0] wci_wslv_respF_cntr_r_8_MINUS_1___d27;
  wire IF_flashC_reqF_first__65_BIT_40_66_THEN_flashC_ETC___d371,
       _dfoo1,
       _dfoo3,
       flashC_rseqFsm_abort_whas__58_AND_flashC_rseqF_ETC___d225,
       flashC_wseqFsm_abort_whas__31_AND_flashC_wseqF_ETC___d361,
       wci_wslv_reqF_i_notEmpty__2_AND_IF_wci_wslv_re_ETC___d426,
       wci_wslv_reqF_i_notEmpty__2_AND_wci_wslv_reqF__ETC___d404;
  ...
  FIFO2 #(.width(32'd41), .guarded(32'd1)) flashC_reqF(.RST(wciS0_MReset_n),
						       .CLK(wciS0_Clk),
						       .D_IN(flashC_reqF_D_IN),
						       .ENQ(flashC_reqF_ENQ),
						       .DEQ(flashC_reqF_DEQ),
						       .CLR(flashC_reqF_CLR),
						       .D_OUT(flashC_reqF_D_OUT),
						       .FULL_N(flashC_reqF_FULL_N),
						       .EMPTY_N(flashC_reqF_EMPTY_N));

  // submodule flashC_respF
  FIFO2 #(.width(32'd16), .guarded(32'd1)) flashC_respF(.RST(wciS0_MReset_n),
							.CLK(wciS0_Clk),
							.D_IN(flashC_respF_D_IN),
							.ENQ(flashC_respF_ENQ),
							.DEQ(flashC_respF_DEQ),
							.CLR(flashC_respF_CLR),
							.D_OUT(flashC_respF_D_OUT),
							.FULL_N(flashC_respF_FULL_N),
							.EMPTY_N(flashC_respF_EMPTY_N));
  ...
  assign WILL_FIRE_RL_advance_response =
	     flashC_respF_EMPTY_N &&
	     (!splitReadInFlight || wci_wslv_respF_cntr_r != 2'd2) &&
	     !wci_wslv_wci_cfwr_pw_whas &&
	     !WILL_FIRE_RL_wci_wslv_ctl_op_complete ;
  ...
  assign WILL_FIRE_RL_flashC_rseqFsm_action_l63c10 =
	     flashC_respF_FULL_N && flashC_isRead &&
  ...
  assign WILL_FIRE_RL_flashC_rseqFsm_action_l60c12 =
	     flashC_isRead && flashC_rseqFsm_start_wire_whas &&
  ...
  assign WILL_FIRE_RL_flashC_wseqFsm_action_np_2 =
	     !flashC_isRead && !flashC_wseqFsm_jj_1_delay_count[6] &&
  ...
  assign WILL_FIRE_RL_flashC_wseqFsm_action_l70c12 =
	     !flashC_isRead && flashC_wseqFsm_start_wire_whas &&
  ...
  assign WILL_FIRE_RL_flashC_nextRequest =
	     flashC_reqF_EMPTY_N &&
	     IF_flashC_reqF_first__65_BIT_40_66_THEN_flashC_ETC___d371 &&
	     flashC_rseqFsm_abort_whas__58_AND_flashC_rseqF_ETC___d225 &&
	     !flashC_rseqFsm_start_reg &&
	     flashC_wseqFsm_abort_whas__31_AND_flashC_wseqF_ETC___d361 &&
	     !flashC_wseqFsm_start_reg ;
  ...
  // inputs to muxes for submodule ports
  assign MUX_flashC_ceReg_write_1__SEL_1 =
	     WILL_FIRE_RL_flashC_wseqFsm_action_l91c12 ||
	     WILL_FIRE_RL_flashC_wseqFsm_action_l83c12 ||
	     WILL_FIRE_RL_flashC_wseqFsm_action_l76c12 ||
	     WILL_FIRE_RL_flashC_rseqFsm_action_l65c12 ;
  assign MUX_flashC_oeReg_write_1__SEL_1 =
	     WILL_FIRE_RL_flashC_wseqFsm_action_l90c12 ||
	     WILL_FIRE_RL_flashC_rseqFsm_action_l64c12 ;
  assign MUX_flashC_rseqFsm_start_reg_write_1__SEL_1 =
	     WILL_FIRE_RL_flashC_nextRequest && flashC_reqF_D_OUT[40] ;
  assign MUX_flashC_weReg_write_1__SEL_1 =
	     WILL_FIRE_RL_flashC_wseqFsm_action_l82c12 ||
	     WILL_FIRE_RL_flashC_wseqFsm_action_l75c12 ;
  assign MUX_flashC_wseqFsm_start_reg_write_1__SEL_1 =
	     WILL_FIRE_RL_flashC_nextRequest && !flashC_reqF_D_OUT[40] ;
  assign MUX_rdReg_write_1__SEL_1 =
	     WILL_FIRE_RL_wci_cfwr && wci_wslv_reqF_D_OUT[39:32] == 8'h10 ;
  ...
  assign MUX_wci_wslv_respF_x_wire_wset_1__SEL_2 =
	     WILL_FIRE_RL_wci_cfrd && !wci_wslv_reqF_D_OUT[51] ;
  assign MUX_flashC_reqF_enq_1__VAL_1 = { 1'd1, x_addr__h87461, 16'hAAAA } ;
  assign MUX_flashC_reqF_enq_1__VAL_2 =
	     { wci_wslv_reqF_D_OUT[39:32] != 8'h14,
	       aReg[23:0],
	       wdReg[15:0] } ;
  assign MUX_flashC_rseqFsm_jj_delay_count_write_1__VAL_1 =
	     { flashC_rseqFsm_jj_delay_count[13:0], 1'd0 } ;
  assign MUX_flashC_wseqFsm_jj_1_delay_count_write_1__VAL_1 =
	     { flashC_wseqFsm_jj_1_delay_count[5:0], 1'd0 } ;
  assign MUX_flashC_wseqFsm_jj_2_delay_count_write_1__VAL_1 =
	     { flashC_wseqFsm_jj_2_delay_count[5:0], 1'd0 } ;
  assign MUX_flashC_wseqFsm_jj_delay_count_write_1__VAL_1 =
	     { flashC_wseqFsm_jj_delay_count[5:0], 1'd0 } ;
  assign MUX_rdReg_write_1__VAL_2 = { 16'd0, flashC_respF_D_OUT } ;
  ...
  assign MUX_wci_wslv_respF_x_wire_wset_1__VAL_1 =
	     { 18'd65536, flashC_respF_D_OUT } ;
  assign MUX_wci_wslv_respF_x_wire_wset_1__VAL_2 = { 2'd1, g_data__h87561 } ;
  ...
  assign flashC_rseqFsm_start_wire_wget = 1'd1 ;
  assign flashC_rseqFsm_start_wire_whas =
	     WILL_FIRE_RL_flashC_rseqFsm_fsm_start ||
	     flashC_rseqFsm_start_reg_1 && !flashC_rseqFsm_state_fired ;
  assign flashC_rseqFsm_start_reg_2_wget = 1'd1 ;
  assign flashC_rseqFsm_start_reg_2_whas = flashC_rseqFsm_start_wire_whas ;
  assign flashC_rseqFsm_abort_wget = 1'b0 ;
  assign flashC_rseqFsm_abort_whas = 1'b0 ;
  assign flashC_rseqFsm_state_fired_1_wget = 1'd1 ;
  assign flashC_rseqFsm_state_fired_1_whas =
	     flashC_rseqFsm_state_set_pw_whas ;
  assign flashC_wseqFsm_start_wire_wget = 1'd1 ;
  assign flashC_wseqFsm_start_wire_whas =
	     WILL_FIRE_RL_flashC_wseqFsm_fsm_start ||
	     flashC_wseqFsm_start_reg_1 && !flashC_wseqFsm_state_fired ;
  assign flashC_wseqFsm_start_reg_2_wget = 1'd1 ;
  assign flashC_wseqFsm_start_reg_2_whas = flashC_wseqFsm_start_wire_whas ;
  assign flashC_wseqFsm_abort_wget = 1'b0 ;
  assign flashC_wseqFsm_abort_whas = 1'b0 ;
  assign flashC_wseqFsm_state_fired_1_wget = 1'd1 ;
  assign flashC_wseqFsm_state_fired_1_whas =
	     flashC_wseqFsm_state_set_pw_whas ;
  ...
  assign wci_wslv_wci_ctrl_pw_whas =
	     wci_wslv_reqF_EMPTY_N && !wci_wslv_reqF_D_OUT[68] &&
	     wci_wslv_reqF_D_OUT[71:69] == 3'd2 ;
  assign flashC_rseqFsm_state_set_pw_whas =
	     WILL_FIRE_RL_flashC_rseqFsm_idle_l59c15 ||
	     WILL_FIRE_RL_flashC_rseqFsm_action_l65c12 ||
	     WILL_FIRE_RL_flashC_rseqFsm_action_l64c12 ||
	     WILL_FIRE_RL_flashC_rseqFsm_action_l63c10 ||
	     ...
	     WILL_FIRE_RL_flashC_rseqFsm_action_l61c12 ||
	     WILL_FIRE_RL_flashC_rseqFsm_action_l60c12 ;
  assign flashC_rseqFsm_state_overlap_pw_whas = 1'b0 ;
  assign flashC_wseqFsm_state_set_pw_whas =
	     WILL_FIRE_RL_flashC_wseqFsm_idle_l69c15 ||
	     WILL_FIRE_RL_flashC_wseqFsm_action_l91c12 ||
	     WILL_FIRE_RL_flashC_wseqFsm_action_l90c12 ||
	     WILL_FIRE_RL_flashC_wseqFsm_action_np_4 ||
	     ...
	     WILL_FIRE_RL_flashC_wseqFsm_action_l71c12 ||
	     WILL_FIRE_RL_flashC_wseqFsm_action_l70c12 ;
  assign flashC_wseqFsm_state_overlap_pw_whas = 1'b0 ;

  // register aReg
  assign aReg_D_IN = wci_wslv_reqF_D_OUT[31:0] ;
  assign aReg_EN =
	     WILL_FIRE_RL_wci_cfwr && wci_wslv_reqF_D_OUT[39:32] == 8'h08 ;

  // register flashC_aReg
  assign flashC_aReg_D_IN = flashC_reqF_D_OUT[39:16] ;
  assign flashC_aReg_EN = WILL_FIRE_RL_flashC_nextRequest ;

  // register flashC_ceReg
  assign flashC_ceReg_D_IN = !MUX_flashC_ceReg_write_1__SEL_1 ;
  assign flashC_ceReg_EN =
	     WILL_FIRE_RL_flashC_wseqFsm_action_l91c12 ||
	     WILL_FIRE_RL_flashC_wseqFsm_action_l83c12 ||
	     WILL_FIRE_RL_flashC_wseqFsm_action_l76c12 ||
	     WILL_FIRE_RL_flashC_rseqFsm_action_l65c12 ||
  ...
  // register flashC_isRead
  assign flashC_isRead_D_IN = flashC_reqF_D_OUT[40] ;
  assign flashC_isRead_EN = WILL_FIRE_RL_flashC_nextRequest ;

  // register flashC_oeReg
  assign flashC_oeReg_D_IN = !MUX_flashC_oeReg_write_1__SEL_1 ;
  assign flashC_oeReg_EN =
	     WILL_FIRE_RL_flashC_wseqFsm_action_l90c12 ||
	     WILL_FIRE_RL_flashC_rseqFsm_action_l64c12 ||
	     WILL_FIRE_RL_flashC_wseqFsm_action_l88c12 ||
	     WILL_FIRE_RL_flashC_rseqFsm_action_l61c12 ;
  ...
  // register flashC_rseqFsm_jj_delay_count
  assign flashC_rseqFsm_jj_delay_count_D_IN =
	     WILL_FIRE_RL_flashC_rseqFsm_action_np ?
	       MUX_flashC_rseqFsm_jj_delay_count_write_1__VAL_1 :
	       15'd1 ;
  assign flashC_rseqFsm_jj_delay_count_EN =
	     WILL_FIRE_RL_flashC_rseqFsm_action_np ||
	     WILL_FIRE_RL_flashC_rseqFsm_action_d_init_np ;

  // register flashC_rseqFsm_start_reg
  assign flashC_rseqFsm_start_reg_D_IN =
	     MUX_flashC_rseqFsm_start_reg_write_1__SEL_1 ;
  assign flashC_rseqFsm_start_reg_EN =
	     WILL_FIRE_RL_flashC_nextRequest && flashC_reqF_D_OUT[40] ||
	     WILL_FIRE_RL_flashC_rseqFsm_fsm_start ;

  // register flashC_rseqFsm_start_reg_1
  assign flashC_rseqFsm_start_reg_1_D_IN = flashC_rseqFsm_start_wire_whas ;
  assign flashC_rseqFsm_start_reg_1_EN = 1'd1 ;

  // register flashC_rseqFsm_state_can_overlap
  assign flashC_rseqFsm_state_can_overlap_D_IN =
	     flashC_rseqFsm_state_set_pw_whas ||
	     flashC_rseqFsm_state_can_overlap ;
  assign flashC_rseqFsm_state_can_overlap_EN = 1'd1 ;

  // register flashC_rseqFsm_state_fired
  assign flashC_rseqFsm_state_fired_D_IN = flashC_rseqFsm_state_set_pw_whas ;
  assign flashC_rseqFsm_state_fired_EN = 1'd1 ;
  ...
  begin
    case (1'b1) // synopsys parallel_case
      WILL_FIRE_RL_flashC_rseqFsm_idle_l59c15:
	  flashC_rseqFsm_state_mkFSMstate_D_IN = 4'd0;
      WILL_FIRE_RL_flashC_rseqFsm_action_l60c12:
	  flashC_rseqFsm_state_mkFSMstate_D_IN = 4'd1;
      WILL_FIRE_RL_flashC_rseqFsm_action_l61c12:
	  flashC_rseqFsm_state_mkFSMstate_D_IN = 4'd2;
      WILL_FIRE_RL_flashC_rseqFsm_action_d_init_np:
	  flashC_rseqFsm_state_mkFSMstate_D_IN = 4'd3;
      WILL_FIRE_RL_flashC_rseqFsm_action_np:
	  flashC_rseqFsm_state_mkFSMstate_D_IN = 4'd4;
      WILL_FIRE_RL_flashC_rseqFsm_action_l63c10:
	  flashC_rseqFsm_state_mkFSMstate_D_IN = 4'd5;
      WILL_FIRE_RL_flashC_rseqFsm_action_l64c12:
	  flashC_rseqFsm_state_mkFSMstate_D_IN = 4'd6;
      WILL_FIRE_RL_flashC_rseqFsm_action_l65c12:
	  flashC_rseqFsm_state_mkFSMstate_D_IN = 4'd7;
      default: flashC_rseqFsm_state_mkFSMstate_D_IN =
		   4'b1010 /* unspecified value */ ;
    endcase
  end
  assign flashC_rseqFsm_state_mkFSMstate_EN =
	     WILL_FIRE_RL_flashC_rseqFsm_idle_l59c15 ||
	     WILL_FIRE_RL_flashC_rseqFsm_action_l60c12 ||
	     WILL_FIRE_RL_flashC_rseqFsm_action_l61c12 ||
	     WILL_FIRE_RL_flashC_rseqFsm_action_d_init_np ||
  ...
  // register flashC_tmpWD
  assign flashC_tmpWD_D_IN = flashC_reqF_D_OUT[15:0] ;
  assign flashC_tmpWD_EN = WILL_FIRE_RL_flashC_nextRequest ;

  // register flashC_tsOE
  assign flashC_tsOE_D_IN = !WILL_FIRE_RL_flashC_wseqFsm_action_l84c12 ;
  assign flashC_tsOE_EN =
	     WILL_FIRE_RL_flashC_wseqFsm_action_l84c12 ||
	     WILL_FIRE_RL_flashC_wseqFsm_action_l72c12 ;

  // register flashC_tsWD
  assign flashC_tsWD_D_IN =
	     WILL_FIRE_RL_flashC_wseqFsm_action_l78c12 ?
	       flashC_tmpWD :
	       16'd64 ;
  assign flashC_tsWD_EN =
	     WILL_FIRE_RL_flashC_wseqFsm_action_l78c12 ||
	     WILL_FIRE_RL_flashC_wseqFsm_action_l70c12 ;

  // register flashC_waitReg
  assign flashC_waitReg_D_IN = flash_fwait_i ;
  assign flashC_waitReg_EN = 1'd1 ;

  // register flashC_wdReg
  assign flashC_wdReg_D_IN = 16'h0 ;
  assign flashC_wdReg_EN = 1'b0 ;

  // register flashC_weReg
  assign flashC_weReg_D_IN = !MUX_flashC_weReg_write_1__SEL_1 ;
  assign flashC_weReg_EN =
	     WILL_FIRE_RL_flashC_wseqFsm_action_l82c12 ||
	     WILL_FIRE_RL_flashC_wseqFsm_action_l75c12 ||
	     WILL_FIRE_RL_flashC_wseqFsm_action_l80c12 ||
	     WILL_FIRE_RL_flashC_wseqFsm_action_l73c12 ;
  ...
  // register flashC_wseqFsm_jj_1_delay_count
  assign flashC_wseqFsm_jj_1_delay_count_D_IN =
	     WILL_FIRE_RL_flashC_wseqFsm_action_np_2 ?
	       MUX_flashC_wseqFsm_jj_1_delay_count_write_1__VAL_1 :
	       7'd1 ;
  assign flashC_wseqFsm_jj_1_delay_count_EN =
	     WILL_FIRE_RL_flashC_wseqFsm_action_np_2 ||
	     WILL_FIRE_RL_flashC_wseqFsm_action_d_init_np_1 ;

  // register flashC_wseqFsm_jj_2_delay_count
  assign flashC_wseqFsm_jj_2_delay_count_D_IN =
	     WILL_FIRE_RL_flashC_wseqFsm_action_np_4 ?
	       MUX_flashC_wseqFsm_jj_2_delay_count_write_1__VAL_1 :
	       7'd1 ;
  assign flashC_wseqFsm_jj_2_delay_count_EN =
	     WILL_FIRE_RL_flashC_wseqFsm_action_np_4 ||
	     WILL_FIRE_RL_flashC_wseqFsm_action_d_init_np_2 ;

  // register flashC_wseqFsm_jj_delay_count
  assign flashC_wseqFsm_jj_delay_count_D_IN =
	     WILL_FIRE_RL_flashC_wseqFsm_action_np ?
	       MUX_flashC_wseqFsm_jj_delay_count_write_1__VAL_1 :
	       7'd1 ;
  assign flashC_wseqFsm_jj_delay_count_EN =
	     WILL_FIRE_RL_flashC_wseqFsm_action_np ||
	     WILL_FIRE_RL_flashC_wseqFsm_action_d_init_np ;

  // register flashC_wseqFsm_start_reg
  assign flashC_wseqFsm_start_reg_D_IN =
	     MUX_flashC_wseqFsm_start_reg_write_1__SEL_1 ;
  assign flashC_wseqFsm_start_reg_EN =
	     WILL_FIRE_RL_flashC_nextRequest && !flashC_reqF_D_OUT[40] ||
	     WILL_FIRE_RL_flashC_wseqFsm_fsm_start ;

  // register flashC_wseqFsm_start_reg_1
  assign flashC_wseqFsm_start_reg_1_D_IN = flashC_wseqFsm_start_wire_whas ;
  assign flashC_wseqFsm_start_reg_1_EN = 1'd1 ;

  // register flashC_wseqFsm_state_can_overlap
  assign flashC_wseqFsm_state_can_overlap_D_IN =
	     flashC_wseqFsm_state_set_pw_whas ||
	     flashC_wseqFsm_state_can_overlap ;
  assign flashC_wseqFsm_state_can_overlap_EN = 1'd1 ;

  // register flashC_wseqFsm_state_fired
  assign flashC_wseqFsm_state_fired_D_IN = flashC_wseqFsm_state_set_pw_whas ;
  assign flashC_wseqFsm_state_fired_EN = 1'd1 ;
  ...
  begin
    case (1'b1) // synopsys parallel_case
      WILL_FIRE_RL_flashC_wseqFsm_idle_l69c15:
	  flashC_wseqFsm_state_mkFSMstate_D_IN = 5'd0;
      WILL_FIRE_RL_flashC_wseqFsm_action_l70c12:
	  flashC_wseqFsm_state_mkFSMstate_D_IN = 5'd1;
      WILL_FIRE_RL_flashC_wseqFsm_action_l71c12:
	  flashC_wseqFsm_state_mkFSMstate_D_IN = 5'd2;
      WILL_FIRE_RL_flashC_wseqFsm_action_l72c12:
	  flashC_wseqFsm_state_mkFSMstate_D_IN = 5'd3;
      WILL_FIRE_RL_flashC_wseqFsm_action_l73c12:
	  flashC_wseqFsm_state_mkFSMstate_D_IN = 5'd4;
      WILL_FIRE_RL_flashC_wseqFsm_action_d_init_np:
	  flashC_wseqFsm_state_mkFSMstate_D_IN = 5'd5;
      WILL_FIRE_RL_flashC_wseqFsm_action_np:
	  flashC_wseqFsm_state_mkFSMstate_D_IN = 5'd6;
      WILL_FIRE_RL_flashC_wseqFsm_action_l75c12:
	  flashC_wseqFsm_state_mkFSMstate_D_IN = 5'd7;
      WILL_FIRE_RL_flashC_wseqFsm_action_l76c12:
	  flashC_wseqFsm_state_mkFSMstate_D_IN = 5'd8;
      WILL_FIRE_RL_flashC_wseqFsm_action_np_1:
	  flashC_wseqFsm_state_mkFSMstate_D_IN = 5'd9;
      WILL_FIRE_RL_flashC_wseqFsm_action_l78c12:
	  flashC_wseqFsm_state_mkFSMstate_D_IN = 5'd10;
      WILL_FIRE_RL_flashC_wseqFsm_action_l79c12:
	  flashC_wseqFsm_state_mkFSMstate_D_IN = 5'd11;
      WILL_FIRE_RL_flashC_wseqFsm_action_l80c12:
	  flashC_wseqFsm_state_mkFSMstate_D_IN = 5'd12;
      WILL_FIRE_RL_flashC_wseqFsm_action_d_init_np_1:
	  flashC_wseqFsm_state_mkFSMstate_D_IN = 5'd13;
      WILL_FIRE_RL_flashC_wseqFsm_action_np_2:
	  flashC_wseqFsm_state_mkFSMstate_D_IN = 5'd14;
      WILL_FIRE_RL_flashC_wseqFsm_action_l82c12:
	  flashC_wseqFsm_state_mkFSMstate_D_IN = 5'd15;
      WILL_FIRE_RL_flashC_wseqFsm_action_l83c12:
	  flashC_wseqFsm_state_mkFSMstate_D_IN = 5'd16;
      WILL_FIRE_RL_flashC_wseqFsm_action_l84c12:
	  flashC_wseqFsm_state_mkFSMstate_D_IN = 5'd17;
      WILL_FIRE_RL_flashC_wseqFsm_action_np_3:
	  flashC_wseqFsm_state_mkFSMstate_D_IN = 5'd18;
      WILL_FIRE_RL_flashC_wseqFsm_action_l87c12:
	  flashC_wseqFsm_state_mkFSMstate_D_IN = 5'd19;
      WILL_FIRE_RL_flashC_wseqFsm_action_l88c12:
	  flashC_wseqFsm_state_mkFSMstate_D_IN = 5'd20;
      WILL_FIRE_RL_flashC_wseqFsm_action_d_init_np_2:
	  flashC_wseqFsm_state_mkFSMstate_D_IN = 5'd21;
      WILL_FIRE_RL_flashC_wseqFsm_action_np_4:
	  flashC_wseqFsm_state_mkFSMstate_D_IN = 5'd22;
      WILL_FIRE_RL_flashC_wseqFsm_action_l90c12:
	  flashC_wseqFsm_state_mkFSMstate_D_IN = 5'd23;
      WILL_FIRE_RL_flashC_wseqFsm_action_l91c12:
	  flashC_wseqFsm_state_mkFSMstate_D_IN = 5'd24;
      default: flashC_wseqFsm_state_mkFSMstate_D_IN =
		   5'b01010 /* unspecified value */ ;
    endcase
  end
  assign flashC_wseqFsm_state_mkFSMstate_EN =
	     WILL_FIRE_RL_flashC_wseqFsm_idle_l69c15 ||
	     WILL_FIRE_RL_flashC_wseqFsm_action_l70c12 ||
	     WILL_FIRE_RL_flashC_wseqFsm_action_l71c12 ||
	     WILL_FIRE_RL_flashC_wseqFsm_action_l72c12 ||
  ...
  // register flashCtrl
  assign flashCtrl_D_IN = wci_wslv_reqF_D_OUT[31:0] ;
  assign flashCtrl_EN =
  ...
  // register wdReg
  assign wdReg_D_IN = wci_wslv_reqF_D_OUT[31:0] ;
  assign wdReg_EN =
	     WILL_FIRE_RL_wci_cfwr && wci_wslv_reqF_D_OUT[39:32] == 8'h0C ;

  // submodule flashC_reqF
  assign flashC_reqF_D_IN =
	     MUX_splitReadInFlight_write_1__SEL_2 ?
	       MUX_flashC_reqF_enq_1__VAL_1 :
	       MUX_flashC_reqF_enq_1__VAL_2 ;
  assign flashC_reqF_ENQ =
	     WILL_FIRE_RL_wci_cfrd && wci_wslv_reqF_D_OUT[51] ||
	     WILL_FIRE_RL_wci_cfwr &&
	     (wci_wslv_reqF_D_OUT[39:32] == 8'h14 ||
	      wci_wslv_reqF_D_OUT[39:32] == 8'h18) ;
  assign flashC_reqF_DEQ = WILL_FIRE_RL_flashC_nextRequest ;
  assign flashC_reqF_CLR = 1'b0 ;

  // submodule flashC_respF
  assign flashC_respF_D_IN = flashC_tsd_O ;
  assign flashC_respF_ENQ = WILL_FIRE_RL_flashC_rseqFsm_action_l63c10 ;
  assign flashC_respF_DEQ = WILL_FIRE_RL_advance_response ;
  assign flashC_respF_CLR = 1'b0 ;
  ...
  // remaining internal signals
  assign IF_flashC_reqF_first__65_BIT_40_66_THEN_flashC_ETC___d371 =
	     flashC_reqF_D_OUT[40] ?
	       flashC_rseqFsm_abort_whas__58_AND_flashC_rseqF_ETC___d225 &&
	       !flashC_rseqFsm_start_reg :
	       flashC_wseqFsm_abort_whas__31_AND_flashC_wseqF_ETC___d361 &&
	       !flashC_wseqFsm_start_reg ;
  ...
  assign flashC_rseqFsm_abort_whas__58_AND_flashC_rseqF_ETC___d225 =
	     (flashC_rseqFsm_state_mkFSMstate == 4'd0 ||
	      flashC_rseqFsm_state_mkFSMstate == 4'd7) &&
	     (!flashC_rseqFsm_start_reg_1 || flashC_rseqFsm_state_fired) ;
  assign flashC_wseqFsm_abort_whas__31_AND_flashC_wseqF_ETC___d361 =
	     (flashC_wseqFsm_state_mkFSMstate == 5'd0 ||
	      flashC_wseqFsm_state_mkFSMstate == 5'd24) &&
	     (!flashC_wseqFsm_start_reg_1 || flashC_wseqFsm_state_fired) ;
  assign flashStatus__h86674 = { 31'd1, flashC_waitReg } ;
  assign g_data__h87561 =
	     wci_wslv_reqF_D_OUT[51] ?
	       32'd0 :
	       IF_wci_wslv_reqF_first__3_BITS_39_TO_32_89_EQ__ETC___d442 ;
  assign wci_wslv_reqF_i_notEmpty__2_AND_IF_wci_wslv_re_ETC___d426 =
	     wci_wslv_reqF_EMPTY_N &&
	     (wci_wslv_reqF_D_OUT[51] ?
		flashC_reqF_FULL_N :
		wci_wslv_respF_cntr_r != 2'd2) ;
  assign wci_wslv_reqF_i_notEmpty__2_AND_wci_wslv_reqF__ETC___d404 =
	     wci_wslv_reqF_EMPTY_N &&
	     ((wci_wslv_reqF_D_OUT[39:32] == 8'h14) ?
		flashC_reqF_FULL_N :
		wci_wslv_reqF_D_OUT[39:32] != 8'h18 || flashC_reqF_FULL_N) ;
  assign wci_wslv_respF_cntr_r_8_MINUS_1___d27 =
	     wci_wslv_respF_cntr_r - 2'd1 ;
  assign x_addr__h87461 = { 5'h0, wci_wslv_reqF_D_OUT[50:34], 2'b0 } ;
  always@(wci_wslv_reqF_D_OUT or
	  flashStatus__h86674 or flashCtrl or aReg or wdReg or rdReg)
  begin
    case (wci_wslv_reqF_D_OUT[39:32])
	  ...
	  IF_wci_wslv_reqF_first__3_BITS_39_TO_32_89_EQ__ETC___d442 =
	      flashCtrl;
      8'h08: IF_wci_wslv_reqF_first__3_BITS_39_TO_32_89_EQ__ETC___d442 = aReg;
      8'h0C:
	  IF_wci_wslv_reqF_first__3_BITS_39_TO_32_89_EQ__ETC___d442 = wdReg;
      8'h10:
	  IF_wci_wslv_reqF_first__3_BITS_39_TO_32_89_EQ__ETC___d442 = rdReg;
      default: IF_wci_wslv_reqF_first__3_BITS_39_TO_32_89_EQ__ETC___d442 =
		   32'd0;
    endcase
  end
  ...
  begin
	...
	flashC_wseqFsm_jj_1_delay_count <= `BSV_ASSIGNMENT_DELAY 7'd1;
	...
	if (flashC_aReg_EN)
	  flashC_aReg <= `BSV_ASSIGNMENT_DELAY flashC_aReg_D_IN;
	if (flashC_ceReg_EN)
	  flashC_ceReg <= `BSV_ASSIGNMENT_DELAY flashC_ceReg_D_IN;
	if (flashC_isRead_EN)
	  flashC_isRead <= `BSV_ASSIGNMENT_DELAY flashC_isRead_D_IN;
	if (flashC_oeReg_EN)
	  flashC_oeReg <= `BSV_ASSIGNMENT_DELAY flashC_oeReg_D_IN;
	if (flashC_rseqFsm_jj_delay_count_EN)
	  flashC_rseqFsm_jj_delay_count <= `BSV_ASSIGNMENT_DELAY
	      flashC_rseqFsm_jj_delay_count_D_IN;
	if (flashC_rseqFsm_start_reg_EN)
	  flashC_rseqFsm_start_reg <= `BSV_ASSIGNMENT_DELAY
	      flashC_rseqFsm_start_reg_D_IN;
	if (flashC_rseqFsm_start_reg_1_EN)
	  flashC_rseqFsm_start_reg_1 <= `BSV_ASSIGNMENT_DELAY
	      flashC_rseqFsm_start_reg_1_D_IN;
	if (flashC_rseqFsm_state_can_overlap_EN)
	  flashC_rseqFsm_state_can_overlap <= `BSV_ASSIGNMENT_DELAY
	      flashC_rseqFsm_state_can_overlap_D_IN;
	if (flashC_rseqFsm_state_fired_EN)
	  flashC_rseqFsm_state_fired <= `BSV_ASSIGNMENT_DELAY
	      flashC_rseqFsm_state_fired_D_IN;
	if (flashC_rseqFsm_state_mkFSMstate_EN)
	  flashC_rseqFsm_state_mkFSMstate <= `BSV_ASSIGNMENT_DELAY
	      flashC_rseqFsm_state_mkFSMstate_D_IN;
	if (flashC_tmpWD_EN)
	  flashC_tmpWD <= `BSV_ASSIGNMENT_DELAY flashC_tmpWD_D_IN;
	if (flashC_tsOE_EN)
	  flashC_tsOE <= `BSV_ASSIGNMENT_DELAY flashC_tsOE_D_IN;
	if (flashC_tsWD_EN)
	  flashC_tsWD <= `BSV_ASSIGNMENT_DELAY flashC_tsWD_D_IN;
	if (flashC_wdReg_EN)
	  flashC_wdReg <= `BSV_ASSIGNMENT_DELAY flashC_wdReg_D_IN;
	if (flashC_weReg_EN)
	  flashC_weReg <= `BSV_ASSIGNMENT_DELAY flashC_weReg_D_IN;
	if (flashC_wseqFsm_jj_1_delay_count_EN)
	  flashC_wseqFsm_jj_1_delay_count <= `BSV_ASSIGNMENT_DELAY
	      flashC_wseqFsm_jj_1_delay_count_D_IN;
	if (flashC_wseqFsm_jj_2_delay_count_EN)
	  flashC_wseqFsm_jj_2_delay_count <= `BSV_ASSIGNMENT_DELAY
	      flashC_wseqFsm_jj_2_delay_count_D_IN;
	if (flashC_wseqFsm_jj_delay_count_EN)
	  flashC_wseqFsm_jj_delay_count <= `BSV_ASSIGNMENT_DELAY
	      flashC_wseqFsm_jj_delay_count_D_IN;
	if (flashC_wseqFsm_start_reg_EN)
	  flashC_wseqFsm_start_reg <= `BSV_ASSIGNMENT_DELAY
	      flashC_wseqFsm_start_reg_D_IN;
	if (flashC_wseqFsm_start_reg_1_EN)
	  flashC_wseqFsm_start_reg_1 <= `BSV_ASSIGNMENT_DELAY
	      flashC_wseqFsm_start_reg_1_D_IN;
	if (flashC_wseqFsm_state_can_overlap_EN)
	  flashC_wseqFsm_state_can_overlap <= `BSV_ASSIGNMENT_DELAY
	      flashC_wseqFsm_state_can_overlap_D_IN;
	if (flashC_wseqFsm_state_fired_EN)
	  flashC_wseqFsm_state_fired <= `BSV_ASSIGNMENT_DELAY
	      flashC_wseqFsm_state_fired_D_IN;
	if (flashC_wseqFsm_state_mkFSMstate_EN)
	  flashC_wseqFsm_state_mkFSMstate <= `BSV_ASSIGNMENT_DELAY
	      flashC_wseqFsm_state_mkFSMstate_D_IN;
	if (flashCtrl_EN) flashCtrl <= `BSV_ASSIGNMENT_DELAY flashCtrl_D_IN;
	if (rdReg_EN) rdReg <= `BSV_ASSIGNMENT_DELAY rdReg_D_IN;
    ...
    if (flashC_waitReg_EN)
      flashC_waitReg <= `BSV_ASSIGNMENT_DELAY flashC_waitReg_D_IN;
  end
  ...
  begin
    ...
    flashC_weReg = 1'h0;
    flashC_wseqFsm_jj_1_delay_count = 7'h2A;
