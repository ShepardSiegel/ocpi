...
//
// On Wed Oct 30 08:48:01 EDT 2013
//
//
// Ports:
// Name                         I/O  size props
...
module mkFlashWorker(wciS0_Clk,
  ...
  wire flashC_rseqFsm_abort$wget,
       ...
       flashC_rseqFsm_start_reg_2$wget,
       flashC_rseqFsm_start_reg_2$whas,
       ...
       flashC_wseqFsm_start_reg_2$wget,
       flashC_wseqFsm_start_reg_2$whas,
  ...
  wire [6 : 0] flashC_wseqFsm_jj_1_delay_count$D_IN;
  wire flashC_wseqFsm_jj_1_delay_count$EN;
  ...
  wire [6 : 0] MUX_flashC_wseqFsm_jj_1_delay_count$write_1__VAL_1,
  ...
  assign MUX_wci_wslv_respF_x_wire$wset_1__SEL_2 =
	     WILL_FIRE_RL_wci_cfrd && !wci_wslv_reqF$D_OUT[51] ;
  assign MUX_flashC_reqF$enq_1__VAL_1 = { 1'd1, x_addr__h87461, 16'hAAAA } ;
  assign MUX_flashC_reqF$enq_1__VAL_2 =
  ...
  assign MUX_flashC_wseqFsm_jj_1_delay_count$write_1__VAL_1 =
  ...
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_2 = { 2'd1, g_data__h87561 } ;
  ...
  assign flashC_rseqFsm_start_reg_2$wget = 1'd1 ;
  assign flashC_rseqFsm_start_reg_2$whas = flashC_rseqFsm_start_wire$whas ;
  ...
  assign flashC_wseqFsm_start_reg_2$wget = 1'd1 ;
  assign flashC_wseqFsm_start_reg_2$whas = flashC_wseqFsm_start_wire$whas ;
  ...
  // register flashC_wseqFsm_jj_1_delay_count
  assign flashC_wseqFsm_jj_1_delay_count$D_IN =
	     WILL_FIRE_RL_flashC_wseqFsm_action_np_2 ?
	       MUX_flashC_wseqFsm_jj_1_delay_count$write_1__VAL_1 :
	       7'd1 ;
  assign flashC_wseqFsm_jj_1_delay_count$EN =
	     WILL_FIRE_RL_flashC_wseqFsm_action_np_2 ||
	     WILL_FIRE_RL_flashC_wseqFsm_action_d_init_np_1 ;
  ...
  assign wci_wslv_respF_cntr_r_8_MINUS_1___d27 =
	     wci_wslv_respF_cntr_r - 2'd1 ;
  assign x_addr__h87461 = { 5'h0, wci_wslv_reqF$D_OUT[50:34], 2'b0 } ;
  ...
  begin
	...
	if (flashC_wseqFsm_jj_1_delay_count$EN)
	  flashC_wseqFsm_jj_1_delay_count <= `BSV_ASSIGNMENT_DELAY
	      flashC_wseqFsm_jj_1_delay_count$D_IN;
