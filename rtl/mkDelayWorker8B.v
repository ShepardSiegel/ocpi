...
//
// On Tue Jul 13 07:46:15 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker8B(wciS0_Clk,
  ...
  reg [63 : 0] v__h17546,
	       ...
	       v__h2820,
	       v__h3719;
  reg [31 : 0] x_data__h22179;
  reg CASE_wrtSerPos_0b1_0_1_1_1_2_1_3_0b1__q1,
      CASE_wrtSerPos_NOT_wrtSerPos_EQ_3_OR_wide16Fa_ETC__q2;
  wire [127 : 0] IF_wrtSerPos_44_EQ_2_47_THEN_0x0_ELSE_mesgWF_w_ETC___d388,
		 IF_wrtSerPos_44_EQ_2_47_THEN_0x0_ELSE_metaWF_f_ETC___d413,
		 x1__h19941,
		 x1__h19972,
		 x1__h20637,
		 x1__h20664;
  wire [63 : 0] x__h15357, x__h19802;
  wire [35 : 0] addr__h21209, addr__h21477;
  wire [31 : 0] rdat__h22206,
		rdat__h22212,
		rdat__h22219,
		rdat__h22225,
		rdat__h22349,
		...
		rdat__h22472,
		v__h23184;
  wire [26 : 0] x__h21267, x__h21522;
  wire [23 : 0] x1_length__h17239, x__h22229;
  wire [13 : 0] mlp1__h17940, x__h17283;
  wire [12 : 0] x__h15249;
  wire [11 : 0] x_burstLength__h22903;
  wire [7 : 0] x1_opcode__h17238, x_byteEn__h22904;
  wire [1 : 0] wrtSerPos_44_PLUS_1___d1045;
  wire IF_wrtSerPos_44_EQ_0_45_OR_wrtSerPos_44_EQ_1_4_ETC___d364,
       NOT_dlyWordsStored_value_27_SLE_0_84_85_AND_NO_ETC___d292,
       NOT_wmemi_reqF_c_r_77_EQ_2_78_79_AND_NOT_wmemi_ETC___d318,
       NOT_wrtSerPos_44_EQ_3_51_52_AND_NOT_metaWF_fir_ETC___d400,
       ...
       wci_cState_9_EQ_2_0_AND_dlyCtrl_5_BITS_3_TO_0__ETC___d328,
       wci_cState_9_EQ_2_0_AND_dlyCtrl_5_BITS_3_TO_0__ETC___d433,
       wsiS_reqFifo_notFull__32_AND_wsiS_burstKind_12_ETC___d748;
  ...
  assign WILL_FIRE_RL_cycles_passed_count = wsiS_statusR[0] ;
  assign CAN_FIRE_RL_cycles_passed_count = WILL_FIRE_RL_cycles_passed_count ;
  ...
  assign CAN_FIRE_RL_wrtSer_body =
	     ...
	     IF_wrtSerPos_44_EQ_0_45_OR_wrtSerPos_44_EQ_1_4_ETC___d364 &&
	     wci_cState == 3'd2 &&
	     dlyCtrl[3:0] == 4'h7 &&
	     wrtSerUnroll != 16'd0 ;
  ...
  assign MUX_mesgLength$write_1__VAL_3 = { 1'd1, mlp1__h17940[10:0], 3'd0 } ;
  ...
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_1 = { 4'd5, addr__h21209, 12'd1 } ;
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_2 = { 4'd3, addr__h21477, 12'd1 } ;
  assign MUX_rdSyncWord$write_1__VAL_2 =
	     rdSerPos != 2'd3 && v__h23184[23:0] == 24'd0 ;
  assign MUX_wsiM_reqFifo_x_wire$wset_1__VAL_1 =
	     { 3'd1,
	       unrollCnt == 16'd1,
	       1'd1,
	       x_burstLength__h22903,
	       mesgRF$D_OUT,
	       x_byteEn__h22904,
	       readMeta[31:24] } ;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_1 = { 2'd1, x_data__h22179 } ;
  ...
  always@(wrtSerPos or
	  IF_wrtSerPos_44_EQ_2_47_THEN_0x0_ELSE_mesgWF_w_ETC___d388 or
	  x1__h19941 or x1__h19972)
  begin
    case (wrtSerPos)
      2'd0: MUX_wide16Fa$enq_1__VAL_2 = x1__h19941;
      2'd1: MUX_wide16Fa$enq_1__VAL_2 = x1__h19972;
      default: MUX_wide16Fa$enq_1__VAL_2 =
		   IF_wrtSerPos_44_EQ_2_47_THEN_0x0_ELSE_mesgWF_w_ETC___d388;
    endcase
  end
  ...
  always@(wrtSerPos or
	  IF_wrtSerPos_44_EQ_2_47_THEN_0x0_ELSE_metaWF_f_ETC___d413 or
	  x1__h20637 or x1__h20664)
  begin
    case (wrtSerPos)
      2'd0: MUX_wide16Fa$enq_1__VAL_1 = x1__h20637;
      2'd1: MUX_wide16Fa$enq_1__VAL_1 = x1__h20664;
      default: MUX_wide16Fa$enq_1__VAL_1 =
		   IF_wrtSerPos_44_EQ_2_47_THEN_0x0_ELSE_metaWF_f_ETC___d413;
    endcase
  end
  assign MUX_wrtSerPos$write_1__VAL_1 =
	     (wrtSerUnroll == 16'd1) ? 2'd0 : wrtSerPos_44_PLUS_1___d1045 ;
  assign MUX_wrtSerPos$write_1__VAL_2 =
	     (metaWF$D_OUT[23:0] == 24'd0) ?
	       2'd0 :
	       wrtSerPos_44_PLUS_1___d1045 ;
  ...
  assign wrtSerStage$D_IN =
	     MUX_wrtSerStage$write_1__SEL_1 ? x__h19802[31:0] : metaWF$D_OUT ;
  ...
  assign mesgRF$D_IN = { 32'd0, v__h23184 } ;
  ...
  // remaining internal signals
  assign IF_wrtSerPos_44_EQ_0_45_OR_wrtSerPos_44_EQ_1_4_ETC___d364 =
	     CASE_wrtSerPos_0b1_0_1_1_1_2_1_3_0b1__q1 &&
	     (wrtSerPos != 2'd3 && wrtSerUnroll != 16'd1 ||
	      CASE_wrtSerPos_NOT_wrtSerPos_EQ_3_OR_wide16Fa_ETC__q2) ;
  assign IF_wrtSerPos_44_EQ_2_47_THEN_0x0_ELSE_mesgWF_w_ETC___d388 =
	     { (wrtSerPos == 2'd2) ? 32'h0 : x__h19802[31:0],
	       (wrtSerPos == 2'd2) ? x__h19802[31:0] : wrtSerStage_2,
	       wrtSerStage_1,
	       wrtSerStage } ;
  assign IF_wrtSerPos_44_EQ_2_47_THEN_0x0_ELSE_metaWF_f_ETC___d413 =
	     { (wrtSerPos == 2'd2) ? 32'h0 : metaWF$D_OUT,
	       (wrtSerPos == 2'd2) ? metaWF$D_OUT : wrtSerStage_2,
	       wrtSerStage_1,
	       wrtSerStage } ;
  assign NOT_dlyWordsStored_value_27_SLE_0_84_85_AND_NO_ETC___d292 =
	     (dlyWordsStored_value ^ 24'h800000) > 24'd8388608 &&
	     bytesWritten >= dlyHoldoffBytes &&
	     cyclesPassed >= dlyHoldoffCycles ;
  assign NOT_wmemi_reqF_c_r_77_EQ_2_78_79_AND_NOT_wmemi_ETC___d318 =
	     wmemi_reqF_c_r != 2'd2 && wmemi_dhF_c_r != 2'd2 &&
	     wmemi_operateD &&
	     wmemi_peerIsReady ;
  assign NOT_wrtSerPos_44_EQ_3_51_52_AND_NOT_metaWF_fir_ETC___d400 =
	     wrtSerPos != 2'd3 && metaWF$D_OUT[23:0] != 24'd0 ||
	     CASE_wrtSerPos_NOT_wrtSerPos_EQ_3_OR_wide16Fa_ETC__q2 ;
  assign _dor1bytesWritten$EN_write =
	     WILL_FIRE_RL_wmwt_messagePushPrecise ||
	     WILL_FIRE_RL_wmwt_messagePushImprecise ;
  assign addr__h21209 = { 9'd0, x__h21267 } ;
  assign addr__h21477 = { 9'd0, x__h21522 } ;
  ...
  assign rdat__h22206 = hasDebugLogic ? mesgWtCount : 32'd0 ;
  assign rdat__h22212 = hasDebugLogic ? mesgRdCount : 32'd0 ;
  assign rdat__h22219 = hasDebugLogic ? bytesWritten : 32'd0 ;
  assign rdat__h22225 = hasDebugLogic ? { 8'd0, x__h22229 } : 32'd0 ;
  assign rdat__h22349 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h22363 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h22371 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h22377 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h22391 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h22399 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h22405 = hasDebugLogic ? wmemiWrReq : 32'd0 ;
  assign rdat__h22411 = hasDebugLogic ? wmemiRdReq : 32'd0 ;
  assign rdat__h22417 = hasDebugLogic ? wmemiRdResp : 32'd0 ;
  assign rdat__h22423 =
	     hasDebugLogic ? { 8'd0, dlyWordsStored_value } : 32'd0 ;
  assign rdat__h22433 =
	     hasDebugLogic ? { 24'd0, dlyReadCredit_value } : 32'd0 ;
  assign rdat__h22443 = hasDebugLogic ? { 9'd0, dlyWAG } : 32'd0 ;
  assign rdat__h22453 = hasDebugLogic ? { 9'd0, dlyRAG } : 32'd0 ;
  assign rdat__h22463 = { {24{dlyMaxReadCredit[7]}}, dlyMaxReadCredit } ;
  assign rdat__h22472 =
	     { {24{dlyReadCredit_value[7]}}, dlyReadCredit_value } ;
  assign v__h23184 = metaRF$D_IN ;
  assign wci_cState_9_EQ_2_0_AND_dlyCtrl_5_BITS_3_TO_0__ETC___d328 =
	     wci_cState == 3'd2 && dlyCtrl[3:0] == 4'h7 &&
	     ((dlyWriteJustFired || dlyWriteFlush == 8'd255) ?
		(dlyReadyToWrite_value ^ 5'h10) > 5'd16 :
		(dlyReadyToWrite_value ^ 5'h10) > 5'd19) ;
  assign wci_cState_9_EQ_2_0_AND_dlyCtrl_5_BITS_3_TO_0__ETC___d433 =
	     wci_cState == 3'd2 && dlyCtrl[3:0] == 4'h7 && mesgLength[14] &&
	     !doAbort &&
	     (preciseBurst && wsiWordsRemain == 12'd0 ||
	      impreciseBurst && endOfMessage) ;
  assign wrtSerPos_44_PLUS_1___d1045 = wrtSerPos + 2'd1 ;
  assign wsiS_reqFifo_notFull__32_AND_wsiS_burstKind_12_ETC___d748 =
	     wsiS_reqFifo$FULL_N &&
	     (wsiS_burstKind == 2'd0 ||
	      (wsiS_burstKind == 2'd1 || wsiS_burstKind == 2'd2) &&
	      wsiS_wsiReq$wget[93]) ;
  assign x1__h19941 = { 96'd0, x__h19802[31:0] } ;
  assign x1__h19972 = { 64'd0, x__h19802[31:0], wrtSerStage } ;
  assign x1__h20637 = { 96'd0, metaWF$D_OUT } ;
  assign x1__h20664 = { 64'd0, metaWF$D_OUT, wrtSerStage } ;
  ...
  assign x__h19802 = mesgWF_wDataOut$wget ;
  assign x__h21267 = { dlyRAG, 4'h0 } ;
  assign x__h21522 = { dlyWAG, 4'h0 } ;
  assign x__h22229 = { wmemi_statusR, wsiS_statusR, wsiM_statusR } ;
  assign x_burstLength__h22903 =
	     (readMeta[23:0] == 24'd0) ? 12'd1 : readMeta[14:3] ;
  assign x_byteEn__h22904 = (readMeta[23:0] == 24'd0) ? 8'd0 : 8'd255 ;
  always@(wci_reqF$D_OUT or
	  ...
	  rdat__h22423 or
	  rdat__h22433 or
	  rdat__h22443 or rdat__h22453 or rdat__h22463 or rdat__h22472)
  begin
    case (wci_reqF$D_OUT[51:32])
      20'h0: x_data__h22179 = dlyCtrl;
      20'h00004: x_data__h22179 = dlyHoldoffBytes;
      20'h00008: x_data__h22179 = dlyHoldoffCycles;
      20'h0000C: x_data__h22179 = rdat__h22206;
      20'h00010: x_data__h22179 = rdat__h22212;
      20'h00014: x_data__h22179 = rdat__h22219;
      20'h00018: x_data__h22179 = rdat__h22225;
      20'h0001C: x_data__h22179 = 32'd0;
      20'h00020: x_data__h22179 = rdat__h22349;
      20'h00024: x_data__h22179 = rdat__h22363;
      20'h00028: x_data__h22179 = rdat__h22371;
      20'h0002C: x_data__h22179 = rdat__h22377;
      20'h00030: x_data__h22179 = rdat__h22391;
      20'h00034: x_data__h22179 = rdat__h22399;
      20'h00038: x_data__h22179 = rdat__h22405;
      20'h0003C: x_data__h22179 = rdat__h22411;
      20'h00040: x_data__h22179 = rdat__h22417;
      20'h00044: x_data__h22179 = rdat__h22423;
      20'h00048: x_data__h22179 = rdat__h22433;
      20'h0004C: x_data__h22179 = rdat__h22443;
      20'h00050: x_data__h22179 = rdat__h22453;
      20'h00054: x_data__h22179 = rdat__h22463;
      20'h00058: x_data__h22179 = rdat__h22472;
      default: x_data__h22179 = 32'd0;
    endcase
  end
  always@(wrtSerPos)
  begin
