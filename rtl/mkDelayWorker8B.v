...
//
// On Wed Oct 13 07:01:32 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker8B(wciS0_Clk,
  ...
  wire [127 : 0] IF_wrtSerPos_80_EQ_2_83_THEN_0x0_ELSE_mesgWF_w_ETC___d423,
		 ...
		 x__h18796,
		 x__h18823;
  wire [63 : 0] x__h15075, x__h17995;
  wire [35 : 0] addr__h19480, addr__h19649;
  wire [31 : 0] delayStatus__h21799,
		rdat__h22257,
		rdat__h22263,
		rdat__h22269,
		rdat__h22275,
  ...
  assign MUX_rdSyncWord$write_1__VAL_2 =
	     rdSerPos != 2'd3 && v__h20256[23:0] == 24'd0 ;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_1 = { 2'd1, x_data__h22230 } ;
  ...
  assign dlyRdOpOther$EN =
	     WILL_FIRE_RL_rdSer_begin && v__h20256[31:24] != 8'd0 ;
  ...
  assign wrtSerStage$D_IN =
	     MUX_wrtSerStage$write_1__SEL_1 ? x__h17995[31:0] : metaWF$D_OUT ;
  ...
  assign mesgRF$D_IN = { 32'd0, v__h20256 } ;
  ...
  assign IF_wrtSerPos_80_EQ_2_83_THEN_0x0_ELSE_mesgWF_w_ETC___d423 =
	     { (wrtSerPos == 2'd2) ? 32'h0 : x__h17995[31:0],
	       (wrtSerPos == 2'd2) ? x__h17995[31:0] : wrtSerStage_2,
	       wrtSerStage_1,
	       wrtSerStage } ;
  ...
  assign x__h15075 =
	     CAN_FIRE_RL_wmwt_mesg_ingress ?
	       ...
	       64'd0 ;
  assign x__h17995 = mesgWF_wDataOut$wget ;
  assign x__h18134 = { 96'd0, x__h17995[31:0] } ;
  assign x__h18165 = { 64'd0, x__h17995[31:0], wrtSerStage } ;
  ...
  assign x_byteEn__h19979 = (readMeta[23:0] == 24'd0) ? 8'd0 : 8'd255 ;
  always@(wrtSerPos)
  begin
    case (wrtSerPos)
