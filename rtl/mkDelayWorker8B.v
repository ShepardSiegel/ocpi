...
//
// On Sun Dec 19 11:20:55 EST 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker8B(wciS0_Clk,
  ...
  // submodule mesgRF
  assign mesgRF$D_IN = { 32'd0, v__h19843 } ;
  ...
  assign btm__h17357 =
		 ...
		 { 7'd0, mesgLengthSoFar_65_PLUS_1___d970 },
	       3'd0 } ;
  ...
  assign x_byteEn__h21716 = (readMeta[23:0] == 24'd0) ? 8'd0 : 8'd255 ;
  always@(rdSerPos or
