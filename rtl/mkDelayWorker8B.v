...
//
// On Thu Jan 19 16:21:46 EST 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker8B(wciS0_Clk,
  ...
  wire [127 : 0] IF_wrtSerPos_90_EQ_2_00_THEN_0x0_ELSE_mesgWF_w_ETC___d558,
		 ...
		 x__h19431,
		 x__h19455;
  wire [63 : 0] x__h15541, x__h19298;
  wire [35 : 0] addr__h19855, addr__h20205;
  wire [31 : 0] delayStatus__h22485,
		rdat__h22890,
		rdat__h22896,
		rdat__h22902,
		rdat__h22908,
  ...
  wire [13 : 0] mesgLengthSoFar_73_PLUS_1___d955;
  wire [12 : 0] x__h15642;
  wire [11 : 0] x_burstLength__h22392;
  wire [7 : 0] x_byteEn__h22393;
  wire [1 : 0] wrtSerPos_90_PLUS_1___d954;
  wire IF_wrtSerPos_90_EQ_0_98_OR_wrtSerPos_90_EQ_1_9_ETC___d543,
       ...
       bytesWritten_86_ULT_dlyHoldoffBytes_66___d989,
       cyclesPassed_56_ULT_dlyHoldoffCycles_69___d991,
       dlyWordsStored_value_17_SLE_0_65_OR_bytesWritt_ETC___d573,
       dlyWordsStored_value_17_SLE_0___d992,
  ...
  assign MUX_wrtSerPos$write_1__VAL_1 =
	     (metaWF$D_OUT[23:0] == 24'd0) ?
	       2'd0 :
	       wrtSerPos_90_PLUS_1___d954 ;
  assign MUX_wrtSerPos$write_1__VAL_2 =
	     (wrtSerUnroll == 16'd1) ? 2'd0 : wrtSerPos_90_PLUS_1___d954 ;
  ...
  assign mesgLengthSoFar$D_IN =
	     wsiS_reqFifo$D_OUT[93] ?
	       14'd0 :
	       mesgLengthSoFar_73_PLUS_1___d955 ;
  ...
  assign wrtSerStage$D_IN =
	     MUX_wrtSerStage$write_1__SEL_1 ? x__h19298[31:0] : metaWF$D_OUT ;
  ...
  // submodule mesgRF
  assign mesgRF$D_IN = { 32'd0, v__h20520 } ;
  ...
  assign IF_wrtSerPos_90_EQ_2_00_THEN_0x0_ELSE_mesgWF_w_ETC___d558 =
	     { (wrtSerPos == 2'd2) ? 32'h0 : x__h19298[31:0],
	       (wrtSerPos == 2'd2) ? x__h19298[31:0] : wrtSerStage_2,
	       wrtSerStage_1,
	       wrtSerStage } ;
  ...
  assign btm__h18030 =
		 ...
		 { 7'd0, mesgLengthSoFar_73_PLUS_1___d955 },
	       3'd0 } ;
  assign bytesWritten_86_ULT_dlyHoldoffBytes_66___d989 =
	     bytesWritten < dlyHoldoffBytes ;
  assign cyclesPassed_56_ULT_dlyHoldoffCycles_69___d991 =
  ...
  assign dlyWordsStored_value_17_SLE_0_65_OR_bytesWritt_ETC___d573 =
	     ...
	     wsiM_reqFifo_c_r == 2'd2 ||
	     tog50 ;
  assign dlyWordsStored_value_17_SLE_0___d992 =
  ...
  assign mesgLengthSoFar_73_PLUS_1___d955 = mesgLengthSoFar + 14'd1 ;
  ...
  assign wci_wslv_cState_6_EQ_2_7_AND_dlyCtrl_48_BITS_3_ETC___d593 =
	     ...
	     !bytesWritten_86_ULT_dlyHoldoffBytes_66___d989 &&
	     !cyclesPassed_56_ULT_dlyHoldoffCycles_69___d991 ;
  assign wrtSerPos_90_PLUS_1___d954 = wrtSerPos + 2'd1 ;
  assign x__h15541 =
	     WILL_FIRE_RL_wmwt_mesg_ingress ?
  ...
  assign x__h19298 = mesgWF_wDataOut$wget ;
  assign x__h19431 = { 96'd0, x__h19298[31:0] } ;
  assign x__h19455 = { 64'd0, x__h19298[31:0], wrtSerStage } ;
  ...
  assign x_byteEn__h22393 = (readMeta[23:0] == 24'd0) ? 8'd0 : 8'd255 ;
  always@(rdSerPos or
