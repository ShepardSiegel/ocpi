...
//
// On Tue Jun  1 12:37:39 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker8B(wciS0_Clk,
  ...
  wire [63 : 0] mesg__h20119, x__h15013, x__h15939, x__h18848;
  ...
  wire [7 : 0] x1_opcode__h16255, x_byteEn__h20211;
  ...
  assign MUX_mesgLength$write_1__VAL_3 = { 1'd1, mlp1__h16955[10:0], 3'd0 } ;
  ...
  assign mesgRF_wDataIn$wget = { 32'd0, v__h20432 } ;
  ...
  assign x__h15939 = CAN_FIRE_RL_rdSer_body ? mesgRF_wDataIn$wget : 64'd0 ;
  ...
  assign x_byteEn__h20211 = (readMeta[23:0] == 24'd0) ? 8'd0 : 8'd255 ;
  always@(wrtSerPos)
  begin
    case (wrtSerPos)
