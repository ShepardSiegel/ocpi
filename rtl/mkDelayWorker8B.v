...
//
// On Tue Jul 20 10:44:27 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker8B(wciS0_Clk,
  ...
  reg [31 : 0] x_data__h22372;
  reg CASE_wrtSerPos_0b1_0_1_1_1_2_1_3_0b1__q1,
      CASE_wrtSerPos_NOT_wrtSerPos_EQ_3_OR_wide16Fa_ETC__q2;
  wire [127 : 0] IF_wrtSerPos_88_EQ_2_91_THEN_0x0_ELSE_mesgWF_w_ETC___d432,
		 IF_wrtSerPos_88_EQ_2_91_THEN_0x0_ELSE_metaWF_f_ETC___d457,
		 x1__h18149,
		 x1__h18180,
		 x1__h18815,
		 x1__h18842;
  wire [63 : 0] x__h14851, x__h18010;
  wire [35 : 0] addr__h19499, addr__h19721;
  wire [31 : 0] delayStatus__h21941,
		rdat__h22399,
		rdat__h22405,
		rdat__h22411,
		rdat__h22417,
  ...
  wire [7 : 0] x_byteEn__h20115;
  wire [1 : 0] wrtSerPos_88_PLUS_1___d1000;
  wire IF_wrtSerPos_88_EQ_0_89_OR_wrtSerPos_88_EQ_1_9_ETC___d408,
       NOT_mesgWF_rRdPtr_65_EQ_mesgWF_rWrPtr_67_70___d171,
       NOT_mesgWF_rRdPtr_65_PLUS_2048_66_EQ_mesgWF_rW_ETC___d169,
       NOT_wrtSerPos_88_EQ_3_95_96_AND_NOT_metaWF_fir_ETC___d444,
       ...
       metaRF_RDY_enq__10_AND_NOT_rdSerEmpty_65_66_AN_ETC___d311,
       wci_cState_9_EQ_2_0_AND_dlyCtrl_5_BITS_3_TO_0__ETC___d351,
       wordsEnqued_61_EQ_wordsExact_62_MINUS_1_63___d928,
       wsiS_reqFifo_notFull__22_AND_wsiS_burstKind_02_ETC___d738;
  ...
  assign CAN_FIRE_RL_wrtSer_body =
	     NOT_mesgWF_rRdPtr_65_EQ_mesgWF_rWrPtr_67_70___d171 &&
	     IF_wrtSerPos_88_EQ_0_89_OR_wrtSerPos_88_EQ_1_9_ETC___d408 &&
	     wci_cState == 3'd2 &&
	     dlyCtrl[3:0] == 4'h7 &&
	     wrtSerUnroll != 16'd0 ;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_1 = { 2'd1, x_data__h22372 } ;
  ...
  assign MUX_rdSyncWord$write_1__VAL_2 =
	     rdSerPos != 2'd3 && v__h20396[23:0] == 24'd0 ;
  ...
  always@(wrtSerPos or
	  IF_wrtSerPos_88_EQ_2_91_THEN_0x0_ELSE_mesgWF_w_ETC___d432 or
  ...
  begin
    case (wrtSerPos)
      ...
      default: MUX_wide16Fa$enq_1__VAL_2 =
		   IF_wrtSerPos_88_EQ_2_91_THEN_0x0_ELSE_mesgWF_w_ETC___d432;
    endcase
  end
  always@(wrtSerPos or
	  IF_wrtSerPos_88_EQ_2_91_THEN_0x0_ELSE_metaWF_f_ETC___d457 or
  ...
  assign MUX_wrtSerPos$write_1__VAL_1 =
	     (wrtSerUnroll == 16'd1) ? 2'd0 : wrtSerPos_88_PLUS_1___d1000 ;
  assign MUX_wrtSerPos$write_1__VAL_2 =
	     (metaWF$D_OUT[23:0] == 24'd0) ?
	       2'd0 :
	       wrtSerPos_88_PLUS_1___d1000 ;
  ...
  assign wmemi_dhF_x_wire$wget = MUX_wmemi_dhF_q_1$write_1__VAL_2 ;
  ...
  assign dlyRdOpOther$EN =
	     WILL_FIRE_RL_rdSer_begin && v__h20396[31:24] != 8'd0 ;
  ...
  always@(WILL_FIRE_RL_wmemi_dhF_both or
	  ...
	  MUX_wmemi_dhF_q_1$write_1__VAL_2 or
  ...
  begin
    case (1'b1) // synopsys parallel_case
      ...
      MUX_wmemi_dhF_q_0$write_1__SEL_2:
	  wmemi_dhF_q_0$D_IN = MUX_wmemi_dhF_q_1$write_1__VAL_2;
  ...
  assign wrtSerStage$D_IN =
	     MUX_wrtSerStage$write_1__SEL_1 ? x__h18010[31:0] : metaWF$D_OUT ;
  ...
  assign mesgRF$D_IN = { 32'd0, v__h20396 } ;
  ...
  // remaining internal signals
  assign IF_wrtSerPos_88_EQ_0_89_OR_wrtSerPos_88_EQ_1_9_ETC___d408 =
	     CASE_wrtSerPos_0b1_0_1_1_1_2_1_3_0b1__q1 &&
	     (wrtSerPos != 2'd3 && wrtSerUnroll != 16'd1 ||
	      CASE_wrtSerPos_NOT_wrtSerPos_EQ_3_OR_wide16Fa_ETC__q2) ;
  assign IF_wrtSerPos_88_EQ_2_91_THEN_0x0_ELSE_mesgWF_w_ETC___d432 =
	     { (wrtSerPos == 2'd2) ? 32'h0 : x__h18010[31:0],
	       (wrtSerPos == 2'd2) ? x__h18010[31:0] : wrtSerStage_2,
	       wrtSerStage_1,
	       wrtSerStage } ;
  assign IF_wrtSerPos_88_EQ_2_91_THEN_0x0_ELSE_metaWF_f_ETC___d457 =
  ...
  assign NOT_wrtSerPos_88_EQ_3_95_96_AND_NOT_metaWF_fir_ETC___d444 =
	     wrtSerPos != 2'd3 && metaWF$D_OUT[23:0] != 24'd0 ||
	     CASE_wrtSerPos_NOT_wrtSerPos_EQ_3_OR_wide16Fa_ETC__q2 ;
  ...
  assign metaRF_RDY_enq__10_AND_NOT_rdSerEmpty_65_66_AN_ETC___d311 =
	     metaRF$FULL_N &&
	     (!rdSerEmpty && rdSerPos != 2'd0 || wide16Fc$EMPTY_N) ;
  ...
  assign v__h20396 = metaRF$D_IN ;
  assign wci_cState_9_EQ_2_0_AND_dlyCtrl_5_BITS_3_TO_0__ETC___d351 =
	     wci_cState == 3'd2 && dlyCtrl[3:0] == 4'h7 &&
	     !dlyWordsStored_value_27_SLE_0___d152 &&
	     !bytesWritten_7_ULT_dlyHoldoffBytes_7___d153 &&
	     !cyclesPassed_55_ULT_dlyHoldoffCycles_9___d156 ;
  assign wordsEnqued_61_EQ_wordsExact_62_MINUS_1_63___d928 =
	     wordsEnqued == wordsExact - 16'd1 ;
  assign wrtSerPos_88_PLUS_1___d1000 = wrtSerPos + 2'd1 ;
  assign wsiS_reqFifo_notFull__22_AND_wsiS_burstKind_02_ETC___d738 =
	     wsiS_reqFifo$FULL_N &&
	     (wsiS_burstKind == 2'd0 ||
	      (wsiS_burstKind == 2'd1 || wsiS_burstKind == 2'd2) &&
	      wsiS_wsiReq$wget[93]) ;
  assign x1__h18149 = { 96'd0, x__h18010[31:0] } ;
  assign x1__h18180 = { 64'd0, x__h18010[31:0], wrtSerStage } ;
  ...
  assign x__h14851 =
	     CAN_FIRE_RL_wmwt_mesg_ingress ?
	       ...
	       64'd0 ;
  assign x__h17114 = { wordsExact[12:0], 3'd0 } ;
  assign x__h17216 = wordsEnqued + 16'd1 ;
  assign x__h18010 = mesgWF_wDataOut$wget ;
  ...
  assign x_byteEn__h20115 = (readMeta[23:0] == 24'd0) ? 8'd0 : 8'd255 ;
