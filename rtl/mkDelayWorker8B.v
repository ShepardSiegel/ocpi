...
//
// On Mon Oct 25 17:57:30 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker8B(wciS0_Clk,
  ...
  wire [127 : 0] IF_wrtSerPos_80_EQ_2_83_THEN_0x0_ELSE_mesgWF_w_ETC___d423,
		 ...
		 x__h18828,
		 x__h18855;
  wire [63 : 0] x__h15107, x__h18027;
  wire [35 : 0] addr__h19512, addr__h19681;
  wire [31 : 0] delayStatus__h21831,
		rdat__h22297,
		rdat__h22303,
		rdat__h22309,
		rdat__h22315,
  ...
  wire [13 : 0] mesgLengthSoFar_05_PLUS_1___d970;
  wire [12 : 0] x__h14999;
  wire [11 : 0] x_burstLength__h20010;
  wire [7 : 0] x_byteEn__h20011;
  wire [1 : 0] wrtSerPos_80_PLUS_1___d969;
  wire IF_wrtSerPos_80_EQ_0_81_OR_wrtSerPos_80_EQ_1_8_ETC___d399,
       ...
       bytesWritten_6_ULT_dlyHoldoffBytes_6___d1004,
       cyclesPassed_54_ULT_dlyHoldoffCycles_8___d1006,
       dlyWordsStored_value_26_SLE_0_49_OR_bytesWritt_ETC___d164,
       dlyWordsStored_value_26_SLE_0___d1005,
  ...
  assign MUX_rdSyncWord$write_1__VAL_2 =
	     rdSerPos != 2'd3 && v__h20288[23:0] == 24'd0 ;
  ...
  assign MUX_wrtSerPos$write_1__VAL_1 =
	     (wrtSerUnroll == 16'd1) ? 2'd0 : wrtSerPos_80_PLUS_1___d969 ;
  assign MUX_wrtSerPos$write_1__VAL_2 =
	     (metaWF$D_OUT[23:0] == 24'd0) ?
	       2'd0 :
	       wrtSerPos_80_PLUS_1___d969 ;
  assign MUX_wci_respF_x_wire$wset_1__VAL_1 = { 2'd1, x_data__h22264 } ;
  ...
  assign dlyRdOpOther$EN =
	     WILL_FIRE_RL_rdSer_begin && v__h20288[31:24] != 8'd0 ;
  ...
  assign mesgLengthSoFar$D_IN =
	     wsiS_reqFifo$D_OUT[93] ?
	       14'd0 :
	       mesgLengthSoFar_05_PLUS_1___d970 ;
  ...
  assign wrtSerStage$D_IN =
	     MUX_wrtSerStage$write_1__SEL_1 ? x__h18027[31:0] : metaWF$D_OUT ;
  ...
  assign mesgRF$D_IN = { 32'd0, v__h20288 } ;
  ...
  assign IF_wrtSerPos_80_EQ_2_83_THEN_0x0_ELSE_mesgWF_w_ETC___d423 =
	     { (wrtSerPos == 2'd2) ? 32'h0 : x__h18027[31:0],
	       (wrtSerPos == 2'd2) ? x__h18027[31:0] : wrtSerStage_2,
	       wrtSerStage_1,
	       wrtSerStage } ;
  ...
  assign btm__h17061 =
		 ...
		 { 7'd0, mesgLengthSoFar_05_PLUS_1___d970 },
	       3'd0 } ;
  assign bytesWritten_6_ULT_dlyHoldoffBytes_6___d1004 =
	     bytesWritten < dlyHoldoffBytes ;
  assign cyclesPassed_54_ULT_dlyHoldoffCycles_8___d1006 =
  ...
  assign dlyWordsStored_value_26_SLE_0_49_OR_bytesWritt_ETC___d164 =
	     ...
	     wsiM_reqFifo_c_r == 2'd2 ||
	     tog50 ;
  assign dlyWordsStored_value_26_SLE_0___d1005 =
  ...
  assign mesgLengthSoFar_05_PLUS_1___d970 = mesgLengthSoFar + 14'd1 ;
  ...
  assign x__h15107 =
	     CAN_FIRE_RL_wmwt_mesg_ingress ?
	       ...
	       64'd0 ;
  assign x__h18027 = mesgWF_wDataOut$wget ;
  assign x__h18166 = { 96'd0, x__h18027[31:0] } ;
  assign x__h18197 = { 64'd0, x__h18027[31:0], wrtSerStage } ;
  ...
  assign x_byteEn__h20011 = (readMeta[23:0] == 24'd0) ? 8'd0 : 8'd255 ;
  always@(wrtSerPos)
  begin
    case (wrtSerPos)
