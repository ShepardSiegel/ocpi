...
//
// On Tue Jul  6 08:21:03 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker8B(wciS0_Clk,
  ...
  reg [63 : 0] v__h16649,
	       ...
	       v__h2816,
	       v__h3715;
  reg [31 : 0] x_data__h20735;
  reg CASE_wrtSerPos_0b1_0_1_1_1_2_1_3_0b1__q1,
      IF_wrtSerPos_23_EQ_0_24_OR_wrtSerPos_23_EQ_1_2_ETC___d884;
  wire [127 : 0] IF_wrtSerPos_23_EQ_2_26_THEN_0x0_ELSE_mesgWF_w_ETC___d366,
		 IF_wrtSerPos_23_EQ_2_26_THEN_0x0_ELSE_metaWF_f_ETC___d389,
		 x1__h18900,
		 x1__h18909,
		 x1__h19423,
		 x1__h19432;
  wire [63 : 0] x__h15143, x__h18836;
  wire [35 : 0] addr__h19925, addr__h20097;
  wire [31 : 0] rdat__h20762,
		rdat__h20768,
		rdat__h20775,
		rdat__h20781,
		rdat__h20905,
		...
		rdat__h21009,
		v__h21675;
  wire [26 : 0] x__h19983, x__h20142;
  wire [23 : 0] x1_length__h16342, x__h20785;
  wire [13 : 0] mlp1__h17012, x__h16386;
  wire [12 : 0] x__h15035;
  wire [11 : 0] x_burstLength__h21394;
  wire [7 : 0] x1_opcode__h16341, x_byteEn__h21395;
  wire [1 : 0] wrtSerPos_23_PLUS_1___d992;
  wire NOT_dlyWordsStored_value_26_SLE_0_76_77_AND_NO_ETC___d284,
       NOT_wmemi_reqF_c_r_69_EQ_2_70_71_AND_NOT_wmemi_ETC___d303,
       NOT_wsiS_reqFifo_countReg_76_ULE_1_77___d678,
       _dor1bytesWritten$EN_write,
       mesgRF_RDY_enq__07_AND_NOT_rdSerEmpty_08_09_AN_ETC___d220,
       metaRF_RDY_enq__53_AND_NOT_rdSerEmpty_08_09_AN_ETC___d254,
       metaWF_RDY_deq__70_AND_NOT_wrtSerPos_23_EQ_3_3_ETC___d377,
       wci_cState_9_EQ_2_0_AND_dlyCtrl_4_BITS_3_TO_0__ETC___d409;
  ...
  assign CAN_FIRE_RL_delay_read_req =
	     ...
	     wci_cState == 3'd2 &&
	     dlyCtrl[3:0] == 4'h7 &&
	     NOT_dlyWordsStored_value_26_SLE_0_76_77_AND_NO_ETC___d284 &&
  ...
  assign MUX_mesgLength$write_1__VAL_3 = { 1'd1, mlp1__h17012[10:0], 3'd0 } ;
  assign MUX_mesgRdCount$write_1__VAL_1 = mesgRdCount + 32'd1 ;
  assign MUX_mesgWtCount$write_1__VAL_1 = mesgWtCount + 32'd1 ;
  assign MUX_metaWF$enq_1__VAL_2 = { x1_opcode__h16341, x1_length__h16342 } ;
  ...
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_1 = { 4'd5, addr__h19925, 12'd1 } ;
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_2 = { 4'd3, addr__h20097, 12'd1 } ;
  assign MUX_rdSyncWord$write_1__VAL_2 =
	     rdSerPos != 2'd3 && v__h21675[23:0] == 24'd0 ;
  assign MUX_wsiM_reqFifo_x_wire$wset_1__VAL_1 =
	     { 3'd1,
	       unrollCnt == 16'd1,
	       1'd1,
	       x_burstLength__h21394,
	       mesgRF$D_OUT,
	       x_byteEn__h21395,
	       readMeta[31:24] } ;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_1 = { 2'd1, x_data__h20735 } ;
  ...
  always@(wrtSerPos or
	  IF_wrtSerPos_23_EQ_2_26_THEN_0x0_ELSE_mesgWF_w_ETC___d366 or
	  x1__h18900 or x1__h18909)
  begin
    case (wrtSerPos)
      2'd0: MUX_wide16Fa$enq_1__VAL_2 = x1__h18900;
      2'd1: MUX_wide16Fa$enq_1__VAL_2 = x1__h18909;
      default: MUX_wide16Fa$enq_1__VAL_2 =
		   IF_wrtSerPos_23_EQ_2_26_THEN_0x0_ELSE_mesgWF_w_ETC___d366;
    endcase
  end
  always@(wrtSerPos or
	  IF_wrtSerPos_23_EQ_2_26_THEN_0x0_ELSE_metaWF_f_ETC___d389 or
	  x1__h19423 or x1__h19432)
  begin
    case (wrtSerPos)
      2'd0: MUX_wide16Fa$enq_1__VAL_1 = x1__h19423;
      2'd1: MUX_wide16Fa$enq_1__VAL_1 = x1__h19432;
      default: MUX_wide16Fa$enq_1__VAL_1 =
		   IF_wrtSerPos_23_EQ_2_26_THEN_0x0_ELSE_metaWF_f_ETC___d389;
    endcase
  end
  assign MUX_wrtSerPos$write_1__VAL_1 =
	     (wrtSerUnroll == 16'd1) ? 2'd0 : wrtSerPos_23_PLUS_1___d992 ;
  assign MUX_wrtSerPos$write_1__VAL_2 =
	     (metaWF$D_OUT[23:0] == 24'd0) ?
	       2'd0 :
	       wrtSerPos_23_PLUS_1___d992 ;
  ...
  assign mesgLengthSoFar$D_IN =
	     MUX_impreciseBurst$write_1__SEL_2 ? 14'd0 : mlp1__h17012 ;
  ...
  // register mesgWF_rCache
  assign mesgWF_rCache$D_IN = { 1'd1, mesgWF_rWrPtr, x__h15143 } ;
  assign mesgWF_rCache$EN = mesgWF_pwEnqueue$whas ;

  // register mesgWF_rRdPtr
  assign mesgWF_rRdPtr$D_IN = x__h15035 ;
  ...
  assign wrtSerStage$D_IN =
	     MUX_wrtSerStage$write_1__SEL_1 ? x__h18836[31:0] : metaWF$D_OUT ;
  ...
  assign mesgRF$D_IN = { 32'd0, v__h21675 } ;
  ...
  assign mesgWF_memory$DIA = x__h15143 ;
  assign mesgWF_memory$ADDRB =
	     CAN_FIRE_RL_wrtSer_body ? x__h15035[11:0] : mesgWF_rRdPtr[11:0] ;
  ...
  // remaining internal signals
  assign IF_wrtSerPos_23_EQ_2_26_THEN_0x0_ELSE_mesgWF_w_ETC___d366 =
	     { (wrtSerPos == 2'd2) ? 32'h0 : x__h18836[31:0],
	       (wrtSerPos == 2'd2) ? x__h18836[31:0] : wrtSerStage_2,
	       wrtSerStage_1,
	       wrtSerStage } ;
  assign IF_wrtSerPos_23_EQ_2_26_THEN_0x0_ELSE_metaWF_f_ETC___d389 =
	     { (wrtSerPos == 2'd2) ? 32'h0 : metaWF$D_OUT,
	       (wrtSerPos == 2'd2) ? metaWF$D_OUT : wrtSerStage_2,
	       wrtSerStage_1,
	       wrtSerStage } ;
  assign NOT_dlyWordsStored_value_26_SLE_0_76_77_AND_NO_ETC___d284 =
	     (dlyWordsStored_value ^ 23'h400000) > 23'd4194304 &&
	     bytesWritten >= dlyHoldoffBytes &&
	     cyclesPassed >= dlyHoldoffCycles ;
  assign NOT_wmemi_reqF_c_r_69_EQ_2_70_71_AND_NOT_wmemi_ETC___d303 =
	     wmemi_reqF_c_r != 2'd2 && wmemi_dhF_c_r != 2'd2 &&
	     wmemi_operateD &&
	     wmemi_peerIsReady ;
  assign NOT_wsiS_reqFifo_countReg_76_ULE_1_77___d678 =
	     wsiS_reqFifo_countReg > 2'd1 ;
  assign _dor1bytesWritten$EN_write =
	     WILL_FIRE_RL_wmwt_messagePushPrecise ||
	     WILL_FIRE_RL_wmwt_messagePushImprecise ;
  assign addr__h19925 = { 9'd0, x__h19983 } ;
  assign addr__h20097 = { 9'd0, x__h20142 } ;
  assign mesgRF_RDY_enq__07_AND_NOT_rdSerEmpty_08_09_AN_ETC___d220 =
	     mesgRF$FULL_N &&
	     (!rdSerEmpty && rdSerPos != 2'd0 || wide16Fb$EMPTY_N) ;
  assign metaRF_RDY_enq__53_AND_NOT_rdSerEmpty_08_09_AN_ETC___d254 =
	     metaRF$FULL_N &&
	     (!rdSerEmpty && rdSerPos != 2'd0 || wide16Fb$EMPTY_N) ;
  assign metaWF_RDY_deq__70_AND_NOT_wrtSerPos_23_EQ_3_3_ETC___d377 =
	     metaWF$EMPTY_N &&
	     (wrtSerPos != 2'd3 && metaWF$D_OUT[23:0] != 24'd0 ||
	      IF_wrtSerPos_23_EQ_0_24_OR_wrtSerPos_23_EQ_1_2_ETC___d884) ;
  assign mlp1__h17012 = mesgLengthSoFar + 14'd1 ;
  assign rdat__h20762 = hasDebugLogic ? mesgWtCount : 32'd0 ;
  assign rdat__h20768 = hasDebugLogic ? mesgRdCount : 32'd0 ;
  assign rdat__h20775 = hasDebugLogic ? bytesWritten : 32'd0 ;
  assign rdat__h20781 = hasDebugLogic ? { 8'd0, x__h20785 } : 32'd0 ;
  assign rdat__h20905 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h20919 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h20927 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h20933 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h20947 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h20955 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h20961 = hasDebugLogic ? wmemiWrReq : 32'd0 ;
  assign rdat__h20967 = hasDebugLogic ? wmemiRdReq : 32'd0 ;
  assign rdat__h20973 = hasDebugLogic ? wmemiRdResp : 32'd0 ;
  assign rdat__h20979 =
	     hasDebugLogic ? { 9'd0, dlyWordsStored_value } : 32'd0 ;
  assign rdat__h20989 =
	     hasDebugLogic ? { 24'd0, dlyReadCredit_value } : 32'd0 ;
  assign rdat__h20999 = hasDebugLogic ? { 9'd0, dlyWAG } : 32'd0 ;
  assign rdat__h21009 = hasDebugLogic ? { 9'd0, dlyRAG } : 32'd0 ;
  assign v__h21675 = metaRF$D_IN ;
  assign wci_cState_9_EQ_2_0_AND_dlyCtrl_4_BITS_3_TO_0__ETC___d409 =
	     wci_cState == 3'd2 && dlyCtrl[3:0] == 4'h7 && mesgLength[14] &&
	     !doAbort &&
	     (preciseBurst && wsiWordsRemain == 12'd0 ||
	      impreciseBurst && endOfMessage) ;
  assign wrtSerPos_23_PLUS_1___d992 = wrtSerPos + 2'd1 ;
  assign x1__h18900 = { 96'd0, x__h18836[31:0] } ;
  assign x1__h18909 = { 64'd0, x__h18836[31:0], wrtSerStage } ;
  assign x1__h19423 = { 96'd0, metaWF$D_OUT } ;
  assign x1__h19432 = { 64'd0, metaWF$D_OUT, wrtSerStage } ;
  assign x1_length__h16342 = { 10'd0, x__h16386 } ;
  assign x1_opcode__h16341 = opcode[8] ? opcode[7:0] : 8'd0 ;
  assign x__h15035 = mesgWF_rRdPtr + 13'd1 ;
  assign x__h15143 =
	     mesgWF_pwEnqueue$whas ? wsiS_reqFifo$D_OUT[79:16] : 64'd0 ;
  assign x__h16386 = mesgLength[14] ? mesgLength[13:0] : 14'd0 ;
  assign x__h18836 = mesgWF_wDataOut$wget ;
  assign x__h19983 = { dlyRAG, 4'h0 } ;
  assign x__h20142 = { dlyWAG, 4'h0 } ;
  assign x__h20785 = { wmemi_statusR, wsiS_statusR, wsiM_statusR } ;
  assign x_burstLength__h21394 =
	     (readMeta[23:0] == 24'd0) ? 12'd1 : readMeta[14:3] ;
  assign x_byteEn__h21395 = (readMeta[23:0] == 24'd0) ? 8'd0 : 8'd255 ;
  always@(wci_reqF$D_OUT or
	  ...
	  rdat__h20967 or
	  rdat__h20973 or
	  rdat__h20979 or rdat__h20989 or rdat__h20999 or rdat__h21009)
  begin
    case (wci_reqF$D_OUT[51:32])
      20'h0: x_data__h20735 = dlyCtrl;
      20'h00004: x_data__h20735 = dlyHoldoffBytes;
      20'h00008: x_data__h20735 = dlyHoldoffCycles;
      20'h0000C: x_data__h20735 = rdat__h20762;
      20'h00010: x_data__h20735 = rdat__h20768;
      20'h00014: x_data__h20735 = rdat__h20775;
      20'h00018: x_data__h20735 = rdat__h20781;
      20'h0001C: x_data__h20735 = 32'd0;
      20'h00020: x_data__h20735 = rdat__h20905;
      20'h00024: x_data__h20735 = rdat__h20919;
      20'h00028: x_data__h20735 = rdat__h20927;
      20'h0002C: x_data__h20735 = rdat__h20933;
      20'h00030: x_data__h20735 = rdat__h20947;
      20'h00034: x_data__h20735 = rdat__h20955;
      20'h00038: x_data__h20735 = rdat__h20961;
      20'h0003C: x_data__h20735 = rdat__h20967;
      20'h00040: x_data__h20735 = rdat__h20973;
      20'h00044: x_data__h20735 = rdat__h20979;
      20'h00048: x_data__h20735 = rdat__h20989;
      20'h0004C: x_data__h20735 = rdat__h20999;
      20'h00050: x_data__h20735 = rdat__h21009;
      default: x_data__h20735 = 32'd0;
    endcase
  end
  ...
  begin
    ...
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wmwt_doAbort)
	$display("[%0d]: %m: wmwt_doAbort", v__h16865);
    if (wciS0_MReset_n)
