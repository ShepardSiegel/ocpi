...
//
// On Tue Jun  1 17:10:15 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker8B(wciS0_Clk,
  ...
  wire [63 : 0] mesg__h20847, x__h15015, x__h15941, x__h19468;
  ...
  wire [7 : 0] x1_opcode__h16875, x_byteEn__h20939;
  ...
  assign MUX_mesgLength$write_1__VAL_3 = { 1'd1, mlp1__h17575[10:0], 3'd0 } ;
  ...
  assign mesgRF_wDataIn$wget = { 32'd0, v__h21160 } ;
  ...
  assign x__h15941 = CAN_FIRE_RL_rdSer_body ? mesgRF_wDataIn$wget : 64'd0 ;
  ...
  assign x_byteEn__h20939 = (readMeta[23:0] == 24'd0) ? 8'd0 : 8'd255 ;
  always@(wrtSerPos)
  begin
    case (wrtSerPos)
