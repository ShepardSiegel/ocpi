...
//
// On Mon Jul 12 14:04:31 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker8B(wciS0_Clk,
  ...
  reg [63 : 0] v__h17546,
	       ...
	       v__h2820,
	       v__h3719;
  reg [31 : 0] x_data__h22212;
  reg CASE_wrtSerPos_0b1_0_1_1_1_2_1_3_0b1__q1,
      CASE_wrtSerPos_NOT_wrtSerPos_EQ_3_OR_wide16Fa_ETC__q2;
  wire [127 : 0] IF_wrtSerPos_41_EQ_2_44_THEN_0x0_ELSE_mesgWF_w_ETC___d385,
		 IF_wrtSerPos_41_EQ_2_44_THEN_0x0_ELSE_metaWF_f_ETC___d410,
		 x1__h19941,
		 x1__h19972,
		 x1__h20637,
		 x1__h20664;
  wire [63 : 0] x__h15357, x__h19802;
  wire [35 : 0] addr__h21242, addr__h21510;
  wire [31 : 0] rdat__h22239,
		rdat__h22245,
		rdat__h22252,
		rdat__h22258,
		rdat__h22382,
		...
		rdat__h22496,
		v__h23207;
  wire [26 : 0] x__h21300, x__h21555;
  wire [23 : 0] x1_length__h17239, x__h22262;
  wire [13 : 0] mlp1__h17940, x__h17283;
  wire [12 : 0] x__h15249;
  wire [11 : 0] x_burstLength__h22926;
  wire [7 : 0] x1_opcode__h17238, x_byteEn__h22927;
  wire [1 : 0] wrtSerPos_41_PLUS_1___d1042;
  wire IF_wrtSerPos_41_EQ_0_42_OR_wrtSerPos_41_EQ_1_4_ETC___d361,
       NOT_dlyWordsStored_value_27_SLE_0_81_82_AND_NO_ETC___d289,
       NOT_wmemi_reqF_c_r_74_EQ_2_75_76_AND_NOT_wmemi_ETC___d315,
       NOT_wrtSerPos_41_EQ_3_48_49_AND_NOT_metaWF_fir_ETC___d397,
       ...
       wci_cState_9_EQ_2_0_AND_dlyCtrl_5_BITS_3_TO_0__ETC___d325,
       wci_cState_9_EQ_2_0_AND_dlyCtrl_5_BITS_3_TO_0__ETC___d430,
  ...
  assign CAN_FIRE_RL_wrtSer_body =
	     ...
	     IF_wrtSerPos_41_EQ_0_42_OR_wrtSerPos_41_EQ_1_4_ETC___d361 &&
	     wci_cState == 3'd2 &&
	     dlyCtrl[3:0] == 4'h7 &&
	     wrtSerUnroll != 16'd0 ;
  ...
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_1 = { 4'd5, addr__h21242, 12'd1 } ;
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_2 = { 4'd3, addr__h21510, 12'd1 } ;
  assign MUX_rdSyncWord$write_1__VAL_2 =
	     rdSerPos != 2'd3 && v__h23207[23:0] == 24'd0 ;
  assign MUX_wsiM_reqFifo_x_wire$wset_1__VAL_1 =
	     { 3'd1,
	       unrollCnt == 16'd1,
	       1'd1,
	       x_burstLength__h22926,
	       mesgRF$D_OUT,
	       x_byteEn__h22927,
	       readMeta[31:24] } ;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_1 = { 2'd1, x_data__h22212 } ;
  ...
  always@(wrtSerPos or
	  IF_wrtSerPos_41_EQ_2_44_THEN_0x0_ELSE_mesgWF_w_ETC___d385 or
  ...
  begin
    case (wrtSerPos)
      ...
      default: MUX_wide16Fa$enq_1__VAL_2 =
		   IF_wrtSerPos_41_EQ_2_44_THEN_0x0_ELSE_mesgWF_w_ETC___d385;
    endcase
  end
  ...
  always@(wrtSerPos or
	  IF_wrtSerPos_41_EQ_2_44_THEN_0x0_ELSE_metaWF_f_ETC___d410 or
  ...
  assign MUX_wrtSerPos$write_1__VAL_1 =
	     (wrtSerUnroll == 16'd1) ? 2'd0 : wrtSerPos_41_PLUS_1___d1042 ;
  assign MUX_wrtSerPos$write_1__VAL_2 =
	     (metaWF$D_OUT[23:0] == 24'd0) ?
	       2'd0 :
	       wrtSerPos_41_PLUS_1___d1042 ;
  ...
  assign mesgRF$D_IN = { 32'd0, v__h23207 } ;
  ...
  // remaining internal signals
  assign IF_wrtSerPos_41_EQ_0_42_OR_wrtSerPos_41_EQ_1_4_ETC___d361 =
	     CASE_wrtSerPos_0b1_0_1_1_1_2_1_3_0b1__q1 &&
	     (wrtSerPos != 2'd3 && wrtSerUnroll != 16'd1 ||
	      CASE_wrtSerPos_NOT_wrtSerPos_EQ_3_OR_wide16Fa_ETC__q2) ;
  assign IF_wrtSerPos_41_EQ_2_44_THEN_0x0_ELSE_mesgWF_w_ETC___d385 =
	     { (wrtSerPos == 2'd2) ? 32'h0 : x__h19802[31:0],
	       (wrtSerPos == 2'd2) ? x__h19802[31:0] : wrtSerStage_2,
	       wrtSerStage_1,
	       wrtSerStage } ;
  assign IF_wrtSerPos_41_EQ_2_44_THEN_0x0_ELSE_metaWF_f_ETC___d410 =
  ...
  assign NOT_wmemi_reqF_c_r_74_EQ_2_75_76_AND_NOT_wmemi_ETC___d315 =
	     wmemi_reqF_c_r != 2'd2 && wmemi_dhF_c_r != 2'd2 &&
	     wmemi_operateD &&
	     wmemi_peerIsReady ;
  assign NOT_wrtSerPos_41_EQ_3_48_49_AND_NOT_metaWF_fir_ETC___d397 =
	     wrtSerPos != 2'd3 && metaWF$D_OUT[23:0] != 24'd0 ||
	     CASE_wrtSerPos_NOT_wrtSerPos_EQ_3_OR_wide16Fa_ETC__q2 ;
  assign _dor1bytesWritten$EN_write =
	     WILL_FIRE_RL_wmwt_messagePushPrecise ||
	     WILL_FIRE_RL_wmwt_messagePushImprecise ;
  assign addr__h21242 = { 9'd0, x__h21300 } ;
  assign addr__h21510 = { 9'd0, x__h21555 } ;
  ...
  assign rdat__h22239 = hasDebugLogic ? mesgWtCount : 32'd0 ;
  assign rdat__h22245 = hasDebugLogic ? mesgRdCount : 32'd0 ;
  assign rdat__h22252 = hasDebugLogic ? bytesWritten : 32'd0 ;
  assign rdat__h22258 = hasDebugLogic ? { 8'd0, x__h22262 } : 32'd0 ;
  assign rdat__h22382 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h22396 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h22404 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h22410 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h22424 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h22432 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h22438 = hasDebugLogic ? wmemiWrReq : 32'd0 ;
  assign rdat__h22444 = hasDebugLogic ? wmemiRdReq : 32'd0 ;
  assign rdat__h22450 = hasDebugLogic ? wmemiRdResp : 32'd0 ;
  assign rdat__h22456 =
	     hasDebugLogic ? { 8'd0, dlyWordsStored_value } : 32'd0 ;
  assign rdat__h22466 =
	     hasDebugLogic ? { 24'd0, dlyReadCredit_value } : 32'd0 ;
  assign rdat__h22476 = hasDebugLogic ? { 9'd0, dlyWAG } : 32'd0 ;
  assign rdat__h22486 = hasDebugLogic ? { 9'd0, dlyRAG } : 32'd0 ;
  assign rdat__h22496 = { {24{dlyMaxReadCredit[7]}}, dlyMaxReadCredit } ;
  assign v__h23207 = metaRF$D_IN ;
  assign wci_cState_9_EQ_2_0_AND_dlyCtrl_5_BITS_3_TO_0__ETC___d325 =
	     wci_cState == 3'd2 && dlyCtrl[3:0] == 4'h7 &&
	     ((dlyWriteJustFired || dlyWriteFlush == 8'd255) ?
		(dlyReadyToWrite_value ^ 5'h10) > 5'd16 :
		(dlyReadyToWrite_value ^ 5'h10) > 5'd19) ;
  assign wci_cState_9_EQ_2_0_AND_dlyCtrl_5_BITS_3_TO_0__ETC___d430 =
	     wci_cState == 3'd2 && dlyCtrl[3:0] == 4'h7 && mesgLength[14] &&
	     !doAbort &&
	     (preciseBurst && wsiWordsRemain == 12'd0 ||
	      impreciseBurst && endOfMessage) ;
  assign wrtSerPos_41_PLUS_1___d1042 = wrtSerPos + 2'd1 ;
  ...
  assign x__h21300 = { dlyRAG, 4'h0 } ;
  assign x__h21555 = { dlyWAG, 4'h0 } ;
  assign x__h22262 = { wmemi_statusR, wsiS_statusR, wsiM_statusR } ;
  assign x_burstLength__h22926 =
	     (readMeta[23:0] == 24'd0) ? 12'd1 : readMeta[14:3] ;
  assign x_byteEn__h22927 = (readMeta[23:0] == 24'd0) ? 8'd0 : 8'd255 ;
  always@(wci_reqF$D_OUT or
	  ...
	  rdat__h22450 or
	  rdat__h22456 or
	  rdat__h22466 or rdat__h22476 or rdat__h22486 or rdat__h22496)
  begin
    case (wci_reqF$D_OUT[51:32])
      20'h0: x_data__h22212 = dlyCtrl;
      20'h00004: x_data__h22212 = dlyHoldoffBytes;
      20'h00008: x_data__h22212 = dlyHoldoffCycles;
      20'h0000C: x_data__h22212 = rdat__h22239;
      20'h00010: x_data__h22212 = rdat__h22245;
      20'h00014: x_data__h22212 = rdat__h22252;
      20'h00018: x_data__h22212 = rdat__h22258;
      20'h0001C: x_data__h22212 = 32'd0;
      20'h00020: x_data__h22212 = rdat__h22382;
      20'h00024: x_data__h22212 = rdat__h22396;
      20'h00028: x_data__h22212 = rdat__h22404;
      20'h0002C: x_data__h22212 = rdat__h22410;
      20'h00030: x_data__h22212 = rdat__h22424;
      20'h00034: x_data__h22212 = rdat__h22432;
      20'h00038: x_data__h22212 = rdat__h22438;
      20'h0003C: x_data__h22212 = rdat__h22444;
      20'h00040: x_data__h22212 = rdat__h22450;
      20'h00044: x_data__h22212 = rdat__h22456;
      20'h00048: x_data__h22212 = rdat__h22466;
      20'h0004C: x_data__h22212 = rdat__h22476;
      20'h00050: x_data__h22212 = rdat__h22486;
      20'h00054: x_data__h22212 = rdat__h22496;
      default: x_data__h22212 = 32'd0;
    endcase
  end
  always@(wrtSerPos)
  begin
