...
//
// On Fri Jun  4 10:55:30 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker8B(wciS0_Clk,
  ...
  wire [63 : 0] mesg__h21699, x__h15021, x__h15947, x__h19644;
  ...
  wire [7 : 0] x1_opcode__h17051, x_byteEn__h21791;
  ...
  assign MUX_mesgLength$write_1__VAL_3 = { 1'd1, mlp1__h17751[10:0], 3'd0 } ;
  ...
  assign mesgRF_wDataIn$wget = { 32'd0, v__h22012 } ;
  ...
  assign x__h15947 = CAN_FIRE_RL_rdSer_body ? mesgRF_wDataIn$wget : 64'd0 ;
  ...
  assign x_byteEn__h21791 = (readMeta[23:0] == 24'd0) ? 8'd0 : 8'd255 ;
  always@(wrtSerPos)
  begin
    case (wrtSerPos)
