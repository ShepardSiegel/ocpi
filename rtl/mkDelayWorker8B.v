...
//
// On Mon Aug 23 08:49:38 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker8B(wciS0_Clk,
  ...
  wire [13 : 0] mesgLengthSoFar_05_PLUS_1___d989;
  wire [12 : 0] x__h14967;
  wire [11 : 0] x_burstLength__h19978;
  wire [7 : 0] x_byteEn__h19979;
  wire [1 : 0] wrtSerPos_80_PLUS_1___d988;
  ...
  assign MUX_wrtSerPos$write_1__VAL_1 =
	     (wrtSerUnroll == 16'd1) ? 2'd0 : wrtSerPos_80_PLUS_1___d988 ;
  assign MUX_wrtSerPos$write_1__VAL_2 =
	     (metaWF$D_OUT[23:0] == 24'd0) ?
	       2'd0 :
	       wrtSerPos_80_PLUS_1___d988 ;
  ...
  assign mesgLengthSoFar$D_IN =
	     wsiS_reqFifo$D_OUT[93] ?
	       14'd0 :
	       mesgLengthSoFar_05_PLUS_1___d989 ;
  ...
  assign btm__h17029 =
		 ...
		 { 7'd0, mesgLengthSoFar_05_PLUS_1___d989 },
	       3'd0 } ;
  ...
  assign mesgLengthSoFar_05_PLUS_1___d989 = mesgLengthSoFar + 14'd1 ;
  ...
  assign wci_cState_9_EQ_2_0_AND_dlyCtrl_4_BITS_3_TO_0__ETC___d352 =
	     ...
	     !bytesWritten_6_ULT_dlyHoldoffBytes_6___d907 &&
	     !cyclesPassed_54_ULT_dlyHoldoffCycles_8___d905 ;
  assign wrtSerPos_80_PLUS_1___d988 = wrtSerPos + 2'd1 ;
