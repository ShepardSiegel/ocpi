...
//
// On Mon Jul 12 09:45:56 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker8B(wciS0_Clk,
  ...
  reg [63 : 0] v__h17545,
	       ...
	       v__h2820,
	       v__h3719;
  reg [31 : 0] x_data__h22208;
  reg CASE_wrtSerPos_0b1_0_1_1_1_2_1_3_0b1__q1,
      CASE_wrtSerPos_NOT_wrtSerPos_EQ_3_OR_wide16Fa_ETC__q2;
  wire [127 : 0] IF_wrtSerPos_40_EQ_2_43_THEN_0x0_ELSE_mesgWF_w_ETC___d384,
		 IF_wrtSerPos_40_EQ_2_43_THEN_0x0_ELSE_metaWF_f_ETC___d409,
		 x1__h19940,
		 x1__h19971,
		 x1__h20636,
		 x1__h20663;
  wire [63 : 0] x__h15356, x__h19801;
  wire [35 : 0] addr__h21238, addr__h21506;
  wire [31 : 0] rdat__h22235,
		rdat__h22241,
		rdat__h22248,
		rdat__h22254,
		rdat__h22378,
		...
		rdat__h22492,
		v__h23203;
  wire [26 : 0] x__h21296, x__h21551;
  wire [23 : 0] x1_length__h17238, x__h22258;
  wire [13 : 0] mlp1__h17939, x__h17282;
  wire [12 : 0] x__h15248;
  wire [11 : 0] x_burstLength__h22922;
  wire [7 : 0] x1_opcode__h17237, x_byteEn__h22923;
  wire [1 : 0] wrtSerPos_40_PLUS_1___d1041;
  wire IF_wrtSerPos_40_EQ_0_41_OR_wrtSerPos_40_EQ_1_4_ETC___d360,
       NOT_dlyWordsStored_value_27_SLE_0_81_82_AND_NO_ETC___d289,
       NOT_wmemi_reqF_c_r_74_EQ_2_75_76_AND_NOT_wmemi_ETC___d314,
       NOT_wrtSerPos_40_EQ_3_47_48_AND_NOT_metaWF_fir_ETC___d396,
       _dor1bytesWritten$EN_write,
       mesgRF_RDY_enq__12_AND_NOT_rdSerEmpty_13_14_AN_ETC___d225,
       metaRF_RDY_enq__58_AND_NOT_rdSerEmpty_13_14_AN_ETC___d259,
       wci_cState_9_EQ_2_0_AND_dlyCtrl_5_BITS_3_TO_0__ETC___d324,
       wci_cState_9_EQ_2_0_AND_dlyCtrl_5_BITS_3_TO_0__ETC___d429,
       wsiS_reqFifo_notFull__28_AND_wsiS_burstKind_08_ETC___d744;
  ...
  assign MUX_mesgLength$write_1__VAL_3 = { 1'd1, mlp1__h17939[10:0], 3'd0 } ;
  ...
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_1 = { 4'd5, addr__h21238, 12'd1 } ;
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_2 = { 4'd3, addr__h21506, 12'd1 } ;
  assign MUX_rdSyncWord$write_1__VAL_2 =
	     rdSerPos != 2'd3 && v__h23203[23:0] == 24'd0 ;
  assign MUX_wsiM_reqFifo_x_wire$wset_1__VAL_1 =
	     { 3'd1,
	       unrollCnt == 16'd1,
	       1'd1,
	       x_burstLength__h22922,
	       mesgRF$D_OUT,
	       x_byteEn__h22923,
	       readMeta[31:24] } ;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_1 = { 2'd1, x_data__h22208 } ;
  ...
  always@(wrtSerPos or
	  IF_wrtSerPos_40_EQ_2_43_THEN_0x0_ELSE_mesgWF_w_ETC___d384 or
  ...
  begin
    case (wrtSerPos)
      ...
      default: MUX_wide16Fa$enq_1__VAL_2 =
		   IF_wrtSerPos_40_EQ_2_43_THEN_0x0_ELSE_mesgWF_w_ETC___d384;
    endcase
  end
  ...
  always@(wrtSerPos or
	  IF_wrtSerPos_40_EQ_2_43_THEN_0x0_ELSE_metaWF_f_ETC___d409 or
  ...
  assign MUX_wrtSerPos$write_1__VAL_1 =
	     (wrtSerUnroll == 16'd1) ? 2'd0 : wrtSerPos_40_PLUS_1___d1041 ;
  assign MUX_wrtSerPos$write_1__VAL_2 =
	     (metaWF$D_OUT[23:0] == 24'd0) ?
	       2'd0 :
	       wrtSerPos_40_PLUS_1___d1041 ;
  ...
  assign wrtSerStage$D_IN =
	     MUX_wrtSerStage$write_1__SEL_1 ? x__h19801[31:0] : metaWF$D_OUT ;
  ...
  assign mesgRF$D_IN = { 32'd0, v__h23203 } ;
  ...
  assign IF_wrtSerPos_40_EQ_0_41_OR_wrtSerPos_40_EQ_1_4_ETC___d360 =
	     ...
	     (wrtSerPos != 2'd3 && wrtSerUnroll != 16'd1 ||
	      CASE_wrtSerPos_NOT_wrtSerPos_EQ_3_OR_wide16Fa_ETC__q2) ;
  assign IF_wrtSerPos_40_EQ_2_43_THEN_0x0_ELSE_mesgWF_w_ETC___d384 =
	     { (wrtSerPos == 2'd2) ? 32'h0 : x__h19801[31:0],
	       (wrtSerPos == 2'd2) ? x__h19801[31:0] : wrtSerStage_2,
	       wrtSerStage_1,
	       wrtSerStage } ;
  assign IF_wrtSerPos_40_EQ_2_43_THEN_0x0_ELSE_metaWF_f_ETC___d409 =
	     { (wrtSerPos == 2'd2) ? 32'h0 : metaWF$D_OUT,
	       (wrtSerPos == 2'd2) ? metaWF$D_OUT : wrtSerStage_2,
	       wrtSerStage_1,
	       wrtSerStage } ;
  assign NOT_dlyWordsStored_value_27_SLE_0_81_82_AND_NO_ETC___d289 =
	     (dlyWordsStored_value ^ 24'h800000) > 24'd8388608 &&
	     bytesWritten >= dlyHoldoffBytes &&
	     cyclesPassed >= dlyHoldoffCycles ;
  assign NOT_wmemi_reqF_c_r_74_EQ_2_75_76_AND_NOT_wmemi_ETC___d314 =
	     wmemi_reqF_c_r != 2'd2 && wmemi_dhF_c_r != 2'd2 &&
	     wmemi_operateD &&
	     wmemi_peerIsReady ;
  assign NOT_wrtSerPos_40_EQ_3_47_48_AND_NOT_metaWF_fir_ETC___d396 =
	     wrtSerPos != 2'd3 && metaWF$D_OUT[23:0] != 24'd0 ||
	     CASE_wrtSerPos_NOT_wrtSerPos_EQ_3_OR_wide16Fa_ETC__q2 ;
  assign _dor1bytesWritten$EN_write =
	     WILL_FIRE_RL_wmwt_messagePushPrecise ||
	     WILL_FIRE_RL_wmwt_messagePushImprecise ;
  assign addr__h21238 = { 9'd0, x__h21296 } ;
  assign addr__h21506 = { 9'd0, x__h21551 } ;
  assign mesgRF_RDY_enq__12_AND_NOT_rdSerEmpty_13_14_AN_ETC___d225 =
	     mesgRF$FULL_N &&
	     (!rdSerEmpty && rdSerPos != 2'd0 || wide16Fb$EMPTY_N) ;
  assign metaRF_RDY_enq__58_AND_NOT_rdSerEmpty_13_14_AN_ETC___d259 =
	     metaRF$FULL_N &&
	     (!rdSerEmpty && rdSerPos != 2'd0 || wide16Fb$EMPTY_N) ;
  assign mlp1__h17939 = mesgLengthSoFar + 14'd1 ;
  assign rdat__h22235 = hasDebugLogic ? mesgWtCount : 32'd0 ;
  assign rdat__h22241 = hasDebugLogic ? mesgRdCount : 32'd0 ;
  assign rdat__h22248 = hasDebugLogic ? bytesWritten : 32'd0 ;
  assign rdat__h22254 = hasDebugLogic ? { 8'd0, x__h22258 } : 32'd0 ;
  assign rdat__h22378 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h22392 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h22400 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h22406 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h22420 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h22428 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h22434 = hasDebugLogic ? wmemiWrReq : 32'd0 ;
  assign rdat__h22440 = hasDebugLogic ? wmemiRdReq : 32'd0 ;
  assign rdat__h22446 = hasDebugLogic ? wmemiRdResp : 32'd0 ;
  assign rdat__h22452 =
	     hasDebugLogic ? { 8'd0, dlyWordsStored_value } : 32'd0 ;
  assign rdat__h22462 =
	     hasDebugLogic ? { 24'd0, dlyReadCredit_value } : 32'd0 ;
  assign rdat__h22472 = hasDebugLogic ? { 9'd0, dlyWAG } : 32'd0 ;
  assign rdat__h22482 = hasDebugLogic ? { 9'd0, dlyRAG } : 32'd0 ;
  assign rdat__h22492 = { {24{dlyMaxReadCredit[7]}}, dlyMaxReadCredit } ;
  assign v__h23203 = metaRF$D_IN ;
  ...
  assign wci_cState_9_EQ_2_0_AND_dlyCtrl_5_BITS_3_TO_0__ETC___d429 =
	     wci_cState == 3'd2 && dlyCtrl[3:0] == 4'h7 && mesgLength[14] &&
	     !doAbort &&
	     (preciseBurst && wsiWordsRemain == 12'd0 ||
	      impreciseBurst && endOfMessage) ;
  assign wrtSerPos_40_PLUS_1___d1041 = wrtSerPos + 2'd1 ;
  assign wsiS_reqFifo_notFull__28_AND_wsiS_burstKind_08_ETC___d744 =
	     wsiS_reqFifo$FULL_N &&
	     (wsiS_burstKind == 2'd0 ||
	      (wsiS_burstKind == 2'd1 || wsiS_burstKind == 2'd2) &&
	      wsiS_wsiReq$wget[93]) ;
  assign x1__h19940 = { 96'd0, x__h19801[31:0] } ;
  assign x1__h19971 = { 64'd0, x__h19801[31:0], wrtSerStage } ;
  ...
  assign x__h19801 = mesgWF_wDataOut$wget ;
  assign x__h21296 = { dlyRAG, 4'h0 } ;
  assign x__h21551 = { dlyWAG, 4'h0 } ;
  assign x__h22258 = { wmemi_statusR, wsiS_statusR, wsiM_statusR } ;
  assign x_burstLength__h22922 =
	     (readMeta[23:0] == 24'd0) ? 12'd1 : readMeta[14:3] ;
  assign x_byteEn__h22923 = (readMeta[23:0] == 24'd0) ? 8'd0 : 8'd255 ;
  always@(wci_reqF$D_OUT or
	  ...
	  rdat__h22446 or
	  rdat__h22452 or
	  rdat__h22462 or rdat__h22472 or rdat__h22482 or rdat__h22492)
  begin
    case (wci_reqF$D_OUT[51:32])
      20'h0: x_data__h22208 = dlyCtrl;
      20'h00004: x_data__h22208 = dlyHoldoffBytes;
      20'h00008: x_data__h22208 = dlyHoldoffCycles;
      20'h0000C: x_data__h22208 = rdat__h22235;
      20'h00010: x_data__h22208 = rdat__h22241;
      20'h00014: x_data__h22208 = rdat__h22248;
      20'h00018: x_data__h22208 = rdat__h22254;
      20'h0001C: x_data__h22208 = 32'd0;
      20'h00020: x_data__h22208 = rdat__h22378;
      20'h00024: x_data__h22208 = rdat__h22392;
      20'h00028: x_data__h22208 = rdat__h22400;
      20'h0002C: x_data__h22208 = rdat__h22406;
      20'h00030: x_data__h22208 = rdat__h22420;
      20'h00034: x_data__h22208 = rdat__h22428;
      20'h00038: x_data__h22208 = rdat__h22434;
      20'h0003C: x_data__h22208 = rdat__h22440;
      20'h00040: x_data__h22208 = rdat__h22446;
      20'h00044: x_data__h22208 = rdat__h22452;
      20'h00048: x_data__h22208 = rdat__h22462;
      20'h0004C: x_data__h22208 = rdat__h22472;
      20'h00050: x_data__h22208 = rdat__h22482;
      20'h00054: x_data__h22208 = rdat__h22492;
      default: x_data__h22208 = 32'd0;
    endcase
  end
  always@(wrtSerPos)
  begin
