...
//
// On Thu Jul  8 12:39:13 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker8B(wciS0_Clk,
  ...
  wire [127 : 0] IF_wrtSerPos_40_EQ_2_43_THEN_0x0_ELSE_mesgWF_w_ETC___d384,
		 ...
		 x1__h20358,
		 x1__h20385;
  wire [63 : 0] x__h15147, x__h19523;
  wire [35 : 0] addr__h20960, addr__h21228;
  wire [31 : 0] rdat__h21957,
		rdat__h21963,
		rdat__h21970,
		rdat__h21976,
		rdat__h22100,
		...
		rdat__h22214,
		v__h22925;
  wire [26 : 0] x__h21018, x__h21273;
  wire [23 : 0] x1_length__h17029, x__h21980;
  wire [13 : 0] mlp1__h17699, x__h17073;
  wire [12 : 0] x__h15039;
  wire [11 : 0] x_burstLength__h22644;
  wire [7 : 0] x1_opcode__h17028, x_byteEn__h22645;
  wire [1 : 0] wrtSerPos_40_PLUS_1___d942;
  wire IF_wrtSerPos_40_EQ_0_41_OR_wrtSerPos_40_EQ_1_4_ETC___d360,
       ...
       NOT_wsiS_reqFifo_countReg_10_ULE_1_11___d712,
  ...
  assign MUX_mesgLength$write_1__VAL_3 = { 1'd1, mlp1__h17699[10:0], 3'd0 } ;
  assign MUX_mesgRdCount$write_1__VAL_1 = mesgRdCount + 32'd1 ;
  assign MUX_mesgWtCount$write_1__VAL_1 = mesgWtCount + 32'd1 ;
  assign MUX_metaWF$enq_1__VAL_1 = { x1_opcode__h17028, x1_length__h17029 } ;
  ...
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_1 = { 4'd5, addr__h20960, 12'd1 } ;
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_2 = { 4'd3, addr__h21228, 12'd1 } ;
  assign MUX_rdSyncWord$write_1__VAL_2 =
	     rdSerPos != 2'd3 && v__h22925[23:0] == 24'd0 ;
  assign MUX_wsiM_reqFifo_x_wire$wset_1__VAL_1 =
	     { 3'd1,
	       unrollCnt == 16'd1,
	       1'd1,
	       x_burstLength__h22644,
	       mesgRF$D_OUT,
	       x_byteEn__h22645,
	       readMeta[31:24] } ;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_1 = { 2'd1, x_data__h21930 } ;
  ...
  always@(wrtSerPos or
	  ...
	  x1__h19662 or x1__h19693)
  begin
    case (wrtSerPos)
      2'd0: MUX_wide16Fa$enq_1__VAL_2 = x1__h19662;
      2'd1: MUX_wide16Fa$enq_1__VAL_2 = x1__h19693;
  ...
  always@(wrtSerPos or
	  ...
	  x1__h20358 or x1__h20385)
  begin
    case (wrtSerPos)
      2'd0: MUX_wide16Fa$enq_1__VAL_1 = x1__h20358;
      2'd1: MUX_wide16Fa$enq_1__VAL_1 = x1__h20385;
      default: MUX_wide16Fa$enq_1__VAL_1 =
		   IF_wrtSerPos_40_EQ_2_43_THEN_0x0_ELSE_metaWF_f_ETC___d409;
    endcase
  end
  assign MUX_wrtSerPos$write_1__VAL_1 =
	     (wrtSerUnroll == 16'd1) ? 2'd0 : wrtSerPos_40_PLUS_1___d942 ;
  assign MUX_wrtSerPos$write_1__VAL_2 =
	     (metaWF$D_OUT[23:0] == 24'd0) ?
	       2'd0 :
	       wrtSerPos_40_PLUS_1___d942 ;
  ...
  assign wrtSerStage$D_IN =
	     MUX_wrtSerStage$write_1__SEL_1 ? x__h19523[31:0] : metaWF$D_OUT ;
  ...
  assign mesgRF$D_IN = { 32'd0, v__h22925 } ;
  ...
  assign IF_wrtSerPos_40_EQ_2_43_THEN_0x0_ELSE_mesgWF_w_ETC___d384 =
	     { (wrtSerPos == 2'd2) ? 32'h0 : x__h19523[31:0],
	       (wrtSerPos == 2'd2) ? x__h19523[31:0] : wrtSerStage_2,
	       wrtSerStage_1,
	       wrtSerStage } ;
  ...
  assign NOT_wrtSerPos_40_EQ_3_47_48_AND_NOT_metaWF_fir_ETC___d396 =
	     wrtSerPos != 2'd3 && metaWF$D_OUT[23:0] != 24'd0 ||
	     CASE_wrtSerPos_NOT_wrtSerPos_EQ_3_OR_wide16Fa_ETC__q2 ;
  assign NOT_wsiS_reqFifo_countReg_10_ULE_1_11___d712 =
	     wsiS_reqFifo_countReg > 2'd1 ;
  assign _dor1bytesWritten$EN_write =
	     WILL_FIRE_RL_wmwt_messagePushPrecise ||
	     WILL_FIRE_RL_wmwt_messagePushImprecise ;
  assign addr__h20960 = { 9'd0, x__h21018 } ;
  assign addr__h21228 = { 9'd0, x__h21273 } ;
  ...
  assign rdat__h21957 = hasDebugLogic ? mesgWtCount : 32'd0 ;
  assign rdat__h21963 = hasDebugLogic ? mesgRdCount : 32'd0 ;
  assign rdat__h21970 = hasDebugLogic ? bytesWritten : 32'd0 ;
  assign rdat__h21976 = hasDebugLogic ? { 8'd0, x__h21980 } : 32'd0 ;
  assign rdat__h22100 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h22114 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h22122 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h22128 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h22142 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h22150 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h22156 = hasDebugLogic ? wmemiWrReq : 32'd0 ;
  assign rdat__h22162 = hasDebugLogic ? wmemiRdReq : 32'd0 ;
  assign rdat__h22168 = hasDebugLogic ? wmemiRdResp : 32'd0 ;
  assign rdat__h22174 =
	     hasDebugLogic ? { 8'd0, dlyWordsStored_value } : 32'd0 ;
  assign rdat__h22184 =
	     hasDebugLogic ? { 24'd0, dlyReadCredit_value } : 32'd0 ;
  assign rdat__h22194 = hasDebugLogic ? { 9'd0, dlyWAG } : 32'd0 ;
  assign rdat__h22204 = hasDebugLogic ? { 9'd0, dlyRAG } : 32'd0 ;
  assign rdat__h22214 = { {24{dlyMaxReadCredit[7]}}, dlyMaxReadCredit } ;
  assign v__h22925 = metaRF$D_IN ;
  ...
  assign wrtSerPos_40_PLUS_1___d942 = wrtSerPos + 2'd1 ;
  assign x1__h19662 = { 96'd0, x__h19523[31:0] } ;
  assign x1__h19693 = { 64'd0, x__h19523[31:0], wrtSerStage } ;
  assign x1__h20358 = { 96'd0, metaWF$D_OUT } ;
  assign x1__h20385 = { 64'd0, metaWF$D_OUT, wrtSerStage } ;
  ...
  assign x__h19523 = mesgWF_wDataOut$wget ;
  assign x__h21018 = { dlyRAG, 4'h0 } ;
  assign x__h21273 = { dlyWAG, 4'h0 } ;
  assign x__h21980 = { wmemi_statusR, wsiS_statusR, wsiM_statusR } ;
  assign x_burstLength__h22644 =
	     (readMeta[23:0] == 24'd0) ? 12'd1 : readMeta[14:3] ;
  assign x_byteEn__h22645 = (readMeta[23:0] == 24'd0) ? 8'd0 : 8'd255 ;
  always@(wci_reqF$D_OUT or
	  ...
	  rdat__h22168 or
	  rdat__h22174 or
	  rdat__h22184 or rdat__h22194 or rdat__h22204 or rdat__h22214)
  begin
    case (wci_reqF$D_OUT[51:32])
      20'h0: x_data__h21930 = dlyCtrl;
      20'h00004: x_data__h21930 = dlyHoldoffBytes;
      20'h00008: x_data__h21930 = dlyHoldoffCycles;
      20'h0000C: x_data__h21930 = rdat__h21957;
      20'h00010: x_data__h21930 = rdat__h21963;
      20'h00014: x_data__h21930 = rdat__h21970;
      20'h00018: x_data__h21930 = rdat__h21976;
      20'h0001C: x_data__h21930 = 32'd0;
      20'h00020: x_data__h21930 = rdat__h22100;
      20'h00024: x_data__h21930 = rdat__h22114;
      20'h00028: x_data__h21930 = rdat__h22122;
      20'h0002C: x_data__h21930 = rdat__h22128;
      20'h00030: x_data__h21930 = rdat__h22142;
      20'h00034: x_data__h21930 = rdat__h22150;
      20'h00038: x_data__h21930 = rdat__h22156;
      20'h0003C: x_data__h21930 = rdat__h22162;
      20'h00040: x_data__h21930 = rdat__h22168;
      20'h00044: x_data__h21930 = rdat__h22174;
      20'h00048: x_data__h21930 = rdat__h22184;
      20'h0004C: x_data__h21930 = rdat__h22194;
      20'h00050: x_data__h21930 = rdat__h22204;
      20'h00054: x_data__h21930 = rdat__h22214;
      default: x_data__h21930 = 32'd0;
    endcase
  end
  always@(wrtSerPos)
  begin
