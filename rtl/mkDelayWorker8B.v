...
//
// On Thu Jul  1 06:53:42 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker8B(wciS0_Clk,
  ...
  reg [63 : 0] v__h16611,
	       ...
	       v__h2816,
	       v__h3715;
  reg [31 : 0] x_data__h20697;
  reg CASE_wrtSerPos_0b1_0_1_1_1_2_1_3_0b1__q1,
      IF_wrtSerPos_23_EQ_0_24_OR_wrtSerPos_23_EQ_1_2_ETC___d878;
  wire [127 : 0] IF_wrtSerPos_23_EQ_2_26_THEN_0x0_ELSE_mesgWF_w_ETC___d366,
		 ...
		 x1__h19385,
		 x1__h19394;
  wire [63 : 0] x__h15105, x__h18798;
  wire [35 : 0] addr__h19887, addr__h20059;
  wire [31 : 0] rdat__h20724,
		rdat__h20730,
		rdat__h20737,
		rdat__h20743,
		rdat__h20867,
		...
		rdat__h20971,
		v__h21637;
  wire [26 : 0] x__h19945, x__h20104;
  wire [23 : 0] x1_length__h16304, x__h20747;
  wire [13 : 0] mlp1__h16974, x__h16348;
  wire [12 : 0] x__h14997;
  wire [11 : 0] x_burstLength__h21356;
  wire [7 : 0] x1_opcode__h16303, x_byteEn__h21357;
  wire [1 : 0] wrtSerPos_23_PLUS_1___d990;
  wire NOT_dlyWordsStored_value_26_SLE_0_76_77_AND_NO_ETC___d284,
       NOT_wmemi_reqF_c_r_69_EQ_2_70_71_AND_NOT_wmemi_ETC___d303,
       NOT_wsiS_reqFifo_countReg_74_ULE_1_75___d676,
  ...
  assign MUX_mesgLength$write_1__VAL_3 = { 1'd1, mlp1__h16974[10:0], 3'd0 } ;
  assign MUX_mesgRdCount$write_1__VAL_1 = mesgRdCount + 32'd1 ;
  assign MUX_mesgWtCount$write_1__VAL_1 = mesgWtCount + 32'd1 ;
  assign MUX_metaWF$enq_1__VAL_2 = { x1_opcode__h16303, x1_length__h16304 } ;
  ...
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_1 = { 4'd5, addr__h19887, 12'd1 } ;
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_2 = { 4'd3, addr__h20059, 12'd1 } ;
  assign MUX_rdSyncWord$write_1__VAL_2 =
	     rdSerPos != 2'd3 && v__h21637[23:0] == 24'd0 ;
  assign MUX_wsiM_reqFifo_x_wire$wset_1__VAL_1 =
	     { 3'd1,
	       unrollCnt == 16'd1,
	       1'd1,
	       x_burstLength__h21356,
	       mesgRF$D_OUT,
	       x_byteEn__h21357,
	       readMeta[31:24] } ;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_1 = { 2'd1, x_data__h20697 } ;
  ...
  always@(wrtSerPos or
	  ...
	  x1__h18862 or x1__h18871)
  begin
    case (wrtSerPos)
      2'd0: MUX_wide16Fa$enq_1__VAL_2 = x1__h18862;
      2'd1: MUX_wide16Fa$enq_1__VAL_2 = x1__h18871;
  ...
  always@(wrtSerPos or
	  ...
	  x1__h19385 or x1__h19394)
  begin
    case (wrtSerPos)
      2'd0: MUX_wide16Fa$enq_1__VAL_1 = x1__h19385;
      2'd1: MUX_wide16Fa$enq_1__VAL_1 = x1__h19394;
      default: MUX_wide16Fa$enq_1__VAL_1 =
		   IF_wrtSerPos_23_EQ_2_26_THEN_0x0_ELSE_metaWF_f_ETC___d389;
    endcase
  end
  assign MUX_wrtSerPos$write_1__VAL_1 =
	     (wrtSerUnroll == 16'd1) ? 2'd0 : wrtSerPos_23_PLUS_1___d990 ;
  assign MUX_wrtSerPos$write_1__VAL_2 =
	     (metaWF$D_OUT[23:0] == 24'd0) ?
	       2'd0 :
	       wrtSerPos_23_PLUS_1___d990 ;
  ...
  assign wrtSerStage$D_IN =
	     MUX_wrtSerStage$write_1__SEL_1 ? x__h18798[31:0] : metaWF$D_OUT ;
  ...
  assign mesgRF$D_IN = { 32'd0, v__h21637 } ;
  ...
  assign IF_wrtSerPos_23_EQ_2_26_THEN_0x0_ELSE_mesgWF_w_ETC___d366 =
	     { (wrtSerPos == 2'd2) ? 32'h0 : x__h18798[31:0],
	       (wrtSerPos == 2'd2) ? x__h18798[31:0] : wrtSerStage_2,
	       wrtSerStage_1,
	       wrtSerStage } ;
  ...
  assign NOT_wmemi_reqF_c_r_69_EQ_2_70_71_AND_NOT_wmemi_ETC___d303 =
	     ...
	     wmemi_operateD &&
	     wmemi_peerIsReady ;
  assign NOT_wsiS_reqFifo_countReg_74_ULE_1_75___d676 =
	     wsiS_reqFifo_countReg > 2'd1 ;
  assign _dor1bytesWritten$EN_write =
	     WILL_FIRE_RL_wmwt_messagePushPrecise ||
	     WILL_FIRE_RL_wmwt_messagePushImprecise ;
  assign addr__h19887 = { 9'd0, x__h19945 } ;
  assign addr__h20059 = { 9'd0, x__h20104 } ;
  ...
  assign rdat__h20724 = hasDebugLogic ? mesgWtCount : 32'd0 ;
  assign rdat__h20730 = hasDebugLogic ? mesgRdCount : 32'd0 ;
  assign rdat__h20737 = hasDebugLogic ? bytesWritten : 32'd0 ;
  assign rdat__h20743 = hasDebugLogic ? { 8'd0, x__h20747 } : 32'd0 ;
  assign rdat__h20867 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h20881 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h20889 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h20895 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h20909 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h20917 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h20923 = hasDebugLogic ? wmemiWrReq : 32'd0 ;
  assign rdat__h20929 = hasDebugLogic ? wmemiRdReq : 32'd0 ;
  assign rdat__h20935 = hasDebugLogic ? wmemiRdResp : 32'd0 ;
  assign rdat__h20941 =
	     hasDebugLogic ? { 9'd0, dlyWordsStored_value } : 32'd0 ;
  assign rdat__h20951 =
	     hasDebugLogic ? { 24'd0, dlyReadCredit_value } : 32'd0 ;
  assign rdat__h20961 = hasDebugLogic ? { 9'd0, dlyWAG } : 32'd0 ;
  assign rdat__h20971 = hasDebugLogic ? { 9'd0, dlyRAG } : 32'd0 ;
  assign v__h21637 = metaRF$D_IN ;
  ...
  assign wrtSerPos_23_PLUS_1___d990 = wrtSerPos + 2'd1 ;
  assign x1__h18862 = { 96'd0, x__h18798[31:0] } ;
  assign x1__h18871 = { 64'd0, x__h18798[31:0], wrtSerStage } ;
  assign x1__h19385 = { 96'd0, metaWF$D_OUT } ;
  assign x1__h19394 = { 64'd0, metaWF$D_OUT, wrtSerStage } ;
  ...
  assign x__h18798 = mesgWF_wDataOut$wget ;
  assign x__h19945 = { dlyRAG, 4'h0 } ;
  assign x__h20104 = { dlyWAG, 4'h0 } ;
  assign x__h20747 = { wmemi_statusR, wsiS_statusR, wsiM_statusR } ;
  assign x_burstLength__h21356 =
	     (readMeta[23:0] == 24'd0) ? 12'd1 : readMeta[14:3] ;
  assign x_byteEn__h21357 = (readMeta[23:0] == 24'd0) ? 8'd0 : 8'd255 ;
  always@(wci_reqF$D_OUT or
	  ...
	  rdat__h20929 or
	  rdat__h20935 or
	  rdat__h20941 or rdat__h20951 or rdat__h20961 or rdat__h20971)
  begin
    case (wci_reqF$D_OUT[51:32])
      20'h0: x_data__h20697 = dlyCtrl;
      20'h00004: x_data__h20697 = dlyHoldoffBytes;
      20'h00008: x_data__h20697 = dlyHoldoffCycles;
      20'h0000C: x_data__h20697 = rdat__h20724;
      20'h00010: x_data__h20697 = rdat__h20730;
      20'h00014: x_data__h20697 = rdat__h20737;
      20'h00018: x_data__h20697 = rdat__h20743;
      20'h0001C: x_data__h20697 = 32'd0;
      20'h00020: x_data__h20697 = rdat__h20867;
      20'h00024: x_data__h20697 = rdat__h20881;
      20'h00028: x_data__h20697 = rdat__h20889;
      20'h0002C: x_data__h20697 = rdat__h20895;
      20'h00030: x_data__h20697 = rdat__h20909;
      20'h00034: x_data__h20697 = rdat__h20917;
      20'h00038: x_data__h20697 = rdat__h20923;
      20'h0003C: x_data__h20697 = rdat__h20929;
      20'h00040: x_data__h20697 = rdat__h20935;
      20'h00044: x_data__h20697 = rdat__h20941;
      20'h00048: x_data__h20697 = rdat__h20951;
      20'h0004C: x_data__h20697 = rdat__h20961;
      20'h00050: x_data__h20697 = rdat__h20971;
      default: x_data__h20697 = 32'd0;
    endcase
  end
