...
//
// On Thu Jun  3 15:11:54 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker8B(wciS0_Clk,
  ...
  wire [63 : 0] mesg__h21701, x__h15021, x__h15947, x__h19644;
  ...
  wire [7 : 0] x1_opcode__h17051, x_byteEn__h21793;
  ...
  assign mesgRF_wDataIn$wget = { 32'd0, v__h22014 } ;
  ...
  assign x_byteEn__h21793 = (readMeta[23:0] == 24'd0) ? 8'd0 : 8'd255 ;
  always@(wrtSerPos)
  begin
    case (wrtSerPos)
