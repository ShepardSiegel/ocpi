...
//
// On Fri Jul 23 11:09:30 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker8B(wciS0_Clk,
  ...
  reg [31 : 0] x_data__h21642;
  reg CASE_wrtSerPos_0b1_0_1_1_1_2_1_3_0b1__q1,
      CASE_wrtSerPos_NOT_wrtSerPos_EQ_3_OR_wide16Fa_ETC__q2;
  wire [127 : 0] IF_wrtSerPos_76_EQ_2_79_THEN_0x0_ELSE_mesgWF_w_ETC___d420,
		 IF_wrtSerPos_76_EQ_2_79_THEN_0x0_ELSE_metaWF_f_ETC___d445,
		 x1__h17560,
		 x1__h17591,
		 x1__h18226,
		 x1__h18253;
  wire [63 : 0] x__h14794, x__h17421;
  wire [35 : 0] addr__h18912, addr__h19080;
  wire [31 : 0] delayStatus__h21238,
		rdat__h21669,
		rdat__h21675,
		rdat__h21681,
		rdat__h21687,
  ...
  wire [7 : 0] x_byteEn__h19412;
  wire [1 : 0] wrtSerPos_76_PLUS_1___d920;
  wire IF_wrtSerPos_76_EQ_0_77_OR_wrtSerPos_76_EQ_1_7_ETC___d396,
       NOT_mesgWF_rRdPtr_62_EQ_mesgWF_rWrPtr_64_67___d168,
       NOT_mesgWF_rRdPtr_62_PLUS_2048_63_EQ_mesgWF_rW_ETC___d166,
       NOT_wmemi_reqF_c_r_34_EQ_2_35_36_AND_NOT_wmemi_ETC___d363,
       NOT_wrtSerPos_76_EQ_3_83_84_AND_NOT_metaWF_fir_ETC___d432,
       ...
       metaRF_RDY_enq__05_AND_NOT_rdSerEmpty_60_61_AN_ETC___d306,
       wci_cState_9_EQ_2_0_AND_dlyCtrl_4_BITS_3_TO_0__ETC___d346,
       wci_cState_9_EQ_2_0_AND_dlyCtrl_4_BITS_3_TO_0__ETC___d367,
       wsiS_reqFifo_notFull__99_AND_wsiS_burstKind_79_ETC___d717;
  ...
  assign CAN_FIRE_RL_wrtSer_body =
	     NOT_mesgWF_rRdPtr_62_EQ_mesgWF_rWrPtr_64_67___d168 &&
	     IF_wrtSerPos_76_EQ_0_77_OR_wrtSerPos_76_EQ_1_7_ETC___d396 &&
	     wci_cState == 3'd2 &&
	     dlyCtrl[3:0] == 4'h7 &&
	     wrtSerUnroll != 16'd0 ;
  ...
  assign MUX_wsiS_reqFifo_levelsValid$write_1__SEL_3 =
	     ...
	     wci_cState == 3'd2 &&
	     dlyCtrl[3:0] == 4'h7 ;
  assign MUX_wci_respF_x_wire$wset_1__VAL_1 = { 2'd1, x_data__h21642 } ;
  ...
  assign MUX_rdSyncWord$write_1__VAL_2 =
	     rdSerPos != 2'd3 && v__h19693[23:0] == 24'd0 ;
  ...
  always@(wrtSerPos or
	  IF_wrtSerPos_76_EQ_2_79_THEN_0x0_ELSE_mesgWF_w_ETC___d420 or
  ...
  begin
    case (wrtSerPos)
      ...
      default: MUX_wide16Fa$enq_1__VAL_2 =
		   IF_wrtSerPos_76_EQ_2_79_THEN_0x0_ELSE_mesgWF_w_ETC___d420;
    endcase
  end
  always@(wrtSerPos or
	  IF_wrtSerPos_76_EQ_2_79_THEN_0x0_ELSE_metaWF_f_ETC___d445 or
  ...
  assign MUX_wrtSerPos$write_1__VAL_1 =
	     (wrtSerUnroll == 16'd1) ? 2'd0 : wrtSerPos_76_PLUS_1___d920 ;
  assign MUX_wrtSerPos$write_1__VAL_2 =
	     (metaWF$D_OUT[23:0] == 24'd0) ?
	       2'd0 :
	       wrtSerPos_76_PLUS_1___d920 ;
  ...
  assign dlyRdOpOther$EN =
	     WILL_FIRE_RL_rdSer_begin && v__h19693[31:24] != 8'd0 ;
  ...
  assign wrtSerStage$D_IN =
	     MUX_wrtSerStage$write_1__SEL_1 ? x__h17421[31:0] : metaWF$D_OUT ;
  ...
  assign wsiS_wordCount$D_IN =
	     wsiS_wsiReq$wget[93] ? 12'd0 : wsiS_wordCount + 12'd1 ;
  ...
  assign mesgRF$D_IN = { 32'd0, v__h19693 } ;
  ...
  // remaining internal signals
  assign IF_wrtSerPos_76_EQ_0_77_OR_wrtSerPos_76_EQ_1_7_ETC___d396 =
	     CASE_wrtSerPos_0b1_0_1_1_1_2_1_3_0b1__q1 &&
	     (wrtSerPos != 2'd3 && wrtSerUnroll != 16'd1 ||
	      CASE_wrtSerPos_NOT_wrtSerPos_EQ_3_OR_wide16Fa_ETC__q2) ;
  assign IF_wrtSerPos_76_EQ_2_79_THEN_0x0_ELSE_mesgWF_w_ETC___d420 =
	     { (wrtSerPos == 2'd2) ? 32'h0 : x__h17421[31:0],
	       (wrtSerPos == 2'd2) ? x__h17421[31:0] : wrtSerStage_2,
	       wrtSerStage_1,
	       wrtSerStage } ;
  assign IF_wrtSerPos_76_EQ_2_79_THEN_0x0_ELSE_metaWF_f_ETC___d445 =
  ...
  assign NOT_wmemi_reqF_c_r_34_EQ_2_35_36_AND_NOT_wmemi_ETC___d363 =
	     wmemi_reqF_c_r != 2'd2 && wmemi_dhF_c_r != 2'd2 &&
	     wmemi_operateD &&
	     wmemi_peerIsReady ;
  assign NOT_wrtSerPos_76_EQ_3_83_84_AND_NOT_metaWF_fir_ETC___d432 =
	     wrtSerPos != 2'd3 && metaWF$D_OUT[23:0] != 24'd0 ||
	     CASE_wrtSerPos_NOT_wrtSerPos_EQ_3_OR_wide16Fa_ETC__q2 ;
  ...
  assign metaRF_RDY_enq__05_AND_NOT_rdSerEmpty_60_61_AN_ETC___d306 =
	     metaRF$FULL_N &&
	     (!rdSerEmpty && rdSerPos != 2'd0 || wide16Fc$EMPTY_N) ;
  ...
  assign v__h19693 = metaRF$D_IN ;
  assign wci_cState_9_EQ_2_0_AND_dlyCtrl_4_BITS_3_TO_0__ETC___d346 =
	     wci_cState == 3'd2 && dlyCtrl[3:0] == 4'h7 &&
	     !dlyWordsStored_value_26_SLE_0___d149 &&
	     !bytesWritten_6_ULT_dlyHoldoffBytes_6___d150 &&
	     !cyclesPassed_52_ULT_dlyHoldoffCycles_8___d153 ;
  assign wci_cState_9_EQ_2_0_AND_dlyCtrl_4_BITS_3_TO_0__ETC___d367 =
	     wci_cState == 3'd2 && dlyCtrl[3:0] == 4'h7 &&
	     dlyWordsStored_value_26_SLE_0_49_OR_bytesWritt_ETC___d157 &&
	     dlyWordsStored_value_26_SLT_8388608___d158 ;
  assign wrtSerPos_76_PLUS_1___d920 = wrtSerPos + 2'd1 ;
  assign wsiS_reqFifo_notFull__99_AND_wsiS_burstKind_79_ETC___d717 =
	     wsiS_reqFifo$FULL_N &&
	     (wsiS_burstKind == 2'd0 ||
	      (wsiS_burstKind == 2'd1 || wsiS_burstKind == 2'd2) &&
	      wsiS_wsiReq$wget[93]) ;
  assign x1__h17560 = { 96'd0, x__h17421[31:0] } ;
  assign x1__h17591 = { 64'd0, x__h17421[31:0], wrtSerStage } ;
  ...
  assign x__h14794 =
	     MUX_wsiS_reqFifo_levelsValid$write_1__SEL_3 ?
	       ...
	       64'd0 ;
  assign x__h16572 = { wsiS_wordCount[8:0], 3'd0 } ;
  assign x__h17421 = mesgWF_wDataOut$wget ;
  ...
  assign x_byteEn__h19412 = (readMeta[23:0] == 24'd0) ? 8'd0 : 8'd255 ;
