...
//
// On Sat Jan  8 10:50:24 EST 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker8B(wciS0_Clk,
  ...
  // submodule mesgRF
  assign mesgRF$D_IN = { 32'd0, v__h20293 } ;
  ...
  assign btm__h17807 =
		 ...
		 { 7'd0, mesgLengthSoFar_82_PLUS_1___d970 },
	       3'd0 } ;
  ...
  assign x_byteEn__h22166 = (readMeta[23:0] == 24'd0) ? 8'd0 : 8'd255 ;
  always@(rdSerPos or
