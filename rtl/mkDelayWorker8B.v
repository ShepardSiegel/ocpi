...
//
// On Tue Jul 13 17:08:25 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker8B(wciS0_Clk,
  ...
  reg [63 : 0] v__h17599,
	       ...
	       v__h2820,
	       v__h3719;
  reg [31 : 0] x_data__h22360;
  reg CASE_wrtSerPos_0b1_0_1_1_1_2_1_3_0b1__q1,
      CASE_wrtSerPos_NOT_wrtSerPos_EQ_3_OR_wide16Fa_ETC__q2;
  wire [127 : 0] IF_wrtSerPos_55_EQ_2_58_THEN_0x0_ELSE_mesgWF_w_ETC___d399,
		 IF_wrtSerPos_55_EQ_2_58_THEN_0x0_ELSE_metaWF_f_ETC___d424,
		 x1__h19994,
		 x1__h20025,
		 x1__h20690,
		 x1__h20717;
  wire [63 : 0] x__h15357, x__h19855;
  wire [35 : 0] addr__h21367, addr__h21658;
  wire [31 : 0] rdat__h22387,
		rdat__h22393,
		rdat__h22400,
		rdat__h22406,
		rdat__h22530,
		...
		rdat__h22653,
		v__h23365;
  wire [26 : 0] x__h21425, x__h21703;
  wire [23 : 0] x1_length__h17292, x__h22410;
  wire [13 : 0] mlp1__h17993, x__h17336;
  wire [12 : 0] x__h15249;
  wire [11 : 0] x_burstLength__h23084;
  wire [7 : 0] x1_opcode__h17291, x_byteEn__h23085;
  wire [1 : 0] wrtSerPos_55_PLUS_1___d1056;
  wire IF_wrtSerPos_55_EQ_0_56_OR_wrtSerPos_55_EQ_1_5_ETC___d375,
       NOT_dlyWordsStored_value_27_SLE_0_91_92_AND_NO_ETC___d299,
       NOT_wrtSerPos_55_EQ_3_62_63_AND_NOT_metaWF_fir_ETC___d411,
       _dor1bytesWritten$EN_write,
       mesgRF_RDY_enq__15_AND_NOT_rdSerEmpty_16_17_AN_ETC___d228,
       metaRF_RDY_enq__61_AND_NOT_rdSerEmpty_16_17_AN_ETC___d262,
       wci_cState_9_EQ_2_0_AND_dlyCtrl_5_BITS_3_TO_0__ETC___d309,
       wci_cState_9_EQ_2_0_AND_dlyCtrl_5_BITS_3_TO_0__ETC___d337,
       wci_cState_9_EQ_2_0_AND_dlyCtrl_5_BITS_3_TO_0__ETC___d444,
       wsiS_reqFifo_notFull__43_AND_wsiS_burstKind_23_ETC___d759;
  ...
  assign CAN_FIRE_RL_wrtSer_body =
	     ...
	     IF_wrtSerPos_55_EQ_0_56_OR_wrtSerPos_55_EQ_1_5_ETC___d375 &&
	     wci_cState == 3'd2 &&
	     dlyCtrl[3:0] == 4'h7 &&
	     wrtSerUnroll != 16'd0 ;
  ...
  assign MUX_mesgLength$write_1__VAL_3 = { 1'd1, mlp1__h17993[10:0], 3'd0 } ;
  ...
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_1 = { 4'd5, addr__h21367, 12'd1 } ;
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_2 = { 4'd3, addr__h21658, 12'd1 } ;
  assign MUX_rdSyncWord$write_1__VAL_2 =
	     rdSerPos != 2'd3 && v__h23365[23:0] == 24'd0 ;
  assign MUX_wsiM_reqFifo_x_wire$wset_1__VAL_1 =
	     { 3'd1,
	       unrollCnt == 16'd1,
	       1'd1,
	       x_burstLength__h23084,
	       mesgRF$D_OUT,
	       x_byteEn__h23085,
	       readMeta[31:24] } ;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_1 = { 2'd1, x_data__h22360 } ;
  ...
  always@(wrtSerPos or
	  IF_wrtSerPos_55_EQ_2_58_THEN_0x0_ELSE_mesgWF_w_ETC___d399 or
	  x1__h19994 or x1__h20025)
  begin
    case (wrtSerPos)
      2'd0: MUX_wide16Fa$enq_1__VAL_2 = x1__h19994;
      2'd1: MUX_wide16Fa$enq_1__VAL_2 = x1__h20025;
      default: MUX_wide16Fa$enq_1__VAL_2 =
		   IF_wrtSerPos_55_EQ_2_58_THEN_0x0_ELSE_mesgWF_w_ETC___d399;
    endcase
  end
  always@(wrtSerPos or
	  IF_wrtSerPos_55_EQ_2_58_THEN_0x0_ELSE_metaWF_f_ETC___d424 or
	  x1__h20690 or x1__h20717)
  begin
    case (wrtSerPos)
      2'd0: MUX_wide16Fa$enq_1__VAL_1 = x1__h20690;
      2'd1: MUX_wide16Fa$enq_1__VAL_1 = x1__h20717;
  ...
  assign MUX_wrtSerPos$write_1__VAL_1 =
	     (wrtSerUnroll == 16'd1) ? 2'd0 : wrtSerPos_55_PLUS_1___d1056 ;
  assign MUX_wrtSerPos$write_1__VAL_2 =
	     (metaWF$D_OUT[23:0] == 24'd0) ?
	       2'd0 :
	       wrtSerPos_55_PLUS_1___d1056 ;
  ...
  begin
    case (rdSerPos)
      2'd0: rdSerMeta$D_IN = wide16Fc$D_OUT[31:0];
      2'd1: rdSerMeta$D_IN = rdSerStage_1;
      2'd2: rdSerMeta$D_IN = rdSerStage_2;
      2'd3: rdSerMeta$D_IN = rdSerStage_3;
    endcase
  end
  ...
  assign wrtSerStage$D_IN =
	     MUX_wrtSerStage$write_1__SEL_1 ? x__h19855[31:0] : metaWF$D_OUT ;
  ...
  assign mesgRF$D_IN = { 32'd0, v__h23365 } ;
  ...
  // submodule metaRF
  assign metaRF$D_IN = rdSerMeta$D_IN ;
  ...
  // remaining internal signals
  assign IF_wrtSerPos_55_EQ_0_56_OR_wrtSerPos_55_EQ_1_5_ETC___d375 =
	     CASE_wrtSerPos_0b1_0_1_1_1_2_1_3_0b1__q1 &&
	     (wrtSerPos != 2'd3 && wrtSerUnroll != 16'd1 ||
	      CASE_wrtSerPos_NOT_wrtSerPos_EQ_3_OR_wide16Fa_ETC__q2) ;
  assign IF_wrtSerPos_55_EQ_2_58_THEN_0x0_ELSE_mesgWF_w_ETC___d399 =
	     { (wrtSerPos == 2'd2) ? 32'h0 : x__h19855[31:0],
	       (wrtSerPos == 2'd2) ? x__h19855[31:0] : wrtSerStage_2,
	       wrtSerStage_1,
	       wrtSerStage } ;
  assign IF_wrtSerPos_55_EQ_2_58_THEN_0x0_ELSE_metaWF_f_ETC___d424 =
	     { (wrtSerPos == 2'd2) ? 32'h0 : metaWF$D_OUT,
	       (wrtSerPos == 2'd2) ? metaWF$D_OUT : wrtSerStage_2,
	       wrtSerStage_1,
	       wrtSerStage } ;
  assign NOT_dlyWordsStored_value_27_SLE_0_91_92_AND_NO_ETC___d299 =
	     (dlyWordsStored_value ^ 24'h800000) > 24'd8388608 &&
	     bytesWritten >= dlyHoldoffBytes &&
	     cyclesPassed >= dlyHoldoffCycles ;
  assign NOT_wrtSerPos_55_EQ_3_62_63_AND_NOT_metaWF_fir_ETC___d411 =
	     wrtSerPos != 2'd3 && metaWF$D_OUT[23:0] != 24'd0 ||
	     CASE_wrtSerPos_NOT_wrtSerPos_EQ_3_OR_wide16Fa_ETC__q2 ;
  assign _dor1bytesWritten$EN_write =
	     WILL_FIRE_RL_wmwt_messagePushPrecise ||
	     WILL_FIRE_RL_wmwt_messagePushImprecise ;
  assign addr__h21367 = { 9'd0, x__h21425 } ;
  assign addr__h21658 = { 9'd0, x__h21703 } ;
  assign mesgRF_RDY_enq__15_AND_NOT_rdSerEmpty_16_17_AN_ETC___d228 =
	     mesgRF$FULL_N &&
	     (!rdSerEmpty && rdSerPos != 2'd0 || wide16Fc$EMPTY_N) ;
  assign metaRF_RDY_enq__61_AND_NOT_rdSerEmpty_16_17_AN_ETC___d262 =
	     metaRF$FULL_N &&
	     (!rdSerEmpty && rdSerPos != 2'd0 || wide16Fc$EMPTY_N) ;
  assign mlp1__h17993 = mesgLengthSoFar + 14'd1 ;
  assign rdat__h22387 = hasDebugLogic ? mesgWtCount : 32'd0 ;
  assign rdat__h22393 = hasDebugLogic ? mesgRdCount : 32'd0 ;
  assign rdat__h22400 = hasDebugLogic ? bytesWritten : 32'd0 ;
  assign rdat__h22406 = hasDebugLogic ? { 8'd0, x__h22410 } : 32'd0 ;
  assign rdat__h22530 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h22544 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h22552 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h22558 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h22572 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h22580 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h22586 = hasDebugLogic ? wmemiWrReq : 32'd0 ;
  assign rdat__h22592 = hasDebugLogic ? wmemiRdReq : 32'd0 ;
  assign rdat__h22598 = hasDebugLogic ? wmemiRdResp : 32'd0 ;
  assign rdat__h22604 =
	     hasDebugLogic ? { 8'd0, dlyWordsStored_value } : 32'd0 ;
  assign rdat__h22614 =
	     hasDebugLogic ? { 24'd0, dlyReadCredit_value } : 32'd0 ;
  assign rdat__h22624 = hasDebugLogic ? { 9'd0, dlyWAG } : 32'd0 ;
  assign rdat__h22634 = hasDebugLogic ? { 9'd0, dlyRAG } : 32'd0 ;
  assign rdat__h22644 = { {24{dlyMaxReadCredit[7]}}, dlyMaxReadCredit } ;
  assign rdat__h22653 =
	     { {24{dlyReadCredit_value[7]}}, dlyReadCredit_value } ;
  assign v__h23365 = rdSerMeta$D_IN ;
  assign wci_cState_9_EQ_2_0_AND_dlyCtrl_5_BITS_3_TO_0__ETC___d309 =
	     wci_cState == 3'd2 && dlyCtrl[3:0] == 4'h7 &&
	     NOT_dlyWordsStored_value_27_SLE_0_91_92_AND_NO_ETC___d299 &&
	     (dlyReadCredit_value ^ 8'h80) > 8'd128 &&
	     (!dlyWriteJustFired || dlyCtrl[5]) &&
	     wsiM_reqFifo_c_r != 2'd2 ;
  assign wci_cState_9_EQ_2_0_AND_dlyCtrl_5_BITS_3_TO_0__ETC___d337 =
	     wci_cState == 3'd2 && dlyCtrl[3:0] == 4'h7 &&
	     ((dlyWriteJustFired || dlyWriteFlush == 8'd255) ?
		(dlyReadyToWrite_value ^ 5'h10) > 5'd16 :
		(dlyReadyToWrite_value ^ 5'h10) > 5'd23) ;
  assign wci_cState_9_EQ_2_0_AND_dlyCtrl_5_BITS_3_TO_0__ETC___d444 =
	     wci_cState == 3'd2 && dlyCtrl[3:0] == 4'h7 && mesgLength[14] &&
	     !doAbort &&
	     (preciseBurst && wsiWordsRemain == 12'd0 ||
	      impreciseBurst && endOfMessage) ;
  assign wrtSerPos_55_PLUS_1___d1056 = wrtSerPos + 2'd1 ;
  assign wsiS_reqFifo_notFull__43_AND_wsiS_burstKind_23_ETC___d759 =
	     wsiS_reqFifo$FULL_N &&
	     (wsiS_burstKind == 2'd0 ||
	      (wsiS_burstKind == 2'd1 || wsiS_burstKind == 2'd2) &&
	      wsiS_wsiReq$wget[93]) ;
  assign x1__h19994 = { 96'd0, x__h19855[31:0] } ;
  assign x1__h20025 = { 64'd0, x__h19855[31:0], wrtSerStage } ;
  assign x1__h20690 = { 96'd0, metaWF$D_OUT } ;
  assign x1__h20717 = { 64'd0, metaWF$D_OUT, wrtSerStage } ;
  ...
  assign x__h19855 = mesgWF_wDataOut$wget ;
  assign x__h21425 = { dlyRAG, 4'h0 } ;
  assign x__h21703 = { dlyWAG, 4'h0 } ;
  assign x__h22410 = { wmemi_statusR, wsiS_statusR, wsiM_statusR } ;
  assign x_burstLength__h23084 =
	     (readMeta[23:0] == 24'd0) ? 12'd1 : readMeta[14:3] ;
  assign x_byteEn__h23085 = (readMeta[23:0] == 24'd0) ? 8'd0 : 8'd255 ;
  always@(wci_reqF$D_OUT or
	  ...
	  rdat__h22604 or
	  rdat__h22614 or
	  rdat__h22624 or rdat__h22634 or rdat__h22644 or rdat__h22653)
  begin
    case (wci_reqF$D_OUT[51:32])
      20'h0: x_data__h22360 = dlyCtrl;
      20'h00004: x_data__h22360 = dlyHoldoffBytes;
      20'h00008: x_data__h22360 = dlyHoldoffCycles;
      20'h0000C: x_data__h22360 = rdat__h22387;
      20'h00010: x_data__h22360 = rdat__h22393;
      20'h00014: x_data__h22360 = rdat__h22400;
      20'h00018: x_data__h22360 = rdat__h22406;
      20'h0001C: x_data__h22360 = 32'd0;
      20'h00020: x_data__h22360 = rdat__h22530;
      20'h00024: x_data__h22360 = rdat__h22544;
      20'h00028: x_data__h22360 = rdat__h22552;
      20'h0002C: x_data__h22360 = rdat__h22558;
      20'h00030: x_data__h22360 = rdat__h22572;
      20'h00034: x_data__h22360 = rdat__h22580;
      20'h00038: x_data__h22360 = rdat__h22586;
      20'h0003C: x_data__h22360 = rdat__h22592;
      20'h00040: x_data__h22360 = rdat__h22598;
      20'h00044: x_data__h22360 = rdat__h22604;
      20'h00048: x_data__h22360 = rdat__h22614;
      20'h0004C: x_data__h22360 = rdat__h22624;
      20'h00050: x_data__h22360 = rdat__h22634;
      20'h00054: x_data__h22360 = rdat__h22644;
      20'h00058: x_data__h22360 = rdat__h22653;
      default: x_data__h22360 = 32'd0;
    endcase
  end
  always@(wrtSerPos)
  begin
