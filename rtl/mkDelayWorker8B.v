...
//
// On Mon Jul 12 17:43:26 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker8B(wciS0_Clk,
  ...
  wire [12 : 0] x__h15249;
  wire [11 : 0] x_burstLength__h22893;
  wire [7 : 0] x1_opcode__h17238, x_byteEn__h22894;
  ...
  wire IF_wrtSerPos_41_EQ_0_42_OR_wrtSerPos_41_EQ_1_4_ETC___d361,
       ...
       wci_cState_9_EQ_2_0_AND_dlyCtrl_5_BITS_3_TO_0__ETC___d293,
  ...
  assign MUX_rdSyncWord$write_1__VAL_2 =
	     rdSerPos != 2'd3 && v__h23174[23:0] == 24'd0 ;
  assign MUX_wsiM_reqFifo_x_wire$wset_1__VAL_1 =
	     { 3'd1,
	       unrollCnt == 16'd1,
	       1'd1,
	       x_burstLength__h22893,
	       mesgRF$D_OUT,
	       x_byteEn__h22894,
	       readMeta[31:24] } ;
  ...
  assign mesgRF$D_IN = { 32'd0, v__h23174 } ;
  ...
  assign v__h23174 = metaRF$D_IN ;
  assign wci_cState_9_EQ_2_0_AND_dlyCtrl_5_BITS_3_TO_0__ETC___d293 =
	     wci_cState == 3'd2 && dlyCtrl[3:0] == 4'h7 &&
	     NOT_dlyWordsStored_value_27_SLE_0_81_82_AND_NO_ETC___d289 &&
  ...
  assign x_burstLength__h22893 =
	     (readMeta[23:0] == 24'd0) ? 12'd1 : readMeta[14:3] ;
  assign x_byteEn__h22894 = (readMeta[23:0] == 24'd0) ? 8'd0 : 8'd255 ;
  always@(wci_reqF$D_OUT or
	  ...
	  rdat__h22417 or
	  rdat__h22423 or
	  rdat__h22433 or rdat__h22443 or rdat__h22453 or rdat__h22463)
  begin
