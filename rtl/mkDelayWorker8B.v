...
//
// On Wed Jan 26 17:07:19 EST 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker8B(wciS0_Clk,
  ...
  wire [127 : 0] IF_wrtSerPos_99_EQ_2_09_THEN_0x0_ELSE_mesgWF_w_ETC___d567,
		 ...
		 x__h19203,
		 x__h19227;
  wire [63 : 0] x__h15317, x__h19070;
  wire [35 : 0] addr__h19627, addr__h19977;
  wire [31 : 0] delayStatus__h22257,
		rdat__h22662,
		rdat__h22668,
		rdat__h22674,
		rdat__h22680,
  ...
  wire [13 : 0] mesgLengthSoFar_82_PLUS_1___d993;
  wire [12 : 0] x__h15418;
  wire [11 : 0] x_burstLength__h22164;
  wire [7 : 0] x_byteEn__h22165;
  wire [1 : 0] wrtSerPos_99_PLUS_1___d992;
  wire IF_wrtSerPos_99_EQ_0_07_OR_wrtSerPos_99_EQ_1_0_ETC___d552,
       ...
       bytesWritten_95_ULT_dlyHoldoffBytes_75___d911,
       cyclesPassed_65_ULT_dlyHoldoffCycles_78___d907,
  ...
  assign MUX_wrtSerPos$write_1__VAL_1 =
	     (metaWF$D_OUT[23:0] == 24'd0) ?
	       2'd0 :
	       wrtSerPos_99_PLUS_1___d992 ;
  assign MUX_wrtSerPos$write_1__VAL_2 =
	     (wrtSerUnroll == 16'd1) ? 2'd0 : wrtSerPos_99_PLUS_1___d992 ;
  ...
  assign mesgLengthSoFar$D_IN =
	     wsiS_reqFifo$D_OUT[93] ?
	       14'd0 :
	       mesgLengthSoFar_82_PLUS_1___d993 ;
  ...
  assign wrtSerStage$D_IN =
	     MUX_wrtSerStage$write_1__SEL_1 ? x__h19070[31:0] : metaWF$D_OUT ;
  ...
  // submodule mesgRF
  assign mesgRF$D_IN = { 32'd0, v__h20292 } ;
  ...
  assign IF_wrtSerPos_99_EQ_2_09_THEN_0x0_ELSE_mesgWF_w_ETC___d567 =
	     { (wrtSerPos == 2'd2) ? 32'h0 : x__h19070[31:0],
	       (wrtSerPos == 2'd2) ? x__h19070[31:0] : wrtSerStage_2,
	       wrtSerStage_1,
	       wrtSerStage } ;
  ...
  assign btm__h17806 =
		 ...
		 { 7'd0, mesgLengthSoFar_82_PLUS_1___d993 },
	       3'd0 } ;
  assign bytesWritten_95_ULT_dlyHoldoffBytes_75___d911 =
	     bytesWritten < dlyHoldoffBytes ;
  assign cyclesPassed_65_ULT_dlyHoldoffCycles_78___d907 =
  ...
  assign mesgLengthSoFar_82_PLUS_1___d993 = mesgLengthSoFar + 14'd1 ;
  ...
  assign wci_wslv_cState_5_EQ_2_6_AND_dlyCtrl_57_BITS_3_ETC___d602 =
	     ...
	     !bytesWritten_95_ULT_dlyHoldoffBytes_75___d911 &&
	     !cyclesPassed_65_ULT_dlyHoldoffCycles_78___d907 ;
  assign wrtSerPos_99_PLUS_1___d992 = wrtSerPos + 2'd1 ;
  ...
  assign x__h19070 = mesgWF_wDataOut$wget ;
  assign x__h19203 = { 96'd0, x__h19070[31:0] } ;
  assign x__h19227 = { 64'd0, x__h19070[31:0], wrtSerStage } ;
  ...
  assign x_byteEn__h22165 = (readMeta[23:0] == 24'd0) ? 8'd0 : 8'd255 ;
  always@(rdSerPos or
