...
//
// On Tue Jul 20 14:07:30 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker8B(wciS0_Clk,
  ...
  reg [31 : 0] x_data__h21791;
  reg CASE_wrtSerPos_0b1_0_1_1_1_2_1_3_0b1__q1,
      CASE_wrtSerPos_NOT_wrtSerPos_EQ_3_OR_wide16Fa_ETC__q2;
  wire [127 : 0] IF_wrtSerPos_81_EQ_2_84_THEN_0x0_ELSE_mesgWF_w_ETC___d425,
		 IF_wrtSerPos_81_EQ_2_84_THEN_0x0_ELSE_metaWF_f_ETC___d450,
		 x1__h17684,
		 x1__h17715,
		 x1__h18350,
		 x1__h18377;
  wire [63 : 0] x__h14850, x__h17545;
  wire [35 : 0] addr__h19034, addr__h19202;
  wire [31 : 0] delayStatus__h21360,
		rdat__h21818,
		rdat__h21824,
		rdat__h21830,
		rdat__h21836,
  ...
  wire [7 : 0] x_byteEn__h19534;
  wire [1 : 0] wrtSerPos_81_PLUS_1___d987;
  wire IF_wrtSerPos_81_EQ_0_82_OR_wrtSerPos_81_EQ_1_8_ETC___d401,
       NOT_mesgWF_rRdPtr_65_EQ_mesgWF_rWrPtr_67_70___d171,
       NOT_mesgWF_rRdPtr_65_PLUS_2048_66_EQ_mesgWF_rW_ETC___d169,
       NOT_wrtSerPos_81_EQ_3_88_89_AND_NOT_metaWF_fir_ETC___d437,
       ...
       wordsEnqued_54_EQ_wordsExact_55_MINUS_1_56___d916,
       wsiS_reqFifo_notFull__08_AND_wsiS_burstKind_88_ETC___d724;
  ...
  assign CAN_FIRE_RL_wrtSer_body =
	     NOT_mesgWF_rRdPtr_65_EQ_mesgWF_rWrPtr_67_70___d171 &&
	     IF_wrtSerPos_81_EQ_0_82_OR_wrtSerPos_81_EQ_1_8_ETC___d401 &&
	     wci_cState == 3'd2 &&
	     dlyCtrl[3:0] == 4'h7 &&
	     wrtSerUnroll != 16'd0 ;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_1 = { 2'd1, x_data__h21791 } ;
  ...
  assign MUX_rdSyncWord$write_1__VAL_2 =
	     rdSerPos != 2'd3 && v__h19815[23:0] == 24'd0 ;
  ...
  always@(wrtSerPos or
	  IF_wrtSerPos_81_EQ_2_84_THEN_0x0_ELSE_mesgWF_w_ETC___d425 or
  ...
  begin
    case (wrtSerPos)
      ...
      default: MUX_wide16Fa$enq_1__VAL_2 =
		   IF_wrtSerPos_81_EQ_2_84_THEN_0x0_ELSE_mesgWF_w_ETC___d425;
    endcase
  end
  always@(wrtSerPos or
	  IF_wrtSerPos_81_EQ_2_84_THEN_0x0_ELSE_metaWF_f_ETC___d450 or
  ...
  assign MUX_wrtSerPos$write_1__VAL_1 =
	     (wrtSerUnroll == 16'd1) ? 2'd0 : wrtSerPos_81_PLUS_1___d987 ;
  assign MUX_wrtSerPos$write_1__VAL_2 =
	     (metaWF$D_OUT[23:0] == 24'd0) ?
	       2'd0 :
	       wrtSerPos_81_PLUS_1___d987 ;
  ...
  assign dlyRdOpOther$EN =
	     WILL_FIRE_RL_rdSer_begin && v__h19815[31:24] != 8'd0 ;
  ...
  assign wrtSerStage$D_IN =
	     MUX_wrtSerStage$write_1__SEL_1 ? x__h17545[31:0] : metaWF$D_OUT ;
  ...
  assign mesgRF$D_IN = { 32'd0, v__h19815 } ;
  ...
  // remaining internal signals
  assign IF_wrtSerPos_81_EQ_0_82_OR_wrtSerPos_81_EQ_1_8_ETC___d401 =
	     CASE_wrtSerPos_0b1_0_1_1_1_2_1_3_0b1__q1 &&
	     (wrtSerPos != 2'd3 && wrtSerUnroll != 16'd1 ||
	      CASE_wrtSerPos_NOT_wrtSerPos_EQ_3_OR_wide16Fa_ETC__q2) ;
  assign IF_wrtSerPos_81_EQ_2_84_THEN_0x0_ELSE_mesgWF_w_ETC___d425 =
	     { (wrtSerPos == 2'd2) ? 32'h0 : x__h17545[31:0],
	       (wrtSerPos == 2'd2) ? x__h17545[31:0] : wrtSerStage_2,
	       wrtSerStage_1,
	       wrtSerStage } ;
  assign IF_wrtSerPos_81_EQ_2_84_THEN_0x0_ELSE_metaWF_f_ETC___d450 =
  ...
  assign NOT_wrtSerPos_81_EQ_3_88_89_AND_NOT_metaWF_fir_ETC___d437 =
	     wrtSerPos != 2'd3 && metaWF$D_OUT[23:0] != 24'd0 ||
	     CASE_wrtSerPos_NOT_wrtSerPos_EQ_3_OR_wide16Fa_ETC__q2 ;
  ...
  assign v__h19815 = metaRF$D_IN ;
  assign wci_cState_9_EQ_2_0_AND_dlyCtrl_5_BITS_3_TO_0__ETC___d351 =
	     wci_cState == 3'd2 && dlyCtrl[3:0] == 4'h7 &&
	     !dlyWordsStored_value_27_SLE_0___d152 &&
	     !bytesWritten_7_ULT_dlyHoldoffBytes_7___d153 &&
	     !cyclesPassed_55_ULT_dlyHoldoffCycles_9___d156 ;
  assign wordsEnqued_54_EQ_wordsExact_55_MINUS_1_56___d916 =
	     wordsEnqued == wordsExact - 16'd1 ;
  assign wrtSerPos_81_PLUS_1___d987 = wrtSerPos + 2'd1 ;
  assign wsiS_reqFifo_notFull__08_AND_wsiS_burstKind_88_ETC___d724 =
	     wsiS_reqFifo$FULL_N &&
	     (wsiS_burstKind == 2'd0 ||
	      (wsiS_burstKind == 2'd1 || wsiS_burstKind == 2'd2) &&
	      wsiS_wsiReq$wget[93]) ;
  assign x1__h17684 = { 96'd0, x__h17545[31:0] } ;
  assign x1__h17715 = { 64'd0, x__h17545[31:0], wrtSerStage } ;
  ...
  assign x__h14850 =
	     CAN_FIRE_RL_wmwt_mesg_ingress ?
	       ...
	       64'd0 ;
  assign x__h16649 = { wordsExact[12:0], 3'd0 } ;
  assign x__h16751 = wordsEnqued + 16'd1 ;
  assign x__h17545 = mesgWF_wDataOut$wget ;
  ...
  assign x_byteEn__h19534 = (readMeta[23:0] == 24'd0) ? 8'd0 : 8'd255 ;
