...
//
// On Wed Jul  7 10:05:57 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker8B(wciS0_Clk,
  ...
  wire [1 : 0] wrtSerPos_40_PLUS_1___d1024;
  ...
  assign MUX_wrtSerPos$write_1__VAL_1 =
	     (wrtSerUnroll == 16'd1) ? 2'd0 : wrtSerPos_40_PLUS_1___d1024 ;
  assign MUX_wrtSerPos$write_1__VAL_2 =
	     (metaWF$D_OUT[23:0] == 24'd0) ?
	       2'd0 :
	       wrtSerPos_40_PLUS_1___d1024 ;
  ...
  assign wrtSerPos_40_PLUS_1___d1024 = wrtSerPos + 2'd1 ;
