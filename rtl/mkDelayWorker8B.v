...
//
// On Thu Jun 17 14:44:29 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker8B(wciS0_Clk,
  ...
  reg [76 : 0] mesgWF_rCache;
  wire [76 : 0] mesgWF_rCache$D_IN;
  ...
  wire [127 : 0] IF_wrtSerPos_11_EQ_2_14_THEN_0x0_ELSE_mesgWF_w_ETC___d354,
		 ...
		 x1__h20496,
		 x1__h20505;
  wire [63 : 0] mesg__h22350, x__h15237, x__h16164, x__h19909;
  ...
  wire [10 : 0] x__h16056;
  wire [7 : 0] x1_opcode__h17257, x_byteEn__h22442;
  ...
  assign MUX_mesgLength$write_1__VAL_3 = { 1'd1, mlp1__h17957[10:0], 3'd0 } ;
  ...
  assign mesgWF_wDataOut$wget =
	     (mesgWF_rCache[76] && mesgWF_rCache[75:64] == mesgWF_rRdPtr) ?
	       mesgWF_rCache[63:0] :
	       mesgWF_memory$DOB ;
  ...
  assign mesgRF_wDataIn$wget = { 32'd0, v__h22724 } ;
  ...
  assign x__h16164 = CAN_FIRE_RL_rdSer_body ? mesgRF_wDataIn$wget : 64'd0 ;
  ...
  assign x_byteEn__h22442 = (readMeta[23:0] == 24'd0) ? 8'd0 : 8'd255 ;
  ...
  begin
	...
	mesgWF_rCache <= `BSV_ASSIGNMENT_DELAY 77'h0AAAAAAAAAAAAAAAAAAA;
  ...
  begin
    ...
    mesgReqValid = 1'h0;
    mesgWF_rCache = 77'h0AAAAAAAAAAAAAAAAAAA;
