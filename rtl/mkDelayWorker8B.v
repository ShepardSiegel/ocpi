...
//
// On Wed Jul 14 09:20:04 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker8B(wciS0_Clk,
  ...
  reg [63 : 0] v__h17681,
	       ...
	       v__h2822,
	       v__h3721;
  reg [31 : 0] x_data__h22453;
  reg CASE_wrtSerPos_0b1_0_1_1_1_2_1_3_0b1__q1,
      CASE_wrtSerPos_NOT_wrtSerPos_EQ_3_OR_wide16Fa_ETC__q2;
  wire [127 : 0] IF_wrtSerPos_69_EQ_2_72_THEN_0x0_ELSE_mesgWF_w_ETC___d413,
		 IF_wrtSerPos_69_EQ_2_72_THEN_0x0_ELSE_metaWF_f_ETC___d438,
		 x1__h20076,
		 x1__h20107,
		 x1__h20772,
		 x1__h20799;
  wire [63 : 0] x__h15359, x__h19937;
  wire [35 : 0] addr__h21451, addr__h21751;
  wire [31 : 0] rdat__h22480,
		rdat__h22486,
		rdat__h22493,
		rdat__h22499,
		rdat__h22623,
		...
		rdat__h22737,
		v__h23462;
  wire [26 : 0] x__h21509, x__h21796;
  wire [23 : 0] x1_length__h17374, x__h22503;
  wire [13 : 0] mlp1__h18075, x__h17418;
  wire [12 : 0] x__h15251;
  wire [11 : 0] x_burstLength__h23181;
  wire [7 : 0] x1_opcode__h17373, x_byteEn__h23182;
  wire [1 : 0] wrtSerPos_69_PLUS_1___d1070;
  wire IF_wrtSerPos_69_EQ_0_70_OR_wrtSerPos_69_EQ_1_7_ETC___d389,
       NOT_wrtSerPos_69_EQ_3_76_77_AND_NOT_metaWF_fir_ETC___d425,
       _dor1bytesWritten$EN_write,
       bytesWritten_7_ULT_dlyHoldoffBytes_7___d301,
       cyclesPassed_04_ULT_dlyHoldoffCycles_9___d305,
       dlyWordsStored_value_27_SLE_0___d299,
       mesgRF_RDY_enq__18_AND_NOT_rdSerEmpty_19_20_AN_ETC___d231,
       metaRF_RDY_enq__64_AND_NOT_rdSerEmpty_19_20_AN_ETC___d265,
       wci_cState_9_EQ_2_0_AND_dlyCtrl_5_BITS_3_TO_0__ETC___d308,
       wci_cState_9_EQ_2_0_AND_dlyCtrl_5_BITS_3_TO_0__ETC___d345,
       wci_cState_9_EQ_2_0_AND_dlyCtrl_5_BITS_3_TO_0__ETC___d354,
       wci_cState_9_EQ_2_0_AND_dlyCtrl_5_BITS_3_TO_0__ETC___d458,
       wsiS_reqFifo_notFull__57_AND_wsiS_burstKind_37_ETC___d773;
  ...
  assign CAN_FIRE_RL_wrtSer_body =
	     ...
	     IF_wrtSerPos_69_EQ_0_70_OR_wrtSerPos_69_EQ_1_7_ETC___d389 &&
	     wci_cState == 3'd2 &&
	     dlyCtrl[3:0] == 4'h7 &&
	     wrtSerUnroll != 16'd0 ;
  ...
  assign MUX_mesgLength$write_1__VAL_3 = { 1'd1, mlp1__h18075[10:0], 3'd0 } ;
  assign MUX_mesgRdCount$write_1__VAL_1 = mesgRdCount + 32'd1 ;
  assign MUX_mesgWtCount$write_1__VAL_1 = mesgWtCount + 32'd1 ;
  assign MUX_metaWF$enq_1__VAL_1 = { x1_opcode__h17373, x1_length__h17374 } ;
  ...
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_1 = { 4'd5, addr__h21451, 12'd1 } ;
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_2 = { 4'd3, addr__h21751, 12'd1 } ;
  assign MUX_rdSyncWord$write_1__VAL_2 =
	     rdSerPos != 2'd3 && v__h23462[23:0] == 24'd0 ;
  assign MUX_wsiM_reqFifo_x_wire$wset_1__VAL_1 =
	     { 3'd1,
	       unrollCnt == 16'd1,
	       1'd1,
	       x_burstLength__h23181,
	       mesgRF$D_OUT,
	       x_byteEn__h23182,
	       readMeta[31:24] } ;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_1 = { 2'd1, x_data__h22453 } ;
  ...
  always@(wrtSerPos or
	  IF_wrtSerPos_69_EQ_2_72_THEN_0x0_ELSE_mesgWF_w_ETC___d413 or
	  x1__h20076 or x1__h20107)
  begin
    case (wrtSerPos)
      2'd0: MUX_wide16Fa$enq_1__VAL_2 = x1__h20076;
      2'd1: MUX_wide16Fa$enq_1__VAL_2 = x1__h20107;
      default: MUX_wide16Fa$enq_1__VAL_2 =
		   IF_wrtSerPos_69_EQ_2_72_THEN_0x0_ELSE_mesgWF_w_ETC___d413;
    endcase
  end
  always@(wrtSerPos or
	  IF_wrtSerPos_69_EQ_2_72_THEN_0x0_ELSE_metaWF_f_ETC___d438 or
	  x1__h20772 or x1__h20799)
  begin
    case (wrtSerPos)
      2'd0: MUX_wide16Fa$enq_1__VAL_1 = x1__h20772;
      2'd1: MUX_wide16Fa$enq_1__VAL_1 = x1__h20799;
  ...
  assign MUX_wrtSerPos$write_1__VAL_1 =
	     (wrtSerUnroll == 16'd1) ? 2'd0 : wrtSerPos_69_PLUS_1___d1070 ;
  assign MUX_wrtSerPos$write_1__VAL_2 =
	     (metaWF$D_OUT[23:0] == 24'd0) ?
	       2'd0 :
	       wrtSerPos_69_PLUS_1___d1070 ;
  ...
  assign dlyRdOpOther$EN =
	     WILL_FIRE_RL_rdSer_begin && v__h23462[31:24] != 8'd0 ;
  ...
  assign wrtSerStage$D_IN =
	     MUX_wrtSerStage$write_1__SEL_1 ? x__h19937[31:0] : metaWF$D_OUT ;
  ...
  assign mesgRF$D_IN = { 32'd0, v__h23462 } ;
  ...
  // remaining internal signals
  assign IF_wrtSerPos_69_EQ_0_70_OR_wrtSerPos_69_EQ_1_7_ETC___d389 =
	     CASE_wrtSerPos_0b1_0_1_1_1_2_1_3_0b1__q1 &&
	     (wrtSerPos != 2'd3 && wrtSerUnroll != 16'd1 ||
	      CASE_wrtSerPos_NOT_wrtSerPos_EQ_3_OR_wide16Fa_ETC__q2) ;
  assign IF_wrtSerPos_69_EQ_2_72_THEN_0x0_ELSE_mesgWF_w_ETC___d413 =
	     { (wrtSerPos == 2'd2) ? 32'h0 : x__h19937[31:0],
	       (wrtSerPos == 2'd2) ? x__h19937[31:0] : wrtSerStage_2,
	       wrtSerStage_1,
	       wrtSerStage } ;
  assign IF_wrtSerPos_69_EQ_2_72_THEN_0x0_ELSE_metaWF_f_ETC___d438 =
	     { (wrtSerPos == 2'd2) ? 32'h0 : metaWF$D_OUT,
	       (wrtSerPos == 2'd2) ? metaWF$D_OUT : wrtSerStage_2,
	       wrtSerStage_1,
	       wrtSerStage } ;
  assign NOT_wrtSerPos_69_EQ_3_76_77_AND_NOT_metaWF_fir_ETC___d425 =
	     wrtSerPos != 2'd3 && metaWF$D_OUT[23:0] != 24'd0 ||
	     CASE_wrtSerPos_NOT_wrtSerPos_EQ_3_OR_wide16Fa_ETC__q2 ;
  assign _dor1bytesWritten$EN_write =
	     WILL_FIRE_RL_wmwt_messagePushPrecise ||
	     WILL_FIRE_RL_wmwt_messagePushImprecise ;
  assign addr__h21451 = { 9'd0, x__h21509 } ;
  assign addr__h21751 = { 9'd0, x__h21796 } ;
  assign bytesWritten_7_ULT_dlyHoldoffBytes_7___d301 =
	     bytesWritten < dlyHoldoffBytes ;
  assign cyclesPassed_04_ULT_dlyHoldoffCycles_9___d305 =
	     cyclesPassed < dlyHoldoffCycles ;
  assign dlyWordsStored_value_27_SLE_0___d299 =
  ...
  assign metaRF_RDY_enq__64_AND_NOT_rdSerEmpty_19_20_AN_ETC___d265 =
	     metaRF$FULL_N &&
	     (!rdSerEmpty && rdSerPos != 2'd0 || wide16Fc$EMPTY_N) ;
  assign mlp1__h18075 = mesgLengthSoFar + 14'd1 ;
  assign rdat__h22480 = hasDebugLogic ? mesgWtCount : 32'd0 ;
  assign rdat__h22486 = hasDebugLogic ? mesgRdCount : 32'd0 ;
  assign rdat__h22493 = hasDebugLogic ? bytesWritten : 32'd0 ;
  assign rdat__h22499 = hasDebugLogic ? { 8'd0, x__h22503 } : 32'd0 ;
  assign rdat__h22623 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h22637 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h22645 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h22651 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h22665 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h22673 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h22679 = hasDebugLogic ? wmemiWrReq : 32'd0 ;
  assign rdat__h22685 = hasDebugLogic ? wmemiRdReq : 32'd0 ;
  assign rdat__h22691 = hasDebugLogic ? wmemiRdResp : 32'd0 ;
  assign rdat__h22697 =
	     hasDebugLogic ? { 7'd0, dlyWordsStored_value } : 32'd0 ;
  assign rdat__h22707 =
	     hasDebugLogic ? { 24'd0, dlyReadCredit_value } : 32'd0 ;
  assign rdat__h22717 = hasDebugLogic ? { 9'd0, dlyWAG } : 32'd0 ;
  assign rdat__h22727 = hasDebugLogic ? { 9'd0, dlyRAG } : 32'd0 ;
  assign rdat__h22737 = { {24{dlyMaxReadCredit[7]}}, dlyMaxReadCredit } ;
  assign v__h23462 = metaRF$D_IN ;
  assign wci_cState_9_EQ_2_0_AND_dlyCtrl_5_BITS_3_TO_0__ETC___d308 =
	     wci_cState == 3'd2 && dlyCtrl[3:0] == 4'h7 &&
	     !dlyWordsStored_value_27_SLE_0___d299 &&
	     !bytesWritten_7_ULT_dlyHoldoffBytes_7___d301 &&
	     !cyclesPassed_04_ULT_dlyHoldoffCycles_9___d305 ;
  assign wci_cState_9_EQ_2_0_AND_dlyCtrl_5_BITS_3_TO_0__ETC___d345 =
	     wci_cState == 3'd2 && dlyCtrl[3:0] == 4'h7 &&
	     ((dlyWriteJustFired || dlyWriteFlush == 8'd255) ?
		(dlyReadyToWrite_value ^ 5'h10) > 5'd16 :
		(dlyReadyToWrite_value ^ 5'h10) > 5'd23) ;
  assign wci_cState_9_EQ_2_0_AND_dlyCtrl_5_BITS_3_TO_0__ETC___d354 =
	     wci_cState_9_EQ_2_0_AND_dlyCtrl_5_BITS_3_TO_0__ETC___d345 &&
	     ...
	     (dlyWordsStored_value_27_SLE_0___d299 ||
	      ...
	      cyclesPassed_04_ULT_dlyHoldoffCycles_9___d305 ||
	      wsiM_reqFifo_c_r == 2'd2) ;
  assign wci_cState_9_EQ_2_0_AND_dlyCtrl_5_BITS_3_TO_0__ETC___d458 =
	     wci_cState == 3'd2 && dlyCtrl[3:0] == 4'h7 && mesgLength[14] &&
	     !doAbort &&
	     (preciseBurst && wsiWordsRemain == 12'd0 ||
	      impreciseBurst && endOfMessage) ;
  assign wrtSerPos_69_PLUS_1___d1070 = wrtSerPos + 2'd1 ;
  assign wsiS_reqFifo_notFull__57_AND_wsiS_burstKind_37_ETC___d773 =
	     wsiS_reqFifo$FULL_N &&
	     (wsiS_burstKind == 2'd0 ||
	      (wsiS_burstKind == 2'd1 || wsiS_burstKind == 2'd2) &&
	      wsiS_wsiReq$wget[93]) ;
  assign x1__h20076 = { 96'd0, x__h19937[31:0] } ;
  assign x1__h20107 = { 64'd0, x__h19937[31:0], wrtSerStage } ;
  assign x1__h20772 = { 96'd0, metaWF$D_OUT } ;
  assign x1__h20799 = { 64'd0, metaWF$D_OUT, wrtSerStage } ;
  ...
  assign x__h19937 = mesgWF_wDataOut$wget ;
  assign x__h21509 = { dlyRAG, 4'h0 } ;
  assign x__h21796 = { dlyWAG, 4'h0 } ;
  assign x__h22503 = { wmemi_statusR, wsiS_statusR, wsiM_statusR } ;
  assign x_burstLength__h23181 =
	     (readMeta[23:0] == 24'd0) ? 12'd1 : readMeta[14:3] ;
  assign x_byteEn__h23182 = (readMeta[23:0] == 24'd0) ? 8'd0 : 8'd255 ;
  always@(wci_reqF$D_OUT or
	  ...
	  rdat__h22707 or
	  rdat__h22717 or
	  rdat__h22727 or rdat__h22737 or dlyRdOpZero or dlyRdOpOther)
  begin
    case (wci_reqF$D_OUT[51:32])
      20'h0: x_data__h22453 = dlyCtrl;
      20'h00004: x_data__h22453 = dlyHoldoffBytes;
      20'h00008: x_data__h22453 = dlyHoldoffCycles;
      20'h0000C: x_data__h22453 = rdat__h22480;
      20'h00010: x_data__h22453 = rdat__h22486;
      20'h00014: x_data__h22453 = rdat__h22493;
      20'h00018: x_data__h22453 = rdat__h22499;
      20'h0001C: x_data__h22453 = 32'd0;
      20'h00020: x_data__h22453 = rdat__h22623;
      20'h00024: x_data__h22453 = rdat__h22637;
      20'h00028: x_data__h22453 = rdat__h22645;
      20'h0002C: x_data__h22453 = rdat__h22651;
      20'h00030: x_data__h22453 = rdat__h22665;
      20'h00034: x_data__h22453 = rdat__h22673;
      20'h00038: x_data__h22453 = rdat__h22679;
      20'h0003C: x_data__h22453 = rdat__h22685;
      20'h00040: x_data__h22453 = rdat__h22691;
      20'h00044: x_data__h22453 = rdat__h22697;
      20'h00048: x_data__h22453 = rdat__h22707;
      20'h0004C: x_data__h22453 = rdat__h22717;
      20'h00050: x_data__h22453 = rdat__h22727;
      20'h00054: x_data__h22453 = rdat__h22737;
      20'h00058: x_data__h22453 = dlyRdOpZero;
      20'h0005C: x_data__h22453 = dlyRdOpOther;
      default: x_data__h22453 = 32'd0;
    endcase
  end
  always@(wrtSerPos)
  begin
