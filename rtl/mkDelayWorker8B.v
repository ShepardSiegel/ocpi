...
//
// On Mon Mar 21 18:13:42 EDT 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker8B(wciS0_Clk,
  ...
  wire [127 : 0] IF_wrtSerPos_00_EQ_2_10_THEN_0x0_ELSE_mesgWF_w_ETC___d568,
		 IF_wrtSerPos_00_EQ_2_10_THEN_0x0_ELSE_metaWF_f_ETC___d538,
		 x__h18803,
		 x__h18830,
		 x__h19453,
		 x__h19477;
  wire [63 : 0] x__h15563, x__h19320;
  wire [35 : 0] addr__h19877, addr__h20227;
  wire [31 : 0] delayStatus__h22507,
		rdat__h22912,
		rdat__h22918,
		rdat__h22924,
		rdat__h22930,
  ...
  wire [13 : 0] mesgLengthSoFar_83_PLUS_1___d985;
  wire [12 : 0] x__h15664;
  wire [11 : 0] x_burstLength__h22414;
  wire [7 : 0] x_byteEn__h22415;
  wire [1 : 0] wrtSerPos_00_PLUS_1___d984;
  wire IF_wrtSerPos_00_EQ_0_08_OR_wrtSerPos_00_EQ_1_0_ETC___d553,
       ...
       NOT_wmemi_dhF_c_r_41_EQ_2_60_61_AND_wmemi_oper_ETC___d573,
       NOT_wrtSerPos_00_EQ_3_01_02_AND_NOT_metaWF_fir_ETC___d516,
       bytesWritten_96_ULT_dlyHoldoffBytes_76___d912,
       cyclesPassed_66_ULT_dlyHoldoffCycles_79___d910,
       dlyWordsStored_value_27_SLE_0_75_OR_bytesWritt_ETC___d583,
       dlyWordsStored_value_27_SLE_0___d911,
       dlyWordsStored_value_27_SLT_8388608___d585,
       mesgRF_i_notFull__82_AND_NOT_rdSerEmpty_32_33__ETC___d683,
       metaRF_i_notFull__31_AND_NOT_rdSerEmpty_32_33__ETC___d642,
       wci_wslv_cState_6_EQ_2_7_AND_dlyCtrl_58_BITS_3_ETC___d586,
       wci_wslv_cState_6_EQ_2_7_AND_dlyCtrl_58_BITS_3_ETC___d603,
  ...
  always@(wrtSerPos or
	  IF_wrtSerPos_00_EQ_2_10_THEN_0x0_ELSE_mesgWF_w_ETC___d568 or
  ...
  begin
    case (wrtSerPos)
      ...
      default: MUX_wide16Fa$enq_1__VAL_2 =
		   IF_wrtSerPos_00_EQ_2_10_THEN_0x0_ELSE_mesgWF_w_ETC___d568;
    endcase
  end
  ...
  assign MUX_wrtSerPos$write_1__VAL_1 =
	     (metaWF$D_OUT[23:0] == 24'd0) ?
	       2'd0 :
	       wrtSerPos_00_PLUS_1___d984 ;
  assign MUX_wrtSerPos$write_1__VAL_2 =
	     (wrtSerUnroll == 16'd1) ? 2'd0 : wrtSerPos_00_PLUS_1___d984 ;
  ...
  assign mesgWF_wDataOut$wget = x__h19320 ;
  ...
  assign mesgLengthSoFar$D_IN =
	     wsiS_reqFifo$D_OUT[93] ?
	       14'd0 :
	       mesgLengthSoFar_83_PLUS_1___d985 ;
  ...
  assign wrtSerStage$D_IN =
	     MUX_wrtSerStage$write_1__SEL_1 ? x__h19320[31:0] : metaWF$D_OUT ;
  ...
  // submodule mesgRF
  assign mesgRF$D_IN = { 32'd0, v__h20542 } ;
  ...
  assign IF_wrtSerPos_00_EQ_0_08_OR_wrtSerPos_00_EQ_1_0_ETC___d553 =
	     ...
	     (wrtSerPos != 2'd3 && wrtSerUnroll != 16'd1 ||
	      CASE_wrtSerPos_NOT_wrtSerPos_EQ_3_OR_wide16Fa_ETC__q1) ;
  assign IF_wrtSerPos_00_EQ_2_10_THEN_0x0_ELSE_mesgWF_w_ETC___d568 =
	     { (wrtSerPos == 2'd2) ? 32'h0 : x__h19320[31:0],
	       (wrtSerPos == 2'd2) ? x__h19320[31:0] : wrtSerStage_2,
	       wrtSerStage_1,
	       wrtSerStage } ;
  ...
  assign NOT_wmemi_dhF_c_r_41_EQ_2_60_61_AND_wmemi_oper_ETC___d573 =
  ...
  assign btm__h18052 =
		 ...
		 { 7'd0, mesgLengthSoFar_83_PLUS_1___d985 },
	       3'd0 } ;
  assign bytesWritten_96_ULT_dlyHoldoffBytes_76___d912 =
	     bytesWritten < dlyHoldoffBytes ;
  assign cyclesPassed_66_ULT_dlyHoldoffCycles_79___d910 =
  ...
  assign delayStatus__h22507 =
	     { 14'h0,
	       ...
	       wide16Fc$FULL_N,
	       wide16Fc$EMPTY_N } ;
  assign dlyWordsStored_value_27_SLE_0_75_OR_bytesWritt_ETC___d583 =
	     dlyWordsStored_value_27_SLE_0___d911 ||
	     bytesWritten_96_ULT_dlyHoldoffBytes_76___d912 ||
	     cyclesPassed_66_ULT_dlyHoldoffCycles_79___d910 ||
	     wsiM_reqFifo_c_r == 2'd2 ||
	     tog50 ;
  assign dlyWordsStored_value_27_SLE_0___d911 =
	     (dlyWordsStored_value ^ 25'h1000000) <= 25'd16777216 ;
  assign dlyWordsStored_value_27_SLT_8388608___d585 =
	     (dlyWordsStored_value ^ 25'h1000000) < 25'd25165824 ;
  assign mesgLengthSoFar_83_PLUS_1___d985 = mesgLengthSoFar + 14'd1 ;
  assign mesgRF_i_notFull__82_AND_NOT_rdSerEmpty_32_33__ETC___d683 =
	     mesgRF$FULL_N &&
	     (!rdSerEmpty && rdSerPos != 2'd0 || wide16Fc$EMPTY_N) ;
  assign metaRF_i_notFull__31_AND_NOT_rdSerEmpty_32_33__ETC___d642 =
	     metaRF$FULL_N &&
	     (!rdSerEmpty && rdSerPos != 2'd0 || wide16Fc$EMPTY_N) ;
  ...
  assign wci_wslv_cState_6_EQ_2_7_AND_dlyCtrl_58_BITS_3_ETC___d586 =
	     wci_wslv_cState == 3'd2 && dlyCtrl[3:0] == 4'h7 &&
	     dlyWordsStored_value_27_SLE_0_75_OR_bytesWritt_ETC___d583 &&
	     dlyWordsStored_value_27_SLT_8388608___d585 ;
  assign wci_wslv_cState_6_EQ_2_7_AND_dlyCtrl_58_BITS_3_ETC___d603 =
	     wci_wslv_cState == 3'd2 && dlyCtrl[3:0] == 4'h7 &&
	     !dlyWordsStored_value_27_SLE_0___d911 &&
	     !bytesWritten_96_ULT_dlyHoldoffBytes_76___d912 &&
	     !cyclesPassed_66_ULT_dlyHoldoffCycles_79___d910 ;
  assign wrtSerPos_00_PLUS_1___d984 = wrtSerPos + 2'd1 ;
  ...
  assign x__h19320 =
	     (mesgWF_rCache[77] && mesgWF_rCache[76:64] == mesgWF_rRdPtr) ?
	       mesgWF_rCache[63:0] :
	       mesgWF_memory$DOB ;
  assign x__h19453 = { 96'd0, x__h19320[31:0] } ;
  assign x__h19477 = { 64'd0, x__h19320[31:0], wrtSerStage } ;
  ...
  assign x_byteEn__h22415 = (readMeta[23:0] == 24'd0) ? 8'd0 : 8'd255 ;
  always@(rdSerPos or
