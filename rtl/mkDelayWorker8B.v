...
//
// On Thu Aug 12 10:34:05 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker8B(wciS0_Clk,
  ...
  assign mesgRF$D_IN = { 32'd0, v__h20254 } ;
  ...
  assign x__h15073 =
	     CAN_FIRE_RL_wmwt_mesg_ingress ?
	       ...
	       64'd0 ;
  assign x__h17993 = mesgWF_wDataOut$wget ;
  ...
  assign x_byteEn__h19977 = (readMeta[23:0] == 24'd0) ? 8'd0 : 8'd255 ;
  always@(wrtSerPos)
  begin
    case (wrtSerPos)
