...
//
// On Sun Jan 26 15:29:09 EST 2014
//
//
// Ports:
// Name                         I/O  size props
...
module mkCTop16B(pciDevice,
  ...
  // value method upads_rts
  assign upads_rts = inf_upads_rts ;

  // value method upads_tx
  assign upads_tx = inf_upads_tx ;
  ...
  mkOCInf16B inf(.pciDevice(pciDevice),
		 ...
		 .upads_cts_arg(inf_upads_cts_arg),
		 .upads_rx_arg(inf_upads_rx_arg),
		 ...
		 .RDY_uuid(),
		 .upads_rts(inf_upads_rts),
		 .upads_tx(inf_upads_tx),
  ...
  assign inf_upads_cts_arg = upads_cts_arg ;
  assign inf_upads_rx_arg = upads_rx_arg ;
