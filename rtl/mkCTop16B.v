...
//
// On Fri Aug 19 11:40:22 EDT 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkCTop16B(pciDevice,
  ...
  wire [1 : 0] app$wci_s_0_MFlag,
	       ...
	       app$wmiM0_SResp,
	       app$wmiM1_SResp;
  wire app$RDY_deviceDNA,
       app$wci_s_0_MAddrSpace,
  ...
  wire [127 : 0] inf$wmiDP0_MData,
		 inf$wmiDP0_SData,
		 inf$wmiDP1_MData,
		 inf$wmiDP1_SData;
  wire [63 : 0] inf$cpNow, inf$deviceDNA_arg;
  ...
  wire [15 : 0] inf$wmiDP0_MDataByteEn, inf$wmiDP1_MDataByteEn;
  ...
  // submodule app
  mkOCApp16B #(.hasDebugLogic(1'd1)) app(.RST_N_rst_0(inf$RST_N_wci_m_0),
					 ...
					 .wsi_m_dac_MReqInfo(),
					 .wsi_m_dac_MReset_n(),
					 .deviceDNA(app$deviceDNA),
					 .RDY_deviceDNA(app$RDY_deviceDNA));
  ...
  mkOCInf16B inf(.pciDevice(pciDevice),
		 ...
		 .CLK(CLK),
		 .RST_N(RST_N),
		 .deviceDNA_arg(inf$deviceDNA_arg),
  ...
  assign app$wsi_s_adc_MByteEn = 16'h0 ;
  assign app$wsi_s_adc_MCmd = 3'h0 ;
  assign app$wsi_s_adc_MData = 128'h0 ;
  ...
  // submodule inf
  assign inf$deviceDNA_arg = app$deviceDNA ;
  ...
  assign inf$EN_deviceDNA = app$RDY_deviceDNA ;
endmodule  // mkCTop16B
