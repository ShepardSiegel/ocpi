...
//
// On Wed Jul 20 14:27:40 EDT 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkDramServer_k7(CLK_sys0_clk,
		       RST_N_sys0_rst,
		       wciS0_Clk,
		       wciS0_MReset_n,
  ...
  wire [39 : 0] memc_memc$dbg_cpt_tap_cnt,
  ...
  reg [63 : 0] v__h18735, v__h3636, v__h3810, v__h3954;
  reg [31 : 0] CASE_wci_wslv_reqFD_OUT_BITS_39_TO_32_0_0x0_d_ETC__q1,
	       g_data__h14523,
	       x__h5908,
	       x__h6129;
  reg CASE_x378_NOT_x378_EQ_0b11_OR_memc_respFFULL__ETC__q2;
  wire [175 : 0] IF_wci_wslv_reqF_first__5_BIT_51_29_THEN_pReg__ETC___d480;
  wire [127 : 0] x1_data__h15762, x1_data__h16763;
  wire [31 : 0] dramStatus__h13165,
		g_data__h18279,
		myBE__h5945,
		myBE__h5978,
		rdat___1__h18342,
		...
		rdat___1__h18500,
		x1_addr__h16761;
  wire [15 : 0] x1_be__h16762, x__h18319;
  wire [2 : 0] x__h6378;
  wire IF_memc_memc_app_rd_data_end__11_CONCAT_memc_r_ETC___d227,
       IF_wci_wslv_reqF_first__5_BIT_51_29_THEN_lreqF_ETC___d505,
       NOT_wci_wslv_respF_c_r_2_EQ_2_1_2_AND_IF_wci_w_ETC___d441,
       dbg_rd_bitslip_cnt_RDY_write__20_AND_dbg_rd_cl_ETC___d332,
       dbg_wl_odelay_dqs_tap_cnt_RDY_write__17_AND_db_ETC___d335,
       lrespF_RDY_first__90_AND_NOT_splitReadInFlight_ETC___d408,
       lrespF_RDY_first__90_AND_NOT_wmemi_respF_c_r_4_ETC___d392,
       wmemi_operateD_76_AND_wmemi_peerIsReady_77_78__ETC___d368,
       x1__h12184;
  ...
  // submodule memc_memc
  mig_7series_v1_2 memc_memc(.sys_rst(memc_mem_rst_p$OUT_RST_N),
  ...
  assign WILL_FIRE_RL_memc_advance_request =
	     memc_reqF$EMPTY_N &&
	     (x1__h12184 || !memc_reqF$D_OUT[176] || memc_rdpF$FULL_N) &&
	     memc_memc$phy_init_done &&
	     !memc_firstBeat &&
	     !memc_secondBeat ;
  ...
  assign MUX_lreqF$enq_1__VAL_1 =
	     { !wci_wslv_reqF$D_OUT[51] &&
	       wci_wslv_reqF$D_OUT[39:32] != 8'h54,
	       IF_wci_wslv_reqF_first__5_BIT_51_29_THEN_pReg__ETC___d480 } ;
  ...
  assign MUX_wci_wslv_respF_q_1$write_1__VAL_2 =
	     (wci_wslv_respF_c_r == 2'd2) ?
	       MUX_wci_wslv_respF_q_0$write_1__VAL_1 :
	       34'h0AAAAAAAA ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_1 = { 2'd1, g_data__h14523 } ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_2 = { 2'd1, g_data__h18279 } ;
  ...
  // submodule appFull
  assign appFull$sD_IN = x1__h12184 ;
  ...
  assign memc_memc$app_wdf_mask =
	     WILL_FIRE_RL_memc_advance_write0 ? ~x__h5908 : ~x__h6129 ;
  ...
  assign IF_memc_memc_app_rd_data_end__11_CONCAT_memc_r_ETC___d227 =
	     CASE_x378_NOT_x378_EQ_0b11_OR_memc_respFFULL__ETC__q2 &&
	     (!memc_memc$app_rd_data_end || memc_rdpF$EMPTY_N) ;
  assign IF_wci_wslv_reqF_first__5_BIT_51_29_THEN_lreqF_ETC___d505 =
	     wci_wslv_reqF$D_OUT[51] ?
	       lreqF$sFULL_N && splaF$FULL_N :
	       wci_wslv_respF_c_r != 2'd2 ;
  assign IF_wci_wslv_reqF_first__5_BIT_51_29_THEN_pReg__ETC___d480 =
	     wci_wslv_reqF$D_OUT[51] ?
	       { x1_addr__h16761, x1_be__h16762, x1_data__h16763 } :
	       { wci_wslv_reqF$D_OUT[31:0], mReg, x1_data__h15762 } ;
  assign NOT_wci_wslv_respF_c_r_2_EQ_2_1_2_AND_IF_wci_w_ETC___d441 =
	     wci_wslv_respF_c_r != 2'd2 &&
	     (wci_wslv_reqF$D_OUT[51] ?
		lreqF$sFULL_N :
		((wci_wslv_reqF$D_OUT[39:32] == 8'h54) ?
  ...
  assign dbg_rd_bitslip_cnt_RDY_write__20_AND_dbg_rd_cl_ETC___d332 =
	     dbg_rd_bitslip_cnt$sRDY && dbg_rd_clkdly_cnt$sRDY &&
	     dbg_rd_active_dly$sRDY &&
	     dbg_dqs_p_tap_cnt$sRDY &&
	     dbg_dqs_n_tap_cnt$sRDY &&
	     dbg_dq_tap_cnt$sRDY &&
	     requestCount$sRDY ;
  assign dbg_wl_odelay_dqs_tap_cnt_RDY_write__17_AND_db_ETC___d335 =
	     dbg_wl_odelay_dqs_tap_cnt$sRDY &&
	     dbg_wl_odelay_dq_tap_cnt$sRDY &&
	     dbg_cpt_tap_cnt$sRDY &&
	     dbg_rd_bitslip_cnt_RDY_write__20_AND_dbg_rd_cl_ETC___d332 ;
  assign dramStatus__h13165 = { 16'd0, x__h18319 } ;
  assign g_data__h18279 =
	     wci_wslv_reqF$D_OUT[51] ?
	       32'd0 :
	       CASE_wci_wslv_reqFD_OUT_BITS_39_TO_32_0_0x0_d_ETC__q1 ;
  assign lrespF_RDY_first__90_AND_NOT_splitReadInFlight_ETC___d408 =
	     lrespF$dEMPTY_N &&
	     (!splitReadInFlight ||
	      splaF$EMPTY_N && wci_wslv_respF_c_r != 2'd2) ;
  assign lrespF_RDY_first__90_AND_NOT_wmemi_respF_c_r_4_ETC___d392 =
	     lrespF$dEMPTY_N && wmemi_respF_c_r != 2'd2 && wmemi_operateD &&
	     wmemi_peerIsReady ;
  assign myBE__h5945 = { 16'h0, memc_reqF$D_OUT[143:128] } ;
  assign myBE__h5978 = { memc_reqF$D_OUT[143:128], 16'h0 } ;
  assign rdat___1__h18342 = { 24'd0, dbg_wl_dqs_inverted$dD_OUT } ;
  assign rdat___1__h18351 = { 16'd0, dbg_wr_calib_clk_delay$dD_OUT } ;
  assign rdat___1__h18378 = { 30'd0, dbg_rdlvl_done$dD_OUT } ;
  assign rdat___1__h18387 = { 30'd0, dbg_rdlvl_err$dD_OUT } ;
  assign rdat___1__h18423 = { 8'd0, dbg_rd_bitslip_cnt$dD_OUT } ;
  assign rdat___1__h18432 = { 16'd0, dbg_rd_clkdly_cnt$dD_OUT } ;
  assign rdat___1__h18441 = { 27'd0, dbg_rd_active_dly$dD_OUT } ;
  assign rdat___1__h18483 = { 16'd0, requestCount$dD_OUT } ;
  assign rdat___1__h18492 = { 16'd0, pReg } ;
  assign rdat___1__h18500 = { 16'd0, mReg } ;
  assign wmemi_operateD_76_AND_wmemi_peerIsReady_77_78__ETC___d368 =
	     wmemi_operateD && wmemi_peerIsReady && wmemi_reqF$EMPTY_N &&
	     (wmemi_reqF$D_OUT[51:49] != 3'd1 || wmemi_dhF$EMPTY_N) ;
  assign x1__h12184 = !memc_memc$app_rdy ;
  assign x1_addr__h16761 = { pReg[12:0], wci_wslv_reqF$D_OUT[50:36], 4'd0 } ;
  assign x1_be__h16762 =
  ...
  assign x1_data__h15762 = { wdReg_3, wdReg_2, wdReg_1, wdReg } ;
  assign x1_data__h16763 = {4{wci_wslv_reqF$D_OUT[31:0]}} ;
  assign x__h18319 =
	     { respCount,
	       2'h0,
	       memIsResetCC$dD_OUT,
  ...
  begin
    case (splaF$D_OUT)
      2'd0: g_data__h14523 = lrespF$dD_OUT[31:0];
      2'd1: g_data__h14523 = lrespF$dD_OUT[63:32];
      2'd2: g_data__h14523 = lrespF$dD_OUT[95:64];
      2'd3: g_data__h14523 = lrespF$dD_OUT[127:96];
    endcase
  end
  always@(wci_wslv_reqF$D_OUT or
	  dramStatus__h13165 or
	  dramCtrl or
	  rdat___1__h18342 or
	  rdat___1__h18351 or
  ...
  always@(memc_reqF$D_OUT or myBE__h5945 or myBE__h5978)
  begin
    case (memc_reqF$D_OUT[149:148])
      2'b0: x__h5908 = myBE__h5945;
      2'b01: x__h5908 = myBE__h5978;
      default: x__h5908 = 32'd0;
    endcase
  end
  always@(memc_reqF$D_OUT or myBE__h5945 or myBE__h5978)
  begin
    case (memc_reqF$D_OUT[149:148])
      2'b10: x__h6129 = myBE__h5945;
      2'b11: x__h6129 = myBE__h5978;
      default: x__h6129 = 32'd0;
    endcase
  end
  ...
  begin
    case (x__h6378)
	  ...
	  CASE_x378_NOT_x378_EQ_0b11_OR_memc_respFFULL__ETC__q2 =
	      memc_respF$FULL_N;
      default: CASE_x378_NOT_x378_EQ_0b11_OR_memc_respFFULL__ETC__q2 =
  ...
  begin
	...
	$display("Error: \"bsv/wrk/DramServer_k7.bsv\", line 173, column 28: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_cfwr] and\n  [RL_advance_response] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n)
	...
	$display("Error: \"bsv/wrk/DramServer_k7.bsv\", line 173, column 38: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_cfrd] and\n  [RL_advance_response] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n)
	...
	$display("Error: \"bsv/wrk/DramServer_k7.bsv\", line 173, column 62: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_ctrl_IsO] and\n  [RL_wci_ctrl_OrE] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wci_ctrl_EiI && WILL_FIRE_RL_wci_ctrl_OrE)
	$display("Error: \"bsv/wrk/DramServer_k7.bsv\", line 173, column 48: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_ctrl_EiI] and\n  [RL_wci_ctrl_OrE] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n)
