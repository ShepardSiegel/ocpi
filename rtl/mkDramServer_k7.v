...
//
// On Wed Sep 12 08:12:02 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkDramServer_k7(CLK_sys0_clk,
  ...
  reg [63 : 0] v__h18068, v__h3637, v__h3811, v__h3955;
  ...
  wire [127 : 0] x1_data__h15050, x1_data__h16051;
  wire [31 : 0] dramStatus__h12438,
		g_data__h17567,
		myBE__h5845,
		myBE__h5878,
		rdat___1__h17630,
		...
		rdat___1__h17934,
		x1_addr__h16049;
  wire [15 : 0] x1_be__h16050, x__h17607;
  wire [2 : 0] x__h6278;
  wire IF_memc_memc_app_rd_data_end__11_CONCAT_memc_r_ETC___d227,
       ...
       wmemiReadInFlight_value_05_SLT_16___d696,
       x1__h12135;
  ...
  assign WILL_FIRE_RL_memc_advance_request =
	     memc_reqF$EMPTY_N &&
	     (x1__h12135 || !memc_reqF$D_OUT[176] || memc_rdpF$FULL_N) &&
	     memc_memc$init_calib_complete &&
	     !memc_firstBeat &&
	     !memc_secondBeat ;
  ...
  assign MUX_wci_wslv_respF_q_1$write_1__VAL_1 =
	     (wci_wslv_respF_c_r == 2'd2) ?
	       MUX_wci_wslv_respF_q_0$write_1__VAL_2 :
	       34'h0AAAAAAAA ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_1 = { 2'd1, g_data__h13809 } ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_2 = { 2'd1, g_data__h17567 } ;
  ...
  // submodule appFull
  assign appFull$sD_IN = x1__h12135 ;
  ...
  assign IF_wci_wslv_reqF_first__5_BIT_51_00_THEN_pReg__ETC___d451 =
	     wci_wslv_reqF$D_OUT[51] ?
	       { x1_addr__h16049, x1_be__h16050, x1_data__h16051 } :
	       { wci_wslv_reqF$D_OUT[31:0], mReg, x1_data__h15050 } ;
  assign IF_wmemi_reqF_first__26_BITS_51_TO_49_27_EQ_1__ETC___d335 =
	     (wmemi_reqF$D_OUT[51:49] == 3'd1) ?
	       lreqF$sFULL_N && wmemi_dhF$EMPTY_N :
	       !wmemiReadInFlight_value_05_SLT_16___d696 || lreqF$sFULL_N ;
  assign dramStatus__h12438 = { 16'd0, x__h17607 } ;
  assign g_data__h17567 =
	     wci_wslv_reqF$D_OUT[51] ?
	       32'd0 :
  ...
  assign rdat___1__h17630 =
	     hasDebugLogic ? { 24'd0, dbg_wl_dqs_inverted$dD_OUT } : 32'd0 ;
  assign rdat___1__h17641 =
	     hasDebugLogic ?
	       { 16'd0, dbg_wr_calib_clk_delay$dD_OUT } :
	       32'd0 ;
  assign rdat___1__h17652 =
	     hasDebugLogic ? dbg_wl_odelay_dqs_tap_cnt$dD_OUT[31:0] : 32'd0 ;
  assign rdat___1__h17663 =
	     hasDebugLogic ? dbg_wl_odelay_dq_tap_cnt$dD_OUT[31:0] : 32'd0 ;
  assign rdat___1__h17674 =
	     hasDebugLogic ? { 30'd0, dbg_rdlvl_done$dD_OUT } : 32'd0 ;
  assign rdat___1__h17685 =
	     hasDebugLogic ? { 30'd0, dbg_rdlvl_err$dD_OUT } : 32'd0 ;
  assign rdat___1__h17696 =
	     hasDebugLogic ? dbg_cpt_tap_cnt$dD_OUT[31:0] : 32'd0 ;
  assign rdat___1__h17707 =
	     hasDebugLogic ? dbg_cpt_first_edge_cnt$dD_OUT[31:0] : 32'd0 ;
  assign rdat___1__h17718 =
	     hasDebugLogic ? dbg_cpt_second_edge_cnt$dD_OUT[31:0] : 32'd0 ;
  assign rdat___1__h17729 =
	     hasDebugLogic ? { 8'd0, dbg_rd_bitslip_cnt$dD_OUT } : 32'd0 ;
  assign rdat___1__h17740 =
	     hasDebugLogic ? { 16'd0, dbg_rd_clkdly_cnt$dD_OUT } : 32'd0 ;
  assign rdat___1__h17751 =
	     hasDebugLogic ? { 27'd0, dbg_rd_active_dly$dD_OUT } : 32'd0 ;
  assign rdat___1__h17762 =
	     hasDebugLogic ? dbg_dqs_p_tap_cnt$dD_OUT[31:0] : 32'd0 ;
  assign rdat___1__h17773 =
	     hasDebugLogic ? dbg_dqs_n_tap_cnt$dD_OUT[31:0] : 32'd0 ;
  assign rdat___1__h17784 =
	     hasDebugLogic ? dbg_dq_tap_cnt$dD_OUT[31:0] : 32'd0 ;
  assign rdat___1__h17795 = hasDebugLogic ? dbg_rddata$dD_OUT : 32'd0 ;
  assign rdat___1__h17802 =
	     hasDebugLogic ? { 16'd0, requestCount$dD_OUT } : 32'd0 ;
  assign rdat___1__h17813 = hasDebugLogic ? { 16'd0, pReg } : 32'd0 ;
  assign rdat___1__h17823 = hasDebugLogic ? { 16'd0, mReg } : 32'd0 ;
  assign rdat___1__h17833 = hasDebugLogic ? wdReg : 32'd0 ;
  assign rdat___1__h17847 = hasDebugLogic ? wdReg_1 : 32'd0 ;
  assign rdat___1__h17861 = hasDebugLogic ? wdReg_2 : 32'd0 ;
  assign rdat___1__h17875 = hasDebugLogic ? wdReg_3 : 32'd0 ;
  assign rdat___1__h17889 = hasDebugLogic ? rdReg : 32'd0 ;
  assign rdat___1__h17904 = hasDebugLogic ? rdReg_1 : 32'd0 ;
  assign rdat___1__h17919 = hasDebugLogic ? rdReg_2 : 32'd0 ;
  assign rdat___1__h17934 = hasDebugLogic ? rdReg_3 : 32'd0 ;
  ...
  assign wmemiReadInFlight_value_05_SLT_16___d696 =
	     (wmemiReadInFlight_value ^ 8'h80) < 8'd144 ;
  assign x1__h12135 = !memc_memc$app_rdy ;
  assign x1_addr__h16049 = { pReg[12:0], wci_wslv_reqF$D_OUT[50:36], 4'd0 } ;
  assign x1_be__h16050 =
  ...
  assign x1_data__h15050 = { wdReg_3, wdReg_2, wdReg_1, wdReg } ;
  assign x1_data__h16051 = {4{wci_wslv_reqF$D_OUT[31:0]}} ;
  assign x__h17607 =
	     { respCount,
	       2'h0,
	       memIsResetCC$dD_OUT,
  ...
  begin
    case (splaF$D_OUT)
      2'd0: g_data__h13809 = lrespF$dD_OUT[31:0];
      2'd1: g_data__h13809 = lrespF$dD_OUT[63:32];
      2'd2: g_data__h13809 = lrespF$dD_OUT[95:64];
      2'd3: g_data__h13809 = lrespF$dD_OUT[127:96];
    endcase
  end
  always@(wci_wslv_reqF$D_OUT or
	  dramStatus__h12438 or
	  dramCtrl or
	  rdat___1__h17630 or
	  rdat___1__h17641 or
	  rdat___1__h17652 or
	  ...
	  rdat___1__h17875 or
	  rdat___1__h17889 or
	  rdat___1__h17904 or rdat___1__h17919 or rdat___1__h17934)
  begin
