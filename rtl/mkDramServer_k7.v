...
//
// On Wed Jul 20 17:12:39 EDT 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkDramServer_k7(CLK_sys0_clk,
  ...
  reg [63 : 0] v__h17957, v__h3636, v__h3810, v__h3954;
  reg [31 : 0] CASE_wci_wslv_reqFD_OUT_BITS_39_TO_32_0_0x0_d_ETC__q1,
	       g_data__h13743,
	       x__h5807,
	       x__h6028;
  reg CASE_x277_NOT_x277_EQ_0b11_OR_memc_respFFULL__ETC__q2;
  wire [175 : 0] IF_wci_wslv_reqF_first__5_BIT_51_95_THEN_pReg__ETC___d446;
  wire [127 : 0] x1_data__h14984, x1_data__h15985;
  wire [31 : 0] dramStatus__h12385,
		g_data__h17501,
		myBE__h5844,
		myBE__h5877,
		rdat___1__h17564,
  ...
  assign WILL_FIRE_RL_memc_advance_request =
	     memc_reqF$EMPTY_N &&
	     (x1__h12082 || !memc_reqF$D_OUT[176] || memc_rdpF$FULL_N) &&
	     memc_memc$init_calib_complete &&
	     !memc_firstBeat &&
	     !memc_secondBeat ;
  ...
  assign MUX_wci_wslv_respF_q_1$write_1__VAL_2 =
	     (wci_wslv_respF_c_r == 2'd2) ?
	       MUX_wci_wslv_respF_q_0$write_1__VAL_1 :
	       34'h0AAAAAAAA ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_1 = { 2'd1, g_data__h13743 } ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_2 = { 2'd1, g_data__h17501 } ;
  ...
  // submodule appFull
  assign appFull$sD_IN = x1__h12082 ;
  ...
  assign memc_memc$app_wdf_mask =
	     WILL_FIRE_RL_memc_advance_write0 ? ~x__h5807 : ~x__h6028 ;
  ...
  // submodule memc_respF
  always@(x__h6277 or memc_memc$app_rd_data)
  begin
    case (x__h6277)
  ...
  assign memc_respF$ENQ =
	     WILL_FIRE_RL_memc_advance_readData &&
	     (x__h6277 == 3'b0 || x__h6277 == 3'b101 || x__h6277 == 3'b110 ||
	      x__h6277 == 3'b011) ;
  ...
  assign IF_memc_memc_app_rd_data_end__11_CONCAT_memc_r_ETC___d227 =
	     CASE_x277_NOT_x277_EQ_0b11_OR_memc_respFFULL__ETC__q2 &&
  ...
  assign IF_wci_wslv_reqF_first__5_BIT_51_95_THEN_pReg__ETC___d446 =
	     wci_wslv_reqF$D_OUT[51] ?
	       { x1_addr__h15983, x1_be__h15984, x1_data__h15985 } :
	       { wci_wslv_reqF$D_OUT[31:0], mReg, x1_data__h14984 } ;
  assign NOT_wci_wslv_respF_c_r_2_EQ_2_1_2_AND_IF_wci_w_ETC___d407 =
	     wci_wslv_respF_c_r != 2'd2 &&
	     (wci_wslv_reqF$D_OUT[51] ?
		lreqF$sFULL_N :
		((wci_wslv_reqF$D_OUT[39:32] == 8'h54) ?
  ...
  assign dramStatus__h12385 = { 16'd0, x__h17541 } ;
  assign g_data__h17501 =
	     wci_wslv_reqF$D_OUT[51] ?
	       32'd0 :
  ...
  assign lrespF_RDY_first__56_AND_NOT_wmemi_respF_c_r_4_ETC___d358 =
	     ...
	     wmemi_peerIsReady ;
  assign myBE__h5844 = { 16'h0, memc_reqF$D_OUT[143:128] } ;
  assign myBE__h5877 = { memc_reqF$D_OUT[143:128], 16'h0 } ;
  assign rdat___1__h17564 = { 24'd0, dbg_wl_dqs_inverted$dD_OUT } ;
  assign rdat___1__h17573 = { 16'd0, dbg_wr_calib_clk_delay$dD_OUT } ;
  assign rdat___1__h17600 = { 30'd0, dbg_rdlvl_done$dD_OUT } ;
  assign rdat___1__h17609 = { 30'd0, dbg_rdlvl_err$dD_OUT } ;
  assign rdat___1__h17645 = { 8'd0, dbg_rd_bitslip_cnt$dD_OUT } ;
  assign rdat___1__h17654 = { 16'd0, dbg_rd_clkdly_cnt$dD_OUT } ;
  assign rdat___1__h17663 = { 27'd0, dbg_rd_active_dly$dD_OUT } ;
  assign rdat___1__h17705 = { 16'd0, requestCount$dD_OUT } ;
  assign rdat___1__h17714 = { 16'd0, pReg } ;
  assign rdat___1__h17722 = { 16'd0, mReg } ;
  ...
  assign x1__h12082 = !memc_memc$app_rdy ;
  assign x1_addr__h15983 = { pReg[12:0], wci_wslv_reqF$D_OUT[50:36], 4'd0 } ;
  assign x1_be__h15984 =
  ...
  assign x1_data__h14984 = { wdReg_3, wdReg_2, wdReg_1, wdReg } ;
  assign x1_data__h15985 = {4{wci_wslv_reqF$D_OUT[31:0]}} ;
  assign x__h17541 =
	     { respCount,
	       2'h0,
	       memIsResetCC$dD_OUT,
	       ...
	       firBeat$dD_OUT,
	       initComplete$dD_OUT } ;
  assign x__h6277 = { memc_memc$app_rd_data_end, memc_rdpF$D_OUT } ;
  always@(splaF$D_OUT or lrespF$dD_OUT)
  begin
    case (splaF$D_OUT)
      2'd0: g_data__h13743 = lrespF$dD_OUT[31:0];
      2'd1: g_data__h13743 = lrespF$dD_OUT[63:32];
      2'd2: g_data__h13743 = lrespF$dD_OUT[95:64];
      2'd3: g_data__h13743 = lrespF$dD_OUT[127:96];
    endcase
  end
  always@(memc_reqF$D_OUT or myBE__h5844 or myBE__h5877)
  begin
    case (memc_reqF$D_OUT[149:148])
      2'b0: x__h5807 = myBE__h5844;
      2'b01: x__h5807 = myBE__h5877;
      default: x__h5807 = 32'd0;
    endcase
  end
  always@(memc_reqF$D_OUT or myBE__h5844 or myBE__h5877)
  begin
    case (memc_reqF$D_OUT[149:148])
      2'b10: x__h6028 = myBE__h5844;
      2'b11: x__h6028 = myBE__h5877;
      default: x__h6028 = 32'd0;
    endcase
  end
  always@(wci_wslv_reqF$D_OUT or
	  dramStatus__h12385 or
	  dramCtrl or
	  rdat___1__h17564 or
	  rdat___1__h17573 or
  ...
  always@(x__h6277 or memc_respF$FULL_N)
  begin
    case (x__h6277)
      3'b0, 3'b101, 3'b110:
	  CASE_x277_NOT_x277_EQ_0b11_OR_memc_respFFULL__ETC__q2 =
	      memc_respF$FULL_N;
      default: CASE_x277_NOT_x277_EQ_0b11_OR_memc_respFFULL__ETC__q2 =
		   x__h6277 != 3'b011 || memc_respF$FULL_N;
    endcase
  end
