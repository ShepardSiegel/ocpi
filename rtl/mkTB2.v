...
//
// On Tue Dec 13 10:05:21 EST 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkTB2(CLK,
  ...
  assign cm0$EN_s0_request_put =
	     tg$RDY_client_request_get && cm0$RDY_s0_request_put ;
  assign cm0$EN_s0_response_get =
	     tg$RDY_client_response_put && cm0$RDY_s0_response_get ;
  ...
  begin
    ...
    if (RST_N)
      if (cycle == 16'd5000) $display("[%0d] %m termination", v__h831);
    if (RST_N) if (cycle == 16'd5000) $finish(32'd1);
  end
  // synopsys translate_on
endmodule  // mkTB2
