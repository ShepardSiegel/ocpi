...
//
// On Wed Feb  9 17:11:30 EST 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkOPED_v6(pci0_clkp,
  ...
  wire [31 : 0] axis2wsi$axi_TDATA, axis2wsi$axi_TUSER, axis2wsi$wsi_MData;
  ...
  reg [63 : 0] v__h103733,
	       ...
	       v__h86393,
	       v__h86547;
  reg [31 : 0] IF_0_MINUS_dp0_tlp_writeDWAddr_184_BITS_1_TO_0_ETC___d4571,
	       IF_0_MINUS_dp1_tlp_writeDWAddr_199_BITS_1_TO_0_ETC___d4576,
	       IF_1_MINUS_dp0_tlp_writeDWAddr_184_BITS_1_TO_0_ETC___d4572,
	       IF_1_MINUS_dp1_tlp_writeDWAddr_199_BITS_1_TO_0_ETC___d4577,
	       IF_2_MINUS_dp0_tlp_writeDWAddr_184_BITS_1_TO_0_ETC___d4573,
	       IF_2_MINUS_dp1_tlp_writeDWAddr_199_BITS_1_TO_0_ETC___d4578,
	       IF_3_MINUS_dp0_tlp_writeDWAddr_184_BITS_1_TO_0_ETC___d4574,
	       IF_3_MINUS_dp1_tlp_writeDWAddr_199_BITS_1_TO_0_ETC___d4579,
	       IF_dp0_tlp_readReq_first__412_BITS_30_TO_29_41_ETC___d4575,
	       IF_dp1_tlp_readReq_first__427_BITS_30_TO_29_42_ETC___d4580,
	       _theResult____h163921,
	       _theResult____h86531,
	       rdata__h157131,
	       rdata__h79738;
  reg [15 : 0] CASE_dp0_tlp_outDwRemain_BITS_1_TO_0_0xFFF0_0b_ETC__q23,
	       CASE_dp1_tlp_outDwRemain_BITS_1_TO_0_0xFFF0_0b_ETC__q24;
  reg [1 : 0] lowAddr10__h139210,
	      lowAddr10__h61817,
	      x__h139332,
	      x__h139355,
	      x__h61939,
  ...
  reg CASE_dp0_dpControl_BITS_1_TO_0_NOT_dp0_bml_fab_ETC__q17,
      ...
      IF_0_MINUS_dp0_tlp_writeDWAddr_184_BITS_1_TO_0_ETC___d4517,
      IF_0_MINUS_dp1_tlp_writeDWAddr_199_BITS_1_TO_0_ETC___d3216,
      IF_0_MINUS_dp1_tlp_writeDWAddr_199_BITS_1_TO_0_ETC___d4537,
      IF_1_MINUS_dp0_tlp_writeDWAddr_184_BITS_1_TO_0_ETC___d1211,
      IF_1_MINUS_dp0_tlp_writeDWAddr_184_BITS_1_TO_0_ETC___d4547,
      IF_1_MINUS_dp1_tlp_writeDWAddr_199_BITS_1_TO_0_ETC___d3226,
      IF_1_MINUS_dp1_tlp_writeDWAddr_199_BITS_1_TO_0_ETC___d4550,
      IF_2_MINUS_dp0_tlp_writeDWAddr_184_BITS_1_TO_0_ETC___d1221,
      IF_2_MINUS_dp0_tlp_writeDWAddr_184_BITS_1_TO_0_ETC___d4518,
      IF_2_MINUS_dp1_tlp_writeDWAddr_199_BITS_1_TO_0_ETC___d3236,
      IF_2_MINUS_dp1_tlp_writeDWAddr_199_BITS_1_TO_0_ETC___d4538,
      IF_3_MINUS_dp0_tlp_writeDWAddr_184_BITS_1_TO_0_ETC___d1231,
      IF_3_MINUS_dp0_tlp_writeDWAddr_184_BITS_1_TO_0_ETC___d4519,
      IF_3_MINUS_dp1_tlp_writeDWAddr_199_BITS_1_TO_0_ETC___d3246,
      IF_3_MINUS_dp1_tlp_writeDWAddr_199_BITS_1_TO_0_ETC___d4539,
      IF_dp0_bml_dpControl_wget__952_BITS_1_TO_0_958_ETC___d2029,
      IF_dp0_tlp_readReq_first__412_BITS_30_TO_29_41_ETC___d1427,
      IF_dp0_wmi_addr_784_BITS_3_TO_2_785_EQ_0_786_T_ETC___d4499,
      ...
      IF_dp1_wmi_addr_799_BITS_3_TO_2_800_EQ_0_801_T_ETC___d4500,
  ...
  wire [127 : 0] IF_dp0_tlp_readNxtDWAddr_364_BIT_0_535_THEN_dp_ETC___d1540,
		 ...
		 w_data__h47134,
		 w_data__h48448;
  wire [31 : 0] dp0_bml_fabFlowAddr_991_PLUS_dp0_bml_fabFlowSi_ETC___d4445,
		dp1_bml_fabFlowAddr_006_PLUS_dp1_bml_fabFlowSi_ETC___d4447,
		mesgMeta_opcode__h155411,
		mesgMeta_opcode__h78018,
		nowLS__h110175,
		nowLS__h43641,
		nowMS__h110174,
		nowMS__h43640,
  ...
  wire [12 : 0] dp0_tlp_readNxtDWAddr_PLUS_1__q7,
		...
		spanToNextPage__h113388,
		spanToNextPage__h46852,
		thisRequestLength__h113389,
		thisRequestLength__h46853;
  wire [11 : 0] byteCount__h139212,
		byteCount__h61819,
		x__h139323,
		x__h139325,
		x__h61930,
		...
		y__h61931,
		y__h61933;
  wire [9 : 0] x__h113944, x__h47463, x__h48141;
  wire [7 : 0] rreq_tag__h113618, tag__h47128, tagm__h47254;
  wire [6 : 0] lowAddr__h139211, lowAddr__h61818;
  wire [3 : 0] lastBE__h113817, lastBE__h47155;
  ...
  wire IF_1_MINUS_dp0_tlp_writeDWAddr_184_BITS_1_TO_0_ETC___d1234,
       ...
       _dfoo13,
       dp0_bml_crdBuf_value_934_EQ_dp0_bml_crdBuf_mod_ETC___d5248,
       dp0_bml_fabBuf_value_919_EQ_dp0_bml_fabBuf_mod_ETC___d5249,
       dp0_bml_lclBufDone_976_AND_IF_dp0_bml_dpContro_ETC___d4521,
       dp0_bml_lclBuf_value_889_EQ_dp0_bml_lclBuf_mod_ETC___d5263,
       dp0_bml_remBuf_value_904_EQ_dp0_bml_remBuf_mod_ETC___d5264,
       dp0_bram_serverAdapterA_1_cnt_50_SLT_3___d5069,
       dp0_bram_serverAdapterA_2_cnt_68_SLT_3___d5070,
       dp0_bram_serverAdapterA_2_outDataCore_notEmpty_ETC___d1498,
       dp0_bram_serverAdapterA_3_cnt_86_SLT_3___d5071,
       dp0_bram_serverAdapterA_cnt_32_SLT_3___d5068,
       ...
       dp0_tlp_dmaPullRemainDWLen_014_ULE_dp0_tlp_dma_ETC___d5066,
       dp0_tlp_dmaPullRemainDWSub_028_ULE_4___d5067,
       ...
       dp0_tlp_outDwRemain_138_ULE_4___d4717,
       ...
       dp0_tlp_writeRemainDWLen_188_ULE_1___d4491,
       dp0_tlp_writeRemainDWLen_188_ULE_2___d4460,
       dp0_tlp_writeRemainDWLen_188_ULE_3___d4492,
       dp0_wmi_dpControl_whas__683_AND_dp0_bram_serve_ETC___d1729,
       dp1_bml_crdBuf_value_949_EQ_dp1_bml_crdBuf_mod_ETC___d5305,
       dp1_bml_fabBuf_value_934_EQ_dp1_bml_fabBuf_mod_ETC___d5306,
       dp1_bml_lclBufDone_991_AND_IF_dp1_bml_dpContro_ETC___d4541,
       dp1_bml_lclBuf_value_904_EQ_dp1_bml_lclBuf_mod_ETC___d5319,
       dp1_bml_remBuf_value_919_EQ_dp1_bml_remBuf_mod_ETC___d5320,
       dp1_bram_serverAdapterA_1_cnt_368_SLT_3___d5073,
       dp1_bram_serverAdapterA_2_cnt_486_SLT_3___d5074,
       dp1_bram_serverAdapterA_2_outDataCore_notEmpty_ETC___d3513,
       dp1_bram_serverAdapterA_3_cnt_604_SLT_3___d5075,
       dp1_bram_serverAdapterA_cnt_250_SLT_3___d5072,
       ...
       dp1_tlp_mRespF_first__887_BITS_71_TO_62_978_ULE_1___d4493,
       dp1_tlp_outDwRemain_004_ULE_4___d4722,
       ...
       dp1_tlp_writeRemainDWLen_203_ULE_1___d4494,
       dp1_tlp_writeRemainDWLen_203_ULE_2___d4461,
       dp1_tlp_writeRemainDWLen_203_ULE_3___d4471,
  ...
  assign MUX_dp0_bml_fabBufsAvail$write_1__VAL_1 =
	     (dp0_bml_fabAvail && !dp0_bml_remStart) ? x__h85005 : x__h85010 ;
  assign MUX_dp0_bml_fabBufsAvail$write_1__VAL_2 =
	     (dp0_dpControl[3:2] == 2'd1) ? x__h83762 : 16'd0 ;
  assign MUX_dp0_bml_fabFlowAddr$write_1__VAL_1 =
	     dp0_bml_fabBuf_value_919_EQ_dp0_bml_fabBuf_mod_ETC___d5249 ?
	       dp0_bml_fabFlowBase :
	       dp0_bml_fabFlowAddr_991_PLUS_dp0_bml_fabFlowSi_ETC___d4445 ;
  ...
  assign MUX_dp0_bram_memory$a_put_3__VAL_3 =
	     { IF_0_MINUS_dp0_tlp_writeDWAddr_184_BITS_1_TO_0_ETC___d4571[7:0],
	       IF_0_MINUS_dp0_tlp_writeDWAddr_184_BITS_1_TO_0_ETC___d4571[15:8],
	       IF_0_MINUS_dp0_tlp_writeDWAddr_184_BITS_1_TO_0_ETC___d4571[23:16],
	       IF_0_MINUS_dp0_tlp_writeDWAddr_184_BITS_1_TO_0_ETC___d4571[31:24] } ;
  ...
  assign MUX_dp0_bram_memory_1$a_put_3__VAL_3 =
	     { IF_1_MINUS_dp0_tlp_writeDWAddr_184_BITS_1_TO_0_ETC___d4572[7:0],
	       IF_1_MINUS_dp0_tlp_writeDWAddr_184_BITS_1_TO_0_ETC___d4572[15:8],
	       IF_1_MINUS_dp0_tlp_writeDWAddr_184_BITS_1_TO_0_ETC___d4572[23:16],
	       IF_1_MINUS_dp0_tlp_writeDWAddr_184_BITS_1_TO_0_ETC___d4572[31:24] } ;
  assign MUX_dp0_bram_memory_1$b_put_3__VAL_4 =
	     { 24'h800000, dp0_wmi_wmi_mFlagReg[31:24] } ;
  always@(idx__h56159 or
	  dp0_tlp_writeDWAddr_PLUS_3__q3 or
	  dp0_tlp_writeDWAddr or
	  dp0_tlp_writeDWAddr_PLUS_1__q4 or dp0_tlp_writeDWAddr_PLUS_2__q5)
  begin
  ...
  assign MUX_dp0_bram_memory_2$a_put_3__VAL_3 =
	     { IF_2_MINUS_dp0_tlp_writeDWAddr_184_BITS_1_TO_0_ETC___d4573[7:0],
	       IF_2_MINUS_dp0_tlp_writeDWAddr_184_BITS_1_TO_0_ETC___d4573[15:8],
	       IF_2_MINUS_dp0_tlp_writeDWAddr_184_BITS_1_TO_0_ETC___d4573[23:16],
	       IF_2_MINUS_dp0_tlp_writeDWAddr_184_BITS_1_TO_0_ETC___d4573[31:24] } ;
  always@(idx__h57455 or
	  dp0_tlp_writeDWAddr_PLUS_3__q3 or
	  dp0_tlp_writeDWAddr or
	  dp0_tlp_writeDWAddr_PLUS_1__q4 or dp0_tlp_writeDWAddr_PLUS_2__q5)
  begin
  ...
  assign MUX_dp0_bram_memory_3$a_put_3__VAL_3 =
	     { IF_3_MINUS_dp0_tlp_writeDWAddr_184_BITS_1_TO_0_ETC___d4574[7:0],
	       IF_3_MINUS_dp0_tlp_writeDWAddr_184_BITS_1_TO_0_ETC___d4574[15:8],
	       IF_3_MINUS_dp0_tlp_writeDWAddr_184_BITS_1_TO_0_ETC___d4574[23:16],
	       IF_3_MINUS_dp0_tlp_writeDWAddr_184_BITS_1_TO_0_ETC___d4574[31:24] } ;
  ...
  assign MUX_dp0_tlp_mesgComplReceived$write_1__VAL_2 =
	     dp0_tlp_mesgComplReceived + y__h48138 ;
  ...
  assign MUX_dp0_tlp_mesgLengthRemainPull$write_1__VAL_2 =
	     dp0_tlp_mesgLengthRemainPull - y__h46878 ;
  ...
  assign MUX_dp0_tlp_outF$enq_1__VAL_1 = { 25'd25362416, w_data__h41361 } ;
  assign MUX_dp0_tlp_outF$enq_1__VAL_2 = { 25'd25362416, w_data__h47134 } ;
  assign MUX_dp0_tlp_outF$enq_1__VAL_3 = { 25'd25296895, w_data__h48448 } ;
  ...
  assign MUX_dp0_wmi_wmi_respF_q_0$write_1__VAL_2 = { 2'd1, rdata__h79738 } ;
  ...
  assign MUX_dp1_bml_fabBufsAvail$write_1__VAL_2 =
	     (dp1_dpControl[3:2] == 2'd1) ? x__h161152 : 16'd0 ;
  ...
  assign MUX_dp1_bram_memory$a_put_3__VAL_3 =
	     { IF_0_MINUS_dp1_tlp_writeDWAddr_199_BITS_1_TO_0_ETC___d4576[7:0],
	       IF_0_MINUS_dp1_tlp_writeDWAddr_199_BITS_1_TO_0_ETC___d4576[15:8],
	       IF_0_MINUS_dp1_tlp_writeDWAddr_199_BITS_1_TO_0_ETC___d4576[23:16],
	       IF_0_MINUS_dp1_tlp_writeDWAddr_199_BITS_1_TO_0_ETC___d4576[31:24] } ;
  ...
  assign MUX_dp1_bram_memory_1$a_put_3__VAL_3 =
	     { IF_1_MINUS_dp1_tlp_writeDWAddr_199_BITS_1_TO_0_ETC___d4577[7:0],
	       IF_1_MINUS_dp1_tlp_writeDWAddr_199_BITS_1_TO_0_ETC___d4577[15:8],
	       IF_1_MINUS_dp1_tlp_writeDWAddr_199_BITS_1_TO_0_ETC___d4577[23:16],
	       IF_1_MINUS_dp1_tlp_writeDWAddr_199_BITS_1_TO_0_ETC___d4577[31:24] } ;
  assign MUX_dp1_bram_memory_1$b_put_3__VAL_4 =
	     { 24'h800000, dp1_wmi_wmi_mFlagReg[31:24] } ;
  always@(idx__h133552 or
	  dp1_tlp_writeDWAddr_PLUS_3__q9 or
	  dp1_tlp_writeDWAddr or
	  dp1_tlp_writeDWAddr_PLUS_1__q10 or dp1_tlp_writeDWAddr_PLUS_2__q11)
  begin
  ...
  assign MUX_dp1_bram_memory_2$a_put_3__VAL_3 =
	     { IF_2_MINUS_dp1_tlp_writeDWAddr_199_BITS_1_TO_0_ETC___d4578[7:0],
	       IF_2_MINUS_dp1_tlp_writeDWAddr_199_BITS_1_TO_0_ETC___d4578[15:8],
	       IF_2_MINUS_dp1_tlp_writeDWAddr_199_BITS_1_TO_0_ETC___d4578[23:16],
	       IF_2_MINUS_dp1_tlp_writeDWAddr_199_BITS_1_TO_0_ETC___d4578[31:24] } ;
  always@(idx__h134848 or
	  dp1_tlp_writeDWAddr_PLUS_3__q9 or
	  dp1_tlp_writeDWAddr or
	  dp1_tlp_writeDWAddr_PLUS_1__q10 or dp1_tlp_writeDWAddr_PLUS_2__q11)
  begin
  ...
  assign MUX_dp1_bram_memory_3$a_put_3__VAL_3 =
	     { IF_3_MINUS_dp1_tlp_writeDWAddr_199_BITS_1_TO_0_ETC___d4579[7:0],
	       IF_3_MINUS_dp1_tlp_writeDWAddr_199_BITS_1_TO_0_ETC___d4579[15:8],
	       IF_3_MINUS_dp1_tlp_writeDWAddr_199_BITS_1_TO_0_ETC___d4579[23:16],
	       IF_3_MINUS_dp1_tlp_writeDWAddr_199_BITS_1_TO_0_ETC___d4579[31:24] } ;
  assign MUX_dp1_tlp_fabMesgAccu$write_1__VAL_2 =
	     dp1_tlp_fabMesgAccu + y__h113941 ;
  ...
  assign MUX_dp1_tlp_mReqF$enq_1__VAL_3 =
	     { 88'hAAAAAAAAAAAAAAAAAAFFF8,
	       ...
	       thisRequestLength__h113389[11:2],
	       8'd255,
	       rreq_tag__h113618,
	       3'h2 } ;
  ...
  assign MUX_dp1_tlp_mesgLengthRemainPush$write_1__VAL_2 =
	     dp1_tlp_mesgLengthRemainPush - y__h113429 ;
  ...
  assign MUX_dp1_tlp_outF$enq_1__VAL_1 =
	     { 1'd1,
	       ...
	       23'd196607,
	       w_data__h113793 } ;
  assign MUX_dp1_tlp_outF$enq_1__VAL_2 = { 25'd16973823, w_data__h114772 } ;
  assign MUX_dp1_tlp_outF$enq_1__VAL_3 = { 25'd8585200, w_data__h115834 } ;
  assign MUX_dp1_tlp_outF$enq_1__VAL_4 = { 25'd25296895, w_data__h125840 } ;
  ...
  assign MUX_dp1_tlp_remMesgAccu$write_1__VAL_2 =
	     dp1_tlp_remMesgAccu + y__h113571 ;
  assign MUX_dp1_tlp_srcMesgAccu$write_1__VAL_2 =
	     dp1_tlp_srcMesgAccu + y__h113523 ;
  ...
  assign MUX_dp1_wmi_wmi_respF_q_0$write_1__VAL_2 = { 2'd1, rdata__h157131 } ;
  ...
  assign dp0_tlp_pullTagMatch_1$wget =
	     tagm__h47254 == dp0_tlp_inF$D_OUT[47:40] &&
	     dp0_tlp_inF_first__00_BITS_63_TO_56_03_EQ_pciD_ETC___d912 ;
  ...
  assign dp1_bram_serverAdapterA_s1_1$wget =
	     { 1'd1, !ab__h89862[1] || ab__h89862[0] } ;
  ...
  assign dp1_bram_serverAdapterB_s1_1$wget =
	     { 1'd1, !ab__h91261[1] || ab__h91261[0] } ;
  ...
  assign dp1_bram_serverAdapterA_1_s1_1$wget =
	     { 1'd1, !ab__h92791[1] || ab__h92791[0] } ;
  ...
  assign dp1_bram_serverAdapterB_1_s1_1$wget =
	     { 1'd1, !ab__h94188[1] || ab__h94188[0] } ;
  ...
  assign dp1_bram_serverAdapterA_2_s1_1$wget =
	     { 1'd1, !ab__h95718[1] || ab__h95718[0] } ;
  ...
  assign dp1_bram_serverAdapterB_2_s1_1$wget =
	     { 1'd1, !ab__h97115[1] || ab__h97115[0] } ;
  ...
  assign dp1_bram_serverAdapterA_3_s1_1$wget =
	     { 1'd1, !ab__h98645[1] || ab__h98645[0] } ;
  ...
  assign dp1_bram_serverAdapterB_3_s1_1$wget =
	     { 1'd1, !ab__h100042[1] || ab__h100042[0] } ;
  ...
  begin
    case (1'b1) // synopsys parallel_case
      WILL_FIRE_RL_dp0_tlp_dmaPullRequestFarMesg:
	  dp0_tlp_dmaPullRemainDWLen$D_IN = thisRequestLength__h46853[11:2];
      WILL_FIRE_RL_dp0_tlp_dmaPullResponseHeader:
  ...
  always@(WILL_FIRE_RL_dp0_tlp_dmaPullResponseHeader or
	  ...
	  WILL_FIRE_RL_dp0_tlp_dmaPullResponseBody or
	  dp0_tlp_dmaPullRemainDWSub_028_ULE_4___d5067 or
	  WILL_FIRE_RL_dp0_tlp_dmaPullRequestFarMesg)
  begin
    case (1'b1) // synopsys parallel_case
      WILL_FIRE_RL_dp0_tlp_dmaPullResponseHeader:
  ...
  assign dp0_wmi_wmi_sFlagReg$D_IN =
	     { y_avValue__h79594[7:0], y_avValue__h79574[23:0] } ;
  ...
  // register dp1_bml_crdBuf_modulus
  assign dp1_bml_crdBuf_modulus$D_IN = dp1_bml_lclBuf_modulus$D_IN ;
  ...
  // register dp1_bml_lclBuf_modulus
  assign dp1_bml_lclBuf_modulus$D_IN = dp1_bml_lclNumBufs - 16'd1 ;
  ...
  // register dp1_bml_remBuf_modulus
  assign dp1_bml_remBuf_modulus$D_IN = dp1_bml_lclBuf_modulus$D_IN ;
  ...
  assign dp1_wmi_wmi_sFlagReg$D_IN =
	     { y_avValue__h156987[7:0], y_avValue__h156967[23:0] } ;
  ...
  assign _dfoo13 =
	     dp1_tlp_mRespF$D_OUT[71:62] != 10'd1 ||
	     dp1_tlp_mRespF$D_OUT[42:35] == 8'h01 ;
  assign ab__h100042 = dp1_bram_serverAdapterB_3_writeWithResp$wget ;
  ...
  assign ab__h89862 = dp1_bram_serverAdapterA_writeWithResp$wget ;
  assign ab__h91261 = dp1_bram_serverAdapterB_writeWithResp$wget ;
  assign ab__h92791 = dp1_bram_serverAdapterA_1_writeWithResp$wget ;
  assign ab__h94188 = dp1_bram_serverAdapterB_1_writeWithResp$wget ;
  assign ab__h95718 = dp1_bram_serverAdapterA_2_writeWithResp$wget ;
  assign ab__h97115 = dp1_bram_serverAdapterB_2_writeWithResp$wget ;
  assign ab__h98645 = dp1_bram_serverAdapterA_3_writeWithResp$wget ;
  assign byteCount__h139212 = x__h139323 - y__h139324 ;
  assign byteCount__h61819 = x__h61930 - y__h61931 ;
  assign dp0_bml_crdBuf_value_934_EQ_dp0_bml_crdBuf_mod_ETC___d5248 =
	     dp0_bml_crdBuf_value == dp0_bml_crdBuf_modulus ;
  assign dp0_bml_fabBuf_value_919_EQ_dp0_bml_fabBuf_mod_ETC___d5249 =
	     dp0_bml_fabBuf_value == dp0_bml_fabBuf_modulus ;
  assign dp0_bml_fabFlowAddr_991_PLUS_dp0_bml_fabFlowSi_ETC___d4445 =
	     dp0_bml_fabFlowAddr + dp0_bml_fabFlowSize ;
  assign dp0_bml_lclBufDone_976_AND_IF_dp0_bml_dpContro_ETC___d4521 =
	     dp0_bml_lclBufDone &&
	     CASE_dp0_dpControl_BITS_1_TO_0_NOT_dp0_bml_fab_ETC__q29 ;
  assign dp0_bml_lclBuf_value_889_EQ_dp0_bml_lclBuf_mod_ETC___d5263 =
	     dp0_bml_lclBuf_value == dp0_bml_lclBuf_modulus ;
  assign dp0_bml_remBuf_value_904_EQ_dp0_bml_remBuf_mod_ETC___d5264 =
  ...
  assign dp0_bram_serverAdapterA_1_cnt_50_PLUS_IF_dp0_b_ETC___d356 =
		...
		3'd7 :
		3'd0) ;
  assign dp0_bram_serverAdapterA_1_cnt_50_SLT_3___d5069 =
  ...
  assign dp0_bram_serverAdapterA_2_cnt_68_PLUS_IF_dp0_b_ETC___d474 =
		...
		3'd7 :
		3'd0) ;
  assign dp0_bram_serverAdapterA_2_cnt_68_SLT_3___d5070 =
  ...
  assign dp0_bram_serverAdapterA_3_cnt_86_PLUS_IF_dp0_b_ETC___d592 =
		...
		3'd7 :
		3'd0) ;
  assign dp0_bram_serverAdapterA_3_cnt_86_SLT_3___d5071 =
  ...
  assign dp0_bram_serverAdapterA_cnt_32_SLT_3___d5068 =
  ...
  assign dp0_tlp_dmaPullRemainDWLen_014_ULE_dp0_tlp_dma_ETC___d5066 =
	     dp0_tlp_dmaPullRemainDWLen <= dp0_tlp_dmaPullRemainDWSub ;
  assign dp0_tlp_dmaPullRemainDWSub_028_ULE_4___d5067 =
	     dp0_tlp_dmaPullRemainDWSub <= 10'd4 ;
  ...
  assign dp0_tlp_mReqF_i_notEmpty__152_AND_IF_dp0_tlp_m_ETC___d1168 =
	     dp0_tlp_mReqF$EMPTY_N &&
	     CASE_dp0_tlp_mReqFD_OUT_BITS_51_TO_50_NOT_dp0_ETC__q25 ;
  assign dp0_tlp_outDwRemain_138_ULE_4___d4717 =
	     dp0_tlp_outDwRemain <= 10'd4 ;
  ...
  assign dp0_tlp_writeRemainDWLen_188_ULE_1___d4491 =
	     dp0_tlp_writeRemainDWLen <= 10'd1 ;
  assign dp0_tlp_writeRemainDWLen_188_ULE_2___d4460 =
	     dp0_tlp_writeRemainDWLen <= 10'd2 ;
  assign dp0_tlp_writeRemainDWLen_188_ULE_3___d4492 =
  ...
  assign dp0_wmi_dpControl_whas__683_AND_dp0_bram_serve_ETC___d1729 =
	     ...
	     (dp0_bram_serverAdapterB_1_outDataCore$EMPTY_N ||
	      dp0_bram_serverAdapterB_1_outData_enqData$whas) &&
	     dp0_bram_serverAdapterB_1_outData_outData_whas_ETC___d1725 ;
  assign dp1_bml_crdBuf_value_949_EQ_dp1_bml_crdBuf_mod_ETC___d5305 =
	     dp1_bml_crdBuf_value == dp1_bml_crdBuf_modulus ;
  assign dp1_bml_fabBuf_value_934_EQ_dp1_bml_fabBuf_mod_ETC___d5306 =
	     dp1_bml_fabBuf_value == dp1_bml_fabBuf_modulus ;
  assign dp1_bml_fabFlowAddr_006_PLUS_dp1_bml_fabFlowSi_ETC___d4447 =
	     dp1_bml_fabFlowAddr + dp1_bml_fabFlowSize ;
  assign dp1_bml_lclBufDone_991_AND_IF_dp1_bml_dpContro_ETC___d4541 =
	     dp1_bml_lclBufDone &&
	     CASE_dp1_dpControl_BITS_1_TO_0_NOT_dp1_bml_fab_ETC__q30 ;
  assign dp1_bml_lclBuf_value_904_EQ_dp1_bml_lclBuf_mod_ETC___d5319 =
	     dp1_bml_lclBuf_value == dp1_bml_lclBuf_modulus ;
  assign dp1_bml_remBuf_value_919_EQ_dp1_bml_remBuf_mod_ETC___d5320 =
  ...
  assign dp1_bram_serverAdapterA_1_cnt_368_PLUS_IF_dp1__ETC___d2374 =
		...
		3'd7 :
		3'd0) ;
  assign dp1_bram_serverAdapterA_1_cnt_368_SLT_3___d5073 =
  ...
  assign dp1_bram_serverAdapterA_2_cnt_486_PLUS_IF_dp1__ETC___d2492 =
		...
		3'd7 :
		3'd0) ;
  assign dp1_bram_serverAdapterA_2_cnt_486_SLT_3___d5074 =
  ...
  assign dp1_bram_serverAdapterA_3_cnt_604_PLUS_IF_dp1__ETC___d2610 =
		...
		3'd7 :
		3'd0) ;
  assign dp1_bram_serverAdapterA_3_cnt_604_SLT_3___d5075 =
  ...
  assign dp1_bram_serverAdapterA_cnt_250_SLT_3___d5072 =
  ...
  assign dp1_tlp_mReqF_i_notEmpty__167_AND_IF_dp1_tlp_m_ETC___d3183 =
	     dp1_tlp_mReqF$EMPTY_N &&
	     CASE_dp1_tlp_mReqFD_OUT_BITS_51_TO_50_NOT_dp1_ETC__q27 ;
  assign dp1_tlp_mRespF_first__887_BITS_71_TO_62_978_ULE_1___d4493 =
	     dp1_tlp_mRespF$D_OUT[71:62] <= 10'd1 ;
  assign dp1_tlp_outDwRemain_004_ULE_4___d4722 =
	     dp1_tlp_outDwRemain <= 10'd4 ;
  ...
  assign dp1_tlp_writeRemainDWLen_203_ULE_1___d4494 =
	     dp1_tlp_writeRemainDWLen <= 10'd1 ;
  assign dp1_tlp_writeRemainDWLen_203_ULE_2___d4461 =
	     dp1_tlp_writeRemainDWLen <= 10'd2 ;
  assign dp1_tlp_writeRemainDWLen_203_ULE_3___d4471 =
  ...
  assign dp1_wmi_dpControl_whas__698_AND_dp1_bram_serve_ETC___d3744 =
	     ...
	     (dp1_bram_serverAdapterB_1_outDataCore$EMPTY_N ||
	      dp1_bram_serverAdapterB_1_outData_enqData$whas) &&
	     dp1_bram_serverAdapterB_1_outData_outData_whas_ETC___d3740 ;
  assign idx__h130033 = 2'd0 - dp1_tlp_writeDWAddr[1:0] ;
  assign idx__h132256 = 2'd1 - dp1_tlp_writeDWAddr[1:0] ;
  assign idx__h133552 = 2'd2 - dp1_tlp_writeDWAddr[1:0] ;
  assign idx__h134848 = 2'd3 - dp1_tlp_writeDWAddr[1:0] ;
  assign idx__h137096 = 2'd0 - dp1_tlp_readNxtDWAddr[1:0] ;
  assign idx__h137564 = 2'd1 - dp1_tlp_readNxtDWAddr[1:0] ;
  assign idx__h137937 = 2'd2 - dp1_tlp_readNxtDWAddr[1:0] ;
  assign idx__h138310 = 2'd3 - dp1_tlp_readNxtDWAddr[1:0] ;
  assign idx__h52640 = 2'd0 - dp0_tlp_writeDWAddr[1:0] ;
  assign idx__h54863 = 2'd1 - dp0_tlp_writeDWAddr[1:0] ;
  assign idx__h56159 = 2'd2 - dp0_tlp_writeDWAddr[1:0] ;
  assign idx__h57455 = 2'd3 - dp0_tlp_writeDWAddr[1:0] ;
  assign idx__h59703 = 2'd0 - dp0_tlp_readNxtDWAddr[1:0] ;
  assign idx__h60171 = 2'd1 - dp0_tlp_readNxtDWAddr[1:0] ;
  assign idx__h60544 = 2'd2 - dp0_tlp_readNxtDWAddr[1:0] ;
  assign idx__h60917 = 2'd3 - dp0_tlp_readNxtDWAddr[1:0] ;
  assign lastBE__h113817 =
	     dp1_tlp_mRespF_first__887_BITS_71_TO_62_978_ULE_1___d4493 ?
	       4'd0 :
	       4'd15 ;
  assign lastBE__h47155 =
	     (thisRequestLength__h46853[11:2] == 10'd1) ? 4'd0 : 4'd15 ;
  assign lowAddr__h139211 =
	     { dp1_tlp_readReq$D_OUT[33:29], lowAddr10__h139210 } ;
  assign lowAddr__h61818 =
	     { dp0_tlp_readReq$D_OUT[33:29], lowAddr10__h61817 } ;
  assign mesgMeta_opcode__h155411 = MUX_dp1_bram_memory_1$b_put_3__VAL_4 ;
  assign mesgMeta_opcode__h78018 = MUX_dp0_bram_memory_1$b_put_3__VAL_4 ;
  assign nowLS__h110175 =
	     { dp1_tlp_mRespF$D_OUT[39:32],
	       dp1_tlp_mRespF$D_OUT[47:40],
	       dp1_tlp_mRespF$D_OUT[55:48],
	       dp1_tlp_mRespF$D_OUT[63:56] } ;
  assign nowLS__h43641 =
	     { dp0_tlp_inF$D_OUT[39:32],
	       dp0_tlp_inF$D_OUT[47:40],
	       dp0_tlp_inF$D_OUT[55:48],
	       dp0_tlp_inF$D_OUT[63:56] } ;
  assign nowMS__h110174 =
	     { dp1_tlp_mRespF$D_OUT[71:64],
	       dp1_tlp_mRespF$D_OUT[79:72],
	       dp1_tlp_mRespF$D_OUT[87:80],
	       dp1_tlp_mRespF$D_OUT[95:88] } ;
  assign nowMS__h43640 =
	     { dp0_tlp_inF$D_OUT[71:64],
	       dp0_tlp_inF$D_OUT[79:72],
	       dp0_tlp_inF$D_OUT[87:80],
	       dp0_tlp_inF$D_OUT[95:88] } ;
  assign opcode__h110173 =
	     { dp1_tlp_mRespF$D_OUT[103:96],
	       dp1_tlp_mRespF$D_OUT[111:104],
	       dp1_tlp_mRespF$D_OUT[119:112],
	       dp1_tlp_mRespF$D_OUT[127:120] } ;
  assign opcode__h43639 =
  ...
  assign rdat__h164000 = { 16'd0, dp1_bml_lclNumBufs } ;
  assign rdat__h164008 = { 16'd0, dp1_bml_fabNumBufs } ;
  assign rdat__h164016 = { 16'd0, dp1_bml_mesgBase } ;
  assign rdat__h164024 = { 16'd0, dp1_bml_metaBase } ;
  assign rdat__h164032 = { 16'd0, dp1_bml_mesgSize } ;
  assign rdat__h164040 = { 16'd0, dp1_bml_metaSize } ;
  assign rdat__h164048 = { 16'd0, dp1_bml_lclBufsCF } ;
  assign rdat__h164069 = { dp1_bml_lclBufsAR, dp1_bml_fabBufsAvail } ;
  assign rdat__h164074 = { dp1_bml_remBuf_value, dp1_bml_lclBuf_value } ;
  assign rdat__h164085 = { dp1_bml_lclStarts, dp1_bml_lclDones } ;
  assign rdat__h164090 = { dp1_bml_remStarts, dp1_bml_remDones } ;
  assign rdat__h164151 = { 28'd0, dp1_dpControl } ;
  assign rdat__h86610 = { 16'd0, dp0_bml_lclNumBufs } ;
  assign rdat__h86618 = { 16'd0, dp0_bml_fabNumBufs } ;
  assign rdat__h86626 = { 16'd0, dp0_bml_mesgBase } ;
  assign rdat__h86634 = { 16'd0, dp0_bml_metaBase } ;
  assign rdat__h86642 = { 16'd0, dp0_bml_mesgSize } ;
  assign rdat__h86650 = { 16'd0, dp0_bml_metaSize } ;
  assign rdat__h86658 = { 16'd0, dp0_bml_lclBufsCF } ;
  assign rdat__h86679 = { dp0_bml_lclBufsAR, dp0_bml_fabBufsAvail } ;
  assign rdat__h86684 = { dp0_bml_remBuf_value, dp0_bml_lclBuf_value } ;
  assign rdat__h86695 = { dp0_bml_lclStarts, dp0_bml_lclDones } ;
  assign rdat__h86700 = { dp0_bml_remStarts, dp0_bml_remDones } ;
  assign rdat__h86761 = { 28'd0, dp0_dpControl } ;
  assign rdata__h144578 =
	     dp1_tlp_readNxtDWAddr[1] ?
	       IF_dp1_tlp_readNxtDWAddr_379_BIT_0_550_THEN_dp_ETC___d3555 :
	       IF_dp1_tlp_readNxtDWAddr_379_BIT_0_550_THEN_dp_ETC___d3560 ;
  assign rdata__h67185 =
	     dp0_tlp_readNxtDWAddr[1] ?
	       IF_dp0_tlp_readNxtDWAddr_364_BIT_0_535_THEN_dp_ETC___d1540 :
	       IF_dp0_tlp_readNxtDWAddr_364_BIT_0_535_THEN_dp_ETC___d1545 ;
  assign rreq_tag__h113618 =
	     (y__h113429 == dp1_tlp_mesgLengthRemainPush) ? 8'h01 : 8'h0 ;
  assign rresp_data__h139254 =
	     { IF_dp1_tlp_readReq_first__427_BITS_30_TO_29_42_ETC___d4580[7:0],
	       IF_dp1_tlp_readReq_first__427_BITS_30_TO_29_42_ETC___d4580[15:8],
	       IF_dp1_tlp_readReq_first__427_BITS_30_TO_29_42_ETC___d4580[23:16],
	       IF_dp1_tlp_readReq_first__427_BITS_30_TO_29_42_ETC___d4580[31:24] } ;
  assign rresp_data__h61861 =
	     { IF_dp0_tlp_readReq_first__412_BITS_30_TO_29_41_ETC___d4575[7:0],
	       IF_dp0_tlp_readReq_first__412_BITS_30_TO_29_41_ETC___d4575[15:8],
	       IF_dp0_tlp_readReq_first__412_BITS_30_TO_29_41_ETC___d4575[23:16],
	       IF_dp0_tlp_readReq_first__412_BITS_30_TO_29_41_ETC___d4575[31:24] } ;
  assign spanToNextPage__h113388 =
	     13'd4096 - { 1'd0, dp1_tlp_srcMesgAccu[11:0] } ;
  assign spanToNextPage__h46852 =
	     13'd4096 - { 1'd0, dp0_tlp_fabMesgAccu[11:0] } ;
  assign tag__h47128 = { 3'd0, dp0_tlp_dmaTag } ;
  assign tagm__h47254 = { 3'd0, dp0_tlp_dmaReqTag } ;
  assign thisRequestLength__h113389 =
	     (x__h113442[12:0] <= spanToNextPage__h113388) ?
	       x__h113442[12:0] :
	       spanToNextPage__h113388 ;
  assign thisRequestLength__h46853 =
	     (x__h46886[12:0] <= spanToNextPage__h46852) ?
	       x__h46886[12:0] :
	       spanToNextPage__h46852 ;
  ...
  assign w_data__h115834 =
	     { dp1_tlp_fabMeta[71:64],
	       ...
	       32'b0 } ;
  assign w_data__h125840 =
	     { 32'd1073745921,
	       pciDevice[15:3],
	       19'd65551,
	       dp1_tlp_fabFlowAddr,
	       32'd16777216 } ;
  assign w_data__h41361 =
	     { 32'd4100,
	       pciDevice[15:3],
	       3'd0,
	       tag__h47128,
	       ...
	       34'd0 } ;
  assign w_data__h47134 =
	     { 22'd4,
	       thisRequestLength__h46853[11:2],
	       pciDevice[15:3],
	       3'd0,
	       tag__h47128,
	       lastBE__h47155,
	       ...
	       34'd0 } ;
  assign w_data__h48448 =
	     { 32'd1073745921,
	       pciDevice[15:3],
	       19'd15,
	       dp0_tlp_fabFlowAddr,
	       32'd16777216 } ;
  assign x3__h155371 = MUX_dp1_bram_memory$b_put_3__VAL_4 ;
  assign x3__h77978 = MUX_dp0_bram_memory$b_put_3__VAL_4 ;
  assign x__h110236 = { 15'd0, dp1_tlp_mesgLengthRemainPush } ;
  assign x__h113442 =
	     (dp1_tlp_mesgLengthRemainPush <= y__h113444) ?
	       dp1_tlp_mesgLengthRemainPush :
	       y__h113444 ;
  assign x__h113944 = { dp1_tlp_mRespF$D_OUT[69:62], 2'd0 } ;
  assign x__h139323 = x__h139325 - y__h139326 ;
  assign x__h139325 = { dp1_tlp_readReq$D_OUT[28:19], 2'b0 } ;
  assign x__h161152 =
	     (dp1_dpControl[1:0] == 2'd1) ? dp1_bml_fabNumBufs : 16'd0 ;
  assign x__h162276 = dp1_bml_lclBufsAR + 16'd1 ;
  assign x__h162281 = dp1_bml_lclBufsAR - 16'd1 ;
  assign x__h162353 = dp1_bml_lclBufsCF + 16'd1 ;
  assign x__h162358 = dp1_bml_lclBufsCF - 16'd1 ;
  assign x__h162395 = dp1_bml_fabBufsAvail + 16'd1 ;
  assign x__h162400 = dp1_bml_fabBufsAvail - 16'd1 ;
  assign x__h162433 = dp1_bml_lclCredit + 16'd1 ;
  assign x__h162438 = dp1_bml_lclCredit - 16'd1 ;
  assign x__h43671 = { 15'd0, dp0_tlp_mesgLengthRemainPull } ;
  assign x__h46886 =
	     (dp0_tlp_mesgLengthRemainPull <= y__h46888) ?
	       dp0_tlp_mesgLengthRemainPull :
	       y__h46888 ;
  assign x__h47463 = { dp0_tlp_inF$D_OUT[103:96], 2'd0 } ;
  assign x__h48141 = { dp0_tlp_dmaPullRemainDWSub[7:0], 2'd0 } ;
  assign x__h61930 = x__h61932 - y__h61933 ;
  assign x__h61932 = { dp0_tlp_readReq$D_OUT[28:19], 2'b0 } ;
  assign x__h83762 =
	     (dp0_dpControl[1:0] == 2'd1) ? dp0_bml_fabNumBufs : 16'd0 ;
  assign x__h84886 = dp0_bml_lclBufsAR + 16'd1 ;
  assign x__h84891 = dp0_bml_lclBufsAR - 16'd1 ;
  assign x__h84963 = dp0_bml_lclBufsCF + 16'd1 ;
  assign x__h84968 = dp0_bml_lclBufsCF - 16'd1 ;
  assign x__h85005 = dp0_bml_fabBufsAvail + 16'd1 ;
  assign x__h85010 = dp0_bml_fabBufsAvail - 16'd1 ;
  assign x__h85043 = dp0_bml_lclCredit + 16'd1 ;
  assign x__h85048 = dp0_bml_lclCredit - 16'd1 ;
  assign y__h113429 = { 4'd0, thisRequestLength__h113389 } ;
  assign y__h113444 = { 4'd0, dp1_tlp_maxPayloadSize } ;
  assign y__h113523 = { 19'd0, thisRequestLength__h113389 } ;
  assign y__h113571 = { 3'd0, thisRequestLength__h113389 } ;
  assign y__h113941 = { 22'd0, x__h113944 } ;
  assign y__h139324 =
	     (dp1_tlp_readReq$D_OUT[28:19] == 10'd1) ?
	       12'd0 :
	       { 10'd0, x__h139355 } ;
  assign y__h139326 = { 10'd0, x__h139332 } ;
  assign y__h46878 = { 4'd0, thisRequestLength__h46853 } ;
  assign y__h46888 = { 4'd0, dp0_tlp_maxReadReqSize } ;
  assign y__h46949 = { 19'd0, thisRequestLength__h46853 } ;
  assign y__h47460 = { 6'd0, x__h47463 } ;
  assign y__h48138 =
	     dp0_tlp_dmaPullRemainDWSub_028_ULE_4___d5067 ?
	       { 7'd0, x__h48141 } :
	       17'd16 ;
  assign y__h61931 =
	     (dp0_tlp_readReq$D_OUT[28:19] == 10'd1) ?
	       12'd0 :
	       { 10'd0, x__h61962 } ;
  assign y__h61933 = { 10'd0, x__h61939 } ;
  assign y_avValue__h156967 = dp1_bram_serverAdapterB_outData_outData$wget ;
  assign y_avValue__h156987 = dp1_bram_serverAdapterB_1_outData_outData$wget ;
  assign y_avValue__h157007 = dp1_bram_serverAdapterB_2_outData_outData$wget ;
  assign y_avValue__h157027 = dp1_bram_serverAdapterB_3_outData_outData$wget ;
  assign y_avValue__h79574 = dp0_bram_serverAdapterB_outData_outData$wget ;
  assign y_avValue__h79594 = dp0_bram_serverAdapterB_1_outData_outData$wget ;
  assign y_avValue__h79614 = dp0_bram_serverAdapterB_2_outData_outData$wget ;
  assign y_avValue__h79634 = dp0_bram_serverAdapterB_3_outData_outData$wget ;
  always@(dp0_tlp_readReq$D_OUT)
  begin
    case (dp0_tlp_readReq$D_OUT[18:15])
      4'b1100: x__h61939 = 2'b10;
      4'b1110: x__h61939 = 2'b01;
      4'b1111: x__h61939 = 2'b0;
      default: x__h61939 = 2'b11;
    endcase
  end
  always@(dp0_tlp_readReq$D_OUT)
  begin
    case (dp0_tlp_readReq$D_OUT[14:11])
      4'b1100: x__h61962 = 2'b10;
      4'b1110: x__h61962 = 2'b01;
      4'b1111: x__h61962 = 2'b0;
      default: x__h61962 = 2'b11;
    endcase
  end
  always@(dp1_tlp_readReq$D_OUT)
  begin
    case (dp1_tlp_readReq$D_OUT[18:15])
      4'b1100: x__h139332 = 2'b10;
      4'b1110: x__h139332 = 2'b01;
      4'b1111: x__h139332 = 2'b0;
      default: x__h139332 = 2'b11;
    endcase
  end
  always@(dp1_tlp_readReq$D_OUT)
  begin
    case (dp1_tlp_readReq$D_OUT[14:11])
      4'b1100: x__h139355 = 2'b10;
      4'b1110: x__h139355 = 2'b01;
      4'b1111: x__h139355 = 2'b0;
      default: x__h139355 = 2'b11;
    endcase
  end
  always@(dp0_wmi_p4B or
	  y_avValue__h79634 or
	  y_avValue__h79574 or y_avValue__h79594 or y_avValue__h79614)
  begin
    case (dp0_wmi_p4B)
      2'd0: rdata__h79738 = y_avValue__h79574;
      2'd1: rdata__h79738 = y_avValue__h79594;
      2'd2: rdata__h79738 = y_avValue__h79614;
      2'd3: rdata__h79738 = y_avValue__h79634;
    endcase
  end
  always@(dp1_wmi_p4B or
	  y_avValue__h157027 or
	  y_avValue__h156967 or y_avValue__h156987 or y_avValue__h157007)
  begin
    case (dp1_wmi_p4B)
      2'd0: rdata__h157131 = y_avValue__h156967;
      2'd1: rdata__h157131 = y_avValue__h156987;
      2'd2: rdata__h157131 = y_avValue__h157007;
      2'd3: rdata__h157131 = y_avValue__h157027;
    endcase
  end
  always@(dp1_tlp_readReq$D_OUT)
  begin
    case (dp1_tlp_readReq$D_OUT[18:15])
      4'b1000: lowAddr10__h139210 = 2'b11;
      4'b1100: lowAddr10__h139210 = 2'b10;
      4'b1110: lowAddr10__h139210 = 2'b01;
      default: lowAddr10__h139210 = 2'b0;
    endcase
  end
  always@(dp0_tlp_readReq$D_OUT)
  begin
    case (dp0_tlp_readReq$D_OUT[18:15])
      4'b1000: lowAddr10__h61817 = 2'b11;
      4'b1100: lowAddr10__h61817 = 2'b10;
      4'b1110: lowAddr10__h61817 = 2'b01;
      default: lowAddr10__h61817 = 2'b0;
    endcase
  end
  always@(dp0_wci_reqF$D_OUT or
	  ...
	  dp0_bml_fabFlowBase or dp0_bml_fabFlowSize or rdat__h86761)
  begin
    case (dp0_wci_reqF$D_OUT[39:32])
      8'h0: _theResult____h86531 = rdat__h86610;
      8'h04: _theResult____h86531 = rdat__h86618;
      8'h08: _theResult____h86531 = rdat__h86626;
      8'h0C: _theResult____h86531 = rdat__h86634;
      8'h10: _theResult____h86531 = rdat__h86642;
      8'h14: _theResult____h86531 = rdat__h86650;
      8'h20: _theResult____h86531 = rdat__h86658;
      8'h24: _theResult____h86531 = 32'hF00DFACE;
      8'h28: _theResult____h86531 = rdat__h86679;
      8'h2C: _theResult____h86531 = rdat__h86684;
      8'h30: _theResult____h86531 = rdat__h86695;
      8'h34: _theResult____h86531 = rdat__h86700;
      8'h48: _theResult____h86531 = 32'hDADEBABE;
      8'h4C: _theResult____h86531 = 32'h00008000;
      8'h50: _theResult____h86531 = dp0_bml_fabMesgBase;
      8'h54: _theResult____h86531 = dp0_bml_fabMetaBase;
      8'h58: _theResult____h86531 = dp0_bml_fabMesgSize;
      8'h5C: _theResult____h86531 = dp0_bml_fabMetaSize;
      8'h60: _theResult____h86531 = dp0_bml_fabFlowBase;
      8'h64: _theResult____h86531 = dp0_bml_fabFlowSize;
      8'h68: _theResult____h86531 = rdat__h86761;
      default: _theResult____h86531 = 32'd0;
    endcase
  end
  always@(dp1_wci_reqF$D_OUT or
	  ...
	  dp1_bml_fabFlowBase or dp1_bml_fabFlowSize or rdat__h164151)
  begin
    case (dp1_wci_reqF$D_OUT[39:32])
      8'h0: _theResult____h163921 = rdat__h164000;
      8'h04: _theResult____h163921 = rdat__h164008;
      8'h08: _theResult____h163921 = rdat__h164016;
      8'h0C: _theResult____h163921 = rdat__h164024;
      8'h10: _theResult____h163921 = rdat__h164032;
      8'h14: _theResult____h163921 = rdat__h164040;
      8'h20: _theResult____h163921 = rdat__h164048;
      8'h24: _theResult____h163921 = 32'hF00DFACE;
      8'h28: _theResult____h163921 = rdat__h164069;
      8'h2C: _theResult____h163921 = rdat__h164074;
      8'h30: _theResult____h163921 = rdat__h164085;
      8'h34: _theResult____h163921 = rdat__h164090;
      8'h48: _theResult____h163921 = 32'hDADEBABE;
      8'h4C: _theResult____h163921 = 32'h00008000;
      8'h50: _theResult____h163921 = dp1_bml_fabMesgBase;
      8'h54: _theResult____h163921 = dp1_bml_fabMetaBase;
      8'h58: _theResult____h163921 = dp1_bml_fabMesgSize;
      8'h5C: _theResult____h163921 = dp1_bml_fabMetaSize;
      8'h60: _theResult____h163921 = dp1_bml_fabFlowBase;
      8'h64: _theResult____h163921 = dp1_bml_fabFlowSize;
      8'h68: _theResult____h163921 = rdat__h164151;
      default: _theResult____h163921 = 32'd0;
    endcase
  end
  ...
  always@(idx__h52640 or
	  dp0_tlp_writeRemainDWLen_188_ULE_3___d4492 or
	  dp0_tlp_writeRemainDWLen or
	  dp0_tlp_writeRemainDWLen_188_ULE_1___d4491 or
	  dp0_tlp_writeRemainDWLen_188_ULE_2___d4460)
  begin
    case (idx__h52640)
      2'd0:
  ...
  always@(idx__h130033 or
	  dp1_tlp_writeRemainDWLen_203_ULE_3___d4471 or
	  dp1_tlp_writeRemainDWLen or
	  dp1_tlp_writeRemainDWLen_203_ULE_1___d4494 or
	  dp1_tlp_writeRemainDWLen_203_ULE_2___d4461)
  begin
    case (idx__h130033)
      2'd0:
  ...
  always@(dp0_tlp_mReqF$D_OUT or
	  dp0_bram_serverAdapterA_3_cnt_86_SLT_3___d5071 or
	  dp0_bram_serverAdapterA_cnt_32_SLT_3___d5068 or
	  dp0_bram_serverAdapterA_1_cnt_50_SLT_3___d5069 or
	  dp0_bram_serverAdapterA_2_cnt_68_SLT_3___d5070)
  begin
  ...
  always@(dp1_tlp_mReqF$D_OUT or
	  dp1_bram_serverAdapterA_3_cnt_604_SLT_3___d5075 or
	  dp1_bram_serverAdapterA_cnt_250_SLT_3___d5072 or
	  dp1_bram_serverAdapterA_1_cnt_368_SLT_3___d5073 or
	  dp1_bram_serverAdapterA_2_cnt_486_SLT_3___d5074)
  begin
  ...
  always@(idx__h52640 or dp0_tlp_mReqF$D_OUT)
  begin
    case (idx__h52640)
      2'd0:
	  IF_0_MINUS_dp0_tlp_writeDWAddr_184_BITS_1_TO_0_ETC___d4571 =
  ...
  always@(idx__h54863 or dp0_tlp_mReqF$D_OUT)
  begin
    case (idx__h54863)
      2'd0:
	  IF_1_MINUS_dp0_tlp_writeDWAddr_184_BITS_1_TO_0_ETC___d4572 =
  ...
  always@(idx__h56159 or dp0_tlp_mReqF$D_OUT)
  begin
    case (idx__h56159)
      2'd0:
	  IF_2_MINUS_dp0_tlp_writeDWAddr_184_BITS_1_TO_0_ETC___d4573 =
  ...
  always@(idx__h57455 or dp0_tlp_mReqF$D_OUT)
  begin
    case (idx__h57455)
      2'd0:
	  IF_3_MINUS_dp0_tlp_writeDWAddr_184_BITS_1_TO_0_ETC___d4574 =
  ...
  always@(idx__h130033 or dp1_tlp_mReqF$D_OUT)
  begin
    case (idx__h130033)
      2'd0:
	  IF_0_MINUS_dp1_tlp_writeDWAddr_199_BITS_1_TO_0_ETC___d4576 =
  ...
  always@(idx__h132256 or dp1_tlp_mReqF$D_OUT)
  begin
    case (idx__h132256)
      2'd0:
	  IF_1_MINUS_dp1_tlp_writeDWAddr_199_BITS_1_TO_0_ETC___d4577 =
  ...
  always@(idx__h133552 or dp1_tlp_mReqF$D_OUT)
  begin
    case (idx__h133552)
      2'd0:
	  IF_2_MINUS_dp1_tlp_writeDWAddr_199_BITS_1_TO_0_ETC___d4578 =
  ...
  always@(idx__h134848 or dp1_tlp_mReqF$D_OUT)
  begin
    case (idx__h134848)
      2'd0:
	  IF_3_MINUS_dp1_tlp_writeDWAddr_199_BITS_1_TO_0_ETC___d4579 =
  ...
  begin
    ...
    if (cp$RST_N_wci_Vm_13)
      if (WILL_FIRE_RL_dp0_tlp_dmaXmtDoorbell)
	$display("[%0d]: %m: dmaXmtDoorbell FC/FPactFlow-Step1/1", v__h41091);
    if (cp$RST_N_wci_Vm_13)
      if (pciw_p125rst$OUT_RST_N)
    ...
    if (cp$RST_N_wci_Vm_13)
      if (pciw_p125rst$OUT_RST_N)
	if (WILL_FIRE_RL_dp0_tlp_dmaTailEventSender)
	  $display("[%0d]: %m: dmaTailEventSender - generic", v__h49316);
    if (cp$RST_N_wci_Vm_13)
      if (pciw_p125rst$OUT_RST_N)
    ...
    if (cp$RST_N_wci_Vm_13)
      if (WILL_FIRE_RL_dp0_tlp_dmaPullTailEvent)
	$display("[%0d]: %m: dmaPullTailEvent FPactMesg-Step5/5", v__h48361);
    if (cp$RST_N_wci_Vm_13)
    ...
    if (cp$RST_N_wci_Vm_13)
      if (WILL_FIRE_RL_dp0_wci_cfwr && dp0_wci_reqF$D_OUT[39:32] == 8'h18)
	$display("[%0d] %m: fabDoneAvail Event", v__h86019);
    if (cp$RST_N_wci_Vm_13)
    ...
    if (cp$RST_N_wci_Vm_14)
      if (pciw_p125rst$OUT_RST_N)
	if (WILL_FIRE_RL_dp1_tlp_dmaXmtMetaHead)
	  $display("[%0d]: %m: dmaXmtMetaHead FPactMesg-Step5/7", v__h115666);
    if (cp$RST_N_wci_Vm_14)
    ...
    if (cp$RST_N_wci_Vm_14)
      if (WILL_FIRE_RL_dp1_tlp_dmaXmtMetaBody)
	$display("[%0d]: %m: dmaXmtMetaBody FPactMesg-Step6/7", v__h118400);
    if (cp$RST_N_wci_Vm_14)
    ...
    if (cp$RST_N_wci_Vm_14)
      if (WILL_FIRE_RL_dp1_tlp_dmaXmtTailEvent)
	$display("[%0d]: %m: dmaXmtTailEvent FPactMesg-Step7/7", v__h118585);
    if (cp$RST_N_wci_Vm_14)
      if (pciw_p125rst$OUT_RST_N)
    ...
    if (cp$RST_N_wci_Vm_14)
      if (pciw_p125rst$OUT_RST_N)
	if (WILL_FIRE_RL_dp1_tlp_dmaTailEventSender)
	  $display("[%0d]: %m: dmaTailEventSender - generic", v__h126708);
    if (cp$RST_N_wci_Vm_14)
    ...
    if (cp$RST_N_wci_Vm_14)
      if (WILL_FIRE_RL_dp1_wci_cfwr && dp1_wci_reqF$D_OUT[39:32] == 8'h18)
	$display("[%0d] %m: fabDoneAvail Event", v__h163409);
    if (cp$RST_N_wci_Vm_14)
