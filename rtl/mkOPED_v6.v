...
//
// On Tue Feb  8 14:19:35 EST 2011
//
//
// Ports:
// Name                         I/O  size props
...
// axisM_TDATA                    O    32 const
// axisM_TSTRB                    O     4 const
// axisM_TUSER                    O    32 const
...
// axi4m_RRESP                    I     2 reg
// axisS_TDATA                    I    32 unused
// axisS_TSTRB                    I     4 unused
// axisS_TUSER                    I     8 unused
// axi4m_AWREADY                  I     1
// axi4m_WREADY                   I     1
// axi4m_BVALID                   I     1
// axi4m_ARREADY                  I     1
...
module mkOPED_v6(pci0_clkp,
  ...
  reg [63 : 0] v__h103575,
	       ...
	       v__h86235,
	       v__h86389;
  reg [31 : 0] IF_0_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d4695,
	       IF_0_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d4699,
	       IF_1_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d4498,
	       IF_1_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d4700,
	       IF_2_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d4696,
	       IF_2_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d4701,
	       IF_3_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d4697,
	       IF_3_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d4702,
	       IF_dp0_tlp_readReq_first__424_BITS_30_TO_29_42_ETC___d4698,
	       IF_dp1_tlp_readReq_first__455_BITS_30_TO_29_45_ETC___d4703,
	       _theResult____h163605,
	       _theResult____h86373,
	       rdata__h156815,
	       rdata__h79580;
  reg [15 : 0] CASE_dp0_tlp_outDwRemain_BITS_1_TO_0_0xFFF0_0b_ETC__q23,
	       CASE_dp1_tlp_outDwRemain_BITS_1_TO_0_0xFFF0_0b_ETC__q24;
  reg [1 : 0] lowAddr10__h138892,
	      lowAddr10__h61657,
	      x__h139014,
	      x__h139037,
	      x__h61779,
	      x__h61802;
  reg CASE_dp0_dpControl_BITS_1_TO_0_NOT_dp0_bml_fab_ETC__q16,
      ...
      CASE_dp0_wmi_p4B_NOT_dp0_wmi_p4B_EQ_3_OR_dp0_b_ETC__q17,
      ...
      IF_0_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d4562,
      IF_0_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d3238,
      IF_0_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d4587,
      IF_1_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d1217,
      IF_1_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d4595,
      IF_1_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d3248,
      IF_1_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d4588,
      IF_2_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d1227,
      IF_2_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d4594,
      IF_2_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d3258,
      IF_2_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d4589,
      ...
      IF_dp0_wmi_addr_802_BITS_3_TO_2_803_EQ_0_804_T_ETC___d4650,
      ...
      IF_dp1_wmi_addr_833_BITS_3_TO_2_834_EQ_0_835_T_ETC___d4651,
  ...
  wire [127 : 0] IF_dp0_tlp_readNxtDWAddr_376_BIT_0_553_THEN_dp_ETC___d1558,
		 ...
		 w_data__h46972,
		 w_data__h48286;
  wire [31 : 0] dp0_bml_fabFlowAddr_009_PLUS_dp0_bml_fabFlowSi_ETC___d4624,
		dp1_bml_fabFlowAddr_040_PLUS_dp1_bml_fabFlowSi_ETC___d4626,
		mesgMeta_opcode__h155095,
		mesgMeta_opcode__h77860,
		nowLS__h109853,
		nowLS__h43479,
		nowMS__h109852,
		nowMS__h43478,
  ...
  wire [12 : 0] dp0_tlp_readNxtDWAddr_PLUS_1__q10,
		...
		dp1_tlp_writeDWAddr_PLUS_1__q7,
		dp1_tlp_writeDWAddr_PLUS_2__q8,
		dp1_tlp_writeDWAddr_PLUS_3__q6,
		spanToNextPage__h113066,
		spanToNextPage__h46690,
		thisRequestLength__h113067,
		thisRequestLength__h46691;
  wire [11 : 0] byteCount__h138894,
		byteCount__h61659,
		x__h139005,
		x__h139007,
		x__h61770,
		...
		y__h61771,
		y__h61773;
  wire [9 : 0] x__h113622, x__h47301, x__h47979;
  wire [7 : 0] rreq_tag__h113296, tag__h46966, tagm__h47092;
  wire [6 : 0] lowAddr__h138893, lowAddr__h61658;
  wire [3 : 0] lastBE__h113495, lastBE__h46993;
  ...
  wire IF_1_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d1240,
       ...
       _dfoo13,
       dp0_bml_crdBuf_value_952_EQ_dp0_bml_crdBuf_mod_ETC___d5212,
       dp0_bml_fabBuf_value_937_EQ_dp0_bml_fabBuf_mod_ETC___d5213,
       dp0_bml_lclBufDone_994_AND_IF_dp0_bml_dpContro_ETC___d4564,
       dp0_bml_lclBuf_value_907_EQ_dp0_bml_lclBuf_mod_ETC___d5228,
       dp0_bml_remBuf_value_922_EQ_dp0_bml_remBuf_mod_ETC___d5229,
       dp0_bram_serverAdapterA_1_cnt_50_SLT_3___d4497,
       dp0_bram_serverAdapterA_2_cnt_68_SLT_3___d5090,
       dp0_bram_serverAdapterA_2_outDataCore_notEmpty_ETC___d1518,
       dp0_bram_serverAdapterA_3_cnt_86_SLT_3___d5091,
       dp0_bram_serverAdapterA_cnt_32_SLT_3___d5089,
       ...
       dp0_tlp_dmaPullRemainDWLen_017_ULE_dp0_tlp_dma_ETC___d5087,
       dp0_tlp_dmaPullRemainDWSub_031_ULE_4___d5088,
       ...
       dp0_tlp_outDwRemain_142_ULE_4___d4503,
       dp0_tlp_rdRespDwRemain_508_ULE_4___d1509,
       dp0_tlp_readRemainDWLen_364_ULE_4___d1365,
       dp0_tlp_writeRemainDWLen_194_ULE_1___d4517,
       dp0_tlp_writeRemainDWLen_194_ULE_2___d4509,
       dp0_tlp_writeRemainDWLen_194_ULE_3___d4511,
       dp0_wmi_dpControl_whas__701_AND_dp0_bram_serve_ETC___d1747,
       dp1_bml_crdBuf_value_983_EQ_dp1_bml_crdBuf_mod_ETC___d5279,
       dp1_bml_fabBuf_value_968_EQ_dp1_bml_fabBuf_mod_ETC___d5280,
       dp1_bml_lclBufDone_025_AND_IF_dp1_bml_dpContro_ETC___d4611,
       dp1_bml_lclBuf_value_938_EQ_dp1_bml_lclBuf_mod_ETC___d5294,
       dp1_bml_remBuf_value_953_EQ_dp1_bml_remBuf_mod_ETC___d5295,
       dp1_bram_serverAdapterA_1_cnt_386_SLT_3___d5093,
       dp1_bram_serverAdapterA_2_cnt_504_SLT_3___d5094,
       dp1_bram_serverAdapterA_2_outDataCore_notEmpty_ETC___d3549,
       dp1_bram_serverAdapterA_3_cnt_622_SLT_3___d5095,
       dp1_bram_serverAdapterA_cnt_268_SLT_3___d5092,
       ...
       dp1_tlp_mRespF_first__905_BITS_71_TO_62_995_ULE_1___d4518,
       dp1_tlp_outDwRemain_021_ULE_4___d4803,
       dp1_tlp_rdRespDwRemain_539_ULE_4___d3540,
       dp1_tlp_readRemainDWLen_395_ULE_4___d3396,
       dp1_tlp_writeRemainDWLen_225_ULE_1___d4542,
       dp1_tlp_writeRemainDWLen_225_ULE_2___d4544,
       dp1_tlp_writeRemainDWLen_225_ULE_3___d4512,
  ...
  // value method axisM_mTDATA
  assign axisM_TDATA = 32'hAAAAAAAA ;

  // value method axisM_mTSTRB
  assign axisM_TSTRB = 4'hA ;

  // value method axisM_mTUSER
  assign axisM_TUSER = 32'hAAAAAAAA ;
  ...
  // submodule axis2wsi
  mkAXIStoWSI4B axis2wsi(.CLK(pciw_pci0_pcie_ep$trn2_clk),
  ...
  // submodule wsi2axis
  mkWSItoAXIS4B wsi2axis(.CLK(pciw_pci0_pcie_ep$trn2_clk),
			 .RST_N(pciw_p125rst$OUT_RST_N),
  ...
  assign CAN_FIRE_RL_stbConnect_7 = wsi2axis$wsi_SThreadBusy ;
  assign WILL_FIRE_RL_stbConnect_7 = wsi2axis$wsi_SThreadBusy ;
  ...
  assign CAN_FIRE_RL_sRstConnect_1 = wsi2axis$wsi_SReset_n ;
  assign WILL_FIRE_RL_sRstConnect_1 = wsi2axis$wsi_SReset_n ;
  ...
  assign CAN_FIRE_RL_mReqLConnect_2 = axis2wsi$wsi_MReqLast ;
  assign WILL_FIRE_RL_mReqLConnect_2 = axis2wsi$wsi_MReqLast ;

  // rule RL_mBurstPConnect_1
  assign CAN_FIRE_RL_mBurstPConnect_1 = axis2wsi$wsi_MBurstPrecise ;
  assign WILL_FIRE_RL_mBurstPConnect_1 = axis2wsi$wsi_MBurstPrecise ;
  ...
  assign CAN_FIRE_RL_mRstConnect_2 = axis2wsi$wsi_MReset_n ;
  assign WILL_FIRE_RL_mRstConnect_2 = axis2wsi$wsi_MReset_n ;
  ...
  assign WILL_FIRE_RL_dp0_bml_remAdvance = CAN_FIRE_RL_dp0_bml_remAdvance ;
  ...
  assign CAN_FIRE_RL_dp0_bml_remBuf_ruleInc = CAN_FIRE_RL_dp0_bml_remAdvance ;
  ...
  assign MUX_dp0_bml_lclBufsAR$write_1__SEL_1 =
	     ...
	     (IF_dp0_bml_dpControl_wget__970_BITS_1_TO_0_976_ETC___d2047 &&
	      !dp0_bml_lclBufStart ||
	      CASE_dp0_dpControl_BITS_1_TO_0_NOT_dp0_bml_fab_ETC__q16 &&
	      dp0_bml_lclBufStart) ;
  ...
  assign MUX_dp0_bml_fabBufsAvail$write_1__VAL_1 =
	     (dp0_bml_fabAvail && !dp0_bml_remStart) ? x__h84847 : x__h84852 ;
  assign MUX_dp0_bml_fabBufsAvail$write_1__VAL_2 =
	     (dp0_dpControl[3:2] == 2'd1) ? x__h83604 : 16'd0 ;
  assign MUX_dp0_bml_fabFlowAddr$write_1__VAL_1 =
	     dp0_bml_fabBuf_value_937_EQ_dp0_bml_fabBuf_mod_ETC___d5213 ?
	       dp0_bml_fabFlowBase :
	       dp0_bml_fabFlowAddr_009_PLUS_dp0_bml_fabFlowSi_ETC___d4624 ;
  ...
  assign MUX_dp0_bram_memory$a_put_3__VAL_3 =
	     { IF_0_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d4695[7:0],
	       IF_0_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d4695[15:8],
	       IF_0_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d4695[23:16],
	       IF_0_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d4695[31:24] } ;
  ...
  assign MUX_dp0_bram_memory_2$a_put_3__VAL_3 =
	     { IF_2_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d4696[7:0],
	       IF_2_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d4696[15:8],
	       IF_2_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d4696[23:16],
	       IF_2_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d4696[31:24] } ;
  always@(idx__h57295 or
	  dp0_tlp_writeDWAddr_PLUS_3__q3 or
	  dp0_tlp_writeDWAddr or
	  dp0_tlp_writeDWAddr_PLUS_1__q4 or dp0_tlp_writeDWAddr_PLUS_2__q5)
  begin
  ...
  assign MUX_dp0_bram_memory_3$a_put_3__VAL_3 =
	     { IF_3_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d4697[7:0],
	       IF_3_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d4697[15:8],
	       IF_3_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d4697[23:16],
	       IF_3_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d4697[31:24] } ;
  ...
  assign MUX_dp0_tlp_mesgComplReceived$write_1__VAL_2 =
	     dp0_tlp_mesgComplReceived + y__h47976 ;
  ...
  assign MUX_dp0_tlp_mesgLengthRemainPull$write_1__VAL_2 =
	     dp0_tlp_mesgLengthRemainPull - y__h46716 ;
  ...
  assign MUX_dp0_tlp_outF$enq_1__VAL_1 = { 25'd25362416, w_data__h41197 } ;
  assign MUX_dp0_tlp_outF$enq_1__VAL_2 = { 25'd25362416, w_data__h46972 } ;
  assign MUX_dp0_tlp_outF$enq_1__VAL_3 = { 25'd25296895, w_data__h48286 } ;
  ...
  assign MUX_dp0_wmi_wmi_respF_q_0$write_1__VAL_2 = { 2'd1, rdata__h79580 } ;
  ...
  assign MUX_dp1_bml_fabBufsAvail$write_1__VAL_2 =
	     (dp1_dpControl[3:2] == 2'd1) ? x__h160836 : 16'd0 ;
  ...
  always@(idx__h129715 or
	  dp1_tlp_writeDWAddr_PLUS_3__q6 or
	  dp1_tlp_writeDWAddr or
	  dp1_tlp_writeDWAddr_PLUS_1__q7 or dp1_tlp_writeDWAddr_PLUS_2__q8)
  begin
    case (idx__h129715)
      2'd0: MUX_dp1_bram_memory$a_put_2__VAL_3 = dp1_tlp_writeDWAddr[12:2];
      2'd1:
	  MUX_dp1_bram_memory$a_put_2__VAL_3 =
	      dp1_tlp_writeDWAddr_PLUS_1__q7[12:2];
      2'd2:
	  MUX_dp1_bram_memory$a_put_2__VAL_3 =
	      dp1_tlp_writeDWAddr_PLUS_2__q8[12:2];
      2'd3:
	  MUX_dp1_bram_memory$a_put_2__VAL_3 =
	      dp1_tlp_writeDWAddr_PLUS_3__q6[12:2];
    endcase
  end
  always@(idx__h136778 or
  ...
  assign MUX_dp1_bram_memory$a_put_3__VAL_3 =
	     { IF_0_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d4699[7:0],
	       IF_0_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d4699[15:8],
	       IF_0_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d4699[23:16],
	       IF_0_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d4699[31:24] } ;
  ...
  assign MUX_dp1_bram_memory_1$a_put_3__VAL_3 =
	     { IF_1_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d4700[7:0],
	       IF_1_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d4700[15:8],
	       IF_1_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d4700[23:16],
	       IF_1_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d4700[31:24] } ;
  assign MUX_dp1_bram_memory_1$b_put_3__VAL_4 =
	     { 24'h800000, dp1_wmi_wmi_mFlagReg[31:24] } ;
  always@(idx__h133234 or
	  dp1_tlp_writeDWAddr_PLUS_3__q6 or
	  dp1_tlp_writeDWAddr or
	  dp1_tlp_writeDWAddr_PLUS_1__q7 or dp1_tlp_writeDWAddr_PLUS_2__q8)
  begin
  ...
  assign MUX_dp1_bram_memory_2$a_put_3__VAL_3 =
	     { IF_2_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d4701[7:0],
	       IF_2_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d4701[15:8],
	       IF_2_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d4701[23:16],
	       IF_2_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d4701[31:24] } ;
  always@(idx__h134530 or
	  dp1_tlp_writeDWAddr_PLUS_3__q6 or
	  dp1_tlp_writeDWAddr or
	  dp1_tlp_writeDWAddr_PLUS_1__q7 or dp1_tlp_writeDWAddr_PLUS_2__q8)
  begin
  ...
  assign MUX_dp1_bram_memory_3$a_put_3__VAL_3 =
	     { IF_3_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d4702[7:0],
	       IF_3_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d4702[15:8],
	       IF_3_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d4702[23:16],
	       IF_3_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d4702[31:24] } ;
  assign MUX_dp1_tlp_fabMesgAccu$write_1__VAL_2 =
	     dp1_tlp_fabMesgAccu + y__h113619 ;
  ...
  assign MUX_dp1_tlp_mReqF$enq_1__VAL_3 =
	     { 88'hAAAAAAAAAAAAAAAAAAFFF8,
	       ...
	       thisRequestLength__h113067[11:2],
	       8'd255,
	       rreq_tag__h113296,
	       3'h2 } ;
  ...
  assign MUX_dp1_tlp_mesgLengthRemainPush$write_1__VAL_2 =
	     dp1_tlp_mesgLengthRemainPush - y__h113107 ;
  ...
  assign MUX_dp1_tlp_outF$enq_1__VAL_1 =
	     { 1'd1,
	       ...
	       23'd196607,
	       w_data__h113471 } ;
  assign MUX_dp1_tlp_outF$enq_1__VAL_2 = { 25'd16973823, w_data__h114450 } ;
  assign MUX_dp1_tlp_outF$enq_1__VAL_3 = { 25'd8585200, w_data__h115512 } ;
  assign MUX_dp1_tlp_outF$enq_1__VAL_4 = { 25'd25296895, w_data__h125520 } ;
  ...
  assign MUX_dp1_tlp_remMesgAccu$write_1__VAL_2 =
	     dp1_tlp_remMesgAccu + y__h113249 ;
  assign MUX_dp1_tlp_srcMesgAccu$write_1__VAL_2 =
	     dp1_tlp_srcMesgAccu + y__h113201 ;
  ...
  assign MUX_dp1_wmi_wmi_respF_q_0$write_1__VAL_2 = { 2'd1, rdata__h156815 } ;
  ...
  assign dp0_bram_serverAdapterA_s1_1$wget =
	     { 1'd1, !ab__h12371[1] || ab__h12371[0] } ;
  ...
  assign dp0_bram_serverAdapterB_s1_1$wget =
	     { 1'd1, !ab__h13770[1] || ab__h13770[0] } ;
  ...
  assign dp0_bram_serverAdapterA_1_s1_1$wget =
	     { 1'd1, !ab__h15300[1] || ab__h15300[0] } ;
  ...
  assign dp0_bram_serverAdapterB_1_s1_1$wget =
	     { 1'd1, !ab__h16697[1] || ab__h16697[0] } ;
  ...
  assign dp0_bram_serverAdapterA_2_s1_1$wget =
	     { 1'd1, !ab__h18227[1] || ab__h18227[0] } ;
  ...
  assign dp0_bram_serverAdapterB_2_s1_1$wget =
	     { 1'd1, !ab__h19624[1] || ab__h19624[0] } ;
  ...
  assign dp0_bram_serverAdapterA_3_s1_1$wget =
	     { 1'd1, !ab__h21154[1] || ab__h21154[0] } ;
  ...
  assign dp0_bram_serverAdapterB_3_s1_1$wget =
	     { 1'd1, !ab__h22551[1] || ab__h22551[0] } ;
  ...
  assign dp0_tlp_pullTagMatch_1$wget =
	     tagm__h47092 == dp0_tlp_inF$D_OUT[47:40] &&
	     dp0_tlp_inF_first__02_BITS_63_TO_56_05_EQ_pciD_ETC___d914 ;
  ...
  assign dp1_bram_serverAdapterA_s1_1$wget =
	     { 1'd1, !ab__h89704[1] || ab__h89704[0] } ;
  ...
  assign dp1_bram_serverAdapterB_s1_1$wget =
	     { 1'd1, !ab__h91103[1] || ab__h91103[0] } ;
  ...
  assign dp1_bram_serverAdapterA_1_s1_1$wget =
	     { 1'd1, !ab__h92633[1] || ab__h92633[0] } ;
  ...
  assign dp1_bram_serverAdapterB_1_s1_1$wget =
	     { 1'd1, !ab__h94030[1] || ab__h94030[0] } ;
  ...
  assign dp1_bram_serverAdapterA_2_s1_1$wget =
	     { 1'd1, !ab__h95560[1] || ab__h95560[0] } ;
  ...
  assign dp1_bram_serverAdapterB_2_s1_1$wget =
	     { 1'd1, !ab__h96957[1] || ab__h96957[0] } ;
  ...
  assign dp1_bram_serverAdapterA_3_s1_1$wget =
	     { 1'd1, !ab__h98487[1] || ab__h98487[0] } ;
  ...
  assign dp1_bram_serverAdapterB_3_s1_1$wget =
	     { 1'd1, !ab__h99884[1] || ab__h99884[0] } ;
  ...
  assign dp0_bml_remBuf_incAction$whas = CAN_FIRE_RL_dp0_bml_remAdvance ;
  ...
  begin
    case (1'b1) // synopsys parallel_case
      WILL_FIRE_RL_dp0_tlp_dmaPullRequestFarMesg:
	  dp0_tlp_dmaPullRemainDWLen$D_IN = thisRequestLength__h46691[11:2];
      WILL_FIRE_RL_dp0_tlp_dmaPullResponseHeader:
  ...
  always@(WILL_FIRE_RL_dp0_tlp_dmaPullResponseHeader or
	  ...
	  WILL_FIRE_RL_dp0_tlp_dmaPullResponseBody or
	  dp0_tlp_dmaPullRemainDWSub_031_ULE_4___d5088 or
	  WILL_FIRE_RL_dp0_tlp_dmaPullRequestFarMesg)
  begin
    case (1'b1) // synopsys parallel_case
      WILL_FIRE_RL_dp0_tlp_dmaPullResponseHeader:
  ...
  assign dp0_wmi_wmi_sFlagReg$D_IN =
	     { y_avValue__h79436[7:0], y_avValue__h79416[23:0] } ;
  ...
  assign dp1_wmi_wmi_sFlagReg$D_IN =
	     { y_avValue__h156671[7:0], y_avValue__h156651[23:0] } ;
  ...
  assign _dfoo13 =
	     dp1_tlp_mRespF$D_OUT[71:62] != 10'd1 ||
	     dp1_tlp_mRespF$D_OUT[42:35] == 8'h01 ;
  assign ab__h12371 = dp0_bram_serverAdapterA_writeWithResp$wget ;
  assign ab__h13770 = dp0_bram_serverAdapterB_writeWithResp$wget ;
  assign ab__h15300 = dp0_bram_serverAdapterA_1_writeWithResp$wget ;
  assign ab__h16697 = dp0_bram_serverAdapterB_1_writeWithResp$wget ;
  assign ab__h18227 = dp0_bram_serverAdapterA_2_writeWithResp$wget ;
  assign ab__h19624 = dp0_bram_serverAdapterB_2_writeWithResp$wget ;
  assign ab__h21154 = dp0_bram_serverAdapterA_3_writeWithResp$wget ;
  assign ab__h22551 = dp0_bram_serverAdapterB_3_writeWithResp$wget ;
  assign ab__h89704 = dp1_bram_serverAdapterA_writeWithResp$wget ;
  assign ab__h91103 = dp1_bram_serverAdapterB_writeWithResp$wget ;
  assign ab__h92633 = dp1_bram_serverAdapterA_1_writeWithResp$wget ;
  assign ab__h94030 = dp1_bram_serverAdapterB_1_writeWithResp$wget ;
  assign ab__h95560 = dp1_bram_serverAdapterA_2_writeWithResp$wget ;
  assign ab__h96957 = dp1_bram_serverAdapterB_2_writeWithResp$wget ;
  assign ab__h98487 = dp1_bram_serverAdapterA_3_writeWithResp$wget ;
  assign ab__h99884 = dp1_bram_serverAdapterB_3_writeWithResp$wget ;
  assign byteCount__h138894 = x__h139005 - y__h139006 ;
  assign byteCount__h61659 = x__h61770 - y__h61771 ;
  assign dp0_bml_crdBuf_value_952_EQ_dp0_bml_crdBuf_mod_ETC___d5212 =
	     dp0_bml_crdBuf_value == dp0_bml_crdBuf_modulus ;
  assign dp0_bml_fabBuf_value_937_EQ_dp0_bml_fabBuf_mod_ETC___d5213 =
	     dp0_bml_fabBuf_value == dp0_bml_fabBuf_modulus ;
  assign dp0_bml_fabFlowAddr_009_PLUS_dp0_bml_fabFlowSi_ETC___d4624 =
	     dp0_bml_fabFlowAddr + dp0_bml_fabFlowSize ;
  assign dp0_bml_lclBufDone_994_AND_IF_dp0_bml_dpContro_ETC___d4564 =
	     dp0_bml_lclBufDone &&
	     CASE_dp0_dpControl_BITS_1_TO_0_NOT_dp0_bml_fab_ETC__q29 ;
  assign dp0_bml_lclBuf_value_907_EQ_dp0_bml_lclBuf_mod_ETC___d5228 =
	     dp0_bml_lclBuf_value == dp0_bml_lclBuf_modulus ;
  assign dp0_bml_remBuf_value_922_EQ_dp0_bml_remBuf_mod_ETC___d5229 =
  ...
  assign dp0_bram_serverAdapterA_1_cnt_50_PLUS_IF_dp0_b_ETC___d356 =
		...
		3'd7 :
		3'd0) ;
  assign dp0_bram_serverAdapterA_1_cnt_50_SLT_3___d4497 =
  ...
  assign dp0_bram_serverAdapterA_2_cnt_68_PLUS_IF_dp0_b_ETC___d474 =
		...
		3'd7 :
		3'd0) ;
  assign dp0_bram_serverAdapterA_2_cnt_68_SLT_3___d5090 =
  ...
  assign dp0_bram_serverAdapterA_3_cnt_86_PLUS_IF_dp0_b_ETC___d592 =
		...
		3'd7 :
		3'd0) ;
  assign dp0_bram_serverAdapterA_3_cnt_86_SLT_3___d5091 =
  ...
  assign dp0_bram_serverAdapterA_cnt_32_SLT_3___d5089 =
  ...
  assign dp0_tlp_dmaPullRemainDWLen_017_ULE_dp0_tlp_dma_ETC___d5087 =
	     dp0_tlp_dmaPullRemainDWLen <= dp0_tlp_dmaPullRemainDWSub ;
  assign dp0_tlp_dmaPullRemainDWSub_031_ULE_4___d5088 =
	     dp0_tlp_dmaPullRemainDWSub <= 10'd4 ;
  ...
  assign dp0_tlp_mReqF_RDY_deq__157_AND_IF_dp0_tlp_mReq_ETC___d1173 =
	     dp0_tlp_mReqF$EMPTY_N &&
	     CASE_dp0_tlp_mReqFD_OUT_BITS_51_TO_50_NOT_dp0_ETC__q25 ;
  assign dp0_tlp_outDwRemain_142_ULE_4___d4503 =
	     dp0_tlp_outDwRemain <= 10'd4 ;
  ...
  assign dp0_tlp_writeRemainDWLen_194_ULE_1___d4517 =
	     dp0_tlp_writeRemainDWLen <= 10'd1 ;
  assign dp0_tlp_writeRemainDWLen_194_ULE_2___d4509 =
	     dp0_tlp_writeRemainDWLen <= 10'd2 ;
  assign dp0_tlp_writeRemainDWLen_194_ULE_3___d4511 =
  ...
  assign dp0_wmi_dpControl_whas__701_AND_dp0_bram_serve_ETC___d1747 =
	     ...
	     (dp0_bram_serverAdapterB_1_outDataCore$EMPTY_N ||
	      dp0_bram_serverAdapterB_1_outData_enqData$whas) &&
	     dp0_bram_serverAdapterB_1_outData_outData_whas_ETC___d1743 ;
  assign dp1_bml_crdBuf_value_983_EQ_dp1_bml_crdBuf_mod_ETC___d5279 =
	     dp1_bml_crdBuf_value == dp1_bml_crdBuf_modulus ;
  assign dp1_bml_fabBuf_value_968_EQ_dp1_bml_fabBuf_mod_ETC___d5280 =
	     dp1_bml_fabBuf_value == dp1_bml_fabBuf_modulus ;
  assign dp1_bml_fabFlowAddr_040_PLUS_dp1_bml_fabFlowSi_ETC___d4626 =
	     dp1_bml_fabFlowAddr + dp1_bml_fabFlowSize ;
  assign dp1_bml_lclBufDone_025_AND_IF_dp1_bml_dpContro_ETC___d4611 =
	     dp1_bml_lclBufDone &&
	     CASE_dp1_dpControl_BITS_1_TO_0_NOT_dp1_bml_fab_ETC__q30 ;
  assign dp1_bml_lclBuf_value_938_EQ_dp1_bml_lclBuf_mod_ETC___d5294 =
	     dp1_bml_lclBuf_value == dp1_bml_lclBuf_modulus ;
  assign dp1_bml_remBuf_value_953_EQ_dp1_bml_remBuf_mod_ETC___d5295 =
  ...
  assign dp1_bram_serverAdapterA_1_cnt_386_PLUS_IF_dp1__ETC___d2392 =
		...
		3'd7 :
		3'd0) ;
  assign dp1_bram_serverAdapterA_1_cnt_386_SLT_3___d5093 =
  ...
  assign dp1_bram_serverAdapterA_2_cnt_504_PLUS_IF_dp1__ETC___d2510 =
		...
		3'd7 :
		3'd0) ;
  assign dp1_bram_serverAdapterA_2_cnt_504_SLT_3___d5094 =
  ...
  assign dp1_bram_serverAdapterA_3_cnt_622_PLUS_IF_dp1__ETC___d2628 =
		...
		3'd7 :
		3'd0) ;
  assign dp1_bram_serverAdapterA_3_cnt_622_SLT_3___d5095 =
  ...
  assign dp1_bram_serverAdapterA_cnt_268_SLT_3___d5092 =
  ...
  assign dp1_tlp_mReqF_RDY_deq__188_AND_IF_dp1_tlp_mReq_ETC___d3204 =
	     dp1_tlp_mReqF$EMPTY_N &&
	     CASE_dp1_tlp_mReqFD_OUT_BITS_51_TO_50_NOT_dp1_ETC__q27 ;
  assign dp1_tlp_mRespF_first__905_BITS_71_TO_62_995_ULE_1___d4518 =
	     dp1_tlp_mRespF$D_OUT[71:62] <= 10'd1 ;
  assign dp1_tlp_outDwRemain_021_ULE_4___d4803 =
	     dp1_tlp_outDwRemain <= 10'd4 ;
  ...
  assign dp1_tlp_readRemainDWLen_395_ULE_4___d3396 =
	     dp1_tlp_readRemainDWLen <= 10'd4 ;
  assign dp1_tlp_writeDWAddr_PLUS_1__q7 = dp1_tlp_writeDWAddr + 13'd1 ;
  assign dp1_tlp_writeDWAddr_PLUS_2__q8 = dp1_tlp_writeDWAddr + 13'd2 ;
  assign dp1_tlp_writeDWAddr_PLUS_3__q6 = dp1_tlp_writeDWAddr + 13'd3 ;
  assign dp1_tlp_writeRemainDWLen_225_ULE_1___d4542 =
	     dp1_tlp_writeRemainDWLen <= 10'd1 ;
  assign dp1_tlp_writeRemainDWLen_225_ULE_2___d4544 =
	     dp1_tlp_writeRemainDWLen <= 10'd2 ;
  assign dp1_tlp_writeRemainDWLen_225_ULE_3___d4512 =
  ...
  assign dp1_wmi_dpControl_whas__732_AND_dp1_bram_serve_ETC___d3778 =
	     ...
	     (dp1_bram_serverAdapterB_1_outDataCore$EMPTY_N ||
	      dp1_bram_serverAdapterB_1_outData_enqData$whas) &&
	     dp1_bram_serverAdapterB_1_outData_outData_whas_ETC___d3774 ;
  assign idx__h129715 = 2'd0 - dp1_tlp_writeDWAddr[1:0] ;
  assign idx__h131938 = 2'd1 - dp1_tlp_writeDWAddr[1:0] ;
  assign idx__h133234 = 2'd2 - dp1_tlp_writeDWAddr[1:0] ;
  assign idx__h134530 = 2'd3 - dp1_tlp_writeDWAddr[1:0] ;
  assign idx__h136778 = 2'd0 - dp1_tlp_readNxtDWAddr[1:0] ;
  assign idx__h137246 = 2'd1 - dp1_tlp_readNxtDWAddr[1:0] ;
  assign idx__h137619 = 2'd2 - dp1_tlp_readNxtDWAddr[1:0] ;
  assign idx__h137992 = 2'd3 - dp1_tlp_readNxtDWAddr[1:0] ;
  assign idx__h52480 = 2'd0 - dp0_tlp_writeDWAddr[1:0] ;
  assign idx__h54703 = 2'd1 - dp0_tlp_writeDWAddr[1:0] ;
  assign idx__h55999 = 2'd2 - dp0_tlp_writeDWAddr[1:0] ;
  assign idx__h57295 = 2'd3 - dp0_tlp_writeDWAddr[1:0] ;
  assign idx__h59543 = 2'd0 - dp0_tlp_readNxtDWAddr[1:0] ;
  assign idx__h60011 = 2'd1 - dp0_tlp_readNxtDWAddr[1:0] ;
  assign idx__h60384 = 2'd2 - dp0_tlp_readNxtDWAddr[1:0] ;
  assign idx__h60757 = 2'd3 - dp0_tlp_readNxtDWAddr[1:0] ;
  assign lastBE__h113495 =
	     dp1_tlp_mRespF_first__905_BITS_71_TO_62_995_ULE_1___d4518 ?
	       4'd0 :
	       4'd15 ;
  assign lastBE__h46993 =
	     (thisRequestLength__h46691[11:2] == 10'd1) ? 4'd0 : 4'd15 ;
  assign lowAddr__h138893 =
	     { dp1_tlp_readReq$D_OUT[33:29], lowAddr10__h138892 } ;
  assign lowAddr__h61658 =
	     { dp0_tlp_readReq$D_OUT[33:29], lowAddr10__h61657 } ;
  assign mesgMeta_opcode__h155095 = MUX_dp1_bram_memory_1$b_put_3__VAL_4 ;
  assign mesgMeta_opcode__h77860 = MUX_dp0_bram_memory_1$b_put_3__VAL_4 ;
  assign nowLS__h109853 =
	     { dp1_tlp_mRespF$D_OUT[39:32],
	       dp1_tlp_mRespF$D_OUT[47:40],
	       dp1_tlp_mRespF$D_OUT[55:48],
	       dp1_tlp_mRespF$D_OUT[63:56] } ;
  assign nowLS__h43479 =
	     { dp0_tlp_inF$D_OUT[39:32],
	       dp0_tlp_inF$D_OUT[47:40],
	       dp0_tlp_inF$D_OUT[55:48],
	       dp0_tlp_inF$D_OUT[63:56] } ;
  assign nowMS__h109852 =
	     { dp1_tlp_mRespF$D_OUT[71:64],
	       dp1_tlp_mRespF$D_OUT[79:72],
	       dp1_tlp_mRespF$D_OUT[87:80],
	       dp1_tlp_mRespF$D_OUT[95:88] } ;
  assign nowMS__h43478 =
	     { dp0_tlp_inF$D_OUT[71:64],
	       dp0_tlp_inF$D_OUT[79:72],
	       dp0_tlp_inF$D_OUT[87:80],
	       dp0_tlp_inF$D_OUT[95:88] } ;
  assign opcode__h109851 =
	     { dp1_tlp_mRespF$D_OUT[103:96],
	       dp1_tlp_mRespF$D_OUT[111:104],
	       dp1_tlp_mRespF$D_OUT[119:112],
	       dp1_tlp_mRespF$D_OUT[127:120] } ;
  assign opcode__h43477 =
  ...
  assign rdat__h163684 = { 16'd0, dp1_bml_lclNumBufs } ;
  assign rdat__h163692 = { 16'd0, dp1_bml_fabNumBufs } ;
  assign rdat__h163700 = { 16'd0, dp1_bml_mesgBase } ;
  assign rdat__h163708 = { 16'd0, dp1_bml_metaBase } ;
  assign rdat__h163716 = { 16'd0, dp1_bml_mesgSize } ;
  assign rdat__h163724 = { 16'd0, dp1_bml_metaSize } ;
  assign rdat__h163732 = { 16'd0, dp1_bml_lclBufsCF } ;
  assign rdat__h163753 = { dp1_bml_lclBufsAR, dp1_bml_fabBufsAvail } ;
  assign rdat__h163758 = { dp1_bml_remBuf_value, dp1_bml_lclBuf_value } ;
  assign rdat__h163769 = { dp1_bml_lclStarts, dp1_bml_lclDones } ;
  assign rdat__h163774 = { dp1_bml_remStarts, dp1_bml_remDones } ;
  assign rdat__h163835 = { 28'd0, dp1_dpControl } ;
  assign rdat__h86452 = { 16'd0, dp0_bml_lclNumBufs } ;
  assign rdat__h86460 = { 16'd0, dp0_bml_fabNumBufs } ;
  assign rdat__h86468 = { 16'd0, dp0_bml_mesgBase } ;
  assign rdat__h86476 = { 16'd0, dp0_bml_metaBase } ;
  assign rdat__h86484 = { 16'd0, dp0_bml_mesgSize } ;
  assign rdat__h86492 = { 16'd0, dp0_bml_metaSize } ;
  assign rdat__h86500 = { 16'd0, dp0_bml_lclBufsCF } ;
  assign rdat__h86521 = { dp0_bml_lclBufsAR, dp0_bml_fabBufsAvail } ;
  assign rdat__h86526 = { dp0_bml_remBuf_value, dp0_bml_lclBuf_value } ;
  assign rdat__h86537 = { dp0_bml_lclStarts, dp0_bml_lclDones } ;
  assign rdat__h86542 = { dp0_bml_remStarts, dp0_bml_remDones } ;
  assign rdat__h86603 = { 28'd0, dp0_dpControl } ;
  assign rdata__h144262 =
	     dp1_tlp_readNxtDWAddr[1] ?
	       IF_dp1_tlp_readNxtDWAddr_407_BIT_0_584_THEN_dp_ETC___d3589 :
	       IF_dp1_tlp_readNxtDWAddr_407_BIT_0_584_THEN_dp_ETC___d3594 ;
  assign rdata__h67027 =
	     dp0_tlp_readNxtDWAddr[1] ?
	       IF_dp0_tlp_readNxtDWAddr_376_BIT_0_553_THEN_dp_ETC___d1558 :
	       IF_dp0_tlp_readNxtDWAddr_376_BIT_0_553_THEN_dp_ETC___d1563 ;
  assign rreq_tag__h113296 =
	     (y__h113107 == dp1_tlp_mesgLengthRemainPush) ? 8'h01 : 8'h0 ;
  assign rresp_data__h138936 =
	     { IF_dp1_tlp_readReq_first__455_BITS_30_TO_29_45_ETC___d4703[7:0],
	       IF_dp1_tlp_readReq_first__455_BITS_30_TO_29_45_ETC___d4703[15:8],
	       IF_dp1_tlp_readReq_first__455_BITS_30_TO_29_45_ETC___d4703[23:16],
	       IF_dp1_tlp_readReq_first__455_BITS_30_TO_29_45_ETC___d4703[31:24] } ;
  assign rresp_data__h61701 =
	     { IF_dp0_tlp_readReq_first__424_BITS_30_TO_29_42_ETC___d4698[7:0],
	       IF_dp0_tlp_readReq_first__424_BITS_30_TO_29_42_ETC___d4698[15:8],
	       IF_dp0_tlp_readReq_first__424_BITS_30_TO_29_42_ETC___d4698[23:16],
	       IF_dp0_tlp_readReq_first__424_BITS_30_TO_29_42_ETC___d4698[31:24] } ;
  assign spanToNextPage__h113066 =
	     13'd4096 - { 1'd0, dp1_tlp_srcMesgAccu[11:0] } ;
  assign spanToNextPage__h46690 =
	     13'd4096 - { 1'd0, dp0_tlp_fabMesgAccu[11:0] } ;
  assign tag__h46966 = { 3'd0, dp0_tlp_dmaTag } ;
  assign tagm__h47092 = { 3'd0, dp0_tlp_dmaReqTag } ;
  assign thisRequestLength__h113067 =
	     (x__h113120[12:0] <= spanToNextPage__h113066) ?
	       x__h113120[12:0] :
	       spanToNextPage__h113066 ;
  assign thisRequestLength__h46691 =
	     (x__h46724[12:0] <= spanToNextPage__h46690) ?
	       x__h46724[12:0] :
	       spanToNextPage__h46690 ;
  ...
  assign w_data__h115512 =
	     { dp1_tlp_fabMeta[71:64],
	       ...
	       32'b0 } ;
  assign w_data__h125520 =
	     { 32'd1073745921,
	       pciDevice[15:3],
	       19'd65551,
	       dp1_tlp_fabFlowAddr,
	       32'd16777216 } ;
  assign w_data__h41197 =
	     { 32'd4100,
	       pciDevice[15:3],
	       3'd0,
	       tag__h46966,
	       ...
	       34'd0 } ;
  assign w_data__h46972 =
	     { 22'd4,
	       thisRequestLength__h46691[11:2],
	       pciDevice[15:3],
	       3'd0,
	       tag__h46966,
	       lastBE__h46993,
	       ...
	       34'd0 } ;
  assign w_data__h48286 =
	     { 32'd1073745921,
	       pciDevice[15:3],
	       19'd15,
	       dp0_tlp_fabFlowAddr,
	       32'd16777216 } ;
  assign x3__h155055 = MUX_dp1_bram_memory$b_put_3__VAL_4 ;
  assign x3__h77820 = MUX_dp0_bram_memory$b_put_3__VAL_4 ;
  assign x__h109914 = { 15'd0, dp1_tlp_mesgLengthRemainPush } ;
  assign x__h113120 =
	     (dp1_tlp_mesgLengthRemainPush <= y__h113122) ?
	       dp1_tlp_mesgLengthRemainPush :
	       y__h113122 ;
  assign x__h113622 = { dp1_tlp_mRespF$D_OUT[69:62], 2'd0 } ;
  assign x__h139005 = x__h139007 - y__h139008 ;
  assign x__h139007 = { dp1_tlp_readReq$D_OUT[28:19], 2'b0 } ;
  assign x__h160836 =
	     (dp1_dpControl[1:0] == 2'd1) ? dp1_bml_fabNumBufs : 16'd0 ;
  assign x__h161960 = dp1_bml_lclBufsAR + 16'd1 ;
  assign x__h161965 = dp1_bml_lclBufsAR - 16'd1 ;
  assign x__h162037 = dp1_bml_lclBufsCF + 16'd1 ;
  assign x__h162042 = dp1_bml_lclBufsCF - 16'd1 ;
  assign x__h162079 = dp1_bml_fabBufsAvail + 16'd1 ;
  assign x__h162084 = dp1_bml_fabBufsAvail - 16'd1 ;
  assign x__h162117 = dp1_bml_lclCredit + 16'd1 ;
  assign x__h162122 = dp1_bml_lclCredit - 16'd1 ;
  assign x__h43509 = { 15'd0, dp0_tlp_mesgLengthRemainPull } ;
  assign x__h46724 =
	     (dp0_tlp_mesgLengthRemainPull <= y__h46726) ?
	       dp0_tlp_mesgLengthRemainPull :
	       y__h46726 ;
  assign x__h47301 = { dp0_tlp_inF$D_OUT[103:96], 2'd0 } ;
  assign x__h47979 = { dp0_tlp_dmaPullRemainDWSub[7:0], 2'd0 } ;
  assign x__h61770 = x__h61772 - y__h61773 ;
  assign x__h61772 = { dp0_tlp_readReq$D_OUT[28:19], 2'b0 } ;
  assign x__h83604 =
	     (dp0_dpControl[1:0] == 2'd1) ? dp0_bml_fabNumBufs : 16'd0 ;
  assign x__h84728 = dp0_bml_lclBufsAR + 16'd1 ;
  assign x__h84733 = dp0_bml_lclBufsAR - 16'd1 ;
  assign x__h84805 = dp0_bml_lclBufsCF + 16'd1 ;
  assign x__h84810 = dp0_bml_lclBufsCF - 16'd1 ;
  assign x__h84847 = dp0_bml_fabBufsAvail + 16'd1 ;
  assign x__h84852 = dp0_bml_fabBufsAvail - 16'd1 ;
  assign x__h84885 = dp0_bml_lclCredit + 16'd1 ;
  assign x__h84890 = dp0_bml_lclCredit - 16'd1 ;
  assign y__h113107 = { 4'd0, thisRequestLength__h113067 } ;
  assign y__h113122 = { 4'd0, dp1_tlp_maxPayloadSize } ;
  assign y__h113201 = { 19'd0, thisRequestLength__h113067 } ;
  assign y__h113249 = { 3'd0, thisRequestLength__h113067 } ;
  assign y__h113619 = { 22'd0, x__h113622 } ;
  assign y__h139006 =
	     (dp1_tlp_readReq$D_OUT[28:19] == 10'd1) ?
	       12'd0 :
	       { 10'd0, x__h139037 } ;
  assign y__h139008 = { 10'd0, x__h139014 } ;
  assign y__h46716 = { 4'd0, thisRequestLength__h46691 } ;
  assign y__h46726 = { 4'd0, dp0_tlp_maxReadReqSize } ;
  assign y__h46787 = { 19'd0, thisRequestLength__h46691 } ;
  assign y__h47298 = { 6'd0, x__h47301 } ;
  assign y__h47976 =
	     dp0_tlp_dmaPullRemainDWSub_031_ULE_4___d5088 ?
	       { 7'd0, x__h47979 } :
	       17'd16 ;
  assign y__h61771 =
	     (dp0_tlp_readReq$D_OUT[28:19] == 10'd1) ?
	       12'd0 :
	       { 10'd0, x__h61802 } ;
  assign y__h61773 = { 10'd0, x__h61779 } ;
  assign y_avValue__h156651 = dp1_bram_serverAdapterB_outData_outData$wget ;
  assign y_avValue__h156671 = dp1_bram_serverAdapterB_1_outData_outData$wget ;
  assign y_avValue__h156691 = dp1_bram_serverAdapterB_2_outData_outData$wget ;
  assign y_avValue__h156711 = dp1_bram_serverAdapterB_3_outData_outData$wget ;
  assign y_avValue__h79416 = dp0_bram_serverAdapterB_outData_outData$wget ;
  assign y_avValue__h79436 = dp0_bram_serverAdapterB_1_outData_outData$wget ;
  assign y_avValue__h79456 = dp0_bram_serverAdapterB_2_outData_outData$wget ;
  assign y_avValue__h79476 = dp0_bram_serverAdapterB_3_outData_outData$wget ;
  always@(dp0_tlp_readReq$D_OUT)
  begin
    case (dp0_tlp_readReq$D_OUT[18:15])
      4'b1100: x__h61779 = 2'b10;
      4'b1110: x__h61779 = 2'b01;
      4'b1111: x__h61779 = 2'b0;
      default: x__h61779 = 2'b11;
    endcase
  end
  always@(dp0_tlp_readReq$D_OUT)
  begin
    case (dp0_tlp_readReq$D_OUT[14:11])
      4'b1100: x__h61802 = 2'b10;
      4'b1110: x__h61802 = 2'b01;
      4'b1111: x__h61802 = 2'b0;
      default: x__h61802 = 2'b11;
    endcase
  end
  always@(dp1_tlp_readReq$D_OUT)
  begin
    case (dp1_tlp_readReq$D_OUT[18:15])
      4'b1100: x__h139014 = 2'b10;
      4'b1110: x__h139014 = 2'b01;
      4'b1111: x__h139014 = 2'b0;
      default: x__h139014 = 2'b11;
    endcase
  end
  always@(dp1_tlp_readReq$D_OUT)
  begin
    case (dp1_tlp_readReq$D_OUT[14:11])
      4'b1100: x__h139037 = 2'b10;
      4'b1110: x__h139037 = 2'b01;
      4'b1111: x__h139037 = 2'b0;
      default: x__h139037 = 2'b11;
    endcase
  end
  always@(dp0_wmi_p4B or
	  y_avValue__h79476 or
	  y_avValue__h79416 or y_avValue__h79436 or y_avValue__h79456)
  begin
    case (dp0_wmi_p4B)
      2'd0: rdata__h79580 = y_avValue__h79416;
      2'd1: rdata__h79580 = y_avValue__h79436;
      2'd2: rdata__h79580 = y_avValue__h79456;
      2'd3: rdata__h79580 = y_avValue__h79476;
    endcase
  end
  always@(dp1_wmi_p4B or
	  y_avValue__h156711 or
	  y_avValue__h156651 or y_avValue__h156671 or y_avValue__h156691)
  begin
    case (dp1_wmi_p4B)
      2'd0: rdata__h156815 = y_avValue__h156651;
      2'd1: rdata__h156815 = y_avValue__h156671;
      2'd2: rdata__h156815 = y_avValue__h156691;
      2'd3: rdata__h156815 = y_avValue__h156711;
    endcase
  end
  always@(dp0_tlp_readReq$D_OUT)
  begin
    case (dp0_tlp_readReq$D_OUT[18:15])
      4'b1000: lowAddr10__h61657 = 2'b11;
      4'b1100: lowAddr10__h61657 = 2'b10;
      4'b1110: lowAddr10__h61657 = 2'b01;
      default: lowAddr10__h61657 = 2'b0;
    endcase
  end
  always@(dp0_wci_reqF$D_OUT or
	  ...
	  dp0_bml_fabFlowBase or dp0_bml_fabFlowSize or rdat__h86603)
  begin
    case (dp0_wci_reqF$D_OUT[39:32])
      8'h0: _theResult____h86373 = rdat__h86452;
      8'h04: _theResult____h86373 = rdat__h86460;
      8'h08: _theResult____h86373 = rdat__h86468;
      8'h0C: _theResult____h86373 = rdat__h86476;
      8'h10: _theResult____h86373 = rdat__h86484;
      8'h14: _theResult____h86373 = rdat__h86492;
      8'h20: _theResult____h86373 = rdat__h86500;
      8'h24: _theResult____h86373 = 32'hF00DFACE;
      8'h28: _theResult____h86373 = rdat__h86521;
      8'h2C: _theResult____h86373 = rdat__h86526;
      8'h30: _theResult____h86373 = rdat__h86537;
      8'h34: _theResult____h86373 = rdat__h86542;
      8'h48: _theResult____h86373 = 32'hDADEBABE;
      8'h4C: _theResult____h86373 = 32'h00008000;
      8'h50: _theResult____h86373 = dp0_bml_fabMesgBase;
      8'h54: _theResult____h86373 = dp0_bml_fabMetaBase;
      8'h58: _theResult____h86373 = dp0_bml_fabMesgSize;
      8'h5C: _theResult____h86373 = dp0_bml_fabMetaSize;
      8'h60: _theResult____h86373 = dp0_bml_fabFlowBase;
      8'h64: _theResult____h86373 = dp0_bml_fabFlowSize;
      8'h68: _theResult____h86373 = rdat__h86603;
      default: _theResult____h86373 = 32'd0;
    endcase
  end
  always@(dp1_tlp_readReq$D_OUT)
  begin
    case (dp1_tlp_readReq$D_OUT[18:15])
      4'b1000: lowAddr10__h138892 = 2'b11;
      4'b1100: lowAddr10__h138892 = 2'b10;
      4'b1110: lowAddr10__h138892 = 2'b01;
      default: lowAddr10__h138892 = 2'b0;
    endcase
  end
  always@(dp1_wci_reqF$D_OUT or
	  ...
	  dp1_bml_fabFlowBase or dp1_bml_fabFlowSize or rdat__h163835)
  begin
    case (dp1_wci_reqF$D_OUT[39:32])
      8'h0: _theResult____h163605 = rdat__h163684;
      8'h04: _theResult____h163605 = rdat__h163692;
      8'h08: _theResult____h163605 = rdat__h163700;
      8'h0C: _theResult____h163605 = rdat__h163708;
      8'h10: _theResult____h163605 = rdat__h163716;
      8'h14: _theResult____h163605 = rdat__h163724;
      8'h20: _theResult____h163605 = rdat__h163732;
      8'h24: _theResult____h163605 = 32'hF00DFACE;
      8'h28: _theResult____h163605 = rdat__h163753;
      8'h2C: _theResult____h163605 = rdat__h163758;
      8'h30: _theResult____h163605 = rdat__h163769;
      8'h34: _theResult____h163605 = rdat__h163774;
      8'h48: _theResult____h163605 = 32'hDADEBABE;
      8'h4C: _theResult____h163605 = 32'h00008000;
      8'h50: _theResult____h163605 = dp1_bml_fabMesgBase;
      8'h54: _theResult____h163605 = dp1_bml_fabMetaBase;
      8'h58: _theResult____h163605 = dp1_bml_fabMesgSize;
      8'h5C: _theResult____h163605 = dp1_bml_fabMetaSize;
      8'h60: _theResult____h163605 = dp1_bml_fabFlowBase;
      8'h64: _theResult____h163605 = dp1_bml_fabFlowSize;
      8'h68: _theResult____h163605 = rdat__h163835;
      default: _theResult____h163605 = 32'd0;
    endcase
  end
  ...
  begin
    case (dp0_dpControl[1:0])
	  ...
	  CASE_dp0_dpControl_BITS_1_TO_0_NOT_dp0_bml_fab_ETC__q16 =
	      !dp0_bml_remDone;
      default: CASE_dp0_dpControl_BITS_1_TO_0_NOT_dp0_bml_fab_ETC__q16 =
		   !dp0_bml_fabDone;
    endcase
  end
  always@(dp0_wmi_p4B or
  ...
  begin
    case (dp0_wmi_p4B)
	  ...
	  CASE_dp0_wmi_p4B_NOT_dp0_wmi_p4B_EQ_3_OR_dp0_b_ETC__q17 =
	      dp0_bram_serverAdapterB_2_outData_outData$whas;
      default: CASE_dp0_wmi_p4B_NOT_dp0_wmi_p4B_EQ_3_OR_dp0_b_ETC__q17 =
		   dp0_wmi_p4B != 2'd3 ||
		   dp0_bram_serverAdapterB_3_outData_outData$whas;
    endcase
  end
  ...
  always@(idx__h52480 or
	  dp0_tlp_writeRemainDWLen_194_ULE_3___d4511 or
	  dp0_tlp_writeRemainDWLen or
	  dp0_tlp_writeRemainDWLen_194_ULE_1___d4517 or
	  dp0_tlp_writeRemainDWLen_194_ULE_2___d4509)
  begin
    case (idx__h52480)
      2'd0:
  ...
  always@(idx__h129715 or
	  dp1_tlp_writeRemainDWLen_225_ULE_3___d4512 or
	  dp1_tlp_writeRemainDWLen or
	  dp1_tlp_writeRemainDWLen_225_ULE_1___d4542 or
	  dp1_tlp_writeRemainDWLen_225_ULE_2___d4544)
  begin
    case (idx__h129715)
      2'd0:
  ...
  always@(dp0_tlp_mReqF$D_OUT or
	  dp0_bram_serverAdapterA_3_cnt_86_SLT_3___d5091 or
	  dp0_bram_serverAdapterA_cnt_32_SLT_3___d5089 or
	  dp0_bram_serverAdapterA_1_cnt_50_SLT_3___d4497 or
	  dp0_bram_serverAdapterA_2_cnt_68_SLT_3___d5090)
  begin
  ...
  always@(dp1_tlp_mReqF$D_OUT or
	  dp1_bram_serverAdapterA_3_cnt_622_SLT_3___d5095 or
	  dp1_bram_serverAdapterA_cnt_268_SLT_3___d5092 or
	  dp1_bram_serverAdapterA_1_cnt_386_SLT_3___d5093 or
	  dp1_bram_serverAdapterA_2_cnt_504_SLT_3___d5094)
  begin
  ...
  always@(idx__h52480 or dp0_tlp_mReqF$D_OUT)
  begin
    case (idx__h52480)
      2'd0:
	  IF_0_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d4695 =
  ...
  always@(idx__h54703 or dp0_tlp_mReqF$D_OUT)
  begin
    case (idx__h54703)
      2'd0:
	  IF_1_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d4498 =
  ...
  always@(idx__h55999 or dp0_tlp_mReqF$D_OUT)
  begin
    case (idx__h55999)
      2'd0:
	  IF_2_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d4696 =
  ...
  always@(idx__h57295 or dp0_tlp_mReqF$D_OUT)
  begin
    case (idx__h57295)
      2'd0:
	  IF_3_MINUS_dp0_tlp_writeDWAddr_190_BITS_1_TO_0_ETC___d4697 =
  ...
  always@(idx__h129715 or dp1_tlp_mReqF$D_OUT)
  begin
    case (idx__h129715)
      2'd0:
	  IF_0_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d4699 =
  ...
  always@(idx__h131938 or dp1_tlp_mReqF$D_OUT)
  begin
    case (idx__h131938)
      2'd0:
	  IF_1_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d4700 =
  ...
  always@(idx__h134530 or dp1_tlp_mReqF$D_OUT)
  begin
    case (idx__h134530)
      2'd0:
	  IF_3_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d4702 =
  ...
  always@(idx__h133234 or dp1_tlp_mReqF$D_OUT)
  begin
    case (idx__h133234)
      2'd0:
	  IF_2_MINUS_dp1_tlp_writeDWAddr_221_BITS_1_TO_0_ETC___d4701 =
  ...
  begin
    ...
    if (cp$RST_N_wci_Vm_13)
      if (WILL_FIRE_RL_dp0_tlp_dmaXmtDoorbell)
	$display("[%0d]: %m: dmaXmtDoorbell FC/FPactFlow-Step1/1", v__h40927);
    if (cp$RST_N_wci_Vm_13)
      if (pciw_p125rst$OUT_RST_N)
    ...
    if (cp$RST_N_wci_Vm_13)
      if (pciw_p125rst$OUT_RST_N)
	if (WILL_FIRE_RL_dp0_tlp_dmaTailEventSender)
	  $display("[%0d]: %m: dmaTailEventSender - generic", v__h49154);
    if (cp$RST_N_wci_Vm_13)
      if (pciw_p125rst$OUT_RST_N)
    ...
    if (cp$RST_N_wci_Vm_13)
      if (WILL_FIRE_RL_dp0_tlp_dmaPullTailEvent)
	$display("[%0d]: %m: dmaPullTailEvent FPactMesg-Step5/5", v__h48199);
    if (cp$RST_N_wci_Vm_13)
    ...
    if (cp$RST_N_wci_Vm_13)
      if (WILL_FIRE_RL_dp0_wci_cfwr && dp0_wci_reqF$D_OUT[39:32] == 8'h18)
	$display("[%0d] %m: fabDoneAvail Event", v__h85861);
    if (cp$RST_N_wci_Vm_13)
    ...
    if (cp$RST_N_wci_Vm_14)
      if (pciw_p125rst$OUT_RST_N)
	if (WILL_FIRE_RL_dp1_tlp_dmaXmtMetaHead)
	  $display("[%0d]: %m: dmaXmtMetaHead FPactMesg-Step5/7", v__h115344);
    if (cp$RST_N_wci_Vm_14)
    ...
    if (cp$RST_N_wci_Vm_14)
      if (WILL_FIRE_RL_dp1_tlp_dmaXmtMetaBody)
	$display("[%0d]: %m: dmaXmtMetaBody FPactMesg-Step6/7", v__h118078);
    if (cp$RST_N_wci_Vm_14)
    ...
    if (cp$RST_N_wci_Vm_14)
      if (WILL_FIRE_RL_dp1_tlp_dmaXmtTailEvent)
	$display("[%0d]: %m: dmaXmtTailEvent FPactMesg-Step7/7", v__h118263);
    if (cp$RST_N_wci_Vm_14)
      if (pciw_p125rst$OUT_RST_N)
    ...
    if (cp$RST_N_wci_Vm_14)
      if (pciw_p125rst$OUT_RST_N)
	if (WILL_FIRE_RL_dp1_tlp_dmaTailEventSender)
	  $display("[%0d]: %m: dmaTailEventSender - generic", v__h126388);
    if (cp$RST_N_wci_Vm_14)
    ...
    if (cp$RST_N_wci_Vm_14)
      if (WILL_FIRE_RL_dp1_wci_cfwr && dp1_wci_reqF$D_OUT[39:32] == 8'h18)
	$display("[%0d] %m: fabDoneAvail Event", v__h163093);
    if (cp$RST_N_wci_Vm_14)
