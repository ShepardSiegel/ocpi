...
//
// On Mon Jul 12 17:40:27 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkWsiAdapter16B4B(CLK,
  ...
  reg [31 : 0] x_data__h5369;
  reg [3 : 0] x_byteEn__h5370;
  ...
  begin
    case (pos)
      2'd0: x_data__h5369 = req16[55:24];
      2'd1: x_data__h5369 = req16[87:56];
      2'd2: x_data__h5369 = req16[119:88];
      2'd3: x_data__h5369 = req16[151:120];
    endcase
  end
  always@(pos or req16)
  begin
    case (pos)
      2'd0: x_byteEn__h5370 = req16[11:8];
      2'd1: x_byteEn__h5370 = req16[15:12];
      2'd2: x_byteEn__h5370 = req16[19:16];
      2'd3: x_byteEn__h5370 = req16[23:20];
    endcase
  end
