...
//
// On Sat Jul 10 13:12:32 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkWsiAdapter16B4B(CLK,
  ...
  reg [31 : 0] x_data__h5368;
  reg [3 : 0] x_byteEn__h5369;
  wire wsiS_reqFifo_notFull__61_AND_wsiS_burstKind_41_ETC___d177;
  ...
  assign wsiS_burstKind$EN =
	     WILL_FIRE_RL_wsiS_reqFifo_enq &&
	     wsiS_reqFifo_notFull__61_AND_wsiS_burstKind_41_ETC___d177 ;
  ...
  // remaining internal signals
  assign wsiS_reqFifo_notFull__61_AND_wsiS_burstKind_41_ETC___d177 =
	     wsiS_reqFifo$FULL_N &&
	     (wsiS_burstKind == 2'd0 ||
  ...
  begin
    case (pos)
      2'd0: x_data__h5368 = req16[55:24];
      2'd1: x_data__h5368 = req16[87:56];
      2'd2: x_data__h5368 = req16[119:88];
      2'd3: x_data__h5368 = req16[151:120];
    endcase
  end
  always@(pos or req16)
  begin
    case (pos)
      2'd0: x_byteEn__h5369 = req16[11:8];
      2'd1: x_byteEn__h5369 = req16[15:12];
      2'd2: x_byteEn__h5369 = req16[19:16];
      2'd3: x_byteEn__h5369 = req16[23:20];
    endcase
  end
