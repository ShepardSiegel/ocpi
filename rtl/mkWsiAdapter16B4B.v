...
//
// On Tue Jun 29 15:12:04 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkWsiAdapter16B4B(CLK,
  ...
  reg [31 : 0] x_data__h5144;
  reg [3 : 0] x_byteEn__h5145;
  wire NOT_wsiS_reqFifo_countReg_44_ULE_1_45___d146;
  ...
  assign wsiS1_SThreadBusy =
	     NOT_wsiS_reqFifo_countReg_44_ULE_1_45___d146 ||
	     wsiS_isReset$VAL ||
	     !wsiS_operateD ||
	     !wsiS_peerIsReady ;
  ...
  // remaining internal signals
  assign NOT_wsiS_reqFifo_countReg_44_ULE_1_45___d146 =
	     wsiS_reqFifo_countReg > 2'd1 ;
  always@(pos or req16)
  begin
    case (pos)
      2'd0: x_data__h5144 = req16[55:24];
      2'd1: x_data__h5144 = req16[87:56];
      2'd2: x_data__h5144 = req16[119:88];
      2'd3: x_data__h5144 = req16[151:120];
    endcase
  end
  always@(pos or req16)
  begin
    case (pos)
      2'd0: x_byteEn__h5145 = req16[11:8];
      2'd1: x_byteEn__h5145 = req16[15:12];
      2'd2: x_byteEn__h5145 = req16[19:16];
      2'd3: x_byteEn__h5145 = req16[23:20];
    endcase
  end
