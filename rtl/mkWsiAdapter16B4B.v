...
module mkWsiAdapter16B4B(CLK,
  ...
  // remaining internal signals
  assign x_burstLength__h6105 = { req16[161:152], 2'd0 } ;
  always@(pos or req16)
  begin
    case (pos)
      2'd0: x_data__h6106 = req16[55:24];
      2'd1: x_data__h6106 = req16[87:56];
      2'd2: x_data__h6106 = req16[119:88];
      2'd3: x_data__h6106 = req16[151:120];
    endcase
  end
  always@(pos or req16)
  begin
    case (pos)
      2'd0: x_byteEn__h6107 = req16[11:8];
      2'd1: x_byteEn__h6107 = req16[15:12];
      2'd2: x_byteEn__h6107 = req16[19:16];
      2'd3: x_byteEn__h6107 = req16[23:20];
    endcase
  end
