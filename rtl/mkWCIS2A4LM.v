...
//
// On Tue Dec 28 10:49:30 EST 2010
//
//
// Ports:
// Name                         I/O  size props
...
// wciS0_SFlag                    O     2
// axiM0_wrAddr_data              O    23 reg
// axiM0_wrAddr_valid             O     1
// axiM0_wrData_data              O    36 reg
// axiM0_wrData_valid             O     1
// axiM0_wrResp_ready             O     1
// axiM0_rdAddr_data              O    23 reg
// axiM0_rdAddr_valid             O     1
// axiM0_rdResp_ready             O     1
// wciS0_Clk                      I     1 clock
...
module mkWCIS2A4LM(wciS0_Clk,
  ...
  wire [22 : 0] axiM0_rdAddr_data, axiM0_wrAddr_data;
  ...
  wire [35 : 0] a4wrData_fifof_x_wire$wget;
  wire [33 : 0] a4rdResp_data_wire$wget, wci_respF_x_wire$wget;
  wire [31 : 0] wci_Es_mData_w$wget;
  wire [22 : 0] a4rdAddr_fifof_x_wire$wget, a4wrAddr_fifof_x_wire$wget;
  wire [19 : 0] wci_Es_mAddr_w$wget;
  wire [3 : 0] wci_Es_mByteEn_w$wget;
  wire [2 : 0] wci_Es_mCmd_w$wget, wci_wEdge$wget;
  wire [1 : 0] a4wrResp_data_wire$wget;
  wire a4rdAddr_deq_deq$whas,
       a4rdAddr_deq_ready$whas,
       a4rdAddr_fifof_dequeueing$whas,
       a4rdAddr_fifof_enqueueing$whas,
       a4rdAddr_fifof_x_wire$whas,
       a4rdResp_enq_enq$whas,
       a4rdResp_enq_valid$whas,
       a4wrAddr_deq_deq$whas,
       a4wrAddr_deq_ready$whas,
       a4wrAddr_fifof_dequeueing$whas,
       a4wrAddr_fifof_enqueueing$whas,
       a4wrAddr_fifof_x_wire$whas,
       a4wrData_deq_deq$whas,
       a4wrData_deq_ready$whas,
       a4wrData_fifof_dequeueing$whas,
       a4wrData_fifof_enqueueing$whas,
       a4wrData_fifof_x_wire$whas,
       a4wrResp_enq_enq$whas,
       a4wrResp_enq_valid$whas,
  ...
  // register a4rdAddr_fifof_c_r
  reg [1 : 0] a4rdAddr_fifof_c_r;
  wire [1 : 0] a4rdAddr_fifof_c_r$D_IN;
  wire a4rdAddr_fifof_c_r$EN;

  // register a4rdAddr_fifof_q_0
  reg [22 : 0] a4rdAddr_fifof_q_0;
  reg [22 : 0] a4rdAddr_fifof_q_0$D_IN;
  wire a4rdAddr_fifof_q_0$EN;

  // register a4rdAddr_fifof_q_1
  reg [22 : 0] a4rdAddr_fifof_q_1;
  reg [22 : 0] a4rdAddr_fifof_q_1$D_IN;
  wire a4rdAddr_fifof_q_1$EN;

  // register a4wrAddr_fifof_c_r
  reg [1 : 0] a4wrAddr_fifof_c_r;
  wire [1 : 0] a4wrAddr_fifof_c_r$D_IN;
  wire a4wrAddr_fifof_c_r$EN;

  // register a4wrAddr_fifof_q_0
  reg [22 : 0] a4wrAddr_fifof_q_0;
  reg [22 : 0] a4wrAddr_fifof_q_0$D_IN;
  wire a4wrAddr_fifof_q_0$EN;

  // register a4wrAddr_fifof_q_1
  reg [22 : 0] a4wrAddr_fifof_q_1;
  reg [22 : 0] a4wrAddr_fifof_q_1$D_IN;
  wire a4wrAddr_fifof_q_1$EN;

  // register a4wrData_fifof_c_r
  reg [1 : 0] a4wrData_fifof_c_r;
  wire [1 : 0] a4wrData_fifof_c_r$D_IN;
  wire a4wrData_fifof_c_r$EN;

  // register a4wrData_fifof_q_0
  reg [35 : 0] a4wrData_fifof_q_0;
  reg [35 : 0] a4wrData_fifof_q_0$D_IN;
  wire a4wrData_fifof_q_0$EN;

  // register a4wrData_fifof_q_1
  reg [35 : 0] a4wrData_fifof_q_1;
  reg [35 : 0] a4wrData_fifof_q_1$D_IN;
  wire a4wrData_fifof_q_1$EN;

  // register rdInFlight
  reg rdInFlight;
  wire rdInFlight$D_IN, rdInFlight$EN;
  ...
  // register wrInFlight
  reg wrInFlight;
  wire wrInFlight$D_IN, wrInFlight$EN;

  // ports of submodule a4rdResp_fifof
  wire [33 : 0] a4rdResp_fifof$D_IN, a4rdResp_fifof$D_OUT;
  wire a4rdResp_fifof$CLR,
       a4rdResp_fifof$DEQ,
       a4rdResp_fifof$EMPTY_N,
       a4rdResp_fifof$ENQ,
       a4rdResp_fifof$FULL_N;

  // ports of submodule a4wrResp_fifof
  wire [1 : 0] a4wrResp_fifof$D_IN;
  wire a4wrResp_fifof$CLR,
       a4wrResp_fifof$DEQ,
       a4wrResp_fifof$EMPTY_N,
       a4wrResp_fifof$ENQ,
       a4wrResp_fifof$FULL_N;
  ...
  wire CAN_FIRE_RL_a4rdAddr_do_deq,
       CAN_FIRE_RL_a4rdAddr_fifof_both,
       CAN_FIRE_RL_a4rdAddr_fifof_decCtr,
       CAN_FIRE_RL_a4rdAddr_fifof_incCtr,
       CAN_FIRE_RL_a4rdResp_do_enq,
       CAN_FIRE_RL_a4wrAddr_do_deq,
       CAN_FIRE_RL_a4wrAddr_fifof_both,
       CAN_FIRE_RL_a4wrAddr_fifof_decCtr,
       CAN_FIRE_RL_a4wrAddr_fifof_incCtr,
       CAN_FIRE_RL_a4wrData_do_deq,
       CAN_FIRE_RL_a4wrData_fifof_both,
       CAN_FIRE_RL_a4wrData_fifof_decCtr,
       CAN_FIRE_RL_a4wrData_fifof_incCtr,
       CAN_FIRE_RL_a4wrResp_do_enq,
       CAN_FIRE_RL_wci_Es_doAlways_Req,
       CAN_FIRE_RL_wci_cfird_resp,
       ...
       WILL_FIRE_RL_a4rdAddr_do_deq,
       WILL_FIRE_RL_a4rdAddr_fifof_both,
       WILL_FIRE_RL_a4rdAddr_fifof_decCtr,
       WILL_FIRE_RL_a4rdAddr_fifof_incCtr,
       WILL_FIRE_RL_a4rdResp_do_enq,
       WILL_FIRE_RL_a4wrAddr_do_deq,
       WILL_FIRE_RL_a4wrAddr_fifof_both,
       WILL_FIRE_RL_a4wrAddr_fifof_decCtr,
       WILL_FIRE_RL_a4wrAddr_fifof_incCtr,
       WILL_FIRE_RL_a4wrData_do_deq,
       WILL_FIRE_RL_a4wrData_fifof_both,
       WILL_FIRE_RL_a4wrData_fifof_decCtr,
       WILL_FIRE_RL_a4wrData_fifof_incCtr,
       WILL_FIRE_RL_a4wrResp_do_enq,
       WILL_FIRE_RL_wci_Es_doAlways_Req,
       WILL_FIRE_RL_wci_cfird_resp,
  ...
  wire [35 : 0] MUX_a4wrData_fifof_q_0$write_1__VAL_1,
		MUX_a4wrData_fifof_q_0$write_1__VAL_2,
		MUX_a4wrData_fifof_q_1$write_1__VAL_2;
  ...
  wire [22 : 0] MUX_a4rdAddr_fifof_q_0$write_1__VAL_2,
		MUX_a4rdAddr_fifof_q_1$write_1__VAL_1,
		MUX_a4rdAddr_fifof_q_1$write_1__VAL_2,
		MUX_a4wrAddr_fifof_q_0$write_1__VAL_2,
		MUX_a4wrAddr_fifof_q_1$write_1__VAL_2;
  wire [1 : 0] MUX_a4rdAddr_fifof_c_r$write_1__VAL_1,
	       MUX_a4rdAddr_fifof_c_r$write_1__VAL_2,
	       MUX_a4wrAddr_fifof_c_r$write_1__VAL_1,
	       MUX_a4wrAddr_fifof_c_r$write_1__VAL_2,
	       MUX_a4wrData_fifof_c_r$write_1__VAL_1,
	       MUX_a4wrData_fifof_c_r$write_1__VAL_2,
	       MUX_wci_respF_c_r$write_1__VAL_1,
	       MUX_wci_respF_c_r$write_1__VAL_2;
  wire MUX_a4rdAddr_fifof_q_0$write_1__SEL_1,
       MUX_a4rdAddr_fifof_q_1$write_1__SEL_1,
       MUX_a4wrAddr_fifof_q_0$write_1__SEL_1,
       MUX_a4wrAddr_fifof_q_1$write_1__SEL_1,
       MUX_a4wrData_fifof_q_0$write_1__SEL_1,
       MUX_a4wrData_fifof_q_1$write_1__SEL_1,
  ...
  // value method axiM0_wrAddr_data
  assign axiM0_wrAddr_data = a4wrAddr_fifof_q_0 ;

  // value method axiM0_wrAddr_valid
  assign axiM0_wrAddr_valid = a4wrAddr_fifof_c_r != 2'd0 ;
  ...
  // value method axiM0_wrData_data
  assign axiM0_wrData_data = a4wrData_fifof_q_0 ;

  // value method axiM0_wrData_valid
  assign axiM0_wrData_valid = a4wrData_fifof_c_r != 2'd0 ;
  ...
  // value method axiM0_wrResp_ready
  assign axiM0_wrResp_ready = a4wrResp_fifof$FULL_N ;

  // value method axiM0_rdAddr_data
  assign axiM0_rdAddr_data = a4rdAddr_fifof_q_0 ;

  // value method axiM0_rdAddr_valid
  assign axiM0_rdAddr_valid = a4rdAddr_fifof_c_r != 2'd0 ;
  ...
  // value method axiM0_rdResp_ready
  assign axiM0_rdResp_ready = a4rdResp_fifof$FULL_N ;

  // submodule a4rdResp_fifof
  FIFO2 #(.width(32'd34),
	  .guarded(32'd1)) a4rdResp_fifof(.RST_N(wciS0_MReset_n),
					  .CLK(wciS0_Clk),
					  .D_IN(a4rdResp_fifof$D_IN),
					  .ENQ(a4rdResp_fifof$ENQ),
					  .DEQ(a4rdResp_fifof$DEQ),
					  .CLR(a4rdResp_fifof$CLR),
					  .D_OUT(a4rdResp_fifof$D_OUT),
					  .FULL_N(a4rdResp_fifof$FULL_N),
					  .EMPTY_N(a4rdResp_fifof$EMPTY_N));

  // submodule a4wrResp_fifof
  FIFO2 #(.width(32'd2),
	  .guarded(32'd1)) a4wrResp_fifof(.RST_N(wciS0_MReset_n),
					  .CLK(wciS0_Clk),
					  .D_IN(a4wrResp_fifof$D_IN),
					  .ENQ(a4wrResp_fifof$ENQ),
					  .DEQ(a4wrResp_fifof$DEQ),
					  .CLR(a4wrResp_fifof$CLR),
					  .D_OUT(),
					  .FULL_N(a4wrResp_fifof$FULL_N),
					  .EMPTY_N(a4wrResp_fifof$EMPTY_N));
  ...
  assign CAN_FIRE_RL_wci_cfwr_resp =
	     wci_respF_c_r != 2'd2 && a4wrResp_fifof$EMPTY_N && wrInFlight ;
  assign WILL_FIRE_RL_wci_cfwr_resp = CAN_FIRE_RL_wci_cfwr_resp ;

  // rule RL_wci_cfird_resp
  assign CAN_FIRE_RL_wci_cfird_resp =
	     wci_respF_c_r != 2'd2 && a4rdResp_fifof$EMPTY_N && rdInFlight ;
  assign WILL_FIRE_RL_wci_cfird_resp =
	     CAN_FIRE_RL_wci_cfird_resp && !WILL_FIRE_RL_wci_cfwr_resp ;
  ...
  assign CAN_FIRE_RL_wci_cfwr =
	     wci_reqF$EMPTY_N && a4wrAddr_fifof_c_r != 2'd2 &&
	     a4wrData_fifof_c_r != 2'd2 &&
	     wci_wci_cfwr_pw$whas &&
	     !wrInFlight ;
  ...
  assign CAN_FIRE_RL_wci_cfrd =
	     wci_reqF$EMPTY_N && a4rdAddr_fifof_c_r != 2'd2 &&
	     wci_wci_cfrd_pw$whas &&
	     !rdInFlight ;
  ...
  // rule RL_a4wrAddr_do_deq
  assign CAN_FIRE_RL_a4wrAddr_do_deq =
	     a4wrAddr_fifof_c_r != 2'd0 && axiM0_wrAddr_ready_value ;
  assign WILL_FIRE_RL_a4wrAddr_do_deq = CAN_FIRE_RL_a4wrAddr_do_deq ;

  // rule RL_a4wrAddr_fifof_incCtr
  assign CAN_FIRE_RL_a4wrAddr_fifof_incCtr =
	     ((a4wrAddr_fifof_c_r == 2'd0) ?
		WILL_FIRE_RL_wci_cfwr :
		a4wrAddr_fifof_c_r != 2'd1 || WILL_FIRE_RL_wci_cfwr) &&
	     WILL_FIRE_RL_wci_cfwr &&
	     !CAN_FIRE_RL_a4wrAddr_do_deq ;
  assign WILL_FIRE_RL_a4wrAddr_fifof_incCtr =
	     CAN_FIRE_RL_a4wrAddr_fifof_incCtr ;

  // rule RL_a4wrAddr_fifof_decCtr
  assign CAN_FIRE_RL_a4wrAddr_fifof_decCtr =
	     CAN_FIRE_RL_a4wrAddr_do_deq && !WILL_FIRE_RL_wci_cfwr ;
  assign WILL_FIRE_RL_a4wrAddr_fifof_decCtr =
	     CAN_FIRE_RL_a4wrAddr_fifof_decCtr ;

  // rule RL_a4wrAddr_fifof_both
  assign CAN_FIRE_RL_a4wrAddr_fifof_both =
	     ((a4wrAddr_fifof_c_r == 2'd1) ?
		WILL_FIRE_RL_wci_cfwr :
		a4wrAddr_fifof_c_r != 2'd2 || WILL_FIRE_RL_wci_cfwr) &&
	     CAN_FIRE_RL_a4wrAddr_do_deq &&
	     WILL_FIRE_RL_wci_cfwr ;
  assign WILL_FIRE_RL_a4wrAddr_fifof_both = CAN_FIRE_RL_a4wrAddr_fifof_both ;

  // rule RL_a4wrData_do_deq
  assign CAN_FIRE_RL_a4wrData_do_deq =
	     a4wrData_fifof_c_r != 2'd0 && axiM0_wrData_ready_value ;
  assign WILL_FIRE_RL_a4wrData_do_deq = CAN_FIRE_RL_a4wrData_do_deq ;

  // rule RL_a4wrData_fifof_incCtr
  assign CAN_FIRE_RL_a4wrData_fifof_incCtr =
	     ((a4wrData_fifof_c_r == 2'd0) ?
		WILL_FIRE_RL_wci_cfwr :
		a4wrData_fifof_c_r != 2'd1 || WILL_FIRE_RL_wci_cfwr) &&
	     WILL_FIRE_RL_wci_cfwr &&
	     !CAN_FIRE_RL_a4wrData_do_deq ;
  assign WILL_FIRE_RL_a4wrData_fifof_incCtr =
	     CAN_FIRE_RL_a4wrData_fifof_incCtr ;

  // rule RL_a4wrData_fifof_decCtr
  assign CAN_FIRE_RL_a4wrData_fifof_decCtr =
	     CAN_FIRE_RL_a4wrData_do_deq && !WILL_FIRE_RL_wci_cfwr ;
  assign WILL_FIRE_RL_a4wrData_fifof_decCtr =
	     CAN_FIRE_RL_a4wrData_fifof_decCtr ;

  // rule RL_a4wrData_fifof_both
  assign CAN_FIRE_RL_a4wrData_fifof_both =
	     ((a4wrData_fifof_c_r == 2'd1) ?
		WILL_FIRE_RL_wci_cfwr :
		a4wrData_fifof_c_r != 2'd2 || WILL_FIRE_RL_wci_cfwr) &&
	     CAN_FIRE_RL_a4wrData_do_deq &&
	     WILL_FIRE_RL_wci_cfwr ;
  assign WILL_FIRE_RL_a4wrData_fifof_both = CAN_FIRE_RL_a4wrData_fifof_both ;

  // rule RL_a4wrResp_do_enq
  assign CAN_FIRE_RL_a4wrResp_do_enq =
	     a4wrResp_fifof$FULL_N && axiM0_wrResp_valid_value ;
  assign WILL_FIRE_RL_a4wrResp_do_enq = CAN_FIRE_RL_a4wrResp_do_enq ;

  // rule RL_a4rdAddr_do_deq
  assign CAN_FIRE_RL_a4rdAddr_do_deq =
	     a4rdAddr_fifof_c_r != 2'd0 && axiM0_rdAddr_ready_value ;
  assign WILL_FIRE_RL_a4rdAddr_do_deq = CAN_FIRE_RL_a4rdAddr_do_deq ;

  // rule RL_a4rdAddr_fifof_incCtr
  assign CAN_FIRE_RL_a4rdAddr_fifof_incCtr =
	     ((a4rdAddr_fifof_c_r == 2'd0) ?
		WILL_FIRE_RL_wci_cfrd :
		a4rdAddr_fifof_c_r != 2'd1 || WILL_FIRE_RL_wci_cfrd) &&
	     WILL_FIRE_RL_wci_cfrd &&
	     !CAN_FIRE_RL_a4rdAddr_do_deq ;
  assign WILL_FIRE_RL_a4rdAddr_fifof_incCtr =
	     CAN_FIRE_RL_a4rdAddr_fifof_incCtr ;

  // rule RL_a4rdAddr_fifof_decCtr
  assign CAN_FIRE_RL_a4rdAddr_fifof_decCtr =
	     CAN_FIRE_RL_a4rdAddr_do_deq && !WILL_FIRE_RL_wci_cfrd ;
  assign WILL_FIRE_RL_a4rdAddr_fifof_decCtr =
	     CAN_FIRE_RL_a4rdAddr_fifof_decCtr ;

  // rule RL_a4rdAddr_fifof_both
  assign CAN_FIRE_RL_a4rdAddr_fifof_both =
	     ((a4rdAddr_fifof_c_r == 2'd1) ?
		WILL_FIRE_RL_wci_cfrd :
		a4rdAddr_fifof_c_r != 2'd2 || WILL_FIRE_RL_wci_cfrd) &&
	     CAN_FIRE_RL_a4rdAddr_do_deq &&
	     WILL_FIRE_RL_wci_cfrd ;
  assign WILL_FIRE_RL_a4rdAddr_fifof_both = CAN_FIRE_RL_a4rdAddr_fifof_both ;

  // rule RL_a4rdResp_do_enq
  assign CAN_FIRE_RL_a4rdResp_do_enq =
	     a4rdResp_fifof$FULL_N && axiM0_rdResp_valid_value ;
  assign WILL_FIRE_RL_a4rdResp_do_enq = CAN_FIRE_RL_a4rdResp_do_enq ;
  ...
  // inputs to muxes for submodule ports
  assign MUX_a4rdAddr_fifof_q_0$write_1__SEL_1 =
	     WILL_FIRE_RL_a4rdAddr_fifof_incCtr &&
	     a4rdAddr_fifof_c_r == 2'd0 ;
  assign MUX_a4rdAddr_fifof_q_1$write_1__SEL_1 =
	     WILL_FIRE_RL_a4rdAddr_fifof_incCtr &&
	     a4rdAddr_fifof_c_r == 2'd1 ;
  assign MUX_a4wrAddr_fifof_q_0$write_1__SEL_1 =
	     WILL_FIRE_RL_a4wrAddr_fifof_incCtr &&
	     a4wrAddr_fifof_c_r == 2'd0 ;
  assign MUX_a4wrAddr_fifof_q_1$write_1__SEL_1 =
	     WILL_FIRE_RL_a4wrAddr_fifof_incCtr &&
	     a4wrAddr_fifof_c_r == 2'd1 ;
  assign MUX_a4wrData_fifof_q_0$write_1__SEL_1 =
	     WILL_FIRE_RL_a4wrData_fifof_incCtr &&
	     a4wrData_fifof_c_r == 2'd0 ;
  assign MUX_a4wrData_fifof_q_1$write_1__SEL_1 =
	     WILL_FIRE_RL_a4wrData_fifof_incCtr &&
	     a4wrData_fifof_c_r == 2'd1 ;
  ...
  assign MUX_a4rdAddr_fifof_c_r$write_1__VAL_1 = a4rdAddr_fifof_c_r + 2'd1 ;
  assign MUX_a4rdAddr_fifof_c_r$write_1__VAL_2 = a4rdAddr_fifof_c_r - 2'd1 ;
  assign MUX_a4rdAddr_fifof_q_0$write_1__VAL_2 =
	     (a4rdAddr_fifof_c_r == 2'd1) ?
	       MUX_a4rdAddr_fifof_q_1$write_1__VAL_1 :
	       a4rdAddr_fifof_q_1 ;
  assign MUX_a4rdAddr_fifof_q_1$write_1__VAL_1 =
	     { 3'd0, wci_reqF$D_OUT[51:32] } ;
  assign MUX_a4rdAddr_fifof_q_1$write_1__VAL_2 =
	     (a4rdAddr_fifof_c_r == 2'd2) ?
	       MUX_a4rdAddr_fifof_q_1$write_1__VAL_1 :
	       23'd0 ;
  assign MUX_a4wrAddr_fifof_c_r$write_1__VAL_1 = a4wrAddr_fifof_c_r + 2'd1 ;
  assign MUX_a4wrAddr_fifof_c_r$write_1__VAL_2 = a4wrAddr_fifof_c_r - 2'd1 ;
  assign MUX_a4wrAddr_fifof_q_0$write_1__VAL_2 =
	     (a4wrAddr_fifof_c_r == 2'd1) ?
	       MUX_a4rdAddr_fifof_q_1$write_1__VAL_1 :
	       a4wrAddr_fifof_q_1 ;
  assign MUX_a4wrAddr_fifof_q_1$write_1__VAL_2 =
	     (a4wrAddr_fifof_c_r == 2'd2) ?
	       MUX_a4rdAddr_fifof_q_1$write_1__VAL_1 :
	       23'd0 ;
  assign MUX_a4wrData_fifof_c_r$write_1__VAL_1 = a4wrData_fifof_c_r + 2'd1 ;
  assign MUX_a4wrData_fifof_c_r$write_1__VAL_2 = a4wrData_fifof_c_r - 2'd1 ;
  assign MUX_a4wrData_fifof_q_0$write_1__VAL_1 =
	     { wci_reqF$D_OUT[55:52], wci_reqF$D_OUT[31:0] } ;
  assign MUX_a4wrData_fifof_q_0$write_1__VAL_2 =
	     (a4wrData_fifof_c_r == 2'd1) ?
	       MUX_a4wrData_fifof_q_0$write_1__VAL_1 :
	       a4wrData_fifof_q_1 ;
  assign MUX_a4wrData_fifof_q_1$write_1__VAL_2 =
	     (a4wrData_fifof_c_r == 2'd2) ?
	       MUX_a4wrData_fifof_q_0$write_1__VAL_1 :
	       36'd0 ;
  ...
  always@(WILL_FIRE_RL_wci_ctl_op_complete or
	  ...
	  WILL_FIRE_RL_wci_cfird_resp or
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 =
	     { 2'd1, a4rdResp_fifof$D_OUT[31:0] } ;
  ...
  assign wci_ctlAckReg_1$whas =
	     ...
	     WILL_FIRE_RL_wci_ctrl_EiI ;
  assign a4wrAddr_fifof_x_wire$wget = MUX_a4rdAddr_fifof_q_1$write_1__VAL_1 ;
  assign a4wrAddr_fifof_x_wire$whas = WILL_FIRE_RL_wci_cfwr ;
  assign a4wrData_fifof_x_wire$wget = MUX_a4wrData_fifof_q_0$write_1__VAL_1 ;
  assign a4wrData_fifof_x_wire$whas = WILL_FIRE_RL_wci_cfwr ;
  assign a4rdAddr_fifof_x_wire$wget = MUX_a4rdAddr_fifof_q_1$write_1__VAL_1 ;
  assign a4rdAddr_fifof_x_wire$whas = WILL_FIRE_RL_wci_cfrd ;
  ...
  assign wci_respF_enqueueing$whas =
	     WILL_FIRE_RL_wci_cfird_resp || WILL_FIRE_RL_wci_cfwr_resp ||
	     WILL_FIRE_RL_wci_ctl_op_complete ;
  ...
  assign wci_wci_ctrl_pw$whas =
	     wci_reqF$EMPTY_N && !wci_reqF$D_OUT[56] &&
	     wci_reqF$D_OUT[59:57] == 3'd2 ;
  assign a4wrAddr_fifof_enqueueing$whas = WILL_FIRE_RL_wci_cfwr ;
  assign a4wrAddr_fifof_dequeueing$whas = CAN_FIRE_RL_a4wrAddr_do_deq ;
  assign a4wrAddr_deq_ready$whas = axiM0_wrAddr_ready_value ;
  assign a4wrAddr_deq_deq$whas = 1'b0 ;
  assign a4wrData_fifof_enqueueing$whas = WILL_FIRE_RL_wci_cfwr ;
  assign a4wrData_fifof_dequeueing$whas = CAN_FIRE_RL_a4wrData_do_deq ;
  assign a4wrData_deq_ready$whas = axiM0_wrData_ready_value ;
  assign a4wrData_deq_deq$whas = 1'b0 ;
  assign a4wrResp_enq_valid$whas = axiM0_wrResp_valid_value ;
  assign a4wrResp_enq_enq$whas = 1'b0 ;
  assign a4rdAddr_fifof_enqueueing$whas = WILL_FIRE_RL_wci_cfrd ;
  assign a4rdAddr_fifof_dequeueing$whas = CAN_FIRE_RL_a4rdAddr_do_deq ;
  assign a4rdAddr_deq_ready$whas = axiM0_rdAddr_ready_value ;
  assign a4rdAddr_deq_deq$whas = 1'b0 ;
  assign a4rdResp_enq_valid$whas = axiM0_rdResp_valid_value ;
  assign a4rdResp_enq_enq$whas = 1'b0 ;
  assign a4wrResp_data_wire$wget = axiM0_wrResp_data_value ;
  assign a4rdResp_data_wire$wget = axiM0_rdResp_data_value ;

  // register a4rdAddr_fifof_c_r
  assign a4rdAddr_fifof_c_r$D_IN =
	     WILL_FIRE_RL_a4rdAddr_fifof_incCtr ?
	       MUX_a4rdAddr_fifof_c_r$write_1__VAL_1 :
	       MUX_a4rdAddr_fifof_c_r$write_1__VAL_2 ;
  assign a4rdAddr_fifof_c_r$EN =
	     WILL_FIRE_RL_a4rdAddr_fifof_incCtr ||
	     WILL_FIRE_RL_a4rdAddr_fifof_decCtr ;

  // register a4rdAddr_fifof_q_0
  always@(MUX_a4rdAddr_fifof_q_0$write_1__SEL_1 or
	  MUX_a4rdAddr_fifof_q_1$write_1__VAL_1 or
	  WILL_FIRE_RL_a4rdAddr_fifof_both or
	  MUX_a4rdAddr_fifof_q_0$write_1__VAL_2 or
	  WILL_FIRE_RL_a4rdAddr_fifof_decCtr or a4rdAddr_fifof_q_1)
  begin
    case (1'b1) // synopsys parallel_case
      MUX_a4rdAddr_fifof_q_0$write_1__SEL_1:
	  a4rdAddr_fifof_q_0$D_IN = MUX_a4rdAddr_fifof_q_1$write_1__VAL_1;
      WILL_FIRE_RL_a4rdAddr_fifof_both:
	  a4rdAddr_fifof_q_0$D_IN = MUX_a4rdAddr_fifof_q_0$write_1__VAL_2;
      WILL_FIRE_RL_a4rdAddr_fifof_decCtr:
	  a4rdAddr_fifof_q_0$D_IN = a4rdAddr_fifof_q_1;
      default: a4rdAddr_fifof_q_0$D_IN =
		   23'b01010101010101010101010 /* unspecified value */ ;
    endcase
  end
  assign a4rdAddr_fifof_q_0$EN =
	     WILL_FIRE_RL_a4rdAddr_fifof_incCtr &&
	     a4rdAddr_fifof_c_r == 2'd0 ||
	     WILL_FIRE_RL_a4rdAddr_fifof_both ||
	     WILL_FIRE_RL_a4rdAddr_fifof_decCtr ;
  ...
  // register a4rdAddr_fifof_q_1
  always@(MUX_a4rdAddr_fifof_q_1$write_1__SEL_1 or
	  MUX_a4rdAddr_fifof_q_1$write_1__VAL_1 or
	  WILL_FIRE_RL_a4rdAddr_fifof_both or
	  MUX_a4rdAddr_fifof_q_1$write_1__VAL_2 or
	  WILL_FIRE_RL_a4rdAddr_fifof_decCtr)
  begin
    case (1'b1) // synopsys parallel_case
      MUX_a4rdAddr_fifof_q_1$write_1__SEL_1:
	  a4rdAddr_fifof_q_1$D_IN = MUX_a4rdAddr_fifof_q_1$write_1__VAL_1;
      WILL_FIRE_RL_a4rdAddr_fifof_both:
	  a4rdAddr_fifof_q_1$D_IN = MUX_a4rdAddr_fifof_q_1$write_1__VAL_2;
      WILL_FIRE_RL_a4rdAddr_fifof_decCtr: a4rdAddr_fifof_q_1$D_IN = 23'd0;
      default: a4rdAddr_fifof_q_1$D_IN =
		   23'b01010101010101010101010 /* unspecified value */ ;
    endcase
  end
  assign a4rdAddr_fifof_q_1$EN =
	     WILL_FIRE_RL_a4rdAddr_fifof_incCtr &&
	     a4rdAddr_fifof_c_r == 2'd1 ||
	     WILL_FIRE_RL_a4rdAddr_fifof_both ||
	     WILL_FIRE_RL_a4rdAddr_fifof_decCtr ;
  ...
  // register a4wrAddr_fifof_c_r
  assign a4wrAddr_fifof_c_r$D_IN =
	     WILL_FIRE_RL_a4wrAddr_fifof_incCtr ?
	       MUX_a4wrAddr_fifof_c_r$write_1__VAL_1 :
	       MUX_a4wrAddr_fifof_c_r$write_1__VAL_2 ;
  assign a4wrAddr_fifof_c_r$EN =
	     WILL_FIRE_RL_a4wrAddr_fifof_incCtr ||
	     WILL_FIRE_RL_a4wrAddr_fifof_decCtr ;

  // register a4wrAddr_fifof_q_0
  always@(MUX_a4wrAddr_fifof_q_0$write_1__SEL_1 or
	  MUX_a4rdAddr_fifof_q_1$write_1__VAL_1 or
	  WILL_FIRE_RL_a4wrAddr_fifof_both or
	  MUX_a4wrAddr_fifof_q_0$write_1__VAL_2 or
	  WILL_FIRE_RL_a4wrAddr_fifof_decCtr or a4wrAddr_fifof_q_1)
  begin
    case (1'b1) // synopsys parallel_case
      MUX_a4wrAddr_fifof_q_0$write_1__SEL_1:
	  a4wrAddr_fifof_q_0$D_IN = MUX_a4rdAddr_fifof_q_1$write_1__VAL_1;
      WILL_FIRE_RL_a4wrAddr_fifof_both:
	  a4wrAddr_fifof_q_0$D_IN = MUX_a4wrAddr_fifof_q_0$write_1__VAL_2;
      WILL_FIRE_RL_a4wrAddr_fifof_decCtr:
	  a4wrAddr_fifof_q_0$D_IN = a4wrAddr_fifof_q_1;
      default: a4wrAddr_fifof_q_0$D_IN =
		   23'b01010101010101010101010 /* unspecified value */ ;
    endcase
  end
  assign a4wrAddr_fifof_q_0$EN =
	     WILL_FIRE_RL_a4wrAddr_fifof_incCtr &&
	     a4wrAddr_fifof_c_r == 2'd0 ||
	     WILL_FIRE_RL_a4wrAddr_fifof_both ||
	     WILL_FIRE_RL_a4wrAddr_fifof_decCtr ;
  ...
  // register a4wrAddr_fifof_q_1
  always@(MUX_a4wrAddr_fifof_q_1$write_1__SEL_1 or
	  MUX_a4rdAddr_fifof_q_1$write_1__VAL_1 or
	  WILL_FIRE_RL_a4wrAddr_fifof_both or
	  MUX_a4wrAddr_fifof_q_1$write_1__VAL_2 or
	  WILL_FIRE_RL_a4wrAddr_fifof_decCtr)
  begin
    case (1'b1) // synopsys parallel_case
      MUX_a4wrAddr_fifof_q_1$write_1__SEL_1:
	  a4wrAddr_fifof_q_1$D_IN = MUX_a4rdAddr_fifof_q_1$write_1__VAL_1;
      WILL_FIRE_RL_a4wrAddr_fifof_both:
	  a4wrAddr_fifof_q_1$D_IN = MUX_a4wrAddr_fifof_q_1$write_1__VAL_2;
      WILL_FIRE_RL_a4wrAddr_fifof_decCtr: a4wrAddr_fifof_q_1$D_IN = 23'd0;
      default: a4wrAddr_fifof_q_1$D_IN =
		   23'b01010101010101010101010 /* unspecified value */ ;
    endcase
  end
  assign a4wrAddr_fifof_q_1$EN =
	     WILL_FIRE_RL_a4wrAddr_fifof_incCtr &&
	     a4wrAddr_fifof_c_r == 2'd1 ||
	     WILL_FIRE_RL_a4wrAddr_fifof_both ||
	     WILL_FIRE_RL_a4wrAddr_fifof_decCtr ;
  ...
  // register a4wrData_fifof_c_r
  assign a4wrData_fifof_c_r$D_IN =
	     WILL_FIRE_RL_a4wrData_fifof_incCtr ?
	       MUX_a4wrData_fifof_c_r$write_1__VAL_1 :
	       MUX_a4wrData_fifof_c_r$write_1__VAL_2 ;
  assign a4wrData_fifof_c_r$EN =
	     WILL_FIRE_RL_a4wrData_fifof_incCtr ||
	     WILL_FIRE_RL_a4wrData_fifof_decCtr ;

  // register a4wrData_fifof_q_0
  always@(MUX_a4wrData_fifof_q_0$write_1__SEL_1 or
	  MUX_a4wrData_fifof_q_0$write_1__VAL_1 or
	  WILL_FIRE_RL_a4wrData_fifof_both or
	  MUX_a4wrData_fifof_q_0$write_1__VAL_2 or
	  WILL_FIRE_RL_a4wrData_fifof_decCtr or a4wrData_fifof_q_1)
  begin
    case (1'b1) // synopsys parallel_case
      MUX_a4wrData_fifof_q_0$write_1__SEL_1:
	  a4wrData_fifof_q_0$D_IN = MUX_a4wrData_fifof_q_0$write_1__VAL_1;
      WILL_FIRE_RL_a4wrData_fifof_both:
	  a4wrData_fifof_q_0$D_IN = MUX_a4wrData_fifof_q_0$write_1__VAL_2;
      WILL_FIRE_RL_a4wrData_fifof_decCtr:
	  a4wrData_fifof_q_0$D_IN = a4wrData_fifof_q_1;
      default: a4wrData_fifof_q_0$D_IN =
		   36'hAAAAAAAAA /* unspecified value */ ;
    endcase
  end
  assign a4wrData_fifof_q_0$EN =
	     WILL_FIRE_RL_a4wrData_fifof_incCtr &&
	     a4wrData_fifof_c_r == 2'd0 ||
	     WILL_FIRE_RL_a4wrData_fifof_both ||
	     WILL_FIRE_RL_a4wrData_fifof_decCtr ;
  ...
  // register a4wrData_fifof_q_1
  always@(MUX_a4wrData_fifof_q_1$write_1__SEL_1 or
	  MUX_a4wrData_fifof_q_0$write_1__VAL_1 or
	  WILL_FIRE_RL_a4wrData_fifof_both or
	  MUX_a4wrData_fifof_q_1$write_1__VAL_2 or
	  WILL_FIRE_RL_a4wrData_fifof_decCtr)
  begin
    case (1'b1) // synopsys parallel_case
      MUX_a4wrData_fifof_q_1$write_1__SEL_1:
	  a4wrData_fifof_q_1$D_IN = MUX_a4wrData_fifof_q_0$write_1__VAL_1;
      WILL_FIRE_RL_a4wrData_fifof_both:
	  a4wrData_fifof_q_1$D_IN = MUX_a4wrData_fifof_q_1$write_1__VAL_2;
      WILL_FIRE_RL_a4wrData_fifof_decCtr: a4wrData_fifof_q_1$D_IN = 36'd0;
      default: a4wrData_fifof_q_1$D_IN =
		   36'hAAAAAAAAA /* unspecified value */ ;
    endcase
  end
  assign a4wrData_fifof_q_1$EN =
	     WILL_FIRE_RL_a4wrData_fifof_incCtr &&
	     a4wrData_fifof_c_r == 2'd1 ||
	     WILL_FIRE_RL_a4wrData_fifof_both ||
	     WILL_FIRE_RL_a4wrData_fifof_decCtr ;
  ...
  // register rdInFlight
  assign rdInFlight$D_IN = !WILL_FIRE_RL_wci_cfird_resp ;
  assign rdInFlight$EN =
	     WILL_FIRE_RL_wci_cfird_resp || WILL_FIRE_RL_wci_cfrd ;
  ...
  // register wrInFlight
  assign wrInFlight$D_IN = !WILL_FIRE_RL_wci_cfwr_resp ;
  assign wrInFlight$EN = WILL_FIRE_RL_wci_cfwr_resp || WILL_FIRE_RL_wci_cfwr ;

  // submodule a4rdResp_fifof
  assign a4rdResp_fifof$D_IN = axiM0_rdResp_data_value ;
  assign a4rdResp_fifof$ENQ = CAN_FIRE_RL_a4rdResp_do_enq ;
  assign a4rdResp_fifof$DEQ = WILL_FIRE_RL_wci_cfird_resp ;
  assign a4rdResp_fifof$CLR = 1'b0 ;

  // submodule a4wrResp_fifof
  assign a4wrResp_fifof$D_IN = axiM0_wrResp_data_value ;
  assign a4wrResp_fifof$ENQ = CAN_FIRE_RL_a4wrResp_do_enq ;
  assign a4wrResp_fifof$DEQ = CAN_FIRE_RL_wci_cfwr_resp ;
  assign a4wrResp_fifof$CLR = 1'b0 ;
  ...
  begin
    if (!wciS0_MReset_n)
      begin
        a4rdAddr_fifof_c_r <= `BSV_ASSIGNMENT_DELAY 2'd0;
	a4rdAddr_fifof_q_0 <= `BSV_ASSIGNMENT_DELAY 23'd0;
	a4rdAddr_fifof_q_1 <= `BSV_ASSIGNMENT_DELAY 23'd0;
	a4wrAddr_fifof_c_r <= `BSV_ASSIGNMENT_DELAY 2'd0;
	a4wrAddr_fifof_q_0 <= `BSV_ASSIGNMENT_DELAY 23'd0;
	a4wrAddr_fifof_q_1 <= `BSV_ASSIGNMENT_DELAY 23'd0;
	a4wrData_fifof_c_r <= `BSV_ASSIGNMENT_DELAY 2'd0;
	a4wrData_fifof_q_0 <= `BSV_ASSIGNMENT_DELAY 36'd0;
	a4wrData_fifof_q_1 <= `BSV_ASSIGNMENT_DELAY 36'd0;
	rdInFlight <= `BSV_ASSIGNMENT_DELAY 1'd0;
	...
	wrInFlight <= `BSV_ASSIGNMENT_DELAY 1'd0;
      end
    else
      begin
        if (a4rdAddr_fifof_c_r$EN)
	  a4rdAddr_fifof_c_r <= `BSV_ASSIGNMENT_DELAY a4rdAddr_fifof_c_r$D_IN;
	if (a4rdAddr_fifof_q_0$EN)
	  a4rdAddr_fifof_q_0 <= `BSV_ASSIGNMENT_DELAY a4rdAddr_fifof_q_0$D_IN;
	if (a4rdAddr_fifof_q_1$EN)
	  a4rdAddr_fifof_q_1 <= `BSV_ASSIGNMENT_DELAY a4rdAddr_fifof_q_1$D_IN;
	if (a4wrAddr_fifof_c_r$EN)
	  a4wrAddr_fifof_c_r <= `BSV_ASSIGNMENT_DELAY a4wrAddr_fifof_c_r$D_IN;
	if (a4wrAddr_fifof_q_0$EN)
	  a4wrAddr_fifof_q_0 <= `BSV_ASSIGNMENT_DELAY a4wrAddr_fifof_q_0$D_IN;
	if (a4wrAddr_fifof_q_1$EN)
	  a4wrAddr_fifof_q_1 <= `BSV_ASSIGNMENT_DELAY a4wrAddr_fifof_q_1$D_IN;
	if (a4wrData_fifof_c_r$EN)
	  a4wrData_fifof_c_r <= `BSV_ASSIGNMENT_DELAY a4wrData_fifof_c_r$D_IN;
	if (a4wrData_fifof_q_0$EN)
	  a4wrData_fifof_q_0 <= `BSV_ASSIGNMENT_DELAY a4wrData_fifof_q_0$D_IN;
	if (a4wrData_fifof_q_1$EN)
	  a4wrData_fifof_q_1 <= `BSV_ASSIGNMENT_DELAY a4wrData_fifof_q_1$D_IN;
	if (rdInFlight$EN)
	  rdInFlight <= `BSV_ASSIGNMENT_DELAY rdInFlight$D_IN;
	...
	if (wrInFlight$EN)
	  wrInFlight <= `BSV_ASSIGNMENT_DELAY wrInFlight$D_IN;
      end
  end
  ...
  initial
  begin
    a4rdAddr_fifof_c_r = 2'h2;
    a4rdAddr_fifof_q_0 = 23'h2AAAAA;
    a4rdAddr_fifof_q_1 = 23'h2AAAAA;
    a4wrAddr_fifof_c_r = 2'h2;
    a4wrAddr_fifof_q_0 = 23'h2AAAAA;
    a4wrAddr_fifof_q_1 = 23'h2AAAAA;
    a4wrData_fifof_c_r = 2'h2;
    a4wrData_fifof_q_0 = 36'hAAAAAAAAA;
    a4wrData_fifof_q_1 = 36'hAAAAAAAAA;
    rdInFlight = 1'h0;
    wci_cEdge = 3'h2;
    wci_cState = 3'h2;
    wci_ctlAckReg = 1'h0;
  ...
  begin
    ...
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wci_cfwr_resp)
	$display("[%0d]: %m: WCI CONFIG WRITE RESPOSNE", v__h8756);
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wci_cfird_resp)
	begin
	  v__h9123 = $time;
	  #0;
	end
