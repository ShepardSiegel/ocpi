...
//
// On Wed Sep 22 10:16:52 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkWCIS2A4LM(wciS0_Clk,
  ...
  wire [35 : 0] MUX_a4wrData_fifof_q_0$write_1__VAL_1,
		...
		MUX_a4wrData_fifof_q_1$write_1__VAL_1;
  ...
  wire [22 : 0] MUX_a4rdAddr_fifof_q_0$write_1__VAL_1,
  ...
  wire MUX_a4rdAddr_fifof_q_0$write_1__SEL_2,
       MUX_a4rdAddr_fifof_q_1$write_1__SEL_2,
       MUX_a4wrAddr_fifof_q_0$write_1__SEL_1,
       MUX_a4wrAddr_fifof_q_1$write_1__SEL_1,
       MUX_a4wrData_fifof_q_0$write_1__SEL_2,
       MUX_a4wrData_fifof_q_1$write_1__SEL_2,
  ...
  assign WILL_FIRE_RL_wci_cfird_resp =
	     CAN_FIRE_RL_wci_cfird_resp && !WILL_FIRE_RL_wci_ctl_op_complete ;
  ...
  assign WILL_FIRE_RL_wci_cfwr_resp =
	     CAN_FIRE_RL_wci_cfwr_resp && !WILL_FIRE_RL_wci_cfird_resp &&
	     !WILL_FIRE_RL_wci_ctl_op_complete ;
  ...
  assign MUX_a4wrData_fifof_q_0$write_1__VAL_1 =
	     (a4wrData_fifof_c_r == 2'd1) ?
	       MUX_a4wrData_fifof_q_0$write_1__VAL_2 :
	       a4wrData_fifof_q_1 ;
  assign MUX_a4wrData_fifof_q_1$write_1__VAL_1 =
	     (a4wrData_fifof_c_r == 2'd2) ?
	       MUX_a4wrData_fifof_q_0$write_1__VAL_2 :
	       36'd0 ;
  ...
  assign MUX_a4rdAddr_fifof_q_0$write_1__SEL_2 =
	     WILL_FIRE_RL_a4rdAddr_fifof_incCtr &&
	     a4rdAddr_fifof_c_r == 2'd0 ;
  assign MUX_a4rdAddr_fifof_q_1$write_1__SEL_2 =
	     WILL_FIRE_RL_a4rdAddr_fifof_incCtr &&
	     a4rdAddr_fifof_c_r == 2'd1 ;
  ...
  assign MUX_a4wrAddr_fifof_q_1$write_1__SEL_1 =
	     WILL_FIRE_RL_a4wrAddr_fifof_incCtr &&
	     a4wrAddr_fifof_c_r == 2'd1 ;
  assign MUX_a4wrData_fifof_q_0$write_1__SEL_2 =
	     WILL_FIRE_RL_a4wrData_fifof_incCtr &&
	     a4wrData_fifof_c_r == 2'd0 ;
  assign MUX_a4wrData_fifof_q_1$write_1__SEL_2 =
	     WILL_FIRE_RL_a4wrData_fifof_incCtr &&
	     a4wrData_fifof_c_r == 2'd1 ;
  ...
  assign wci_respF_enqueueing$whas =
	     WILL_FIRE_RL_wci_cfwr_resp || WILL_FIRE_RL_wci_cfird_resp ||
	     WILL_FIRE_RL_wci_ctl_op_complete ;
  ...
  assign a4wrAddr_fifof_x_wire$wget = MUX_a4rdAddr_fifof_q_0$write_1__VAL_2 ;
  ...
  assign a4wrData_fifof_x_wire$wget = MUX_a4wrData_fifof_q_0$write_1__VAL_2 ;
  ...
  assign a4rdAddr_fifof_x_wire$wget = MUX_a4rdAddr_fifof_q_0$write_1__VAL_2 ;
  ...
  // register a4rdAddr_fifof_q_0
  always@(WILL_FIRE_RL_a4rdAddr_fifof_both or
	  MUX_a4rdAddr_fifof_q_0$write_1__VAL_1 or
	  MUX_a4rdAddr_fifof_q_0$write_1__SEL_2 or
  ...
  begin
    case (1'b1) // synopsys parallel_case
      ...
      MUX_a4rdAddr_fifof_q_0$write_1__SEL_2:
  ...
  always@(WILL_FIRE_RL_a4rdAddr_fifof_both or
	  ...
	  MUX_a4rdAddr_fifof_q_1$write_1__SEL_2 or
	  MUX_a4rdAddr_fifof_q_0$write_1__VAL_2 or
	  WILL_FIRE_RL_a4rdAddr_fifof_decCtr)
  begin
    case (1'b1) // synopsys parallel_case
      ...
      MUX_a4rdAddr_fifof_q_1$write_1__SEL_2:
	  a4rdAddr_fifof_q_1$D_IN = MUX_a4rdAddr_fifof_q_0$write_1__VAL_2;
  ...
  begin
    case (1'b1) // synopsys parallel_case
      MUX_a4wrAddr_fifof_q_0$write_1__SEL_1:
	  a4wrAddr_fifof_q_0$D_IN = MUX_a4rdAddr_fifof_q_0$write_1__VAL_2;
      WILL_FIRE_RL_a4wrAddr_fifof_both:
  ...
  begin
    case (1'b1) // synopsys parallel_case
      MUX_a4wrAddr_fifof_q_1$write_1__SEL_1:
	  a4wrAddr_fifof_q_1$D_IN = MUX_a4rdAddr_fifof_q_0$write_1__VAL_2;
      WILL_FIRE_RL_a4wrAddr_fifof_both:
  ...
  // register a4wrData_fifof_q_0
  always@(WILL_FIRE_RL_a4wrData_fifof_both or
	  MUX_a4wrData_fifof_q_0$write_1__VAL_1 or
	  MUX_a4wrData_fifof_q_0$write_1__SEL_2 or
  ...
  // register a4wrData_fifof_q_1
  always@(WILL_FIRE_RL_a4wrData_fifof_both or
	  MUX_a4wrData_fifof_q_1$write_1__VAL_1 or
	  MUX_a4wrData_fifof_q_1$write_1__SEL_2 or
	  MUX_a4wrData_fifof_q_0$write_1__VAL_2 or
	  WILL_FIRE_RL_a4wrData_fifof_decCtr)
  begin
    case (1'b1) // synopsys parallel_case
      WILL_FIRE_RL_a4wrData_fifof_both:
	  a4wrData_fifof_q_1$D_IN = MUX_a4wrData_fifof_q_1$write_1__VAL_1;
      MUX_a4wrData_fifof_q_1$write_1__SEL_2:
	  a4wrData_fifof_q_1$D_IN = MUX_a4wrData_fifof_q_0$write_1__VAL_2;
  ...
  assign a4wrResp_fifof$DEQ = WILL_FIRE_RL_wci_cfwr_resp ;
  ...
  begin
    ...
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wci_cfwr_resp)
	$display("[%0d]: %m: WCI CONFIG WRITE RESPOSNE", v__h8871);
  end
  // synopsys translate_on
