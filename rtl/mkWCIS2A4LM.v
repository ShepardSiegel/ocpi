...
//
// On Fri Jan  7 16:53:49 EST 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkWCIS2A4LM(wciS0_Clk,
  ...
  wire [35 : 0] MUX_a4l_a4wrData_fifof_q_0$write_1__VAL_1,
		...
		MUX_a4l_a4wrData_fifof_q_1$write_1__VAL_1;
  wire [34 : 0] MUX_a4l_a4rdAddr_fifof_q_0$write_1__VAL_1,
		MUX_a4l_a4rdAddr_fifof_q_1$write_1__VAL_1,
		MUX_a4l_a4rdAddr_fifof_q_1$write_1__VAL_2,
		MUX_a4l_a4wrAddr_fifof_q_0$write_1__VAL_1,
		MUX_a4l_a4wrAddr_fifof_q_1$write_1__VAL_1;
  ...
  wire MUX_a4l_a4rdAddr_fifof_q_0$write_1__SEL_2,
       MUX_a4l_a4rdAddr_fifof_q_1$write_1__SEL_2,
       MUX_a4l_a4wrAddr_fifof_q_0$write_1__SEL_2,
       MUX_a4l_a4wrAddr_fifof_q_1$write_1__SEL_2,
       MUX_a4l_a4wrData_fifof_q_0$write_1__SEL_2,
       MUX_a4l_a4wrData_fifof_q_1$write_1__SEL_2,
  ...
  assign CAN_FIRE_RL_wci_cfwr_resp =
	     ...
	     token$EMPTY_N ;
  assign WILL_FIRE_RL_wci_cfwr_resp = MUX_wci_respF_x_wire$wset_1__SEL_3 ;

  // rule RL_wci_cfrd_resp
  assign CAN_FIRE_RL_wci_cfrd_resp =
	     wci_respF_c_r != 2'd2 && token$EMPTY_N &&
	     a4l_a4rdResp_fifof$EMPTY_N ;
  assign WILL_FIRE_RL_wci_cfrd_resp = MUX_wci_respF_x_wire$wset_1__SEL_2 ;
  ...
  assign CAN_FIRE_RL_wci_cfrd =
	     a4l_a4rdAddr_fifof_c_r != 2'd2 && wci_reqF$EMPTY_N &&
	     token$FULL_N &&
	     wci_wci_cfrd_pw$whas ;
  ...
  // inputs to muxes for submodule ports
  assign MUX_a4l_a4rdAddr_fifof_q_0$write_1__SEL_2 =
	     WILL_FIRE_RL_a4l_a4rdAddr_fifof_incCtr &&
	     a4l_a4rdAddr_fifof_c_r == 2'd0 ;
  assign MUX_a4l_a4rdAddr_fifof_q_1$write_1__SEL_2 =
	     WILL_FIRE_RL_a4l_a4rdAddr_fifof_incCtr &&
	     a4l_a4rdAddr_fifof_c_r == 2'd1 ;
  assign MUX_a4l_a4wrAddr_fifof_q_0$write_1__SEL_2 =
	     WILL_FIRE_RL_a4l_a4wrAddr_fifof_incCtr &&
	     a4l_a4wrAddr_fifof_c_r == 2'd0 ;
  assign MUX_a4l_a4wrAddr_fifof_q_1$write_1__SEL_2 =
	     WILL_FIRE_RL_a4l_a4wrAddr_fifof_incCtr &&
	     a4l_a4wrAddr_fifof_c_r == 2'd1 ;
  assign MUX_a4l_a4wrData_fifof_q_0$write_1__SEL_2 =
	     WILL_FIRE_RL_a4l_a4wrData_fifof_incCtr &&
	     a4l_a4wrData_fifof_c_r == 2'd0 ;
  assign MUX_a4l_a4wrData_fifof_q_1$write_1__SEL_2 =
	     WILL_FIRE_RL_a4l_a4wrData_fifof_incCtr &&
	     a4l_a4wrData_fifof_c_r == 2'd1 ;
  ...
  assign MUX_a4l_a4rdAddr_fifof_q_1$write_1__VAL_1 =
  ...
  assign MUX_a4l_a4wrAddr_fifof_c_r$write_1__VAL_2 =
	     a4l_a4wrAddr_fifof_c_r - 2'd1 ;
  assign MUX_a4l_a4wrAddr_fifof_q_0$write_1__VAL_1 =
	     (a4l_a4wrAddr_fifof_c_r == 2'd1) ?
	       MUX_a4l_a4rdAddr_fifof_q_1$write_1__VAL_2 :
	       a4l_a4wrAddr_fifof_q_1 ;
  assign MUX_a4l_a4wrAddr_fifof_q_1$write_1__VAL_1 =
	     (a4l_a4wrAddr_fifof_c_r == 2'd2) ?
	       MUX_a4l_a4rdAddr_fifof_q_1$write_1__VAL_2 :
	       35'd0 ;
  ...
  assign MUX_a4l_a4wrData_fifof_q_1$write_1__VAL_1 =
	     (a4l_a4wrData_fifof_c_r == 2'd2) ?
	       MUX_a4l_a4wrData_fifof_q_0$write_1__VAL_2 :
	       36'd0 ;
  ...
  // register a4l_a4rdAddr_fifof_q_0
  always@(WILL_FIRE_RL_a4l_a4rdAddr_fifof_both or
	  MUX_a4l_a4rdAddr_fifof_q_0$write_1__VAL_1 or
	  MUX_a4l_a4rdAddr_fifof_q_0$write_1__SEL_2 or
  ...
  begin
    case (1'b1) // synopsys parallel_case
      ...
      MUX_a4l_a4rdAddr_fifof_q_0$write_1__SEL_2:
	  a4l_a4rdAddr_fifof_q_0$D_IN =
	      MUX_a4l_a4rdAddr_fifof_q_1$write_1__VAL_2;
      WILL_FIRE_RL_a4l_a4rdAddr_fifof_decCtr:
  ...
  // register a4l_a4rdAddr_fifof_q_1
  always@(WILL_FIRE_RL_a4l_a4rdAddr_fifof_both or
	  MUX_a4l_a4rdAddr_fifof_q_1$write_1__VAL_1 or
	  MUX_a4l_a4rdAddr_fifof_q_1$write_1__SEL_2 or
	  MUX_a4l_a4rdAddr_fifof_q_1$write_1__VAL_2 or
	  WILL_FIRE_RL_a4l_a4rdAddr_fifof_decCtr)
  begin
    case (1'b1) // synopsys parallel_case
  ...
  // register a4l_a4wrAddr_fifof_q_0
  always@(WILL_FIRE_RL_a4l_a4wrAddr_fifof_both or
	  MUX_a4l_a4wrAddr_fifof_q_0$write_1__VAL_1 or
	  MUX_a4l_a4wrAddr_fifof_q_0$write_1__SEL_2 or
	  MUX_a4l_a4rdAddr_fifof_q_1$write_1__VAL_2 or
  ...
  // register a4l_a4wrAddr_fifof_q_1
  always@(WILL_FIRE_RL_a4l_a4wrAddr_fifof_both or
	  MUX_a4l_a4wrAddr_fifof_q_1$write_1__VAL_1 or
	  MUX_a4l_a4wrAddr_fifof_q_1$write_1__SEL_2 or
	  MUX_a4l_a4rdAddr_fifof_q_1$write_1__VAL_2 or
	  WILL_FIRE_RL_a4l_a4wrAddr_fifof_decCtr)
  begin
    case (1'b1) // synopsys parallel_case
  ...
  // register a4l_a4wrData_fifof_q_0
  always@(WILL_FIRE_RL_a4l_a4wrData_fifof_both or
	  MUX_a4l_a4wrData_fifof_q_0$write_1__VAL_1 or
	  MUX_a4l_a4wrData_fifof_q_0$write_1__SEL_2 or
  ...
  // register a4l_a4wrData_fifof_q_1
  always@(WILL_FIRE_RL_a4l_a4wrData_fifof_both or
	  MUX_a4l_a4wrData_fifof_q_1$write_1__VAL_1 or
	  MUX_a4l_a4wrData_fifof_q_1$write_1__SEL_2 or
	  MUX_a4l_a4wrData_fifof_q_0$write_1__VAL_2 or
	  WILL_FIRE_RL_a4l_a4wrData_fifof_decCtr)
  begin
    case (1'b1) // synopsys parallel_case
  ...
  assign a4l_a4rdResp_fifof$DEQ = MUX_wci_respF_x_wire$wset_1__SEL_2 ;
  ...
  assign a4l_a4wrResp_fifof$DEQ = MUX_wci_respF_x_wire$wset_1__SEL_3 ;
  ...
  begin
    ...
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wci_cfwr_resp)
	$display("[%0d]: %m: WCI CONFIG WRITE RESPOSNE", v__h8701);
    if (wciS0_MReset_n)
