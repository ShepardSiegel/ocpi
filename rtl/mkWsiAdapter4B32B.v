...
//
// On Thu Jan 24 17:40:01 EST 2013
//
//
// Ports:
// Name                         I/O  size props
...
module mkWsiAdapter4B32B(CLK,
  ...
  wire [1 : 0] MUX_wsiM_reqFifo_cntr_r$write_1__VAL_1,
  ...
  // register stage_0
  assign stage_0$D_IN = wsiS_reqFifo$D_OUT ;
  assign stage_0$EN =
  ...
  begin
    ...
    if (stage_0$EN) stage_0 <= `BSV_ASSIGNMENT_DELAY stage_0$D_IN;
