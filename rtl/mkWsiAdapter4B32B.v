...
//
// On Sat Oct  1 13:09:53 EDT 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkWsiAdapter4B32B(CLK,
  ...
  assign CAN_FIRE_RL_doRequestIngress = wsiS_reqFifo$EMPTY_N && !isFull ;
  assign WILL_FIRE_RL_doRequestIngress = CAN_FIRE_RL_doRequestIngress ;

  // rule RL_doRequestEgress
  assign CAN_FIRE_RL_doRequestEgress = wsiM_reqFifo_c_r != 2'd2 && isFull ;
  ...
  assign wsiS_reqFifo_doResetEnq$whas = CAN_FIRE_RL_wsiS_reqFifo_enq ;
  assign wsiS_reqFifo_doResetDeq$whas = CAN_FIRE_RL_doRequestIngress ;
  ...
  // register isFull
  assign isFull$D_IN =
	     WILL_FIRE_RL_doRequestIngress && MUX_isFull$write_1__VAL_1 ;
  assign isFull$EN =
	     WILL_FIRE_RL_doRequestIngress || WILL_FIRE_RL_doRequestEgress ;

  // register isLast
  assign isLast$D_IN =
	     WILL_FIRE_RL_doRequestIngress && wsiS_reqFifo$D_OUT[57] ;
  assign isLast$EN =
	     WILL_FIRE_RL_doRequestIngress || WILL_FIRE_RL_doRequestEgress ;

  // register pos
  assign pos$D_IN =
	     WILL_FIRE_RL_doRequestIngress ? MUX_pos$write_1__VAL_1 : 3'd0 ;
  assign pos$EN =
	     WILL_FIRE_RL_doRequestIngress || WILL_FIRE_RL_doRequestEgress ;

  // register stage
  assign stage$D_IN = wsiS_reqFifo$D_OUT ;
  assign stage$EN = WILL_FIRE_RL_doRequestIngress && pos == 3'd0 ;

  // register stage_1
  assign stage_1$D_IN = wsiS_reqFifo$D_OUT ;
  assign stage_1$EN = WILL_FIRE_RL_doRequestIngress && pos == 3'd1 ;

  // register stage_2
  assign stage_2$D_IN = wsiS_reqFifo$D_OUT ;
  assign stage_2$EN = WILL_FIRE_RL_doRequestIngress && pos == 3'd2 ;

  // register stage_3
  assign stage_3$D_IN = wsiS_reqFifo$D_OUT ;
  assign stage_3$EN = WILL_FIRE_RL_doRequestIngress && pos == 3'd3 ;

  // register stage_4
  assign stage_4$D_IN = wsiS_reqFifo$D_OUT ;
  assign stage_4$EN = WILL_FIRE_RL_doRequestIngress && pos == 3'd4 ;

  // register stage_5
  assign stage_5$D_IN = wsiS_reqFifo$D_OUT ;
  assign stage_5$EN = WILL_FIRE_RL_doRequestIngress && pos == 3'd5 ;

  // register stage_6
  assign stage_6$D_IN = wsiS_reqFifo$D_OUT ;
  assign stage_6$EN = WILL_FIRE_RL_doRequestIngress && pos == 3'd6 ;

  // register stage_7
  assign stage_7$D_IN = wsiS_reqFifo$D_OUT ;
  assign stage_7$EN = WILL_FIRE_RL_doRequestIngress && pos == 3'd7 ;
  ...
  assign wsiS_reqFifo_levelsValid$EN =
	     WILL_FIRE_RL_doRequestIngress || WILL_FIRE_RL_wsiS_reqFifo_enq ||
	     WILL_FIRE_RL_wsiS_reqFifo_reset ;
  ...
  assign wsiS_wordCount$EN = CAN_FIRE_RL_wsiS_reqFifo_enq ;
