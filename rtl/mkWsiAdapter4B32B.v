...
//
// On Fri Jun 24 16:35:31 EDT 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkWsiAdapter4B32B(CLK,
  ...
  assign stage$EN =
	     MUX_wsiS_reqFifo_levelsValid$write_1__SEL_2 && pos == 3'd0 ;

  // register stage_1
  assign stage_1$D_IN = wsiS_reqFifo$D_OUT ;
  assign stage_1$EN =
	     MUX_wsiS_reqFifo_levelsValid$write_1__SEL_2 && pos == 3'd1 ;

  // register stage_2
  assign stage_2$D_IN = wsiS_reqFifo$D_OUT ;
  assign stage_2$EN =
	     MUX_wsiS_reqFifo_levelsValid$write_1__SEL_2 && pos == 3'd2 ;

  // register stage_3
  assign stage_3$D_IN = wsiS_reqFifo$D_OUT ;
  assign stage_3$EN =
	     MUX_wsiS_reqFifo_levelsValid$write_1__SEL_2 && pos == 3'd3 ;

  // register stage_4
  assign stage_4$D_IN = wsiS_reqFifo$D_OUT ;
  assign stage_4$EN =
	     MUX_wsiS_reqFifo_levelsValid$write_1__SEL_2 && pos == 3'd4 ;

  // register stage_5
  assign stage_5$D_IN = wsiS_reqFifo$D_OUT ;
  assign stage_5$EN =
	     MUX_wsiS_reqFifo_levelsValid$write_1__SEL_2 && pos == 3'd5 ;

  // register stage_6
  assign stage_6$D_IN = wsiS_reqFifo$D_OUT ;
  assign stage_6$EN =
	     MUX_wsiS_reqFifo_levelsValid$write_1__SEL_2 && pos == 3'd6 ;

  // register stage_7
  assign stage_7$D_IN = wsiS_reqFifo$D_OUT ;
  assign stage_7$EN =
	     MUX_wsiS_reqFifo_levelsValid$write_1__SEL_2 && pos == 3'd7 ;
