...
//
// On Fri Jun  8 10:57:32 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkPWk_n210(wciS0_Clk,
  ...
  reg [63 : 0] v__h22546, v__h3617, v__h3791, v__h3935;
  ...
  wire [86 : 0] _121583396715528419856163987__q5,
		...
		wWrData__h5887;
  wire [31 : 0] flashStatus__h21530, g_data__h22409;
  wire [2 : 0] a0__h5872,
	       a1__h5871,
	       a2__h5870,
	       a3__h5869,
	       ...
	       s5__h5858,
	       s6__h5857;
  wire _306783360_BIT_i2cC_rPlayIndex_value__74_BITS_6_ETC___d420,
       wci_wslv_reqF_i_notEmpty__4_AND_IF_wci_wslv_re_ETC___d337,
       wci_wslv_reqF_i_notEmpty__4_AND_wci_wslv_reqF__ETC___d316;

  // value method macAddr
  assign macAddr = 48'hAAAAAAAAAAAA ;
  ...
  SizedFIFO #(.p1width(32'd24),
	      .p2depth(32'd16),
	      .p3cntr_width(32'd4),
	      .guarded(32'd1)) i2cC_fRequest(.RST_N(wciS0_MReset_n),
					     .CLK(wciS0_Clk),
  ...
  SizedFIFO #(.p1width(32'd8),
	      .p2depth(32'd16),
	      .p3cntr_width(32'd4),
	      .guarded(32'd1)) i2cC_fResponse(.RST_N(wciS0_MReset_n),
					      .CLK(wciS0_Clk),
  ...
  Counter #(.width(32'd32), .init(32'd6)) i2cC_rPrescaler(.CLK(wciS0_Clk),
							  .RST_N(wciS0_MReset_n),
  ...
  assign MUX_i2cC_rSDA$write_1__VAL_1 =
	     wRdData__h5883[i2cC_rPlayIndex$Q_OUT[6:0]] ;
  assign MUX_i2cC_rSDA$write_1__VAL_2 =
	     wWrData__h5887[i2cC_rPlayIndex$Q_OUT[6:0]] ;
  ...
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_2 = { 2'd1, g_data__h22409 } ;
  ...
  assign i2cC_vrReadData$EN =
	     WILL_FIRE_RL_i2cC_running_read &&
	     _306783360_BIT_i2cC_rPlayIndex_value__74_BITS_6_ETC___d420 ;
  ...
  // submodule i2cC_fRequest
  assign i2cC_fRequest$D_IN = 24'h0 ;
  assign i2cC_fRequest$ENQ = 1'b0 ;
  ...
  assign i2cC_fResponse$DEQ = 1'b0 ;
  ...
  assign i2cC_rPrescaler$DATA_F = 32'd6 ;
  ...
  assign _306783360_BIT_i2cC_rPlayIndex_value__74_BITS_6_ETC___d420 =
	     _306783360__q2[i2cC_rPlayIndex$Q_OUT[6:0]] ;
  assign _306783360__q2 = 117'd306783360 ;
  assign a0__h5872 = {3{i2cC_rAddress[0]}} ;
  assign a1__h5871 = {3{i2cC_rAddress[1]}} ;
  assign a2__h5870 = {3{i2cC_rAddress[2]}} ;
  assign a3__h5869 = {3{i2cC_rAddress[3]}} ;
  assign a4__h5868 = {3{i2cC_rAddress[4]}} ;
  assign a5__h5867 = {3{i2cC_rAddress[5]}} ;
  assign a6__h5866 = {3{i2cC_rAddress[6]}} ;
  assign a7__h5865 = {3{i2cC_rAddress[7]}} ;
  assign d0__h5881 = {3{i2cC_rWriteData[0]}} ;
  assign d1__h5880 = {3{i2cC_rWriteData[1]}} ;
  assign d2__h5879 = {3{i2cC_rWriteData[2]}} ;
  assign d3__h5878 = {3{i2cC_rWriteData[3]}} ;
  assign d4__h5877 = {3{i2cC_rWriteData[4]}} ;
  assign d5__h5876 = {3{i2cC_rWriteData[5]}} ;
  assign d6__h5875 = {3{i2cC_rWriteData[6]}} ;
  assign d7__h5874 = {3{i2cC_rWriteData[7]}} ;
  assign flashStatus__h21530 = { 31'd1, flashC_waitReg } ;
  assign g_data__h22409 =
	     wci_wslv_reqF$D_OUT[51] ?
	       32'd0 :
	       CASE_wci_wslv_reqFD_OUT_BITS_39_TO_32_0_0x0_f_ETC__q1 ;
  assign s0__h5863 = {3{i2cC_rSlaveAddr[0]}} ;
  assign s1__h5862 = {3{i2cC_rSlaveAddr[1]}} ;
  assign s2__h5861 = {3{i2cC_rSlaveAddr[2]}} ;
  assign s3__h5860 = {3{i2cC_rSlaveAddr[3]}} ;
  assign s4__h5859 = {3{i2cC_rSlaveAddr[4]}} ;
  assign s5__h5858 = {3{i2cC_rSlaveAddr[5]}} ;
  assign s6__h5857 = {3{i2cC_rSlaveAddr[6]}} ;
  assign wRdData__h5883 =
	     { 3'b100,
	       s6__h5857,
	       s5__h5858,
	       s4__h5859,
  ...
  assign wWrData__h5887 =
	     { 3'b100,
	       ...
	       d0__h5881,
	       6'd1 } ;
  assign wci_wslv_reqF_i_notEmpty__4_AND_IF_wci_wslv_re_ETC___d337 =
	     wci_wslv_reqF$EMPTY_N &&
	     (wci_wslv_reqF$D_OUT[51] ?
		flashC_reqF$FULL_N :
		wci_wslv_respF_c_r != 2'd2) ;
  assign wci_wslv_reqF_i_notEmpty__4_AND_wci_wslv_reqF__ETC___d316 =
	     wci_wslv_reqF$EMPTY_N &&
	     ((wci_wslv_reqF$D_OUT[39:32] == 8'h14) ?
		flashC_reqF$FULL_N :
		wci_wslv_reqF$D_OUT[39:32] != 8'h18 || flashC_reqF$FULL_N) ;
  always@(wci_wslv_reqF$D_OUT or
	  flashStatus__h21530 or flashCtrl or aReg or wdReg or rdReg)
  begin
  ...
  begin
	...
	$display("Error: \"bsv/pwk/PWk_n210.bsv\", line 44, column 38: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_cfrd] and\n  [RL_advance_response] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n)
	...
	$display("Error: \"bsv/pwk/PWk_n210.bsv\", line 44, column 62: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_ctrl_IsO] and\n  [RL_wci_ctrl_OrE] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wci_ctrl_EiI && WILL_FIRE_RL_wci_ctrl_OrE)
	$display("Error: \"bsv/pwk/PWk_n210.bsv\", line 44, column 48: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_ctrl_EiI] and\n  [RL_wci_ctrl_OrE] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n)
