...
//
// On Fri Sep 21 13:44:12 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkQABSMF3(et0,
  ...
  reg [7 : 0] IF_fork0_ptr_68_EQ_0_86_THEN_fork0_sr_72_BITS__ETC___d1324,
	      IF_fork0_ptr_68_EQ_0_86_THEN_fork0_sr_72_BITS__ETC___d1325,
	      IF_fork0_ptr_68_EQ_0_86_THEN_fork0_sr_72_BITS__ETC___d1326,
	      IF_fork0_ptr_68_EQ_0_86_THEN_fork0_sr_72_BITS__ETC___d1327,
	      IF_fork1_ptr_35_EQ_0_53_THEN_fork1_sr_39_BITS__ETC___d1328,
	      IF_fork1_ptr_35_EQ_0_53_THEN_fork1_sr_39_BITS__ETC___d1329,
	      IF_fork1_ptr_35_EQ_0_53_THEN_fork1_sr_39_BITS__ETC___d1330,
	      IF_fork1_ptr_35_EQ_0_53_THEN_fork1_sr_39_BITS__ETC___d1331;
  ...
  wire [39 : 0] IF_fork0_srcF_first__28_BITS_39_TO_38_29_EQ_0__ETC___d1332,
  ...
  wire [15 : 0] seen__h15791, seen__h26359;
  ...
  wire [7 : 0] IF_merge0_fi0HasPrio_06_THEN_merge0_fi0_first__ETC___d1316,
	       IF_merge0_fi0HasPrio_06_THEN_merge0_fi0_first__ETC___d1317,
	       IF_merge0_fi0HasPrio_06_THEN_merge0_fi0_first__ETC___d1318,
	       IF_merge0_fi0HasPrio_06_THEN_merge0_fi0_first__ETC___d1319,
	       IF_merge1_fi0HasPrio_66_THEN_merge1_fi0_first__ETC___d1320,
	       IF_merge1_fi0HasPrio_66_THEN_merge1_fi0_first__ETC___d1321,
	       IF_merge1_fi0HasPrio_66_THEN_merge1_fi0_first__ETC___d1322,
	       IF_merge1_fi0HasPrio_66_THEN_merge1_fi0_first__ETC___d1323;
  wire [2 : 0] fork0_ptr_68_PLUS_1___d1429, fork1_ptr_35_PLUS_1___d1430;
  ...
  assign MUX_fork0_ptr$write_1__VAL_1 =
	     fork0_stageSent ? 3'd0 : fork0_ptr_68_PLUS_1___d1429 ;
  assign MUX_fork0_ptr$write_1__VAL_2 =
	     (fork0_srcF$D_OUT[9:8] != 2'd0 ||
	      ...
	      fork0_srcF$D_OUT[39:38] != 2'd0) ?
	       3'd0 :
	       fork0_ptr_68_PLUS_1___d1429 ;
  assign MUX_fork1_ptr$write_1__VAL_1 =
	     fork1_stageSent ? 3'd0 : fork1_ptr_35_PLUS_1___d1430 ;
  ...
  // register fork0_match0
  assign fork0_match0$D_IN = et0 == seen__h15791 ;
  ...
  assign fork0_sr$D_IN =
	     { IF_fork0_srcF_first__28_BITS_39_TO_38_29_EQ_0__ETC___d1332,
	       CASE_fork0_sr_BITS_119_TO_118_3_0_fork0_sr_BIT_ETC__q65,
	       fork0_sr[117:110],
	       CASE_fork0_sr_BITS_109_TO_108_3_0_fork0_sr_BIT_ETC__q66,
	       fork0_sr[107:100],
  ...
  // register fork1_match0
  assign fork1_match0$D_IN = did == seen__h26359 ;
  ...
  assign IF_IF_fork0_ptr_68_EQ_0_86_THEN_fork0_sr_72_BI_ETC___d508 =
		 ...
		 2'd2 :
		 2'd3,
	       IF_fork0_ptr_68_EQ_0_86_THEN_fork0_sr_72_BITS__ETC___d1324 } ;
  ...
  assign IF_IF_merge1_fi0HasPrio_66_THEN_merge1_fi0_fir_ETC___d315 =
		...
		merge1_fi1$D_OUT[9:8] == 2'd1) ?
		 ...
		 IF_merge1_fi0HasPrio_66_THEN_merge1_fi0_first__ETC___d1323 } :
	       { IF_IF_merge1_fi0HasPrio_66_THEN_merge1_fi0_fir_ETC___d313,
		 IF_merge1_fi0HasPrio_66_THEN_merge1_fi0_first__ETC___d1323 } ;
  assign IF_fork0_srcF_first__28_BITS_39_TO_38_29_EQ_0__ETC___d1332 =
	     { CASE_fork0_srcFD_OUT_BITS_39_TO_38_3_0_fork0__ETC__q41,
  ...
  assign IF_fork1_srcF_first__95_BITS_39_TO_38_96_EQ_0__ETC___d1333 =
	     { CASE_fork1_srcFD_OUT_BITS_39_TO_38_3_0_fork1__ETC__q45,
  ...
  assign IF_merge0_fi0HasPrio_06_THEN_merge0_fi0_first__ETC___d1300 =
	     merge0_fi0HasPrio ?
	       merge0_fi0$D_OUT[29:28] == 2'd0 :
	       merge0_fi1$D_OUT[29:28] == 2'd0 ;
  assign IF_merge0_fi0HasPrio_06_THEN_merge0_fi0_first__ETC___d1313 =
	     merge0_fi0HasPrio ?
	       merge0_fi0$D_OUT[39:38] == 2'd0 :
	       merge0_fi1$D_OUT[39:38] == 2'd0 ;
  ...
  assign IF_merge0_fi0HasPrio_06_THEN_merge0_fi0_first__ETC___d1318 =
	     merge0_fi0HasPrio ?
	       merge0_fi0$D_OUT[17:10] :
	       merge0_fi1$D_OUT[17:10] ;
  assign IF_merge0_fi0HasPrio_06_THEN_merge0_fi0_first__ETC___d1319 =
	     merge0_fi0HasPrio ?
	       merge0_fi0$D_OUT[7:0] :
	       merge0_fi1$D_OUT[7:0] ;
  assign IF_merge0_fi0HasPrio_06_THEN_merge0_fi0_first__ETC___d1642 =
	     merge0_fi0HasPrio ?
	       merge0_fi0$D_OUT[19:18] == 2'd0 :
	       merge0_fi1$D_OUT[19:18] == 2'd0 ;
  assign IF_merge0_fi0HasPrio_06_THEN_merge0_fi0_first__ETC___d1643 =
	     merge0_fi0HasPrio ?
	       merge0_fi0$D_OUT[9:8] == 2'd0 :
	       merge0_fi1$D_OUT[9:8] == 2'd0 ;
  assign IF_merge1_fi0HasPrio_66_THEN_merge1_fi0_first__ETC___d1305 =
	     merge1_fi0HasPrio ?
	       merge1_fi0$D_OUT[39:38] == 2'd0 :
	       merge1_fi1$D_OUT[39:38] == 2'd0 ;
  assign IF_merge1_fi0HasPrio_66_THEN_merge1_fi0_first__ETC___d1320 =
	     merge1_fi0HasPrio ?
	       merge1_fi0$D_OUT[37:30] :
	       merge1_fi1$D_OUT[37:30] ;
  assign IF_merge1_fi0HasPrio_66_THEN_merge1_fi0_first__ETC___d1321 =
	     merge1_fi0HasPrio ?
	       merge1_fi0$D_OUT[27:20] :
	       merge1_fi1$D_OUT[27:20] ;
  assign IF_merge1_fi0HasPrio_66_THEN_merge1_fi0_first__ETC___d1322 =
	     merge1_fi0HasPrio ?
	       merge1_fi0$D_OUT[17:10] :
	       merge1_fi1$D_OUT[17:10] ;
  assign IF_merge1_fi0HasPrio_66_THEN_merge1_fi0_first__ETC___d1323 =
	     merge1_fi0HasPrio ?
	       merge1_fi0$D_OUT[7:0] :
	       merge1_fi1$D_OUT[7:0] ;
  assign IF_merge1_fi0HasPrio_66_THEN_merge1_fi0_first__ETC___d1645 =
	     merge1_fi0HasPrio ?
	       merge1_fi0$D_OUT[29:28] == 2'd0 :
	       merge1_fi1$D_OUT[29:28] == 2'd0 ;
  assign IF_merge1_fi0HasPrio_66_THEN_merge1_fi0_first__ETC___d1646 =
	     merge1_fi0HasPrio ?
	       merge1_fi0$D_OUT[19:18] == 2'd0 :
	       merge1_fi1$D_OUT[19:18] == 2'd0 ;
  assign IF_merge1_fi0HasPrio_66_THEN_merge1_fi0_first__ETC___d1647 =
	     merge1_fi0HasPrio ?
	       merge1_fi0$D_OUT[9:8] == 2'd0 :
	       merge1_fi1$D_OUT[9:8] == 2'd0 ;
  ...
  assign fork0_ptr_68_PLUS_1___d1429 = fork0_ptr + 3'd1 ;
  assign fork1_ptr_35_PLUS_1___d1430 = fork1_ptr + 3'd1 ;
  ...
  assign seen__h15791 = { fork0_srcF$D_OUT[7:0], fork0_srcF$D_OUT[17:10] } ;
  assign seen__h26359 = { fork1_srcF$D_OUT[27:20], fork1_srcF$D_OUT[37:30] } ;
  ...
  begin
    case (fork0_ptr)
	  ...
	  IF_fork0_ptr_68_EQ_0_86_THEN_fork0_sr_72_BITS__ETC___d1324 =
	      fork0_sr[77:70];
      default: IF_fork0_ptr_68_EQ_0_86_THEN_fork0_sr_72_BITS__ETC___d1324 =
		   fork0_sr[117:110];
    endcase
  end
  always@(fork0_ptr or fork0_sr)
  ...
  begin
    case (fork0_ptr)
	  ...
	  IF_fork0_ptr_68_EQ_0_86_THEN_fork0_sr_72_BITS__ETC___d1325 =
	      fork0_sr[67:60];
      default: IF_fork0_ptr_68_EQ_0_86_THEN_fork0_sr_72_BITS__ETC___d1325 =
		   fork0_sr[107:100];
    endcase
  end
  always@(fork0_ptr or fork0_sr)
  ...
  begin
    case (fork0_ptr)
	  ...
	  IF_fork0_ptr_68_EQ_0_86_THEN_fork0_sr_72_BITS__ETC___d1326 =
	      fork0_sr[57:50];
      default: IF_fork0_ptr_68_EQ_0_86_THEN_fork0_sr_72_BITS__ETC___d1326 =
		   fork0_sr[97:90];
    endcase
  end
  always@(fork0_ptr or fork0_sr)
  ...
  begin
    case (fork0_ptr)
	  ...
	  IF_fork0_ptr_68_EQ_0_86_THEN_fork0_sr_72_BITS__ETC___d1327 =
	      fork0_sr[47:40];
      default: IF_fork0_ptr_68_EQ_0_86_THEN_fork0_sr_72_BITS__ETC___d1327 =
		   fork0_sr[87:80];
    endcase
  end
  always@(fork0_ptr or fork0_sr)
  ...
  begin
    case (fork1_ptr)
	  ...
	  IF_fork1_ptr_35_EQ_0_53_THEN_fork1_sr_39_BITS__ETC___d1328 =
	      fork1_sr[77:70];
      default: IF_fork1_ptr_35_EQ_0_53_THEN_fork1_sr_39_BITS__ETC___d1328 =
		   fork1_sr[117:110];
    endcase
  end
  always@(fork1_ptr or fork1_sr)
  ...
  begin
    case (fork1_ptr)
	  ...
	  IF_fork1_ptr_35_EQ_0_53_THEN_fork1_sr_39_BITS__ETC___d1329 =
	      fork1_sr[67:60];
      default: IF_fork1_ptr_35_EQ_0_53_THEN_fork1_sr_39_BITS__ETC___d1329 =
		   fork1_sr[107:100];
    endcase
  end
  always@(fork1_ptr or fork1_sr)
  ...
  begin
    case (fork1_ptr)
	  ...
	  IF_fork1_ptr_35_EQ_0_53_THEN_fork1_sr_39_BITS__ETC___d1330 =
	      fork1_sr[57:50];
      default: IF_fork1_ptr_35_EQ_0_53_THEN_fork1_sr_39_BITS__ETC___d1330 =
		   fork1_sr[97:90];
    endcase
  end
  always@(fork1_ptr or fork1_sr)
  ...
  begin
    case (fork1_ptr)
	  ...
	  IF_fork1_ptr_35_EQ_0_53_THEN_fork1_sr_39_BITS__ETC___d1331 =
	      fork1_sr[47:40];
      default: IF_fork1_ptr_35_EQ_0_53_THEN_fork1_sr_39_BITS__ETC___d1331 =
		   fork1_sr[87:80];
    endcase
  end
  always@(fork1_ptr or fork1_sr)
