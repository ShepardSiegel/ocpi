...
//
// On Wed Sep 19 10:30:34 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkQABSMF3(et0,
  ...
  wire [15 : 0] seenEt__h16115, seenEt__h26912;
  ...
  wire IF_merge0_fi0HasPrio_06_THEN_merge0_fi0_first__ETC___d1627,
       IF_merge0_fi0HasPrio_06_THEN_merge0_fi0_first__ETC___d1628,
       IF_merge0_fi0HasPrio_06_THEN_merge0_fi0_first__ETC___d1629,
       IF_merge0_fi0HasPrio_06_THEN_merge0_fi0_first__ETC___d1647,
       IF_merge1_fi0HasPrio_66_THEN_merge1_fi0_first__ETC___d1631,
       IF_merge1_fi0HasPrio_66_THEN_merge1_fi0_first__ETC___d1632,
       IF_merge1_fi0HasPrio_66_THEN_merge1_fi0_first__ETC___d1633,
       IF_merge1_fi0HasPrio_66_THEN_merge1_fi0_first__ETC___d1648,
  ...
  // register fork0_match0
  assign fork0_match0$D_IN = seenEt__h16115 == et0 ;
  ...
  // register fork1_match0
  assign fork1_match0$D_IN = seenEt__h26912 == did ;
  ...
  assign IF_merge0_fi0HasPrio_06_THEN_merge0_fi0_first__ETC___d1628 =
	     merge0_fi0HasPrio ?
	       merge0_fi0$D_OUT[19:18] == 2'd0 :
	       merge0_fi1$D_OUT[19:18] == 2'd0 ;
  assign IF_merge0_fi0HasPrio_06_THEN_merge0_fi0_first__ETC___d1629 =
	     merge0_fi0HasPrio ?
	       merge0_fi0$D_OUT[9:8] == 2'd0 :
	       merge0_fi1$D_OUT[9:8] == 2'd0 ;
  assign IF_merge0_fi0HasPrio_06_THEN_merge0_fi0_first__ETC___d1647 =
	     merge0_fi0HasPrio ?
	       merge0_fi0$D_OUT[39:38] == 2'd0 :
	       merge0_fi1$D_OUT[39:38] == 2'd0 ;
  ...
  assign IF_merge1_fi0HasPrio_66_THEN_merge1_fi0_first__ETC___d1632 =
	     merge1_fi0HasPrio ?
	       merge1_fi0$D_OUT[19:18] == 2'd0 :
	       merge1_fi1$D_OUT[19:18] == 2'd0 ;
  assign IF_merge1_fi0HasPrio_66_THEN_merge1_fi0_first__ETC___d1633 =
	     merge1_fi0HasPrio ?
	       merge1_fi0$D_OUT[9:8] == 2'd0 :
	       merge1_fi1$D_OUT[9:8] == 2'd0 ;
  assign IF_merge1_fi0HasPrio_66_THEN_merge1_fi0_first__ETC___d1648 =
	     merge1_fi0HasPrio ?
	       merge1_fi0$D_OUT[39:38] == 2'd0 :
	       merge1_fi1$D_OUT[39:38] == 2'd0 ;
  ...
  assign seenEt__h16115 = { fork0_srcF$D_OUT[7:0], fork0_srcF$D_OUT[17:10] } ;
  assign seenEt__h26912 = { fork1_srcF$D_OUT[7:0], fork1_srcF$D_OUT[17:10] } ;
