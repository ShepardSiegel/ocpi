...
//
// On Mon Sep 24 15:02:57 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkQABSMF3(et0,
  ...
  reg [7 : 0] IF_fork0_ptr_90_EQ_0_08_THEN_fork0_sr_94_BITS__ETC___d1323,
	      IF_fork0_ptr_90_EQ_0_08_THEN_fork0_sr_94_BITS__ETC___d1324,
	      IF_fork0_ptr_90_EQ_0_08_THEN_fork0_sr_94_BITS__ETC___d1325,
	      IF_fork0_ptr_90_EQ_0_08_THEN_fork0_sr_94_BITS__ETC___d1326,
	      IF_fork1_ptr_57_EQ_0_75_THEN_fork1_sr_61_BITS__ETC___d1327,
	      IF_fork1_ptr_57_EQ_0_75_THEN_fork1_sr_61_BITS__ETC___d1328,
	      IF_fork1_ptr_57_EQ_0_75_THEN_fork1_sr_61_BITS__ETC___d1329,
	      IF_fork1_ptr_57_EQ_0_75_THEN_fork1_sr_61_BITS__ETC___d1330;
  ...
  wire [39 : 0] IF_fork0_srcF_first__50_BITS_39_TO_38_51_EQ_0__ETC___d1331,
		IF_fork1_srcF_first__17_BITS_39_TO_38_18_EQ_0__ETC___d1332;
  ...
  wire [15 : 0] seen__h16174, seen__h26999;
  ...
  wire [7 : 0] IF_merge0_fi0HasPrio_06_THEN_merge0_fi0_first__ETC___d1315,
	       ...
	       IF_merge0_fi0HasPrio_06_THEN_merge0_fi0_first__ETC___d1317,
	       IF_merge0_fi0HasPrio_06_THEN_merge0_fi0_first__ETC___d1318,
	       IF_merge1_fi0HasPrio_77_THEN_merge1_fi0_first__ETC___d1319,
  ...
  wire [2 : 0] fork0_ptr_90_PLUS_1___d1433, fork1_ptr_57_PLUS_1___d1434;
  ...
  wire IF_merge0_fi0HasPrio_06_THEN_NOT_merge0_fi0_i__ETC___d113,
       ...
       IF_merge0_fi0HasPrio_06_THEN_merge0_fi0_first__ETC___d1649,
       IF_merge0_fi0HasPrio_06_THEN_merge0_fi0_first__ETC___d1651,
       IF_merge0_fi0HasPrio_06_THEN_merge0_fi0_first__ETC___d1672,
       IF_merge0_fi0HasPrio_06_THEN_merge0_fi0_i_notE_ETC___d118,
       IF_merge1_fi0HasPrio_77_THEN_NOT_merge1_fi0_i__ETC___d1654,
       IF_merge1_fi0HasPrio_77_THEN_NOT_merge1_fi0_i__ETC___d284,
       IF_merge1_fi0HasPrio_77_THEN_merge1_fi0_first__ETC___d1652,
       IF_merge1_fi0HasPrio_77_THEN_merge1_fi0_first__ETC___d1653,
       IF_merge1_fi0HasPrio_77_THEN_merge1_fi0_first__ETC___d1655,
       IF_merge1_fi0HasPrio_77_THEN_merge1_fi0_first__ETC___d1673,
  ...
  assign MUX_fork0_ptr$write_1__VAL_1 =
	     fork0_stageSent ? 3'd0 : fork0_ptr_90_PLUS_1___d1433 ;
  assign MUX_fork0_ptr$write_1__VAL_2 =
	     (fork0_srcF$D_OUT[9:8] != 2'd0 ||
	      ...
	      fork0_srcF$D_OUT[39:38] != 2'd0) ?
	       3'd0 :
	       fork0_ptr_90_PLUS_1___d1433 ;
  assign MUX_fork1_ptr$write_1__VAL_1 =
	     fork1_stageSent ? 3'd0 : fork1_ptr_57_PLUS_1___d1434 ;
  ...
  // register fork0_match0
  assign fork0_match0$D_IN = et0 == seen__h16174 ;
  ...
  assign fork0_sr$D_IN =
	     { IF_fork0_srcF_first__50_BITS_39_TO_38_51_EQ_0__ETC___d1331,
	       CASE_fork0_sr_BITS_119_TO_118_3_0_fork0_sr_BIT_ETC__q65,
	       fork0_sr[117:110],
	       CASE_fork0_sr_BITS_109_TO_108_3_0_fork0_sr_BIT_ETC__q66,
	       fork0_sr[107:100],
  ...
  // register fork1_match0
  assign fork1_match0$D_IN = did == seen__h26999 ;
  ...
  assign IF_IF_merge0_fi0HasPrio_06_THEN_merge0_fi0_fir_ETC___d135 =
		...
		merge0_fi1$D_OUT[39:38] == 2'd1) ?
	       { 2'd1,
		 IF_merge0_fi0HasPrio_06_THEN_merge0_fi0_first__ETC___d1315 } :
  ...
  assign IF_IF_merge1_fi0HasPrio_77_THEN_merge1_fi0_fir_ETC___d337 =
		...
		merge1_fi1$D_OUT[9:8] == 2'd1) ?
		 ...
		 IF_merge1_fi0HasPrio_77_THEN_merge1_fi0_first__ETC___d1322 } :
	       { IF_IF_merge1_fi0HasPrio_77_THEN_merge1_fi0_fir_ETC___d335,
		 IF_merge1_fi0HasPrio_77_THEN_merge1_fi0_first__ETC___d1322 } ;
  assign IF_fork0_srcF_first__50_BITS_39_TO_38_51_EQ_0__ETC___d1331 =
	     { CASE_fork0_srcFD_OUT_BITS_39_TO_38_3_0_fork0__ETC__q41,
  ...
  assign IF_fork1_srcF_first__17_BITS_39_TO_38_18_EQ_0__ETC___d1332 =
	     { CASE_fork1_srcFD_OUT_BITS_39_TO_38_3_0_fork1__ETC__q45,
  ...
  assign IF_merge0_fi0HasPrio_06_THEN_NOT_merge0_fi0_i__ETC___d1650 =
	     IF_merge0_fi0HasPrio_06_THEN_NOT_merge0_fi0_i__ETC___d113 ||
	     (merge0_fi0HasPrio ? merge0_fi0$EMPTY_N : merge0_fi1$EMPTY_N) ;
  assign IF_merge0_fi0HasPrio_06_THEN_merge0_fi0_first__ETC___d1315 =
	     merge0_fi0HasPrio ?
	       merge0_fi0$D_OUT[37:30] :
	       merge0_fi1$D_OUT[37:30] ;
  assign IF_merge0_fi0HasPrio_06_THEN_merge0_fi0_first__ETC___d1316 =
	     merge0_fi0HasPrio ?
	       merge0_fi0$D_OUT[27:20] :
	       merge0_fi1$D_OUT[27:20] ;
  assign IF_merge0_fi0HasPrio_06_THEN_merge0_fi0_first__ETC___d1317 =
	     merge0_fi0HasPrio ?
	       merge0_fi0$D_OUT[17:10] :
	       merge0_fi1$D_OUT[17:10] ;
  assign IF_merge0_fi0HasPrio_06_THEN_merge0_fi0_first__ETC___d1318 =
	     merge0_fi0HasPrio ?
	       merge0_fi0$D_OUT[7:0] :
	       merge0_fi1$D_OUT[7:0] ;
  ...
  assign IF_merge0_fi0HasPrio_06_THEN_merge0_fi0_first__ETC___d1649 =
	     merge0_fi0HasPrio ?
	       merge0_fi0$D_OUT[19:18] == 2'd0 :
	       merge0_fi1$D_OUT[19:18] == 2'd0 ;
  assign IF_merge0_fi0HasPrio_06_THEN_merge0_fi0_first__ETC___d1651 =
	     merge0_fi0HasPrio ?
	       merge0_fi0$D_OUT[9:8] == 2'd0 :
	       merge0_fi1$D_OUT[9:8] == 2'd0 ;
  assign IF_merge0_fi0HasPrio_06_THEN_merge0_fi0_first__ETC___d1672 =
	     merge0_fi0HasPrio ?
	       merge0_fi0$D_OUT[39:38] == 2'd0 :
	       merge0_fi1$D_OUT[39:38] == 2'd0 ;
  assign IF_merge0_fi0HasPrio_06_THEN_merge0_fi0_i_notE_ETC___d118 =
	     merge0_fi0HasPrio ?
	       ...
	       merge0_fi1$EMPTY_N &&
	       IF_merge0_fi0HasPrio_06_THEN_NOT_merge0_fi0_i__ETC___d1650 ;
  assign IF_merge1_fi0HasPrio_77_THEN_NOT_merge1_fi0_i__ETC___d1654 =
	     IF_merge1_fi0HasPrio_77_THEN_NOT_merge1_fi0_i__ETC___d284 ||
  ...
  assign IF_merge1_fi0HasPrio_77_THEN_merge1_fi0_first__ETC___d1319 =
	     merge1_fi0HasPrio ?
	       merge1_fi0$D_OUT[37:30] :
	       merge1_fi1$D_OUT[37:30] ;
  assign IF_merge1_fi0HasPrio_77_THEN_merge1_fi0_first__ETC___d1320 =
	     merge1_fi0HasPrio ?
	       merge1_fi0$D_OUT[27:20] :
	       merge1_fi1$D_OUT[27:20] ;
  assign IF_merge1_fi0HasPrio_77_THEN_merge1_fi0_first__ETC___d1321 =
	     merge1_fi0HasPrio ?
	       merge1_fi0$D_OUT[17:10] :
	       merge1_fi1$D_OUT[17:10] ;
  assign IF_merge1_fi0HasPrio_77_THEN_merge1_fi0_first__ETC___d1322 =
	     merge1_fi0HasPrio ?
	       merge1_fi0$D_OUT[7:0] :
	       merge1_fi1$D_OUT[7:0] ;
  assign IF_merge1_fi0HasPrio_77_THEN_merge1_fi0_first__ETC___d1652 =
	     merge1_fi0HasPrio ?
	       merge1_fi0$D_OUT[29:28] == 2'd0 :
	       merge1_fi1$D_OUT[29:28] == 2'd0 ;
  assign IF_merge1_fi0HasPrio_77_THEN_merge1_fi0_first__ETC___d1653 =
	     merge1_fi0HasPrio ?
	       merge1_fi0$D_OUT[19:18] == 2'd0 :
	       merge1_fi1$D_OUT[19:18] == 2'd0 ;
  assign IF_merge1_fi0HasPrio_77_THEN_merge1_fi0_first__ETC___d1655 =
	     merge1_fi0HasPrio ?
	       merge1_fi0$D_OUT[9:8] == 2'd0 :
	       merge1_fi1$D_OUT[9:8] == 2'd0 ;
  assign IF_merge1_fi0HasPrio_77_THEN_merge1_fi0_first__ETC___d1673 =
	     merge1_fi0HasPrio ?
	       merge1_fi0$D_OUT[39:38] == 2'd0 :
	       merge1_fi1$D_OUT[39:38] == 2'd0 ;
  ...
  assign fork0_ptr_90_PLUS_1___d1433 = fork0_ptr + 3'd1 ;
  assign fork1_ptr_57_PLUS_1___d1434 = fork1_ptr + 3'd1 ;
  assign seen__h16174 = { fork0_srcF$D_OUT[7:0], fork0_srcF$D_OUT[17:10] } ;
  assign seen__h26999 = { fork1_srcF$D_OUT[27:20], fork1_srcF$D_OUT[37:30] } ;
  ...
  begin
    case (fork0_ptr)
	  ...
	  IF_fork0_ptr_90_EQ_0_08_THEN_fork0_sr_94_BITS__ETC___d1323 =
	      fork0_sr[77:70];
      default: IF_fork0_ptr_90_EQ_0_08_THEN_fork0_sr_94_BITS__ETC___d1323 =
		   fork0_sr[117:110];
    endcase
  end
  always@(fork0_ptr or fork0_sr)
  ...
  begin
    case (fork0_ptr)
	  ...
	  IF_fork0_ptr_90_EQ_0_08_THEN_fork0_sr_94_BITS__ETC___d1324 =
	      fork0_sr[67:60];
      default: IF_fork0_ptr_90_EQ_0_08_THEN_fork0_sr_94_BITS__ETC___d1324 =
		   fork0_sr[107:100];
    endcase
  end
  always@(fork0_ptr or fork0_sr)
  ...
  begin
    case (fork0_ptr)
	  ...
	  IF_fork0_ptr_90_EQ_0_08_THEN_fork0_sr_94_BITS__ETC___d1325 =
	      fork0_sr[57:50];
      default: IF_fork0_ptr_90_EQ_0_08_THEN_fork0_sr_94_BITS__ETC___d1325 =
		   fork0_sr[97:90];
    endcase
  end
  always@(fork0_ptr or fork0_sr)
  ...
  begin
    case (fork0_ptr)
	  ...
	  IF_fork0_ptr_90_EQ_0_08_THEN_fork0_sr_94_BITS__ETC___d1326 =
	      fork0_sr[47:40];
      default: IF_fork0_ptr_90_EQ_0_08_THEN_fork0_sr_94_BITS__ETC___d1326 =
		   fork0_sr[87:80];
    endcase
  end
  always@(fork0_ptr or fork0_sr)
  ...
  begin
    case (fork1_ptr)
	  ...
	  IF_fork1_ptr_57_EQ_0_75_THEN_fork1_sr_61_BITS__ETC___d1327 =
	      fork1_sr[77:70];
      default: IF_fork1_ptr_57_EQ_0_75_THEN_fork1_sr_61_BITS__ETC___d1327 =
		   fork1_sr[117:110];
    endcase
  end
  always@(fork1_ptr or fork1_sr)
  ...
  begin
    case (fork1_ptr)
	  ...
	  IF_fork1_ptr_57_EQ_0_75_THEN_fork1_sr_61_BITS__ETC___d1328 =
	      fork1_sr[67:60];
      default: IF_fork1_ptr_57_EQ_0_75_THEN_fork1_sr_61_BITS__ETC___d1328 =
		   fork1_sr[107:100];
    endcase
  end
  always@(fork1_ptr or fork1_sr)
  ...
  begin
    case (fork1_ptr)
	  ...
	  IF_fork1_ptr_57_EQ_0_75_THEN_fork1_sr_61_BITS__ETC___d1329 =
	      fork1_sr[57:50];
      default: IF_fork1_ptr_57_EQ_0_75_THEN_fork1_sr_61_BITS__ETC___d1329 =
		   fork1_sr[97:90];
    endcase
  end
  always@(fork1_ptr or fork1_sr)
  ...
  begin
    case (fork1_ptr)
	  ...
	  IF_fork1_ptr_57_EQ_0_75_THEN_fork1_sr_61_BITS__ETC___d1330 =
	      fork1_sr[47:40];
      default: IF_fork1_ptr_57_EQ_0_75_THEN_fork1_sr_61_BITS__ETC___d1330 =
		   fork1_sr[87:80];
    endcase
  end
  always@(fork1_ptr or fork1_sr)
