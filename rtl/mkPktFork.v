...
//
// On Wed Feb  9 16:44:28 EST 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkPktFork(pfk,
  ...
  reg IF_pfk_BITS_13_TO_12_3_EQ_0_4_THEN_fi_first_BI_ETC___d60;
  wire [6 : 0] y__h729, y__h952;
  wire IF_fi_first_BITS_124_TO_120_0_EQ_0b1010_1_THEN_ETC___d31,
       IF_fi_first_BITS_124_TO_120_0_EQ_0b1010_1_THEN_ETC___d40,
       fi_first_BITS_63_TO_56_3_EQ_pfk_BITS_7_TO_0_4___d58,
  ...
  assign MUX_f0Active$write_1__SEL_1 =
	     WILL_FIRE_RL_select &&
	     IF_pfk_BITS_13_TO_12_3_EQ_0_4_THEN_fi_first_BI_ETC___d60 ;
  ...
  assign IF_fi_first_BITS_124_TO_120_0_EQ_0b1010_1_THEN_ETC___d31 =
	     (fi$D_OUT[124:120] == 5'b01010) ?
	       ...
	       fi$D_OUT[150:144] == y__h952 && pfk[3] == fi$D_OUT[47] ;
  assign IF_fi_first_BITS_124_TO_120_0_EQ_0b1010_1_THEN_ETC___d40 =
	     (fi$D_OUT[124:120] == 5'b01010) ?
	       fi_first_BITS_63_TO_56_3_EQ_pfk_BITS_7_TO_0_4___d58 :
	       pfk[11:8] == fi$D_OUT[60:57] ;
  assign fi_first_BITS_63_TO_56_3_EQ_pfk_BITS_7_TO_0_4___d58 =
  ...
  assign y__h952 = 7'd1 << pfk[6:4] ;
  always@(pfk or
	  IF_fi_first_BITS_124_TO_120_0_EQ_0b1010_1_THEN_ETC___d40 or
	  fi$D_OUT or
	  y__h729 or
	  fi_first_BITS_63_TO_56_3_EQ_pfk_BITS_7_TO_0_4___d58 or
