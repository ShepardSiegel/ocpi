...
//
// On Sun Oct 28 11:00:04 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkPWrk_n210(RST_N_sys0_rst,
  ...
  reg [63 : 0] v__h19784, v__h19959, v__h20103, v__h24410;
  ...
  wire [86 : 0] _121583396715528419856163987__q5,
		...
		wWrData__h1492;
  wire [31 : 0] flashStatus__h23386, g_data__h24270;
  wire [7 : 0] x__h21933;
  wire [2 : 0] a0__h1477,
	       a1__h1476,
	       a2__h1475,
	       ...
	       s5__h1463,
	       s6__h1462;
  wire _306783360_BIT_i2cC_rPlayIndex_value__8_BITS_6__ETC___d391,
  ...
  FIFO2 #(.width(32'd53), .guarded(32'd1)) flashC_reqF(.RST(wciS0_MReset_n),
						       .CLK(wciS0_Clk),
  ...
  FIFO2 #(.width(32'd32), .guarded(32'd1)) flashC_respF(.RST(wciS0_MReset_n),
							.CLK(wciS0_Clk),
  ...
  SizedFIFO #(.p1width(32'd24),
	      .p2depth(32'd16),
	      .p3cntr_width(32'd4),
	      .guarded(32'd1)) i2cC_fRequest(.RST(RST_N_sys0_rst),
					     .CLK(wciS0_Clk),
  ...
  SizedFIFO #(.p1width(32'd8),
	      .p2depth(32'd16),
	      .p3cntr_width(32'd4),
	      .guarded(32'd1)) i2cC_fResponse(.RST(RST_N_sys0_rst),
					      .CLK(wciS0_Clk),
  ...
  assign MUX_i2cC_rSDA$write_1__VAL_1 =
	     wRdData__h1488[i2cC_rPlayIndex$Q_OUT[6:0]] ;
  assign MUX_i2cC_rSDA$write_1__VAL_2 =
	     wWrData__h1492[i2cC_rPlayIndex$Q_OUT[6:0]] ;
  ...
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_2 = { 2'd1, g_data__h24270 } ;
  ...
  assign i2cC_vrReadData$EN =
	     WILL_FIRE_RL_i2cC_running_read &&
	     _306783360_BIT_i2cC_rPlayIndex_value__8_BITS_6__ETC___d391 ;
  ...
  // submodule i2cC_fRequest
  assign i2cC_fRequest$D_IN = { 8'd80, x__h21933, 8'd0 } ;
  ...
  assign _306783360_BIT_i2cC_rPlayIndex_value__8_BITS_6__ETC___d391 =
	     _306783360__q2[i2cC_rPlayIndex$Q_OUT[6:0]] ;
  assign _306783360__q2 = 117'd306783360 ;
  assign a0__h1477 = {3{i2cC_rAddress[0]}} ;
  assign a1__h1476 = {3{i2cC_rAddress[1]}} ;
  assign a2__h1475 = {3{i2cC_rAddress[2]}} ;
  assign a3__h1474 = {3{i2cC_rAddress[3]}} ;
  assign a4__h1473 = {3{i2cC_rAddress[4]}} ;
  assign a5__h1472 = {3{i2cC_rAddress[5]}} ;
  assign a6__h1471 = {3{i2cC_rAddress[6]}} ;
  assign a7__h1470 = {3{i2cC_rAddress[7]}} ;
  assign d0__h1486 = {3{i2cC_rWriteData[0]}} ;
  assign d1__h1485 = {3{i2cC_rWriteData[1]}} ;
  assign d2__h1484 = {3{i2cC_rWriteData[2]}} ;
  assign d3__h1483 = {3{i2cC_rWriteData[3]}} ;
  assign d4__h1482 = {3{i2cC_rWriteData[4]}} ;
  assign d5__h1481 = {3{i2cC_rWriteData[5]}} ;
  assign d6__h1480 = {3{i2cC_rWriteData[6]}} ;
  assign d7__h1479 = {3{i2cC_rWriteData[7]}} ;
  assign flashStatus__h23386 = { 31'd1, flashC_waitReg } ;
  assign g_data__h24270 =
	     wci_wslv_reqF$D_OUT[51] ?
	       32'd0 :
	       CASE_wci_wslv_reqFD_OUT_BITS_39_TO_32_0_0x0_f_ETC__q1 ;
  assign s0__h1468 = {3{i2cC_rSlaveAddr[0]}} ;
  assign s1__h1467 = {3{i2cC_rSlaveAddr[1]}} ;
  assign s2__h1466 = {3{i2cC_rSlaveAddr[2]}} ;
  assign s3__h1465 = {3{i2cC_rSlaveAddr[3]}} ;
  assign s4__h1464 = {3{i2cC_rSlaveAddr[4]}} ;
  assign s5__h1463 = {3{i2cC_rSlaveAddr[5]}} ;
  assign s6__h1462 = {3{i2cC_rSlaveAddr[6]}} ;
  assign wRdData__h1488 =
	     { 3'b100,
	       s6__h1462,
	       s5__h1463,
	       s4__h1464,
  ...
  assign x__h21933 = 8'd8 - doGetMAC ;
  always@(wci_wslv_reqF$D_OUT or
	  flashStatus__h23386 or flashCtrl or aReg or wdReg or rdReg)
  begin
