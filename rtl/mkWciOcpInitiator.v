...
//
// On Mon Nov  8 07:13:06 EST 2010
//
//
// Ports:
// Name                         I/O  size props
...
// wciM0_MFlag                    O     2 reg
// RST_N_wciM0_mReset_n           O     1 reset
// wciM0_Clk                      I     1 clock
// wciM0_MReset_n                 I     1 reset
// wciM0_SResp                    I     2
// wciM0_SData                    I    32
// wciM0_SFlag                    I     2 reg
...
module mkWciOcpInitiator(wciM0_Clk,
			 wciM0_MReset_n,
			 ...
			 RST_N_wciM0_mReset_n);
  input  wciM0_Clk;
  input  wciM0_MReset_n;
  ...
  wire RST_N_wciM0_mReset_n, wciM0_MAddrSpace;
  ...
  wire MUX_initiator_reqF_c_r$write_1__VAL_1,
  ...
  reg [63 : 0] v__h2940,
	       ...
	       v__h3814,
	       v__h3903;
  wire [31 : 0] toCount__h2397, x__h2819;
  wire [26 : 0] IF_initiator_lastControlOp_6_BIT_3_7_THEN_init_ETC___d34;
  wire [3 : 0] x__h2571;
  wire initiator_respTimr_0_ULT_1_SL_initiator_wTimeo_ETC___d185;

  // output resets
  assign RST_N_wciM0_mReset_n = initiator_mReset$OUT_RST_N ;
  ...
  MakeResetA #(.RSTDELAY(32'd16),
	       .init(32'd0)) initiator_mReset(.CLK(wciM0_Clk),
					      .RST_N(wciM0_MReset_n),
					      .DST_CLK(wciM0_Clk),
  ...
  FIFO1 #(.width(32'd34),
	  .guarded(32'd1)) initiator_respF(.RST_N(wciM0_MReset_n),
					   .CLK(wciM0_Clk),
  ...
  assign CAN_FIRE_RL_initiator_wrkBusy =
		...
		initiator_respTimr_0_ULT_1_SL_initiator_wTimeo_ETC___d185 ||
		initiator_respF$FULL_N :
		initiator_respF$FULL_N) &&
	     initiator_busy ;
  ...
  // register initiator_reqF_c_r
  assign initiator_reqF_c_r$D_IN = MUX_initiator_reqF_c_r$write_1__VAL_1 ;
  ...
  assign initiator_wStatus$D_IN =
	     { 4'b0,
	       ...
	       IF_initiator_lastControlOp_6_BIT_3_7_THEN_init_ETC___d34 } ;
  ...
  // remaining internal signals
  assign IF_initiator_lastControlOp_6_BIT_3_7_THEN_init_ETC___d34 =
		 ...
		 3'b111,
	       ...
	       initiator_reqFAIL,
	       initiator_reqERR } ;
  assign initiator_respTimr_0_ULT_1_SL_initiator_wTimeo_ETC___d185 =
	     initiator_respTimr < toCount__h2397 ;
  assign toCount__h2397 = 32'd1 << initiator_wTimeout ;
  assign x__h2571 =
	     initiator_lastConfigBE[4] ? initiator_lastConfigBE[3:0] : 4'hF ;
  assign x__h2819 = initiator_respTimr + 32'd1 ;

  // handling of inlined registers

  always@(posedge wciM0_Clk)
  begin
    if (!wciM0_MReset_n)
      begin
  ...
  begin
    ...
    if (wciM0_MReset_n)
	  ...
	  !initiator_respTimr_0_ULT_1_SL_initiator_wTimeo_ETC___d185 &&
	  initiator_reqPend == 2'd1)
	$display("[%0d]: %m: WORKER CONFIG-WRITE TIMEOUT", v__h2940);
    if (wciM0_MReset_n)
      if (WILL_FIRE_RL_initiator_wrkBusy &&
	  initiator_wciResponse$wget[33:32] == 2'd0 &&
	  !initiator_respTimr_0_ULT_1_SL_initiator_wTimeo_ETC___d185 &&
    ...
    if (wciM0_MReset_n)
	  ...
	  !initiator_respTimr_0_ULT_1_SL_initiator_wTimeo_ETC___d185 &&
	  initiator_reqPend == 2'd2)
	$display("[%0d]: %m: WORKER CONFIG-READ  TIMEOUT", v__h3029);
    if (wciM0_MReset_n)
      if (WILL_FIRE_RL_initiator_wrkBusy &&
	  initiator_wciResponse$wget[33:32] == 2'd0 &&
	  !initiator_respTimr_0_ULT_1_SL_initiator_wTimeo_ETC___d185 &&
    ...
    if (wciM0_MReset_n)
	  ...
	  !initiator_respTimr_0_ULT_1_SL_initiator_wTimeo_ETC___d185 &&
	  initiator_reqPend == 2'd3)
	$display("[%0d]: %m: WORKER CONTROL-OP   TIMEOUT", v__h3118);
    if (wciM0_MReset_n)
      if (WILL_FIRE_RL_initiator_wrkBusy &&
	  initiator_wciResponse$wget[33:32] == 2'd2 &&
	  initiator_reqPend == 2'd1)
    ...
    if (wciM0_MReset_n)
	  ...
	  initiator_wciResponse$wget[33:32] == 2'd2 &&
	  initiator_reqPend == 2'd1)
	$display("[%0d]: %m: WORKER CONFIG-WRITE RESPONSE-FAIL", v__h3330);
    if (wciM0_MReset_n)
      if (WILL_FIRE_RL_initiator_wrkBusy &&
	  initiator_wciResponse$wget[33:32] == 2'd2 &&
	  initiator_reqPend == 2'd2)
    ...
    if (wciM0_MReset_n)
	  ...
	  initiator_wciResponse$wget[33:32] == 2'd2 &&
	  initiator_reqPend == 2'd2)
	$display("[%0d]: %m: WORKER CONFIG-READ  RESPONSE-FAIL", v__h3419);
    if (wciM0_MReset_n)
      if (WILL_FIRE_RL_initiator_wrkBusy &&
	  initiator_wciResponse$wget[33:32] == 2'd2 &&
	  initiator_reqPend == 2'd3)
    ...
    if (wciM0_MReset_n)
	  ...
	  initiator_wciResponse$wget[33:32] == 2'd2 &&
	  initiator_reqPend == 2'd3)
	$display("[%0d]: %m: WORKER CONTROL-OP   RESPONSE-FAIL", v__h3508);
    if (wciM0_MReset_n)
      if (WILL_FIRE_RL_initiator_wrkBusy &&
	  initiator_wciResponse$wget[33:32] == 2'd3 &&
	  initiator_reqPend == 2'd1)
    ...
    if (wciM0_MReset_n)
	  ...
	  initiator_wciResponse$wget[33:32] == 2'd3 &&
	  initiator_reqPend == 2'd1)
	$display("[%0d]: %m: WORKER CONFIG-WRITE RESPONSE-ERR", v__h3725);
    if (wciM0_MReset_n)
      if (WILL_FIRE_RL_initiator_wrkBusy &&
	  initiator_wciResponse$wget[33:32] == 2'd3 &&
	  initiator_reqPend == 2'd2)
    ...
    if (wciM0_MReset_n)
	  ...
	  initiator_wciResponse$wget[33:32] == 2'd3 &&
	  initiator_reqPend == 2'd2)
	$display("[%0d]: %m: WORKER CONFIG-READ  RESPONSE-ERR", v__h3814);
    if (wciM0_MReset_n)
      if (WILL_FIRE_RL_initiator_wrkBusy &&
	  initiator_wciResponse$wget[33:32] == 2'd3 &&
	  initiator_reqPend == 2'd3)
    ...
    if (wciM0_MReset_n)
	  ...
	  initiator_wciResponse$wget[33:32] == 2'd3 &&
	  initiator_reqPend == 2'd3)
	$display("[%0d]: %m: WORKER CONTROL-OP   RESPONSE-ERR", v__h3903);
  end
  // synopsys translate_on
