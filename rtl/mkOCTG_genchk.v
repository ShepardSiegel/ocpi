...
//
// On Thu Jun 10 09:44:36 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkOCTG_genchk(CLK,
  ...
  reg [31 : 0] MUX_rdServer0_fifo_in_data$write_1__VAL_1;
  ...
  assign CAN_FIRE_RL_reqFsm_actionof_l156c15_F =
	     !rdServer0_fifo_in_empty &&
	     (rdServer0_fifo_in_empty || MUX_dwValue$write_1__SEL_2) &&
	     rdServer0_fifo_in_rvr$Q_OUT &&
	     reqFsm_state_mkFSMstate == 6'd19 ;
  ...
  assign CAN_FIRE_RL_reqFsm_action_l138c15 =
	     WILL_FIRE_RL_reqFsm_actionof_l138c15_F ||
	     WILL_FIRE_RL_reqFsm_actionof_l138c15_T ;
  assign WILL_FIRE_RL_reqFsm_action_l138c15 =
	     CAN_FIRE_RL_reqFsm_action_l138c15 ;
  ...
  assign CAN_FIRE_RL_rdServer0_fifo_in_fill_fifo =
	     rdServer0_fifo_in_do_enq$whas && !MUX_dwValue$write_1__SEL_2 ;
  ...
  assign CAN_FIRE_RL_rdServer0_fifo_in_empty_fifo =
	     MUX_dwValue$write_1__SEL_2 && !rdServer0_fifo_in_do_enq$whas ;
  ...
  begin
    case (1'b1) // synopsys parallel_case
      WILL_FIRE_RL_reqFsm_actionof_l138c15_T:
	  MUX_rdServer0_fifo_in_data$write_1__VAL_1 = 32'd16;
      WILL_FIRE_RL_reqFsm_actionof_l152c15_T:
	  MUX_rdServer0_fifo_in_data$write_1__VAL_1 = 32'd196608;
      WILL_FIRE_RL_reqFsm_actionof_l190c15_T:
	  MUX_rdServer0_fifo_in_data$write_1__VAL_1 = 32'd196612;
      WILL_FIRE_RL_reqFsm_actionof_l153c15_T:
	  MUX_rdServer0_fifo_in_data$write_1__VAL_1 = 32'd262144;
      WILL_FIRE_RL_reqFsm_actionof_l191c15_T:
	  MUX_rdServer0_fifo_in_data$write_1__VAL_1 = 32'd262148;
      WILL_FIRE_RL_reqFsm_actionof_l154c15_T:
	  MUX_rdServer0_fifo_in_data$write_1__VAL_1 = 32'd327680;
      WILL_FIRE_RL_reqFsm_actionof_l192c15_T:
	  MUX_rdServer0_fifo_in_data$write_1__VAL_1 = 32'd327684;
      WILL_FIRE_RL_reqFsm_actionof_l155c15_T:
	  MUX_rdServer0_fifo_in_data$write_1__VAL_1 = 32'd917504;
      WILL_FIRE_RL_reqFsm_actionof_l193c15_T:
	  MUX_rdServer0_fifo_in_data$write_1__VAL_1 = 32'd917508;
      WILL_FIRE_RL_reqFsm_actionof_l156c15_T:
	  MUX_rdServer0_fifo_in_data$write_1__VAL_1 = 32'd983040;
      WILL_FIRE_RL_reqFsm_actionof_l194c15_T:
	  MUX_rdServer0_fifo_in_data$write_1__VAL_1 = 32'd983044;
      WILL_FIRE_RL_reqFsm_actionof_l171c15_T:
	  MUX_rdServer0_fifo_in_data$write_1__VAL_1 = 32'd14680100;
      WILL_FIRE_RL_reqFsm_actionof_l173c15_T:
	  MUX_rdServer0_fifo_in_data$write_1__VAL_1 = 32'd14680140;
      WILL_FIRE_RL_reqFsm_actionof_l172c15_T:
	  MUX_rdServer0_fifo_in_data$write_1__VAL_1 = 32'd15728676;
      WILL_FIRE_RL_reqFsm_actionof_l174c15_T:
	  MUX_rdServer0_fifo_in_data$write_1__VAL_1 = 32'd15728716;
      default: MUX_rdServer0_fifo_in_data$write_1__VAL_1 =
  ...
  // inlined wires
  assign rdServer0_fifo_in_do_deq$whas = MUX_dwValue$write_1__SEL_2 ;
  assign rdServer0_fifo_in_do_enq$whas =
	     ...
	     WILL_FIRE_RL_reqFsm_actionof_l138c15_F ||
	     WILL_FIRE_RL_reqFsm_actionof_l138c15_T ;
  assign rdServer0_fifo_in_bypass_enq$wget =
	     MUX_rdServer0_fifo_in_data$write_1__VAL_1 ;
  assign rdServer0_fifo_in_bypass_enq$whas =
	     CAN_FIRE_RL_rdServer0_fifo_in_write_data ;
  assign rdServer0_fifo_out_do_enq$whas = CAN_FIRE_RL_rdServer0_action_l58c5 ;
  assign rdServer0_fifo_out_do_deq$whas = MUX_dwValue$write_1__SEL_2 ;
  assign rdServer0_start_wire$whas = CAN_FIRE_RL_rdServer0_fsm_start ;
  assign rdServer0_fifo_out_bypass_enq$wget = v__h12483 ;
  ...
  assign rdServer0_pw_list_1$whas = CAN_FIRE_RL_rdServer0_action_l53c3 ;
  assign rdServer0_pw_list_2$whas = CAN_FIRE_RL_rdServer0_action_l54c5 ;
  assign rdServer0_pw_list_3$whas = CAN_FIRE_RL_rdServer0_action_l58c5 ;
  ...
  assign rdServer1_fifo_out_bypass_enq$wget = v__h12483 ;
  assign rdServer1_fifo_out_do_enq$whas = CAN_FIRE_RL_rdServer1_action_l79c5 ;
  ...
  assign rdServer1_pw_list_2$whas = CAN_FIRE_RL_rdServer1_action_l74c10 ;
  assign rdServer1_pw_list_1$whas = CAN_FIRE_RL_rdServer1_action_l73c3 ;
  assign rdServer1_pw_list_3$whas = CAN_FIRE_RL_rdServer1_action_l79c5 ;
  assign rdServer1_pw_list_4$whas = 1'b0 ;
  assign reqFsm_start_reg_1$wget = 1'd1 ;
  assign reqFsm_start_wire$wget = 1'd1 ;
  assign reqFsm_start_reg_1$whas = CAN_FIRE_RL_startup ;
  ...
  assign reqFsm_pw_list_1$whas = CAN_FIRE_RL_reqFsm_action_l135c3 ;
  assign reqFsm_pw_list_2$whas = CAN_FIRE_RL_reqFsm_action_l137c5 ;
  assign reqFsm_pw_list_4$whas = CAN_FIRE_RL_reqFsm_action_l138c15_1 ;
  assign reqFsm_pw_list_3$whas = CAN_FIRE_RL_reqFsm_action_l138c15 ;
  ...
  assign reqFsm_pw_list_49$whas = CAN_FIRE_RL_reqFsm_actionof_l192c15_1 ;
  ...
  assign reqFsm_pw_list_56$whas = CAN_FIRE_RL_reqFsm_actionof_l199c14 ;
  ...
  always@(WILL_FIRE_RL_rdServer0_fifo_in_write_data or
	  MUX_rdServer0_fifo_in_data$write_1__VAL_1 or
	  ...
	  WILL_FIRE_RL_reqFsm_actionof_l138c15_F or
	  WILL_FIRE_RL_reqFsm_actionof_l156c15_F)
  case (1'b1)
    WILL_FIRE_RL_rdServer0_fifo_in_write_data:
  ...
  // register rdServer0_state_mkFSMstate
  always@(CAN_FIRE_RL_rdServer0_action_l53c3 or
  ...
  assign rdServer1_enabled$EN = CAN_FIRE_RL_rdServer1_action_l79c5 ;
  ...
  assign rdServer1_fifo_out_empty$EN = CAN_FIRE_RL_rdServer1_action_l79c5 ;

  // register rdServer1_state_mkFSMstate
  always@(CAN_FIRE_RL_rdServer1_action_l73c3 or
  ...
  // register reqFsm_start_reg
  assign reqFsm_start_reg$D_IN = CAN_FIRE_RL_startup ;
  assign reqFsm_start_reg$EN = 1'd1 ;

  // register reqFsm_state_mkFSMstate
  always@(CAN_FIRE_RL_reqFsm_action_l135c3 or
	  WILL_FIRE_RL_reqFsm_actionof_l137c5 or
	  CAN_FIRE_RL_reqFsm_action_l138c15 or
	  WILL_FIRE_RL_reqFsm_actionof_l138c15_1 or
  ...
  begin
    case (1'b1) // synopsys parallel_case
      CAN_FIRE_RL_reqFsm_action_l135c3: reqFsm_state_mkFSMstate$D_IN = 6'd1;
      WILL_FIRE_RL_reqFsm_actionof_l137c5:
	  reqFsm_state_mkFSMstate$D_IN = 6'd2;
      CAN_FIRE_RL_reqFsm_action_l138c15: reqFsm_state_mkFSMstate$D_IN = 6'd3;
      WILL_FIRE_RL_reqFsm_actionof_l138c15_1:
  ...
  assign rdServer0_fifo_out_empty_92_OR_rdServer0_fifo__ETC___d1029 =
	     (rdServer0_fifo_out_empty || MUX_dwValue$write_1__SEL_2) &&
	     rdServer0_fifo_out_rvr$Q_OUT &&
	     (CAN_FIRE_RL_rdServer0_fifo_in_write_data ||
	      !rdServer0_fifo_in_empty) &&
	     inF$EMPTY_N ;
