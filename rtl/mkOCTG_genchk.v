...
//
// On Sat Sep 29 14:27:30 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkOCTG_genchk(CLK,
  ...
  reg [63 : 0] v__h121869,
	       ...
	       v__h19475,
	       v__h9478;
  reg [31 : 0] CASE_chkUnroll_BITS_4_TO_0_x84037_0x4_x83879_0_ETC__q2,
	       CASE_genUnroll_BITS_4_TO_0_x72236_0x4_x72078_0_ETC__q3;
  reg [15 : 0] v__h172004;
  wire [127 : 0] d_data__h170908,
		 d_data__h182355,
		 t_data__h172288,
		 x__h184102,
		 x__h184130,
  ...
  wire [31 : 0] bAddr__h1532,
		...
		x__h184037,
		y__h190539;
  wire [15 : 0] t_be__h172287, v__h171988;
  wire [7 : 0] x__h178977, x__h195325;
  wire NOT_chkUnroll_10_ULE_16_58_59_AND_NOT_chkVal_3_ETC___d814,
       ...
       chkCurBuf_81_ULT_chkNumBuf_82_MINUS_1_83___d971,
       ...
       genCurBuf_41_ULT_genNumBuf_42_MINUS_1_43___d970,
  ...
  assign MUX_chkDoMeta0$write_1__SEL_3 =
	     WILL_FIRE_RL_chkRespMesgContinue && chkUnroll_10_ULE_16___d937 ;
  ...
  assign MUX_chkUnroll$write_1__VAL_3 =
	     chkUnroll_10_ULE_16___d937 ? 32'd0 : chkUnroll - 32'd16 ;
  assign MUX_chkVal$write_1__VAL_1 =
	     chkUnroll_10_ULE_16___d937 ?
	       CASE_chkUnroll_BITS_4_TO_0_x84037_0x4_x83879_0_ETC__q2 :
	       x__h184037 ;
  ...
  assign MUX_outF$enq_1__VAL_3 = { 25'd25296895, x_data__h169563 } ;
  assign MUX_outF$enq_1__VAL_4 =
	     { 1'd1, genUnroll == 32'd4, 23'd196607, d_data__h170908 } ;
  ...
  assign MUX_outF$enq_1__VAL_7 =
	     { 89'h182FFFF40000001FF00000F,
	       ...
	       genOpcode,
	       24'd0 } ;
  assign MUX_outF$enq_1__VAL_8 = { 25'd25296895, x_data__h180971 } ;
  assign MUX_outF$enq_1__VAL_9 = { 25'd25362431, d_data__h182355 } ;
  assign MUX_outF$enq_1__VAL_10 = { 25'd25362431, x_data__h192989 } ;
  ...
  // register chkDebugExp
  assign chkDebugExp$D_IN = x__h184102 ;
  assign chkDebugExp$EN = WILL_FIRE_RL_chkRespMesgContinue ;

  // register chkDebugGot
  assign chkDebugGot$D_IN = x__h184130 ;
  ...
  // register chkRepeat
  assign chkRepeat$D_IN = (chkRepeat == 8'd0) ? chkRepeat : x__h195325 ;
  ...
  // register genDebugPbe
  assign genDebugPbe$D_IN = t_be__h172287 ;
  assign genDebugPbe$EN = WILL_FIRE_RL_genMesgContinue ;

  // register genDebugPdata
  assign genDebugPdata$D_IN = t_data__h172288 ;
  ...
  // register genRepeat
  assign genRepeat$D_IN = (genRepeat == 8'd0) ? genRepeat : x__h178977 ;
  ...
  assign bAddr__h1532 =
	     rdServer0_fifo_in_empty ?
		  ...
		  rdServer0_fifo_in_data) :
	       rdServer0_fifo_in_data ;
  assign chkCurBuf_81_ULT_chkNumBuf_82_MINUS_1_83___d971 =
  ...
  assign chkUnroll_10_ULE_16_58_AND_chkUnroll_10_BITS_4_ETC___d813 =
	     ...
	     (chkUnroll[4:0] == 5'h04 &&
	      ...
	      chkUnroll[4:0] != 5'h04 &&
	      chkUnroll_10_BITS_4_TO_0_50_EQ_0x8_52_AND_NOT__ETC___d810) ;
  assign chkUnroll_10_ULE_16___d937 = chkUnroll <= 32'd16 ;
  assign d_data__h170908 =
	     { 22'd1048576,
	       genUnroll[11:2],
	       32'hFF00000F,
	       genMesgAddr[31:2],
  ...
  assign genCurBuf_41_ULT_genNumBuf_42_MINUS_1_43___d970 =
	     genCurBuf < genNumBuf - 8'd1 ;
  assign genUnroll_35_ULE_16___d923 = genUnroll <= 32'd16 ;
  assign got0__h184086 =
	     { inF$D_OUT[103:96],
	       inF$D_OUT[111:104],
	       inF$D_OUT[119:112],
	       inF$D_OUT[127:120] } ;
  assign got1__h184087 =
	     { inF$D_OUT[71:64],
	       inF$D_OUT[79:72],
	       inF$D_OUT[87:80],
	       inF$D_OUT[95:88] } ;
  assign got2__h184088 =
	     { inF$D_OUT[39:32],
	       inF$D_OUT[47:40],
	       inF$D_OUT[55:48],
	       inF$D_OUT[63:56] } ;
  assign ph_data__h175936 =
  ...
  assign reqFsm_abort_whas__94_AND_reqFsm_abort_wget__9_ETC___d470 =
	     (reqFsm_state_mkFSMstate == 6'd0 ||
	      reqFsm_state_mkFSMstate == 6'd57) &&
	     (!reqFsm_start_reg_1 || reqFsm_state_fired) ;
  assign t_be__h172287 = genUnroll_35_ULE_16___d923 ? v__h171988 : 16'd65535 ;
  assign t_data__h172288 =
	     { genVal[7:0],
	       genVal[15:8],
	       genVal[23:16],
	       genVal[31:24],
	       ...
	       x__h172148[23:16],
	       x__h172148[31:24] } ;
  assign v__h171988 = genUnroll_35_ULE_16___d923 ? v__h172004 : 16'd0 ;
  assign v__h19429 = MUX_rdServer0_fifo_out_data$write_1__VAL_1 ;
  assign x__h172078 = genVal + 32'd1 ;
  assign x__h172113 = genVal + 32'd2 ;
  assign x__h172148 = genVal + 32'd3 ;
  assign x__h172236 = genVal + 32'd4 ;
  assign x__h178977 = genRepeat - 8'd1 ;
  assign x__h183879 = chkVal + 32'd1 ;
  assign x__h183914 = chkVal + 32'd2 ;
  assign x__h183949 = chkVal + 32'd3 ;
  assign x__h184037 = chkVal + 32'd4 ;
  assign x__h184102 = { chkVal, x__h183879, x__h183914, x__h183949 } ;
  assign x__h184130 =
	     { got0__h184086, got1__h184087, got2__h184088, v__h19429 } ;
  assign x__h195325 = chkRepeat - 8'd1 ;
  assign x_data__h169563 = { 48'd130816, tag, 72'h0F00E0002000000000 } ;
  assign x_data__h180971 = { 48'd130816, tag, 72'h0F00F0002000000000 } ;
  assign x_data__h19161 =
	     { 48'd130816, tag, 8'd15, rdServer1_fifo_in_data[31:2], 34'd0 } ;
  assign x_data__h192989 =
	     { 48'd130816, tag, 8'd15, chkMetaAddr[31:2], 34'd0 } ;
  assign x_data__h9152 =
	     { 48'd130816, tag, 8'd15, bAddr__h1532[31:2], 34'd0 } ;
  assign y__h190539 = { 24'd8388608, chkOpcode } ;
  always@(genUnroll)
  begin
    case (genUnroll[4:0])
      5'h04: v__h172004 = 16'hF000;
      5'h08: v__h172004 = 16'hFF00;
      5'h0C: v__h172004 = 16'hFFF0;
      5'h10: v__h172004 = 16'hFFFF;
      default: v__h172004 = 16'd0;
    endcase
  end
  always@(chkUnroll or x__h184037 or x__h183879 or x__h183914 or x__h183949)
  begin
    case (chkUnroll[4:0])
      5'h04:
	  CASE_chkUnroll_BITS_4_TO_0_x84037_0x4_x83879_0_ETC__q2 = x__h183879;
      5'h08:
	  CASE_chkUnroll_BITS_4_TO_0_x84037_0x4_x83879_0_ETC__q2 = x__h183914;
      5'h0C:
	  CASE_chkUnroll_BITS_4_TO_0_x84037_0x4_x83879_0_ETC__q2 = x__h183949;
      default: CASE_chkUnroll_BITS_4_TO_0_x84037_0x4_x83879_0_ETC__q2 =
		   x__h184037;
    endcase
  end
  always@(genUnroll or x__h172236 or x__h172078 or x__h172113 or x__h172148)
  begin
    case (genUnroll[4:0])
      5'h04:
	  CASE_genUnroll_BITS_4_TO_0_x72236_0x4_x72078_0_ETC__q3 = x__h172078;
      5'h08:
	  CASE_genUnroll_BITS_4_TO_0_x72236_0x4_x72078_0_ETC__q3 = x__h172113;
      5'h0C:
	  CASE_genUnroll_BITS_4_TO_0_x72236_0x4_x72078_0_ETC__q3 = x__h172148;
      default: CASE_genUnroll_BITS_4_TO_0_x72236_0x4_x72078_0_ETC__q3 =
		   x__h172236;
    endcase
  end
  ...
  begin
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (reqFsm_state_mkFSMstate == 6'd3)
	$display("[%0d]: %m: Taking Workers out of Reset...", v__h122742);
    if (RST_N != `BSV_RESET_VALUE)
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (reqFsm_state_mkFSMstate == 6'd9)
	$display("[%0d]: %m: Initialize Workers...", v__h129006);
    if (RST_N != `BSV_RESET_VALUE)
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (reqFsm_state_mkFSMstate == 6'd41)
	$display("[%0d]: %m: Start Workers...", v__h155469);
    if (RST_N != `BSV_RESET_VALUE)
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_chkRespMesgContinue && chkUnroll_10_ULE_16___d937 &&
	  chkUnroll[4:0] == 5'h04 &&
	  NOT_chkVal_37_EQ_inF_first__9_BITS_103_TO_96_7_ETC___d792)
	begin
	  v__h188044 = $time;
	...
	$display("[%0d]: %m: chkRespMesg 3DW-L ***MISMATCH*** chkVal:%0x got:%0x (opcode:%0x)",
		 v__h188359,
		 { chkVal, x__h183879, x__h183914 },
		 { got0__h184086, got1__h184087, got2__h184088 },
		 chkOpcode);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_chkRespMesgContinue && chkUnroll_10_ULE_16___d937 &&
	  chkUnroll_10_BITS_4_TO_0_50_EQ_0x10_54_AND_NOT_ETC___d807)
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_reqFsm_action_l137c5)
	$display("[%0d]: %m: Reading Worker Bit Mask...", v__h121869);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_reqFsm_action_l137c5 &&
	  (WILL_FIRE_RL_reqFsm_action_l138c15_T ||
	   WILL_FIRE_RL_reqFsm_action_l138c15_F ||
