...
//
// On Mon Mar 12 15:35:52 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkOCTG_genchk(CLK,
  ...
  assign MUX_chkDoMeta0$write_1__SEL_3 =
	     WILL_FIRE_RL_chkRespMesgContinue && chkUnroll_10_ULE_16___d939 ;
  ...
  assign MUX_chkUnroll$write_1__VAL_3 =
	     chkUnroll_10_ULE_16___d939 ? 32'd0 : chkUnroll - 32'd16 ;
  ...
  assign MUX_genUnroll$write_1__VAL_3 =
	     genUnroll_35_ULE_16___d924 ? 32'd0 : genUnroll - 32'd16 ;
  ...
  assign genDoMeta0$EN =
	     WILL_FIRE_RL_genRespReady && genLen == 32'd0 ||
	     WILL_FIRE_RL_genMesgContinue && genUnroll_35_ULE_16___d924 ||
	     WILL_FIRE_RL_genMesg && genUnroll == 32'd4 ||
	     WILL_FIRE_RL_genMeta0 ;
  ...
  assign chkUnroll_10_ULE_16_58_AND_chkUnroll_10_BITS_4_ETC___d813 =
	     ...
	     (chkUnroll[4:0] == 5'h04 &&
	      ...
	      chkUnroll[4:0] != 5'h04 &&
	      chkUnroll_10_BITS_4_TO_0_50_EQ_0x8_52_AND_NOT__ETC___d810) ;
  assign chkUnroll_10_ULE_16___d939 = chkUnroll <= 32'd16 ;
  ...
  assign genUnroll_35_ULE_16___d924 = genUnroll <= 32'd16 ;
  ...
  assign reqFsm_abort_whas__94_AND_reqFsm_abort_wget__9_ETC___d470 =
	     (reqFsm_state_mkFSMstate == 6'd0 ||
	      reqFsm_state_mkFSMstate == 6'd57) &&
	     (!reqFsm_start_reg_1 || reqFsm_state_fired) ;
  assign t_be__h171900 = genUnroll_35_ULE_16___d924 ? v__h171601 : 16'd65535 ;
  assign t_data__h171901 =
	     { genVal[7:0],
	       ...
	       x__h171761[23:16],
	       x__h171761[31:24] } ;
  assign v__h171601 = genUnroll_35_ULE_16___d924 ? v__h171617 : 16'd0 ;
  ...
  begin
    ...
    if (RST_N)
      if (WILL_FIRE_RL_chkRespMesgContinue && chkUnroll_10_ULE_16___d939 &&
	  chkUnroll[4:0] == 5'h04 &&
	  NOT_chkVal_37_EQ_inF_first__9_BITS_103_TO_96_7_ETC___d792)
	begin
	  v__h187497 = $time;
