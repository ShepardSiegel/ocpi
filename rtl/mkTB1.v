...
//
// On Tue Dec 20 15:22:07 EST 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkTB1(CLK,
  ...
  wire NOT_wci_busy_5_04_AND_IF_wci_wReset_n_5_THEN_N_ETC___d817,
       ...
       wci_respTimr_7_ULT_1_SL_wci_wTimeout_8_9___d1017,
       wsiS_reqFifo_first__99_BITS_43_TO_12_00_EQ_dst_ETC___d1056;
  ...
  assign wciSeqFsm_abort_whas__63_AND_wciSeqFsm_abort_w_ETC___d875 =
	     (wciSeqFsm_state_mkFSMstate == 5'd0 ||
	      wciSeqFsm_state_mkFSMstate == 5'd22) &&
	     (!wciSeqFsm_start_reg_1 || wciSeqFsm_state_fired) ;
  assign wci_respTimr_7_ULT_1_SL_wci_wTimeout_8_9___d1017 =
	     wci_respTimr < toCount__h2445 ;
  assign wsiBurstLength__h65481 = { 4'd0, wsiS_reqFifo$D_OUT[55:44] } ;
  assign wsiS_reqFifo_first__99_BITS_43_TO_12_00_EQ_dst_ETC___d1056 =
  ...
  begin
    ...
    if (RST_N)
      if (simCycle == 16'd1000)
	$display("[%0d]: %m: mkTB1 termination", v__h66080);
    if (RST_N)
