...
//
// On Thu Feb 10 09:44:39 EST 2011
//
//
// Ports:
// Name                         I/O  size props
...
// axiM0_TDATA                    O    64 const
// axiM0_TSTRB                    O     8 const
...
// wsiS0_MByteEn                  I     8
// wsiS0_MReqInfo                 I     8
// axiS0_TDATA                    I    64 unused
// axiS0_TSTRB                    I     8 unused
...
module mkAXISDWorker8B(wciS0_Clk,
		       wciS0_MReset_n,
  ...
  output [63 : 0] axiM0_TDATA;

  // value method axiM0_mTSTRB
  output [7 : 0] axiM0_TSTRB;
  ...
  input  [63 : 0] axiS0_TDATA;

  // action method axiS0_mTSTRB
  input  [7 : 0] axiS0_TSTRB;
  ...
  wire [63 : 0] axiM0_TDATA, wsiM0_MData;
  wire [31 : 0] axiM0_TUSER, wciS0_SData;
  wire [11 : 0] wsiM0_MBurstLength;
  wire [7 : 0] axiM0_TSTRB, wsiM0_MByteEn, wsiM0_MReqInfo;
  wire [2 : 0] wsiM0_MCmd;
  ...
  wire [96 : 0] MUX_wsiM_reqFifo_q_0$write_1__VAL_2,
  ...
  // value method axiM0_mTDATA
  assign axiM0_TDATA = 64'hAAAAAAAAAAAAAAAA ;

  // value method axiM0_mTSTRB
  assign axiM0_TSTRB = 8'hAA ;
