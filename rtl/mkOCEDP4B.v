...
//
// On Fri Sep 14 13:32:41 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkOCEDP4B(pciDevice,
  ...
  wire [12 : 0] edp_tlpBRAM_readNxtDWAddr_PLUS_1__q15,
		...
		spanToNextPage__h85276,
		thisRequestLength__h85277,
		y__h24291,
		y__h33061;
  ...
  wire IF_1_MINUS_edp_tlpBRAM_writeDWAddr_22_BITS_1_T_ETC___d872,
       ...
       hasPush_AND_edp_dpControl_wget__424_BITS_7_TO__ETC___d1626,
  ...
  assign MUX_bml_fabBufsAvail$write_1__VAL_1 =
	     (bml_fabAvail && !bml_remStart) ? x__h107138 : x__h107143 ;
  assign MUX_bml_fabBufsAvail$write_1__VAL_2 =
	     (dpControl[3:2] == 2'd1) ? x__h105787 : 16'd0 ;
  ...
  assign MUX_bml_lclCredit$write_1__VAL_1 =
	     (bml_lclBufDone && !bml_remStart) ? x__h107176 : x__h107181 ;
  ...
  assign MUX_edp_fabMesgAccu$write_1__VAL_2 = edp_fabMesgAccu + y__h85695 ;
  ...
  assign MUX_edp_mesgLengthRemainPush$write_1__VAL_3 =
	     edp_mesgLengthRemainPush - y__h85302 ;
  ...
  assign MUX_edp_remMesgAccu$write_1__VAL_2 =
	     edp_remMesgAccu + { 3'd0, thisRequestLength__h85277 } ;
  assign MUX_edp_srcMesgAccu$write_1__VAL_2 = edp_srcMesgAccu + y__h85393 ;
  ...
  assign MUX_edp_tlpBRAM_mReqF$enq_1__VAL_2 =
	     { 69'h12AAAAAAAAAAAAAAAA,
	       ...
	       thisRequestLength__h85277[11:2],
	       8'd255,
	       rreq_tag__h85470,
	       3'h2 } ;
  ...
  assign MUX_wmi_wmi_respF_q_0$write_1__VAL_1 = { 2'd1, rdata__h101430 } ;
  ...
  assign bram_serverAdapterB_outData_enqData$whas =
	     ...
	     bram_serverAdapterB_s1[0] ;
  assign bram_serverAdapterB_outData_outData$wget = y_avValue__h101266 ;
  ...
  assign bram_serverAdapterB_1_outData_enqData$whas =
	     ...
	     bram_serverAdapterB_1_s1[0] ;
  assign bram_serverAdapterB_1_outData_outData$wget = y_avValue__h101286 ;
  ...
  assign bram_serverAdapterB_2_outData_enqData$whas =
	     ...
	     bram_serverAdapterB_2_s1[0] ;
  assign bram_serverAdapterB_2_outData_outData$wget = y_avValue__h101306 ;
  ...
  assign bram_serverAdapterB_3_outData_enqData$whas =
	     ...
	     bram_serverAdapterB_3_s1[0] ;
  assign bram_serverAdapterB_3_outData_outData$wget = y_avValue__h101326 ;
  ...
  assign wmi_wmi_sFlagReg$D_IN =
	     { y_avValue__h101286[7:0], y_avValue__h101266[23:0] } ;
  ...
  begin
    case (1'b1) // synopsys parallel_case
      ...
      WILL_FIRE_RL_wmi_doWriteFinalize: bram_memory$DIB = x3__h99671;
  ...
  begin
    case (1'b1) // synopsys parallel_case
      ...
      WILL_FIRE_RL_wmi_doWriteFinalize:
	  bram_memory_1$DIB = mesgMeta_opcode__h99711;
  ...
  assign hasPush_AND_edp_dpControl_wget__424_BITS_7_TO__ETC___d1609 =
	     ...
	     edp_mhFsm_abort_whas__328_AND_edp_mhFsm_abort__ETC___d1415 &&
	     !edp_mhFsm_start_reg ;
  assign hasPush_AND_edp_dpControl_wget__424_BITS_7_TO__ETC___d1626 =
	     hasPush && dpControl[7:4] == 4'd0 && dpControl[3:2] == 2'd1 &&
	     dpControl[1:0] == 2'd1 &&
	     edp_fabMeta[128] &&
	     !edp_tlpXmtBusy &&
  ...
  assign rdat__h109181 = { 16'd0, bml_lclNumBufs } ;
  assign rdat__h109189 = { 16'd0, bml_fabNumBufs } ;
  assign rdat__h109197 = { 16'd0, bml_mesgBase } ;
  assign rdat__h109205 = { 16'd0, bml_metaBase } ;
  assign rdat__h109213 = { 16'd0, bml_mesgSize } ;
  assign rdat__h109221 = { 16'd0, bml_metaSize } ;
  assign rdat__h109229 = { 16'd0, bml_lclBufsCF } ;
  assign rdat__h109250 =
	     hasDebugLogic ? { bml_lclBufsAR, bml_fabBufsAvail } : 32'd0 ;
  assign rdat__h109257 =
	     hasDebugLogic ? { bml_remBuf_value, bml_lclBuf_value } : 32'd0 ;
  assign rdat__h109270 =
	     hasDebugLogic ? { bml_lclStarts, bml_lclDones } : 32'd0 ;
  assign rdat__h109277 =
	     hasDebugLogic ? { bml_remStarts, bml_remDones } : 32'd0 ;
  assign rdat__h109284 = hasDebugLogic ? wmi_thisMesg : 32'd0 ;
  assign rdat__h109548 = hasDebugLogic ? wmi_lastMesg : 32'd0 ;
  assign rdat__h109598 =
	     hasDebugLogic ? { wmi_reqCount, wmi_wrtCount } : 32'd0 ;
  assign rdat__h109698 = hasDebugLogic ? 32'hDADEBABE : 32'd0 ;
  assign rdat__h109756 = { 24'd0, dpControl } ;
  assign rdat__h109778 = hasDebugLogic ? edp_flowDiagCount : 32'd0 ;
  assign rdat__h109788 =
	     hasDebugLogic ?
	       { 4'h0,
		 edp_complTimerCount,
		 12'h0,
		 CASE_edp_lastRuleFired_10_1_edp_lastRuleFired__ETC__q5 } :
	       32'd0 ;
  assign rdat__h109910 = hasDebugLogic ? edp_lastMetaV : 32'd0 ;
  assign rdat__h110030 = hasDebugLogic ? edp_lastMetaV_1 : 32'd0 ;
  assign rdat__h110059 = hasDebugLogic ? edp_lastMetaV_2 : 32'd0 ;
  assign rdat__h110088 = hasDebugLogic ? edp_lastMetaV_3 : 32'd0 ;
  assign rdat__h110117 = hasDebugLogic ? 32'hC0DE0111 : 32'd0 ;
  assign rdat__h110147 = hasDebugLogic ? dmaStartTime[31:0] : 32'd0 ;
  assign rdat__h110181 = hasDebugLogic ? dmaStartTime[63:32] : 32'd0 ;
  assign rdat__h110214 = hasDebugLogic ? dmaDoneTime[31:0] : 32'd0 ;
  assign rdat__h110248 = hasDebugLogic ? dmaDoneTime[63:32] : 32'd0 ;
  assign rdat__h110281 = hasDebugLogic ? edp_dbgBytesTxEnq : 32'd0 ;
  assign rdat__h110292 = hasDebugLogic ? edp_dbgBytesTxDeq : 32'd0 ;
  assign rdat__h110303 = hasDebugLogic ? edpDebug : 32'd0 ;
  assign rdata__h40880 =
	     edp_tlpBRAM_readReq_first__061_BITS_30_TO_29_0_ETC___d3062[1] ?
	       ...
	       IF_edp_tlpBRAM_readReq_first__061_BITS_30_TO_2_ETC___d1206 ;
  assign rreq_tag__h85470 =
	     (y__h85302 == edp_mesgLengthRemainPush) ? 8'h01 : 8'h0 ;
  ...
  assign spanToNextPage__h85276 = 13'd4096 - { 1'd0, edp_srcMesgAccu[11:0] } ;
  assign thisRequestLength__h85277 =
	     (x__h85312[12:0] <= spanToNextPage__h85276) ?
	       x__h85312[12:0] :
	       spanToNextPage__h85276 ;
  ...
  assign wmi_wmi_operateD_821_AND_wmi_wmi_peerIsReady_8_ETC___d1996 =
	     ...
	     bram_serverAdapterB_3_cnt_39_SLT_3___d1884 &&
	     wmi_wmi_mFlagF$EMPTY_N ;
  assign x3__h99671 = { 8'd0, wmi_wmi_mFlagF$D_OUT[23:0] } ;
  assign x__h105787 = (dpControl[1:0] == 2'd1) ? bml_fabNumBufs : 16'd0 ;
  assign x__h106911 = bml_lclBufsAR + 16'd1 ;
  assign x__h106916 = bml_lclBufsAR - 16'd1 ;
  assign x__h107023 = bml_lclBufsCF + 16'd1 ;
  assign x__h107060 = bml_lclBufsCF - 16'd1 ;
  assign x__h107138 = bml_fabBufsAvail + 16'd1 ;
  assign x__h107143 = bml_fabBufsAvail - 16'd1 ;
  assign x__h107176 = bml_lclCredit + 16'd1 ;
  assign x__h107181 = bml_lclCredit - 16'd1 ;
  ...
  assign x__h78196 =
	     { edp_tlpBRAM_mRespF$D_OUT[7:0],
	       ...
	       edp_tlpBRAM_mRespF$D_OUT[23:16],
	       edp_tlpBRAM_mRespF$D_OUT[31:24] } ;
  assign x__h83208 = { 15'd0, edp_mesgLengthRemainPush } ;
  assign x__h85312 =
	     (edp_mesgLengthRemainPush <= y__h85314) ?
  ...
  assign y__h85302 = { 4'd0, thisRequestLength__h85277 } ;
  assign y__h85314 = { 4'd0, edp_maxPayloadSize } ;
  assign y__h85393 = { 19'd0, thisRequestLength__h85277 } ;
  assign y__h85644 = (edp_fabMesgAddrMS == 32'd0) ? 10'd1 : 10'd0 ;
  assign y__h85695 = { 20'd0, edp_tlpBRAM_mRespF$D_OUT[71:62], 2'd0 } ;
  assign y_avValue__h101266 =
	     bram_serverAdapterB_outDataCore$EMPTY_N ?
	       bram_serverAdapterB_outDataCore$D_OUT :
	       bram_memory$DOB ;
  assign y_avValue__h101286 =
	     bram_serverAdapterB_1_outDataCore$EMPTY_N ?
	       bram_serverAdapterB_1_outDataCore$D_OUT :
	       bram_memory_1$DOB ;
  assign y_avValue__h101306 =
	     bram_serverAdapterB_2_outDataCore$EMPTY_N ?
	       bram_serverAdapterB_2_outDataCore$D_OUT :
	       bram_memory_2$DOB ;
  assign y_avValue__h101326 =
	     bram_serverAdapterB_3_outDataCore$EMPTY_N ?
	       bram_serverAdapterB_3_outDataCore$D_OUT :
	       bram_memory_3$DOB ;
  ...
  always@(wmi_p4B or
	  y_avValue__h101326 or
	  y_avValue__h101266 or y_avValue__h101286 or y_avValue__h101306)
  begin
    case (wmi_p4B)
      2'd0: rdata__h101430 = y_avValue__h101266;
      2'd1: rdata__h101430 = y_avValue__h101286;
      2'd2: rdata__h101430 = y_avValue__h101306;
      2'd3: rdata__h101430 = y_avValue__h101326;
    endcase
  end
  always@(wci_reqF$D_OUT or
	  ...
	  rdat__h110181 or
	  rdat__h110214 or
	  rdat__h110248 or rdat__h110281 or rdat__h110292 or rdat__h110303)
  begin
    case (wci_reqF$D_OUT[39:32])
      8'h0: _theResult____h109102 = rdat__h109181;
      8'h04: _theResult____h109102 = rdat__h109189;
      8'h08: _theResult____h109102 = rdat__h109197;
      8'h0C: _theResult____h109102 = rdat__h109205;
      8'h10: _theResult____h109102 = rdat__h109213;
      8'h14: _theResult____h109102 = rdat__h109221;
      8'h20: _theResult____h109102 = rdat__h109229;
      8'h24: _theResult____h109102 = 32'hF00DFACE;
      8'h28: _theResult____h109102 = rdat__h109250;
      8'h2C: _theResult____h109102 = rdat__h109257;
      8'h30: _theResult____h109102 = rdat__h109270;
      8'h34: _theResult____h109102 = rdat__h109277;
      8'h38: _theResult____h109102 = rdat__h109284;
      8'h3C: _theResult____h109102 = rdat__h109548;
      8'h40: _theResult____h109102 = rdat__h109598;
      8'h44: _theResult____h109102 = 32'd0;
      8'h48: _theResult____h109102 = rdat__h109698;
      8'h4C: _theResult____h109102 = 32'h00008000;
      8'h50: _theResult____h109102 = bml_fabMesgBase;
      8'h54: _theResult____h109102 = bml_fabMetaBase;
      8'h58: _theResult____h109102 = bml_fabMesgSize;
      8'h5C: _theResult____h109102 = bml_fabMetaSize;
      8'h60: _theResult____h109102 = bml_fabFlowBase;
      8'h64: _theResult____h109102 = bml_fabFlowSize;
      8'h68: _theResult____h109102 = rdat__h109756;
      8'h6C: _theResult____h109102 = rdat__h109778;
      8'h70: _theResult____h109102 = rdat__h109788;
      8'h80: _theResult____h109102 = rdat__h109910;
      8'h84: _theResult____h109102 = rdat__h110030;
      8'h88: _theResult____h109102 = rdat__h110059;
      8'h8C: _theResult____h109102 = rdat__h110088;
      8'h90: _theResult____h109102 = rdat__h110117;
      8'h94: _theResult____h109102 = bml_fabMesgBaseMS;
      8'h98: _theResult____h109102 = bml_fabMetaBaseMS;
      8'h9C: _theResult____h109102 = bml_fabFlowBaseMS;
      8'hA0: _theResult____h109102 = rdat__h110147;
      8'hA4: _theResult____h109102 = rdat__h110181;
      8'hA8: _theResult____h109102 = rdat__h110214;
      8'hAC: _theResult____h109102 = rdat__h110248;
      8'hB0: _theResult____h109102 = rdat__h110281;
      8'hB4: _theResult____h109102 = rdat__h110292;
      8'hB8: _theResult____h109102 = rdat__h110303;
      default: _theResult____h109102 = 32'd0;
    endcase
  end
  always@(edp_tlpBRAM_readReq$D_OUT)
  begin
  ...
  begin
    ...
    if (RST_N)
      if (WILL_FIRE_RL_edp_dmaXmtMetaHead)
	$display("[%0d]: %m: dmaXmtMetaHead FPactMesg-Step5/7", v__h86979);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_edp_dmaXmtDoorbell)
	$display("[%0d]: %m: dmaXmtDoorbell FC/FPactFlow-Step1/1", v__h88292);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_edp_dmaXmtTailEvent)
	$display("[%0d]: %m: dmaXmtTailEvent FPactMesg-Step7/7", v__h87254);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_edp_dmaXmtMetaBody)
	$display("[%0d]: %m: dmaXmtMetaBody FPactMesg-Step6/7", v__h87122);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_edp_dmaTailEventSender)
	$display("[%0d]: %m: dmaTailEventSender - generic", v__h89054);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_wci_cfwr && wci_reqF$D_OUT[39:32] == 8'h18)
	$display("[%0d] %m: fabDoneAvail Event", v__h108467);
    if (RST_N)
