...
//
// On Fri Aug  3 15:54:41 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkOCEDP4B(pciDevice,
  ...
  // inlined wires
  wire [127 : 0] edp_edpTx_new_data$wget;
  ...
  wire [4 : 0] edp_edpTx_delta_enq$wget;
  ...
  wire bml_crdBuf_decAction$whas,
       ...
       edp_dpControl$whas,
       edp_edpTx_delta_deq$wget,
       edp_edpTx_delta_deq$whas,
       edp_edpTx_delta_enq$whas,
       edp_edpTx_new_data$whas,
  ...
  // register edp_edpTx_num_empty
  reg [5 : 0] edp_edpTx_num_empty;
  wire [5 : 0] edp_edpTx_num_empty$D_IN;
  wire edp_edpTx_num_empty$EN;

  // register edp_edpTx_num_full
  reg [5 : 0] edp_edpTx_num_full;
  wire [5 : 0] edp_edpTx_num_full$D_IN;
  wire edp_edpTx_num_full$EN;

  // register edp_edpTx_vec
  reg [255 : 0] edp_edpTx_vec;
  wire [255 : 0] edp_edpTx_vec$D_IN;
  wire edp_edpTx_vec$EN;
  ...
  reg [63 : 0] v__h15543,
	       ...
	       v__h99753,
	       v__h99907;
  reg [31 : 0] IF_0_MINUS_edp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2197,
	       IF_1_MINUS_edp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2198,
	       IF_2_MINUS_edp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2199,
	       IF_3_MINUS_edp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2200,
	       IF_edp_tlpBRAM_readReq_first__97_BITS_30_TO_29_ETC___d2549,
	       _theResult____h99891,
	       rdata__h92299;
  ...
  reg CASE_dpControl_BITS_1_TO_0_NOT_bml_fabDone_0_N_ETC__q6,
      ...
      IF_0_MINUS_edp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2587,
      IF_0_MINUS_edp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d675,
      IF_1_MINUS_edp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2588,
      IF_1_MINUS_edp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d685,
      IF_2_MINUS_edp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2589,
      IF_2_MINUS_edp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d695,
      IF_3_MINUS_edp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2590,
      IF_3_MINUS_edp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d705,
      IF_bml_dpControl_wget__765_BITS_1_TO_0_771_EQ__ETC___d1842,
      IF_edp_tlpBRAM_readReq_first__97_BITS_30_TO_29_ETC___d912,
      IF_wmi_addr_591_BITS_3_TO_2_592_EQ_0_593_THEN__ETC___d2559,
      IF_wmi_p4B_648_EQ_1_651_THEN_bram_serverAdapte_ETC___d1657;
  wire [255 : 0] edp_edpTx_vec_135_SRL_edp_edpTx_delta_deq_whas_ETC___d2306;
  wire [127 : 0] IF_edp_tlpBRAM_readReq_first__97_BITS_30_TO_29_ETC___d1037,
		 ...
		 rdata__h33886;
  wire [31 : 0] bml_fabFlowAddr_804_PLUS_bml_fabFlowSize_805___d2304,
		mesgMeta_opcode__h90580,
		nowLS__h77560,
		nowMS__h76617,
		opcode__h75386,
		rdat__h100002,
  ...
  wire [12 : 0] edp_tlpBRAM_readNxtDWAddr_PLUS_1__q12,
		...
		spanToNextPage__h78808,
		thisRequestLength__h78809,
		y__h17297,
		y__h26067;
  wire [11 : 0] byteCount__h28457, x__h28575, x__h28577, y__h28576, y__h28578;
  wire [9 : 0] y__h17368, y__h26019, y__h29517, y__h79175;
  wire [7 : 0] rreq_tag__h79002;
  wire [6 : 0] lowAddr__h28456;
  ...
  wire [1 : 0] ab__h10383,
	       ...
	       ab__h7456,
	       ab__h8853,
	       edp_tlpBRAM_readReq_first__97_BITS_30_TO_29_99_ETC___d2543,
	       idx__h19083,
	       idx__h21314,
	       idx__h22618,
	       idx__h23922,
  ...
  wire IF_1_MINUS_edp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d708,
       ...
       IF_wmi_p4B_648_EQ_0_649_THEN_bram_serverAdapte_ETC___d1662,
       NOT_bml_lclBufDone_789_856_AND_IF_bml_dpContro_ETC___d1869,
       NOT_wmi_wrActive_563_564_OR_NOT_wmi_rdActive_5_ETC___d1573,
       _dfoo5,
       bml_crdBuf_value_747_EQ_bml_crdBuf_modulus_bw__ETC___d2462,
       bml_fabBuf_value_732_EQ_bml_fabBuf_modulus_bw__ETC___d2463,
       bml_lclBufDone_789_AND_IF_bml_dpControl_wget___ETC___d2593,
       bml_lclBuf_value_702_EQ_bml_lclBuf_modulus_bw__ETC___d2481,
       bml_remBuf_value_717_EQ_bml_remBuf_modulus_bw__ETC___d2482,
       bram_serverAdapterA_1_cnt_44_SLT_3___d2308,
       bram_serverAdapterA_2_cnt_62_SLT_3___d2309,
       bram_serverAdapterA_2_outDataCore_notEmpty__38_ETC___d993,
       bram_serverAdapterA_3_cnt_80_SLT_3___d2310,
       bram_serverAdapterA_cnt_6_SLT_3___d2307,
       bram_serverAdapterA_outDataCore_notEmpty_OR_br_ETC___d995,
       bram_serverAdapterB_1_cnt_03_SLT_3___d1513,
       bram_serverAdapterB_1_outData_outData_whas__53_ETC___d1541,
       bram_serverAdapterB_2_cnt_21_SLT_3___d1514,
       bram_serverAdapterB_3_cnt_39_SLT_3___d1515,
       bram_serverAdapterB_cnt_5_SLT_3___d1512,
       edp_outDwRemain_299_ULE_4___d1301,
       ...
       edp_tlpBRAM_writeRemainDWLen_62_ULE_1___d2541,
       edp_tlpBRAM_writeRemainDWLen_62_ULE_2___d2542,
       edp_tlpBRAM_writeRemainDWLen_62_ULE_3___d2175,
       hasPush_AND_edp_dpControl_wget__148_BITS_7_TO__ETC___d1168,
       hasPush_AND_edp_dpControl_wget__148_BITS_7_TO__ETC___d1241,
       hasPush_AND_edp_dpControl_wget__148_BITS_7_TO__ETC___d1279,
       hasPush_AND_edp_dpControl_wget__148_BITS_7_TO__ETC___d1313,
       wmi_dpControl_whas__499_AND_bram_serverAdapter_ETC___d1545,
       wmi_wmi_operateD_452_AND_wmi_wmi_peerIsReady_4_ETC___d1627;
  ...
  assign MUX_bml_fabBufsAvail$write_1__VAL_1 =
	     (bml_fabAvail && !bml_remStart) ? x__h98007 : x__h98012 ;
  assign MUX_bml_fabBufsAvail$write_1__VAL_2 =
	     (dpControl[3:2] == 2'd1) ? x__h96656 : 16'd0 ;
  assign MUX_bml_fabFlowAddr$write_1__VAL_1 =
	     bml_fabBuf_value_732_EQ_bml_fabBuf_modulus_bw__ETC___d2463 ?
	       bml_fabFlowBase :
	       bml_fabFlowAddr_804_PLUS_bml_fabFlowSize_805___d2304 ;
  ...
  assign MUX_bml_lclCredit$write_1__VAL_1 =
	     (bml_lclBufDone && !bml_remStart) ? x__h98045 : x__h98050 ;
  ...
  assign MUX_bram_memory$a_put_3__VAL_3 =
	     { IF_0_MINUS_edp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2197[7:0],
	       IF_0_MINUS_edp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2197[15:8],
	       IF_0_MINUS_edp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2197[23:16],
	       IF_0_MINUS_edp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2197[31:24] } ;
  assign MUX_bram_memory$b_put_2__VAL_1 =
	     wmi_lclMesgAddr[14:4] + { 1'd0, wmi_addr[13:4] } ;
  always@(idx__h21314 or
	  edp_tlpBRAM_writeDWAddr_PLUS_3__q8 or
	  edp_tlpBRAM_writeDWAddr or
	  edp_tlpBRAM_writeDWAddr_PLUS_1__q9 or
	  edp_tlpBRAM_writeDWAddr_PLUS_2__q10)
  ...
  assign MUX_bram_memory_1$a_put_3__VAL_3 =
	     { IF_1_MINUS_edp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2198[7:0],
	       IF_1_MINUS_edp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2198[15:8],
	       IF_1_MINUS_edp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2198[23:16],
	       IF_1_MINUS_edp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2198[31:24] } ;
  always@(idx__h22618 or
	  edp_tlpBRAM_writeDWAddr_PLUS_3__q8 or
	  edp_tlpBRAM_writeDWAddr or
	  edp_tlpBRAM_writeDWAddr_PLUS_1__q9 or
	  edp_tlpBRAM_writeDWAddr_PLUS_2__q10)
  ...
  assign MUX_bram_memory_2$a_put_3__VAL_3 =
	     { IF_2_MINUS_edp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2199[7:0],
	       IF_2_MINUS_edp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2199[15:8],
	       IF_2_MINUS_edp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2199[23:16],
	       IF_2_MINUS_edp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2199[31:24] } ;
  always@(idx__h23922 or
	  edp_tlpBRAM_writeDWAddr_PLUS_3__q8 or
	  edp_tlpBRAM_writeDWAddr or
	  edp_tlpBRAM_writeDWAddr_PLUS_1__q9 or
	  edp_tlpBRAM_writeDWAddr_PLUS_2__q10)
  ...
  assign MUX_bram_memory_3$a_put_3__VAL_3 =
	     { IF_3_MINUS_edp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2200[7:0],
	       IF_3_MINUS_edp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2200[15:8],
	       IF_3_MINUS_edp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2200[23:16],
	       IF_3_MINUS_edp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2200[31:24] } ;
  assign MUX_edp_doorSeqDwell$write_1__VAL_1 = edp_doorSeqDwell - 4'd1 ;
  assign MUX_edp_fabMesgAccu$write_1__VAL_2 = edp_fabMesgAccu + y__h79226 ;
  ...
  assign MUX_edp_mesgLengthRemainPush$write_1__VAL_3 =
	     edp_mesgLengthRemainPush - y__h78834 ;
  assign MUX_edp_outDwRemain$write_1__VAL_1 =
	     edp_tlpBRAM_mRespF$D_OUT[71:62] - y__h79175 ;
  ...
  assign MUX_edp_remMesgAccu$write_1__VAL_2 =
	     edp_remMesgAccu + { 3'd0, thisRequestLength__h78809 } ;
  assign MUX_edp_srcMesgAccu$write_1__VAL_2 = edp_srcMesgAccu + y__h78925 ;
  ...
  assign MUX_edp_tlpBRAM_mReqF$enq_1__VAL_2 =
	     { 69'h12AAAAAAAAAAAAAAAA,
	       ...
	       thisRequestLength__h78809[11:2],
	       8'd255,
	       rreq_tag__h79002,
	       3'h2 } ;
  ...
  assign MUX_edp_tlpBRAM_rdRespDwRemain$write_1__VAL_1 =
	     edp_tlpBRAM_readReq$D_OUT[28:19] - y__h29517 ;
  ...
  assign MUX_edp_tlpBRAM_readNxtDWAddr$write_1__VAL_1 =
	     edp_tlpBRAM_mReqF$D_OUT[41:29] + y__h26067 ;
  ...
  assign MUX_edp_tlpBRAM_readRemainDWLen$write_1__VAL_1 =
	     edp_tlpBRAM_mReqF$D_OUT[28:19] - y__h26019 ;
  ...
  assign MUX_edp_tlpBRAM_writeDWAddr$write_1__VAL_1 =
	     edp_tlpBRAM_mReqF$D_OUT[62:50] + y__h17297 ;
  ...
  assign MUX_edp_tlpBRAM_writeRemainDWLen$write_1__VAL_1 =
	     edp_tlpBRAM_mReqF$D_OUT[49:40] - y__h17368 ;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, _theResult____h99891 } ;
  ...
  assign MUX_wmi_wmi_respF_q_0$write_1__VAL_1 = { 2'd1, rdata__h92299 } ;
  ...
  assign bram_serverAdapterB_outData_enqData$whas =
	     ...
	     bram_serverAdapterB_s1[0] ;
  assign bram_serverAdapterB_outData_outData$wget = y_avValue__h92135 ;
  ...
  assign bram_serverAdapterB_1_outData_enqData$whas =
	     ...
	     bram_serverAdapterB_1_s1[0] ;
  assign bram_serverAdapterB_1_outData_outData$wget = y_avValue__h92155 ;
  ...
  assign bram_serverAdapterB_2_outData_enqData$whas =
	     ...
	     bram_serverAdapterB_2_s1[0] ;
  assign bram_serverAdapterB_2_outData_outData$wget = y_avValue__h92175 ;
  ...
  assign bram_serverAdapterB_3_outData_enqData$whas =
	     ...
	     bram_serverAdapterB_3_s1[0] ;
  assign bram_serverAdapterB_3_outData_outData$wget = y_avValue__h92195 ;
  ...
  assign edp_edpTx_delta_enq$wget = 5'h0 ;
  assign edp_edpTx_delta_enq$whas = 1'b0 ;
  assign edp_edpTx_delta_deq$wget = 1'b0 ;
  assign edp_edpTx_delta_deq$whas = 1'b0 ;
  assign edp_edpTx_new_data$wget = 128'h0 ;
  assign edp_edpTx_new_data$whas = 1'b0 ;
  ...
  // register edp_edpTx_num_empty
  assign edp_edpTx_num_empty$D_IN = edp_edpTx_num_empty + 6'd0 - 6'd0 ;
  assign edp_edpTx_num_empty$EN = 1'd1 ;

  // register edp_edpTx_num_full
  assign edp_edpTx_num_full$D_IN = edp_edpTx_num_full + 6'd0 - 6'd0 ;
  assign edp_edpTx_num_full$EN = 1'd1 ;

  // register edp_edpTx_vec
  assign edp_edpTx_vec$D_IN =
	     { 248'd0 |
	       edp_edpTx_vec_135_SRL_edp_edpTx_delta_deq_whas_ETC___d2306[255:8],
	       8'd0 |
	       edp_edpTx_vec_135_SRL_edp_edpTx_delta_deq_whas_ETC___d2306[7:0] } ;
  assign edp_edpTx_vec$EN = 1'd1 ;
  ...
  // register edp_frameNumber
  assign edp_frameNumber$D_IN = 16'h0 ;
  assign edp_frameNumber$EN = 1'b0 ;
  ...
  assign wmi_wmi_sFlagReg$D_IN =
	     { y_avValue__h92155[7:0], y_avValue__h92135[23:0] } ;
  ...
  begin
    case (1'b1) // synopsys parallel_case
      ...
      WILL_FIRE_RL_wmi_doWriteFinalize: bram_memory$DIB = x3__h90540;
  ...
  begin
    case (1'b1) // synopsys parallel_case
      ...
      WILL_FIRE_RL_wmi_doWriteFinalize:
	  bram_memory_1$DIB = mesgMeta_opcode__h90580;
  ...
  assign IF_edp_tlpBRAM_readReq_first__97_BITS_30_TO_29_ETC___d1037 =
	     edp_tlpBRAM_readReq_first__97_BITS_30_TO_29_99_ETC___d2543[0] ?
	       { bram_serverAdapterA_3_outData_outData$wget[7:0],
		 bram_serverAdapterA_3_outData_outData$wget[15:8],
		 bram_serverAdapterA_3_outData_outData$wget[23:16],
		 bram_serverAdapterA_3_outData_outData$wget[31:24],
  ...
  assign IF_edp_tlpBRAM_readReq_first__97_BITS_30_TO_29_ETC___d921 =
	     IF_edp_tlpBRAM_readReq_first__97_BITS_30_TO_29_ETC___d912 &&
	     CASE_edp_tlpBRAM_readReqD_OUT_BITS_30_TO_29_N_ETC__q16 ;
  assign IF_wmi_p4B_648_EQ_0_649_THEN_bram_serverAdapte_ETC___d1662 =
	     (wmi_p4B == 2'd0) ?
	       (bram_serverAdapterB_outDataCore$EMPTY_N ||
		bram_serverAdapterB_outData_enqData$whas) &&
	       bram_serverAdapterB_outData_outData$whas :
	       IF_wmi_p4B_648_EQ_1_651_THEN_bram_serverAdapte_ETC___d1657 &&
	       CASE_wmi_p4B_NOT_wmi_p4B_EQ_3_OR_bram_serverAd_ETC__q17 ;
  assign NOT_bml_lclBufDone_789_856_AND_IF_bml_dpContro_ETC___d1869 =
	     !bml_lclBufDone &&
	     CASE_dpControl_BITS_1_TO_0_bml_fabDone_0_bml_f_ETC__q3 ;
  assign NOT_wmi_wrActive_563_564_OR_NOT_wmi_rdActive_5_ETC___d1573 =
  ...
  assign ab__h8853 =
	     (MUX_bram_memory_2$b_put_1__SEL_1 ||
	      WILL_FIRE_RL_wmi_reqMetadata) ?
	       2'd0 :
	       2'd2 ;
  assign bml_crdBuf_value_747_EQ_bml_crdBuf_modulus_bw__ETC___d2462 =
	     bml_crdBuf_value == bml_crdBuf_modulus ;
  assign bml_fabBuf_value_732_EQ_bml_fabBuf_modulus_bw__ETC___d2463 =
	     bml_fabBuf_value == bml_fabBuf_modulus ;
  assign bml_fabFlowAddr_804_PLUS_bml_fabFlowSize_805___d2304 =
	     bml_fabFlowAddr + bml_fabFlowSize ;
  assign bml_lclBufDone_789_AND_IF_bml_dpControl_wget___ETC___d2593 =
	     bml_lclBufDone &&
	     CASE_dpControl_BITS_1_TO_0_NOT_bml_fabDone_0_N_ETC__q6 ;
  assign bml_lclBuf_value_702_EQ_bml_lclBuf_modulus_bw__ETC___d2481 =
	     bml_lclBuf_value == bml_lclBuf_modulus ;
  assign bml_remBuf_value_717_EQ_bml_remBuf_modulus_bw__ETC___d2482 =
  ...
  assign bram_serverAdapterA_1_cnt_44_SLT_3___d2308 =
  ...
  assign bram_serverAdapterA_2_cnt_62_SLT_3___d2309 =
  ...
  assign bram_serverAdapterA_3_cnt_80_SLT_3___d2310 =
  ...
  assign bram_serverAdapterA_cnt_6_SLT_3___d2307 =
  ...
  assign bram_serverAdapterB_1_cnt_03_SLT_3___d1513 =
	     (bram_serverAdapterB_1_cnt ^ 3'h4) < 3'd7 ;
  assign bram_serverAdapterB_1_outData_outData_whas__53_ETC___d1541 =
	     bram_serverAdapterB_1_outData_outData$whas &&
	     (bram_serverAdapterB_2_outDataCore$EMPTY_N ||
	      bram_serverAdapterB_2_outData_enqData$whas) &&
	     bram_serverAdapterB_2_outData_outData$whas &&
  ...
  assign bram_serverAdapterB_2_cnt_21_SLT_3___d1514 =
  ...
  assign bram_serverAdapterB_3_cnt_39_SLT_3___d1515 =
  ...
  assign bram_serverAdapterB_cnt_5_SLT_3___d1512 =
	     (bram_serverAdapterB_cnt ^ 3'h4) < 3'd7 ;
  assign byteCount__h28457 = x__h28575 - y__h28576 ;
  assign edp_edpTx_vec_135_SRL_edp_edpTx_delta_deq_whas_ETC___d2306 =
	     edp_edpTx_vec >> 0 ;
  assign edp_mesgLengthRemainPush_PLUS_3__q15 =
	     edp_mesgLengthRemainPush + 17'd3 ;
  assign edp_outDwRemain_299_ULE_4___d1301 = edp_outDwRemain <= 10'd4 ;
  ...
  assign edp_tlpBRAM_readRemainDWLen_46_ULE_4___d847 =
	     edp_tlpBRAM_readRemainDWLen <= 10'd4 ;
  assign edp_tlpBRAM_readReq_first__97_BITS_30_TO_29_99_ETC___d2543 =
  ...
  assign edp_tlpBRAM_writeRemainDWLen_62_ULE_1___d2541 =
	     edp_tlpBRAM_writeRemainDWLen <= 10'd1 ;
  assign edp_tlpBRAM_writeRemainDWLen_62_ULE_2___d2542 =
	     edp_tlpBRAM_writeRemainDWLen <= 10'd2 ;
  assign edp_tlpBRAM_writeRemainDWLen_62_ULE_3___d2175 =
	     edp_tlpBRAM_writeRemainDWLen <= 10'd3 ;
  assign hasPush_AND_edp_dpControl_wget__148_BITS_7_TO__ETC___d1168 =
	     hasPush && dpControl[7:4] == 4'd0 && dpControl[3:2] == 2'd1 &&
	     dpControl[1:0] == 2'd1 &&
	     !edp_reqMetaInFlight &&
	     !edp_fabMeta[128] &&
	     edp_nearBufReady &&
	     edp_farBufReady ;
  assign hasPush_AND_edp_dpControl_wget__148_BITS_7_TO__ETC___d1241 =
	     hasPush && dpControl[7:4] == 4'd0 && dpControl[3:2] == 2'd1 &&
	     dpControl[1:0] == 2'd1 &&
	     edp_fabMeta[128] &&
  ...
  assign hasPush_AND_edp_dpControl_wget__148_BITS_7_TO__ETC___d1279 =
	     hasPush && dpControl[7:4] == 4'd0 && dpControl[3:2] == 2'd1 &&
	     dpControl[1:0] == 2'd1 &&
	     !edp_tlpBRAM_mRespF$D_OUT[138] &&
	     ...
	     !edp_tlpXmtBusy &&
	     edp_postSeqDwell == 4'd0 ;
  assign hasPush_AND_edp_dpControl_wget__148_BITS_7_TO__ETC___d1313 =
	     hasPush && dpControl[7:4] == 4'd0 && dpControl[3:2] == 2'd1 &&
	     dpControl[1:0] == 2'd1 &&
	     edp_fabMeta[128] &&
	     !edp_tlpXmtBusy &&
	     ...
	     edp_xmtMetaOK &&
	     edp_postSeqDwell == 4'd0 ;
  assign idx__h19083 = 2'd0 - edp_tlpBRAM_writeDWAddr[1:0] ;
  assign idx__h21314 = 2'd1 - edp_tlpBRAM_writeDWAddr[1:0] ;
  assign idx__h22618 = 2'd2 - edp_tlpBRAM_writeDWAddr[1:0] ;
  assign idx__h23922 = 2'd3 - edp_tlpBRAM_writeDWAddr[1:0] ;
  assign idx__h26314 = 2'd0 - edp_tlpBRAM_readNxtDWAddr[1:0] ;
  assign idx__h26782 = 2'd1 - edp_tlpBRAM_readNxtDWAddr[1:0] ;
  assign idx__h27155 = 2'd2 - edp_tlpBRAM_readNxtDWAddr[1:0] ;
  assign idx__h27528 = 2'd3 - edp_tlpBRAM_readNxtDWAddr[1:0] ;
  assign lowAddr__h28456 =
	     { edp_tlpBRAM_readReq$D_OUT[33:29], lowAddr10__h28455 } ;
  assign mesgMeta_opcode__h90580 =
	     { 24'h800000, wmi_wmi_mFlagF$D_OUT[31:24] } ;
  assign nowLS__h77560 =
	     { edp_tlpBRAM_mRespF$D_OUT[39:32],
	       edp_tlpBRAM_mRespF$D_OUT[47:40],
	       edp_tlpBRAM_mRespF$D_OUT[55:48],
	       edp_tlpBRAM_mRespF$D_OUT[63:56] } ;
  assign nowMS__h76617 =
	     { edp_tlpBRAM_mRespF$D_OUT[71:64],
	       edp_tlpBRAM_mRespF$D_OUT[79:72],
	       edp_tlpBRAM_mRespF$D_OUT[87:80],
	       edp_tlpBRAM_mRespF$D_OUT[95:88] } ;
  assign opcode__h75386 =
  ...
  assign rdat__h100002 = { 16'd0, bml_mesgSize } ;
  assign rdat__h100010 = { 16'd0, bml_metaSize } ;
  assign rdat__h100018 = { 16'd0, bml_lclBufsCF } ;
  assign rdat__h100039 =
	     hasDebugLogic ? { bml_lclBufsAR, bml_fabBufsAvail } : 32'd0 ;
  assign rdat__h100046 =
	     hasDebugLogic ? { bml_remBuf_value, bml_lclBuf_value } : 32'd0 ;
  assign rdat__h100059 =
	     hasDebugLogic ? { bml_lclStarts, bml_lclDones } : 32'd0 ;
  assign rdat__h100066 =
	     hasDebugLogic ? { bml_remStarts, bml_remDones } : 32'd0 ;
  assign rdat__h100073 = hasDebugLogic ? wmi_thisMesg : 32'd0 ;
  assign rdat__h100337 = hasDebugLogic ? wmi_lastMesg : 32'd0 ;
  assign rdat__h100387 =
	     hasDebugLogic ? { wmi_reqCount, wmi_wrtCount } : 32'd0 ;
  assign rdat__h100487 = hasDebugLogic ? 32'hDADEBABE : 32'd0 ;
  assign rdat__h100545 = { 24'd0, dpControl } ;
  assign rdat__h100567 = hasDebugLogic ? edp_flowDiagCount : 32'd0 ;
  assign rdat__h100577 =
	     hasDebugLogic ?
	       { 4'h0,
		 edp_complTimerCount,
		 12'h0,
		 CASE_edp_lastRuleFired_10_1_edp_lastRuleFired__ETC__q2 } :
	       32'd0 ;
  assign rdat__h100699 = hasDebugLogic ? edp_lastMetaV : 32'd0 ;
  assign rdat__h100820 = hasDebugLogic ? edp_lastMetaV_1 : 32'd0 ;
  assign rdat__h100849 = hasDebugLogic ? edp_lastMetaV_2 : 32'd0 ;
  assign rdat__h100878 = hasDebugLogic ? edp_lastMetaV_3 : 32'd0 ;
  assign rdat__h100907 = hasDebugLogic ? 32'hC0DE0111 : 32'd0 ;
  assign rdat__h100937 = hasDebugLogic ? dmaStartTime[31:0] : 32'd0 ;
  assign rdat__h100971 = hasDebugLogic ? dmaStartTime[63:32] : 32'd0 ;
  assign rdat__h101004 = hasDebugLogic ? dmaDoneTime[31:0] : 32'd0 ;
  assign rdat__h101038 = hasDebugLogic ? dmaDoneTime[63:32] : 32'd0 ;
  assign rdat__h99970 = { 16'd0, bml_lclNumBufs } ;
  assign rdat__h99978 = { 16'd0, bml_fabNumBufs } ;
  assign rdat__h99986 = { 16'd0, bml_mesgBase } ;
  assign rdat__h99994 = { 16'd0, bml_metaBase } ;
  assign rdata__h33886 =
	     edp_tlpBRAM_readReq_first__97_BITS_30_TO_29_99_ETC___d2543[1] ?
	       IF_edp_tlpBRAM_readReq_first__97_BITS_30_TO_29_ETC___d1037 :
	       IF_edp_tlpBRAM_readReq_first__97_BITS_30_TO_29_ETC___d1042 ;
  assign rreq_tag__h79002 =
	     (y__h78834 == edp_mesgLengthRemainPush) ? 8'h01 : 8'h0 ;
  assign rresp_data__h28502 =
	     { IF_edp_tlpBRAM_readReq_first__97_BITS_30_TO_29_ETC___d2549[7:0],
	       IF_edp_tlpBRAM_readReq_first__97_BITS_30_TO_29_ETC___d2549[15:8],
	       IF_edp_tlpBRAM_readReq_first__97_BITS_30_TO_29_ETC___d2549[23:16],
	       IF_edp_tlpBRAM_readReq_first__97_BITS_30_TO_29_ETC___d2549[31:24] } ;
  assign spanToNextPage__h78808 = 13'd4096 - { 1'd0, edp_srcMesgAccu[11:0] } ;
  assign thisRequestLength__h78809 =
	     (x__h78844[12:0] <= spanToNextPage__h78808) ?
	       x__h78844[12:0] :
	       spanToNextPage__h78808 ;
  assign wmi_dpControl_whas__499_AND_bram_serverAdapter_ETC___d1545 =
	     (bram_serverAdapterB_outDataCore$EMPTY_N ||
	      bram_serverAdapterB_outData_enqData$whas) &&
	     bram_serverAdapterB_outData_outData$whas &&
	     (bram_serverAdapterB_1_outDataCore$EMPTY_N ||
	      bram_serverAdapterB_1_outData_enqData$whas) &&
	     bram_serverAdapterB_1_outData_outData_whas__53_ETC___d1541 ;
  assign wmi_wmi_operateD_452_AND_wmi_wmi_peerIsReady_4_ETC___d1627 =
	     wmi_wmi_operateD && wmi_wmi_peerIsReady &&
	     bram_serverAdapterB_cnt_5_SLT_3___d1512 &&
	     bram_serverAdapterB_1_cnt_03_SLT_3___d1513 &&
	     bram_serverAdapterB_2_cnt_21_SLT_3___d1514 &&
	     bram_serverAdapterB_3_cnt_39_SLT_3___d1515 &&
	     wmi_wmi_mFlagF$EMPTY_N ;
  assign x3__h90540 = { 8'd0, wmi_wmi_mFlagF$D_OUT[23:0] } ;
  assign x__h28575 = x__h28577 - y__h28578 ;
  assign x__h28577 = { edp_tlpBRAM_readReq$D_OUT[28:19], 2'b0 } ;
  assign x__h73552 =
	     { edp_tlpBRAM_mRespF$D_OUT[7:0],
	       edp_tlpBRAM_mRespF$D_OUT[15:8],
	       edp_tlpBRAM_mRespF$D_OUT[23:16],
	       edp_tlpBRAM_mRespF$D_OUT[31:24] } ;
  assign x__h78563 = { 15'd0, edp_mesgLengthRemainPush } ;
  assign x__h78844 =
	     (edp_mesgLengthRemainPush <= y__h78846) ?
	       edp_mesgLengthRemainPush :
	       y__h78846 ;
  assign x__h96656 = (dpControl[1:0] == 2'd1) ? bml_fabNumBufs : 16'd0 ;
  assign x__h97780 = bml_lclBufsAR + 16'd1 ;
  assign x__h97785 = bml_lclBufsAR - 16'd1 ;
  assign x__h97892 = bml_lclBufsCF + 16'd1 ;
  assign x__h97929 = bml_lclBufsCF - 16'd1 ;
  assign x__h98007 = bml_fabBufsAvail + 16'd1 ;
  assign x__h98012 = bml_fabBufsAvail - 16'd1 ;
  assign x__h98045 = bml_lclCredit + 16'd1 ;
  assign x__h98050 = bml_lclCredit - 16'd1 ;
  assign y__h17297 = edp_tlpBRAM_mReqF$D_OUT[63] ? 13'd0 : 13'd1 ;
  assign y__h17368 = edp_tlpBRAM_mReqF$D_OUT[63] ? 10'd0 : 10'd1 ;
  assign y__h26019 = edp_tlpBRAM_mReqF$D_OUT[60] ? 10'd0 : 10'd1 ;
  assign y__h26067 = edp_tlpBRAM_mReqF$D_OUT[60] ? 13'd0 : 13'd1 ;
  assign y__h28576 =
	     (edp_tlpBRAM_readReq$D_OUT[28:19] == 10'd1) ?
	       12'd0 :
	       { 10'd0, x__h28607 } ;
  assign y__h28578 = { 10'd0, x__h28584 } ;
  assign y__h29517 = edp_tlpBRAM_readReq$D_OUT[60] ? 10'd0 : 10'd1 ;
  assign y__h78834 = { 4'd0, thisRequestLength__h78809 } ;
  assign y__h78846 = { 4'd0, edp_maxPayloadSize } ;
  assign y__h78925 = { 19'd0, thisRequestLength__h78809 } ;
  assign y__h79175 = (edp_fabMesgAddrMS == 32'd0) ? 10'd1 : 10'd0 ;
  assign y__h79226 = { 20'd0, edp_tlpBRAM_mRespF$D_OUT[71:62], 2'd0 } ;
  assign y_avValue__h92135 =
	     bram_serverAdapterB_outDataCore$EMPTY_N ?
	       bram_serverAdapterB_outDataCore$D_OUT :
	       bram_memory$DOB ;
  assign y_avValue__h92155 =
	     bram_serverAdapterB_1_outDataCore$EMPTY_N ?
	       bram_serverAdapterB_1_outDataCore$D_OUT :
	       bram_memory_1$DOB ;
  assign y_avValue__h92175 =
	     bram_serverAdapterB_2_outDataCore$EMPTY_N ?
	       bram_serverAdapterB_2_outDataCore$D_OUT :
	       bram_memory_2$DOB ;
  assign y_avValue__h92195 =
	     bram_serverAdapterB_3_outDataCore$EMPTY_N ?
	       bram_serverAdapterB_3_outDataCore$D_OUT :
	       bram_memory_3$DOB ;
  ...
  begin
    case (edp_tlpBRAM_readReq$D_OUT[18:15])
      4'b1100: x__h28584 = 2'b10;
      4'b1110: x__h28584 = 2'b01;
      4'b1111: x__h28584 = 2'b0;
      default: x__h28584 = 2'b11;
    endcase
  end
  always@(edp_tlpBRAM_readReq$D_OUT)
  begin
    case (edp_tlpBRAM_readReq$D_OUT[14:11])
      4'b1100: x__h28607 = 2'b10;
      4'b1110: x__h28607 = 2'b01;
      4'b1111: x__h28607 = 2'b0;
      default: x__h28607 = 2'b11;
    endcase
  end
  ...
  always@(wmi_p4B or
	  y_avValue__h92195 or
	  y_avValue__h92135 or y_avValue__h92155 or y_avValue__h92175)
  begin
    case (wmi_p4B)
      2'd0: rdata__h92299 = y_avValue__h92135;
      2'd1: rdata__h92299 = y_avValue__h92155;
      2'd2: rdata__h92299 = y_avValue__h92175;
      2'd3: rdata__h92299 = y_avValue__h92195;
    endcase
  end
  always@(wci_reqF$D_OUT or
	  ...
	  rdat__h100937 or rdat__h100971 or rdat__h101004 or rdat__h101038)
  begin
    case (wci_reqF$D_OUT[39:32])
      8'h0: _theResult____h99891 = rdat__h99970;
      8'h04: _theResult____h99891 = rdat__h99978;
      8'h08: _theResult____h99891 = rdat__h99986;
      8'h0C: _theResult____h99891 = rdat__h99994;
      8'h10: _theResult____h99891 = rdat__h100002;
      8'h14: _theResult____h99891 = rdat__h100010;
      8'h20: _theResult____h99891 = rdat__h100018;
      8'h24: _theResult____h99891 = 32'hF00DFACE;
      8'h28: _theResult____h99891 = rdat__h100039;
      8'h2C: _theResult____h99891 = rdat__h100046;
      8'h30: _theResult____h99891 = rdat__h100059;
      8'h34: _theResult____h99891 = rdat__h100066;
      8'h38: _theResult____h99891 = rdat__h100073;
      8'h3C: _theResult____h99891 = rdat__h100337;
      8'h40: _theResult____h99891 = rdat__h100387;
      8'h44: _theResult____h99891 = 32'd0;
      8'h48: _theResult____h99891 = rdat__h100487;
      8'h4C: _theResult____h99891 = 32'h00008000;
      8'h50: _theResult____h99891 = bml_fabMesgBase;
      8'h54: _theResult____h99891 = bml_fabMetaBase;
      8'h58: _theResult____h99891 = bml_fabMesgSize;
      8'h5C: _theResult____h99891 = bml_fabMetaSize;
      8'h60: _theResult____h99891 = bml_fabFlowBase;
      8'h64: _theResult____h99891 = bml_fabFlowSize;
      8'h68: _theResult____h99891 = rdat__h100545;
      8'h6C: _theResult____h99891 = rdat__h100567;
      8'h70: _theResult____h99891 = rdat__h100577;
      8'h80: _theResult____h99891 = rdat__h100699;
      8'h84: _theResult____h99891 = rdat__h100820;
      8'h88: _theResult____h99891 = rdat__h100849;
      8'h8C: _theResult____h99891 = rdat__h100878;
      8'h90: _theResult____h99891 = rdat__h100907;
      8'h94: _theResult____h99891 = bml_fabMesgBaseMS;
      8'h98: _theResult____h99891 = bml_fabMetaBaseMS;
      8'h9C: _theResult____h99891 = bml_fabFlowBaseMS;
      8'hA0: _theResult____h99891 = rdat__h100937;
      8'hA4: _theResult____h99891 = rdat__h100971;
      8'hA8: _theResult____h99891 = rdat__h101004;
      8'hAC: _theResult____h99891 = rdat__h101038;
      default: _theResult____h99891 = 32'd0;
    endcase
  end
  always@(edp_tlpBRAM_readReq$D_OUT)
  begin
    case (edp_tlpBRAM_readReq$D_OUT[18:15])
      4'b1000: lowAddr10__h28455 = 2'b11;
      4'b1100: lowAddr10__h28455 = 2'b10;
      4'b1110: lowAddr10__h28455 = 2'b01;
      default: lowAddr10__h28455 = 2'b0;
    endcase
  end
  ...
  begin
    case (dpControl[1:0])
	  ...
	  IF_bml_dpControl_wget__765_BITS_1_TO_0_771_EQ__ETC___d1842 =
	      bml_remDone;
      default: IF_bml_dpControl_wget__765_BITS_1_TO_0_771_EQ__ETC___d1842 =
		   bml_fabDone;
    endcase
  end
  ...
  always@(idx__h19083 or
	  edp_tlpBRAM_writeRemainDWLen_62_ULE_3___d2175 or
	  edp_tlpBRAM_writeRemainDWLen or
	  edp_tlpBRAM_writeRemainDWLen_62_ULE_1___d2541 or
	  edp_tlpBRAM_writeRemainDWLen_62_ULE_2___d2542)
  begin
    case (idx__h19083)
      2'd0:
  ...
  always@(edp_tlpBRAM_mReqF$D_OUT or
	  bram_serverAdapterA_3_cnt_80_SLT_3___d2310 or
	  bram_serverAdapterA_cnt_6_SLT_3___d2307 or
	  bram_serverAdapterA_1_cnt_44_SLT_3___d2308 or
	  bram_serverAdapterA_2_cnt_62_SLT_3___d2309)
  begin
  ...
  always@(wmi_addr or
	  bram_serverAdapterB_3_cnt_39_SLT_3___d1515 or
	  bram_serverAdapterB_cnt_5_SLT_3___d1512 or
	  bram_serverAdapterB_1_cnt_03_SLT_3___d1513 or
	  bram_serverAdapterB_2_cnt_21_SLT_3___d1514)
  begin
    case (wmi_addr[3:2])
      2'd0:
  ...
  always@(idx__h19083 or edp_tlpBRAM_mReqF$D_OUT)
  begin
    case (idx__h19083)
      2'd0:
	  IF_0_MINUS_edp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2197 =
  ...
  always@(idx__h21314 or edp_tlpBRAM_mReqF$D_OUT)
  begin
    case (idx__h21314)
      2'd0:
	  IF_1_MINUS_edp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2198 =
  ...
  always@(idx__h22618 or edp_tlpBRAM_mReqF$D_OUT)
  begin
    case (idx__h22618)
      2'd0:
	  IF_2_MINUS_edp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2199 =
  ...
  always@(idx__h23922 or edp_tlpBRAM_mReqF$D_OUT)
  begin
    case (idx__h23922)
      2'd0:
	  IF_3_MINUS_edp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2200 =
  ...
  begin
    case (wmi_p4B)
	  ...
	  IF_wmi_p4B_648_EQ_1_651_THEN_bram_serverAdapte_ETC___d1657 =
	      bram_serverAdapterB_2_outDataCore$EMPTY_N ||
	      bram_serverAdapterB_2_outData_enqData$whas;
      default: IF_wmi_p4B_648_EQ_1_651_THEN_bram_serverAdapte_ETC___d1657 =
		   wmi_p4B != 2'd3 ||
		   bram_serverAdapterB_3_outDataCore$EMPTY_N ||
		   bram_serverAdapterB_3_outData_enqData$whas;
    endcase
  ...
  begin
	...
	edp_edpTx_num_empty <= `BSV_ASSIGNMENT_DELAY 6'd32;
	edp_edpTx_num_full <= `BSV_ASSIGNMENT_DELAY 6'd0;
	edp_edpTx_vec <= `BSV_ASSIGNMENT_DELAY 256'd0;
	...
	if (edp_edpTx_num_empty$EN)
	  edp_edpTx_num_empty <= `BSV_ASSIGNMENT_DELAY
	      edp_edpTx_num_empty$D_IN;
	if (edp_edpTx_num_full$EN)
	  edp_edpTx_num_full <= `BSV_ASSIGNMENT_DELAY edp_edpTx_num_full$D_IN;
	if (edp_edpTx_vec$EN)
	  edp_edpTx_vec <= `BSV_ASSIGNMENT_DELAY edp_edpTx_vec$D_IN;
	if (edp_fabMeta$EN)
  ...
  begin
    ...
    edp_edpTx_num_empty = 6'h2A;
    edp_edpTx_num_full = 6'h2A;
    edp_edpTx_vec =
  ...
  begin
    ...
    if (RST_N)
      if (WILL_FIRE_RL_edp_dmaXmtMetaHead)
	$display("[%0d]: %m: dmaXmtMetaHead FPactMesg-Step5/7", v__h79911);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_edp_dmaXmtTailEvent)
	$display("[%0d]: %m: dmaXmtTailEvent FPactMesg-Step7/7", v__h80174);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_edp_dmaXmtMetaBody)
	$display("[%0d]: %m: dmaXmtMetaBody FPactMesg-Step6/7", v__h80054);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_edp_dmaXmtDoorbell)
	$display("[%0d]: %m: dmaXmtDoorbell FC/FPactFlow-Step1/1", v__h80381);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_edp_dmaTailEventSender)
	$display("[%0d]: %m: dmaTailEventSender - generic", v__h81143);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_wci_cfwr && wci_reqF$D_OUT[39:32] == 8'h18)
	$display("[%0d] %m: fabDoneAvail Event", v__h99284);
    if (RST_N)
