...
//
// On Mon Aug  6 14:42:41 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkOCEDP4B(pciDevice,
  ...
  // inlined wires
  reg [127 : 0] edp_dgdpTx_new_data$wget;
  ...
  reg [511 : 0] edp_dgdpTx_vec;
  wire [511 : 0] edp_dgdpTx_vec$D_IN;
  ...
  wire edp_outF$CLR, edp_outF$DEQ, edp_outF$EMPTY_N, edp_outF$ENQ;
  ...
  wire [127 : 0] MUX_edp_dgdpTx_new_data$wset_1__VAL_1,
  ...
  wire MUX_bml_fabBufsAvail$write_1__SEL_1,
       ...
       MUX_edp_tlpXmtBusy$write_1__SEL_5,
       MUX_edp_tlpXmtBusy$write_1__VAL_5,
       MUX_edp_xmtMetaOK$write_1__SEL_1,
       MUX_edp_xmtMetaOK$write_1__SEL_4,
  ...
  reg [63 : 0] v__h112222,
	       ...
	       v__h15861,
	       v__h99930;
  reg [31 : 0] IF_0_MINUS_edp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2278,
	       IF_1_MINUS_edp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2279,
	       IF_2_MINUS_edp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2280,
	       IF_3_MINUS_edp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2281,
	       IF_edp_tlpBRAM_readReq_first__97_BITS_30_TO_29_ETC___d2633,
	       _theResult____h147065,
	       rdata__h139473;
  reg [3 : 0] CASE_edp_lastRuleFired_10_1_edp_lastRuleFired__ETC__q2;
  reg [1 : 0] CASE_edp_outFD_OUT_BITS_9_TO_8_3_0_edp_outFD_ETC__q1,
	      CASE_server_request_put_BITS_9_TO_8_3_0_server_ETC__q18,
	      lowAddr10__h28457,
	      x__h28586,
	      x__h28609;
  reg CASE_dpControl_BITS_1_TO_0_NOT_bml_fabDone_0_N_ETC__q6,
      ...
      IF_0_MINUS_edp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2678,
      IF_0_MINUS_edp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d675,
      IF_1_MINUS_edp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2679,
      IF_1_MINUS_edp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d685,
      IF_2_MINUS_edp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2680,
      IF_2_MINUS_edp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d695,
      IF_3_MINUS_edp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2681,
      IF_3_MINUS_edp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d705,
      IF_bml_dpControl_wget__848_BITS_1_TO_0_854_EQ__ETC___d1925,
      IF_edp_tlpBRAM_readReq_first__97_BITS_30_TO_29_ETC___d912,
      IF_wmi_addr_674_BITS_3_TO_2_675_EQ_0_676_THEN__ETC___d2650,
      IF_wmi_p4B_731_EQ_1_734_THEN_bram_serverAdapte_ETC___d1740;
  wire [511 : 0] _0_CONCAT_edp_dgdpTx_new_data_wget__084_BITS_12_ETC___d2383,
		 edp_dgdpTx_vec_135_SRL_edp_dgdpTx_delta_deq_wh_ETC___d2384;
  wire [127 : 0] IF_edp_tlpBRAM_readReq_first__97_BITS_30_TO_29_ETC___d1037,
		 ...
		 rdata__h33888,
		 x__h59164;
  wire [111 : 0] IF_edp_firstMesgMH_329_THEN_1_ELSE_0_331_CONCA_ETC___d1349,
		 _0_CONCAT_IF_edp_firstMetaMH_196_THEN_2_ELSE_0__ETC___d1219;
  wire [95 : 0] IF_edp_firstMesgMH_329_THEN_1_ELSE_0_331_CONCA_ETC___d1344;
  wire [31 : 0] bml_fabFlowAddr_887_PLUS_bml_fabFlowSize_888___d2382,
		mesgMeta_opcode__h137754,
		nowLS__h115337,
		nowMS__h114394,
		opcode__h113163,
		rdat__h147144,
  ...
  wire [12 : 0] edp_tlpBRAM_readNxtDWAddr_PLUS_1__q12,
		...
		spanToNextPage__h119386,
		thisRequestLength__h119387,
		y__h17299,
		y__h26069;
  wire [11 : 0] byteCount__h28459, x__h28577, x__h28579, y__h28578, y__h28580;
  wire [9 : 0] x__h63813, y__h126349, y__h17370, y__h26021, y__h29519;
  wire [7 : 0] IF_edp_firstMesgMH_329_THEN_1_ELSE_0___d2649,
	       rreq_tag__h119580;
  wire [6 : 0] lowAddr__h28458;
  wire [4 : 0] IF_edp_dgdpTx_delta_enq_whas__070_THEN_edp_dgd_ETC___d2622;
  ...
  wire [1 : 0] ab__h10383,
	       ...
	       ab__h7456,
	       ab__h8853,
	       edp_tlpBRAM_readReq_first__97_BITS_30_TO_29_99_ETC___d2627,
	       idx__h19085,
	       idx__h21316,
	       idx__h22620,
	       idx__h23924,
  ...
  wire IF_1_MINUS_edp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d708,
       ...
       IF_wmi_p4B_731_EQ_0_732_THEN_bram_serverAdapte_ETC___d1745,
       NOT_bml_lclBufDone_872_939_AND_IF_bml_dpContro_ETC___d1952,
       NOT_wmi_wrActive_646_647_OR_NOT_wmi_rdActive_6_ETC___d1656,
       _dfoo5,
       bml_crdBuf_value_830_EQ_bml_crdBuf_modulus_bw__ETC___d2544,
       bml_fabBuf_value_815_EQ_bml_fabBuf_modulus_bw__ETC___d2545,
       bml_lclBufDone_872_AND_IF_bml_dpControl_wget___ETC___d2684,
       bml_lclBuf_value_785_EQ_bml_lclBuf_modulus_bw__ETC___d2563,
       bml_remBuf_value_800_EQ_bml_remBuf_modulus_bw__ETC___d2564,
       bram_serverAdapterA_1_cnt_44_SLT_3___d2386,
       bram_serverAdapterA_2_cnt_62_SLT_3___d2387,
       bram_serverAdapterA_2_outDataCore_notEmpty__38_ETC___d993,
       bram_serverAdapterA_3_cnt_80_SLT_3___d2388,
       bram_serverAdapterA_cnt_6_SLT_3___d2385,
       bram_serverAdapterA_outDataCore_notEmpty_OR_br_ETC___d995,
       bram_serverAdapterB_1_cnt_03_SLT_3___d1596,
       bram_serverAdapterB_1_outData_outData_whas__61_ETC___d1624,
       bram_serverAdapterB_2_cnt_21_SLT_3___d1597,
       bram_serverAdapterB_3_cnt_39_SLT_3___d1598,
       bram_serverAdapterB_cnt_5_SLT_3___d1595,
       edp_outDwRemain_382_ULE_4___d1384,
       ...
       edp_tlpBRAM_writeRemainDWLen_62_ULE_1___d2625,
       edp_tlpBRAM_writeRemainDWLen_62_ULE_2___d2624,
       edp_tlpBRAM_writeRemainDWLen_62_ULE_3___d2626,
       hasPush_AND_edp_dpControl_wget__151_BITS_7_TO__ETC___d1171,
       hasPush_AND_edp_dpControl_wget__151_BITS_7_TO__ETC___d1295,
       hasPush_AND_edp_dpControl_wget__151_BITS_7_TO__ETC___d1362,
       hasPush_AND_edp_dpControl_wget__151_BITS_7_TO__ETC___d1396,
       wmi_dpControl_whas__582_AND_bram_serverAdapter_ETC___d1628,
       wmi_wmi_operateD_535_AND_wmi_wmi_peerIsReady_5_ETC___d1710;
  ...
  assign MUX_edp_tlpXmtBusy$write_1__SEL_5 =
	     WILL_FIRE_RL_edp_dmaPushResponseHeader && _dfoo5 ;
  assign MUX_edp_xmtMetaOK$write_1__SEL_1 =
	     WILL_FIRE_RL_edp_dmaPushResponseBody &&
	     edp_outDwRemain_382_ULE_4___d1384 &&
	     edp_tlpBRAM_mRespF$D_OUT[135:128] == 8'h01 ;
  assign MUX_edp_xmtMetaOK$write_1__SEL_4 =
	     WILL_FIRE_RL_edp_dmaPushResponseHeader &&
	     edp_fabMesgAddrMS == 32'd0 &&
	     edp_tlpBRAM_mRespF$D_OUT[71:62] == 10'd1 &&
	     edp_tlpBRAM_mRespF$D_OUT[42:35] == 8'h01 ;
  ...
  assign MUX_bml_fabBufsAvail$write_1__VAL_1 =
	     (bml_fabAvail && !bml_remStart) ? x__h145181 : x__h145186 ;
  assign MUX_bml_fabBufsAvail$write_1__VAL_2 =
	     (dpControl[3:2] == 2'd1) ? x__h143830 : 16'd0 ;
  assign MUX_bml_fabFlowAddr$write_1__VAL_1 =
	     bml_fabBuf_value_815_EQ_bml_fabBuf_modulus_bw__ETC___d2545 ?
	       bml_fabFlowBase :
	       bml_fabFlowAddr_887_PLUS_bml_fabFlowSize_888___d2382 ;
  ...
  assign MUX_bml_lclCredit$write_1__VAL_1 =
	     (bml_lclBufDone && !bml_remStart) ? x__h145219 : x__h145224 ;
  ...
  assign MUX_bram_memory$a_put_3__VAL_3 =
	     { IF_0_MINUS_edp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2278[7:0],
	       IF_0_MINUS_edp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2278[15:8],
	       IF_0_MINUS_edp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2278[23:16],
	       IF_0_MINUS_edp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2278[31:24] } ;
  ...
  assign MUX_bram_memory_1$a_put_3__VAL_3 =
	     { IF_1_MINUS_edp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2279[7:0],
	       IF_1_MINUS_edp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2279[15:8],
	       IF_1_MINUS_edp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2279[23:16],
	       IF_1_MINUS_edp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2279[31:24] } ;
  ...
  assign MUX_bram_memory_2$a_put_3__VAL_3 =
	     { IF_2_MINUS_edp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2280[7:0],
	       IF_2_MINUS_edp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2280[15:8],
	       IF_2_MINUS_edp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2280[23:16],
	       IF_2_MINUS_edp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2280[31:24] } ;
  ...
  assign MUX_bram_memory_3$a_put_3__VAL_3 =
	     { IF_3_MINUS_edp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2281[7:0],
	       IF_3_MINUS_edp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2281[15:8],
	       IF_3_MINUS_edp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2281[23:16],
	       IF_3_MINUS_edp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2281[31:24] } ;
  ...
  assign MUX_edp_dgdpTx_new_data$wset_1__VAL_4 =
	     { IF_edp_firstMesgMH_329_THEN_1_ELSE_0_331_CONCA_ETC___d1349,
	       edp_firstMesgMH ?
		 edp_xactionNumber[23:16] :
  ...
  assign MUX_edp_fabMesgAccu$write_1__VAL_2 = edp_fabMesgAccu + y__h126400 ;
  ...
  assign MUX_edp_mesgLengthRemainPush$write_1__VAL_3 =
	     edp_mesgLengthRemainPush - y__h119412 ;
  assign MUX_edp_outDwRemain$write_1__VAL_1 =
	     edp_tlpBRAM_mRespF$D_OUT[71:62] - y__h126349 ;
  ...
  assign MUX_edp_remMesgAccu$write_1__VAL_2 =
	     edp_remMesgAccu + { 3'd0, thisRequestLength__h119387 } ;
  assign MUX_edp_srcMesgAccu$write_1__VAL_2 = edp_srcMesgAccu + y__h119503 ;
  ...
  assign MUX_edp_tlpBRAM_mReqF$enq_1__VAL_2 =
	     { 69'h12AAAAAAAAAAAAAAAA,
	       ...
	       thisRequestLength__h119387[11:2],
	       8'd255,
	       rreq_tag__h119580,
	       3'h2 } ;
  ...
  assign MUX_edp_tlpXmtBusy$write_1__VAL_5 =
	     edp_fabMesgAddrMS != 32'd0 ||
	     edp_tlpBRAM_mRespF$D_OUT[71:62] != 10'd1 ;
  ...
  assign MUX_wmi_wmi_respF_q_0$write_1__VAL_1 = { 2'd1, rdata__h139473 } ;
  ...
  assign bram_serverAdapterB_outData_enqData$whas =
	     ...
	     bram_serverAdapterB_s1[0] ;
  assign bram_serverAdapterB_outData_outData$wget = y_avValue__h139309 ;
  ...
  assign bram_serverAdapterB_1_outData_enqData$whas =
	     ...
	     bram_serverAdapterB_1_s1[0] ;
  assign bram_serverAdapterB_1_outData_outData$wget = y_avValue__h139329 ;
  ...
  assign bram_serverAdapterB_2_outData_enqData$whas =
	     ...
	     bram_serverAdapterB_2_s1[0] ;
  assign bram_serverAdapterB_2_outData_outData$wget = y_avValue__h139349 ;
  ...
  assign bram_serverAdapterB_3_outData_enqData$whas =
	     ...
	     bram_serverAdapterB_3_s1[0] ;
  assign bram_serverAdapterB_3_outData_outData$wget = y_avValue__h139369 ;
  ...
  assign edp_dgdpTx_delta_enq$whas =
	     ...
	     WILL_FIRE_RL_edp_dmaRequestNearMeta ||
	     WILL_FIRE_RL_edp_dmaResponseNearMetaBody ;
  assign edp_dgdpTx_delta_deq$wget = 1'b0 ;
  assign edp_dgdpTx_delta_deq$whas = 1'b0 ;
  ...
  assign edp_dgdpTx_num_empty$D_IN =
	     ...
	     { 2'd0,
	       IF_edp_dgdpTx_delta_enq_whas__070_THEN_edp_dgd_ETC___d2622 } ;
  ...
  assign edp_dgdpTx_vec$D_IN =
	     { (edp_dgdpTx_new_data$whas ?
		  _0_CONCAT_edp_dgdpTx_new_data_wget__084_BITS_12_ETC___d2383[511:8] :
		  504'd0) |
	       edp_dgdpTx_vec_135_SRL_edp_dgdpTx_delta_deq_wh_ETC___d2384[511:8],
	       (edp_dgdpTx_new_data$whas ?
		  _0_CONCAT_edp_dgdpTx_new_data_wget__084_BITS_12_ETC___d2383[7:0] :
		  8'd0) |
	       edp_dgdpTx_vec_135_SRL_edp_dgdpTx_delta_deq_wh_ETC___d2384[7:0] } ;
  ...
  always@(MUX_edp_tlpXmtBusy$write_1__SEL_1 or
	  ...
	  MUX_edp_tlpXmtBusy$write_1__SEL_5 or
	  MUX_edp_tlpXmtBusy$write_1__VAL_5)
  case (1'b1)
    ...
    WILL_FIRE_RL_edp_dmaXmtMetaHead: edp_tlpXmtBusy$D_IN = 1'd1;
    MUX_edp_tlpXmtBusy$write_1__SEL_5:
	edp_tlpXmtBusy$D_IN = MUX_edp_tlpXmtBusy$write_1__VAL_5;
  ...
  always@(MUX_edp_xmtMetaOK$write_1__SEL_1 or
	  ...
	  WILL_FIRE_RL_edp_dmaXmtMetaHead or MUX_edp_xmtMetaOK$write_1__SEL_4)
  case (1'b1)
    ...
    MUX_edp_xmtMetaOK$write_1__SEL_4: edp_xmtMetaOK$D_IN = 1'd1;
  ...
  assign wmi_wmi_sFlagReg$D_IN =
	     { y_avValue__h139329[7:0], y_avValue__h139309[23:0] } ;
  ...
  begin
    case (1'b1) // synopsys parallel_case
      ...
      WILL_FIRE_RL_wmi_doWriteFinalize: bram_memory$DIB = x3__h137714;
  ...
  begin
    case (1'b1) // synopsys parallel_case
      ...
      WILL_FIRE_RL_wmi_doWriteFinalize:
	  bram_memory_1$DIB = mesgMeta_opcode__h137754;
  ...
  assign IF_1_MINUS_edp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d708 =
	     ...
	     (IF_3_MINUS_edp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d705 ||
	      bram_serverAdapterA_3_cnt_80_SLT_3___d2388) ;
  assign IF_edp_dgdpTx_delta_enq_whas__070_THEN_edp_dgd_ETC___d2622 =
	     edp_dgdpTx_delta_enq$whas ? edp_dgdpTx_delta_enq$wget : 5'd0 ;
  assign IF_edp_firstMesgMH_329_THEN_1_ELSE_0_331_CONCA_ETC___d1344 =
	     { IF_edp_firstMesgMH_329_THEN_1_ELSE_0___d2649,
	       8'd0,
		 ...
		 edp_lastMetaV[15:8] } ;
  assign IF_edp_firstMesgMH_329_THEN_1_ELSE_0_331_CONCA_ETC___d1349 =
	     { IF_edp_firstMesgMH_329_THEN_1_ELSE_0_331_CONCA_ETC___d1344,
	       edp_firstMesgMH ?
  ...
  assign IF_edp_firstMesgMH_329_THEN_1_ELSE_0___d2649 =
	     edp_firstMesgMH ? 8'd1 : 8'd0 ;
  assign IF_edp_tlpBRAM_readReq_first__97_BITS_30_TO_29_ETC___d1037 =
	     edp_tlpBRAM_readReq_first__97_BITS_30_TO_29_99_ETC___d2627[0] ?
	       { bram_serverAdapterA_3_outData_outData$wget[7:0],
		 bram_serverAdapterA_3_outData_outData$wget[15:8],
		 bram_serverAdapterA_3_outData_outData$wget[23:16],
		 bram_serverAdapterA_3_outData_outData$wget[31:24],
  ...
  assign IF_edp_tlpBRAM_readReq_first__97_BITS_30_TO_29_ETC___d921 =
	     IF_edp_tlpBRAM_readReq_first__97_BITS_30_TO_29_ETC___d912 &&
	     CASE_edp_tlpBRAM_readReqD_OUT_BITS_30_TO_29_N_ETC__q16 ;
  assign IF_wmi_p4B_731_EQ_0_732_THEN_bram_serverAdapte_ETC___d1745 =
	     (wmi_p4B == 2'd0) ?
	       (bram_serverAdapterB_outDataCore$EMPTY_N ||
		bram_serverAdapterB_outData_enqData$whas) &&
	       bram_serverAdapterB_outData_outData$whas :
	       IF_wmi_p4B_731_EQ_1_734_THEN_bram_serverAdapte_ETC___d1740 &&
	       CASE_wmi_p4B_NOT_wmi_p4B_EQ_3_OR_bram_serverAd_ETC__q17 ;
  assign NOT_bml_lclBufDone_872_939_AND_IF_bml_dpContro_ETC___d1952 =
	     !bml_lclBufDone &&
	     CASE_dpControl_BITS_1_TO_0_bml_fabDone_0_bml_f_ETC__q3 ;
  assign NOT_wmi_wrActive_646_647_OR_NOT_wmi_rdActive_6_ETC___d1656 =
	     (!wmi_wrActive || !wmi_rdActive) && !wmi_wrFinalize &&
	     (wmi_mesgBufReady || wmi_mesgBusy) ;
  assign _0_CONCAT_IF_edp_firstMetaMH_196_THEN_2_ELSE_0__ETC___d1219 =
	     { 16'd0,
		 ...
		 edp_xactionNumber[15:8] :
		 edp_fabMetaAddr[15:8] } ;
  assign _0_CONCAT_edp_dgdpTx_new_data_wget__084_BITS_12_ETC___d2383 =
	     { 384'd0, x__h59164 } << x__h63813 ;
  assign _dfoo5 =
	     edp_fabMesgAddrMS != 32'd0 ||
	     edp_tlpBRAM_mRespF$D_OUT[71:62] != 10'd1 ||
	     edp_tlpBRAM_mRespF$D_OUT[42:35] == 8'h01 ;
  ...
  assign ab__h8853 =
	     (MUX_bram_memory_2$b_put_1__SEL_1 ||
	      WILL_FIRE_RL_wmi_reqMetadata) ?
	       2'd0 :
	       2'd2 ;
  assign bml_crdBuf_value_830_EQ_bml_crdBuf_modulus_bw__ETC___d2544 =
	     bml_crdBuf_value == bml_crdBuf_modulus ;
  assign bml_fabBuf_value_815_EQ_bml_fabBuf_modulus_bw__ETC___d2545 =
	     bml_fabBuf_value == bml_fabBuf_modulus ;
  assign bml_fabFlowAddr_887_PLUS_bml_fabFlowSize_888___d2382 =
	     bml_fabFlowAddr + bml_fabFlowSize ;
  assign bml_lclBufDone_872_AND_IF_bml_dpControl_wget___ETC___d2684 =
	     bml_lclBufDone &&
	     CASE_dpControl_BITS_1_TO_0_NOT_bml_fabDone_0_N_ETC__q6 ;
  assign bml_lclBuf_value_785_EQ_bml_lclBuf_modulus_bw__ETC___d2563 =
	     bml_lclBuf_value == bml_lclBuf_modulus ;
  assign bml_remBuf_value_800_EQ_bml_remBuf_modulus_bw__ETC___d2564 =
  ...
  assign bram_serverAdapterA_1_cnt_44_SLT_3___d2386 =
  ...
  assign bram_serverAdapterA_2_cnt_62_SLT_3___d2387 =
  ...
  assign bram_serverAdapterA_3_cnt_80_SLT_3___d2388 =
  ...
  assign bram_serverAdapterA_cnt_6_SLT_3___d2385 =
  ...
  assign bram_serverAdapterB_1_cnt_03_SLT_3___d1596 =
	     (bram_serverAdapterB_1_cnt ^ 3'h4) < 3'd7 ;
  assign bram_serverAdapterB_1_outData_outData_whas__61_ETC___d1624 =
	     bram_serverAdapterB_1_outData_outData$whas &&
	     (bram_serverAdapterB_2_outDataCore$EMPTY_N ||
	      bram_serverAdapterB_2_outData_enqData$whas) &&
	     bram_serverAdapterB_2_outData_outData$whas &&
  ...
  assign bram_serverAdapterB_2_cnt_21_SLT_3___d1597 =
  ...
  assign bram_serverAdapterB_3_cnt_39_SLT_3___d1598 =
  ...
  assign bram_serverAdapterB_cnt_5_SLT_3___d1595 =
	     (bram_serverAdapterB_cnt ^ 3'h4) < 3'd7 ;
  assign byteCount__h28459 = x__h28577 - y__h28578 ;
  assign edp_dgdpTx_vec_135_SRL_edp_dgdpTx_delta_deq_wh_ETC___d2384 =
	     edp_dgdpTx_vec >> 0 ;
  assign edp_mesgLengthRemainPush_PLUS_3__q15 =
	     edp_mesgLengthRemainPush + 17'd3 ;
  assign edp_outDwRemain_382_ULE_4___d1384 = edp_outDwRemain <= 10'd4 ;
  ...
  assign edp_tlpBRAM_readRemainDWLen_46_ULE_4___d847 =
	     edp_tlpBRAM_readRemainDWLen <= 10'd4 ;
  assign edp_tlpBRAM_readReq_first__97_BITS_30_TO_29_99_ETC___d2627 =
  ...
  assign edp_tlpBRAM_writeRemainDWLen_62_ULE_1___d2625 =
	     edp_tlpBRAM_writeRemainDWLen <= 10'd1 ;
  assign edp_tlpBRAM_writeRemainDWLen_62_ULE_2___d2624 =
	     edp_tlpBRAM_writeRemainDWLen <= 10'd2 ;
  assign edp_tlpBRAM_writeRemainDWLen_62_ULE_3___d2626 =
	     edp_tlpBRAM_writeRemainDWLen <= 10'd3 ;
  assign hasPush_AND_edp_dpControl_wget__151_BITS_7_TO__ETC___d1171 =
	     hasPush && dpControl[7:4] == 4'd0 && dpControl[3:2] == 2'd1 &&
	     dpControl[1:0] == 2'd1 &&
	     !edp_reqMetaInFlight &&
	     !edp_fabMeta[128] &&
	     edp_nearBufReady &&
	     edp_farBufReady ;
  assign hasPush_AND_edp_dpControl_wget__151_BITS_7_TO__ETC___d1295 =
	     hasPush && dpControl[7:4] == 4'd0 && dpControl[3:2] == 2'd1 &&
	     dpControl[1:0] == 2'd1 &&
	     edp_fabMeta[128] &&
  ...
  assign hasPush_AND_edp_dpControl_wget__151_BITS_7_TO__ETC___d1362 =
	     hasPush && dpControl[7:4] == 4'd0 && dpControl[3:2] == 2'd1 &&
	     dpControl[1:0] == 2'd1 &&
	     !edp_tlpBRAM_mRespF$D_OUT[138] &&
	     ...
	     !edp_tlpXmtBusy &&
	     edp_postSeqDwell == 4'd0 ;
  assign hasPush_AND_edp_dpControl_wget__151_BITS_7_TO__ETC___d1396 =
	     hasPush && dpControl[7:4] == 4'd0 && dpControl[3:2] == 2'd1 &&
	     dpControl[1:0] == 2'd1 &&
	     edp_fabMeta[128] &&
	     !edp_tlpXmtBusy &&
  ...
  assign mesgMeta_opcode__h137754 =
	     { 24'h800000, wmi_wmi_mFlagF$D_OUT[31:24] } ;
  assign nowLS__h115337 =
	     { edp_tlpBRAM_mRespF$D_OUT[39:32],
	       edp_tlpBRAM_mRespF$D_OUT[47:40],
	       edp_tlpBRAM_mRespF$D_OUT[55:48],
	       edp_tlpBRAM_mRespF$D_OUT[63:56] } ;
  assign nowMS__h114394 =
	     { edp_tlpBRAM_mRespF$D_OUT[71:64],
	       edp_tlpBRAM_mRespF$D_OUT[79:72],
	       edp_tlpBRAM_mRespF$D_OUT[87:80],
	       edp_tlpBRAM_mRespF$D_OUT[95:88] } ;
  assign opcode__h113163 =
	     { edp_tlpBRAM_mRespF$D_OUT[103:96],
	       edp_tlpBRAM_mRespF$D_OUT[111:104],
	       edp_tlpBRAM_mRespF$D_OUT[119:112],
	       edp_tlpBRAM_mRespF$D_OUT[127:120] } ;
  assign rdat__h147144 = { 16'd0, bml_lclNumBufs } ;
  assign rdat__h147152 = { 16'd0, bml_fabNumBufs } ;
  assign rdat__h147160 = { 16'd0, bml_mesgBase } ;
  assign rdat__h147168 = { 16'd0, bml_metaBase } ;
  assign rdat__h147176 = { 16'd0, bml_mesgSize } ;
  assign rdat__h147184 = { 16'd0, bml_metaSize } ;
  assign rdat__h147192 = { 16'd0, bml_lclBufsCF } ;
  assign rdat__h147213 =
	     hasDebugLogic ? { bml_lclBufsAR, bml_fabBufsAvail } : 32'd0 ;
  assign rdat__h147220 =
	     hasDebugLogic ? { bml_remBuf_value, bml_lclBuf_value } : 32'd0 ;
  assign rdat__h147233 =
	     hasDebugLogic ? { bml_lclStarts, bml_lclDones } : 32'd0 ;
  assign rdat__h147240 =
	     hasDebugLogic ? { bml_remStarts, bml_remDones } : 32'd0 ;
  assign rdat__h147247 = hasDebugLogic ? wmi_thisMesg : 32'd0 ;
  assign rdat__h147511 = hasDebugLogic ? wmi_lastMesg : 32'd0 ;
  assign rdat__h147561 =
	     hasDebugLogic ? { wmi_reqCount, wmi_wrtCount } : 32'd0 ;
  assign rdat__h147661 = hasDebugLogic ? 32'hDADEBABE : 32'd0 ;
  assign rdat__h147719 = { 24'd0, dpControl } ;
  assign rdat__h147741 = hasDebugLogic ? edp_flowDiagCount : 32'd0 ;
  assign rdat__h147751 =
	     hasDebugLogic ?
	       { 4'h0,
		 edp_complTimerCount,
		 12'h0,
		 CASE_edp_lastRuleFired_10_1_edp_lastRuleFired__ETC__q2 } :
	       32'd0 ;
  assign rdat__h147873 = hasDebugLogic ? edp_lastMetaV : 32'd0 ;
  assign rdat__h147993 = hasDebugLogic ? edp_lastMetaV_1 : 32'd0 ;
  assign rdat__h148022 = hasDebugLogic ? edp_lastMetaV_2 : 32'd0 ;
  assign rdat__h148051 = hasDebugLogic ? edp_lastMetaV_3 : 32'd0 ;
  assign rdat__h148080 = hasDebugLogic ? 32'hC0DE0111 : 32'd0 ;
  assign rdat__h148110 = hasDebugLogic ? dmaStartTime[31:0] : 32'd0 ;
  assign rdat__h148144 = hasDebugLogic ? dmaStartTime[63:32] : 32'd0 ;
  assign rdat__h148177 = hasDebugLogic ? dmaDoneTime[31:0] : 32'd0 ;
  assign rdat__h148211 = hasDebugLogic ? dmaDoneTime[63:32] : 32'd0 ;
  assign rdata__h33888 =
	     edp_tlpBRAM_readReq_first__97_BITS_30_TO_29_99_ETC___d2627[1] ?
	       IF_edp_tlpBRAM_readReq_first__97_BITS_30_TO_29_ETC___d1037 :
	       IF_edp_tlpBRAM_readReq_first__97_BITS_30_TO_29_ETC___d1042 ;
  assign rreq_tag__h119580 =
	     (y__h119412 == edp_mesgLengthRemainPush) ? 8'h01 : 8'h0 ;
  assign rresp_data__h28504 =
	     { IF_edp_tlpBRAM_readReq_first__97_BITS_30_TO_29_ETC___d2633[7:0],
	       IF_edp_tlpBRAM_readReq_first__97_BITS_30_TO_29_ETC___d2633[15:8],
	       IF_edp_tlpBRAM_readReq_first__97_BITS_30_TO_29_ETC___d2633[23:16],
	       IF_edp_tlpBRAM_readReq_first__97_BITS_30_TO_29_ETC___d2633[31:24] } ;
  assign spanToNextPage__h119386 =
	     13'd4096 - { 1'd0, edp_srcMesgAccu[11:0] } ;
  assign thisRequestLength__h119387 =
	     (x__h119422[12:0] <= spanToNextPage__h119386) ?
	       x__h119422[12:0] :
	       spanToNextPage__h119386 ;
  assign wmi_dpControl_whas__582_AND_bram_serverAdapter_ETC___d1628 =
	     (bram_serverAdapterB_outDataCore$EMPTY_N ||
	      bram_serverAdapterB_outData_enqData$whas) &&
	     bram_serverAdapterB_outData_outData$whas &&
	     (bram_serverAdapterB_1_outDataCore$EMPTY_N ||
	      bram_serverAdapterB_1_outData_enqData$whas) &&
	     bram_serverAdapterB_1_outData_outData_whas__61_ETC___d1624 ;
  assign wmi_wmi_operateD_535_AND_wmi_wmi_peerIsReady_5_ETC___d1710 =
	     wmi_wmi_operateD && wmi_wmi_peerIsReady &&
	     bram_serverAdapterB_cnt_5_SLT_3___d1595 &&
	     bram_serverAdapterB_1_cnt_03_SLT_3___d1596 &&
	     bram_serverAdapterB_2_cnt_21_SLT_3___d1597 &&
	     bram_serverAdapterB_3_cnt_39_SLT_3___d1598 &&
	     wmi_wmi_mFlagF$EMPTY_N ;
  assign x3__h137714 = { 8'd0, wmi_wmi_mFlagF$D_OUT[23:0] } ;
  assign x__h111329 =
	     { edp_tlpBRAM_mRespF$D_OUT[7:0],
	       edp_tlpBRAM_mRespF$D_OUT[15:8],
	       edp_tlpBRAM_mRespF$D_OUT[23:16],
	       edp_tlpBRAM_mRespF$D_OUT[31:24] } ;
  assign x__h116340 = { 15'd0, edp_mesgLengthRemainPush } ;
  assign x__h119422 =
	     (edp_mesgLengthRemainPush <= y__h119424) ?
	       edp_mesgLengthRemainPush :
	       y__h119424 ;
  assign x__h143830 = (dpControl[1:0] == 2'd1) ? bml_fabNumBufs : 16'd0 ;
  assign x__h144954 = bml_lclBufsAR + 16'd1 ;
  assign x__h144959 = bml_lclBufsAR - 16'd1 ;
  assign x__h145066 = bml_lclBufsCF + 16'd1 ;
  assign x__h145103 = bml_lclBufsCF - 16'd1 ;
  assign x__h145181 = bml_fabBufsAvail + 16'd1 ;
  assign x__h145186 = bml_fabBufsAvail - 16'd1 ;
  assign x__h145219 = bml_lclCredit + 16'd1 ;
  assign x__h145224 = bml_lclCredit - 16'd1 ;
  assign x__h28577 = x__h28579 - y__h28580 ;
  assign x__h28579 = { edp_tlpBRAM_readReq$D_OUT[28:19], 2'b0 } ;
  assign x__h59164 =
	     { edp_dgdpTx_new_data$wget[127:8] &
	       { (IF_edp_dgdpTx_delta_enq_whas__070_THEN_edp_dgd_ETC___d2622 <=
		  5'd15) ?
		   8'd0 :
		   8'd255,
		 ...
		 5'd0) ?
		  8'd0 :
		  8'd255) } ;
  assign x__h63813 = { edp_dgdpTx_num_full - 7'd0, 3'd0 } ;
  assign y__h119412 = { 4'd0, thisRequestLength__h119387 } ;
  assign y__h119424 = { 4'd0, edp_maxPayloadSize } ;
  assign y__h119503 = { 19'd0, thisRequestLength__h119387 } ;
  assign y__h126349 = (edp_fabMesgAddrMS == 32'd0) ? 10'd1 : 10'd0 ;
  assign y__h126400 = { 20'd0, edp_tlpBRAM_mRespF$D_OUT[71:62], 2'd0 } ;
  ...
  assign y_avValue__h139309 =
	     bram_serverAdapterB_outDataCore$EMPTY_N ?
	       bram_serverAdapterB_outDataCore$D_OUT :
	       bram_memory$DOB ;
  assign y_avValue__h139329 =
	     bram_serverAdapterB_1_outDataCore$EMPTY_N ?
	       bram_serverAdapterB_1_outDataCore$D_OUT :
	       bram_memory_1$DOB ;
  assign y_avValue__h139349 =
	     bram_serverAdapterB_2_outDataCore$EMPTY_N ?
	       bram_serverAdapterB_2_outDataCore$D_OUT :
	       bram_memory_2$DOB ;
  assign y_avValue__h139369 =
	     bram_serverAdapterB_3_outDataCore$EMPTY_N ?
	       bram_serverAdapterB_3_outDataCore$D_OUT :
	       bram_memory_3$DOB ;
  ...
  always@(wmi_p4B or
	  y_avValue__h139369 or
	  y_avValue__h139309 or y_avValue__h139329 or y_avValue__h139349)
  begin
    case (wmi_p4B)
      2'd0: rdata__h139473 = y_avValue__h139309;
      2'd1: rdata__h139473 = y_avValue__h139329;
      2'd2: rdata__h139473 = y_avValue__h139349;
      2'd3: rdata__h139473 = y_avValue__h139369;
    endcase
  end
  always@(wci_reqF$D_OUT or
	  ...
	  rdat__h148110 or rdat__h148144 or rdat__h148177 or rdat__h148211)
  begin
    case (wci_reqF$D_OUT[39:32])
      8'h0: _theResult____h147065 = rdat__h147144;
      8'h04: _theResult____h147065 = rdat__h147152;
      8'h08: _theResult____h147065 = rdat__h147160;
      8'h0C: _theResult____h147065 = rdat__h147168;
      8'h10: _theResult____h147065 = rdat__h147176;
      8'h14: _theResult____h147065 = rdat__h147184;
      8'h20: _theResult____h147065 = rdat__h147192;
      8'h24: _theResult____h147065 = 32'hF00DFACE;
      8'h28: _theResult____h147065 = rdat__h147213;
      8'h2C: _theResult____h147065 = rdat__h147220;
      8'h30: _theResult____h147065 = rdat__h147233;
      8'h34: _theResult____h147065 = rdat__h147240;
      8'h38: _theResult____h147065 = rdat__h147247;
      8'h3C: _theResult____h147065 = rdat__h147511;
      8'h40: _theResult____h147065 = rdat__h147561;
      8'h44: _theResult____h147065 = 32'd0;
      8'h48: _theResult____h147065 = rdat__h147661;
      8'h4C: _theResult____h147065 = 32'h00008000;
      8'h50: _theResult____h147065 = bml_fabMesgBase;
      8'h54: _theResult____h147065 = bml_fabMetaBase;
      8'h58: _theResult____h147065 = bml_fabMesgSize;
      8'h5C: _theResult____h147065 = bml_fabMetaSize;
      8'h60: _theResult____h147065 = bml_fabFlowBase;
      8'h64: _theResult____h147065 = bml_fabFlowSize;
      8'h68: _theResult____h147065 = rdat__h147719;
      8'h6C: _theResult____h147065 = rdat__h147741;
      8'h70: _theResult____h147065 = rdat__h147751;
      8'h80: _theResult____h147065 = rdat__h147873;
      8'h84: _theResult____h147065 = rdat__h147993;
      8'h88: _theResult____h147065 = rdat__h148022;
      8'h8C: _theResult____h147065 = rdat__h148051;
      8'h90: _theResult____h147065 = rdat__h148080;
      8'h94: _theResult____h147065 = bml_fabMesgBaseMS;
      8'h98: _theResult____h147065 = bml_fabMetaBaseMS;
      8'h9C: _theResult____h147065 = bml_fabFlowBaseMS;
      8'hA0: _theResult____h147065 = rdat__h148110;
      8'hA4: _theResult____h147065 = rdat__h148144;
      8'hA8: _theResult____h147065 = rdat__h148177;
      8'hAC: _theResult____h147065 = rdat__h148211;
      default: _theResult____h147065 = 32'd0;
    endcase
  end
  always@(edp_tlpBRAM_readReq$D_OUT)
  begin
  ...
  begin
    case (dpControl[1:0])
	  ...
	  IF_bml_dpControl_wget__848_BITS_1_TO_0_854_EQ__ETC___d1925 =
	      bml_remDone;
      default: IF_bml_dpControl_wget__848_BITS_1_TO_0_854_EQ__ETC___d1925 =
		   bml_fabDone;
    endcase
  end
  ...
  always@(idx__h19085 or
	  edp_tlpBRAM_writeRemainDWLen_62_ULE_3___d2626 or
	  edp_tlpBRAM_writeRemainDWLen or
	  edp_tlpBRAM_writeRemainDWLen_62_ULE_1___d2625 or
	  edp_tlpBRAM_writeRemainDWLen_62_ULE_2___d2624)
  begin
    case (idx__h19085)
      2'd0:
  ...
  always@(edp_tlpBRAM_mReqF$D_OUT or
	  bram_serverAdapterA_3_cnt_80_SLT_3___d2388 or
	  bram_serverAdapterA_cnt_6_SLT_3___d2385 or
	  bram_serverAdapterA_1_cnt_44_SLT_3___d2386 or
	  bram_serverAdapterA_2_cnt_62_SLT_3___d2387)
  begin
  ...
  always@(wmi_addr or
	  bram_serverAdapterB_3_cnt_39_SLT_3___d1598 or
	  bram_serverAdapterB_cnt_5_SLT_3___d1595 or
	  bram_serverAdapterB_1_cnt_03_SLT_3___d1596 or
	  bram_serverAdapterB_2_cnt_21_SLT_3___d1597)
  begin
    case (wmi_addr[3:2])
      2'd0:
  ...
  begin
    case (idx__h19085)
      2'd0:
	  IF_0_MINUS_edp_tlpBRAM_writeDWAddr_58_BITS_1_T_ETC___d2278 =
  ...
  begin
    case (wmi_p4B)
	  ...
	  IF_wmi_p4B_731_EQ_1_734_THEN_bram_serverAdapte_ETC___d1740 =
	      bram_serverAdapterB_2_outDataCore$EMPTY_N ||
	      bram_serverAdapterB_2_outData_enqData$whas;
      default: IF_wmi_p4B_731_EQ_1_734_THEN_bram_serverAdapte_ETC___d1740 =
		   wmi_p4B != 2'd3 ||
		   bram_serverAdapterB_3_outDataCore$EMPTY_N ||
		   bram_serverAdapterB_3_outData_enqData$whas;
    endcase
  ...
  begin
    case (server_request_put[9:8])
      ...
      2'd3: CASE_server_request_put_BITS_9_TO_8_3_0_server_ETC__q18 = 2'd3;
    endcase
  end
  ...
  begin
	...
	edp_dgdpTx_vec <= `BSV_ASSIGNMENT_DELAY 512'd0;
  ...
  begin
    ...
    if (RST_N)
      if (WILL_FIRE_RL_edp_dmaXmtMetaHead)
	$display("[%0d]: %m: dmaXmtMetaHead FPactMesg-Step5/7", v__h127085);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_edp_dmaXmtTailEvent)
	$display("[%0d]: %m: dmaXmtTailEvent FPactMesg-Step7/7", v__h127348);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_edp_dmaXmtMetaBody)
	$display("[%0d]: %m: dmaXmtMetaBody FPactMesg-Step6/7", v__h127228);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_edp_dmaTailEventSender)
	$display("[%0d]: %m: dmaTailEventSender - generic", v__h128317);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_wci_cfwr && wci_reqF$D_OUT[39:32] == 8'h18)
	$display("[%0d] %m: fabDoneAvail Event", v__h146458);
    if (RST_N)
