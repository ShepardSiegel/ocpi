...
//
// On Tue Sep 18 13:35:34 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkOCEDP4B(pciDevice,
  ...
  reg [31 : 0] IF_0_MINUS_edp_tlpBRAM_writeDWAddr_22_BITS_1_T_ETC___d2671,
	       ...
	       IF_edp_tlpBRAM_readReq_first__061_BITS_30_TO_2_ETC___d3119,
	       _theResult____h117161,
	       rdata__h109597;
  ...
  wire IF_1_MINUS_edp_tlpBRAM_writeDWAddr_22_BITS_1_T_ETC___d872,
       ...
       edp_tlpBRAM_writeRemainDWLen_26_ULE_1___d3105,
       edp_tlpBRAM_writeRemainDWLen_26_ULE_2___d3106,
  ...
  assign MUX_bml_fabBufsAvail$write_1__VAL_1 =
	     (bml_fabAvail && !bml_remStart) ? x__h115305 : x__h115310 ;
  assign MUX_bml_fabBufsAvail$write_1__VAL_2 =
	     (dpControl[3:2] == 2'd1) ? x__h113954 : 16'd0 ;
  ...
  assign MUX_bml_lclCredit$write_1__VAL_1 =
	     (bml_lclBufDone && !bml_remStart) ? x__h115343 : x__h115348 ;
  ...
  assign MUX_wmi_wmi_respF_q_0$write_1__VAL_1 = { 2'd1, rdata__h109597 } ;
  ...
  assign bram_serverAdapterB_outData_enqData$whas =
	     ...
	     bram_serverAdapterB_s1[0] ;
  assign bram_serverAdapterB_outData_outData$wget = y_avValue__h109433 ;
  ...
  assign bram_serverAdapterB_1_outData_enqData$whas =
	     ...
	     bram_serverAdapterB_1_s1[0] ;
  assign bram_serverAdapterB_1_outData_outData$wget = y_avValue__h109453 ;
  ...
  assign bram_serverAdapterB_2_outData_enqData$whas =
	     ...
	     bram_serverAdapterB_2_s1[0] ;
  assign bram_serverAdapterB_2_outData_outData$wget = y_avValue__h109473 ;
  ...
  assign bram_serverAdapterB_3_outData_enqData$whas =
	     ...
	     bram_serverAdapterB_3_s1[0] ;
  assign bram_serverAdapterB_3_outData_outData$wget = y_avValue__h109493 ;
  ...
  assign wmi_wmi_sFlagReg$D_IN =
	     { y_avValue__h109453[7:0], y_avValue__h109433[23:0] } ;
  ...
  begin
    case (1'b1) // synopsys parallel_case
      ...
      WILL_FIRE_RL_wmi_doWriteFinalize: bram_memory$DIB = x3__h107838;
  ...
  begin
    case (1'b1) // synopsys parallel_case
      ...
      WILL_FIRE_RL_wmi_doWriteFinalize:
	  bram_memory_1$DIB = mesgMeta_opcode__h107878;
  ...
  assign edp_tlpBRAM_writeRemainDWLen_26_ULE_1___d3105 =
	     edp_tlpBRAM_writeRemainDWLen <= 10'd1 ;
  assign edp_tlpBRAM_writeRemainDWLen_26_ULE_2___d3106 =
  ...
  assign mesgMeta_opcode__h107878 =
  ...
  assign rdat__h117240 = { 16'd0, bml_lclNumBufs } ;
  assign rdat__h117248 = { 16'd0, bml_fabNumBufs } ;
  assign rdat__h117256 = { 16'd0, bml_mesgBase } ;
  assign rdat__h117264 = { 16'd0, bml_metaBase } ;
  assign rdat__h117272 = { 16'd0, bml_mesgSize } ;
  assign rdat__h117280 = { 16'd0, bml_metaSize } ;
  assign rdat__h117288 = { 16'd0, bml_lclBufsCF } ;
  assign rdat__h117309 =
	     hasDebugLogic ? { bml_lclBufsAR, bml_fabBufsAvail } : 32'd0 ;
  assign rdat__h117316 =
	     hasDebugLogic ? { bml_remBuf_value, bml_lclBuf_value } : 32'd0 ;
  assign rdat__h117329 =
	     hasDebugLogic ? { bml_lclStarts, bml_lclDones } : 32'd0 ;
  assign rdat__h117336 =
	     hasDebugLogic ? { bml_remStarts, bml_remDones } : 32'd0 ;
  assign rdat__h117343 = hasDebugLogic ? wmi_thisMesg : 32'd0 ;
  assign rdat__h117607 = hasDebugLogic ? wmi_lastMesg : 32'd0 ;
  assign rdat__h117657 =
	     hasDebugLogic ? { wmi_reqCount, wmi_wrtCount } : 32'd0 ;
  assign rdat__h117757 = hasDebugLogic ? 32'hDADEBABE : 32'd0 ;
  assign rdat__h117815 = { 24'd0, dpControl } ;
  assign rdat__h117837 = hasDebugLogic ? edp_flowDiagCount : 32'd0 ;
  assign rdat__h117847 =
	     hasDebugLogic ?
	       { 4'h0,
		 edp_complTimerCount,
		 12'h0,
		 CASE_edp_lastRuleFired_10_1_edp_lastRuleFired__ETC__q5 } :
	       32'd0 ;
  assign rdat__h117969 = hasDebugLogic ? edp_lastMetaV : 32'd0 ;
  assign rdat__h118089 = hasDebugLogic ? edp_lastMetaV_1 : 32'd0 ;
  assign rdat__h118118 = hasDebugLogic ? edp_lastMetaV_2 : 32'd0 ;
  assign rdat__h118147 = hasDebugLogic ? edp_lastMetaV_3 : 32'd0 ;
  assign rdat__h118176 = hasDebugLogic ? 32'hC0DE0111 : 32'd0 ;
  assign rdat__h118206 = hasDebugLogic ? dmaStartTime[31:0] : 32'd0 ;
  assign rdat__h118240 = hasDebugLogic ? dmaStartTime[63:32] : 32'd0 ;
  assign rdat__h118273 = hasDebugLogic ? dmaDoneTime[31:0] : 32'd0 ;
  assign rdat__h118307 = hasDebugLogic ? dmaDoneTime[63:32] : 32'd0 ;
  assign rdat__h118340 = hasDebugLogic ? edp_dbgBytesTxEnq : 32'd0 ;
  assign rdat__h118351 = hasDebugLogic ? edp_dbgBytesTxDeq : 32'd0 ;
  assign rdat__h118362 = hasDebugLogic ? edpDebug : 32'd0 ;
  ...
  assign rresp_data__h35499 =
	     { IF_edp_tlpBRAM_readReq_first__061_BITS_30_TO_2_ETC___d3119[7:0],
	       IF_edp_tlpBRAM_readReq_first__061_BITS_30_TO_2_ETC___d3119[15:8],
	       IF_edp_tlpBRAM_readReq_first__061_BITS_30_TO_2_ETC___d3119[23:16],
	       IF_edp_tlpBRAM_readReq_first__061_BITS_30_TO_2_ETC___d3119[31:24] } ;
  ...
  assign wmi_wmi_operateD_864_AND_wmi_wmi_peerIsReady_8_ETC___d2039 =
	     ...
	     bram_serverAdapterB_3_cnt_39_SLT_3___d1927 &&
	     wmi_wmi_mFlagF$EMPTY_N ;
  assign x3__h107838 = { 8'd0, wmi_wmi_mFlagF$D_OUT[23:0] } ;
  assign x__h113954 = (dpControl[1:0] == 2'd1) ? bml_fabNumBufs : 16'd0 ;
  assign x__h115078 = bml_lclBufsAR + 16'd1 ;
  assign x__h115083 = bml_lclBufsAR - 16'd1 ;
  assign x__h115190 = bml_lclBufsCF + 16'd1 ;
  assign x__h115227 = bml_lclBufsCF - 16'd1 ;
  assign x__h115305 = bml_fabBufsAvail + 16'd1 ;
  assign x__h115310 = bml_fabBufsAvail - 16'd1 ;
  assign x__h115343 = bml_lclCredit + 16'd1 ;
  assign x__h115348 = bml_lclCredit - 16'd1 ;
  ...
  assign y_avValue__h109433 =
	     bram_serverAdapterB_outDataCore$EMPTY_N ?
	       bram_serverAdapterB_outDataCore$D_OUT :
	       bram_memory$DOB ;
  assign y_avValue__h109453 =
	     bram_serverAdapterB_1_outDataCore$EMPTY_N ?
	       bram_serverAdapterB_1_outDataCore$D_OUT :
	       bram_memory_1$DOB ;
  assign y_avValue__h109473 =
	     bram_serverAdapterB_2_outDataCore$EMPTY_N ?
	       bram_serverAdapterB_2_outDataCore$D_OUT :
	       bram_memory_2$DOB ;
  assign y_avValue__h109493 =
	     bram_serverAdapterB_3_outDataCore$EMPTY_N ?
	       bram_serverAdapterB_3_outDataCore$D_OUT :
	       bram_memory_3$DOB ;
  ...
  always@(wmi_p4B or
	  y_avValue__h109493 or
	  y_avValue__h109433 or y_avValue__h109453 or y_avValue__h109473)
  begin
    case (wmi_p4B)
      2'd0: rdata__h109597 = y_avValue__h109433;
      2'd1: rdata__h109597 = y_avValue__h109453;
      2'd2: rdata__h109597 = y_avValue__h109473;
      2'd3: rdata__h109597 = y_avValue__h109493;
    endcase
  end
  always@(wci_reqF$D_OUT or
	  ...
	  rdat__h118240 or
	  rdat__h118273 or
	  rdat__h118307 or rdat__h118340 or rdat__h118351 or rdat__h118362)
  begin
    case (wci_reqF$D_OUT[39:32])
      8'h0: _theResult____h117161 = rdat__h117240;
      8'h04: _theResult____h117161 = rdat__h117248;
      8'h08: _theResult____h117161 = rdat__h117256;
      8'h0C: _theResult____h117161 = rdat__h117264;
      8'h10: _theResult____h117161 = rdat__h117272;
      8'h14: _theResult____h117161 = rdat__h117280;
      8'h20: _theResult____h117161 = rdat__h117288;
      8'h24: _theResult____h117161 = 32'hF00DFACE;
      8'h28: _theResult____h117161 = rdat__h117309;
      8'h2C: _theResult____h117161 = rdat__h117316;
      8'h30: _theResult____h117161 = rdat__h117329;
      8'h34: _theResult____h117161 = rdat__h117336;
      8'h38: _theResult____h117161 = rdat__h117343;
      8'h3C: _theResult____h117161 = rdat__h117607;
      8'h40: _theResult____h117161 = rdat__h117657;
      8'h44: _theResult____h117161 = 32'd0;
      8'h48: _theResult____h117161 = rdat__h117757;
      8'h4C: _theResult____h117161 = 32'h00008000;
      8'h50: _theResult____h117161 = bml_fabMesgBase;
      8'h54: _theResult____h117161 = bml_fabMetaBase;
      8'h58: _theResult____h117161 = bml_fabMesgSize;
      8'h5C: _theResult____h117161 = bml_fabMetaSize;
      8'h60: _theResult____h117161 = bml_fabFlowBase;
      8'h64: _theResult____h117161 = bml_fabFlowSize;
      8'h68: _theResult____h117161 = rdat__h117815;
      8'h6C: _theResult____h117161 = rdat__h117837;
      8'h70: _theResult____h117161 = rdat__h117847;
      8'h80: _theResult____h117161 = rdat__h117969;
      8'h84: _theResult____h117161 = rdat__h118089;
      8'h88: _theResult____h117161 = rdat__h118118;
      8'h8C: _theResult____h117161 = rdat__h118147;
      8'h90: _theResult____h117161 = rdat__h118176;
      8'h94: _theResult____h117161 = bml_fabMesgBaseMS;
      8'h98: _theResult____h117161 = bml_fabMetaBaseMS;
      8'h9C: _theResult____h117161 = bml_fabFlowBaseMS;
      8'hA0: _theResult____h117161 = rdat__h118206;
      8'hA4: _theResult____h117161 = rdat__h118240;
      8'hA8: _theResult____h117161 = rdat__h118273;
      8'hAC: _theResult____h117161 = rdat__h118307;
      8'hB0: _theResult____h117161 = rdat__h118340;
      8'hB4: _theResult____h117161 = rdat__h118351;
      8'hB8: _theResult____h117161 = rdat__h118362;
      default: _theResult____h117161 = 32'd0;
    endcase
  end
  always@(edp_tlpBRAM_readReq$D_OUT)
  begin
  ...
  always@(idx__h26080 or
	  ...
	  edp_tlpBRAM_writeRemainDWLen_26_ULE_1___d3105 or
	  edp_tlpBRAM_writeRemainDWLen_26_ULE_2___d3106)
  begin
    case (idx__h26080)
      2'd0:
