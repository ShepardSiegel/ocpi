...
//
// On Tue Jul 13 07:46:25 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker32B(wciS0_Clk,
  ...
  wire [255 : 0] x__h15357, x__h19802;
  ...
  assign MUX_mesgLength$write_1__VAL_3 = { 1'd1, mlp1__h17940[8:0], 5'd0 } ;
  ...
  assign mesgRF$D_IN = { 224'd0, v__h23184 } ;
  ...
  assign x_byteEn__h22904 = (readMeta[23:0] == 24'd0) ? 32'd0 : 32'hFFFFFFFF ;
