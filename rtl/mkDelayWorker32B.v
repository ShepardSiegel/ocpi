...
//
// On Tue Jul 13 17:08:34 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker32B(wciS0_Clk,
  ...
  wire [255 : 0] x__h15357, x__h19855;
  ...
  assign MUX_mesgLength$write_1__VAL_3 = { 1'd1, mlp1__h17993[8:0], 5'd0 } ;
  ...
  assign mesgRF$D_IN = { 224'd0, v__h23365 } ;
  ...
  assign x_byteEn__h23085 = (readMeta[23:0] == 24'd0) ? 32'd0 : 32'hFFFFFFFF ;
