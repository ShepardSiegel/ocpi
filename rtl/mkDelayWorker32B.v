...
//
// On Tue Jun  1 17:10:23 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker32B(wciS0_Clk,
  ...
  wire [255 : 0] mesg__h20847, x__h15015, x__h15941, x__h19468;
  wire [31 : 0] rdat__h20418, v__h21160, x_byteEn__h20939;
  ...
  assign MUX_mesgLength$write_1__VAL_3 = { 1'd1, mlp1__h17575[8:0], 5'd0 } ;
  ...
  assign mesgRF_wDataIn$wget = { 224'd0, v__h21160 } ;
  ...
  assign x__h15941 = CAN_FIRE_RL_rdSer_body ? mesgRF_wDataIn$wget : 256'd0 ;
  ...
  assign x_byteEn__h20939 = (readMeta[23:0] == 24'd0) ? 32'd0 : 32'hFFFFFFFF ;
  always@(wrtSerPos)
  begin
    case (wrtSerPos)
