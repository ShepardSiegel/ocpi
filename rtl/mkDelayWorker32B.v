...
//
// On Mon Jun  7 12:26:43 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker32B(wciS0_Clk,
  ...
  wire [255 : 0] mesg__h22342, x__h15234, x__h16160, x__h19907;
  ...
  assign MUX_mesgLength$write_1__VAL_3 = { 1'd1, mlp1__h17955[8:0], 5'd0 } ;
  ...
  assign mesgRF_wDataIn$wget = { 224'd0, v__h22716 } ;
  ...
  assign x__h16160 = CAN_FIRE_RL_rdSer_body ? mesgRF_wDataIn$wget : 256'd0 ;
  ...
  assign x_byteEn__h22434 = (readMeta[23:0] == 24'd0) ? 32'd0 : 32'hFFFFFFFF ;
