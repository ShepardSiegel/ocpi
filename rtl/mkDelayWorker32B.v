...
//
// On Wed Jul 14 09:20:14 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker32B(wciS0_Clk,
  ...
  wire [255 : 0] x__h15359, x__h19937;
  ...
  assign MUX_mesgLength$write_1__VAL_3 = { 1'd1, mlp1__h18075[8:0], 5'd0 } ;
  ...
  assign mesgRF$D_IN = { 224'd0, v__h23462 } ;
  ...
  assign x_byteEn__h23182 = (readMeta[23:0] == 24'd0) ? 32'd0 : 32'hFFFFFFFF ;
