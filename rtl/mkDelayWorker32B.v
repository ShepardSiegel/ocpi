...
//
// On Wed Jun 16 18:04:02 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker32B(wciS0_Clk,
  ...
  assign MUX_mesgLength$write_1__VAL_3 = { 1'd1, mlp1__h17953[8:0], 5'd0 } ;
  ...
  assign mesgRF_wDataIn$wget = { 224'd0, v__h22720 } ;
  ...
  assign x_byteEn__h22438 = (readMeta[23:0] == 24'd0) ? 32'd0 : 32'hFFFFFFFF ;
