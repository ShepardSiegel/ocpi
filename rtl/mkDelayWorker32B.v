...
//
// On Thu Jul  1 06:53:53 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker32B(wciS0_Clk,
  ...
  wire [255 : 0] x__h15105, x__h18798;
  ...
  assign MUX_mesgLength$write_1__VAL_3 = { 1'd1, mlp1__h16974[8:0], 5'd0 } ;
  ...
  assign mesgRF$D_IN = { 224'd0, v__h21637 } ;
  ...
  assign x_byteEn__h21357 = (readMeta[23:0] == 24'd0) ? 32'd0 : 32'hFFFFFFFF ;
