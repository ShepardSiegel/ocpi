...
//
// On Fri Oct 22 08:41:31 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker32B(wciS0_Clk,
  ...
  wire [255 : 0] x__h15075, x__h17995;
  ...
  assign mesgRF$D_IN = { 224'd0, v__h20256 } ;
  ...
  assign x_byteEn__h19979 = (readMeta[23:0] == 24'd0) ? 32'd0 : 32'hFFFFFFFF ;
  always@(wrtSerPos)
  begin
    case (wrtSerPos)
