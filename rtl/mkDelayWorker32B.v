...
//
// On Fri Oct 29 10:34:19 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker32B(wciS0_Clk,
  ...
  wire [255 : 0] x__h15107, x__h18027;
  ...
  assign mesgRF$D_IN = { 224'd0, v__h20288 } ;
  ...
  assign btm__h17061 =
		 ...
		 { 5'd0, mesgLengthSoFar_05_PLUS_1___d957 },
	       5'd0 } ;
  ...
  assign x_byteEn__h20011 = (readMeta[23:0] == 24'd0) ? 32'd0 : 32'hFFFFFFFF ;
  always@(wrtSerPos)
  begin
    case (wrtSerPos)
