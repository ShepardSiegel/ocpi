...
//
// On Wed Jul  7 12:36:32 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker32B(wciS0_Clk,
  ...
  wire [255 : 0] x__h15147, x__h19523;
  ...
  assign MUX_mesgLength$write_1__VAL_3 = { 1'd1, mlp1__h17699[8:0], 5'd0 } ;
  ...
  assign mesgRF$D_IN = { 224'd0, v__h22925 } ;
  ...
  assign x_byteEn__h22645 = (readMeta[23:0] == 24'd0) ? 32'd0 : 32'hFFFFFFFF ;
