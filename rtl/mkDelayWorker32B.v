...
//
// On Thu Jun  3 15:12:02 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker32B(wciS0_Clk,
  ...
  wire [255 : 0] mesg__h21701, x__h15021, x__h15947, x__h19644;
  ...
  assign mesgRF_wDataIn$wget = { 224'd0, v__h22014 } ;
  ...
  assign x_byteEn__h21793 = (readMeta[23:0] == 24'd0) ? 32'd0 : 32'hFFFFFFFF ;
  always@(wrtSerPos)
  begin
    case (wrtSerPos)
