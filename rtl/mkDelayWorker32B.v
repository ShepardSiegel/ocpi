...
//
// On Thu Jun 17 14:44:39 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker32B(wciS0_Clk,
  ...
  reg [268 : 0] mesgWF_rCache;
  wire [268 : 0] mesgWF_rCache$D_IN;
  ...
  wire [255 : 0] mesg__h22350, x__h15237, x__h16164, x__h19909;
  ...
  assign MUX_mesgLength$write_1__VAL_3 = { 1'd1, mlp1__h17957[8:0], 5'd0 } ;
  ...
  assign mesgWF_wDataOut$wget =
	     (mesgWF_rCache[268] && mesgWF_rCache[267:256] == mesgWF_rRdPtr) ?
	       mesgWF_rCache[255:0] :
	       mesgWF_memory$DOB ;
  ...
  assign mesgRF_wDataIn$wget = { 224'd0, v__h22724 } ;
  ...
  assign x__h16164 = CAN_FIRE_RL_rdSer_body ? mesgRF_wDataIn$wget : 256'd0 ;
  ...
  assign x_byteEn__h22442 = (readMeta[23:0] == 24'd0) ? 32'd0 : 32'hFFFFFFFF ;
