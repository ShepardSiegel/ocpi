...
//
// On Fri Jul 23 11:09:39 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker32B(wciS0_Clk,
  ...
  wire [255 : 0] x__h14794, x__h17421;
  ...
  assign wsiS_wordCount$D_IN =
	     wsiS_wsiReq$wget[309] ? 12'd0 : wsiS_wordCount + 12'd1 ;
  ...
  assign mesgRF$D_IN = { 224'd0, v__h19693 } ;
  ...
  assign x__h14794 =
	     MUX_wsiS_reqFifo_levelsValid$write_1__SEL_3 ?
	       ...
	       256'd0 ;
  assign x__h16572 = { wsiS_wordCount[6:0], 5'd0 } ;
  ...
  assign x_byteEn__h19412 = (readMeta[23:0] == 24'd0) ? 32'd0 : 32'hFFFFFFFF ;
