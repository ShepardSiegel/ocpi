...
//
// On Tue Jul  6 08:21:13 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker32B(wciS0_Clk,
  ...
  wire [255 : 0] x__h15143, x__h18836;
  ...
  assign MUX_mesgLength$write_1__VAL_3 = { 1'd1, mlp1__h17012[8:0], 5'd0 } ;
  ...
  assign mesgRF$D_IN = { 224'd0, v__h21675 } ;
  ...
  assign x_byteEn__h21395 = (readMeta[23:0] == 24'd0) ? 32'd0 : 32'hFFFFFFFF ;
