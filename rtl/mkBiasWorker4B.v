...
//
// On Tue Mar 20 10:53:59 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkBiasWorker4B(wciS0_Clk,
  ...
  reg [63 : 0] v__h10679, v__h10832, v__h3628, v__h3802, v__h3946;
  reg [31 : 0] _theResult____h10816;
  wire [31 : 0] rdat__h10906,
		rdat__h11006,
		rdat__h11020,
		rdat__h11028,
		rdat__h11034,
  ...
  // remaining internal signals
  assign rdat__h10906 = hasDebugLogic ? { 16'd0, x__h10910 } : 32'd0 ;
  assign rdat__h11006 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h11020 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h11028 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h11034 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h11048 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h11056 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign x__h10910 = { wsiS_statusR, wsiM_statusR } ;
  assign x_data__h10151 = wsiS_reqFifo$D_OUT[43:12] + biasValue ;
  always@(wci_wslv_reqF$D_OUT or
	  ...
	  rdat__h11006 or
	  rdat__h11020 or
	  rdat__h11028 or rdat__h11034 or rdat__h11048 or rdat__h11056)
  begin
    case (wci_wslv_reqF$D_OUT[39:32])
      8'h0: _theResult____h10816 = biasValue;
      8'h04: _theResult____h10816 = controlReg;
      8'h20: _theResult____h10816 = rdat__h10906;
      8'h24: _theResult____h10816 = rdat__h11006;
      8'h28: _theResult____h10816 = rdat__h11020;
      8'h2C: _theResult____h10816 = rdat__h11028;
      8'h30: _theResult____h10816 = rdat__h11034;
      8'h34: _theResult____h10816 = rdat__h11048;
      8'h38: _theResult____h10816 = rdat__h11056;
      default: _theResult____h10816 = 32'd0;
    endcase
  end
