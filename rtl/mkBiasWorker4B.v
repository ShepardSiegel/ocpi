...
//
// On Sat Oct 30 16:29:02 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkBiasWorker4B(wciS0_Clk,
  ...
  wire [31 : 0] rdat__h9583,
		...
		x_data__h10275;
  wire [15 : 0] x__h9587;
  wire wsiS_reqFifo_notFull__23_AND_wsiS_burstKind_03_ETC___d243;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, _theResult____h9498 } ;
  ...
  assign wsiS_burstKind$EN =
	     WILL_FIRE_RL_wsiS_reqFifo_enq &&
	     wsiS_reqFifo_notFull__23_AND_wsiS_burstKind_03_ETC___d243 ;
  ...
  assign wsiS_reqFifo_notFull__23_AND_wsiS_burstKind_03_ETC___d243 =
	     wsiS_reqFifo$FULL_N &&
	     (wsiS_burstKind == 2'd0 ||
	      (wsiS_burstKind == 2'd1 || wsiS_burstKind == 2'd2) &&
	      wsiS_wsiReq$wget[57]) ;
  assign x__h9587 = { wsiS_statusR, wsiM_statusR } ;
  assign x_data__h10275 = wsiS_reqFifo$D_OUT[43:12] + biasValue ;
