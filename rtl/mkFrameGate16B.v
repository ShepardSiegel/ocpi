...
//
// On Fri Jun 25 12:09:01 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkFrameGate16B(wciS0_Clk,
		      wciS0_MReset_n,
  ...
  reg [63 : 0] v__h2637, v__h2784, v__h3683, v__h9781;
  reg [31 : 0] x_data__h9913;
  wire [31 : 0] frameGateStatus__h9669,
		rdat__h10047,
		rdat__h10061,
		rdat__h10069,
		rdat__h10075,
		...
		x__h9403;
  wire [15 : 0] x__h9951;
  wire NOT_frameGateCtrl_6_BITS_3_TO_0_23_EQ_0x0_24_2_ETC___d139,
       NOT_gated_28_42_AND_byteCount_43_EQ_frameSize__ETC___d486,
       NOT_wsiS_reqFifo_countReg_38_ULE_1_39___d240;
  ...
  assign CAN_FIRE_RL_wsipass_doMessagePush =
	     wsiS_reqFifo$EMPTY_N &&
	     NOT_frameGateCtrl_6_BITS_3_TO_0_23_EQ_0x0_24_2_ETC___d139 &&
	     wci_cState == 3'd2 ;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, x_data__h9913 } ;
  ...
  // remaining internal signals
  assign NOT_frameGateCtrl_6_BITS_3_TO_0_23_EQ_0x0_24_2_ETC___d139 =
	     frameGateCtrl[3:0] != 4'h0 &&
	     (frameGateCtrl[3:0] != 4'h1 || gated) &&
	     wsiS_reqFifo$D_OUT[163:152] != 12'd1 ||
	     wsiM_reqFifo_c_r != 2'd2 ;
  assign NOT_gated_28_42_AND_byteCount_43_EQ_frameSize__ETC___d486 =
	     !gated && byteCount == frameSize ||
	     gated && byteCount == gateSize ;
  assign NOT_wsiS_reqFifo_countReg_38_ULE_1_39___d240 =
	     wsiS_reqFifo_countReg > 2'd1 ;
  assign frameGateStatus__h9669 = { 31'd0, hasDebugLogic } ;
  assign rdat__h10047 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h10061 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h10069 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h10075 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h10089 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h10097 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h10103 = hasDebugLogic ? op0MesgCnt : 32'd0 ;
  assign rdat__h10114 = hasDebugLogic ? otherMesgCnt : 32'd0 ;
  assign rdat__h9947 = hasDebugLogic ? { 16'd0, x__h9951 } : 32'd0 ;
  assign x__h9403 = byteCount + 32'd16 ;
  assign x__h9951 = { wsiS_statusR, wsiM_statusR } ;
  always@(wci_reqF$D_OUT or
	  frameGateStatus__h9669 or
	  frameGateCtrl or
	  frameSize or
	  gateSize or
	  rdat__h9947 or
	  ...
	  rdat__h10069 or
	  rdat__h10075 or
	  rdat__h10089 or rdat__h10097 or rdat__h10103 or rdat__h10114)
  begin
    case (wci_reqF$D_OUT[51:32])
      20'h0: x_data__h9913 = frameGateStatus__h9669;
      20'h00004: x_data__h9913 = frameGateCtrl;
      20'h00008: x_data__h9913 = frameSize;
      20'h0000C: x_data__h9913 = gateSize;
      20'h00010: x_data__h9913 = rdat__h9947;
      20'h00014: x_data__h9913 = rdat__h10047;
      20'h00018: x_data__h9913 = rdat__h10061;
      20'h0001C: x_data__h9913 = rdat__h10069;
      20'h00020: x_data__h9913 = rdat__h10075;
      20'h00024: x_data__h9913 = rdat__h10089;
      20'h00028: x_data__h9913 = rdat__h10097;
      20'h0002C: x_data__h9913 = rdat__h10103;
      20'h00030: x_data__h9913 = rdat__h10114;
      default: x_data__h9913 = 32'd0;
    endcase
  end
  ...
  begin
    if (!wciS0_MReset_n)
      begin
        byteCount <= `BSV_ASSIGNMENT_DELAY 32'd0;
