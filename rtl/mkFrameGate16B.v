...
//
// On Fri Jun 25 13:29:29 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkFrameGate16B(wciS0_Clk,
  ...
  reg [63 : 0] v__h2638, v__h2785, v__h3684, v__h9785;
  reg [31 : 0] x_data__h9917;
  wire [31 : 0] frameGateStatus__h9673,
		rdat__h10051,
		rdat__h10065,
		rdat__h10073,
		rdat__h10079,
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, x_data__h9917 } ;
  ...
  assign NOT_wsiS_reqFifo_countReg_38_ULE_1_39___d240 =
	     wsiS_reqFifo_countReg > 2'd1 ;
  assign frameGateStatus__h9673 = { 31'd0, hasDebugLogic } ;
  assign rdat__h10051 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h10065 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h10073 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h10079 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h10093 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h10101 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h10107 = hasDebugLogic ? op0MesgCnt : 32'd0 ;
  assign rdat__h10118 = hasDebugLogic ? otherMesgCnt : 32'd0 ;
  assign rdat__h9951 = hasDebugLogic ? { 16'd0, x__h9955 } : 32'd0 ;
  assign x__h9419 = byteCount + 32'd16 ;
  assign x__h9955 = { wsiS_statusR, wsiM_statusR } ;
  always@(wci_reqF$D_OUT or
	  frameGateStatus__h9673 or
	  frameGateCtrl or
	  frameSize or
	  gateSize or
	  rdat__h9951 or
	  ...
	  rdat__h10073 or
	  rdat__h10079 or
	  rdat__h10093 or rdat__h10101 or rdat__h10107 or rdat__h10118)
  begin
    case (wci_reqF$D_OUT[51:32])
      20'h0: x_data__h9917 = frameGateStatus__h9673;
      20'h00004: x_data__h9917 = frameGateCtrl;
      20'h00008: x_data__h9917 = frameSize;
      20'h0000C: x_data__h9917 = gateSize;
      20'h00010: x_data__h9917 = rdat__h9951;
      20'h00014: x_data__h9917 = rdat__h10051;
      20'h00018: x_data__h9917 = rdat__h10065;
      20'h0001C: x_data__h9917 = rdat__h10073;
      20'h00020: x_data__h9917 = rdat__h10079;
      20'h00024: x_data__h9917 = rdat__h10093;
      20'h00028: x_data__h9917 = rdat__h10101;
      20'h0002C: x_data__h9917 = rdat__h10107;
      20'h00030: x_data__h9917 = rdat__h10118;
      default: x_data__h9917 = 32'd0;
    endcase
  end
