...
//
// On Thu Jan 19 16:32:14 EST 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkFrameGate16B(wciS0_Clk,
  ...
  wire [31 : 0] frameGateStatus__h10276,
		...
		x__h10054;
  wire [15 : 0] x__h10690;
  wire NOT_gated_99_05_AND_byteCount_06_EQ_frameSize__ETC___d495,
  ...
  assign byteCount$D_IN =
	     NOT_gated_99_05_AND_byteCount_06_EQ_frameSize__ETC___d495 ?
	       32'd16 :
	       x__h10054 ;
  ...
  // remaining internal signals
  assign NOT_gated_99_05_AND_byteCount_06_EQ_frameSize__ETC___d495 =
  ...
  assign wsiS_reqFifo_i_notEmpty__92_AND_NOT_frameGateC_ETC___d303 =
	     ...
	     (frameGateCtrl[3:0] != 4'h0 &&
	      (frameGateCtrl[3:0] != 4'h1 || gated) ||
	      wsiM_reqFifo_c_r != 2'd2) ;
  assign x__h10054 = byteCount + 32'd16 ;
