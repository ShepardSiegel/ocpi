...
//
// On Fri Jun 25 14:32:37 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkFrameGate16B(wciS0_Clk,
  ...
  reg [63 : 0] v__h2638, v__h2785, v__h3684, v__h9782;
  reg [31 : 0] x_data__h9914;
  wire [31 : 0] frameGateStatus__h9670,
		rdat__h10048,
		rdat__h10062,
		rdat__h10070,
		rdat__h10076,
		...
		x__h9419;
  wire [15 : 0] x__h9952;
  wire NOT_gated_28_37_AND_byteCount_38_EQ_frameSize__ETC___d432,
       NOT_wsiS_reqFifo_countReg_33_ULE_1_34___d235,
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, x_data__h9914 } ;
  ...
  assign byteCount$D_IN =
	     NOT_gated_28_37_AND_byteCount_38_EQ_frameSize__ETC___d432 ?
	       32'd16 :
	       x__h9419 ;
  ...
  // remaining internal signals
  assign NOT_gated_28_37_AND_byteCount_38_EQ_frameSize__ETC___d432 =
	     !gated && byteCount == frameSize ||
	     gated && byteCount == gateSize ;
  assign NOT_wsiS_reqFifo_countReg_33_ULE_1_34___d235 =
	     wsiS_reqFifo_countReg > 2'd1 ;
  assign frameGateStatus__h9670 = { 31'd0, hasDebugLogic } ;
  assign rdat__h10048 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h10062 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h10070 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h10076 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h10090 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h10098 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h10104 = hasDebugLogic ? op0MesgCnt : 32'd0 ;
  assign rdat__h10115 = hasDebugLogic ? otherMesgCnt : 32'd0 ;
  assign rdat__h9948 = hasDebugLogic ? { 16'd0, x__h9952 } : 32'd0 ;
  ...
  assign x__h9952 = { wsiS_statusR, wsiM_statusR } ;
  always@(wci_reqF$D_OUT or
	  frameGateStatus__h9670 or
	  frameGateCtrl or
	  frameSize or
	  gateSize or
	  rdat__h9948 or
	  ...
	  rdat__h10070 or
	  rdat__h10076 or
	  rdat__h10090 or rdat__h10098 or rdat__h10104 or rdat__h10115)
  begin
    case (wci_reqF$D_OUT[51:32])
      20'h0: x_data__h9914 = frameGateStatus__h9670;
      20'h00004: x_data__h9914 = frameGateCtrl;
      20'h00008: x_data__h9914 = frameSize;
      20'h0000C: x_data__h9914 = gateSize;
      20'h00010: x_data__h9914 = rdat__h9948;
      20'h00014: x_data__h9914 = rdat__h10048;
      20'h00018: x_data__h9914 = rdat__h10062;
      20'h0001C: x_data__h9914 = rdat__h10070;
      20'h00020: x_data__h9914 = rdat__h10076;
      20'h00024: x_data__h9914 = rdat__h10090;
      20'h00028: x_data__h9914 = rdat__h10098;
      20'h0002C: x_data__h9914 = rdat__h10104;
      20'h00030: x_data__h9914 = rdat__h10115;
      default: x_data__h9914 = 32'd0;
    endcase
  end
