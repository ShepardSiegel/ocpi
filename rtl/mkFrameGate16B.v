...
//
// On Mon Jun 21 17:13:18 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkFrameGate16B(wciS0_Clk,
  ...
  wire [31 : 0] rdat__h9947, x__h9403;
  wire [15 : 0] x__h9950;
  wire NOT_frameGateCtrl_6_BITS_3_TO_0_13_EQ_0x0_14_1_ETC___d129,
       NOT_gated_18_32_AND_byteCount_33_EQ_frameSize__ETC___d476,
       NOT_wsiS_reqFifo_countReg_28_ULE_1_29___d230;
  ...
  assign CAN_FIRE_RL_wsipass_doMessagePush =
	     wsiS_reqFifo$EMPTY_N &&
	     NOT_frameGateCtrl_6_BITS_3_TO_0_13_EQ_0x0_14_1_ETC___d129 &&
	     wci_cState == 3'd2 ;
  ...
  // remaining internal signals
  assign NOT_frameGateCtrl_6_BITS_3_TO_0_13_EQ_0x0_14_1_ETC___d129 =
	     frameGateCtrl[3:0] != 4'h0 &&
	     (frameGateCtrl[3:0] != 4'h1 || gated) &&
	     wsiS_reqFifo$D_OUT[163:152] != 12'd1 ||
	     wsiM_reqFifo_c_r != 2'd2 ;
  assign NOT_gated_18_32_AND_byteCount_33_EQ_frameSize__ETC___d476 =
	     !gated && byteCount == frameSize ||
	     gated && byteCount == gateSize ;
  assign NOT_wsiS_reqFifo_countReg_28_ULE_1_29___d230 =
	     wsiS_reqFifo_countReg > 2'd1 ;
  assign rdat__h9947 = { 16'd0, x__h9950 } ;
  assign x__h9403 = byteCount + 32'd16 ;
  assign x__h9950 = { wsiS_statusR, wsiM_statusR } ;
  always@(wci_reqF$D_OUT or
	  ...
	  wsiM_extStatusW$wget or op0MesgCnt or otherMesgCnt)
  begin
    case (wci_reqF$D_OUT[51:32])
      20'h0: x_data__h9913 = 32'd1;
      ...
      20'h00014: x_data__h9913 = wsiS_extStatusW$wget[95:64];
      20'h00018: x_data__h9913 = wsiS_extStatusW$wget[63:32];
      20'h0001C: x_data__h9913 = wsiS_extStatusW$wget[31:0];
      20'h00020: x_data__h9913 = wsiM_extStatusW$wget[95:64];
      20'h00024: x_data__h9913 = wsiM_extStatusW$wget[63:32];
      20'h00028: x_data__h9913 = wsiM_extStatusW$wget[31:0];
      20'h0002C: x_data__h9913 = op0MesgCnt;
      20'h00030: x_data__h9913 = otherMesgCnt;
