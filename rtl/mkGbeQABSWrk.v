...
//
// On Sun Sep  2 12:24:00 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkGbeQABSWrk(CLK_gmii_rx_clk,
		    CLK_gmiixo_clk,
		    RST_N_gmiixo_rst,
		    wciS0_Clk,
		    wciS0_MReset_n,
  ...
  // submodule eReqF
  FIFO2 #(.width(32'd40), .guarded(32'd1)) eReqF(.RST_N(wciS0_MReset_n),
						 .CLK(wciS0_Clk),
						 .D_IN(eReqF$D_IN),
						 .ENQ(eReqF$ENQ),
						 .DEQ(eReqF$DEQ),
  ...
  // submodule eRespF
  FIFO2 #(.width(32'd40), .guarded(32'd1)) eRespF(.RST_N(wciS0_MReset_n),
						  .CLK(wciS0_Clk),
						  .D_IN(eRespF$D_IN),
						  .ENQ(eRespF$ENQ),
						  .DEQ(eRespF$DEQ),
