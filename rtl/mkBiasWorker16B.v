...
//
// On Sat Oct 30 16:29:04 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkBiasWorker16B(wciS0_Clk,
		       wciS0_MReset_n,
  ...
  reg [63 : 0] v__h10002, v__h2657, v__h2815, v__h3714, v__h9514;
  reg [31 : 0] _theResult____h9498;
  wire [127 : 0] x_data__h10275;
  wire [31 : 0] rdat__h9583,
		rdat__h9683,
		rdat__h9697,
		rdat__h9705,
		rdat__h9711,
		...
		rdat__h9733;
  wire [15 : 0] x__h9587;
  wire wsiS_reqFifo_notFull__24_AND_wsiS_burstKind_04_ETC___d244;
  ...
  assign MUX_wsiM_reqFifo_q_0$write_1__VAL_2 =
	     { wsiS_reqFifo$D_OUT[168:152],
	       x_data__h10275,
	       wsiS_reqFifo$D_OUT[23:0] } ;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_1 = { 2'd1, _theResult____h9498 } ;
  ...
  assign wsiS_burstKind$EN =
	     WILL_FIRE_RL_wsiS_reqFifo_enq &&
	     wsiS_reqFifo_notFull__24_AND_wsiS_burstKind_04_ETC___d244 ;
  ...
  // remaining internal signals
  assign rdat__h9583 = hasDebugLogic ? { 16'd0, x__h9587 } : 32'd0 ;
  assign rdat__h9683 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h9697 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h9705 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h9711 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h9725 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h9733 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign wsiS_reqFifo_notFull__24_AND_wsiS_burstKind_04_ETC___d244 =
	     wsiS_reqFifo$FULL_N &&
	     (wsiS_burstKind == 2'd0 ||
	      (wsiS_burstKind == 2'd1 || wsiS_burstKind == 2'd2) &&
	      wsiS_wsiReq$wget[165]) ;
  assign x__h9587 = { wsiS_statusR, wsiM_statusR } ;
  assign x_data__h10275 = wsiS_reqFifo$D_OUT[151:24] + { 96'd0, biasValue } ;
  always@(wci_reqF$D_OUT or
	  ...
	  rdat__h9683 or
	  rdat__h9697 or
	  rdat__h9705 or rdat__h9711 or rdat__h9725 or rdat__h9733)
  begin
    case (wci_reqF$D_OUT[39:32])
      8'h0: _theResult____h9498 = biasValue;
      8'h04: _theResult____h9498 = controlReg;
      8'h20: _theResult____h9498 = rdat__h9583;
      8'h24: _theResult____h9498 = rdat__h9683;
      8'h28: _theResult____h9498 = rdat__h9697;
      8'h2C: _theResult____h9498 = rdat__h9705;
      8'h30: _theResult____h9498 = rdat__h9711;
      8'h34: _theResult____h9498 = rdat__h9725;
      8'h38: _theResult____h9498 = rdat__h9733;
      default: _theResult____h9498 = 32'd0;
    endcase
  end
