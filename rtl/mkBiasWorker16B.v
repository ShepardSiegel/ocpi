...
//
// On Thu Dec 16 04:42:19 EST 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkBiasWorker16B(wciS0_Clk,
  ...
  reg [63 : 0] v__h3560, v__h3745, v__h3900, v__h9772, v__h9933;
  reg [31 : 0] _theResult____h9917;
  wire [127 : 0] x_data__h9506;
  wire [31 : 0] rdat__h10007,
		rdat__h10107,
		rdat__h10121,
		rdat__h10129,
		rdat__h10135,
		...
		rdat__h10157;
  wire [15 : 0] x__h10011;
  wire wsiS_reqFifo_notFull__69_AND_wsiS_burstKind_84_ETC___d191;
  ...
  assign CAN_FIRE_RL_wci_ctrl_EiI = MUX_biasValue$write_1__SEL_2 ;
  assign WILL_FIRE_RL_wci_ctrl_EiI = MUX_biasValue$write_1__SEL_2 ;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, _theResult____h9917 } ;
  ...
  // remaining internal signals
  assign rdat__h10007 = hasDebugLogic ? { 16'd0, x__h10011 } : 32'd0 ;
  assign rdat__h10107 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h10121 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h10129 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h10135 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h10149 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h10157 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign wsiS_reqFifo_notFull__69_AND_wsiS_burstKind_84_ETC___d191 =
	     wsiS_reqFifo$FULL_N &&
	     (wsiS_burstKind == 2'd0 ||
	      (wsiS_burstKind == 2'd1 || wsiS_burstKind == 2'd2) &&
	      wsiS_wsiReq$wget[165]) ;
  assign x__h10011 = { wsiS_statusR, wsiM_statusR } ;
  assign x_data__h9506 = wsiS_reqFifo$D_OUT[151:24] + { 96'd0, biasValue } ;
  always@(wci_reqF$D_OUT or
	  ...
	  rdat__h10107 or
	  rdat__h10121 or
	  rdat__h10129 or rdat__h10135 or rdat__h10149 or rdat__h10157)
  begin
    case (wci_reqF$D_OUT[39:32])
      8'h0: _theResult____h9917 = biasValue;
      8'h04: _theResult____h9917 = controlReg;
      8'h20: _theResult____h9917 = rdat__h10007;
      8'h24: _theResult____h9917 = rdat__h10107;
      8'h28: _theResult____h9917 = rdat__h10121;
      8'h2C: _theResult____h9917 = rdat__h10129;
      8'h30: _theResult____h9917 = rdat__h10135;
      8'h34: _theResult____h9917 = rdat__h10149;
      8'h38: _theResult____h9917 = rdat__h10157;
      default: _theResult____h9917 = 32'd0;
    endcase
  end
