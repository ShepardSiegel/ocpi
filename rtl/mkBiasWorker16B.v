...
//
// On Wed Jan  5 11:04:51 EST 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkBiasWorker16B(wciS0_Clk,
  ...
  reg [63 : 0] v__h3560, v__h3734, v__h3878, v__h9750, v__h9903;
  reg [31 : 0] _theResult____h9887;
  wire [127 : 0] x_data__h9484;
  wire [31 : 0] rdat__h10077,
		rdat__h10091,
		rdat__h10099,
		rdat__h10105,
		rdat__h10119,
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, _theResult____h9887 } ;
  ...
  // remaining internal signals
  assign rdat__h10077 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h10091 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h10099 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h10105 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h10119 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h10127 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h9977 = hasDebugLogic ? { 16'd0, x__h9981 } : 32'd0 ;
  assign wsiS_reqFifo_notFull__69_AND_wsiS_burstKind_84_ETC___d191 =
	     wsiS_reqFifo$FULL_N &&
	     (wsiS_burstKind == 2'd0 ||
	      (wsiS_burstKind == 2'd1 || wsiS_burstKind == 2'd2) &&
	      wsiS_wsiReq$wget[165]) ;
  assign x__h9981 = { wsiS_statusR, wsiM_statusR } ;
  assign x_data__h9484 = wsiS_reqFifo$D_OUT[151:24] + { 96'd0, biasValue } ;
  always@(wci_reqF$D_OUT or
	  ...
	  rdat__h10077 or
	  rdat__h10091 or
	  rdat__h10099 or rdat__h10105 or rdat__h10119 or rdat__h10127)
  begin
    case (wci_reqF$D_OUT[39:32])
      8'h0: _theResult____h9887 = biasValue;
      8'h04: _theResult____h9887 = controlReg;
      8'h20: _theResult____h9887 = rdat__h9977;
      8'h24: _theResult____h9887 = rdat__h10077;
      8'h28: _theResult____h9887 = rdat__h10091;
      8'h2C: _theResult____h9887 = rdat__h10099;
      8'h30: _theResult____h9887 = rdat__h10105;
      8'h34: _theResult____h9887 = rdat__h10119;
      8'h38: _theResult____h9887 = rdat__h10127;
      default: _theResult____h9887 = 32'd0;
    endcase
  end
