...
//
// On Sun Sep 15 08:30:35 EDT 2013
//
//
// Ports:
// Name                         I/O  size props
...
module mkBiasWorker16B(wciS0_Clk,
  ...
  assign rdat__h11559 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h11573 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h11581 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h11587 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h11601 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h11609 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign wci_wslv_respF_cntr_r_8_MINUS_1___d27 =
	     wci_wslv_respF_cntr_r - 2'd1 ;
  assign x__h11463 = { wsiS_statusR, wsiM_statusR } ;
  assign x_data__h10099 =
	     { wsiS_reqFifo$D_OUT[151:120] + biasValue,
	       wsiS_reqFifo$D_OUT[119:88] + biasValue,
	       wsiS_reqFifo$D_OUT[87:56] + biasValue,
	       wsiS_reqFifo$D_OUT[55:24] + biasValue } ;
