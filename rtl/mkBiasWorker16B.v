...
//
// On Fri Jun 24 16:35:34 EDT 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkBiasWorker16B(wciS0_Clk,
  ...
  assign x_data__h10141 = wsiS_reqFifo$D_OUT[151:24] + { 96'd0, biasValue } ;
  ...
  begin
	...
	$display("[%0d]: %m: WCI ControlOp: Starting-transition edge:%x from:%x",
		 ...
		 wci_wslv_cState);
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wci_ctrl_IsO && MUX_biasValue$write_1__SEL_2)
	...
	$display("Error: \"bsv/wrk/BiasWorker.bsv\", line 85, column 8: (R0001)\n  Mutually exclusive rules RL_wci_ctrl_OrE and RL_wci_ctrl_IsO fired in the\n  same clock cycle.\n");
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wci_ctrl_OrE && MUX_biasValue$write_1__SEL_2)
