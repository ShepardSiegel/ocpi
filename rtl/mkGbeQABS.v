...
//
// On Mon Sep 10 07:00:04 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkGbeQABS(CLK_gmii_rx_clk,
  ...
  reg [1 : 0] CASE_client_response_put_BITS_19_TO_18_3_0_cli_ETC__q15,
	      ...
	      CASE_eReqFD_OUT_BITS_19_TO_18_3_0_eReqFD_OUT_ETC__q7,
	      CASE_eReqFD_OUT_BITS_29_TO_28_3_0_eReqFD_OUT_ETC__q6,
	      CASE_eReqFD_OUT_BITS_39_TO_38_3_0_eReqFD_OUT_ETC__q5,
	      CASE_eReqFD_OUT_BITS_9_TO_8_3_0_eReqFD_OUT_B_ETC__q8,
	      CASE_eRespFD_OUT_BITS_19_TO_18_3_0_eRespFD_O_ETC__q3,
	      CASE_eRespFD_OUT_BITS_29_TO_28_3_0_eRespFD_O_ETC__q2,
	      CASE_eRespFD_OUT_BITS_39_TO_38_3_0_eRespFD_O_ETC__q1,
	      CASE_eRespFD_OUT_BITS_9_TO_8_3_0_eRespFD_OUT_ETC__q4,
  ...
  assign rxCount$EN = gmac$RDY_rx_get && eReqF$FULL_N ;
  ...
  assign txCount$EN = gmac$RDY_tx_put && eRespF$EMPTY_N ;
  ...
  assign eReqF$D_IN =
	     { CASE_gmacrx_get_BITS_39_TO_38_3_0_gmacrx_get_ETC__q9,
	       ...
	       CASE_gmacrx_get_BITS_9_TO_8_3_0_gmacrx_get_B_ETC__q12,
	       gmac$rx_get[7:0] } ;
  assign eReqF$ENQ = gmac$RDY_rx_get && eReqF$FULL_N ;
  ...
  assign eRespF$DEQ = gmac$RDY_tx_put && eRespF$EMPTY_N ;
  ...
  begin
    case (eRespF$D_OUT[39:38])
	  ...
	  CASE_eRespFD_OUT_BITS_39_TO_38_3_0_eRespFD_O_ETC__q1 =
	      eRespF$D_OUT[39:38];
      2'd3: CASE_eRespFD_OUT_BITS_39_TO_38_3_0_eRespFD_O_ETC__q1 = 2'd3;
    endcase
  end
  always@(eRespF$D_OUT)
  begin
    case (eRespF$D_OUT[29:28])
	  ...
	  CASE_eRespFD_OUT_BITS_29_TO_28_3_0_eRespFD_O_ETC__q2 =
	      eRespF$D_OUT[29:28];
      2'd3: CASE_eRespFD_OUT_BITS_29_TO_28_3_0_eRespFD_O_ETC__q2 = 2'd3;
    endcase
  end
  always@(eRespF$D_OUT)
  begin
    case (eRespF$D_OUT[19:18])
	  ...
	  CASE_eRespFD_OUT_BITS_19_TO_18_3_0_eRespFD_O_ETC__q3 =
	      eRespF$D_OUT[19:18];
      2'd3: CASE_eRespFD_OUT_BITS_19_TO_18_3_0_eRespFD_O_ETC__q3 = 2'd3;
    endcase
  end
  always@(eRespF$D_OUT)
  begin
    case (eRespF$D_OUT[9:8])
	  ...
	  CASE_eRespFD_OUT_BITS_9_TO_8_3_0_eRespFD_OUT_ETC__q4 =
	      eRespF$D_OUT[9:8];
      2'd3: CASE_eRespFD_OUT_BITS_9_TO_8_3_0_eRespFD_OUT_ETC__q4 = 2'd3;
    endcase
  end
  always@(eReqF$D_OUT)
  begin
    case (eReqF$D_OUT[39:38])
	  ...
	  CASE_eReqFD_OUT_BITS_39_TO_38_3_0_eReqFD_OUT_ETC__q5 =
	      eReqF$D_OUT[39:38];
      2'd3: CASE_eReqFD_OUT_BITS_39_TO_38_3_0_eReqFD_OUT_ETC__q5 = 2'd3;
    endcase
  end
  always@(eReqF$D_OUT)
  begin
    case (eReqF$D_OUT[29:28])
	  ...
	  CASE_eReqFD_OUT_BITS_29_TO_28_3_0_eReqFD_OUT_ETC__q6 =
	      eReqF$D_OUT[29:28];
      2'd3: CASE_eReqFD_OUT_BITS_29_TO_28_3_0_eReqFD_OUT_ETC__q6 = 2'd3;
    endcase
  end
  always@(eReqF$D_OUT)
  begin
    case (eReqF$D_OUT[19:18])
	  ...
	  CASE_eReqFD_OUT_BITS_19_TO_18_3_0_eReqFD_OUT_ETC__q7 =
	      eReqF$D_OUT[19:18];
      2'd3: CASE_eReqFD_OUT_BITS_19_TO_18_3_0_eReqFD_OUT_ETC__q7 = 2'd3;
    endcase
  end
  always@(eReqF$D_OUT)
  begin
    case (eReqF$D_OUT[9:8])
	  ...
	  CASE_eReqFD_OUT_BITS_9_TO_8_3_0_eReqFD_OUT_B_ETC__q8 =
	      eReqF$D_OUT[9:8];
      2'd3: CASE_eReqFD_OUT_BITS_9_TO_8_3_0_eReqFD_OUT_B_ETC__q8 = 2'd3;
    endcase
  end
  always@(gmac$rx_get)
  begin
