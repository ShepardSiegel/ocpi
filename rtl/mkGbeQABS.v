...
//
// On Tue Sep 11 06:08:53 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkGbeQABS(CLK_gmii_rx_clk,
  ...
  reg [1 : 0] CASE_client_response_put_BITS_19_TO_18_3_0_cli_ETC__q11,
	      ...
	      CASE_gmacrx_get_BITS_19_TO_18_3_0_gmacrx_get_ETC__q7,
	      CASE_gmacrx_get_BITS_29_TO_28_3_0_gmacrx_get_ETC__q6,
	      CASE_gmacrx_get_BITS_39_TO_38_3_0_gmacrx_get_ETC__q5,
	      CASE_gmacrx_get_BITS_9_TO_8_3_0_gmacrx_get_B_ETC__q8;
  ...
  begin
    case (gmac$rx_get[39:38])
	  ...
	  CASE_gmacrx_get_BITS_39_TO_38_3_0_gmacrx_get_ETC__q5 =
	      gmac$rx_get[39:38];
      2'd3: CASE_gmacrx_get_BITS_39_TO_38_3_0_gmacrx_get_ETC__q5 = 2'd3;
    endcase
  end
  always@(gmac$rx_get)
  begin
    case (gmac$rx_get[29:28])
	  ...
	  CASE_gmacrx_get_BITS_29_TO_28_3_0_gmacrx_get_ETC__q6 =
	      gmac$rx_get[29:28];
      2'd3: CASE_gmacrx_get_BITS_29_TO_28_3_0_gmacrx_get_ETC__q6 = 2'd3;
    endcase
  end
  always@(gmac$rx_get)
  begin
    case (gmac$rx_get[19:18])
	  ...
	  CASE_gmacrx_get_BITS_19_TO_18_3_0_gmacrx_get_ETC__q7 =
	      gmac$rx_get[19:18];
      2'd3: CASE_gmacrx_get_BITS_19_TO_18_3_0_gmacrx_get_ETC__q7 = 2'd3;
    endcase
  end
  always@(gmac$rx_get)
  begin
    case (gmac$rx_get[9:8])
	  ...
	  CASE_gmacrx_get_BITS_9_TO_8_3_0_gmacrx_get_B_ETC__q8 =
	      gmac$rx_get[9:8];
      2'd3: CASE_gmacrx_get_BITS_9_TO_8_3_0_gmacrx_get_B_ETC__q8 = 2'd3;
    endcase
  end
