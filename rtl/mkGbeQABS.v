...
//
// On Wed Sep  5 16:25:52 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkGbeQABS(CLK_gmii_rx_clk,
  ...
  wire MUX_mdi_rState$write_1__PSEL_1,
  ...
  reg [1 : 0] CASE_client_response_put_BITS_19_TO_18_3_0_cli_ETC__q7,
	      ...
	      CASE_eRespFD_OUT_BITS_19_TO_18_3_0_eRespFD_O_ETC__q15,
	      CASE_eRespFD_OUT_BITS_29_TO_28_3_0_eRespFD_O_ETC__q14,
	      CASE_eRespFD_OUT_BITS_39_TO_38_3_0_eRespFD_O_ETC__q13,
	      CASE_eRespFD_OUT_BITS_9_TO_8_3_0_eRespFD_OUT_ETC__q16,
  ...
  assign mdi_rMDC$EN = MUX_mdi_rState$write_1__PSEL_1 ;

  // register mdi_rMDD
  assign mdi_rMDD$D_IN = bs__h2365[mdi_rPlayIndex$Q_OUT] ;
  assign mdi_rMDD$EN = MUX_mdi_rState$write_1__PSEL_1 ;

  // register mdi_rOutEn
  assign mdi_rOutEn$D_IN = bs__h14890[mdi_rPlayIndex$Q_OUT] ;
  assign mdi_rOutEn$EN = MUX_mdi_rState$write_1__PSEL_1 ;
  ...
  assign mdi_rPlayIndex$ADDB = MUX_mdi_rState$write_1__PSEL_1 ;
  ...
  begin
    case (eRespF$D_OUT[39:38])
	  ...
	  CASE_eRespFD_OUT_BITS_39_TO_38_3_0_eRespFD_O_ETC__q13 =
	      eRespF$D_OUT[39:38];
      2'd3: CASE_eRespFD_OUT_BITS_39_TO_38_3_0_eRespFD_O_ETC__q13 = 2'd3;
    endcase
  end
  always@(eRespF$D_OUT)
  begin
    case (eRespF$D_OUT[29:28])
	  ...
	  CASE_eRespFD_OUT_BITS_29_TO_28_3_0_eRespFD_O_ETC__q14 =
	      eRespF$D_OUT[29:28];
      2'd3: CASE_eRespFD_OUT_BITS_29_TO_28_3_0_eRespFD_O_ETC__q14 = 2'd3;
    endcase
  end
  always@(eRespF$D_OUT)
  begin
    case (eRespF$D_OUT[19:18])
	  ...
	  CASE_eRespFD_OUT_BITS_19_TO_18_3_0_eRespFD_O_ETC__q15 =
	      eRespF$D_OUT[19:18];
      2'd3: CASE_eRespFD_OUT_BITS_19_TO_18_3_0_eRespFD_O_ETC__q15 = 2'd3;
    endcase
  end
  always@(eRespF$D_OUT)
  begin
    case (eRespF$D_OUT[9:8])
	  ...
	  CASE_eRespFD_OUT_BITS_9_TO_8_3_0_eRespFD_OUT_ETC__q16 =
	      eRespF$D_OUT[9:8];
      2'd3: CASE_eRespFD_OUT_BITS_9_TO_8_3_0_eRespFD_OUT_ETC__q16 = 2'd3;
    endcase
  end
