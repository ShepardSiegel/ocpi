...
//
// On Thu Nov  3 16:01:36 EDT 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkOCInf8B(pciDevice,
  ...
  wire [63 : 0] cpNow, wmiDP0_SData, wmiDP1_SData;
  ...
  wire [63 : 0] dp0$wmiS0_MData, dp0$wmiS0_SData;
  ...
  wire [7 : 0] dp0$wmiS0_MDataByteEn;
  ...
  wire [63 : 0] dp1$wmiS0_MData, dp1$wmiS0_SData;
  ...
  wire [7 : 0] dp1$wmiS0_MDataByteEn;
  ...
  reg [63 : 0] v__h1802;
  wire [15 : 0] pciDevice_BITS_15_TO_3_9_CONCAT_0___d97,
		pciDevice_BITS_15_TO_3_9_CONCAT_1___d98;
  ...
  // submodule dp0
  mkOCDP8B #(.hasPush(1'd0),
	     .hasPull(1'd1),
	     .hasDebugLogic(1'd1)) dp0(.pciDevice(pciDevice_BITS_15_TO_3_9_CONCAT_0___d97),
				       .CLK(CLK),
  ...
  // submodule dp1
  mkOCDP8B #(.hasPush(1'd1),
	     .hasPull(1'd0),
	     .hasDebugLogic(1'd1)) dp1(.pciDevice(pciDevice_BITS_15_TO_3_9_CONCAT_1___d98),
				       .CLK(CLK),
  ...
  // remaining internal signals
  assign pciDevice_BITS_15_TO_3_9_CONCAT_0___d97 = { pciDevice[15:3], 3'd0 } ;
  assign pciDevice_BITS_15_TO_3_9_CONCAT_1___d98 = { pciDevice[15:3], 3'd1 } ;
