...
//
// On Wed May 11 10:58:57 EDT 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkFTop_alst4(sys0_clk,
  ...
  wire swParity__h135, z__h726, z__h733, z__h740, z__h747, z__h754, z__h761;
  ...
  // inlined wires
  assign pciw_pwAvaTx$whas = 1'b0 ;
  assign pciw_pwAvaRx$whas = 1'b0 ;
  ...
  // remaining internal signals
  assign swParity__h135 = z__h761 ^ swReg[7] ;
  assign z__h726 = swReg[0] ^ swReg[1] ;
  assign z__h733 = z__h726 ^ swReg[2] ;
  assign z__h740 = z__h733 ^ swReg[3] ;
  assign z__h747 = z__h740 ^ swReg[4] ;
  assign z__h754 = z__h747 ^ swReg[5] ;
  assign z__h761 = z__h754 ^ swReg[6] ;
