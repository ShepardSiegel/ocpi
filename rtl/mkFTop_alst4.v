...
//
// On Fri May 27 10:25:25 EDT 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkFTop_alst4(sys0_clk,
  ...
  wire [31 : 0] pciw_pci0_pcie_ep$tl_cfg_ctl;
  ...
  wire [152 : 0] pciw_pci0_rxOutF$D_IN;
  ...
  wire [127 : 0] data__h1218, data__h1778, y_avValue_snd__h1614;
  wire [15 : 0] be__h1217;
  ...
  assign pciw_pci0_pcie_ep$rx_st_ready0 = pciw_pci0_pwAvaRx$whas ;
  ...
  assign pciw_pci0_rxOutF$ENQ =
	     ...
	     (!pciw_pci0_pcie_ep$rx_st_sop0 ||
	      pciw_pci0_pcie_ep$rx_st_data0[34]) ||
	     WILL_FIRE_RL_pciw_pci0_rx_destage ;
  assign pciw_pci0_rxOutF$DEQ = 1'b0 ;
  ...
  // submodule pciw_pci0_txInF
  assign pciw_pci0_txInF$D_IN = 153'h0 ;
  assign pciw_pci0_txInF$ENQ = 1'b0 ;
  ...
  assign swParity__h6102 = z__h7026 ^ swReg[7] ;
  assign y_avValue_snd__h1614 =
	     { 16'h0,
	       pciw_pci0_txInF$D_OUT[15:0],
	       pciw_pci0_txInF$D_OUT[63:32],
	       pciw_pci0_txInF$D_OUT[95:64],
	       pciw_pci0_txInF$D_OUT[127:96] } ;
  assign z__h6991 = swReg[0] ^ swReg[1] ;
  assign z__h6998 = z__h6991 ^ swReg[2] ;
  assign z__h7005 = z__h6998 ^ swReg[3] ;
  assign z__h7012 = z__h7005 ^ swReg[4] ;
  assign z__h7019 = z__h7012 ^ swReg[5] ;
  assign z__h7026 = z__h7019 ^ swReg[6] ;
