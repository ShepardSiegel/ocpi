...
//
// On Fri Aug 13 08:41:11 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkOCApp(RST_N_rst_0,
  ...
  assign appW2$wsiM1_SReset_n = appW3$wsiS0_SReset_n ;
  assign appW2$wsiM1_SThreadBusy = appW3$wsiS0_SThreadBusy ;
  ...
  assign appW3$wsiS0_MBurstLength = appW2$wsiM1_MBurstLength ;
  assign appW3$wsiS0_MByteEn = appW2$wsiM1_MByteEn ;
  assign appW3$wsiS0_MCmd = appW2$wsiM1_MCmd ;
  assign appW3$wsiS0_MData = appW2$wsiM1_MData ;
  assign appW3$wsiS0_MReqInfo = appW2$wsiM1_MReqInfo ;
  assign appW3$wsiM0_SThreadBusy = appW4$wsiS1_SThreadBusy ;
  assign appW3$wsiM0_SReset_n = appW4$wsiS1_SReset_n ;
  assign appW3$wsiS0_MBurstPrecise = appW2$wsiM1_MBurstPrecise ;
  assign appW3$wsiS0_MReqLast = appW2$wsiM1_MReqLast ;
  assign appW3$wsiS0_MReset_n = appW2$wsiM1_MReset_n ;
  ...
  assign appW4$wsiS1_MBurstLength = appW3$wsiM0_MBurstLength ;
  assign appW4$wsiS1_MByteEn = appW3$wsiM0_MByteEn ;
  assign appW4$wsiS1_MData = appW3$wsiM0_MData ;
  assign appW4$wsiS1_MCmd = appW3$wsiM0_MCmd ;
  assign appW4$wsiS1_MReqInfo = appW3$wsiM0_MReqInfo ;
  ...
  assign appW4$wsiS1_MBurstPrecise = appW3$wsiM0_MBurstPrecise ;
  assign appW4$wsiS1_MReset_n = appW3$wsiM0_MReset_n ;
  assign appW4$wsiS1_MReqLast = appW3$wsiM0_MReqLast ;
endmodule  // mkOCApp
