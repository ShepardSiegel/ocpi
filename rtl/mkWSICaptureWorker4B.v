...
//
// On Tue Jan 10 09:43:55 EST 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkWSICaptureWorker4B(wciS0_Clk,
  ...
  reg [63 : 0] v__h24659,
	       ...
	       v__h3814,
	       v__h3958;
  reg [31 : 0] IF_splaF_first__88_BITS_1_TO_0_90_EQ_0_91_THEN_ETC___d942,
	       v__h26134;
  reg CASE_splaFD_OUT_BITS_1_TO_0_NOT_splaFD_OUT_B_ETC__q1,
      IF_splaF_first__88_BITS_1_TO_0_90_EQ_0_91_THEN_ETC___d909,
      IF_wci_wslv_reqF_first__5_BITS_35_TO_34_64_EQ__ETC___d977;
  wire [63 : 0] IF_nowW_whas__81_THEN_nowW_wget__82_ELSE_0___d1277;
  wire [31 : 0] g_data__h27166,
		rdat___1__h26256,
		rdat___1__h26311,
		rdat___1__h26325,
		rdat___1__h26333,
		...
		y_avValue__h25499,
		y_avValue__h25539;
  wire [13 : 0] mlB__h22541, mlInc__h22540;
  wire [2 : 0] dataBram_serverAdapterB_cnt_16_PLUS_IF_dataBra_ETC___d322,
	       metaBram_serverAdapterB_1_cnt_52_PLUS_IF_metaB_ETC___d558,
	       metaBram_serverAdapterB_2_cnt_70_PLUS_IF_metaB_ETC___d676,
	       metaBram_serverAdapterB_3_cnt_88_PLUS_IF_metaB_ETC___d794,
	       metaBram_serverAdapterB_cnt_34_PLUS_IF_metaBra_ETC___d440,
	       x__h22589,
	       x__h22601,
	       x__h22613,
	       y__h22590,
	       y__h22602,
	       y__h22614;
  wire IF_splaF_first__88_BITS_1_TO_0_90_EQ_0_91_THEN_ETC___d918,
       IF_wci_wslv_reqF_first__5_BITS_63_TO_52_56_EQ__ETC___d980,
       NOT_controlReg_23_BIT_0_24_25_OR_controlReg_23_ETC___d849,
       controlReg_23_BIT_0_24_AND_NOT_controlReg_23_B_ETC___d871,
       dataCount_30_ULT_1024___d831,
       mesgCount_27_ULT_1024___d828,
       splaF_i_notEmpty__87_AND_IF_splaF_first__88_BI_ETC___d920;
  ...
  assign MUX_wci_wslv_respF_q_1$write_1__VAL_2 =
	     (wci_wslv_respF_c_r == 2'd2) ?
	       MUX_wci_wslv_respF_q_0$write_1__VAL_1 :
	       34'h0AAAAAAAA ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_1 = { 2'd1, g_data__h27166 } ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_2 =
	     wci_wslv_illegalEdge ? 34'h3C0DE4202 : 34'h1C0DE4201 ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_3 = { 2'd1, v__h24748 } ;
  ...
  assign dataBram_serverAdapterB_outData_enqData$whas =
	     ...
	     dataBram_serverAdapterB_s1[0] ;
  assign dataBram_serverAdapterB_outData_outData$wget = y_avValue__h25375 ;
  ...
  assign metaBram_serverAdapterB_outData_enqData$whas =
	     ...
	     metaBram_serverAdapterB_s1[0] ;
  assign metaBram_serverAdapterB_outData_outData$wget = y_avValue__h25419 ;
  ...
  assign metaBram_serverAdapterB_1_outData_enqData$whas =
	     ...
	     metaBram_serverAdapterB_1_s1[0] ;
  assign metaBram_serverAdapterB_1_outData_outData$wget = y_avValue__h25459 ;
  ...
  assign metaBram_serverAdapterB_2_outData_enqData$whas =
	     ...
	     metaBram_serverAdapterB_2_s1[0] ;
  assign metaBram_serverAdapterB_2_outData_outData$wget = y_avValue__h25499 ;
  ...
  assign metaBram_serverAdapterB_3_outData_enqData$whas =
	     ...
	     metaBram_serverAdapterB_3_s1[0] ;
  assign metaBram_serverAdapterB_3_outData_outData$wget = y_avValue__h25539 ;
  ...
  // register mesgLengthSoFar
  assign mesgLengthSoFar$D_IN = wsiS_reqFifo$D_OUT[57] ? 14'd0 : mlB__h22541 ;
  ...
  assign metaBram_memory$DIA = { 18'd0, mlB__h22541 } ;
  ...
  assign metaBram_memory_2$DIA =
	     IF_nowW_whas__81_THEN_nowW_wget__82_ELSE_0___d1277[63:32] ;
  ...
  assign metaBram_memory_3$DIA =
	     IF_nowW_whas__81_THEN_nowW_wget__82_ELSE_0___d1277[31:0] ;
  ...
  // remaining internal signals
  assign IF_nowW_whas__81_THEN_nowW_wget__82_ELSE_0___d1277 =
	     EN_now ? now_arg : 64'd0 ;
  assign IF_splaF_first__88_BITS_1_TO_0_90_EQ_0_91_THEN_ETC___d918 =
	     IF_splaF_first__88_BITS_1_TO_0_90_EQ_0_91_THEN_ETC___d909 &&
	     CASE_splaFD_OUT_BITS_1_TO_0_NOT_splaFD_OUT_B_ETC__q1 ;
  assign IF_wci_wslv_reqF_first__5_BITS_63_TO_52_56_EQ__ETC___d980 =
	     (wci_wslv_reqF$D_OUT[63:52] == 12'h001) ?
	       (dataBram_serverAdapterB_cnt ^ 3'h4) < 3'd7 && splaF$FULL_N :
	       wci_wslv_reqF$D_OUT[63:52] != 12'h002 ||
	       splaF$FULL_N &&
	       IF_wci_wslv_reqF_first__5_BITS_35_TO_34_64_EQ__ETC___d977 ;
  assign NOT_controlReg_23_BIT_0_24_25_OR_controlReg_23_ETC___d849 =
	     !controlReg[0] ||
	     controlReg[1] && !mesgCount_27_ULT_1024___d828 &&
	     !dataCount_30_ULT_1024___d831 ||
  ...
  assign controlReg_23_BIT_0_24_AND_NOT_controlReg_23_B_ETC___d871 =
	     controlReg[0] &&
	     (!controlReg[1] || mesgCount_27_ULT_1024___d828 ||
	      dataCount_30_ULT_1024___d831) ;
  ...
  assign dataCount_30_ULT_1024___d831 = dataCount < 32'd1024 ;
  assign g_data__h27166 =
	     (wci_wslv_reqF$D_OUT[63:52] == 12'h0) ? v__h26134 : 32'd0 ;
  assign mesgCount_27_ULT_1024___d828 = mesgCount < 32'd1024 ;
  assign metaBram_serverAdapterB_1_cnt_52_PLUS_IF_metaB_ETC___d558 =
		...
		3'd7 :
		3'd0) ;
  assign metaBram_serverAdapterB_2_cnt_70_PLUS_IF_metaB_ETC___d676 =
	     metaBram_serverAdapterB_2_cnt +
	     (WILL_FIRE_RL_metaBram_serverAdapterB_2_stageReadResponseAlways ?
		3'd1 :
		3'd0) +
	     (metaBram_serverAdapterB_2_cnt_2$whas ? 3'd7 : 3'd0) ;
  assign metaBram_serverAdapterB_3_cnt_88_PLUS_IF_metaB_ETC___d794 =
		...
		3'd7 :
		3'd0) ;
  assign metaBram_serverAdapterB_cnt_34_PLUS_IF_metaBra_ETC___d440 =
	     metaBram_serverAdapterB_cnt +
	     (WILL_FIRE_RL_metaBram_serverAdapterB_stageReadResponseAlways ?
		3'd1 :
		3'd0) +
	     (metaBram_serverAdapterB_outData_deqCalled$whas ? 3'd7 : 3'd0) ;
  assign mlB__h22541 = mesgLengthSoFar + mlInc__h22540 ;
  assign mlInc__h22540 =
	     wsiS_reqFifo$D_OUT[57] ?
	       { 11'd0, x__h22589 + y__h22590 } :
	       14'd4 ;
  assign rdat___1__h26256 = hasDebugLogic ? { 24'd0, wsiS_statusR } : 32'd0 ;
  assign rdat___1__h26311 =
	     hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat___1__h26325 =
	     hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat___1__h26333 =
	     hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign splaF_i_notEmpty__87_AND_IF_splaF_first__88_BI_ETC___d920 =
	     splaF$EMPTY_N &&
	     (splaF$D_OUT[2] ?
		(splaF$D_OUT[1:0] != 2'd0 ||
		 dataBram_serverAdapterB_outDataCore$EMPTY_N ||
		...
		(splaF$D_OUT[1:0] != 2'd0 ||
		 dataBram_serverAdapterB_outData_outData$whas) :
		IF_splaF_first__88_BITS_1_TO_0_90_EQ_0_91_THEN_ETC___d918) ;
  assign v__h24748 =
	     splaF$D_OUT[2] ?
	       y_avValue__h25375 :
	       IF_splaF_first__88_BITS_1_TO_0_90_EQ_0_91_THEN_ETC___d942 ;
  assign x__h22589 = x__h22601 + y__h22602 ;
  assign x__h22601 = x__h22613 + y__h22614 ;
  assign x__h22613 = { 2'd0, wsiS_reqFifo$D_OUT[11] } ;
  assign y__h22590 = { 2'd0, wsiS_reqFifo$D_OUT[8] } ;
  assign y__h22602 = { 2'd0, wsiS_reqFifo$D_OUT[9] } ;
  assign y__h22614 = { 2'd0, wsiS_reqFifo$D_OUT[10] } ;
  assign y_avValue__h25375 =
	     dataBram_serverAdapterB_outDataCore$EMPTY_N ?
	       dataBram_serverAdapterB_outDataCore$D_OUT :
	       dataBram_memory$DOB ;
  assign y_avValue__h25419 =
	     metaBram_serverAdapterB_outDataCore$EMPTY_N ?
	       metaBram_serverAdapterB_outDataCore$D_OUT :
	       metaBram_memory$DOB ;
  assign y_avValue__h25459 =
	     metaBram_serverAdapterB_1_outDataCore$EMPTY_N ?
	       metaBram_serverAdapterB_1_outDataCore$D_OUT :
	       metaBram_memory_1$DOB ;
  assign y_avValue__h25499 =
	     metaBram_serverAdapterB_2_outDataCore$EMPTY_N ?
	       metaBram_serverAdapterB_2_outDataCore$D_OUT :
	       metaBram_memory_2$DOB ;
  assign y_avValue__h25539 =
	     metaBram_serverAdapterB_3_outDataCore$EMPTY_N ?
	       metaBram_serverAdapterB_3_outDataCore$D_OUT :
	       metaBram_memory_3$DOB ;
  ...
  always@(splaF$D_OUT or
	  y_avValue__h25539 or
	  y_avValue__h25419 or y_avValue__h25459 or y_avValue__h25499)
  begin
  ...
  always@(wci_wslv_reqF$D_OUT or
	  ...
	  dataCount or
	  rdat___1__h26256 or
	  rdat___1__h26311 or rdat___1__h26325 or rdat___1__h26333)
  begin
    case (wci_wslv_reqF$D_OUT[39:32])
      8'h0: v__h26134 = controlReg;
      8'h04: v__h26134 = mesgCount;
      8'h08: v__h26134 = dataCount;
      8'h10: v__h26134 = 32'd2361866;
      8'h1C: v__h26134 = 32'hFEEDC0DE;
      8'h20: v__h26134 = rdat___1__h26256;
      8'h24: v__h26134 = rdat___1__h26311;
      8'h28: v__h26134 = rdat___1__h26325;
      8'h2C: v__h26134 = rdat___1__h26333;
      default: v__h26134 = 32'd0;
    endcase
  end
  always@(splaF$D_OUT or
  ...
  begin
    ...
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_advance_split_response)
	$display("[%0d]: %m: WCI SPLIT READ Data:%0x", v__h25667, v__h24748);
    if (wciS0_MReset_n)
