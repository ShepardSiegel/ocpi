...
//
// On Wed Jan 11 15:59:54 EST 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkWSICaptureWorker4B(wciS0_Clk,
  ...
  reg [63 : 0] v__h25110,
	       ...
	       v__h3815,
	       v__h3959;
  reg [31 : 0] IF_splaF_first__95_BITS_1_TO_0_97_EQ_0_98_THEN_ETC___d949,
	       v__h26585;
  reg CASE_splaFD_OUT_BITS_1_TO_0_NOT_splaFD_OUT_B_ETC__q1,
      IF_splaF_first__95_BITS_1_TO_0_97_EQ_0_98_THEN_ETC___d916,
      IF_wci_wslv_reqF_first__5_BITS_35_TO_34_71_EQ__ETC___d984;
  wire [31 : 0] g_data__h27617,
		rdat___1__h26707,
		rdat___1__h26762,
		rdat___1__h26776,
		rdat___1__h26784,
		...
		y_avValue__h25950,
		y_avValue__h25990;
  wire [13 : 0] mlB__h22995, mlInc__h22994;
  wire [2 : 0] dataBram_serverAdapterB_cnt_21_PLUS_IF_dataBra_ETC___d327,
	       ...
	       y__h23056,
	       y__h23068;
  wire IF_splaF_first__95_BITS_1_TO_0_97_EQ_0_98_THEN_ETC___d925,
       IF_wci_wslv_reqF_first__5_BITS_63_TO_52_63_EQ__ETC___d987,
       NOT_controlReg_30_BIT_0_31_32_OR_controlReg_30_ETC___d856,
       controlReg_30_BIT_0_31_AND_NOT_controlReg_30_B_ETC___d878,
       dataCount_37_ULT_1024___d838,
       mesgCount_34_ULT_1024___d835,
       splaF_i_notEmpty__94_AND_IF_splaF_first__95_BI_ETC___d927;
  ...
  assign MUX_wci_wslv_respF_q_1$write_1__VAL_1 =
	     (wci_wslv_respF_c_r == 2'd2) ?
	       MUX_wci_wslv_respF_q_0$write_1__VAL_2 :
	       34'h0AAAAAAAA ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_1 = { 2'd1, g_data__h27617 } ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_2 =
	     wci_wslv_illegalEdge ? 34'h3C0DE4202 : 34'h1C0DE4201 ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_3 = { 2'd1, v__h25199 } ;
  ...
  assign dataBram_serverAdapterB_outData_enqData$whas =
	     ...
	     dataBram_serverAdapterB_s1[0] ;
  assign dataBram_serverAdapterB_outData_outData$wget = y_avValue__h25826 ;
  ...
  assign metaBram_serverAdapterB_outData_enqData$whas =
	     ...
	     metaBram_serverAdapterB_s1[0] ;
  assign metaBram_serverAdapterB_outData_outData$wget = y_avValue__h25870 ;
  ...
  assign metaBram_serverAdapterB_1_outData_enqData$whas =
	     ...
	     metaBram_serverAdapterB_1_s1[0] ;
  assign metaBram_serverAdapterB_1_outData_outData$wget = y_avValue__h25910 ;
  ...
  assign metaBram_serverAdapterB_2_outData_enqData$whas =
	     ...
	     metaBram_serverAdapterB_2_s1[0] ;
  assign metaBram_serverAdapterB_2_outData_outData$wget = y_avValue__h25950 ;
  ...
  assign metaBram_serverAdapterB_3_outData_enqData$whas =
	     ...
	     metaBram_serverAdapterB_3_s1[0] ;
  assign metaBram_serverAdapterB_3_outData_outData$wget = y_avValue__h25990 ;
  ...
  // register mesgLengthSoFar
  assign mesgLengthSoFar$D_IN = wsiS_reqFifo$D_OUT[57] ? 14'd0 : mlB__h22995 ;
  ...
  assign metaBram_memory$DIA = { 18'd0, mlB__h22995 } ;
  ...
  // remaining internal signals
  assign IF_splaF_first__95_BITS_1_TO_0_97_EQ_0_98_THEN_ETC___d925 =
	     IF_splaF_first__95_BITS_1_TO_0_97_EQ_0_98_THEN_ETC___d916 &&
	     CASE_splaFD_OUT_BITS_1_TO_0_NOT_splaFD_OUT_B_ETC__q1 ;
  assign IF_wci_wslv_reqF_first__5_BITS_63_TO_52_63_EQ__ETC___d987 =
	     (wci_wslv_reqF$D_OUT[63:52] == 12'h001) ?
  ...
  assign NOT_controlReg_30_BIT_0_31_32_OR_controlReg_30_ETC___d856 =
	     !controlReg[0] ||
	     controlReg[1] && !mesgCount_34_ULT_1024___d835 &&
	     !dataCount_37_ULT_1024___d838 ||
  ...
  assign dataCount_37_ULT_1024___d838 = dataCount < 32'd1024 ;
  assign g_data__h27617 =
	     (wci_wslv_reqF$D_OUT[63:52] == 12'h0) ? v__h26585 : 32'd0 ;
  assign mesgCount_34_ULT_1024___d835 = mesgCount < 32'd1024 ;
  ...
  assign mlB__h22995 = mesgLengthSoFar + mlInc__h22994 ;
  assign mlInc__h22994 =
	     wsiS_reqFifo$D_OUT[57] ?
	       { 11'd0, x__h23043 + y__h23044 } :
	       14'd4 ;
  assign rdat___1__h26707 = hasDebugLogic ? { 24'd0, wsiS_statusR } : 32'd0 ;
  assign rdat___1__h26762 =
	     hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat___1__h26776 =
	     hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat___1__h26784 =
	     hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign splaF_i_notEmpty__94_AND_IF_splaF_first__95_BI_ETC___d927 =
	     splaF$EMPTY_N &&
	     (splaF$D_OUT[2] ?
		(splaF$D_OUT[1:0] != 2'd0 ||
		 dataBram_serverAdapterB_outDataCore$EMPTY_N ||
		...
		(splaF$D_OUT[1:0] != 2'd0 ||
		 dataBram_serverAdapterB_outData_outData$whas) :
		IF_splaF_first__95_BITS_1_TO_0_97_EQ_0_98_THEN_ETC___d925) ;
  assign v__h25199 =
	     splaF$D_OUT[2] ?
	       y_avValue__h25826 :
	       IF_splaF_first__95_BITS_1_TO_0_97_EQ_0_98_THEN_ETC___d949 ;
  assign x__h23043 = x__h23055 + y__h23056 ;
  assign x__h23055 = x__h23067 + y__h23068 ;
  assign x__h23067 = { 2'd0, wsiS_reqFifo$D_OUT[11] } ;
  assign y__h23044 = { 2'd0, wsiS_reqFifo$D_OUT[8] } ;
  assign y__h23056 = { 2'd0, wsiS_reqFifo$D_OUT[9] } ;
  assign y__h23068 = { 2'd0, wsiS_reqFifo$D_OUT[10] } ;
  assign y_avValue__h25826 =
	     dataBram_serverAdapterB_outDataCore$EMPTY_N ?
	       dataBram_serverAdapterB_outDataCore$D_OUT :
	       dataBram_memory$DOB ;
  assign y_avValue__h25870 =
	     metaBram_serverAdapterB_outDataCore$EMPTY_N ?
	       metaBram_serverAdapterB_outDataCore$D_OUT :
	       metaBram_memory$DOB ;
  assign y_avValue__h25910 =
	     metaBram_serverAdapterB_1_outDataCore$EMPTY_N ?
	       metaBram_serverAdapterB_1_outDataCore$D_OUT :
	       metaBram_memory_1$DOB ;
  assign y_avValue__h25950 =
	     metaBram_serverAdapterB_2_outDataCore$EMPTY_N ?
	       metaBram_serverAdapterB_2_outDataCore$D_OUT :
	       metaBram_memory_2$DOB ;
  assign y_avValue__h25990 =
	     metaBram_serverAdapterB_3_outDataCore$EMPTY_N ?
	       metaBram_serverAdapterB_3_outDataCore$D_OUT :
	       metaBram_memory_3$DOB ;
  ...
  always@(splaF$D_OUT or
	  y_avValue__h25990 or
	  y_avValue__h25870 or y_avValue__h25910 or y_avValue__h25950)
  begin
  ...
  always@(wci_wslv_reqF$D_OUT or
	  ...
	  dataCount or
	  rdat___1__h26707 or
	  rdat___1__h26762 or rdat___1__h26776 or rdat___1__h26784)
  begin
    case (wci_wslv_reqF$D_OUT[39:32])
      8'h0: v__h26585 = controlReg;
      8'h04: v__h26585 = mesgCount;
      8'h08: v__h26585 = dataCount;
      8'h10: v__h26585 = 32'd2361866;
      8'h1C: v__h26585 = 32'hFEEDC0DE;
      8'h20: v__h26585 = rdat___1__h26707;
      8'h24: v__h26585 = rdat___1__h26762;
      8'h28: v__h26585 = rdat___1__h26776;
      8'h2C: v__h26585 = rdat___1__h26784;
      default: v__h26585 = 32'd0;
    endcase
  end
  always@(splaF$D_OUT or
  ...
  begin
    ...
    if (wciS0_MReset_n)
      if (MUX_wci_wslv_respF_x_wire$wset_1__SEL_3)
	$display("[%0d]: %m: WCI SPLIT READ Data:%0x", v__h26118, v__h25199);
    if (wciS0_MReset_n)
