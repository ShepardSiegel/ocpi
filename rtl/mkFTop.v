...
//
// On Wed Jan  5 16:49:47 EST 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkFTop(sys0_clkp,
  ...
  // register pmemMonW8_pmGrab
  assign pmemMonW8_pmGrab$D_IN = z__h14372 ^ pmemMonW8_pmh[31] ;
  ...
  assign z__h14169 = pmemMonW8_pmh[0] ^ pmemMonW8_pmh[1] ;
  assign z__h14176 = z__h14169 ^ pmemMonW8_pmh[2] ;
  assign z__h14183 = z__h14176 ^ pmemMonW8_pmh[3] ;
  assign z__h14190 = z__h14183 ^ pmemMonW8_pmh[4] ;
  assign z__h14197 = z__h14190 ^ pmemMonW8_pmh[5] ;
  assign z__h14204 = z__h14197 ^ pmemMonW8_pmh[6] ;
  assign z__h14211 = z__h14204 ^ pmemMonW8_pmh[7] ;
  assign z__h14218 = z__h14211 ^ pmemMonW8_pmh[8] ;
  assign z__h14225 = z__h14218 ^ pmemMonW8_pmh[9] ;
  assign z__h14232 = z__h14225 ^ pmemMonW8_pmh[10] ;
  assign z__h14239 = z__h14232 ^ pmemMonW8_pmh[11] ;
  assign z__h14246 = z__h14239 ^ pmemMonW8_pmh[12] ;
  assign z__h14253 = z__h14246 ^ pmemMonW8_pmh[13] ;
  assign z__h14260 = z__h14253 ^ pmemMonW8_pmh[14] ;
  assign z__h14267 = z__h14260 ^ pmemMonW8_pmh[15] ;
  assign z__h14274 =
	     z__h14267 ^
	     IF_pmemMonW8_pmh_97_BITS_23_TO_16_29_EQ_0_30_O_ETC___d724[0] ;
  assign z__h14281 =
	     z__h14274 ^
	     IF_pmemMonW8_pmh_97_BITS_23_TO_16_29_EQ_0_30_O_ETC___d724[1] ;
  assign z__h14288 =
	     z__h14281 ^
	     IF_pmemMonW8_pmh_97_BITS_23_TO_16_29_EQ_0_30_O_ETC___d724[2] ;
  assign z__h14295 =
	     z__h14288 ^
	     IF_pmemMonW8_pmh_97_BITS_23_TO_16_29_EQ_0_30_O_ETC___d724[3] ;
  assign z__h14302 =
	     z__h14295 ^
	     IF_pmemMonW8_pmh_97_BITS_23_TO_16_29_EQ_0_30_O_ETC___d724[4] ;
  assign z__h14309 =
	     z__h14302 ^
	     IF_pmemMonW8_pmh_97_BITS_23_TO_16_29_EQ_0_30_O_ETC___d724[5] ;
  assign z__h14316 =
	     z__h14309 ^
	     IF_pmemMonW8_pmh_97_BITS_23_TO_16_29_EQ_0_30_O_ETC___d724[6] ;
  assign z__h14323 =
	     z__h14316 ^
	     IF_pmemMonW8_pmh_97_BITS_23_TO_16_29_EQ_0_30_O_ETC___d724[7] ;
  assign z__h14330 = z__h14323 ^ pmemMonW8_pmh[24] ;
  assign z__h14337 = z__h14330 ^ pmemMonW8_pmh[25] ;
  assign z__h14344 = z__h14337 ^ pmemMonW8_pmh[26] ;
  assign z__h14351 = z__h14344 ^ pmemMonW8_pmh[27] ;
  assign z__h14358 = z__h14351 ^ pmemMonW8_pmh[28] ;
  assign z__h14365 = z__h14358 ^ pmemMonW8_pmh[29] ;
  assign z__h14372 = z__h14365 ^ pmemMonW8_pmh[30] ;
  ...
  begin
    case (pmemMonW8_pmh[23:16])
	  ...
	  IF_pmemMonW8_pmh_97_BITS_23_TO_16_29_EQ_0_30_O_ETC___d724 =
	      pmemMonW8_pmh[23:16];
      default: IF_pmemMonW8_pmh_97_BITS_23_TO_16_29_EQ_0_30_O_ETC___d724 =
		   8'd255;
    endcase
  end
  ...
  begin
    ...
    if (pciw_p125rst$OUT_RST_N)
      if (WILL_FIRE_RL_pmemMonW8_get_message_head_dw)
	$write("[%0d]: %m: PMEM HEAD: ", v__h15654);
    if (pciw_p125rst$OUT_RST_N)
