...
//
// On Tue Dec 21 08:51:32 EST 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkFTop(sys0_clkp,
  ...
  reg [63 : 0] v__h15951, v__h16034, v__h17333, v__h17416;
  ...
  assign pmemMonW8_pmGrab_1$wget = z__h14591 ^ pmemMonW8_pmh[31] ;
  ...
  assign z__h14388 = pmemMonW8_pmh[0] ^ pmemMonW8_pmh[1] ;
  assign z__h14395 = z__h14388 ^ pmemMonW8_pmh[2] ;
  assign z__h14402 = z__h14395 ^ pmemMonW8_pmh[3] ;
  assign z__h14409 = z__h14402 ^ pmemMonW8_pmh[4] ;
  assign z__h14416 = z__h14409 ^ pmemMonW8_pmh[5] ;
  assign z__h14423 = z__h14416 ^ pmemMonW8_pmh[6] ;
  assign z__h14430 = z__h14423 ^ pmemMonW8_pmh[7] ;
  assign z__h14437 = z__h14430 ^ pmemMonW8_pmh[8] ;
  assign z__h14444 = z__h14437 ^ pmemMonW8_pmh[9] ;
  assign z__h14451 = z__h14444 ^ pmemMonW8_pmh[10] ;
  assign z__h14458 = z__h14451 ^ pmemMonW8_pmh[11] ;
  assign z__h14465 = z__h14458 ^ pmemMonW8_pmh[12] ;
  assign z__h14472 = z__h14465 ^ pmemMonW8_pmh[13] ;
  assign z__h14479 = z__h14472 ^ pmemMonW8_pmh[14] ;
  assign z__h14486 = z__h14479 ^ pmemMonW8_pmh[15] ;
  assign z__h14493 =
	     z__h14486 ^
  ...
  assign z__h14549 = z__h14542 ^ pmemMonW8_pmh[24] ;
  assign z__h14556 = z__h14549 ^ pmemMonW8_pmh[25] ;
  assign z__h14563 = z__h14556 ^ pmemMonW8_pmh[26] ;
  assign z__h14570 = z__h14563 ^ pmemMonW8_pmh[27] ;
  assign z__h14577 = z__h14570 ^ pmemMonW8_pmh[28] ;
  assign z__h14584 = z__h14577 ^ pmemMonW8_pmh[29] ;
  assign z__h14591 = z__h14584 ^ pmemMonW8_pmh[30] ;
  ...
  begin
    ...
    if (pciw_p125rst$OUT_RST_N)
	  ...
	  pmemMonW8_pmemF$D_OUT[7:0] == 8'd1 &&
	  !pmemMonW8_pmemF$D_OUT[33])
	$display("[%0d]: %m PMEM HEAD EOF ERROR", v__h15951);
    if (pciw_p125rst$OUT_RST_N)
      if (WILL_FIRE_RL_pmemMonW8_get_message_head)
	begin
	  v__h16034 = $time;
    ...
    if (pciw_p125rst$OUT_RST_N)
      if (WILL_FIRE_RL_pmemMonW8_get_message_head)
	$write("[%0d]: %m PMEM event: ", v__h16034);
    if (pciw_p125rst$OUT_RST_N)
    ...
    if (pciw_p125rst$OUT_RST_N)
	  ...
	  pmemMonW8_dwRemain == 8'd1 &&
	  !pmemMonW8_pmemF$D_OUT[33])
	$display("[%0d]: %m PMEM BODY EOF ERROR", v__h17333);
    if (pciw_p125rst$OUT_RST_N)
      if (WILL_FIRE_RL_pmemMonW8_gen_message_body)
	begin
	  v__h17416 = $time;
