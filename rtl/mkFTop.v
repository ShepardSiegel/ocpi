...
//
// On Sun Dec 19 18:17:44 EST 2010
//
//
// Ports:
// Name                         I/O  size props
...
// pci0_reset_n_p125rst           O     1 reset
...
module mkFTop(sys0_clkp,
  ...
  reg [63 : 0] v__h15965, v__h16048, v__h17347, v__h17430;
  reg [7 : 0] CASE_pmemMonW8_pmemFD_OUT_BITS_23_TO_16_255_0_ETC__q2,
	      CASE_pmemMonW8_wsiS_reqFifoD_OUT_BITS_35_TO_2_ETC__q1,
	      IF_pmemMonW8_pmh_88_BITS_23_TO_16_20_EQ_0_21_O_ETC___d787;
  wire [127 : 0] val_data__h5585, wOut_data__h5691;
  wire [15 : 0] val_be__h5584, wOut_be__h5690;
  wire pciw_p2iAF_head_wrapped_crossed__1_EQ_pciw_p2i_ETC___d100,
       pmemMonW8_wsiS_reqFifo_notFull__25_AND_pmemMon_ETC___d247,
       z__h14402,
       z__h14409,
       z__h14416,
       z__h14423,
  ...
  // output resets
  assign pci0_reset_n_p125rst = pciw_p125rst$OUT_RST_N ;
  ...
  IBUF pciw_pci0_rst(.I(pci0_reset_n), .O(pciw_pci0_rst$O));
  ...
  // submodule wciMonW8
  mkWciOcpMonitor #(.monId(8'h42)) wciMonW8(.CLK(pciw_pci0_pcie_ep$trn2_clk),
					    .RST_N(pciw_p125rst$OUT_RST_N),
  ...
  assign MUX_pciw_p2iS$write_1__VAL_1 =
	     { pciw_fP2I$D_OUT[80:72], val_be__h5584, val_data__h5585 } ;
  ...
  assign pmemMonW8_pmGrab_1$wget = z__h14605 ^ pmemMonW8_pmh[31] ;
  ...
  assign pciw_p2iAF_head_wrapped_crossed__1_EQ_pciw_p2i_ETC___d100 =
	     ...
	     !pciw_p2iAF_sInReset_isInReset &&
	     pciw_preEdge$CLK_VAL ;
  assign pmemMonW8_wsiS_reqFifo_notFull__25_AND_pmemMon_ETC___d247 =
	     pmemMonW8_wsiS_reqFifo$FULL_N &&
	     (pmemMonW8_wsiS_burstKind == 2'd0 ||
	      (pmemMonW8_wsiS_burstKind == 2'd1 ||
	       pmemMonW8_wsiS_burstKind == 2'd2) &&
	      pmemMonW8_wsiS_wsiReq$wget[57]) ;
  assign val_be__h5584 = { pciw_fP2I$D_OUT[71:64], 8'd0 } ;
  assign val_data__h5585 = { pciw_fP2I$D_OUT[63:0], 64'hAAAAAAAAAAAAAAAA } ;
  assign wOut_be__h5690 =
	     { pciw_Prelude_inst_changeSpecialWires_1_rg[71:64],
	       pciw_fP2I$D_OUT[71:64] } ;
  assign wOut_data__h5691 =
	     { pciw_Prelude_inst_changeSpecialWires_1_rg[63:0],
	       pciw_fP2I$D_OUT[63:0] } ;
  assign z__h14402 = pmemMonW8_pmh[0] ^ pmemMonW8_pmh[1] ;
  assign z__h14409 = z__h14402 ^ pmemMonW8_pmh[2] ;
  assign z__h14416 = z__h14409 ^ pmemMonW8_pmh[3] ;
  assign z__h14423 = z__h14416 ^ pmemMonW8_pmh[4] ;
  assign z__h14430 = z__h14423 ^ pmemMonW8_pmh[5] ;
  assign z__h14437 = z__h14430 ^ pmemMonW8_pmh[6] ;
  assign z__h14444 = z__h14437 ^ pmemMonW8_pmh[7] ;
  assign z__h14451 = z__h14444 ^ pmemMonW8_pmh[8] ;
  assign z__h14458 = z__h14451 ^ pmemMonW8_pmh[9] ;
  assign z__h14465 = z__h14458 ^ pmemMonW8_pmh[10] ;
  assign z__h14472 = z__h14465 ^ pmemMonW8_pmh[11] ;
  assign z__h14479 = z__h14472 ^ pmemMonW8_pmh[12] ;
  assign z__h14486 = z__h14479 ^ pmemMonW8_pmh[13] ;
  assign z__h14493 = z__h14486 ^ pmemMonW8_pmh[14] ;
  assign z__h14500 = z__h14493 ^ pmemMonW8_pmh[15] ;
  assign z__h14507 =
	     z__h14500 ^
	     IF_pmemMonW8_pmh_88_BITS_23_TO_16_20_EQ_0_21_O_ETC___d787[0] ;
  assign z__h14514 =
	     z__h14507 ^
	     IF_pmemMonW8_pmh_88_BITS_23_TO_16_20_EQ_0_21_O_ETC___d787[1] ;
  assign z__h14521 =
	     z__h14514 ^
	     IF_pmemMonW8_pmh_88_BITS_23_TO_16_20_EQ_0_21_O_ETC___d787[2] ;
  assign z__h14528 =
	     z__h14521 ^
	     IF_pmemMonW8_pmh_88_BITS_23_TO_16_20_EQ_0_21_O_ETC___d787[3] ;
  assign z__h14535 =
	     z__h14528 ^
	     IF_pmemMonW8_pmh_88_BITS_23_TO_16_20_EQ_0_21_O_ETC___d787[4] ;
  assign z__h14542 =
	     z__h14535 ^
	     IF_pmemMonW8_pmh_88_BITS_23_TO_16_20_EQ_0_21_O_ETC___d787[5] ;
  assign z__h14549 =
	     z__h14542 ^
	     IF_pmemMonW8_pmh_88_BITS_23_TO_16_20_EQ_0_21_O_ETC___d787[6] ;
  assign z__h14556 =
	     z__h14549 ^
	     IF_pmemMonW8_pmh_88_BITS_23_TO_16_20_EQ_0_21_O_ETC___d787[7] ;
  assign z__h14563 = z__h14556 ^ pmemMonW8_pmh[24] ;
  assign z__h14570 = z__h14563 ^ pmemMonW8_pmh[25] ;
  assign z__h14577 = z__h14570 ^ pmemMonW8_pmh[26] ;
  assign z__h14584 = z__h14577 ^ pmemMonW8_pmh[27] ;
  assign z__h14591 = z__h14584 ^ pmemMonW8_pmh[28] ;
  assign z__h14598 = z__h14591 ^ pmemMonW8_pmh[29] ;
  assign z__h14605 = z__h14598 ^ pmemMonW8_pmh[30] ;
  ...
  begin
    case (pmemMonW8_pmh[23:16])
	  ...
	  IF_pmemMonW8_pmh_88_BITS_23_TO_16_20_EQ_0_21_O_ETC___d787 =
	      pmemMonW8_pmh[23:16];
      default: IF_pmemMonW8_pmh_88_BITS_23_TO_16_20_EQ_0_21_O_ETC___d787 =
		   8'd255;
    endcase
  end
  ...
  begin
    ...
    if (pciw_p125rst$OUT_RST_N)
	  ...
	  pmemMonW8_pmemF$D_OUT[7:0] == 8'd1 &&
	  !pmemMonW8_pmemF$D_OUT[33])
	$display("[%0d]: %m PMEM HEAD EOF ERROR", v__h15965);
    if (pciw_p125rst$OUT_RST_N)
      if (WILL_FIRE_RL_pmemMonW8_get_message_head)
	begin
	  v__h16048 = $time;
    ...
    if (pciw_p125rst$OUT_RST_N)
      if (WILL_FIRE_RL_pmemMonW8_get_message_head)
	$write("[%0d]: %m PMEM event: ", v__h16048);
    if (pciw_p125rst$OUT_RST_N)
    ...
    if (pciw_p125rst$OUT_RST_N)
	  ...
	  pmemMonW8_dwRemain == 8'd1 &&
	  !pmemMonW8_pmemF$D_OUT[33])
	$display("[%0d]: %m PMEM BODY EOF ERROR", v__h17347);
    if (pciw_p125rst$OUT_RST_N)
      if (WILL_FIRE_RL_pmemMonW8_gen_message_body)
	begin
	  v__h17430 = $time;
