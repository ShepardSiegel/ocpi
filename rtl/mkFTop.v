...
//
// On Mon Nov 29 20:32:53 EST 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkFTop(sys0_clkp,
  ...
  // inlined wires
  wire [31 : 0] icapwci_Es_mData_w$wget;
  wire [19 : 0] icapwci_Es_mAddr_w$wget;
  wire [7 : 0] pcie_irq_wInterruptDo$wget;
  wire [3 : 0] icapwci_Es_mByteEn_w$wget;
  wire [2 : 0] icapwci_Es_mCmd_w$wget;
  ...
  wire [33 : 0] wciMonW8$pmem_get;
  wire [31 : 0] wciMonW8$observe_MData, wciMonW8$observe_SData;
  wire [19 : 0] wciMonW8$observe_MAddr;
  wire [3 : 0] wciMonW8$observe_MByteEn;
  wire [2 : 0] wciMonW8$observe_MCmd;
  wire [1 : 0] wciMonW8$observe_MFlag,
	       wciMonW8$observe_SFlag,
	       wciMonW8$observe_SResp;
  wire wciMonW8$EN_pmem_get,
       wciMonW8$RDY_pmem_get,
       wciMonW8$observe_MAddrSpace,
  ...
  wire CAN_FIRE_RL_Prelude_inst_changeSpecialWires_1_upconv_connect1,
       ...
       CAN_FIRE_RL_Prelude_inst_changeSpecialWires_6_mkConnectionGetPut,
       ...
       WILL_FIRE_RL_Prelude_inst_changeSpecialWires_6_mkConnectionGetPut,
  ...
  reg [63 : 0] v__h13053, v__h13136, v__h14435, v__h14518;
  reg [7 : 0] CASE_pmemMonW8_pmemFD_OUT_BITS_23_TO_16_255_0_ETC__q2,
	      CASE_wciMonW8pmem_get_BITS_23_TO_16_255_0_wci_ETC__q1,
	      IF_pmemMonW8_pmh_45_BITS_23_TO_16_77_EQ_0_78_O_ETC___d662;
  ...
  mkWciOcpMonitor #(.monId(8'h42)) wciMonW8(.CLK(pci0_pcie_ep$trn2_clk),
					    ...
					    .EN_pmem_get(wciMonW8$EN_pmem_get),
					    .pmem_get(wciMonW8$pmem_get),
					    .RDY_pmem_get(wciMonW8$RDY_pmem_get));
  ...
  // rule RL_Prelude_inst_changeSpecialWires_6_mkConnectionGetPut
  assign CAN_FIRE_RL_Prelude_inst_changeSpecialWires_6_mkConnectionGetPut =
	     wciMonW8$RDY_pmem_get && pmemMonW8_pmemF$FULL_N ;
  assign WILL_FIRE_RL_Prelude_inst_changeSpecialWires_6_mkConnectionGetPut =
	     CAN_FIRE_RL_Prelude_inst_changeSpecialWires_6_mkConnectionGetPut ;
  ...
  assign pmemMonW8_pmGrab_1$wget = z__h11690 ^ pmemMonW8_pmh[31] ;
  ...
  assign pmemMonW8_pmemF$D_IN =
	     { wciMonW8$pmem_get[33:32],
	       wciMonW8$pmem_get[32] ?
		 wciMonW8$pmem_get[31:0] :
		 { wciMonW8$pmem_get[31:24],
		   CASE_wciMonW8pmem_get_BITS_23_TO_16_255_0_wci_ETC__q1,
		   wciMonW8$pmem_get[15:0] } } ;
  ...
  assign wOut_data__h6639 =
	     { Prelude_inst_changeSpecialWires_1_rg[63:0],
	       fP2I$D_OUT[63:0] } ;
  assign z__h11487 = pmemMonW8_pmh[0] ^ pmemMonW8_pmh[1] ;
  assign z__h11494 = z__h11487 ^ pmemMonW8_pmh[2] ;
  assign z__h11501 = z__h11494 ^ pmemMonW8_pmh[3] ;
  assign z__h11508 = z__h11501 ^ pmemMonW8_pmh[4] ;
  assign z__h11515 = z__h11508 ^ pmemMonW8_pmh[5] ;
  assign z__h11522 = z__h11515 ^ pmemMonW8_pmh[6] ;
  assign z__h11529 = z__h11522 ^ pmemMonW8_pmh[7] ;
  assign z__h11536 = z__h11529 ^ pmemMonW8_pmh[8] ;
  assign z__h11543 = z__h11536 ^ pmemMonW8_pmh[9] ;
  assign z__h11550 = z__h11543 ^ pmemMonW8_pmh[10] ;
  assign z__h11557 = z__h11550 ^ pmemMonW8_pmh[11] ;
  assign z__h11564 = z__h11557 ^ pmemMonW8_pmh[12] ;
  assign z__h11571 = z__h11564 ^ pmemMonW8_pmh[13] ;
  assign z__h11578 = z__h11571 ^ pmemMonW8_pmh[14] ;
  assign z__h11585 = z__h11578 ^ pmemMonW8_pmh[15] ;
  assign z__h11592 =
	     z__h11585 ^
	     IF_pmemMonW8_pmh_45_BITS_23_TO_16_77_EQ_0_78_O_ETC___d662[0] ;
  assign z__h11599 =
	     z__h11592 ^
	     IF_pmemMonW8_pmh_45_BITS_23_TO_16_77_EQ_0_78_O_ETC___d662[1] ;
  assign z__h11606 =
	     z__h11599 ^
	     IF_pmemMonW8_pmh_45_BITS_23_TO_16_77_EQ_0_78_O_ETC___d662[2] ;
  assign z__h11613 =
	     z__h11606 ^
	     IF_pmemMonW8_pmh_45_BITS_23_TO_16_77_EQ_0_78_O_ETC___d662[3] ;
  assign z__h11620 =
	     z__h11613 ^
	     IF_pmemMonW8_pmh_45_BITS_23_TO_16_77_EQ_0_78_O_ETC___d662[4] ;
  assign z__h11627 =
	     z__h11620 ^
	     IF_pmemMonW8_pmh_45_BITS_23_TO_16_77_EQ_0_78_O_ETC___d662[5] ;
  assign z__h11634 =
	     z__h11627 ^
	     IF_pmemMonW8_pmh_45_BITS_23_TO_16_77_EQ_0_78_O_ETC___d662[6] ;
  assign z__h11641 =
	     z__h11634 ^
	     IF_pmemMonW8_pmh_45_BITS_23_TO_16_77_EQ_0_78_O_ETC___d662[7] ;
  assign z__h11648 = z__h11641 ^ pmemMonW8_pmh[24] ;
  assign z__h11655 = z__h11648 ^ pmemMonW8_pmh[25] ;
  assign z__h11662 = z__h11655 ^ pmemMonW8_pmh[26] ;
  assign z__h11669 = z__h11662 ^ pmemMonW8_pmh[27] ;
  assign z__h11676 = z__h11669 ^ pmemMonW8_pmh[28] ;
  assign z__h11683 = z__h11676 ^ pmemMonW8_pmh[29] ;
  assign z__h11690 = z__h11683 ^ pmemMonW8_pmh[30] ;
  ...
  begin
    case (pmemMonW8_pmh[23:16])
	  ...
	  IF_pmemMonW8_pmh_45_BITS_23_TO_16_77_EQ_0_78_O_ETC___d662 =
	      pmemMonW8_pmh[23:16];
      default: IF_pmemMonW8_pmh_45_BITS_23_TO_16_77_EQ_0_78_O_ETC___d662 =
		   8'd255;
    endcase
  end
  always@(wciMonW8$pmem_get)
  begin
    case (wciMonW8$pmem_get[23:16])
      8'd0,
      8'd1,
      8'd2,
      8'd3,
      ...
      8'd160:
	  CASE_wciMonW8pmem_get_BITS_23_TO_16_255_0_wci_ETC__q1 =
	      wciMonW8$pmem_get[23:16];
      default: CASE_wciMonW8pmem_get_BITS_23_TO_16_255_0_wci_ETC__q1 = 8'd255;
    endcase
  end
  ...
  begin
    ...
    if (trn2_rst$OUT_RST_N)
	  ...
	  pmemMonW8_pmemF$D_OUT[7:0] == 8'd1 &&
	  !pmemMonW8_pmemF$D_OUT[33])
	$display("[%0d]: %m PMEM HEAD EOF ERROR", v__h13053);
    if (trn2_rst$OUT_RST_N)
      if (WILL_FIRE_RL_pmemMonW8_get_message_head)
	begin
	  v__h13136 = $time;
    ...
    if (trn2_rst$OUT_RST_N)
      if (WILL_FIRE_RL_pmemMonW8_get_message_head)
	$write("[%0d]: %m PMEM event: ", v__h13136);
    if (trn2_rst$OUT_RST_N)
    ...
    if (trn2_rst$OUT_RST_N)
	  ...
	  pmemMonW8_dwRemain == 8'd1 &&
	  !pmemMonW8_pmemF$D_OUT[33])
	$display("[%0d]: %m PMEM BODY EOF ERROR", v__h14435);
    if (trn2_rst$OUT_RST_N)
      if (WILL_FIRE_RL_pmemMonW8_gen_message_body)
	begin
	  v__h14518 = $time;
