...
//
// On Mon Oct 25 10:58:28 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkFTop(sys0_clkp,
  ...
  wire p2iAF_sCrossedHeadWrapped_wget__86_EQ_p2iAF_ta_ETC___d192;
  ...
  mkCTop ctop(.pciDevice(pciDevice$dD_OUT),
	      ...
	      .RST_N_wci_m_0_mReset_n(ctop$RST_N_wci_m_0_mReset_n),
  ...
  mkICAPWorker #(.isV6ICAP(1'd1),
		 .hasDebugLogic(1'd1)) icap(.wciS0_Clk(pci0_pcie_ep$trn2_clk),
					    .wciS0_MReset_n(ctop$RST_N_wci_m_0_mReset_n),
  ...
  assign CAN_FIRE_RL_Prelude_inst_changeSpecialWires_1_upconv_connect2 =
	     p2iAF_sCrossedHeadWrapped_wget__86_EQ_p2iAF_ta_ETC___d192 &&
	     fP2I$EMPTY_N &&
  ...
  // remaining internal signals
  assign p2iAF_sCrossedHeadWrapped_wget__86_EQ_p2iAF_ta_ETC___d192 =
