...
//
// On Thu Jul  1 10:28:07 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkFTop(sys0_clkp,
  ...
  wire [127 : 0] put_data__h4443, wOut_data__h4272;
  wire [15 : 0] pci0_pcie_ep_cfg_bus_number__33_CONCAT_pci0_pc_ETC___d249,
		put_be__h4442,
		wOut_be__h4271;
  ...
  // submodule ctop
  mkCTop ctop(.pciDevice(pci0_pcie_ep_cfg_bus_number__33_CONCAT_pci0_pc_ETC___d249),
  ...
  assign MUX_ctop$server_request_put_1__VAL_1 =
	     { fP2I$D_OUT[80:72], put_be__h4442, put_data__h4443 } ;
  ...
  assign pci0_wTrnRxCplS$wget = 1'd0 ;
  ...
  assign pci0_pcie_ep$trn_rcpl_streaming_n = 1'b0 ;
  ...
  // remaining internal signals
  assign pci0_pcie_ep_cfg_bus_number__33_CONCAT_pci0_pc_ETC___d249 =
	     { pci0_pcie_ep$cfg_bus_number,
	       pci0_pcie_ep$cfg_device_number,
	       pci0_pcie_ep$cfg_function_number } ;
  assign put_be__h4442 = { fP2I$D_OUT[71:64], 8'd0 } ;
  assign put_data__h4443 = { fP2I$D_OUT[63:0], 64'hAAAAAAAAAAAAAAAA } ;
  assign wOut_be__h4271 =
	     { Prelude_inst_changeSpecialWires_rg[71:64],
	       fP2I$D_OUT[71:64] } ;
  assign wOut_data__h4272 =
