...
//
// On Mon Nov 29 19:22:46 EST 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkFTop(sys0_clkp,
  ...
  reg [63 : 0] v__h11487, v__h11570, v__h12869, v__h12952;
  ...
  begin
    ...
    if (trn2_rst$OUT_RST_N)
	  ...
	  pmemMonW8_pmemF$D_OUT[7:0] == 8'd1 &&
	  !pmemMonW8_pmemF$D_OUT[33])
	$display("[%0d]: %m PMEM HEAD EOF ERROR", v__h11487);
    if (trn2_rst$OUT_RST_N)
      if (WILL_FIRE_RL_pmemMonW8_get_message_head)
	begin
	  v__h11570 = $time;
    ...
    if (trn2_rst$OUT_RST_N)
      if (WILL_FIRE_RL_pmemMonW8_get_message_head)
	$write("[%0d]: %m PMEM event: ", v__h11570);
    if (trn2_rst$OUT_RST_N)
    ...
    if (trn2_rst$OUT_RST_N)
	  ...
	  pmemMonW8_dwRemain == 8'd1 &&
	  !pmemMonW8_pmemF$D_OUT[33])
	$display("[%0d]: %m PMEM BODY EOF ERROR", v__h12869);
    if (trn2_rst$OUT_RST_N)
      if (WILL_FIRE_RL_pmemMonW8_gen_message_body)
	begin
	  v__h12952 = $time;
