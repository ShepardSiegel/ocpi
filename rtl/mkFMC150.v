...
//
// On Tue Oct 23 15:39:41 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkFMC150(CLK_flp_clk,
  ...
  reg [63 : 0] v__h3694, v__h3869, v__h4013, v__h42019, v__h42781;
  reg [31 : 0] rdat__h42765;
  reg CASE_31_MINUS_spiCDC_dPos_31_30_31_MINUS_spiCD_ETC__q4,
      CASE_31_MINUS_spiCDC_dPos_31_30_x3624_0_spiCDC_ETC__q5,
      CASE_spiDAC_iPos_spiDAC_reqS_BIT_8_1_spiDAC_re_ETC__q3,
      IF_spiDAC_iPos_47_EQ_4_54_OR_spiDAC_iPos_47_EQ_ETC___d364;
  wire [31 : 0] IF_fcCdc_grayCounter_rsCounter_15_BIT_0_22_OR__ETC___d686,
		IF_fcCdc_grayCounter_rsCounter_15_BIT_0_22_XOR_ETC___d777,
		rdat__h42539;
  wire [27 : 0] spiCDC_reqS_BITS_27_TO_0__q1;
  wire [17 : 0] x__h36382, y__h37787;
  wire [7 : 0] spiDAC_reqS_BITS_7_TO_0__q2;
  wire [4 : 0] _31_MINUS_spiCDC_dPos_31___d730, x__h13667;
  wire IF_spiDAC_iPos_47_EQ_7_48_THEN_NOT_spiDAC_reqF_ETC___d367,
       IF_wci_wslv_reqF_i_notEmpty__4_AND_wci_wslv_re_ETC___d771,
       ...
       fcCdc_grayCounter_rdCounter_13_BIT_17_14_XOR_f_ETC___d671,
  ...
  assign MUX_fcCdc_grayCounter_rsCounter$write_1__VAL_1 =
	     (~fcCdc_grayCounter_rsCounter[IF_fcCdc_grayCounter_rsCounter_15_BIT_0_22_XOR_ETC___d777[4:0]]) ?
	       fcCdc_grayCounter_rsCounter | x__h36382 :
	       fcCdc_grayCounter_rsCounter & y__h37787 ;
  ...
  assign MUX_wci_wslv_respF_q_1$write_1__VAL_1 =
	     (wci_wslv_respF_c_r == 2'd2) ?
	       MUX_wci_wslv_respF_q_0$write_1__VAL_2 :
	       34'h0AAAAAAAA ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_1 = { 2'd1, rdat__h42765 } ;
  ...
  assign spiCDC_sdoR$D_IN =
	     spiCDC_reqS[32] ?
	       _31_MINUS_spiCDC_dPos_31___d730 != 5'd0 &&
	       (_31_MINUS_spiCDC_dPos_31___d730 == 5'd1 ||
		_31_MINUS_spiCDC_dPos_31___d730 == 5'd2 ||
		_31_MINUS_spiCDC_dPos_31___d730 == 5'd3 ||
		CASE_31_MINUS_spiCDC_dPos_31_30_31_MINUS_spiCD_ETC__q4) :
	       CASE_31_MINUS_spiCDC_dPos_31_30_x3624_0_spiCDC_ETC__q5 ;
  ...
  // remaining internal signals
  assign IF_fcCdc_grayCounter_rsCounter_15_BIT_0_22_OR__ETC___d686 =
  ...
  assign IF_fcCdc_grayCounter_rsCounter_15_BIT_0_22_XOR_ETC___d777 =
	     fcCdc_grayCounter_rsCounter_15_BIT_0_22_XOR_fc_ETC___d731 ?
	       IF_fcCdc_grayCounter_rsCounter_15_BIT_0_22_OR__ETC___d686 :
	       32'd0 ;
  assign IF_spiDAC_iPos_47_EQ_7_48_THEN_NOT_spiDAC_reqF_ETC___d367 =
	     (spiDAC_iPos == 3'd7) ?
	       ...
	       spiDAC_iPos == 3'd6 || spiDAC_iPos == 3'd5 ||
	       IF_spiDAC_iPos_47_EQ_4_54_OR_spiDAC_iPos_47_EQ_ETC___d364 ;
  assign IF_wci_wslv_reqF_i_notEmpty__4_AND_wci_wslv_re_ETC___d771 =
  ...
  assign NOT_spiDAC_iPos_47_EQ_0_61_62_OR_NOT_spiDAC_re_ETC___d363 =
	     ...
	     spiDAC_reqF_head_wrapped != spiDAC_reqF_tail_wrapped &&
	     !spiDAC_reqF_dInReset$VAL ;
  assign _31_MINUS_spiCDC_dPos_31___d730 = 5'd31 - spiCDC_dPos ;
  ...
  assign fcCdc_grayCounter_rdCounter_13_BIT_17_14_XOR_f_ETC___d671 =
	     fcCdc_grayCounter_rdCounter[17] ^
  ...
  assign fcCdc_grayCounter_rsCounter_15_BIT_0_22_XOR_fc_ETC___d731 =
	     z__h36507 ^ fcCdc_grayCounter_rsCounter[17] ;
  assign rdat__h42539 = { 14'd0, fcCdc_frequency } ;
  ...
  assign x__h36382 =
	     18'd1 <<
	     IF_fcCdc_grayCounter_rsCounter_15_BIT_0_22_XOR_ETC___d777 ;
  assign y__h37787 = ~x__h36382 ;
  assign z__h36402 =
	     fcCdc_grayCounter_rsCounter[0] ^ fcCdc_grayCounter_rsCounter[1] ;
  assign z__h36409 = z__h36402 ^ fcCdc_grayCounter_rsCounter[2] ;
  assign z__h36416 = z__h36409 ^ fcCdc_grayCounter_rsCounter[3] ;
  assign z__h36423 = z__h36416 ^ fcCdc_grayCounter_rsCounter[4] ;
  assign z__h36430 = z__h36423 ^ fcCdc_grayCounter_rsCounter[5] ;
  assign z__h36437 = z__h36430 ^ fcCdc_grayCounter_rsCounter[6] ;
  assign z__h36444 = z__h36437 ^ fcCdc_grayCounter_rsCounter[7] ;
  assign z__h36451 = z__h36444 ^ fcCdc_grayCounter_rsCounter[8] ;
  assign z__h36458 = z__h36451 ^ fcCdc_grayCounter_rsCounter[9] ;
  assign z__h36465 = z__h36458 ^ fcCdc_grayCounter_rsCounter[10] ;
  assign z__h36472 = z__h36465 ^ fcCdc_grayCounter_rsCounter[11] ;
  assign z__h36479 = z__h36472 ^ fcCdc_grayCounter_rsCounter[12] ;
  assign z__h36486 = z__h36479 ^ fcCdc_grayCounter_rsCounter[13] ;
  assign z__h36493 = z__h36486 ^ fcCdc_grayCounter_rsCounter[14] ;
  assign z__h36500 = z__h36493 ^ fcCdc_grayCounter_rsCounter[15] ;
  assign z__h36507 = z__h36500 ^ fcCdc_grayCounter_rsCounter[16] ;
  always@(wci_wslv_reqF$D_OUT or rdat__h42539)
  begin
    case (wci_wslv_reqF$D_OUT[43:42])
      2'b0, 2'b01: rdat__h42765 = 32'd0;
      2'b10: rdat__h42765 = 32'hFEEDFACE;
      2'b11: rdat__h42765 = rdat__h42539;
    endcase
  end
  ...
  always@(_31_MINUS_spiCDC_dPos_31___d730 or spiCDC_reqS)
  begin
    case (_31_MINUS_spiCDC_dPos_31___d730)
      5'd4:
	  CASE_31_MINUS_spiCDC_dPos_31_30_31_MINUS_spiCD_ETC__q4 =
	      spiCDC_reqS[28];
      5'd5:
	  ...
	  CASE_31_MINUS_spiCDC_dPos_31_30_31_MINUS_spiCD_ETC__q4 =
	      spiCDC_reqS[30];
      default: CASE_31_MINUS_spiCDC_dPos_31_30_31_MINUS_spiCD_ETC__q4 =
		   _31_MINUS_spiCDC_dPos_31___d730 == 5'd7 && spiCDC_reqS[31];
    endcase
  end
  always@(_31_MINUS_spiCDC_dPos_31___d730 or x__h13624 or spiCDC_reqS)
  begin
    case (_31_MINUS_spiCDC_dPos_31___d730)
      5'd0:
	  CASE_31_MINUS_spiCDC_dPos_31_30_x3624_0_spiCDC_ETC__q5 =
	  ...
	  CASE_31_MINUS_spiCDC_dPos_31_30_x3624_0_spiCDC_ETC__q5 =
	      spiCDC_reqS[31];
      default: CASE_31_MINUS_spiCDC_dPos_31_30_x3624_0_spiCDC_ETC__q5 =
		   x__h13624;
    endcase
  end
  ...
  always@(posedge CLK_flp_clk or `BSV_RESET_EDGE !`BSV_RESET_VALUE)
