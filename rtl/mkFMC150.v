...
//
// On Sun Apr 15 13:50:09 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkFMC150(CLK_flp_clk,
  ...
  reg [63 : 0] v__h31161, v__h31650, v__h3616, v__h3790, v__h3934;
  reg [31 : 0] rdat__h31634;
  ...
  assign MUX_fcCdc_grayCounter_rsCounter$write_1__VAL_1 =
	     (~fcCdc_grayCounter_rsCounter[IF_fcCdc_grayCounter_rsCounter_84_BIT_0_91_XOR_ETC___d559[4:0]]) ?
	       fcCdc_grayCounter_rsCounter | x__h25682 :
	       fcCdc_grayCounter_rsCounter & y__h27087 ;
  ...
  assign MUX_wci_wslv_respF_q_1$write_1__VAL_2 =
	     (wci_wslv_respF_c_r == 2'd2) ?
	       MUX_wci_wslv_respF_q_0$write_1__VAL_1 :
	       34'h0AAAAAAAA ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_1 = { 2'd1, rdat__h31634 } ;
  ...
  assign fcCdc_grayCounter_rsCounter_84_BIT_0_91_XOR_fc_ETC___d528 =
	     z__h25807 ^ fcCdc_grayCounter_rsCounter[17] ;
  assign rdat__h31510 = { 14'd0, fcCdc_frequency } ;
  ...
  assign x__h25682 =
	     18'd1 <<
	     IF_fcCdc_grayCounter_rsCounter_84_BIT_0_91_XOR_ETC___d559 ;
  assign y__h27087 = ~x__h25682 ;
  assign z__h25702 =
	     fcCdc_grayCounter_rsCounter[0] ^ fcCdc_grayCounter_rsCounter[1] ;
  assign z__h25709 = z__h25702 ^ fcCdc_grayCounter_rsCounter[2] ;
  assign z__h25716 = z__h25709 ^ fcCdc_grayCounter_rsCounter[3] ;
  assign z__h25723 = z__h25716 ^ fcCdc_grayCounter_rsCounter[4] ;
  assign z__h25730 = z__h25723 ^ fcCdc_grayCounter_rsCounter[5] ;
  assign z__h25737 = z__h25730 ^ fcCdc_grayCounter_rsCounter[6] ;
  assign z__h25744 = z__h25737 ^ fcCdc_grayCounter_rsCounter[7] ;
  assign z__h25751 = z__h25744 ^ fcCdc_grayCounter_rsCounter[8] ;
  assign z__h25758 = z__h25751 ^ fcCdc_grayCounter_rsCounter[9] ;
  assign z__h25765 = z__h25758 ^ fcCdc_grayCounter_rsCounter[10] ;
  assign z__h25772 = z__h25765 ^ fcCdc_grayCounter_rsCounter[11] ;
  assign z__h25779 = z__h25772 ^ fcCdc_grayCounter_rsCounter[12] ;
  assign z__h25786 = z__h25779 ^ fcCdc_grayCounter_rsCounter[13] ;
  assign z__h25793 = z__h25786 ^ fcCdc_grayCounter_rsCounter[14] ;
  assign z__h25800 = z__h25793 ^ fcCdc_grayCounter_rsCounter[15] ;
  assign z__h25807 = z__h25800 ^ fcCdc_grayCounter_rsCounter[16] ;
  always@(wci_wslv_reqF$D_OUT or rdat__h31510)
  begin
    case (wci_wslv_reqF$D_OUT[43:42])
      2'b0: rdat__h31634 = 32'd0;
      2'b01: rdat__h31634 = 32'hBEEFF00D;
      2'b10: rdat__h31634 = 32'hFEEDFACE;
      2'b11: rdat__h31634 = rdat__h31510;
    endcase
  end
