...
//
// On Wed Oct 30 08:48:06 EDT 2013
//
//
// Ports:
// Name                         I/O  size props
...
module mkFMC150(CLK_flp_clk,
  ...
  wire MUX_spiCDC_doResp_1$wset_1__SEL_1,
       MUX_spiCDC_rcv_d$write_1__SEL_2,
  ...
  assign WILL_FIRE_RL_spiCDC_reqF_deq_update_head =
	     !spiCDC_reqF_dInReset$VAL && MUX_spiCDC_rcv_d$write_1__SEL_2 ;
  ...
  assign MUX_spiCDC_rcv_d$write_1__SEL_2 =
  ...
  assign MUX_wci_wslv_respF_q_1$write_1__VAL_2 =
	     (wci_wslv_respF_cntr_r == 2'd2) ?
	       MUX_wci_wslv_respF_q_0$write_1__VAL_1 :
	       34'h0AAAAAAAA ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_1 = { 2'd1, rdat__h43022 } ;
  ...
  assign spiCDC_reqF_enq_pw$whas =
	     _dor1spiCDC_reqF_enq_pw$EN_wset &&
	     wci_wslv_reqF$D_OUT[43:42] == 2'b0 ;
  assign spiCDC_reqF_deq_pw$whas = MUX_spiCDC_rcv_d$write_1__SEL_2 ;
  ...
  assign spiCDC_rcv_d$D_IN =
	     !MUX_spiCDC_doResp_1$wset_1__SEL_1 && spiCDC_reqS[32] ;
  ...
  // register spiCDC_xmt_d
  assign spiCDC_xmt_d$D_IN = !MUX_spiCDC_rcv_d$write_1__SEL_2 ;
  ...
  always@(wci_wslv_reqF$D_OUT or rdat__h42796)
  begin
