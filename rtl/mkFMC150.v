...
//
// On Sat Apr 14 13:11:40 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkFMC150(CLK_flp_clk,
  ...
  reg [31 : 0] spiCDC_capV;
  wire [31 : 0] spiCDC_capV$D_IN;
  wire spiCDC_capV$EN;
  ...
  reg [36 : 0] spiCDC_reqS;
  wire [36 : 0] spiCDC_reqS$D_IN;
  wire spiCDC_reqS$EN;
  ...
  reg [31 : 0] spiCDC_respS;
  wire [31 : 0] spiCDC_respS$D_IN;
  ...
  wire [36 : 0] MUX_spiCDC_reqS$write_1__VAL_1,
  ...
  reg [63 : 0] v__h32752, v__h33238, v__h3616, v__h3790, v__h3934;
  reg [31 : 0] rdat__h33222;
  reg CASE_31_MINUS_spiCDC_dPos_28_19_31_MINUS_spiCD_ETC__q2,
      CASE_31_MINUS_spiCDC_dPos_28_19_x3865_0_spiCDC_ETC__q3;
  wire [31 : 0] IF_fcCdc_grayCounter_rsCounter_79_BIT_0_86_OR__ETC___d549,
		IF_fcCdc_grayCounter_rsCounter_79_BIT_0_86_XOR_ETC___d550,
		rdat__h33093,
		spiCDC_reqS_BITS_31_TO_0__q1;
  wire [17 : 0] x__h27299, y__h28704;
  wire [4 : 0] _31_MINUS_spiCDC_dPos_28___d519;
  wire _dor1spiCDC_reqF_enq_pw$EN_wset,
       fcCdc_grayCounter_rdCounter_77_BIT_17_78_XOR_f_ETC___d556,
       fcCdc_grayCounter_rdCounter_77_BIT_17_78_XOR_f_ETC___d557,
       fcCdc_grayCounter_rdCounter_77_BIT_17_78_XOR_f_ETC___d558,
       fcCdc_grayCounter_rdCounter_77_BIT_17_78_XOR_f_ETC___d559,
       fcCdc_grayCounter_rdCounter_77_BIT_17_78_XOR_f_ETC___d560,
       fcCdc_grayCounter_rdCounter_77_BIT_17_78_XOR_f_ETC___d561,
       fcCdc_grayCounter_rdCounter_77_BIT_17_78_XOR_f_ETC___d562,
       fcCdc_grayCounter_rdCounter_77_BIT_17_78_XOR_f_ETC___d563,
       fcCdc_grayCounter_rdCounter_77_BIT_17_78_XOR_f_ETC___d564,
       fcCdc_grayCounter_rdCounter_77_BIT_17_78_XOR_f_ETC___d565,
       fcCdc_grayCounter_rdCounter_77_BIT_17_78_XOR_f_ETC___d566,
       fcCdc_grayCounter_rdCounter_77_BIT_17_78_XOR_f_ETC___d567,
       fcCdc_grayCounter_rdCounter_77_BIT_17_78_XOR_f_ETC___d568,
       fcCdc_grayCounter_rdCounter_77_BIT_17_78_XOR_f_ETC___d569,
       fcCdc_grayCounter_rdCounter_77_BIT_17_78_XOR_f_ETC___d570,
       fcCdc_grayCounter_rdCounter_77_BIT_17_78_XOR_f_ETC___d571,
       fcCdc_grayCounter_rsCounter_79_BIT_0_86_XOR_fc_ETC___d520,
       spiCDC_reqF_head_wrapped_crossed__67_EQ_spiCDC_ETC___d446,
       wci_wslv_reqF_i_notEmpty__4_AND_IF_wci_wslv_re_ETC___d466,
       x__h13865,
       z__h27319,
       z__h27326,
       z__h27333,
  ...
  assign MUX_spiCDC_doResp_1$wset_1__SEL_1 =
	     WILL_FIRE_RL_spiCDC_recv_d && spiCDC_rPos == 5'd0 ;
  ...
  assign MUX_fcCdc_grayCounter_rsCounter$write_1__VAL_1 =
	     (~fcCdc_grayCounter_rsCounter[IF_fcCdc_grayCounter_rsCounter_79_BIT_0_86_XOR_ETC___d550[4:0]]) ?
	       fcCdc_grayCounter_rsCounter | x__h27299 :
	       fcCdc_grayCounter_rsCounter & y__h28704 ;
  ...
  assign MUX_spiCDC_rPos$write_1__VAL_1 = spiCDC_reqS[36] ? 5'd31 : 5'd0 ;
  assign MUX_spiCDC_rPos$write_1__VAL_2 =
	     (spiCDC_rPos == 5'd0) ? spiCDC_rPos : spiCDC_rPos - 5'd1 ;
  assign MUX_spiCDC_reqS$write_1__VAL_1 =
	     { 1'd0, wci_wslv_reqF$D_OUT[37:34], wci_wslv_reqF$D_OUT[31:0] } ;
  assign MUX_spiCDC_reqS$write_1__VAL_2 =
	     { 1'd1, wci_wslv_reqF$D_OUT[37:34], 32'd0 } ;
  ...
  assign MUX_wci_wslv_respF_q_1$write_1__VAL_2 =
	     (wci_wslv_respF_c_r == 2'd2) ?
	       MUX_wci_wslv_respF_q_0$write_1__VAL_1 :
	       34'h0AAAAAAAA ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_1 = { 2'd1, rdat__h33222 } ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_2 =
	     wci_wslv_illegalEdge ? 34'h3C0DE4202 : 34'h1C0DE4201 ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_3 = { 2'd1, spiCDC_respS } ;
  ...
  assign spiCDC_csbR_1$wget =
	     WILL_FIRE_RL_spiCDC_recv_d && spiCDC_rPos == 5'd31 ;
  assign spiCDC_csbR_1$whas =
  ...
  // register spiCDC_capV
  assign spiCDC_capV$D_IN = { spiCDC_capV[30:0], spiCDC_sdiP } ;
  assign spiCDC_capV$EN = WILL_FIRE_RL_spiCDC_recv_d ;

  // register spiCDC_csbR
  assign spiCDC_csbR$D_IN = !spiCDC_csbR_1$whas || spiCDC_csbR_1$wget ;
  ...
  assign spiCDC_rcv_d$D_IN =
	     MUX_spiCDC_rcv_d$write_1__SEL_1 && spiCDC_reqS[36] ;
  ...
  // register spiCDC_respS
  assign spiCDC_respS$D_IN = spiCDC_capV ;
  ...
  assign spiCDC_sdoR$D_IN =
	     spiCDC_reqS[36] ?
	       _31_MINUS_spiCDC_dPos_28___d519 != 5'd0 &&
	       (_31_MINUS_spiCDC_dPos_28___d519 == 5'd1 ||
		_31_MINUS_spiCDC_dPos_28___d519 == 5'd2 ||
		_31_MINUS_spiCDC_dPos_28___d519 == 5'd3 ||
		CASE_31_MINUS_spiCDC_dPos_28_19_31_MINUS_spiCD_ETC__q2) :
	       CASE_31_MINUS_spiCDC_dPos_28_19_x3865_0_spiCDC_ETC__q3 ;
  ...
  // remaining internal signals
  assign IF_fcCdc_grayCounter_rsCounter_79_BIT_0_86_OR__ETC___d549 =
							 ...
							 (fcCdc_grayCounter_rsCounter[14] ?
							    ...
							    (fcCdc_grayCounter_rsCounter[15] ?
								  ...
								  (fcCdc_grayCounter_rsCounter[17] ?
								     ...
								     32'd19)))))))))))))))))) :
	       32'd17 ;
  assign IF_fcCdc_grayCounter_rsCounter_79_BIT_0_86_XOR_ETC___d550 =
	     fcCdc_grayCounter_rsCounter_79_BIT_0_86_XOR_fc_ETC___d520 ?
	       IF_fcCdc_grayCounter_rsCounter_79_BIT_0_86_OR__ETC___d549 :
	       32'd0 ;
  assign _31_MINUS_spiCDC_dPos_28___d519 = 5'd31 - spiCDC_dPos ;
  assign _dor1spiCDC_reqF_enq_pw$EN_wset =
	     WILL_FIRE_RL_wci_cfrd || WILL_FIRE_RL_wci_cfwr ;
  assign fcCdc_grayCounter_rdCounter_77_BIT_17_78_XOR_f_ETC___d556 =
	     fcCdc_grayCounter_rdCounter[17] ^
	     fcCdc_grayCounter_rdCounter[16] ;
  assign fcCdc_grayCounter_rdCounter_77_BIT_17_78_XOR_f_ETC___d557 =
	     fcCdc_grayCounter_rdCounter_77_BIT_17_78_XOR_f_ETC___d556 ^
	     fcCdc_grayCounter_rdCounter[15] ;
  assign fcCdc_grayCounter_rdCounter_77_BIT_17_78_XOR_f_ETC___d558 =
	     fcCdc_grayCounter_rdCounter_77_BIT_17_78_XOR_f_ETC___d557 ^
	     fcCdc_grayCounter_rdCounter[14] ;
  assign fcCdc_grayCounter_rdCounter_77_BIT_17_78_XOR_f_ETC___d559 =
	     fcCdc_grayCounter_rdCounter_77_BIT_17_78_XOR_f_ETC___d558 ^
	     fcCdc_grayCounter_rdCounter[13] ;
  assign fcCdc_grayCounter_rdCounter_77_BIT_17_78_XOR_f_ETC___d560 =
	     fcCdc_grayCounter_rdCounter_77_BIT_17_78_XOR_f_ETC___d559 ^
	     fcCdc_grayCounter_rdCounter[12] ;
  assign fcCdc_grayCounter_rdCounter_77_BIT_17_78_XOR_f_ETC___d561 =
	     fcCdc_grayCounter_rdCounter_77_BIT_17_78_XOR_f_ETC___d560 ^
	     fcCdc_grayCounter_rdCounter[11] ;
  assign fcCdc_grayCounter_rdCounter_77_BIT_17_78_XOR_f_ETC___d562 =
	     fcCdc_grayCounter_rdCounter_77_BIT_17_78_XOR_f_ETC___d561 ^
	     fcCdc_grayCounter_rdCounter[10] ;
  assign fcCdc_grayCounter_rdCounter_77_BIT_17_78_XOR_f_ETC___d563 =
	     fcCdc_grayCounter_rdCounter_77_BIT_17_78_XOR_f_ETC___d562 ^
	     fcCdc_grayCounter_rdCounter[9] ;
  assign fcCdc_grayCounter_rdCounter_77_BIT_17_78_XOR_f_ETC___d564 =
	     fcCdc_grayCounter_rdCounter_77_BIT_17_78_XOR_f_ETC___d563 ^
	     fcCdc_grayCounter_rdCounter[8] ;
  assign fcCdc_grayCounter_rdCounter_77_BIT_17_78_XOR_f_ETC___d565 =
	     fcCdc_grayCounter_rdCounter_77_BIT_17_78_XOR_f_ETC___d564 ^
	     fcCdc_grayCounter_rdCounter[7] ;
  assign fcCdc_grayCounter_rdCounter_77_BIT_17_78_XOR_f_ETC___d566 =
	     fcCdc_grayCounter_rdCounter_77_BIT_17_78_XOR_f_ETC___d565 ^
	     fcCdc_grayCounter_rdCounter[6] ;
  assign fcCdc_grayCounter_rdCounter_77_BIT_17_78_XOR_f_ETC___d567 =
	     fcCdc_grayCounter_rdCounter_77_BIT_17_78_XOR_f_ETC___d566 ^
	     fcCdc_grayCounter_rdCounter[5] ;
  assign fcCdc_grayCounter_rdCounter_77_BIT_17_78_XOR_f_ETC___d568 =
	     fcCdc_grayCounter_rdCounter_77_BIT_17_78_XOR_f_ETC___d567 ^
	     fcCdc_grayCounter_rdCounter[4] ;
  assign fcCdc_grayCounter_rdCounter_77_BIT_17_78_XOR_f_ETC___d569 =
	     fcCdc_grayCounter_rdCounter_77_BIT_17_78_XOR_f_ETC___d568 ^
	     fcCdc_grayCounter_rdCounter[3] ;
  assign fcCdc_grayCounter_rdCounter_77_BIT_17_78_XOR_f_ETC___d570 =
	     fcCdc_grayCounter_rdCounter_77_BIT_17_78_XOR_f_ETC___d569 ^
	     fcCdc_grayCounter_rdCounter[2] ;
  assign fcCdc_grayCounter_rdCounter_77_BIT_17_78_XOR_f_ETC___d571 =
	     fcCdc_grayCounter_rdCounter_77_BIT_17_78_XOR_f_ETC___d570 ^
	     fcCdc_grayCounter_rdCounter[1] ;
  assign fcCdc_grayCounter_rsCounter_79_BIT_0_86_XOR_fc_ETC___d520 =
	     z__h27424 ^ fcCdc_grayCounter_rsCounter[17] ;
  assign rdat__h33093 = { 14'd0, fcCdc_frequency } ;
  assign spiCDC_reqF_head_wrapped_crossed__67_EQ_spiCDC_ETC___d446 =
	     spiCDC_reqF_head_wrapped == spiCDC_reqF_tail_wrapped &&
	     !spiCDC_reqF_sInReset$VAL &&
	     spiCDC_cd$PREEDGE ;
  assign spiCDC_reqS_BITS_31_TO_0__q1 = spiCDC_reqS[31:0] ;
  assign wci_wslv_reqF_i_notEmpty__4_AND_IF_wci_wslv_re_ETC___d466 =
	     wci_wslv_reqF$EMPTY_N &&
	     ((wci_wslv_reqF$D_OUT[43:42] == 2'b0) ?
		spiCDC_reqF_head_wrapped_crossed__67_EQ_spiCDC_ETC___d446 :
		wci_wslv_respF_c_r != 2'd2) ;
  assign x__h13865 =
	     spiCDC_reqS_BITS_31_TO_0__q1[_31_MINUS_spiCDC_dPos_28___d519] ;
  assign x__h27299 =
	     18'd1 <<
	     IF_fcCdc_grayCounter_rsCounter_79_BIT_0_86_XOR_ETC___d550 ;
  assign y__h28704 = ~x__h27299 ;
  assign z__h27319 =
	     fcCdc_grayCounter_rsCounter[0] ^ fcCdc_grayCounter_rsCounter[1] ;
  assign z__h27326 = z__h27319 ^ fcCdc_grayCounter_rsCounter[2] ;
  assign z__h27333 = z__h27326 ^ fcCdc_grayCounter_rsCounter[3] ;
  assign z__h27340 = z__h27333 ^ fcCdc_grayCounter_rsCounter[4] ;
  assign z__h27347 = z__h27340 ^ fcCdc_grayCounter_rsCounter[5] ;
  assign z__h27354 = z__h27347 ^ fcCdc_grayCounter_rsCounter[6] ;
  assign z__h27361 = z__h27354 ^ fcCdc_grayCounter_rsCounter[7] ;
  assign z__h27368 = z__h27361 ^ fcCdc_grayCounter_rsCounter[8] ;
  assign z__h27375 = z__h27368 ^ fcCdc_grayCounter_rsCounter[9] ;
  assign z__h27382 = z__h27375 ^ fcCdc_grayCounter_rsCounter[10] ;
  assign z__h27389 = z__h27382 ^ fcCdc_grayCounter_rsCounter[11] ;
  assign z__h27396 = z__h27389 ^ fcCdc_grayCounter_rsCounter[12] ;
  assign z__h27403 = z__h27396 ^ fcCdc_grayCounter_rsCounter[13] ;
  assign z__h27410 = z__h27403 ^ fcCdc_grayCounter_rsCounter[14] ;
  assign z__h27417 = z__h27410 ^ fcCdc_grayCounter_rsCounter[15] ;
  assign z__h27424 = z__h27417 ^ fcCdc_grayCounter_rsCounter[16] ;
  always@(wci_wslv_reqF$D_OUT or rdat__h33093)
  begin
    case (wci_wslv_reqF$D_OUT[43:42])
      2'b0, 2'd3: rdat__h33222 = 32'd0;
      2'b01: rdat__h33222 = 32'hBEEFF00D;
      2'b10: rdat__h33222 = rdat__h33093;
    endcase
  end
  always@(_31_MINUS_spiCDC_dPos_28___d519 or spiCDC_reqS)
  begin
    case (_31_MINUS_spiCDC_dPos_28___d519)
      5'd4:
	  CASE_31_MINUS_spiCDC_dPos_28_19_31_MINUS_spiCD_ETC__q2 =
	      spiCDC_reqS[32];
      5'd5:
	  ...
	  CASE_31_MINUS_spiCDC_dPos_28_19_31_MINUS_spiCD_ETC__q2 =
	      spiCDC_reqS[34];
      default: CASE_31_MINUS_spiCDC_dPos_28_19_31_MINUS_spiCD_ETC__q2 =
		   _31_MINUS_spiCDC_dPos_28___d519 == 5'd7 && spiCDC_reqS[35];
    endcase
  end
  always@(_31_MINUS_spiCDC_dPos_28___d519 or x__h13865 or spiCDC_reqS)
  begin
    case (_31_MINUS_spiCDC_dPos_28___d519)
      5'd0:
	  CASE_31_MINUS_spiCDC_dPos_28_19_x3865_0_spiCDC_ETC__q3 =
	  ...
	  CASE_31_MINUS_spiCDC_dPos_28_19_x3865_0_spiCDC_ETC__q3 =
	      spiCDC_reqS[35];
      default: CASE_31_MINUS_spiCDC_dPos_28_19_x3865_0_spiCDC_ETC__q3 =
		   x__h13865;
    endcase
  end
