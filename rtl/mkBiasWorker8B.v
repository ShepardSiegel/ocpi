...
//
// On Wed Oct 30 08:48:20 EDT 2013
//
//
// Ports:
// Name                         I/O  size props
...
module mkBiasWorker8B(wciS0_Clk,
  ...
  assign rdat__h11161 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h11175 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h11183 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h11189 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h11203 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h11211 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign wci_wslv_respF_cntr_r_8_MINUS_1___d27 =
	     wci_wslv_respF_cntr_r - 2'd1 ;
  assign x__h11065 = { wsiS_statusR, wsiM_statusR } ;
  assign x_data__h10099 =
	     { wsiS_reqFifo$D_OUT[79:48] + biasValue,
	       wsiS_reqFifo$D_OUT[47:16] + biasValue } ;
