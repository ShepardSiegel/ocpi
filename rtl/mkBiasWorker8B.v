...
//
// On Fri Nov 12 16:23:24 EST 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkBiasWorker8B(wciS0_Clk,
  ...
  assign MUX_wsiM_reqFifo_q_0$write_1__VAL_2 =
	     { wsiS_reqFifo$D_OUT[96:80],
	       x_data__h9506,
	       wsiS_reqFifo$D_OUT[15:0] } ;
  ...
  assign x_data__h9506 = wsiS_reqFifo$D_OUT[79:16] + { 32'd0, biasValue } ;
