...
//
// On Wed Jan  5 11:18:47 EST 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkDramServer(CLK_sys0_clk,
  ...
  reg [63 : 0] v__h18227, v__h3568, v__h3742, v__h3886;
  reg [31 : 0] CASE_wci_reqFD_OUT_BITS_39_TO_32_0_0x0_dramSt_ETC__q1,
	       g_data__h14047,
	       x__h5398,
	       x__h5620;
  reg CASE_x870_NOT_x870_EQ_0b11_OR_memc_respFFULL__ETC__q2;
  wire [175 : 0] IF_wci_reqF_first__4_BIT_51_26_THEN_pReg_50_BI_ETC___d477;
  wire [127 : 0] x1_data__h15278, x1_data__h16271;
  wire [31 : 0] dramStatus__h12689,
		g_data__h17771,
		myBE__h5435,
		myBE__h5468,
		rdat___1__h17834,
		...
		rdat___1__h17992,
		x1_addr__h16269;
  wire [15 : 0] x1_be__h16270, x__h17811;
  wire [2 : 0] x__h5870;
  ...
  assign MUX_wci_respF_q_1$write_1__VAL_1 =
	     (wci_respF_c_r == 2'd2) ?
	       MUX_wci_respF_q_0$write_1__VAL_2 :
	       34'h0AAAAAAAA ;
  assign MUX_wci_respF_x_wire$wset_1__VAL_1 = { 2'd1, g_data__h14047 } ;
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, g_data__h17771 } ;
  ...
  assign memc_memc$app_wdf_mask =
	     WILL_FIRE_RL_memc_advance_write0 ? ~x__h5398 : ~x__h5620 ;
  ...
  // submodule memc_respF
  always@(x__h5870 or memc_memc$app_rd_data)
  begin
    case (x__h5870)
  ...
  assign memc_respF$ENQ =
	     WILL_FIRE_RL_memc_advance_readData &&
	     (x__h5870 == 3'b0 || x__h5870 == 3'b101 || x__h5870 == 3'b110 ||
	      x__h5870 == 3'b011) ;
  ...
  assign IF_memc_memc_app_rd_data_end__94_CONCAT_memc_r_ETC___d210 =
	     CASE_x870_NOT_x870_EQ_0b11_OR_memc_respFFULL__ETC__q2 &&
  ...
  assign IF_wci_reqF_first__4_BIT_51_26_THEN_pReg_50_BI_ETC___d477 =
	     wci_reqF$D_OUT[51] ?
	       { x1_addr__h16269, x1_be__h16270, x1_data__h16271 } :
	       { wci_reqF$D_OUT[31:0], mReg, x1_data__h15278 } ;
  ...
  assign dbg_rdlvl_done_RDY_write__01_AND_dbg_rdlvl_err_ETC___d325 =
	     ...
	     dbg_rd_clkdly_cnt_RDY_write__07_AND_dbg_rd_act_ETC___d319 ;
  assign dramStatus__h12689 = { 16'd0, x__h17811 } ;
  assign g_data__h17771 =
	     wci_reqF$D_OUT[51] ?
	       32'd0 :
  ...
  assign myBE__h5435 = { 16'h0, memc_reqF$D_OUT[143:128] } ;
  assign myBE__h5468 = { memc_reqF$D_OUT[143:128], 16'h0 } ;
  assign rdat___1__h17834 = { 24'd0, dbg_wl_dqs_inverted$dD_OUT } ;
  assign rdat___1__h17843 = { 16'd0, dbg_wr_calib_clk_delay$dD_OUT } ;
  assign rdat___1__h17870 = { 30'd0, dbg_rdlvl_done$dD_OUT } ;
  assign rdat___1__h17879 = { 30'd0, dbg_rdlvl_err$dD_OUT } ;
  assign rdat___1__h17915 = { 8'd0, dbg_rd_bitslip_cnt$dD_OUT } ;
  assign rdat___1__h17924 = { 16'd0, dbg_rd_clkdly_cnt$dD_OUT } ;
  assign rdat___1__h17933 = { 27'd0, dbg_rd_active_dly$dD_OUT } ;
  assign rdat___1__h17975 = { 16'd0, requestCount$dD_OUT } ;
  assign rdat___1__h17984 = { 16'd0, pReg } ;
  assign rdat___1__h17992 = { 16'd0, mReg } ;
  ...
  assign x1_addr__h16269 = { pReg[12:0], wci_reqF$D_OUT[50:36], 4'd0 } ;
  assign x1_be__h16270 =
  ...
  assign x1_data__h15278 = { wdReg_3, wdReg_2, wdReg_1, wdReg } ;
  assign x1_data__h16271 = {4{wci_reqF$D_OUT[31:0]}} ;
  assign x__h17811 =
	     { respCount,
	       2'h0,
	       memIsResetCC$dD_OUT,
	       ...
	       firBeat$dD_OUT,
	       initComplete$dD_OUT } ;
  assign x__h5870 = { memc_memc$app_rd_data_end, memc_rdpF$D_OUT } ;
  always@(splaF$D_OUT or lrespF$dD_OUT)
  begin
    case (splaF$D_OUT)
      2'd0: g_data__h14047 = lrespF$dD_OUT[31:0];
      2'd1: g_data__h14047 = lrespF$dD_OUT[63:32];
      2'd2: g_data__h14047 = lrespF$dD_OUT[95:64];
      2'd3: g_data__h14047 = lrespF$dD_OUT[127:96];
    endcase
  end
  always@(wci_reqF$D_OUT or
	  dramStatus__h12689 or
	  dramCtrl or
	  rdat___1__h17834 or
	  rdat___1__h17843 or
  ...
  always@(memc_reqF$D_OUT or myBE__h5435 or myBE__h5468)
  begin
    case (memc_reqF$D_OUT[149:148])
      2'b0: x__h5398 = myBE__h5435;
      2'b01: x__h5398 = myBE__h5468;
      default: x__h5398 = 32'd0;
    endcase
  end
  always@(memc_reqF$D_OUT or myBE__h5435 or myBE__h5468)
  begin
    case (memc_reqF$D_OUT[149:148])
      2'b10: x__h5620 = myBE__h5435;
      2'b11: x__h5620 = myBE__h5468;
      default: x__h5620 = 32'd0;
    endcase
  end
  always@(x__h5870 or memc_respF$FULL_N)
  begin
    case (x__h5870)
      3'b0, 3'b101, 3'b110:
	  CASE_x870_NOT_x870_EQ_0b11_OR_memc_respFFULL__ETC__q2 =
	      memc_respF$FULL_N;
      default: CASE_x870_NOT_x870_EQ_0b11_OR_memc_respFFULL__ETC__q2 =
		   x__h5870 != 3'b011 || memc_respF$FULL_N;
    endcase
  end
