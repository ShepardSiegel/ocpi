...
//
// On Tue Sep 28 13:58:33 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDramServer(CLK_sys0_clk,
  ...
  wire wmemi_dhF$CLR, wmemi_dhF$DEQ, wmemi_dhF$ENQ, wmemi_dhF$FULL_N;
  ...
  wire wmemi_reqF$CLR, wmemi_reqF$DEQ, wmemi_reqF$ENQ, wmemi_reqF$FULL_N;
  ...
  reg [63 : 0] v__h12336, v__h2639, v__h2786, v__h3685;
  reg [31 : 0] CASE_wci_reqFD_OUT_BITS_39_TO_32_0_0x0_dramSt_ETC__q1,
	       x__h5431,
	       x__h5676,
	       x_data__h16971;
  reg CASE_x958_NOT_x958_EQ_0b11_OR_memc_respFFULL__ETC__q2;
  wire [175 : 0] IF_wci_reqF_first__3_BIT_51_4_THEN_pReg_5_BITS_ETC___d216;
  wire [127 : 0] x1_data__h14193, x1_data__h15163;
  wire [31 : 0] dramStatus__h12209,
		myBE__h5464,
		myBE__h5492,
		rdat___1__h12732,
		rdat___1__h12741,
		...
		x1_addr__h12523,
		x_data__h12675;
  wire [15 : 0] x1_be__h15162, x__h12709;
  wire [2 : 0] x__h4958;
  wire IF_memc_memc_app_rd_data_end__89_CONCAT_memc_r_ETC___d405,
  ...
  assign CAN_FIRE_RL_memc_advance_readData =
	     memc_rdpF$EMPTY_N &&
	     IF_memc_memc_app_rd_data_end__89_CONCAT_memc_r_ETC___d405 &&
	     memc_memc$phy_init_done &&
	     memc_memc$app_rd_data_valid ;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_1 = { 2'd1, x_data__h16971 } ;
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, x_data__h12675 } ;
  ...
  assign memc_memc$app_wdf_mask =
	     WILL_FIRE_RL_memc_advance_write1 ? ~x__h5431 : ~x__h5676 ;
  ...
  // submodule memc_respF
  always@(x__h4958 or memc_memc$app_rd_data)
  begin
    case (x__h4958)
  ...
  assign memc_respF$ENQ =
	     WILL_FIRE_RL_memc_advance_readData &&
	     (x__h4958 == 3'b0 || x__h4958 == 3'b101 || x__h4958 == 3'b110 ||
	      x__h4958 == 3'b011) ;
  ...
  // remaining internal signals
  assign IF_memc_memc_app_rd_data_end__89_CONCAT_memc_r_ETC___d405 =
	     CASE_x958_NOT_x958_EQ_0b11_OR_memc_respFFULL__ETC__q2 &&
  ...
  assign IF_wci_reqF_first__3_BIT_51_4_THEN_pReg_5_BITS_ETC___d216 =
	     wci_reqF$D_OUT[51] ?
	       { x1_addr__h12523, x1_be__h15162, x1_data__h15163 } :
	       { wci_reqF$D_OUT[31:0], mReg, x1_data__h14193 } ;
  ...
  assign dbg_rdlvl_done_RDY_write__73_AND_dbg_rdlvl_err_ETC___d297 =
	     ...
	     dbg_rd_clkdly_cnt_RDY_write__79_AND_dbg_rd_act_ETC___d291 ;
  assign dramStatus__h12209 = { 16'd0, x__h12709 } ;
  assign lrespF_RDY_deq__31_AND_NOT_splitReadInFlight_3_ETC___d239 =
	     lrespF$dEMPTY_N &&
	     (!splitReadInFlight || splaF$EMPTY_N && wci_respF_c_r != 2'd2) ;
  assign myBE__h5464 = { 16'h0, memc_reqF$D_OUT[143:128] } ;
  assign myBE__h5492 = { memc_reqF$D_OUT[143:128], 16'h0 } ;
  assign rdat___1__h12732 = { 24'd0, dbg_wl_dqs_inverted$dD_OUT } ;
  assign rdat___1__h12741 = { 16'd0, dbg_wr_calib_clk_delay$dD_OUT } ;
  assign rdat___1__h12768 = { 30'd0, dbg_rdlvl_done$dD_OUT } ;
  assign rdat___1__h12777 = { 30'd0, dbg_rdlvl_err$dD_OUT } ;
  assign rdat___1__h12813 = { 8'd0, dbg_rd_bitslip_cnt$dD_OUT } ;
  assign rdat___1__h12822 = { 16'd0, dbg_rd_clkdly_cnt$dD_OUT } ;
  assign rdat___1__h12831 = { 27'd0, dbg_rd_active_dly$dD_OUT } ;
  assign rdat___1__h12873 = { 16'd0, requestCount$dD_OUT } ;
  assign rdat___1__h12882 = { 16'd0, pReg } ;
  assign rdat___1__h12890 = { 16'd0, mReg } ;
  assign x1_addr__h12523 = { pReg[12:0], wci_reqF$D_OUT[50:36], 4'd0 } ;
  assign x1_be__h15162 =
  ...
  assign x1_data__h14193 = { wdReg_3, wdReg_2, wdReg_1, wdReg } ;
  assign x1_data__h15163 = {4{wci_reqF$D_OUT[31:0]}} ;
  assign x__h12709 =
	     { respCount,
	       2'h0,
	       memIsResetCC$dD_OUT,
	       ...
	       firBeat$dD_OUT,
	       initComplete$dD_OUT } ;
  assign x__h4958 = { memc_memc$app_rd_data_end, memc_rdpF$D_OUT } ;
  assign x_data__h12675 =
	     wci_reqF$D_OUT[51] ?
	       32'd0 :
  ...
  begin
    case (splaF$D_OUT)
      2'd0: x_data__h16971 = lrespF$dD_OUT[31:0];
      2'd1: x_data__h16971 = lrespF$dD_OUT[63:32];
      2'd2: x_data__h16971 = lrespF$dD_OUT[95:64];
      2'd3: x_data__h16971 = lrespF$dD_OUT[127:96];
    endcase
  end
  always@(wci_reqF$D_OUT or
	  dramStatus__h12209 or
	  dramCtrl or
	  rdat___1__h12732 or
	  rdat___1__h12741 or
  ...
  always@(memc_reqF$D_OUT or myBE__h5464 or myBE__h5492)
  begin
    case (memc_reqF$D_OUT[149:148])
      2'b10: x__h5431 = myBE__h5464;
      2'b11: x__h5431 = myBE__h5492;
      default: x__h5431 = 32'd0;
    endcase
  end
  always@(memc_reqF$D_OUT or myBE__h5464 or myBE__h5492)
  begin
    case (memc_reqF$D_OUT[149:148])
      2'b0: x__h5676 = myBE__h5464;
      2'b01: x__h5676 = myBE__h5492;
      default: x__h5676 = 32'd0;
    endcase
  end
  always@(x__h4958 or memc_respF$FULL_N)
  begin
    case (x__h4958)
      3'b0, 3'b101, 3'b110:
	  CASE_x958_NOT_x958_EQ_0b11_OR_memc_respFFULL__ETC__q2 =
	      memc_respF$FULL_N;
      default: CASE_x958_NOT_x958_EQ_0b11_OR_memc_respFFULL__ETC__q2 =
		   x__h4958 != 3'b011 || memc_respF$FULL_N;
    endcase
  end
