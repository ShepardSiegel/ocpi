...
//
// On Sat Jan  8 10:59:53 EST 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkDramServer(CLK_sys0_clk,
  ...
  wire [7 : 0] dram_dm;
  wire [2 : 0] dram_ba;
  wire [1 : 0] wci_s_SFlag, wci_s_SResp, wmemiS_SResp;
  wire dram_cas_n,
       dram_ck_n,
       dram_ck_p,
       dram_cke,
  ...
  wire IF_memc_memc_app_rd_data_end__11_CONCAT_memc_r_ETC___d227,
       ...
       NOT_wci_wslv_respF_c_r_2_EQ_2_1_2_AND_IF_wci_w_ETC___d455,
  ...
  assign NOT_wci_wslv_respF_c_r_2_EQ_2_1_2_AND_IF_wci_w_ETC___d455 =
	     wci_wslv_respF_c_r != 2'd2 &&
	     (wci_wslv_reqF$D_OUT[51] ?
		lreqF$sFULL_N :
		((wci_wslv_reqF$D_OUT[39:32] == 8'h54) ?
