...
//
// On Thu Dec 16 18:38:00 EST 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDramServer(CLK_sys0_clk,
  ...
  wire [130 : 0] MUX_wmemi_respF_q_0$write_1__VAL_1,
		 ...
		 MUX_wmemi_respF_q_1$write_1__VAL_1;
  ...
  reg [63 : 0] v__h18273, v__h3568, v__h3753, v__h3908;
  reg [31 : 0] CASE_wci_reqFD_OUT_BITS_39_TO_32_0_0x0_dramSt_ETC__q1,
	       x__h5420,
	       x__h5642,
	       x_data__h14071;
  reg CASE_x892_NOT_x892_EQ_0b11_OR_memc_respFFULL__ETC__q2;
  wire [175 : 0] IF_wci_reqF_first__4_BIT_51_26_THEN_pReg_50_BI_ETC___d477;
  wire [127 : 0] x1_data__h15308, x1_data__h16301;
  wire [31 : 0] dramStatus__h12711,
		myBE__h5457,
		myBE__h5490,
		rdat___1__h17880,
		rdat___1__h17889,
		...
		x1_addr__h16299,
		x_data__h17811;
  wire [15 : 0] x1_be__h16300, x__h17857;
  wire [2 : 0] x__h5892;
  wire IF_memc_memc_app_rd_data_end__94_CONCAT_memc_r_ETC___d210,
       IF_wci_reqF_first__4_BIT_51_26_THEN_lreqF_RDY__ETC___d502,
       dbg_rd_clkdly_cnt_RDY_write__07_AND_dbg_rd_act_ETC___d319,
       dbg_rdlvl_done_RDY_write__01_AND_dbg_rdlvl_err_ETC___d325,
       lrespF_RDY_deq__87_AND_NOT_splitReadInFlight_9_ETC___d405,
       wci_reqF_i_notEmpty__3_AND_IF_wci_reqF_first___ETC___d438,
       wmemi_operateD_58_AND_wmemi_peerIsReady_59_60__ETC___d365;
  ...
  // submodule wmemi_dhF
  FIFO2 #(.width(32'd146), .guarded(32'd1)) wmemi_dhF(.RST_N(RST_N),
						      .CLK(CLK),
						      .D_IN(wmemi_dhF$D_IN),
						      .ENQ(wmemi_dhF$ENQ),
						      .DEQ(wmemi_dhF$DEQ),
  ...
  FIFO2 #(.width(32'd52), .guarded(32'd1)) wmemi_reqF(.RST_N(RST_N),
						      .CLK(CLK),
  ...
  assign CAN_FIRE_RL_memc_advance_readData =
	     memc_rdpF$EMPTY_N &&
	     IF_memc_memc_app_rd_data_end__94_CONCAT_memc_r_ETC___d210 &&
	     memc_memc$phy_init_done &&
	     memc_memc$app_rd_data_valid ;
  ...
  assign MUX_lreqF$enq_1__VAL_1 =
	     { !wci_reqF$D_OUT[51] && wci_reqF$D_OUT[39:32] != 8'h54,
	       IF_wci_reqF_first__4_BIT_51_26_THEN_pReg_50_BI_ETC___d477 } ;
  ...
  assign MUX_wci_respF_q_1$write_1__VAL_1 =
	     (wci_respF_c_r == 2'd2) ?
	       MUX_wci_respF_q_0$write_1__VAL_2 :
	       34'h0AAAAAAAA ;
  assign MUX_wci_respF_x_wire$wset_1__VAL_1 = { 2'd1, x_data__h14071 } ;
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, x_data__h17811 } ;
  ...
  assign MUX_wmemi_respF_q_0$write_1__VAL_1 =
	     (wmemi_respF_c_r == 2'd1) ?
	       MUX_wmemi_respF_q_0$write_1__VAL_2 :
	       wmemi_respF_q_1 ;
  assign MUX_wmemi_respF_q_0$write_1__VAL_2 = { 3'd3, lrespF$dD_OUT } ;
  assign MUX_wmemi_respF_q_1$write_1__VAL_1 =
  ...
  assign wmemi_respF_x_wire$wget = MUX_wmemi_respF_q_0$write_1__VAL_2 ;
  ...
  // register wmemi_respF_q_0
  always@(WILL_FIRE_RL_wmemi_respF_both or
  ...
  // register wmemi_respF_q_1
  always@(WILL_FIRE_RL_wmemi_respF_both or
	  MUX_wmemi_respF_q_1$write_1__VAL_1 or
  ...
  begin
    case (1'b1) // synopsys parallel_case
      WILL_FIRE_RL_wmemi_respF_both:
	  wmemi_respF_q_1$D_IN = MUX_wmemi_respF_q_1$write_1__VAL_1;
      MUX_wmemi_respF_q_1$write_1__SEL_2:
	  wmemi_respF_q_1$D_IN = MUX_wmemi_respF_q_0$write_1__VAL_2;
      WILL_FIRE_RL_wmemi_respF_decCtr:
  ...
  assign memc_memc$app_wdf_mask =
	     WILL_FIRE_RL_memc_advance_write0 ? ~x__h5420 : ~x__h5642 ;
  ...
  // submodule memc_respF
  always@(x__h5892 or memc_memc$app_rd_data)
  begin
    case (x__h5892)
  ...
  assign memc_respF$ENQ =
	     WILL_FIRE_RL_memc_advance_readData &&
	     (x__h5892 == 3'b0 || x__h5892 == 3'b101 || x__h5892 == 3'b110 ||
	      x__h5892 == 3'b011) ;
  ...
  // remaining internal signals
  assign IF_memc_memc_app_rd_data_end__94_CONCAT_memc_r_ETC___d210 =
	     CASE_x892_NOT_x892_EQ_0b11_OR_memc_respFFULL__ETC__q2 &&
	     (!memc_memc$app_rd_data_end || memc_rdpF$EMPTY_N) ;
  assign IF_wci_reqF_first__4_BIT_51_26_THEN_lreqF_RDY__ETC___d502 =
	     wci_reqF$D_OUT[51] ?
	       lreqF$sFULL_N && splaF$FULL_N :
	       wci_respF_c_r != 2'd2 ;
  assign IF_wci_reqF_first__4_BIT_51_26_THEN_pReg_50_BI_ETC___d477 =
	     wci_reqF$D_OUT[51] ?
	       { x1_addr__h16299, x1_be__h16300, x1_data__h16301 } :
	       { wci_reqF$D_OUT[31:0], mReg, x1_data__h15308 } ;
  assign dbg_rd_clkdly_cnt_RDY_write__07_AND_dbg_rd_act_ETC___d319 =
	     ...
	     dbg_rddata$sRDY &&
	     requestCount$sRDY ;
  assign dbg_rdlvl_done_RDY_write__01_AND_dbg_rdlvl_err_ETC___d325 =
	     ...
	     dbg_rd_clkdly_cnt_RDY_write__07_AND_dbg_rd_act_ETC___d319 ;
  assign dramStatus__h12711 = { 16'd0, x__h17857 } ;
  assign lrespF_RDY_deq__87_AND_NOT_splitReadInFlight_9_ETC___d405 =
	     lrespF$dEMPTY_N &&
	     (!splitReadInFlight || splaF$EMPTY_N && wci_respF_c_r != 2'd2) ;
  assign myBE__h5457 = { 16'h0, memc_reqF$D_OUT[143:128] } ;
  assign myBE__h5490 = { memc_reqF$D_OUT[143:128], 16'h0 } ;
  assign rdat___1__h17880 = { 24'd0, dbg_wl_dqs_inverted$dD_OUT } ;
  assign rdat___1__h17889 = { 16'd0, dbg_wr_calib_clk_delay$dD_OUT } ;
  assign rdat___1__h17916 = { 30'd0, dbg_rdlvl_done$dD_OUT } ;
  assign rdat___1__h17925 = { 30'd0, dbg_rdlvl_err$dD_OUT } ;
  assign rdat___1__h17961 = { 8'd0, dbg_rd_bitslip_cnt$dD_OUT } ;
  assign rdat___1__h17970 = { 16'd0, dbg_rd_clkdly_cnt$dD_OUT } ;
  assign rdat___1__h17979 = { 27'd0, dbg_rd_active_dly$dD_OUT } ;
  assign rdat___1__h18021 = { 16'd0, requestCount$dD_OUT } ;
  assign rdat___1__h18030 = { 16'd0, pReg } ;
  assign rdat___1__h18038 = { 16'd0, mReg } ;
  assign wci_reqF_i_notEmpty__3_AND_IF_wci_reqF_first___ETC___d438 =
	     wci_reqF$EMPTY_N &&
	     (wci_reqF$D_OUT[51] ?
		lreqF$sFULL_N :
  ...
  assign wmemi_operateD_58_AND_wmemi_peerIsReady_59_60__ETC___d365 =
	     wmemi_operateD && wmemi_peerIsReady && wmemi_reqF$EMPTY_N &&
	     (wmemi_reqF$D_OUT[51:49] != 3'd1 || wmemi_dhF$EMPTY_N) ;
  assign x1_addr__h16299 = { pReg[12:0], wci_reqF$D_OUT[50:36], 4'd0 } ;
  assign x1_be__h16300 =
  ...
  assign x1_data__h15308 = { wdReg_3, wdReg_2, wdReg_1, wdReg } ;
  assign x1_data__h16301 = {4{wci_reqF$D_OUT[31:0]}} ;
  assign x__h17857 =
	     { respCount,
	       2'h0,
	       memIsResetCC$dD_OUT,
	       ...
	       firBeat$dD_OUT,
	       initComplete$dD_OUT } ;
  assign x__h5892 = { memc_memc$app_rd_data_end, memc_rdpF$D_OUT } ;
  assign x_data__h17811 =
	     wci_reqF$D_OUT[51] ?
	       32'd0 :
  ...
  begin
    case (splaF$D_OUT)
      2'd0: x_data__h14071 = lrespF$dD_OUT[31:0];
      2'd1: x_data__h14071 = lrespF$dD_OUT[63:32];
      2'd2: x_data__h14071 = lrespF$dD_OUT[95:64];
      2'd3: x_data__h14071 = lrespF$dD_OUT[127:96];
    endcase
  end
  always@(wci_reqF$D_OUT or
	  dramStatus__h12711 or
	  dramCtrl or
	  rdat___1__h17880 or
	  rdat___1__h17889 or
  ...
  always@(memc_reqF$D_OUT or myBE__h5457 or myBE__h5490)
  begin
    case (memc_reqF$D_OUT[149:148])
      2'b0: x__h5420 = myBE__h5457;
      2'b01: x__h5420 = myBE__h5490;
      default: x__h5420 = 32'd0;
    endcase
  end
  always@(memc_reqF$D_OUT or myBE__h5457 or myBE__h5490)
  begin
    case (memc_reqF$D_OUT[149:148])
      2'b10: x__h5642 = myBE__h5457;
      2'b11: x__h5642 = myBE__h5490;
      default: x__h5642 = 32'd0;
    endcase
  end
  always@(x__h5892 or memc_respF$FULL_N)
  begin
    case (x__h5892)
      3'b0, 3'b101, 3'b110:
	  CASE_x892_NOT_x892_EQ_0b11_OR_memc_respFFULL__ETC__q2 =
	      memc_respF$FULL_N;
      default: CASE_x892_NOT_x892_EQ_0b11_OR_memc_respFFULL__ETC__q2 =
		   x__h5892 != 3'b011 || memc_respF$FULL_N;
    endcase
  end
