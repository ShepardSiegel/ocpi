...
//
// On Mon Nov  8 07:13:39 EST 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDramServer(CLK_sys0_clk,
  ...
  reg [63 : 0] v__h13316, v__h2664, v__h2822, v__h3721;
  reg [31 : 0] CASE_wci_reqFD_OUT_BITS_39_TO_32_0_0x0_dramSt_ETC__q1,
	       x__h5467,
	       x__h5712,
	       x_data__h17962;
  reg CASE_x994_NOT_x994_EQ_0b11_OR_memc_respFFULL__ETC__q2;
  wire [175 : 0] IF_wci_reqF_first__3_BIT_51_4_THEN_pReg_5_BITS_ETC___d216;
  wire [127 : 0] x1_data__h15175, x1_data__h16145;
  wire [31 : 0] dramStatus__h12674,
		myBE__h5500,
		myBE__h5528,
		rdat___1__h13716,
		rdat___1__h13725,
		...
		x1_addr__h13499,
		x_data__h13653;
  wire [15 : 0] x1_be__h16144, x__h13693;
  wire [2 : 0] x__h4994;
  wire IF_memc_memc_app_rd_data_end__35_CONCAT_memc_r_ETC___d451,
       IF_wci_reqF_first__3_BIT_51_4_THEN_lreqF_RDY_e_ETC___d51,
       dbg_rd_clkdly_cnt_RDY_write__23_AND_dbg_rd_act_ETC___d335,
       dbg_rdlvl_done_RDY_write__17_AND_dbg_rdlvl_err_ETC___d341,
       lrespF_RDY_deq__31_AND_NOT_splitReadInFlight_3_ETC___d239,
       wci_reqF_i_notEmpty__2_AND_IF_wci_reqF_first___ETC___d187,
       wmemi_operateD_65_AND_wmemi_peerIsReady_66_67__ETC___d285;
  ...
  assign CAN_FIRE_RL_memc_advance_readData =
	     memc_rdpF$EMPTY_N &&
	     IF_memc_memc_app_rd_data_end__35_CONCAT_memc_r_ETC___d451 &&
	     memc_memc$phy_init_done &&
	     memc_memc$app_rd_data_valid ;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_1 = { 2'd1, x_data__h17962 } ;
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, x_data__h13653 } ;
  ...
  assign memc_memc$app_wdf_mask =
	     WILL_FIRE_RL_memc_advance_write1 ? ~x__h5467 : ~x__h5712 ;
  ...
  // submodule memc_respF
  always@(x__h4994 or memc_memc$app_rd_data)
  begin
    case (x__h4994)
  ...
  assign memc_respF$ENQ =
	     WILL_FIRE_RL_memc_advance_readData &&
	     (x__h4994 == 3'b0 || x__h4994 == 3'b101 || x__h4994 == 3'b110 ||
	      x__h4994 == 3'b011) ;
  ...
  // remaining internal signals
  assign IF_memc_memc_app_rd_data_end__35_CONCAT_memc_r_ETC___d451 =
	     CASE_x994_NOT_x994_EQ_0b11_OR_memc_respFFULL__ETC__q2 &&
  ...
  assign IF_wci_reqF_first__3_BIT_51_4_THEN_pReg_5_BITS_ETC___d216 =
	     wci_reqF$D_OUT[51] ?
	       { x1_addr__h13499, x1_be__h16144, x1_data__h16145 } :
	       { wci_reqF$D_OUT[31:0], mReg, x1_data__h15175 } ;
  assign dbg_rd_clkdly_cnt_RDY_write__23_AND_dbg_rd_act_ETC___d335 =
	     ...
	     dbg_rddata$sRDY &&
	     requestCount$sRDY ;
  assign dbg_rdlvl_done_RDY_write__17_AND_dbg_rdlvl_err_ETC___d341 =
	     ...
	     dbg_rd_clkdly_cnt_RDY_write__23_AND_dbg_rd_act_ETC___d335 ;
  assign dramStatus__h12674 = { 16'd0, x__h13693 } ;
  assign lrespF_RDY_deq__31_AND_NOT_splitReadInFlight_3_ETC___d239 =
	     lrespF$dEMPTY_N &&
	     (!splitReadInFlight || splaF$EMPTY_N && wci_respF_c_r != 2'd2) ;
  assign myBE__h5500 = { 16'h0, memc_reqF$D_OUT[143:128] } ;
  assign myBE__h5528 = { memc_reqF$D_OUT[143:128], 16'h0 } ;
  assign rdat___1__h13716 = { 24'd0, dbg_wl_dqs_inverted$dD_OUT } ;
  assign rdat___1__h13725 = { 16'd0, dbg_wr_calib_clk_delay$dD_OUT } ;
  assign rdat___1__h13752 = { 30'd0, dbg_rdlvl_done$dD_OUT } ;
  assign rdat___1__h13761 = { 30'd0, dbg_rdlvl_err$dD_OUT } ;
  assign rdat___1__h13797 = { 8'd0, dbg_rd_bitslip_cnt$dD_OUT } ;
  assign rdat___1__h13806 = { 16'd0, dbg_rd_clkdly_cnt$dD_OUT } ;
  assign rdat___1__h13815 = { 27'd0, dbg_rd_active_dly$dD_OUT } ;
  assign rdat___1__h13857 = { 16'd0, requestCount$dD_OUT } ;
  assign rdat___1__h13866 = { 16'd0, pReg } ;
  assign rdat___1__h13874 = { 16'd0, mReg } ;
  ...
  assign wmemi_operateD_65_AND_wmemi_peerIsReady_66_67__ETC___d285 =
	     wmemi_operateD && wmemi_peerIsReady && wmemi_reqF$EMPTY_N &&
	     (wmemi_reqF$D_OUT[51:49] != 3'd1 || wmemi_dhF$EMPTY_N) ;
  assign x1_addr__h13499 = { pReg[12:0], wci_reqF$D_OUT[50:36], 4'd0 } ;
  assign x1_be__h16144 =
  ...
  assign x1_data__h15175 = { wdReg_3, wdReg_2, wdReg_1, wdReg } ;
  assign x1_data__h16145 = {4{wci_reqF$D_OUT[31:0]}} ;
  assign x__h13693 =
	     { respCount,
	       2'h0,
	       memIsResetCC$dD_OUT,
	       ...
	       firBeat$dD_OUT,
	       initComplete$dD_OUT } ;
  assign x__h4994 = { memc_memc$app_rd_data_end, memc_rdpF$D_OUT } ;
  assign x_data__h13653 =
	     wci_reqF$D_OUT[51] ?
	       32'd0 :
  ...
  begin
    case (splaF$D_OUT)
      2'd0: x_data__h17962 = lrespF$dD_OUT[31:0];
      2'd1: x_data__h17962 = lrespF$dD_OUT[63:32];
      2'd2: x_data__h17962 = lrespF$dD_OUT[95:64];
      2'd3: x_data__h17962 = lrespF$dD_OUT[127:96];
    endcase
  end
  always@(wci_reqF$D_OUT or
	  dramStatus__h12674 or
	  dramCtrl or
	  rdat___1__h13716 or
	  rdat___1__h13725 or
  ...
  always@(memc_reqF$D_OUT or myBE__h5500 or myBE__h5528)
  begin
    case (memc_reqF$D_OUT[149:148])
      2'b10: x__h5467 = myBE__h5500;
      2'b11: x__h5467 = myBE__h5528;
      default: x__h5467 = 32'd0;
    endcase
  end
  always@(memc_reqF$D_OUT or myBE__h5500 or myBE__h5528)
  begin
    case (memc_reqF$D_OUT[149:148])
      2'b0: x__h5712 = myBE__h5500;
      2'b01: x__h5712 = myBE__h5528;
      default: x__h5712 = 32'd0;
    endcase
  end
  always@(x__h4994 or memc_respF$FULL_N)
  begin
    case (x__h4994)
      3'b0, 3'b101, 3'b110:
	  CASE_x994_NOT_x994_EQ_0b11_OR_memc_respFFULL__ETC__q2 =
	      memc_respF$FULL_N;
      default: CASE_x994_NOT_x994_EQ_0b11_OR_memc_respFFULL__ETC__q2 =
		   x__h4994 != 3'b011 || memc_respF$FULL_N;
    endcase
  end
