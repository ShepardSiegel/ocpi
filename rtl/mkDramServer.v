...
//
// On Fri Jul 30 17:15:07 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDramServer(CLK_sys0_clk,
  ...
  reg [63 : 0] v__h12334, v__h2639, v__h2786, v__h3685;
  ...
  wire [127 : 0] x1_data__h14191, x1_data__h15161;
  wire [31 : 0] dramStatus__h12207,
		myBE__h5462,
		myBE__h5490,
		rdat___1__h12730,
		rdat___1__h12739,
		...
		x1_addr__h12521,
		x_data__h12673;
  wire [15 : 0] x1_be__h15160, x__h12707;
  wire [2 : 0] x__h4956;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_1 = { 2'd1, x_data__h16969 } ;
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, x_data__h12673 } ;
  ...
  assign IF_wci_reqF_first__3_BIT_51_4_THEN_pReg_5_BITS_ETC___d216 =
	     wci_reqF$D_OUT[51] ?
	       { x1_addr__h12521, x1_be__h15160, x1_data__h15161 } :
	       { wci_reqF$D_OUT[31:0], mReg, x1_data__h14191 } ;
  ...
  assign dbg_rdlvl_done_RDY_write__73_AND_dbg_rdlvl_err_ETC___d297 =
	     ...
	     dbg_rd_clkdly_cnt_RDY_write__79_AND_dbg_rd_act_ETC___d291 ;
  assign dramStatus__h12207 = { 16'd0, x__h12707 } ;
  ...
  assign rdat___1__h12730 = { 24'd0, dbg_wl_dqs_inverted$dD_OUT } ;
  assign rdat___1__h12739 = { 16'd0, dbg_wr_calib_clk_delay$dD_OUT } ;
  assign rdat___1__h12766 = { 30'd0, dbg_rdlvl_done$dD_OUT } ;
  assign rdat___1__h12775 = { 30'd0, dbg_rdlvl_err$dD_OUT } ;
  assign rdat___1__h12811 = { 8'd0, dbg_rd_bitslip_cnt$dD_OUT } ;
  assign rdat___1__h12820 = { 16'd0, dbg_rd_clkdly_cnt$dD_OUT } ;
  assign rdat___1__h12829 = { 27'd0, dbg_rd_active_dly$dD_OUT } ;
  assign rdat___1__h12871 = { 16'd0, requestCount$dD_OUT } ;
  assign rdat___1__h12880 = { 16'd0, pReg } ;
  assign rdat___1__h12888 = { 16'd0, mReg } ;
  assign x1_addr__h12521 = { pReg[12:0], wci_reqF$D_OUT[50:36], 4'd0 } ;
  assign x1_be__h15160 =
  ...
  assign x1_data__h14191 = { wdReg_3, wdReg_2, wdReg_1, wdReg } ;
  assign x1_data__h15161 = {4{wci_reqF$D_OUT[31:0]}} ;
  assign x__h12707 =
	     { respCount,
	       2'h0,
	       memIsResetCC$dD_OUT,
  ...
  begin
    case (splaF$D_OUT)
      2'd0: x_data__h16969 = lrespF$dD_OUT[31:0];
      2'd1: x_data__h16969 = lrespF$dD_OUT[63:32];
      2'd2: x_data__h16969 = lrespF$dD_OUT[95:64];
      2'd3: x_data__h16969 = lrespF$dD_OUT[127:96];
    endcase
  end
  always@(wci_reqF$D_OUT or
	  dramStatus__h12207 or
	  dramCtrl or
	  rdat___1__h12730 or
	  rdat___1__h12739 or
