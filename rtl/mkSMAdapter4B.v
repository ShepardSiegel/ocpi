...
//
// On Fri Jul 23 11:09:48 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter4B(wciS0_Clk,
  ...
  wire [31 : 0] rdat__h15933,
		...
		rdat__h16135,
		rdat__h16143;
  wire [23 : 0] mesgMetaF_length__h17452, mesgMetaF_length__h18494;
  wire [15 : 0] wsiBurstLength__h19222, x__h15997, x_length__h17729;
  wire [13 : 0] IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d794,
		addr__h17299,
		b__h19843,
		mlp1B__h17283,
		mlp1__h17282;
  wire [11 : 0] bl__h18351, x_burstLength__h19318;
  wire [7 : 0] mesgMetaF_opcode__h17451;
  wire [3 : 0] b__h14385, x_byteEn__h19320;
  wire NOT_wmi_reqF_c_r_57_EQ_2_58_59_AND_wmi_operate_ETC___d306,
       ...
       wsiS_reqFifo_notFull__85_AND_wsiS_burstKind_65_ETC___d404,
       x__h19643;
  ...
  assign MUX_wsiM_reqFifo_x_wire$wset_1__VAL_2 =
	     { 3'd1,
	       unrollCnt == 16'd1,
	       !smaCtrl[5],
	       x_burstLength__h19318,
	       wmi_respF$D_OUT[31:0],
	       x_byteEn__h19320,
	       thisMesg[23:16] } ;
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, x_data__h15896 } ;
  ...
  assign MUX_wmi_mFlagF_x_wire$wset_1__SEL_2 =
	     WILL_FIRE_RL_wmrd_mesgBodyRequest && x__h19643 ;
  ...
  assign MUX_wmi_mFlagF_x_wire$wset_1__VAL_3 =
	     { mesgMetaF_opcode__h17451, mesgMetaF_length__h18494 } ;
  ...
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_2 =
	     { 4'd5, x__h19643, 1'b0, mesgReqAddr, fabWordsCurReq[11:0] } ;
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_3 =
	     { 4'd3, wsiS_reqFifo$D_OUT[57], 1'b0, addr__h17299, 12'd1 } ;
  ...
  assign fabWordsCurReq$D_IN =
	     (fabWordsRemain <= b__h19843) ? fabWordsRemain : b__h19843 ;
  ...
  assign NOT_wmi_reqF_c_r_57_EQ_2_58_59_AND_wmi_operate_ETC___d306 =
	     ...
	     (!x__h19643 || wmi_mFlagF_c_r != 2'd2) ;
  assign addr__h17299 = { mesgLengthSoFar[11:0], 2'd0 } ;
  assign b__h14385 = -fabWordsCurReq[3:0] ;
  assign b__h19843 = { {10{fabRespCredit_value[3]}}, fabRespCredit_value } ;
  assign bl__h18351 =
	     zeroLengthMesg ?
	       12'd1 :
	       IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d794[13:2] ;
  assign mesgMetaF_length__h17452 = { 10'd0, mlp1B__h17283 } ;
  assign mesgMetaF_length__h18494 =
	     { 10'd0,
	       IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d794 } ;
  assign mesgMetaF_opcode__h17451 = opcode[8] ? opcode[7:0] : 8'd0 ;
  assign mlp1B__h17283 = { mlp1__h17282[11:0], 2'd0 } ;
  ...
  assign wsiS_reqFifo_notFull__85_AND_wsiS_burstKind_65_ETC___d404 =
	     wsiS_reqFifo$FULL_N &&
	     (wsiS_burstKind == 2'd0 ||
	      (wsiS_burstKind == 2'd1 || wsiS_burstKind == 2'd2) &&
	      wsiS_wsiReq$wget[57]) ;
  assign x__h15997 = { wsiS_statusR, wsiM_statusR } ;
  assign x__h19643 = fabWordsRemain == fabWordsCurReq ;
  assign x_burstLength__h19318 =
	     (thisMesg[15:0] == 16'd0 || smaCtrl[5] && unrollCnt == 16'd1) ?
	       12'd1 :
	       (smaCtrl[5] ? 12'd4095 : wsiBurstLength__h19222[11:0]) ;
  assign x_byteEn__h19320 = (thisMesg[15:0] == 16'd0) ? 4'd0 : 4'd15 ;
