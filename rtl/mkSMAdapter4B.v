...
//
// On Thu Oct 31 09:24:40 EDT 2013
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter4B(wciS0_Clk,
  ...
  wire [60 : 0] respF_wDataIn_wget,
		respF_wDataOut_wget,
		wsiM_reqFifo_x_wire_wget,
		wsiS_wsiReq_wget;
  wire [37 : 0] wmi_dhF_x_wire_wget;
  wire [33 : 0] wci_wslv_respF_x_wire_wget, wmi_wmiResponse_wget;
  ...
  reg [37 : 0] wmi_dhF_q_0_D_IN;
  wire wmi_dhF_q_0_EN;

  // register wmi_dhF_q_1
  reg [37 : 0] wmi_dhF_q_1;
  reg [37 : 0] wmi_dhF_q_1_D_IN;
  wire wmi_dhF_q_1_EN;
  ...
  wire [60 : 0] respF_memory_DIA, respF_memory_DIB, respF_memory_DOB;
  ...
  wire [33 : 0] wmi_respF_D_IN, wmi_respF_D_OUT;
  wire wmi_respF_CLR,
       wmi_respF_DEQ,
       wmi_respF_EMPTY_N,
       wmi_respF_ENQ,
  ...
  wire [37 : 0] MUX_wmi_dhF_q_0_write_1__VAL_1,
  ...
  assign MUX_wci_wslv_respF_x_wire_wset_1__VAL_2 = { 2'd1, g_data__h23748 } ;
  assign MUX_wmi_dhF_cntr_r_write_1__VAL_2 = wmi_dhF_cntr_r + 2'd1 ;
  assign MUX_wmi_dhF_q_0_write_1__VAL_1 =
	     { 1'd1, wsiS_reqFifo_D_OUT[57], wsiS_reqFifo_D_OUT[43:8] } ;
  ...
  assign MUX_wmi_reqF_x_wire_wset_1__VAL_2 =
	     { 4'd3, wsiS_reqFifo_D_OUT[57], 1'b0, mesgLengthSoFar, 12'd1 } ;
  ...
  // register errCount
  assign errCount_D_IN = errCount + 32'd1 ;
  assign errCount_EN =
	     MUX_wsiS_reqFifo_levelsValid_write_1__SEL_3 &&
	     wsiS_reqFifo_D_OUT[43:12] != valExpect &&
	     (!wsiS_reqFifo_D_OUT[57] || wsiS_reqFifo_D_OUT[11:8] != 4'd0 ||
  ...
  assign respF_rCache_D_IN =
	     { 1'd1,
	       ...
	       respF_pwEnqueue_whas && respF_wDataIn_wget[57],
	       respF_pwEnqueue_whas && respF_wDataIn_wget[56],
  ...
  // register valExpect
  assign valExpect_D_IN = valExpect + 32'd1 ;
  assign valExpect_EN =
	     MUX_wsiS_reqFifo_levelsValid_write_1__SEL_3 &&
	     (!wsiS_reqFifo_D_OUT[57] || wsiS_reqFifo_D_OUT[11:8] != 4'd0 ||
	      mesgLengthSoFar != 14'd0) ;
  ...
  begin
    case (1'b1) // synopsys parallel_case
      ...
      default: wmi_dhF_q_0_D_IN = 38'h2AAAAAAAAA /* unspecified value */ ;
    endcase
  end
  ...
  begin
    case (1'b1) // synopsys parallel_case
      ...
      WILL_FIRE_RL_wmi_dhF_decCtr: wmi_dhF_q_1_D_IN = 38'd0;
      default: wmi_dhF_q_1_D_IN = 38'h2AAAAAAAAA /* unspecified value */ ;
    endcase
  end
  ...
  assign respF_memory_DIA =
	     { IF_respF_wDataIn_whas__28_THEN_respF_wDataIn_w_ETC___d431,
	       ...
	       respF_pwEnqueue_whas && respF_wDataIn_wget[56],
	       IF_respF_wDataIn_whas__28_THEN_respF_wDataIn_w_ETC___d437 } ;
  assign respF_memory_DIB = 61'h0AAAAAAAAAAAAAAA /* unspecified value */  ;
  ...
  assign wmi_respF_ENQ =
	     ...
	     wmi_wmiResponse_wget[33:32] != 2'd0 ;
  ...
  assign IF_respF_wDataIn_whas__28_THEN_respF_wDataIn_w_ETC___d431 =
	     respF_pwEnqueue_whas ? respF_wDataIn_wget[60:58] : 3'd0 ;
  assign IF_respF_wDataIn_whas__28_THEN_respF_wDataIn_w_ETC___d437 =
	     respF_pwEnqueue_whas ? respF_wDataIn_wget[55:0] : 56'd0 ;
  ...
  assign rdat__h23939 = hasDebugLogic ? wsiS_extStatusW_wget[95:64] : 32'd0 ;
  assign rdat__h23953 = hasDebugLogic ? wsiS_extStatusW_wget[63:32] : 32'd0 ;
  assign rdat__h23961 = hasDebugLogic ? wsiS_extStatusW_wget[31:0] : 32'd0 ;
  assign rdat__h23967 = hasDebugLogic ? wsiM_extStatusW_wget[95:64] : 32'd0 ;
  assign rdat__h23981 = hasDebugLogic ? wsiM_extStatusW_wget[63:32] : 32'd0 ;
  assign rdat__h23989 = hasDebugLogic ? wsiM_extStatusW_wget[31:0] : 32'd0 ;
  ...
  assign wsiS_reqFifo_i_notEmpty__61_AND_NOT_smaCtrl_62_ETC___d666 =
	     ...
	     (!wsiS_reqFifo_D_OUT[57] || wmi_mFlagF_cntr_r != 2'd2) ;
  ...
  assign x__h22435 = { 2'd0, wsiS_reqFifo_D_OUT[11] } ;
  ...
  assign y__h22412 = { 2'd0, wsiS_reqFifo_D_OUT[8] } ;
  assign y__h22424 = { 2'd0, wsiS_reqFifo_D_OUT[9] } ;
  assign y__h22436 = { 2'd0, wsiS_reqFifo_D_OUT[10] } ;
  ...
  begin
	...
	$display("[%0d]: %m: wmrd_mesgBegin mesgCount:%0h mesgLength:%0h reqInfo:%0h",
		 ...
		 wmi_sFlagReg[31:24]);
    if (wciS0_MReset_n != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_wmwt_mesgBegin && wsiS_reqFifo_D_OUT[56])
	begin
	  v__h21792 = $time;
	  #0;
	end
