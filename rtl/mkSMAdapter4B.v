...
//
// On Fri Jun 25 13:29:38 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter4B(wciS0_Clk,
  ...
  wire [31 : 0] rdat__h15486,
		...
		rdat__h15688,
		rdat__h15696;
  wire [23 : 0] mesgMetaF_length__h16976, mesgMetaF_length__h17996;
  wire [15 : 0] wsiBurstLength__h18724, x__h15550, x_length__h17251;
  wire [13 : 0] IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d750,
		addr__h16821,
		b__h19345,
		mlp1B__h16805,
		mlp1__h16804;
  wire [11 : 0] bl__h17853, x_burstLength__h18820;
  wire [7 : 0] mesgMetaF_opcode__h16975;
  wire [3 : 0] b__h13938, x_byteEn__h18822;
  wire NOT_wmi_dhF_c_r_61_EQ_2_62_63_AND_wmi_operateD_ETC___d222,
       NOT_wmi_reqF_c_r_58_EQ_2_59_60_AND_wmi_operate_ETC___d305,
       NOT_wsiS_reqFifo_countReg_67_ULE_1_68___d369,
  ...
  assign CAN_FIRE_RL_wmwt_messagePushPrecise =
	     wsiS_reqFifo$EMPTY_N &&
	     NOT_wmi_dhF_c_r_61_EQ_2_62_63_AND_wmi_operateD_ETC___d222 &&
	     wci_cState == 3'd2 &&
	     (smaCtrl[3:0] == 4'h2 || smaCtrl[3:0] == 4'h3) &&
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, x_data__h15449 } ;
  ...
  assign MUX_wmi_mFlagF_x_wire$wset_1__SEL_2 =
	     WILL_FIRE_RL_wmrd_mesgBodyRequest && x__h19145 ;
  ...
  assign MUX_wmi_dhF_x_wire$wset_1__VAL_2 =
	     { 1'd1, x__h16889, wsiS_reqFifo$D_OUT[43:12], 4'd15 } ;
  ...
  assign MUX_wmi_mFlagF_x_wire$wset_1__VAL_3 =
	     { mesgMetaF_opcode__h16975, mesgMetaF_length__h17996 } ;
  ...
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_2 =
	     { 4'd5, x__h19145, 1'b0, mesgReqAddr, fabWordsCurReq[11:0] } ;
  ...
  assign errCount$EN =
	     ...
	     (!x__h16889 || wsiS_reqFifo$D_OUT[11:8] != 4'd0) ;
  ...
  assign fabWordsCurReq$D_IN =
	     (fabWordsRemain <= b__h19345) ? fabWordsRemain : b__h19345 ;
  ...
  assign mesgLengthSoFar$D_IN =
	     MUX_impreciseBurst$write_1__SEL_2 ? 14'd0 : mlp1__h16804 ;
  ...
  begin
    case (1'b1) // synopsys parallel_case
      MUX_wmi_mFlagF_q_0$write_1__SEL_1: wmi_mFlagF_q_0$D_IN = value__h6066;
      WILL_FIRE_RL_wmi_mFlagF_both:
  ...
  begin
    case (1'b1) // synopsys parallel_case
      MUX_wmi_mFlagF_q_1$write_1__SEL_1: wmi_mFlagF_q_1$D_IN = value__h6066;
      WILL_FIRE_RL_wmi_mFlagF_both:
  ...
  // remaining internal signals
  assign IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d750 =
	     mesgLength[14] ? mesgLength[13:0] : 14'd0 ;
  assign NOT_wmi_dhF_c_r_61_EQ_2_62_63_AND_wmi_operateD_ETC___d222 =
	     wmi_dhF_c_r != 2'd2 && wmi_operateD && wmi_peerIsReady &&
	     (smaCtrl[3:0] != 4'h3 || wsiM_reqFifo_c_r != 2'd2) ;
  assign NOT_wmi_reqF_c_r_58_EQ_2_59_60_AND_wmi_operate_ETC___d305 =
	     wmi_reqF_c_r != 2'd2 && wmi_operateD && wmi_peerIsReady &&
	     (!x__h19145 || wmi_mFlagF_c_r != 2'd2) ;
  assign NOT_wsiS_reqFifo_countReg_67_ULE_1_68___d369 =
	     wsiS_reqFifo_countReg > 2'd1 ;
  assign addr__h16821 = { mesgLengthSoFar[11:0], 2'd0 } ;
  assign b__h13938 = -fabWordsCurReq[3:0] ;
  assign b__h19345 = { {10{fabRespCredit_value[3]}}, fabRespCredit_value } ;
  assign bl__h17853 =
	     zeroLengthMesg ?
	       12'd1 :
	       IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d750[13:2] ;
  assign mesgMetaF_length__h16976 = { 10'd0, mlp1B__h16805 } ;
  assign mesgMetaF_length__h17996 =
	     { 10'd0,
	       IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d750 } ;
  assign mesgMetaF_opcode__h16975 = opcode[8] ? opcode[7:0] : 8'd0 ;
  assign mlp1B__h16805 = { mlp1__h16804[11:0], 2'd0 } ;
  assign mlp1__h16804 = mesgLengthSoFar + 14'd1 ;
  ...
  assign wsiBurstLength__h18724 =
	     smaCtrl[5] ? 16'd2 : { 2'd0, thisMesg[15:2] } ;
  assign x__h15550 = { wsiS_statusR, wsiM_statusR } ;
  assign x__h16889 = wsiS_reqFifo$D_OUT[55:44] == 12'd1 ;
  assign x__h19145 = fabWordsRemain == fabWordsCurReq ;
  assign x_burstLength__h18820 =
	     (thisMesg[15:0] == 16'd0 || smaCtrl[5] && unrollCnt == 16'd1) ?
	       12'd1 :
	       (smaCtrl[5] ? 12'd4095 : wsiBurstLength__h18724[11:0]) ;
  assign x_byteEn__h18822 = (thisMesg[15:0] == 16'd0) ? 4'd0 : 4'd15 ;
