...
//
// On Mon Jun 21 17:03:50 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter4B(wciS0_Clk,
  ...
  reg [63 : 0] v__h15315,
	       ...
	       v__h2800,
	       v__h3699;
  reg [31 : 0] value__h6065, x_data__h15448;
  wire [31 : 0] rdat__h15541;
  wire [23 : 0] mesgMetaF_length__h16963, mesgMetaF_length__h17983;
  wire [15 : 0] wsiBurstLength__h18711, x__h15544, x_length__h17238;
  wire [13 : 0] IF_mesgLength_22_BIT_14_23_THEN_mesgLength_22__ETC___d736,
		addr__h16808,
		b__h19332,
		mlp1B__h16792,
		mlp1__h16791;
  wire [11 : 0] bl__h17840, x_burstLength__h18807;
  wire [7 : 0] mesgMetaF_opcode__h16962;
  wire [3 : 0] b__h13937, x_byteEn__h18809;
  wire NOT_wmi_dhF_c_r_50_EQ_2_51_52_AND_wmi_operateD_ETC___d211,
       NOT_wmi_reqF_c_r_47_EQ_2_48_49_AND_wmi_operate_ETC___d294,
       NOT_wsiS_reqFifo_countReg_56_ULE_1_57___d358,
       wmi_operateD_53_AND_wmi_peerIsReady_54_55_AND__ETC___d170,
       x__h16876,
       x__h19132;
  ...
  assign CAN_FIRE_RL_wmwt_messagePushImprecise =
	     wsiS_reqFifo$EMPTY_N && wmi_reqF_c_r != 2'd2 &&
	     wmi_dhF_c_r != 2'd2 &&
	     wmi_operateD_53_AND_wmi_peerIsReady_54_55_AND__ETC___d170 &&
	     wci_cState == 3'd2 &&
  ...
  assign CAN_FIRE_RL_wmwt_messagePushPrecise =
	     wsiS_reqFifo$EMPTY_N &&
	     NOT_wmi_dhF_c_r_50_EQ_2_51_52_AND_wmi_operateD_ETC___d211 &&
	     wci_cState == 3'd2 &&
	     (smaCtrl[3:0] == 4'h2 || smaCtrl[3:0] == 4'h3) &&
  ...
  assign MUX_endOfMessage$write_1__SEL_1 =
	     WILL_FIRE_RL_wmwt_messagePushImprecise && x__h16876 ;
  ...
  assign MUX_wmi_mFlagF_x_wire$wset_1__SEL_2 =
	     WILL_FIRE_RL_wmrd_mesgBodyRequest && x__h19132 ;
  ...
  assign MUX_mesgLength$write_1__VAL_4 = { 1'd1, mlp1B__h16792 } ;
  ...
  assign MUX_thisMesg$write_1__VAL_1 =
	     { mesgCount[7:0], mesgMetaF_opcode__h16962, x_length__h17238 } ;
  ...
  assign MUX_wmi_dhF_x_wire$wset_1__VAL_2 =
	     { 1'd1, x__h16876, wsiS_reqFifo$D_OUT[43:12], 4'd15 } ;
  ...
  assign MUX_wmi_mFlagF_x_wire$wset_1__VAL_1 =
	     { mesgMetaF_opcode__h16962, mesgMetaF_length__h16963 } ;
  assign MUX_wmi_mFlagF_x_wire$wset_1__VAL_3 =
	     { mesgMetaF_opcode__h16962, mesgMetaF_length__h17983 } ;
  ...
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_1 = { 20'd229376, bl__h17840 } ;
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_2 =
	     { 4'd5, x__h19132, 1'b0, mesgReqAddr, fabWordsCurReq[11:0] } ;
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_3 =
	     { 4'd3, x__h16876, 1'b0, addr__h16808, 12'd1 } ;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, x_data__h15448 } ;
  ...
  assign errCount$EN =
	     ...
	     (!x__h16876 || wsiS_reqFifo$D_OUT[11:8] != 4'd0) ;
  ...
  assign fabWordsCurReq$D_IN =
	     (fabWordsRemain <= b__h19332) ? fabWordsRemain : b__h19332 ;
  ...
  assign mesgLengthSoFar$D_IN =
	     MUX_impreciseBurst$write_1__SEL_2 ? 14'd0 : mlp1__h16791 ;
  ...
  begin
    case (1'b1) // synopsys parallel_case
      MUX_wmi_mFlagF_q_0$write_1__SEL_1: wmi_mFlagF_q_0$D_IN = value__h6065;
      WILL_FIRE_RL_wmi_mFlagF_both:
  ...
  begin
    case (1'b1) // synopsys parallel_case
      MUX_wmi_mFlagF_q_1$write_1__SEL_1: wmi_mFlagF_q_1$D_IN = value__h6065;
      WILL_FIRE_RL_wmi_mFlagF_both:
  ...
  // remaining internal signals
  assign IF_mesgLength_22_BIT_14_23_THEN_mesgLength_22__ETC___d736 =
	     mesgLength[14] ? mesgLength[13:0] : 14'd0 ;
  assign NOT_wmi_dhF_c_r_50_EQ_2_51_52_AND_wmi_operateD_ETC___d211 =
	     wmi_dhF_c_r != 2'd2 && wmi_operateD && wmi_peerIsReady &&
	     (smaCtrl[3:0] != 4'h3 || wsiM_reqFifo_c_r != 2'd2) ;
  assign NOT_wmi_reqF_c_r_47_EQ_2_48_49_AND_wmi_operate_ETC___d294 =
	     wmi_reqF_c_r != 2'd2 && wmi_operateD && wmi_peerIsReady &&
	     (!x__h19132 || wmi_mFlagF_c_r != 2'd2) ;
  assign NOT_wsiS_reqFifo_countReg_56_ULE_1_57___d358 =
	     wsiS_reqFifo_countReg > 2'd1 ;
  assign addr__h16808 = { mesgLengthSoFar[11:0], 2'd0 } ;
  assign b__h13937 = -fabWordsCurReq[3:0] ;
  assign b__h19332 = { {10{fabRespCredit_value[3]}}, fabRespCredit_value } ;
  assign bl__h17840 =
	     zeroLengthMesg ?
	       12'd1 :
	       IF_mesgLength_22_BIT_14_23_THEN_mesgLength_22__ETC___d736[13:2] ;
  assign mesgMetaF_length__h16963 = { 10'd0, mlp1B__h16792 } ;
  assign mesgMetaF_length__h17983 =
	     { 10'd0,
	       IF_mesgLength_22_BIT_14_23_THEN_mesgLength_22__ETC___d736 } ;
  assign mesgMetaF_opcode__h16962 = opcode[8] ? opcode[7:0] : 8'd0 ;
  assign mlp1B__h16792 = { mlp1__h16791[11:0], 2'd0 } ;
  assign mlp1__h16791 = mesgLengthSoFar + 14'd1 ;
  assign rdat__h15541 = { 16'd0, x__h15544 } ;
  assign wmi_operateD_53_AND_wmi_peerIsReady_54_55_AND__ETC___d170 =
	     wmi_operateD && wmi_peerIsReady &&
	     (smaCtrl[3:0] != 4'h3 || wsiM_reqFifo_c_r != 2'd2) &&
	     (!x__h16876 || wmi_mFlagF_c_r != 2'd2) ;
  assign wsiBurstLength__h18711 =
	     smaCtrl[5] ? 16'd2 : { 2'd0, thisMesg[15:2] } ;
  assign x__h15544 = { wsiS_statusR, wsiM_statusR } ;
  assign x__h16876 = wsiS_reqFifo$D_OUT[55:44] == 12'd1 ;
  assign x__h19132 = fabWordsRemain == fabWordsCurReq ;
  assign x_burstLength__h18807 =
	     (thisMesg[15:0] == 16'd0 || smaCtrl[5] && unrollCnt == 16'd1) ?
	       12'd1 :
	       (smaCtrl[5] ? 12'd4095 : wsiBurstLength__h18711[11:0]) ;
  assign x_byteEn__h18809 = (thisMesg[15:0] == 16'd0) ? 4'd0 : 4'd15 ;
  assign x_length__h17238 =
	     { 2'd0,
	       IF_mesgLength_22_BIT_14_23_THEN_mesgLength_22__ETC___d736 } ;
  always@(MUX_endOfMessage$write_1__SEL_1 or
  ...
  always@(wci_reqF$D_OUT or
	  ...
	  thisMesg or
	  lastMesg or
	  rdat__h15541 or wsiS_extStatusW$wget or wsiM_extStatusW$wget)
  begin
    case (wci_reqF$D_OUT[39:32])
      8'h0: x_data__h15448 = smaCtrl;
      8'h04: x_data__h15448 = mesgCount;
      8'h08: x_data__h15448 = abortCount;
      8'h10: x_data__h15448 = thisMesg;
      8'h14: x_data__h15448 = lastMesg;
      8'h18: x_data__h15448 = rdat__h15541;
      8'h20: x_data__h15448 = wsiS_extStatusW$wget[95:64];
      8'h24: x_data__h15448 = wsiS_extStatusW$wget[63:32];
      8'h28: x_data__h15448 = wsiS_extStatusW$wget[31:0];
      8'h2C: x_data__h15448 = wsiM_extStatusW$wget[95:64];
      8'h30: x_data__h15448 = wsiM_extStatusW$wget[63:32];
      8'h34: x_data__h15448 = wsiM_extStatusW$wget[31:0];
      default: x_data__h15448 = 32'd0;
    endcase
  end
  ...
  begin
    ...
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wmwt_doAbort)
	$display("[%0d]: %m: wmwt_doAbort", v__h16484);
    if (wciS0_MReset_n)
