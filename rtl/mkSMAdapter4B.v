...
//
// On Thu Dec 16 18:38:48 EST 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter4B(wciS0_Clk,
  ...
  reg [63 : 0] v__h17606,
	       ...
	       v__h3767,
	       v__h3922;
  reg [31 : 0] value__h6113, x_data__h21423;
  wire [55 : 0] IF_respF_wDataIn_whas__26_THEN_respF_wDataIn_w_ETC___d812;
  wire [31 : 0] rdat__h21472,
		rdat__h21478,
		rdat__h21484,
		rdat__h21497,
		rdat__h21520,
		...
		rdat__h21662,
		rdat__h21670;
  wire [23 : 0] mesgMetaF_length__h19401, mesgMetaF_length__h20137;
  wire [15 : 0] wsiBurstLength__h18068, x__h21524, x_length__h19156;
  wire [13 : 0] addr__h20007,
		b__h17690,
		mlp1B__h19991,
		mlp1__h19990,
		x__h19174;
  wire [11 : 0] b__h14502,
		...
		x__h15856;
  wire [7 : 0] x__h19160;
  wire [3 : 0] sendData_byteEn__h18152;
  ...
  wire NOT_wmi_reqF_c_r_39_EQ_2_58_59_AND_wmi_operate_ETC___d510,
       wmi_operateD_25_AND_wmi_peerIsReady_26_27_AND__ETC___d605,
       wmi_respF_i_notEmpty__22_AND_smaCtrl_58_BIT_4__ETC___d527,
       wsiS_reqFifo_i_notEmpty__57_AND_NOT_smaCtrl_58_ETC___d624,
  ...
  assign MUX_mesgLength$write_1__VAL_3 = { 1'd1, mlp1B__h19991 } ;
  ...
  assign MUX_thisMesg$write_1__VAL_1 =
	     { mesgCount[7:0], x__h19160, x_length__h19156 } ;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, x_data__h21423 } ;
  ...
  assign MUX_wmi_mFlagF_x_wire$wset_1__VAL_2 =
	     { x__h19160, mesgMetaF_length__h20137 } ;
  assign MUX_wmi_mFlagF_x_wire$wset_1__VAL_3 =
	     { x__h19160, mesgMetaF_length__h19401 } ;
  ...
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_2 = { 20'd229376, bl__h19263 } ;
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_3 =
	     { 4'd3, wsiS_reqFifo$D_OUT[57], 1'b0, addr__h20007, 12'd1 } ;
  ...
  assign mesgLengthSoFar$D_IN =
	     MUX_impreciseBurst$write_1__SEL_3 ? 14'd0 : mlp1__h19990 ;
  ...
  assign addr__h20007 = { mesgLengthSoFar[11:0], 2'd0 } ;
  assign b__h14502 = -fabWordsCurReq[11:0] ;
  assign b__h17690 = { {2{fabRespCredit_value[11]}}, fabRespCredit_value } ;
  assign bl__h19263 = zeroLengthMesg ? 12'd1 : x__h19174[13:2] ;
  assign mesgMetaF_length__h19401 = { 10'd0, x__h19174 } ;
  assign mesgMetaF_length__h20137 = { 10'd0, mlp1B__h19991 } ;
  assign mlp1B__h19991 = { mlp1__h19990[11:0], 2'd0 } ;
  assign mlp1__h19990 = mesgLengthSoFar + 14'd1 ;
  assign rdat__h21472 = hasDebugLogic ? mesgCount : 32'd0 ;
  assign rdat__h21478 = hasDebugLogic ? abortCount : 32'd0 ;
  assign rdat__h21484 = hasDebugLogic ? thisMesg : 32'd0 ;
  assign rdat__h21497 = hasDebugLogic ? lastMesg : 32'd0 ;
  assign rdat__h21520 = hasDebugLogic ? { 16'd0, x__h21524 } : 32'd0 ;
  assign rdat__h21620 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h21634 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h21642 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h21648 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h21662 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h21670 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  ...
  assign sendData_byteEn__h18152 = (thisMesg[15:0] == 16'd0) ? 4'd0 : 4'd15 ;
  assign wmi_operateD_25_AND_wmi_peerIsReady_26_27_AND__ETC___d605 =
	     wmi_operateD && wmi_peerIsReady && wsiS_reqFifo$EMPTY_N &&
	     (smaCtrl[3:0] != 4'h3 || wsiM_reqFifo_c_r != 2'd2) ;
  assign wmi_respF_i_notEmpty__22_AND_smaCtrl_58_BIT_4__ETC___d527 =
	     wmi_respF$EMPTY_N &&
	     (smaCtrl[4] || respF_rRdPtr + 12'd1024 != respF_rWrPtr) ;
  assign wsiBurstLength__h18068 =
	     smaCtrl[5] ? 16'd2 : { 2'd0, thisMesg[15:2] } ;
  assign wsiS_reqFifo_i_notEmpty__57_AND_NOT_smaCtrl_58_ETC___d624 =
	     wsiS_reqFifo$EMPTY_N &&
	     (smaCtrl[3:0] != 4'h3 || wsiM_reqFifo_c_r != 2'd2) &&
  ...
  assign x__h19160 = opcode[8] ? opcode[7:0] : 8'd0 ;
  assign x__h19174 = mesgLength[14] ? mesgLength[13:0] : 14'd0 ;
  assign x__h21524 = { wsiS_statusR, wsiM_statusR } ;
  assign x_length__h19156 = { 2'd0, x__h19174 } ;
  always@(wci_reqF$D_OUT or
	  ...
	  rdat__h21620 or
	  rdat__h21634 or
	  rdat__h21642 or rdat__h21648 or rdat__h21662 or rdat__h21670)
  begin
    case (wci_reqF$D_OUT[39:32])
      8'h0: x_data__h21423 = smaCtrl;
      8'h04: x_data__h21423 = rdat__h21472;
      8'h08: x_data__h21423 = rdat__h21478;
      8'h10: x_data__h21423 = rdat__h21484;
      8'h14: x_data__h21423 = rdat__h21497;
      8'h18: x_data__h21423 = rdat__h21520;
      8'h20: x_data__h21423 = rdat__h21620;
      8'h24: x_data__h21423 = rdat__h21634;
      8'h28: x_data__h21423 = rdat__h21642;
      8'h2C: x_data__h21423 = rdat__h21648;
      8'h30: x_data__h21423 = rdat__h21662;
      8'h34: x_data__h21423 = rdat__h21670;
      default: x_data__h21423 = 32'd0;
    endcase
  end
  ...
  begin
    ...
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wmwt_doAbort)
	$display("[%0d]: %m: wmwt_doAbort", v__h20820);
    if (wciS0_MReset_n)
