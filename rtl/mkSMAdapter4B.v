...
//
// On Wed Sep 12 12:50:14 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter4B(wciS0_Clk,
  ...
  reg [63 : 0] v__h18191,
	       ...
	       v__h3825,
	       v__h3969;
  reg [31 : 0] g_data__h24550;
  wire [55 : 0] IF_respF_wDataIn_whas__33_THEN_respF_wDataIn_w_ETC___d882;
  wire [31 : 0] rdat__h24593,
		rdat__h24599,
		rdat__h24605,
		rdat__h24618,
		rdat__h24641,
  ...
  wire [23 : 0] b__h17902,
		...
		residue__h17765,
		x__h18022;
  wire [15 : 0] wsiBurstLength__h18650, x__h24645, x_length__h23581;
  ...
  wire [2 : 0] IF_respF_wDataIn_whas__33_THEN_respF_wDataIn_w_ETC___d880,
	       x__h23220,
	       x__h23232,
	       x__h23244,
	       y__h23221,
  ...
  assign MUX_thisMesg$write_1__VAL_1 =
	     { mesgCount[7:0], mesgMetaF_opcode__h23180, x_length__h23581 } ;
  ...
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_2 = { 2'd1, g_data__h24550 } ;
  ...
  assign mesgLengthSoFar$D_IN =
	     WILL_FIRE_RL_wmwt_messagePush ? mlB__h23014 : 14'd0 ;
  ...
  assign respF_rCache$D_IN =
	     { 1'd1,
	       respF_rWrPtr,
	       IF_respF_wDataIn_whas__33_THEN_respF_wDataIn_w_ETC___d880,
	       respF_pwEnqueue$whas && respF_wDataIn$wget[57],
	       respF_pwEnqueue$whas && respF_wDataIn$wget[56],
	       IF_respF_wDataIn_whas__33_THEN_respF_wDataIn_w_ETC___d882 } ;
  ...
  begin
    case (1'b1) // synopsys parallel_case
      MUX_wmi_mFlagF_q_0$write_1__SEL_1: wmi_mFlagF_q_0$D_IN = value__h6580;
      WILL_FIRE_RL_wmi_mFlagF_both:
  ...
  begin
    case (1'b1) // synopsys parallel_case
      MUX_wmi_mFlagF_q_1$write_1__SEL_1: wmi_mFlagF_q_1$D_IN = value__h6580;
      WILL_FIRE_RL_wmi_mFlagF_both:
  ...
  // remaining internal signals
  assign IF_respF_wDataIn_whas__33_THEN_respF_wDataIn_w_ETC___d880 =
	     respF_pwEnqueue$whas ? respF_wDataIn$wget[60:58] : 3'd0 ;
  assign IF_respF_wDataIn_whas__33_THEN_respF_wDataIn_w_ETC___d882 =
  ...
  assign mlInc__h23013 =
	     wsiS_reqFifo$D_OUT[57] ?
	       { 11'd0, x__h23220 + y__h23221 } :
	       14'd4 ;
  assign rdat__h24593 = hasDebugLogic ? mesgCount : 32'd0 ;
  assign rdat__h24599 = hasDebugLogic ? abortCount : 32'd0 ;
  assign rdat__h24605 = hasDebugLogic ? thisMesg : 32'd0 ;
  assign rdat__h24618 = hasDebugLogic ? lastMesg : 32'd0 ;
  assign rdat__h24641 = hasDebugLogic ? { 16'd0, x__h24645 } : 32'd0 ;
  assign rdat__h24741 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h24755 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h24763 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h24769 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h24783 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h24791 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h24797 = hasDebugLogic ? wmwtBeginCount : 32'd0 ;
  assign rdat__h24803 = hasDebugLogic ? wmwtPushCount : 32'd0 ;
  assign rdat__h24809 = hasDebugLogic ? wmwtFinalCount : 32'd0 ;
  assign rdat__h24815 = hasDebugLogic ? { 31'd0, x__h24819 } : 32'd0 ;
  assign rdat__h24825 = hasDebugLogic ? 32'hFEEDC0DE : 32'd0 ;
  ...
  assign x__h23244 = { 2'd0, wsiS_reqFifo$D_OUT[11] } ;
  assign x__h24645 = { wsiS_statusR, wsiM_statusR } ;
  assign x__h24819 = wmi_sThreadBusy_d || wmi_sDataThreadBusy_d ;
  assign x_length__h23581 = { 2'd0, mlB__h23014 } ;
  assign y__h23221 = { 2'd0, wsiS_reqFifo$D_OUT[8] } ;
  assign y__h23233 = { 2'd0, wsiS_reqFifo$D_OUT[9] } ;
  assign y__h23245 = { 2'd0, wsiS_reqFifo$D_OUT[10] } ;
  always@(wci_wslv_reqF$D_OUT or
	  ...
	  rdat__h24791 or
	  rdat__h24797 or
	  rdat__h24803 or rdat__h24809 or rdat__h24815 or rdat__h24825)
  begin
    case (wci_wslv_reqF$D_OUT[39:32])
      8'h0: g_data__h24550 = smaCtrl;
      8'h04: g_data__h24550 = rdat__h24593;
      8'h08: g_data__h24550 = rdat__h24599;
      8'h10: g_data__h24550 = rdat__h24605;
      8'h14: g_data__h24550 = rdat__h24618;
      8'h18: g_data__h24550 = rdat__h24641;
      8'h20: g_data__h24550 = rdat__h24741;
      8'h24: g_data__h24550 = rdat__h24755;
      8'h28: g_data__h24550 = rdat__h24763;
      8'h2C: g_data__h24550 = rdat__h24769;
      8'h30: g_data__h24550 = rdat__h24783;
      8'h34: g_data__h24550 = rdat__h24791;
      8'h38: g_data__h24550 = rdat__h24797;
      8'h3C: g_data__h24550 = rdat__h24803;
      8'h40: g_data__h24550 = rdat__h24809;
      8'h44: g_data__h24550 = rdat__h24815;
      8'h48: g_data__h24550 = rdat__h24825;
      default: g_data__h24550 = 32'd0;
    endcase
  end
  ...
  begin
    ...
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wmwt_doAbort)
	$display("[%0d]: %m: wmwt_doAbort", v__h24001);
    if (wciS0_MReset_n)
