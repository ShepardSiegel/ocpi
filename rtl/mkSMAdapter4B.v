...
//
// On Wed Sep 29 14:45:57 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter4B(wciS0_Clk,
  ...
  wire [31 : 0] rdat__h16043,
		...
		rdat__h16245,
		rdat__h16253;
  wire [23 : 0] mesgMetaF_length__h17562, mesgMetaF_length__h18604;
  wire [15 : 0] wsiBurstLength__h19332, x__h16107, x_length__h17839;
  wire [13 : 0] IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d782,
		addr__h17409,
		b__h19953,
		mlp1B__h17393,
		mlp1__h17392;
  wire [11 : 0] bl__h18461, x_burstLength__h19428;
  wire [7 : 0] mesgMetaF_opcode__h17561;
  wire [3 : 0] b__h14495, x_byteEn__h19430;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, x_data__h16006 } ;
  ...
  assign MUX_wmi_mFlagF_x_wire$wset_1__VAL_3 =
	     { mesgMetaF_opcode__h17561, mesgMetaF_length__h18604 } ;
  ...
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_3 =
	     { 4'd3, wsiS_reqFifo$D_OUT[57], 1'b0, addr__h17409, 12'd1 } ;
  ...
  // remaining internal signals
  assign IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d782 =
  ...
  assign addr__h17409 = { mesgLengthSoFar[11:0], 2'd0 } ;
  assign b__h14495 = -fabWordsCurReq[3:0] ;
  assign b__h19953 = { {10{fabRespCredit_value[3]}}, fabRespCredit_value } ;
  assign bl__h18461 =
	     zeroLengthMesg ?
	       12'd1 :
	       IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d782[13:2] ;
  assign mesgMetaF_length__h17562 = { 10'd0, mlp1B__h17393 } ;
  assign mesgMetaF_length__h18604 =
	     { 10'd0,
	       IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d782 } ;
  assign mesgMetaF_opcode__h17561 = opcode[8] ? opcode[7:0] : 8'd0 ;
  assign mlp1B__h17393 = { mlp1__h17392[11:0], 2'd0 } ;
  ...
  assign x_byteEn__h19430 = (thisMesg[15:0] == 16'd0) ? 4'd0 : 4'd15 ;
