...
//
// On Tue Nov  5 11:22:11 EST 2013
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter4B(wciS0_Clk,
  ...
  wire [23 : 0] b__h17784,
		...
		residue__h17647,
		x__h17904;
  wire [15 : 0] wsiBurstLength__h18535, x__h24540, x_length__h23469;
  ...
  assign MUX_thisMesg$write_1__VAL_1 =
	     { mesgCount[7:0], mesgMetaF_opcode__h23069, x_length__h23469 } ;
  ...
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_2 = { 2'd1, g_data__h24445 } ;
  ...
  assign mlInc__h22902 =
	     wsiS_reqFifo$D_OUT[57] ?
	       { 11'd0, x__h23108 + y__h23109 } :
	       14'd4 ;
  assign rdat__h24488 = hasDebugLogic ? mesgCount : 32'd0 ;
  assign rdat__h24494 = hasDebugLogic ? abortCount : 32'd0 ;
  assign rdat__h24500 = hasDebugLogic ? thisMesg : 32'd0 ;
  assign rdat__h24513 = hasDebugLogic ? lastMesg : 32'd0 ;
  assign rdat__h24536 = hasDebugLogic ? { 16'd0, x__h24540 } : 32'd0 ;
  assign rdat__h24636 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h24650 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h24658 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h24664 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h24678 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h24686 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h24692 = hasDebugLogic ? wmwtBeginCount : 32'd0 ;
  assign rdat__h24698 = hasDebugLogic ? wmwtPushCount : 32'd0 ;
  assign rdat__h24704 = hasDebugLogic ? wmwtFinalCount : 32'd0 ;
  assign rdat__h24710 = hasDebugLogic ? { 31'd0, x__h24714 } : 32'd0 ;
  assign rdat__h24720 = hasDebugLogic ? 32'hFEEDC0DE : 32'd0 ;
  ...
  assign x__h23132 = { 2'd0, wsiS_reqFifo$D_OUT[11] } ;
  assign x__h24540 = { wsiS_statusR, wsiM_statusR } ;
  assign x__h24714 = wmi_sThreadBusy_d || wmi_sDataThreadBusy_d ;
  assign x_length__h23469 = { 2'd0, mlB__h22903 } ;
  assign y__h23109 = { 2'd0, wsiS_reqFifo$D_OUT[8] } ;
  assign y__h23121 = { 2'd0, wsiS_reqFifo$D_OUT[9] } ;
  assign y__h23133 = { 2'd0, wsiS_reqFifo$D_OUT[10] } ;
  always@(wci_wslv_reqF$D_OUT or
	  ...
	  rdat__h24686 or
	  rdat__h24692 or
	  rdat__h24698 or rdat__h24704 or rdat__h24710 or rdat__h24720)
  begin
    case (wci_wslv_reqF$D_OUT[39:32])
      8'h0: g_data__h24445 = smaCtrl;
      8'h04: g_data__h24445 = rdat__h24488;
      8'h08: g_data__h24445 = rdat__h24494;
      8'h10: g_data__h24445 = rdat__h24500;
      8'h14: g_data__h24445 = rdat__h24513;
      8'h18: g_data__h24445 = rdat__h24536;
      8'h20: g_data__h24445 = rdat__h24636;
      8'h24: g_data__h24445 = rdat__h24650;
      8'h28: g_data__h24445 = rdat__h24658;
      8'h2C: g_data__h24445 = rdat__h24664;
      8'h30: g_data__h24445 = rdat__h24678;
      8'h34: g_data__h24445 = rdat__h24686;
      8'h38: g_data__h24445 = rdat__h24692;
      8'h3C: g_data__h24445 = rdat__h24698;
      8'h40: g_data__h24445 = rdat__h24704;
      8'h44: g_data__h24445 = rdat__h24710;
      8'h48: g_data__h24445 = rdat__h24720;
      default: g_data__h24445 = 32'd0;
    endcase
  end
  ...
  begin
    ...
    if (wciS0_MReset_n != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_wmwt_doAbort)
	$display("[%0d]: %m: wmwt_doAbort", v__h23894);
    if (wciS0_MReset_n != `BSV_RESET_VALUE)
