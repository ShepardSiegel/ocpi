...
//
// On Fri Dec 17 14:58:26 EST 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter4B(wciS0_Clk,
  ...
  reg [63 : 0] v__h16535,
	       ...
	       v__h3767,
	       v__h3922;
  reg [31 : 0] value__h6113, x_data__h20327;
  wire [31 : 0] rdat__h20376,
		rdat__h20382,
		rdat__h20388,
		rdat__h20401,
		rdat__h20424,
		...
		rdat__h20566,
		rdat__h20574;
  wire [23 : 0] mesgMetaF_length__h18305, mesgMetaF_length__h19041;
  wire [15 : 0] wsiBurstLength__h16997, x__h20428, x_length__h18060;
  wire [13 : 0] addr__h18911,
		b__h16619,
		mlp1B__h18895,
		mlp1__h18894,
		x__h18078;
  wire [11 : 0] b__h14502, bl__h18167, x1_burstLength__h17056;
  wire [7 : 0] x__h18064;
  wire [3 : 0] x1_byteEn__h17058;
  wire NOT_wmi_reqF_c_r_39_EQ_2_58_59_AND_wmi_operate_ETC___d476,
       wmi_operateD_25_AND_wmi_peerIsReady_26_27_AND__ETC___d568,
       wsiS_reqFifo_i_notEmpty__23_AND_NOT_smaCtrl_24_ETC___d587,
  ...
  assign MUX_mesgLength$write_1__VAL_3 = { 1'd1, mlp1B__h18895 } ;
  ...
  assign MUX_thisMesg$write_1__VAL_1 =
	     { mesgCount[7:0], x__h18064, x_length__h18060 } ;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, x_data__h20327 } ;
  ...
  assign MUX_wmi_mFlagF_x_wire$wset_1__VAL_2 =
	     { x__h18064, mesgMetaF_length__h19041 } ;
  assign MUX_wmi_mFlagF_x_wire$wset_1__VAL_3 =
	     { x__h18064, mesgMetaF_length__h18305 } ;
  ...
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_2 = { 20'd229376, bl__h18167 } ;
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_3 =
	     { 4'd3, wsiS_reqFifo$D_OUT[57], 1'b0, addr__h18911, 12'd1 } ;
  ...
  assign mesgLengthSoFar$D_IN =
	     MUX_impreciseBurst$write_1__SEL_3 ? 14'd0 : mlp1__h18894 ;
  ...
  assign addr__h18911 = { mesgLengthSoFar[11:0], 2'd0 } ;
  assign b__h14502 = -fabWordsCurReq[11:0] ;
  assign b__h16619 = { {2{fabRespCredit_value[11]}}, fabRespCredit_value } ;
  assign bl__h18167 = zeroLengthMesg ? 12'd1 : x__h18078[13:2] ;
  assign mesgMetaF_length__h18305 = { 10'd0, x__h18078 } ;
  assign mesgMetaF_length__h19041 = { 10'd0, mlp1B__h18895 } ;
  assign mlp1B__h18895 = { mlp1__h18894[11:0], 2'd0 } ;
  assign mlp1__h18894 = mesgLengthSoFar + 14'd1 ;
  assign rdat__h20376 = hasDebugLogic ? mesgCount : 32'd0 ;
  assign rdat__h20382 = hasDebugLogic ? abortCount : 32'd0 ;
  assign rdat__h20388 = hasDebugLogic ? thisMesg : 32'd0 ;
  assign rdat__h20401 = hasDebugLogic ? lastMesg : 32'd0 ;
  assign rdat__h20424 = hasDebugLogic ? { 16'd0, x__h20428 } : 32'd0 ;
  assign rdat__h20524 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h20538 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h20546 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h20552 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h20566 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h20574 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign wmi_operateD_25_AND_wmi_peerIsReady_26_27_AND__ETC___d568 =
  ...
  assign wsiS_reqFifo_i_notEmpty__23_AND_NOT_smaCtrl_24_ETC___d587 =
	     wsiS_reqFifo$EMPTY_N &&
	     (smaCtrl[3:0] != 4'h3 || wsiM_reqFifo_c_r != 2'd2) &&
  ...
  assign x1_byteEn__h17058 = (thisMesg[15:0] == 16'd0) ? 4'd0 : 4'd15 ;
  assign x__h16790 = fabWordsRemain == fabWordsCurReq ;
  assign x__h18064 = opcode[8] ? opcode[7:0] : 8'd0 ;
  assign x__h18078 = mesgLength[14] ? mesgLength[13:0] : 14'd0 ;
  assign x__h20428 = { wsiS_statusR, wsiM_statusR } ;
  assign x_length__h18060 = { 2'd0, x__h18078 } ;
  always@(wci_reqF$D_OUT or
	  ...
	  rdat__h20524 or
	  rdat__h20538 or
	  rdat__h20546 or rdat__h20552 or rdat__h20566 or rdat__h20574)
  begin
    case (wci_reqF$D_OUT[39:32])
      8'h0: x_data__h20327 = smaCtrl;
      8'h04: x_data__h20327 = rdat__h20376;
      8'h08: x_data__h20327 = rdat__h20382;
      8'h10: x_data__h20327 = rdat__h20388;
      8'h14: x_data__h20327 = rdat__h20401;
      8'h18: x_data__h20327 = rdat__h20424;
      8'h20: x_data__h20327 = rdat__h20524;
      8'h24: x_data__h20327 = rdat__h20538;
      8'h28: x_data__h20327 = rdat__h20546;
      8'h2C: x_data__h20327 = rdat__h20552;
      8'h30: x_data__h20327 = rdat__h20566;
      8'h34: x_data__h20327 = rdat__h20574;
      default: x_data__h20327 = 32'd0;
    endcase
  end
  ...
  begin
    ...
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wmwt_doAbort)
	$display("[%0d]: %m: wmwt_doAbort", v__h19724);
    if (wciS0_MReset_n)
