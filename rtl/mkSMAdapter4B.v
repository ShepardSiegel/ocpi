...
//
// On Sun Jan 27 10:33:23 EST 2013
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter4B(wciS0_Clk,
  ...
  reg [63 : 0] v__h18073,
	       ...
	       v__h3772,
	       v__h3916;
  reg [31 : 0] g_data__h23748;
  wire [55 : 0] IF_respF_wDataIn_whas__28_THEN_respF_wDataIn_w_ETC___d437;
  wire [31 : 0] rdat__h23791,
		rdat__h23797,
		rdat__h23803,
		rdat__h23816,
		rdat__h23839,
  ...
  wire [23 : 0] b__h17784,
		...
		residue__h17647,
		x__h17904;
  wire [15 : 0] wsiBurstLength__h18535, x__h23843, x_length__h22772;
  ...
  wire [3 : 0] sendData_byteEn__h18619;
  ...
  wire NOT_wmi_reqF_cntr_r_61_EQ_2_73_74_AND_wmi_oper_ETC___d521,
       ...
       _dfoo7,
       _dfoo9,
       wmi_respF_i_notEmpty__33_AND_smaCtrl_62_BIT_4__ETC___d538,
  ...
  assign MUX_thisMesg$write_1__VAL_1 =
	     { mesgCount[7:0], mesgMetaF_opcode__h22372, x_length__h22772 } ;
  ...
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_2 = { 2'd1, g_data__h23748 } ;
  ...
  assign mlInc__h22205 =
	     wsiS_reqFifo$D_OUT[57] ?
	       { 11'd0, x__h22411 + y__h22412 } :
	       14'd4 ;
  assign rdat__h23791 = hasDebugLogic ? mesgCount : 32'd0 ;
  assign rdat__h23797 = hasDebugLogic ? abortCount : 32'd0 ;
  assign rdat__h23803 = hasDebugLogic ? thisMesg : 32'd0 ;
  assign rdat__h23816 = hasDebugLogic ? lastMesg : 32'd0 ;
  assign rdat__h23839 = hasDebugLogic ? { 16'd0, x__h23843 } : 32'd0 ;
  assign rdat__h23939 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h23953 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h23961 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h23967 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h23981 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h23989 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h23995 = hasDebugLogic ? wmwtBeginCount : 32'd0 ;
  assign rdat__h24001 = hasDebugLogic ? wmwtPushCount : 32'd0 ;
  assign rdat__h24007 = hasDebugLogic ? wmwtFinalCount : 32'd0 ;
  assign rdat__h24013 = hasDebugLogic ? { 31'd0, x__h24017 } : 32'd0 ;
  assign rdat__h24023 = hasDebugLogic ? 32'hFEEDC0DE : 32'd0 ;
  ...
  assign sendData_byteEn__h18619 =
	     (thisMesg[15:0] == 16'd0) ?
	       4'd0 :
	       ((unrollCnt == 16'd1) ? x__h18676[3:0] : 4'd15) ;
  assign value__h6387 =
	     MUX_wmi_mFlagF_x_wire$wset_1__SEL_1 ?
  ...
  assign wmi_respF_i_notEmpty__33_AND_smaCtrl_62_BIT_4__ETC___d538 =
	     wmi_respF$EMPTY_N &&
  ...
  assign wsiS_reqFifo_i_notEmpty__61_AND_NOT_smaCtrl_62_ETC___d666 =
	     ...
	     (!wsiS_reqFifo$D_OUT[57] || wmi_mFlagF_cntr_r != 2'd2) ;
  assign x__h16103 = respF_rWrPtr + 12'd1 ;
  assign x__h16253 = respF_rRdPtr + 12'd1 ;
  assign x__h17904 = { 2'd0, wmi_sFlagReg[23:2] } ;
  ...
  assign x__h22435 = { 2'd0, wsiS_reqFifo$D_OUT[11] } ;
  assign x__h23843 = { wsiS_statusR, wsiM_statusR } ;
  assign x__h24017 = wmi_sThreadBusy_d || wmi_sDataThreadBusy_d ;
  assign x_length__h22772 = { 2'd0, mlB__h22206 } ;
  assign y__h22412 = { 2'd0, wsiS_reqFifo$D_OUT[8] } ;
  assign y__h22424 = { 2'd0, wsiS_reqFifo$D_OUT[9] } ;
  assign y__h22436 = { 2'd0, wsiS_reqFifo$D_OUT[10] } ;
  always@(wci_wslv_reqF$D_OUT or
	  ...
	  rdat__h23989 or
	  rdat__h23995 or
	  rdat__h24001 or rdat__h24007 or rdat__h24013 or rdat__h24023)
  begin
    case (wci_wslv_reqF$D_OUT[39:32])
      8'h0: g_data__h23748 = smaCtrl;
      8'h04: g_data__h23748 = rdat__h23791;
      8'h08: g_data__h23748 = rdat__h23797;
      8'h10: g_data__h23748 = rdat__h23803;
      8'h14: g_data__h23748 = rdat__h23816;
      8'h18: g_data__h23748 = rdat__h23839;
      8'h20: g_data__h23748 = rdat__h23939;
      8'h24: g_data__h23748 = rdat__h23953;
      8'h28: g_data__h23748 = rdat__h23961;
      8'h2C: g_data__h23748 = rdat__h23967;
      8'h30: g_data__h23748 = rdat__h23981;
      8'h34: g_data__h23748 = rdat__h23989;
      8'h38: g_data__h23748 = rdat__h23995;
      8'h3C: g_data__h23748 = rdat__h24001;
      8'h40: g_data__h23748 = rdat__h24007;
      8'h44: g_data__h23748 = rdat__h24013;
      8'h48: g_data__h23748 = rdat__h24023;
      default: g_data__h23748 = 32'd0;
    endcase
  end
  ...
  begin
    ...
    if (wciS0_MReset_n != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_wmwt_doAbort)
	$display("[%0d]: %m: wmwt_doAbort", v__h23197);
    if (wciS0_MReset_n != `BSV_RESET_VALUE)
