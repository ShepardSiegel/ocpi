...
//
// On Mon Jul 12 17:43:47 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter4B(wciS0_Clk,
  ...
  wire [31 : 0] rdat__h15856,
		...
		rdat__h16058,
		rdat__h16066;
  wire [23 : 0] mesgMetaF_length__h17375, mesgMetaF_length__h18417;
  wire [15 : 0] wsiBurstLength__h19145, x__h15920, x_length__h17652;
  wire [13 : 0] IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d787,
		addr__h17222,
		b__h19766,
		mlp1B__h17206,
		mlp1__h17205;
  wire [11 : 0] bl__h18274, x_burstLength__h19241;
  wire [7 : 0] mesgMetaF_opcode__h17374;
  wire [3 : 0] b__h14308, x_byteEn__h19243;
  wire NOT_wmi_reqF_c_r_57_EQ_2_58_59_AND_wmi_operate_ETC___d306,
       ...
       wsiS_reqFifo_notFull__85_AND_wsiS_burstKind_65_ETC___d401,
       x__h19566;
  ...
  assign MUX_wsiM_reqFifo_x_wire$wset_1__VAL_2 =
	     { 3'd1,
	       unrollCnt == 16'd1,
	       !smaCtrl[5],
	       x_burstLength__h19241,
	       wmi_respF$D_OUT[31:0],
	       x_byteEn__h19243,
	       thisMesg[23:16] } ;
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, x_data__h15819 } ;
  ...
  assign MUX_wmi_mFlagF_x_wire$wset_1__SEL_2 =
	     WILL_FIRE_RL_wmrd_mesgBodyRequest && x__h19566 ;
  ...
  assign MUX_wmi_mFlagF_x_wire$wset_1__VAL_3 =
	     { mesgMetaF_opcode__h17374, mesgMetaF_length__h18417 } ;
  ...
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_2 =
	     { 4'd5, x__h19566, 1'b0, mesgReqAddr, fabWordsCurReq[11:0] } ;
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_3 =
	     { 4'd3, wsiS_reqFifo$D_OUT[57], 1'b0, addr__h17222, 12'd1 } ;
  ...
  assign fabWordsCurReq$D_IN =
	     (fabWordsRemain <= b__h19766) ? fabWordsRemain : b__h19766 ;
  ...
  assign NOT_wmi_reqF_c_r_57_EQ_2_58_59_AND_wmi_operate_ETC___d306 =
	     ...
	     (!x__h19566 || wmi_mFlagF_c_r != 2'd2) ;
  assign addr__h17222 = { mesgLengthSoFar[11:0], 2'd0 } ;
  assign b__h14308 = -fabWordsCurReq[3:0] ;
  assign b__h19766 = { {10{fabRespCredit_value[3]}}, fabRespCredit_value } ;
  assign bl__h18274 =
	     zeroLengthMesg ?
	       12'd1 :
	       IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d787[13:2] ;
  ...
  assign mlp1B__h17206 = { mlp1__h17205[11:0], 2'd0 } ;
  ...
  assign wsiS_reqFifo_notFull__85_AND_wsiS_burstKind_65_ETC___d401 =
	     wsiS_reqFifo$FULL_N &&
	     (wsiS_burstKind == 2'd0 ||
	      (wsiS_burstKind == 2'd1 || wsiS_burstKind == 2'd2) &&
	      wsiS_wsiReq$wget[57]) ;
  assign x__h15920 = { wsiS_statusR, wsiM_statusR } ;
  assign x__h19566 = fabWordsRemain == fabWordsCurReq ;
  assign x_burstLength__h19241 =
	     (thisMesg[15:0] == 16'd0 || smaCtrl[5] && unrollCnt == 16'd1) ?
	       12'd1 :
	       (smaCtrl[5] ? 12'd4095 : wsiBurstLength__h19145[11:0]) ;
  assign x_byteEn__h19243 = (thisMesg[15:0] == 16'd0) ? 4'd0 : 4'd15 ;
