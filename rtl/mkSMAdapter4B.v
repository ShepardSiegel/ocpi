...
//
// On Tue Jun 21 16:39:56 EDT 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter4B(wciS0_Clk,
  ...
  reg [63 : 0] v__h18508,
	       ...
	       v__h3827,
	       v__h3971;
  reg [31 : 0] g_data__h25238, value__h6629;
  wire [55 : 0] IF_respF_wDataIn_whas__45_THEN_respF_wDataIn_w_ETC___d918;
  wire [31 : 0] rdat__h25281,
		rdat__h25287,
		rdat__h25293,
		rdat__h25306,
		rdat__h25329,
		...
		rdat__h25503,
		x__h19111;
  wire [23 : 0] mesgMetaF_length__h23009, mesgMetaF_length__h23769;
  wire [15 : 0] wsiBurstLength__h18970, x__h25333, x_length__h22764;
  wire [13 : 0] addr__h23639,
		b__h18592,
		mlp1B__h23599,
		mlp1__h23598,
		x__h22782;
  wire [11 : 0] b__h15203,
		...
		x__h16557;
  wire [7 : 0] x__h22768;
  wire [3 : 0] sendData_byteEn__h19054;
  wire [2 : 0] IF_respF_wDataIn_whas__45_THEN_respF_wDataIn_w_ETC___d917;
  wire NOT_wmi_reqF_c_r_57_EQ_2_76_77_AND_wmi_operate_ETC___d529,
       wci_wslv_cState_6_EQ_2_7_AND_smaCtrl_77_BITS_3_ETC___d769,
       wmi_operateD_44_AND_wmi_peerIsReady_45_46_AND__ETC___d696,
       wmi_respF_i_notEmpty__41_AND_smaCtrl_77_BIT_4__ETC___d546,
       wsiS_reqFifo_i_notEmpty__76_AND_NOT_smaCtrl_77_ETC___d715,
  ...
  assign MUX_mesgLength$write_1__VAL_3 = { 1'd1, mlp1B__h23599 } ;
  ...
  assign MUX_thisMesg$write_1__VAL_1 =
	     { mesgCount[7:0], x__h22768, x_length__h22764 } ;
  ...
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_2 = { 2'd1, g_data__h25238 } ;
  ...
  assign MUX_wmi_mFlagF_x_wire$wset_1__VAL_2 =
	     { x__h22768, mesgMetaF_length__h23769 } ;
  assign MUX_wmi_mFlagF_x_wire$wset_1__VAL_3 =
	     { x__h22768, mesgMetaF_length__h23009 } ;
  ...
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_2 = { 20'd229376, bl__h22871 } ;
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_3 =
	     { 4'd3, wsiS_reqFifo$D_OUT[57], 1'b0, addr__h23639, 12'd1 } ;
  ...
  assign respF_rCache$D_IN =
	     { 1'd1,
	       respF_rWrPtr,
	       IF_respF_wDataIn_whas__45_THEN_respF_wDataIn_w_ETC___d917,
	       respF_pwEnqueue$whas && respF_wDataIn$wget[57],
	       respF_pwEnqueue$whas && respF_wDataIn$wget[56],
	       IF_respF_wDataIn_whas__45_THEN_respF_wDataIn_w_ETC___d918 } ;
  ...
  // remaining internal signals
  assign IF_respF_wDataIn_whas__45_THEN_respF_wDataIn_w_ETC___d917 =
	     respF_pwEnqueue$whas ? respF_wDataIn$wget[60:58] : 3'd0 ;
  assign IF_respF_wDataIn_whas__45_THEN_respF_wDataIn_w_ETC___d918 =
  ...
  assign addr__h23639 = { mesgLengthSoFar[11:0], 2'd0 } ;
  assign b__h15203 = -fabWordsCurReq[11:0] ;
  assign b__h18592 = { {2{fabRespCredit_value[11]}}, fabRespCredit_value } ;
  assign bl__h22871 = zeroLengthMesg ? 12'd1 : x__h22782[13:2] ;
  assign mesgMetaF_length__h23009 = { 10'd0, x__h22782 } ;
  assign mesgMetaF_length__h23769 =
	     (wsiS_reqFifo$D_OUT[57] && wsiS_reqFifo$D_OUT[11:8] == 4'd0 &&
	      mesgLengthSoFar == 14'd0) ?
	       24'd0 :
	       { 10'd0, mlp1B__h23599 } ;
  assign mlp1B__h23599 = { mlp1__h23598[11:0], 2'd0 } ;
  assign mlp1__h23598 = MUX_mesgLengthSoFar$write_1__VAL_2 ;
  assign rdat__h25281 = hasDebugLogic ? mesgCount : 32'd0 ;
  assign rdat__h25287 = hasDebugLogic ? abortCount : 32'd0 ;
  assign rdat__h25293 = hasDebugLogic ? thisMesg : 32'd0 ;
  assign rdat__h25306 = hasDebugLogic ? lastMesg : 32'd0 ;
  assign rdat__h25329 = hasDebugLogic ? { 16'd0, x__h25333 } : 32'd0 ;
  assign rdat__h25429 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h25443 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h25451 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h25457 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h25471 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h25479 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h25485 = hasDebugLogic ? wmwtBeginCount : 32'd0 ;
  assign rdat__h25491 = hasDebugLogic ? wmwtPImpCount : 32'd0 ;
  assign rdat__h25497 = hasDebugLogic ? wmwtFinalCount : 32'd0 ;
  assign rdat__h25503 = hasDebugLogic ? 32'hFEEDC0DE : 32'd0 ;
  ...
  assign sendData_byteEn__h19054 =
	     (thisMesg[15:0] == 16'd0) ?
	       4'd0 :
	       ((unrollCnt == 16'd1) ? x__h19111[3:0] : 4'd15) ;
  assign wci_wslv_cState_6_EQ_2_7_AND_smaCtrl_77_BITS_3_ETC___d769 =
	     wci_wslv_cState == 3'd2 &&
	     (smaCtrl[3:0] == 4'h2 || smaCtrl[3:0] == 4'h3) &&
	     mesgLength[14] &&
	     !doAbort &&
  ...
  assign wmi_operateD_44_AND_wmi_peerIsReady_45_46_AND__ETC___d696 =
  ...
  assign wsiS_reqFifo_i_notEmpty__76_AND_NOT_smaCtrl_77_ETC___d715 =
	     wsiS_reqFifo$EMPTY_N &&
	     (smaCtrl[3:0] != 4'h3 || wsiM_reqFifo_c_r != 2'd2) &&
													...
													6'd30) ?
													 ...
													 (({ 4'd0,
													   ...
													   6'd31) ?
													    32'h7FFFFFFF :
													    32'hFFFFFFFF))))))))))))))))))))))))))))))) ;
  assign x__h22768 = opcode[8] ? opcode[7:0] : 8'd0 ;
  assign x__h22782 = mesgLength[14] ? mesgLength[13:0] : 14'd0 ;
  assign x__h25333 = { wsiS_statusR, wsiM_statusR } ;
  assign x_length__h22764 = { 2'd0, x__h22782 } ;
  always@(wci_wslv_reqF$D_OUT or
	  ...
	  rdat__h25471 or
	  rdat__h25479 or
	  rdat__h25485 or rdat__h25491 or rdat__h25497 or rdat__h25503)
  begin
    case (wci_wslv_reqF$D_OUT[39:32])
      8'h0: g_data__h25238 = smaCtrl;
      8'h04: g_data__h25238 = rdat__h25281;
      8'h08: g_data__h25238 = rdat__h25287;
      8'h10: g_data__h25238 = rdat__h25293;
      8'h14: g_data__h25238 = rdat__h25306;
      8'h18: g_data__h25238 = rdat__h25329;
      8'h20: g_data__h25238 = rdat__h25429;
      8'h24: g_data__h25238 = rdat__h25443;
      8'h28: g_data__h25238 = rdat__h25451;
      8'h2C: g_data__h25238 = rdat__h25457;
      8'h30: g_data__h25238 = rdat__h25471;
      8'h34: g_data__h25238 = rdat__h25479;
      8'h38: g_data__h25238 = rdat__h25485;
      8'h3C: g_data__h25238 = rdat__h25491;
      8'h40: g_data__h25238 = rdat__h25497;
      8'h44: g_data__h25238 = rdat__h25503;
      default: g_data__h25238 = 32'd0;
    endcase
  end
  ...
  begin
    ...
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wmwt_doAbort)
	$display("[%0d]: %m: wmwt_doAbort", v__h24537);
    if (wciS0_MReset_n)
