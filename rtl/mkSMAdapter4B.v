...
//
// On Sat Oct 30 16:22:04 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter4B(wciS0_Clk,
  ...
  wire [55 : 0] IF_respF_wDataIn_whas__75_THEN_respF_wDataIn_w_ETC___d812;
  wire [31 : 0] rdat__h17208,
		...
		rdat__h17410,
		rdat__h17418;
  wire [23 : 0] mesgMetaF_length__h18735, mesgMetaF_length__h19777;
  wire [15 : 0] wsiBurstLength__h20630, x__h17272, x_length__h19012;
  wire [13 : 0] IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d810,
		addr__h18582,
		b__h21259,
		mlp1B__h18566,
		mlp1__h18565;
  wire [11 : 0] b__h14530,
		bl__h19634,
		sendData_burstLength__h20734,
		x__h15812;
  wire [7 : 0] mesgMetaF_opcode__h18734;
  wire [3 : 0] sendData_byteEn__h20736;
  wire [2 : 0] IF_respF_wDataIn_whas__75_THEN_respF_wDataIn_w_ETC___d815;
  wire NOT_wmi_reqF_c_r_57_EQ_2_58_59_AND_wmi_operate_ETC___d318,
       wmi_operateD_63_AND_wmi_peerIsReady_64_65_AND__ETC___d221,
       wmi_respF_i_notEmpty__78_AND_smaCtrl_3_BIT_4_7_ETC___d284,
       wsiS_reqFifo_i_notEmpty__66_AND_NOT_smaCtrl_3__ETC___d180,
       wsiS_reqFifo_notFull__29_AND_wsiS_burstKind_09_ETC___d449,
       x__h21059;
  ...
  assign CAN_FIRE_RL_wmrd_mesgBodyRequest =
	     NOT_wmi_reqF_c_r_57_EQ_2_58_59_AND_wmi_operate_ETC___d318 &&
	     wci_cState == 3'd2 &&
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, x_data__h17165 } ;
  ...
  assign MUX_wmi_mFlagF_x_wire$wset_1__SEL_2 =
	     WILL_FIRE_RL_wmrd_mesgBodyRequest && x__h21059 ;
  ...
  assign MUX_wmi_mFlagF_x_wire$wset_1__VAL_3 =
	     { mesgMetaF_opcode__h18734, mesgMetaF_length__h19777 } ;
  ...
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_2 =
	     { 4'd5, x__h21059, 1'b0, mesgReqAddr, fabWordsCurReq[11:0] } ;
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_3 =
	     { 4'd3, wsiS_reqFifo$D_OUT[57], 1'b0, addr__h18582, 12'd1 } ;
  ...
  assign fabWordsCurReq$D_IN =
	     (fabWordsRemain <= b__h21259) ? fabWordsRemain : b__h21259 ;
  ...
  assign respF_rCache$D_IN =
	     { 1'd1,
	       respF_rWrPtr,
	       IF_respF_wDataIn_whas__75_THEN_respF_wDataIn_w_ETC___d815,
	       respF_pwEnqueue$whas && respF_wDataIn$wget[57],
	       respF_pwEnqueue$whas && respF_wDataIn$wget[56],
	       IF_respF_wDataIn_whas__75_THEN_respF_wDataIn_w_ETC___d812 } ;
  ...
  // remaining internal signals
  assign IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d810 =
	     mesgLength[14] ? mesgLength[13:0] : 14'd0 ;
  assign IF_respF_wDataIn_whas__75_THEN_respF_wDataIn_w_ETC___d812 =
	     respF_pwEnqueue$whas ? respF_wDataIn$wget[55:0] : 56'd0 ;
  assign IF_respF_wDataIn_whas__75_THEN_respF_wDataIn_w_ETC___d815 =
	     respF_pwEnqueue$whas ? respF_wDataIn$wget[60:58] : 3'd0 ;
  assign NOT_wmi_reqF_c_r_57_EQ_2_58_59_AND_wmi_operate_ETC___d318 =
	     wmi_reqF_c_r != 2'd2 && wmi_operateD && wmi_peerIsReady &&
	     (!x__h21059 || wmi_mFlagF_c_r != 2'd2) ;
  assign addr__h18582 = { mesgLengthSoFar[11:0], 2'd0 } ;
  assign b__h14530 = -fabWordsCurReq[11:0] ;
  assign b__h21259 = { {2{fabRespCredit_value[11]}}, fabRespCredit_value } ;
  assign bl__h19634 =
	     zeroLengthMesg ?
	       12'd1 :
	       IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d810[13:2] ;
  assign mesgMetaF_length__h18735 = { 10'd0, mlp1B__h18566 } ;
  assign mesgMetaF_length__h19777 =
	     { 10'd0,
	       IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d810 } ;
  assign mesgMetaF_opcode__h18734 = opcode[8] ? opcode[7:0] : 8'd0 ;
  assign mlp1B__h18566 = { mlp1__h18565[11:0], 2'd0 } ;
  ...
  assign sendData_burstLength__h20734 =
	     (thisMesg[15:0] == 16'd0 || smaCtrl[5] && unrollCnt == 16'd1) ?
	       12'd1 :
	       (smaCtrl[5] ? 12'd4095 : wsiBurstLength__h20630[11:0]) ;
  assign sendData_byteEn__h20736 = (thisMesg[15:0] == 16'd0) ? 4'd0 : 4'd15 ;
  ...
  assign wmi_respF_i_notEmpty__78_AND_smaCtrl_3_BIT_4_7_ETC___d284 =
	     wmi_respF$EMPTY_N &&
	     (smaCtrl[4] || respF_rRdPtr + 12'd1024 != respF_rWrPtr) ;
  assign wsiBurstLength__h20630 =
  ...
  assign wsiS_reqFifo_notFull__29_AND_wsiS_burstKind_09_ETC___d449 =
	     wsiS_reqFifo$FULL_N &&
	     (wsiS_burstKind == 2'd0 ||
  ...
  assign x__h21059 = fabWordsRemain == fabWordsCurReq ;
