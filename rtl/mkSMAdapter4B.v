...
//
// On Sun Jul 11 06:47:14 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter4B(wciS0_Clk,
  ...
  wire [31 : 0] rdat__h15855,
		...
		rdat__h16057,
		rdat__h16065;
  wire [23 : 0] mesgMetaF_length__h17374, mesgMetaF_length__h18416;
  wire [15 : 0] wsiBurstLength__h19144, x__h15919, x_length__h17651;
  wire [13 : 0] IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d787,
		addr__h17221,
		b__h19765,
		mlp1B__h17205,
		mlp1__h17204;
  wire [11 : 0] bl__h18273, x_burstLength__h19240;
  wire [7 : 0] mesgMetaF_opcode__h17373;
  wire [3 : 0] b__h14307, x_byteEn__h19242;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, x_data__h15818 } ;
  ...
  assign MUX_wmi_mFlagF_x_wire$wset_1__SEL_2 =
	     WILL_FIRE_RL_wmrd_mesgBodyRequest && x__h19565 ;
  ...
  assign MUX_wmi_mFlagF_x_wire$wset_1__VAL_3 =
	     { mesgMetaF_opcode__h17373, mesgMetaF_length__h18416 } ;
  ...
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_2 =
	     { 4'd5, x__h19565, 1'b0, mesgReqAddr, fabWordsCurReq[11:0] } ;
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_3 =
	     { 4'd3, wsiS_reqFifo$D_OUT[57], 1'b0, addr__h17221, 12'd1 } ;
  ...
  assign fabWordsCurReq$D_IN =
	     (fabWordsRemain <= b__h19765) ? fabWordsRemain : b__h19765 ;
  ...
  assign x__h19565 = fabWordsRemain == fabWordsCurReq ;
  assign x_burstLength__h19240 =
	     (thisMesg[15:0] == 16'd0 || smaCtrl[5] && unrollCnt == 16'd1) ?
	       12'd1 :
	       (smaCtrl[5] ? 12'd4095 : wsiBurstLength__h19144[11:0]) ;
  assign x_byteEn__h19242 = (thisMesg[15:0] == 16'd0) ? 4'd0 : 4'd15 ;
