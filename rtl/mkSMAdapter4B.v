...
//
// On Fri Oct 29 10:34:30 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter4B(wciS0_Clk,
  ...
  wire [4 : 0] fabRespCredit_acc_v1$wget, fabRespCredit_acc_v2$wget;
  ...
  reg [4 : 0] fabRespCredit_value;
  wire [4 : 0] fabRespCredit_value$D_IN;
  ...
  wire [60 : 0] respF$D_IN, respF$D_OUT;
  ...
  wire [4 : 0] MUX_fabRespCredit_value$write_1__VAL_2;
  ...
  reg [63 : 0] v__h15957,
	       ...
	       v__h2833,
	       v__h3732;
  reg [31 : 0] value__h6111, x_data__h16092;
  wire [31 : 0] rdat__h16135,
		rdat__h16142,
		rdat__h16149,
		rdat__h16172,
		rdat__h16195,
		...
		rdat__h16337,
		rdat__h16345;
  wire [23 : 0] mesgMetaF_length__h17662, mesgMetaF_length__h18704;
  wire [15 : 0] wsiBurstLength__h19564, x__h16199, x_length__h17939;
  wire [13 : 0] IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d772,
		addr__h17509,
		b__h20161,
		mlp1B__h17493,
		mlp1__h17492;
  wire [11 : 0] bl__h18561, x1_burstLength__h19636;
  wire [7 : 0] mesgMetaF_opcode__h17661;
  wire [4 : 0] b__h14527;
  wire [3 : 0] x1_byteEn__h19638;
  wire NOT_wmi_reqF_c_r_57_EQ_2_58_59_AND_wmi_operate_ETC___d313,
       wmi_operateD_63_AND_wmi_peerIsReady_64_65_AND__ETC___d221,
       wsiS_reqFifo_i_notEmpty__66_AND_NOT_smaCtrl_3__ETC___d180,
       wsiS_reqFifo_notFull__93_AND_wsiS_burstKind_73_ETC___d413,
       x__h19961;
  ...
  // submodule respF
  arSRLFIFO #(.width(32'd61),
	      .l2depth(32'd4),
	      .depth(32'd16)) respF(.CLK(wciS0_Clk),
  ...
  assign CAN_FIRE_RL_wmrd_mesgBodyRequest =
	     NOT_wmi_reqF_c_r_57_EQ_2_58_59_AND_wmi_operate_ETC___d313 &&
	     wci_cState == 3'd2 &&
  ...
  assign CAN_FIRE_RL_wmrd_mesgBodyPreRequest =
	     ...
	     (fabRespCredit_value ^ 5'h10) > 5'd16 &&
	     mesgReqOK ;
  ...
  assign CAN_FIRE_RL_wmrd_mesgResptoWsi =
	     respF$EMPTY_N && wsiM_reqFifo_c_r != 2'd2 &&
	     wci_cState == 3'd2 &&
	     (smaCtrl[3:0] == 4'h1 || smaCtrl[3:0] == 4'h4 ||
	      smaCtrl[3:0] == 4'h9) ;
  ...
  assign CAN_FIRE_RL_wmrd_mesgBodyResponse =
	     wmi_respF$EMPTY_N && (smaCtrl[4] || respF$FULL_N) &&
	     wci_cState == 3'd2 &&
	     (smaCtrl[3:0] == 4'h1 || smaCtrl[3:0] == 4'h4 ||
	      smaCtrl[3:0] == 4'h9) &&
	     unrollCnt != 16'd0 ;
  ...
  assign CAN_FIRE_RL_wmi_mFlagF_both =
	     ((wmi_mFlagF_c_r == 2'd1) ?
		wmi_mFlagF_x_wire$whas :
		wmi_mFlagF_c_r != 2'd2 || wmi_mFlagF_x_wire$whas) &&
	     wmi_mFlagF_dequeueing$whas &&
	     wmi_mFlagF_x_wire$whas ;
  ...
  assign CAN_FIRE_RL_wmi_mFlagF_decCtr =
	     wmi_mFlagF_dequeueing$whas && !wmi_mFlagF_x_wire$whas ;
  ...
  assign CAN_FIRE_RL_wmi_mFlagF_incCtr =
	     ((wmi_mFlagF_c_r == 2'd0) ?
		wmi_mFlagF_x_wire$whas :
		wmi_mFlagF_c_r != 2'd1 || wmi_mFlagF_x_wire$whas) &&
	     wmi_mFlagF_x_wire$whas &&
	     !wmi_mFlagF_dequeueing$whas ;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, x_data__h16092 } ;
  ...
  assign MUX_wmi_mFlagF_x_wire$wset_1__SEL_2 =
	     WILL_FIRE_RL_wmrd_mesgBodyRequest && x__h19961 ;
  ...
  assign MUX_fabRespCredit_value$write_1__VAL_2 =
	     fabRespCredit_value +
	     (CAN_FIRE_RL_wmrd_mesgBodyRequest ? b__h14527 : 5'd0) +
	     (CAN_FIRE_RL_wmrd_mesgResptoWsi ? 5'd1 : 5'd0) ;
  ...
  assign MUX_mesgLength$write_1__VAL_4 = { 1'd1, mlp1B__h17493 } ;
  ...
  assign MUX_thisMesg$write_1__VAL_1 =
	     { mesgCount[7:0], mesgMetaF_opcode__h17661, x_length__h17939 } ;
  ...
  assign MUX_wmi_mFlagF_x_wire$wset_1__VAL_1 =
	     { mesgMetaF_opcode__h17661, mesgMetaF_length__h17662 } ;
  assign MUX_wmi_mFlagF_x_wire$wset_1__VAL_3 =
	     { mesgMetaF_opcode__h17661, mesgMetaF_length__h18704 } ;
  assign MUX_wmi_mFlagF_q_0$write_1__VAL_1 =
	     (wmi_mFlagF_c_r == 2'd1) ? value__h6111 : wmi_mFlagF_q_1 ;
  assign MUX_wmi_mFlagF_q_1$write_1__VAL_1 =
	     (wmi_mFlagF_c_r == 2'd2) ? value__h6111 : 32'd0 ;
  assign MUX_wmi_reqF_c_r$write_1__VAL_1 = wmi_reqF_c_r - 2'd1 ;
  assign MUX_wmi_reqF_c_r$write_1__VAL_2 = wmi_reqF_c_r + 2'd1 ;
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_1 = { 20'd229376, bl__h18561 } ;
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_2 =
	     { 4'd5, x__h19961, 1'b0, mesgReqAddr, fabWordsCurReq[11:0] } ;
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_3 =
	     { 4'd3, wsiS_reqFifo$D_OUT[57], 1'b0, addr__h17509, 12'd1 } ;
  ...
  assign wmi_mFlagF_x_wire$wget = value__h6111 ;
  assign wmi_mFlagF_x_wire$whas =
	     WILL_FIRE_RL_wmwt_messagePushImprecise &&
	     wsiS_reqFifo$D_OUT[57] ||
	     WILL_FIRE_RL_wmrd_mesgBodyRequest && x__h19961 ||
	     WILL_FIRE_RL_wmwt_requestPrecise ;
  assign wmi_mFlagF_enqueueing$whas = wmi_mFlagF_x_wire$whas ;
  ...
  assign fabRespCredit_acc_v1$wget = b__h14527 ;
  assign fabRespCredit_acc_v1$whas = CAN_FIRE_RL_wmrd_mesgBodyRequest ;
  assign fabRespCredit_acc_v2$wget = 5'd1 ;
  ...
  assign fabWordsCurReq$D_IN =
	     (fabWordsRemain <= b__h20161) ? fabWordsRemain : b__h20161 ;
  ...
  assign mesgLengthSoFar$D_IN =
	     MUX_impreciseBurst$write_1__SEL_2 ? 14'd0 : mlp1__h17492 ;
  ...
  always@(WILL_FIRE_RL_wmi_mFlagF_both or
	  ...
	  value__h6111 or WILL_FIRE_RL_wmi_mFlagF_decCtr or wmi_mFlagF_q_1)
  begin
    case (1'b1) // synopsys parallel_case
      WILL_FIRE_RL_wmi_mFlagF_both:
	  wmi_mFlagF_q_0$D_IN = MUX_wmi_mFlagF_q_0$write_1__VAL_1;
      MUX_wmi_mFlagF_q_0$write_1__SEL_2: wmi_mFlagF_q_0$D_IN = value__h6111;
  ...
  always@(WILL_FIRE_RL_wmi_mFlagF_both or
	  ...
	  value__h6111 or WILL_FIRE_RL_wmi_mFlagF_decCtr)
  begin
    case (1'b1) // synopsys parallel_case
      WILL_FIRE_RL_wmi_mFlagF_both:
	  wmi_mFlagF_q_1$D_IN = MUX_wmi_mFlagF_q_1$write_1__VAL_1;
      MUX_wmi_mFlagF_q_1$write_1__SEL_2: wmi_mFlagF_q_1$D_IN = value__h6111;
  ...
  assign respF$D_IN =
	     { 3'd1,
	       unrollCnt == 16'd1,
	       !smaCtrl[5],
	       x1_burstLength__h19636,
	       wmi_respF$D_OUT[31:0],
	       x1_byteEn__h19638,
	       thisMesg[23:16] } ;
  assign respF$ENQ = WILL_FIRE_RL_wmrd_mesgBodyResponse && !smaCtrl[4] ;
  assign respF$DEQ = CAN_FIRE_RL_wmrd_mesgResptoWsi ;
  ...
  // remaining internal signals
  assign IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d772 =
	     mesgLength[14] ? mesgLength[13:0] : 14'd0 ;
  assign NOT_wmi_reqF_c_r_57_EQ_2_58_59_AND_wmi_operate_ETC___d313 =
	     wmi_reqF_c_r != 2'd2 && wmi_operateD && wmi_peerIsReady &&
	     (!x__h19961 || wmi_mFlagF_c_r != 2'd2) ;
  assign addr__h17509 = { mesgLengthSoFar[11:0], 2'd0 } ;
  assign b__h14527 = -fabWordsCurReq[4:0] ;
  assign b__h20161 = { {9{fabRespCredit_value[4]}}, fabRespCredit_value } ;
  assign bl__h18561 =
	     zeroLengthMesg ?
	       12'd1 :
	       IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d772[13:2] ;
  assign mesgMetaF_length__h17662 = { 10'd0, mlp1B__h17493 } ;
  assign mesgMetaF_length__h18704 =
	     { 10'd0,
	       IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d772 } ;
  assign mesgMetaF_opcode__h17661 = opcode[8] ? opcode[7:0] : 8'd0 ;
  assign mlp1B__h17493 = { mlp1__h17492[11:0], 2'd0 } ;
  assign mlp1__h17492 = mesgLengthSoFar + 14'd1 ;
  assign rdat__h16135 = hasDebugLogic ? mesgCount : 32'd0 ;
  assign rdat__h16142 = hasDebugLogic ? abortCount : 32'd0 ;
  assign rdat__h16149 = hasDebugLogic ? thisMesg : 32'd0 ;
  assign rdat__h16172 = hasDebugLogic ? lastMesg : 32'd0 ;
  assign rdat__h16195 = hasDebugLogic ? { 16'd0, x__h16199 } : 32'd0 ;
  assign rdat__h16295 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h16309 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h16317 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h16323 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h16337 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h16345 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  ...
  assign wsiS_reqFifo_notFull__93_AND_wsiS_burstKind_73_ETC___d413 =
	     wsiS_reqFifo$FULL_N &&
	     (wsiS_burstKind == 2'd0 ||
	      (wsiS_burstKind == 2'd1 || wsiS_burstKind == 2'd2) &&
	      wsiS_wsiReq$wget[57]) ;
  assign x1_burstLength__h19636 =
	     (thisMesg[15:0] == 16'd0 || smaCtrl[5] && unrollCnt == 16'd1) ?
	       12'd1 :
	       (smaCtrl[5] ? 12'd4095 : wsiBurstLength__h19564[11:0]) ;
  assign x1_byteEn__h19638 = (thisMesg[15:0] == 16'd0) ? 4'd0 : 4'd15 ;
  assign x__h16199 = { wsiS_statusR, wsiM_statusR } ;
  assign x__h19961 = fabWordsRemain == fabWordsCurReq ;
  assign x_length__h17939 =
	     { 2'd0,
	       IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d772 } ;
  always@(wci_reqF$D_OUT or
	  ...
	  rdat__h16295 or
	  rdat__h16309 or
	  rdat__h16317 or rdat__h16323 or rdat__h16337 or rdat__h16345)
  begin
    case (wci_reqF$D_OUT[39:32])
      8'h0: x_data__h16092 = smaCtrl;
      8'h04: x_data__h16092 = rdat__h16135;
      8'h08: x_data__h16092 = rdat__h16142;
      8'h10: x_data__h16092 = rdat__h16149;
      8'h14: x_data__h16092 = rdat__h16172;
      8'h18: x_data__h16092 = rdat__h16195;
      8'h20: x_data__h16092 = rdat__h16295;
      8'h24: x_data__h16092 = rdat__h16309;
      8'h28: x_data__h16092 = rdat__h16317;
      8'h2C: x_data__h16092 = rdat__h16323;
      8'h30: x_data__h16092 = rdat__h16337;
      8'h34: x_data__h16092 = rdat__h16345;
      default: x_data__h16092 = 32'd0;
    endcase
  end
  always@(MUX_endOfMessage$write_1__SEL_1 or
  ...
  begin
    case (1'b1) // synopsys parallel_case
      MUX_endOfMessage$write_1__SEL_1:
	  value__h6111 = MUX_wmi_mFlagF_x_wire$wset_1__VAL_1;
      MUX_wmi_mFlagF_x_wire$wset_1__SEL_2:
	  value__h6111 = 32'hAAAAAAAA /* unspecified value */ ;
      WILL_FIRE_RL_wmwt_requestPrecise:
	  value__h6111 = MUX_wmi_mFlagF_x_wire$wset_1__VAL_3;
      default: value__h6111 = 32'hAAAAAAAA /* unspecified value */ ;
    endcase
  end
  ...
  begin
	...
	fabRespCredit_value <= `BSV_ASSIGNMENT_DELAY 5'd0;
  ...
  begin
    ...
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wmwt_doAbort)
	$display("[%0d]: %m: wmwt_doAbort", v__h17154);
    if (wciS0_MReset_n)
