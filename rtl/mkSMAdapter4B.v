...
//
// On Fri Oct 22 08:41:39 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter4B(wciS0_Clk,
  ...
  wire [31 : 0] rdat__h16095,
		...
		rdat__h16297,
		rdat__h16305;
  wire [23 : 0] mesgMetaF_length__h17614, mesgMetaF_length__h18656;
  wire [15 : 0] wsiBurstLength__h19516, x__h16159, x_length__h17891;
  wire [13 : 0] IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d788,
		addr__h17461,
		b__h20113,
		mlp1B__h17445,
		mlp1__h17444;
  wire [11 : 0] bl__h18513, x1_burstLength__h19588;
  wire [7 : 0] mesgMetaF_opcode__h17613;
  wire [4 : 0] b__h14495;
  wire [3 : 0] x1_byteEn__h19590;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, x_data__h16058 } ;
  ...
  assign MUX_wmi_mFlagF_x_wire$wset_1__SEL_2 =
	     WILL_FIRE_RL_wmrd_mesgBodyRequest && x__h19913 ;
  ...
  assign MUX_wmi_mFlagF_x_wire$wset_1__VAL_3 =
	     { mesgMetaF_opcode__h17613, mesgMetaF_length__h18656 } ;
  ...
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_2 =
	     { 4'd5, x__h19913, 1'b0, mesgReqAddr, fabWordsCurReq[11:0] } ;
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_3 =
	     { 4'd3, wsiS_reqFifo$D_OUT[57], 1'b0, addr__h17461, 12'd1 } ;
  ...
  assign fabWordsCurReq$D_IN =
	     (fabWordsRemain <= b__h20113) ? fabWordsRemain : b__h20113 ;
  ...
  assign NOT_wmi_reqF_c_r_57_EQ_2_58_59_AND_wmi_operate_ETC___d313 =
	     ...
	     (!x__h19913 || wmi_mFlagF_c_r != 2'd2) ;
  assign addr__h17461 = { mesgLengthSoFar[11:0], 2'd0 } ;
  assign b__h14495 = -fabWordsCurReq[4:0] ;
  assign b__h20113 = { {9{fabRespCredit_value[4]}}, fabRespCredit_value } ;
  assign bl__h18513 =
	     zeroLengthMesg ?
	       12'd1 :
	       IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d788[13:2] ;
  assign mesgMetaF_length__h17614 = { 10'd0, mlp1B__h17445 } ;
  assign mesgMetaF_length__h18656 =
	     { 10'd0,
	       IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d788 } ;
  assign mesgMetaF_opcode__h17613 = opcode[8] ? opcode[7:0] : 8'd0 ;
  assign mlp1B__h17445 = { mlp1__h17444[11:0], 2'd0 } ;
  ...
  assign wsiS_reqFifo_notFull__93_AND_wsiS_burstKind_73_ETC___d413 =
	     ...
	     (wsiS_burstKind == 2'd0 ||
	      ...
	      wsiS_wsiReq$wget[57]) ;
  assign x1_burstLength__h19588 =
	     (thisMesg[15:0] == 16'd0 || smaCtrl[5] && unrollCnt == 16'd1) ?
	       12'd1 :
	       (smaCtrl[5] ? 12'd4095 : wsiBurstLength__h19516[11:0]) ;
  assign x1_byteEn__h19590 = (thisMesg[15:0] == 16'd0) ? 4'd0 : 4'd15 ;
  assign x__h16159 = { wsiS_statusR, wsiM_statusR } ;
  assign x__h19913 = fabWordsRemain == fabWordsCurReq ;
