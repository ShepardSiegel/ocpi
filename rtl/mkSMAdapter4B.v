...
//
// On Thu Jun 10 07:46:14 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter4B(wciS0_Clk,
  ...
  wire [13 : 0] IF_mesgLength_22_BIT_14_23_THEN_mesgLength_22__ETC___d748,
		addr__h16647,
		b__h19084,
		mlp1B__h16631,
		mlp1__h16630;
  ...
  wire NOT_wmi_dhF_c_r_50_EQ_2_51_52_AND_wmi_operateD_ETC___d165,
       NOT_wmi_reqF_c_r_47_EQ_2_48_49_AND_wmi_operate_ETC___d290,
  ...
  assign MUX_wmi_dhF_x_wire$wset_1__VAL_2 =
	     { 1'd1, x__h16715, wsiS_reqFifo$D_OUT[43:12], 4'd15 } ;
  ...
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_2 =
	     { 4'd5, x__h18884, 1'b0, mesgReqAddr, fabWordsCurReq[11:0] } ;
  ...
  // remaining internal signals
  assign IF_mesgLength_22_BIT_14_23_THEN_mesgLength_22__ETC___d748 =
  ...
  assign NOT_wmi_reqF_c_r_47_EQ_2_48_49_AND_wmi_operate_ETC___d290 =
	     wmi_reqF_c_r != 2'd2 && wmi_operateD && wmi_peerIsReady &&
	     (!x__h18884 || wmi_mFlagF_c_r != 2'd2) ;
  ...
  assign bl__h17580 =
	     zeroLengthMesg ?
	       12'd1 :
	       IF_mesgLength_22_BIT_14_23_THEN_mesgLength_22__ETC___d748[13:2] ;
  assign mesgMetaF_length__h16810 = { 10'd0, mlp1B__h16631 } ;
  assign mesgMetaF_length__h17723 =
	     { 10'd0,
	       IF_mesgLength_22_BIT_14_23_THEN_mesgLength_22__ETC___d748 } ;
  ...
  assign x_burstLength__h18559 =
	     (thisMesg[15:0] == 16'd0 || smaCtrl[5] && unrollCnt == 16'd1) ?
	       12'd1 :
	       (smaCtrl[5] ? 12'd4095 : wsiBurstLength__h18454[11:0]) ;
  assign x_byteEn__h18561 = (thisMesg[15:0] == 16'd0) ? 4'd0 : 4'd15 ;
