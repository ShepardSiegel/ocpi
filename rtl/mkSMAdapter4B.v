...
//
// On Tue Feb  8 15:40:56 EST 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter4B(wciS0_Clk,
  ...
  reg [63 : 0] v__h18176,
	       ...
	       v__h3761,
	       v__h3905;
  reg [31 : 0] g_data__h22293, value__h6563;
  wire [55 : 0] IF_respF_wDataIn_whas__43_THEN_respF_wDataIn_w_ETC___d954;
  wire [31 : 0] rdat__h22336,
		rdat__h22342,
		rdat__h22348,
		rdat__h22361,
		rdat__h22384,
		...
		rdat__h22552,
		rdat__h22558;
  wire [23 : 0] mesgMetaF_length__h20100, mesgMetaF_length__h20860;
  wire [15 : 0] wsiBurstLength__h18638, x__h22388, x_length__h19855;
  wire [13 : 0] addr__h20730,
		b__h18260,
		mlp1B__h20690,
		mlp1__h20689,
		x__h19873;
  wire [11 : 0] b__h14952,
		...
		x__h16306;
  wire [7 : 0] x__h19859;
  wire [3 : 0] sendData_byteEn__h18722;
  wire [2 : 0] IF_respF_wDataIn_whas__43_THEN_respF_wDataIn_w_ETC___d945;
  wire NOT_wmi_reqF_c_r_56_EQ_2_75_76_AND_wmi_operate_ETC___d527,
       wmi_operateD_42_AND_wmi_peerIsReady_43_44_AND__ETC___d624,
       wmi_respF_i_notEmpty__39_AND_smaCtrl_75_BIT_4__ETC___d544,
       wsiS_reqFifo_i_notEmpty__74_AND_NOT_smaCtrl_75_ETC___d643,
  ...
  assign MUX_mesgLength$write_1__VAL_3 = { 1'd1, mlp1B__h20690 } ;
  ...
  assign MUX_thisMesg$write_1__VAL_1 =
	     { mesgCount[7:0], x__h19859, x_length__h19855 } ;
  ...
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_2 = { 2'd1, g_data__h22293 } ;
  ...
  assign MUX_wmi_mFlagF_x_wire$wset_1__VAL_2 =
	     { x__h19859, mesgMetaF_length__h20860 } ;
  assign MUX_wmi_mFlagF_x_wire$wset_1__VAL_3 =
	     { x__h19859, mesgMetaF_length__h20100 } ;
  ...
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_2 = { 20'd229376, bl__h19962 } ;
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_3 =
	     { 4'd3, wsiS_reqFifo$D_OUT[57], 1'b0, addr__h20730, 12'd1 } ;
  ...
  assign mesgLengthSoFar$D_IN =
	     MUX_impreciseBurst$write_1__SEL_3 ? 14'd0 : mlp1__h20689 ;
  ...
  assign respF_rCache$D_IN =
	     { 1'd1,
	       respF_rWrPtr,
	       IF_respF_wDataIn_whas__43_THEN_respF_wDataIn_w_ETC___d945,
	       respF_pwEnqueue$whas && respF_wDataIn$wget[57],
	       respF_pwEnqueue$whas && respF_wDataIn$wget[56],
	       IF_respF_wDataIn_whas__43_THEN_respF_wDataIn_w_ETC___d954 } ;
  ...
  begin
    case (1'b1) // synopsys parallel_case
      MUX_wmi_mFlagF_q_0$write_1__SEL_1: wmi_mFlagF_q_0$D_IN = value__h6563;
      WILL_FIRE_RL_wmi_mFlagF_both:
  ...
  begin
    case (1'b1) // synopsys parallel_case
      MUX_wmi_mFlagF_q_1$write_1__SEL_1: wmi_mFlagF_q_1$D_IN = value__h6563;
      WILL_FIRE_RL_wmi_mFlagF_both:
  ...
  // remaining internal signals
  assign IF_respF_wDataIn_whas__43_THEN_respF_wDataIn_w_ETC___d945 =
	     respF_pwEnqueue$whas ? respF_wDataIn$wget[60:58] : 3'd0 ;
  assign IF_respF_wDataIn_whas__43_THEN_respF_wDataIn_w_ETC___d954 =
  ...
  assign addr__h20730 = { mesgLengthSoFar[11:0], 2'd0 } ;
  assign b__h14952 = -fabWordsCurReq[11:0] ;
  assign b__h18260 = { {2{fabRespCredit_value[11]}}, fabRespCredit_value } ;
  assign bl__h19962 = zeroLengthMesg ? 12'd1 : x__h19873[13:2] ;
  assign mesgMetaF_length__h20100 = { 10'd0, x__h19873 } ;
  assign mesgMetaF_length__h20860 = { 10'd0, mlp1B__h20690 } ;
  assign mlp1B__h20690 = { mlp1__h20689[11:0], 2'd0 } ;
  assign mlp1__h20689 = mesgLengthSoFar + 14'd1 ;
  assign rdat__h22336 = hasDebugLogic ? mesgCount : 32'd0 ;
  assign rdat__h22342 = hasDebugLogic ? abortCount : 32'd0 ;
  assign rdat__h22348 = hasDebugLogic ? thisMesg : 32'd0 ;
  assign rdat__h22361 = hasDebugLogic ? lastMesg : 32'd0 ;
  assign rdat__h22384 = hasDebugLogic ? { 16'd0, x__h22388 } : 32'd0 ;
  assign rdat__h22484 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h22498 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h22506 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h22512 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h22526 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h22534 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h22540 = hasDebugLogic ? wmwtBeginCount : 32'd0 ;
  assign rdat__h22546 = hasDebugLogic ? wmwtPImpCount : 32'd0 ;
  assign rdat__h22552 = hasDebugLogic ? wmwtFinalCount : 32'd0 ;
  assign rdat__h22558 = hasDebugLogic ? 32'hFEEDC0DE : 32'd0 ;
  ...
  assign sendData_byteEn__h18722 = (thisMesg[15:0] == 16'd0) ? 4'd0 : 4'd15 ;
  assign wmi_operateD_42_AND_wmi_peerIsReady_43_44_AND__ETC___d624 =
  ...
  assign wsiS_reqFifo_i_notEmpty__74_AND_NOT_smaCtrl_75_ETC___d643 =
	     wsiS_reqFifo$EMPTY_N &&
	     (smaCtrl[3:0] != 4'h3 || wsiM_reqFifo_c_r != 2'd2) &&
  ...
  assign x__h19859 = opcode[8] ? opcode[7:0] : 8'd0 ;
  assign x__h19873 = mesgLength[14] ? mesgLength[13:0] : 14'd0 ;
  assign x__h22388 = { wsiS_statusR, wsiM_statusR } ;
  assign x_length__h19855 = { 2'd0, x__h19873 } ;
  ...
  always@(wci_wslv_reqF$D_OUT or
	  ...
	  rdat__h22526 or
	  rdat__h22534 or
	  rdat__h22540 or rdat__h22546 or rdat__h22552 or rdat__h22558)
  begin
    case (wci_wslv_reqF$D_OUT[39:32])
      8'h0: g_data__h22293 = smaCtrl;
      8'h04: g_data__h22293 = rdat__h22336;
      8'h08: g_data__h22293 = rdat__h22342;
      8'h10: g_data__h22293 = rdat__h22348;
      8'h14: g_data__h22293 = rdat__h22361;
      8'h18: g_data__h22293 = rdat__h22384;
      8'h20: g_data__h22293 = rdat__h22484;
      8'h24: g_data__h22293 = rdat__h22498;
      8'h28: g_data__h22293 = rdat__h22506;
      8'h2C: g_data__h22293 = rdat__h22512;
      8'h30: g_data__h22293 = rdat__h22526;
      8'h34: g_data__h22293 = rdat__h22534;
      8'h38: g_data__h22293 = rdat__h22540;
      8'h3C: g_data__h22293 = rdat__h22546;
      8'h40: g_data__h22293 = rdat__h22552;
      8'h44: g_data__h22293 = rdat__h22558;
      default: g_data__h22293 = 32'd0;
    endcase
  end
  ...
  begin
    ...
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wmwt_doAbort)
	$display("[%0d]: %m: wmwt_doAbort", v__h21625);
    if (wciS0_MReset_n)
