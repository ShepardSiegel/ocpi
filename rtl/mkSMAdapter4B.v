...
//
// On Wed Feb  9 16:47:39 EST 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter4B(wciS0_Clk,
  ...
  reg [63 : 0] v__h18255,
	       ...
	       v__h3761,
	       v__h3905;
  reg [31 : 0] g_data__h22442, value__h6563;
  wire [55 : 0] IF_respF_wDataIn_whas__43_THEN_respF_wDataIn_w_ETC___d844;
  wire [31 : 0] rdat__h22485,
		rdat__h22491,
		rdat__h22497,
		rdat__h22510,
		rdat__h22533,
		...
		rdat__h22701,
		rdat__h22707;
  wire [23 : 0] mesgMetaF_length__h20213, mesgMetaF_length__h20973;
  wire [15 : 0] wsiBurstLength__h18717, x__h22537, x_length__h19968;
  wire [13 : 0] addr__h20843,
		b__h18339,
		mlp1B__h20803,
		mlp1__h20802,
		x__h19986;
  wire [11 : 0] b__h14952,
		...
		x__h16306;
  wire [7 : 0] x__h19972;
  wire [3 : 0] sendData_byteEn__h18801;
  wire [2 : 0] IF_respF_wDataIn_whas__43_THEN_respF_wDataIn_w_ETC___d841;
  wire NOT_wmi_reqF_c_r_56_EQ_2_75_76_AND_wmi_operate_ETC___d527,
       wci_wslv_cState_5_EQ_2_6_AND_smaCtrl_75_BITS_3_ETC___d699,
       wmi_operateD_42_AND_wmi_peerIsReady_43_44_AND__ETC___d626,
       wmi_respF_i_notEmpty__39_AND_smaCtrl_75_BIT_4__ETC___d544,
       wsiS_reqFifo_i_notEmpty__74_AND_NOT_smaCtrl_75_ETC___d645,
  ...
  assign MUX_mesgLength$write_1__VAL_3 = { 1'd1, mlp1B__h20803 } ;
  ...
  assign MUX_thisMesg$write_1__VAL_1 =
	     { mesgCount[7:0], x__h19972, x_length__h19968 } ;
  ...
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_2 = { 2'd1, g_data__h22442 } ;
  ...
  assign MUX_wmi_mFlagF_x_wire$wset_1__VAL_2 =
	     { x__h19972, mesgMetaF_length__h20973 } ;
  assign MUX_wmi_mFlagF_x_wire$wset_1__VAL_3 =
	     { x__h19972, mesgMetaF_length__h20213 } ;
  ...
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_2 = { 20'd229376, bl__h20075 } ;
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_3 =
	     { 4'd3, wsiS_reqFifo$D_OUT[57], 1'b0, addr__h20843, 12'd1 } ;
  ...
  assign mesgLengthSoFar$D_IN =
	     MUX_impreciseBurst$write_1__SEL_3 ? 14'd0 : mlp1__h20802 ;
  ...
  assign respF_rCache$D_IN =
	     { 1'd1,
	       respF_rWrPtr,
	       IF_respF_wDataIn_whas__43_THEN_respF_wDataIn_w_ETC___d841,
  ...
  // remaining internal signals
  assign IF_respF_wDataIn_whas__43_THEN_respF_wDataIn_w_ETC___d841 =
  ...
  assign addr__h20843 = { mesgLengthSoFar[11:0], 2'd0 } ;
  assign b__h14952 = -fabWordsCurReq[11:0] ;
  assign b__h18339 = { {2{fabRespCredit_value[11]}}, fabRespCredit_value } ;
  assign bl__h20075 = zeroLengthMesg ? 12'd1 : x__h19986[13:2] ;
  assign mesgMetaF_length__h20213 = { 10'd0, x__h19986 } ;
  assign mesgMetaF_length__h20973 =
	     (wsiS_reqFifo$D_OUT[57] && wsiS_reqFifo$D_OUT[11:8] == 4'd0 &&
	      mesgLengthSoFar == 14'd0) ?
	       24'd0 :
	       { 10'd0, mlp1B__h20803 } ;
  assign mlp1B__h20803 = { mlp1__h20802[11:0], 2'd0 } ;
  assign mlp1__h20802 = mesgLengthSoFar + 14'd1 ;
  assign rdat__h22485 = hasDebugLogic ? mesgCount : 32'd0 ;
  assign rdat__h22491 = hasDebugLogic ? abortCount : 32'd0 ;
  assign rdat__h22497 = hasDebugLogic ? thisMesg : 32'd0 ;
  assign rdat__h22510 = hasDebugLogic ? lastMesg : 32'd0 ;
  assign rdat__h22533 = hasDebugLogic ? { 16'd0, x__h22537 } : 32'd0 ;
  assign rdat__h22633 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h22647 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h22655 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h22661 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h22675 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h22683 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h22689 = hasDebugLogic ? wmwtBeginCount : 32'd0 ;
  assign rdat__h22695 = hasDebugLogic ? wmwtPImpCount : 32'd0 ;
  assign rdat__h22701 = hasDebugLogic ? wmwtFinalCount : 32'd0 ;
  assign rdat__h22707 = hasDebugLogic ? 32'hFEEDC0DE : 32'd0 ;
  ...
  assign sendData_byteEn__h18801 = (thisMesg[15:0] == 16'd0) ? 4'd0 : 4'd15 ;
  assign wci_wslv_cState_5_EQ_2_6_AND_smaCtrl_75_BITS_3_ETC___d699 =
	     wci_wslv_cState == 3'd2 &&
	     (smaCtrl[3:0] == 4'h2 || smaCtrl[3:0] == 4'h3) &&
	     mesgLength[14] &&
	     !doAbort &&
  ...
  assign wmi_operateD_42_AND_wmi_peerIsReady_43_44_AND__ETC___d626 =
  ...
  assign wsiS_reqFifo_i_notEmpty__74_AND_NOT_smaCtrl_75_ETC___d645 =
	     wsiS_reqFifo$EMPTY_N &&
	     (smaCtrl[3:0] != 4'h3 || wsiM_reqFifo_c_r != 2'd2) &&
  ...
  assign x__h19972 = opcode[8] ? opcode[7:0] : 8'd0 ;
  assign x__h19986 = mesgLength[14] ? mesgLength[13:0] : 14'd0 ;
  assign x__h22537 = { wsiS_statusR, wsiM_statusR } ;
  assign x_length__h19968 = { 2'd0, x__h19986 } ;
  always@(wci_wslv_reqF$D_OUT or
	  ...
	  rdat__h22675 or
	  rdat__h22683 or
	  rdat__h22689 or rdat__h22695 or rdat__h22701 or rdat__h22707)
  begin
    case (wci_wslv_reqF$D_OUT[39:32])
      8'h0: g_data__h22442 = smaCtrl;
      8'h04: g_data__h22442 = rdat__h22485;
      8'h08: g_data__h22442 = rdat__h22491;
      8'h10: g_data__h22442 = rdat__h22497;
      8'h14: g_data__h22442 = rdat__h22510;
      8'h18: g_data__h22442 = rdat__h22533;
      8'h20: g_data__h22442 = rdat__h22633;
      8'h24: g_data__h22442 = rdat__h22647;
      8'h28: g_data__h22442 = rdat__h22655;
      8'h2C: g_data__h22442 = rdat__h22661;
      8'h30: g_data__h22442 = rdat__h22675;
      8'h34: g_data__h22442 = rdat__h22683;
      8'h38: g_data__h22442 = rdat__h22689;
      8'h3C: g_data__h22442 = rdat__h22695;
      8'h40: g_data__h22442 = rdat__h22701;
      8'h44: g_data__h22442 = rdat__h22707;
      default: g_data__h22442 = 32'd0;
    endcase
  end
  ...
  begin
    ...
    if (wciS0_MReset_n)
      if (MUX_opcode$write_1__SEL_2)
	$display("[%0d]: %m: wmwt_doAbort", v__h21741);
    if (wciS0_MReset_n)
