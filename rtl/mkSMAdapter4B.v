...
//
// On Fri Jan  7 15:23:51 EST 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter4B(wciS0_Clk,
  ...
  wire [31 : 0] rdat__h21434,
		...
		rdat__h21624,
		rdat__h21632;
  wire [23 : 0] mesgMetaF_length__h19379, mesgMetaF_length__h20115;
  wire [15 : 0] wsiBurstLength__h18046, x__h21486, x_length__h19134;
  wire [13 : 0] addr__h19985,
		b__h17668,
		mlp1B__h19969,
		mlp1__h19968,
		x__h19152;
  wire [11 : 0] b__h14480,
		...
		x__h15834;
  wire [7 : 0] x__h19138;
  wire [3 : 0] sendData_byteEn__h18130;
  ...
  assign MUX_mesgLength$write_1__VAL_3 = { 1'd1, mlp1B__h19969 } ;
  ...
  assign MUX_thisMesg$write_1__VAL_1 =
	     { mesgCount[7:0], x__h19138, x_length__h19134 } ;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, g_data__h21391 } ;
  ...
  assign MUX_wmi_mFlagF_x_wire$wset_1__VAL_2 =
	     { x__h19138, mesgMetaF_length__h20115 } ;
  assign MUX_wmi_mFlagF_x_wire$wset_1__VAL_3 =
	     { x__h19138, mesgMetaF_length__h19379 } ;
  ...
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_2 = { 20'd229376, bl__h19241 } ;
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_3 =
	     { 4'd3, wsiS_reqFifo$D_OUT[57], 1'b0, addr__h19985, 12'd1 } ;
  ...
  assign mesgLengthSoFar$D_IN =
	     MUX_impreciseBurst$write_1__SEL_3 ? 14'd0 : mlp1__h19968 ;
  ...
  assign addr__h19985 = { mesgLengthSoFar[11:0], 2'd0 } ;
  assign b__h14480 = -fabWordsCurReq[11:0] ;
  assign b__h17668 = { {2{fabRespCredit_value[11]}}, fabRespCredit_value } ;
  assign bl__h19241 = zeroLengthMesg ? 12'd1 : x__h19152[13:2] ;
  assign mesgMetaF_length__h19379 = { 10'd0, x__h19152 } ;
  assign mesgMetaF_length__h20115 = { 10'd0, mlp1B__h19969 } ;
  assign mlp1B__h19969 = { mlp1__h19968[11:0], 2'd0 } ;
  assign mlp1__h19968 = mesgLengthSoFar + 14'd1 ;
  assign rdat__h21434 = hasDebugLogic ? mesgCount : 32'd0 ;
  assign rdat__h21440 = hasDebugLogic ? abortCount : 32'd0 ;
  assign rdat__h21446 = hasDebugLogic ? thisMesg : 32'd0 ;
  assign rdat__h21459 = hasDebugLogic ? lastMesg : 32'd0 ;
  assign rdat__h21482 = hasDebugLogic ? { 16'd0, x__h21486 } : 32'd0 ;
  assign rdat__h21582 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h21596 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h21604 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h21610 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h21624 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h21632 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  ...
  assign sendData_byteEn__h18130 = (thisMesg[15:0] == 16'd0) ? 4'd0 : 4'd15 ;
  ...
  assign x__h19138 = opcode[8] ? opcode[7:0] : 8'd0 ;
  assign x__h19152 = mesgLength[14] ? mesgLength[13:0] : 14'd0 ;
  assign x__h21486 = { wsiS_statusR, wsiM_statusR } ;
  assign x_length__h19134 = { 2'd0, x__h19152 } ;
  always@(wci_reqF$D_OUT or
	  ...
	  rdat__h21582 or
	  rdat__h21596 or
	  rdat__h21604 or rdat__h21610 or rdat__h21624 or rdat__h21632)
  begin
    case (wci_reqF$D_OUT[39:32])
      8'h0: g_data__h21391 = smaCtrl;
      8'h04: g_data__h21391 = rdat__h21434;
      8'h08: g_data__h21391 = rdat__h21440;
      8'h10: g_data__h21391 = rdat__h21446;
      8'h14: g_data__h21391 = rdat__h21459;
      8'h18: g_data__h21391 = rdat__h21482;
      8'h20: g_data__h21391 = rdat__h21582;
      8'h24: g_data__h21391 = rdat__h21596;
      8'h28: g_data__h21391 = rdat__h21604;
      8'h2C: g_data__h21391 = rdat__h21610;
      8'h30: g_data__h21391 = rdat__h21624;
      8'h34: g_data__h21391 = rdat__h21632;
      default: g_data__h21391 = 32'd0;
    endcase
  end
  ...
  begin
    ...
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wmwt_doAbort)
	$display("[%0d]: %m: wmwt_doAbort", v__h20798);
    if (wciS0_MReset_n)
