...
//
// On Wed Jun 22 17:50:59 EDT 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter4B(wciS0_Clk,
  ...
  reg [63 : 0] v__h18234,
	       ...
	       v__h3825,
	       v__h3969;
  reg [31 : 0] g_data__h24599;
  wire [55 : 0] IF_respF_wDataIn_whas__45_THEN_respF_wDataIn_w_ETC___d997;
  wire [31 : 0] rdat__h24642,
		rdat__h24648,
		rdat__h24654,
		rdat__h24667,
		rdat__h24690,
		...
		value__h6627,
		x__h18834;
  wire [23 : 0] mesgMetaF_length__h23231;
  wire [15 : 0] wsiBurstLength__h18693, x__h24694, x_length__h23630;
  wire [13 : 0] addr__h23097, b__h18318, mlB__h23057, mlInc__h23056;
  wire [11 : 0] b__h15201, sendData_burstLength__h18775, x__h16555;
  wire [7 : 0] mesgMetaF_opcode__h23230;
  wire [3 : 0] sendData_byteEn__h18777;
  wire [2 : 0] IF_respF_wDataIn_whas__45_THEN_respF_wDataIn_w_ETC___d988,
	       x__h23270,
	       x__h23282,
	       x__h23294,
	       y__h23271,
  ...
  assign MUX_endOfMessage$write_1__SEL_1 =
	     WILL_FIRE_RL_wmwt_messagePush && wsiS_reqFifo$D_OUT[57] ;
  ...
  assign MUX_thisMesg$write_1__VAL_1 =
	     { mesgCount[7:0], mesgMetaF_opcode__h23230, x_length__h23630 } ;
  ...
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_2 = { 2'd1, g_data__h24599 } ;
  ...
  assign MUX_wmi_mFlagF_x_wire$wset_1__VAL_2 =
	     { mesgMetaF_opcode__h23230, mesgMetaF_length__h23231 } ;
  ...
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_2 =
	     { 4'd3, wsiS_reqFifo$D_OUT[57], 1'b0, addr__h23097, 12'd1 } ;
  ...
  assign mesgLengthSoFar$D_IN =
	     WILL_FIRE_RL_wmwt_messagePush ? mlB__h23057 : 14'd0 ;
  ...
  assign respF_rCache$D_IN =
	     { 1'd1,
	       respF_rWrPtr,
	       IF_respF_wDataIn_whas__45_THEN_respF_wDataIn_w_ETC___d988,
	       respF_pwEnqueue$whas && respF_wDataIn$wget[57],
	       respF_pwEnqueue$whas && respF_wDataIn$wget[56],
	       IF_respF_wDataIn_whas__45_THEN_respF_wDataIn_w_ETC___d997 } ;
  ...
  begin
    case (1'b1) // synopsys parallel_case
      MUX_wmi_mFlagF_q_0$write_1__SEL_1: wmi_mFlagF_q_0$D_IN = value__h6627;
      WILL_FIRE_RL_wmi_mFlagF_both:
  ...
  begin
    case (1'b1) // synopsys parallel_case
      MUX_wmi_mFlagF_q_1$write_1__SEL_1: wmi_mFlagF_q_1$D_IN = value__h6627;
      WILL_FIRE_RL_wmi_mFlagF_both:
  ...
  // remaining internal signals
  assign IF_respF_wDataIn_whas__45_THEN_respF_wDataIn_w_ETC___d988 =
	     respF_pwEnqueue$whas ? respF_wDataIn$wget[60:58] : 3'd0 ;
  assign IF_respF_wDataIn_whas__45_THEN_respF_wDataIn_w_ETC___d997 =
  ...
  assign addr__h23097 = { mesgLengthSoFar[11:0], 2'd0 } ;
  assign b__h15201 = -fabWordsCurReq[11:0] ;
  assign b__h18318 = { {2{fabRespCredit_value[11]}}, fabRespCredit_value } ;
  assign mesgMetaF_length__h23231 =
	     (wsiS_reqFifo$D_OUT[57] && wsiS_reqFifo$D_OUT[11:8] == 4'd0 &&
	      mesgLengthSoFar == 14'd0) ?
	       24'd0 :
	       { 10'd0, mlB__h23057 } ;
  assign mesgMetaF_opcode__h23230 = opcode[8] ? opcode[7:0] : 8'd0 ;
  assign mlB__h23057 = mesgLengthSoFar + mlInc__h23056 ;
  assign mlInc__h23056 =
	     wsiS_reqFifo$D_OUT[57] ?
	       { 11'd0, x__h23270 + y__h23271 } :
	       14'd4 ;
  assign rdat__h24642 = hasDebugLogic ? mesgCount : 32'd0 ;
  assign rdat__h24648 = hasDebugLogic ? abortCount : 32'd0 ;
  assign rdat__h24654 = hasDebugLogic ? thisMesg : 32'd0 ;
  assign rdat__h24667 = hasDebugLogic ? lastMesg : 32'd0 ;
  assign rdat__h24690 = hasDebugLogic ? { 16'd0, x__h24694 } : 32'd0 ;
  assign rdat__h24790 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h24804 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h24812 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h24818 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h24832 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h24840 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h24846 = hasDebugLogic ? wmwtBeginCount : 32'd0 ;
  assign rdat__h24852 = hasDebugLogic ? wmwtPushCount : 32'd0 ;
  assign rdat__h24858 = hasDebugLogic ? wmwtFinalCount : 32'd0 ;
  assign rdat__h24864 = hasDebugLogic ? 32'hFEEDC0DE : 32'd0 ;
  ...
  assign sendData_byteEn__h18777 =
	     (thisMesg[15:0] == 16'd0) ?
	       4'd0 :
	       ((unrollCnt == 16'd1) ? x__h18834[3:0] : 4'd15) ;
  assign value__h6627 =
	     MUX_wmi_mFlagF_x_wire$wset_1__SEL_1 ?
													...
													6'd30) ?
													 ...
													 (({ 4'd0,
													   ...
													   6'd31) ?
													    32'h7FFFFFFF :
													    32'hFFFFFFFF))))))))))))))))))))))))))))))) ;
  assign x__h23270 = x__h23282 + y__h23283 ;
  assign x__h23282 = x__h23294 + y__h23295 ;
  assign x__h23294 = { 2'd0, wsiS_reqFifo$D_OUT[11] } ;
  assign x__h24694 = { wsiS_statusR, wsiM_statusR } ;
  assign x_length__h23630 = { 2'd0, mlB__h23057 } ;
  assign y__h23271 = { 2'd0, wsiS_reqFifo$D_OUT[8] } ;
  assign y__h23283 = { 2'd0, wsiS_reqFifo$D_OUT[9] } ;
  assign y__h23295 = { 2'd0, wsiS_reqFifo$D_OUT[10] } ;
  always@(wci_wslv_reqF$D_OUT or
	  ...
	  rdat__h24832 or
	  rdat__h24840 or
	  rdat__h24846 or rdat__h24852 or rdat__h24858 or rdat__h24864)
  begin
    case (wci_wslv_reqF$D_OUT[39:32])
      8'h0: g_data__h24599 = smaCtrl;
      8'h04: g_data__h24599 = rdat__h24642;
      8'h08: g_data__h24599 = rdat__h24648;
      8'h10: g_data__h24599 = rdat__h24654;
      8'h14: g_data__h24599 = rdat__h24667;
      8'h18: g_data__h24599 = rdat__h24690;
      8'h20: g_data__h24599 = rdat__h24790;
      8'h24: g_data__h24599 = rdat__h24804;
      8'h28: g_data__h24599 = rdat__h24812;
      8'h2C: g_data__h24599 = rdat__h24818;
      8'h30: g_data__h24599 = rdat__h24832;
      8'h34: g_data__h24599 = rdat__h24840;
      8'h38: g_data__h24599 = rdat__h24846;
      8'h3C: g_data__h24599 = rdat__h24852;
      8'h40: g_data__h24599 = rdat__h24858;
      8'h44: g_data__h24599 = rdat__h24864;
      default: g_data__h24599 = 32'd0;
    endcase
  end
  ...
  begin
    ...
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wmwt_doAbort)
	$display("[%0d]: %m: wmwt_doAbort", v__h24050);
    if (wciS0_MReset_n)
