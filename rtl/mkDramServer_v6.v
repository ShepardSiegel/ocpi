...
//
// On Thu Oct 31 10:33:27 EDT 2013
//
//
// Ports:
// Name                         I/O  size props
...
module mkDramServer_v6(CLK_sys0_clk,
  ...
  reg [63 : 0] v__h19455, v__h3583, v__h3758, v__h3902;
  reg [31 : 0] IF_wci_wslv_reqF_first__3_BITS_39_TO_32_49_EQ__ETC___d670,
	       g_data__h15249,
	       x__h5927,
	       x__h6148;
  reg CASE_x385_0b0_memc_respFFULL_N_0b101_memc_res_ETC__q1;
  wire [175 : 0] IF_wci_wslv_reqF_first__3_BIT_51_48_THEN_pReg__ETC___d499;
  wire [127 : 0] x1_data__h16437, x1_data__h17446;
  wire [31 : 0] dramStatus__h13875,
		g_data__h18913,
		myBE__h5964,
		myBE__h5997,
		rdat___1__h18976,
		...
		rdat___1__h19324,
		x1_addr__h17444;
  wire [15 : 0] x1_be__h17445, x__h18953;
  wire [2 : 0] x__h6385;
  ...
  wire IF_memc_memc_app_rd_data_end__09_CONCAT_memc_r_ETC___d225,
       IF_wci_wslv_reqF_first__3_BIT_51_48_THEN_lreqF_ETC___d524,
       IF_wmemi_reqF_first__80_BITS_51_TO_49_81_EQ_1__ETC___d389,
       _dfoo1,
       _dfoo3,
       _dfoo5,
       _dfoo7,
       ...
       lrespF_RDY_first__15_AND_NOT_splitReadInFlight_ETC___d433,
       lrespF_RDY_first__15_AND_NOT_wmemi_respF_cntr__ETC___d417,
       wci_wslv_reqF_i_notEmpty__2_AND_IF_wci_wslv_re_ETC___d460,
       wmemiReadInFlight_value_03_SLT_16___d386,
       x1__h12597;
  ...
  assign WILL_FIRE_RL_memc_advance_request =
	     memc_reqF_EMPTY_N &&
	     (x1__h12597 || !memc_reqF_D_OUT[176] || memc_rdpF_FULL_N) &&
	     memc_memc_phy_init_done &&
	     !memc_firstBeat &&
	     !memc_secondBeat ;
  ...
  assign MUX_lreqF_enq_1__VAL_3 =
	     { !wci_wslv_reqF_D_OUT[51] &&
	       wci_wslv_reqF_D_OUT[39:32] != 8'h54,
	       IF_wci_wslv_reqF_first__3_BIT_51_48_THEN_pReg__ETC___d499 } ;
  ...
  assign MUX_wci_wslv_respF_q_1_write_1__VAL_2 =
	     (wci_wslv_respF_cntr_r == 2'd2) ?
	       MUX_wci_wslv_respF_q_0_write_1__VAL_1 :
	       34'h0AAAAAAAA ;
  assign MUX_wci_wslv_respF_x_wire_wset_1__VAL_1 = { 2'd1, g_data__h15249 } ;
  assign MUX_wci_wslv_respF_x_wire_wset_1__VAL_2 = { 2'd1, g_data__h18913 } ;
  ...
  // submodule appFull
  assign appFull_sD_IN = x1__h12597 ;
  ...
  assign IF_wci_wslv_reqF_first__3_BIT_51_48_THEN_lreqF_ETC___d524 =
	     wci_wslv_reqF_D_OUT[51] ?
	       lreqF_sFULL_N && splaF_FULL_N :
	       wci_wslv_respF_cntr_r != 2'd2 ;
  assign IF_wci_wslv_reqF_first__3_BIT_51_48_THEN_pReg__ETC___d499 =
	     wci_wslv_reqF_D_OUT[51] ?
	       { x1_addr__h17444, x1_be__h17445, x1_data__h17446 } :
	       { wci_wslv_reqF_D_OUT[31:0], mReg, x1_data__h16437 } ;
  assign IF_wmemi_reqF_first__80_BITS_51_TO_49_81_EQ_1__ETC___d389 =
	     (wmemi_reqF_D_OUT[51:49] == 3'd1) ?
	       lreqF_sFULL_N && wmemi_dhF_EMPTY_N :
	       !wmemiReadInFlight_value_03_SLT_16___d386 || lreqF_sFULL_N ;
  assign _dfoo1 =
	     wci_wslv_respF_cntr_r != 2'd2 ||
  ...
  assign dbg_wl_odelay_dqs_tap_cnt_RDY_write__15_AND_db_ETC___d345 =
	     ...
	     dbg_rdlvl_done_sRDY &&
	     dbg_rdlvl_err_RDY_write__18_AND_dbg_cpt_tap_cn_ETC___d342 ;
  assign dramStatus__h13875 = { 16'd0, x__h18953 } ;
  assign g_data__h18913 =
	     wci_wslv_reqF_D_OUT[51] ?
	       32'd0 :
	       IF_wci_wslv_reqF_first__3_BITS_39_TO_32_49_EQ__ETC___d670 ;
  assign lrespF_RDY_first__15_AND_NOT_splitReadInFlight_ETC___d433 =
	     lrespF_dEMPTY_N &&
	     (!splitReadInFlight ||
	      splaF_EMPTY_N && wci_wslv_respF_cntr_r != 2'd2) ;
  assign lrespF_RDY_first__15_AND_NOT_wmemi_respF_cntr__ETC___d417 =
  ...
  assign rdat___1__h18976 =
	     hasDebugLogic ? { 24'd0, dbg_wl_dqs_inverted_dD_OUT } : 32'd0 ;
  assign rdat___1__h18987 =
	     hasDebugLogic ?
	       { 16'd0, dbg_wr_calib_clk_delay_dD_OUT } :
	       32'd0 ;
  assign rdat___1__h18998 =
	     hasDebugLogic ? dbg_wl_odelay_dqs_tap_cnt_dD_OUT[31:0] : 32'd0 ;
  assign rdat___1__h19009 =
	     hasDebugLogic ? dbg_wl_odelay_dq_tap_cnt_dD_OUT[31:0] : 32'd0 ;
  assign rdat___1__h19020 =
	     hasDebugLogic ? { 30'd0, dbg_rdlvl_done_dD_OUT } : 32'd0 ;
  assign rdat___1__h19031 =
	     hasDebugLogic ? { 30'd0, dbg_rdlvl_err_dD_OUT } : 32'd0 ;
  assign rdat___1__h19042 =
	     hasDebugLogic ? dbg_cpt_tap_cnt_dD_OUT[31:0] : 32'd0 ;
  assign rdat___1__h19053 =
	     hasDebugLogic ? dbg_cpt_first_edge_cnt_dD_OUT[31:0] : 32'd0 ;
  assign rdat___1__h19064 =
	     hasDebugLogic ? dbg_cpt_second_edge_cnt_dD_OUT[31:0] : 32'd0 ;
  assign rdat___1__h19075 =
	     hasDebugLogic ? { 8'd0, dbg_rd_bitslip_cnt_dD_OUT } : 32'd0 ;
  assign rdat___1__h19086 =
	     hasDebugLogic ? { 16'd0, dbg_rd_clkdly_cnt_dD_OUT } : 32'd0 ;
  assign rdat___1__h19097 =
	     hasDebugLogic ? { 27'd0, dbg_rd_active_dly_dD_OUT } : 32'd0 ;
  assign rdat___1__h19108 =
	     hasDebugLogic ? dbg_dqs_p_tap_cnt_dD_OUT[31:0] : 32'd0 ;
  assign rdat___1__h19119 =
	     hasDebugLogic ? dbg_dqs_n_tap_cnt_dD_OUT[31:0] : 32'd0 ;
  assign rdat___1__h19130 =
	     hasDebugLogic ? dbg_dq_tap_cnt_dD_OUT[31:0] : 32'd0 ;
  assign rdat___1__h19141 = hasDebugLogic ? dbg_rddata_dD_OUT : 32'd0 ;
  assign rdat___1__h19148 =
	     hasDebugLogic ? { 16'd0, requestCount_dD_OUT } : 32'd0 ;
  assign rdat___1__h19159 =
	     hasDebugLogic ? { 16'd0, responseCount_dD_OUT } : 32'd0 ;
  assign rdat___1__h19170 = hasDebugLogic ? { 16'd0, pReg } : 32'd0 ;
  assign rdat___1__h19180 = hasDebugLogic ? { 16'd0, mReg } : 32'd0 ;
  assign rdat___1__h19190 = hasDebugLogic ? wdReg_0 : 32'd0 ;
  assign rdat___1__h19204 = hasDebugLogic ? wdReg_1 : 32'd0 ;
  assign rdat___1__h19218 = hasDebugLogic ? wdReg_2 : 32'd0 ;
  assign rdat___1__h19232 = hasDebugLogic ? wdReg_3 : 32'd0 ;
  assign rdat___1__h19246 = hasDebugLogic ? rdReg_0 : 32'd0 ;
  assign rdat___1__h19261 = hasDebugLogic ? rdReg_1 : 32'd0 ;
  assign rdat___1__h19276 = hasDebugLogic ? rdReg_2 : 32'd0 ;
  assign rdat___1__h19291 = hasDebugLogic ? rdReg_3 : 32'd0 ;
  assign rdat___1__h19306 = hasDebugLogic ? wmemiWrReq : 32'd0 ;
  assign rdat___1__h19312 = hasDebugLogic ? wmemiRdReq : 32'd0 ;
  assign rdat___1__h19318 = hasDebugLogic ? wmemiRdResp : 32'd0 ;
  assign rdat___1__h19324 = hasDebugLogic ? wci_uclkUpdateCnt_dD_OUT : 32'd0 ;
  assign wci_wslv_reqF_i_notEmpty__2_AND_IF_wci_wslv_re_ETC___d460 =
	     wci_wslv_reqF_EMPTY_N &&
	     (wci_wslv_reqF_D_OUT[51] ?
		lreqF_sFULL_N :
		((wci_wslv_reqF_D_OUT[39:32] == 8'h54) ?
  ...
  assign wci_wslv_respF_cntr_r_8_MINUS_1___d27 =
	     wci_wslv_respF_cntr_r - 2'd1 ;
  assign wmemiReadInFlight_value_03_SLT_16___d386 =
	     (wmemiReadInFlight_value ^ 8'h80) < 8'd144 ;
  assign wmemi_respF_cntr_r_47_MINUS_1___d256 = wmemi_respF_cntr_r - 2'd1 ;
  assign x1__h12597 = !memc_memc_app_rdy ;
  assign x1_addr__h17444 = { pReg[12:0], wci_wslv_reqF_D_OUT[50:36], 4'd0 } ;
  assign x1_be__h17445 =
  ...
  assign x1_data__h16437 = { wdReg_3, wdReg_2, wdReg_1, wdReg_0 } ;
  assign x1_data__h17446 = {4{wci_wslv_reqF_D_OUT[31:0]}} ;
  assign x__h18953 =
	     { respCount,
	       2'b0,
	       memIsResetCC_dD_OUT,
  ...
  begin
    case (splaF_D_OUT)
      2'd0: g_data__h15249 = lrespF_dD_OUT[31:0];
      2'd1: g_data__h15249 = lrespF_dD_OUT[63:32];
      2'd2: g_data__h15249 = lrespF_dD_OUT[95:64];
      2'd3: g_data__h15249 = lrespF_dD_OUT[127:96];
    endcase
  end
  ...
  always@(wci_wslv_reqF_D_OUT or
	  ...
	  rdat___1__h19291 or
	  rdat___1__h19306 or
	  rdat___1__h19312 or rdat___1__h19318 or rdat___1__h19324)
  begin
    case (wci_wslv_reqF_D_OUT[39:32])
	  ...
	  IF_wci_wslv_reqF_first__3_BITS_39_TO_32_49_EQ__ETC___d670 =
	      rdat___1__h19324;
      default: IF_wci_wslv_reqF_first__3_BITS_39_TO_32_49_EQ__ETC___d670 =
		   32'd0;
    endcase
  end
  ...
  begin
	...
	$display("Error: \"bsv/wrk/DramServer_v6.bsv\", line 198, column 28: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_cfwr] and\n  [RL_advance_response] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n != `BSV_RESET_VALUE)
	...
	$display("Error: \"bsv/wrk/DramServer_v6.bsv\", line 198, column 38: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_cfrd] and\n  [RL_advance_response] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n != `BSV_RESET_VALUE)
	...
	$display("Error: \"bsv/wrk/DramServer_v6.bsv\", line 198, column 62: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_ctrl_IsO] and\n  [RL_wci_ctrl_OrE] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_wci_ctrl_EiI && WILL_FIRE_RL_wci_ctrl_OrE)
	$display("Error: \"bsv/wrk/DramServer_v6.bsv\", line 198, column 48: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_ctrl_EiI] and\n  [RL_wci_ctrl_OrE] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n != `BSV_RESET_VALUE)
