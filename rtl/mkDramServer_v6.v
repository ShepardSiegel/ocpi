...
//
// On Tue Apr 10 14:12:41 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkDramServer_v6(CLK_sys0_clk,
  ...
  reg [63 : 0] v__h19222, v__h3637, v__h3811, v__h3955;
  reg [31 : 0] CASE_wci_wslv_reqFD_OUT_BITS_39_TO_32_0_0x0_d_ETC__q1,
	       g_data__h14932,
	       x__h5962,
	       x__h6183;
  reg CASE_x432_NOT_x432_EQ_0b11_OR_memc_respFFULL__ETC__q2;
  wire [175 : 0] IF_wci_wslv_reqF_first__5_BIT_51_55_THEN_pReg__ETC___d506;
  wire [127 : 0] x1_data__h16171, x1_data__h17172;
  wire [31 : 0] dramStatus__h13561,
		g_data__h18688,
		myBE__h5999,
		myBE__h6032,
		rdat___1__h18751,
		...
		rdat___1__h19093,
		x1_addr__h17170;
  wire [15 : 0] x1_be__h17171, x__h18728;
  wire [2 : 0] x__h6432;
  wire IF_memc_memc_app_rd_data_end__11_CONCAT_memc_r_ETC___d227,
       ...
       NOT_wci_wslv_respF_c_r_2_EQ_2_1_2_AND_IF_wci_w_ETC___d467,
       ...
       wmemiReadInFlight_value_07_SLT_16___d773,
       x1__h12369;
  ...
  assign WILL_FIRE_RL_memc_advance_request =
	     memc_reqF$EMPTY_N &&
	     (x1__h12369 || !memc_reqF$D_OUT[176] || memc_rdpF$FULL_N) &&
	     memc_memc$phy_init_done &&
	     !memc_firstBeat &&
	     !memc_secondBeat ;
  ...
  assign MUX_wci_wslv_respF_q_1$write_1__VAL_1 =
	     (wci_wslv_respF_c_r == 2'd2) ?
	       MUX_wci_wslv_respF_q_0$write_1__VAL_2 :
	       34'h0AAAAAAAA ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_1 = { 2'd1, g_data__h14932 } ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_2 = { 2'd1, g_data__h18688 } ;
  ...
  // submodule appFull
  assign appFull$sD_IN = x1__h12369 ;
  ...
  assign memc_memc$app_wdf_mask =
	     WILL_FIRE_RL_memc_advance_write0 ? ~x__h5962 : ~x__h6183 ;
  ...
  // submodule memc_respF
  always@(x__h6432 or memc_memc$app_rd_data)
  begin
    case (x__h6432)
  ...
  assign memc_respF$ENQ =
	     WILL_FIRE_RL_memc_advance_readData &&
	     (x__h6432 == 3'b0 || x__h6432 == 3'b101 || x__h6432 == 3'b110 ||
	      x__h6432 == 3'b011) ;
  ...
  assign IF_memc_memc_app_rd_data_end__11_CONCAT_memc_r_ETC___d227 =
	     CASE_x432_NOT_x432_EQ_0b11_OR_memc_respFFULL__ETC__q2 &&
  ...
  assign IF_wci_wslv_reqF_first__5_BIT_51_55_THEN_pReg__ETC___d506 =
	     wci_wslv_reqF$D_OUT[51] ?
	       { x1_addr__h17170, x1_be__h17171, x1_data__h17172 } :
	       { wci_wslv_reqF$D_OUT[31:0], mReg, x1_data__h16171 } ;
  assign IF_wmemi_reqF_first__81_BITS_51_TO_49_82_EQ_1__ETC___d390 =
	     (wmemi_reqF$D_OUT[51:49] == 3'd1) ?
	       lreqF$sFULL_N && wmemi_dhF$EMPTY_N :
	       !wmemiReadInFlight_value_07_SLT_16___d773 || lreqF$sFULL_N ;
  assign NOT_wci_wslv_respF_c_r_2_EQ_2_1_2_AND_IF_wci_w_ETC___d467 =
	     wci_wslv_respF_c_r != 2'd2 &&
	     (wci_wslv_reqF$D_OUT[51] ?
		lreqF$sFULL_N :
		((wci_wslv_reqF$D_OUT[39:32] == 8'h54) ?
  ...
  assign dbg_wl_odelay_dqs_tap_cnt_RDY_write__19_AND_db_ETC___d349 =
	     ...
	     dbg_rdlvl_done$sRDY &&
	     dbg_rdlvl_err_RDY_write__22_AND_dbg_cpt_tap_cn_ETC___d346 ;
  assign dramStatus__h13561 = { 16'd0, x__h18728 } ;
  assign g_data__h18688 =
	     wci_wslv_reqF$D_OUT[51] ?
	       32'd0 :
  ...
  assign lrespF_RDY_first__16_AND_NOT_wmemi_respF_c_r_4_ETC___d418 =
	     ...
	     wmemi_peerIsReady ;
  assign myBE__h5999 = { 16'h0, memc_reqF$D_OUT[143:128] } ;
  assign myBE__h6032 = { memc_reqF$D_OUT[143:128], 16'h0 } ;
  assign rdat___1__h18751 =
	     hasDebugLogic ? { 24'd0, dbg_wl_dqs_inverted$dD_OUT } : 32'd0 ;
  assign rdat___1__h18762 =
	     hasDebugLogic ?
	       { 16'd0, dbg_wr_calib_clk_delay$dD_OUT } :
	       32'd0 ;
  assign rdat___1__h18773 =
	     hasDebugLogic ? dbg_wl_odelay_dqs_tap_cnt$dD_OUT[31:0] : 32'd0 ;
  assign rdat___1__h18784 =
	     hasDebugLogic ? dbg_wl_odelay_dq_tap_cnt$dD_OUT[31:0] : 32'd0 ;
  assign rdat___1__h18795 =
	     hasDebugLogic ? { 30'd0, dbg_rdlvl_done$dD_OUT } : 32'd0 ;
  assign rdat___1__h18806 =
	     hasDebugLogic ? { 30'd0, dbg_rdlvl_err$dD_OUT } : 32'd0 ;
  assign rdat___1__h18817 =
	     hasDebugLogic ? dbg_cpt_tap_cnt$dD_OUT[31:0] : 32'd0 ;
  assign rdat___1__h18828 =
	     hasDebugLogic ? dbg_cpt_first_edge_cnt$dD_OUT[31:0] : 32'd0 ;
  assign rdat___1__h18839 =
	     hasDebugLogic ? dbg_cpt_second_edge_cnt$dD_OUT[31:0] : 32'd0 ;
  assign rdat___1__h18850 =
	     hasDebugLogic ? { 8'd0, dbg_rd_bitslip_cnt$dD_OUT } : 32'd0 ;
  assign rdat___1__h18861 =
	     hasDebugLogic ? { 16'd0, dbg_rd_clkdly_cnt$dD_OUT } : 32'd0 ;
  assign rdat___1__h18872 =
	     hasDebugLogic ? { 27'd0, dbg_rd_active_dly$dD_OUT } : 32'd0 ;
  assign rdat___1__h18883 =
	     hasDebugLogic ? dbg_dqs_p_tap_cnt$dD_OUT[31:0] : 32'd0 ;
  assign rdat___1__h18894 =
	     hasDebugLogic ? dbg_dqs_n_tap_cnt$dD_OUT[31:0] : 32'd0 ;
  assign rdat___1__h18905 =
	     hasDebugLogic ? dbg_dq_tap_cnt$dD_OUT[31:0] : 32'd0 ;
  assign rdat___1__h18916 = hasDebugLogic ? dbg_rddata$dD_OUT : 32'd0 ;
  assign rdat___1__h18923 =
	     hasDebugLogic ? { 16'd0, requestCount$dD_OUT } : 32'd0 ;
  assign rdat___1__h18934 =
	     hasDebugLogic ? { 16'd0, responseCount$dD_OUT } : 32'd0 ;
  assign rdat___1__h18945 = hasDebugLogic ? { 16'd0, pReg } : 32'd0 ;
  assign rdat___1__h18955 = hasDebugLogic ? { 16'd0, mReg } : 32'd0 ;
  assign rdat___1__h18965 = hasDebugLogic ? wdReg : 32'd0 ;
  assign rdat___1__h18979 = hasDebugLogic ? wdReg_1 : 32'd0 ;
  assign rdat___1__h18993 = hasDebugLogic ? wdReg_2 : 32'd0 ;
  assign rdat___1__h19007 = hasDebugLogic ? wdReg_3 : 32'd0 ;
  assign rdat___1__h19021 = hasDebugLogic ? rdReg : 32'd0 ;
  assign rdat___1__h19036 = hasDebugLogic ? rdReg_1 : 32'd0 ;
  assign rdat___1__h19051 = hasDebugLogic ? rdReg_2 : 32'd0 ;
  assign rdat___1__h19066 = hasDebugLogic ? rdReg_3 : 32'd0 ;
  assign rdat___1__h19081 = hasDebugLogic ? wmemiWrReq : 32'd0 ;
  assign rdat___1__h19087 = hasDebugLogic ? wmemiRdReq : 32'd0 ;
  assign rdat___1__h19093 = hasDebugLogic ? wmemiRdResp : 32'd0 ;
  assign wmemiReadInFlight_value_07_SLT_16___d773 =
	     (wmemiReadInFlight_value ^ 8'h80) < 8'd144 ;
  assign x1__h12369 = !memc_memc$app_rdy ;
  assign x1_addr__h17170 = { pReg[12:0], wci_wslv_reqF$D_OUT[50:36], 4'd0 } ;
  assign x1_be__h17171 =
  ...
  assign x1_data__h16171 = { wdReg_3, wdReg_2, wdReg_1, wdReg } ;
  assign x1_data__h17172 = {4{wci_wslv_reqF$D_OUT[31:0]}} ;
  assign x__h18728 =
	     { respCount,
	       2'h0,
	       memIsResetCC$dD_OUT,
	       ...
	       firBeat$dD_OUT,
	       initComplete$dD_OUT } ;
  assign x__h6432 = { memc_memc$app_rd_data_end, memc_rdpF$D_OUT } ;
  always@(splaF$D_OUT or lrespF$dD_OUT)
  begin
    case (splaF$D_OUT)
      2'd0: g_data__h14932 = lrespF$dD_OUT[31:0];
      2'd1: g_data__h14932 = lrespF$dD_OUT[63:32];
      2'd2: g_data__h14932 = lrespF$dD_OUT[95:64];
      2'd3: g_data__h14932 = lrespF$dD_OUT[127:96];
    endcase
  end
  always@(wci_wslv_reqF$D_OUT or
	  dramStatus__h13561 or
	  dramCtrl or
	  rdat___1__h18751 or
	  rdat___1__h18762 or
	  rdat___1__h18773 or
	  ...
	  rdat___1__h19051 or
	  rdat___1__h19066 or
	  rdat___1__h19081 or rdat___1__h19087 or rdat___1__h19093)
  begin
  ...
  always@(memc_reqF$D_OUT or myBE__h5999 or myBE__h6032)
  begin
    case (memc_reqF$D_OUT[149:148])
      2'b0: x__h5962 = myBE__h5999;
      2'b01: x__h5962 = myBE__h6032;
      default: x__h5962 = 32'd0;
    endcase
  end
  always@(memc_reqF$D_OUT or myBE__h5999 or myBE__h6032)
  begin
    case (memc_reqF$D_OUT[149:148])
      2'b10: x__h6183 = myBE__h5999;
      2'b11: x__h6183 = myBE__h6032;
      default: x__h6183 = 32'd0;
    endcase
  end
  always@(x__h6432 or memc_respF$FULL_N)
  begin
    case (x__h6432)
      3'b0, 3'b101, 3'b110:
	  CASE_x432_NOT_x432_EQ_0b11_OR_memc_respFFULL__ETC__q2 =
	      memc_respF$FULL_N;
      default: CASE_x432_NOT_x432_EQ_0b11_OR_memc_respFFULL__ETC__q2 =
		   x__h6432 != 3'b011 || memc_respF$FULL_N;
    endcase
  end
