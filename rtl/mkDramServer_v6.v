...
//
// On Mon Feb 27 09:35:29 EST 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkDramServer_v6(CLK_sys0_clk,
  ...
  reg [63 : 0] v__h18936, v__h3637, v__h3811, v__h3955;
  ...
  wire [127 : 0] x1_data__h15963, x1_data__h16964;
  wire [31 : 0] dramStatus__h13366,
		g_data__h18480,
		myBE__h5971,
		myBE__h6004,
		rdat___1__h18543,
		...
		rdat___1__h18701,
		x1_addr__h16962;
  wire [15 : 0] x1_be__h16963, x__h18520;
  wire [2 : 0] x__h6404;
  ...
  assign WILL_FIRE_RL_memc_advance_request =
	     memc_reqF$EMPTY_N &&
	     (x1__h12210 || !memc_reqF$D_OUT[176] || memc_rdpF$FULL_N) &&
	     memc_memc$phy_init_done &&
	     !memc_firstBeat &&
	     !memc_secondBeat ;
  ...
  assign MUX_wci_wslv_respF_q_1$write_1__VAL_1 =
	     (wci_wslv_respF_c_r == 2'd2) ?
	       MUX_wci_wslv_respF_q_0$write_1__VAL_2 :
	       34'h0AAAAAAAA ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_1 = { 2'd1, g_data__h14724 } ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_2 = { 2'd1, g_data__h18480 } ;
  ...
  // submodule appFull
  assign appFull$sD_IN = x1__h12210 ;
  ...
  assign IF_wci_wslv_reqF_first__5_BIT_51_44_THEN_pReg__ETC___d495 =
	     wci_wslv_reqF$D_OUT[51] ?
	       { x1_addr__h16962, x1_be__h16963, x1_data__h16964 } :
	       { wci_wslv_reqF$D_OUT[31:0], mReg, x1_data__h15963 } ;
  ...
  assign dbg_wr_calib_clk_delay_RDY_write__16_AND_dbg_w_ETC___d346 =
	     ...
	     dbg_rdlvl_done_RDY_write__19_AND_dbg_rdlvl_err_ETC___d343 ;
  assign dramStatus__h13366 = { 16'd0, x__h18520 } ;
  assign g_data__h18480 =
	     wci_wslv_reqF$D_OUT[51] ?
	       32'd0 :
  ...
  assign rdat___1__h18543 = { 24'd0, dbg_wl_dqs_inverted$dD_OUT } ;
  assign rdat___1__h18552 = { 16'd0, dbg_wr_calib_clk_delay$dD_OUT } ;
  assign rdat___1__h18579 = { 30'd0, dbg_rdlvl_done$dD_OUT } ;
  assign rdat___1__h18588 = { 30'd0, dbg_rdlvl_err$dD_OUT } ;
  assign rdat___1__h18624 = { 8'd0, dbg_rd_bitslip_cnt$dD_OUT } ;
  assign rdat___1__h18633 = { 16'd0, dbg_rd_clkdly_cnt$dD_OUT } ;
  assign rdat___1__h18642 = { 27'd0, dbg_rd_active_dly$dD_OUT } ;
  assign rdat___1__h18684 = { 16'd0, requestCount$dD_OUT } ;
  assign rdat___1__h18693 = { 16'd0, pReg } ;
  assign rdat___1__h18701 = { 16'd0, mReg } ;
  ...
  assign x1__h12210 = !memc_memc$app_rdy ;
  assign x1_addr__h16962 = { pReg[12:0], wci_wslv_reqF$D_OUT[50:36], 4'd0 } ;
  assign x1_be__h16963 =
  ...
  assign x1_data__h15963 = { wdReg_3, wdReg_2, wdReg_1, wdReg } ;
  assign x1_data__h16964 = {4{wci_wslv_reqF$D_OUT[31:0]}} ;
  assign x__h18520 =
	     { respCount,
	       2'h0,
	       memIsResetCC$dD_OUT,
  ...
  begin
    case (splaF$D_OUT)
      2'd0: g_data__h14724 = lrespF$dD_OUT[31:0];
      2'd1: g_data__h14724 = lrespF$dD_OUT[63:32];
      2'd2: g_data__h14724 = lrespF$dD_OUT[95:64];
      2'd3: g_data__h14724 = lrespF$dD_OUT[127:96];
    endcase
  end
  always@(wci_wslv_reqF$D_OUT or
	  dramStatus__h13366 or
	  dramCtrl or
	  rdat___1__h18543 or
	  rdat___1__h18552 or
