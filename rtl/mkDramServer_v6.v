...
//
// On Thu Jan 24 17:39:41 EST 2013
//
//
// Ports:
// Name                         I/O  size props
...
module mkDramServer_v6(CLK_sys0_clk,
  ...
  wire [1 : 0] wmemi_respF_cntr_r$D_IN;
  wire wmemi_respF_cntr_r$EN;
  ...
  wire [1 : 0] MUX_wci_wslv_respF_cntr_r$write_1__VAL_2,
	       MUX_wmemi_respF_cntr_r$write_1__VAL_2;
  wire MUX_lreqF$enq_1__SEL_1,
       ...
       MUX_wmemi_respF_q_0$write_1__SEL_2,
       MUX_wmemi_respF_q_1$write_1__SEL_1,
       MUX_wmemi_respF_q_1$write_1__SEL_2;

  // remaining internal signals
  reg [63 : 0] v__h19271, v__h3583, v__h3758, v__h3902;
  reg [31 : 0] IF_wci_wslv_reqF_first__3_BITS_39_TO_32_46_EQ__ETC___d663,
	       g_data__h15073,
	       x__h5920,
	       x__h6141;
  reg CASE_x378_0b0_memc_respFFULL_N_0b101_memc_res_ETC__q1;
  wire [175 : 0] IF_wci_wslv_reqF_first__3_BIT_51_45_THEN_pReg__ETC___d496;
  wire [127 : 0] x1_data__h16261, x1_data__h17270;
  wire [31 : 0] dramStatus__h13684,
		g_data__h18737,
		myBE__h5957,
		myBE__h5990,
		rdat___1__h18800,
		...
		rdat___1__h19142,
		x1_addr__h17268;
  wire [15 : 0] x1_be__h17269, x__h18777;
  wire [2 : 0] x__h6378;
  ...
  assign WILL_FIRE_RL_memc_advance_request =
	     memc_reqF$EMPTY_N &&
	     (x1__h12469 || !memc_reqF$D_OUT[176] || memc_rdpF$FULL_N) &&
	     memc_memc$phy_init_done &&
	     !memc_firstBeat &&
	     !memc_secondBeat ;
  ...
  assign WILL_FIRE_RL_wmemi_respF_incCtr =
	     wmemi_respF_enqueueing$whas && wmemi_respF_enqueueing$whas &&
	     !(wmemi_respF_cntr_r != 2'd0) ;

  // rule RL_wmemi_respF_decCtr
  assign WILL_FIRE_RL_wmemi_respF_decCtr =
	     wmemi_respF_cntr_r != 2'd0 && !wmemi_respF_enqueueing$whas ;

  // rule RL_wmemi_respF_both
  assign WILL_FIRE_RL_wmemi_respF_both =
	     wmemi_respF_enqueueing$whas && wmemi_respF_cntr_r != 2'd0 &&
	     wmemi_respF_enqueueing$whas ;
  ...
  assign MUX_rdReg_0$write_1__SEL_1 =
  ...
  assign MUX_wmemi_respF_q_0$write_1__SEL_2 =
  ...
  assign MUX_wmemi_respF_q_1$write_1__SEL_2 =
  ...
  assign MUX_wci_wslv_respF_q_1$write_1__VAL_1 =
	     (wci_wslv_respF_cntr_r == 2'd2) ?
	       MUX_wci_wslv_respF_q_0$write_1__VAL_2 :
	       34'h0AAAAAAAA ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_1 = { 2'd1, g_data__h15073 } ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_2 = { 2'd1, g_data__h18737 } ;
  ...
  assign MUX_wmemi_respF_cntr_r$write_1__VAL_2 = wmemi_respF_cntr_r + 2'd1 ;
  ...
  assign wmemi_respF_dequeueing$whas = wmemi_respF_cntr_r != 2'd0 ;
  ...
  // register wdReg_0
  assign wdReg_0$D_IN = wci_wslv_reqF$D_OUT[31:0] ;
  assign wdReg_0$EN =
	     WILL_FIRE_RL_wci_cfwr && !wci_wslv_reqF$D_OUT[51] &&
  ...
  // register wmemi_respF_cntr_r
  assign wmemi_respF_cntr_r$D_IN =
	     WILL_FIRE_RL_wmemi_respF_decCtr ?
	       wmemi_respF_cntr_r_47_MINUS_1___d256 :
	       MUX_wmemi_respF_cntr_r$write_1__VAL_2 ;
  assign wmemi_respF_cntr_r$EN =
	     WILL_FIRE_RL_wmemi_respF_decCtr ||
	     WILL_FIRE_RL_wmemi_respF_incCtr ;
  ...
  always@(MUX_wmemi_respF_q_0$write_1__SEL_1 or
	  ...
	  MUX_wmemi_respF_q_0$write_1__SEL_2 or
  ...
  always@(MUX_wmemi_respF_q_1$write_1__SEL_1 or
	  MUX_wmemi_respF_q_0$write_1__VAL_1 or
	  MUX_wmemi_respF_q_1$write_1__SEL_2 or
  ...
  // submodule appFull
  assign appFull$sD_IN = x1__h12469 ;
  ...
  assign memc_memc$app_wdf_mask =
	     WILL_FIRE_RL_memc_advance_write0 ? ~x__h5920 : ~x__h6141 ;
  ...
  // submodule memc_respF
  always@(x__h6378 or memc_memc$app_rd_data)
  begin
    case (x__h6378)
  ...
  assign memc_respF$ENQ =
	     WILL_FIRE_RL_memc_advance_readData &&
	     (x__h6378 == 3'b0 || x__h6378 == 3'b101 || x__h6378 == 3'b110 ||
	      x__h6378 == 3'b011) ;
  ...
  assign splaF$ENQ = MUX_lreqF$enq_1__SEL_1 ;
  ...
  assign IF_memc_memc_app_rd_data_end__09_CONCAT_memc_r_ETC___d225 =
	     CASE_x378_0b0_memc_respFFULL_N_0b101_memc_res_ETC__q1 &&
  ...
  assign IF_wci_wslv_reqF_first__3_BIT_51_45_THEN_pReg__ETC___d496 =
	     wci_wslv_reqF$D_OUT[51] ?
	       { x1_addr__h17268, x1_be__h17269, x1_data__h17270 } :
	       { wci_wslv_reqF$D_OUT[31:0], mReg, x1_data__h16261 } ;
  assign IF_wmemi_reqF_first__77_BITS_51_TO_49_78_EQ_1__ETC___d386 =
	     (wmemi_reqF$D_OUT[51:49] == 3'd1) ?
	       lreqF$sFULL_N && wmemi_dhF$EMPTY_N :
	       !wmemiReadInFlight_value_03_SLT_16___d383 || lreqF$sFULL_N ;
  assign _dfoo1 =
	     wci_wslv_respF_cntr_r != 2'd2 ||
  ...
  assign dbg_wl_odelay_dqs_tap_cnt_RDY_write__15_AND_db_ETC___d345 =
	     ...
	     dbg_rdlvl_done$sRDY &&
	     dbg_rdlvl_err_RDY_write__18_AND_dbg_cpt_tap_cn_ETC___d342 ;
  assign dramStatus__h13684 = { 16'd0, x__h18777 } ;
  assign g_data__h18737 =
	     wci_wslv_reqF$D_OUT[51] ?
	       32'd0 :
  ...
  assign lrespF_RDY_first__12_AND_NOT_splitReadInFlight_ETC___d430 =
	     lrespF$dEMPTY_N &&
	     (!splitReadInFlight ||
	      splaF$EMPTY_N && wci_wslv_respF_cntr_r != 2'd2) ;
  assign lrespF_RDY_first__12_AND_NOT_wmemi_respF_cntr__ETC___d414 =
	     lrespF$dEMPTY_N && wmemi_respF_cntr_r != 2'd2 &&
	     wmemi_operateD &&
	     wmemi_peerIsReady ;
  assign myBE__h5957 = { 16'h0, memc_reqF$D_OUT[143:128] } ;
  assign myBE__h5990 = { memc_reqF$D_OUT[143:128], 16'h0 } ;
  assign rdat___1__h18800 =
	     hasDebugLogic ? { 24'd0, dbg_wl_dqs_inverted$dD_OUT } : 32'd0 ;
  assign rdat___1__h18811 =
	     hasDebugLogic ?
	       { 16'd0, dbg_wr_calib_clk_delay$dD_OUT } :
	       32'd0 ;
  assign rdat___1__h18822 =
	     hasDebugLogic ? dbg_wl_odelay_dqs_tap_cnt$dD_OUT[31:0] : 32'd0 ;
  assign rdat___1__h18833 =
	     hasDebugLogic ? dbg_wl_odelay_dq_tap_cnt$dD_OUT[31:0] : 32'd0 ;
  assign rdat___1__h18844 =
	     hasDebugLogic ? { 30'd0, dbg_rdlvl_done$dD_OUT } : 32'd0 ;
  assign rdat___1__h18855 =
	     hasDebugLogic ? { 30'd0, dbg_rdlvl_err$dD_OUT } : 32'd0 ;
  assign rdat___1__h18866 =
	     hasDebugLogic ? dbg_cpt_tap_cnt$dD_OUT[31:0] : 32'd0 ;
  assign rdat___1__h18877 =
	     hasDebugLogic ? dbg_cpt_first_edge_cnt$dD_OUT[31:0] : 32'd0 ;
  assign rdat___1__h18888 =
	     hasDebugLogic ? dbg_cpt_second_edge_cnt$dD_OUT[31:0] : 32'd0 ;
  assign rdat___1__h18899 =
	     hasDebugLogic ? { 8'd0, dbg_rd_bitslip_cnt$dD_OUT } : 32'd0 ;
  assign rdat___1__h18910 =
	     hasDebugLogic ? { 16'd0, dbg_rd_clkdly_cnt$dD_OUT } : 32'd0 ;
  assign rdat___1__h18921 =
	     hasDebugLogic ? { 27'd0, dbg_rd_active_dly$dD_OUT } : 32'd0 ;
  assign rdat___1__h18932 =
	     hasDebugLogic ? dbg_dqs_p_tap_cnt$dD_OUT[31:0] : 32'd0 ;
  assign rdat___1__h18943 =
	     hasDebugLogic ? dbg_dqs_n_tap_cnt$dD_OUT[31:0] : 32'd0 ;
  assign rdat___1__h18954 =
	     hasDebugLogic ? dbg_dq_tap_cnt$dD_OUT[31:0] : 32'd0 ;
  assign rdat___1__h18965 = hasDebugLogic ? dbg_rddata$dD_OUT : 32'd0 ;
  assign rdat___1__h18972 =
	     hasDebugLogic ? { 16'd0, requestCount$dD_OUT } : 32'd0 ;
  assign rdat___1__h18983 =
	     hasDebugLogic ? { 16'd0, responseCount$dD_OUT } : 32'd0 ;
  assign rdat___1__h18994 = hasDebugLogic ? { 16'd0, pReg } : 32'd0 ;
  assign rdat___1__h19004 = hasDebugLogic ? { 16'd0, mReg } : 32'd0 ;
  assign rdat___1__h19014 = hasDebugLogic ? wdReg_0 : 32'd0 ;
  assign rdat___1__h19028 = hasDebugLogic ? wdReg_1 : 32'd0 ;
  assign rdat___1__h19042 = hasDebugLogic ? wdReg_2 : 32'd0 ;
  assign rdat___1__h19056 = hasDebugLogic ? wdReg_3 : 32'd0 ;
  assign rdat___1__h19070 = hasDebugLogic ? rdReg_0 : 32'd0 ;
  assign rdat___1__h19085 = hasDebugLogic ? rdReg_1 : 32'd0 ;
  assign rdat___1__h19100 = hasDebugLogic ? rdReg_2 : 32'd0 ;
  assign rdat___1__h19115 = hasDebugLogic ? rdReg_3 : 32'd0 ;
  assign rdat___1__h19130 = hasDebugLogic ? wmemiWrReq : 32'd0 ;
  assign rdat___1__h19136 = hasDebugLogic ? wmemiRdReq : 32'd0 ;
  assign rdat___1__h19142 = hasDebugLogic ? wmemiRdResp : 32'd0 ;
  ...
  assign x1__h12469 = !memc_memc$app_rdy ;
  assign x1_addr__h17268 = { pReg[12:0], wci_wslv_reqF$D_OUT[50:36], 4'd0 } ;
  assign x1_be__h17269 =
  ...
  assign x1_data__h16261 = { wdReg_3, wdReg_2, wdReg_1, wdReg_0 } ;
  assign x1_data__h17270 = {4{wci_wslv_reqF$D_OUT[31:0]}} ;
  assign x__h18777 =
	     { respCount,
	       2'h0,
	       memIsResetCC$dD_OUT,
	       ...
	       firBeat$dD_OUT,
	       initComplete$dD_OUT } ;
  assign x__h6378 = { memc_memc$app_rd_data_end, memc_rdpF$D_OUT } ;
  always@(splaF$D_OUT or lrespF$dD_OUT)
  begin
    case (splaF$D_OUT)
      2'd0: g_data__h15073 = lrespF$dD_OUT[31:0];
      2'd1: g_data__h15073 = lrespF$dD_OUT[63:32];
      2'd2: g_data__h15073 = lrespF$dD_OUT[95:64];
      2'd3: g_data__h15073 = lrespF$dD_OUT[127:96];
    endcase
  end
  always@(memc_reqF$D_OUT or myBE__h5957 or myBE__h5990)
  begin
    case (memc_reqF$D_OUT[149:148])
      2'b0: x__h5920 = myBE__h5957;
      2'b01: x__h5920 = myBE__h5990;
      default: x__h5920 = 32'd0;
    endcase
  end
  always@(memc_reqF$D_OUT or myBE__h5957 or myBE__h5990)
  begin
    case (memc_reqF$D_OUT[149:148])
      2'b10: x__h6141 = myBE__h5957;
      2'b11: x__h6141 = myBE__h5990;
      default: x__h6141 = 32'd0;
    endcase
  end
  always@(x__h6378 or memc_respF$FULL_N)
  begin
    case (x__h6378)
      3'b0, 3'b101, 3'b110:
	  CASE_x378_0b0_memc_respFFULL_N_0b101_memc_res_ETC__q1 =
	      memc_respF$FULL_N;
      default: CASE_x378_0b0_memc_respFFULL_N_0b101_memc_res_ETC__q1 =
		   x__h6378 != 3'b011 || memc_respF$FULL_N;
    endcase
  end
  always@(wci_wslv_reqF$D_OUT or
	  dramStatus__h13684 or
	  dramCtrl or
	  rdat___1__h18800 or
	  rdat___1__h18811 or
	  rdat___1__h18822 or
	  ...
	  rdat___1__h19100 or
	  rdat___1__h19115 or
	  rdat___1__h19130 or rdat___1__h19136 or rdat___1__h19142)
  begin
  ...
  begin
	...
	if (rdReg_0$EN) rdReg_0 <= `BSV_ASSIGNMENT_DELAY rdReg_0$D_IN;
	...
	if (wdReg_0$EN) wdReg_0 <= `BSV_ASSIGNMENT_DELAY wdReg_0$D_IN;
	...
	if (wmemi_respF_cntr_r$EN)
	  wmemi_respF_cntr_r <= `BSV_ASSIGNMENT_DELAY wmemi_respF_cntr_r$D_IN;
