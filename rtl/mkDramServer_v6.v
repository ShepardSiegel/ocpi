...
//
// On Wed Oct 30 15:55:56 EDT 2013
//
//
// Ports:
// Name                         I/O  size props
...
module mkDramServer_v6(CLK_sys0_clk,
  ...
  wire memc_memc_app_en,
       ...
       memc_memc_dbg_dec_rd_fps,
       memc_memc_dbg_inc_cpt,
       memc_memc_dbg_inc_rd_dqs,
       memc_memc_dbg_inc_rd_fps,
       memc_memc_dbg_ocb_mon_off,
       memc_memc_dbg_pd_byte_sel,
       memc_memc_dbg_pd_maintain_0_only,
       memc_memc_dbg_pd_maintain_off,
       memc_memc_dbg_pd_msb_sel,
       memc_memc_dbg_pd_off,
       memc_memc_dbg_sel_idel_cpt,
       memc_memc_dbg_sel_idel_rsync,
       memc_memc_dbg_wr_dq_tap_set,
       memc_memc_dbg_wr_dqs_tap_set,
       memc_memc_dbg_wr_tap_set_en,
  ...
  reg [63 : 0] v__h19620, v__h3583, v__h3758, v__h3902;
  reg [31 : 0] IF_wci_wslv_reqF_first__3_BITS_39_TO_32_46_EQ__ETC___d663,
	       g_data__h15422,
	       x__h5972,
	       x__h6193;
  reg CASE_x430_0b0_memc_respFFULL_N_0b101_memc_res_ETC__q1;
  wire [175 : 0] IF_wci_wslv_reqF_first__3_BIT_51_45_THEN_pReg__ETC___d496;
  wire [127 : 0] x1_data__h16610, x1_data__h17619;
  wire [31 : 0] dramStatus__h14033,
		g_data__h19086,
		myBE__h6009,
		myBE__h6042,
		rdat___1__h19149,
		...
		rdat___1__h19491,
		x1_addr__h17617;
  wire [15 : 0] x1_be__h17618, x__h19126;
  wire [2 : 0] x__h6430;
  ...
  wire IF_memc_memc_app_rd_data_end__09_CONCAT_memc_r_ETC___d225,
       IF_wci_wslv_reqF_first__3_BIT_51_45_THEN_lreqF_ETC___d521,
       IF_wmemi_reqF_first__77_BITS_51_TO_49_78_EQ_1__ETC___d386,
       _dfoo1,
       _dfoo3,
       _dfoo5,
       _dfoo7,
       dbg_rd_active_dly_RDY_write__24_AND_dbg_dqs_p__ETC___d336,
       dbg_rdlvl_err_RDY_write__18_AND_dbg_cpt_tap_cn_ETC___d342,
       dbg_wl_odelay_dqs_tap_cnt_RDY_write__15_AND_db_ETC___d345,
       lrespF_RDY_first__12_AND_NOT_splitReadInFlight_ETC___d430,
       lrespF_RDY_first__12_AND_NOT_wmemi_respF_cntr__ETC___d414,
       wci_wslv_reqF_i_notEmpty__2_AND_IF_wci_wslv_re_ETC___d457,
  ...
  // submodule appFull
  SyncBit #(.init(1'd0)) appFull(.sCLK(memc_memc_ui_clk),
				 .dCLK(wciS0_Clk),
				 .sRST(memc_memc_ui_clk_sync_rst_n),
				 .sD_IN(appFull_sD_IN),
				 .sEN(appFull_sEN),
  ...
  SyncRegister #(.width(32'd40),
		 .init(40'd0)) dbg_cpt_first_edge_cnt(.sCLK(memc_memc_ui_clk),
						      .dCLK(wciS0_Clk),
						      .sRST(memc_memc_ui_clk_sync_rst_n),
  ...
  SyncRegister #(.width(32'd40),
		 .init(40'd0)) dbg_cpt_second_edge_cnt(.sCLK(memc_memc_ui_clk),
						       .dCLK(wciS0_Clk),
						       .sRST(memc_memc_ui_clk_sync_rst_n),
  ...
  SyncRegister #(.width(32'd40),
		 .init(40'd0)) dbg_cpt_tap_cnt(.sCLK(memc_memc_ui_clk),
					       .dCLK(wciS0_Clk),
					       .sRST(memc_memc_ui_clk_sync_rst_n),
  ...
  SyncRegister #(.width(32'd40),
		 .init(40'd0)) dbg_dq_tap_cnt(.sCLK(memc_memc_ui_clk),
					      .dCLK(wciS0_Clk),
					      .sRST(memc_memc_ui_clk_sync_rst_n),
  ...
  SyncRegister #(.width(32'd40),
		 .init(40'd0)) dbg_dqs_n_tap_cnt(.sCLK(memc_memc_ui_clk),
						 .dCLK(wciS0_Clk),
						 .sRST(memc_memc_ui_clk_sync_rst_n),
  ...
  SyncRegister #(.width(32'd40),
		 .init(40'd0)) dbg_dqs_p_tap_cnt(.sCLK(memc_memc_ui_clk),
						 .dCLK(wciS0_Clk),
						 .sRST(memc_memc_ui_clk_sync_rst_n),
  ...
  SyncRegister #(.width(32'd5),
		 .init(5'd0)) dbg_rd_active_dly(.sCLK(memc_memc_ui_clk),
						.dCLK(wciS0_Clk),
						.sRST(memc_memc_ui_clk_sync_rst_n),
  ...
  SyncRegister #(.width(32'd24),
		 .init(24'd0)) dbg_rd_bitslip_cnt(.sCLK(memc_memc_ui_clk),
						  .dCLK(wciS0_Clk),
						  .sRST(memc_memc_ui_clk_sync_rst_n),
  ...
  SyncRegister #(.width(32'd16),
		 .init(16'd0)) dbg_rd_clkdly_cnt(.sCLK(memc_memc_ui_clk),
						 .dCLK(wciS0_Clk),
						 .sRST(memc_memc_ui_clk_sync_rst_n),
  ...
  SyncRegister #(.width(32'd32),
		 .init(32'd0)) dbg_rddata(.sCLK(memc_memc_ui_clk),
					  .dCLK(wciS0_Clk),
					  .sRST(memc_memc_ui_clk_sync_rst_n),
  ...
  SyncRegister #(.width(32'd2),
		 .init(2'd0)) dbg_rdlvl_done(.sCLK(memc_memc_ui_clk),
					     .dCLK(wciS0_Clk),
					     .sRST(memc_memc_ui_clk_sync_rst_n),
  ...
  SyncRegister #(.width(32'd2),
		 .init(2'd0)) dbg_rdlvl_err(.sCLK(memc_memc_ui_clk),
					    .dCLK(wciS0_Clk),
					    .sRST(memc_memc_ui_clk_sync_rst_n),
  ...
  SyncRegister #(.width(32'd8),
		 .init(8'd0)) dbg_wl_dqs_inverted(.sCLK(memc_memc_ui_clk),
						  .dCLK(wciS0_Clk),
						  .sRST(memc_memc_ui_clk_sync_rst_n),
  ...
  SyncRegister #(.width(32'd40),
		 .init(40'd0)) dbg_wl_odelay_dq_tap_cnt(.sCLK(memc_memc_ui_clk),
							.dCLK(wciS0_Clk),
							.sRST(memc_memc_ui_clk_sync_rst_n),
  ...
  SyncRegister #(.width(32'd40),
		 .init(40'd0)) dbg_wl_odelay_dqs_tap_cnt(.sCLK(memc_memc_ui_clk),
							 .dCLK(wciS0_Clk),
							 .sRST(memc_memc_ui_clk_sync_rst_n),
  ...
  SyncRegister #(.width(32'd16),
		 .init(16'd0)) dbg_wr_calib_clk_delay(.sCLK(memc_memc_ui_clk),
						      .dCLK(wciS0_Clk),
						      .sRST(memc_memc_ui_clk_sync_rst_n),
  ...
  // submodule firBeat
  SyncBit #(.init(1'd0)) firBeat(.sCLK(memc_memc_ui_clk),
				 .dCLK(wciS0_Clk),
				 .sRST(memc_memc_ui_clk_sync_rst_n),
				 .sD_IN(firBeat_sD_IN),
				 .sEN(firBeat_sEN),
  ...
  SyncBit #(.init(1'd0)) initComplete(.sCLK(memc_memc_ui_clk),
				      .dCLK(wciS0_Clk),
				      .sRST(memc_memc_ui_clk_sync_rst_n),
  ...
  SyncFIFO #(.dataWidth(32'd128),
	     .depth(32'd2),
	     .indxWidth(32'd1)) lrespF(.sCLK(memc_memc_ui_clk),
				       .dCLK(wciS0_Clk),
				       .sRST(memc_memc_ui_clk_sync_rst_n),
				       .sD_IN(lrespF_sD_IN),
				       .sENQ(lrespF_sENQ),
  ...
  SyncBit #(.init(1'd0)) memIsResetCC(.sCLK(memc_memc_ui_clk),
				      .dCLK(wciS0_Clk),
				      .sRST(memc_memc_ui_clk_sync_rst_n),
  ...
  // submodule memc_memc
  v6_mig39_2 memc_memc(.sys_rst(memc_rst_stretch_p_RESET_OUT),
		       ...
		       .dbg_dec_rd_fps(memc_memc_dbg_dec_rd_fps),
		       .dbg_inc_cpt(memc_memc_dbg_inc_cpt),
		       .dbg_inc_dec_sel(memc_memc_dbg_inc_dec_sel),
		       .dbg_inc_rd_dqs(memc_memc_dbg_inc_rd_dqs),
		       .dbg_inc_rd_fps(memc_memc_dbg_inc_rd_fps),
		       .dbg_ocb_mon_off(memc_memc_dbg_ocb_mon_off),
		       .dbg_pd_byte_sel(memc_memc_dbg_pd_byte_sel),
		       .dbg_pd_maintain_0_only(memc_memc_dbg_pd_maintain_0_only),
		       .dbg_pd_maintain_off(memc_memc_dbg_pd_maintain_off),
		       .dbg_pd_msb_sel(memc_memc_dbg_pd_msb_sel),
		       .dbg_pd_off(memc_memc_dbg_pd_off),
		       .dbg_sel_idel_cpt(memc_memc_dbg_sel_idel_cpt),
		       .dbg_sel_idel_rsync(memc_memc_dbg_sel_idel_rsync),
		       .dbg_wr_dq_tap_set(memc_memc_dbg_wr_dq_tap_set),
		       .dbg_wr_dqs_tap_set(memc_memc_dbg_wr_dqs_tap_set),
		       .dbg_wr_tap_set_en(memc_memc_dbg_wr_tap_set_en),
		       ...
		       .ui_clk(memc_memc_ui_clk),
		       .ui_clk_sync_rst_n(memc_memc_ui_clk_sync_rst_n),
		       .ddr3_dq(dram_io_dq),
  ...
  arSRLFIFOD #(.width(32'd2),
	       .l2depth(32'd4)) memc_rdpF(.CLK(memc_memc_ui_clk),
					  .RST_N(memc_memc_ui_clk_sync_rst_n),
					  .D_IN(memc_rdpF_D_IN),
					  .ENQ(memc_rdpF_ENQ),
					  .DEQ(memc_rdpF_DEQ),
					  .CLR(memc_rdpF_CLR),
  ...
  // submodule memc_reqF
  FIFO2 #(.width(32'd177),
	  .guarded(32'd1)) memc_reqF(.RST(memc_memc_ui_clk_sync_rst_n),
				     .CLK(memc_memc_ui_clk),
				     .D_IN(memc_reqF_D_IN),
				     .ENQ(memc_reqF_ENQ),
				     .DEQ(memc_reqF_DEQ),
				     .CLR(memc_reqF_CLR),
  ...
  arSRLFIFOD #(.width(32'd128),
	       .l2depth(32'd4)) memc_respF(.CLK(memc_memc_ui_clk),
					   .RST_N(memc_memc_ui_clk_sync_rst_n),
  ...
  SyncRegister #(.width(32'd16),
		 .init(16'd0)) requestCount(.sCLK(memc_memc_ui_clk),
					    .dCLK(wciS0_Clk),
					    .sRST(memc_memc_ui_clk_sync_rst_n),
  ...
  SyncRegister #(.width(32'd16),
		 .init(16'd0)) responseCount(.sCLK(memc_memc_ui_clk),
					     .dCLK(wciS0_Clk),
					     .sRST(memc_memc_ui_clk_sync_rst_n),
  ...
  // submodule secBeat
  SyncBit #(.init(1'd0)) secBeat(.sCLK(memc_memc_ui_clk),
				 .dCLK(wciS0_Clk),
				 .sRST(memc_memc_ui_clk_sync_rst_n),
				 .sD_IN(secBeat_sD_IN),
				 .sEN(secBeat_sEN),
  ...
  // submodule wdfFull
  SyncBit #(.init(1'd0)) wdfFull(.sCLK(memc_memc_ui_clk),
				 .dCLK(wciS0_Clk),
				 .sRST(memc_memc_ui_clk_sync_rst_n),
				 .sD_IN(wdfFull_sD_IN),
				 .sEN(wdfFull_sEN),
  ...
  assign WILL_FIRE_RL_memc_advance_request =
	     memc_reqF_EMPTY_N &&
	     (x1__h12521 || !memc_reqF_D_OUT[176] || memc_rdpF_FULL_N) &&
	     memc_memc_phy_init_done &&
	     !memc_firstBeat &&
	     !memc_secondBeat ;
  ...
  assign MUX_lreqF_enq_1__VAL_3 =
	     { !wci_wslv_reqF_D_OUT[51] &&
	       wci_wslv_reqF_D_OUT[39:32] != 8'h54,
	       IF_wci_wslv_reqF_first__3_BIT_51_45_THEN_pReg__ETC___d496 } ;
  ...
  assign MUX_wci_wslv_respF_q_1_write_1__VAL_1 =
	     (wci_wslv_respF_cntr_r == 2'd2) ?
	       MUX_wci_wslv_respF_q_0_write_1__VAL_2 :
	       34'h0AAAAAAAA ;
  assign MUX_wci_wslv_respF_x_wire_wset_1__VAL_1 = { 2'd1, g_data__h15422 } ;
  assign MUX_wci_wslv_respF_x_wire_wset_1__VAL_2 = { 2'd1, g_data__h19086 } ;
  ...
  // submodule appFull
  assign appFull_sD_IN = x1__h12521 ;
  ...
  assign memc_memc_app_wdf_mask =
	     WILL_FIRE_RL_memc_advance_write0 ? ~x__h5972 : ~x__h6193 ;
  assign memc_memc_dbg_dec_cpt = 1'd0 ;
  assign memc_memc_dbg_dec_rd_dqs = 1'd0 ;
  assign memc_memc_dbg_dec_rd_fps = 1'd0 ;
  assign memc_memc_dbg_inc_cpt = 1'd0 ;
  assign memc_memc_dbg_inc_dec_sel = 3'd0 ;
  assign memc_memc_dbg_inc_rd_dqs = 1'd0 ;
  assign memc_memc_dbg_inc_rd_fps = 1'd0 ;
  assign memc_memc_dbg_ocb_mon_off = 1'd0 ;
  assign memc_memc_dbg_pd_byte_sel = 1'd0 ;
  assign memc_memc_dbg_pd_maintain_0_only = 1'd0 ;
  assign memc_memc_dbg_pd_maintain_off = 1'd0 ;
  assign memc_memc_dbg_pd_msb_sel = 1'd0 ;
  assign memc_memc_dbg_pd_off = 1'd0 ;
  assign memc_memc_dbg_sel_idel_cpt = 1'd0 ;
  assign memc_memc_dbg_sel_idel_rsync = 1'd0 ;
  assign memc_memc_dbg_wr_dq_tap_set = 1'd0 ;
  assign memc_memc_dbg_wr_dqs_tap_set = 1'd0 ;
  assign memc_memc_dbg_wr_tap_set_en = 1'd0 ;
  ...
  // submodule memc_respF
  always@(x__h6430 or memc_memc_app_rd_data)
  begin
    case (x__h6430)
  ...
  assign memc_respF_ENQ =
	     WILL_FIRE_RL_memc_advance_readData &&
	     (x__h6430 == 3'b0 || x__h6430 == 3'b101 || x__h6430 == 3'b110 ||
	      x__h6430 == 3'b011) ;
  ...
  assign IF_memc_memc_app_rd_data_end__09_CONCAT_memc_r_ETC___d225 =
	     CASE_x430_0b0_memc_respFFULL_N_0b101_memc_res_ETC__q1 &&
	     (!memc_memc_app_rd_data_end || memc_rdpF_EMPTY_N) ;
  assign IF_wci_wslv_reqF_first__3_BIT_51_45_THEN_lreqF_ETC___d521 =
	     wci_wslv_reqF_D_OUT[51] ?
	       lreqF_sFULL_N && splaF_FULL_N :
	       wci_wslv_respF_cntr_r != 2'd2 ;
  assign IF_wci_wslv_reqF_first__3_BIT_51_45_THEN_pReg__ETC___d496 =
	     wci_wslv_reqF_D_OUT[51] ?
	       { x1_addr__h17617, x1_be__h17618, x1_data__h17619 } :
	       { wci_wslv_reqF_D_OUT[31:0], mReg, x1_data__h16610 } ;
  assign IF_wmemi_reqF_first__77_BITS_51_TO_49_78_EQ_1__ETC___d386 =
	     (wmemi_reqF_D_OUT[51:49] == 3'd1) ?
	       lreqF_sFULL_N && wmemi_dhF_EMPTY_N :
	       !wmemiReadInFlight_value_03_SLT_16___d383 || lreqF_sFULL_N ;
  assign _dfoo1 =
	     wci_wslv_respF_cntr_r != 2'd2 ||
  ...
  assign dbg_rd_active_dly_RDY_write__24_AND_dbg_dqs_p__ETC___d336 =
	     ...
	     requestCount_sRDY &&
	     responseCount_sRDY ;
  assign dbg_rdlvl_err_RDY_write__18_AND_dbg_cpt_tap_cn_ETC___d342 =
	     ...
	     dbg_rd_active_dly_RDY_write__24_AND_dbg_dqs_p__ETC___d336 ;
  assign dbg_wl_odelay_dqs_tap_cnt_RDY_write__15_AND_db_ETC___d345 =
	     dbg_wl_odelay_dqs_tap_cnt_sRDY &&
	     dbg_wl_odelay_dq_tap_cnt_sRDY &&
	     dbg_rdlvl_done_sRDY &&
	     dbg_rdlvl_err_RDY_write__18_AND_dbg_cpt_tap_cn_ETC___d342 ;
  assign dramStatus__h14033 = { 16'd0, x__h19126 } ;
  assign g_data__h19086 =
	     wci_wslv_reqF_D_OUT[51] ?
	       32'd0 :
	       IF_wci_wslv_reqF_first__3_BITS_39_TO_32_46_EQ__ETC___d663 ;
  assign lrespF_RDY_first__12_AND_NOT_splitReadInFlight_ETC___d430 =
	     lrespF_dEMPTY_N &&
	     (!splitReadInFlight ||
	      splaF_EMPTY_N && wci_wslv_respF_cntr_r != 2'd2) ;
  assign lrespF_RDY_first__12_AND_NOT_wmemi_respF_cntr__ETC___d414 =
	     lrespF_dEMPTY_N && wmemi_respF_cntr_r != 2'd2 &&
	     wmemi_operateD &&
	     wmemi_peerIsReady ;
  assign myBE__h6009 = { 16'h0, memc_reqF_D_OUT[143:128] } ;
  assign myBE__h6042 = { memc_reqF_D_OUT[143:128], 16'h0 } ;
  assign rdat___1__h19149 =
	     hasDebugLogic ? { 24'd0, dbg_wl_dqs_inverted_dD_OUT } : 32'd0 ;
  assign rdat___1__h19160 =
	     hasDebugLogic ?
	       { 16'd0, dbg_wr_calib_clk_delay_dD_OUT } :
	       32'd0 ;
  assign rdat___1__h19171 =
	     hasDebugLogic ? dbg_wl_odelay_dqs_tap_cnt_dD_OUT[31:0] : 32'd0 ;
  assign rdat___1__h19182 =
	     hasDebugLogic ? dbg_wl_odelay_dq_tap_cnt_dD_OUT[31:0] : 32'd0 ;
  assign rdat___1__h19193 =
  ...
  assign rdat___1__h19314 = hasDebugLogic ? dbg_rddata_dD_OUT : 32'd0 ;
  assign rdat___1__h19321 =
	     hasDebugLogic ? { 16'd0, requestCount_dD_OUT } : 32'd0 ;
  assign rdat___1__h19332 =
	     hasDebugLogic ? { 16'd0, responseCount_dD_OUT } : 32'd0 ;
  assign rdat___1__h19343 = hasDebugLogic ? { 16'd0, pReg } : 32'd0 ;
  assign rdat___1__h19353 = hasDebugLogic ? { 16'd0, mReg } : 32'd0 ;
  assign rdat___1__h19363 = hasDebugLogic ? wdReg_0 : 32'd0 ;
  assign rdat___1__h19377 = hasDebugLogic ? wdReg_1 : 32'd0 ;
  assign rdat___1__h19391 = hasDebugLogic ? wdReg_2 : 32'd0 ;
  assign rdat___1__h19405 = hasDebugLogic ? wdReg_3 : 32'd0 ;
  assign rdat___1__h19419 = hasDebugLogic ? rdReg_0 : 32'd0 ;
  assign rdat___1__h19434 = hasDebugLogic ? rdReg_1 : 32'd0 ;
  assign rdat___1__h19449 = hasDebugLogic ? rdReg_2 : 32'd0 ;
  assign rdat___1__h19464 = hasDebugLogic ? rdReg_3 : 32'd0 ;
  assign rdat___1__h19479 = hasDebugLogic ? wmemiWrReq : 32'd0 ;
  assign rdat___1__h19485 = hasDebugLogic ? wmemiRdReq : 32'd0 ;
  assign rdat___1__h19491 = hasDebugLogic ? wmemiRdResp : 32'd0 ;
  assign wci_wslv_reqF_i_notEmpty__2_AND_IF_wci_wslv_re_ETC___d457 =
	     wci_wslv_reqF_EMPTY_N &&
	     (wci_wslv_reqF_D_OUT[51] ?
		lreqF_sFULL_N :
		((wci_wslv_reqF_D_OUT[39:32] == 8'h54) ?
  ...
  assign wci_wslv_respF_cntr_r_8_MINUS_1___d27 =
	     wci_wslv_respF_cntr_r - 2'd1 ;
  assign wmemiReadInFlight_value_03_SLT_16___d383 =
	     (wmemiReadInFlight_value ^ 8'h80) < 8'd144 ;
  assign wmemi_respF_cntr_r_47_MINUS_1___d256 = wmemi_respF_cntr_r - 2'd1 ;
  assign x1__h12521 = !memc_memc_app_rdy ;
  assign x1_addr__h17617 = { pReg[12:0], wci_wslv_reqF_D_OUT[50:36], 4'd0 } ;
  assign x1_be__h17618 =
  ...
  assign x1_data__h16610 = { wdReg_3, wdReg_2, wdReg_1, wdReg_0 } ;
  assign x1_data__h17619 = {4{wci_wslv_reqF_D_OUT[31:0]}} ;
  assign x__h19126 =
	     { respCount,
	       2'b0,
	       memIsResetCC_dD_OUT,
	       ...
	       firBeat_dD_OUT,
	       initComplete_dD_OUT } ;
  assign x__h6430 = { memc_memc_app_rd_data_end, memc_rdpF_D_OUT } ;
  always@(splaF_D_OUT or lrespF_dD_OUT)
  begin
    case (splaF_D_OUT)
      2'd0: g_data__h15422 = lrespF_dD_OUT[31:0];
      2'd1: g_data__h15422 = lrespF_dD_OUT[63:32];
      2'd2: g_data__h15422 = lrespF_dD_OUT[95:64];
      2'd3: g_data__h15422 = lrespF_dD_OUT[127:96];
    endcase
  end
  always@(memc_reqF_D_OUT or myBE__h6009 or myBE__h6042)
  begin
    case (memc_reqF_D_OUT[149:148])
      2'b0: x__h5972 = myBE__h6009;
      2'b01: x__h5972 = myBE__h6042;
      default: x__h5972 = 32'd0;
    endcase
  end
  always@(memc_reqF_D_OUT or myBE__h6009 or myBE__h6042)
  begin
    case (memc_reqF_D_OUT[149:148])
      2'b10: x__h6193 = myBE__h6009;
      2'b11: x__h6193 = myBE__h6042;
      default: x__h6193 = 32'd0;
    endcase
  end
  always@(x__h6430 or memc_respF_FULL_N)
  begin
    case (x__h6430)
      3'b0, 3'b101, 3'b110:
	  CASE_x430_0b0_memc_respFFULL_N_0b101_memc_res_ETC__q1 =
	      memc_respF_FULL_N;
      default: CASE_x430_0b0_memc_respFFULL_N_0b101_memc_res_ETC__q1 =
		   x__h6430 != 3'b011 || memc_respF_FULL_N;
    endcase
  end
  always@(wci_wslv_reqF_D_OUT or
	  dramStatus__h14033 or
	  dramCtrl or
	  rdat___1__h19149 or
	  rdat___1__h19160 or
	  rdat___1__h19171 or
	  ...
	  rdat___1__h19449 or
	  rdat___1__h19464 or
	  rdat___1__h19479 or rdat___1__h19485 or rdat___1__h19491)
  begin
    case (wci_wslv_reqF_D_OUT[39:32])
	  ...
	  IF_wci_wslv_reqF_first__3_BITS_39_TO_32_46_EQ__ETC___d663 =
	      rdat___1__h19491;
      default: IF_wci_wslv_reqF_first__3_BITS_39_TO_32_46_EQ__ETC___d663 =
		   32'd0;
    endcase
  end
  ...
  always@(posedge memc_memc_ui_clk)
  begin
    if (memc_memc_ui_clk_sync_rst_n == `BSV_RESET_VALUE)
      begin
  ...
  always@(posedge memc_memc_ui_clk or
	  `BSV_RESET_EDGE memc_memc_ui_clk_sync_rst_n)
  if (memc_memc_ui_clk_sync_rst_n == `BSV_RESET_VALUE)
    begin
  ...
  begin
	...
	$display("Error: \"bsv/wrk/DramServer_v6.bsv\", line 186, column 28: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_cfwr] and\n  [RL_advance_response] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n != `BSV_RESET_VALUE)
	...
	$display("Error: \"bsv/wrk/DramServer_v6.bsv\", line 186, column 38: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_cfrd] and\n  [RL_advance_response] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n != `BSV_RESET_VALUE)
	...
	$display("Error: \"bsv/wrk/DramServer_v6.bsv\", line 186, column 62: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_ctrl_IsO] and\n  [RL_wci_ctrl_OrE] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_wci_ctrl_EiI && WILL_FIRE_RL_wci_ctrl_OrE)
	$display("Error: \"bsv/wrk/DramServer_v6.bsv\", line 186, column 48: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_ctrl_EiI] and\n  [RL_wci_ctrl_OrE] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n != `BSV_RESET_VALUE)
