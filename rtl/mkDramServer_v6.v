...
//
// On Tue Nov  5 11:21:41 EST 2013
//
//
// Ports:
// Name                         I/O  size props
...
module mkDramServer_v6(CLK_sys0_clk,
  ...
  // register memInReset
  reg memInReset;
  wire memInReset$D_IN, memInReset$EN;
  ...
  wire [31 : 0] uclkUpdateCnt$D_IN;
  wire uclkUpdateCnt$EN;
  ...
  wire [31 : 0] wci_uclkUpdateCnt$dD_OUT, wci_uclkUpdateCnt$sD_IN;
  wire wci_uclkUpdateCnt$sEN, wci_uclkUpdateCnt$sRDY;
  ...
  // value method isReset
  assign isReset = memIsResetCC$dD_OUT ;

  // value method isTrained
  assign isTrained = initComplete$dD_OUT ;
  ...
  SyncRegister #(.width(32'd32),
		 .init(32'd0)) wci_uclkUpdateCnt(.sCLK(memc_memc$tb_clk),
						 .dCLK(wciS0_Clk),
						 .sRST(memc_memc$tb_rst_n),
						 .sD_IN(wci_uclkUpdateCnt$sD_IN),
						 .sEN(wci_uclkUpdateCnt$sEN),
						 .dD_OUT(wci_uclkUpdateCnt$dD_OUT),
						 .sRDY(wci_uclkUpdateCnt$sRDY));
  ...
  assign WILL_FIRE_RL_memc_advance_request =
	     memc_reqF$EMPTY_N &&
	     (x1__h12825 || !memc_reqF$D_OUT[176] || memc_rdpF$FULL_N) &&
	     memc_memc$phy_init_done &&
	     !memc_firstBeat &&
	     !memc_secondBeat ;
  ...
  assign MUX_wci_wslv_respF_q_1$write_1__VAL_1 =
	     (wci_wslv_respF_cntr_r == 2'd2) ?
	       MUX_wci_wslv_respF_q_0$write_1__VAL_2 :
	       34'h0AAAAAAAA ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_1 = { 2'd1, g_data__h15477 } ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_2 = { 2'd1, g_data__h19141 } ;
  ...
  assign memInReset_1$wget = 1'd0 ;
  assign memInReset_1$whas = 1'd1 ;
  ...
  // register memInReset
  assign memInReset$D_IN = 1'b0 ;
  assign memInReset$EN = 1'd1 ;
  ...
  // register uclkUpdateCnt
  assign uclkUpdateCnt$D_IN = uclkUpdateCnt + 32'd1 ;
  assign uclkUpdateCnt$EN =
  ...
  // submodule appFull
  assign appFull$sD_IN = x1__h12825 ;
  ...
  // submodule wci_uclkUpdateCnt
  assign wci_uclkUpdateCnt$sD_IN = uclkUpdateCnt ;
  assign wci_uclkUpdateCnt$sEN = wci_uclkUpdateCnt$sRDY ;
  ...
  assign IF_wci_wslv_reqF_first__3_BIT_51_52_THEN_pReg__ETC___d503 =
	     wci_wslv_reqF$D_OUT[51] ?
	       ...
	       { wci_wslv_reqF$D_OUT[31:0], mReg, x1_data__h16665 } ;
  assign IF_wmemi_reqF_first__84_BITS_51_TO_49_85_EQ_1__ETC___d393 =
	     (wmemi_reqF$D_OUT[51:49] == 3'd1) ?
	       lreqF$sFULL_N && wmemi_dhF$EMPTY_N :
	       !wmemiReadInFlight_value_07_SLT_16___d390 || lreqF$sFULL_N ;
  assign _dfoo1 =
	     wci_wslv_respF_cntr_r != 2'd2 ||
  ...
  assign rdat___1__h19369 = hasDebugLogic ? dbg_rddata$dD_OUT : 32'd0 ;
  ...
  assign rdat___1__h19552 = hasDebugLogic ? wci_uclkUpdateCnt$dD_OUT : 32'd0 ;
  ...
  assign x1__h12825 = !memc_memc$app_rdy ;
  assign x1_addr__h17672 = { pReg[12:0], wci_wslv_reqF$D_OUT[50:36], 4'd0 } ;
  ...
  assign x1_data__h17674 = {4{wci_wslv_reqF$D_OUT[31:0]}} ;
  assign x__h19181 =
	     { respCount,
	       2'b0,
	       memIsResetCC$dD_OUT,
  ...
  begin
    case (splaF$D_OUT)
      2'd0: g_data__h15477 = lrespF$dD_OUT[31:0];
      2'd1: g_data__h15477 = lrespF$dD_OUT[63:32];
      2'd2: g_data__h15477 = lrespF$dD_OUT[95:64];
      2'd3: g_data__h15477 = lrespF$dD_OUT[127:96];
    endcase
  end
  ...
  begin
	...
	if (memInReset$EN)
	  memInReset <= `BSV_ASSIGNMENT_DELAY memInReset$D_IN;
  ...
  begin
	...
	if (uclkUpdateCnt$EN)
	  uclkUpdateCnt <= `BSV_ASSIGNMENT_DELAY uclkUpdateCnt$D_IN;
      end
  end
