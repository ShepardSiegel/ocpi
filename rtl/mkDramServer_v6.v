...
//
// On Wed Oct 30 11:23:55 EDT 2013
//
//
// Ports:
// Name                         I/O  size props
...
module mkDramServer_v6(CLK_sys0_clk,
  ...
  wire memc_rst_stretch_n$OUT_RST;

  // ports of submodule memc_rst_stretch_p
  wire memc_rst_stretch_p$RESET_OUT;
  ...
  reg [63 : 0] v__h19278, v__h3583, v__h3758, v__h3902;
  ...
  wire [127 : 0] x1_data__h16268, x1_data__h17277;
  wire [31 : 0] dramStatus__h13691,
		g_data__h18744,
		myBE__h5964,
		myBE__h5997,
		rdat___1__h18807,
		...
		rdat___1__h19149,
		x1_addr__h17275;
  wire [15 : 0] x1_be__h17276, x__h18784;
  wire [2 : 0] x__h6385;
  ...
  // submodule memc_memc
  v6_mig37 memc_memc(.sys_rst(memc_rst_stretch_p$RESET_OUT),
  ...
  SyncResetA #(.RSTDELAY(32'd15)) memc_rst_stretch_n(.CLK(CLK_sys0_clk),
						     ...
						     .OUT_RST(memc_rst_stretch_n$OUT_RST));

  // submodule memc_rst_stretch_p
  ResetInverter memc_rst_stretch_p(.RESET_IN(memc_rst_stretch_n$OUT_RST),
				   .RESET_OUT(memc_rst_stretch_p$RESET_OUT));
  ...
  assign WILL_FIRE_RL_memc_advance_request =
	     memc_reqF$EMPTY_N &&
	     (x1__h12476 || !memc_reqF$D_OUT[176] || memc_rdpF$FULL_N) &&
	     memc_memc$phy_init_done &&
	     !memc_firstBeat &&
	     !memc_secondBeat ;
  ...
  assign MUX_wci_wslv_respF_q_1$write_1__VAL_2 =
	     (wci_wslv_respF_cntr_r == 2'd2) ?
	       MUX_wci_wslv_respF_q_0$write_1__VAL_1 :
	       34'h0AAAAAAAA ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_1 = { 2'd1, g_data__h15080 } ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_2 = { 2'd1, g_data__h18744 } ;
  ...
  // submodule appFull
  assign appFull$sD_IN = x1__h12476 ;
  ...
  // submodule memc_respF
  always@(x__h6385 or memc_memc$app_rd_data)
  begin
    case (x__h6385)
  ...
  assign IF_wci_wslv_reqF_first__3_BIT_51_45_THEN_pReg__ETC___d496 =
	     wci_wslv_reqF$D_OUT[51] ?
	       { x1_addr__h17275, x1_be__h17276, x1_data__h17277 } :
	       { wci_wslv_reqF$D_OUT[31:0], mReg, x1_data__h16268 } ;
  ...
  assign dbg_wl_odelay_dqs_tap_cnt_RDY_write__15_AND_db_ETC___d345 =
	     ...
	     dbg_rdlvl_done$sRDY &&
	     dbg_rdlvl_err_RDY_write__18_AND_dbg_cpt_tap_cn_ETC___d342 ;
  assign dramStatus__h13691 = { 16'd0, x__h18784 } ;
  assign g_data__h18744 =
	     wci_wslv_reqF$D_OUT[51] ?
	       32'd0 :
  ...
  assign lrespF_RDY_first__12_AND_NOT_wmemi_respF_cntr__ETC___d414 =
	     ...
	     wmemi_operateD &&
	     wmemi_peerIsReady ;
  assign myBE__h5964 = { 16'h0, memc_reqF$D_OUT[143:128] } ;
  assign myBE__h5997 = { memc_reqF$D_OUT[143:128], 16'h0 } ;
  assign rdat___1__h18807 =
	     hasDebugLogic ? { 24'd0, dbg_wl_dqs_inverted$dD_OUT } : 32'd0 ;
  assign rdat___1__h18818 =
	     hasDebugLogic ?
	       { 16'd0, dbg_wr_calib_clk_delay$dD_OUT } :
	       32'd0 ;
  assign rdat___1__h18829 =
	     hasDebugLogic ? dbg_wl_odelay_dqs_tap_cnt$dD_OUT[31:0] : 32'd0 ;
  assign rdat___1__h18840 =
	     hasDebugLogic ? dbg_wl_odelay_dq_tap_cnt$dD_OUT[31:0] : 32'd0 ;
  assign rdat___1__h18851 =
	     hasDebugLogic ? { 30'd0, dbg_rdlvl_done$dD_OUT } : 32'd0 ;
  assign rdat___1__h18862 =
	     hasDebugLogic ? { 30'd0, dbg_rdlvl_err$dD_OUT } : 32'd0 ;
  assign rdat___1__h18873 =
	     hasDebugLogic ? dbg_cpt_tap_cnt$dD_OUT[31:0] : 32'd0 ;
  assign rdat___1__h18884 =
	     hasDebugLogic ? dbg_cpt_first_edge_cnt$dD_OUT[31:0] : 32'd0 ;
  assign rdat___1__h18895 =
	     hasDebugLogic ? dbg_cpt_second_edge_cnt$dD_OUT[31:0] : 32'd0 ;
  assign rdat___1__h18906 =
	     hasDebugLogic ? { 8'd0, dbg_rd_bitslip_cnt$dD_OUT } : 32'd0 ;
  assign rdat___1__h18917 =
	     hasDebugLogic ? { 16'd0, dbg_rd_clkdly_cnt$dD_OUT } : 32'd0 ;
  assign rdat___1__h18928 =
	     hasDebugLogic ? { 27'd0, dbg_rd_active_dly$dD_OUT } : 32'd0 ;
  assign rdat___1__h18939 =
	     hasDebugLogic ? dbg_dqs_p_tap_cnt$dD_OUT[31:0] : 32'd0 ;
  assign rdat___1__h18950 =
	     hasDebugLogic ? dbg_dqs_n_tap_cnt$dD_OUT[31:0] : 32'd0 ;
  assign rdat___1__h18961 =
	     hasDebugLogic ? dbg_dq_tap_cnt$dD_OUT[31:0] : 32'd0 ;
  assign rdat___1__h18972 = hasDebugLogic ? dbg_rddata$dD_OUT : 32'd0 ;
  assign rdat___1__h18979 =
	     hasDebugLogic ? { 16'd0, requestCount$dD_OUT } : 32'd0 ;
  assign rdat___1__h18990 =
	     hasDebugLogic ? { 16'd0, responseCount$dD_OUT } : 32'd0 ;
  assign rdat___1__h19001 = hasDebugLogic ? { 16'd0, pReg } : 32'd0 ;
  assign rdat___1__h19011 = hasDebugLogic ? { 16'd0, mReg } : 32'd0 ;
  assign rdat___1__h19021 = hasDebugLogic ? wdReg_0 : 32'd0 ;
  assign rdat___1__h19035 = hasDebugLogic ? wdReg_1 : 32'd0 ;
  assign rdat___1__h19049 = hasDebugLogic ? wdReg_2 : 32'd0 ;
  assign rdat___1__h19063 = hasDebugLogic ? wdReg_3 : 32'd0 ;
  assign rdat___1__h19077 = hasDebugLogic ? rdReg_0 : 32'd0 ;
  assign rdat___1__h19092 = hasDebugLogic ? rdReg_1 : 32'd0 ;
  assign rdat___1__h19107 = hasDebugLogic ? rdReg_2 : 32'd0 ;
  assign rdat___1__h19122 = hasDebugLogic ? rdReg_3 : 32'd0 ;
  assign rdat___1__h19137 = hasDebugLogic ? wmemiWrReq : 32'd0 ;
  assign rdat___1__h19143 = hasDebugLogic ? wmemiRdReq : 32'd0 ;
  assign rdat___1__h19149 = hasDebugLogic ? wmemiRdResp : 32'd0 ;
  ...
  assign x1__h12476 = !memc_memc$app_rdy ;
  assign x1_addr__h17275 = { pReg[12:0], wci_wslv_reqF$D_OUT[50:36], 4'd0 } ;
  assign x1_be__h17276 =
  ...
  assign x1_data__h16268 = { wdReg_3, wdReg_2, wdReg_1, wdReg_0 } ;
  assign x1_data__h17277 = {4{wci_wslv_reqF$D_OUT[31:0]}} ;
  assign x__h18784 =
	     { respCount,
	       2'b0,
	       memIsResetCC$dD_OUT,
	       ...
	       firBeat$dD_OUT,
	       initComplete$dD_OUT } ;
  assign x__h6385 = { memc_memc$app_rd_data_end, memc_rdpF$D_OUT } ;
  always@(splaF$D_OUT or lrespF$dD_OUT)
  begin
    case (splaF$D_OUT)
      2'd0: g_data__h15080 = lrespF$dD_OUT[31:0];
      2'd1: g_data__h15080 = lrespF$dD_OUT[63:32];
      2'd2: g_data__h15080 = lrespF$dD_OUT[95:64];
      2'd3: g_data__h15080 = lrespF$dD_OUT[127:96];
    endcase
  end
  always@(memc_reqF$D_OUT or myBE__h5964 or myBE__h5997)
  begin
  ...
  always@(x__h6385 or memc_respF$FULL_N)
  begin
    case (x__h6385)
      3'b0, 3'b101, 3'b110:
	  CASE_x385_0b0_memc_respFFULL_N_0b101_memc_res_ETC__q1 =
      ...
      default: CASE_x385_0b0_memc_respFFULL_N_0b101_memc_res_ETC__q1 =
		   x__h6385 != 3'b011 || memc_respF$FULL_N;
    endcase
  end
  always@(wci_wslv_reqF$D_OUT or
	  dramStatus__h13691 or
	  dramCtrl or
	  rdat___1__h18807 or
	  rdat___1__h18818 or
	  rdat___1__h18829 or
	  ...
	  rdat___1__h19107 or
	  rdat___1__h19122 or
	  rdat___1__h19137 or rdat___1__h19143 or rdat___1__h19149)
  begin
