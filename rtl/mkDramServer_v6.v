...
//
// On Tue Feb 28 18:24:49 EST 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkDramServer_v6(CLK_sys0_clk,
  ...
  reg [63 : 0] v__h19123, v__h3637, v__h3811, v__h3955;
  ...
  wire [127 : 0] x1_data__h16122, x1_data__h17123;
  wire [31 : 0] dramStatus__h13512,
		g_data__h18639,
		myBE__h5999,
		myBE__h6032,
		rdat___1__h18702,
		...
		rdat___1__h18869,
		x1_addr__h17121;
  wire [15 : 0] x1_be__h17122, x__h18679;
  wire [2 : 0] x__h6432;
  wire IF_memc_memc_app_rd_data_end__11_CONCAT_memc_r_ETC___d227,
       ...
       wmemiReadInFlight_value_07_SLT_16___d715,
       x1__h12320;
  ...
  assign WILL_FIRE_RL_memc_advance_request =
	     memc_reqF$EMPTY_N &&
	     (x1__h12320 || !memc_reqF$D_OUT[176] || memc_rdpF$FULL_N) &&
	     memc_memc$phy_init_done &&
	     !memc_firstBeat &&
	     !memc_secondBeat ;
  ...
  assign MUX_wci_wslv_respF_q_1$write_1__VAL_2 =
	     (wci_wslv_respF_c_r == 2'd2) ?
	       MUX_wci_wslv_respF_q_0$write_1__VAL_1 :
	       34'h0AAAAAAAA ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_1 = { 2'd1, g_data__h14883 } ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_2 = { 2'd1, g_data__h18639 } ;
  ...
  // submodule appFull
  assign appFull$sD_IN = x1__h12320 ;
  ...
  assign IF_wci_wslv_reqF_first__5_BIT_51_55_THEN_pReg__ETC___d506 =
	     wci_wslv_reqF$D_OUT[51] ?
	       { x1_addr__h17121, x1_be__h17122, x1_data__h17123 } :
	       { wci_wslv_reqF$D_OUT[31:0], mReg, x1_data__h16122 } ;
  assign IF_wmemi_reqF_first__81_BITS_51_TO_49_82_EQ_1__ETC___d390 =
	     (wmemi_reqF$D_OUT[51:49] == 3'd1) ?
	       lreqF$sFULL_N && wmemi_dhF$EMPTY_N :
	       !wmemiReadInFlight_value_07_SLT_16___d715 || lreqF$sFULL_N ;
  ...
  assign dbg_wl_odelay_dqs_tap_cnt_RDY_write__19_AND_db_ETC___d349 =
	     ...
	     dbg_rdlvl_done$sRDY &&
	     dbg_rdlvl_err_RDY_write__22_AND_dbg_cpt_tap_cn_ETC___d346 ;
  assign dramStatus__h13512 = { 16'd0, x__h18679 } ;
  assign g_data__h18639 =
	     wci_wslv_reqF$D_OUT[51] ?
	       32'd0 :
  ...
  assign rdat___1__h18702 = { 24'd0, dbg_wl_dqs_inverted$dD_OUT } ;
  assign rdat___1__h18711 = { 16'd0, dbg_wr_calib_clk_delay$dD_OUT } ;
  assign rdat___1__h18738 = { 30'd0, dbg_rdlvl_done$dD_OUT } ;
  assign rdat___1__h18747 = { 30'd0, dbg_rdlvl_err$dD_OUT } ;
  assign rdat___1__h18783 = { 8'd0, dbg_rd_bitslip_cnt$dD_OUT } ;
  assign rdat___1__h18792 = { 16'd0, dbg_rd_clkdly_cnt$dD_OUT } ;
  assign rdat___1__h18801 = { 27'd0, dbg_rd_active_dly$dD_OUT } ;
  assign rdat___1__h18843 = { 16'd0, requestCount$dD_OUT } ;
  assign rdat___1__h18852 = { 16'd0, responseCount$dD_OUT } ;
  assign rdat___1__h18861 = { 16'd0, pReg } ;
  assign rdat___1__h18869 = { 16'd0, mReg } ;
  ...
  assign wmemiReadInFlight_value_07_SLT_16___d715 =
	     (wmemiReadInFlight_value ^ 8'h80) < 8'd144 ;
  assign x1__h12320 = !memc_memc$app_rdy ;
  assign x1_addr__h17121 = { pReg[12:0], wci_wslv_reqF$D_OUT[50:36], 4'd0 } ;
  assign x1_be__h17122 =
  ...
  assign x1_data__h16122 = { wdReg_3, wdReg_2, wdReg_1, wdReg } ;
  assign x1_data__h17123 = {4{wci_wslv_reqF$D_OUT[31:0]}} ;
  assign x__h18679 =
	     { respCount,
	       2'h0,
	       memIsResetCC$dD_OUT,
  ...
  begin
    case (splaF$D_OUT)
      2'd0: g_data__h14883 = lrespF$dD_OUT[31:0];
      2'd1: g_data__h14883 = lrespF$dD_OUT[63:32];
      2'd2: g_data__h14883 = lrespF$dD_OUT[95:64];
      2'd3: g_data__h14883 = lrespF$dD_OUT[127:96];
    endcase
  end
  always@(wci_wslv_reqF$D_OUT or
	  dramStatus__h13512 or
	  dramCtrl or
	  rdat___1__h18702 or
	  rdat___1__h18711 or
	  ...
	  rdReg or
	  rdReg_1 or
	  rdReg_2 or rdReg_3 or wmemiWrReq or wmemiRdReq or wmemiRdResp)
  begin
  ...
  begin
	...
	$display("Error: \"bsv/wrk/DramServer_v6.bsv\", line 175, column 28: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_cfwr] and\n  [RL_advance_response] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n)
	...
	$display("Error: \"bsv/wrk/DramServer_v6.bsv\", line 175, column 38: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_cfrd] and\n  [RL_advance_response] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n)
	...
	$display("Error: \"bsv/wrk/DramServer_v6.bsv\", line 175, column 62: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_ctrl_IsO] and\n  [RL_wci_ctrl_OrE] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wci_ctrl_EiI && WILL_FIRE_RL_wci_ctrl_OrE)
	$display("Error: \"bsv/wrk/DramServer_v6.bsv\", line 175, column 48: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_ctrl_EiI] and\n  [RL_wci_ctrl_OrE] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n)
