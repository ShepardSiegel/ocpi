...
//
// On Mon Sep 19 13:11:20 EDT 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkGbeWorker(CLK_gmii_rx_clk,
  ...
  wire [31 : 0] IF_emac_rx_buffer_rRdPackets_rsCounter_95_BIT__ETC___d1571,
		IF_emac_rx_buffer_rRdPackets_rsCounter_95_BIT__ETC___d1572,
		IF_emac_rx_buffer_rWrPackets_rsCounter_65_BIT__ETC___d1566,
		IF_emac_rx_buffer_rWrPackets_rsCounter_65_BIT__ETC___d1567,
		IF_emac_tx_buffer_rRdPackets_rsCounter_065_BIT_ETC___d1581,
		IF_emac_tx_buffer_rRdPackets_rsCounter_065_BIT_ETC___d1582,
		IF_emac_tx_buffer_rWrPackets_rsCounter_48_BIT__ETC___d1576,
		IF_emac_tx_buffer_rWrPackets_rsCounter_48_BIT__ETC___d1577,
		status__h39033,
		x_data__h38455;
  wire [15 : 0] x__h39179;
  ...
  wire IF_emac_rx_buffer_fifoDeq_rw_enq_whas__82_THEN_ETC___d1327,
       IF_emac_tx_buffer_fifoEnq_rw_enq_whas__36_THEN_ETC___d1573,
       IF_emac_tx_buffer_fifoEnq_rw_enq_whas__36_THEN_ETC___d1574,
       ...
       emac_rx_buffer_rRdPackets_rsCounter_95_BIT_0_0_ETC___d1492,
       emac_rx_buffer_rWrPackets_rsCounter_65_BIT_0_7_ETC___d1491,
       ...
       emac_tx_buffer_rRdPackets_rsCounter_065_BIT_0__ETC___d1494,
       emac_tx_buffer_rWrPackets_rsCounter_48_BIT_0_5_ETC___d1493,
       z__h16941,
       z__h16948,
       z__h16955,
       z__h16962,
  ...
  assign MUX_emac_rx_buffer_rRdPackets_rsCounter$write_1__VAL_1 =
	     (~emac_rx_buffer_rRdPackets_rsCounter[IF_emac_rx_buffer_rRdPackets_rsCounter_95_BIT__ETC___d1572[2:0]]) ?
  ...
  assign MUX_emac_rx_buffer_rWrPackets_rsCounter$write_1__VAL_1 =
	     (~emac_rx_buffer_rWrPackets_rsCounter[IF_emac_rx_buffer_rWrPackets_rsCounter_65_BIT__ETC___d1567[2:0]]) ?
  ...
  assign MUX_emac_tx_buffer_rRdPackets_rsCounter$write_1__VAL_1 =
	     (~emac_tx_buffer_rRdPackets_rsCounter[IF_emac_tx_buffer_rRdPackets_rsCounter_065_BIT_ETC___d1582[2:0]]) ?
  ...
  assign MUX_emac_tx_buffer_rWrPackets_rsCounter$write_1__VAL_1 =
	     (~emac_tx_buffer_rWrPackets_rsCounter[IF_emac_tx_buffer_rWrPackets_rsCounter_48_BIT__ETC___d1577[2:0]]) ?
  ...
  assign MUX_wsiM_reqFifo_q_0$write_1__VAL_1 =
	     { 3'd1,
	       IF_emac_rx_buffer_fifoDeq_rw_enq_whas__82_THEN_ETC___d1327,
	       1'd0,
  ...
  // remaining internal signals
  assign IF_emac_rx_buffer_fifoDeq_rw_enq_whas__82_THEN_ETC___d1327 =
	     WILL_FIRE_RL_emac_rx_buffer_dequeue_next_beat ?
  ...
  assign IF_emac_rx_buffer_rRdPackets_rsCounter_95_BIT__ETC___d1571 =
			   ...
			   (emac_rx_buffer_rRdPackets_rsCounter[4] ?
				 ...
				 (emac_rx_buffer_rRdPackets_rsCounter[6] ?
				    ...
				    (emac_rx_buffer_rRdPackets_rsCounter[7] ?
				       ...
				       32'd9)))))))) :
	       32'd7 ;
  assign IF_emac_rx_buffer_rRdPackets_rsCounter_95_BIT__ETC___d1572 =
	     emac_rx_buffer_rRdPackets_rsCounter_95_BIT_0_0_ETC___d1492 ?
	       IF_emac_rx_buffer_rRdPackets_rsCounter_95_BIT__ETC___d1571 :
	       32'd0 ;
  assign IF_emac_rx_buffer_rWrPackets_rsCounter_65_BIT__ETC___d1566 =
			   ...
			   (emac_rx_buffer_rWrPackets_rsCounter[4] ?
				 ...
				 (emac_rx_buffer_rWrPackets_rsCounter[6] ?
				    ...
				    (emac_rx_buffer_rWrPackets_rsCounter[7] ?
				       ...
				       32'd9)))))))) :
	       32'd7 ;
  assign IF_emac_rx_buffer_rWrPackets_rsCounter_65_BIT__ETC___d1567 =
	     emac_rx_buffer_rWrPackets_rsCounter_65_BIT_0_7_ETC___d1491 ?
	       IF_emac_rx_buffer_rWrPackets_rsCounter_65_BIT__ETC___d1566 :
	       32'd0 ;
  assign IF_emac_tx_buffer_fifoEnq_rw_enq_whas__36_THEN_ETC___d1573 =
	     MUX_wsiS_reqFifo_levelsValid$write_1__SEL_3 ?
	       emac_tx_buffer_fifoEnq_rw_enq$wget[9:8] == 2'd0 :
	       emac_tx_buffer_fifoEnq_taggedReg[10] &&
	       emac_tx_buffer_fifoEnq_taggedReg[9:8] == 2'd0 ;
  assign IF_emac_tx_buffer_fifoEnq_rw_enq_whas__36_THEN_ETC___d1574 =
	     MUX_wsiS_reqFifo_levelsValid$write_1__SEL_3 ?
	       emac_tx_buffer_fifoEnq_rw_enq$wget[9:8] == 2'd1 :
	       emac_tx_buffer_fifoEnq_taggedReg[10] &&
	       emac_tx_buffer_fifoEnq_taggedReg[9:8] == 2'd1 ;
  assign IF_emac_tx_buffer_rRdPackets_rsCounter_065_BIT_ETC___d1581 =
			   ...
			   (emac_tx_buffer_rRdPackets_rsCounter[4] ?
				 ...
				 (emac_tx_buffer_rRdPackets_rsCounter[6] ?
				    ...
				    (emac_tx_buffer_rRdPackets_rsCounter[7] ?
				       ...
				       32'd9)))))))) :
	       32'd7 ;
  assign IF_emac_tx_buffer_rRdPackets_rsCounter_065_BIT_ETC___d1582 =
	     emac_tx_buffer_rRdPackets_rsCounter_065_BIT_0__ETC___d1494 ?
	       IF_emac_tx_buffer_rRdPackets_rsCounter_065_BIT_ETC___d1581 :
	       32'd0 ;
  assign IF_emac_tx_buffer_rWrPackets_rsCounter_48_BIT__ETC___d1576 =
			   ...
			   (emac_tx_buffer_rWrPackets_rsCounter[4] ?
				 ...
				 (emac_tx_buffer_rWrPackets_rsCounter[6] ?
				    ...
				    (emac_tx_buffer_rWrPackets_rsCounter[7] ?
				       ...
				       32'd9)))))))) :
	       32'd7 ;
  assign IF_emac_tx_buffer_rWrPackets_rsCounter_48_BIT__ETC___d1577 =
	     emac_tx_buffer_rWrPackets_rsCounter_48_BIT_0_5_ETC___d1493 ?
	       IF_emac_tx_buffer_rWrPackets_rsCounter_48_BIT__ETC___d1576 :
	       32'd0 ;
  ...
  assign emac_rx_buffer_memBuffer_serverAdapterB_outDat_ETC___d827 =
	     ...
	     (emac_rx_buffer_memBuffer_serverAdapterB_outData_outData$wget[9:8] !=
	      ...
	      2'd1 ||
	      emac_rx_buffer_memBuffer_serverAdapterB_cnt_41_ETC___d803) ;
  assign emac_rx_buffer_rRdPackets_rsCounter_95_BIT_0_0_ETC___d1492 =
	     z__h23573 ^ emac_rx_buffer_rRdPackets_rsCounter[7] ;
  assign emac_rx_buffer_rWrPackets_rsCounter_65_BIT_0_7_ETC___d1491 =
  ...
  assign emac_tx_buffer_memBuffer_serverAdapterB_outDat_ETC___d1188 =
	     ...
	     (emac_tx_buffer_memBuffer_serverAdapterB_outData_outData$wget[9:8] !=
	      2'd1 ||
	      emac_tx_buffer_memBuffer_serverAdapterB_cnt_02_ETC___d1155) ;
  assign emac_tx_buffer_rRdPackets_rsCounter_065_BIT_0__ETC___d1494 =
	     z__h34510 ^ emac_tx_buffer_rRdPackets_rsCounter[7] ;
  assign emac_tx_buffer_rWrPackets_rsCounter_48_BIT_0_5_ETC___d1493 =
