...
//
// On Wed Apr  4 14:43:48 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkGbeWorker(CLK_gmii_rx_clk,
  ...
  wire [77 : 0] dcp_dcpReqF$D_IN, dcp_dcpReqF$D_OUT;
  wire dcp_dcpReqF$CLR, dcp_dcpReqF$DEQ, dcp_dcpReqF$EMPTY_N, dcp_dcpReqF$ENQ;
  ...
  reg [63 : 0] v__h3632, v__h3806, v__h3950, v__h76429, v__h76718, v__h96694;
  reg [31 : 0] IF_wci_wslv_reqF_first__5_BITS_39_TO_32_00_EQ__ETC___d1049;
  reg [7 : 0] CASE_13_MINUS_txDBGPos_87_162_255_0_65_1_240_2_ETC__q6,
	      CASE_13_MINUS_txDCPPos_68_161_txDCPHdrFD_OUT__ETC__q5,
	      CASE_rxHdr_pos_rxHdr_pV_BITS_111_TO_104_0_rxHd_ETC__q2,
	      CASE_rxHdr_pos_rxHdr_sV_BITS_111_TO_104_0_rxHd_ETC__q1;
  reg CASE_13_MINUS_txDCPPos_68_161_NOT_13_MINUS_txD_ETC__q3,
      CASE_17_MINUS_txDBGPos_87_163_NOT_17_MINUS_txD_ETC__q4,
      IF_txDBGPos_87_EQ_0_88_OR_txDBGPos_87_EQ_1_89__ETC___d839,
      IF_txDCPPos_68_EQ_0_69_OR_txDCPPos_68_EQ_1_70__ETC___d743;
  wire [101 : 0] _1448743543117976458853375091858__q7,
		 _643371375338640__q8,
		 bs__h12596,
		 bs__h25059;
  wire [31 : 0] rdat___1__h76937,
		rdat___1__h76988,
		rdat___1__h77029,
		rdat___1__h77064,
		rdat___1__h77097,
		...
		status__h76503,
		x__h69076;
  wire [15 : 0] x__h76783, x__h76941, x_data__h28257;
  wire [4 : 0] _13_MINUS_txDBGPos_87___d1162,
	       _13_MINUS_txDCPPos_68___d1161,
	       _17_MINUS_txDBGPos_87___d1163;
  wire [2 : 0] d0__h12222,
	       d10__h12212,
	       d11__h12211,
	       d12__h12210,
  ...
  wire IF_dcp_dcpReqF_first__43_BITS_77_TO_76_44_EQ_0_ETC___d454,
       ...
       gmac_RDY_tx_put__96_AND_IF_13_MINUS_txDCPPos_6_ETC___d728,
       gmac_RDY_tx_put__96_AND_IF_17_MINUS_txDBGPos_8_ETC___d833,
       gmac_rx_get_09_BITS_9_TO_8_10_EQ_0_11_OR_gmac__ETC___d603,
       rxLenCount_06_ULT_16___d607,
       wci_wslv_reqF_i_notEmpty__4_AND_IF_wci_wslv_re_ETC___d925;
  ...
  assign MUX_dcp_dcpRespF$enq_1__VAL_2 =
	     { 2'd2,
	       ...
	       2'd0 } ;
  always@(txDCPPos or CASE_13_MINUS_txDCPPos_68_161_txDCPHdrFD_OUT__ETC__q5)
  begin
    case (txDCPPos)
      5'd0,
      5'd1,
	  ...
	  MUX_gmac$tx_put_1__VAL_1 =
	      { 2'd0, CASE_13_MINUS_txDCPPos_68_161_txDCPHdrFD_OUT__ETC__q5 };
      5'd14, 5'd15, 5'd16, 5'd17, 5'd18: MUX_gmac$tx_put_1__VAL_1 = 10'd0;
      default: MUX_gmac$tx_put_1__VAL_1 = 10'd256;
    endcase
  end
  always@(txDBGPos or
	  CASE_13_MINUS_txDBGPos_87_162_255_0_65_1_240_2_ETC__q6 or
	  _17_MINUS_txDBGPos_87___d1163 or txDBGF$D_OUT)
  begin
    case (txDBGPos)
      5'd0,
      5'd1,
	  ...
	  MUX_gmac$tx_put_1__VAL_2 =
	      { 2'd0,
		CASE_13_MINUS_txDBGPos_87_162_255_0_65_1_240_2_ETC__q6 };
      5'd14, 5'd15, 5'd16, 5'd17:
	  MUX_gmac$tx_put_1__VAL_2 =
	      { 2'd0,
		(_17_MINUS_txDBGPos_87___d1163 == 5'd0) ?
		  txDBGF$D_OUT[7:0] :
		  ((_17_MINUS_txDBGPos_87___d1163 == 5'd1) ?
		     txDBGF$D_OUT[15:8] :
		     ((_17_MINUS_txDBGPos_87___d1163 == 5'd2) ?
			txDBGF$D_OUT[23:16] :
			txDBGF$D_OUT[31:24])) };
  ...
  assign MUX_wci_wslv_respF_q_1$write_1__VAL_1 =
	     (wci_wslv_respF_c_r == 2'd2) ?
	       MUX_wci_wslv_respF_q_0$write_1__VAL_2 :
	       34'h0AAAAAAAA ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_1 = { 2'd1, rdat__h76702 } ;
  ...
  assign wsiM_operateD_1$whas = wsiS_operateD_1$whas ;
  ...
  // register rxLenCount
  assign rxLenCount$D_IN = (gmac$rx_get[9:8] == 2'd0) ? x__h69076 : 32'd0 ;
  assign rxLenCount$EN = WILL_FIRE_RL_rx_data ;

  // register rxLenLast
  assign rxLenLast$D_IN = x__h69076 ;
  ...
  // register wsiM_operateD
  assign wsiM_operateD$D_IN = wsiS_operateD_1$whas ;
  ...
  // register wsiS_operateD
  assign wsiS_operateD$D_IN = wsiS_operateD_1$whas ;
  ...
  // submodule dcp_dcpReqF
  assign dcp_dcpReqF$D_IN = 78'h0 ;
  assign dcp_dcpReqF$ENQ = 1'b0 ;
  ...
  assign gmac$EN_tx_put =
	     ...
	     (txDBGPos == 5'd0 || txDBGPos == 5'd1 || txDBGPos == 5'd2 ||
	      ...
	      txDBGPos == 5'd17 ||
	      txDBGPos == 5'd18) ;
  assign gmac$EN_rxOperate = wsiS_operateD_1$whas ;
  assign gmac$EN_txOperate = wsiS_operateD_1$whas ;
  ...
  assign IF_rxHdr_pos_15_EQ_0_31_THEN_rxHdr_sV_97_BITS__ETC___d600 =
	     CASE_rxHdr_pos_rxHdr_sV_BITS_111_TO_104_0_rxHd_ETC__q1 ==
	     CASE_rxHdr_pos_rxHdr_pV_BITS_111_TO_104_0_rxHd_ETC__q2 ;
  assign _13_MINUS_txDBGPos_87___d1162 = 5'd13 - txDBGPos ;
  assign _13_MINUS_txDCPPos_68___d1161 = 5'd13 - txDCPPos ;
  assign _1448743543117976458853375091858__q7 =
	     102'h12492492492492492492492492 ;
  assign _17_MINUS_txDBGPos_87___d1163 = 5'd17 - txDBGPos ;
  ...
  assign gmac_RDY_tx_put__96_AND_IF_13_MINUS_txDCPPos_6_ETC___d728 =
	     gmac$RDY_tx_put &&
	     CASE_13_MINUS_txDCPPos_68_161_NOT_13_MINUS_txD_ETC__q3 ;
  assign gmac_RDY_tx_put__96_AND_IF_17_MINUS_txDBGPos_8_ETC___d833 =
	     gmac$RDY_tx_put &&
	     CASE_17_MINUS_txDBGPos_87_163_NOT_17_MINUS_txD_ETC__q4 ;
  ...
  assign rdat___1__h76937 = hasDebugLogic ? { 16'd0, x__h76941 } : 32'd0 ;
  assign rdat___1__h76988 =
	     hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat___1__h77029 =
	     hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat___1__h77064 =
	     hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat___1__h77097 =
	     hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat___1__h77138 =
	     hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat___1__h77173 = hasDebugLogic ? txDBGCnt : 32'd0 ;
  assign rdat___1__h77206 = hasDebugLogic ? rxCount : 32'd0 ;
  assign rdat___1__h77239 = hasDebugLogic ? txCount : 32'd0 ;
  assign rdat___1__h77272 = hasDebugLogic ? rxOvfCount : 32'd0 ;
  assign rdat___1__h77305 = hasDebugLogic ? txUndCount : 32'd0 ;
  assign rdat___1__h77338 = hasDebugLogic ? rxValidNoEOPC : 32'd0 ;
  assign rdat___1__h77371 = hasDebugLogic ? rxValidEOPC : 32'd0 ;
  assign rdat___1__h77404 = hasDebugLogic ? rxEmptyEOPC : 32'd0 ;
  assign rdat___1__h77437 = hasDebugLogic ? rxAbortEOPC : 32'd0 ;
  assign rdat___1__h77470 = hasDebugLogic ? rxDCPCnt : 32'd0 ;
  assign rdat___1__h77503 = hasDebugLogic ? rxHdrMatchCnt : 32'd0 ;
  assign rdat___1__h77536 = hasDebugLogic ? rxLenLast : 32'd0 ;
  assign rdat___1__h77570 = hasDebugLogic ? txDCPCnt : 32'd0 ;
  assign rdat___1__h77603 = hasDebugLogic ? { 28'd0, rxHdr_pos } : 32'd0 ;
  assign rdat___1__h77640 = hasDebugLogic ? { 28'd0, rxHdr_mCnt } : 32'd0 ;
  assign rdat___1__h77677 =
	     hasDebugLogic ? { 16'd0, rxHdr_sV[111:96] } : 32'd0 ;
  assign rdat___1__h80178 = hasDebugLogic ? rxHdr_sV[95:64] : 32'd0 ;
  assign rdat___1__h82676 =
	     hasDebugLogic ? { 16'd0, rxHdr_sV[63:48] } : 32'd0 ;
  assign rdat___1__h85177 = hasDebugLogic ? rxHdr_sV[47:16] : 32'd0 ;
  assign rdat___1__h87675 =
	     hasDebugLogic ? { 16'd0, rxHdr_sV[15:0] } : 32'd0 ;
  assign rdat___1__h90176 = hasDebugLogic ? rxHeadCap[127:96] : 32'd0 ;
  assign rdat___1__h91783 = hasDebugLogic ? rxHeadCap[95:64] : 32'd0 ;
  assign rdat___1__h93353 = hasDebugLogic ? rxHeadCap[63:32] : 32'd0 ;
  assign rdat___1__h94923 = hasDebugLogic ? rxHeadCap[31:0] : 32'd0 ;
  assign rdat__h76702 =
	     wci_wslv_reqF$D_OUT[39] ?
	       32'd0 :
	       IF_wci_wslv_reqF_first__5_BITS_39_TO_32_00_EQ__ETC___d1049 ;
  assign rxLenCount_06_ULT_16___d607 = rxLenCount < 32'd16 ;
  assign status__h76503 = { 16'd0, x__h76783 } ;
  assign wci_wslv_reqF_i_notEmpty__4_AND_IF_wci_wslv_re_ETC___d925 =
	     wci_wslv_reqF$EMPTY_N &&
	     (wci_wslv_reqF$D_OUT[39] ?
		mdi_fRequest$FULL_N :
		wci_wslv_respF_c_r != 2'd2) ;
  assign x__h69076 = rxLenCount + 32'd1 ;
  assign x__h76783 = { wsiM_statusR, wsiS_statusR } ;
  assign x__h76941 = { wsiS_statusR, wsiM_statusR } ;
  ...
  always@(wci_wslv_reqF$D_OUT or
	  ...
	  rdat___1__h87675 or
	  rdat___1__h90176 or
	  rdat___1__h91783 or rdat___1__h93353 or rdat___1__h94923)
  begin
    case (wci_wslv_reqF$D_OUT[39:32])
	  ...
	  IF_wci_wslv_reqF_first__5_BITS_39_TO_32_00_EQ__ETC___d1049 =
	      rdat___1__h94923;
      default: IF_wci_wslv_reqF_first__5_BITS_39_TO_32_00_EQ__ETC___d1049 =
		   32'd0;
    endcase
  end
  always@(_13_MINUS_txDCPPos_68___d1161 or txDCPHdrF$EMPTY_N)
  begin
    case (_13_MINUS_txDCPPos_68___d1161)
      5'd0,
      5'd1,
      5'd2,
      5'd3,
	  ...
	  CASE_13_MINUS_txDCPPos_68_161_NOT_13_MINUS_txD_ETC__q3 =
	      txDCPHdrF$EMPTY_N;
      default: CASE_13_MINUS_txDCPPos_68_161_NOT_13_MINUS_txD_ETC__q3 =
		   _13_MINUS_txDCPPos_68___d1161 != 5'd13 ||
		   txDCPHdrF$EMPTY_N;
    endcase
  end
  always@(txDCPPos or
  ...
  begin
    case (txDCPPos)
	  ...
	  IF_txDCPPos_68_EQ_0_69_OR_txDCPPos_68_EQ_1_70__ETC___d743 =
	      gmac$RDY_tx_put;
      default: IF_txDCPPos_68_EQ_0_69_OR_txDCPPos_68_EQ_1_70__ETC___d743 =
		   txDCPPos != 5'd19 || gmac$RDY_tx_put && txDCPHdrF$EMPTY_N;
    endcase
  end
  always@(_17_MINUS_txDBGPos_87___d1163 or txDBGF$EMPTY_N)
  begin
    case (_17_MINUS_txDBGPos_87___d1163)
      5'd0, 5'd1, 5'd2:
	  CASE_17_MINUS_txDBGPos_87_163_NOT_17_MINUS_txD_ETC__q4 =
	      txDBGF$EMPTY_N;
      default: CASE_17_MINUS_txDBGPos_87_163_NOT_17_MINUS_txD_ETC__q4 =
		   _17_MINUS_txDBGPos_87___d1163 != 5'd3 || txDBGF$EMPTY_N;
    endcase
  end
  always@(txDBGPos or
	  gmac$RDY_tx_put or
  ...
  begin
    case (txDBGPos)
	  ...
	  IF_txDBGPos_87_EQ_0_88_OR_txDBGPos_87_EQ_1_89__ETC___d839 =
	      gmac_RDY_tx_put__96_AND_IF_17_MINUS_txDBGPos_8_ETC___d833;
      default: IF_txDBGPos_87_EQ_0_88_OR_txDBGPos_87_EQ_1_89__ETC___d839 =
		   txDBGPos != 5'd18 || gmac$RDY_tx_put && txDBGF$EMPTY_N;
    endcase
  end
  always@(_13_MINUS_txDCPPos_68___d1161 or txDCPHdrF$D_OUT)
  begin
    case (_13_MINUS_txDCPPos_68___d1161)
      5'd0:
	  CASE_13_MINUS_txDCPPos_68_161_txDCPHdrFD_OUT__ETC__q5 =
      ...
      default: CASE_13_MINUS_txDCPPos_68_161_txDCPHdrFD_OUT__ETC__q5 =
		   txDCPHdrF$D_OUT[111:104];
    endcase
  end
  always@(_13_MINUS_txDBGPos_87___d1162)
  begin
    case (_13_MINUS_txDBGPos_87___d1162)
      5'd0: CASE_13_MINUS_txDBGPos_87_162_255_0_65_1_240_2_ETC__q6 = 8'd65;
      5'd1: CASE_13_MINUS_txDBGPos_87_162_255_0_65_1_240_2_ETC__q6 = 8'd240;
      5'd2: CASE_13_MINUS_txDBGPos_87_162_255_0_65_1_240_2_ETC__q6 = 8'd39;
      5'd3: CASE_13_MINUS_txDBGPos_87_162_255_0_65_1_240_2_ETC__q6 = 8'd38;
      5'd4: CASE_13_MINUS_txDBGPos_87_162_255_0_65_1_240_2_ETC__q6 = 8'd37;
      5'd5: CASE_13_MINUS_txDBGPos_87_162_255_0_65_1_240_2_ETC__q6 = 8'd36;
      5'd6: CASE_13_MINUS_txDBGPos_87_162_255_0_65_1_240_2_ETC__q6 = 8'd34;
      5'd7: CASE_13_MINUS_txDBGPos_87_162_255_0_65_1_240_2_ETC__q6 = 8'd33;
      default: CASE_13_MINUS_txDBGPos_87_162_255_0_65_1_240_2_ETC__q6 =
		   8'd255;
    endcase
  end
  ...
  begin
	...
	$display("Error: \"bsv/wrk/GbeWorker.bsv\", line 251, column 46: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_ctrl_EiI] and\n  [RL_wci_ctrl_OrE] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wci_ctrl_EiI && WILL_FIRE_RL_wci_ctrl_IsO)
	$display("Error: \"bsv/wrk/GbeWorker.bsv\", line 251, column 46: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_ctrl_EiI] and\n  [RL_wci_ctrl_IsO] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wci_ctrl_IsO && WILL_FIRE_RL_wci_ctrl_OrE)
	$display("Error: \"bsv/wrk/GbeWorker.bsv\", line 251, column 60: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_ctrl_IsO] and\n  [RL_wci_ctrl_OrE] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n)
	...
	$display("Error: \"bsv/wrk/GbeWorker.bsv\", line 251, column 36: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_cfrd] and\n  [RL_wci_ctrl_OrE] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n)
	...
	$display("Error: \"bsv/wrk/GbeWorker.bsv\", line 251, column 26: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_cfwr] and\n  [RL_wci_ctrl_OrE] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n)
