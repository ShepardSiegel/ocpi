...
//
// On Mon Jan 30 20:22:41 EST 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkGbeWorker(CLK_gmii_rx_clk,
  ...
  wire [31 : 0] IF_emac_rx_buffer_rRdPackets_rsCounter_99_BIT__ETC___d1542,
		IF_emac_rx_buffer_rWrPackets_rsCounter_69_BIT__ETC___d1335,
		IF_emac_rx_buffer_rWrPackets_rsCounter_69_BIT__ETC___d1536,
		IF_emac_tx_buffer_rRdPackets_rsCounter_069_BIT_ETC___d1554,
		IF_emac_tx_buffer_rRdPackets_rsCounter_069_BIT_ETC___d1555,
		IF_emac_tx_buffer_rWrPackets_rsCounter_52_BIT__ETC___d1547,
		IF_emac_tx_buffer_rWrPackets_rsCounter_52_BIT__ETC___d1548,
		status__h39250,
		x__h24368,
		x_data__h38672;
  wire [15 : 0] x__h39396;
  ...
  wire IF_emac_rx_buffer_fifoDeq_rw_enq_whas__86_THEN_ETC___d1334,
       IF_emac_tx_buffer_fifoEnq_rw_enq_whas__40_THEN_ETC___d1544,
       IF_emac_tx_buffer_fifoEnq_rw_enq_whas__40_THEN_ETC___d1545,
       ...
       emac_rx_buffer_rRdPackets_rsCounter_99_BIT_0_0_ETC___d1437,
       emac_rx_buffer_rWrPackets_rsCounter_69_BIT_0_7_ETC___d1436,
       ...
       emac_tx_buffer_rRdPackets_rsCounter_069_BIT_0__ETC___d1439,
       emac_tx_buffer_rWrPackets_rsCounter_52_BIT_0_5_ETC___d1438,
       z__h17152,
       z__h17159,
       z__h17166,
       z__h17173,
  ...
  assign MUX_emac_rx_buffer_rRdPackets_rsCounter$write_1__VAL_1 =
	     (~emac_rx_buffer_rRdPackets_rsCounter[x__h24368[2:0]]) ?
  ...
  assign MUX_emac_rx_buffer_rWrPackets_rsCounter$write_1__VAL_1 =
	     (~emac_rx_buffer_rWrPackets_rsCounter[IF_emac_rx_buffer_rWrPackets_rsCounter_69_BIT__ETC___d1536[2:0]]) ?
  ...
  assign MUX_emac_tx_buffer_rRdPackets_rsCounter$write_1__VAL_1 =
	     (~emac_tx_buffer_rRdPackets_rsCounter[IF_emac_tx_buffer_rRdPackets_rsCounter_069_BIT_ETC___d1555[2:0]]) ?
  ...
  assign MUX_emac_tx_buffer_rWrPackets_rsCounter$write_1__VAL_1 =
	     (~emac_tx_buffer_rWrPackets_rsCounter[IF_emac_tx_buffer_rWrPackets_rsCounter_52_BIT__ETC___d1548[2:0]]) ?
  ...
  assign IF_emac_rx_buffer_rRdPackets_rsCounter_99_BIT__ETC___d1542 =
			   ...
			   (emac_rx_buffer_rRdPackets_rsCounter[4] ?
				 ...
				 (emac_rx_buffer_rRdPackets_rsCounter[6] ?
				    ...
				    (emac_rx_buffer_rRdPackets_rsCounter[7] ?
				       ...
				       32'd9)))))))) :
	       32'd7 ;
  assign IF_emac_rx_buffer_rWrPackets_rsCounter_69_BIT__ETC___d1335 =
			   ...
			   (emac_rx_buffer_rWrPackets_rsCounter[4] ?
				 ...
				 (emac_rx_buffer_rWrPackets_rsCounter[6] ?
				    ...
				    (emac_rx_buffer_rWrPackets_rsCounter[7] ?
				       ...
				       32'd9)))))))) :
	       32'd7 ;
  assign IF_emac_rx_buffer_rWrPackets_rsCounter_69_BIT__ETC___d1536 =
	     emac_rx_buffer_rWrPackets_rsCounter_69_BIT_0_7_ETC___d1436 ?
	       IF_emac_rx_buffer_rWrPackets_rsCounter_69_BIT__ETC___d1335 :
	       32'd0 ;
  assign IF_emac_tx_buffer_fifoEnq_rw_enq_whas__40_THEN_ETC___d1544 =
	     MUX_wsiS_reqFifo_levelsValid$write_1__SEL_3 ?
	       emac_tx_buffer_fifoEnq_rw_enq$wget[9:8] == 2'd0 :
	       emac_tx_buffer_fifoEnq_taggedReg[10] &&
	       emac_tx_buffer_fifoEnq_taggedReg[9:8] == 2'd0 ;
  assign IF_emac_tx_buffer_fifoEnq_rw_enq_whas__40_THEN_ETC___d1545 =
	     MUX_wsiS_reqFifo_levelsValid$write_1__SEL_3 ?
	       emac_tx_buffer_fifoEnq_rw_enq$wget[9:8] == 2'd1 :
	       emac_tx_buffer_fifoEnq_taggedReg[10] &&
	       emac_tx_buffer_fifoEnq_taggedReg[9:8] == 2'd1 ;
  assign IF_emac_tx_buffer_rRdPackets_rsCounter_069_BIT_ETC___d1554 =
			   ...
			   (emac_tx_buffer_rRdPackets_rsCounter[4] ?
				 ...
				 (emac_tx_buffer_rRdPackets_rsCounter[6] ?
				    ...
				    (emac_tx_buffer_rRdPackets_rsCounter[7] ?
				       ...
				       32'd9)))))))) :
	       32'd7 ;
  assign IF_emac_tx_buffer_rRdPackets_rsCounter_069_BIT_ETC___d1555 =
	     emac_tx_buffer_rRdPackets_rsCounter_069_BIT_0__ETC___d1439 ?
	       IF_emac_tx_buffer_rRdPackets_rsCounter_069_BIT_ETC___d1554 :
	       32'd0 ;
  assign IF_emac_tx_buffer_rWrPackets_rsCounter_52_BIT__ETC___d1547 =
			   ...
			   (emac_tx_buffer_rWrPackets_rsCounter[4] ?
				 ...
				 (emac_tx_buffer_rWrPackets_rsCounter[6] ?
				    ...
				    (emac_tx_buffer_rWrPackets_rsCounter[7] ?
				       ...
				       32'd9)))))))) :
	       32'd7 ;
  assign IF_emac_tx_buffer_rWrPackets_rsCounter_52_BIT__ETC___d1548 =
	     emac_tx_buffer_rWrPackets_rsCounter_52_BIT_0_5_ETC___d1438 ?
	       IF_emac_tx_buffer_rWrPackets_rsCounter_52_BIT__ETC___d1547 :
	       32'd0 ;
  ...
  assign emac_rx_buffer_memBuffer_serverAdapterB_outDat_ETC___d831 =
	     ...
	     (emac_rx_buffer_memBuffer_serverAdapterB_outData_outData$wget[9:8] !=
	      ...
	      2'd1 ||
	      emac_rx_buffer_memBuffer_serverAdapterB_cnt_45_ETC___d807) ;
  assign emac_rx_buffer_rRdPackets_rsCounter_99_BIT_0_0_ETC___d1437 =
	     z__h23786 ^ emac_rx_buffer_rRdPackets_rsCounter[7] ;
  assign emac_rx_buffer_rWrPackets_rsCounter_69_BIT_0_7_ETC___d1436 =
  ...
  assign emac_tx_buffer_memBuffer_serverAdapterB_outDat_ETC___d1192 =
	     ...
	     (emac_tx_buffer_memBuffer_serverAdapterB_outData_outData$wget[9:8] !=
	      2'd1 ||
	      emac_tx_buffer_memBuffer_serverAdapterB_cnt_02_ETC___d1159) ;
  assign emac_tx_buffer_rRdPackets_rsCounter_069_BIT_0__ETC___d1439 =
	     z__h34727 ^ emac_tx_buffer_rRdPackets_rsCounter[7] ;
  assign emac_tx_buffer_rWrPackets_rsCounter_52_BIT_0_5_ETC___d1438 =
	     z__h27974 ^ emac_tx_buffer_rWrPackets_rsCounter[7] ;
  assign status__h39250 = { 16'd0, x__h39396 } ;
  assign x__h17132 =
	     8'd1 <<
	     IF_emac_rx_buffer_rWrPackets_rsCounter_69_BIT__ETC___d1536 ;
  assign x__h23731 = 8'd1 << x__h24368 ;
  assign x__h24368 =
	     emac_rx_buffer_rRdPackets_rsCounter_99_BIT_0_0_ETC___d1437 ?
	       IF_emac_rx_buffer_rRdPackets_rsCounter_99_BIT__ETC___d1542 :
	       32'd0 ;
  assign x__h27919 =
	     8'd1 <<
	     IF_emac_tx_buffer_rWrPackets_rsCounter_52_BIT__ETC___d1548 ;
