...
//
// On Mon Mar  5 12:34:49 EST 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkGbeWorker(CLK_gmii_rx_clk,
  ...
  reg [63 : 0] v__h3624, v__h3798, v__h3942, v__h39655, v__h39944, v__h43166;
  reg [31 : 0] IF_wci_wslv_reqF_first__5_BITS_39_TO_32_95_EQ__ETC___d690;
  reg [3 : 0] x_byteEn__h33481;
  reg [1 : 0] CASE_gmacrx_get_BITS_9_TO_8_3_0_gmacrx_get_B_ETC__q2,
	      CASE_loopFD_OUT_BITS_9_TO_8_3_0_loopFD_OUT_B_ETC__q1;
  wire [101 : 0] _1448743543117976458853375091858__q3,
		 _643371375338640__q4,
		 bs__h12588,
		 bs__h25051;
  wire [60 : 0] _24577_CONCAT_IF_gmac_rx_get_75_BITS_9_TO_8_76__ETC___d505;
  wire [31 : 0] rdat___1__h40163,
		rdat___1__h40214,
		rdat___1__h40255,
		rdat___1__h40290,
		rdat___1__h40323,
		...
		x__h38478,
		x_data__h32748;
  wire [15 : 0] x__h40009, x__h40167, x_data__h28249;
  wire [9 : 0] IF_daF_notEmpty__43_THEN_0_CONCAT_daF_first__5_ETC___d572;
  wire [2 : 0] d0__h12214,
	       d10__h12204,
	       d11__h12203,
	       d12__h12202,
	       ...
	       ra3__h12194,
	       ra4__h12193;
  wire IF_saF_notEmpty__39_THEN_saF_RDY_deq__40_AND_s_ETC___d551,
       ...
       wci_wslv_reqF_i_notEmpty__4_AND_IF_wci_wslv_re_ETC___d603;
  ...
  assign WILL_FIRE_RL_tx_loopback =
	     gmac$RDY_tx_put &&
	     IF_saF_notEmpty__39_THEN_saF_RDY_deq__40_AND_s_ETC___d551 &&
	     wci_wslv_cState == 3'd2 &&
	     loopF$EMPTY_N ;
  ...
  assign WILL_FIRE_RL_wsiM_reqFifo_decCtr =
	     WILL_FIRE_RL_wsiM_reqFifo_deq && !wsiM_reqFifo_x_wire$whas ;
  ...
  assign MUX_wci_wslv_respF_q_1$write_1__VAL_1 =
	     (wci_wslv_respF_c_r == 2'd2) ?
	       MUX_wci_wslv_respF_q_0$write_1__VAL_2 :
	       34'h0AAAAAAAA ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_1 = { 2'd1, rdat__h39928 } ;
  ...
  assign mdi_rMDC$D_IN =
	     _1448743543117976458853375091858__q3[mdi_rPlayIndex$Q_OUT[6:0]] ;
  assign mdi_rMDC$EN = WILL_FIRE_RL_mdi_run_frame ;

  // register mdi_rMDD
  assign mdi_rMDD$D_IN = bs__h12588[mdi_rPlayIndex$Q_OUT[6:0]] ;
  assign mdi_rMDD$EN = WILL_FIRE_RL_mdi_run_frame ;

  // register mdi_rOutEn
  assign mdi_rOutEn$D_IN = bs__h25051[mdi_rPlayIndex$Q_OUT[6:0]] ;
  ...
  assign mdi_vrReadData$EN =
	     WILL_FIRE_RL_mdi_run_frame && mdi_rPlayIndex$Q_OUT != 8'd0 &&
	     !mdi_rWrite &&
	     _643371375338640__q4[mdi_rPlayIndex$Q_OUT[6:0]] ;
  ...
  // register rxHdrLast
  assign rxHdrLast$D_IN = { rxHdrLast[119:0], gmac$rx_get[7:0] } ;
  assign rxHdrLast$EN =
	     WILL_FIRE_RL_rx_data && gmac$rx_get[9:8] == 2'd0 &&
	     rxIdx < 5'd16 ;
  ...
  // register rxLenCount
  assign rxLenCount$D_IN = (gmac$rx_get[9:8] == 2'd0) ? x__h38478 : 32'd0 ;
  assign rxLenCount$EN =
	     WILL_FIRE_RL_rx_data &&
	     (gmac$rx_get[9:8] == 2'd0 || gmac$rx_get[9:8] == 2'd1) ;

  // register rxLenLast
  assign rxLenLast$D_IN = x__h38478 ;
  ...
  // register rxPipe
  assign rxPipe$D_IN = x_data__h32748 ;
  ...
  assign gmac$tx_put =
	     saF$EMPTY_N ?
	       { 2'd0, saF$D_OUT } :
	       IF_daF_notEmpty__43_THEN_0_CONCAT_daF_first__5_ETC___d572 ;
  assign gmac$EN_rx_get = WILL_FIRE_RL_rx_data ;
  assign gmac$EN_tx_put = WILL_FIRE_RL_tx_loopback ;

  // submodule loopF
  assign loopF$D_IN =
	     { CASE_gmacrx_get_BITS_9_TO_8_3_0_gmacrx_get_B_ETC__q2,
	       gmac$rx_get[7:0] } ;
  assign loopF$ENQ =
  ...
  // submodule mdi_fResponse
  assign mdi_fResponse$D_IN = { 1'd1, x_data__h28249 } ;
  ...
  // remaining internal signals
  assign IF_daF_notEmpty__43_THEN_0_CONCAT_daF_first__5_ETC___d572 =
	     daF$EMPTY_N ?
	       { 2'd0, daF$D_OUT } :
	       { CASE_loopFD_OUT_BITS_9_TO_8_3_0_loopFD_OUT_B_ETC__q1,
		 loopF$D_OUT[7:0] } ;
  assign IF_saF_notEmpty__39_THEN_saF_RDY_deq__40_AND_s_ETC___d551 =
	     saF$EMPTY_N ?
	       saF$EMPTY_N :
  ...
  assign NOT_rxIdx_49_ULT_6_57_58_OR_NOT_gbeControl_51__ETC___d467 =
	     ...
	     (rxIdx_49_ULT_6___d457 || !rxIdx_49_ULT_12___d450 ||
	      !gbeControl[8] ||
	      saF$FULL_N) ;
  assign _1448743543117976458853375091858__q3 =
	     102'h12492492492492492492492492 ;
  assign _24577_CONCAT_IF_gmac_rx_get_75_BITS_9_TO_8_76__ETC___d505 =
	     { 17'd24577,
	       (gmac$rx_get[9:8] == 2'd1) ? x_data__h32748 : rxPipe,
	       x_byteEn__h33481,
	       8'd0 } ;
  assign _643371375338640__q4 = 102'h00000000000002492492492490 ;
  assign bs__h12588 =
  ...
  assign d0__h12214 = {3{mdi_rWriteData[0]}} ;
  assign d10__h12204 = {3{mdi_rWriteData[10]}} ;
  assign d11__h12203 = {3{mdi_rWriteData[11]}} ;
  assign d12__h12202 = {3{mdi_rWriteData[12]}} ;
  assign d13__h12201 = {3{mdi_rWriteData[13]}} ;
  assign d14__h12200 = {3{mdi_rWriteData[14]}} ;
  assign d15__h12199 = {3{mdi_rWriteData[15]}} ;
  assign d1__h12213 = {3{mdi_rWriteData[1]}} ;
  assign d2__h12212 = {3{mdi_rWriteData[2]}} ;
  assign d3__h12211 = {3{mdi_rWriteData[3]}} ;
  assign d4__h12210 = {3{mdi_rWriteData[4]}} ;
  assign d5__h12209 = {3{mdi_rWriteData[5]}} ;
  assign d6__h12208 = {3{mdi_rWriteData[6]}} ;
  assign d7__h12207 = {3{mdi_rWriteData[7]}} ;
  assign d8__h12206 = {3{mdi_rWriteData[8]}} ;
  assign d9__h12205 = {3{mdi_rWriteData[9]}} ;
  assign pa0__h12191 = {3{mdi_rPhyAddr[0]}} ;
  assign pa1__h12190 = {3{mdi_rPhyAddr[1]}} ;
  assign pa2__h12189 = {3{mdi_rPhyAddr[2]}} ;
  assign pa3__h12188 = {3{mdi_rPhyAddr[3]}} ;
  assign pa4__h12187 = {3{mdi_rPhyAddr[4]}} ;
  assign ra0__h12197 = {3{mdi_rRegAddr[0]}} ;
  assign ra1__h12196 = {3{mdi_rRegAddr[1]}} ;
  assign ra2__h12195 = {3{mdi_rRegAddr[2]}} ;
  assign ra3__h12194 = {3{mdi_rRegAddr[3]}} ;
  assign ra4__h12193 = {3{mdi_rRegAddr[4]}} ;
  assign rdat___1__h40163 = hasDebugLogic ? { 16'd0, x__h40167 } : 32'd0 ;
  assign rdat___1__h40214 =
	     hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat___1__h40255 =
	     hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat___1__h40290 =
	     hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat___1__h40323 =
	     hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat___1__h40364 =
	     hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat___1__h40399 =
	     hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat___1__h40432 = hasDebugLogic ? rxCount : 32'd0 ;
  assign rdat___1__h40465 = hasDebugLogic ? txCount : 32'd0 ;
  assign rdat___1__h40498 = hasDebugLogic ? rxOvfCount : 32'd0 ;
  assign rdat___1__h40531 = hasDebugLogic ? txUndCount : 32'd0 ;
  assign rdat___1__h40564 = hasDebugLogic ? rxValidNoEOPC : 32'd0 ;
  assign rdat___1__h40597 = hasDebugLogic ? rxValidEOPC : 32'd0 ;
  assign rdat___1__h40630 = hasDebugLogic ? rxEmptyEOPC : 32'd0 ;
  assign rdat___1__h40663 = hasDebugLogic ? rxAbortEOPC : 32'd0 ;
  assign rdat___1__h40696 = hasDebugLogic ? rxHdrLast[127:96] : 32'd0 ;
  assign rdat___1__h41285 = hasDebugLogic ? rxHdrLast[95:64] : 32'd0 ;
  assign rdat___1__h41837 = hasDebugLogic ? rxHdrLast[63:32] : 32'd0 ;
  assign rdat___1__h42389 = hasDebugLogic ? rxHdrLast[31:0] : 32'd0 ;
  assign rdat___1__h42941 = hasDebugLogic ? rxLenLast : 32'd0 ;
  assign rdat__h39928 =
	     wci_wslv_reqF$D_OUT[39] ?
	       32'd0 :
	       IF_wci_wslv_reqF_first__5_BITS_39_TO_32_95_EQ__ETC___d690 ;
  ...
  assign status__h39729 = { 16'd0, x__h40009 } ;
  assign wci_wslv_reqF_i_notEmpty__4_AND_IF_wci_wslv_re_ETC___d603 =
	     wci_wslv_reqF$EMPTY_N &&
	     (wci_wslv_reqF$D_OUT[39] ?
		mdi_fRequest$FULL_N :
		wci_wslv_respF_c_r != 2'd2) ;
  assign x__h38478 = rxLenCount + 32'd1 ;
  assign x__h40009 = { wsiM_statusR, wsiS_statusR } ;
  assign x__h40167 = { wsiS_statusR, wsiM_statusR } ;
  assign x_data__h28249 =
	     { mdi_vrReadData_15,
	       mdi_vrReadData_14,
	       mdi_vrReadData_13,
	       mdi_vrReadData_12,
	       ...
	       mdi_vrReadData_1,
	       mdi_vrReadData } ;
  assign x_data__h32748 = { rxPipe[23:0], gmac$rx_get[7:0] } ;
  always@(rxPos)
  begin
    case (rxPos)
      2'd0: x_byteEn__h33481 = 4'b0001;
      2'd1: x_byteEn__h33481 = 4'b0011;
      2'd2: x_byteEn__h33481 = 4'b0111;
      2'd3: x_byteEn__h33481 = 4'b1111;
    endcase
  end
  always@(loopF$D_OUT)
  begin
  ...
  always@(wci_wslv_reqF$D_OUT or
	  ...
	  rdat___1__h40696 or
	  rdat___1__h41285 or
	  rdat___1__h41837 or rdat___1__h42389 or rdat___1__h42941)
  begin
    case (wci_wslv_reqF$D_OUT[39:32])
	  ...
	  IF_wci_wslv_reqF_first__5_BITS_39_TO_32_95_EQ__ETC___d690 =
	      rdat___1__h42941;
      default: IF_wci_wslv_reqF_first__5_BITS_39_TO_32_95_EQ__ETC___d690 =
		   32'd0;
    endcase
  end
  always@(gmac$rx_get)
  begin
    case (gmac$rx_get[9:8])
	  ...
	  CASE_gmacrx_get_BITS_9_TO_8_3_0_gmacrx_get_B_ETC__q2 =
	      gmac$rx_get[9:8];
      2'd3: CASE_gmacrx_get_BITS_9_TO_8_3_0_gmacrx_get_B_ETC__q2 = 2'd3;
    endcase
  end
  ...
  begin
	...
	$display("Error: \"bsv/wrk/GbeWorker.bsv\", line 160, column 46: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_ctrl_EiI] and\n  [RL_wci_ctrl_OrE] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wci_ctrl_EiI && WILL_FIRE_RL_wci_ctrl_IsO)
	$display("Error: \"bsv/wrk/GbeWorker.bsv\", line 160, column 46: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_ctrl_EiI] and\n  [RL_wci_ctrl_IsO] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wci_ctrl_IsO && WILL_FIRE_RL_wci_ctrl_OrE)
	$display("Error: \"bsv/wrk/GbeWorker.bsv\", line 160, column 60: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_ctrl_IsO] and\n  [RL_wci_ctrl_OrE] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n)
	...
	$display("Error: \"bsv/wrk/GbeWorker.bsv\", line 160, column 36: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_cfrd] and\n  [RL_wci_ctrl_OrE] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n)
	...
	$display("Error: \"bsv/wrk/GbeWorker.bsv\", line 160, column 26: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_cfwr] and\n  [RL_wci_ctrl_OrE] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n)
