...
//
// On Thu Aug 12 10:40:18 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkGbeWorker(CLK_gmii_rx_clk,
  ...
  wire [31 : 0] IF_emac_rx_buffer_rRdPackets_rsCounter_21_BIT__ETC___d1528,
		IF_emac_rx_buffer_rWrPackets_rsCounter_03_BIT__ETC___d1525,
		IF_emac_tx_buffer_rRdPackets_rsCounter_74_BIT__ETC___d1534,
		IF_emac_tx_buffer_rWrPackets_rsCounter_35_BIT__ETC___d1531,
		status__h35933,
		x__h16674,
		x__h22993,
		x__h26894,
		...
		x_data__h36865;
  wire [15 : 0] x__h36082;
  wire [11 : 0] x_burstLength__h36864;
  wire [7 : 0] x__h16138,
	       x__h22457,
	       x__h26358,
	       x__h32825,
  ...
  wire [1 : 0] ab__h20116, ab__h30283;
  wire IF_emac_rx_buffer_fifoDeq_rw_enq_whas__2_THEN__ETC___d1294,
       IF_emac_tx_buffer_fifoEnq_rw_enq_whas__81_THEN_ETC___d1529,
       IF_emac_tx_buffer_fifoEnq_rw_enq_whas__81_THEN_ETC___d1530,
       ...
       emac_rx_buffer_rRdPackets_rsCounter_21_BIT_0_8_ETC___d1450,
       emac_rx_buffer_rWrPackets_rsCounter_03_BIT_0_0_ETC___d1449,
       ...
       emac_tx_buffer_rRdPackets_rsCounter_74_BIT_0_2_ETC___d1452,
       emac_tx_buffer_rWrPackets_rsCounter_35_BIT_0_3_ETC___d1451,
  ...
  assign MUX_emac_rx_buffer_rRdPackets_rsCounter$write_1__VAL_2 =
	     (~emac_rx_buffer_rRdPackets_rsCounter[x__h22993[2:0]]) ?
	       emac_rx_buffer_rRdPackets_rsCounter | x__h22457 :
	       emac_rx_buffer_rRdPackets_rsCounter & y__h23021 ;
  ...
  assign MUX_emac_rx_buffer_rWrPackets_rsCounter$write_1__VAL_2 =
	     (~emac_rx_buffer_rWrPackets_rsCounter[x__h16674[2:0]]) ?
	       emac_rx_buffer_rWrPackets_rsCounter | x__h16138 :
	       emac_rx_buffer_rWrPackets_rsCounter & y__h16702 ;
  ...
  assign MUX_emac_tx_buffer_rRdPackets_rsCounter$write_1__VAL_2 =
	     (~emac_tx_buffer_rRdPackets_rsCounter[x__h33361[2:0]]) ?
	       emac_tx_buffer_rRdPackets_rsCounter | x__h32825 :
	       emac_tx_buffer_rRdPackets_rsCounter & y__h33389 ;
  ...
  assign MUX_emac_tx_buffer_rWrPackets_rsCounter$write_1__VAL_2 =
	     (~emac_tx_buffer_rWrPackets_rsCounter[x__h26894[2:0]]) ?
	       emac_tx_buffer_rWrPackets_rsCounter | x__h26358 :
	       emac_tx_buffer_rWrPackets_rsCounter & y__h26922 ;
  ...
  assign emac_rx_buffer_memBuffer_serverAdapterB_s1_1$wget =
	     { 1'd1, !ab__h20116[1] || ab__h20116[0] } ;
  ...
  assign emac_tx_buffer_memBuffer_serverAdapterB_s1_1$wget =
	     { 1'd1, !ab__h30283[1] || ab__h30283[0] } ;
  ...
  assign IF_emac_rx_buffer_rRdPackets_rsCounter_21_BIT__ETC___d1528 =
			   ...
			   (emac_rx_buffer_rRdPackets_rsCounter[4] ?
				 ...
				 (emac_rx_buffer_rRdPackets_rsCounter[6] ?
				    ...
				    (emac_rx_buffer_rRdPackets_rsCounter[7] ?
				       ...
				       32'd9)))))))) :
	       32'd7 ;
  assign IF_emac_rx_buffer_rWrPackets_rsCounter_03_BIT__ETC___d1525 =
			   ...
			   (emac_rx_buffer_rWrPackets_rsCounter[4] ?
				 ...
				 (emac_rx_buffer_rWrPackets_rsCounter[6] ?
				    ...
				    (emac_rx_buffer_rWrPackets_rsCounter[7] ?
				       ...
				       32'd9)))))))) :
	       32'd7 ;
  assign IF_emac_tx_buffer_fifoEnq_rw_enq_whas__81_THEN_ETC___d1529 =
	     CAN_FIRE_RL_tx_data ?
	       emac_tx_buffer_fifoEnq_rw_enq$wget[9:8] == 2'd0 :
	       emac_tx_buffer_fifoEnq_taggedReg[10] &&
	       emac_tx_buffer_fifoEnq_taggedReg[9:8] == 2'd0 ;
  assign IF_emac_tx_buffer_fifoEnq_rw_enq_whas__81_THEN_ETC___d1530 =
	     CAN_FIRE_RL_tx_data ?
	       emac_tx_buffer_fifoEnq_rw_enq$wget[9:8] == 2'd1 :
	       emac_tx_buffer_fifoEnq_taggedReg[10] &&
	       emac_tx_buffer_fifoEnq_taggedReg[9:8] == 2'd1 ;
  assign IF_emac_tx_buffer_rRdPackets_rsCounter_74_BIT__ETC___d1534 =
			   ...
			   (emac_tx_buffer_rRdPackets_rsCounter[4] ?
				 ...
				 (emac_tx_buffer_rRdPackets_rsCounter[6] ?
				    ...
				    (emac_tx_buffer_rRdPackets_rsCounter[7] ?
				       ...
				       32'd9)))))))) :
	       32'd7 ;
  assign IF_emac_tx_buffer_rWrPackets_rsCounter_35_BIT__ETC___d1531 =
			   ...
			   (emac_tx_buffer_rWrPackets_rsCounter[4] ?
				 ...
				 (emac_tx_buffer_rWrPackets_rsCounter[6] ?
				    ...
				    (emac_tx_buffer_rWrPackets_rsCounter[7] ?
				       ...
				       32'd9)))))))) :
	       32'd7 ;
  assign ab__h20116 = 2'd0 ;
  assign ab__h30283 = 2'd0 ;
  ...
  assign emac_rx_buffer_memBuffer_serverAdapterB_outDat_ETC___d510 =
	     ...
	     (emac_rx_buffer_memBuffer_serverAdapterB_outData_outData$wget[9:8] !=
	      ...
	      2'd1 ||
	      emac_rx_buffer_memBuffer_serverAdapterB_cnt_06_ETC___d507) ;
  assign emac_rx_buffer_rRdPackets_rsCounter_21_BIT_0_8_ETC___d1450 =
	     z__h21923 ^ emac_rx_buffer_rRdPackets_rsCounter[7] ;
  assign emac_rx_buffer_rWrPackets_rsCounter_03_BIT_0_0_ETC___d1449 =
	     z__h15604 ^ emac_rx_buffer_rWrPackets_rsCounter[7] ;
  ...
  assign emac_tx_buffer_memBuffer_serverAdapterB_outDat_ETC___d151 =
	     ...
	     (emac_tx_buffer_memBuffer_serverAdapterB_outData_outData$wget[9:8] !=
	      2'd1 ||
	      emac_tx_buffer_memBuffer_serverAdapterB_cnt_47_ETC___d148) ;
  assign emac_tx_buffer_rRdPackets_rsCounter_74_BIT_0_2_ETC___d1452 =
	     z__h32291 ^ emac_tx_buffer_rRdPackets_rsCounter[7] ;
  assign emac_tx_buffer_rWrPackets_rsCounter_35_BIT_0_3_ETC___d1451 =
	     z__h25824 ^ emac_tx_buffer_rWrPackets_rsCounter[7] ;
  assign status__h35933 = { 16'd0, x__h36082 } ;
  assign wsiS_reqFifo_notFull__82_AND_wsiS_burstKind_62_ETC___d902 =
	     wsiS_reqFifo$FULL_N &&
	     (wsiS_burstKind == 2'd0 ||
	      (wsiS_burstKind == 2'd1 || wsiS_burstKind == 2'd2) &&
	      wsiS_wsiReq$wget[57]) ;
  assign x__h16138 = 8'd1 << x__h16674 ;
  assign x__h16674 =
	     emac_rx_buffer_rWrPackets_rsCounter_03_BIT_0_0_ETC___d1449 ?
	       IF_emac_rx_buffer_rWrPackets_rsCounter_03_BIT__ETC___d1525 :
	       32'd0 ;
  assign x__h22457 = 8'd1 << x__h22993 ;
  assign x__h22993 =
	     emac_rx_buffer_rRdPackets_rsCounter_21_BIT_0_8_ETC___d1450 ?
	       IF_emac_rx_buffer_rRdPackets_rsCounter_21_BIT__ETC___d1528 :
	       32'd0 ;
  assign x__h26358 = 8'd1 << x__h26894 ;
  assign x__h26894 =
	     emac_tx_buffer_rWrPackets_rsCounter_35_BIT_0_3_ETC___d1451 ?
	       IF_emac_tx_buffer_rWrPackets_rsCounter_35_BIT__ETC___d1531 :
	       32'd0 ;
  assign x__h32825 = 8'd1 << x__h33361 ;
  assign x__h33361 =
	     emac_tx_buffer_rRdPackets_rsCounter_74_BIT_0_2_ETC___d1452 ?
	       IF_emac_tx_buffer_rRdPackets_rsCounter_74_BIT__ETC___d1534 :
	       32'd0 ;
  assign x__h36082 = { wsiM_statusR, wsiS_statusR } ;
  assign x__h36929 =
	     CAN_FIRE_RL_emac_rx_buffer_dequeue_next_beat ?
	       emac_rx_buffer_fifoDeq_rw_enq$wget[7:0] :
	       emac_rx_buffer_fifoDeq_taggedReg[7:0] ;
  assign x_burstLength__h36864 =
	     IF_emac_rx_buffer_fifoDeq_rw_enq_whas__2_THEN__ETC___d1294 ?
	       12'd1 :
	       12'd4095 ;
  assign x_data__h36865 = { 24'd0, x__h36929 } ;
  assign y__h16702 = ~x__h16138 ;
  assign y__h23021 = ~x__h22457 ;
  assign y__h26922 = ~x__h26358 ;
  assign y__h33389 = ~x__h32825 ;
  assign z__h15569 =
	     emac_rx_buffer_rWrPackets_rsCounter[0] ^
	     emac_rx_buffer_rWrPackets_rsCounter[1] ;
  assign z__h15576 = z__h15569 ^ emac_rx_buffer_rWrPackets_rsCounter[2] ;
  assign z__h15583 = z__h15576 ^ emac_rx_buffer_rWrPackets_rsCounter[3] ;
  assign z__h15590 = z__h15583 ^ emac_rx_buffer_rWrPackets_rsCounter[4] ;
  assign z__h15597 = z__h15590 ^ emac_rx_buffer_rWrPackets_rsCounter[5] ;
  assign z__h15604 = z__h15597 ^ emac_rx_buffer_rWrPackets_rsCounter[6] ;
  assign z__h21888 =
	     emac_rx_buffer_rRdPackets_rsCounter[0] ^
	     emac_rx_buffer_rRdPackets_rsCounter[1] ;
  assign z__h21895 = z__h21888 ^ emac_rx_buffer_rRdPackets_rsCounter[2] ;
  assign z__h21902 = z__h21895 ^ emac_rx_buffer_rRdPackets_rsCounter[3] ;
  assign z__h21909 = z__h21902 ^ emac_rx_buffer_rRdPackets_rsCounter[4] ;
  assign z__h21916 = z__h21909 ^ emac_rx_buffer_rRdPackets_rsCounter[5] ;
  assign z__h21923 = z__h21916 ^ emac_rx_buffer_rRdPackets_rsCounter[6] ;
  assign z__h25789 =
	     emac_tx_buffer_rWrPackets_rsCounter[0] ^
	     emac_tx_buffer_rWrPackets_rsCounter[1] ;
  assign z__h25796 = z__h25789 ^ emac_tx_buffer_rWrPackets_rsCounter[2] ;
  assign z__h25803 = z__h25796 ^ emac_tx_buffer_rWrPackets_rsCounter[3] ;
  assign z__h25810 = z__h25803 ^ emac_tx_buffer_rWrPackets_rsCounter[4] ;
  assign z__h25817 = z__h25810 ^ emac_tx_buffer_rWrPackets_rsCounter[5] ;
  assign z__h25824 = z__h25817 ^ emac_tx_buffer_rWrPackets_rsCounter[6] ;
  assign z__h32256 =
	     emac_tx_buffer_rRdPackets_rsCounter[0] ^
	     emac_tx_buffer_rRdPackets_rsCounter[1] ;
  assign z__h32263 = z__h32256 ^ emac_tx_buffer_rRdPackets_rsCounter[2] ;
  assign z__h32270 = z__h32263 ^ emac_tx_buffer_rRdPackets_rsCounter[3] ;
  assign z__h32277 = z__h32270 ^ emac_tx_buffer_rRdPackets_rsCounter[4] ;
  assign z__h32284 = z__h32277 ^ emac_tx_buffer_rRdPackets_rsCounter[5] ;
  assign z__h32291 = z__h32284 ^ emac_tx_buffer_rRdPackets_rsCounter[6] ;
  ...
  begin
    case (wciRx_reqF$D_OUT[39:32])
      8'h0: _theResult____h36007 = status__h35933;
      8'h04: _theResult____h36007 = gbeControl;
      8'h10: _theResult____h36007 = wsiM_extStatusW$wget[95:64];
      8'h14: _theResult____h36007 = wsiM_extStatusW$wget[63:32];
      8'h18: _theResult____h36007 = wsiS_extStatusW$wget[95:64];
      8'h1C: _theResult____h36007 = wsiS_extStatusW$wget[63:32];
      default: _theResult____h36007 = 32'd0;
    endcase
  end
