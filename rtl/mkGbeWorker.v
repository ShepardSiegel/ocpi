...
//
// On Sat Jun 25 15:43:30 EDT 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkGbeWorker(CLK_gmii_rx_clk,
  ...
  wire [31 : 0] IF_emac_rx_buffer_rRdPackets_rsCounter_02_BIT__ETC___d1581,
		IF_emac_rx_buffer_rRdPackets_rsCounter_02_BIT__ETC___d1582,
		IF_emac_rx_buffer_rWrPackets_rsCounter_72_BIT__ETC___d1576,
		IF_emac_rx_buffer_rWrPackets_rsCounter_72_BIT__ETC___d1577,
		IF_emac_tx_buffer_rRdPackets_rsCounter_072_BIT_ETC___d1591,
		IF_emac_tx_buffer_rRdPackets_rsCounter_072_BIT_ETC___d1592,
		IF_emac_tx_buffer_rWrPackets_rsCounter_55_BIT__ETC___d1586,
		IF_emac_tx_buffer_rWrPackets_rsCounter_55_BIT__ETC___d1587,
		status__h39036,
		x_data__h38458;
  wire [15 : 0] x__h39182;
  ...
  wire IF_emac_rx_buffer_fifoDeq_rw_enq_whas__89_THEN_ETC___d1333,
       IF_emac_tx_buffer_fifoEnq_rw_enq_whas__43_THEN_ETC___d1583,
       IF_emac_tx_buffer_fifoEnq_rw_enq_whas__43_THEN_ETC___d1584,
       ...
       emac_rx_buffer_rRdPackets_rsCounter_02_BIT_0_0_ETC___d1502,
       emac_rx_buffer_rWrPackets_rsCounter_72_BIT_0_7_ETC___d1501,
       ...
       emac_tx_buffer_rRdPackets_rsCounter_072_BIT_0__ETC___d1504,
       emac_tx_buffer_rWrPackets_rsCounter_55_BIT_0_6_ETC___d1503,
  ...
  assign MUX_emac_rx_buffer_rRdPackets_rsCounter$write_1__VAL_1 =
	     (~emac_rx_buffer_rRdPackets_rsCounter[IF_emac_rx_buffer_rRdPackets_rsCounter_02_BIT__ETC___d1582[2:0]]) ?
  ...
  assign MUX_emac_rx_buffer_rWrPackets_rsCounter$write_1__VAL_1 =
	     (~emac_rx_buffer_rWrPackets_rsCounter[IF_emac_rx_buffer_rWrPackets_rsCounter_72_BIT__ETC___d1577[2:0]]) ?
  ...
  assign MUX_emac_tx_buffer_rRdPackets_rsCounter$write_1__VAL_1 =
	     (~emac_tx_buffer_rRdPackets_rsCounter[IF_emac_tx_buffer_rRdPackets_rsCounter_072_BIT_ETC___d1592[2:0]]) ?
  ...
  assign MUX_emac_tx_buffer_rWrPackets_rsCounter$write_1__VAL_1 =
	     (~emac_tx_buffer_rWrPackets_rsCounter[IF_emac_tx_buffer_rWrPackets_rsCounter_55_BIT__ETC___d1587[2:0]]) ?
  ...
  assign MUX_wsiM_reqFifo_q_0$write_1__VAL_1 =
	     { 3'd1,
	       IF_emac_rx_buffer_fifoDeq_rw_enq_whas__89_THEN_ETC___d1333,
	       1'd0,
  ...
  // remaining internal signals
  assign IF_emac_rx_buffer_fifoDeq_rw_enq_whas__89_THEN_ETC___d1333 =
	     WILL_FIRE_RL_emac_rx_buffer_dequeue_next_beat ?
  ...
  assign IF_emac_rx_buffer_rRdPackets_rsCounter_02_BIT__ETC___d1581 =
			   ...
			   (emac_rx_buffer_rRdPackets_rsCounter[4] ?
				 ...
				 (emac_rx_buffer_rRdPackets_rsCounter[6] ?
				    ...
				    (emac_rx_buffer_rRdPackets_rsCounter[7] ?
				       ...
				       32'd9)))))))) :
	       32'd7 ;
  assign IF_emac_rx_buffer_rRdPackets_rsCounter_02_BIT__ETC___d1582 =
	     emac_rx_buffer_rRdPackets_rsCounter_02_BIT_0_0_ETC___d1502 ?
	       IF_emac_rx_buffer_rRdPackets_rsCounter_02_BIT__ETC___d1581 :
	       32'd0 ;
  assign IF_emac_rx_buffer_rWrPackets_rsCounter_72_BIT__ETC___d1576 =
			   ...
			   (emac_rx_buffer_rWrPackets_rsCounter[4] ?
				 ...
				 (emac_rx_buffer_rWrPackets_rsCounter[6] ?
				    ...
				    (emac_rx_buffer_rWrPackets_rsCounter[7] ?
				       ...
				       32'd9)))))))) :
	       32'd7 ;
  assign IF_emac_rx_buffer_rWrPackets_rsCounter_72_BIT__ETC___d1577 =
	     emac_rx_buffer_rWrPackets_rsCounter_72_BIT_0_7_ETC___d1501 ?
	       IF_emac_rx_buffer_rWrPackets_rsCounter_72_BIT__ETC___d1576 :
	       32'd0 ;
  assign IF_emac_tx_buffer_fifoEnq_rw_enq_whas__43_THEN_ETC___d1583 =
	     MUX_wsiS_reqFifo_levelsValid$write_1__SEL_2 ?
	       emac_tx_buffer_fifoEnq_rw_enq$wget[9:8] == 2'd0 :
	       emac_tx_buffer_fifoEnq_taggedReg[10] &&
	       emac_tx_buffer_fifoEnq_taggedReg[9:8] == 2'd0 ;
  assign IF_emac_tx_buffer_fifoEnq_rw_enq_whas__43_THEN_ETC___d1584 =
	     MUX_wsiS_reqFifo_levelsValid$write_1__SEL_2 ?
	       emac_tx_buffer_fifoEnq_rw_enq$wget[9:8] == 2'd1 :
	       emac_tx_buffer_fifoEnq_taggedReg[10] &&
	       emac_tx_buffer_fifoEnq_taggedReg[9:8] == 2'd1 ;
  assign IF_emac_tx_buffer_rRdPackets_rsCounter_072_BIT_ETC___d1591 =
			   ...
			   (emac_tx_buffer_rRdPackets_rsCounter[4] ?
				 ...
				 (emac_tx_buffer_rRdPackets_rsCounter[6] ?
				    ...
				    (emac_tx_buffer_rRdPackets_rsCounter[7] ?
				       ...
				       32'd9)))))))) :
	       32'd7 ;
  assign IF_emac_tx_buffer_rRdPackets_rsCounter_072_BIT_ETC___d1592 =
	     emac_tx_buffer_rRdPackets_rsCounter_072_BIT_0__ETC___d1504 ?
	       IF_emac_tx_buffer_rRdPackets_rsCounter_072_BIT_ETC___d1591 :
	       32'd0 ;
  assign IF_emac_tx_buffer_rWrPackets_rsCounter_55_BIT__ETC___d1586 =
			   ...
			   (emac_tx_buffer_rWrPackets_rsCounter[4] ?
				 ...
				 (emac_tx_buffer_rWrPackets_rsCounter[6] ?
				    ...
				    (emac_tx_buffer_rWrPackets_rsCounter[7] ?
				       ...
				       32'd9)))))))) :
	       32'd7 ;
  assign IF_emac_tx_buffer_rWrPackets_rsCounter_55_BIT__ETC___d1587 =
	     emac_tx_buffer_rWrPackets_rsCounter_55_BIT_0_6_ETC___d1503 ?
	       IF_emac_tx_buffer_rWrPackets_rsCounter_55_BIT__ETC___d1586 :
	       32'd0 ;
  ...
  assign emac_rx_buffer_memBuffer_serverAdapterB_outDat_ETC___d834 =
	     ...
	     (emac_rx_buffer_memBuffer_serverAdapterB_outData_outData$wget[9:8] !=
	      ...
	      2'd1 ||
	      emac_rx_buffer_memBuffer_serverAdapterB_cnt_48_ETC___d810) ;
  assign emac_rx_buffer_rRdPackets_rsCounter_02_BIT_0_0_ETC___d1502 =
	     z__h23580 ^ emac_rx_buffer_rRdPackets_rsCounter[7] ;
  assign emac_rx_buffer_rWrPackets_rsCounter_72_BIT_0_7_ETC___d1501 =
  ...
  assign emac_tx_buffer_memBuffer_serverAdapterB_outDat_ETC___d1195 =
	     ...
	     (emac_tx_buffer_memBuffer_serverAdapterB_outData_outData$wget[9:8] !=
	      2'd1 ||
	      emac_tx_buffer_memBuffer_serverAdapterB_cnt_03_ETC___d1162) ;
  assign emac_tx_buffer_rRdPackets_rsCounter_072_BIT_0__ETC___d1504 =
	     z__h34513 ^ emac_tx_buffer_rRdPackets_rsCounter[7] ;
  assign emac_tx_buffer_rWrPackets_rsCounter_55_BIT_0_6_ETC___d1503 =
