...
//
// On Thu Mar 29 16:41:29 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkGbeWorker(CLK_gmii_rx_clk,
  ...
  reg [63 : 0] v__h3626, v__h3800, v__h3944, v__h72909, v__h73198, v__h93174;
  reg [31 : 0] IF_wci_wslv_reqF_first__5_BITS_39_TO_32_52_EQ__ETC___d886;
  reg [7 : 0] CASE_13_MINUS_txDCPPos_19_78_txDCPHdrFD_OUT_B_ETC__q4,
	      CASE_rxHdr_pos_rxHdr_pV_BITS_111_TO_104_0_rxHd_ETC__q2,
	      CASE_rxHdr_pos_rxHdr_sV_BITS_111_TO_104_0_rxHd_ETC__q1;
  reg CASE_13_MINUS_txDCPPos_19_78_NOT_13_MINUS_txDC_ETC__q3,
      IF_txDCPPos_19_EQ_0_20_OR_txDCPPos_19_EQ_1_21__ETC___d694;
  wire [101 : 0] _1448743543117976458853375091858__q5,
		 _643371375338640__q6,
		 bs__h12590,
		 bs__h25053;
  wire [31 : 0] rdat___1__h73417,
		rdat___1__h73468,
		rdat___1__h73509,
		rdat___1__h73544,
		rdat___1__h73577,
		...
		status__h72983,
		x__h67819;
  wire [15 : 0] x__h73263, x__h73421, x_data__h28251;
  wire [4 : 0] _13_MINUS_txDCPPos_19___d978;
  wire [2 : 0] d0__h12216,
	       d10__h12206,
	       d11__h12205,
	       d12__h12204,
  ...
  wire IF_rxHdr_pos_67_EQ_0_83_THEN_rxHdr_sV_49_BITS__ETC___d552,
       ...
       wci_wslv_reqF_i_notEmpty__4_AND_IF_wci_wslv_re_ETC___d760;
  ...
  assign MUX_wci_wslv_respF_q_1$write_1__VAL_2 =
	     (wci_wslv_respF_c_r == 2'd2) ?
	       MUX_wci_wslv_respF_q_0$write_1__VAL_1 :
	       34'h0AAAAAAAA ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_1 = { 2'd1, rdat__h73182 } ;
  ...
  assign mdi_rMDC$D_IN =
	     _1448743543117976458853375091858__q5[mdi_rPlayIndex$Q_OUT[6:0]] ;
  assign mdi_rMDC$EN = WILL_FIRE_RL_mdi_run_frame ;

  // register mdi_rMDD
  assign mdi_rMDD$D_IN = bs__h12590[mdi_rPlayIndex$Q_OUT[6:0]] ;
  assign mdi_rMDD$EN = WILL_FIRE_RL_mdi_run_frame ;

  // register mdi_rOutEn
  assign mdi_rOutEn$D_IN = bs__h25053[mdi_rPlayIndex$Q_OUT[6:0]] ;
  ...
  assign mdi_vrReadData$EN =
	     WILL_FIRE_RL_mdi_run_frame && mdi_rPlayIndex$Q_OUT != 8'd0 &&
	     !mdi_rWrite &&
	     _643371375338640__q6[mdi_rPlayIndex$Q_OUT[6:0]] ;
  ...
  // register rxLenCount
  assign rxLenCount$D_IN = (gmac$rx_get[9:8] == 2'd0) ? x__h67819 : 32'd0 ;
  assign rxLenCount$EN = WILL_FIRE_RL_rx_data ;

  // register rxLenLast
  assign rxLenLast$D_IN = x__h67819 ;
  ...
  always@(txDCPPos or CASE_13_MINUS_txDCPPos_19_78_txDCPHdrFD_OUT_B_ETC__q4)
  begin
    case (txDCPPos)
      5'd0,
      5'd1,
      ...
      5'd13:
	  gmac$tx_put =
	      { 2'd0, CASE_13_MINUS_txDCPPos_19_78_txDCPHdrFD_OUT_B_ETC__q4 };
      5'd14, 5'd15, 5'd16, 5'd17, 5'd18: gmac$tx_put = 10'd0;
      default: gmac$tx_put = 10'd256;
    endcase
  end
  ...
  // submodule mdi_fResponse
  assign mdi_fResponse$D_IN = { 1'd1, x_data__h28251 } ;
  ...
  assign IF_rxHdr_pos_67_EQ_0_83_THEN_rxHdr_sV_49_BITS__ETC___d552 =
	     CASE_rxHdr_pos_rxHdr_sV_BITS_111_TO_104_0_rxHd_ETC__q1 ==
	     CASE_rxHdr_pos_rxHdr_pV_BITS_111_TO_104_0_rxHd_ETC__q2 ;
  assign _13_MINUS_txDCPPos_19___d978 = 5'd13 - txDCPPos ;
  assign _1448743543117976458853375091858__q5 =
	     102'h12492492492492492492492492 ;
  assign _643371375338640__q6 = 102'h00000000000002492492492490 ;
  assign bs__h12590 =
  ...
  assign d0__h12216 = {3{mdi_rWriteData[0]}} ;
  assign d10__h12206 = {3{mdi_rWriteData[10]}} ;
  assign d11__h12205 = {3{mdi_rWriteData[11]}} ;
  assign d12__h12204 = {3{mdi_rWriteData[12]}} ;
  assign d13__h12203 = {3{mdi_rWriteData[13]}} ;
  assign d14__h12202 = {3{mdi_rWriteData[14]}} ;
  assign d15__h12201 = {3{mdi_rWriteData[15]}} ;
  assign d1__h12215 = {3{mdi_rWriteData[1]}} ;
  assign d2__h12214 = {3{mdi_rWriteData[2]}} ;
  assign d3__h12213 = {3{mdi_rWriteData[3]}} ;
  assign d4__h12212 = {3{mdi_rWriteData[4]}} ;
  assign d5__h12211 = {3{mdi_rWriteData[5]}} ;
  assign d6__h12210 = {3{mdi_rWriteData[6]}} ;
  assign d7__h12209 = {3{mdi_rWriteData[7]}} ;
  assign d8__h12208 = {3{mdi_rWriteData[8]}} ;
  assign d9__h12207 = {3{mdi_rWriteData[9]}} ;
  assign gmac_RDY_tx_put__47_AND_IF_13_MINUS_txDCPPos_1_ETC___d679 =
	     gmac$RDY_tx_put &&
	     CASE_13_MINUS_txDCPPos_19_78_NOT_13_MINUS_txDC_ETC__q3 ;
  ...
  assign pa0__h12193 = {3{mdi_rPhyAddr[0]}} ;
  assign pa1__h12192 = {3{mdi_rPhyAddr[1]}} ;
  assign pa2__h12191 = {3{mdi_rPhyAddr[2]}} ;
  assign pa3__h12190 = {3{mdi_rPhyAddr[3]}} ;
  assign pa4__h12189 = {3{mdi_rPhyAddr[4]}} ;
  assign ra0__h12199 = {3{mdi_rRegAddr[0]}} ;
  assign ra1__h12198 = {3{mdi_rRegAddr[1]}} ;
  assign ra2__h12197 = {3{mdi_rRegAddr[2]}} ;
  assign ra3__h12196 = {3{mdi_rRegAddr[3]}} ;
  assign ra4__h12195 = {3{mdi_rRegAddr[4]}} ;
  assign rdat___1__h73417 = hasDebugLogic ? { 16'd0, x__h73421 } : 32'd0 ;
  assign rdat___1__h73468 =
	     hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat___1__h73509 =
	     hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat___1__h73544 =
	     hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat___1__h73577 =
	     hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat___1__h73618 =
	     hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat___1__h73653 =
	     hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat___1__h73686 = hasDebugLogic ? rxCount : 32'd0 ;
  assign rdat___1__h73719 = hasDebugLogic ? txCount : 32'd0 ;
  assign rdat___1__h73752 = hasDebugLogic ? rxOvfCount : 32'd0 ;
  assign rdat___1__h73785 = hasDebugLogic ? txUndCount : 32'd0 ;
  assign rdat___1__h73818 = hasDebugLogic ? rxValidNoEOPC : 32'd0 ;
  assign rdat___1__h73851 = hasDebugLogic ? rxValidEOPC : 32'd0 ;
  assign rdat___1__h73884 = hasDebugLogic ? rxEmptyEOPC : 32'd0 ;
  assign rdat___1__h73917 = hasDebugLogic ? rxAbortEOPC : 32'd0 ;
  assign rdat___1__h73950 = hasDebugLogic ? rxDCPCnt : 32'd0 ;
  assign rdat___1__h73983 = hasDebugLogic ? rxHdrMatchCnt : 32'd0 ;
  assign rdat___1__h74016 = hasDebugLogic ? rxLenLast : 32'd0 ;
  assign rdat___1__h74050 = hasDebugLogic ? txDCPCnt : 32'd0 ;
  assign rdat___1__h74083 = hasDebugLogic ? { 28'd0, rxHdr_pos } : 32'd0 ;
  assign rdat___1__h74120 = hasDebugLogic ? { 28'd0, rxHdr_mCnt } : 32'd0 ;
  assign rdat___1__h74157 =
	     hasDebugLogic ? { 16'd0, rxHdr_sV[111:96] } : 32'd0 ;
  assign rdat___1__h76658 = hasDebugLogic ? rxHdr_sV[95:64] : 32'd0 ;
  assign rdat___1__h79156 =
	     hasDebugLogic ? { 16'd0, rxHdr_sV[63:48] } : 32'd0 ;
  assign rdat___1__h81657 = hasDebugLogic ? rxHdr_sV[47:16] : 32'd0 ;
  assign rdat___1__h84155 =
	     hasDebugLogic ? { 16'd0, rxHdr_sV[15:0] } : 32'd0 ;
  assign rdat___1__h86656 = hasDebugLogic ? rxHeadCap[127:96] : 32'd0 ;
  assign rdat___1__h88263 = hasDebugLogic ? rxHeadCap[95:64] : 32'd0 ;
  assign rdat___1__h89833 = hasDebugLogic ? rxHeadCap[63:32] : 32'd0 ;
  assign rdat___1__h91403 = hasDebugLogic ? rxHeadCap[31:0] : 32'd0 ;
  assign rdat__h73182 =
	     wci_wslv_reqF$D_OUT[39] ?
	       32'd0 :
	       IF_wci_wslv_reqF_first__5_BITS_39_TO_32_52_EQ__ETC___d886 ;
  assign rxLenCount_58_ULT_16___d559 = rxLenCount < 32'd16 ;
  assign status__h72983 = { 16'd0, x__h73263 } ;
  assign wci_wslv_reqF_i_notEmpty__4_AND_IF_wci_wslv_re_ETC___d760 =
	     wci_wslv_reqF$EMPTY_N &&
	     (wci_wslv_reqF$D_OUT[39] ?
		mdi_fRequest$FULL_N :
		wci_wslv_respF_c_r != 2'd2) ;
  assign x__h67819 = rxLenCount + 32'd1 ;
  assign x__h73263 = { wsiM_statusR, wsiS_statusR } ;
  assign x__h73421 = { wsiS_statusR, wsiM_statusR } ;
  assign x_data__h28251 =
	     { mdi_vrReadData_15,
	       mdi_vrReadData_14,
	       mdi_vrReadData_13,
	       mdi_vrReadData_12,
  ...
  always@(_13_MINUS_txDCPPos_19___d978 or txDCPHdrF$EMPTY_N)
  begin
    case (_13_MINUS_txDCPPos_19___d978)
      5'd0,
      5'd1,
      5'd2,
      5'd3,
	  ...
	  CASE_13_MINUS_txDCPPos_19_78_NOT_13_MINUS_txDC_ETC__q3 =
	      txDCPHdrF$EMPTY_N;
      default: CASE_13_MINUS_txDCPPos_19_78_NOT_13_MINUS_txDC_ETC__q3 =
		   _13_MINUS_txDCPPos_19___d978 != 5'd13 || txDCPHdrF$EMPTY_N;
    endcase
  end
  always@(txDCPPos or
	  gmac$RDY_tx_put or
  ...
  always@(wci_wslv_reqF$D_OUT or
	  ...
	  rdat___1__h84155 or
	  rdat___1__h86656 or
	  rdat___1__h88263 or rdat___1__h89833 or rdat___1__h91403)
  begin
    case (wci_wslv_reqF$D_OUT[39:32])
	  ...
	  IF_wci_wslv_reqF_first__5_BITS_39_TO_32_52_EQ__ETC___d886 =
	      rdat___1__h91403;
      default: IF_wci_wslv_reqF_first__5_BITS_39_TO_32_52_EQ__ETC___d886 =
		   32'd0;
    endcase
  end
  always@(_13_MINUS_txDCPPos_19___d978 or txDCPHdrF$D_OUT)
  begin
    case (_13_MINUS_txDCPPos_19___d978)
      5'd0:
	  CASE_13_MINUS_txDCPPos_19_78_txDCPHdrFD_OUT_B_ETC__q4 =
	      txDCPHdrF$D_OUT[7:0];
      5'd1:
	  CASE_13_MINUS_txDCPPos_19_78_txDCPHdrFD_OUT_B_ETC__q4 =
      ...
      default: CASE_13_MINUS_txDCPPos_19_78_txDCPHdrFD_OUT_B_ETC__q4 =
  ...
  begin
	...
	$display("Error: \"bsv/wrk/GbeWorker.bsv\", line 205, column 60: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_ctrl_IsO] and\n  [RL_wci_ctrl_OrE] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n)
	...
	$display("Error: \"bsv/wrk/GbeWorker.bsv\", line 205, column 26: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_cfwr] and\n  [RL_wci_ctrl_OrE] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n)
	...
	$display("Error: \"bsv/wrk/GbeWorker.bsv\", line 205, column 36: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_cfrd] and\n  [RL_wci_ctrl_OrE] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wci_cfrd && WILL_FIRE_RL_wci_ctrl_IsO)
	$display("Error: \"bsv/wrk/GbeWorker.bsv\", line 205, column 36: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_cfrd] and\n  [RL_wci_ctrl_IsO] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wci_ctrl_EiI && WILL_FIRE_RL_wci_ctrl_OrE)
	$display("Error: \"bsv/wrk/GbeWorker.bsv\", line 205, column 46: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_ctrl_EiI] and\n  [RL_wci_ctrl_OrE] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n)
