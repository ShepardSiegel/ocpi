...
//
// On Wed Nov 10 09:52:04 EST 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkGbeWorker(CLK_gmii_rx_clk,
  ...
  wire [31 : 0] IF_emac_rx_buffer_rRdPackets_rsCounter_65_BIT__ETC___d1526,
		IF_emac_rx_buffer_rWrPackets_rsCounter_35_BIT__ETC___d1519,
		IF_emac_rx_buffer_rWrPackets_rsCounter_35_BIT__ETC___d1520,
		IF_emac_tx_buffer_rRdPackets_rsCounter_035_BIT_ETC___d1538,
		IF_emac_tx_buffer_rRdPackets_rsCounter_035_BIT_ETC___d1539,
		IF_emac_tx_buffer_rWrPackets_rsCounter_18_BIT__ETC___d1531,
		IF_emac_tx_buffer_rWrPackets_rsCounter_18_BIT__ETC___d1532,
		status__h37750,
		x__h22910,
		x_data__h37164;
  wire [15 : 0] x__h37896;
  wire [11 : 0] x_burstLength__h37163;
  wire [7 : 0] x__h15700,
	       x__h22275,
	       x__h26439,
	       x__h33168,
  ...
  wire [1 : 0] ab__h20421, ab__h31112;
  wire IF_emac_rx_buffer_fifoDeq_rw_enq_whas__52_THEN_ETC___d1295,
       IF_emac_tx_buffer_fifoEnq_rw_enq_whas__06_THEN_ETC___d1528,
       IF_emac_tx_buffer_fifoEnq_rw_enq_whas__06_THEN_ETC___d1529,
       ...
       emac_rx_buffer_rRdPackets_rsCounter_65_BIT_0_7_ETC___d1457,
       emac_rx_buffer_rWrPackets_rsCounter_35_BIT_0_4_ETC___d1456,
       ...
       emac_tx_buffer_rRdPackets_rsCounter_035_BIT_0__ETC___d1459,
       emac_tx_buffer_rWrPackets_rsCounter_18_BIT_0_2_ETC___d1458,
  ...
  assign MUX_emac_rx_buffer_rRdPackets_rsCounter$write_1__VAL_1 =
	     (~emac_rx_buffer_rRdPackets_rsCounter[x__h22910[2:0]]) ?
	       emac_rx_buffer_rRdPackets_rsCounter | x__h22275 :
	       emac_rx_buffer_rRdPackets_rsCounter & y__h22938 ;
  ...
  assign MUX_emac_rx_buffer_rWrPackets_rsCounter$write_1__VAL_1 =
	     (~emac_rx_buffer_rWrPackets_rsCounter[IF_emac_rx_buffer_rWrPackets_rsCounter_35_BIT__ETC___d1520[2:0]]) ?
	       emac_rx_buffer_rWrPackets_rsCounter | x__h15700 :
	       emac_rx_buffer_rWrPackets_rsCounter & y__h16363 ;
  ...
  assign MUX_emac_tx_buffer_rRdPackets_rsCounter$write_1__VAL_1 =
	     (~emac_tx_buffer_rRdPackets_rsCounter[IF_emac_tx_buffer_rRdPackets_rsCounter_035_BIT_ETC___d1539[2:0]]) ?
	       emac_tx_buffer_rRdPackets_rsCounter | x__h33168 :
	       emac_tx_buffer_rRdPackets_rsCounter & y__h33831 ;
  ...
  assign MUX_emac_tx_buffer_rWrPackets_rsCounter$write_1__VAL_1 =
	     (~emac_tx_buffer_rWrPackets_rsCounter[IF_emac_tx_buffer_rWrPackets_rsCounter_18_BIT__ETC___d1532[2:0]]) ?
	       emac_tx_buffer_rWrPackets_rsCounter | x__h26439 :
	       emac_tx_buffer_rWrPackets_rsCounter & y__h27102 ;
  ...
  assign emac_rx_buffer_memBuffer_serverAdapterB_s1_1$wget =
	     { 1'd1, !ab__h20421[1] || ab__h20421[0] } ;
  ...
  assign emac_tx_buffer_memBuffer_serverAdapterB_s1_1$wget =
	     { 1'd1, !ab__h31112[1] || ab__h31112[0] } ;
  ...
  assign IF_emac_rx_buffer_rRdPackets_rsCounter_65_BIT__ETC___d1526 =
			   ...
			   (emac_rx_buffer_rRdPackets_rsCounter[4] ?
				 ...
				 (emac_rx_buffer_rRdPackets_rsCounter[6] ?
				    ...
				    (emac_rx_buffer_rRdPackets_rsCounter[7] ?
				       ...
				       32'd9)))))))) :
	       32'd7 ;
  assign IF_emac_rx_buffer_rWrPackets_rsCounter_35_BIT__ETC___d1519 =
			   ...
			   (emac_rx_buffer_rWrPackets_rsCounter[4] ?
				 ...
				 (emac_rx_buffer_rWrPackets_rsCounter[6] ?
				    ...
				    (emac_rx_buffer_rWrPackets_rsCounter[7] ?
				       ...
				       32'd9)))))))) :
	       32'd7 ;
  assign IF_emac_rx_buffer_rWrPackets_rsCounter_35_BIT__ETC___d1520 =
	     emac_rx_buffer_rWrPackets_rsCounter_35_BIT_0_4_ETC___d1456 ?
	       IF_emac_rx_buffer_rWrPackets_rsCounter_35_BIT__ETC___d1519 :
	       32'd0 ;
  assign IF_emac_tx_buffer_fifoEnq_rw_enq_whas__06_THEN_ETC___d1528 =
	     CAN_FIRE_RL_tx_data ?
	       emac_tx_buffer_fifoEnq_rw_enq$wget[9:8] == 2'd0 :
	       emac_tx_buffer_fifoEnq_taggedReg[10] &&
	       emac_tx_buffer_fifoEnq_taggedReg[9:8] == 2'd0 ;
  assign IF_emac_tx_buffer_fifoEnq_rw_enq_whas__06_THEN_ETC___d1529 =
	     CAN_FIRE_RL_tx_data ?
	       emac_tx_buffer_fifoEnq_rw_enq$wget[9:8] == 2'd1 :
	       emac_tx_buffer_fifoEnq_taggedReg[10] &&
	       emac_tx_buffer_fifoEnq_taggedReg[9:8] == 2'd1 ;
  assign IF_emac_tx_buffer_rRdPackets_rsCounter_035_BIT_ETC___d1538 =
			   ...
			   (emac_tx_buffer_rRdPackets_rsCounter[4] ?
				 ...
				 (emac_tx_buffer_rRdPackets_rsCounter[6] ?
				    ...
				    (emac_tx_buffer_rRdPackets_rsCounter[7] ?
				       ...
				       32'd9)))))))) :
	       32'd7 ;
  assign IF_emac_tx_buffer_rRdPackets_rsCounter_035_BIT_ETC___d1539 =
	     emac_tx_buffer_rRdPackets_rsCounter_035_BIT_0__ETC___d1459 ?
	       IF_emac_tx_buffer_rRdPackets_rsCounter_035_BIT_ETC___d1538 :
	       32'd0 ;
  assign IF_emac_tx_buffer_rWrPackets_rsCounter_18_BIT__ETC___d1531 =
			   ...
			   (emac_tx_buffer_rWrPackets_rsCounter[4] ?
				 ...
				 (emac_tx_buffer_rWrPackets_rsCounter[6] ?
				    ...
				    (emac_tx_buffer_rWrPackets_rsCounter[7] ?
				       ...
				       32'd9)))))))) :
	       32'd7 ;
  assign IF_emac_tx_buffer_rWrPackets_rsCounter_18_BIT__ETC___d1532 =
	     emac_tx_buffer_rWrPackets_rsCounter_18_BIT_0_2_ETC___d1458 ?
	       IF_emac_tx_buffer_rWrPackets_rsCounter_18_BIT__ETC___d1531 :
	       32'd0 ;
  assign ab__h20421 = 2'd0 ;
  assign ab__h31112 = 2'd0 ;
  ...
  assign emac_rx_buffer_memBuffer_serverAdapterB_outDat_ETC___d797 =
	     ...
	     (emac_rx_buffer_memBuffer_serverAdapterB_outData_outData$wget[9:8] !=
	      ...
	      2'd1 ||
	      emac_rx_buffer_memBuffer_serverAdapterB_cnt_11_ETC___d773) ;
  assign emac_rx_buffer_rRdPackets_rsCounter_65_BIT_0_7_ETC___d1457 =
	     z__h22330 ^ emac_rx_buffer_rRdPackets_rsCounter[7] ;
  assign emac_rx_buffer_rWrPackets_rsCounter_35_BIT_0_4_ETC___d1456 =
	     z__h15755 ^ emac_rx_buffer_rWrPackets_rsCounter[7] ;
  ...
  assign emac_tx_buffer_memBuffer_serverAdapterB_outDat_ETC___d1158 =
	     ...
	     (emac_tx_buffer_memBuffer_serverAdapterB_outData_outData$wget[9:8] !=
	      2'd1 ||
	      emac_tx_buffer_memBuffer_serverAdapterB_cnt_94_ETC___d1125) ;
  assign emac_tx_buffer_rRdPackets_rsCounter_035_BIT_0__ETC___d1459 =
	     z__h33223 ^ emac_tx_buffer_rRdPackets_rsCounter[7] ;
  assign emac_tx_buffer_rWrPackets_rsCounter_18_BIT_0_2_ETC___d1458 =
	     z__h26494 ^ emac_tx_buffer_rWrPackets_rsCounter[7] ;
  assign status__h37750 = { 16'd0, x__h37896 } ;
  ...
  assign x__h15700 =
	     8'd1 <<
	     IF_emac_rx_buffer_rWrPackets_rsCounter_35_BIT__ETC___d1520 ;
  assign x__h22275 = 8'd1 << x__h22910 ;
  assign x__h22910 =
	     emac_rx_buffer_rRdPackets_rsCounter_65_BIT_0_7_ETC___d1457 ?
	       IF_emac_rx_buffer_rRdPackets_rsCounter_65_BIT__ETC___d1526 :
	       32'd0 ;
  assign x__h26439 =
	     8'd1 <<
	     IF_emac_tx_buffer_rWrPackets_rsCounter_18_BIT__ETC___d1532 ;
  ...
  assign x__h37896 = { wsiM_statusR, wsiS_statusR } ;
  assign x_burstLength__h37163 =
	     IF_emac_rx_buffer_fifoDeq_rw_enq_whas__52_THEN_ETC___d1295 ?
	       12'd1 :
	       12'd4095 ;
  assign x_data__h37164 = { 24'd0, x__h37228 } ;
  assign y__h16363 = ~x__h15700 ;
  assign y__h22938 = ~x__h22275 ;
  assign y__h27102 = ~x__h26439 ;
  assign y__h33831 = ~x__h33168 ;
  assign z__h15720 =
	     emac_rx_buffer_rWrPackets_rsCounter[0] ^
	     emac_rx_buffer_rWrPackets_rsCounter[1] ;
  assign z__h15727 = z__h15720 ^ emac_rx_buffer_rWrPackets_rsCounter[2] ;
  assign z__h15734 = z__h15727 ^ emac_rx_buffer_rWrPackets_rsCounter[3] ;
  assign z__h15741 = z__h15734 ^ emac_rx_buffer_rWrPackets_rsCounter[4] ;
  assign z__h15748 = z__h15741 ^ emac_rx_buffer_rWrPackets_rsCounter[5] ;
  assign z__h15755 = z__h15748 ^ emac_rx_buffer_rWrPackets_rsCounter[6] ;
  assign z__h22295 =
	     emac_rx_buffer_rRdPackets_rsCounter[0] ^
	     emac_rx_buffer_rRdPackets_rsCounter[1] ;
  assign z__h22302 = z__h22295 ^ emac_rx_buffer_rRdPackets_rsCounter[2] ;
  assign z__h22309 = z__h22302 ^ emac_rx_buffer_rRdPackets_rsCounter[3] ;
  assign z__h22316 = z__h22309 ^ emac_rx_buffer_rRdPackets_rsCounter[4] ;
  assign z__h22323 = z__h22316 ^ emac_rx_buffer_rRdPackets_rsCounter[5] ;
  assign z__h22330 = z__h22323 ^ emac_rx_buffer_rRdPackets_rsCounter[6] ;
  assign z__h26459 =
	     emac_tx_buffer_rWrPackets_rsCounter[0] ^
	     emac_tx_buffer_rWrPackets_rsCounter[1] ;
  assign z__h26466 = z__h26459 ^ emac_tx_buffer_rWrPackets_rsCounter[2] ;
  assign z__h26473 = z__h26466 ^ emac_tx_buffer_rWrPackets_rsCounter[3] ;
  assign z__h26480 = z__h26473 ^ emac_tx_buffer_rWrPackets_rsCounter[4] ;
  assign z__h26487 = z__h26480 ^ emac_tx_buffer_rWrPackets_rsCounter[5] ;
  assign z__h26494 = z__h26487 ^ emac_tx_buffer_rWrPackets_rsCounter[6] ;
  assign z__h33188 =
	     emac_tx_buffer_rRdPackets_rsCounter[0] ^
	     emac_tx_buffer_rRdPackets_rsCounter[1] ;
  assign z__h33195 = z__h33188 ^ emac_tx_buffer_rRdPackets_rsCounter[2] ;
  assign z__h33202 = z__h33195 ^ emac_tx_buffer_rRdPackets_rsCounter[3] ;
  assign z__h33209 = z__h33202 ^ emac_tx_buffer_rRdPackets_rsCounter[4] ;
  assign z__h33216 = z__h33209 ^ emac_tx_buffer_rRdPackets_rsCounter[5] ;
  assign z__h33223 = z__h33216 ^ emac_tx_buffer_rRdPackets_rsCounter[6] ;
  ...
  begin
    case (wciRx_reqF$D_OUT[39:32])
      8'h0: _theResult____h37815 = status__h37750;
      8'h04: _theResult____h37815 = gbeControl;
      8'h10: _theResult____h37815 = wsiM_extStatusW$wget[95:64];
      8'h14: _theResult____h37815 = wsiM_extStatusW$wget[63:32];
      8'h18: _theResult____h37815 = wsiS_extStatusW$wget[95:64];
      8'h1C: _theResult____h37815 = wsiS_extStatusW$wget[63:32];
      default: _theResult____h37815 = 32'd0;
    endcase
  end
