...
//
// On Sun Mar  4 17:18:25 EST 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkGbeWorker(CLK_gmii_rx_clk,
  ...
  reg [63 : 0] v__h3624, v__h3798, v__h38398, v__h38687, v__h3942, v__h41700;
  reg [31 : 0] IF_wci_wslv_reqF_first__5_BITS_39_TO_32_39_EQ__ETC___d628;
  reg [3 : 0] x_byteEn__h33210;
  wire [101 : 0] _1448743543117976458853375091858__q1,
		 _643371375338640__q2,
		 bs__h12588,
		 bs__h25051;
  wire [60 : 0] _24577_CONCAT_IF_gmac_rx_get_53_BITS_9_TO_8_54__ETC___d478;
  wire [31 : 0] rdat___1__h38906,
		rdat___1__h38947,
		rdat___1__h38982,
		rdat___1__h39023,
		rdat___1__h39058,
		...
		x__h37712,
		x_data__h32477;
  wire [15 : 0] x__h38752, x_data__h28249;
  wire [2 : 0] d0__h12214,
	       d10__h12204,
	       d11__h12203,
	       d12__h12202,
	       ...
	       ra3__h12194,
	       ra4__h12193;
  wire rxIdx_86_ULT_12___d499,
       rxIdx_86_ULT_6___d493,
       wci_wslv_reqF_i_notEmpty__4_AND_IF_wci_wslv_re_ETC___d547;
  ...
  assign MUX_wci_wslv_respF_q_1$write_1__VAL_2 =
	     (wci_wslv_respF_c_r == 2'd2) ?
	       MUX_wci_wslv_respF_q_0$write_1__VAL_1 :
	       34'h0AAAAAAAA ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_1 = { 2'd1, rdat__h38671 } ;
  ...
  assign MUX_wsiM_reqFifo_q_0$write_1__VAL_1 =
	     (gmac$rx_get[9:8] == 2'd0) ?
	       ...
	       _24577_CONCAT_IF_gmac_rx_get_53_BITS_9_TO_8_54__ETC___d478 ;
  ...
  assign mdi_rMDC$D_IN =
	     _1448743543117976458853375091858__q1[mdi_rPlayIndex$Q_OUT[6:0]] ;
  ...
  assign mdi_vrReadData$EN =
	     WILL_FIRE_RL_mdi_run_frame && mdi_rPlayIndex$Q_OUT != 8'd0 &&
	     !mdi_rWrite &&
	     _643371375338640__q2[mdi_rPlayIndex$Q_OUT[6:0]] ;
  ...
  // register rxDstLast
  assign rxDstLast$D_IN = { rxDstLast[39:0], gmac$rx_get[7:0] } ;
  assign rxDstLast$EN =
	     WILL_FIRE_RL_rx_data && gmac$rx_get[9:8] == 2'd0 &&
	     rxIdx_86_ULT_6___d493 ;
  ...
  assign rxIdx$D_IN =
	     (gmac$rx_get[9:8] == 2'd0) ?
	       ((rxIdx == 4'd15) ? rxIdx : rxIdx + 4'd1) :
	       4'd0 ;
  assign rxIdx$EN = WILL_FIRE_RL_rx_data ;

  // register rxLenCount
  assign rxLenCount$D_IN = (gmac$rx_get[9:8] == 2'd0) ? x__h37712 : 32'd0 ;
  assign rxLenCount$EN =
	     WILL_FIRE_RL_rx_data &&
	     (gmac$rx_get[9:8] == 2'd0 || gmac$rx_get[9:8] == 2'd1) ;

  // register rxLenLast
  assign rxLenLast$D_IN = x__h37712 ;
  assign rxLenLast$EN = WILL_FIRE_RL_rx_data && gmac$rx_get[9:8] == 2'd1 ;

  // register rxOpLast
  assign rxOpLast$D_IN = { rxOpLast[7:0], gmac$rx_get[7:0] } ;
  assign rxOpLast$EN =
	     WILL_FIRE_RL_rx_data && gmac$rx_get[9:8] == 2'd0 &&
	     !rxIdx_86_ULT_6___d493 &&
	     !rxIdx_86_ULT_12___d499 &&
	     rxIdx < 4'd13 ;
  ...
  // register rxPipe
  assign rxPipe$D_IN = x_data__h32477 ;
  ...
  // register rxSrcLast
  assign rxSrcLast$D_IN = { rxSrcLast[39:0], gmac$rx_get[7:0] } ;
  assign rxSrcLast$EN =
	     WILL_FIRE_RL_rx_data && gmac$rx_get[9:8] == 2'd0 &&
	     !rxIdx_86_ULT_6___d493 &&
	     rxIdx_86_ULT_12___d499 ;
  ...
  assign _24577_CONCAT_IF_gmac_rx_get_53_BITS_9_TO_8_54__ETC___d478 =
	     { 17'd24577,
	       (gmac$rx_get[9:8] == 2'd1) ? x_data__h32477 : rxPipe,
	       x_byteEn__h33210,
	       8'd0 } ;
  assign _643371375338640__q2 = 102'h00000000000002492492492490 ;
  assign bs__h12588 =
  ...
  assign rdat___1__h38906 =
	     hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat___1__h38947 =
	     hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat___1__h38982 =
	     hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat___1__h39023 =
	     hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat___1__h39058 = hasDebugLogic ? rxCount : 32'd0 ;
  assign rdat___1__h39091 = hasDebugLogic ? txCount : 32'd0 ;
  assign rdat___1__h39125 = hasDebugLogic ? rxOvfCount : 32'd0 ;
  assign rdat___1__h39158 = hasDebugLogic ? txUndCount : 32'd0 ;
  assign rdat___1__h39191 = hasDebugLogic ? rxValidNoEOPC : 32'd0 ;
  assign rdat___1__h39224 = hasDebugLogic ? rxValidEOPC : 32'd0 ;
  assign rdat___1__h39257 = hasDebugLogic ? rxEmptyEOPC : 32'd0 ;
  assign rdat___1__h39290 = hasDebugLogic ? rxAbortEOPC : 32'd0 ;
  assign rdat___1__h39323 =
	     hasDebugLogic ? { 16'h0, rxDstLast[47:32] } : 32'd0 ;
  assign rdat___1__h39673 = hasDebugLogic ? rxDstLast[31:0] : 32'd0 ;
  assign rdat___1__h40225 =
	     hasDebugLogic ? { 16'h0, rxSrcLast[47:32] } : 32'd0 ;
  assign rdat___1__h40575 = hasDebugLogic ? rxSrcLast[31:0] : 32'd0 ;
  assign rdat___1__h41127 = hasDebugLogic ? { 16'h0, rxOpLast } : 32'd0 ;
  assign rdat___1__h41477 = hasDebugLogic ? rxLenLast : 32'd0 ;
  assign rdat__h38671 =
	     wci_wslv_reqF$D_OUT[39] ?
	       32'd0 :
	       IF_wci_wslv_reqF_first__5_BITS_39_TO_32_39_EQ__ETC___d628 ;
  assign rxIdx_86_ULT_12___d499 = rxIdx < 4'd12 ;
  assign rxIdx_86_ULT_6___d493 = rxIdx < 4'd6 ;
  assign status__h38472 = { 16'd0, x__h38752 } ;
  assign wci_wslv_reqF_i_notEmpty__4_AND_IF_wci_wslv_re_ETC___d547 =
	     wci_wslv_reqF$EMPTY_N &&
	     (wci_wslv_reqF$D_OUT[39] ?
		mdi_fRequest$FULL_N :
		wci_wslv_respF_c_r != 2'd2) ;
  assign x__h37712 = rxLenCount + 32'd1 ;
  assign x__h38752 = { wsiM_statusR, wsiS_statusR } ;
  assign x_data__h28249 =
	     { mdi_vrReadData_15,
	       ...
	       mdi_vrReadData_1,
	       mdi_vrReadData } ;
  assign x_data__h32477 = { rxPipe[23:0], gmac$rx_get[7:0] } ;
  always@(rxPos)
  begin
    case (rxPos)
      2'd0: x_byteEn__h33210 = 4'b0001;
      2'd1: x_byteEn__h33210 = 4'b0011;
      2'd2: x_byteEn__h33210 = 4'b0111;
      2'd3: x_byteEn__h33210 = 4'b1111;
    endcase
  end
  always@(wci_wslv_reqF$D_OUT or
	  ...
	  rdat___1__h39673 or
	  rdat___1__h40225 or
	  rdat___1__h40575 or rdat___1__h41127 or rdat___1__h41477)
  begin
    case (wci_wslv_reqF$D_OUT[39:32])
	  ...
	  IF_wci_wslv_reqF_first__5_BITS_39_TO_32_39_EQ__ETC___d628 =
	      rdat___1__h41477;
      default: IF_wci_wslv_reqF_first__5_BITS_39_TO_32_39_EQ__ETC___d628 =
		   32'd0;
    endcase
  end
  ...
  begin
	...
	rxIdx <= `BSV_ASSIGNMENT_DELAY 4'd0;
    ...
    if (rxDstLast$EN) rxDstLast <= `BSV_ASSIGNMENT_DELAY rxDstLast$D_IN;
    if (rxLenLast$EN) rxLenLast <= `BSV_ASSIGNMENT_DELAY rxLenLast$D_IN;
    if (rxOpLast$EN) rxOpLast <= `BSV_ASSIGNMENT_DELAY rxOpLast$D_IN;
    if (rxPipe$EN) rxPipe <= `BSV_ASSIGNMENT_DELAY rxPipe$D_IN;
    if (rxSrcLast$EN) rxSrcLast <= `BSV_ASSIGNMENT_DELAY rxSrcLast$D_IN;
    if (wsiM_statusR$EN)
  ...
  begin
	...
	$display("Error: \"bsv/wrk/GbeWorker.bsv\", line 141, column 60: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_ctrl_IsO] and\n  [RL_wci_ctrl_OrE] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n)
	...
	$display("Error: \"bsv/wrk/GbeWorker.bsv\", line 141, column 26: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_cfwr] and\n  [RL_wci_ctrl_OrE] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n)
	...
	$display("Error: \"bsv/wrk/GbeWorker.bsv\", line 141, column 36: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_cfrd] and\n  [RL_wci_ctrl_OrE] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wci_cfrd && WILL_FIRE_RL_wci_ctrl_IsO)
	$display("Error: \"bsv/wrk/GbeWorker.bsv\", line 141, column 36: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_cfrd] and\n  [RL_wci_ctrl_IsO] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wci_ctrl_EiI && WILL_FIRE_RL_wci_ctrl_OrE)
	$display("Error: \"bsv/wrk/GbeWorker.bsv\", line 141, column 46: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_ctrl_EiI] and\n  [RL_wci_ctrl_OrE] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n)
