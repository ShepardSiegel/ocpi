...
//
// On Wed May 23 14:26:34 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkGbeWorker(CLK_gmii_rx_clk,
  ...
  reg [63 : 0] v__h102126, v__h3630, v__h3804, v__h3948, v__h81857, v__h82146;
  reg [31 : 0] IF_wci_wslv_reqF_first__5_BITS_39_TO_32_98_EQ__ETC___d1051;
  ...
  reg [7 : 0] CASE_13_MINUS_txDCPPos_rxHdr_sV_BITS_63_TO_56__ETC__q6,
	      ...
	      IF_rxDCPMesgPos_15_EQ_5_56_THEN_rxDCPMesg_22_B_ETC___d1116,
	      tag__h72386;
  ...
  reg CASE_IF_rxDCPMesgPos_15_EQ_5_56_THEN_rxDCPMesg_ETC__q4,
      CASE_dcpRespFD_OUT_BITS_43_TO_42_IF_txDCPPos__ETC__q3,
      IF_txDCPPos_54_EQ_0_55_OR_txDCPPos_54_EQ_1_56__ETC___d1249;
  wire [194 : 0] _1434766110945527031733894725304609466537681244_ETC__q10,
		 _643371375338640__q12,
		 bs__h12594,
		 bs__h25119;
  wire [31 : 0] rdat___1__h100355,
		rdat___1__h82365,
		rdat___1__h82416,
		rdat___1__h82457,
		rdat___1__h82492,
		...
		status__h81931,
		x__h72177;
  wire [15 : 0] x__h82211, x__h82369, x_data__h28317;
  wire [4 : 0] IF_txDCPPos_54_EQ_9_72_THEN_0_ELSE_txDCPPos_54_ETC___d1233,
	       txDCPPos_54_PLUS_1___d1162;
  wire [2 : 0] d0__h12220,
	       d10__h12210,
	       d11__h12209,
	       d12__h12208,
	       ...
	       ra3__h12200,
	       ra4__h12199;
  wire IF_dcp_dcpReqF_first__42_BITS_77_TO_76_43_EQ_0_ETC___d453,
       IF_rxHdr_pos_14_EQ_0_30_THEN_rxHdr_sV_96_BITS__ETC___d599,
       NOT_rxHdr_sV_96_BIT_112_97_14_AND_rxHdr_sV_96__ETC___d620,
       NOT_rxHdr_sV_96_BIT_112_97_14_AND_rxHdr_sV_96__ETC___d810,
       dcpRespF_i_notEmpty__50_AND_IF_dcpRespF_first__ETC___d786,
       gmac_rx_get_08_BITS_9_TO_8_09_EQ_0_10_OR_gmac__ETC___d602,
       rxHdr_sV_96_BIT_112_97_OR_NOT_rxHdr_sV_96_BITS_ETC___d893,
       wci_wslv_reqF_i_notEmpty__4_AND_IF_wci_wslv_re_ETC___d923;
  ...
  assign CAN_FIRE_RL_rx_dcp =
	     rxDCPHdrF$EMPTY_N &&
	     CASE_IF_rxDCPMesgPos_15_EQ_5_56_THEN_rxDCPMesg_ETC__q4 &&
  ...
  assign WILL_FIRE_RL_dcp_dcp_request =
	     dcp_dcpReqF$EMPTY_N &&
	     IF_dcp_dcpReqF_first__42_BITS_77_TO_76_43_EQ_0_ETC___d453 ;
  ...
  assign MUX_wci_wslv_respF_q_1$write_1__VAL_2 =
	     (wci_wslv_respF_c_r == 2'd2) ?
	       MUX_wci_wslv_respF_q_0$write_1__VAL_1 :
	       34'h0AAAAAAAA ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_1 = { 2'd1, rdat__h82130 } ;
  ...
  // register rxLenCount
  assign rxLenCount$D_IN = (gmac$rx_get[9:8] == 2'd0) ? x__h72177 : 32'd0 ;
  assign rxLenCount$EN = WILL_FIRE_RL_rx_data ;

  // register rxLenLast
  assign rxLenLast$D_IN = x__h72177 ;
  ...
  assign txDCPPos$D_IN =
	     (!rxHdr_sV[112] && rxHdr_sV[15:0] == 16'hF040) ?
	       ((txDCPPos == 5'd13) ? 5'd0 : txDCPPos_54_PLUS_1___d1162) :
  ...
  // submodule dcp_dcpReqF
  always@(IF_rxDCPMesgPos_15_EQ_5_56_THEN_rxDCPMesg_22_B_ETC___d1116 or
	  tag__h72386 or rxDCPMesg)
  begin
    case (IF_rxDCPMesgPos_15_EQ_5_56_THEN_rxDCPMesg_22_B_ETC___d1116[7:4])
      4'd0:
	  dcp_dcpReqF$D_IN = { 38'h0AAAAAAAAA, tag__h72386, rxDCPMesg[31:0] };
      4'd1:
	  dcp_dcpReqF$D_IN =
	      { 2'd1,
		IF_rxDCPMesgPos_15_EQ_5_56_THEN_rxDCPMesg_22_B_ETC___d1116[3:0],
		tag__h72386,
		rxDCPMesg[31:0],
		rxDCPMesg[63:32] };
  ...
  assign dcp_dcpReqF$ENQ =
	     WILL_FIRE_RL_rx_dcp &&
	     (IF_rxDCPMesgPos_15_EQ_5_56_THEN_rxDCPMesg_22_B_ETC___d1116[7:4] ==
	      4'd0 ||
	      IF_rxDCPMesgPos_15_EQ_5_56_THEN_rxDCPMesg_22_B_ETC___d1116[7:4] ==
	      4'd1 ||
	      IF_rxDCPMesgPos_15_EQ_5_56_THEN_rxDCPMesg_22_B_ETC___d1116[7:4] ==
  ...
  // remaining internal signals
  assign IF_dcp_dcpReqF_first__42_BITS_77_TO_76_43_EQ_0_ETC___d453 =
	     (dcp_dcpReqF$D_OUT[77:76] == 2'd0) ?
	       dcp_dcpRespF$FULL_N :
	       (dcp_dcpReqF$D_OUT[77:76] == 2'd1 || dcp_cpReqF$FULL_N) &&
	       (dcp_dcpReqF$D_OUT[77:76] != 2'd1 ||
		dcp_dcpRespF$FULL_N && dcp_cpReqF$FULL_N) ;
  assign IF_rxHdr_pos_14_EQ_0_30_THEN_rxHdr_sV_96_BITS__ETC___d599 =
	     CASE_rxHdr_pos_rxHdr_sV_BITS_111_TO_104_0_rxHd_ETC__q1 ==
	     CASE_rxHdr_pos_rxHdr_pV_BITS_111_TO_104_0_rxHd_ETC__q2 ;
  assign IF_txDCPPos_54_EQ_9_72_THEN_0_ELSE_txDCPPos_54_ETC___d1233 =
	     (txDCPPos == 5'd9) ? 5'd0 : txDCPPos_54_PLUS_1___d1162 ;
  assign NOT_rxHdr_sV_96_BIT_112_97_14_AND_rxHdr_sV_96__ETC___d620 =
	     !rxHdr_sV[112] && rxHdr_sV[15:0] == 16'hF040 &&
	     { 3'd0, rxDCPMesgPos } < rxDCPPLI ;
  assign NOT_rxHdr_sV_96_BIT_112_97_14_AND_rxHdr_sV_96__ETC___d810 =
	     !rxHdr_sV[112] && rxHdr_sV[15:0] == 16'hF040 ||
  ...
  assign dcpRespF_i_notEmpty__50_AND_IF_dcpRespF_first__ETC___d786 =
	     dcpRespF$EMPTY_N &&
	     CASE_dcpRespFD_OUT_BITS_43_TO_42_IF_txDCPPos__ETC__q3 ;
  assign gmac_rx_get_08_BITS_9_TO_8_09_EQ_0_10_OR_gmac__ETC___d602 =
	     (gmac$rx_get[9:8] == 2'd0 || gmac$rx_get[9:8] == 2'd1) &&
	     rxHdr_sV[112] &&
	     !rxHdr_pV[112] &&
	     IF_rxHdr_pos_14_EQ_0_30_THEN_rxHdr_sV_96_BITS__ETC___d599 ;
  ...
  assign rdat___1__h100355 = hasDebugLogic ? rxHeadCap[31:0] : 32'd0 ;
  assign rdat___1__h82365 = hasDebugLogic ? { 16'd0, x__h82369 } : 32'd0 ;
  assign rdat___1__h82416 =
	     hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat___1__h82457 =
	     hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat___1__h82492 =
	     hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat___1__h82525 =
	     hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat___1__h82566 =
	     hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat___1__h82601 = hasDebugLogic ? txDBGCnt : 32'd0 ;
  assign rdat___1__h82635 = hasDebugLogic ? rxCount : 32'd0 ;
  assign rdat___1__h82668 = hasDebugLogic ? txCount : 32'd0 ;
  assign rdat___1__h82702 = hasDebugLogic ? rxOvfCount : 32'd0 ;
  assign rdat___1__h82735 = hasDebugLogic ? txUndCount : 32'd0 ;
  assign rdat___1__h82768 = hasDebugLogic ? rxValidNoEOPC : 32'd0 ;
  assign rdat___1__h82801 = hasDebugLogic ? rxValidEOPC : 32'd0 ;
  assign rdat___1__h82834 = hasDebugLogic ? rxEmptyEOPC : 32'd0 ;
  assign rdat___1__h82867 = hasDebugLogic ? rxAbortEOPC : 32'd0 ;
  assign rdat___1__h82900 = hasDebugLogic ? rxDCPCnt : 32'd0 ;
  assign rdat___1__h82934 = hasDebugLogic ? rxHdrMatchCnt : 32'd0 ;
  assign rdat___1__h82967 = hasDebugLogic ? rxLenLast : 32'd0 ;
  assign rdat___1__h83001 = hasDebugLogic ? txDCPCnt : 32'd0 ;
  assign rdat___1__h83035 = hasDebugLogic ? { 28'd0, rxHdr_pos } : 32'd0 ;
  assign rdat___1__h83072 = hasDebugLogic ? { 28'd0, rxHdr_mCnt } : 32'd0 ;
  assign rdat___1__h83109 =
	     hasDebugLogic ? { 16'd0, rxHdr_sV[111:96] } : 32'd0 ;
  assign rdat___1__h85610 = hasDebugLogic ? rxHdr_sV[95:64] : 32'd0 ;
  assign rdat___1__h88108 =
	     hasDebugLogic ? { 16'd0, rxHdr_sV[63:48] } : 32'd0 ;
  assign rdat___1__h90609 = hasDebugLogic ? rxHdr_sV[47:16] : 32'd0 ;
  assign rdat___1__h93107 =
	     hasDebugLogic ? { 16'd0, rxHdr_sV[15:0] } : 32'd0 ;
  assign rdat___1__h95608 = hasDebugLogic ? rxHeadCap[127:96] : 32'd0 ;
  assign rdat___1__h97215 = hasDebugLogic ? rxHeadCap[95:64] : 32'd0 ;
  assign rdat___1__h98785 = hasDebugLogic ? rxHeadCap[63:32] : 32'd0 ;
  assign rdat__h82130 =
	     wci_wslv_reqF$D_OUT[39] ?
	       32'd0 :
	       IF_wci_wslv_reqF_first__5_BITS_39_TO_32_98_EQ__ETC___d1051 ;
  assign rxHdr_sV_96_BIT_112_97_OR_NOT_rxHdr_sV_96_BITS_ETC___d893 =
	     (rxHdr_sV[112] || rxHdr_sV[15:0] != 16'hF040) &&
	     (dcpRespF$D_OUT[43:42] == 2'd0 && txDCPPos == 5'd9 ||
	      dcpRespF$D_OUT[43:42] != 2'd0 &&
	      (dcpRespF$D_OUT[43:42] == 2'd1 && txDCPPos == 5'd5 ||
	       dcpRespF$D_OUT[43:42] != 2'd1 && txDCPPos == 5'd9)) ;
  assign status__h81931 = { 16'd0, x__h82211 } ;
  assign txDCPPos_54_PLUS_1___d1162 = txDCPPos + 5'd1 ;
  assign wci_wslv_reqF_i_notEmpty__4_AND_IF_wci_wslv_re_ETC___d923 =
	     wci_wslv_reqF$EMPTY_N &&
	     (wci_wslv_reqF$D_OUT[39] ?
		mdi_fRequest$FULL_N :
		wci_wslv_respF_c_r != 2'd2) ;
  assign x__h72177 = rxLenCount + 32'd1 ;
  assign x__h82211 = { wsiM_statusR, wsiS_statusR } ;
  assign x__h82369 = { wsiS_statusR, wsiM_statusR } ;
  ...
  begin
    case (rxDCPMesgPos)
      5'd6: tag__h72386 = rxDCPMesg[7:0];
      5'd7: tag__h72386 = rxDCPMesg[15:8];
      5'd8: tag__h72386 = rxDCPMesg[23:16];
      5'd9: tag__h72386 = rxDCPMesg[31:24];
      5'd10: tag__h72386 = rxDCPMesg[39:32];
      5'd11: tag__h72386 = rxDCPMesg[47:40];
      5'd12: tag__h72386 = rxDCPMesg[55:48];
      5'd13: tag__h72386 = rxDCPMesg[63:56];
      5'd14: tag__h72386 = rxDCPMesg[71:64];
      5'd15: tag__h72386 = rxDCPMesg[79:72];
      5'd16: tag__h72386 = rxDCPMesg[87:80];
      5'd17: tag__h72386 = rxDCPMesg[95:88];
      5'd18: tag__h72386 = rxDCPMesg[103:96];
      default: tag__h72386 = rxDCPMesg[111:104];
    endcase
  end
  ...
  begin
    case (txDCPPos)
	  ...
	  IF_txDCPPos_54_EQ_0_55_OR_txDCPPos_54_EQ_1_56__ETC___d1249 =
	      gmac$RDY_tx_put;
      default: IF_txDCPPos_54_EQ_0_55_OR_txDCPPos_54_EQ_1_56__ETC___d1249 =
		   txDCPPos != 5'd9 || gmac$RDY_tx_put;
    endcase
  end
  always@(dcpRespF$D_OUT or
	  IF_txDCPPos_54_EQ_0_55_OR_txDCPPos_54_EQ_1_56__ETC___d1249 or
  ...
  begin
    case (rxDCPMesgPos)
	  ...
	  IF_rxDCPMesgPos_15_EQ_5_56_THEN_rxDCPMesg_22_B_ETC___d1116 =
	      rxDCPMesg[103:96];
      default: IF_rxDCPMesgPos_15_EQ_5_56_THEN_rxDCPMesg_22_B_ETC___d1116 =
		   rxDCPMesg[111:104];
    endcase
  end
  always@(IF_rxDCPMesgPos_15_EQ_5_56_THEN_rxDCPMesg_22_B_ETC___d1116 or
  ...
  begin
    case (IF_rxDCPMesgPos_15_EQ_5_56_THEN_rxDCPMesg_22_B_ETC___d1116[7:4])
	  ...
	  CASE_IF_rxDCPMesgPos_15_EQ_5_56_THEN_rxDCPMesg_ETC__q4 =
	      dcp_dcpReqF$FULL_N;
      default: CASE_IF_rxDCPMesgPos_15_EQ_5_56_THEN_rxDCPMesg_ETC__q4 =
		   IF_rxDCPMesgPos_15_EQ_5_56_THEN_rxDCPMesg_22_B_ETC___d1116[7:4] !=
		   4'd2 ||
		   dcp_dcpReqF$FULL_N;
    endcase
  ...
  always@(wci_wslv_reqF$D_OUT or
	  ...
	  rdat___1__h93107 or
	  rdat___1__h95608 or
	  rdat___1__h97215 or rdat___1__h98785 or rdat___1__h100355)
  begin
    case (wci_wslv_reqF$D_OUT[39:32])
	  ...
	  IF_wci_wslv_reqF_first__5_BITS_39_TO_32_98_EQ__ETC___d1051 =
	      rdat___1__h100355;
      default: IF_wci_wslv_reqF_first__5_BITS_39_TO_32_98_EQ__ETC___d1051 =
		   32'd0;
    endcase
  end
  ...
  always@(dcpRespF$D_OUT or
	  IF_txDCPPos_54_EQ_9_72_THEN_0_ELSE_txDCPPos_54_ETC___d1233 or
	  txDCPPos or txDCPPos_54_PLUS_1___d1162)
  begin
    case (dcpRespF$D_OUT[43:42])
      2'd0:
	  CASE_dcpRespFD_OUT_BITS_43_TO_42_IF_txDCPPos__ETC__q11 =
	      IF_txDCPPos_54_EQ_9_72_THEN_0_ELSE_txDCPPos_54_ETC___d1233;
      2'd1:
	  CASE_dcpRespFD_OUT_BITS_43_TO_42_IF_txDCPPos__ETC__q11 =
	      (txDCPPos == 5'd5) ? 5'd0 : txDCPPos_54_PLUS_1___d1162;
