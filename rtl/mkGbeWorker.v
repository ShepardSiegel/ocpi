...
//
// On Sun Mar  4 11:32:37 EST 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkGbeWorker(CLK_gmii_rx_clk,
  ...
  reg [63 : 0] v__h34619, v__h34908, v__h35727, v__h3621, v__h3795, v__h3939;
  reg [31 : 0] IF_wci_wslv_reqF_first__5_BITS_39_TO_32_10_EQ__ETC___d573;
  reg [3 : 0] x_byteEn__h32918;
  ...
  wire [31 : 0] rdat___1__h35127,
		...
		status__h34693,
		x_data__h32185;
  wire [15 : 0] x__h34973, x_data__h28246;
  wire [2 : 0] d0__h12211,
	       d10__h12201,
	       d11__h12200,
	       d12__h12199,
	       ...
	       ra3__h12191,
	       ra4__h12190;
  wire wci_wslv_reqF_i_notEmpty__4_AND_IF_wci_wslv_re_ETC___d518;
  ...
  assign WILL_FIRE_RL_wci_cfrd =
	     wci_wslv_reqF_i_notEmpty__4_AND_IF_wci_wslv_re_ETC___d518 &&
	     wci_wslv_wci_cfrd_pw$whas &&
	     !WILL_FIRE_RL_wci_wslv_ctl_op_start &&
	     !WILL_FIRE_RL_advance_split_response &&
	     !WILL_FIRE_RL_wci_wslv_ctl_op_complete ;
  ...
  assign MUX_wci_wslv_respF_q_1$write_1__VAL_2 =
	     (wci_wslv_respF_c_r == 2'd2) ?
	       MUX_wci_wslv_respF_q_0$write_1__VAL_1 :
	       34'h0AAAAAAAA ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_1 = { 2'd1, rdat__h34892 } ;
  ...
  // register rxPipe
  assign rxPipe$D_IN = x_data__h32185 ;
  ...
  assign _24577_CONCAT_IF_gmac_rx_get_53_BITS_9_TO_8_54__ETC___d478 =
	     { 17'd24577,
	       (gmac$rx_get[9:8] == 2'd1) ? x_data__h32185 : rxPipe,
	       x_byteEn__h32918,
	       8'd0 } ;
  ...
  assign rdat___1__h35127 =
	     hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat___1__h35168 =
	     hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat___1__h35203 =
	     hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat___1__h35244 =
	     hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat___1__h35279 = hasDebugLogic ? rxCount : 32'd0 ;
  assign rdat___1__h35312 = hasDebugLogic ? txCount : 32'd0 ;
  assign rdat___1__h35346 = hasDebugLogic ? rxOvfCount : 32'd0 ;
  assign rdat___1__h35379 = hasDebugLogic ? txUndCount : 32'd0 ;
  assign rdat___1__h35412 = hasDebugLogic ? rxValidNoEOPC : 32'd0 ;
  assign rdat___1__h35445 = hasDebugLogic ? rxValidEOPC : 32'd0 ;
  assign rdat___1__h35478 = hasDebugLogic ? rxEmptyEOPC : 32'd0 ;
  assign rdat___1__h35511 = hasDebugLogic ? rxAbortEOPC : 32'd0 ;
  assign rdat__h34892 =
	     wci_wslv_reqF$D_OUT[39] ?
	       32'd0 :
	       IF_wci_wslv_reqF_first__5_BITS_39_TO_32_10_EQ__ETC___d573 ;
  assign status__h34693 = { 16'd0, x__h34973 } ;
  assign wci_wslv_reqF_i_notEmpty__4_AND_IF_wci_wslv_re_ETC___d518 =
	     wci_wslv_reqF$EMPTY_N &&
	     (wci_wslv_reqF$D_OUT[39] ?
		mdi_fRequest$FULL_N :
		wci_wslv_respF_c_r != 2'd2) ;
  assign x__h34973 = { wsiM_statusR, wsiS_statusR } ;
  assign x_data__h28246 =
	     { mdi_vrReadData_15,
	       ...
	       mdi_vrReadData_1,
	       mdi_vrReadData } ;
  assign x_data__h32185 = { rxPipe[23:0], gmac$rx_get[7:0] } ;
  always@(rxPos)
  begin
    case (rxPos)
      2'd0: x_byteEn__h32918 = 4'b0001;
      2'd1: x_byteEn__h32918 = 4'b0011;
      2'd2: x_byteEn__h32918 = 4'b0111;
      2'd3: x_byteEn__h32918 = 4'b1111;
    endcase
  end
  always@(wci_wslv_reqF$D_OUT or
	  ...
	  rdat___1__h35379 or
	  rdat___1__h35412 or
	  rdat___1__h35445 or rdat___1__h35478 or rdat___1__h35511)
  begin
    case (wci_wslv_reqF$D_OUT[39:32])
	  ...
	  IF_wci_wslv_reqF_first__5_BITS_39_TO_32_10_EQ__ETC___d573 =
	      rdat___1__h35511;
      default: IF_wci_wslv_reqF_first__5_BITS_39_TO_32_10_EQ__ETC___d573 =
		   32'd0;
    endcase
  end
  ...
  begin
	...
	$display("Error: \"bsv/wrk/GbeWorker.bsv\", line 123, column 60: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_ctrl_IsO] and\n  [RL_wci_ctrl_OrE] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n)
	...
	$display("Error: \"bsv/wrk/GbeWorker.bsv\", line 123, column 26: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_cfwr] and\n  [RL_wci_ctrl_OrE] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n)
	...
	$display("Error: \"bsv/wrk/GbeWorker.bsv\", line 123, column 36: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_cfrd] and\n  [RL_wci_ctrl_OrE] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wci_cfrd && WILL_FIRE_RL_wci_ctrl_IsO)
	$display("Error: \"bsv/wrk/GbeWorker.bsv\", line 123, column 36: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_cfrd] and\n  [RL_wci_ctrl_IsO] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wci_ctrl_EiI && WILL_FIRE_RL_wci_ctrl_OrE)
	$display("Error: \"bsv/wrk/GbeWorker.bsv\", line 123, column 46: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_ctrl_EiI] and\n  [RL_wci_ctrl_OrE] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n)
