...
//
// On Tue Jun 12 09:22:30 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkGbeWorker(CLK_gmii_rx_clk,
  ...
  reg [63 : 0] v__h102116, v__h3630, v__h3804, v__h3948, v__h81847, v__h82136;
  ...
  reg [7 : 0] CASE_13_MINUS_txDCPPos_rxHdr_sV_BITS_63_TO_56__ETC__q6,
	      ...
	      IF_rxDCPMesgPos_15_EQ_5_56_THEN_rxDCPMesg_22_B_ETC___d1127,
	      tag__h72376;
  ...
  wire [31 : 0] rdat___1__h100345,
		...
		status__h81921,
		x__h72167;
  wire [15 : 0] x__h82201, x__h82359, x_data__h28317;
  wire [4 : 0] IF_txDCPPos_54_EQ_9_72_THEN_0_ELSE_txDCPPos_54_ETC___d1239,
	       txDCPPos_54_PLUS_1___d1172;
  wire [2 : 0] d0__h12220,
	       d10__h12210,
	       d11__h12209,
	       d12__h12208,
  ...
  assign MUX_wci_wslv_respF_q_1$write_1__VAL_1 =
	     (wci_wslv_respF_c_r == 2'd2) ?
	       MUX_wci_wslv_respF_q_0$write_1__VAL_2 :
	       34'h0AAAAAAAA ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_1 = { 2'd1, rdat__h82120 } ;
  ...
  // register rxLenCount
  assign rxLenCount$D_IN = (gmac$rx_get[9:8] == 2'd0) ? x__h72167 : 32'd0 ;
  assign rxLenCount$EN = WILL_FIRE_RL_rx_data ;

  // register rxLenLast
  assign rxLenLast$D_IN = x__h72167 ;
  ...
  assign txDCPPos$D_IN =
	     (!rxHdr_sV[112] && rxHdr_sV[15:0] == 16'hF040) ?
	       ((txDCPPos == 5'd13) ? 5'd0 : txDCPPos_54_PLUS_1___d1172) :
  ...
  // submodule dcp_dcpReqF
  always@(IF_rxDCPMesgPos_15_EQ_5_56_THEN_rxDCPMesg_22_B_ETC___d1127 or
	  tag__h72376 or rxDCPMesg)
  begin
    case (IF_rxDCPMesgPos_15_EQ_5_56_THEN_rxDCPMesg_22_B_ETC___d1127[7:4])
      4'd0:
	  dcp_dcpReqF$D_IN = { 38'h0AAAAAAAAA, tag__h72376, rxDCPMesg[31:0] };
      4'd1:
	  dcp_dcpReqF$D_IN =
	      { 2'd1,
		IF_rxDCPMesgPos_15_EQ_5_56_THEN_rxDCPMesg_22_B_ETC___d1127[3:0],
		tag__h72376,
		rxDCPMesg[31:0],
		rxDCPMesg[63:32] };
  ...
  assign dcp_dcpReqF$ENQ =
	     WILL_FIRE_RL_rx_dcp &&
	     (IF_rxDCPMesgPos_15_EQ_5_56_THEN_rxDCPMesg_22_B_ETC___d1127[7:4] ==
	      4'd0 ||
	      IF_rxDCPMesgPos_15_EQ_5_56_THEN_rxDCPMesg_22_B_ETC___d1127[7:4] ==
	      4'd1 ||
	      IF_rxDCPMesgPos_15_EQ_5_56_THEN_rxDCPMesg_22_B_ETC___d1127[7:4] ==
  ...
  assign IF_rxHdr_pos_14_EQ_0_30_THEN_rxHdr_sV_96_BITS__ETC___d599 =
	     CASE_rxHdr_pos_rxHdr_sV_BITS_111_TO_104_0_rxHd_ETC__q1 ==
	     CASE_rxHdr_pos_rxHdr_pV_BITS_111_TO_104_0_rxHd_ETC__q2 ;
  assign IF_txDCPPos_54_EQ_9_72_THEN_0_ELSE_txDCPPos_54_ETC___d1239 =
	     (txDCPPos == 5'd9) ? 5'd0 : txDCPPos_54_PLUS_1___d1172 ;
  ...
  assign rdat___1__h100345 = hasDebugLogic ? rxHeadCap[31:0] : 32'd0 ;
  assign rdat___1__h82355 = hasDebugLogic ? { 16'd0, x__h82359 } : 32'd0 ;
  assign rdat___1__h82406 =
	     hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat___1__h82447 =
	     hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat___1__h82482 =
	     hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat___1__h82515 =
	     hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat___1__h82556 =
	     hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat___1__h82591 = hasDebugLogic ? txDBGCnt : 32'd0 ;
  assign rdat___1__h82625 = hasDebugLogic ? rxCount : 32'd0 ;
  assign rdat___1__h82658 = hasDebugLogic ? txCount : 32'd0 ;
  assign rdat___1__h82692 = hasDebugLogic ? rxOvfCount : 32'd0 ;
  assign rdat___1__h82725 = hasDebugLogic ? txUndCount : 32'd0 ;
  assign rdat___1__h82758 = hasDebugLogic ? rxValidNoEOPC : 32'd0 ;
  assign rdat___1__h82791 = hasDebugLogic ? rxValidEOPC : 32'd0 ;
  assign rdat___1__h82824 = hasDebugLogic ? rxEmptyEOPC : 32'd0 ;
  assign rdat___1__h82857 = hasDebugLogic ? rxAbortEOPC : 32'd0 ;
  assign rdat___1__h82890 = hasDebugLogic ? rxDCPCnt : 32'd0 ;
  assign rdat___1__h82924 = hasDebugLogic ? rxHdrMatchCnt : 32'd0 ;
  assign rdat___1__h82957 = hasDebugLogic ? rxLenLast : 32'd0 ;
  assign rdat___1__h82991 = hasDebugLogic ? txDCPCnt : 32'd0 ;
  assign rdat___1__h83025 = hasDebugLogic ? { 28'd0, rxHdr_pos } : 32'd0 ;
  assign rdat___1__h83062 = hasDebugLogic ? { 28'd0, rxHdr_mCnt } : 32'd0 ;
  assign rdat___1__h83099 =
	     hasDebugLogic ? { 16'd0, rxHdr_sV[111:96] } : 32'd0 ;
  assign rdat___1__h85600 = hasDebugLogic ? rxHdr_sV[95:64] : 32'd0 ;
  assign rdat___1__h88098 =
	     hasDebugLogic ? { 16'd0, rxHdr_sV[63:48] } : 32'd0 ;
  assign rdat___1__h90599 = hasDebugLogic ? rxHdr_sV[47:16] : 32'd0 ;
  assign rdat___1__h93097 =
	     hasDebugLogic ? { 16'd0, rxHdr_sV[15:0] } : 32'd0 ;
  assign rdat___1__h95598 = hasDebugLogic ? rxHeadCap[127:96] : 32'd0 ;
  assign rdat___1__h97205 = hasDebugLogic ? rxHeadCap[95:64] : 32'd0 ;
  assign rdat___1__h98775 = hasDebugLogic ? rxHeadCap[63:32] : 32'd0 ;
  assign rdat__h82120 =
	     wci_wslv_reqF$D_OUT[39] ?
	       32'd0 :
  ...
  assign status__h81921 = { 16'd0, x__h82201 } ;
  assign txDCPPos_54_PLUS_1___d1172 = txDCPPos + 5'd1 ;
  assign wci_wslv_reqF_i_notEmpty__4_AND_IF_wci_wslv_re_ETC___d923 =
	     wci_wslv_reqF$EMPTY_N &&
	     (wci_wslv_reqF$D_OUT[39] ?
		mdi_fRequest$FULL_N :
		wci_wslv_respF_c_r != 2'd2) ;
  assign x__h72167 = rxLenCount + 32'd1 ;
  assign x__h82201 = { wsiM_statusR, wsiS_statusR } ;
  assign x__h82359 = { wsiS_statusR, wsiM_statusR } ;
  ...
  begin
    case (rxDCPMesgPos)
      5'd6: tag__h72376 = rxDCPMesg[7:0];
      5'd7: tag__h72376 = rxDCPMesg[15:8];
      5'd8: tag__h72376 = rxDCPMesg[23:16];
      5'd9: tag__h72376 = rxDCPMesg[31:24];
      5'd10: tag__h72376 = rxDCPMesg[39:32];
      5'd11: tag__h72376 = rxDCPMesg[47:40];
      5'd12: tag__h72376 = rxDCPMesg[55:48];
      5'd13: tag__h72376 = rxDCPMesg[63:56];
      5'd14: tag__h72376 = rxDCPMesg[71:64];
      5'd15: tag__h72376 = rxDCPMesg[79:72];
      5'd16: tag__h72376 = rxDCPMesg[87:80];
      5'd17: tag__h72376 = rxDCPMesg[95:88];
      5'd18: tag__h72376 = rxDCPMesg[103:96];
      default: tag__h72376 = rxDCPMesg[111:104];
    endcase
  end
  ...
  begin
    case (txDCPPos)
	  ...
	  IF_txDCPPos_54_EQ_0_55_OR_txDCPPos_54_EQ_1_56__ETC___d1253 =
	      gmac$RDY_tx_put;
      default: IF_txDCPPos_54_EQ_0_55_OR_txDCPPos_54_EQ_1_56__ETC___d1253 =
		   txDCPPos != 5'd9 || gmac$RDY_tx_put;
    endcase
  end
  always@(dcpRespF$D_OUT or
	  IF_txDCPPos_54_EQ_0_55_OR_txDCPPos_54_EQ_1_56__ETC___d1253 or
  ...
  begin
    case (rxDCPMesgPos)
	  ...
	  IF_rxDCPMesgPos_15_EQ_5_56_THEN_rxDCPMesg_22_B_ETC___d1127 =
	      rxDCPMesg[103:96];
      default: IF_rxDCPMesgPos_15_EQ_5_56_THEN_rxDCPMesg_22_B_ETC___d1127 =
		   rxDCPMesg[111:104];
    endcase
  end
  always@(IF_rxDCPMesgPos_15_EQ_5_56_THEN_rxDCPMesg_22_B_ETC___d1127 or
  ...
  always@(wci_wslv_reqF$D_OUT or
	  ...
	  rdat___1__h93097 or
	  rdat___1__h95598 or
	  rdat___1__h97205 or rdat___1__h98775 or rdat___1__h100345)
  begin
  ...
  always@(dcpRespF$D_OUT or
	  IF_txDCPPos_54_EQ_9_72_THEN_0_ELSE_txDCPPos_54_ETC___d1239 or
	  txDCPPos or txDCPPos_54_PLUS_1___d1172)
  begin
    case (dcpRespF$D_OUT[43:42])
      2'd0:
	  CASE_dcpRespFD_OUT_BITS_43_TO_42_IF_txDCPPos__ETC__q11 =
	      IF_txDCPPos_54_EQ_9_72_THEN_0_ELSE_txDCPPos_54_ETC___d1239;
      2'd1:
	  CASE_dcpRespFD_OUT_BITS_43_TO_42_IF_txDCPPos__ETC__q11 =
	      (txDCPPos == 5'd5) ? 5'd0 : txDCPPos_54_PLUS_1___d1172;
