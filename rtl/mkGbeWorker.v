...
//
// On Fri Apr 27 14:51:29 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkGbeWorker(CLK_gmii_rx_clk,
  ...
  reg [7 : 0] CASE_13_MINUS_txDCPPos_rxHdr_sV_BITS_63_TO_56__ETC__q6,
	      ...
	      IF_rxDCPMesgPos_16_EQ_5_57_THEN_rxDCPMesg_23_B_ETC___d1129,
	      tag__h72295;
  ...
  assign txDCPPos$D_IN =
	     (!rxHdr_sV[112] && rxHdr_sV[15:0] == 16'hF040) ?
	       ((txDCPPos == 5'd13) ? 5'd0 : txDCPPos_55_PLUS_1___d1174) :
  ...
  // submodule dcp_dcpReqF
  always@(IF_rxDCPMesgPos_16_EQ_5_57_THEN_rxDCPMesg_23_B_ETC___d1129 or
	  tag__h72295 or rxDCPMesg)
  begin
    case (IF_rxDCPMesgPos_16_EQ_5_57_THEN_rxDCPMesg_23_B_ETC___d1129[7:4])
      4'd0:
	  dcp_dcpReqF$D_IN = { 38'h0AAAAAAAAA, tag__h72295, rxDCPMesg[31:0] };
      4'd1:
	  dcp_dcpReqF$D_IN =
	      { 2'd1,
		IF_rxDCPMesgPos_16_EQ_5_57_THEN_rxDCPMesg_23_B_ETC___d1129[3:0],
		tag__h72295,
		rxDCPMesg[31:0],
		rxDCPMesg[63:32] };
  ...
  assign dcp_dcpReqF$ENQ =
	     WILL_FIRE_RL_rx_dcp &&
	     (IF_rxDCPMesgPos_16_EQ_5_57_THEN_rxDCPMesg_23_B_ETC___d1129[7:4] ==
	      4'd0 ||
	      IF_rxDCPMesgPos_16_EQ_5_57_THEN_rxDCPMesg_23_B_ETC___d1129[7:4] ==
	      4'd1 ||
	      IF_rxDCPMesgPos_16_EQ_5_57_THEN_rxDCPMesg_23_B_ETC___d1129[7:4] ==
  ...
  assign IF_txDCPPos_55_EQ_9_73_THEN_0_ELSE_txDCPPos_55_ETC___d1241 =
	     (txDCPPos == 5'd9) ? 5'd0 : txDCPPos_55_PLUS_1___d1174 ;
  ...
  assign txDCPPos_55_PLUS_1___d1174 = txDCPPos + 5'd1 ;
  ...
  begin
    case (rxDCPMesgPos)
	  ...
	  IF_rxDCPMesgPos_16_EQ_5_57_THEN_rxDCPMesg_23_B_ETC___d1129 =
	      rxDCPMesg[103:96];
      default: IF_rxDCPMesgPos_16_EQ_5_57_THEN_rxDCPMesg_23_B_ETC___d1129 =
		   rxDCPMesg[111:104];
    endcase
  end
  always@(IF_rxDCPMesgPos_16_EQ_5_57_THEN_rxDCPMesg_23_B_ETC___d1129 or
  ...
  always@(dcpRespF$D_OUT or
	  ...
	  txDCPPos or txDCPPos_55_PLUS_1___d1174)
  begin
    case (dcpRespF$D_OUT[43:42])
      2'd0:
	  CASE_dcpRespFD_OUT_BITS_43_TO_42_IF_txDCPPos__ETC__q11 =
      ...
      2'd1:
	  CASE_dcpRespFD_OUT_BITS_43_TO_42_IF_txDCPPos__ETC__q11 =
	      (txDCPPos == 5'd5) ? 5'd0 : txDCPPos_55_PLUS_1___d1174;
