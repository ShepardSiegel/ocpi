...
//
// On Mon Feb  6 11:48:51 EST 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkGbeWorker(CLK_gmii_rx_clk,
  ...
  wire [31 : 0] IF_emac_rx_buffer_rRdPackets_rsCounter_99_BIT__ETC___d1554,
		IF_emac_rx_buffer_rRdPackets_rsCounter_99_BIT__ETC___d1555,
		IF_emac_rx_buffer_rWrPackets_rsCounter_69_BIT__ETC___d1547,
		IF_emac_rx_buffer_rWrPackets_rsCounter_69_BIT__ETC___d1548,
		IF_emac_tx_buffer_rRdPackets_rsCounter_069_BIT_ETC___d1567,
		IF_emac_tx_buffer_rRdPackets_rsCounter_069_BIT_ETC___d1568,
		IF_emac_tx_buffer_rWrPackets_rsCounter_52_BIT__ETC___d1560,
		IF_emac_tx_buffer_rWrPackets_rsCounter_52_BIT__ETC___d1561,
		status__h39242,
		x_data__h38664;
  wire [15 : 0] x__h39388;
  ...
  wire IF_emac_rx_buffer_fifoDeq_rw_enq_whas__86_THEN_ETC___d1330,
       IF_emac_tx_buffer_fifoEnq_rw_enq_whas__40_THEN_ETC___d1557,
       IF_emac_tx_buffer_fifoEnq_rw_enq_whas__40_THEN_ETC___d1558,
       ...
       emac_rx_buffer_rRdPackets_rsCounter_99_BIT_0_0_ETC___d1493,
       emac_rx_buffer_rWrPackets_rsCounter_69_BIT_0_7_ETC___d1492,
       ...
       emac_tx_buffer_rRdPackets_rsCounter_069_BIT_0__ETC___d1495,
       emac_tx_buffer_rWrPackets_rsCounter_52_BIT_0_5_ETC___d1494,
       z__h17150,
       z__h17157,
       z__h17164,
       z__h17171,
  ...
  assign MUX_emac_rx_buffer_rRdPackets_rsCounter$write_1__VAL_1 =
	     (~emac_rx_buffer_rRdPackets_rsCounter[IF_emac_rx_buffer_rRdPackets_rsCounter_99_BIT__ETC___d1555[2:0]]) ?
  ...
  assign MUX_emac_rx_buffer_rWrPackets_rsCounter$write_1__VAL_1 =
	     (~emac_rx_buffer_rWrPackets_rsCounter[IF_emac_rx_buffer_rWrPackets_rsCounter_69_BIT__ETC___d1548[2:0]]) ?
  ...
  assign MUX_emac_tx_buffer_rRdPackets_rsCounter$write_1__VAL_1 =
	     (~emac_tx_buffer_rRdPackets_rsCounter[IF_emac_tx_buffer_rRdPackets_rsCounter_069_BIT_ETC___d1568[2:0]]) ?
  ...
  assign MUX_emac_tx_buffer_rWrPackets_rsCounter$write_1__VAL_1 =
	     (~emac_tx_buffer_rWrPackets_rsCounter[IF_emac_tx_buffer_rWrPackets_rsCounter_52_BIT__ETC___d1561[2:0]]) ?
  ...
  assign MUX_wsiM_reqFifo_q_0$write_1__VAL_1 =
	     { 3'd1,
	       IF_emac_rx_buffer_fifoDeq_rw_enq_whas__86_THEN_ETC___d1330,
	       1'd0,
  ...
  // remaining internal signals
  assign IF_emac_rx_buffer_fifoDeq_rw_enq_whas__86_THEN_ETC___d1330 =
	     WILL_FIRE_RL_emac_rx_buffer_dequeue_next_beat ?
			   ...
			   (emac_rx_buffer_rRdPackets_rsCounter[4] ?
				 ...
				 (emac_rx_buffer_rRdPackets_rsCounter[6] ?
				    ...
				    (emac_rx_buffer_rRdPackets_rsCounter[7] ?
				       ...
				       32'd9)))))))) :
	       32'd7 ;
  assign IF_emac_rx_buffer_rRdPackets_rsCounter_99_BIT__ETC___d1555 =
	     emac_rx_buffer_rRdPackets_rsCounter_99_BIT_0_0_ETC___d1493 ?
			   ...
			   (emac_rx_buffer_rWrPackets_rsCounter[4] ?
				 ...
				 (emac_rx_buffer_rWrPackets_rsCounter[6] ?
				    ...
				    (emac_rx_buffer_rWrPackets_rsCounter[7] ?
				       ...
				       32'd9)))))))) :
	       32'd7 ;
  assign IF_emac_rx_buffer_rWrPackets_rsCounter_69_BIT__ETC___d1548 =
	     emac_rx_buffer_rWrPackets_rsCounter_69_BIT_0_7_ETC___d1492 ?
	       IF_emac_rx_buffer_rWrPackets_rsCounter_69_BIT__ETC___d1547 :
	       32'd0 ;
  assign IF_emac_tx_buffer_fifoEnq_rw_enq_whas__40_THEN_ETC___d1557 =
	     MUX_wsiS_reqFifo_levelsValid$write_1__SEL_3 ?
	       ...
	       emac_tx_buffer_fifoEnq_taggedReg[10] &&
	       emac_tx_buffer_fifoEnq_taggedReg[9:8] == 2'd0 ;
  assign IF_emac_tx_buffer_fifoEnq_rw_enq_whas__40_THEN_ETC___d1558 =
	     MUX_wsiS_reqFifo_levelsValid$write_1__SEL_3 ?
	       emac_tx_buffer_fifoEnq_rw_enq$wget[9:8] == 2'd1 :
	       emac_tx_buffer_fifoEnq_taggedReg[10] &&
	       emac_tx_buffer_fifoEnq_taggedReg[9:8] == 2'd1 ;
			   ...
			   (emac_tx_buffer_rRdPackets_rsCounter[4] ?
				 ...
				 (emac_tx_buffer_rRdPackets_rsCounter[6] ?
				    ...
				    (emac_tx_buffer_rRdPackets_rsCounter[7] ?
				       ...
				       32'd9)))))))) :
	       32'd7 ;
  assign IF_emac_tx_buffer_rRdPackets_rsCounter_069_BIT_ETC___d1568 =
	     emac_tx_buffer_rRdPackets_rsCounter_069_BIT_0__ETC___d1495 ?
	       IF_emac_tx_buffer_rRdPackets_rsCounter_069_BIT_ETC___d1567 :
	       32'd0 ;
			   ...
			   (emac_tx_buffer_rWrPackets_rsCounter[4] ?
				 ...
				 (emac_tx_buffer_rWrPackets_rsCounter[6] ?
				    ...
				    (emac_tx_buffer_rWrPackets_rsCounter[7] ?
				       ...
				       32'd9)))))))) :
	       32'd7 ;
  assign IF_emac_tx_buffer_rWrPackets_rsCounter_52_BIT__ETC___d1561 =
	     emac_tx_buffer_rWrPackets_rsCounter_52_BIT_0_5_ETC___d1494 ?
	       IF_emac_tx_buffer_rWrPackets_rsCounter_52_BIT__ETC___d1560 :
	       32'd0 ;
  ...
  assign emac_rx_buffer_memBuffer_serverAdapterB_outDat_ETC___d831 =
	     ...
	     (emac_rx_buffer_memBuffer_serverAdapterB_outData_outData$wget[9:8] !=
	      ...
	      2'd1 ||
	      emac_rx_buffer_memBuffer_serverAdapterB_cnt_45_ETC___d807) ;
  assign emac_rx_buffer_rRdPackets_rsCounter_99_BIT_0_0_ETC___d1493 =
	     z__h23782 ^ emac_rx_buffer_rRdPackets_rsCounter[7] ;
  assign emac_rx_buffer_rWrPackets_rsCounter_69_BIT_0_7_ETC___d1492 =
  ...
  assign emac_tx_buffer_memBuffer_serverAdapterB_outDat_ETC___d1192 =
	     ...
	     (emac_tx_buffer_memBuffer_serverAdapterB_outData_outData$wget[9:8] !=
	      2'd1 ||
	      emac_tx_buffer_memBuffer_serverAdapterB_cnt_02_ETC___d1159) ;
  assign emac_tx_buffer_rRdPackets_rsCounter_069_BIT_0__ETC___d1495 =
	     z__h34719 ^ emac_tx_buffer_rRdPackets_rsCounter[7] ;
  assign emac_tx_buffer_rWrPackets_rsCounter_52_BIT_0_5_ETC___d1494 =
