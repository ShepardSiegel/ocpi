...
//
// On Sat Mar  3 16:15:15 EST 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkGbeWorker(CLK_gmii_rx_clk,
  ...
  reg [63 : 0] v__h31537, v__h31826, v__h32509, v__h3620, v__h3794, v__h3938;
  reg [31 : 0] IF_wci_wslv_reqF_first__5_BITS_39_TO_32_78_EQ__ETC___d529;
  wire [101 : 0] _1448743543117976458853375091858__q1,
		 _643371375338640__q2,
		 bs__h12584,
		 bs__h25047;
  wire [31 : 0] rdat___1__h32045,
		rdat___1__h32086,
		rdat___1__h32121,
		rdat___1__h32162,
		rdat___1__h32197,
		...
		status__h31611,
		x_data__h30916;
  wire [15 : 0] x__h31891, x_data__h28245;
  wire [2 : 0] d0__h12210,
	       d10__h12200,
	       d11__h12199,
	       d12__h12198,
	       ...
	       ra3__h12190,
	       ra4__h12189;
  wire wci_wslv_reqF_i_notEmpty__4_AND_IF_wci_wslv_re_ETC___d486;
  ...
  assign WILL_FIRE_RL_wci_cfrd =
	     wci_wslv_reqF_i_notEmpty__4_AND_IF_wci_wslv_re_ETC___d486 &&
	     wci_wslv_wci_cfrd_pw$whas &&
	     !WILL_FIRE_RL_wci_wslv_ctl_op_start &&
	     !WILL_FIRE_RL_advance_split_response &&
	     !WILL_FIRE_RL_wci_wslv_ctl_op_complete ;
  ...
  assign MUX_wci_wslv_respF_q_1$write_1__VAL_2 =
	     (wci_wslv_respF_c_r == 2'd2) ?
	       MUX_wci_wslv_respF_q_0$write_1__VAL_1 :
	       34'h0AAAAAAAA ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_1 = { 2'd1, rdat__h31810 } ;
  ...
  assign MUX_wsiM_reqFifo_q_1$write_1__VAL_1 =
	     { (gmac$rx_get[9:8] == 2'd0) ? 17'd20479 : 17'd24577,
	       x_data__h30916,
	       12'd3840 } ;
  ...
  // register mdi_rMDD
  assign mdi_rMDD$D_IN = bs__h12584[mdi_rPlayIndex$Q_OUT[6:0]] ;
  assign mdi_rMDD$EN = WILL_FIRE_RL_mdi_run_frame ;

  // register mdi_rOutEn
  assign mdi_rOutEn$D_IN = bs__h25047[mdi_rPlayIndex$Q_OUT[6:0]] ;
  ...
  // submodule mdi_fResponse
  assign mdi_fResponse$D_IN = { 1'd1, x_data__h28245 } ;
  ...
  assign d0__h12210 = {3{mdi_rWriteData[0]}} ;
  assign d10__h12200 = {3{mdi_rWriteData[10]}} ;
  assign d11__h12199 = {3{mdi_rWriteData[11]}} ;
  assign d12__h12198 = {3{mdi_rWriteData[12]}} ;
  assign d13__h12197 = {3{mdi_rWriteData[13]}} ;
  assign d14__h12196 = {3{mdi_rWriteData[14]}} ;
  assign d15__h12195 = {3{mdi_rWriteData[15]}} ;
  assign d1__h12209 = {3{mdi_rWriteData[1]}} ;
  assign d2__h12208 = {3{mdi_rWriteData[2]}} ;
  assign d3__h12207 = {3{mdi_rWriteData[3]}} ;
  assign d4__h12206 = {3{mdi_rWriteData[4]}} ;
  assign d5__h12205 = {3{mdi_rWriteData[5]}} ;
  assign d6__h12204 = {3{mdi_rWriteData[6]}} ;
  assign d7__h12203 = {3{mdi_rWriteData[7]}} ;
  assign d8__h12202 = {3{mdi_rWriteData[8]}} ;
  assign d9__h12201 = {3{mdi_rWriteData[9]}} ;
  assign pa0__h12187 = {3{mdi_rPhyAddr[0]}} ;
  assign pa1__h12186 = {3{mdi_rPhyAddr[1]}} ;
  assign pa2__h12185 = {3{mdi_rPhyAddr[2]}} ;
  assign pa3__h12184 = {3{mdi_rPhyAddr[3]}} ;
  assign pa4__h12183 = {3{mdi_rPhyAddr[4]}} ;
  assign ra0__h12193 = {3{mdi_rRegAddr[0]}} ;
  assign ra1__h12192 = {3{mdi_rRegAddr[1]}} ;
  assign ra2__h12191 = {3{mdi_rRegAddr[2]}} ;
  assign ra3__h12190 = {3{mdi_rRegAddr[3]}} ;
  assign ra4__h12189 = {3{mdi_rRegAddr[4]}} ;
  assign rdat___1__h32045 =
	     hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat___1__h32086 =
	     hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat___1__h32121 =
	     hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat___1__h32162 =
	     hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat___1__h32197 = hasDebugLogic ? rxCount : 32'd0 ;
  assign rdat___1__h32230 = hasDebugLogic ? txCount : 32'd0 ;
  assign rdat___1__h32264 = hasDebugLogic ? rxOvfCount : 32'd0 ;
  assign rdat___1__h32297 = hasDebugLogic ? txUndCount : 32'd0 ;
  assign rdat__h31810 =
	     wci_wslv_reqF$D_OUT[39] ?
	       32'd0 :
	       IF_wci_wslv_reqF_first__5_BITS_39_TO_32_78_EQ__ETC___d529 ;
  assign status__h31611 = { 16'd0, x__h31891 } ;
  assign wci_wslv_reqF_i_notEmpty__4_AND_IF_wci_wslv_re_ETC___d486 =
	     wci_wslv_reqF$EMPTY_N &&
	     (wci_wslv_reqF$D_OUT[39] ?
		mdi_fRequest$FULL_N :
		wci_wslv_respF_c_r != 2'd2) ;
  assign x__h31891 = { wsiM_statusR, wsiS_statusR } ;
  assign x_data__h28245 =
	     { mdi_vrReadData_15,
	       mdi_vrReadData_14,
	       mdi_vrReadData_13,
	       mdi_vrReadData_12,
	       ...
	       mdi_vrReadData_1,
	       mdi_vrReadData } ;
  assign x_data__h30916 = { 24'd0, gmac$rx_get[7:0] } ;
  always@(wci_wslv_reqF$D_OUT or
	  ...
	  rdat___1__h32162 or
	  rdat___1__h32197 or
	  rdat___1__h32230 or rdat___1__h32264 or rdat___1__h32297)
  begin
    case (wci_wslv_reqF$D_OUT[39:32])
	  ...
	  IF_wci_wslv_reqF_first__5_BITS_39_TO_32_78_EQ__ETC___d529 =
	      rdat___1__h32297;
      default: IF_wci_wslv_reqF_first__5_BITS_39_TO_32_78_EQ__ETC___d529 =
		   32'd0;
    endcase
  end
  ...
  begin
	...
	$display("Error: \"bsv/wrk/GbeWorker.bsv\", line 91, column 60: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_ctrl_IsO] and\n  [RL_wci_ctrl_OrE] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n)
	...
	$display("Error: \"bsv/wrk/GbeWorker.bsv\", line 91, column 26: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_cfwr] and\n  [RL_wci_ctrl_OrE] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n)
	...
	$display("Error: \"bsv/wrk/GbeWorker.bsv\", line 91, column 36: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_cfrd] and\n  [RL_wci_ctrl_OrE] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wci_cfrd && WILL_FIRE_RL_wci_ctrl_IsO)
	$display("Error: \"bsv/wrk/GbeWorker.bsv\", line 91, column 36: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_cfrd] and\n  [RL_wci_ctrl_IsO] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wci_ctrl_EiI && WILL_FIRE_RL_wci_ctrl_OrE)
	$display("Error: \"bsv/wrk/GbeWorker.bsv\", line 91, column 46: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_ctrl_EiI] and\n  [RL_wci_ctrl_OrE] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n)
