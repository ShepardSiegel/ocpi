...
//
// On Tue May  8 16:31:19 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkGbeWorker(CLK_gmii_rx_clk,
  ...
  reg [63 : 0] v__h102041, v__h3630, v__h3804, v__h3948, v__h81772, v__h82061;
  ...
  reg [7 : 0] CASE_13_MINUS_txDCPPos_rxHdr_sV_BITS_63_TO_56__ETC__q6,
	      ...
	      IF_rxDCPMesgPos_16_EQ_5_57_THEN_rxDCPMesg_23_B_ETC___d1130,
	      tag__h72301;
  ...
  reg CASE_IF_rxDCPMesgPos_16_EQ_5_57_THEN_rxDCPMesg_ETC__q4,
      ...
      IF_txDCPPos_55_EQ_0_56_OR_txDCPPos_55_EQ_1_57__ETC___d1254;
  wire [101 : 0] _1448743543117976458853375091858__q10,
		 _643371375338640__q12,
		 bs__h12594,
		 bs__h25057;
  wire [31 : 0] rdat___1__h100270,
		rdat___1__h82280,
		rdat___1__h82331,
		rdat___1__h82372,
		rdat___1__h82407,
		...
		status__h81846,
		x__h72092;
  wire [15 : 0] x__h82126, x__h82284, x_data__h28255;
  wire [4 : 0] IF_txDCPPos_55_EQ_9_73_THEN_0_ELSE_txDCPPos_55_ETC___d1241,
	       txDCPPos_55_PLUS_1___d1175;
  wire [2 : 0] d0__h12220,
	       d10__h12210,
	       d11__h12209,
	       d12__h12208,
  ...
  assign MUX_wci_wslv_respF_q_1$write_1__VAL_1 =
	     (wci_wslv_respF_c_r == 2'd2) ?
	       MUX_wci_wslv_respF_q_0$write_1__VAL_2 :
	       34'h0AAAAAAAA ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_1 = { 2'd1, rdat__h82045 } ;
  ...
  // register rxLenCount
  assign rxLenCount$D_IN = (gmac$rx_get[9:8] == 2'd0) ? x__h72092 : 32'd0 ;
  assign rxLenCount$EN = WILL_FIRE_RL_rx_data ;

  // register rxLenLast
  assign rxLenLast$D_IN = x__h72092 ;
  ...
  assign txDCPPos$D_IN =
	     (!rxHdr_sV[112] && rxHdr_sV[15:0] == 16'hF040) ?
	       ((txDCPPos == 5'd13) ? 5'd0 : txDCPPos_55_PLUS_1___d1175) :
  ...
  // submodule dcp_dcpReqF
  always@(IF_rxDCPMesgPos_16_EQ_5_57_THEN_rxDCPMesg_23_B_ETC___d1130 or
	  tag__h72301 or rxDCPMesg)
  begin
    case (IF_rxDCPMesgPos_16_EQ_5_57_THEN_rxDCPMesg_23_B_ETC___d1130[7:4])
      4'd0:
	  dcp_dcpReqF$D_IN = { 38'h0AAAAAAAAA, tag__h72301, rxDCPMesg[31:0] };
      4'd1:
	  dcp_dcpReqF$D_IN =
	      { 2'd1,
		IF_rxDCPMesgPos_16_EQ_5_57_THEN_rxDCPMesg_23_B_ETC___d1130[3:0],
		tag__h72301,
		rxDCPMesg[31:0],
		rxDCPMesg[63:32] };
  ...
  assign dcp_dcpReqF$ENQ =
	     WILL_FIRE_RL_rx_dcp &&
	     (IF_rxDCPMesgPos_16_EQ_5_57_THEN_rxDCPMesg_23_B_ETC___d1130[7:4] ==
	      4'd0 ||
	      IF_rxDCPMesgPos_16_EQ_5_57_THEN_rxDCPMesg_23_B_ETC___d1130[7:4] ==
	      4'd1 ||
	      IF_rxDCPMesgPos_16_EQ_5_57_THEN_rxDCPMesg_23_B_ETC___d1130[7:4] ==
  ...
  assign IF_rxHdr_pos_15_EQ_0_31_THEN_rxHdr_sV_97_BITS__ETC___d600 =
	     CASE_rxHdr_pos_rxHdr_sV_BITS_111_TO_104_0_rxHd_ETC__q1 ==
	     CASE_rxHdr_pos_rxHdr_pV_BITS_111_TO_104_0_rxHd_ETC__q2 ;
  assign IF_txDCPPos_55_EQ_9_73_THEN_0_ELSE_txDCPPos_55_ETC___d1241 =
	     (txDCPPos == 5'd9) ? 5'd0 : txDCPPos_55_PLUS_1___d1175 ;
  ...
  assign rdat___1__h100270 = hasDebugLogic ? rxHeadCap[31:0] : 32'd0 ;
  assign rdat___1__h82280 = hasDebugLogic ? { 16'd0, x__h82284 } : 32'd0 ;
  assign rdat___1__h82331 =
	     hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat___1__h82372 =
	     hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat___1__h82407 =
	     hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat___1__h82440 =
	     hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat___1__h82481 =
	     hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat___1__h82516 = hasDebugLogic ? txDBGCnt : 32'd0 ;
  assign rdat___1__h82550 = hasDebugLogic ? rxCount : 32'd0 ;
  assign rdat___1__h82583 = hasDebugLogic ? txCount : 32'd0 ;
  assign rdat___1__h82617 = hasDebugLogic ? rxOvfCount : 32'd0 ;
  assign rdat___1__h82650 = hasDebugLogic ? txUndCount : 32'd0 ;
  assign rdat___1__h82683 = hasDebugLogic ? rxValidNoEOPC : 32'd0 ;
  assign rdat___1__h82716 = hasDebugLogic ? rxValidEOPC : 32'd0 ;
  assign rdat___1__h82749 = hasDebugLogic ? rxEmptyEOPC : 32'd0 ;
  assign rdat___1__h82782 = hasDebugLogic ? rxAbortEOPC : 32'd0 ;
  assign rdat___1__h82815 = hasDebugLogic ? rxDCPCnt : 32'd0 ;
  assign rdat___1__h82849 = hasDebugLogic ? rxHdrMatchCnt : 32'd0 ;
  assign rdat___1__h82882 = hasDebugLogic ? rxLenLast : 32'd0 ;
  assign rdat___1__h82916 = hasDebugLogic ? txDCPCnt : 32'd0 ;
  assign rdat___1__h82950 = hasDebugLogic ? { 28'd0, rxHdr_pos } : 32'd0 ;
  assign rdat___1__h82987 = hasDebugLogic ? { 28'd0, rxHdr_mCnt } : 32'd0 ;
  assign rdat___1__h83024 =
	     hasDebugLogic ? { 16'd0, rxHdr_sV[111:96] } : 32'd0 ;
  assign rdat___1__h85525 = hasDebugLogic ? rxHdr_sV[95:64] : 32'd0 ;
  assign rdat___1__h88023 =
	     hasDebugLogic ? { 16'd0, rxHdr_sV[63:48] } : 32'd0 ;
  assign rdat___1__h90524 = hasDebugLogic ? rxHdr_sV[47:16] : 32'd0 ;
  assign rdat___1__h93022 =
	     hasDebugLogic ? { 16'd0, rxHdr_sV[15:0] } : 32'd0 ;
  assign rdat___1__h95523 = hasDebugLogic ? rxHeadCap[127:96] : 32'd0 ;
  assign rdat___1__h97130 = hasDebugLogic ? rxHeadCap[95:64] : 32'd0 ;
  assign rdat___1__h98700 = hasDebugLogic ? rxHeadCap[63:32] : 32'd0 ;
  assign rdat__h82045 =
	     wci_wslv_reqF$D_OUT[39] ?
	       32'd0 :
  ...
  assign status__h81846 = { 16'd0, x__h82126 } ;
  assign txDCPPos_55_PLUS_1___d1175 = txDCPPos + 5'd1 ;
  assign wci_wslv_reqF_i_notEmpty__4_AND_IF_wci_wslv_re_ETC___d924 =
	     wci_wslv_reqF$EMPTY_N &&
	     (wci_wslv_reqF$D_OUT[39] ?
		mdi_fRequest$FULL_N :
		wci_wslv_respF_c_r != 2'd2) ;
  assign x__h72092 = rxLenCount + 32'd1 ;
  assign x__h82126 = { wsiM_statusR, wsiS_statusR } ;
  assign x__h82284 = { wsiS_statusR, wsiM_statusR } ;
  ...
  begin
    case (rxDCPMesgPos)
      5'd6: tag__h72301 = rxDCPMesg[7:0];
      5'd7: tag__h72301 = rxDCPMesg[15:8];
      5'd8: tag__h72301 = rxDCPMesg[23:16];
      5'd9: tag__h72301 = rxDCPMesg[31:24];
      5'd10: tag__h72301 = rxDCPMesg[39:32];
      5'd11: tag__h72301 = rxDCPMesg[47:40];
      5'd12: tag__h72301 = rxDCPMesg[55:48];
      5'd13: tag__h72301 = rxDCPMesg[63:56];
      5'd14: tag__h72301 = rxDCPMesg[71:64];
      5'd15: tag__h72301 = rxDCPMesg[79:72];
      5'd16: tag__h72301 = rxDCPMesg[87:80];
      5'd17: tag__h72301 = rxDCPMesg[95:88];
      5'd18: tag__h72301 = rxDCPMesg[103:96];
      default: tag__h72301 = rxDCPMesg[111:104];
    endcase
  end
  ...
  begin
    case (txDCPPos)
	  ...
	  IF_txDCPPos_55_EQ_0_56_OR_txDCPPos_55_EQ_1_57__ETC___d1254 =
	      gmac$RDY_tx_put;
      default: IF_txDCPPos_55_EQ_0_56_OR_txDCPPos_55_EQ_1_57__ETC___d1254 =
		   txDCPPos != 5'd9 || gmac$RDY_tx_put;
    endcase
  end
  always@(dcpRespF$D_OUT or
	  IF_txDCPPos_55_EQ_0_56_OR_txDCPPos_55_EQ_1_57__ETC___d1254 or
  ...
  begin
    case (rxDCPMesgPos)
	  ...
	  IF_rxDCPMesgPos_16_EQ_5_57_THEN_rxDCPMesg_23_B_ETC___d1130 =
	      rxDCPMesg[103:96];
      default: IF_rxDCPMesgPos_16_EQ_5_57_THEN_rxDCPMesg_23_B_ETC___d1130 =
		   rxDCPMesg[111:104];
    endcase
  end
  always@(IF_rxDCPMesgPos_16_EQ_5_57_THEN_rxDCPMesg_23_B_ETC___d1130 or
  ...
  always@(wci_wslv_reqF$D_OUT or
	  ...
	  rdat___1__h93022 or
	  rdat___1__h95523 or
	  rdat___1__h97130 or rdat___1__h98700 or rdat___1__h100270)
  begin
  ...
  always@(dcpRespF$D_OUT or
	  IF_txDCPPos_55_EQ_9_73_THEN_0_ELSE_txDCPPos_55_ETC___d1241 or
	  txDCPPos or txDCPPos_55_PLUS_1___d1175)
  begin
    case (dcpRespF$D_OUT[43:42])
      2'd0:
	  CASE_dcpRespFD_OUT_BITS_43_TO_42_IF_txDCPPos__ETC__q11 =
	      IF_txDCPPos_55_EQ_9_73_THEN_0_ELSE_txDCPPos_55_ETC___d1241;
      2'd1:
	  CASE_dcpRespFD_OUT_BITS_43_TO_42_IF_txDCPPos__ETC__q11 =
	      (txDCPPos == 5'd5) ? 5'd0 : txDCPPos_55_PLUS_1___d1175;
