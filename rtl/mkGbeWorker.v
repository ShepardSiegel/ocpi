...
//
// On Wed Jan 11 14:26:42 EST 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkGbeWorker(CLK_gmii_rx_clk,
  ...
  wire [31 : 0] IF_emac_rx_buffer_rRdPackets_rsCounter_99_BIT__ETC___d1576,
		IF_emac_rx_buffer_rRdPackets_rsCounter_99_BIT__ETC___d1577,
		IF_emac_rx_buffer_rWrPackets_rsCounter_69_BIT__ETC___d1571,
		IF_emac_rx_buffer_rWrPackets_rsCounter_69_BIT__ETC___d1572,
		IF_emac_tx_buffer_rRdPackets_rsCounter_069_BIT_ETC___d1586,
		IF_emac_tx_buffer_rRdPackets_rsCounter_069_BIT_ETC___d1587,
		IF_emac_tx_buffer_rWrPackets_rsCounter_52_BIT__ETC___d1581,
		IF_emac_tx_buffer_rWrPackets_rsCounter_52_BIT__ETC___d1582,
		status__h39242,
		x_data__h38664;
  wire [15 : 0] x__h39388;
  ...
  wire IF_emac_rx_buffer_fifoDeq_rw_enq_whas__86_THEN_ETC___d1329,
       IF_emac_tx_buffer_fifoEnq_rw_enq_whas__40_THEN_ETC___d1578,
       IF_emac_tx_buffer_fifoEnq_rw_enq_whas__40_THEN_ETC___d1579,
  ...
  assign MUX_emac_rx_buffer_rRdPackets_rsCounter$write_1__VAL_1 =
	     (~emac_rx_buffer_rRdPackets_rsCounter[IF_emac_rx_buffer_rRdPackets_rsCounter_99_BIT__ETC___d1577[2:0]]) ?
  ...
  assign MUX_emac_rx_buffer_rWrPackets_rsCounter$write_1__VAL_1 =
	     (~emac_rx_buffer_rWrPackets_rsCounter[IF_emac_rx_buffer_rWrPackets_rsCounter_69_BIT__ETC___d1572[2:0]]) ?
  ...
  assign MUX_emac_tx_buffer_rRdPackets_rsCounter$write_1__VAL_1 =
	     (~emac_tx_buffer_rRdPackets_rsCounter[IF_emac_tx_buffer_rRdPackets_rsCounter_069_BIT_ETC___d1587[2:0]]) ?
  ...
  assign MUX_emac_tx_buffer_rWrPackets_rsCounter$write_1__VAL_1 =
	     (~emac_tx_buffer_rWrPackets_rsCounter[IF_emac_tx_buffer_rWrPackets_rsCounter_52_BIT__ETC___d1582[2:0]]) ?
  ...
  assign MUX_wsiM_reqFifo_q_0$write_1__VAL_1 =
	     { 3'd1,
	       IF_emac_rx_buffer_fifoDeq_rw_enq_whas__86_THEN_ETC___d1329,
	       1'd0,
  ...
  // remaining internal signals
  assign IF_emac_rx_buffer_fifoDeq_rw_enq_whas__86_THEN_ETC___d1329 =
	     WILL_FIRE_RL_emac_rx_buffer_dequeue_next_beat ?
			   ...
			   (emac_rx_buffer_rRdPackets_rsCounter[4] ?
				 ...
				 (emac_rx_buffer_rRdPackets_rsCounter[6] ?
				    ...
				    (emac_rx_buffer_rRdPackets_rsCounter[7] ?
				       ...
				       32'd9)))))))) :
	       32'd7 ;
  assign IF_emac_rx_buffer_rRdPackets_rsCounter_99_BIT__ETC___d1577 =
	     emac_rx_buffer_rRdPackets_rsCounter_99_BIT_0_0_ETC___d1493 ?
			   ...
			   (emac_rx_buffer_rWrPackets_rsCounter[4] ?
				 ...
				 (emac_rx_buffer_rWrPackets_rsCounter[6] ?
				    ...
				    (emac_rx_buffer_rWrPackets_rsCounter[7] ?
				       ...
				       32'd9)))))))) :
	       32'd7 ;
  assign IF_emac_rx_buffer_rWrPackets_rsCounter_69_BIT__ETC___d1572 =
	     emac_rx_buffer_rWrPackets_rsCounter_69_BIT_0_7_ETC___d1492 ?
	       IF_emac_rx_buffer_rWrPackets_rsCounter_69_BIT__ETC___d1571 :
	       32'd0 ;
  assign IF_emac_tx_buffer_fifoEnq_rw_enq_whas__40_THEN_ETC___d1578 =
	     MUX_wsiS_reqFifo_levelsValid$write_1__SEL_3 ?
	       ...
	       emac_tx_buffer_fifoEnq_taggedReg[10] &&
	       emac_tx_buffer_fifoEnq_taggedReg[9:8] == 2'd0 ;
  assign IF_emac_tx_buffer_fifoEnq_rw_enq_whas__40_THEN_ETC___d1579 =
	     MUX_wsiS_reqFifo_levelsValid$write_1__SEL_3 ?
	       emac_tx_buffer_fifoEnq_rw_enq$wget[9:8] == 2'd1 :
	       emac_tx_buffer_fifoEnq_taggedReg[10] &&
	       emac_tx_buffer_fifoEnq_taggedReg[9:8] == 2'd1 ;
			   ...
			   (emac_tx_buffer_rRdPackets_rsCounter[4] ?
				 ...
				 (emac_tx_buffer_rRdPackets_rsCounter[6] ?
				    ...
				    (emac_tx_buffer_rRdPackets_rsCounter[7] ?
				       ...
				       32'd9)))))))) :
	       32'd7 ;
  assign IF_emac_tx_buffer_rRdPackets_rsCounter_069_BIT_ETC___d1587 =
	     emac_tx_buffer_rRdPackets_rsCounter_069_BIT_0__ETC___d1495 ?
	       IF_emac_tx_buffer_rRdPackets_rsCounter_069_BIT_ETC___d1586 :
	       32'd0 ;
			   ...
			   (emac_tx_buffer_rWrPackets_rsCounter[4] ?
				 ...
				 (emac_tx_buffer_rWrPackets_rsCounter[6] ?
				    ...
				    (emac_tx_buffer_rWrPackets_rsCounter[7] ?
				       ...
				       32'd9)))))))) :
	       32'd7 ;
  assign IF_emac_tx_buffer_rWrPackets_rsCounter_52_BIT__ETC___d1582 =
	     emac_tx_buffer_rWrPackets_rsCounter_52_BIT_0_5_ETC___d1494 ?
	       IF_emac_tx_buffer_rWrPackets_rsCounter_52_BIT__ETC___d1581 :
	       32'd0 ;
