...
//
// On Wed Jul 20 13:58:11 EDT 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkGbeWorker(CLK_gmii_rx_clk,
  ...
  wire [31 : 0] IF_emac_rx_buffer_rRdPackets_rsCounter_02_BIT__ETC___d1560,
		IF_emac_rx_buffer_rRdPackets_rsCounter_02_BIT__ETC___d1561,
		IF_emac_rx_buffer_rWrPackets_rsCounter_72_BIT__ETC___d1553,
		IF_emac_rx_buffer_rWrPackets_rsCounter_72_BIT__ETC___d1554,
		IF_emac_tx_buffer_rRdPackets_rsCounter_072_BIT_ETC___d1573,
		IF_emac_tx_buffer_rRdPackets_rsCounter_072_BIT_ETC___d1574,
		IF_emac_tx_buffer_rWrPackets_rsCounter_55_BIT__ETC___d1566,
		IF_emac_tx_buffer_rWrPackets_rsCounter_55_BIT__ETC___d1567,
		status__h39044,
		x_data__h38466;
  wire [15 : 0] x__h39190;
  wire [11 : 0] x_burstLength__h38465;
  wire [7 : 0] x__h16932,
	       x__h23529,
	       x__h27715,
	       x__h34466,
  ...
  wire [1 : 0] ab__h21657, ab__h32392;
  wire IF_emac_rx_buffer_fifoDeq_rw_enq_whas__89_THEN_ETC___d1335,
       IF_emac_tx_buffer_fifoEnq_rw_enq_whas__43_THEN_ETC___d1563,
       IF_emac_tx_buffer_fifoEnq_rw_enq_whas__43_THEN_ETC___d1564,
       ...
       emac_rx_buffer_rWrPackets_rsCounter_72_BIT_0_7_ETC___d1339,
  ...
  assign MUX_emac_rx_buffer_rRdPackets_rsCounter$write_1__VAL_1 =
	     (~emac_rx_buffer_rRdPackets_rsCounter[IF_emac_rx_buffer_rRdPackets_rsCounter_02_BIT__ETC___d1561[2:0]]) ?
	       emac_rx_buffer_rRdPackets_rsCounter | x__h23529 :
	       emac_rx_buffer_rRdPackets_rsCounter & y__h24194 ;
  ...
  assign MUX_emac_rx_buffer_rWrPackets_rsCounter$write_1__VAL_1 =
	     (~emac_rx_buffer_rWrPackets_rsCounter[IF_emac_rx_buffer_rWrPackets_rsCounter_72_BIT__ETC___d1554[2:0]]) ?
	       emac_rx_buffer_rWrPackets_rsCounter | x__h16932 :
	       emac_rx_buffer_rWrPackets_rsCounter & y__h17597 ;
  ...
  assign MUX_emac_tx_buffer_rRdPackets_rsCounter$write_1__VAL_1 =
	     (~emac_tx_buffer_rRdPackets_rsCounter[IF_emac_tx_buffer_rRdPackets_rsCounter_072_BIT_ETC___d1574[2:0]]) ?
	       emac_tx_buffer_rRdPackets_rsCounter | x__h34466 :
	       emac_tx_buffer_rRdPackets_rsCounter & y__h35131 ;
  ...
  assign MUX_emac_tx_buffer_rWrPackets_rsCounter$write_1__VAL_1 =
	     (~emac_tx_buffer_rWrPackets_rsCounter[IF_emac_tx_buffer_rWrPackets_rsCounter_55_BIT__ETC___d1567[2:0]]) ?
	       emac_tx_buffer_rWrPackets_rsCounter | x__h27715 :
	       emac_tx_buffer_rWrPackets_rsCounter & y__h28380 ;
  ...
  assign MUX_wsiM_reqFifo_q_0$write_1__VAL_1 =
	     { 3'd1,
	       IF_emac_rx_buffer_fifoDeq_rw_enq_whas__89_THEN_ETC___d1335,
	       1'd0,
	       x_burstLength__h38465,
	       x_data__h38466,
	       12'd3840 } ;
  ...
  assign emac_rx_buffer_memBuffer_serverAdapterB_s1_1$wget =
	     { 1'd1, !ab__h21657[1] || ab__h21657[0] } ;
  ...
  assign emac_tx_buffer_memBuffer_serverAdapterB_s1_1$wget =
	     { 1'd1, !ab__h32392[1] || ab__h32392[0] } ;
  ...
  // remaining internal signals
  assign IF_emac_rx_buffer_fifoDeq_rw_enq_whas__89_THEN_ETC___d1335 =
	     WILL_FIRE_RL_emac_rx_buffer_dequeue_next_beat ?
  ...
  assign IF_emac_rx_buffer_rRdPackets_rsCounter_02_BIT__ETC___d1560 =
			   ...
			   (emac_rx_buffer_rRdPackets_rsCounter[4] ?
				 ...
				 (emac_rx_buffer_rRdPackets_rsCounter[6] ?
				    ...
				    (emac_rx_buffer_rRdPackets_rsCounter[7] ?
				       ...
				       32'd9)))))))) :
	       32'd7 ;
  assign IF_emac_rx_buffer_rRdPackets_rsCounter_02_BIT__ETC___d1561 =
	     emac_rx_buffer_rRdPackets_rsCounter_02_BIT_0_0_ETC___d1497 ?
	       IF_emac_rx_buffer_rRdPackets_rsCounter_02_BIT__ETC___d1560 :
	       32'd0 ;
  assign IF_emac_rx_buffer_rWrPackets_rsCounter_72_BIT__ETC___d1553 =
			   ...
			   (emac_rx_buffer_rWrPackets_rsCounter[4] ?
				 ...
				 (emac_rx_buffer_rWrPackets_rsCounter[6] ?
				    ...
				    (emac_rx_buffer_rWrPackets_rsCounter[7] ?
				       ...
				       32'd9)))))))) :
	       32'd7 ;
  assign IF_emac_rx_buffer_rWrPackets_rsCounter_72_BIT__ETC___d1554 =
	     emac_rx_buffer_rWrPackets_rsCounter_72_BIT_0_7_ETC___d1339 ?
	       IF_emac_rx_buffer_rWrPackets_rsCounter_72_BIT__ETC___d1553 :
	       32'd0 ;
  assign IF_emac_tx_buffer_fifoEnq_rw_enq_whas__43_THEN_ETC___d1563 =
	     MUX_wsiS_reqFifo_levelsValid$write_1__SEL_2 ?
	       emac_tx_buffer_fifoEnq_rw_enq$wget[9:8] == 2'd0 :
	       emac_tx_buffer_fifoEnq_taggedReg[10] &&
	       emac_tx_buffer_fifoEnq_taggedReg[9:8] == 2'd0 ;
  assign IF_emac_tx_buffer_fifoEnq_rw_enq_whas__43_THEN_ETC___d1564 =
	     MUX_wsiS_reqFifo_levelsValid$write_1__SEL_2 ?
	       emac_tx_buffer_fifoEnq_rw_enq$wget[9:8] == 2'd1 :
	       emac_tx_buffer_fifoEnq_taggedReg[10] &&
	       emac_tx_buffer_fifoEnq_taggedReg[9:8] == 2'd1 ;
  assign IF_emac_tx_buffer_rRdPackets_rsCounter_072_BIT_ETC___d1573 =
			   ...
			   (emac_tx_buffer_rRdPackets_rsCounter[4] ?
				 ...
				 (emac_tx_buffer_rRdPackets_rsCounter[6] ?
				    ...
				    (emac_tx_buffer_rRdPackets_rsCounter[7] ?
				       ...
				       32'd9)))))))) :
	       32'd7 ;
  assign IF_emac_tx_buffer_rRdPackets_rsCounter_072_BIT_ETC___d1574 =
	     emac_tx_buffer_rRdPackets_rsCounter_072_BIT_0__ETC___d1499 ?
	       IF_emac_tx_buffer_rRdPackets_rsCounter_072_BIT_ETC___d1573 :
	       32'd0 ;
  assign IF_emac_tx_buffer_rWrPackets_rsCounter_55_BIT__ETC___d1566 =
			   ...
			   (emac_tx_buffer_rWrPackets_rsCounter[4] ?
				 ...
				 (emac_tx_buffer_rWrPackets_rsCounter[6] ?
				    ...
				    (emac_tx_buffer_rWrPackets_rsCounter[7] ?
				       ...
				       32'd9)))))))) :
	       32'd7 ;
  assign IF_emac_tx_buffer_rWrPackets_rsCounter_55_BIT__ETC___d1567 =
	     emac_tx_buffer_rWrPackets_rsCounter_55_BIT_0_6_ETC___d1498 ?
	       IF_emac_tx_buffer_rWrPackets_rsCounter_55_BIT__ETC___d1566 :
	       32'd0 ;
  assign ab__h21657 = 2'd0 ;
  assign ab__h32392 = 2'd0 ;
  ...
  assign emac_rx_buffer_rRdPackets_rsCounter_02_BIT_0_0_ETC___d1497 =
	     z__h23584 ^ emac_rx_buffer_rRdPackets_rsCounter[7] ;
  assign emac_rx_buffer_rWrPackets_rsCounter_72_BIT_0_7_ETC___d1339 =
	     z__h16987 ^ emac_rx_buffer_rWrPackets_rsCounter[7] ;
  ...
  assign emac_tx_buffer_rRdPackets_rsCounter_072_BIT_0__ETC___d1499 =
	     z__h34521 ^ emac_tx_buffer_rRdPackets_rsCounter[7] ;
  assign emac_tx_buffer_rWrPackets_rsCounter_55_BIT_0_6_ETC___d1498 =
	     z__h27770 ^ emac_tx_buffer_rWrPackets_rsCounter[7] ;
  assign status__h39044 = { 16'd0, x__h39190 } ;
  ...
  assign x__h39190 = { wsiM_statusR, wsiS_statusR } ;
  assign x_burstLength__h38465 =
	     IF_emac_rx_buffer_fifoDeq_rw_enq_whas__89_THEN_ETC___d1335 ?
	       12'd1 :
	       12'd4095 ;
  assign x_data__h38466 = { 24'd0, x__h38530 } ;
  assign y__h17597 = ~x__h16932 ;
  assign y__h24194 = ~x__h23529 ;
  assign y__h28380 = ~x__h27715 ;
  assign y__h35131 = ~x__h34466 ;
  assign z__h16952 =
	     emac_rx_buffer_rWrPackets_rsCounter[0] ^
	     emac_rx_buffer_rWrPackets_rsCounter[1] ;
  assign z__h16959 = z__h16952 ^ emac_rx_buffer_rWrPackets_rsCounter[2] ;
  assign z__h16966 = z__h16959 ^ emac_rx_buffer_rWrPackets_rsCounter[3] ;
  assign z__h16973 = z__h16966 ^ emac_rx_buffer_rWrPackets_rsCounter[4] ;
  assign z__h16980 = z__h16973 ^ emac_rx_buffer_rWrPackets_rsCounter[5] ;
  assign z__h16987 = z__h16980 ^ emac_rx_buffer_rWrPackets_rsCounter[6] ;
  assign z__h23549 =
	     emac_rx_buffer_rRdPackets_rsCounter[0] ^
	     emac_rx_buffer_rRdPackets_rsCounter[1] ;
  assign z__h23556 = z__h23549 ^ emac_rx_buffer_rRdPackets_rsCounter[2] ;
  assign z__h23563 = z__h23556 ^ emac_rx_buffer_rRdPackets_rsCounter[3] ;
  assign z__h23570 = z__h23563 ^ emac_rx_buffer_rRdPackets_rsCounter[4] ;
  assign z__h23577 = z__h23570 ^ emac_rx_buffer_rRdPackets_rsCounter[5] ;
  assign z__h23584 = z__h23577 ^ emac_rx_buffer_rRdPackets_rsCounter[6] ;
  assign z__h27735 =
	     emac_tx_buffer_rWrPackets_rsCounter[0] ^
	     emac_tx_buffer_rWrPackets_rsCounter[1] ;
  assign z__h27742 = z__h27735 ^ emac_tx_buffer_rWrPackets_rsCounter[2] ;
  assign z__h27749 = z__h27742 ^ emac_tx_buffer_rWrPackets_rsCounter[3] ;
  assign z__h27756 = z__h27749 ^ emac_tx_buffer_rWrPackets_rsCounter[4] ;
  assign z__h27763 = z__h27756 ^ emac_tx_buffer_rWrPackets_rsCounter[5] ;
  assign z__h27770 = z__h27763 ^ emac_tx_buffer_rWrPackets_rsCounter[6] ;
  assign z__h34486 =
	     emac_tx_buffer_rRdPackets_rsCounter[0] ^
	     emac_tx_buffer_rRdPackets_rsCounter[1] ;
  assign z__h34493 = z__h34486 ^ emac_tx_buffer_rRdPackets_rsCounter[2] ;
  assign z__h34500 = z__h34493 ^ emac_tx_buffer_rRdPackets_rsCounter[3] ;
  assign z__h34507 = z__h34500 ^ emac_tx_buffer_rRdPackets_rsCounter[4] ;
  assign z__h34514 = z__h34507 ^ emac_tx_buffer_rRdPackets_rsCounter[5] ;
  assign z__h34521 = z__h34514 ^ emac_tx_buffer_rRdPackets_rsCounter[6] ;
  ...
  begin
    case (wciRx_wslv_reqF$D_OUT[39:32])
      8'h0: _theResult____h39109 = status__h39044;
      8'h04: _theResult____h39109 = gbeControl;
      8'h10: _theResult____h39109 = wsiM_extStatusW$wget[95:64];
      8'h14: _theResult____h39109 = wsiM_extStatusW$wget[63:32];
      8'h18: _theResult____h39109 = wsiS_extStatusW$wget[95:64];
      8'h1C: _theResult____h39109 = wsiS_extStatusW$wget[63:32];
      default: _theResult____h39109 = 32'd0;
    endcase
  end
