...
//
// On Thu Oct 28 11:07:39 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkGbeWorker(CLK_gmii_rx_clk,
  ...
  wire [31 : 0] IF_emac_rx_buffer_rRdPackets_rsCounter_21_BIT__ETC___d1510,
		IF_emac_rx_buffer_rWrPackets_rsCounter_03_BIT__ETC___d1505,
		IF_emac_tx_buffer_rRdPackets_rsCounter_74_BIT__ETC___d1519,
		IF_emac_tx_buffer_rWrPackets_rsCounter_35_BIT__ETC___d1514,
		status__h35998,
		x__h16739,
		x__h23058,
		x__h26959,
		...
		x_data__h36946;
  wire [15 : 0] x__h36147;
  wire [11 : 0] x_burstLength__h36945;
  wire [7 : 0] x__h16203,
	       x__h22522,
	       x__h26423,
	       x__h32890,
  ...
  wire [1 : 0] ab__h20181, ab__h30348;
  wire IF_emac_rx_buffer_fifoDeq_rw_enq_whas__2_THEN__ETC___d1291,
       IF_emac_tx_buffer_fifoEnq_rw_enq_whas__81_THEN_ETC___d1512,
       IF_emac_tx_buffer_fifoEnq_rw_enq_whas__81_THEN_ETC___d1513,
       ...
       emac_rx_buffer_rRdPackets_rsCounter_21_BIT_0_8_ETC___d1452,
       emac_rx_buffer_rWrPackets_rsCounter_03_BIT_0_0_ETC___d1451,
       ...
       emac_tx_buffer_rRdPackets_rsCounter_74_BIT_0_2_ETC___d1454,
       emac_tx_buffer_rWrPackets_rsCounter_35_BIT_0_3_ETC___d1453,
  ...
  assign MUX_emac_rx_buffer_rRdPackets_rsCounter$write_1__VAL_2 =
	     (~emac_rx_buffer_rRdPackets_rsCounter[x__h23058[2:0]]) ?
	       emac_rx_buffer_rRdPackets_rsCounter | x__h22522 :
	       emac_rx_buffer_rRdPackets_rsCounter & y__h23086 ;
  ...
  assign MUX_emac_rx_buffer_rWrPackets_rsCounter$write_1__VAL_2 =
	     (~emac_rx_buffer_rWrPackets_rsCounter[x__h16739[2:0]]) ?
	       emac_rx_buffer_rWrPackets_rsCounter | x__h16203 :
	       emac_rx_buffer_rWrPackets_rsCounter & y__h16767 ;
  ...
  assign MUX_emac_tx_buffer_rRdPackets_rsCounter$write_1__VAL_2 =
	     (~emac_tx_buffer_rRdPackets_rsCounter[x__h33426[2:0]]) ?
	       emac_tx_buffer_rRdPackets_rsCounter | x__h32890 :
	       emac_tx_buffer_rRdPackets_rsCounter & y__h33454 ;
  ...
  assign MUX_emac_tx_buffer_rWrPackets_rsCounter$write_1__VAL_2 =
	     (~emac_tx_buffer_rWrPackets_rsCounter[x__h26959[2:0]]) ?
	       emac_tx_buffer_rWrPackets_rsCounter | x__h26423 :
	       emac_tx_buffer_rWrPackets_rsCounter & y__h26987 ;
  ...
  assign MUX_wsiM_reqFifo_q_0$write_1__VAL_2 =
	     { 3'd1,
	       IF_emac_rx_buffer_fifoDeq_rw_enq_whas__2_THEN__ETC___d1291,
	       1'd0,
	       x_burstLength__h36945,
	       x_data__h36946,
	       12'd3840 } ;
  ...
  assign emac_rx_buffer_memBuffer_serverAdapterB_s1_1$wget =
	     { 1'd1, !ab__h20181[1] || ab__h20181[0] } ;
  ...
  assign emac_tx_buffer_memBuffer_serverAdapterB_s1_1$wget =
	     { 1'd1, !ab__h30348[1] || ab__h30348[0] } ;
  ...
  // remaining internal signals
  assign IF_emac_rx_buffer_fifoDeq_rw_enq_whas__2_THEN__ETC___d1291 =
	     CAN_FIRE_RL_emac_rx_buffer_dequeue_next_beat ?
  ...
  assign IF_emac_rx_buffer_rRdPackets_rsCounter_21_BIT__ETC___d1510 =
			   ...
			   (emac_rx_buffer_rRdPackets_rsCounter[4] ?
				 ...
				 (emac_rx_buffer_rRdPackets_rsCounter[6] ?
				    ...
				    (emac_rx_buffer_rRdPackets_rsCounter[7] ?
				       ...
				       32'd9)))))))) :
	       32'd7 ;
  assign IF_emac_rx_buffer_rWrPackets_rsCounter_03_BIT__ETC___d1505 =
			   ...
			   (emac_rx_buffer_rWrPackets_rsCounter[4] ?
				 ...
				 (emac_rx_buffer_rWrPackets_rsCounter[6] ?
				    ...
				    (emac_rx_buffer_rWrPackets_rsCounter[7] ?
				       ...
				       32'd9)))))))) :
	       32'd7 ;
  assign IF_emac_tx_buffer_fifoEnq_rw_enq_whas__81_THEN_ETC___d1512 =
	     CAN_FIRE_RL_tx_data ?
	       emac_tx_buffer_fifoEnq_rw_enq$wget[9:8] == 2'd0 :
	       emac_tx_buffer_fifoEnq_taggedReg[10] &&
	       emac_tx_buffer_fifoEnq_taggedReg[9:8] == 2'd0 ;
  assign IF_emac_tx_buffer_fifoEnq_rw_enq_whas__81_THEN_ETC___d1513 =
	     CAN_FIRE_RL_tx_data ?
	       emac_tx_buffer_fifoEnq_rw_enq$wget[9:8] == 2'd1 :
	       emac_tx_buffer_fifoEnq_taggedReg[10] &&
	       emac_tx_buffer_fifoEnq_taggedReg[9:8] == 2'd1 ;
  assign IF_emac_tx_buffer_rRdPackets_rsCounter_74_BIT__ETC___d1519 =
			   ...
			   (emac_tx_buffer_rRdPackets_rsCounter[4] ?
				 ...
				 (emac_tx_buffer_rRdPackets_rsCounter[6] ?
				    ...
				    (emac_tx_buffer_rRdPackets_rsCounter[7] ?
				       ...
				       32'd9)))))))) :
	       32'd7 ;
  assign IF_emac_tx_buffer_rWrPackets_rsCounter_35_BIT__ETC___d1514 =
			   ...
			   (emac_tx_buffer_rWrPackets_rsCounter[4] ?
				 ...
				 (emac_tx_buffer_rWrPackets_rsCounter[6] ?
				    ...
				    (emac_tx_buffer_rWrPackets_rsCounter[7] ?
				       ...
				       32'd9)))))))) :
	       32'd7 ;
  assign ab__h20181 = 2'd0 ;
  assign ab__h30348 = 2'd0 ;
  ...
  assign emac_rx_buffer_memBuffer_serverAdapterB_outDat_ETC___d510 =
	     ...
	     (emac_rx_buffer_memBuffer_serverAdapterB_outData_outData$wget[9:8] !=
	      ...
	      2'd1 ||
	      emac_rx_buffer_memBuffer_serverAdapterB_cnt_06_ETC___d507) ;
  assign emac_rx_buffer_rRdPackets_rsCounter_21_BIT_0_8_ETC___d1452 =
	     z__h21988 ^ emac_rx_buffer_rRdPackets_rsCounter[7] ;
  assign emac_rx_buffer_rWrPackets_rsCounter_03_BIT_0_0_ETC___d1451 =
	     z__h15669 ^ emac_rx_buffer_rWrPackets_rsCounter[7] ;
  ...
  assign emac_tx_buffer_memBuffer_serverAdapterB_outDat_ETC___d151 =
	     ...
	     (emac_tx_buffer_memBuffer_serverAdapterB_outData_outData$wget[9:8] !=
	      2'd1 ||
	      emac_tx_buffer_memBuffer_serverAdapterB_cnt_47_ETC___d148) ;
  assign emac_tx_buffer_rRdPackets_rsCounter_74_BIT_0_2_ETC___d1454 =
	     z__h32356 ^ emac_tx_buffer_rRdPackets_rsCounter[7] ;
  assign emac_tx_buffer_rWrPackets_rsCounter_35_BIT_0_3_ETC___d1453 =
	     z__h25889 ^ emac_tx_buffer_rWrPackets_rsCounter[7] ;
  assign status__h35998 = { 16'd0, x__h36147 } ;
  assign wsiS_reqFifo_notFull__82_AND_wsiS_burstKind_62_ETC___d902 =
	     wsiS_reqFifo$FULL_N &&
	     (wsiS_burstKind == 2'd0 ||
	      (wsiS_burstKind == 2'd1 || wsiS_burstKind == 2'd2) &&
	      wsiS_wsiReq$wget[57]) ;
  assign x__h16203 = 8'd1 << x__h16739 ;
  assign x__h16739 =
	     emac_rx_buffer_rWrPackets_rsCounter_03_BIT_0_0_ETC___d1451 ?
	       IF_emac_rx_buffer_rWrPackets_rsCounter_03_BIT__ETC___d1505 :
	       32'd0 ;
  assign x__h22522 = 8'd1 << x__h23058 ;
  assign x__h23058 =
	     emac_rx_buffer_rRdPackets_rsCounter_21_BIT_0_8_ETC___d1452 ?
	       IF_emac_rx_buffer_rRdPackets_rsCounter_21_BIT__ETC___d1510 :
	       32'd0 ;
  assign x__h26423 = 8'd1 << x__h26959 ;
  assign x__h26959 =
	     emac_tx_buffer_rWrPackets_rsCounter_35_BIT_0_3_ETC___d1453 ?
	       IF_emac_tx_buffer_rWrPackets_rsCounter_35_BIT__ETC___d1514 :
	       32'd0 ;
  assign x__h32890 = 8'd1 << x__h33426 ;
  assign x__h33426 =
	     emac_tx_buffer_rRdPackets_rsCounter_74_BIT_0_2_ETC___d1454 ?
	       IF_emac_tx_buffer_rRdPackets_rsCounter_74_BIT__ETC___d1519 :
	       32'd0 ;
  assign x__h36147 = { wsiM_statusR, wsiS_statusR } ;
  assign x__h37010 =
	     CAN_FIRE_RL_emac_rx_buffer_dequeue_next_beat ?
	       emac_rx_buffer_fifoDeq_rw_enq$wget[7:0] :
	       emac_rx_buffer_fifoDeq_taggedReg[7:0] ;
  assign x_burstLength__h36945 =
	     IF_emac_rx_buffer_fifoDeq_rw_enq_whas__2_THEN__ETC___d1291 ?
	       12'd1 :
	       12'd4095 ;
  assign x_data__h36946 = { 24'd0, x__h37010 } ;
  assign y__h16767 = ~x__h16203 ;
  assign y__h23086 = ~x__h22522 ;
  assign y__h26987 = ~x__h26423 ;
  assign y__h33454 = ~x__h32890 ;
  assign z__h15634 =
	     emac_rx_buffer_rWrPackets_rsCounter[0] ^
	     emac_rx_buffer_rWrPackets_rsCounter[1] ;
  assign z__h15641 = z__h15634 ^ emac_rx_buffer_rWrPackets_rsCounter[2] ;
  assign z__h15648 = z__h15641 ^ emac_rx_buffer_rWrPackets_rsCounter[3] ;
  assign z__h15655 = z__h15648 ^ emac_rx_buffer_rWrPackets_rsCounter[4] ;
  assign z__h15662 = z__h15655 ^ emac_rx_buffer_rWrPackets_rsCounter[5] ;
  assign z__h15669 = z__h15662 ^ emac_rx_buffer_rWrPackets_rsCounter[6] ;
  assign z__h21953 =
	     emac_rx_buffer_rRdPackets_rsCounter[0] ^
	     emac_rx_buffer_rRdPackets_rsCounter[1] ;
  assign z__h21960 = z__h21953 ^ emac_rx_buffer_rRdPackets_rsCounter[2] ;
  assign z__h21967 = z__h21960 ^ emac_rx_buffer_rRdPackets_rsCounter[3] ;
  assign z__h21974 = z__h21967 ^ emac_rx_buffer_rRdPackets_rsCounter[4] ;
  assign z__h21981 = z__h21974 ^ emac_rx_buffer_rRdPackets_rsCounter[5] ;
  assign z__h21988 = z__h21981 ^ emac_rx_buffer_rRdPackets_rsCounter[6] ;
  assign z__h25854 =
	     emac_tx_buffer_rWrPackets_rsCounter[0] ^
	     emac_tx_buffer_rWrPackets_rsCounter[1] ;
  assign z__h25861 = z__h25854 ^ emac_tx_buffer_rWrPackets_rsCounter[2] ;
  assign z__h25868 = z__h25861 ^ emac_tx_buffer_rWrPackets_rsCounter[3] ;
  assign z__h25875 = z__h25868 ^ emac_tx_buffer_rWrPackets_rsCounter[4] ;
  assign z__h25882 = z__h25875 ^ emac_tx_buffer_rWrPackets_rsCounter[5] ;
  assign z__h25889 = z__h25882 ^ emac_tx_buffer_rWrPackets_rsCounter[6] ;
  assign z__h32321 =
	     emac_tx_buffer_rRdPackets_rsCounter[0] ^
	     emac_tx_buffer_rRdPackets_rsCounter[1] ;
  assign z__h32328 = z__h32321 ^ emac_tx_buffer_rRdPackets_rsCounter[2] ;
  assign z__h32335 = z__h32328 ^ emac_tx_buffer_rRdPackets_rsCounter[3] ;
  assign z__h32342 = z__h32335 ^ emac_tx_buffer_rRdPackets_rsCounter[4] ;
  assign z__h32349 = z__h32342 ^ emac_tx_buffer_rRdPackets_rsCounter[5] ;
  assign z__h32356 = z__h32349 ^ emac_tx_buffer_rRdPackets_rsCounter[6] ;
  ...
  begin
    case (wciRx_reqF$D_OUT[39:32])
      8'h0: _theResult____h36072 = status__h35998;
      8'h04: _theResult____h36072 = gbeControl;
      8'h10: _theResult____h36072 = wsiM_extStatusW$wget[95:64];
      8'h14: _theResult____h36072 = wsiM_extStatusW$wget[63:32];
      8'h18: _theResult____h36072 = wsiS_extStatusW$wget[95:64];
      8'h1C: _theResult____h36072 = wsiS_extStatusW$wget[63:32];
      default: _theResult____h36072 = 32'd0;
    endcase
  end
