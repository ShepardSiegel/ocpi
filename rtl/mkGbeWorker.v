...
//
// On Wed Nov 16 08:07:55 EST 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkGbeWorker(CLK_gmii_rx_clk,
  ...
  wire [31 : 0] IF_emac_rx_buffer_rRdPackets_rsCounter_95_BIT__ETC___d1549,
		IF_emac_rx_buffer_rRdPackets_rsCounter_95_BIT__ETC___d1550,
		IF_emac_rx_buffer_rWrPackets_rsCounter_65_BIT__ETC___d1542,
		IF_emac_rx_buffer_rWrPackets_rsCounter_65_BIT__ETC___d1543,
		IF_emac_tx_buffer_rRdPackets_rsCounter_065_BIT_ETC___d1562,
		IF_emac_tx_buffer_rRdPackets_rsCounter_065_BIT_ETC___d1563,
		IF_emac_tx_buffer_rWrPackets_rsCounter_48_BIT__ETC___d1555,
		IF_emac_tx_buffer_rWrPackets_rsCounter_48_BIT__ETC___d1556,
		status__h39033,
		x_data__h38455;
  wire [15 : 0] x__h39179;
  ...
  wire IF_emac_rx_buffer_fifoDeq_rw_enq_whas__82_THEN_ETC___d1324,
       IF_emac_tx_buffer_fifoEnq_rw_enq_whas__36_THEN_ETC___d1552,
       IF_emac_tx_buffer_fifoEnq_rw_enq_whas__36_THEN_ETC___d1553,
       ...
       emac_rx_buffer_rRdPackets_rsCounter_95_BIT_0_0_ETC___d1489,
       emac_rx_buffer_rWrPackets_rsCounter_65_BIT_0_7_ETC___d1488,
       ...
       emac_tx_buffer_rRdPackets_rsCounter_065_BIT_0__ETC___d1491,
       emac_tx_buffer_rWrPackets_rsCounter_48_BIT_0_5_ETC___d1490,
       z__h16941,
       z__h16948,
       z__h16955,
       z__h16962,
  ...
  assign MUX_emac_rx_buffer_rRdPackets_rsCounter$write_1__VAL_1 =
	     (~emac_rx_buffer_rRdPackets_rsCounter[IF_emac_rx_buffer_rRdPackets_rsCounter_95_BIT__ETC___d1550[2:0]]) ?
  ...
  assign MUX_emac_rx_buffer_rWrPackets_rsCounter$write_1__VAL_1 =
	     (~emac_rx_buffer_rWrPackets_rsCounter[IF_emac_rx_buffer_rWrPackets_rsCounter_65_BIT__ETC___d1543[2:0]]) ?
  ...
  assign MUX_emac_tx_buffer_rRdPackets_rsCounter$write_1__VAL_1 =
	     (~emac_tx_buffer_rRdPackets_rsCounter[IF_emac_tx_buffer_rRdPackets_rsCounter_065_BIT_ETC___d1563[2:0]]) ?
  ...
  assign MUX_emac_tx_buffer_rWrPackets_rsCounter$write_1__VAL_1 =
	     (~emac_tx_buffer_rWrPackets_rsCounter[IF_emac_tx_buffer_rWrPackets_rsCounter_48_BIT__ETC___d1556[2:0]]) ?
  ...
  assign MUX_wsiM_reqFifo_q_0$write_1__VAL_1 =
	     { 3'd1,
	       IF_emac_rx_buffer_fifoDeq_rw_enq_whas__82_THEN_ETC___d1324,
	       1'd0,
  ...
  // remaining internal signals
  assign IF_emac_rx_buffer_fifoDeq_rw_enq_whas__82_THEN_ETC___d1324 =
	     WILL_FIRE_RL_emac_rx_buffer_dequeue_next_beat ?
			   ...
			   (emac_rx_buffer_rRdPackets_rsCounter[4] ?
				 ...
				 (emac_rx_buffer_rRdPackets_rsCounter[6] ?
				    ...
				    (emac_rx_buffer_rRdPackets_rsCounter[7] ?
				       ...
				       32'd9)))))))) :
	       32'd7 ;
  assign IF_emac_rx_buffer_rRdPackets_rsCounter_95_BIT__ETC___d1550 =
	     emac_rx_buffer_rRdPackets_rsCounter_95_BIT_0_0_ETC___d1489 ?
			   ...
			   (emac_rx_buffer_rWrPackets_rsCounter[4] ?
				 ...
				 (emac_rx_buffer_rWrPackets_rsCounter[6] ?
				    ...
				    (emac_rx_buffer_rWrPackets_rsCounter[7] ?
				       ...
				       32'd9)))))))) :
	       32'd7 ;
  assign IF_emac_rx_buffer_rWrPackets_rsCounter_65_BIT__ETC___d1543 =
	     emac_rx_buffer_rWrPackets_rsCounter_65_BIT_0_7_ETC___d1488 ?
	       IF_emac_rx_buffer_rWrPackets_rsCounter_65_BIT__ETC___d1542 :
	       32'd0 ;
  assign IF_emac_tx_buffer_fifoEnq_rw_enq_whas__36_THEN_ETC___d1552 =
	     MUX_wsiS_reqFifo_levelsValid$write_1__SEL_3 ?
	       ...
	       emac_tx_buffer_fifoEnq_taggedReg[10] &&
	       emac_tx_buffer_fifoEnq_taggedReg[9:8] == 2'd0 ;
  assign IF_emac_tx_buffer_fifoEnq_rw_enq_whas__36_THEN_ETC___d1553 =
	     MUX_wsiS_reqFifo_levelsValid$write_1__SEL_3 ?
	       emac_tx_buffer_fifoEnq_rw_enq$wget[9:8] == 2'd1 :
	       emac_tx_buffer_fifoEnq_taggedReg[10] &&
	       emac_tx_buffer_fifoEnq_taggedReg[9:8] == 2'd1 ;
			   ...
			   (emac_tx_buffer_rRdPackets_rsCounter[4] ?
				 ...
				 (emac_tx_buffer_rRdPackets_rsCounter[6] ?
				    ...
				    (emac_tx_buffer_rRdPackets_rsCounter[7] ?
				       ...
				       32'd9)))))))) :
	       32'd7 ;
  assign IF_emac_tx_buffer_rRdPackets_rsCounter_065_BIT_ETC___d1563 =
	     emac_tx_buffer_rRdPackets_rsCounter_065_BIT_0__ETC___d1491 ?
	       IF_emac_tx_buffer_rRdPackets_rsCounter_065_BIT_ETC___d1562 :
	       32'd0 ;
			   ...
			   (emac_tx_buffer_rWrPackets_rsCounter[4] ?
				 ...
				 (emac_tx_buffer_rWrPackets_rsCounter[6] ?
				    ...
				    (emac_tx_buffer_rWrPackets_rsCounter[7] ?
				       ...
				       32'd9)))))))) :
	       32'd7 ;
  assign IF_emac_tx_buffer_rWrPackets_rsCounter_48_BIT__ETC___d1556 =
	     emac_tx_buffer_rWrPackets_rsCounter_48_BIT_0_5_ETC___d1490 ?
	       IF_emac_tx_buffer_rWrPackets_rsCounter_48_BIT__ETC___d1555 :
	       32'd0 ;
  ...
  assign emac_rx_buffer_memBuffer_serverAdapterB_outDat_ETC___d827 =
	     ...
	     (emac_rx_buffer_memBuffer_serverAdapterB_outData_outData$wget[9:8] !=
	      ...
	      2'd1 ||
	      emac_rx_buffer_memBuffer_serverAdapterB_cnt_41_ETC___d803) ;
  assign emac_rx_buffer_rRdPackets_rsCounter_95_BIT_0_0_ETC___d1489 =
	     z__h23573 ^ emac_rx_buffer_rRdPackets_rsCounter[7] ;
  assign emac_rx_buffer_rWrPackets_rsCounter_65_BIT_0_7_ETC___d1488 =
  ...
  assign emac_tx_buffer_memBuffer_serverAdapterB_outDat_ETC___d1188 =
	     ...
	     (emac_tx_buffer_memBuffer_serverAdapterB_outData_outData$wget[9:8] !=
	      2'd1 ||
	      emac_tx_buffer_memBuffer_serverAdapterB_cnt_02_ETC___d1155) ;
  assign emac_tx_buffer_rRdPackets_rsCounter_065_BIT_0__ETC___d1491 =
	     z__h34510 ^ emac_tx_buffer_rRdPackets_rsCounter[7] ;
  assign emac_tx_buffer_rWrPackets_rsCounter_48_BIT_0_5_ETC___d1490 =
