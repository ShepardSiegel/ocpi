...
//
// On Tue Sep 28 14:01:19 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkGbeWorker(CLK_gmii_rx_clk,
  ...
  wire MUX_emac_rx_buffer_memBuffer_memory$b_put_1__SEL_1,
       ...
       MUX_wciTx_respF_q_0$write_1__SEL_1,
       MUX_wciTx_respF_q_1$write_1__SEL_1,
  ...
  wire [31 : 0] IF_emac_rx_buffer_rRdPackets_rsCounter_21_BIT__ETC___d1505,
		IF_emac_rx_buffer_rWrPackets_rsCounter_03_BIT__ETC___d1500,
		IF_emac_tx_buffer_rRdPackets_rsCounter_74_BIT__ETC___d1514,
		IF_emac_tx_buffer_rWrPackets_rsCounter_35_BIT__ETC___d1509,
		status__h35937,
		x__h16678,
		x__h22997,
		x__h26898,
		...
		x_data__h36869;
  wire [15 : 0] x__h36086;
  wire [11 : 0] x_burstLength__h36868;
  wire [7 : 0] x__h16142,
	       x__h22461,
	       x__h26362,
	       x__h32829,
  ...
  wire [1 : 0] ab__h20120, ab__h30287;
  wire IF_emac_rx_buffer_fifoDeq_rw_enq_whas__2_THEN__ETC___d1536,
       IF_emac_tx_buffer_fifoEnq_rw_enq_whas__81_THEN_ETC___d1507,
       IF_emac_tx_buffer_fifoEnq_rw_enq_whas__81_THEN_ETC___d1508,
       ...
       emac_rx_buffer_rRdPackets_rsCounter_21_BIT_0_8_ETC___d1446,
       emac_rx_buffer_rWrPackets_rsCounter_03_BIT_0_0_ETC___d1445,
       ...
       emac_tx_buffer_rRdPackets_rsCounter_74_BIT_0_2_ETC___d1448,
       emac_tx_buffer_rWrPackets_rsCounter_35_BIT_0_3_ETC___d1447,
       wsiS_reqFifo_notFull__82_AND_wsiS_burstKind_62_ETC___d902,
       z__h15573,
       z__h15580,
       z__h15587,
       z__h15594,
  ...
  assign MUX_wciTx_respF_q_0$write_1__SEL_1 =
	     WILL_FIRE_RL_wciTx_respF_incCtr && wciTx_respF_c_r == 2'd0 ;
  assign MUX_wciTx_respF_q_1$write_1__SEL_1 =
  ...
  assign MUX_emac_rx_buffer_rRdPackets_rsCounter$write_1__VAL_2 =
	     (~emac_rx_buffer_rRdPackets_rsCounter[x__h22997[2:0]]) ?
	       emac_rx_buffer_rRdPackets_rsCounter | x__h22461 :
	       emac_rx_buffer_rRdPackets_rsCounter & y__h23025 ;
  ...
  assign MUX_emac_rx_buffer_rWrPackets_rsCounter$write_1__VAL_2 =
	     (~emac_rx_buffer_rWrPackets_rsCounter[x__h16678[2:0]]) ?
	       emac_rx_buffer_rWrPackets_rsCounter | x__h16142 :
	       emac_rx_buffer_rWrPackets_rsCounter & y__h16706 ;
  ...
  assign MUX_emac_tx_buffer_rRdPackets_rsCounter$write_1__VAL_2 =
	     (~emac_tx_buffer_rRdPackets_rsCounter[x__h33365[2:0]]) ?
	       emac_tx_buffer_rRdPackets_rsCounter | x__h32829 :
	       emac_tx_buffer_rRdPackets_rsCounter & y__h33393 ;
  ...
  assign MUX_emac_tx_buffer_rWrPackets_rsCounter$write_1__VAL_2 =
	     (~emac_tx_buffer_rWrPackets_rsCounter[x__h26898[2:0]]) ?
	       emac_tx_buffer_rWrPackets_rsCounter | x__h26362 :
	       emac_tx_buffer_rWrPackets_rsCounter & y__h26926 ;
  ...
  assign MUX_wsiM_reqFifo_q_0$write_1__VAL_2 =
	     { 3'd1,
	       IF_emac_rx_buffer_fifoDeq_rw_enq_whas__2_THEN__ETC___d1536,
	       1'd0,
	       x_burstLength__h36868,
	       x_data__h36869,
	       12'd3840 } ;
  ...
  assign wciTx_respF_x_wire$wget = MUX_wciTx_respF_q_0$write_1__VAL_1 ;
  ...
  assign emac_rx_buffer_memBuffer_serverAdapterB_s1_1$wget =
	     { 1'd1, !ab__h20120[1] || ab__h20120[0] } ;
  ...
  assign emac_tx_buffer_memBuffer_serverAdapterB_s1_1$wget =
	     { 1'd1, !ab__h30287[1] || ab__h30287[0] } ;
  ...
  // register wciTx_respF_q_0
  always@(MUX_wciTx_respF_q_0$write_1__SEL_1 or
	  MUX_wciTx_respF_q_0$write_1__VAL_1 or
	  WILL_FIRE_RL_wciTx_respF_both or
  ...
  // register wciTx_respF_q_1
  always@(MUX_wciTx_respF_q_1$write_1__SEL_1 or
	  MUX_wciTx_respF_q_0$write_1__VAL_1 or
	  WILL_FIRE_RL_wciTx_respF_both or
  ...
  begin
    case (1'b1) // synopsys parallel_case
      MUX_wciTx_respF_q_1$write_1__SEL_1:
	  wciTx_respF_q_1$D_IN = MUX_wciTx_respF_q_0$write_1__VAL_1;
      WILL_FIRE_RL_wciTx_respF_both:
  ...
  // remaining internal signals
  assign IF_emac_rx_buffer_fifoDeq_rw_enq_whas__2_THEN__ETC___d1536 =
	     CAN_FIRE_RL_emac_rx_buffer_dequeue_next_beat ?
  ...
  assign IF_emac_rx_buffer_rRdPackets_rsCounter_21_BIT__ETC___d1505 =
			   ...
			   (emac_rx_buffer_rRdPackets_rsCounter[4] ?
				 ...
				 (emac_rx_buffer_rRdPackets_rsCounter[6] ?
				    ...
				    (emac_rx_buffer_rRdPackets_rsCounter[7] ?
				       ...
				       32'd9)))))))) :
	       32'd7 ;
  assign IF_emac_rx_buffer_rWrPackets_rsCounter_03_BIT__ETC___d1500 =
			   ...
			   (emac_rx_buffer_rWrPackets_rsCounter[4] ?
				 ...
				 (emac_rx_buffer_rWrPackets_rsCounter[6] ?
				    ...
				    (emac_rx_buffer_rWrPackets_rsCounter[7] ?
				       ...
				       32'd9)))))))) :
	       32'd7 ;
  assign IF_emac_tx_buffer_fifoEnq_rw_enq_whas__81_THEN_ETC___d1507 =
	     CAN_FIRE_RL_tx_data ?
	       emac_tx_buffer_fifoEnq_rw_enq$wget[9:8] == 2'd0 :
	       emac_tx_buffer_fifoEnq_taggedReg[10] &&
	       emac_tx_buffer_fifoEnq_taggedReg[9:8] == 2'd0 ;
  assign IF_emac_tx_buffer_fifoEnq_rw_enq_whas__81_THEN_ETC___d1508 =
	     CAN_FIRE_RL_tx_data ?
	       emac_tx_buffer_fifoEnq_rw_enq$wget[9:8] == 2'd1 :
	       emac_tx_buffer_fifoEnq_taggedReg[10] &&
	       emac_tx_buffer_fifoEnq_taggedReg[9:8] == 2'd1 ;
  assign IF_emac_tx_buffer_rRdPackets_rsCounter_74_BIT__ETC___d1514 =
			   ...
			   (emac_tx_buffer_rRdPackets_rsCounter[4] ?
				 ...
				 (emac_tx_buffer_rRdPackets_rsCounter[6] ?
				    ...
				    (emac_tx_buffer_rRdPackets_rsCounter[7] ?
				       ...
				       32'd9)))))))) :
	       32'd7 ;
  assign IF_emac_tx_buffer_rWrPackets_rsCounter_35_BIT__ETC___d1509 =
			   ...
			   (emac_tx_buffer_rWrPackets_rsCounter[4] ?
				 ...
				 (emac_tx_buffer_rWrPackets_rsCounter[6] ?
				    ...
				    (emac_tx_buffer_rWrPackets_rsCounter[7] ?
				       ...
				       32'd9)))))))) :
	       32'd7 ;
  assign ab__h20120 = 2'd0 ;
  assign ab__h30287 = 2'd0 ;
  ...
  assign emac_rx_buffer_memBuffer_serverAdapterB_outDat_ETC___d510 =
	     ...
	     (emac_rx_buffer_memBuffer_serverAdapterB_outData_outData$wget[9:8] !=
	      ...
	      2'd1 ||
	      emac_rx_buffer_memBuffer_serverAdapterB_cnt_06_ETC___d507) ;
  assign emac_rx_buffer_rRdPackets_rsCounter_21_BIT_0_8_ETC___d1446 =
	     z__h21927 ^ emac_rx_buffer_rRdPackets_rsCounter[7] ;
  assign emac_rx_buffer_rWrPackets_rsCounter_03_BIT_0_0_ETC___d1445 =
	     z__h15608 ^ emac_rx_buffer_rWrPackets_rsCounter[7] ;
  ...
  assign emac_tx_buffer_memBuffer_serverAdapterB_outDat_ETC___d151 =
	     ...
	     (emac_tx_buffer_memBuffer_serverAdapterB_outData_outData$wget[9:8] !=
	      2'd1 ||
	      emac_tx_buffer_memBuffer_serverAdapterB_cnt_47_ETC___d148) ;
  assign emac_tx_buffer_rRdPackets_rsCounter_74_BIT_0_2_ETC___d1448 =
	     z__h32295 ^ emac_tx_buffer_rRdPackets_rsCounter[7] ;
  assign emac_tx_buffer_rWrPackets_rsCounter_35_BIT_0_3_ETC___d1447 =
	     z__h25828 ^ emac_tx_buffer_rWrPackets_rsCounter[7] ;
  assign status__h35937 = { 16'd0, x__h36086 } ;
  assign wsiS_reqFifo_notFull__82_AND_wsiS_burstKind_62_ETC___d902 =
	     wsiS_reqFifo$FULL_N &&
	     (wsiS_burstKind == 2'd0 ||
	      (wsiS_burstKind == 2'd1 || wsiS_burstKind == 2'd2) &&
	      wsiS_wsiReq$wget[57]) ;
  assign x__h16142 = 8'd1 << x__h16678 ;
  assign x__h16678 =
	     emac_rx_buffer_rWrPackets_rsCounter_03_BIT_0_0_ETC___d1445 ?
	       IF_emac_rx_buffer_rWrPackets_rsCounter_03_BIT__ETC___d1500 :
	       32'd0 ;
  assign x__h22461 = 8'd1 << x__h22997 ;
  assign x__h22997 =
	     emac_rx_buffer_rRdPackets_rsCounter_21_BIT_0_8_ETC___d1446 ?
	       IF_emac_rx_buffer_rRdPackets_rsCounter_21_BIT__ETC___d1505 :
	       32'd0 ;
  assign x__h26362 = 8'd1 << x__h26898 ;
  assign x__h26898 =
	     emac_tx_buffer_rWrPackets_rsCounter_35_BIT_0_3_ETC___d1447 ?
	       IF_emac_tx_buffer_rWrPackets_rsCounter_35_BIT__ETC___d1509 :
	       32'd0 ;
  assign x__h32829 = 8'd1 << x__h33365 ;
  assign x__h33365 =
	     emac_tx_buffer_rRdPackets_rsCounter_74_BIT_0_2_ETC___d1448 ?
	       IF_emac_tx_buffer_rRdPackets_rsCounter_74_BIT__ETC___d1514 :
	       32'd0 ;
  assign x__h36086 = { wsiM_statusR, wsiS_statusR } ;
  assign x__h36933 =
	     CAN_FIRE_RL_emac_rx_buffer_dequeue_next_beat ?
	       emac_rx_buffer_fifoDeq_rw_enq$wget[7:0] :
	       emac_rx_buffer_fifoDeq_taggedReg[7:0] ;
  assign x_burstLength__h36868 =
	     IF_emac_rx_buffer_fifoDeq_rw_enq_whas__2_THEN__ETC___d1536 ?
	       12'd1 :
	       12'd4095 ;
  assign x_data__h36869 = { 24'd0, x__h36933 } ;
  assign y__h16706 = ~x__h16142 ;
  assign y__h23025 = ~x__h22461 ;
  assign y__h26926 = ~x__h26362 ;
  assign y__h33393 = ~x__h32829 ;
  assign z__h15573 =
	     emac_rx_buffer_rWrPackets_rsCounter[0] ^
	     emac_rx_buffer_rWrPackets_rsCounter[1] ;
  assign z__h15580 = z__h15573 ^ emac_rx_buffer_rWrPackets_rsCounter[2] ;
  assign z__h15587 = z__h15580 ^ emac_rx_buffer_rWrPackets_rsCounter[3] ;
  assign z__h15594 = z__h15587 ^ emac_rx_buffer_rWrPackets_rsCounter[4] ;
  assign z__h15601 = z__h15594 ^ emac_rx_buffer_rWrPackets_rsCounter[5] ;
  assign z__h15608 = z__h15601 ^ emac_rx_buffer_rWrPackets_rsCounter[6] ;
  assign z__h21892 =
	     emac_rx_buffer_rRdPackets_rsCounter[0] ^
	     emac_rx_buffer_rRdPackets_rsCounter[1] ;
  assign z__h21899 = z__h21892 ^ emac_rx_buffer_rRdPackets_rsCounter[2] ;
  assign z__h21906 = z__h21899 ^ emac_rx_buffer_rRdPackets_rsCounter[3] ;
  assign z__h21913 = z__h21906 ^ emac_rx_buffer_rRdPackets_rsCounter[4] ;
  assign z__h21920 = z__h21913 ^ emac_rx_buffer_rRdPackets_rsCounter[5] ;
  assign z__h21927 = z__h21920 ^ emac_rx_buffer_rRdPackets_rsCounter[6] ;
  assign z__h25793 =
	     emac_tx_buffer_rWrPackets_rsCounter[0] ^
	     emac_tx_buffer_rWrPackets_rsCounter[1] ;
  assign z__h25800 = z__h25793 ^ emac_tx_buffer_rWrPackets_rsCounter[2] ;
  assign z__h25807 = z__h25800 ^ emac_tx_buffer_rWrPackets_rsCounter[3] ;
  assign z__h25814 = z__h25807 ^ emac_tx_buffer_rWrPackets_rsCounter[4] ;
  assign z__h25821 = z__h25814 ^ emac_tx_buffer_rWrPackets_rsCounter[5] ;
  assign z__h25828 = z__h25821 ^ emac_tx_buffer_rWrPackets_rsCounter[6] ;
  assign z__h32260 =
	     emac_tx_buffer_rRdPackets_rsCounter[0] ^
	     emac_tx_buffer_rRdPackets_rsCounter[1] ;
  assign z__h32267 = z__h32260 ^ emac_tx_buffer_rRdPackets_rsCounter[2] ;
  assign z__h32274 = z__h32267 ^ emac_tx_buffer_rRdPackets_rsCounter[3] ;
  assign z__h32281 = z__h32274 ^ emac_tx_buffer_rRdPackets_rsCounter[4] ;
  assign z__h32288 = z__h32281 ^ emac_tx_buffer_rRdPackets_rsCounter[5] ;
  assign z__h32295 = z__h32288 ^ emac_tx_buffer_rRdPackets_rsCounter[6] ;
  ...
  begin
    case (wciRx_reqF$D_OUT[39:32])
      8'h0: _theResult____h36011 = status__h35937;
      8'h04: _theResult____h36011 = gbeControl;
      8'h10: _theResult____h36011 = wsiM_extStatusW$wget[95:64];
      8'h14: _theResult____h36011 = wsiM_extStatusW$wget[63:32];
      8'h18: _theResult____h36011 = wsiS_extStatusW$wget[95:64];
      8'h1C: _theResult____h36011 = wsiS_extStatusW$wget[63:32];
      default: _theResult____h36011 = 32'd0;
    endcase
  end
