...
//
// On Mon Aug 15 14:45:47 EDT 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkGbeWorker(CLK_gmii_rx_clk,
  ...
  wire [31 : 0] IF_emac_rx_buffer_rRdPackets_rsCounter_95_BIT__ETC___d1552,
		IF_emac_rx_buffer_rRdPackets_rsCounter_95_BIT__ETC___d1553,
		IF_emac_rx_buffer_rWrPackets_rsCounter_65_BIT__ETC___d1545,
		IF_emac_rx_buffer_rWrPackets_rsCounter_65_BIT__ETC___d1546,
		IF_emac_tx_buffer_rRdPackets_rsCounter_065_BIT_ETC___d1565,
		IF_emac_tx_buffer_rRdPackets_rsCounter_065_BIT_ETC___d1566,
		IF_emac_tx_buffer_rWrPackets_rsCounter_48_BIT__ETC___d1558,
		IF_emac_tx_buffer_rWrPackets_rsCounter_48_BIT__ETC___d1559,
		status__h39033,
		x_data__h38455;
  wire [15 : 0] x__h39179;
  ...
  wire IF_emac_rx_buffer_fifoDeq_rw_enq_whas__82_THEN_ETC___d1323,
       IF_emac_tx_buffer_fifoEnq_rw_enq_whas__36_THEN_ETC___d1555,
       IF_emac_tx_buffer_fifoEnq_rw_enq_whas__36_THEN_ETC___d1556,
  ...
  assign MUX_emac_rx_buffer_rRdPackets_rsCounter$write_1__VAL_1 =
	     (~emac_rx_buffer_rRdPackets_rsCounter[IF_emac_rx_buffer_rRdPackets_rsCounter_95_BIT__ETC___d1553[2:0]]) ?
  ...
  assign MUX_emac_rx_buffer_rWrPackets_rsCounter$write_1__VAL_1 =
	     (~emac_rx_buffer_rWrPackets_rsCounter[IF_emac_rx_buffer_rWrPackets_rsCounter_65_BIT__ETC___d1546[2:0]]) ?
  ...
  assign MUX_emac_tx_buffer_rRdPackets_rsCounter$write_1__VAL_1 =
	     (~emac_tx_buffer_rRdPackets_rsCounter[IF_emac_tx_buffer_rRdPackets_rsCounter_065_BIT_ETC___d1566[2:0]]) ?
  ...
  assign MUX_emac_tx_buffer_rWrPackets_rsCounter$write_1__VAL_1 =
	     (~emac_tx_buffer_rWrPackets_rsCounter[IF_emac_tx_buffer_rWrPackets_rsCounter_48_BIT__ETC___d1559[2:0]]) ?
  ...
  assign MUX_wsiM_reqFifo_q_0$write_1__VAL_1 =
	     { 3'd1,
	       IF_emac_rx_buffer_fifoDeq_rw_enq_whas__82_THEN_ETC___d1323,
	       1'd0,
  ...
  // remaining internal signals
  assign IF_emac_rx_buffer_fifoDeq_rw_enq_whas__82_THEN_ETC___d1323 =
	     WILL_FIRE_RL_emac_rx_buffer_dequeue_next_beat ?
  ...
  assign IF_emac_rx_buffer_rRdPackets_rsCounter_95_BIT__ETC___d1552 =
			   ...
			   (emac_rx_buffer_rRdPackets_rsCounter[4] ?
				 ...
				 (emac_rx_buffer_rRdPackets_rsCounter[6] ?
				    ...
				    (emac_rx_buffer_rRdPackets_rsCounter[7] ?
				       ...
				       32'd9)))))))) :
	       32'd7 ;
  assign IF_emac_rx_buffer_rRdPackets_rsCounter_95_BIT__ETC___d1553 =
	     emac_rx_buffer_rRdPackets_rsCounter_95_BIT_0_0_ETC___d1492 ?
	       IF_emac_rx_buffer_rRdPackets_rsCounter_95_BIT__ETC___d1552 :
	       32'd0 ;
  assign IF_emac_rx_buffer_rWrPackets_rsCounter_65_BIT__ETC___d1545 =
			   ...
			   (emac_rx_buffer_rWrPackets_rsCounter[4] ?
				 ...
				 (emac_rx_buffer_rWrPackets_rsCounter[6] ?
				    ...
				    (emac_rx_buffer_rWrPackets_rsCounter[7] ?
				       ...
				       32'd9)))))))) :
	       32'd7 ;
  assign IF_emac_rx_buffer_rWrPackets_rsCounter_65_BIT__ETC___d1546 =
	     emac_rx_buffer_rWrPackets_rsCounter_65_BIT_0_7_ETC___d1491 ?
	       IF_emac_rx_buffer_rWrPackets_rsCounter_65_BIT__ETC___d1545 :
	       32'd0 ;
  assign IF_emac_tx_buffer_fifoEnq_rw_enq_whas__36_THEN_ETC___d1555 =
	     MUX_wsiS_reqFifo_levelsValid$write_1__SEL_3 ?
	       emac_tx_buffer_fifoEnq_rw_enq$wget[9:8] == 2'd0 :
	       emac_tx_buffer_fifoEnq_taggedReg[10] &&
	       emac_tx_buffer_fifoEnq_taggedReg[9:8] == 2'd0 ;
  assign IF_emac_tx_buffer_fifoEnq_rw_enq_whas__36_THEN_ETC___d1556 =
	     MUX_wsiS_reqFifo_levelsValid$write_1__SEL_3 ?
	       emac_tx_buffer_fifoEnq_rw_enq$wget[9:8] == 2'd1 :
	       emac_tx_buffer_fifoEnq_taggedReg[10] &&
	       emac_tx_buffer_fifoEnq_taggedReg[9:8] == 2'd1 ;
  assign IF_emac_tx_buffer_rRdPackets_rsCounter_065_BIT_ETC___d1565 =
			   ...
			   (emac_tx_buffer_rRdPackets_rsCounter[4] ?
				 ...
				 (emac_tx_buffer_rRdPackets_rsCounter[6] ?
				    ...
				    (emac_tx_buffer_rRdPackets_rsCounter[7] ?
				       ...
				       32'd9)))))))) :
	       32'd7 ;
  assign IF_emac_tx_buffer_rRdPackets_rsCounter_065_BIT_ETC___d1566 =
	     emac_tx_buffer_rRdPackets_rsCounter_065_BIT_0__ETC___d1494 ?
	       IF_emac_tx_buffer_rRdPackets_rsCounter_065_BIT_ETC___d1565 :
	       32'd0 ;
  assign IF_emac_tx_buffer_rWrPackets_rsCounter_48_BIT__ETC___d1558 =
			   ...
			   (emac_tx_buffer_rWrPackets_rsCounter[4] ?
				 ...
				 (emac_tx_buffer_rWrPackets_rsCounter[6] ?
				    ...
				    (emac_tx_buffer_rWrPackets_rsCounter[7] ?
				       ...
				       32'd9)))))))) :
	       32'd7 ;
  assign IF_emac_tx_buffer_rWrPackets_rsCounter_48_BIT__ETC___d1559 =
	     emac_tx_buffer_rWrPackets_rsCounter_48_BIT_0_5_ETC___d1493 ?
	       IF_emac_tx_buffer_rWrPackets_rsCounter_48_BIT__ETC___d1558 :
	       32'd0 ;
