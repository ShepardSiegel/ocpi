...
//
// On Sat Mar 31 15:12:58 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkGbeWorker(CLK_gmii_rx_clk,
  ...
  reg [63 : 0] v__h3631, v__h3805, v__h3949, v__h75394, v__h75683, v__h95659;
  reg [31 : 0] IF_wci_wslv_reqF_first__5_BITS_39_TO_32_47_EQ__ETC___d996;
  reg [7 : 0] CASE_13_MINUS_txDBGPos_39_098_255_0_65_1_240_2_ETC__q6,
	      CASE_13_MINUS_txDCPPos_19_097_txDCPHdrFD_OUT__ETC__q5,
	      CASE_rxHdr_pos_rxHdr_pV_BITS_111_TO_104_0_rxHd_ETC__q2,
	      CASE_rxHdr_pos_rxHdr_sV_BITS_111_TO_104_0_rxHd_ETC__q1;
  reg CASE_13_MINUS_txDCPPos_19_097_NOT_13_MINUS_txD_ETC__q3,
      CASE_17_MINUS_txDBGPos_39_099_NOT_17_MINUS_txD_ETC__q4,
      IF_txDBGPos_39_EQ_0_40_OR_txDBGPos_39_EQ_1_41__ETC___d791,
      IF_txDCPPos_19_EQ_0_20_OR_txDCPPos_19_EQ_1_21__ETC___d694;
  wire [101 : 0] _1448743543117976458853375091858__q7,
		 _643371375338640__q8,
		 bs__h12595,
		 bs__h25058;
  wire [31 : 0] rdat___1__h75902,
		rdat___1__h75953,
		rdat___1__h75994,
		rdat___1__h76029,
		rdat___1__h76062,
		...
		status__h75468,
		x__h68050;
  wire [15 : 0] x__h75748, x__h75906, x_data__h28256;
  wire [4 : 0] _13_MINUS_txDBGPos_39___d1098,
	       _13_MINUS_txDCPPos_19___d1097,
	       _17_MINUS_txDBGPos_39___d1099;
  wire [2 : 0] d0__h12221,
	       d10__h12211,
	       d11__h12210,
	       d12__h12209,
	       ...
	       ra3__h12201,
	       ra4__h12200;
  wire IF_rxHdr_pos_67_EQ_0_83_THEN_rxHdr_sV_49_BITS__ETC___d552,
       gmac_RDY_tx_put__47_AND_IF_13_MINUS_txDCPPos_1_ETC___d679,
       gmac_RDY_tx_put__47_AND_IF_17_MINUS_txDBGPos_3_ETC___d785,
       gmac_rx_get_61_BITS_9_TO_8_62_EQ_0_63_OR_gmac__ETC___d555,
       rxLenCount_58_ULT_16___d559,
       wci_wslv_reqF_i_notEmpty__4_AND_IF_wci_wslv_re_ETC___d872;
  ...
  always@(txDCPPos or CASE_13_MINUS_txDCPPos_19_097_txDCPHdrFD_OUT__ETC__q5)
  begin
    case (txDCPPos)
      5'd0,
      5'd1,
	  ...
	  MUX_gmac$tx_put_1__VAL_1 =
	      { 2'd0, CASE_13_MINUS_txDCPPos_19_097_txDCPHdrFD_OUT__ETC__q5 };
      5'd14, 5'd15, 5'd16, 5'd17, 5'd18: MUX_gmac$tx_put_1__VAL_1 = 10'd0;
      default: MUX_gmac$tx_put_1__VAL_1 = 10'd256;
    endcase
  end
  always@(txDBGPos or
	  CASE_13_MINUS_txDBGPos_39_098_255_0_65_1_240_2_ETC__q6 or
	  _17_MINUS_txDBGPos_39___d1099 or txDBGF$D_OUT)
  begin
    case (txDBGPos)
      5'd0,
      5'd1,
	  ...
	  MUX_gmac$tx_put_1__VAL_2 =
	      { 2'd0,
		CASE_13_MINUS_txDBGPos_39_098_255_0_65_1_240_2_ETC__q6 };
      5'd14, 5'd15, 5'd16, 5'd17:
	  MUX_gmac$tx_put_1__VAL_2 =
	      { 2'd0,
		(_17_MINUS_txDBGPos_39___d1099 == 5'd0) ?
		  txDBGF$D_OUT[7:0] :
		  ((_17_MINUS_txDBGPos_39___d1099 == 5'd1) ?
		     txDBGF$D_OUT[15:8] :
		     ((_17_MINUS_txDBGPos_39___d1099 == 5'd2) ?
			txDBGF$D_OUT[23:16] :
			txDBGF$D_OUT[31:24])) };
  ...
  assign MUX_wci_wslv_respF_q_1$write_1__VAL_1 =
	     (wci_wslv_respF_c_r == 2'd2) ?
	       MUX_wci_wslv_respF_q_0$write_1__VAL_2 :
	       34'h0AAAAAAAA ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_1 = { 2'd1, rdat__h75667 } ;
  ...
  // register rxLenCount
  assign rxLenCount$D_IN = (gmac$rx_get[9:8] == 2'd0) ? x__h68050 : 32'd0 ;
  assign rxLenCount$EN = WILL_FIRE_RL_rx_data ;

  // register rxLenLast
  assign rxLenLast$D_IN = x__h68050 ;
  ...
  assign gmac$EN_tx_put =
	     ...
	     (txDBGPos == 5'd0 || txDBGPos == 5'd1 || txDBGPos == 5'd2 ||
	      ...
	      txDBGPos == 5'd17 ||
	      txDBGPos == 5'd18) ;
  assign gmac$EN_rxOperate = wci_wslv_cState == 3'd2 ;
  assign gmac$EN_txOperate = wci_wslv_cState == 3'd2 ;
  ...
  // remaining internal signals
  assign IF_rxHdr_pos_67_EQ_0_83_THEN_rxHdr_sV_49_BITS__ETC___d552 =
	     CASE_rxHdr_pos_rxHdr_sV_BITS_111_TO_104_0_rxHd_ETC__q1 ==
	     CASE_rxHdr_pos_rxHdr_pV_BITS_111_TO_104_0_rxHd_ETC__q2 ;
  assign _13_MINUS_txDBGPos_39___d1098 = 5'd13 - txDBGPos ;
  assign _13_MINUS_txDCPPos_19___d1097 = 5'd13 - txDCPPos ;
  assign _1448743543117976458853375091858__q7 =
	     102'h12492492492492492492492492 ;
  assign _17_MINUS_txDBGPos_39___d1099 = 5'd17 - txDBGPos ;
  ...
  assign gmac_RDY_tx_put__47_AND_IF_13_MINUS_txDCPPos_1_ETC___d679 =
	     gmac$RDY_tx_put &&
	     CASE_13_MINUS_txDCPPos_19_097_NOT_13_MINUS_txD_ETC__q3 ;
  assign gmac_RDY_tx_put__47_AND_IF_17_MINUS_txDBGPos_3_ETC___d785 =
	     gmac$RDY_tx_put &&
	     CASE_17_MINUS_txDBGPos_39_099_NOT_17_MINUS_txD_ETC__q4 ;
  assign gmac_rx_get_61_BITS_9_TO_8_62_EQ_0_63_OR_gmac__ETC___d555 =
	     (gmac$rx_get[9:8] == 2'd0 || gmac$rx_get[9:8] == 2'd1) &&
	     rxHdr_sV[112] &&
	     !rxHdr_pV[112] &&
	     IF_rxHdr_pos_67_EQ_0_83_THEN_rxHdr_sV_49_BITS__ETC___d552 ;
  ...
  assign rdat___1__h75902 = hasDebugLogic ? { 16'd0, x__h75906 } : 32'd0 ;
  assign rdat___1__h75953 =
	     hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat___1__h75994 =
	     hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat___1__h76029 =
	     hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat___1__h76062 =
	     hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat___1__h76103 =
	     hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat___1__h76138 = hasDebugLogic ? txDBGCnt : 32'd0 ;
  assign rdat___1__h76171 = hasDebugLogic ? rxCount : 32'd0 ;
  assign rdat___1__h76204 = hasDebugLogic ? txCount : 32'd0 ;
  assign rdat___1__h76237 = hasDebugLogic ? rxOvfCount : 32'd0 ;
  assign rdat___1__h76270 = hasDebugLogic ? txUndCount : 32'd0 ;
  assign rdat___1__h76303 = hasDebugLogic ? rxValidNoEOPC : 32'd0 ;
  assign rdat___1__h76336 = hasDebugLogic ? rxValidEOPC : 32'd0 ;
  assign rdat___1__h76369 = hasDebugLogic ? rxEmptyEOPC : 32'd0 ;
  assign rdat___1__h76402 = hasDebugLogic ? rxAbortEOPC : 32'd0 ;
  assign rdat___1__h76435 = hasDebugLogic ? rxDCPCnt : 32'd0 ;
  assign rdat___1__h76468 = hasDebugLogic ? rxHdrMatchCnt : 32'd0 ;
  assign rdat___1__h76501 = hasDebugLogic ? rxLenLast : 32'd0 ;
  assign rdat___1__h76535 = hasDebugLogic ? txDCPCnt : 32'd0 ;
  assign rdat___1__h76568 = hasDebugLogic ? { 28'd0, rxHdr_pos } : 32'd0 ;
  assign rdat___1__h76605 = hasDebugLogic ? { 28'd0, rxHdr_mCnt } : 32'd0 ;
  assign rdat___1__h76642 =
	     hasDebugLogic ? { 16'd0, rxHdr_sV[111:96] } : 32'd0 ;
  assign rdat___1__h79143 = hasDebugLogic ? rxHdr_sV[95:64] : 32'd0 ;
  assign rdat___1__h81641 =
	     hasDebugLogic ? { 16'd0, rxHdr_sV[63:48] } : 32'd0 ;
  assign rdat___1__h84142 = hasDebugLogic ? rxHdr_sV[47:16] : 32'd0 ;
  assign rdat___1__h86640 =
	     hasDebugLogic ? { 16'd0, rxHdr_sV[15:0] } : 32'd0 ;
  assign rdat___1__h89141 = hasDebugLogic ? rxHeadCap[127:96] : 32'd0 ;
  assign rdat___1__h90748 = hasDebugLogic ? rxHeadCap[95:64] : 32'd0 ;
  assign rdat___1__h92318 = hasDebugLogic ? rxHeadCap[63:32] : 32'd0 ;
  assign rdat___1__h93888 = hasDebugLogic ? rxHeadCap[31:0] : 32'd0 ;
  assign rdat__h75667 =
	     wci_wslv_reqF$D_OUT[39] ?
	       32'd0 :
	       IF_wci_wslv_reqF_first__5_BITS_39_TO_32_47_EQ__ETC___d996 ;
  assign rxLenCount_58_ULT_16___d559 = rxLenCount < 32'd16 ;
  assign status__h75468 = { 16'd0, x__h75748 } ;
  assign wci_wslv_reqF_i_notEmpty__4_AND_IF_wci_wslv_re_ETC___d872 =
	     wci_wslv_reqF$EMPTY_N &&
	     (wci_wslv_reqF$D_OUT[39] ?
		mdi_fRequest$FULL_N :
		wci_wslv_respF_c_r != 2'd2) ;
  assign x__h68050 = rxLenCount + 32'd1 ;
  assign x__h75748 = { wsiM_statusR, wsiS_statusR } ;
  assign x__h75906 = { wsiS_statusR, wsiM_statusR } ;
  ...
  always@(_13_MINUS_txDCPPos_19___d1097 or txDCPHdrF$EMPTY_N)
  begin
    case (_13_MINUS_txDCPPos_19___d1097)
      5'd0,
      5'd1,
      5'd2,
      5'd3,
	  ...
	  CASE_13_MINUS_txDCPPos_19_097_NOT_13_MINUS_txD_ETC__q3 =
	      txDCPHdrF$EMPTY_N;
      default: CASE_13_MINUS_txDCPPos_19_097_NOT_13_MINUS_txD_ETC__q3 =
		   _13_MINUS_txDCPPos_19___d1097 != 5'd13 ||
		   txDCPHdrF$EMPTY_N;
    endcase
  end
  always@(txDCPPos or
  ...
  begin
    case (txDCPPos)
	  ...
	  IF_txDCPPos_19_EQ_0_20_OR_txDCPPos_19_EQ_1_21__ETC___d694 =
	      gmac$RDY_tx_put;
      default: IF_txDCPPos_19_EQ_0_20_OR_txDCPPos_19_EQ_1_21__ETC___d694 =
		   txDCPPos != 5'd19 || gmac$RDY_tx_put && txDCPHdrF$EMPTY_N;
    endcase
  end
  always@(_17_MINUS_txDBGPos_39___d1099 or txDBGF$EMPTY_N)
  begin
    case (_17_MINUS_txDBGPos_39___d1099)
      5'd0, 5'd1, 5'd2:
	  CASE_17_MINUS_txDBGPos_39_099_NOT_17_MINUS_txD_ETC__q4 =
	      txDBGF$EMPTY_N;
      default: CASE_17_MINUS_txDBGPos_39_099_NOT_17_MINUS_txD_ETC__q4 =
		   _17_MINUS_txDBGPos_39___d1099 != 5'd3 || txDBGF$EMPTY_N;
    endcase
  end
  always@(txDBGPos or
	  gmac$RDY_tx_put or
  ...
  begin
    case (txDBGPos)
	  ...
	  IF_txDBGPos_39_EQ_0_40_OR_txDBGPos_39_EQ_1_41__ETC___d791 =
	      gmac_RDY_tx_put__47_AND_IF_17_MINUS_txDBGPos_3_ETC___d785;
      default: IF_txDBGPos_39_EQ_0_40_OR_txDBGPos_39_EQ_1_41__ETC___d791 =
		   txDBGPos != 5'd18 || gmac$RDY_tx_put && txDBGF$EMPTY_N;
    endcase
  end
  always@(_13_MINUS_txDCPPos_19___d1097 or txDCPHdrF$D_OUT)
  begin
    case (_13_MINUS_txDCPPos_19___d1097)
      5'd0:
	  CASE_13_MINUS_txDCPPos_19_097_txDCPHdrFD_OUT__ETC__q5 =
      ...
      default: CASE_13_MINUS_txDCPPos_19_097_txDCPHdrFD_OUT__ETC__q5 =
		   txDCPHdrF$D_OUT[111:104];
    endcase
  end
  always@(_13_MINUS_txDBGPos_39___d1098)
  begin
    case (_13_MINUS_txDBGPos_39___d1098)
      5'd0: CASE_13_MINUS_txDBGPos_39_098_255_0_65_1_240_2_ETC__q6 = 8'd65;
      5'd1: CASE_13_MINUS_txDBGPos_39_098_255_0_65_1_240_2_ETC__q6 = 8'd240;
      5'd2: CASE_13_MINUS_txDBGPos_39_098_255_0_65_1_240_2_ETC__q6 = 8'd39;
      5'd3: CASE_13_MINUS_txDBGPos_39_098_255_0_65_1_240_2_ETC__q6 = 8'd38;
      5'd4: CASE_13_MINUS_txDBGPos_39_098_255_0_65_1_240_2_ETC__q6 = 8'd37;
      5'd5: CASE_13_MINUS_txDBGPos_39_098_255_0_65_1_240_2_ETC__q6 = 8'd36;
      5'd6: CASE_13_MINUS_txDBGPos_39_098_255_0_65_1_240_2_ETC__q6 = 8'd34;
      5'd7: CASE_13_MINUS_txDBGPos_39_098_255_0_65_1_240_2_ETC__q6 = 8'd33;
      default: CASE_13_MINUS_txDBGPos_39_098_255_0_65_1_240_2_ETC__q6 =
		   8'd255;
    endcase
  end
  always@(wci_wslv_reqF$D_OUT or
	  ...
	  rdat___1__h86640 or
	  rdat___1__h89141 or
	  rdat___1__h90748 or rdat___1__h92318 or rdat___1__h93888)
  begin
    case (wci_wslv_reqF$D_OUT[39:32])
	  ...
	  IF_wci_wslv_reqF_first__5_BITS_39_TO_32_47_EQ__ETC___d996 =
	      rdat___1__h93888;
      default: IF_wci_wslv_reqF_first__5_BITS_39_TO_32_47_EQ__ETC___d996 =
		   32'd0;
    endcase
  end
  ...
  begin
	...
	$display("Error: \"bsv/wrk/GbeWorker.bsv\", line 230, column 46: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_ctrl_EiI] and\n  [RL_wci_ctrl_OrE] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wci_ctrl_EiI && WILL_FIRE_RL_wci_ctrl_IsO)
	$display("Error: \"bsv/wrk/GbeWorker.bsv\", line 230, column 46: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_ctrl_EiI] and\n  [RL_wci_ctrl_IsO] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wci_ctrl_IsO && WILL_FIRE_RL_wci_ctrl_OrE)
	$display("Error: \"bsv/wrk/GbeWorker.bsv\", line 230, column 60: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_ctrl_IsO] and\n  [RL_wci_ctrl_OrE] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n)
	...
	$display("Error: \"bsv/wrk/GbeWorker.bsv\", line 230, column 36: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_cfrd] and\n  [RL_wci_ctrl_OrE] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n)
	...
	$display("Error: \"bsv/wrk/GbeWorker.bsv\", line 230, column 26: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_cfwr] and\n  [RL_wci_ctrl_OrE] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n)
