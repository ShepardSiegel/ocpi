...
//
// On Sat Jan 28 16:03:18 EST 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkGbeWorker(CLK_gmii_rx_clk,
  ...
  wire [31 : 0] IF_emac_rx_buffer_rRdPackets_rsCounter_99_BIT__ETC___d1552,
		IF_emac_rx_buffer_rRdPackets_rsCounter_99_BIT__ETC___d1553,
		IF_emac_rx_buffer_rWrPackets_rsCounter_69_BIT__ETC___d1546,
		IF_emac_tx_buffer_rRdPackets_rsCounter_069_BIT_ETC___d1565,
		IF_emac_tx_buffer_rRdPackets_rsCounter_069_BIT_ETC___d1566,
		IF_emac_tx_buffer_rWrPackets_rsCounter_52_BIT__ETC___d1558,
  ...
  wire IF_emac_rx_buffer_fifoDeq_rw_enq_whas__86_THEN_ETC___d1334,
       IF_emac_tx_buffer_fifoEnq_rw_enq_whas__40_THEN_ETC___d1555,
  ...
  assign MUX_emac_rx_buffer_rRdPackets_rsCounter$write_1__VAL_1 =
	     (~emac_rx_buffer_rRdPackets_rsCounter[IF_emac_rx_buffer_rRdPackets_rsCounter_99_BIT__ETC___d1553[2:0]]) ?
  ...
  assign MUX_emac_rx_buffer_rWrPackets_rsCounter$write_1__VAL_1 =
	     (~emac_rx_buffer_rWrPackets_rsCounter[x__h17767[2:0]]) ?
  ...
  assign MUX_emac_tx_buffer_rRdPackets_rsCounter$write_1__VAL_1 =
	     (~emac_tx_buffer_rRdPackets_rsCounter[IF_emac_tx_buffer_rRdPackets_rsCounter_069_BIT_ETC___d1566[2:0]]) ?
  ...
  assign MUX_emac_tx_buffer_rWrPackets_rsCounter$write_1__VAL_1 =
	     (~emac_tx_buffer_rWrPackets_rsCounter[IF_emac_tx_buffer_rWrPackets_rsCounter_52_BIT__ETC___d1559[2:0]]) ?
  ...
  assign IF_emac_rx_buffer_rRdPackets_rsCounter_99_BIT__ETC___d1552 =
  ...
  assign IF_emac_rx_buffer_rRdPackets_rsCounter_99_BIT__ETC___d1553 =
	     emac_rx_buffer_rRdPackets_rsCounter_99_BIT_0_0_ETC___d1489 ?
	       IF_emac_rx_buffer_rRdPackets_rsCounter_99_BIT__ETC___d1552 :
	       32'd0 ;
			   ...
			   (emac_rx_buffer_rWrPackets_rsCounter[4] ?
				 ...
				 (emac_rx_buffer_rWrPackets_rsCounter[6] ?
				    ...
				    (emac_rx_buffer_rWrPackets_rsCounter[7] ?
				       ...
				       32'd9)))))))) :
	       32'd7 ;
  assign IF_emac_tx_buffer_fifoEnq_rw_enq_whas__40_THEN_ETC___d1555 =
	     MUX_wsiS_reqFifo_levelsValid$write_1__SEL_3 ?
	       emac_tx_buffer_fifoEnq_rw_enq$wget[9:8] == 2'd0 :
	       emac_tx_buffer_fifoEnq_taggedReg[10] &&
	       emac_tx_buffer_fifoEnq_taggedReg[9:8] == 2'd0 ;
  assign IF_emac_tx_buffer_fifoEnq_rw_enq_whas__40_THEN_ETC___d1556 =
	     MUX_wsiS_reqFifo_levelsValid$write_1__SEL_3 ?
	       ...
	       emac_tx_buffer_fifoEnq_taggedReg[10] &&
	       emac_tx_buffer_fifoEnq_taggedReg[9:8] == 2'd1 ;
  assign IF_emac_tx_buffer_rRdPackets_rsCounter_069_BIT_ETC___d1565 =
  ...
  assign IF_emac_tx_buffer_rRdPackets_rsCounter_069_BIT_ETC___d1566 =
	     emac_tx_buffer_rRdPackets_rsCounter_069_BIT_0__ETC___d1491 ?
	       IF_emac_tx_buffer_rRdPackets_rsCounter_069_BIT_ETC___d1565 :
	       32'd0 ;
  assign IF_emac_tx_buffer_rWrPackets_rsCounter_52_BIT__ETC___d1558 =
  ...
  assign x__h17130 = 8'd1 << x__h17767 ;
  assign x__h17767 =
	     emac_rx_buffer_rWrPackets_rsCounter_69_BIT_0_7_ETC___d1488 ?
	       IF_emac_rx_buffer_rWrPackets_rsCounter_69_BIT__ETC___d1546 :
	       32'd0 ;
