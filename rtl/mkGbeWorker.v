...
//
// On Sat Jun 23 11:24:57 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkGbeWorker(CLK_gmii_rx_clk,
  ...
  reg [43 : 0] dcp_lastResp;
  wire [43 : 0] dcp_lastResp$D_IN;
  ...
  reg [63 : 0] v__h102731, v__h3630, v__h3804, v__h3948, v__h82462, v__h82751;
  reg [31 : 0] IF_wci_wslv_reqF_first__5_BITS_39_TO_32_32_EQ__ETC___d1085;
  ...
  reg [7 : 0] CASE_13_MINUS_txDCPPos_rxHdr_sV_BITS_63_TO_56__ETC__q6,
	      ...
	      IF_rxDCPMesgPos_49_EQ_5_90_THEN_rxDCPMesg_56_B_ETC___d1162,
	      tag__h72991;
  ...
  reg CASE_IF_rxDCPMesgPos_49_EQ_5_90_THEN_rxDCPMesg_ETC__q4,
      CASE_dcpRespFD_OUT_BITS_43_TO_42_IF_txDCPPos__ETC__q3,
      IF_txDCPPos_88_EQ_0_89_OR_txDCPPos_88_EQ_1_90__ETC___d1298;
  wire [194 : 0] _1434766110945527031733894725304609466537681244_ETC__q10,
		 _643371375338640__q12,
		 bs__h12594,
		 bs__h25119;
  wire [31 : 0] rdat___1__h100960,
		rdat___1__h82970,
		rdat___1__h83021,
		rdat___1__h83062,
		rdat___1__h83097,
		...
		status__h82536,
		x__h72782;
  wire [15 : 0] x__h82816, x__h82974, x_data__h28317;
  wire [4 : 0] IF_txDCPPos_88_EQ_9_06_THEN_0_ELSE_txDCPPos_88_ETC___d1281,
	       txDCPPos_88_PLUS_1___d1210;
  wire [2 : 0] d0__h12220,
	       d10__h12210,
	       d11__h12209,
	       d12__h12208,
	       ...
	       ra3__h12200,
	       ra4__h12199;
  wire IF_dcp_dcpReqF_first__42_BITS_77_TO_76_43_EQ_0_ETC___d468,
       IF_dcp_dcpReqF_first__42_BITS_77_TO_76_43_EQ_1_ETC___d466,
       IF_rxHdr_pos_48_EQ_0_64_THEN_rxHdr_sV_30_BITS__ETC___d633,
       NOT_rxHdr_sV_30_BIT_112_31_48_AND_rxHdr_sV_30__ETC___d654,
       NOT_rxHdr_sV_30_BIT_112_31_48_AND_rxHdr_sV_30__ETC___d844,
       dcpRespF_i_notEmpty__84_AND_IF_dcpRespF_first__ETC___d820,
       dcp_dcpReqF_first__42_BITS_39_TO_32_47_EQ_IF_d_ETC___d1293,
       dcp_dcpReqF_first__42_BITS_71_TO_64_58_EQ_IF_d_ETC___d1294,
       dcp_dcpReqF_first__42_BITS_77_TO_76_43_EQ_1_46_ETC___d490,
       dcp_dcpRespF_i_notFull__45_AND_dcp_dcpReqF_fir_ETC___d463,
       gmac_rx_get_42_BITS_9_TO_8_43_EQ_0_44_OR_gmac__ETC___d636,
       rxHdr_sV_30_BIT_112_31_OR_NOT_rxHdr_sV_30_BITS_ETC___d927,
       wci_wslv_reqF_i_notEmpty__4_AND_IF_wci_wslv_re_ETC___d957;
  ...
  assign CAN_FIRE_RL_rx_dcp =
	     rxDCPHdrF$EMPTY_N &&
	     CASE_IF_rxDCPMesgPos_49_EQ_5_90_THEN_rxDCPMesg_ETC__q4 &&
  ...
  assign WILL_FIRE_RL_dcp_dcp_request =
	     dcp_dcpReqF$EMPTY_N &&
	     IF_dcp_dcpReqF_first__42_BITS_77_TO_76_43_EQ_0_ETC___d468 ;
  ...
  assign MUX_wci_wslv_respF_q_1$write_1__VAL_1 =
	     (wci_wslv_respF_c_r == 2'd2) ?
	       MUX_wci_wslv_respF_q_0$write_1__VAL_2 :
	       34'h0AAAAAAAA ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_1 = { 2'd1, rdat__h82735 } ;
  ...
  assign dcp_lastResp$EN = MUX_dcp_dcpRespF$enq_1__SEL_2 ;
  ...
  // register mdi_rMDD
  assign mdi_rMDD$D_IN = bs__h12594[mdi_rPlayIndex$Q_OUT] ;
  assign mdi_rMDD$EN = WILL_FIRE_RL_mdi_run_frame ;

  // register mdi_rOutEn
  assign mdi_rOutEn$D_IN = bs__h25119[mdi_rPlayIndex$Q_OUT] ;
  ...
  // register rxLenCount
  assign rxLenCount$D_IN = (gmac$rx_get[9:8] == 2'd0) ? x__h72782 : 32'd0 ;
  assign rxLenCount$EN = WILL_FIRE_RL_rx_data ;

  // register rxLenLast
  assign rxLenLast$D_IN = x__h72782 ;
  ...
  assign txDCPPos$D_IN =
	     (!rxHdr_sV[112] && rxHdr_sV[15:0] == 16'hF040) ?
	       ((txDCPPos == 5'd13) ? 5'd0 : txDCPPos_88_PLUS_1___d1210) :
  ...
  // submodule dcp_dcpReqF
  always@(IF_rxDCPMesgPos_49_EQ_5_90_THEN_rxDCPMesg_56_B_ETC___d1162 or
	  tag__h72991 or rxDCPMesg)
  begin
    case (IF_rxDCPMesgPos_49_EQ_5_90_THEN_rxDCPMesg_56_B_ETC___d1162[7:4])
      4'd0:
	  dcp_dcpReqF$D_IN = { 38'h0AAAAAAAAA, tag__h72991, rxDCPMesg[31:0] };
      4'd1:
	  dcp_dcpReqF$D_IN =
	      { 2'd1,
		IF_rxDCPMesgPos_49_EQ_5_90_THEN_rxDCPMesg_56_B_ETC___d1162[3:0],
		tag__h72991,
		rxDCPMesg[31:0],
		rxDCPMesg[63:32] };
  ...
  assign dcp_dcpReqF$ENQ =
	     WILL_FIRE_RL_rx_dcp &&
	     (IF_rxDCPMesgPos_49_EQ_5_90_THEN_rxDCPMesg_56_B_ETC___d1162[7:4] ==
	      4'd0 ||
	      IF_rxDCPMesgPos_49_EQ_5_90_THEN_rxDCPMesg_56_B_ETC___d1162[7:4] ==
	      4'd1 ||
	      IF_rxDCPMesgPos_49_EQ_5_90_THEN_rxDCPMesg_56_B_ETC___d1162[7:4] ==
  ...
  // submodule mdi_fResponse
  assign mdi_fResponse$D_IN = { 1'd1, x_data__h28317 } ;
  ...
  // remaining internal signals
  assign IF_dcp_dcpReqF_first__42_BITS_77_TO_76_43_EQ_0_ETC___d468 =
	     (dcp_dcpReqF$D_OUT[77:76] == 2'd0) ?
	       dcp_dcpRespF$FULL_N :
	       (dcp_dcpReqF$D_OUT[77:76] == 2'd1 ||
		!dcp_dcpReqF_first__42_BITS_39_TO_32_47_EQ_IF_d_ETC___d1293 ||
		...
		dcp_dcpRespF$FULL_N) &&
	       IF_dcp_dcpReqF_first__42_BITS_77_TO_76_43_EQ_1_ETC___d466 ;
  assign IF_dcp_dcpReqF_first__42_BITS_77_TO_76_43_EQ_1_ETC___d466 =
	     (dcp_dcpReqF$D_OUT[77:76] == 2'd1) ?
	       dcp_dcpRespF_i_notFull__45_AND_dcp_dcpReqF_fir_ETC___d463 :
	       dcp_dcpReqF_first__42_BITS_39_TO_32_47_EQ_IF_d_ETC___d1293 &&
	       dcp_lastTag[8] ||
	       dcp_cpReqF$FULL_N ;
  assign IF_rxHdr_pos_48_EQ_0_64_THEN_rxHdr_sV_30_BITS__ETC___d633 =
	     CASE_rxHdr_pos_rxHdr_sV_BITS_111_TO_104_0_rxHd_ETC__q1 ==
	     CASE_rxHdr_pos_rxHdr_pV_BITS_111_TO_104_0_rxHd_ETC__q2 ;
  assign IF_txDCPPos_88_EQ_9_06_THEN_0_ELSE_txDCPPos_88_ETC___d1281 =
	     (txDCPPos == 5'd9) ? 5'd0 : txDCPPos_88_PLUS_1___d1210 ;
  assign NOT_rxHdr_sV_30_BIT_112_31_48_AND_rxHdr_sV_30__ETC___d654 =
	     !rxHdr_sV[112] && rxHdr_sV[15:0] == 16'hF040 &&
	     { 3'd0, rxDCPMesgPos } < rxDCPPLI ;
  assign NOT_rxHdr_sV_30_BIT_112_31_48_AND_rxHdr_sV_30__ETC___d844 =
	     !rxHdr_sV[112] && rxHdr_sV[15:0] == 16'hF040 ||
  ...
  assign dcpRespF_i_notEmpty__84_AND_IF_dcpRespF_first__ETC___d820 =
	     dcpRespF$EMPTY_N &&
	     CASE_dcpRespFD_OUT_BITS_43_TO_42_IF_txDCPPos__ETC__q3 ;
  assign dcp_dcpReqF_first__42_BITS_39_TO_32_47_EQ_IF_d_ETC___d1293 =
	     dcp_dcpReqF$D_OUT[39:32] == dcp_lastTag[7:0] ;
  assign dcp_dcpReqF_first__42_BITS_71_TO_64_58_EQ_IF_d_ETC___d1294 =
	     dcp_dcpReqF$D_OUT[71:64] == dcp_lastTag[7:0] ;
  assign dcp_dcpReqF_first__42_BITS_77_TO_76_43_EQ_1_46_ETC___d490 =
	     dcp_dcpReqF$D_OUT[77:76] == 2'd1 &&
	     (!dcp_dcpReqF_first__42_BITS_71_TO_64_58_EQ_IF_d_ETC___d1294 ||
	      !dcp_lastTag[8]) ||
	     dcp_dcpReqF$D_OUT[77:76] != 2'd1 &&
	     (!dcp_dcpReqF_first__42_BITS_39_TO_32_47_EQ_IF_d_ETC___d1293 ||
	      !dcp_lastTag[8]) ;
  assign dcp_dcpRespF_i_notFull__45_AND_dcp_dcpReqF_fir_ETC___d463 =
	     dcp_dcpRespF$FULL_N &&
	     (dcp_dcpReqF_first__42_BITS_71_TO_64_58_EQ_IF_d_ETC___d1294 &&
	      dcp_lastTag[8] ||
	      dcp_cpReqF$FULL_N) ;
  assign gmac_rx_get_42_BITS_9_TO_8_43_EQ_0_44_OR_gmac__ETC___d636 =
	     (gmac$rx_get[9:8] == 2'd0 || gmac$rx_get[9:8] == 2'd1) &&
	     rxHdr_sV[112] &&
	     !rxHdr_pV[112] &&
	     IF_rxHdr_pos_48_EQ_0_64_THEN_rxHdr_sV_30_BITS__ETC___d633 ;
  ...
  assign rdat___1__h100960 = hasDebugLogic ? rxHeadCap[31:0] : 32'd0 ;
  assign rdat___1__h82970 = hasDebugLogic ? { 16'd0, x__h82974 } : 32'd0 ;
  assign rdat___1__h83021 =
	     hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat___1__h83062 =
	     hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat___1__h83097 =
	     hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat___1__h83130 =
	     hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat___1__h83171 =
	     hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat___1__h83206 = hasDebugLogic ? txDBGCnt : 32'd0 ;
  assign rdat___1__h83240 = hasDebugLogic ? rxCount : 32'd0 ;
  assign rdat___1__h83273 = hasDebugLogic ? txCount : 32'd0 ;
  assign rdat___1__h83307 = hasDebugLogic ? rxOvfCount : 32'd0 ;
  assign rdat___1__h83340 = hasDebugLogic ? txUndCount : 32'd0 ;
  assign rdat___1__h83373 = hasDebugLogic ? rxValidNoEOPC : 32'd0 ;
  assign rdat___1__h83406 = hasDebugLogic ? rxValidEOPC : 32'd0 ;
  assign rdat___1__h83439 = hasDebugLogic ? rxEmptyEOPC : 32'd0 ;
  assign rdat___1__h83472 = hasDebugLogic ? rxAbortEOPC : 32'd0 ;
  assign rdat___1__h83505 = hasDebugLogic ? rxDCPCnt : 32'd0 ;
  assign rdat___1__h83539 = hasDebugLogic ? rxHdrMatchCnt : 32'd0 ;
  assign rdat___1__h83572 = hasDebugLogic ? rxLenLast : 32'd0 ;
  assign rdat___1__h83606 = hasDebugLogic ? txDCPCnt : 32'd0 ;
  assign rdat___1__h83640 = hasDebugLogic ? { 28'd0, rxHdr_pos } : 32'd0 ;
  assign rdat___1__h83677 = hasDebugLogic ? { 28'd0, rxHdr_mCnt } : 32'd0 ;
  assign rdat___1__h83714 =
	     hasDebugLogic ? { 16'd0, rxHdr_sV[111:96] } : 32'd0 ;
  assign rdat___1__h86215 = hasDebugLogic ? rxHdr_sV[95:64] : 32'd0 ;
  assign rdat___1__h88713 =
	     hasDebugLogic ? { 16'd0, rxHdr_sV[63:48] } : 32'd0 ;
  assign rdat___1__h91214 = hasDebugLogic ? rxHdr_sV[47:16] : 32'd0 ;
  assign rdat___1__h93712 =
	     hasDebugLogic ? { 16'd0, rxHdr_sV[15:0] } : 32'd0 ;
  assign rdat___1__h96213 = hasDebugLogic ? rxHeadCap[127:96] : 32'd0 ;
  assign rdat___1__h97820 = hasDebugLogic ? rxHeadCap[95:64] : 32'd0 ;
  assign rdat___1__h99390 = hasDebugLogic ? rxHeadCap[63:32] : 32'd0 ;
  assign rdat__h82735 =
	     wci_wslv_reqF$D_OUT[39] ?
	       32'd0 :
	       IF_wci_wslv_reqF_first__5_BITS_39_TO_32_32_EQ__ETC___d1085 ;
  assign rxHdr_sV_30_BIT_112_31_OR_NOT_rxHdr_sV_30_BITS_ETC___d927 =
	     (rxHdr_sV[112] || rxHdr_sV[15:0] != 16'hF040) &&
	     (dcpRespF$D_OUT[43:42] == 2'd0 && txDCPPos == 5'd9 ||
	      dcpRespF$D_OUT[43:42] != 2'd0 &&
	      (dcpRespF$D_OUT[43:42] == 2'd1 && txDCPPos == 5'd5 ||
	       dcpRespF$D_OUT[43:42] != 2'd1 && txDCPPos == 5'd9)) ;
  assign status__h82536 = { 16'd0, x__h82816 } ;
  assign txDCPPos_88_PLUS_1___d1210 = txDCPPos + 5'd1 ;
  assign wci_wslv_reqF_i_notEmpty__4_AND_IF_wci_wslv_re_ETC___d957 =
	     wci_wslv_reqF$EMPTY_N &&
	     (wci_wslv_reqF$D_OUT[39] ?
		mdi_fRequest$FULL_N :
		wci_wslv_respF_c_r != 2'd2) ;
  assign x__h72782 = rxLenCount + 32'd1 ;
  assign x__h82816 = { wsiM_statusR, wsiS_statusR } ;
  assign x__h82974 = { wsiS_statusR, wsiM_statusR } ;
  assign x_data__h28317 =
	     { mdi_vrReadData_15,
	       mdi_vrReadData_14,
	       mdi_vrReadData_13,
	       mdi_vrReadData_12,
  ...
  begin
    case (rxDCPMesgPos)
      5'd6: tag__h72991 = rxDCPMesg[7:0];
      5'd7: tag__h72991 = rxDCPMesg[15:8];
      5'd8: tag__h72991 = rxDCPMesg[23:16];
      5'd9: tag__h72991 = rxDCPMesg[31:24];
      5'd10: tag__h72991 = rxDCPMesg[39:32];
      5'd11: tag__h72991 = rxDCPMesg[47:40];
      5'd12: tag__h72991 = rxDCPMesg[55:48];
      5'd13: tag__h72991 = rxDCPMesg[63:56];
      5'd14: tag__h72991 = rxDCPMesg[71:64];
      5'd15: tag__h72991 = rxDCPMesg[79:72];
      5'd16: tag__h72991 = rxDCPMesg[87:80];
      5'd17: tag__h72991 = rxDCPMesg[95:88];
      5'd18: tag__h72991 = rxDCPMesg[103:96];
      default: tag__h72991 = rxDCPMesg[111:104];
    endcase
  end
  ...
  begin
    case (txDCPPos)
	  ...
	  IF_txDCPPos_88_EQ_0_89_OR_txDCPPos_88_EQ_1_90__ETC___d1298 =
	      gmac$RDY_tx_put;
      default: IF_txDCPPos_88_EQ_0_89_OR_txDCPPos_88_EQ_1_90__ETC___d1298 =
		   txDCPPos != 5'd9 || gmac$RDY_tx_put;
    endcase
  end
  always@(dcpRespF$D_OUT or
	  IF_txDCPPos_88_EQ_0_89_OR_txDCPPos_88_EQ_1_90__ETC___d1298 or
  ...
  begin
    case (rxDCPMesgPos)
	  ...
	  IF_rxDCPMesgPos_49_EQ_5_90_THEN_rxDCPMesg_56_B_ETC___d1162 =
	      rxDCPMesg[103:96];
      default: IF_rxDCPMesgPos_49_EQ_5_90_THEN_rxDCPMesg_56_B_ETC___d1162 =
		   rxDCPMesg[111:104];
    endcase
  end
  always@(IF_rxDCPMesgPos_49_EQ_5_90_THEN_rxDCPMesg_56_B_ETC___d1162 or
  ...
  begin
    case (IF_rxDCPMesgPos_49_EQ_5_90_THEN_rxDCPMesg_56_B_ETC___d1162[7:4])
	  ...
	  CASE_IF_rxDCPMesgPos_49_EQ_5_90_THEN_rxDCPMesg_ETC__q4 =
	      dcp_dcpReqF$FULL_N;
      default: CASE_IF_rxDCPMesgPos_49_EQ_5_90_THEN_rxDCPMesg_ETC__q4 =
		   IF_rxDCPMesgPos_49_EQ_5_90_THEN_rxDCPMesg_56_B_ETC___d1162[7:4] !=
		   4'd2 ||
		   dcp_dcpReqF$FULL_N;
    endcase
  ...
  always@(wci_wslv_reqF$D_OUT or
	  ...
	  rdat___1__h93712 or
	  rdat___1__h96213 or
	  rdat___1__h97820 or rdat___1__h99390 or rdat___1__h100960)
  begin
    case (wci_wslv_reqF$D_OUT[39:32])
	  ...
	  IF_wci_wslv_reqF_first__5_BITS_39_TO_32_32_EQ__ETC___d1085 =
	      rdat___1__h100960;
      default: IF_wci_wslv_reqF_first__5_BITS_39_TO_32_32_EQ__ETC___d1085 =
		   32'd0;
    endcase
  end
  ...
  always@(dcpRespF$D_OUT or
	  IF_txDCPPos_88_EQ_9_06_THEN_0_ELSE_txDCPPos_88_ETC___d1281 or
	  txDCPPos or txDCPPos_88_PLUS_1___d1210)
  begin
    case (dcpRespF$D_OUT[43:42])
      2'd0:
	  CASE_dcpRespFD_OUT_BITS_43_TO_42_IF_txDCPPos__ETC__q11 =
	      IF_txDCPPos_88_EQ_9_06_THEN_0_ELSE_txDCPPos_88_ETC___d1281;
      2'd1:
	  CASE_dcpRespFD_OUT_BITS_43_TO_42_IF_txDCPPos__ETC__q11 =
	      (txDCPPos == 5'd5) ? 5'd0 : txDCPPos_88_PLUS_1___d1210;
