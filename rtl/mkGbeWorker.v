...
//
// On Wed Sep 12 08:16:23 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkGbeWorker(CLK_gmii_rx_clk,
  ...
  reg [63 : 0] v__h103291, v__h3630, v__h3804, v__h3948, v__h83022, v__h83311;
  reg [31 : 0] IF_wci_wslv_reqF_first__5_BITS_39_TO_32_60_EQ__ETC___d1113;
  ...
  reg [7 : 0] CASE_13_MINUS_txDCPPos_rxHdr_sV_BITS_63_TO_56__ETC__q6,
	      ...
	      IF_rxDCPMesgPos_75_EQ_5_16_THEN_rxDCPMesg_82_B_ETC___d1178,
	      tag__h73509;
  ...
  wire [31 : 0] rdat___1__h101520,
		...
		status__h83096,
		x__h73300;
  wire [15 : 0] x__h83376, x__h83534, x_data__h28317;
  wire [4 : 0] IF_txDCPPos_16_EQ_9_34_THEN_0_ELSE_txDCPPos_16_ETC___d1308,
	       txDCPPos_16_PLUS_1___d1230;
  wire [2 : 0] d0__h12220,
	       d10__h12210,
	       d11__h12209,
	       d12__h12208,
  ...
  wire IF_dcp_dcpReqF_first__42_BITS_78_TO_77_43_EQ_0_ETC___d475,
       ...
       NOT_rxHdr_sV_56_BIT_112_57_74_AND_rxHdr_sV_56__ETC___d872,
       dcpRespF_i_notEmpty__12_AND_IF_dcpRespF_first__ETC___d848,
       dcp_dcpReqF_first__42_BITS_39_TO_32_47_EQ_IF_d_ETC___d1321,
       dcp_dcpReqF_first__42_BITS_71_TO_64_60_EQ_IF_d_ETC___d1322,
       ...
       rxHdr_sV_56_BIT_112_57_OR_NOT_rxHdr_sV_56_BITS_ETC___d955,
       wci_wslv_reqF_i_notEmpty__4_AND_IF_wci_wslv_re_ETC___d985;
  ...
  FIFO2 #(.width(32'd79), .guarded(32'd1)) dcp_dcpReqF(.RST_N(wciS0_MReset_n),
						       .CLK(wciS0_Clk),
  ...
  assign MUX_wci_wslv_respF_q_1$write_1__VAL_2 =
	     (wci_wslv_respF_c_r == 2'd2) ?
	       MUX_wci_wslv_respF_q_0$write_1__VAL_1 :
	       34'h0AAAAAAAA ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_1 = { 2'd1, rdat__h83295 } ;
  ...
  // register rxLenCount
  assign rxLenCount$D_IN = (gmac$rx_get[9:8] == 2'd0) ? x__h73300 : 32'd0 ;
  assign rxLenCount$EN = WILL_FIRE_RL_rx_data ;

  // register rxLenLast
  assign rxLenLast$D_IN = x__h73300 ;
  ...
  assign txDCPPos$D_IN =
	     (!rxHdr_sV[112] && rxHdr_sV[15:0] == 16'hF040) ?
	       ((txDCPPos == 5'd13) ? 5'd0 : txDCPPos_16_PLUS_1___d1230) :
  ...
  // submodule dcp_dcpReqF
  always@(IF_rxDCPMesgPos_75_EQ_5_16_THEN_rxDCPMesg_82_B_ETC___d1178 or
	  tag__h73509 or rxDCPMesg)
  begin
    case (IF_rxDCPMesgPos_75_EQ_5_16_THEN_rxDCPMesg_82_B_ETC___d1178[5:4])
      2'd0:
	  dcp_dcpReqF$D_IN = { 39'h1555555554, tag__h73509, rxDCPMesg[31:0] };
      2'd1:
	  dcp_dcpReqF$D_IN =
	      { IF_rxDCPMesgPos_75_EQ_5_16_THEN_rxDCPMesg_82_B_ETC___d1178[5:4],
		1'h0,
		IF_rxDCPMesgPos_75_EQ_5_16_THEN_rxDCPMesg_82_B_ETC___d1178[3:0],
		tag__h73509,
		rxDCPMesg[31:0],
		rxDCPMesg[63:32] };
  ...
  assign IF_rxHdr_pos_74_EQ_0_90_THEN_rxHdr_sV_56_BITS__ETC___d659 =
	     CASE_rxHdr_pos_rxHdr_sV_BITS_111_TO_104_0_rxHd_ETC__q1 ==
	     CASE_rxHdr_pos_rxHdr_pV_BITS_111_TO_104_0_rxHd_ETC__q2 ;
  assign IF_txDCPPos_16_EQ_9_34_THEN_0_ELSE_txDCPPos_16_ETC___d1308 =
	     (txDCPPos == 5'd9) ? 5'd0 : txDCPPos_16_PLUS_1___d1230 ;
  assign NOT_rxHdr_sV_56_BIT_112_57_74_AND_rxHdr_sV_56__ETC___d680 =
	     !rxHdr_sV[112] && rxHdr_sV[15:0] == 16'hF040 &&
	     { 3'd0, rxDCPMesgPos } < rxDCPPLI ;
  assign NOT_rxHdr_sV_56_BIT_112_57_74_AND_rxHdr_sV_56__ETC___d872 =
	     !rxHdr_sV[112] && rxHdr_sV[15:0] == 16'hF040 ||
  ...
  assign dcpRespF_i_notEmpty__12_AND_IF_dcpRespF_first__ETC___d848 =
	     dcpRespF$EMPTY_N &&
	     CASE_dcpRespFD_OUT_BITS_44_TO_43_IF_txDCPPos__ETC__q3 ;
  assign dcp_dcpReqF_first__42_BITS_39_TO_32_47_EQ_IF_d_ETC___d1321 =
	     dcp_dcpReqF$D_OUT[39:32] == dcp_lastTag[7:0] ;
  assign dcp_dcpReqF_first__42_BITS_71_TO_64_60_EQ_IF_d_ETC___d1322 =
  ...
  assign rdat___1__h101520 = hasDebugLogic ? rxHeadCap[31:0] : 32'd0 ;
  assign rdat___1__h83530 = hasDebugLogic ? { 16'd0, x__h83534 } : 32'd0 ;
  assign rdat___1__h83581 =
	     hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat___1__h83622 =
	     hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat___1__h83657 =
	     hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat___1__h83690 =
	     hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat___1__h83731 =
	     hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat___1__h83766 = hasDebugLogic ? txDBGCnt : 32'd0 ;
  assign rdat___1__h83800 = hasDebugLogic ? rxCount : 32'd0 ;
  assign rdat___1__h83833 = hasDebugLogic ? txCount : 32'd0 ;
  assign rdat___1__h83867 = hasDebugLogic ? rxOvfCount : 32'd0 ;
  assign rdat___1__h83900 = hasDebugLogic ? txUndCount : 32'd0 ;
  assign rdat___1__h83933 = hasDebugLogic ? rxValidNoEOPC : 32'd0 ;
  assign rdat___1__h83966 = hasDebugLogic ? rxValidEOPC : 32'd0 ;
  assign rdat___1__h83999 = hasDebugLogic ? rxEmptyEOPC : 32'd0 ;
  assign rdat___1__h84032 = hasDebugLogic ? rxAbortEOPC : 32'd0 ;
  assign rdat___1__h84065 = hasDebugLogic ? rxDCPCnt : 32'd0 ;
  assign rdat___1__h84099 = hasDebugLogic ? rxHdrMatchCnt : 32'd0 ;
  assign rdat___1__h84132 = hasDebugLogic ? rxLenLast : 32'd0 ;
  assign rdat___1__h84166 = hasDebugLogic ? txDCPCnt : 32'd0 ;
  assign rdat___1__h84200 = hasDebugLogic ? { 28'd0, rxHdr_pos } : 32'd0 ;
  assign rdat___1__h84237 = hasDebugLogic ? { 28'd0, rxHdr_mCnt } : 32'd0 ;
  assign rdat___1__h84274 =
	     hasDebugLogic ? { 16'd0, rxHdr_sV[111:96] } : 32'd0 ;
  assign rdat___1__h86775 = hasDebugLogic ? rxHdr_sV[95:64] : 32'd0 ;
  assign rdat___1__h89273 =
	     hasDebugLogic ? { 16'd0, rxHdr_sV[63:48] } : 32'd0 ;
  assign rdat___1__h91774 = hasDebugLogic ? rxHdr_sV[47:16] : 32'd0 ;
  assign rdat___1__h94272 =
	     hasDebugLogic ? { 16'd0, rxHdr_sV[15:0] } : 32'd0 ;
  assign rdat___1__h96773 = hasDebugLogic ? rxHeadCap[127:96] : 32'd0 ;
  assign rdat___1__h98380 = hasDebugLogic ? rxHeadCap[95:64] : 32'd0 ;
  assign rdat___1__h99950 = hasDebugLogic ? rxHeadCap[63:32] : 32'd0 ;
  assign rdat__h83295 =
	     wci_wslv_reqF$D_OUT[39] ?
	       32'd0 :
	       IF_wci_wslv_reqF_first__5_BITS_39_TO_32_60_EQ__ETC___d1113 ;
  assign rxHdr_sV_56_BIT_112_57_OR_NOT_rxHdr_sV_56_BITS_ETC___d955 =
	     (rxHdr_sV[112] || rxHdr_sV[15:0] != 16'hF040) &&
	     (dcpRespF$D_OUT[44:43] == 2'd0 && txDCPPos == 5'd9 ||
	      dcpRespF$D_OUT[44:43] != 2'd0 &&
	      (dcpRespF$D_OUT[44:43] == 2'd1 && txDCPPos == 5'd5 ||
	       dcpRespF$D_OUT[44:43] != 2'd1 && txDCPPos == 5'd9)) ;
  assign status__h83096 = { 16'd0, x__h83376 } ;
  assign txDCPPos_16_PLUS_1___d1230 = txDCPPos + 5'd1 ;
  assign wci_wslv_reqF_i_notEmpty__4_AND_IF_wci_wslv_re_ETC___d985 =
	     wci_wslv_reqF$EMPTY_N &&
	     (wci_wslv_reqF$D_OUT[39] ?
		mdi_fRequest$FULL_N :
		wci_wslv_respF_c_r != 2'd2) ;
  assign x__h73300 = rxLenCount + 32'd1 ;
  assign x__h83376 = { wsiM_statusR, wsiS_statusR } ;
  assign x__h83534 = { wsiS_statusR, wsiM_statusR } ;
  ...
  begin
    case (rxDCPMesgPos)
      5'd6: tag__h73509 = rxDCPMesg[7:0];
      5'd7: tag__h73509 = rxDCPMesg[15:8];
      5'd8: tag__h73509 = rxDCPMesg[23:16];
      5'd9: tag__h73509 = rxDCPMesg[31:24];
      5'd10: tag__h73509 = rxDCPMesg[39:32];
      5'd11: tag__h73509 = rxDCPMesg[47:40];
      5'd12: tag__h73509 = rxDCPMesg[55:48];
      5'd13: tag__h73509 = rxDCPMesg[63:56];
      5'd14: tag__h73509 = rxDCPMesg[71:64];
      5'd15: tag__h73509 = rxDCPMesg[79:72];
      5'd16: tag__h73509 = rxDCPMesg[87:80];
      5'd17: tag__h73509 = rxDCPMesg[95:88];
      5'd18: tag__h73509 = rxDCPMesg[103:96];
      default: tag__h73509 = rxDCPMesg[111:104];
    endcase
  end
  ...
  begin
    case (txDCPPos)
	  ...
	  IF_txDCPPos_16_EQ_0_17_OR_txDCPPos_16_EQ_1_18__ETC___d1326 =
	      gmac$RDY_tx_put;
      default: IF_txDCPPos_16_EQ_0_17_OR_txDCPPos_16_EQ_1_18__ETC___d1326 =
		   txDCPPos != 5'd9 || gmac$RDY_tx_put;
    endcase
  end
  always@(dcpRespF$D_OUT or
	  IF_txDCPPos_16_EQ_0_17_OR_txDCPPos_16_EQ_1_18__ETC___d1326 or
  ...
  begin
    case (rxDCPMesgPos)
	  ...
	  IF_rxDCPMesgPos_75_EQ_5_16_THEN_rxDCPMesg_82_B_ETC___d1178 =
	      rxDCPMesg[103:96];
      default: IF_rxDCPMesgPos_75_EQ_5_16_THEN_rxDCPMesg_82_B_ETC___d1178 =
		   rxDCPMesg[111:104];
    endcase
  end
  always@(IF_rxDCPMesgPos_75_EQ_5_16_THEN_rxDCPMesg_82_B_ETC___d1178 or
  ...
  always@(wci_wslv_reqF$D_OUT or
	  ...
	  rdat___1__h94272 or
	  rdat___1__h96773 or
	  rdat___1__h98380 or rdat___1__h99950 or rdat___1__h101520)
  begin
    case (wci_wslv_reqF$D_OUT[39:32])
	  ...
	  IF_wci_wslv_reqF_first__5_BITS_39_TO_32_60_EQ__ETC___d1113 =
	      rdat___1__h101520;
      default: IF_wci_wslv_reqF_first__5_BITS_39_TO_32_60_EQ__ETC___d1113 =
		   32'd0;
    endcase
  end
  ...
  always@(dcpRespF$D_OUT or
	  IF_txDCPPos_16_EQ_9_34_THEN_0_ELSE_txDCPPos_16_ETC___d1308 or
	  txDCPPos or txDCPPos_16_PLUS_1___d1230)
  begin
    case (dcpRespF$D_OUT[44:43])
      2'd0:
	  CASE_dcpRespFD_OUT_BITS_44_TO_43_IF_txDCPPos__ETC__q11 =
	      IF_txDCPPos_16_EQ_9_34_THEN_0_ELSE_txDCPPos_16_ETC___d1308;
      2'd1:
	  CASE_dcpRespFD_OUT_BITS_44_TO_43_IF_txDCPPos__ETC__q11 =
	      (txDCPPos == 5'd5) ? 5'd0 : txDCPPos_16_PLUS_1___d1230;
