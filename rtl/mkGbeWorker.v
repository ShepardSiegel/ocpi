...
//
// On Tue Feb  7 16:36:57 EST 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkGbeWorker(CLK_gmii_rx_clk,
  ...
  wire [31 : 0] IF_emac_rx_buffer_rRdPackets_rsCounter_99_BIT__ETC___d1533,
		IF_emac_rx_buffer_rRdPackets_rsCounter_99_BIT__ETC___d1534,
		IF_emac_rx_buffer_rWrPackets_rsCounter_69_BIT__ETC___d1526,
		IF_emac_rx_buffer_rWrPackets_rsCounter_69_BIT__ETC___d1527,
		IF_emac_tx_buffer_rRdPackets_rsCounter_069_BIT_ETC___d1546,
		IF_emac_tx_buffer_rRdPackets_rsCounter_069_BIT_ETC___d1547,
		IF_emac_tx_buffer_rWrPackets_rsCounter_52_BIT__ETC___d1539,
		IF_emac_tx_buffer_rWrPackets_rsCounter_52_BIT__ETC___d1540,
		status__h39250,
		x_data__h38672;
  wire [15 : 0] x__h39396;
  wire [11 : 0] x_burstLength__h38671;
  wire [7 : 0] x__h17132,
	       x__h23731,
	       x__h27919,
	       x__h34672,
  ...
  wire [1 : 0] ab__h21857, ab__h32596;
  wire IF_emac_rx_buffer_fifoDeq_rw_enq_whas__86_THEN_ETC___d1581,
       IF_emac_tx_buffer_fifoEnq_rw_enq_whas__40_THEN_ETC___d1536,
       IF_emac_tx_buffer_fifoEnq_rw_enq_whas__40_THEN_ETC___d1537,
       ...
       emac_rx_buffer_rRdPackets_rsCounter_99_BIT_0_0_ETC___d1419,
       emac_rx_buffer_rWrPackets_rsCounter_69_BIT_0_7_ETC___d1418,
       ...
       emac_tx_buffer_rRdPackets_rsCounter_069_BIT_0__ETC___d1421,
       emac_tx_buffer_rWrPackets_rsCounter_52_BIT_0_5_ETC___d1420,
       z__h17152,
       z__h17159,
       z__h17166,
       z__h17173,
  ...
  assign MUX_emac_rx_buffer_rRdPackets_rsCounter$write_1__VAL_1 =
	     (~emac_rx_buffer_rRdPackets_rsCounter[IF_emac_rx_buffer_rRdPackets_rsCounter_99_BIT__ETC___d1534[2:0]]) ?
	       emac_rx_buffer_rRdPackets_rsCounter | x__h23731 :
	       emac_rx_buffer_rRdPackets_rsCounter & y__h24396 ;
  ...
  assign MUX_emac_rx_buffer_rWrPackets_rsCounter$write_1__VAL_1 =
	     (~emac_rx_buffer_rWrPackets_rsCounter[IF_emac_rx_buffer_rWrPackets_rsCounter_69_BIT__ETC___d1527[2:0]]) ?
	       emac_rx_buffer_rWrPackets_rsCounter | x__h17132 :
	       emac_rx_buffer_rWrPackets_rsCounter & y__h17797 ;
  ...
  assign MUX_emac_tx_buffer_rRdPackets_rsCounter$write_1__VAL_1 =
	     (~emac_tx_buffer_rRdPackets_rsCounter[IF_emac_tx_buffer_rRdPackets_rsCounter_069_BIT_ETC___d1547[2:0]]) ?
	       emac_tx_buffer_rRdPackets_rsCounter | x__h34672 :
	       emac_tx_buffer_rRdPackets_rsCounter & y__h35337 ;
  ...
  assign MUX_emac_tx_buffer_rWrPackets_rsCounter$write_1__VAL_1 =
	     (~emac_tx_buffer_rWrPackets_rsCounter[IF_emac_tx_buffer_rWrPackets_rsCounter_52_BIT__ETC___d1540[2:0]]) ?
	       emac_tx_buffer_rWrPackets_rsCounter | x__h27919 :
	       emac_tx_buffer_rWrPackets_rsCounter & y__h28584 ;
  ...
  assign MUX_wsiM_reqFifo_q_0$write_1__VAL_1 =
	     { 3'd1,
	       IF_emac_rx_buffer_fifoDeq_rw_enq_whas__86_THEN_ETC___d1581,
	       1'd0,
	       x_burstLength__h38671,
	       x_data__h38672,
	       12'd3840 } ;
  ...
  assign emac_rx_buffer_memBuffer_serverAdapterB_s1_1$wget =
	     { 1'd1, !ab__h21857[1] || ab__h21857[0] } ;
  ...
  assign emac_tx_buffer_memBuffer_serverAdapterB_s1_1$wget =
	     { 1'd1, !ab__h32596[1] || ab__h32596[0] } ;
  ...
  // remaining internal signals
  assign IF_emac_rx_buffer_fifoDeq_rw_enq_whas__86_THEN_ETC___d1581 =
	     WILL_FIRE_RL_emac_rx_buffer_dequeue_next_beat ?
  ...
  assign IF_emac_rx_buffer_rRdPackets_rsCounter_99_BIT__ETC___d1533 =
			   ...
			   (emac_rx_buffer_rRdPackets_rsCounter[4] ?
				 ...
				 (emac_rx_buffer_rRdPackets_rsCounter[6] ?
				    ...
				    (emac_rx_buffer_rRdPackets_rsCounter[7] ?
				       ...
				       32'd9)))))))) :
	       32'd7 ;
  assign IF_emac_rx_buffer_rRdPackets_rsCounter_99_BIT__ETC___d1534 =
	     emac_rx_buffer_rRdPackets_rsCounter_99_BIT_0_0_ETC___d1419 ?
	       IF_emac_rx_buffer_rRdPackets_rsCounter_99_BIT__ETC___d1533 :
	       32'd0 ;
  assign IF_emac_rx_buffer_rWrPackets_rsCounter_69_BIT__ETC___d1526 =
			   ...
			   (emac_rx_buffer_rWrPackets_rsCounter[4] ?
				 ...
				 (emac_rx_buffer_rWrPackets_rsCounter[6] ?
				    ...
				    (emac_rx_buffer_rWrPackets_rsCounter[7] ?
				       ...
				       32'd9)))))))) :
	       32'd7 ;
  assign IF_emac_rx_buffer_rWrPackets_rsCounter_69_BIT__ETC___d1527 =
	     emac_rx_buffer_rWrPackets_rsCounter_69_BIT_0_7_ETC___d1418 ?
	       IF_emac_rx_buffer_rWrPackets_rsCounter_69_BIT__ETC___d1526 :
	       32'd0 ;
  assign IF_emac_tx_buffer_fifoEnq_rw_enq_whas__40_THEN_ETC___d1536 =
	     MUX_wsiS_reqFifo_levelsValid$write_1__SEL_3 ?
	       emac_tx_buffer_fifoEnq_rw_enq$wget[9:8] == 2'd0 :
	       emac_tx_buffer_fifoEnq_taggedReg[10] &&
	       emac_tx_buffer_fifoEnq_taggedReg[9:8] == 2'd0 ;
  assign IF_emac_tx_buffer_fifoEnq_rw_enq_whas__40_THEN_ETC___d1537 =
	     MUX_wsiS_reqFifo_levelsValid$write_1__SEL_3 ?
	       emac_tx_buffer_fifoEnq_rw_enq$wget[9:8] == 2'd1 :
	       emac_tx_buffer_fifoEnq_taggedReg[10] &&
	       emac_tx_buffer_fifoEnq_taggedReg[9:8] == 2'd1 ;
  assign IF_emac_tx_buffer_rRdPackets_rsCounter_069_BIT_ETC___d1546 =
			   ...
			   (emac_tx_buffer_rRdPackets_rsCounter[4] ?
				 ...
				 (emac_tx_buffer_rRdPackets_rsCounter[6] ?
				    ...
				    (emac_tx_buffer_rRdPackets_rsCounter[7] ?
				       ...
				       32'd9)))))))) :
	       32'd7 ;
  assign IF_emac_tx_buffer_rRdPackets_rsCounter_069_BIT_ETC___d1547 =
	     emac_tx_buffer_rRdPackets_rsCounter_069_BIT_0__ETC___d1421 ?
	       IF_emac_tx_buffer_rRdPackets_rsCounter_069_BIT_ETC___d1546 :
	       32'd0 ;
  assign IF_emac_tx_buffer_rWrPackets_rsCounter_52_BIT__ETC___d1539 =
			   ...
			   (emac_tx_buffer_rWrPackets_rsCounter[4] ?
				 ...
				 (emac_tx_buffer_rWrPackets_rsCounter[6] ?
				    ...
				    (emac_tx_buffer_rWrPackets_rsCounter[7] ?
				       ...
				       32'd9)))))))) :
	       32'd7 ;
  assign IF_emac_tx_buffer_rWrPackets_rsCounter_52_BIT__ETC___d1540 =
	     emac_tx_buffer_rWrPackets_rsCounter_52_BIT_0_5_ETC___d1420 ?
	       IF_emac_tx_buffer_rWrPackets_rsCounter_52_BIT__ETC___d1539 :
	       32'd0 ;
  assign ab__h21857 = 2'd0 ;
  assign ab__h32596 = 2'd0 ;
  ...
  assign emac_rx_buffer_memBuffer_serverAdapterB_outDat_ETC___d831 =
	     ...
	     (emac_rx_buffer_memBuffer_serverAdapterB_outData_outData$wget[9:8] !=
	      ...
	      2'd1 ||
	      emac_rx_buffer_memBuffer_serverAdapterB_cnt_45_ETC___d807) ;
  assign emac_rx_buffer_rRdPackets_rsCounter_99_BIT_0_0_ETC___d1419 =
	     z__h23786 ^ emac_rx_buffer_rRdPackets_rsCounter[7] ;
  assign emac_rx_buffer_rWrPackets_rsCounter_69_BIT_0_7_ETC___d1418 =
	     z__h17187 ^ emac_rx_buffer_rWrPackets_rsCounter[7] ;
  ...
  assign emac_tx_buffer_memBuffer_serverAdapterB_outDat_ETC___d1192 =
	     ...
	     (emac_tx_buffer_memBuffer_serverAdapterB_outData_outData$wget[9:8] !=
	      2'd1 ||
	      emac_tx_buffer_memBuffer_serverAdapterB_cnt_02_ETC___d1159) ;
  assign emac_tx_buffer_rRdPackets_rsCounter_069_BIT_0__ETC___d1421 =
	     z__h34727 ^ emac_tx_buffer_rRdPackets_rsCounter[7] ;
  assign emac_tx_buffer_rWrPackets_rsCounter_52_BIT_0_5_ETC___d1420 =
	     z__h27974 ^ emac_tx_buffer_rWrPackets_rsCounter[7] ;
  assign status__h39250 = { 16'd0, x__h39396 } ;
  assign x__h17132 =
	     8'd1 <<
	     IF_emac_rx_buffer_rWrPackets_rsCounter_69_BIT__ETC___d1527 ;
  assign x__h23731 =
  ...
  assign x__h39396 = { wsiM_statusR, wsiS_statusR } ;
  assign x_burstLength__h38671 =
	     IF_emac_rx_buffer_fifoDeq_rw_enq_whas__86_THEN_ETC___d1581 ?
	       12'd1 :
	       12'd4095 ;
  assign x_data__h38672 = { 24'd0, x__h38736 } ;
  assign y__h17797 = ~x__h17132 ;
  assign y__h24396 = ~x__h23731 ;
  assign y__h28584 = ~x__h27919 ;
  assign y__h35337 = ~x__h34672 ;
  assign z__h17152 =
	     emac_rx_buffer_rWrPackets_rsCounter[0] ^
	     emac_rx_buffer_rWrPackets_rsCounter[1] ;
  assign z__h17159 = z__h17152 ^ emac_rx_buffer_rWrPackets_rsCounter[2] ;
  assign z__h17166 = z__h17159 ^ emac_rx_buffer_rWrPackets_rsCounter[3] ;
  assign z__h17173 = z__h17166 ^ emac_rx_buffer_rWrPackets_rsCounter[4] ;
  assign z__h17180 = z__h17173 ^ emac_rx_buffer_rWrPackets_rsCounter[5] ;
  assign z__h17187 = z__h17180 ^ emac_rx_buffer_rWrPackets_rsCounter[6] ;
  assign z__h23751 =
	     emac_rx_buffer_rRdPackets_rsCounter[0] ^
	     emac_rx_buffer_rRdPackets_rsCounter[1] ;
  assign z__h23758 = z__h23751 ^ emac_rx_buffer_rRdPackets_rsCounter[2] ;
  assign z__h23765 = z__h23758 ^ emac_rx_buffer_rRdPackets_rsCounter[3] ;
  assign z__h23772 = z__h23765 ^ emac_rx_buffer_rRdPackets_rsCounter[4] ;
  assign z__h23779 = z__h23772 ^ emac_rx_buffer_rRdPackets_rsCounter[5] ;
  assign z__h23786 = z__h23779 ^ emac_rx_buffer_rRdPackets_rsCounter[6] ;
  assign z__h27939 =
	     emac_tx_buffer_rWrPackets_rsCounter[0] ^
	     emac_tx_buffer_rWrPackets_rsCounter[1] ;
  assign z__h27946 = z__h27939 ^ emac_tx_buffer_rWrPackets_rsCounter[2] ;
  assign z__h27953 = z__h27946 ^ emac_tx_buffer_rWrPackets_rsCounter[3] ;
  assign z__h27960 = z__h27953 ^ emac_tx_buffer_rWrPackets_rsCounter[4] ;
  assign z__h27967 = z__h27960 ^ emac_tx_buffer_rWrPackets_rsCounter[5] ;
  assign z__h27974 = z__h27967 ^ emac_tx_buffer_rWrPackets_rsCounter[6] ;
  assign z__h34692 =
	     emac_tx_buffer_rRdPackets_rsCounter[0] ^
	     emac_tx_buffer_rRdPackets_rsCounter[1] ;
  assign z__h34699 = z__h34692 ^ emac_tx_buffer_rRdPackets_rsCounter[2] ;
  assign z__h34706 = z__h34699 ^ emac_tx_buffer_rRdPackets_rsCounter[3] ;
  assign z__h34713 = z__h34706 ^ emac_tx_buffer_rRdPackets_rsCounter[4] ;
  assign z__h34720 = z__h34713 ^ emac_tx_buffer_rRdPackets_rsCounter[5] ;
  assign z__h34727 = z__h34720 ^ emac_tx_buffer_rRdPackets_rsCounter[6] ;
  ...
  begin
    case (wciRx_wslv_reqF$D_OUT[39:32])
      8'h0: _theResult____h39315 = status__h39250;
      8'h04: _theResult____h39315 = gbeControl;
      8'h10: _theResult____h39315 = wsiM_extStatusW$wget[95:64];
      8'h14: _theResult____h39315 = wsiM_extStatusW$wget[63:32];
      8'h18: _theResult____h39315 = wsiS_extStatusW$wget[95:64];
      8'h1C: _theResult____h39315 = wsiS_extStatusW$wget[63:32];
      default: _theResult____h39315 = 32'd0;
    endcase
  end
