...
//
// On Fri Mar  9 11:13:22 EST 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkGbeWorker(CLK_gmii_rx_clk,
  ...
  // register rxHdrLast
  reg [127 : 0] rxHdrLast;
  wire [127 : 0] rxHdrLast$D_IN;
  wire rxHdrLast$EN;

  // register rxHdrMatch
  reg [4 : 0] rxHdrMatch;
  wire [4 : 0] rxHdrMatch$D_IN;
  wire rxHdrMatch$EN;
  ...
  // ports of submodule daF
  wire [7 : 0] daF$D_IN, daF$D_OUT;
  wire daF$CLR, daF$DEQ, daF$EMPTY_N, daF$ENQ, daF$FULL_N;
  ...
  // ports of submodule loopF
  wire [9 : 0] loopF$D_IN, loopF$D_OUT;
  wire loopF$CLR, loopF$DEQ, loopF$EMPTY_N, loopF$ENQ, loopF$FULL_N;
  ...
  // ports of submodule saF
  wire [7 : 0] saF$D_IN, saF$D_OUT;
  wire saF$CLR, saF$DEQ, saF$EMPTY_N, saF$ENQ, saF$FULL_N;
  ...
  reg [63 : 0] v__h3629, v__h3803, v__h3947, v__h43134, v__h43423, v__h46642;
  reg [31 : 0] CASE_wci_wslv_reqFD_OUT_BITS_39_TO_32_0_0x0_s_ETC__q2;
  reg [7 : 0] y__h38439;
  reg [3 : 0] x_byteEn__h33625;
  reg [1 : 0] CASE_gmacrx_get_BITS_9_TO_8_3_0_gmacrx_get_B_ETC__q3,
	      CASE_loopFD_OUT_BITS_9_TO_8_3_0_loopFD_OUT_B_ETC__q1;
  wire [101 : 0] _1448743543117976458853375091858__q4,
		 _643371375338640__q5,
		 bs__h12593,
		 bs__h25056;
  wire [60 : 0] _24577_CONCAT_IF_gmac_rx_get_75_BITS_9_TO_8_76__ETC___d505;
  wire [31 : 0] rdat___1__h43642,
		rdat___1__h43693,
		rdat___1__h43734,
		rdat___1__h43769,
		rdat___1__h43802,
		...
		x__h41885,
		x_data__h32892;
  wire [15 : 0] x__h43488, x__h43646, x_data__h28254;
  wire [9 : 0] IF_daF_notEmpty__06_THEN_0_CONCAT_daF_first__2_ETC___d635;
  wire [2 : 0] d0__h12219,
	       d10__h12209,
	       d11__h12208,
	       d12__h12207,
	       ...
	       ra3__h12199,
	       ra4__h12198;
  wire IF_saF_notEmpty__02_THEN_saF_RDY_deq__03_AND_s_ETC___d614,
       NOT_rxIdx_49_ULT_6_57_58_OR_NOT_gbeControl_51__ETC___d467,
       rxIdx_49_ULT_12_50_OR_NOT_gbeControl_51_BIT_8__ETC___d469,
       rxIdx_49_ULT_12___d450,
       rxIdx_49_ULT_16___d516,
       rxIdx_49_ULT_6___d457,
       wci_wslv_reqF_i_notEmpty__4_AND_IF_wci_wslv_re_ETC___d666;
  ...
  // submodule daF
  arSRLFIFOD #(.width(32'd8), .l2depth(32'd3)) daF(.CLK(wciS0_Clk),
  ...
  // submodule loopF
  arSRLFIFOD #(.width(32'd10), .l2depth(32'd4)) loopF(.CLK(wciS0_Clk),
						      .RST_N(wciS0_MReset_n),
						      .D_IN(loopF$D_IN),
						      .ENQ(loopF$ENQ),
						      .DEQ(loopF$DEQ),
  ...
  // submodule saF
  arSRLFIFOD #(.width(32'd8), .l2depth(32'd3)) saF(.CLK(wciS0_Clk),
						   .RST_N(wciS0_MReset_n),
						   .D_IN(saF$D_IN),
						   .ENQ(saF$ENQ),
						   .DEQ(saF$DEQ),
  ...
  assign WILL_FIRE_RL_tx_loopback =
	     gmac$RDY_tx_put &&
	     IF_saF_notEmpty__02_THEN_saF_RDY_deq__03_AND_s_ETC___d614 &&
	     wci_wslv_cState == 3'd2 &&
	     loopF$EMPTY_N ;
  ...
  assign MUX_wci_wslv_respF_q_1$write_1__VAL_2 =
	     (wci_wslv_respF_c_r == 2'd2) ?
	       MUX_wci_wslv_respF_q_0$write_1__VAL_1 :
	       34'h0AAAAAAAA ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_1 = { 2'd1, rdat__h43407 } ;
  ...
  assign MUX_wsiM_reqFifo_q_0$write_1__VAL_1 =
	     (gmac$rx_get[9:8] == 2'd0) ?
	       ...
	       _24577_CONCAT_IF_gmac_rx_get_75_BITS_9_TO_8_76__ETC___d505 ;
  ...
  // register mdi_rMDD
  assign mdi_rMDD$D_IN = bs__h12593[mdi_rPlayIndex$Q_OUT[6:0]] ;
  assign mdi_rMDD$EN = WILL_FIRE_RL_mdi_run_frame ;

  // register mdi_rOutEn
  assign mdi_rOutEn$D_IN = bs__h25056[mdi_rPlayIndex$Q_OUT[6:0]] ;
  ...
  // register rxHdrLast
  assign rxHdrLast$D_IN = rxHdrThis ;
  assign rxHdrLast$EN =
	     WILL_FIRE_RL_rx_data && gmac$rx_get[9:8] == 2'd0 &&
	     rxIdx == 5'd16 ;

  // register rxHdrMatch
  assign rxHdrMatch$D_IN =
	     (gmac$rx_get[9:8] == 2'd0) ?
	       ((gmac$rx_get[7:0] == y__h38439) ? rxHdrMatch + 5'd1 : 5'd0) :
	       5'd0 ;
  assign rxHdrMatch$EN =
	     WILL_FIRE_RL_rx_data &&
	     (rxIdx_49_ULT_16___d516 || gmac$rx_get[9:8] != 2'd0) ;

  // register rxHdrMatchCnt
  assign rxHdrMatchCnt$D_IN = rxHdrMatchCnt + 32'd1 ;
  ...
  // register rxHdrThis
  assign rxHdrThis$D_IN = { rxHdrThis[119:0], gmac$rx_get[7:0] } ;
  assign rxHdrThis$EN =
	     WILL_FIRE_RL_rx_data && gmac$rx_get[9:8] == 2'd0 &&
	     rxIdx_49_ULT_16___d516 ;
  ...
  assign rxIdx$D_IN =
	     (gmac$rx_get[9:8] == 2'd0) ?
	       ((rxIdx == 5'd31) ? rxIdx : rxIdx + 5'd1) :
	       5'd0 ;
  assign rxIdx$EN = WILL_FIRE_RL_rx_data ;

  // register rxLenCount
  assign rxLenCount$D_IN = (gmac$rx_get[9:8] == 2'd0) ? x__h41885 : 32'd0 ;
  assign rxLenCount$EN =
	     WILL_FIRE_RL_rx_data &&
	     (gmac$rx_get[9:8] == 2'd0 || gmac$rx_get[9:8] == 2'd1) ;

  // register rxLenLast
  assign rxLenLast$D_IN = x__h41885 ;
  ...
  // register rxPipe
  assign rxPipe$D_IN = x_data__h32892 ;
  assign rxPipe$EN = WILL_FIRE_RL_rx_data && gmac$rx_get[9:8] == 2'd0 ;
  ...
  assign txCount$EN = WILL_FIRE_RL_tx_loopback ;
  ...
  // submodule daF
  assign daF$D_IN = gmac$rx_get[7:0] ;
  assign daF$ENQ =
	     WILL_FIRE_RL_rx_data && gmac$rx_get[9:8] == 2'd0 &&
	     rxIdx_49_ULT_6___d457 &&
	     gbeControl[8] ;
  assign daF$DEQ = WILL_FIRE_RL_tx_loopback && !saF$EMPTY_N && daF$EMPTY_N ;
  assign daF$CLR = 1'b0 ;
  ...
  assign gmac$tx_put =
	     saF$EMPTY_N ?
	       { 2'd0, saF$D_OUT } :
	       IF_daF_notEmpty__06_THEN_0_CONCAT_daF_first__2_ETC___d635 ;
  assign gmac$EN_rx_get = WILL_FIRE_RL_rx_data ;
  assign gmac$EN_tx_put = WILL_FIRE_RL_tx_loopback ;
  ...
  assign loopF$D_IN =
	     { CASE_gmacrx_get_BITS_9_TO_8_3_0_gmacrx_get_B_ETC__q3,
	       gmac$rx_get[7:0] } ;
  assign loopF$ENQ =
	     WILL_FIRE_RL_rx_data && !rxIdx_49_ULT_12___d450 &&
	     gbeControl[8] ;
  assign loopF$DEQ =
	     WILL_FIRE_RL_tx_loopback && !saF$EMPTY_N && !daF$EMPTY_N ;
  assign loopF$CLR = 1'b0 ;
  ...
  // submodule mdi_fResponse
  assign mdi_fResponse$D_IN = { 1'd1, x_data__h28254 } ;
  ...
  // submodule saF
  assign saF$D_IN = gmac$rx_get[7:0] ;
  assign saF$ENQ =
	     WILL_FIRE_RL_rx_data && gmac$rx_get[9:8] == 2'd0 &&
	     !rxIdx_49_ULT_6___d457 &&
	     rxIdx_49_ULT_12___d450 &&
	     gbeControl[8] ;
  assign saF$DEQ = WILL_FIRE_RL_tx_loopback && saF$EMPTY_N ;
  assign saF$CLR = 1'b0 ;
  ...
  // remaining internal signals
  assign IF_daF_notEmpty__06_THEN_0_CONCAT_daF_first__2_ETC___d635 =
	     daF$EMPTY_N ?
	       { 2'd0, daF$D_OUT } :
	       { CASE_loopFD_OUT_BITS_9_TO_8_3_0_loopFD_OUT_B_ETC__q1,
		 loopF$D_OUT[7:0] } ;
  assign IF_saF_notEmpty__02_THEN_saF_RDY_deq__03_AND_s_ETC___d614 =
	     saF$EMPTY_N ?
	       saF$EMPTY_N :
	       (daF$EMPTY_N ? daF$EMPTY_N : loopF$EMPTY_N) ;
  assign NOT_rxIdx_49_ULT_6_57_58_OR_NOT_gbeControl_51__ETC___d467 =
	     (!rxIdx_49_ULT_6___d457 || !gbeControl[8] || daF$FULL_N) &&
	     (rxIdx_49_ULT_6___d457 || !rxIdx_49_ULT_12___d450 ||
	      !gbeControl[8] ||
	      saF$FULL_N) ;
  assign _1448743543117976458853375091858__q4 =
	     102'h12492492492492492492492492 ;
  assign _24577_CONCAT_IF_gmac_rx_get_75_BITS_9_TO_8_76__ETC___d505 =
	     { 17'd24577,
	       (gmac$rx_get[9:8] == 2'd1) ? x_data__h32892 : rxPipe,
	       x_byteEn__h33625,
	       8'd0 } ;
  ...
  assign d0__h12219 = {3{mdi_rWriteData[0]}} ;
  assign d10__h12209 = {3{mdi_rWriteData[10]}} ;
  assign d11__h12208 = {3{mdi_rWriteData[11]}} ;
  assign d12__h12207 = {3{mdi_rWriteData[12]}} ;
  assign d13__h12206 = {3{mdi_rWriteData[13]}} ;
  assign d14__h12205 = {3{mdi_rWriteData[14]}} ;
  assign d15__h12204 = {3{mdi_rWriteData[15]}} ;
  assign d1__h12218 = {3{mdi_rWriteData[1]}} ;
  assign d2__h12217 = {3{mdi_rWriteData[2]}} ;
  assign d3__h12216 = {3{mdi_rWriteData[3]}} ;
  assign d4__h12215 = {3{mdi_rWriteData[4]}} ;
  assign d5__h12214 = {3{mdi_rWriteData[5]}} ;
  assign d6__h12213 = {3{mdi_rWriteData[6]}} ;
  assign d7__h12212 = {3{mdi_rWriteData[7]}} ;
  assign d8__h12211 = {3{mdi_rWriteData[8]}} ;
  assign d9__h12210 = {3{mdi_rWriteData[9]}} ;
  assign pa0__h12196 = {3{mdi_rPhyAddr[0]}} ;
  assign pa1__h12195 = {3{mdi_rPhyAddr[1]}} ;
  assign pa2__h12194 = {3{mdi_rPhyAddr[2]}} ;
  assign pa3__h12193 = {3{mdi_rPhyAddr[3]}} ;
  assign pa4__h12192 = {3{mdi_rPhyAddr[4]}} ;
  assign ra0__h12202 = {3{mdi_rRegAddr[0]}} ;
  assign ra1__h12201 = {3{mdi_rRegAddr[1]}} ;
  assign ra2__h12200 = {3{mdi_rRegAddr[2]}} ;
  assign ra3__h12199 = {3{mdi_rRegAddr[3]}} ;
  assign ra4__h12198 = {3{mdi_rRegAddr[4]}} ;
  assign rdat___1__h43642 = hasDebugLogic ? { 16'd0, x__h43646 } : 32'd0 ;
  assign rdat___1__h43693 =
	     hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat___1__h43734 =
	     hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat___1__h43769 =
	     hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat___1__h43802 =
	     hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat___1__h43843 =
	     hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat___1__h43878 =
	     hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat___1__h43911 = hasDebugLogic ? rxCount : 32'd0 ;
  assign rdat___1__h43944 = hasDebugLogic ? txCount : 32'd0 ;
  assign rdat___1__h43977 = hasDebugLogic ? rxOvfCount : 32'd0 ;
  assign rdat___1__h44010 = hasDebugLogic ? txUndCount : 32'd0 ;
  assign rdat___1__h44043 = hasDebugLogic ? rxValidNoEOPC : 32'd0 ;
  assign rdat___1__h44076 = hasDebugLogic ? rxValidEOPC : 32'd0 ;
  assign rdat___1__h44109 = hasDebugLogic ? rxEmptyEOPC : 32'd0 ;
  assign rdat___1__h44142 = hasDebugLogic ? rxAbortEOPC : 32'd0 ;
  assign rdat___1__h44175 = hasDebugLogic ? rxHdrLast[127:96] : 32'd0 ;
  assign rdat___1__h44727 = hasDebugLogic ? rxHdrLast[95:64] : 32'd0 ;
  assign rdat___1__h45279 = hasDebugLogic ? rxHdrLast[63:32] : 32'd0 ;
  assign rdat___1__h45831 = hasDebugLogic ? rxHdrLast[31:0] : 32'd0 ;
  assign rdat___1__h46383 = hasDebugLogic ? rxLenLast : 32'd0 ;
  assign rdat___1__h46417 = hasDebugLogic ? rxHdrMatchCnt : 32'd0 ;
  assign rdat__h43407 =
	     wci_wslv_reqF$D_OUT[39] ?
	       32'd0 :
	       CASE_wci_wslv_reqFD_OUT_BITS_39_TO_32_0_0x0_s_ETC__q2 ;
  assign rxIdx_49_ULT_12_50_OR_NOT_gbeControl_51_BIT_8__ETC___d469 =
	     (rxIdx_49_ULT_12___d450 || !gbeControl[8] || loopF$FULL_N) &&
	     NOT_rxIdx_49_ULT_6_57_58_OR_NOT_gbeControl_51__ETC___d467 &&
	     wsiM_reqFifo_c_r != 2'd2 ;
  assign rxIdx_49_ULT_12___d450 = rxIdx < 5'd12 ;
  assign rxIdx_49_ULT_16___d516 = rxIdx < 5'd16 ;
  assign rxIdx_49_ULT_6___d457 = rxIdx < 5'd6 ;
  assign status__h43208 = { 16'd0, x__h43488 } ;
  assign wci_wslv_reqF_i_notEmpty__4_AND_IF_wci_wslv_re_ETC___d666 =
	     wci_wslv_reqF$EMPTY_N &&
	     (wci_wslv_reqF$D_OUT[39] ?
		mdi_fRequest$FULL_N :
		wci_wslv_respF_c_r != 2'd2) ;
  assign x__h41885 = rxLenCount + 32'd1 ;
  assign x__h43488 = { wsiM_statusR, wsiS_statusR } ;
  assign x__h43646 = { wsiS_statusR, wsiM_statusR } ;
  assign x_data__h28254 =
	     { mdi_vrReadData_15,
	       mdi_vrReadData_14,
	       mdi_vrReadData_13,
	       mdi_vrReadData_12,
	       ...
	       mdi_vrReadData_1,
	       mdi_vrReadData } ;
  assign x_data__h32892 = { rxPipe[23:0], gmac$rx_get[7:0] } ;
  always@(rxPos)
  begin
    case (rxPos)
      2'd0: x_byteEn__h33625 = 4'b0001;
      2'd1: x_byteEn__h33625 = 4'b0011;
      2'd2: x_byteEn__h33625 = 4'b0111;
      2'd3: x_byteEn__h33625 = 4'b1111;
    endcase
  end
  always@(rxIdx or rxHdrLast)
  begin
    case (5'd15 - rxIdx)
      5'd0: y__h38439 = rxHdrLast[7:0];
      5'd1: y__h38439 = rxHdrLast[15:8];
      5'd2: y__h38439 = rxHdrLast[23:16];
      5'd3: y__h38439 = rxHdrLast[31:24];
      5'd4: y__h38439 = rxHdrLast[39:32];
      5'd5: y__h38439 = rxHdrLast[47:40];
      5'd6: y__h38439 = rxHdrLast[55:48];
      5'd7: y__h38439 = rxHdrLast[63:56];
      5'd8: y__h38439 = rxHdrLast[71:64];
      5'd9: y__h38439 = rxHdrLast[79:72];
      5'd10: y__h38439 = rxHdrLast[87:80];
      5'd11: y__h38439 = rxHdrLast[95:88];
      5'd12: y__h38439 = rxHdrLast[103:96];
      5'd13: y__h38439 = rxHdrLast[111:104];
      5'd14: y__h38439 = rxHdrLast[119:112];
      default: y__h38439 = rxHdrLast[127:120];
    endcase
  end
  always@(loopF$D_OUT)
  begin
    case (loopF$D_OUT[9:8])
      2'd0, 2'd1, 2'd2:
	  CASE_loopFD_OUT_BITS_9_TO_8_3_0_loopFD_OUT_B_ETC__q1 =
	      loopF$D_OUT[9:8];
      2'd3: CASE_loopFD_OUT_BITS_9_TO_8_3_0_loopFD_OUT_B_ETC__q1 = 2'd3;
    endcase
  end
  always@(wci_wslv_reqF$D_OUT or
	  ...
	  rdat___1__h44727 or
	  rdat___1__h45279 or
	  rdat___1__h45831 or rdat___1__h46383 or rdat___1__h46417)
  begin
    case (wci_wslv_reqF$D_OUT[39:32])
	  ...
	  CASE_wci_wslv_reqFD_OUT_BITS_39_TO_32_0_0x0_s_ETC__q2 =
	      status__h43208;
      8'h04:
	  CASE_wci_wslv_reqFD_OUT_BITS_39_TO_32_0_0x0_s_ETC__q2 = gbeControl;
      8'h08:
	  CASE_wci_wslv_reqFD_OUT_BITS_39_TO_32_0_0x0_s_ETC__q2 =
	      rdat___1__h43642;
      8'h0C:
	  ...
	  CASE_wci_wslv_reqFD_OUT_BITS_39_TO_32_0_0x0_s_ETC__q2 =
	      rdat___1__h46417;
      default: CASE_wci_wslv_reqFD_OUT_BITS_39_TO_32_0_0x0_s_ETC__q2 = 32'd0;
    endcase
  end
  always@(gmac$rx_get)
  begin
  ...
  begin
	...
	rxHdrMatch <= `BSV_ASSIGNMENT_DELAY 5'd0;
	rxIdx <= `BSV_ASSIGNMENT_DELAY 5'd0;
	...
	if (rxHdrMatch$EN)
	  rxHdrMatch <= `BSV_ASSIGNMENT_DELAY rxHdrMatch$D_IN;
	if (rxIdx$EN) rxIdx <= `BSV_ASSIGNMENT_DELAY rxIdx$D_IN;
	if (rxLenCount$EN)
    ...
    if (rxHdrLast$EN) rxHdrLast <= `BSV_ASSIGNMENT_DELAY rxHdrLast$D_IN;
    if (rxHdrMatchCnt$EN)
      rxHdrMatchCnt <= `BSV_ASSIGNMENT_DELAY rxHdrMatchCnt$D_IN;
    if (rxHdrThis$EN) rxHdrThis <= `BSV_ASSIGNMENT_DELAY rxHdrThis$D_IN;
  ...
  begin
    ...
    rxHdrLast = 128'hAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA;
    rxHdrMatch = 5'h0A;
    rxHdrMatchCnt = 32'hAAAAAAAA;
    rxHdrThis = 128'hAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA;
    rxIdx = 5'h0A;
  ...
  begin
	...
	$display("Error: \"bsv/wrk/GbeWorker.bsv\", line 171, column 60: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_ctrl_IsO] and\n  [RL_wci_ctrl_OrE] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n)
	...
	$display("Error: \"bsv/wrk/GbeWorker.bsv\", line 171, column 36: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_cfrd] and\n  [RL_wci_ctrl_OrE] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n)
	...
	$display("Error: \"bsv/wrk/GbeWorker.bsv\", line 171, column 26: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_cfwr] and\n  [RL_wci_ctrl_OrE] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n)
	...
	$display("Error: \"bsv/wrk/GbeWorker.bsv\", line 171, column 46: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_ctrl_EiI] and\n  [RL_wci_ctrl_OrE] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n)
