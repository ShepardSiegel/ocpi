...
//
// On Sun May 15 10:02:46 EDT 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkAXISDWorker4B(wciS0_Clk,
  ...
  reg [63 : 0] v__h14764, v__h14917, v__h3626, v__h3800, v__h3944;
  reg [31 : 0] _theResult____h14901;
  wire [127 : 0] x_user__h11440;
  wire [31 : 0] rdat__h14991,
		rdat__h15091,
		rdat__h15105,
		rdat__h15113,
		rdat__h15119,
		...
		rdat__h15153,
		rdat__h15159;
  wire [15 : 0] aui_length__h11482, x__h12843, x__h14995;
  wire [11 : 0] x__h11491;
  ...
  // remaining internal signals
  assign aui_length__h11482 = { 4'd0, x__h11491 } ;
  assign rdat__h14991 = hasDebugLogic ? { 16'd0, x__h14995 } : 32'd0 ;
  assign rdat__h15091 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h15105 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h15113 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h15119 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h15133 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h15141 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h15147 = hasDebugLogic ? bypassCount : 32'd0 ;
  assign rdat__h15153 = hasDebugLogic ? axiSendCount : 32'd0 ;
  assign rdat__h15159 = hasDebugLogic ? axiRecvCount : 32'd0 ;
  assign wsiS_reqFifo_notFull__88_AND_wsiS_burstKind_03_ETC___d210 =
	     wsiS_reqFifo$FULL_N &&
	     (wsiS_burstKind == 2'd0 ||
	      (wsiS_burstKind == 2'd1 || wsiS_burstKind == 2'd2) &&
	      wsiS_wsiReq$wget[57]) ;
  assign x__h11491 = { axiM_reqFifo$D_OUT[53:44], 2'd0 } ;
  assign x__h12843 = axiS_axiS_fifof$D_OUT[16:1] >> 2 ;
  assign x__h14995 = { wsiS_statusR, wsiM_statusR } ;
  assign x_user__h11440 =
	     { 104'd1, axiM_reqFifo$D_OUT[7:0], aui_length__h11482 } ;
  always@(wci_wslv_reqF$D_OUT or
	  ...
	  rdat__h15119 or
	  rdat__h15133 or
	  rdat__h15141 or rdat__h15147 or rdat__h15153 or rdat__h15159)
  begin
    case (wci_wslv_reqF$D_OUT[39:32])
      8'h0: _theResult____h14901 = spareValue;
      8'h04: _theResult____h14901 = controlReg;
      8'h20: _theResult____h14901 = rdat__h14991;
      8'h24: _theResult____h14901 = rdat__h15091;
      8'h28: _theResult____h14901 = rdat__h15105;
      8'h2C: _theResult____h14901 = rdat__h15113;
      8'h30: _theResult____h14901 = rdat__h15119;
      8'h34: _theResult____h14901 = rdat__h15133;
      8'h38: _theResult____h14901 = rdat__h15141;
      8'h3C: _theResult____h14901 = rdat__h15147;
      8'h40: _theResult____h14901 = rdat__h15153;
      8'h44: _theResult____h14901 = rdat__h15159;
      default: _theResult____h14901 = 32'd0;
    endcase
  end
