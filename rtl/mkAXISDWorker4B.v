...
//
// On Thu Feb  2 08:20:59 EST 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkAXISDWorker4B(wciS0_Clk,
  ...
  reg [63 : 0] v__h15154, v__h15307, v__h3626, v__h3800, v__h3944;
  reg [31 : 0] _theResult____h15291;
  wire [127 : 0] x_user__h11430;
  wire [31 : 0] rdat__h15381,
		rdat__h15481,
		rdat__h15495,
		rdat__h15503,
		rdat__h15509,
  ...
  assign axiSendCount$EN = MUX_wsiS_reqFifo_levelsValid$write_1__SEL_3 ;
  ...
  assign axiM_reqFifo$ENQ = MUX_wsiS_reqFifo_levelsValid$write_1__SEL_3 ;
  ...
  assign rdat__h15381 = hasDebugLogic ? { 16'd0, x__h15385 } : 32'd0 ;
  assign rdat__h15481 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h15495 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h15503 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h15509 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h15523 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h15531 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h15537 = hasDebugLogic ? bypassCount : 32'd0 ;
  assign rdat__h15543 = hasDebugLogic ? axiSendCount : 32'd0 ;
  assign rdat__h15549 = hasDebugLogic ? axiRecvCount : 32'd0 ;
  assign x__h11533 = x__h11545 + y__h11546 ;
  assign x__h11545 = x__h11557 + y__h11558 ;
  assign x__h11557 = { 2'd0, axiM_reqFifo$D_OUT[11] } ;
  assign x__h15385 = { wsiS_statusR, wsiM_statusR } ;
  assign x_user__h11430 =
	     { 104'd1,
	       axiM_reqFifo$D_OUT[7:0],
	       { 4'd0,
		 axiM_reqFifoD_OUT_BITS_55_TO_44_MINUS_1__q1[9:0],
		 2'd0 } +
	       { 13'd0, x__h11533 + y__h11534 } } ;
  assign y__h11534 = { 2'd0, axiM_reqFifo$D_OUT[8] } ;
  assign y__h11546 = { 2'd0, axiM_reqFifo$D_OUT[9] } ;
  assign y__h11558 = { 2'd0, axiM_reqFifo$D_OUT[10] } ;
  always@(wci_wslv_reqF$D_OUT or
	  ...
	  rdat__h15509 or
	  rdat__h15523 or
	  rdat__h15531 or rdat__h15537 or rdat__h15543 or rdat__h15549)
  begin
    case (wci_wslv_reqF$D_OUT[39:32])
      8'h0: _theResult____h15291 = spareValue;
      8'h04: _theResult____h15291 = controlReg;
      8'h20: _theResult____h15291 = rdat__h15381;
      8'h24: _theResult____h15291 = rdat__h15481;
      8'h28: _theResult____h15291 = rdat__h15495;
      8'h2C: _theResult____h15291 = rdat__h15503;
      8'h30: _theResult____h15291 = rdat__h15509;
      8'h34: _theResult____h15291 = rdat__h15523;
      8'h38: _theResult____h15291 = rdat__h15531;
      8'h3C: _theResult____h15291 = rdat__h15537;
      8'h40: _theResult____h15291 = rdat__h15543;
      8'h44: _theResult____h15291 = rdat__h15549;
      default: _theResult____h15291 = 32'd0;
    endcase
  end
