...
//
// On Thu Feb 10 11:31:23 EST 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkAXISDWorker4B(wciS0_Clk,
  ...
  wire [31 : 0] axiM0_TDATA, axiM0_TUSER, wciS0_SData, wsiM0_MData;
  ...
  wire [68 : 0] axiM_axiM_fifof_x_wire$wget, axiS_axiS_data_wire$wget;
  wire [60 : 0] axiM_reqFifo_x_wire$wget,
		wsiM_reqFifo_x_wire$wget,
		wsiS_wsiReq$wget;
  wire [33 : 0] wci_wslv_respF_x_wire$wget;
  wire [31 : 0] axiS_axi_Es_mTData_w$wget,
		axiS_axi_Es_mTUser_w$wget,
  ...
  wire axiM_axiM_deq_deq$whas,
       ...
       axiM_reqFifo_dequeueing$whas,
       axiM_reqFifo_enqueueing$whas,
       axiM_reqFifo_x_wire$whas,
  ...
  reg [68 : 0] axiM_axiM_fifof_q_0;
  reg [68 : 0] axiM_axiM_fifof_q_0$D_IN;
  wire axiM_axiM_fifof_q_0$EN;

  // register axiM_axiM_fifof_q_1
  reg [68 : 0] axiM_axiM_fifof_q_1;
  reg [68 : 0] axiM_axiM_fifof_q_1$D_IN;
  ...
  // register axiM_reqFifo_c_r
  reg [1 : 0] axiM_reqFifo_c_r;
  wire [1 : 0] axiM_reqFifo_c_r$D_IN;
  wire axiM_reqFifo_c_r$EN;

  // register axiM_reqFifo_q_0
  reg [60 : 0] axiM_reqFifo_q_0;
  reg [60 : 0] axiM_reqFifo_q_0$D_IN;
  wire axiM_reqFifo_q_0$EN;

  // register axiM_reqFifo_q_1
  reg [60 : 0] axiM_reqFifo_q_1;
  reg [60 : 0] axiM_reqFifo_q_1$D_IN;
  wire axiM_reqFifo_q_1$EN;
  ...
  wire [68 : 0] axiS_axiS_fifof$D_IN, axiS_axiS_fifof$D_OUT;
  ...
  wire CAN_FIRE_RL_axiM_advance_data,
       ...
       CAN_FIRE_RL_axiM_reqFifo_both,
       CAN_FIRE_RL_axiM_reqFifo_decCtr,
       CAN_FIRE_RL_axiM_reqFifo_incCtr,
       ...
       WILL_FIRE_RL_axiM_reqFifo_both,
       WILL_FIRE_RL_axiM_reqFifo_decCtr,
       WILL_FIRE_RL_axiM_reqFifo_incCtr,
  ...
  wire [68 : 0] MUX_axiM_axiM_fifof_q_0$write_1__VAL_1,
		MUX_axiM_axiM_fifof_q_0$write_1__VAL_2,
		MUX_axiM_axiM_fifof_q_1$write_1__VAL_2;
  wire [60 : 0] MUX_axiM_reqFifo_q_0$write_1__VAL_2,
		MUX_axiM_reqFifo_q_1$write_1__VAL_2,
  ...
  wire [1 : 0] MUX_axiM_axiM_fifof_c_r$write_1__VAL_1,
	       ...
	       MUX_axiM_reqFifo_c_r$write_1__VAL_1,
	       MUX_axiM_reqFifo_c_r$write_1__VAL_2,
  ...
  wire MUX_axiM_axiM_fifof_q_0$write_1__SEL_1,
       MUX_axiM_axiM_fifof_q_1$write_1__SEL_1,
       MUX_axiM_reqFifo_q_0$write_1__SEL_1,
       MUX_axiM_reqFifo_q_1$write_1__SEL_1,
  ...
  reg [63 : 0] v__h15737, v__h15890, v__h3563, v__h3737, v__h3881;
  reg [31 : 0] _theResult____h15874;
  wire [31 : 0] rdat__h15964,
		rdat__h16064,
		rdat__h16078,
		rdat__h16086,
		rdat__h16092,
		...
		rdat__h16132,
		x_user__h12385;
  wire [15 : 0] aui_length__h12423, x__h13788, x__h15968;
  wire [11 : 0] x__h12428;
  ...
  // value method axiM0_mTDATA
  assign axiM0_TDATA = axiM_axiM_fifof_q_0[68:37] ;

  // value method axiM0_mTSTRB
  assign axiM0_TSTRB = axiM_axiM_fifof_q_0[36:33] ;

  // value method axiM0_mTUSER
  assign axiM0_TUSER = axiM_axiM_fifof_q_0[32:1] ;
  ...
  assign CAN_FIRE_RL_axiM_advance_data =
	     axiM_axiM_fifof_c_r != 2'd2 && axiM_operateD ;
  ...
  assign CAN_FIRE_RL_doMessageAXIsend =
	     axiM_reqFifo_c_r != 2'd2 && wsiS_reqFifo$EMPTY_N &&
	     wci_wslv_cState == 3'd2 &&
	     controlReg[0] ;
  ...
  // rule RL_axiM_reqFifo_incCtr
  assign CAN_FIRE_RL_axiM_reqFifo_incCtr =
	     ((axiM_reqFifo_c_r == 2'd0) ?
		CAN_FIRE_RL_doMessageAXIsend :
		axiM_reqFifo_c_r != 2'd1 || CAN_FIRE_RL_doMessageAXIsend) &&
	     CAN_FIRE_RL_doMessageAXIsend &&
	     !axiM_reqFifo_dequeueing$whas ;
  assign WILL_FIRE_RL_axiM_reqFifo_incCtr = CAN_FIRE_RL_axiM_reqFifo_incCtr ;

  // rule RL_axiM_reqFifo_decCtr
  assign CAN_FIRE_RL_axiM_reqFifo_decCtr =
	     axiM_reqFifo_dequeueing$whas && !CAN_FIRE_RL_doMessageAXIsend ;
  assign WILL_FIRE_RL_axiM_reqFifo_decCtr = CAN_FIRE_RL_axiM_reqFifo_decCtr ;

  // rule RL_axiM_reqFifo_both
  assign CAN_FIRE_RL_axiM_reqFifo_both =
	     ((axiM_reqFifo_c_r == 2'd1) ?
		CAN_FIRE_RL_doMessageAXIsend :
		axiM_reqFifo_c_r != 2'd2 || CAN_FIRE_RL_doMessageAXIsend) &&
	     axiM_reqFifo_dequeueing$whas &&
	     CAN_FIRE_RL_doMessageAXIsend ;
  assign WILL_FIRE_RL_axiM_reqFifo_both = CAN_FIRE_RL_axiM_reqFifo_both ;

  // inputs to muxes for submodule ports
  assign MUX_axiM_axiM_fifof_q_0$write_1__SEL_1 =
	     WILL_FIRE_RL_axiM_axiM_fifof_incCtr &&
	     axiM_axiM_fifof_c_r == 2'd0 ;
  assign MUX_axiM_axiM_fifof_q_1$write_1__SEL_1 =
	     WILL_FIRE_RL_axiM_axiM_fifof_incCtr &&
	     axiM_axiM_fifof_c_r == 2'd1 ;
  assign MUX_axiM_reqFifo_q_0$write_1__SEL_1 =
	     WILL_FIRE_RL_axiM_reqFifo_incCtr && axiM_reqFifo_c_r == 2'd0 ;
  assign MUX_axiM_reqFifo_q_1$write_1__SEL_1 =
	     WILL_FIRE_RL_axiM_reqFifo_incCtr && axiM_reqFifo_c_r == 2'd1 ;
  ...
  assign MUX_axiM_axiM_fifof_q_0$write_1__VAL_1 =
	     { axiM_reqFifo_q_0[43:8],
	       x_user__h12385,
	       axiM_reqFifo_q_0[57] } ;
  assign MUX_axiM_axiM_fifof_q_0$write_1__VAL_2 =
	     (axiM_axiM_fifof_c_r == 2'd1) ?
	       MUX_axiM_axiM_fifof_q_0$write_1__VAL_1 :
	       axiM_axiM_fifof_q_1 ;
  assign MUX_axiM_axiM_fifof_q_1$write_1__VAL_2 =
	     (axiM_axiM_fifof_c_r == 2'd2) ?
	       MUX_axiM_axiM_fifof_q_0$write_1__VAL_1 :
	       69'd0 ;
  assign MUX_axiM_reqFifo_c_r$write_1__VAL_1 = axiM_reqFifo_c_r + 2'd1 ;
  assign MUX_axiM_reqFifo_c_r$write_1__VAL_2 = axiM_reqFifo_c_r - 2'd1 ;
  assign MUX_axiM_reqFifo_q_0$write_1__VAL_2 =
	     (axiM_reqFifo_c_r == 2'd1) ?
	       wsiS_reqFifo$D_OUT :
	       axiM_reqFifo_q_1 ;
  assign MUX_axiM_reqFifo_q_1$write_1__VAL_2 =
	     (axiM_reqFifo_c_r == 2'd2) ?
	       wsiS_reqFifo$D_OUT :
  ...
  assign axiM_reqFifo_x_wire$wget = wsiS_reqFifo$D_OUT ;
  assign axiM_reqFifo_x_wire$whas = CAN_FIRE_RL_doMessageAXIsend ;
  ...
  assign axiM_reqFifo_enqueueing$whas = CAN_FIRE_RL_doMessageAXIsend ;
  assign axiM_reqFifo_dequeueing$whas =
	     WILL_FIRE_RL_axiM_advance_data && axiM_reqFifo_c_r != 2'd0 ;
  ...
  // register axiM_axiM_fifof_q_1
  always@(MUX_axiM_axiM_fifof_q_1$write_1__SEL_1 or
	  MUX_axiM_axiM_fifof_q_0$write_1__VAL_1 or
	  WILL_FIRE_RL_axiM_axiM_fifof_both or
	  MUX_axiM_axiM_fifof_q_1$write_1__VAL_2 or
	  WILL_FIRE_RL_axiM_axiM_fifof_decCtr)
  begin
    case (1'b1) // synopsys parallel_case
      MUX_axiM_axiM_fifof_q_1$write_1__SEL_1:
	  axiM_axiM_fifof_q_1$D_IN = MUX_axiM_axiM_fifof_q_0$write_1__VAL_1;
      WILL_FIRE_RL_axiM_axiM_fifof_both:
	  axiM_axiM_fifof_q_1$D_IN = MUX_axiM_axiM_fifof_q_1$write_1__VAL_2;
      WILL_FIRE_RL_axiM_axiM_fifof_decCtr: axiM_axiM_fifof_q_1$D_IN = 69'd0;
  ...
  // register axiM_reqFifo_c_r
  assign axiM_reqFifo_c_r$D_IN =
	     WILL_FIRE_RL_axiM_reqFifo_incCtr ?
	       MUX_axiM_reqFifo_c_r$write_1__VAL_1 :
	       MUX_axiM_reqFifo_c_r$write_1__VAL_2 ;
  assign axiM_reqFifo_c_r$EN =
	     WILL_FIRE_RL_axiM_reqFifo_incCtr ||
	     WILL_FIRE_RL_axiM_reqFifo_decCtr ;

  // register axiM_reqFifo_q_0
  always@(MUX_axiM_reqFifo_q_0$write_1__SEL_1 or
	  wsiS_reqFifo$D_OUT or
	  WILL_FIRE_RL_axiM_reqFifo_both or
	  MUX_axiM_reqFifo_q_0$write_1__VAL_2 or
	  WILL_FIRE_RL_axiM_reqFifo_decCtr or axiM_reqFifo_q_1)
  begin
    case (1'b1) // synopsys parallel_case
      MUX_axiM_reqFifo_q_0$write_1__SEL_1:
	  axiM_reqFifo_q_0$D_IN = wsiS_reqFifo$D_OUT;
      WILL_FIRE_RL_axiM_reqFifo_both:
	  axiM_reqFifo_q_0$D_IN = MUX_axiM_reqFifo_q_0$write_1__VAL_2;
      WILL_FIRE_RL_axiM_reqFifo_decCtr:
	  axiM_reqFifo_q_0$D_IN = axiM_reqFifo_q_1;
      default: axiM_reqFifo_q_0$D_IN =
		   61'h0AAAAAAAAAAAAAAA /* unspecified value */ ;
    endcase
  end
  assign axiM_reqFifo_q_0$EN =
	     WILL_FIRE_RL_axiM_reqFifo_incCtr && axiM_reqFifo_c_r == 2'd0 ||
	     WILL_FIRE_RL_axiM_reqFifo_both ||
	     WILL_FIRE_RL_axiM_reqFifo_decCtr ;

  // register axiM_reqFifo_q_1
  always@(MUX_axiM_reqFifo_q_1$write_1__SEL_1 or
	  wsiS_reqFifo$D_OUT or
	  WILL_FIRE_RL_axiM_reqFifo_both or
	  MUX_axiM_reqFifo_q_1$write_1__VAL_2 or
	  WILL_FIRE_RL_axiM_reqFifo_decCtr)
  begin
    case (1'b1) // synopsys parallel_case
      MUX_axiM_reqFifo_q_1$write_1__SEL_1:
	  axiM_reqFifo_q_1$D_IN = wsiS_reqFifo$D_OUT;
      WILL_FIRE_RL_axiM_reqFifo_both:
	  axiM_reqFifo_q_1$D_IN = MUX_axiM_reqFifo_q_1$write_1__VAL_2;
      WILL_FIRE_RL_axiM_reqFifo_decCtr:
	  axiM_reqFifo_q_1$D_IN = 61'h00000AAAAAAAAA00;
      default: axiM_reqFifo_q_1$D_IN =
		   61'h0AAAAAAAAAAAAAAA /* unspecified value */ ;
    endcase
  end
  assign axiM_reqFifo_q_1$EN =
	     WILL_FIRE_RL_axiM_reqFifo_incCtr && axiM_reqFifo_c_r == 2'd1 ||
	     WILL_FIRE_RL_axiM_reqFifo_both ||
	     WILL_FIRE_RL_axiM_reqFifo_decCtr ;
  ...
  assign axiS_reqFifo$D_IN =
	     { 3'd1,
	       ...
	       1'd1,
	       x__h13788[11:0],
	       axiS_axiS_fifof$D_OUT[68:33],
	       axiS_axiS_fifof$D_OUT[8:1] } ;
  ...
  // remaining internal signals
  assign aui_length__h12423 = { 4'd0, x__h12428 } ;
  assign rdat__h15964 = hasDebugLogic ? { 16'd0, x__h15968 } : 32'd0 ;
  assign rdat__h16064 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h16078 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h16086 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h16092 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h16106 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h16114 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h16120 = hasDebugLogic ? bypassCount : 32'd0 ;
  assign rdat__h16126 = hasDebugLogic ? axiSendCount : 32'd0 ;
  assign rdat__h16132 = hasDebugLogic ? axiRecvCount : 32'd0 ;
  assign wsiS_reqFifo_notFull__86_AND_wsiS_burstKind_01_ETC___d208 =
	     wsiS_reqFifo$FULL_N &&
	     (wsiS_burstKind == 2'd0 ||
	      (wsiS_burstKind == 2'd1 || wsiS_burstKind == 2'd2) &&
	      wsiS_wsiReq$wget[57]) ;
  assign x__h12428 = { axiM_reqFifo_q_0[53:44], 2'd0 } ;
  assign x__h13788 = axiS_axiS_fifof$D_OUT[32:17] >> 2 ;
  assign x__h15968 = { wsiS_statusR, wsiM_statusR } ;
  assign x_user__h12385 = { aui_length__h12423, axiM_reqFifo_q_0[15:0] } ;
  always@(wci_wslv_reqF$D_OUT or
	  ...
	  rdat__h16092 or
	  rdat__h16106 or
	  rdat__h16114 or rdat__h16120 or rdat__h16126 or rdat__h16132)
  begin
    case (wci_wslv_reqF$D_OUT[39:32])
      8'h0: _theResult____h15874 = spareValue;
      8'h04: _theResult____h15874 = controlReg;
      8'h20: _theResult____h15874 = rdat__h15964;
      8'h24: _theResult____h15874 = rdat__h16064;
      8'h28: _theResult____h15874 = rdat__h16078;
      8'h2C: _theResult____h15874 = rdat__h16086;
      8'h30: _theResult____h15874 = rdat__h16092;
      8'h34: _theResult____h15874 = rdat__h16106;
      8'h38: _theResult____h15874 = rdat__h16114;
      8'h3C: _theResult____h15874 = rdat__h16120;
      8'h40: _theResult____h15874 = rdat__h16126;
      8'h44: _theResult____h15874 = rdat__h16132;
      default: _theResult____h15874 = 32'd0;
    endcase
  end
  ...
  begin
	...
	axiM_axiM_fifof_q_0 <= `BSV_ASSIGNMENT_DELAY 69'd0;
	axiM_axiM_fifof_q_1 <= `BSV_ASSIGNMENT_DELAY 69'd0;
	axiM_operateD <= `BSV_ASSIGNMENT_DELAY 1'd0;
	axiM_reqFifo_c_r <= `BSV_ASSIGNMENT_DELAY 2'd0;
	axiM_reqFifo_q_0 <= `BSV_ASSIGNMENT_DELAY 61'h00000AAAAAAAAA00;
	axiM_reqFifo_q_1 <= `BSV_ASSIGNMENT_DELAY 61'h00000AAAAAAAAA00;
	...
	if (axiM_reqFifo_c_r$EN)
	  axiM_reqFifo_c_r <= `BSV_ASSIGNMENT_DELAY axiM_reqFifo_c_r$D_IN;
	if (axiM_reqFifo_q_0$EN)
	  axiM_reqFifo_q_0 <= `BSV_ASSIGNMENT_DELAY axiM_reqFifo_q_0$D_IN;
	if (axiM_reqFifo_q_1$EN)
	  axiM_reqFifo_q_1 <= `BSV_ASSIGNMENT_DELAY axiM_reqFifo_q_1$D_IN;
	if (axiRecvCount$EN)
  ...
  begin
    ...
    axiM_axiM_fifof_q_0 = 69'h0AAAAAAAAAAAAAAAAA;
    axiM_axiM_fifof_q_1 = 69'h0AAAAAAAAAAAAAAAAA;
    axiM_operateD = 1'h0;
    axiM_reqFifo_c_r = 2'h2;
    axiM_reqFifo_q_0 = 61'h0AAAAAAAAAAAAAAA;
    axiM_reqFifo_q_1 = 61'h0AAAAAAAAAAAAAAA;
  ...
  begin
	...
	$display("Error: \"bsv/axi/AXISDWorker.bsv\", line 51, column 8: (R0001)\n  Mutually exclusive rules RL_doMessageBypass and RL_doMessageAXIrecv fired in\n  the same clock cycle.\n");
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_doMessageAXIsend && WILL_FIRE_RL_doMessageBypass)
	$display("Error: \"bsv/axi/AXISDWorker.bsv\", line 57, column 8: (R0001)\n  Mutually exclusive rules RL_doMessageAXIsend and RL_doMessageBypass fired in\n  the same clock cycle.\n");
    if (wciS0_MReset_n)
