...
//
// On Fri Mar 18 08:43:18 EDT 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkAXISDWorker4B(wciS0_Clk,
  ...
  reg [63 : 0] v__h15922, v__h16075, v__h3626, v__h3800, v__h3944;
  reg [31 : 0] _theResult____h16059;
  wire [31 : 0] rdat__h16149,
		rdat__h16249,
		rdat__h16263,
		rdat__h16271,
		rdat__h16277,
		...
		rdat__h16317,
		x_user__h12570;
  wire [15 : 0] aui_length__h12608, x__h13973, x__h16153;
  wire [11 : 0] x__h12613;
  ...
  // remaining internal signals
  assign aui_length__h12608 = { 4'd0, x__h12613 } ;
  assign rdat__h16149 = hasDebugLogic ? { 16'd0, x__h16153 } : 32'd0 ;
  assign rdat__h16249 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h16263 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h16271 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h16277 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h16291 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h16299 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h16305 = hasDebugLogic ? bypassCount : 32'd0 ;
  assign rdat__h16311 = hasDebugLogic ? axiSendCount : 32'd0 ;
  assign rdat__h16317 = hasDebugLogic ? axiRecvCount : 32'd0 ;
  assign wsiS_reqFifo_notFull__88_AND_wsiS_burstKind_03_ETC___d210 =
	     wsiS_reqFifo$FULL_N &&
	     (wsiS_burstKind == 2'd0 ||
	      (wsiS_burstKind == 2'd1 || wsiS_burstKind == 2'd2) &&
	      wsiS_wsiReq$wget[57]) ;
  assign x__h12613 = { axiM_reqFifo_q_0[53:44], 2'd0 } ;
  assign x__h13973 = axiS_axiS_fifof$D_OUT[32:17] >> 2 ;
  assign x__h16153 = { wsiS_statusR, wsiM_statusR } ;
  assign x_user__h12570 = { aui_length__h12608, axiM_reqFifo_q_0[15:0] } ;
  always@(wci_wslv_reqF$D_OUT or
	  ...
	  rdat__h16277 or
	  rdat__h16291 or
	  rdat__h16299 or rdat__h16305 or rdat__h16311 or rdat__h16317)
  begin
    case (wci_wslv_reqF$D_OUT[39:32])
      8'h0: _theResult____h16059 = spareValue;
      8'h04: _theResult____h16059 = controlReg;
      8'h20: _theResult____h16059 = rdat__h16149;
      8'h24: _theResult____h16059 = rdat__h16249;
      8'h28: _theResult____h16059 = rdat__h16263;
      8'h2C: _theResult____h16059 = rdat__h16271;
      8'h30: _theResult____h16059 = rdat__h16277;
      8'h34: _theResult____h16059 = rdat__h16291;
      8'h38: _theResult____h16059 = rdat__h16299;
      8'h3C: _theResult____h16059 = rdat__h16305;
      8'h40: _theResult____h16059 = rdat__h16311;
      8'h44: _theResult____h16059 = rdat__h16317;
      default: _theResult____h16059 = 32'd0;
    endcase
  end
