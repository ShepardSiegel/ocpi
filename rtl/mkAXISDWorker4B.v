...
//
// On Fri Feb 11 17:08:26 EST 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkAXISDWorker4B(wciS0_Clk,
  ...
  wire [60 : 0] MUX_axiM_reqFifo_q_0$write_1__VAL_1,
		MUX_axiM_reqFifo_q_1$write_1__VAL_1,
  ...
  wire MUX_axiM_axiM_fifof_q_0$write_1__SEL_2,
       ...
       MUX_axiM_reqFifo_q_0$write_1__SEL_2,
       MUX_axiM_reqFifo_q_1$write_1__SEL_2,
  ...
  assign CAN_FIRE_RL_wci_ctrl_EiI = MUX_controlReg$write_1__SEL_2 ;
  assign WILL_FIRE_RL_wci_ctrl_EiI = MUX_controlReg$write_1__SEL_2 ;
  ...
  assign CAN_FIRE_RL_doMessageAXIrecv =
	     MUX_wsiM_reqFifo_x_wire$wset_1__SEL_1 ;
  assign WILL_FIRE_RL_doMessageAXIrecv =
	     MUX_wsiM_reqFifo_x_wire$wset_1__SEL_1 ;
  ...
  assign CAN_FIRE_RL_doMessageBypass =
	     MUX_wsiS_reqFifo_levelsValid$write_1__SEL_3 ;
  assign WILL_FIRE_RL_doMessageBypass =
	     MUX_wsiS_reqFifo_levelsValid$write_1__SEL_3 ;

  // rule RL_doMessageAXIsend
  assign CAN_FIRE_RL_doMessageAXIsend =
	     MUX_wsiS_reqFifo_levelsValid$write_1__SEL_2 ;
  assign WILL_FIRE_RL_doMessageAXIsend =
	     MUX_wsiS_reqFifo_levelsValid$write_1__SEL_2 ;
  ...
  assign MUX_axiM_axiM_fifof_q_1$write_1__SEL_2 =
	     WILL_FIRE_RL_axiM_axiM_fifof_incCtr &&
	     axiM_axiM_fifof_c_r == 2'd1 ;
  assign MUX_axiM_reqFifo_q_0$write_1__SEL_2 =
	     WILL_FIRE_RL_axiM_reqFifo_incCtr && axiM_reqFifo_c_r == 2'd0 ;
  assign MUX_axiM_reqFifo_q_1$write_1__SEL_2 =
  ...
  assign MUX_axiM_reqFifo_q_0$write_1__VAL_1 =
	     (axiM_reqFifo_c_r == 2'd1) ?
	       wsiS_reqFifo$D_OUT :
	       axiM_reqFifo_q_1 ;
  assign MUX_axiM_reqFifo_q_1$write_1__VAL_1 =
	     (axiM_reqFifo_c_r == 2'd2) ?
	       wsiS_reqFifo$D_OUT :
  ...
  assign axiM_reqFifo_x_wire$whas =
	     MUX_wsiS_reqFifo_levelsValid$write_1__SEL_2 ;
  ...
  assign axiM_reqFifo_enqueueing$whas =
	     MUX_wsiS_reqFifo_levelsValid$write_1__SEL_2 ;
  ...
  assign axiS_reqFifo_r_deq$whas = MUX_wsiM_reqFifo_x_wire$wset_1__SEL_1 ;
  assign axiS_reqFifo_r_clr$whas = 1'b0 ;
  assign axiS_reqFifo_doResetEnq$whas = CAN_FIRE_RL_axiS_advance_data ;
  assign axiS_reqFifo_doResetDeq$whas =
	     MUX_wsiM_reqFifo_x_wire$wset_1__SEL_1 ;
  ...
  // register axiM_reqFifo_q_0
  always@(WILL_FIRE_RL_axiM_reqFifo_both or
	  MUX_axiM_reqFifo_q_0$write_1__VAL_1 or
	  MUX_axiM_reqFifo_q_0$write_1__SEL_2 or
	  wsiS_reqFifo$D_OUT or
	  WILL_FIRE_RL_axiM_reqFifo_decCtr or axiM_reqFifo_q_1)
  begin
    case (1'b1) // synopsys parallel_case
      WILL_FIRE_RL_axiM_reqFifo_both:
	  axiM_reqFifo_q_0$D_IN = MUX_axiM_reqFifo_q_0$write_1__VAL_1;
      MUX_axiM_reqFifo_q_0$write_1__SEL_2:
  ...
  // register axiM_reqFifo_q_1
  always@(WILL_FIRE_RL_axiM_reqFifo_both or
	  MUX_axiM_reqFifo_q_1$write_1__VAL_1 or
	  MUX_axiM_reqFifo_q_1$write_1__SEL_2 or
	  wsiS_reqFifo$D_OUT or WILL_FIRE_RL_axiM_reqFifo_decCtr)
  begin
    case (1'b1) // synopsys parallel_case
      WILL_FIRE_RL_axiM_reqFifo_both:
	  axiM_reqFifo_q_1$D_IN = MUX_axiM_reqFifo_q_1$write_1__VAL_1;
      MUX_axiM_reqFifo_q_1$write_1__SEL_2:
  ...
  assign axiRecvCount$EN = MUX_wsiM_reqFifo_x_wire$wset_1__SEL_1 ;
  ...
  assign axiSendCount$EN = MUX_wsiS_reqFifo_levelsValid$write_1__SEL_2 ;

  // register bypassCount
  assign bypassCount$D_IN = bypassCount + 32'd1 ;
  assign bypassCount$EN = MUX_wsiS_reqFifo_levelsValid$write_1__SEL_3 ;
  ...
  assign axiS_reqFifo$DEQ = MUX_wsiM_reqFifo_x_wire$wset_1__SEL_1 ;
