...
//
// On Tue Jul 12 11:33:19 EDT 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkFTop_kc705(sys0_clkp,
  ...
  // register pciw_dbpciCD
  reg [3 : 0] pciw_dbpciCD;
  wire [3 : 0] pciw_dbpciCD$D_IN;
  wire pciw_dbpciCD$EN;

  // register pciw_dbpciCE
  reg [3 : 0] pciw_dbpciCE;
  wire [3 : 0] pciw_dbpciCE$D_IN;
  wire pciw_dbpciCE$EN;

  // register pciw_dbpciCF
  reg [3 : 0] pciw_dbpciCF;
  wire [3 : 0] pciw_dbpciCF$D_IN;
  wire pciw_dbpciCF$EN;
  ...
  wire [7 : 0] pciw_pci0_pcie_ep$cfg_interrupt_di,
	       pciw_pci0_pcie_ep$m_axis_rx_tstrb,
	       pciw_pci0_pcie_ep$s_axis_tx_tstrb;
  wire [3 : 0] pciw_pci0_pcie_ep$cfg_byte_en,
  ...
  wire pciw_pci0_pcie_ep$cfg_err_cor,
       ...
       pciw_pci0_pcie_ep$cfg_rd_en,
       pciw_pci0_pcie_ep$cfg_trn_pending,
       pciw_pci0_pcie_ep$cfg_turnoff_ok,
       pciw_pci0_pcie_ep$cfg_wr_en,
       pciw_pci0_pcie_ep$drp_clk,
  ...
  reg [63 : 0] v__h17625, v__h19119;
  reg [7 : 0] CASE_pmemMonW8_pmemFD_OUT_BITS_23_TO_16_255_0_ETC__q2,
	      CASE_pmemMonW8_wsiS_reqFifoD_OUT_BITS_35_TO_2_ETC__q1,
	      IF_pmemMonW8_pmh_98_BITS_23_TO_16_30_EQ_0_31_O_ETC___d775;
  wire [127 : 0] val_data__h6993, wOut_data__h7099;
  wire [15 : 0] val_be__h6992, wOut_be__h7098;
  wire _dor1pmemMonW8_eventCount$EN_write,
       pciw_p2iAF_head_wrapped_crossed__5_EQ_pciw_p2i_ETC___d100,
       pmemMonW8_wsiS_reqFifo_notFull__18_AND_pmemMon_ETC___d240,
       z__h16140,
       z__h16147,
       z__h16154,
       z__h16161,
  ...
  // oscillator and gates for output clock p125clk
  assign p125clk = pciw_pci0_pcie_ep$drp_clk ;
  ...
  mkDramServer_v6 dram0(.CLK_sys0_clk(sys0_clk$O),
			.RST_N_sys0_rst(sys0_rst$OUT_RST_N),
			.wciS0_Clk(pciw_pci0_pcie_ep$drp_clk),
  ...
  // submodule flash0
  mkFlashWorker flash0(.wciS0_Clk(pciw_pci0_pcie_ep$drp_clk),
  ...
  mkICAPWorker #(.isV6ICAP(1'd1),
		 .hasDebugLogic(1'd1)) icap(.wciS0_Clk(pciw_pci0_pcie_ep$drp_clk),
  ...
  SyncResetA #(.RSTDELAY(32'd0)) pciw_p125rst(.CLK(pciw_pci0_pcie_ep$drp_clk),
  ...
  SyncResetA #(.RSTDELAY(32'd1)) pciw_pci0_axiRst125(.CLK(pciw_pci0_pcie_ep$drp_clk),
						     .IN_RST_N(pciw_pci0_usr_rst_n$RESET_OUT),
  ...
  v6_pcie_v2_3 #(.PL_FAST_TRAIN("FALSE")) pciw_pci0_pcie_ep(.sys_clk(pciw_pci0_clk$O),
							    .sys_reset(pciw_pci0_pcie_ep_reset$RESET_OUT),
							    .cfg_byte_en(pciw_pci0_pcie_ep$cfg_byte_en),
							    ...
							    .s_axis_tx_tstrb(pciw_pci0_pcie_ep$s_axis_tx_tstrb),
							    ...
							    .m_axis_rx_tstrb(pciw_pci0_pcie_ep$m_axis_rx_tstrb),
							    ...
							    .drp_clk(pciw_pci0_pcie_ep$drp_clk),
  ...
  SyncRegister #(.width(32'd16),
		 .init(16'd0)) pciw_pciDevice(.sCLK(pciw_pci0_pcie_ep$user_clk_out),
					      .dCLK(pciw_pci0_pcie_ep$drp_clk),
  ...
  ClockInvToBool pciw_preEdge(.CLK_FAST(pciw_pci0_pcie_ep$user_clk_out),
			      .CLK_SLOW(pciw_pci0_pcie_ep$drp_clk),
  ...
  // submodule wciMonW8
  mkWciMonitor #(.monId(8'h42)) wciMonW8(.CLK(pciw_pci0_pcie_ep$drp_clk),
					 .RST_N(pciw_p125rst$OUT_RST_N),
  ...
  assign MUX_pciw_p2iS$write_1__VAL_1 =
	     { pciw_fP2I$D_OUT[80:72], val_be__h6992, val_data__h6993 } ;
  ...
  // register pciw_dbpciCD
  assign pciw_dbpciCD$D_IN = pciw_dbpciCD + 4'd1 ;
  assign pciw_dbpciCD$EN = 1'd1 ;

  // register pciw_dbpciCE
  assign pciw_dbpciCE$D_IN = pciw_dbpciCE + 4'd1 ;
  assign pciw_dbpciCE$EN = 1'd1 ;

  // register pciw_dbpciCF
  assign pciw_dbpciCF$D_IN = pciw_dbpciCF + 4'd1 ;
  assign pciw_dbpciCF$EN = 1'd1 ;
  ...
  // register pmemMonW8_pmGrab
  assign pmemMonW8_pmGrab$D_IN = z__h16343 ^ pmemMonW8_pmh[31] ;
  ...
  assign pciw_fP2I$D_IN =
	     { !pciw_pci0_rcvPktActive,
	       ...
	       pciw_pci0_pcie_ep$m_axis_rx_tstrb[0],
	       pciw_pci0_pcie_ep$m_axis_rx_tstrb[1],
	       pciw_pci0_pcie_ep$m_axis_rx_tstrb[2],
	       pciw_pci0_pcie_ep$m_axis_rx_tstrb[3],
	       pciw_pci0_pcie_ep$m_axis_rx_tstrb[4],
	       pciw_pci0_pcie_ep$m_axis_rx_tstrb[5],
	       pciw_pci0_pcie_ep$m_axis_rx_tstrb[6],
	       pciw_pci0_pcie_ep$m_axis_rx_tstrb[7],
  ...
  // submodule pciw_pci0_pcie_ep
  assign pciw_pci0_pcie_ep$cfg_byte_en = 4'd0 ;
  ...
  assign pciw_pci0_pcie_ep$cfg_pm_wake = 1'd0 ;
  assign pciw_pci0_pcie_ep$cfg_rd_en = 1'd0 ;
  assign pciw_pci0_pcie_ep$cfg_trn_pending = 1'd0 ;
  assign pciw_pci0_pcie_ep$cfg_turnoff_ok = 1'd0 ;
  assign pciw_pci0_pcie_ep$cfg_wr_en = 1'd0 ;
  ...
  assign pciw_pci0_pcie_ep$s_axis_tx_tdata =
	     { pciw_fI2P$D_OUT[31:0], pciw_fI2P$D_OUT[63:32] } ;
  assign pciw_pci0_pcie_ep$s_axis_tx_tlast = pciw_fI2P$D_OUT[79] ;
  assign pciw_pci0_pcie_ep$s_axis_tx_tstrb =
	     { pciw_fI2P$D_OUT[64],
	       pciw_fI2P$D_OUT[65],
	       pciw_fI2P$D_OUT[66],
	       pciw_fI2P$D_OUT[67],
  ...
  assign _dor1pmemMonW8_eventCount$EN_write =
	     WILL_FIRE_RL_pmemMonW8_gen_message_body_dw ||
	     WILL_FIRE_RL_pmemMonW8_get_message_head_dw ;
  assign pciw_p2iAF_head_wrapped_crossed__5_EQ_pciw_p2i_ETC___d100 =
	     pciw_p2iAF_head_wrapped == pciw_p2iAF_tail_wrapped &&
	     !pciw_p2iAF_sInReset_isInReset &&
	     pciw_preEdge$CLK_VAL ;
  assign pmemMonW8_wsiS_reqFifo_notFull__18_AND_pmemMon_ETC___d240 =
	     pmemMonW8_wsiS_reqFifo$FULL_N &&
	     (pmemMonW8_wsiS_burstKind == 2'd0 ||
	      (pmemMonW8_wsiS_burstKind == 2'd1 ||
	       pmemMonW8_wsiS_burstKind == 2'd2) &&
	      pmemMonW8_wsiS_wsiReq$wget[57]) ;
  assign val_be__h6992 = { pciw_fP2I$D_OUT[71:64], 8'd0 } ;
  assign val_data__h6993 = { pciw_fP2I$D_OUT[63:0], 64'hAAAAAAAAAAAAAAAA } ;
  assign wOut_be__h7098 =
	     { pciw_Prelude_inst_changeSpecialWires_1_rg[71:64],
	       pciw_fP2I$D_OUT[71:64] } ;
  assign wOut_data__h7099 =
	     { pciw_Prelude_inst_changeSpecialWires_1_rg[63:0],
	       pciw_fP2I$D_OUT[63:0] } ;
  assign z__h16140 = pmemMonW8_pmh[0] ^ pmemMonW8_pmh[1] ;
  assign z__h16147 = z__h16140 ^ pmemMonW8_pmh[2] ;
  assign z__h16154 = z__h16147 ^ pmemMonW8_pmh[3] ;
  assign z__h16161 = z__h16154 ^ pmemMonW8_pmh[4] ;
  assign z__h16168 = z__h16161 ^ pmemMonW8_pmh[5] ;
  assign z__h16175 = z__h16168 ^ pmemMonW8_pmh[6] ;
  assign z__h16182 = z__h16175 ^ pmemMonW8_pmh[7] ;
  assign z__h16189 = z__h16182 ^ pmemMonW8_pmh[8] ;
  assign z__h16196 = z__h16189 ^ pmemMonW8_pmh[9] ;
  assign z__h16203 = z__h16196 ^ pmemMonW8_pmh[10] ;
  assign z__h16210 = z__h16203 ^ pmemMonW8_pmh[11] ;
  assign z__h16217 = z__h16210 ^ pmemMonW8_pmh[12] ;
  assign z__h16224 = z__h16217 ^ pmemMonW8_pmh[13] ;
  assign z__h16231 = z__h16224 ^ pmemMonW8_pmh[14] ;
  assign z__h16238 = z__h16231 ^ pmemMonW8_pmh[15] ;
  assign z__h16245 =
	     z__h16238 ^
	     IF_pmemMonW8_pmh_98_BITS_23_TO_16_30_EQ_0_31_O_ETC___d775[0] ;
  assign z__h16252 =
	     z__h16245 ^
	     IF_pmemMonW8_pmh_98_BITS_23_TO_16_30_EQ_0_31_O_ETC___d775[1] ;
  assign z__h16259 =
	     z__h16252 ^
	     IF_pmemMonW8_pmh_98_BITS_23_TO_16_30_EQ_0_31_O_ETC___d775[2] ;
  assign z__h16266 =
	     z__h16259 ^
	     IF_pmemMonW8_pmh_98_BITS_23_TO_16_30_EQ_0_31_O_ETC___d775[3] ;
  assign z__h16273 =
	     z__h16266 ^
	     IF_pmemMonW8_pmh_98_BITS_23_TO_16_30_EQ_0_31_O_ETC___d775[4] ;
  assign z__h16280 =
	     z__h16273 ^
	     IF_pmemMonW8_pmh_98_BITS_23_TO_16_30_EQ_0_31_O_ETC___d775[5] ;
  assign z__h16287 =
	     z__h16280 ^
	     IF_pmemMonW8_pmh_98_BITS_23_TO_16_30_EQ_0_31_O_ETC___d775[6] ;
  assign z__h16294 =
	     z__h16287 ^
	     IF_pmemMonW8_pmh_98_BITS_23_TO_16_30_EQ_0_31_O_ETC___d775[7] ;
  assign z__h16301 = z__h16294 ^ pmemMonW8_pmh[24] ;
  assign z__h16308 = z__h16301 ^ pmemMonW8_pmh[25] ;
  assign z__h16315 = z__h16308 ^ pmemMonW8_pmh[26] ;
  assign z__h16322 = z__h16315 ^ pmemMonW8_pmh[27] ;
  assign z__h16329 = z__h16322 ^ pmemMonW8_pmh[28] ;
  assign z__h16336 = z__h16329 ^ pmemMonW8_pmh[29] ;
  assign z__h16343 = z__h16336 ^ pmemMonW8_pmh[30] ;
  ...
  begin
    case (pmemMonW8_pmh[23:16])
	  ...
	  IF_pmemMonW8_pmh_98_BITS_23_TO_16_30_EQ_0_31_O_ETC___d775 =
	      pmemMonW8_pmh[23:16];
      default: IF_pmemMonW8_pmh_98_BITS_23_TO_16_30_EQ_0_31_O_ETC___d775 =
		   8'd255;
    endcase
  end
  ...
  begin
    if (!pci0_rstn)
      begin
        pciw_dbpciCD <= `BSV_ASSIGNMENT_DELAY 4'd4;
	pciw_pci0_dbpciCA <= `BSV_ASSIGNMENT_DELAY 4'd1;
      end
    else
      begin
        if (pciw_dbpciCD$EN)
	  pciw_dbpciCD <= `BSV_ASSIGNMENT_DELAY pciw_dbpciCD$D_IN;
  ...
  begin
	...
	pciw_Prelude_inst_changeSpecialWires_2_rg <= `BSV_ASSIGNMENT_DELAY
	    82'h0AAAAAAAAAAAAAAAAAAAA;
	pciw_dbpciCE <= `BSV_ASSIGNMENT_DELAY 4'd5;
	...
	if (pciw_dbpciCE$EN)
	  pciw_dbpciCE <= `BSV_ASSIGNMENT_DELAY pciw_dbpciCE$D_IN;
  ...
  always@(posedge pciw_pci0_pcie_ep$drp_clk)
  begin
    if (!pciw_p125rst$OUT_RST_N)
      begin
        pciDevice <= `BSV_ASSIGNMENT_DELAY 16'd0;
	pciw_dbpciCF <= `BSV_ASSIGNMENT_DELAY 4'd6;
	...
	if (pciw_dbpciCF$EN)
	  pciw_dbpciCF <= `BSV_ASSIGNMENT_DELAY pciw_dbpciCF$D_IN;
  ...
  always@(posedge pciw_pci0_pcie_ep$drp_clk or negedge ctop$RST_N_wci_m_0)
  ...
  always@(posedge pciw_pci0_pcie_ep$drp_clk or
  ...
  always@(posedge pciw_pci0_pcie_ep$drp_clk or negedge pciw_p125rst$OUT_RST_N)
  if (!pciw_p125rst$OUT_RST_N)
    begin
  ...
  // synopsys translate_off
  always@(negedge pciw_pci0_pcie_ep$drp_clk)
  begin
    #0;
    if (pciw_p125rst$OUT_RST_N)
    ...
    if (pciw_p125rst$OUT_RST_N)
      if (WILL_FIRE_RL_pmemMonW8_get_message_head_dw)
	$write("[%0d]: %m: PMEM HEAD: ", v__h17625);
    if (pciw_p125rst$OUT_RST_N)
