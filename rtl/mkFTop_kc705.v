...
//
// On Wed Jul 20 17:12:53 EDT 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkFTop_kc705(sys0_clkp,
  ...
  reg [63 : 0] v__h13203, v__h14697;
  reg [7 : 0] CASE_pmemMonW8_pmemFD_OUT_BITS_23_TO_16_255_0_ETC__q2,
	      CASE_pmemMonW8_wsiS_reqFifoD_OUT_BITS_35_TO_2_ETC__q1,
	      IF_pmemMonW8_pmh_68_BITS_23_TO_16_00_EQ_0_01_O_ETC___d652;
  wire [127 : 0] wOut_data__h3157, x_data__h3078;
  wire [15 : 0] wOut_be__h3156, x_be__h3077;
  ...
  // submodule dram0
  mkDramServer_k7 dram0(.CLK_sys0_clk(sys0_clk$O),
			.RST_N_sys0_rst(sys0_rst$OUT_RST_N),
  ...
  // submodule flash0
  mkFlashWorker flash0(.wciS0_Clk(pciw_pci0_pcie_ep$trn_clk),
  ...
  mkICAPWorker #(.isV6ICAP(1'd1),
		 .hasDebugLogic(1'd1)) icap(.wciS0_Clk(pciw_pci0_pcie_ep$trn_clk),
  ...
  assign MUX_pciw_uP2IF$enq_1__VAL_1 =
	     { pciw_inFifo$D_OUT[80:72], x_be__h3077, x_data__h3078 } ;
  ...
  // register pmemMonW8_pmGrab
  assign pmemMonW8_pmGrab$D_IN = z__h11921 ^ pmemMonW8_pmh[31] ;
  ...
  assign pmemMonW8_wsiS_reqFifo_notFull__88_AND_pmemMon_ETC___d210 =
	     ...
	     (pmemMonW8_wsiS_burstKind == 2'd0 ||
	      (pmemMonW8_wsiS_burstKind == 2'd1 ||
	       pmemMonW8_wsiS_burstKind == 2'd2) &&
	      pmemMonW8_wsiS_wsiReq$wget[57]) ;
  assign wOut_be__h3156 = { pciw_rg[71:64], pciw_inFifo$D_OUT[71:64] } ;
  assign wOut_data__h3157 = { pciw_rg[63:0], pciw_inFifo$D_OUT[63:0] } ;
  assign x_be__h3077 = { pciw_inFifo$D_OUT[71:64], 8'd0 } ;
  assign x_data__h3078 = { pciw_inFifo$D_OUT[63:0], 64'hAAAAAAAAAAAAAAAA } ;
  assign z__h11718 = pmemMonW8_pmh[0] ^ pmemMonW8_pmh[1] ;
  assign z__h11725 = z__h11718 ^ pmemMonW8_pmh[2] ;
  assign z__h11732 = z__h11725 ^ pmemMonW8_pmh[3] ;
  assign z__h11739 = z__h11732 ^ pmemMonW8_pmh[4] ;
  assign z__h11746 = z__h11739 ^ pmemMonW8_pmh[5] ;
  assign z__h11753 = z__h11746 ^ pmemMonW8_pmh[6] ;
  assign z__h11760 = z__h11753 ^ pmemMonW8_pmh[7] ;
  assign z__h11767 = z__h11760 ^ pmemMonW8_pmh[8] ;
  assign z__h11774 = z__h11767 ^ pmemMonW8_pmh[9] ;
  assign z__h11781 = z__h11774 ^ pmemMonW8_pmh[10] ;
  assign z__h11788 = z__h11781 ^ pmemMonW8_pmh[11] ;
  assign z__h11795 = z__h11788 ^ pmemMonW8_pmh[12] ;
  assign z__h11802 = z__h11795 ^ pmemMonW8_pmh[13] ;
  assign z__h11809 = z__h11802 ^ pmemMonW8_pmh[14] ;
  assign z__h11816 = z__h11809 ^ pmemMonW8_pmh[15] ;
  assign z__h11823 =
	     z__h11816 ^
	     IF_pmemMonW8_pmh_68_BITS_23_TO_16_00_EQ_0_01_O_ETC___d652[0] ;
  assign z__h11830 =
	     z__h11823 ^
	     IF_pmemMonW8_pmh_68_BITS_23_TO_16_00_EQ_0_01_O_ETC___d652[1] ;
  assign z__h11837 =
	     z__h11830 ^
	     IF_pmemMonW8_pmh_68_BITS_23_TO_16_00_EQ_0_01_O_ETC___d652[2] ;
  assign z__h11844 =
	     z__h11837 ^
	     IF_pmemMonW8_pmh_68_BITS_23_TO_16_00_EQ_0_01_O_ETC___d652[3] ;
  assign z__h11851 =
	     z__h11844 ^
	     IF_pmemMonW8_pmh_68_BITS_23_TO_16_00_EQ_0_01_O_ETC___d652[4] ;
  assign z__h11858 =
	     z__h11851 ^
	     IF_pmemMonW8_pmh_68_BITS_23_TO_16_00_EQ_0_01_O_ETC___d652[5] ;
  assign z__h11865 =
	     z__h11858 ^
	     IF_pmemMonW8_pmh_68_BITS_23_TO_16_00_EQ_0_01_O_ETC___d652[6] ;
  assign z__h11872 =
	     z__h11865 ^
	     IF_pmemMonW8_pmh_68_BITS_23_TO_16_00_EQ_0_01_O_ETC___d652[7] ;
  assign z__h11879 = z__h11872 ^ pmemMonW8_pmh[24] ;
  assign z__h11886 = z__h11879 ^ pmemMonW8_pmh[25] ;
  assign z__h11893 = z__h11886 ^ pmemMonW8_pmh[26] ;
  assign z__h11900 = z__h11893 ^ pmemMonW8_pmh[27] ;
  assign z__h11907 = z__h11900 ^ pmemMonW8_pmh[28] ;
  assign z__h11914 = z__h11907 ^ pmemMonW8_pmh[29] ;
  assign z__h11921 = z__h11914 ^ pmemMonW8_pmh[30] ;
  ...
  begin
    case (pmemMonW8_pmh[23:16])
	  ...
	  IF_pmemMonW8_pmh_68_BITS_23_TO_16_00_EQ_0_01_O_ETC___d652 =
	      pmemMonW8_pmh[23:16];
      default: IF_pmemMonW8_pmh_68_BITS_23_TO_16_00_EQ_0_01_O_ETC___d652 =
		   8'd255;
    endcase
  end
  ...
  always@(posedge pciw_pci0_pcie_ep$trn_clk or negedge ctop$RST_N_wci_m_0)
  ...
  begin
    ...
    if (pciw_p125rst$OUT_RST_N)
      if (WILL_FIRE_RL_pmemMonW8_get_message_head_dw)
	$write("[%0d]: %m: PMEM HEAD: ", v__h13203);
    if (pciw_p125rst$OUT_RST_N)
