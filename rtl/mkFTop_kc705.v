...
//
// On Sat Jan 28 11:49:50 EST 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkFTop_kc705(sys0_clkp,
  ...
  wire [15 : 0] IF_pciw_pci0_pcie_ep_axi_rx_tuser_BIT_21_THEN__ETC___d138,
		x_be__h1483;
  ...
  // submodule lcd_ctrl
  assign lcd_ctrl$setLine1_text = 128'h3233762073656C75522063696D6F7441 ;
  ...
  // remaining internal signals
  assign IF_pciw_pci0_pcie_ep_axi_rx_tuser_BIT_21_THEN__ETC___d138 =
	     pciw_pci0_pcie_ep$m_axis_rx_tuser[21] ?
	       CASE_pciw_pci0_pcie_epm_axis_rx_tuser_BITS_20_ETC__q1 :
	       16'd65535 ;
  assign x_be__h1483 =
	     { IF_pciw_pci0_pcie_ep_axi_rx_tuser_BIT_21_THEN__ETC___d138[0],
	       IF_pciw_pci0_pcie_ep_axi_rx_tuser_BIT_21_THEN__ETC___d138[1],
	       IF_pciw_pci0_pcie_ep_axi_rx_tuser_BIT_21_THEN__ETC___d138[2],
	       IF_pciw_pci0_pcie_ep_axi_rx_tuser_BIT_21_THEN__ETC___d138[3],
	       IF_pciw_pci0_pcie_ep_axi_rx_tuser_BIT_21_THEN__ETC___d138[4],
	       IF_pciw_pci0_pcie_ep_axi_rx_tuser_BIT_21_THEN__ETC___d138[5],
	       IF_pciw_pci0_pcie_ep_axi_rx_tuser_BIT_21_THEN__ETC___d138[6],
	       IF_pciw_pci0_pcie_ep_axi_rx_tuser_BIT_21_THEN__ETC___d138[7],
	       IF_pciw_pci0_pcie_ep_axi_rx_tuser_BIT_21_THEN__ETC___d138[8],
	       IF_pciw_pci0_pcie_ep_axi_rx_tuser_BIT_21_THEN__ETC___d138[9],
	       IF_pciw_pci0_pcie_ep_axi_rx_tuser_BIT_21_THEN__ETC___d138[10],
	       IF_pciw_pci0_pcie_ep_axi_rx_tuser_BIT_21_THEN__ETC___d138[11],
	       IF_pciw_pci0_pcie_ep_axi_rx_tuser_BIT_21_THEN__ETC___d138[12],
	       IF_pciw_pci0_pcie_ep_axi_rx_tuser_BIT_21_THEN__ETC___d138[13],
	       IF_pciw_pci0_pcie_ep_axi_rx_tuser_BIT_21_THEN__ETC___d138[14],
	       IF_pciw_pci0_pcie_ep_axi_rx_tuser_BIT_21_THEN__ETC___d138[15] } ;
