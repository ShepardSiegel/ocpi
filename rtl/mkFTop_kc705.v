...
//
// On Sun Apr  3 10:47:33 EDT 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkFTop_kc705(sys0_clkp,
  ...
  // register pmemMonW8_pmGrab
  assign pmemMonW8_pmGrab$D_IN = z__h11630 ^ pmemMonW8_pmh[31] ;
  ...
  assign z__h11427 = pmemMonW8_pmh[0] ^ pmemMonW8_pmh[1] ;
  assign z__h11434 = z__h11427 ^ pmemMonW8_pmh[2] ;
  assign z__h11441 = z__h11434 ^ pmemMonW8_pmh[3] ;
  assign z__h11448 = z__h11441 ^ pmemMonW8_pmh[4] ;
  assign z__h11455 = z__h11448 ^ pmemMonW8_pmh[5] ;
  assign z__h11462 = z__h11455 ^ pmemMonW8_pmh[6] ;
  assign z__h11469 = z__h11462 ^ pmemMonW8_pmh[7] ;
  assign z__h11476 = z__h11469 ^ pmemMonW8_pmh[8] ;
  assign z__h11483 = z__h11476 ^ pmemMonW8_pmh[9] ;
  assign z__h11490 = z__h11483 ^ pmemMonW8_pmh[10] ;
  assign z__h11497 = z__h11490 ^ pmemMonW8_pmh[11] ;
  assign z__h11504 = z__h11497 ^ pmemMonW8_pmh[12] ;
  assign z__h11511 = z__h11504 ^ pmemMonW8_pmh[13] ;
  assign z__h11518 = z__h11511 ^ pmemMonW8_pmh[14] ;
  assign z__h11525 = z__h11518 ^ pmemMonW8_pmh[15] ;
  assign z__h11532 =
	     z__h11525 ^
	     IF_pmemMonW8_pmh_68_BITS_23_TO_16_00_EQ_0_01_O_ETC___d700[0] ;
  assign z__h11539 =
	     z__h11532 ^
	     IF_pmemMonW8_pmh_68_BITS_23_TO_16_00_EQ_0_01_O_ETC___d700[1] ;
  assign z__h11546 =
	     z__h11539 ^
	     IF_pmemMonW8_pmh_68_BITS_23_TO_16_00_EQ_0_01_O_ETC___d700[2] ;
  assign z__h11553 =
	     z__h11546 ^
	     IF_pmemMonW8_pmh_68_BITS_23_TO_16_00_EQ_0_01_O_ETC___d700[3] ;
  assign z__h11560 =
	     z__h11553 ^
	     IF_pmemMonW8_pmh_68_BITS_23_TO_16_00_EQ_0_01_O_ETC___d700[4] ;
  assign z__h11567 =
	     z__h11560 ^
	     IF_pmemMonW8_pmh_68_BITS_23_TO_16_00_EQ_0_01_O_ETC___d700[5] ;
  assign z__h11574 =
	     z__h11567 ^
	     IF_pmemMonW8_pmh_68_BITS_23_TO_16_00_EQ_0_01_O_ETC___d700[6] ;
  assign z__h11581 =
	     z__h11574 ^
	     IF_pmemMonW8_pmh_68_BITS_23_TO_16_00_EQ_0_01_O_ETC___d700[7] ;
  assign z__h11588 = z__h11581 ^ pmemMonW8_pmh[24] ;
  assign z__h11595 = z__h11588 ^ pmemMonW8_pmh[25] ;
  assign z__h11602 = z__h11595 ^ pmemMonW8_pmh[26] ;
  assign z__h11609 = z__h11602 ^ pmemMonW8_pmh[27] ;
  assign z__h11616 = z__h11609 ^ pmemMonW8_pmh[28] ;
  assign z__h11623 = z__h11616 ^ pmemMonW8_pmh[29] ;
  assign z__h11630 = z__h11623 ^ pmemMonW8_pmh[30] ;
  ...
  begin
    case (pmemMonW8_pmh[23:16])
	  ...
	  IF_pmemMonW8_pmh_68_BITS_23_TO_16_00_EQ_0_01_O_ETC___d700 =
	      pmemMonW8_pmh[23:16];
      default: IF_pmemMonW8_pmh_68_BITS_23_TO_16_00_EQ_0_01_O_ETC___d700 =
		   8'd255;
    endcase
  end
  ...
  begin
    ...
    if (pciw_p125rst$OUT_RST_N)
      if (WILL_FIRE_RL_pmemMonW8_get_message_head_dw)
	$write("[%0d]: %m: PMEM HEAD: ", v__h12912);
    if (pciw_p125rst$OUT_RST_N)
