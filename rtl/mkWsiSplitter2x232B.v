...
//
// On Mon Jun 21 15:30:35 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkWsiSplitter2x232B(wciS0_Clk,
  ...
  wire [31 : 0] wci_s_SData, wsiM0_MByteEn, wsiM1_MByteEn;
  ...
  reg [63 : 0] v__h13772, v__h14310, v__h2632, v__h2779, v__h3678;
  reg [31 : 0] _theResult____h13756;
  wire [31 : 0] rdat__h13835;
  wire NOT_wsi_S0_reqFifo_countReg_76_ULE_1_77___d378,
       NOT_wsi_S1_reqFifo_countReg_11_ULE_1_12___d313;
  ...
  assign wsiS0_SThreadBusy =
	     NOT_wsi_S0_reqFifo_countReg_76_ULE_1_77___d378 ||
	     wsi_S0_isReset$VAL ||
	     !wsi_S0_operateD ||
	     !wsi_S0_peerIsReady ;
  ...
  assign MUX_wsi_M1_reqFifo_q_1$write_1__SEL_1 =
	     WILL_FIRE_RL_wsi_M1_reqFifo_incCtr &&
	     wsi_M1_reqFifo_c_r == 2'd1 ;
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, _theResult____h13756 } ;
  ...
  assign wsi_M0_burstKind$EN =
	     ...
	     (wsi_M0_burstKind == 2'd0 ||
	      wsi_M0_burstKind == 2'd1 && wsi_M0_reqFifo_q_0[309] ||
	      wsi_M0_burstKind == 2'd2 &&
	      wsi_M0_reqFifo_q_0[307:296] == 12'd1) ;
  ...
  assign wsi_M1_burstKind$EN =
	     ...
	     (wsi_M1_burstKind == 2'd0 ||
	      wsi_M1_burstKind == 2'd1 && wsi_M1_reqFifo_q_0[309] ||
	      wsi_M1_burstKind == 2'd2 &&
	      wsi_M1_reqFifo_q_0[307:296] == 12'd1) ;
  ...
  assign wsi_S0_burstKind$EN =
	     WILL_FIRE_RL_wsi_S0_reqFifo_enq &&
	     (wsi_S0_burstKind == 2'd0 ||
	      wsi_S0_burstKind == 2'd1 && wsi_S0_wsiReq$wget[309] ||
	      wsi_S0_burstKind == 2'd2 &&
	      wsi_S0_wsiReq$wget[307:296] == 12'd1) ;
  ...
  assign wsi_S1_burstKind$EN =
	     WILL_FIRE_RL_wsi_S1_reqFifo_enq &&
	     (wsi_S1_burstKind == 2'd0 ||
	      wsi_S1_burstKind == 2'd1 && wsi_S1_wsiReq$wget[309] ||
	      wsi_S1_burstKind == 2'd2 &&
	      wsi_S1_wsiReq$wget[307:296] == 12'd1) ;
  ...
  // remaining internal signals
  assign NOT_wsi_S0_reqFifo_countReg_76_ULE_1_77___d378 =
	     wsi_S0_reqFifo_countReg > 2'd1 ;
  assign NOT_wsi_S1_reqFifo_countReg_11_ULE_1_12___d313 =
	     wsi_S1_reqFifo_countReg > 2'd1 ;
  assign rdat__h13835 =
	     { wsi_S0_statusR,
	       wsi_S1_statusR,
  ...
  always@(wci_reqF$D_OUT or
	  splitCtrl or
	  rdat__h13835 or
	  wsi_S0_extStatusW$wget or
	  wsi_S1_extStatusW$wget or
	  wsi_M0_extStatusW$wget or wsi_M1_extStatusW$wget)
  begin
    case (wci_reqF$D_OUT[39:32])
      8'h04: _theResult____h13756 = splitCtrl;
      8'h1C: _theResult____h13756 = rdat__h13835;
      8'h20, 8'h28: _theResult____h13756 = wsi_S0_extStatusW$wget[95:64];
      8'h24: _theResult____h13756 = wsi_S0_extStatusW$wget[63:32];
      8'h2C: _theResult____h13756 = wsi_S1_extStatusW$wget[63:32];
      8'h30: _theResult____h13756 = wsi_M0_extStatusW$wget[95:64];
      8'h34: _theResult____h13756 = wsi_M0_extStatusW$wget[63:32];
      8'h38: _theResult____h13756 = wsi_M1_extStatusW$wget[95:64];
      8'h3C: _theResult____h13756 = wsi_M1_extStatusW$wget[63:32];
      default: _theResult____h13756 = 32'd0;
    endcase
  end
