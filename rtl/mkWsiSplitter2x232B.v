...
//
// On Fri Jun 25 13:30:01 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkWsiSplitter2x232B(wciS0_Clk,
  ...
  reg [63 : 0] v__h13773, v__h14321, v__h2633, v__h2780, v__h3679;
  reg [31 : 0] _theResult____h13757;
  wire [31 : 0] rdat__h13836,
		rdat__h14025,
		rdat__h14039,
		rdat__h14047,
		rdat__h14061,
		...
		rdat__h14091,
		rdat__h14105;
  wire NOT_wsi_S0_reqFifo_countReg_86_ULE_1_87___d388,
       NOT_wsi_S1_reqFifo_countReg_21_ULE_1_22___d323;
  ...
  assign wsiS0_SThreadBusy =
	     NOT_wsi_S0_reqFifo_countReg_86_ULE_1_87___d388 ||
	     wsi_S0_isReset$VAL ||
	     !wsi_S0_operateD ||
	     !wsi_S0_peerIsReady ;
  ...
  assign MUX_wsi_M1_reqFifo_q_1$write_1__SEL_2 =
	     WILL_FIRE_RL_wsi_M1_reqFifo_incCtr &&
	     wsi_M1_reqFifo_c_r == 2'd1 ;
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, _theResult____h13757 } ;
  ...
  assign wsi_M1_reqFifo_x_wire$wget = MUX_wsi_M1_reqFifo_q_1$write_1__VAL_2 ;
  ...
  begin
    case (1'b1) // synopsys parallel_case
      ...
      MUX_wsi_M1_reqFifo_q_0$write_1__SEL_2:
	  wsi_M1_reqFifo_q_0$D_IN = MUX_wsi_M1_reqFifo_q_1$write_1__VAL_2;
      WILL_FIRE_RL_wsi_M1_reqFifo_decCtr:
  ...
  // remaining internal signals
  assign NOT_wsi_S0_reqFifo_countReg_86_ULE_1_87___d388 =
	     wsi_S0_reqFifo_countReg > 2'd1 ;
  assign NOT_wsi_S1_reqFifo_countReg_21_ULE_1_22___d323 =
	     wsi_S1_reqFifo_countReg > 2'd1 ;
  assign rdat__h13836 =
	     hasDebugLogic ?
	       { wsi_S0_statusR,
  ...
  always@(wci_reqF$D_OUT or
	  ...
	  rdat__h14047 or
	  rdat__h14061 or
	  rdat__h14069 or rdat__h14083 or rdat__h14091 or rdat__h14105)
  begin
    case (wci_reqF$D_OUT[39:32])
      8'h04: _theResult____h13757 = splitCtrl;
      8'h1C: _theResult____h13757 = rdat__h13836;
      8'h20: _theResult____h13757 = rdat__h14025;
      8'h24: _theResult____h13757 = rdat__h14039;
      8'h28: _theResult____h13757 = rdat__h14047;
      8'h2C: _theResult____h13757 = rdat__h14061;
      8'h30: _theResult____h13757 = rdat__h14069;
      8'h34: _theResult____h13757 = rdat__h14083;
      8'h38: _theResult____h13757 = rdat__h14091;
      8'h3C: _theResult____h13757 = rdat__h14105;
      default: _theResult____h13757 = 32'd0;
    endcase
  end
