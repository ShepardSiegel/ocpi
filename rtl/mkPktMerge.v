...
//
// On Sun Oct 10 11:02:37 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkPktMerge(CLK,
  ...
  reg [63 : 0] v__h679;
  wire fo_RDY_enq_AND_IF_fi0HasPrio_THEN_fi0_RDY_deq__ETC___d10;
  ...
  assign CAN_FIRE_RL_arbitrate =
	     fo_RDY_enq_AND_IF_fi0HasPrio_THEN_fi0_RDY_deq__ETC___d10 &&
	     fi0$EMPTY_N &&
	     fi1$EMPTY_N &&
	     !fi0Active &&
	     !fi1Active ;
  ...
  // remaining internal signals
  assign fo_RDY_enq_AND_IF_fi0HasPrio_THEN_fi0_RDY_deq__ETC___d10 =
