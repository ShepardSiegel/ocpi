...
//
// On Fri Jun 21 16:58:23 EDT 2013
//
//
// Ports:
// Name                         I/O  size props
...
module mkPktMerge(CLK,
  ...
  wire [152 : 0] MUX_fo$enq_1__VAL_3;
  ...
  assign MUX_fo$enq_1__VAL_3 = fi0HasPrio ? fi0$D_OUT : fi1$D_OUT ;
  ...
  always@(WILL_FIRE_RL_fi0_advance or
	  ...
	  fi1$D_OUT or WILL_FIRE_RL_arbitrate or MUX_fo$enq_1__VAL_3)
  begin
    case (1'b1) // synopsys parallel_case
      WILL_FIRE_RL_fi0_advance: fo$D_IN = fi0$D_OUT;
      WILL_FIRE_RL_fi1_advance: fo$D_IN = fi1$D_OUT;
      WILL_FIRE_RL_arbitrate: fo$D_IN = MUX_fo$enq_1__VAL_3;
      default: fo$D_IN =
