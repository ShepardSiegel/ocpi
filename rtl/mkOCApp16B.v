...
//
// On Sun Mar 20 12:51:41 EDT 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkOCApp16B(RST_N_rst_0,
  ...
  wire [31 : 0] appW2$wciS0_MAddr,
		...
		appW2$wmiM0_MFlag,
		appW2$wmiM0_SFlag;
  wire [15 : 0] appW2$wmiM0_MDataByteEn,
		appW2$wsiM0_MByteEn,
		appW2$wsiS0_MByteEn;
  ...
  wire [127 : 0] appW3$wmemiM0_MData,
		 appW3$wmemiM0_SData,
		 appW3$wsiM0_MData,
		 appW3$wsiS0_MData;
  wire [35 : 0] appW3$wmemiM0_MAddr;
  wire [31 : 0] appW3$wciS0_MAddr, appW3$wciS0_MData, appW3$wciS0_SData;
  ...
  wire [31 : 0] appW4$wciS0_MAddr,
		...
		appW4$wmiM0_MFlag,
		appW4$wmiM0_SFlag;
  wire [15 : 0] appW4$wmiM0_MDataByteEn,
		appW4$wsiM0_MByteEn,
		appW4$wsiS0_MByteEn;
  ...
  // submodule appW3
  mkDelayWorker16B #(.dlyCtrlInit(32'h0),
