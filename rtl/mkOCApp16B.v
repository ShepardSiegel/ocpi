...
//
// On Fri Aug 19 11:38:30 EDT 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkOCApp16B(RST_N_rst_0,
  ...
  // value method deviceDNA
  output [63 : 0] deviceDNA;
  ...
  wire [127 : 0] appW3$wsiM0_MData, appW3$wsiS0_MData;
  wire [31 : 0] appW3$wciS0_MAddr, appW3$wciS0_MData, appW3$wciS0_SData;
  wire [15 : 0] appW3$wsiM0_MByteEn, appW3$wsiS0_MByteEn;
  ...
  // value method deviceDNA
  assign deviceDNA = { 7'd0, dna_sr } ;
  assign RDY_deviceDNA = dna_cnt == 7'd127 ;
