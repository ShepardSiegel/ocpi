...
//
// On Tue Dec 11 16:19:51 EST 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkWciInitiator(CLK,
  ...
  wire initiator_mReset$ASSERT_IN, initiator_mReset$OUT_RST;
  ...
  wire WILL_FIRE_RL_initFsm_action_l1105c5,
       WILL_FIRE_RL_initFsm_action_l1106c14,
       WILL_FIRE_RL_initFsm_action_l1107c5,
       WILL_FIRE_RL_initFsm_action_l1108c14,
       ...
       WILL_FIRE_RL_initFsm_idle_l1104c3,
  ...
  reg [63 : 0] v__h22397,
	       ...
	       v__h3787,
	       v__h3876;
  wire [31 : 0] toCount__h2563, x__h25252, x__h2726;
  ...
  wire NOT_initiator_busy_5_79_AND_IF_initiator_wRese_ETC___d192,
       ...
       initiator_respTimr_7_ULT_1_SL_initiator_wTimeo_ETC___d283;

  // output resets
  assign RST_N_wciM0 = initiator_mReset$OUT_RST ;
  ...
  MakeResetA #(.RSTDELAY(32'd16), .init(1'd0)) initiator_mReset(.CLK(CLK),
								...
								.ASSERT_OUT(),
								.OUT_RST(initiator_mReset$OUT_RST));
  ...
  // rule RL_initFsm_action_l1106c14
  assign WILL_FIRE_RL_initFsm_action_l1106c14 =
	     !initiator_busy && initiator_respF$FULL_N &&
	     initFsm_state_mkFSMstate == 4'd1 ;

  // rule RL_initFsm_action_l1107c5
  assign WILL_FIRE_RL_initFsm_action_l1107c5 =
	     initiator_respF$EMPTY_N && initFsm_state_mkFSMstate == 4'd2 ;

  // rule RL_initFsm_action_l1108c14
  assign WILL_FIRE_RL_initFsm_action_l1108c14 =
  ...
  // rule RL_initFsm_action_l1105c5
  assign WILL_FIRE_RL_initFsm_action_l1105c5 =
	     initFsm_start_wire$whas &&
	     (initFsm_state_mkFSMstate == 4'd0 ||
	      initFsm_state_mkFSMstate == 4'd11) ;

  // rule RL_initFsm_idle_l1104c3
  ...
  assign MUX_initiator_lastControlOp$write_1__SEL_1 =
	     WILL_FIRE_RL_initFsm_action_l1108c14 && initiator_wReset_n ;
  assign MUX_initiator_lastControlOp$write_1__SEL_2 =
	     WILL_FIRE_RL_initFsm_action_l1110c14 && initiator_wReset_n ;
  ...
  assign MUX_initiator_reqF_x_wire$wset_1__VAL_1 =
	     { 8'd63, x__h25252, 32'h80000042 } ;
  assign MUX_initiator_reqF_x_wire$wset_1__VAL_2 =
	     { 8'd95, x__h25252, 32'h80000000 } ;
  ...
  assign initFsm_state_set_pw$whas =
	     ...
	     WILL_FIRE_RL_initFsm_action_l1107c5 ||
	     WILL_FIRE_RL_initFsm_action_l1106c14 ||
	     WILL_FIRE_RL_initFsm_action_l1105c5 ;
  ...
  // register initFsm_state_mkFSMstate
  always@(WILL_FIRE_RL_initFsm_idle_l1104c3 or
	  WILL_FIRE_RL_initFsm_action_l1105c5 or
	  WILL_FIRE_RL_initFsm_action_l1106c14 or
	  WILL_FIRE_RL_initFsm_action_l1107c5 or
	  WILL_FIRE_RL_initFsm_action_l1108c14 or
  ...
  begin
    case (1'b1) // synopsys parallel_case
      WILL_FIRE_RL_initFsm_idle_l1104c3: initFsm_state_mkFSMstate$D_IN = 4'd0;
      WILL_FIRE_RL_initFsm_action_l1105c5:
  ...
  assign initiator_wReset_n$EN = WILL_FIRE_RL_initFsm_action_l1106c14 ;
  ...
  assign initiator_wTimeout$EN = WILL_FIRE_RL_initFsm_action_l1106c14 ;
  ...
  assign initFsm_abort_whas__45_AND_initFsm_abort_wget__ETC___d231 =
	     (initFsm_state_mkFSMstate == 4'd0 ||
	      initFsm_state_mkFSMstate == 4'd11) &&
	     (!initFsm_start_reg_1 || initFsm_state_fired) ;
  assign initiator_respTimr_7_ULT_1_SL_initiator_wTimeo_ETC___d283 =
	     initiator_respTimr < toCount__h2563 ;
  assign toCount__h2563 = 32'd1 << initiator_wTimeout ;
  assign x__h25252 = { initiator_pageWindow, 20'h0 } ;
  assign x__h2726 = initiator_respTimr + 32'd1 ;
  ...
  begin
    #0;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_initFsm_action_l1107c5)
	begin
	  v__h23185 = $time;
	  #0;
	end
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_initFsm_action_l1108c14)
	begin
	  v__h23475 = $time;
	  #0;
	end
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_initFsm_action_l1108c14)
	$display("[%0d]: %m: WORKER CONTROL ARM...", v__h23475);
    if (RST_N != `BSV_RESET_VALUE)
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_initFsm_action_l1110c14)
	$display("[%0d]: %m: WORKER CONTROL ARM...", v__h24273);
    if (RST_N != `BSV_RESET_VALUE)
	...
	$display("[%0d]: %m: WCI Initiator received response %0x",
		 ...
		 initiator_respF$D_OUT[31:0]);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_initFsm_action_l1106c14 &&
	  (WILL_FIRE_RL_initFsm_action_l1107c5 ||
	   WILL_FIRE_RL_initFsm_action_l1108c14 ||
	   WILL_FIRE_RL_initFsm_action_l1109c5 ||
	   WILL_FIRE_RL_initFsm_action_l1110c14 ||
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_initFsm_action_l1105c5)
	begin
	  v__h22397 = $time;
	  #0;
	end
    ...
    if (RST_N != `BSV_RESET_VALUE)
	  ...
	  !initiator_respTimr_7_ULT_1_SL_initiator_wTimeo_ETC___d283 &&
	  initiator_reqPend == 2'd1)
	$display("[%0d]: %m: WORKER CONFIG-WRITE TIMEOUT", v__h2868);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_initiator_wrkBusy &&
	  initiator_wciResponse$wget[33:32] == 2'd0 &&
	  !initiator_respTimr_7_ULT_1_SL_initiator_wTimeo_ETC___d283 &&
    ...
    if (RST_N != `BSV_RESET_VALUE)
	  ...
	  !initiator_respTimr_7_ULT_1_SL_initiator_wTimeo_ETC___d283 &&
	  initiator_reqPend == 2'd2)
	$display("[%0d]: %m: WORKER CONFIG-READ  TIMEOUT", v__h2958);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_initiator_wrkBusy &&
	  initiator_wciResponse$wget[33:32] == 2'd0 &&
	  !initiator_respTimr_7_ULT_1_SL_initiator_wTimeo_ETC___d283 &&
    ...
    if (RST_N != `BSV_RESET_VALUE)
	  ...
	  !initiator_respTimr_7_ULT_1_SL_initiator_wTimeo_ETC___d283 &&
	  initiator_reqPend == 2'd3)
	$display("[%0d]: %m: WORKER CONTROL-OP   TIMEOUT", v__h3047);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_initiator_wrkBusy &&
	  initiator_wciResponse$wget[33:32] == 2'd2 &&
	  initiator_reqPend == 2'd1)
    ...
    if (RST_N != `BSV_RESET_VALUE)
	  ...
	  initiator_wciResponse$wget[33:32] == 2'd2 &&
	  initiator_reqPend == 2'd1)
	$display("[%0d]: %m: WORKER CONFIG-WRITE RESPONSE-FAIL", v__h3280);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_initiator_wrkBusy &&
	  initiator_wciResponse$wget[33:32] == 2'd2 &&
	  initiator_reqPend == 2'd2)
    ...
    if (RST_N != `BSV_RESET_VALUE)
	  ...
	  initiator_wciResponse$wget[33:32] == 2'd2 &&
	  initiator_reqPend == 2'd2)
	$display("[%0d]: %m: WORKER CONFIG-READ  RESPONSE-FAIL", v__h3370);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_initiator_wrkBusy &&
	  initiator_wciResponse$wget[33:32] == 2'd2 &&
	  initiator_reqPend == 2'd3)
    ...
    if (RST_N != `BSV_RESET_VALUE)
	  ...
	  initiator_wciResponse$wget[33:32] == 2'd2 &&
	  initiator_reqPend == 2'd3)
	$display("[%0d]: %m: WORKER CONTROL-OP   RESPONSE-FAIL", v__h3459);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_initiator_wrkBusy &&
	  initiator_wciResponse$wget[33:32] == 2'd3 &&
	  initiator_reqPend == 2'd1)
    ...
    if (RST_N != `BSV_RESET_VALUE)
	  ...
	  initiator_wciResponse$wget[33:32] == 2'd3 &&
	  initiator_reqPend == 2'd1)
	$display("[%0d]: %m: WORKER CONFIG-WRITE RESPONSE-ERR", v__h3697);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_initiator_wrkBusy &&
	  initiator_wciResponse$wget[33:32] == 2'd3 &&
	  initiator_reqPend == 2'd2)
    ...
    if (RST_N != `BSV_RESET_VALUE)
	  ...
	  initiator_wciResponse$wget[33:32] == 2'd3 &&
	  initiator_reqPend == 2'd2)
	$display("[%0d]: %m: WORKER CONFIG-READ  RESPONSE-ERR", v__h3787);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_initiator_wrkBusy &&
	  initiator_wciResponse$wget[33:32] == 2'd3 &&
	  initiator_reqPend == 2'd3)
    ...
    if (RST_N != `BSV_RESET_VALUE)
	  ...
	  initiator_wciResponse$wget[33:32] == 2'd3 &&
	  initiator_reqPend == 2'd3)
	$display("[%0d]: %m: WORKER CONTROL-OP   RESPONSE-ERR", v__h3876);
  end
  // synopsys translate_on
