...
//
// On Fri Feb 11 17:07:41 EST 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkWciInitiator(CLK,
  ...
  reg [63 : 0] v__h18546,
	       ...
	       v__h3651,
	       v__h3740;
  wire [31 : 0] toCount__h2428, x__h20932, x__h2590;
  ...
  assign MUX_initiator_reqF_x_wire$wset_1__VAL_1 =
	     { 8'd63, x__h20932, 32'h80000042 } ;
  assign MUX_initiator_reqF_x_wire$wset_1__VAL_2 =
	     { 8'd95, x__h20932, 32'h80000000 } ;
  ...
  assign initFsm_pw_list_5$whas = CAN_FIRE_RL_initFsm_action_l1087c14 ;
  assign initFsm_pw_list_6$whas = CAN_FIRE_RL_initFsm_action_l1088c5 ;
  assign initFsm_pw_list_7$whas = CAN_FIRE_RL_initFsm_action_l1089c14 ;
  ...
  assign initFsm_pw_list_10$whas = CAN_FIRE_RL_initFsm_actionof_l1092c5 ;
  ...
  assign x__h20932 = { initiator_pageWindow, 20'h0 } ;
  ...
  begin
    ...
    if (RST_N)
      if (WILL_FIRE_RL_initFsm_actionof_l1087c14)
	$display("[%0d]: %m: WORKER CONTROL ARM...", v__h19455);
    ...
    if (RST_N)
      if (WILL_FIRE_RL_initFsm_actionof_l1089c14)
	$display("[%0d]: %m: WORKER CONTROL ARM...", v__h20113);
