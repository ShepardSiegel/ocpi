...
//
// On Sun Jan 27 10:32:44 EST 2013
//
//
// Ports:
// Name                         I/O  size props
...
module mkWciInitiator(CLK,
  ...
  wire initFsm_abort$wget,
       initFsm_abort$whas,
       initFsm_start_reg_2$wget,
       initFsm_start_reg_2$whas,
  ...
  wire initiator_reqF_cntr_r$D_IN, initiator_reqF_cntr_r$EN;
  ...
  wire MUX_initFsm_start_reg$write_1__SEL_2,
       ...
       MUX_initiator_reqF_cntr_r$write_1__VAL_1,
       MUX_initiator_reqF_cntr_r$write_1__VAL_2,
  ...
  assign MUX_initiator_respF$enq_1__SEL_1 =
	     MUX_initiator_busy$write_1__PSEL_1 && !initiator_wReset_n ;
  assign MUX_initiator_reqF_cntr_r$write_1__VAL_1 =
	     initiator_reqF_cntr_r + 1'd1 ;
  assign MUX_initiator_reqF_cntr_r$write_1__VAL_2 =
	     initiator_reqF_cntr_r - 1'd1 ;
  ...
  assign initFsm_start_reg_2$wget = 1'd1 ;
  assign initFsm_start_reg_2$whas = initFsm_start_wire$whas ;
  ...
  begin
    case (1'b1) // synopsys parallel_case
      WILL_FIRE_RL_initFsm_idle_l1108c3: initFsm_state_mkFSMstate$D_IN = 4'd0;
      WILL_FIRE_RL_initFsm_action_l1109c5:
  ...
  // register initiator_reqF_cntr_r
  assign initiator_reqF_cntr_r$D_IN =
	     WILL_FIRE_RL_initiator_reqF_incCtr ?
	       MUX_initiator_reqF_cntr_r$write_1__VAL_1 :
	       MUX_initiator_reqF_cntr_r$write_1__VAL_2 ;
  assign initiator_reqF_cntr_r$EN =
	     WILL_FIRE_RL_initiator_reqF_incCtr ||
	     WILL_FIRE_RL_initiator_reqF_decCtr ;
  ...
  // register initiator_respTimrAct
  assign initiator_respTimrAct$D_IN = initiator_reqF_cntr_r ;
  ...
  assign initiator_wReset_n$EN = WILL_FIRE_RL_initFsm_action_l1110c14 ;
  ...
  assign initiator_wTimeout$EN = WILL_FIRE_RL_initFsm_action_l1110c14 ;
  ...
  begin
	...
	if (initiator_reqF_cntr_r$EN)
	  initiator_reqF_cntr_r <= `BSV_ASSIGNMENT_DELAY
	      initiator_reqF_cntr_r$D_IN;
