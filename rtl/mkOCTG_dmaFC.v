...
//
// On Tue Dec 13 10:04:26 EST 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkOCTG_dmaFC(CLK,
  ...
  reg [63 : 0] v__h123589,
	       ...
	       v__h199294,
	       v__h9383;
  reg [31 : 0] CASE_chkUnroll_BITS_4_TO_0_x91849_0x4_x91691_0_ETC__q2,
	       CASE_genUnroll_BITS_4_TO_0_x80194_0x4_x80036_0_ETC__q3;
  reg [15 : 0] v__h179962;
  wire [127 : 0] d_data__h178738,
		 d_data__h190167,
		 t_data__h180246,
		 x__h191914,
		 x__h191942,
  ...
  wire [31 : 0] bAddr__h1460,
		...
		x__h191849,
		y__h198350;
  wire [15 : 0] t_be__h180245, v__h179946;
  wire [7 : 0] x__h187028, x__h200509;
  wire NOT_chkUnroll_23_ULE_16_71_72_AND_NOT_chkVal_5_ETC___d827,
       ...
       genCurBuf_53_ULT_genNumBuf_54_MINUS_1_55___d929,
       genUnroll_45_ULE_16___d954,
  ...
  assign MUX_chkReqInFlight$write_1__SEL_3 =
	     WILL_FIRE_RL_chkRespMesgContinue && chkUnroll_23_ULE_16___d963 ;
  ...
  assign MUX_chkUnroll$write_1__VAL_3 =
	     chkUnroll_23_ULE_16___d963 ? 32'd0 : chkUnroll - 32'd16 ;
  assign MUX_chkVal$write_1__VAL_1 =
	     chkUnroll_23_ULE_16___d963 ?
	       CASE_chkUnroll_BITS_4_TO_0_x91849_0x4_x91691_0_ETC__q2 :
	       x__h191849 ;
  ...
  assign MUX_genUnroll$write_1__VAL_3 =
	     genUnroll_45_ULE_16___d954 ? 32'd0 : genUnroll - 32'd16 ;
  ...
  assign MUX_outF$enq_1__VAL_3 = { 25'd25296895, x_data__h177393 } ;
  assign MUX_outF$enq_1__VAL_4 =
	     { 1'd1, genUnroll == 32'd4, 23'd196607, d_data__h178738 } ;
  ...
  assign MUX_outF$enq_1__VAL_7 =
	     { 89'h182FFFF40000001FF00000F,
	       ...
	       genOpcode,
	       24'd0 } ;
  assign MUX_outF$enq_1__VAL_8 = { 25'd25296895, x_data__h188783 } ;
  assign MUX_outF$enq_1__VAL_9 = { 25'd25362431, d_data__h190167 } ;
  assign MUX_outF$enq_1__VAL_10 = { 25'd25362431, x_data__h198103 } ;
  ...
  // register chkDebugExp
  assign chkDebugExp$D_IN = { chkVal, x__h191691, x__h191726, x__h191761 } ;
  assign chkDebugExp$EN = WILL_FIRE_RL_chkRespMesgContinue ;

  // register chkDebugGot
  assign chkDebugGot$D_IN =
	     { got0__h191898, got1__h191899, got2__h191900, v__h19277 } ;
  ...
  // register chkRepeat
  assign chkRepeat$D_IN = (chkRepeat == 8'd0) ? chkRepeat : x__h200509 ;
  ...
  assign genDebugPbe$D_IN =
	     genUnroll_45_ULE_16___d954 ? v__h179946 : 16'd65535 ;
  ...
  assign genDoMeta0$EN =
	     WILL_FIRE_RL_genRespReady && genLen == 32'd0 ||
	     WILL_FIRE_RL_genMesgContinue && genUnroll_45_ULE_16___d954 ||
	     WILL_FIRE_RL_genMesg && genUnroll == 32'd4 ||
	     WILL_FIRE_RL_genMeta0 ;
  ...
  // register genRepeat
  assign genRepeat$D_IN = (genRepeat == 8'd0) ? genRepeat : x__h187028 ;
  ...
  begin
    case (1'b1) // synopsys parallel_case
      ...
      WILL_FIRE_RL_reqFsm_action_l218c14:
	  reqFsm_state_mkFSMstate$D_IN = 6'd58;
  ...
  assign chkUnroll_23_ULE_16_71_AND_chkUnroll_23_BITS_4_ETC___d826 =
	     ...
	     (chkUnroll[4:0] == 5'h04 &&
	      ...
	      chkUnroll[4:0] != 5'h04 &&
	      chkUnroll_23_BITS_4_TO_0_63_EQ_0x8_65_AND_NOT__ETC___d823) ;
  assign chkUnroll_23_ULE_16___d963 = chkUnroll <= 32'd16 ;
  assign d_data__h178738 =
	     { 22'd1048576,
	       genUnroll[11:2],
	       32'hFF00000F,
	       genMesgAddr[31:2],
  ...
  assign genCurBuf_53_ULT_genNumBuf_54_MINUS_1_55___d929 =
	     genCurBuf < genNumBuf - 8'd1 ;
  assign genUnroll_45_ULE_16___d954 = genUnroll <= 32'd16 ;
  assign got0__h191898 =
	     { inF$D_OUT[103:96],
	       inF$D_OUT[111:104],
	       inF$D_OUT[119:112],
	       inF$D_OUT[127:120] } ;
  assign got1__h191899 =
	     { inF$D_OUT[71:64],
	       inF$D_OUT[79:72],
	       inF$D_OUT[87:80],
	       inF$D_OUT[95:88] } ;
  assign got2__h191900 =
	     { inF$D_OUT[39:32],
	       inF$D_OUT[47:40],
	       inF$D_OUT[55:48],
	       inF$D_OUT[63:56] } ;
  assign ph_data__h183894 =
  ...
  assign reqFsm_abort_whas__94_AND_reqFsm_abort_wget__9_ETC___d480 =
	     (reqFsm_state_mkFSMstate == 6'd0 ||
	      reqFsm_state_mkFSMstate == 6'd58) &&
	     (!reqFsm_start_reg_1 || reqFsm_state_fired) ;
  assign t_be__h180245 = genUnroll_45_ULE_16___d954 ? v__h179946 : 16'd65535 ;
  assign t_data__h180246 = genDebugPdata$D_IN ;
  assign v__h179946 = genUnroll_45_ULE_16___d954 ? v__h179962 : 16'd0 ;
  assign v__h19277 = MUX_rdServer0_fifo_out_data$write_1__VAL_1 ;
  assign x__h180036 = MUX_genVal$write_1__VAL_2 ;
  assign x__h180071 = genVal + 32'd2 ;
  assign x__h180106 = genVal + 32'd3 ;
  assign x__h180194 = genVal + 32'd4 ;
  assign x__h187028 = genRepeat - 8'd1 ;
  assign x__h191691 = MUX_chkVal$write_1__VAL_2 ;
  assign x__h191726 = chkVal + 32'd2 ;
  assign x__h191761 = chkVal + 32'd3 ;
  assign x__h191849 = chkVal + 32'd4 ;
  assign x__h191914 = { chkVal, x__h191691, x__h191726, x__h191761 } ;
  assign x__h191942 =
	     { got0__h191898, got1__h191899, got2__h191900, v__h19277 } ;
  assign x__h200509 = chkRepeat - 8'd1 ;
  assign x_data__h177393 = { 48'd130816, tag, 72'h0F00E0002000000000 } ;
  assign x_data__h188783 = { 48'd130816, tag, 72'h0F00F0002000000000 } ;
  assign x_data__h19011 =
	     { 48'd130816, tag, 8'd15, rdServer1_fifo_in_data[31:2], 34'd0 } ;
  assign x_data__h198103 =
	     { 48'd130816, tag, 8'd15, chkMetaAddr[31:2], 34'd0 } ;
  assign x_data__h9058 =
	     { 48'd130816, tag, 8'd15, bAddr__h1460[31:2], 34'd0 } ;
  assign y__h198350 = { 24'd8388608, chkOpcode } ;
  always@(genUnroll)
  begin
    case (genUnroll[4:0])
      5'h04: v__h179962 = 16'hF000;
      5'h08: v__h179962 = 16'hFF00;
      5'h0C: v__h179962 = 16'hFFF0;
      5'h10: v__h179962 = 16'hFFFF;
      default: v__h179962 = 16'd0;
    endcase
  end
  always@(chkUnroll or x__h191849 or x__h191691 or x__h191726 or x__h191761)
  begin
    case (chkUnroll[4:0])
      5'h04:
	  CASE_chkUnroll_BITS_4_TO_0_x91849_0x4_x91691_0_ETC__q2 = x__h191691;
      5'h08:
	  CASE_chkUnroll_BITS_4_TO_0_x91849_0x4_x91691_0_ETC__q2 = x__h191726;
      5'h0C:
	  CASE_chkUnroll_BITS_4_TO_0_x91849_0x4_x91691_0_ETC__q2 = x__h191761;
      default: CASE_chkUnroll_BITS_4_TO_0_x91849_0x4_x91691_0_ETC__q2 =
		   x__h191849;
    endcase
  end
  always@(genUnroll or x__h180194 or x__h180036 or x__h180071 or x__h180106)
  begin
    case (genUnroll[4:0])
      5'h04:
	  CASE_genUnroll_BITS_4_TO_0_x80194_0x4_x80036_0_ETC__q3 = x__h180036;
      5'h08:
	  CASE_genUnroll_BITS_4_TO_0_x80194_0x4_x80036_0_ETC__q3 = x__h180071;
      5'h0C:
	  CASE_genUnroll_BITS_4_TO_0_x80194_0x4_x80036_0_ETC__q3 = x__h180106;
      default: CASE_genUnroll_BITS_4_TO_0_x80194_0x4_x80036_0_ETC__q3 =
		   x__h180194;
    endcase
  end
  ...
  begin
    ...
    if (RST_N)
      if (reqFsm_state_mkFSMstate == 6'd3)
	$display("[%0d]: %m: Taking Workers out of Reset...", v__h124458);
    if (RST_N)
    ...
    if (RST_N)
      if (reqFsm_state_mkFSMstate == 6'd11)
	$display("[%0d]: %m: Initialize Workers...", v__h133167);
    if (RST_N)
    ...
    if (RST_N)
      if (reqFsm_state_mkFSMstate == 6'd37)
	$display("[%0d]: %m: Start Workers...", v__h157962);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_chkRespMesgContinue && chkUnroll_23_ULE_16___d963 &&
	  chkUnroll[4:0] == 5'h04 &&
	  NOT_chkVal_50_EQ_inF_first__9_BITS_103_TO_96_8_ETC___d805)
	begin
	  v__h195855 = $time;
	...
	$display("[%0d]: %m: chkRespMesg 3DW-L ***MISMATCH*** chkVal:%0x got:%0x",
		 v__h196170,
		 { chkVal, x__h191691, x__h191726 },
		 { got0__h191898, got1__h191899, got2__h191900 });
    if (RST_N)
      if (WILL_FIRE_RL_chkRespMesgContinue && chkUnroll_23_ULE_16___d963 &&
	  chkUnroll_23_BITS_4_TO_0_63_EQ_0x10_67_AND_NOT_ETC___d820)
	begin
	...
	$display("[%0d]: %m: 1DW WRITE-INITIATED  Addr:%0x Data:%0x",
		 ...
		 32'h00E0001C);
    if (RST_N)
      if (WILL_FIRE_RL_reqFsm_action_l218c14)
	begin
	  v__h175129 = $time;
	  #0;
	end
    ...
    if (RST_N)
      if (MUX_reqFsm_state_mkFSMstate$write_1__SEL_2)
	$display("[%0d]: %m: Reading Worker Bit Mask...", v__h123589);
    if (RST_N)
      if (MUX_reqFsm_state_mkFSMstate$write_1__SEL_2 &&
	  (MUX_rdServer0_fifo_in_bypass_enq$wset_1__SEL_1 ||
	   MUX_rdServer0_fifo_in_data$write_1__SEL_16 ||
