...
//
// On Sat Sep 15 15:05:38 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkWSIPatternWorker4B(wciS0_Clk,
  ...
  reg CASE_splaFD_OUT_BITS_1_TO_0_NOT_splaFD_OUT_B_ETC__q1,
      ...
      IF_wci_wslv_reqF_first__5_BITS_35_TO_34_076_EQ_ETC___d1427,
      IF_wci_wslv_reqF_first__5_BITS_63_TO_52_070_EQ_ETC___d1132;
  wire [31 : 0] b__h25071,
		g_data__h32953,
		rdat___1__h32113,
		rdat___1__h32168,
		...
		y_avValue__h30301,
		y_avValue__h30341;
  wire [11 : 0] x_burstLength__h25879;
  wire [3 : 0] x_byteEn__h25881;
  ...
  wire IF_splaF_first__012_BITS_1_TO_0_014_EQ_0_015_T_ETC___d1042,
       dataBram_serverAdapterB_cnt_33_SLT_3___d1260,
  ...
  assign MUX_unrollCnt$write_1__VAL_1 =
	     (v__h24454 == 32'd0) ? 16'd1 : b__h25071[15:0] ;
  ...
  assign MUX_wci_wslv_respF_q_1$write_1__VAL_2 =
	     (wci_wslv_respF_c_r == 2'd2) ?
	       MUX_wci_wslv_respF_q_0$write_1__VAL_1 :
	       34'h0AAAAAAAA ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_1 = { 2'd1, g_data__h32953 } ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_2 =
	     wci_wslv_illegalEdge ? 34'h3C0DE4202 : 34'h1C0DE4201 ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_3 = { 2'd1, v__h29551 } ;
  ...
  assign dataBram_serverAdapterB_outData_enqData$whas =
	     ...
	     dataBram_serverAdapterB_s1[0] ;
  assign dataBram_serverAdapterB_outData_outData$wget = y_avValue__h30177 ;
  ...
  assign metaBram_serverAdapterA_outData_enqData$whas =
	     ...
	     metaBram_serverAdapterA_s1[0] ;
  assign metaBram_serverAdapterA_outData_outData$wget = v__h24454 ;
  ...
  assign metaBram_serverAdapterB_outData_enqData$whas =
	     ...
	     metaBram_serverAdapterB_s1[0] ;
  assign metaBram_serverAdapterB_outData_outData$wget = y_avValue__h30221 ;
  ...
  assign metaBram_serverAdapterB_1_outData_enqData$whas =
	     ...
	     metaBram_serverAdapterB_1_s1[0] ;
  assign metaBram_serverAdapterB_1_outData_outData$wget = y_avValue__h30261 ;
  ...
  assign metaBram_serverAdapterB_2_outData_enqData$whas =
	     ...
	     metaBram_serverAdapterB_2_s1[0] ;
  assign metaBram_serverAdapterB_2_outData_outData$wget = y_avValue__h30301 ;
  ...
  assign metaBram_serverAdapterB_3_outData_enqData$whas =
	     ...
	     metaBram_serverAdapterB_3_s1[0] ;
  assign metaBram_serverAdapterB_3_outData_outData$wget = y_avValue__h30341 ;
  ...
  assign dataBram_serverAdapterA_outData_deqCalled$whas =
	     WILL_FIRE_RL_doMessageEmit && !doZLM ;
  ...
  // register doZLM
  assign doZLM$D_IN = WILL_FIRE_RL_resp_meta && v__h24454 == 32'd0 ;
  assign doZLM$EN =
	     WILL_FIRE_RL_doMessageEmit && doZLM || WILL_FIRE_RL_resp_meta ;
  ...
  // register thisLength
  assign thisLength$D_IN = v__h24454 ;
  ...
  assign b__h25071 = x__h25087 + residue__h25060 ;
  ...
  assign dataBram_serverAdapterB_cnt_33_SLT_3___d1260 =
  ...
  assign doZLM_09_OR_dataBram_serverAdapterA_outDataCor_ETC___d923 =
	     ...
	     (thisLength != 32'd0 && unrollCnt != 16'd1 ||
	      loopReqInFlightF$EMPTY_N) ;
  assign g_data__h32953 =
	     (wci_wslv_reqF$D_OUT[63:52] == 12'h0) ? v__h31927 : 32'd0 ;
  ...
  assign metaReqInFlightF_i_notEmpty__59_AND_metaBram_s_ETC___d875 =
	     ...
	     (metaBram_serverAdapterA_1_outDataCore$EMPTY_N ||
	      metaBram_serverAdapterA_1_outData_enqData$whas) &&
	     metaBram_serverAdapterA_1_outData_outData_whas_ETC___d871 ;
  assign rdat___1__h32113 = hasDebugLogic ? { 24'd0, wsiM_statusR } : 32'd0 ;
  assign rdat___1__h32168 =
	     hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat___1__h32182 =
	     hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat___1__h32190 =
	     hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign residue__h25060 =
	     ({ 4'd0, v__h24454[1:0] } == 6'd0) ? 32'd0 : 32'd1 ;
  ...
  assign x__h25087 = { 2'd0, v__h24454[31:2] } ;
  assign x__h26045 =
													...
													6'd30) ?
													 ...
													 (({ 4'd0,
													   ...
													   6'd31) ?
													    32'h7FFFFFFF :
													    32'hFFFFFFFF))))))))))))))))))))))))))))))) ;
  assign x_burstLength__h25879 =
	     (thisLength == 32'd0 || unrollCnt == 16'd1) ? 12'd1 : 12'd4095 ;
  assign x_byteEn__h25881 =
	     (thisLength == 32'd0) ?
	       4'd0 :
	       ((unrollCnt == 16'd1) ? x__h26045[3:0] : 4'd15) ;
  assign y_avValue__h30177 =
	     dataBram_serverAdapterB_outDataCore$EMPTY_N ?
	       dataBram_serverAdapterB_outDataCore$D_OUT :
	       dataBram_memory$DOB ;
  assign y_avValue__h30221 =
	     metaBram_serverAdapterB_outDataCore$EMPTY_N ?
	       metaBram_serverAdapterB_outDataCore$D_OUT :
	       metaBram_memory$DOB ;
  assign y_avValue__h30261 =
	     metaBram_serverAdapterB_1_outDataCore$EMPTY_N ?
	       metaBram_serverAdapterB_1_outDataCore$D_OUT :
	       metaBram_memory_1$DOB ;
  assign y_avValue__h30301 =
	     metaBram_serverAdapterB_2_outDataCore$EMPTY_N ?
	       metaBram_serverAdapterB_2_outDataCore$D_OUT :
	       metaBram_memory_2$DOB ;
  assign y_avValue__h30341 =
	     metaBram_serverAdapterB_3_outDataCore$EMPTY_N ?
	       metaBram_serverAdapterB_3_outDataCore$D_OUT :
	       metaBram_memory_3$DOB ;
  always@(splaF$D_OUT or
	  y_avValue__h30341 or
	  y_avValue__h30221 or y_avValue__h30261 or y_avValue__h30301)
  begin
  ...
  always@(wci_wslv_reqF$D_OUT or
	  splaF$FULL_N or
	  IF_wci_wslv_reqF_first__5_BITS_35_TO_34_076_EQ_ETC___d1427 or
	  dataBram_serverAdapterB_cnt_33_SLT_3___d1260)
  begin
    case (wci_wslv_reqF$D_OUT[63:52])
      12'h0:
	  IF_wci_wslv_reqF_first__5_BITS_63_TO_52_070_EQ_ETC___d1132 = 1'b1;
      12'h800:
	  IF_wci_wslv_reqF_first__5_BITS_63_TO_52_070_EQ_ETC___d1132 =
	      dataBram_serverAdapterB_cnt_33_SLT_3___d1260 && splaF$FULL_N;
      default: IF_wci_wslv_reqF_first__5_BITS_63_TO_52_070_EQ_ETC___d1132 =
		   wci_wslv_reqF$D_OUT[63:52] != 12'h400 ||
		   splaF$FULL_N &&
		   IF_wci_wslv_reqF_first__5_BITS_35_TO_34_076_EQ_ETC___d1427;
    endcase
  ...
  always@(wci_wslv_reqF$D_OUT or
	  ...
	  mesgRemain or
	  rdat___1__h32113 or
	  rdat___1__h32168 or rdat___1__h32182 or rdat___1__h32190)
  begin
    case (wci_wslv_reqF$D_OUT[39:32])
      8'h0: v__h31927 = controlReg;
      8'h08: v__h31927 = mesgCount;
      8'h0C: v__h31927 = dataCount;
      8'h10: v__h31927 = mesgRemain;
      8'h1C: v__h31927 = 32'hA0240A0A;
      8'h20: v__h31927 = rdat___1__h32113;
      8'h24: v__h31927 = rdat___1__h32168;
      8'h28: v__h31927 = rdat___1__h32182;
      8'h2C: v__h31927 = rdat___1__h32190;
      default: v__h31927 = 32'd0;
    endcase
  end
  always@(splaF$D_OUT or
  ...
  begin
    ...
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_advance_split_response)
	$display("[%0d]: %m: WCI SPLIT READ Data:%0x", v__h30469, v__h29551);
    if (wciS0_MReset_n)
