...
//
// On Thu Sep 27 11:26:39 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkWSIPatternWorker4B(wciS0_Clk,
  ...
  reg CASE_splaFD_OUT_BITS_1_TO_0_NOT_splaFD_OUT_B_ETC__q1,
      ...
      IF_wci_wslv_reqF_first__5_BITS_63_TO_52_070_EQ_ETC___d1138;
  wire [31 : 0] b__h25414,
		g_data__h33320,
		rdat___1__h32480,
		rdat___1__h32535,
  ...
  wire IF_splaF_first__012_BITS_1_TO_0_014_EQ_0_015_T_ETC___d1042,
       ...
       IF_wci_wslv_reqF_i_notEmpty__4_AND_wci_wslv_re_ETC___d1368,
       dataBram_serverAdapterB_cnt_33_SLT_3___d1241,
  ...
  assign MUX_wci_wslv_respF_q_1$write_1__VAL_1 =
	     (wci_wslv_respF_c_r == 2'd2) ?
	       MUX_wci_wslv_respF_q_0$write_1__VAL_2 :
	       34'h0AAAAAAAA ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_1 = { 2'd1, g_data__h33320 } ;
  ...
  // register doZLM
  assign doZLM$D_IN = WILL_FIRE_RL_resp_meta && v__h24797 == 32'd0 ;
  assign doZLM$EN =
  ...
  assign IF_wci_wslv_reqF_i_notEmpty__4_AND_wci_wslv_re_ETC___d1093 =
	     (wci_wslv_reqF$EMPTY_N && wci_wslv_reqF$D_OUT[35:34] == 2'd1) ?
	       ...
	       IF_wci_wslv_reqF_i_notEmpty__4_AND_wci_wslv_re_ETC___d1092 ;
  assign IF_wci_wslv_reqF_i_notEmpty__4_AND_wci_wslv_re_ETC___d1368 =
  ...
  assign dataBram_serverAdapterB_cnt_33_SLT_3___d1241 =
  ...
  assign doZLM_09_OR_dataBram_serverAdapterA_outDataCor_ETC___d923 =
	     ...
	     (thisLength != 32'd0 && unrollCnt != 16'd1 ||
	      loopReqInFlightF$EMPTY_N) ;
  assign g_data__h33320 =
	     (wci_wslv_reqF$D_OUT[63:52] == 12'h0) ? v__h32294 : 32'd0 ;
  ...
  assign metaReqInFlightF_i_notEmpty__59_AND_metaBram_s_ETC___d875 =
	     ...
	     (metaBram_serverAdapterA_1_outDataCore$EMPTY_N ||
	      metaBram_serverAdapterA_1_outData_enqData$whas) &&
	     metaBram_serverAdapterA_1_outData_outData_whas_ETC___d871 ;
  assign rdat___1__h32480 = hasDebugLogic ? { 24'd0, wsiM_statusR } : 32'd0 ;
  assign rdat___1__h32535 =
	     hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat___1__h32549 =
	     hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat___1__h32557 =
  ...
  always@(wci_wslv_reqF$D_OUT or
	  splaF$FULL_N or
	  IF_wci_wslv_reqF_i_notEmpty__4_AND_wci_wslv_re_ETC___d1368 or
	  dataBram_serverAdapterB_cnt_33_SLT_3___d1241)
  begin
    case (wci_wslv_reqF$D_OUT[63:52])
      12'h0:
	  IF_wci_wslv_reqF_first__5_BITS_63_TO_52_070_EQ_ETC___d1138 = 1'b1;
      12'h800:
	  IF_wci_wslv_reqF_first__5_BITS_63_TO_52_070_EQ_ETC___d1138 =
	      dataBram_serverAdapterB_cnt_33_SLT_3___d1241 && splaF$FULL_N;
      default: IF_wci_wslv_reqF_first__5_BITS_63_TO_52_070_EQ_ETC___d1138 =
		   wci_wslv_reqF$D_OUT[63:52] != 12'h400 ||
		   splaF$FULL_N &&
		   IF_wci_wslv_reqF_i_notEmpty__4_AND_wci_wslv_re_ETC___d1368;
    endcase
  ...
  always@(wci_wslv_reqF$D_OUT or
	  ...
	  mesgRemain or
	  rdat___1__h32480 or
	  rdat___1__h32535 or rdat___1__h32549 or rdat___1__h32557)
  begin
    case (wci_wslv_reqF$D_OUT[39:32])
      8'h0: v__h32294 = controlReg;
      8'h08: v__h32294 = mesgCount;
      8'h0C: v__h32294 = dataCount;
      8'h10: v__h32294 = mesgRemain;
      8'h1C: v__h32294 = 32'hA0240A0A;
      8'h20: v__h32294 = rdat___1__h32480;
      8'h24: v__h32294 = rdat___1__h32535;
      8'h28: v__h32294 = rdat___1__h32549;
      8'h2C: v__h32294 = rdat___1__h32557;
      default: v__h32294 = 32'd0;
    endcase
  end
  always@(splaF$D_OUT or
