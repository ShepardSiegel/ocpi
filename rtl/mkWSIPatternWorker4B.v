...
//
// On Mon Mar 12 15:59:32 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkWSIPatternWorker4B(wciS0_Clk,
  ...
  wire MUX_controlReg$write_1__SEL_1,
       ...
       MUX_metaBram_memory_1$b_put_2__SEL_2,
  ...
  reg [63 : 0] v__h29021,
	       ...
	       v__h3820,
	       v__h3964;
  reg [31 : 0] IF_splaF_first__95_BITS_1_TO_0_97_EQ_0_98_THEN_ETC___d1049,
	       v__h31536;
  reg CASE_splaFD_OUT_BITS_1_TO_0_NOT_splaFD_OUT_B_ETC__q2,
      IF_splaF_first__95_BITS_1_TO_0_97_EQ_0_98_THEN_ETC___d1016,
      IF_wci_wslv_reqF_first__5_BITS_35_TO_34_059_EQ_ETC___d1402,
      IF_wci_wslv_reqF_first__5_BITS_63_TO_52_053_EQ_ETC___d1112;
  wire [31 : 0] g_data__h32556,
		rdat___1__h31717,
		rdat___1__h31772,
		rdat___1__h31786,
		rdat___1__h31794,
		...
		y_avValue__h29951,
		y_avValue__h29991;
  wire [11 : 0] x_burstLength__h25518;
  wire [3 : 0] x_byteEn__h25520;
  ...
  wire [1 : 0] ab__h11330, ab__h14429, ab__h17356, ab__h20283, ab__h23210;
  wire IF_splaF_first__95_BITS_1_TO_0_97_EQ_0_98_THEN_ETC___d1025,
       dataBram_serverAdapterB_cnt_33_SLT_3___d1210,
       metaBram_serverAdapterA_1_outData_outData_whas_ETC___d869,
       metaReqInFlightF_i_notEmpty__57_AND_metaBram_s_ETC___d873,
       splaF_i_notEmpty__94_AND_IF_splaF_first__95_BI_ETC___d1027;
  ...
  // rule RL_doMessageEmit
  assign WILL_FIRE_RL_doMessageEmit =
  ...
  assign WILL_FIRE_RL_wsiM_reqFifo_incCtr =
		...
		WILL_FIRE_RL_doMessageEmit :
		wsiM_reqFifo_c_r != 2'd1 || WILL_FIRE_RL_doMessageEmit) &&
	     WILL_FIRE_RL_doMessageEmit &&
	     !WILL_FIRE_RL_wsiM_reqFifo_deq ;

  // rule RL_wsiM_reqFifo_decCtr
  assign WILL_FIRE_RL_wsiM_reqFifo_decCtr =
	     WILL_FIRE_RL_wsiM_reqFifo_deq && !WILL_FIRE_RL_doMessageEmit ;

  // rule RL_wsiM_reqFifo_both
  assign WILL_FIRE_RL_wsiM_reqFifo_both =
	     ((wsiM_reqFifo_c_r == 2'd1) ?
		WILL_FIRE_RL_doMessageEmit :
		wsiM_reqFifo_c_r != 2'd2 || WILL_FIRE_RL_doMessageEmit) &&
	     WILL_FIRE_RL_wsiM_reqFifo_deq &&
	     WILL_FIRE_RL_doMessageEmit ;
  ...
  assign MUX_mesgCount$write_1__SEL_2 =
	     WILL_FIRE_RL_doMessageEmit && unrollCnt == 16'd1 ;
  ...
  assign MUX_metaBram_memory_1$b_put_2__SEL_2 =
	     WILL_FIRE_RL_wci_cfwr && wci_wslv_reqF$D_OUT[63:52] == 12'h400 &&
	     wci_wslv_reqF$D_OUT[35:34] == 2'd1 ;
  ...
  assign MUX_unrollCnt$write_1__VAL_1 =
	     (v__h24310 == 32'd0) ? 16'd1 : x4918_PLUS_residue4889__q1[15:0] ;
  ...
  assign MUX_wci_wslv_respF_q_1$write_1__VAL_1 =
	     (wci_wslv_respF_c_r == 2'd2) ?
	       MUX_wci_wslv_respF_q_0$write_1__VAL_2 :
	       34'h0AAAAAAAA ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_1 = { 2'd1, g_data__h32556 } ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_2 =
	     wci_wslv_illegalEdge ? 34'h3C0DE4202 : 34'h1C0DE4201 ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_3 = { 2'd1, v__h29201 } ;
  ...
  assign wsiM_reqFifo_x_wire$whas = WILL_FIRE_RL_doMessageEmit ;
  ...
  assign dataBram_serverAdapterA_outData_enqData$whas =
	     ...
	     dataBram_serverAdapterA_s1[0] ;
  assign dataBram_serverAdapterA_outData_outData$wget = x_data__h25519 ;
  ...
  assign dataBram_serverAdapterA_cnt_2$whas = WILL_FIRE_RL_doMessageEmit ;
  ...
  assign dataBram_serverAdapterB_outData_enqData$whas =
	     ...
	     dataBram_serverAdapterB_s1[0] ;
  assign dataBram_serverAdapterB_outData_outData$wget = y_avValue__h29827 ;
  ...
  assign dataBram_serverAdapterB_writeWithResp$wget = ab__h11330 ;
  assign dataBram_serverAdapterB_writeWithResp$whas =
	     MUX_dataBram_memory$b_put_1__SEL_1 ||
	     MUX_dataBram_memory$b_put_1__SEL_2 ;
  assign dataBram_serverAdapterB_s1_1$wget =
	     { 1'd1, !ab__h11330[1] || ab__h11330[0] } ;
  ...
  assign metaBram_serverAdapterA_outData_enqData$whas =
	     ...
	     metaBram_serverAdapterA_s1[0] ;
  assign metaBram_serverAdapterA_outData_outData$wget = v__h24310 ;
  ...
  assign metaBram_serverAdapterA_cnt_2$whas = WILL_FIRE_RL_resp_meta ;
  ...
  assign metaBram_serverAdapterB_outData_enqData$whas =
	     ...
	     metaBram_serverAdapterB_s1[0] ;
  assign metaBram_serverAdapterB_outData_outData$wget = y_avValue__h29871 ;
  ...
  assign metaBram_serverAdapterB_writeWithResp$wget = ab__h14429 ;
  assign metaBram_serverAdapterB_writeWithResp$whas =
	     MUX_metaBram_memory$b_put_1__SEL_1 ||
	     MUX_metaBram_memory$b_put_1__SEL_2 ;
  assign metaBram_serverAdapterB_s1_1$wget =
	     { 1'd1, !ab__h14429[1] || ab__h14429[0] } ;
  ...
  assign metaBram_serverAdapterA_1_cnt_2$whas = WILL_FIRE_RL_resp_meta ;
  ...
  assign metaBram_serverAdapterB_1_outData_enqData$whas =
	     ...
	     metaBram_serverAdapterB_1_s1[0] ;
  assign metaBram_serverAdapterB_1_outData_outData$wget = y_avValue__h29911 ;
  ...
  assign metaBram_serverAdapterA_2_cnt_2$whas = WILL_FIRE_RL_resp_meta ;
  ...
  assign metaBram_serverAdapterB_2_outData_enqData$whas =
	     ...
	     metaBram_serverAdapterB_2_s1[0] ;
  assign metaBram_serverAdapterB_2_outData_outData$wget = y_avValue__h29951 ;
  ...
  assign metaBram_serverAdapterA_3_cnt_2$whas = WILL_FIRE_RL_resp_meta ;
  ...
  assign metaBram_serverAdapterB_3_outData_enqData$whas =
	     ...
	     metaBram_serverAdapterB_3_s1[0] ;
  assign metaBram_serverAdapterB_3_outData_outData$wget = y_avValue__h29991 ;
  ...
  assign wci_wslv_wci_ctrl_pw$whas =
	     wci_wslv_reqF$EMPTY_N && !wci_wslv_reqF$D_OUT[68] &&
	     wci_wslv_reqF$D_OUT[71:69] == 3'd2 ;
  assign wsiM_reqFifo_enqueueing$whas = WILL_FIRE_RL_doMessageEmit ;
  ...
  case (1'b1)
    ...
    WILL_FIRE_RL_doMessageEmit: dataCount$D_IN = MUX_dataCount$write_1__VAL_2;
  ...
  // register mesgRemain
  assign mesgRemain$D_IN = mesgRemain - 16'd1 ;
  assign mesgRemain$EN = WILL_FIRE_RL_resp_meta ;
  ...
  assign unrollCnt$D_IN =
	     WILL_FIRE_RL_resp_meta ?
	       MUX_unrollCnt$write_1__VAL_1 :
	       MUX_unrollCnt$write_1__VAL_2 ;
  assign unrollCnt$EN = WILL_FIRE_RL_resp_meta || WILL_FIRE_RL_doMessageEmit ;
  ...
  assign metaReqInFlightF$ENQ =
	     WILL_FIRE_RL_metaBram_serverAdapterA_stageReadResponseAlways ;
  assign metaReqInFlightF$DEQ = WILL_FIRE_RL_resp_meta ;
  ...
  // remaining internal signals
  assign IF_splaF_first__95_BITS_1_TO_0_97_EQ_0_98_THEN_ETC___d1025 =
	     IF_splaF_first__95_BITS_1_TO_0_97_EQ_0_98_THEN_ETC___d1016 &&
	     CASE_splaFD_OUT_BITS_1_TO_0_NOT_splaFD_OUT_B_ETC__q2 ;
  assign ab__h11330 = MUX_dataBram_memory$b_put_1__SEL_1 ? 2'd0 : 2'd2 ;
  assign ab__h14429 = MUX_metaBram_memory$b_put_1__SEL_1 ? 2'd0 : 2'd2 ;
  assign ab__h17356 = MUX_metaBram_memory_1$b_put_1__SEL_1 ? 2'd0 : 2'd2 ;
  assign ab__h20283 = MUX_metaBram_memory_2$b_put_1__SEL_1 ? 2'd0 : 2'd2 ;
  assign ab__h23210 = MUX_metaBram_memory_3$b_put_1__SEL_1 ? 2'd0 : 2'd2 ;
  assign dataBram_serverAdapterA_cnt_74_PLUS_IF_dataBra_ETC___d280 =
	     dataBram_serverAdapterA_cnt +
	     (WILL_FIRE_RL_dataBram_serverAdapterA_stageReadResponseAlways ?
		3'd1 :
		3'd0) +
	     (WILL_FIRE_RL_doMessageEmit ? 3'd7 : 3'd0) ;
  assign dataBram_serverAdapterB_cnt_33_PLUS_IF_dataBra_ETC___d339 =
	     ...
	     (dataBram_serverAdapterB_cnt_2$whas ? 3'd7 : 3'd0) ;
  assign dataBram_serverAdapterB_cnt_33_SLT_3___d1210 =
	     (dataBram_serverAdapterB_cnt ^ 3'h4) < 3'd7 ;
  assign g_data__h32556 =
	     (wci_wslv_reqF$D_OUT[63:52] == 12'h0) ? v__h31536 : 32'd0 ;
  assign metaBram_serverAdapterA_1_cnt_10_PLUS_IF_metaB_ETC___d516 =
	     metaBram_serverAdapterA_1_cnt +
	     (WILL_FIRE_RL_metaBram_serverAdapterA_stageReadResponseAlways ?
		3'd1 :
		3'd0) +
	     (WILL_FIRE_RL_resp_meta ? 3'd7 : 3'd0) ;
  assign metaBram_serverAdapterA_1_outData_outData_whas_ETC___d869 =
	     metaBram_serverAdapterA_1_outData_outData$whas &&
	     (metaBram_serverAdapterA_2_outDataCore$EMPTY_N ||
	      metaBram_serverAdapterA_2_outData_enqData$whas) &&
	     metaBram_serverAdapterA_2_outData_outData$whas &&
  ...
  assign metaReqInFlightF_i_notEmpty__57_AND_metaBram_s_ETC___d873 =
	     metaReqInFlightF$EMPTY_N &&
	     (metaBram_serverAdapterA_outDataCore$EMPTY_N ||
	      metaBram_serverAdapterA_outData_enqData$whas) &&
	     metaBram_serverAdapterA_outData_outData$whas &&
	     (metaBram_serverAdapterA_1_outDataCore$EMPTY_N ||
	      metaBram_serverAdapterA_1_outData_enqData$whas) &&
	     metaBram_serverAdapterA_1_outData_outData_whas_ETC___d869 ;
  assign rdat___1__h31717 = hasDebugLogic ? { 24'd0, wsiM_statusR } : 32'd0 ;
  assign rdat___1__h31772 =
	     hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat___1__h31786 =
	     hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat___1__h31794 =
	     hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign residue__h24889 =
	     ({ 4'd0, v__h24310[1:0] } == 6'd0) ? 32'd0 : 32'd1 ;
  assign splaF_i_notEmpty__94_AND_IF_splaF_first__95_BI_ETC___d1027 =
	     splaF$EMPTY_N &&
	     (splaF$D_OUT[2] ?
		(splaF$D_OUT[1:0] != 2'd0 ||
		 dataBram_serverAdapterB_outDataCore$EMPTY_N ||
		...
		(splaF$D_OUT[1:0] != 2'd0 ||
		 dataBram_serverAdapterB_outData_outData$whas) :
		IF_splaF_first__95_BITS_1_TO_0_97_EQ_0_98_THEN_ETC___d1025) ;
  assign v__h24310 =
	     metaBram_serverAdapterA_outDataCore$EMPTY_N ?
	       metaBram_serverAdapterA_outDataCore$D_OUT :
	       metaBram_memory$DOA ;
  assign v__h29201 =
	     splaF$D_OUT[2] ?
	       y_avValue__h29827 :
	       IF_splaF_first__95_BITS_1_TO_0_97_EQ_0_98_THEN_ETC___d1049 ;
  assign x4918_PLUS_residue4889__q1 = x__h24918 + residue__h24889 ;
  assign x__h24918 = { 2'd0, v__h24310[31:2] } ;
  assign x__h25693 =
													...
													6'd30) ?
													 ...
													 (({ 4'd0,
													   ...
													   6'd31) ?
													    32'h7FFFFFFF :
													    32'hFFFFFFFF))))))))))))))))))))))))))))))) ;
  assign x_burstLength__h25518 =
	     (thisLength == 32'd0 || unrollCnt == 16'd1) ? 12'd1 : 12'd4095 ;
  assign x_byteEn__h25520 =
	     (thisLength == 32'd0) ?
	       4'd0 :
	       ((unrollCnt == 16'd1) ? x__h25693[3:0] : 4'd15) ;
  assign x_data__h25519 =
	     dataBram_serverAdapterA_outDataCore$EMPTY_N ?
	       dataBram_serverAdapterA_outDataCore$D_OUT :
	       dataBram_memory$DOA ;
  assign y_avValue__h29827 =
	     dataBram_serverAdapterB_outDataCore$EMPTY_N ?
	       dataBram_serverAdapterB_outDataCore$D_OUT :
	       dataBram_memory$DOB ;
  assign y_avValue__h29871 =
	     metaBram_serverAdapterB_outDataCore$EMPTY_N ?
	       metaBram_serverAdapterB_outDataCore$D_OUT :
	       metaBram_memory$DOB ;
  assign y_avValue__h29911 =
	     metaBram_serverAdapterB_1_outDataCore$EMPTY_N ?
	       metaBram_serverAdapterB_1_outDataCore$D_OUT :
	       metaBram_memory_1$DOB ;
  assign y_avValue__h29951 =
	     metaBram_serverAdapterB_2_outDataCore$EMPTY_N ?
	       metaBram_serverAdapterB_2_outDataCore$D_OUT :
	       metaBram_memory_2$DOB ;
  assign y_avValue__h29991 =
	     metaBram_serverAdapterB_3_outDataCore$EMPTY_N ?
	       metaBram_serverAdapterB_3_outDataCore$D_OUT :
	       metaBram_memory_3$DOB ;
  always@(splaF$D_OUT or
	  y_avValue__h29991 or
	  y_avValue__h29871 or y_avValue__h29911 or y_avValue__h29951)
  begin
  ...
  always@(wci_wslv_reqF$D_OUT or
	  splaF$FULL_N or
	  IF_wci_wslv_reqF_first__5_BITS_35_TO_34_059_EQ_ETC___d1402 or
	  dataBram_serverAdapterB_cnt_33_SLT_3___d1210)
  begin
    case (wci_wslv_reqF$D_OUT[63:52])
      12'h0:
	  IF_wci_wslv_reqF_first__5_BITS_63_TO_52_053_EQ_ETC___d1112 = 1'b1;
      12'h800:
	  IF_wci_wslv_reqF_first__5_BITS_63_TO_52_053_EQ_ETC___d1112 =
	      dataBram_serverAdapterB_cnt_33_SLT_3___d1210 && splaF$FULL_N;
      default: IF_wci_wslv_reqF_first__5_BITS_63_TO_52_053_EQ_ETC___d1112 =
		   wci_wslv_reqF$D_OUT[63:52] != 12'h400 ||
		   splaF$FULL_N &&
		   IF_wci_wslv_reqF_first__5_BITS_35_TO_34_059_EQ_ETC___d1402;
    endcase
  ...
  always@(wci_wslv_reqF$D_OUT or
	  ...
	  dataCount or
	  rdat___1__h31717 or
	  rdat___1__h31772 or rdat___1__h31786 or rdat___1__h31794)
  begin
    case (wci_wslv_reqF$D_OUT[39:32])
      8'h0: v__h31536 = controlReg;
      8'h08: v__h31536 = mesgCount;
      8'h0C: v__h31536 = dataCount;
      8'h1C: v__h31536 = 32'hA0240A0A;
      8'h20: v__h31536 = rdat___1__h31717;
      8'h24: v__h31536 = rdat___1__h31772;
      8'h28: v__h31536 = rdat___1__h31786;
      8'h2C: v__h31536 = rdat___1__h31794;
      default: v__h31536 = 32'd0;
    endcase
  end
  always@(splaF$D_OUT or
  ...
  begin
	...
	mesgRemain <= `BSV_ASSIGNMENT_DELAY 16'd1;
  ...
  begin
	...
	$display("Error: \"bsv/wrk/WSIPatternWorker.bsv\", line 218, column 62: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_ctrl_IsO] and\n  [RL_wci_ctrl_OrE] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n)
	...
	$display("Error: \"bsv/wrk/WSIPatternWorker.bsv\", line 218, column 48: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_ctrl_EiI] and\n  [RL_wci_ctrl_OrE] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n)
    ...
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_doMessageEmit && unrollCnt == 16'd1)
	begin
	  v__h29021 = $time;
	  #0;
	end
	...
	$display("Error: \"bsv/wrk/WSIPatternWorker.bsv\", line 218, column 28: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_cfwr] and\n  [RL_advance_split_response] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n)
	...
	$display("Error: \"bsv/wrk/WSIPatternWorker.bsv\", line 218, column 38: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_cfrd] and\n  [RL_advance_split_response] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n)
