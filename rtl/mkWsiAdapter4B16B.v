...
//
// On Sat Oct  1 13:09:52 EDT 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkWsiAdapter4B16B(CLK,
  ...
  // inlined wires
  wire [168 : 0] wsiM_reqFifo_x_wire$wget;
  ...
  reg [15 : 0] x_byteEn__h6550;
  wire [127 : 0] x_data__h6549;
  wire [15 : 0] be__h7339, be__h7358, be__h7399, be__h7455;
  wire [11 : 0] x__h7403, x_burstLength__h6548;
  wire [7 : 0] x__h7362;
  ...
  assign MUX_isFull$write_1__VAL_1 = pos == 2'd3 || wsiS_reqFifo$D_OUT[57] ;
  assign MUX_pos$write_1__VAL_1 = pos + 2'd1 ;
  ...
  // register pos
  assign pos$D_IN =
	     WILL_FIRE_RL_doRequestIngress ? MUX_pos$write_1__VAL_1 : 2'd0 ;
  assign pos$EN =
	     WILL_FIRE_RL_doRequestIngress || WILL_FIRE_RL_doRequestEgress ;

  // register stage
  assign stage$D_IN = wsiS_reqFifo$D_OUT ;
  assign stage$EN = WILL_FIRE_RL_doRequestIngress && pos == 2'd0 ;

  // register stage_1
  assign stage_1$D_IN = wsiS_reqFifo$D_OUT ;
  assign stage_1$EN = WILL_FIRE_RL_doRequestIngress && pos == 2'd1 ;

  // register stage_2
  assign stage_2$D_IN = wsiS_reqFifo$D_OUT ;
  assign stage_2$EN = WILL_FIRE_RL_doRequestIngress && pos == 2'd2 ;

  // register stage_3
  assign stage_3$D_IN = wsiS_reqFifo$D_OUT ;
  assign stage_3$EN = WILL_FIRE_RL_doRequestIngress && pos == 2'd3 ;
  ...
  // remaining internal signals
  assign be__h7339 = { 12'd0, stage[11:8] } ;
  assign be__h7358 = { 8'd0, x__h7362 } ;
  assign be__h7399 = { 4'd0, x__h7403 } ;
  assign be__h7455 = { stage_3[11:8], x__h7403 } ;
  assign x__h7362 = { stage_1[11:8], stage[11:8] } ;
  assign x__h7403 = { stage_2[11:8], x__h7362 } ;
  assign x_burstLength__h6548 = stage[55:44] >> 2 ;
  assign x_data__h6549 =
	     { stage_3[43:12],
	       stage_2[43:12],
	       stage_1[43:12],
	       stage[43:12] } ;
  always@(pos or
	  ...
	  stage_2 or
	  stage_1 or
	  stage or be__h7339 or be__h7358 or be__h7399 or be__h7455)
  begin
    case (pos)
      2'd0: x_byteEn__h6550 = be__h7339;
      2'd1: x_byteEn__h6550 = be__h7358;
      2'd2: x_byteEn__h6550 = be__h7399;
      2'd3: x_byteEn__h6550 = be__h7455;
    endcase
  end
