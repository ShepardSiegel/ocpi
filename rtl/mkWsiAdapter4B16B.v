...
//
// On Fri Jul 23 11:06:34 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkWsiAdapter4B16B(CLK,
  ...
  wire [127 : 0] wsiM1_MData;
  wire [15 : 0] wsiM1_MByteEn;
  ...
  reg [15 : 0] x_byteEn__h5729;
  wire [127 : 0] x_data__h5728;
  wire [15 : 0] be__h6064, be__h6083, be__h6124, be__h6180;
  wire [11 : 0] x__h6128;
  wire [7 : 0] x__h6087;
  wire wsiS_reqFifo_notFull__70_AND_wsiS_burstKind_50_ETC___d189;
  ...
  assign wsiS_burstKind$EN =
	     WILL_FIRE_RL_wsiS_reqFifo_enq &&
	     wsiS_reqFifo_notFull__70_AND_wsiS_burstKind_50_ETC___d189 ;
  ...
  // remaining internal signals
  assign be__h6064 = { 12'd0, stage[11:8] } ;
  assign be__h6083 = { 8'd0, x__h6087 } ;
  assign be__h6124 = { 4'd0, x__h6128 } ;
  assign be__h6180 = { stage_3[11:8], x__h6128 } ;
  assign wsiS_reqFifo_notFull__70_AND_wsiS_burstKind_50_ETC___d189 =
	     wsiS_reqFifo$FULL_N &&
	     (wsiS_burstKind == 2'd0 ||
	      (wsiS_burstKind == 2'd1 || wsiS_burstKind == 2'd2) &&
	      wsiS_wsiReq$wget[57]) ;
  assign x__h6087 = { stage_1[11:8], stage[11:8] } ;
  assign x__h6128 = { stage_2[11:8], x__h6087 } ;
  assign x_data__h5728 =
	     { stage_3[43:12],
	       stage_2[43:12],
	       stage_1[43:12],
	       stage[43:12] } ;
  always@(pos or
	  ...
	  stage_2 or
	  stage_1 or
	  stage or be__h6064 or be__h6083 or be__h6124 or be__h6180)
  begin
    case (pos)
      2'd0: x_byteEn__h5729 = be__h6064;
      2'd1: x_byteEn__h5729 = be__h6083;
      2'd2: x_byteEn__h5729 = be__h6124;
      2'd3: x_byteEn__h5729 = be__h6180;
    endcase
  end
