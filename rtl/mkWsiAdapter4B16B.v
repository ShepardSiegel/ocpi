...
//
// On Fri Mar 18 08:42:59 EDT 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkWsiAdapter4B16B(CLK,
  ...
  reg [15 : 0] x_byteEn__h6561;
  wire [127 : 0] x_data__h6560;
  wire [15 : 0] be__h7350, be__h7369, be__h7410, be__h7466;
  wire [11 : 0] x__h7414, x_burstLength__h6559;
  wire [7 : 0] x__h7373;
  ...
  // remaining internal signals
  assign be__h7350 = { 12'd0, stage[11:8] } ;
  assign be__h7369 = { 8'd0, x__h7373 } ;
  assign be__h7410 = { 4'd0, x__h7414 } ;
  assign be__h7466 = { stage_3[11:8], x__h7414 } ;
  assign wsiS_reqFifo_notFull__2_AND_wsiS_burstKind_7_E_ETC___d54 =
	     wsiS_reqFifo$FULL_N &&
	     (wsiS_burstKind == 2'd0 ||
	      (wsiS_burstKind == 2'd1 || wsiS_burstKind == 2'd2) &&
	      wsiS_wsiReq$wget[57]) ;
  assign x__h7373 = { stage_1[11:8], stage[11:8] } ;
  assign x__h7414 = { stage_2[11:8], x__h7373 } ;
  assign x_burstLength__h6559 = stage[55:44] >> 2 ;
  assign x_data__h6560 =
	     { stage_3[43:12],
	       stage_2[43:12],
	       stage_1[43:12],
	       stage[43:12] } ;
  always@(pos or
	  ...
	  stage_2 or
	  stage_1 or
	  stage or be__h7350 or be__h7369 or be__h7410 or be__h7466)
  begin
    case (pos)
      2'd0: x_byteEn__h6561 = be__h7350;
      2'd1: x_byteEn__h6561 = be__h7369;
      2'd2: x_byteEn__h6561 = be__h7410;
      2'd3: x_byteEn__h6561 = be__h7466;
    endcase
  end
