...
//
// On Fri Mar 18 16:39:12 EDT 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkWsiAdapter4B16B(CLK,
  ...
  assign stage$EN =
	     MUX_wsiS_reqFifo_levelsValid$write_1__SEL_2 && pos == 2'd0 ;

  // register stage_1
  assign stage_1$D_IN = wsiS_reqFifo$D_OUT ;
  assign stage_1$EN =
	     MUX_wsiS_reqFifo_levelsValid$write_1__SEL_2 && pos == 2'd1 ;

  // register stage_2
  assign stage_2$D_IN = wsiS_reqFifo$D_OUT ;
  assign stage_2$EN =
	     MUX_wsiS_reqFifo_levelsValid$write_1__SEL_2 && pos == 2'd2 ;

  // register stage_3
  assign stage_3$D_IN = wsiS_reqFifo$D_OUT ;
  assign stage_3$EN =
	     MUX_wsiS_reqFifo_levelsValid$write_1__SEL_2 && pos == 2'd3 ;
