...
//
// On Tue Jan 18 08:55:33 EST 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkWsiAdapter4B16B(CLK,
  ...
  wire [15 : 0] be__h6636, be__h6655, be__h6696, be__h6752;
  wire [11 : 0] x__h6700;
  wire [7 : 0] x__h6659;
  ...
  // remaining internal signals
  assign be__h6636 = { 12'd0, stage[11:8] } ;
  assign be__h6655 = { 8'd0, x__h6659 } ;
  assign be__h6696 = { 4'd0, x__h6700 } ;
  assign be__h6752 = { stage_3[11:8], x__h6700 } ;
  assign wsiS_reqFifo_notFull__1_AND_wsiS_burstKind_6_E_ETC___d53 =
	     wsiS_reqFifo$FULL_N &&
	     (wsiS_burstKind == 2'd0 ||
	      (wsiS_burstKind == 2'd1 || wsiS_burstKind == 2'd2) &&
	      wsiS_wsiReq$wget[57]) ;
  assign x__h6659 = { stage_1[11:8], stage[11:8] } ;
  assign x__h6700 = { stage_2[11:8], x__h6659 } ;
  ...
  always@(pos or
	  ...
	  stage_2 or
	  stage_1 or
	  stage or be__h6636 or be__h6655 or be__h6696 or be__h6752)
  begin
    case (pos)
      2'd0: x_byteEn__h6439 = be__h6636;
      2'd1: x_byteEn__h6439 = be__h6655;
      2'd2: x_byteEn__h6439 = be__h6696;
      2'd3: x_byteEn__h6439 = be__h6752;
    endcase
  end
