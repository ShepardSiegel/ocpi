...
//
// On Tue Jul 13 07:43:17 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkWsiAdapter4B16B(CLK,
  ...
  reg [15 : 0] x_byteEn__h5652;
  wire [127 : 0] x_data__h5651;
  wire [15 : 0] be__h5987, be__h6006, be__h6047, be__h6103;
  wire [11 : 0] x__h6051;
  wire [7 : 0] x__h6010;
  wire wsiS_reqFifo_notFull__70_AND_wsiS_burstKind_50_ETC___d186;
  ...
  assign wsiS_burstKind$EN =
	     WILL_FIRE_RL_wsiS_reqFifo_enq &&
	     wsiS_reqFifo_notFull__70_AND_wsiS_burstKind_50_ETC___d186 ;
  ...
  // remaining internal signals
  assign be__h5987 = { 12'd0, stage[11:8] } ;
  assign be__h6006 = { 8'd0, x__h6010 } ;
  assign be__h6047 = { 4'd0, x__h6051 } ;
  assign be__h6103 = { stage_3[11:8], x__h6051 } ;
  assign wsiS_reqFifo_notFull__70_AND_wsiS_burstKind_50_ETC___d186 =
	     wsiS_reqFifo$FULL_N &&
	     (wsiS_burstKind == 2'd0 ||
	      (wsiS_burstKind == 2'd1 || wsiS_burstKind == 2'd2) &&
	      wsiS_wsiReq$wget[57]) ;
  assign x__h6010 = { stage_1[11:8], stage[11:8] } ;
  assign x__h6051 = { stage_2[11:8], x__h6010 } ;
  assign x_data__h5651 =
	     { stage_3[43:12],
	       stage_2[43:12],
	       stage_1[43:12],
	       stage[43:12] } ;
  always@(pos or
	  ...
	  stage_2 or
	  stage_1 or
	  stage or be__h5987 or be__h6006 or be__h6047 or be__h6103)
  begin
    case (pos)
      2'd0: x_byteEn__h5652 = be__h5987;
      2'd1: x_byteEn__h5652 = be__h6006;
      2'd2: x_byteEn__h5652 = be__h6047;
      2'd3: x_byteEn__h5652 = be__h6103;
    endcase
  end
