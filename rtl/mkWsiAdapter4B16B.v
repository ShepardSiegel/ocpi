...
//
// On Wed Feb  9 16:44:56 EST 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkWsiAdapter4B16B(CLK,
  ...
  reg [15 : 0] x_byteEn__h6439;
  wire [127 : 0] x_data__h6438;
  wire [15 : 0] be__h7220, be__h7239, be__h7280, be__h7336;
  wire [11 : 0] x__h7284, x_burstLength__h6437;
  wire [7 : 0] x__h7243;
  ...
  // remaining internal signals
  assign be__h7220 = { 12'd0, stage[11:8] } ;
  assign be__h7239 = { 8'd0, x__h7243 } ;
  assign be__h7280 = { 4'd0, x__h7284 } ;
  assign be__h7336 = { stage_3[11:8], x__h7284 } ;
  assign wsiS_reqFifo_notFull__1_AND_wsiS_burstKind_6_E_ETC___d53 =
	     wsiS_reqFifo$FULL_N &&
	     (wsiS_burstKind == 2'd0 ||
	      (wsiS_burstKind == 2'd1 || wsiS_burstKind == 2'd2) &&
	      wsiS_wsiReq$wget[57]) ;
  assign x__h7243 = { stage_1[11:8], stage[11:8] } ;
  assign x__h7284 = { stage_2[11:8], x__h7243 } ;
  assign x_burstLength__h6437 = stage[55:44] >> 2 ;
  assign x_data__h6438 =
	     { stage_3[43:12],
	       stage_2[43:12],
	       stage_1[43:12],
	       stage[43:12] } ;
  always@(pos or
	  ...
	  stage_2 or
	  stage_1 or
	  stage or be__h7220 or be__h7239 or be__h7280 or be__h7336)
  begin
    case (pos)
      2'd0: x_byteEn__h6439 = be__h7220;
      2'd1: x_byteEn__h6439 = be__h7239;
      2'd2: x_byteEn__h6439 = be__h7280;
      2'd3: x_byteEn__h6439 = be__h7336;
    endcase
  end
