...
module mkWciTarget(wciS0_Clk,
  ...
  reg [63 : 0] v__h3690, v__h3865, v__h4009, v__h4302, v__h4560, v__h4715;
  reg [31 : 0] _theResult____h4699;
  ...
  begin
    case (target_reqF$D_OUT[39:32])
      8'h0: _theResult____h4699 = biasValue;
      8'h04: _theResult____h4699 = controlReg;
      default: _theResult____h4699 = 32'd0;
    endcase
  end
  ...
  begin
    ...
    if (wciS0_MReset_n != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_report_operating)
	$display("[%0d]: %m: WCI Target is Operating", v__h4302);
    if (wciS0_MReset_n != `BSV_RESET_VALUE)
