...
//
// On Tue Jan 11 11:58:34 EST 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkWciTarget(wciS0_Clk,
  ...
  reg [63 : 0] v__h3549, v__h3723, v__h3867, v__h4149, v__h4407, v__h4560;
  reg [31 : 0] _theResult____h4544;
  ...
  assign target_reqF_r_enq$whas = target_wciReq$wget[59:57] != 3'd0 ;
  ...
  assign target_reqF_countReg$EN =
	     (target_wciReq$wget[59:57] != 3'd0) != target_reqF_r_deq$whas ;
  ...
  assign target_reqF$ENQ = target_wciReq$wget[59:57] != 3'd0 ;
  ...
  begin
    case (target_reqF$D_OUT[39:32])
      8'h0: _theResult____h4544 = biasValue;
      8'h04: _theResult____h4544 = controlReg;
      default: _theResult____h4544 = 32'd0;
    endcase
  end
  ...
  begin
    ...
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_report_operating)
	$display("[%0d]: %m: WCI Target is Operating", v__h4149);
    if (wciS0_MReset_n)
