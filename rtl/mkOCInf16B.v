...
//
// On Tue Jun 12 09:26:44 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
// wci_m_7_MCmd                   O     3 const
// wci_m_7_MAddrSpace             O     1 const
// wci_m_7_MByteEn                O     4 const
// wci_m_7_MAddr                  O    32 const
// wci_m_7_MData                  O    32 const
// wci_m_7_MFlag                  O     2 const
// wci_m_8_MCmd                   O     3 const
// wci_m_8_MAddrSpace             O     1 const
// wci_m_8_MByteEn                O     4 const
// wci_m_8_MAddr                  O    32 const
// wci_m_8_MData                  O    32 const
// wci_m_8_MFlag                  O     2 const
// wci_m_9_MCmd                   O     3 const
// wci_m_9_MAddrSpace             O     1 const
// wci_m_9_MByteEn                O     4 const
// wci_m_9_MAddr                  O    32 const
// wci_m_9_MData                  O    32 const
// wci_m_9_MFlag                  O     2 const
// wci_m_10_MCmd                  O     3 const
// wci_m_10_MAddrSpace            O     1 const
// wci_m_10_MByteEn               O     4 const
// wci_m_10_MAddr                 O    32 const
// wci_m_10_MData                 O    32 const
// wci_m_10_MFlag                 O     2 const
// wci_m_11_MCmd                  O     3
...
// wci_m_7_SResp                  I     2 unused
// wci_m_7_SData                  I    32 unused
// wci_m_7_SFlag                  I     2 unused
// wci_m_8_SResp                  I     2 unused
// wci_m_8_SData                  I    32 unused
// wci_m_8_SFlag                  I     2 unused
// wci_m_9_SResp                  I     2 unused
// wci_m_9_SData                  I    32 unused
// wci_m_9_SFlag                  I     2 unused
// wci_m_10_SResp                 I     2 unused
// wci_m_10_SData                 I    32 unused
// wci_m_10_SFlag                 I     2 unused
// wci_m_11_SResp                 I     2
// wci_m_11_SData                 I    32
...
// wci_m_7_SThreadBusy            I     1 unused
// wci_m_8_SThreadBusy            I     1 unused
// wci_m_9_SThreadBusy            I     1 unused
// wci_m_10_SThreadBusy           I     1 unused
...
module mkOCInf16B(pciDevice,
  ...
  // inlined wires
  wire itc0_wti_peerIsReady_1$wget,
       itc0_wti_peerIsReady_1$whas,
       itc0_wti_sThreadBusy_pw$whas,
       itc1_wti_peerIsReady_1$wget,
       itc1_wti_peerIsReady_1$whas,
  ...
  // register itc0_wti_peerIsReady
  reg itc0_wti_peerIsReady;
  wire itc0_wti_peerIsReady$D_IN, itc0_wti_peerIsReady$EN;
  ...
  // register itc1_wti_peerIsReady
  reg itc1_wti_peerIsReady;
  wire itc1_wti_peerIsReady$D_IN, itc1_wti_peerIsReady$EN;
  ...
  wire [127 : 0] dp0$wmiS0_MData, dp0$wmiS0_SData;
  ...
  wire [31 : 0] dp0$wci_s_MAddr,
		...
		dp0$wmiS0_SFlag,
		dp0$wmiS0_arg_mFlag;
  wire [15 : 0] dp0$wmiS0_MDataByteEn;
  wire [13 : 0] dp0$wmiS0_MAddr;
  wire [11 : 0] dp0$wmiS0_MBurstLength;
  wire [3 : 0] dp0$wci_s_MByteEn;
  ...
  wire [127 : 0] dp1$wmiS0_MData, dp1$wmiS0_SData;
  ...
  wire [31 : 0] dp1$wci_s_MAddr,
		...
		dp1$wmiS0_SFlag,
		dp1$wmiS0_arg_mFlag;
  wire [15 : 0] dp1$wmiS0_MDataByteEn;
  wire [13 : 0] dp1$wmiS0_MAddr;
  wire [11 : 0] dp1$wmiS0_MBurstLength;
  wire [3 : 0] dp1$wci_s_MByteEn;
  ...
  reg [63 : 0] v__h1804;
  reg [31 : 0] v__h5606;
  reg [15 : 0] lastRema__h10279;
  reg [1 : 0] lowAddr10__h5136, x__h5366, x__h5389;
  ...
  wire [31 : 0] IF_cpTlp_tlpReq_6_BIT_62_7_AND_NOT_cpTlp_tlpFi_ETC___d354,
		wreq_data__h6162;
  wire [15 : 0] pciDevice_BITS_15_TO_3_43_CONCAT_0___d362,
		pciDevice_BITS_15_TO_3_43_CONCAT_1___d363,
		pw_be__h10311;
  wire [11 : 0] byteCount__h5138, x__h5357, x__h5359, y__h5358, y__h5360;
  wire [6 : 0] lowAddr__h5137;
  wire [3 : 0] _theResult_____2__h5548;
  wire [2 : 0] x__h10731;
  ...
  FIFO2 #(.width(32'd1), .guarded(32'd1)) cpMux_aActF(.RST_N(RST_N),
						      .CLK(CLK),
  ...
  FIFO2 #(.width(32'd59), .guarded(32'd1)) cpMux_cpReqF(.RST_N(RST_N),
							.CLK(CLK),
  ...
  FIFO2 #(.width(32'd40), .guarded(32'd1)) cpMux_cpRespF(.RST_N(RST_N),
							 .CLK(CLK),
  ...
  FIFO2 #(.width(32'd59), .guarded(32'd1)) cpMux_reqAF(.RST_N(RST_N),
						       .CLK(CLK),
  ...
  FIFO2 #(.width(32'd59), .guarded(32'd1)) cpMux_reqBF(.RST_N(RST_N),
						       .CLK(CLK),
  ...
  FIFO2 #(.width(32'd40), .guarded(32'd1)) cpMux_respAF(.RST_N(RST_N),
							.CLK(CLK),
  ...
  FIFO2 #(.width(32'd40), .guarded(32'd1)) cpMux_respBF(.RST_N(RST_N),
							.CLK(CLK),
  ...
  FIFO2 #(.width(32'd56), .guarded(32'd1)) cpTlp_cmpF(.RST_N(RST_N),
						      .CLK(CLK),
  ...
  FIFO2 #(.width(32'd59), .guarded(32'd1)) cpTlp_cpReqF(.RST_N(RST_N),
							.CLK(CLK),
  ...
  FIFO2 #(.width(32'd40), .guarded(32'd1)) cpTlp_cpRespF(.RST_N(RST_N),
							 .CLK(CLK),
  ...
  // submodule cpTlp_inF
  FIFO2 #(.width(32'd153), .guarded(32'd1)) cpTlp_inF(.RST_N(RST_N),
						      .CLK(CLK),
						      .D_IN(cpTlp_inF$D_IN),
						      .ENQ(cpTlp_inF$ENQ),
						      .DEQ(cpTlp_inF$DEQ),
  ...
  FIFO2 #(.width(32'd153), .guarded(32'd1)) cpTlp_outF(.RST_N(RST_N),
						       .CLK(CLK),
  ...
  mkOCDP16B #(.hasPush(1'd0),
	      .hasPull(1'd1),
	      .hasDebugLogic(1'd1)) dp0(.pciDevice(pciDevice_BITS_15_TO_3_43_CONCAT_0___d362),
					.CLK(CLK),
  ...
  mkOCDP16B #(.hasPush(1'd1),
	      .hasPull(1'd0),
	      .hasDebugLogic(1'd1)) dp1(.pciDevice(pciDevice_BITS_15_TO_3_43_CONCAT_1___d363),
					.CLK(CLK),
  ...
  // inlined wires
  assign itc0_wti_peerIsReady_1$wget = 1'd1 ;
  assign itc0_wti_peerIsReady_1$whas = dp0$wti_s_SReset_n ;
  assign itc1_wti_peerIsReady_1$wget = 1'd1 ;
  assign itc1_wti_peerIsReady_1$whas = dp1$wti_s_SReset_n ;
  ...
  // register itc0_wti_peerIsReady
  assign itc0_wti_peerIsReady$D_IN = dp0$wti_s_SReset_n ;
  assign itc0_wti_peerIsReady$EN = 1'd1 ;
  ...
  // register itc1_wti_peerIsReady
  assign itc1_wti_peerIsReady$D_IN = dp1$wti_s_SReset_n ;
  assign itc1_wti_peerIsReady$EN = 1'd1 ;
  ...
  // remaining internal signals
  assign IF_cpTlp_tlpReq_6_BIT_62_7_AND_NOT_cpTlp_tlpFi_ETC___d354 =
  ...
  assign IF_cpTlp_tlpReq_6_BIT_62_7_THEN_cpTlp_tlpDWAdd_ETC___d147 =
		 ...
		 _theResult_____2__h5548,
		 wreq_data__h6162 } :
	       { 24'hAAAAAA,
		 cpTlp_tlpReq[15:8],
		 cpTlp_tlpDWAddr[21:0],
		 _theResult_____2__h5548 } ;
  assign _theResult_____2__h5548 =
	     cpTlp_tlpFirst ?
	       cpTlp_tlpReq[3:0] :
	       ((cpTlp_tlpUnroll == 10'd1) ? cpTlp_tlpReq[7:4] : 4'hF) ;
  assign byteCount__h5138 = x__h5357 - y__h5358 ;
  ...
  assign pciDevice_BITS_15_TO_3_43_CONCAT_0___d362 =
	     { pciDevice[15:3], 3'd0 } ;
  assign pciDevice_BITS_15_TO_3_43_CONCAT_1___d363 =
	     { pciDevice[15:3], 3'd1 } ;
  assign pkt__h7324 =
	     { 9'd148,
	       ...
	       cpTlp_cpRespF$D_OUT[23:16],
	       cpTlp_cpRespF$D_OUT[31:24] } ;
  assign pw_be__h10311 = (cpTlp_rss == 2'd2) ? lastRema__h10279 : 16'd65535 ;
  assign pw_data__h10312 =
	     x__h10731[1] ?
	       (x__h10731[0] ?
  ...
  assign wreq_data__h6162 =
	     { IF_cpTlp_tlpReq_6_BIT_62_7_AND_NOT_cpTlp_tlpFi_ETC___d354[7:0],
	       IF_cpTlp_tlpReq_6_BIT_62_7_AND_NOT_cpTlp_tlpFi_ETC___d354[15:8],
	       IF_cpTlp_tlpReq_6_BIT_62_7_AND_NOT_cpTlp_tlpFi_ETC___d354[23:16],
	       IF_cpTlp_tlpReq_6_BIT_62_7_AND_NOT_cpTlp_tlpFi_ETC___d354[31:24] } ;
  ...
  assign y__h5358 =
	     (cpTlp_inF$D_OUT[105:96] == 10'd1) ?
	       12'd0 :
	       { 10'd0, x__h5389 } ;
  assign y__h5360 = { 10'd0, x__h5366 } ;
  always@(cpTlp_inF$D_OUT)
  begin
    case (cpTlp_inF$D_OUT[67:64])
      4'b1100: x__h5366 = 2'b10;
      4'b1110: x__h5366 = 2'b01;
      4'b1111: x__h5366 = 2'b0;
      default: x__h5366 = 2'b11;
    endcase
  end
  always@(cpTlp_inF$D_OUT)
  begin
    case (cpTlp_inF$D_OUT[71:68])
      4'b1100: x__h5389 = 2'b10;
      4'b1110: x__h5389 = 2'b01;
      4'b1111: x__h5389 = 2'b0;
      default: x__h5389 = 2'b11;
    endcase
  end
  always@(cpTlp_tlpDWp or cpTlp_inF$D_OUT)
  begin
    case (cpTlp_tlpDWp)
      2'd0: v__h5606 = cpTlp_inF$D_OUT[31:0];
      2'd1: v__h5606 = cpTlp_inF$D_OUT[63:32];
      2'd2: v__h5606 = cpTlp_inF$D_OUT[95:64];
      2'd3: v__h5606 = cpTlp_inF$D_OUT[127:96];
    endcase
  end
  always@(cpTlp_rdp)
  begin
    case (cpTlp_rdp)
      2'b0: lastRema__h10279 = 16'hFFFF;
      2'b01: lastRema__h10279 = 16'hF000;
      2'b10: lastRema__h10279 = 16'hFF00;
      2'd3: lastRema__h10279 = 16'hFFF0;
    endcase
  end
  always@(cpTlp_inF$D_OUT)
  begin
    case (cpTlp_inF$D_OUT[67:64])
      4'b1000: lowAddr10__h5136 = 2'b11;
      4'b1100: lowAddr10__h5136 = 2'b10;
      4'b1110: lowAddr10__h5136 = 2'b01;
      default: lowAddr10__h5136 = 2'b0;
    endcase
  end
  ...
  begin
	...
	itc0_wti_peerIsReady <= `BSV_ASSIGNMENT_DELAY 1'd0;
	itc0_wti_sThreadBusy_d <= `BSV_ASSIGNMENT_DELAY 1'd1;
	itc1_wti_nowReq <= `BSV_ASSIGNMENT_DELAY 67'd0;
	itc1_wti_peerIsReady <= `BSV_ASSIGNMENT_DELAY 1'd0;
	...
	if (itc0_wti_peerIsReady$EN)
	  itc0_wti_peerIsReady <= `BSV_ASSIGNMENT_DELAY
	      itc0_wti_peerIsReady$D_IN;
	...
	if (itc1_wti_peerIsReady$EN)
	  itc1_wti_peerIsReady <= `BSV_ASSIGNMENT_DELAY
	      itc1_wti_peerIsReady$D_IN;
