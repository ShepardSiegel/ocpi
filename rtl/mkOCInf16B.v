...
//
// On Mon Sep 19 13:13:32 EDT 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkOCInf16B(pciDevice,
  ...
  reg [63 : 0] v__h1802;
  wire [15 : 0] pciDevice_BITS_15_TO_3_9_CONCAT_0___d98,
		pciDevice_BITS_15_TO_3_9_CONCAT_1___d94;
  ...
  // submodule dp0
  mkOCDP16B dp0(.pciDevice(pciDevice_BITS_15_TO_3_9_CONCAT_0___d98),
		.hasPush(1'd0),
		.hasPull(1'd1),
		.CLK(CLK),
  ...
  // submodule dp1
  mkOCDP16B dp1(.pciDevice(pciDevice_BITS_15_TO_3_9_CONCAT_1___d94),
		.hasPush(1'd1),
		.hasPull(1'd0),
		.CLK(CLK),
  ...
  // remaining internal signals
  assign pciDevice_BITS_15_TO_3_9_CONCAT_0___d98 = { pciDevice[15:3], 3'd0 } ;
  assign pciDevice_BITS_15_TO_3_9_CONCAT_1___d94 = { pciDevice[15:3], 3'd1 } ;
