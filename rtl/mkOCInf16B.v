...
//
// On Mon Jan 27 11:02:46 EST 2014
//
//
// Ports:
// Name                         I/O  size props
...
module mkOCInf16B(pciDevice,
  ...
  // value method upads_rts
  assign upads_rts = cp_upads_rts ;

  // value method upads_tx
  assign upads_tx = cp_upads_tx ;
  ...
  mkOCCP cp(.pciDevice(pciDevice),
	    ...
	    .upads_cts_arg(cp_upads_cts_arg),
	    .upads_rx_arg(cp_upads_rx_arg),
	    ...
	    .led(cp_led),
	    .upads_rts(cp_upads_rts),
	    .upads_tx(cp_upads_tx),
  ...
  mkOCDP16B #(.hasPush(1'd0),
	      .hasPull(1'd1),
	      .hasDebugLogic(1'd1)) dp0(.pciDevice(x__h2831),
					.CLK(CLK),
  ...
  mkOCDP16B #(.hasPush(1'd1),
	      .hasPull(1'd0),
	      .hasDebugLogic(1'd1)) dp1(.pciDevice(x__h3125),
					.CLK(CLK),
  ...
  assign cp_upads_cts_arg = upads_cts_arg ;
  assign cp_upads_rx_arg = upads_rx_arg ;
  ...
  assign cpTlp_EN_server_request_put =
	     cpTlp_RDY_server_request_put && noc_sm0_RDY_c0_request_get ;
  ...
  assign dp0_EN_server_request_put =
	     dp0_RDY_server_request_put && noc_sm1_RDY_c0_request_get ;
  assign dp0_EN_server_response_get =
	     dp0_RDY_server_response_get && noc_sm1_RDY_c0_response_put ;
  ...
  assign dp1_EN_server_request_put =
	     dp1_RDY_server_request_put && noc_sm2_RDY_c0_request_get ;
  assign dp1_EN_server_response_get =
	     dp1_RDY_server_response_get && noc_sm2_RDY_c0_response_put ;
  ...
  assign noc_sm0_EN_c1_request_get =
	     noc_sm0_RDY_c1_request_get && noc_sm1_RDY_s_request_put ;
  assign noc_sm0_EN_c1_response_put =
	     noc_sm0_RDY_c1_response_put && noc_sm1_RDY_s_response_get ;
  ...
  assign noc_sm1_EN_c1_request_get =
	     noc_sm1_RDY_c1_request_get && noc_sm2_RDY_s_request_put ;
  assign noc_sm1_EN_c1_response_put =
	     noc_sm1_RDY_c1_response_put && noc_sm2_RDY_s_response_get ;
  ...
  assign x__h2831 = { pciDevice[15:3], 3'd0 } ;
  assign x__h3125 = { pciDevice[15:3], 3'd1 } ;
