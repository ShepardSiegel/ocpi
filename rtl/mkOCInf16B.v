...
//
// On Tue Feb 28 06:58:57 EST 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkOCInf16B(pciDevice,
  ...
  reg [63 : 0] v__h1803;
  wire [15 : 0] pciDevice_BITS_15_TO_3_7_CONCAT_0___d105,
		pciDevice_BITS_15_TO_3_7_CONCAT_1___d106;
  ...
  mkOCDP16B #(.hasPush(1'd0),
	      .hasPull(1'd1),
	      .hasDebugLogic(1'd1)) dp0(.pciDevice(pciDevice_BITS_15_TO_3_7_CONCAT_0___d105),
					.CLK(CLK),
  ...
  mkOCDP16B #(.hasPush(1'd1),
	      .hasPull(1'd0),
	      .hasDebugLogic(1'd1)) dp1(.pciDevice(pciDevice_BITS_15_TO_3_7_CONCAT_1___d106),
					.CLK(CLK),
  ...
  // remaining internal signals
  assign pciDevice_BITS_15_TO_3_7_CONCAT_0___d105 =
	     { pciDevice[15:3], 3'd0 } ;
  assign pciDevice_BITS_15_TO_3_7_CONCAT_1___d106 =
	     { pciDevice[15:3], 3'd1 } ;
