...
//
// On Tue May  8 16:33:49 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkOCInf16B(pciDevice,
  ...
  wire [31 : 0] IF_cpTlp_tlpReq_6_BIT_62_7_AND_NOT_cpTlp_tlpFi_ETC___d363,
		wreq_data__h6162;
  wire [15 : 0] pciDevice_BITS_15_TO_3_43_CONCAT_0___d370,
		pciDevice_BITS_15_TO_3_43_CONCAT_1___d371,
		pw_be__h10311;
  ...
  mkOCDP16B #(.hasPush(1'd0),
	      .hasPull(1'd1),
	      .hasDebugLogic(1'd1)) dp0(.pciDevice(pciDevice_BITS_15_TO_3_43_CONCAT_0___d370),
					.CLK(CLK),
  ...
  mkOCDP16B #(.hasPush(1'd1),
	      .hasPull(1'd0),
	      .hasDebugLogic(1'd1)) dp1(.pciDevice(pciDevice_BITS_15_TO_3_43_CONCAT_1___d371),
					.CLK(CLK),
  ...
  assign MUX_cpTlp_tlpDWAddr$write_1__SEL_1 =
	     ...
	     !cpTlp_inF$D_OUT[125] &&
	     cpTlp_inF$D_OUT[124:120] == 5'b0 ;
  assign MUX_cpTlp_cmpDWRemain$write_1__VAL_1 = cpTlp_cmpDWRemain - 10'd1 ;
  assign MUX_cpTlp_cmpDWRemain$write_1__VAL_2 =
	     cpTlp_cmpF$D_OUT[21:12] - 10'd1 ;
  ...
  // remaining internal signals
  assign IF_cpTlp_tlpReq_6_BIT_62_7_AND_NOT_cpTlp_tlpFi_ETC___d363 =
  ...
  assign pciDevice_BITS_15_TO_3_43_CONCAT_0___d370 =
	     { pciDevice[15:3], 3'd0 } ;
  assign pciDevice_BITS_15_TO_3_43_CONCAT_1___d371 =
	     { pciDevice[15:3], 3'd1 } ;
  assign pkt__h7324 =
	     { 9'd148,
  ...
  assign wreq_data__h6162 =
	     { IF_cpTlp_tlpReq_6_BIT_62_7_AND_NOT_cpTlp_tlpFi_ETC___d363[7:0],
	       IF_cpTlp_tlpReq_6_BIT_62_7_AND_NOT_cpTlp_tlpFi_ETC___d363[15:8],
	       IF_cpTlp_tlpReq_6_BIT_62_7_AND_NOT_cpTlp_tlpFi_ETC___d363[23:16],
	       IF_cpTlp_tlpReq_6_BIT_62_7_AND_NOT_cpTlp_tlpFi_ETC___d363[31:24] } ;
