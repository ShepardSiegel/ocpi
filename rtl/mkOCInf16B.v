...
//
// On Wed Jul 20 14:01:32 EDT 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkOCInf16B(pciDevice,
  ...
  reg [63 : 0] v__h1862;
  wire [15 : 0] pciDevice_BITS_15_TO_3_0_CONCAT_0___d100,
		pciDevice_BITS_15_TO_3_0_CONCAT_1___d101;
  ...
  // submodule dp0
  mkOCDP16B dp0(.pciDevice(pciDevice_BITS_15_TO_3_0_CONCAT_0___d100),
		.hasPush(1'd0),
		.hasPull(1'd1),
		.CLK(CLK),
  ...
  // submodule dp1
  mkOCDP16B dp1(.pciDevice(pciDevice_BITS_15_TO_3_0_CONCAT_1___d101),
		.hasPush(1'd1),
		.hasPull(1'd0),
		.CLK(CLK),
  ...
  // remaining internal signals
  assign pciDevice_BITS_15_TO_3_0_CONCAT_0___d100 =
	     { pciDevice[15:3], 3'd0 } ;
  assign pciDevice_BITS_15_TO_3_0_CONCAT_1___d101 =
	     { pciDevice[15:3], 3'd1 } ;
