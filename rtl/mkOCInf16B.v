...
//
// On Thu Aug 25 13:37:21 EDT 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkOCInf16B(pciDevice,
  ...
  // submodule dp0
  mkOCDP16B dp0(.pciDevice(pciDevice_BITS_15_TO_3_9_CONCAT_0___d97),
		.hasPush(1'd0),
		.hasPull(1'd1),
		.CLK(CLK),
  ...
  // submodule dp1
  mkOCDP16B dp1(.pciDevice(pciDevice_BITS_15_TO_3_9_CONCAT_1___d98),
		.hasPush(1'd1),
		.hasPull(1'd0),
		.CLK(CLK),
