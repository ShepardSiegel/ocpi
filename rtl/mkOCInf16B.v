...
//
// On Sun Jan 27 10:35:38 EST 2013
//
//
// Ports:
// Name                         I/O  size props
...
module mkOCInf16B(pciDevice,
  ...
  wire [1 : 0] MUX_cpTlp_rdp$write_1__VAL_1,
	       MUX_cpTlp_rss$write_1__VAL_2,
	       MUX_cpTlp_tlpDWp$write_1__VAL_1;
  wire MUX_cpMux_aActF$enq_1__SEL_1,
       ...
       MUX_cpTlp_tlpDWp$write_1__SEL_1;

  // remaining internal signals
  reg [63 : 0] v__h1839;
  reg [31 : 0] v__h5708;
  reg [15 : 0] lastRema__h10389;
  reg [1 : 0] lowAddr10__h5233, x__h5463, x__h5486;
  wire [127 : 0] pkt__h7383, pw_data__h10422;
  wire [57 : 0] IF_cpTlp_tlpReq_6_BIT_62_7_THEN_cpTlp_tlpDWAdd_ETC___d136;
  wire [31 : 0] IF_cpTlp_tlpReq_6_BIT_62_7_AND_NOT_cpTlp_tlpFi_ETC___d125,
		wreq_data__h6203;
  wire [15 : 0] pw_be__h10421, x__h2806, x__h3100;
  wire [11 : 0] byteCount__h5235, x__h5454, x__h5456, y__h5455, y__h5457;
  wire [6 : 0] lowAddr__h5234;
  wire [3 : 0] _theResult_____2__h5650;
  wire [2 : 0] x__h10845;
  wire cpMux_aActF_i_notEmpty__34_AND_IF_cpMux_aActF__ETC___d239;
  ...
  assign WILL_FIRE_RL_cpMux_response_cp =
	     cpMux_cpRespF$EMPTY_N &&
	     cpMux_aActF_i_notEmpty__34_AND_IF_cpMux_aActF__ETC___d239 ;
  ...
  assign MUX_cpTlp_tlpDWAddr$write_1__SEL_1 =
	     ...
	     !cpTlp_inF$D_OUT[125] &&
	     cpTlp_inF$D_OUT[124:120] == 5'b0 ;
  assign MUX_cpTlp_tlpDWp$write_1__SEL_1 =
  ...
  assign cpTlp_cpReqF$D_IN =
	     { !cpTlp_tlpReq[62],
	       IF_cpTlp_tlpReq_6_BIT_62_7_THEN_cpTlp_tlpDWAdd_ETC___d136 } ;
  ...
  // remaining internal signals
  assign IF_cpTlp_tlpReq_6_BIT_62_7_AND_NOT_cpTlp_tlpFi_ETC___d125 =
	     (cpTlp_tlpReq[62] && !cpTlp_tlpFirst) ? v__h5708 : cpTlp_tlpDW ;
  assign IF_cpTlp_tlpReq_6_BIT_62_7_THEN_cpTlp_tlpDWAdd_ETC___d136 =
	     cpTlp_tlpReq[62] ?
	       { cpTlp_tlpDWAddr[21:0],
		 _theResult_____2__h5650,
		 wreq_data__h6203 } :
	       { 24'hAAAAAA,
		 cpTlp_tlpReq[15:8],
		 cpTlp_tlpDWAddr[21:0],
		 _theResult_____2__h5650 } ;
  assign _theResult_____2__h5650 =
	     cpTlp_tlpFirst ?
	       cpTlp_tlpReq[3:0] :
	       ((cpTlp_tlpUnroll == 10'd1) ? cpTlp_tlpReq[7:4] : 4'hF) ;
  assign byteCount__h5235 = x__h5454 - y__h5455 ;
  assign cpMux_aActF_i_notEmpty__34_AND_IF_cpMux_aActF__ETC___d239 =
	     cpMux_aActF$EMPTY_N &&
	     (cpMux_aActF$D_OUT ? cpMux_respAF$FULL_N : cpMux_respBF$FULL_N) ;
  assign lowAddr__h5234 = { cpTlp_inF$D_OUT[38:34], lowAddr10__h5233 } ;
  assign pkt__h7383 =
	     { 9'd148,
	       ...
	       cpTlp_cpRespF$D_OUT[23:16],
	       cpTlp_cpRespF$D_OUT[31:24] } ;
  assign pw_be__h10421 = (cpTlp_rss == 2'd2) ? lastRema__h10389 : 16'd65535 ;
  assign pw_data__h10422 =
	     x__h10845[1] ?
	       (x__h10845[0] ?
		  ...
		  cpTlp_rdv) ;
  assign wreq_data__h6203 =
	     { IF_cpTlp_tlpReq_6_BIT_62_7_AND_NOT_cpTlp_tlpFi_ETC___d125[7:0],
	       IF_cpTlp_tlpReq_6_BIT_62_7_AND_NOT_cpTlp_tlpFi_ETC___d125[15:8],
	       IF_cpTlp_tlpReq_6_BIT_62_7_AND_NOT_cpTlp_tlpFi_ETC___d125[23:16],
	       IF_cpTlp_tlpReq_6_BIT_62_7_AND_NOT_cpTlp_tlpFi_ETC___d125[31:24] } ;
  assign x__h10845 = 3'h4 - { 1'd0, cpTlp_rdp } ;
  assign x__h2806 = { pciDevice[15:3], 3'd0 } ;
  assign x__h3100 = { pciDevice[15:3], 3'd1 } ;
  assign x__h5454 = x__h5456 - y__h5457 ;
  assign x__h5456 = { cpTlp_inF$D_OUT[105:96], 2'b0 } ;
  assign y__h5455 =
	     (cpTlp_inF$D_OUT[105:96] == 10'd1) ?
	       12'd0 :
	       { 10'd0, x__h5486 } ;
  assign y__h5457 = { 10'd0, x__h5463 } ;
  always@(cpTlp_inF$D_OUT)
  begin
    case (cpTlp_inF$D_OUT[67:64])
      4'b1100: x__h5463 = 2'b10;
      4'b1110: x__h5463 = 2'b01;
      4'b1111: x__h5463 = 2'b0;
      default: x__h5463 = 2'b11;
    endcase
  end
  always@(cpTlp_inF$D_OUT)
  begin
    case (cpTlp_inF$D_OUT[71:68])
      4'b1100: x__h5486 = 2'b10;
      4'b1110: x__h5486 = 2'b01;
      4'b1111: x__h5486 = 2'b0;
      default: x__h5486 = 2'b11;
    endcase
  end
  always@(cpTlp_tlpDWp or cpTlp_inF$D_OUT)
  begin
    case (cpTlp_tlpDWp)
      2'd0: v__h5708 = cpTlp_inF$D_OUT[31:0];
      2'd1: v__h5708 = cpTlp_inF$D_OUT[63:32];
      2'd2: v__h5708 = cpTlp_inF$D_OUT[95:64];
      2'd3: v__h5708 = cpTlp_inF$D_OUT[127:96];
    endcase
  end
  always@(cpTlp_rdp)
  begin
    case (cpTlp_rdp)
      2'b0: lastRema__h10389 = 16'hFFFF;
      2'b01: lastRema__h10389 = 16'hF000;
      2'b10: lastRema__h10389 = 16'hFF00;
      2'd3: lastRema__h10389 = 16'hFFF0;
    endcase
  end
  always@(cpTlp_inF$D_OUT)
  begin
    case (cpTlp_inF$D_OUT[67:64])
      4'b1000: lowAddr10__h5233 = 2'b11;
      4'b1100: lowAddr10__h5233 = 2'b10;
      4'b1110: lowAddr10__h5233 = 2'b01;
      default: lowAddr10__h5233 = 2'b0;
    endcase
  end
