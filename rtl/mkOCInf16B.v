...
//
// On Sun Sep 15 08:33:00 EDT 2013
//
//
// Ports:
// Name                         I/O  size props
...
module mkOCInf16B(pciDevice,
  ...
  wire [152 : 0] cpTlp$server_request_put, cpTlp$server_response_get;
  wire [58 : 0] cpTlp$client_request_get;
  wire [39 : 0] cpTlp$client_response_put;
  wire cpTlp$EN_client_request_get,
       cpTlp$EN_client_response_put,
       cpTlp$EN_server_request_put,
       cpTlp$EN_server_response_get,
       cpTlp$RDY_client_request_get,
       cpTlp$RDY_client_response_put,
       cpTlp$RDY_server_request_put,
       cpTlp$RDY_server_response_get;
  ...
  mkTLPSerializer cpTlp(.pciDevice(pciDevice),
			.CLK(CLK),
			.RST_N(RST_N),
			.client_response_put(cpTlp$client_response_put),
			.server_request_put(cpTlp$server_request_put),
			.EN_server_request_put(cpTlp$EN_server_request_put),
			.EN_server_response_get(cpTlp$EN_server_response_get),
			.EN_client_request_get(cpTlp$EN_client_request_get),
			.EN_client_response_put(cpTlp$EN_client_response_put),
			.RDY_server_request_put(cpTlp$RDY_server_request_put),
			.server_response_get(cpTlp$server_response_get),
			.RDY_server_response_get(cpTlp$RDY_server_response_get),
			.client_request_get(cpTlp$client_request_get),
			.RDY_client_request_get(cpTlp$RDY_client_request_get),
			.RDY_client_response_put(cpTlp$RDY_client_response_put));
  ...
  // submodule cpMux_reqAF
  assign cpMux_reqAF$D_IN = cpTlp$client_request_get ;
  assign cpMux_reqAF$ENQ =
	     cpTlp$RDY_client_request_get && cpMux_reqAF$FULL_N ;
  ...
  assign cpMux_respAF$DEQ =
	     cpTlp$RDY_client_response_put && cpMux_respAF$EMPTY_N ;
  ...
  // submodule cpTlp
  assign cpTlp$client_response_put = cpMux_respAF$D_OUT ;
  assign cpTlp$server_request_put = noc_sm0$c0_request_get ;
  assign cpTlp$EN_server_request_put =
	     cpTlp$RDY_server_request_put && noc_sm0$RDY_c0_request_get ;
  assign cpTlp$EN_server_response_get =
	     cpTlp$RDY_server_response_get && noc_sm0$RDY_c0_response_put ;
  assign cpTlp$EN_client_request_get =
	     cpTlp$RDY_client_request_get && cpMux_reqAF$FULL_N ;
  assign cpTlp$EN_client_response_put =
	     cpTlp$RDY_client_response_put && cpMux_respAF$EMPTY_N ;
  ...
  // submodule noc_sm0
  assign noc_sm0$c0_response_put = cpTlp$server_response_get ;
