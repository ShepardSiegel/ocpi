...
//
// On Fri Aug 19 11:40:13 EDT 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkOCInf16B(pciDevice,
  ...
  // submodule dp0
  mkOCDP16B dp0(.pciDevice(pciDevice_BITS_15_TO_3_0_CONCAT_0___d98),
		.hasPush(1'd0),
		.hasPull(1'd1),
		.CLK(CLK),
  ...
  // submodule dp1
  mkOCDP16B dp1(.pciDevice(pciDevice_BITS_15_TO_3_0_CONCAT_1___d99),
		.hasPush(1'd1),
		.hasPull(1'd0),
		.CLK(CLK),
