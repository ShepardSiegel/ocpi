...
//
// On Fri Aug 19 10:58:59 EDT 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkOCInf16B(pciDevice,
  ...
  wire [63 : 0] cp$cpNow, cp$deviceDNA_arg;
  ...
  wire [1 : 0] cp$led,
	       ...
	       cp$wci_Vm_9_SFlag,
	       cp$wci_Vm_9_SResp;
  wire cp$EN_deviceDNA,
       cp$EN_server_request_put,
  ...
  reg [63 : 0] v__h1869;
  wire [15 : 0] pciDevice_BITS_15_TO_3_0_CONCAT_0___d96,
		pciDevice_BITS_15_TO_3_0_CONCAT_1___d97;
  ...
  mkOCCP cp(.pciDevice(pciDevice),
	    ...
	    .CLK(CLK),
	    .RST_N(RST_N),
	    .deviceDNA_arg(cp$deviceDNA_arg),
  ...
  // submodule dp0
  mkOCDP16B dp0(.pciDevice(pciDevice_BITS_15_TO_3_0_CONCAT_0___d96),
		.hasPush(1'd0),
		.hasPull(1'd1),
		.CLK(CLK),
  ...
  // submodule dp1
  mkOCDP16B dp1(.pciDevice(pciDevice_BITS_15_TO_3_0_CONCAT_1___d97),
		.hasPush(1'd1),
		.hasPull(1'd0),
		.CLK(CLK),
  ...
  // submodule cp
  assign cp$deviceDNA_arg = deviceDNA_arg ;
  ...
  assign cp$EN_deviceDNA = EN_deviceDNA ;
  ...
  // remaining internal signals
  assign pciDevice_BITS_15_TO_3_0_CONCAT_0___d96 = { pciDevice[15:3], 3'd0 } ;
  assign pciDevice_BITS_15_TO_3_0_CONCAT_1___d97 = { pciDevice[15:3], 3'd1 } ;
