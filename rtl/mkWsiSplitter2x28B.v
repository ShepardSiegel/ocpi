...
//
// On Fri Jun 25 13:29:57 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkWsiSplitter2x28B(wciS0_Clk,
  ...
  assign wsi_M0_burstKind$EN =
	     ...
	     (wsi_M0_burstKind == 2'd0 ||
	      wsi_M0_burstKind == 2'd1 && wsi_M0_reqFifo_q_0[93] ||
	      wsi_M0_burstKind == 2'd2 &&
	      wsi_M0_reqFifo_q_0[91:80] == 12'd1) ;
  ...
  assign wsi_M1_burstKind$EN =
	     ...
	     (wsi_M1_burstKind == 2'd0 ||
	      wsi_M1_burstKind == 2'd1 && wsi_M1_reqFifo_q_0[93] ||
	      wsi_M1_burstKind == 2'd2 &&
	      wsi_M1_reqFifo_q_0[91:80] == 12'd1) ;
  ...
  assign wsi_S0_burstKind$EN =
	     WILL_FIRE_RL_wsi_S0_reqFifo_enq &&
	     (wsi_S0_burstKind == 2'd0 ||
	      wsi_S0_burstKind == 2'd1 && wsi_S0_wsiReq$wget[93] ||
	      wsi_S0_burstKind == 2'd2 &&
	      wsi_S0_wsiReq$wget[91:80] == 12'd1) ;
  ...
  assign wsi_S1_burstKind$EN =
	     WILL_FIRE_RL_wsi_S1_reqFifo_enq &&
	     (wsi_S1_burstKind == 2'd0 ||
	      wsi_S1_burstKind == 2'd1 && wsi_S1_wsiReq$wget[93] ||
	      wsi_S1_burstKind == 2'd2 &&
	      wsi_S1_wsiReq$wget[91:80] == 12'd1) ;
