...
//
// On Sat Sep 29 11:48:57 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkTB18(CLK,
  ...
  wire [7 : 0] simIO$host_response_put;
  wire simIO$EN_host_request_get, simIO$EN_host_response_put;
  ...
  wire [31 : 0] b__h27012,
		...
		y_avValue__h60991,
		y_avValue__h61031;
  wire [13 : 0] mlB__h58010, mlInc__h58009;
  wire [11 : 0] x_burstLength__h27820;
  wire [3 : 0] x_byteEn__h27822;
  wire [2 : 0] cap0_dataBram_serverAdapterB_cnt_509_PLUS_IF_c_ETC___d1515,
	       ...
	       y__h58071,
	       y__h58083;
  wire [1 : 0] ab__h13322, ab__h16440, ab__h19386, ab__h22332, ab__h25278;
  wire IF_cap0_splaF_first__085_BITS_1_TO_0_087_EQ_0__ETC___d2115,
       ...
       IF_pat0_wci_wslv_reqF_i_notEmpty__4_AND_pat0_w_ETC___d2748,
       NOT_cap0_controlReg_018_BIT_0_019_020_OR_cap0__ETC___d2044,
       cap0_controlReg_018_BIT_0_019_AND_NOT_cap0_con_ETC___d2066,
       cap0_dataCount_025_ULT_1024___d2545,
       cap0_metaCount_022_ULT_1024___d2544,
       cap0_splaF_i_notEmpty__084_AND_IF_cap0_splaF_f_ETC___d2117,
       pat0_dataBram_serverAdapterB_cnt_33_SLT_3___d2546,
  ...
  assign MUX_cap0_wci_wslv_respF_x_wire$wset_1__VAL_3 = { 2'd1, v__h60240 } ;
  ...
  assign MUX_pat0_unrollCnt$write_1__VAL_1 =
	     (v__h26395 == 32'd0) ? 16'd1 : b__h27012[15:0] ;
  ...
  assign MUX_pat0_wci_wslv_respF_x_wire$wset_1__VAL_3 = { 2'd1, v__h30795 } ;
  ...
  assign pat0_metaBram_serverAdapterA_outData_enqData$whas =
	     ...
	     pat0_metaBram_serverAdapterA_s1[0] ;
  assign pat0_metaBram_serverAdapterA_outData_outData$wget = v__h26395 ;
  ...
  assign cap0_statusReg_w$wget = rdat___1__h61737 ;
  ...
  assign cap0_mesgLengthSoFar$D_IN =
	     cap0_wsiS_reqFifo$D_OUT[57] ? 14'd0 : mlB__h58010 ;
  ...
  // register pat0_doZLM
  assign pat0_doZLM$D_IN = WILL_FIRE_RL_pat0_resp_meta && v__h26395 == 32'd0 ;
  ...
  // register pat0_thisLength
  assign pat0_thisLength$D_IN = v__h26395 ;
  ...
  assign cap0_metaBram_memory$DIA = { 18'd0, mlB__h58010 } ;
  ...
  assign cp$server_request_put = 59'h0 ;
  ...
  assign cp$EN_server_request_put = 1'b0 ;
  assign cp$EN_server_response_get = 1'b0 ;
  ...
  // submodule simIO
  assign simIO$host_response_put = 8'h0 ;
  assign simIO$EN_host_request_get = 1'b0 ;
  assign simIO$EN_host_response_put = 1'b0 ;
  ...
  assign IF_pat0_wci_wslv_reqF_i_notEmpty__4_AND_pat0_w_ETC___d1093 =
	     (pat0_wci_wslv_reqF$EMPTY_N &&
	      pat0_wci_wslv_reqF$D_OUT[35:34] == 2'd1) ?
	       ...
	       IF_pat0_wci_wslv_reqF_i_notEmpty__4_AND_pat0_w_ETC___d1092 ;
  assign IF_pat0_wci_wslv_reqF_i_notEmpty__4_AND_pat0_w_ETC___d2748 =
	     (pat0_wci_wslv_reqF$EMPTY_N &&
	      pat0_wci_wslv_reqF$D_OUT[35:34] == 2'd0) ?
  ...
  assign ab__h13322 = MUX_pat0_dataBram_memory$b_put_1__SEL_1 ? 2'd0 : 2'd2 ;
  assign ab__h16440 = MUX_pat0_metaBram_memory$b_put_1__SEL_1 ? 2'd0 : 2'd2 ;
  assign ab__h19386 =
  ...
  assign b__h27012 = x__h27028 + residue__h27001 ;
  ...
  assign cap0_dataBram_serverAdapterB_cnt_509_PLUS_IF_c_ETC___d1515 =
		...
		3'd7 :
		3'd0) ;
  assign cap0_dataCount_025_ULT_1024___d2545 = cap0_dataCount < 32'd1024 ;
  ...
  assign cap0_metaBram_serverAdapterB_cnt_627_PLUS_IF_c_ETC___d1633 =
		...
		3'd7 :
		3'd0) ;
  assign cap0_metaCount_022_ULT_1024___d2544 = cap0_metaCount < 32'd1024 ;
  ...
  assign g_data__h34203 =
	     (pat0_wci_wslv_reqF$D_OUT[63:52] == 12'h0) ? v__h33192 : 32'd0 ;
  assign g_data__h62715 =
	     (cap0_wci_wslv_reqF$D_OUT[63:52] == 12'h0) ? v__h61640 : 32'd0 ;
  assign mlB__h58010 = cap0_mesgLengthSoFar + mlInc__h58009 ;
  assign mlInc__h58009 =
	     cap0_wsiS_reqFifo$D_OUT[57] ?
	       { 11'd0, x__h58058 + y__h58059 } :
	       14'd4 ;
  ...
  assign pat0_dataBram_serverAdapterB_cnt_33_PLUS_IF_pa_ETC___d339 =
		...
		3'd7 :
		3'd0) ;
  assign pat0_dataBram_serverAdapterB_cnt_33_SLT_3___d2546 =
  ...
  assign pat0_splaF_i_notEmpty__011_AND_IF_pat0_splaF_f_ETC___d1044 =
		...
		(pat0_splaF$D_OUT[1:0] != 2'd0 ||
		 pat0_dataBram_serverAdapterB_outData_outData$whas) :
		IF_pat0_splaF_first__012_BITS_1_TO_0_014_EQ_0__ETC___d1042) ;
  assign rdat___1__h33368 = { 24'd0, pat0_wsiM_statusR } ;
  assign rdat___1__h61737 =
	     { 6'd40,
	       !cap0_metaCount_022_ULT_1024___d2544,
	       !cap0_dataCount_025_ULT_1024___d2545,
	       24'd2361866 } ;
  assign rdat___1__h61811 = { 24'd0, cap0_wsiS_statusR } ;
  assign residue__h27001 =
	     ({ 4'd0, v__h26395[1:0] } == 6'd0) ? 32'd0 : 32'd1 ;
  assign v__h26395 =
	     pat0_metaBram_serverAdapterA_outDataCore$EMPTY_N ?
	       pat0_metaBram_serverAdapterA_outDataCore$D_OUT :
	       pat0_metaBram_memory$DOA ;
  ...
  assign x__h27028 = { 2'd0, v__h26395[31:2] } ;
  assign x__h27986 =
													...
													6'd30) ?
													 ...
													 (({ 4'd0,
													   ...
													   6'd31) ?
													    32'h7FFFFFFF :
													    32'hFFFFFFFF))))))))))))))))))))))))))))))) ;
  assign x__h58058 = x__h58070 + y__h58071 ;
  assign x__h58070 = x__h58082 + y__h58083 ;
  assign x__h58082 = { 2'd0, cap0_wsiS_reqFifo$D_OUT[11] } ;
  assign x_burstLength__h27820 =
	     (pat0_thisLength == 32'd0 || pat0_unrollCnt == 16'd1) ?
	       12'd1 :
	       12'd4095 ;
  assign x_byteEn__h27822 =
	     (pat0_thisLength == 32'd0) ?
	       4'd0 :
	       ((pat0_unrollCnt == 16'd1) ? x__h27986[3:0] : 4'd15) ;
  assign y__h58059 = { 2'd0, cap0_wsiS_reqFifo$D_OUT[8] } ;
  assign y__h58071 = { 2'd0, cap0_wsiS_reqFifo$D_OUT[9] } ;
  assign y__h58083 = { 2'd0, cap0_wsiS_reqFifo$D_OUT[10] } ;
  assign y_avValue__h31421 =
	     pat0_dataBram_serverAdapterB_outDataCore$EMPTY_N ?
	       pat0_dataBram_serverAdapterB_outDataCore$D_OUT :
	       pat0_dataBram_memory$DOB ;
  assign y_avValue__h31465 =
	     pat0_metaBram_serverAdapterB_outDataCore$EMPTY_N ?
	       pat0_metaBram_serverAdapterB_outDataCore$D_OUT :
	       pat0_metaBram_memory$DOB ;
  assign y_avValue__h31505 =
	     pat0_metaBram_serverAdapterB_1_outDataCore$EMPTY_N ?
	       pat0_metaBram_serverAdapterB_1_outDataCore$D_OUT :
	       pat0_metaBram_memory_1$DOB ;
  assign y_avValue__h31545 =
	     pat0_metaBram_serverAdapterB_2_outDataCore$EMPTY_N ?
	       pat0_metaBram_serverAdapterB_2_outDataCore$D_OUT :
	       pat0_metaBram_memory_2$DOB ;
  assign y_avValue__h31585 =
	     pat0_metaBram_serverAdapterB_3_outDataCore$EMPTY_N ?
	       pat0_metaBram_serverAdapterB_3_outDataCore$D_OUT :
	       pat0_metaBram_memory_3$DOB ;
  assign y_avValue__h60867 =
	     cap0_dataBram_serverAdapterB_outDataCore$EMPTY_N ?
	       cap0_dataBram_serverAdapterB_outDataCore$D_OUT :
	       cap0_dataBram_memory$DOB ;
  assign y_avValue__h60911 =
	     cap0_metaBram_serverAdapterB_outDataCore$EMPTY_N ?
	       cap0_metaBram_serverAdapterB_outDataCore$D_OUT :
	       cap0_metaBram_memory$DOB ;
  assign y_avValue__h60951 =
	     cap0_metaBram_serverAdapterB_1_outDataCore$EMPTY_N ?
	       cap0_metaBram_serverAdapterB_1_outDataCore$D_OUT :
	       cap0_metaBram_memory_1$DOB ;
  assign y_avValue__h60991 =
	     cap0_metaBram_serverAdapterB_2_outDataCore$EMPTY_N ?
	       cap0_metaBram_serverAdapterB_2_outDataCore$D_OUT :
	       cap0_metaBram_memory_2$DOB ;
  assign y_avValue__h61031 =
	     cap0_metaBram_serverAdapterB_3_outDataCore$EMPTY_N ?
	       cap0_metaBram_serverAdapterB_3_outDataCore$D_OUT :
	       cap0_metaBram_memory_3$DOB ;
  always@(pat0_splaF$D_OUT or
	  y_avValue__h31585 or
	  y_avValue__h31465 or y_avValue__h31505 or y_avValue__h31545)
  begin
  ...
  always@(cap0_splaF$D_OUT or
	  y_avValue__h61031 or
	  y_avValue__h60911 or y_avValue__h60951 or y_avValue__h60991)
  begin
  ...
  always@(pat0_wci_wslv_reqF$D_OUT or
	  ...
	  IF_pat0_wci_wslv_reqF_i_notEmpty__4_AND_pat0_w_ETC___d2748 or
	  pat0_dataBram_serverAdapterB_cnt_33_SLT_3___d2546)
  begin
  ...
  always@(pat0_wci_wslv_reqF$D_OUT or
	  ...
	  pat0_mesgCount or
	  pat0_dataCount or
	  pat0_mesgRemain or rdat___1__h33368 or pat0_wsiM_extStatusW$wget)
  begin
    case (pat0_wci_wslv_reqF$D_OUT[39:32])
      8'h0: v__h33192 = pat0_controlReg;
      8'h08: v__h33192 = pat0_mesgCount;
      8'h0C: v__h33192 = pat0_dataCount;
      8'h10: v__h33192 = pat0_mesgRemain;
      8'h1C: v__h33192 = 32'hA0240A0A;
      8'h20: v__h33192 = rdat___1__h33368;
      8'h24: v__h33192 = pat0_wsiM_extStatusW$wget[95:64];
      8'h28: v__h33192 = pat0_wsiM_extStatusW$wget[63:32];
      8'h2C: v__h33192 = pat0_wsiM_extStatusW$wget[31:0];
      default: v__h33192 = 32'd0;
    endcase
  end
  always@(pat0_splaF$D_OUT or
  ...
  always@(cap0_wci_wslv_reqF$D_OUT or
	  ...
	  cap0_metaCount or
	  cap0_dataCount or
	  rdat___1__h61737 or rdat___1__h61811 or cap0_wsiS_extStatusW$wget)
  begin
    case (cap0_wci_wslv_reqF$D_OUT[39:32])
      8'h0: v__h61640 = cap0_controlReg;
      8'h04: v__h61640 = cap0_metaCount;
      8'h08: v__h61640 = cap0_dataCount;
      8'h0C: v__h61640 = rdat___1__h61737;
      8'h10: v__h61640 = rdat___1__h61811;
      8'h14: v__h61640 = cap0_wsiS_extStatusW$wget[95:64];
      8'h18: v__h61640 = cap0_wsiS_extStatusW$wget[63:32];
      8'h1C: v__h61640 = cap0_wsiS_extStatusW$wget[31:0];
      default: v__h61640 = 32'd0;
    endcase
  end
  always@(cap0_splaF$D_OUT or
  ...
  begin
    ...
    if (cp$RST_N_wci_Vm_2 != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_pat0_advance_split_response)
	$display("[%0d]: %m: WCI SPLIT READ Data:%0x", v__h31713, v__h30795);
    if (cp$RST_N_wci_Vm_2 != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_pat0_advance_split_response &&
	  WILL_FIRE_RL_pat0_wci_ctrl_OrE)
    ...
    if (cp$RST_N_wci_Vm_4 != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_cap0_advance_split_response)
	$display("[%0d]: %m: WCI SPLIT READ Data:%0x", v__h61159, v__h60240);
    if (cp$RST_N_wci_Vm_4 != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_cap0_advance_split_response &&
	  WILL_FIRE_RL_cap0_wci_ctrl_OrE)
