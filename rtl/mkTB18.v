...
//
// On Sun Sep 30 09:23:16 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkTB18(CLK,
  ...
  reg [33 : 0] MUX_cap0_wci_wslv_respF_q_0$write_1__VAL_1,
  ...
  wire [33 : 0] MUX_cap0_wci_wslv_respF_q_0$write_1__VAL_2,
		MUX_cap0_wci_wslv_respF_q_1$write_1__VAL_2,
  ...
  wire MUX_cap0_controlReg$write_1__SEL_1,
       ...
       MUX_cap0_wci_wslv_respF_q_0$write_1__SEL_1,
       MUX_cap0_wci_wslv_respF_q_1$write_1__SEL_1,
  ...
  wire IF_cap0_splaF_first__085_BITS_1_TO_0_087_EQ_0__ETC___d2115,
       ...
       cap0_dataCount_025_ULT_1024___d2478,
       cap0_metaCount_022_ULT_1024___d2477,
       cap0_splaF_i_notEmpty__084_AND_IF_cap0_splaF_f_ETC___d2117,
       pat0_dataBram_serverAdapterB_cnt_33_SLT_3___d2479,
  ...
  assign MUX_cap0_wci_wslv_respF_q_0$write_1__SEL_1 =
	     WILL_FIRE_RL_cap0_wci_wslv_respF_incCtr &&
	     cap0_wci_wslv_respF_c_r == 2'd0 ;
  assign MUX_cap0_wci_wslv_respF_q_1$write_1__SEL_1 =
	     WILL_FIRE_RL_cap0_wci_wslv_respF_incCtr &&
	     cap0_wci_wslv_respF_c_r == 2'd1 ;
  ...
  begin
    case (1'b1) // synopsys parallel_case
	  ...
	  MUX_cap0_wci_wslv_respF_q_0$write_1__VAL_1 =
	      MUX_cap0_wci_wslv_respF_x_wire$wset_1__VAL_3;
      WILL_FIRE_RL_cap0_wci_cfwr:
	  MUX_cap0_wci_wslv_respF_q_0$write_1__VAL_1 = 34'h1C0DE4201;
      default: MUX_cap0_wci_wslv_respF_q_0$write_1__VAL_1 =
		   34'h2AAAAAAAA /* unspecified value */ ;
    endcase
  end
  assign MUX_cap0_wci_wslv_respF_q_0$write_1__VAL_2 =
	     (cap0_wci_wslv_respF_c_r == 2'd1) ?
	       MUX_cap0_wci_wslv_respF_q_0$write_1__VAL_1 :
	       cap0_wci_wslv_respF_q_1 ;
  assign MUX_cap0_wci_wslv_respF_q_1$write_1__VAL_2 =
	     (cap0_wci_wslv_respF_c_r == 2'd2) ?
	       MUX_cap0_wci_wslv_respF_q_0$write_1__VAL_1 :
	       34'h0AAAAAAAA ;
  ...
  // register cap0_wci_wslv_respF_q_0
  always@(MUX_cap0_wci_wslv_respF_q_0$write_1__SEL_1 or
	  MUX_cap0_wci_wslv_respF_q_0$write_1__VAL_1 or
	  WILL_FIRE_RL_cap0_wci_wslv_respF_both or
  ...
  // register cap0_wci_wslv_respF_q_1
  always@(MUX_cap0_wci_wslv_respF_q_1$write_1__SEL_1 or
	  MUX_cap0_wci_wslv_respF_q_0$write_1__VAL_1 or
	  WILL_FIRE_RL_cap0_wci_wslv_respF_both or
	  MUX_cap0_wci_wslv_respF_q_1$write_1__VAL_2 or
	  WILL_FIRE_RL_cap0_wci_wslv_respF_decCtr)
  begin
    case (1'b1) // synopsys parallel_case
      MUX_cap0_wci_wslv_respF_q_1$write_1__SEL_1:
  ...
  assign cp$EN_server_request_put =
	     cp$RDY_server_request_put && simDCP$RDY_client_request_get ;
  assign cp$EN_server_response_get =
	     cp$RDY_server_response_get && simDCP$RDY_client_response_put ;
  ...
  assign IF_pat0_wci_wslv_reqF_i_notEmpty__4_AND_pat0_w_ETC___d1093 =
	     (pat0_wci_wslv_reqF$EMPTY_N &&
	      pat0_wci_wslv_reqF$D_OUT[35:34] == 2'd1) ?
	       ...
	       IF_pat0_wci_wslv_reqF_i_notEmpty__4_AND_pat0_w_ETC___d1092 ;
  assign IF_pat0_wci_wslv_reqF_i_notEmpty__4_AND_pat0_w_ETC___d2697 =
	     (pat0_wci_wslv_reqF$EMPTY_N &&
	      pat0_wci_wslv_reqF$D_OUT[35:34] == 2'd0) ?
  ...
  assign cap0_dataBram_serverAdapterB_cnt_509_PLUS_IF_c_ETC___d1515 =
		...
		3'd7 :
		3'd0) ;
  assign cap0_dataCount_025_ULT_1024___d2478 = cap0_dataCount < 32'd1024 ;
  ...
  assign cap0_metaBram_serverAdapterB_cnt_627_PLUS_IF_c_ETC___d1633 =
		...
		3'd7 :
		3'd0) ;
  assign cap0_metaCount_022_ULT_1024___d2477 = cap0_metaCount < 32'd1024 ;
  ...
  assign pat0_dataBram_serverAdapterB_cnt_33_PLUS_IF_pa_ETC___d339 =
		...
		3'd7 :
		3'd0) ;
  assign pat0_dataBram_serverAdapterB_cnt_33_SLT_3___d2479 =
  ...
  always@(pat0_wci_wslv_reqF$D_OUT or
	  ...
	  IF_pat0_wci_wslv_reqF_i_notEmpty__4_AND_pat0_w_ETC___d2697 or
	  pat0_dataBram_serverAdapterB_cnt_33_SLT_3___d2479)
  begin
