...
//
// On Mon Sep 10 16:34:15 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkEDCPAdapter(CLK,
  ...
  reg [7 : 0] CASE_dcpRespFD_OUT_BITS_44_TO_43_IF_dcpRespF__ETC__q6;
  reg [1 : 0] CASE_ecpRespFD_OUT_BITS_19_TO_18_3_0_ecpRespF_ETC__q3,
	      ...
	      CASE_server_request_put_BITS_19_TO_18_3_0_serv_ETC__q9,
	      CASE_server_request_put_BITS_29_TO_28_3_0_serv_ETC__q8,
	      CASE_server_request_put_BITS_39_TO_38_3_0_serv_ETC__q7,
	      CASE_server_request_put_BITS_9_TO_8_3_0_server_ETC__q10;
  ...
  wire [7 : 0] IF_dcpRespF_first__35_BIT_42_42_THEN_0x70_ELSE_ETC___d455;
  wire [3 : 0] x__h1849;
  wire IF_dcpReqF_first__13_BITS_78_TO_77_14_EQ_0_15__ETC___d146,
       ...
       eMAddrF_i_notFull__3_AND_IF_eDMH_4_BITS_13_TO__ETC___d94,
       edpFsm_abort_whas__13_AND_edpFsm_abort_wget__1_ETC___d247,
       edpFsm_abort_whas__13_AND_edpFsm_abort_wget__1_ETC___d329;
  ...
  assign WILL_FIRE_RL_edpFsm_idle_l221c3 =
  ...
  assign eDoReq_1$whas = ecpReqF$EMPTY_N && !eDoReq ;
  ...
  // register eAddr
  assign eAddr$D_IN = eDMH$D_IN ;
  assign eAddr$EN = eDoReq_1$whas && ptr == 4'd5 ;

  // register eDAddr
  assign eDAddr$D_IN = (ptr == 4'd0) ? x__h3330 : x__h5102 ;
  assign eDAddr$EN = eDoReq_1$whas && (ptr == 4'd0 || ptr == 4'd1) ;

  // register eDMH
  assign eDMH$D_IN =
	     { x__h5190, ecpReqF$D_OUT[27:20], ecpReqF$D_OUT[37:30] } ;
  assign eDMH$EN = eDoReq_1$whas && ptr == 4'd4 ;

  // register eData
  assign eData$D_IN = eDMH$D_IN ;
  assign eData$EN = eDoReq_1$whas && ptr == 4'd6 ;

  // register eDoReq
  assign eDoReq$D_IN = eDoReq_1$whas && eDoReq_1$wget ;
  assign eDoReq$EN = 1'd1 ;

  // register eMAddr
  assign eMAddr$D_IN = (ptr == 4'd1) ? x__h5061 : x__h5157 ;
  assign eMAddr$EN = eDoReq_1$whas && (ptr == 4'd1 || ptr == 4'd2) ;

  // register ePli
  assign ePli$D_IN = { ecpReqF$D_OUT[27:20], ecpReqF$D_OUT[37:30] } ;
  assign ePli$EN = eDoReq_1$whas && ptr == 4'd3 ;

  // register eTyp
  assign eTyp$D_IN = { ecpReqF$D_OUT[7:0], ecpReqF$D_OUT[17:10] } ;
  assign eTyp$EN = eDoReq_1$whas && ptr == 4'd3 ;
  ...
  assign eeDmh$D_IN =
	     { dcpRespF$D_OUT[9:2],
	       CASE_dcpRespFD_OUT_BITS_44_TO_43_IF_dcpRespF__ETC__q6,
	       16'h0 } ;
  assign eeDmh$EN =
	     edpFsm_abort_whas__13_AND_edpFsm_abort_wget__1_ETC___d329 &&
	     eMAddrF$EMPTY_N &&
  ...
  assign ecpReqF$DEQ = eDoReq_1$whas ;
  ...
  assign IF_dcpReqF_first__13_BITS_78_TO_77_14_EQ_1_17__ETC___d144 =
		...
		cpReqF$FULL_N) :
	       ...
	       !dcpReqF$D_OUT[44] ||
	       cpReqF$FULL_N ;
  assign IF_dcpRespF_first__35_BIT_42_42_THEN_0x70_ELSE_ETC___d455 =
	     dcpRespF$D_OUT[42] ? 8'h70 : 8'h30 ;
  assign bedw__h1824 = eDMH$D_IN ;
  ...
  assign dcpReqF_first__13_BITS_78_TO_77_14_EQ_1_17_AND_ETC___d190 =
	     ...
	     (!dcpReqF_first__13_BITS_39_TO_32_18_EQ_IF_lastT_ETC___d440 ||
	      !lastTag[8] ||
	      dcpReqF$D_OUT[44]) ;
  assign eMAddrF_i_notFull__3_AND_IF_eDMH_4_BITS_13_TO__ETC___d94 =
	     eMAddrF$FULL_N &&
  ...
  assign edpFsm_abort_whas__13_AND_edpFsm_abort_wget__1_ETC___d329 =
	     edpFsm_abort_whas__13_AND_edpFsm_abort_wget__1_ETC___d247 &&
	     (!edpFsm_start_reg_1 || edpFsm_state_fired) &&
	     !edpFsm_start_reg ;
  assign x__h1849 =
  ...
  always@(dcpRespF$D_OUT or
	  IF_dcpRespF_first__35_BIT_42_42_THEN_0x70_ELSE_ETC___d455)
  begin
    case (dcpRespF$D_OUT[44:43])
      2'd0:
	  CASE_dcpRespFD_OUT_BITS_44_TO_43_IF_dcpRespF__ETC__q6 =
      ...
      default: CASE_dcpRespFD_OUT_BITS_44_TO_43_IF_dcpRespF__ETC__q6 =
		   IF_dcpRespF_first__35_BIT_42_42_THEN_0x70_ELSE_ETC___d455;
    endcase
  end
  ...
  begin
    case (server_request_put[39:38])
      ...
      2'd3: CASE_server_request_put_BITS_39_TO_38_3_0_serv_ETC__q7 = 2'd3;
    endcase
  end
  always@(server_request_put)
  begin
    case (server_request_put[29:28])
      ...
      2'd3: CASE_server_request_put_BITS_29_TO_28_3_0_serv_ETC__q8 = 2'd3;
    endcase
  end
  always@(server_request_put)
  begin
    case (server_request_put[19:18])
      ...
      2'd3: CASE_server_request_put_BITS_19_TO_18_3_0_serv_ETC__q9 = 2'd3;
    endcase
  end
  always@(server_request_put)
  begin
    case (server_request_put[9:8])
      ...
      2'd3: CASE_server_request_put_BITS_9_TO_8_3_0_server_ETC__q10 = 2'd3;
    endcase
  end
