...
//
// On Wed Sep  5 16:30:43 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkEDCPAdapter(CLK,
  ...
  wire WILL_FIRE_RL_cp_to_dcp_response,
       ...
       WILL_FIRE_RL_edpFsm_action_l215c14,
       WILL_FIRE_RL_edpFsm_action_l216c14,
       WILL_FIRE_RL_edpFsm_action_l217c14,
       WILL_FIRE_RL_edpFsm_action_l218c14,
       WILL_FIRE_RL_edpFsm_action_l220c16,
       WILL_FIRE_RL_edpFsm_action_l222c16,
       WILL_FIRE_RL_edpFsm_action_l223c16,
       WILL_FIRE_RL_edpFsm_fsm_start,
       WILL_FIRE_RL_edpFsm_idle_l214c3;
  ...
  wire [47 : 0] x__h3220, x__h4964;
  wire [31 : 0] bedw__h1728;
  wire [15 : 0] x__h4996, x__h5064;
  wire [7 : 0] IF_dcpRespF_first__08_BIT_42_15_THEN_0x70_ELSE_ETC___d501;
  wire [3 : 0] x__h1753;
  wire IF_dcpReqF_first__8_BITS_78_TO_77_9_EQ_0_00_TH_ETC___d131,
       IF_dcpReqF_first__8_BITS_78_TO_77_9_EQ_1_02_TH_ETC___d129,
       dcpReqF_first__8_BITS_39_TO_32_03_EQ_IF_lastTa_ETC___d489,
       dcpReqF_first__8_BITS_71_TO_64_16_EQ_IF_lastTa_ETC___d490,
       dcpReqF_first__8_BITS_78_TO_77_9_EQ_0_00_OR_dc_ETC___d134,
       dcpReqF_first__8_BITS_78_TO_77_9_EQ_1_02_AND_N_ETC___d175,
       eMAddrF_i_notFull__8_AND_IF_eDMH_9_BITS_21_TO__ETC___d79,
       edpFsm_abort_whas__98_AND_edpFsm_abort_wget__9_ETC___d298;
  ...
  assign WILL_FIRE_RL_dcp_to_cp_request =
	     dcpReqF$EMPTY_N &&
	     IF_dcpReqF_first__8_BITS_78_TO_77_9_EQ_0_00_TH_ETC___d131 ;
  ...
  // rule RL_edpFsm_action_l216c14
  assign WILL_FIRE_RL_edpFsm_action_l216c14 =
	     ecpRespF$FULL_N && edpFsm_state_mkFSMstate == 4'd1 ;

  // rule RL_edpFsm_action_l217c14
  assign WILL_FIRE_RL_edpFsm_action_l217c14 =
	     ecpRespF$FULL_N && edpFsm_state_mkFSMstate == 4'd2 ;

  // rule RL_edpFsm_action_l218c14
  assign WILL_FIRE_RL_edpFsm_action_l218c14 =
	     ecpRespF$FULL_N && edpFsm_state_mkFSMstate == 4'd3 ;

  // rule RL_edpFsm_action_l220c16
  assign WILL_FIRE_RL_edpFsm_action_l220c16 =
	     ecpRespF$FULL_N && isWrtResp && edpFsm_state_mkFSMstate == 4'd4 ;

  // rule RL_edpFsm_action_l222c16
  assign WILL_FIRE_RL_edpFsm_action_l222c16 =
	     ecpRespF$FULL_N && !isWrtResp &&
	     edpFsm_state_mkFSMstate == 4'd4 ;

  // rule RL_edpFsm_action_l223c16
  assign WILL_FIRE_RL_edpFsm_action_l223c16 =
	     ecpRespF$FULL_N &&
  ...
  // rule RL_edpFsm_action_l215c14
  assign WILL_FIRE_RL_edpFsm_action_l215c14 =
  ...
  // rule RL_edpFsm_idle_l214c3
  assign WILL_FIRE_RL_edpFsm_idle_l214c3 =
  ...
  assign MUX_ecpRespF$enq_1__VAL_2 =
	     { 22'd221824, eeMDst[7:0], 2'd0, eeMDst[15:8] } ;
  assign MUX_ecpRespF$enq_1__VAL_3 =
	     { 2'd0, eePli[7:0], 2'd0, eePli[15:8], 20'd213232 } ;
  ...
  // register eMAddr
  assign eMAddr$D_IN = (ptr == 4'd1) ? x__h3220 : x__h4964 ;
  assign eMAddr$EN =
	     WILL_FIRE_RL_ecp_ingress && (ptr == 4'd1 || ptr == 4'd2) ;

  // register ePli
  assign ePli$D_IN = x__h5064 ;
  assign ePli$EN = WILL_FIRE_RL_ecp_ingress && ptr == 4'd3 ;

  // register eTyp
  assign eTyp$D_IN = x__h4996 ;
  ...
  // register edpFsm_state_mkFSMstate
  always@(WILL_FIRE_RL_edpFsm_idle_l214c3 or
	  WILL_FIRE_RL_edpFsm_action_l215c14 or
	  WILL_FIRE_RL_edpFsm_action_l216c14 or
	  WILL_FIRE_RL_edpFsm_action_l217c14 or
	  WILL_FIRE_RL_edpFsm_action_l218c14 or
	  WILL_FIRE_RL_edpFsm_action_l220c16 or
	  WILL_FIRE_RL_edpFsm_action_l222c16 or
	  WILL_FIRE_RL_edpFsm_action_l223c16)
  begin
    case (1'b1) // synopsys parallel_case
      WILL_FIRE_RL_edpFsm_idle_l214c3: edpFsm_state_mkFSMstate$D_IN = 4'd0;
      WILL_FIRE_RL_edpFsm_action_l215c14: edpFsm_state_mkFSMstate$D_IN = 4'd1;
      WILL_FIRE_RL_edpFsm_action_l216c14: edpFsm_state_mkFSMstate$D_IN = 4'd2;
      WILL_FIRE_RL_edpFsm_action_l217c14: edpFsm_state_mkFSMstate$D_IN = 4'd3;
      WILL_FIRE_RL_edpFsm_action_l218c14: edpFsm_state_mkFSMstate$D_IN = 4'd4;
      WILL_FIRE_RL_edpFsm_action_l220c16: edpFsm_state_mkFSMstate$D_IN = 4'd5;
      WILL_FIRE_RL_edpFsm_action_l222c16: edpFsm_state_mkFSMstate$D_IN = 4'd6;
      WILL_FIRE_RL_edpFsm_action_l223c16: edpFsm_state_mkFSMstate$D_IN = 4'd7;
  ...
  // register ptr
  assign ptr$D_IN =
	     (x__h1753 == 4'd0) ? ((ptr == 4'd6) ? ptr : ptr + 4'd1) : 4'd0 ;
  ...
  // submodule ecpRespF
  always@(WILL_FIRE_RL_edpFsm_action_l215c14 or
	  ...
	  WILL_FIRE_RL_edpFsm_action_l223c16 or
	  MUX_ecpRespF$enq_1__VAL_6 or WILL_FIRE_RL_edpFsm_action_l217c14)
  begin
    case (1'b1) // synopsys parallel_case
      WILL_FIRE_RL_edpFsm_action_l215c14:
      ...
      WILL_FIRE_RL_edpFsm_action_l217c14: ecpRespF$D_IN = 40'h2943E094FA;
  ...
  // remaining internal signals
  assign IF_dcpReqF_first__8_BITS_78_TO_77_9_EQ_0_00_TH_ETC___d131 =
	     (dcpReqF$D_OUT[78:77] == 2'd0) ?
	       dcpRespF$FULL_N :
	       (dcpReqF$D_OUT[78:77] == 2'd1 ||
		!dcpReqF_first__8_BITS_39_TO_32_03_EQ_IF_lastTa_ETC___d489 ||
		...
		dcpRespF$FULL_N) &&
	       IF_dcpReqF_first__8_BITS_78_TO_77_9_EQ_1_02_TH_ETC___d129 ;
  assign IF_dcpReqF_first__8_BITS_78_TO_77_9_EQ_1_02_TH_ETC___d129 =
	     (dcpReqF$D_OUT[78:77] == 2'd1) ?
	       dcpRespF$FULL_N &&
	       (dcpReqF_first__8_BITS_71_TO_64_16_EQ_IF_lastTa_ETC___d490 &&
		lastTag[8] &&
		...
		cpReqF$FULL_N) :
	       ...
	       !dcpReqF$D_OUT[44] ||
	       cpReqF$FULL_N ;
  assign IF_dcpRespF_first__08_BIT_42_15_THEN_0x70_ELSE_ETC___d501 =
	     dcpRespF$D_OUT[42] ? 8'h70 : 8'h30 ;
  assign bedw__h1728 =
	     { x__h4996, ecpReqF$D_OUT[27:20], ecpReqF$D_OUT[37:30] } ;
  assign dcpReqF_first__8_BITS_39_TO_32_03_EQ_IF_lastTa_ETC___d489 =
	     dcpReqF$D_OUT[39:32] == lastTag[7:0] ;
  assign dcpReqF_first__8_BITS_71_TO_64_16_EQ_IF_lastTa_ETC___d490 =
	     dcpReqF$D_OUT[71:64] == lastTag[7:0] ;
  assign dcpReqF_first__8_BITS_78_TO_77_9_EQ_0_00_OR_dc_ETC___d134 =
	     dcpReqF$D_OUT[78:77] == 2'd0 || dcpReqF$D_OUT[78:77] == 2'd1 ||
	     dcpReqF_first__8_BITS_39_TO_32_03_EQ_IF_lastTa_ETC___d489 &&
	     lastTag[8] &&
	     !dcpReqF$D_OUT[44] ;
  assign dcpReqF_first__8_BITS_78_TO_77_9_EQ_1_02_AND_N_ETC___d175 =
	     dcpReqF$D_OUT[78:77] == 2'd1 &&
	     (!dcpReqF_first__8_BITS_71_TO_64_16_EQ_IF_lastTa_ETC___d490 ||
	      !lastTag[8] ||
	      dcpReqF$D_OUT[76]) ||
	     ...
	     (!dcpReqF_first__8_BITS_39_TO_32_03_EQ_IF_lastTa_ETC___d489 ||
	      !lastTag[8] ||
	      dcpReqF$D_OUT[44]) ;
  assign eMAddrF_i_notFull__8_AND_IF_eDMH_9_BITS_21_TO__ETC___d79 =
	     eMAddrF$FULL_N &&
	     CASE_eDMH_BITS_21_TO_20_NOT_eDMH_BITS_21_TO_20_ETC__q5 ;
  assign edpFsm_abort_whas__98_AND_edpFsm_abort_wget__9_ETC___d298 =
	     (edpFsm_state_mkFSMstate == 4'd0 ||
	      edpFsm_state_mkFSMstate == 4'd7) &&
	     (!edpFsm_start_reg_1 || edpFsm_state_fired) ;
  assign x__h1753 =
  ...
  assign x__h3220 = { x__h5064, 32'h0 } ;
  assign x__h4964 = eMAddr | { 16'd0, bedw__h1728 } ;
  assign x__h4996 = { ecpReqF$D_OUT[7:0], ecpReqF$D_OUT[17:10] } ;
  assign x__h5064 = { ecpReqF$D_OUT[27:20], ecpReqF$D_OUT[37:30] } ;
  ...
  always@(dcpRespF$D_OUT or
	  IF_dcpRespF_first__08_BIT_42_15_THEN_0x70_ELSE_ETC___d501)
  begin
    case (dcpRespF$D_OUT[44:43])
      2'd0:
	  CASE_dcpRespFD_OUT_BITS_44_TO_43_IF_dcpRespF__ETC__q10 =
  ...
  begin
    #0;
    if (RST_N)
      if (WILL_FIRE_RL_edpFsm_action_l216c14 &&
	  (WILL_FIRE_RL_edpFsm_action_l217c14 ||
	   WILL_FIRE_RL_edpFsm_action_l218c14 ||
	   WILL_FIRE_RL_edpFsm_action_l220c16 ||
	   WILL_FIRE_RL_edpFsm_action_l222c16 ||
	   WILL_FIRE_RL_edpFsm_action_l223c16))
	$display("Error: \"bsv/eth/EDCP.bsv\", line 216, column 14: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_edpFsm_action_l216c14] and\n  [RL_edpFsm_action_l217c14, RL_edpFsm_action_l218c14,\n  RL_edpFsm_action_l220c16, RL_edpFsm_action_l222c16,\n  RL_edpFsm_action_l223c16] ) fired in the same clock cycle.\n");
    if (RST_N)
      if (WILL_FIRE_RL_edpFsm_action_l217c14 &&
	  (WILL_FIRE_RL_edpFsm_action_l218c14 ||
	   WILL_FIRE_RL_edpFsm_action_l220c16 ||
	   WILL_FIRE_RL_edpFsm_action_l222c16 ||
	   WILL_FIRE_RL_edpFsm_action_l223c16))
	$display("Error: \"bsv/eth/EDCP.bsv\", line 217, column 14: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_edpFsm_action_l217c14] and\n  [RL_edpFsm_action_l218c14, RL_edpFsm_action_l220c16,\n  RL_edpFsm_action_l222c16, RL_edpFsm_action_l223c16] ) fired in the same\n  clock cycle.\n");
    if (RST_N)
      if (WILL_FIRE_RL_edpFsm_action_l218c14 &&
	  (WILL_FIRE_RL_edpFsm_action_l220c16 ||
	   WILL_FIRE_RL_edpFsm_action_l222c16 ||
	   WILL_FIRE_RL_edpFsm_action_l223c16))
	$display("Error: \"bsv/eth/EDCP.bsv\", line 218, column 14: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_edpFsm_action_l218c14] and\n  [RL_edpFsm_action_l220c16, RL_edpFsm_action_l222c16,\n  RL_edpFsm_action_l223c16] ) fired in the same clock cycle.\n");
    if (RST_N)
      if (WILL_FIRE_RL_edpFsm_action_l220c16 &&
	  (WILL_FIRE_RL_edpFsm_action_l222c16 ||
	   WILL_FIRE_RL_edpFsm_action_l223c16))
	$display("Error: \"bsv/eth/EDCP.bsv\", line 220, column 16: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_edpFsm_action_l220c16] and\n  [RL_edpFsm_action_l222c16, RL_edpFsm_action_l223c16] ) fired in the same\n  clock cycle.\n");
    if (RST_N)
      if (WILL_FIRE_RL_edpFsm_action_l222c16 &&
	  WILL_FIRE_RL_edpFsm_action_l223c16)
	$display("Error: \"bsv/eth/EDCP.bsv\", line 222, column 16: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_edpFsm_action_l222c16] and\n  [RL_edpFsm_action_l223c16] ) fired in the same clock cycle.\n");
    if (RST_N)
      if (WILL_FIRE_RL_edpFsm_action_l215c14 &&
	  (WILL_FIRE_RL_edpFsm_action_l216c14 ||
	   WILL_FIRE_RL_edpFsm_action_l217c14 ||
	   WILL_FIRE_RL_edpFsm_action_l218c14 ||
	   WILL_FIRE_RL_edpFsm_action_l220c16 ||
	   WILL_FIRE_RL_edpFsm_action_l222c16 ||
	   WILL_FIRE_RL_edpFsm_action_l223c16))
	$display("Error: \"bsv/eth/EDCP.bsv\", line 215, column 14: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_edpFsm_action_l215c14] and\n  [RL_edpFsm_action_l216c14, RL_edpFsm_action_l217c14,\n  RL_edpFsm_action_l218c14, RL_edpFsm_action_l220c16,\n  RL_edpFsm_action_l222c16, RL_edpFsm_action_l223c16] ) fired in the same\n  clock cycle.\n");
  end
  // synopsys translate_on
