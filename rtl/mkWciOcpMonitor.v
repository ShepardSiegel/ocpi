...
//
// On Mon Nov 29 15:21:46 EST 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkWciOcpMonitor(CLK,
  ...
  wire [33 : 0] pmemgen_pmemF$D_IN, pmemgen_pmemF$D_OUT;
  ...
  wire [33 : 0] MUX_pmemgen_pmemF$enq_1__VAL_1,
  ...
  wire [31 : 0] monId_CONCAT_IF_IF_pmemgen_evF_first__6_BITS_7_ETC___d201,
		x__h1125;
  ...
  assign MUX_pmemgen_pmemF$enq_1__VAL_1 =
	     { pmemgen_evF$D_OUT[73:72] == 2'd0,
	       1'd0,
	       monId_CONCAT_IF_IF_pmemgen_evF_first__6_BITS_7_ETC___d201 } ;
  ...
  // remaining internal signals
  assign monId_CONCAT_IF_IF_pmemgen_evF_first__6_BITS_7_ETC___d201 =
	     { monId,
	       CASE_pmemgen_evFD_OUT_BITS_73_TO_72_pmemgen_e_ETC__q2 ?
		 8'd0 :
		 (CASE_pmemgen_evFD_OUT_BITS_73_TO_72_pmemgen_e_ETC__q3 ?
  ...
  begin
    case (pmemgen_evF$D_OUT[73:72])
      2'd0: len__h2078 = 8'd1;
      2'd1: len__h2078 = 8'd2;
      default: len__h2078 = 8'd3;
    endcase
  end
  always@(pmemgen_evF$D_OUT)
  begin
