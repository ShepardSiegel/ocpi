...
//
// On Fri Nov 19 16:00:13 EST 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkWciOcpMonitor(monId,
  ...
  wire [73 : 0] observer_evF$D_IN, observer_evF$D_OUT;
  ...
  wire [73 : 0] MUX_observer_evF$enq_1__VAL_1, MUX_observer_evF$enq_1__VAL_2;
  ...
  reg [7 : 0] x__h1770, x__h1797;
  reg [1 : 0] CASE_observer_evFD_OUT_BITS_73_TO_72_2_0_obse_ETC__q1;
  wire [31 : 0] x__h965;
  wire [7 : 0] eType__h1127, eType__h959;
  ...
  assign MUX_observer_evF$enq_1__VAL_1 =
	     { 34'h1AAAAAAAA, eType__h1127, observer_r_sData } ;
  assign MUX_observer_evF$enq_1__VAL_2 =
	     (observer_r_mCmd == 3'd1) ?
	       { 2'd2, eType__h959, x__h965, observer_r_mData } :
	       { 54'h1AAAAAAAA30000, observer_r_mAddr } ;
  ...
  assign MUX_pmemgen_pmemF$enq_1__VAL_1 =
	     { 1'd0, monId, x__h1770, pmemgen_srcTag, x__h1797 } ;
  ...
  // submodule observer_evF
  assign observer_evF$D_IN =
	     MUX_observer_evF$enq_1__SEL_1 ?
	       MUX_observer_evF$enq_1__VAL_1 :
  ...
  // submodule pmemgen_evF
  assign pmemgen_evF$D_IN =
	     { CASE_observer_evFD_OUT_BITS_73_TO_72_2_0_obse_ETC__q1,
	       observer_evF$D_OUT[71:0] } ;
  ...
  // remaining internal signals
  assign eType__h1127 = observer_readInFlight ? 8'h32 : 8'h31 ;
  assign eType__h959 = { 4'h2, observer_r_mByteEn } ;
  assign x__h965 = { 12'd0, observer_r_mAddr } ;
  always@(pmemgen_evF$D_OUT)
  begin
    case (pmemgen_evF$D_OUT[73:72])
      2'd0: x__h1770 = pmemgen_evF$D_OUT[7:0];
      2'd1: x__h1770 = pmemgen_evF$D_OUT[39:32];
      default: x__h1770 = pmemgen_evF$D_OUT[71:64];
    endcase
  end
  always@(pmemgen_evF$D_OUT)
  begin
  ...
  begin
    case (observer_evF$D_OUT[73:72])
      ...
      default: CASE_observer_evFD_OUT_BITS_73_TO_72_2_0_obse_ETC__q1 = 2'd2;
    endcase
  end
