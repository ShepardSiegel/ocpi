...
//
// On Wed Aug 24 18:14:32 EDT 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkOCInf4B(pciDevice,
  ...
  // submodule dp0
  mkOCDP4B dp0(.pciDevice(pciDevice_BITS_15_TO_3_9_CONCAT_0___d98),
	       .hasPush(1'd0),
	       .hasPull(1'd1),
	       .CLK(CLK),
  ...
  // submodule dp1
  mkOCDP4B dp1(.pciDevice(pciDevice_BITS_15_TO_3_9_CONCAT_1___d94),
	       .hasPush(1'd1),
	       .hasPull(1'd0),
	       .CLK(CLK),
