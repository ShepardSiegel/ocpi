...
//
// On Wed May 23 09:15:18 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkOCInf4B(pciDevice,
  ...
  mkOCDP4B #(.hasPush(1'd0),
	     .hasPull(1'd1),
	     .hasDebugLogic(1'd0)) dp0(.pciDevice(pciDevice_BITS_15_TO_3_43_CONCAT_0___d367),
				       .CLK(CLK),
  ...
  mkOCDP4B #(.hasPush(1'd1),
	     .hasPull(1'd0),
	     .hasDebugLogic(1'd0)) dp1(.pciDevice(pciDevice_BITS_15_TO_3_43_CONCAT_1___d368),
				       .CLK(CLK),
