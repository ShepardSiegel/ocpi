...
//
// On Tue Nov 29 12:00:18 EST 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkOCInf4B(pciDevice,
  ...
  mkOCDP4B #(.hasPush(1'd0),
	     .hasPull(1'd1),
	     .hasDebugLogic(1'd1)) dp0(.pciDevice(pciDevice_BITS_15_TO_3_9_CONCAT_0___d98),
				       .CLK(CLK),
  ...
  mkOCDP4B #(.hasPush(1'd1),
	     .hasPull(1'd0),
	     .hasDebugLogic(1'd1)) dp1(.pciDevice(pciDevice_BITS_15_TO_3_9_CONCAT_1___d94),
				       .CLK(CLK),
