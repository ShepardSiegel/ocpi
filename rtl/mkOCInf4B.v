...
//
// On Sun Mar  4 13:41:24 EST 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkOCInf4B(pciDevice,
  ...
  wire [15 : 0] pciDevice_BITS_15_TO_3_7_CONCAT_0___d106,
		pciDevice_BITS_15_TO_3_7_CONCAT_1___d100;
  ...
  mkOCDP4B #(.hasPush(1'd1),
	     .hasPull(1'd0),
	     .hasDebugLogic(1'd1)) dp1(.pciDevice(pciDevice_BITS_15_TO_3_7_CONCAT_1___d100),
				       .CLK(CLK),
  ...
  assign pciDevice_BITS_15_TO_3_7_CONCAT_0___d106 =
	     { pciDevice[15:3], 3'd0 } ;
  assign pciDevice_BITS_15_TO_3_7_CONCAT_1___d100 =
	     { pciDevice[15:3], 3'd1 } ;
