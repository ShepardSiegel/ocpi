...
//
// On Wed Aug 11 15:30:50 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDDCWorker(wciS0_Clk,
  ...
  reg [63 : 0] v__h12530, v__h2629, v__h2776, v__h3675;
  reg [31 : 0] IF_wci_reqF_first__8_BITS_51_TO_32_3_EQ_0x0_4__ETC___d122;
  wire [31 : 0] ddcStatus__h12407,
		rdat___1__h12852,
		rdat___1__h12952,
		rdat___1__h12966,
		rdat___1__h12974,
  ...
  wire wci_reqF_i_notEmpty__7_AND_IF_wci_reqF_first___ETC___d65,
       wsiS_reqFifo_notFull__41_AND_wsiS_burstKind_21_ETC___d361;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_1 = { 2'd1, x_data__h12828 } ;
  ...
  // remaining internal signals
  assign ddcStatus__h12407 = { 31'd0, hasDebugLogic } ;
  assign rdat___1__h12852 = hasDebugLogic ? { 16'd0, x__h12856 } : 32'd0 ;
  assign rdat___1__h12952 =
	     hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat___1__h12966 =
	     hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat___1__h12974 =
	     hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat___1__h12980 =
	     hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat___1__h12994 =
	     hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat___1__h13002 =
	     hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat___1__h13008 = hasDebugLogic ? ambaWrReqCnt : 32'd0 ;
  assign rdat___1__h13015 = hasDebugLogic ? ambaRdReqCnt : 32'd0 ;
  assign rdat___1__h13021 = hasDebugLogic ? ambaRespCnt : 32'd0 ;
  assign wci_reqF_i_notEmpty__7_AND_IF_wci_reqF_first___ETC___d65 =
	     wci_reqF$EMPTY_N &&
	     (wci_reqF$D_OUT[44] ?
		ddc_apbReqF$FULL_N :
		wci_respF_c_r != 2'd2) ;
  assign wsiS_reqFifo_notFull__41_AND_wsiS_burstKind_21_ETC___d361 =
	     wsiS_reqFifo$FULL_N &&
	     (wsiS_burstKind == 2'd0 ||
	      (wsiS_burstKind == 2'd1 || wsiS_burstKind == 2'd2) &&
	      wsiS_wsiReq$wget[57]) ;
  assign x__h12856 = { wsiS_statusR, wsiM_statusR } ;
  assign x_data__h11800 = { ddc_xkF$D_OUT[15:0], ddc_xkF$D_OUT[31:16] } ;
  assign x_data__h12828 =
	     wci_reqF$D_OUT[44] ?
	       32'd0 :
	       IF_wci_reqF_first__8_BITS_51_TO_32_3_EQ_0x0_4__ETC___d122 ;
  always@(wci_reqF$D_OUT or
	  ddcStatus__h12407 or
	  ddcCtrl or
	  rdat___1__h12852 or
	  rdat___1__h12952 or
	  rdat___1__h12966 or
	  ...
	  rdat___1__h12994 or
	  rdat___1__h13002 or
	  rdat___1__h13008 or rdat___1__h13015 or rdat___1__h13021)
  begin
  ...
  begin
    ...
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wci_ctrl_IsO)
	$display("[%0d]: %m: Starting DDC ddcCtrl:%0x", v__h12530, ddcCtrl);
    if (wciS0_MReset_n)
