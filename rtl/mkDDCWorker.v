...
//
// On Wed Aug 11 17:55:36 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDDCWorker(wciS0_Clk,
  ...
  reg [63 : 0] v__h12628, v__h2629, v__h2776, v__h3675;
  reg [31 : 0] CASE_wci_reqFD_OUT_BITS_51_TO_32_0_0x0_ddcSta_ETC__q1;
  wire [31 : 0] ddcStatus__h12505,
		rdat___1__h12948,
		rdat___1__h13048,
		rdat___1__h13062,
		rdat___1__h13070,
  ...
  wire wci_reqF_i_notEmpty__7_AND_IF_wci_reqF_first___ETC___d65,
       wsiS_reqFifo_notFull__52_AND_wsiS_burstKind_32_ETC___d372;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_1 = { 2'd1, x_data__h12911 } ;
  ...
  // remaining internal signals
  assign ddcStatus__h12505 = { 24'd0, x__h12925 } ;
  assign rdat___1__h12948 = hasDebugLogic ? { 16'd0, x__h12952 } : 32'd0 ;
  assign rdat___1__h13048 =
	     hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat___1__h13062 =
	     hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat___1__h13070 =
	     hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat___1__h13076 =
	     hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat___1__h13090 =
	     hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat___1__h13098 =
	     hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat___1__h13104 = hasDebugLogic ? ambaWrReqCnt : 32'd0 ;
  assign rdat___1__h13111 = hasDebugLogic ? ambaRdReqCnt : 32'd0 ;
  assign rdat___1__h13117 = hasDebugLogic ? ambaRespCnt : 32'd0 ;
  assign rdat___1__h13124 = hasDebugLogic ? outMesgCnt : 32'd0 ;
  assign wci_reqF_i_notEmpty__7_AND_IF_wci_reqF_first___ETC___d65 =
	     wci_reqF$EMPTY_N &&
	     (wci_reqF$D_OUT[44] ?
		ddc_apbReqF$FULL_N :
		wci_respF_c_r != 2'd2) ;
  assign wsiS_reqFifo_notFull__52_AND_wsiS_burstKind_32_ETC___d372 =
	     wsiS_reqFifo$FULL_N &&
	     (wsiS_burstKind == 2'd0 ||
  ...
  assign x__h12925 =
	     { ddc_ddc$int_missinput,
	       ...
	       3'b0,
	       hasDebugLogic } ;
  assign x__h12952 = { wsiS_statusR, wsiM_statusR } ;
  assign x_data__h11847 = { ddc_xkF$D_OUT[15:0], ddc_xkF$D_OUT[31:16] } ;
  assign x_data__h12911 =
	     wci_reqF$D_OUT[44] ?
	       32'd0 :
	       CASE_wci_reqFD_OUT_BITS_51_TO_32_0_0x0_ddcSta_ETC__q1 ;
  always@(wci_reqF$D_OUT or
	  ddcStatus__h12505 or
	  ddcCtrl or
	  rdat___1__h12948 or
	  rdat___1__h13048 or
	  rdat___1__h13062 or
	  ...
	  rdat___1__h13098 or
	  rdat___1__h13104 or
	  rdat___1__h13111 or rdat___1__h13117 or rdat___1__h13124)
  begin
