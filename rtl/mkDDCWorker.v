...
//
// On Fri Aug 13 09:59:28 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDDCWorker(wciS0_Clk,
  ...
  reg [63 : 0] v__h12724, v__h2629, v__h2776, v__h3675;
  reg [31 : 0] IF_wci_reqF_first__8_BITS_51_TO_32_3_EQ_0x0_4__ETC___d136;
  wire [31 : 0] ddcStatus__h12601,
		rdat___1__h13044,
		rdat___1__h13144,
		rdat___1__h13158,
		rdat___1__h13166,
  ...
  wire wci_reqF_i_notEmpty__7_AND_IF_wci_reqF_first___ETC___d65,
       wsiS_reqFifo_notFull__64_AND_wsiS_burstKind_44_ETC___d384;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_1 = { 2'd1, x_data__h13007 } ;
  ...
  // remaining internal signals
  assign ddcStatus__h12601 = { 24'd0, x__h13021 } ;
  assign rdat___1__h13044 = hasDebugLogic ? { 16'd0, x__h13048 } : 32'd0 ;
  assign rdat___1__h13144 =
	     hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat___1__h13158 =
	     hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat___1__h13166 =
	     hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat___1__h13172 =
	     hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat___1__h13186 =
	     hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat___1__h13194 =
	     hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat___1__h13200 = hasDebugLogic ? ambaWrReqCnt : 32'd0 ;
  assign rdat___1__h13207 = hasDebugLogic ? ambaRdReqCnt : 32'd0 ;
  assign rdat___1__h13213 = hasDebugLogic ? ambaRespCnt : 32'd0 ;
  assign rdat___1__h13220 = hasDebugLogic ? ambaErrCnt : 32'd0 ;
  assign rdat___1__h13227 = hasDebugLogic ? outMesgCnt : 32'd0 ;
  assign wci_reqF_i_notEmpty__7_AND_IF_wci_reqF_first___ETC___d65 =
	     wci_reqF$EMPTY_N &&
	     (wci_reqF$D_OUT[44] ?
		ddc_apbReqF$FULL_N :
		wci_respF_c_r != 2'd2) ;
  assign wsiS_reqFifo_notFull__64_AND_wsiS_burstKind_44_ETC___d384 =
	     wsiS_reqFifo$FULL_N &&
	     (wsiS_burstKind == 2'd0 ||
  ...
  always@(wci_reqF$D_OUT or
	  ...
	  rdat___1__h13200 or
	  rdat___1__h13207 or
	  rdat___1__h13213 or rdat___1__h13220 or rdat___1__h13227)
  begin
