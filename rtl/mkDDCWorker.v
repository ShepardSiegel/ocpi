...
//
// On Wed Aug 11 07:38:51 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDDCWorker(wciS0_Clk,
  ...
  reg [63 : 0] v__h12471, v__h2629, v__h2776, v__h3675;
  reg [31 : 0] IF_wci_reqF_first__8_BITS_51_TO_32_3_EQ_0x0_4__ETC___d122;
  wire [31 : 0] ddcStatus__h12348,
		rdat___1__h12793,
		rdat___1__h12893,
		rdat___1__h12907,
		rdat___1__h12915,
		...
		x_data__h12769;
  wire [15 : 0] x__h12797;
  wire NOT_ddc_ddc_sRegPready__82_83_OR_ddc_apbReqF_i_ETC___d190,
       wci_reqF_i_notEmpty__7_AND_IF_wci_reqF_first___ETC___d65,
       wsiS_reqFifo_notFull__39_AND_wsiS_burstKind_19_ETC___d359;
  ...
  assign CAN_FIRE_RL_ddc_sreg_request =
	     ddc_reqSetup ?
	       NOT_ddc_ddc_sRegPready__82_83_OR_ddc_apbReqF_i_ETC___d190 :
	       ddc_apbReqF$EMPTY_N ;
  ...
  // rule RL_ddc_sreg_reset
  assign CAN_FIRE_RL_ddc_sreg_reset = 1'd1 ;
  assign WILL_FIRE_RL_ddc_sreg_reset = 1'd1 ;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_1 = { 2'd1, x_data__h12769 } ;
  ...
  assign ddc_sRegPresetn_w$wget = 1'd1 ;
  assign ddc_sRegPresetn_w$whas = 1'd1 ;
  assign ddc_sRegPaddr_w$wget = ddc_apbReqF$D_OUT[43:32] ;
  assign ddc_sRegPaddr_w$whas =
	     WILL_FIRE_RL_ddc_sreg_request && !ddc_reqSetup ;
  assign ddc_sRegPsel_w$wget = 1'd1 ;
  assign ddc_sRegPsel_w$whas = ddc_sRegPaddr_w$whas ;
  assign ddc_sRegPenable_w$wget = 1'd1 ;
  assign ddc_sRegPenable_w$whas = ddc_sRegPaddr_w$whas ;
  assign ddc_sRegPwrite_w$wget = ddc_apbReqF$D_OUT[45] ;
  assign ddc_sRegPwrite_w$whas = ddc_sRegPaddr_w$whas ;
  assign ddc_sRegPwdata_w$wget = ddc_apbReqF$D_OUT[31:0] ;
  assign ddc_sRegPwdata_w$whas = ddc_sRegPaddr_w$whas ;
  ...
  assign ambaRespCnt$EN = WILL_FIRE_RL_advance_wci_response ;
  ...
  // register splitReadInFlight
  assign splitReadInFlight$D_IN = MUX_ddc_apbReqF$enq_1__SEL_2 ;
  ...
  // submodule ddc_apbRespF
  assign ddc_apbRespF$D_IN = { 1'd0, ddc_ddc$sreg_prdata } ;
  ...
  assign ddc_ddc$sreg_paddr =
	     ddc_sRegPaddr_w$whas ? ddc_apbReqF$D_OUT[43:32] : 12'd0 ;
  assign ddc_ddc$sreg_penable = ddc_sRegPaddr_w$whas ;
  assign ddc_ddc$sreg_presetn = 1'b1 ;
  assign ddc_ddc$sreg_psel = ddc_sRegPaddr_w$whas ;
  assign ddc_ddc$sreg_pwrite = ddc_sRegPaddr_w$whas && ddc_apbReqF$D_OUT[45] ;
  assign ddc_ddc$sreg_pwdata =
	     ddc_sRegPaddr_w$whas ? ddc_apbReqF$D_OUT[31:0] : 32'd0 ;
  ...
  // remaining internal signals
  assign NOT_ddc_ddc_sRegPready__82_83_OR_ddc_apbReqF_i_ETC___d190 =
	     !ddc_ddc$sreg_pready ||
	     ddc_apbReqF$EMPTY_N &&
	     (ddc_apbReqF$D_OUT[45] || ddc_apbRespF$FULL_N) ;
  assign ddcStatus__h12348 = { 31'd0, hasDebugLogic } ;
  assign rdat___1__h12793 = hasDebugLogic ? { 16'd0, x__h12797 } : 32'd0 ;
  assign rdat___1__h12893 =
	     hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat___1__h12907 =
	     hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat___1__h12915 =
	     hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat___1__h12921 =
	     hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat___1__h12935 =
	     hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat___1__h12943 =
	     hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat___1__h12949 = hasDebugLogic ? ambaWrReqCnt : 32'd0 ;
  assign rdat___1__h12956 = hasDebugLogic ? ambaRdReqCnt : 32'd0 ;
  assign rdat___1__h12962 = hasDebugLogic ? ambaRespCnt : 32'd0 ;
  assign wci_reqF_i_notEmpty__7_AND_IF_wci_reqF_first___ETC___d65 =
	     wci_reqF$EMPTY_N &&
	     (wci_reqF$D_OUT[44] ?
		ddc_apbReqF$FULL_N :
		wci_respF_c_r != 2'd2) ;
  assign wsiS_reqFifo_notFull__39_AND_wsiS_burstKind_19_ETC___d359 =
	     wsiS_reqFifo$FULL_N &&
	     (wsiS_burstKind == 2'd0 ||
	      (wsiS_burstKind == 2'd1 || wsiS_burstKind == 2'd2) &&
	      wsiS_wsiReq$wget[57]) ;
  assign x__h12797 = { wsiS_statusR, wsiM_statusR } ;
  assign x_data__h11741 = { ddc_xkF$D_OUT[15:0], ddc_xkF$D_OUT[31:16] } ;
  assign x_data__h12769 =
	     wci_reqF$D_OUT[44] ?
	       32'd0 :
	       IF_wci_reqF_first__8_BITS_51_TO_32_3_EQ_0x0_4__ETC___d122 ;
  always@(wci_reqF$D_OUT or
	  ddcStatus__h12348 or
	  ddcCtrl or
	  rdat___1__h12793 or
	  rdat___1__h12893 or
	  rdat___1__h12907 or
	  ...
	  rdat___1__h12935 or
	  rdat___1__h12943 or
	  rdat___1__h12949 or rdat___1__h12956 or rdat___1__h12962)
  begin
    case (wci_reqF$D_OUT[51:32])
	  ...
	  IF_wci_reqF_first__8_BITS_51_TO_32_3_EQ_0x0_4__ETC___d122 =
	      ddcStatus__h12348;
      20'h00004:
	  IF_wci_reqF_first__8_BITS_51_TO_32_3_EQ_0x0_4__ETC___d122 = ddcCtrl;
      20'h00010:
	  IF_wci_reqF_first__8_BITS_51_TO_32_3_EQ_0x0_4__ETC___d122 =
	      rdat___1__h12793;
      20'h00014:
	  ...
	  IF_wci_reqF_first__8_BITS_51_TO_32_3_EQ_0x0_4__ETC___d122 =
	      rdat___1__h12962;
      default: IF_wci_reqF_first__8_BITS_51_TO_32_3_EQ_0x0_4__ETC___d122 =
		   32'd0;
    endcase
  end
