...
//
// On Fri Aug 13 08:41:03 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDDCWorker(wciS0_Clk,
  ...
  wire MUX_ddc_apbReqF$enq_1__SEL_1,
       ...
       MUX_splitWriteInFlight$write_1__SEL_1,
  ...
  reg [63 : 0] v__h12714, v__h2629, v__h2776, v__h3675;
  reg [31 : 0] IF_wci_reqF_first__8_BITS_51_TO_32_3_EQ_0x0_4__ETC___d136;
  wire [31 : 0] ddcStatus__h12591,
		rdat___1__h13034,
		rdat___1__h13134,
		rdat___1__h13148,
		rdat___1__h13156,
  ...
  wire wci_reqF_i_notEmpty__7_AND_IF_wci_reqF_first___ETC___d65,
       wsiS_reqFifo_notFull__57_AND_wsiS_burstKind_37_ETC___d377;
  ...
  assign CAN_FIRE_RL_ddc_sreg_request =
	     ddc_apbReqF$EMPTY_N &&
	     (!ddc_reqSetup || !ddc_ddc$sreg_pready || ddc_apbRespF$FULL_N) ;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_4 =
  ...
  assign MUX_splitWriteInFlight$write_1__SEL_1 =
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_1 = { 2'd1, x_data__h12997 } ;
  ...
  // register splitWriteInFlight
  assign splitWriteInFlight$D_IN = !MUX_splitWriteInFlight$write_1__SEL_1 ;
  ...
  // remaining internal signals
  assign ddcStatus__h12591 = { 24'd0, x__h13011 } ;
  assign rdat___1__h13034 = hasDebugLogic ? { 16'd0, x__h13038 } : 32'd0 ;
  assign rdat___1__h13134 =
	     hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat___1__h13148 =
	     hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat___1__h13156 =
	     hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat___1__h13162 =
	     hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat___1__h13176 =
	     hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat___1__h13184 =
	     hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat___1__h13190 = hasDebugLogic ? ambaWrReqCnt : 32'd0 ;
  assign rdat___1__h13197 = hasDebugLogic ? ambaRdReqCnt : 32'd0 ;
  assign rdat___1__h13203 = hasDebugLogic ? ambaRespCnt : 32'd0 ;
  assign rdat___1__h13210 = hasDebugLogic ? ambaErrCnt : 32'd0 ;
  assign rdat___1__h13217 = hasDebugLogic ? outMesgCnt : 32'd0 ;
  assign wci_reqF_i_notEmpty__7_AND_IF_wci_reqF_first___ETC___d65 =
	     wci_reqF$EMPTY_N &&
	     (wci_reqF$D_OUT[44] ?
		ddc_apbReqF$FULL_N :
		wci_respF_c_r != 2'd2) ;
  assign wsiS_reqFifo_notFull__57_AND_wsiS_burstKind_37_ETC___d377 =
	     wsiS_reqFifo$FULL_N &&
	     (wsiS_burstKind == 2'd0 ||
  ...
  assign x__h13011 =
	     { ddc_ddc$int_missinput,
	       ...
	       3'b0,
	       hasDebugLogic } ;
  assign x__h13038 = { wsiS_statusR, wsiM_statusR } ;
  assign x_data__h11933 = { ddc_xkF$D_OUT[15:0], ddc_xkF$D_OUT[31:16] } ;
  assign x_data__h12997 =
	     wci_reqF$D_OUT[44] ?
	       32'd0 :
	       IF_wci_reqF_first__8_BITS_51_TO_32_3_EQ_0x0_4__ETC___d136 ;
  always@(wci_reqF$D_OUT or
	  ddcStatus__h12591 or
	  ddcCtrl or
	  rdat___1__h13034 or
	  rdat___1__h13134 or
	  rdat___1__h13148 or
	  ...
	  rdat___1__h13190 or
	  rdat___1__h13197 or
	  rdat___1__h13203 or rdat___1__h13210 or rdat___1__h13217)
  begin
