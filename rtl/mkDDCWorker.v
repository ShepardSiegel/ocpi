...
//
// On Mon Aug  9 17:16:36 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDDCWorker(wciS0_Clk,
  ...
  wire [31 : 0] ddc_xkF$D_IN;
  wire ddc_xkF$CLR, ddc_xkF$DEQ, ddc_xkF$ENQ, ddc_xkF$FULL_N;

  // ports of submodule ddc_xnF
  wire [15 : 0] ddc_xnF$D_IN, ddc_xnF$D_OUT;
  wire ddc_xnF$CLR, ddc_xnF$DEQ, ddc_xnF$EMPTY_N, ddc_xnF$ENQ;
  ...
  wire [31 : 0] xnF$D_IN;
  wire xnF$CLR, xnF$DEQ, xnF$ENQ;

  // rule scheduling signals
  wire CAN_FIRE_RL_ddcPass_bypass,
  ...
  reg [63 : 0] v__h11434, v__h2624, v__h2771, v__h3670;
  reg [31 : 0] x_data__h11566;
  wire [31 : 0] ddcStatus__h11311,
		rdat__h11590,
		rdat__h11690,
		rdat__h11704,
		rdat__h11712,
		...
		rdat__h11740;
  wire [15 : 0] x__h11594;
  wire wsiS_reqFifo_notFull__55_AND_wsiS_burstKind_35_ETC___d275;
  ...
  assign CAN_FIRE_RL_wsiM_reqFifo_both =
		...
		wsiM_reqFifo_c_r != 2'd2 || CAN_FIRE_RL_ddcPass_bypass) &&
	     CAN_FIRE_RL_wsiM_reqFifo_deq &&
	     CAN_FIRE_RL_ddcPass_bypass ;
  ...
  assign CAN_FIRE_RL_wsiM_reqFifo_decCtr =
	     CAN_FIRE_RL_wsiM_reqFifo_deq && !CAN_FIRE_RL_ddcPass_bypass ;
  ...
  assign CAN_FIRE_RL_wsiM_reqFifo_incCtr =
		...
		CAN_FIRE_RL_ddcPass_bypass :
		wsiM_reqFifo_c_r != 2'd1 || CAN_FIRE_RL_ddcPass_bypass) &&
	     CAN_FIRE_RL_ddcPass_bypass &&
	     !CAN_FIRE_RL_wsiM_reqFifo_deq ;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, x_data__h11566 } ;
  ...
  assign wsiS_reqFifo_r_enq$whas =
	     MUX_wsiS_reqFifo_levelsValid$write_1__SEL_3 ;
  assign wsiS_reqFifo_r_deq$whas = CAN_FIRE_RL_ddcPass_bypass ;
  assign wsiS_reqFifo_r_clr$whas = 1'b0 ;
  assign wsiS_reqFifo_doResetDeq$whas = CAN_FIRE_RL_ddcPass_bypass ;
  ...
  assign wsiM_reqFifo_enqueueing$whas = CAN_FIRE_RL_ddcPass_bypass ;
  assign wsiM_reqFifo_x_wire$whas = CAN_FIRE_RL_ddcPass_bypass ;
  ...
  // register evenMag
  assign evenMag$EN = 1'b0 ;
  assign evenMag$D_IN = 16'h0 ;

  // register sendEven
  assign sendEven$D_IN = 1'b0 ;
  assign sendEven$EN = 1'b0 ;

  // register takeEven
  assign takeEven$D_IN = 1'b0 ;
  assign takeEven$EN = 1'b0 ;

  // register unloadCnt
  assign unloadCnt$D_IN = 16'h0 ;
  assign unloadCnt$EN = 1'b0 ;
  ...
  assign wsiS_burstKind$EN =
	     WILL_FIRE_RL_wsiS_reqFifo_enq &&
	     wsiS_reqFifo_notFull__55_AND_wsiS_burstKind_35_ETC___d275 ;
  ...
  assign wsiS_reqFifo$DEQ = CAN_FIRE_RL_ddcPass_bypass ;
  assign wsiS_reqFifo$CLR = 1'b0 ;

  // submodule xnF
  assign xnF$D_IN = 32'h0 ;
  assign xnF$ENQ = 1'b0 ;
  assign xnF$CLR = 1'b0 ;
  assign xnF$DEQ = 1'b0 ;

  // remaining internal signals
  assign ddcStatus__h11311 = { 31'd0, hasDebugLogic } ;
  assign rdat__h11590 = hasDebugLogic ? { 16'd0, x__h11594 } : 32'd0 ;
  assign rdat__h11690 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h11704 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h11712 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h11718 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h11732 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h11740 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign wsiS_reqFifo_notFull__55_AND_wsiS_burstKind_35_ETC___d275 =
	     wsiS_reqFifo$FULL_N &&
	     (wsiS_burstKind == 2'd0 ||
	      (wsiS_burstKind == 2'd1 || wsiS_burstKind == 2'd2) &&
	      wsiS_wsiReq$wget[57]) ;
  assign x__h11594 = { wsiS_statusR, wsiM_statusR } ;
  always@(wci_reqF$D_OUT or
	  ddcStatus__h11311 or
	  ddcCtrl or
	  rdat__h11590 or
	  rdat__h11690 or
	  rdat__h11704 or
	  rdat__h11712 or rdat__h11718 or rdat__h11732 or rdat__h11740)
  begin
    case (wci_reqF$D_OUT[51:32])
      20'h0: x_data__h11566 = ddcStatus__h11311;
      20'h00004: x_data__h11566 = ddcCtrl;
      20'h00010: x_data__h11566 = rdat__h11590;
      20'h00014: x_data__h11566 = rdat__h11690;
      20'h00018: x_data__h11566 = rdat__h11704;
      20'h0001C: x_data__h11566 = rdat__h11712;
      20'h00020: x_data__h11566 = rdat__h11718;
      20'h00024: x_data__h11566 = rdat__h11732;
      20'h00028: x_data__h11566 = rdat__h11740;
      default: x_data__h11566 = 32'd0;
    endcase
  end
