...
//
// On Wed Feb  9 20:15:32 EST 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkWSItoAXIS4B(CLK,
  ...
  // remaining internal signals
  assign aui_length__h3970 = { 4'd0, x__h3975 } ;
  assign wsiS_reqFifo_notFull__1_AND_wsiS_burstKind_6_E_ETC___d53 =
	     wsiS_reqFifo$FULL_N &&
	     (wsiS_burstKind == 2'd0 ||
	      (wsiS_burstKind == 2'd1 || wsiS_burstKind == 2'd2) &&
	      wsiS_wsiReq$wget[57]) ;
  assign x__h3975 = { wsiS_reqFifo$D_OUT[53:44], 2'd0 } ;
  assign x_user__h3955 = { aui_length__h3970, wsiS_reqFifo$D_OUT[15:0] } ;
