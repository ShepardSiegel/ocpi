...
//
// On Mon Feb  7 14:58:09 EST 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkWSItoAXIS4B(CLK,
  ...
  input  [31 : 0] wsi_MData;

  // action method wsi_mByteEn
  input  [3 : 0] wsi_MByteEn;
  ...
  wire [7 : 0] axi_dpt_TDATA, axi_spt_TDATA;
  ...
  reg [1 : 0] err_fifof_q_0;
  wire [1 : 0] err_fifof_q_0$D_IN;
  wire err_fifof_q_0$EN;

  // register err_fifof_q_1
  reg [1 : 0] err_fifof_q_1;
  wire [1 : 0] err_fifof_q_1$D_IN;
  ...
  wire [288 : 0] MUX_dat_fifof_q_0$write_1__VAL_1,
		 ...
		 MUX_dat_fifof_q_1$write_1__VAL_2;
  wire [18 : 0] MUX_len_fifof_q_0$write_1__VAL_1,
		MUX_len_fifof_q_0$write_1__VAL_2,
		MUX_len_fifof_q_1$write_1__VAL_2;
  wire [9 : 0] MUX_dpt_fifof_q_0$write_1__VAL_1,
	       MUX_dpt_fifof_q_0$write_1__VAL_2,
	       MUX_dpt_fifof_q_1$write_1__VAL_2,
	       MUX_spt_fifof_q_0$write_1__VAL_2,
	       MUX_spt_fifof_q_1$write_1__VAL_2;
  ...
  wire MUX_dat_fifof_q_0$write_1__SEL_1,
       MUX_dat_fifof_q_1$write_1__SEL_1,
       MUX_dpt_fifof_q_0$write_1__SEL_1,
       MUX_dpt_fifof_q_1$write_1__SEL_1,
       MUX_len_fifof_q_0$write_1__SEL_1,
       MUX_len_fifof_q_1$write_1__SEL_1,
       MUX_spt_fifof_q_0$write_1__SEL_1,
       MUX_spt_fifof_q_1$write_1__SEL_1,
       MUX_wsiS_reqFifo_levelsValid$write_1__SEL_3;

  // remaining internal signals
  wire [255 : 0] x_data__h8895;
  wire [31 : 0] x_strb__h8896;
  wire [15 : 0] x_data__h9022;
  wire [11 : 0] x__h9028;
  ...
  // value method axi_err_mTDATA
  assign axi_err_TDATA = err_fifof_q_0[1] ;
  ...
  assign MUX_dat_fifof_q_0$write_1__VAL_1 =
	     { x_data__h8895, x_strb__h8896, wsiS_reqFifo$D_OUT[57] } ;
  assign MUX_dat_fifof_q_0$write_1__VAL_2 =
	     (dat_fifof_c_r == 2'd1) ?
	       MUX_dat_fifof_q_0$write_1__VAL_1 :
	       dat_fifof_q_1 ;
  assign MUX_dat_fifof_q_1$write_1__VAL_2 =
	     (dat_fifof_c_r == 2'd2) ?
	       MUX_dat_fifof_q_0$write_1__VAL_1 :
	       289'd0 ;
  ...
  assign MUX_dpt_fifof_q_0$write_1__VAL_2 =
	     (dpt_fifof_c_r == 2'd1) ?
	       MUX_dpt_fifof_q_0$write_1__VAL_1 :
	       dpt_fifof_q_1 ;
  assign MUX_dpt_fifof_q_1$write_1__VAL_2 =
	     (dpt_fifof_c_r == 2'd2) ?
	       MUX_dpt_fifof_q_0$write_1__VAL_1 :
	       10'd0 ;
  ...
  assign MUX_len_fifof_q_0$write_1__VAL_1 = { x_data__h9022, 3'd7 } ;
  assign MUX_len_fifof_q_0$write_1__VAL_2 =
	     (len_fifof_c_r == 2'd1) ?
	       MUX_len_fifof_q_0$write_1__VAL_1 :
	       len_fifof_q_1 ;
  assign MUX_len_fifof_q_1$write_1__VAL_2 =
	     (len_fifof_c_r == 2'd2) ?
	       MUX_len_fifof_q_0$write_1__VAL_1 :
	       19'd0 ;
  assign MUX_spt_fifof_c_r$write_1__VAL_1 = spt_fifof_c_r + 2'd1 ;
  assign MUX_spt_fifof_c_r$write_1__VAL_2 = spt_fifof_c_r - 2'd1 ;
  assign MUX_spt_fifof_q_0$write_1__VAL_2 =
	     (spt_fifof_c_r == 2'd1) ? 10'd67 : spt_fifof_q_1 ;
  assign MUX_spt_fifof_q_1$write_1__VAL_2 =
  ...
  assign dat_fifof_x_wire$wget = MUX_dat_fifof_q_0$write_1__VAL_1 ;
  assign dat_fifof_x_wire$whas = WILL_FIRE_RL_advance_data ;
  assign len_fifof_x_wire$wget = MUX_len_fifof_q_0$write_1__VAL_1 ;
  ...
  assign dpt_fifof_x_wire$wget = MUX_dpt_fifof_q_0$write_1__VAL_1 ;
  assign dpt_fifof_x_wire$whas = len_fifof_enqueueing$whas ;
  assign err_fifof_x_wire$wget = 2'h0 ;
  assign err_fifof_x_wire$whas = 1'b0 ;
  ...
  assign err_fifof_enqueueing$whas = 1'b0 ;
  ...
  // register dat_fifof_q_1
  always@(MUX_dat_fifof_q_1$write_1__SEL_1 or
	  MUX_dat_fifof_q_0$write_1__VAL_1 or
	  WILL_FIRE_RL_dat_fifof_both or
	  MUX_dat_fifof_q_1$write_1__VAL_2 or WILL_FIRE_RL_dat_fifof_decCtr)
  begin
    case (1'b1) // synopsys parallel_case
      MUX_dat_fifof_q_1$write_1__SEL_1:
	  dat_fifof_q_1$D_IN = MUX_dat_fifof_q_0$write_1__VAL_1;
      WILL_FIRE_RL_dat_fifof_both:
	  dat_fifof_q_1$D_IN = MUX_dat_fifof_q_1$write_1__VAL_2;
  ...
  // register dpt_fifof_q_0
  always@(MUX_dpt_fifof_q_0$write_1__SEL_1 or
	  MUX_dpt_fifof_q_0$write_1__VAL_1 or
	  WILL_FIRE_RL_dpt_fifof_both or
  ...
  // register dpt_fifof_q_1
  always@(MUX_dpt_fifof_q_1$write_1__SEL_1 or
	  MUX_dpt_fifof_q_0$write_1__VAL_1 or
	  WILL_FIRE_RL_dpt_fifof_both or
	  MUX_dpt_fifof_q_1$write_1__VAL_2 or WILL_FIRE_RL_dpt_fifof_decCtr)
  begin
    case (1'b1) // synopsys parallel_case
      MUX_dpt_fifof_q_1$write_1__SEL_1:
	  dpt_fifof_q_1$D_IN = MUX_dpt_fifof_q_0$write_1__VAL_1;
      WILL_FIRE_RL_dpt_fifof_both:
	  dpt_fifof_q_1$D_IN = MUX_dpt_fifof_q_1$write_1__VAL_2;
  ...
  // register err_fifof_c_r
  assign err_fifof_c_r$D_IN = MUX_err_fifof_c_r$write_1__VAL_2 ;
  assign err_fifof_c_r$EN = err_fifof_dequeueing$whas ;

  // register err_fifof_q_0
  assign err_fifof_q_0$D_IN = err_fifof_q_1 ;
  assign err_fifof_q_0$EN = err_fifof_dequeueing$whas ;

  // register err_fifof_q_1
  assign err_fifof_q_1$D_IN = 2'd0 ;
  assign err_fifof_q_1$EN = err_fifof_dequeueing$whas ;

  // register firstWord
  assign firstWord$D_IN = wsiS_reqFifo$D_OUT[57] ;
  ...
  // register len_fifof_q_0
  always@(MUX_len_fifof_q_0$write_1__SEL_1 or
	  MUX_len_fifof_q_0$write_1__VAL_1 or
	  WILL_FIRE_RL_len_fifof_both or
  ...
  // register len_fifof_q_1
  always@(MUX_len_fifof_q_1$write_1__SEL_1 or
	  MUX_len_fifof_q_0$write_1__VAL_1 or
	  WILL_FIRE_RL_len_fifof_both or
	  MUX_len_fifof_q_1$write_1__VAL_2 or WILL_FIRE_RL_len_fifof_decCtr)
  begin
    case (1'b1) // synopsys parallel_case
      MUX_len_fifof_q_1$write_1__SEL_1:
	  len_fifof_q_1$D_IN = MUX_len_fifof_q_0$write_1__VAL_1;
      WILL_FIRE_RL_len_fifof_both:
	  len_fifof_q_1$D_IN = MUX_len_fifof_q_1$write_1__VAL_2;
  ...
  // register spt_fifof_q_0
  always@(MUX_spt_fifof_q_0$write_1__SEL_1 or
	  WILL_FIRE_RL_spt_fifof_both or
	  MUX_spt_fifof_q_0$write_1__VAL_2 or
	  WILL_FIRE_RL_spt_fifof_decCtr or spt_fifof_q_1)
  begin
    case (1'b1) // synopsys parallel_case
      MUX_spt_fifof_q_0$write_1__SEL_1: spt_fifof_q_0$D_IN = 10'd67;
      WILL_FIRE_RL_spt_fifof_both:
	  spt_fifof_q_0$D_IN = MUX_spt_fifof_q_0$write_1__VAL_2;
  ...
  // register spt_fifof_q_1
  always@(MUX_spt_fifof_q_1$write_1__SEL_1 or
	  WILL_FIRE_RL_spt_fifof_both or
	  MUX_spt_fifof_q_1$write_1__VAL_2 or WILL_FIRE_RL_spt_fifof_decCtr)
  begin
    case (1'b1) // synopsys parallel_case
      MUX_spt_fifof_q_1$write_1__SEL_1: spt_fifof_q_1$D_IN = 10'd67;
      WILL_FIRE_RL_spt_fifof_both:
	  spt_fifof_q_1$D_IN = MUX_spt_fifof_q_1$write_1__VAL_2;
  ...
  assign wsiS_reqFifo_notFull__1_AND_wsiS_burstKind_6_E_ETC___d53 =
	     ...
	     (wsiS_burstKind == 2'd0 ||
	      ...
	      wsiS_wsiReq$wget[57]) ;
  assign x__h9028 = { wsiS_reqFifo$D_OUT[50:44], 5'd0 } ;
  assign x_data__h8895 = { 224'd0, wsiS_reqFifo$D_OUT[43:12] } ;
  assign x_data__h9022 = { 4'd0, x__h9028 } ;
  assign x_strb__h8896 = { 28'd0, wsiS_reqFifo$D_OUT[11:8] } ;
  ...
  begin
	...
	err_fifof_q_0 <= `BSV_ASSIGNMENT_DELAY 2'd0;
	err_fifof_q_1 <= `BSV_ASSIGNMENT_DELAY 2'd0;
