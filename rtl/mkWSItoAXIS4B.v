...
//
// On Tue Feb  8 14:43:41 EST 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkWSItoAXIS4B(CLK,
  ...
  wire WILL_FIRE_RL_axiM_fifof_both,
  ...
  assign WILL_FIRE_RL_axiM_fifof_incCtr =
	     ((axiM_fifof_c_r == 2'd0) ?
		MUX_wsiS_reqFifo_levelsValid$write_1__SEL_2 :
		axiM_fifof_c_r != 2'd1 ||
		MUX_wsiS_reqFifo_levelsValid$write_1__SEL_2) &&
  ...
  assign WILL_FIRE_RL_axiM_fifof_decCtr =
	     axiM_fifof_dequeueing$whas &&
	     !MUX_wsiS_reqFifo_levelsValid$write_1__SEL_2 ;

  // rule RL_axiM_fifof_both
  assign WILL_FIRE_RL_axiM_fifof_both =
	     ((axiM_fifof_c_r == 2'd1) ?
		MUX_wsiS_reqFifo_levelsValid$write_1__SEL_2 :
		axiM_fifof_c_r != 2'd2 ||
		MUX_wsiS_reqFifo_levelsValid$write_1__SEL_2) &&
  ...
  assign axiM_fifof_enqueueing$whas =
	     MUX_wsiS_reqFifo_levelsValid$write_1__SEL_2 ;
  assign axiM_fifof_dequeueing$whas = axiM_fifof_c_r != 2'd0 && axi_TREADY ;
