...
//
// On Mon Feb  7 17:11:40 EST 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkWSItoAXIS4B(CLK,
  ...
  wire [9 : 0] MUX_dpt_fifof_q_0$write_1__VAL_1,
	       ...
	       MUX_err_fifof_q_0$write_1__VAL_2,
	       MUX_err_fifof_q_1$write_1__VAL_2,
  ...
  wire MUX_dat_fifof_q_0$write_1__SEL_1,
       ...
       MUX_err_fifof_q_0$write_1__SEL_1,
       MUX_err_fifof_q_1$write_1__SEL_1,
  ...
  wire [255 : 0] x_data__h8889;
  wire [31 : 0] x_strb__h8890;
  wire [15 : 0] x_data__h9016;
  wire [11 : 0] x__h9022;
  ...
  assign MUX_err_fifof_q_0$write_1__SEL_1 =
	     WILL_FIRE_RL_err_fifof_incCtr && err_fifof_c_r == 2'd0 ;
  assign MUX_err_fifof_q_1$write_1__SEL_1 =
  ...
  assign MUX_dat_fifof_q_0$write_1__VAL_1 =
	     { x_data__h8889, x_strb__h8890, wsiS_reqFifo$D_OUT[57] } ;
  ...
  assign MUX_err_fifof_q_0$write_1__VAL_2 =
	     (err_fifof_c_r == 2'd1) ? 10'd3 : err_fifof_q_1 ;
  assign MUX_err_fifof_q_1$write_1__VAL_2 =
  ...
  assign MUX_len_fifof_q_0$write_1__VAL_1 = { x_data__h9016, 3'd7 } ;
  ...
  // register err_fifof_q_0
  always@(MUX_err_fifof_q_0$write_1__SEL_1 or
	  WILL_FIRE_RL_err_fifof_both or
	  MUX_err_fifof_q_0$write_1__VAL_2 or
	  WILL_FIRE_RL_err_fifof_decCtr or err_fifof_q_1)
  begin
    case (1'b1) // synopsys parallel_case
      MUX_err_fifof_q_0$write_1__SEL_1: err_fifof_q_0$D_IN = 10'd3;
      WILL_FIRE_RL_err_fifof_both:
	  err_fifof_q_0$D_IN = MUX_err_fifof_q_0$write_1__VAL_2;
  ...
  // register err_fifof_q_1
  always@(MUX_err_fifof_q_1$write_1__SEL_1 or
	  WILL_FIRE_RL_err_fifof_both or
	  MUX_err_fifof_q_1$write_1__VAL_2 or WILL_FIRE_RL_err_fifof_decCtr)
  begin
    case (1'b1) // synopsys parallel_case
      MUX_err_fifof_q_1$write_1__SEL_1: err_fifof_q_1$D_IN = 10'd3;
      WILL_FIRE_RL_err_fifof_both:
	  err_fifof_q_1$D_IN = MUX_err_fifof_q_1$write_1__VAL_2;
  ...
  assign wsiS_reqFifo_notFull__1_AND_wsiS_burstKind_6_E_ETC___d53 =
	     ...
	     (wsiS_burstKind == 2'd0 ||
	      ...
	      wsiS_wsiReq$wget[57]) ;
  assign x__h9022 = { wsiS_reqFifo$D_OUT[50:44], 5'd0 } ;
  assign x_data__h8889 = { 224'd0, wsiS_reqFifo$D_OUT[43:12] } ;
  assign x_data__h9016 = { 4'd0, x__h9022 } ;
  assign x_strb__h8890 = { 28'd0, wsiS_reqFifo$D_OUT[11:8] } ;
