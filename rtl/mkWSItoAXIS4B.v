...
module mkWSItoAXIS4B(CLK,
  ...
  assign MUX_axiM_fifof_q_1$write_1__VAL_1 =
	     (axiM_fifof_c_r == 2'd2) ?
	       MUX_axiM_fifof_q_0$write_1__VAL_2 :
	       69'd0 ;
  ...
  assign axiM_fifof_x_wire$wget = MUX_axiM_fifof_q_0$write_1__VAL_2 ;
  assign axiM_fifof_x_wire$whas =
	     MUX_wsiS_reqFifo_levelsValid$write_1__SEL_2 ;
  ...
  assign axiM_fifof_enqueueing$whas =
	     MUX_wsiS_reqFifo_levelsValid$write_1__SEL_2 ;
  ...
  // register axiM_fifof_q_0
  always@(WILL_FIRE_RL_axiM_fifof_both or
	  MUX_axiM_fifof_q_0$write_1__VAL_1 or
	  MUX_axiM_fifof_q_0$write_1__SEL_2 or
  ...
  begin
    case (1'b1) // synopsys parallel_case
      ...
      MUX_axiM_fifof_q_0$write_1__SEL_2:
  ...
  // register axiM_fifof_q_1
  always@(WILL_FIRE_RL_axiM_fifof_both or
	  MUX_axiM_fifof_q_1$write_1__VAL_1 or
	  MUX_axiM_fifof_q_1$write_1__SEL_2 or
	  MUX_axiM_fifof_q_0$write_1__VAL_2 or WILL_FIRE_RL_axiM_fifof_decCtr)
  begin
    case (1'b1) // synopsys parallel_case
      WILL_FIRE_RL_axiM_fifof_both:
	  axiM_fifof_q_1$D_IN = MUX_axiM_fifof_q_1$write_1__VAL_1;
      MUX_axiM_fifof_q_1$write_1__SEL_2:
	  axiM_fifof_q_1$D_IN = MUX_axiM_fifof_q_0$write_1__VAL_2;
  ...
  // remaining internal signals
  assign length__h3907 = { 4'd0, x__h3971 } ;
  assign wsiS_reqFifo_notFull__1_AND_wsiS_burstKind_6_E_ETC___d53 =
	     wsiS_reqFifo$FULL_N &&
	     (wsiS_burstKind == 2'd0 ||
	      (wsiS_burstKind == 2'd1 || wsiS_burstKind == 2'd2) &&
	      wsiS_wsiReq$wget[57]) ;
  assign x__h3971 = { wsiS_reqFifo$D_OUT[53:44], 2'd0 } ;
  assign x_user__h3955 = { length__h3907, 8'h0, wsiS_reqFifo$D_OUT[7:0] } ;
