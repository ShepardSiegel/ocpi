...
//
// On Tue Jan 10 09:17:13 EST 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkOCDP4B(pciDevice,
  ...
  wire [3 : 0] MUX_tlp_lastRuleFired$write_1__VAL_3,
	       ...
	       MUX_tlp_postSeqDwell$write_1__VAL_3;
  ...
  reg [63 : 0] v__h15540,
	       ...
	       v__h87787,
	       v__h87941;
  reg [31 : 0] IF_0_MINUS_tlp_tlpBRAM_writeDWAddr_54_BITS_1_T_ETC___d2462,
	       IF_1_MINUS_tlp_tlpBRAM_writeDWAddr_54_BITS_1_T_ETC___d2463,
	       IF_2_MINUS_tlp_tlpBRAM_writeDWAddr_54_BITS_1_T_ETC___d2367,
	       IF_3_MINUS_tlp_tlpBRAM_writeDWAddr_54_BITS_1_T_ETC___d2364,
	       IF_tlp_tlpBRAM_readReq_first__93_BITS_30_TO_29_ETC___d2398,
	       _theResult____h87925,
	       rdata__h80765;
  ...
  reg CASE_dpControl_BITS_1_TO_0_NOT_bml_fabDone_0_N_ETC__q6,
      ...
      IF_0_MINUS_tlp_tlpBRAM_writeDWAddr_54_BITS_1_T_ETC___d2420,
      IF_0_MINUS_tlp_tlpBRAM_writeDWAddr_54_BITS_1_T_ETC___d671,
      IF_1_MINUS_tlp_tlpBRAM_writeDWAddr_54_BITS_1_T_ETC___d2419,
      IF_1_MINUS_tlp_tlpBRAM_writeDWAddr_54_BITS_1_T_ETC___d681,
      IF_2_MINUS_tlp_tlpBRAM_writeDWAddr_54_BITS_1_T_ETC___d2417,
      IF_2_MINUS_tlp_tlpBRAM_writeDWAddr_54_BITS_1_T_ETC___d691,
      IF_3_MINUS_tlp_tlpBRAM_writeDWAddr_54_BITS_1_T_ETC___d2418,
      IF_3_MINUS_tlp_tlpBRAM_writeDWAddr_54_BITS_1_T_ETC___d701,
      IF_bml_dpControl_wget__000_BITS_1_TO_0_006_EQ__ETC___d2077,
      IF_tlp_tlpBRAM_readReq_first__93_BITS_30_TO_29_ETC___d908,
      IF_wmi_addr_829_BITS_3_TO_2_830_EQ_0_831_THEN__ETC___d2399,
      IF_wmi_p4B_886_EQ_1_889_THEN_bram_serverAdapte_ETC___d1895;
  wire [127 : 0] IF_tlp_fabMesgAddrMS_176_EQ_0_177_THEN_0_ELSE__ETC___d1448,
		 IF_tlp_fabMetaAddrMS_255_EQ_0_256_THEN_4_ELSE__ETC___d1343,
		 ...
		 w_data__h63292,
		 w_data__h64343;
  wire [31 : 0] bml_fabFlowAddr_039_PLUS_bml_fabFlowSize_040___d2696,
		mesgMeta_opcode__h79046,
		nowLS__h43916,
		nowLS__h60152,
		nowMS__h42973,
		nowMS__h59211,
  ...
  wire [15 : 0] w_be__h46311,
		...
		y__h45330,
		y__h62100;
  wire [12 : 0] spanToNextPage__h45162,
		spanToNextPage__h61402,
		thisRequestLength__h45163,
		thisRequestLength__h61403,
  ...
  wire [9 : 0] y__h17160, y__h25811, y__h29309, y__h45891;
  wire [7 : 0] rreq_tag__h45378, tag__h61678, tagm__h61893;
  wire [6 : 0] lowAddr__h28248;
  wire [3 : 0] lastBE__h45599, lastBE__h61710;
  ...
  wire [1 : 0] ab__h10380,
	       ...
	       idx__h26947,
	       idx__h27320,
	       tlp_tlpBRAM_readReq_first__93_BITS_30_TO_29_95_ETC___d2376;
  wire IF_1_MINUS_tlp_tlpBRAM_writeDWAddr_54_BITS_1_T_ETC___d704,
       IF_tlp_tlpBRAM_readReq_first__93_BITS_30_TO_29_ETC___d917,
       IF_wmi_p4B_886_EQ_0_887_THEN_bram_serverAdapte_ETC___d1900,
       NOT_bml_lclBufDone_024_091_AND_IF_bml_dpContro_ETC___d2104,
       NOT_wmi_wrActive_801_802_OR_NOT_wmi_rdActive_8_ETC___d1811,
       _dfoo5,
       bml_crdBuf_value_982_EQ_bml_crdBuf_modulus_bw__ETC___d2791,
       bml_fabBuf_value_967_EQ_bml_fabBuf_modulus_bw__ETC___d2792,
       bml_lclBufDone_024_AND_IF_bml_dpControl_wget___ETC___d2431,
       bml_lclBuf_value_937_EQ_bml_lclBuf_modulus_bw__ETC___d2809,
       bml_remBuf_value_952_EQ_bml_remBuf_modulus_bw__ETC___d2810,
       bram_serverAdapterA_1_cnt_44_SLT_3___d2385,
       bram_serverAdapterA_2_cnt_62_SLT_3___d2700,
       bram_serverAdapterA_2_outDataCore_notEmpty__38_ETC___d989,
       bram_serverAdapterA_3_cnt_80_SLT_3___d2701,
       bram_serverAdapterA_cnt_6_SLT_3___d2381,
       bram_serverAdapterA_outDataCore_notEmpty_OR_br_ETC___d991,
       bram_serverAdapterB_1_cnt_03_SLT_3___d1751,
       bram_serverAdapterB_1_outData_outData_whas__77_ETC___d1779,
       bram_serverAdapterB_2_cnt_21_SLT_3___d1752,
       bram_serverAdapterB_3_cnt_39_SLT_3___d1753,
       bram_serverAdapterB_cnt_5_SLT_3___d1750,
       hasPull_AND_tlp_dpControl_wget__062_BITS_7_TO__ETC___d1328,
       hasPull_AND_tlp_dpControl_wget__062_BITS_7_TO__ETC___d1369,
       hasPull_AND_tlp_dpControl_wget__062_BITS_7_TO__ETC___d1421,
       hasPull_AND_tlp_dpControl_wget__062_BITS_7_TO__ETC___d1460,
       hasPull_AND_tlp_dpControl_wget__062_BITS_7_TO__ETC___d1480,
       hasPull_AND_tlp_dpControl_wget__062_BITS_7_TO__ETC___d1505,
       hasPush_AND_tlp_dpControl_wget__062_BITS_7_TO__ETC___d1083,
       hasPush_AND_tlp_dpControl_wget__062_BITS_7_TO__ETC___d1156,
       hasPush_AND_tlp_dpControl_wget__062_BITS_7_TO__ETC___d1196,
       hasPush_AND_tlp_dpControl_wget__062_BITS_7_TO__ETC___d1253,
       tlp_dmaPullRemainDWLen_468_ULE_tlp_dmaPullRema_ETC___d2697,
       tlp_dmaPullRemainDWSub_482_ULE_4___d2698,
       tlp_inF_first__354_BITS_63_TO_56_357_EQ_pciDev_ETC___d1367,
       tlp_inF_first__354_BIT_152_545_AND_NOT_tlp_inF_ETC___d1570,
       tlp_outDwRemain_227_ULE_4___d2539,
       tlp_tlpBRAM_mReqF_first__14_BIT_60_98_OR_IF_tl_ETC___d809,
       tlp_tlpBRAM_mReqF_first__14_BIT_63_15_OR_IF_tl_ETC___d630,
       tlp_tlpBRAM_mRespF_first__098_BITS_71_TO_62_19_ETC___d2373,
       tlp_tlpBRAM_rdRespDwRemain_020_ULE_4___d1022,
       tlp_tlpBRAM_readRemainDWLen_42_ULE_4___d843,
       tlp_tlpBRAM_writeRemainDWLen_58_ULE_1___d2369,
       tlp_tlpBRAM_writeRemainDWLen_58_ULE_2___d2370,
       tlp_tlpBRAM_writeRemainDWLen_58_ULE_3___d2371,
       wmi_dpControl_whas__737_AND_bram_serverAdapter_ETC___d1783,
       wmi_wmi_operateD_690_AND_wmi_wmi_peerIsReady_6_ETC___d1865;
  ...
  assign MUX_bml_fabBufsAvail$write_1__VAL_1 =
	     (bml_fabAvail && !bml_remStart) ? x__h86156 : x__h86161 ;
  assign MUX_bml_fabBufsAvail$write_1__VAL_2 =
	     (dpControl[3:2] == 2'd1) ? x__h84913 : 16'd0 ;
  assign MUX_bml_fabFlowAddr$write_1__VAL_1 =
	     bml_fabBuf_value_967_EQ_bml_fabBuf_modulus_bw__ETC___d2792 ?
	       bml_fabFlowBase :
	       bml_fabFlowAddr_039_PLUS_bml_fabFlowSize_040___d2696 ;
  ...
  assign MUX_bml_lclCredit$write_1__VAL_1 =
	     (bml_lclBufDone && !bml_remStart) ? x__h86194 : x__h86199 ;
  ...
  assign MUX_bram_memory$a_put_3__VAL_3 =
	     { IF_0_MINUS_tlp_tlpBRAM_writeDWAddr_54_BITS_1_T_ETC___d2462[7:0],
	       IF_0_MINUS_tlp_tlpBRAM_writeDWAddr_54_BITS_1_T_ETC___d2462[15:8],
	       IF_0_MINUS_tlp_tlpBRAM_writeDWAddr_54_BITS_1_T_ETC___d2462[23:16],
	       IF_0_MINUS_tlp_tlpBRAM_writeDWAddr_54_BITS_1_T_ETC___d2462[31:24] } ;
  ...
  assign MUX_bram_memory_1$a_put_3__VAL_3 =
	     { IF_1_MINUS_tlp_tlpBRAM_writeDWAddr_54_BITS_1_T_ETC___d2463[7:0],
	       IF_1_MINUS_tlp_tlpBRAM_writeDWAddr_54_BITS_1_T_ETC___d2463[15:8],
	       IF_1_MINUS_tlp_tlpBRAM_writeDWAddr_54_BITS_1_T_ETC___d2463[23:16],
	       IF_1_MINUS_tlp_tlpBRAM_writeDWAddr_54_BITS_1_T_ETC___d2463[31:24] } ;
  ...
  assign MUX_bram_memory_2$a_put_3__VAL_3 =
	     { IF_2_MINUS_tlp_tlpBRAM_writeDWAddr_54_BITS_1_T_ETC___d2367[7:0],
	       IF_2_MINUS_tlp_tlpBRAM_writeDWAddr_54_BITS_1_T_ETC___d2367[15:8],
	       IF_2_MINUS_tlp_tlpBRAM_writeDWAddr_54_BITS_1_T_ETC___d2367[23:16],
	       IF_2_MINUS_tlp_tlpBRAM_writeDWAddr_54_BITS_1_T_ETC___d2367[31:24] } ;
  ...
  assign MUX_bram_memory_3$a_put_3__VAL_3 =
	     { IF_3_MINUS_tlp_tlpBRAM_writeDWAddr_54_BITS_1_T_ETC___d2364[7:0],
	       IF_3_MINUS_tlp_tlpBRAM_writeDWAddr_54_BITS_1_T_ETC___d2364[15:8],
	       IF_3_MINUS_tlp_tlpBRAM_writeDWAddr_54_BITS_1_T_ETC___d2364[23:16],
	       IF_3_MINUS_tlp_tlpBRAM_writeDWAddr_54_BITS_1_T_ETC___d2364[31:24] } ;
  ...
  assign MUX_tlp_fabMesgAccu$write_1__VAL_2 = tlp_fabMesgAccu + y__h45944 ;
  assign MUX_tlp_fabMesgAccu$write_1__VAL_3 = tlp_fabMesgAccu + y__h61499 ;
  ...
  assign MUX_tlp_mesgComplReceived$write_1__VAL_2 =
	     tlp_mesgComplReceived + y__h62807 ;
  ...
  assign MUX_tlp_mesgLengthRemainPull$write_1__VAL_3 =
	     tlp_mesgLengthRemainPull - y__h61428 ;
  ...
  assign MUX_tlp_mesgLengthRemainPush$write_1__VAL_3 =
	     tlp_mesgLengthRemainPush - y__h45188 ;
  assign MUX_tlp_outDwRemain$write_1__VAL_1 =
	     tlp_tlpBRAM_mRespF$D_OUT[71:62] - y__h45891 ;
  ...
  assign MUX_tlp_outF$enq_1__VAL_5 =
	     { 9'd386,
	       ...
	       IF_tlp_fabMesgAddrMS_176_EQ_0_177_THEN_0_ELSE__ETC___d1448 } ;
  assign MUX_tlp_outF$enq_1__VAL_6 =
	     (tlp_fabFlowAddrMS == 32'd0) ?
	       { 25'd25362431, w_data__h63292 } :
	       (tlp_sentTail4DWHeader ?
		  153'h082F00001000000000000000000000000000000 :
		  { 25'd16973823, w_data__h64343 }) ;
  ...
  assign MUX_tlp_postSeqDwell$write_1__VAL_3 = tlp_postSeqDwell - 4'd1 ;
  assign MUX_tlp_remMesgAccu$write_1__VAL_2 = tlp_remMesgAccu + y__h45330 ;
  assign MUX_tlp_remMesgAccu$write_1__VAL_3 = tlp_remMesgAccu + y__h62100 ;
  assign MUX_tlp_reqMesgInFlight$write_1__VAL_2 =
	     !tlp_dmaPullRemainDWSub_482_ULE_4___d2698 ||
	     !tlp_dmaPullRemainDWLen_468_ULE_tlp_dmaPullRema_ETC___d2697 ;
  assign MUX_tlp_srcMesgAccu$write_1__VAL_2 = tlp_srcMesgAccu + y__h45282 ;
  ...
  assign MUX_tlp_tlpBRAM_mReqF$enq_1__VAL_3 =
	     { 69'h12AAAAAAAAAAAAAAAA,
	       ...
	       thisRequestLength__h45163[11:2],
	       8'd255,
	       rreq_tag__h45378,
	       3'h2 } ;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, _theResult____h87925 } ;
  ...
  assign MUX_wmi_wmi_respF_q_0$write_1__VAL_1 =
	     (wmi_wmi_respF_c_r == 2'd1) ?
	       MUX_wmi_wmi_respF_q_0$write_1__VAL_2 :
	       wmi_wmi_respF_q_1 ;
  assign MUX_wmi_wmi_respF_q_0$write_1__VAL_2 = { 2'd1, rdata__h80765 } ;
  ...
  assign bram_serverAdapterB_outData_enqData$whas =
	     ...
	     bram_serverAdapterB_s1[0] ;
  assign bram_serverAdapterB_outData_outData$wget = y_avValue__h80601 ;
  ...
  assign bram_serverAdapterB_1_outData_enqData$whas =
	     ...
	     bram_serverAdapterB_1_s1[0] ;
  assign bram_serverAdapterB_1_outData_outData$wget = y_avValue__h80621 ;
  ...
  assign bram_serverAdapterB_2_outData_enqData$whas =
	     ...
	     bram_serverAdapterB_2_s1[0] ;
  assign bram_serverAdapterB_2_outData_outData$wget = y_avValue__h80641 ;
  ...
  assign bram_serverAdapterB_3_outData_enqData$whas =
	     ...
	     bram_serverAdapterB_3_s1[0] ;
  assign bram_serverAdapterB_3_outData_outData$wget = y_avValue__h80661 ;
  ...
  assign tlp_pullTagMatch_1$wget =
	     tagm__h61893 == tlp_inF$D_OUT[47:40] &&
	     tlp_inF_first__354_BITS_63_TO_56_357_EQ_pciDev_ETC___d1367 ;
  ...
  begin
    case (1'b1) // synopsys parallel_case
      WILL_FIRE_RL_tlp_dmaPullRequestFarMesg:
	  tlp_dmaPullRemainDWLen$D_IN = thisRequestLength__h61403[11:2];
      WILL_FIRE_RL_tlp_dmaPullResponseHeader:
  ...
  always@(WILL_FIRE_RL_tlp_dmaPullResponseHeader or
	  tlp_inF$D_OUT or
	  WILL_FIRE_RL_tlp_dmaPullResponseBody or
	  tlp_dmaPullRemainDWSub_482_ULE_4___d2698 or
	  WILL_FIRE_RL_tlp_dmaPullRequestFarMesg)
  begin
    case (1'b1) // synopsys parallel_case
      WILL_FIRE_RL_tlp_dmaPullResponseHeader:
  ...
  assign tlp_outDwRemain$EN =
	     MUX_tlp_outF$enq_1__SEL_1 || WILL_FIRE_RL_tlp_dataXmt_Body ||
	     WILL_FIRE_RL_tlp_dmaPushResponseBody ||
	     WILL_FIRE_RL_tlp_dataXmt_Header ;

  // register tlp_postSeqDwell
  always@(MUX_tlp_fabMeta$write_1__SEL_2 or
	  MUX_tlp_postSeqDwell$write_1__VAL_1 or
	  WILL_FIRE_RL_tlp_dmaXmtDoorbell or
	  tlp_postSeqDwell or MUX_tlp_postSeqDwell$write_1__VAL_3)
  begin
    case (1'b1) // synopsys parallel_case
      MUX_tlp_fabMeta$write_1__SEL_2:
	  tlp_postSeqDwell$D_IN = MUX_tlp_postSeqDwell$write_1__VAL_1;
      WILL_FIRE_RL_tlp_dmaXmtDoorbell:
	  tlp_postSeqDwell$D_IN = MUX_tlp_postSeqDwell$write_1__VAL_1;
      tlp_postSeqDwell != 4'd0:
	  tlp_postSeqDwell$D_IN = MUX_tlp_postSeqDwell$write_1__VAL_3;
      default: tlp_postSeqDwell$D_IN = 4'b1010 /* unspecified value */ ;
    endcase
  end
  ...
  begin
    case (1'b1) // synopsys parallel_case
      ...
      WILL_FIRE_RL_tlp_dmaPullResponseBody:
	  tlp_tlpRcvBusy$D_IN = !tlp_dmaPullRemainDWSub_482_ULE_4___d2698;
  ...
  always@(MUX_tlp_tlpXmtBusy$write_1__SEL_1 or
	  ...
	  MUX_tlp_tlpXmtBusy$write_1__SEL_3 or MUX_tlp_outF$enq_1__SEL_2)
  begin
    case (1'b1) // synopsys parallel_case
      MUX_tlp_tlpXmtBusy$write_1__SEL_1:
      ...
      MUX_tlp_tlpXmtBusy$write_1__SEL_3 || MUX_tlp_outF$enq_1__SEL_2:
  ...
  assign wmi_wmi_sFlagReg$D_IN =
	     { y_avValue__h80621[7:0], y_avValue__h80601[23:0] } ;
  ...
  begin
    case (1'b1) // synopsys parallel_case
      ...
      WILL_FIRE_RL_wmi_doWriteFinalize: bram_memory$DIB = x3__h79006;
  ...
  begin
    case (1'b1) // synopsys parallel_case
      ...
      WILL_FIRE_RL_wmi_doWriteFinalize:
	  bram_memory_1$DIB = mesgMeta_opcode__h79046;
  ...
  assign IF_1_MINUS_tlp_tlpBRAM_writeDWAddr_54_BITS_1_T_ETC___d704 =
	     ...
	     (IF_3_MINUS_tlp_tlpBRAM_writeDWAddr_54_BITS_1_T_ETC___d701 ||
	      bram_serverAdapterA_3_cnt_80_SLT_3___d2701) ;
  assign IF_tlp_fabMesgAddrMS_176_EQ_0_177_THEN_0_ELSE__ETC___d1448 =
	     { (tlp_fabMesgAddrMS == 32'd0) ? 22'd0 : 22'd524288,
	       thisRequestLength__h61403[11:2],
	       pciDevice,
	       tag__h61678,
	       lastBE__h61710,
	       4'd15,
  ...
  assign IF_tlp_fabMetaAddrMS_255_EQ_0_256_THEN_4_ELSE__ETC___d1343 =
  ...
  assign IF_tlp_tlpBRAM_readReq_first__93_BITS_30_TO_29_ETC___d1033 =
	     tlp_tlpBRAM_readReq_first__93_BITS_30_TO_29_95_ETC___d2376[0] ?
	       { bram_serverAdapterA_3_outData_outData$wget[7:0],
		 bram_serverAdapterA_3_outData_outData$wget[15:8],
		 bram_serverAdapterA_3_outData_outData$wget[23:16],
		 bram_serverAdapterA_3_outData_outData$wget[31:24],
  ...
  assign IF_tlp_tlpBRAM_readReq_first__93_BITS_30_TO_29_ETC___d917 =
	     IF_tlp_tlpBRAM_readReq_first__93_BITS_30_TO_29_ETC___d908 &&
	     CASE_tlp_tlpBRAM_readReqD_OUT_BITS_30_TO_29_N_ETC__q17 ;
  assign IF_wmi_p4B_886_EQ_0_887_THEN_bram_serverAdapte_ETC___d1900 =
	     (wmi_p4B == 2'd0) ?
	       (bram_serverAdapterB_outDataCore$EMPTY_N ||
		bram_serverAdapterB_outData_enqData$whas) &&
	       bram_serverAdapterB_outData_outData$whas :
	       IF_wmi_p4B_886_EQ_1_889_THEN_bram_serverAdapte_ETC___d1895 &&
	       CASE_wmi_p4B_NOT_wmi_p4B_EQ_3_OR_bram_serverAd_ETC__q18 ;
  assign NOT_bml_lclBufDone_024_091_AND_IF_bml_dpContro_ETC___d2104 =
	     !bml_lclBufDone &&
	     CASE_dpControl_BITS_1_TO_0_bml_fabDone_0_bml_f_ETC__q2 ;
  assign NOT_wmi_wrActive_801_802_OR_NOT_wmi_rdActive_8_ETC___d1811 =
  ...
  assign ab__h8850 =
	     (MUX_bram_memory_2$b_put_1__SEL_1 ||
	      WILL_FIRE_RL_wmi_reqMetadata) ?
	       2'd0 :
	       2'd2 ;
  assign bml_crdBuf_value_982_EQ_bml_crdBuf_modulus_bw__ETC___d2791 =
	     bml_crdBuf_value == bml_crdBuf_modulus ;
  assign bml_fabBuf_value_967_EQ_bml_fabBuf_modulus_bw__ETC___d2792 =
	     bml_fabBuf_value == bml_fabBuf_modulus ;
  assign bml_fabFlowAddr_039_PLUS_bml_fabFlowSize_040___d2696 =
	     bml_fabFlowAddr + bml_fabFlowSize ;
  assign bml_lclBufDone_024_AND_IF_bml_dpControl_wget___ETC___d2431 =
	     bml_lclBufDone &&
	     CASE_dpControl_BITS_1_TO_0_NOT_bml_fabDone_0_N_ETC__q6 ;
  assign bml_lclBuf_value_937_EQ_bml_lclBuf_modulus_bw__ETC___d2809 =
	     bml_lclBuf_value == bml_lclBuf_modulus ;
  assign bml_remBuf_value_952_EQ_bml_remBuf_modulus_bw__ETC___d2810 =
  ...
  assign bram_serverAdapterA_1_cnt_44_SLT_3___d2385 =
  ...
  assign bram_serverAdapterA_2_cnt_62_SLT_3___d2700 =
  ...
  assign bram_serverAdapterA_3_cnt_80_SLT_3___d2701 =
  ...
  assign bram_serverAdapterA_cnt_6_SLT_3___d2381 =
  ...
  assign bram_serverAdapterB_1_cnt_03_SLT_3___d1751 =
	     (bram_serverAdapterB_1_cnt ^ 3'h4) < 3'd7 ;
  assign bram_serverAdapterB_1_outData_outData_whas__77_ETC___d1779 =
	     bram_serverAdapterB_1_outData_outData$whas &&
	     (bram_serverAdapterB_2_outDataCore$EMPTY_N ||
	      bram_serverAdapterB_2_outData_enqData$whas) &&
	     bram_serverAdapterB_2_outData_outData$whas &&
  ...
  assign bram_serverAdapterB_2_cnt_21_SLT_3___d1752 =
  ...
  assign bram_serverAdapterB_3_cnt_39_SLT_3___d1753 =
  ...
  assign bram_serverAdapterB_cnt_5_SLT_3___d1750 =
	     (bram_serverAdapterB_cnt ^ 3'h4) < 3'd7 ;
  assign byteCount__h28249 = x__h28367 - y__h28368 ;
  assign hasPull_AND_tlp_dpControl_wget__062_BITS_7_TO__ETC___d1328 =
	     ...
	     !tlp_reqMetaBodyInFlight &&
	     !tlp_fabMeta[128] ;
  assign hasPull_AND_tlp_dpControl_wget__062_BITS_7_TO__ETC___d1369 =
	     hasPull && dpControl[7:4] == 4'd0 && dpControl[3:2] == 2'd2 &&
	     dpControl[1:0] == 2'd1 &&
	     tlp_reqMetaInFlight &&
	     !tlp_tlpRcvBusy &&
	     tagm__h61893 == tlp_inF$D_OUT[47:40] &&
	     tlp_inF_first__354_BITS_63_TO_56_357_EQ_pciDev_ETC___d1367 ;
  assign hasPull_AND_tlp_dpControl_wget__062_BITS_7_TO__ETC___d1421 =
	     hasPull && dpControl[7:4] == 4'd0 && dpControl[3:2] == 2'd2 &&
	     dpControl[1:0] == 2'd1 &&
	     tlp_fabMeta[128] &&
  ...
  assign hasPull_AND_tlp_dpControl_wget__062_BITS_7_TO__ETC___d1460 =
	     hasPull && dpControl[7:4] == 4'd0 && dpControl[3:2] == 2'd2 &&
	     dpControl[1:0] == 2'd1 &&
	     tlp_fabMeta[128] &&
	     tlp_reqMesgInFlight &&
  ...
  assign hasPull_AND_tlp_dpControl_wget__062_BITS_7_TO__ETC___d1480 =
	     hasPull && dpControl[7:4] == 4'd0 && dpControl[3:2] == 2'd2 &&
	     dpControl[1:0] == 2'd1 &&
	     tlp_fabMeta[128] &&
	     tlp_reqMesgInFlight &&
	     tlp_gotResponseHeader ;
  assign hasPull_AND_tlp_dpControl_wget__062_BITS_7_TO__ETC___d1505 =
	     hasPull && dpControl[7:4] == 4'd0 && dpControl[3:2] == 2'd2 &&
	     dpControl[1:0] == 2'd1 &&
	     tlp_fabMeta[128] &&
	     tlp_dmaDoTailEvent &&
  ...
  assign hasPush_AND_tlp_dpControl_wget__062_BITS_7_TO__ETC___d1083 =
	     ...
	     !tlp_fabMeta[128] &&
	     tlp_nearBufReady ;
  assign hasPush_AND_tlp_dpControl_wget__062_BITS_7_TO__ETC___d1156 =
	     hasPush && dpControl[7:4] == 4'd0 && dpControl[3:2] == 2'd1 &&
	     dpControl[1:0] == 2'd1 &&
	     tlp_fabMeta[128] &&
	     tlp_fabMeta[127:96] != 32'd0 &&
  ...
  assign hasPush_AND_tlp_dpControl_wget__062_BITS_7_TO__ETC___d1196 =
	     hasPush && dpControl[7:4] == 4'd0 && dpControl[3:2] == 2'd1 &&
	     dpControl[1:0] == 2'd1 &&
	     !tlp_tlpBRAM_mRespF$D_OUT[138] &&
	     ...
	     !tlp_tlpXmtBusy &&
	     tlp_postSeqDwell == 4'd0 ;
  assign hasPush_AND_tlp_dpControl_wget__062_BITS_7_TO__ETC___d1253 =
	     hasPush && dpControl[7:4] == 4'd0 && dpControl[3:2] == 2'd1 &&
	     dpControl[1:0] == 2'd1 &&
	     tlp_fabMeta[128] &&
	     !tlp_tlpXmtBusy &&
  ...
  assign rdat__h88004 = { 16'd0, bml_lclNumBufs } ;
  assign rdat__h88012 = { 16'd0, bml_fabNumBufs } ;
  assign rdat__h88020 = { 16'd0, bml_mesgBase } ;
  assign rdat__h88028 = { 16'd0, bml_metaBase } ;
  assign rdat__h88036 = { 16'd0, bml_mesgSize } ;
  assign rdat__h88044 = { 16'd0, bml_metaSize } ;
  assign rdat__h88052 = { 16'd0, bml_lclBufsCF } ;
  assign rdat__h88073 =
  ...
  assign rdat__h88107 = hasDebugLogic ? wmi_thisMesg : 32'd0 ;
  assign rdat__h88371 = hasDebugLogic ? wmi_lastMesg : 32'd0 ;
  assign rdat__h88421 =
	     hasDebugLogic ? { wmi_reqCount, wmi_wrtCount } : 32'd0 ;
  assign rdat__h88521 = hasDebugLogic ? 32'hDADEBABE : 32'd0 ;
  assign rdat__h88579 = { 24'd0, dpControl } ;
  assign rdat__h88601 = hasDebugLogic ? tlp_flowDiagCount : 32'd0 ;
  assign rdat__h88611 =
	     hasDebugLogic ?
	       { 4'h0,
		 tlp_complTimerCount,
		 ...
		 CASE_tlp_lastRuleFired_10_1_tlp_lastRuleFired__ETC__q1 } :
	       32'd0 ;
  assign rdat__h88733 = hasDebugLogic ? tlp_lastMetaV : 32'd0 ;
  assign rdat__h88854 = hasDebugLogic ? tlp_lastMetaV_1 : 32'd0 ;
  assign rdat__h88883 = hasDebugLogic ? tlp_lastMetaV_2 : 32'd0 ;
  assign rdat__h88912 = hasDebugLogic ? tlp_lastMetaV_3 : 32'd0 ;
  assign rdat__h88941 = hasDebugLogic ? 32'hC0DE0111 : 32'd0 ;
  assign rdata__h33678 =
	     tlp_tlpBRAM_readReq_first__93_BITS_30_TO_29_95_ETC___d2376[1] ?
	       IF_tlp_tlpBRAM_readReq_first__93_BITS_30_TO_29_ETC___d1033 :
	       IF_tlp_tlpBRAM_readReq_first__93_BITS_30_TO_29_ETC___d1038 ;
  assign rreq_tag__h45378 =
	     (y__h45188 == tlp_mesgLengthRemainPush) ? 8'h01 : 8'h0 ;
  assign rresp_data__h28294 =
	     { IF_tlp_tlpBRAM_readReq_first__93_BITS_30_TO_29_ETC___d2398[7:0],
	       IF_tlp_tlpBRAM_readReq_first__93_BITS_30_TO_29_ETC___d2398[15:8],
	       IF_tlp_tlpBRAM_readReq_first__93_BITS_30_TO_29_ETC___d2398[23:16],
	       IF_tlp_tlpBRAM_readReq_first__93_BITS_30_TO_29_ETC___d2398[31:24] } ;
  assign spanToNextPage__h45162 = 13'd4096 - { 1'd0, tlp_srcMesgAccu[11:0] } ;
  assign spanToNextPage__h61402 = 13'd4096 - { 1'd0, tlp_fabMesgAccu[11:0] } ;
  assign tag__h61678 = { 3'd0, tlp_dmaTag } ;
  assign tagm__h61893 = { 3'd0, tlp_dmaReqTag } ;
  assign thisRequestLength__h45163 =
	     (x__h45201[12:0] <= spanToNextPage__h45162) ?
	       x__h45201[12:0] :
	       spanToNextPage__h45162 ;
  assign thisRequestLength__h61403 =
	     (x__h61436[12:0] <= spanToNextPage__h61402) ?
	       x__h61436[12:0] :
	       spanToNextPage__h61402 ;
  assign tlp_dmaPullRemainDWLen_468_ULE_tlp_dmaPullRema_ETC___d2697 =
	     tlp_dmaPullRemainDWLen <= tlp_dmaPullRemainDWSub ;
  assign tlp_dmaPullRemainDWSub_482_ULE_4___d2698 =
	     tlp_dmaPullRemainDWSub <= 10'd4 ;
  assign tlp_inF_first__354_BITS_63_TO_56_357_EQ_pciDev_ETC___d1367 =
	     tlp_inF$D_OUT[63:56] == pciDevice[15:8] &&
	     tlp_inF$D_OUT[55:51] == pciDevice[7:3] &&
	     tlp_inF$D_OUT[50:48] == pciDevice[2:0] ;
  assign tlp_inF_first__354_BIT_152_545_AND_NOT_tlp_inF_ETC___d1570 =
  ...
  assign tlp_outDwRemain_227_ULE_4___d2539 = tlp_outDwRemain <= 10'd4 ;
  ...
  assign tlp_tlpBRAM_mReqF_first__14_BIT_63_15_OR_IF_tl_ETC___d630 =
	     tlp_tlpBRAM_mReqF$D_OUT[63] ||
	     CASE_tlp_tlpBRAM_mReqFD_OUT_BITS_51_TO_50_NOT_ETC__q4 ;
  assign tlp_tlpBRAM_mRespF_first__098_BITS_71_TO_62_19_ETC___d2373 =
	     tlp_tlpBRAM_mRespF$D_OUT[71:62] <= 10'd1 ;
  ...
  assign tlp_tlpBRAM_readRemainDWLen_42_ULE_4___d843 =
	     tlp_tlpBRAM_readRemainDWLen <= 10'd4 ;
  assign tlp_tlpBRAM_readReq_first__93_BITS_30_TO_29_95_ETC___d2376 =
  ...
  assign tlp_tlpBRAM_writeRemainDWLen_58_ULE_1___d2369 =
	     tlp_tlpBRAM_writeRemainDWLen <= 10'd1 ;
  assign tlp_tlpBRAM_writeRemainDWLen_58_ULE_2___d2370 =
	     tlp_tlpBRAM_writeRemainDWLen <= 10'd2 ;
  assign tlp_tlpBRAM_writeRemainDWLen_58_ULE_3___d2371 =
	     tlp_tlpBRAM_writeRemainDWLen <= 10'd3 ;
  assign w_be__h46311 =
	     tlp_outDwRemain_227_ULE_4___d2539 ?
	       CASE_tlp_outDwRemain_BITS_1_TO_0_0xFFF0_0b0_0x_ETC__q3 :
	       16'd65535 ;
  assign w_data__h45572 =
	     { 22'd1048576,
	       tlp_tlpBRAM_mRespF$D_OUT[71:62],
	       pciDevice,
	       8'd0,
  ...
  assign w_data__h50636 =
	     { tlp_fabMeta[103:96],
	       ...
	       tlp_fabMeta[23:16],
	       tlp_fabMeta[31:24] } ;
  assign w_data__h63292 =
	     { 32'd1073741825,
	       pciDevice,
	       16'd15,
	       tlp_fabFlowAddr,
	       32'd16777216 } ;
  assign w_data__h64343 =
	     { 32'd1610612737,
	       pciDevice,
	       16'd15,
	       tlp_fabFlowAddrMS,
	       tlp_fabFlowAddr } ;
  assign wmi_dpControl_whas__737_AND_bram_serverAdapter_ETC___d1783 =
	     (bram_serverAdapterB_outDataCore$EMPTY_N ||
	      bram_serverAdapterB_outData_enqData$whas) &&
	     bram_serverAdapterB_outData_outData$whas &&
	     (bram_serverAdapterB_1_outDataCore$EMPTY_N ||
	      bram_serverAdapterB_1_outData_enqData$whas) &&
	     bram_serverAdapterB_1_outData_outData_whas__77_ETC___d1779 ;
  assign wmi_wmi_operateD_690_AND_wmi_wmi_peerIsReady_6_ETC___d1865 =
	     wmi_wmi_operateD && wmi_wmi_peerIsReady &&
	     bram_serverAdapterB_cnt_5_SLT_3___d1750 &&
	     bram_serverAdapterB_1_cnt_03_SLT_3___d1751 &&
	     bram_serverAdapterB_2_cnt_21_SLT_3___d1752 &&
	     bram_serverAdapterB_3_cnt_39_SLT_3___d1753 &&
	     wmi_wmi_mFlagF$EMPTY_N ;
  assign x3__h79006 = { 8'd0, wmi_wmi_mFlagF$D_OUT[23:0] } ;
  ...
  assign x__h39908 =
	     { tlp_tlpBRAM_mRespF$D_OUT[7:0],
	       ...
	       tlp_tlpBRAM_mRespF$D_OUT[23:16],
	       tlp_tlpBRAM_mRespF$D_OUT[31:24] } ;
  assign x__h44919 = { 15'd0, tlp_mesgLengthRemainPush } ;
  assign x__h45201 =
	     (tlp_mesgLengthRemainPush <= y__h45203) ?
  ...
  assign x__h55963 =
	     { tlp_inF$D_OUT[7:0],
	       ...
	       tlp_inF$D_OUT[23:16],
	       tlp_inF$D_OUT[31:24] } ;
  assign x__h61122 = { 15'd0, tlp_mesgLengthRemainPull } ;
  assign x__h61436 =
	     (tlp_mesgLengthRemainPull <= y__h61438) ?
	       tlp_mesgLengthRemainPull :
	       y__h61438 ;
  assign x__h84913 = (dpControl[1:0] == 2'd1) ? bml_fabNumBufs : 16'd0 ;
  assign x__h86037 = bml_lclBufsAR + 16'd1 ;
  assign x__h86042 = bml_lclBufsAR - 16'd1 ;
  assign x__h86114 = bml_lclBufsCF + 16'd1 ;
  assign x__h86119 = bml_lclBufsCF - 16'd1 ;
  assign x__h86156 = bml_fabBufsAvail + 16'd1 ;
  assign x__h86161 = bml_fabBufsAvail - 16'd1 ;
  assign x__h86194 = bml_lclCredit + 16'd1 ;
  assign x__h86199 = bml_lclCredit - 16'd1 ;
  ...
  assign y__h45188 = { 4'd0, thisRequestLength__h45163 } ;
  assign y__h45203 = { 4'd0, tlp_maxPayloadSize } ;
  assign y__h45282 = { 19'd0, thisRequestLength__h45163 } ;
  assign y__h45330 = { 3'd0, thisRequestLength__h45163 } ;
  assign y__h45891 = (tlp_fabMesgAddrMS == 32'd0) ? 10'd1 : 10'd0 ;
  assign y__h45944 = { 20'd0, tlp_tlpBRAM_mRespF$D_OUT[71:62], 2'd0 } ;
  assign y__h61428 = { 4'd0, thisRequestLength__h61403 } ;
  assign y__h61438 = { 4'd0, tlp_maxReadReqSize } ;
  assign y__h61499 = { 19'd0, thisRequestLength__h61403 } ;
  assign y__h62100 = { 4'd0, tlp_inF$D_OUT[105:96], 2'd0 } ;
  assign y__h62807 =
	     tlp_dmaPullRemainDWSub_482_ULE_4___d2698 ?
  ...
  always@(wmi_p4B or
	  y_avValue__h80661 or
	  y_avValue__h80601 or y_avValue__h80621 or y_avValue__h80641)
  begin
    case (wmi_p4B)
      2'd0: rdata__h80765 = y_avValue__h80601;
      2'd1: rdata__h80765 = y_avValue__h80621;
      2'd2: rdata__h80765 = y_avValue__h80641;
      2'd3: rdata__h80765 = y_avValue__h80661;
    endcase
  end
  ...
  begin
    case (wci_reqF$D_OUT[39:32])
      8'h0: _theResult____h87925 = rdat__h88004;
      8'h04: _theResult____h87925 = rdat__h88012;
      8'h08: _theResult____h87925 = rdat__h88020;
      8'h0C: _theResult____h87925 = rdat__h88028;
      8'h10: _theResult____h87925 = rdat__h88036;
      8'h14: _theResult____h87925 = rdat__h88044;
      8'h20: _theResult____h87925 = rdat__h88052;
      8'h24: _theResult____h87925 = 32'hF00DFACE;
      8'h28: _theResult____h87925 = rdat__h88073;
      8'h2C: _theResult____h87925 = rdat__h88080;
      8'h30: _theResult____h87925 = rdat__h88093;
      8'h34: _theResult____h87925 = rdat__h88100;
      8'h38: _theResult____h87925 = rdat__h88107;
      8'h3C: _theResult____h87925 = rdat__h88371;
      8'h40: _theResult____h87925 = rdat__h88421;
      8'h44: _theResult____h87925 = 32'd0;
      8'h48: _theResult____h87925 = rdat__h88521;
      8'h4C: _theResult____h87925 = 32'h00008000;
      8'h50: _theResult____h87925 = bml_fabMesgBase;
      8'h54: _theResult____h87925 = bml_fabMetaBase;
      8'h58: _theResult____h87925 = bml_fabMesgSize;
      8'h5C: _theResult____h87925 = bml_fabMetaSize;
      8'h60: _theResult____h87925 = bml_fabFlowBase;
      8'h64: _theResult____h87925 = bml_fabFlowSize;
      8'h68: _theResult____h87925 = rdat__h88579;
      8'h6C: _theResult____h87925 = rdat__h88601;
      8'h70: _theResult____h87925 = rdat__h88611;
      8'h80: _theResult____h87925 = rdat__h88733;
      8'h84: _theResult____h87925 = rdat__h88854;
      8'h88: _theResult____h87925 = rdat__h88883;
      8'h8C: _theResult____h87925 = rdat__h88912;
      8'h90: _theResult____h87925 = rdat__h88941;
      8'h94: _theResult____h87925 = bml_fabMesgBaseMS;
      8'h98: _theResult____h87925 = bml_fabMetaBaseMS;
      8'h9C: _theResult____h87925 = bml_fabFlowBaseMS;
      default: _theResult____h87925 = 32'd0;
    endcase
  end
  always@(tlp_tlpBRAM_readReq$D_OUT)
  begin
  ...
  begin
    case (dpControl[1:0])
	  ...
	  IF_bml_dpControl_wget__000_BITS_1_TO_0_006_EQ__ETC___d2077 =
	      bml_remDone;
      default: IF_bml_dpControl_wget__000_BITS_1_TO_0_006_EQ__ETC___d2077 =
		   bml_fabDone;
    endcase
  end
  ...
  always@(idx__h18875 or
	  tlp_tlpBRAM_writeRemainDWLen_58_ULE_3___d2371 or
	  tlp_tlpBRAM_writeRemainDWLen or
	  tlp_tlpBRAM_writeRemainDWLen_58_ULE_1___d2369 or
	  tlp_tlpBRAM_writeRemainDWLen_58_ULE_2___d2370)
  begin
    case (idx__h18875)
      2'd0:
  ...
  always@(tlp_tlpBRAM_mReqF$D_OUT or
	  bram_serverAdapterA_3_cnt_80_SLT_3___d2701 or
	  bram_serverAdapterA_cnt_6_SLT_3___d2381 or
	  bram_serverAdapterA_1_cnt_44_SLT_3___d2385 or
	  bram_serverAdapterA_2_cnt_62_SLT_3___d2700)
  begin
  ...
  always@(wmi_addr or
	  bram_serverAdapterB_3_cnt_39_SLT_3___d1753 or
	  bram_serverAdapterB_cnt_5_SLT_3___d1750 or
	  bram_serverAdapterB_1_cnt_03_SLT_3___d1751 or
	  bram_serverAdapterB_2_cnt_21_SLT_3___d1752)
  begin
    case (wmi_addr[3:2])
      2'd0:
  ...
  begin
    case (idx__h18875)
      2'd0:
	  IF_0_MINUS_tlp_tlpBRAM_writeDWAddr_54_BITS_1_T_ETC___d2462 =
	      tlp_tlpBRAM_mReqF$D_OUT[127:96];
      2'd1:
	  IF_0_MINUS_tlp_tlpBRAM_writeDWAddr_54_BITS_1_T_ETC___d2462 =
	      tlp_tlpBRAM_mReqF$D_OUT[95:64];
  ...
  begin
    case (wmi_p4B)
	  ...
	  IF_wmi_p4B_886_EQ_1_889_THEN_bram_serverAdapte_ETC___d1895 =
	      bram_serverAdapterB_2_outDataCore$EMPTY_N ||
	      bram_serverAdapterB_2_outData_enqData$whas;
      default: IF_wmi_p4B_886_EQ_1_889_THEN_bram_serverAdapte_ETC___d1895 =
		   wmi_p4B != 2'd3 ||
		   bram_serverAdapterB_3_outDataCore$EMPTY_N ||
		   bram_serverAdapterB_3_outData_enqData$whas;
    endcase
  ...
  begin
    ...
    if (RST_N)
      if (MUX_tlp_outF$enq_1__SEL_2)
	$display("[%0d]: %m: dmaXmtMetaHead FPactMesg-Step5/7", v__h47799);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_tlp_dmaXmtTailEvent)
	$display("[%0d]: %m: dmaXmtTailEvent FPactMesg-Step7/7", v__h54205);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_tlp_dmaXmtMetaBody)
	$display("[%0d]: %m: dmaXmtMetaBody FPactMesg-Step6/7", v__h54085);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_tlp_dmaXmtDoorbell)
	$display("[%0d]: %m: dmaXmtDoorbell FC/FPactFlow-Step1/1", v__h54377);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_tlp_dmaPullTailEvent)
	$display("[%0d]: %m: dmaPullTailEvent FPactMesg-Step5/5", v__h63015);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_tlp_dmaTailEventSender)
	$display("[%0d]: %m: dmaTailEventSender - generic", v__h68084);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_tlp_dmaRequestFarMeta)
	$display("[%0d]: %m: dmaRequestFarMeta FCactMesg-Step1/5", v__h54808);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_wci_cfwr && wci_reqF$D_OUT[39:32] == 8'h18)
	$display("[%0d] %m: fabDoneAvail Event", v__h87318);
    if (RST_N)
