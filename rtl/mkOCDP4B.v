...
//
// On Fri Jun 24 15:30:30 EDT 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkOCDP4B(pciDevice,
  ...
  reg [63 : 0] v__h15553,
	       ...
	       v__h75937,
	       v__h76091;
  reg [31 : 0] IF_0_MINUS_tlp_writeDWAddr_156_BITS_1_TO_0_157_ETC___d2231,
	       IF_1_MINUS_tlp_writeDWAddr_156_BITS_1_TO_0_157_ETC___d2232,
	       IF_2_MINUS_tlp_writeDWAddr_156_BITS_1_TO_0_157_ETC___d2233,
	       IF_3_MINUS_tlp_writeDWAddr_156_BITS_1_TO_0_157_ETC___d2234,
	       IF_tlp_readReq_first__390_BITS_30_TO_29_391_EQ_ETC___d2235,
	       _theResult____h76075,
	       rdata__h69280;
  reg [15 : 0] CASE_tlp_outDwRemain_BITS_1_TO_0_0xFFF0_0b0_0x_ETC__q2;
  reg [1 : 0] lowAddr10__h51371, x__h51493, x__h51516;
  reg CASE_dpControl_BITS_1_TO_0_NOT_bml_fabDone_0_N_ETC__q5,
      ...
      CASE_tlp_readReqD_OUT_BITS_30_TO_29_NOT_tlp_r_ETC__q15,
      CASE_wmi_p4B_NOT_wmi_p4B_EQ_3_OR_bram_serverAd_ETC__q16,
      IF_0_MINUS_tlp_writeDWAddr_156_BITS_1_TO_0_157_ETC___d1173,
      IF_0_MINUS_tlp_writeDWAddr_156_BITS_1_TO_0_157_ETC___d2670,
      IF_1_MINUS_tlp_writeDWAddr_156_BITS_1_TO_0_157_ETC___d1183,
      IF_1_MINUS_tlp_writeDWAddr_156_BITS_1_TO_0_157_ETC___d2671,
      IF_2_MINUS_tlp_writeDWAddr_156_BITS_1_TO_0_157_ETC___d1193,
      IF_2_MINUS_tlp_writeDWAddr_156_BITS_1_TO_0_157_ETC___d2672,
      IF_3_MINUS_tlp_writeDWAddr_156_BITS_1_TO_0_157_ETC___d1203,
      IF_3_MINUS_tlp_writeDWAddr_156_BITS_1_TO_0_157_ETC___d2673,
      IF_bml_dpControl_wget__931_BITS_1_TO_0_937_EQ__ETC___d2008,
      IF_tlp_readReq_first__390_BITS_30_TO_29_391_EQ_ETC___d1405,
      IF_wmi_addr_760_BITS_3_TO_2_761_EQ_0_762_THEN__ETC___d2644,
      IF_wmi_p4B_817_EQ_1_820_THEN_bram_serverAdapte_ETC___d1826;
  wire [127 : 0] IF_tlp_readNxtDWAddr_342_BIT_0_519_THEN_bram_s_ETC___d1524,
		 IF_tlp_readNxtDWAddr_342_BIT_0_519_THEN_bram_s_ETC___d1529,
		 pkt__h39814,
		 rdata__h56789,
		 w_data__h25529,
		 w_data__h26516,
		 ...
		 w_data__h36641,
		 w_data__h37957;
  wire [31 : 0] bml_fabFlowAddr_970_PLUS_bml_fabFlowSize_971___d2482,
		mesgMeta_opcode__h67561,
		nowLS__h21885,
		nowLS__h33083,
		nowMS__h21884,
		nowMS__h33082,
  ...
  wire [15 : 0] w_be__h26089,
		...
		y__h25306,
		y__h36967;
  wire [12 : 0] spanToNextPage__h25123,
		spanToNextPage__h36359,
		thisRequestLength__h25124,
		thisRequestLength__h36360,
  ...
  wire [11 : 0] byteCount__h51373, x__h51484, x__h51486, y__h51485, y__h51487;
  wire [9 : 0] x__h25684, x__h36970, x__h37649;
  wire [7 : 0] rreq_tag__h25353, tag__h36635, tagm__h36760;
  wire [6 : 0] lowAddr__h51372;
  wire [3 : 0] lastBE__h25553, lastBE__h36662;
  ...
  wire [1 : 0] ab__h10393,
	       ...
	       idx__h50098,
	       idx__h50471;
  wire IF_1_MINUS_tlp_writeDWAddr_156_BITS_1_TO_0_157_ETC___d1206,
       IF_tlp_readReq_first__390_BITS_30_TO_29_391_EQ_ETC___d1413,
       IF_wmi_p4B_817_EQ_0_818_THEN_bram_serverAdapte_ETC___d1831,
       NOT_bml_lclBufDone_955_022_AND_IF_bml_dpContro_ETC___d2035,
       NOT_tlp_mReqF_first__124_BITS_28_TO_19_301_EQ__ETC___d1315,
       NOT_wmi_wrActive_732_733_OR_NOT_wmi_rdActive_7_ETC___d1742,
       _dfoo5,
       bml_crdBuf_value_913_EQ_bml_crdBuf_modulus_bw__ETC___d2585,
       bml_fabBuf_value_898_EQ_bml_fabBuf_modulus_bw__ETC___d2587,
       bml_lclBufDone_955_AND_IF_bml_dpControl_wget___ETC___d2675,
       bml_lclBuf_value_868_EQ_bml_lclBuf_modulus_bw__ETC___d2584,
       bml_remBuf_value_883_EQ_bml_remBuf_modulus_bw__ETC___d2586,
       bram_serverAdapterA_1_cnt_44_SLT_3___d2486,
       bram_serverAdapterA_1_outDataCore_notEmpty__20_ETC___d1484,
       bram_serverAdapterA_2_cnt_62_SLT_3___d2487,
       bram_serverAdapterA_3_cnt_80_SLT_3___d2488,
       bram_serverAdapterA_3_outDataCore_notEmpty__56_ETC___d1482,
       bram_serverAdapterA_cnt_6_SLT_3___d2485,
       bram_serverAdapterB_1_cnt_03_SLT_3___d1682,
       bram_serverAdapterB_1_outData_outData_whas__70_ETC___d1710,
       bram_serverAdapterB_2_cnt_21_SLT_3___d1683,
       bram_serverAdapterB_3_cnt_39_SLT_3___d1684,
       bram_serverAdapterB_cnt_5_SLT_3___d1681,
       hasPull_AND_tlp_dpControl_wget__34_BITS_3_TO_2_ETC___d1000,
       hasPull_AND_tlp_dpControl_wget__34_BITS_3_TO_2_ETC___d1021,
       hasPull_AND_tlp_dpControl_wget__34_BITS_3_TO_2_ETC___d1048,
       ...
       tlp_dmaPullRemainDWLen_009_ULE_tlp_dmaPullRema_ETC___d2483,
       tlp_dmaPullRemainDWSub_023_ULE_4___d2484,
       tlp_inF_first__00_BITS_63_TO_56_03_EQ_pciDevic_ETC___d913,
       tlp_inF_first__00_BIT_152_058_AND_NOT_tlp_inF__ETC___d1083,
       tlp_mReqF_RDY_deq__123_AND_IF_tlp_mReqF_first__ETC___d1139,
       tlp_mRespF_first__69_BITS_71_TO_62_61_ULE_1___d2616,
       tlp_outDwRemain_86_ULE_4___d2322,
       tlp_rdRespDwRemain_474_ULE_4___d1475,
       tlp_readRemainDWLen_330_ULE_4___d1331,
       tlp_writeRemainDWLen_160_ULE_1___d2618,
       tlp_writeRemainDWLen_160_ULE_2___d2619,
       tlp_writeRemainDWLen_160_ULE_3___d2620,
       wmi_dpControl_whas__668_AND_bram_serverAdapter_ETC___d1714,
       wmi_wmi_operateD_612_AND_wmi_wmi_peerIsReady_6_ETC___d1796;
  ...
  assign WILL_FIRE_RL_tlp_writeData =
	     ...
	     (IF_0_MINUS_tlp_writeDWAddr_156_BITS_1_TO_0_157_ETC___d1173 ||
	      bram_serverAdapterA_cnt_6_SLT_3___d2485) &&
	     IF_1_MINUS_tlp_writeDWAddr_156_BITS_1_TO_0_157_ETC___d1206 &&
  ...
  assign MUX_bml_fabBufsAvail$write_1__VAL_1 =
	     (bml_fabAvail && !bml_remStart) ? x__h74547 : x__h74552 ;
  assign MUX_bml_fabBufsAvail$write_1__VAL_2 =
	     (dpControl[3:2] == 2'd1) ? x__h73304 : 16'd0 ;
  assign MUX_bml_fabFlowAddr$write_1__VAL_1 =
	     bml_fabBuf_value_898_EQ_bml_fabBuf_modulus_bw__ETC___d2587 ?
	       bml_fabFlowBase :
	       bml_fabFlowAddr_970_PLUS_bml_fabFlowSize_971___d2482 ;
  ...
  assign MUX_bml_lclCredit$write_1__VAL_1 =
	     (bml_lclBufDone && !bml_remStart) ? x__h74585 : x__h74590 ;
  ...
  assign MUX_bram_memory$a_put_3__VAL_2 =
	     { IF_0_MINUS_tlp_writeDWAddr_156_BITS_1_TO_0_157_ETC___d2231[7:0],
	       IF_0_MINUS_tlp_writeDWAddr_156_BITS_1_TO_0_157_ETC___d2231[15:8],
	       IF_0_MINUS_tlp_writeDWAddr_156_BITS_1_TO_0_157_ETC___d2231[23:16],
	       IF_0_MINUS_tlp_writeDWAddr_156_BITS_1_TO_0_157_ETC___d2231[31:24] } ;
  assign MUX_bram_memory$b_put_2__VAL_1 =
	     wmi_lclMesgAddr[14:4] + { 1'd0, wmi_addr[13:4] } ;
  always@(idx__h44393 or
	  tlp_writeDWAddr_PLUS_3__q7 or
	  tlp_writeDWAddr or
	  tlp_writeDWAddr_PLUS_1__q8 or tlp_writeDWAddr_PLUS_2__q9)
  begin
  ...
  assign MUX_bram_memory_1$a_put_3__VAL_2 =
	     { IF_1_MINUS_tlp_writeDWAddr_156_BITS_1_TO_0_157_ETC___d2232[7:0],
	       IF_1_MINUS_tlp_writeDWAddr_156_BITS_1_TO_0_157_ETC___d2232[15:8],
	       IF_1_MINUS_tlp_writeDWAddr_156_BITS_1_TO_0_157_ETC___d2232[23:16],
	       IF_1_MINUS_tlp_writeDWAddr_156_BITS_1_TO_0_157_ETC___d2232[31:24] } ;
  always@(idx__h45697 or
	  tlp_writeDWAddr_PLUS_3__q7 or
	  tlp_writeDWAddr or
	  tlp_writeDWAddr_PLUS_1__q8 or tlp_writeDWAddr_PLUS_2__q9)
  begin
  ...
  assign MUX_bram_memory_2$a_put_3__VAL_2 =
	     { IF_2_MINUS_tlp_writeDWAddr_156_BITS_1_TO_0_157_ETC___d2233[7:0],
	       IF_2_MINUS_tlp_writeDWAddr_156_BITS_1_TO_0_157_ETC___d2233[15:8],
	       IF_2_MINUS_tlp_writeDWAddr_156_BITS_1_TO_0_157_ETC___d2233[23:16],
	       IF_2_MINUS_tlp_writeDWAddr_156_BITS_1_TO_0_157_ETC___d2233[31:24] } ;
  always@(idx__h47001 or
	  tlp_writeDWAddr_PLUS_3__q7 or
	  tlp_writeDWAddr or
	  tlp_writeDWAddr_PLUS_1__q8 or tlp_writeDWAddr_PLUS_2__q9)
  begin
  ...
  assign MUX_bram_memory_3$a_put_3__VAL_3 =
	     { IF_3_MINUS_tlp_writeDWAddr_156_BITS_1_TO_0_157_ETC___d2234[7:0],
	       IF_3_MINUS_tlp_writeDWAddr_156_BITS_1_TO_0_157_ETC___d2234[15:8],
	       IF_3_MINUS_tlp_writeDWAddr_156_BITS_1_TO_0_157_ETC___d2234[23:16],
	       IF_3_MINUS_tlp_writeDWAddr_156_BITS_1_TO_0_157_ETC___d2234[31:24] } ;
  ...
  assign MUX_tlp_fabMesgAccu$write_1__VAL_2 = tlp_fabMesgAccu + y__h25681 ;
  assign MUX_tlp_fabMesgAccu$write_1__VAL_3 = tlp_fabMesgAccu + y__h36456 ;
  ...
  assign MUX_tlp_mReqF$enq_1__VAL_3 =
	     { 88'hAAAAAAAAAAAAAAAAAAFFF8,
	       ...
	       thisRequestLength__h25124[11:2],
	       8'd255,
	       rreq_tag__h25353,
	       3'h2 } ;
  ...
  assign MUX_tlp_mesgComplReceived$write_1__VAL_2 =
	     tlp_mesgComplReceived + y__h37646 ;
  ...
  assign MUX_tlp_mesgLengthRemainPull$write_1__VAL_3 =
	     tlp_mesgLengthRemainPull - y__h36385 ;
  ...
  assign MUX_tlp_mesgLengthRemainPush$write_1__VAL_2 =
	     tlp_mesgLengthRemainPush - y__h25164 ;
  ...
  assign MUX_tlp_outF$enq_1__VAL_1 =
	     { 1'd1,
	       ...
	       23'd196607,
	       w_data__h25529 } ;
  assign MUX_tlp_outF$enq_1__VAL_2 = { 25'd16973823, w_data__h26516 } ;
  assign MUX_tlp_outF$enq_1__VAL_3 = { 25'd8585200, w_data__h27586 } ;
  assign MUX_tlp_outF$enq_1__VAL_4 = { 25'd25362416, w_data__h30786 } ;
  assign MUX_tlp_outF$enq_1__VAL_5 = { 25'd25362416, w_data__h36641 } ;
  assign MUX_tlp_outF$enq_1__VAL_6 = { 25'd25296895, w_data__h37957 } ;
  ...
  assign MUX_tlp_remMesgAccu$write_1__VAL_2 = tlp_remMesgAccu + y__h25306 ;
  assign MUX_tlp_remMesgAccu$write_1__VAL_3 = tlp_remMesgAccu + y__h36967 ;
  assign MUX_tlp_reqMesgInFlight$write_1__VAL_2 =
	     !tlp_dmaPullRemainDWSub_023_ULE_4___d2484 ||
	     !tlp_dmaPullRemainDWLen_009_ULE_tlp_dmaPullRema_ETC___d2483 ;
  assign MUX_tlp_srcMesgAccu$write_1__VAL_2 = tlp_srcMesgAccu + y__h25258 ;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, _theResult____h76075 } ;
  ...
  assign MUX_wmi_wmi_respF_q_0$write_1__VAL_1 = { 2'd1, rdata__h69280 } ;
  ...
  assign bram_serverAdapterB_outData_enqData$whas =
	     ...
	     bram_serverAdapterB_s1[0] ;
  assign bram_serverAdapterB_outData_outData$wget = y_avValue__h69116 ;
  ...
  assign bram_serverAdapterB_1_outData_enqData$whas =
	     ...
	     bram_serverAdapterB_1_s1[0] ;
  assign bram_serverAdapterB_1_outData_outData$wget = y_avValue__h69136 ;
  ...
  assign bram_serverAdapterB_2_outData_enqData$whas =
	     ...
	     bram_serverAdapterB_2_s1[0] ;
  assign bram_serverAdapterB_2_outData_outData$wget = y_avValue__h69156 ;
  ...
  assign bram_serverAdapterB_3_outData_enqData$whas =
	     ...
	     bram_serverAdapterB_3_s1[0] ;
  assign bram_serverAdapterB_3_outData_outData$wget = y_avValue__h69176 ;
  ...
  assign tlp_pullTagMatch_1$wget =
	     tagm__h36760 == tlp_inF$D_OUT[47:40] &&
	     tlp_inF_first__00_BITS_63_TO_56_03_EQ_pciDevic_ETC___d913 ;
  ...
  begin
    case (1'b1) // synopsys parallel_case
      WILL_FIRE_RL_tlp_dmaPullRequestFarMesg:
	  tlp_dmaPullRemainDWLen$D_IN = thisRequestLength__h36360[11:2];
      WILL_FIRE_RL_tlp_dmaPullResponseHeader:
  ...
  always@(WILL_FIRE_RL_tlp_dmaPullResponseHeader or
	  tlp_inF$D_OUT or
	  WILL_FIRE_RL_tlp_dmaPullResponseBody or
	  tlp_dmaPullRemainDWSub_023_ULE_4___d2484 or
	  WILL_FIRE_RL_tlp_dmaPullRequestFarMesg)
  begin
    case (1'b1) // synopsys parallel_case
      WILL_FIRE_RL_tlp_dmaPullResponseHeader:
  ...
  begin
    case (1'b1) // synopsys parallel_case
      ...
      WILL_FIRE_RL_tlp_dmaPullResponseBody:
	  tlp_tlpRcvBusy$D_IN = !tlp_dmaPullRemainDWSub_023_ULE_4___d2484;
  ...
  assign wmi_wmi_sFlagReg$D_IN =
	     { y_avValue__h69136[7:0], y_avValue__h69116[23:0] } ;
  ...
  begin
    case (1'b1) // synopsys parallel_case
      ...
      WILL_FIRE_RL_wmi_doWriteFinalize: bram_memory$DIB = x3__h67521;
  ...
  begin
    case (1'b1) // synopsys parallel_case
      ...
      WILL_FIRE_RL_wmi_doWriteFinalize:
	  bram_memory_1$DIB = mesgMeta_opcode__h67561;
  ...
  // remaining internal signals
  assign IF_1_MINUS_tlp_writeDWAddr_156_BITS_1_TO_0_157_ETC___d1206 =
	     (IF_1_MINUS_tlp_writeDWAddr_156_BITS_1_TO_0_157_ETC___d1183 ||
	      bram_serverAdapterA_1_cnt_44_SLT_3___d2486) &&
	     (IF_2_MINUS_tlp_writeDWAddr_156_BITS_1_TO_0_157_ETC___d1193 ||
	      bram_serverAdapterA_2_cnt_62_SLT_3___d2487) &&
	     (IF_3_MINUS_tlp_writeDWAddr_156_BITS_1_TO_0_157_ETC___d1203 ||
	      bram_serverAdapterA_3_cnt_80_SLT_3___d2488) ;
  assign IF_tlp_readNxtDWAddr_342_BIT_0_519_THEN_bram_s_ETC___d1524 =
	     tlp_readNxtDWAddr[0] ?
	       { bram_serverAdapterA_3_outData_outData$wget[7:0],
		 bram_serverAdapterA_3_outData_outData$wget[15:8],
		 bram_serverAdapterA_3_outData_outData$wget[23:16],
		 ...
		 bram_serverAdapterA_1_outData_outData$wget[23:16],
		 bram_serverAdapterA_1_outData_outData$wget[31:24] } ;
  assign IF_tlp_readNxtDWAddr_342_BIT_0_519_THEN_bram_s_ETC___d1529 =
	     tlp_readNxtDWAddr[0] ?
	       { bram_serverAdapterA_1_outData_outData$wget[7:0],
		 bram_serverAdapterA_1_outData_outData$wget[15:8],
		 bram_serverAdapterA_1_outData_outData$wget[23:16],
		 ...
		 bram_serverAdapterA_3_outData_outData$wget[23:16],
		 bram_serverAdapterA_3_outData_outData$wget[31:24] } ;
  assign IF_tlp_readReq_first__390_BITS_30_TO_29_391_EQ_ETC___d1413 =
	     (tlp_readReq$D_OUT[30:29] == 2'd0) ?
	       (bram_serverAdapterA_outDataCore$EMPTY_N ||
		bram_serverAdapterA_outData_enqData$whas) &&
	       bram_serverAdapterA_outData_outData$whas :
	       IF_tlp_readReq_first__390_BITS_30_TO_29_391_EQ_ETC___d1405 &&
	       CASE_tlp_readReqD_OUT_BITS_30_TO_29_NOT_tlp_r_ETC__q15 ;
  assign IF_wmi_p4B_817_EQ_0_818_THEN_bram_serverAdapte_ETC___d1831 =
	     (wmi_p4B == 2'd0) ?
	       (bram_serverAdapterB_outDataCore$EMPTY_N ||
		bram_serverAdapterB_outData_enqData$whas) &&
	       bram_serverAdapterB_outData_outData$whas :
	       IF_wmi_p4B_817_EQ_1_820_THEN_bram_serverAdapte_ETC___d1826 &&
	       CASE_wmi_p4B_NOT_wmi_p4B_EQ_3_OR_bram_serverAd_ETC__q16 ;
  assign NOT_bml_lclBufDone_955_022_AND_IF_bml_dpContro_ETC___d2035 =
	     !bml_lclBufDone &&
	     CASE_dpControl_BITS_1_TO_0_bml_fabDone_0_bml_f_ETC__q1 ;
  assign NOT_tlp_mReqF_first__124_BITS_28_TO_19_301_EQ__ETC___d1315 =
  ...
  assign ab__h8863 =
	     (MUX_bram_memory_2$b_put_1__SEL_1 ||
	      WILL_FIRE_RL_wmi_reqMetadata) ?
	       2'd0 :
	       2'd2 ;
  assign bml_crdBuf_value_913_EQ_bml_crdBuf_modulus_bw__ETC___d2585 =
	     bml_crdBuf_value == bml_crdBuf_modulus ;
  assign bml_fabBuf_value_898_EQ_bml_fabBuf_modulus_bw__ETC___d2587 =
	     bml_fabBuf_value == bml_fabBuf_modulus ;
  assign bml_fabFlowAddr_970_PLUS_bml_fabFlowSize_971___d2482 =
	     bml_fabFlowAddr + bml_fabFlowSize ;
  assign bml_lclBufDone_955_AND_IF_bml_dpControl_wget___ETC___d2675 =
	     bml_lclBufDone &&
	     CASE_dpControl_BITS_1_TO_0_NOT_bml_fabDone_0_N_ETC__q5 ;
  assign bml_lclBuf_value_868_EQ_bml_lclBuf_modulus_bw__ETC___d2584 =
	     bml_lclBuf_value == bml_lclBuf_modulus ;
  assign bml_remBuf_value_883_EQ_bml_remBuf_modulus_bw__ETC___d2586 =
  ...
  assign bram_serverAdapterA_1_outDataCore_notEmpty__20_ETC___d1484 =
	     (bram_serverAdapterA_1_outDataCore$EMPTY_N ||
	      bram_serverAdapterA_1_outData_enqData$whas) &&
	     (bram_serverAdapterA_2_outDataCore$EMPTY_N ||
	      bram_serverAdapterA_2_outData_enqData$whas) &&
  ...
  assign bram_serverAdapterA_3_outDataCore_notEmpty__56_ETC___d1482 =
	     (bram_serverAdapterA_3_outDataCore$EMPTY_N ||
	      bram_serverAdapterA_3_outData_enqData$whas) &&
	     bram_serverAdapterA_outData_outData$whas &&
	     bram_serverAdapterA_1_outData_outData$whas &&
	     bram_serverAdapterA_2_outData_outData$whas &&
	     bram_serverAdapterA_3_outData_outData$whas &&
	     (!tlp_rdRespDwRemain_474_ULE_4___d1475 || tlp_readReq$EMPTY_N) ;
  ...
  assign bram_serverAdapterB_1_cnt_03_SLT_3___d1682 =
	     (bram_serverAdapterB_1_cnt ^ 3'h4) < 3'd7 ;
  assign bram_serverAdapterB_1_outData_outData_whas__70_ETC___d1710 =
	     bram_serverAdapterB_1_outData_outData$whas &&
	     (bram_serverAdapterB_2_outDataCore$EMPTY_N ||
	      bram_serverAdapterB_2_outData_enqData$whas) &&
	     bram_serverAdapterB_2_outData_outData$whas &&
  ...
  assign bram_serverAdapterB_2_cnt_21_SLT_3___d1683 =
  ...
  assign bram_serverAdapterB_3_cnt_39_SLT_3___d1684 =
  ...
  assign bram_serverAdapterB_cnt_5_SLT_3___d1681 =
	     (bram_serverAdapterB_cnt ^ 3'h4) < 3'd7 ;
  assign byteCount__h51373 = x__h51484 - y__h51485 ;
  ...
  assign hasPull_AND_tlp_dpControl_wget__34_BITS_3_TO_2_ETC___d1021 =
	     hasPull && dpControl[3:2] == 2'd2 && dpControl[1:0] == 2'd1 &&
	     tlp_fabMeta[128] &&
	     tlp_reqMesgInFlight &&
	     tlp_gotResponseHeader ;
  assign hasPull_AND_tlp_dpControl_wget__34_BITS_3_TO_2_ETC___d1048 =
	     hasPull && dpControl[3:2] == 2'd2 && dpControl[1:0] == 2'd1 &&
	     tlp_fabMeta[128] &&
	     !tlp_tlpXmtBusy &&
	     tlp_dmaDoTailEvent &&
  ...
  assign hasPush_AND_tlp_dpControl_wget__34_BITS_3_TO_2_ETC___d654 =
	     ...
	     tlp_nearBufReady &&
	     tlp_farBufReady ;
  assign idx__h42162 = 2'd0 - tlp_writeDWAddr[1:0] ;
  assign idx__h44393 = 2'd1 - tlp_writeDWAddr[1:0] ;
  assign idx__h45697 = 2'd2 - tlp_writeDWAddr[1:0] ;
  assign idx__h47001 = 2'd3 - tlp_writeDWAddr[1:0] ;
  assign idx__h49257 = 2'd0 - tlp_readNxtDWAddr[1:0] ;
  assign idx__h49725 = 2'd1 - tlp_readNxtDWAddr[1:0] ;
  assign idx__h50098 = 2'd2 - tlp_readNxtDWAddr[1:0] ;
  assign idx__h50471 = 2'd3 - tlp_readNxtDWAddr[1:0] ;
  assign lastBE__h25553 =
	     tlp_mRespF_first__69_BITS_71_TO_62_61_ULE_1___d2616 ?
	       4'd0 :
	       4'd15 ;
  assign lastBE__h36662 =
	     (thisRequestLength__h36360[11:2] == 10'd1) ? 4'd0 : 4'd15 ;
  assign lowAddr__h51372 = { tlp_readReq$D_OUT[33:29], lowAddr10__h51371 } ;
  assign mesgMeta_opcode__h67561 =
  ...
  assign rdat__h76154 = { 16'd0, bml_lclNumBufs } ;
  assign rdat__h76162 = { 16'd0, bml_fabNumBufs } ;
  assign rdat__h76170 = { 16'd0, bml_mesgBase } ;
  assign rdat__h76178 = { 16'd0, bml_metaBase } ;
  assign rdat__h76186 = { 16'd0, bml_mesgSize } ;
  assign rdat__h76194 = { 16'd0, bml_metaSize } ;
  assign rdat__h76202 = { 16'd0, bml_lclBufsCF } ;
  assign rdat__h76223 = { bml_lclBufsAR, bml_fabBufsAvail } ;
  assign rdat__h76228 = { bml_remBuf_value, bml_lclBuf_value } ;
  assign rdat__h76239 = { bml_lclStarts, bml_lclDones } ;
  assign rdat__h76244 = { bml_remStarts, bml_remDones } ;
  assign rdat__h76561 = { wmi_reqCount, wmi_wrtCount } ;
  assign rdat__h76715 = { 28'd0, dpControl } ;
  assign rdata__h56789 =
	     tlp_readNxtDWAddr[1] ?
	       IF_tlp_readNxtDWAddr_342_BIT_0_519_THEN_bram_s_ETC___d1524 :
	       IF_tlp_readNxtDWAddr_342_BIT_0_519_THEN_bram_s_ETC___d1529 ;
  assign rreq_tag__h25353 =
	     (y__h25164 == tlp_mesgLengthRemainPush) ? 8'h01 : 8'h0 ;
  assign rresp_data__h51415 =
	     { IF_tlp_readReq_first__390_BITS_30_TO_29_391_EQ_ETC___d2235[7:0],
	       IF_tlp_readReq_first__390_BITS_30_TO_29_391_EQ_ETC___d2235[15:8],
	       IF_tlp_readReq_first__390_BITS_30_TO_29_391_EQ_ETC___d2235[23:16],
	       IF_tlp_readReq_first__390_BITS_30_TO_29_391_EQ_ETC___d2235[31:24] } ;
  assign spanToNextPage__h25123 = 13'd4096 - { 1'd0, tlp_srcMesgAccu[11:0] } ;
  assign spanToNextPage__h36359 = 13'd4096 - { 1'd0, tlp_fabMesgAccu[11:0] } ;
  assign tag__h36635 = { 3'd0, tlp_dmaTag } ;
  assign tagm__h36760 = { 3'd0, tlp_dmaReqTag } ;
  assign thisRequestLength__h25124 =
	     (x__h25177[12:0] <= spanToNextPage__h25123) ?
	       x__h25177[12:0] :
	       spanToNextPage__h25123 ;
  assign thisRequestLength__h36360 =
	     (x__h36393[12:0] <= spanToNextPage__h36359) ?
	       x__h36393[12:0] :
	       spanToNextPage__h36359 ;
  assign tlp_dmaPullRemainDWLen_009_ULE_tlp_dmaPullRema_ETC___d2483 =
	     tlp_dmaPullRemainDWLen <= tlp_dmaPullRemainDWSub ;
  assign tlp_dmaPullRemainDWSub_023_ULE_4___d2484 =
	     tlp_dmaPullRemainDWSub <= 10'd4 ;
  ...
  assign tlp_inF_first__00_BIT_152_058_AND_NOT_tlp_inF__ETC___d1083 =
	     tlp_inF$D_OUT[152] && !tlp_inF$D_OUT[110] &&
	     !tlp_inF$D_OUT[125] &&
	     tlp_inF$D_OUT[124:120] == 5'b0 ||
	     !tlp_inF$D_OUT[152] && !tlp_inIgnorePkt ;
  assign tlp_mReqF_RDY_deq__123_AND_IF_tlp_mReqF_first__ETC___d1139 =
	     tlp_mReqF$EMPTY_N &&
	     CASE_tlp_mReqFD_OUT_BITS_51_TO_50_NOT_tlp_mRe_ETC__q3 ;
  assign tlp_mRespF_first__69_BITS_71_TO_62_61_ULE_1___d2616 =
	     tlp_mRespF$D_OUT[71:62] <= 10'd1 ;
  assign tlp_mesgLengthRemainPull_PLUS_3__q14 =
	     tlp_mesgLengthRemainPull + 17'd3 ;
  assign tlp_outDwRemain_86_ULE_4___d2322 = tlp_outDwRemain <= 10'd4 ;
  assign tlp_rdRespDwRemain_474_ULE_4___d1475 = tlp_rdRespDwRemain <= 10'd4 ;
  ...
  assign tlp_readRemainDWLen_330_ULE_4___d1331 =
	     tlp_readRemainDWLen <= 10'd4 ;
  ...
  assign tlp_writeRemainDWLen_160_ULE_1___d2618 =
	     tlp_writeRemainDWLen <= 10'd1 ;
  assign tlp_writeRemainDWLen_160_ULE_2___d2619 =
	     tlp_writeRemainDWLen <= 10'd2 ;
  assign tlp_writeRemainDWLen_160_ULE_3___d2620 =
	     tlp_writeRemainDWLen <= 10'd3 ;
  assign w_be__h26089 =
	     tlp_outDwRemain_86_ULE_4___d2322 ?
	       CASE_tlp_outDwRemain_BITS_1_TO_0_0xFFF0_0b0_0x_ETC__q2 :
	       16'd65535 ;
  assign w_data__h25529 =
	     { 22'd1048580,
	       tlp_mRespF$D_OUT[71:62],
	       pciDevice,
	       8'd0,
  ...
  assign w_data__h30786 =
	     { 32'd4100,
	       ...
	       34'd0 } ;
  assign w_data__h36641 =
	     { 22'd4,
	       thisRequestLength__h36360[11:2],
	       pciDevice,
	       tag__h36635,
	       lastBE__h36662,
	       4'd15,
	       ...
	       34'd0 } ;
  assign w_data__h37957 =
	     { 32'd1073745921,
	       pciDevice,
	       16'd15,
	       tlp_fabFlowAddr,
	       32'd16777216 } ;
  assign wmi_dpControl_whas__668_AND_bram_serverAdapter_ETC___d1714 =
	     (bram_serverAdapterB_outDataCore$EMPTY_N ||
	      bram_serverAdapterB_outData_enqData$whas) &&
	     bram_serverAdapterB_outData_outData$whas &&
	     (bram_serverAdapterB_1_outDataCore$EMPTY_N ||
	      bram_serverAdapterB_1_outData_enqData$whas) &&
	     bram_serverAdapterB_1_outData_outData_whas__70_ETC___d1710 ;
  assign wmi_wmi_operateD_612_AND_wmi_wmi_peerIsReady_6_ETC___d1796 =
	     wmi_wmi_operateD && wmi_wmi_peerIsReady &&
	     bram_serverAdapterB_cnt_5_SLT_3___d1681 &&
	     bram_serverAdapterB_1_cnt_03_SLT_3___d1682 &&
	     bram_serverAdapterB_2_cnt_21_SLT_3___d1683 &&
	     bram_serverAdapterB_3_cnt_39_SLT_3___d1684 &&
	     wmi_wmi_mFlagF$EMPTY_N ;
  assign x3__h67521 = { 8'd0, wmi_wmi_mFlagF$D_OUT[23:0] } ;
  assign x__h21946 = { 15'd0, tlp_mesgLengthRemainPush } ;
  assign x__h25177 =
	     (tlp_mesgLengthRemainPush <= y__h25179) ?
	       tlp_mesgLengthRemainPush :
	       y__h25179 ;
  assign x__h25684 = { tlp_mRespF$D_OUT[69:62], 2'd0 } ;
  assign x__h33113 = { 15'd0, tlp_mesgLengthRemainPull } ;
  assign x__h36393 =
	     (tlp_mesgLengthRemainPull <= y__h36395) ?
	       tlp_mesgLengthRemainPull :
	       y__h36395 ;
  assign x__h36970 = { tlp_inF$D_OUT[103:96], 2'd0 } ;
  assign x__h37649 = { tlp_dmaPullRemainDWSub[7:0], 2'd0 } ;
  assign x__h51484 = x__h51486 - y__h51487 ;
  assign x__h51486 = { tlp_readReq$D_OUT[28:19], 2'b0 } ;
  assign x__h73304 = (dpControl[1:0] == 2'd1) ? bml_fabNumBufs : 16'd0 ;
  assign x__h74428 = bml_lclBufsAR + 16'd1 ;
  assign x__h74433 = bml_lclBufsAR - 16'd1 ;
  assign x__h74505 = bml_lclBufsCF + 16'd1 ;
  assign x__h74510 = bml_lclBufsCF - 16'd1 ;
  assign x__h74547 = bml_fabBufsAvail + 16'd1 ;
  assign x__h74552 = bml_fabBufsAvail - 16'd1 ;
  assign x__h74585 = bml_lclCredit + 16'd1 ;
  assign x__h74590 = bml_lclCredit - 16'd1 ;
  assign y__h25164 = { 4'd0, thisRequestLength__h25124 } ;
  assign y__h25179 = { 4'd0, tlp_maxPayloadSize } ;
  assign y__h25258 = { 19'd0, thisRequestLength__h25124 } ;
  assign y__h25306 = { 3'd0, thisRequestLength__h25124 } ;
  assign y__h25681 = { 22'd0, x__h25684 } ;
  assign y__h36385 = { 4'd0, thisRequestLength__h36360 } ;
  assign y__h36395 = { 4'd0, tlp_maxReadReqSize } ;
  assign y__h36456 = { 19'd0, thisRequestLength__h36360 } ;
  assign y__h36967 = { 6'd0, x__h36970 } ;
  assign y__h37646 =
	     tlp_dmaPullRemainDWSub_023_ULE_4___d2484 ?
	       { 7'd0, x__h37649 } :
	       17'd16 ;
  assign y__h51485 =
	     (tlp_readReq$D_OUT[28:19] == 10'd1) ?
	       12'd0 :
	       { 10'd0, x__h51516 } ;
  assign y__h51487 = { 10'd0, x__h51493 } ;
  assign y_avValue__h69116 =
	     bram_serverAdapterB_outDataCore$EMPTY_N ?
	       bram_serverAdapterB_outDataCore$D_OUT :
	       bram_memory$DOB ;
  assign y_avValue__h69136 =
	     bram_serverAdapterB_1_outDataCore$EMPTY_N ?
	       bram_serverAdapterB_1_outDataCore$D_OUT :
	       bram_memory_1$DOB ;
  assign y_avValue__h69156 =
	     bram_serverAdapterB_2_outDataCore$EMPTY_N ?
	       bram_serverAdapterB_2_outDataCore$D_OUT :
	       bram_memory_2$DOB ;
  assign y_avValue__h69176 =
	     bram_serverAdapterB_3_outDataCore$EMPTY_N ?
	       bram_serverAdapterB_3_outDataCore$D_OUT :
	       bram_memory_3$DOB ;
  ...
  begin
    case (tlp_readReq$D_OUT[18:15])
      4'b1100: x__h51493 = 2'b10;
      4'b1110: x__h51493 = 2'b01;
      4'b1111: x__h51493 = 2'b0;
      default: x__h51493 = 2'b11;
    endcase
  end
  always@(tlp_readReq$D_OUT)
  begin
    case (tlp_readReq$D_OUT[14:11])
      4'b1100: x__h51516 = 2'b10;
      4'b1110: x__h51516 = 2'b01;
      4'b1111: x__h51516 = 2'b0;
      default: x__h51516 = 2'b11;
    endcase
  end
  always@(wmi_p4B or
	  y_avValue__h69176 or
	  y_avValue__h69116 or y_avValue__h69136 or y_avValue__h69156)
  begin
    case (wmi_p4B)
      2'd0: rdata__h69280 = y_avValue__h69116;
      2'd1: rdata__h69280 = y_avValue__h69136;
      2'd2: rdata__h69280 = y_avValue__h69156;
      2'd3: rdata__h69280 = y_avValue__h69176;
    endcase
  end
  always@(tlp_readReq$D_OUT)
  begin
    case (tlp_readReq$D_OUT[18:15])
      4'b1000: lowAddr10__h51371 = 2'b11;
      4'b1100: lowAddr10__h51371 = 2'b10;
      4'b1110: lowAddr10__h51371 = 2'b01;
      default: lowAddr10__h51371 = 2'b0;
    endcase
  end
  always@(wci_reqF$D_OUT or
	  ...
	  bml_fabMesgSize or
	  bml_fabMetaSize or
	  bml_fabFlowBase or bml_fabFlowSize or rdat__h76715)
  begin
    case (wci_reqF$D_OUT[39:32])
      8'h0: _theResult____h76075 = rdat__h76154;
      8'h04: _theResult____h76075 = rdat__h76162;
      8'h08: _theResult____h76075 = rdat__h76170;
      8'h0C: _theResult____h76075 = rdat__h76178;
      8'h10: _theResult____h76075 = rdat__h76186;
      8'h14: _theResult____h76075 = rdat__h76194;
      8'h20: _theResult____h76075 = rdat__h76202;
      8'h24: _theResult____h76075 = 32'hF00DFACE;
      8'h28: _theResult____h76075 = rdat__h76223;
      8'h2C: _theResult____h76075 = rdat__h76228;
      8'h30: _theResult____h76075 = rdat__h76239;
      8'h34: _theResult____h76075 = rdat__h76244;
      8'h38: _theResult____h76075 = wmi_thisMesg;
      8'h3C: _theResult____h76075 = wmi_lastMesg;
      8'h40: _theResult____h76075 = rdat__h76561;
      8'h44: _theResult____h76075 = 32'h0;
      8'h48: _theResult____h76075 = 32'hDADEBABE;
      8'h4C: _theResult____h76075 = 32'h00008000;
      8'h50: _theResult____h76075 = bml_fabMesgBase;
      8'h54: _theResult____h76075 = bml_fabMetaBase;
      8'h58: _theResult____h76075 = bml_fabMesgSize;
      8'h5C: _theResult____h76075 = bml_fabMetaSize;
      8'h60: _theResult____h76075 = bml_fabFlowBase;
      8'h64: _theResult____h76075 = bml_fabFlowSize;
      8'h68: _theResult____h76075 = rdat__h76715;
      default: _theResult____h76075 = 32'd0;
    endcase
  end
  ...
  begin
    case (dpControl[1:0])
	  ...
	  IF_bml_dpControl_wget__931_BITS_1_TO_0_937_EQ__ETC___d2008 =
	      bml_remDone;
      default: IF_bml_dpControl_wget__931_BITS_1_TO_0_937_EQ__ETC___d2008 =
		   bml_fabDone;
    endcase
  end
  ...
  always@(idx__h42162 or
	  tlp_writeRemainDWLen_160_ULE_3___d2620 or
	  tlp_writeRemainDWLen or
	  tlp_writeRemainDWLen_160_ULE_1___d2618 or
	  tlp_writeRemainDWLen_160_ULE_2___d2619)
  begin
    case (idx__h42162)
      2'd0:
  ...
  always@(wmi_addr or
	  bram_serverAdapterB_3_cnt_39_SLT_3___d1684 or
	  bram_serverAdapterB_cnt_5_SLT_3___d1681 or
	  bram_serverAdapterB_1_cnt_03_SLT_3___d1682 or
	  bram_serverAdapterB_2_cnt_21_SLT_3___d1683)
  begin
    case (wmi_addr[3:2])
      2'd0:
  ...
  always@(idx__h42162 or tlp_mReqF$D_OUT)
  begin
    case (idx__h42162)
      2'd0:
	  IF_0_MINUS_tlp_writeDWAddr_156_BITS_1_TO_0_157_ETC___d2231 =
  ...
  always@(idx__h44393 or tlp_mReqF$D_OUT)
  begin
    case (idx__h44393)
      2'd0:
	  IF_1_MINUS_tlp_writeDWAddr_156_BITS_1_TO_0_157_ETC___d2232 =
  ...
  always@(idx__h45697 or tlp_mReqF$D_OUT)
  begin
    case (idx__h45697)
      2'd0:
	  IF_2_MINUS_tlp_writeDWAddr_156_BITS_1_TO_0_157_ETC___d2233 =
  ...
  always@(idx__h47001 or tlp_mReqF$D_OUT)
  begin
    case (idx__h47001)
      2'd0:
	  IF_3_MINUS_tlp_writeDWAddr_156_BITS_1_TO_0_157_ETC___d2234 =
  ...
  begin
    case (tlp_readReq$D_OUT[30:29])
	  ...
	  IF_tlp_readReq_first__390_BITS_30_TO_29_391_EQ_ETC___d1405 =
	      bram_serverAdapterA_2_outDataCore$EMPTY_N ||
	      bram_serverAdapterA_2_outData_enqData$whas;
      default: IF_tlp_readReq_first__390_BITS_30_TO_29_391_EQ_ETC___d1405 =
		   tlp_readReq$D_OUT[30:29] != 2'd3 ||
		   bram_serverAdapterA_3_outDataCore$EMPTY_N ||
		   bram_serverAdapterA_3_outData_enqData$whas;
    endcase
  ...
  begin
    case (tlp_readReq$D_OUT[30:29])
	  ...
	  CASE_tlp_readReqD_OUT_BITS_30_TO_29_NOT_tlp_r_ETC__q15 =
	      bram_serverAdapterA_2_outData_outData$whas;
      default: CASE_tlp_readReqD_OUT_BITS_30_TO_29_NOT_tlp_r_ETC__q15 =
		   tlp_readReq$D_OUT[30:29] != 2'd3 ||
		   bram_serverAdapterA_3_outData_outData$whas;
    endcase
  end
  ...
  begin
    case (wmi_p4B)
	  ...
	  IF_wmi_p4B_817_EQ_1_820_THEN_bram_serverAdapte_ETC___d1826 =
	      bram_serverAdapterB_2_outDataCore$EMPTY_N ||
	      bram_serverAdapterB_2_outData_enqData$whas;
      default: IF_wmi_p4B_817_EQ_1_820_THEN_bram_serverAdapte_ETC___d1826 =
		   wmi_p4B != 2'd3 ||
		   bram_serverAdapterB_3_outDataCore$EMPTY_N ||
		   bram_serverAdapterB_3_outData_enqData$whas;
    endcase
  ...
  begin
    case (wmi_p4B)
	  ...
	  CASE_wmi_p4B_NOT_wmi_p4B_EQ_3_OR_bram_serverAd_ETC__q16 =
	      bram_serverAdapterB_2_outData_outData$whas;
      default: CASE_wmi_p4B_NOT_wmi_p4B_EQ_3_OR_bram_serverAd_ETC__q16 =
		   wmi_p4B != 2'd3 ||
		   bram_serverAdapterB_3_outData_outData$whas;
    endcase
  end
  ...
  begin
    ...
    if (RST_N)
      if (WILL_FIRE_RL_tlp_dmaXmtMetaHead)
	$display("[%0d]: %m: dmaXmtMetaHead FPactMesg-Step5/7", v__h27417);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_tlp_dmaXmtMetaBody)
	$display("[%0d]: %m: dmaXmtMetaBody FPactMesg-Step6/7", v__h30176);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_tlp_dmaXmtTailEvent)
	$display("[%0d]: %m: dmaXmtTailEvent FPactMesg-Step7/7", v__h30362);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_tlp_dmaXmtDoorbell)
	$display("[%0d]: %m: dmaXmtDoorbell FC/FPactFlow-Step1/1", v__h30528);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_tlp_dmaTailEventSender)
	$display("[%0d]: %m: dmaTailEventSender - generic", v__h38832);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_tlp_dmaRequestFarMeta)
	$display("[%0d]: %m: dmaRequestFarMeta FCactMesg-Step1/5", v__h30867);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_tlp_dmaPullTailEvent)
	$display("[%0d]: %m: dmaPullTailEvent FPactMesg-Step5/5", v__h37870);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_wci_cfwr && wci_reqF$D_OUT[39:32] == 8'h18)
	$display("[%0d] %m: fabDoneAvail Event", v__h75563);
    if (RST_N)
