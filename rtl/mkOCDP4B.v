...
//
// On Tue Nov 29 12:00:09 EST 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkOCDP4B(pciDevice,
  ...
  wire [9 : 0] bml_dpControl$wget, tlp_dpControl$wget, wmi_dpControl$wget;
  ...
  reg [63 : 0] v__h15540,
	       ...
	       v__h79475,
	       v__h79629;
  reg [31 : 0] IF_0_MINUS_tlp_writeDWAddr_172_BITS_1_TO_0_173_ETC___d2414,
	       IF_1_MINUS_tlp_writeDWAddr_172_BITS_1_TO_0_173_ETC___d2415,
	       IF_2_MINUS_tlp_writeDWAddr_172_BITS_1_TO_0_173_ETC___d2416,
	       IF_3_MINUS_tlp_writeDWAddr_172_BITS_1_TO_0_173_ETC___d2417,
	       IF_tlp_readReq_first__406_BITS_30_TO_29_407_EQ_ETC___d2418,
	       _theResult____h79613,
	       rdata__h72286;
  ...
  reg [1 : 0] lowAddr10__h54393, x__h54515, x__h54538;
  reg CASE_dpControl_BITS_1_TO_0_NOT_bml_fabDone_0_N_ETC__q6,
      ...
      IF_0_MINUS_tlp_writeDWAddr_172_BITS_1_TO_0_173_ETC___d1189,
      IF_0_MINUS_tlp_writeDWAddr_172_BITS_1_TO_0_173_ETC___d2378,
      IF_1_MINUS_tlp_writeDWAddr_172_BITS_1_TO_0_173_ETC___d1199,
      IF_1_MINUS_tlp_writeDWAddr_172_BITS_1_TO_0_173_ETC___d2379,
      IF_2_MINUS_tlp_writeDWAddr_172_BITS_1_TO_0_173_ETC___d1209,
      IF_2_MINUS_tlp_writeDWAddr_172_BITS_1_TO_0_173_ETC___d2381,
      IF_3_MINUS_tlp_writeDWAddr_172_BITS_1_TO_0_173_ETC___d1219,
      IF_3_MINUS_tlp_writeDWAddr_172_BITS_1_TO_0_173_ETC___d2380,
      IF_bml_dpControl_wget__939_BITS_1_TO_0_945_EQ__ETC___d2016,
      IF_tlp_readReq_first__406_BITS_30_TO_29_407_EQ_ETC___d1421,
      IF_wmi_addr_768_BITS_3_TO_2_769_EQ_0_770_THEN__ETC___d2355,
      IF_wmi_p4B_825_EQ_1_828_THEN_bram_serverAdapte_ETC___d1834;
  wire [127 : 0] IF_tlp_readReq_first__406_BITS_30_TO_29_407_PL_ETC___d1541,
		 IF_tlp_readReq_first__406_BITS_30_TO_29_407_PL_ETC___d1546,
		 pkt__h42836,
		 rdata__h59812,
		 w_data__h27202,
		 w_data__h28183,
		 ...
		 w_data__h39419,
		 w_data__h40934;
  wire [31 : 0] bml_fabFlowAddr_978_PLUS_bml_fabFlowSize_979___d2607,
		mesgMeta_opcode__h70567,
		nowLS__h25555,
		nowLS__h37887,
		nowMS__h24612,
		nowMS__h36946,
  ...
  wire [15 : 0] w_be__h27752,
		...
		y__h26969,
		y__h39797;
  wire [12 : 0] spanToNextPage__h26801,
		spanToNextPage__h39137,
		thisRequestLength__h26802,
		thisRequestLength__h39138,
  ...
  wire [11 : 0] byteCount__h54395, x__h54506, x__h54508, y__h54507, y__h54509;
  wire [7 : 0] rreq_tag__h27016, tag__h39413, tagm__h39590;
  wire [6 : 0] lowAddr__h54394;
  wire [3 : 0] lastBE__h27226, lastBE__h39440;
  ...
  wire [1 : 0] ab__h10380,
	       ...
	       idx__h53120,
	       idx__h53493,
	       tlp_readReq_first__406_BITS_30_TO_29_407_PLUS_1___d2312;
  wire IF_1_MINUS_tlp_writeDWAddr_172_BITS_1_TO_0_173_ETC___d1222,
       IF_tlp_readReq_first__406_BITS_30_TO_29_407_EQ_ETC___d1429,
       IF_wmi_p4B_825_EQ_0_826_THEN_bram_serverAdapte_ETC___d1839,
       NOT_bml_lclBufDone_963_030_AND_IF_bml_dpContro_ETC___d2043,
       NOT_tlp_mReqF_first__140_BITS_28_TO_19_317_EQ__ETC___d1331,
       NOT_wmi_wrActive_740_741_OR_NOT_wmi_rdActive_7_ETC___d1750,
       _dfoo5,
       bml_crdBuf_value_921_EQ_bml_crdBuf_modulus_bw__ETC___d2704,
       bml_fabBuf_value_906_EQ_bml_fabBuf_modulus_bw__ETC___d2705,
       bml_lclBufDone_963_AND_IF_bml_dpControl_wget___ETC___d2384,
       bml_lclBuf_value_876_EQ_bml_lclBuf_modulus_bw__ETC___d2722,
       bml_remBuf_value_891_EQ_bml_remBuf_modulus_bw__ETC___d2723,
       bram_serverAdapterA_1_cnt_44_SLT_3___d2612,
       bram_serverAdapterA_1_outDataCore_notEmpty__20_ETC___d1500,
       bram_serverAdapterA_2_cnt_62_SLT_3___d2613,
       bram_serverAdapterA_3_cnt_80_SLT_3___d2614,
       bram_serverAdapterA_3_outDataCore_notEmpty__56_ETC___d1498,
       bram_serverAdapterA_cnt_6_SLT_3___d2611,
       bram_serverAdapterB_1_cnt_03_SLT_3___d1690,
       bram_serverAdapterB_1_outData_outData_whas__71_ETC___d1718,
       bram_serverAdapterB_2_cnt_21_SLT_3___d1691,
       bram_serverAdapterB_3_cnt_39_SLT_3___d1692,
       bram_serverAdapterB_cnt_5_SLT_3___d1689,
       hasPull_AND_NOT_tlp_dpControl_wget__34_BIT_9_3_ETC___d1011,
       hasPull_AND_NOT_tlp_dpControl_wget__34_BIT_9_3_ETC___d1031,
       hasPull_AND_NOT_tlp_dpControl_wget__34_BIT_9_3_ETC___d1056,
       hasPull_AND_NOT_tlp_dpControl_wget__34_BIT_9_3_ETC___d890,
       hasPull_AND_NOT_tlp_dpControl_wget__34_BIT_9_3_ETC___d927,
       hasPull_AND_NOT_tlp_dpControl_wget__34_BIT_9_3_ETC___d978,
       hasPush_AND_NOT_tlp_dpControl_wget__34_BIT_9_3_ETC___d661,
       hasPush_AND_NOT_tlp_dpControl_wget__34_BIT_9_3_ETC___d736,
       hasPush_AND_NOT_tlp_dpControl_wget__34_BIT_9_3_ETC___d773,
       hasPush_AND_NOT_tlp_dpControl_wget__34_BIT_9_3_ETC___d824,
       hasPush_AND_NOT_tlp_dpControl_wget__34_BIT_9_3_ETC___d839,
       hasPush_AND_NOT_tlp_dpControl_wget__34_BIT_9_3_ETC___d865,
       tlp_dmaPullRemainDWLen_019_ULE_tlp_dmaPullRema_ETC___d2608,
       tlp_dmaPullRemainDWSub_033_ULE_4___d2609,
       tlp_inF_first__12_BITS_63_TO_56_15_EQ_pciDevic_ETC___d925,
       tlp_inF_first__12_BIT_152_074_AND_NOT_tlp_inF__ETC___d1099,
       tlp_mReqF_RDY_first__139_AND_IF_tlp_mReqF_firs_ETC___d1155,
       tlp_mRespF_first__78_BITS_71_TO_62_75_ULE_1___d2315,
       tlp_outDwRemain_98_ULE_4___d2482,
       tlp_rdRespDwRemain_490_ULE_4___d1491,
       tlp_readRemainDWLen_346_ULE_4___d1347,
       tlp_writeRemainDWLen_176_ULE_1___d2317,
       tlp_writeRemainDWLen_176_ULE_2___d2316,
       tlp_writeRemainDWLen_176_ULE_3___d2318,
       wmi_dpControl_whas__676_AND_bram_serverAdapter_ETC___d1722,
       wmi_wmi_operateD_629_AND_wmi_wmi_peerIsReady_6_ETC___d1804;
  ...
  assign WILL_FIRE_RL_tlp_dmaResponseNearMetaHead =
	     tlp_mRespF$EMPTY_N && hasPush && !dpControl[9] &&
	     !dpControl[8] &&
	     dpControl[7:4] == 4'd0 &&
	     dpControl[3:2] == 2'd1 &&
	     dpControl[1:0] == 2'd1 &&
  ...
  assign WILL_FIRE_RL_tlp_writeData =
	     ...
	     (IF_0_MINUS_tlp_writeDWAddr_172_BITS_1_TO_0_173_ETC___d1189 ||
	      bram_serverAdapterA_cnt_6_SLT_3___d2611) &&
	     IF_1_MINUS_tlp_writeDWAddr_172_BITS_1_TO_0_173_ETC___d1222 &&
  ...
  assign MUX_bml_fabBufsAvail$write_1__VAL_1 =
	     (bml_fabAvail && !bml_remStart) ? x__h77805 : x__h77810 ;
  assign MUX_bml_fabBufsAvail$write_1__VAL_2 =
	     (dpControl[3:2] == 2'd1) ? x__h76562 : 16'd0 ;
  assign MUX_bml_fabFlowAddr$write_1__VAL_1 =
	     bml_fabBuf_value_906_EQ_bml_fabBuf_modulus_bw__ETC___d2705 ?
	       bml_fabFlowBase :
	       bml_fabFlowAddr_978_PLUS_bml_fabFlowSize_979___d2607 ;
  ...
  assign MUX_bml_lclCredit$write_1__VAL_1 =
	     (bml_lclBufDone && !bml_remStart) ? x__h77843 : x__h77848 ;
  ...
  assign MUX_bram_memory$a_put_3__VAL_3 =
	     { IF_0_MINUS_tlp_writeDWAddr_172_BITS_1_TO_0_173_ETC___d2414[7:0],
	       IF_0_MINUS_tlp_writeDWAddr_172_BITS_1_TO_0_173_ETC___d2414[15:8],
	       IF_0_MINUS_tlp_writeDWAddr_172_BITS_1_TO_0_173_ETC___d2414[23:16],
	       IF_0_MINUS_tlp_writeDWAddr_172_BITS_1_TO_0_173_ETC___d2414[31:24] } ;
  assign MUX_bram_memory$b_put_2__VAL_1 =
	     wmi_lclMesgAddr[14:4] + { 1'd0, wmi_addr[13:4] } ;
  always@(idx__h47415 or
	  tlp_writeDWAddr_PLUS_3__q8 or
	  tlp_writeDWAddr or
	  tlp_writeDWAddr_PLUS_1__q9 or tlp_writeDWAddr_PLUS_2__q10)
  begin
  ...
  assign MUX_bram_memory_1$a_put_3__VAL_3 =
	     { IF_1_MINUS_tlp_writeDWAddr_172_BITS_1_TO_0_173_ETC___d2415[7:0],
	       IF_1_MINUS_tlp_writeDWAddr_172_BITS_1_TO_0_173_ETC___d2415[15:8],
	       IF_1_MINUS_tlp_writeDWAddr_172_BITS_1_TO_0_173_ETC___d2415[23:16],
	       IF_1_MINUS_tlp_writeDWAddr_172_BITS_1_TO_0_173_ETC___d2415[31:24] } ;
  always@(idx__h48719 or
	  tlp_writeDWAddr_PLUS_3__q8 or
	  tlp_writeDWAddr or
	  tlp_writeDWAddr_PLUS_1__q9 or tlp_writeDWAddr_PLUS_2__q10)
  begin
  ...
  assign MUX_bram_memory_2$a_put_3__VAL_3 =
	     { IF_2_MINUS_tlp_writeDWAddr_172_BITS_1_TO_0_173_ETC___d2416[7:0],
	       IF_2_MINUS_tlp_writeDWAddr_172_BITS_1_TO_0_173_ETC___d2416[15:8],
	       IF_2_MINUS_tlp_writeDWAddr_172_BITS_1_TO_0_173_ETC___d2416[23:16],
	       IF_2_MINUS_tlp_writeDWAddr_172_BITS_1_TO_0_173_ETC___d2416[31:24] } ;
  always@(idx__h50023 or
	  tlp_writeDWAddr_PLUS_3__q8 or
	  tlp_writeDWAddr or
	  tlp_writeDWAddr_PLUS_1__q9 or tlp_writeDWAddr_PLUS_2__q10)
  begin
  ...
  assign MUX_bram_memory_3$a_put_3__VAL_3 =
	     { IF_3_MINUS_tlp_writeDWAddr_172_BITS_1_TO_0_173_ETC___d2417[7:0],
	       IF_3_MINUS_tlp_writeDWAddr_172_BITS_1_TO_0_173_ETC___d2417[15:8],
	       IF_3_MINUS_tlp_writeDWAddr_172_BITS_1_TO_0_173_ETC___d2417[23:16],
	       IF_3_MINUS_tlp_writeDWAddr_172_BITS_1_TO_0_173_ETC___d2417[31:24] } ;
  ...
  assign MUX_tlp_fabMesgAccu$write_1__VAL_2 = tlp_fabMesgAccu + y__h27354 ;
  assign MUX_tlp_fabMesgAccu$write_1__VAL_3 = tlp_fabMesgAccu + y__h39234 ;
  ...
  assign MUX_tlp_mReqF$enq_1__VAL_3 =
	     { 88'hAAAAAAAAAAAAAAAAAAFFF8,
	       ...
	       thisRequestLength__h26802[11:2],
	       8'd255,
	       rreq_tag__h27016,
	       3'h2 } ;
  ...
  assign MUX_tlp_mesgComplReceived$write_1__VAL_2 =
	     tlp_mesgComplReceived + y__h40502 ;
  ...
  assign MUX_tlp_mesgLengthRemainPull$write_1__VAL_3 =
	     tlp_mesgLengthRemainPull - y__h39163 ;
  ...
  assign MUX_tlp_mesgLengthRemainPush$write_1__VAL_3 =
	     tlp_mesgLengthRemainPush - y__h26827 ;
  ...
  assign MUX_tlp_outF$enq_1__VAL_1 =
	     { 1'd1,
	       ...
	       23'd196607,
	       w_data__h27202 } ;
  assign MUX_tlp_outF$enq_1__VAL_2 = { 25'd16973823, w_data__h28183 } ;
  assign MUX_tlp_outF$enq_1__VAL_3 = { 25'd8585200, w_data__h29253 } ;
  assign MUX_tlp_outF$enq_1__VAL_4 = { 25'd25362416, w_data__h32412 } ;
  assign MUX_tlp_outF$enq_1__VAL_5 = { 25'd25362416, w_data__h39419 } ;
  assign MUX_tlp_outF$enq_1__VAL_6 = { 25'd25296895, w_data__h40934 } ;
  ...
  assign MUX_tlp_remMesgAccu$write_1__VAL_2 = tlp_remMesgAccu + y__h26969 ;
  assign MUX_tlp_remMesgAccu$write_1__VAL_3 = tlp_remMesgAccu + y__h39797 ;
  assign MUX_tlp_reqMesgInFlight$write_1__VAL_2 =
	     !tlp_dmaPullRemainDWSub_033_ULE_4___d2609 ||
	     !tlp_dmaPullRemainDWLen_019_ULE_tlp_dmaPullRema_ETC___d2608 ;
  assign MUX_tlp_srcMesgAccu$write_1__VAL_2 = tlp_srcMesgAccu + y__h26921 ;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, _theResult____h79613 } ;
  ...
  assign MUX_wmi_wmi_respF_q_0$write_1__VAL_1 =
	     (wmi_wmi_respF_c_r == 2'd1) ?
	       MUX_wmi_wmi_respF_q_0$write_1__VAL_2 :
	       wmi_wmi_respF_q_1 ;
  assign MUX_wmi_wmi_respF_q_0$write_1__VAL_2 = { 2'd1, rdata__h72286 } ;
  ...
  assign bram_serverAdapterB_outData_enqData$whas =
	     ...
	     bram_serverAdapterB_s1[0] ;
  assign bram_serverAdapterB_outData_outData$wget = y_avValue__h72122 ;
  ...
  assign bram_serverAdapterB_1_outData_enqData$whas =
	     ...
	     bram_serverAdapterB_1_s1[0] ;
  assign bram_serverAdapterB_1_outData_outData$wget = y_avValue__h72142 ;
  ...
  assign bram_serverAdapterB_2_outData_enqData$whas =
	     ...
	     bram_serverAdapterB_2_s1[0] ;
  assign bram_serverAdapterB_2_outData_outData$wget = y_avValue__h72162 ;
  ...
  assign bram_serverAdapterB_3_outData_enqData$whas =
	     ...
	     bram_serverAdapterB_3_s1[0] ;
  assign bram_serverAdapterB_3_outData_outData$wget = y_avValue__h72182 ;
  ...
  assign tlp_pullTagMatch_1$wget =
	     tagm__h39590 == tlp_inF$D_OUT[47:40] &&
	     tlp_inF_first__12_BITS_63_TO_56_15_EQ_pciDevic_ETC___d925 ;
  assign tlp_pullTagMatch_1$whas =
	     tlp_inF$EMPTY_N && hasPull && !dpControl[9] && !dpControl[8] &&
	     dpControl[7:4] == 4'd0 &&
	     dpControl[3:2] == 2'd2 &&
	     dpControl[1:0] == 2'd1 ;
  ...
  // register dpControl
  assign dpControl$D_IN = wci_reqF$D_OUT[9:0] ;
  assign dpControl$EN =
  ...
  begin
    case (1'b1) // synopsys parallel_case
      WILL_FIRE_RL_tlp_dmaPullRequestFarMesg:
	  tlp_dmaPullRemainDWLen$D_IN = thisRequestLength__h39138[11:2];
      WILL_FIRE_RL_tlp_dmaPullResponseHeader:
  ...
  always@(WILL_FIRE_RL_tlp_dmaPullResponseHeader or
	  tlp_inF$D_OUT or
	  WILL_FIRE_RL_tlp_dmaPullResponseBody or
	  tlp_dmaPullRemainDWSub_033_ULE_4___d2609 or
	  WILL_FIRE_RL_tlp_dmaPullRequestFarMesg)
  begin
    case (1'b1) // synopsys parallel_case
      WILL_FIRE_RL_tlp_dmaPullResponseHeader:
  ...
  begin
    case (1'b1) // synopsys parallel_case
      ...
      WILL_FIRE_RL_tlp_dmaPullResponseBody:
	  tlp_tlpRcvBusy$D_IN = !tlp_dmaPullRemainDWSub_033_ULE_4___d2609;
  ...
  always@(WILL_FIRE_RL_tlp_dmaResponseNearMetaBody or
	  ...
	  MUX_tlp_outF$enq_1__SEL_2 or MUX_tlp_xmtMetaOK$write_1__SEL_4)
  case (1'b1)
    WILL_FIRE_RL_tlp_dmaResponseNearMetaBody:
  ...
  assign wmi_wmi_sFlagReg$D_IN =
	     { y_avValue__h72142[7:0], y_avValue__h72122[23:0] } ;
  ...
  begin
    case (1'b1) // synopsys parallel_case
      ...
      WILL_FIRE_RL_wmi_doWriteFinalize: bram_memory$DIB = x3__h70527;
  ...
  begin
    case (1'b1) // synopsys parallel_case
      ...
      WILL_FIRE_RL_wmi_doWriteFinalize:
	  bram_memory_1$DIB = mesgMeta_opcode__h70567;
  ...
  // remaining internal signals
  assign IF_1_MINUS_tlp_writeDWAddr_172_BITS_1_TO_0_173_ETC___d1222 =
	     (IF_1_MINUS_tlp_writeDWAddr_172_BITS_1_TO_0_173_ETC___d1199 ||
	      bram_serverAdapterA_1_cnt_44_SLT_3___d2612) &&
	     (IF_2_MINUS_tlp_writeDWAddr_172_BITS_1_TO_0_173_ETC___d1209 ||
	      bram_serverAdapterA_2_cnt_62_SLT_3___d2613) &&
	     (IF_3_MINUS_tlp_writeDWAddr_172_BITS_1_TO_0_173_ETC___d1219 ||
	      bram_serverAdapterA_3_cnt_80_SLT_3___d2614) ;
  assign IF_tlp_readReq_first__406_BITS_30_TO_29_407_EQ_ETC___d1429 =
	     (tlp_readReq$D_OUT[30:29] == 2'd0) ?
	       (bram_serverAdapterA_outDataCore$EMPTY_N ||
		bram_serverAdapterA_outData_enqData$whas) &&
	       bram_serverAdapterA_outData_outData$whas :
	       IF_tlp_readReq_first__406_BITS_30_TO_29_407_EQ_ETC___d1421 &&
	       CASE_tlp_readReqD_OUT_BITS_30_TO_29_NOT_tlp_r_ETC__q17 ;
  assign IF_tlp_readReq_first__406_BITS_30_TO_29_407_PL_ETC___d1541 =
	     tlp_readReq_first__406_BITS_30_TO_29_407_PLUS_1___d2312[0] ?
	       { bram_serverAdapterA_3_outData_outData$wget[7:0],
		 bram_serverAdapterA_3_outData_outData$wget[15:8],
		 bram_serverAdapterA_3_outData_outData$wget[23:16],
		 bram_serverAdapterA_3_outData_outData$wget[31:24],
		 ...
		 bram_serverAdapterA_1_outData_outData$wget[23:16],
		 bram_serverAdapterA_1_outData_outData$wget[31:24] } ;
  assign IF_tlp_readReq_first__406_BITS_30_TO_29_407_PL_ETC___d1546 =
	     tlp_readReq_first__406_BITS_30_TO_29_407_PLUS_1___d2312[0] ?
	       { bram_serverAdapterA_1_outData_outData$wget[7:0],
		 bram_serverAdapterA_1_outData_outData$wget[15:8],
		 bram_serverAdapterA_1_outData_outData$wget[23:16],
		 ...
		 bram_serverAdapterA_3_outData_outData$wget[23:16],
		 bram_serverAdapterA_3_outData_outData$wget[31:24] } ;
  assign IF_wmi_p4B_825_EQ_0_826_THEN_bram_serverAdapte_ETC___d1839 =
	     (wmi_p4B == 2'd0) ?
	       (bram_serverAdapterB_outDataCore$EMPTY_N ||
		bram_serverAdapterB_outData_enqData$whas) &&
	       bram_serverAdapterB_outData_outData$whas :
	       IF_wmi_p4B_825_EQ_1_828_THEN_bram_serverAdapte_ETC___d1834 &&
	       CASE_wmi_p4B_NOT_wmi_p4B_EQ_3_OR_bram_serverAd_ETC__q18 ;
  assign NOT_bml_lclBufDone_963_030_AND_IF_bml_dpContro_ETC___d2043 =
	     !bml_lclBufDone &&
	     CASE_dpControl_BITS_1_TO_0_bml_fabDone_0_bml_f_ETC__q2 ;
  assign NOT_tlp_mReqF_first__140_BITS_28_TO_19_317_EQ__ETC___d1331 =
	     (tlp_mReqF$D_OUT[28:19] != 10'd1 || tlp_mReqF$EMPTY_N) &&
	     CASE_tlp_mReqFD_OUT_BITS_30_TO_29_NOT_tlp_mRe_ETC__q5 ;
  assign NOT_wmi_wrActive_740_741_OR_NOT_wmi_rdActive_7_ETC___d1750 =
  ...
  assign ab__h8850 =
	     (MUX_bram_memory_2$b_put_1__SEL_1 ||
	      WILL_FIRE_RL_wmi_reqMetadata) ?
	       2'd0 :
	       2'd2 ;
  assign bml_crdBuf_value_921_EQ_bml_crdBuf_modulus_bw__ETC___d2704 =
	     bml_crdBuf_value == bml_crdBuf_modulus ;
  assign bml_fabBuf_value_906_EQ_bml_fabBuf_modulus_bw__ETC___d2705 =
	     bml_fabBuf_value == bml_fabBuf_modulus ;
  assign bml_fabFlowAddr_978_PLUS_bml_fabFlowSize_979___d2607 =
	     bml_fabFlowAddr + bml_fabFlowSize ;
  assign bml_lclBufDone_963_AND_IF_bml_dpControl_wget___ETC___d2384 =
	     bml_lclBufDone &&
	     CASE_dpControl_BITS_1_TO_0_NOT_bml_fabDone_0_N_ETC__q6 ;
  assign bml_lclBuf_value_876_EQ_bml_lclBuf_modulus_bw__ETC___d2722 =
	     bml_lclBuf_value == bml_lclBuf_modulus ;
  assign bml_remBuf_value_891_EQ_bml_remBuf_modulus_bw__ETC___d2723 =
  ...
  assign bram_serverAdapterA_1_cnt_44_SLT_3___d2612 =
	     (bram_serverAdapterA_1_cnt ^ 3'h4) < 3'd7 ;
  assign bram_serverAdapterA_1_outDataCore_notEmpty__20_ETC___d1500 =
	     (bram_serverAdapterA_1_outDataCore$EMPTY_N ||
	      bram_serverAdapterA_1_outData_enqData$whas) &&
	     (bram_serverAdapterA_2_outDataCore$EMPTY_N ||
	      bram_serverAdapterA_2_outData_enqData$whas) &&
  ...
  assign bram_serverAdapterA_2_cnt_62_SLT_3___d2613 =
  ...
  assign bram_serverAdapterA_3_cnt_80_SLT_3___d2614 =
	     (bram_serverAdapterA_3_cnt ^ 3'h4) < 3'd7 ;
  assign bram_serverAdapterA_3_outDataCore_notEmpty__56_ETC___d1498 =
	     (bram_serverAdapterA_3_outDataCore$EMPTY_N ||
	      bram_serverAdapterA_3_outData_enqData$whas) &&
	     bram_serverAdapterA_outData_outData$whas &&
	     bram_serverAdapterA_1_outData_outData$whas &&
	     bram_serverAdapterA_2_outData_outData$whas &&
	     bram_serverAdapterA_3_outData_outData$whas &&
	     (!tlp_rdRespDwRemain_490_ULE_4___d1491 || tlp_readReq$EMPTY_N) ;
  assign bram_serverAdapterA_cnt_6_PLUS_IF_bram_serverA_ETC___d32 =
	     ...
	     (bram_serverAdapterA_cnt_2$whas ? 3'd7 : 3'd0) ;
  assign bram_serverAdapterA_cnt_6_SLT_3___d2611 =
  ...
  assign bram_serverAdapterB_1_cnt_03_SLT_3___d1690 =
	     (bram_serverAdapterB_1_cnt ^ 3'h4) < 3'd7 ;
  assign bram_serverAdapterB_1_outData_outData_whas__71_ETC___d1718 =
	     bram_serverAdapterB_1_outData_outData$whas &&
	     (bram_serverAdapterB_2_outDataCore$EMPTY_N ||
	      bram_serverAdapterB_2_outData_enqData$whas) &&
	     bram_serverAdapterB_2_outData_outData$whas &&
  ...
  assign bram_serverAdapterB_2_cnt_21_SLT_3___d1691 =
  ...
  assign bram_serverAdapterB_3_cnt_39_SLT_3___d1692 =
  ...
  assign bram_serverAdapterB_cnt_5_SLT_3___d1689 =
	     (bram_serverAdapterB_cnt ^ 3'h4) < 3'd7 ;
  assign byteCount__h54395 = x__h54506 - y__h54507 ;
  assign hasPull_AND_NOT_tlp_dpControl_wget__34_BIT_9_3_ETC___d1011 =
	     hasPull && !dpControl[9] && !dpControl[8] &&
	     dpControl[7:4] == 4'd0 &&
	     dpControl[3:2] == 2'd2 &&
	     dpControl[1:0] == 2'd1 &&
	     tlp_fabMeta[128] &&
  ...
  assign hasPull_AND_NOT_tlp_dpControl_wget__34_BIT_9_3_ETC___d1031 =
	     hasPull && !dpControl[9] && !dpControl[8] &&
	     dpControl[7:4] == 4'd0 &&
	     dpControl[3:2] == 2'd2 &&
	     dpControl[1:0] == 2'd1 &&
	     ...
	     tlp_reqMesgInFlight &&
	     tlp_gotResponseHeader ;
  assign hasPull_AND_NOT_tlp_dpControl_wget__34_BIT_9_3_ETC___d1056 =
	     hasPull && !dpControl[9] && !dpControl[8] &&
	     dpControl[7:4] == 4'd0 &&
	     dpControl[3:2] == 2'd2 &&
	     dpControl[1:0] == 2'd1 &&
  ...
  assign hasPull_AND_NOT_tlp_dpControl_wget__34_BIT_9_3_ETC___d890 =
	     hasPull && !dpControl[9] && !dpControl[8] &&
	     dpControl[7:4] == 4'd0 &&
	     dpControl[3:2] == 2'd2 &&
	     dpControl[1:0] == 2'd1 &&
	     ...
	     !tlp_reqMetaBodyInFlight &&
	     !tlp_fabMeta[128] ;
  assign hasPull_AND_NOT_tlp_dpControl_wget__34_BIT_9_3_ETC___d927 =
	     hasPull && !dpControl[9] && !dpControl[8] &&
	     dpControl[7:4] == 4'd0 &&
	     dpControl[3:2] == 2'd2 &&
	     dpControl[1:0] == 2'd1 &&
	     ...
	     tagm__h39590 == tlp_inF$D_OUT[47:40] &&
	     tlp_inF_first__12_BITS_63_TO_56_15_EQ_pciDevic_ETC___d925 ;
  assign hasPull_AND_NOT_tlp_dpControl_wget__34_BIT_9_3_ETC___d978 =
	     hasPull && !dpControl[9] && !dpControl[8] &&
	     dpControl[7:4] == 4'd0 &&
	     dpControl[3:2] == 2'd2 &&
	     dpControl[1:0] == 2'd1 &&
  ...
  assign hasPush_AND_NOT_tlp_dpControl_wget__34_BIT_9_3_ETC___d661 =
	     hasPush && !dpControl[9] && !dpControl[8] &&
	     dpControl[7:4] == 4'd0 &&
	     dpControl[3:2] == 2'd1 &&
	     dpControl[1:0] == 2'd1 &&
	     !tlp_tlpRcvBusy &&
	     ...
	     !tlp_fabMeta[128] &&
	     tlp_nearBufReady ;
  assign hasPush_AND_NOT_tlp_dpControl_wget__34_BIT_9_3_ETC___d736 =
	     hasPush && !dpControl[9] && !dpControl[8] &&
	     dpControl[7:4] == 4'd0 &&
	     dpControl[3:2] == 2'd1 &&
	     dpControl[1:0] == 2'd1 &&
  ...
  assign hasPush_AND_NOT_tlp_dpControl_wget__34_BIT_9_3_ETC___d773 =
	     hasPush && !dpControl[9] && !dpControl[8] &&
	     dpControl[7:4] == 4'd0 &&
	     dpControl[3:2] == 2'd1 &&
	     dpControl[1:0] == 2'd1 &&
	     ...
	     !tlp_tlpXmtBusy &&
	     tlp_postSeqDwell == 4'd0 ;
  assign hasPush_AND_NOT_tlp_dpControl_wget__34_BIT_9_3_ETC___d824 =
	     hasPush && !dpControl[9] && !dpControl[8] &&
	     dpControl[7:4] == 4'd0 &&
	     dpControl[3:2] == 2'd1 &&
	     dpControl[1:0] == 2'd1 &&
	     ...
	     tlp_xmtMetaOK &&
	     tlp_postSeqDwell == 4'd0 ;
  assign hasPush_AND_NOT_tlp_dpControl_wget__34_BIT_9_3_ETC___d839 =
	     hasPush && !dpControl[9] && !dpControl[8] &&
	     dpControl[7:4] == 4'd0 &&
	     dpControl[3:2] == 2'd1 &&
	     dpControl[1:0] == 2'd1 &&
	     tlp_fabMeta[128] &&
	     tlp_doXmtMetaBody ;
  assign hasPush_AND_NOT_tlp_dpControl_wget__34_BIT_9_3_ETC___d865 =
	     hasPush && !dpControl[9] && !dpControl[8] &&
	     dpControl[7:4] == 4'd0 &&
	     dpControl[3:2] == 2'd1 &&
	     dpControl[1:0] == 2'd1 &&
	     tlp_fabMeta[128] &&
	     tlp_tlpMetaSent ;
  assign idx__h45184 = 2'd0 - tlp_writeDWAddr[1:0] ;
  assign idx__h47415 = 2'd1 - tlp_writeDWAddr[1:0] ;
  assign idx__h48719 = 2'd2 - tlp_writeDWAddr[1:0] ;
  assign idx__h50023 = 2'd3 - tlp_writeDWAddr[1:0] ;
  assign idx__h52279 = 2'd0 - tlp_readNxtDWAddr[1:0] ;
  assign idx__h52747 = 2'd1 - tlp_readNxtDWAddr[1:0] ;
  assign idx__h53120 = 2'd2 - tlp_readNxtDWAddr[1:0] ;
  assign idx__h53493 = 2'd3 - tlp_readNxtDWAddr[1:0] ;
  assign lastBE__h27226 =
	     tlp_mRespF_first__78_BITS_71_TO_62_75_ULE_1___d2315 ?
	       4'd0 :
	       4'd15 ;
  assign lastBE__h39440 =
	     (thisRequestLength__h39138[11:2] == 10'd1) ? 4'd0 : 4'd15 ;
  assign lowAddr__h54394 = { tlp_readReq$D_OUT[33:29], lowAddr10__h54393 } ;
  assign mesgMeta_opcode__h70567 =
	     { 24'h800000, wmi_wmi_mFlagF$D_OUT[31:24] } ;
  assign nowLS__h25555 =
	     { tlp_mRespF$D_OUT[39:32],
	       tlp_mRespF$D_OUT[47:40],
	       tlp_mRespF$D_OUT[55:48],
	       tlp_mRespF$D_OUT[63:56] } ;
  assign nowLS__h37887 =
	     { tlp_inF$D_OUT[39:32],
	       tlp_inF$D_OUT[47:40],
	       tlp_inF$D_OUT[55:48],
	       tlp_inF$D_OUT[63:56] } ;
  assign nowMS__h24612 =
	     { tlp_mRespF$D_OUT[71:64],
	       tlp_mRespF$D_OUT[79:72],
	       tlp_mRespF$D_OUT[87:80],
	       tlp_mRespF$D_OUT[95:88] } ;
  assign nowMS__h36946 =
	     { tlp_inF$D_OUT[71:64],
	       tlp_inF$D_OUT[79:72],
	       tlp_inF$D_OUT[87:80],
	       tlp_inF$D_OUT[95:88] } ;
  assign opcode__h23381 =
	     { tlp_mRespF$D_OUT[103:96],
	       tlp_mRespF$D_OUT[111:104],
	       tlp_mRespF$D_OUT[119:112],
	       tlp_mRespF$D_OUT[127:120] } ;
  assign opcode__h35726 =
  ...
  assign rdat__h79692 = { 16'd0, bml_lclNumBufs } ;
  assign rdat__h79700 = { 16'd0, bml_fabNumBufs } ;
  assign rdat__h79708 = { 16'd0, bml_mesgBase } ;
  assign rdat__h79716 = { 16'd0, bml_metaBase } ;
  assign rdat__h79724 = { 16'd0, bml_mesgSize } ;
  assign rdat__h79732 = { 16'd0, bml_metaSize } ;
  assign rdat__h79740 = { 16'd0, bml_lclBufsCF } ;
  assign rdat__h79757 = hasDebugLogic ? 32'hF00DFACE : 32'd0 ;
  assign rdat__h79763 =
  ...
  assign rdat__h79797 = hasDebugLogic ? wmi_thisMesg : 32'd0 ;
  assign rdat__h80061 = hasDebugLogic ? wmi_lastMesg : 32'd0 ;
  assign rdat__h80111 =
	     hasDebugLogic ? { wmi_reqCount, wmi_wrtCount } : 32'd0 ;
  assign rdat__h80211 = hasDebugLogic ? 32'hDADEBABE : 32'd0 ;
  assign rdat__h80217 = hasDebugLogic ? 32'h00008000 : 32'd0 ;
  assign rdat__h80271 = { 22'd0, dpControl } ;
  assign rdat__h80305 = hasDebugLogic ? tlp_flowDiagCount : 32'd0 ;
  assign rdat__h80315 =
	     hasDebugLogic ?
	       { 4'h0,
		 tlp_complTimerCount,
		 ...
		 CASE_tlp_lastRuleFired_8_1_tlp_lastRuleFired_2_ETC__q1 } :
	       32'd0 ;
  assign rdat__h80421 = hasDebugLogic ? tlp_lastMetaV : 32'd0 ;
  assign rdat__h80542 = hasDebugLogic ? tlp_lastMetaV_1 : 32'd0 ;
  assign rdat__h80571 = hasDebugLogic ? tlp_lastMetaV_2 : 32'd0 ;
  assign rdat__h80600 = hasDebugLogic ? tlp_lastMetaV_3 : 32'd0 ;
  assign rdat__h80629 = hasDebugLogic ? 32'hC0DE0111 : 32'd0 ;
  assign rdat__h80635 = hasDebugLogic ? bml_fabMesgBaseMS : 32'd0 ;
  assign rdat__h80646 = hasDebugLogic ? bml_fabMetaBaseMS : 32'd0 ;
  assign rdat__h80657 = hasDebugLogic ? bml_fabFlowBaseMS : 32'd0 ;
  assign rdata__h59812 =
	     tlp_readReq_first__406_BITS_30_TO_29_407_PLUS_1___d2312[1] ?
	       IF_tlp_readReq_first__406_BITS_30_TO_29_407_PL_ETC___d1541 :
	       IF_tlp_readReq_first__406_BITS_30_TO_29_407_PL_ETC___d1546 ;
  assign rreq_tag__h27016 =
	     (y__h26827 == tlp_mesgLengthRemainPush) ? 8'h01 : 8'h0 ;
  assign rresp_data__h54437 =
	     { IF_tlp_readReq_first__406_BITS_30_TO_29_407_EQ_ETC___d2418[7:0],
	       IF_tlp_readReq_first__406_BITS_30_TO_29_407_EQ_ETC___d2418[15:8],
	       IF_tlp_readReq_first__406_BITS_30_TO_29_407_EQ_ETC___d2418[23:16],
	       IF_tlp_readReq_first__406_BITS_30_TO_29_407_EQ_ETC___d2418[31:24] } ;
  assign spanToNextPage__h26801 = 13'd4096 - { 1'd0, tlp_srcMesgAccu[11:0] } ;
  assign spanToNextPage__h39137 = 13'd4096 - { 1'd0, tlp_fabMesgAccu[11:0] } ;
  assign tag__h39413 = { 3'd0, tlp_dmaTag } ;
  assign tagm__h39590 = { 3'd0, tlp_dmaReqTag } ;
  assign thisRequestLength__h26802 =
	     (x__h26840[12:0] <= spanToNextPage__h26801) ?
	       x__h26840[12:0] :
	       spanToNextPage__h26801 ;
  assign thisRequestLength__h39138 =
	     (x__h39171[12:0] <= spanToNextPage__h39137) ?
	       x__h39171[12:0] :
	       spanToNextPage__h39137 ;
  assign tlp_dmaPullRemainDWLen_019_ULE_tlp_dmaPullRema_ETC___d2608 =
	     tlp_dmaPullRemainDWLen <= tlp_dmaPullRemainDWSub ;
  assign tlp_dmaPullRemainDWSub_033_ULE_4___d2609 =
	     tlp_dmaPullRemainDWSub <= 10'd4 ;
  assign tlp_inF_first__12_BITS_63_TO_56_15_EQ_pciDevic_ETC___d925 =
	     tlp_inF$D_OUT[63:56] == pciDevice[15:8] &&
	     tlp_inF$D_OUT[55:51] == pciDevice[7:3] &&
	     tlp_inF$D_OUT[50:48] == pciDevice[2:0] ;
  assign tlp_inF_first__12_BIT_152_074_AND_NOT_tlp_inF__ETC___d1099 =
	     tlp_inF$D_OUT[152] && !tlp_inF$D_OUT[110] &&
	     !tlp_inF$D_OUT[125] &&
	     tlp_inF$D_OUT[124:120] == 5'b0 ||
	     !tlp_inF$D_OUT[152] && !tlp_inIgnorePkt ;
  assign tlp_mReqF_RDY_first__139_AND_IF_tlp_mReqF_firs_ETC___d1155 =
	     tlp_mReqF$EMPTY_N &&
	     CASE_tlp_mReqFD_OUT_BITS_51_TO_50_NOT_tlp_mRe_ETC__q4 ;
  assign tlp_mRespF_first__78_BITS_71_TO_62_75_ULE_1___d2315 =
	     tlp_mRespF$D_OUT[71:62] <= 10'd1 ;
  ...
  assign tlp_outDwRemain_98_ULE_4___d2482 = tlp_outDwRemain <= 10'd4 ;
  assign tlp_rdRespDwRemain_490_ULE_4___d1491 = tlp_rdRespDwRemain <= 10'd4 ;
  ...
  assign tlp_readRemainDWLen_346_ULE_4___d1347 =
	     tlp_readRemainDWLen <= 10'd4 ;
  assign tlp_readReq_first__406_BITS_30_TO_29_407_PLUS_1___d2312 =
	     tlp_readReq$D_OUT[30:29] + 2'd1 ;
  ...
  assign tlp_writeRemainDWLen_176_ULE_1___d2317 =
	     tlp_writeRemainDWLen <= 10'd1 ;
  assign tlp_writeRemainDWLen_176_ULE_2___d2316 =
	     tlp_writeRemainDWLen <= 10'd2 ;
  assign tlp_writeRemainDWLen_176_ULE_3___d2318 =
	     tlp_writeRemainDWLen <= 10'd3 ;
  assign w_be__h27752 =
	     tlp_outDwRemain_98_ULE_4___d2482 ?
	       CASE_tlp_outDwRemain_BITS_1_TO_0_0xFFF0_0b0_0x_ETC__q3 :
	       16'd65535 ;
  assign w_data__h27202 =
	     { 22'd1048576,
	       tlp_mRespF$D_OUT[71:62],
	       pciDevice,
	       8'd0,
  ...
  assign w_data__h32412 =
	     { 32'd4,
	       ...
	       34'd0 } ;
  assign w_data__h39419 =
	     { 22'd0,
	       thisRequestLength__h39138[11:2],
	       pciDevice,
	       tag__h39413,
	       lastBE__h39440,
	       4'd15,
	       ...
	       34'd0 } ;
  assign w_data__h40934 =
	     { 32'd1073741825,
	       pciDevice,
	       16'd15,
	       tlp_fabFlowAddr,
	       32'd16777216 } ;
  assign wmi_dpControl_whas__676_AND_bram_serverAdapter_ETC___d1722 =
	     (bram_serverAdapterB_outDataCore$EMPTY_N ||
	      bram_serverAdapterB_outData_enqData$whas) &&
	     bram_serverAdapterB_outData_outData$whas &&
	     (bram_serverAdapterB_1_outDataCore$EMPTY_N ||
	      bram_serverAdapterB_1_outData_enqData$whas) &&
	     bram_serverAdapterB_1_outData_outData_whas__71_ETC___d1718 ;
  assign wmi_wmi_operateD_629_AND_wmi_wmi_peerIsReady_6_ETC___d1804 =
	     wmi_wmi_operateD && wmi_wmi_peerIsReady &&
	     bram_serverAdapterB_cnt_5_SLT_3___d1689 &&
	     bram_serverAdapterB_1_cnt_03_SLT_3___d1690 &&
	     bram_serverAdapterB_2_cnt_21_SLT_3___d1691 &&
	     bram_serverAdapterB_3_cnt_39_SLT_3___d1692 &&
	     wmi_wmi_mFlagF$EMPTY_N ;
  assign x3__h70527 = { 8'd0, wmi_wmi_mFlagF$D_OUT[23:0] } ;
  assign x__h21553 =
	     { tlp_mRespF$D_OUT[7:0],
	       tlp_mRespF$D_OUT[15:8],
	       tlp_mRespF$D_OUT[23:16],
	       tlp_mRespF$D_OUT[31:24] } ;
  assign x__h26558 = { 15'd0, tlp_mesgLengthRemainPush } ;
  assign x__h26840 =
	     (tlp_mesgLengthRemainPush <= y__h26842) ?
  ...
  assign x__h33700 =
	     { tlp_inF$D_OUT[7:0],
	       ...
	       tlp_inF$D_OUT[23:16],
	       tlp_inF$D_OUT[31:24] } ;
  assign x__h38857 = { 15'd0, tlp_mesgLengthRemainPull } ;
  assign x__h39171 =
	     (tlp_mesgLengthRemainPull <= y__h39173) ?
	       tlp_mesgLengthRemainPull :
	       y__h39173 ;
  assign x__h54506 = x__h54508 - y__h54509 ;
  assign x__h54508 = { tlp_readReq$D_OUT[28:19], 2'b0 } ;
  assign x__h76562 = (dpControl[1:0] == 2'd1) ? bml_fabNumBufs : 16'd0 ;
  assign x__h77686 = bml_lclBufsAR + 16'd1 ;
  assign x__h77691 = bml_lclBufsAR - 16'd1 ;
  assign x__h77763 = bml_lclBufsCF + 16'd1 ;
  assign x__h77768 = bml_lclBufsCF - 16'd1 ;
  assign x__h77805 = bml_fabBufsAvail + 16'd1 ;
  assign x__h77810 = bml_fabBufsAvail - 16'd1 ;
  assign x__h77843 = bml_lclCredit + 16'd1 ;
  assign x__h77848 = bml_lclCredit - 16'd1 ;
  assign y__h26827 = { 4'd0, thisRequestLength__h26802 } ;
  assign y__h26842 = { 4'd0, tlp_maxPayloadSize } ;
  assign y__h26921 = { 19'd0, thisRequestLength__h26802 } ;
  assign y__h26969 = { 3'd0, thisRequestLength__h26802 } ;
  assign y__h27354 = { 20'd0, tlp_mRespF$D_OUT[71:62], 2'd0 } ;
  assign y__h39163 = { 4'd0, thisRequestLength__h39138 } ;
  assign y__h39173 = { 4'd0, tlp_maxReadReqSize } ;
  assign y__h39234 = { 19'd0, thisRequestLength__h39138 } ;
  assign y__h39797 = { 4'd0, tlp_inF$D_OUT[105:96], 2'd0 } ;
  assign y__h40502 =
	     tlp_dmaPullRemainDWSub_033_ULE_4___d2609 ?
  ...
  assign y__h54507 =
	     (tlp_readReq$D_OUT[28:19] == 10'd1) ?
	       12'd0 :
	       { 10'd0, x__h54538 } ;
  assign y__h54509 = { 10'd0, x__h54515 } ;
  assign y_avValue__h72122 =
	     bram_serverAdapterB_outDataCore$EMPTY_N ?
	       bram_serverAdapterB_outDataCore$D_OUT :
	       bram_memory$DOB ;
  assign y_avValue__h72142 =
	     bram_serverAdapterB_1_outDataCore$EMPTY_N ?
	       bram_serverAdapterB_1_outDataCore$D_OUT :
	       bram_memory_1$DOB ;
  assign y_avValue__h72162 =
	     bram_serverAdapterB_2_outDataCore$EMPTY_N ?
	       bram_serverAdapterB_2_outDataCore$D_OUT :
	       bram_memory_2$DOB ;
  assign y_avValue__h72182 =
	     bram_serverAdapterB_3_outDataCore$EMPTY_N ?
	       bram_serverAdapterB_3_outDataCore$D_OUT :
	       bram_memory_3$DOB ;
  ...
  begin
    case (tlp_readReq$D_OUT[18:15])
      4'b1100: x__h54515 = 2'b10;
      4'b1110: x__h54515 = 2'b01;
      4'b1111: x__h54515 = 2'b0;
      default: x__h54515 = 2'b11;
    endcase
  end
  always@(tlp_readReq$D_OUT)
  begin
    case (tlp_readReq$D_OUT[14:11])
      4'b1100: x__h54538 = 2'b10;
      4'b1110: x__h54538 = 2'b01;
      4'b1111: x__h54538 = 2'b0;
      default: x__h54538 = 2'b11;
    endcase
  end
  ...
  always@(wmi_p4B or
	  y_avValue__h72182 or
	  y_avValue__h72122 or y_avValue__h72142 or y_avValue__h72162)
  begin
    case (wmi_p4B)
      2'd0: rdata__h72286 = y_avValue__h72122;
      2'd1: rdata__h72286 = y_avValue__h72142;
      2'd2: rdata__h72286 = y_avValue__h72162;
      2'd3: rdata__h72286 = y_avValue__h72182;
    endcase
  end
  always@(wci_reqF$D_OUT or
	  ...
	  rdat__h80571 or
	  rdat__h80600 or
	  rdat__h80629 or rdat__h80635 or rdat__h80646 or rdat__h80657)
  begin
    case (wci_reqF$D_OUT[39:32])
      8'h0: _theResult____h79613 = rdat__h79692;
      8'h04: _theResult____h79613 = rdat__h79700;
      8'h08: _theResult____h79613 = rdat__h79708;
      8'h0C: _theResult____h79613 = rdat__h79716;
      8'h10: _theResult____h79613 = rdat__h79724;
      8'h14: _theResult____h79613 = rdat__h79732;
      8'h20: _theResult____h79613 = rdat__h79740;
      8'h24: _theResult____h79613 = rdat__h79757;
      8'h28: _theResult____h79613 = rdat__h79763;
      8'h2C: _theResult____h79613 = rdat__h79770;
      8'h30: _theResult____h79613 = rdat__h79783;
      8'h34: _theResult____h79613 = rdat__h79790;
      8'h38: _theResult____h79613 = rdat__h79797;
      8'h3C: _theResult____h79613 = rdat__h80061;
      8'h40: _theResult____h79613 = rdat__h80111;
      8'h44: _theResult____h79613 = 32'd0;
      8'h48: _theResult____h79613 = rdat__h80211;
      8'h4C: _theResult____h79613 = rdat__h80217;
      8'h50: _theResult____h79613 = bml_fabMesgBase;
      8'h54: _theResult____h79613 = bml_fabMetaBase;
      8'h58: _theResult____h79613 = bml_fabMesgSize;
      8'h5C: _theResult____h79613 = bml_fabMetaSize;
      8'h60: _theResult____h79613 = bml_fabFlowBase;
      8'h64: _theResult____h79613 = bml_fabFlowSize;
      8'h68: _theResult____h79613 = rdat__h80271;
      8'h6C: _theResult____h79613 = rdat__h80305;
      8'h70: _theResult____h79613 = rdat__h80315;
      8'h80: _theResult____h79613 = rdat__h80421;
      8'h84: _theResult____h79613 = rdat__h80542;
      8'h88: _theResult____h79613 = rdat__h80571;
      8'h8C: _theResult____h79613 = rdat__h80600;
      8'h90: _theResult____h79613 = rdat__h80629;
      8'h94: _theResult____h79613 = rdat__h80635;
      8'h98: _theResult____h79613 = rdat__h80646;
      8'h9C: _theResult____h79613 = rdat__h80657;
      default: _theResult____h79613 = 32'd0;
    endcase
  end
  always@(tlp_readReq$D_OUT)
  begin
    case (tlp_readReq$D_OUT[18:15])
      4'b1000: lowAddr10__h54393 = 2'b11;
      4'b1100: lowAddr10__h54393 = 2'b10;
      4'b1110: lowAddr10__h54393 = 2'b01;
      default: lowAddr10__h54393 = 2'b0;
    endcase
  end
  ...
  begin
    case (dpControl[1:0])
	  ...
	  IF_bml_dpControl_wget__939_BITS_1_TO_0_945_EQ__ETC___d2016 =
	      bml_remDone;
      default: IF_bml_dpControl_wget__939_BITS_1_TO_0_945_EQ__ETC___d2016 =
		   bml_fabDone;
    endcase
  end
  ...
  always@(idx__h45184 or
	  tlp_writeRemainDWLen_176_ULE_3___d2318 or
	  tlp_writeRemainDWLen or
	  tlp_writeRemainDWLen_176_ULE_1___d2317 or
	  tlp_writeRemainDWLen_176_ULE_2___d2316)
  begin
    case (idx__h45184)
      2'd0:
  ...
  always@(tlp_mReqF$D_OUT or
	  bram_serverAdapterA_3_cnt_80_SLT_3___d2614 or
	  bram_serverAdapterA_cnt_6_SLT_3___d2611 or
	  bram_serverAdapterA_1_cnt_44_SLT_3___d2612 or
	  bram_serverAdapterA_2_cnt_62_SLT_3___d2613)
  begin
  ...
  always@(wmi_addr or
	  bram_serverAdapterB_3_cnt_39_SLT_3___d1692 or
	  bram_serverAdapterB_cnt_5_SLT_3___d1689 or
	  bram_serverAdapterB_1_cnt_03_SLT_3___d1690 or
	  bram_serverAdapterB_2_cnt_21_SLT_3___d1691)
  begin
    case (wmi_addr[3:2])
      2'd0:
  ...
  always@(idx__h45184 or tlp_mReqF$D_OUT)
  begin
    case (idx__h45184)
      2'd0:
	  IF_0_MINUS_tlp_writeDWAddr_172_BITS_1_TO_0_173_ETC___d2414 =
  ...
  always@(idx__h47415 or tlp_mReqF$D_OUT)
  begin
    case (idx__h47415)
      2'd0:
	  IF_1_MINUS_tlp_writeDWAddr_172_BITS_1_TO_0_173_ETC___d2415 =
  ...
  always@(idx__h48719 or tlp_mReqF$D_OUT)
  begin
    case (idx__h48719)
      2'd0:
	  IF_2_MINUS_tlp_writeDWAddr_172_BITS_1_TO_0_173_ETC___d2416 =
  ...
  always@(idx__h50023 or tlp_mReqF$D_OUT)
  begin
    case (idx__h50023)
      2'd0:
	  IF_3_MINUS_tlp_writeDWAddr_172_BITS_1_TO_0_173_ETC___d2417 =
  ...
  begin
    case (tlp_readReq$D_OUT[30:29])
	  ...
	  IF_tlp_readReq_first__406_BITS_30_TO_29_407_EQ_ETC___d1421 =
	      bram_serverAdapterA_2_outDataCore$EMPTY_N ||
	      bram_serverAdapterA_2_outData_enqData$whas;
      default: IF_tlp_readReq_first__406_BITS_30_TO_29_407_EQ_ETC___d1421 =
		   tlp_readReq$D_OUT[30:29] != 2'd3 ||
		   bram_serverAdapterA_3_outDataCore$EMPTY_N ||
		   bram_serverAdapterA_3_outData_enqData$whas;
    endcase
  ...
  begin
    case (wmi_p4B)
	  ...
	  IF_wmi_p4B_825_EQ_1_828_THEN_bram_serverAdapte_ETC___d1834 =
	      bram_serverAdapterB_2_outDataCore$EMPTY_N ||
	      bram_serverAdapterB_2_outData_enqData$whas;
      default: IF_wmi_p4B_825_EQ_1_828_THEN_bram_serverAdapte_ETC___d1834 =
		   wmi_p4B != 2'd3 ||
		   bram_serverAdapterB_3_outDataCore$EMPTY_N ||
		   bram_serverAdapterB_3_outData_enqData$whas;
    endcase
  ...
  begin
	...
	dpControl <= `BSV_ASSIGNMENT_DELAY 10'd0;
  ...
  begin
    ...
    if (RST_N)
      if (MUX_tlp_outF$enq_1__SEL_2)
	$display("[%0d]: %m: dmaXmtMetaHead FPactMesg-Step5/7", v__h29084);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_tlp_dmaXmtTailEvent)
	$display("[%0d]: %m: dmaXmtTailEvent FPactMesg-Step7/7", v__h31963);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_tlp_dmaXmtMetaBody)
	$display("[%0d]: %m: dmaXmtMetaBody FPactMesg-Step6/7", v__h31843);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_tlp_dmaXmtDoorbell)
	$display("[%0d]: %m: dmaXmtDoorbell FC/FPactFlow-Step1/1", v__h32132);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_tlp_dmaPullTailEvent)
	$display("[%0d]: %m: dmaPullTailEvent FPactMesg-Step5/5", v__h40710);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_tlp_dmaTailEventSender)
	$display("[%0d]: %m: dmaTailEventSender - generic", v__h41835);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_tlp_dmaRequestFarMeta)
	$display("[%0d]: %m: dmaRequestFarMeta FCactMesg-Step1/5", v__h32545);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_wci_cfwr && wci_reqF$D_OUT[39:32] == 8'h18)
	$display("[%0d] %m: fabDoneAvail Event", v__h78992);
    if (RST_N)
