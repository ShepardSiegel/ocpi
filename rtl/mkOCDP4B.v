...
//
// On Tue Dec  6 16:12:09 EST 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkOCDP4B(pciDevice,
  ...
  wire [8 : 0] bml_dpControl$wget, tlp_dpControl$wget, wmi_dpControl$wget;
  ...
  // register bml_fabFlowAddrMS
  reg [31 : 0] bml_fabFlowAddrMS;
  wire [31 : 0] bml_fabFlowAddrMS$D_IN;
  wire bml_fabFlowAddrMS$EN;
  ...
  // register bml_fabMesgAddrMS
  reg [31 : 0] bml_fabMesgAddrMS;
  wire [31 : 0] bml_fabMesgAddrMS$D_IN;
  wire bml_fabMesgAddrMS$EN;
  ...
  // register bml_fabMetaAddrMS
  reg [31 : 0] bml_fabMetaAddrMS;
  wire [31 : 0] bml_fabMetaAddrMS$D_IN;
  wire bml_fabMetaAddrMS$EN;
  ...
  wire [60 : 0] tlp_readReq$D_IN, tlp_readReq$D_OUT;
  ...
  wire MUX_bml_fabBufsAvail$write_1__SEL_1,
       MUX_bml_fabMesgAddr$write_1__SEL_1,
       ...
       MUX_tlp_fabMesgAccu$write_1__SEL_2,
       ...
       MUX_tlp_tlpXmtBusy$write_1__VAL_3,
  ...
  reg [63 : 0] v__h15540,
	       ...
	       v__h79986,
	       v__h80140;
  reg [31 : 0] IF_0_MINUS_tlp_writeDWAddr_187_BITS_1_TO_0_188_ETC___d2334,
	       IF_1_MINUS_tlp_writeDWAddr_187_BITS_1_TO_0_188_ETC___d2335,
	       IF_2_MINUS_tlp_writeDWAddr_187_BITS_1_TO_0_188_ETC___d2336,
	       IF_3_MINUS_tlp_writeDWAddr_187_BITS_1_TO_0_188_ETC___d2337,
	       IF_tlp_readReq_first__432_BITS_30_TO_29_433_EQ_ETC___d2338,
	       _theResult____h80124,
	       rdata__h72833;
  ...
  reg [1 : 0] lowAddr10__h54931, x__h55059, x__h55082;
  reg CASE_dpControl_BITS_1_TO_0_NOT_bml_fabDone_0_N_ETC__q6,
      ...
      IF_0_MINUS_tlp_writeDWAddr_187_BITS_1_TO_0_188_ETC___d1204,
      IF_0_MINUS_tlp_writeDWAddr_187_BITS_1_TO_0_188_ETC___d2787,
      IF_1_MINUS_tlp_writeDWAddr_187_BITS_1_TO_0_188_ETC___d1214,
      IF_1_MINUS_tlp_writeDWAddr_187_BITS_1_TO_0_188_ETC___d2788,
      IF_2_MINUS_tlp_writeDWAddr_187_BITS_1_TO_0_188_ETC___d1224,
      IF_2_MINUS_tlp_writeDWAddr_187_BITS_1_TO_0_188_ETC___d2789,
      IF_3_MINUS_tlp_writeDWAddr_187_BITS_1_TO_0_188_ETC___d1234,
      IF_3_MINUS_tlp_writeDWAddr_187_BITS_1_TO_0_188_ETC___d2790,
      IF_bml_dpControl_wget__969_BITS_1_TO_0_975_EQ__ETC___d2046,
      IF_tlp_readReq_first__432_BITS_30_TO_29_433_EQ_ETC___d1447,
      IF_wmi_addr_798_BITS_3_TO_2_799_EQ_0_800_THEN__ETC___d2761,
      IF_wmi_p4B_855_EQ_1_858_THEN_bram_serverAdapte_ETC___d1864;
  wire [127 : 0] IF_tlp_readReq_first__432_BITS_30_TO_29_433_PL_ETC___d1571,
		 IF_tlp_readReq_first__432_BITS_30_TO_29_433_PL_ETC___d1576,
		 pkt__h43152,
		 rdata__h60363,
		 w_data__h27331,
		 w_data__h27645,
		 ...
		 w_data__h39726,
		 w_data__h41243;
  wire [31 : 0] bml_fabFlowAddr_008_PLUS_bml_fabFlowSize_009___d2586,
		mesgMeta_opcode__h71114,
		nowLS__h25675,
		nowLS__h38194,
		nowMS__h24732,
		nowMS__h37253,
  ...
  wire [15 : 0] w_be__h28066,
		...
		y__h27089,
		y__h40104;
  wire [12 : 0] spanToNextPage__h26921,
		spanToNextPage__h39444,
		thisRequestLength__h26922,
		thisRequestLength__h39445,
		...
		y__h43829,
		y__h52573;
  wire [11 : 0] byteCount__h54933, x__h55050, x__h55052, y__h55051, y__h55053;
  wire [9 : 0] y__h43881, y__h52525, y__h55992;
  wire [7 : 0] rreq_tag__h27137, tag__h39720, tagm__h39897;
  wire [6 : 0] lowAddr__h54932;
  wire [3 : 0] lastBE__h27358, lastBE__h39747;
  ...
  wire [1 : 0] ab__h10380,
	       ...
	       idx__h53654,
	       idx__h54027,
	       tlp_readReq_first__432_BITS_30_TO_29_433_PLUS_1___d2729;
  wire IF_1_MINUS_tlp_writeDWAddr_187_BITS_1_TO_0_188_ETC___d1237,
       IF_tlp_readReq_first__432_BITS_30_TO_29_433_EQ_ETC___d1455,
       IF_wmi_p4B_855_EQ_0_856_THEN_bram_serverAdapte_ETC___d1869,
       NOT_bml_lclBufDone_993_060_AND_IF_bml_dpContro_ETC___d2073,
       NOT_wmi_wrActive_770_771_OR_NOT_wmi_rdActive_7_ETC___d1780,
       _dfoo5,
       bml_crdBuf_value_951_EQ_bml_crdBuf_modulus_bw__ETC___d2696,
       bml_fabBuf_value_936_EQ_bml_fabBuf_modulus_bw__ETC___d2698,
       bml_lclBufDone_993_AND_IF_bml_dpControl_wget___ETC___d2792,
       bml_lclBuf_value_906_EQ_bml_lclBuf_modulus_bw__ETC___d2695,
       bml_remBuf_value_921_EQ_bml_remBuf_modulus_bw__ETC___d2697,
       bram_serverAdapterA_1_cnt_44_SLT_3___d2591,
       bram_serverAdapterA_1_outDataCore_notEmpty__20_ETC___d1530,
       bram_serverAdapterA_2_cnt_62_SLT_3___d2592,
       bram_serverAdapterA_3_cnt_80_SLT_3___d2593,
       bram_serverAdapterA_3_outDataCore_notEmpty__56_ETC___d1528,
       bram_serverAdapterA_cnt_6_SLT_3___d2590,
       bram_serverAdapterB_1_cnt_03_SLT_3___d1720,
       bram_serverAdapterB_1_outData_outData_whas__74_ETC___d1748,
       bram_serverAdapterB_2_cnt_21_SLT_3___d1721,
       bram_serverAdapterB_3_cnt_39_SLT_3___d1722,
       bram_serverAdapterB_cnt_5_SLT_3___d1719,
       hasPull_AND_NOT_tlp_dpControl_wget__34_BIT_8_3_ETC___d1016,
       hasPull_AND_NOT_tlp_dpControl_wget__34_BIT_8_3_ETC___d1036,
       hasPull_AND_NOT_tlp_dpControl_wget__34_BIT_8_3_ETC___d1061,
       hasPull_AND_NOT_tlp_dpControl_wget__34_BIT_8_3_ETC___d894,
       hasPull_AND_NOT_tlp_dpControl_wget__34_BIT_8_3_ETC___d931,
       hasPull_AND_NOT_tlp_dpControl_wget__34_BIT_8_3_ETC___d983,
       hasPush_AND_NOT_tlp_dpControl_wget__34_BIT_8_3_ETC___d658,
       hasPush_AND_NOT_tlp_dpControl_wget__34_BIT_8_3_ETC___d733,
       hasPush_AND_NOT_tlp_dpControl_wget__34_BIT_8_3_ETC___d773,
       hasPush_AND_NOT_tlp_dpControl_wget__34_BIT_8_3_ETC___d829,
       hasPush_AND_NOT_tlp_dpControl_wget__34_BIT_8_3_ETC___d844,
       hasPush_AND_NOT_tlp_dpControl_wget__34_BIT_8_3_ETC___d870,
       tlp_dmaPullRemainDWLen_024_ULE_tlp_dmaPullRema_ETC___d2587,
       tlp_dmaPullRemainDWSub_038_ULE_4___d2588,
       tlp_inF_first__16_BITS_63_TO_56_19_EQ_pciDevic_ETC___d929,
       tlp_inF_first__16_BIT_152_079_AND_NOT_tlp_inF__ETC___d1104,
       tlp_mReqF_first__146_BIT_60_335_OR_IF_tlp_mReq_ETC___d1348,
       tlp_mReqF_first__146_BIT_63_147_OR_IF_tlp_mReq_ETC___d1162,
       tlp_mRespF_first__75_BITS_71_TO_62_75_ULE_1___d2731,
       tlp_outDwRemain_03_ULE_4___d2426,
       tlp_rdRespDwRemain_520_ULE_4___d1521,
       tlp_readRemainDWLen_372_ULE_4___d1373,
       tlp_writeRemainDWLen_191_ULE_1___d2733,
       tlp_writeRemainDWLen_191_ULE_2___d2734,
       tlp_writeRemainDWLen_191_ULE_3___d2735,
       wmi_dpControl_whas__706_AND_bram_serverAdapter_ETC___d1752,
       wmi_wmi_operateD_659_AND_wmi_wmi_peerIsReady_6_ETC___d1834;
  ...
  arSRLFIFOD #(.width(32'd61), .l2depth(32'd4)) tlp_readReq(.CLK(CLK),
							    .RST_N(RST_N),
  ...
  assign WILL_FIRE_RL_tlp_dmaResponseNearMetaHead =
	     tlp_mRespF$EMPTY_N && hasPush && !dpControl[8] &&
	     dpControl[7:4] == 4'd0 &&
	     dpControl[3:2] == 2'd1 &&
	     dpControl[1:0] == 2'd1 &&
  ...
  assign WILL_FIRE_RL_tlp_writeData =
	     ...
	     (IF_0_MINUS_tlp_writeDWAddr_187_BITS_1_TO_0_188_ETC___d1204 ||
	      bram_serverAdapterA_cnt_6_SLT_3___d2590) &&
	     IF_1_MINUS_tlp_writeDWAddr_187_BITS_1_TO_0_188_ETC___d1237 &&
  ...
  assign WILL_FIRE_RL_tlp_read_FirstReq =
	     ...
	     (tlp_mReqF$D_OUT[28:19] != 10'd1 || tlp_mReqF$D_OUT[60] ||
	      tlp_mReqF$EMPTY_N) &&
	     tlp_mReqF_first__146_BIT_60_335_OR_IF_tlp_mReq_ETC___d1348 &&
	     !tlp_readStarted &&
	     tlp_mReqF$D_OUT[129:128] != 2'd0 &&
  ...
  assign WILL_FIRE_RL_tlp_read_FirstResp =
	     ...
	     IF_tlp_readReq_first__432_BITS_30_TO_29_433_EQ_ETC___d1455 &&
	     (tlp_readReq$D_OUT[28:19] != 10'd1 || tlp_readReq$D_OUT[60] ||
	      tlp_readReq$EMPTY_N) &&
	     !tlp_readHeaderSent ;
  ...
  assign MUX_bml_fabBufsAvail$write_1__SEL_1 =
	     ...
	     (bml_fabAvail && !bml_remStart ||
	      !bml_fabAvail && bml_remStart) ;
  assign MUX_bml_fabMesgAddr$write_1__SEL_1 =
  ...
  assign MUX_bram_memory$a_put_1__SEL_1 =
	     WILL_FIRE_RL_tlp_writeReq && !tlp_mReqF$D_OUT[63] &&
	     tlp_mReqF$D_OUT[51:50] == 2'd0 ;
  assign MUX_bram_memory$a_put_1__SEL_2 =
	     WILL_FIRE_RL_tlp_read_FirstReq && !tlp_mReqF$D_OUT[60] &&
  ...
  assign MUX_tlp_fabMesgAccu$write_1__SEL_2 =
	     WILL_FIRE_RL_tlp_dmaRespBodyFarMeta ||
	     WILL_FIRE_RL_tlp_dmaResponseNearMetaBody ;
  ...
  assign MUX_bml_fabBufsAvail$write_1__VAL_1 =
	     (bml_fabAvail && !bml_remStart) ? x__h78348 : x__h78353 ;
  assign MUX_bml_fabBufsAvail$write_1__VAL_2 =
	     (dpControl[3:2] == 2'd1) ? x__h77105 : 16'd0 ;
  assign MUX_bml_fabFlowAddr$write_1__VAL_1 =
	     bml_fabBuf_value_936_EQ_bml_fabBuf_modulus_bw__ETC___d2698 ?
	       bml_fabFlowBase :
	       bml_fabFlowAddr_008_PLUS_bml_fabFlowSize_009___d2586 ;
  ...
  assign MUX_bml_lclCredit$write_1__VAL_1 =
	     (bml_lclBufDone && !bml_remStart) ? x__h78386 : x__h78391 ;
  ...
  begin
    case (idx__h45592)
      ...
      2'd1: MUX_bram_memory$a_put_2__VAL_3 = tlp_writeDWAddr_PLUS_1__q9[12:2];
      2'd2:
	  MUX_bram_memory$a_put_2__VAL_3 = tlp_writeDWAddr_PLUS_2__q10[12:2];
      2'd3: MUX_bram_memory$a_put_2__VAL_3 = tlp_writeDWAddr_PLUS_3__q8[12:2];
    endcase
  end
  always@(idx__h52813 or
  ...
  assign MUX_bram_memory$a_put_3__VAL_3 =
	     { IF_0_MINUS_tlp_writeDWAddr_187_BITS_1_TO_0_188_ETC___d2334[7:0],
	       IF_0_MINUS_tlp_writeDWAddr_187_BITS_1_TO_0_188_ETC___d2334[15:8],
	       IF_0_MINUS_tlp_writeDWAddr_187_BITS_1_TO_0_188_ETC___d2334[23:16],
	       IF_0_MINUS_tlp_writeDWAddr_187_BITS_1_TO_0_188_ETC___d2334[31:24] } ;
  assign MUX_bram_memory$b_put_2__VAL_1 =
	     wmi_lclMesgAddr[14:4] + { 1'd0, wmi_addr[13:4] } ;
  always@(idx__h47823 or
	  tlp_writeDWAddr_PLUS_3__q8 or
	  tlp_writeDWAddr or
	  tlp_writeDWAddr_PLUS_1__q9 or tlp_writeDWAddr_PLUS_2__q10)
  begin
    case (idx__h47823)
      ...
      2'd1:
	  MUX_bram_memory_1$a_put_2__VAL_3 = tlp_writeDWAddr_PLUS_1__q9[12:2];
      2'd2:
	  MUX_bram_memory_1$a_put_2__VAL_3 =
	      tlp_writeDWAddr_PLUS_2__q10[12:2];
      2'd3:
	  MUX_bram_memory_1$a_put_2__VAL_3 = tlp_writeDWAddr_PLUS_3__q8[12:2];
    endcase
  end
  always@(idx__h53281 or
	  tlp_readNxtDWAddr_PLUS_3__q11 or
	  tlp_readNxtDWAddr or
	  tlp_readNxtDWAddr_PLUS_1__q12 or tlp_readNxtDWAddr_PLUS_2__q13)
  begin
  ...
  assign MUX_bram_memory_1$a_put_3__VAL_3 =
	     { IF_1_MINUS_tlp_writeDWAddr_187_BITS_1_TO_0_188_ETC___d2335[7:0],
	       IF_1_MINUS_tlp_writeDWAddr_187_BITS_1_TO_0_188_ETC___d2335[15:8],
	       IF_1_MINUS_tlp_writeDWAddr_187_BITS_1_TO_0_188_ETC___d2335[23:16],
	       IF_1_MINUS_tlp_writeDWAddr_187_BITS_1_TO_0_188_ETC___d2335[31:24] } ;
  always@(idx__h49127 or
	  tlp_writeDWAddr_PLUS_3__q8 or
	  tlp_writeDWAddr or
	  tlp_writeDWAddr_PLUS_1__q9 or tlp_writeDWAddr_PLUS_2__q10)
  begin
    case (idx__h49127)
      ...
      2'd1:
	  MUX_bram_memory_2$a_put_2__VAL_3 = tlp_writeDWAddr_PLUS_1__q9[12:2];
      2'd2:
	  MUX_bram_memory_2$a_put_2__VAL_3 =
	      tlp_writeDWAddr_PLUS_2__q10[12:2];
      2'd3:
	  MUX_bram_memory_2$a_put_2__VAL_3 = tlp_writeDWAddr_PLUS_3__q8[12:2];
    endcase
  end
  always@(idx__h53654 or
	  tlp_readNxtDWAddr_PLUS_3__q11 or
	  tlp_readNxtDWAddr or
	  tlp_readNxtDWAddr_PLUS_1__q12 or tlp_readNxtDWAddr_PLUS_2__q13)
  begin
  ...
  assign MUX_bram_memory_2$a_put_3__VAL_3 =
	     { IF_2_MINUS_tlp_writeDWAddr_187_BITS_1_TO_0_188_ETC___d2336[7:0],
	       IF_2_MINUS_tlp_writeDWAddr_187_BITS_1_TO_0_188_ETC___d2336[15:8],
	       IF_2_MINUS_tlp_writeDWAddr_187_BITS_1_TO_0_188_ETC___d2336[23:16],
	       IF_2_MINUS_tlp_writeDWAddr_187_BITS_1_TO_0_188_ETC___d2336[31:24] } ;
  always@(idx__h50431 or
	  tlp_writeDWAddr_PLUS_3__q8 or
	  tlp_writeDWAddr or
	  tlp_writeDWAddr_PLUS_1__q9 or tlp_writeDWAddr_PLUS_2__q10)
  begin
  ...
  assign MUX_bram_memory_3$a_put_3__VAL_3 =
	     { IF_3_MINUS_tlp_writeDWAddr_187_BITS_1_TO_0_188_ETC___d2337[7:0],
	       IF_3_MINUS_tlp_writeDWAddr_187_BITS_1_TO_0_188_ETC___d2337[15:8],
	       IF_3_MINUS_tlp_writeDWAddr_187_BITS_1_TO_0_188_ETC___d2337[23:16],
	       IF_3_MINUS_tlp_writeDWAddr_187_BITS_1_TO_0_188_ETC___d2337[31:24] } ;
  ...
  assign MUX_tlp_fabMesgAccu$write_1__VAL_1 = tlp_fabMesgAccu + y__h27495 ;
  assign MUX_tlp_fabMesgAccu$write_1__VAL_3 = tlp_fabMesgAccu + y__h39541 ;
  ...
  assign MUX_tlp_mReqF$enq_1__VAL_3 =
	     { 69'h12AAAAAAAAAAAAAAAA,
	       ...
	       thisRequestLength__h26922[11:2],
	       8'd255,
	       rreq_tag__h27137,
	       3'h2 } ;
  ...
  assign MUX_tlp_mesgComplReceived$write_1__VAL_2 =
	     tlp_mesgComplReceived + y__h40811 ;
  ...
  assign MUX_tlp_mesgLengthRemainPull$write_1__VAL_3 =
	     tlp_mesgLengthRemainPull - y__h39470 ;
  ...
  assign MUX_tlp_mesgLengthRemainPush$write_1__VAL_3 =
	     tlp_mesgLengthRemainPush - y__h26947 ;
  assign MUX_tlp_outDwRemain$write_1__VAL_2 =
	     tlp_mRespF$D_OUT[71:62] - 10'd1 ;
  assign MUX_tlp_outDwRemain$write_1__VAL_3 = tlp_outDwRemain - 10'd4 ;
  assign MUX_tlp_outF$enq_1__VAL_1 =
		 ...
		 23'd196607,
		 w_data__h27331 } :
	       { 25'd16973823, w_data__h27645 } ;
  assign MUX_tlp_outF$enq_1__VAL_2 = { 25'd16973823, w_data__h28497 } ;
  assign MUX_tlp_outF$enq_1__VAL_3 = { 25'd8585200, w_data__h29567 } ;
  assign MUX_tlp_outF$enq_1__VAL_4 = { 25'd25362416, w_data__h32717 } ;
  assign MUX_tlp_outF$enq_1__VAL_5 = { 25'd25362416, w_data__h39726 } ;
  assign MUX_tlp_outF$enq_1__VAL_6 = { 25'd25296895, w_data__h41243 } ;
  ...
  assign MUX_tlp_rdRespDwRemain$write_1__VAL_1 =
	     tlp_readReq$D_OUT[28:19] - y__h55992 ;
  assign MUX_tlp_rdRespDwRemain$write_1__VAL_2 = tlp_rdRespDwRemain - 10'd4 ;
  assign MUX_tlp_readNxtDWAddr$write_1__VAL_1 =
	     tlp_mReqF$D_OUT[41:29] + y__h52573 ;
  assign MUX_tlp_readNxtDWAddr$write_1__VAL_2 = tlp_readNxtDWAddr + 13'd4 ;
  assign MUX_tlp_readRemainDWLen$write_1__VAL_1 =
	     tlp_mReqF$D_OUT[28:19] - y__h52525 ;
  assign MUX_tlp_readRemainDWLen$write_1__VAL_2 =
	     tlp_readRemainDWLen - 10'd4 ;
  assign MUX_tlp_remMesgAccu$write_1__VAL_2 = tlp_remMesgAccu + y__h27089 ;
  assign MUX_tlp_remMesgAccu$write_1__VAL_3 = tlp_remMesgAccu + y__h40104 ;
  assign MUX_tlp_reqMesgInFlight$write_1__VAL_2 =
	     !tlp_dmaPullRemainDWSub_038_ULE_4___d2588 ||
	     !tlp_dmaPullRemainDWLen_024_ULE_tlp_dmaPullRema_ETC___d2587 ;
  assign MUX_tlp_srcMesgAccu$write_1__VAL_2 = tlp_srcMesgAccu + y__h27041 ;
  assign MUX_tlp_tlpXmtBusy$write_1__VAL_3 =
	     tlp_fabMesgAddrMS != 32'd0 || tlp_mRespF$D_OUT[71:62] != 10'd1 ;
  assign MUX_tlp_writeDWAddr$write_1__VAL_1 =
	     tlp_mReqF$D_OUT[62:50] + y__h43829 ;
  assign MUX_tlp_writeDWAddr$write_1__VAL_2 = tlp_writeDWAddr + 13'd4 ;
  assign MUX_tlp_writeRemainDWLen$write_1__VAL_1 =
	     tlp_mReqF$D_OUT[49:40] - y__h43881 ;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, _theResult____h80124 } ;
  ...
  assign MUX_wmi_wmi_respF_q_0$write_1__VAL_1 = { 2'd1, rdata__h72833 } ;
  ...
  assign bram_serverAdapterA_writeWithResp$wget = ab__h1597 ;
  ...
  assign bram_serverAdapterB_outData_enqData$whas =
	     ...
	     bram_serverAdapterB_s1[0] ;
  assign bram_serverAdapterB_outData_outData$wget = y_avValue__h72669 ;
  ...
  assign bram_serverAdapterB_writeWithResp$wget = ab__h2996 ;
  ...
  assign bram_serverAdapterB_1_outData_enqData$whas =
	     ...
	     bram_serverAdapterB_1_s1[0] ;
  assign bram_serverAdapterB_1_outData_outData$wget = y_avValue__h72689 ;
  ...
  assign bram_serverAdapterB_1_writeWithResp$wget = ab__h5923 ;
  ...
  assign bram_serverAdapterA_2_writeWithResp$wget = ab__h7453 ;
  ...
  assign bram_serverAdapterB_2_outData_enqData$whas =
	     ...
	     bram_serverAdapterB_2_s1[0] ;
  assign bram_serverAdapterB_2_outData_outData$wget = y_avValue__h72709 ;
  ...
  assign bram_serverAdapterB_2_writeWithResp$wget = ab__h8850 ;
  ...
  assign bram_serverAdapterA_3_writeWithResp$wget = ab__h10380 ;
  ...
  assign bram_serverAdapterA_3_s1_1$wget =
	     { 1'd1, !ab__h10380[1] || ab__h10380[0] } ;
  ...
  assign bram_serverAdapterB_3_outData_enqData$whas =
	     ...
	     bram_serverAdapterB_3_s1[0] ;
  assign bram_serverAdapterB_3_outData_outData$wget = y_avValue__h72729 ;
  ...
  assign bram_serverAdapterB_3_writeWithResp$wget = ab__h11777 ;
  ...
  assign bram_serverAdapterB_3_s1_1$wget =
	     { 1'd1, !ab__h11777[1] || ab__h11777[0] } ;
  ...
  assign tlp_pullTagMatch_1$wget =
	     tagm__h39897 == tlp_inF$D_OUT[47:40] &&
	     tlp_inF_first__16_BITS_63_TO_56_19_EQ_pciDevic_ETC___d929 ;
  assign tlp_pullTagMatch_1$whas =
	     tlp_inF$EMPTY_N && hasPull && !dpControl[8] &&
	     dpControl[7:4] == 4'd0 &&
	     dpControl[3:2] == 2'd2 &&
	     dpControl[1:0] == 2'd1 ;
  ...
  assign bml_fabBuf_incAction$whas = MUX_bml_fabMesgAddr$write_1__SEL_1 ;
  ...
  // register bml_fabFlowAddr
  always@(MUX_bml_fabMesgAddr$write_1__SEL_1 or
  ...
  // register bml_fabFlowAddrMS
  assign bml_fabFlowAddrMS$D_IN = 32'h0 ;
  assign bml_fabFlowAddrMS$EN = 1'b0 ;
  ...
  // register bml_fabMesgAddrMS
  assign bml_fabMesgAddrMS$D_IN = 32'h0 ;
  assign bml_fabMesgAddrMS$EN = 1'b0 ;
  ...
  // register bml_fabMetaAddrMS
  assign bml_fabMetaAddrMS$D_IN = 32'h0 ;
  assign bml_fabMetaAddrMS$EN = 1'b0 ;
  ...
  // register dpControl
  assign dpControl$D_IN = wci_reqF$D_OUT[8:0] ;
  assign dpControl$EN =
  ...
  begin
    case (1'b1) // synopsys parallel_case
      WILL_FIRE_RL_tlp_dmaPullRequestFarMesg:
	  tlp_dmaPullRemainDWLen$D_IN = thisRequestLength__h39445[11:2];
      WILL_FIRE_RL_tlp_dmaPullResponseHeader:
  ...
  // register tlp_fabMesgAddrMS
  assign tlp_fabMesgAddrMS$D_IN = bml_fabMesgAddrMS ;
  ...
  // register tlp_fabMetaAddrMS
  assign tlp_fabMetaAddrMS$D_IN = bml_fabMetaAddrMS ;
  ...
  always@(WILL_FIRE_RL_tlp_dmaPullResponseHeader or
	  tlp_inF$D_OUT or
	  WILL_FIRE_RL_tlp_dmaPullResponseBody or
	  tlp_dmaPullRemainDWSub_038_ULE_4___d2588 or
	  WILL_FIRE_RL_tlp_dmaPullRequestFarMesg)
  begin
    case (1'b1) // synopsys parallel_case
      WILL_FIRE_RL_tlp_dmaPullResponseHeader:
  ...
  // register tlp_remMesgAccu
  always@(MUX_tlp_fabMesgAccu$write_1__SEL_2 or
	  tlp_remMesgAddr or
	  WILL_FIRE_RL_tlp_dmaPushRequestMesg or
  ...
  begin
    case (1'b1) // synopsys parallel_case
      ...
      WILL_FIRE_RL_tlp_dmaPullResponseBody:
	  tlp_tlpRcvBusy$D_IN = !tlp_dmaPullRemainDWSub_038_ULE_4___d2588;
  ...
  always@(MUX_tlp_tlpXmtBusy$write_1__SEL_3 or
	  MUX_tlp_tlpXmtBusy$write_1__VAL_3 or
  ...
  begin
    case (1'b1) // synopsys parallel_case
      MUX_tlp_tlpXmtBusy$write_1__SEL_3:
	  tlp_tlpXmtBusy$D_IN = MUX_tlp_tlpXmtBusy$write_1__VAL_3;
  ...
  assign wmi_wmi_sFlagReg$D_IN =
	     { y_avValue__h72689[7:0], y_avValue__h72669[23:0] } ;
  ...
  begin
    case (1'b1) // synopsys parallel_case
      ...
      WILL_FIRE_RL_wmi_doWriteFinalize: bram_memory$DIB = x3__h71074;
  ...
  begin
    case (1'b1) // synopsys parallel_case
      ...
      WILL_FIRE_RL_wmi_doWriteFinalize:
	  bram_memory_1$DIB = mesgMeta_opcode__h71114;
  ...
  // submodule tlp_readReq
  assign tlp_readReq$D_IN = tlp_mReqF$D_OUT[60:0] ;
  ...
  // remaining internal signals
  assign IF_1_MINUS_tlp_writeDWAddr_187_BITS_1_TO_0_188_ETC___d1237 =
	     (IF_1_MINUS_tlp_writeDWAddr_187_BITS_1_TO_0_188_ETC___d1214 ||
	      bram_serverAdapterA_1_cnt_44_SLT_3___d2591) &&
	     (IF_2_MINUS_tlp_writeDWAddr_187_BITS_1_TO_0_188_ETC___d1224 ||
	      bram_serverAdapterA_2_cnt_62_SLT_3___d2592) &&
	     (IF_3_MINUS_tlp_writeDWAddr_187_BITS_1_TO_0_188_ETC___d1234 ||
	      bram_serverAdapterA_3_cnt_80_SLT_3___d2593) ;
  assign IF_tlp_readReq_first__432_BITS_30_TO_29_433_EQ_ETC___d1455 =
	     (tlp_readReq$D_OUT[30:29] == 2'd0) ?
	       (bram_serverAdapterA_outDataCore$EMPTY_N ||
		bram_serverAdapterA_outData_enqData$whas) &&
	       bram_serverAdapterA_outData_outData$whas :
	       IF_tlp_readReq_first__432_BITS_30_TO_29_433_EQ_ETC___d1447 &&
	       CASE_tlp_readReqD_OUT_BITS_30_TO_29_NOT_tlp_r_ETC__q17 ;
  assign IF_tlp_readReq_first__432_BITS_30_TO_29_433_PL_ETC___d1571 =
	     tlp_readReq_first__432_BITS_30_TO_29_433_PLUS_1___d2729[0] ?
	       { bram_serverAdapterA_3_outData_outData$wget[7:0],
		 bram_serverAdapterA_3_outData_outData$wget[15:8],
		 bram_serverAdapterA_3_outData_outData$wget[23:16],
		 bram_serverAdapterA_3_outData_outData$wget[31:24],
		 ...
		 bram_serverAdapterA_1_outData_outData$wget[23:16],
		 bram_serverAdapterA_1_outData_outData$wget[31:24] } ;
  assign IF_tlp_readReq_first__432_BITS_30_TO_29_433_PL_ETC___d1576 =
	     tlp_readReq_first__432_BITS_30_TO_29_433_PLUS_1___d2729[0] ?
	       { bram_serverAdapterA_1_outData_outData$wget[7:0],
		 bram_serverAdapterA_1_outData_outData$wget[15:8],
		 bram_serverAdapterA_1_outData_outData$wget[23:16],
		 ...
		 bram_serverAdapterA_3_outData_outData$wget[23:16],
		 bram_serverAdapterA_3_outData_outData$wget[31:24] } ;
  assign IF_wmi_p4B_855_EQ_0_856_THEN_bram_serverAdapte_ETC___d1869 =
	     (wmi_p4B == 2'd0) ?
	       (bram_serverAdapterB_outDataCore$EMPTY_N ||
		bram_serverAdapterB_outData_enqData$whas) &&
	       bram_serverAdapterB_outData_outData$whas :
	       IF_wmi_p4B_855_EQ_1_858_THEN_bram_serverAdapte_ETC___d1864 &&
	       CASE_wmi_p4B_NOT_wmi_p4B_EQ_3_OR_bram_serverAd_ETC__q18 ;
  assign NOT_bml_lclBufDone_993_060_AND_IF_bml_dpContro_ETC___d2073 =
	     !bml_lclBufDone &&
	     CASE_dpControl_BITS_1_TO_0_bml_fabDone_0_bml_f_ETC__q2 ;
  assign NOT_wmi_wrActive_770_771_OR_NOT_wmi_rdActive_7_ETC___d1780 =
  ...
  assign ab__h8850 =
	     (MUX_bram_memory_2$b_put_1__SEL_1 ||
	      WILL_FIRE_RL_wmi_reqMetadata) ?
	       2'd0 :
	       2'd2 ;
  assign bml_crdBuf_value_951_EQ_bml_crdBuf_modulus_bw__ETC___d2696 =
	     bml_crdBuf_value == bml_crdBuf_modulus ;
  assign bml_fabBuf_value_936_EQ_bml_fabBuf_modulus_bw__ETC___d2698 =
	     bml_fabBuf_value == bml_fabBuf_modulus ;
  assign bml_fabFlowAddr_008_PLUS_bml_fabFlowSize_009___d2586 =
	     bml_fabFlowAddr + bml_fabFlowSize ;
  assign bml_lclBufDone_993_AND_IF_bml_dpControl_wget___ETC___d2792 =
	     bml_lclBufDone &&
	     CASE_dpControl_BITS_1_TO_0_NOT_bml_fabDone_0_N_ETC__q6 ;
  assign bml_lclBuf_value_906_EQ_bml_lclBuf_modulus_bw__ETC___d2695 =
	     bml_lclBuf_value == bml_lclBuf_modulus ;
  assign bml_remBuf_value_921_EQ_bml_remBuf_modulus_bw__ETC___d2697 =
  ...
  assign bram_serverAdapterA_1_cnt_44_SLT_3___d2591 =
	     (bram_serverAdapterA_1_cnt ^ 3'h4) < 3'd7 ;
  assign bram_serverAdapterA_1_outDataCore_notEmpty__20_ETC___d1530 =
	     (bram_serverAdapterA_1_outDataCore$EMPTY_N ||
	      bram_serverAdapterA_1_outData_enqData$whas) &&
	     (bram_serverAdapterA_2_outDataCore$EMPTY_N ||
	      bram_serverAdapterA_2_outData_enqData$whas) &&
  ...
  assign bram_serverAdapterA_2_cnt_62_SLT_3___d2592 =
  ...
  assign bram_serverAdapterA_3_cnt_80_SLT_3___d2593 =
	     (bram_serverAdapterA_3_cnt ^ 3'h4) < 3'd7 ;
  assign bram_serverAdapterA_3_outDataCore_notEmpty__56_ETC___d1528 =
	     (bram_serverAdapterA_3_outDataCore$EMPTY_N ||
	      bram_serverAdapterA_3_outData_enqData$whas) &&
	     bram_serverAdapterA_outData_outData$whas &&
	     bram_serverAdapterA_1_outData_outData$whas &&
	     bram_serverAdapterA_2_outData_outData$whas &&
	     bram_serverAdapterA_3_outData_outData$whas &&
	     (!tlp_rdRespDwRemain_520_ULE_4___d1521 || tlp_readReq$EMPTY_N) ;
  ...
  assign bram_serverAdapterA_cnt_6_SLT_3___d2590 =
  ...
  assign bram_serverAdapterB_1_cnt_03_SLT_3___d1720 =
	     (bram_serverAdapterB_1_cnt ^ 3'h4) < 3'd7 ;
  assign bram_serverAdapterB_1_outData_outData_whas__74_ETC___d1748 =
	     bram_serverAdapterB_1_outData_outData$whas &&
	     (bram_serverAdapterB_2_outDataCore$EMPTY_N ||
	      bram_serverAdapterB_2_outData_enqData$whas) &&
	     bram_serverAdapterB_2_outData_outData$whas &&
  ...
  assign bram_serverAdapterB_2_cnt_21_SLT_3___d1721 =
  ...
  assign bram_serverAdapterB_3_cnt_39_SLT_3___d1722 =
  ...
  assign bram_serverAdapterB_cnt_5_SLT_3___d1719 =
	     (bram_serverAdapterB_cnt ^ 3'h4) < 3'd7 ;
  assign byteCount__h54933 = x__h55050 - y__h55051 ;
  assign hasPull_AND_NOT_tlp_dpControl_wget__34_BIT_8_3_ETC___d1016 =
	     hasPull && !dpControl[8] && dpControl[7:4] == 4'd0 &&
	     dpControl[3:2] == 2'd2 &&
	     dpControl[1:0] == 2'd1 &&
	     tlp_fabMeta[128] &&
	     tlp_reqMesgInFlight &&
  ...
  assign hasPull_AND_NOT_tlp_dpControl_wget__34_BIT_8_3_ETC___d1036 =
	     hasPull && !dpControl[8] && dpControl[7:4] == 4'd0 &&
	     dpControl[3:2] == 2'd2 &&
	     dpControl[1:0] == 2'd1 &&
	     tlp_fabMeta[128] &&
	     tlp_reqMesgInFlight &&
	     tlp_gotResponseHeader ;
  assign hasPull_AND_NOT_tlp_dpControl_wget__34_BIT_8_3_ETC___d1061 =
	     hasPull && !dpControl[8] && dpControl[7:4] == 4'd0 &&
	     dpControl[3:2] == 2'd2 &&
	     dpControl[1:0] == 2'd1 &&
	     tlp_fabMeta[128] &&
  ...
  assign hasPull_AND_NOT_tlp_dpControl_wget__34_BIT_8_3_ETC___d894 =
	     hasPull && !dpControl[8] && dpControl[7:4] == 4'd0 &&
	     dpControl[3:2] == 2'd2 &&
	     dpControl[1:0] == 2'd1 &&
	     !tlp_tlpXmtBusy &&
	     ...
	     !tlp_reqMetaBodyInFlight &&
	     !tlp_fabMeta[128] ;
  assign hasPull_AND_NOT_tlp_dpControl_wget__34_BIT_8_3_ETC___d931 =
	     hasPull && !dpControl[8] && dpControl[7:4] == 4'd0 &&
	     dpControl[3:2] == 2'd2 &&
	     dpControl[1:0] == 2'd1 &&
	     tlp_reqMetaInFlight &&
	     ...
	     tagm__h39897 == tlp_inF$D_OUT[47:40] &&
	     tlp_inF_first__16_BITS_63_TO_56_19_EQ_pciDevic_ETC___d929 ;
  assign hasPull_AND_NOT_tlp_dpControl_wget__34_BIT_8_3_ETC___d983 =
	     hasPull && !dpControl[8] && dpControl[7:4] == 4'd0 &&
	     dpControl[3:2] == 2'd2 &&
	     dpControl[1:0] == 2'd1 &&
	     tlp_fabMeta[128] &&
  ...
  assign hasPush_AND_NOT_tlp_dpControl_wget__34_BIT_8_3_ETC___d658 =
	     hasPush && !dpControl[8] && dpControl[7:4] == 4'd0 &&
	     dpControl[3:2] == 2'd1 &&
	     dpControl[1:0] == 2'd1 &&
	     !tlp_tlpRcvBusy &&
	     !tlp_reqMetaInFlight &&
	     !tlp_fabMeta[128] &&
	     tlp_nearBufReady ;
  assign hasPush_AND_NOT_tlp_dpControl_wget__34_BIT_8_3_ETC___d733 =
	     hasPush && !dpControl[8] && dpControl[7:4] == 4'd0 &&
	     dpControl[3:2] == 2'd1 &&
	     dpControl[1:0] == 2'd1 &&
	     tlp_fabMeta[128] &&
  ...
  assign hasPush_AND_NOT_tlp_dpControl_wget__34_BIT_8_3_ETC___d773 =
	     hasPush && !dpControl[8] && dpControl[7:4] == 4'd0 &&
	     dpControl[3:2] == 2'd1 &&
	     dpControl[1:0] == 2'd1 &&
	     !tlp_mRespF$D_OUT[138] &&
	     ...
	     !tlp_tlpXmtBusy &&
	     tlp_postSeqDwell == 4'd0 ;
  assign hasPush_AND_NOT_tlp_dpControl_wget__34_BIT_8_3_ETC___d829 =
	     hasPush && !dpControl[8] && dpControl[7:4] == 4'd0 &&
	     dpControl[3:2] == 2'd1 &&
	     dpControl[1:0] == 2'd1 &&
	     tlp_fabMeta[128] &&
	     ...
	     tlp_xmtMetaOK &&
	     tlp_postSeqDwell == 4'd0 ;
  assign hasPush_AND_NOT_tlp_dpControl_wget__34_BIT_8_3_ETC___d844 =
	     hasPush && !dpControl[8] && dpControl[7:4] == 4'd0 &&
	     dpControl[3:2] == 2'd1 &&
	     dpControl[1:0] == 2'd1 &&
	     tlp_fabMeta[128] &&
	     tlp_doXmtMetaBody ;
  assign hasPush_AND_NOT_tlp_dpControl_wget__34_BIT_8_3_ETC___d870 =
	     hasPush && !dpControl[8] && dpControl[7:4] == 4'd0 &&
	     dpControl[3:2] == 2'd1 &&
	     dpControl[1:0] == 2'd1 &&
	     tlp_fabMeta[128] &&
	     tlp_tlpMetaSent ;
  assign idx__h45592 = 2'd0 - tlp_writeDWAddr[1:0] ;
  assign idx__h47823 = 2'd1 - tlp_writeDWAddr[1:0] ;
  assign idx__h49127 = 2'd2 - tlp_writeDWAddr[1:0] ;
  assign idx__h50431 = 2'd3 - tlp_writeDWAddr[1:0] ;
  assign idx__h52813 = 2'd0 - tlp_readNxtDWAddr[1:0] ;
  assign idx__h53281 = 2'd1 - tlp_readNxtDWAddr[1:0] ;
  assign idx__h53654 = 2'd2 - tlp_readNxtDWAddr[1:0] ;
  assign idx__h54027 = 2'd3 - tlp_readNxtDWAddr[1:0] ;
  assign lastBE__h27358 =
	     tlp_mRespF_first__75_BITS_71_TO_62_75_ULE_1___d2731 ?
	       4'd0 :
	       4'd15 ;
  assign lastBE__h39747 =
	     (thisRequestLength__h39445[11:2] == 10'd1) ? 4'd0 : 4'd15 ;
  assign lowAddr__h54932 = { tlp_readReq$D_OUT[33:29], lowAddr10__h54931 } ;
  assign mesgMeta_opcode__h71114 =
	     { 24'h800000, wmi_wmi_mFlagF$D_OUT[31:24] } ;
  assign nowLS__h25675 =
	     { tlp_mRespF$D_OUT[39:32],
	       tlp_mRespF$D_OUT[47:40],
	       tlp_mRespF$D_OUT[55:48],
	       tlp_mRespF$D_OUT[63:56] } ;
  assign nowLS__h38194 =
	     { tlp_inF$D_OUT[39:32],
	       tlp_inF$D_OUT[47:40],
	       tlp_inF$D_OUT[55:48],
	       tlp_inF$D_OUT[63:56] } ;
  assign nowMS__h24732 =
	     { tlp_mRespF$D_OUT[71:64],
	       tlp_mRespF$D_OUT[79:72],
	       tlp_mRespF$D_OUT[87:80],
	       tlp_mRespF$D_OUT[95:88] } ;
  assign nowMS__h37253 =
	     { tlp_inF$D_OUT[71:64],
	       tlp_inF$D_OUT[79:72],
	       tlp_inF$D_OUT[87:80],
	       tlp_inF$D_OUT[95:88] } ;
  assign opcode__h23501 =
	     { tlp_mRespF$D_OUT[103:96],
	       tlp_mRespF$D_OUT[111:104],
	       tlp_mRespF$D_OUT[119:112],
	       tlp_mRespF$D_OUT[127:120] } ;
  assign opcode__h36033 =
  ...
  assign rdat__h80203 = { 16'd0, bml_lclNumBufs } ;
  assign rdat__h80211 = { 16'd0, bml_fabNumBufs } ;
  assign rdat__h80219 = { 16'd0, bml_mesgBase } ;
  assign rdat__h80227 = { 16'd0, bml_metaBase } ;
  assign rdat__h80235 = { 16'd0, bml_mesgSize } ;
  assign rdat__h80243 = { 16'd0, bml_metaSize } ;
  assign rdat__h80251 = { 16'd0, bml_lclBufsCF } ;
  assign rdat__h80268 = hasDebugLogic ? 32'hF00DFACE : 32'd0 ;
  assign rdat__h80274 =
  ...
  assign rdat__h80308 = hasDebugLogic ? wmi_thisMesg : 32'd0 ;
  assign rdat__h80572 = hasDebugLogic ? wmi_lastMesg : 32'd0 ;
  assign rdat__h80622 =
	     hasDebugLogic ? { wmi_reqCount, wmi_wrtCount } : 32'd0 ;
  assign rdat__h80722 = hasDebugLogic ? 32'hDADEBABE : 32'd0 ;
  assign rdat__h80728 = hasDebugLogic ? 32'h00008000 : 32'd0 ;
  assign rdat__h80782 = { 23'd0, dpControl } ;
  assign rdat__h80810 = hasDebugLogic ? tlp_flowDiagCount : 32'd0 ;
  assign rdat__h80820 =
	     hasDebugLogic ?
	       { 4'h0,
		 tlp_complTimerCount,
		 ...
		 CASE_tlp_lastRuleFired_8_1_tlp_lastRuleFired_2_ETC__q1 } :
	       32'd0 ;
  assign rdat__h80926 = hasDebugLogic ? tlp_lastMetaV : 32'd0 ;
  assign rdat__h81047 = hasDebugLogic ? tlp_lastMetaV_1 : 32'd0 ;
  assign rdat__h81076 = hasDebugLogic ? tlp_lastMetaV_2 : 32'd0 ;
  assign rdat__h81105 = hasDebugLogic ? tlp_lastMetaV_3 : 32'd0 ;
  assign rdat__h81134 = hasDebugLogic ? 32'hC0DE0111 : 32'd0 ;
  assign rdata__h60363 =
	     tlp_readReq_first__432_BITS_30_TO_29_433_PLUS_1___d2729[1] ?
	       IF_tlp_readReq_first__432_BITS_30_TO_29_433_PL_ETC___d1571 :
	       IF_tlp_readReq_first__432_BITS_30_TO_29_433_PL_ETC___d1576 ;
  assign rreq_tag__h27137 =
	     (y__h26947 == tlp_mesgLengthRemainPush) ? 8'h01 : 8'h0 ;
  assign rresp_data__h54976 =
	     { IF_tlp_readReq_first__432_BITS_30_TO_29_433_EQ_ETC___d2338[7:0],
	       IF_tlp_readReq_first__432_BITS_30_TO_29_433_EQ_ETC___d2338[15:8],
	       IF_tlp_readReq_first__432_BITS_30_TO_29_433_EQ_ETC___d2338[23:16],
	       IF_tlp_readReq_first__432_BITS_30_TO_29_433_EQ_ETC___d2338[31:24] } ;
  assign spanToNextPage__h26921 = 13'd4096 - { 1'd0, tlp_srcMesgAccu[11:0] } ;
  assign spanToNextPage__h39444 = 13'd4096 - { 1'd0, tlp_fabMesgAccu[11:0] } ;
  assign tag__h39720 = { 3'd0, tlp_dmaTag } ;
  assign tagm__h39897 = { 3'd0, tlp_dmaReqTag } ;
  assign thisRequestLength__h26922 =
	     (x__h26960[12:0] <= spanToNextPage__h26921) ?
	       x__h26960[12:0] :
	       spanToNextPage__h26921 ;
  assign thisRequestLength__h39445 =
	     (x__h39478[12:0] <= spanToNextPage__h39444) ?
	       x__h39478[12:0] :
	       spanToNextPage__h39444 ;
  assign tlp_dmaPullRemainDWLen_024_ULE_tlp_dmaPullRema_ETC___d2587 =
	     tlp_dmaPullRemainDWLen <= tlp_dmaPullRemainDWSub ;
  assign tlp_dmaPullRemainDWSub_038_ULE_4___d2588 =
	     tlp_dmaPullRemainDWSub <= 10'd4 ;
  assign tlp_inF_first__16_BITS_63_TO_56_19_EQ_pciDevic_ETC___d929 =
	     tlp_inF$D_OUT[63:56] == pciDevice[15:8] &&
	     tlp_inF$D_OUT[55:51] == pciDevice[7:3] &&
	     tlp_inF$D_OUT[50:48] == pciDevice[2:0] ;
  assign tlp_inF_first__16_BIT_152_079_AND_NOT_tlp_inF__ETC___d1104 =
	     tlp_inF$D_OUT[152] && !tlp_inF$D_OUT[110] &&
	     !tlp_inF$D_OUT[125] &&
	     tlp_inF$D_OUT[124:120] == 5'b0 ||
	     !tlp_inF$D_OUT[152] && !tlp_inIgnorePkt ;
  assign tlp_mReqF_first__146_BIT_60_335_OR_IF_tlp_mReq_ETC___d1348 =
	     tlp_mReqF$D_OUT[60] ||
	     CASE_tlp_mReqFD_OUT_BITS_30_TO_29_NOT_tlp_mRe_ETC__q5 ;
  assign tlp_mReqF_first__146_BIT_63_147_OR_IF_tlp_mReq_ETC___d1162 =
	     tlp_mReqF$D_OUT[63] ||
	     CASE_tlp_mReqFD_OUT_BITS_51_TO_50_NOT_tlp_mRe_ETC__q4 ;
  assign tlp_mRespF_first__75_BITS_71_TO_62_75_ULE_1___d2731 =
	     tlp_mRespF$D_OUT[71:62] <= 10'd1 ;
  ...
  assign tlp_outDwRemain_03_ULE_4___d2426 = tlp_outDwRemain <= 10'd4 ;
  assign tlp_rdRespDwRemain_520_ULE_4___d1521 = tlp_rdRespDwRemain <= 10'd4 ;
  ...
  assign tlp_readRemainDWLen_372_ULE_4___d1373 =
	     tlp_readRemainDWLen <= 10'd4 ;
  assign tlp_readReq_first__432_BITS_30_TO_29_433_PLUS_1___d2729 =
	     tlp_readReq$D_OUT[30:29] + 2'd1 ;
  ...
  assign tlp_writeRemainDWLen_191_ULE_1___d2733 =
	     tlp_writeRemainDWLen <= 10'd1 ;
  assign tlp_writeRemainDWLen_191_ULE_2___d2734 =
	     tlp_writeRemainDWLen <= 10'd2 ;
  assign tlp_writeRemainDWLen_191_ULE_3___d2735 =
	     tlp_writeRemainDWLen <= 10'd3 ;
  assign w_be__h28066 =
	     tlp_outDwRemain_03_ULE_4___d2426 ?
	       CASE_tlp_outDwRemain_BITS_1_TO_0_0xFFF0_0b0_0x_ETC__q3 :
	       16'd65535 ;
  assign w_data__h27331 =
	     { 22'd1048576,
	       tlp_mRespF$D_OUT[71:62],
	       pciDevice,
	       8'd0,
  ...
  assign w_data__h32717 =
	     { 32'd4,
	       ...
	       34'd0 } ;
  assign w_data__h39726 =
	     { 22'd0,
	       thisRequestLength__h39445[11:2],
	       pciDevice,
	       tag__h39720,
	       lastBE__h39747,
	       4'd15,
	       ...
	       34'd0 } ;
  assign w_data__h41243 =
	     { 32'd1073741825,
	       pciDevice,
	       16'd15,
	       tlp_fabFlowAddr,
	       32'd16777216 } ;
  assign wmi_dpControl_whas__706_AND_bram_serverAdapter_ETC___d1752 =
	     (bram_serverAdapterB_outDataCore$EMPTY_N ||
	      bram_serverAdapterB_outData_enqData$whas) &&
	     bram_serverAdapterB_outData_outData$whas &&
	     (bram_serverAdapterB_1_outDataCore$EMPTY_N ||
	      bram_serverAdapterB_1_outData_enqData$whas) &&
	     bram_serverAdapterB_1_outData_outData_whas__74_ETC___d1748 ;
  assign wmi_wmi_operateD_659_AND_wmi_wmi_peerIsReady_6_ETC___d1834 =
	     wmi_wmi_operateD && wmi_wmi_peerIsReady &&
	     bram_serverAdapterB_cnt_5_SLT_3___d1719 &&
	     bram_serverAdapterB_1_cnt_03_SLT_3___d1720 &&
	     bram_serverAdapterB_2_cnt_21_SLT_3___d1721 &&
	     bram_serverAdapterB_3_cnt_39_SLT_3___d1722 &&
	     wmi_wmi_mFlagF$EMPTY_N ;
  assign x3__h71074 = { 8'd0, wmi_wmi_mFlagF$D_OUT[23:0] } ;
  assign x__h21667 =
	     { tlp_mRespF$D_OUT[7:0],
	       tlp_mRespF$D_OUT[15:8],
	       tlp_mRespF$D_OUT[23:16],
	       tlp_mRespF$D_OUT[31:24] } ;
  assign x__h26678 = { 15'd0, tlp_mesgLengthRemainPush } ;
  assign x__h26960 =
	     (tlp_mesgLengthRemainPush <= y__h26962) ?
  ...
  assign x__h34005 =
	     { tlp_inF$D_OUT[7:0],
	       ...
	       tlp_inF$D_OUT[23:16],
	       tlp_inF$D_OUT[31:24] } ;
  assign x__h39164 = { 15'd0, tlp_mesgLengthRemainPull } ;
  assign x__h39478 =
	     (tlp_mesgLengthRemainPull <= y__h39480) ?
	       tlp_mesgLengthRemainPull :
	       y__h39480 ;
  assign x__h55050 = x__h55052 - y__h55053 ;
  assign x__h55052 = { tlp_readReq$D_OUT[28:19], 2'b0 } ;
  assign x__h77105 = (dpControl[1:0] == 2'd1) ? bml_fabNumBufs : 16'd0 ;
  assign x__h78229 = bml_lclBufsAR + 16'd1 ;
  assign x__h78234 = bml_lclBufsAR - 16'd1 ;
  assign x__h78306 = bml_lclBufsCF + 16'd1 ;
  assign x__h78311 = bml_lclBufsCF - 16'd1 ;
  assign x__h78348 = bml_fabBufsAvail + 16'd1 ;
  assign x__h78353 = bml_fabBufsAvail - 16'd1 ;
  assign x__h78386 = bml_lclCredit + 16'd1 ;
  assign x__h78391 = bml_lclCredit - 16'd1 ;
  assign y__h26947 = { 4'd0, thisRequestLength__h26922 } ;
  assign y__h26962 = { 4'd0, tlp_maxPayloadSize } ;
  assign y__h27041 = { 19'd0, thisRequestLength__h26922 } ;
  assign y__h27089 = { 3'd0, thisRequestLength__h26922 } ;
  assign y__h27495 = { 20'd0, tlp_mRespF$D_OUT[71:62], 2'd0 } ;
  assign y__h39470 = { 4'd0, thisRequestLength__h39445 } ;
  assign y__h39480 = { 4'd0, tlp_maxReadReqSize } ;
  assign y__h39541 = { 19'd0, thisRequestLength__h39445 } ;
  assign y__h40104 = { 4'd0, tlp_inF$D_OUT[105:96], 2'd0 } ;
  assign y__h40811 =
	     tlp_dmaPullRemainDWSub_038_ULE_4___d2588 ?
	       { 5'd0, tlp_dmaPullRemainDWSub, 2'd0 } :
	       17'd16 ;
  assign y__h43829 = tlp_mReqF$D_OUT[63] ? 13'd0 : 13'd1 ;
  assign y__h43881 = tlp_mReqF$D_OUT[63] ? 10'd0 : 10'd1 ;
  assign y__h52525 = tlp_mReqF$D_OUT[60] ? 10'd0 : 10'd1 ;
  assign y__h52573 = tlp_mReqF$D_OUT[60] ? 13'd0 : 13'd1 ;
  assign y__h55051 =
	     (tlp_readReq$D_OUT[28:19] == 10'd1) ?
	       12'd0 :
	       { 10'd0, x__h55082 } ;
  assign y__h55053 = { 10'd0, x__h55059 } ;
  assign y__h55992 = tlp_readReq$D_OUT[60] ? 10'd0 : 10'd1 ;
  assign y_avValue__h72669 =
	     bram_serverAdapterB_outDataCore$EMPTY_N ?
	       bram_serverAdapterB_outDataCore$D_OUT :
	       bram_memory$DOB ;
  assign y_avValue__h72689 =
	     bram_serverAdapterB_1_outDataCore$EMPTY_N ?
	       bram_serverAdapterB_1_outDataCore$D_OUT :
	       bram_memory_1$DOB ;
  assign y_avValue__h72709 =
	     bram_serverAdapterB_2_outDataCore$EMPTY_N ?
	       bram_serverAdapterB_2_outDataCore$D_OUT :
	       bram_memory_2$DOB ;
  assign y_avValue__h72729 =
	     bram_serverAdapterB_3_outDataCore$EMPTY_N ?
	       bram_serverAdapterB_3_outDataCore$D_OUT :
	       bram_memory_3$DOB ;
  ...
  begin
    case (tlp_readReq$D_OUT[18:15])
      4'b1100: x__h55059 = 2'b10;
      4'b1110: x__h55059 = 2'b01;
      4'b1111: x__h55059 = 2'b0;
      default: x__h55059 = 2'b11;
    endcase
  end
  always@(tlp_readReq$D_OUT)
  begin
    case (tlp_readReq$D_OUT[14:11])
      4'b1100: x__h55082 = 2'b10;
      4'b1110: x__h55082 = 2'b01;
      4'b1111: x__h55082 = 2'b0;
      default: x__h55082 = 2'b11;
    endcase
  end
  ...
  always@(wmi_p4B or
	  y_avValue__h72729 or
	  y_avValue__h72669 or y_avValue__h72689 or y_avValue__h72709)
  begin
    case (wmi_p4B)
      2'd0: rdata__h72833 = y_avValue__h72669;
      2'd1: rdata__h72833 = y_avValue__h72689;
      2'd2: rdata__h72833 = y_avValue__h72709;
      2'd3: rdata__h72833 = y_avValue__h72729;
    endcase
  end
  always@(wci_reqF$D_OUT or
	  ...
	  rdat__h81105 or
	  rdat__h81134 or
	  bml_fabMesgBaseMS or bml_fabMetaBaseMS or bml_fabFlowBaseMS)
  begin
    case (wci_reqF$D_OUT[39:32])
      8'h0: _theResult____h80124 = rdat__h80203;
      8'h04: _theResult____h80124 = rdat__h80211;
      8'h08: _theResult____h80124 = rdat__h80219;
      8'h0C: _theResult____h80124 = rdat__h80227;
      8'h10: _theResult____h80124 = rdat__h80235;
      8'h14: _theResult____h80124 = rdat__h80243;
      8'h20: _theResult____h80124 = rdat__h80251;
      8'h24: _theResult____h80124 = rdat__h80268;
      8'h28: _theResult____h80124 = rdat__h80274;
      8'h2C: _theResult____h80124 = rdat__h80281;
      8'h30: _theResult____h80124 = rdat__h80294;
      8'h34: _theResult____h80124 = rdat__h80301;
      8'h38: _theResult____h80124 = rdat__h80308;
      8'h3C: _theResult____h80124 = rdat__h80572;
      8'h40: _theResult____h80124 = rdat__h80622;
      8'h44: _theResult____h80124 = 32'd0;
      8'h48: _theResult____h80124 = rdat__h80722;
      8'h4C: _theResult____h80124 = rdat__h80728;
      8'h50: _theResult____h80124 = bml_fabMesgBase;
      8'h54: _theResult____h80124 = bml_fabMetaBase;
      8'h58: _theResult____h80124 = bml_fabMesgSize;
      8'h5C: _theResult____h80124 = bml_fabMetaSize;
      8'h60: _theResult____h80124 = bml_fabFlowBase;
      8'h64: _theResult____h80124 = bml_fabFlowSize;
      8'h68: _theResult____h80124 = rdat__h80782;
      8'h6C: _theResult____h80124 = rdat__h80810;
      8'h70: _theResult____h80124 = rdat__h80820;
      8'h80: _theResult____h80124 = rdat__h80926;
      8'h84: _theResult____h80124 = rdat__h81047;
      8'h88: _theResult____h80124 = rdat__h81076;
      8'h8C: _theResult____h80124 = rdat__h81105;
      8'h90: _theResult____h80124 = rdat__h81134;
      8'h94: _theResult____h80124 = bml_fabMesgBaseMS;
      8'h98: _theResult____h80124 = bml_fabMetaBaseMS;
      8'h9C: _theResult____h80124 = bml_fabFlowBaseMS;
      default: _theResult____h80124 = 32'd0;
    endcase
  end
  always@(tlp_readReq$D_OUT)
  begin
    case (tlp_readReq$D_OUT[18:15])
      4'b1000: lowAddr10__h54931 = 2'b11;
      4'b1100: lowAddr10__h54931 = 2'b10;
      4'b1110: lowAddr10__h54931 = 2'b01;
      default: lowAddr10__h54931 = 2'b0;
    endcase
  end
  ...
  begin
    case (dpControl[1:0])
	  ...
	  IF_bml_dpControl_wget__969_BITS_1_TO_0_975_EQ__ETC___d2046 =
	      bml_remDone;
      default: IF_bml_dpControl_wget__969_BITS_1_TO_0_975_EQ__ETC___d2046 =
		   bml_fabDone;
    endcase
  end
  ...
  always@(idx__h45592 or
	  tlp_writeRemainDWLen_191_ULE_3___d2735 or
	  tlp_writeRemainDWLen or
	  tlp_writeRemainDWLen_191_ULE_1___d2733 or
	  tlp_writeRemainDWLen_191_ULE_2___d2734)
  begin
    case (idx__h45592)
      2'd0:
  ...
  always@(tlp_mReqF$D_OUT or
	  bram_serverAdapterA_3_cnt_80_SLT_3___d2593 or
	  bram_serverAdapterA_cnt_6_SLT_3___d2590 or
	  bram_serverAdapterA_1_cnt_44_SLT_3___d2591 or
	  bram_serverAdapterA_2_cnt_62_SLT_3___d2592)
  begin
  ...
  always@(wmi_addr or
	  bram_serverAdapterB_3_cnt_39_SLT_3___d1722 or
	  bram_serverAdapterB_cnt_5_SLT_3___d1719 or
	  bram_serverAdapterB_1_cnt_03_SLT_3___d1720 or
	  bram_serverAdapterB_2_cnt_21_SLT_3___d1721)
  begin
    case (wmi_addr[3:2])
      2'd0:
  ...
  always@(idx__h45592 or tlp_mReqF$D_OUT)
  begin
    case (idx__h45592)
      2'd0:
	  IF_0_MINUS_tlp_writeDWAddr_187_BITS_1_TO_0_188_ETC___d2334 =
  ...
  always@(idx__h47823 or tlp_mReqF$D_OUT)
  begin
    case (idx__h47823)
      2'd0:
	  IF_1_MINUS_tlp_writeDWAddr_187_BITS_1_TO_0_188_ETC___d2335 =
  ...
  always@(idx__h49127 or tlp_mReqF$D_OUT)
  begin
    case (idx__h49127)
      2'd0:
	  IF_2_MINUS_tlp_writeDWAddr_187_BITS_1_TO_0_188_ETC___d2336 =
  ...
  always@(idx__h50431 or tlp_mReqF$D_OUT)
  begin
    case (idx__h50431)
      2'd0:
	  IF_3_MINUS_tlp_writeDWAddr_187_BITS_1_TO_0_188_ETC___d2337 =
  ...
  begin
    case (tlp_readReq$D_OUT[30:29])
	  ...
	  IF_tlp_readReq_first__432_BITS_30_TO_29_433_EQ_ETC___d1447 =
	      bram_serverAdapterA_2_outDataCore$EMPTY_N ||
	      bram_serverAdapterA_2_outData_enqData$whas;
      default: IF_tlp_readReq_first__432_BITS_30_TO_29_433_EQ_ETC___d1447 =
		   tlp_readReq$D_OUT[30:29] != 2'd3 ||
		   bram_serverAdapterA_3_outDataCore$EMPTY_N ||
		   bram_serverAdapterA_3_outData_enqData$whas;
    endcase
  ...
  begin
    case (wmi_p4B)
	  ...
	  IF_wmi_p4B_855_EQ_1_858_THEN_bram_serverAdapte_ETC___d1864 =
	      bram_serverAdapterB_2_outDataCore$EMPTY_N ||
	      bram_serverAdapterB_2_outData_enqData$whas;
      default: IF_wmi_p4B_855_EQ_1_858_THEN_bram_serverAdapte_ETC___d1864 =
		   wmi_p4B != 2'd3 ||
		   bram_serverAdapterB_3_outDataCore$EMPTY_N ||
		   bram_serverAdapterB_3_outData_enqData$whas;
    endcase
  ...
  begin
	...
	dpControl <= `BSV_ASSIGNMENT_DELAY 9'd0;
    ...
    if (bml_fabFlowAddrMS$EN)
      bml_fabFlowAddrMS <= `BSV_ASSIGNMENT_DELAY bml_fabFlowAddrMS$D_IN;
    if (bml_fabMesgAddr$EN)
      bml_fabMesgAddr <= `BSV_ASSIGNMENT_DELAY bml_fabMesgAddr$D_IN;
    if (bml_fabMesgAddrMS$EN)
      bml_fabMesgAddrMS <= `BSV_ASSIGNMENT_DELAY bml_fabMesgAddrMS$D_IN;
    if (bml_fabMetaAddr$EN)
      bml_fabMetaAddr <= `BSV_ASSIGNMENT_DELAY bml_fabMetaAddr$D_IN;
    if (bml_fabMetaAddrMS$EN)
      bml_fabMetaAddrMS <= `BSV_ASSIGNMENT_DELAY bml_fabMetaAddrMS$D_IN;
    if (bml_lclBufsAR$EN)
  ...
  begin
    ...
    if (RST_N)
      if (WILL_FIRE_RL_tlp_dmaXmtMetaHead)
	$display("[%0d]: %m: dmaXmtMetaHead FPactMesg-Step5/7", v__h29398);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_tlp_dmaXmtTailEvent)
	$display("[%0d]: %m: dmaXmtTailEvent FPactMesg-Step7/7", v__h32277);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_tlp_dmaXmtMetaBody)
	$display("[%0d]: %m: dmaXmtMetaBody FPactMesg-Step6/7", v__h32157);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_tlp_dmaXmtDoorbell)
	$display("[%0d]: %m: dmaXmtDoorbell FC/FPactFlow-Step1/1", v__h32446);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_tlp_dmaPullTailEvent)
	$display("[%0d]: %m: dmaPullTailEvent FPactMesg-Step5/5", v__h41019);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_tlp_dmaTailEventSender)
	$display("[%0d]: %m: dmaTailEventSender - generic", v__h42144);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_tlp_dmaRequestFarMeta)
	$display("[%0d]: %m: dmaRequestFarMeta FCactMesg-Step1/5", v__h32850);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_wci_cfwr && wci_reqF$D_OUT[39:32] == 8'h18)
	$display("[%0d] %m: fabDoneAvail Event", v__h79510);
    if (RST_N)
