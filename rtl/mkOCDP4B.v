...
//
// On Wed Aug  3 11:45:18 EDT 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkOCDP4B(pciDevice,
  ...
  reg [63 : 0] v__h15553,
	       ...
	       v__h75924,
	       v__h76078;
  reg [31 : 0] IF_0_MINUS_tlp_writeDWAddr_156_BITS_1_TO_0_157_ETC___d2315,
	       IF_1_MINUS_tlp_writeDWAddr_156_BITS_1_TO_0_157_ETC___d2316,
	       IF_2_MINUS_tlp_writeDWAddr_156_BITS_1_TO_0_157_ETC___d2317,
	       IF_3_MINUS_tlp_writeDWAddr_156_BITS_1_TO_0_157_ETC___d2318,
	       IF_tlp_readReq_first__390_BITS_30_TO_29_391_EQ_ETC___d2319,
	       _theResult____h76062,
	       rdata__h69267;
  reg [15 : 0] CASE_tlp_outDwRemain_BITS_1_TO_0_0xFFF0_0b0_0x_ETC__q2;
  reg [1 : 0] lowAddr10__h51388, x__h51510, x__h51533;
  reg CASE_dpControl_BITS_1_TO_0_NOT_bml_fabDone_0_N_ETC__q5,
      ...
      IF_0_MINUS_tlp_writeDWAddr_156_BITS_1_TO_0_157_ETC___d2276,
      IF_1_MINUS_tlp_writeDWAddr_156_BITS_1_TO_0_157_ETC___d1183,
      IF_1_MINUS_tlp_writeDWAddr_156_BITS_1_TO_0_157_ETC___d2277,
      IF_2_MINUS_tlp_writeDWAddr_156_BITS_1_TO_0_157_ETC___d1193,
      IF_2_MINUS_tlp_writeDWAddr_156_BITS_1_TO_0_157_ETC___d2280,
      IF_3_MINUS_tlp_writeDWAddr_156_BITS_1_TO_0_157_ETC___d1203,
      IF_3_MINUS_tlp_writeDWAddr_156_BITS_1_TO_0_157_ETC___d2278,
      IF_bml_dpControl_wget__923_BITS_1_TO_0_929_EQ__ETC___d2000,
      IF_tlp_readReq_first__390_BITS_30_TO_29_391_EQ_ETC___d1405,
      IF_wmi_addr_752_BITS_3_TO_2_753_EQ_0_754_THEN__ETC___d2255,
      IF_wmi_p4B_809_EQ_1_812_THEN_bram_serverAdapte_ETC___d1818;
  wire [127 : 0] IF_tlp_readReq_first__390_BITS_30_TO_29_391_PL_ETC___d1525,
		 IF_tlp_readReq_first__390_BITS_30_TO_29_391_PL_ETC___d1530,
		 pkt__h39831,
		 rdata__h56807,
		 w_data__h25587,
		 w_data__h26568,
		 ...
		 w_data__h36589,
		 w_data__h37974;
  wire [31 : 0] bml_fabFlowAddr_962_PLUS_bml_fabFlowSize_963___d2539,
		mesgMeta_opcode__h67548,
		nowLS__h21891,
		nowLS__h33041,
		nowMS__h21890,
		nowMS__h33040,
  ...
  wire [12 : 0] spanToNextPage__h25186,
		spanToNextPage__h36307,
		thisRequestLength__h25187,
		thisRequestLength__h36308,
  ...
  wire [11 : 0] byteCount__h51390, x__h51501, x__h51503, y__h51502, y__h51504;
  wire [7 : 0] rreq_tag__h25401, tag__h36583, tagm__h36708;
  wire [6 : 0] lowAddr__h51389;
  wire [3 : 0] lastBE__h25611, lastBE__h36610;
  ...
  wire [1 : 0] ab__h10393,
	       ...
	       idx__h50115,
	       idx__h50488,
	       tlp_readReq_first__390_BITS_30_TO_29_391_PLUS_1___d2231;
  wire IF_1_MINUS_tlp_writeDWAddr_156_BITS_1_TO_0_157_ETC___d1206,
       ...
       IF_wmi_p4B_809_EQ_0_810_THEN_bram_serverAdapte_ETC___d1823,
       NOT_bml_lclBufDone_947_014_AND_IF_bml_dpContro_ETC___d2027,
       NOT_tlp_mReqF_first__124_BITS_28_TO_19_301_EQ__ETC___d1315,
       NOT_wmi_wrActive_724_725_OR_NOT_wmi_rdActive_7_ETC___d1734,
       _dfoo5,
       bml_crdBuf_value_905_EQ_bml_crdBuf_modulus_bw__ETC___d2620,
       bml_fabBuf_value_890_EQ_bml_fabBuf_modulus_bw__ETC___d2622,
       bml_lclBufDone_947_AND_IF_bml_dpControl_wget___ETC___d2282,
       bml_lclBuf_value_860_EQ_bml_lclBuf_modulus_bw__ETC___d2619,
       bml_remBuf_value_875_EQ_bml_remBuf_modulus_bw__ETC___d2621,
       bram_serverAdapterA_1_cnt_44_SLT_3___d2544,
       bram_serverAdapterA_1_outDataCore_notEmpty__20_ETC___d1484,
       bram_serverAdapterA_2_cnt_62_SLT_3___d2545,
       bram_serverAdapterA_3_cnt_80_SLT_3___d2546,
       bram_serverAdapterA_3_outDataCore_notEmpty__56_ETC___d1482,
       bram_serverAdapterA_cnt_6_SLT_3___d2543,
       bram_serverAdapterB_1_cnt_03_SLT_3___d1674,
       bram_serverAdapterB_1_outData_outData_whas__69_ETC___d1702,
       bram_serverAdapterB_2_cnt_21_SLT_3___d1675,
       bram_serverAdapterB_3_cnt_39_SLT_3___d1676,
       bram_serverAdapterB_cnt_5_SLT_3___d1673,
       hasPull_AND_tlp_dpControl_wget__34_BITS_3_TO_2_ETC___d1018,
       hasPull_AND_tlp_dpControl_wget__34_BITS_3_TO_2_ETC___d1044,
       hasPull_AND_tlp_dpControl_wget__34_BITS_3_TO_2_ETC___d878,
       hasPull_AND_tlp_dpControl_wget__34_BITS_3_TO_2_ETC___d914,
       hasPull_AND_tlp_dpControl_wget__34_BITS_3_TO_2_ETC___d965,
       hasPull_AND_tlp_dpControl_wget__34_BITS_3_TO_2_ETC___d998,
       ...
       tlp_dmaPullRemainDWLen_006_ULE_tlp_dmaPullRema_ETC___d2540,
       tlp_dmaPullRemainDWSub_020_ULE_4___d2541,
       tlp_inF_first__99_BITS_63_TO_56_02_EQ_pciDevic_ETC___d912,
       tlp_inF_first__99_BIT_152_058_AND_NOT_tlp_inF__ETC___d1083,
       tlp_mReqF_RDY_first__123_AND_IF_tlp_mReqF_firs_ETC___d1139,
       tlp_mRespF_first__69_BITS_71_TO_62_66_ULE_1___d2249,
       tlp_outDwRemain_89_ULE_4___d2385,
       tlp_rdRespDwRemain_474_ULE_4___d1475,
       tlp_readRemainDWLen_330_ULE_4___d1331,
       tlp_writeRemainDWLen_160_ULE_1___d2250,
       tlp_writeRemainDWLen_160_ULE_2___d2251,
       tlp_writeRemainDWLen_160_ULE_3___d2252,
       wmi_dpControl_whas__660_AND_bram_serverAdapter_ETC___d1706,
       wmi_wmi_operateD_613_AND_wmi_wmi_peerIsReady_6_ETC___d1788;
  ...
  assign MUX_bml_fabBufsAvail$write_1__VAL_1 =
	     (bml_fabAvail && !bml_remStart) ? x__h74534 : x__h74539 ;
  assign MUX_bml_fabBufsAvail$write_1__VAL_2 =
	     (dpControl[3:2] == 2'd1) ? x__h73291 : 16'd0 ;
  assign MUX_bml_fabFlowAddr$write_1__VAL_1 =
	     bml_fabBuf_value_890_EQ_bml_fabBuf_modulus_bw__ETC___d2622 ?
	       bml_fabFlowBase :
	       bml_fabFlowAddr_962_PLUS_bml_fabFlowSize_963___d2539 ;
  ...
  assign MUX_bml_lclCredit$write_1__VAL_1 =
	     (bml_lclBufDone && !bml_remStart) ? x__h74572 : x__h74577 ;
  ...
  assign MUX_bram_memory$a_put_3__VAL_2 =
	     { IF_0_MINUS_tlp_writeDWAddr_156_BITS_1_TO_0_157_ETC___d2315[7:0],
	       IF_0_MINUS_tlp_writeDWAddr_156_BITS_1_TO_0_157_ETC___d2315[15:8],
	       IF_0_MINUS_tlp_writeDWAddr_156_BITS_1_TO_0_157_ETC___d2315[23:16],
	       IF_0_MINUS_tlp_writeDWAddr_156_BITS_1_TO_0_157_ETC___d2315[31:24] } ;
  assign MUX_bram_memory$b_put_2__VAL_1 =
	     wmi_lclMesgAddr[14:4] + { 1'd0, wmi_addr[13:4] } ;
  always@(idx__h44410 or
	  tlp_writeDWAddr_PLUS_3__q7 or
	  tlp_writeDWAddr or
	  tlp_writeDWAddr_PLUS_1__q8 or tlp_writeDWAddr_PLUS_2__q9)
  begin
  ...
  assign MUX_bram_memory_1$a_put_3__VAL_2 =
	     { IF_1_MINUS_tlp_writeDWAddr_156_BITS_1_TO_0_157_ETC___d2316[7:0],
	       IF_1_MINUS_tlp_writeDWAddr_156_BITS_1_TO_0_157_ETC___d2316[15:8],
	       IF_1_MINUS_tlp_writeDWAddr_156_BITS_1_TO_0_157_ETC___d2316[23:16],
	       IF_1_MINUS_tlp_writeDWAddr_156_BITS_1_TO_0_157_ETC___d2316[31:24] } ;
  always@(idx__h45714 or
	  tlp_writeDWAddr_PLUS_3__q7 or
	  tlp_writeDWAddr or
	  tlp_writeDWAddr_PLUS_1__q8 or tlp_writeDWAddr_PLUS_2__q9)
  begin
  ...
  assign MUX_bram_memory_2$a_put_3__VAL_2 =
	     { IF_2_MINUS_tlp_writeDWAddr_156_BITS_1_TO_0_157_ETC___d2317[7:0],
	       IF_2_MINUS_tlp_writeDWAddr_156_BITS_1_TO_0_157_ETC___d2317[15:8],
	       IF_2_MINUS_tlp_writeDWAddr_156_BITS_1_TO_0_157_ETC___d2317[23:16],
	       IF_2_MINUS_tlp_writeDWAddr_156_BITS_1_TO_0_157_ETC___d2317[31:24] } ;
  always@(idx__h47018 or
	  tlp_writeDWAddr_PLUS_3__q7 or
	  tlp_writeDWAddr or
	  tlp_writeDWAddr_PLUS_1__q8 or tlp_writeDWAddr_PLUS_2__q9)
  begin
  ...
  assign MUX_bram_memory_3$a_put_3__VAL_3 =
	     { IF_3_MINUS_tlp_writeDWAddr_156_BITS_1_TO_0_157_ETC___d2318[7:0],
	       IF_3_MINUS_tlp_writeDWAddr_156_BITS_1_TO_0_157_ETC___d2318[15:8],
	       IF_3_MINUS_tlp_writeDWAddr_156_BITS_1_TO_0_157_ETC___d2318[23:16],
	       IF_3_MINUS_tlp_writeDWAddr_156_BITS_1_TO_0_157_ETC___d2318[31:24] } ;
  ...
  assign MUX_tlp_fabMesgAccu$write_1__VAL_2 = tlp_fabMesgAccu + y__h25739 ;
  assign MUX_tlp_fabMesgAccu$write_1__VAL_3 = tlp_fabMesgAccu + y__h36404 ;
  ...
  assign MUX_tlp_mesgComplReceived$write_1__VAL_2 =
	     tlp_mesgComplReceived + y__h37594 ;
  ...
  assign MUX_tlp_mesgLengthRemainPull$write_1__VAL_3 =
	     tlp_mesgLengthRemainPull - y__h36333 ;
  ...
  assign MUX_tlp_mesgLengthRemainPush$write_1__VAL_3 =
	     tlp_mesgLengthRemainPush - y__h25212 ;
  ...
  assign MUX_tlp_outF$enq_1__VAL_1 =
	     { 1'd1,
	       ...
	       23'd196607,
	       w_data__h25587 } ;
  assign MUX_tlp_outF$enq_1__VAL_2 = { 25'd16973823, w_data__h26568 } ;
  assign MUX_tlp_outF$enq_1__VAL_3 = { 25'd8585200, w_data__h27638 } ;
  assign MUX_tlp_outF$enq_1__VAL_4 = { 25'd25362416, w_data__h30744 } ;
  assign MUX_tlp_outF$enq_1__VAL_5 = { 25'd25362416, w_data__h36589 } ;
  assign MUX_tlp_outF$enq_1__VAL_6 = { 25'd25296895, w_data__h37974 } ;
  ...
  assign MUX_tlp_remMesgAccu$write_1__VAL_2 = tlp_remMesgAccu + y__h25354 ;
  assign MUX_tlp_remMesgAccu$write_1__VAL_3 = tlp_remMesgAccu + y__h36915 ;
  assign MUX_tlp_reqMesgInFlight$write_1__VAL_2 =
	     !tlp_dmaPullRemainDWSub_020_ULE_4___d2541 ||
	     !tlp_dmaPullRemainDWLen_006_ULE_tlp_dmaPullRema_ETC___d2540 ;
  assign MUX_tlp_srcMesgAccu$write_1__VAL_2 = tlp_srcMesgAccu + y__h25306 ;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, _theResult____h76062 } ;
  ...
  assign MUX_wmi_wmi_respF_q_0$write_1__VAL_1 =
	     (wmi_wmi_respF_c_r == 2'd1) ?
	       MUX_wmi_wmi_respF_q_0$write_1__VAL_2 :
	       wmi_wmi_respF_q_1 ;
  assign MUX_wmi_wmi_respF_q_0$write_1__VAL_2 = { 2'd1, rdata__h69267 } ;
  ...
  assign bram_serverAdapterB_outData_enqData$whas =
	     ...
	     bram_serverAdapterB_s1[0] ;
  assign bram_serverAdapterB_outData_outData$wget = y_avValue__h69103 ;
  ...
  assign bram_serverAdapterB_1_outData_enqData$whas =
	     ...
	     bram_serverAdapterB_1_s1[0] ;
  assign bram_serverAdapterB_1_outData_outData$wget = y_avValue__h69123 ;
  ...
  assign bram_serverAdapterB_2_outData_enqData$whas =
	     ...
	     bram_serverAdapterB_2_s1[0] ;
  assign bram_serverAdapterB_2_outData_outData$wget = y_avValue__h69143 ;
  ...
  assign bram_serverAdapterB_3_outData_enqData$whas =
	     ...
	     bram_serverAdapterB_3_s1[0] ;
  assign bram_serverAdapterB_3_outData_outData$wget = y_avValue__h69163 ;
  ...
  assign tlp_pullTagMatch_1$wget =
	     tagm__h36708 == tlp_inF$D_OUT[47:40] &&
	     tlp_inF_first__99_BITS_63_TO_56_02_EQ_pciDevic_ETC___d912 ;
  ...
  begin
    case (1'b1) // synopsys parallel_case
      WILL_FIRE_RL_tlp_dmaPullRequestFarMesg:
	  tlp_dmaPullRemainDWLen$D_IN = thisRequestLength__h36308[11:2];
      WILL_FIRE_RL_tlp_dmaPullResponseHeader:
  ...
  always@(WILL_FIRE_RL_tlp_dmaPullResponseHeader or
	  tlp_inF$D_OUT or
	  WILL_FIRE_RL_tlp_dmaPullResponseBody or
	  tlp_dmaPullRemainDWSub_020_ULE_4___d2541 or
	  WILL_FIRE_RL_tlp_dmaPullRequestFarMesg)
  begin
    case (1'b1) // synopsys parallel_case
      WILL_FIRE_RL_tlp_dmaPullResponseHeader:
  ...
  assign tlp_postSeqDwell$EN =
	     tlp_postSeqDwell != 4'd0 || WILL_FIRE_RL_tlp_dmaTailEventSender ;
  ...
  begin
    case (1'b1) // synopsys parallel_case
      ...
      WILL_FIRE_RL_tlp_dmaPullResponseBody:
	  tlp_tlpRcvBusy$D_IN = !tlp_dmaPullRemainDWSub_020_ULE_4___d2541;
  ...
  assign wmi_wmi_sFlagReg$D_IN =
	     { y_avValue__h69123[7:0], y_avValue__h69103[23:0] } ;
  ...
  begin
    case (1'b1) // synopsys parallel_case
      ...
      WILL_FIRE_RL_wmi_doWriteFinalize: bram_memory$DIB = x3__h67508;
  ...
  begin
    case (1'b1) // synopsys parallel_case
      ...
      WILL_FIRE_RL_wmi_doWriteFinalize:
	  bram_memory_1$DIB = mesgMeta_opcode__h67548;
  ...
  assign IF_tlp_readReq_first__390_BITS_30_TO_29_391_EQ_ETC___d1413 =
		...
		bram_serverAdapterA_outData_enqData$whas) &&
	       ...
	       IF_tlp_readReq_first__390_BITS_30_TO_29_391_EQ_ETC___d1405 &&
	       CASE_tlp_readReqD_OUT_BITS_30_TO_29_NOT_tlp_r_ETC__q16 ;
  assign IF_tlp_readReq_first__390_BITS_30_TO_29_391_PL_ETC___d1525 =
	     tlp_readReq_first__390_BITS_30_TO_29_391_PLUS_1___d2231[0] ?
	       { bram_serverAdapterA_3_outData_outData$wget[7:0],
		 bram_serverAdapterA_3_outData_outData$wget[15:8],
		 bram_serverAdapterA_3_outData_outData$wget[23:16],
		 bram_serverAdapterA_3_outData_outData$wget[31:24],
		 ...
		 bram_serverAdapterA_1_outData_outData$wget[23:16],
		 bram_serverAdapterA_1_outData_outData$wget[31:24] } ;
  assign IF_tlp_readReq_first__390_BITS_30_TO_29_391_PL_ETC___d1530 =
	     tlp_readReq_first__390_BITS_30_TO_29_391_PLUS_1___d2231[0] ?
	       { bram_serverAdapterA_1_outData_outData$wget[7:0],
		 bram_serverAdapterA_1_outData_outData$wget[15:8],
		 bram_serverAdapterA_1_outData_outData$wget[23:16],
		 ...
		 bram_serverAdapterA_3_outData_outData$wget[23:16],
		 bram_serverAdapterA_3_outData_outData$wget[31:24] } ;
  assign IF_wmi_p4B_809_EQ_0_810_THEN_bram_serverAdapte_ETC___d1823 =
	     (wmi_p4B == 2'd0) ?
	       (bram_serverAdapterB_outDataCore$EMPTY_N ||
		bram_serverAdapterB_outData_enqData$whas) &&
	       bram_serverAdapterB_outData_outData$whas :
	       IF_wmi_p4B_809_EQ_1_812_THEN_bram_serverAdapte_ETC___d1818 &&
	       CASE_wmi_p4B_NOT_wmi_p4B_EQ_3_OR_bram_serverAd_ETC__q17 ;
  assign NOT_bml_lclBufDone_947_014_AND_IF_bml_dpContro_ETC___d2027 =
	     !bml_lclBufDone &&
	     CASE_dpControl_BITS_1_TO_0_bml_fabDone_0_bml_f_ETC__q1 ;
  ...
  assign ab__h8863 =
	     (MUX_bram_memory_2$b_put_1__SEL_1 ||
	      WILL_FIRE_RL_wmi_reqMetadata) ?
	       2'd0 :
	       2'd2 ;
  assign bml_crdBuf_value_905_EQ_bml_crdBuf_modulus_bw__ETC___d2620 =
	     bml_crdBuf_value == bml_crdBuf_modulus ;
  assign bml_fabBuf_value_890_EQ_bml_fabBuf_modulus_bw__ETC___d2622 =
	     bml_fabBuf_value == bml_fabBuf_modulus ;
  assign bml_fabFlowAddr_962_PLUS_bml_fabFlowSize_963___d2539 =
	     bml_fabFlowAddr + bml_fabFlowSize ;
  assign bml_lclBufDone_947_AND_IF_bml_dpControl_wget___ETC___d2282 =
	     bml_lclBufDone &&
	     CASE_dpControl_BITS_1_TO_0_NOT_bml_fabDone_0_N_ETC__q5 ;
  assign bml_lclBuf_value_860_EQ_bml_lclBuf_modulus_bw__ETC___d2619 =
	     bml_lclBuf_value == bml_lclBuf_modulus ;
  assign bml_remBuf_value_875_EQ_bml_remBuf_modulus_bw__ETC___d2621 =
  ...
  assign bram_serverAdapterA_1_cnt_44_SLT_3___d2544 =
  ...
  assign bram_serverAdapterA_2_cnt_62_SLT_3___d2545 =
  ...
  assign bram_serverAdapterA_3_cnt_80_SLT_3___d2546 =
  ...
  assign bram_serverAdapterA_cnt_6_SLT_3___d2543 =
  ...
  assign bram_serverAdapterB_1_cnt_03_SLT_3___d1674 =
	     (bram_serverAdapterB_1_cnt ^ 3'h4) < 3'd7 ;
  assign bram_serverAdapterB_1_outData_outData_whas__69_ETC___d1702 =
	     bram_serverAdapterB_1_outData_outData$whas &&
	     (bram_serverAdapterB_2_outDataCore$EMPTY_N ||
	      bram_serverAdapterB_2_outData_enqData$whas) &&
	     bram_serverAdapterB_2_outData_outData$whas &&
  ...
  assign bram_serverAdapterB_2_cnt_21_SLT_3___d1675 =
  ...
  assign bram_serverAdapterB_3_cnt_39_SLT_3___d1676 =
  ...
  assign bram_serverAdapterB_cnt_5_SLT_3___d1673 =
	     (bram_serverAdapterB_cnt ^ 3'h4) < 3'd7 ;
  assign byteCount__h51390 = x__h51501 - y__h51502 ;
  ...
  assign hasPull_AND_tlp_dpControl_wget__34_BITS_3_TO_2_ETC___d878 =
	     hasPull && dpControl[3:2] == 2'd2 && dpControl[1:0] == 2'd1 &&
	     !tlp_tlpXmtBusy &&
	     !tlp_reqMetaInFlight &&
	     !tlp_reqMetaBodyInFlight &&
	     !tlp_fabMeta[128] &&
	     tlp_nearBufReady ;
  assign hasPull_AND_tlp_dpControl_wget__34_BITS_3_TO_2_ETC___d914 =
	     hasPull && dpControl[3:2] == 2'd2 && dpControl[1:0] == 2'd1 &&
	     tlp_reqMetaInFlight &&
	     !tlp_tlpRcvBusy &&
	     tagm__h36708 == tlp_inF$D_OUT[47:40] &&
	     tlp_inF_first__99_BITS_63_TO_56_02_EQ_pciDevic_ETC___d912 ;
  assign hasPull_AND_tlp_dpControl_wget__34_BITS_3_TO_2_ETC___d965 =
	     hasPull && dpControl[3:2] == 2'd2 && dpControl[1:0] == 2'd1 &&
	     tlp_fabMeta[128] &&
	     tlp_fabMeta[127:96] != 32'd0 &&
	     !tlp_tlpXmtBusy &&
  ...
  assign hasPull_AND_tlp_dpControl_wget__34_BITS_3_TO_2_ETC___d998 =
	     hasPull && dpControl[3:2] == 2'd2 && dpControl[1:0] == 2'd1 &&
	     tlp_fabMeta[128] &&
	     tlp_reqMesgInFlight &&
	     !tlp_tlpRcvBusy &&
  ...
  assign hasPush_AND_tlp_dpControl_wget__34_BITS_3_TO_2_ETC___d815 =
	     ...
	     tlp_xmtMetaOK &&
	     tlp_postSeqDwell == 4'd0 ;
  assign idx__h42179 = 2'd0 - tlp_writeDWAddr[1:0] ;
  assign idx__h44410 = 2'd1 - tlp_writeDWAddr[1:0] ;
  assign idx__h45714 = 2'd2 - tlp_writeDWAddr[1:0] ;
  assign idx__h47018 = 2'd3 - tlp_writeDWAddr[1:0] ;
  assign idx__h49274 = 2'd0 - tlp_readNxtDWAddr[1:0] ;
  assign idx__h49742 = 2'd1 - tlp_readNxtDWAddr[1:0] ;
  assign idx__h50115 = 2'd2 - tlp_readNxtDWAddr[1:0] ;
  assign idx__h50488 = 2'd3 - tlp_readNxtDWAddr[1:0] ;
  assign lastBE__h25611 =
	     tlp_mRespF_first__69_BITS_71_TO_62_66_ULE_1___d2249 ?
	       4'd0 :
	       4'd15 ;
  assign lastBE__h36610 =
	     (thisRequestLength__h36308[11:2] == 10'd1) ? 4'd0 : 4'd15 ;
  assign lowAddr__h51389 = { tlp_readReq$D_OUT[33:29], lowAddr10__h51388 } ;
  assign mesgMeta_opcode__h67548 =
	     { 24'h800000, wmi_wmi_mFlagF$D_OUT[31:24] } ;
  assign nowLS__h21891 =
	     { tlp_mRespF$D_OUT[39:32],
	       tlp_mRespF$D_OUT[47:40],
	       tlp_mRespF$D_OUT[55:48],
	       tlp_mRespF$D_OUT[63:56] } ;
  assign nowLS__h33041 =
	     { tlp_inF$D_OUT[39:32],
	       tlp_inF$D_OUT[47:40],
	       tlp_inF$D_OUT[55:48],
	       tlp_inF$D_OUT[63:56] } ;
  assign nowMS__h21890 =
	     { tlp_mRespF$D_OUT[71:64],
	       tlp_mRespF$D_OUT[79:72],
	       tlp_mRespF$D_OUT[87:80],
	       tlp_mRespF$D_OUT[95:88] } ;
  assign nowMS__h33040 =
	     { tlp_inF$D_OUT[71:64],
	       tlp_inF$D_OUT[79:72],
	       tlp_inF$D_OUT[87:80],
	       tlp_inF$D_OUT[95:88] } ;
  assign opcode__h21889 =
	     { tlp_mRespF$D_OUT[103:96],
	       tlp_mRespF$D_OUT[111:104],
	       tlp_mRespF$D_OUT[119:112],
	       tlp_mRespF$D_OUT[127:120] } ;
  assign opcode__h33039 =
  ...
  assign rdat__h76141 = { 16'd0, bml_lclNumBufs } ;
  assign rdat__h76149 = { 16'd0, bml_fabNumBufs } ;
  assign rdat__h76157 = { 16'd0, bml_mesgBase } ;
  assign rdat__h76165 = { 16'd0, bml_metaBase } ;
  assign rdat__h76173 = { 16'd0, bml_mesgSize } ;
  assign rdat__h76181 = { 16'd0, bml_metaSize } ;
  assign rdat__h76189 = { 16'd0, bml_lclBufsCF } ;
  assign rdat__h76210 = { bml_lclBufsAR, bml_fabBufsAvail } ;
  assign rdat__h76215 = { bml_remBuf_value, bml_lclBuf_value } ;
  assign rdat__h76226 = { bml_lclStarts, bml_lclDones } ;
  assign rdat__h76231 = { bml_remStarts, bml_remDones } ;
  assign rdat__h76548 = { wmi_reqCount, wmi_wrtCount } ;
  assign rdat__h76702 = { 28'd0, dpControl } ;
  assign rdata__h56807 =
	     tlp_readReq_first__390_BITS_30_TO_29_391_PLUS_1___d2231[1] ?
	       IF_tlp_readReq_first__390_BITS_30_TO_29_391_PL_ETC___d1525 :
	       IF_tlp_readReq_first__390_BITS_30_TO_29_391_PL_ETC___d1530 ;
  assign rreq_tag__h25401 =
	     (y__h25212 == tlp_mesgLengthRemainPush) ? 8'h01 : 8'h0 ;
  assign rresp_data__h51432 =
	     { IF_tlp_readReq_first__390_BITS_30_TO_29_391_EQ_ETC___d2319[7:0],
	       IF_tlp_readReq_first__390_BITS_30_TO_29_391_EQ_ETC___d2319[15:8],
	       IF_tlp_readReq_first__390_BITS_30_TO_29_391_EQ_ETC___d2319[23:16],
	       IF_tlp_readReq_first__390_BITS_30_TO_29_391_EQ_ETC___d2319[31:24] } ;
  assign spanToNextPage__h25186 = 13'd4096 - { 1'd0, tlp_srcMesgAccu[11:0] } ;
  assign spanToNextPage__h36307 = 13'd4096 - { 1'd0, tlp_fabMesgAccu[11:0] } ;
  assign tag__h36583 = { 3'd0, tlp_dmaTag } ;
  assign tagm__h36708 = { 3'd0, tlp_dmaReqTag } ;
  assign thisRequestLength__h25187 =
	     (x__h25225[12:0] <= spanToNextPage__h25186) ?
	       x__h25225[12:0] :
	       spanToNextPage__h25186 ;
  assign thisRequestLength__h36308 =
	     (x__h36341[12:0] <= spanToNextPage__h36307) ?
	       x__h36341[12:0] :
	       spanToNextPage__h36307 ;
  assign tlp_dmaPullRemainDWLen_006_ULE_tlp_dmaPullRema_ETC___d2540 =
	     tlp_dmaPullRemainDWLen <= tlp_dmaPullRemainDWSub ;
  assign tlp_dmaPullRemainDWSub_020_ULE_4___d2541 =
	     tlp_dmaPullRemainDWSub <= 10'd4 ;
  assign tlp_inF_first__99_BITS_63_TO_56_02_EQ_pciDevic_ETC___d912 =
	     tlp_inF$D_OUT[63:56] == pciDevice[15:8] &&
	     tlp_inF$D_OUT[55:51] == pciDevice[7:3] &&
	     tlp_inF$D_OUT[50:48] == pciDevice[2:0] ;
  assign tlp_inF_first__99_BIT_152_058_AND_NOT_tlp_inF__ETC___d1083 =
	     tlp_inF$D_OUT[152] && !tlp_inF$D_OUT[110] &&
	     !tlp_inF$D_OUT[125] &&
	     tlp_inF$D_OUT[124:120] == 5'b0 ||
	     !tlp_inF$D_OUT[152] && !tlp_inIgnorePkt ;
  assign tlp_mReqF_RDY_first__123_AND_IF_tlp_mReqF_firs_ETC___d1139 =
	     tlp_mReqF$EMPTY_N &&
	     CASE_tlp_mReqFD_OUT_BITS_51_TO_50_NOT_tlp_mRe_ETC__q3 ;
  assign tlp_mRespF_first__69_BITS_71_TO_62_66_ULE_1___d2249 =
	     tlp_mRespF$D_OUT[71:62] <= 10'd1 ;
  ...
  assign tlp_outDwRemain_89_ULE_4___d2385 = tlp_outDwRemain <= 10'd4 ;
  ...
  assign tlp_readRemainDWLen_330_ULE_4___d1331 =
	     tlp_readRemainDWLen <= 10'd4 ;
  assign tlp_readReq_first__390_BITS_30_TO_29_391_PLUS_1___d2231 =
	     tlp_readReq$D_OUT[30:29] + 2'd1 ;
  ...
  assign tlp_writeRemainDWLen_160_ULE_1___d2250 =
	     tlp_writeRemainDWLen <= 10'd1 ;
  assign tlp_writeRemainDWLen_160_ULE_2___d2251 =
	     tlp_writeRemainDWLen <= 10'd2 ;
  assign tlp_writeRemainDWLen_160_ULE_3___d2252 =
	     tlp_writeRemainDWLen <= 10'd3 ;
  assign w_be__h26137 =
	     tlp_outDwRemain_89_ULE_4___d2385 ?
	       CASE_tlp_outDwRemain_BITS_1_TO_0_0xFFF0_0b0_0x_ETC__q2 :
	       16'd65535 ;
  assign w_data__h25587 =
	     { 22'd1048580,
	       tlp_mRespF$D_OUT[71:62],
	       pciDevice,
	       8'd0,
  ...
  assign w_data__h30744 =
	     { 32'd4100,
	       ...
	       34'd0 } ;
  assign w_data__h36589 =
	     { 22'd4,
	       thisRequestLength__h36308[11:2],
	       pciDevice,
	       tag__h36583,
	       lastBE__h36610,
	       4'd15,
	       ...
	       34'd0 } ;
  assign w_data__h37974 =
	     { 32'd1073745921,
	       pciDevice,
	       16'd15,
	       tlp_fabFlowAddr,
	       32'd16777216 } ;
  assign wmi_dpControl_whas__660_AND_bram_serverAdapter_ETC___d1706 =
	     (bram_serverAdapterB_outDataCore$EMPTY_N ||
	      bram_serverAdapterB_outData_enqData$whas) &&
	     bram_serverAdapterB_outData_outData$whas &&
	     (bram_serverAdapterB_1_outDataCore$EMPTY_N ||
	      bram_serverAdapterB_1_outData_enqData$whas) &&
	     bram_serverAdapterB_1_outData_outData_whas__69_ETC___d1702 ;
  assign wmi_wmi_operateD_613_AND_wmi_wmi_peerIsReady_6_ETC___d1788 =
	     wmi_wmi_operateD && wmi_wmi_peerIsReady &&
	     bram_serverAdapterB_cnt_5_SLT_3___d1673 &&
	     bram_serverAdapterB_1_cnt_03_SLT_3___d1674 &&
	     bram_serverAdapterB_2_cnt_21_SLT_3___d1675 &&
	     bram_serverAdapterB_3_cnt_39_SLT_3___d1676 &&
	     wmi_wmi_mFlagF$EMPTY_N ;
  assign x3__h67508 = { 8'd0, wmi_wmi_mFlagF$D_OUT[23:0] } ;
  assign x__h21952 = { 15'd0, tlp_mesgLengthRemainPush } ;
  assign x__h25225 =
	     (tlp_mesgLengthRemainPush <= y__h25227) ?
	       tlp_mesgLengthRemainPush :
	       y__h25227 ;
  assign x__h33071 = { 15'd0, tlp_mesgLengthRemainPull } ;
  assign x__h36341 =
	     (tlp_mesgLengthRemainPull <= y__h36343) ?
	       tlp_mesgLengthRemainPull :
	       y__h36343 ;
  assign x__h51501 = x__h51503 - y__h51504 ;
  assign x__h51503 = { tlp_readReq$D_OUT[28:19], 2'b0 } ;
  assign x__h73291 = (dpControl[1:0] == 2'd1) ? bml_fabNumBufs : 16'd0 ;
  assign x__h74415 = bml_lclBufsAR + 16'd1 ;
  assign x__h74420 = bml_lclBufsAR - 16'd1 ;
  assign x__h74492 = bml_lclBufsCF + 16'd1 ;
  assign x__h74497 = bml_lclBufsCF - 16'd1 ;
  assign x__h74534 = bml_fabBufsAvail + 16'd1 ;
  assign x__h74539 = bml_fabBufsAvail - 16'd1 ;
  assign x__h74572 = bml_lclCredit + 16'd1 ;
  assign x__h74577 = bml_lclCredit - 16'd1 ;
  assign y__h25212 = { 4'd0, thisRequestLength__h25187 } ;
  assign y__h25227 = { 4'd0, tlp_maxPayloadSize } ;
  assign y__h25306 = { 19'd0, thisRequestLength__h25187 } ;
  assign y__h25354 = { 3'd0, thisRequestLength__h25187 } ;
  assign y__h25739 = { 20'd0, tlp_mRespF$D_OUT[71:62], 2'd0 } ;
  assign y__h36333 = { 4'd0, thisRequestLength__h36308 } ;
  assign y__h36343 = { 4'd0, tlp_maxReadReqSize } ;
  assign y__h36404 = { 19'd0, thisRequestLength__h36308 } ;
  assign y__h36915 = { 4'd0, tlp_inF$D_OUT[105:96], 2'd0 } ;
  assign y__h37594 =
	     tlp_dmaPullRemainDWSub_020_ULE_4___d2541 ?
  ...
  assign y__h51502 =
	     (tlp_readReq$D_OUT[28:19] == 10'd1) ?
	       12'd0 :
	       { 10'd0, x__h51533 } ;
  assign y__h51504 = { 10'd0, x__h51510 } ;
  assign y_avValue__h69103 =
	     bram_serverAdapterB_outDataCore$EMPTY_N ?
	       bram_serverAdapterB_outDataCore$D_OUT :
	       bram_memory$DOB ;
  assign y_avValue__h69123 =
	     bram_serverAdapterB_1_outDataCore$EMPTY_N ?
	       bram_serverAdapterB_1_outDataCore$D_OUT :
	       bram_memory_1$DOB ;
  assign y_avValue__h69143 =
	     bram_serverAdapterB_2_outDataCore$EMPTY_N ?
	       bram_serverAdapterB_2_outDataCore$D_OUT :
	       bram_memory_2$DOB ;
  assign y_avValue__h69163 =
	     bram_serverAdapterB_3_outDataCore$EMPTY_N ?
	       bram_serverAdapterB_3_outDataCore$D_OUT :
	       bram_memory_3$DOB ;
  ...
  begin
    case (tlp_readReq$D_OUT[18:15])
      4'b1100: x__h51510 = 2'b10;
      4'b1110: x__h51510 = 2'b01;
      4'b1111: x__h51510 = 2'b0;
      default: x__h51510 = 2'b11;
    endcase
  end
  always@(tlp_readReq$D_OUT)
  begin
    case (tlp_readReq$D_OUT[14:11])
      4'b1100: x__h51533 = 2'b10;
      4'b1110: x__h51533 = 2'b01;
      4'b1111: x__h51533 = 2'b0;
      default: x__h51533 = 2'b11;
    endcase
  end
  always@(wmi_p4B or
	  y_avValue__h69163 or
	  y_avValue__h69103 or y_avValue__h69123 or y_avValue__h69143)
  begin
    case (wmi_p4B)
      2'd0: rdata__h69267 = y_avValue__h69103;
      2'd1: rdata__h69267 = y_avValue__h69123;
      2'd2: rdata__h69267 = y_avValue__h69143;
      2'd3: rdata__h69267 = y_avValue__h69163;
    endcase
  end
  always@(tlp_readReq$D_OUT)
  begin
    case (tlp_readReq$D_OUT[18:15])
      4'b1000: lowAddr10__h51388 = 2'b11;
      4'b1100: lowAddr10__h51388 = 2'b10;
      4'b1110: lowAddr10__h51388 = 2'b01;
      default: lowAddr10__h51388 = 2'b0;
    endcase
  end
  always@(wci_reqF$D_OUT or
	  ...
	  bml_fabMesgSize or
	  bml_fabMetaSize or
	  bml_fabFlowBase or bml_fabFlowSize or rdat__h76702)
  begin
    case (wci_reqF$D_OUT[39:32])
      8'h0: _theResult____h76062 = rdat__h76141;
      8'h04: _theResult____h76062 = rdat__h76149;
      8'h08: _theResult____h76062 = rdat__h76157;
      8'h0C: _theResult____h76062 = rdat__h76165;
      8'h10: _theResult____h76062 = rdat__h76173;
      8'h14: _theResult____h76062 = rdat__h76181;
      8'h20: _theResult____h76062 = rdat__h76189;
      8'h24: _theResult____h76062 = 32'hF00DFACE;
      8'h28: _theResult____h76062 = rdat__h76210;
      8'h2C: _theResult____h76062 = rdat__h76215;
      8'h30: _theResult____h76062 = rdat__h76226;
      8'h34: _theResult____h76062 = rdat__h76231;
      8'h38: _theResult____h76062 = wmi_thisMesg;
      8'h3C: _theResult____h76062 = wmi_lastMesg;
      8'h40: _theResult____h76062 = rdat__h76548;
      8'h44: _theResult____h76062 = 32'h0;
      8'h48: _theResult____h76062 = 32'hDADEBABE;
      8'h4C: _theResult____h76062 = 32'h00008000;
      8'h50: _theResult____h76062 = bml_fabMesgBase;
      8'h54: _theResult____h76062 = bml_fabMetaBase;
      8'h58: _theResult____h76062 = bml_fabMesgSize;
      8'h5C: _theResult____h76062 = bml_fabMetaSize;
      8'h60: _theResult____h76062 = bml_fabFlowBase;
      8'h64: _theResult____h76062 = bml_fabFlowSize;
      8'h68: _theResult____h76062 = rdat__h76702;
      default: _theResult____h76062 = 32'd0;
    endcase
  end
  ...
  begin
    case (dpControl[1:0])
	  ...
	  IF_bml_dpControl_wget__923_BITS_1_TO_0_929_EQ__ETC___d2000 =
	      bml_remDone;
      default: IF_bml_dpControl_wget__923_BITS_1_TO_0_929_EQ__ETC___d2000 =
		   bml_fabDone;
    endcase
  end
  ...
  always@(idx__h42179 or
	  tlp_writeRemainDWLen_160_ULE_3___d2252 or
	  tlp_writeRemainDWLen or
	  tlp_writeRemainDWLen_160_ULE_1___d2250 or
	  tlp_writeRemainDWLen_160_ULE_2___d2251)
  begin
    case (idx__h42179)
      2'd0:
  ...
  always@(tlp_mReqF$D_OUT or
	  bram_serverAdapterA_3_cnt_80_SLT_3___d2546 or
	  bram_serverAdapterA_cnt_6_SLT_3___d2543 or
	  bram_serverAdapterA_1_cnt_44_SLT_3___d2544 or
	  bram_serverAdapterA_2_cnt_62_SLT_3___d2545)
  begin
  ...
  always@(wmi_addr or
	  bram_serverAdapterB_3_cnt_39_SLT_3___d1676 or
	  bram_serverAdapterB_cnt_5_SLT_3___d1673 or
	  bram_serverAdapterB_1_cnt_03_SLT_3___d1674 or
	  bram_serverAdapterB_2_cnt_21_SLT_3___d1675)
  begin
    case (wmi_addr[3:2])
      2'd0:
  ...
  always@(idx__h42179 or tlp_mReqF$D_OUT)
  begin
    case (idx__h42179)
      2'd0:
	  IF_0_MINUS_tlp_writeDWAddr_156_BITS_1_TO_0_157_ETC___d2315 =
  ...
  always@(idx__h44410 or tlp_mReqF$D_OUT)
  begin
    case (idx__h44410)
      2'd0:
	  IF_1_MINUS_tlp_writeDWAddr_156_BITS_1_TO_0_157_ETC___d2316 =
  ...
  always@(idx__h45714 or tlp_mReqF$D_OUT)
  begin
    case (idx__h45714)
      2'd0:
	  IF_2_MINUS_tlp_writeDWAddr_156_BITS_1_TO_0_157_ETC___d2317 =
  ...
  always@(idx__h47018 or tlp_mReqF$D_OUT)
  begin
    case (idx__h47018)
      2'd0:
	  IF_3_MINUS_tlp_writeDWAddr_156_BITS_1_TO_0_157_ETC___d2318 =
  ...
  begin
    case (wmi_p4B)
	  ...
	  IF_wmi_p4B_809_EQ_1_812_THEN_bram_serverAdapte_ETC___d1818 =
	      bram_serverAdapterB_2_outDataCore$EMPTY_N ||
	      bram_serverAdapterB_2_outData_enqData$whas;
      default: IF_wmi_p4B_809_EQ_1_812_THEN_bram_serverAdapte_ETC___d1818 =
		   wmi_p4B != 2'd3 ||
		   bram_serverAdapterB_3_outDataCore$EMPTY_N ||
		   bram_serverAdapterB_3_outData_enqData$whas;
    endcase
  ...
  begin
    ...
    if (RST_N)
      if (MUX_tlp_outF$enq_1__SEL_2)
	$display("[%0d]: %m: dmaXmtMetaHead FPactMesg-Step5/7", v__h27469);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_tlp_dmaXmtTailEvent)
	$display("[%0d]: %m: dmaXmtTailEvent FPactMesg-Step7/7", v__h30348);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_tlp_dmaXmtMetaBody)
	$display("[%0d]: %m: dmaXmtMetaBody FPactMesg-Step6/7", v__h30228);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_tlp_dmaXmtDoorbell)
	$display("[%0d]: %m: dmaXmtDoorbell FC/FPactFlow-Step1/1", v__h30486);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_tlp_dmaPullTailEvent)
	$display("[%0d]: %m: dmaPullTailEvent FPactMesg-Step5/5", v__h37726);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_tlp_dmaTailEventSender)
	$display("[%0d]: %m: dmaTailEventSender - generic", v__h38849);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_tlp_dmaRequestFarMeta)
	$display("[%0d]: %m: dmaRequestFarMeta FCactMesg-Step1/5", v__h30825);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_wci_cfwr && wci_reqF$D_OUT[39:32] == 8'h18)
	$display("[%0d] %m: fabDoneAvail Event", v__h75550);
    if (RST_N)
