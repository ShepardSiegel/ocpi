...
//
// On Fri Dec  9 10:59:18 EST 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkOCDP4B(pciDevice,
  ...
  reg [63 : 0] v__h15540,
	       ...
	       v__h87756,
	       v__h87910;
  reg [31 : 0] IF_0_MINUS_tlp_tlpBRAM_writeDWAddr_54_BITS_1_T_ETC___d2358,
	       IF_1_MINUS_tlp_tlpBRAM_writeDWAddr_54_BITS_1_T_ETC___d2359,
	       IF_2_MINUS_tlp_tlpBRAM_writeDWAddr_54_BITS_1_T_ETC___d2360,
	       IF_3_MINUS_tlp_tlpBRAM_writeDWAddr_54_BITS_1_T_ETC___d2361,
	       IF_tlp_tlpBRAM_readReq_first__93_BITS_30_TO_29_ETC___d2778,
	       _theResult____h87894,
	       rdata__h80723;
  ...
  reg [1 : 0] lowAddr10__h28247, x__h28376, x__h28399;
  reg CASE_dpControl_BITS_1_TO_0_NOT_bml_fabDone_0_N_ETC__q6,
      ...
      IF_0_MINUS_tlp_tlpBRAM_writeDWAddr_54_BITS_1_T_ETC___d2817,
      IF_0_MINUS_tlp_tlpBRAM_writeDWAddr_54_BITS_1_T_ETC___d671,
      IF_1_MINUS_tlp_tlpBRAM_writeDWAddr_54_BITS_1_T_ETC___d2818,
      IF_1_MINUS_tlp_tlpBRAM_writeDWAddr_54_BITS_1_T_ETC___d681,
      IF_2_MINUS_tlp_tlpBRAM_writeDWAddr_54_BITS_1_T_ETC___d2819,
      IF_2_MINUS_tlp_tlpBRAM_writeDWAddr_54_BITS_1_T_ETC___d691,
      IF_3_MINUS_tlp_tlpBRAM_writeDWAddr_54_BITS_1_T_ETC___d2820,
      IF_3_MINUS_tlp_tlpBRAM_writeDWAddr_54_BITS_1_T_ETC___d701,
      IF_bml_dpControl_wget__994_BITS_1_TO_0_000_EQ__ETC___d2071,
      IF_tlp_tlpBRAM_readReq_first__93_BITS_30_TO_29_ETC___d908,
      IF_wmi_addr_823_BITS_3_TO_2_824_EQ_0_825_THEN__ETC___d2791,
      IF_wmi_p4B_880_EQ_1_883_THEN_bram_serverAdapte_ETC___d1889;
  wire [127 : 0] IF_tlp_fabMesgAddrMS_178_EQ_0_179_THEN_0_ELSE__ETC___d1449,
		 IF_tlp_fabMetaAddrMS_256_EQ_0_257_THEN_4_ELSE__ETC___d1344,
		 IF_tlp_tlpBRAM_readReq_first__93_BITS_30_TO_29_ETC___d1032,
		 IF_tlp_tlpBRAM_readReq_first__93_BITS_30_TO_29_ETC___d1037,
		 pkt__h69046,
		 rdata__h33678,
		 w_data__h45580,
		 w_data__h45894,
		 ...
		 w_data__h63296,
		 w_data__h64349;
  wire [31 : 0] bml_fabFlowAddr_033_PLUS_bml_fabFlowSize_034___d2623,
		mesgMeta_opcode__h79004,
		nowLS__h43924,
		nowLS__h60162,
		nowMS__h42981,
		nowMS__h59221,
  ...
  wire [15 : 0] w_be__h46315,
		...
		y__h45338,
		y__h62110;
  wire [12 : 0] spanToNextPage__h45170,
		spanToNextPage__h61412,
		thisRequestLength__h45171,
		thisRequestLength__h61413,
		...
		y__h17089,
		y__h25859;
  wire [11 : 0] byteCount__h28249, x__h28367, x__h28369, y__h28368, y__h28370;
  wire [9 : 0] y__h17160, y__h25811, y__h29309;
  wire [7 : 0] rreq_tag__h45386, tag__h61688, tagm__h61903;
  wire [6 : 0] lowAddr__h28248;
  wire [3 : 0] lastBE__h45607, lastBE__h61720;
  ...
  wire [1 : 0] ab__h10380,
	       ...
	       idx__h26947,
	       idx__h27320,
	       tlp_tlpBRAM_readReq_first__93_BITS_30_TO_29_95_ETC___d2766;
  wire IF_1_MINUS_tlp_tlpBRAM_writeDWAddr_54_BITS_1_T_ETC___d704,
       IF_tlp_tlpBRAM_readReq_first__93_BITS_30_TO_29_ETC___d917,
       IF_wmi_p4B_880_EQ_0_881_THEN_bram_serverAdapte_ETC___d1894,
       NOT_bml_lclBufDone_018_085_AND_IF_bml_dpContro_ETC___d2098,
       NOT_wmi_wrActive_795_796_OR_NOT_wmi_rdActive_7_ETC___d1805,
       _dfoo5,
       bml_crdBuf_value_976_EQ_bml_crdBuf_modulus_bw__ETC___d2733,
       bml_fabBuf_value_961_EQ_bml_fabBuf_modulus_bw__ETC___d2735,
       bml_lclBufDone_018_AND_IF_bml_dpControl_wget___ETC___d2824,
       bml_lclBuf_value_931_EQ_bml_lclBuf_modulus_bw__ETC___d2732,
       bml_remBuf_value_946_EQ_bml_remBuf_modulus_bw__ETC___d2734,
       bram_serverAdapterA_1_cnt_44_SLT_3___d2628,
       bram_serverAdapterA_2_cnt_62_SLT_3___d2629,
       bram_serverAdapterA_2_outDataCore_notEmpty__38_ETC___d989,
       bram_serverAdapterA_3_cnt_80_SLT_3___d2630,
       bram_serverAdapterA_cnt_6_SLT_3___d2627,
       bram_serverAdapterA_outDataCore_notEmpty_OR_br_ETC___d991,
       bram_serverAdapterB_1_cnt_03_SLT_3___d1745,
       bram_serverAdapterB_1_outData_outData_whas__76_ETC___d1773,
       bram_serverAdapterB_2_cnt_21_SLT_3___d1746,
       bram_serverAdapterB_3_cnt_39_SLT_3___d1747,
       bram_serverAdapterB_cnt_5_SLT_3___d1744,
       hasPull_AND_NOT_tlp_dpControl_wget__061_BIT_8__ETC___d1329,
       hasPull_AND_NOT_tlp_dpControl_wget__061_BIT_8__ETC___d1370,
       hasPull_AND_NOT_tlp_dpControl_wget__061_BIT_8__ETC___d1422,
       hasPull_AND_NOT_tlp_dpControl_wget__061_BIT_8__ETC___d1461,
       hasPull_AND_NOT_tlp_dpControl_wget__061_BIT_8__ETC___d1481,
       hasPull_AND_NOT_tlp_dpControl_wget__061_BIT_8__ETC___d1506,
       hasPush_AND_NOT_tlp_dpControl_wget__061_BIT_8__ETC___d1085,
       hasPush_AND_NOT_tlp_dpControl_wget__061_BIT_8__ETC___d1158,
       hasPush_AND_NOT_tlp_dpControl_wget__061_BIT_8__ETC___d1198,
       hasPush_AND_NOT_tlp_dpControl_wget__061_BIT_8__ETC___d1254,
       hasPush_AND_NOT_tlp_dpControl_wget__061_BIT_8__ETC___d1274,
       hasPush_AND_NOT_tlp_dpControl_wget__061_BIT_8__ETC___d1305,
       tlp_dmaPullRemainDWLen_469_ULE_tlp_dmaPullRema_ETC___d2624,
       tlp_dmaPullRemainDWSub_483_ULE_4___d2625,
       tlp_inF_first__355_BITS_63_TO_56_358_EQ_pciDev_ETC___d1368,
       tlp_inF_first__355_BIT_152_540_AND_NOT_tlp_inF_ETC___d1565,
       tlp_outDwRemain_228_ULE_4___d2459,
       tlp_tlpBRAM_mReqF_first__14_BIT_60_98_OR_IF_tl_ETC___d809,
       tlp_tlpBRAM_mReqF_first__14_BIT_63_15_OR_IF_tl_ETC___d630,
       tlp_tlpBRAM_mRespF_first__100_BITS_71_TO_62_20_ETC___d2772,
       tlp_tlpBRAM_rdRespDwRemain_020_ULE_4___d1022,
       tlp_tlpBRAM_readRemainDWLen_42_ULE_4___d843,
       tlp_tlpBRAM_writeRemainDWLen_58_ULE_1___d2769,
       tlp_tlpBRAM_writeRemainDWLen_58_ULE_2___d2770,
       tlp_tlpBRAM_writeRemainDWLen_58_ULE_3___d2771,
       wmi_dpControl_whas__731_AND_bram_serverAdapter_ETC___d1777,
       wmi_wmi_operateD_684_AND_wmi_wmi_peerIsReady_6_ETC___d1859;
  ...
  assign MUX_bml_fabBufsAvail$write_1__VAL_1 =
	     (bml_fabAvail && !bml_remStart) ? x__h86118 : x__h86123 ;
  assign MUX_bml_fabBufsAvail$write_1__VAL_2 =
	     (dpControl[3:2] == 2'd1) ? x__h84875 : 16'd0 ;
  assign MUX_bml_fabFlowAddr$write_1__VAL_1 =
	     bml_fabBuf_value_961_EQ_bml_fabBuf_modulus_bw__ETC___d2735 ?
	       bml_fabFlowBase :
	       bml_fabFlowAddr_033_PLUS_bml_fabFlowSize_034___d2623 ;
  ...
  assign MUX_bml_lclCredit$write_1__VAL_1 =
	     (bml_lclBufDone && !bml_remStart) ? x__h86156 : x__h86161 ;
  ...
  assign MUX_bram_memory$a_put_3__VAL_3 =
	     { IF_0_MINUS_tlp_tlpBRAM_writeDWAddr_54_BITS_1_T_ETC___d2358[7:0],
	       IF_0_MINUS_tlp_tlpBRAM_writeDWAddr_54_BITS_1_T_ETC___d2358[15:8],
	       IF_0_MINUS_tlp_tlpBRAM_writeDWAddr_54_BITS_1_T_ETC___d2358[23:16],
	       IF_0_MINUS_tlp_tlpBRAM_writeDWAddr_54_BITS_1_T_ETC___d2358[31:24] } ;
  ...
  assign MUX_bram_memory_1$a_put_3__VAL_3 =
	     { IF_1_MINUS_tlp_tlpBRAM_writeDWAddr_54_BITS_1_T_ETC___d2359[7:0],
	       IF_1_MINUS_tlp_tlpBRAM_writeDWAddr_54_BITS_1_T_ETC___d2359[15:8],
	       IF_1_MINUS_tlp_tlpBRAM_writeDWAddr_54_BITS_1_T_ETC___d2359[23:16],
	       IF_1_MINUS_tlp_tlpBRAM_writeDWAddr_54_BITS_1_T_ETC___d2359[31:24] } ;
  ...
  assign MUX_bram_memory_2$a_put_3__VAL_3 =
	     { IF_2_MINUS_tlp_tlpBRAM_writeDWAddr_54_BITS_1_T_ETC___d2360[7:0],
	       IF_2_MINUS_tlp_tlpBRAM_writeDWAddr_54_BITS_1_T_ETC___d2360[15:8],
	       IF_2_MINUS_tlp_tlpBRAM_writeDWAddr_54_BITS_1_T_ETC___d2360[23:16],
	       IF_2_MINUS_tlp_tlpBRAM_writeDWAddr_54_BITS_1_T_ETC___d2360[31:24] } ;
  ...
  assign MUX_bram_memory_3$a_put_3__VAL_3 =
	     { IF_3_MINUS_tlp_tlpBRAM_writeDWAddr_54_BITS_1_T_ETC___d2361[7:0],
	       IF_3_MINUS_tlp_tlpBRAM_writeDWAddr_54_BITS_1_T_ETC___d2361[15:8],
	       IF_3_MINUS_tlp_tlpBRAM_writeDWAddr_54_BITS_1_T_ETC___d2361[23:16],
	       IF_3_MINUS_tlp_tlpBRAM_writeDWAddr_54_BITS_1_T_ETC___d2361[31:24] } ;
  ...
  assign MUX_tlp_fabMesgAccu$write_1__VAL_1 = tlp_fabMesgAccu + y__h45744 ;
  assign MUX_tlp_fabMesgAccu$write_1__VAL_3 = tlp_fabMesgAccu + y__h61509 ;
  ...
  assign MUX_tlp_mesgComplReceived$write_1__VAL_2 =
	     tlp_mesgComplReceived + y__h62817 ;
  ...
  assign MUX_tlp_mesgLengthRemainPull$write_1__VAL_3 =
	     tlp_mesgLengthRemainPull - y__h61438 ;
  ...
  assign MUX_tlp_mesgLengthRemainPush$write_1__VAL_3 =
	     tlp_mesgLengthRemainPush - y__h45196 ;
  ...
  assign MUX_tlp_outF$enq_1__VAL_5 =
	     { 9'd386,
	       ...
	       IF_tlp_fabMesgAddrMS_178_EQ_0_179_THEN_0_ELSE__ETC___d1449 } ;
  assign MUX_tlp_outF$enq_1__VAL_6 =
	     (tlp_fabFlowAddrMS == 32'd0) ?
	       { 25'd25362431, w_data__h63296 } :
	       (tlp_sentTail4DWHeader ?
		  153'h082F00001000000000000000000000000000000 :
		  { 25'd16973823, w_data__h64349 }) ;
  ...
  assign MUX_tlp_remMesgAccu$write_1__VAL_2 = tlp_remMesgAccu + y__h45338 ;
  assign MUX_tlp_remMesgAccu$write_1__VAL_3 = tlp_remMesgAccu + y__h62110 ;
  assign MUX_tlp_reqMesgInFlight$write_1__VAL_2 =
	     !tlp_dmaPullRemainDWSub_483_ULE_4___d2625 ||
	     !tlp_dmaPullRemainDWLen_469_ULE_tlp_dmaPullRema_ETC___d2624 ;
  assign MUX_tlp_srcMesgAccu$write_1__VAL_2 = tlp_srcMesgAccu + y__h45290 ;
  ...
  assign MUX_tlp_tlpBRAM_mReqF$enq_1__VAL_3 =
	     { 69'h12AAAAAAAAAAAAAAAA,
	       ...
	       thisRequestLength__h45171[11:2],
	       8'd255,
	       rreq_tag__h45386,
	       3'h2 } ;
  ...
  assign MUX_tlp_tlpBRAM_rdRespDwRemain$write_1__VAL_1 =
	     tlp_tlpBRAM_readReq$D_OUT[28:19] - y__h29309 ;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, _theResult____h87894 } ;
  ...
  assign MUX_wmi_wmi_respF_q_0$write_1__VAL_1 = { 2'd1, rdata__h80723 } ;
  ...
  assign bram_serverAdapterB_outData_enqData$whas =
	     ...
	     bram_serverAdapterB_s1[0] ;
  assign bram_serverAdapterB_outData_outData$wget = y_avValue__h80559 ;
  ...
  assign bram_serverAdapterB_1_outData_enqData$whas =
	     ...
	     bram_serverAdapterB_1_s1[0] ;
  assign bram_serverAdapterB_1_outData_outData$wget = y_avValue__h80579 ;
  ...
  assign bram_serverAdapterB_2_outData_enqData$whas =
	     ...
	     bram_serverAdapterB_2_s1[0] ;
  assign bram_serverAdapterB_2_outData_outData$wget = y_avValue__h80599 ;
  ...
  assign bram_serverAdapterB_3_outData_enqData$whas =
	     ...
	     bram_serverAdapterB_3_s1[0] ;
  assign bram_serverAdapterB_3_outData_outData$wget = y_avValue__h80619 ;
  ...
  assign tlp_pullTagMatch_1$wget =
	     tagm__h61903 == tlp_inF$D_OUT[47:40] &&
	     tlp_inF_first__355_BITS_63_TO_56_358_EQ_pciDev_ETC___d1368 ;
  ...
  begin
    case (1'b1) // synopsys parallel_case
      WILL_FIRE_RL_tlp_dmaPullRequestFarMesg:
	  tlp_dmaPullRemainDWLen$D_IN = thisRequestLength__h61413[11:2];
      WILL_FIRE_RL_tlp_dmaPullResponseHeader:
  ...
  always@(WILL_FIRE_RL_tlp_dmaPullResponseHeader or
	  tlp_inF$D_OUT or
	  WILL_FIRE_RL_tlp_dmaPullResponseBody or
	  tlp_dmaPullRemainDWSub_483_ULE_4___d2625 or
	  WILL_FIRE_RL_tlp_dmaPullRequestFarMesg)
  begin
    case (1'b1) // synopsys parallel_case
      WILL_FIRE_RL_tlp_dmaPullResponseHeader:
  ...
  begin
    case (1'b1) // synopsys parallel_case
      ...
      WILL_FIRE_RL_tlp_dmaPullResponseBody:
	  tlp_tlpRcvBusy$D_IN = !tlp_dmaPullRemainDWSub_483_ULE_4___d2625;
  ...
  assign wmi_wmi_sFlagReg$D_IN =
	     { y_avValue__h80579[7:0], y_avValue__h80559[23:0] } ;
  ...
  begin
    case (1'b1) // synopsys parallel_case
      ...
      WILL_FIRE_RL_wmi_doWriteFinalize: bram_memory$DIB = x3__h78964;
  ...
  begin
    case (1'b1) // synopsys parallel_case
      ...
      WILL_FIRE_RL_wmi_doWriteFinalize:
	  bram_memory_1$DIB = mesgMeta_opcode__h79004;
  ...
  assign IF_1_MINUS_tlp_tlpBRAM_writeDWAddr_54_BITS_1_T_ETC___d704 =
	     ...
	     (IF_3_MINUS_tlp_tlpBRAM_writeDWAddr_54_BITS_1_T_ETC___d701 ||
	      bram_serverAdapterA_3_cnt_80_SLT_3___d2630) ;
  assign IF_tlp_fabMesgAddrMS_178_EQ_0_179_THEN_0_ELSE__ETC___d1449 =
	     { (tlp_fabMesgAddrMS == 32'd0) ? 22'd0 : 22'd524288,
	       thisRequestLength__h61413[11:2],
	       pciDevice,
	       tag__h61688,
	       lastBE__h61720,
	       4'd15,
  ...
  assign IF_tlp_fabMetaAddrMS_256_EQ_0_257_THEN_4_ELSE__ETC___d1344 =
  ...
  assign IF_tlp_tlpBRAM_readReq_first__93_BITS_30_TO_29_ETC___d1032 =
	     tlp_tlpBRAM_readReq_first__93_BITS_30_TO_29_95_ETC___d2766[0] ?
	       { bram_serverAdapterA_3_outData_outData$wget[7:0],
		 bram_serverAdapterA_3_outData_outData$wget[15:8],
		 bram_serverAdapterA_3_outData_outData$wget[23:16],
		 bram_serverAdapterA_3_outData_outData$wget[31:24],
		 ...
		 bram_serverAdapterA_1_outData_outData$wget[23:16],
		 bram_serverAdapterA_1_outData_outData$wget[31:24] } ;
  assign IF_tlp_tlpBRAM_readReq_first__93_BITS_30_TO_29_ETC___d1037 =
	     tlp_tlpBRAM_readReq_first__93_BITS_30_TO_29_95_ETC___d2766[0] ?
	       { bram_serverAdapterA_1_outData_outData$wget[7:0],
		 bram_serverAdapterA_1_outData_outData$wget[15:8],
		 bram_serverAdapterA_1_outData_outData$wget[23:16],
		 ...
		 bram_serverAdapterA_3_outData_outData$wget[23:16],
		 bram_serverAdapterA_3_outData_outData$wget[31:24] } ;
  assign IF_tlp_tlpBRAM_readReq_first__93_BITS_30_TO_29_ETC___d917 =
	     IF_tlp_tlpBRAM_readReq_first__93_BITS_30_TO_29_ETC___d908 &&
	     CASE_tlp_tlpBRAM_readReqD_OUT_BITS_30_TO_29_N_ETC__q17 ;
  assign IF_wmi_p4B_880_EQ_0_881_THEN_bram_serverAdapte_ETC___d1894 =
	     (wmi_p4B == 2'd0) ?
	       (bram_serverAdapterB_outDataCore$EMPTY_N ||
		bram_serverAdapterB_outData_enqData$whas) &&
	       bram_serverAdapterB_outData_outData$whas :
	       IF_wmi_p4B_880_EQ_1_883_THEN_bram_serverAdapte_ETC___d1889 &&
	       CASE_wmi_p4B_NOT_wmi_p4B_EQ_3_OR_bram_serverAd_ETC__q18 ;
  assign NOT_bml_lclBufDone_018_085_AND_IF_bml_dpContro_ETC___d2098 =
	     !bml_lclBufDone &&
	     CASE_dpControl_BITS_1_TO_0_bml_fabDone_0_bml_f_ETC__q2 ;
  assign NOT_wmi_wrActive_795_796_OR_NOT_wmi_rdActive_7_ETC___d1805 =
  ...
  assign ab__h8850 =
	     (MUX_bram_memory_2$b_put_1__SEL_1 ||
	      WILL_FIRE_RL_wmi_reqMetadata) ?
	       2'd0 :
	       2'd2 ;
  assign bml_crdBuf_value_976_EQ_bml_crdBuf_modulus_bw__ETC___d2733 =
	     bml_crdBuf_value == bml_crdBuf_modulus ;
  assign bml_fabBuf_value_961_EQ_bml_fabBuf_modulus_bw__ETC___d2735 =
	     bml_fabBuf_value == bml_fabBuf_modulus ;
  assign bml_fabFlowAddr_033_PLUS_bml_fabFlowSize_034___d2623 =
	     bml_fabFlowAddr + bml_fabFlowSize ;
  assign bml_lclBufDone_018_AND_IF_bml_dpControl_wget___ETC___d2824 =
	     bml_lclBufDone &&
	     CASE_dpControl_BITS_1_TO_0_NOT_bml_fabDone_0_N_ETC__q6 ;
  assign bml_lclBuf_value_931_EQ_bml_lclBuf_modulus_bw__ETC___d2732 =
	     bml_lclBuf_value == bml_lclBuf_modulus ;
  assign bml_remBuf_value_946_EQ_bml_remBuf_modulus_bw__ETC___d2734 =
  ...
  assign bram_serverAdapterA_1_cnt_44_SLT_3___d2628 =
  ...
  assign bram_serverAdapterA_2_cnt_62_SLT_3___d2629 =
	     (bram_serverAdapterA_2_cnt ^ 3'h4) < 3'd7 ;
  assign bram_serverAdapterA_2_outDataCore_notEmpty__38_ETC___d989 =
	     (bram_serverAdapterA_2_outDataCore$EMPTY_N ||
	      bram_serverAdapterA_2_outData_enqData$whas) &&
	     (bram_serverAdapterA_3_outDataCore$EMPTY_N ||
	      bram_serverAdapterA_3_outData_enqData$whas) &&
  ...
  assign bram_serverAdapterA_3_cnt_80_SLT_3___d2630 =
  ...
  assign bram_serverAdapterA_cnt_6_SLT_3___d2627 =
	     (bram_serverAdapterA_cnt ^ 3'h4) < 3'd7 ;
  assign bram_serverAdapterA_outDataCore_notEmpty_OR_br_ETC___d991 =
	     (bram_serverAdapterA_outDataCore$EMPTY_N ||
	      bram_serverAdapterA_outData_enqData$whas) &&
	     (bram_serverAdapterA_1_outDataCore$EMPTY_N ||
	      bram_serverAdapterA_1_outData_enqData$whas) &&
  ...
  assign bram_serverAdapterB_1_cnt_03_SLT_3___d1745 =
	     (bram_serverAdapterB_1_cnt ^ 3'h4) < 3'd7 ;
  assign bram_serverAdapterB_1_outData_outData_whas__76_ETC___d1773 =
	     bram_serverAdapterB_1_outData_outData$whas &&
	     (bram_serverAdapterB_2_outDataCore$EMPTY_N ||
	      bram_serverAdapterB_2_outData_enqData$whas) &&
	     bram_serverAdapterB_2_outData_outData$whas &&
  ...
  assign bram_serverAdapterB_2_cnt_21_SLT_3___d1746 =
  ...
  assign bram_serverAdapterB_3_cnt_39_SLT_3___d1747 =
  ...
  assign bram_serverAdapterB_cnt_5_SLT_3___d1744 =
	     (bram_serverAdapterB_cnt ^ 3'h4) < 3'd7 ;
  assign byteCount__h28249 = x__h28367 - y__h28368 ;
  assign hasPull_AND_NOT_tlp_dpControl_wget__061_BIT_8__ETC___d1329 =
	     ...
	     !tlp_reqMetaBodyInFlight &&
	     !tlp_fabMeta[128] ;
  assign hasPull_AND_NOT_tlp_dpControl_wget__061_BIT_8__ETC___d1370 =
	     hasPull && !dpControl[8] && dpControl[7:4] == 4'd0 &&
	     dpControl[3:2] == 2'd2 &&
	     dpControl[1:0] == 2'd1 &&
	     tlp_reqMetaInFlight &&
	     ...
	     tagm__h61903 == tlp_inF$D_OUT[47:40] &&
	     tlp_inF_first__355_BITS_63_TO_56_358_EQ_pciDev_ETC___d1368 ;
  assign hasPull_AND_NOT_tlp_dpControl_wget__061_BIT_8__ETC___d1422 =
	     hasPull && !dpControl[8] && dpControl[7:4] == 4'd0 &&
	     dpControl[3:2] == 2'd2 &&
	     dpControl[1:0] == 2'd1 &&
	     tlp_fabMeta[128] &&
  ...
  assign hasPull_AND_NOT_tlp_dpControl_wget__061_BIT_8__ETC___d1461 =
	     hasPull && !dpControl[8] && dpControl[7:4] == 4'd0 &&
	     dpControl[3:2] == 2'd2 &&
	     dpControl[1:0] == 2'd1 &&
	     tlp_fabMeta[128] &&
  ...
  assign hasPull_AND_NOT_tlp_dpControl_wget__061_BIT_8__ETC___d1481 =
	     hasPull && !dpControl[8] && dpControl[7:4] == 4'd0 &&
	     dpControl[3:2] == 2'd2 &&
	     dpControl[1:0] == 2'd1 &&
	     tlp_fabMeta[128] &&
	     tlp_reqMesgInFlight &&
	     tlp_gotResponseHeader ;
  assign hasPull_AND_NOT_tlp_dpControl_wget__061_BIT_8__ETC___d1506 =
	     hasPull && !dpControl[8] && dpControl[7:4] == 4'd0 &&
	     dpControl[3:2] == 2'd2 &&
	     dpControl[1:0] == 2'd1 &&
	     tlp_fabMeta[128] &&
  ...
  assign hasPush_AND_NOT_tlp_dpControl_wget__061_BIT_8__ETC___d1085 =
	     ...
	     !tlp_fabMeta[128] &&
	     tlp_nearBufReady ;
  assign hasPush_AND_NOT_tlp_dpControl_wget__061_BIT_8__ETC___d1158 =
	     hasPush && !dpControl[8] && dpControl[7:4] == 4'd0 &&
	     dpControl[3:2] == 2'd1 &&
	     dpControl[1:0] == 2'd1 &&
	     tlp_fabMeta[128] &&
  ...
  assign hasPush_AND_NOT_tlp_dpControl_wget__061_BIT_8__ETC___d1198 =
	     hasPush && !dpControl[8] && dpControl[7:4] == 4'd0 &&
	     dpControl[3:2] == 2'd1 &&
	     dpControl[1:0] == 2'd1 &&
	     !tlp_tlpBRAM_mRespF$D_OUT[138] &&
	     ...
	     !tlp_tlpXmtBusy &&
	     tlp_postSeqDwell == 4'd0 ;
  assign hasPush_AND_NOT_tlp_dpControl_wget__061_BIT_8__ETC___d1254 =
	     hasPush && !dpControl[8] && dpControl[7:4] == 4'd0 &&
	     dpControl[3:2] == 2'd1 &&
	     dpControl[1:0] == 2'd1 &&
	     tlp_fabMeta[128] &&
	     ...
	     tlp_xmtMetaOK &&
	     tlp_postSeqDwell == 4'd0 ;
  assign hasPush_AND_NOT_tlp_dpControl_wget__061_BIT_8__ETC___d1274 =
	     hasPush && !dpControl[8] && dpControl[7:4] == 4'd0 &&
	     dpControl[3:2] == 2'd1 &&
	     dpControl[1:0] == 2'd1 &&
	     tlp_fabMeta[128] &&
	     tlp_doXmtMetaBody ;
  assign hasPush_AND_NOT_tlp_dpControl_wget__061_BIT_8__ETC___d1305 =
	     hasPush && !dpControl[8] && dpControl[7:4] == 4'd0 &&
	     dpControl[3:2] == 2'd1 &&
	     dpControl[1:0] == 2'd1 &&
	     tlp_fabMeta[128] &&
  ...
  assign lastBE__h45607 =
	     tlp_tlpBRAM_mRespF_first__100_BITS_71_TO_62_20_ETC___d2772 ?
	       4'd0 :
	       4'd15 ;
  assign lastBE__h61720 =
	     (thisRequestLength__h61413[11:2] == 10'd1) ? 4'd0 : 4'd15 ;
  assign lowAddr__h28248 =
	     { tlp_tlpBRAM_readReq$D_OUT[33:29], lowAddr10__h28247 } ;
  assign mesgMeta_opcode__h79004 =
	     { 24'h800000, wmi_wmi_mFlagF$D_OUT[31:24] } ;
  assign nowLS__h43924 =
	     { tlp_tlpBRAM_mRespF$D_OUT[39:32],
	       tlp_tlpBRAM_mRespF$D_OUT[47:40],
	       tlp_tlpBRAM_mRespF$D_OUT[55:48],
	       tlp_tlpBRAM_mRespF$D_OUT[63:56] } ;
  assign nowLS__h60162 =
	     { tlp_inF$D_OUT[39:32],
	       tlp_inF$D_OUT[47:40],
	       tlp_inF$D_OUT[55:48],
	       tlp_inF$D_OUT[63:56] } ;
  assign nowMS__h42981 =
	     { tlp_tlpBRAM_mRespF$D_OUT[71:64],
	       tlp_tlpBRAM_mRespF$D_OUT[79:72],
	       tlp_tlpBRAM_mRespF$D_OUT[87:80],
	       tlp_tlpBRAM_mRespF$D_OUT[95:88] } ;
  assign nowMS__h59221 =
	     { tlp_inF$D_OUT[71:64],
	       tlp_inF$D_OUT[79:72],
	       tlp_inF$D_OUT[87:80],
	       tlp_inF$D_OUT[95:88] } ;
  assign opcode__h41750 =
  ...
  assign rdat__h87973 = { 16'd0, bml_lclNumBufs } ;
  assign rdat__h87981 = { 16'd0, bml_fabNumBufs } ;
  assign rdat__h87989 = { 16'd0, bml_mesgBase } ;
  assign rdat__h87997 = { 16'd0, bml_metaBase } ;
  assign rdat__h88005 = { 16'd0, bml_mesgSize } ;
  assign rdat__h88013 = { 16'd0, bml_metaSize } ;
  assign rdat__h88021 = { 16'd0, bml_lclBufsCF } ;
  assign rdat__h88038 = hasDebugLogic ? 32'hF00DFACE : 32'd0 ;
  assign rdat__h88044 =
  ...
  assign rdat__h88078 = hasDebugLogic ? wmi_thisMesg : 32'd0 ;
  assign rdat__h88342 = hasDebugLogic ? wmi_lastMesg : 32'd0 ;
  assign rdat__h88392 =
	     hasDebugLogic ? { wmi_reqCount, wmi_wrtCount } : 32'd0 ;
  assign rdat__h88492 = hasDebugLogic ? 32'hDADEBABE : 32'd0 ;
  assign rdat__h88498 = hasDebugLogic ? 32'h00008000 : 32'd0 ;
  assign rdat__h88552 = { 23'd0, dpControl } ;
  assign rdat__h88580 = hasDebugLogic ? tlp_flowDiagCount : 32'd0 ;
  assign rdat__h88590 =
	     hasDebugLogic ?
	       { 4'h0,
		 tlp_complTimerCount,
		 ...
		 CASE_tlp_lastRuleFired_10_1_tlp_lastRuleFired__ETC__q1 } :
	       32'd0 ;
  assign rdat__h88712 = hasDebugLogic ? tlp_lastMetaV : 32'd0 ;
  assign rdat__h88833 = hasDebugLogic ? tlp_lastMetaV_1 : 32'd0 ;
  assign rdat__h88862 = hasDebugLogic ? tlp_lastMetaV_2 : 32'd0 ;
  assign rdat__h88891 = hasDebugLogic ? tlp_lastMetaV_3 : 32'd0 ;
  assign rdat__h88920 = hasDebugLogic ? 32'hC0DE0111 : 32'd0 ;
  assign rdata__h33678 =
	     tlp_tlpBRAM_readReq_first__93_BITS_30_TO_29_95_ETC___d2766[1] ?
	       IF_tlp_tlpBRAM_readReq_first__93_BITS_30_TO_29_ETC___d1032 :
	       IF_tlp_tlpBRAM_readReq_first__93_BITS_30_TO_29_ETC___d1037 ;
  assign rreq_tag__h45386 =
	     (y__h45196 == tlp_mesgLengthRemainPush) ? 8'h01 : 8'h0 ;
  assign rresp_data__h28294 =
	     { IF_tlp_tlpBRAM_readReq_first__93_BITS_30_TO_29_ETC___d2778[7:0],
	       IF_tlp_tlpBRAM_readReq_first__93_BITS_30_TO_29_ETC___d2778[15:8],
	       IF_tlp_tlpBRAM_readReq_first__93_BITS_30_TO_29_ETC___d2778[23:16],
	       IF_tlp_tlpBRAM_readReq_first__93_BITS_30_TO_29_ETC___d2778[31:24] } ;
  assign spanToNextPage__h45170 = 13'd4096 - { 1'd0, tlp_srcMesgAccu[11:0] } ;
  assign spanToNextPage__h61412 = 13'd4096 - { 1'd0, tlp_fabMesgAccu[11:0] } ;
  assign tag__h61688 = { 3'd0, tlp_dmaTag } ;
  assign tagm__h61903 = { 3'd0, tlp_dmaReqTag } ;
  assign thisRequestLength__h45171 =
	     (x__h45209[12:0] <= spanToNextPage__h45170) ?
	       x__h45209[12:0] :
	       spanToNextPage__h45170 ;
  assign thisRequestLength__h61413 =
	     (x__h61446[12:0] <= spanToNextPage__h61412) ?
	       x__h61446[12:0] :
	       spanToNextPage__h61412 ;
  assign tlp_dmaPullRemainDWLen_469_ULE_tlp_dmaPullRema_ETC___d2624 =
	     tlp_dmaPullRemainDWLen <= tlp_dmaPullRemainDWSub ;
  assign tlp_dmaPullRemainDWSub_483_ULE_4___d2625 =
	     tlp_dmaPullRemainDWSub <= 10'd4 ;
  assign tlp_inF_first__355_BITS_63_TO_56_358_EQ_pciDev_ETC___d1368 =
	     tlp_inF$D_OUT[63:56] == pciDevice[15:8] &&
	     tlp_inF$D_OUT[55:51] == pciDevice[7:3] &&
	     tlp_inF$D_OUT[50:48] == pciDevice[2:0] ;
  assign tlp_inF_first__355_BIT_152_540_AND_NOT_tlp_inF_ETC___d1565 =
  ...
  assign tlp_outDwRemain_228_ULE_4___d2459 = tlp_outDwRemain <= 10'd4 ;
  ...
  assign tlp_tlpBRAM_mReqF_first__14_BIT_63_15_OR_IF_tl_ETC___d630 =
	     tlp_tlpBRAM_mReqF$D_OUT[63] ||
	     CASE_tlp_tlpBRAM_mReqFD_OUT_BITS_51_TO_50_NOT_ETC__q4 ;
  assign tlp_tlpBRAM_mRespF_first__100_BITS_71_TO_62_20_ETC___d2772 =
	     tlp_tlpBRAM_mRespF$D_OUT[71:62] <= 10'd1 ;
  assign tlp_tlpBRAM_rdRespDwRemain_020_ULE_4___d1022 =
	     tlp_tlpBRAM_rdRespDwRemain <= 10'd4 ;
  ...
  assign tlp_tlpBRAM_readRemainDWLen_42_ULE_4___d843 =
	     tlp_tlpBRAM_readRemainDWLen <= 10'd4 ;
  assign tlp_tlpBRAM_readReq_first__93_BITS_30_TO_29_95_ETC___d2766 =
	     tlp_tlpBRAM_readReq$D_OUT[30:29] + 2'd1 ;
  ...
  assign tlp_tlpBRAM_writeRemainDWLen_58_ULE_1___d2769 =
	     tlp_tlpBRAM_writeRemainDWLen <= 10'd1 ;
  assign tlp_tlpBRAM_writeRemainDWLen_58_ULE_2___d2770 =
	     tlp_tlpBRAM_writeRemainDWLen <= 10'd2 ;
  assign tlp_tlpBRAM_writeRemainDWLen_58_ULE_3___d2771 =
	     tlp_tlpBRAM_writeRemainDWLen <= 10'd3 ;
  assign w_be__h46315 =
	     tlp_outDwRemain_228_ULE_4___d2459 ?
	       CASE_tlp_outDwRemain_BITS_1_TO_0_0xFFF0_0b0_0x_ETC__q3 :
	       16'd65535 ;
  assign w_data__h45580 =
	     { 22'd1048576,
	       tlp_tlpBRAM_mRespF$D_OUT[71:62],
	       pciDevice,
	       8'd0,
  ...
  assign w_data__h50640 =
	     { tlp_fabMeta[103:96],
	       ...
	       tlp_fabMeta[23:16],
	       tlp_fabMeta[31:24] } ;
  assign w_data__h63296 =
	     { 32'd1073741825,
	       pciDevice,
	       16'd15,
	       tlp_fabFlowAddr,
	       32'd16777216 } ;
  assign w_data__h64349 =
	     { 32'd1610612737,
	       pciDevice,
	       16'd15,
	       tlp_fabFlowAddrMS,
	       tlp_fabFlowAddr } ;
  assign wmi_dpControl_whas__731_AND_bram_serverAdapter_ETC___d1777 =
	     (bram_serverAdapterB_outDataCore$EMPTY_N ||
	      bram_serverAdapterB_outData_enqData$whas) &&
	     bram_serverAdapterB_outData_outData$whas &&
	     (bram_serverAdapterB_1_outDataCore$EMPTY_N ||
	      bram_serverAdapterB_1_outData_enqData$whas) &&
	     bram_serverAdapterB_1_outData_outData_whas__76_ETC___d1773 ;
  assign wmi_wmi_operateD_684_AND_wmi_wmi_peerIsReady_6_ETC___d1859 =
	     wmi_wmi_operateD && wmi_wmi_peerIsReady &&
	     bram_serverAdapterB_cnt_5_SLT_3___d1744 &&
	     bram_serverAdapterB_1_cnt_03_SLT_3___d1745 &&
	     bram_serverAdapterB_2_cnt_21_SLT_3___d1746 &&
	     bram_serverAdapterB_3_cnt_39_SLT_3___d1747 &&
	     wmi_wmi_mFlagF$EMPTY_N ;
  assign x3__h78964 = { 8'd0, wmi_wmi_mFlagF$D_OUT[23:0] } ;
  assign x__h28367 = x__h28369 - y__h28370 ;
  assign x__h28369 = { tlp_tlpBRAM_readReq$D_OUT[28:19], 2'b0 } ;
  assign x__h39916 =
	     { tlp_tlpBRAM_mRespF$D_OUT[7:0],
	       tlp_tlpBRAM_mRespF$D_OUT[15:8],
	       tlp_tlpBRAM_mRespF$D_OUT[23:16],
	       tlp_tlpBRAM_mRespF$D_OUT[31:24] } ;
  assign x__h44927 = { 15'd0, tlp_mesgLengthRemainPush } ;
  assign x__h45209 =
	     (tlp_mesgLengthRemainPush <= y__h45211) ?
  ...
  assign x__h55973 =
	     { tlp_inF$D_OUT[7:0],
	       ...
	       tlp_inF$D_OUT[23:16],
	       tlp_inF$D_OUT[31:24] } ;
  assign x__h61132 = { 15'd0, tlp_mesgLengthRemainPull } ;
  assign x__h61446 =
	     (tlp_mesgLengthRemainPull <= y__h61448) ?
	       tlp_mesgLengthRemainPull :
	       y__h61448 ;
  assign x__h84875 = (dpControl[1:0] == 2'd1) ? bml_fabNumBufs : 16'd0 ;
  assign x__h85999 = bml_lclBufsAR + 16'd1 ;
  assign x__h86004 = bml_lclBufsAR - 16'd1 ;
  assign x__h86076 = bml_lclBufsCF + 16'd1 ;
  assign x__h86081 = bml_lclBufsCF - 16'd1 ;
  assign x__h86118 = bml_fabBufsAvail + 16'd1 ;
  assign x__h86123 = bml_fabBufsAvail - 16'd1 ;
  assign x__h86156 = bml_lclCredit + 16'd1 ;
  assign x__h86161 = bml_lclCredit - 16'd1 ;
  ...
  assign y__h28368 =
	     (tlp_tlpBRAM_readReq$D_OUT[28:19] == 10'd1) ?
	       12'd0 :
	       { 10'd0, x__h28399 } ;
  assign y__h28370 = { 10'd0, x__h28376 } ;
  assign y__h29309 = tlp_tlpBRAM_readReq$D_OUT[60] ? 10'd0 : 10'd1 ;
  assign y__h45196 = { 4'd0, thisRequestLength__h45171 } ;
  assign y__h45211 = { 4'd0, tlp_maxPayloadSize } ;
  assign y__h45290 = { 19'd0, thisRequestLength__h45171 } ;
  assign y__h45338 = { 3'd0, thisRequestLength__h45171 } ;
  assign y__h45744 = { 20'd0, tlp_tlpBRAM_mRespF$D_OUT[71:62], 2'd0 } ;
  assign y__h61438 = { 4'd0, thisRequestLength__h61413 } ;
  assign y__h61448 = { 4'd0, tlp_maxReadReqSize } ;
  assign y__h61509 = { 19'd0, thisRequestLength__h61413 } ;
  assign y__h62110 = { 4'd0, tlp_inF$D_OUT[105:96], 2'd0 } ;
  assign y__h62817 =
	     tlp_dmaPullRemainDWSub_483_ULE_4___d2625 ?
	       { 5'd0, tlp_dmaPullRemainDWSub, 2'd0 } :
	       17'd16 ;
  assign y_avValue__h80559 =
	     bram_serverAdapterB_outDataCore$EMPTY_N ?
	       bram_serverAdapterB_outDataCore$D_OUT :
	       bram_memory$DOB ;
  assign y_avValue__h80579 =
	     bram_serverAdapterB_1_outDataCore$EMPTY_N ?
	       bram_serverAdapterB_1_outDataCore$D_OUT :
	       bram_memory_1$DOB ;
  assign y_avValue__h80599 =
	     bram_serverAdapterB_2_outDataCore$EMPTY_N ?
	       bram_serverAdapterB_2_outDataCore$D_OUT :
	       bram_memory_2$DOB ;
  assign y_avValue__h80619 =
	     bram_serverAdapterB_3_outDataCore$EMPTY_N ?
	       bram_serverAdapterB_3_outDataCore$D_OUT :
	       bram_memory_3$DOB ;
  ...
  begin
    case (tlp_tlpBRAM_readReq$D_OUT[14:11])
      4'b1100: x__h28399 = 2'b10;
      4'b1110: x__h28399 = 2'b01;
      4'b1111: x__h28399 = 2'b0;
      default: x__h28399 = 2'b11;
    endcase
  end
  ...
  always@(wmi_p4B or
	  y_avValue__h80619 or
	  y_avValue__h80559 or y_avValue__h80579 or y_avValue__h80599)
  begin
    case (wmi_p4B)
      2'd0: rdata__h80723 = y_avValue__h80559;
      2'd1: rdata__h80723 = y_avValue__h80579;
      2'd2: rdata__h80723 = y_avValue__h80599;
      2'd3: rdata__h80723 = y_avValue__h80619;
    endcase
  end
  ...
  begin
    case (wci_reqF$D_OUT[39:32])
      8'h0: _theResult____h87894 = rdat__h87973;
      8'h04: _theResult____h87894 = rdat__h87981;
      8'h08: _theResult____h87894 = rdat__h87989;
      8'h0C: _theResult____h87894 = rdat__h87997;
      8'h10: _theResult____h87894 = rdat__h88005;
      8'h14: _theResult____h87894 = rdat__h88013;
      8'h20: _theResult____h87894 = rdat__h88021;
      8'h24: _theResult____h87894 = rdat__h88038;
      8'h28: _theResult____h87894 = rdat__h88044;
      8'h2C: _theResult____h87894 = rdat__h88051;
      8'h30: _theResult____h87894 = rdat__h88064;
      8'h34: _theResult____h87894 = rdat__h88071;
      8'h38: _theResult____h87894 = rdat__h88078;
      8'h3C: _theResult____h87894 = rdat__h88342;
      8'h40: _theResult____h87894 = rdat__h88392;
      8'h44: _theResult____h87894 = 32'd0;
      8'h48: _theResult____h87894 = rdat__h88492;
      8'h4C: _theResult____h87894 = rdat__h88498;
      8'h50: _theResult____h87894 = bml_fabMesgBase;
      8'h54: _theResult____h87894 = bml_fabMetaBase;
      8'h58: _theResult____h87894 = bml_fabMesgSize;
      8'h5C: _theResult____h87894 = bml_fabMetaSize;
      8'h60: _theResult____h87894 = bml_fabFlowBase;
      8'h64: _theResult____h87894 = bml_fabFlowSize;
      8'h68: _theResult____h87894 = rdat__h88552;
      8'h6C: _theResult____h87894 = rdat__h88580;
      8'h70: _theResult____h87894 = rdat__h88590;
      8'h80: _theResult____h87894 = rdat__h88712;
      8'h84: _theResult____h87894 = rdat__h88833;
      8'h88: _theResult____h87894 = rdat__h88862;
      8'h8C: _theResult____h87894 = rdat__h88891;
      8'h90: _theResult____h87894 = rdat__h88920;
      8'h94: _theResult____h87894 = bml_fabMesgBaseMS;
      8'h98: _theResult____h87894 = bml_fabMetaBaseMS;
      8'h9C: _theResult____h87894 = bml_fabFlowBaseMS;
      default: _theResult____h87894 = 32'd0;
    endcase
  end
  always@(tlp_tlpBRAM_readReq$D_OUT)
  begin
    case (tlp_tlpBRAM_readReq$D_OUT[18:15])
      4'b1000: lowAddr10__h28247 = 2'b11;
      4'b1100: lowAddr10__h28247 = 2'b10;
      4'b1110: lowAddr10__h28247 = 2'b01;
      default: lowAddr10__h28247 = 2'b0;
    endcase
  end
  ...
  begin
    case (dpControl[1:0])
	  ...
	  IF_bml_dpControl_wget__994_BITS_1_TO_0_000_EQ__ETC___d2071 =
	      bml_remDone;
      default: IF_bml_dpControl_wget__994_BITS_1_TO_0_000_EQ__ETC___d2071 =
		   bml_fabDone;
    endcase
  end
  ...
  always@(idx__h18875 or
	  tlp_tlpBRAM_writeRemainDWLen_58_ULE_3___d2771 or
	  tlp_tlpBRAM_writeRemainDWLen or
	  tlp_tlpBRAM_writeRemainDWLen_58_ULE_1___d2769 or
	  tlp_tlpBRAM_writeRemainDWLen_58_ULE_2___d2770)
  begin
    case (idx__h18875)
      2'd0:
  ...
  always@(tlp_tlpBRAM_mReqF$D_OUT or
	  bram_serverAdapterA_3_cnt_80_SLT_3___d2630 or
	  bram_serverAdapterA_cnt_6_SLT_3___d2627 or
	  bram_serverAdapterA_1_cnt_44_SLT_3___d2628 or
	  bram_serverAdapterA_2_cnt_62_SLT_3___d2629)
  begin
  ...
  always@(wmi_addr or
	  bram_serverAdapterB_3_cnt_39_SLT_3___d1747 or
	  bram_serverAdapterB_cnt_5_SLT_3___d1744 or
	  bram_serverAdapterB_1_cnt_03_SLT_3___d1745 or
	  bram_serverAdapterB_2_cnt_21_SLT_3___d1746)
  begin
    case (wmi_addr[3:2])
      2'd0:
  ...
  begin
    case (idx__h18875)
      2'd0:
	  IF_0_MINUS_tlp_tlpBRAM_writeDWAddr_54_BITS_1_T_ETC___d2358 =
	      tlp_tlpBRAM_mReqF$D_OUT[127:96];
      2'd1:
	  IF_0_MINUS_tlp_tlpBRAM_writeDWAddr_54_BITS_1_T_ETC___d2358 =
	      tlp_tlpBRAM_mReqF$D_OUT[95:64];
  ...
  begin
    case (wmi_p4B)
	  ...
	  IF_wmi_p4B_880_EQ_1_883_THEN_bram_serverAdapte_ETC___d1889 =
	      bram_serverAdapterB_2_outDataCore$EMPTY_N ||
	      bram_serverAdapterB_2_outData_enqData$whas;
      default: IF_wmi_p4B_880_EQ_1_883_THEN_bram_serverAdapte_ETC___d1889 =
		   wmi_p4B != 2'd3 ||
		   bram_serverAdapterB_3_outDataCore$EMPTY_N ||
		   bram_serverAdapterB_3_outData_enqData$whas;
    endcase
  ...
  begin
    ...
    if (RST_N)
      if (WILL_FIRE_RL_tlp_dmaXmtMetaHead)
	$display("[%0d]: %m: dmaXmtMetaHead FPactMesg-Step5/7", v__h47803);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_tlp_dmaXmtTailEvent)
	$display("[%0d]: %m: dmaXmtTailEvent FPactMesg-Step7/7", v__h54209);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_tlp_dmaXmtMetaBody)
	$display("[%0d]: %m: dmaXmtMetaBody FPactMesg-Step6/7", v__h54089);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_tlp_dmaXmtDoorbell)
	$display("[%0d]: %m: dmaXmtDoorbell FC/FPactFlow-Step1/1", v__h54378);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_tlp_dmaPullTailEvent)
	$display("[%0d]: %m: dmaPullTailEvent FPactMesg-Step5/5", v__h63025);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_tlp_dmaTailEventSender)
	$display("[%0d]: %m: dmaTailEventSender - generic", v__h68038);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_tlp_dmaRequestFarMeta)
	$display("[%0d]: %m: dmaRequestFarMeta FCactMesg-Step1/5", v__h54818);
    if (RST_N)
    ...
    if (RST_N)
      if (WILL_FIRE_RL_wci_cfwr && wci_reqF$D_OUT[39:32] == 8'h18)
	$display("[%0d] %m: fabDoneAvail Event", v__h87280);
    if (RST_N)
