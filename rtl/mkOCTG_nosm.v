...
//
// On Thu Mar 17 17:01:53 EDT 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkOCTG_nosm(CLK,
  ...
  reg [63 : 0] v__h12165, v__h5728;
  wire [127 : 0] x_data__h11908, x_data__h5458;
  wire [31 : 0] v__h12119;
  wire NOT_rdServer0_abort_whas__4_6_OR_NOT_rdServer0_ETC___d51,
       NOT_reqFsm_abort_whas__81_95_OR_NOT_reqFsm_abo_ETC___d200,
  ...
  assign MUX_outF$enq_1__VAL_2 = { 25'd25362431, x_data__h11908 } ;

  // inlined wires
  assign rdServer0_fifo_in_bypass_enq$wget = 32'h0 ;
  assign rdServer0_fifo_in_bypass_enq$whas = 1'b0 ;
  assign rdServer0_fifo_out_bypass_enq$wget = v__h12119 ;
  ...
  assign rdServer1_fifo_out_bypass_enq$wget = v__h12119 ;
  ...
  assign reqFsm_start_reg$EN = reqFsm_start_wire$whas ;
  ...
  assign NOT_reqFsm_abort_whas__81_95_OR_NOT_reqFsm_abo_ETC___d200 =
