...
//
// On Sun Jun  6 11:14:32 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker4B(wciS0_Clk,
  ...
  reg [63 : 0] v__h17437,
	       ...
	       v__h2816,
	       v__h3715;
  reg [31 : 0] sendData__h23174, x_data__h21569;
  reg CASE_wrtSerPos_0b1_0_1_1_1_2_1_3_0b1__q1,
      IF_wrtSerPos_00_EQ_0_01_OR_wrtSerPos_00_EQ_1_0_ETC___d885;
  wire [127 : 0] IF_wrtSerPos_00_EQ_2_03_THEN_0x0_ELSE_mesgWF_w_ETC___d342,
		 IF_wrtSerPos_00_EQ_2_03_THEN_0x0_ELSE_metaWF_f_ETC___d365,
		 x1__h19787,
		 x1__h19796,
		 x1__h20310,
		 x1__h20319;
  wire [35 : 0] addr__h20788, addr__h20960;
  wire [31 : 0] data__h19441,
		mesg__h22096,
		rdat__h21613,
		rdat__h21822,
		rdat__h21830,
		...
		x__h15108,
		x__h16034;
  wire [23 : 0] x1_length__h17130, x__h20846, x__h21005, x__h21616;
  wire [13 : 0] mlp1__h17829, x__h17174;
  wire [11 : 0] x_burstLength__h22187;
  wire [10 : 0] x__h15000, x__h15926;
  wire [7 : 0] x1_opcode__h17129;
  wire [3 : 0] x_byteEn__h22188;
  wire [1 : 0] wrtSerPos_00_PLUS_1___d970;
  wire NOT_mesgRF_rRdPtr_49_PLUS_512_93_EQ_mesgRF_rWr_ETC___d208,
       NOT_wmemi_reqF_c_r_56_EQ_2_57_58_AND_NOT_wmemi_ETC___d283,
       NOT_wsiS_reqFifo_countReg_79_ULE_1_80___d681,
       _dor1bytesWritten$EN_write,
       metaRF_RDY_enq__40_AND_NOT_rdSerEmpty_96_97_AN_ETC___d241,
       metaWF_RDY_deq__46_AND_NOT_wrtSerPos_00_EQ_3_0_ETC___d353,
       wci_cState_9_EQ_2_0_AND_dlyCtrl_4_BITS_3_TO_0__ETC___d184,
       wci_cState_9_EQ_2_0_AND_dlyCtrl_4_BITS_3_TO_0__ETC___d385;
  ...
  assign CAN_FIRE_RL_rdSer_body =
	     NOT_mesgRF_rRdPtr_49_PLUS_512_93_EQ_mesgRF_rWr_ETC___d208 &&
	     wci_cState == 3'd2 &&
	     dlyCtrl[3:0] == 4'h7 &&
	     rdSerUnroll != 16'd0 &&
	     !rdSyncWord ;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, x_data__h21569 } ;
  ...
  assign MUX_wci_respF_q_1$write_1__VAL_1 =
	     (wci_respF_c_r == 2'd2) ?
	       MUX_wci_respF_q_0$write_1__VAL_2 :
	       34'h0AAAAAAAA ;
  assign MUX_mesgLength$write_1__VAL_3 = { 1'd1, mlp1__h17829[11:0], 2'd0 } ;
  ...
  assign MUX_metaWF$enq_1__VAL_1 = { x1_opcode__h17129, x1_length__h17130 } ;
  ...
  assign MUX_rdSyncWord$write_1__VAL_2 =
	     rdSerPos != 2'd3 && sendData__h23174[23:0] == 24'd0 ;
  ...
  always@(wrtSerPos or
	  IF_wrtSerPos_00_EQ_2_03_THEN_0x0_ELSE_metaWF_f_ETC___d365 or
	  x1__h20310 or x1__h20319)
  begin
    case (wrtSerPos)
      2'd0: MUX_wide16Fa$enq_1__VAL_1 = x1__h20310;
      2'd1: MUX_wide16Fa$enq_1__VAL_1 = x1__h20319;
      default: MUX_wide16Fa$enq_1__VAL_1 =
		   IF_wrtSerPos_00_EQ_2_03_THEN_0x0_ELSE_metaWF_f_ETC___d365;
    endcase
  end
  always@(wrtSerPos or
	  IF_wrtSerPos_00_EQ_2_03_THEN_0x0_ELSE_mesgWF_w_ETC___d342 or
	  x1__h19787 or x1__h19796)
  begin
    case (wrtSerPos)
      2'd0: MUX_wide16Fa$enq_1__VAL_2 = x1__h19787;
      2'd1: MUX_wide16Fa$enq_1__VAL_2 = x1__h19796;
      default: MUX_wide16Fa$enq_1__VAL_2 =
		   IF_wrtSerPos_00_EQ_2_03_THEN_0x0_ELSE_mesgWF_w_ETC___d342;
    endcase
  end
  ...
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_1 = { 4'd5, addr__h20788, 12'd1 } ;
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_2 = { 4'd3, addr__h20960, 12'd1 } ;
  ...
  assign mesgWF_wDataOut$wget = data__h19441 ;
  ...
  assign mesgRF_wDataIn$wget = sendData__h23174 ;
  assign mesgRF_wDataIn$whas = CAN_FIRE_RL_rdSer_body ;
  assign mesgRF_wDataOut$wget = mesg__h22096 ;
  ...
  // register blockDelayWrite
  assign blockDelayWrite$D_IN = !WILL_FIRE_RL_delay_write_unblock ;
  ...
  // register mesgRF_rCache
  assign mesgRF_rCache$D_IN = { 1'd1, mesgRF_rWrPtr, x__h16034 } ;
  assign mesgRF_rCache$EN = CAN_FIRE_RL_rdSer_body ;

  // register mesgRF_rRdPtr
  assign mesgRF_rRdPtr$D_IN = x__h15926 ;
  ...
  // register mesgWF_rCache
  assign mesgWF_rCache$D_IN = { 1'd1, mesgWF_rWrPtr, x__h15108 } ;
  assign mesgWF_rCache$EN = mesgWF_pwEnqueue$whas ;

  // register mesgWF_rRdPtr
  assign mesgWF_rRdPtr$D_IN = x__h15000 ;
  ...
  // register rdSerMeta
  assign rdSerMeta$D_IN = sendData__h23174 ;
  ...
  assign wrtSerStage$D_IN =
	     MUX_wrtSerStage$write_1__SEL_1 ? data__h19441 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_1$D_IN =
	     MUX_wrtSerStage_1$write_1__SEL_1 ? data__h19441 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_2$D_IN =
	     MUX_wrtSerStage_2$write_1__SEL_1 ? data__h19441 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_3$D_IN =
	     MUX_wrtSerStage_3$write_1__SEL_1 ? data__h19441 : metaWF$D_OUT ;
  ...
  assign mesgRF_memory$DIA = x__h16034 ;
  ...
  // remaining internal signals
  assign IF_wrtSerPos_00_EQ_2_03_THEN_0x0_ELSE_mesgWF_w_ETC___d342 =
	     { (wrtSerPos == 2'd2) ? 32'h0 : data__h19441,
	       (wrtSerPos == 2'd2) ? data__h19441 : wrtSerStage_2,
	       wrtSerStage_1,
	       wrtSerStage } ;
  assign IF_wrtSerPos_00_EQ_2_03_THEN_0x0_ELSE_metaWF_f_ETC___d365 =
	     { (wrtSerPos == 2'd2) ? 32'h0 : metaWF$D_OUT,
	       (wrtSerPos == 2'd2) ? metaWF$D_OUT : wrtSerStage_2,
	       wrtSerStage_1,
	       wrtSerStage } ;
  assign NOT_mesgRF_rRdPtr_49_PLUS_512_93_EQ_mesgRF_rWr_ETC___d208 =
	     mesgRF_rRdPtr + 11'd512 != mesgRF_rWrPtr &&
	     (!rdSerEmpty && rdSerPos != 2'd0 || wide16Fb$EMPTY_N) ;
  assign NOT_wmemi_reqF_c_r_56_EQ_2_57_58_AND_NOT_wmemi_ETC___d283 =
	     wmemi_reqF_c_r != 2'd2 && wmemi_dhF_c_r != 2'd2 &&
	     wmemi_operateD &&
	     wmemi_peerIsReady ;
  assign NOT_wsiS_reqFifo_countReg_79_ULE_1_80___d681 =
	     wsiS_reqFifo_countReg > 2'd1 ;
  assign _dor1bytesWritten$EN_write =
	     WILL_FIRE_RL_wmwt_messagePushPrecise ||
	     WILL_FIRE_RL_wmwt_messagePushImprecise ;
  assign addr__h20788 = { 12'd0, x__h20846 } ;
  assign addr__h20960 = { 12'd0, x__h21005 } ;
  assign data__h19441 =
  ...
  assign metaRF_RDY_enq__40_AND_NOT_rdSerEmpty_96_97_AN_ETC___d241 =
	     metaRF$FULL_N &&
	     (!rdSerEmpty && rdSerPos != 2'd0 || wide16Fb$EMPTY_N) ;
  assign metaWF_RDY_deq__46_AND_NOT_wrtSerPos_00_EQ_3_0_ETC___d353 =
	     metaWF$EMPTY_N &&
	     (wrtSerPos != 2'd3 && metaWF$D_OUT[23:0] != 24'd0 ||
	      IF_wrtSerPos_00_EQ_0_01_OR_wrtSerPos_00_EQ_1_0_ETC___d885) ;
  assign mlp1__h17829 = MUX_mesgLengthSoFar$write_1__VAL_2 ;
  assign rdat__h21613 = { 8'd0, x__h21616 } ;
  assign rdat__h21822 = { 12'd0, dlyWordsStored_value } ;
  assign rdat__h21830 = { 24'd0, dlyReadCredit_value } ;
  assign rdat__h21838 = { 12'd0, dlyWAG } ;
  assign rdat__h21846 = { 12'd0, dlyRAG } ;
  assign wci_cState_9_EQ_2_0_AND_dlyCtrl_4_BITS_3_TO_0__ETC___d184 =
	     wci_cState == 3'd2 && dlyCtrl[3:0] == 4'h7 &&
	     unrollCnt == 16'd0 &&
	     bytesWritten > dlyHoldoff ;
  assign wci_cState_9_EQ_2_0_AND_dlyCtrl_4_BITS_3_TO_0__ETC___d385 =
	     wci_cState == 3'd2 && dlyCtrl[3:0] == 4'h7 && mesgLength[14] &&
	     !doAbort &&
	     (preciseBurst && wsiWordsRemain == 12'd0 ||
	      impreciseBurst && endOfMessage) ;
  assign wrtSerPos_00_PLUS_1___d970 = wrtSerPos + 2'd1 ;
  assign x1__h19787 = { 96'd0, data__h19441 } ;
  assign x1__h19796 = { 64'd0, data__h19441, wrtSerStage } ;
  assign x1__h20310 = { 96'd0, metaWF$D_OUT } ;
  assign x1__h20319 = { 64'd0, metaWF$D_OUT, wrtSerStage } ;
  assign x1_length__h17130 = { 10'd0, x__h17174 } ;
  assign x1_opcode__h17129 = opcode[8] ? opcode[7:0] : 8'd0 ;
  assign x__h15000 = mesgWF_rRdPtr + 11'd1 ;
  assign x__h15108 =
	     mesgWF_pwEnqueue$whas ? wsiS_reqFifo$D_OUT[43:12] : 32'd0 ;
  assign x__h15926 = mesgRF_rRdPtr + 11'd1 ;
  assign x__h16034 = CAN_FIRE_RL_rdSer_body ? sendData__h23174 : 32'd0 ;
  assign x__h17174 = mesgLength[14] ? mesgLength[13:0] : 14'd0 ;
  assign x__h20846 = { dlyRAG, 4'h0 } ;
  assign x__h21005 = { dlyWAG, 4'h0 } ;
  assign x__h21616 = { wmemi_statusR, wsiS_statusR, wsiM_statusR } ;
  assign x_burstLength__h22187 =
	     (readMeta[23:0] == 24'd0) ? 12'd1 : readMeta[13:2] ;
  assign x_byteEn__h22188 = (readMeta[23:0] == 24'd0) ? 4'd0 : 4'd15 ;
  always@(wci_reqF$D_OUT or
	  ...
	  wmemiRdReq or
	  wmemiRdResp or
	  rdat__h21822 or rdat__h21830 or rdat__h21838 or rdat__h21846)
  begin
    case (wci_reqF$D_OUT[51:32])
      20'h0: x_data__h21569 = dlyCtrl;
      20'h00004: x_data__h21569 = dlyHoldoff;
      20'h00008: x_data__h21569 = mesgWtCount;
      20'h0000C: x_data__h21569 = mesgRdCount;
      20'h00010: x_data__h21569 = bytesWritten;
      20'h00014: x_data__h21569 = 32'd0;
      20'h00018: x_data__h21569 = rdat__h21613;
      20'h00020: x_data__h21569 = wsiS_extStatusW$wget[95:64];
      20'h00024: x_data__h21569 = wsiS_extStatusW$wget[63:32];
      20'h00028: x_data__h21569 = wsiS_extStatusW$wget[31:0];
      20'h0002C: x_data__h21569 = wsiM_extStatusW$wget[95:64];
      20'h00030: x_data__h21569 = wsiM_extStatusW$wget[63:32];
      20'h00034: x_data__h21569 = wsiM_extStatusW$wget[31:0];
      20'h00038: x_data__h21569 = wmemiWrReq;
      20'h0003C: x_data__h21569 = wmemiRdReq;
      20'h00040: x_data__h21569 = wmemiRdResp;
      20'h00044: x_data__h21569 = rdat__h21822;
      20'h00048: x_data__h21569 = rdat__h21830;
      20'h0004C: x_data__h21569 = rdat__h21838;
      20'h00050: x_data__h21569 = rdat__h21846;
      default: x_data__h21569 = 32'd0;
    endcase
  end
  always@(rdSerPos or
  ...
  begin
    case (rdSerPos)
      2'd0: sendData__h23174 = wide16Fb$D_OUT[31:0];
      2'd1: sendData__h23174 = rdSerStage_1;
      2'd2: sendData__h23174 = rdSerStage_2;
      2'd3: sendData__h23174 = rdSerStage_3;
    endcase
  end
  ...
  begin
    ...
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wmwt_doAbort)
	$display("[%0d]: %m: wmwt_doAbort", v__h17682);
    if (wciS0_MReset_n)
