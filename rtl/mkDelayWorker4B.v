...
//
// On Thu Jul  8 12:39:09 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker4B(wciS0_Clk,
  ...
  wire [31 : 0] mesgWF_wDataIn$wget,
		...
		wci_Es_mData_w$wget,
		wsi_Es_mData_w$wget;
  wire [23 : 0] dlyWordsStored_acc_v1$wget, dlyWordsStored_acc_v2$wget;
  ...
  wire [4 : 0] dlyReadyToWrite_acc_v1$wget, dlyReadyToWrite_acc_v2$wget;
  ...
  reg [4 : 0] dlyReadyToWrite_value;
  wire [4 : 0] dlyReadyToWrite_value$D_IN;
  ...
  reg [23 : 0] dlyWordsStored_value;
  wire [23 : 0] dlyWordsStored_value$D_IN;
  ...
  wire [23 : 0] MUX_dlyWordsStored_value$write_1__VAL_2;
  ...
  wire [7 : 0] MUX_dlyReadCredit_value$write_1__VAL_2,
	       MUX_dlyWriteFlush$write_1__VAL_1;
  wire [4 : 0] MUX_dlyReadyToWrite_value$write_1__VAL_2;
  ...
  wire MUX_dlyWriteFlush$write_1__SEL_1,
  ...
  reg [63 : 0] v__h17336,
	       ...
	       v__h2820,
	       v__h3719;
  reg [31 : 0] x1__h23620, x_data__h21929;
  reg CASE_wrtSerPos_0b1_0_1_1_1_2_1_3_0b1__q2,
      CASE_wrtSerPos_NOT_wrtSerPos_EQ_3_OR_wide16Fa_ETC__q1;
  wire [127 : 0] IF_wrtSerPos_39_EQ_2_42_THEN_0x0_ELSE_mesgWF_w_ETC___d382,
		 IF_wrtSerPos_39_EQ_2_42_THEN_0x0_ELSE_metaWF_f_ETC___d407,
		 x1__h19661,
		 x1__h19692,
		 x1__h20357,
		 x1__h20384;
  wire [35 : 0] addr__h20959, addr__h21227;
  wire [31 : 0] data__h19240,
		rdat__h21956,
		rdat__h21962,
		rdat__h21969,
		rdat__h21975,
		...
		rdat__h22213,
		x__h15147;
  wire [26 : 0] x__h21017, x__h21272;
  wire [23 : 0] x1_length__h17029, x__h21979;
  wire [13 : 0] mlp1__h17699, x__h17073;
  wire [12 : 0] x__h15039;
  wire [11 : 0] x_burstLength__h22643;
  wire [7 : 0] x1_opcode__h17028;
  wire [3 : 0] x_byteEn__h22644;
  wire [1 : 0] wrtSerPos_39_PLUS_1___d996;
  wire IF_wrtSerPos_39_EQ_0_40_OR_wrtSerPos_39_EQ_1_4_ETC___d359,
       NOT_dlyWordsStored_value_27_SLE_0_80_81_AND_NO_ETC___d288,
       NOT_wmemi_reqF_c_r_73_EQ_2_74_75_AND_NOT_wmemi_ETC___d313,
       NOT_wrtSerPos_39_EQ_3_46_47_AND_NOT_metaWF_fir_ETC___d394,
       NOT_wsiS_reqFifo_countReg_07_ULE_1_08___d709,
       _dor1bytesWritten$EN_write,
       mesgRF_RDY_enq__12_AND_NOT_rdSerEmpty_13_14_AN_ETC___d225,
       metaRF_RDY_enq__57_AND_NOT_rdSerEmpty_13_14_AN_ETC___d258,
       wci_cState_9_EQ_2_0_AND_dlyCtrl_5_BITS_3_TO_0__ETC___d323,
       wci_cState_9_EQ_2_0_AND_dlyCtrl_5_BITS_3_TO_0__ETC___d427;
  ...
  assign CAN_FIRE_RL_delay_writeFlush =
	     ...
	     !dlyWriteJustFired ;
  assign WILL_FIRE_RL_delay_writeFlush =
	     CAN_FIRE_RL_delay_writeFlush && !WILL_FIRE_RL_delay_write_req ;
  ...
  assign CAN_FIRE_RL_wrtSer_body =
	     ...
	     IF_wrtSerPos_39_EQ_0_40_OR_wrtSerPos_39_EQ_1_4_ETC___d359 &&
	     wci_cState == 3'd2 &&
	     dlyCtrl[3:0] == 4'h7 &&
	     wrtSerUnroll != 16'd0 ;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, x_data__h21929 } ;
  ...
  assign MUX_dlyWriteFlush$write_1__SEL_1 =
  ...
  assign MUX_dlyWordsStored_value$write_1__VAL_2 =
	     ...
	     (CAN_FIRE_RL_delay_write_req ? 24'd1 : 24'd0) +
	     (WILL_FIRE_RL_delay_read_req ? 24'd16777215 : 24'd0) ;
  assign MUX_dlyWriteFlush$write_1__VAL_1 = dlyWriteFlush + 8'd1 ;
  assign MUX_mesgLength$write_1__VAL_3 = { 1'd1, mlp1__h17699[11:0], 2'd0 } ;
  ...
  assign MUX_metaWF$enq_1__VAL_2 = { x1_opcode__h17028, x1_length__h17029 } ;
  ...
  assign MUX_rdSyncWord$write_1__VAL_2 =
	     rdSerPos != 2'd3 && x1__h23620[23:0] == 24'd0 ;
  ...
  always@(wrtSerPos or
	  IF_wrtSerPos_39_EQ_2_42_THEN_0x0_ELSE_metaWF_f_ETC___d407 or
	  x1__h20357 or x1__h20384)
  begin
    case (wrtSerPos)
      2'd0: MUX_wide16Fa$enq_1__VAL_1 = x1__h20357;
      2'd1: MUX_wide16Fa$enq_1__VAL_1 = x1__h20384;
  ...
  always@(wrtSerPos or
	  IF_wrtSerPos_39_EQ_2_42_THEN_0x0_ELSE_mesgWF_w_ETC___d382 or
	  x1__h19661 or x1__h19692)
  begin
    case (wrtSerPos)
      2'd0: MUX_wide16Fa$enq_1__VAL_2 = x1__h19661;
      2'd1: MUX_wide16Fa$enq_1__VAL_2 = x1__h19692;
      default: MUX_wide16Fa$enq_1__VAL_2 =
		   IF_wrtSerPos_39_EQ_2_42_THEN_0x0_ELSE_mesgWF_w_ETC___d382;
    endcase
  end
  ...
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_1 = { 4'd5, addr__h20959, 12'd1 } ;
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_2 = { 4'd3, addr__h21227, 12'd1 } ;
  ...
  assign MUX_dlyReadyToWrite_value$write_1__VAL_2 =
	     ...
	     (dlyReadyToWrite_acc_v1$whas ? 5'd1 : 5'd0) +
	     (CAN_FIRE_RL_delay_write_req ? 5'd31 : 5'd0) ;
  ...
  assign mesgWF_wDataIn$whas =
	     WILL_FIRE_RL_wmwt_messagePushPrecise ||
	     WILL_FIRE_RL_wmwt_messagePushImprecise ;
  assign mesgWF_pwDequeue$whas = CAN_FIRE_RL_wrtSer_body ;
  assign mesgWF_pwEnqueue$whas = mesgWF_wDataIn$whas ;
  assign mesgWF_wDataOut$wget = data__h19240 ;
  assign dlyWordsStored_acc_v1$wget = 24'd1 ;
  assign mesgWF_wDataOut$whas = 1'd1 ;
  assign dlyWordsStored_acc_v1$whas = CAN_FIRE_RL_delay_write_req ;
  assign dlyWordsStored_acc_v2$wget = 24'd16777215 ;
  ...
  assign dlyReadJustFired_1$whas = WILL_FIRE_RL_delay_read_req ;
  ...
  // register dlyReadJustFired
  assign dlyReadJustFired$D_IN = WILL_FIRE_RL_delay_read_req ;
  ...
  assign dlyWriteFlush$D_IN =
	     MUX_dlyWriteFlush$write_1__SEL_1 ?
	       MUX_dlyWriteFlush$write_1__VAL_1 :
	       8'd0 ;
  ...
  assign mesgLengthSoFar$D_IN =
	     MUX_impreciseBurst$write_1__SEL_2 ? 14'd0 : mlp1__h17699 ;
  ...
  // register mesgWF_rCache
  assign mesgWF_rCache$D_IN = { 1'd1, mesgWF_rWrPtr, x__h15147 } ;
  assign mesgWF_rCache$EN = mesgWF_wDataIn$whas ;

  // register mesgWF_rRdPtr
  assign mesgWF_rRdPtr$D_IN = x__h15039 ;
  assign mesgWF_rRdPtr$EN = CAN_FIRE_RL_wrtSer_body ;

  // register mesgWF_rWrPtr
  assign mesgWF_rWrPtr$D_IN = mesgWF_rWrPtr + 13'd1 ;
  assign mesgWF_rWrPtr$EN = mesgWF_wDataIn$whas ;
  ...
  // register rdSerMeta
  assign rdSerMeta$D_IN = x1__h23620 ;
  ...
  assign wrtSerStage$D_IN =
	     MUX_wrtSerStage$write_1__SEL_1 ? data__h19240 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_1$D_IN =
	     MUX_wrtSerStage_1$write_1__SEL_1 ? data__h19240 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_2$D_IN =
	     MUX_wrtSerStage_2$write_1__SEL_1 ? data__h19240 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_3$D_IN =
	     MUX_wrtSerStage_3$write_1__SEL_1 ? data__h19240 : metaWF$D_OUT ;
  ...
  // remaining internal signals
  assign IF_wrtSerPos_39_EQ_0_40_OR_wrtSerPos_39_EQ_1_4_ETC___d359 =
	     CASE_wrtSerPos_0b1_0_1_1_1_2_1_3_0b1__q2 &&
	     (wrtSerPos != 2'd3 && wrtSerUnroll != 16'd1 ||
	      CASE_wrtSerPos_NOT_wrtSerPos_EQ_3_OR_wide16Fa_ETC__q1) ;
  assign IF_wrtSerPos_39_EQ_2_42_THEN_0x0_ELSE_mesgWF_w_ETC___d382 =
	     { (wrtSerPos == 2'd2) ? 32'h0 : data__h19240,
	       (wrtSerPos == 2'd2) ? data__h19240 : wrtSerStage_2,
	       wrtSerStage_1,
	       wrtSerStage } ;
  assign IF_wrtSerPos_39_EQ_2_42_THEN_0x0_ELSE_metaWF_f_ETC___d407 =
	     { (wrtSerPos == 2'd2) ? 32'h0 : metaWF$D_OUT,
	       (wrtSerPos == 2'd2) ? metaWF$D_OUT : wrtSerStage_2,
	       wrtSerStage_1,
	       wrtSerStage } ;
  assign NOT_dlyWordsStored_value_27_SLE_0_80_81_AND_NO_ETC___d288 =
	     (dlyWordsStored_value ^ 24'h800000) > 24'd8388608 &&
	     bytesWritten >= dlyHoldoffBytes &&
	     cyclesPassed >= dlyHoldoffCycles ;
  assign NOT_wmemi_reqF_c_r_73_EQ_2_74_75_AND_NOT_wmemi_ETC___d313 =
	     wmemi_reqF_c_r != 2'd2 && wmemi_dhF_c_r != 2'd2 &&
	     wmemi_operateD &&
	     wmemi_peerIsReady ;
  assign NOT_wrtSerPos_39_EQ_3_46_47_AND_NOT_metaWF_fir_ETC___d394 =
	     wrtSerPos != 2'd3 && metaWF$D_OUT[23:0] != 24'd0 ||
	     CASE_wrtSerPos_NOT_wrtSerPos_EQ_3_OR_wide16Fa_ETC__q1 ;
  assign NOT_wsiS_reqFifo_countReg_07_ULE_1_08___d709 =
	     wsiS_reqFifo_countReg > 2'd1 ;
  assign _dor1bytesWritten$EN_write =
	     WILL_FIRE_RL_wmwt_messagePushPrecise ||
	     WILL_FIRE_RL_wmwt_messagePushImprecise ;
  assign addr__h20959 = { 9'd0, x__h21017 } ;
  assign addr__h21227 = { 9'd0, x__h21272 } ;
  assign data__h19240 =
	     (mesgWF_rCache[45] && mesgWF_rCache[44:32] == mesgWF_rRdPtr) ?
	       mesgWF_rCache[31:0] :
	       mesgWF_memory$DOB ;
  assign mesgRF_RDY_enq__12_AND_NOT_rdSerEmpty_13_14_AN_ETC___d225 =
	     mesgRF$FULL_N &&
	     (!rdSerEmpty && rdSerPos != 2'd0 || wide16Fb$EMPTY_N) ;
  assign metaRF_RDY_enq__57_AND_NOT_rdSerEmpty_13_14_AN_ETC___d258 =
	     metaRF$FULL_N &&
	     (!rdSerEmpty && rdSerPos != 2'd0 || wide16Fb$EMPTY_N) ;
  assign mlp1__h17699 = mesgLengthSoFar + 14'd1 ;
  assign rdat__h21956 = hasDebugLogic ? mesgWtCount : 32'd0 ;
  assign rdat__h21962 = hasDebugLogic ? mesgRdCount : 32'd0 ;
  assign rdat__h21969 = hasDebugLogic ? bytesWritten : 32'd0 ;
  assign rdat__h21975 = hasDebugLogic ? { 8'd0, x__h21979 } : 32'd0 ;
  assign rdat__h22099 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h22113 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h22121 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h22127 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h22141 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h22149 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h22155 = hasDebugLogic ? wmemiWrReq : 32'd0 ;
  assign rdat__h22161 = hasDebugLogic ? wmemiRdReq : 32'd0 ;
  assign rdat__h22167 = hasDebugLogic ? wmemiRdResp : 32'd0 ;
  assign rdat__h22173 =
	     hasDebugLogic ? { 8'd0, dlyWordsStored_value } : 32'd0 ;
  assign rdat__h22183 =
	     hasDebugLogic ? { 24'd0, dlyReadCredit_value } : 32'd0 ;
  assign rdat__h22193 = hasDebugLogic ? { 9'd0, dlyWAG } : 32'd0 ;
  assign rdat__h22203 = hasDebugLogic ? { 9'd0, dlyRAG } : 32'd0 ;
  assign rdat__h22213 = { {24{dlyMaxReadCredit[7]}}, dlyMaxReadCredit } ;
  assign wci_cState_9_EQ_2_0_AND_dlyCtrl_5_BITS_3_TO_0__ETC___d323 =
	     wci_cState == 3'd2 && dlyCtrl[3:0] == 4'h7 &&
	     ((dlyWriteJustFired || dlyWriteFlush == 8'd255) ?
		(dlyReadyToWrite_value ^ 5'h10) > 5'd16 :
		(dlyReadyToWrite_value ^ 5'h10) > 5'd19) ;
  assign wci_cState_9_EQ_2_0_AND_dlyCtrl_5_BITS_3_TO_0__ETC___d427 =
	     wci_cState == 3'd2 && dlyCtrl[3:0] == 4'h7 && mesgLength[14] &&
	     !doAbort &&
	     (preciseBurst && wsiWordsRemain == 12'd0 ||
	      impreciseBurst && endOfMessage) ;
  assign wrtSerPos_39_PLUS_1___d996 = wrtSerPos + 2'd1 ;
  assign x1__h19661 = { 96'd0, data__h19240 } ;
  assign x1__h19692 = { 64'd0, data__h19240, wrtSerStage } ;
  assign x1__h20357 = { 96'd0, metaWF$D_OUT } ;
  assign x1__h20384 = { 64'd0, metaWF$D_OUT, wrtSerStage } ;
  assign x1_length__h17029 = { 10'd0, x__h17073 } ;
  assign x1_opcode__h17028 = opcode[8] ? opcode[7:0] : 8'd0 ;
  assign x__h15039 = mesgWF_rRdPtr + 13'd1 ;
  assign x__h15147 = mesgWF_wDataIn$whas ? wsiS_reqFifo$D_OUT[43:12] : 32'd0 ;
  assign x__h17073 = mesgLength[14] ? mesgLength[13:0] : 14'd0 ;
  assign x__h21017 = { dlyRAG, 4'h0 } ;
  assign x__h21272 = { dlyWAG, 4'h0 } ;
  assign x__h21979 = { wmemi_statusR, wsiS_statusR, wsiM_statusR } ;
  assign x_burstLength__h22643 =
	     (readMeta[23:0] == 24'd0) ? 12'd1 : readMeta[13:2] ;
  assign x_byteEn__h22644 = (readMeta[23:0] == 24'd0) ? 4'd0 : 4'd15 ;
  always@(wci_reqF$D_OUT or
	  ...
	  rdat__h22167 or
	  rdat__h22173 or
	  rdat__h22183 or rdat__h22193 or rdat__h22203 or rdat__h22213)
  begin
    case (wci_reqF$D_OUT[51:32])
      20'h0: x_data__h21929 = dlyCtrl;
      20'h00004: x_data__h21929 = dlyHoldoffBytes;
      20'h00008: x_data__h21929 = dlyHoldoffCycles;
      20'h0000C: x_data__h21929 = rdat__h21956;
      20'h00010: x_data__h21929 = rdat__h21962;
      20'h00014: x_data__h21929 = rdat__h21969;
      20'h00018: x_data__h21929 = rdat__h21975;
      20'h0001C: x_data__h21929 = 32'd0;
      20'h00020: x_data__h21929 = rdat__h22099;
      20'h00024: x_data__h21929 = rdat__h22113;
      20'h00028: x_data__h21929 = rdat__h22121;
      20'h0002C: x_data__h21929 = rdat__h22127;
      20'h00030: x_data__h21929 = rdat__h22141;
      20'h00034: x_data__h21929 = rdat__h22149;
      20'h00038: x_data__h21929 = rdat__h22155;
      20'h0003C: x_data__h21929 = rdat__h22161;
      20'h00040: x_data__h21929 = rdat__h22167;
      20'h00044: x_data__h21929 = rdat__h22173;
      20'h00048: x_data__h21929 = rdat__h22183;
      20'h0004C: x_data__h21929 = rdat__h22193;
      20'h00050: x_data__h21929 = rdat__h22203;
      20'h00054: x_data__h21929 = rdat__h22213;
      default: x_data__h21929 = 32'd0;
    endcase
  end
  always@(rdSerPos or
  ...
  begin
    case (rdSerPos)
      2'd0: x1__h23620 = wide16Fb$D_OUT[31:0];
      2'd1: x1__h23620 = rdSerStage_1;
      2'd2: x1__h23620 = rdSerStage_2;
      2'd3: x1__h23620 = rdSerStage_3;
    endcase
  end
  ...
  begin
	...
	dlyReadyToWrite_value <= `BSV_ASSIGNMENT_DELAY 5'd0;
	dlyWAG <= `BSV_ASSIGNMENT_DELAY 23'd0;
	dlyWordsStored_value <= `BSV_ASSIGNMENT_DELAY 24'd0;
  ...
  begin
    ...
    dlyReadyToWrite_value = 5'h0A;
    dlyWAG = 23'h2AAAAA;
    dlyWordsStored_value = 24'hAAAAAA;
    dlyWriteFlush = 8'hAA;
  ...
  begin
    ...
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wmwt_doAbort)
	$display("[%0d]: %m: wmwt_doAbort", v__h17552);
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wci_cfwr && WILL_FIRE_RL_wci_ctrl_OrE)
	$display("Error: \"bsv/DelayWorker.bsv\", line 442, column 6: (R0001)\n  Mutually exclusive rules RL_wci_cfwr and RL_wci_ctrl_OrE fired in the same\n  clock cycle.\n");
    if (wciS0_MReset_n)
