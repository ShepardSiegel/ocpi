...
//
// On Tue Jul 13 07:46:10 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker4B(wciS0_Clk,
  ...
  reg [63 : 0] v__h17546,
	       ...
	       v__h2820,
	       v__h3719;
  reg [31 : 0] x1__h23912, x_data__h22178;
  reg CASE_wrtSerPos_0b1_0_1_1_1_2_1_3_0b1__q1,
      CASE_wrtSerPos_NOT_wrtSerPos_EQ_3_OR_wide16Fa_ETC__q2;
  wire [127 : 0] IF_wrtSerPos_43_EQ_2_46_THEN_0x0_ELSE_mesgWF_w_ETC___d386,
		 IF_wrtSerPos_43_EQ_2_46_THEN_0x0_ELSE_metaWF_f_ETC___d411,
		 x1__h19940,
		 x1__h19971,
		 x1__h20636,
		 x1__h20663;
  wire [35 : 0] addr__h21208, addr__h21476;
  wire [31 : 0] data__h19519,
		rdat__h22205,
		rdat__h22211,
		rdat__h22218,
		rdat__h22224,
		...
		rdat__h22471,
		x__h15357;
  wire [26 : 0] x__h21266, x__h21521;
  wire [23 : 0] x1_length__h17239, x__h22228;
  wire [13 : 0] mlp1__h17940, x__h17283;
  wire [12 : 0] x__h15249;
  wire [11 : 0] x_burstLength__h22902;
  wire [7 : 0] x1_opcode__h17238;
  wire [3 : 0] x_byteEn__h22903;
  wire [1 : 0] wrtSerPos_43_PLUS_1___d1017;
  wire IF_wrtSerPos_43_EQ_0_44_OR_wrtSerPos_43_EQ_1_4_ETC___d363,
       NOT_dlyWordsStored_value_27_SLE_0_83_84_AND_NO_ETC___d291,
       NOT_wmemi_reqF_c_r_76_EQ_2_77_78_AND_NOT_wmemi_ETC___d317,
       NOT_wrtSerPos_43_EQ_3_50_51_AND_NOT_metaWF_fir_ETC___d398,
       ...
       wci_cState_9_EQ_2_0_AND_dlyCtrl_5_BITS_3_TO_0__ETC___d327,
       wci_cState_9_EQ_2_0_AND_dlyCtrl_5_BITS_3_TO_0__ETC___d431,
       wsiS_reqFifo_notFull__29_AND_wsiS_burstKind_09_ETC___d745;
  ...
  assign CAN_FIRE_RL_wrtSer_body =
	     ...
	     IF_wrtSerPos_43_EQ_0_44_OR_wrtSerPos_43_EQ_1_4_ETC___d363 &&
	     wci_cState == 3'd2 &&
	     dlyCtrl[3:0] == 4'h7 &&
	     wrtSerUnroll != 16'd0 ;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, x_data__h22178 } ;
  ...
  assign MUX_mesgLength$write_1__VAL_3 = { 1'd1, mlp1__h17940[11:0], 2'd0 } ;
  assign MUX_mesgRdCount$write_1__VAL_1 = mesgRdCount + 32'd1 ;
  assign MUX_mesgWtCount$write_1__VAL_1 = mesgWtCount + 32'd1 ;
  assign MUX_metaWF$enq_1__VAL_1 = { x1_opcode__h17238, x1_length__h17239 } ;
  ...
  assign MUX_rdSyncWord$write_1__VAL_2 =
	     rdSerPos != 2'd3 && x1__h23912[23:0] == 24'd0 ;
  ...
  always@(wrtSerPos or
	  IF_wrtSerPos_43_EQ_2_46_THEN_0x0_ELSE_mesgWF_w_ETC___d386 or
	  x1__h19940 or x1__h19971)
  begin
    case (wrtSerPos)
      2'd0: MUX_wide16Fa$enq_1__VAL_2 = x1__h19940;
      2'd1: MUX_wide16Fa$enq_1__VAL_2 = x1__h19971;
      default: MUX_wide16Fa$enq_1__VAL_2 =
		   IF_wrtSerPos_43_EQ_2_46_THEN_0x0_ELSE_mesgWF_w_ETC___d386;
    endcase
  end
  always@(wrtSerPos or
	  IF_wrtSerPos_43_EQ_2_46_THEN_0x0_ELSE_metaWF_f_ETC___d411 or
	  x1__h20636 or x1__h20663)
  begin
    case (wrtSerPos)
      2'd0: MUX_wide16Fa$enq_1__VAL_1 = x1__h20636;
      2'd1: MUX_wide16Fa$enq_1__VAL_1 = x1__h20663;
  ...
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_1 = { 4'd5, addr__h21208, 12'd1 } ;
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_2 = { 4'd3, addr__h21476, 12'd1 } ;
  ...
  assign mesgWF_wDataOut$wget = data__h19519 ;
  ...
  assign mesgLengthSoFar$D_IN =
	     MUX_impreciseBurst$write_1__SEL_2 ? 14'd0 : mlp1__h17940 ;
  ...
  // register rdSerMeta
  assign rdSerMeta$D_IN = x1__h23912 ;
  ...
  assign wrtSerStage$D_IN =
	     MUX_wrtSerStage$write_1__SEL_1 ? data__h19519 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_1$D_IN =
	     MUX_wrtSerStage_1$write_1__SEL_1 ? data__h19519 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_2$D_IN =
	     MUX_wrtSerStage_2$write_1__SEL_1 ? data__h19519 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_3$D_IN =
	     MUX_wrtSerStage_3$write_1__SEL_1 ? data__h19519 : metaWF$D_OUT ;
  ...
  // remaining internal signals
  assign IF_wrtSerPos_43_EQ_0_44_OR_wrtSerPos_43_EQ_1_4_ETC___d363 =
	     CASE_wrtSerPos_0b1_0_1_1_1_2_1_3_0b1__q1 &&
	     (wrtSerPos != 2'd3 && wrtSerUnroll != 16'd1 ||
	      CASE_wrtSerPos_NOT_wrtSerPos_EQ_3_OR_wide16Fa_ETC__q2) ;
  assign IF_wrtSerPos_43_EQ_2_46_THEN_0x0_ELSE_mesgWF_w_ETC___d386 =
	     { (wrtSerPos == 2'd2) ? 32'h0 : data__h19519,
	       (wrtSerPos == 2'd2) ? data__h19519 : wrtSerStage_2,
	       wrtSerStage_1,
	       wrtSerStage } ;
  assign IF_wrtSerPos_43_EQ_2_46_THEN_0x0_ELSE_metaWF_f_ETC___d411 =
	     { (wrtSerPos == 2'd2) ? 32'h0 : metaWF$D_OUT,
	       (wrtSerPos == 2'd2) ? metaWF$D_OUT : wrtSerStage_2,
	       wrtSerStage_1,
	       wrtSerStage } ;
  assign NOT_dlyWordsStored_value_27_SLE_0_83_84_AND_NO_ETC___d291 =
	     (dlyWordsStored_value ^ 24'h800000) > 24'd8388608 &&
	     bytesWritten >= dlyHoldoffBytes &&
	     cyclesPassed >= dlyHoldoffCycles ;
  assign NOT_wmemi_reqF_c_r_76_EQ_2_77_78_AND_NOT_wmemi_ETC___d317 =
	     wmemi_reqF_c_r != 2'd2 && wmemi_dhF_c_r != 2'd2 &&
	     wmemi_operateD &&
	     wmemi_peerIsReady ;
  assign NOT_wrtSerPos_43_EQ_3_50_51_AND_NOT_metaWF_fir_ETC___d398 =
	     wrtSerPos != 2'd3 && metaWF$D_OUT[23:0] != 24'd0 ||
	     CASE_wrtSerPos_NOT_wrtSerPos_EQ_3_OR_wide16Fa_ETC__q2 ;
  assign _dor1bytesWritten$EN_write =
	     WILL_FIRE_RL_wmwt_messagePushPrecise ||
	     WILL_FIRE_RL_wmwt_messagePushImprecise ;
  assign addr__h21208 = { 9'd0, x__h21266 } ;
  assign addr__h21476 = { 9'd0, x__h21521 } ;
  assign data__h19519 =
  ...
  assign metaRF_RDY_enq__60_AND_NOT_rdSerEmpty_16_17_AN_ETC___d261 =
	     metaRF$FULL_N &&
	     (!rdSerEmpty && rdSerPos != 2'd0 || wide16Fb$EMPTY_N) ;
  assign mlp1__h17940 = mesgLengthSoFar + 14'd1 ;
  assign rdat__h22205 = hasDebugLogic ? mesgWtCount : 32'd0 ;
  assign rdat__h22211 = hasDebugLogic ? mesgRdCount : 32'd0 ;
  assign rdat__h22218 = hasDebugLogic ? bytesWritten : 32'd0 ;
  assign rdat__h22224 = hasDebugLogic ? { 8'd0, x__h22228 } : 32'd0 ;
  assign rdat__h22348 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h22362 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h22370 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h22376 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h22390 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h22398 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h22404 = hasDebugLogic ? wmemiWrReq : 32'd0 ;
  assign rdat__h22410 = hasDebugLogic ? wmemiRdReq : 32'd0 ;
  assign rdat__h22416 = hasDebugLogic ? wmemiRdResp : 32'd0 ;
  assign rdat__h22422 =
	     hasDebugLogic ? { 8'd0, dlyWordsStored_value } : 32'd0 ;
  assign rdat__h22432 =
	     hasDebugLogic ? { 24'd0, dlyReadCredit_value } : 32'd0 ;
  assign rdat__h22442 = hasDebugLogic ? { 9'd0, dlyWAG } : 32'd0 ;
  assign rdat__h22452 = hasDebugLogic ? { 9'd0, dlyRAG } : 32'd0 ;
  assign rdat__h22462 = { {24{dlyMaxReadCredit[7]}}, dlyMaxReadCredit } ;
  assign rdat__h22471 =
	     { {24{dlyReadCredit_value[7]}}, dlyReadCredit_value } ;
  assign wci_cState_9_EQ_2_0_AND_dlyCtrl_5_BITS_3_TO_0__ETC___d327 =
	     wci_cState == 3'd2 && dlyCtrl[3:0] == 4'h7 &&
	     ((dlyWriteJustFired || dlyWriteFlush == 8'd255) ?
		(dlyReadyToWrite_value ^ 5'h10) > 5'd16 :
		(dlyReadyToWrite_value ^ 5'h10) > 5'd19) ;
  assign wci_cState_9_EQ_2_0_AND_dlyCtrl_5_BITS_3_TO_0__ETC___d431 =
	     wci_cState == 3'd2 && dlyCtrl[3:0] == 4'h7 && mesgLength[14] &&
	     !doAbort &&
	     (preciseBurst && wsiWordsRemain == 12'd0 ||
	      impreciseBurst && endOfMessage) ;
  assign wrtSerPos_43_PLUS_1___d1017 = wrtSerPos + 2'd1 ;
  assign wsiS_reqFifo_notFull__29_AND_wsiS_burstKind_09_ETC___d745 =
	     wsiS_reqFifo$FULL_N &&
	     (wsiS_burstKind == 2'd0 ||
	      (wsiS_burstKind == 2'd1 || wsiS_burstKind == 2'd2) &&
	      wsiS_wsiReq$wget[57]) ;
  assign x1__h19940 = { 96'd0, data__h19519 } ;
  assign x1__h19971 = { 64'd0, data__h19519, wrtSerStage } ;
  assign x1__h20636 = { 96'd0, metaWF$D_OUT } ;
  assign x1__h20663 = { 64'd0, metaWF$D_OUT, wrtSerStage } ;
  assign x1_length__h17239 = { 10'd0, x__h17283 } ;
  assign x1_opcode__h17238 = opcode[8] ? opcode[7:0] : 8'd0 ;
  assign x__h15249 = mesgWF_rRdPtr + 13'd1 ;
  assign x__h15357 =
	     mesgWF_pwEnqueue$whas ? wsiS_reqFifo$D_OUT[43:12] : 32'd0 ;
  assign x__h17283 = mesgLength[14] ? mesgLength[13:0] : 14'd0 ;
  assign x__h21266 = { dlyRAG, 4'h0 } ;
  assign x__h21521 = { dlyWAG, 4'h0 } ;
  assign x__h22228 = { wmemi_statusR, wsiS_statusR, wsiM_statusR } ;
  assign x_burstLength__h22902 =
	     (readMeta[23:0] == 24'd0) ? 12'd1 : readMeta[13:2] ;
  assign x_byteEn__h22903 = (readMeta[23:0] == 24'd0) ? 4'd0 : 4'd15 ;
  always@(wci_reqF$D_OUT or
	  ...
	  rdat__h22422 or
	  rdat__h22432 or
	  rdat__h22442 or rdat__h22452 or rdat__h22462 or rdat__h22471)
  begin
    case (wci_reqF$D_OUT[51:32])
      20'h0: x_data__h22178 = dlyCtrl;
      20'h00004: x_data__h22178 = dlyHoldoffBytes;
      20'h00008: x_data__h22178 = dlyHoldoffCycles;
      20'h0000C: x_data__h22178 = rdat__h22205;
      20'h00010: x_data__h22178 = rdat__h22211;
      20'h00014: x_data__h22178 = rdat__h22218;
      20'h00018: x_data__h22178 = rdat__h22224;
      20'h0001C: x_data__h22178 = 32'd0;
      20'h00020: x_data__h22178 = rdat__h22348;
      20'h00024: x_data__h22178 = rdat__h22362;
      20'h00028: x_data__h22178 = rdat__h22370;
      20'h0002C: x_data__h22178 = rdat__h22376;
      20'h00030: x_data__h22178 = rdat__h22390;
      20'h00034: x_data__h22178 = rdat__h22398;
      20'h00038: x_data__h22178 = rdat__h22404;
      20'h0003C: x_data__h22178 = rdat__h22410;
      20'h00040: x_data__h22178 = rdat__h22416;
      20'h00044: x_data__h22178 = rdat__h22422;
      20'h00048: x_data__h22178 = rdat__h22432;
      20'h0004C: x_data__h22178 = rdat__h22442;
      20'h00050: x_data__h22178 = rdat__h22452;
      20'h00054: x_data__h22178 = rdat__h22462;
      20'h00058: x_data__h22178 = rdat__h22471;
      default: x_data__h22178 = 32'd0;
    endcase
  end
  always@(rdSerPos or
  ...
  begin
    case (rdSerPos)
      2'd0: x1__h23912 = wide16Fb$D_OUT[31:0];
      2'd1: x1__h23912 = rdSerStage_1;
      2'd2: x1__h23912 = rdSerStage_2;
      2'd3: x1__h23912 = rdSerStage_3;
    endcase
  end
  always@(wrtSerPos)
  begin
  ...
  begin
    ...
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wmwt_doAbort)
	$display("[%0d]: %m: wmwt_doAbort", v__h17762);
    if (wciS0_MReset_n)
