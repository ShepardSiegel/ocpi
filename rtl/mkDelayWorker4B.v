...
//
// On Fri Jun  4 10:55:26 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker4B(wciS0_Clk,
  ...
  wire [127 : 0] MUX_wide16Fa$enq_1__VAL_1, MUX_wide16Fa$enq_1__VAL_2;
  ...
  reg [63 : 0] v__h17359,
	       ...
	       v__h2812,
	       v__h3711;
  reg [31 : 0] sendData__h22657, x_data__h21171;
  reg CASE_wrtSerPos_0b1_0_1_1_1_2_1_3_0b1__q1;
  wire [35 : 0] addr__h20431, addr__h20588;
  wire [31 : 0] data__h19361,
		mesg__h21698,
		rdat__h21215,
		rdat__h21424,
		rdat__h21432,
		...
		x__h15021,
		x__h15947;
  wire [23 : 0] x1_length__h17052, x__h20489, x__h20633, x__h21218;
  wire [13 : 0] mlp1__h17751, x__h17096;
  wire [11 : 0] x_burstLength__h21789;
  wire [10 : 0] x__h14913, x__h15839;
  wire [7 : 0] x1_opcode__h17051;
  wire [3 : 0] x_byteEn__h21790;
  wire NOT_mesgRF_rRdPtr_48_PLUS_512_91_EQ_mesgRF_rWr_ETC___d206,
       NOT_wmemi_reqF_c_r_40_EQ_2_41_42_AND_NOT_wmemi_ETC___d262,
       NOT_wsiS_reqFifo_countReg_27_ULE_1_28___d629,
       ...
       _dor1wide16Fb$EN_deq,
       metaRF_RDY_enq__28_AND_NOT_rdSerEmpty_94_95_AN_ETC___d229,
       wci_cState_9_EQ_2_0_AND_dlyCtrl_4_BITS_3_TO_0__ETC___d184,
       wci_cState_9_EQ_2_0_AND_dlyCtrl_4_BITS_3_TO_0__ETC___d333;
  ...
  assign CAN_FIRE_RL_rdSer_body =
	     NOT_mesgRF_rRdPtr_48_PLUS_512_91_EQ_mesgRF_rWr_ETC___d206 &&
	     wci_cState == 3'd2 &&
	     dlyCtrl[3:0] == 4'h7 &&
	     rdSerUnroll != 16'd0 ;
  ...
  assign CAN_FIRE_RL_wrtSer_begin =
	     metaWF$EMPTY_N && (wrtSerPos != 2'd3 || wide16Fa$FULL_N) &&
	     wci_cState == 3'd2 &&
	     dlyCtrl[3:0] == 4'h7 &&
	     wrtSerUnroll == 16'd0 ;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, x_data__h21171 } ;
  ...
  assign MUX_wci_respF_q_1$write_1__VAL_1 =
	     (wci_respF_c_r == 2'd2) ?
	       MUX_wci_respF_q_0$write_1__VAL_2 :
	       34'h0AAAAAAAA ;
  assign MUX_mesgLength$write_1__VAL_3 = { 1'd1, mlp1__h17751[11:0], 2'd0 } ;
  ...
  assign MUX_metaWF$enq_1__VAL_1 = { x1_opcode__h17051, x1_length__h17052 } ;
  ...
  assign MUX_wide16Fa$enq_1__VAL_2 =
	     { metaWF$D_OUT, wrtSerStage_2, wrtSerStage_1, wrtSerStage } ;
  assign MUX_wide16Fa$enq_1__VAL_1 =
	     { data__h19361, wrtSerStage_2, wrtSerStage_1, wrtSerStage } ;
  ...
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_1 = { 4'd5, addr__h20431, 12'd1 } ;
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_2 = { 4'd3, addr__h20588, 12'd1 } ;
  ...
  assign mesgWF_wDataOut$wget = data__h19361 ;
  ...
  assign mesgRF_wDataIn$wget = sendData__h22657 ;
  assign mesgRF_wDataIn$whas = CAN_FIRE_RL_rdSer_body ;
  assign mesgRF_wDataOut$wget = mesg__h21698 ;
  ...
  // register mesgRF_rCache
  assign mesgRF_rCache$D_IN = { 1'd1, mesgRF_rWrPtr, x__h15947 } ;
  assign mesgRF_rCache$EN = CAN_FIRE_RL_rdSer_body ;

  // register mesgRF_rRdPtr
  assign mesgRF_rRdPtr$D_IN = x__h15839 ;
  ...
  // register mesgWF_rCache
  assign mesgWF_rCache$D_IN = { 1'd1, mesgWF_rWrPtr, x__h15021 } ;
  assign mesgWF_rCache$EN = mesgWF_pwEnqueue$whas ;

  // register mesgWF_rRdPtr
  assign mesgWF_rRdPtr$D_IN = x__h14913 ;
  ...
  // register rdSerMeta
  assign rdSerMeta$D_IN = sendData__h22657 ;
  ...
  assign wrtSerStage$D_IN =
	     MUX_wrtSerStage$write_1__SEL_1 ? data__h19361 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_1$D_IN =
	     MUX_wrtSerStage_1$write_1__SEL_1 ? data__h19361 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_2$D_IN =
	     MUX_wrtSerStage_2$write_1__SEL_1 ? data__h19361 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_3$D_IN =
	     MUX_wide16Fa$enq_1__SEL_1 ? data__h19361 : metaWF$D_OUT ;
  ...
  assign mesgRF_memory$DIA = x__h15947 ;
  ...
  assign wide16Fb$DEQ =
	     _dor1wide16Fb$EN_deq && (rdSerEmpty || rdSerPos == 2'd0) ;
  ...
  // remaining internal signals
  assign NOT_mesgRF_rRdPtr_48_PLUS_512_91_EQ_mesgRF_rWr_ETC___d206 =
	     mesgRF_rRdPtr + 11'd512 != mesgRF_rWrPtr &&
	     (!rdSerEmpty && rdSerPos != 2'd0 || wide16Fb$EMPTY_N) ;
  assign NOT_wmemi_reqF_c_r_40_EQ_2_41_42_AND_NOT_wmemi_ETC___d262 =
	     wmemi_reqF_c_r != 2'd2 && wmemi_dhF_c_r != 2'd2 &&
	     wmemi_operateD &&
	     wmemi_peerIsReady ;
  assign NOT_wsiS_reqFifo_countReg_27_ULE_1_28___d629 =
	     wsiS_reqFifo_countReg > 2'd1 ;
  ...
  assign _dor1rdSerStage_3$EN_write =
	     WILL_FIRE_RL_rdSer_begin || WILL_FIRE_RL_rdSer_body ;
  assign _dor1wide16Fb$EN_deq =
	     WILL_FIRE_RL_rdSer_begin || WILL_FIRE_RL_rdSer_body ;
  assign addr__h20431 = { 12'd0, x__h20489 } ;
  assign addr__h20588 = { 12'd0, x__h20633 } ;
  assign data__h19361 =
  ...
  assign mesg__h21698 =
	     (mesgRF_rCache[43] && mesgRF_rCache[42:32] == mesgRF_rRdPtr) ?
	       mesgRF_rCache[31:0] :
	       mesgRF_memory$DOB ;
  assign metaRF_RDY_enq__28_AND_NOT_rdSerEmpty_94_95_AN_ETC___d229 =
	     metaRF$FULL_N &&
	     (!rdSerEmpty && rdSerPos != 2'd0 || wide16Fb$EMPTY_N) ;
  assign mlp1__h17751 = MUX_mesgLengthSoFar$write_1__VAL_2 ;
  assign rdat__h21215 = { 8'd0, x__h21218 } ;
  assign rdat__h21424 = { 12'd0, dlyWordsStored_value } ;
  assign rdat__h21432 = { 24'd0, dlyReadCredit_value } ;
  assign rdat__h21440 = { 12'd0, dlyWAG } ;
  assign rdat__h21448 = { 12'd0, dlyRAG } ;
  assign wci_cState_9_EQ_2_0_AND_dlyCtrl_4_BITS_3_TO_0__ETC___d184 =
	     wci_cState == 3'd2 && dlyCtrl[3:0] == 4'h7 &&
	     unrollCnt == 16'd0 &&
	     bytesWritten > dlyHoldoff ;
  assign wci_cState_9_EQ_2_0_AND_dlyCtrl_4_BITS_3_TO_0__ETC___d333 =
	     wci_cState == 3'd2 && dlyCtrl[3:0] == 4'h7 && mesgLength[14] &&
	     !doAbort &&
	     (preciseBurst && wsiWordsRemain == 12'd0 ||
	      impreciseBurst && endOfMessage) ;
  assign x1_length__h17052 = { 10'd0, x__h17096 } ;
  assign x1_opcode__h17051 = opcode[8] ? opcode[7:0] : 8'd0 ;
  assign x__h14913 = mesgWF_rRdPtr + 11'd1 ;
  assign x__h15021 =
	     mesgWF_pwEnqueue$whas ? wsiS_reqFifo$D_OUT[43:12] : 32'd0 ;
  assign x__h15839 = mesgRF_rRdPtr + 11'd1 ;
  assign x__h15947 = CAN_FIRE_RL_rdSer_body ? sendData__h22657 : 32'd0 ;
  assign x__h17096 = mesgLength[14] ? mesgLength[13:0] : 14'd0 ;
  assign x__h20489 = { dlyRAG, 4'h0 } ;
  assign x__h20633 = { dlyWAG, 4'h0 } ;
  assign x__h21218 = { wmemi_statusR, wsiS_statusR, wsiM_statusR } ;
  assign x_burstLength__h21789 =
	     (readMeta[23:0] == 24'd0) ? 12'd1 : readMeta[13:2] ;
  assign x_byteEn__h21790 = (readMeta[23:0] == 24'd0) ? 4'd0 : 4'd15 ;
  always@(wci_reqF$D_OUT or
	  ...
	  wmemiRdReq or
	  wmemiRdResp or
	  rdat__h21424 or rdat__h21432 or rdat__h21440 or rdat__h21448)
  begin
    case (wci_reqF$D_OUT[51:32])
      20'h0: x_data__h21171 = dlyCtrl;
      20'h00004: x_data__h21171 = dlyHoldoff;
      20'h00008: x_data__h21171 = mesgWtCount;
      20'h0000C: x_data__h21171 = mesgRdCount;
      20'h00010, 20'h00014: x_data__h21171 = 32'd0;
      20'h00018: x_data__h21171 = rdat__h21215;
      20'h00020: x_data__h21171 = wsiS_extStatusW$wget[95:64];
      20'h00024: x_data__h21171 = wsiS_extStatusW$wget[63:32];
      20'h00028: x_data__h21171 = wsiS_extStatusW$wget[31:0];
      20'h0002C: x_data__h21171 = wsiM_extStatusW$wget[95:64];
      20'h00030: x_data__h21171 = wsiM_extStatusW$wget[63:32];
      20'h00034: x_data__h21171 = wsiM_extStatusW$wget[31:0];
      20'h00038: x_data__h21171 = wmemiWrReq;
      20'h0003C: x_data__h21171 = wmemiRdReq;
      20'h00040: x_data__h21171 = wmemiRdResp;
      20'h00044: x_data__h21171 = rdat__h21424;
      20'h00048: x_data__h21171 = rdat__h21432;
      20'h0004C: x_data__h21171 = rdat__h21440;
      20'h00050: x_data__h21171 = rdat__h21448;
      default: x_data__h21171 = 32'd0;
    endcase
  end
  always@(rdSerPos or
  ...
  begin
    case (rdSerPos)
      2'd0: sendData__h22657 = wide16Fb$D_OUT[31:0];
      2'd1: sendData__h22657 = rdSerStage_1;
      2'd2: sendData__h22657 = rdSerStage_2;
      2'd3: sendData__h22657 = rdSerStage_3;
    endcase
  end
  always@(wrtSerPos)
  begin
  ...
  begin
    ...
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wmwt_doAbort)
	$display("[%0d]: %m: wmwt_doAbort", v__h17604);
    if (wciS0_MReset_n)
