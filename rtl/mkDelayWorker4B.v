...
//
// On Tue Jul 27 12:20:27 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker4B(wciS0_Clk,
  ...
  wire [13 : 0] mesgLengthSoFar_05_PLUS_1___d958;
  wire [12 : 0] x__h14965;
  wire [11 : 0] x_burstLength__h19976;
  wire [3 : 0] x_byteEn__h19977;
  wire [1 : 0] wrtSerPos_79_PLUS_1___d957;
  ...
  assign MUX_wrtSerPos$write_1__VAL_1 =
	     (wrtSerUnroll == 16'd1) ? 2'd0 : wrtSerPos_79_PLUS_1___d957 ;
  assign MUX_wrtSerPos$write_1__VAL_2 =
	     (metaWF$D_OUT[23:0] == 24'd0) ?
	       2'd0 :
	       wrtSerPos_79_PLUS_1___d957 ;
  ...
  assign mesgLengthSoFar$D_IN =
	     wsiS_reqFifo$D_OUT[57] ?
	       14'd0 :
	       mesgLengthSoFar_05_PLUS_1___d958 ;
  ...
  assign btm__h17027 =
		 ...
		 { 8'd0, mesgLengthSoFar_05_PLUS_1___d958 },
	       2'd0 } ;
  ...
  assign mesgLengthSoFar_05_PLUS_1___d958 = mesgLengthSoFar + 14'd1 ;
  ...
  assign wci_cState_9_EQ_2_0_AND_dlyCtrl_4_BITS_3_TO_0__ETC___d351 =
	     ...
	     !bytesWritten_6_ULT_dlyHoldoffBytes_6___d1010 &&
	     !cyclesPassed_54_ULT_dlyHoldoffCycles_8___d1008 ;
  assign wrtSerPos_79_PLUS_1___d957 = wrtSerPos + 2'd1 ;
