...
//
// On Thu Jun 17 14:44:23 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker4B(wciS0_Clk,
  ...
  reg [44 : 0] mesgWF_rCache;
  wire [44 : 0] mesgWF_rCache$D_IN;
  wire mesgWF_rCache$EN;

  // register mesgWF_rRdPtr
  reg [11 : 0] mesgWF_rRdPtr;
  wire [11 : 0] mesgWF_rRdPtr$D_IN;
  wire mesgWF_rRdPtr$EN;

  // register mesgWF_rWrPtr
  reg [11 : 0] mesgWF_rWrPtr;
  wire [11 : 0] mesgWF_rWrPtr$D_IN;
  ...
  wire [10 : 0] mesgWF_memory$ADDRA, mesgWF_memory$ADDRB;
  ...
  reg [63 : 0] v__h17565,
	       ...
	       v__h2817,
	       v__h3716;
  reg [31 : 0] sendData__h23420, x_data__h21807;
  reg CASE_wrtSerPos_0b1_0_1_1_1_2_1_3_0b1__q1,
      IF_wrtSerPos_10_EQ_0_11_OR_wrtSerPos_10_EQ_1_1_ETC___d894;
  wire [127 : 0] IF_wrtSerPos_10_EQ_2_13_THEN_0x0_ELSE_mesgWF_w_ETC___d352,
		 ...
		 x1__h20495,
		 x1__h20504;
  wire [35 : 0] addr__h20997, addr__h21169;
  wire [31 : 0] data__h19626,
		mesg__h22349,
		rdat__h21850,
		rdat__h22033,
		rdat__h22041,
		...
		x__h15237,
		x__h16164;
  wire [26 : 0] x__h21055, x__h21214;
  wire [23 : 0] x1_length__h17258, x__h21853;
  wire [13 : 0] mlp1__h17957, x__h17302;
  wire [11 : 0] x__h15129, x_burstLength__h22440;
  wire [10 : 0] x__h16056;
  wire [7 : 0] x1_opcode__h17257;
  wire [3 : 0] x_byteEn__h22441;
  wire [1 : 0] wrtSerPos_10_PLUS_1___d983;
  wire NOT_dlyWordsStored_value_13_SLE_0_63_64_AND_NO_ETC___d271,
       NOT_mesgRF_rRdPtr_52_PLUS_512_93_EQ_mesgRF_rWr_ETC___d208,
       NOT_wmemi_reqF_c_r_56_EQ_2_57_58_AND_NOT_wmemi_ETC___d290,
  ...
  BRAM2 #(.PIPELINED(1'd0),
	  .ADDR_WIDTH(32'd11),
	  .DATA_WIDTH(32'd32),
	  .MEMSIZE(12'd2048)) mesgWF_memory(.CLKA(wciS0_Clk),
					    .CLKB(wciS0_Clk),
  ...
  assign CAN_FIRE_RL_wmwt_messagePushPrecise =
	     mesgWF_rRdPtr + 12'd1024 != mesgWF_rWrPtr &&
	     wsiS_reqFifo$EMPTY_N &&
	     wci_cState == 3'd2 &&
	     dlyCtrl[3:0] == 4'h7 &&
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, x_data__h21807 } ;
  ...
  assign MUX_wci_respF_q_1$write_1__VAL_1 =
	     (wci_respF_c_r == 2'd2) ?
	       MUX_wci_respF_q_0$write_1__VAL_2 :
	       34'h0AAAAAAAA ;
  assign MUX_mesgLength$write_1__VAL_3 = { 1'd1, mlp1__h17957[11:0], 2'd0 } ;
  ...
  assign MUX_metaWF$enq_1__VAL_1 = { x1_opcode__h17257, x1_length__h17258 } ;
  ...
  assign MUX_rdSyncWord$write_1__VAL_2 =
	     rdSerPos != 2'd3 && sendData__h23420[23:0] == 24'd0 ;
  ...
  always@(wrtSerPos or
	  ...
	  x1__h20495 or x1__h20504)
  begin
    case (wrtSerPos)
      2'd0: MUX_wide16Fa$enq_1__VAL_1 = x1__h20495;
      2'd1: MUX_wide16Fa$enq_1__VAL_1 = x1__h20504;
  ...
  always@(wrtSerPos or
	  ...
	  x1__h19972 or x1__h19981)
  begin
    case (wrtSerPos)
      2'd0: MUX_wide16Fa$enq_1__VAL_2 = x1__h19972;
      2'd1: MUX_wide16Fa$enq_1__VAL_2 = x1__h19981;
  ...
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_1 = { 4'd5, addr__h20997, 12'd1 } ;
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_2 = { 4'd3, addr__h21169, 12'd1 } ;
  ...
  // register mesgRF_rCache
  assign mesgRF_rCache$D_IN = { 1'd1, mesgRF_rWrPtr, x__h16164 } ;
  assign mesgRF_rCache$EN = CAN_FIRE_RL_rdSer_body ;

  // register mesgRF_rRdPtr
  assign mesgRF_rRdPtr$D_IN = x__h16056 ;
  ...
  // register mesgWF_rCache
  assign mesgWF_rCache$D_IN = { 1'd1, mesgWF_rWrPtr, x__h15237 } ;
  assign mesgWF_rCache$EN = mesgWF_pwEnqueue$whas ;

  // register mesgWF_rRdPtr
  assign mesgWF_rRdPtr$D_IN = x__h15129 ;
  assign mesgWF_rRdPtr$EN = CAN_FIRE_RL_wrtSer_body ;

  // register mesgWF_rWrPtr
  assign mesgWF_rWrPtr$D_IN = mesgWF_rWrPtr + 12'd1 ;
  ...
  // register rdSerMeta
  assign rdSerMeta$D_IN = sendData__h23420 ;
  ...
  assign wrtSerStage$D_IN =
	     MUX_wrtSerStage$write_1__SEL_1 ? data__h19626 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_1$D_IN =
	     MUX_wrtSerStage_1$write_1__SEL_1 ? data__h19626 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_2$D_IN =
	     MUX_wrtSerStage_2$write_1__SEL_1 ? data__h19626 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_3$D_IN =
	     MUX_wrtSerStage_3$write_1__SEL_1 ? data__h19626 : metaWF$D_OUT ;
  ...
  assign mesgRF_memory$DIA = x__h16164 ;
  ...
  assign mesgWF_memory$ADDRA = mesgWF_rWrPtr[10:0] ;
  assign mesgWF_memory$DIA = x__h15237 ;
  assign mesgWF_memory$WEB = 1'd0 ;
  assign mesgWF_memory$ADDRB =
	     CAN_FIRE_RL_wrtSer_body ? x__h15129[10:0] : mesgWF_rRdPtr[10:0] ;
  assign mesgWF_memory$DIB = 32'hAAAAAAAA /* unspecified value */  ;
  assign mesgWF_memory$ENA = 1'd1 ;
  assign mesgWF_memory$ENB = 1'd1 ;

  // submodule metaRF
  assign metaRF$D_IN = sendData__h23420 ;
  ...
  assign IF_wrtSerPos_10_EQ_2_13_THEN_0x0_ELSE_mesgWF_w_ETC___d352 =
	     { (wrtSerPos == 2'd2) ? 32'h0 : data__h19626,
	       (wrtSerPos == 2'd2) ? data__h19626 : wrtSerStage_2,
	       wrtSerStage_1,
	       wrtSerStage } ;
  ...
  assign NOT_wmemi_reqF_c_r_56_EQ_2_57_58_AND_NOT_wmemi_ETC___d290 =
  ...
  assign _dor1bytesWritten$EN_write =
	     WILL_FIRE_RL_wmwt_messagePushPrecise ||
	     WILL_FIRE_RL_wmwt_messagePushImprecise ;
  assign addr__h20997 = { 9'd0, x__h21055 } ;
  assign addr__h21169 = { 9'd0, x__h21214 } ;
  assign data__h19626 =
	     (mesgWF_rCache[44] && mesgWF_rCache[43:32] == mesgWF_rRdPtr) ?
	       mesgWF_rCache[31:0] :
	       mesgWF_memory$DOB ;
  assign mesg__h22349 =
  ...
  assign metaWF_RDY_deq__56_AND_NOT_wrtSerPos_10_EQ_3_1_ETC___d363 =
	     ...
	     (wrtSerPos != 2'd3 && metaWF$D_OUT[23:0] != 24'd0 ||
	      IF_wrtSerPos_10_EQ_0_11_OR_wrtSerPos_10_EQ_1_1_ETC___d894) ;
  assign mlp1__h17957 = MUX_mesgLengthSoFar$write_1__VAL_2 ;
  assign rdat__h21850 = { 8'd0, x__h21853 } ;
  assign rdat__h22033 = { 9'd0, dlyWordsStored_value } ;
  assign rdat__h22041 = { 24'd0, dlyReadCredit_value } ;
  assign rdat__h22049 = { 9'd0, dlyWAG } ;
  assign rdat__h22057 = { 9'd0, dlyRAG } ;
  ...
  assign wrtSerPos_10_PLUS_1___d983 = wrtSerPos + 2'd1 ;
  assign x1__h19972 = { 96'd0, data__h19626 } ;
  assign x1__h19981 = { 64'd0, data__h19626, wrtSerStage } ;
  assign x1__h20495 = { 96'd0, metaWF$D_OUT } ;
  assign x1__h20504 = { 64'd0, metaWF$D_OUT, wrtSerStage } ;
  assign x1_length__h17258 = { 10'd0, x__h17302 } ;
  assign x1_opcode__h17257 = opcode[8] ? opcode[7:0] : 8'd0 ;
  assign x__h15129 = mesgWF_rRdPtr + 12'd1 ;
  assign x__h15237 =
	     mesgWF_pwEnqueue$whas ? wsiS_reqFifo$D_OUT[43:12] : 32'd0 ;
  assign x__h16056 = mesgRF_rRdPtr + 11'd1 ;
  assign x__h16164 = CAN_FIRE_RL_rdSer_body ? sendData__h23420 : 32'd0 ;
  assign x__h17302 = mesgLength[14] ? mesgLength[13:0] : 14'd0 ;
  assign x__h21055 = { dlyRAG, 4'h0 } ;
  assign x__h21214 = { dlyWAG, 4'h0 } ;
  assign x__h21853 = { wmemi_statusR, wsiS_statusR, wsiM_statusR } ;
  assign x_burstLength__h22440 =
	     (readMeta[23:0] == 24'd0) ? 12'd1 : readMeta[13:2] ;
  assign x_byteEn__h22441 = (readMeta[23:0] == 24'd0) ? 4'd0 : 4'd15 ;
  always@(wci_reqF$D_OUT or
	  ...
	  wmemiRdReq or
	  wmemiRdResp or
	  rdat__h22033 or rdat__h22041 or rdat__h22049 or rdat__h22057)
  begin
    case (wci_reqF$D_OUT[51:32])
      20'h0: x_data__h21807 = dlyCtrl;
      20'h00004: x_data__h21807 = dlyHoldoffBytes;
      20'h00008: x_data__h21807 = dlyHoldoffCycles;
      20'h0000C: x_data__h21807 = mesgWtCount;
      20'h00010: x_data__h21807 = mesgRdCount;
      20'h00014: x_data__h21807 = bytesWritten;
      20'h00018: x_data__h21807 = rdat__h21850;
      20'h0001C: x_data__h21807 = 32'd0;
      20'h00020: x_data__h21807 = wsiS_extStatusW$wget[95:64];
      20'h00024: x_data__h21807 = wsiS_extStatusW$wget[63:32];
      20'h00028: x_data__h21807 = wsiS_extStatusW$wget[31:0];
      20'h0002C: x_data__h21807 = wsiM_extStatusW$wget[95:64];
      20'h00030: x_data__h21807 = wsiM_extStatusW$wget[63:32];
      20'h00034: x_data__h21807 = wsiM_extStatusW$wget[31:0];
      20'h00038: x_data__h21807 = wmemiWrReq;
      20'h0003C: x_data__h21807 = wmemiRdReq;
      20'h00040: x_data__h21807 = wmemiRdResp;
      20'h00044: x_data__h21807 = rdat__h22033;
      20'h00048: x_data__h21807 = rdat__h22041;
      20'h0004C: x_data__h21807 = rdat__h22049;
      20'h00050: x_data__h21807 = rdat__h22057;
      default: x_data__h21807 = 32'd0;
    endcase
  end
  always@(rdSerPos or
  ...
  begin
    case (rdSerPos)
      2'd0: sendData__h23420 = wide16Fb$D_OUT[31:0];
      2'd1: sendData__h23420 = rdSerStage_1;
      2'd2: sendData__h23420 = rdSerStage_2;
      2'd3: sendData__h23420 = rdSerStage_3;
    endcase
  end
  ...
  begin
	...
	mesgWF_rCache <= `BSV_ASSIGNMENT_DELAY 45'h0AAAAAAAAAAA;
	mesgWF_rRdPtr <= `BSV_ASSIGNMENT_DELAY 12'd0;
	mesgWF_rWrPtr <= `BSV_ASSIGNMENT_DELAY 12'd0;
  ...
  begin
    ...
    mesgReqValid = 1'h0;
    mesgWF_rCache = 45'h0AAAAAAAAAAA;
    mesgWF_rRdPtr = 12'hAAA;
    mesgWF_rWrPtr = 12'hAAA;
  ...
  begin
    ...
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wmwt_doAbort)
	$display("[%0d]: %m: wmwt_doAbort", v__h17810);
    if (wciS0_MReset_n)
