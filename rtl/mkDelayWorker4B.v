...
//
// On Tue Jul 13 17:08:21 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker4B(wciS0_Clk,
  ...
  reg [63 : 0] v__h17599,
	       ...
	       v__h2820,
	       v__h3719;
  reg [31 : 0] x1__h24060, x_data__h22359;
  reg CASE_wrtSerPos_0b1_0_1_1_1_2_1_3_0b1__q1,
      CASE_wrtSerPos_NOT_wrtSerPos_EQ_3_OR_wide16Fa_ETC__q2;
  wire [127 : 0] IF_wrtSerPos_54_EQ_2_57_THEN_0x0_ELSE_mesgWF_w_ETC___d397,
		 IF_wrtSerPos_54_EQ_2_57_THEN_0x0_ELSE_metaWF_f_ETC___d422,
		 x1__h19993,
		 x1__h20024,
		 x1__h20689,
		 x1__h20716;
  wire [35 : 0] addr__h21366, addr__h21657;
  wire [31 : 0] data__h19572,
		rdat__h22386,
		rdat__h22392,
		rdat__h22399,
		rdat__h22405,
		...
		rdat__h22652,
		x__h15357;
  wire [26 : 0] x__h21424, x__h21702;
  wire [23 : 0] x1_length__h17292, x__h22409;
  wire [13 : 0] mlp1__h17993, x__h17336;
  wire [12 : 0] x__h15249;
  wire [11 : 0] x_burstLength__h23083;
  wire [7 : 0] x1_opcode__h17291;
  wire [3 : 0] x_byteEn__h23084;
  wire [1 : 0] wrtSerPos_54_PLUS_1___d1025;
  wire IF_wrtSerPos_54_EQ_0_55_OR_wrtSerPos_54_EQ_1_5_ETC___d374,
       NOT_dlyWordsStored_value_27_SLE_0_90_91_AND_NO_ETC___d298,
       NOT_wrtSerPos_54_EQ_3_61_62_AND_NOT_metaWF_fir_ETC___d409,
       _dor1bytesWritten$EN_write,
       mesgRF_RDY_enq__15_AND_NOT_rdSerEmpty_16_17_AN_ETC___d228,
       metaRF_RDY_enq__60_AND_NOT_rdSerEmpty_16_17_AN_ETC___d261,
       wci_cState_9_EQ_2_0_AND_dlyCtrl_5_BITS_3_TO_0__ETC___d308,
       wci_cState_9_EQ_2_0_AND_dlyCtrl_5_BITS_3_TO_0__ETC___d336,
       wci_cState_9_EQ_2_0_AND_dlyCtrl_5_BITS_3_TO_0__ETC___d442,
       wsiS_reqFifo_notFull__40_AND_wsiS_burstKind_20_ETC___d756;
  ...
  assign CAN_FIRE_RL_wrtSer_body =
	     ...
	     IF_wrtSerPos_54_EQ_0_55_OR_wrtSerPos_54_EQ_1_5_ETC___d374 &&
	     wci_cState == 3'd2 &&
	     dlyCtrl[3:0] == 4'h7 &&
	     wrtSerUnroll != 16'd0 ;
  ...
  assign MUX_mesgLength$write_1__VAL_3 = { 1'd1, mlp1__h17993[11:0], 2'd0 } ;
  assign MUX_mesgRdCount$write_1__VAL_1 = mesgRdCount + 32'd1 ;
  assign MUX_mesgWtCount$write_1__VAL_1 = mesgWtCount + 32'd1 ;
  assign MUX_metaWF$enq_1__VAL_1 = { x1_opcode__h17291, x1_length__h17292 } ;
  ...
  assign MUX_rdSyncWord$write_1__VAL_2 =
	     rdSerPos != 2'd3 && x1__h24060[23:0] == 24'd0 ;
  ...
  always@(wrtSerPos or
	  IF_wrtSerPos_54_EQ_2_57_THEN_0x0_ELSE_metaWF_f_ETC___d422 or
	  x1__h20689 or x1__h20716)
  begin
    case (wrtSerPos)
      2'd0: MUX_wide16Fa$enq_1__VAL_1 = x1__h20689;
      2'd1: MUX_wide16Fa$enq_1__VAL_1 = x1__h20716;
      default: MUX_wide16Fa$enq_1__VAL_1 =
		   IF_wrtSerPos_54_EQ_2_57_THEN_0x0_ELSE_metaWF_f_ETC___d422;
    endcase
  end
  always@(wrtSerPos or
	  IF_wrtSerPos_54_EQ_2_57_THEN_0x0_ELSE_mesgWF_w_ETC___d397 or
	  x1__h19993 or x1__h20024)
  begin
    case (wrtSerPos)
      2'd0: MUX_wide16Fa$enq_1__VAL_2 = x1__h19993;
      2'd1: MUX_wide16Fa$enq_1__VAL_2 = x1__h20024;
      default: MUX_wide16Fa$enq_1__VAL_2 =
		   IF_wrtSerPos_54_EQ_2_57_THEN_0x0_ELSE_mesgWF_w_ETC___d397;
    endcase
  end
  ...
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_1 = { 4'd5, addr__h21366, 12'd1 } ;
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_2 = { 4'd3, addr__h21657, 12'd1 } ;
  ...
  assign MUX_wrtSerPos$write_1__VAL_1 =
	     (wrtSerUnroll == 16'd1) ? 2'd0 : wrtSerPos_54_PLUS_1___d1025 ;
  assign MUX_wrtSerPos$write_1__VAL_2 =
	     (metaWF$D_OUT[23:0] == 24'd0) ?
	       2'd0 :
	       wrtSerPos_54_PLUS_1___d1025 ;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, x_data__h22359 } ;
  ...
  assign mesgWF_wDataOut$wget = data__h19572 ;
  ...
  assign mesgLengthSoFar$D_IN =
	     MUX_impreciseBurst$write_1__SEL_2 ? 14'd0 : mlp1__h17993 ;
  ...
  // register mesgWF_rCache
  assign mesgWF_rCache$D_IN = { 1'd1, mesgWF_rWrPtr, x__h15357 } ;
  assign mesgWF_rCache$EN = mesgWF_pwEnqueue$whas ;

  // register mesgWF_rRdPtr
  assign mesgWF_rRdPtr$D_IN = x__h15249 ;
  ...
  // register rdSerMeta
  assign rdSerMeta$D_IN = x1__h24060 ;
  ...
  assign wrtSerStage$D_IN =
	     MUX_wrtSerStage$write_1__SEL_1 ? data__h19572 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_1$D_IN =
	     MUX_wrtSerStage_1$write_1__SEL_1 ? data__h19572 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_2$D_IN =
	     MUX_wrtSerStage_2$write_1__SEL_1 ? data__h19572 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_3$D_IN =
	     MUX_wrtSerStage_3$write_1__SEL_1 ? data__h19572 : metaWF$D_OUT ;
  ...
  // remaining internal signals
  assign IF_wrtSerPos_54_EQ_0_55_OR_wrtSerPos_54_EQ_1_5_ETC___d374 =
	     CASE_wrtSerPos_0b1_0_1_1_1_2_1_3_0b1__q1 &&
	     (wrtSerPos != 2'd3 && wrtSerUnroll != 16'd1 ||
	      CASE_wrtSerPos_NOT_wrtSerPos_EQ_3_OR_wide16Fa_ETC__q2) ;
  assign IF_wrtSerPos_54_EQ_2_57_THEN_0x0_ELSE_mesgWF_w_ETC___d397 =
	     { (wrtSerPos == 2'd2) ? 32'h0 : data__h19572,
	       (wrtSerPos == 2'd2) ? data__h19572 : wrtSerStage_2,
	       wrtSerStage_1,
	       wrtSerStage } ;
  assign IF_wrtSerPos_54_EQ_2_57_THEN_0x0_ELSE_metaWF_f_ETC___d422 =
	     { (wrtSerPos == 2'd2) ? 32'h0 : metaWF$D_OUT,
	       (wrtSerPos == 2'd2) ? metaWF$D_OUT : wrtSerStage_2,
	       wrtSerStage_1,
	       wrtSerStage } ;
  assign NOT_dlyWordsStored_value_27_SLE_0_90_91_AND_NO_ETC___d298 =
	     (dlyWordsStored_value ^ 24'h800000) > 24'd8388608 &&
	     bytesWritten >= dlyHoldoffBytes &&
	     cyclesPassed >= dlyHoldoffCycles ;
  assign NOT_wrtSerPos_54_EQ_3_61_62_AND_NOT_metaWF_fir_ETC___d409 =
	     wrtSerPos != 2'd3 && metaWF$D_OUT[23:0] != 24'd0 ||
	     CASE_wrtSerPos_NOT_wrtSerPos_EQ_3_OR_wide16Fa_ETC__q2 ;
  assign _dor1bytesWritten$EN_write =
	     WILL_FIRE_RL_wmwt_messagePushPrecise ||
	     WILL_FIRE_RL_wmwt_messagePushImprecise ;
  assign addr__h21366 = { 9'd0, x__h21424 } ;
  assign addr__h21657 = { 9'd0, x__h21702 } ;
  assign data__h19572 =
	     (mesgWF_rCache[45] && mesgWF_rCache[44:32] == mesgWF_rRdPtr) ?
	       mesgWF_rCache[31:0] :
	       mesgWF_memory$DOB ;
  assign mesgRF_RDY_enq__15_AND_NOT_rdSerEmpty_16_17_AN_ETC___d228 =
	     mesgRF$FULL_N &&
	     (!rdSerEmpty && rdSerPos != 2'd0 || wide16Fc$EMPTY_N) ;
  assign metaRF_RDY_enq__60_AND_NOT_rdSerEmpty_16_17_AN_ETC___d261 =
	     metaRF$FULL_N &&
	     (!rdSerEmpty && rdSerPos != 2'd0 || wide16Fc$EMPTY_N) ;
  assign mlp1__h17993 = mesgLengthSoFar + 14'd1 ;
  assign rdat__h22386 = hasDebugLogic ? mesgWtCount : 32'd0 ;
  assign rdat__h22392 = hasDebugLogic ? mesgRdCount : 32'd0 ;
  assign rdat__h22399 = hasDebugLogic ? bytesWritten : 32'd0 ;
  assign rdat__h22405 = hasDebugLogic ? { 8'd0, x__h22409 } : 32'd0 ;
  assign rdat__h22529 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h22543 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h22551 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h22557 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h22571 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h22579 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h22585 = hasDebugLogic ? wmemiWrReq : 32'd0 ;
  assign rdat__h22591 = hasDebugLogic ? wmemiRdReq : 32'd0 ;
  assign rdat__h22597 = hasDebugLogic ? wmemiRdResp : 32'd0 ;
  assign rdat__h22603 =
	     hasDebugLogic ? { 8'd0, dlyWordsStored_value } : 32'd0 ;
  assign rdat__h22613 =
	     hasDebugLogic ? { 24'd0, dlyReadCredit_value } : 32'd0 ;
  assign rdat__h22623 = hasDebugLogic ? { 9'd0, dlyWAG } : 32'd0 ;
  assign rdat__h22633 = hasDebugLogic ? { 9'd0, dlyRAG } : 32'd0 ;
  assign rdat__h22643 = { {24{dlyMaxReadCredit[7]}}, dlyMaxReadCredit } ;
  assign rdat__h22652 =
	     { {24{dlyReadCredit_value[7]}}, dlyReadCredit_value } ;
  assign wci_cState_9_EQ_2_0_AND_dlyCtrl_5_BITS_3_TO_0__ETC___d308 =
	     wci_cState == 3'd2 && dlyCtrl[3:0] == 4'h7 &&
	     NOT_dlyWordsStored_value_27_SLE_0_90_91_AND_NO_ETC___d298 &&
	     (dlyReadCredit_value ^ 8'h80) > 8'd128 &&
	     (!dlyWriteJustFired || dlyCtrl[5]) &&
	     wsiM_reqFifo_c_r != 2'd2 ;
  assign wci_cState_9_EQ_2_0_AND_dlyCtrl_5_BITS_3_TO_0__ETC___d336 =
	     wci_cState == 3'd2 && dlyCtrl[3:0] == 4'h7 &&
	     ((dlyWriteJustFired || dlyWriteFlush == 8'd255) ?
		(dlyReadyToWrite_value ^ 5'h10) > 5'd16 :
		(dlyReadyToWrite_value ^ 5'h10) > 5'd23) ;
  assign wci_cState_9_EQ_2_0_AND_dlyCtrl_5_BITS_3_TO_0__ETC___d442 =
	     wci_cState == 3'd2 && dlyCtrl[3:0] == 4'h7 && mesgLength[14] &&
	     !doAbort &&
	     (preciseBurst && wsiWordsRemain == 12'd0 ||
	      impreciseBurst && endOfMessage) ;
  assign wrtSerPos_54_PLUS_1___d1025 = wrtSerPos + 2'd1 ;
  assign wsiS_reqFifo_notFull__40_AND_wsiS_burstKind_20_ETC___d756 =
	     wsiS_reqFifo$FULL_N &&
	     (wsiS_burstKind == 2'd0 ||
	      (wsiS_burstKind == 2'd1 || wsiS_burstKind == 2'd2) &&
	      wsiS_wsiReq$wget[57]) ;
  assign x1__h19993 = { 96'd0, data__h19572 } ;
  assign x1__h20024 = { 64'd0, data__h19572, wrtSerStage } ;
  assign x1__h20689 = { 96'd0, metaWF$D_OUT } ;
  assign x1__h20716 = { 64'd0, metaWF$D_OUT, wrtSerStage } ;
  assign x1_length__h17292 = { 10'd0, x__h17336 } ;
  assign x1_opcode__h17291 = opcode[8] ? opcode[7:0] : 8'd0 ;
  assign x__h15249 = mesgWF_rRdPtr + 13'd1 ;
  assign x__h15357 =
	     mesgWF_pwEnqueue$whas ? wsiS_reqFifo$D_OUT[43:12] : 32'd0 ;
  assign x__h17336 = mesgLength[14] ? mesgLength[13:0] : 14'd0 ;
  assign x__h21424 = { dlyRAG, 4'h0 } ;
  assign x__h21702 = { dlyWAG, 4'h0 } ;
  assign x__h22409 = { wmemi_statusR, wsiS_statusR, wsiM_statusR } ;
  assign x_burstLength__h23083 =
	     (readMeta[23:0] == 24'd0) ? 12'd1 : readMeta[13:2] ;
  assign x_byteEn__h23084 = (readMeta[23:0] == 24'd0) ? 4'd0 : 4'd15 ;
  always@(rdSerPos or
	  rdSerStage_3 or wide16Fc$D_OUT or rdSerStage_1 or rdSerStage_2)
  begin
    case (rdSerPos)
      2'd0: x1__h24060 = wide16Fc$D_OUT[31:0];
      2'd1: x1__h24060 = rdSerStage_1;
      2'd2: x1__h24060 = rdSerStage_2;
      2'd3: x1__h24060 = rdSerStage_3;
    endcase
  end
  always@(wrtSerPos)
  begin
  ...
  always@(wci_reqF$D_OUT or
	  ...
	  rdat__h22603 or
	  rdat__h22613 or
	  rdat__h22623 or rdat__h22633 or rdat__h22643 or rdat__h22652)
  begin
    case (wci_reqF$D_OUT[51:32])
      20'h0: x_data__h22359 = dlyCtrl;
      20'h00004: x_data__h22359 = dlyHoldoffBytes;
      20'h00008: x_data__h22359 = dlyHoldoffCycles;
      20'h0000C: x_data__h22359 = rdat__h22386;
      20'h00010: x_data__h22359 = rdat__h22392;
      20'h00014: x_data__h22359 = rdat__h22399;
      20'h00018: x_data__h22359 = rdat__h22405;
      20'h0001C: x_data__h22359 = 32'd0;
      20'h00020: x_data__h22359 = rdat__h22529;
      20'h00024: x_data__h22359 = rdat__h22543;
      20'h00028: x_data__h22359 = rdat__h22551;
      20'h0002C: x_data__h22359 = rdat__h22557;
      20'h00030: x_data__h22359 = rdat__h22571;
      20'h00034: x_data__h22359 = rdat__h22579;
      20'h00038: x_data__h22359 = rdat__h22585;
      20'h0003C: x_data__h22359 = rdat__h22591;
      20'h00040: x_data__h22359 = rdat__h22597;
      20'h00044: x_data__h22359 = rdat__h22603;
      20'h00048: x_data__h22359 = rdat__h22613;
      20'h0004C: x_data__h22359 = rdat__h22623;
      20'h00050: x_data__h22359 = rdat__h22633;
      20'h00054: x_data__h22359 = rdat__h22643;
      20'h00058: x_data__h22359 = rdat__h22652;
      default: x_data__h22359 = 32'd0;
    endcase
  end
  ...
  begin
    ...
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wmwt_doAbort)
	$display("[%0d]: %m: wmwt_doAbort", v__h17815);
    if (wciS0_MReset_n)
