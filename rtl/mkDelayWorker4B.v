...
//
// On Tue Jun  1 12:37:34 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker4B(wciS0_Clk,
  ...
  reg [63 : 0] v__h16563,
	       ...
	       v__h2804,
	       v__h3703;
  reg [31 : 0] sendData__h21077, x_data__h19645;
  reg CASE_wrtSerPos_0b1_0_1_1_1_2_1_3_0b1__q1;
  wire [31 : 0] data__h18565,
		mesg__h20118,
		rdat__h19689,
		x__h15013,
		x__h15939;
  wire [23 : 0] x1_length__h16256, x__h19692;
  wire [13 : 0] mlp1__h16955, x__h16300;
  wire [11 : 0] x_burstLength__h20209;
  wire [10 : 0] x__h14905, x__h15831;
  wire [7 : 0] x1_opcode__h16255;
  wire [3 : 0] x_byteEn__h20210;
  wire NOT_mesgRF_rRdPtr_23_PLUS_512_66_EQ_mesgRF_rWr_ETC___d181,
       NOT_wsiS_reqFifo_countReg_54_ULE_1_55___d556,
  ...
  assign MUX_mesgLength$write_1__VAL_3 = { 1'd1, mlp1__h16955[11:0], 2'd0 } ;
  assign MUX_mesgRdCount$write_1__VAL_1 = mesgRdCount + 32'd1 ;
  assign MUX_mesgWtCount$write_1__VAL_1 = mesgWtCount + 32'd1 ;
  assign MUX_metaWF$enq_1__VAL_1 = { x1_opcode__h16255, x1_length__h16256 } ;
  ...
  assign MUX_wide16F$enq_1__VAL_1 =
	     { data__h18565, wrtSerStage_2, wrtSerStage_1, wrtSerStage } ;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, x_data__h19645 } ;
  ...
  assign mesgWF_wDataOut$wget = data__h18565 ;
  ...
  assign mesgRF_wDataIn$wget = sendData__h21077 ;
  assign mesgRF_wDataIn$whas = CAN_FIRE_RL_rdSer_body ;
  assign mesgRF_wDataOut$wget = mesg__h20118 ;
  ...
  assign mesgLengthSoFar$D_IN =
	     MUX_impreciseBurst$write_1__SEL_2 ? 14'd0 : mlp1__h16955 ;
  assign mesgLengthSoFar$EN =
	     WILL_FIRE_RL_wmwt_mesgBegin && !wsiS_reqFifo$D_OUT[56] ||
	     WILL_FIRE_RL_wmwt_messagePushImprecise ;

  // register mesgRF_rCache
  assign mesgRF_rCache$D_IN = { 1'd1, mesgRF_rWrPtr, x__h15939 } ;
  assign mesgRF_rCache$EN = CAN_FIRE_RL_rdSer_body ;

  // register mesgRF_rRdPtr
  assign mesgRF_rRdPtr$D_IN = x__h15831 ;
  ...
  // register mesgWF_rCache
  assign mesgWF_rCache$D_IN = { 1'd1, mesgWF_rWrPtr, x__h15013 } ;
  assign mesgWF_rCache$EN = mesgWF_pwEnqueue$whas ;

  // register mesgWF_rRdPtr
  assign mesgWF_rRdPtr$D_IN = x__h14905 ;
  ...
  // register rdSerMeta
  assign rdSerMeta$D_IN = sendData__h21077 ;
  ...
  assign wrtSerStage$D_IN =
	     MUX_wrtSerStage$write_1__SEL_1 ? data__h18565 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_1$D_IN =
	     MUX_wrtSerStage_1$write_1__SEL_1 ? data__h18565 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_2$D_IN =
	     MUX_wrtSerStage_2$write_1__SEL_1 ? data__h18565 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_3$D_IN =
	     MUX_wide16F$enq_1__SEL_1 ? data__h18565 : metaWF$D_OUT ;
  ...
  assign mesgRF_memory$DIA = x__h15939 ;
  ...
  assign NOT_wsiS_reqFifo_countReg_54_ULE_1_55___d556 =
	     wsiS_reqFifo_countReg > 2'd1 ;
  ...
  assign metaRF_RDY_enq__03_AND_NOT_rdSerEmpty_69_70_AN_ETC___d204 =
	     metaRF$FULL_N &&
	     (!rdSerEmpty && rdSerPos != 2'd0 || wide16F$EMPTY_N) ;
  assign mlp1__h16955 = mesgLengthSoFar + 14'd1 ;
  assign rdat__h19689 = { 8'd0, x__h19692 } ;
  ...
  assign x1_length__h16256 = { 10'd0, x__h16300 } ;
  assign x1_opcode__h16255 = opcode[8] ? opcode[7:0] : 8'd0 ;
  assign x__h14905 = mesgWF_rRdPtr + 11'd1 ;
  assign x__h15013 =
	     mesgWF_pwEnqueue$whas ? wsiS_reqFifo$D_OUT[43:12] : 32'd0 ;
  assign x__h15831 = mesgRF_rRdPtr + 11'd1 ;
  assign x__h15939 = CAN_FIRE_RL_rdSer_body ? sendData__h21077 : 32'd0 ;
  assign x__h16300 = mesgLength[14] ? mesgLength[13:0] : 14'd0 ;
  assign x__h19692 = { wmemi_statusR, wsiS_statusR, wsiM_statusR } ;
  assign x_burstLength__h20209 =
	     (readMeta[23:0] == 24'd0) ? 12'd1 : readMeta[13:2] ;
  assign x_byteEn__h20210 = (readMeta[23:0] == 24'd0) ? 4'd0 : 4'd15 ;
  always@(rdSerPos or
	  rdSerStage_3 or wide16F$D_OUT or rdSerStage_1 or rdSerStage_2)
  begin
    case (rdSerPos)
      2'd0: sendData__h21077 = wide16F$D_OUT[31:0];
      2'd1: sendData__h21077 = rdSerStage_1;
      2'd2: sendData__h21077 = rdSerStage_2;
      2'd3: sendData__h21077 = rdSerStage_3;
    endcase
  end
  always@(wrtSerPos)
  begin
  ...
  always@(wci_reqF$D_OUT or
	  ...
	  mesgWtCount or
	  mesgRdCount or
	  rdat__h19689 or wsiS_extStatusW$wget or wsiM_extStatusW$wget)
  begin
    case (wci_reqF$D_OUT[51:32])
      20'h0: x_data__h19645 = dlyCtrl;
      20'h00004: x_data__h19645 = dlyHoldoff;
      20'h00008: x_data__h19645 = mesgWtCount;
      20'h0000C: x_data__h19645 = mesgRdCount;
      20'h00010, 20'h00014: x_data__h19645 = 32'd0;
      20'h00018: x_data__h19645 = rdat__h19689;
      20'h00020: x_data__h19645 = wsiS_extStatusW$wget[95:64];
      20'h00024: x_data__h19645 = wsiS_extStatusW$wget[63:32];
      20'h00028: x_data__h19645 = wsiS_extStatusW$wget[31:0];
      20'h0002C: x_data__h19645 = wsiM_extStatusW$wget[95:64];
      20'h00030: x_data__h19645 = wsiM_extStatusW$wget[63:32];
      20'h00034: x_data__h19645 = wsiM_extStatusW$wget[31:0];
      default: x_data__h19645 = 32'd0;
    endcase
  end
  ...
  begin
    ...
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wmwt_doAbort)
	$display("[%0d]: %m: wmwt_doAbort", v__h16808);
    if (wciS0_MReset_n)
