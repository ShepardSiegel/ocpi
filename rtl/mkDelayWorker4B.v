...
//
// On Wed Jun 23 18:13:34 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker4B(wciS0_Clk,
  ...
  reg CASE_wrtSerPos_0b1_0_1_1_1_2_1_3_0b1__q1,
      IF_wrtSerPos_10_EQ_0_11_OR_wrtSerPos_10_EQ_1_1_ETC___d993;
  ...
  wire [1 : 0] wrtSerPos_10_PLUS_1___d931;
  ...
  assign MUX_wrtSerPos$write_1__VAL_1 =
	     (wrtSerUnroll == 16'd1) ? 2'd0 : wrtSerPos_10_PLUS_1___d931 ;
  assign MUX_wrtSerPos$write_1__VAL_2 =
	     (metaWF$D_OUT[23:0] == 24'd0) ?
	       2'd0 :
	       wrtSerPos_10_PLUS_1___d931 ;
  ...
  assign mesgLengthSoFar$D_IN =
	     MUX_impreciseBurst$write_1__SEL_2 ? 14'd0 : mlp1__h17808 ;
  ...
  assign metaWF_RDY_deq__56_AND_NOT_wrtSerPos_10_EQ_3_1_ETC___d363 =
	     ...
	     (wrtSerPos != 2'd3 && metaWF$D_OUT[23:0] != 24'd0 ||
	      IF_wrtSerPos_10_EQ_0_11_OR_wrtSerPos_10_EQ_1_1_ETC___d993) ;
  assign mlp1__h17808 = mesgLengthSoFar + 14'd1 ;
  ...
  assign wrtSerPos_10_PLUS_1___d931 = wrtSerPos + 2'd1 ;
