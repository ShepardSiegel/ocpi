...
//
// On Mon Oct 25 17:57:26 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker4B(wciS0_Clk,
  ...
  reg [63 : 0] v__h22130, v__h2691, v__h2849, v__h3748;
  reg [31 : 0] x__h20982, x_data__h22264;
  ...
  wire [127 : 0] IF_wrtSerPos_79_EQ_2_82_THEN_0x0_ELSE_mesgWF_w_ETC___d421,
		 ...
		 x__h18828,
		 x__h18855;
  wire [35 : 0] addr__h19512, addr__h19681;
  wire [31 : 0] data__h17745,
		delayStatus__h21831,
		rdat__h22297,
		rdat__h22303,
		rdat__h22309,
		...
		rdat__h22649,
		x__h15107;
  wire [26 : 0] x__h19570, x__h19726;
  wire [23 : 0] btm__h17061, x__h22319;
  wire [13 : 0] mesgLengthSoFar_05_PLUS_1___d968;
  wire [12 : 0] x__h14999;
  wire [11 : 0] x_burstLength__h20010;
  wire [3 : 0] x_byteEn__h20011;
  wire [1 : 0] wrtSerPos_79_PLUS_1___d967;
  wire IF_wrtSerPos_79_EQ_0_80_OR_wrtSerPos_79_EQ_1_8_ETC___d398,
       ...
       bytesWritten_6_ULT_dlyHoldoffBytes_6___d1010,
       cyclesPassed_54_ULT_dlyHoldoffCycles_8___d1008,
  ...
  assign MUX_rdSyncWord$write_1__VAL_2 =
	     rdSerPos != 2'd3 && x__h20982[23:0] == 24'd0 ;
  ...
  always@(wrtSerPos or
	  ...
	  x__h18828 or x__h18855)
  begin
    case (wrtSerPos)
      2'd0: MUX_wide16Fa$enq_1__VAL_1 = x__h18828;
      2'd1: MUX_wide16Fa$enq_1__VAL_1 = x__h18855;
  ...
  always@(wrtSerPos or
	  ...
	  x__h18166 or x__h18197)
  begin
    case (wrtSerPos)
      2'd0: MUX_wide16Fa$enq_1__VAL_2 = x__h18166;
      2'd1: MUX_wide16Fa$enq_1__VAL_2 = x__h18197;
  ...
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_1 = { 4'd5, addr__h19512, 12'd1 } ;
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_2 = { 4'd3, addr__h19681, 12'd1 } ;
  ...
  assign MUX_wrtSerPos$write_1__VAL_1 =
	     (wrtSerUnroll == 16'd1) ? 2'd0 : wrtSerPos_79_PLUS_1___d967 ;
  assign MUX_wrtSerPos$write_1__VAL_2 =
	     (metaWF$D_OUT[23:0] == 24'd0) ?
	       2'd0 :
	       wrtSerPos_79_PLUS_1___d967 ;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, x_data__h22264 } ;
  ...
  assign mesgWF_wDataOut$wget = data__h17745 ;
  ...
  // register bytesThisMessage
  assign bytesThisMessage$D_IN = btm__h17061 ;
  ...
  assign dlyRdOpOther$EN =
	     WILL_FIRE_RL_rdSer_begin && x__h20982[31:24] != 8'd0 ;
  ...
  assign mesgLengthSoFar$D_IN =
	     wsiS_reqFifo$D_OUT[57] ?
	       14'd0 :
	       mesgLengthSoFar_05_PLUS_1___d968 ;
  ...
  // register rdSerMeta
  assign rdSerMeta$D_IN = x__h20982 ;
  ...
  assign wrtSerStage$D_IN =
	     MUX_wrtSerStage$write_1__SEL_1 ? data__h17745 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_1$D_IN =
	     MUX_wrtSerStage_1$write_1__SEL_1 ? data__h17745 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_2$D_IN =
	     MUX_wrtSerStage_2$write_1__SEL_1 ? data__h17745 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_3$D_IN =
	     MUX_wrtSerStage_3$write_1__SEL_1 ? data__h17745 : metaWF$D_OUT ;
  ...
  assign mesgWF_memory$ADDRB =
	     CAN_FIRE_RL_wrtSer_body ? x__h14999[11:0] : mesgWF_rRdPtr[11:0] ;
  ...
  assign IF_wrtSerPos_79_EQ_2_82_THEN_0x0_ELSE_mesgWF_w_ETC___d421 =
	     { (wrtSerPos == 2'd2) ? 32'h0 : data__h17745,
	       (wrtSerPos == 2'd2) ? data__h17745 : wrtSerStage_2,
	       wrtSerStage_1,
	       wrtSerStage } ;
  ...
  assign NOT_wrtSerPos_79_EQ_3_86_87_AND_NOT_metaWF_fir_ETC___d432 =
	     wrtSerPos != 2'd3 && metaWF$D_OUT[23:0] != 24'd0 ||
	     CASE_wrtSerPos_NOT_wrtSerPos_EQ_3_OR_wide16Fa_ETC__q2 ;
  assign addr__h19512 = { 9'd0, x__h19570 } ;
  assign addr__h19681 = { 9'd0, x__h19726 } ;
  assign btm__h17061 =
	     { wsiS_reqFifo$D_OUT[56] ?
		 { 10'd0, wsiS_reqFifo$D_OUT[55:44] } :
		 { 8'd0, mesgLengthSoFar_05_PLUS_1___d968 },
	       2'd0 } ;
  assign bytesWritten_6_ULT_dlyHoldoffBytes_6___d1010 =
	     bytesWritten < dlyHoldoffBytes ;
  assign cyclesPassed_54_ULT_dlyHoldoffCycles_8___d1008 =
	     cyclesPassed < dlyHoldoffCycles ;
  assign data__h17745 =
	     (mesgWF_rCache[45] && mesgWF_rCache[44:32] == mesgWF_rRdPtr) ?
	       mesgWF_rCache[31:0] :
	       mesgWF_memory$DOB ;
  assign delayStatus__h21831 =
	     { 14'h0,
	       !dlyWordsStored_value_26_SLE_0___d1009 &&
	       !bytesWritten_6_ULT_dlyHoldoffBytes_6___d1010 &&
	       !cyclesPassed_54_ULT_dlyHoldoffCycles_8___d1008,
  ...
  assign mesgLengthSoFar_05_PLUS_1___d968 = mesgLengthSoFar + 14'd1 ;
  ...
  assign metaRF_i_notFull__17_AND_NOT_rdSerEmpty_75_76__ETC___d318 =
	     metaRF$FULL_N &&
	     (!rdSerEmpty && rdSerPos != 2'd0 || wide16Fc$EMPTY_N) ;
  assign rdat__h22297 = hasDebugLogic ? mesgWtCount : 32'd0 ;
  assign rdat__h22303 = hasDebugLogic ? mesgRdCount : 32'd0 ;
  assign rdat__h22309 = hasDebugLogic ? bytesWritten : 32'd0 ;
  assign rdat__h22315 = hasDebugLogic ? { 8'd0, x__h22319 } : 32'd0 ;
  assign rdat__h22439 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h22453 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h22461 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h22467 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h22481 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h22489 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h22495 = hasDebugLogic ? wmemiWrReq : 32'd0 ;
  assign rdat__h22501 = hasDebugLogic ? wmemiRdReq : 32'd0 ;
  assign rdat__h22507 = hasDebugLogic ? wmemiRdResp1 : 32'd0 ;
  assign rdat__h22513 =
	     hasDebugLogic ?
  ...
  assign rdat__h22524 =
	     hasDebugLogic ?
	       ...
	       32'd0 ;
  assign rdat__h22535 = hasDebugLogic ? { 9'd0, dlyWAG } : 32'd0 ;
  assign rdat__h22546 = hasDebugLogic ? { 9'd0, dlyRAG } : 32'd0 ;
  assign rdat__h22567 = hasDebugLogic ? wmemiRdResp2 : 32'd0 ;
  assign rdat__h22622 =
	     { {16{dlyReadyToWrite_value[15]}}, dlyReadyToWrite_value } ;
  assign rdat__h22631 = { 16'd0, wrtSerUnroll } ;
  assign rdat__h22640 = { 8'd0, bytesThisMessage } ;
  assign rdat__h22649 = { 18'd0, mesgLengthSoFar } ;
  assign wci_cState_9_EQ_2_0_AND_dlyCtrl_4_BITS_3_TO_0__ETC___d351 =
	     wci_cState == 3'd2 && dlyCtrl[3:0] == 4'h7 &&
	     !dlyWordsStored_value_26_SLE_0___d1009 &&
	     !bytesWritten_6_ULT_dlyHoldoffBytes_6___d1010 &&
	     !cyclesPassed_54_ULT_dlyHoldoffCycles_8___d1008 ;
  assign wrtSerPos_79_PLUS_1___d967 = wrtSerPos + 2'd1 ;
  assign wsiS_reqFifo_notFull__03_AND_wsiS_burstKind_83_ETC___d723 =
	     wsiS_reqFifo$FULL_N &&
	     (wsiS_burstKind == 2'd0 ||
	      (wsiS_burstKind == 2'd1 || wsiS_burstKind == 2'd2) &&
	      wsiS_wsiReq$wget[57]) ;
  assign x__h14999 = mesgWF_rRdPtr + 13'd1 ;
  assign x__h15107 =
	     CAN_FIRE_RL_wmwt_mesg_ingress ?
	       wsiS_reqFifo$D_OUT[43:12] :
	       32'd0 ;
  assign x__h18166 = { 96'd0, data__h17745 } ;
  assign x__h18197 = { 64'd0, data__h17745, wrtSerStage } ;
  assign x__h18828 = { 96'd0, metaWF$D_OUT } ;
  assign x__h18855 = { 64'd0, metaWF$D_OUT, wrtSerStage } ;
  assign x__h19570 = { dlyRAG, 4'h0 } ;
  assign x__h19726 = { dlyWAG, 4'h0 } ;
  assign x__h22319 = { wmemi_statusR, wsiS_statusR, wsiM_statusR } ;
  assign x_burstLength__h20010 =
	     (readMeta[23:0] == 24'd0) ? 12'd1 : readMeta[13:2] ;
  assign x_byteEn__h20011 = (readMeta[23:0] == 24'd0) ? 4'd0 : 4'd15 ;
  always@(rdSerPos or
	  rdSerStage_3 or wide16Fc$D_OUT or rdSerStage_1 or rdSerStage_2)
  begin
    case (rdSerPos)
      2'd0: x__h20982 = wide16Fc$D_OUT[31:0];
      2'd1: x__h20982 = rdSerStage_1;
      2'd2: x__h20982 = rdSerStage_2;
      2'd3: x__h20982 = rdSerStage_3;
    endcase
  end
  always@(wrtSerPos)
  begin
  ...
  always@(wci_reqF$D_OUT or
	  ...
	  dlyRdOpOther or
	  rdat__h22567 or
	  delayStatus__h21831 or
	  rdat__h22622 or rdat__h22631 or rdat__h22640 or rdat__h22649)
  begin
    case (wci_reqF$D_OUT[51:32])
      20'h0: x_data__h22264 = dlyCtrl;
      20'h00004: x_data__h22264 = dlyHoldoffBytes;
      20'h00008: x_data__h22264 = dlyHoldoffCycles;
      20'h0000C: x_data__h22264 = rdat__h22297;
      20'h00010: x_data__h22264 = rdat__h22303;
      20'h00014: x_data__h22264 = rdat__h22309;
      20'h00018: x_data__h22264 = rdat__h22315;
      20'h0001C: x_data__h22264 = 32'd0;
      20'h00020: x_data__h22264 = rdat__h22439;
      20'h00024: x_data__h22264 = rdat__h22453;
      20'h00028: x_data__h22264 = rdat__h22461;
      20'h0002C: x_data__h22264 = rdat__h22467;
      20'h00030: x_data__h22264 = rdat__h22481;
      20'h00034: x_data__h22264 = rdat__h22489;
      20'h00038: x_data__h22264 = rdat__h22495;
      20'h0003C: x_data__h22264 = rdat__h22501;
      20'h00040: x_data__h22264 = rdat__h22507;
      20'h00044: x_data__h22264 = rdat__h22513;
      20'h00048: x_data__h22264 = rdat__h22524;
      20'h0004C: x_data__h22264 = rdat__h22535;
      20'h00050: x_data__h22264 = rdat__h22546;
      20'h00058: x_data__h22264 = dlyRdOpZero;
      20'h0005C: x_data__h22264 = dlyRdOpOther;
      20'h00060: x_data__h22264 = rdat__h22567;
      20'h00064: x_data__h22264 = delayStatus__h21831;
      20'h00068: x_data__h22264 = rdat__h22622;
      20'h0006C: x_data__h22264 = rdat__h22631;
      20'h00070: x_data__h22264 = rdat__h22640;
      20'h00074: x_data__h22264 = rdat__h22649;
      default: x_data__h22264 = 32'd0;
    endcase
  end
