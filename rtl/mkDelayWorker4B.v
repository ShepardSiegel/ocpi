...
//
// On Sat Jun  5 13:28:01 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker4B(wciS0_Clk,
  ...
  reg [63 : 0] v__h17393,
	       ...
	       v__h2815,
	       v__h3714;
  reg [31 : 0] sendData__h23485, x_data__h21484;
  reg CASE_wrtSerPos_0b1_0_1_1_1_2_1_3_0b1__q1,
      IF_wrtSerPos_93_EQ_0_94_OR_wrtSerPos_93_EQ_1_9_ETC___d983;
  wire [127 : 0] IF_wrtSerPos_93_EQ_2_96_THEN_0x0_ELSE_mesgWF_w_ETC___d335,
		 IF_wrtSerPos_93_EQ_2_96_THEN_0x0_ELSE_metaWF_f_ETC___d358,
		 x1__h19743,
		 x1__h19752,
		 x1__h20266,
		 x1__h20275;
  wire [35 : 0] addr__h20744, addr__h20901;
  wire [31 : 0] data__h19397,
		mesg__h22011,
		rdat__h21528,
		rdat__h21737,
		rdat__h21745,
		...
		x__h15107,
		x__h16033;
  wire [23 : 0] x1_length__h17086, x__h20802, x__h20946, x__h21531;
  wire [13 : 0] mlp1__h17785, x__h17130;
  wire [11 : 0] x_burstLength__h22102;
  wire [10 : 0] x__h14999, x__h15925;
  wire [7 : 0] x1_opcode__h17085;
  wire [3 : 0] x_byteEn__h22103;
  wire [1 : 0] wrtSerPos_93_PLUS_1___d935;
  wire NOT_mesgRF_rRdPtr_49_PLUS_512_02_EQ_mesgRF_rWr_ETC___d214,
       NOT_wsiS_reqFifo_countReg_72_ULE_1_73___d674,
       _dor1bytesWritten$EN_write,
       metaRF_RDY_enq__38_AND_NOT_rdSerEmpty_05_06_AN_ETC___d239,
       metaWF_RDY_deq__39_AND_NOT_wrtSerPos_93_EQ_3_0_ETC___d346,
       wci_cState_9_EQ_2_0_AND_dlyCtrl_4_BITS_3_TO_0__ETC___d184,
       wci_cState_9_EQ_2_0_AND_dlyCtrl_4_BITS_3_TO_0__ETC___d378;
  ...
  assign CAN_FIRE_RL_rdSer_sync =
	     wide16Fb$EMPTY_N && wci_cState == 3'd2 && dlyCtrl[3:0] == 4'h7 &&
	     rdSyncWord ;
  assign WILL_FIRE_RL_rdSer_sync = CAN_FIRE_RL_rdSer_sync ;

  // rule RL_rdSer_body
  assign CAN_FIRE_RL_rdSer_body =
	     NOT_mesgRF_rRdPtr_49_PLUS_512_02_EQ_mesgRF_rWr_ETC___d214 &&
	     wci_cState == 3'd2 &&
	     dlyCtrl[3:0] == 4'h7 &&
	     rdSerUnroll != 16'd0 &&
	     !rdSyncWord ;
  ...
  assign MUX_mesgLength$write_1__VAL_3 = { 1'd1, mlp1__h17785[11:0], 2'd0 } ;
  assign MUX_mesgRdCount$write_1__VAL_1 = mesgRdCount + 32'd1 ;
  assign MUX_mesgWtCount$write_1__VAL_1 = mesgWtCount + 32'd1 ;
  assign MUX_metaWF$enq_1__VAL_1 = { x1_opcode__h17085, x1_length__h17086 } ;
  ...
  always@(wrtSerPos or
	  IF_wrtSerPos_93_EQ_2_96_THEN_0x0_ELSE_metaWF_f_ETC___d358 or
	  x1__h20266 or x1__h20275)
  begin
    case (wrtSerPos)
      2'd0: MUX_wide16Fa$enq_1__VAL_1 = x1__h20266;
      2'd1: MUX_wide16Fa$enq_1__VAL_1 = x1__h20275;
      default: MUX_wide16Fa$enq_1__VAL_1 =
		   IF_wrtSerPos_93_EQ_2_96_THEN_0x0_ELSE_metaWF_f_ETC___d358;
    endcase
  end
  always@(wrtSerPos or
	  IF_wrtSerPos_93_EQ_2_96_THEN_0x0_ELSE_mesgWF_w_ETC___d335 or
	  x1__h19743 or x1__h19752)
  begin
    case (wrtSerPos)
      2'd0: MUX_wide16Fa$enq_1__VAL_2 = x1__h19743;
      2'd1: MUX_wide16Fa$enq_1__VAL_2 = x1__h19752;
      default: MUX_wide16Fa$enq_1__VAL_2 =
		   IF_wrtSerPos_93_EQ_2_96_THEN_0x0_ELSE_mesgWF_w_ETC___d335;
    endcase
  end
  ...
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_1 = { 4'd5, addr__h20744, 12'd1 } ;
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_2 = { 4'd3, addr__h20901, 12'd1 } ;
  ...
  assign MUX_wrtSerPos$write_1__VAL_1 =
	     (wrtSerUnroll == 16'd1) ? 2'd0 : wrtSerPos_93_PLUS_1___d935 ;
  assign MUX_wrtSerPos$write_1__VAL_2 =
	     (metaWF$D_OUT[23:0] == 24'd0) ?
	       2'd0 :
	       wrtSerPos_93_PLUS_1___d935 ;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, x_data__h21484 } ;
  ...
  assign mesgWF_wDataOut$wget = data__h19397 ;
  ...
  assign mesgRF_wDataIn$wget = sendData__h23485 ;
  assign mesgRF_wDataOut$wget = mesg__h22011 ;
  ...
  assign mesgLengthSoFar$D_IN =
	     MUX_impreciseBurst$write_1__SEL_2 ? 14'd0 : mlp1__h17785 ;
  assign mesgLengthSoFar$EN =
	     WILL_FIRE_RL_wmwt_mesgBegin && !wsiS_reqFifo$D_OUT[56] ||
	     WILL_FIRE_RL_wmwt_messagePushImprecise ;

  // register mesgRF_rCache
  assign mesgRF_rCache$D_IN = { 1'd1, mesgRF_rWrPtr, x__h16033 } ;
  assign mesgRF_rCache$EN = CAN_FIRE_RL_rdSer_body ;

  // register mesgRF_rRdPtr
  assign mesgRF_rRdPtr$D_IN = x__h15925 ;
  ...
  // register mesgWF_rCache
  assign mesgWF_rCache$D_IN = { 1'd1, mesgWF_rWrPtr, x__h15107 } ;
  assign mesgWF_rCache$EN = mesgWF_pwEnqueue$whas ;

  // register mesgWF_rRdPtr
  assign mesgWF_rRdPtr$D_IN = x__h14999 ;
  ...
  // register rdSerMeta
  assign rdSerMeta$D_IN = sendData__h23485 ;
  ...
  always@(WILL_FIRE_RL_rdSer_begin or
	  sendData__h23485 or
	  WILL_FIRE_RL_rdSer_body or rdSerUnroll or WILL_FIRE_RL_rdSer_sync)
  begin
    case (1'b1) // synopsys parallel_case
      WILL_FIRE_RL_rdSer_begin:
	  rdSyncWord$D_IN = sendData__h23485[23:0] == 24'd0;
      WILL_FIRE_RL_rdSer_body: rdSyncWord$D_IN = rdSerUnroll == 16'd1;
  ...
  assign wrtSerStage$D_IN =
	     MUX_wrtSerStage$write_1__SEL_1 ? data__h19397 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_1$D_IN =
	     MUX_wrtSerStage_1$write_1__SEL_1 ? data__h19397 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_2$D_IN =
	     MUX_wrtSerStage_2$write_1__SEL_1 ? data__h19397 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_3$D_IN =
	     MUX_wrtSerStage_3$write_1__SEL_1 ? data__h19397 : metaWF$D_OUT ;
  ...
  assign mesgRF_memory$DIA = x__h16033 ;
  ...
  // remaining internal signals
  assign IF_wrtSerPos_93_EQ_2_96_THEN_0x0_ELSE_mesgWF_w_ETC___d335 =
	     { (wrtSerPos == 2'd2) ? 32'h0 : data__h19397,
	       (wrtSerPos == 2'd2) ? data__h19397 : wrtSerStage_2,
	       wrtSerStage_1,
	       wrtSerStage } ;
  assign IF_wrtSerPos_93_EQ_2_96_THEN_0x0_ELSE_metaWF_f_ETC___d358 =
	     { (wrtSerPos == 2'd2) ? 32'h0 : metaWF$D_OUT,
	       (wrtSerPos == 2'd2) ? metaWF$D_OUT : wrtSerStage_2,
	       wrtSerStage_1,
	       wrtSerStage } ;
  assign NOT_mesgRF_rRdPtr_49_PLUS_512_02_EQ_mesgRF_rWr_ETC___d214 =
	     mesgRF_rRdPtr + 11'd512 != mesgRF_rWrPtr &&
	     (!rdSerEmpty && rdSerPos != 2'd0 || wide16Fb$EMPTY_N) ;
  assign NOT_wsiS_reqFifo_countReg_72_ULE_1_73___d674 =
	     wsiS_reqFifo_countReg > 2'd1 ;
  assign _dor1bytesWritten$EN_write =
	     WILL_FIRE_RL_wmwt_messagePushPrecise ||
	     WILL_FIRE_RL_wmwt_messagePushImprecise ;
  assign addr__h20744 = { 12'd0, x__h20802 } ;
  assign addr__h20901 = { 12'd0, x__h20946 } ;
  assign data__h19397 =
  ...
  assign mesg__h22011 =
	     (mesgRF_rCache[43] && mesgRF_rCache[42:32] == mesgRF_rRdPtr) ?
	       mesgRF_rCache[31:0] :
	       mesgRF_memory$DOB ;
  assign metaRF_RDY_enq__38_AND_NOT_rdSerEmpty_05_06_AN_ETC___d239 =
	     metaRF$FULL_N &&
	     (!rdSerEmpty && rdSerPos != 2'd0 || wide16Fb$EMPTY_N) ;
  assign metaWF_RDY_deq__39_AND_NOT_wrtSerPos_93_EQ_3_0_ETC___d346 =
	     metaWF$EMPTY_N &&
	     (wrtSerPos != 2'd3 && metaWF$D_OUT[23:0] != 24'd0 ||
	      IF_wrtSerPos_93_EQ_0_94_OR_wrtSerPos_93_EQ_1_9_ETC___d983) ;
  assign mlp1__h17785 = mesgLengthSoFar + 14'd1 ;
  assign rdat__h21528 = { 8'd0, x__h21531 } ;
  assign rdat__h21737 = { 12'd0, dlyWordsStored_value } ;
  assign rdat__h21745 = { 24'd0, dlyReadCredit_value } ;
  assign rdat__h21753 = { 12'd0, dlyWAG } ;
  assign rdat__h21761 = { 12'd0, dlyRAG } ;
  assign wci_cState_9_EQ_2_0_AND_dlyCtrl_4_BITS_3_TO_0__ETC___d184 =
	     wci_cState == 3'd2 && dlyCtrl[3:0] == 4'h7 &&
	     unrollCnt == 16'd0 &&
	     bytesWritten > dlyHoldoff ;
  assign wci_cState_9_EQ_2_0_AND_dlyCtrl_4_BITS_3_TO_0__ETC___d378 =
	     wci_cState == 3'd2 && dlyCtrl[3:0] == 4'h7 && mesgLength[14] &&
	     !doAbort &&
	     (preciseBurst && wsiWordsRemain == 12'd0 ||
	      impreciseBurst && endOfMessage) ;
  assign wrtSerPos_93_PLUS_1___d935 = wrtSerPos + 2'd1 ;
  assign x1__h19743 = { 96'd0, data__h19397 } ;
  assign x1__h19752 = { 64'd0, data__h19397, wrtSerStage } ;
  assign x1__h20266 = { 96'd0, metaWF$D_OUT } ;
  assign x1__h20275 = { 64'd0, metaWF$D_OUT, wrtSerStage } ;
  assign x1_length__h17086 = { 10'd0, x__h17130 } ;
  assign x1_opcode__h17085 = opcode[8] ? opcode[7:0] : 8'd0 ;
  assign x__h14999 = mesgWF_rRdPtr + 11'd1 ;
  assign x__h15107 =
	     mesgWF_pwEnqueue$whas ? wsiS_reqFifo$D_OUT[43:12] : 32'd0 ;
  assign x__h15925 = mesgRF_rRdPtr + 11'd1 ;
  assign x__h16033 = CAN_FIRE_RL_rdSer_body ? sendData__h23485 : 32'd0 ;
  assign x__h17130 = mesgLength[14] ? mesgLength[13:0] : 14'd0 ;
  assign x__h20802 = { dlyRAG, 4'h0 } ;
  assign x__h20946 = { dlyWAG, 4'h0 } ;
  assign x__h21531 = { wmemi_statusR, wsiS_statusR, wsiM_statusR } ;
  assign x_burstLength__h22102 =
	     (readMeta[23:0] == 24'd0) ? 12'd1 : readMeta[13:2] ;
  assign x_byteEn__h22103 = (readMeta[23:0] == 24'd0) ? 4'd0 : 4'd15 ;
  always@(rdSerPos or
	  rdSerStage_3 or wide16Fb$D_OUT or rdSerStage_1 or rdSerStage_2)
  begin
    case (rdSerPos)
      2'd0: sendData__h23485 = wide16Fb$D_OUT[31:0];
      2'd1: sendData__h23485 = rdSerStage_1;
      2'd2: sendData__h23485 = rdSerStage_2;
      2'd3: sendData__h23485 = rdSerStage_3;
    endcase
  end
  ...
  always@(wci_reqF$D_OUT or
	  ...
	  wmemiRdReq or
	  wmemiRdResp or
	  rdat__h21737 or rdat__h21745 or rdat__h21753 or rdat__h21761)
  begin
    case (wci_reqF$D_OUT[51:32])
      20'h0: x_data__h21484 = dlyCtrl;
      20'h00004: x_data__h21484 = dlyHoldoff;
      20'h00008: x_data__h21484 = mesgWtCount;
      20'h0000C: x_data__h21484 = mesgRdCount;
      20'h00010: x_data__h21484 = bytesWritten;
      20'h00014: x_data__h21484 = 32'd0;
      20'h00018: x_data__h21484 = rdat__h21528;
      20'h00020: x_data__h21484 = wsiS_extStatusW$wget[95:64];
      20'h00024: x_data__h21484 = wsiS_extStatusW$wget[63:32];
      20'h00028: x_data__h21484 = wsiS_extStatusW$wget[31:0];
      20'h0002C: x_data__h21484 = wsiM_extStatusW$wget[95:64];
      20'h00030: x_data__h21484 = wsiM_extStatusW$wget[63:32];
      20'h00034: x_data__h21484 = wsiM_extStatusW$wget[31:0];
      20'h00038: x_data__h21484 = wmemiWrReq;
      20'h0003C: x_data__h21484 = wmemiRdReq;
      20'h00040: x_data__h21484 = wmemiRdResp;
      20'h00044: x_data__h21484 = rdat__h21737;
      20'h00048: x_data__h21484 = rdat__h21745;
      20'h0004C: x_data__h21484 = rdat__h21753;
      20'h00050: x_data__h21484 = rdat__h21761;
      default: x_data__h21484 = 32'd0;
    endcase
  end
  ...
  begin
	...
	dlyHoldoff <= `BSV_ASSIGNMENT_DELAY 32'd0;
  ...
  begin
    ...
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wmwt_doAbort)
	$display("[%0d]: %m: wmwt_doAbort", v__h17638);
    if (wciS0_MReset_n)
