...
//
// On Wed Jul  7 10:05:53 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker4B(wciS0_Clk,
  ...
  wire [3 : 0] dlyReadyToWrite_acc_v1$wget,
  ...
  reg [3 : 0] dlyReadyToWrite_value;
  wire [3 : 0] dlyReadyToWrite_value$D_IN;
  ...
  wire [3 : 0] MUX_dlyReadyToWrite_value$write_1__VAL_2;
  ...
  wire [1 : 0] wrtSerPos_39_PLUS_1___d968;
  ...
  assign MUX_wrtSerPos$write_1__VAL_1 =
	     (wrtSerUnroll == 16'd1) ? 2'd0 : wrtSerPos_39_PLUS_1___d968 ;
  assign MUX_wrtSerPos$write_1__VAL_2 =
	     (metaWF$D_OUT[23:0] == 24'd0) ?
	       2'd0 :
	       wrtSerPos_39_PLUS_1___d968 ;
  ...
  assign MUX_dlyReadyToWrite_value$write_1__VAL_2 =
	     ...
	     (dlyReadyToWrite_acc_v1$whas ? 4'd1 : 4'd0) +
	     (CAN_FIRE_RL_delay_write_req ? 4'd15 : 4'd0) ;
  ...
  assign dlyReadyToWrite_acc_v1$wget = 4'd1 ;
  assign dlyReadyToWrite_acc_v2$wget = 4'd15 ;
  ...
  assign wci_cState_9_EQ_2_0_AND_dlyCtrl_5_BITS_3_TO_0__ETC___d323 =
		...
		(dlyReadyToWrite_value ^ 4'h8) > 4'd8 :
		(dlyReadyToWrite_value ^ 4'h8) > 4'd11) ;
  ...
  assign wrtSerPos_39_PLUS_1___d968 = wrtSerPos + 2'd1 ;
  ...
  begin
	...
	dlyReadyToWrite_value <= `BSV_ASSIGNMENT_DELAY 4'd0;
