...
//
// On Fri Mar 18 08:37:29 EDT 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker4B(wciS0_Clk,
  ...
  wire [13 : 0] mesgLengthSoFar_83_PLUS_1___d962;
  wire [12 : 0] x__h15664;
  wire [11 : 0] x_burstLength__h22414;
  wire [3 : 0] x_byteEn__h22415;
  wire [1 : 0] wrtSerPos_00_PLUS_1___d961;
  wire IF_wrtSerPos_00_EQ_0_08_OR_wrtSerPos_00_EQ_1_0_ETC___d553,
       ...
       bytesWritten_96_ULT_dlyHoldoffBytes_75___d1007,
       cyclesPassed_66_ULT_dlyHoldoffCycles_78___d1005,
       dlyWordsStored_value_27_SLE_0_74_OR_bytesWritt_ETC___d582,
       dlyWordsStored_value_27_SLE_0___d1006,
  ...
  assign MUX_wrtSerPos$write_1__VAL_1 =
	     (metaWF$D_OUT[23:0] == 24'd0) ?
	       2'd0 :
	       wrtSerPos_00_PLUS_1___d961 ;
  assign MUX_wrtSerPos$write_1__VAL_2 =
	     (wrtSerUnroll == 16'd1) ? 2'd0 : wrtSerPos_00_PLUS_1___d961 ;
  ...
  assign mesgLengthSoFar$D_IN =
	     wsiS_reqFifo$D_OUT[57] ?
	       14'd0 :
	       mesgLengthSoFar_83_PLUS_1___d962 ;
  ...
  assign btm__h18052 =
		 ...
		 { 8'd0, mesgLengthSoFar_83_PLUS_1___d962 },
	       2'd0 } ;
  assign bytesWritten_96_ULT_dlyHoldoffBytes_75___d1007 =
	     bytesWritten < dlyHoldoffBytes ;
  assign cyclesPassed_66_ULT_dlyHoldoffCycles_78___d1005 =
  ...
  assign dlyWordsStored_value_27_SLE_0_74_OR_bytesWritt_ETC___d582 =
	     ...
	     wsiM_reqFifo_c_r == 2'd2 ||
	     tog50 ;
  assign dlyWordsStored_value_27_SLE_0___d1006 =
  ...
  assign mesgLengthSoFar_83_PLUS_1___d962 = mesgLengthSoFar + 14'd1 ;
  ...
  assign wci_wslv_cState_6_EQ_2_7_AND_dlyCtrl_58_BITS_3_ETC___d602 =
	     ...
	     !bytesWritten_96_ULT_dlyHoldoffBytes_75___d1007 &&
	     !cyclesPassed_66_ULT_dlyHoldoffCycles_78___d1005 ;
  assign wrtSerPos_00_PLUS_1___d961 = wrtSerPos + 2'd1 ;
