...
//
// On Tue Jul  6 08:20:59 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker4B(wciS0_Clk,
  ...
  reg [63 : 0] v__h16649,
	       ...
	       v__h2816,
	       v__h3715;
  reg [31 : 0] x1__h22370, x_data__h20734;
  reg CASE_wrtSerPos_0b1_0_1_1_1_2_1_3_0b1__q1,
      IF_wrtSerPos_22_EQ_0_23_OR_wrtSerPos_22_EQ_1_2_ETC___d879;
  wire [127 : 0] IF_wrtSerPos_22_EQ_2_25_THEN_0x0_ELSE_mesgWF_w_ETC___d364,
		 ...
		 x1__h19422,
		 x1__h19431;
  wire [35 : 0] addr__h19924, addr__h20096;
  wire [31 : 0] data__h18553,
		rdat__h20761,
		rdat__h20767,
		rdat__h20774,
		rdat__h20780,
		...
		rdat__h21008,
		x__h15143;
  wire [26 : 0] x__h19982, x__h20141;
  wire [23 : 0] x1_length__h16342, x__h20784;
  wire [13 : 0] mlp1__h17012, x__h16386;
  wire [12 : 0] x__h15035;
  wire [11 : 0] x_burstLength__h21393;
  wire [7 : 0] x1_opcode__h16341;
  wire [3 : 0] x_byteEn__h21394;
  wire [1 : 0] wrtSerPos_22_PLUS_1___d960;
  wire NOT_dlyWordsStored_value_26_SLE_0_75_76_AND_NO_ETC___d283,
       NOT_wmemi_reqF_c_r_68_EQ_2_69_70_AND_NOT_wmemi_ETC___d302,
       NOT_wsiS_reqFifo_countReg_73_ULE_1_74___d675,
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, x_data__h20734 } ;
  ...
  assign MUX_mesgLength$write_1__VAL_3 = { 1'd1, mlp1__h17012[11:0], 2'd0 } ;
  ...
  assign MUX_rdSyncWord$write_1__VAL_2 =
	     rdSerPos != 2'd3 && x1__h22370[23:0] == 24'd0 ;
  ...
  always@(wrtSerPos or
	  ...
	  x1__h19422 or x1__h19431)
  begin
    case (wrtSerPos)
      2'd0: MUX_wide16Fa$enq_1__VAL_1 = x1__h19422;
      2'd1: MUX_wide16Fa$enq_1__VAL_1 = x1__h19431;
  ...
  always@(wrtSerPos or
	  ...
	  x1__h18899 or x1__h18908)
  begin
    case (wrtSerPos)
      2'd0: MUX_wide16Fa$enq_1__VAL_2 = x1__h18899;
      2'd1: MUX_wide16Fa$enq_1__VAL_2 = x1__h18908;
  ...
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_1 = { 4'd5, addr__h19924, 12'd1 } ;
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_2 = { 4'd3, addr__h20096, 12'd1 } ;
  ...
  assign mesgWF_wDataOut$wget = data__h18553 ;
  ...
  // register rdSerMeta
  assign rdSerMeta$D_IN = x1__h22370 ;
  ...
  assign wrtSerStage$D_IN =
	     MUX_wrtSerStage$write_1__SEL_1 ? data__h18553 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_1$D_IN =
	     MUX_wrtSerStage_1$write_1__SEL_1 ? data__h18553 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_2$D_IN =
	     MUX_wrtSerStage_2$write_1__SEL_1 ? data__h18553 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_3$D_IN =
	     MUX_wrtSerStage_3$write_1__SEL_1 ? data__h18553 : metaWF$D_OUT ;
  ...
  assign IF_wrtSerPos_22_EQ_2_25_THEN_0x0_ELSE_mesgWF_w_ETC___d364 =
	     { (wrtSerPos == 2'd2) ? 32'h0 : data__h18553,
	       (wrtSerPos == 2'd2) ? data__h18553 : wrtSerStage_2,
	       wrtSerStage_1,
	       wrtSerStage } ;
  ...
  assign NOT_wmemi_reqF_c_r_68_EQ_2_69_70_AND_NOT_wmemi_ETC___d302 =
	     wmemi_reqF_c_r != 2'd2 && wmemi_dhF_c_r != 2'd2 &&
	     wmemi_operateD &&
	     wmemi_peerIsReady ;
  assign NOT_wsiS_reqFifo_countReg_73_ULE_1_74___d675 =
	     wsiS_reqFifo_countReg > 2'd1 ;
  assign _dor1bytesWritten$EN_write =
	     WILL_FIRE_RL_wmwt_messagePushPrecise ||
	     WILL_FIRE_RL_wmwt_messagePushImprecise ;
  assign addr__h19924 = { 9'd0, x__h19982 } ;
  assign addr__h20096 = { 9'd0, x__h20141 } ;
  assign data__h18553 =
  ...
  assign rdat__h20761 = hasDebugLogic ? mesgWtCount : 32'd0 ;
  assign rdat__h20767 = hasDebugLogic ? mesgRdCount : 32'd0 ;
  assign rdat__h20774 = hasDebugLogic ? bytesWritten : 32'd0 ;
  assign rdat__h20780 = hasDebugLogic ? { 8'd0, x__h20784 } : 32'd0 ;
  assign rdat__h20904 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h20918 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h20926 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h20932 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h20946 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h20954 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h20960 = hasDebugLogic ? wmemiWrReq : 32'd0 ;
  assign rdat__h20966 = hasDebugLogic ? wmemiRdReq : 32'd0 ;
  assign rdat__h20972 = hasDebugLogic ? wmemiRdResp : 32'd0 ;
  assign rdat__h20978 =
	     hasDebugLogic ? { 9'd0, dlyWordsStored_value } : 32'd0 ;
  assign rdat__h20988 =
	     hasDebugLogic ? { 24'd0, dlyReadCredit_value } : 32'd0 ;
  assign rdat__h20998 = hasDebugLogic ? { 9'd0, dlyWAG } : 32'd0 ;
  assign rdat__h21008 = hasDebugLogic ? { 9'd0, dlyRAG } : 32'd0 ;
  ...
  assign wrtSerPos_22_PLUS_1___d960 = wrtSerPos + 2'd1 ;
  assign x1__h18899 = { 96'd0, data__h18553 } ;
  assign x1__h18908 = { 64'd0, data__h18553, wrtSerStage } ;
  assign x1__h19422 = { 96'd0, metaWF$D_OUT } ;
  assign x1__h19431 = { 64'd0, metaWF$D_OUT, wrtSerStage } ;
  ...
  assign x__h19982 = { dlyRAG, 4'h0 } ;
  assign x__h20141 = { dlyWAG, 4'h0 } ;
  assign x__h20784 = { wmemi_statusR, wsiS_statusR, wsiM_statusR } ;
  assign x_burstLength__h21393 =
	     (readMeta[23:0] == 24'd0) ? 12'd1 : readMeta[13:2] ;
  assign x_byteEn__h21394 = (readMeta[23:0] == 24'd0) ? 4'd0 : 4'd15 ;
  always@(rdSerPos or
	  rdSerStage_3 or wide16Fb$D_OUT or rdSerStage_1 or rdSerStage_2)
  begin
    case (rdSerPos)
      2'd0: x1__h22370 = wide16Fb$D_OUT[31:0];
      2'd1: x1__h22370 = rdSerStage_1;
      2'd2: x1__h22370 = rdSerStage_2;
      2'd3: x1__h22370 = rdSerStage_3;
    endcase
  end
  always@(wci_reqF$D_OUT or
	  ...
	  rdat__h20966 or
	  rdat__h20972 or
	  rdat__h20978 or rdat__h20988 or rdat__h20998 or rdat__h21008)
  begin
    case (wci_reqF$D_OUT[51:32])
      20'h0: x_data__h20734 = dlyCtrl;
      20'h00004: x_data__h20734 = dlyHoldoffBytes;
      20'h00008: x_data__h20734 = dlyHoldoffCycles;
      20'h0000C: x_data__h20734 = rdat__h20761;
      20'h00010: x_data__h20734 = rdat__h20767;
      20'h00014: x_data__h20734 = rdat__h20774;
      20'h00018: x_data__h20734 = rdat__h20780;
      20'h0001C: x_data__h20734 = 32'd0;
      20'h00020: x_data__h20734 = rdat__h20904;
      20'h00024: x_data__h20734 = rdat__h20918;
      20'h00028: x_data__h20734 = rdat__h20926;
      20'h0002C: x_data__h20734 = rdat__h20932;
      20'h00030: x_data__h20734 = rdat__h20946;
      20'h00034: x_data__h20734 = rdat__h20954;
      20'h00038: x_data__h20734 = rdat__h20960;
      20'h0003C: x_data__h20734 = rdat__h20966;
      20'h00040: x_data__h20734 = rdat__h20972;
      20'h00044: x_data__h20734 = rdat__h20978;
      20'h00048: x_data__h20734 = rdat__h20988;
      20'h0004C: x_data__h20734 = rdat__h20998;
      20'h00050: x_data__h20734 = rdat__h21008;
      default: x_data__h20734 = 32'd0;
    endcase
  end
