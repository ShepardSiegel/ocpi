...
//
// On Mon Jun 21 11:40:09 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker4B(wciS0_Clk,
  ...
  reg [63 : 0] v__h17445,
	       ...
	       v__h2815,
	       v__h3714;
  reg [31 : 0] sendData__h23145, x_data__h21532;
  reg CASE_wrtSerPos_0b1_0_1_1_1_2_1_3_0b1__q1,
      IF_wrtSerPos_10_EQ_0_11_OR_wrtSerPos_10_EQ_1_1_ETC___d887;
  wire [127 : 0] IF_wrtSerPos_10_EQ_2_13_THEN_0x0_ELSE_mesgWF_w_ETC___d352,
		 ...
		 x1__h20220,
		 x1__h20229;
  wire [35 : 0] addr__h20722, addr__h20894;
  wire [31 : 0] data__h19351,
		mesg__h22074,
		rdat__h21575,
		rdat__h21758,
		rdat__h21766,
		...
		x__h15116,
		x__h16044;
  wire [26 : 0] x__h20780, x__h20939;
  wire [23 : 0] x1_length__h17138, x__h21578;
  ...
  wire [1 : 0] wrtSerPos_10_PLUS_1___d974;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, x_data__h21532 } ;
  ...
  assign MUX_wci_respF_q_1$write_1__VAL_1 =
	     (wci_respF_c_r == 2'd2) ?
	       MUX_wci_respF_q_0$write_1__VAL_2 :
	       34'h0AAAAAAAA ;
  assign MUX_mesgLength$write_1__VAL_3 = { 1'd1, mlp1__h17808[11:0], 2'd0 } ;
  ...
  assign MUX_metaWF$enq_1__VAL_1 = { x1_opcode__h17137, x1_length__h17138 } ;
  ...
  assign MUX_rdSyncWord$write_1__VAL_2 =
	     rdSerPos != 2'd3 && sendData__h23145[23:0] == 24'd0 ;
  ...
  always@(wrtSerPos or
	  ...
	  x1__h20220 or x1__h20229)
  begin
    case (wrtSerPos)
      2'd0: MUX_wide16Fa$enq_1__VAL_1 = x1__h20220;
      2'd1: MUX_wide16Fa$enq_1__VAL_1 = x1__h20229;
  ...
  always@(wrtSerPos or
	  ...
	  x1__h19697 or x1__h19706)
  begin
    case (wrtSerPos)
      2'd0: MUX_wide16Fa$enq_1__VAL_2 = x1__h19697;
      2'd1: MUX_wide16Fa$enq_1__VAL_2 = x1__h19706;
  ...
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_1 = { 4'd5, addr__h20722, 12'd1 } ;
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_2 = { 4'd3, addr__h20894, 12'd1 } ;
  ...
  assign MUX_wrtSerPos$write_1__VAL_1 =
	     (wrtSerUnroll == 16'd1) ? 2'd0 : wrtSerPos_10_PLUS_1___d974 ;
  assign MUX_wrtSerPos$write_1__VAL_2 =
	     (metaWF$D_OUT[23:0] == 24'd0) ?
	       2'd0 :
	       wrtSerPos_10_PLUS_1___d974 ;
  ...
  assign mesgWF_wDataOut$wget = data__h19351 ;
  ...
  assign mesgRF_wDataIn$wget = sendData__h23145 ;
  assign mesgRF_wDataIn$whas = CAN_FIRE_RL_rdSer_body ;
  assign mesgRF_wDataOut$wget = mesg__h22074 ;
  ...
  // register rdSerMeta
  assign rdSerMeta$D_IN = sendData__h23145 ;
  ...
  assign wrtSerStage$D_IN =
	     MUX_wrtSerStage$write_1__SEL_1 ? data__h19351 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_1$D_IN =
	     MUX_wrtSerStage_1$write_1__SEL_1 ? data__h19351 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_2$D_IN =
	     MUX_wrtSerStage_2$write_1__SEL_1 ? data__h19351 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_3$D_IN =
	     MUX_wrtSerStage_3$write_1__SEL_1 ? data__h19351 : metaWF$D_OUT ;
  ...
  // submodule metaRF
  assign metaRF$D_IN = sendData__h23145 ;
  ...
  assign IF_wrtSerPos_10_EQ_2_13_THEN_0x0_ELSE_mesgWF_w_ETC___d352 =
	     { (wrtSerPos == 2'd2) ? 32'h0 : data__h19351,
	       (wrtSerPos == 2'd2) ? data__h19351 : wrtSerStage_2,
	       wrtSerStage_1,
	       wrtSerStage } ;
  ...
  assign _dor1bytesWritten$EN_write =
	     WILL_FIRE_RL_wmwt_messagePushPrecise ||
	     WILL_FIRE_RL_wmwt_messagePushImprecise ;
  assign addr__h20722 = { 9'd0, x__h20780 } ;
  assign addr__h20894 = { 9'd0, x__h20939 } ;
  assign data__h19351 =
  ...
  assign rdat__h21575 = { 8'd0, x__h21578 } ;
  assign rdat__h21758 = { 9'd0, dlyWordsStored_value } ;
  assign rdat__h21766 = { 24'd0, dlyReadCredit_value } ;
  assign rdat__h21774 = { 9'd0, dlyWAG } ;
  assign rdat__h21782 = { 9'd0, dlyRAG } ;
  ...
  assign wrtSerPos_10_PLUS_1___d974 = wrtSerPos + 2'd1 ;
  assign x1__h19697 = { 96'd0, data__h19351 } ;
  assign x1__h19706 = { 64'd0, data__h19351, wrtSerStage } ;
  assign x1__h20220 = { 96'd0, metaWF$D_OUT } ;
  assign x1__h20229 = { 64'd0, metaWF$D_OUT, wrtSerStage } ;
  ...
  assign x__h16044 = CAN_FIRE_RL_rdSer_body ? sendData__h23145 : 32'd0 ;
  assign x__h17182 = mesgLength[14] ? mesgLength[13:0] : 14'd0 ;
  assign x__h20780 = { dlyRAG, 4'h0 } ;
  assign x__h20939 = { dlyWAG, 4'h0 } ;
  assign x__h21578 = { wmemi_statusR, wsiS_statusR, wsiM_statusR } ;
  ...
  always@(wci_reqF$D_OUT or
	  ...
	  wmemiRdReq or
	  wmemiRdResp or
	  rdat__h21758 or rdat__h21766 or rdat__h21774 or rdat__h21782)
  begin
    case (wci_reqF$D_OUT[51:32])
      20'h0: x_data__h21532 = dlyCtrl;
      20'h00004: x_data__h21532 = dlyHoldoffBytes;
      20'h00008: x_data__h21532 = dlyHoldoffCycles;
      20'h0000C: x_data__h21532 = mesgWtCount;
      20'h00010: x_data__h21532 = mesgRdCount;
      20'h00014: x_data__h21532 = bytesWritten;
      20'h00018: x_data__h21532 = rdat__h21575;
      20'h0001C: x_data__h21532 = 32'd0;
      20'h00020: x_data__h21532 = wsiS_extStatusW$wget[95:64];
      20'h00024: x_data__h21532 = wsiS_extStatusW$wget[63:32];
      20'h00028: x_data__h21532 = wsiS_extStatusW$wget[31:0];
      20'h0002C: x_data__h21532 = wsiM_extStatusW$wget[95:64];
      20'h00030: x_data__h21532 = wsiM_extStatusW$wget[63:32];
      20'h00034: x_data__h21532 = wsiM_extStatusW$wget[31:0];
      20'h00038: x_data__h21532 = wmemiWrReq;
      20'h0003C: x_data__h21532 = wmemiRdReq;
      20'h00040: x_data__h21532 = wmemiRdResp;
      20'h00044: x_data__h21532 = rdat__h21758;
      20'h00048: x_data__h21532 = rdat__h21766;
      20'h0004C: x_data__h21532 = rdat__h21774;
      20'h00050: x_data__h21532 = rdat__h21782;
      default: x_data__h21532 = 32'd0;
    endcase
  end
  always@(rdSerPos or
  ...
  begin
    case (rdSerPos)
      2'd0: sendData__h23145 = wide16Fb$D_OUT[31:0];
      2'd1: sendData__h23145 = rdSerStage_1;
      2'd2: sendData__h23145 = rdSerStage_2;
      2'd3: sendData__h23145 = rdSerStage_3;
    endcase
  end
