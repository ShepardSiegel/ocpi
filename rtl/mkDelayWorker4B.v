...
//
// On Wed Jun 23 09:36:10 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker4B(wciS0_Clk,
  ...
  wire [1 : 0] wrtSerPos_10_PLUS_1___d944;
  ...
  assign MUX_wrtSerPos$write_1__VAL_1 =
	     (wrtSerUnroll == 16'd1) ? 2'd0 : wrtSerPos_10_PLUS_1___d944 ;
  assign MUX_wrtSerPos$write_1__VAL_2 =
	     (metaWF$D_OUT[23:0] == 24'd0) ?
	       2'd0 :
	       wrtSerPos_10_PLUS_1___d944 ;
  ...
  assign wrtSerPos_10_PLUS_1___d944 = wrtSerPos + 2'd1 ;
