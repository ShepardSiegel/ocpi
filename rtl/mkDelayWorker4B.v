...
//
// On Mon Jun  7 12:26:30 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker4B(wciS0_Clk,
  ...
  reg [63 : 0] v__h17563,
	       ...
	       v__h2817,
	       v__h3716;
  reg [31 : 0] sendData__h23412, x_data__h21805;
  reg CASE_wrtSerPos_0b1_0_1_1_1_2_1_3_0b1__q1,
      IF_wrtSerPos_08_EQ_0_09_OR_wrtSerPos_08_EQ_1_1_ETC___d1004;
  wire [127 : 0] IF_wrtSerPos_08_EQ_2_11_THEN_0x0_ELSE_mesgWF_w_ETC___d350,
		 IF_wrtSerPos_08_EQ_2_11_THEN_0x0_ELSE_metaWF_f_ETC___d373,
		 x1__h19970,
		 x1__h19979,
		 x1__h20493,
		 x1__h20502;
  wire [35 : 0] addr__h20995, addr__h21167;
  wire [31 : 0] data__h19624,
		mesg__h22341,
		rdat__h21848,
		rdat__h22026,
		rdat__h22034,
		...
		x__h15234,
		x__h16160;
  wire [23 : 0] x1_length__h17256, x__h21053, x__h21212, x__h21851;
  wire [13 : 0] mlp1__h17955, x__h17300;
  wire [11 : 0] x_burstLength__h22432;
  wire [10 : 0] x__h15126, x__h16052;
  wire [7 : 0] x1_opcode__h17255;
  wire [3 : 0] x_byteEn__h22433;
  wire [1 : 0] wrtSerPos_08_PLUS_1___d954;
  wire NOT_dlyWordsStored_value_12_SLE_0_61_62_AND_NO_ETC___d269,
       NOT_mesgRF_rRdPtr_50_PLUS_512_91_EQ_mesgRF_rWr_ETC___d206,
       NOT_wsiS_reqFifo_countReg_91_ULE_1_92___d693,
       _dor1bytesWritten$EN_write,
       metaRF_RDY_enq__38_AND_NOT_rdSerEmpty_94_95_AN_ETC___d239,
       metaWF_RDY_deq__54_AND_NOT_wrtSerPos_08_EQ_3_1_ETC___d361,
       wci_cState_9_EQ_2_0_AND_dlyCtrl_4_BITS_3_TO_0__ETC___d393;
  ...
  assign CAN_FIRE_RL_delay_read_req =
	     ...
	     wci_cState == 3'd2 &&
	     dlyCtrl[3:0] == 4'h7 &&
	     NOT_dlyWordsStored_value_12_SLE_0_61_62_AND_NO_ETC___d269 &&
  ...
  assign MUX_mesgLength$write_1__VAL_3 = { 1'd1, mlp1__h17955[11:0], 2'd0 } ;
  assign MUX_mesgRdCount$write_1__VAL_1 = mesgRdCount + 32'd1 ;
  assign MUX_mesgWtCount$write_1__VAL_1 = mesgWtCount + 32'd1 ;
  assign MUX_metaWF$enq_1__VAL_1 = { x1_opcode__h17255, x1_length__h17256 } ;
  ...
  assign MUX_rdSyncWord$write_1__VAL_2 =
	     rdSerPos != 2'd3 && sendData__h23412[23:0] == 24'd0 ;
  ...
  always@(wrtSerPos or
	  IF_wrtSerPos_08_EQ_2_11_THEN_0x0_ELSE_metaWF_f_ETC___d373 or
	  x1__h20493 or x1__h20502)
  begin
    case (wrtSerPos)
      2'd0: MUX_wide16Fa$enq_1__VAL_1 = x1__h20493;
      2'd1: MUX_wide16Fa$enq_1__VAL_1 = x1__h20502;
      default: MUX_wide16Fa$enq_1__VAL_1 =
		   IF_wrtSerPos_08_EQ_2_11_THEN_0x0_ELSE_metaWF_f_ETC___d373;
    endcase
  end
  always@(wrtSerPos or
	  IF_wrtSerPos_08_EQ_2_11_THEN_0x0_ELSE_mesgWF_w_ETC___d350 or
	  x1__h19970 or x1__h19979)
  begin
    case (wrtSerPos)
      2'd0: MUX_wide16Fa$enq_1__VAL_2 = x1__h19970;
      2'd1: MUX_wide16Fa$enq_1__VAL_2 = x1__h19979;
      default: MUX_wide16Fa$enq_1__VAL_2 =
		   IF_wrtSerPos_08_EQ_2_11_THEN_0x0_ELSE_mesgWF_w_ETC___d350;
    endcase
  end
  ...
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_1 = { 4'd5, addr__h20995, 12'd1 } ;
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_2 = { 4'd3, addr__h21167, 12'd1 } ;
  ...
  assign MUX_wrtSerPos$write_1__VAL_1 =
	     (wrtSerUnroll == 16'd1) ? 2'd0 : wrtSerPos_08_PLUS_1___d954 ;
  assign MUX_wrtSerPos$write_1__VAL_2 =
	     (metaWF$D_OUT[23:0] == 24'd0) ?
	       2'd0 :
	       wrtSerPos_08_PLUS_1___d954 ;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, x_data__h21805 } ;
  ...
  assign mesgWF_wDataOut$wget = data__h19624 ;
  ...
  assign mesgRF_wDataIn$wget = sendData__h23412 ;
  assign mesgRF_wDataIn$whas = CAN_FIRE_RL_rdSer_body ;
  assign mesgRF_wDataOut$wget = mesg__h22341 ;
  ...
  assign mesgLengthSoFar$D_IN =
	     MUX_impreciseBurst$write_1__SEL_2 ? 14'd0 : mlp1__h17955 ;
  assign mesgLengthSoFar$EN =
	     WILL_FIRE_RL_wmwt_mesgBegin && !wsiS_reqFifo$D_OUT[56] ||
	     WILL_FIRE_RL_wmwt_messagePushImprecise ;

  // register mesgRF_rCache
  assign mesgRF_rCache$D_IN = { 1'd1, mesgRF_rWrPtr, x__h16160 } ;
  assign mesgRF_rCache$EN = CAN_FIRE_RL_rdSer_body ;

  // register mesgRF_rRdPtr
  assign mesgRF_rRdPtr$D_IN = x__h16052 ;
  ...
  // register mesgWF_rCache
  assign mesgWF_rCache$D_IN = { 1'd1, mesgWF_rWrPtr, x__h15234 } ;
  assign mesgWF_rCache$EN = mesgWF_pwEnqueue$whas ;

  // register mesgWF_rRdPtr
  assign mesgWF_rRdPtr$D_IN = x__h15126 ;
  ...
  // register rdSerMeta
  assign rdSerMeta$D_IN = sendData__h23412 ;
  ...
  assign wrtSerStage$D_IN =
	     MUX_wrtSerStage$write_1__SEL_1 ? data__h19624 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_1$D_IN =
	     MUX_wrtSerStage_1$write_1__SEL_1 ? data__h19624 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_2$D_IN =
	     MUX_wrtSerStage_2$write_1__SEL_1 ? data__h19624 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_3$D_IN =
	     MUX_wrtSerStage_3$write_1__SEL_1 ? data__h19624 : metaWF$D_OUT ;
  ...
  assign mesgRF_memory$DIA = x__h16160 ;
  ...
  assign mesgWF_memory$DIA = x__h15234 ;
  ...
  // submodule metaRF
  assign metaRF$D_IN = sendData__h23412 ;
  ...
  // remaining internal signals
  assign IF_wrtSerPos_08_EQ_2_11_THEN_0x0_ELSE_mesgWF_w_ETC___d350 =
	     { (wrtSerPos == 2'd2) ? 32'h0 : data__h19624,
	       (wrtSerPos == 2'd2) ? data__h19624 : wrtSerStage_2,
	       wrtSerStage_1,
	       wrtSerStage } ;
  assign IF_wrtSerPos_08_EQ_2_11_THEN_0x0_ELSE_metaWF_f_ETC___d373 =
	     { (wrtSerPos == 2'd2) ? 32'h0 : metaWF$D_OUT,
	       (wrtSerPos == 2'd2) ? metaWF$D_OUT : wrtSerStage_2,
	       wrtSerStage_1,
	       wrtSerStage } ;
  assign NOT_dlyWordsStored_value_12_SLE_0_61_62_AND_NO_ETC___d269 =
	     (dlyWordsStored_value ^ 20'h80000) > 20'd524288 &&
	     dlyHoldoffBytes >= bytesWritten &&
	     dlyHoldoffCycles >= cyclesPassed ;
  assign NOT_mesgRF_rRdPtr_50_PLUS_512_91_EQ_mesgRF_rWr_ETC___d206 =
	     mesgRF_rRdPtr + 11'd512 != mesgRF_rWrPtr &&
	     (!rdSerEmpty && rdSerPos != 2'd0 || wide16Fb$EMPTY_N) ;
  assign NOT_wsiS_reqFifo_countReg_91_ULE_1_92___d693 =
	     wsiS_reqFifo_countReg > 2'd1 ;
  assign _dor1bytesWritten$EN_write =
	     WILL_FIRE_RL_wmwt_messagePushPrecise ||
	     WILL_FIRE_RL_wmwt_messagePushImprecise ;
  assign addr__h20995 = { 12'd0, x__h21053 } ;
  assign addr__h21167 = { 12'd0, x__h21212 } ;
  assign data__h19624 =
  ...
  assign mesg__h22341 =
	     (mesgRF_rCache[43] && mesgRF_rCache[42:32] == mesgRF_rRdPtr) ?
	       mesgRF_rCache[31:0] :
	       mesgRF_memory$DOB ;
  assign metaRF_RDY_enq__38_AND_NOT_rdSerEmpty_94_95_AN_ETC___d239 =
	     metaRF$FULL_N &&
	     (!rdSerEmpty && rdSerPos != 2'd0 || wide16Fb$EMPTY_N) ;
  assign metaWF_RDY_deq__54_AND_NOT_wrtSerPos_08_EQ_3_1_ETC___d361 =
	     metaWF$EMPTY_N &&
	     (wrtSerPos != 2'd3 && metaWF$D_OUT[23:0] != 24'd0 ||
	      IF_wrtSerPos_08_EQ_0_09_OR_wrtSerPos_08_EQ_1_1_ETC___d1004) ;
  assign mlp1__h17955 = mesgLengthSoFar + 14'd1 ;
  assign rdat__h21848 = { 8'd0, x__h21851 } ;
  assign rdat__h22026 = { 12'd0, dlyWordsStored_value } ;
  assign rdat__h22034 = { 24'd0, dlyReadCredit_value } ;
  assign rdat__h22042 = { 12'd0, dlyWAG } ;
  assign rdat__h22050 = { 12'd0, dlyRAG } ;
  assign wci_cState_9_EQ_2_0_AND_dlyCtrl_4_BITS_3_TO_0__ETC___d393 =
	     wci_cState == 3'd2 && dlyCtrl[3:0] == 4'h7 && mesgLength[14] &&
	     !doAbort &&
	     (preciseBurst && wsiWordsRemain == 12'd0 ||
	      impreciseBurst && endOfMessage) ;
  assign wrtSerPos_08_PLUS_1___d954 = wrtSerPos + 2'd1 ;
  assign x1__h19970 = { 96'd0, data__h19624 } ;
  assign x1__h19979 = { 64'd0, data__h19624, wrtSerStage } ;
  assign x1__h20493 = { 96'd0, metaWF$D_OUT } ;
  assign x1__h20502 = { 64'd0, metaWF$D_OUT, wrtSerStage } ;
  assign x1_length__h17256 = { 10'd0, x__h17300 } ;
  assign x1_opcode__h17255 = opcode[8] ? opcode[7:0] : 8'd0 ;
  assign x__h15126 = mesgWF_rRdPtr + 11'd1 ;
  assign x__h15234 =
	     mesgWF_pwEnqueue$whas ? wsiS_reqFifo$D_OUT[43:12] : 32'd0 ;
  assign x__h16052 = mesgRF_rRdPtr + 11'd1 ;
  assign x__h16160 = CAN_FIRE_RL_rdSer_body ? sendData__h23412 : 32'd0 ;
  assign x__h17300 = mesgLength[14] ? mesgLength[13:0] : 14'd0 ;
  assign x__h21053 = { dlyRAG, 4'h0 } ;
  assign x__h21212 = { dlyWAG, 4'h0 } ;
  assign x__h21851 = { wmemi_statusR, wsiS_statusR, wsiM_statusR } ;
  assign x_burstLength__h22432 =
	     (readMeta[23:0] == 24'd0) ? 12'd1 : readMeta[13:2] ;
  assign x_byteEn__h22433 = (readMeta[23:0] == 24'd0) ? 4'd0 : 4'd15 ;
  always@(rdSerPos or
	  rdSerStage_3 or wide16Fb$D_OUT or rdSerStage_1 or rdSerStage_2)
  begin
    case (rdSerPos)
      2'd0: sendData__h23412 = wide16Fb$D_OUT[31:0];
      2'd1: sendData__h23412 = rdSerStage_1;
      2'd2: sendData__h23412 = rdSerStage_2;
      2'd3: sendData__h23412 = rdSerStage_3;
    endcase
  end
  ...
  always@(wci_reqF$D_OUT or
	  ...
	  wmemiRdReq or
	  wmemiRdResp or
	  rdat__h22026 or rdat__h22034 or rdat__h22042 or rdat__h22050)
  begin
    case (wci_reqF$D_OUT[51:32])
      20'h0: x_data__h21805 = dlyCtrl;
      20'h00004: x_data__h21805 = dlyHoldoffBytes;
      20'h00008: x_data__h21805 = dlyHoldoffCycles;
      20'h0000C: x_data__h21805 = mesgWtCount;
      20'h00010: x_data__h21805 = mesgRdCount;
      20'h00014: x_data__h21805 = bytesWritten;
      20'h00018: x_data__h21805 = rdat__h21848;
      20'h00020: x_data__h21805 = wsiS_extStatusW$wget[95:64];
      20'h00024: x_data__h21805 = wsiS_extStatusW$wget[63:32];
      20'h00028: x_data__h21805 = wsiS_extStatusW$wget[31:0];
      20'h0002C: x_data__h21805 = wsiM_extStatusW$wget[95:64];
      20'h00030: x_data__h21805 = wsiM_extStatusW$wget[63:32];
      20'h00034: x_data__h21805 = wsiM_extStatusW$wget[31:0];
      20'h00038: x_data__h21805 = wmemiWrReq;
      20'h0003C: x_data__h21805 = wmemiRdReq;
      20'h00040: x_data__h21805 = wmemiRdResp;
      20'h00044: x_data__h21805 = rdat__h22026;
      20'h00048: x_data__h21805 = rdat__h22034;
      20'h0004C: x_data__h21805 = rdat__h22042;
      20'h00050: x_data__h21805 = rdat__h22050;
      default: x_data__h21805 = 32'd0;
    endcase
  end
  ...
  begin
    ...
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wmwt_doAbort)
	$display("[%0d]: %m: wmwt_doAbort", v__h17808);
    if (wciS0_MReset_n)
