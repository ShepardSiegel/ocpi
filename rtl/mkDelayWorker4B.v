...
//
// On Tue Jun  1 06:19:47 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker4B(wciS0_Clk,
  ...
  assign MUX_metaWF$enq_1__VAL_2 = { x1_opcode__h16255, x1_length__h16256 } ;
  ...
  assign metaRF_RDY_enq__03_AND_NOT_rdSerEmpty_69_70_AN_ETC___d204 =
	     metaRF$FULL_N &&
	     (!rdSerEmpty && rdSerPos != 2'd0 || wide16F$EMPTY_N) ;
  assign mlp1__h16955 = MUX_mesgLengthSoFar$write_1__VAL_2 ;
