...
//
// On Sun Jun  6 14:12:16 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker4B(wciS0_Clk,
  ...
  reg CASE_wrtSerPos_0b1_0_1_1_1_2_1_3_0b1__q1,
      IF_wrtSerPos_00_EQ_0_01_OR_wrtSerPos_00_EQ_1_0_ETC___d991;
  ...
  wire [1 : 0] wrtSerPos_00_PLUS_1___d929;
  ...
  assign MUX_wrtSerPos$write_1__VAL_1 =
	     (wrtSerUnroll == 16'd1) ? 2'd0 : wrtSerPos_00_PLUS_1___d929 ;
  assign MUX_wrtSerPos$write_1__VAL_2 =
	     (metaWF$D_OUT[23:0] == 24'd0) ?
	       2'd0 :
	       wrtSerPos_00_PLUS_1___d929 ;
  ...
  assign mesgLengthSoFar$D_IN =
	     MUX_impreciseBurst$write_1__SEL_2 ? 14'd0 : mlp1__h17829 ;
  ...
  assign metaWF_RDY_deq__46_AND_NOT_wrtSerPos_00_EQ_3_0_ETC___d353 =
	     ...
	     (wrtSerPos != 2'd3 && metaWF$D_OUT[23:0] != 24'd0 ||
	      IF_wrtSerPos_00_EQ_0_01_OR_wrtSerPos_00_EQ_1_0_ETC___d991) ;
  assign mlp1__h17829 = mesgLengthSoFar + 14'd1 ;
  ...
  assign wrtSerPos_00_PLUS_1___d929 = wrtSerPos + 2'd1 ;
