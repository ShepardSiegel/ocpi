...
//
// On Wed Jul 14 09:20:00 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker4B(wciS0_Clk,
  ...
  reg [63 : 0] v__h17681,
	       ...
	       v__h2822,
	       v__h3721;
  reg [31 : 0] x1__h24157, x_data__h22452;
  reg CASE_wrtSerPos_0b1_0_1_1_1_2_1_3_0b1__q2,
      CASE_wrtSerPos_NOT_wrtSerPos_EQ_3_OR_wide16Fa_ETC__q1;
  wire [127 : 0] IF_wrtSerPos_68_EQ_2_71_THEN_0x0_ELSE_mesgWF_w_ETC___d411,
		 IF_wrtSerPos_68_EQ_2_71_THEN_0x0_ELSE_metaWF_f_ETC___d436,
		 x1__h20075,
		 x1__h20106,
		 x1__h20771,
		 x1__h20798;
  wire [35 : 0] addr__h21450, addr__h21750;
  wire [31 : 0] data__h19654,
		rdat__h22479,
		rdat__h22485,
		rdat__h22492,
		rdat__h22498,
		...
		rdat__h22736,
		x__h15359;
  wire [26 : 0] x__h21508, x__h21795;
  wire [23 : 0] x1_length__h17374, x__h22502;
  wire [13 : 0] mlp1__h18075, x__h17418;
  wire [12 : 0] x__h15251;
  wire [11 : 0] x_burstLength__h23180;
  wire [7 : 0] x1_opcode__h17373;
  wire [3 : 0] x_byteEn__h23181;
  wire [1 : 0] wrtSerPos_68_PLUS_1___d1038;
  wire IF_wrtSerPos_68_EQ_0_69_OR_wrtSerPos_68_EQ_1_7_ETC___d388,
       NOT_wrtSerPos_68_EQ_3_75_76_AND_NOT_metaWF_fir_ETC___d423,
       _dor1bytesWritten$EN_write,
       bytesWritten_7_ULT_dlyHoldoffBytes_7___d300,
       cyclesPassed_03_ULT_dlyHoldoffCycles_9___d304,
       dlyWordsStored_value_27_SLE_0___d298,
       mesgRF_RDY_enq__18_AND_NOT_rdSerEmpty_19_20_AN_ETC___d231,
       metaRF_RDY_enq__63_AND_NOT_rdSerEmpty_19_20_AN_ETC___d264,
       wci_cState_9_EQ_2_0_AND_dlyCtrl_5_BITS_3_TO_0__ETC___d307,
       wci_cState_9_EQ_2_0_AND_dlyCtrl_5_BITS_3_TO_0__ETC___d344,
       wci_cState_9_EQ_2_0_AND_dlyCtrl_5_BITS_3_TO_0__ETC___d353,
       wci_cState_9_EQ_2_0_AND_dlyCtrl_5_BITS_3_TO_0__ETC___d456,
       wsiS_reqFifo_notFull__54_AND_wsiS_burstKind_34_ETC___d770;
  ...
  assign CAN_FIRE_RL_wrtSer_body =
	     ...
	     IF_wrtSerPos_68_EQ_0_69_OR_wrtSerPos_68_EQ_1_7_ETC___d388 &&
	     wci_cState == 3'd2 &&
	     dlyCtrl[3:0] == 4'h7 &&
	     wrtSerUnroll != 16'd0 ;
  ...
  assign MUX_mesgLength$write_1__VAL_3 = { 1'd1, mlp1__h18075[11:0], 2'd0 } ;
  assign MUX_mesgRdCount$write_1__VAL_1 = mesgRdCount + 32'd1 ;
  assign MUX_metaWF$enq_1__VAL_2 = { x1_opcode__h17373, x1_length__h17374 } ;
  ...
  assign MUX_rdSyncWord$write_1__VAL_2 =
	     rdSerPos != 2'd3 && x1__h24157[23:0] == 24'd0 ;
  ...
  always@(wrtSerPos or
	  IF_wrtSerPos_68_EQ_2_71_THEN_0x0_ELSE_metaWF_f_ETC___d436 or
	  x1__h20771 or x1__h20798)
  begin
    case (wrtSerPos)
      2'd0: MUX_wide16Fa$enq_1__VAL_1 = x1__h20771;
      2'd1: MUX_wide16Fa$enq_1__VAL_1 = x1__h20798;
      default: MUX_wide16Fa$enq_1__VAL_1 =
		   IF_wrtSerPos_68_EQ_2_71_THEN_0x0_ELSE_metaWF_f_ETC___d436;
    endcase
  end
  always@(wrtSerPos or
	  IF_wrtSerPos_68_EQ_2_71_THEN_0x0_ELSE_mesgWF_w_ETC___d411 or
	  x1__h20075 or x1__h20106)
  begin
    case (wrtSerPos)
      2'd0: MUX_wide16Fa$enq_1__VAL_2 = x1__h20075;
      2'd1: MUX_wide16Fa$enq_1__VAL_2 = x1__h20106;
      default: MUX_wide16Fa$enq_1__VAL_2 =
		   IF_wrtSerPos_68_EQ_2_71_THEN_0x0_ELSE_mesgWF_w_ETC___d411;
    endcase
  end
  ...
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_1 = { 4'd5, addr__h21450, 12'd1 } ;
  assign MUX_wrtSerPos$write_1__VAL_1 =
	     (wrtSerUnroll == 16'd1) ? 2'd0 : wrtSerPos_68_PLUS_1___d1038 ;
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_2 = { 4'd3, addr__h21750, 12'd1 } ;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, x_data__h22452 } ;
  ...
  assign mesgWF_wDataOut$wget = data__h19654 ;
  ...
  assign dlyRdOpOther$EN =
	     WILL_FIRE_RL_rdSer_begin && x1__h24157[31:24] != 8'd0 ;
  ...
  assign mesgLengthSoFar$D_IN =
	     MUX_impreciseBurst$write_1__SEL_2 ? 14'd0 : mlp1__h18075 ;
  ...
  // register mesgWF_rCache
  assign mesgWF_rCache$D_IN = { 1'd1, mesgWF_rWrPtr, x__h15359 } ;
  assign mesgWF_rCache$EN = mesgWF_pwEnqueue$whas ;

  // register mesgWF_rRdPtr
  assign mesgWF_rRdPtr$D_IN = x__h15251 ;
  ...
  // register rdSerMeta
  assign rdSerMeta$D_IN = x1__h24157 ;
  ...
  assign wrtSerStage$D_IN =
	     MUX_wrtSerStage$write_1__SEL_1 ? data__h19654 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_1$D_IN =
	     MUX_wrtSerStage_1$write_1__SEL_1 ? data__h19654 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_2$D_IN =
	     MUX_wrtSerStage_2$write_1__SEL_1 ? data__h19654 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_3$D_IN =
	     MUX_wrtSerStage_3$write_1__SEL_1 ? data__h19654 : metaWF$D_OUT ;
  ...
  // remaining internal signals
  assign IF_wrtSerPos_68_EQ_0_69_OR_wrtSerPos_68_EQ_1_7_ETC___d388 =
	     CASE_wrtSerPos_0b1_0_1_1_1_2_1_3_0b1__q2 &&
	     (wrtSerPos != 2'd3 && wrtSerUnroll != 16'd1 ||
	      CASE_wrtSerPos_NOT_wrtSerPos_EQ_3_OR_wide16Fa_ETC__q1) ;
  assign IF_wrtSerPos_68_EQ_2_71_THEN_0x0_ELSE_mesgWF_w_ETC___d411 =
	     { (wrtSerPos == 2'd2) ? 32'h0 : data__h19654,
	       (wrtSerPos == 2'd2) ? data__h19654 : wrtSerStage_2,
	       wrtSerStage_1,
	       wrtSerStage } ;
  assign IF_wrtSerPos_68_EQ_2_71_THEN_0x0_ELSE_metaWF_f_ETC___d436 =
	     { (wrtSerPos == 2'd2) ? 32'h0 : metaWF$D_OUT,
	       (wrtSerPos == 2'd2) ? metaWF$D_OUT : wrtSerStage_2,
	       wrtSerStage_1,
	       wrtSerStage } ;
  assign NOT_wrtSerPos_68_EQ_3_75_76_AND_NOT_metaWF_fir_ETC___d423 =
	     wrtSerPos != 2'd3 && metaWF$D_OUT[23:0] != 24'd0 ||
	     CASE_wrtSerPos_NOT_wrtSerPos_EQ_3_OR_wide16Fa_ETC__q1 ;
  assign _dor1bytesWritten$EN_write =
	     WILL_FIRE_RL_wmwt_messagePushPrecise ||
	     WILL_FIRE_RL_wmwt_messagePushImprecise ;
  assign addr__h21450 = { 9'd0, x__h21508 } ;
  assign addr__h21750 = { 9'd0, x__h21795 } ;
  assign bytesWritten_7_ULT_dlyHoldoffBytes_7___d300 =
	     bytesWritten < dlyHoldoffBytes ;
  assign cyclesPassed_03_ULT_dlyHoldoffCycles_9___d304 =
	     cyclesPassed < dlyHoldoffCycles ;
  assign data__h19654 =
	     (mesgWF_rCache[45] && mesgWF_rCache[44:32] == mesgWF_rRdPtr) ?
	       mesgWF_rCache[31:0] :
	       mesgWF_memory$DOB ;
  assign dlyWordsStored_value_27_SLE_0___d298 =
	     (dlyWordsStored_value ^ 25'h1000000) <= 25'd16777216 ;
  assign mesgRF_RDY_enq__18_AND_NOT_rdSerEmpty_19_20_AN_ETC___d231 =
	     mesgRF$FULL_N &&
	     (!rdSerEmpty && rdSerPos != 2'd0 || wide16Fc$EMPTY_N) ;
  assign metaRF_RDY_enq__63_AND_NOT_rdSerEmpty_19_20_AN_ETC___d264 =
	     metaRF$FULL_N &&
	     (!rdSerEmpty && rdSerPos != 2'd0 || wide16Fc$EMPTY_N) ;
  assign mlp1__h18075 = mesgLengthSoFar + 14'd1 ;
  assign rdat__h22479 = hasDebugLogic ? mesgWtCount : 32'd0 ;
  assign rdat__h22485 = hasDebugLogic ? mesgRdCount : 32'd0 ;
  assign rdat__h22492 = hasDebugLogic ? bytesWritten : 32'd0 ;
  assign rdat__h22498 = hasDebugLogic ? { 8'd0, x__h22502 } : 32'd0 ;
  assign rdat__h22622 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h22636 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h22644 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h22650 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h22664 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h22672 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h22678 = hasDebugLogic ? wmemiWrReq : 32'd0 ;
  assign rdat__h22684 = hasDebugLogic ? wmemiRdReq : 32'd0 ;
  assign rdat__h22690 = hasDebugLogic ? wmemiRdResp : 32'd0 ;
  assign rdat__h22696 =
	     hasDebugLogic ? { 7'd0, dlyWordsStored_value } : 32'd0 ;
  assign rdat__h22706 =
	     hasDebugLogic ? { 24'd0, dlyReadCredit_value } : 32'd0 ;
  assign rdat__h22716 = hasDebugLogic ? { 9'd0, dlyWAG } : 32'd0 ;
  assign rdat__h22726 = hasDebugLogic ? { 9'd0, dlyRAG } : 32'd0 ;
  assign rdat__h22736 = { {24{dlyMaxReadCredit[7]}}, dlyMaxReadCredit } ;
  assign wci_cState_9_EQ_2_0_AND_dlyCtrl_5_BITS_3_TO_0__ETC___d307 =
	     wci_cState == 3'd2 && dlyCtrl[3:0] == 4'h7 &&
	     !dlyWordsStored_value_27_SLE_0___d298 &&
	     !bytesWritten_7_ULT_dlyHoldoffBytes_7___d300 &&
	     !cyclesPassed_03_ULT_dlyHoldoffCycles_9___d304 ;
  assign wci_cState_9_EQ_2_0_AND_dlyCtrl_5_BITS_3_TO_0__ETC___d344 =
	     wci_cState == 3'd2 && dlyCtrl[3:0] == 4'h7 &&
	     ((dlyWriteJustFired || dlyWriteFlush == 8'd255) ?
		(dlyReadyToWrite_value ^ 5'h10) > 5'd16 :
		(dlyReadyToWrite_value ^ 5'h10) > 5'd23) ;
  assign wci_cState_9_EQ_2_0_AND_dlyCtrl_5_BITS_3_TO_0__ETC___d353 =
	     wci_cState_9_EQ_2_0_AND_dlyCtrl_5_BITS_3_TO_0__ETC___d344 &&
	     ...
	     (dlyWordsStored_value_27_SLE_0___d298 ||
	      ...
	      cyclesPassed_03_ULT_dlyHoldoffCycles_9___d304 ||
	      wsiM_reqFifo_c_r == 2'd2) ;
  assign wci_cState_9_EQ_2_0_AND_dlyCtrl_5_BITS_3_TO_0__ETC___d456 =
	     wci_cState == 3'd2 && dlyCtrl[3:0] == 4'h7 && mesgLength[14] &&
	     !doAbort &&
	     (preciseBurst && wsiWordsRemain == 12'd0 ||
	      impreciseBurst && endOfMessage) ;
  assign wrtSerPos_68_PLUS_1___d1038 = wrtSerPos + 2'd1 ;
  assign wsiS_reqFifo_notFull__54_AND_wsiS_burstKind_34_ETC___d770 =
	     wsiS_reqFifo$FULL_N &&
	     (wsiS_burstKind == 2'd0 ||
	      (wsiS_burstKind == 2'd1 || wsiS_burstKind == 2'd2) &&
	      wsiS_wsiReq$wget[57]) ;
  assign x1__h20075 = { 96'd0, data__h19654 } ;
  assign x1__h20106 = { 64'd0, data__h19654, wrtSerStage } ;
  assign x1__h20771 = { 96'd0, metaWF$D_OUT } ;
  assign x1__h20798 = { 64'd0, metaWF$D_OUT, wrtSerStage } ;
  assign x1_length__h17374 = { 10'd0, x__h17418 } ;
  assign x1_opcode__h17373 = opcode[8] ? opcode[7:0] : 8'd0 ;
  assign x__h15251 = mesgWF_rRdPtr + 13'd1 ;
  assign x__h15359 =
	     mesgWF_pwEnqueue$whas ? wsiS_reqFifo$D_OUT[43:12] : 32'd0 ;
  assign x__h17418 = mesgLength[14] ? mesgLength[13:0] : 14'd0 ;
  assign x__h21508 = { dlyRAG, 4'h0 } ;
  assign x__h21795 = { dlyWAG, 4'h0 } ;
  assign x__h22502 = { wmemi_statusR, wsiS_statusR, wsiM_statusR } ;
  assign x_burstLength__h23180 =
	     (readMeta[23:0] == 24'd0) ? 12'd1 : readMeta[13:2] ;
  assign x_byteEn__h23181 = (readMeta[23:0] == 24'd0) ? 4'd0 : 4'd15 ;
  always@(rdSerPos or
	  rdSerStage_3 or wide16Fc$D_OUT or rdSerStage_1 or rdSerStage_2)
  begin
    case (rdSerPos)
      2'd0: x1__h24157 = wide16Fc$D_OUT[31:0];
      2'd1: x1__h24157 = rdSerStage_1;
      2'd2: x1__h24157 = rdSerStage_2;
      2'd3: x1__h24157 = rdSerStage_3;
    endcase
  end
  ...
  always@(wci_reqF$D_OUT or
	  ...
	  rdat__h22706 or
	  rdat__h22716 or
	  rdat__h22726 or rdat__h22736 or dlyRdOpZero or dlyRdOpOther)
  begin
    case (wci_reqF$D_OUT[51:32])
      20'h0: x_data__h22452 = dlyCtrl;
      20'h00004: x_data__h22452 = dlyHoldoffBytes;
      20'h00008: x_data__h22452 = dlyHoldoffCycles;
      20'h0000C: x_data__h22452 = rdat__h22479;
      20'h00010: x_data__h22452 = rdat__h22485;
      20'h00014: x_data__h22452 = rdat__h22492;
      20'h00018: x_data__h22452 = rdat__h22498;
      20'h0001C: x_data__h22452 = 32'd0;
      20'h00020: x_data__h22452 = rdat__h22622;
      20'h00024: x_data__h22452 = rdat__h22636;
      20'h00028: x_data__h22452 = rdat__h22644;
      20'h0002C: x_data__h22452 = rdat__h22650;
      20'h00030: x_data__h22452 = rdat__h22664;
      20'h00034: x_data__h22452 = rdat__h22672;
      20'h00038: x_data__h22452 = rdat__h22678;
      20'h0003C: x_data__h22452 = rdat__h22684;
      20'h00040: x_data__h22452 = rdat__h22690;
      20'h00044: x_data__h22452 = rdat__h22696;
      20'h00048: x_data__h22452 = rdat__h22706;
      20'h0004C: x_data__h22452 = rdat__h22716;
      20'h00050: x_data__h22452 = rdat__h22726;
      20'h00054: x_data__h22452 = rdat__h22736;
      20'h00058: x_data__h22452 = dlyRdOpZero;
      20'h0005C: x_data__h22452 = dlyRdOpOther;
      default: x_data__h22452 = 32'd0;
    endcase
  end
  ...
  begin
    ...
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wmwt_doAbort)
	$display("[%0d]: %m: wmwt_doAbort", v__h17897);
    if (wciS0_MReset_n)
