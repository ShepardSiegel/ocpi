...
//
// On Tue Jul 20 14:07:26 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker4B(wciS0_Clk,
  ...
  reg [63 : 0] v__h21659, v__h2673, v__h2820, v__h3719;
  reg [31 : 0] x1__h20511, x_data__h21791;
  ...
  wire [127 : 0] IF_wrtSerPos_80_EQ_2_83_THEN_0x0_ELSE_mesgWF_w_ETC___d423,
		 IF_wrtSerPos_80_EQ_2_83_THEN_0x0_ELSE_metaWF_f_ETC___d448,
		 x1__h17684,
		 x1__h17715,
		 x1__h18350,
		 x1__h18377;
  wire [35 : 0] addr__h19034, addr__h19202;
  wire [31 : 0] data__h17263,
		delayStatus__h21360,
		rdat__h21818,
		rdat__h21824,
		rdat__h21830,
		...
		rdat__h22151,
		x__h14850;
  wire [26 : 0] x__h19092, x__h19247;
  wire [23 : 0] mesgMetaF_length__h16642, x__h21840;
  wire [15 : 0] x__h16649, x__h16751;
  wire [12 : 0] x__h14742;
  wire [11 : 0] x_burstLength__h19533;
  wire [3 : 0] x_byteEn__h19534;
  wire [1 : 0] wrtSerPos_80_PLUS_1___d985;
  wire IF_wrtSerPos_80_EQ_0_81_OR_wrtSerPos_80_EQ_1_8_ETC___d400,
       NOT_mesgWF_rRdPtr_65_EQ_mesgWF_rWrPtr_67_70___d171,
       NOT_mesgWF_rRdPtr_65_PLUS_2048_66_EQ_mesgWF_rW_ETC___d169,
       NOT_wrtSerPos_80_EQ_3_87_88_AND_NOT_metaWF_fir_ETC___d435,
       ...
       wordsEnqued_52_EQ_wordsExact_53_MINUS_1_54___d912,
       wsiS_reqFifo_notFull__06_AND_wsiS_burstKind_86_ETC___d722;
  ...
  assign CAN_FIRE_RL_wrtSer_body =
	     NOT_mesgWF_rRdPtr_65_EQ_mesgWF_rWrPtr_67_70___d171 &&
	     IF_wrtSerPos_80_EQ_0_81_OR_wrtSerPos_80_EQ_1_8_ETC___d400 &&
	     wci_cState == 3'd2 &&
	     dlyCtrl[3:0] == 4'h7 &&
	     wrtSerUnroll != 16'd0 ;
  ...
  assign MUX_rdSyncWord$write_1__VAL_2 =
	     rdSerPos != 2'd3 && x1__h20511[23:0] == 24'd0 ;
  ...
  always@(wrtSerPos or
	  IF_wrtSerPos_80_EQ_2_83_THEN_0x0_ELSE_metaWF_f_ETC___d448 or
	  x1__h18350 or x1__h18377)
  begin
    case (wrtSerPos)
      2'd0: MUX_wide16Fa$enq_1__VAL_1 = x1__h18350;
      2'd1: MUX_wide16Fa$enq_1__VAL_1 = x1__h18377;
  ...
  always@(wrtSerPos or
	  ...
	  x1__h17684 or x1__h17715)
  begin
    case (wrtSerPos)
      2'd0: MUX_wide16Fa$enq_1__VAL_2 = x1__h17684;
      2'd1: MUX_wide16Fa$enq_1__VAL_2 = x1__h17715;
  ...
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_1 = { 4'd5, addr__h19034, 12'd1 } ;
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_2 = { 4'd3, addr__h19202, 12'd1 } ;
  ...
  assign MUX_wrtSerPos$write_1__VAL_1 =
	     (wrtSerUnroll == 16'd1) ? 2'd0 : wrtSerPos_80_PLUS_1___d985 ;
  assign MUX_wrtSerPos$write_1__VAL_2 =
	     (metaWF$D_OUT[23:0] == 24'd0) ?
	       2'd0 :
	       wrtSerPos_80_PLUS_1___d985 ;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, x_data__h21791 } ;
  ...
  assign mesgWF_wDataOut$wget = data__h17263 ;
  ...
  assign dlyRdOpOther$EN =
	     WILL_FIRE_RL_rdSer_begin && x1__h20511[31:24] != 8'd0 ;
  ...
  // register mesgWF_rCache
  assign mesgWF_rCache$D_IN = { 1'd1, mesgWF_rWrPtr, x__h14850 } ;
  assign mesgWF_rCache$EN = CAN_FIRE_RL_wmwt_mesg_ingress ;

  // register mesgWF_rRdPtr
  assign mesgWF_rRdPtr$D_IN = x__h14742 ;
  ...
  // register rdSerMeta
  assign rdSerMeta$D_IN = x1__h20511 ;
  ...
  assign wrtSerStage$D_IN =
	     MUX_wrtSerStage$write_1__SEL_1 ? data__h17263 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_1$D_IN =
	     MUX_wrtSerStage_1$write_1__SEL_1 ? data__h17263 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_2$D_IN =
	     MUX_wrtSerStage_2$write_1__SEL_1 ? data__h17263 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_3$D_IN =
	     MUX_wrtSerStage_3$write_1__SEL_1 ? data__h17263 : metaWF$D_OUT ;
  ...
  // remaining internal signals
  assign IF_wrtSerPos_80_EQ_0_81_OR_wrtSerPos_80_EQ_1_8_ETC___d400 =
	     CASE_wrtSerPos_0b1_0_1_1_1_2_1_3_0b1__q1 &&
	     (wrtSerPos != 2'd3 && wrtSerUnroll != 16'd1 ||
	      CASE_wrtSerPos_NOT_wrtSerPos_EQ_3_OR_wide16Fa_ETC__q2) ;
  assign IF_wrtSerPos_80_EQ_2_83_THEN_0x0_ELSE_mesgWF_w_ETC___d423 =
	     { (wrtSerPos == 2'd2) ? 32'h0 : data__h17263,
	       (wrtSerPos == 2'd2) ? data__h17263 : wrtSerStage_2,
	       wrtSerStage_1,
	       wrtSerStage } ;
  assign IF_wrtSerPos_80_EQ_2_83_THEN_0x0_ELSE_metaWF_f_ETC___d448 =
  ...
  assign NOT_wrtSerPos_80_EQ_3_87_88_AND_NOT_metaWF_fir_ETC___d435 =
	     wrtSerPos != 2'd3 && metaWF$D_OUT[23:0] != 24'd0 ||
	     CASE_wrtSerPos_NOT_wrtSerPos_EQ_3_OR_wide16Fa_ETC__q2 ;
  assign addr__h19034 = { 9'd0, x__h19092 } ;
  assign addr__h19202 = { 9'd0, x__h19247 } ;
  ...
  assign mesgMetaF_length__h16642 = { 8'd0, x__h16649 } ;
  ...
  assign metaRF_RDY_enq__09_AND_NOT_rdSerEmpty_65_66_AN_ETC___d310 =
	     metaRF$FULL_N &&
	     (!rdSerEmpty && rdSerPos != 2'd0 || wide16Fc$EMPTY_N) ;
  assign rdat__h21818 = hasDebugLogic ? mesgWtCount : 32'd0 ;
  assign rdat__h21824 = hasDebugLogic ? mesgRdCount : 32'd0 ;
  assign rdat__h21830 = hasDebugLogic ? bytesWritten : 32'd0 ;
  assign rdat__h21836 = hasDebugLogic ? { 8'd0, x__h21840 } : 32'd0 ;
  assign rdat__h21960 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h21974 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h21982 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h21988 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h22002 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h22010 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h22016 = hasDebugLogic ? wmemiWrReq : 32'd0 ;
  assign rdat__h22022 = hasDebugLogic ? wmemiRdReq : 32'd0 ;
  assign rdat__h22028 = hasDebugLogic ? wmemiRdResp : 32'd0 ;
  assign rdat__h22034 =
	     hasDebugLogic ?
  ...
  assign rdat__h22045 =
	     hasDebugLogic ?
	       ...
	       32'd0 ;
  assign rdat__h22056 = hasDebugLogic ? { 9'd0, dlyWAG } : 32'd0 ;
  assign rdat__h22067 = hasDebugLogic ? { 9'd0, dlyRAG } : 32'd0 ;
  assign rdat__h22078 = { {24{dlyMaxReadCredit[7]}}, dlyMaxReadCredit } ;
  assign rdat__h22097 = hasDebugLogic ? wmemiRdResp2 : 32'd0 ;
  assign rdat__h22151 =
  ...
  assign wci_cState_9_EQ_2_0_AND_dlyCtrl_5_BITS_3_TO_0__ETC___d350 =
	     ...
	     !bytesWritten_7_ULT_dlyHoldoffBytes_7___d153 &&
	     !cyclesPassed_55_ULT_dlyHoldoffCycles_9___d156 ;
  assign wordsEnqued_52_EQ_wordsExact_53_MINUS_1_54___d912 =
	     wordsEnqued == wordsExact - 16'd1 ;
  assign wrtSerPos_80_PLUS_1___d985 = wrtSerPos + 2'd1 ;
  assign wsiS_reqFifo_notFull__06_AND_wsiS_burstKind_86_ETC___d722 =
	     wsiS_reqFifo$FULL_N &&
	     (wsiS_burstKind == 2'd0 ||
	      (wsiS_burstKind == 2'd1 || wsiS_burstKind == 2'd2) &&
	      wsiS_wsiReq$wget[57]) ;
  assign x1__h17684 = { 96'd0, data__h17263 } ;
  assign x1__h17715 = { 64'd0, data__h17263, wrtSerStage } ;
  assign x1__h18350 = { 96'd0, metaWF$D_OUT } ;
  assign x1__h18377 = { 64'd0, metaWF$D_OUT, wrtSerStage } ;
  assign x__h14742 = mesgWF_rRdPtr + 13'd1 ;
  assign x__h14850 =
	     CAN_FIRE_RL_wmwt_mesg_ingress ?
	       wsiS_reqFifo$D_OUT[43:12] :
	       32'd0 ;
  assign x__h16649 = { wordsExact[13:0], 2'd0 } ;
  assign x__h16751 = wordsEnqued + 16'd1 ;
  assign x__h19092 = { dlyRAG, 4'h0 } ;
  assign x__h19247 = { dlyWAG, 4'h0 } ;
  assign x__h21840 = { wmemi_statusR, wsiS_statusR, wsiM_statusR } ;
  assign x_burstLength__h19533 =
	     (readMeta[23:0] == 24'd0) ? 12'd1 : readMeta[13:2] ;
  assign x_byteEn__h19534 = (readMeta[23:0] == 24'd0) ? 4'd0 : 4'd15 ;
  always@(rdSerPos or
	  rdSerStage_3 or wide16Fc$D_OUT or rdSerStage_1 or rdSerStage_2)
  begin
    case (rdSerPos)
      2'd0: x1__h20511 = wide16Fc$D_OUT[31:0];
      2'd1: x1__h20511 = rdSerStage_1;
      2'd2: x1__h20511 = rdSerStage_2;
      2'd3: x1__h20511 = rdSerStage_3;
    endcase
  end
  always@(wrtSerPos)
  begin
  ...
  always@(wci_reqF$D_OUT or
	  ...
	  rdat__h22078 or
	  dlyRdOpZero or
	  dlyRdOpOther or rdat__h22097 or delayStatus__h21360 or rdat__h22151)
  begin
    case (wci_reqF$D_OUT[51:32])
      20'h0: x_data__h21791 = dlyCtrl;
      20'h00004: x_data__h21791 = dlyHoldoffBytes;
      20'h00008: x_data__h21791 = dlyHoldoffCycles;
      20'h0000C: x_data__h21791 = rdat__h21818;
      20'h00010: x_data__h21791 = rdat__h21824;
      20'h00014: x_data__h21791 = rdat__h21830;
      20'h00018: x_data__h21791 = rdat__h21836;
      20'h0001C: x_data__h21791 = 32'd0;
      20'h00020: x_data__h21791 = rdat__h21960;
      20'h00024: x_data__h21791 = rdat__h21974;
      20'h00028: x_data__h21791 = rdat__h21982;
      20'h0002C: x_data__h21791 = rdat__h21988;
      20'h00030: x_data__h21791 = rdat__h22002;
      20'h00034: x_data__h21791 = rdat__h22010;
      20'h00038: x_data__h21791 = rdat__h22016;
      20'h0003C: x_data__h21791 = rdat__h22022;
      20'h00040: x_data__h21791 = rdat__h22028;
      20'h00044: x_data__h21791 = rdat__h22034;
      20'h00048: x_data__h21791 = rdat__h22045;
      20'h0004C: x_data__h21791 = rdat__h22056;
      20'h00050: x_data__h21791 = rdat__h22067;
      20'h00054: x_data__h21791 = rdat__h22078;
      20'h00058: x_data__h21791 = dlyRdOpZero;
      20'h0005C: x_data__h21791 = dlyRdOpOther;
      20'h00060: x_data__h21791 = rdat__h22097;
      20'h00064: x_data__h21791 = delayStatus__h21360;
      20'h00068: x_data__h21791 = rdat__h22151;
      default: x_data__h21791 = 32'd0;
    endcase
  end
