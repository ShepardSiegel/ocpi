...
//
// On Tue Jul 20 10:44:23 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker4B(wciS0_Clk,
  ...
  // register dlyMaxReadCredit
  reg [7 : 0] dlyMaxReadCredit;
  wire [7 : 0] dlyMaxReadCredit$D_IN;
  wire dlyMaxReadCredit$EN;
  ...
  // register dlyReadJustFired
  reg dlyReadJustFired;
  wire dlyReadJustFired$D_IN, dlyReadJustFired$EN;
  ...
  // register dlyWriteFlush
  reg [7 : 0] dlyWriteFlush;
  wire [7 : 0] dlyWriteFlush$D_IN;
  wire dlyWriteFlush$EN;

  // register dlyWriteJustFired
  reg dlyWriteJustFired;
  wire dlyWriteJustFired$D_IN, dlyWriteJustFired$EN;
  ...
  // register wordsEnqued
  reg [15 : 0] wordsEnqued;
  wire [15 : 0] wordsEnqued$D_IN;
  wire wordsEnqued$EN;

  // register wordsExact
  reg [15 : 0] wordsExact;
  wire [15 : 0] wordsExact$D_IN;
  wire wordsExact$EN;
  ...
  wire [7 : 0] MUX_dlyReadCredit_value$write_1__VAL_2,
	       MUX_dlyWriteFlush$write_1__VAL_2;
  ...
  reg [63 : 0] v__h22240, v__h2674, v__h2821, v__h3720;
  reg [31 : 0] x1__h21092, x_data__h22372;
  reg CASE_wrtSerPos_0b1_0_1_1_1_2_1_3_0b1__q1,
      CASE_wrtSerPos_NOT_wrtSerPos_EQ_3_OR_wide16Fa_ETC__q2;
  wire [127 : 0] IF_wrtSerPos_87_EQ_2_90_THEN_0x0_ELSE_mesgWF_w_ETC___d430,
		 IF_wrtSerPos_87_EQ_2_90_THEN_0x0_ELSE_metaWF_f_ETC___d455,
		 x1__h18149,
		 x1__h18180,
		 x1__h18815,
		 x1__h18842;
  wire [35 : 0] addr__h19499, addr__h19721;
  wire [31 : 0] data__h17728,
		delayStatus__h21941,
		rdat__h22399,
		rdat__h22405,
		rdat__h22411,
		...
		rdat__h22732,
		x__h14851;
  wire [26 : 0] x__h19557, x__h19766;
  wire [23 : 0] mesgMetaF_length__h17107, x__h22421;
  wire [15 : 0] x__h17114, x__h17216;
  wire [12 : 0] x__h14743;
  wire [11 : 0] x_burstLength__h20114;
  wire [3 : 0] x_byteEn__h20115;
  wire [1 : 0] wrtSerPos_87_PLUS_1___d998;
  wire IF_wrtSerPos_87_EQ_0_88_OR_wrtSerPos_87_EQ_1_8_ETC___d407,
       NOT_mesgWF_rRdPtr_65_EQ_mesgWF_rWrPtr_67_70___d171,
       NOT_mesgWF_rRdPtr_65_PLUS_2048_66_EQ_mesgWF_rW_ETC___d169,
       NOT_wrtSerPos_87_EQ_3_94_95_AND_NOT_metaWF_fir_ETC___d442,
       bytesWritten_7_ULT_dlyHoldoffBytes_7___d153,
       cyclesPassed_55_ULT_dlyHoldoffCycles_9___d156,
       dlyWordsStored_value_27_SLE_0_52_OR_bytesWritt_ETC___d160,
       dlyWordsStored_value_27_SLE_0___d152,
       dlyWordsStored_value_27_SLT_8388608___d161,
       mesgRF_RDY_enq__64_AND_NOT_rdSerEmpty_65_66_AN_ETC___d277,
       metaRF_RDY_enq__09_AND_NOT_rdSerEmpty_65_66_AN_ETC___d310,
       wci_cState_9_EQ_2_0_AND_dlyCtrl_5_BITS_3_TO_0__ETC___d350,
       wordsEnqued_59_EQ_wordsExact_60_MINUS_1_61___d926,
       wsiS_reqFifo_notFull__20_AND_wsiS_burstKind_00_ETC___d736;
  ...
  arSRLFIFO #(.width(32'd128),
	      .l2depth(32'd4),
	      .depth(32'd16)) wide16Fc(.CLK(wciS0_Clk),
				       .RST_N(wciS0_MReset_n),
				       .D_IN(wide16Fc$D_IN),
				       .ENQ(wide16Fc$ENQ),
				       .DEQ(wide16Fc$DEQ),
  ...
  // rule RL_delay_writeFlush
  assign CAN_FIRE_RL_delay_writeFlush =
	     wci_cState == 3'd2 && dlyCtrl[3:0] == 4'h7 &&
	     !dlyWriteJustFired ;
  assign WILL_FIRE_RL_delay_writeFlush = CAN_FIRE_RL_delay_writeFlush ;
  ...
  assign CAN_FIRE_RL_delay_Fb2Fc =
	     wide16Fb$EMPTY_N && wide16Fc$FULL_N && wci_cState == 3'd2 &&
	     dlyCtrl[3:0] == 4'h7 ;
  ...
  assign CAN_FIRE_RL_wrtSer_body =
	     NOT_mesgWF_rRdPtr_65_EQ_mesgWF_rWrPtr_67_70___d171 &&
	     IF_wrtSerPos_87_EQ_0_88_OR_wrtSerPos_87_EQ_1_8_ETC___d407 &&
	     wci_cState == 3'd2 &&
	     dlyCtrl[3:0] == 4'h7 &&
	     wrtSerUnroll != 16'd0 ;
  ...
  // rule RL_dlyReadJustFired__dreg_update
  assign CAN_FIRE_RL_dlyReadJustFired__dreg_update = 1'd1 ;
  assign WILL_FIRE_RL_dlyReadJustFired__dreg_update = 1'd1 ;

  // rule RL_dlyWriteJustFired__dreg_update
  assign CAN_FIRE_RL_dlyWriteJustFired__dreg_update = 1'd1 ;
  assign WILL_FIRE_RL_dlyWriteJustFired__dreg_update = 1'd1 ;
  ...
  assign CAN_FIRE_RL_wmwt_mesg_ingress =
	     ...
	     wci_cState == 3'd2 &&
	     dlyCtrl[3:0] == 4'h7 ;
  assign WILL_FIRE_RL_wmwt_mesg_ingress = CAN_FIRE_RL_wmwt_mesg_ingress ;
  ...
  assign MUX_dlyWordsStored_value$write_1__VAL_2 =
	     ...
	     (CAN_FIRE_RL_delay_write_req ? 25'd1 : 25'd0) +
	     (CAN_FIRE_RL_delay_read_req ? 25'd33554431 : 25'd0) ;
  assign MUX_dlyWriteFlush$write_1__VAL_2 = dlyWriteFlush + 8'd1 ;
  ...
  assign MUX_rdSyncWord$write_1__VAL_2 =
	     rdSerPos != 2'd3 && x1__h21092[23:0] == 24'd0 ;
  assign MUX_unrollCnt$write_1__VAL_1 =
	     (metaRF$D_OUT[23:0] == 24'd0) ? 16'd1 : metaRF$D_OUT[17:2] ;
  always@(wrtSerPos or
	  IF_wrtSerPos_87_EQ_2_90_THEN_0x0_ELSE_metaWF_f_ETC___d455 or
	  x1__h18815 or x1__h18842)
  begin
    case (wrtSerPos)
      2'd0: MUX_wide16Fa$enq_1__VAL_1 = x1__h18815;
      2'd1: MUX_wide16Fa$enq_1__VAL_1 = x1__h18842;
      default: MUX_wide16Fa$enq_1__VAL_1 =
		   IF_wrtSerPos_87_EQ_2_90_THEN_0x0_ELSE_metaWF_f_ETC___d455;
    endcase
  end
  always@(wrtSerPos or
	  IF_wrtSerPos_87_EQ_2_90_THEN_0x0_ELSE_mesgWF_w_ETC___d430 or
	  x1__h18149 or x1__h18180)
  begin
    case (wrtSerPos)
      2'd0: MUX_wide16Fa$enq_1__VAL_2 = x1__h18149;
      2'd1: MUX_wide16Fa$enq_1__VAL_2 = x1__h18180;
      default: MUX_wide16Fa$enq_1__VAL_2 =
		   IF_wrtSerPos_87_EQ_2_90_THEN_0x0_ELSE_mesgWF_w_ETC___d430;
    endcase
  end
  ...
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_1 = { 4'd5, addr__h19499, 12'd1 } ;
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_2 = { 4'd3, addr__h19721, 12'd1 } ;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, x_data__h22372 } ;
  ...
  assign MUX_dlyReadyToWrite_value$write_1__VAL_2 =
	     ...
	     (CAN_FIRE_RL_delay_write_req ? 16'd65535 : 16'd0) ;
  ...
  assign mesgWF_pwEnqueue$whas = CAN_FIRE_RL_wmwt_mesg_ingress ;
  assign mesgWF_pwDequeue$whas = CAN_FIRE_RL_wrtSer_body ;
  assign mesgWF_wDataIn$wget = wsiS_reqFifo$D_OUT[43:12] ;
  assign mesgWF_wDataIn$whas = CAN_FIRE_RL_wmwt_mesg_ingress ;
  assign mesgWF_wDataOut$wget = data__h17728 ;
  ...
  assign dlyReadyToWrite_acc_v2$whas = CAN_FIRE_RL_delay_write_req ;
  assign dlyWriteJustFired_1$wget = 1'd1 ;
  assign dlyWriteJustFired_1$whas = CAN_FIRE_RL_delay_write_req ;
  assign dlyReadJustFired_1$whas = CAN_FIRE_RL_delay_read_req ;
  assign dlyReadJustFired_1$wget = 1'd1 ;
  ...
  assign bytesWritten$EN =
	     WILL_FIRE_RL_wmwt_mesg_ingress && bytesWritten != 32'hFFFFFFFF ;
  ...
  // register dlyMaxReadCredit
  assign dlyMaxReadCredit$D_IN = wci_reqF$D_OUT[7:0] ;
  assign dlyMaxReadCredit$EN =
	     WILL_FIRE_RL_wci_cfwr && wci_reqF$D_OUT[51:32] == 20'h00054 ;
  ...
  assign dlyRdOpOther$EN =
	     WILL_FIRE_RL_rdSer_begin && x1__h21092[31:24] != 8'd0 ;
  ...
  // register dlyReadJustFired
  assign dlyReadJustFired$D_IN = CAN_FIRE_RL_delay_read_req ;
  assign dlyReadJustFired$EN = 1'd1 ;
  ...
  // register dlyWriteFlush
  assign dlyWriteFlush$D_IN =
	     WILL_FIRE_RL_delay_write_req ?
	       8'd0 :
	       MUX_dlyWriteFlush$write_1__VAL_2 ;
  assign dlyWriteFlush$EN =
	     WILL_FIRE_RL_delay_writeFlush && dlyWriteFlush != 8'd255 ||
	     WILL_FIRE_RL_delay_write_req ;

  // register dlyWriteJustFired
  assign dlyWriteJustFired$D_IN = CAN_FIRE_RL_delay_write_req ;
  assign dlyWriteJustFired$EN = 1'd1 ;
  ...
  // register mesgWF_rCache
  assign mesgWF_rCache$D_IN = { 1'd1, mesgWF_rWrPtr, x__h14851 } ;
  assign mesgWF_rCache$EN = CAN_FIRE_RL_wmwt_mesg_ingress ;

  // register mesgWF_rRdPtr
  assign mesgWF_rRdPtr$D_IN = x__h14743 ;
  assign mesgWF_rRdPtr$EN = CAN_FIRE_RL_wrtSer_body ;

  // register mesgWF_rWrPtr
  assign mesgWF_rWrPtr$D_IN = mesgWF_rWrPtr + 13'd1 ;
  assign mesgWF_rWrPtr$EN = CAN_FIRE_RL_wmwt_mesg_ingress ;
  ...
  // register rdSerMeta
  assign rdSerMeta$D_IN = x1__h21092 ;
  ...
  // register wordsEnqued
  assign wordsEnqued$D_IN =
	     wordsEnqued_59_EQ_wordsExact_60_MINUS_1_61___d926 ?
	       16'd0 :
	       x__h17216 ;
  assign wordsEnqued$EN = CAN_FIRE_RL_wmwt_mesg_ingress ;

  // register wordsExact
  assign wordsExact$D_IN = 16'h0 ;
  assign wordsExact$EN = 1'b0 ;
  ...
  assign wrtSerStage$D_IN =
	     MUX_wrtSerStage$write_1__SEL_1 ? data__h17728 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_1$D_IN =
	     MUX_wrtSerStage_1$write_1__SEL_1 ? data__h17728 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_2$D_IN =
	     MUX_wrtSerStage_2$write_1__SEL_1 ? data__h17728 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_3$D_IN =
	     MUX_wrtSerStage_3$write_1__SEL_1 ? data__h17728 : metaWF$D_OUT ;
  ...
  // remaining internal signals
  assign IF_wrtSerPos_87_EQ_0_88_OR_wrtSerPos_87_EQ_1_8_ETC___d407 =
	     CASE_wrtSerPos_0b1_0_1_1_1_2_1_3_0b1__q1 &&
	     (wrtSerPos != 2'd3 && wrtSerUnroll != 16'd1 ||
	      CASE_wrtSerPos_NOT_wrtSerPos_EQ_3_OR_wide16Fa_ETC__q2) ;
  assign IF_wrtSerPos_87_EQ_2_90_THEN_0x0_ELSE_mesgWF_w_ETC___d430 =
	     { (wrtSerPos == 2'd2) ? 32'h0 : data__h17728,
	       (wrtSerPos == 2'd2) ? data__h17728 : wrtSerStage_2,
	       wrtSerStage_1,
	       wrtSerStage } ;
  assign IF_wrtSerPos_87_EQ_2_90_THEN_0x0_ELSE_metaWF_f_ETC___d455 =
	     { (wrtSerPos == 2'd2) ? 32'h0 : metaWF$D_OUT,
	       (wrtSerPos == 2'd2) ? metaWF$D_OUT : wrtSerStage_2,
	       wrtSerStage_1,
	       wrtSerStage } ;
  assign NOT_mesgWF_rRdPtr_65_EQ_mesgWF_rWrPtr_67_70___d171 =
	     mesgWF_rRdPtr != mesgWF_rWrPtr ;
  assign NOT_mesgWF_rRdPtr_65_PLUS_2048_66_EQ_mesgWF_rW_ETC___d169 =
	     mesgWF_rRdPtr + 13'd2048 != mesgWF_rWrPtr ;
  assign NOT_wrtSerPos_87_EQ_3_94_95_AND_NOT_metaWF_fir_ETC___d442 =
	     wrtSerPos != 2'd3 && metaWF$D_OUT[23:0] != 24'd0 ||
	     CASE_wrtSerPos_NOT_wrtSerPos_EQ_3_OR_wide16Fa_ETC__q2 ;
  assign addr__h19499 = { 9'd0, x__h19557 } ;
  assign addr__h19721 = { 9'd0, x__h19766 } ;
  assign bytesWritten_7_ULT_dlyHoldoffBytes_7___d153 =
	     bytesWritten < dlyHoldoffBytes ;
  assign cyclesPassed_55_ULT_dlyHoldoffCycles_9___d156 =
	     cyclesPassed < dlyHoldoffCycles ;
  assign data__h17728 =
	     (mesgWF_rCache[45] && mesgWF_rCache[44:32] == mesgWF_rRdPtr) ?
	       mesgWF_rCache[31:0] :
	       mesgWF_memory$DOB ;
  assign delayStatus__h21941 =
	     { 15'h0,
	       dlyWordsStored_value_27_SLE_0_52_OR_bytesWritt_ETC___d160,
	       dlyWordsStored_value_27_SLT_8388608___d161,
	       wsiM_reqFifo_c_r != 2'd2,
	       ...
	       wide16Fc$FULL_N,
	       wide16Fc$EMPTY_N } ;
  assign dlyWordsStored_value_27_SLE_0_52_OR_bytesWritt_ETC___d160 =
	     dlyWordsStored_value_27_SLE_0___d152 ||
	     bytesWritten_7_ULT_dlyHoldoffBytes_7___d153 ||
	     cyclesPassed_55_ULT_dlyHoldoffCycles_9___d156 ||
	     wsiM_reqFifo_c_r == 2'd2 ;
  assign dlyWordsStored_value_27_SLE_0___d152 =
	     (dlyWordsStored_value ^ 25'h1000000) <= 25'd16777216 ;
  assign dlyWordsStored_value_27_SLT_8388608___d161 =
	     (dlyWordsStored_value ^ 25'h1000000) < 25'd25165824 ;
  assign mesgMetaF_length__h17107 = { 8'd0, x__h17114 } ;
  assign mesgRF_RDY_enq__64_AND_NOT_rdSerEmpty_65_66_AN_ETC___d277 =
	     mesgRF$FULL_N &&
	     (!rdSerEmpty && rdSerPos != 2'd0 || wide16Fc$EMPTY_N) ;
  assign metaRF_RDY_enq__09_AND_NOT_rdSerEmpty_65_66_AN_ETC___d310 =
	     metaRF$FULL_N &&
	     (!rdSerEmpty && rdSerPos != 2'd0 || wide16Fc$EMPTY_N) ;
  assign rdat__h22399 = hasDebugLogic ? mesgWtCount : 32'd0 ;
  assign rdat__h22405 = hasDebugLogic ? mesgRdCount : 32'd0 ;
  assign rdat__h22411 = hasDebugLogic ? bytesWritten : 32'd0 ;
  assign rdat__h22417 = hasDebugLogic ? { 8'd0, x__h22421 } : 32'd0 ;
  assign rdat__h22541 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h22555 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h22563 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h22569 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h22583 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h22591 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h22597 = hasDebugLogic ? wmemiWrReq : 32'd0 ;
  assign rdat__h22603 = hasDebugLogic ? wmemiRdReq : 32'd0 ;
  assign rdat__h22609 = hasDebugLogic ? wmemiRdResp : 32'd0 ;
  assign rdat__h22615 =
	     hasDebugLogic ?
  ...
  assign rdat__h22626 =
	     hasDebugLogic ?
	       ...
	       32'd0 ;
  assign rdat__h22637 = hasDebugLogic ? { 9'd0, dlyWAG } : 32'd0 ;
  assign rdat__h22648 = hasDebugLogic ? { 9'd0, dlyRAG } : 32'd0 ;
  assign rdat__h22659 = { {24{dlyMaxReadCredit[7]}}, dlyMaxReadCredit } ;
  assign rdat__h22678 = hasDebugLogic ? wmemiRdResp2 : 32'd0 ;
  assign rdat__h22732 =
	     { {16{dlyReadyToWrite_value[15]}}, dlyReadyToWrite_value } ;
  assign wci_cState_9_EQ_2_0_AND_dlyCtrl_5_BITS_3_TO_0__ETC___d350 =
	     wci_cState == 3'd2 && dlyCtrl[3:0] == 4'h7 &&
	     !dlyWordsStored_value_27_SLE_0___d152 &&
	     !bytesWritten_7_ULT_dlyHoldoffBytes_7___d153 &&
	     !cyclesPassed_55_ULT_dlyHoldoffCycles_9___d156 ;
  assign wordsEnqued_59_EQ_wordsExact_60_MINUS_1_61___d926 =
	     wordsEnqued == wordsExact - 16'd1 ;
  assign wrtSerPos_87_PLUS_1___d998 = wrtSerPos + 2'd1 ;
  assign wsiS_reqFifo_notFull__20_AND_wsiS_burstKind_00_ETC___d736 =
	     wsiS_reqFifo$FULL_N &&
	     (wsiS_burstKind == 2'd0 ||
	      (wsiS_burstKind == 2'd1 || wsiS_burstKind == 2'd2) &&
	      wsiS_wsiReq$wget[57]) ;
  assign x1__h18149 = { 96'd0, data__h17728 } ;
  assign x1__h18180 = { 64'd0, data__h17728, wrtSerStage } ;
  assign x1__h18815 = { 96'd0, metaWF$D_OUT } ;
  assign x1__h18842 = { 64'd0, metaWF$D_OUT, wrtSerStage } ;
  assign x__h14743 = mesgWF_rRdPtr + 13'd1 ;
  assign x__h14851 =
	     CAN_FIRE_RL_wmwt_mesg_ingress ?
	       wsiS_reqFifo$D_OUT[43:12] :
	       32'd0 ;
  assign x__h17114 = { wordsExact[13:0], 2'd0 } ;
  assign x__h17216 = wordsEnqued + 16'd1 ;
  assign x__h19557 = { dlyRAG, 4'h0 } ;
  assign x__h19766 = { dlyWAG, 4'h0 } ;
  assign x__h22421 = { wmemi_statusR, wsiS_statusR, wsiM_statusR } ;
  assign x_burstLength__h20114 =
	     (readMeta[23:0] == 24'd0) ? 12'd1 : readMeta[13:2] ;
  assign x_byteEn__h20115 = (readMeta[23:0] == 24'd0) ? 4'd0 : 4'd15 ;
  always@(rdSerPos or
	  rdSerStage_3 or wide16Fc$D_OUT or rdSerStage_1 or rdSerStage_2)
  begin
    case (rdSerPos)
      2'd0: x1__h21092 = wide16Fc$D_OUT[31:0];
      2'd1: x1__h21092 = rdSerStage_1;
      2'd2: x1__h21092 = rdSerStage_2;
      2'd3: x1__h21092 = rdSerStage_3;
    endcase
  end
  always@(wrtSerPos)
  begin
  ...
  always@(wci_reqF$D_OUT or
	  ...
	  rdat__h22659 or
	  dlyRdOpZero or
	  dlyRdOpOther or rdat__h22678 or delayStatus__h21941 or rdat__h22732)
  begin
    case (wci_reqF$D_OUT[51:32])
      20'h0: x_data__h22372 = dlyCtrl;
      20'h00004: x_data__h22372 = dlyHoldoffBytes;
      20'h00008: x_data__h22372 = dlyHoldoffCycles;
      20'h0000C: x_data__h22372 = rdat__h22399;
      20'h00010: x_data__h22372 = rdat__h22405;
      20'h00014: x_data__h22372 = rdat__h22411;
      20'h00018: x_data__h22372 = rdat__h22417;
      20'h0001C: x_data__h22372 = 32'd0;
      20'h00020: x_data__h22372 = rdat__h22541;
      20'h00024: x_data__h22372 = rdat__h22555;
      20'h00028: x_data__h22372 = rdat__h22563;
      20'h0002C: x_data__h22372 = rdat__h22569;
      20'h00030: x_data__h22372 = rdat__h22583;
      20'h00034: x_data__h22372 = rdat__h22591;
      20'h00038: x_data__h22372 = rdat__h22597;
      20'h0003C: x_data__h22372 = rdat__h22603;
      20'h00040: x_data__h22372 = rdat__h22609;
      20'h00044: x_data__h22372 = rdat__h22615;
      20'h00048: x_data__h22372 = rdat__h22626;
      20'h0004C: x_data__h22372 = rdat__h22637;
      20'h00050: x_data__h22372 = rdat__h22648;
      20'h00054: x_data__h22372 = rdat__h22659;
      20'h00058: x_data__h22372 = dlyRdOpZero;
      20'h0005C: x_data__h22372 = dlyRdOpOther;
      20'h00060: x_data__h22372 = rdat__h22678;
      20'h00064: x_data__h22372 = delayStatus__h21941;
      20'h00068: x_data__h22372 = rdat__h22732;
      default: x_data__h22372 = 32'd0;
    endcase
  end
  ...
  begin
	...
	dlyMaxReadCredit <= `BSV_ASSIGNMENT_DELAY 8'd4;
	...
	dlyReadJustFired <= `BSV_ASSIGNMENT_DELAY 1'd0;
	...
	dlyWriteFlush <= `BSV_ASSIGNMENT_DELAY 8'd0;
	dlyWriteJustFired <= `BSV_ASSIGNMENT_DELAY 1'd0;
	...
	wordsEnqued <= `BSV_ASSIGNMENT_DELAY 16'd0;
	wordsExact <= `BSV_ASSIGNMENT_DELAY 16'd2048;
	...
	if (dlyMaxReadCredit$EN)
	  dlyMaxReadCredit <= `BSV_ASSIGNMENT_DELAY dlyMaxReadCredit$D_IN;
	...
	if (dlyReadJustFired$EN)
	  dlyReadJustFired <= `BSV_ASSIGNMENT_DELAY dlyReadJustFired$D_IN;
	...
	if (dlyWriteFlush$EN)
	  dlyWriteFlush <= `BSV_ASSIGNMENT_DELAY dlyWriteFlush$D_IN;
	if (dlyWriteJustFired$EN)
	  dlyWriteJustFired <= `BSV_ASSIGNMENT_DELAY dlyWriteJustFired$D_IN;
	if (mesgRdCount$EN)
	...
	if (wordsEnqued$EN)
	  wordsEnqued <= `BSV_ASSIGNMENT_DELAY wordsEnqued$D_IN;
	if (wordsExact$EN)
	  wordsExact <= `BSV_ASSIGNMENT_DELAY wordsExact$D_IN;
	if (wrtSerAddr$EN)
