...
//
// On Tue Jun  1 17:10:12 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker4B(wciS0_Clk,
  ...
  // ports of submodule wide16F
  wire [127 : 0] wide16F$D_IN, wide16F$D_OUT;
  wire wide16F$CLR, wide16F$DEQ, wide16F$EMPTY_N, wide16F$ENQ, wide16F$FULL_N;

  // ports of submodule wide4F
  wire [31 : 0] wide4F$D_IN;
  wire wide4F$CLR, wide4F$DEQ, wide4F$ENQ;

  // ports of submodule wmemi_isReset
  wire wmemi_isReset$VAL;

  // ports of submodule wmemi_respF
  wire [130 : 0] wmemi_respF$D_IN;
  wire wmemi_respF$CLR, wmemi_respF$DEQ, wmemi_respF$ENQ, wmemi_respF$FULL_N;
  ...
  wire [127 : 0] MUX_wide16F$enq_1__VAL_1, MUX_wide16F$enq_1__VAL_2;
  ...
  wire [19 : 0] MUX_dlyWordsStored_value$write_1__VAL_2;
  ...
  reg [63 : 0] v__h17183,
	       ...
	       v__h2806,
	       v__h3705;
  reg [31 : 0] sendData__h21805, x_data__h20373;
  reg CASE_wrtSerPos_0b1_0_1_1_1_2_1_3_0b1__q1;
  wire [31 : 0] data__h19185,
		mesg__h20846,
		rdat__h20417,
		x__h15015,
		x__h15941;
  wire [23 : 0] x1_length__h16876, x__h20420;
  wire [13 : 0] mlp1__h17575, x__h16920;
  wire [11 : 0] x_burstLength__h20937;
  wire [10 : 0] x__h14907, x__h15833;
  wire [7 : 0] x1_opcode__h16875;
  wire [3 : 0] x_byteEn__h20938;
  wire NOT_mesgRF_rRdPtr_23_PLUS_512_66_EQ_mesgRF_rWr_ETC___d181,
       NOT_wsiS_reqFifo_countReg_72_ULE_1_73___d574,
       _dor1bytesWritten$EN_write,
       _dor1rdSerEmpty$EN_write,
       _dor1rdSerStage$EN_write,
       _dor1rdSerStage_1$EN_write,
       _dor1rdSerStage_2$EN_write,
       _dor1rdSerStage_3$EN_write,
       _dor1wide16F$EN_deq,
       metaRF_RDY_enq__03_AND_NOT_rdSerEmpty_69_70_AN_ETC___d204,
       wci_cState_9_EQ_2_0_AND_dlyCtrl_4_BITS_3_TO_0__ETC___d159,
       wci_cState_9_EQ_2_0_AND_dlyCtrl_4_BITS_3_TO_0__ETC___d268;
  ...
  arSRLFIFO #(.width(32'd128),
	      .l2depth(32'd4),
	      .depth(32'd16)) wide16F(.CLK(wciS0_Clk),
				      .RST_N(wciS0_MReset_n),
				      .D_IN(wide16F$D_IN),
				      .DEQ(wide16F$DEQ),
				      .ENQ(wide16F$ENQ),
				      .CLR(wide16F$CLR),
				      .EMPTY_N(wide16F$EMPTY_N),
				      .D_OUT(wide16F$D_OUT),
				      .FULL_N(wide16F$FULL_N));

  // submodule wide4F
  arSRLFIFO #(.width(32'd32),
	      .l2depth(32'd4),
	      .depth(32'd16)) wide4F(.CLK(wciS0_Clk),
				     .RST_N(wciS0_MReset_n),
				     .D_IN(wide4F$D_IN),
				     .DEQ(wide4F$DEQ),
				     .ENQ(wide4F$ENQ),
  ...
  assign CAN_FIRE_RL_rdSer_body =
	     NOT_mesgRF_rRdPtr_23_PLUS_512_66_EQ_mesgRF_rWr_ETC___d181 &&
	     wci_cState == 3'd2 &&
	     dlyCtrl[3:0] == 4'h7 &&
	     rdSerUnroll != 16'd0 ;
  ...
  assign CAN_FIRE_RL_wrtSer_begin =
	     metaWF$EMPTY_N && (wrtSerPos != 2'd3 || wide16F$FULL_N) &&
	     wci_cState == 3'd2 &&
	     dlyCtrl[3:0] == 4'h7 &&
	     wrtSerUnroll == 16'd0 ;
  ...
  assign CAN_FIRE_RL_wmemi_dhF_both = 1'b0 ;
  assign WILL_FIRE_RL_wmemi_dhF_both = 1'b0 ;

  // rule RL_wmemi_dhF_incCtr
  assign CAN_FIRE_RL_wmemi_dhF_incCtr = 1'b0 ;
  assign WILL_FIRE_RL_wmemi_dhF_incCtr = 1'b0 ;

  // rule RL_wmemi_dhF_decCtr
  assign CAN_FIRE_RL_wmemi_dhF_decCtr = wmemi_dhF_dequeueing$whas ;
  assign WILL_FIRE_RL_wmemi_dhF_decCtr = wmemi_dhF_dequeueing$whas ;

  // rule RL_wmemi_reqF_both
  assign CAN_FIRE_RL_wmemi_reqF_both = 1'b0 ;
  assign WILL_FIRE_RL_wmemi_reqF_both = 1'b0 ;

  // rule RL_wmemi_reqF_decCtr
  assign CAN_FIRE_RL_wmemi_reqF_decCtr = wmemi_reqF_dequeueing$whas ;
  assign WILL_FIRE_RL_wmemi_reqF_decCtr = wmemi_reqF_dequeueing$whas ;
  ...
  assign CAN_FIRE_RL_wmemi_reqF_incCtr = 1'b0 ;
  assign WILL_FIRE_RL_wmemi_reqF_incCtr = 1'b0 ;
  ...
  assign MUX_wide16F$enq_1__SEL_1 =
  ...
  assign MUX_wide16F$enq_1__VAL_1 =
	     { data__h19185, wrtSerStage_2, wrtSerStage_1, wrtSerStage } ;
  assign MUX_wide16F$enq_1__VAL_2 =
	     { metaWF$D_OUT, wrtSerStage_2, wrtSerStage_1, wrtSerStage } ;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, x_data__h20373 } ;
  ...
  assign wmemi_reqF_enqueueing$whas = 1'b0 ;
  assign wmemi_reqF_x_wire$wget = 52'h0 ;
  assign wmemi_reqF_x_wire$whas = 1'b0 ;
  assign wmemi_dhF_enqueueing$whas = 1'b0 ;
  assign wmemi_reqF_dequeueing$whas =
	     wmemiM_SCmdAccept && wmemi_reqF_c_r != 2'd0 ;
  assign wmemi_dhF_x_wire$wget = 146'h0 ;
  assign wmemi_dhF_x_wire$whas = 1'b0 ;
  ...
  assign mesgWF_wDataOut$wget = data__h19185 ;
  ...
  assign mesgRF_wDataIn$wget = sendData__h21805 ;
  assign mesgRF_wDataIn$whas = CAN_FIRE_RL_rdSer_body ;
  assign mesgRF_wDataOut$wget = mesg__h20846 ;
  assign mesgRF_wDataOut$whas = 1'd1 ;
  assign dlyWordsStored_acc_v1$whas = 1'b0 ;
  assign dlyWordsStored_acc_v1$wget = 20'h0 ;
  assign dlyWordsStored_acc_v2$wget = 20'h0 ;
  assign dlyWordsStored_acc_v2$whas = 1'b0 ;
  assign dlyReadCredit_acc_v1$wget = 8'h0 ;
  assign dlyReadCredit_acc_v1$whas = 1'b0 ;
  assign dlyReadCredit_acc_v2$wget = 8'h0 ;
  assign wci_Es_mCmd_w$wget = wciS0_MCmd ;
  assign dlyReadCredit_acc_v2$whas = 1'b0 ;
  ...
  // register dlyHoldoff
  assign dlyHoldoff$D_IN = wci_reqF$D_OUT[31:0] ;
  assign dlyHoldoff$EN =
	     WILL_FIRE_RL_wci_cfwr && wci_reqF$D_OUT[51:32] == 20'h00004 ;

  // register dlyRAG
  assign dlyRAG$D_IN = 20'd0 ;
  assign dlyRAG$EN = CAN_FIRE_RL_wci_ctrl_IsO ;
  ...
  // register dlyWAG
  assign dlyWAG$D_IN = 20'd0 ;
  assign dlyWAG$EN = CAN_FIRE_RL_wci_ctrl_IsO ;
  ...
  assign mesgLengthSoFar$D_IN =
	     MUX_impreciseBurst$write_1__SEL_2 ? 14'd0 : mlp1__h17575 ;
  assign mesgLengthSoFar$EN =
	     WILL_FIRE_RL_wmwt_mesgBegin && !wsiS_reqFifo$D_OUT[56] ||
	     WILL_FIRE_RL_wmwt_messagePushImprecise ;

  // register mesgRF_rCache
  assign mesgRF_rCache$D_IN = { 1'd1, mesgRF_rWrPtr, x__h15941 } ;
  assign mesgRF_rCache$EN = CAN_FIRE_RL_rdSer_body ;

  // register mesgRF_rRdPtr
  assign mesgRF_rRdPtr$D_IN = x__h15833 ;
  ...
  // register mesgWF_rCache
  assign mesgWF_rCache$D_IN = { 1'd1, mesgWF_rWrPtr, x__h15015 } ;
  assign mesgWF_rCache$EN = mesgWF_pwEnqueue$whas ;

  // register mesgWF_rRdPtr
  assign mesgWF_rRdPtr$D_IN = x__h14907 ;
  ...
  // register rdSerEmpty
  assign rdSerEmpty$D_IN = 1'd0 ;
  assign rdSerEmpty$EN =
	     _dor1rdSerEmpty$EN_write && (rdSerEmpty || rdSerPos == 2'd0) ;

  // register rdSerMeta
  assign rdSerMeta$D_IN = sendData__h21805 ;
  assign rdSerMeta$EN = CAN_FIRE_RL_rdSer_begin ;

  // register rdSerPos
  assign rdSerPos$D_IN = rdSerPos + 2'd1 ;
  assign rdSerPos$EN = WILL_FIRE_RL_rdSer_begin || WILL_FIRE_RL_rdSer_body ;

  // register rdSerStage
  assign rdSerStage$D_IN = wide16F$D_OUT[31:0] ;
  assign rdSerStage$EN =
	     _dor1rdSerStage$EN_write && (rdSerEmpty || rdSerPos == 2'd0) ;

  // register rdSerStage_1
  assign rdSerStage_1$D_IN = wide16F$D_OUT[63:32] ;
  assign rdSerStage_1$EN =
	     _dor1rdSerStage_1$EN_write && (rdSerEmpty || rdSerPos == 2'd0) ;

  // register rdSerStage_2
  assign rdSerStage_2$D_IN = wide16F$D_OUT[95:64] ;
  assign rdSerStage_2$EN =
	     _dor1rdSerStage_2$EN_write && (rdSerEmpty || rdSerPos == 2'd0) ;

  // register rdSerStage_3
  assign rdSerStage_3$D_IN = wide16F$D_OUT[127:96] ;
  assign rdSerStage_3$EN =
	     _dor1rdSerStage_3$EN_write && (rdSerEmpty || rdSerPos == 2'd0) ;

  // register rdSerUnroll
  assign rdSerUnroll$D_IN =
	     WILL_FIRE_RL_rdSer_begin ?
	       sendData__h21805[17:2] :
  ...
  // register wmemi_dhF_c_r
  assign wmemi_dhF_c_r$D_IN = MUX_wmemi_dhF_c_r$write_1__VAL_1 ;
  assign wmemi_dhF_c_r$EN = wmemi_dhF_dequeueing$whas ;

  // register wmemi_dhF_q_0
  assign wmemi_dhF_q_0$D_IN = wmemi_dhF_q_1 ;
  assign wmemi_dhF_q_0$EN = wmemi_dhF_dequeueing$whas ;

  // register wmemi_dhF_q_1
  assign wmemi_dhF_q_1$D_IN = 146'h0AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA ;
  assign wmemi_dhF_q_1$EN = wmemi_dhF_dequeueing$whas ;
  ...
  // register wmemi_peerIsReady
  assign wmemi_peerIsReady$D_IN = 1'b0 ;
  assign wmemi_peerIsReady$EN = 1'd1 ;

  // register wmemi_reqF_c_r
  assign wmemi_reqF_c_r$D_IN = MUX_wmemi_reqF_c_r$write_1__VAL_1 ;
  assign wmemi_reqF_c_r$EN = wmemi_reqF_dequeueing$whas ;

  // register wmemi_reqF_q_0
  assign wmemi_reqF_q_0$D_IN = wmemi_reqF_q_1 ;
  assign wmemi_reqF_q_0$EN = wmemi_reqF_dequeueing$whas ;

  // register wmemi_reqF_q_1
  assign wmemi_reqF_q_1$D_IN = 52'h0AAAAAAAAAAAA ;
  assign wmemi_reqF_q_1$EN = wmemi_reqF_dequeueing$whas ;
  ...
  // register wrtSerPos
  assign wrtSerPos$D_IN = wrtSerPos + 2'd1 ;
  assign wrtSerPos$EN =
	     WILL_FIRE_RL_wrtSer_begin || WILL_FIRE_RL_wrtSer_body ;

  // register wrtSerStage
  assign wrtSerStage$D_IN =
	     MUX_wrtSerStage$write_1__SEL_1 ? data__h19185 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_1$D_IN =
	     MUX_wrtSerStage_1$write_1__SEL_1 ? data__h19185 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_2$D_IN =
	     MUX_wrtSerStage_2$write_1__SEL_1 ? data__h19185 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_3$D_IN =
	     MUX_wide16F$enq_1__SEL_1 ? data__h19185 : metaWF$D_OUT ;
  ...
  assign mesgRF_memory$DIA = x__h15941 ;
  ...
  assign wide16F$D_IN =
	     MUX_wide16F$enq_1__SEL_1 ?
	       MUX_wide16F$enq_1__VAL_1 :
	       MUX_wide16F$enq_1__VAL_2 ;
  assign wide16F$DEQ =
	     _dor1wide16F$EN_deq && (rdSerEmpty || rdSerPos == 2'd0) ;
  assign wide16F$ENQ =
	     WILL_FIRE_RL_wrtSer_body && wrtSerPos == 2'd3 ||
	     WILL_FIRE_RL_wrtSer_begin && wrtSerPos == 2'd3 ;
  assign wide16F$CLR = 1'b0 ;

  // submodule wide4F
  assign wide4F$DEQ = 1'b0 ;
  assign wide4F$D_IN = 32'h0 ;
  assign wide4F$ENQ = 1'b0 ;
  assign wide4F$CLR = 1'b0 ;

  // submodule wmemi_respF
  assign wmemi_respF$D_IN = wmemi_wmemiResponse$wget ;
  assign wmemi_respF$ENQ = CAN_FIRE_RL_wmemi_respAdvance ;
  assign wmemi_respF$DEQ = 1'b0 ;
  ...
  // remaining internal signals
  assign NOT_mesgRF_rRdPtr_23_PLUS_512_66_EQ_mesgRF_rWr_ETC___d181 =
	     mesgRF_rRdPtr + 11'd512 != mesgRF_rWrPtr &&
	     (!rdSerEmpty && rdSerPos != 2'd0 || wide16F$EMPTY_N) ;
  assign NOT_wsiS_reqFifo_countReg_72_ULE_1_73___d574 =
	     wsiS_reqFifo_countReg > 2'd1 ;
  assign _dor1bytesWritten$EN_write =
	     WILL_FIRE_RL_wmwt_messagePushPrecise ||
	     WILL_FIRE_RL_wmwt_messagePushImprecise ;
  assign _dor1rdSerEmpty$EN_write =
	     WILL_FIRE_RL_rdSer_begin || WILL_FIRE_RL_rdSer_body ;
  assign _dor1rdSerStage$EN_write =
	     WILL_FIRE_RL_rdSer_begin || WILL_FIRE_RL_rdSer_body ;
  assign _dor1rdSerStage_1$EN_write =
	     WILL_FIRE_RL_rdSer_begin || WILL_FIRE_RL_rdSer_body ;
  assign _dor1rdSerStage_2$EN_write =
	     WILL_FIRE_RL_rdSer_begin || WILL_FIRE_RL_rdSer_body ;
  assign _dor1rdSerStage_3$EN_write =
	     WILL_FIRE_RL_rdSer_begin || WILL_FIRE_RL_rdSer_body ;
  assign _dor1wide16F$EN_deq =
	     WILL_FIRE_RL_rdSer_begin || WILL_FIRE_RL_rdSer_body ;
  assign data__h19185 =
  ...
  assign mesg__h20846 =
	     (mesgRF_rCache[43] && mesgRF_rCache[42:32] == mesgRF_rRdPtr) ?
	       mesgRF_rCache[31:0] :
	       mesgRF_memory$DOB ;
  assign metaRF_RDY_enq__03_AND_NOT_rdSerEmpty_69_70_AN_ETC___d204 =
	     metaRF$FULL_N &&
	     (!rdSerEmpty && rdSerPos != 2'd0 || wide16F$EMPTY_N) ;
  assign mlp1__h17575 = mesgLengthSoFar + 14'd1 ;
  assign rdat__h20417 = { 8'd0, x__h20420 } ;
  assign wci_cState_9_EQ_2_0_AND_dlyCtrl_4_BITS_3_TO_0__ETC___d159 =
	     wci_cState == 3'd2 && dlyCtrl[3:0] == 4'h7 &&
	     unrollCnt == 16'd0 &&
	     bytesWritten > dlyHoldoff ;
  assign wci_cState_9_EQ_2_0_AND_dlyCtrl_4_BITS_3_TO_0__ETC___d268 =
	     wci_cState == 3'd2 && dlyCtrl[3:0] == 4'h7 && mesgLength[14] &&
	     !doAbort &&
	     (preciseBurst && wsiWordsRemain == 12'd0 ||
	      impreciseBurst && endOfMessage) ;
  assign x1_length__h16876 = { 10'd0, x__h16920 } ;
  assign x1_opcode__h16875 = opcode[8] ? opcode[7:0] : 8'd0 ;
  assign x__h14907 = mesgWF_rRdPtr + 11'd1 ;
  assign x__h15015 =
	     mesgWF_pwEnqueue$whas ? wsiS_reqFifo$D_OUT[43:12] : 32'd0 ;
  assign x__h15833 = mesgRF_rRdPtr + 11'd1 ;
  assign x__h15941 = CAN_FIRE_RL_rdSer_body ? sendData__h21805 : 32'd0 ;
  assign x__h16920 = mesgLength[14] ? mesgLength[13:0] : 14'd0 ;
  assign x__h20420 = { wmemi_statusR, wsiS_statusR, wsiM_statusR } ;
  assign x_burstLength__h20937 =
	     (readMeta[23:0] == 24'd0) ? 12'd1 : readMeta[13:2] ;
  assign x_byteEn__h20938 = (readMeta[23:0] == 24'd0) ? 4'd0 : 4'd15 ;
  always@(rdSerPos or
	  rdSerStage_3 or wide16F$D_OUT or rdSerStage_1 or rdSerStage_2)
  begin
    case (rdSerPos)
      2'd0: sendData__h21805 = wide16F$D_OUT[31:0];
      2'd1: sendData__h21805 = rdSerStage_1;
      2'd2: sendData__h21805 = rdSerStage_2;
      2'd3: sendData__h21805 = rdSerStage_3;
    endcase
  end
  always@(wrtSerPos)
  begin
  ...
  always@(wci_reqF$D_OUT or
	  ...
	  mesgWtCount or
	  mesgRdCount or
	  rdat__h20417 or wsiS_extStatusW$wget or wsiM_extStatusW$wget)
  begin
    case (wci_reqF$D_OUT[51:32])
      20'h0: x_data__h20373 = dlyCtrl;
      20'h00004: x_data__h20373 = dlyHoldoff;
      20'h00008: x_data__h20373 = mesgWtCount;
      20'h0000C: x_data__h20373 = mesgRdCount;
      20'h00010, 20'h00014: x_data__h20373 = 32'd0;
      20'h00018: x_data__h20373 = rdat__h20417;
      20'h00020: x_data__h20373 = wsiS_extStatusW$wget[95:64];
      20'h00024: x_data__h20373 = wsiS_extStatusW$wget[63:32];
      20'h00028: x_data__h20373 = wsiS_extStatusW$wget[31:0];
      20'h0002C: x_data__h20373 = wsiM_extStatusW$wget[95:64];
      20'h00030: x_data__h20373 = wsiM_extStatusW$wget[63:32];
      20'h00034: x_data__h20373 = wsiM_extStatusW$wget[31:0];
      default: x_data__h20373 = 32'd0;
    endcase
  end
  ...
  begin
	...
	dlyHoldoff <= `BSV_ASSIGNMENT_DELAY 32'd128;
	...
	if (dlyHoldoff$EN)
	  dlyHoldoff <= `BSV_ASSIGNMENT_DELAY dlyHoldoff$D_IN;
  ...
  begin
    ...
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wmwt_doAbort)
	$display("[%0d]: %m: wmwt_doAbort", v__h17428);
    if (wciS0_MReset_n)
