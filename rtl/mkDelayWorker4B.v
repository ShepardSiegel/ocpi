...
//
// On Fri Jul 23 11:09:26 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker4B(wciS0_Clk,
  ...
  reg [63 : 0] v__h21510, v__h2669, v__h2816, v__h3715;
  reg [31 : 0] x1__h20389, x_data__h21642;
  reg CASE_wrtSerPos_0b1_0_1_1_1_2_1_3_0b1__q1,
      CASE_wrtSerPos_NOT_wrtSerPos_EQ_3_OR_wide16Fa_ETC__q2;
  wire [127 : 0] IF_wrtSerPos_75_EQ_2_78_THEN_0x0_ELSE_mesgWF_w_ETC___d418,
		 IF_wrtSerPos_75_EQ_2_78_THEN_0x0_ELSE_metaWF_f_ETC___d443,
		 x1__h17560,
		 x1__h17591,
		 x1__h18226,
		 x1__h18253;
  wire [35 : 0] addr__h18912, addr__h19080;
  wire [31 : 0] data__h17139,
		delayStatus__h21238,
		rdat__h21669,
		rdat__h21675,
		rdat__h21681,
		...
		rdat__h21993,
		x__h14794;
  wire [26 : 0] x__h18970, x__h19125;
  wire [23 : 0] mesgMetaF_length__h16565, x__h21691;
  wire [12 : 0] x__h14686;
  wire [11 : 0] x__h16572, x_burstLength__h19411;
  wire [3 : 0] x_byteEn__h19412;
  wire [1 : 0] wrtSerPos_75_PLUS_1___d918;
  wire IF_wrtSerPos_75_EQ_0_76_OR_wrtSerPos_75_EQ_1_7_ETC___d395,
       NOT_mesgWF_rRdPtr_62_EQ_mesgWF_rWrPtr_64_67___d168,
       NOT_mesgWF_rRdPtr_62_PLUS_2048_63_EQ_mesgWF_rW_ETC___d166,
       NOT_wmemi_reqF_c_r_33_EQ_2_34_35_AND_NOT_wmemi_ETC___d362,
       NOT_wrtSerPos_75_EQ_3_82_83_AND_NOT_metaWF_fir_ETC___d430,
       bytesWritten_6_ULT_dlyHoldoffBytes_6___d150,
       cyclesPassed_52_ULT_dlyHoldoffCycles_8___d153,
       dlyWordsStored_value_26_SLE_0_49_OR_bytesWritt_ETC___d157,
       dlyWordsStored_value_26_SLE_0___d149,
       dlyWordsStored_value_26_SLT_8388608___d158,
       mesgRF_RDY_enq__59_AND_NOT_rdSerEmpty_60_61_AN_ETC___d272,
       metaRF_RDY_enq__04_AND_NOT_rdSerEmpty_60_61_AN_ETC___d305,
       wci_cState_9_EQ_2_0_AND_dlyCtrl_4_BITS_3_TO_0__ETC___d345,
       wci_cState_9_EQ_2_0_AND_dlyCtrl_4_BITS_3_TO_0__ETC___d366,
       wsiS_reqFifo_notFull__97_AND_wsiS_burstKind_77_ETC___d715;
  ...
  assign WILL_FIRE_RL_wsiS_reqFifo_enq =
	     CAN_FIRE_RL_wsiS_reqFifo_enq && !WILL_FIRE_RL_wmwt_mesg_ingress ;
  ...
  assign CAN_FIRE_RL_wrtSer_body =
	     NOT_mesgWF_rRdPtr_62_EQ_mesgWF_rWrPtr_64_67___d168 &&
	     IF_wrtSerPos_75_EQ_0_76_OR_wrtSerPos_75_EQ_1_7_ETC___d395 &&
	     wci_cState == 3'd2 &&
	     dlyCtrl[3:0] == 4'h7 &&
	     wrtSerUnroll != 16'd0 ;
  ...
  assign MUX_wsiS_reqFifo_levelsValid$write_1__SEL_3 =
	     ...
	     wci_cState == 3'd2 &&
	     dlyCtrl[3:0] == 4'h7 ;
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, x_data__h21642 } ;
  ...
  assign MUX_rdSyncWord$write_1__VAL_2 =
	     rdSerPos != 2'd3 && x1__h20389[23:0] == 24'd0 ;
  assign MUX_unrollCnt$write_1__VAL_1 =
	     (metaRF$D_OUT[23:0] == 24'd0) ? 16'd1 : metaRF$D_OUT[17:2] ;
  always@(wrtSerPos or
	  IF_wrtSerPos_75_EQ_2_78_THEN_0x0_ELSE_metaWF_f_ETC___d443 or
	  x1__h18226 or x1__h18253)
  begin
    case (wrtSerPos)
      2'd0: MUX_wide16Fa$enq_1__VAL_1 = x1__h18226;
      2'd1: MUX_wide16Fa$enq_1__VAL_1 = x1__h18253;
  ...
  always@(wrtSerPos or
	  IF_wrtSerPos_75_EQ_2_78_THEN_0x0_ELSE_mesgWF_w_ETC___d418 or
	  x1__h17560 or x1__h17591)
  begin
    case (wrtSerPos)
      2'd0: MUX_wide16Fa$enq_1__VAL_2 = x1__h17560;
      2'd1: MUX_wide16Fa$enq_1__VAL_2 = x1__h17591;
      default: MUX_wide16Fa$enq_1__VAL_2 =
		   IF_wrtSerPos_75_EQ_2_78_THEN_0x0_ELSE_mesgWF_w_ETC___d418;
    endcase
  end
  ...
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_1 = { 4'd5, addr__h18912, 12'd1 } ;
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_2 = { 4'd3, addr__h19080, 12'd1 } ;
  ...
  assign mesgWF_wDataOut$wget = data__h17139 ;
  ...
  assign dlyRdOpOther$EN =
	     WILL_FIRE_RL_rdSer_begin && x1__h20389[31:24] != 8'd0 ;
  ...
  assign dlyReadCredit_value$EN = 1'd1 ;
  ...
  // register mesgWF_rCache
  assign mesgWF_rCache$D_IN = { 1'd1, mesgWF_rWrPtr, x__h14794 } ;
  assign mesgWF_rCache$EN = MUX_wsiS_reqFifo_levelsValid$write_1__SEL_3 ;

  // register mesgWF_rRdPtr
  assign mesgWF_rRdPtr$D_IN = x__h14686 ;
  ...
  // register rdSerMeta
  assign rdSerMeta$D_IN = x1__h20389 ;
  ...
  assign wrtSerStage$D_IN =
	     MUX_wrtSerStage$write_1__SEL_1 ? data__h17139 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_1$D_IN =
	     MUX_wrtSerStage_1$write_1__SEL_1 ? data__h17139 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_2$D_IN =
	     MUX_wrtSerStage_2$write_1__SEL_1 ? data__h17139 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_3$D_IN =
	     MUX_wrtSerStage_3$write_1__SEL_1 ? data__h17139 : metaWF$D_OUT ;
  ...
  assign wsiS_wordCount$D_IN =
	     wsiS_wsiReq$wget[57] ? 12'd0 : wsiS_wordCount + 12'd1 ;
  assign wsiS_wordCount$EN = wsiS_reqFifo_r_enq$whas ;

  // submodule mesgRF
  assign mesgRF$D_IN = x1__h20389 ;
  ...
  assign mesgWF_memory$DIA = x__h14794 ;
  assign mesgWF_memory$ADDRB =
	     CAN_FIRE_RL_wrtSer_body ? x__h14686[11:0] : mesgWF_rRdPtr[11:0] ;
  ...
  // remaining internal signals
  assign IF_wrtSerPos_75_EQ_0_76_OR_wrtSerPos_75_EQ_1_7_ETC___d395 =
	     CASE_wrtSerPos_0b1_0_1_1_1_2_1_3_0b1__q1 &&
	     (wrtSerPos != 2'd3 && wrtSerUnroll != 16'd1 ||
	      CASE_wrtSerPos_NOT_wrtSerPos_EQ_3_OR_wide16Fa_ETC__q2) ;
  assign IF_wrtSerPos_75_EQ_2_78_THEN_0x0_ELSE_mesgWF_w_ETC___d418 =
	     { (wrtSerPos == 2'd2) ? 32'h0 : data__h17139,
	       (wrtSerPos == 2'd2) ? data__h17139 : wrtSerStage_2,
	       wrtSerStage_1,
	       wrtSerStage } ;
  assign IF_wrtSerPos_75_EQ_2_78_THEN_0x0_ELSE_metaWF_f_ETC___d443 =
	     { (wrtSerPos == 2'd2) ? 32'h0 : metaWF$D_OUT,
	       (wrtSerPos == 2'd2) ? metaWF$D_OUT : wrtSerStage_2,
	       wrtSerStage_1,
	       wrtSerStage } ;
  assign NOT_mesgWF_rRdPtr_62_EQ_mesgWF_rWrPtr_64_67___d168 =
	     mesgWF_rRdPtr != mesgWF_rWrPtr ;
  assign NOT_mesgWF_rRdPtr_62_PLUS_2048_63_EQ_mesgWF_rW_ETC___d166 =
	     mesgWF_rRdPtr + 13'd2048 != mesgWF_rWrPtr ;
  assign NOT_wmemi_reqF_c_r_33_EQ_2_34_35_AND_NOT_wmemi_ETC___d362 =
	     wmemi_reqF_c_r != 2'd2 && wmemi_dhF_c_r != 2'd2 &&
	     wmemi_operateD &&
	     wmemi_peerIsReady ;
  assign NOT_wrtSerPos_75_EQ_3_82_83_AND_NOT_metaWF_fir_ETC___d430 =
	     wrtSerPos != 2'd3 && metaWF$D_OUT[23:0] != 24'd0 ||
	     CASE_wrtSerPos_NOT_wrtSerPos_EQ_3_OR_wide16Fa_ETC__q2 ;
  assign addr__h18912 = { 9'd0, x__h18970 } ;
  assign addr__h19080 = { 9'd0, x__h19125 } ;
  assign bytesWritten_6_ULT_dlyHoldoffBytes_6___d150 =
	     bytesWritten < dlyHoldoffBytes ;
  assign cyclesPassed_52_ULT_dlyHoldoffCycles_8___d153 =
	     cyclesPassed < dlyHoldoffCycles ;
  assign data__h17139 =
	     (mesgWF_rCache[45] && mesgWF_rCache[44:32] == mesgWF_rRdPtr) ?
	       mesgWF_rCache[31:0] :
	       mesgWF_memory$DOB ;
  assign delayStatus__h21238 =
	     { 15'h0,
	       dlyWordsStored_value_26_SLE_0_49_OR_bytesWritt_ETC___d157,
	       dlyWordsStored_value_26_SLT_8388608___d158,
	       wsiM_reqFifo_c_r != 2'd2,
	       ...
	       wide16Fc$FULL_N,
	       wide16Fc$EMPTY_N } ;
  assign dlyWordsStored_value_26_SLE_0_49_OR_bytesWritt_ETC___d157 =
	     dlyWordsStored_value_26_SLE_0___d149 ||
	     bytesWritten_6_ULT_dlyHoldoffBytes_6___d150 ||
	     cyclesPassed_52_ULT_dlyHoldoffCycles_8___d153 ||
	     wsiM_reqFifo_c_r == 2'd2 ;
  assign dlyWordsStored_value_26_SLE_0___d149 =
	     (dlyWordsStored_value ^ 25'h1000000) <= 25'd16777216 ;
  assign dlyWordsStored_value_26_SLT_8388608___d158 =
	     (dlyWordsStored_value ^ 25'h1000000) < 25'd25165824 ;
  assign mesgMetaF_length__h16565 = { 12'd0, x__h16572 } ;
  assign mesgRF_RDY_enq__59_AND_NOT_rdSerEmpty_60_61_AN_ETC___d272 =
	     mesgRF$FULL_N &&
	     (!rdSerEmpty && rdSerPos != 2'd0 || wide16Fc$EMPTY_N) ;
  assign metaRF_RDY_enq__04_AND_NOT_rdSerEmpty_60_61_AN_ETC___d305 =
	     metaRF$FULL_N &&
	     (!rdSerEmpty && rdSerPos != 2'd0 || wide16Fc$EMPTY_N) ;
  assign rdat__h21669 = hasDebugLogic ? mesgWtCount : 32'd0 ;
  assign rdat__h21675 = hasDebugLogic ? mesgRdCount : 32'd0 ;
  assign rdat__h21681 = hasDebugLogic ? bytesWritten : 32'd0 ;
  assign rdat__h21687 = hasDebugLogic ? { 8'd0, x__h21691 } : 32'd0 ;
  assign rdat__h21811 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h21825 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h21833 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h21839 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h21853 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h21861 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h21867 = hasDebugLogic ? wmemiWrReq : 32'd0 ;
  assign rdat__h21873 = hasDebugLogic ? wmemiRdReq : 32'd0 ;
  assign rdat__h21879 = hasDebugLogic ? wmemiRdResp : 32'd0 ;
  assign rdat__h21885 =
	     hasDebugLogic ?
  ...
  assign rdat__h21896 =
	     hasDebugLogic ?
	       ...
	       32'd0 ;
  assign rdat__h21907 = hasDebugLogic ? { 9'd0, dlyWAG } : 32'd0 ;
  assign rdat__h21918 = hasDebugLogic ? { 9'd0, dlyRAG } : 32'd0 ;
  assign rdat__h21939 = hasDebugLogic ? wmemiRdResp2 : 32'd0 ;
  assign rdat__h21993 =
	     { {16{dlyReadyToWrite_value[15]}}, dlyReadyToWrite_value } ;
  assign wci_cState_9_EQ_2_0_AND_dlyCtrl_4_BITS_3_TO_0__ETC___d345 =
	     wci_cState == 3'd2 && dlyCtrl[3:0] == 4'h7 &&
	     !dlyWordsStored_value_26_SLE_0___d149 &&
	     !bytesWritten_6_ULT_dlyHoldoffBytes_6___d150 &&
	     !cyclesPassed_52_ULT_dlyHoldoffCycles_8___d153 ;
  assign wci_cState_9_EQ_2_0_AND_dlyCtrl_4_BITS_3_TO_0__ETC___d366 =
	     wci_cState == 3'd2 && dlyCtrl[3:0] == 4'h7 &&
	     dlyWordsStored_value_26_SLE_0_49_OR_bytesWritt_ETC___d157 &&
	     dlyWordsStored_value_26_SLT_8388608___d158 ;
  assign wrtSerPos_75_PLUS_1___d918 = wrtSerPos + 2'd1 ;
  assign wsiS_reqFifo_notFull__97_AND_wsiS_burstKind_77_ETC___d715 =
	     wsiS_reqFifo$FULL_N &&
	     (wsiS_burstKind == 2'd0 ||
	      (wsiS_burstKind == 2'd1 || wsiS_burstKind == 2'd2) &&
	      wsiS_wsiReq$wget[57]) ;
  assign x1__h17560 = { 96'd0, data__h17139 } ;
  assign x1__h17591 = { 64'd0, data__h17139, wrtSerStage } ;
  assign x1__h18226 = { 96'd0, metaWF$D_OUT } ;
  assign x1__h18253 = { 64'd0, metaWF$D_OUT, wrtSerStage } ;
  assign x__h14686 = mesgWF_rRdPtr + 13'd1 ;
  assign x__h14794 =
	     MUX_wsiS_reqFifo_levelsValid$write_1__SEL_3 ?
	       wsiS_reqFifo$D_OUT[43:12] :
	       32'd0 ;
  assign x__h16572 = { wsiS_wordCount[9:0], 2'd0 } ;
  assign x__h18970 = { dlyRAG, 4'h0 } ;
  assign x__h19125 = { dlyWAG, 4'h0 } ;
  assign x__h21691 = { wmemi_statusR, wsiS_statusR, wsiM_statusR } ;
  assign x_burstLength__h19411 =
	     (readMeta[23:0] == 24'd0) ? 12'd1 : readMeta[13:2] ;
  assign x_byteEn__h19412 = (readMeta[23:0] == 24'd0) ? 4'd0 : 4'd15 ;
  always@(rdSerPos or
	  rdSerStage_3 or wide16Fc$D_OUT or rdSerStage_1 or rdSerStage_2)
  begin
    case (rdSerPos)
      2'd0: x1__h20389 = wide16Fc$D_OUT[31:0];
      2'd1: x1__h20389 = rdSerStage_1;
      2'd2: x1__h20389 = rdSerStage_2;
      2'd3: x1__h20389 = rdSerStage_3;
    endcase
  end
  always@(wrtSerPos)
  begin
  ...
  always@(wci_reqF$D_OUT or
	  ...
	  rdat__h21918 or
	  dlyRdOpZero or
	  dlyRdOpOther or rdat__h21939 or delayStatus__h21238 or rdat__h21993)
  begin
    case (wci_reqF$D_OUT[51:32])
      20'h0: x_data__h21642 = dlyCtrl;
      20'h00004: x_data__h21642 = dlyHoldoffBytes;
      20'h00008: x_data__h21642 = dlyHoldoffCycles;
      20'h0000C: x_data__h21642 = rdat__h21669;
      20'h00010: x_data__h21642 = rdat__h21675;
      20'h00014: x_data__h21642 = rdat__h21681;
      20'h00018: x_data__h21642 = rdat__h21687;
      20'h0001C: x_data__h21642 = 32'd0;
      20'h00020: x_data__h21642 = rdat__h21811;
      20'h00024: x_data__h21642 = rdat__h21825;
      20'h00028: x_data__h21642 = rdat__h21833;
      20'h0002C: x_data__h21642 = rdat__h21839;
      20'h00030: x_data__h21642 = rdat__h21853;
      20'h00034: x_data__h21642 = rdat__h21861;
      20'h00038: x_data__h21642 = rdat__h21867;
      20'h0003C: x_data__h21642 = rdat__h21873;
      20'h00040: x_data__h21642 = rdat__h21879;
      20'h00044: x_data__h21642 = rdat__h21885;
      20'h00048: x_data__h21642 = rdat__h21896;
      20'h0004C: x_data__h21642 = rdat__h21907;
      20'h00050: x_data__h21642 = rdat__h21918;
      20'h00058: x_data__h21642 = dlyRdOpZero;
      20'h0005C: x_data__h21642 = dlyRdOpOther;
      20'h00060: x_data__h21642 = rdat__h21939;
      20'h00064: x_data__h21642 = delayStatus__h21238;
      20'h00068: x_data__h21642 = rdat__h21993;
      default: x_data__h21642 = 32'd0;
    endcase
  end
  ...
  begin
	...
	wsiS_wordCount <= `BSV_ASSIGNMENT_DELAY 12'd0;
      end
    else
      begin
