...
//
// On Mon Jul 12 17:43:21 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker4B(wciS0_Clk,
  ...
  reg [63 : 0] v__h17546,
	       ...
	       v__h2820,
	       v__h3719;
  reg [31 : 0] x1__h23902, x_data__h22178;
  reg CASE_wrtSerPos_0b1_0_1_1_1_2_1_3_0b1__q1,
      CASE_wrtSerPos_NOT_wrtSerPos_EQ_3_OR_wide16Fa_ETC__q2;
  wire [127 : 0] IF_wrtSerPos_40_EQ_2_43_THEN_0x0_ELSE_mesgWF_w_ETC___d383,
		 IF_wrtSerPos_40_EQ_2_43_THEN_0x0_ELSE_metaWF_f_ETC___d408,
		 x1__h19940,
		 x1__h19971,
		 x1__h20636,
		 x1__h20663;
  ...
  wire [12 : 0] x__h15249;
  wire [11 : 0] x_burstLength__h22892;
  wire [7 : 0] x1_opcode__h17238;
  wire [3 : 0] x_byteEn__h22893;
  wire [1 : 0] wrtSerPos_40_PLUS_1___d1013;
  wire IF_wrtSerPos_40_EQ_0_41_OR_wrtSerPos_40_EQ_1_4_ETC___d360,
       NOT_dlyWordsStored_value_27_SLE_0_80_81_AND_NO_ETC___d288,
       NOT_wrtSerPos_40_EQ_3_47_48_AND_NOT_metaWF_fir_ETC___d395,
       ...
       wci_cState_9_EQ_2_0_AND_dlyCtrl_5_BITS_3_TO_0__ETC___d292,
       wci_cState_9_EQ_2_0_AND_dlyCtrl_5_BITS_3_TO_0__ETC___d324,
       wci_cState_9_EQ_2_0_AND_dlyCtrl_5_BITS_3_TO_0__ETC___d428,
       wsiS_reqFifo_notFull__26_AND_wsiS_burstKind_06_ETC___d742;
  ...
  assign CAN_FIRE_RL_wrtSer_body =
	     ...
	     IF_wrtSerPos_40_EQ_0_41_OR_wrtSerPos_40_EQ_1_4_ETC___d360 &&
	     wci_cState == 3'd2 &&
	     dlyCtrl[3:0] == 4'h7 &&
	     wrtSerUnroll != 16'd0 ;
  ...
  assign MUX_dlyWordsStored_value$write_1__VAL_2 =
	     ...
	     (WILL_FIRE_RL_delay_write_req ? 24'd1 : 24'd0) +
	     (CAN_FIRE_RL_delay_read_req ? 24'd16777215 : 24'd0) ;
  ...
  assign MUX_rdSyncWord$write_1__VAL_2 =
	     rdSerPos != 2'd3 && x1__h23902[23:0] == 24'd0 ;
  ...
  always@(wrtSerPos or
	  IF_wrtSerPos_40_EQ_2_43_THEN_0x0_ELSE_mesgWF_w_ETC___d383 or
  ...
  begin
    case (wrtSerPos)
      ...
      default: MUX_wide16Fa$enq_1__VAL_2 =
		   IF_wrtSerPos_40_EQ_2_43_THEN_0x0_ELSE_mesgWF_w_ETC___d383;
    endcase
  end
  always@(wrtSerPos or
	  IF_wrtSerPos_40_EQ_2_43_THEN_0x0_ELSE_metaWF_f_ETC___d408 or
  ...
  assign MUX_dlyReadyToWrite_value$write_1__VAL_2 =
	     ...
	     (WILL_FIRE_RL_delay_write_req ? 5'd31 : 5'd0) ;
  ...
  assign dlyWriteJustFired_1$whas = WILL_FIRE_RL_delay_write_req ;
  ...
  // register dlyWriteJustFired
  assign dlyWriteJustFired$D_IN = WILL_FIRE_RL_delay_write_req ;
  ...
  // register rdSerMeta
  assign rdSerMeta$D_IN = x1__h23902 ;
  ...
  // remaining internal signals
  assign IF_wrtSerPos_40_EQ_0_41_OR_wrtSerPos_40_EQ_1_4_ETC___d360 =
	     CASE_wrtSerPos_0b1_0_1_1_1_2_1_3_0b1__q1 &&
	     (wrtSerPos != 2'd3 && wrtSerUnroll != 16'd1 ||
	      CASE_wrtSerPos_NOT_wrtSerPos_EQ_3_OR_wide16Fa_ETC__q2) ;
  assign IF_wrtSerPos_40_EQ_2_43_THEN_0x0_ELSE_mesgWF_w_ETC___d383 =
	     { (wrtSerPos == 2'd2) ? 32'h0 : data__h19519,
	       (wrtSerPos == 2'd2) ? data__h19519 : wrtSerStage_2,
	       wrtSerStage_1,
	       wrtSerStage } ;
  assign IF_wrtSerPos_40_EQ_2_43_THEN_0x0_ELSE_metaWF_f_ETC___d408 =
  ...
  assign NOT_wrtSerPos_40_EQ_3_47_48_AND_NOT_metaWF_fir_ETC___d395 =
	     wrtSerPos != 2'd3 && metaWF$D_OUT[23:0] != 24'd0 ||
	     CASE_wrtSerPos_NOT_wrtSerPos_EQ_3_OR_wide16Fa_ETC__q2 ;
  ...
  assign wci_cState_9_EQ_2_0_AND_dlyCtrl_5_BITS_3_TO_0__ETC___d292 =
	     wci_cState == 3'd2 && dlyCtrl[3:0] == 4'h7 &&
	     NOT_dlyWordsStored_value_27_SLE_0_80_81_AND_NO_ETC___d288 &&
	     (dlyReadCredit_value ^ 8'h80) > 8'd128 ;
  assign wci_cState_9_EQ_2_0_AND_dlyCtrl_5_BITS_3_TO_0__ETC___d324 =
	     wci_cState == 3'd2 && dlyCtrl[3:0] == 4'h7 &&
	     ((dlyWriteJustFired || dlyWriteFlush == 8'd255) ?
		(dlyReadyToWrite_value ^ 5'h10) > 5'd16 :
		(dlyReadyToWrite_value ^ 5'h10) > 5'd19) ;
  assign wci_cState_9_EQ_2_0_AND_dlyCtrl_5_BITS_3_TO_0__ETC___d428 =
	     wci_cState == 3'd2 && dlyCtrl[3:0] == 4'h7 && mesgLength[14] &&
	     !doAbort &&
	     (preciseBurst && wsiWordsRemain == 12'd0 ||
	      impreciseBurst && endOfMessage) ;
  assign wrtSerPos_40_PLUS_1___d1013 = wrtSerPos + 2'd1 ;
  assign wsiS_reqFifo_notFull__26_AND_wsiS_burstKind_06_ETC___d742 =
	     wsiS_reqFifo$FULL_N &&
	     (wsiS_burstKind == 2'd0 ||
  ...
  assign x_burstLength__h22892 =
	     (readMeta[23:0] == 24'd0) ? 12'd1 : readMeta[13:2] ;
  assign x_byteEn__h22893 = (readMeta[23:0] == 24'd0) ? 4'd0 : 4'd15 ;
  always@(rdSerPos or
	  rdSerStage_3 or wide16Fb$D_OUT or rdSerStage_1 or rdSerStage_2)
  begin
    case (rdSerPos)
      2'd0: x1__h23902 = wide16Fb$D_OUT[31:0];
      2'd1: x1__h23902 = rdSerStage_1;
      2'd2: x1__h23902 = rdSerStage_2;
      2'd3: x1__h23902 = rdSerStage_3;
    endcase
  end
  always@(wci_reqF$D_OUT or
	  ...
	  rdat__h22416 or
	  rdat__h22422 or
	  rdat__h22432 or rdat__h22442 or rdat__h22452 or rdat__h22462)
  begin
