...
//
// On Tue Dec 28 16:50:24 EST 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker4B(wciS0_Clk,
  ...
  reg [63 : 0] v__h22830, v__h3594, v__h3768, v__h3912;
  reg [31 : 0] g_data__h22166, v__h19821;
  ...
  wire [127 : 0] IF_wrtSerPos_82_EQ_2_92_THEN_0x0_ELSE_mesgWF_w_ETC___d549,
		 ...
		 x__h18732,
		 x__h18756;
  wire [35 : 0] addr__h19156, addr__h19506;
  wire [31 : 0] data__h18447,
		delayStatus__h21786,
		rdat__h22193,
		rdat__h22199,
		rdat__h22205,
		...
		rdat__h22545,
		x__h14846;
  wire [26 : 0] x__h19214, x__h19551;
  wire [23 : 0] btm__h17335, x__h22215;
  wire [13 : 0] mesgLengthSoFar_65_PLUS_1___d968;
  wire [12 : 0] x__h14947;
  wire [11 : 0] x_burstLength__h21693;
  wire [3 : 0] x_byteEn__h21694;
  ...
  assign MUX_rdSyncWord$write_1__VAL_1 =
	     rdSerPos != 2'd3 && v__h19821[23:0] == 24'd0 ;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, g_data__h22166 } ;
  always@(wrtSerPos or
	  IF_wrtSerPos_82_EQ_2_92_THEN_0x0_ELSE_metaWF_f_ETC___d520 or
	  x__h18082 or x__h18109)
  begin
    case (wrtSerPos)
      2'd0: MUX_wide16Fa$enq_1__VAL_1 = x__h18082;
      2'd1: MUX_wide16Fa$enq_1__VAL_1 = x__h18109;
  ...
  always@(wrtSerPos or
	  ...
	  x__h18732 or x__h18756)
  begin
    case (wrtSerPos)
      2'd0: MUX_wide16Fa$enq_1__VAL_2 = x__h18732;
      2'd1: MUX_wide16Fa$enq_1__VAL_2 = x__h18756;
  ...
  assign MUX_wmemi_reqF_q_1$write_1__VAL_2 =
	     (wmemi_reqF_c_r == 2'd2) ?
	       MUX_wmemi_reqF_q_0$write_1__VAL_1 :
	       52'h0AAAAAAAAAAAA ;
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_1 = { 4'd3, addr__h19156, 12'd1 } ;
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_2 = { 4'd5, addr__h19506, 12'd1 } ;
  ...
  assign mesgWF_wDataOut$wget = data__h18447 ;
  ...
  // register bytesThisMessage
  assign bytesThisMessage$D_IN = btm__h17335 ;
  ...
  assign dlyRdOpOther$EN =
	     WILL_FIRE_RL_rdSer_begin && v__h19821[31:24] != 8'd0 ;
  ...
  // register mesgWF_rCache
  assign mesgWF_rCache$D_IN = { 1'd1, mesgWF_rWrPtr, x__h14846 } ;
  assign mesgWF_rCache$EN = CAN_FIRE_RL_wmwt_mesg_ingress ;

  // register mesgWF_rRdPtr
  assign mesgWF_rRdPtr$D_IN = x__h14947 ;
  ...
  // register rdSerMeta
  assign rdSerMeta$D_IN = v__h19821 ;
  ...
  assign wrtSerStage$D_IN =
	     MUX_wrtSerStage$write_1__SEL_1 ? data__h18447 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_1$D_IN =
	     MUX_wrtSerStage_1$write_1__SEL_1 ? data__h18447 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_2$D_IN =
	     MUX_wrtSerStage_2$write_1__SEL_1 ? data__h18447 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_3$D_IN =
	     MUX_wrtSerStage_3$write_1__SEL_1 ? data__h18447 : metaWF$D_OUT ;
  ...
  assign mesgWF_memory$ADDRB =
	     CAN_FIRE_RL_wrtSer_body ? x__h14947[11:0] : mesgWF_rRdPtr[11:0] ;
  assign mesgWF_memory$DIA = x__h14846 ;
  ...
  assign IF_wrtSerPos_82_EQ_2_92_THEN_0x0_ELSE_mesgWF_w_ETC___d549 =
	     { (wrtSerPos == 2'd2) ? 32'h0 : data__h18447,
	       (wrtSerPos == 2'd2) ? data__h18447 : wrtSerStage_2,
	       wrtSerStage_1,
	       wrtSerStage } ;
  ...
  assign NOT_wrtSerPos_82_EQ_3_83_84_AND_NOT_metaWF_fir_ETC___d498 =
	     wrtSerPos != 2'd3 && metaWF$D_OUT[23:0] != 24'd0 ||
	     CASE_wrtSerPos_NOT_wrtSerPos_EQ_3_OR_wide16Fa_ETC__q1 ;
  assign addr__h19156 = { 9'd0, x__h19214 } ;
  assign addr__h19506 = { 9'd0, x__h19551 } ;
  assign btm__h17335 =
  ...
  assign metaRF_i_notFull__12_AND_NOT_rdSerEmpty_13_14__ETC___d623 =
	     metaRF$FULL_N &&
	     (!rdSerEmpty && rdSerPos != 2'd0 || wide16Fc$EMPTY_N) ;
  assign rdat__h22193 = hasDebugLogic ? mesgWtCount : 32'd0 ;
  assign rdat__h22199 = hasDebugLogic ? mesgRdCount : 32'd0 ;
  assign rdat__h22205 = hasDebugLogic ? bytesWritten : 32'd0 ;
  assign rdat__h22211 = hasDebugLogic ? { 8'd0, x__h22215 } : 32'd0 ;
  assign rdat__h22335 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h22349 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h22357 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h22363 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h22377 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h22385 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h22391 = hasDebugLogic ? wmemiWrReq : 32'd0 ;
  assign rdat__h22397 = hasDebugLogic ? wmemiRdReq : 32'd0 ;
  assign rdat__h22403 = hasDebugLogic ? wmemiRdResp1 : 32'd0 ;
  assign rdat__h22409 =
	     hasDebugLogic ?
  ...
  assign rdat__h22420 =
	     hasDebugLogic ?
	       ...
	       32'd0 ;
  assign rdat__h22431 = hasDebugLogic ? { 9'd0, dlyWAG } : 32'd0 ;
  assign rdat__h22442 = hasDebugLogic ? { 9'd0, dlyRAG } : 32'd0 ;
  assign rdat__h22463 = hasDebugLogic ? wmemiRdResp2 : 32'd0 ;
  assign rdat__h22518 =
	     { {16{dlyReadyToWrite_value[15]}}, dlyReadyToWrite_value } ;
  assign rdat__h22527 = { 16'd0, wrtSerUnroll } ;
  assign rdat__h22536 = { 8'd0, bytesThisMessage } ;
  assign rdat__h22545 = { 18'd0, mesgLengthSoFar } ;
  ...
  assign x__h14846 =
	     CAN_FIRE_RL_wmwt_mesg_ingress ?
	       ...
	       32'd0 ;
  assign x__h14947 = mesgWF_rRdPtr + 13'd1 ;
  assign x__h18082 = { 96'd0, metaWF$D_OUT } ;
  assign x__h18109 = { 64'd0, metaWF$D_OUT, wrtSerStage } ;
  assign x__h18732 = { 96'd0, data__h18447 } ;
  assign x__h18756 = { 64'd0, data__h18447, wrtSerStage } ;
  assign x__h19214 = { dlyWAG, 4'h0 } ;
  assign x__h19551 = { dlyRAG, 4'h0 } ;
  assign x__h22215 = { wmemi_statusR, wsiS_statusR, wsiM_statusR } ;
  assign x_burstLength__h21693 =
	     (readMeta[23:0] == 24'd0) ? 12'd1 : readMeta[13:2] ;
  assign x_byteEn__h21694 = (readMeta[23:0] == 24'd0) ? 4'd0 : 4'd15 ;
  always@(rdSerPos or
	  rdSerStage_3 or wide16Fc$D_OUT or rdSerStage_1 or rdSerStage_2)
  begin
    case (rdSerPos)
      2'd0: v__h19821 = wide16Fc$D_OUT[31:0];
      2'd1: v__h19821 = rdSerStage_1;
      2'd2: v__h19821 = rdSerStage_2;
      2'd3: v__h19821 = rdSerStage_3;
    endcase
  end
  ...
  always@(wci_reqF$D_OUT or
	  ...
	  dlyRdOpOther or
	  rdat__h22463 or
	  delayStatus__h21786 or
	  rdat__h22518 or rdat__h22527 or rdat__h22536 or rdat__h22545)
  begin
    case (wci_reqF$D_OUT[51:32])
      20'h0: g_data__h22166 = dlyCtrl;
      20'h00004: g_data__h22166 = dlyHoldoffBytes;
      20'h00008: g_data__h22166 = dlyHoldoffCycles;
      20'h0000C: g_data__h22166 = rdat__h22193;
      20'h00010: g_data__h22166 = rdat__h22199;
      20'h00014: g_data__h22166 = rdat__h22205;
      20'h00018: g_data__h22166 = rdat__h22211;
      20'h0001C: g_data__h22166 = 32'd0;
      20'h00020: g_data__h22166 = rdat__h22335;
      20'h00024: g_data__h22166 = rdat__h22349;
      20'h00028: g_data__h22166 = rdat__h22357;
      20'h0002C: g_data__h22166 = rdat__h22363;
      20'h00030: g_data__h22166 = rdat__h22377;
      20'h00034: g_data__h22166 = rdat__h22385;
      20'h00038: g_data__h22166 = rdat__h22391;
      20'h0003C: g_data__h22166 = rdat__h22397;
      20'h00040: g_data__h22166 = rdat__h22403;
      20'h00044: g_data__h22166 = rdat__h22409;
      20'h00048: g_data__h22166 = rdat__h22420;
      20'h0004C: g_data__h22166 = rdat__h22431;
      20'h00050: g_data__h22166 = rdat__h22442;
      20'h00058: g_data__h22166 = dlyRdOpZero;
      20'h0005C: g_data__h22166 = dlyRdOpOther;
      20'h00060: g_data__h22166 = rdat__h22463;
      20'h00064: g_data__h22166 = delayStatus__h21786;
      20'h00068: g_data__h22166 = rdat__h22518;
      20'h0006C: g_data__h22166 = rdat__h22527;
      20'h00070: g_data__h22166 = rdat__h22536;
      20'h00074: g_data__h22166 = rdat__h22545;
      default: g_data__h22166 = 32'd0;
    endcase
  end
