...
//
// On Thu Jun 17 09:01:05 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker4B(wciS0_Clk,
  ...
  reg [63 : 0] v__h17561,
	       ...
	       v__h2817,
	       v__h3716;
  reg [31 : 0] sendData__h23416, x_data__h21803;
  reg CASE_wrtSerPos_0b1_0_1_1_1_2_1_3_0b1__q1,
      IF_wrtSerPos_10_EQ_0_11_OR_wrtSerPos_10_EQ_1_1_ETC___d896;
  wire [127 : 0] IF_wrtSerPos_10_EQ_2_13_THEN_0x0_ELSE_mesgWF_w_ETC___d352,
		 ...
		 x1__h20491,
		 x1__h20500;
  wire [35 : 0] addr__h20993, addr__h21165;
  wire [31 : 0] data__h19622,
		mesg__h22345,
		rdat__h21846,
		rdat__h22029,
		rdat__h22037,
		...
		x__h15234,
		x__h16160;
  wire [26 : 0] x__h21051, x__h21210;
  wire [23 : 0] x1_length__h17254, x__h21849;
  wire [13 : 0] mlp1__h17953, x__h17298;
  wire [11 : 0] x_burstLength__h22436;
  wire [10 : 0] x__h15126, x__h16052;
  wire [7 : 0] x1_opcode__h17253;
  wire [3 : 0] x_byteEn__h22437;
  wire [1 : 0] wrtSerPos_10_PLUS_1___d984;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, x_data__h21803 } ;
  ...
  assign MUX_wci_respF_q_1$write_1__VAL_1 =
	     (wci_respF_c_r == 2'd2) ?
	       MUX_wci_respF_q_0$write_1__VAL_2 :
	       34'h0AAAAAAAA ;
  assign MUX_mesgLength$write_1__VAL_3 = { 1'd1, mlp1__h17953[11:0], 2'd0 } ;
  ...
  assign MUX_metaWF$enq_1__VAL_1 = { x1_opcode__h17253, x1_length__h17254 } ;
  ...
  assign MUX_rdSyncWord$write_1__VAL_2 =
	     rdSerPos != 2'd3 && sendData__h23416[23:0] == 24'd0 ;
  ...
  always@(wrtSerPos or
	  ...
	  x1__h20491 or x1__h20500)
  begin
    case (wrtSerPos)
      2'd0: MUX_wide16Fa$enq_1__VAL_1 = x1__h20491;
      2'd1: MUX_wide16Fa$enq_1__VAL_1 = x1__h20500;
  ...
  always@(wrtSerPos or
	  ...
	  x1__h19968 or x1__h19977)
  begin
    case (wrtSerPos)
      2'd0: MUX_wide16Fa$enq_1__VAL_2 = x1__h19968;
      2'd1: MUX_wide16Fa$enq_1__VAL_2 = x1__h19977;
  ...
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_1 = { 4'd5, addr__h20993, 12'd1 } ;
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_2 = { 4'd3, addr__h21165, 12'd1 } ;
  ...
  // register rdSerMeta
  assign rdSerMeta$D_IN = sendData__h23416 ;
  ...
  assign wrtSerStage$D_IN =
	     MUX_wrtSerStage$write_1__SEL_1 ? data__h19622 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_1$D_IN =
	     MUX_wrtSerStage_1$write_1__SEL_1 ? data__h19622 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_2$D_IN =
	     MUX_wrtSerStage_2$write_1__SEL_1 ? data__h19622 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_3$D_IN =
	     MUX_wrtSerStage_3$write_1__SEL_1 ? data__h19622 : metaWF$D_OUT ;
  ...
  // submodule metaRF
  assign metaRF$D_IN = sendData__h23416 ;
  ...
  assign IF_wrtSerPos_10_EQ_2_13_THEN_0x0_ELSE_mesgWF_w_ETC___d352 =
	     { (wrtSerPos == 2'd2) ? 32'h0 : data__h19622,
	       (wrtSerPos == 2'd2) ? data__h19622 : wrtSerStage_2,
	       wrtSerStage_1,
	       wrtSerStage } ;
  ...
  assign _dor1bytesWritten$EN_write =
	     WILL_FIRE_RL_wmwt_messagePushPrecise ||
	     WILL_FIRE_RL_wmwt_messagePushImprecise ;
  assign addr__h20993 = { 9'd0, x__h21051 } ;
  assign addr__h21165 = { 9'd0, x__h21210 } ;
  assign data__h19622 =
  ...
  assign metaWF_RDY_deq__56_AND_NOT_wrtSerPos_10_EQ_3_1_ETC___d363 =
	     ...
	     (wrtSerPos != 2'd3 && metaWF$D_OUT[23:0] != 24'd0 ||
	      IF_wrtSerPos_10_EQ_0_11_OR_wrtSerPos_10_EQ_1_1_ETC___d896) ;
  assign mlp1__h17953 = MUX_mesgLengthSoFar$write_1__VAL_2 ;
  assign rdat__h21846 = { 8'd0, x__h21849 } ;
  assign rdat__h22029 = { 9'd0, dlyWordsStored_value } ;
  assign rdat__h22037 = { 24'd0, dlyReadCredit_value } ;
  assign rdat__h22045 = { 9'd0, dlyWAG } ;
  assign rdat__h22053 = { 9'd0, dlyRAG } ;
  ...
  assign wrtSerPos_10_PLUS_1___d984 = wrtSerPos + 2'd1 ;
  assign x1__h19968 = { 96'd0, data__h19622 } ;
  assign x1__h19977 = { 64'd0, data__h19622, wrtSerStage } ;
  assign x1__h20491 = { 96'd0, metaWF$D_OUT } ;
  assign x1__h20500 = { 64'd0, metaWF$D_OUT, wrtSerStage } ;
  assign x1_length__h17254 = { 10'd0, x__h17298 } ;
  assign x1_opcode__h17253 = opcode[8] ? opcode[7:0] : 8'd0 ;
  ...
  assign x__h16160 = CAN_FIRE_RL_rdSer_body ? sendData__h23416 : 32'd0 ;
  assign x__h17298 = mesgLength[14] ? mesgLength[13:0] : 14'd0 ;
  assign x__h21051 = { dlyRAG, 4'h0 } ;
  assign x__h21210 = { dlyWAG, 4'h0 } ;
  assign x__h21849 = { wmemi_statusR, wsiS_statusR, wsiM_statusR } ;
  assign x_burstLength__h22436 =
	     (readMeta[23:0] == 24'd0) ? 12'd1 : readMeta[13:2] ;
  assign x_byteEn__h22437 = (readMeta[23:0] == 24'd0) ? 4'd0 : 4'd15 ;
  always@(wci_reqF$D_OUT or
	  ...
	  wmemiRdReq or
	  wmemiRdResp or
	  rdat__h22029 or rdat__h22037 or rdat__h22045 or rdat__h22053)
  begin
    case (wci_reqF$D_OUT[51:32])
      20'h0: x_data__h21803 = dlyCtrl;
      20'h00004: x_data__h21803 = dlyHoldoffBytes;
      20'h00008: x_data__h21803 = dlyHoldoffCycles;
      20'h0000C: x_data__h21803 = mesgWtCount;
      20'h00010: x_data__h21803 = mesgRdCount;
      20'h00014: x_data__h21803 = bytesWritten;
      20'h00018: x_data__h21803 = rdat__h21846;
      20'h0001C: x_data__h21803 = 32'd0;
      20'h00020: x_data__h21803 = wsiS_extStatusW$wget[95:64];
      20'h00024: x_data__h21803 = wsiS_extStatusW$wget[63:32];
      20'h00028: x_data__h21803 = wsiS_extStatusW$wget[31:0];
      20'h0002C: x_data__h21803 = wsiM_extStatusW$wget[95:64];
      20'h00030: x_data__h21803 = wsiM_extStatusW$wget[63:32];
      20'h00034: x_data__h21803 = wsiM_extStatusW$wget[31:0];
      20'h00038: x_data__h21803 = wmemiWrReq;
      20'h0003C: x_data__h21803 = wmemiRdReq;
      20'h00040: x_data__h21803 = wmemiRdResp;
      20'h00044: x_data__h21803 = rdat__h22029;
      20'h00048: x_data__h21803 = rdat__h22037;
      20'h0004C: x_data__h21803 = rdat__h22045;
      20'h00050: x_data__h21803 = rdat__h22053;
      default: x_data__h21803 = 32'd0;
    endcase
  end
  always@(rdSerPos or
  ...
  begin
    case (rdSerPos)
      2'd0: sendData__h23416 = wide16Fb$D_OUT[31:0];
      2'd1: sendData__h23416 = rdSerStage_1;
      2'd2: sendData__h23416 = rdSerStage_2;
      2'd3: sendData__h23416 = rdSerStage_3;
    endcase
  end
  ...
  begin
    ...
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wmwt_doAbort)
	$display("[%0d]: %m: wmwt_doAbort", v__h17806);
    if (wciS0_MReset_n)
