...
//
// On Thu Jun  3 15:11:50 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker4B(wciS0_Clk,
  ...
  reg [63 : 0] v__h17359,
	       ...
	       v__h2812,
	       v__h3711;
  reg [31 : 0] sendData__h22659, x_data__h21173;
  ...
  wire [31 : 0] data__h19361,
		...
		x__h15021,
		x__h15947;
  wire [23 : 0] x1_length__h17052, x__h20489, x__h20633, x__h21220;
  wire [13 : 0] mlp1__h17751, x__h17096;
  wire [11 : 0] x_burstLength__h21791;
  wire [10 : 0] x__h14913, x__h15839;
  wire [7 : 0] x1_opcode__h17051;
  wire [3 : 0] x_byteEn__h21792;
  ...
  assign MUX_wmemi_dhF_q_0$write_1__VAL_1 = { 2'd3, wide16Fa$D_OUT, 16'd0 } ;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, x_data__h21173 } ;
  ...
  assign mesgRF_wDataIn$wget = sendData__h22659 ;
  assign mesgRF_wDataIn$whas = CAN_FIRE_RL_rdSer_body ;
  assign mesgRF_wDataOut$wget = mesg__h21700 ;
  ...
  assign mesgLengthSoFar$D_IN =
	     MUX_impreciseBurst$write_1__SEL_2 ? 14'd0 : mlp1__h17751 ;
  ...
  // register rdSerMeta
  assign rdSerMeta$D_IN = sendData__h22659 ;
  ...
  // submodule metaRF
  assign metaRF$D_IN = sendData__h22659 ;
  ...
  assign metaRF_RDY_enq__28_AND_NOT_rdSerEmpty_94_95_AN_ETC___d229 =
	     metaRF$FULL_N &&
	     (!rdSerEmpty && rdSerPos != 2'd0 || wide16Fb$EMPTY_N) ;
  assign mlp1__h17751 = mesgLengthSoFar + 14'd1 ;
  assign rdat__h21217 = { 8'd0, x__h21220 } ;
  assign rdat__h21426 = { 12'd0, dlyWordsStored_value } ;
  assign rdat__h21434 = { 24'd0, dlyReadCredit_value } ;
  assign rdat__h21442 = { 12'd0, dlyWAG } ;
  assign rdat__h21450 = { 12'd0, dlyRAG } ;
  ...
  assign x__h15947 = CAN_FIRE_RL_rdSer_body ? sendData__h22659 : 32'd0 ;
  assign x__h17096 = mesgLength[14] ? mesgLength[13:0] : 14'd0 ;
  assign x__h20489 = { dlyRAG, 4'h0 } ;
  assign x__h20633 = { dlyWAG, 4'h0 } ;
  assign x__h21220 = { wmemi_statusR, wsiS_statusR, wsiM_statusR } ;
  assign x_burstLength__h21791 =
	     (readMeta[23:0] == 24'd0) ? 12'd1 : readMeta[13:2] ;
  assign x_byteEn__h21792 = (readMeta[23:0] == 24'd0) ? 4'd0 : 4'd15 ;
  always@(rdSerPos or
	  rdSerStage_3 or wide16Fb$D_OUT or rdSerStage_1 or rdSerStage_2)
  begin
    case (rdSerPos)
      2'd0: sendData__h22659 = wide16Fb$D_OUT[31:0];
      2'd1: sendData__h22659 = rdSerStage_1;
      2'd2: sendData__h22659 = rdSerStage_2;
      2'd3: sendData__h22659 = rdSerStage_3;
    endcase
  end
  always@(wrtSerPos)
  begin
  ...
  always@(wci_reqF$D_OUT or
	  ...
	  wmemiRdReq or
	  wmemiRdResp or
	  rdat__h21426 or rdat__h21434 or rdat__h21442 or rdat__h21450)
  begin
    case (wci_reqF$D_OUT[51:32])
      20'h0: x_data__h21173 = dlyCtrl;
      20'h00004: x_data__h21173 = dlyHoldoff;
      20'h00008: x_data__h21173 = mesgWtCount;
      20'h0000C: x_data__h21173 = mesgRdCount;
      20'h00010, 20'h00014: x_data__h21173 = 32'd0;
      20'h00018: x_data__h21173 = rdat__h21217;
      20'h00020: x_data__h21173 = wsiS_extStatusW$wget[95:64];
      20'h00024: x_data__h21173 = wsiS_extStatusW$wget[63:32];
      20'h00028: x_data__h21173 = wsiS_extStatusW$wget[31:0];
      20'h0002C: x_data__h21173 = wsiM_extStatusW$wget[95:64];
      20'h00030: x_data__h21173 = wsiM_extStatusW$wget[63:32];
      20'h00034: x_data__h21173 = wsiM_extStatusW$wget[31:0];
      20'h00038: x_data__h21173 = wmemiWrReq;
      20'h0003C: x_data__h21173 = wmemiRdReq;
      20'h00040: x_data__h21173 = wmemiRdResp;
      20'h00044: x_data__h21173 = rdat__h21426;
      20'h00048: x_data__h21173 = rdat__h21434;
      20'h0004C: x_data__h21173 = rdat__h21442;
      20'h00050: x_data__h21173 = rdat__h21450;
      default: x_data__h21173 = 32'd0;
    endcase
  end
