...
//
// On Mon Nov 15 15:54:17 EST 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker4B(wciS0_Clk,
  ...
  reg [63 : 0] v__h22868, v__h3594, v__h3779, v__h3934;
  reg [31 : 0] v__h19843, x_data__h22198;
  reg CASE_wrtSerPos_0b1_0_1_1_1_2_1_3_0b1__q2,
      CASE_wrtSerPos_NOT_wrtSerPos_EQ_3_OR_wide16Fa_ETC__q1;
  wire [127 : 0] IF_wrtSerPos_82_EQ_2_92_THEN_0x0_ELSE_mesgWF_w_ETC___d549,
		 IF_wrtSerPos_82_EQ_2_92_THEN_0x0_ELSE_metaWF_f_ETC___d520,
		 x__h18104,
		 x__h18131,
		 x__h18754,
		 x__h18778;
  wire [35 : 0] addr__h19178, addr__h19528;
  wire [31 : 0] data__h18469,
		delayStatus__h21808,
		rdat__h22231,
		rdat__h22237,
		rdat__h22243,
		...
		rdat__h22583,
		x__h14868;
  wire [26 : 0] x__h19236, x__h19573;
  wire [23 : 0] btm__h17357, x__h22253;
  wire [13 : 0] mesgLengthSoFar_65_PLUS_1___d955;
  wire [12 : 0] x__h14969;
  wire [11 : 0] x_burstLength__h21715;
  wire [3 : 0] x_byteEn__h21716;
  wire [1 : 0] wrtSerPos_82_PLUS_1___d954;
  wire IF_wrtSerPos_82_EQ_0_90_OR_wrtSerPos_82_EQ_1_9_ETC___d535,
       NOT_mesgWF_rRdPtr_96_EQ_mesgWF_rWrPtr_87_23___d524,
       NOT_mesgWF_rRdPtr_96_PLUS_2048_52_EQ_mesgWF_rW_ETC___d454,
       NOT_wrtSerPos_82_EQ_3_83_84_AND_NOT_metaWF_fir_ETC___d498,
       bytesWritten_78_ULT_dlyHoldoffBytes_57___d1010,
       cyclesPassed_48_ULT_dlyHoldoffCycles_60___d1008,
       dlyWordsStored_value_09_SLE_0_56_OR_bytesWritt_ETC___d564,
       dlyWordsStored_value_09_SLE_0___d1009,
       dlyWordsStored_value_09_SLT_8388608___d566,
       mesgRF_i_notFull__63_AND_NOT_rdSerEmpty_13_14__ETC___d664,
       metaRF_i_notFull__12_AND_NOT_rdSerEmpty_13_14__ETC___d623,
       wci_cState_5_EQ_2_6_AND_dlyCtrl_40_BITS_3_TO_0_ETC___d584,
  ...
  assign CAN_FIRE_RL_wrtSer_body =
	     NOT_mesgWF_rRdPtr_96_EQ_mesgWF_rWrPtr_87_23___d524 &&
	     IF_wrtSerPos_82_EQ_0_90_OR_wrtSerPos_82_EQ_1_9_ETC___d535 &&
	     wci_cState == 3'd2 &&
	     dlyCtrl[3:0] == 4'h7 &&
	     wrtSerUnroll != 16'd0 ;
  ...
  assign MUX_rdSyncWord$write_1__VAL_1 =
	     rdSerPos != 2'd3 && v__h19843[23:0] == 24'd0 ;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, x_data__h22198 } ;
  always@(wrtSerPos or
	  IF_wrtSerPos_82_EQ_2_92_THEN_0x0_ELSE_metaWF_f_ETC___d520 or
	  x__h18104 or x__h18131)
  begin
    case (wrtSerPos)
      2'd0: MUX_wide16Fa$enq_1__VAL_1 = x__h18104;
      2'd1: MUX_wide16Fa$enq_1__VAL_1 = x__h18131;
      default: MUX_wide16Fa$enq_1__VAL_1 =
		   IF_wrtSerPos_82_EQ_2_92_THEN_0x0_ELSE_metaWF_f_ETC___d520;
    endcase
  end
  always@(wrtSerPos or
	  IF_wrtSerPos_82_EQ_2_92_THEN_0x0_ELSE_mesgWF_w_ETC___d549 or
	  x__h18754 or x__h18778)
  begin
    case (wrtSerPos)
      2'd0: MUX_wide16Fa$enq_1__VAL_2 = x__h18754;
      2'd1: MUX_wide16Fa$enq_1__VAL_2 = x__h18778;
      default: MUX_wide16Fa$enq_1__VAL_2 =
		   IF_wrtSerPos_82_EQ_2_92_THEN_0x0_ELSE_mesgWF_w_ETC___d549;
    endcase
  end
  ...
  assign MUX_wmemi_reqF_q_1$write_1__VAL_2 =
	     (wmemi_reqF_c_r == 2'd2) ?
	       MUX_wmemi_reqF_q_0$write_1__VAL_1 :
	       52'h0AAAAAAAAAAAA ;
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_1 = { 4'd3, addr__h19178, 12'd1 } ;
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_2 = { 4'd5, addr__h19528, 12'd1 } ;
  assign MUX_wrtSerPos$write_1__VAL_1 =
	     (metaWF$D_OUT[23:0] == 24'd0) ?
	       2'd0 :
	       wrtSerPos_82_PLUS_1___d954 ;
  assign MUX_wrtSerPos$write_1__VAL_2 =
	     (wrtSerUnroll == 16'd1) ? 2'd0 : wrtSerPos_82_PLUS_1___d954 ;
  ...
  assign mesgWF_wDataOut$wget = data__h18469 ;
  ...
  // register bytesThisMessage
  assign bytesThisMessage$D_IN = btm__h17357 ;
  ...
  assign dlyRdOpOther$EN =
	     WILL_FIRE_RL_rdSer_begin && v__h19843[31:24] != 8'd0 ;
  ...
  assign mesgLengthSoFar$D_IN =
	     wsiS_reqFifo$D_OUT[57] ?
	       14'd0 :
	       mesgLengthSoFar_65_PLUS_1___d955 ;
  assign mesgLengthSoFar$EN = CAN_FIRE_RL_wmwt_mesg_ingress ;
  ...
  // register mesgWF_rCache
  assign mesgWF_rCache$D_IN = { 1'd1, mesgWF_rWrPtr, x__h14868 } ;
  assign mesgWF_rCache$EN = CAN_FIRE_RL_wmwt_mesg_ingress ;

  // register mesgWF_rRdPtr
  assign mesgWF_rRdPtr$D_IN = x__h14969 ;
  ...
  // register rdSerMeta
  assign rdSerMeta$D_IN = v__h19843 ;
  ...
  assign wrtSerStage$D_IN =
	     MUX_wrtSerStage$write_1__SEL_1 ? data__h18469 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_1$D_IN =
	     MUX_wrtSerStage_1$write_1__SEL_1 ? data__h18469 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_2$D_IN =
	     MUX_wrtSerStage_2$write_1__SEL_1 ? data__h18469 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_3$D_IN =
	     MUX_wrtSerStage_3$write_1__SEL_1 ? data__h18469 : metaWF$D_OUT ;
  ...
  assign mesgWF_memory$ADDRB =
	     CAN_FIRE_RL_wrtSer_body ? x__h14969[11:0] : mesgWF_rRdPtr[11:0] ;
  assign mesgWF_memory$DIA = x__h14868 ;
  ...
  // remaining internal signals
  assign IF_wrtSerPos_82_EQ_0_90_OR_wrtSerPos_82_EQ_1_9_ETC___d535 =
	     CASE_wrtSerPos_0b1_0_1_1_1_2_1_3_0b1__q2 &&
	     (wrtSerPos != 2'd3 && wrtSerUnroll != 16'd1 ||
	      CASE_wrtSerPos_NOT_wrtSerPos_EQ_3_OR_wide16Fa_ETC__q1) ;
  assign IF_wrtSerPos_82_EQ_2_92_THEN_0x0_ELSE_mesgWF_w_ETC___d549 =
	     { (wrtSerPos == 2'd2) ? 32'h0 : data__h18469,
	       (wrtSerPos == 2'd2) ? data__h18469 : wrtSerStage_2,
	       wrtSerStage_1,
	       wrtSerStage } ;
  assign IF_wrtSerPos_82_EQ_2_92_THEN_0x0_ELSE_metaWF_f_ETC___d520 =
	     { (wrtSerPos == 2'd2) ? 32'h0 : metaWF$D_OUT,
	       (wrtSerPos == 2'd2) ? metaWF$D_OUT : wrtSerStage_2,
	       wrtSerStage_1,
	       wrtSerStage } ;
  assign NOT_mesgWF_rRdPtr_96_EQ_mesgWF_rWrPtr_87_23___d524 =
	     mesgWF_rRdPtr != mesgWF_rWrPtr ;
  assign NOT_mesgWF_rRdPtr_96_PLUS_2048_52_EQ_mesgWF_rW_ETC___d454 =
	     mesgWF_rRdPtr + 13'd2048 != mesgWF_rWrPtr ;
  assign NOT_wrtSerPos_82_EQ_3_83_84_AND_NOT_metaWF_fir_ETC___d498 =
	     wrtSerPos != 2'd3 && metaWF$D_OUT[23:0] != 24'd0 ||
	     CASE_wrtSerPos_NOT_wrtSerPos_EQ_3_OR_wide16Fa_ETC__q1 ;
  assign addr__h19178 = { 9'd0, x__h19236 } ;
  assign addr__h19528 = { 9'd0, x__h19573 } ;
  assign btm__h17357 =
	     { wsiS_reqFifo$D_OUT[56] ?
		 { 10'd0, wsiS_reqFifo$D_OUT[55:44] } :
		 { 8'd0, mesgLengthSoFar_65_PLUS_1___d955 },
	       2'd0 } ;
  assign bytesWritten_78_ULT_dlyHoldoffBytes_57___d1010 =
	     bytesWritten < dlyHoldoffBytes ;
  assign cyclesPassed_48_ULT_dlyHoldoffCycles_60___d1008 =
	     cyclesPassed < dlyHoldoffCycles ;
  assign data__h18469 =
	     (mesgWF_rCache[45] && mesgWF_rCache[44:32] == mesgWF_rRdPtr) ?
	       mesgWF_rCache[31:0] :
	       mesgWF_memory$DOB ;
  assign delayStatus__h21808 =
	     { 14'h0,
	       !dlyWordsStored_value_09_SLE_0___d1009 &&
	       !bytesWritten_78_ULT_dlyHoldoffBytes_57___d1010 &&
	       !cyclesPassed_48_ULT_dlyHoldoffCycles_60___d1008,
	       ...
	       wide16Fc$FULL_N,
	       wide16Fc$EMPTY_N } ;
  assign dlyWordsStored_value_09_SLE_0_56_OR_bytesWritt_ETC___d564 =
	     dlyWordsStored_value_09_SLE_0___d1009 ||
	     bytesWritten_78_ULT_dlyHoldoffBytes_57___d1010 ||
	     cyclesPassed_48_ULT_dlyHoldoffCycles_60___d1008 ||
	     wsiM_reqFifo_c_r == 2'd2 ||
	     tog50 ;
  assign dlyWordsStored_value_09_SLE_0___d1009 =
	     (dlyWordsStored_value ^ 25'h1000000) <= 25'd16777216 ;
  assign dlyWordsStored_value_09_SLT_8388608___d566 =
	     (dlyWordsStored_value ^ 25'h1000000) < 25'd25165824 ;
  assign mesgLengthSoFar_65_PLUS_1___d955 = mesgLengthSoFar + 14'd1 ;
  assign mesgRF_i_notFull__63_AND_NOT_rdSerEmpty_13_14__ETC___d664 =
	     mesgRF$FULL_N &&
	     (!rdSerEmpty && rdSerPos != 2'd0 || wide16Fc$EMPTY_N) ;
  assign metaRF_i_notFull__12_AND_NOT_rdSerEmpty_13_14__ETC___d623 =
	     metaRF$FULL_N &&
	     (!rdSerEmpty && rdSerPos != 2'd0 || wide16Fc$EMPTY_N) ;
  assign rdat__h22231 = hasDebugLogic ? mesgWtCount : 32'd0 ;
  assign rdat__h22237 = hasDebugLogic ? mesgRdCount : 32'd0 ;
  assign rdat__h22243 = hasDebugLogic ? bytesWritten : 32'd0 ;
  assign rdat__h22249 = hasDebugLogic ? { 8'd0, x__h22253 } : 32'd0 ;
  assign rdat__h22373 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h22387 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h22395 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h22401 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h22415 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h22423 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h22429 = hasDebugLogic ? wmemiWrReq : 32'd0 ;
  assign rdat__h22435 = hasDebugLogic ? wmemiRdReq : 32'd0 ;
  assign rdat__h22441 = hasDebugLogic ? wmemiRdResp1 : 32'd0 ;
  assign rdat__h22447 =
	     hasDebugLogic ?
  ...
  assign rdat__h22458 =
	     hasDebugLogic ?
	       ...
	       32'd0 ;
  assign rdat__h22469 = hasDebugLogic ? { 9'd0, dlyWAG } : 32'd0 ;
  assign rdat__h22480 = hasDebugLogic ? { 9'd0, dlyRAG } : 32'd0 ;
  assign rdat__h22501 = hasDebugLogic ? wmemiRdResp2 : 32'd0 ;
  assign rdat__h22556 =
	     { {16{dlyReadyToWrite_value[15]}}, dlyReadyToWrite_value } ;
  assign rdat__h22565 = { 16'd0, wrtSerUnroll } ;
  assign rdat__h22574 = { 8'd0, bytesThisMessage } ;
  assign rdat__h22583 = { 18'd0, mesgLengthSoFar } ;
  assign wci_cState_5_EQ_2_6_AND_dlyCtrl_40_BITS_3_TO_0_ETC___d584 =
	     wci_cState == 3'd2 && dlyCtrl[3:0] == 4'h7 &&
	     !dlyWordsStored_value_09_SLE_0___d1009 &&
	     !bytesWritten_78_ULT_dlyHoldoffBytes_57___d1010 &&
	     !cyclesPassed_48_ULT_dlyHoldoffCycles_60___d1008 ;
  assign wrtSerPos_82_PLUS_1___d954 = wrtSerPos + 2'd1 ;
  ...
  assign x__h14868 =
	     CAN_FIRE_RL_wmwt_mesg_ingress ?
	       ...
	       32'd0 ;
  assign x__h14969 = mesgWF_rRdPtr + 13'd1 ;
  assign x__h18104 = { 96'd0, metaWF$D_OUT } ;
  assign x__h18131 = { 64'd0, metaWF$D_OUT, wrtSerStage } ;
  assign x__h18754 = { 96'd0, data__h18469 } ;
  assign x__h18778 = { 64'd0, data__h18469, wrtSerStage } ;
  assign x__h19236 = { dlyWAG, 4'h0 } ;
  assign x__h19573 = { dlyRAG, 4'h0 } ;
  assign x__h22253 = { wmemi_statusR, wsiS_statusR, wsiM_statusR } ;
  assign x_burstLength__h21715 =
	     (readMeta[23:0] == 24'd0) ? 12'd1 : readMeta[13:2] ;
  assign x_byteEn__h21716 = (readMeta[23:0] == 24'd0) ? 4'd0 : 4'd15 ;
  always@(rdSerPos or
	  rdSerStage_3 or wide16Fc$D_OUT or rdSerStage_1 or rdSerStage_2)
  begin
    case (rdSerPos)
      2'd0: v__h19843 = wide16Fc$D_OUT[31:0];
      2'd1: v__h19843 = rdSerStage_1;
      2'd2: v__h19843 = rdSerStage_2;
      2'd3: v__h19843 = rdSerStage_3;
    endcase
  end
  ...
  always@(wci_reqF$D_OUT or
	  ...
	  dlyRdOpOther or
	  rdat__h22501 or
	  delayStatus__h21808 or
	  rdat__h22556 or rdat__h22565 or rdat__h22574 or rdat__h22583)
  begin
    case (wci_reqF$D_OUT[51:32])
      20'h0: x_data__h22198 = dlyCtrl;
      20'h00004: x_data__h22198 = dlyHoldoffBytes;
      20'h00008: x_data__h22198 = dlyHoldoffCycles;
      20'h0000C: x_data__h22198 = rdat__h22231;
      20'h00010: x_data__h22198 = rdat__h22237;
      20'h00014: x_data__h22198 = rdat__h22243;
      20'h00018: x_data__h22198 = rdat__h22249;
      20'h0001C: x_data__h22198 = 32'd0;
      20'h00020: x_data__h22198 = rdat__h22373;
      20'h00024: x_data__h22198 = rdat__h22387;
      20'h00028: x_data__h22198 = rdat__h22395;
      20'h0002C: x_data__h22198 = rdat__h22401;
      20'h00030: x_data__h22198 = rdat__h22415;
      20'h00034: x_data__h22198 = rdat__h22423;
      20'h00038: x_data__h22198 = rdat__h22429;
      20'h0003C: x_data__h22198 = rdat__h22435;
      20'h00040: x_data__h22198 = rdat__h22441;
      20'h00044: x_data__h22198 = rdat__h22447;
      20'h00048: x_data__h22198 = rdat__h22458;
      20'h0004C: x_data__h22198 = rdat__h22469;
      20'h00050: x_data__h22198 = rdat__h22480;
      20'h00058: x_data__h22198 = dlyRdOpZero;
      20'h0005C: x_data__h22198 = dlyRdOpOther;
      20'h00060: x_data__h22198 = rdat__h22501;
      20'h00064: x_data__h22198 = delayStatus__h21808;
      20'h00068: x_data__h22198 = rdat__h22556;
      20'h0006C: x_data__h22198 = rdat__h22565;
      20'h00070: x_data__h22198 = rdat__h22574;
      20'h00074: x_data__h22198 = rdat__h22583;
      default: x_data__h22198 = 32'd0;
    endcase
  end
