...
//
// On Mon Jul 12 09:45:52 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker4B(wciS0_Clk,
  ...
  reg [63 : 0] v__h17545,
	       ...
	       v__h2820,
	       v__h3719;
  reg [31 : 0] x1__h23898, x_data__h22207;
  ...
  wire [127 : 0] IF_wrtSerPos_39_EQ_2_42_THEN_0x0_ELSE_mesgWF_w_ETC___d382,
		 ...
		 x1__h20635,
		 x1__h20662;
  wire [35 : 0] addr__h21237, addr__h21505;
  wire [31 : 0] data__h19518,
		rdat__h22234,
		rdat__h22240,
		rdat__h22247,
		rdat__h22253,
		...
		rdat__h22491,
		x__h15356;
  wire [26 : 0] x__h21295, x__h21550;
  wire [23 : 0] x1_length__h17238, x__h22257;
  wire [13 : 0] mlp1__h17939, x__h17282;
  wire [12 : 0] x__h15248;
  wire [11 : 0] x_burstLength__h22921;
  wire [7 : 0] x1_opcode__h17237;
  wire [3 : 0] x_byteEn__h22922;
  wire [1 : 0] wrtSerPos_39_PLUS_1___d1012;
  wire IF_wrtSerPos_39_EQ_0_40_OR_wrtSerPos_39_EQ_1_4_ETC___d359,
       ...
       wsiS_reqFifo_notFull__25_AND_wsiS_burstKind_05_ETC___d741;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, x_data__h22207 } ;
  ...
  assign MUX_mesgLength$write_1__VAL_3 = { 1'd1, mlp1__h17939[11:0], 2'd0 } ;
  assign MUX_mesgRdCount$write_1__VAL_1 = mesgRdCount + 32'd1 ;
  assign MUX_metaWF$enq_1__VAL_1 = { x1_opcode__h17237, x1_length__h17238 } ;
  ...
  assign MUX_rdSyncWord$write_1__VAL_2 =
	     rdSerPos != 2'd3 && x1__h23898[23:0] == 24'd0 ;
  ...
  always@(wrtSerPos or
	  ...
	  x1__h20635 or x1__h20662)
  begin
    case (wrtSerPos)
      2'd0: MUX_wide16Fa$enq_1__VAL_1 = x1__h20635;
      2'd1: MUX_wide16Fa$enq_1__VAL_1 = x1__h20662;
  ...
  always@(wrtSerPos or
	  ...
	  x1__h19939 or x1__h19970)
  begin
    case (wrtSerPos)
      2'd0: MUX_wide16Fa$enq_1__VAL_2 = x1__h19939;
      2'd1: MUX_wide16Fa$enq_1__VAL_2 = x1__h19970;
  ...
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_1 = { 4'd5, addr__h21237, 12'd1 } ;
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_2 = { 4'd3, addr__h21505, 12'd1 } ;
  ...
  assign mesgWF_wDataOut$wget = data__h19518 ;
  ...
  assign mesgLengthSoFar$D_IN =
	     MUX_impreciseBurst$write_1__SEL_2 ? 14'd0 : mlp1__h17939 ;
  ...
  // register mesgWF_rCache
  assign mesgWF_rCache$D_IN = { 1'd1, mesgWF_rWrPtr, x__h15356 } ;
  assign mesgWF_rCache$EN = mesgWF_pwEnqueue$whas ;

  // register mesgWF_rRdPtr
  assign mesgWF_rRdPtr$D_IN = x__h15248 ;
  ...
  // register rdSerMeta
  assign rdSerMeta$D_IN = x1__h23898 ;
  ...
  assign wrtSerStage$D_IN =
	     MUX_wrtSerStage$write_1__SEL_1 ? data__h19518 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_1$D_IN =
	     MUX_wrtSerStage_1$write_1__SEL_1 ? data__h19518 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_2$D_IN =
	     MUX_wrtSerStage_2$write_1__SEL_1 ? data__h19518 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_3$D_IN =
	     MUX_wrtSerStage_3$write_1__SEL_1 ? data__h19518 : metaWF$D_OUT ;
  ...
  assign IF_wrtSerPos_39_EQ_2_42_THEN_0x0_ELSE_mesgWF_w_ETC___d382 =
	     { (wrtSerPos == 2'd2) ? 32'h0 : data__h19518,
	       (wrtSerPos == 2'd2) ? data__h19518 : wrtSerStage_2,
	       wrtSerStage_1,
	       wrtSerStage } ;
  ...
  assign _dor1bytesWritten$EN_write =
	     WILL_FIRE_RL_wmwt_messagePushPrecise ||
	     WILL_FIRE_RL_wmwt_messagePushImprecise ;
  assign addr__h21237 = { 9'd0, x__h21295 } ;
  assign addr__h21505 = { 9'd0, x__h21550 } ;
  assign data__h19518 =
  ...
  assign metaRF_RDY_enq__57_AND_NOT_rdSerEmpty_13_14_AN_ETC___d258 =
	     metaRF$FULL_N &&
	     (!rdSerEmpty && rdSerPos != 2'd0 || wide16Fb$EMPTY_N) ;
  assign mlp1__h17939 = mesgLengthSoFar + 14'd1 ;
  assign rdat__h22234 = hasDebugLogic ? mesgWtCount : 32'd0 ;
  assign rdat__h22240 = hasDebugLogic ? mesgRdCount : 32'd0 ;
  assign rdat__h22247 = hasDebugLogic ? bytesWritten : 32'd0 ;
  assign rdat__h22253 = hasDebugLogic ? { 8'd0, x__h22257 } : 32'd0 ;
  assign rdat__h22377 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h22391 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h22399 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h22405 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h22419 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h22427 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h22433 = hasDebugLogic ? wmemiWrReq : 32'd0 ;
  assign rdat__h22439 = hasDebugLogic ? wmemiRdReq : 32'd0 ;
  assign rdat__h22445 = hasDebugLogic ? wmemiRdResp : 32'd0 ;
  assign rdat__h22451 =
	     hasDebugLogic ? { 8'd0, dlyWordsStored_value } : 32'd0 ;
  assign rdat__h22461 =
	     hasDebugLogic ? { 24'd0, dlyReadCredit_value } : 32'd0 ;
  assign rdat__h22471 = hasDebugLogic ? { 9'd0, dlyWAG } : 32'd0 ;
  assign rdat__h22481 = hasDebugLogic ? { 9'd0, dlyRAG } : 32'd0 ;
  assign rdat__h22491 = { {24{dlyMaxReadCredit[7]}}, dlyMaxReadCredit } ;
  ...
  assign wrtSerPos_39_PLUS_1___d1012 = wrtSerPos + 2'd1 ;
  assign wsiS_reqFifo_notFull__25_AND_wsiS_burstKind_05_ETC___d741 =
	     wsiS_reqFifo$FULL_N &&
	     (wsiS_burstKind == 2'd0 ||
	      (wsiS_burstKind == 2'd1 || wsiS_burstKind == 2'd2) &&
	      wsiS_wsiReq$wget[57]) ;
  assign x1__h19939 = { 96'd0, data__h19518 } ;
  assign x1__h19970 = { 64'd0, data__h19518, wrtSerStage } ;
  assign x1__h20635 = { 96'd0, metaWF$D_OUT } ;
  assign x1__h20662 = { 64'd0, metaWF$D_OUT, wrtSerStage } ;
  assign x1_length__h17238 = { 10'd0, x__h17282 } ;
  assign x1_opcode__h17237 = opcode[8] ? opcode[7:0] : 8'd0 ;
  assign x__h15248 = mesgWF_rRdPtr + 13'd1 ;
  assign x__h15356 =
	     mesgWF_pwEnqueue$whas ? wsiS_reqFifo$D_OUT[43:12] : 32'd0 ;
  assign x__h17282 = mesgLength[14] ? mesgLength[13:0] : 14'd0 ;
  assign x__h21295 = { dlyRAG, 4'h0 } ;
  assign x__h21550 = { dlyWAG, 4'h0 } ;
  assign x__h22257 = { wmemi_statusR, wsiS_statusR, wsiM_statusR } ;
  assign x_burstLength__h22921 =
	     (readMeta[23:0] == 24'd0) ? 12'd1 : readMeta[13:2] ;
  assign x_byteEn__h22922 = (readMeta[23:0] == 24'd0) ? 4'd0 : 4'd15 ;
  always@(wci_reqF$D_OUT or
	  ...
	  rdat__h22445 or
	  rdat__h22451 or
	  rdat__h22461 or rdat__h22471 or rdat__h22481 or rdat__h22491)
  begin
    case (wci_reqF$D_OUT[51:32])
      20'h0: x_data__h22207 = dlyCtrl;
      20'h00004: x_data__h22207 = dlyHoldoffBytes;
      20'h00008: x_data__h22207 = dlyHoldoffCycles;
      20'h0000C: x_data__h22207 = rdat__h22234;
      20'h00010: x_data__h22207 = rdat__h22240;
      20'h00014: x_data__h22207 = rdat__h22247;
      20'h00018: x_data__h22207 = rdat__h22253;
      20'h0001C: x_data__h22207 = 32'd0;
      20'h00020: x_data__h22207 = rdat__h22377;
      20'h00024: x_data__h22207 = rdat__h22391;
      20'h00028: x_data__h22207 = rdat__h22399;
      20'h0002C: x_data__h22207 = rdat__h22405;
      20'h00030: x_data__h22207 = rdat__h22419;
      20'h00034: x_data__h22207 = rdat__h22427;
      20'h00038: x_data__h22207 = rdat__h22433;
      20'h0003C: x_data__h22207 = rdat__h22439;
      20'h00040: x_data__h22207 = rdat__h22445;
      20'h00044: x_data__h22207 = rdat__h22451;
      20'h00048: x_data__h22207 = rdat__h22461;
      20'h0004C: x_data__h22207 = rdat__h22471;
      20'h00050: x_data__h22207 = rdat__h22481;
      20'h00054: x_data__h22207 = rdat__h22491;
      default: x_data__h22207 = 32'd0;
    endcase
  end
  always@(rdSerPos or
  ...
  begin
    case (rdSerPos)
      2'd0: x1__h23898 = wide16Fb$D_OUT[31:0];
      2'd1: x1__h23898 = rdSerStage_1;
      2'd2: x1__h23898 = rdSerStage_2;
      2'd3: x1__h23898 = rdSerStage_3;
    endcase
  end
  always@(wrtSerPos)
  begin
  ...
  begin
    ...
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wmwt_doAbort)
	$display("[%0d]: %m: wmwt_doAbort", v__h17761);
    if (wciS0_MReset_n)
