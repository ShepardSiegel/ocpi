...
//
// On Thu Jun 10 07:45:49 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker4B(wciS0_Clk,
  ...
  reg CASE_wrtSerPos_0b1_0_1_1_1_2_1_3_0b1__q1,
      IF_wrtSerPos_10_EQ_0_11_OR_wrtSerPos_10_EQ_1_1_ETC___d901;
  ...
  wire [31 : 0] data__h19622,
		...
		x__h15234,
		x__h16160;
  wire [23 : 0] x1_length__h17254, x__h21051, x__h21210, x__h21849;
  ...
  wire [1 : 0] wrtSerPos_10_PLUS_1___d981;
  wire NOT_dlyWordsStored_value_13_SLE_0_63_64_AND_NO_ETC___d271,
       ...
       metaWF_RDY_first__56_AND_NOT_wrtSerPos_10_EQ_3_ETC___d363,
  ...
  assign MUX_wrtSerPos$write_1__VAL_1 =
	     (wrtSerUnroll == 16'd1) ? 2'd0 : wrtSerPos_10_PLUS_1___d981 ;
  assign MUX_wrtSerPos$write_1__VAL_2 =
	     (metaWF$D_OUT[23:0] == 24'd0) ?
	       2'd0 :
	       wrtSerPos_10_PLUS_1___d981 ;
  ...
  assign mesgLengthSoFar$D_IN =
	     MUX_impreciseBurst$write_1__SEL_2 ? 14'd0 : mlp1__h17953 ;
  ...
  assign _dor1bytesWritten$EN_write =
	     WILL_FIRE_RL_wmwt_messagePushPrecise ||
	     WILL_FIRE_RL_wmwt_messagePushImprecise ;
  assign addr__h20993 = { 12'd0, x__h21051 } ;
  assign addr__h21165 = { 12'd0, x__h21210 } ;
  assign data__h19622 =
  ...
  assign metaRF_RDY_enq__40_AND_NOT_rdSerEmpty_96_97_AN_ETC___d241 =
	     metaRF$FULL_N &&
	     (!rdSerEmpty && rdSerPos != 2'd0 || wide16Fb$EMPTY_N) ;
  assign metaWF_RDY_first__56_AND_NOT_wrtSerPos_10_EQ_3_ETC___d363 =
	     metaWF$EMPTY_N &&
	     (wrtSerPos != 2'd3 && metaWF$D_OUT[23:0] != 24'd0 ||
	      IF_wrtSerPos_10_EQ_0_11_OR_wrtSerPos_10_EQ_1_1_ETC___d901) ;
  assign mlp1__h17953 = mesgLengthSoFar + 14'd1 ;
  assign rdat__h21846 = { 8'd0, x__h21849 } ;
  assign rdat__h22029 = { 12'd0, dlyWordsStored_value } ;
  assign rdat__h22037 = { 24'd0, dlyReadCredit_value } ;
  assign rdat__h22045 = { 12'd0, dlyWAG } ;
  assign rdat__h22053 = { 12'd0, dlyRAG } ;
  ...
  assign wrtSerPos_10_PLUS_1___d981 = wrtSerPos + 2'd1 ;
