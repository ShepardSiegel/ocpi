...
//
// On Fri Jun 25 12:01:01 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker4B(wciS0_Clk,
  ...
  reg [63 : 0] v__h17446,
	       ...
	       v__h2816,
	       v__h3715;
  reg [31 : 0] sendData__h23172, x_data__h21533;
  reg CASE_wrtSerPos_0b1_0_1_1_1_2_1_3_0b1__q1,
      IF_wrtSerPos_27_EQ_0_28_OR_wrtSerPos_27_EQ_1_2_ETC___d903;
  wire [127 : 0] IF_wrtSerPos_27_EQ_2_30_THEN_0x0_ELSE_mesgWF_w_ETC___d369,
		 IF_wrtSerPos_27_EQ_2_30_THEN_0x0_ELSE_metaWF_f_ETC___d392,
		 x1__h19698,
		 x1__h19707,
		 x1__h20221,
		 x1__h20230;
  wire [35 : 0] addr__h20723, addr__h20895;
  wire [31 : 0] data__h19352,
		mesg__h22101,
		rdat__h21560,
		rdat__h21566,
		rdat__h21573,
  ...
  wire [23 : 0] x1_length__h17139, x__h21583;
  wire [13 : 0] mlp1__h17809, x__h17183;
  wire [12 : 0] x__h15009;
  wire [11 : 0] x_burstLength__h22192;
  wire [10 : 0] x__h15937;
  wire [7 : 0] x1_opcode__h17138;
  wire [3 : 0] x_byteEn__h22193;
  wire [1 : 0] wrtSerPos_27_PLUS_1___d990;
  wire NOT_dlyWordsStored_value_26_SLE_0_80_81_AND_NO_ETC___d288,
       NOT_mesgRF_rRdPtr_69_PLUS_512_10_EQ_mesgRF_rWr_ETC___d225,
       NOT_wmemi_reqF_c_r_73_EQ_2_74_75_AND_NOT_wmemi_ETC___d307,
       NOT_wsiS_reqFifo_countReg_98_ULE_1_99___d700,
       _dor1bytesWritten$EN_write,
       metaRF_RDY_enq__57_AND_NOT_rdSerEmpty_13_14_AN_ETC___d258,
       metaWF_RDY_deq__73_AND_NOT_wrtSerPos_27_EQ_3_3_ETC___d380,
       wci_cState_9_EQ_2_0_AND_dlyCtrl_4_BITS_3_TO_0__ETC___d412;
  ...
  assign CAN_FIRE_RL_delay_read_req =
	     ...
	     wci_cState == 3'd2 &&
	     dlyCtrl[3:0] == 4'h7 &&
	     NOT_dlyWordsStored_value_26_SLE_0_80_81_AND_NO_ETC___d288 &&
  ...
  assign MUX_mesgLength$write_1__VAL_3 = { 1'd1, mlp1__h17809[11:0], 2'd0 } ;
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, x_data__h21533 } ;
  ...
  assign MUX_rdSyncWord$write_1__VAL_2 =
	     rdSerPos != 2'd3 && sendData__h23172[23:0] == 24'd0 ;
  ...
  always@(wrtSerPos or
	  IF_wrtSerPos_27_EQ_2_30_THEN_0x0_ELSE_metaWF_f_ETC___d392 or
  ...
  always@(wrtSerPos or
	  IF_wrtSerPos_27_EQ_2_30_THEN_0x0_ELSE_mesgWF_w_ETC___d369 or
  ...
  begin
    case (wrtSerPos)
      ...
      default: MUX_wide16Fa$enq_1__VAL_2 =
		   IF_wrtSerPos_27_EQ_2_30_THEN_0x0_ELSE_mesgWF_w_ETC___d369;
    endcase
  end
  ...
  assign MUX_wrtSerPos$write_1__VAL_1 =
	     (wrtSerUnroll == 16'd1) ? 2'd0 : wrtSerPos_27_PLUS_1___d990 ;
  ...
  assign mesgWF_wDataOut$wget = data__h19352 ;
  ...
  assign mesgRF_wDataIn$wget = sendData__h23172 ;
  assign mesgRF_wDataIn$whas = CAN_FIRE_RL_rdSer_body ;
  assign mesgRF_wDataOut$wget = mesg__h22101 ;
  ...
  // register rdSerMeta
  assign rdSerMeta$D_IN = sendData__h23172 ;
  ...
  assign wrtSerStage$D_IN =
	     MUX_wrtSerStage$write_1__SEL_1 ? data__h19352 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_1$D_IN =
	     MUX_wrtSerStage_1$write_1__SEL_1 ? data__h19352 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_2$D_IN =
	     MUX_wrtSerStage_2$write_1__SEL_1 ? data__h19352 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_3$D_IN =
	     MUX_wrtSerStage_3$write_1__SEL_1 ? data__h19352 : metaWF$D_OUT ;
  ...
  // submodule metaRF
  assign metaRF$D_IN = sendData__h23172 ;
  ...
  // remaining internal signals
  assign IF_wrtSerPos_27_EQ_2_30_THEN_0x0_ELSE_mesgWF_w_ETC___d369 =
	     { (wrtSerPos == 2'd2) ? 32'h0 : data__h19352,
	       (wrtSerPos == 2'd2) ? data__h19352 : wrtSerStage_2,
	       wrtSerStage_1,
	       wrtSerStage } ;
  assign IF_wrtSerPos_27_EQ_2_30_THEN_0x0_ELSE_metaWF_f_ETC___d392 =
	     { (wrtSerPos == 2'd2) ? 32'h0 : metaWF$D_OUT,
	       (wrtSerPos == 2'd2) ? metaWF$D_OUT : wrtSerStage_2,
	       wrtSerStage_1,
	       wrtSerStage } ;
  assign NOT_dlyWordsStored_value_26_SLE_0_80_81_AND_NO_ETC___d288 =
  ...
  assign NOT_wmemi_reqF_c_r_73_EQ_2_74_75_AND_NOT_wmemi_ETC___d307 =
	     wmemi_reqF_c_r != 2'd2 && wmemi_dhF_c_r != 2'd2 &&
	     wmemi_operateD &&
	     wmemi_peerIsReady ;
  assign NOT_wsiS_reqFifo_countReg_98_ULE_1_99___d700 =
	     wsiS_reqFifo_countReg > 2'd1 ;
  ...
  assign metaRF_RDY_enq__57_AND_NOT_rdSerEmpty_13_14_AN_ETC___d258 =
	     metaRF$FULL_N &&
	     (!rdSerEmpty && rdSerPos != 2'd0 || wide16Fb$EMPTY_N) ;
  assign metaWF_RDY_deq__73_AND_NOT_wrtSerPos_27_EQ_3_3_ETC___d380 =
	     metaWF$EMPTY_N &&
	     (wrtSerPos != 2'd3 && metaWF$D_OUT[23:0] != 24'd0 ||
	      IF_wrtSerPos_27_EQ_0_28_OR_wrtSerPos_27_EQ_1_2_ETC___d903) ;
  assign mlp1__h17809 = MUX_mesgLengthSoFar$write_1__VAL_2 ;
  assign rdat__h21560 = hasDebugLogic ? mesgWtCount : 32'd0 ;
  assign rdat__h21566 = hasDebugLogic ? mesgRdCount : 32'd0 ;
  assign rdat__h21573 = hasDebugLogic ? bytesWritten : 32'd0 ;
  assign rdat__h21579 = hasDebugLogic ? { 8'd0, x__h21583 } : 32'd0 ;
  assign rdat__h21703 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h21717 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h21725 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h21731 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h21745 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h21753 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h21759 = hasDebugLogic ? wmemiWrReq : 32'd0 ;
  assign rdat__h21765 = hasDebugLogic ? wmemiRdReq : 32'd0 ;
  assign rdat__h21771 = hasDebugLogic ? wmemiRdResp : 32'd0 ;
  assign rdat__h21777 =
	     hasDebugLogic ? { 9'd0, dlyWordsStored_value } : 32'd0 ;
  assign rdat__h21787 =
	     hasDebugLogic ? { 24'd0, dlyReadCredit_value } : 32'd0 ;
  assign rdat__h21797 = hasDebugLogic ? { 9'd0, dlyWAG } : 32'd0 ;
  assign rdat__h21807 = hasDebugLogic ? { 9'd0, dlyRAG } : 32'd0 ;
  assign wci_cState_9_EQ_2_0_AND_dlyCtrl_4_BITS_3_TO_0__ETC___d412 =
	     wci_cState == 3'd2 && dlyCtrl[3:0] == 4'h7 && mesgLength[14] &&
	     !doAbort &&
	     (preciseBurst && wsiWordsRemain == 12'd0 ||
	      impreciseBurst && endOfMessage) ;
  assign wrtSerPos_27_PLUS_1___d990 = wrtSerPos + 2'd1 ;
  assign x1__h19698 = { 96'd0, data__h19352 } ;
  assign x1__h19707 = { 64'd0, data__h19352, wrtSerStage } ;
  ...
  assign x__h16045 = CAN_FIRE_RL_rdSer_body ? sendData__h23172 : 32'd0 ;
  assign x__h17183 = mesgLength[14] ? mesgLength[13:0] : 14'd0 ;
  assign x__h20781 = { dlyRAG, 4'h0 } ;
  assign x__h20940 = { dlyWAG, 4'h0 } ;
  assign x__h21583 = { wmemi_statusR, wsiS_statusR, wsiM_statusR } ;
  assign x_burstLength__h22192 =
	     (readMeta[23:0] == 24'd0) ? 12'd1 : readMeta[13:2] ;
  assign x_byteEn__h22193 = (readMeta[23:0] == 24'd0) ? 4'd0 : 4'd15 ;
  always@(wci_reqF$D_OUT or
	  ...
	  rdat__h21765 or
	  rdat__h21771 or
	  rdat__h21777 or rdat__h21787 or rdat__h21797 or rdat__h21807)
  begin
    case (wci_reqF$D_OUT[51:32])
      ...
      20'h0000C: x_data__h21533 = rdat__h21560;
      20'h00010: x_data__h21533 = rdat__h21566;
      20'h00014: x_data__h21533 = rdat__h21573;
      20'h00018: x_data__h21533 = rdat__h21579;
      20'h0001C: x_data__h21533 = 32'd0;
      20'h00020: x_data__h21533 = rdat__h21703;
      20'h00024: x_data__h21533 = rdat__h21717;
      20'h00028: x_data__h21533 = rdat__h21725;
      20'h0002C: x_data__h21533 = rdat__h21731;
      20'h00030: x_data__h21533 = rdat__h21745;
      20'h00034: x_data__h21533 = rdat__h21753;
      20'h00038: x_data__h21533 = rdat__h21759;
      20'h0003C: x_data__h21533 = rdat__h21765;
      20'h00040: x_data__h21533 = rdat__h21771;
      20'h00044: x_data__h21533 = rdat__h21777;
      20'h00048: x_data__h21533 = rdat__h21787;
      20'h0004C: x_data__h21533 = rdat__h21797;
      20'h00050: x_data__h21533 = rdat__h21807;
  ...
  begin
    case (rdSerPos)
      2'd0: sendData__h23172 = wide16Fb$D_OUT[31:0];
      2'd1: sendData__h23172 = rdSerStage_1;
      2'd2: sendData__h23172 = rdSerStage_2;
      2'd3: sendData__h23172 = rdSerStage_3;
    endcase
  end
