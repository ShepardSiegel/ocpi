...
//
// On Fri Jun 18 15:19:55 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkDelayWorker4B(wciS0_Clk,
  ...
  reg [63 : 0] v__h17441,
	       ...
	       v__h2815,
	       v__h3714;
  reg [31 : 0] sendData__h23141, x_data__h21528;
  reg CASE_wrtSerPos_0b1_0_1_1_1_2_1_3_0b1__q1,
      IF_wrtSerPos_10_EQ_0_11_OR_wrtSerPos_10_EQ_1_1_ETC___d888;
  wire [127 : 0] IF_wrtSerPos_10_EQ_2_13_THEN_0x0_ELSE_mesgWF_w_ETC___d352,
		 ...
		 x1__h20216,
		 x1__h20225;
  wire [35 : 0] addr__h20718, addr__h20890;
  wire [31 : 0] data__h19347,
		mesg__h22070,
		rdat__h21571,
		rdat__h21754,
		rdat__h21762,
		...
		x__h15113,
		x__h16040;
  wire [26 : 0] x__h20776, x__h20935;
  wire [23 : 0] x1_length__h17134, x__h21574;
  wire [13 : 0] mlp1__h17804, x__h17178;
  wire [11 : 0] x__h15005, x_burstLength__h22161;
  wire [10 : 0] x__h15932;
  wire [7 : 0] x1_opcode__h17133;
  wire [3 : 0] x_byteEn__h22162;
  wire [1 : 0] wrtSerPos_10_PLUS_1___d975;
  wire NOT_dlyWordsStored_value_13_SLE_0_63_64_AND_NO_ETC___d271,
       ...
       NOT_wsiS_reqFifo_countReg_81_ULE_1_82___d683,
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, x_data__h21528 } ;
  ...
  assign MUX_wci_respF_q_1$write_1__VAL_1 =
	     (wci_respF_c_r == 2'd2) ?
	       MUX_wci_respF_q_0$write_1__VAL_2 :
	       34'h0AAAAAAAA ;
  assign MUX_mesgLength$write_1__VAL_3 = { 1'd1, mlp1__h17804[11:0], 2'd0 } ;
  ...
  assign MUX_metaWF$enq_1__VAL_1 = { x1_opcode__h17133, x1_length__h17134 } ;
  ...
  assign MUX_rdSyncWord$write_1__VAL_2 =
	     rdSerPos != 2'd3 && sendData__h23141[23:0] == 24'd0 ;
  ...
  always@(wrtSerPos or
	  ...
	  x1__h20216 or x1__h20225)
  begin
    case (wrtSerPos)
      2'd0: MUX_wide16Fa$enq_1__VAL_1 = x1__h20216;
      2'd1: MUX_wide16Fa$enq_1__VAL_1 = x1__h20225;
  ...
  always@(wrtSerPos or
	  ...
	  x1__h19693 or x1__h19702)
  begin
    case (wrtSerPos)
      2'd0: MUX_wide16Fa$enq_1__VAL_2 = x1__h19693;
      2'd1: MUX_wide16Fa$enq_1__VAL_2 = x1__h19702;
  ...
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_1 = { 4'd5, addr__h20718, 12'd1 } ;
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_2 = { 4'd3, addr__h20890, 12'd1 } ;
  ...
  assign mesgWF_wDataOut$wget = data__h19347 ;
  ...
  assign mesgRF_wDataIn$wget = sendData__h23141 ;
  assign mesgRF_wDataIn$whas = CAN_FIRE_RL_rdSer_body ;
  assign mesgRF_wDataOut$wget = mesg__h22070 ;
  ...
  // register mesgRF_rCache
  assign mesgRF_rCache$D_IN = { 1'd1, mesgRF_rWrPtr, x__h16040 } ;
  assign mesgRF_rCache$EN = CAN_FIRE_RL_rdSer_body ;

  // register mesgRF_rRdPtr
  assign mesgRF_rRdPtr$D_IN = x__h15932 ;
  ...
  // register mesgWF_rCache
  assign mesgWF_rCache$D_IN = { 1'd1, mesgWF_rWrPtr, x__h15113 } ;
  assign mesgWF_rCache$EN = mesgWF_pwEnqueue$whas ;

  // register mesgWF_rRdPtr
  assign mesgWF_rRdPtr$D_IN = x__h15005 ;
  ...
  // register rdSerMeta
  assign rdSerMeta$D_IN = sendData__h23141 ;
  ...
  assign wrtSerStage$D_IN =
	     MUX_wrtSerStage$write_1__SEL_1 ? data__h19347 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_1$D_IN =
	     MUX_wrtSerStage_1$write_1__SEL_1 ? data__h19347 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_2$D_IN =
	     MUX_wrtSerStage_2$write_1__SEL_1 ? data__h19347 : metaWF$D_OUT ;
  ...
  assign wrtSerStage_3$D_IN =
	     MUX_wrtSerStage_3$write_1__SEL_1 ? data__h19347 : metaWF$D_OUT ;
  ...
  assign mesgRF_memory$DIA = x__h16040 ;
  ...
  assign IF_wrtSerPos_10_EQ_2_13_THEN_0x0_ELSE_mesgWF_w_ETC___d352 =
	     { (wrtSerPos == 2'd2) ? 32'h0 : data__h19347,
	       (wrtSerPos == 2'd2) ? data__h19347 : wrtSerStage_2,
	       wrtSerStage_1,
	       wrtSerStage } ;
  ...
  assign NOT_wmemi_reqF_c_r_56_EQ_2_57_58_AND_NOT_wmemi_ETC___d290 =
	     ...
	     wmemi_operateD &&
	     wmemi_peerIsReady ;
  assign NOT_wsiS_reqFifo_countReg_81_ULE_1_82___d683 =
	     wsiS_reqFifo_countReg > 2'd1 ;
  assign _dor1bytesWritten$EN_write =
	     WILL_FIRE_RL_wmwt_messagePushPrecise ||
	     WILL_FIRE_RL_wmwt_messagePushImprecise ;
  assign addr__h20718 = { 9'd0, x__h20776 } ;
  assign addr__h20890 = { 9'd0, x__h20935 } ;
  assign data__h19347 =
  ...
  assign metaWF_RDY_deq__56_AND_NOT_wrtSerPos_10_EQ_3_1_ETC___d363 =
	     ...
	     (wrtSerPos != 2'd3 && metaWF$D_OUT[23:0] != 24'd0 ||
	      IF_wrtSerPos_10_EQ_0_11_OR_wrtSerPos_10_EQ_1_1_ETC___d888) ;
  assign mlp1__h17804 = MUX_mesgLengthSoFar$write_1__VAL_2 ;
  assign rdat__h21571 = { 8'd0, x__h21574 } ;
  assign rdat__h21754 = { 9'd0, dlyWordsStored_value } ;
  assign rdat__h21762 = { 24'd0, dlyReadCredit_value } ;
  assign rdat__h21770 = { 9'd0, dlyWAG } ;
  assign rdat__h21778 = { 9'd0, dlyRAG } ;
  ...
  assign wrtSerPos_10_PLUS_1___d975 = wrtSerPos + 2'd1 ;
  assign x1__h19693 = { 96'd0, data__h19347 } ;
  assign x1__h19702 = { 64'd0, data__h19347, wrtSerStage } ;
  assign x1__h20216 = { 96'd0, metaWF$D_OUT } ;
  assign x1__h20225 = { 64'd0, metaWF$D_OUT, wrtSerStage } ;
  assign x1_length__h17134 = { 10'd0, x__h17178 } ;
  assign x1_opcode__h17133 = opcode[8] ? opcode[7:0] : 8'd0 ;
  assign x__h15005 = mesgWF_rRdPtr + 12'd1 ;
  assign x__h15113 =
	     mesgWF_pwEnqueue$whas ? wsiS_reqFifo$D_OUT[43:12] : 32'd0 ;
  assign x__h15932 = mesgRF_rRdPtr + 11'd1 ;
  assign x__h16040 = CAN_FIRE_RL_rdSer_body ? sendData__h23141 : 32'd0 ;
  assign x__h17178 = mesgLength[14] ? mesgLength[13:0] : 14'd0 ;
  assign x__h20776 = { dlyRAG, 4'h0 } ;
  assign x__h20935 = { dlyWAG, 4'h0 } ;
  assign x__h21574 = { wmemi_statusR, wsiS_statusR, wsiM_statusR } ;
  assign x_burstLength__h22161 =
	     (readMeta[23:0] == 24'd0) ? 12'd1 : readMeta[13:2] ;
  assign x_byteEn__h22162 = (readMeta[23:0] == 24'd0) ? 4'd0 : 4'd15 ;
  always@(wci_reqF$D_OUT or
	  ...
	  wmemiRdReq or
	  wmemiRdResp or
	  rdat__h21754 or rdat__h21762 or rdat__h21770 or rdat__h21778)
  begin
    case (wci_reqF$D_OUT[51:32])
      20'h0: x_data__h21528 = dlyCtrl;
      20'h00004: x_data__h21528 = dlyHoldoffBytes;
      20'h00008: x_data__h21528 = dlyHoldoffCycles;
      20'h0000C: x_data__h21528 = mesgWtCount;
      20'h00010: x_data__h21528 = mesgRdCount;
      20'h00014: x_data__h21528 = bytesWritten;
      20'h00018: x_data__h21528 = rdat__h21571;
      20'h0001C: x_data__h21528 = 32'd0;
      20'h00020: x_data__h21528 = wsiS_extStatusW$wget[95:64];
      20'h00024: x_data__h21528 = wsiS_extStatusW$wget[63:32];
      20'h00028: x_data__h21528 = wsiS_extStatusW$wget[31:0];
      20'h0002C: x_data__h21528 = wsiM_extStatusW$wget[95:64];
      20'h00030: x_data__h21528 = wsiM_extStatusW$wget[63:32];
      20'h00034: x_data__h21528 = wsiM_extStatusW$wget[31:0];
      20'h00038: x_data__h21528 = wmemiWrReq;
      20'h0003C: x_data__h21528 = wmemiRdReq;
      20'h00040: x_data__h21528 = wmemiRdResp;
      20'h00044: x_data__h21528 = rdat__h21754;
      20'h00048: x_data__h21528 = rdat__h21762;
      20'h0004C: x_data__h21528 = rdat__h21770;
      20'h00050: x_data__h21528 = rdat__h21778;
      default: x_data__h21528 = 32'd0;
    endcase
  end
  always@(rdSerPos or
  ...
  begin
    case (rdSerPos)
      2'd0: sendData__h23141 = wide16Fb$D_OUT[31:0];
      2'd1: sendData__h23141 = rdSerStage_1;
      2'd2: sendData__h23141 = rdSerStage_2;
      2'd3: sendData__h23141 = rdSerStage_3;
    endcase
  end
  ...
  begin
    ...
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wmwt_doAbort)
	$display("[%0d]: %m: wmwt_doAbort", v__h17657);
    if (wciS0_MReset_n)
