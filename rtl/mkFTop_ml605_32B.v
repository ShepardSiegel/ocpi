...
//
// On Thu Nov  3 16:03:45 EDT 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkFTop_ml605(sys0_clkp,
  ...
  wire [255 : 0] ctop$wsi_s_adc_MData;
  ...
  // submodule ctop
  mkCTop32B ctop(.pciDevice(pciDevice),
  ...
  assign ctop$wsi_s_adc_MByteEn = 32'h0 ;
  assign ctop$wsi_s_adc_MCmd = 3'h0 ;
  assign ctop$wsi_s_adc_MData = 256'h0 ;
