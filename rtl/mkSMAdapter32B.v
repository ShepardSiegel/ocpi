...
//
// On Wed Feb 29 09:02:55 EST 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter32B(wciS0_Clk,
  ...
  wire [307 : 0] IF_respF_wDataIn_whas__33_THEN_respF_wDataIn_w_ETC___d959;
  ...
  wire [5 : 0] x__h22523,
	       ...
	       y__h22872,
	       y__h22884;
  wire [2 : 0] IF_respF_wDataIn_whas__33_THEN_respF_wDataIn_w_ETC___d957;
  ...
  assign MUX_wsiS_reqFifo_levelsValid$write_1__SEL_3 =
	     CAN_FIRE_RL_wmwt_messagePush && !MUX_opcode$write_1__SEL_1 ;
  ...
  always@(MUX_mesgCount$write_1__SEL_1 or
	  ...
	  MUX_opcode$write_1__SEL_1 or WILL_FIRE_RL_wci_ctrl_IsO)
  begin
    case (1'b1) // synopsys parallel_case
      MUX_mesgCount$write_1__SEL_1:
  ...
  // register opcode
  assign opcode$D_IN =
	     (MUX_opcode$write_1__SEL_1 || WILL_FIRE_RL_wmwt_doAbort) ?
	       9'd170 :
	       MUX_opcode$write_1__VAL_3 ;
  assign opcode$EN =
	     WILL_FIRE_RL_wmwt_mesgBegin || MUX_opcode$write_1__SEL_1 ||
	     WILL_FIRE_RL_wmwt_doAbort ;
  ...
  assign respF_rCache$D_IN =
	     { 1'd1,
	       respF_rWrPtr,
	       IF_respF_wDataIn_whas__33_THEN_respF_wDataIn_w_ETC___d957,
	       respF_pwEnqueue$whas && respF_wDataIn$wget[309],
	       respF_pwEnqueue$whas && respF_wDataIn$wget[308],
	       IF_respF_wDataIn_whas__33_THEN_respF_wDataIn_w_ETC___d959 } ;
  ...
  assign wmwtFinalCount$EN = MUX_opcode$write_1__SEL_1 ;
  ...
  assign mesgTokenF$DEQ = MUX_opcode$write_1__SEL_1 ;
  ...
  // remaining internal signals
  assign IF_respF_wDataIn_whas__33_THEN_respF_wDataIn_w_ETC___d957 =
	     respF_pwEnqueue$whas ? respF_wDataIn$wget[312:310] : 3'd0 ;
  assign IF_respF_wDataIn_whas__33_THEN_respF_wDataIn_w_ETC___d959 =
