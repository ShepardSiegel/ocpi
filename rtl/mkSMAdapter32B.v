...
//
// On Wed Feb  9 09:57:00 EST 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter32B(wciS0_Clk,
  ...
  wire [307 : 0] IF_respF_wDataIn_whas__43_THEN_respF_wDataIn_w_ETC___d842;
  ...
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_3 =
	     { 4'd3, wsiS_reqFifo$D_OUT[309], 1'b0, addr__h20732, 12'd1 } ;
  ...
  assign addr__h20732 = { mesgLengthSoFar[8:0], 5'd0 } ;
  assign b__h14952 = -fabWordsCurReq[11:0] ;
  assign b__h18260 = { {2{fabRespCredit_value[11]}}, fabRespCredit_value } ;
  assign bl__h19963 = zeroLengthMesg ? 12'd1 : { 3'd0, x__h19874[13:5] } ;
  ...
  assign mesgMetaF_length__h20862 =
	     (wsiS_reqFifo$D_OUT[309] && wsiS_reqFifo$D_OUT[39:8] == 32'd0 &&
	      mesgLengthSoFar == 14'd0) ?
	       24'd0 :
	       { 10'd0, mlp1B__h20692 } ;
  assign mlp1B__h20692 = { mlp1__h20691[8:0], 5'd0 } ;
