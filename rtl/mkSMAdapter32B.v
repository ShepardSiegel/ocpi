...
//
// On Tue Jun  1 12:38:08 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter32B(wciS0_Clk,
  ...
  wire [31 : 0] rdat__h15540, x_byteEn__h18565;
  ...
  assign MUX_wmi_dhF_x_wire$wset_1__VAL_2 =
	     { 1'd1, x__h16715, wsiS_reqFifo$D_OUT[295:40], 32'd0 } ;
  ...
  assign errCount$EN =
	     ...
	     (!x__h16715 || wsiS_reqFifo$D_OUT[39:8] != 32'd0) ;
  ...
  assign NOT_wsiS_reqFifo_countReg_56_ULE_1_57___d358 =
	     wsiS_reqFifo_countReg > 2'd1 ;
  assign addr__h16647 = { mesgLengthSoFar[8:0], 5'd0 } ;
  ...
  assign mlp1B__h16631 = { mlp1__h16630[8:0], 5'd0 } ;
  ...
  assign x__h16715 = wsiS_reqFifo$D_OUT[307:296] == 12'd1 ;
  ...
  assign x_byteEn__h18565 = (thisMesg[15:0] == 16'd0) ? 32'd0 : 32'hFFFFFFFF ;
