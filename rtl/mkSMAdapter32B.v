...
//
// On Sun Apr  3 10:10:46 EDT 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter32B(wciS0_Clk,
  ...
  wire [307 : 0] IF_respF_wDataIn_whas__45_THEN_respF_wDataIn_w_ETC___d848;
  ...
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_3 =
	     { 4'd3, wsiS_reqFifo$D_OUT[309], 1'b0, addr__h21095, 12'd1 } ;
  ...
  assign addr__h21095 = { mesgLengthSoFar[8:0], 5'd0 } ;
  assign b__h15200 = -fabWordsCurReq[11:0] ;
  assign b__h18589 = { {2{fabRespCredit_value[11]}}, fabRespCredit_value } ;
  assign bl__h20326 = zeroLengthMesg ? 12'd1 : { 3'd0, x__h20237[13:5] } ;
  ...
  assign mesgMetaF_length__h21225 =
	     (wsiS_reqFifo$D_OUT[309] && wsiS_reqFifo$D_OUT[39:8] == 32'd0 &&
	      mesgLengthSoFar == 14'd0) ?
	       24'd0 :
	       { 10'd0, mlp1B__h21055 } ;
  assign mlp1B__h21055 = { mlp1__h21054[8:0], 5'd0 } ;
