...
//
// On Thu Jan 19 15:37:10 EST 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter32B(wciS0_Clk,
  ...
  wire [5 : 0] x__h22523,
	       ...
	       y__h22872,
	       y__h22884;
  wire [2 : 0] IF_respF_wDataIn_whas__33_THEN_respF_wDataIn_w_ETC___d956;
  ...
  assign abortCount$EN = MUX_opcode$write_1__SEL_2 ;

  // register doAbort
  assign doAbort$D_IN = 1'd0 ;
  assign doAbort$EN = MUX_opcode$write_1__SEL_2 ;
  ...
  // register opcode
  assign opcode$D_IN =
	     (MUX_opcode$write_1__SEL_1 || MUX_opcode$write_1__SEL_2) ?
	       9'd170 :
  ...
  assign readyToPush$D_IN =
	     !MUX_opcode$write_1__SEL_2 && !MUX_endOfMessage$write_1__SEL_1 ;
  ...
  assign respF_rCache$D_IN =
	     { 1'd1,
	       respF_rWrPtr,
	       IF_respF_wDataIn_whas__33_THEN_respF_wDataIn_w_ETC___d956,
  ...
  // remaining internal signals
  assign IF_respF_wDataIn_whas__33_THEN_respF_wDataIn_w_ETC___d956 =
