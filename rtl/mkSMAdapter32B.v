...
//
// On Fri Oct 29 10:34:40 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter32B(wciS0_Clk,
  ...
  wire [312 : 0] respF$D_IN, respF$D_OUT;
  ...
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_3 =
	     { 4'd3, wsiS_reqFifo$D_OUT[309], 1'b0, addr__h17509, 12'd1 } ;
  ...
  assign addr__h17509 = { mesgLengthSoFar[8:0], 5'd0 } ;
  ...
  assign bl__h18561 =
	     zeroLengthMesg ?
	       12'd1 :
	       { 3'd0,
		 IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d775[13:5] } ;
  ...
  assign mlp1B__h17493 = { mlp1__h17492[8:0], 5'd0 } ;
