...
//
// On Fri Jun 18 15:20:48 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter32B(wciS0_Clk,
  ...
  wire [31 : 0] rdat__h15541, x_byteEn__h18811;
  wire [23 : 0] mesgMetaF_length__h16963, mesgMetaF_length__h17984;
  wire [15 : 0] wsiBurstLength__h18713, x__h15544, x_length__h17238;
  ...
  assign MUX_wmi_dhF_x_wire$wset_1__VAL_2 =
	     { 1'd1, x__h16876, wsiS_reqFifo$D_OUT[295:40], 32'hFFFFFFFF } ;
  ...
  assign errCount$EN =
	     ...
	     (!x__h16876 || wsiS_reqFifo$D_OUT[39:8] != 32'd0) ;
  ...
  assign NOT_wsiS_reqFifo_countReg_59_ULE_1_60___d361 =
	     wsiS_reqFifo_countReg > 2'd1 ;
  assign addr__h16808 = { mesgLengthSoFar[8:0], 5'd0 } ;
  ...
  assign bl__h17840 =
	     zeroLengthMesg ?
	       12'd1 :
	       { 3'd0,
		 IF_mesgLength_22_BIT_14_23_THEN_mesgLength_22__ETC___d758[13:5] } ;
  ...
  assign mlp1B__h16792 = { mlp1__h16791[8:0], 5'd0 } ;
  ...
  assign x__h16876 = wsiS_reqFifo$D_OUT[307:296] == 12'd1 ;
  ...
  assign x_byteEn__h18811 = (thisMesg[15:0] == 16'd0) ? 32'd0 : 32'hFFFFFFFF ;
