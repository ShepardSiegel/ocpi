...
//
// On Fri Oct 22 08:41:50 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter32B(wciS0_Clk,
  ...
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_3 =
	     { 4'd3, wsiS_reqFifo$D_OUT[309], 1'b0, addr__h17461, 12'd1 } ;
  ...
  assign addr__h17461 = { mesgLengthSoFar[8:0], 5'd0 } ;
  ...
  assign bl__h18513 =
	     zeroLengthMesg ?
	       12'd1 :
	       { 3'd0,
		 IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d791[13:5] } ;
  ...
  assign mlp1B__h17445 = { mlp1__h17444[8:0], 5'd0 } ;
