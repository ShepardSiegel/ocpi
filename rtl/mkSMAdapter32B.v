...
//
// On Wed Jul 14 11:35:06 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter32B(wciS0_Clk,
  ...
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_3 =
	     { 4'd3, wsiS_reqFifo$D_OUT[309], 1'b0, addr__h17222, 12'd1 } ;
  ...
  assign addr__h17222 = { mesgLengthSoFar[8:0], 5'd0 } ;
  ...
  assign bl__h18274 =
	     zeroLengthMesg ?
	       12'd1 :
	       { 3'd0,
		 IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d790[13:5] } ;
  ...
  assign mlp1B__h17206 = { mlp1__h17205[8:0], 5'd0 } ;
  ...
  assign x_byteEn__h19245 = (thisMesg[15:0] == 16'd0) ? 32'd0 : 32'hFFFFFFFF ;
