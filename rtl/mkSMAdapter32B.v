...
//
// On Fri Jul 23 11:10:00 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter32B(wciS0_Clk,
  ...
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_3 =
	     { 4'd3, wsiS_reqFifo$D_OUT[309], 1'b0, addr__h17299, 12'd1 } ;
  ...
  assign addr__h17299 = { mesgLengthSoFar[8:0], 5'd0 } ;
  ...
  assign bl__h18351 =
	     zeroLengthMesg ?
	       12'd1 :
	       { 3'd0,
		 IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d798[13:5] } ;
  ...
  assign mlp1B__h17283 = { mlp1__h17282[8:0], 5'd0 } ;
  ...
  assign x_byteEn__h19322 = (thisMesg[15:0] == 16'd0) ? 32'd0 : 32'hFFFFFFFF ;
