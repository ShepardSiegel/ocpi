...
//
// On Fri Jun 21 16:58:01 EDT 2013
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter32B(wciS0_Clk,
  ...
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_2 = { 2'd1, g_data__h24896 } ;
  ...
  assign rdat__h25087 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h25101 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h25109 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h25115 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h25129 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h25137 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  ...
  assign wsiS_reqFifo_i_notEmpty__61_AND_NOT_smaCtrl_62_ETC___d666 =
	     ...
	     (!wsiS_reqFifo$D_OUT[309] || wmi_mFlagF_cntr_r != 2'd2) ;
  ...
  assign x__h22771 = { 5'd0, wsiS_reqFifo$D_OUT[39] } ;
  ...
  assign y__h22412 = { 5'd0, wsiS_reqFifo$D_OUT[8] } ;
  assign y__h22424 = { 5'd0, wsiS_reqFifo$D_OUT[9] } ;
  assign y__h22436 = { 5'd0, wsiS_reqFifo$D_OUT[10] } ;
  assign y__h22448 = { 5'd0, wsiS_reqFifo$D_OUT[11] } ;
  assign y__h22460 = { 5'd0, wsiS_reqFifo$D_OUT[12] } ;
  assign y__h22472 = { 5'd0, wsiS_reqFifo$D_OUT[13] } ;
  assign y__h22484 = { 5'd0, wsiS_reqFifo$D_OUT[14] } ;
  assign y__h22496 = { 5'd0, wsiS_reqFifo$D_OUT[15] } ;
  assign y__h22508 = { 5'd0, wsiS_reqFifo$D_OUT[16] } ;
  assign y__h22520 = { 5'd0, wsiS_reqFifo$D_OUT[17] } ;
  assign y__h22532 = { 5'd0, wsiS_reqFifo$D_OUT[18] } ;
  assign y__h22544 = { 5'd0, wsiS_reqFifo$D_OUT[19] } ;
  assign y__h22556 = { 5'd0, wsiS_reqFifo$D_OUT[20] } ;
  assign y__h22568 = { 5'd0, wsiS_reqFifo$D_OUT[21] } ;
  assign y__h22580 = { 5'd0, wsiS_reqFifo$D_OUT[22] } ;
  assign y__h22592 = { 5'd0, wsiS_reqFifo$D_OUT[23] } ;
  assign y__h22604 = { 5'd0, wsiS_reqFifo$D_OUT[24] } ;
  assign y__h22616 = { 5'd0, wsiS_reqFifo$D_OUT[25] } ;
  assign y__h22628 = { 5'd0, wsiS_reqFifo$D_OUT[26] } ;
  assign y__h22640 = { 5'd0, wsiS_reqFifo$D_OUT[27] } ;
  assign y__h22652 = { 5'd0, wsiS_reqFifo$D_OUT[28] } ;
  assign y__h22664 = { 5'd0, wsiS_reqFifo$D_OUT[29] } ;
  assign y__h22676 = { 5'd0, wsiS_reqFifo$D_OUT[30] } ;
  assign y__h22688 = { 5'd0, wsiS_reqFifo$D_OUT[31] } ;
  assign y__h22700 = { 5'd0, wsiS_reqFifo$D_OUT[32] } ;
  assign y__h22712 = { 5'd0, wsiS_reqFifo$D_OUT[33] } ;
  assign y__h22724 = { 5'd0, wsiS_reqFifo$D_OUT[34] } ;
  assign y__h22736 = { 5'd0, wsiS_reqFifo$D_OUT[35] } ;
  assign y__h22748 = { 5'd0, wsiS_reqFifo$D_OUT[36] } ;
  assign y__h22760 = { 5'd0, wsiS_reqFifo$D_OUT[37] } ;
  assign y__h22772 = { 5'd0, wsiS_reqFifo$D_OUT[38] } ;
