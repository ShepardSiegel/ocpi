...
//
// On Wed Jun 22 17:51:11 EDT 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter32B(wciS0_Clk,
  ...
  wire [312 : 0] respF_memory$DIA, respF_memory$DIB, respF_memory$DOB;
  ...
  reg [63 : 0] v__h18234,
	       ...
	       v__h3825,
	       v__h3969;
  reg [31 : 0] g_data__h25050;
  wire [307 : 0] IF_respF_wDataIn_whas__45_THEN_respF_wDataIn_w_ETC___d1048;
  wire [31 : 0] rdat__h25093,
		rdat__h25099,
		rdat__h25105,
		rdat__h25118,
		rdat__h25141,
		...
		rdat__h25309,
		rdat__h25315,
		sendData_byteEn__h18777,
		value__h6627;
  wire [23 : 0] mesgMetaF_length__h22534;
  wire [15 : 0] wsiBurstLength__h18693, x__h25145, x_length__h24081;
  wire [13 : 0] addr__h22400, b__h18318, mlB__h22360, mlInc__h22359;
  wire [11 : 0] b__h15201, sendData_burstLength__h18775, x__h16555;
  wire [7 : 0] mesgMetaF_opcode__h22533;
  wire [5 : 0] x__h22573,
	       x__h22585,
	       x__h22597,
	       x__h22609,
	       ...
	       y__h22922,
	       y__h22934;
  wire [2 : 0] IF_respF_wDataIn_whas__45_THEN_respF_wDataIn_w_ETC___d1049;
  wire NOT_wmi_reqF_c_r_57_EQ_2_76_77_AND_wmi_operate_ETC___d529,
       wmi_respF_i_notEmpty__42_AND_smaCtrl_77_BIT_4__ETC___d547,
       wsiS_reqFifo_i_notEmpty__76_AND_NOT_smaCtrl_77_ETC___d674,
  ...
  // value method wmiM0_mDataLast
  assign wmiM0_MDataLast = wmi_dhF_q_0[288] ;

  // value method wmiM0_mData
  assign wmiM0_MData = wmi_dhF_q_0[287:32] ;

  // value method wmiM0_mDataByteEn
  assign wmiM0_MDataByteEn = wmi_dhF_q_0[31:0] ;
  ...
  assign WILL_FIRE_RL_wmwt_mesgBegin =
	     CAN_FIRE_RL_wmwt_mesgBegin && !WILL_FIRE_RL_wmwt_messagePush ;
  ...
  assign CAN_FIRE_RL_wmwt_messagePush =
	     ...
	     (smaCtrl[3:0] == 4'h2 || smaCtrl[3:0] == 4'h3) &&
	     readyToPush ;
  assign WILL_FIRE_RL_wmwt_messagePush =
	     CAN_FIRE_RL_wmwt_messagePush &&
	     !WILL_FIRE_RL_wmwt_messageFinalize ;
  ...
  assign CAN_FIRE_RL_wmi_dhF_incCtr =
	     ((wmi_dhF_c_r == 2'd0) ?
		WILL_FIRE_RL_wmwt_messagePush :
		wmi_dhF_c_r != 2'd1 || WILL_FIRE_RL_wmwt_messagePush) &&
	     WILL_FIRE_RL_wmwt_messagePush &&
	     !wmi_dhF_dequeueing$whas ;
  ...
  assign CAN_FIRE_RL_wmi_dhF_decCtr =
	     wmi_dhF_dequeueing$whas && !WILL_FIRE_RL_wmwt_messagePush ;
  ...
  assign CAN_FIRE_RL_wmi_dhF_both =
	     ((wmi_dhF_c_r == 2'd1) ?
		WILL_FIRE_RL_wmwt_messagePush :
		wmi_dhF_c_r != 2'd2 || WILL_FIRE_RL_wmwt_messagePush) &&
	     wmi_dhF_dequeueing$whas &&
	     WILL_FIRE_RL_wmwt_messagePush ;
  ...
  assign MUX_endOfMessage$write_1__SEL_1 =
	     WILL_FIRE_RL_wmwt_messagePush && wsiS_reqFifo$D_OUT[309] ;
  ...
  assign MUX_wmi_mFlagF_x_wire$wset_1__SEL_1 =
	     WILL_FIRE_RL_wmrd_mesgBodyRequest && x__h18489 ;
  ...
  assign MUX_wsiM_reqFifo_x_wire$wset_1__SEL_1 =
	     WILL_FIRE_RL_wmwt_messagePush && smaCtrl[3:0] == 4'h3 ;
  ...
  assign MUX_fabRespCredit_value$write_1__VAL_2 =
	     fabRespCredit_value +
	     (CAN_FIRE_RL_wmrd_mesgBodyRequest ? b__h15201 : 12'd0) +
  ...
  assign MUX_thisMesg$write_1__VAL_1 =
	     { mesgCount[7:0], mesgMetaF_opcode__h22533, x_length__h24081 } ;
  ...
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_2 = { 2'd1, g_data__h25050 } ;
  ...
  assign MUX_wmi_mFlagF_q_0$write_1__VAL_1 =
	     (wmi_mFlagF_c_r == 2'd1) ? value__h6627 : wmi_mFlagF_q_1 ;
  assign MUX_wmi_mFlagF_q_1$write_1__VAL_1 =
	     (wmi_mFlagF_c_r == 2'd2) ? value__h6627 : 32'd0 ;
  assign MUX_wmi_mFlagF_x_wire$wset_1__VAL_2 =
	     { mesgMetaF_opcode__h22533, mesgMetaF_length__h22534 } ;
  ...
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_1 =
	     { 4'd5, x__h18489, 1'b0, mesgReqAddr, fabWordsCurReq[11:0] } ;
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_2 =
	     { 4'd3, wsiS_reqFifo$D_OUT[309], 1'b0, addr__h22400, 12'd1 } ;
  ...
  assign fabRespCredit_acc_v1$wget = b__h15201 ;
  ...
  assign wmi_mFlagF_dequeueing$whas =
	     ...
	     wmi_mFlagF_c_r != 2'd0 ;
  assign wmi_dhF_enqueueing$whas = WILL_FIRE_RL_wmwt_messagePush ;
  ...
  assign fabWordsCurReq$D_IN =
	     (fabWordsRemain <= b__h18318) ? fabWordsRemain : b__h18318 ;
  ...
  assign mesgLengthSoFar$EN =
	     WILL_FIRE_RL_wmwt_messagePush || WILL_FIRE_RL_wmwt_mesgBegin ;
  ...
  assign respF_rCache$D_IN =
	     { 1'd1,
	       respF_rWrPtr,
	       IF_respF_wDataIn_whas__45_THEN_respF_wDataIn_w_ETC___d1049,
	       respF_pwEnqueue$whas && respF_wDataIn$wget[309],
	       respF_pwEnqueue$whas && respF_wDataIn$wget[308],
	       IF_respF_wDataIn_whas__45_THEN_respF_wDataIn_w_ETC___d1048 } ;
  assign respF_rCache$EN = respF_pwEnqueue$whas ;

  // register respF_rRdPtr
  assign respF_rRdPtr$D_IN = x__h16555 ;
  ...
  always@(WILL_FIRE_RL_wmi_mFlagF_both or
	  ...
	  value__h6627 or WILL_FIRE_RL_wmi_mFlagF_decCtr or wmi_mFlagF_q_1)
  begin
    case (1'b1) // synopsys parallel_case
      WILL_FIRE_RL_wmi_mFlagF_both:
	  wmi_mFlagF_q_0$D_IN = MUX_wmi_mFlagF_q_0$write_1__VAL_1;
      MUX_wmi_mFlagF_q_0$write_1__SEL_2: wmi_mFlagF_q_0$D_IN = value__h6627;
  ...
  always@(WILL_FIRE_RL_wmi_mFlagF_both or
	  ...
	  value__h6627 or WILL_FIRE_RL_wmi_mFlagF_decCtr)
  begin
    case (1'b1) // synopsys parallel_case
      WILL_FIRE_RL_wmi_mFlagF_both:
	  wmi_mFlagF_q_1$D_IN = MUX_wmi_mFlagF_q_1$write_1__VAL_1;
      MUX_wmi_mFlagF_q_1$write_1__SEL_2: wmi_mFlagF_q_1$D_IN = value__h6627;
  ...
  assign wmwtPushCount$EN = WILL_FIRE_RL_wmwt_messagePush ;
  ...
  // remaining internal signals
  assign IF_respF_wDataIn_whas__45_THEN_respF_wDataIn_w_ETC___d1048 =
	     respF_pwEnqueue$whas ? respF_wDataIn$wget[307:0] : 308'd0 ;
  assign IF_respF_wDataIn_whas__45_THEN_respF_wDataIn_w_ETC___d1049 =
  ...
  assign NOT_wmi_reqF_c_r_57_EQ_2_76_77_AND_wmi_operate_ETC___d529 =
	     ...
	     (!x__h18489 || wmi_mFlagF_c_r != 2'd2) ;
  assign addr__h22400 = { mesgLengthSoFar[8:0], 5'd0 } ;
  assign b__h15201 = -fabWordsCurReq[11:0] ;
  assign b__h18318 = { {2{fabRespCredit_value[11]}}, fabRespCredit_value } ;
  assign mesgMetaF_length__h22534 =
	     (wsiS_reqFifo$D_OUT[309] && wsiS_reqFifo$D_OUT[39:8] == 32'd0 &&
	      mesgLengthSoFar == 14'd0) ?
	       24'd0 :
	       { 10'd0, mlB__h22360 } ;
  assign mesgMetaF_opcode__h22533 = opcode[8] ? opcode[7:0] : 8'd0 ;
  assign mlB__h22360 = MUX_mesgLengthSoFar$write_1__VAL_1 ;
  assign mlInc__h22359 =
	     wsiS_reqFifo$D_OUT[309] ?
	       { 8'd0, x__h22573 + y__h22574 } :
	       14'd32 ;
  assign rdat__h25093 = hasDebugLogic ? mesgCount : 32'd0 ;
  assign rdat__h25099 = hasDebugLogic ? abortCount : 32'd0 ;
  assign rdat__h25105 = hasDebugLogic ? thisMesg : 32'd0 ;
  assign rdat__h25118 = hasDebugLogic ? lastMesg : 32'd0 ;
  assign rdat__h25141 = hasDebugLogic ? { 16'd0, x__h25145 } : 32'd0 ;
  assign rdat__h25241 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h25255 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h25263 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h25269 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h25283 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h25291 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h25297 = hasDebugLogic ? wmwtBeginCount : 32'd0 ;
  assign rdat__h25303 = hasDebugLogic ? wmwtPushCount : 32'd0 ;
  assign rdat__h25309 = hasDebugLogic ? wmwtFinalCount : 32'd0 ;
  assign rdat__h25315 = hasDebugLogic ? 32'hFEEDC0DE : 32'd0 ;
  assign sendData_burstLength__h18775 =
	     (thisMesg[15:0] == 16'd0 || smaCtrl[5] && unrollCnt == 16'd1) ?
	       12'd1 :
	       (smaCtrl[5] ? 12'd4095 : wsiBurstLength__h18693[11:0]) ;
  assign sendData_byteEn__h18777 =
	     (thisMesg[15:0] == 16'd0) ?
	       32'd0 :
	       ((unrollCnt == 16'd1) ?
  ...
  assign value__h6627 =
	     MUX_wmi_mFlagF_x_wire$wset_1__SEL_1 ?
	       ...
	       MUX_wmi_mFlagF_x_wire$wset_1__VAL_2 ;
  assign wmi_respF_i_notEmpty__42_AND_smaCtrl_77_BIT_4__ETC___d547 =
	     wmi_respF$EMPTY_N &&
	     (smaCtrl[4] || respF_rRdPtr + 12'd1024 != respF_rWrPtr) ;
  assign wsiBurstLength__h18693 =
	     smaCtrl[5] ? 16'd2 : { 5'd0, thisMesg[15:5] } ;
  assign wsiS_reqFifo_i_notEmpty__76_AND_NOT_smaCtrl_77_ETC___d674 =
	     wsiS_reqFifo$EMPTY_N &&
  ...
  assign wsiS_reqFifo_notFull__79_AND_wsiS_burstKind_94_ETC___d401 =
	     ...
	     (wsiS_burstKind == 2'd0 ||
	      ...
	      wsiS_wsiReq$wget[309]) ;
  assign x__h16555 = respF_rRdPtr + 12'd1 ;
  assign x__h18489 = fabWordsRemain == fabWordsCurReq ;
  assign x__h22573 = x__h22585 + y__h22586 ;
  assign x__h22585 = x__h22597 + y__h22598 ;
  assign x__h22597 = x__h22609 + y__h22610 ;
  assign x__h22609 = x__h22621 + y__h22622 ;
  assign x__h22621 = x__h22633 + y__h22634 ;
  assign x__h22633 = x__h22645 + y__h22646 ;
  assign x__h22645 = x__h22657 + y__h22658 ;
  assign x__h22657 = x__h22669 + y__h22670 ;
  assign x__h22669 = x__h22681 + y__h22682 ;
  assign x__h22681 = x__h22693 + y__h22694 ;
  assign x__h22693 = x__h22705 + y__h22706 ;
  assign x__h22705 = x__h22717 + y__h22718 ;
  assign x__h22717 = x__h22729 + y__h22730 ;
  assign x__h22729 = x__h22741 + y__h22742 ;
  assign x__h22741 = x__h22753 + y__h22754 ;
  assign x__h22753 = x__h22765 + y__h22766 ;
  assign x__h22765 = x__h22777 + y__h22778 ;
  assign x__h22777 = x__h22789 + y__h22790 ;
  assign x__h22789 = x__h22801 + y__h22802 ;
  assign x__h22801 = x__h22813 + y__h22814 ;
  assign x__h22813 = x__h22825 + y__h22826 ;
  assign x__h22825 = x__h22837 + y__h22838 ;
  assign x__h22837 = x__h22849 + y__h22850 ;
  assign x__h22849 = x__h22861 + y__h22862 ;
  assign x__h22861 = x__h22873 + y__h22874 ;
  assign x__h22873 = x__h22885 + y__h22886 ;
  assign x__h22885 = x__h22897 + y__h22898 ;
  assign x__h22897 = x__h22909 + y__h22910 ;
  assign x__h22909 = x__h22921 + y__h22922 ;
  assign x__h22921 = x__h22933 + y__h22934 ;
  assign x__h22933 = { 5'd0, wsiS_reqFifo$D_OUT[39] } ;
  assign x__h25145 = { wsiS_statusR, wsiM_statusR } ;
  assign x_length__h24081 = { 2'd0, mlB__h22360 } ;
  assign y__h22574 = { 5'd0, wsiS_reqFifo$D_OUT[8] } ;
  assign y__h22586 = { 5'd0, wsiS_reqFifo$D_OUT[9] } ;
  assign y__h22598 = { 5'd0, wsiS_reqFifo$D_OUT[10] } ;
  assign y__h22610 = { 5'd0, wsiS_reqFifo$D_OUT[11] } ;
  assign y__h22622 = { 5'd0, wsiS_reqFifo$D_OUT[12] } ;
  assign y__h22634 = { 5'd0, wsiS_reqFifo$D_OUT[13] } ;
  assign y__h22646 = { 5'd0, wsiS_reqFifo$D_OUT[14] } ;
  assign y__h22658 = { 5'd0, wsiS_reqFifo$D_OUT[15] } ;
  assign y__h22670 = { 5'd0, wsiS_reqFifo$D_OUT[16] } ;
  assign y__h22682 = { 5'd0, wsiS_reqFifo$D_OUT[17] } ;
  assign y__h22694 = { 5'd0, wsiS_reqFifo$D_OUT[18] } ;
  assign y__h22706 = { 5'd0, wsiS_reqFifo$D_OUT[19] } ;
  assign y__h22718 = { 5'd0, wsiS_reqFifo$D_OUT[20] } ;
  assign y__h22730 = { 5'd0, wsiS_reqFifo$D_OUT[21] } ;
  assign y__h22742 = { 5'd0, wsiS_reqFifo$D_OUT[22] } ;
  assign y__h22754 = { 5'd0, wsiS_reqFifo$D_OUT[23] } ;
  assign y__h22766 = { 5'd0, wsiS_reqFifo$D_OUT[24] } ;
  assign y__h22778 = { 5'd0, wsiS_reqFifo$D_OUT[25] } ;
  assign y__h22790 = { 5'd0, wsiS_reqFifo$D_OUT[26] } ;
  assign y__h22802 = { 5'd0, wsiS_reqFifo$D_OUT[27] } ;
  assign y__h22814 = { 5'd0, wsiS_reqFifo$D_OUT[28] } ;
  assign y__h22826 = { 5'd0, wsiS_reqFifo$D_OUT[29] } ;
  assign y__h22838 = { 5'd0, wsiS_reqFifo$D_OUT[30] } ;
  assign y__h22850 = { 5'd0, wsiS_reqFifo$D_OUT[31] } ;
  assign y__h22862 = { 5'd0, wsiS_reqFifo$D_OUT[32] } ;
  assign y__h22874 = { 5'd0, wsiS_reqFifo$D_OUT[33] } ;
  assign y__h22886 = { 5'd0, wsiS_reqFifo$D_OUT[34] } ;
  assign y__h22898 = { 5'd0, wsiS_reqFifo$D_OUT[35] } ;
  assign y__h22910 = { 5'd0, wsiS_reqFifo$D_OUT[36] } ;
  assign y__h22922 = { 5'd0, wsiS_reqFifo$D_OUT[37] } ;
  assign y__h22934 = { 5'd0, wsiS_reqFifo$D_OUT[38] } ;
  always@(wci_wslv_reqF$D_OUT or
	  ...
	  rdat__h25283 or
	  rdat__h25291 or
	  rdat__h25297 or rdat__h25303 or rdat__h25309 or rdat__h25315)
  begin
    case (wci_wslv_reqF$D_OUT[39:32])
      8'h0: g_data__h25050 = smaCtrl;
      8'h04: g_data__h25050 = rdat__h25093;
      8'h08: g_data__h25050 = rdat__h25099;
      8'h10: g_data__h25050 = rdat__h25105;
      8'h14: g_data__h25050 = rdat__h25118;
      8'h18: g_data__h25050 = rdat__h25141;
      8'h20: g_data__h25050 = rdat__h25241;
      8'h24: g_data__h25050 = rdat__h25255;
      8'h28: g_data__h25050 = rdat__h25263;
      8'h2C: g_data__h25050 = rdat__h25269;
      8'h30: g_data__h25050 = rdat__h25283;
      8'h34: g_data__h25050 = rdat__h25291;
      8'h38: g_data__h25050 = rdat__h25297;
      8'h3C: g_data__h25050 = rdat__h25303;
      8'h40: g_data__h25050 = rdat__h25309;
      8'h44: g_data__h25050 = rdat__h25315;
      default: g_data__h25050 = 32'd0;
    endcase
  end
  ...
  begin
    ...
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wmwt_doAbort)
	$display("[%0d]: %m: wmwt_doAbort", v__h24501);
    if (wciS0_MReset_n)
