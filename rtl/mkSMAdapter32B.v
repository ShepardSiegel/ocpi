...
//
// On Sat Sep 29 14:30:00 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter32B(wciS0_Clk,
  ...
  wire [307 : 0] IF_respF_wDataIn_whas__33_THEN_respF_wDataIn_w_ETC___d965;
  ...
  wire [23 : 0] b__h18410,
		...
		residue__h18273,
		x__h18530;
  wire [15 : 0] wsiBurstLength__h19161, x__h25619, x_length__h24547;
  ...
  wire [5 : 0] x__h23038,
	       ...
	       y__h23387,
	       y__h23399;
  wire [2 : 0] IF_respF_wDataIn_whas__33_THEN_respF_wDataIn_w_ETC___d974;
  ...
  assign MUX_thisMesg$write_1__VAL_1 =
	     { mesgCount[7:0], mesgMetaF_opcode__h22998, x_length__h24547 } ;
  ...
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_2 = { 2'd1, g_data__h25524 } ;
  ...
  assign mlInc__h22831 =
	     wsiS_reqFifo$D_OUT[309] ?
	       { 8'd0, x__h23038 + y__h23039 } :
	       14'd32 ;
  assign rdat__h25567 = hasDebugLogic ? mesgCount : 32'd0 ;
  assign rdat__h25573 = hasDebugLogic ? abortCount : 32'd0 ;
  assign rdat__h25579 = hasDebugLogic ? thisMesg : 32'd0 ;
  assign rdat__h25592 = hasDebugLogic ? lastMesg : 32'd0 ;
  assign rdat__h25615 = hasDebugLogic ? { 16'd0, x__h25619 } : 32'd0 ;
  assign rdat__h25715 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h25729 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h25737 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h25743 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h25757 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h25765 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h25771 = hasDebugLogic ? wmwtBeginCount : 32'd0 ;
  assign rdat__h25777 = hasDebugLogic ? wmwtPushCount : 32'd0 ;
  assign rdat__h25783 = hasDebugLogic ? wmwtFinalCount : 32'd0 ;
  assign rdat__h25789 = hasDebugLogic ? { 31'd0, x__h25793 } : 32'd0 ;
  assign rdat__h25799 = hasDebugLogic ? 32'hFEEDC0DE : 32'd0 ;
  ...
  assign x__h18530 = { 5'd0, wmi_sFlagReg[23:5] } ;
  assign x__h18954 = fabWordsRemain == fabWordsCurReq ;
  assign x__h23038 = x__h23050 + y__h23051 ;
  assign x__h23050 = x__h23062 + y__h23063 ;
  assign x__h23062 = x__h23074 + y__h23075 ;
  assign x__h23074 = x__h23086 + y__h23087 ;
  assign x__h23086 = x__h23098 + y__h23099 ;
  assign x__h23098 = x__h23110 + y__h23111 ;
  assign x__h23110 = x__h23122 + y__h23123 ;
  assign x__h23122 = x__h23134 + y__h23135 ;
  assign x__h23134 = x__h23146 + y__h23147 ;
  assign x__h23146 = x__h23158 + y__h23159 ;
  assign x__h23158 = x__h23170 + y__h23171 ;
  assign x__h23170 = x__h23182 + y__h23183 ;
  assign x__h23182 = x__h23194 + y__h23195 ;
  assign x__h23194 = x__h23206 + y__h23207 ;
  assign x__h23206 = x__h23218 + y__h23219 ;
  assign x__h23218 = x__h23230 + y__h23231 ;
  assign x__h23230 = x__h23242 + y__h23243 ;
  assign x__h23242 = x__h23254 + y__h23255 ;
  assign x__h23254 = x__h23266 + y__h23267 ;
  assign x__h23266 = x__h23278 + y__h23279 ;
  assign x__h23278 = x__h23290 + y__h23291 ;
  assign x__h23290 = x__h23302 + y__h23303 ;
  assign x__h23302 = x__h23314 + y__h23315 ;
  assign x__h23314 = x__h23326 + y__h23327 ;
  assign x__h23326 = x__h23338 + y__h23339 ;
  assign x__h23338 = x__h23350 + y__h23351 ;
  assign x__h23350 = x__h23362 + y__h23363 ;
  assign x__h23362 = x__h23374 + y__h23375 ;
  assign x__h23374 = x__h23386 + y__h23387 ;
  assign x__h23386 = x__h23398 + y__h23399 ;
  assign x__h23398 = { 5'd0, wsiS_reqFifo$D_OUT[39] } ;
  assign x__h25619 = { wsiS_statusR, wsiM_statusR } ;
  assign x__h25793 = wmi_sThreadBusy_d || wmi_sDataThreadBusy_d ;
  assign x_length__h24547 = { 2'd0, mlB__h22832 } ;
  assign y__h23039 = { 5'd0, wsiS_reqFifo$D_OUT[8] } ;
  assign y__h23051 = { 5'd0, wsiS_reqFifo$D_OUT[9] } ;
  assign y__h23063 = { 5'd0, wsiS_reqFifo$D_OUT[10] } ;
  assign y__h23075 = { 5'd0, wsiS_reqFifo$D_OUT[11] } ;
  assign y__h23087 = { 5'd0, wsiS_reqFifo$D_OUT[12] } ;
  assign y__h23099 = { 5'd0, wsiS_reqFifo$D_OUT[13] } ;
  assign y__h23111 = { 5'd0, wsiS_reqFifo$D_OUT[14] } ;
  assign y__h23123 = { 5'd0, wsiS_reqFifo$D_OUT[15] } ;
  assign y__h23135 = { 5'd0, wsiS_reqFifo$D_OUT[16] } ;
  assign y__h23147 = { 5'd0, wsiS_reqFifo$D_OUT[17] } ;
  assign y__h23159 = { 5'd0, wsiS_reqFifo$D_OUT[18] } ;
  assign y__h23171 = { 5'd0, wsiS_reqFifo$D_OUT[19] } ;
  assign y__h23183 = { 5'd0, wsiS_reqFifo$D_OUT[20] } ;
  assign y__h23195 = { 5'd0, wsiS_reqFifo$D_OUT[21] } ;
  assign y__h23207 = { 5'd0, wsiS_reqFifo$D_OUT[22] } ;
  assign y__h23219 = { 5'd0, wsiS_reqFifo$D_OUT[23] } ;
  assign y__h23231 = { 5'd0, wsiS_reqFifo$D_OUT[24] } ;
  assign y__h23243 = { 5'd0, wsiS_reqFifo$D_OUT[25] } ;
  assign y__h23255 = { 5'd0, wsiS_reqFifo$D_OUT[26] } ;
  assign y__h23267 = { 5'd0, wsiS_reqFifo$D_OUT[27] } ;
  assign y__h23279 = { 5'd0, wsiS_reqFifo$D_OUT[28] } ;
  assign y__h23291 = { 5'd0, wsiS_reqFifo$D_OUT[29] } ;
  assign y__h23303 = { 5'd0, wsiS_reqFifo$D_OUT[30] } ;
  assign y__h23315 = { 5'd0, wsiS_reqFifo$D_OUT[31] } ;
  assign y__h23327 = { 5'd0, wsiS_reqFifo$D_OUT[32] } ;
  assign y__h23339 = { 5'd0, wsiS_reqFifo$D_OUT[33] } ;
  assign y__h23351 = { 5'd0, wsiS_reqFifo$D_OUT[34] } ;
  assign y__h23363 = { 5'd0, wsiS_reqFifo$D_OUT[35] } ;
  assign y__h23375 = { 5'd0, wsiS_reqFifo$D_OUT[36] } ;
  assign y__h23387 = { 5'd0, wsiS_reqFifo$D_OUT[37] } ;
  assign y__h23399 = { 5'd0, wsiS_reqFifo$D_OUT[38] } ;
  always@(wci_wslv_reqF$D_OUT or
	  ...
	  rdat__h25765 or
	  rdat__h25771 or
	  rdat__h25777 or rdat__h25783 or rdat__h25789 or rdat__h25799)
  begin
    case (wci_wslv_reqF$D_OUT[39:32])
      8'h0: g_data__h25524 = smaCtrl;
      8'h04: g_data__h25524 = rdat__h25567;
      8'h08: g_data__h25524 = rdat__h25573;
      8'h10: g_data__h25524 = rdat__h25579;
      8'h14: g_data__h25524 = rdat__h25592;
      8'h18: g_data__h25524 = rdat__h25615;
      8'h20: g_data__h25524 = rdat__h25715;
      8'h24: g_data__h25524 = rdat__h25729;
      8'h28: g_data__h25524 = rdat__h25737;
      8'h2C: g_data__h25524 = rdat__h25743;
      8'h30: g_data__h25524 = rdat__h25757;
      8'h34: g_data__h25524 = rdat__h25765;
      8'h38: g_data__h25524 = rdat__h25771;
      8'h3C: g_data__h25524 = rdat__h25777;
      8'h40: g_data__h25524 = rdat__h25783;
      8'h44: g_data__h25524 = rdat__h25789;
      8'h48: g_data__h25524 = rdat__h25799;
      default: g_data__h25524 = 32'd0;
    endcase
  end
  ...
  begin
    ...
    if (wciS0_MReset_n != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_wmwt_doAbort)
	$display("[%0d]: %m: wmwt_doAbort", v__h24973);
    if (wciS0_MReset_n != `BSV_RESET_VALUE)
