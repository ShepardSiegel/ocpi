...
//
// On Thu Dec 16 18:38:57 EST 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter32B(wciS0_Clk,
  ...
  wire [255 : 0] wmiM_MData, wsiM0_MData;
  wire [31 : 0] wciS0_SData, wmiM_MDataByteEn, wmiM_MFlag, wsiM0_MByteEn;
  ...
  wire [307 : 0] IF_respF_wDataIn_whas__26_THEN_respF_wDataIn_w_ETC___d813;
  ...
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_3 =
	     { 4'd3, wsiS_reqFifo$D_OUT[309], 1'b0, addr__h20009, 12'd1 } ;
  ...
  assign sendData_byteEn__h18152 =
	     (thisMesg[15:0] == 16'd0) ? 32'd0 : 32'hFFFFFFFF ;
