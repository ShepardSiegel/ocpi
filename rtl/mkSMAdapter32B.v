...
//
// On Sun Aug 19 11:25:53 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter32B(wciS0_Clk,
  ...
  wire MUX_lastMesg$write_1__SEL_1,
  ...
  reg [63 : 0] v__h18191,
	       ...
	       v__h3825,
	       v__h3969;
  reg [31 : 0] g_data__h25001;
  wire [307 : 0] IF_respF_wDataIn_whas__33_THEN_respF_wDataIn_w_ETC___d1037;
  wire [31 : 0] rdat__h25044,
		rdat__h25050,
		rdat__h25056,
		rdat__h25069,
		rdat__h25092,
  ...
  wire [23 : 0] b__h17902,
		...
		residue__h17765,
		x__h18022;
  wire [15 : 0] wsiBurstLength__h18650, x__h25096, x_length__h24032;
  ...
  wire [5 : 0] x__h22523,
	       ...
	       y__h22872,
	       y__h22884;
  wire [2 : 0] IF_respF_wDataIn_whas__33_THEN_respF_wDataIn_w_ETC___d1035;
  ...
  assign WILL_FIRE_RL_wsiS_reqFifo_reset =
	     WILL_FIRE_RL_wsiS_reqFifo_enq || wsiS_reqFifo_doResetDeq$whas ;

  // inputs to muxes for submodule ports
  assign MUX_lastMesg$write_1__SEL_1 =
  ...
  assign MUX_thisMesg$write_1__VAL_1 =
	     { mesgCount[7:0], mesgMetaF_opcode__h22483, x_length__h24032 } ;
  ...
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_2 = { 2'd1, g_data__h25001 } ;
  ...
  assign MUX_wmi_dhF_q_0$write_1__VAL_2 =
	     { 1'd1, wsiS_reqFifo$D_OUT[309], wsiS_reqFifo$D_OUT[295:8] } ;
  assign MUX_wmi_dhF_q_1$write_1__VAL_1 =
	     (wmi_dhF_c_r == 2'd2) ? MUX_wmi_dhF_q_0$write_1__VAL_2 : 290'd0 ;
  ...
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_2 =
	     { 4'd3, wsiS_reqFifo$D_OUT[309], 1'b0, mesgLengthSoFar, 12'd1 } ;
  ...
  assign wsiS_reqFifo_r_deq$whas = wsiS_reqFifo_doResetDeq$whas ;
  ...
  // register endOfMessage
  assign endOfMessage$D_IN = MUX_lastMesg$write_1__SEL_1 ;
  ...
  assign lastMesg$D_IN =
	     (MUX_lastMesg$write_1__SEL_1 || WILL_FIRE_RL_wmrd_mesgBegin) ?
	       thisMesg :
	       32'hFEFEFFFE ;
  assign lastMesg$EN =
	     WILL_FIRE_RL_wmwt_messagePush && wsiS_reqFifo$D_OUT[309] ||
  ...
  assign readyToPush$D_IN =
	     !WILL_FIRE_RL_wmwt_doAbort && !MUX_lastMesg$write_1__SEL_1 ;
  ...
  assign respF_rCache$D_IN =
	     { 1'd1,
	       respF_rWrPtr,
	       IF_respF_wDataIn_whas__33_THEN_respF_wDataIn_w_ETC___d1035,
	       respF_pwEnqueue$whas && respF_wDataIn$wget[309],
	       respF_pwEnqueue$whas && respF_wDataIn$wget[308],
	       IF_respF_wDataIn_whas__33_THEN_respF_wDataIn_w_ETC___d1037 } ;
  ...
  begin
    case (1'b1) // synopsys parallel_case
      ...
      WILL_FIRE_RL_wmi_dhF_decCtr: wmi_dhF_q_1$D_IN = 290'd0;
  ...
  assign wsiS_reqFifo$DEQ = wsiS_reqFifo_doResetDeq$whas ;
  assign wsiS_reqFifo$CLR = 1'b0 ;

  // remaining internal signals
  assign IF_respF_wDataIn_whas__33_THEN_respF_wDataIn_w_ETC___d1035 =
	     respF_pwEnqueue$whas ? respF_wDataIn$wget[312:310] : 3'd0 ;
  assign IF_respF_wDataIn_whas__33_THEN_respF_wDataIn_w_ETC___d1037 =
  ...
  assign mlInc__h22316 =
	     wsiS_reqFifo$D_OUT[309] ?
	       { 8'd0, x__h22523 + y__h22524 } :
	       14'd32 ;
  assign rdat__h25044 = hasDebugLogic ? mesgCount : 32'd0 ;
  assign rdat__h25050 = hasDebugLogic ? abortCount : 32'd0 ;
  assign rdat__h25056 = hasDebugLogic ? thisMesg : 32'd0 ;
  assign rdat__h25069 = hasDebugLogic ? lastMesg : 32'd0 ;
  assign rdat__h25092 = hasDebugLogic ? { 16'd0, x__h25096 } : 32'd0 ;
  assign rdat__h25192 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h25206 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h25214 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h25220 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h25234 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h25242 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h25248 = hasDebugLogic ? wmwtBeginCount : 32'd0 ;
  assign rdat__h25254 = hasDebugLogic ? wmwtPushCount : 32'd0 ;
  assign rdat__h25260 = hasDebugLogic ? wmwtFinalCount : 32'd0 ;
  assign rdat__h25266 = hasDebugLogic ? { 31'd0, x__h25270 } : 32'd0 ;
  assign rdat__h25276 = hasDebugLogic ? 32'hFEEDC0DE : 32'd0 ;
  ...
  assign value__h6580 =
	     MUX_wmi_mFlagF_x_wire$wset_1__SEL_1 ?
	       ...
	       MUX_wmi_mFlagF_x_wire$wset_1__VAL_2 ;
  assign wmi_respF_i_notEmpty__37_AND_smaCtrl_65_BIT_4__ETC___d542 =
	     wmi_respF$EMPTY_N &&
  ...
  assign x__h18022 = { 5'd0, wmi_sFlagReg[23:5] } ;
  assign x__h18446 = fabWordsRemain == fabWordsCurReq ;
  assign x__h22523 = x__h22535 + y__h22536 ;
  assign x__h22535 = x__h22547 + y__h22548 ;
  assign x__h22547 = x__h22559 + y__h22560 ;
  assign x__h22559 = x__h22571 + y__h22572 ;
  assign x__h22571 = x__h22583 + y__h22584 ;
  assign x__h22583 = x__h22595 + y__h22596 ;
  assign x__h22595 = x__h22607 + y__h22608 ;
  assign x__h22607 = x__h22619 + y__h22620 ;
  assign x__h22619 = x__h22631 + y__h22632 ;
  assign x__h22631 = x__h22643 + y__h22644 ;
  assign x__h22643 = x__h22655 + y__h22656 ;
  assign x__h22655 = x__h22667 + y__h22668 ;
  assign x__h22667 = x__h22679 + y__h22680 ;
  assign x__h22679 = x__h22691 + y__h22692 ;
  assign x__h22691 = x__h22703 + y__h22704 ;
  assign x__h22703 = x__h22715 + y__h22716 ;
  assign x__h22715 = x__h22727 + y__h22728 ;
  assign x__h22727 = x__h22739 + y__h22740 ;
  assign x__h22739 = x__h22751 + y__h22752 ;
  assign x__h22751 = x__h22763 + y__h22764 ;
  assign x__h22763 = x__h22775 + y__h22776 ;
  assign x__h22775 = x__h22787 + y__h22788 ;
  assign x__h22787 = x__h22799 + y__h22800 ;
  assign x__h22799 = x__h22811 + y__h22812 ;
  assign x__h22811 = x__h22823 + y__h22824 ;
  assign x__h22823 = x__h22835 + y__h22836 ;
  assign x__h22835 = x__h22847 + y__h22848 ;
  assign x__h22847 = x__h22859 + y__h22860 ;
  assign x__h22859 = x__h22871 + y__h22872 ;
  assign x__h22871 = x__h22883 + y__h22884 ;
  assign x__h22883 = { 5'd0, wsiS_reqFifo$D_OUT[39] } ;
  assign x__h25096 = { wsiS_statusR, wsiM_statusR } ;
  assign x__h25270 = wmi_sThreadBusy_d || wmi_sDataThreadBusy_d ;
  assign x_length__h24032 = { 2'd0, mlB__h22317 } ;
  assign y__h22524 = { 5'd0, wsiS_reqFifo$D_OUT[8] } ;
  assign y__h22536 = { 5'd0, wsiS_reqFifo$D_OUT[9] } ;
  assign y__h22548 = { 5'd0, wsiS_reqFifo$D_OUT[10] } ;
  assign y__h22560 = { 5'd0, wsiS_reqFifo$D_OUT[11] } ;
  assign y__h22572 = { 5'd0, wsiS_reqFifo$D_OUT[12] } ;
  assign y__h22584 = { 5'd0, wsiS_reqFifo$D_OUT[13] } ;
  assign y__h22596 = { 5'd0, wsiS_reqFifo$D_OUT[14] } ;
  assign y__h22608 = { 5'd0, wsiS_reqFifo$D_OUT[15] } ;
  assign y__h22620 = { 5'd0, wsiS_reqFifo$D_OUT[16] } ;
  assign y__h22632 = { 5'd0, wsiS_reqFifo$D_OUT[17] } ;
  assign y__h22644 = { 5'd0, wsiS_reqFifo$D_OUT[18] } ;
  assign y__h22656 = { 5'd0, wsiS_reqFifo$D_OUT[19] } ;
  assign y__h22668 = { 5'd0, wsiS_reqFifo$D_OUT[20] } ;
  assign y__h22680 = { 5'd0, wsiS_reqFifo$D_OUT[21] } ;
  assign y__h22692 = { 5'd0, wsiS_reqFifo$D_OUT[22] } ;
  assign y__h22704 = { 5'd0, wsiS_reqFifo$D_OUT[23] } ;
  assign y__h22716 = { 5'd0, wsiS_reqFifo$D_OUT[24] } ;
  assign y__h22728 = { 5'd0, wsiS_reqFifo$D_OUT[25] } ;
  assign y__h22740 = { 5'd0, wsiS_reqFifo$D_OUT[26] } ;
  assign y__h22752 = { 5'd0, wsiS_reqFifo$D_OUT[27] } ;
  assign y__h22764 = { 5'd0, wsiS_reqFifo$D_OUT[28] } ;
  assign y__h22776 = { 5'd0, wsiS_reqFifo$D_OUT[29] } ;
  assign y__h22788 = { 5'd0, wsiS_reqFifo$D_OUT[30] } ;
  assign y__h22800 = { 5'd0, wsiS_reqFifo$D_OUT[31] } ;
  assign y__h22812 = { 5'd0, wsiS_reqFifo$D_OUT[32] } ;
  assign y__h22824 = { 5'd0, wsiS_reqFifo$D_OUT[33] } ;
  assign y__h22836 = { 5'd0, wsiS_reqFifo$D_OUT[34] } ;
  assign y__h22848 = { 5'd0, wsiS_reqFifo$D_OUT[35] } ;
  assign y__h22860 = { 5'd0, wsiS_reqFifo$D_OUT[36] } ;
  assign y__h22872 = { 5'd0, wsiS_reqFifo$D_OUT[37] } ;
  assign y__h22884 = { 5'd0, wsiS_reqFifo$D_OUT[38] } ;
  always@(wci_wslv_reqF$D_OUT or
	  ...
	  rdat__h25242 or
	  rdat__h25248 or
	  rdat__h25254 or rdat__h25260 or rdat__h25266 or rdat__h25276)
  begin
    case (wci_wslv_reqF$D_OUT[39:32])
      8'h0: g_data__h25001 = smaCtrl;
      8'h04: g_data__h25001 = rdat__h25044;
      8'h08: g_data__h25001 = rdat__h25050;
      8'h10: g_data__h25001 = rdat__h25056;
      8'h14: g_data__h25001 = rdat__h25069;
      8'h18: g_data__h25001 = rdat__h25092;
      8'h20: g_data__h25001 = rdat__h25192;
      8'h24: g_data__h25001 = rdat__h25206;
      8'h28: g_data__h25001 = rdat__h25214;
      8'h2C: g_data__h25001 = rdat__h25220;
      8'h30: g_data__h25001 = rdat__h25234;
      8'h34: g_data__h25001 = rdat__h25242;
      8'h38: g_data__h25001 = rdat__h25248;
      8'h3C: g_data__h25001 = rdat__h25254;
      8'h40: g_data__h25001 = rdat__h25260;
      8'h44: g_data__h25001 = rdat__h25266;
      8'h48: g_data__h25001 = rdat__h25276;
      default: g_data__h25001 = 32'd0;
    endcase
  end
  ...
  begin
    ...
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wmwt_doAbort)
	$display("[%0d]: %m: wmwt_doAbort", v__h24452);
    if (wciS0_MReset_n)
