...
//
// On Sat Jun 25 08:29:29 EDT 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter32B(wciS0_Clk,
  ...
  reg [63 : 0] v__h18213,
	       ...
	       v__h3825,
	       v__h3969;
  reg [31 : 0] g_data__h25023;
  wire [307 : 0] IF_respF_wDataIn_whas__43_THEN_respF_wDataIn_w_ETC___d1054;
  wire [31 : 0] rdat__h25066,
		rdat__h25072,
		rdat__h25078,
		rdat__h25091,
		rdat__h25114,
  ...
  wire [23 : 0] b__h17924,
		...
		residue__h17787,
		x__h18044;
  wire [15 : 0] wsiBurstLength__h18672, x__h25118, x_length__h24054;
  ...
  wire [5 : 0] x__h22545,
	       ...
	       y__h22894,
	       y__h22906;
  wire [2 : 0] IF_respF_wDataIn_whas__43_THEN_respF_wDataIn_w_ETC___d1042;
  wire NOT_wmi_reqF_c_r_57_EQ_2_75_76_AND_wmi_operate_ETC___d534,
       wmi_respF_i_notEmpty__47_AND_smaCtrl_75_BIT_4__ETC___d552,
  ...
  assign MUX_fabRespCredit_value$write_1__VAL_2 =
	     fabRespCredit_value +
	     (CAN_FIRE_RL_wmrd_mesgBodyRequest ? b__h15112 : 12'd0) +
  ...
  assign MUX_thisMesg$write_1__VAL_1 =
	     { mesgCount[7:0], mesgMetaF_opcode__h22505, x_length__h24054 } ;
  ...
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_2 = { 2'd1, g_data__h25023 } ;
  ...
  assign respF_rCache$D_IN =
	     { 1'd1,
	       respF_rWrPtr,
	       IF_respF_wDataIn_whas__43_THEN_respF_wDataIn_w_ETC___d1042,
	       respF_pwEnqueue$whas && respF_wDataIn$wget[309],
	       respF_pwEnqueue$whas && respF_wDataIn$wget[308],
	       IF_respF_wDataIn_whas__43_THEN_respF_wDataIn_w_ETC___d1054 } ;
  ...
  // remaining internal signals
  assign IF_respF_wDataIn_whas__43_THEN_respF_wDataIn_w_ETC___d1042 =
	     respF_pwEnqueue$whas ? respF_wDataIn$wget[312:310] : 3'd0 ;
  assign IF_respF_wDataIn_whas__43_THEN_respF_wDataIn_w_ETC___d1054 =
  ...
  assign mlInc__h22338 =
	     wsiS_reqFifo$D_OUT[309] ?
	       { 8'd0, x__h22545 + y__h22546 } :
	       14'd32 ;
  assign rdat__h25066 = hasDebugLogic ? mesgCount : 32'd0 ;
  assign rdat__h25072 = hasDebugLogic ? abortCount : 32'd0 ;
  assign rdat__h25078 = hasDebugLogic ? thisMesg : 32'd0 ;
  assign rdat__h25091 = hasDebugLogic ? lastMesg : 32'd0 ;
  assign rdat__h25114 = hasDebugLogic ? { 16'd0, x__h25118 } : 32'd0 ;
  assign rdat__h25214 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h25228 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h25236 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h25242 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h25256 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h25264 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h25270 = hasDebugLogic ? wmwtBeginCount : 32'd0 ;
  assign rdat__h25276 = hasDebugLogic ? wmwtPushCount : 32'd0 ;
  assign rdat__h25282 = hasDebugLogic ? wmwtFinalCount : 32'd0 ;
  assign rdat__h25288 = hasDebugLogic ? 32'hFEEDC0DE : 32'd0 ;
  ...
  assign value__h6580 =
	     MUX_wmi_mFlagF_x_wire$wset_1__SEL_1 ?
	       ...
	       MUX_wmi_mFlagF_x_wire$wset_1__VAL_2 ;
  assign wmi_respF_i_notEmpty__47_AND_smaCtrl_75_BIT_4__ETC___d552 =
	     wmi_respF$EMPTY_N &&
  ...
  assign x__h18044 = { 5'd0, wmi_sFlagReg[23:5] } ;
  assign x__h18468 = fabWordsRemain == fabWordsCurReq ;
  assign x__h22545 = x__h22557 + y__h22558 ;
  assign x__h22557 = x__h22569 + y__h22570 ;
  assign x__h22569 = x__h22581 + y__h22582 ;
  assign x__h22581 = x__h22593 + y__h22594 ;
  assign x__h22593 = x__h22605 + y__h22606 ;
  assign x__h22605 = x__h22617 + y__h22618 ;
  assign x__h22617 = x__h22629 + y__h22630 ;
  assign x__h22629 = x__h22641 + y__h22642 ;
  assign x__h22641 = x__h22653 + y__h22654 ;
  assign x__h22653 = x__h22665 + y__h22666 ;
  assign x__h22665 = x__h22677 + y__h22678 ;
  assign x__h22677 = x__h22689 + y__h22690 ;
  assign x__h22689 = x__h22701 + y__h22702 ;
  assign x__h22701 = x__h22713 + y__h22714 ;
  assign x__h22713 = x__h22725 + y__h22726 ;
  assign x__h22725 = x__h22737 + y__h22738 ;
  assign x__h22737 = x__h22749 + y__h22750 ;
  assign x__h22749 = x__h22761 + y__h22762 ;
  assign x__h22761 = x__h22773 + y__h22774 ;
  assign x__h22773 = x__h22785 + y__h22786 ;
  assign x__h22785 = x__h22797 + y__h22798 ;
  assign x__h22797 = x__h22809 + y__h22810 ;
  assign x__h22809 = x__h22821 + y__h22822 ;
  assign x__h22821 = x__h22833 + y__h22834 ;
  assign x__h22833 = x__h22845 + y__h22846 ;
  assign x__h22845 = x__h22857 + y__h22858 ;
  assign x__h22857 = x__h22869 + y__h22870 ;
  assign x__h22869 = x__h22881 + y__h22882 ;
  assign x__h22881 = x__h22893 + y__h22894 ;
  assign x__h22893 = x__h22905 + y__h22906 ;
  assign x__h22905 = { 5'd0, wsiS_reqFifo$D_OUT[39] } ;
  assign x__h25118 = { wsiS_statusR, wsiM_statusR } ;
  assign x_length__h24054 = { 2'd0, mlB__h22339 } ;
  assign y__h22546 = { 5'd0, wsiS_reqFifo$D_OUT[8] } ;
  assign y__h22558 = { 5'd0, wsiS_reqFifo$D_OUT[9] } ;
  assign y__h22570 = { 5'd0, wsiS_reqFifo$D_OUT[10] } ;
  assign y__h22582 = { 5'd0, wsiS_reqFifo$D_OUT[11] } ;
  assign y__h22594 = { 5'd0, wsiS_reqFifo$D_OUT[12] } ;
  assign y__h22606 = { 5'd0, wsiS_reqFifo$D_OUT[13] } ;
  assign y__h22618 = { 5'd0, wsiS_reqFifo$D_OUT[14] } ;
  assign y__h22630 = { 5'd0, wsiS_reqFifo$D_OUT[15] } ;
  assign y__h22642 = { 5'd0, wsiS_reqFifo$D_OUT[16] } ;
  assign y__h22654 = { 5'd0, wsiS_reqFifo$D_OUT[17] } ;
  assign y__h22666 = { 5'd0, wsiS_reqFifo$D_OUT[18] } ;
  assign y__h22678 = { 5'd0, wsiS_reqFifo$D_OUT[19] } ;
  assign y__h22690 = { 5'd0, wsiS_reqFifo$D_OUT[20] } ;
  assign y__h22702 = { 5'd0, wsiS_reqFifo$D_OUT[21] } ;
  assign y__h22714 = { 5'd0, wsiS_reqFifo$D_OUT[22] } ;
  assign y__h22726 = { 5'd0, wsiS_reqFifo$D_OUT[23] } ;
  assign y__h22738 = { 5'd0, wsiS_reqFifo$D_OUT[24] } ;
  assign y__h22750 = { 5'd0, wsiS_reqFifo$D_OUT[25] } ;
  assign y__h22762 = { 5'd0, wsiS_reqFifo$D_OUT[26] } ;
  assign y__h22774 = { 5'd0, wsiS_reqFifo$D_OUT[27] } ;
  assign y__h22786 = { 5'd0, wsiS_reqFifo$D_OUT[28] } ;
  assign y__h22798 = { 5'd0, wsiS_reqFifo$D_OUT[29] } ;
  assign y__h22810 = { 5'd0, wsiS_reqFifo$D_OUT[30] } ;
  assign y__h22822 = { 5'd0, wsiS_reqFifo$D_OUT[31] } ;
  assign y__h22834 = { 5'd0, wsiS_reqFifo$D_OUT[32] } ;
  assign y__h22846 = { 5'd0, wsiS_reqFifo$D_OUT[33] } ;
  assign y__h22858 = { 5'd0, wsiS_reqFifo$D_OUT[34] } ;
  assign y__h22870 = { 5'd0, wsiS_reqFifo$D_OUT[35] } ;
  assign y__h22882 = { 5'd0, wsiS_reqFifo$D_OUT[36] } ;
  assign y__h22894 = { 5'd0, wsiS_reqFifo$D_OUT[37] } ;
  assign y__h22906 = { 5'd0, wsiS_reqFifo$D_OUT[38] } ;
  always@(wci_wslv_reqF$D_OUT or
	  ...
	  rdat__h25256 or
	  rdat__h25264 or
	  rdat__h25270 or rdat__h25276 or rdat__h25282 or rdat__h25288)
  begin
    case (wci_wslv_reqF$D_OUT[39:32])
      8'h0: g_data__h25023 = smaCtrl;
      8'h04: g_data__h25023 = rdat__h25066;
      8'h08: g_data__h25023 = rdat__h25072;
      8'h10: g_data__h25023 = rdat__h25078;
      8'h14: g_data__h25023 = rdat__h25091;
      8'h18: g_data__h25023 = rdat__h25114;
      8'h20: g_data__h25023 = rdat__h25214;
      8'h24: g_data__h25023 = rdat__h25228;
      8'h28: g_data__h25023 = rdat__h25236;
      8'h2C: g_data__h25023 = rdat__h25242;
      8'h30: g_data__h25023 = rdat__h25256;
      8'h34: g_data__h25023 = rdat__h25264;
      8'h38: g_data__h25023 = rdat__h25270;
      8'h3C: g_data__h25023 = rdat__h25276;
      8'h40: g_data__h25023 = rdat__h25282;
      8'h44: g_data__h25023 = rdat__h25288;
      default: g_data__h25023 = 32'd0;
    endcase
  end
  ...
  begin
    ...
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wmwt_doAbort)
	$display("[%0d]: %m: wmwt_doAbort", v__h24474);
    if (wciS0_MReset_n)
