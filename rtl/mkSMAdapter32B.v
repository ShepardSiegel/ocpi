...
//
// On Sat Mar 31 15:13:24 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter32B(wciS0_Clk,
  ...
  wire MUX_endOfMessage$write_1__SEL_1,
       ...
       MUX_mesgLengthSoFar$write_1__SEL_2,
  ...
  wire [307 : 0] IF_respF_wDataIn_whas__33_THEN_respF_wDataIn_w_ETC___d960;
  ...
  wire [5 : 0] x__h22523,
	       ...
	       y__h22872,
	       y__h22884;
  wire [2 : 0] IF_respF_wDataIn_whas__33_THEN_respF_wDataIn_w_ETC___d963;
  ...
  assign MUX_mesgLengthSoFar$write_1__SEL_2 =
	     CAN_FIRE_RL_wmwt_mesgBegin &&
	     !MUX_wsiS_reqFifo_levelsValid$write_1__SEL_3 ;
  ...
  assign respF_rCache$D_IN =
	     { 1'd1,
	       respF_rWrPtr,
	       IF_respF_wDataIn_whas__33_THEN_respF_wDataIn_w_ETC___d963,
	       respF_pwEnqueue$whas && respF_wDataIn$wget[309],
	       respF_pwEnqueue$whas && respF_wDataIn$wget[308],
	       IF_respF_wDataIn_whas__33_THEN_respF_wDataIn_w_ETC___d960 } ;
  ...
  assign wmwtBeginCount$EN = MUX_mesgLengthSoFar$write_1__SEL_2 ;
  ...
  // submodule mesgTokenF
  assign mesgTokenF$ENQ = MUX_mesgLengthSoFar$write_1__SEL_2 ;
  ...
  // remaining internal signals
  assign IF_respF_wDataIn_whas__33_THEN_respF_wDataIn_w_ETC___d960 =
	     respF_pwEnqueue$whas ? respF_wDataIn$wget[307:0] : 308'd0 ;
  assign IF_respF_wDataIn_whas__33_THEN_respF_wDataIn_w_ETC___d963 =
  ...
  begin
	...
	$display("[%0d]: %m: wmrd_mesgBegin mesgCount:%0h mesgLength:%0h reqInfo:%0h",
		 ...
		 wmi_sFlagReg[31:24]);
    if (wciS0_MReset_n)
      if (MUX_mesgLengthSoFar$write_1__SEL_2 && wsiS_reqFifo$D_OUT[308])
	begin
	  v__h21903 = $time;
	  #0;
	end
