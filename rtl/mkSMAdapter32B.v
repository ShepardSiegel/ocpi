...
//
// On Thu Jun 10 12:52:38 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter32B(wciS0_Clk,
  ...
  wire [31 : 0] rdat__h15540, x_byteEn__h18563;
  wire [23 : 0] mesgMetaF_length__h16810, mesgMetaF_length__h17724;
  wire [15 : 0] wsiBurstLength__h18456, x__h15543, x_length__h17087;
  ...
  assign MUX_wmi_dhF_x_wire$wset_1__VAL_2 =
	     { 1'd1, x__h16715, wsiS_reqFifo$D_OUT[295:40], 32'hFFFFFFFF } ;
  ...
  assign bl__h17580 =
	     zeroLengthMesg ?
	       12'd1 :
	       { 3'd0,
		 IF_mesgLength_22_BIT_14_23_THEN_mesgLength_22__ETC___d755[13:5] } ;
  ...
  assign x_byteEn__h18563 = (thisMesg[15:0] == 16'd0) ? 32'd0 : 32'hFFFFFFFF ;
