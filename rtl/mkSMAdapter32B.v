...
//
// On Tue Jun 21 16:40:04 EDT 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter32B(wciS0_Clk,
  ...
  wire [307 : 0] IF_respF_wDataIn_whas__45_THEN_respF_wDataIn_w_ETC___d919;
  ...
  wire [11 : 0] b__h15203,
		...
		x__h16557;
  wire [7 : 0] x__h22769;
  wire [2 : 0] IF_respF_wDataIn_whas__45_THEN_respF_wDataIn_w_ETC___d922;
  wire NOT_wmi_reqF_c_r_57_EQ_2_76_77_AND_wmi_operate_ETC___d529,
       wci_wslv_cState_6_EQ_2_7_AND_smaCtrl_77_BITS_3_ETC___d771,
       wmi_operateD_44_AND_wmi_peerIsReady_45_46_AND__ETC___d698,
       wmi_respF_i_notEmpty__42_AND_smaCtrl_77_BIT_4__ETC___d547,
       wsiS_reqFifo_i_notEmpty__76_AND_NOT_smaCtrl_77_ETC___d717,
  ...
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_3 =
	     { 4'd3, wsiS_reqFifo$D_OUT[309], 1'b0, addr__h23641, 12'd1 } ;
  ...
  assign respF_rCache$D_IN =
	     { 1'd1,
	       respF_rWrPtr,
	       IF_respF_wDataIn_whas__45_THEN_respF_wDataIn_w_ETC___d922,
  ...
  always@(WILL_FIRE_RL_wmi_dhF_both or
	  ...
	  MUX_wmi_dhF_q_0$write_1__VAL_1 or WILL_FIRE_RL_wmi_dhF_decCtr)
  begin
    case (1'b1) // synopsys parallel_case
      WILL_FIRE_RL_wmi_dhF_both:
  ...
  assign IF_respF_wDataIn_whas__45_THEN_respF_wDataIn_w_ETC___d922 =
  ...
  assign addr__h23641 = { mesgLengthSoFar[8:0], 5'd0 } ;
  assign b__h15203 = -fabWordsCurReq[11:0] ;
  assign b__h18592 = { {2{fabRespCredit_value[11]}}, fabRespCredit_value } ;
  assign bl__h22872 = zeroLengthMesg ? 12'd1 : { 3'd0, x__h22783[13:5] } ;
  ...
  assign mesgMetaF_length__h23771 =
	     (wsiS_reqFifo$D_OUT[309] && wsiS_reqFifo$D_OUT[39:8] == 32'd0 &&
	      mesgLengthSoFar == 14'd0) ?
	       24'd0 :
	       { 10'd0, mlp1B__h23601 } ;
  assign mlp1B__h23601 = { mlp1__h23600[8:0], 5'd0 } ;
													   ...
													   6'd29) ?
														...
														thisMesg[4:0] } <=
														 ...
														 6'd31) ?
														  ...
														  32'hFFFFFFFF)))))))))))))))))))))))))))))))) :
		  32'hFFFFFFFF) ;
  assign wci_wslv_cState_6_EQ_2_7_AND_smaCtrl_77_BITS_3_ETC___d771 =
	     wci_wslv_cState == 3'd2 &&
	     (smaCtrl[3:0] == 4'h2 || smaCtrl[3:0] == 4'h3) &&
	     mesgLength[14] &&
	     !doAbort &&
  ...
  assign wmi_operateD_44_AND_wmi_peerIsReady_45_46_AND__ETC___d698 =
  ...
  assign wsiS_reqFifo_i_notEmpty__76_AND_NOT_smaCtrl_77_ETC___d717 =
	     wsiS_reqFifo$EMPTY_N &&
	     (smaCtrl[3:0] != 4'h3 || wsiM_reqFifo_c_r != 2'd2) &&
