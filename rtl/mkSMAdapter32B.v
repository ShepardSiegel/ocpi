...
//
// On Sun Jul 11 06:47:26 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter32B(wciS0_Clk,
  ...
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_3 =
	     { 4'd3, wsiS_reqFifo$D_OUT[309], 1'b0, addr__h17221, 12'd1 } ;
  ...
  assign addr__h17221 = { mesgLengthSoFar[8:0], 5'd0 } ;
  ...
  assign mlp1B__h17205 = { mlp1__h17204[8:0], 5'd0 } ;
  ...
  assign x_byteEn__h19244 = (thisMesg[15:0] == 16'd0) ? 32'd0 : 32'hFFFFFFFF ;
