...
//
// On Wed Jan 11 15:59:57 EST 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkWSICaptureWorker8B(wciS0_Clk,
  ...
  wire [63 : 0] nowW$wget, wsi_Es_mData_w$wget, wti_Es_mData_w$wget;
  ...
  reg [63 : 0] v__h28496,
	       ...
	       v__h3815,
	       v__h3959;
  reg [31 : 0] IF_splaF_first__028_BITS_1_TO_0_030_EQ_0_031_T_ETC___d1089,
	       v__h30110;
  reg CASE_splaFD_OUT_BITS_1_TO_0_NOT_splaFD_OUT_B_ETC__q1,
      IF_splaF_first__028_BITS_1_TO_0_030_EQ_0_031_T_ETC___d1053,
      IF_wci_wslv_reqF_first__5_BITS_35_TO_34_111_EQ_ETC___d1124;
  wire [31 : 0] g_data__h31142,
		rdat___1__h30232,
		rdat___1__h30287,
		rdat___1__h30301,
		rdat___1__h30309,
		...
		y_avValue__h29472,
		y_avValue__h29512;
  wire [13 : 0] mlB__h25950, mlInc__h25949;
  wire [3 : 0] x__h25998,
	       x__h26010,
	       x__h26022,
	       x__h26034,
  ...
  wire [2 : 0] dataBram_serverAdapterB_cnt_21_PLUS_IF_dataBra_ETC___d327,
	       metaBram_serverAdapterB_1_cnt_75_PLUS_IF_metaB_ETC___d681,
	       metaBram_serverAdapterB_2_cnt_93_PLUS_IF_metaB_ETC___d799,
	       metaBram_serverAdapterB_3_cnt_11_PLUS_IF_metaB_ETC___d917,
	       metaBram_serverAdapterB_cnt_57_PLUS_IF_metaBra_ETC___d563;
  wire IF_splaF_first__028_BITS_1_TO_0_030_EQ_0_031_T_ETC___d1037,
       IF_splaF_first__028_BITS_1_TO_0_030_EQ_0_031_T_ETC___d1042,
       IF_splaF_first__028_BITS_1_TO_0_030_EQ_0_031_T_ETC___d1062,
       IF_wci_wslv_reqF_first__5_BITS_63_TO_52_103_EQ_ETC___d1127,
       controlReg_48_BIT_0_49_AND_NOT_controlReg_48_B_ETC___d1010,
       dataBram_serverAdapterA_cnt_62_SLT_3_61_AND_da_ETC___d975,
       dataCount_55_ULT_1024___d956,
       mesgCount_52_ULT_1024___d953,
       splaF_i_notEmpty__027_AND_IF_splaF_first__028__ETC___d1064;
  ...
  assign WILL_FIRE_RL_doMessageAccept =
	     wsiS_reqFifo$EMPTY_N &&
	     (!controlReg[0] ||
	      controlReg[1] && !mesgCount_52_ULT_1024___d953 &&
	      !dataCount_55_ULT_1024___d956 ||
	      dataBram_serverAdapterA_cnt_62_SLT_3_61_AND_da_ETC___d975) &&
	     wci_wslv_cState == 3'd2 ;
  ...
  assign MUX_wci_wslv_respF_q_1$write_1__VAL_1 =
	     (wci_wslv_respF_c_r == 2'd2) ?
	       MUX_wci_wslv_respF_q_0$write_1__VAL_2 :
	       34'h0AAAAAAAA ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_1 = { 2'd1, g_data__h31142 } ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_2 =
	     wci_wslv_illegalEdge ? 34'h3C0DE4202 : 34'h1C0DE4201 ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_3 = { 2'd1, v__h28585 } ;
  ...
  assign dataBram_serverAdapterB_1_outData_enqData$whas =
	     ...
	     dataBram_serverAdapterB_1_s1[0] ;
  assign dataBram_serverAdapterB_1_outData_outData$wget = y_avValue__h29347 ;
  ...
  // register mesgLengthSoFar
  assign mesgLengthSoFar$D_IN = wsiS_reqFifo$D_OUT[93] ? 14'd0 : mlB__h25950 ;
  ...
  assign metaBram_memory$DIA = { 18'd0, mlB__h25950 } ;
  ...
  // remaining internal signals
  assign IF_splaF_first__028_BITS_1_TO_0_030_EQ_0_031_T_ETC___d1037 =
	     (splaF$D_OUT[1:0] == 2'd0) ?
	       dataBram_serverAdapterB_outDataCore$EMPTY_N ||
	       dataBram_serverAdapterB_outData_enqData$whas :
	       splaF$D_OUT[1:0] != 2'd1 ||
	       dataBram_serverAdapterB_1_outDataCore$EMPTY_N ||
	       dataBram_serverAdapterB_1_outData_enqData$whas ;
  assign IF_splaF_first__028_BITS_1_TO_0_030_EQ_0_031_T_ETC___d1042 =
	     IF_splaF_first__028_BITS_1_TO_0_030_EQ_0_031_T_ETC___d1037 &&
	     ((splaF$D_OUT[1:0] == 2'd0) ?
		dataBram_serverAdapterB_outData_outData$whas :
		splaF$D_OUT[1:0] != 2'd1 ||
		dataBram_serverAdapterB_1_outData_outData$whas) ;
  assign IF_splaF_first__028_BITS_1_TO_0_030_EQ_0_031_T_ETC___d1062 =
	     IF_splaF_first__028_BITS_1_TO_0_030_EQ_0_031_T_ETC___d1053 &&
	     CASE_splaFD_OUT_BITS_1_TO_0_NOT_splaFD_OUT_B_ETC__q1 ;
  assign IF_wci_wslv_reqF_first__5_BITS_63_TO_52_103_EQ_ETC___d1127 =
	     (wci_wslv_reqF$D_OUT[63:52] == 12'h001) ?
	       (dataBram_serverAdapterB_cnt ^ 3'h4) < 3'd7 && splaF$FULL_N :
	       wci_wslv_reqF$D_OUT[63:52] != 12'h002 ||
	       splaF$FULL_N &&
	       IF_wci_wslv_reqF_first__5_BITS_35_TO_34_111_EQ_ETC___d1124 ;
  assign controlReg_48_BIT_0_49_AND_NOT_controlReg_48_B_ETC___d1010 =
	     controlReg[0] &&
	     (!controlReg[1] || mesgCount_52_ULT_1024___d953 ||
	      dataCount_55_ULT_1024___d956) ;
  assign dataBram_serverAdapterA_cnt_62_SLT_3_61_AND_da_ETC___d975 =
  ...
  assign dataCount_55_ULT_1024___d956 = dataCount < 32'd1024 ;
  assign g_data__h31142 =
	     (wci_wslv_reqF$D_OUT[63:52] == 12'h0) ? v__h30110 : 32'd0 ;
  assign mesgCount_52_ULT_1024___d953 = mesgCount < 32'd1024 ;
  assign metaBram_serverAdapterB_1_cnt_75_PLUS_IF_metaB_ETC___d681 =
		...
		3'd7 :
		3'd0) ;
  assign metaBram_serverAdapterB_2_cnt_93_PLUS_IF_metaB_ETC___d799 =
		...
		3'd7 :
		3'd0) ;
  assign metaBram_serverAdapterB_3_cnt_11_PLUS_IF_metaB_ETC___d917 =
	     metaBram_serverAdapterB_3_cnt +
	     (WILL_FIRE_RL_metaBram_serverAdapterB_3_stageReadResponseAlways ?
		3'd1 :
		3'd0) +
	     (metaBram_serverAdapterB_3_cnt_2$whas ? 3'd7 : 3'd0) ;
  assign metaBram_serverAdapterB_cnt_57_PLUS_IF_metaBra_ETC___d563 =
	     metaBram_serverAdapterB_cnt +
	     (WILL_FIRE_RL_metaBram_serverAdapterB_stageReadResponseAlways ?
		3'd1 :
		3'd0) +
	     (metaBram_serverAdapterB_outData_deqCalled$whas ? 3'd7 : 3'd0) ;
  assign mlB__h25950 = mesgLengthSoFar + mlInc__h25949 ;
  assign mlInc__h25949 =
	     wsiS_reqFifo$D_OUT[93] ?
	       { 10'd0, x__h25998 + y__h25999 } :
	       14'd8 ;
  assign rdat___1__h30232 = hasDebugLogic ? { 24'd0, wsiS_statusR } : 32'd0 ;
  assign rdat___1__h30287 =
	     hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat___1__h30301 =
	     hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat___1__h30309 =
	     hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign splaF_i_notEmpty__027_AND_IF_splaF_first__028__ETC___d1064 =
	     splaF$EMPTY_N &&
	     (splaF$D_OUT[2] ?
		IF_splaF_first__028_BITS_1_TO_0_030_EQ_0_031_T_ETC___d1042 :
		IF_splaF_first__028_BITS_1_TO_0_030_EQ_0_031_T_ETC___d1062) ;
  assign v__h28585 =
	     splaF$D_OUT[2] ?
		  ...
		  y_avValue__h29307 :
		  y_avValue__h29347) :
	       IF_splaF_first__028_BITS_1_TO_0_030_EQ_0_031_T_ETC___d1089 ;
  assign x__h25998 = x__h26010 + y__h26011 ;
  assign x__h26010 = x__h26022 + y__h26023 ;
  assign x__h26022 = x__h26034 + y__h26035 ;
  assign x__h26034 = x__h26046 + y__h26047 ;
  assign x__h26046 = x__h26058 + y__h26059 ;
  assign x__h26058 = x__h26070 + y__h26071 ;
  assign x__h26070 = { 3'd0, wsiS_reqFifo$D_OUT[15] } ;
  assign y__h25999 = { 3'd0, wsiS_reqFifo$D_OUT[8] } ;
  assign y__h26011 = { 3'd0, wsiS_reqFifo$D_OUT[9] } ;
  assign y__h26023 = { 3'd0, wsiS_reqFifo$D_OUT[10] } ;
  assign y__h26035 = { 3'd0, wsiS_reqFifo$D_OUT[11] } ;
  assign y__h26047 = { 3'd0, wsiS_reqFifo$D_OUT[12] } ;
  assign y__h26059 = { 3'd0, wsiS_reqFifo$D_OUT[13] } ;
  assign y__h26071 = { 3'd0, wsiS_reqFifo$D_OUT[14] } ;
  assign y_avValue__h29307 = dataBram_serverAdapterB_outData_outData$wget ;
  assign y_avValue__h29347 =
	     dataBram_serverAdapterB_1_outDataCore$EMPTY_N ?
	       dataBram_serverAdapterB_1_outDataCore$D_OUT :
	       dataBram_memory_1$DOB ;
  assign y_avValue__h29392 = metaBram_serverAdapterB_outData_outData$wget ;
  assign y_avValue__h29432 = metaBram_serverAdapterB_1_outData_outData$wget ;
  assign y_avValue__h29472 = metaBram_serverAdapterB_2_outData_outData$wget ;
  assign y_avValue__h29512 = metaBram_serverAdapterB_3_outData_outData$wget ;
  always@(wci_wslv_reqF$D_OUT or
	  controlReg or
	  mesgCount or
	  dataCount or
	  rdat___1__h30232 or
	  rdat___1__h30287 or rdat___1__h30301 or rdat___1__h30309)
  begin
    case (wci_wslv_reqF$D_OUT[39:32])
      8'h0: v__h30110 = controlReg;
      8'h04: v__h30110 = mesgCount;
      8'h08: v__h30110 = dataCount;
      8'h10: v__h30110 = 32'd2361866;
      8'h1C: v__h30110 = 32'hFEEDC0DE;
      8'h20: v__h30110 = rdat___1__h30232;
      8'h24: v__h30110 = rdat___1__h30287;
      8'h28: v__h30110 = rdat___1__h30301;
      8'h2C: v__h30110 = rdat___1__h30309;
      default: v__h30110 = 32'd0;
    endcase
  end
  ...
  always@(splaF$D_OUT or
	  y_avValue__h29512 or
	  y_avValue__h29392 or y_avValue__h29432 or y_avValue__h29472)
  begin
    case (splaF$D_OUT[1:0])
      2'd0:
	  IF_splaF_first__028_BITS_1_TO_0_030_EQ_0_031_T_ETC___d1089 =
  ...
  begin
    ...
    if (wciS0_MReset_n)
      if (MUX_wci_wslv_respF_x_wire$wset_1__SEL_3)
	$display("[%0d]: %m: WCI SPLIT READ Data:%0x", v__h29643, v__h28585);
    if (wciS0_MReset_n)
