...
//
// On Sun Mar  4 13:38:41 EST 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkWSICaptureWorker8B(wciS0_Clk,
  ...
  reg [63 : 0] v__h28556,
	       ...
	       v__h3814,
	       v__h3958;
  reg [31 : 0] IF_splaF_first__030_BITS_1_TO_0_032_EQ_0_033_T_ETC___d1091,
	       v__h30205;
  reg CASE_splaFD_OUT_BITS_1_TO_0_NOT_splaFD_OUT_B_ETC__q1,
      IF_splaF_first__030_BITS_1_TO_0_032_EQ_0_033_T_ETC___d1055,
      IF_wci_wslv_reqF_first__5_BITS_35_TO_34_120_EQ_ETC___d1133,
      IF_wci_wslv_reqF_first__5_BITS_63_TO_52_105_EQ_ETC___d1137;
  wire [31 : 0] g_data__h31285,
		rdat___1__h30302,
		rdat___1__h30376,
		rdat___1__h30431,
		rdat___1__h30445,
		...
		y_avValue__h29567,
		y_avValue__h29607;
  wire [13 : 0] mlB__h26021, mlInc__h26020;
  wire [3 : 0] x__h26069,
	       x__h26081,
	       x__h26093,
	       x__h26105,
  ...
  wire IF_splaF_first__030_BITS_1_TO_0_032_EQ_0_033_T_ETC___d1039,
       IF_splaF_first__030_BITS_1_TO_0_032_EQ_0_033_T_ETC___d1044,
       IF_splaF_first__030_BITS_1_TO_0_032_EQ_0_033_T_ETC___d1064,
       controlReg_48_BIT_0_49_AND_NOT_controlReg_48_B_ETC___d1010,
       dataBram_serverAdapterA_cnt_62_SLT_3_61_AND_da_ETC___d975,
       dataCount_55_ULT_1024___d1363,
       metaCount_52_ULT_1024___d1362,
       splaF_i_notEmpty__029_AND_IF_splaF_first__030__ETC___d1066;
  ...
  assign MUX_wci_wslv_respF_q_1$write_1__VAL_1 =
	     (wci_wslv_respF_c_r == 2'd2) ?
	       MUX_wci_wslv_respF_q_0$write_1__VAL_2 :
	       34'h0AAAAAAAA ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_1 = { 2'd1, g_data__h31285 } ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_2 =
	     wci_wslv_illegalEdge ? 34'h3C0DE4202 : 34'h1C0DE4201 ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_3 = { 2'd1, v__h28680 } ;
  ...
  assign dataBram_serverAdapterB_1_outData_enqData$whas =
	     ...
	     dataBram_serverAdapterB_1_s1[0] ;
  assign dataBram_serverAdapterB_1_outData_outData$wget = y_avValue__h29442 ;
  ...
  // register mesgLengthSoFar
  assign mesgLengthSoFar$D_IN = wsiS_reqFifo$D_OUT[93] ? 14'd0 : mlB__h26021 ;
  ...
  assign metaBram_memory$DIA = { 18'd0, mlB__h26021 } ;
  ...
  // remaining internal signals
  assign IF_splaF_first__030_BITS_1_TO_0_032_EQ_0_033_T_ETC___d1039 =
	     (splaF$D_OUT[1:0] == 2'd0) ?
	       dataBram_serverAdapterB_outDataCore$EMPTY_N ||
	       dataBram_serverAdapterB_outData_enqData$whas :
	       splaF$D_OUT[1:0] != 2'd1 ||
	       dataBram_serverAdapterB_1_outDataCore$EMPTY_N ||
	       dataBram_serverAdapterB_1_outData_enqData$whas ;
  assign IF_splaF_first__030_BITS_1_TO_0_032_EQ_0_033_T_ETC___d1044 =
	     IF_splaF_first__030_BITS_1_TO_0_032_EQ_0_033_T_ETC___d1039 &&
	     ((splaF$D_OUT[1:0] == 2'd0) ?
		dataBram_serverAdapterB_outData_outData$whas :
		splaF$D_OUT[1:0] != 2'd1 ||
		dataBram_serverAdapterB_1_outData_outData$whas) ;
  assign IF_splaF_first__030_BITS_1_TO_0_032_EQ_0_033_T_ETC___d1064 =
	     IF_splaF_first__030_BITS_1_TO_0_032_EQ_0_033_T_ETC___d1055 &&
  ...
  assign dataCount_55_ULT_1024___d1363 = dataCount < 32'd1024 ;
  assign g_data__h31285 =
	     (wci_wslv_reqF$D_OUT[63:52] == 12'h0) ? v__h30205 : 32'd0 ;
  ...
  assign metaCount_52_ULT_1024___d1362 = metaCount < 32'd1024 ;
  assign mlB__h26021 = mesgLengthSoFar + mlInc__h26020 ;
  assign mlInc__h26020 =
	     wsiS_reqFifo$D_OUT[93] ?
	       { 10'd0, x__h26069 + y__h26070 } :
	       14'd8 ;
  assign rdat___1__h30302 = statusReg_w$wget ;
  assign rdat___1__h30376 = hasDebugLogic ? { 24'd0, wsiS_statusR } : 32'd0 ;
  assign rdat___1__h30431 =
	     hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat___1__h30445 =
	     hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat___1__h30453 =
	     hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign splaF_i_notEmpty__029_AND_IF_splaF_first__030__ETC___d1066 =
	     splaF$EMPTY_N &&
	     (splaF$D_OUT[2] ?
		IF_splaF_first__030_BITS_1_TO_0_032_EQ_0_033_T_ETC___d1044 :
		IF_splaF_first__030_BITS_1_TO_0_032_EQ_0_033_T_ETC___d1064) ;
  assign v__h28680 =
	     splaF$D_OUT[2] ?
		  ...
		  y_avValue__h29402 :
		  y_avValue__h29442) :
	       IF_splaF_first__030_BITS_1_TO_0_032_EQ_0_033_T_ETC___d1091 ;
  assign x__h26069 = x__h26081 + y__h26082 ;
  assign x__h26081 = x__h26093 + y__h26094 ;
  assign x__h26093 = x__h26105 + y__h26106 ;
  assign x__h26105 = x__h26117 + y__h26118 ;
  assign x__h26117 = x__h26129 + y__h26130 ;
  assign x__h26129 = x__h26141 + y__h26142 ;
  assign x__h26141 = { 3'd0, wsiS_reqFifo$D_OUT[15] } ;
  assign y__h26070 = { 3'd0, wsiS_reqFifo$D_OUT[8] } ;
  assign y__h26082 = { 3'd0, wsiS_reqFifo$D_OUT[9] } ;
  assign y__h26094 = { 3'd0, wsiS_reqFifo$D_OUT[10] } ;
  assign y__h26106 = { 3'd0, wsiS_reqFifo$D_OUT[11] } ;
  assign y__h26118 = { 3'd0, wsiS_reqFifo$D_OUT[12] } ;
  assign y__h26130 = { 3'd0, wsiS_reqFifo$D_OUT[13] } ;
  assign y__h26142 = { 3'd0, wsiS_reqFifo$D_OUT[14] } ;
  assign y_avValue__h29402 = dataBram_serverAdapterB_outData_outData$wget ;
  assign y_avValue__h29442 =
	     dataBram_serverAdapterB_1_outDataCore$EMPTY_N ?
	       dataBram_serverAdapterB_1_outDataCore$D_OUT :
	       dataBram_memory_1$DOB ;
  assign y_avValue__h29487 = metaBram_serverAdapterB_outData_outData$wget ;
  assign y_avValue__h29527 = metaBram_serverAdapterB_1_outData_outData$wget ;
  assign y_avValue__h29567 = metaBram_serverAdapterB_2_outData_outData$wget ;
  assign y_avValue__h29607 = metaBram_serverAdapterB_3_outData_outData$wget ;
  ...
  always@(wci_wslv_reqF$D_OUT or
	  splaF$FULL_N or
	  IF_wci_wslv_reqF_first__5_BITS_35_TO_34_120_EQ_ETC___d1133 or
	  dataBram_serverAdapterB_cnt)
  begin
    case (wci_wslv_reqF$D_OUT[63:52])
      12'h0:
	  IF_wci_wslv_reqF_first__5_BITS_63_TO_52_105_EQ_ETC___d1137 = 1'b1;
      12'h800:
	  IF_wci_wslv_reqF_first__5_BITS_63_TO_52_105_EQ_ETC___d1137 =
	      (dataBram_serverAdapterB_cnt ^ 3'h4) < 3'd7 && splaF$FULL_N;
      default: IF_wci_wslv_reqF_first__5_BITS_63_TO_52_105_EQ_ETC___d1137 =
		   wci_wslv_reqF$D_OUT[63:52] != 12'h400 ||
		   splaF$FULL_N &&
		   IF_wci_wslv_reqF_first__5_BITS_35_TO_34_120_EQ_ETC___d1133;
    endcase
  ...
  always@(splaF$D_OUT or
	  y_avValue__h29607 or
	  y_avValue__h29487 or y_avValue__h29527 or y_avValue__h29567)
  begin
    case (splaF$D_OUT[1:0])
      2'd0:
	  IF_splaF_first__030_BITS_1_TO_0_032_EQ_0_033_T_ETC___d1091 =
  ...
  always@(wci_wslv_reqF$D_OUT or
	  ...
	  rdat___1__h30302 or
	  rdat___1__h30376 or
	  rdat___1__h30431 or rdat___1__h30445 or rdat___1__h30453)
  begin
    case (wci_wslv_reqF$D_OUT[39:32])
      8'h0: v__h30205 = controlReg;
      8'h04: v__h30205 = metaCount;
      8'h08: v__h30205 = dataCount;
      8'h0C: v__h30205 = rdat___1__h30302;
      8'h10: v__h30205 = rdat___1__h30376;
      8'h14: v__h30205 = rdat___1__h30431;
      8'h18: v__h30205 = rdat___1__h30445;
      8'h1C: v__h30205 = rdat___1__h30453;
      default: v__h30205 = 32'd0;
    endcase
  end
  ...
  begin
    ...
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_advance_split_response)
	$display("[%0d]: %m: WCI SPLIT READ Data:%0x", v__h29738, v__h28680);
    if (wciS0_MReset_n)
