...
//
// On Tue Jan 10 09:43:58 EST 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkWSICaptureWorker8B(wciS0_Clk,
			    wciS0_MReset_n,
  ...
  // inlined wires
  wire [96 : 0] wsiS_wsiReq$wget;
  wire [95 : 0] wsiS_extStatusW$wget;
  wire [71 : 0] wci_wslv_wciReq$wget;
  wire [63 : 0] nowW$wget, wsi_Es_mData_w$wget;
  ...
  reg [63 : 0] v__h28045,
	       ...
	       v__h3814,
	       v__h3958;
  reg [31 : 0] IF_splaF_first__021_BITS_1_TO_0_023_EQ_0_024_T_ETC___d1082,
	       v__h29659;
  reg CASE_splaFD_OUT_BITS_1_TO_0_NOT_splaFD_OUT_B_ETC__q1,
      IF_splaF_first__021_BITS_1_TO_0_023_EQ_0_024_T_ETC___d1046,
      IF_wci_wslv_reqF_first__5_BITS_35_TO_34_104_EQ_ETC___d1117;
  wire [63 : 0] IF_nowW_whas__014_THEN_nowW_wget__015_ELSE_0___d1238;
  wire [31 : 0] g_data__h30691,
		rdat___1__h29781,
		rdat___1__h29836,
		rdat___1__h29850,
		rdat___1__h29858,
		...
		y_avValue__h29021,
		y_avValue__h29061;
  wire [13 : 0] mlB__h25496, mlInc__h25495;
  wire [3 : 0] x__h25544,
	       x__h25556,
	       x__h25568,
	       x__h25580,
  ...
  wire [2 : 0] dataBram_serverAdapterB_cnt_16_PLUS_IF_dataBra_ETC___d322,
	       metaBram_serverAdapterB_1_cnt_70_PLUS_IF_metaB_ETC___d676,
	       metaBram_serverAdapterB_2_cnt_88_PLUS_IF_metaB_ETC___d794,
	       metaBram_serverAdapterB_3_cnt_06_PLUS_IF_metaB_ETC___d912,
	       metaBram_serverAdapterB_cnt_52_PLUS_IF_metaBra_ETC___d558;
  wire IF_splaF_first__021_BITS_1_TO_0_023_EQ_0_024_T_ETC___d1030,
       IF_splaF_first__021_BITS_1_TO_0_023_EQ_0_024_T_ETC___d1035,
       IF_splaF_first__021_BITS_1_TO_0_023_EQ_0_024_T_ETC___d1055,
       IF_wci_wslv_reqF_first__5_BITS_63_TO_52_096_EQ_ETC___d1120,
       controlReg_41_BIT_0_42_AND_NOT_controlReg_41_B_ETC___d1003,
       dataBram_serverAdapterA_cnt_57_SLT_3_54_AND_da_ETC___d968,
       dataCount_48_ULT_1024___d949,
       mesgCount_45_ULT_1024___d946,
       splaF_i_notEmpty__020_AND_IF_splaF_first__021__ETC___d1057;
  ...
  assign WILL_FIRE_RL_doMessageAccept =
	     wsiS_reqFifo$EMPTY_N &&
	     (!controlReg[0] ||
	      controlReg[1] && !mesgCount_45_ULT_1024___d946 &&
	      !dataCount_48_ULT_1024___d949 ||
	      dataBram_serverAdapterA_cnt_57_SLT_3_54_AND_da_ETC___d968) &&
	     wci_wslv_cState == 3'd2 ;
  ...
  assign MUX_wci_wslv_respF_q_1$write_1__VAL_1 =
	     (wci_wslv_respF_c_r == 2'd2) ?
	       MUX_wci_wslv_respF_q_0$write_1__VAL_2 :
	       34'h0AAAAAAAA ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_1 = { 2'd1, g_data__h30691 } ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_2 =
	     wci_wslv_illegalEdge ? 34'h3C0DE4202 : 34'h1C0DE4201 ;
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_3 = { 2'd1, v__h28134 } ;
  ...
  assign dataBram_serverAdapterB_1_outData_enqData$whas =
	     ...
	     dataBram_serverAdapterB_1_s1[0] ;
  assign dataBram_serverAdapterB_1_outData_outData$wget = y_avValue__h28896 ;
  ...
  // register mesgLengthSoFar
  assign mesgLengthSoFar$D_IN = wsiS_reqFifo$D_OUT[93] ? 14'd0 : mlB__h25496 ;
  ...
  assign dataBram_memory$DIA = wsiS_reqFifo$D_OUT[47:16] ;
  ...
  assign dataBram_memory_1$DIA = wsiS_reqFifo$D_OUT[79:48] ;
  ...
  assign metaBram_memory$DIA = { 18'd0, mlB__h25496 } ;
  ...
  assign metaBram_memory_2$DIA =
	     IF_nowW_whas__014_THEN_nowW_wget__015_ELSE_0___d1238[63:32] ;
  ...
  assign metaBram_memory_3$DIA =
	     IF_nowW_whas__014_THEN_nowW_wget__015_ELSE_0___d1238[31:0] ;
  ...
  // remaining internal signals
  assign IF_nowW_whas__014_THEN_nowW_wget__015_ELSE_0___d1238 =
	     EN_now ? now_arg : 64'd0 ;
  assign IF_splaF_first__021_BITS_1_TO_0_023_EQ_0_024_T_ETC___d1030 =
	     (splaF$D_OUT[1:0] == 2'd0) ?
	       dataBram_serverAdapterB_outDataCore$EMPTY_N ||
	       dataBram_serverAdapterB_outData_enqData$whas :
	       splaF$D_OUT[1:0] != 2'd1 ||
	       dataBram_serverAdapterB_1_outDataCore$EMPTY_N ||
	       dataBram_serverAdapterB_1_outData_enqData$whas ;
  assign IF_splaF_first__021_BITS_1_TO_0_023_EQ_0_024_T_ETC___d1035 =
	     IF_splaF_first__021_BITS_1_TO_0_023_EQ_0_024_T_ETC___d1030 &&
	     ((splaF$D_OUT[1:0] == 2'd0) ?
		dataBram_serverAdapterB_outData_outData$whas :
		splaF$D_OUT[1:0] != 2'd1 ||
		dataBram_serverAdapterB_1_outData_outData$whas) ;
  assign IF_splaF_first__021_BITS_1_TO_0_023_EQ_0_024_T_ETC___d1055 =
	     IF_splaF_first__021_BITS_1_TO_0_023_EQ_0_024_T_ETC___d1046 &&
	     CASE_splaFD_OUT_BITS_1_TO_0_NOT_splaFD_OUT_B_ETC__q1 ;
  assign IF_wci_wslv_reqF_first__5_BITS_63_TO_52_096_EQ_ETC___d1120 =
	     (wci_wslv_reqF$D_OUT[63:52] == 12'h001) ?
	       (dataBram_serverAdapterB_cnt ^ 3'h4) < 3'd7 && splaF$FULL_N :
	       wci_wslv_reqF$D_OUT[63:52] != 12'h002 ||
	       splaF$FULL_N &&
	       IF_wci_wslv_reqF_first__5_BITS_35_TO_34_104_EQ_ETC___d1117 ;
  assign controlReg_41_BIT_0_42_AND_NOT_controlReg_41_B_ETC___d1003 =
	     controlReg[0] &&
	     (!controlReg[1] || mesgCount_45_ULT_1024___d946 ||
	      dataCount_48_ULT_1024___d949) ;
  assign dataBram_serverAdapterA_cnt_57_SLT_3_54_AND_da_ETC___d968 =
  ...
  assign dataCount_48_ULT_1024___d949 = dataCount < 32'd1024 ;
  assign g_data__h30691 =
	     (wci_wslv_reqF$D_OUT[63:52] == 12'h0) ? v__h29659 : 32'd0 ;
  assign mesgCount_45_ULT_1024___d946 = mesgCount < 32'd1024 ;
  assign metaBram_serverAdapterB_1_cnt_70_PLUS_IF_metaB_ETC___d676 =
		...
		3'd7 :
		3'd0) ;
  assign metaBram_serverAdapterB_2_cnt_88_PLUS_IF_metaB_ETC___d794 =
		...
		3'd7 :
		3'd0) ;
  assign metaBram_serverAdapterB_3_cnt_06_PLUS_IF_metaB_ETC___d912 =
		...
		3'd7 :
		3'd0) ;
  assign metaBram_serverAdapterB_cnt_52_PLUS_IF_metaBra_ETC___d558 =
	     metaBram_serverAdapterB_cnt +
	     (WILL_FIRE_RL_metaBram_serverAdapterB_stageReadResponseAlways ?
		3'd1 :
		3'd0) +
	     (metaBram_serverAdapterB_outData_deqCalled$whas ? 3'd7 : 3'd0) ;
  assign mlB__h25496 = mesgLengthSoFar + mlInc__h25495 ;
  assign mlInc__h25495 =
	     wsiS_reqFifo$D_OUT[93] ?
	       { 10'd0, x__h25544 + y__h25545 } :
	       14'd8 ;
  assign rdat___1__h29781 = hasDebugLogic ? { 24'd0, wsiS_statusR } : 32'd0 ;
  assign rdat___1__h29836 =
	     hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat___1__h29850 =
	     hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat___1__h29858 =
	     hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign splaF_i_notEmpty__020_AND_IF_splaF_first__021__ETC___d1057 =
	     splaF$EMPTY_N &&
	     (splaF$D_OUT[2] ?
		IF_splaF_first__021_BITS_1_TO_0_023_EQ_0_024_T_ETC___d1035 :
		IF_splaF_first__021_BITS_1_TO_0_023_EQ_0_024_T_ETC___d1055) ;
  assign v__h28134 =
	     splaF$D_OUT[2] ?
		  ...
		  y_avValue__h28856 :
		  y_avValue__h28896) :
	       IF_splaF_first__021_BITS_1_TO_0_023_EQ_0_024_T_ETC___d1082 ;
  assign x__h25544 = x__h25556 + y__h25557 ;
  assign x__h25556 = x__h25568 + y__h25569 ;
  assign x__h25568 = x__h25580 + y__h25581 ;
  assign x__h25580 = x__h25592 + y__h25593 ;
  assign x__h25592 = x__h25604 + y__h25605 ;
  assign x__h25604 = x__h25616 + y__h25617 ;
  assign x__h25616 = { 3'd0, wsiS_reqFifo$D_OUT[15] } ;
  assign y__h25545 = { 3'd0, wsiS_reqFifo$D_OUT[8] } ;
  assign y__h25557 = { 3'd0, wsiS_reqFifo$D_OUT[9] } ;
  assign y__h25569 = { 3'd0, wsiS_reqFifo$D_OUT[10] } ;
  assign y__h25581 = { 3'd0, wsiS_reqFifo$D_OUT[11] } ;
  assign y__h25593 = { 3'd0, wsiS_reqFifo$D_OUT[12] } ;
  assign y__h25605 = { 3'd0, wsiS_reqFifo$D_OUT[13] } ;
  assign y__h25617 = { 3'd0, wsiS_reqFifo$D_OUT[14] } ;
  assign y_avValue__h28856 = dataBram_serverAdapterB_outData_outData$wget ;
  assign y_avValue__h28896 =
	     dataBram_serverAdapterB_1_outDataCore$EMPTY_N ?
	       dataBram_serverAdapterB_1_outDataCore$D_OUT :
	       dataBram_memory_1$DOB ;
  assign y_avValue__h28941 = metaBram_serverAdapterB_outData_outData$wget ;
  assign y_avValue__h28981 = metaBram_serverAdapterB_1_outData_outData$wget ;
  assign y_avValue__h29021 = metaBram_serverAdapterB_2_outData_outData$wget ;
  assign y_avValue__h29061 = metaBram_serverAdapterB_3_outData_outData$wget ;
  always@(wci_wslv_reqF$D_OUT or
	  controlReg or
	  mesgCount or
	  dataCount or
	  rdat___1__h29781 or
	  rdat___1__h29836 or rdat___1__h29850 or rdat___1__h29858)
  begin
    case (wci_wslv_reqF$D_OUT[39:32])
      8'h0: v__h29659 = controlReg;
      8'h04: v__h29659 = mesgCount;
      8'h08: v__h29659 = dataCount;
      8'h10: v__h29659 = 32'd2361866;
      8'h1C: v__h29659 = 32'hFEEDC0DE;
      8'h20: v__h29659 = rdat___1__h29781;
      8'h24: v__h29659 = rdat___1__h29836;
      8'h28: v__h29659 = rdat___1__h29850;
      8'h2C: v__h29659 = rdat___1__h29858;
      default: v__h29659 = 32'd0;
    endcase
  end
  ...
  always@(splaF$D_OUT or
	  y_avValue__h29061 or
	  y_avValue__h28941 or y_avValue__h28981 or y_avValue__h29021)
  begin
    case (splaF$D_OUT[1:0])
      2'd0:
	  IF_splaF_first__021_BITS_1_TO_0_023_EQ_0_024_T_ETC___d1082 =
  ...
  begin
    ...
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_advance_split_response)
	$display("[%0d]: %m: WCI SPLIT READ Data:%0x", v__h29192, v__h28134);
    if (wciS0_MReset_n)
  ...
  // synopsys translate_on
endmodule  // mkWSICaptureWorker8B
