...
//
// On Tue Feb  4 14:43:52 EST 2014
//
//
// Ports:
// Name                         I/O  size props
...
module mkMemiTestWorker(wciS0_Clk,
  ...
  // register isCharPush
  reg isCharPush;
  wire isCharPush_D_IN, isCharPush_EN;
  ...
  reg [51 : 0] MUX_wmemi_reqF_q_0_write_1__VAL_1;
  ...
  wire [145 : 0] MUX_wmemi_dhF_q_0_write_1__VAL_1,
		 ...
		 MUX_wmemi_dhF_x_wire_wset_1__VAL_1;
  wire [51 : 0] MUX_wmemi_reqF_q_0_write_1__VAL_2,
		MUX_wmemi_reqF_q_1_write_1__VAL_2,
  ...
  wire MUX_isCharPush_write_1__SEL_1,
  ...
  reg [63 : 0] v__h14270, v__h15171, v__h3568, v__h3743, v__h3887;
  reg [31 : 0] g_data__h14986;
  wire [35 : 0] addr__h13652;
  wire [31 : 0] rdat__h15008, testStatus__h14482;
  wire [1 : 0] wci_wslv_respF_cntr_r_8_MINUS_1___d27,
	       wmemi_dhF_cntr_r_84_MINUS_1___d193,
	       wmemi_reqF_cntr_r_61_MINUS_1___d170;
  wire NOT_rgen_gsF_first__12_EQ_wmemi_respF_first__1_ETC___d316,
       _dfoo1,
       _dfoo11,
       _dfoo3,
       _dfoo5,
  ...
  // rule RL_char_push
  assign WILL_FIRE_RL_char_push =
	     wmemi_reqF_cntr_r != 2'd2 && wmemi_dhF_cntr_r != 2'd2 &&
	     wmemi_operateD &&
	     wmemi_peerIsReady &&
	     wci_wslv_cState_4_EQ_2_5_AND_isTesting_66_67_A_ETC___d272 &&
	     isCharPush ;
  ...
  assign WILL_FIRE_RL_wmemi_dhF_incCtr =
	     wmemi_dhF_x_wire_whas && wmemi_dhF_enqueueing_whas &&
	     !wmemi_dhF_dequeueing_whas ;

  // rule RL_wmemi_dhF_decCtr
  assign WILL_FIRE_RL_wmemi_dhF_decCtr =
	     wmemi_dhF_dequeueing_whas && !wmemi_dhF_enqueueing_whas ;

  // rule RL_wmemi_dhF_both
  assign WILL_FIRE_RL_wmemi_dhF_both =
	     wmemi_dhF_x_wire_whas && wmemi_dhF_dequeueing_whas &&
	     wmemi_dhF_enqueueing_whas ;

  // inputs to muxes for submodule ports
  assign MUX_isCharPush_write_1__SEL_1 =
  ...
  assign MUX_wci_wslv_respF_x_wire_wset_1__VAL_2 = { 2'd1, g_data__h14986 } ;
  assign MUX_wmemi_dhF_cntr_r_write_1__VAL_2 = wmemi_dhF_cntr_r + 2'd1 ;
  assign MUX_wmemi_dhF_q_0_write_1__VAL_1 =
	     WILL_FIRE_RL_write_req ?
	       MUX_wmemi_dhF_x_wire_wset_1__VAL_1 :
	       146'h30000000000000000000000000000002BFFFF ;
  ...
  always@(WILL_FIRE_RL_write_req or
	  MUX_wmemi_reqF_x_wire_wset_1__VAL_1 or
	  WILL_FIRE_RL_read_req or
	  MUX_wmemi_reqF_x_wire_wset_1__VAL_2 or WILL_FIRE_RL_char_push)
  begin
    case (1'b1) // synopsys parallel_case
      WILL_FIRE_RL_write_req:
	  ...
	  MUX_wmemi_reqF_q_0_write_1__VAL_1 =
	      MUX_wmemi_reqF_x_wire_wset_1__VAL_2;
      WILL_FIRE_RL_char_push:
	  MUX_wmemi_reqF_q_0_write_1__VAL_1 = 52'h308000002C001;
      default: MUX_wmemi_reqF_q_0_write_1__VAL_1 =
  ...
  assign MUX_wmemi_reqF_q_0_write_1__VAL_2 =
	     (wmemi_reqF_cntr_r == 2'd1) ?
	       MUX_wmemi_reqF_q_0_write_1__VAL_1 :
	       wmemi_reqF_q_1 ;
  assign MUX_wmemi_reqF_q_1_write_1__VAL_2 =
	     (wmemi_reqF_cntr_r == 2'd2) ?
	       MUX_wmemi_reqF_q_0_write_1__VAL_1 :
	       52'h0AAAAAAAAAAAA ;
  assign MUX_wmemi_reqF_x_wire_wset_1__VAL_1 = { 4'd3, addr__h13652, 12'd1 } ;
  assign MUX_wmemi_reqF_x_wire_wset_1__VAL_2 = { 4'd5, addr__h13652, 12'd1 } ;
  ...
  assign wmemi_reqF_x_wire_wget = MUX_wmemi_reqF_q_0_write_1__VAL_1 ;
  ...
  assign wmemi_dhF_x_wire_whas =
	     WILL_FIRE_RL_write_req || WILL_FIRE_RL_char_push ;
  ...
  assign wmemi_reqF_enqueueing_whas =
	     WILL_FIRE_RL_char_push || WILL_FIRE_RL_read_req ||
	     WILL_FIRE_RL_write_req ;
  assign wmemi_reqF_dequeueing_whas =
	     wmemiM0_SCmdAccept && wmemi_reqF_cntr_r != 2'd0 ;
  assign wmemi_dhF_enqueueing_whas =
	     WILL_FIRE_RL_char_push || WILL_FIRE_RL_write_req ;
  ...
  assign hwordAddr_EN = WILL_FIRE_RL_read_req || WILL_FIRE_RL_write_req ;

  // register isCharPush
  assign isCharPush_D_IN = MUX_isCharPush_write_1__SEL_1 && tstCtrl[1] ;
  assign isCharPush_EN =
	     WILL_FIRE_RL_read_req && unrollCnt == 32'd1 ||
	     WILL_FIRE_RL_char_push ;

  // register isReader
  assign isReader_D_IN = !MUX_isCharPush_write_1__SEL_1 ;
  assign isReader_EN =
	     WILL_FIRE_RL_read_req && unrollCnt == 32'd1 ||
	     WILL_FIRE_RL_write_req && unrollCnt == 32'd1 ;
  ...
  assign rdDuration_EN = MUX_isCharPush_write_1__SEL_1 ;
  ...
  assign testCycleCount_EN = MUX_isCharPush_write_1__SEL_1 ;
  ...
  assign wmemiRdReq_EN = WILL_FIRE_RL_read_req ;

  // register wmemiRdResp
  assign wmemiRdResp_D_IN = wmemiRdResp + 32'd1 ;
  assign wmemiRdResp_EN = WILL_FIRE_RL_read_resp ;

  // register wmemiWrReq
  assign wmemiWrReq_D_IN = wmemiWrReq + 32'd1 ;
  assign wmemiWrReq_EN = WILL_FIRE_RL_write_req ;
  ...
  always@(MUX_wmemi_reqF_q_1_write_1__SEL_1 or
	  ...
	  MUX_wmemi_reqF_q_1_write_1__VAL_2 or WILL_FIRE_RL_wmemi_reqF_decCtr)
  begin
    case (1'b1) // synopsys parallel_case
      MUX_wmemi_reqF_q_1_write_1__SEL_1:
	  wmemi_reqF_q_1_D_IN = MUX_wmemi_reqF_q_0_write_1__VAL_1;
      MUX_wmemi_reqF_q_1_write_1__SEL_2:
	  wmemi_reqF_q_1_D_IN = MUX_wmemi_reqF_q_1_write_1__VAL_2;
  ...
  assign wtCycStart_EN = MUX_isCharPush_write_1__SEL_1 ;
  ...
  // remaining internal signals
  assign NOT_rgen_gsF_first__12_EQ_wmemi_respF_first__1_ETC___d316 =
  ...
  assign addr__h13652 = { hwordAddr, 4'h0 } ;
  assign rdat__h15008 = { 24'd0, wmemi_statusR } ;
  assign testStatus__h14482 = { 31'h0, isReader } ;
  ...
  always@(wci_wslv_reqF_D_OUT or
	  ...
	  wtDuration or
	  rdDuration or
	  wmemiWrReq or wmemiRdReq or wmemiRdResp or testStatus__h14482)
  begin
    case (wci_wslv_reqF_D_OUT[63:32])
      32'h0: g_data__h14986 = tstCtrl;
      32'h00000004: g_data__h14986 = seqLen;
      32'h00000008: g_data__h14986 = rdat__h15008;
      32'h0000000C: g_data__h14986 = testCycleCount;
      32'h00000010: g_data__h14986 = errorCount;
      32'h00000014: g_data__h14986 = wtDuration;
      32'h00000018: g_data__h14986 = rdDuration;
      32'h0000001C: g_data__h14986 = wmemiWrReq;
      32'h00000020: g_data__h14986 = wmemiRdReq;
      32'h00000024: g_data__h14986 = wmemiRdResp;
      32'h00000028: g_data__h14986 = testStatus__h14482;
      default: g_data__h14986 = 32'd0;
    endcase
  end
  ...
  begin
	...
	isCharPush <= `BSV_ASSIGNMENT_DELAY 1'd0;
	...
	if (isCharPush_EN)
	  isCharPush <= `BSV_ASSIGNMENT_DELAY isCharPush_D_IN;
  ...
  begin
    ...
    if (wciS0_MReset_n != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_wci_ctrl_IsO)
	$display("[%0d]: %m: Starting MemiTestWorker", v__h15171);
    if (wciS0_MReset_n != `BSV_RESET_VALUE)
