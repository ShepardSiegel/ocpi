...
//
// On Wed Oct 30 08:48:23 EDT 2013
//
//
// Ports:
// Name                         I/O  size props
...
module mkMemiTestWorker(wciS0_Clk,
  ...
  wire [1 : 0] wmemi_dhF_cntr_r$D_IN;
  wire wmemi_dhF_cntr_r$EN;
  ...
  wire [1 : 0] wmemi_reqF_cntr_r$D_IN;
  wire wmemi_reqF_cntr_r$EN;
  ...
  wire [1 : 0] MUX_wci_wslv_respF_cntr_r$write_1__VAL_2,
	       MUX_wmemi_dhF_cntr_r$write_1__VAL_2,
	       MUX_wmemi_reqF_cntr_r$write_1__VAL_2;
  ...
  assign WILL_FIRE_RL_wmemi_reqF_both =
	     wmemi_reqF_x_wire$whas && wmemi_reqF_dequeueing$whas &&
	     wmemi_reqF_enqueueing$whas ;
  ...
  assign WILL_FIRE_RL_wmemi_dhF_both =
	     WILL_FIRE_RL_write_req && wmemi_dhF_dequeueing$whas &&
	     WILL_FIRE_RL_write_req ;
  ...
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_2 = { 2'd1, g_data__h14736 } ;
  assign MUX_wmemi_dhF_cntr_r$write_1__VAL_2 = wmemi_dhF_cntr_r + 2'd1 ;
  ...
  assign MUX_wmemi_reqF_cntr_r$write_1__VAL_2 = wmemi_reqF_cntr_r + 2'd1 ;
  ...
  assign MUX_wmemi_reqF_q_1$write_1__VAL_1 =
	     (wmemi_reqF_cntr_r == 2'd2) ?
	       MUX_wmemi_reqF_q_0$write_1__VAL_2 :
	       52'h0AAAAAAAAAAAA ;
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_1 = { 4'd3, addr__h13592, 12'd1 } ;
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_2 = { 4'd5, addr__h13592, 12'd1 } ;
  ...
  // register wmemi_dhF_cntr_r
  assign wmemi_dhF_cntr_r$D_IN =
	     WILL_FIRE_RL_wmemi_dhF_decCtr ?
	       wmemi_dhF_cntr_r_84_MINUS_1___d193 :
	       MUX_wmemi_dhF_cntr_r$write_1__VAL_2 ;
  assign wmemi_dhF_cntr_r$EN =
  ...
  // register wmemi_reqF_cntr_r
  assign wmemi_reqF_cntr_r$D_IN =
	     WILL_FIRE_RL_wmemi_reqF_decCtr ?
	       wmemi_reqF_cntr_r_61_MINUS_1___d170 :
	       MUX_wmemi_reqF_cntr_r$write_1__VAL_2 ;
  assign wmemi_reqF_cntr_r$EN =
	     WILL_FIRE_RL_wmemi_reqF_decCtr ||
	     WILL_FIRE_RL_wmemi_reqF_incCtr ;
  ...
  begin
	...
	if (wmemi_dhF_cntr_r$EN)
	  wmemi_dhF_cntr_r <= `BSV_ASSIGNMENT_DELAY wmemi_dhF_cntr_r$D_IN;
	if (wmemi_dhF_q_0$EN)
	...
	if (wmemi_reqF_cntr_r$EN)
	  wmemi_reqF_cntr_r <= `BSV_ASSIGNMENT_DELAY wmemi_reqF_cntr_r$D_IN;
