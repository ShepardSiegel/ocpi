...
//
// On Fri Oct 12 14:59:29 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkMemiTestWorker(wciS0_Clk,
  ...
  reg [63 : 0] v__h14490, v__h15261, v__h3700, v__h3875, v__h4019;
  reg [31 : 0] g_data__h15071;
  wire [35 : 0] addr__h13927;
  wire [31 : 0] rdat__h15093, testStatus__h14567;
  ...
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_2 = { 2'd1, g_data__h15071 } ;
  ...
  assign MUX_wmemi_reqF_q_1$write_1__VAL_1 =
	     (wmemi_reqF_c_r == 2'd2) ?
	       MUX_wmemi_reqF_q_0$write_1__VAL_2 :
	       52'h0AAAAAAAAAAAA ;
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_1 = { 4'd3, addr__h13927, 12'd1 } ;
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_2 = { 4'd5, addr__h13927, 12'd1 } ;
  ...
  assign addr__h13927 = { hwordAddr, 4'h0 } ;
  assign rdat__h15093 = { 24'd0, wmemi_statusR } ;
  assign testStatus__h14567 = { 31'h0, isReader } ;
  always@(wci_wslv_reqF$D_OUT or
	  ...
	  wtDuration or
	  rdDuration or
	  wmemiWrReq or wmemiRdReq or wmemiRdResp or testStatus__h14567)
  begin
    case (wci_wslv_reqF$D_OUT[63:32])
      32'h0: g_data__h15071 = tstCtrl;
      32'h00000004: g_data__h15071 = seqLen;
      32'h00000008: g_data__h15071 = rdat__h15093;
      32'h0000000C: g_data__h15071 = testCycleCount;
      32'h00000010: g_data__h15071 = errorCount;
      32'h00000014: g_data__h15071 = wtDuration;
      32'h00000018: g_data__h15071 = rdDuration;
      32'h0000001C: g_data__h15071 = wmemiWrReq;
      32'h00000020: g_data__h15071 = wmemiRdReq;
      32'h00000024: g_data__h15071 = wmemiRdResp;
      32'h00000028: g_data__h15071 = testStatus__h14567;
      default: g_data__h15071 = 32'd0;
    endcase
  end
  ...
  begin
    ...
    if (wciS0_MReset_n != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_wci_ctrl_IsO)
	$display("[%0d]: %m: Starting MemiTestWorker", v__h15261);
    if (wciS0_MReset_n != `BSV_RESET_VALUE)
