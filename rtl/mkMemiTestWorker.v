...
//
// On Tue Feb 28 06:56:59 EST 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkMemiTestWorker(wciS0_Clk,
  ...
  reg [63 : 0] v__h14159, v__h14863, v__h3627, v__h3801, v__h3945;
  reg [31 : 0] g_data__h14674;
  wire [35 : 0] addr__h13687;
  wire [31 : 0] rdat__h14697, testStatus__h14236;
  wire [29 : 0] x__h13732;
  wire NOT_rgen_gsF_first__14_EQ_wmemi_respF_first__1_ETC___d318;
  ...
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_2 = { 2'd1, g_data__h14674 } ;
  ...
  assign MUX_wmemi_reqF_q_1$write_1__VAL_2 =
	     (wmemi_reqF_c_r == 2'd2) ?
	       MUX_wmemi_reqF_q_0$write_1__VAL_1 :
	       52'h0AAAAAAAAAAAA ;
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_1 = { 4'd3, addr__h13687, 12'd1 } ;
  assign MUX_wmemi_reqF_x_wire$wset_1__VAL_2 = { 4'd5, addr__h13687, 12'd1 } ;
  ...
  assign errorCount$EN =
	     WILL_FIRE_RL_read_resp &&
	     NOT_rgen_gsF_first__14_EQ_wmemi_respF_first__1_ETC___d318 ;
  ...
  // register hwordAddr
  assign hwordAddr$D_IN = (unrollCnt == 32'd1) ? 24'd0 : hwordAddr + 24'd1 ;
  ...
  // register isTesting
  assign isTesting$D_IN = 1'd1 ;
  assign isTesting$EN = MUX_unrollCnt$write_1__SEL_1 ;
  ...
  assign wmemiRdReq$EN = WILL_FIRE_RL_read_req ;

  // register wmemiRdResp
  assign wmemiRdResp$D_IN = wmemiRdResp + 32'd1 ;
  assign wmemiRdResp$EN = WILL_FIRE_RL_read_resp ;

  // register wmemiWrReq
  assign wmemiWrReq$D_IN = wmemiWrReq + 32'd1 ;
  assign wmemiWrReq$EN = WILL_FIRE_RL_write_req ;
  ...
  // remaining internal signals
  assign NOT_rgen_gsF_first__14_EQ_wmemi_respF_first__1_ETC___d318 =
	     rgen_gsF$D_OUT != wmemi_respF$D_OUT[127:0] ;
  assign addr__h13687 = { 6'd0, x__h13732 } ;
  assign rdat__h14697 = { 24'd0, wmemi_statusR } ;
  assign testStatus__h14236 = { 31'h0, isReader } ;
  assign x__h13732 = { hwordAddr, 6'h0 } ;
  always@(wci_wslv_reqF$D_OUT or
	  ...
	  wtDuration or
	  rdDuration or
	  wmemiWrReq or wmemiRdReq or wmemiRdResp or testStatus__h14236)
  begin
    case (wci_wslv_reqF$D_OUT[63:32])
      32'h0: g_data__h14674 = tstCtrl;
      32'h00000004: g_data__h14674 = seqLen;
      32'h00000008: g_data__h14674 = rdat__h14697;
      32'h0000000C: g_data__h14674 = testCycleCount;
      32'h00000010: g_data__h14674 = errorCount;
      32'h00000014: g_data__h14674 = wtDuration;
      32'h00000018: g_data__h14674 = rdDuration;
      32'h0000001C: g_data__h14674 = wmemiWrReq;
      32'h00000020: g_data__h14674 = wmemiRdReq;
      32'h00000024: g_data__h14674 = wmemiRdResp;
      32'h00000028: g_data__h14674 = testStatus__h14236;
      default: g_data__h14674 = 32'd0;
    endcase
  end
  ...
  begin
	...
	hwordAddr <= `BSV_ASSIGNMENT_DELAY 24'd0;
  ...
  begin
    ...
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wci_ctrl_IsO)
	$display("[%0d]: %m: Starting MemiTestWorker", v__h14863);
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wci_cfwr && WILL_FIRE_RL_wci_ctrl_OrE)
	$display("Error: \"bsv/wrk/MemiTestWorker.bsv\", line 115, column 26: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_cfwr] and\n  [RL_wci_ctrl_OrE] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n)
	...
	$display("Error: \"bsv/wrk/MemiTestWorker.bsv\", line 115, column 36: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_cfrd] and\n  [RL_wci_ctrl_OrE] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n)
	...
	$display("Error: \"bsv/wrk/MemiTestWorker.bsv\", line 115, column 60: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_ctrl_IsO] and\n  [RL_wci_ctrl_OrE] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wci_ctrl_EiI && WILL_FIRE_RL_wci_ctrl_OrE)
	$display("Error: \"bsv/wrk/MemiTestWorker.bsv\", line 115, column 46: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_wci_ctrl_EiI] and\n  [RL_wci_ctrl_OrE] ) fired in the same clock cycle.\n");
    if (wciS0_MReset_n)
