...
//
// On Tue Jul 27 12:17:06 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkBiasWorker(wciS0_Clk,
  ...
  reg [63 : 0] v__h2626, v__h2773, v__h3672, v__h9515, v__h9832;
  reg [31 : 0] _theResult____h9499;
  wire [31 : 0] x_data__h10097;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, _theResult____h9499 } ;
  ...
  assign wsiS_reqFifo_notFull__90_AND_wsiS_burstKind_70_ETC___d210 =
	     ...
	     (wsiS_burstKind == 2'd0 ||
	      ...
	      wsiS_wsiReq$wget[57]) ;
  assign x_data__h10097 = wsiS_reqFifo$D_OUT[43:12] + biasValue ;
  always@(wci_reqF$D_OUT or biasValue or controlReg)
  begin
    case (wci_reqF$D_OUT[39:32])
      8'h0: _theResult____h9499 = biasValue;
      8'h04: _theResult____h9499 = controlReg;
      default: _theResult____h9499 = 32'd0;
    endcase
  end
