...
//
// On Fri Jun 25 10:48:20 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkPSD(wciS0_Clk,
  ...
  wire fft_xkF$CLR, fft_xkF$DEQ, fft_xkF$EMPTY_N, fft_xkF$ENQ;
  ...
  wire CAN_FIRE_RL_fft_drive_fft_always_enabled,
       ...
       CAN_FIRE_RL_psdPass_doMessagePush,
       ...
       WILL_FIRE_RL_psdPass_doMessagePush,
  ...
  wire [32 : 0] MUX_fft_xnF$enq_1__VAL_1, MUX_fft_xnF$enq_1__VAL_2;
  ...
  reg [63 : 0] v__h10882, v__h2623, v__h2770, v__h3669;
  reg [31 : 0] x_data__h11014;
  wire [31 : 0] psdStatus__h10759,
		rdat__h11038,
		rdat__h11138,
		rdat__h11152,
		rdat__h11160,
		...
		rdat__h11188;
  wire [15 : 0] x__h11042;
  wire NOT_wsiS_reqFifo_countReg_59_ULE_1_60___d261;
  ...
  assign wsiS0_SThreadBusy =
	     NOT_wsiS_reqFifo_countReg_59_ULE_1_60___d261 ||
	     wsiS_isReset$VAL ||
	     !wsiS_operateD ||
	     !wsiS_peerIsReady ;
  ...
  // rule RL_psdPass_doMessagePush
  assign CAN_FIRE_RL_psdPass_doMessagePush =
	     MUX_wsiM_reqFifo_x_wire$wset_1__SEL_2 ;
  assign WILL_FIRE_RL_psdPass_doMessagePush =
	     MUX_wsiM_reqFifo_x_wire$wset_1__SEL_2 ;
  ...
  assign CAN_FIRE_RL_fft_fft_stream_egress = fft_xnF$FULL_N && fft_fft$dv ;
  ...
  assign MUX_wsiM_reqFifo_x_wire$wset_1__PSEL_1 =
	     ...
	     wci_cState == 3'd2 &&
	     psdCtrl[3:0] == 4'h1 ;
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, x_data__h11014 } ;
  ...
  assign MUX_fft_xnF$enq_1__VAL_2 = { 1'd1, fft_fft$xk_re, fft_fft$xk_im } ;
  assign MUX_fft_xnF$enq_1__VAL_1 =
	     { 1'd1, wsiS_reqFifo$D_OUT[27:12], 16'd0 } ;
  ...
  // submodule fft_xkF
  assign fft_xkF$DEQ = MUX_wsiM_reqFifo_x_wire$wset_1__PSEL_1 ;
  assign fft_xkF$D_IN = 33'h0 ;
  assign fft_xkF$CLR = 1'b0 ;
  assign fft_xkF$ENQ = 1'b0 ;

  // submodule fft_xnF
  assign fft_xnF$D_IN =
	     WILL_FIRE_RL_psdFFT_doIngress ?
	       MUX_fft_xnF$enq_1__VAL_1 :
	       MUX_fft_xnF$enq_1__VAL_2 ;
  ...
  // remaining internal signals
  assign NOT_wsiS_reqFifo_countReg_59_ULE_1_60___d261 =
	     wsiS_reqFifo_countReg > 2'd1 ;
  assign psdStatus__h10759 = { 31'd0, hasDebugLogic } ;
  assign rdat__h11038 = hasDebugLogic ? { 16'd0, x__h11042 } : 32'd0 ;
  assign rdat__h11138 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h11152 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h11160 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h11166 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h11180 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h11188 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign x__h11042 = { wsiS_statusR, wsiM_statusR } ;
  always@(wci_reqF$D_OUT or
	  psdStatus__h10759 or
	  psdCtrl or
	  rdat__h11038 or
	  rdat__h11138 or
	  rdat__h11152 or
	  rdat__h11160 or rdat__h11166 or rdat__h11180 or rdat__h11188)
  begin
    case (wci_reqF$D_OUT[51:32])
      20'h0: x_data__h11014 = psdStatus__h10759;
      20'h00004: x_data__h11014 = psdCtrl;
      20'h00010: x_data__h11014 = rdat__h11038;
      20'h00014: x_data__h11014 = rdat__h11138;
      20'h00018: x_data__h11014 = rdat__h11152;
      20'h0001C: x_data__h11014 = rdat__h11160;
      20'h00020: x_data__h11014 = rdat__h11166;
      20'h00024: x_data__h11014 = rdat__h11180;
      20'h00028: x_data__h11014 = rdat__h11188;
      default: x_data__h11014 = 32'd0;
    endcase
  end
  ...
  begin
    ...
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wci_ctrl_IsO)
	$display("[%0d]: %m: Starting PSD psdCtrl:%0x", v__h10882, psdCtrl);
    if (wciS0_MReset_n)
