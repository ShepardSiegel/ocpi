...
//
// On Sun Jun 27 09:22:29 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkPSD(wciS0_Clk,
  ...
  reg [63 : 0] v__h13377, v__h2623, v__h2770, v__h3669;
  reg [31 : 0] x_data__h13509;
  wire [31 : 0] psdStatus__h13254,
		rdat__h13533,
		rdat__h13633,
		rdat__h13647,
		rdat__h13655,
		...
		x__h7029,
		x_data__h7451;
  wire [15 : 0] w2p_wordsExact_89_MINUS_1___d579, x__h12559, x__h13537;
  wire [12 : 0] x__h6921;
  wire NOT_w2p_dataF_rRdPtr_72_PLUS_2048_00_EQ_w2p_da_ETC___d310,
       NOT_wsiS_reqFifo_countReg_47_ULE_1_48___d349,
       w2p_outF_i_notEmpty__43_AND_IF_psdCtrl_6_BITS__ETC___d147,
       w2p_wordsDequed_88_EQ_w2p_wordsExact_89_MINUS__ETC___d545,
       w2p_wordsEnqued_04_EQ_w2p_wordsExact_89_MINUS__ETC___d612;
  ...
  assign CAN_FIRE_RL_psdFFT_doEgress =
	     fft_xkF$EMPTY_N &&
	     (!fft_xkF$D_OUT[32] || wsiM_reqFifo_c_r != 2'd2) &&
	     wci_cState == 3'd2 &&
	     psdCtrl[3:0] == 4'h2 ;
  ...
  assign CAN_FIRE_RL_w2p_imprecise_enq =
	     NOT_w2p_dataF_rRdPtr_72_PLUS_2048_00_EQ_w2p_da_ETC___d310 &&
	     w2p_operateW$whas ;
  ...
  assign MUX_wsiM_reqFifo_x_wire$wset_1__SEL_1 =
	     WILL_FIRE_RL_psdFFT_doEgress && fft_xkF$D_OUT[32] ;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, x_data__h13509 } ;
  ...
  assign w2p_dataF_wDataOut$wget = x_data__h7451 ;
  ...
  // register w2p_dataF_rCache
  assign w2p_dataF_rCache$D_IN = { 1'd1, w2p_dataF_rWrPtr, x__h7029 } ;
  assign w2p_dataF_rCache$EN = CAN_FIRE_RL_w2p_imprecise_enq ;

  // register w2p_dataF_rRdPtr
  assign w2p_dataF_rRdPtr$D_IN = x__h6921 ;
  ...
  assign fft_xkF$DEQ = WILL_FIRE_RL_psdFFT_doEgress && !sendEven ;
  assign fft_xkF$ENQ = CAN_FIRE_RL_fft_fft_stream_egress ;
  assign fft_xkF$CLR = 1'b0 ;

  // submodule fft_xnF
  assign fft_xnF$D_IN = { 1'd1, x__h12559, 16'd0 } ;
  ...
  assign w2p_dataF_memory$DIA = x__h7029 ;
  ...
  // remaining internal signals
  assign NOT_w2p_dataF_rRdPtr_72_PLUS_2048_00_EQ_w2p_da_ETC___d310 =
	     w2p_dataF_rRdPtr + 13'd2048 != w2p_dataF_rWrPtr &&
	     w2p_inF$EMPTY_N &&
	     (!w2p_wordsEnqued_04_EQ_w2p_wordsExact_89_MINUS__ETC___d612 ||
	      w2p_reqF$FULL_N) ;
  assign NOT_wsiS_reqFifo_countReg_47_ULE_1_48___d349 =
	     wsiS_reqFifo_countReg > 2'd1 ;
  assign psdStatus__h13254 = { 31'd0, hasDebugLogic } ;
  assign rdat__h13533 = hasDebugLogic ? { 16'd0, x__h13537 } : 32'd0 ;
  assign rdat__h13633 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h13647 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h13655 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h13661 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h13675 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h13683 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign w2p_outF_i_notEmpty__43_AND_IF_psdCtrl_6_BITS__ETC___d147 =
	     w2p_outF$EMPTY_N &&
	     ((psdCtrl[3:0] == 4'h1) ?
		wsiM_reqFifo_c_r != 2'd2 :
		xnF$FULL_N) ;
  assign w2p_wordsDequed_88_EQ_w2p_wordsExact_89_MINUS__ETC___d545 =
	     w2p_wordsDequed == w2p_wordsExact_89_MINUS_1___d579 ;
  assign w2p_wordsEnqued_04_EQ_w2p_wordsExact_89_MINUS__ETC___d612 =
	     w2p_wordsEnqued == w2p_wordsExact_89_MINUS_1___d579 ;
  assign w2p_wordsExact_89_MINUS_1___d579 = w2p_wordsExact - 16'd1 ;
  assign x__h12559 = takeEven ? xnF$D_OUT[15:0] : xnF$D_OUT[31:16] ;
  assign x__h13537 = { wsiS_statusR, wsiM_statusR } ;
  assign x__h6921 = w2p_dataF_rRdPtr + 13'd1 ;
  assign x__h7029 =
	     CAN_FIRE_RL_w2p_imprecise_enq ? w2p_inF$D_OUT[43:12] : 32'd0 ;
  assign x_data__h7451 =
	     (w2p_dataF_rCache[45] &&
	      w2p_dataF_rCache[44:32] == w2p_dataF_rRdPtr) ?
	       w2p_dataF_rCache[31:0] :
	       w2p_dataF_memory$DOB ;
  always@(wci_reqF$D_OUT or
	  psdStatus__h13254 or
	  psdCtrl or
	  rdat__h13533 or
	  rdat__h13633 or
	  rdat__h13647 or
	  rdat__h13655 or rdat__h13661 or rdat__h13675 or rdat__h13683)
  begin
    case (wci_reqF$D_OUT[51:32])
      20'h0: x_data__h13509 = psdStatus__h13254;
      20'h00004: x_data__h13509 = psdCtrl;
      20'h00010: x_data__h13509 = rdat__h13533;
      20'h00014: x_data__h13509 = rdat__h13633;
      20'h00018: x_data__h13509 = rdat__h13647;
      20'h0001C: x_data__h13509 = rdat__h13655;
      20'h00020: x_data__h13509 = rdat__h13661;
      20'h00024: x_data__h13509 = rdat__h13675;
      20'h00028: x_data__h13509 = rdat__h13683;
      default: x_data__h13509 = 32'd0;
    endcase
  end
