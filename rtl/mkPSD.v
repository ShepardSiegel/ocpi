...
//
// On Sun Jun 27 15:04:40 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkPSD(wciS0_Clk,
  ...
  wire CAN_FIRE_RL_fft_drive_fft_always_enabled,
       ...
       WILL_FIRE_RL_psdPrecise_output,
  ...
  reg [63 : 0] v__h13661, v__h2625, v__h2772, v__h3671;
  reg [31 : 0] x_data__h13793;
  wire [31 : 0] psdStatus__h13538,
		rdat__h13817,
		rdat__h13917,
		rdat__h13931,
		rdat__h13939,
  ...
  wire [15 : 0] IF_IF_IF_fft_xkF_first__09_BIT_32_10_THEN_fft__ETC___d139,
		IF_IF_IF_fft_xkF_first__09_BIT_32_10_THEN_fft__ETC___d609,
		IF_IF_fft_xkF_first__09_BIT_32_10_THEN_fft_xkF_ETC___d134,
		IF_IF_fft_xkF_first__09_BIT_32_10_THEN_fft_xkF_ETC___d136,
		IF_IF_fft_xkF_first__09_BIT_32_10_THEN_fft_xkF_ETC___d606,
		IF_IF_fft_xkF_first__09_BIT_32_10_THEN_fft_xkF_ETC___d607,
		dReal__h12720,
		fft_xkFD_OUT_BITS_15_TO_0__q2,
		fft_xkFD_OUT_BITS_31_TO_16__q1,
		result__h12788,
		w2p_wordsExact_14_MINUS_1___d608,
		x__h12759,
		x__h13821;
  wire [12 : 0] x__h6923;
  wire NOT_w2p_dataF_rRdPtr_97_PLUS_2048_25_EQ_w2p_da_ETC___d335,
       NOT_wsiS_reqFifo_countReg_72_ULE_1_73___d374,
       w2p_outF_i_notEmpty__68_AND_IF_psdCtrl_6_BITS__ETC___d172,
       w2p_wordsDequed_13_EQ_w2p_wordsExact_14_MINUS__ETC___d570,
       w2p_wordsEnqued_29_EQ_w2p_wordsExact_14_MINUS__ETC___d645;
  ...
  // rule RL_psdPrecise_output
  assign CAN_FIRE_RL_psdPrecise_output =
	     w2p_outF_i_notEmpty__68_AND_IF_psdCtrl_6_BITS__ETC___d172 &&
	     wci_cState == 3'd2 &&
	     (psdCtrl[3:0] == 4'h1 || psdCtrl[3:0] == 4'h2) ;
  assign WILL_FIRE_RL_psdPrecise_output =
	     CAN_FIRE_RL_psdPrecise_output && !WILL_FIRE_RL_psdFFT_doEgress ;
  ...
  assign CAN_FIRE_RL_w2p_imprecise_enq =
	     NOT_w2p_dataF_rRdPtr_97_PLUS_2048_25_EQ_w2p_da_ETC___d335 &&
	     w2p_operateW$whas ;
  ...
  assign MUX_wsiM_reqFifo_x_wire$wset_1__SEL_2 =
	     WILL_FIRE_RL_psdPrecise_output && psdCtrl[3:0] == 4'h1 ;
  ...
  always@(MUX_wsiM_reqFifo_x_wire$wset_1__SEL_1 or
	  ...
	  MUX_wsiM_reqFifo_x_wire$wset_1__SEL_2 or
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, x_data__h13793 } ;
  ...
  assign w2p_operateW$whas =
	     WILL_FIRE_RL_operating_actions && psdCtrl[3:0] == 4'h1 ;
  ...
  // submodule fft_xnF
  assign fft_xnF$D_IN = { 1'd1, x__h12759, 16'd0 } ;
  ...
  assign w2p_outF$D_IN =
	     { 3'd1,
	       ...
	       4'd15,
	       w2p_reqF$D_OUT } ;
  assign w2p_outF$DEQ = WILL_FIRE_RL_psdPrecise_output ;
  ...
  assign xnF$ENQ = WILL_FIRE_RL_psdPrecise_output && psdCtrl[3:0] != 4'h1 ;
  assign xnF$CLR = 1'b0 ;
  ...
  assign IF_IF_IF_fft_xkF_first__09_BIT_32_10_THEN_fft__ETC___d139 =
	     IF_IF_IF_fft_xkF_first__09_BIT_32_10_THEN_fft__ETC___d609 /
	     16'd16 ;
  assign IF_IF_IF_fft_xkF_first__09_BIT_32_10_THEN_fft__ETC___d609 =
	     (IF_IF_fft_xkF_first__09_BIT_32_10_THEN_fft_xkF_ETC___d606 <=
	      IF_IF_fft_xkF_first__09_BIT_32_10_THEN_fft_xkF_ETC___d607) ?
	       IF_IF_fft_xkF_first__09_BIT_32_10_THEN_fft_xkF_ETC___d134 +
	       IF_IF_fft_xkF_first__09_BIT_32_10_THEN_fft_xkF_ETC___d607 :
  ...
  assign IF_IF_fft_xkF_first__09_BIT_32_10_THEN_fft_xkF_ETC___d136 =
	     IF_IF_fft_xkF_first__09_BIT_32_10_THEN_fft_xkF_ETC___d607 /
	     16'd2 ;
  assign IF_IF_fft_xkF_first__09_BIT_32_10_THEN_fft_xkF_ETC___d606 =
	     fft_xkFD_OUT_BITS_31_TO_16__q1[15] ?
	       -fft_xkF$D_OUT[31:16] :
	       fft_xkF$D_OUT[31:16] ;
  assign IF_IF_fft_xkF_first__09_BIT_32_10_THEN_fft_xkF_ETC___d607 =
	     fft_xkFD_OUT_BITS_15_TO_0__q2[15] ?
	       -fft_xkF$D_OUT[15:0] :
	       fft_xkF$D_OUT[15:0] ;
  assign NOT_w2p_dataF_rRdPtr_97_PLUS_2048_25_EQ_w2p_da_ETC___d335 =
	     w2p_dataF_rRdPtr + 13'd2048 != w2p_dataF_rWrPtr &&
	     w2p_inF$EMPTY_N &&
	     (!w2p_wordsEnqued_29_EQ_w2p_wordsExact_14_MINUS__ETC___d645 ||
	      w2p_reqF$FULL_N) ;
  assign NOT_wsiS_reqFifo_countReg_72_ULE_1_73___d374 =
	     wsiS_reqFifo_countReg > 2'd1 ;
  assign dReal__h12720 = takeEven ? xnF$D_OUT[15:0] : xnF$D_OUT[31:16] ;
  assign fft_xkFD_OUT_BITS_15_TO_0__q2 = fft_xkF$D_OUT[15:0] ;
  assign fft_xkFD_OUT_BITS_31_TO_16__q1 = fft_xkF$D_OUT[31:16] ;
  assign psdStatus__h13538 = { 31'd0, hasDebugLogic } ;
  assign rdat__h13817 = hasDebugLogic ? { 16'd0, x__h13821 } : 32'd0 ;
  assign rdat__h13917 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h13931 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h13939 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h13945 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h13959 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h13967 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign result__h12788 = { ~dReal__h12720[15], dReal__h12720[14:0] } ;
  assign w2p_outF_i_notEmpty__68_AND_IF_psdCtrl_6_BITS__ETC___d172 =
	     w2p_outF$EMPTY_N &&
	     ((psdCtrl[3:0] == 4'h1) ?
		wsiM_reqFifo_c_r != 2'd2 :
		xnF$FULL_N) ;
  assign w2p_wordsDequed_13_EQ_w2p_wordsExact_14_MINUS__ETC___d570 =
	     w2p_wordsDequed == w2p_wordsExact_14_MINUS_1___d608 ;
  assign w2p_wordsEnqued_29_EQ_w2p_wordsExact_14_MINUS__ETC___d645 =
	     w2p_wordsEnqued == w2p_wordsExact_14_MINUS_1___d608 ;
  assign w2p_wordsExact_14_MINUS_1___d608 = w2p_wordsExact - 16'd1 ;
  assign x__h12759 = psdCtrl[4] ? result__h12788 : dReal__h12720 ;
  assign x__h13821 = { wsiS_statusR, wsiM_statusR } ;
  assign x__h6923 = w2p_dataF_rRdPtr + 13'd1 ;
  assign x__h7031 =
	     CAN_FIRE_RL_w2p_imprecise_enq ? w2p_inF$D_OUT[43:12] : 32'd0 ;
  assign x_data__h12592 =
	     { IF_IF_IF_fft_xkF_first__09_BIT_32_10_THEN_fft__ETC___d609 -
	       IF_IF_IF_fft_xkF_first__09_BIT_32_10_THEN_fft__ETC___d139,
	       evenMag } ;
  ...
  always@(wci_reqF$D_OUT or
	  psdStatus__h13538 or
	  psdCtrl or
	  rdat__h13817 or
	  rdat__h13917 or
	  rdat__h13931 or
	  rdat__h13939 or rdat__h13945 or rdat__h13959 or rdat__h13967)
  begin
    case (wci_reqF$D_OUT[51:32])
      20'h0: x_data__h13793 = psdStatus__h13538;
      20'h00004: x_data__h13793 = psdCtrl;
      20'h00010: x_data__h13793 = rdat__h13817;
      20'h00014: x_data__h13793 = rdat__h13917;
      20'h00018: x_data__h13793 = rdat__h13931;
      20'h0001C: x_data__h13793 = rdat__h13939;
      20'h00020: x_data__h13793 = rdat__h13945;
      20'h00024: x_data__h13793 = rdat__h13959;
      20'h00028: x_data__h13793 = rdat__h13967;
      default: x_data__h13793 = 32'd0;
    endcase
  end
