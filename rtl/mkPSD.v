...
//
// On Sat Jun 26 14:07:16 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkPSD(wciS0_Clk,
  ...
  reg [63 : 0] v__h12930, v__h2623, v__h2770, v__h3669;
  reg [31 : 0] x_data__h13062;
  wire [31 : 0] psdStatus__h12807,
		rdat__h13086,
		rdat__h13186,
		rdat__h13200,
		rdat__h13208,
  ...
  wire [15 : 0] x__h13090;
  wire [12 : 0] x__h6921;
  wire NOT_w2p_dataF_rRdPtr_59_PLUS_2048_84_EQ_w2p_da_ETC___d294,
       NOT_wsiS_reqFifo_countReg_31_ULE_1_32___d333;
  ...
  assign CAN_FIRE_RL_w2p_imprecise_enq =
	     NOT_w2p_dataF_rRdPtr_59_PLUS_2048_84_EQ_w2p_da_ETC___d294 &&
	     w2p_operateW$whas ;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, x_data__h13062 } ;
  ...
  assign w2p_dataF_wDataOut$wget = x_data__h7411 ;
  ...
  assign w2p_wordsDequed$D_IN =
	     (w2p_wordsDequed == 16'd1023) ? 16'd0 : w2p_wordsDequed + 16'd1 ;
  assign w2p_wordsDequed$EN = CAN_FIRE_RL_w2p_precise_deq ;

  // register w2p_wordsEnqued
  assign w2p_wordsEnqued$D_IN =
	     (w2p_wordsEnqued == 16'd1023) ? 16'd0 : w2p_wordsEnqued + 16'd1 ;
  ...
  assign w2p_reqF$DEQ =
	     WILL_FIRE_RL_w2p_precise_deq && w2p_wordsDequed == 16'd1023 ;
  assign w2p_reqF$ENQ =
	     WILL_FIRE_RL_w2p_imprecise_enq && w2p_wordsEnqued == 16'd1023 ;
  ...
  // remaining internal signals
  assign NOT_w2p_dataF_rRdPtr_59_PLUS_2048_84_EQ_w2p_da_ETC___d294 =
	     w2p_dataF_rRdPtr + 13'd2048 != w2p_dataF_rWrPtr &&
	     w2p_inF$EMPTY_N &&
	     (w2p_wordsEnqued != 16'd1023 || w2p_reqF$FULL_N) ;
  assign NOT_wsiS_reqFifo_countReg_31_ULE_1_32___d333 =
	     wsiS_reqFifo_countReg > 2'd1 ;
  assign psdStatus__h12807 = { 31'd0, hasDebugLogic } ;
  assign rdat__h13086 = hasDebugLogic ? { 16'd0, x__h13090 } : 32'd0 ;
  assign rdat__h13186 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h13200 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h13208 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h13214 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h13228 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h13236 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign x__h13090 = { wsiS_statusR, wsiM_statusR } ;
  assign x__h6921 = w2p_dataF_rRdPtr + 13'd1 ;
  assign x__h7029 =
	     CAN_FIRE_RL_w2p_imprecise_enq ? w2p_inF$D_OUT[43:12] : 32'd0 ;
  assign x_data__h7411 =
	     (w2p_dataF_rCache[45] &&
	      w2p_dataF_rCache[44:32] == w2p_dataF_rRdPtr) ?
	       w2p_dataF_rCache[31:0] :
	       w2p_dataF_memory$DOB ;
  always@(wci_reqF$D_OUT or
	  psdStatus__h12807 or
	  psdCtrl or
	  rdat__h13086 or
	  rdat__h13186 or
	  rdat__h13200 or
	  rdat__h13208 or rdat__h13214 or rdat__h13228 or rdat__h13236)
  begin
    case (wci_reqF$D_OUT[51:32])
      20'h0: x_data__h13062 = psdStatus__h12807;
      20'h00004: x_data__h13062 = psdCtrl;
      20'h00010: x_data__h13062 = rdat__h13086;
      20'h00014: x_data__h13062 = rdat__h13186;
      20'h00018: x_data__h13062 = rdat__h13200;
      20'h0001C: x_data__h13062 = rdat__h13208;
      20'h00020: x_data__h13062 = rdat__h13214;
      20'h00024: x_data__h13062 = rdat__h13228;
      20'h00028: x_data__h13062 = rdat__h13236;
      default: x_data__h13062 = 32'd0;
    endcase
  end
  ...
  begin
    ...
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wci_ctrl_IsO)
	$display("[%0d]: %m: Starting PSD psdCtrl:%0x", v__h12930, psdCtrl);
    if (wciS0_MReset_n)
