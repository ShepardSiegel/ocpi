...
//
// On Mon Oct 25 17:58:15 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkPSD(wciS0_Clk,
  ...
  reg [63 : 0] v__h14395, v__h2646, v__h2804, v__h3703;
  reg [31 : 0] x_data__h14529;
  wire [31 : 0] psdStatus__h14272,
		rdat__h14559,
		rdat__h14659,
		rdat__h14673,
		rdat__h14681,
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, x_data__h14529 } ;
  ...
  assign w2p_dataF_wDataOut$wget = x_data__h7890 ;
  ...
  // register w2p_dataF_rCache
  assign w2p_dataF_rCache$D_IN = { 1'd1, w2p_dataF_rWrPtr, x__h7468 } ;
  assign w2p_dataF_rCache$EN = CAN_FIRE_RL_w2p_imprecise_enq ;

  // register w2p_dataF_rRdPtr
  assign w2p_dataF_rRdPtr$D_IN = x__h7360 ;
  ...
  // submodule fft_xnF
  assign fft_xnF$D_IN = { x__h13449, 16'd0 } ;
  ...
  assign w2p_dataF_memory$DIA = x__h7468 ;
  ...
  assign NOT_w2p_dataF_rRdPtr_11_PLUS_2048_39_EQ_w2p_da_ETC___d349 =
	     ...
	     (!w2p_wordsEnqued_43_EQ_w2p_wordsExact_28_MINUS__ETC___d674 ||
	      w2p_reqF$FULL_N) ;
  assign dReal__h13417 = takeEven ? xnF$D_OUT[15:0] : xnF$D_OUT[31:16] ;
  assign psdStatus__h14272 = { 31'd0, hasDebugLogic } ;
  assign rdat__h14559 = hasDebugLogic ? { 16'd0, x__h14563 } : 32'd0 ;
  assign rdat__h14659 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h14673 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h14681 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h14687 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h14701 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h14709 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h14715 = hasDebugLogic ? x_fftFrameCounts__h12700 : 32'd0 ;
  assign result__h13478 = { ~dReal__h13417[15], dReal__h13417[14:0] } ;
  ...
  assign wsiS_reqFifo_notFull__03_AND_wsiS_burstKind_83_ETC___d423 =
	     ...
	     (wsiS_burstKind == 2'd0 ||
	      ...
	      wsiS_wsiReq$wget[57]) ;
  assign x__h13449 = psdCtrl[4] ? result__h13478 : dReal__h13417 ;
  assign x__h14563 = { wsiS_statusR, wsiM_statusR } ;
  assign x__h7360 = w2p_dataF_rRdPtr + 13'd1 ;
  assign x__h7468 =
	     CAN_FIRE_RL_w2p_imprecise_enq ? w2p_inF$D_OUT[43:12] : 32'd0 ;
  assign x_data__h13285 =
	     { IF_IF_fft_xkF_first__25_BIT_31_26_THEN_NEG_fft_ETC___d646 -
	       IF_IF_fft_xkF_first__25_BIT_31_26_THEN_NEG_fft_ETC___d140,
	       evenMag } ;
  assign x_data__h7890 =
	     (w2p_dataF_rCache[45] &&
	      w2p_dataF_rCache[44:32] == w2p_dataF_rRdPtr) ?
	       w2p_dataF_rCache[31:0] :
	       w2p_dataF_memory$DOB ;
  assign x_fftFrameCounts__h12700 = { fft_loadFrames, fft_unloadFrames } ;
  always@(wci_reqF$D_OUT or
	  psdStatus__h14272 or
	  psdCtrl or
	  rdat__h14559 or
	  rdat__h14659 or
	  rdat__h14673 or
	  rdat__h14681 or
	  rdat__h14687 or rdat__h14701 or rdat__h14709 or rdat__h14715)
  begin
    case (wci_reqF$D_OUT[51:32])
      20'h0: x_data__h14529 = psdStatus__h14272;
      20'h00004: x_data__h14529 = psdCtrl;
      20'h00010: x_data__h14529 = rdat__h14559;
      20'h00014: x_data__h14529 = rdat__h14659;
      20'h00018: x_data__h14529 = rdat__h14673;
      20'h0001C: x_data__h14529 = rdat__h14681;
      20'h00020: x_data__h14529 = rdat__h14687;
      20'h00024: x_data__h14529 = rdat__h14701;
      20'h00028: x_data__h14529 = rdat__h14709;
      20'h0002C: x_data__h14529 = rdat__h14715;
      default: x_data__h14529 = 32'd0;
    endcase
  end
  ...
  begin
    ...
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wci_ctrl_IsO)
	$display("[%0d]: %m: Starting PSD psdCtrl:%0x", v__h14395, psdCtrl);
    if (wciS0_MReset_n)
