...
//
// On Thu Jun 24 17:17:39 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkPSD(wciS0_Clk,
  ...
  reg [63 : 0] v__h2623, v__h2770, v__h3669, v__h9233;
  reg [31 : 0] x_data__h9365;
  wire [31 : 0] psdStatus__h9110,
		rdat__h9389,
		rdat__h9489,
		rdat__h9503,
		rdat__h9511,
		...
		rdat__h9539;
  wire [15 : 0] x__h9393;
  wire NOT_wsiS_reqFifo_countReg_02_ULE_1_03___d204;
  ...
  assign wsiS0_SThreadBusy =
	     NOT_wsiS_reqFifo_countReg_02_ULE_1_03___d204 ||
	     wsiS_isReset$VAL ||
	     !wsiS_operateD ||
	     !wsiS_peerIsReady ;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, x_data__h9365 } ;
  ...
  assign wsiS_reqFifo_r_deq$whas = CAN_FIRE_RL_psdpass_doMessagePush ;
  ...
  assign wsiM_reqFifo_enqueueing$whas = CAN_FIRE_RL_psdpass_doMessagePush ;
  assign wsiM_reqFifo_x_wire$wget = wsiS_reqFifo$D_OUT ;
  assign wsiM_reqFifo_x_wire$whas = CAN_FIRE_RL_psdpass_doMessagePush ;
  ...
  assign wsiS_reqFifo$DEQ = CAN_FIRE_RL_psdpass_doMessagePush ;
  assign wsiS_reqFifo$ENQ = CAN_FIRE_RL_wsiS_reqFifo_enq ;
  assign wsiS_reqFifo$CLR = 1'b0 ;

  // remaining internal signals
  assign NOT_wsiS_reqFifo_countReg_02_ULE_1_03___d204 =
	     wsiS_reqFifo_countReg > 2'd1 ;
  assign psdStatus__h9110 = { 31'd0, hasDebugLogic } ;
  assign rdat__h9389 = hasDebugLogic ? { 16'd0, x__h9393 } : 32'd0 ;
  assign rdat__h9489 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h9503 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h9511 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h9517 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h9531 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h9539 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign x__h9393 = { wsiS_statusR, wsiM_statusR } ;
  always@(wci_reqF$D_OUT or
	  ...
	  rdat__h9489 or
	  rdat__h9503 or
	  rdat__h9511 or rdat__h9517 or rdat__h9531 or rdat__h9539)
  begin
    case (wci_reqF$D_OUT[51:32])
      20'h0: x_data__h9365 = psdStatus__h9110;
      20'h00004: x_data__h9365 = psdCtrl;
      20'h00010: x_data__h9365 = rdat__h9389;
      20'h00014: x_data__h9365 = rdat__h9489;
      20'h00018: x_data__h9365 = rdat__h9503;
      20'h0001C: x_data__h9365 = rdat__h9511;
      20'h00020: x_data__h9365 = rdat__h9517;
      20'h00024: x_data__h9365 = rdat__h9531;
      20'h00028: x_data__h9365 = rdat__h9539;
      default: x_data__h9365 = 32'd0;
    endcase
  end
