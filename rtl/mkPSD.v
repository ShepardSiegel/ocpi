...
//
// On Thu Jun 24 11:20:32 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkPSD(wciS0_Clk,
  ...
  reg [63 : 0] v__h2623, v__h2770, v__h3669, v__h9208;
  reg [31 : 0] x_data__h9341;
  wire [31 : 0] psdStatus__h9085,
		rdat__h9365,
		rdat__h9465,
		rdat__h9479,
		rdat__h9487,
		...
		rdat__h9515;
  wire [15 : 0] x__h9369;
  wire NOT_wsiS_reqFifo_countReg_99_ULE_1_00___d201;
  ...
  assign wsiS0_SThreadBusy =
	     NOT_wsiS_reqFifo_countReg_99_ULE_1_00___d201 ||
	     wsiS_isReset$VAL ||
	     !wsiS_operateD ||
	     !wsiS_peerIsReady ;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, x_data__h9341 } ;
  ...
  assign wsiM_reqFifo_enqueueing$whas = CAN_FIRE_RL_wsipass_doMessagePush ;
  assign wsiM_reqFifo_x_wire$wget = wsiS_reqFifo$D_OUT ;
  assign wsiM_reqFifo_dequeueing$whas = CAN_FIRE_RL_wsiM_reqFifo_deq ;
  assign wsiM_reqFifo_x_wire$whas = CAN_FIRE_RL_wsipass_doMessagePush ;
  ...
  // remaining internal signals
  assign NOT_wsiS_reqFifo_countReg_99_ULE_1_00___d201 =
	     wsiS_reqFifo_countReg > 2'd1 ;
  assign psdStatus__h9085 = { 31'd0, hasDebugLogic } ;
  assign rdat__h9365 = hasDebugLogic ? { 16'd0, x__h9369 } : 32'd0 ;
  assign rdat__h9465 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h9479 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h9487 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h9493 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h9507 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h9515 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign x__h9369 = { wsiS_statusR, wsiM_statusR } ;
  always@(wci_reqF$D_OUT or
	  ...
	  rdat__h9465 or
	  rdat__h9479 or
	  rdat__h9487 or rdat__h9493 or rdat__h9507 or rdat__h9515)
  begin
    case (wci_reqF$D_OUT[51:32])
      20'h0: x_data__h9341 = psdStatus__h9085;
      20'h00004: x_data__h9341 = psdCtrl;
      20'h00010: x_data__h9341 = rdat__h9365;
      20'h00014: x_data__h9341 = rdat__h9465;
      20'h00018: x_data__h9341 = rdat__h9479;
      20'h0001C: x_data__h9341 = rdat__h9487;
      20'h00020: x_data__h9341 = rdat__h9493;
      20'h00024: x_data__h9341 = rdat__h9507;
      20'h00028: x_data__h9341 = rdat__h9515;
      default: x_data__h9341 = 32'd0;
    endcase
  end
