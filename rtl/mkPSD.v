...
//
// On Sun Jun 27 07:16:50 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkPSD(wciS0_Clk,
  ...
  reg [63 : 0] v__h12974, v__h2623, v__h2770, v__h3669;
  reg [31 : 0] x_data__h13106;
  wire [31 : 0] psdStatus__h12851,
		rdat__h13130,
		rdat__h13230,
		rdat__h13244,
		rdat__h13252,
		...
		x__h7029,
		x_data__h7451;
  wire [15 : 0] w2p_wordsExact_76_MINUS_1___d565, x__h13134;
  wire [12 : 0] x__h6921;
  wire NOT_w2p_dataF_rRdPtr_59_PLUS_2048_87_EQ_w2p_da_ETC___d297,
       NOT_wsiS_reqFifo_countReg_34_ULE_1_35___d336,
       w2p_wordsDequed_75_EQ_w2p_wordsExact_76_MINUS__ETC___d532,
       w2p_wordsEnqued_91_EQ_w2p_wordsExact_76_MINUS__ETC___d595;
  ...
  assign CAN_FIRE_RL_psdPrecise_output =
	     ...
	     wci_cState == 3'd2 &&
	     psdCtrl[3:0] == 4'h1 ;
  assign WILL_FIRE_RL_psdPrecise_output = CAN_FIRE_RL_psdPrecise_output ;
  ...
  assign CAN_FIRE_RL_w2p_imprecise_enq =
	     NOT_w2p_dataF_rRdPtr_59_PLUS_2048_87_EQ_w2p_da_ETC___d297 &&
	     w2p_operateW$whas ;
  ...
  assign CAN_FIRE_RL_psdFFT_doIngress =
	     wsiS_reqFifo$EMPTY_N && fft_xnF$FULL_N && wci_cState == 3'd2 &&
	     psdCtrl[3:0] == 4'h2 ;
  ...
  always@(MUX_wsiM_reqFifo_x_wire$wset_1__SEL_1 or
	  ...
	  WILL_FIRE_RL_psdPrecise_output or
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, x_data__h13106 } ;
  ...
  // submodule fft_xnF
  assign fft_xnF$D_IN = { 1'd1, wsiS_reqFifo$D_OUT[27:12], 16'd0 } ;
  ...
  assign w2p_outF$D_IN =
	     { 3'd1,
	       ...
	       4'd15,
	       w2p_reqF$D_OUT } ;
  assign w2p_outF$DEQ = CAN_FIRE_RL_psdPrecise_output ;
  ...
  // remaining internal signals
  assign NOT_w2p_dataF_rRdPtr_59_PLUS_2048_87_EQ_w2p_da_ETC___d297 =
	     w2p_dataF_rRdPtr + 13'd2048 != w2p_dataF_rWrPtr &&
	     w2p_inF$EMPTY_N &&
	     (!w2p_wordsEnqued_91_EQ_w2p_wordsExact_76_MINUS__ETC___d595 ||
	      w2p_reqF$FULL_N) ;
  assign NOT_wsiS_reqFifo_countReg_34_ULE_1_35___d336 =
	     wsiS_reqFifo_countReg > 2'd1 ;
  assign psdStatus__h12851 = { 31'd0, hasDebugLogic } ;
  assign rdat__h13130 = hasDebugLogic ? { 16'd0, x__h13134 } : 32'd0 ;
  assign rdat__h13230 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h13244 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h13252 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h13258 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h13272 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h13280 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign w2p_wordsDequed_75_EQ_w2p_wordsExact_76_MINUS__ETC___d532 =
	     w2p_wordsDequed == w2p_wordsExact_76_MINUS_1___d565 ;
  assign w2p_wordsEnqued_91_EQ_w2p_wordsExact_76_MINUS__ETC___d595 =
	     w2p_wordsEnqued == w2p_wordsExact_76_MINUS_1___d565 ;
  assign w2p_wordsExact_76_MINUS_1___d565 = w2p_wordsExact - 16'd1 ;
  assign x__h13134 = { wsiS_statusR, wsiM_statusR } ;
  ...
  always@(wci_reqF$D_OUT or
	  psdStatus__h12851 or
	  psdCtrl or
	  rdat__h13130 or
	  rdat__h13230 or
	  rdat__h13244 or
	  rdat__h13252 or rdat__h13258 or rdat__h13272 or rdat__h13280)
  begin
    case (wci_reqF$D_OUT[51:32])
      20'h0: x_data__h13106 = psdStatus__h12851;
      20'h00004: x_data__h13106 = psdCtrl;
      20'h00010: x_data__h13106 = rdat__h13130;
      20'h00014: x_data__h13106 = rdat__h13230;
      20'h00018: x_data__h13106 = rdat__h13244;
      20'h0001C: x_data__h13106 = rdat__h13252;
      20'h00020: x_data__h13106 = rdat__h13258;
      20'h00024: x_data__h13106 = rdat__h13272;
      20'h00028: x_data__h13106 = rdat__h13280;
      default: x_data__h13106 = 32'd0;
    endcase
  end
