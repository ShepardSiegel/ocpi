...
//
// On Fri Jan 14 16:47:40 EST 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkPSD(wciS0_Clk,
  ...
  wire [15 : 0] IF_IF_fft_xkF_first__78_BIT_31_79_THEN_NEG_fft_ETC___d664,
		IF_fft_xkF_first__78_BIT_15_83_THEN_NEG_fft_xk_ETC___d661,
		IF_fft_xkF_first__78_BIT_31_79_THEN_NEG_fft_xk_ETC___d662,
		dReal__h14120,
		result__h14187,
		w2p_wordsExact_66_MINUS_1___d663,
		x__h14152,
		x__h15060;
  wire [12 : 0] x__h7850;
  wire NOT_w2p_dataF_rRdPtr_48_EQ_w2p_dataF_rWrPtr_39_ETC___d290,
       NOT_w2p_dataF_rRdPtr_48_PLUS_2048_61_EQ_w2p_da_ETC___d273,
       w2p_wordsDequed_94_EQ_w2p_wordsExact_66_MINUS__ETC___d623,
       w2p_wordsEnqued_65_EQ_w2p_wordsExact_66_MINUS__ETC___d612,
  ...
  always@(MUX_wsiM_reqFifo_x_wire$wset_1__SEL_1 or
	  ...
	  w2p_outF$D_OUT or
	  MUX_wsiS_reqFifo_levelsValid$write_1__SEL_3 or wsiS_reqFifo$D_OUT)
  begin
    case (1'b1) // synopsys parallel_case
      MUX_wsiM_reqFifo_x_wire$wset_1__SEL_1:
	  MUX_wsiM_reqFifo_q_0$write_1__VAL_2 =
  ...
  // register evenMag
  assign evenMag$D_IN =
	     IF_IF_fft_xkF_first__78_BIT_31_79_THEN_NEG_fft_ETC___d664 -
	     (IF_IF_fft_xkF_first__78_BIT_31_79_THEN_NEG_fft_ETC___d664 >>
	      4) ;
  ...
  // remaining internal signals
  assign IF_IF_fft_xkF_first__78_BIT_31_79_THEN_NEG_fft_ETC___d664 =
	     (IF_fft_xkF_first__78_BIT_31_79_THEN_NEG_fft_xk_ETC___d662 <=
	      IF_fft_xkF_first__78_BIT_15_83_THEN_NEG_fft_xk_ETC___d661) ?
	       (IF_fft_xkF_first__78_BIT_31_79_THEN_NEG_fft_xk_ETC___d662 >>
		1) +
	       ...
	       (IF_fft_xkF_first__78_BIT_15_83_THEN_NEG_fft_xk_ETC___d661 >>
		1) ;
  assign IF_fft_xkF_first__78_BIT_15_83_THEN_NEG_fft_xk_ETC___d661 =
	     fft_xkF$D_OUT[15] ? -fft_xkF$D_OUT[15:0] : fft_xkF$D_OUT[15:0] ;
  assign IF_fft_xkF_first__78_BIT_31_79_THEN_NEG_fft_xk_ETC___d662 =
	     fft_xkF$D_OUT[31] ?
	       -fft_xkF$D_OUT[31:16] :
	       fft_xkF$D_OUT[31:16] ;
  ...
  assign w2p_wordsDequed_94_EQ_w2p_wordsExact_66_MINUS__ETC___d623 =
	     w2p_wordsDequed == w2p_wordsExact_66_MINUS_1___d663 ;
  assign w2p_wordsEnqued_65_EQ_w2p_wordsExact_66_MINUS__ETC___d612 =
	     w2p_wordsEnqued == w2p_wordsExact_66_MINUS_1___d663 ;
  assign w2p_wordsExact_66_MINUS_1___d663 = w2p_wordsExact - 16'd1 ;
  ...
  begin
    case (wci_wslv_reqF$D_OUT[51:32])
      20'h0: g_data__h15032 = psdStatus__h14730;
      20'h00004: g_data__h15032 = psdCtrl;
      20'h00010: g_data__h15032 = rdat__h15056;
      20'h00014: g_data__h15032 = rdat__h15156;
      20'h00018: g_data__h15032 = rdat__h15170;
      20'h0001C: g_data__h15032 = rdat__h15178;
      20'h00020: g_data__h15032 = rdat__h15184;
      20'h00024: g_data__h15032 = rdat__h15198;
      20'h00028: g_data__h15032 = rdat__h15206;
      20'h0002C: g_data__h15032 = rdat__h15212;
