...
//
// On Fri Jun 25 14:33:19 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkPSD(wciS0_Clk,
  ...
  reg [63 : 0] v__h10884, v__h2623, v__h2770, v__h3669;
  reg [31 : 0] x_data__h11016;
  wire [31 : 0] psdStatus__h10761,
		rdat__h11040,
		rdat__h11140,
		rdat__h11154,
		rdat__h11162,
		...
		rdat__h11190;
  wire [15 : 0] x__h11044;
  wire NOT_wsiS_reqFifo_countReg_60_ULE_1_61___d262;
  ...
  assign wsiS0_SThreadBusy =
	     NOT_wsiS_reqFifo_countReg_60_ULE_1_61___d262 ||
	     wsiS_isReset$VAL ||
	     !wsiS_operateD ||
	     !wsiS_peerIsReady ;
  ...
  assign MUX_wsiM_reqFifo_x_wire$wset_1__PSEL_1 =
	     ...
	     wci_cState == 3'd2 &&
	     psdCtrl[3:0] == 4'h1 ;
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, x_data__h11016 } ;
  ...
  // remaining internal signals
  assign NOT_wsiS_reqFifo_countReg_60_ULE_1_61___d262 =
	     wsiS_reqFifo_countReg > 2'd1 ;
  assign psdStatus__h10761 = { 31'd0, hasDebugLogic } ;
  assign rdat__h11040 = hasDebugLogic ? { 16'd0, x__h11044 } : 32'd0 ;
  assign rdat__h11140 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h11154 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h11162 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h11168 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h11182 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h11190 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign x__h11044 = { wsiS_statusR, wsiM_statusR } ;
  always@(wci_reqF$D_OUT or
	  psdStatus__h10761 or
	  psdCtrl or
	  rdat__h11040 or
	  rdat__h11140 or
	  rdat__h11154 or
	  rdat__h11162 or rdat__h11168 or rdat__h11182 or rdat__h11190)
  begin
    case (wci_reqF$D_OUT[51:32])
      20'h0: x_data__h11016 = psdStatus__h10761;
      20'h00004: x_data__h11016 = psdCtrl;
      20'h00010: x_data__h11016 = rdat__h11040;
      20'h00014: x_data__h11016 = rdat__h11140;
      20'h00018: x_data__h11016 = rdat__h11154;
      20'h0001C: x_data__h11016 = rdat__h11162;
      20'h00020: x_data__h11016 = rdat__h11168;
      20'h00024: x_data__h11016 = rdat__h11182;
      20'h00028: x_data__h11016 = rdat__h11190;
      default: x_data__h11016 = 32'd0;
    endcase
  end
  ...
  begin
    ...
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wci_ctrl_IsO)
	$display("[%0d]: %m: Starting PSD psdCtrl:%0x", v__h10884, psdCtrl);
    if (wciS0_MReset_n)
