...
//
// On Thu Oct 31 09:24:41 EDT 2013
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter8B(wciS0_Clk,
  ...
  assign MUX_wci_wslv_respF_x_wire_wset_1__VAL_2 = { 2'd1, g_data__h23912 } ;
  assign MUX_wmi_dhF_cntr_r_write_1__VAL_2 = wmi_dhF_cntr_r + 2'd1 ;
  assign MUX_wmi_dhF_q_0_write_1__VAL_1 =
	     { 1'd1, wsiS_reqFifo_D_OUT[93], wsiS_reqFifo_D_OUT[79:8] } ;
  assign MUX_wmi_dhF_q_0_write_1__VAL_2 =
	     (wmi_dhF_cntr_r == 2'd1) ?
	       MUX_wmi_dhF_q_0_write_1__VAL_1 :
	       wmi_dhF_q_1 ;
  assign MUX_wmi_dhF_q_1_write_1__VAL_2 =
	     (wmi_dhF_cntr_r == 2'd2) ?
	       MUX_wmi_dhF_q_0_write_1__VAL_1 :
	       74'd0 ;
  ...
  assign MUX_wmi_reqF_x_wire_wset_1__VAL_2 =
	     { 4'd3, wsiS_reqFifo_D_OUT[93], 1'b0, mesgLengthSoFar, 12'd1 } ;
  ...
  assign MUX_wsiM_reqFifo_q_0_write_1__VAL_2 =
	     (wsiM_reqFifo_cntr_r == 2'd1) ?
	       MUX_wsiM_reqFifo_q_0_write_1__VAL_1 :
	       wsiM_reqFifo_q_1 ;
  assign MUX_wsiM_reqFifo_q_1_write_1__VAL_2 =
  ...
  assign wmi_dhF_x_wire_wget = MUX_wmi_dhF_q_0_write_1__VAL_1 ;
  ...
  assign wsiM_reqFifo_x_wire_wget = MUX_wsiM_reqFifo_q_0_write_1__VAL_1 ;
  ...
  // register errCount
  assign errCount_D_IN = errCount + 64'd1 ;
  assign errCount_EN =
	     MUX_wsiS_reqFifo_levelsValid_write_1__SEL_3 &&
	     wsiS_reqFifo_D_OUT[79:16] != valExpect &&
	     (!wsiS_reqFifo_D_OUT[93] || wsiS_reqFifo_D_OUT[15:8] != 8'd0 ||
  ...
  assign respF_rCache_D_IN =
	     { 1'd1,
	       ...
	       respF_pwEnqueue_whas && respF_wDataIn_wget[93],
	       respF_pwEnqueue_whas && respF_wDataIn_wget[92],
  ...
  // register valExpect
  assign valExpect_D_IN = valExpect + 64'd1 ;
  assign valExpect_EN =
	     MUX_wsiS_reqFifo_levelsValid_write_1__SEL_3 &&
	     (!wsiS_reqFifo_D_OUT[93] || wsiS_reqFifo_D_OUT[15:8] != 8'd0 ||
	      mesgLengthSoFar != 14'd0) ;
  ...
  always@(MUX_wmi_dhF_q_1_write_1__SEL_1 or
	  ...
	  MUX_wmi_dhF_q_1_write_1__VAL_2 or WILL_FIRE_RL_wmi_dhF_decCtr)
  begin
    case (1'b1) // synopsys parallel_case
      MUX_wmi_dhF_q_1_write_1__SEL_1:
	  wmi_dhF_q_1_D_IN = MUX_wmi_dhF_q_0_write_1__VAL_1;
      MUX_wmi_dhF_q_1_write_1__SEL_2:
	  wmi_dhF_q_1_D_IN = MUX_wmi_dhF_q_1_write_1__VAL_2;
      WILL_FIRE_RL_wmi_dhF_decCtr: wmi_dhF_q_1_D_IN = 74'd0;
  ...
  always@(MUX_wsiM_reqFifo_q_1_write_1__SEL_1 or
	  ...
	  MUX_wsiM_reqFifo_q_1_write_1__VAL_2 or
	  WILL_FIRE_RL_wsiM_reqFifo_decCtr)
  begin
    case (1'b1) // synopsys parallel_case
      MUX_wsiM_reqFifo_q_1_write_1__SEL_1:
	  wsiM_reqFifo_q_1_D_IN = MUX_wsiM_reqFifo_q_0_write_1__VAL_1;
      MUX_wsiM_reqFifo_q_1_write_1__SEL_2:
  ...
  assign wmi_respF_ENQ =
	     ...
	     wmi_wmiResponse_wget[65:64] != 2'd0 ;
  ...
  assign IF_respF_wDataIn_whas__28_THEN_respF_wDataIn_w_ETC___d431 =
	     respF_pwEnqueue_whas ? respF_wDataIn_wget[96:94] : 3'd0 ;
  assign IF_respF_wDataIn_whas__28_THEN_respF_wDataIn_w_ETC___d437 =
	     respF_pwEnqueue_whas ? respF_wDataIn_wget[91:0] : 92'd0 ;
  ...
  assign rdat__h24103 = hasDebugLogic ? wsiS_extStatusW_wget[95:64] : 32'd0 ;
  assign rdat__h24117 = hasDebugLogic ? wsiS_extStatusW_wget[63:32] : 32'd0 ;
  assign rdat__h24125 = hasDebugLogic ? wsiS_extStatusW_wget[31:0] : 32'd0 ;
  assign rdat__h24131 = hasDebugLogic ? wsiM_extStatusW_wget[95:64] : 32'd0 ;
  assign rdat__h24145 = hasDebugLogic ? wsiM_extStatusW_wget[63:32] : 32'd0 ;
  assign rdat__h24153 = hasDebugLogic ? wsiM_extStatusW_wget[31:0] : 32'd0 ;
  ...
  assign wsiS_reqFifo_i_notEmpty__61_AND_NOT_smaCtrl_62_ETC___d667 =
	     ...
	     (!wsiS_reqFifo_D_OUT[93] || wmi_mFlagF_cntr_r != 2'd2) ;
  ...
  assign x__h22483 = { 3'd0, wsiS_reqFifo_D_OUT[15] } ;
  ...
  assign y__h22412 = { 3'd0, wsiS_reqFifo_D_OUT[8] } ;
  assign y__h22424 = { 3'd0, wsiS_reqFifo_D_OUT[9] } ;
  assign y__h22436 = { 3'd0, wsiS_reqFifo_D_OUT[10] } ;
  assign y__h22448 = { 3'd0, wsiS_reqFifo_D_OUT[11] } ;
  assign y__h22460 = { 3'd0, wsiS_reqFifo_D_OUT[12] } ;
  assign y__h22472 = { 3'd0, wsiS_reqFifo_D_OUT[13] } ;
  assign y__h22484 = { 3'd0, wsiS_reqFifo_D_OUT[14] } ;
  ...
  begin
	...
	$display("[%0d]: %m: wmrd_mesgBegin mesgCount:%0h mesgLength:%0h reqInfo:%0h",
		 ...
		 wmi_sFlagReg[31:24]);
    if (wciS0_MReset_n != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_wmwt_mesgBegin && wsiS_reqFifo_D_OUT[92])
	begin
	  v__h21792 = $time;
	  #0;
	end
