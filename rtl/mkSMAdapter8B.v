...
//
// On Thu Jun 10 12:52:28 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter8B(wciS0_Clk,
  ...
  wire [7 : 0] mesgMetaF_opcode__h16809, x_byteEn__h18563;
  wire [3 : 0] b__h13937;
  ...
  assign MUX_wmi_dhF_x_wire$wset_1__VAL_2 =
	     { 1'd1, x__h16715, wsiS_reqFifo$D_OUT[79:16], 8'd255 } ;
  ...
  assign bl__h17580 =
	     zeroLengthMesg ?
	       12'd1 :
	       { 1'd0,
		 IF_mesgLength_22_BIT_14_23_THEN_mesgLength_22__ETC___d755[13:3] } ;
  ...
  assign x_byteEn__h18563 = (thisMesg[15:0] == 16'd0) ? 8'd0 : 8'd255 ;
