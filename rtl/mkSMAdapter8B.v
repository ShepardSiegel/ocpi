...
//
// On Tue Aug 10 13:51:18 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter8B(wciS0_Clk,
  ...
  wire [7 : 0] mesgMetaF_opcode__h17559, x_byteEn__h19430;
  wire [3 : 0] b__h14493;
  ...
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_3 =
	     { 4'd3, wsiS_reqFifo$D_OUT[93], 1'b0, addr__h17407, 12'd1 } ;
  ...
  assign addr__h17407 = { mesgLengthSoFar[10:0], 3'd0 } ;
  ...
  assign mlp1B__h17391 = { mlp1__h17390[10:0], 3'd0 } ;
  ...
  assign x_byteEn__h19430 = (thisMesg[15:0] == 16'd0) ? 8'd0 : 8'd255 ;
