...
//
// On Fri Dec 17 14:58:28 EST 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter8B(wciS0_Clk,
  ...
  reg [63 : 0] v__h16535,
	       ...
	       v__h3767,
	       v__h3922;
  reg [31 : 0] value__h6113, x_data__h20329;
  wire [31 : 0] rdat__h20378,
		rdat__h20384,
		rdat__h20390,
		rdat__h20403,
		rdat__h20426,
		...
		rdat__h20568,
		rdat__h20576;
  wire [23 : 0] mesgMetaF_length__h18307, mesgMetaF_length__h19043;
  wire [15 : 0] wsiBurstLength__h16997, x__h20430, x_length__h18061;
  wire [13 : 0] addr__h18913,
		b__h16619,
		mlp1B__h18897,
		mlp1__h18896,
		x__h18079;
  wire [11 : 0] b__h14502, bl__h18168, x1_burstLength__h17056;
  wire [7 : 0] x1_byteEn__h17058, x__h18065;
  wire NOT_wmi_reqF_c_r_39_EQ_2_58_59_AND_wmi_operate_ETC___d476,
       wmi_operateD_25_AND_wmi_peerIsReady_26_27_AND__ETC___d571,
       wsiS_reqFifo_i_notEmpty__23_AND_NOT_smaCtrl_24_ETC___d590,
  ...
  assign CAN_FIRE_RL_wmrd_mesgBodyRequest =
	     NOT_wmi_reqF_c_r_39_EQ_2_58_59_AND_wmi_operate_ETC___d476 &&
	     wci_cState == 3'd2 &&
	     (smaCtrl[3:0] == 4'h1 || smaCtrl[3:0] == 4'h4 ||
	      smaCtrl[3:0] == 4'h9) &&
	     mesgPreRequest ;
  ...
  assign MUX_wmi_mFlagF_x_wire$wset_1__SEL_1 =
	     WILL_FIRE_RL_wmrd_mesgBodyRequest && x__h16790 ;
  ...
  assign MUX_mesgLength$write_1__VAL_3 = { 1'd1, mlp1B__h18897 } ;
  ...
  assign MUX_thisMesg$write_1__VAL_1 =
	     { mesgCount[7:0], x__h18065, x_length__h18061 } ;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, x_data__h20329 } ;
  ...
  assign MUX_wmi_mFlagF_x_wire$wset_1__VAL_2 =
	     { x__h18065, mesgMetaF_length__h19043 } ;
  assign MUX_wmi_mFlagF_x_wire$wset_1__VAL_3 =
	     { x__h18065, mesgMetaF_length__h18307 } ;
  ...
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_1 =
	     { 4'd5, x__h16790, 1'b0, mesgReqAddr, fabWordsCurReq[11:0] } ;
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_2 = { 20'd229376, bl__h18168 } ;
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_3 =
	     { 4'd3, wsiS_reqFifo$D_OUT[93], 1'b0, addr__h18913, 12'd1 } ;
  ...
  assign fabWordsCurReq$D_IN =
	     (fabWordsRemain <= b__h16619) ? fabWordsRemain : b__h16619 ;
  ...
  // remaining internal signals
  assign NOT_wmi_reqF_c_r_39_EQ_2_58_59_AND_wmi_operate_ETC___d476 =
	     wmi_reqF_c_r != 2'd2 && wmi_operateD && wmi_peerIsReady &&
	     (!x__h16790 || wmi_mFlagF_c_r != 2'd2) ;
  assign addr__h18913 = { mesgLengthSoFar[10:0], 3'd0 } ;
  assign b__h14502 = -fabWordsCurReq[11:0] ;
  assign b__h16619 = { {2{fabRespCredit_value[11]}}, fabRespCredit_value } ;
  assign bl__h18168 = zeroLengthMesg ? 12'd1 : { 1'd0, x__h18079[13:3] } ;
  assign mesgMetaF_length__h18307 = { 10'd0, x__h18079 } ;
  assign mesgMetaF_length__h19043 = { 10'd0, mlp1B__h18897 } ;
  assign mlp1B__h18897 = { mlp1__h18896[10:0], 3'd0 } ;
  assign mlp1__h18896 = MUX_mesgLengthSoFar$write_1__VAL_2 ;
  assign rdat__h20378 = hasDebugLogic ? mesgCount : 32'd0 ;
  assign rdat__h20384 = hasDebugLogic ? abortCount : 32'd0 ;
  assign rdat__h20390 = hasDebugLogic ? thisMesg : 32'd0 ;
  assign rdat__h20403 = hasDebugLogic ? lastMesg : 32'd0 ;
  assign rdat__h20426 = hasDebugLogic ? { 16'd0, x__h20430 } : 32'd0 ;
  assign rdat__h20526 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h20540 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h20548 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h20554 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h20568 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h20576 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign wmi_operateD_25_AND_wmi_peerIsReady_26_27_AND__ETC___d571 =
	     wmi_operateD && wmi_peerIsReady && wsiS_reqFifo$EMPTY_N &&
	     (smaCtrl[3:0] != 4'h3 || wsiM_reqFifo_c_r != 2'd2) ;
  assign wsiBurstLength__h16997 =
	     smaCtrl[5] ? 16'd2 : { 3'd0, thisMesg[15:3] } ;
  assign wsiS_reqFifo_i_notEmpty__23_AND_NOT_smaCtrl_24_ETC___d590 =
	     wsiS_reqFifo$EMPTY_N &&
	     (smaCtrl[3:0] != 4'h3 || wsiM_reqFifo_c_r != 2'd2) &&
  ...
  assign wsiS_reqFifo_notFull__59_AND_wsiS_burstKind_74_ETC___d381 =
	     ...
	     (wsiS_burstKind == 2'd0 ||
	      ...
	      wsiS_wsiReq$wget[93]) ;
  assign x1_burstLength__h17056 =
	     (thisMesg[15:0] == 16'd0 || smaCtrl[5] && unrollCnt == 16'd1) ?
	       12'd1 :
	       (smaCtrl[5] ? 12'd4095 : wsiBurstLength__h16997[11:0]) ;
  assign x1_byteEn__h17058 = (thisMesg[15:0] == 16'd0) ? 8'd0 : 8'd255 ;
  assign x__h16790 = fabWordsRemain == fabWordsCurReq ;
  assign x__h18065 = opcode[8] ? opcode[7:0] : 8'd0 ;
  assign x__h18079 = mesgLength[14] ? mesgLength[13:0] : 14'd0 ;
  assign x__h20430 = { wsiS_statusR, wsiM_statusR } ;
  assign x_length__h18061 = { 2'd0, x__h18079 } ;
  always@(wci_reqF$D_OUT or
	  ...
	  rdat__h20526 or
	  rdat__h20540 or
	  rdat__h20548 or rdat__h20554 or rdat__h20568 or rdat__h20576)
  begin
    case (wci_reqF$D_OUT[39:32])
      8'h0: x_data__h20329 = smaCtrl;
      8'h04: x_data__h20329 = rdat__h20378;
      8'h08: x_data__h20329 = rdat__h20384;
      8'h10: x_data__h20329 = rdat__h20390;
      8'h14: x_data__h20329 = rdat__h20403;
      8'h18: x_data__h20329 = rdat__h20426;
      8'h20: x_data__h20329 = rdat__h20526;
      8'h24: x_data__h20329 = rdat__h20540;
      8'h28: x_data__h20329 = rdat__h20548;
      8'h2C: x_data__h20329 = rdat__h20554;
      8'h30: x_data__h20329 = rdat__h20568;
      8'h34: x_data__h20329 = rdat__h20576;
      default: x_data__h20329 = 32'd0;
    endcase
  end
  ...
  begin
    ...
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wmwt_doAbort)
	$display("[%0d]: %m: wmwt_doAbort", v__h19726);
    if (wciS0_MReset_n)
