...
//
// On Fri Oct 22 08:41:43 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter8B(wciS0_Clk,
  ...
  wire [96 : 0] respF$D_IN, respF$D_OUT;
  ...
  reg [63 : 0] v__h15925,
	       ...
	       v__h2801,
	       v__h3700;
  reg [31 : 0] value__h6079, x_data__h16058;
  wire [31 : 0] rdat__h16095,
		rdat__h16102,
		rdat__h16109,
		rdat__h16132,
		rdat__h16155,
		...
		rdat__h16297,
		rdat__h16305;
  wire [23 : 0] mesgMetaF_length__h17614, mesgMetaF_length__h18657;
  wire [15 : 0] wsiBurstLength__h19518, x__h16159, x_length__h17891;
  wire [13 : 0] IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d791,
		addr__h17461,
		b__h20115,
		mlp1B__h17445,
		mlp1__h17444;
  wire [11 : 0] bl__h18513, x1_burstLength__h19590;
  wire [7 : 0] mesgMetaF_opcode__h17613, x1_byteEn__h19592;
  wire [4 : 0] b__h14495;
  wire NOT_wmi_reqF_c_r_57_EQ_2_58_59_AND_wmi_operate_ETC___d315,
       wmi_operateD_63_AND_wmi_peerIsReady_64_65_AND__ETC___d221,
       wsiS_reqFifo_i_notEmpty__66_AND_NOT_smaCtrl_3__ETC___d180,
       wsiS_reqFifo_notFull__96_AND_wsiS_burstKind_76_ETC___d416,
       x__h19915;
  ...
  assign CAN_FIRE_RL_wmrd_mesgBodyRequest =
	     NOT_wmi_reqF_c_r_57_EQ_2_58_59_AND_wmi_operate_ETC___d315 &&
	     wci_cState == 3'd2 &&
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_1 = { 2'd1, x_data__h16058 } ;
  ...
  assign MUX_mesgLength$write_1__VAL_4 = { 1'd1, mlp1B__h17445 } ;
  ...
  assign MUX_wmi_mFlagF_x_wire$wset_1__VAL_1 =
	     { mesgMetaF_opcode__h17613, mesgMetaF_length__h17614 } ;
  assign MUX_wmi_reqF_c_r$write_1__VAL_2 = wmi_reqF_c_r + 2'd1 ;
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_3 =
	     { 4'd3, wsiS_reqFifo$D_OUT[93], 1'b0, addr__h17461, 12'd1 } ;
  ...
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_2 =
	     { 4'd5, x__h19915, 1'b0, mesgReqAddr, fabWordsCurReq[11:0] } ;
  assign MUX_wmi_mFlagF_x_wire$wset_1__SEL_2 =
	     WILL_FIRE_RL_wmrd_mesgBodyRequest && x__h19915 ;
  assign MUX_fabRespCredit_value$write_1__VAL_2 =
	     fabRespCredit_value +
	     (CAN_FIRE_RL_wmrd_mesgBodyRequest ? b__h14495 : 5'd0) +
  ...
  assign MUX_thisMesg$write_1__VAL_1 =
	     { mesgCount[7:0], mesgMetaF_opcode__h17613, x_length__h17891 } ;
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_1 = { 20'd229376, bl__h18513 } ;
  ...
  assign MUX_wmi_mFlagF_x_wire$wset_1__VAL_3 =
	     { mesgMetaF_opcode__h17613, mesgMetaF_length__h18657 } ;
  assign MUX_wmi_mFlagF_q_0$write_1__VAL_1 =
	     (wmi_mFlagF_c_r == 2'd1) ? value__h6079 : wmi_mFlagF_q_1 ;
  assign MUX_wmi_mFlagF_q_1$write_1__VAL_1 =
	     (wmi_mFlagF_c_r == 2'd2) ? value__h6079 : 32'd0 ;
  ...
  assign fabRespCredit_acc_v1$wget = b__h14495 ;
  ...
  assign wmi_mFlagF_x_wire$wget = value__h6079 ;
  ...
  assign fabWordsCurReq$D_IN =
	     (fabWordsRemain <= b__h20115) ? fabWordsRemain : b__h20115 ;
  ...
  assign mesgLengthSoFar$D_IN =
	     MUX_impreciseBurst$write_1__SEL_2 ? 14'd0 : mlp1__h17444 ;
  ...
  always@(WILL_FIRE_RL_wmi_mFlagF_both or
	  ...
	  value__h6079 or WILL_FIRE_RL_wmi_mFlagF_decCtr or wmi_mFlagF_q_1)
  begin
    case (1'b1) // synopsys parallel_case
      WILL_FIRE_RL_wmi_mFlagF_both:
	  wmi_mFlagF_q_0$D_IN = MUX_wmi_mFlagF_q_0$write_1__VAL_1;
      MUX_wmi_mFlagF_q_0$write_1__SEL_2: wmi_mFlagF_q_0$D_IN = value__h6079;
  ...
  always@(WILL_FIRE_RL_wmi_mFlagF_both or
	  ...
	  value__h6079 or WILL_FIRE_RL_wmi_mFlagF_decCtr)
  begin
    case (1'b1) // synopsys parallel_case
      WILL_FIRE_RL_wmi_mFlagF_both:
	  wmi_mFlagF_q_1$D_IN = MUX_wmi_mFlagF_q_1$write_1__VAL_1;
      MUX_wmi_mFlagF_q_1$write_1__SEL_2: wmi_mFlagF_q_1$D_IN = value__h6079;
  ...
  // remaining internal signals
  assign IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d791 =
	     mesgLength[14] ? mesgLength[13:0] : 14'd0 ;
  assign NOT_wmi_reqF_c_r_57_EQ_2_58_59_AND_wmi_operate_ETC___d315 =
	     wmi_reqF_c_r != 2'd2 && wmi_operateD && wmi_peerIsReady &&
	     (!x__h19915 || wmi_mFlagF_c_r != 2'd2) ;
  assign addr__h17461 = { mesgLengthSoFar[10:0], 3'd0 } ;
  assign b__h14495 = -fabWordsCurReq[4:0] ;
  assign b__h20115 = { {9{fabRespCredit_value[4]}}, fabRespCredit_value } ;
  assign bl__h18513 =
	     zeroLengthMesg ?
	       12'd1 :
	       { 1'd0,
		 IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d791[13:3] } ;
  assign mesgMetaF_length__h17614 = { 10'd0, mlp1B__h17445 } ;
  assign mesgMetaF_length__h18657 =
	     { 10'd0,
	       IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d791 } ;
  assign mesgMetaF_opcode__h17613 = opcode[8] ? opcode[7:0] : 8'd0 ;
  assign mlp1B__h17445 = { mlp1__h17444[10:0], 3'd0 } ;
  assign mlp1__h17444 = mesgLengthSoFar + 14'd1 ;
  assign rdat__h16095 = hasDebugLogic ? mesgCount : 32'd0 ;
  assign rdat__h16102 = hasDebugLogic ? abortCount : 32'd0 ;
  assign rdat__h16109 = hasDebugLogic ? thisMesg : 32'd0 ;
  assign rdat__h16132 = hasDebugLogic ? lastMesg : 32'd0 ;
  assign rdat__h16155 = hasDebugLogic ? { 16'd0, x__h16159 } : 32'd0 ;
  assign rdat__h16255 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h16269 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h16277 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h16283 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h16297 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h16305 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  ...
  assign wsiS_reqFifo_notFull__96_AND_wsiS_burstKind_76_ETC___d416 =
	     wsiS_reqFifo$FULL_N &&
	     (wsiS_burstKind == 2'd0 ||
	      (wsiS_burstKind == 2'd1 || wsiS_burstKind == 2'd2) &&
	      wsiS_wsiReq$wget[93]) ;
  assign x1_burstLength__h19590 =
	     (thisMesg[15:0] == 16'd0 || smaCtrl[5] && unrollCnt == 16'd1) ?
	       12'd1 :
	       (smaCtrl[5] ? 12'd4095 : wsiBurstLength__h19518[11:0]) ;
  assign x1_byteEn__h19592 = (thisMesg[15:0] == 16'd0) ? 8'd0 : 8'd255 ;
  assign x__h16159 = { wsiS_statusR, wsiM_statusR } ;
  assign x__h19915 = fabWordsRemain == fabWordsCurReq ;
  assign x_length__h17891 =
	     { 2'd0,
	       IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d791 } ;
  always@(wci_reqF$D_OUT or
	  ...
	  rdat__h16255 or
	  rdat__h16269 or
	  rdat__h16277 or rdat__h16283 or rdat__h16297 or rdat__h16305)
  begin
    case (wci_reqF$D_OUT[39:32])
      8'h0: x_data__h16058 = smaCtrl;
      8'h04: x_data__h16058 = rdat__h16095;
      8'h08: x_data__h16058 = rdat__h16102;
      8'h10: x_data__h16058 = rdat__h16109;
      8'h14: x_data__h16058 = rdat__h16132;
      8'h18: x_data__h16058 = rdat__h16155;
      8'h20: x_data__h16058 = rdat__h16255;
      8'h24: x_data__h16058 = rdat__h16269;
      8'h28: x_data__h16058 = rdat__h16277;
      8'h2C: x_data__h16058 = rdat__h16283;
      8'h30: x_data__h16058 = rdat__h16297;
      8'h34: x_data__h16058 = rdat__h16305;
      default: x_data__h16058 = 32'd0;
    endcase
  end
  always@(MUX_endOfMessage$write_1__SEL_1 or
  ...
  begin
    case (1'b1) // synopsys parallel_case
      MUX_endOfMessage$write_1__SEL_1:
	  value__h6079 = MUX_wmi_mFlagF_x_wire$wset_1__VAL_1;
      MUX_wmi_mFlagF_x_wire$wset_1__SEL_2:
	  value__h6079 = 32'hAAAAAAAA /* unspecified value */ ;
      WILL_FIRE_RL_wmwt_requestPrecise:
	  value__h6079 = MUX_wmi_mFlagF_x_wire$wset_1__VAL_3;
      default: value__h6079 = 32'hAAAAAAAA /* unspecified value */ ;
    endcase
  end
  ...
  begin
    ...
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wmwt_doAbort)
	$display("[%0d]: %m: wmwt_doAbort", v__h17106);
    if (wciS0_MReset_n)
