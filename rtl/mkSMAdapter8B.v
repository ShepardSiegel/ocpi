...
//
// On Tue Dec 28 17:12:14 EST 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter8B(wciS0_Clk,
  ...
  wire [31 : 0] rdat__h21436,
		...
		rdat__h21626,
		rdat__h21634;
  wire [23 : 0] mesgMetaF_length__h19381, mesgMetaF_length__h20117;
  wire [15 : 0] wsiBurstLength__h18046, x__h21488, x_length__h19135;
  wire [13 : 0] addr__h19987,
		b__h17668,
		mlp1B__h19971,
		mlp1__h19970,
		x__h19153;
  wire [11 : 0] b__h14480,
		bl__h19242,
		sendData_burstLength__h18128,
		x__h15834;
  wire [7 : 0] sendData_byteEn__h18130, x__h19139;
  ...
  assign MUX_wmi_mFlagF_x_wire$wset_1__SEL_1 =
	     WILL_FIRE_RL_wmrd_mesgBodyRequest && x__h17839 ;
  ...
  assign MUX_fabRespCredit_value$write_1__VAL_2 =
	     fabRespCredit_value +
	     (CAN_FIRE_RL_wmrd_mesgBodyRequest ? b__h14480 : 12'd0) +
  ...
  assign MUX_mesgLength$write_1__VAL_3 = { 1'd1, mlp1B__h19971 } ;
  ...
  assign MUX_thisMesg$write_1__VAL_1 =
	     { mesgCount[7:0], x__h19139, x_length__h19135 } ;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, g_data__h21393 } ;
  ...
  assign MUX_wmi_mFlagF_q_0$write_1__VAL_1 =
	     (wmi_mFlagF_c_r == 2'd1) ? value__h6091 : wmi_mFlagF_q_1 ;
  assign MUX_wmi_mFlagF_q_1$write_1__VAL_1 =
	     (wmi_mFlagF_c_r == 2'd2) ? value__h6091 : 32'd0 ;
  assign MUX_wmi_mFlagF_x_wire$wset_1__VAL_2 =
	     { x__h19139, mesgMetaF_length__h20117 } ;
  assign MUX_wmi_mFlagF_x_wire$wset_1__VAL_3 =
	     { x__h19139, mesgMetaF_length__h19381 } ;
  ...
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_1 =
	     { 4'd5, x__h17839, 1'b0, mesgReqAddr, fabWordsCurReq[11:0] } ;
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_2 = { 20'd229376, bl__h19242 } ;
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_3 =
	     { 4'd3, wsiS_reqFifo$D_OUT[93], 1'b0, addr__h19987, 12'd1 } ;
  ...
  assign wmi_reqF_x_wire$whas =
	     ...
	     WILL_FIRE_RL_wmwt_requestPrecise ||
	     WILL_FIRE_RL_wmwt_messagePushImprecise ;
  assign wmi_mFlagF_x_wire$wget = value__h6091 ;
  ...
  assign fabRespCredit_acc_v1$wget = b__h14480 ;
  ...
  assign fabWordsCurReq$D_IN =
	     (fabWordsRemain <= b__h17668) ? fabWordsRemain : b__h17668 ;
  ...
  // register respF_rRdPtr
  assign respF_rRdPtr$D_IN = x__h15834 ;
  ...
  always@(WILL_FIRE_RL_wmi_mFlagF_both or
	  ...
	  value__h6091 or WILL_FIRE_RL_wmi_mFlagF_decCtr or wmi_mFlagF_q_1)
  begin
    case (1'b1) // synopsys parallel_case
      WILL_FIRE_RL_wmi_mFlagF_both:
	  wmi_mFlagF_q_0$D_IN = MUX_wmi_mFlagF_q_0$write_1__VAL_1;
      MUX_wmi_mFlagF_q_0$write_1__SEL_2: wmi_mFlagF_q_0$D_IN = value__h6091;
  ...
  always@(WILL_FIRE_RL_wmi_mFlagF_both or
	  ...
	  value__h6091 or WILL_FIRE_RL_wmi_mFlagF_decCtr)
  begin
    case (1'b1) // synopsys parallel_case
      WILL_FIRE_RL_wmi_mFlagF_both:
	  wmi_mFlagF_q_1$D_IN = MUX_wmi_mFlagF_q_1$write_1__VAL_1;
      MUX_wmi_mFlagF_q_1$write_1__SEL_2: wmi_mFlagF_q_1$D_IN = value__h6091;
  ...
  assign NOT_wmi_reqF_c_r_39_EQ_2_58_59_AND_wmi_operate_ETC___d510 =
	     ...
	     (!x__h17839 || wmi_mFlagF_c_r != 2'd2) ;
  assign addr__h19987 = { mesgLengthSoFar[10:0], 3'd0 } ;
  assign b__h14480 = -fabWordsCurReq[11:0] ;
  assign b__h17668 = { {2{fabRespCredit_value[11]}}, fabRespCredit_value } ;
  assign bl__h19242 = zeroLengthMesg ? 12'd1 : { 1'd0, x__h19153[13:3] } ;
  assign mesgMetaF_length__h19381 = { 10'd0, x__h19153 } ;
  assign mesgMetaF_length__h20117 = { 10'd0, mlp1B__h19971 } ;
  assign mlp1B__h19971 = { mlp1__h19970[10:0], 3'd0 } ;
  assign mlp1__h19970 = MUX_mesgLengthSoFar$write_1__VAL_2 ;
  assign rdat__h21436 = hasDebugLogic ? mesgCount : 32'd0 ;
  assign rdat__h21442 = hasDebugLogic ? abortCount : 32'd0 ;
  assign rdat__h21448 = hasDebugLogic ? thisMesg : 32'd0 ;
  assign rdat__h21461 = hasDebugLogic ? lastMesg : 32'd0 ;
  assign rdat__h21484 = hasDebugLogic ? { 16'd0, x__h21488 } : 32'd0 ;
  assign rdat__h21584 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h21598 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h21606 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h21612 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h21626 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h21634 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign sendData_burstLength__h18128 =
	     (thisMesg[15:0] == 16'd0 || smaCtrl[5] && unrollCnt == 16'd1) ?
	       12'd1 :
	       (smaCtrl[5] ? 12'd4095 : wsiBurstLength__h18046[11:0]) ;
  assign sendData_byteEn__h18130 = (thisMesg[15:0] == 16'd0) ? 8'd0 : 8'd255 ;
  ...
  assign wsiS_reqFifo_notFull__59_AND_wsiS_burstKind_74_ETC___d381 =
	     ...
	     (wsiS_burstKind == 2'd0 ||
	      ...
	      wsiS_wsiReq$wget[93]) ;
  assign x__h15834 = respF_rRdPtr + 12'd1 ;
  assign x__h17839 = fabWordsRemain == fabWordsCurReq ;
  assign x__h19139 = opcode[8] ? opcode[7:0] : 8'd0 ;
  assign x__h19153 = mesgLength[14] ? mesgLength[13:0] : 14'd0 ;
  assign x__h21488 = { wsiS_statusR, wsiM_statusR } ;
  assign x_length__h19135 = { 2'd0, x__h19153 } ;
  always@(wci_reqF$D_OUT or
	  ...
	  rdat__h21584 or
	  rdat__h21598 or
	  rdat__h21606 or rdat__h21612 or rdat__h21626 or rdat__h21634)
  begin
    case (wci_reqF$D_OUT[39:32])
      8'h0: g_data__h21393 = smaCtrl;
      8'h04: g_data__h21393 = rdat__h21436;
      8'h08: g_data__h21393 = rdat__h21442;
      8'h10: g_data__h21393 = rdat__h21448;
      8'h14: g_data__h21393 = rdat__h21461;
      8'h18: g_data__h21393 = rdat__h21484;
      8'h20: g_data__h21393 = rdat__h21584;
      8'h24: g_data__h21393 = rdat__h21598;
      8'h28: g_data__h21393 = rdat__h21606;
      8'h2C: g_data__h21393 = rdat__h21612;
      8'h30: g_data__h21393 = rdat__h21626;
      8'h34: g_data__h21393 = rdat__h21634;
      default: g_data__h21393 = 32'd0;
    endcase
  end
  ...
  begin
    case (1'b1) // synopsys parallel_case
      MUX_wmi_mFlagF_x_wire$wset_1__SEL_1:
	  value__h6091 = 32'hAAAAAAAA /* unspecified value */ ;
      MUX_endOfMessage$write_1__SEL_1:
	  value__h6091 = MUX_wmi_mFlagF_x_wire$wset_1__VAL_2;
      WILL_FIRE_RL_wmwt_requestPrecise:
	  value__h6091 = MUX_wmi_mFlagF_x_wire$wset_1__VAL_3;
      default: value__h6091 = 32'hAAAAAAAA /* unspecified value */ ;
    endcase
  end
  ...
  begin
    ...
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wmwt_doAbort)
	$display("[%0d]: %m: wmwt_doAbort", v__h20800);
    if (wciS0_MReset_n)
