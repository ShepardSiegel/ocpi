...
//
// On Thu Jan 13 18:35:42 EST 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter8B(wciS0_Clk,
  ...
  wire MUX_impreciseBurst$write_1__SEL_3,
       MUX_lastMesg$write_1__SEL_2,
       MUX_mesgCount$write_1__SEL_1,
       MUX_mesgLength$write_1__SEL_3,
  ...
  wire [91 : 0] IF_respF_wDataIn_whas__43_THEN_respF_wDataIn_w_ETC___d820;
  ...
  wire [2 : 0] IF_respF_wDataIn_whas__43_THEN_respF_wDataIn_w_ETC___d822;
  ...
  assign MUX_mesgLength$write_1__SEL_3 =
	     MUX_wsiS_reqFifo_levelsValid$write_1__SEL_2 &&
  ...
  // register endOfMessage
  assign endOfMessage$D_IN = MUX_mesgLength$write_1__SEL_3 ;
  ...
  assign lastMesg$D_IN =
	     (MUX_mesgLength$write_1__SEL_3 || MUX_lastMesg$write_1__SEL_2) ?
	       thisMesg :
	       32'hFEFEFFFE ;
  assign lastMesg$EN =
	     MUX_wsiS_reqFifo_levelsValid$write_1__SEL_2 &&
  ...
  always@(WILL_FIRE_RL_wmwt_messageFinalize or
	  ...
	  MUX_mesgLength$write_1__SEL_3 or
  ...
  assign readyToPush$D_IN =
	     !WILL_FIRE_RL_wmwt_doAbort && !MUX_mesgLength$write_1__SEL_3 ;
  ...
  assign respF_rCache$D_IN =
	     { 1'd1,
	       respF_rWrPtr,
	       IF_respF_wDataIn_whas__43_THEN_respF_wDataIn_w_ETC___d822,
	       respF_pwEnqueue$whas && respF_wDataIn$wget[93],
	       respF_pwEnqueue$whas && respF_wDataIn$wget[92],
	       IF_respF_wDataIn_whas__43_THEN_respF_wDataIn_w_ETC___d820 } ;
  ...
  // register thisMesg
  always@(MUX_mesgLength$write_1__SEL_3 or
  ...
  // remaining internal signals
  assign IF_respF_wDataIn_whas__43_THEN_respF_wDataIn_w_ETC___d820 =
	     respF_pwEnqueue$whas ? respF_wDataIn$wget[91:0] : 92'd0 ;
  assign IF_respF_wDataIn_whas__43_THEN_respF_wDataIn_w_ETC___d822 =
