...
//
// On Fri Jul 23 11:09:52 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter8B(wciS0_Clk,
  ...
  wire MUX_impreciseBurst$write_1__SEL_2,
  ...
  reg [63 : 0] v__h15763,
	       ...
	       v__h2801,
	       v__h3700;
  reg [31 : 0] value__h6077, x_data__h15896;
  wire [31 : 0] rdat__h15933,
		rdat__h15940,
		rdat__h15947,
		rdat__h15970,
		rdat__h15993,
		...
		rdat__h16135,
		rdat__h16143;
  wire [23 : 0] mesgMetaF_length__h17452, mesgMetaF_length__h18495;
  wire [15 : 0] wsiBurstLength__h19224, x__h15997, x_length__h17729;
  wire [13 : 0] IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d798,
		addr__h17299,
		b__h19845,
		mlp1B__h17283,
		mlp1__h17282;
  wire [11 : 0] bl__h18351, x_burstLength__h19320;
  wire [7 : 0] mesgMetaF_opcode__h17451, x_byteEn__h19322;
  wire [3 : 0] b__h14385;
  wire NOT_wmi_reqF_c_r_57_EQ_2_58_59_AND_wmi_operate_ETC___d308,
       ...
       wsiS_reqFifo_notFull__88_AND_wsiS_burstKind_68_ETC___d407,
       x__h19645;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_1 = { 2'd1, x_data__h15896 } ;
  ...
  assign MUX_mesgLength$write_1__VAL_4 = { 1'd1, mlp1B__h17283 } ;
  ...
  assign MUX_wmi_mFlagF_x_wire$wset_1__VAL_1 =
	     { mesgMetaF_opcode__h17451, mesgMetaF_length__h17452 } ;
  ...
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_3 =
	     { 4'd3, wsiS_reqFifo$D_OUT[93], 1'b0, addr__h17299, 12'd1 } ;
  ...
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_2 =
	     { 4'd5, x__h19645, 1'b0, mesgReqAddr, fabWordsCurReq[11:0] } ;
  assign MUX_wsiM_reqFifo_x_wire$wset_1__VAL_2 =
	     { 3'd1,
	       unrollCnt == 16'd1,
	       !smaCtrl[5],
	       x_burstLength__h19320,
  ...
  assign MUX_wmi_mFlagF_x_wire$wset_1__SEL_2 =
	     WILL_FIRE_RL_wmrd_mesgBodyRequest && x__h19645 ;
  assign MUX_fabRespCredit_value$write_1__VAL_2 =
	     fabRespCredit_value +
	     (CAN_FIRE_RL_wmrd_mesgBodyRequest ? b__h14385 : 4'd0) +
  ...
  assign MUX_thisMesg$write_1__VAL_1 =
	     { mesgCount[7:0], mesgMetaF_opcode__h17451, x_length__h17729 } ;
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_1 = { 20'd229376, bl__h18351 } ;
  ...
  assign MUX_wmi_mFlagF_x_wire$wset_1__VAL_3 =
	     { mesgMetaF_opcode__h17451, mesgMetaF_length__h18495 } ;
  ...
  assign fabRespCredit_acc_v1$wget = b__h14385 ;
  ...
  assign fabWordsCurReq$D_IN =
	     (fabWordsRemain <= b__h19845) ? fabWordsRemain : b__h19845 ;
  ...
  assign lastMesg$D_IN =
	     (MUX_lastMesg$write_1__SEL_1 || MUX_lastMesg$write_1__SEL_2) ?
	       thisMesg :
	       32'hFEFEFFFE ;
  assign lastMesg$EN =
	     WILL_FIRE_RL_wmwt_messagePushImprecise &&
  ...
  always@(WILL_FIRE_RL_wmwt_doAbort or
	  ...
	  MUX_lastMesg$write_1__SEL_1 or MUX_mesgLength$write_1__VAL_4)
  case (1'b1)
  ...
  assign mesgLengthSoFar$D_IN =
	     MUX_impreciseBurst$write_1__SEL_2 ? 14'd0 : mlp1__h17282 ;
  ...
  // register readyToPush
  always@(WILL_FIRE_RL_wmwt_doAbort or
	  MUX_impreciseBurst$write_1__SEL_2 or MUX_lastMesg$write_1__SEL_1)
  case (1'b1)
    WILL_FIRE_RL_wmwt_doAbort: readyToPush$D_IN = 1'd0;
    MUX_impreciseBurst$write_1__SEL_2: readyToPush$D_IN = 1'd1;
    MUX_lastMesg$write_1__SEL_1: readyToPush$D_IN = 1'd0;
  ...
  // remaining internal signals
  assign IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d798 =
  ...
  assign NOT_wmi_reqF_c_r_57_EQ_2_58_59_AND_wmi_operate_ETC___d308 =
	     ...
	     (!x__h19645 || wmi_mFlagF_c_r != 2'd2) ;
  assign addr__h17299 = { mesgLengthSoFar[10:0], 3'd0 } ;
  assign b__h14385 = -fabWordsCurReq[3:0] ;
  assign b__h19845 = { {10{fabRespCredit_value[3]}}, fabRespCredit_value } ;
  assign bl__h18351 =
	     zeroLengthMesg ?
	       12'd1 :
	       { 1'd0,
		 IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d798[13:3] } ;
  assign mesgMetaF_length__h17452 = { 10'd0, mlp1B__h17283 } ;
  assign mesgMetaF_length__h18495 =
	     { 10'd0,
	       IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d798 } ;
  assign mesgMetaF_opcode__h17451 = opcode[8] ? opcode[7:0] : 8'd0 ;
  assign mlp1B__h17283 = { mlp1__h17282[10:0], 3'd0 } ;
  assign mlp1__h17282 = mesgLengthSoFar + 14'd1 ;
  assign rdat__h15933 = hasDebugLogic ? mesgCount : 32'd0 ;
  assign rdat__h15940 = hasDebugLogic ? abortCount : 32'd0 ;
  assign rdat__h15947 = hasDebugLogic ? thisMesg : 32'd0 ;
  assign rdat__h15970 = hasDebugLogic ? lastMesg : 32'd0 ;
  assign rdat__h15993 = hasDebugLogic ? { 16'd0, x__h15997 } : 32'd0 ;
  assign rdat__h16093 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h16107 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h16115 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h16121 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h16135 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h16143 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  ...
  assign wsiS_reqFifo_notFull__88_AND_wsiS_burstKind_68_ETC___d407 =
	     wsiS_reqFifo$FULL_N &&
	     (wsiS_burstKind == 2'd0 ||
	      (wsiS_burstKind == 2'd1 || wsiS_burstKind == 2'd2) &&
	      wsiS_wsiReq$wget[93]) ;
  assign x__h15997 = { wsiS_statusR, wsiM_statusR } ;
  assign x__h19645 = fabWordsRemain == fabWordsCurReq ;
  assign x_burstLength__h19320 =
	     (thisMesg[15:0] == 16'd0 || smaCtrl[5] && unrollCnt == 16'd1) ?
	       12'd1 :
	       (smaCtrl[5] ? 12'd4095 : wsiBurstLength__h19224[11:0]) ;
  assign x_byteEn__h19322 = (thisMesg[15:0] == 16'd0) ? 8'd0 : 8'd255 ;
  assign x_length__h17729 =
	     { 2'd0,
	       IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d798 } ;
  always@(wci_reqF$D_OUT or
	  ...
	  rdat__h16093 or
	  rdat__h16107 or
	  rdat__h16115 or rdat__h16121 or rdat__h16135 or rdat__h16143)
  begin
    case (wci_reqF$D_OUT[39:32])
      8'h0: x_data__h15896 = smaCtrl;
      8'h04: x_data__h15896 = rdat__h15933;
      8'h08: x_data__h15896 = rdat__h15940;
      8'h10: x_data__h15896 = rdat__h15947;
      8'h14: x_data__h15896 = rdat__h15970;
      8'h18: x_data__h15896 = rdat__h15993;
      8'h20: x_data__h15896 = rdat__h16093;
      8'h24: x_data__h15896 = rdat__h16107;
      8'h28: x_data__h15896 = rdat__h16115;
      8'h2C: x_data__h15896 = rdat__h16121;
      8'h30: x_data__h15896 = rdat__h16135;
      8'h34: x_data__h15896 = rdat__h16143;
      default: x_data__h15896 = 32'd0;
    endcase
  end
  always@(MUX_lastMesg$write_1__SEL_1 or
  ...
  begin
    ...
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wmwt_doAbort)
	$display("[%0d]: %m: wmwt_doAbort", v__h16944);
    if (wciS0_MReset_n)
