...
//
// On Sat Oct 30 09:41:26 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter8B(wciS0_Clk,
  ...
  reg [63 : 0] v__h17030,
	       ...
	       v__h2836,
	       v__h3735;
  reg [31 : 0] value__h6114, x_data__h17165;
  wire [91 : 0] IF_respF_wDataIn_whas__78_THEN_respF_wDataIn_w_ETC___d909;
  wire [31 : 0] rdat__h17208,
		rdat__h17215,
		rdat__h17222,
		rdat__h17245,
		rdat__h17268,
		...
		rdat__h17410,
		rdat__h17418;
  wire [23 : 0] mesgMetaF_length__h18735, mesgMetaF_length__h19778;
  wire [15 : 0] wsiBurstLength__h20632, x__h17272, x_length__h19012;
  wire [13 : 0] IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d817,
		addr__h18582,
		b__h21261,
		mlp1B__h18566,
		mlp1__h18565;
  wire [11 : 0] b__h14530,
		bl__h19634,
		sendData_burstLength__h20736,
		x__h15812;
  wire [7 : 0] mesgMetaF_opcode__h18734, sendData_byteEn__h20738;
  wire [2 : 0] IF_respF_wDataIn_whas__78_THEN_respF_wDataIn_w_ETC___d908;
  wire NOT_wmi_reqF_c_r_57_EQ_2_58_59_AND_wmi_operate_ETC___d320,
       wmi_operateD_63_AND_wmi_peerIsReady_64_65_AND__ETC___d221,
       wmi_respF_i_notEmpty__80_AND_smaCtrl_3_BIT_4_8_ETC___d286,
       wsiS_reqFifo_i_notEmpty__66_AND_NOT_smaCtrl_3__ETC___d180,
       wsiS_reqFifo_notFull__32_AND_wsiS_burstKind_12_ETC___d452,
       x__h21061;
  ...
  assign CAN_FIRE_RL_wmrd_mesgBodyRequest =
	     NOT_wmi_reqF_c_r_57_EQ_2_58_59_AND_wmi_operate_ETC___d320 &&
	     wci_cState == 3'd2 &&
  ...
  assign MUX_mesgLength$write_1__VAL_4 = { 1'd1, mlp1B__h18566 } ;
  ...
  assign MUX_wmi_mFlagF_x_wire$wset_1__VAL_1 =
	     { mesgMetaF_opcode__h18734, mesgMetaF_length__h18735 } ;
  ...
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_3 =
	     { 4'd3, wsiS_reqFifo$D_OUT[93], 1'b0, addr__h18582, 12'd1 } ;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_1 = { 2'd1, x_data__h17165 } ;
  ...
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_2 =
	     { 4'd5, x__h21061, 1'b0, mesgReqAddr, fabWordsCurReq[11:0] } ;
  ...
  assign MUX_wmi_mFlagF_x_wire$wset_1__SEL_2 =
	     WILL_FIRE_RL_wmrd_mesgBodyRequest && x__h21061 ;
  assign MUX_fabRespCredit_value$write_1__VAL_2 =
	     fabRespCredit_value +
	     (CAN_FIRE_RL_wmrd_mesgBodyRequest ? b__h14530 : 12'd0) +
  ...
  assign MUX_thisMesg$write_1__VAL_1 =
	     { mesgCount[7:0], mesgMetaF_opcode__h18734, x_length__h19012 } ;
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_1 = { 20'd229376, bl__h19634 } ;
  ...
  assign MUX_wmi_mFlagF_x_wire$wset_1__VAL_3 =
	     { mesgMetaF_opcode__h18734, mesgMetaF_length__h19778 } ;
  assign MUX_wmi_mFlagF_q_0$write_1__VAL_1 =
	     (wmi_mFlagF_c_r == 2'd1) ? value__h6114 : wmi_mFlagF_q_1 ;
  assign MUX_wmi_mFlagF_q_1$write_1__VAL_1 =
	     (wmi_mFlagF_c_r == 2'd2) ? value__h6114 : 32'd0 ;
  ...
  assign fabRespCredit_acc_v1$wget = b__h14530 ;
  ...
  assign wmi_mFlagF_x_wire$wget = value__h6114 ;
  ...
  assign fabWordsCurReq$D_IN =
	     (fabWordsRemain <= b__h21261) ? fabWordsRemain : b__h21261 ;
  ...
  assign mesgLengthSoFar$D_IN =
	     MUX_impreciseBurst$write_1__SEL_2 ? 14'd0 : mlp1__h18565 ;
  ...
  assign respF_rCache$D_IN =
	     { 1'd1,
	       respF_rWrPtr,
	       IF_respF_wDataIn_whas__78_THEN_respF_wDataIn_w_ETC___d908,
	       respF_pwEnqueue$whas && respF_wDataIn$wget[93],
	       respF_pwEnqueue$whas && respF_wDataIn$wget[92],
	       IF_respF_wDataIn_whas__78_THEN_respF_wDataIn_w_ETC___d909 } ;

  // register respF_rRdPtr
  assign respF_rRdPtr$D_IN = x__h15812 ;
  ...
  always@(WILL_FIRE_RL_wmi_mFlagF_both or
	  ...
	  value__h6114 or WILL_FIRE_RL_wmi_mFlagF_decCtr or wmi_mFlagF_q_1)
  begin
    case (1'b1) // synopsys parallel_case
      WILL_FIRE_RL_wmi_mFlagF_both:
	  wmi_mFlagF_q_0$D_IN = MUX_wmi_mFlagF_q_0$write_1__VAL_1;
      MUX_wmi_mFlagF_q_0$write_1__SEL_2: wmi_mFlagF_q_0$D_IN = value__h6114;
  ...
  always@(WILL_FIRE_RL_wmi_mFlagF_both or
	  ...
	  value__h6114 or WILL_FIRE_RL_wmi_mFlagF_decCtr)
  begin
    case (1'b1) // synopsys parallel_case
      WILL_FIRE_RL_wmi_mFlagF_both:
	  wmi_mFlagF_q_1$D_IN = MUX_wmi_mFlagF_q_1$write_1__VAL_1;
      MUX_wmi_mFlagF_q_1$write_1__SEL_2: wmi_mFlagF_q_1$D_IN = value__h6114;
  ...
  // remaining internal signals
  assign IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d817 =
	     mesgLength[14] ? mesgLength[13:0] : 14'd0 ;
  assign IF_respF_wDataIn_whas__78_THEN_respF_wDataIn_w_ETC___d908 =
	     respF_pwEnqueue$whas ? respF_wDataIn$wget[96:94] : 3'd0 ;
  assign IF_respF_wDataIn_whas__78_THEN_respF_wDataIn_w_ETC___d909 =
	     respF_pwEnqueue$whas ? respF_wDataIn$wget[91:0] : 92'd0 ;
  assign NOT_wmi_reqF_c_r_57_EQ_2_58_59_AND_wmi_operate_ETC___d320 =
	     wmi_reqF_c_r != 2'd2 && wmi_operateD && wmi_peerIsReady &&
	     (!x__h21061 || wmi_mFlagF_c_r != 2'd2) ;
  assign addr__h18582 = { mesgLengthSoFar[10:0], 3'd0 } ;
  assign b__h14530 = -fabWordsCurReq[11:0] ;
  assign b__h21261 = { {2{fabRespCredit_value[11]}}, fabRespCredit_value } ;
  assign bl__h19634 =
	     zeroLengthMesg ?
	       12'd1 :
	       { 1'd0,
		 IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d817[13:3] } ;
  assign mesgMetaF_length__h18735 = { 10'd0, mlp1B__h18566 } ;
  assign mesgMetaF_length__h19778 =
	     { 10'd0,
	       IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d817 } ;
  assign mesgMetaF_opcode__h18734 = opcode[8] ? opcode[7:0] : 8'd0 ;
  assign mlp1B__h18566 = { mlp1__h18565[10:0], 3'd0 } ;
  assign mlp1__h18565 = mesgLengthSoFar + 14'd1 ;
  assign rdat__h17208 = hasDebugLogic ? mesgCount : 32'd0 ;
  assign rdat__h17215 = hasDebugLogic ? abortCount : 32'd0 ;
  assign rdat__h17222 = hasDebugLogic ? thisMesg : 32'd0 ;
  assign rdat__h17245 = hasDebugLogic ? lastMesg : 32'd0 ;
  assign rdat__h17268 = hasDebugLogic ? { 16'd0, x__h17272 } : 32'd0 ;
  assign rdat__h17368 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h17382 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h17390 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h17396 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h17410 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h17418 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign sendData_burstLength__h20736 =
	     (thisMesg[15:0] == 16'd0 || smaCtrl[5] && unrollCnt == 16'd1) ?
	       12'd1 :
	       (smaCtrl[5] ? 12'd4095 : wsiBurstLength__h20632[11:0]) ;
  assign sendData_byteEn__h20738 = (thisMesg[15:0] == 16'd0) ? 8'd0 : 8'd255 ;
  ...
  assign wmi_respF_i_notEmpty__80_AND_smaCtrl_3_BIT_4_8_ETC___d286 =
	     wmi_respF$EMPTY_N &&
	     (smaCtrl[4] || respF_rRdPtr + 12'd1024 != respF_rWrPtr) ;
  assign wsiBurstLength__h20632 =
  ...
  assign wsiS_reqFifo_notFull__32_AND_wsiS_burstKind_12_ETC___d452 =
	     wsiS_reqFifo$FULL_N &&
	     (wsiS_burstKind == 2'd0 ||
	      (wsiS_burstKind == 2'd1 || wsiS_burstKind == 2'd2) &&
	      wsiS_wsiReq$wget[93]) ;
  assign x__h15812 = respF_rRdPtr + 12'd1 ;
  assign x__h17272 = { wsiS_statusR, wsiM_statusR } ;
  assign x__h21061 = fabWordsRemain == fabWordsCurReq ;
  assign x_length__h19012 =
	     { 2'd0,
	       IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d817 } ;
  always@(wci_reqF$D_OUT or
	  ...
	  rdat__h17368 or
	  rdat__h17382 or
	  rdat__h17390 or rdat__h17396 or rdat__h17410 or rdat__h17418)
  begin
    case (wci_reqF$D_OUT[39:32])
      8'h0: x_data__h17165 = smaCtrl;
      8'h04: x_data__h17165 = rdat__h17208;
      8'h08: x_data__h17165 = rdat__h17215;
      8'h10: x_data__h17165 = rdat__h17222;
      8'h14: x_data__h17165 = rdat__h17245;
      8'h18: x_data__h17165 = rdat__h17268;
      8'h20: x_data__h17165 = rdat__h17368;
      8'h24: x_data__h17165 = rdat__h17382;
      8'h28: x_data__h17165 = rdat__h17390;
      8'h2C: x_data__h17165 = rdat__h17396;
      8'h30: x_data__h17165 = rdat__h17410;
      8'h34: x_data__h17165 = rdat__h17418;
      default: x_data__h17165 = 32'd0;
    endcase
  end
  always@(MUX_endOfMessage$write_1__SEL_1 or
  ...
  begin
    case (1'b1) // synopsys parallel_case
      MUX_endOfMessage$write_1__SEL_1:
	  value__h6114 = MUX_wmi_mFlagF_x_wire$wset_1__VAL_1;
      MUX_wmi_mFlagF_x_wire$wset_1__SEL_2:
	  value__h6114 = 32'hAAAAAAAA /* unspecified value */ ;
      WILL_FIRE_RL_wmwt_requestPrecise:
	  value__h6114 = MUX_wmi_mFlagF_x_wire$wset_1__VAL_3;
      default: value__h6114 = 32'hAAAAAAAA /* unspecified value */ ;
    endcase
  end
  ...
  begin
    ...
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wmwt_doAbort)
	$display("[%0d]: %m: wmwt_doAbort", v__h18227);
    if (wciS0_MReset_n)
