...
//
// On Sun Oct 28 09:31:51 EDT 2012
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter8B(wciS0_Clk,
  ...
  wire [91 : 0] IF_respF_wDataIn_whas__33_THEN_respF_wDataIn_w_ETC___d899;
  ...
  wire [23 : 0] b__h18410,
		...
		residue__h18273,
		x__h18530;
  wire [15 : 0] wsiBurstLength__h19161, x__h24635, x_length__h23563;
  wire [13 : 0] b__h18783, mlB__h22832, mlInc__h22831;
  wire [11 : 0] b__h15473, sendData_burstLength__h19243, x__h16878;
  wire [7 : 0] mesgMetaF_opcode__h22998, sendData_byteEn__h19245;
  wire [3 : 0] x__h23038,
	       x__h23050,
	       x__h23062,
	       x__h23074,
	       ...
	       y__h23099,
	       y__h23111;
  wire [2 : 0] IF_respF_wDataIn_whas__33_THEN_respF_wDataIn_w_ETC___d891;
  ...
  assign MUX_thisMesg$write_1__VAL_1 =
	     { mesgCount[7:0], mesgMetaF_opcode__h22998, x_length__h23563 } ;
  ...
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_2 = { 2'd1, g_data__h24540 } ;
  ...
  assign respF_rCache$D_IN =
	     { 1'd1,
	       respF_rWrPtr,
	       IF_respF_wDataIn_whas__33_THEN_respF_wDataIn_w_ETC___d891,
	       respF_pwEnqueue$whas && respF_wDataIn$wget[93],
	       respF_pwEnqueue$whas && respF_wDataIn$wget[92],
	       IF_respF_wDataIn_whas__33_THEN_respF_wDataIn_w_ETC___d899 } ;
  ...
  // remaining internal signals
  assign IF_respF_wDataIn_whas__33_THEN_respF_wDataIn_w_ETC___d891 =
	     respF_pwEnqueue$whas ? respF_wDataIn$wget[96:94] : 3'd0 ;
  assign IF_respF_wDataIn_whas__33_THEN_respF_wDataIn_w_ETC___d899 =
  ...
  assign mlInc__h22831 =
	     wsiS_reqFifo$D_OUT[93] ?
	       { 10'd0, x__h23038 + y__h23039 } :
	       14'd8 ;
  assign rdat__h24583 = hasDebugLogic ? mesgCount : 32'd0 ;
  assign rdat__h24589 = hasDebugLogic ? abortCount : 32'd0 ;
  assign rdat__h24595 = hasDebugLogic ? thisMesg : 32'd0 ;
  assign rdat__h24608 = hasDebugLogic ? lastMesg : 32'd0 ;
  assign rdat__h24631 = hasDebugLogic ? { 16'd0, x__h24635 } : 32'd0 ;
  assign rdat__h24731 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h24745 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h24753 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h24759 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h24773 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h24781 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h24787 = hasDebugLogic ? wmwtBeginCount : 32'd0 ;
  assign rdat__h24793 = hasDebugLogic ? wmwtPushCount : 32'd0 ;
  assign rdat__h24799 = hasDebugLogic ? wmwtFinalCount : 32'd0 ;
  assign rdat__h24805 = hasDebugLogic ? { 31'd0, x__h24809 } : 32'd0 ;
  assign rdat__h24815 = hasDebugLogic ? 32'hFEEDC0DE : 32'd0 ;
  ...
  assign sendData_byteEn__h19245 =
	     (thisMesg[15:0] == 16'd0) ?
	       8'd0 :
	       ((unrollCnt == 16'd1) ? x__h19302[7:0] : 8'd255) ;
  assign value__h6702 =
	     MUX_wmi_mFlagF_x_wire$wset_1__SEL_1 ?
  ...
  assign x__h18530 = { 3'd0, wmi_sFlagReg[23:3] } ;
  ...
  assign x__h23110 = { 3'd0, wsiS_reqFifo$D_OUT[15] } ;
  assign x__h24635 = { wsiS_statusR, wsiM_statusR } ;
  assign x__h24809 = wmi_sThreadBusy_d || wmi_sDataThreadBusy_d ;
  assign x_length__h23563 = { 2'd0, mlB__h22832 } ;
  assign y__h23039 = { 3'd0, wsiS_reqFifo$D_OUT[8] } ;
  assign y__h23051 = { 3'd0, wsiS_reqFifo$D_OUT[9] } ;
  assign y__h23063 = { 3'd0, wsiS_reqFifo$D_OUT[10] } ;
  assign y__h23075 = { 3'd0, wsiS_reqFifo$D_OUT[11] } ;
  assign y__h23087 = { 3'd0, wsiS_reqFifo$D_OUT[12] } ;
  assign y__h23099 = { 3'd0, wsiS_reqFifo$D_OUT[13] } ;
  assign y__h23111 = { 3'd0, wsiS_reqFifo$D_OUT[14] } ;
  always@(wci_wslv_reqF$D_OUT or
	  ...
	  rdat__h24781 or
	  rdat__h24787 or
	  rdat__h24793 or rdat__h24799 or rdat__h24805 or rdat__h24815)
  begin
    case (wci_wslv_reqF$D_OUT[39:32])
      8'h0: g_data__h24540 = smaCtrl;
      8'h04: g_data__h24540 = rdat__h24583;
      8'h08: g_data__h24540 = rdat__h24589;
      8'h10: g_data__h24540 = rdat__h24595;
      8'h14: g_data__h24540 = rdat__h24608;
      8'h18: g_data__h24540 = rdat__h24631;
      8'h20: g_data__h24540 = rdat__h24731;
      8'h24: g_data__h24540 = rdat__h24745;
      8'h28: g_data__h24540 = rdat__h24753;
      8'h2C: g_data__h24540 = rdat__h24759;
      8'h30: g_data__h24540 = rdat__h24773;
      8'h34: g_data__h24540 = rdat__h24781;
      8'h38: g_data__h24540 = rdat__h24787;
      8'h3C: g_data__h24540 = rdat__h24793;
      8'h40: g_data__h24540 = rdat__h24799;
      8'h44: g_data__h24540 = rdat__h24805;
      8'h48: g_data__h24540 = rdat__h24815;
      default: g_data__h24540 = 32'd0;
    endcase
  end
  ...
  begin
    ...
    if (wciS0_MReset_n != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_wmwt_doAbort)
	$display("[%0d]: %m: wmwt_doAbort", v__h23989);
    if (wciS0_MReset_n != `BSV_RESET_VALUE)
