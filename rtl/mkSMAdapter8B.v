...
//
// On Wed Feb  9 09:56:54 EST 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter8B(wciS0_Clk,
  ...
  wire MUX_endOfMessage$write_1__SEL_1,
       ...
       MUX_preciseBurst$write_1__SEL_3,
  ...
  reg [63 : 0] v__h18176,
	       ...
	       v__h3761,
	       v__h3905;
  reg [31 : 0] g_data__h22298, value__h6563;
  wire [91 : 0] IF_respF_wDataIn_whas__43_THEN_respF_wDataIn_w_ETC___d843;
  wire [31 : 0] rdat__h22341,
		rdat__h22347,
		rdat__h22353,
		rdat__h22366,
		rdat__h22389,
		...
		rdat__h22557,
		rdat__h22563;
  wire [23 : 0] mesgMetaF_length__h20102, mesgMetaF_length__h20862;
  wire [15 : 0] wsiBurstLength__h18638, x__h22393, x_length__h19856;
  wire [13 : 0] addr__h20732,
		b__h18260,
		mlp1B__h20692,
		mlp1__h20691,
		x__h19874;
  wire [11 : 0] b__h14952,
		bl__h19963,
		sendData_burstLength__h18720,
		x__h16306;
  wire [7 : 0] sendData_byteEn__h18722, x__h19860;
  wire [2 : 0] IF_respF_wDataIn_whas__43_THEN_respF_wDataIn_w_ETC___d842;
  wire NOT_wmi_reqF_c_r_56_EQ_2_75_76_AND_wmi_operate_ETC___d527,
       wmi_operateD_42_AND_wmi_peerIsReady_43_44_AND__ETC___d627,
       wmi_respF_i_notEmpty__40_AND_smaCtrl_75_BIT_4__ETC___d545,
       wsiS_reqFifo_i_notEmpty__74_AND_NOT_smaCtrl_75_ETC___d646,
  ...
  assign MUX_mesgReqOK$write_1__SEL_3 =
	     ...
	     !WILL_FIRE_RL_wmrd_mesgBodyRequest ;
  assign MUX_preciseBurst$write_1__SEL_3 =
	     WILL_FIRE_RL_wmwt_mesgBegin && wsiS_reqFifo$D_OUT[92] ;
  ...
  assign MUX_wmi_mFlagF_x_wire$wset_1__SEL_1 =
	     WILL_FIRE_RL_wmrd_mesgBodyRequest && x__h18431 ;
  ...
  assign MUX_mesgLength$write_1__VAL_3 = { 1'd1, mlp1B__h20692 } ;
  ...
  assign MUX_thisMesg$write_1__VAL_1 =
	     { mesgCount[7:0], x__h19860, x_length__h19856 } ;
  ...
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_2 = { 2'd1, g_data__h22298 } ;
  ...
  assign MUX_wmi_mFlagF_x_wire$wset_1__VAL_2 =
	     { x__h19860, mesgMetaF_length__h20862 } ;
  assign MUX_wmi_mFlagF_x_wire$wset_1__VAL_3 =
	     { x__h19860, mesgMetaF_length__h20102 } ;
  ...
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_1 =
	     { 4'd5, x__h18431, 1'b0, mesgReqAddr, fabWordsCurReq[11:0] } ;
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_2 = { 20'd229376, bl__h19963 } ;
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_3 =
	     { 4'd3, wsiS_reqFifo$D_OUT[93], 1'b0, addr__h20732, 12'd1 } ;
  ...
  assign fabWordsCurReq$D_IN =
	     (fabWordsRemain <= b__h18260) ? fabWordsRemain : b__h18260 ;
  ...
  always@(WILL_FIRE_RL_wmwt_messageFinalize or
	  ...
	  MUX_preciseBurst$write_1__SEL_3 or MUX_mesgLength$write_1__VAL_4)
  case (1'b1)
  ...
  // register readyToRequest
  assign readyToRequest$D_IN = MUX_preciseBurst$write_1__SEL_3 ;
  ...
  assign respF_rCache$D_IN =
	     { 1'd1,
	       respF_rWrPtr,
	       IF_respF_wDataIn_whas__43_THEN_respF_wDataIn_w_ETC___d842,
	       respF_pwEnqueue$whas && respF_wDataIn$wget[93],
	       respF_pwEnqueue$whas && respF_wDataIn$wget[92],
	       IF_respF_wDataIn_whas__43_THEN_respF_wDataIn_w_ETC___d843 } ;
  ...
  assign zeroLengthMesg$EN = MUX_preciseBurst$write_1__SEL_3 ;
  ...
  // remaining internal signals
  assign IF_respF_wDataIn_whas__43_THEN_respF_wDataIn_w_ETC___d842 =
	     respF_pwEnqueue$whas ? respF_wDataIn$wget[96:94] : 3'd0 ;
  assign IF_respF_wDataIn_whas__43_THEN_respF_wDataIn_w_ETC___d843 =
  ...
  assign NOT_wmi_reqF_c_r_56_EQ_2_75_76_AND_wmi_operate_ETC___d527 =
	     ...
	     (!x__h18431 || wmi_mFlagF_c_r != 2'd2) ;
  assign addr__h20732 = { mesgLengthSoFar[10:0], 3'd0 } ;
  assign b__h14952 = -fabWordsCurReq[11:0] ;
  assign b__h18260 = { {2{fabRespCredit_value[11]}}, fabRespCredit_value } ;
  assign bl__h19963 = zeroLengthMesg ? 12'd1 : { 1'd0, x__h19874[13:3] } ;
  assign mesgMetaF_length__h20102 = { 10'd0, x__h19874 } ;
  assign mesgMetaF_length__h20862 =
	     (wsiS_reqFifo$D_OUT[93] && wsiS_reqFifo$D_OUT[15:8] == 8'd0 &&
	      mesgLengthSoFar == 14'd0) ?
	       24'd0 :
	       { 10'd0, mlp1B__h20692 } ;
  assign mlp1B__h20692 = { mlp1__h20691[10:0], 3'd0 } ;
  assign mlp1__h20691 = MUX_mesgLengthSoFar$write_1__VAL_2 ;
  assign rdat__h22341 = hasDebugLogic ? mesgCount : 32'd0 ;
  assign rdat__h22347 = hasDebugLogic ? abortCount : 32'd0 ;
  assign rdat__h22353 = hasDebugLogic ? thisMesg : 32'd0 ;
  assign rdat__h22366 = hasDebugLogic ? lastMesg : 32'd0 ;
  assign rdat__h22389 = hasDebugLogic ? { 16'd0, x__h22393 } : 32'd0 ;
  assign rdat__h22489 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h22503 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h22511 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h22517 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h22531 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h22539 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h22545 = hasDebugLogic ? wmwtBeginCount : 32'd0 ;
  assign rdat__h22551 = hasDebugLogic ? wmwtPImpCount : 32'd0 ;
  assign rdat__h22557 = hasDebugLogic ? wmwtFinalCount : 32'd0 ;
  assign rdat__h22563 = hasDebugLogic ? 32'hFEEDC0DE : 32'd0 ;
  assign sendData_burstLength__h18720 =
	     (thisMesg[15:0] == 16'd0 || smaCtrl[5] && unrollCnt == 16'd1) ?
	       12'd1 :
	       (smaCtrl[5] ? 12'd4095 : wsiBurstLength__h18638[11:0]) ;
  assign sendData_byteEn__h18722 = (thisMesg[15:0] == 16'd0) ? 8'd0 : 8'd255 ;
  assign wmi_operateD_42_AND_wmi_peerIsReady_43_44_AND__ETC___d627 =
  ...
  assign wsiBurstLength__h18638 =
	     smaCtrl[5] ? 16'd2 : { 3'd0, thisMesg[15:3] } ;
  assign wsiS_reqFifo_i_notEmpty__74_AND_NOT_smaCtrl_75_ETC___d646 =
	     wsiS_reqFifo$EMPTY_N &&
	     (smaCtrl[3:0] != 4'h3 || wsiM_reqFifo_c_r != 2'd2) &&
  ...
  assign x__h18431 = fabWordsRemain == fabWordsCurReq ;
  assign x__h19860 = opcode[8] ? opcode[7:0] : 8'd0 ;
  assign x__h19874 = mesgLength[14] ? mesgLength[13:0] : 14'd0 ;
  assign x__h22393 = { wsiS_statusR, wsiM_statusR } ;
  assign x_length__h19856 = { 2'd0, x__h19874 } ;
  always@(wci_wslv_reqF$D_OUT or
	  ...
	  rdat__h22531 or
	  rdat__h22539 or
	  rdat__h22545 or rdat__h22551 or rdat__h22557 or rdat__h22563)
  begin
    case (wci_wslv_reqF$D_OUT[39:32])
      8'h0: g_data__h22298 = smaCtrl;
      8'h04: g_data__h22298 = rdat__h22341;
      8'h08: g_data__h22298 = rdat__h22347;
      8'h10: g_data__h22298 = rdat__h22353;
      8'h14: g_data__h22298 = rdat__h22366;
      8'h18: g_data__h22298 = rdat__h22389;
      8'h20: g_data__h22298 = rdat__h22489;
      8'h24: g_data__h22298 = rdat__h22503;
      8'h28: g_data__h22298 = rdat__h22511;
      8'h2C: g_data__h22298 = rdat__h22517;
      8'h30: g_data__h22298 = rdat__h22531;
      8'h34: g_data__h22298 = rdat__h22539;
      8'h38: g_data__h22298 = rdat__h22545;
      8'h3C: g_data__h22298 = rdat__h22551;
      8'h40: g_data__h22298 = rdat__h22557;
      8'h44: g_data__h22298 = rdat__h22563;
      default: g_data__h22298 = 32'd0;
    endcase
  end
  ...
  begin
    ...
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wmwt_doAbort)
	$display("[%0d]: %m: wmwt_doAbort", v__h21630);
    if (wciS0_MReset_n)
