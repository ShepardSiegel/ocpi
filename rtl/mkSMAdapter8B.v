...
//
// On Tue Jun 21 16:40:00 EDT 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter8B(wciS0_Clk,
  ...
  reg [63 : 0] v__h18508,
	       ...
	       v__h3827,
	       v__h3971;
  reg [31 : 0] g_data__h25240, value__h6629;
  wire [91 : 0] IF_respF_wDataIn_whas__45_THEN_respF_wDataIn_w_ETC___d921;
  wire [31 : 0] rdat__h25283,
		rdat__h25289,
		rdat__h25295,
		rdat__h25308,
		rdat__h25331,
		...
		rdat__h25505,
		x__h19111;
  wire [23 : 0] mesgMetaF_length__h23011, mesgMetaF_length__h23771;
  wire [15 : 0] wsiBurstLength__h18970, x__h25335, x_length__h22765;
  wire [13 : 0] addr__h23641,
		b__h18592,
		mlp1B__h23601,
		mlp1__h23600,
		x__h22783;
  wire [11 : 0] b__h15203,
		bl__h22872,
		sendData_burstLength__h19052,
		x__h16557;
  wire [7 : 0] sendData_byteEn__h19054, x__h22769;
  wire [2 : 0] IF_respF_wDataIn_whas__45_THEN_respF_wDataIn_w_ETC___d923;
  wire NOT_wmi_reqF_c_r_57_EQ_2_76_77_AND_wmi_operate_ETC___d529,
       wci_wslv_cState_6_EQ_2_7_AND_smaCtrl_77_BITS_3_ETC___d772,
       wmi_operateD_44_AND_wmi_peerIsReady_45_46_AND__ETC___d699,
       wmi_respF_i_notEmpty__42_AND_smaCtrl_77_BIT_4__ETC___d547,
       wsiS_reqFifo_i_notEmpty__76_AND_NOT_smaCtrl_77_ETC___d718,
  ...
  assign MUX_wmi_mFlagF_x_wire$wset_1__SEL_1 =
	     WILL_FIRE_RL_wmrd_mesgBodyRequest && x__h18763 ;
  ...
  assign MUX_fabRespCredit_value$write_1__VAL_2 =
	     fabRespCredit_value +
	     (WILL_FIRE_RL_wmrd_mesgBodyRequest ? b__h15203 : 12'd0) +
  ...
  assign MUX_mesgLength$write_1__VAL_3 = { 1'd1, mlp1B__h23601 } ;
  ...
  assign MUX_thisMesg$write_1__VAL_1 =
	     { mesgCount[7:0], x__h22769, x_length__h22765 } ;
  ...
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_2 = { 2'd1, g_data__h25240 } ;
  ...
  assign MUX_wmi_mFlagF_q_0$write_1__VAL_1 =
	     (wmi_mFlagF_c_r == 2'd1) ? value__h6629 : wmi_mFlagF_q_1 ;
  assign MUX_wmi_mFlagF_q_1$write_1__VAL_1 =
	     (wmi_mFlagF_c_r == 2'd2) ? value__h6629 : 32'd0 ;
  assign MUX_wmi_mFlagF_x_wire$wset_1__VAL_2 =
	     { x__h22769, mesgMetaF_length__h23771 } ;
  assign MUX_wmi_mFlagF_x_wire$wset_1__VAL_3 =
	     { x__h22769, mesgMetaF_length__h23011 } ;
  ...
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_1 =
	     { 4'd5, x__h18763, 1'b0, mesgReqAddr, fabWordsCurReq[11:0] } ;
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_2 = { 20'd229376, bl__h22872 } ;
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_3 =
	     { 4'd3, wsiS_reqFifo$D_OUT[93], 1'b0, addr__h23641, 12'd1 } ;
  ...
  assign wmi_reqF_x_wire$whas =
	     ...
	     WILL_FIRE_RL_wmwt_requestPrecise ||
	     MUX_wsiS_reqFifo_levelsValid$write_1__SEL_2 ;
  assign wmi_mFlagF_x_wire$wget = value__h6629 ;
  ...
  assign fabRespCredit_acc_v1$wget = b__h15203 ;
  ...
  assign fabWordsCurReq$D_IN =
	     (fabWordsRemain <= b__h18592) ? fabWordsRemain : b__h18592 ;
  ...
  assign respF_rCache$D_IN =
	     { 1'd1,
	       respF_rWrPtr,
	       IF_respF_wDataIn_whas__45_THEN_respF_wDataIn_w_ETC___d923,
	       respF_pwEnqueue$whas && respF_wDataIn$wget[93],
	       respF_pwEnqueue$whas && respF_wDataIn$wget[92],
	       IF_respF_wDataIn_whas__45_THEN_respF_wDataIn_w_ETC___d921 } ;
  assign respF_rCache$EN = respF_pwEnqueue$whas ;

  // register respF_rRdPtr
  assign respF_rRdPtr$D_IN = x__h16557 ;
  ...
  always@(WILL_FIRE_RL_wmi_mFlagF_both or
	  ...
	  value__h6629 or WILL_FIRE_RL_wmi_mFlagF_decCtr or wmi_mFlagF_q_1)
  begin
    case (1'b1) // synopsys parallel_case
      WILL_FIRE_RL_wmi_mFlagF_both:
	  wmi_mFlagF_q_0$D_IN = MUX_wmi_mFlagF_q_0$write_1__VAL_1;
      MUX_wmi_mFlagF_q_0$write_1__SEL_2: wmi_mFlagF_q_0$D_IN = value__h6629;
  ...
  always@(WILL_FIRE_RL_wmi_mFlagF_both or
	  ...
	  value__h6629 or WILL_FIRE_RL_wmi_mFlagF_decCtr)
  begin
    case (1'b1) // synopsys parallel_case
      WILL_FIRE_RL_wmi_mFlagF_both:
	  wmi_mFlagF_q_1$D_IN = MUX_wmi_mFlagF_q_1$write_1__VAL_1;
      MUX_wmi_mFlagF_q_1$write_1__SEL_2: wmi_mFlagF_q_1$D_IN = value__h6629;
  ...
  // remaining internal signals
  assign IF_respF_wDataIn_whas__45_THEN_respF_wDataIn_w_ETC___d921 =
	     respF_pwEnqueue$whas ? respF_wDataIn$wget[91:0] : 92'd0 ;
  assign IF_respF_wDataIn_whas__45_THEN_respF_wDataIn_w_ETC___d923 =
  ...
  assign NOT_wmi_reqF_c_r_57_EQ_2_76_77_AND_wmi_operate_ETC___d529 =
	     ...
	     (!x__h18763 || wmi_mFlagF_c_r != 2'd2) ;
  assign addr__h23641 = { mesgLengthSoFar[10:0], 3'd0 } ;
  assign b__h15203 = -fabWordsCurReq[11:0] ;
  assign b__h18592 = { {2{fabRespCredit_value[11]}}, fabRespCredit_value } ;
  assign bl__h22872 = zeroLengthMesg ? 12'd1 : { 1'd0, x__h22783[13:3] } ;
  assign mesgMetaF_length__h23011 = { 10'd0, x__h22783 } ;
  assign mesgMetaF_length__h23771 =
	     (wsiS_reqFifo$D_OUT[93] && wsiS_reqFifo$D_OUT[15:8] == 8'd0 &&
	      mesgLengthSoFar == 14'd0) ?
	       24'd0 :
	       { 10'd0, mlp1B__h23601 } ;
  assign mlp1B__h23601 = { mlp1__h23600[10:0], 3'd0 } ;
  assign mlp1__h23600 = MUX_mesgLengthSoFar$write_1__VAL_2 ;
  assign rdat__h25283 = hasDebugLogic ? mesgCount : 32'd0 ;
  assign rdat__h25289 = hasDebugLogic ? abortCount : 32'd0 ;
  assign rdat__h25295 = hasDebugLogic ? thisMesg : 32'd0 ;
  assign rdat__h25308 = hasDebugLogic ? lastMesg : 32'd0 ;
  assign rdat__h25331 = hasDebugLogic ? { 16'd0, x__h25335 } : 32'd0 ;
  assign rdat__h25431 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h25445 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h25453 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h25459 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h25473 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h25481 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h25487 = hasDebugLogic ? wmwtBeginCount : 32'd0 ;
  assign rdat__h25493 = hasDebugLogic ? wmwtPImpCount : 32'd0 ;
  assign rdat__h25499 = hasDebugLogic ? wmwtFinalCount : 32'd0 ;
  assign rdat__h25505 = hasDebugLogic ? 32'hFEEDC0DE : 32'd0 ;
  assign sendData_burstLength__h19052 =
	     (thisMesg[15:0] == 16'd0 || smaCtrl[5] && unrollCnt == 16'd1) ?
	       12'd1 :
	       (smaCtrl[5] ? 12'd4095 : wsiBurstLength__h18970[11:0]) ;
  assign sendData_byteEn__h19054 =
	     (thisMesg[15:0] == 16'd0) ?
	       8'd0 :
	       ((unrollCnt == 16'd1) ? x__h19111[7:0] : 8'd255) ;
  assign wci_wslv_cState_6_EQ_2_7_AND_smaCtrl_77_BITS_3_ETC___d772 =
	     wci_wslv_cState == 3'd2 &&
	     (smaCtrl[3:0] == 4'h2 || smaCtrl[3:0] == 4'h3) &&
	     mesgLength[14] &&
	     !doAbort &&
  ...
  assign wmi_operateD_44_AND_wmi_peerIsReady_45_46_AND__ETC___d699 =
  ...
  assign wsiBurstLength__h18970 =
	     smaCtrl[5] ? 16'd2 : { 3'd0, thisMesg[15:3] } ;
  assign wsiS_reqFifo_i_notEmpty__76_AND_NOT_smaCtrl_77_ETC___d718 =
	     wsiS_reqFifo$EMPTY_N &&
	     (smaCtrl[3:0] != 4'h3 || wsiM_reqFifo_c_r != 2'd2) &&
  ...
  assign wsiS_reqFifo_notFull__79_AND_wsiS_burstKind_94_ETC___d401 =
	     ...
	     (wsiS_burstKind == 2'd0 ||
	      ...
	      wsiS_wsiReq$wget[93]) ;
  assign x__h16557 = respF_rRdPtr + 12'd1 ;
  assign x__h18763 = fabWordsRemain == fabWordsCurReq ;
  assign x__h19111 =
													...
													6'd30) ?
													 ...
													 (({ 3'd0,
													   ...
													   6'd31) ?
													    32'h7FFFFFFF :
													    32'hFFFFFFFF))))))))))))))))))))))))))))))) ;
  assign x__h22769 = opcode[8] ? opcode[7:0] : 8'd0 ;
  assign x__h22783 = mesgLength[14] ? mesgLength[13:0] : 14'd0 ;
  assign x__h25335 = { wsiS_statusR, wsiM_statusR } ;
  assign x_length__h22765 = { 2'd0, x__h22783 } ;
  always@(wci_wslv_reqF$D_OUT or
	  ...
	  rdat__h25473 or
	  rdat__h25481 or
	  rdat__h25487 or rdat__h25493 or rdat__h25499 or rdat__h25505)
  begin
    case (wci_wslv_reqF$D_OUT[39:32])
      8'h0: g_data__h25240 = smaCtrl;
      8'h04: g_data__h25240 = rdat__h25283;
      8'h08: g_data__h25240 = rdat__h25289;
      8'h10: g_data__h25240 = rdat__h25295;
      8'h14: g_data__h25240 = rdat__h25308;
      8'h18: g_data__h25240 = rdat__h25331;
      8'h20: g_data__h25240 = rdat__h25431;
      8'h24: g_data__h25240 = rdat__h25445;
      8'h28: g_data__h25240 = rdat__h25453;
      8'h2C: g_data__h25240 = rdat__h25459;
      8'h30: g_data__h25240 = rdat__h25473;
      8'h34: g_data__h25240 = rdat__h25481;
      8'h38: g_data__h25240 = rdat__h25487;
      8'h3C: g_data__h25240 = rdat__h25493;
      8'h40: g_data__h25240 = rdat__h25499;
      8'h44: g_data__h25240 = rdat__h25505;
      default: g_data__h25240 = 32'd0;
    endcase
  end
  ...
  begin
    case (1'b1) // synopsys parallel_case
      MUX_wmi_mFlagF_x_wire$wset_1__SEL_1:
	  value__h6629 = 32'hAAAAAAAA /* unspecified value */ ;
      MUX_endOfMessage$write_1__SEL_1:
	  value__h6629 = MUX_wmi_mFlagF_x_wire$wset_1__VAL_2;
      WILL_FIRE_RL_wmwt_requestPrecise:
	  value__h6629 = MUX_wmi_mFlagF_x_wire$wset_1__VAL_3;
      default: value__h6629 = 32'hAAAAAAAA /* unspecified value */ ;
    endcase
  end
  ...
  begin
    ...
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wmwt_doAbort)
	$display("[%0d]: %m: wmwt_doAbort", v__h24539);
    if (wciS0_MReset_n)
