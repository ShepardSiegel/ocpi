...
//
// On Tue Jun  1 12:37:58 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter8B(wciS0_Clk,
  ...
  wire [15 : 0] wsiBurstLength__h18458, x__h15543, x_length__h17088;
  ...
  wire [7 : 0] mesgMetaF_opcode__h16809, x_byteEn__h18565;
  wire [3 : 0] b__h13937;
  ...
  assign MUX_wmi_dhF_x_wire$wset_1__VAL_2 =
	     { 1'd1, x__h16715, wsiS_reqFifo$D_OUT[79:16], 8'd0 } ;
  ...
  assign errCount$EN =
	     ...
	     (!x__h16715 || wsiS_reqFifo$D_OUT[15:8] != 8'd0) ;
  ...
  assign NOT_wsiS_reqFifo_countReg_56_ULE_1_57___d358 =
	     wsiS_reqFifo_countReg > 2'd1 ;
  assign addr__h16647 = { mesgLengthSoFar[10:0], 3'd0 } ;
  ...
  assign mlp1B__h16631 = { mlp1__h16630[10:0], 3'd0 } ;
  ...
  assign x__h16715 = wsiS_reqFifo$D_OUT[91:80] == 12'd1 ;
  ...
  assign x_byteEn__h18565 = (thisMesg[15:0] == 16'd0) ? 8'd0 : 8'd255 ;
