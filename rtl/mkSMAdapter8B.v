...
//
// On Mon Jun 21 13:00:02 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter8B(wciS0_Clk,
  ...
  wire [7 : 0] mesgMetaF_opcode__h16962, x_byteEn__h18811;
  wire [3 : 0] b__h13937;
  ...
  assign MUX_wmi_dhF_x_wire$wset_1__VAL_2 =
	     { 1'd1, x__h16876, wsiS_reqFifo$D_OUT[79:16], 8'd255 } ;
  ...
  assign errCount$EN =
	     ...
	     (!x__h16876 || wsiS_reqFifo$D_OUT[15:8] != 8'd0) ;
  ...
  assign NOT_wsiS_reqFifo_countReg_59_ULE_1_60___d361 =
	     wsiS_reqFifo_countReg > 2'd1 ;
  assign addr__h16808 = { mesgLengthSoFar[10:0], 3'd0 } ;
  ...
  assign bl__h17840 =
	     zeroLengthMesg ?
	       12'd1 :
	       { 1'd0,
		 IF_mesgLength_22_BIT_14_23_THEN_mesgLength_22__ETC___d759[13:3] } ;
  ...
  assign mlp1B__h16792 = { mlp1__h16791[10:0], 3'd0 } ;
  ...
  assign x__h16876 = wsiS_reqFifo$D_OUT[91:80] == 12'd1 ;
  ...
  assign x_byteEn__h18811 = (thisMesg[15:0] == 16'd0) ? 8'd0 : 8'd255 ;
