...
//
// On Mon Jul 12 09:46:21 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter8B(wciS0_Clk,
  ...
  reg [63 : 0] v__h15685,
	       ...
	       v__h2801,
	       v__h3700;
  reg [31 : 0] value__h6077, x_data__h15818;
  wire [31 : 0] rdat__h15855,
		rdat__h15862,
		rdat__h15869,
		rdat__h15892,
		rdat__h15915,
		...
		rdat__h16057,
		rdat__h16065;
  wire [23 : 0] mesgMetaF_length__h17374, mesgMetaF_length__h18417;
  wire [15 : 0] wsiBurstLength__h19146, x__h15919, x_length__h17651;
  wire [13 : 0] IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d789,
		addr__h17221,
		b__h19767,
		mlp1B__h17205,
		mlp1__h17204;
  wire [11 : 0] bl__h18273, x_burstLength__h19242;
  wire [7 : 0] mesgMetaF_opcode__h17373, x_byteEn__h19244;
  wire [3 : 0] b__h14307;
  ...
  assign MUX_mesgLength$write_1__VAL_4 = { 1'd1, mlp1B__h17205 } ;
  assign MUX_wci_respF_x_wire$wset_1__VAL_1 = { 2'd1, x_data__h15818 } ;
  ...
  assign MUX_wmi_mFlagF_x_wire$wset_1__VAL_1 =
	     { mesgMetaF_opcode__h17373, mesgMetaF_length__h17374 } ;
  ...
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_3 =
	     { 4'd3, wsiS_reqFifo$D_OUT[93], 1'b0, addr__h17221, 12'd1 } ;
  ...
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_2 =
	     { 4'd5, x__h19567, 1'b0, mesgReqAddr, fabWordsCurReq[11:0] } ;
  assign MUX_wsiM_reqFifo_x_wire$wset_1__VAL_2 =
	     { 3'd1,
	       unrollCnt == 16'd1,
	       !smaCtrl[5],
	       x_burstLength__h19242,
  ...
  assign MUX_wmi_mFlagF_x_wire$wset_1__SEL_2 =
	     WILL_FIRE_RL_wmrd_mesgBodyRequest && x__h19567 ;
  assign MUX_fabRespCredit_value$write_1__VAL_2 =
	     fabRespCredit_value +
	     (CAN_FIRE_RL_wmrd_mesgBodyRequest ? b__h14307 : 4'd0) +
  ...
  assign MUX_thisMesg$write_1__VAL_1 =
	     { mesgCount[7:0], mesgMetaF_opcode__h17373, x_length__h17651 } ;
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_1 = { 20'd229376, bl__h18273 } ;
  ...
  assign MUX_wmi_mFlagF_x_wire$wset_1__VAL_3 =
	     { mesgMetaF_opcode__h17373, mesgMetaF_length__h18417 } ;
  ...
  assign fabRespCredit_acc_v1$wget = b__h14307 ;
  ...
  assign fabWordsCurReq$D_IN =
	     (fabWordsRemain <= b__h19767) ? fabWordsRemain : b__h19767 ;
  ...
  assign NOT_wmi_reqF_c_r_57_EQ_2_58_59_AND_wmi_operate_ETC___d308 =
	     ...
	     (!x__h19567 || wmi_mFlagF_c_r != 2'd2) ;
  assign addr__h17221 = { mesgLengthSoFar[10:0], 3'd0 } ;
  assign b__h14307 = -fabWordsCurReq[3:0] ;
  assign b__h19767 = { {10{fabRespCredit_value[3]}}, fabRespCredit_value } ;
  assign bl__h18273 =
	     zeroLengthMesg ?
	       12'd1 :
	       { 1'd0,
		 IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d789[13:3] } ;
  assign mesgMetaF_length__h17374 = { 10'd0, mlp1B__h17205 } ;
  assign mesgMetaF_length__h18417 =
	     { 10'd0,
	       IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d789 } ;
  assign mesgMetaF_opcode__h17373 = opcode[8] ? opcode[7:0] : 8'd0 ;
  assign mlp1B__h17205 = { mlp1__h17204[10:0], 3'd0 } ;
  assign mlp1__h17204 = MUX_mesgLengthSoFar$write_1__VAL_2 ;
  assign rdat__h15855 = hasDebugLogic ? mesgCount : 32'd0 ;
  assign rdat__h15862 = hasDebugLogic ? abortCount : 32'd0 ;
  assign rdat__h15869 = hasDebugLogic ? thisMesg : 32'd0 ;
  assign rdat__h15892 = hasDebugLogic ? lastMesg : 32'd0 ;
  assign rdat__h15915 = hasDebugLogic ? { 16'd0, x__h15919 } : 32'd0 ;
  assign rdat__h16015 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h16029 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h16037 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h16043 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h16057 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h16065 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  ...
  assign wsiS_reqFifo_notFull__88_AND_wsiS_burstKind_68_ETC___d404 =
	     ...
	     (wsiS_burstKind == 2'd0 ||
	      ...
	      wsiS_wsiReq$wget[93]) ;
  assign x__h15919 = { wsiS_statusR, wsiM_statusR } ;
  assign x__h19567 = fabWordsRemain == fabWordsCurReq ;
  assign x_burstLength__h19242 =
	     (thisMesg[15:0] == 16'd0 || smaCtrl[5] && unrollCnt == 16'd1) ?
	       12'd1 :
	       (smaCtrl[5] ? 12'd4095 : wsiBurstLength__h19146[11:0]) ;
  assign x_byteEn__h19244 = (thisMesg[15:0] == 16'd0) ? 8'd0 : 8'd255 ;
  assign x_length__h17651 =
	     { 2'd0,
	       IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d789 } ;
  always@(wci_reqF$D_OUT or
	  ...
	  rdat__h16015 or
	  rdat__h16029 or
	  rdat__h16037 or rdat__h16043 or rdat__h16057 or rdat__h16065)
  begin
    case (wci_reqF$D_OUT[39:32])
      8'h0: x_data__h15818 = smaCtrl;
      8'h04: x_data__h15818 = rdat__h15855;
      8'h08: x_data__h15818 = rdat__h15862;
      8'h10: x_data__h15818 = rdat__h15869;
      8'h14: x_data__h15818 = rdat__h15892;
      8'h18: x_data__h15818 = rdat__h15915;
      8'h20: x_data__h15818 = rdat__h16015;
      8'h24: x_data__h15818 = rdat__h16029;
      8'h28: x_data__h15818 = rdat__h16037;
      8'h2C: x_data__h15818 = rdat__h16043;
      8'h30: x_data__h15818 = rdat__h16057;
      8'h34: x_data__h15818 = rdat__h16065;
      default: x_data__h15818 = 32'd0;
    endcase
  end
  always@(MUX_endOfMessage$write_1__SEL_1 or
  ...
  begin
    ...
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wmwt_doAbort)
	$display("[%0d]: %m: wmwt_doAbort", v__h16866);
    if (wciS0_MReset_n)
