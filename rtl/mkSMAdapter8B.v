...
//
// On Wed Jun 22 17:51:03 EDT 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter8B(wciS0_Clk,
  ...
  wire [96 : 0] respF_memory$DIA, respF_memory$DIB, respF_memory$DOB;
  ...
  reg [63 : 0] v__h18234,
	       ...
	       v__h3825,
	       v__h3969;
  reg [31 : 0] g_data__h24066;
  wire [91 : 0] IF_respF_wDataIn_whas__45_THEN_respF_wDataIn_w_ETC___d967;
  wire [31 : 0] rdat__h24109,
		rdat__h24115,
		rdat__h24121,
		rdat__h24134,
		rdat__h24157,
  ...
  wire [15 : 0] wsiBurstLength__h18693, x__h24161, x_length__h23097;
  wire [13 : 0] addr__h22400, b__h18318, mlB__h22360, mlInc__h22359;
  wire [11 : 0] b__h15201, sendData_burstLength__h18775, x__h16555;
  wire [7 : 0] mesgMetaF_opcode__h22533, sendData_byteEn__h18777;
  wire [3 : 0] x__h22573,
	       x__h22585,
	       x__h22597,
	       x__h22609,
	       ...
	       y__h22634,
	       y__h22646;
  wire [2 : 0] IF_respF_wDataIn_whas__45_THEN_respF_wDataIn_w_ETC___d970;
  ...
  // value method wmiM0_mDataValid
  assign wmiM0_MDataValid = !wmi_sDataThreadBusy_d && wmi_dhF_q_0[73] ;

  // value method wmiM0_mDataLast
  assign wmiM0_MDataLast = wmi_dhF_q_0[72] ;

  // value method wmiM0_mData
  assign wmiM0_MData = wmi_dhF_q_0[71:8] ;

  // value method wmiM0_mDataByteEn
  assign wmiM0_MDataByteEn = wmi_dhF_q_0[7:0] ;
  ...
  assign MUX_endOfMessage$write_1__SEL_1 =
	     WILL_FIRE_RL_wmwt_messagePush && wsiS_reqFifo$D_OUT[93] ;
  ...
  assign MUX_thisMesg$write_1__VAL_1 =
	     { mesgCount[7:0], mesgMetaF_opcode__h22533, x_length__h23097 } ;
  ...
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_2 = { 2'd1, g_data__h24066 } ;
  ...
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_2 =
	     { 4'd3, wsiS_reqFifo$D_OUT[93], 1'b0, addr__h22400, 12'd1 } ;
  ...
  assign MUX_wsiM_reqFifo_x_wire$wset_1__VAL_3 =
	     (respF_rCache[109] && respF_rCache[108:97] == respF_rRdPtr) ?
	       respF_rCache[96:0] :
	       respF_memory$DOB ;
  ...
  assign errCount$EN =
	     ...
	     (!wsiS_reqFifo$D_OUT[93] || wsiS_reqFifo$D_OUT[15:8] != 8'd0 ||
  ...
  assign respF_rCache$D_IN =
	     { 1'd1,
	       respF_rWrPtr,
	       IF_respF_wDataIn_whas__45_THEN_respF_wDataIn_w_ETC___d970,
	       respF_pwEnqueue$whas && respF_wDataIn$wget[93],
	       respF_pwEnqueue$whas && respF_wDataIn$wget[92],
	       IF_respF_wDataIn_whas__45_THEN_respF_wDataIn_w_ETC___d967 } ;
  ...
  // remaining internal signals
  assign IF_respF_wDataIn_whas__45_THEN_respF_wDataIn_w_ETC___d967 =
	     respF_pwEnqueue$whas ? respF_wDataIn$wget[91:0] : 92'd0 ;
  assign IF_respF_wDataIn_whas__45_THEN_respF_wDataIn_w_ETC___d970 =
	     respF_pwEnqueue$whas ? respF_wDataIn$wget[96:94] : 3'd0 ;
  ...
  assign addr__h22400 = { mesgLengthSoFar[10:0], 3'd0 } ;
  ...
  assign mlInc__h22359 =
	     wsiS_reqFifo$D_OUT[93] ?
	       { 10'd0, x__h22573 + y__h22574 } :
	       14'd8 ;
  assign rdat__h24109 = hasDebugLogic ? mesgCount : 32'd0 ;
  assign rdat__h24115 = hasDebugLogic ? abortCount : 32'd0 ;
  assign rdat__h24121 = hasDebugLogic ? thisMesg : 32'd0 ;
  assign rdat__h24134 = hasDebugLogic ? lastMesg : 32'd0 ;
  assign rdat__h24157 = hasDebugLogic ? { 16'd0, x__h24161 } : 32'd0 ;
  assign rdat__h24257 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h24271 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h24279 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h24285 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h24299 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h24307 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h24313 = hasDebugLogic ? wmwtBeginCount : 32'd0 ;
  assign rdat__h24319 = hasDebugLogic ? wmwtPushCount : 32'd0 ;
  assign rdat__h24325 = hasDebugLogic ? wmwtFinalCount : 32'd0 ;
  assign rdat__h24331 = hasDebugLogic ? 32'hFEEDC0DE : 32'd0 ;
  ...
  assign sendData_byteEn__h18777 =
	     (thisMesg[15:0] == 16'd0) ?
	       8'd0 :
	       ((unrollCnt == 16'd1) ? x__h18834[7:0] : 8'd255) ;
  assign value__h6627 =
	     MUX_wmi_mFlagF_x_wire$wset_1__SEL_1 ?
  ...
  assign wsiS_reqFifo_i_notEmpty__76_AND_NOT_smaCtrl_77_ETC___d675 =
	     ...
	     (!wsiS_reqFifo$D_OUT[93] || wmi_mFlagF_c_r != 2'd2) ;
  ...
  assign x__h18834 =
	     ({ 3'd0, thisMesg[2:0] } == 6'd0) ?
	       32'hFFFFFFFF :
	       (({ 3'd0, thisMesg[2:0] } <= 6'd1) ?
		  32'd1 :
		  (({ 3'd0, thisMesg[2:0] } <= 6'd2) ?
		     32'd3 :
		     (({ 3'd0, thisMesg[2:0] } <= 6'd3) ?
			32'd7 :
			(({ 3'd0, thisMesg[2:0] } <= 6'd4) ?
			   32'd15 :
			   (({ 3'd0, thisMesg[2:0] } <= 6'd5) ?
			      32'd31 :
			      (({ 3'd0, thisMesg[2:0] } <= 6'd6) ?
				 32'd63 :
				 (({ 3'd0, thisMesg[2:0] } <= 6'd7) ?
				    32'd127 :
				    (({ 3'd0, thisMesg[2:0] } <= 6'd8) ?
				       32'd255 :
				       (({ 3'd0, thisMesg[2:0] } <= 6'd9) ?
					  32'd511 :
					  (({ 3'd0, thisMesg[2:0] } <=
					    6'd10) ?
					     32'd1023 :
  ...
  assign x__h22645 = { 3'd0, wsiS_reqFifo$D_OUT[15] } ;
  assign x__h24161 = { wsiS_statusR, wsiM_statusR } ;
  assign x_length__h23097 = { 2'd0, mlB__h22360 } ;
  assign y__h22574 = { 3'd0, wsiS_reqFifo$D_OUT[8] } ;
  assign y__h22586 = { 3'd0, wsiS_reqFifo$D_OUT[9] } ;
  assign y__h22598 = { 3'd0, wsiS_reqFifo$D_OUT[10] } ;
  assign y__h22610 = { 3'd0, wsiS_reqFifo$D_OUT[11] } ;
  assign y__h22622 = { 3'd0, wsiS_reqFifo$D_OUT[12] } ;
  assign y__h22634 = { 3'd0, wsiS_reqFifo$D_OUT[13] } ;
  assign y__h22646 = { 3'd0, wsiS_reqFifo$D_OUT[14] } ;
  always@(wci_wslv_reqF$D_OUT or
	  ...
	  rdat__h24299 or
	  rdat__h24307 or
	  rdat__h24313 or rdat__h24319 or rdat__h24325 or rdat__h24331)
  begin
    case (wci_wslv_reqF$D_OUT[39:32])
      8'h0: g_data__h24066 = smaCtrl;
      8'h04: g_data__h24066 = rdat__h24109;
      8'h08: g_data__h24066 = rdat__h24115;
      8'h10: g_data__h24066 = rdat__h24121;
      8'h14: g_data__h24066 = rdat__h24134;
      8'h18: g_data__h24066 = rdat__h24157;
      8'h20: g_data__h24066 = rdat__h24257;
      8'h24: g_data__h24066 = rdat__h24271;
      8'h28: g_data__h24066 = rdat__h24279;
      8'h2C: g_data__h24066 = rdat__h24285;
      8'h30: g_data__h24066 = rdat__h24299;
      8'h34: g_data__h24066 = rdat__h24307;
      8'h38: g_data__h24066 = rdat__h24313;
      8'h3C: g_data__h24066 = rdat__h24319;
      8'h40: g_data__h24066 = rdat__h24325;
      8'h44: g_data__h24066 = rdat__h24331;
      default: g_data__h24066 = 32'd0;
    endcase
  end
  ...
  begin
    ...
    readyToPush = 1'h0;
    readyToRequest = 1'h0;
    respF_rCache = 110'h2AAAAAAAAAAAAAAAAAAAAAAAAAAA;
  ...
  begin
    ...
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wmwt_doAbort)
	$display("[%0d]: %m: wmwt_doAbort", v__h23517);
    if (wciS0_MReset_n)
