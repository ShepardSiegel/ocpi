...
//
// On Tue Jun 29 13:17:29 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter8B(wciS0_Clk,
  ...
  wire [31 : 0] rdat__h15474,
		...
		rdat__h15676,
		rdat__h15684;
  wire [23 : 0] mesgMetaF_length__h16962, mesgMetaF_length__h17986;
  wire [15 : 0] wsiBurstLength__h18715, x__h15538, x_length__h17239;
  wire [13 : 0] IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d766,
		addr__h16809,
		b__h19336,
		mlp1B__h16793,
		mlp1__h16792;
  wire [11 : 0] bl__h17842, x_burstLength__h18811;
  wire [7 : 0] mesgMetaF_opcode__h16961, x_byteEn__h18813;
  wire [3 : 0] b__h13926;
  wire NOT_wmi_dhF_c_r_61_EQ_2_62_63_AND_wmi_operateD_ETC___d221,
       NOT_wmi_reqF_c_r_58_EQ_2_59_60_AND_wmi_operate_ETC___d308,
       NOT_wsiS_reqFifo_countReg_71_ULE_1_72___d373,
  ...
  assign CAN_FIRE_RL_wmwt_messagePushPrecise =
	     wsiS_reqFifo$EMPTY_N &&
	     NOT_wmi_dhF_c_r_61_EQ_2_62_63_AND_wmi_operateD_ETC___d221 &&
	     wci_cState == 3'd2 &&
	     (smaCtrl[3:0] == 4'h2 || smaCtrl[3:0] == 4'h3) &&
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_1 = { 2'd1, x_data__h15437 } ;
  ...
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_3 =
	     { 4'd3, wsiS_reqFifo$D_OUT[93], 1'b0, addr__h16809, 12'd1 } ;
  ...
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_2 =
	     { 4'd5, x__h19136, 1'b0, mesgReqAddr, fabWordsCurReq[11:0] } ;
  assign MUX_wsiM_reqFifo_x_wire$wset_1__VAL_2 =
	     { 3'd1,
	       unrollCnt == 16'd1,
	       !smaCtrl[5],
	       x_burstLength__h18811,
  ...
  assign MUX_wmi_mFlagF_x_wire$wset_1__SEL_2 =
	     WILL_FIRE_RL_wmrd_mesgBodyRequest && x__h19136 ;
  ...
  assign MUX_wmi_mFlagF_x_wire$wset_1__VAL_3 =
	     { mesgMetaF_opcode__h16961, mesgMetaF_length__h17986 } ;
  ...
  assign fabWordsCurReq$D_IN =
	     (fabWordsRemain <= b__h19336) ? fabWordsRemain : b__h19336 ;
  ...
  // remaining internal signals
  assign IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d766 =
	     mesgLength[14] ? mesgLength[13:0] : 14'd0 ;
  assign NOT_wmi_dhF_c_r_61_EQ_2_62_63_AND_wmi_operateD_ETC___d221 =
	     wmi_dhF_c_r != 2'd2 && wmi_operateD && wmi_peerIsReady &&
	     (smaCtrl[3:0] != 4'h3 || wsiM_reqFifo_c_r != 2'd2) ;
  assign NOT_wmi_reqF_c_r_58_EQ_2_59_60_AND_wmi_operate_ETC___d308 =
	     wmi_reqF_c_r != 2'd2 && wmi_operateD && wmi_peerIsReady &&
	     (!x__h19136 || wmi_mFlagF_c_r != 2'd2) ;
  assign NOT_wsiS_reqFifo_countReg_71_ULE_1_72___d373 =
	     wsiS_reqFifo_countReg > 2'd1 ;
  assign addr__h16809 = { mesgLengthSoFar[10:0], 3'd0 } ;
  assign b__h13926 = -fabWordsCurReq[3:0] ;
  assign b__h19336 = { {10{fabRespCredit_value[3]}}, fabRespCredit_value } ;
  assign bl__h17842 =
	     zeroLengthMesg ?
	       12'd1 :
	       { 1'd0,
		 IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d766[13:3] } ;
  assign mesgMetaF_length__h16962 = { 10'd0, mlp1B__h16793 } ;
  assign mesgMetaF_length__h17986 =
	     { 10'd0,
	       IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d766 } ;
  assign mesgMetaF_opcode__h16961 = opcode[8] ? opcode[7:0] : 8'd0 ;
  assign mlp1B__h16793 = { mlp1__h16792[10:0], 3'd0 } ;
  ...
  assign wsiBurstLength__h18715 =
	     smaCtrl[5] ? 16'd2 : { 3'd0, thisMesg[15:3] } ;
  assign x__h15538 = { wsiS_statusR, wsiM_statusR } ;
  assign x__h19136 = fabWordsRemain == fabWordsCurReq ;
  assign x_burstLength__h18811 =
	     (thisMesg[15:0] == 16'd0 || smaCtrl[5] && unrollCnt == 16'd1) ?
	       12'd1 :
	       (smaCtrl[5] ? 12'd4095 : wsiBurstLength__h18715[11:0]) ;
  assign x_byteEn__h18813 = (thisMesg[15:0] == 16'd0) ? 8'd0 : 8'd255 ;
