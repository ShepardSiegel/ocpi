...
//
// On Sun Apr  3 10:10:42 EDT 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter8B(wciS0_Clk,
  ...
  reg [63 : 0] v__h18505,
	       ...
	       v__h3824,
	       v__h3968;
  reg [31 : 0] g_data__h22694, value__h6626;
  wire [91 : 0] IF_respF_wDataIn_whas__45_THEN_respF_wDataIn_w_ETC___d855;
  wire [31 : 0] rdat__h22737,
		rdat__h22743,
		rdat__h22749,
		rdat__h22762,
		rdat__h22785,
		...
		rdat__h22953,
		rdat__h22959;
  wire [23 : 0] mesgMetaF_length__h20465, mesgMetaF_length__h21225;
  wire [15 : 0] wsiBurstLength__h18967, x__h22789, x_length__h20219;
  wire [13 : 0] addr__h21095,
		b__h18589,
		mlp1B__h21055,
		mlp1__h21054,
		x__h20237;
  wire [11 : 0] b__h15200,
		...
		x__h16554;
  wire [7 : 0] sendData_byteEn__h19051, x__h20223;
  wire [2 : 0] IF_respF_wDataIn_whas__45_THEN_respF_wDataIn_w_ETC___d857;
  wire NOT_wmi_reqF_c_r_57_EQ_2_76_77_AND_wmi_operate_ETC___d529,
       wci_wslv_cState_6_EQ_2_7_AND_smaCtrl_77_BITS_3_ETC___d704,
       wmi_operateD_44_AND_wmi_peerIsReady_45_46_AND__ETC___d631,
       wmi_respF_i_notEmpty__42_AND_smaCtrl_77_BIT_4__ETC___d547,
       wsiS_reqFifo_i_notEmpty__76_AND_NOT_smaCtrl_77_ETC___d650,
  ...
  assign MUX_mesgLength$write_1__VAL_3 = { 1'd1, mlp1B__h21055 } ;
  ...
  assign MUX_thisMesg$write_1__VAL_1 =
	     { mesgCount[7:0], x__h20223, x_length__h20219 } ;
  ...
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_2 = { 2'd1, g_data__h22694 } ;
  ...
  assign MUX_wmi_mFlagF_x_wire$wset_1__VAL_2 =
	     { x__h20223, mesgMetaF_length__h21225 } ;
  assign MUX_wmi_mFlagF_x_wire$wset_1__VAL_3 =
	     { x__h20223, mesgMetaF_length__h20465 } ;
  ...
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_2 = { 20'd229376, bl__h20326 } ;
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_3 =
	     { 4'd3, wsiS_reqFifo$D_OUT[93], 1'b0, addr__h21095, 12'd1 } ;
  ...
  assign respF_rCache$D_IN =
	     { 1'd1,
	       respF_rWrPtr,
	       IF_respF_wDataIn_whas__45_THEN_respF_wDataIn_w_ETC___d857,
	       respF_pwEnqueue$whas && respF_wDataIn$wget[93],
	       respF_pwEnqueue$whas && respF_wDataIn$wget[92],
	       IF_respF_wDataIn_whas__45_THEN_respF_wDataIn_w_ETC___d855 } ;
  ...
  // remaining internal signals
  assign IF_respF_wDataIn_whas__45_THEN_respF_wDataIn_w_ETC___d855 =
	     respF_pwEnqueue$whas ? respF_wDataIn$wget[91:0] : 92'd0 ;
  assign IF_respF_wDataIn_whas__45_THEN_respF_wDataIn_w_ETC___d857 =
  ...
  assign addr__h21095 = { mesgLengthSoFar[10:0], 3'd0 } ;
  assign b__h15200 = -fabWordsCurReq[11:0] ;
  assign b__h18589 = { {2{fabRespCredit_value[11]}}, fabRespCredit_value } ;
  assign bl__h20326 = zeroLengthMesg ? 12'd1 : { 1'd0, x__h20237[13:3] } ;
  assign mesgMetaF_length__h20465 = { 10'd0, x__h20237 } ;
  assign mesgMetaF_length__h21225 =
	     (wsiS_reqFifo$D_OUT[93] && wsiS_reqFifo$D_OUT[15:8] == 8'd0 &&
	      mesgLengthSoFar == 14'd0) ?
	       24'd0 :
	       { 10'd0, mlp1B__h21055 } ;
  assign mlp1B__h21055 = { mlp1__h21054[10:0], 3'd0 } ;
  assign mlp1__h21054 = MUX_mesgLengthSoFar$write_1__VAL_2 ;
  assign rdat__h22737 = hasDebugLogic ? mesgCount : 32'd0 ;
  assign rdat__h22743 = hasDebugLogic ? abortCount : 32'd0 ;
  assign rdat__h22749 = hasDebugLogic ? thisMesg : 32'd0 ;
  assign rdat__h22762 = hasDebugLogic ? lastMesg : 32'd0 ;
  assign rdat__h22785 = hasDebugLogic ? { 16'd0, x__h22789 } : 32'd0 ;
  assign rdat__h22885 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h22899 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h22907 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h22913 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h22927 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h22935 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h22941 = hasDebugLogic ? wmwtBeginCount : 32'd0 ;
  assign rdat__h22947 = hasDebugLogic ? wmwtPImpCount : 32'd0 ;
  assign rdat__h22953 = hasDebugLogic ? wmwtFinalCount : 32'd0 ;
  assign rdat__h22959 = hasDebugLogic ? 32'hFEEDC0DE : 32'd0 ;
  ...
  assign sendData_byteEn__h19051 = (thisMesg[15:0] == 16'd0) ? 8'd0 : 8'd255 ;
  assign wci_wslv_cState_6_EQ_2_7_AND_smaCtrl_77_BITS_3_ETC___d704 =
	     wci_wslv_cState == 3'd2 &&
	     (smaCtrl[3:0] == 4'h2 || smaCtrl[3:0] == 4'h3) &&
	     mesgLength[14] &&
	     !doAbort &&
  ...
  assign wmi_operateD_44_AND_wmi_peerIsReady_45_46_AND__ETC___d631 =
  ...
  assign wsiS_reqFifo_i_notEmpty__76_AND_NOT_smaCtrl_77_ETC___d650 =
	     wsiS_reqFifo$EMPTY_N &&
	     (smaCtrl[3:0] != 4'h3 || wsiM_reqFifo_c_r != 2'd2) &&
  ...
  assign x__h20223 = opcode[8] ? opcode[7:0] : 8'd0 ;
  assign x__h20237 = mesgLength[14] ? mesgLength[13:0] : 14'd0 ;
  assign x__h22789 = { wsiS_statusR, wsiM_statusR } ;
  assign x_length__h20219 = { 2'd0, x__h20237 } ;
  always@(wci_wslv_reqF$D_OUT or
	  ...
	  rdat__h22927 or
	  rdat__h22935 or
	  rdat__h22941 or rdat__h22947 or rdat__h22953 or rdat__h22959)
  begin
    case (wci_wslv_reqF$D_OUT[39:32])
      8'h0: g_data__h22694 = smaCtrl;
      8'h04: g_data__h22694 = rdat__h22737;
      8'h08: g_data__h22694 = rdat__h22743;
      8'h10: g_data__h22694 = rdat__h22749;
      8'h14: g_data__h22694 = rdat__h22762;
      8'h18: g_data__h22694 = rdat__h22785;
      8'h20: g_data__h22694 = rdat__h22885;
      8'h24: g_data__h22694 = rdat__h22899;
      8'h28: g_data__h22694 = rdat__h22907;
      8'h2C: g_data__h22694 = rdat__h22913;
      8'h30: g_data__h22694 = rdat__h22927;
      8'h34: g_data__h22694 = rdat__h22935;
      8'h38: g_data__h22694 = rdat__h22941;
      8'h3C: g_data__h22694 = rdat__h22947;
      8'h40: g_data__h22694 = rdat__h22953;
      8'h44: g_data__h22694 = rdat__h22959;
      default: g_data__h22694 = 32'd0;
    endcase
  end
  ...
  begin
    ...
    if (wciS0_MReset_n)
      if (MUX_opcode$write_1__SEL_2)
	$display("[%0d]: %m: wmwt_doAbort", v__h21993);
    if (wciS0_MReset_n)
