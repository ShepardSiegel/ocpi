...
//
// On Mon Sep 13 07:38:27 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter8B(wciS0_Clk,
  ...
  reg [63 : 0] v__h15873,
	       ...
	       v__h2801,
	       v__h3700;
  reg [31 : 0] value__h6079, x_data__h16006;
  wire [31 : 0] rdat__h16043,
		rdat__h16050,
		rdat__h16057,
		rdat__h16080,
		rdat__h16103,
		...
		rdat__h16245,
		rdat__h16253;
  wire [23 : 0] mesgMetaF_length__h17562, mesgMetaF_length__h18605;
  wire [15 : 0] wsiBurstLength__h19334, x__h16107, x_length__h17839;
  wire [13 : 0] IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d786,
		addr__h17409,
		b__h19955,
		mlp1B__h17393,
		mlp1__h17392;
  wire [11 : 0] bl__h18461, x_burstLength__h19430;
  wire [7 : 0] mesgMetaF_opcode__h17561, x_byteEn__h19432;
  wire [3 : 0] b__h14495;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_1 = { 2'd1, x_data__h16006 } ;
  ...
  assign MUX_mesgLength$write_1__VAL_4 = { 1'd1, mlp1B__h17393 } ;
  ...
  assign MUX_wmi_mFlagF_x_wire$wset_1__VAL_1 =
	     { mesgMetaF_opcode__h17561, mesgMetaF_length__h17562 } ;
  ...
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_3 =
	     { 4'd3, wsiS_reqFifo$D_OUT[93], 1'b0, addr__h17409, 12'd1 } ;
  ...
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_2 =
	     { 4'd5, x__h19755, 1'b0, mesgReqAddr, fabWordsCurReq[11:0] } ;
  assign MUX_wsiM_reqFifo_x_wire$wset_1__VAL_2 =
	     { 3'd1,
	       unrollCnt == 16'd1,
	       !smaCtrl[5],
	       x_burstLength__h19430,
  ...
  assign MUX_wmi_mFlagF_x_wire$wset_1__SEL_2 =
	     WILL_FIRE_RL_wmrd_mesgBodyRequest && x__h19755 ;
  assign MUX_fabRespCredit_value$write_1__VAL_2 =
	     fabRespCredit_value +
	     (CAN_FIRE_RL_wmrd_mesgBodyRequest ? b__h14495 : 4'd0) +
  ...
  assign MUX_thisMesg$write_1__VAL_1 =
	     { mesgCount[7:0], mesgMetaF_opcode__h17561, x_length__h17839 } ;
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_1 = { 20'd229376, bl__h18461 } ;
  ...
  assign MUX_wmi_mFlagF_x_wire$wset_1__VAL_3 =
	     { mesgMetaF_opcode__h17561, mesgMetaF_length__h18605 } ;
  ...
  assign fabWordsCurReq$D_IN =
	     (fabWordsRemain <= b__h19955) ? fabWordsRemain : b__h19955 ;
  ...
  assign mesgLengthSoFar$D_IN =
	     MUX_impreciseBurst$write_1__SEL_2 ? 14'd0 : mlp1__h17392 ;
  ...
  assign NOT_wmi_reqF_c_r_57_EQ_2_58_59_AND_wmi_operate_ETC___d308 =
	     ...
	     (!x__h19755 || wmi_mFlagF_c_r != 2'd2) ;
  assign addr__h17409 = { mesgLengthSoFar[10:0], 3'd0 } ;
  assign b__h14495 = -fabWordsCurReq[3:0] ;
  assign b__h19955 = { {10{fabRespCredit_value[3]}}, fabRespCredit_value } ;
  assign bl__h18461 =
	     zeroLengthMesg ?
	       12'd1 :
	       { 1'd0,
		 IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d786[13:3] } ;
  assign mesgMetaF_length__h17562 = { 10'd0, mlp1B__h17393 } ;
  assign mesgMetaF_length__h18605 =
	     { 10'd0,
	       IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d786 } ;
  assign mesgMetaF_opcode__h17561 = opcode[8] ? opcode[7:0] : 8'd0 ;
  assign mlp1B__h17393 = { mlp1__h17392[10:0], 3'd0 } ;
  assign mlp1__h17392 = mesgLengthSoFar + 14'd1 ;
  assign rdat__h16043 = hasDebugLogic ? mesgCount : 32'd0 ;
  assign rdat__h16050 = hasDebugLogic ? abortCount : 32'd0 ;
  assign rdat__h16057 = hasDebugLogic ? thisMesg : 32'd0 ;
  assign rdat__h16080 = hasDebugLogic ? lastMesg : 32'd0 ;
  assign rdat__h16103 = hasDebugLogic ? { 16'd0, x__h16107 } : 32'd0 ;
  assign rdat__h16203 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h16217 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h16225 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h16231 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h16245 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h16253 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  ...
  assign wsiS_reqFifo_notFull__88_AND_wsiS_burstKind_68_ETC___d408 =
	     ...
	     (wsiS_burstKind == 2'd0 ||
	      ...
	      wsiS_wsiReq$wget[93]) ;
  assign x__h16107 = { wsiS_statusR, wsiM_statusR } ;
  assign x__h19755 = fabWordsRemain == fabWordsCurReq ;
  assign x_burstLength__h19430 =
	     (thisMesg[15:0] == 16'd0 || smaCtrl[5] && unrollCnt == 16'd1) ?
	       12'd1 :
	       (smaCtrl[5] ? 12'd4095 : wsiBurstLength__h19334[11:0]) ;
  assign x_byteEn__h19432 = (thisMesg[15:0] == 16'd0) ? 8'd0 : 8'd255 ;
  assign x_length__h17839 =
	     { 2'd0,
	       IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d786 } ;
  always@(wci_reqF$D_OUT or
	  ...
	  rdat__h16203 or
	  rdat__h16217 or
	  rdat__h16225 or rdat__h16231 or rdat__h16245 or rdat__h16253)
  begin
    case (wci_reqF$D_OUT[39:32])
      8'h0: x_data__h16006 = smaCtrl;
      8'h04: x_data__h16006 = rdat__h16043;
      8'h08: x_data__h16006 = rdat__h16050;
      8'h10: x_data__h16006 = rdat__h16057;
      8'h14: x_data__h16006 = rdat__h16080;
      8'h18: x_data__h16006 = rdat__h16103;
      8'h20: x_data__h16006 = rdat__h16203;
      8'h24: x_data__h16006 = rdat__h16217;
      8'h28: x_data__h16006 = rdat__h16225;
      8'h2C: x_data__h16006 = rdat__h16231;
      8'h30: x_data__h16006 = rdat__h16245;
      8'h34: x_data__h16006 = rdat__h16253;
      default: x_data__h16006 = 32'd0;
    endcase
  end
  always@(MUX_endOfMessage$write_1__SEL_1 or
  ...
  begin
    ...
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wmwt_doAbort)
	$display("[%0d]: %m: wmwt_doAbort", v__h17054);
    if (wciS0_MReset_n)
