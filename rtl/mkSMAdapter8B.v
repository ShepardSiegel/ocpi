...
//
// On Tue Apr 26 09:25:13 EDT 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter8B(wciS0_Clk,
  ...
  wire MUX_endOfMessage$write_1__SEL_1,
       ...
       MUX_wci_wslv_ctlOpActive$write_1__SEL_1,
  ...
  wire [91 : 0] IF_respF_wDataIn_whas__45_THEN_respF_wDataIn_w_ETC___d851;
  ...
  wire [2 : 0] IF_respF_wDataIn_whas__45_THEN_respF_wDataIn_w_ETC___d853;
  ...
  assign MUX_mesgReqOK$write_1__SEL_3 =
	     ...
	     !WILL_FIRE_RL_wmrd_mesgBodyRequest ;
  assign MUX_wci_wslv_ctlOpActive$write_1__SEL_1 =
  ...
  assign MUX_wci_wslv_respF_q_0$write_1__VAL_1 =
	     (wci_wslv_respF_c_r == 2'd1) ?
	       ...
	       wci_wslv_respF_q_1 ;
  always@(MUX_wci_wslv_ctlOpActive$write_1__SEL_1 or
  ...
  assign mesgLengthSoFar$D_IN =
	     MUX_impreciseBurst$write_1__SEL_3 ? 14'd0 : mlp1__h21054 ;
  ...
  assign respF_rCache$D_IN =
	     { 1'd1,
	       respF_rWrPtr,
	       IF_respF_wDataIn_whas__45_THEN_respF_wDataIn_w_ETC___d853,
	       respF_pwEnqueue$whas && respF_wDataIn$wget[93],
	       respF_pwEnqueue$whas && respF_wDataIn$wget[92],
	       IF_respF_wDataIn_whas__45_THEN_respF_wDataIn_w_ETC___d851 } ;
  ...
  assign wci_wslv_illegalEdge$EN =
	     MUX_wci_wslv_illegalEdge$write_1__SEL_1 ||
	     MUX_wci_wslv_ctlOpActive$write_1__SEL_1 && wci_wslv_illegalEdge ;
  ...
  // remaining internal signals
  assign IF_respF_wDataIn_whas__45_THEN_respF_wDataIn_w_ETC___d851 =
	     respF_pwEnqueue$whas ? respF_wDataIn$wget[91:0] : 92'd0 ;
  assign IF_respF_wDataIn_whas__45_THEN_respF_wDataIn_w_ETC___d853 =
  ...
  assign mlp1__h21054 = mesgLengthSoFar + 14'd1 ;
  ...
  begin
    ...
    if (wciS0_MReset_n)
      if (MUX_wci_wslv_ctlOpActive$write_1__SEL_1 && wci_wslv_illegalEdge)
	begin
	  v__h3968 = $time;
	  #0;
	end
