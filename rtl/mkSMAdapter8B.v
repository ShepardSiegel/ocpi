...
//
// On Sun Jan 16 12:20:34 EST 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter8B(wciS0_Clk,
  ...
  reg [63 : 0] v__h18056,
	       ...
	       v__h3761,
	       v__h3905;
  reg [31 : 0] g_data__h21865, value__h6563;
  wire [91 : 0] IF_respF_wDataIn_whas__43_THEN_respF_wDataIn_w_ETC___d814;
  wire [31 : 0] rdat__h21908,
		rdat__h21914,
		rdat__h21920,
		rdat__h21933,
		rdat__h21956,
		...
		rdat__h22098,
		rdat__h22106;
  wire [23 : 0] mesgMetaF_length__h19853, mesgMetaF_length__h20589;
  wire [15 : 0] wsiBurstLength__h18518, x__h21960, x_length__h19607;
  wire [13 : 0] addr__h20459,
		b__h18140,
		mlp1B__h20443,
		mlp1__h20442,
		x__h19625;
  wire [11 : 0] b__h14952,
		...
		x__h16306;
  wire [7 : 0] sendData_byteEn__h18602, x__h19611;
  wire [2 : 0] IF_respF_wDataIn_whas__43_THEN_respF_wDataIn_w_ETC___d813;
  wire NOT_wmi_reqF_c_r_56_EQ_2_75_76_AND_wmi_operate_ETC___d527,
       wmi_operateD_42_AND_wmi_peerIsReady_43_44_AND__ETC___d625,
       wmi_respF_i_notEmpty__40_AND_smaCtrl_75_BIT_4__ETC___d545,
       wsiS_reqFifo_i_notEmpty__74_AND_NOT_smaCtrl_75_ETC___d644,
  ...
  assign MUX_mesgLength$write_1__VAL_3 = { 1'd1, mlp1B__h20443 } ;
  ...
  assign MUX_thisMesg$write_1__VAL_1 =
	     { mesgCount[7:0], x__h19611, x_length__h19607 } ;
  ...
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_2 = { 2'd1, g_data__h21865 } ;
  ...
  assign MUX_wmi_mFlagF_x_wire$wset_1__VAL_2 =
	     { x__h19611, mesgMetaF_length__h20589 } ;
  assign MUX_wmi_mFlagF_x_wire$wset_1__VAL_3 =
	     { x__h19611, mesgMetaF_length__h19853 } ;
  ...
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_2 = { 20'd229376, bl__h19714 } ;
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_3 =
	     { 4'd3, wsiS_reqFifo$D_OUT[93], 1'b0, addr__h20459, 12'd1 } ;
  ...
  assign respF_rCache$D_IN =
	     { 1'd1,
	       respF_rWrPtr,
	       IF_respF_wDataIn_whas__43_THEN_respF_wDataIn_w_ETC___d813,
	       respF_pwEnqueue$whas && respF_wDataIn$wget[93],
	       respF_pwEnqueue$whas && respF_wDataIn$wget[92],
	       IF_respF_wDataIn_whas__43_THEN_respF_wDataIn_w_ETC___d814 } ;
  ...
  // remaining internal signals
  assign IF_respF_wDataIn_whas__43_THEN_respF_wDataIn_w_ETC___d813 =
	     respF_pwEnqueue$whas ? respF_wDataIn$wget[96:94] : 3'd0 ;
  assign IF_respF_wDataIn_whas__43_THEN_respF_wDataIn_w_ETC___d814 =
  ...
  assign addr__h20459 = { mesgLengthSoFar[10:0], 3'd0 } ;
  assign b__h14952 = -fabWordsCurReq[11:0] ;
  assign b__h18140 = { {2{fabRespCredit_value[11]}}, fabRespCredit_value } ;
  assign bl__h19714 = zeroLengthMesg ? 12'd1 : { 1'd0, x__h19625[13:3] } ;
  assign mesgMetaF_length__h19853 = { 10'd0, x__h19625 } ;
  assign mesgMetaF_length__h20589 = { 10'd0, mlp1B__h20443 } ;
  assign mlp1B__h20443 = { mlp1__h20442[10:0], 3'd0 } ;
  assign mlp1__h20442 = MUX_mesgLengthSoFar$write_1__VAL_2 ;
  assign rdat__h21908 = hasDebugLogic ? mesgCount : 32'd0 ;
  assign rdat__h21914 = hasDebugLogic ? abortCount : 32'd0 ;
  assign rdat__h21920 = hasDebugLogic ? thisMesg : 32'd0 ;
  assign rdat__h21933 = hasDebugLogic ? lastMesg : 32'd0 ;
  assign rdat__h21956 = hasDebugLogic ? { 16'd0, x__h21960 } : 32'd0 ;
  assign rdat__h22056 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h22070 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h22078 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h22084 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h22098 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h22106 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  ...
  assign sendData_byteEn__h18602 = (thisMesg[15:0] == 16'd0) ? 8'd0 : 8'd255 ;
  assign wmi_operateD_42_AND_wmi_peerIsReady_43_44_AND__ETC___d625 =
  ...
  assign wsiS_reqFifo_i_notEmpty__74_AND_NOT_smaCtrl_75_ETC___d644 =
	     wsiS_reqFifo$EMPTY_N &&
	     (smaCtrl[3:0] != 4'h3 || wsiM_reqFifo_c_r != 2'd2) &&
  ...
  assign x__h19611 = opcode[8] ? opcode[7:0] : 8'd0 ;
  assign x__h19625 = mesgLength[14] ? mesgLength[13:0] : 14'd0 ;
  assign x__h21960 = { wsiS_statusR, wsiM_statusR } ;
  assign x_length__h19607 = { 2'd0, x__h19625 } ;
  always@(wci_wslv_reqF$D_OUT or
	  ...
	  rdat__h22056 or
	  rdat__h22070 or
	  rdat__h22078 or rdat__h22084 or rdat__h22098 or rdat__h22106)
  begin
    case (wci_wslv_reqF$D_OUT[39:32])
      8'h0: g_data__h21865 = smaCtrl;
      8'h04: g_data__h21865 = rdat__h21908;
      8'h08: g_data__h21865 = rdat__h21914;
      8'h10: g_data__h21865 = rdat__h21920;
      8'h14: g_data__h21865 = rdat__h21933;
      8'h18: g_data__h21865 = rdat__h21956;
      8'h20: g_data__h21865 = rdat__h22056;
      8'h24: g_data__h21865 = rdat__h22070;
      8'h28: g_data__h21865 = rdat__h22078;
      8'h2C: g_data__h21865 = rdat__h22084;
      8'h30: g_data__h21865 = rdat__h22098;
      8'h34: g_data__h21865 = rdat__h22106;
      default: g_data__h21865 = 32'd0;
    endcase
  end
  ...
  begin
    ...
    if (wciS0_MReset_n)
      if (MUX_opcode$write_1__SEL_2)
	$display("[%0d]: %m: wmwt_doAbort", v__h21272);
    if (wciS0_MReset_n)
