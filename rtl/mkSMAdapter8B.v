...
//
// On Wed Jul 14 11:34:58 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter8B(wciS0_Clk,
  ...
  reg [63 : 0] v__h15686,
	       ...
	       v__h2801,
	       v__h3700;
  reg [31 : 0] value__h6077, x_data__h15819;
  wire [31 : 0] rdat__h15856,
		rdat__h15863,
		rdat__h15870,
		rdat__h15893,
		rdat__h15916,
		...
		rdat__h16058,
		rdat__h16066;
  wire [23 : 0] mesgMetaF_length__h17375, mesgMetaF_length__h18418;
  wire [15 : 0] wsiBurstLength__h19147, x__h15920, x_length__h17652;
  wire [13 : 0] IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d790,
		addr__h17222,
		b__h19768,
		mlp1B__h17206,
		mlp1__h17205;
  wire [11 : 0] bl__h18274, x_burstLength__h19243;
  wire [7 : 0] mesgMetaF_opcode__h17374, x_byteEn__h19245;
  wire [3 : 0] b__h14308;
  wire NOT_wmi_reqF_c_r_57_EQ_2_58_59_AND_wmi_operate_ETC___d308,
       ...
       wsiS_reqFifo_notFull__88_AND_wsiS_burstKind_68_ETC___d404,
       x__h19568;
  ...
  assign CAN_FIRE_RL_wmwt_doAbort = MUX_mesgLength$write_1__SEL_1 ;
  assign WILL_FIRE_RL_wmwt_doAbort = MUX_mesgLength$write_1__SEL_1 ;
  ...
  assign MUX_mesgLength$write_1__SEL_1 =
	     wci_cState == 3'd2 &&
	     (smaCtrl[3:0] == 4'h2 || smaCtrl[3:0] == 4'h3) &&
	     doAbort ;
  ...
  assign MUX_mesgLength$write_1__VAL_4 = { 1'd1, mlp1B__h17206 } ;
  assign MUX_wci_respF_x_wire$wset_1__VAL_1 = { 2'd1, x_data__h15819 } ;
  ...
  assign MUX_wmi_mFlagF_x_wire$wset_1__VAL_1 =
	     { mesgMetaF_opcode__h17374, mesgMetaF_length__h17375 } ;
  ...
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_3 =
	     { 4'd3, wsiS_reqFifo$D_OUT[93], 1'b0, addr__h17222, 12'd1 } ;
  ...
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_2 =
	     { 4'd5, x__h19568, 1'b0, mesgReqAddr, fabWordsCurReq[11:0] } ;
  assign MUX_wsiM_reqFifo_x_wire$wset_1__VAL_2 =
	     { 3'd1,
	       unrollCnt == 16'd1,
	       !smaCtrl[5],
	       x_burstLength__h19243,
  ...
  assign MUX_wmi_mFlagF_x_wire$wset_1__SEL_2 =
	     WILL_FIRE_RL_wmrd_mesgBodyRequest && x__h19568 ;
  assign MUX_fabRespCredit_value$write_1__VAL_2 =
	     fabRespCredit_value +
	     (CAN_FIRE_RL_wmrd_mesgBodyRequest ? b__h14308 : 4'd0) +
  ...
  assign MUX_thisMesg$write_1__VAL_1 =
	     { mesgCount[7:0], mesgMetaF_opcode__h17374, x_length__h17652 } ;
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_1 = { 20'd229376, bl__h18274 } ;
  ...
  assign MUX_wmi_mFlagF_x_wire$wset_1__VAL_3 =
	     { mesgMetaF_opcode__h17374, mesgMetaF_length__h18418 } ;
  ...
  assign fabRespCredit_acc_v1$wget = b__h14308 ;
  ...
  assign abortCount$EN = MUX_mesgLength$write_1__SEL_1 ;

  // register doAbort
  assign doAbort$D_IN = 1'd0 ;
  assign doAbort$EN = MUX_mesgLength$write_1__SEL_1 ;
  ...
  assign fabWordsCurReq$D_IN =
	     (fabWordsRemain <= b__h19768) ? fabWordsRemain : b__h19768 ;
  ...
  assign NOT_wmi_reqF_c_r_57_EQ_2_58_59_AND_wmi_operate_ETC___d308 =
	     ...
	     (!x__h19568 || wmi_mFlagF_c_r != 2'd2) ;
  assign addr__h17222 = { mesgLengthSoFar[10:0], 3'd0 } ;
  assign b__h14308 = -fabWordsCurReq[3:0] ;
  assign b__h19768 = { {10{fabRespCredit_value[3]}}, fabRespCredit_value } ;
  assign bl__h18274 =
	     zeroLengthMesg ?
	       12'd1 :
	       { 1'd0,
		 IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d790[13:3] } ;
  assign mesgMetaF_length__h17375 = { 10'd0, mlp1B__h17206 } ;
  assign mesgMetaF_length__h18418 =
	     { 10'd0,
	       IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d790 } ;
  assign mesgMetaF_opcode__h17374 = opcode[8] ? opcode[7:0] : 8'd0 ;
  assign mlp1B__h17206 = { mlp1__h17205[10:0], 3'd0 } ;
  assign mlp1__h17205 = MUX_mesgLengthSoFar$write_1__VAL_2 ;
  assign rdat__h15856 = hasDebugLogic ? mesgCount : 32'd0 ;
  assign rdat__h15863 = hasDebugLogic ? abortCount : 32'd0 ;
  assign rdat__h15870 = hasDebugLogic ? thisMesg : 32'd0 ;
  assign rdat__h15893 = hasDebugLogic ? lastMesg : 32'd0 ;
  assign rdat__h15916 = hasDebugLogic ? { 16'd0, x__h15920 } : 32'd0 ;
  assign rdat__h16016 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h16030 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h16038 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h16044 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h16058 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h16066 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  ...
  assign wsiS_reqFifo_notFull__88_AND_wsiS_burstKind_68_ETC___d404 =
	     wsiS_reqFifo$FULL_N &&
	     (wsiS_burstKind == 2'd0 ||
	      (wsiS_burstKind == 2'd1 || wsiS_burstKind == 2'd2) &&
	      wsiS_wsiReq$wget[93]) ;
  assign x__h15920 = { wsiS_statusR, wsiM_statusR } ;
  assign x__h19568 = fabWordsRemain == fabWordsCurReq ;
  assign x_burstLength__h19243 =
	     (thisMesg[15:0] == 16'd0 || smaCtrl[5] && unrollCnt == 16'd1) ?
	       12'd1 :
	       (smaCtrl[5] ? 12'd4095 : wsiBurstLength__h19147[11:0]) ;
  assign x_byteEn__h19245 = (thisMesg[15:0] == 16'd0) ? 8'd0 : 8'd255 ;
  assign x_length__h17652 =
	     { 2'd0,
	       IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d790 } ;
  always@(wci_reqF$D_OUT or
	  ...
	  rdat__h16016 or
	  rdat__h16030 or
	  rdat__h16038 or rdat__h16044 or rdat__h16058 or rdat__h16066)
  begin
    case (wci_reqF$D_OUT[39:32])
      8'h0: x_data__h15819 = smaCtrl;
      8'h04: x_data__h15819 = rdat__h15856;
      8'h08: x_data__h15819 = rdat__h15863;
      8'h10: x_data__h15819 = rdat__h15870;
      8'h14: x_data__h15819 = rdat__h15893;
      8'h18: x_data__h15819 = rdat__h15916;
      8'h20: x_data__h15819 = rdat__h16016;
      8'h24: x_data__h15819 = rdat__h16030;
      8'h28: x_data__h15819 = rdat__h16038;
      8'h2C: x_data__h15819 = rdat__h16044;
      8'h30: x_data__h15819 = rdat__h16058;
      8'h34: x_data__h15819 = rdat__h16066;
      default: x_data__h15819 = 32'd0;
    endcase
  end
  always@(MUX_endOfMessage$write_1__SEL_1 or
  ...
  begin
    ...
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wmwt_doAbort)
	$display("[%0d]: %m: wmwt_doAbort", v__h16867);
    if (wciS0_MReset_n)
