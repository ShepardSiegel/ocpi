...
//
// On Sun Sep 15 08:30:45 EDT 2013
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter8B(wciS0_Clk,
  ...
  wire [1 : 0] wmi_dhF_cntr_r$D_IN;
  wire wmi_dhF_cntr_r$EN;
  ...
  wire [1 : 0] wmi_mFlagF_cntr_r$D_IN;
  wire wmi_mFlagF_cntr_r$EN;
  ...
  wire [1 : 0] wmi_reqF_cntr_r$D_IN;
  wire wmi_reqF_cntr_r$EN;
  ...
  wire [1 : 0] MUX_wci_wslv_respF_cntr_r$write_1__VAL_2,
	       MUX_wmi_dhF_cntr_r$write_1__VAL_2,
	       MUX_wmi_mFlagF_cntr_r$write_1__VAL_2,
	       MUX_wmi_reqF_cntr_r$write_1__VAL_2,
	       MUX_wsiM_reqFifo_cntr_r$write_1__VAL_1,
	       MUX_wsiM_reqFifo_cntr_r$write_1__VAL_2;
  ...
  reg [63 : 0] v__h18073,
	       ...
	       v__h3772,
	       v__h3916;
  reg [31 : 0] g_data__h23912;
  wire [91 : 0] IF_respF_wDataIn_whas__28_THEN_respF_wDataIn_w_ETC___d437;
  wire [31 : 0] rdat__h23955,
		rdat__h23961,
		rdat__h23967,
		rdat__h23980,
		rdat__h24003,
  ...
  wire [23 : 0] b__h17784,
		...
		residue__h17647,
		x__h17904;
  wire [15 : 0] wsiBurstLength__h18535, x__h24007, x_length__h22936;
  wire [13 : 0] b__h18157, mlB__h22206, mlInc__h22205;
  wire [11 : 0] b__h14802, sendData_burstLength__h18617, x__h16103, x__h16253;
  wire [7 : 0] mesgMetaF_opcode__h22372, sendData_byteEn__h18619;
  wire [3 : 0] x__h22411,
	       x__h22423,
	       x__h22435,
	       x__h22447,
  ...
  // value method wmiM0_mDataLast
  assign wmiM0_MDataLast = !wmi_sDataThreadBusy_d && wmi_dhF_q_0[72] ;

  // value method wmiM0_mData
  assign wmiM0_MData = wmi_sDataThreadBusy_d ? 64'd0 : wmi_dhF_q_0[71:8] ;

  // value method wmiM0_mDataByteEn
  assign wmiM0_MDataByteEn = wmi_sDataThreadBusy_d ? 8'd0 : wmi_dhF_q_0[7:0] ;
  ...
  // submodule wmi_respF
  FIFO2 #(.width(32'd66), .guarded(32'd1)) wmi_respF(.RST(wciS0_MReset_n),
						     .CLK(wciS0_Clk),
						     .D_IN(wmi_respF$D_IN),
						     .ENQ(wmi_respF$ENQ),
						     .DEQ(wmi_respF$DEQ),
  ...
  assign WILL_FIRE_RL_wmi_reqF_incCtr =
	     wmi_reqF_x_wire$whas && wmi_reqF_enqueueing$whas &&
	     !wmi_reqF_dequeueing$whas ;
  ...
  assign WILL_FIRE_RL_wmi_reqF_both =
	     wmi_reqF_x_wire$whas && wmi_reqF_dequeueing$whas &&
	     wmi_reqF_enqueueing$whas ;

  // rule RL_wmi_mFlagF_incCtr
  assign WILL_FIRE_RL_wmi_mFlagF_incCtr =
	     wmi_mFlagF_enqueueing$whas && wmi_mFlagF_enqueueing$whas &&
	     !wmi_mFlagF_dequeueing$whas ;
  ...
  assign WILL_FIRE_RL_wmi_mFlagF_both =
	     wmi_mFlagF_enqueueing$whas && wmi_mFlagF_dequeueing$whas &&
	     wmi_mFlagF_enqueueing$whas ;
  ...
  assign WILL_FIRE_RL_wsiM_reqFifo_incCtr =
	     wsiM_reqFifo_enqueueing$whas && wsiM_reqFifo_enqueueing$whas &&
	     !WILL_FIRE_RL_wsiM_reqFifo_deq ;
  ...
  assign WILL_FIRE_RL_wsiM_reqFifo_both =
	     wsiM_reqFifo_enqueueing$whas && WILL_FIRE_RL_wsiM_reqFifo_deq &&
	     wsiM_reqFifo_enqueueing$whas ;
  ...
  assign MUX_thisMesg$write_1__VAL_1 =
	     { mesgCount[7:0], mesgMetaF_opcode__h22372, x_length__h22936 } ;
  ...
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_2 = { 2'd1, g_data__h23912 } ;
  assign MUX_wmi_dhF_cntr_r$write_1__VAL_2 = wmi_dhF_cntr_r + 2'd1 ;
  assign MUX_wmi_dhF_q_0$write_1__VAL_1 =
	     { 1'd1, wsiS_reqFifo$D_OUT[93], wsiS_reqFifo$D_OUT[79:8] } ;
  ...
  assign MUX_wmi_dhF_q_1$write_1__VAL_2 =
	     (wmi_dhF_cntr_r == 2'd2) ?
	       MUX_wmi_dhF_q_0$write_1__VAL_1 :
	       74'd0 ;
  assign MUX_wmi_mFlagF_cntr_r$write_1__VAL_2 = wmi_mFlagF_cntr_r + 2'd1 ;
  ...
  assign MUX_wmi_reqF_cntr_r$write_1__VAL_2 = wmi_reqF_cntr_r + 2'd1 ;
  ...
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_2 =
	     { 4'd3, wsiS_reqFifo$D_OUT[93], 1'b0, mesgLengthSoFar, 12'd1 } ;
  assign MUX_wsiM_reqFifo_cntr_r$write_1__VAL_1 = wsiM_reqFifo_cntr_r - 2'd1 ;
  assign MUX_wsiM_reqFifo_cntr_r$write_1__VAL_2 = wsiM_reqFifo_cntr_r + 2'd1 ;
  ...
  assign wmi_reqF_x_wire$whas =
	     WILL_FIRE_RL_wmrd_mesgBodyRequest ||
	     MUX_wsiS_reqFifo_levelsValid$write_1__SEL_3 ;
  assign wmi_mFlagF_x_wire$wget = value__h6387 ;
  ...
  assign fabRespCredit_acc_v1$wget = b__h14802 ;
  ...
  assign respF_pwClear$whas = 1'b0 ;
  ...
  // register respF_rRdPtr
  assign respF_rRdPtr$D_IN = x__h16253 ;
  assign respF_rRdPtr$EN = WILL_FIRE_RL_wmrd_mesgResptoWsi ;

  // register respF_rWrPtr
  assign respF_rWrPtr$D_IN = x__h16103 ;
  ...
  // register wmi_dhF_cntr_r
  assign wmi_dhF_cntr_r$D_IN =
	     WILL_FIRE_RL_wmi_dhF_decCtr ?
	       wmi_dhF_cntr_r_05_MINUS_1___d213 :
	       MUX_wmi_dhF_cntr_r$write_1__VAL_2 ;
  assign wmi_dhF_cntr_r$EN =
  ...
  begin
    case (1'b1) // synopsys parallel_case
      ...
      WILL_FIRE_RL_wmi_dhF_decCtr: wmi_dhF_q_1$D_IN = 74'd0;
  ...
  // register wmi_mFlagF_cntr_r
  assign wmi_mFlagF_cntr_r$D_IN =
	     WILL_FIRE_RL_wmi_mFlagF_decCtr ?
	       wmi_mFlagF_cntr_r_83_MINUS_1___d191 :
	       MUX_wmi_mFlagF_cntr_r$write_1__VAL_2 ;
  assign wmi_mFlagF_cntr_r$EN =
	     WILL_FIRE_RL_wmi_mFlagF_decCtr ||
	     WILL_FIRE_RL_wmi_mFlagF_incCtr ;
  ...
  begin
    case (1'b1) // synopsys parallel_case
      ...
      MUX_wmi_mFlagF_q_0$write_1__SEL_2: wmi_mFlagF_q_0$D_IN = value__h6387;
  ...
  begin
    case (1'b1) // synopsys parallel_case
      ...
      MUX_wmi_mFlagF_q_1$write_1__SEL_2: wmi_mFlagF_q_1$D_IN = value__h6387;
  ...
  // register wmi_reqF_cntr_r
  assign wmi_reqF_cntr_r$D_IN =
	     WILL_FIRE_RL_wmi_reqF_decCtr ?
	       wmi_reqF_cntr_r_61_MINUS_1___d169 :
	       MUX_wmi_reqF_cntr_r$write_1__VAL_2 ;
  assign wmi_reqF_cntr_r$EN =
  ...
  // register wsiM_reqFifo_cntr_r
  assign wsiM_reqFifo_cntr_r$D_IN =
	     WILL_FIRE_RL_wsiM_reqFifo_decCtr ?
	       MUX_wsiM_reqFifo_cntr_r$write_1__VAL_1 :
	       MUX_wsiM_reqFifo_cntr_r$write_1__VAL_2 ;
  assign wsiM_reqFifo_cntr_r$EN =
	     WILL_FIRE_RL_wsiM_reqFifo_decCtr ||
	     WILL_FIRE_RL_wsiM_reqFifo_incCtr ;
  ...
  assign respF_memory$ENA = 1'b1 ;
  assign respF_memory$ENB = 1'b1 ;
  ...
  assign _dfoo17 =
	     wsiM_reqFifo_cntr_r != 2'd2 ||
	     MUX_wsiM_reqFifo_cntr_r$write_1__VAL_1 == 2'd1 ;
  assign _dfoo19 =
	     wsiM_reqFifo_cntr_r != 2'd1 ||
	     MUX_wsiM_reqFifo_cntr_r$write_1__VAL_1 == 2'd0 ;
  assign _dfoo3 =
	     wci_wslv_respF_cntr_r != 2'd1 ||
  ...
  assign mlB__h22206 = MUX_mesgLengthSoFar$write_1__VAL_1 ;
  assign mlInc__h22205 =
	     wsiS_reqFifo$D_OUT[93] ?
	       { 10'd0, x__h22411 + y__h22412 } :
	       14'd8 ;
  assign rdat__h23955 = hasDebugLogic ? mesgCount : 32'd0 ;
  assign rdat__h23961 = hasDebugLogic ? abortCount : 32'd0 ;
  assign rdat__h23967 = hasDebugLogic ? thisMesg : 32'd0 ;
  assign rdat__h23980 = hasDebugLogic ? lastMesg : 32'd0 ;
  assign rdat__h24003 = hasDebugLogic ? { 16'd0, x__h24007 } : 32'd0 ;
  assign rdat__h24103 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h24117 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h24125 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h24131 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h24145 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h24153 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h24159 = hasDebugLogic ? wmwtBeginCount : 32'd0 ;
  assign rdat__h24165 = hasDebugLogic ? wmwtPushCount : 32'd0 ;
  assign rdat__h24171 = hasDebugLogic ? wmwtFinalCount : 32'd0 ;
  assign rdat__h24177 = hasDebugLogic ? { 31'd0, x__h24181 } : 32'd0 ;
  assign rdat__h24187 = hasDebugLogic ? 32'hFEEDC0DE : 32'd0 ;
  assign residue__h17647 =
	     ({ 3'd0, wmi_sFlagReg[2:0] } == 6'd0) ? 24'd0 : 24'd1 ;
  ...
  assign sendData_byteEn__h18619 =
	     (thisMesg[15:0] == 16'd0) ?
	       8'd0 :
	       ((unrollCnt == 16'd1) ? x__h18676[7:0] : 8'd255) ;
  assign value__h6387 =
	     MUX_wmi_mFlagF_x_wire$wset_1__SEL_1 ?
  ...
  assign wsiS_reqFifo_i_notEmpty__61_AND_NOT_smaCtrl_62_ETC___d667 =
	     ...
	     (!wsiS_reqFifo$D_OUT[93] || wmi_mFlagF_cntr_r != 2'd2) ;
  assign x__h16103 = respF_rWrPtr + 12'd1 ;
  assign x__h16253 = respF_rRdPtr + 12'd1 ;
  assign x__h17904 = { 3'd0, wmi_sFlagReg[23:3] } ;
  ...
  assign x__h22483 = { 3'd0, wsiS_reqFifo$D_OUT[15] } ;
  assign x__h24007 = { wsiS_statusR, wsiM_statusR } ;
  assign x__h24181 = wmi_sThreadBusy_d || wmi_sDataThreadBusy_d ;
  assign x_length__h22936 = { 2'd0, mlB__h22206 } ;
  assign y__h22412 = { 3'd0, wsiS_reqFifo$D_OUT[8] } ;
  assign y__h22424 = { 3'd0, wsiS_reqFifo$D_OUT[9] } ;
  assign y__h22436 = { 3'd0, wsiS_reqFifo$D_OUT[10] } ;
  assign y__h22448 = { 3'd0, wsiS_reqFifo$D_OUT[11] } ;
  assign y__h22460 = { 3'd0, wsiS_reqFifo$D_OUT[12] } ;
  assign y__h22472 = { 3'd0, wsiS_reqFifo$D_OUT[13] } ;
  assign y__h22484 = { 3'd0, wsiS_reqFifo$D_OUT[14] } ;
  always@(wci_wslv_reqF$D_OUT or
	  ...
	  rdat__h24153 or
	  rdat__h24159 or
	  rdat__h24165 or rdat__h24171 or rdat__h24177 or rdat__h24187)
  begin
    case (wci_wslv_reqF$D_OUT[39:32])
      8'h0: g_data__h23912 = smaCtrl;
      8'h04: g_data__h23912 = rdat__h23955;
      8'h08: g_data__h23912 = rdat__h23961;
      8'h10: g_data__h23912 = rdat__h23967;
      8'h14: g_data__h23912 = rdat__h23980;
      8'h18: g_data__h23912 = rdat__h24003;
      8'h20: g_data__h23912 = rdat__h24103;
      8'h24: g_data__h23912 = rdat__h24117;
      8'h28: g_data__h23912 = rdat__h24125;
      8'h2C: g_data__h23912 = rdat__h24131;
      8'h30: g_data__h23912 = rdat__h24145;
      8'h34: g_data__h23912 = rdat__h24153;
      8'h38: g_data__h23912 = rdat__h24159;
      8'h3C: g_data__h23912 = rdat__h24165;
      8'h40: g_data__h23912 = rdat__h24171;
      8'h44: g_data__h23912 = rdat__h24177;
      8'h48: g_data__h23912 = rdat__h24187;
      default: g_data__h23912 = 32'd0;
    endcase
  end
  ...
  begin
	...
	wmi_dhF_q_0 <= `BSV_ASSIGNMENT_DELAY 74'd0;
	wmi_dhF_q_1 <= `BSV_ASSIGNMENT_DELAY 74'd0;
	...
	if (wmi_dhF_cntr_r$EN)
	  wmi_dhF_cntr_r <= `BSV_ASSIGNMENT_DELAY wmi_dhF_cntr_r$D_IN;
	if (wmi_dhF_q_0$EN)
	...
	if (wmi_mFlagF_cntr_r$EN)
	  wmi_mFlagF_cntr_r <= `BSV_ASSIGNMENT_DELAY wmi_mFlagF_cntr_r$D_IN;
	...
	if (wmi_reqF_cntr_r$EN)
	  wmi_reqF_cntr_r <= `BSV_ASSIGNMENT_DELAY wmi_reqF_cntr_r$D_IN;
	if (wmi_reqF_q_0$EN)
  ...
  begin
    ...
    if (wciS0_MReset_n != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_wmwt_doAbort)
	$display("[%0d]: %m: wmwt_doAbort", v__h23361);
    if (wciS0_MReset_n != `BSV_RESET_VALUE)
