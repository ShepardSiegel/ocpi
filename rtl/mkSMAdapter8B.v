...
//
// On Thu Dec 16 18:38:51 EST 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter8B(wciS0_Clk,
  ...
  reg [63 : 0] v__h17606,
	       ...
	       v__h3767,
	       v__h3922;
  reg [31 : 0] value__h6113, x_data__h21425;
  wire [91 : 0] IF_respF_wDataIn_whas__26_THEN_respF_wDataIn_w_ETC___d814;
  wire [31 : 0] rdat__h21474,
		rdat__h21480,
		rdat__h21486,
		rdat__h21499,
		rdat__h21522,
		...
		rdat__h21664,
		rdat__h21672;
  wire [23 : 0] mesgMetaF_length__h19403, mesgMetaF_length__h20139;
  wire [15 : 0] wsiBurstLength__h18068, x__h21526, x_length__h19157;
  wire [13 : 0] addr__h20009,
		b__h17690,
		mlp1B__h19993,
		mlp1__h19992,
		x__h19175;
  wire [11 : 0] b__h14502,
		bl__h19264,
		sendData_burstLength__h18150,
		x__h15856;
  wire [7 : 0] sendData_byteEn__h18152, x__h19161;
  wire [2 : 0] IF_respF_wDataIn_whas__26_THEN_respF_wDataIn_w_ETC___d813;
  wire NOT_wmi_reqF_c_r_39_EQ_2_58_59_AND_wmi_operate_ETC___d510,
       wmi_operateD_25_AND_wmi_peerIsReady_26_27_AND__ETC___d608,
       wmi_respF_i_notEmpty__23_AND_smaCtrl_58_BIT_4__ETC___d528,
       wsiS_reqFifo_i_notEmpty__57_AND_NOT_smaCtrl_58_ETC___d627,
       wsiS_reqFifo_notFull__59_AND_wsiS_burstKind_74_ETC___d381,
       x__h17861;
  ...
  assign CAN_FIRE_RL_wmrd_mesgBodyRequest =
	     NOT_wmi_reqF_c_r_39_EQ_2_58_59_AND_wmi_operate_ETC___d510 &&
	     wci_cState == 3'd2 &&
	     (smaCtrl[3:0] == 4'h1 || smaCtrl[3:0] == 4'h4 ||
	      smaCtrl[3:0] == 4'h9) &&
	     mesgPreRequest ;
  ...
  assign MUX_wmi_mFlagF_x_wire$wset_1__SEL_1 =
	     WILL_FIRE_RL_wmrd_mesgBodyRequest && x__h17861 ;
  ...
  assign MUX_fabRespCredit_value$write_1__VAL_2 =
	     fabRespCredit_value +
	     (CAN_FIRE_RL_wmrd_mesgBodyRequest ? b__h14502 : 12'd0) +
  ...
  assign MUX_mesgLength$write_1__VAL_3 = { 1'd1, mlp1B__h19993 } ;
  ...
  assign MUX_thisMesg$write_1__VAL_1 =
	     { mesgCount[7:0], x__h19161, x_length__h19157 } ;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_2 = { 2'd1, x_data__h21425 } ;
  ...
  assign MUX_wmi_mFlagF_q_0$write_1__VAL_1 =
	     (wmi_mFlagF_c_r == 2'd1) ? value__h6113 : wmi_mFlagF_q_1 ;
  assign MUX_wmi_mFlagF_q_1$write_1__VAL_1 =
	     (wmi_mFlagF_c_r == 2'd2) ? value__h6113 : 32'd0 ;
  assign MUX_wmi_mFlagF_x_wire$wset_1__VAL_2 =
	     { x__h19161, mesgMetaF_length__h20139 } ;
  assign MUX_wmi_mFlagF_x_wire$wset_1__VAL_3 =
	     { x__h19161, mesgMetaF_length__h19403 } ;
  ...
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_1 =
	     { 4'd5, x__h17861, 1'b0, mesgReqAddr, fabWordsCurReq[11:0] } ;
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_2 = { 20'd229376, bl__h19264 } ;
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_3 =
	     { 4'd3, wsiS_reqFifo$D_OUT[93], 1'b0, addr__h20009, 12'd1 } ;
  ...
  assign wmi_reqF_x_wire$whas =
	     ...
	     WILL_FIRE_RL_wmwt_requestPrecise ||
	     WILL_FIRE_RL_wmwt_messagePushImprecise ;
  assign wmi_mFlagF_x_wire$wget = value__h6113 ;
  ...
  assign fabRespCredit_acc_v1$wget = b__h14502 ;
  ...
  assign fabWordsCurReq$D_IN =
	     (fabWordsRemain <= b__h17690) ? fabWordsRemain : b__h17690 ;
  ...
  assign respF_rCache$D_IN =
	     { 1'd1,
	       respF_rWrPtr,
	       IF_respF_wDataIn_whas__26_THEN_respF_wDataIn_w_ETC___d813,
	       respF_pwEnqueue$whas && respF_wDataIn$wget[93],
	       respF_pwEnqueue$whas && respF_wDataIn$wget[92],
	       IF_respF_wDataIn_whas__26_THEN_respF_wDataIn_w_ETC___d814 } ;
  assign respF_rCache$EN = respF_pwEnqueue$whas ;

  // register respF_rRdPtr
  assign respF_rRdPtr$D_IN = x__h15856 ;
  ...
  always@(WILL_FIRE_RL_wmi_mFlagF_both or
	  ...
	  value__h6113 or WILL_FIRE_RL_wmi_mFlagF_decCtr or wmi_mFlagF_q_1)
  begin
    case (1'b1) // synopsys parallel_case
      WILL_FIRE_RL_wmi_mFlagF_both:
	  wmi_mFlagF_q_0$D_IN = MUX_wmi_mFlagF_q_0$write_1__VAL_1;
      MUX_wmi_mFlagF_q_0$write_1__SEL_2: wmi_mFlagF_q_0$D_IN = value__h6113;
  ...
  always@(WILL_FIRE_RL_wmi_mFlagF_both or
	  ...
	  value__h6113 or WILL_FIRE_RL_wmi_mFlagF_decCtr)
  begin
    case (1'b1) // synopsys parallel_case
      WILL_FIRE_RL_wmi_mFlagF_both:
	  wmi_mFlagF_q_1$D_IN = MUX_wmi_mFlagF_q_1$write_1__VAL_1;
      MUX_wmi_mFlagF_q_1$write_1__SEL_2: wmi_mFlagF_q_1$D_IN = value__h6113;
  ...
  // remaining internal signals
  assign IF_respF_wDataIn_whas__26_THEN_respF_wDataIn_w_ETC___d813 =
	     respF_pwEnqueue$whas ? respF_wDataIn$wget[96:94] : 3'd0 ;
  assign IF_respF_wDataIn_whas__26_THEN_respF_wDataIn_w_ETC___d814 =
	     respF_pwEnqueue$whas ? respF_wDataIn$wget[91:0] : 92'd0 ;
  assign NOT_wmi_reqF_c_r_39_EQ_2_58_59_AND_wmi_operate_ETC___d510 =
	     wmi_reqF_c_r != 2'd2 && wmi_operateD && wmi_peerIsReady &&
	     (!x__h17861 || wmi_mFlagF_c_r != 2'd2) ;
  assign addr__h20009 = { mesgLengthSoFar[10:0], 3'd0 } ;
  assign b__h14502 = -fabWordsCurReq[11:0] ;
  assign b__h17690 = { {2{fabRespCredit_value[11]}}, fabRespCredit_value } ;
  assign bl__h19264 = zeroLengthMesg ? 12'd1 : { 1'd0, x__h19175[13:3] } ;
  assign mesgMetaF_length__h19403 = { 10'd0, x__h19175 } ;
  assign mesgMetaF_length__h20139 = { 10'd0, mlp1B__h19993 } ;
  assign mlp1B__h19993 = { mlp1__h19992[10:0], 3'd0 } ;
  assign mlp1__h19992 = MUX_mesgLengthSoFar$write_1__VAL_2 ;
  assign rdat__h21474 = hasDebugLogic ? mesgCount : 32'd0 ;
  assign rdat__h21480 = hasDebugLogic ? abortCount : 32'd0 ;
  assign rdat__h21486 = hasDebugLogic ? thisMesg : 32'd0 ;
  assign rdat__h21499 = hasDebugLogic ? lastMesg : 32'd0 ;
  assign rdat__h21522 = hasDebugLogic ? { 16'd0, x__h21526 } : 32'd0 ;
  assign rdat__h21622 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h21636 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h21644 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h21650 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h21664 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h21672 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign sendData_burstLength__h18150 =
	     (thisMesg[15:0] == 16'd0 || smaCtrl[5] && unrollCnt == 16'd1) ?
	       12'd1 :
	       (smaCtrl[5] ? 12'd4095 : wsiBurstLength__h18068[11:0]) ;
  assign sendData_byteEn__h18152 = (thisMesg[15:0] == 16'd0) ? 8'd0 : 8'd255 ;
  assign wmi_operateD_25_AND_wmi_peerIsReady_26_27_AND__ETC___d608 =
	     wmi_operateD && wmi_peerIsReady && wsiS_reqFifo$EMPTY_N &&
	     (smaCtrl[3:0] != 4'h3 || wsiM_reqFifo_c_r != 2'd2) ;
  assign wmi_respF_i_notEmpty__23_AND_smaCtrl_58_BIT_4__ETC___d528 =
	     wmi_respF$EMPTY_N &&
	     (smaCtrl[4] || respF_rRdPtr + 12'd1024 != respF_rWrPtr) ;
  assign wsiBurstLength__h18068 =
	     smaCtrl[5] ? 16'd2 : { 3'd0, thisMesg[15:3] } ;
  assign wsiS_reqFifo_i_notEmpty__57_AND_NOT_smaCtrl_58_ETC___d627 =
	     wsiS_reqFifo$EMPTY_N &&
	     (smaCtrl[3:0] != 4'h3 || wsiM_reqFifo_c_r != 2'd2) &&
	     (!wsiS_reqFifo$D_OUT[93] || wmi_mFlagF_c_r != 2'd2) ;
  assign wsiS_reqFifo_notFull__59_AND_wsiS_burstKind_74_ETC___d381 =
	     wsiS_reqFifo$FULL_N &&
	     (wsiS_burstKind == 2'd0 ||
	      (wsiS_burstKind == 2'd1 || wsiS_burstKind == 2'd2) &&
	      wsiS_wsiReq$wget[93]) ;
  assign x__h15856 = respF_rRdPtr + 12'd1 ;
  assign x__h17861 = fabWordsRemain == fabWordsCurReq ;
  assign x__h19161 = opcode[8] ? opcode[7:0] : 8'd0 ;
  assign x__h19175 = mesgLength[14] ? mesgLength[13:0] : 14'd0 ;
  assign x__h21526 = { wsiS_statusR, wsiM_statusR } ;
  assign x_length__h19157 = { 2'd0, x__h19175 } ;
  always@(wci_reqF$D_OUT or
	  ...
	  rdat__h21622 or
	  rdat__h21636 or
	  rdat__h21644 or rdat__h21650 or rdat__h21664 or rdat__h21672)
  begin
    case (wci_reqF$D_OUT[39:32])
      8'h0: x_data__h21425 = smaCtrl;
      8'h04: x_data__h21425 = rdat__h21474;
      8'h08: x_data__h21425 = rdat__h21480;
      8'h10: x_data__h21425 = rdat__h21486;
      8'h14: x_data__h21425 = rdat__h21499;
      8'h18: x_data__h21425 = rdat__h21522;
      8'h20: x_data__h21425 = rdat__h21622;
      8'h24: x_data__h21425 = rdat__h21636;
      8'h28: x_data__h21425 = rdat__h21644;
      8'h2C: x_data__h21425 = rdat__h21650;
      8'h30: x_data__h21425 = rdat__h21664;
      8'h34: x_data__h21425 = rdat__h21672;
      default: x_data__h21425 = 32'd0;
    endcase
  end
  ...
  begin
    case (1'b1) // synopsys parallel_case
      MUX_wmi_mFlagF_x_wire$wset_1__SEL_1:
	  value__h6113 = 32'hAAAAAAAA /* unspecified value */ ;
      MUX_endOfMessage$write_1__SEL_1:
	  value__h6113 = MUX_wmi_mFlagF_x_wire$wset_1__VAL_2;
      WILL_FIRE_RL_wmwt_requestPrecise:
	  value__h6113 = MUX_wmi_mFlagF_x_wire$wset_1__VAL_3;
      default: value__h6113 = 32'hAAAAAAAA /* unspecified value */ ;
    endcase
  end
  ...
  begin
    ...
    if (wciS0_MReset_n)
      if (WILL_FIRE_RL_wmwt_doAbort)
	$display("[%0d]: %m: wmwt_doAbort", v__h20822);
    if (wciS0_MReset_n)
