...
//
// On Thu Oct 28 11:08:29 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter8B(wciS0_Clk,
  ...
  wire [31 : 0] rdat__h16135,
		...
		rdat__h16337,
		rdat__h16345;
  wire [23 : 0] mesgMetaF_length__h17662, mesgMetaF_length__h18705;
  wire [15 : 0] wsiBurstLength__h19566, x__h16199, x_length__h17939;
  wire [13 : 0] IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d789,
		addr__h17509,
		b__h20163,
		mlp1B__h17493,
		mlp1__h17492;
  wire [11 : 0] bl__h18561, x1_burstLength__h19638;
  wire [7 : 0] mesgMetaF_opcode__h17661, x1_byteEn__h19640;
  wire [4 : 0] b__h14527;
  ...
  assign MUX_wci_respF_x_wire$wset_1__VAL_1 = { 2'd1, x_data__h16092 } ;
  ...
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_3 =
	     { 4'd3, wsiS_reqFifo$D_OUT[93], 1'b0, addr__h17509, 12'd1 } ;
  ...
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_2 =
	     { 4'd5, x__h19963, 1'b0, mesgReqAddr, fabWordsCurReq[11:0] } ;
  assign MUX_wmi_mFlagF_x_wire$wset_1__SEL_2 =
	     WILL_FIRE_RL_wmrd_mesgBodyRequest && x__h19963 ;
  ...
  assign MUX_wmi_mFlagF_x_wire$wset_1__VAL_3 =
	     { mesgMetaF_opcode__h17661, mesgMetaF_length__h18705 } ;
  ...
  assign fabWordsCurReq$D_IN =
	     (fabWordsRemain <= b__h20163) ? fabWordsRemain : b__h20163 ;
  ...
  // remaining internal signals
  assign IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d789 =
  ...
  assign NOT_wmi_reqF_c_r_57_EQ_2_58_59_AND_wmi_operate_ETC___d315 =
	     ...
	     (!x__h19963 || wmi_mFlagF_c_r != 2'd2) ;
  assign addr__h17509 = { mesgLengthSoFar[10:0], 3'd0 } ;
  assign b__h14527 = -fabWordsCurReq[4:0] ;
  assign b__h20163 = { {9{fabRespCredit_value[4]}}, fabRespCredit_value } ;
  assign bl__h18561 =
	     zeroLengthMesg ?
	       12'd1 :
	       { 1'd0,
		 IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d789[13:3] } ;
  assign mesgMetaF_length__h17662 = { 10'd0, mlp1B__h17493 } ;
  assign mesgMetaF_length__h18705 =
	     { 10'd0,
	       IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d789 } ;
  assign mesgMetaF_opcode__h17661 = opcode[8] ? opcode[7:0] : 8'd0 ;
  assign mlp1B__h17493 = { mlp1__h17492[10:0], 3'd0 } ;
  ...
  assign wsiS_reqFifo_notFull__96_AND_wsiS_burstKind_76_ETC___d416 =
	     ...
	     (wsiS_burstKind == 2'd0 ||
	      ...
	      wsiS_wsiReq$wget[93]) ;
  assign x1_burstLength__h19638 =
	     (thisMesg[15:0] == 16'd0 || smaCtrl[5] && unrollCnt == 16'd1) ?
	       12'd1 :
	       (smaCtrl[5] ? 12'd4095 : wsiBurstLength__h19566[11:0]) ;
  assign x1_byteEn__h19640 = (thisMesg[15:0] == 16'd0) ? 8'd0 : 8'd255 ;
  assign x__h16199 = { wsiS_statusR, wsiM_statusR } ;
  assign x__h19963 = fabWordsRemain == fabWordsCurReq ;
