...
//
// On Wed Feb  9 16:47:41 EST 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter8B(wciS0_Clk,
  ...
  reg [63 : 0] v__h18255,
	       ...
	       v__h3761,
	       v__h3905;
  reg [31 : 0] g_data__h22444, value__h6563;
  wire [91 : 0] IF_respF_wDataIn_whas__43_THEN_respF_wDataIn_w_ETC___d857;
  wire [31 : 0] rdat__h22487,
		rdat__h22493,
		rdat__h22499,
		rdat__h22512,
		rdat__h22535,
		...
		rdat__h22703,
		rdat__h22709;
  wire [23 : 0] mesgMetaF_length__h20215, mesgMetaF_length__h20975;
  wire [15 : 0] wsiBurstLength__h18717, x__h22539, x_length__h19969;
  wire [13 : 0] addr__h20845,
		b__h18339,
		mlp1B__h20805,
		mlp1__h20804,
		x__h19987;
  wire [11 : 0] b__h14952,
		bl__h20076,
		sendData_burstLength__h18799,
		x__h16306;
  wire [7 : 0] sendData_byteEn__h18801, x__h19973;
  wire [2 : 0] IF_respF_wDataIn_whas__43_THEN_respF_wDataIn_w_ETC___d844;
  wire NOT_wmi_reqF_c_r_56_EQ_2_75_76_AND_wmi_operate_ETC___d527,
       wci_wslv_cState_5_EQ_2_6_AND_smaCtrl_75_BITS_3_ETC___d702,
       wmi_operateD_42_AND_wmi_peerIsReady_43_44_AND__ETC___d629,
       wmi_respF_i_notEmpty__40_AND_smaCtrl_75_BIT_4__ETC___d545,
       wsiS_reqFifo_i_notEmpty__74_AND_NOT_smaCtrl_75_ETC___d648,
  ...
  assign MUX_wmi_mFlagF_x_wire$wset_1__SEL_1 =
	     WILL_FIRE_RL_wmrd_mesgBodyRequest && x__h18510 ;
  ...
  assign MUX_mesgLength$write_1__VAL_3 = { 1'd1, mlp1B__h20805 } ;
  ...
  assign MUX_thisMesg$write_1__VAL_1 =
	     { mesgCount[7:0], x__h19973, x_length__h19969 } ;
  ...
  assign MUX_wci_wslv_respF_x_wire$wset_1__VAL_2 = { 2'd1, g_data__h22444 } ;
  ...
  assign MUX_wmi_mFlagF_x_wire$wset_1__VAL_2 =
	     { x__h19973, mesgMetaF_length__h20975 } ;
  assign MUX_wmi_mFlagF_x_wire$wset_1__VAL_3 =
	     { x__h19973, mesgMetaF_length__h20215 } ;
  ...
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_1 =
	     { 4'd5, x__h18510, 1'b0, mesgReqAddr, fabWordsCurReq[11:0] } ;
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_2 = { 20'd229376, bl__h20076 } ;
  assign MUX_wmi_reqF_x_wire$wset_1__VAL_3 =
	     { 4'd3, wsiS_reqFifo$D_OUT[93], 1'b0, addr__h20845, 12'd1 } ;
  ...
  assign fabWordsCurReq$D_IN =
	     (fabWordsRemain <= b__h18339) ? fabWordsRemain : b__h18339 ;
  ...
  // register mesgLength
  always@(MUX_opcode$write_1__SEL_1 or
	  MUX_opcode$write_1__SEL_2 or
  ...
  // register mesgReqValid
  assign mesgReqValid$D_IN = !MUX_opcode$write_1__SEL_1 ;
  assign mesgReqValid$EN =
	     MUX_opcode$write_1__SEL_1 || WILL_FIRE_RL_wmwt_requestPrecise ;
  ...
  assign respF_rCache$D_IN =
	     { 1'd1,
	       respF_rWrPtr,
	       IF_respF_wDataIn_whas__43_THEN_respF_wDataIn_w_ETC___d844,
	       respF_pwEnqueue$whas && respF_wDataIn$wget[93],
	       respF_pwEnqueue$whas && respF_wDataIn$wget[92],
	       IF_respF_wDataIn_whas__43_THEN_respF_wDataIn_w_ETC___d857 } ;
  ...
  // remaining internal signals
  assign IF_respF_wDataIn_whas__43_THEN_respF_wDataIn_w_ETC___d844 =
	     respF_pwEnqueue$whas ? respF_wDataIn$wget[96:94] : 3'd0 ;
  assign IF_respF_wDataIn_whas__43_THEN_respF_wDataIn_w_ETC___d857 =
  ...
  assign NOT_wmi_reqF_c_r_56_EQ_2_75_76_AND_wmi_operate_ETC___d527 =
	     ...
	     (!x__h18510 || wmi_mFlagF_c_r != 2'd2) ;
  assign addr__h20845 = { mesgLengthSoFar[10:0], 3'd0 } ;
  assign b__h14952 = -fabWordsCurReq[11:0] ;
  assign b__h18339 = { {2{fabRespCredit_value[11]}}, fabRespCredit_value } ;
  assign bl__h20076 = zeroLengthMesg ? 12'd1 : { 1'd0, x__h19987[13:3] } ;
  assign mesgMetaF_length__h20215 = { 10'd0, x__h19987 } ;
  assign mesgMetaF_length__h20975 =
	     (wsiS_reqFifo$D_OUT[93] && wsiS_reqFifo$D_OUT[15:8] == 8'd0 &&
	      mesgLengthSoFar == 14'd0) ?
	       24'd0 :
	       { 10'd0, mlp1B__h20805 } ;
  assign mlp1B__h20805 = { mlp1__h20804[10:0], 3'd0 } ;
  assign mlp1__h20804 = MUX_mesgLengthSoFar$write_1__VAL_2 ;
  assign rdat__h22487 = hasDebugLogic ? mesgCount : 32'd0 ;
  assign rdat__h22493 = hasDebugLogic ? abortCount : 32'd0 ;
  assign rdat__h22499 = hasDebugLogic ? thisMesg : 32'd0 ;
  assign rdat__h22512 = hasDebugLogic ? lastMesg : 32'd0 ;
  assign rdat__h22535 = hasDebugLogic ? { 16'd0, x__h22539 } : 32'd0 ;
  assign rdat__h22635 = hasDebugLogic ? wsiS_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h22649 = hasDebugLogic ? wsiS_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h22657 = hasDebugLogic ? wsiS_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h22663 = hasDebugLogic ? wsiM_extStatusW$wget[95:64] : 32'd0 ;
  assign rdat__h22677 = hasDebugLogic ? wsiM_extStatusW$wget[63:32] : 32'd0 ;
  assign rdat__h22685 = hasDebugLogic ? wsiM_extStatusW$wget[31:0] : 32'd0 ;
  assign rdat__h22691 = hasDebugLogic ? wmwtBeginCount : 32'd0 ;
  assign rdat__h22697 = hasDebugLogic ? wmwtPImpCount : 32'd0 ;
  assign rdat__h22703 = hasDebugLogic ? wmwtFinalCount : 32'd0 ;
  assign rdat__h22709 = hasDebugLogic ? 32'hFEEDC0DE : 32'd0 ;
  assign sendData_burstLength__h18799 =
	     (thisMesg[15:0] == 16'd0 || smaCtrl[5] && unrollCnt == 16'd1) ?
	       12'd1 :
	       (smaCtrl[5] ? 12'd4095 : wsiBurstLength__h18717[11:0]) ;
  assign sendData_byteEn__h18801 = (thisMesg[15:0] == 16'd0) ? 8'd0 : 8'd255 ;
  assign wci_wslv_cState_5_EQ_2_6_AND_smaCtrl_75_BITS_3_ETC___d702 =
	     wci_wslv_cState == 3'd2 &&
	     (smaCtrl[3:0] == 4'h2 || smaCtrl[3:0] == 4'h3) &&
	     mesgLength[14] &&
	     !doAbort &&
  ...
  assign wmi_operateD_42_AND_wmi_peerIsReady_43_44_AND__ETC___d629 =
	     wmi_operateD && wmi_peerIsReady && wsiS_reqFifo$EMPTY_N &&
	     (smaCtrl[3:0] != 4'h3 || wsiM_reqFifo_c_r != 2'd2) ;
  assign wmi_respF_i_notEmpty__40_AND_smaCtrl_75_BIT_4__ETC___d545 =
	     wmi_respF$EMPTY_N &&
	     (smaCtrl[4] || respF_rRdPtr + 12'd1024 != respF_rWrPtr) ;
  assign wsiBurstLength__h18717 =
	     smaCtrl[5] ? 16'd2 : { 3'd0, thisMesg[15:3] } ;
  assign wsiS_reqFifo_i_notEmpty__74_AND_NOT_smaCtrl_75_ETC___d648 =
	     wsiS_reqFifo$EMPTY_N &&
	     (smaCtrl[3:0] != 4'h3 || wsiM_reqFifo_c_r != 2'd2) &&
  ...
  assign x__h18510 = fabWordsRemain == fabWordsCurReq ;
  assign x__h19973 = opcode[8] ? opcode[7:0] : 8'd0 ;
  assign x__h19987 = mesgLength[14] ? mesgLength[13:0] : 14'd0 ;
  assign x__h22539 = { wsiS_statusR, wsiM_statusR } ;
  assign x_length__h19969 = { 2'd0, x__h19987 } ;
  always@(wci_wslv_reqF$D_OUT or
	  ...
	  rdat__h22677 or
	  rdat__h22685 or
	  rdat__h22691 or rdat__h22697 or rdat__h22703 or rdat__h22709)
  begin
    case (wci_wslv_reqF$D_OUT[39:32])
      8'h0: g_data__h22444 = smaCtrl;
      8'h04: g_data__h22444 = rdat__h22487;
      8'h08: g_data__h22444 = rdat__h22493;
      8'h10: g_data__h22444 = rdat__h22499;
      8'h14: g_data__h22444 = rdat__h22512;
      8'h18: g_data__h22444 = rdat__h22535;
      8'h20: g_data__h22444 = rdat__h22635;
      8'h24: g_data__h22444 = rdat__h22649;
      8'h28: g_data__h22444 = rdat__h22657;
      8'h2C: g_data__h22444 = rdat__h22663;
      8'h30: g_data__h22444 = rdat__h22677;
      8'h34: g_data__h22444 = rdat__h22685;
      8'h38: g_data__h22444 = rdat__h22691;
      8'h3C: g_data__h22444 = rdat__h22697;
      8'h40: g_data__h22444 = rdat__h22703;
      8'h44: g_data__h22444 = rdat__h22709;
      default: g_data__h22444 = 32'd0;
    endcase
  end
  ...
  begin
    ...
    if (wciS0_MReset_n)
      if (MUX_opcode$write_1__SEL_2)
	$display("[%0d]: %m: wmwt_doAbort", v__h21743);
    if (wciS0_MReset_n)
