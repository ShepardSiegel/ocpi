...
//
// On Fri Oct 15 14:27:53 EDT 2010
//
//
// Ports:
// Name                         I/O  size props
...
module mkSMAdapter8B(wciS0_Clk,
  ...
  wire [5 : 0] fabRespCredit_acc_v1$wget, fabRespCredit_acc_v2$wget;
  ...
  reg [5 : 0] fabRespCredit_value;
  wire [5 : 0] fabRespCredit_value$D_IN;
  ...
  wire [5 : 0] MUX_fabRespCredit_value$write_1__VAL_2;
  ...
  wire [13 : 0] IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d794,
		addr__h17461,
		b__h20115,
		mlp1B__h17445,
		mlp1__h17444;
  ...
  arSRLFIFO #(.width(32'd97),
	      .l2depth(32'd5),
	      .depth(32'd32)) respF(.CLK(wciS0_Clk),
  ...
  assign CAN_FIRE_RL_wmrd_mesgBodyPreRequest =
	     ...
	     (fabRespCredit_value ^ 6'h20) > 6'd32 &&
	     mesgReqOK ;
  ...
  assign MUX_fabRespCredit_value$write_1__VAL_2 =
	     fabRespCredit_value +
	     (CAN_FIRE_RL_wmrd_mesgBodyRequest ? b__h14495 : 6'd0) +
	     (CAN_FIRE_RL_wmrd_mesgResptoWsi ? 6'd1 : 6'd0) ;
  ...
  assign fabRespCredit_acc_v2$wget = 6'd1 ;
  ...
  // remaining internal signals
  assign IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d794 =
  ...
  assign b__h14495 = -fabWordsCurReq[5:0] ;
  assign b__h20115 = { {8{fabRespCredit_value[5]}}, fabRespCredit_value } ;
  assign bl__h18513 =
	     zeroLengthMesg ?
	       12'd1 :
	       { 1'd0,
		 IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d794[13:3] } ;
  assign mesgMetaF_length__h17614 = { 10'd0, mlp1B__h17445 } ;
  assign mesgMetaF_length__h18657 =
	     { 10'd0,
	       IF_mesgLength_33_BIT_14_34_THEN_mesgLength_33__ETC___d794 } ;
  ...
  begin
	...
	fabRespCredit_value <= `BSV_ASSIGNMENT_DELAY 6'd0;
