...
//
// On Sun Feb  6 11:13:58 EST 2011
//
//
// Ports:
// Name                         I/O  size props
...
// axi_len_TVALID                 O     1 const
// axi_len_TDATA                  O    16 const
// axi_len_TSTRB                  O     2 const
// axi_len_TLAST                  O     1 const
// axi_spt_TVALID                 O     1 const
// axi_spt_TDATA                  O     8 const
// axi_spt_TSTRB                  O     1 const
// axi_spt_TLAST                  O     1 const
// axi_dpt_TVALID                 O     1 const
// axi_dpt_TDATA                  O     8 const
// axi_dpt_TSTRB                  O     1 const
// axi_dpt_TLAST                  O     1 const
// axi_err_TVALID                 O     1 const
// axi_err_TLAST                  O     1 const
// CLK                            I     1 clock
// RST_N                          I     1 reset
// wsi_MCmd                       I     3
...
// axi_dat_TREADY                 I     1
// axi_len_TREADY                 I     1 unused
// axi_spt_TREADY                 I     1 unused
// axi_dpt_TREADY                 I     1 unused
// axi_err_TREADY                 I     1 unused
//
...
module mkWSItoAXIS32B(CLK,
  ...
  // value method axi_dat_mTVALID
  assign axi_dat_TVALID = a4ms_fifof_c_r != 2'd0 ;

  // value method axi_dat_mTDATA
  assign axi_dat_TDATA = a4ms_fifof_q_0[288:33] ;

  // value method axi_dat_mTSTRB
  assign axi_dat_TSTRB = a4ms_fifof_q_0[32:1] ;

  // value method axi_dat_mTLAST
  assign axi_dat_TLAST = a4ms_fifof_q_0[0] ;

  // value method axi_len_mTVALID
  assign axi_len_TVALID = 1'h0 ;

  // value method axi_len_mTDATA
  assign axi_len_TDATA = 16'hAAAA ;

  // value method axi_len_mTSTRB
  assign axi_len_TSTRB = 2'h2 ;

  // value method axi_len_mTLAST
  assign axi_len_TLAST = 1'h0 ;

  // value method axi_spt_mTVALID
  assign axi_spt_TVALID = 1'h0 ;

  // value method axi_spt_mTDATA
  assign axi_spt_TDATA = 8'hAA ;

  // value method axi_spt_mTSTRB
  assign axi_spt_TSTRB = 1'h0 ;

  // value method axi_spt_mTLAST
  assign axi_spt_TLAST = 1'h0 ;

  // value method axi_dpt_mTVALID
  assign axi_dpt_TVALID = 1'h0 ;

  // value method axi_dpt_mTDATA
  assign axi_dpt_TDATA = 8'hAA ;

  // value method axi_dpt_mTSTRB
  assign axi_dpt_TSTRB = 1'h0 ;

  // value method axi_dpt_mTLAST
  assign axi_dpt_TLAST = 1'h0 ;

  // value method axi_err_mTVALID
  assign axi_err_TVALID = 1'h0 ;

  // value method axi_err_mTLAST
  assign axi_err_TLAST = 1'h0 ;
  ...
  assign axi_Em_mTRdy_w$whas = axi_dat_TREADY ;
  ...
  assign a4ms_fifof_enqueueing$whas =
	     MUX_wsiS_reqFifo_levelsValid$write_1__SEL_2 ;
  assign a4ms_fifof_dequeueing$whas =
	     a4ms_fifof_c_r != 2'd0 && axi_dat_TREADY ;
  assign a4ms_deq_ready$whas = axi_dat_TREADY ;
