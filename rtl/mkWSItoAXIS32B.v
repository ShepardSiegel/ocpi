...
//
// On Mon Feb  7 09:35:38 EST 2011
//
//
// Ports:
// Name                         I/O  size props
...
module mkWSItoAXIS32B(CLK,
  ...
  reg err_fifof_q_0;
  wire err_fifof_q_0$D_IN, err_fifof_q_0$EN;

  // register err_fifof_q_1
  reg err_fifof_q_1;
  wire err_fifof_q_1$D_IN, err_fifof_q_1$EN;
  ...
  // value method axi_err_mTLAST
  assign axi_err_TLAST = err_fifof_q_0 ;
  ...
  assign MUX_len_fifof_q_0$write_1__VAL_1 = { x_data__h9018, 3'd7 } ;
  ...
  assign spt_fifof_x_wire$wget = MUX_dpt_fifof_q_0$write_1__VAL_1 ;
  ...
  assign err_fifof_x_wire$wget = 1'b0 ;
  ...
  // register err_fifof_q_1
  assign err_fifof_q_1$D_IN = 1'd0 ;
  ...
  begin
    case (1'b1) // synopsys parallel_case
      MUX_spt_fifof_q_0$write_1__SEL_1:
	  spt_fifof_q_0$D_IN = MUX_dpt_fifof_q_0$write_1__VAL_1;
      WILL_FIRE_RL_spt_fifof_both:
  ...
  begin
    case (1'b1) // synopsys parallel_case
      MUX_spt_fifof_q_1$write_1__SEL_1:
	  spt_fifof_q_1$D_IN = MUX_dpt_fifof_q_0$write_1__VAL_1;
      WILL_FIRE_RL_spt_fifof_both:
  ...
  assign wsiS_reqFifo_notFull__1_AND_wsiS_burstKind_6_E_ETC___d53 =
	     ...
	     (wsiS_burstKind == 2'd0 ||
	      ...
	      wsiS_wsiReq$wget[309]) ;
  assign x__h9024 = { wsiS_reqFifo$D_OUT[302:296], 5'd0 } ;
  assign x_data__h9018 = { 4'd0, x__h9024 } ;
  ...
  begin
	...
	err_fifof_q_0 <= `BSV_ASSIGNMENT_DELAY 1'd0;
	err_fifof_q_1 <= `BSV_ASSIGNMENT_DELAY 1'd0;
